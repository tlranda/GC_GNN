; ModuleID = 'syr2k_recreations//mmp_syr2k_S_22.c'
source_filename = "syr2k_recreations//mmp_syr2k_S_22.c"
...
vector.body1410:                                  ; preds = %vector.body1410, %vector.ph1412
  ...
  br i1 %57, label %middle.block1408, label %vector.body1410, !llvm.loop !57
...
vector.body1460:                                  ; preds = %vector.body1460, %vector.ph1462
  ...
  br i1 %68, label %middle.block1458, label %vector.body1460, !llvm.loop !59
...
vector.body1472:                                  ; preds = %vector.body1472, %vector.ph1476
  ...
  %wide.load1483 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !65, !noalias !67
  ...
  br i1 %95, label %middle.block1470, label %vector.body1472, !llvm.loop !72
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond941.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !73
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %smin932 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 -44)
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond938.not = icmp eq i64 %polly.indvar_next220, 4
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %99 = shl nuw nsw i64 %polly.indvar225, 2
  %100 = mul nsw i64 %polly.indvar225, -4
  %101 = add nuw nsw i64 %99, 4
  br label %polly.loop_header228

polly.loop_exit230:                               ; preds = %polly.loop_exit259
  %polly.indvar_next226 = add nuw nsw i64 %polly.indvar225, 1
  %indvars.iv.next935 = add nsw i64 %indvars.iv934, -4
  %exitcond937.not = icmp eq i64 %polly.indvar_next226, 20
...
polly.loop_header228:                             ; preds = %polly.loop_exit259, %polly.loop_header222
  ...
  %smin1487 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 3)
  %smin930 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 3)
...
vector.body1486:                                  ; preds = %vector.body1486, %polly.loop_header257
  ...
  %wide.masked.load1507 = call <4 x double> @llvm.masked.load.v4f64.p0v4f64(<4 x double>* %121, i32 8, <4 x i1> %109, <4 x double> poison), !alias.scope !65, !noalias !67
  ...
  call void @llvm.masked.store.v4f64.p0v4f64(<4 x double> %124, <4 x double>* %125, i32 8, <4 x i1> %109), !alias.scope !65, !noalias !67
  %index.next1493 = add i64 %index1492, 4
  %126 = icmp eq i64 %index1492, 0
  br i1 %126, label %polly.loop_exit265, label %vector.body1486, !llvm.loop !77
...
polly.start291:                                   ; preds = %kernel_syr2k.exit
  %malloccall293 = tail call dereferenceable_or_null(10240) i8* @malloc(i64 10240) #8
...
vector.body1422:                                  ; preds = %vector.body1422, %vector.ph1426
  ...
  %wide.load1433 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %134, label %middle.block1420, label %vector.body1422, !llvm.loop !85
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_header385
  ...
  br i1 %exitcond966.not, label %polly.loop_exit387, label %polly.loop_header385, !llvm.loop !86
...
polly.loop_header411:                             ; preds = %polly.loop_exit403, %polly.loop_exit419
  ...
  %smin957 = call i64 @llvm.smin.i64(i64 %indvars.iv947, i64 -44)
  %136 = add nsw i64 %smin957, 60
  %137 = shl nsw i64 %polly.indvar414, 4
...
polly.loop_exit419:                               ; preds = %polly.loop_exit425
  ...
  %exitcond963.not = icmp eq i64 %polly.indvar_next415, 4
...
polly.loop_header417:                             ; preds = %polly.loop_exit425, %polly.loop_header411
  ...
  %138 = shl nuw nsw i64 %polly.indvar420, 2
  %139 = mul nsw i64 %polly.indvar420, -4
  %140 = add nuw nsw i64 %138, 4
...
polly.loop_exit425:                               ; preds = %polly.loop_exit458
  ...
  %indvars.iv.next960 = add nsw i64 %indvars.iv959, -4
  %exitcond962.not = icmp eq i64 %polly.indvar_next421, 20
...
polly.loop_header423:                             ; preds = %polly.loop_exit458, %polly.loop_header417
  ...
  %smin1437 = call i64 @llvm.smin.i64(i64 %indvars.iv943, i64 3)
  %smin955 = call i64 @llvm.smin.i64(i64 %indvars.iv943, i64 3)
...
vector.body1436:                                  ; preds = %vector.body1436, %polly.loop_header456
  ...
  %wide.masked.load1457 = call <4 x double> @llvm.masked.load.v4f64.p0v4f64(<4 x double>* %160, i32 8, <4 x i1> %148, <4 x double> poison), !alias.scope !78, !noalias !80
  ...
  call void @llvm.masked.store.v4f64.p0v4f64(<4 x double> %163, <4 x double>* %164, i32 8, <4 x i1> %148), !alias.scope !78, !noalias !80
  %index.next1443 = add i64 %index1442, 4
  %165 = icmp eq i64 %index1442, 0
  br i1 %165, label %polly.loop_exit464, label %vector.body1436, !llvm.loop !89
...
polly.start490:                                   ; preds = %init_array.exit
  %malloccall492 = tail call dereferenceable_or_null(10240) i8* @malloc(i64 10240) #8
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1381
  ...
  %wide.load1388 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !90, !noalias !92
  ...
  store <4 x double> %171, <4 x double>* %172, align 8, !alias.scope !90, !noalias !92
  %index.next1385 = add i64 %index1384, 4
  %173 = icmp eq i64 %index.next1385, %n.vec1383
  br i1 %173, label %middle.block1377, label %vector.body1379, !llvm.loop !97
...
polly.loop_header584:                             ; preds = %polly.loop_header584.preheader, %polly.loop_header584
  ...
  br i1 %exitcond991.not, label %polly.loop_exit586, label %polly.loop_header584, !llvm.loop !98
...
polly.loop_header610:                             ; preds = %polly.loop_exit602, %polly.loop_exit618
  ...
  %smin982 = call i64 @llvm.smin.i64(i64 %indvars.iv972, i64 -44)
  %175 = add nsw i64 %smin982, 60
  %176 = shl nsw i64 %polly.indvar613, 4
...
polly.loop_exit618:                               ; preds = %polly.loop_exit624
  ...
  %indvars.iv.next973 = add nsw i64 %indvars.iv972, -16
  %exitcond988.not = icmp eq i64 %polly.indvar_next614, 4
...
polly.loop_header616:                             ; preds = %polly.loop_exit624, %polly.loop_header610
  ...
  %177 = shl nuw nsw i64 %polly.indvar619, 2
  %178 = mul nsw i64 %polly.indvar619, -4
  %179 = add nuw nsw i64 %177, 4
...
polly.loop_exit624:                               ; preds = %polly.loop_exit657
  ...
  %exitcond987.not = icmp eq i64 %polly.indvar_next620, 20
...
polly.loop_header622:                             ; preds = %polly.loop_exit657, %polly.loop_header616
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv968, i64 3)
  %smin980 = call i64 @llvm.smin.i64(i64 %indvars.iv968, i64 3)
...
vector.body1391:                                  ; preds = %vector.body1391, %polly.loop_header655
  ...
  %wide.masked.load1407 = call <4 x double> @llvm.masked.load.v4f64.p0v4f64(<4 x double>* %199, i32 8, <4 x i1> %187, <4 x double> poison), !alias.scope !90, !noalias !92
  ...
  call void @llvm.masked.store.v4f64.p0v4f64(<4 x double> %202, <4 x double>* %203, i32 8, <4 x i1> %187), !alias.scope !90, !noalias !92
  %index.next1396 = add i64 %index1395, 4
  %204 = icmp eq i64 %index1395, 0
  br i1 %204, label %polly.loop_exit663, label %vector.body1391, !llvm.loop !101
...
vector.body1101:                                  ; preds = %vector.body1101, %polly.loop_header825
  ...
  store <4 x double> %211, <4 x double>* %215, align 8, !alias.scope !102, !noalias !104
  ...
  br i1 %216, label %polly.loop_exit833, label %vector.body1101, !llvm.loop !107
...
vector.body1215:                                  ; preds = %vector.body1215, %polly.loop_header852
  ...
  store <4 x double> %223, <4 x double>* %227, align 8, !alias.scope !106, !noalias !108
  ...
  br i1 %228, label %polly.loop_exit860, label %vector.body1215, !llvm.loop !109
...
vector.body1293:                                  ; preds = %vector.body1293, %polly.loop_header878
  ...
  store <4 x double> %235, <4 x double>* %239, align 8, !alias.scope !105, !noalias !110
  ...
  br i1 %240, label %polly.loop_exit886, label %vector.body1293, !llvm.loop !111
...
vector.body1307:                                  ; preds = %vector.body1307, %polly.loop_header878.1
  ...
  store <4 x double> %249, <4 x double>* %254, align 8, !alias.scope !105, !noalias !110
  ...
  br i1 %255, label %polly.loop_exit886.1, label %vector.body1307, !llvm.loop !112
...
vector.body1319:                                  ; preds = %vector.body1319, %polly.loop_header878.11020
  ...
  store <4 x double> %263, <4 x double>* %267, align 8, !alias.scope !105, !noalias !110
  ...
  br i1 %268, label %polly.loop_exit886.11031, label %vector.body1319, !llvm.loop !113
...
vector.body1333:                                  ; preds = %vector.body1333, %polly.loop_header878.1.1
  ...
  store <4 x double> %278, <4 x double>* %283, align 8, !alias.scope !105, !noalias !110
  ...
  br i1 %284, label %polly.loop_exit886.1.1, label %vector.body1333, !llvm.loop !114
...
vector.body1345:                                  ; preds = %vector.body1345, %polly.loop_header878.2
  ...
  store <4 x double> %292, <4 x double>* %296, align 8, !alias.scope !105, !noalias !110
  ...
  br i1 %297, label %polly.loop_exit886.2, label %vector.body1345, !llvm.loop !115
...
vector.body1359:                                  ; preds = %vector.body1359, %polly.loop_header878.1.2
  ...
  store <4 x double> %307, <4 x double>* %312, align 8, !alias.scope !105, !noalias !110
  ...
  br i1 %313, label %polly.loop_exit886.1.2, label %vector.body1359, !llvm.loop !116
...
vector.body1229:                                  ; preds = %vector.body1229, %polly.loop_header852.1
  ...
  store <4 x double> %322, <4 x double>* %327, align 8, !alias.scope !106, !noalias !108
  ...
  br i1 %328, label %polly.loop_exit860.1, label %vector.body1229, !llvm.loop !117
...
vector.body1241:                                  ; preds = %vector.body1241, %polly.loop_header852.11034
  ...
  store <4 x double> %336, <4 x double>* %340, align 8, !alias.scope !106, !noalias !108
  ...
  br i1 %341, label %polly.loop_exit860.11045, label %vector.body1241, !llvm.loop !118
...
vector.body1255:                                  ; preds = %vector.body1255, %polly.loop_header852.1.1
  ...
  store <4 x double> %351, <4 x double>* %356, align 8, !alias.scope !106, !noalias !108
  ...
  br i1 %357, label %polly.loop_exit860.1.1, label %vector.body1255, !llvm.loop !119
...
vector.body1267:                                  ; preds = %vector.body1267, %polly.loop_header852.2
  ...
  store <4 x double> %365, <4 x double>* %369, align 8, !alias.scope !106, !noalias !108
  ...
  br i1 %370, label %polly.loop_exit860.2, label %vector.body1267, !llvm.loop !120
...
vector.body1281:                                  ; preds = %vector.body1281, %polly.loop_header852.1.2
  ...
  store <4 x double> %380, <4 x double>* %385, align 8, !alias.scope !106, !noalias !108
  ...
  br i1 %386, label %polly.loop_exit860.1.2, label %vector.body1281, !llvm.loop !121
...
vector.body1115:                                  ; preds = %vector.body1115, %polly.loop_header825.1
  ...
  br i1 %401, label %polly.loop_exit833.1, label %vector.body1115, !llvm.loop !122
...
vector.body1127:                                  ; preds = %vector.body1127, %polly.loop_header825.2
  ...
  store <4 x double> %410, <4 x double>* %415, align 8, !alias.scope !102, !noalias !104
  ...
  br i1 %416, label %polly.loop_exit833.2, label %vector.body1127, !llvm.loop !123
...
vector.body1139:                                  ; preds = %vector.body1139, %polly.loop_header825.11048
  ...
  store <4 x double> %424, <4 x double>* %428, align 8, !alias.scope !102, !noalias !104
  ...
  br i1 %429, label %polly.loop_exit833.11059, label %vector.body1139, !llvm.loop !124
...
vector.body1153:                                  ; preds = %vector.body1153, %polly.loop_header825.1.1
  ...
  store <4 x double> %439, <4 x double>* %444, align 8, !alias.scope !102, !noalias !104
  ...
  br i1 %445, label %polly.loop_exit833.1.1, label %vector.body1153, !llvm.loop !125
...
vector.body1165:                                  ; preds = %vector.body1165, %polly.loop_header825.2.1
  ...
  store <4 x double> %455, <4 x double>* %460, align 8, !alias.scope !102, !noalias !104
  ...
  br i1 %461, label %polly.loop_exit833.2.1, label %vector.body1165, !llvm.loop !126
...
vector.body1177:                                  ; preds = %vector.body1177, %polly.loop_header825.21062
  ...
  store <4 x double> %469, <4 x double>* %473, align 8, !alias.scope !102, !noalias !104
  ...
  br i1 %474, label %polly.loop_exit833.21073, label %vector.body1177, !llvm.loop !127
...
vector.body1191:                                  ; preds = %vector.body1191, %polly.loop_header825.1.2
  ...
  store <4 x double> %484, <4 x double>* %489, align 8, !alias.scope !102, !noalias !104
  ...
  br i1 %490, label %polly.loop_exit833.1.2, label %vector.body1191, !llvm.loop !128
...
vector.body1203:                                  ; preds = %vector.body1203, %polly.loop_header825.2.2
  ...
  store <4 x double> %500, <4 x double>* %505, align 8, !alias.scope !102, !noalias !104
  ...
  br i1 %506, label %polly.loop_exit833.2.2, label %vector.body1203, !llvm.loop !129
