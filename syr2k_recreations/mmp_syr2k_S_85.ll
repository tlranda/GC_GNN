; ModuleID = 'syr2k_recreations//mmp_syr2k_S_85.c'
source_filename = "syr2k_recreations//mmp_syr2k_S_85.c"
...
polly.start266:                                   ; preds = %kernel_syr2k.exit
  %malloccall268 = tail call dereferenceable_or_null(32000) i8* @malloc(i64 32000) #6
...
vector.body1262:                                  ; preds = %vector.body1262, %vector.ph1266
  ...
  %wide.load1273 = load <4 x double>, <4 x double>* %114, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %117, label %middle.block1260, label %vector.body1262, !llvm.loop !85
...
polly.loop_header368:                             ; preds = %polly.loop_header368.preheader, %polly.loop_exit398.2
  ...
  %119 = mul nuw nsw i64 %polly.indvar371, -50
  %120 = icmp slt i64 %119, -10
  %121 = select i1 %120, i64 %119, i64 -10
  %122 = mul nuw nsw i64 %polly.indvar371, 50
...
polly.start435:                                   ; preds = %init_array.exit
  %malloccall437 = tail call dereferenceable_or_null(32000) i8* @malloc(i64 32000) #6
...
vector.body1238:                                  ; preds = %vector.body1238, %vector.ph1240
  ...
  %wide.load1247 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %139, label %middle.block1236, label %vector.body1238, !llvm.loop !95
...
polly.loop_header537:                             ; preds = %polly.loop_header537.preheader, %polly.loop_exit567.2
  ...
  %141 = mul nuw nsw i64 %polly.indvar540, -50
  %142 = icmp slt i64 %141, -10
  %143 = select i1 %142, i64 %141, i64 -10
  %144 = mul nuw nsw i64 %polly.indvar540, 50
...
vector.body960:                                   ; preds = %vector.body960, %polly.loop_header740
  ...
  br i1 %165, label %polly.loop_exit748, label %vector.body960, !llvm.loop !104
...
vector.body1074:                                  ; preds = %vector.body1074, %polly.loop_header767
  ...
  br i1 %177, label %polly.loop_exit775, label %vector.body1074, !llvm.loop !106
...
vector.body1152:                                  ; preds = %vector.body1152, %polly.loop_header793
  ...
  br i1 %189, label %polly.loop_exit801, label %vector.body1152, !llvm.loop !108
...
vector.body1166:                                  ; preds = %vector.body1166, %polly.loop_header793.1
  ...
  store <4 x double> %264, <4 x double>* %269, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %270, label %polly.loop_exit801.1, label %vector.body1166, !llvm.loop !109
...
vector.body1178:                                  ; preds = %vector.body1178, %polly.loop_header793.1885
  ...
  store <4 x double> %278, <4 x double>* %282, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %283, label %polly.loop_exit801.1896, label %vector.body1178, !llvm.loop !110
...
vector.body1192:                                  ; preds = %vector.body1192, %polly.loop_header793.1.1
  ...
  store <4 x double> %293, <4 x double>* %298, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %299, label %polly.loop_exit801.1.1, label %vector.body1192, !llvm.loop !111
...
vector.body1204:                                  ; preds = %vector.body1204, %polly.loop_header793.2
  ...
  store <4 x double> %307, <4 x double>* %311, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %312, label %polly.loop_exit801.2, label %vector.body1204, !llvm.loop !112
...
vector.body1218:                                  ; preds = %vector.body1218, %polly.loop_header793.1.2
  ...
  store <4 x double> %322, <4 x double>* %327, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %328, label %polly.loop_exit801.1.2, label %vector.body1218, !llvm.loop !113
...
vector.body1088:                                  ; preds = %vector.body1088, %polly.loop_header767.1
  ...
  store <4 x double> %337, <4 x double>* %342, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %343, label %polly.loop_exit775.1, label %vector.body1088, !llvm.loop !114
...
vector.body1100:                                  ; preds = %vector.body1100, %polly.loop_header767.1899
  ...
  store <4 x double> %351, <4 x double>* %355, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %356, label %polly.loop_exit775.1910, label %vector.body1100, !llvm.loop !115
...
vector.body1114:                                  ; preds = %vector.body1114, %polly.loop_header767.1.1
  ...
  store <4 x double> %366, <4 x double>* %371, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %372, label %polly.loop_exit775.1.1, label %vector.body1114, !llvm.loop !116
...
vector.body1126:                                  ; preds = %vector.body1126, %polly.loop_header767.2
  ...
  store <4 x double> %380, <4 x double>* %384, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %385, label %polly.loop_exit775.2, label %vector.body1126, !llvm.loop !117
...
vector.body1140:                                  ; preds = %vector.body1140, %polly.loop_header767.1.2
  ...
  store <4 x double> %395, <4 x double>* %400, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %401, label %polly.loop_exit775.1.2, label %vector.body1140, !llvm.loop !118
...
vector.body974:                                   ; preds = %vector.body974, %polly.loop_header740.1
  ...
  br i1 %416, label %polly.loop_exit748.1, label %vector.body974, !llvm.loop !119
...
vector.body986:                                   ; preds = %vector.body986, %polly.loop_header740.2
  ...
  store <4 x double> %425, <4 x double>* %430, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %431, label %polly.loop_exit748.2, label %vector.body986, !llvm.loop !120
...
vector.body998:                                   ; preds = %vector.body998, %polly.loop_header740.1913
  ...
  store <4 x double> %439, <4 x double>* %443, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %444, label %polly.loop_exit748.1924, label %vector.body998, !llvm.loop !121
...
vector.body1012:                                  ; preds = %vector.body1012, %polly.loop_header740.1.1
  ...
  br i1 %460, label %polly.loop_exit748.1.1, label %vector.body1012, !llvm.loop !122
...
vector.body1024:                                  ; preds = %vector.body1024, %polly.loop_header740.2.1
  ...
  store <4 x double> %470, <4 x double>* %475, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %476, label %polly.loop_exit748.2.1, label %vector.body1024, !llvm.loop !123
...
vector.body1036:                                  ; preds = %vector.body1036, %polly.loop_header740.2927
  ...
  store <4 x double> %484, <4 x double>* %488, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %489, label %polly.loop_exit748.2938, label %vector.body1036, !llvm.loop !124
...
vector.body1050:                                  ; preds = %vector.body1050, %polly.loop_header740.1.2
  ...
  store <4 x double> %499, <4 x double>* %504, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %505, label %polly.loop_exit748.1.2, label %vector.body1050, !llvm.loop !125
...
vector.body1062:                                  ; preds = %vector.body1062, %polly.loop_header740.2.2
  ...
  br i1 %521, label %polly.loop_exit748.2.2, label %vector.body1062, !llvm.loop !126
