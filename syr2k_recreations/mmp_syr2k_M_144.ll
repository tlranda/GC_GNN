; ModuleID = 'syr2k_recreations//mmp_syr2k_M_144.c'
source_filename = "syr2k_recreations//mmp_syr2k_M_144.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond795.not = icmp eq i64 %polly.indvar_next209, 20
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv789 = phi i64 [ %104, %polly.loop_header217.preheader ], [ %indvars.iv.next790, %polly.loop_exit225 ]
  %polly.indvar220 = phi i64 [ %103, %polly.loop_header217.preheader ], [ %polly.indvar_next221, %polly.loop_exit225 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv789, i64 49)
  %106 = add nsw i64 %polly.indvar220, %105
  %polly.loop_guard233875 = icmp sgt i64 %106, -1
  %107 = add nuw nsw i64 %polly.indvar220, %98
  %108 = mul i64 %107, 8000
  %109 = mul i64 %107, 9600
  br i1 %polly.loop_guard233875, label %polly.loop_header223.us, label %polly.loop_exit225
...
polly.loop_header223.us:                          ; preds = %polly.loop_header217, %polly.loop_exit232.loopexit.us
  ...
  %111 = shl i64 %110, 3
  %112 = add i64 %111, %108
  %scevgep240.us = getelementptr i8, i8* %call2, i64 %112
  ...
  %scevgep246.us = getelementptr i8, i8* %call1, i64 %112
...
polly.loop_header230.us:                          ; preds = %polly.loop_header223.us, %polly.loop_header230.us
  ...
  %113 = add nuw nsw i64 %polly.indvar234.us, %100
...
polly.loop_exit232.loopexit.us:                   ; preds = %polly.loop_header230.us
  ...
  %exitcond791.not = icmp eq i64 %polly.indvar_next227.us, 50
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph994
  ...
  %120 = shl nuw nsw i64 %index997, 3
  %121 = getelementptr i8, i8* %scevgep350, i64 %120
  %122 = bitcast i8* %121 to <4 x double>*
  %wide.load1001 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !68, !noalias !70
  %123 = fmul fast <4 x double> %wide.load1001, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %125 = icmp eq i64 %index.next998, %n.vec996
  br i1 %125, label %middle.block988, label %vector.body990, !llvm.loop !73

middle.block988:                                  ; preds = %vector.body990
  %cmp.n1000 = icmp eq i64 %118, %n.vec996
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %127 = mul nsw i64 %polly.indvar357, -100
  %128 = mul nuw nsw i64 %polly.indvar357, 100
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.loop_header354
  ...
  %129 = mul nuw nsw i64 %polly.indvar363, 50
  br label %polly.loop_header366

polly.loop_exit368:                               ; preds = %polly.loop_exit375
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %exitcond816.not = icmp eq i64 %polly.indvar_next364, 20
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %130 = mul nuw nsw i64 %polly.indvar369, 50
  %131 = add nsw i64 %130, %127
  %132 = icmp sgt i64 %131, 0
  %133 = select i1 %132, i64 %131, i64 0
  %polly.loop_guard376 = icmp slt i64 %133, 100
...
polly.loop_header373.preheader:                   ; preds = %polly.loop_header366
  ...
  %134 = add i64 %smax803, %indvars.iv806
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382, %polly.loop_header366
  ...
  %indvars.iv.next807 = add nsw i64 %indvars.iv806, -50
...
polly.loop_header373:                             ; preds = %polly.loop_header373.preheader, %polly.loop_exit382
  %indvars.iv808 = phi i64 [ %134, %polly.loop_header373.preheader ], [ %indvars.iv.next809, %polly.loop_exit382 ]
  %polly.indvar377 = phi i64 [ %133, %polly.loop_header373.preheader ], [ %polly.indvar_next378, %polly.loop_exit382 ]
  %smin810 = call i64 @llvm.smin.i64(i64 %indvars.iv808, i64 49)
  %136 = add nsw i64 %polly.indvar377, %135
  %polly.loop_guard390876 = icmp sgt i64 %136, -1
  %137 = add nuw nsw i64 %polly.indvar377, %128
  %138 = mul i64 %137, 8000
  %139 = mul i64 %137, 9600
  br i1 %polly.loop_guard390876, label %polly.loop_header380.us, label %polly.loop_exit382
...
polly.loop_header380.us:                          ; preds = %polly.loop_header373, %polly.loop_exit389.loopexit.us
  ...
  %140 = add nuw nsw i64 %polly.indvar383.us, %129
  %141 = shl i64 %140, 3
  %142 = add i64 %141, %138
  %scevgep397.us = getelementptr i8, i8* %call2, i64 %142
  ...
  %scevgep403.us = getelementptr i8, i8* %call1, i64 %142
...
polly.loop_header387.us:                          ; preds = %polly.loop_header380.us, %polly.loop_header387.us
  ...
  %143 = add nuw nsw i64 %polly.indvar391.us, %130
  %144 = mul nuw nsw i64 %143, 8000
  %145 = add nuw nsw i64 %144, %141
  %scevgep394.us = getelementptr i8, i8* %call1, i64 %145
  ...
  %scevgep400.us = getelementptr i8, i8* %call2, i64 %145
  ...
  %146 = shl i64 %143, 3
  %147 = add i64 %146, %139
  %scevgep406.us = getelementptr i8, i8* %call, i64 %147
...
polly.loop_exit389.loopexit.us:                   ; preds = %polly.loop_header387.us
  ...
  %exitcond812.not = icmp eq i64 %polly.indvar_next384.us, 50
  br i1 %exitcond812.not, label %polly.loop_exit382, label %polly.loop_header380.us
...
polly.loop_header495:                             ; preds = %init_array.exit, %polly.loop_exit503
  ...
  %149 = mul nuw nsw i64 %polly.indvar498, 9600
  %scevgep507 = getelementptr i8, i8* %call, i64 %149
  %min.iters.check967 = icmp ult i64 %148, 4
  br i1 %min.iters.check967, label %polly.loop_header501.preheader, label %vector.ph968

vector.ph968:                                     ; preds = %polly.loop_header495
  %n.vec970 = and i64 %148, -4
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  %150 = shl nuw nsw i64 %index971, 3
  %151 = getelementptr i8, i8* %scevgep507, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load975 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !77, !noalias !79
  %153 = fmul fast <4 x double> %wide.load975, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next972, %n.vec970
  br i1 %155, label %middle.block964, label %vector.body966, !llvm.loop !82

middle.block964:                                  ; preds = %vector.body966
  %cmp.n974 = icmp eq i64 %148, %n.vec970
...
polly.loop_header501:                             ; preds = %polly.loop_header501.preheader, %polly.loop_header501
  ...
  %156 = shl nuw nsw i64 %polly.indvar504, 3
  %scevgep508 = getelementptr i8, i8* %scevgep507, i64 %156
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %157 = mul nsw i64 %polly.indvar514, -100
  %158 = mul nuw nsw i64 %polly.indvar514, 100
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %159 = mul nuw nsw i64 %polly.indvar520, 50
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar_next521, 20
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %160 = mul nuw nsw i64 %polly.indvar526, 50
  %161 = add nsw i64 %160, %157
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %polly.loop_guard533 = icmp slt i64 %163, 100
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header523
  ...
  %164 = add i64 %smax824, %indvars.iv827
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  %indvars.iv829 = phi i64 [ %164, %polly.loop_header530.preheader ], [ %indvars.iv.next830, %polly.loop_exit539 ]
  %polly.indvar534 = phi i64 [ %163, %polly.loop_header530.preheader ], [ %polly.indvar_next535, %polly.loop_exit539 ]
  %smin831 = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 49)
  %166 = add nsw i64 %polly.indvar534, %165
  %polly.loop_guard547877 = icmp sgt i64 %166, -1
  %167 = add nuw nsw i64 %polly.indvar534, %158
  %168 = mul i64 %167, 8000
  %169 = mul i64 %167, 9600
  br i1 %polly.loop_guard547877, label %polly.loop_header537.us, label %polly.loop_exit539
...
polly.loop_header537.us:                          ; preds = %polly.loop_header530, %polly.loop_exit546.loopexit.us
  ...
  %170 = add nuw nsw i64 %polly.indvar540.us, %159
  %171 = shl i64 %170, 3
  %172 = add i64 %171, %168
  %scevgep554.us = getelementptr i8, i8* %call2, i64 %172
  ...
  %scevgep560.us = getelementptr i8, i8* %call1, i64 %172
...
polly.loop_header544.us:                          ; preds = %polly.loop_header537.us, %polly.loop_header544.us
  ...
  %173 = add nuw nsw i64 %polly.indvar548.us, %160
  %174 = mul nuw nsw i64 %173, 8000
  %175 = add nuw nsw i64 %174, %171
  %scevgep551.us = getelementptr i8, i8* %call1, i64 %175
  ...
  %scevgep557.us = getelementptr i8, i8* %call2, i64 %175
  ...
  %176 = shl i64 %173, 3
  %177 = add i64 %176, %169
  %scevgep563.us = getelementptr i8, i8* %call, i64 %177
...
polly.loop_exit546.loopexit.us:                   ; preds = %polly.loop_header544.us
  ...
  %exitcond833.not = icmp eq i64 %polly.indvar_next541.us, 50
  br i1 %exitcond833.not, label %polly.loop_exit539, label %polly.loop_header537.us
...
polly.loop_header692:                             ; preds = %entry, %polly.loop_exit700
  ...
  %178 = shl nsw i64 %polly.indvar695, 5
  %179 = add nsw i64 %smin867, 1199
...
polly.loop_header698:                             ; preds = %polly.loop_exit706, %polly.loop_header692
  ...
  %180 = mul nsw i64 %polly.indvar701, -32
  %smin905 = call i64 @llvm.smin.i64(i64 %180, i64 -1168)
  %181 = add nsw i64 %smin905, 1200
  %smin863 = call i64 @llvm.smin.i64(i64 %indvars.iv861, i64 -1168)
  %182 = shl nsw i64 %polly.indvar701, 5
  %183 = add nsw i64 %smin863, 1199
...
polly.loop_header704:                             ; preds = %polly.loop_exit712, %polly.loop_header698
  ...
  %184 = add nuw nsw i64 %polly.indvar707, %178
...
vector.ph906:                                     ; preds = %polly.loop_header704
  %broadcast.splatinsert913 = insertelement <4 x i64> poison, i64 %182, i32 0
  %broadcast.splat914 = shufflevector <4 x i64> %broadcast.splatinsert913, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert915 = insertelement <4 x i32> poison, i32 %185, i32 0
...
vector.body904:                                   ; preds = %vector.body904, %vector.ph906
  ...
  %187 = add nuw nsw <4 x i64> %vec.ind911, %broadcast.splat914
  %188 = trunc <4 x i64> %187 to <4 x i32>
  %189 = mul <4 x i32> %broadcast.splat916, %188
  ...
  %199 = icmp eq i64 %index.next908, %181
  br i1 %199, label %polly.loop_exit712, label %vector.body904, !llvm.loop !91

polly.loop_exit712:                               ; preds = %vector.body904, %polly.loop_header710
  %polly.indvar_next708 = add nuw nsw i64 %polly.indvar707, 1
  %exitcond868.not = icmp eq i64 %polly.indvar707, %179
...
polly.loop_header710:                             ; preds = %polly.loop_header704, %polly.loop_header710
  ...
  %200 = add nuw nsw i64 %polly.indvar713, %182
  ...
  %scevgep716 = getelementptr i8, i8* %call, i64 %206
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar713, %183
...
polly.loop_header719:                             ; preds = %polly.loop_exit700, %polly.loop_exit727
  ...
  %207 = shl nsw i64 %polly.indvar722, 5
  %208 = add nsw i64 %smin857, 1199
...
polly.loop_header725:                             ; preds = %polly.loop_exit733, %polly.loop_header719
  ...
  %209 = mul nsw i64 %polly.indvar728, -32
  %smin920 = call i64 @llvm.smin.i64(i64 %209, i64 -968)
  %210 = add nsw i64 %smin920, 1000
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 -968)
  %211 = shl nsw i64 %polly.indvar728, 5
  %212 = add nsw i64 %smin853, 999
...
vector.body919:                                   ; preds = %vector.body919, %vector.ph922
  ...
  %216 = add nuw nsw <4 x i64> %vec.ind929, %broadcast.splat932
  %217 = trunc <4 x i64> %216 to <4 x i32>
  %218 = mul <4 x i32> %broadcast.splat934, %217
  ...
  %228 = icmp eq i64 %index.next926, %210
  br i1 %228, label %polly.loop_exit739, label %vector.body919, !llvm.loop !94

polly.loop_exit739:                               ; preds = %vector.body919, %polly.loop_header737
  %polly.indvar_next735 = add nuw nsw i64 %polly.indvar734, 1
  %exitcond858.not = icmp eq i64 %polly.indvar734, %208
...
polly.loop_header737:                             ; preds = %polly.loop_header731, %polly.loop_header737
  ...
  %229 = add nuw nsw i64 %polly.indvar740, %211
  ...
  %scevgep743 = getelementptr i8, i8* %call2, i64 %235
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar740, %212
...
polly.loop_header745:                             ; preds = %polly.loop_exit727, %polly.loop_exit753
  ...
  %236 = shl nsw i64 %polly.indvar748, 5
  %237 = add nsw i64 %smin847, 1199
...
polly.loop_header751:                             ; preds = %polly.loop_exit759, %polly.loop_header745
  ...
  %238 = mul nsw i64 %polly.indvar754, -32
  %smin938 = call i64 @llvm.smin.i64(i64 %238, i64 -968)
  %239 = add nsw i64 %smin938, 1000
  %smin843 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 -968)
  %240 = shl nsw i64 %polly.indvar754, 5
  %241 = add nsw i64 %smin843, 999
...
vector.body937:                                   ; preds = %vector.body937, %vector.ph940
  ...
  %245 = add nuw nsw <4 x i64> %vec.ind947, %broadcast.splat950
  %246 = trunc <4 x i64> %245 to <4 x i32>
  %247 = mul <4 x i32> %broadcast.splat952, %246
  ...
  %257 = icmp eq i64 %index.next944, %239
  br i1 %257, label %polly.loop_exit765, label %vector.body937, !llvm.loop !97

polly.loop_exit765:                               ; preds = %vector.body937, %polly.loop_header763
  %polly.indvar_next761 = add nuw nsw i64 %polly.indvar760, 1
  %exitcond848.not = icmp eq i64 %polly.indvar760, %237
...
polly.loop_header763:                             ; preds = %polly.loop_header757, %polly.loop_header763
  ...
  %258 = add nuw nsw i64 %polly.indvar766, %240
  ...
  %scevgep770 = getelementptr i8, i8* %call1, i64 %264
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar766, %241
