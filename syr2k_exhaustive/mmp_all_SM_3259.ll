; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3259.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3259.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %indvars.iv1001 = phi i64 [ 7, %polly.loop_header199.preheader ], [ %indvars.iv.next1002, %polly.loop_exit207 ]
  ...
  %polly.loop_guard = icmp slt i64 %101, 38
...
polly.loop_exit207:                               ; preds = %polly.loop_exit246, %polly.loop_header199
  ...
  %indvars.iv.next1002 = add nuw nsw i64 %indvars.iv1001, 3
  %indvars.iv.next1006 = add nuw nsw i64 %indvars.iv1005, 12
  %exitcond1013.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit399
  ...
  %indvars.iv1021 = phi i64 [ 7, %polly.loop_header389.preheader ], [ %indvars.iv.next1022, %polly.loop_exit399 ]
  ...
  %146 = and i64 %145, 9223372036854775776
  %147 = mul nuw nsw i64 %polly.indvar392, 3
  %148 = add nuw nsw i64 %147, 7
  %pexp.p_div_q395 = lshr i64 %148, 3
  %149 = sub nsw i64 %polly.indvar392, %pexp.p_div_q395
  %polly.loop_guard400 = icmp slt i64 %149, 38
...
polly.loop_header397.preheader:                   ; preds = %polly.loop_header389
  ...
  %152 = mul nsw i64 %polly.indvar392, -20
  %153 = mul nuw nsw i64 %polly.indvar392, 20
...
polly.loop_exit399:                               ; preds = %polly.loop_exit439, %polly.loop_header389
  ...
  %indvars.iv.next1020 = add nsw i64 %indvars.iv1019, -12
  %indvars.iv.next1022 = add nuw nsw i64 %indvars.iv1021, 3
  %indvars.iv.next1027 = add nuw nsw i64 %indvars.iv1026, 12
  %exitcond1035.not = icmp eq i64 %polly.indvar_next393, 60
...
polly.loop_header397:                             ; preds = %polly.loop_header397.preheader, %polly.loop_exit439
  ...
  %156 = shl nsw i64 %polly.indvar401, 5
  %157 = add nsw i64 %156, %152
  %158 = add nsw i64 %157, -1
  %.inv877 = icmp sgt i64 %157, 19
  %159 = select i1 %.inv877, i64 19, i64 %158
...
polly.loop_header437.preheader:                   ; preds = %polly.loop_exit425, %polly.loop_exit425.us, %polly.loop_header397.split
  ...
  %170 = mul nsw i64 %polly.indvar401, -32
...
polly.loop_header444:                             ; preds = %polly.loop_exit454, %polly.loop_header437
  ...
  %smin1032 = call i64 @llvm.smin.i64(i64 %indvars.iv1030, i64 19)
...
polly.loop_header582:                             ; preds = %polly.loop_header582.preheader, %polly.loop_exit592
  ...
  %indvars.iv1043 = phi i64 [ 7, %polly.loop_header582.preheader ], [ %indvars.iv.next1044, %polly.loop_exit592 ]
  ...
  %195 = mul nuw nsw i64 %polly.indvar585, 3
  %196 = add nuw nsw i64 %195, 7
  %pexp.p_div_q588 = lshr i64 %196, 3
  %197 = sub nsw i64 %polly.indvar585, %pexp.p_div_q588
  %polly.loop_guard593 = icmp slt i64 %197, 38
...
polly.loop_header590.preheader:                   ; preds = %polly.loop_header582
  ...
  %200 = mul nsw i64 %polly.indvar585, -20
  %201 = mul nuw nsw i64 %polly.indvar585, 20
...
polly.loop_exit592:                               ; preds = %polly.loop_exit632, %polly.loop_header582
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next586, 60
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit632
  ...
  %204 = shl nsw i64 %polly.indvar594, 5
  %205 = add nsw i64 %204, %200
  %206 = add nsw i64 %205, -1
  %.inv878 = icmp sgt i64 %205, 19
  %207 = select i1 %.inv878, i64 19, i64 %206
...
polly.loop_header630.preheader:                   ; preds = %polly.loop_exit618, %polly.loop_exit618.us, %polly.loop_header590.split
  ...
  %218 = mul nsw i64 %polly.indvar594, -32
