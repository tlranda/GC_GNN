; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4323.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4323.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond992.not = icmp eq i64 %polly.indvar_next203, 75
...
vector.body1193:                                  ; preds = %vector.body1193, %vector.ph1197
  ...
  %wide.load1204 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %129, label %middle.block1191, label %vector.body1193, !llvm.loop !80
...
polly.loop_header389:                             ; preds = %polly.loop_exit397, %polly.loop_header383
  ...
  %133 = mul nuw nsw i64 %polly.indvar392, 100
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %134 = shl nsw i64 %polly.indvar398, 2
  %135 = add nsw i64 %134, %131
  %136 = icmp sgt i64 %135, 0
  %137 = select i1 %136, i64 %135, i64 0
  %polly.loop_guard405 = icmp slt i64 %137, 16
...
vector.body1169:                                  ; preds = %vector.body1169, %vector.ph1171
  ...
  %wide.load1178 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %163, label %middle.block1167, label %vector.body1169, !llvm.loop !90
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %165 = mul nsw i64 %polly.indvar576, -16
  %166 = shl nsw i64 %polly.indvar576, 4
  br label %polly.loop_header579

polly.loop_exit581:                               ; preds = %polly.loop_exit587
  %polly.indvar_next577 = add nuw nsw i64 %polly.indvar576, 1
  %indvars.iv.next1022 = add nsw i64 %indvars.iv1021, -16
  %indvars.iv.next1027 = add nuw nsw i64 %indvars.iv1026, 16
  %indvars.iv.next1039 = add nuw nsw i64 %indvars.iv1038, 4
  %exitcond1042.not = icmp eq i64 %polly.indvar_next577, 75
...
polly.loop_header579:                             ; preds = %polly.loop_exit587, %polly.loop_header573
  ...
  %167 = mul nuw nsw i64 %polly.indvar582, 100
  br label %polly.loop_header585

polly.loop_exit587:                               ; preds = %polly.loop_exit594
  %polly.indvar_next583 = add nuw nsw i64 %polly.indvar582, 1
  %exitcond1041.not = icmp eq i64 %polly.indvar_next583, 10
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %168 = shl nsw i64 %polly.indvar588, 2
  %169 = add nsw i64 %168, %165
  %170 = icmp sgt i64 %169, 0
  %171 = select i1 %170, i64 %169, i64 0
  %polly.loop_guard595 = icmp slt i64 %171, 16
...
polly.merge618.us:                                ; preds = %polly.then619.us, %polly.cond617.loopexit.us
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next603.us, 100
...
polly.loop_header599:                             ; preds = %polly.loop_header592.split, %polly.loop_header599
  ...
  %exitcond1020.not = icmp eq i64 %polly.indvar_next603, 100
...
polly.loop_exit637.loopexit.us:                   ; preds = %polly.loop_header635.us
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar_next632.us, 100
...
vector.body1108:                                  ; preds = %vector.body1108, %vector.ph1109
  ...
  br i1 %211, label %polly.loop_exit805, label %vector.body1108, !llvm.loop !99
...
vector.body1122:                                  ; preds = %vector.body1122, %vector.ph1125
  ...
  br i1 %240, label %polly.loop_exit832, label %vector.body1122, !llvm.loop !102
...
vector.body1140:                                  ; preds = %vector.body1140, %vector.ph1143
  ...
  br i1 %269, label %polly.loop_exit858, label %vector.body1140, !llvm.loop !105
