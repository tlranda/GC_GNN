; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10376.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10376.c"
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %131, label %middle.block999, label %vector.body1001, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %133 = udiv i64 %indvars.iv820, 25
  %134 = sub nsw i64 %indvars.iv818, %133
  %smin822 = call i64 @llvm.smin.i64(i64 %134, i64 21)
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next364, 10
...
polly.loop_exit390.loopexit.us:                   ; preds = %polly.loop_header388.us
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar_next385.us, 100
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %wide.load986 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %167, label %middle.block975, label %vector.body977, !llvm.loop !83
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %169 = udiv i64 %indvars.iv844, 25
  %170 = sub nsw i64 %indvars.iv842, %169
  %smin846 = call i64 @llvm.smin.i64(i64 %170, i64 21)
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond841.not = icmp eq i64 %polly.indvar_next543.us, 100
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  br i1 %217, label %polly.loop_exit714, label %vector.body915, !llvm.loop !92
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %246, label %polly.loop_exit741, label %vector.body930, !llvm.loop !95
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  br i1 %275, label %polly.loop_exit767, label %vector.body948, !llvm.loop !98
