; ModuleID = 'syr2k_exhaustive/mmp_all_XL_118.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_118.c"
...
polly.loop_header259.preheader:                   ; preds = %polly.loop_exit247, %polly.loop_exit247.us
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv943, i64 99)
  %121 = mul nsw i64 %polly.indvar225, 38400
  %indvars.iv.next946 = or i64 %indvars.iv943, 1
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next946, i64 99)
  %122 = or i64 %112, 1
  %123 = or i64 %111, 1
  %124 = mul nuw nsw i64 %123, 9600
  %indvars.iv.next946.1 = add nuw nsw i64 %indvars.iv.next946, 1
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next946.1, i64 99)
  %125 = or i64 %112, 2
  %126 = or i64 %111, 2
...
polly.loop_exit410:                               ; preds = %polly.loop_exit416
  %178 = mul nsw i64 %polly.indvar405, -100
  %179 = mul nuw nsw i64 %polly.indvar405, 25
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit465
  %polly.indvar_next406 = add nuw nsw i64 %polly.indvar405, 1
  %indvars.iv.next955 = add nsw i64 %indvars.iv954, -100
  %exitcond970.not = icmp eq i64 %polly.indvar_next406, 12
...
polly.loop_header463.preheader:                   ; preds = %polly.loop_exit451, %polly.loop_exit451.us
  %smin965 = call i64 @llvm.smin.i64(i64 %indvars.iv961, i64 99)
  %201 = mul nsw i64 %polly.indvar427, 38400
  %indvars.iv.next964 = or i64 %indvars.iv961, 1
  %smin965.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next964, i64 99)
  %202 = or i64 %192, 1
  %203 = or i64 %191, 1
  %204 = mul nuw nsw i64 %203, 9600
  %indvars.iv.next964.1 = add nuw nsw i64 %indvars.iv.next964, 1
  %smin965.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next964.1, i64 99)
  %205 = or i64 %192, 2
  %206 = or i64 %191, 2
...
polly.loop_header606:                             ; preds = %polly.loop_header606.preheader, %polly.loop_exit630
  ...
  %257 = mul nuw nsw i64 %polly.indvar609, 100
  br label %polly.loop_header612

polly.loop_exit614:                               ; preds = %polly.loop_exit620
  %258 = mul nsw i64 %polly.indvar609, -100
  %259 = mul nuw nsw i64 %polly.indvar609, 25
...
polly.loop_exit630:                               ; preds = %polly.loop_exit669
  ...
  %indvars.iv.next974 = add nsw i64 %indvars.iv973, -100
  %exitcond989.not = icmp eq i64 %polly.indvar_next610, 12
...
polly.loop_header667.preheader:                   ; preds = %polly.loop_exit655, %polly.loop_exit655.us
  ...
  %smin984.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next983, i64 99)
  %282 = or i64 %272, 1
  %283 = or i64 %271, 1
  %284 = mul nuw nsw i64 %283, 9600
  %indvars.iv.next983.1 = add nuw nsw i64 %indvars.iv.next983, 1
  %smin984.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next983.1, i64 99)
  %285 = or i64 %272, 2
  %286 = or i64 %271, 2
