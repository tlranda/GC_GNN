; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2142.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2142.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %smin1060 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -920)
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %116 = mul nsw i64 %polly.indvar231, 100
...
polly.loop_exit237:                               ; preds = %polly.loop_exit269, %polly.loop_header228
  ...
  %indvars.iv.next1051 = add i64 %indvars.iv1050, -100
...
polly.loop_header235:                             ; preds = %polly.loop_header235.preheader, %polly.loop_exit269
  ...
  %smin1365 = call i64 @llvm.smin.i64(i64 %123, i64 99)
  %124 = add nsw i64 %smin1365, 1
  %smin1058 = call i64 @llvm.smin.i64(i64 %indvars.iv1052, i64 99)
...
polly.loop_header422:                             ; preds = %polly.loop_exit414, %polly.loop_exit430
  ...
  %162 = mul nsw i64 %polly.indvar425, -64
  %163 = shl nuw nsw i64 %polly.indvar425, 6
  ...
  %.inv932 = icmp slt i64 %166, 11
  %168 = select i1 %.inv932, i64 %167, i64 11
  %polly.loop_guard439 = icmp sgt i64 %168, -1
  %169 = mul nsw i64 %polly.indvar425, -64
  %170 = icmp slt i64 %169, -1136
  %171 = select i1 %170, i64 %169, i64 -1136
  %172 = add nsw i64 %171, 1199
  %173 = shl nsw i64 %polly.indvar425, 6
...
polly.loop_header428:                             ; preds = %polly.loop_exit438, %polly.loop_header422
  ...
  %smin1090 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 -920)
...
polly.loop_header436.preheader:                   ; preds = %polly.loop_header428
  %175 = mul nuw nsw i64 %polly.indvar431, 80
...
polly.loop_exit438:                               ; preds = %polly.loop_exit446, %polly.loop_header428
  ...
  %exitcond1093.not = icmp eq i64 %polly.indvar_next432, 13
...
polly.loop_header436:                             ; preds = %polly.loop_header436.preheader, %polly.loop_exit446
  ...
  %178 = mul i64 %polly.indvar440, -100
  %179 = add i64 %163, %178
  %180 = add i64 %smax1314, %179
  %181 = mul nsw i64 %polly.indvar440, 100
...
polly.loop_exit446:                               ; preds = %polly.loop_exit482, %polly.loop_header436
  ...
  %indvars.iv.next1081 = add i64 %indvars.iv1080, -100
...
polly.loop_header444:                             ; preds = %polly.loop_header444.preheader, %polly.loop_exit482
  ...
  %smin1317 = call i64 @llvm.smin.i64(i64 %188, i64 99)
  %189 = add nsw i64 %smin1317, 1
  %smin1088 = call i64 @llvm.smin.i64(i64 %indvars.iv1082, i64 99)
...
polly.loop_header635:                             ; preds = %polly.loop_exit627, %polly.loop_exit643
  ...
  %227 = mul nsw i64 %polly.indvar638, -64
  %228 = shl nuw nsw i64 %polly.indvar638, 6
  ...
  %.inv934 = icmp slt i64 %231, 11
  %233 = select i1 %.inv934, i64 %232, i64 11
  %polly.loop_guard652 = icmp sgt i64 %233, -1
  %234 = mul nsw i64 %polly.indvar638, -64
  %235 = icmp slt i64 %234, -1136
  %236 = select i1 %235, i64 %234, i64 -1136
  %237 = add nsw i64 %236, 1199
  %238 = shl nsw i64 %polly.indvar638, 6
...
polly.loop_header641:                             ; preds = %polly.loop_exit651, %polly.loop_header635
  ...
  %smin1120 = call i64 @llvm.smin.i64(i64 %indvars.iv1099, i64 -920)
...
polly.loop_header649.preheader:                   ; preds = %polly.loop_header641
  %240 = mul nuw nsw i64 %polly.indvar644, 80
...
polly.loop_exit651:                               ; preds = %polly.loop_exit659, %polly.loop_header641
  ...
  %exitcond1123.not = icmp eq i64 %polly.indvar_next645, 13
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit659
  ...
  %241 = mul i64 %polly.indvar653, 100
  %242 = add i64 %227, %241
  %smax1266 = call i64 @llvm.smax.i64(i64 %242, i64 0)
  %243 = mul i64 %polly.indvar653, -100
  %244 = add i64 %228, %243
  %245 = add i64 %smax1266, %244
  %246 = mul nsw i64 %polly.indvar653, 100
...
polly.loop_exit659:                               ; preds = %polly.loop_exit695, %polly.loop_header649
  ...
  %indvars.iv.next1106 = add i64 %indvars.iv1105, 100
  %indvars.iv.next1111 = add i64 %indvars.iv1110, -100
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit695
  ...
  %smin1269 = call i64 @llvm.smin.i64(i64 %253, i64 99)
  %254 = add nsw i64 %smin1269, 1
  %smin1118 = call i64 @llvm.smin.i64(i64 %indvars.iv1112, i64 99)
