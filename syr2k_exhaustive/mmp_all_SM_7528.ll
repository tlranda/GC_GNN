; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7528.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7528.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv849 = phi i64 [ %indvars.iv.next850, %polly.loop_exit223 ], [ 3, %polly.loop_exit207 ]
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %103 = shl nsw i64 %polly.indvar230, 5
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next231, %98
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 31)
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv875 = phi i64 [ %indvars.iv.next876, %polly.loop_exit398 ], [ 3, %polly.loop_exit382 ]
  ...
  %130 = lshr i64 %polly.indvar393, 1
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %136 = shl nsw i64 %polly.indvar406, 5
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar_next407, %131
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  ...
  %smin869 = call i64 @llvm.smin.i64(i64 %indvars.iv867, i64 31)
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv901 = phi i64 [ %indvars.iv.next902, %polly.loop_exit576 ], [ 3, %polly.loop_exit560 ]
  ...
  %163 = lshr i64 %polly.indvar571, 1
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %169 = shl nsw i64 %polly.indvar584, 5
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar_next585, %164
