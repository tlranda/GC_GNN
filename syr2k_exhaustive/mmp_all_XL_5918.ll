; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5918.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5918.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %109 = mul nsw i64 %polly.indvar224, -32
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %indvars.iv.next839 = add i64 %indvars.iv838, -32
  %indvars.iv.next843 = add i64 %indvars.iv842, 32
  %exitcond848.not = icmp eq i64 %polly.indvar_next225, 38
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  ...
  %139 = shl nsw i64 %polly.indvar396, 5
  %140 = sub nsw i64 %135, %139
  %141 = icmp sgt i64 %140, 0
  %142 = select i1 %141, i64 %140, i64 0
  %143 = mul nsw i64 %polly.indvar396, -32
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408, %polly.loop_header393
  ...
  %indvars.iv.next864 = add i64 %indvars.iv863, 32
  %exitcond870.not = icmp eq i64 %polly.indvar_next397, 38
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  ...
  %173 = shl nsw i64 %polly.indvar570, 5
  %174 = sub nsw i64 %169, %173
  %175 = icmp sgt i64 %174, 0
  %176 = select i1 %175, i64 %174, i64 0
  %177 = mul nsw i64 %polly.indvar570, -32
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582, %polly.loop_header567
  ...
  %exitcond892.not = icmp eq i64 %polly.indvar_next571, 38
