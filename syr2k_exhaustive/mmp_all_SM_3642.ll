; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3642.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3642.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1028.not = icmp eq i64 %119, 150
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %121 = mul nuw nsw i64 %polly.indvar214, 12
...
polly.loop_header253:                             ; preds = %polly.loop_header246, %polly.loop_exit263
  %indvars.iv1024 = phi i64 [ %120, %polly.loop_header246 ], [ %indvars.iv.next1025, %polly.loop_exit263 ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %168 = udiv i64 %polly.indvar398, 12
  %169 = mul nuw nsw i64 %168, 96
  %170 = sub nsw i64 %indvars.iv1035, %169
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1049.not = icmp eq i64 %182, 150
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit445 ], [ %171, %polly.loop_header395 ]
  %indvars.iv1037 = phi i64 [ %indvars.iv.next1038, %polly.loop_exit445 ], [ %170, %polly.loop_header395 ]
  ...
  %183 = add i64 %smax1039, %indvars.iv1042
  %184 = mul nuw nsw i64 %polly.indvar405, 12
  %.not.not885 = icmp ugt i64 %184, %polly.indvar398
  %185 = mul nuw nsw i64 %polly.indvar405, 96
  %186 = add nsw i64 %185, %173
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %189 = add nsw i64 %186, 95
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_header429.7, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %197 = mul nsw i64 %polly.indvar405, -96
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1044 = phi i64 [ %183, %polly.loop_header443 ], [ %indvars.iv.next1045, %polly.loop_exit460 ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %231 = udiv i64 %polly.indvar595, 12
  %232 = mul nuw nsw i64 %231, 96
  %233 = sub nsw i64 %indvars.iv1056, %232
  %234 = add i64 %indvars.iv1061, %232
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1063 = phi i64 [ %indvars.iv.next1064, %polly.loop_exit642 ], [ %234, %polly.loop_header592 ]
  %indvars.iv1058 = phi i64 [ %indvars.iv.next1059, %polly.loop_exit642 ], [ %233, %polly.loop_header592 ]
  ...
  %246 = add i64 %smax1060, %indvars.iv1063
  %247 = mul nuw nsw i64 %polly.indvar602, 12
  %.not.not886 = icmp ugt i64 %247, %polly.indvar595
  %248 = mul nuw nsw i64 %polly.indvar602, 96
  %249 = add nsw i64 %248, %236
  %250 = icmp sgt i64 %249, 0
  %251 = select i1 %250, i64 %249, i64 0
  %252 = add nsw i64 %249, 95
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_header626.7, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %260 = mul nsw i64 %polly.indvar602, -96
  %261 = icmp slt i64 %260, -1104
  %262 = select i1 %261, i64 %260, i64 -1104
...
polly.loop_header647:                             ; preds = %polly.loop_header640, %polly.loop_exit657
  %indvars.iv1065 = phi i64 [ %246, %polly.loop_header640 ], [ %indvars.iv.next1066, %polly.loop_exit657 ]
