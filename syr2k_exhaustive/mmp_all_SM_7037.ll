; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7037.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7037.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %115 = mul nuw nsw i64 %polly.indvar230, 100
...
vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1022
  ...
  %wide.load1029 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %135, label %middle.block1016, label %vector.body1018, !llvm.loop !80
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %137 = udiv i64 %polly.indvar391, 5
  %138 = mul nuw nsw i64 %polly.indvar391, 20
...
polly.loop_header401:                             ; preds = %polly.loop_exit409, %polly.loop_header394
  ...
  %155 = mul nuw nsw i64 %polly.indvar404, 100
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %175, label %middle.block992, label %vector.body994, !llvm.loop !90
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit572
  ...
  %177 = udiv i64 %polly.indvar567, 5
  %178 = mul nuw nsw i64 %polly.indvar567, 20
...
polly.loop_header577:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %195 = mul nuw nsw i64 %polly.indvar580, 100
...
vector.body932:                                   ; preds = %vector.body932, %vector.ph934
  ...
  br i1 %229, label %polly.loop_exit766, label %vector.body932, !llvm.loop !99
...
vector.body947:                                   ; preds = %vector.body947, %vector.ph950
  ...
  br i1 %258, label %polly.loop_exit793, label %vector.body947, !llvm.loop !102
...
vector.body965:                                   ; preds = %vector.body965, %vector.ph968
  ...
  br i1 %287, label %polly.loop_exit819, label %vector.body965, !llvm.loop !105
