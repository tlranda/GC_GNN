; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10206.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10206.c"
...
polly.loop_header205.us:                          ; preds = %polly.loop_header199, %polly.loop_exit213.loopexit.us
  ...
  %103 = mul nuw nsw i64 %polly.indvar208.us, 20
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %104 = shl nsw i64 %polly.indvar214.us, 7
...
polly.loop_exit213.loopexit.us:                   ; preds = %polly.loop_exit220.us
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next209.us, 50
...
vector.body1106:                                  ; preds = %vector.body1106, %vector.ph1110
  ...
  %wide.load1117 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %129, label %middle.block1104, label %vector.body1106, !llvm.loop !74
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %135 = mul nsw i64 %polly.indvar359, -80
  %136 = mul nuw nsw i64 %polly.indvar359, 80
...
polly.loop_header362.us:                          ; preds = %polly.loop_header356, %polly.loop_exit372.loopexit.us
  ...
  %137 = mul nuw nsw i64 %polly.indvar365.us, 20
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %138 = shl nsw i64 %polly.indvar374.us, 7
...
polly.loop_exit372.loopexit.us:                   ; preds = %polly.loop_exit380.us
  ...
  %exitcond930.not = icmp eq i64 %polly.indvar_next366.us, 50
...
polly.loop_exit394.loopexit.us.us:                ; preds = %polly.loop_header392.us.us
  ...
  %exitcond924.not = icmp eq i64 %polly.indvar_next389.us.us, 20
...
vector.body1082:                                  ; preds = %vector.body1082, %vector.ph1084
  ...
  %wide.load1091 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %163, label %middle.block1080, label %vector.body1082, !llvm.loop !83
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %169 = mul nsw i64 %polly.indvar519, -80
  %170 = mul nuw nsw i64 %polly.indvar519, 80
...
polly.loop_header522.us:                          ; preds = %polly.loop_header516, %polly.loop_exit532.loopexit.us
  ...
  %171 = mul nuw nsw i64 %polly.indvar525.us, 20
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %172 = shl nsw i64 %polly.indvar534.us, 7
...
polly.loop_exit532.loopexit.us:                   ; preds = %polly.loop_exit540.us
  ...
  %exitcond953.not = icmp eq i64 %polly.indvar_next526.us, 50
...
polly.loop_exit554.loopexit.us.us:                ; preds = %polly.loop_header552.us.us
  ...
  %exitcond947.not = icmp eq i64 %polly.indvar_next549.us.us, 20
...
vector.body1020:                                  ; preds = %vector.body1020, %vector.ph1022
  ...
  br i1 %211, label %polly.loop_exit720, label %vector.body1020, !llvm.loop !92
...
vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1038
  ...
  br i1 %240, label %polly.loop_exit747, label %vector.body1035, !llvm.loop !95
...
vector.body1053:                                  ; preds = %vector.body1053, %vector.ph1056
  ...
  br i1 %269, label %polly.loop_exit773, label %vector.body1053, !llvm.loop !98
