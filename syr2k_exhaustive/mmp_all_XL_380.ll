; ModuleID = 'syr2k_exhaustive/mmp_all_XL_380.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_380.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %114 = shl nuw nsw i64 %polly.indvar209, 6
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit220.7
  ...
  %130 = mul nsw i64 %indvar1420, -20
  %131 = add i64 %110, %130
  %smax1439 = call i64 @llvm.smax.i64(i64 %131, i64 0)
  %132 = mul nuw nsw i64 %indvar1420, 20
  %133 = add i64 %112, %132
  %134 = add i64 %smax1439, %133
  %135 = mul nsw i64 %indvar1420, -20
  %136 = add i64 %119, %135
  %smax1422 = call i64 @llvm.smax.i64(i64 %136, i64 0)
  %137 = mul nuw nsw i64 %indvar1420, 20
  %138 = add i64 %118, %137
  ...
  %146 = mul nuw nsw i64 %polly.indvar231, 20
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_header251.7, %polly.loop_header251.us.7, %polly.loop_exit242.loopexit.us.7, %polly.loop_header228.split
  ...
  %polly.loop_guard275 = icmp slt i64 %157, 20
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  ...
  %smin1440 = call i64 @llvm.smin.i64(i64 %160, i64 63)
  ...
  %smin1427 = call i64 @llvm.smin.i64(i64 %165, i64 63)
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %208 = shl nuw nsw i64 %polly.indvar421, 6
  %209 = mul nuw nsw i64 %polly.indvar421, 3
  %210 = udiv i64 %polly.indvar421, 5
  %211 = add nuw i64 %209, %210
  %212 = mul nuw nsw i64 %211, 20
  %213 = sub i64 %208, %212
  %214 = mul nsw i64 %polly.indvar421, -64
  %215 = add i64 %214, %212
  %216 = shl nuw nsw i64 %polly.indvar421, 9
  %217 = shl nuw nsw i64 %polly.indvar421, 6
  %218 = mul nuw nsw i64 %polly.indvar421, 3
  %219 = udiv i64 %polly.indvar421, 5
  %220 = add nuw i64 %218, %219
  %221 = mul nuw nsw i64 %220, 20
  %222 = sub i64 %217, %221
  %223 = or i64 %216, 8
  %224 = mul nsw i64 %polly.indvar421, -64
  %225 = add i64 %224, %221
  %226 = udiv i64 %polly.indvar421, 5
  %227 = add nuw i64 %indvars.iv1113, %226
  %228 = mul nuw nsw i64 %227, 20
  %229 = sub i64 %indvars.iv1111, %228
  %230 = add i64 %indvars.iv1118, %228
  %231 = shl nsw i64 %polly.indvar421, 6
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit432.7
  ...
  %233 = mul nsw i64 %indvar1357, -20
  %234 = add i64 %213, %233
  %smax1376 = call i64 @llvm.smax.i64(i64 %234, i64 0)
  %235 = mul nuw nsw i64 %indvar1357, 20
  %236 = add i64 %215, %235
  %237 = add i64 %smax1376, %236
  %238 = mul nsw i64 %indvar1357, -20
  %239 = add i64 %222, %238
  %smax1359 = call i64 @llvm.smax.i64(i64 %239, i64 0)
  %240 = mul nuw nsw i64 %indvar1357, 20
  %241 = add i64 %221, %240
  ...
  %249 = mul nuw nsw i64 %polly.indvar444, 20
  %250 = add nsw i64 %249, %522
  %251 = add nsw i64 %250, -1
  %.inv942 = icmp sgt i64 %250, 63
  %252 = select i1 %.inv942, i64 63, i64 %251
  %polly.loop_guard457 = icmp sgt i64 %252, -1
  %253 = icmp sgt i64 %250, 0
  %254 = select i1 %253, i64 %250, i64 0
  %255 = add nsw i64 %250, 19
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_header466.7, %polly.loop_header466.us.7, %polly.loop_exit456.loopexit.us.7, %polly.loop_header441.split
  ...
  %polly.loop_guard490 = icmp slt i64 %260, 20
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1377 = call i64 @llvm.smin.i64(i64 %263, i64 63)
  ...
  %smin1364 = call i64 @llvm.smin.i64(i64 %268, i64 63)
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %311 = shl nuw nsw i64 %polly.indvar636, 6
  %312 = mul nuw nsw i64 %polly.indvar636, 3
  %313 = udiv i64 %polly.indvar636, 5
  %314 = add nuw i64 %312, %313
  %315 = mul nuw nsw i64 %314, 20
  %316 = sub i64 %311, %315
  %317 = mul nsw i64 %polly.indvar636, -64
  %318 = add i64 %317, %315
  %319 = shl nuw nsw i64 %polly.indvar636, 9
  %320 = shl nuw nsw i64 %polly.indvar636, 6
  %321 = mul nuw nsw i64 %polly.indvar636, 3
  %322 = udiv i64 %polly.indvar636, 5
  %323 = add nuw i64 %321, %322
  %324 = mul nuw nsw i64 %323, 20
  %325 = sub i64 %320, %324
  %326 = or i64 %319, 8
  %327 = mul nsw i64 %polly.indvar636, -64
  %328 = add i64 %327, %324
  %329 = udiv i64 %polly.indvar636, 5
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit647.7
  ...
  %336 = mul nsw i64 %indvar1294, -20
  %337 = add i64 %316, %336
  %smax1313 = call i64 @llvm.smax.i64(i64 %337, i64 0)
  %338 = mul nuw nsw i64 %indvar1294, 20
  %339 = add i64 %318, %338
  %340 = add i64 %smax1313, %339
  %341 = mul nsw i64 %indvar1294, -20
  %342 = add i64 %325, %341
  %smax1296 = call i64 @llvm.smax.i64(i64 %342, i64 0)
  %343 = mul nuw nsw i64 %indvar1294, 20
  %344 = add i64 %324, %343
  ...
  %352 = mul nuw nsw i64 %polly.indvar659, 20
  %353 = add nsw i64 %352, %553
  %354 = add nsw i64 %353, -1
  %.inv943 = icmp sgt i64 %353, 63
  %355 = select i1 %.inv943, i64 63, i64 %354
  %polly.loop_guard672 = icmp sgt i64 %355, -1
  %356 = icmp sgt i64 %353, 0
  %357 = select i1 %356, i64 %353, i64 0
  %358 = add nsw i64 %353, 19
...
polly.loop_header695.preheader:                   ; preds = %polly.loop_header681.7, %polly.loop_header681.us.7, %polly.loop_exit671.loopexit.us.7, %polly.loop_header656.split
  ...
  %polly.loop_guard705 = icmp slt i64 %363, 20
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  ...
  %smin1314 = call i64 @llvm.smin.i64(i64 %366, i64 63)
  ...
  %smin1301 = call i64 @llvm.smin.i64(i64 %371, i64 63)
...
polly.loop_exit220.7:                             ; preds = %polly.loop_header218.7
  %491 = mul nsw i64 %polly.indvar209, -64
  %492 = mul nuw nsw i64 %polly.indvar209, 3
...
polly.loop_exit432.7:                             ; preds = %polly.loop_header430.7
  %522 = mul nsw i64 %polly.indvar421, -64
  %523 = mul nuw nsw i64 %polly.indvar421, 3
...
polly.loop_exit647.7:                             ; preds = %polly.loop_header645.7
  %553 = mul nsw i64 %polly.indvar636, -64
  %554 = mul nuw nsw i64 %polly.indvar636, 3
