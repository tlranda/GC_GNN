; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8248.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8248.c"
...
polly.loop_header223:                             ; preds = %polly.loop_exit231, %polly.loop_header211
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv770, i64 127)
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %148 = shl nuw nsw i64 %polly.indvar361, 3
  %149 = shl nsw i64 %polly.indvar361, 7
  br label %polly.loop_header364

polly.loop_exit366:                               ; preds = %polly.loop_exit378.7
  %polly.indvar_next362 = add nuw nsw i64 %polly.indvar361, 1
  %exitcond788.not = icmp eq i64 %polly.indvar_next362, 10
...
polly.loop_header364:                             ; preds = %polly.loop_exit378.7, %polly.loop_header358
  ...
  %150 = shl nsw i64 %polly.indvar367, 4
...
polly.loop_header376:                             ; preds = %polly.loop_exit384, %polly.loop_header364
  ...
  %smin783 = call i64 @llvm.smin.i64(i64 %indvars.iv781, i64 127)
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %184 = shl nuw nsw i64 %polly.indvar514, 3
  %185 = shl nsw i64 %polly.indvar514, 7
...
polly.loop_exit519:                               ; preds = %polly.loop_exit531.7
  ...
  %exitcond801.not = icmp eq i64 %polly.indvar_next515, 10
...
polly.loop_header517:                             ; preds = %polly.loop_exit531.7, %polly.loop_header511
  ...
  %186 = shl nsw i64 %polly.indvar520, 4
...
polly.loop_header529:                             ; preds = %polly.loop_exit537, %polly.loop_header517
  ...
  %smin796 = call i64 @llvm.smin.i64(i64 %indvars.iv794, i64 127)
...
polly.loop_header223.1:                           ; preds = %polly.loop_exit231, %polly.loop_exit231.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv770.1, i64 127)
...
polly.loop_header223.2:                           ; preds = %polly.loop_exit231.1, %polly.loop_exit231.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv770.2, i64 127)
...
polly.loop_header223.3:                           ; preds = %polly.loop_exit231.2, %polly.loop_exit231.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv770.3, i64 127)
...
polly.loop_header223.4:                           ; preds = %polly.loop_exit231.3, %polly.loop_exit231.4
  ...
  %smin.4 = call i64 @llvm.smin.i64(i64 %indvars.iv770.4, i64 127)
...
polly.loop_header223.5:                           ; preds = %polly.loop_exit231.4, %polly.loop_exit231.5
  ...
  %smin.5 = call i64 @llvm.smin.i64(i64 %indvars.iv770.5, i64 127)
...
polly.loop_exit231.5:                             ; preds = %polly.loop_header229.5
  ...
  %exitcond772.5.not = icmp eq i64 %polly.indvar_next227.5, 16
...
polly.loop_header223.6:                           ; preds = %polly.loop_exit231.5, %polly.loop_exit231.6
  ...
  %smin.6 = call i64 @llvm.smin.i64(i64 %indvars.iv770.6, i64 127)
...
polly.loop_exit231.6:                             ; preds = %polly.loop_header229.6
  ...
  %exitcond772.6.not = icmp eq i64 %polly.indvar_next227.6, 16
...
polly.loop_header223.7:                           ; preds = %polly.loop_exit231.6, %polly.loop_exit231.7
  ...
  %smin.7 = call i64 @llvm.smin.i64(i64 %indvars.iv770.7, i64 127)
...
polly.loop_exit231.7:                             ; preds = %polly.loop_header229.7
  ...
  %exitcond772.7.not = icmp eq i64 %polly.indvar_next227.7, 16
...
polly.loop_header376.1:                           ; preds = %polly.loop_exit384, %polly.loop_exit384.1
  ...
  %smin783.1 = call i64 @llvm.smin.i64(i64 %indvars.iv781.1, i64 127)
...
polly.loop_header376.2:                           ; preds = %polly.loop_exit384.1, %polly.loop_exit384.2
  ...
  %smin783.2 = call i64 @llvm.smin.i64(i64 %indvars.iv781.2, i64 127)
...
polly.loop_header376.3:                           ; preds = %polly.loop_exit384.2, %polly.loop_exit384.3
  ...
  %smin783.3 = call i64 @llvm.smin.i64(i64 %indvars.iv781.3, i64 127)
...
polly.loop_header376.4:                           ; preds = %polly.loop_exit384.3, %polly.loop_exit384.4
  ...
  %smin783.4 = call i64 @llvm.smin.i64(i64 %indvars.iv781.4, i64 127)
...
polly.loop_header376.5:                           ; preds = %polly.loop_exit384.4, %polly.loop_exit384.5
  ...
  %smin783.5 = call i64 @llvm.smin.i64(i64 %indvars.iv781.5, i64 127)
...
polly.loop_exit384.5:                             ; preds = %polly.loop_header382.5
  ...
  %exitcond785.5.not = icmp eq i64 %polly.indvar_next380.5, 16
...
polly.loop_header376.6:                           ; preds = %polly.loop_exit384.5, %polly.loop_exit384.6
  ...
  %smin783.6 = call i64 @llvm.smin.i64(i64 %indvars.iv781.6, i64 127)
...
polly.loop_exit384.6:                             ; preds = %polly.loop_header382.6
  ...
  %exitcond785.6.not = icmp eq i64 %polly.indvar_next380.6, 16
...
polly.loop_header376.7:                           ; preds = %polly.loop_exit384.6, %polly.loop_exit384.7
  ...
  %smin783.7 = call i64 @llvm.smin.i64(i64 %indvars.iv781.7, i64 127)
...
polly.loop_exit384.7:                             ; preds = %polly.loop_header382.7
  ...
  %exitcond785.7.not = icmp eq i64 %polly.indvar_next380.7, 16
...
polly.loop_header529.1:                           ; preds = %polly.loop_exit537, %polly.loop_exit537.1
  ...
  %smin796.1 = call i64 @llvm.smin.i64(i64 %indvars.iv794.1, i64 127)
...
polly.loop_header529.2:                           ; preds = %polly.loop_exit537.1, %polly.loop_exit537.2
  ...
  %smin796.2 = call i64 @llvm.smin.i64(i64 %indvars.iv794.2, i64 127)
...
polly.loop_header529.3:                           ; preds = %polly.loop_exit537.2, %polly.loop_exit537.3
  ...
  %smin796.3 = call i64 @llvm.smin.i64(i64 %indvars.iv794.3, i64 127)
...
polly.loop_header529.4:                           ; preds = %polly.loop_exit537.3, %polly.loop_exit537.4
  ...
  %smin796.4 = call i64 @llvm.smin.i64(i64 %indvars.iv794.4, i64 127)
...
polly.loop_header529.5:                           ; preds = %polly.loop_exit537.4, %polly.loop_exit537.5
  ...
  %smin796.5 = call i64 @llvm.smin.i64(i64 %indvars.iv794.5, i64 127)
...
polly.loop_exit537.5:                             ; preds = %polly.loop_header535.5
  ...
  %exitcond798.5.not = icmp eq i64 %polly.indvar_next533.5, 16
...
polly.loop_header529.6:                           ; preds = %polly.loop_exit537.5, %polly.loop_exit537.6
  ...
  %smin796.6 = call i64 @llvm.smin.i64(i64 %indvars.iv794.6, i64 127)
...
polly.loop_exit537.6:                             ; preds = %polly.loop_header535.6
  ...
  %exitcond798.6.not = icmp eq i64 %polly.indvar_next533.6, 16
...
polly.loop_header529.7:                           ; preds = %polly.loop_exit537.6, %polly.loop_exit537.7
  ...
  %smin796.7 = call i64 @llvm.smin.i64(i64 %indvars.iv794.7, i64 127)
...
polly.loop_exit537.7:                             ; preds = %polly.loop_header535.7
  ...
  %exitcond798.7.not = icmp eq i64 %polly.indvar_next533.7, 16
