; ModuleID = 'syr2k_exhaustive/mmp_all_SM_861.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_861.c"
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1107.not = icmp eq i64 %124, 60
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit220.7
  ...
  %126 = mul nsw i64 %indvar1425, -80
  %127 = add i64 %108, %126
  %smax1444 = call i64 @llvm.smax.i64(i64 %127, i64 0)
  %128 = mul nuw nsw i64 %indvar1425, 80
  %129 = add i64 %110, %128
  %130 = add i64 %smax1444, %129
  %131 = mul nsw i64 %indvar1425, -80
  %132 = add i64 %115, %131
  %smax1427 = call i64 @llvm.smax.i64(i64 %132, i64 0)
  %133 = mul nuw nsw i64 %indvar1425, 80
  %134 = add i64 %114, %133
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_header250.7, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %polly.loop_guard273 = icmp slt i64 %152, 80
...
polly.loop_header270.us:                          ; preds = %polly.loop_header263.us, %polly.loop_exit280.us
  ...
  %smin1445 = call i64 @llvm.smin.i64(i64 %155, i64 19)
  ...
  %smin1432 = call i64 @llvm.smin.i64(i64 %160, i64 19)
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %204 = lshr i64 %polly.indvar419, 2
  %205 = mul nuw nsw i64 %204, 80
  ...
  %211 = lshr i64 %polly.indvar419, 2
  %212 = mul nuw nsw i64 %211, 80
  %213 = sub nsw i64 %210, %212
  %214 = or i64 %209, 8
  %215 = mul nsw i64 %polly.indvar419, -20
  %216 = add i64 %215, %212
  %217 = lshr i64 %polly.indvar419, 2
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %exitcond1133.not = icmp eq i64 %222, 60
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit430.7
  ...
  %224 = mul nsw i64 %indvar1362, -80
  %225 = add i64 %206, %224
  %smax1381 = call i64 @llvm.smax.i64(i64 %225, i64 0)
  %226 = mul nuw nsw i64 %indvar1362, 80
  %227 = add i64 %208, %226
  %228 = add i64 %smax1381, %227
  %229 = mul nsw i64 %indvar1362, -80
  %230 = add i64 %213, %229
  %smax1364 = call i64 @llvm.smax.i64(i64 %230, i64 0)
  %231 = mul nuw nsw i64 %indvar1362, 80
  %232 = add i64 %212, %231
  ...
  %240 = shl nsw i64 %polly.indvar442, 2
  %.not.not944 = icmp ugt i64 %240, %polly.indvar419
  %241 = mul nuw nsw i64 %polly.indvar442, 80
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_header466.7, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %polly.loop_guard490 = icmp slt i64 %250, 80
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1382 = call i64 @llvm.smin.i64(i64 %253, i64 19)
  ...
  %smin1369 = call i64 @llvm.smin.i64(i64 %258, i64 19)
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %302 = lshr i64 %polly.indvar636, 2
  %303 = mul nuw nsw i64 %302, 80
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %exitcond1159.not = icmp eq i64 %320, 60
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit647.7
  ...
  %322 = mul nsw i64 %indvar1299, -80
  %323 = add i64 %304, %322
  %smax1318 = call i64 @llvm.smax.i64(i64 %323, i64 0)
  %324 = mul nuw nsw i64 %indvar1299, 80
  %325 = add i64 %306, %324
  %326 = add i64 %smax1318, %325
  %327 = mul nsw i64 %indvar1299, -80
  %328 = add i64 %311, %327
  %smax1301 = call i64 @llvm.smax.i64(i64 %328, i64 0)
  %329 = mul nuw nsw i64 %indvar1299, 80
  %330 = add i64 %310, %329
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_header683.7, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %polly.loop_guard707 = icmp slt i64 %348, 80
...
polly.loop_header704.us:                          ; preds = %polly.loop_header697.us, %polly.loop_exit714.us
  ...
  %smin1319 = call i64 @llvm.smin.i64(i64 %351, i64 19)
  ...
  %smin1306 = call i64 @llvm.smin.i64(i64 %356, i64 19)
