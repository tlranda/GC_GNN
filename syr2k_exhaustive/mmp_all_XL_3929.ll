; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3929.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3929.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1026.not = icmp eq i64 %120, 75
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %136 = mul nsw i64 %polly.indvar214, -128
...
polly.loop_header253:                             ; preds = %polly.loop_header246, %polly.loop_exit263
  %indvars.iv1021 = phi i64 [ %121, %polly.loop_header246 ], [ %indvars.iv.next1022, %polly.loop_exit263 ]
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %162 = mul nuw nsw i64 %polly.indvar392, 50
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %163 = lshr i64 %polly.indvar398, 3
  %164 = shl nuw nsw i64 %163, 7
  %165 = sub nsw i64 %indvars.iv1033, %164
  %166 = add i64 %indvars.iv1038, %164
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1048.not = icmp eq i64 %185, 75
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1040 = phi i64 [ %indvars.iv.next1041, %polly.loop_exit445 ], [ %166, %polly.loop_header395 ]
  %indvars.iv1035 = phi i64 [ %indvars.iv.next1036, %polly.loop_exit445 ], [ %165, %polly.loop_header395 ]
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %201 = mul nsw i64 %polly.indvar405, -128
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1042 = phi i64 [ %186, %polly.loop_header443 ], [ %indvars.iv.next1043, %polly.loop_exit460 ]
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %227 = mul nuw nsw i64 %polly.indvar589, 50
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %228 = lshr i64 %polly.indvar595, 3
  %229 = shl nuw nsw i64 %228, 7
  %230 = sub nsw i64 %indvars.iv1055, %229
  %231 = add i64 %indvars.iv1060, %229
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1062 = phi i64 [ %indvars.iv.next1063, %polly.loop_exit642 ], [ %231, %polly.loop_header592 ]
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit642 ], [ %230, %polly.loop_header592 ]
  %polly.indvar602 = phi i64 [ %polly.indvar_next603, %polly.loop_exit642 ], [ %228, %polly.loop_header592 ]
  %smax1059 = call i64 @llvm.smax.i64(i64 %indvars.iv1057, i64 0)
  %251 = add i64 %smax1059, %indvars.iv1062
  %252 = shl nsw i64 %polly.indvar602, 3
  %.not.not886 = icmp ugt i64 %252, %polly.indvar595
  %253 = shl nsw i64 %polly.indvar602, 7
  %254 = add nsw i64 %253, %233
  %255 = icmp sgt i64 %254, 0
  %256 = select i1 %255, i64 %254, i64 0
  %257 = add nsw i64 %254, 127
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %266 = mul nsw i64 %polly.indvar602, -128
  %267 = icmp slt i64 %266, -1072
  %268 = select i1 %267, i64 %266, i64 -1072
...
polly.loop_header647:                             ; preds = %polly.loop_header640, %polly.loop_exit657
  %indvars.iv1064 = phi i64 [ %251, %polly.loop_header640 ], [ %indvars.iv.next1065, %polly.loop_exit657 ]
