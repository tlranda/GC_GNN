; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5012.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5012.c"
...
vector.body1208:                                  ; preds = %vector.body1208, %vector.ph1212
  ...
  %wide.load1219 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %135, label %middle.block1206, label %vector.body1208, !llvm.loop !80
...
polly.loop_header389:                             ; preds = %polly.loop_exit398, %polly.loop_header383
  ...
  %145 = shl nsw i64 %polly.indvar392, 5
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1186
  ...
  %wide.load1193 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %175, label %middle.block1182, label %vector.body1184, !llvm.loop !90
...
polly.loop_header580:                             ; preds = %polly.loop_exit589, %polly.loop_header574
  ...
  %185 = shl nsw i64 %polly.indvar583, 5
...
vector.body1123:                                  ; preds = %vector.body1123, %vector.ph1124
  ...
  br i1 %229, label %polly.loop_exit807, label %vector.body1123, !llvm.loop !99
...
vector.body1137:                                  ; preds = %vector.body1137, %vector.ph1140
  ...
  br i1 %258, label %polly.loop_exit834, label %vector.body1137, !llvm.loop !102
...
vector.body1155:                                  ; preds = %vector.body1155, %vector.ph1158
  ...
  br i1 %287, label %polly.loop_exit860, label %vector.body1155, !llvm.loop !105
