; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1806.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1806.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next220, 60
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %103 = shl nuw nsw i64 %polly.indvar225, 4
  %104 = add i64 %97, %103
  %smax1324 = call i64 @llvm.smax.i64(i64 %104, i64 0)
  %105 = mul nsw i64 %polly.indvar225, -16
  %106 = add i64 %98, %105
...
polly.loop_exit230:                               ; preds = %polly.loop_exit261, %polly.loop_header222
  ...
  %indvars.iv.next1023 = add nsw i64 %indvars.iv1022, -16
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %115, i64 15)
  %116 = add nsw i64 %smin1327, 1
  %smin1028 = call i64 @llvm.smin.i64(i64 %indvars.iv1024, i64 15)
...
polly.loop_exit261:                               ; preds = %polly.loop_exit268.loopexit.us, %polly.loop_header228.split, %polly.loop_header259.preheader
  ...
  %polly.loop_cond233 = icmp ult i64 %polly.indvar231, 19
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  ...
  %151 = mul nsw i64 %polly.indvar417, -20
  %152 = mul nuw nsw i64 %polly.indvar417, 20
  %153 = lshr i64 %polly.indvar417, 2
  %154 = add nuw i64 %indvars.iv1057, %153
  %155 = mul nsw i64 %polly.indvar417, -20
  %156 = mul nuw nsw i64 %polly.indvar417, 20
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %indvars.iv.next1046 = add nuw nsw i64 %indvars.iv1045, 20
  %indvars.iv.next1058 = add nuw nsw i64 %indvars.iv1057, 1
  %exitcond1060.not = icmp eq i64 %polly.indvar_next418, 60
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %157 = shl nuw nsw i64 %polly.indvar424, 4
  %158 = add i64 %151, %157
  %smax1276 = call i64 @llvm.smax.i64(i64 %158, i64 0)
  %159 = mul nsw i64 %polly.indvar424, -16
  %160 = add i64 %152, %159
  %161 = add i64 %smax1276, %160
  %162 = shl nsw i64 %polly.indvar424, 4
  %163 = add nsw i64 %162, %155
  %164 = icmp sgt i64 %163, 0
  %165 = select i1 %164, i64 %163, i64 0
  %polly.loop_guard431 = icmp slt i64 %165, 20
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %169, i64 15)
  %170 = add nsw i64 %smin1279, 1
  %smin1054 = call i64 @llvm.smin.i64(i64 %indvars.iv1049, i64 15)
...
polly.loop_exit466:                               ; preds = %polly.loop_exit473.loopexit.us, %polly.loop_header428.split, %polly.loop_header464.preheader
  ...
  %polly.loop_cond434 = icmp ult i64 %polly.indvar432, 19
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  ...
  %205 = mul nsw i64 %polly.indvar622, -20
  %206 = mul nuw nsw i64 %polly.indvar622, 20
  %207 = lshr i64 %polly.indvar622, 2
  %208 = add nuw i64 %indvars.iv1083, %207
  %209 = mul nsw i64 %polly.indvar622, -20
  %210 = mul nuw nsw i64 %polly.indvar622, 20
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1072 = add nuw nsw i64 %indvars.iv1071, 20
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 1
  %exitcond1086.not = icmp eq i64 %polly.indvar_next623, 60
...
polly.loop_exit635:                               ; preds = %polly.loop_exit671, %polly.loop_header626
  ...
  %indvars.iv.next1069 = add nsw i64 %indvars.iv1068, 16
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %223, i64 15)
  %224 = add nsw i64 %smin1231, 1
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 15)
...
polly.loop_exit671:                               ; preds = %polly.loop_exit678.loopexit.us, %polly.loop_header633.split, %polly.loop_header669.preheader
  ...
  %polly.loop_cond639 = icmp ult i64 %polly.indvar637, 19
