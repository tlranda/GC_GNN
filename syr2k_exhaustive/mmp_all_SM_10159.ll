; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10159.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10159.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin778 = call i64 @llvm.smin.i64(i64 %indvars.iv776, i64 -1136)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next777 = add nsw i64 %indvars.iv776, -64
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %indvars.iv.next772 = add nsw i64 %indvars.iv771, -64
...
polly.loop_header350:                             ; preds = %polly.loop_exit342, %polly.loop_exit358
  ...
  %119 = shl nsw i64 %polly.indvar353, 6
...
polly.loop_exit358:                               ; preds = %polly.loop_exit364
  ...
  %exitcond802.not = icmp eq i64 %polly.indvar_next354, 19
...
polly.loop_header362:                             ; preds = %polly.loop_exit370, %polly.loop_header356
  ...
  %smin792 = call i64 @llvm.smin.i64(i64 %indvars.iv790, i64 63)
...
polly.loop_header503:                             ; preds = %polly.loop_exit495, %polly.loop_exit511
  ...
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 -1136)
  %141 = shl nsw i64 %polly.indvar506, 6
...
polly.loop_exit511:                               ; preds = %polly.loop_exit517
  ...
  %indvars.iv.next806 = add nuw nsw i64 %indvars.iv805, 64
  %indvars.iv.next815 = add nsw i64 %indvars.iv814, -64
  %indvars.iv.next819 = add nuw nsw i64 %indvars.iv818, 1
  %exitcond821.not = icmp eq i64 %polly.indvar_next507, 19
...
polly.loop_header509:                             ; preds = %polly.loop_exit517, %polly.loop_header503
  ...
  %143 = shl nsw i64 %polly.indvar512, 6
...
polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header509
  ...
  %smin811 = call i64 @llvm.smin.i64(i64 %indvars.iv809, i64 63)
