; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3813.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3813.c"
...
vector.body1355:                                  ; preds = %vector.body1355, %vector.ph1359
  ...
  %wide.load1366 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %145, label %middle.block1353, label %vector.body1355, !llvm.loop !85
...
vector.body1331:                                  ; preds = %vector.body1331, %vector.ph1333
  ...
  %wide.load1340 = load <4 x double>, <4 x double>* %192, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %195, label %middle.block1329, label %vector.body1331, !llvm.loop !95
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %197 = mul nuw nsw i64 %polly.indvar623, 50
...
vector.body1269:                                  ; preds = %vector.body1269, %vector.ph1271
  ...
  br i1 %259, label %polly.loop_exit876, label %vector.body1269, !llvm.loop !104
...
vector.body1284:                                  ; preds = %vector.body1284, %vector.ph1287
  ...
  br i1 %288, label %polly.loop_exit903, label %vector.body1284, !llvm.loop !107
...
vector.body1302:                                  ; preds = %vector.body1302, %vector.ph1305
  ...
  br i1 %317, label %polly.loop_exit929, label %vector.body1302, !llvm.loop !110
