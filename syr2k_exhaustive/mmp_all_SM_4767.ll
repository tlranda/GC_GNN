; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4767.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4767.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv993 = phi i64 [ 2, %polly.loop_header199.preheader ], [ %indvars.iv.next994, %polly.loop_exit207 ]
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %polly.loop_guard2331094 = icmp sgt i64 %111, -1
...
vector.body1208:                                  ; preds = %vector.body1208, %vector.ph1212
  ...
  %wide.load1219 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %133, label %middle.block1206, label %vector.body1208, !llvm.loop !79
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  %indvars.iv1023 = phi i64 [ 2, %polly.loop_header383.preheader ], [ %indvars.iv.next1024, %polly.loop_exit391 ]
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_exit440
  ...
  %polly.loop_guard4191095 = icmp sgt i64 %149, -1
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1186
  ...
  %wide.load1193 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %171, label %middle.block1182, label %vector.body1184, !llvm.loop !89
...
polly.loop_header563:                             ; preds = %polly.loop_header563.preheader, %polly.loop_header563
  ...
  br i1 %exitcond1058.not, label %polly.loop_exit565, label %polly.loop_header563, !llvm.loop !90

polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  %indvars.iv1053 = phi i64 [ 2, %polly.loop_header573.preheader ], [ %indvars.iv.next1054, %polly.loop_exit581 ]
...
polly.loop_exit581:                               ; preds = %polly.loop_exit587
  ...
  %indvars.iv.next1054 = add nuw nsw i64 %indvars.iv1053, 2
  %exitcond1057.not = icmp eq i64 %polly.indvar_next577, 19
...
polly.loop_exit587:                               ; preds = %polly.loop_exit594
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next583, 32
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit630
  %indvars.iv1043 = phi i64 [ %184, %polly.loop_header592.preheader ], [ %indvars.iv.next1044, %polly.loop_exit630 ]
  %polly.indvar596 = phi i64 [ %183, %polly.loop_header592.preheader ], [ %polly.indvar_next597, %polly.loop_exit630 ]
  %smin1049 = call i64 @llvm.smin.i64(i64 %indvars.iv1043, i64 31)
  %187 = add nsw i64 %polly.indvar596, %185
  %polly.loop_guard6091096 = icmp sgt i64 %187, -1
...
polly.merge618.us:                                ; preds = %polly.then619.us, %polly.cond617.loopexit.us
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar_next603.us, %178
...
polly.loop_header599:                             ; preds = %polly.loop_header592.split, %polly.loop_header599
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next603, %178
...
polly.loop_exit637.loopexit.us:                   ; preds = %polly.loop_header635.us
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar_next632.us, %178
...
vector.body1123:                                  ; preds = %vector.body1123, %vector.ph1124
  ...
  br i1 %223, label %polly.loop_exit805, label %vector.body1123, !llvm.loop !98

polly.loop_exit805:                               ; preds = %vector.body1123, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond1087.not = icmp eq i64 %polly.indvar800, %203
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond1083.not = icmp eq i64 %polly.indvar806, %207
  br i1 %exitcond1083.not, label %polly.loop_exit805, label %polly.loop_header803, !llvm.loop !99
...
vector.body1137:                                  ; preds = %vector.body1137, %vector.ph1140
  ...
  br i1 %252, label %polly.loop_exit832, label %vector.body1137, !llvm.loop !101

polly.loop_exit832:                               ; preds = %vector.body1137, %polly.loop_header830
  %polly.indvar_next828 = add nuw nsw i64 %polly.indvar827, 1
  %exitcond1077.not = icmp eq i64 %polly.indvar827, %232
...
polly.loop_header830:                             ; preds = %polly.loop_header824, %polly.loop_header830
  ...
  %exitcond1073.not = icmp eq i64 %polly.indvar833, %236
  br i1 %exitcond1073.not, label %polly.loop_exit832, label %polly.loop_header830, !llvm.loop !102
...
vector.body1155:                                  ; preds = %vector.body1155, %vector.ph1158
  ...
  br i1 %281, label %polly.loop_exit858, label %vector.body1155, !llvm.loop !104

polly.loop_exit858:                               ; preds = %vector.body1155, %polly.loop_header856
  %polly.indvar_next854 = add nuw nsw i64 %polly.indvar853, 1
  %exitcond1067.not = icmp eq i64 %polly.indvar853, %261
...
polly.loop_header856:                             ; preds = %polly.loop_header850, %polly.loop_header856
  ...
  %exitcond1063.not = icmp eq i64 %polly.indvar859, %265
  br i1 %exitcond1063.not, label %polly.loop_exit858, label %polly.loop_header856, !llvm.loop !105
}
