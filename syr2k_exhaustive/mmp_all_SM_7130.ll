; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7130.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7130.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar_next219, 60
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %indvars.iv.next826 = add nsw i64 %indvars.iv825, 16
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  ...
  %127 = mul nsw i64 %polly.indvar389, -20
  %128 = mul nuw nsw i64 %polly.indvar389, 20
...
polly.loop_exit395:                               ; preds = %polly.loop_exit402
  ...
  %indvars.iv.next848 = add nuw nsw i64 %indvars.iv847, 20
  %indvars.iv.next857 = add nuw nsw i64 %indvars.iv856, 1
  %exitcond859.not = icmp eq i64 %polly.indvar_next390, 60
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %129 = shl nsw i64 %polly.indvar396, 4
  %130 = add nsw i64 %129, %127
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %polly.loop_guard403 = icmp slt i64 %132, 20
...
polly.loop_exit402:                               ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %indvars.iv.next845 = add nsw i64 %indvars.iv844, 16
  %indvars.iv.next850 = add nsw i64 %indvars.iv849, -16
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit409
  ...
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 15)
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  ...
  %155 = mul nsw i64 %polly.indvar563, -20
  %156 = mul nuw nsw i64 %polly.indvar563, 20
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next564, 60
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %157 = shl nsw i64 %polly.indvar570, 4
  %158 = add nsw i64 %157, %155
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard577 = icmp slt i64 %160, 20
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583, %polly.loop_header567
  ...
  %indvars.iv.next867 = add nsw i64 %indvars.iv866, 16
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit583
  ...
  %smin875 = call i64 @llvm.smin.i64(i64 %indvars.iv873, i64 15)
