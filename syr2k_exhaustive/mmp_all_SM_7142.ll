; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7142.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7142.c"
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %115 = mul nsw i64 %polly.indvar230, 20
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %.inv838 = icmp slt i64 %143, 59
  %145 = select i1 %.inv838, i64 %144, i64 59
  %polly.loop_guard409 = icmp sgt i64 %145, -1
  %146 = mul nsw i64 %polly.indvar395, -32
  %147 = icmp slt i64 %146, -1168
  %148 = select i1 %147, i64 %146, i64 -1168
  %149 = add nsw i64 %148, 1199
  %150 = shl nsw i64 %polly.indvar395, 5
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %159 = mul nsw i64 %polly.indvar410, 20
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %.inv839 = icmp slt i64 %187, 59
  %189 = select i1 %.inv839, i64 %188, i64 59
  %polly.loop_guard589 = icmp sgt i64 %189, -1
  %190 = mul nsw i64 %polly.indvar575, -32
  %191 = icmp slt i64 %190, -1168
  %192 = select i1 %191, i64 %190, i64 -1168
  %193 = add nsw i64 %192, 1199
  %194 = shl nsw i64 %polly.indvar575, 5
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %203 = mul nsw i64 %polly.indvar590, 20
