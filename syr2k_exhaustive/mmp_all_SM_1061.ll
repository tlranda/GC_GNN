; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1061.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1061.c"
...
vector.body1413:                                  ; preds = %vector.body1413, %vector.ph1421
  ...
  %wide.load1434 = load <4 x double>, <4 x double>* %161, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %166, label %middle.block1411, label %vector.body1413, !llvm.loop !84
...
vector.body1349:                                  ; preds = %vector.body1349, %vector.ph1353
  ...
  %wide.load1360 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %177, label %middle.block1347, label %vector.body1349, !llvm.loop !93
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit422
  ...
  %179 = mul nuw nsw i64 %polly.indvar417, 100
...
vector.body1363:                                  ; preds = %vector.body1363, %vector.ph1371
  ...
  %wide.load1384 = load <4 x double>, <4 x double>* %243, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %248, label %middle.block1361, label %vector.body1363, !llvm.loop !97
...
vector.body1301:                                  ; preds = %vector.body1301, %vector.ph1303
  ...
  %wide.load1310 = load <4 x double>, <4 x double>* %256, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %259, label %middle.block1299, label %vector.body1301, !llvm.loop !106
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit639
  ...
  %261 = mul nuw nsw i64 %polly.indvar634, 100
...
vector.body1313:                                  ; preds = %vector.body1313, %vector.ph1321
  ...
  %wide.load1334 = load <4 x double>, <4 x double>* %325, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %330, label %middle.block1311, label %vector.body1313, !llvm.loop !110
...
vector.body1239:                                  ; preds = %vector.body1239, %vector.ph1241
  ...
  br i1 %355, label %polly.loop_exit888, label %vector.body1239, !llvm.loop !117
...
vector.body1254:                                  ; preds = %vector.body1254, %vector.ph1257
  ...
  br i1 %384, label %polly.loop_exit915, label %vector.body1254, !llvm.loop !120
...
vector.body1272:                                  ; preds = %vector.body1272, %vector.ph1275
  ...
  br i1 %413, label %polly.loop_exit941, label %vector.body1272, !llvm.loop !123
