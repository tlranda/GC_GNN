; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1636.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1636.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %105 = mul nsw i64 %polly.indvar231, -100
  %106 = add i64 %98, %105
  %107 = add i64 %smax1345, %106
  %108 = mul nuw nsw i64 %polly.indvar231, 100
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1348 = call i64 @llvm.smin.i64(i64 %115, i64 99)
...
vector.body1344:                                  ; preds = %vector.body1344, %vector.ph1350
  ...
  %wide.load1363 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !65, !noalias !67
  ...
  br i1 %141, label %middle.block1342, label %vector.body1344, !llvm.loop !77
...
vector.body1282:                                  ; preds = %vector.body1282, %vector.ph1286
  ...
  %wide.load1293 = load <4 x double>, <4 x double>* %149, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %152, label %middle.block1280, label %vector.body1282, !llvm.loop !86
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  ...
  %156 = udiv i64 %indvars.iv1076, 25
  %157 = mul nsw i64 %polly.indvar423, -16
  %158 = shl nsw i64 %polly.indvar423, 4
...
polly.loop_header426:                             ; preds = %polly.loop_exit435, %polly.loop_header420
  ...
  %159 = mul nuw nsw i64 %polly.indvar429, 50
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %160 = mul nuw nsw i64 %polly.indvar436, 100
  %161 = add i64 %154, %160
  %smax1297 = call i64 @llvm.smax.i64(i64 %161, i64 0)
  %162 = mul nsw i64 %polly.indvar436, -100
  %163 = add i64 %155, %162
  %164 = add i64 %smax1297, %163
  %165 = mul nuw nsw i64 %polly.indvar436, 100
  %166 = add nsw i64 %165, %157
  %167 = icmp sgt i64 %166, 0
  %168 = select i1 %167, i64 %166, i64 0
  %polly.loop_guard443 = icmp slt i64 %168, 16
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1300 = call i64 @llvm.smin.i64(i64 %172, i64 99)
...
vector.body1296:                                  ; preds = %vector.body1296, %vector.ph1302
  ...
  %wide.load1315 = load <4 x double>, <4 x double>* %193, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %198, label %middle.block1294, label %vector.body1296, !llvm.loop !90
...
vector.body1236:                                  ; preds = %vector.body1236, %vector.ph1238
  ...
  %wide.load1245 = load <4 x double>, <4 x double>* %206, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %209, label %middle.block1234, label %vector.body1236, !llvm.loop !99
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  ...
  %211 = mul nsw i64 %polly.indvar634, -16
  %212 = shl nuw nsw i64 %polly.indvar634, 4
  %213 = udiv i64 %indvars.iv1103, 25
  %214 = mul nsw i64 %polly.indvar634, -16
  %215 = shl nsw i64 %polly.indvar634, 4
...
polly.loop_header637:                             ; preds = %polly.loop_exit646, %polly.loop_header631
  ...
  %216 = mul nuw nsw i64 %polly.indvar640, 50
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %217 = mul nuw nsw i64 %polly.indvar647, 100
  %218 = add i64 %211, %217
  %smax1249 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar647, -100
  %220 = add i64 %212, %219
  %221 = add i64 %smax1249, %220
  %222 = mul nuw nsw i64 %polly.indvar647, 100
  %223 = add nsw i64 %222, %214
  %224 = icmp sgt i64 %223, 0
  %225 = select i1 %224, i64 %223, i64 0
  %polly.loop_guard654 = icmp slt i64 %225, 16
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1252 = call i64 @llvm.smin.i64(i64 %229, i64 99)
...
vector.body1248:                                  ; preds = %vector.body1248, %vector.ph1254
  ...
  %wide.load1267 = load <4 x double>, <4 x double>* %250, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %255, label %middle.block1246, label %vector.body1248, !llvm.loop !103
...
vector.body1175:                                  ; preds = %vector.body1175, %vector.ph1176
  ...
  br i1 %280, label %polly.loop_exit866, label %vector.body1175, !llvm.loop !110
...
vector.body1189:                                  ; preds = %vector.body1189, %vector.ph1192
  ...
  br i1 %309, label %polly.loop_exit893, label %vector.body1189, !llvm.loop !113
...
vector.body1207:                                  ; preds = %vector.body1207, %vector.ph1210
  ...
  br i1 %338, label %polly.loop_exit919, label %vector.body1207, !llvm.loop !116
