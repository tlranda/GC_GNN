; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4971.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4971.c"
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %143 = lshr i64 %indvars.iv1015, 3
  %144 = mul nsw i64 %polly.indvar386, -96
  %145 = icmp slt i64 %144, -1104
  %146 = select i1 %145, i64 %144, i64 -1104
  %147 = add nsw i64 %146, 1199
  %148 = mul nuw nsw i64 %polly.indvar386, 96
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %160 = shl nsw i64 %polly.indvar399, 8
...
polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  ...
  %exitcond1017.not = icmp eq i64 %polly.indvar399, %143
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  ...
  %polly.loop_guard4201082 = icmp sgt i64 %167, -1
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %189 = lshr i64 %indvars.iv1040, 3
  %190 = mul nsw i64 %polly.indvar577, -96
  %191 = icmp slt i64 %190, -1104
  %192 = select i1 %191, i64 %190, i64 -1104
  %193 = add nsw i64 %192, 1199
  %194 = mul nuw nsw i64 %polly.indvar577, 96
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %206 = shl nsw i64 %polly.indvar590, 8
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar590, %189
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1032 = phi i64 [ %210, %polly.loop_header594.preheader ], [ %indvars.iv.next1033, %polly.loop_exit632 ]
  ...
  %polly.loop_guard6111083 = icmp sgt i64 %213, -1
...
vector.body1104:                                  ; preds = %vector.body1104, %vector.ph1105
  ...
  br i1 %247, label %polly.loop_exit807, label %vector.body1104, !llvm.loop !99

polly.loop_exit807:                               ; preds = %vector.body1104, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1074.not = icmp eq i64 %polly.indvar802, %227
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar808, %231
...
vector.body1118:                                  ; preds = %vector.body1118, %vector.ph1121
  ...
  br i1 %276, label %polly.loop_exit834, label %vector.body1118, !llvm.loop !102

polly.loop_exit834:                               ; preds = %vector.body1118, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1064.not = icmp eq i64 %polly.indvar829, %256
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar835, %260
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  br i1 %305, label %polly.loop_exit860, label %vector.body1136, !llvm.loop !105

polly.loop_exit860:                               ; preds = %vector.body1136, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1054.not = icmp eq i64 %polly.indvar855, %285
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar861, %289
