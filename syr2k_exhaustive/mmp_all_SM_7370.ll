; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7370.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7370.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv834 = phi i64 [ %indvars.iv.next835, %polly.loop_exit223 ], [ 13, %polly.loop_exit207 ]
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next835 = add nuw nsw i64 %indvars.iv834, 12
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 3)
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  %indvars.iv856 = phi i64 [ %indvars.iv.next857, %polly.loop_exit395 ], [ 13, %polly.loop_exit378 ]
  ...
  %127 = mul nsw i64 %polly.indvar389, -50
  %128 = mul nuw nsw i64 %polly.indvar389, 50
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %129 = shl nsw i64 %polly.indvar396, 2
  %130 = add nsw i64 %129, %127
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %polly.loop_guard403 = icmp slt i64 %132, 50
...
polly.loop_exit402:                               ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %indvars.iv.next845 = add nsw i64 %indvars.iv844, 4
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit409
  ...
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 3)
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  %indvars.iv878 = phi i64 [ %indvars.iv.next879, %polly.loop_exit569 ], [ 13, %polly.loop_exit552 ]
  ...
  %155 = mul nsw i64 %polly.indvar563, -50
  %156 = mul nuw nsw i64 %polly.indvar563, 50
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %157 = shl nsw i64 %polly.indvar570, 2
  %158 = add nsw i64 %157, %155
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard577 = icmp slt i64 %160, 50
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583, %polly.loop_header567
  ...
  %indvars.iv.next867 = add nsw i64 %indvars.iv866, 4
