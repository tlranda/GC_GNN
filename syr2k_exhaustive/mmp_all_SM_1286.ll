; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1286.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1286.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1100 = call i64 @llvm.smin.i64(i64 %indvars.iv1080, i64 -936)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1081 = add nsw i64 %indvars.iv1080, -64
  %exitcond1104.not = icmp eq i64 %polly.indvar_next204, 16
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %smin1132 = call i64 @llvm.smin.i64(i64 %indvars.iv1110, i64 -936)
  %154 = add nsw i64 %smin1132, 1000
  %155 = shl nsw i64 %polly.indvar413, 6
  br label %polly.loop_header416

polly.loop_exit418:                               ; preds = %polly.loop_exit440
  %polly.indvar_next414 = add nuw nsw i64 %polly.indvar413, 1
  %indvars.iv.next1111 = add nsw i64 %indvars.iv1110, -64
  %exitcond1136.not = icmp eq i64 %polly.indvar_next414, 16
...
polly.start518:                                   ; preds = %init_array.exit
  ...
  %malloccall522 = tail call dereferenceable_or_null(614400) i8* @malloc(i64 614400) #6
...
polly.loop_header622:                             ; preds = %polly.loop_header622.preheader, %polly.loop_exit630
  ...
  %smin1164 = call i64 @llvm.smin.i64(i64 %indvars.iv1142, i64 -936)
  %211 = add nsw i64 %smin1164, 1000
  %212 = shl nsw i64 %polly.indvar625, 6
...
polly.loop_exit630:                               ; preds = %polly.loop_exit652
  ...
  %exitcond1168.not = icmp eq i64 %polly.indvar_next626, 16
