; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7866.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7866.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next225, 250
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249940 = icmp sgt i64 %119, -1
...
vector.body1049:                                  ; preds = %vector.body1049, %vector.ph1053
  ...
  %132 = shl nuw nsw i64 %index1056, 3
  %133 = getelementptr i8, i8* %scevgep370, i64 %132
  %134 = bitcast i8* %133 to <4 x double>*
  %wide.load1060 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !74, !noalias !76
  %135 = fmul fast <4 x double> %wide.load1060, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %137 = icmp eq i64 %index.next1057, %n.vec1055
  br i1 %137, label %middle.block1047, label %vector.body1049, !llvm.loop !80

middle.block1047:                                 ; preds = %vector.body1049
  %cmp.n1059 = icmp eq i64 %130, %n.vec1055
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %139 = udiv i64 %indvars.iv873, 5
  %140 = add nuw i64 %indvars.iv871, %139
  %umin875 = call i64 @llvm.umin.i64(i64 %140, i64 53)
  %141 = mul nsw i64 %polly.indvar393, -128
  %142 = icmp slt i64 %141, -1072
  %143 = select i1 %142, i64 %141, i64 -1072
  %144 = add nsw i64 %143, 1199
  %145 = shl nsw i64 %polly.indvar393, 7
  %146 = add nuw nsw i64 %umin875, 6
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar_next400, 250
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %159 = add i64 %smax861, %indvars.iv864
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar406, %146
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv866 = phi i64 [ %159, %polly.loop_header410.preheader ], [ %indvars.iv.next867, %polly.loop_exit419 ]
  ...
  %polly.loop_guard427941 = icmp sgt i64 %161, -1
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1026 = icmp ult i64 %172, 4
...
vector.body1025:                                  ; preds = %vector.body1025, %vector.ph1027
  ...
  %174 = shl nuw nsw i64 %index1030, 3
  %175 = getelementptr i8, i8* %scevgep548, i64 %174
  %176 = bitcast i8* %175 to <4 x double>*
  %wide.load1034 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !84, !noalias !86
  %177 = fmul fast <4 x double> %wide.load1034, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %179 = icmp eq i64 %index.next1031, %n.vec1029
  br i1 %179, label %middle.block1023, label %vector.body1025, !llvm.loop !90

middle.block1023:                                 ; preds = %vector.body1025
  %cmp.n1033 = icmp eq i64 %172, %n.vec1029
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %181 = udiv i64 %indvars.iv899, 5
  %182 = add nuw i64 %indvars.iv897, %181
  %umin901 = call i64 @llvm.umin.i64(i64 %182, i64 53)
  %183 = mul nsw i64 %polly.indvar571, -128
  %184 = icmp slt i64 %183, -1072
  %185 = select i1 %184, i64 %183, i64 -1072
  %186 = add nsw i64 %185, 1199
  %187 = shl nsw i64 %polly.indvar571, 7
  %188 = add nuw nsw i64 %umin901, 6
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar_next578, 250
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  ...
  %201 = add i64 %smax887, %indvars.iv890
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %exitcond902.not = icmp eq i64 %polly.indvar584, %188
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv892 = phi i64 [ %201, %polly.loop_header588.preheader ], [ %indvars.iv.next893, %polly.loop_exit597 ]
  ...
  %polly.loop_guard605942 = icmp sgt i64 %203, -1
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin964 = call i64 @llvm.smin.i64(i64 %216, i64 -1168)
  %217 = add nsw i64 %smin964, 1200
  %smin931 = call i64 @llvm.smin.i64(i64 %indvars.iv929, i64 -1168)
  %218 = shl nsw i64 %polly.indvar761, 5
  %219 = add nsw i64 %smin931, 1199
...
vector.ph965:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert972 = insertelement <4 x i64> poison, i64 %218, i32 0
  %broadcast.splat973 = shufflevector <4 x i64> %broadcast.splatinsert972, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert974 = insertelement <4 x i32> poison, i32 %221, i32 0
...
vector.body963:                                   ; preds = %vector.body963, %vector.ph965
  ...
  %223 = add nuw nsw <4 x i64> %vec.ind970, %broadcast.splat973
  %224 = trunc <4 x i64> %223 to <4 x i32>
  %225 = mul <4 x i32> %broadcast.splat975, %224
  ...
  %235 = icmp eq i64 %index.next967, %217
  br i1 %235, label %polly.loop_exit772, label %vector.body963, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body963, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond936.not = icmp eq i64 %polly.indvar767, %215
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond932.not = icmp eq i64 %polly.indvar773, %219
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin979 = call i64 @llvm.smin.i64(i64 %245, i64 -968)
  %246 = add nsw i64 %smin979, 1000
  %smin921 = call i64 @llvm.smin.i64(i64 %indvars.iv919, i64 -968)
  %247 = shl nsw i64 %polly.indvar788, 5
  %248 = add nsw i64 %smin921, 999
...
vector.body978:                                   ; preds = %vector.body978, %vector.ph981
  ...
  %252 = add nuw nsw <4 x i64> %vec.ind988, %broadcast.splat991
  %253 = trunc <4 x i64> %252 to <4 x i32>
  %254 = mul <4 x i32> %broadcast.splat993, %253
  ...
  %264 = icmp eq i64 %index.next985, %246
  br i1 %264, label %polly.loop_exit799, label %vector.body978, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body978, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond926.not = icmp eq i64 %polly.indvar794, %244
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond922.not = icmp eq i64 %polly.indvar800, %248
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin997 = call i64 @llvm.smin.i64(i64 %274, i64 -968)
  %275 = add nsw i64 %smin997, 1000
  %smin911 = call i64 @llvm.smin.i64(i64 %indvars.iv909, i64 -968)
  %276 = shl nsw i64 %polly.indvar814, 5
  %277 = add nsw i64 %smin911, 999
...
vector.body996:                                   ; preds = %vector.body996, %vector.ph999
  ...
  %281 = add nuw nsw <4 x i64> %vec.ind1006, %broadcast.splat1009
  %282 = trunc <4 x i64> %281 to <4 x i32>
  %283 = mul <4 x i32> %broadcast.splat1011, %282
  ...
  %293 = icmp eq i64 %index.next1003, %275
  br i1 %293, label %polly.loop_exit825, label %vector.body996, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body996, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond916.not = icmp eq i64 %polly.indvar820, %273
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond912.not = icmp eq i64 %polly.indvar826, %277
...
polly.loop_header424.us.3:                        ; preds = %polly.loop_header424.us.3, %polly.loop_exit426.loopexit.us.2
  ...
  br i1 %exitcond869.3.not, label %polly.loop_exit419, label %polly.loop_header424.us.3
...
polly.loop_header602.us.3:                        ; preds = %polly.loop_header602.us.3, %polly.loop_exit604.loopexit.us.2
  ...
  br i1 %exitcond895.3.not, label %polly.loop_exit597, label %polly.loop_header602.us.3
}
