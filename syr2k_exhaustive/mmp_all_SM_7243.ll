; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7243.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7243.c"
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  %smin855 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -872)
  %107 = shl nsw i64 %polly.indvar224, 7
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar_next225, 8
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  %smin879 = call i64 @llvm.smin.i64(i64 %indvars.iv877, i64 -872)
  %146 = shl nsw i64 %polly.indvar401, 7
...
polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next402, 8
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  ...
  %185 = shl nsw i64 %polly.indvar581, 7
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar_next582, 8
