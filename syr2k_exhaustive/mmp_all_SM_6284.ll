; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6284.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6284.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235.loopexit.us, %polly.loop_header221
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next225, 15
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next862 = add nsw i64 %indvars.iv861, -20
  %exitcond871.not = icmp eq i64 %polly.indvar_next374, 60
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408.loopexit.us, %polly.loop_header393
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next397, 15
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %indvars.iv.next879 = add nuw nsw i64 %indvars.iv878, 20
  %indvars.iv.next884 = add nsw i64 %indvars.iv883, -20
  %exitcond893.not = icmp eq i64 %polly.indvar_next548, 60
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582.loopexit.us, %polly.loop_header567
  ...
  %exitcond892.not = icmp eq i64 %polly.indvar_next571, 15
