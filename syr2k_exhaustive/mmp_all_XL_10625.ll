; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10625.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10625.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv795 = phi i64 [ %indvars.iv.next796, %polly.loop_exit207 ], [ 15, %polly.loop_exit193 ]
  %indvars.iv785 = phi i64 [ %indvars.iv.next786, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %polly.indvar202 = phi i64 [ %polly.indvar_next203, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv795, i64 149)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next796 = add nuw nsw i64 %indvars.iv795, 16
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv819 = phi i64 [ %indvars.iv.next820, %polly.loop_exit362 ], [ 15, %polly.loop_exit346 ]
  ...
  %umin821 = call i64 @llvm.umin.i64(i64 %indvars.iv819, i64 149)
  %131 = mul nsw i64 %polly.indvar357, -128
...
polly.loop_exit362:                               ; preds = %polly.loop_exit368
  ...
  %indvars.iv.next808 = add nuw nsw i64 %indvars.iv807, 128
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next364, 8
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  %indvars.iv844 = phi i64 [ %indvars.iv.next845, %polly.loop_exit519 ], [ 15, %polly.loop_exit503 ]
  ...
  %umin846 = call i64 @llvm.umin.i64(i64 %indvars.iv844, i64 149)
  %165 = mul nsw i64 %polly.indvar514, -128
  %166 = icmp slt i64 %165, -1072
  %167 = select i1 %166, i64 %165, i64 -1072
  %168 = add nsw i64 %167, 1199
  %169 = shl nsw i64 %polly.indvar514, 7
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar_next515, 10
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %smin842 = call i64 @llvm.smin.i64(i64 %indvars.iv840, i64 -872)
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next521, 8
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header523
  ...
  %indvars.iv.next835 = add nsw i64 %indvars.iv834, -8
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %smin838 = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 7)
