; ModuleID = 'syr2k_exhaustive/mmp_all_SM_267.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_267.c"
...
vector.body1447:                                  ; preds = %vector.body1447, %vector.ph1449
  ...
  br i1 %57, label %middle.block1445, label %vector.body1447, !llvm.loop !63
...
vector.body1510:                                  ; preds = %vector.body1510, %vector.ph1512
  ...
  br i1 %68, label %middle.block1508, label %vector.body1510, !llvm.loop !65
...
vector.body1522:                                  ; preds = %vector.body1522, %vector.ph1526
  ...
  %wide.load1533 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1520, label %vector.body1522, !llvm.loop !78
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond1198.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !79
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1194 = call i64 @llvm.smin.i64(i64 %indvars.iv1168, i64 -984)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1197.not = icmp eq i64 %polly.indvar_next204, 63
...
polly.loop_header293.us:                          ; preds = %polly.loop_header293.us.preheader, %polly.loop_header293.us
  ...
  br i1 %exitcond1193.not, label %polly.loop_exit295.us, label %polly.loop_header293.us, !llvm.loop !83
...
vector.body1553:                                  ; preds = %vector.body1553, %vector.ph1557
  ...
  %wide.load1564 = load <4 x double>, <4 x double>* %192, align 8, !alias.scope !84
  ...
  %wide.load1570 = load <4 x double>, <4 x double>* %200, align 8, !alias.scope !87, !noalias !89
  ...
  store <4 x double> %203, <4 x double>* %204, align 8, !alias.scope !87, !noalias !89
  %index.next1561 = add i64 %index1560, 4
  %205 = icmp eq i64 %index.next1561, %n.vec1559
  br i1 %205, label %middle.block1551, label %vector.body1553, !llvm.loop !90
...
vector.body1459:                                  ; preds = %vector.body1459, %vector.ph1463
  ...
  %wide.load1470 = load <4 x double>, <4 x double>* %210, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %213, label %middle.block1457, label %vector.body1459, !llvm.loop !98
...
polly.loop_header415:                             ; preds = %polly.loop_header415.preheader, %polly.loop_header415
  ...
  br i1 %exitcond1235.not, label %polly.loop_exit417, label %polly.loop_header415, !llvm.loop !99
...
polly.loop_header425:                             ; preds = %polly.loop_header425.preheader, %polly.loop_exit433
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %indvars.iv1203, i64 -984)
  %215 = add nsw i64 %smin1231, 1000
  %216 = shl nsw i64 %polly.indvar428, 4
...
polly.loop_exit433:                               ; preds = %polly.loop_exit456
  ...
  %indvars.iv.next1204 = add nsw i64 %indvars.iv1203, -16
  %exitcond1234.not = icmp eq i64 %polly.indvar_next429, 63
...
polly.loop_header525.us:                          ; preds = %polly.loop_header525.us.preheader, %polly.loop_header525.us
  ...
  br i1 %exitcond1230.not, label %polly.loop_exit527.us, label %polly.loop_header525.us, !llvm.loop !102
...
vector.body1490:                                  ; preds = %vector.body1490, %vector.ph1494
  ...
  %wide.load1501 = load <4 x double>, <4 x double>* %310, align 8, !alias.scope !103
  ...
  %wide.load1507 = load <4 x double>, <4 x double>* %318, align 8, !alias.scope !106, !noalias !108
  ...
  store <4 x double> %321, <4 x double>* %322, align 8, !alias.scope !106, !noalias !108
  %index.next1498 = add i64 %index1497, 4
  %323 = icmp eq i64 %index.next1498, %n.vec1496
  br i1 %323, label %middle.block1488, label %vector.body1490, !llvm.loop !109
...
vector.body1398:                                  ; preds = %vector.body1398, %vector.ph1400
  ...
  %wide.load1407 = load <4 x double>, <4 x double>* %328, align 8, !alias.scope !110, !noalias !112
  ...
  store <4 x double> %329, <4 x double>* %330, align 8, !alias.scope !110, !noalias !112
  %index.next1404 = add i64 %index1403, 4
  %331 = icmp eq i64 %index.next1404, %n.vec1402
  br i1 %331, label %middle.block1396, label %vector.body1398, !llvm.loop !117
...
polly.loop_header647:                             ; preds = %polly.loop_header647.preheader, %polly.loop_header647
  ...
  br i1 %exitcond1272.not, label %polly.loop_exit649, label %polly.loop_header647, !llvm.loop !118
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit665
  ...
  %smin1268 = call i64 @llvm.smin.i64(i64 %indvars.iv1240, i64 -984)
  %333 = add nsw i64 %smin1268, 1000
  %334 = shl nsw i64 %polly.indvar660, 4
...
polly.loop_exit665:                               ; preds = %polly.loop_exit688
  ...
  %indvars.iv.next1241 = add nsw i64 %indvars.iv1240, -16
  %exitcond1271.not = icmp eq i64 %polly.indvar_next661, 63
...
polly.loop_header757.us:                          ; preds = %polly.loop_header757.us.preheader, %polly.loop_header757.us
  ...
  br i1 %exitcond1267.not, label %polly.loop_exit759.us, label %polly.loop_header757.us, !llvm.loop !121
...
vector.body1427:                                  ; preds = %vector.body1427, %vector.ph1431
  ...
  %wide.load1438 = load <4 x double>, <4 x double>* %428, align 8, !alias.scope !122
  ...
  %wide.load1444 = load <4 x double>, <4 x double>* %436, align 8, !alias.scope !125, !noalias !127
  ...
  store <4 x double> %439, <4 x double>* %440, align 8, !alias.scope !125, !noalias !127
  %index.next1435 = add i64 %index1434, 4
  %441 = icmp eq i64 %index.next1435, %n.vec1433
  br i1 %441, label %middle.block1425, label %vector.body1427, !llvm.loop !128
...
vector.body1337:                                  ; preds = %vector.body1337, %vector.ph1338
  ...
  store <4 x double> %457, <4 x double>* %462, align 8, !alias.scope !129, !noalias !131
  ...
  br i1 %463, label %polly.loop_exit929, label %vector.body1337, !llvm.loop !134
...
polly.loop_header927:                             ; preds = %polly.loop_header921, %polly.loop_header927
  ...
  br i1 %exitcond1297.not, label %polly.loop_exit929, label %polly.loop_header927, !llvm.loop !135
...
vector.body1351:                                  ; preds = %vector.body1351, %vector.ph1354
  ...
  store <4 x double> %486, <4 x double>* %491, align 8, !alias.scope !133, !noalias !136
  ...
  br i1 %492, label %polly.loop_exit956, label %vector.body1351, !llvm.loop !137
...
polly.loop_header954:                             ; preds = %polly.loop_header948, %polly.loop_header954
  ...
  br i1 %exitcond1287.not, label %polly.loop_exit956, label %polly.loop_header954, !llvm.loop !138
...
vector.body1369:                                  ; preds = %vector.body1369, %vector.ph1372
  ...
  store <4 x double> %515, <4 x double>* %520, align 8, !alias.scope !132, !noalias !139
  ...
  br i1 %521, label %polly.loop_exit982, label %vector.body1369, !llvm.loop !140
...
polly.loop_header980:                             ; preds = %polly.loop_header974, %polly.loop_header980
  ...
  br i1 %exitcond1277.not, label %polly.loop_exit982, label %polly.loop_header980, !llvm.loop !141
}
