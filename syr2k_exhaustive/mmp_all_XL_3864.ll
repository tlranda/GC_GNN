; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3864.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3864.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit242
  ...
  %exitcond1016.not = icmp eq i64 %122, 60
...
polly.loop_header205:                             ; preds = %polly.loop_exit242, %polly.loop_header199
  ...
  %123 = add i64 %smax, %indvars.iv1010
  %124 = mul nuw nsw i64 %polly.indvar208, 5
  %.not.not = icmp ugt i64 %124, %polly.indvar202
  %125 = mul nuw nsw i64 %polly.indvar208, 100
...
polly.loop_header240.preheader:                   ; preds = %polly.loop_exit229, %polly.loop_exit229.us, %polly.loop_header205.split
  ...
  %polly.loop_guard250 = icmp slt i64 %133, 100
...
polly.loop_header247.us:                          ; preds = %polly.loop_exit257.us, %polly.loop_header240.us
  %indvars.iv1012 = phi i64 [ %indvars.iv.next1013, %polly.loop_exit257.us ], [ %123, %polly.loop_header240.us ]
  %polly.indvar251.us = phi i64 [ %polly.indvar_next252.us, %polly.loop_exit257.us ], [ %133, %polly.loop_header240.us ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1012, i64 19)
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit394
  ...
  %153 = udiv i64 %polly.indvar388, 5
  %154 = mul nuw nsw i64 %153, 100
  %155 = sub nsw i64 %indvars.iv1022, %154
  %156 = add i64 %indvars.iv1027, %154
...
polly.loop_exit394:                               ; preds = %polly.loop_exit435
  ...
  %indvars.iv.next1023 = add nuw nsw i64 %indvars.iv1022, 20
  %indvars.iv.next1028 = add nsw i64 %indvars.iv1027, -20
  %exitcond1036.not = icmp eq i64 %178, 60
...
polly.loop_header392:                             ; preds = %polly.loop_exit435, %polly.loop_header385
  %indvars.iv1029 = phi i64 [ %indvars.iv.next1030, %polly.loop_exit435 ], [ %156, %polly.loop_header385 ]
  %indvars.iv1024 = phi i64 [ %indvars.iv.next1025, %polly.loop_exit435 ], [ %155, %polly.loop_header385 ]
  ...
  %179 = add i64 %smax1026, %indvars.iv1029
  %180 = mul nuw nsw i64 %polly.indvar395, 5
  %.not.not873 = icmp ugt i64 %180, %polly.indvar388
  %181 = mul nuw nsw i64 %polly.indvar395, 100
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442.loopexit.us, %polly.loop_header433.preheader
  ...
  %polly.loop_cond397 = icmp ult i64 %polly.indvar395, 11
  %indvars.iv.next1025 = add i64 %indvars.iv1024, -100
...
polly.loop_header433.preheader:                   ; preds = %polly.loop_exit421, %polly.loop_exit421.us, %polly.loop_header392.split
  ...
  %polly.loop_guard443 = icmp slt i64 %189, 100
...
polly.loop_header440.us:                          ; preds = %polly.loop_exit450.us, %polly.loop_header433.us
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit450.us ], [ %179, %polly.loop_header433.us ]
  %polly.indvar444.us = phi i64 [ %polly.indvar_next445.us, %polly.loop_exit450.us ], [ %189, %polly.loop_header433.us ]
  %smin1033 = call i64 @llvm.smin.i64(i64 %indvars.iv1031, i64 19)
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  ...
  %209 = udiv i64 %polly.indvar581, 5
  %210 = mul nuw nsw i64 %209, 100
  %211 = sub nsw i64 %indvars.iv1042, %210
  %212 = add i64 %indvars.iv1047, %210
...
polly.loop_header585:                             ; preds = %polly.loop_exit628, %polly.loop_header578
  %indvars.iv1049 = phi i64 [ %indvars.iv.next1050, %polly.loop_exit628 ], [ %212, %polly.loop_header578 ]
  %indvars.iv1044 = phi i64 [ %indvars.iv.next1045, %polly.loop_exit628 ], [ %211, %polly.loop_header578 ]
  ...
  %235 = add i64 %smax1046, %indvars.iv1049
  %236 = mul nuw nsw i64 %polly.indvar588, 5
  %.not.not874 = icmp ugt i64 %236, %polly.indvar581
  %237 = mul nuw nsw i64 %polly.indvar588, 100
  %238 = add nsw i64 %237, %214
  %239 = icmp sgt i64 %238, 0
  %240 = select i1 %239, i64 %238, i64 0
  %241 = add nsw i64 %238, 99
...
polly.loop_header626.preheader:                   ; preds = %polly.loop_exit614, %polly.loop_exit614.us, %polly.loop_header585.split
  ...
  %polly.loop_guard636 = icmp slt i64 %245, 100
...
polly.loop_header633.us:                          ; preds = %polly.loop_exit643.us, %polly.loop_header626.us
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit643.us ], [ %235, %polly.loop_header626.us ]
