; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6158.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6158.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %105 = mul nsw i64 %polly.indvar230, -64
...
vector.body1060:                                  ; preds = %vector.body1060, %vector.ph1064
  ...
  %wide.load1071 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %126, label %middle.block1058, label %vector.body1060, !llvm.loop !84
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %129 = shl nsw i64 %polly.indvar375, 7
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %130 = shl nsw i64 %polly.indvar381, 7
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %136 = mul nsw i64 %polly.indvar403, -64
  %polly.loop_guard416953 = icmp sgt i64 %136, -1200
  %137 = shl nsw i64 %polly.indvar403, 6
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1038
  ...
  %wide.load1045 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %157, label %middle.block1034, label %vector.body1036, !llvm.loop !94
...
polly.loop_header547:                             ; preds = %polly.loop_header547.preheader, %polly.loop_exit555
  ...
  %160 = shl nsw i64 %polly.indvar550, 7
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_exit561
  ...
  %167 = mul nsw i64 %polly.indvar578, -64
  %polly.loop_guard591954 = icmp sgt i64 %167, -1200
  %168 = shl nsw i64 %polly.indvar578, 6
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph976
  ...
  br i1 %202, label %polly.loop_exit764, label %vector.body975, !llvm.loop !103
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph992
  ...
  br i1 %231, label %polly.loop_exit791, label %vector.body989, !llvm.loop !106
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1010
  ...
  br i1 %260, label %polly.loop_exit817, label %vector.body1007, !llvm.loop !109
