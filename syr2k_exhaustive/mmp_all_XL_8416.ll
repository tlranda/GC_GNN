; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8416.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8416.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond778.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %123 = mul nuw nsw i64 %polly.indvar361, 20
  br label %polly.loop_header364

polly.loop_exit366:                               ; preds = %polly.loop_exit372
  %polly.indvar_next362 = add nuw nsw i64 %polly.indvar361, 1
  %exitcond794.not = icmp eq i64 %polly.indvar_next362, 60
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %124 = mul nuw nsw i64 %polly.indvar367, 20
  br label %polly.loop_header370

polly.loop_exit372:                               ; preds = %polly.loop_exit378
  %polly.indvar_next368 = add nuw nsw i64 %polly.indvar367, 1
  %indvars.iv.next783 = add nuw nsw i64 %indvars.iv782, 20
  %exitcond793.not = icmp eq i64 %polly.indvar_next368, 60
...
polly.loop_header376:                             ; preds = %polly.loop_exit384, %polly.loop_header370
  ...
  %smin786 = call i64 @llvm.smin.i64(i64 %indvars.iv784, i64 19)
...
polly.loop_exit384:                               ; preds = %polly.loop_header382
  ...
  %exitcond788.not = icmp eq i64 %polly.indvar_next380, 20
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %147 = mul nuw nsw i64 %polly.indvar514, 20
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond810.not = icmp eq i64 %polly.indvar_next515, 60
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %148 = mul nuw nsw i64 %polly.indvar520, 20
...
polly.loop_exit525:                               ; preds = %polly.loop_exit531
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next521, 60
...
polly.loop_exit537:                               ; preds = %polly.loop_header535
  ...
  %exitcond804.not = icmp eq i64 %polly.indvar_next533, 20
