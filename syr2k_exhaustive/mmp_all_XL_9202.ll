; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9202.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9202.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %indvars.iv791 = phi i64 [ %indvars.iv.next792, %polly.loop_exit213 ], [ 31, %polly.loop_header199 ]
  ...
  %107 = add nuw nsw i64 %106, 31
  %pexp.p_div_q = lshr i64 %107, 5
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %indvars.iv808 = phi i64 [ %indvars.iv.next809, %polly.loop_exit372 ], [ 31, %polly.loop_header356 ]
  ...
  %148 = shl nuw nsw i64 %indvars.iv808, 2
  %149 = and i64 %148, 9223372036854775680
  %150 = mul nuw nsw i64 %polly.indvar365, 7
  %151 = add nuw nsw i64 %150, 31
  %pexp.p_div_q368 = lshr i64 %151, 5
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %155 = mul nuw nsw i64 %polly.indvar365, 100
  %156 = mul nsw i64 %polly.indvar365, -100
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %indvars.iv828 = phi i64 [ %indvars.iv.next829, %polly.loop_exit532 ], [ 31, %polly.loop_header516 ]
  ...
  %192 = shl nuw nsw i64 %indvars.iv828, 2
  %193 = and i64 %192, 9223372036854775680
  %194 = mul nuw nsw i64 %polly.indvar525, 7
  %195 = add nuw nsw i64 %194, 31
  %pexp.p_div_q528 = lshr i64 %195, 5
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  ...
  %199 = mul nuw nsw i64 %polly.indvar525, 100
  %200 = mul nsw i64 %polly.indvar525, -100
