; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10238.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10238.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next788 = add nuw nsw i64 %indvars.iv787, 80
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv821 = phi i64 [ %indvars.iv.next822, %polly.loop_exit362 ], [ 4, %polly.loop_exit346 ]
  ...
  %129 = lshr i64 %indvars.iv821, 4
  %130 = mul nsw i64 %polly.indvar357, -80
  %131 = mul nuw nsw i64 %polly.indvar357, 80
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit369
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next805 = add nsw i64 %indvars.iv804, -80
  %indvars.iv.next810 = add nuw nsw i64 %indvars.iv809, 80
  %indvars.iv.next822 = add nuw nsw i64 %indvars.iv821, 5
  %exitcond825.not = icmp eq i64 %polly.indvar_next358, 15
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %polly.loop_guard377 = icmp slt i64 %137, 80
...
polly.loop_exit383:                               ; preds = %polly.loop_exit390.loopexit.us, %polly.loop_header374
  ...
  %polly.loop_cond380 = icmp ult i64 %polly.indvar378, 79
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv845 = phi i64 [ %indvars.iv.next846, %polly.loop_exit520 ], [ 4, %polly.loop_exit504 ]
  ...
  %161 = lshr i64 %indvars.iv845, 4
  %162 = mul nsw i64 %polly.indvar515, -80
  %163 = mul nuw nsw i64 %polly.indvar515, 80
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next829 = add nsw i64 %indvars.iv828, -80
  %indvars.iv.next834 = add nuw nsw i64 %indvars.iv833, 80
  %indvars.iv.next846 = add nuw nsw i64 %indvars.iv845, 5
  %exitcond849.not = icmp eq i64 %polly.indvar_next516, 15
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %polly.loop_guard535 = icmp slt i64 %169, 80
...
polly.loop_exit541:                               ; preds = %polly.loop_exit548.loopexit.us, %polly.loop_header532
  ...
  %polly.loop_cond538 = icmp ult i64 %polly.indvar536, 79
