; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6528.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6528.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next841 = add nsw i64 %indvars.iv840, -50
  %exitcond849.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_header233.us:                          ; preds = %polly.loop_exit242.us, %polly.loop_header227.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv844, i64 49)
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235.loopexit.us, %polly.loop_header221
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next225, 12
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %131 = mul nuw nsw i64 %polly.indvar373, 50
  br label %polly.loop_header376

polly.loop_exit378:                               ; preds = %polly.loop_exit384
  %132 = mul nsw i64 %polly.indvar373, -50
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar_next374, 24
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408.loopexit.us, %polly.loop_header393
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next397, 12
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %161 = mul nuw nsw i64 %polly.indvar547, 50
  br label %polly.loop_header550

polly.loop_exit552:                               ; preds = %polly.loop_exit558
  %162 = mul nsw i64 %polly.indvar547, -50
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %indvars.iv.next879 = add nuw nsw i64 %indvars.iv878, 50
  %indvars.iv.next884 = add nsw i64 %indvars.iv883, -50
  %exitcond893.not = icmp eq i64 %polly.indvar_next548, 24
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582.loopexit.us, %polly.loop_header567
  ...
  %exitcond892.not = icmp eq i64 %polly.indvar_next571, 12
