; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10488.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10488.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next203, 12
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %128 = mul nsw i64 %polly.indvar357, -100
  %129 = mul nuw nsw i64 %polly.indvar357, 100
...
polly.loop_exit362:                               ; preds = %polly.loop_exit368
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next358, 12
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %132 = mul nuw nsw i64 %polly.indvar369, 50
  %133 = add nsw i64 %132, %128
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard376 = icmp slt i64 %135, 100
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %159 = mul nsw i64 %polly.indvar514, -100
  %160 = mul nuw nsw i64 %polly.indvar514, 100
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %indvars.iv.next827 = add nsw i64 %indvars.iv826, -100
  %indvars.iv.next832 = add nuw nsw i64 %indvars.iv831, 100
  %indvars.iv.next844 = add nuw nsw i64 %indvars.iv843, 2
  %exitcond847.not = icmp eq i64 %polly.indvar_next515, 12
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %163 = mul nuw nsw i64 %polly.indvar526, 50
  %164 = add nsw i64 %163, %159
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard533 = icmp slt i64 %166, 100
