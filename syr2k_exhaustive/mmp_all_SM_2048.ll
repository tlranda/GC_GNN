; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2048.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2048.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit224 ], [ 4, %polly.loop_exit208 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1032 = add nuw nsw i64 %indvars.iv1031, 3
  %exitcond1034.not = icmp eq i64 %polly.indvar_next220, 24
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %polly.loop_guard = icmp slt i64 %111, 50
...
polly.loop_exit261:                               ; preds = %polly.loop_exit268.loopexit.us, %polly.loop_header228.split, %polly.loop_header259.preheader
  ...
  %polly.loop_cond233 = icmp ult i64 %polly.indvar231, 49
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit423 ], [ 4, %polly.loop_exit406 ]
  ...
  %151 = mul nsw i64 %polly.indvar417, -50
  %152 = mul nuw nsw i64 %polly.indvar417, 50
  %153 = lshr i64 %polly.indvar417, 3
  %154 = add nuw i64 %indvars.iv1057, %153
  %155 = mul nsw i64 %polly.indvar417, -50
  %156 = mul nuw nsw i64 %polly.indvar417, 50
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %indvars.iv.next1046 = add nuw nsw i64 %indvars.iv1045, 50
  %indvars.iv.next1058 = add nuw nsw i64 %indvars.iv1057, 3
  %exitcond1060.not = icmp eq i64 %polly.indvar_next418, 24
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %polly.loop_guard431 = icmp slt i64 %165, 50
...
polly.loop_exit466:                               ; preds = %polly.loop_exit473.loopexit.us, %polly.loop_header428.split, %polly.loop_header464.preheader
  ...
  %polly.loop_cond434 = icmp ult i64 %polly.indvar432, 49
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  %indvars.iv1083 = phi i64 [ %indvars.iv.next1084, %polly.loop_exit628 ], [ 4, %polly.loop_exit611 ]
  ...
  %205 = mul nsw i64 %polly.indvar622, -50
  %206 = mul nuw nsw i64 %polly.indvar622, 50
  %207 = lshr i64 %polly.indvar622, 3
  %208 = add nuw i64 %indvars.iv1083, %207
  %209 = mul nsw i64 %polly.indvar622, -50
  %210 = mul nuw nsw i64 %polly.indvar622, 50
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 3
  %exitcond1086.not = icmp eq i64 %polly.indvar_next623, 24
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %polly.loop_guard636 = icmp slt i64 %219, 50
...
polly.loop_exit671:                               ; preds = %polly.loop_exit678.loopexit.us, %polly.loop_header633.split, %polly.loop_header669.preheader
  ...
  %polly.loop_cond639 = icmp ult i64 %polly.indvar637, 49
