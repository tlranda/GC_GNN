; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6313.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6313.c"
...
polly.loop_header239:                             ; preds = %polly.loop_header233, %polly.loop_exit248
  ...
  %122 = add i64 %polly.indvar242, %112
  %123 = add i64 %122, %314
  %polly.loop_guard249951 = icmp sgt i64 %123, -1
...
vector.body1060:                                  ; preds = %vector.body1060, %vector.ph1064
  ...
  %134 = shl nuw nsw i64 %index1067, 3
  %135 = getelementptr i8, i8* %scevgep370, i64 %134
  %136 = bitcast i8* %135 to <4 x double>*
  %wide.load1071 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !79, !noalias !81
  %137 = fmul fast <4 x double> %wide.load1071, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %139 = icmp eq i64 %index.next1068, %n.vec1066
  br i1 %139, label %middle.block1058, label %vector.body1060, !llvm.loop !85

middle.block1058:                                 ; preds = %vector.body1060
  %cmp.n1070 = icmp eq i64 %132, %n.vec1066
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %149 = udiv i64 %indvars.iv878, 3
  %150 = mul nuw nsw i64 %149, 96
  %151 = add i64 %indvars.iv876, %150
  %152 = sub nsw i64 %indvars.iv883, %150
  %153 = shl nsw i64 %polly.indvar383, 8
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit394.7
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit411 ], [ %152, %polly.loop_exit394.7 ]
  %indvars.iv880 = phi i64 [ %indvars.iv.next881, %polly.loop_exit411 ], [ %151, %polly.loop_exit394.7 ]
  %polly.indvar406 = phi i64 [ %polly.indvar_next407, %polly.loop_exit411 ], [ %328, %polly.loop_exit394.7 ]
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  %indvars.iv887 = phi i64 [ %155, %polly.loop_header409 ], [ %indvars.iv.next888, %polly.loop_exit426 ]
  ...
  %166 = add i64 %polly.indvar420, %156
  %167 = add i64 %166, %325
  %polly.loop_guard427952 = icmp sgt i64 %167, -1
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1037 = icmp ult i64 %176, 4
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1038
  ...
  %178 = shl nuw nsw i64 %index1041, 3
  %179 = getelementptr i8, i8* %scevgep548, i64 %178
  %180 = bitcast i8* %179 to <4 x double>*
  %wide.load1045 = load <4 x double>, <4 x double>* %180, align 8, !alias.scope !89, !noalias !91
  %181 = fmul fast <4 x double> %wide.load1045, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %183 = icmp eq i64 %index.next1042, %n.vec1040
  br i1 %183, label %middle.block1034, label %vector.body1036, !llvm.loop !95

middle.block1034:                                 ; preds = %vector.body1036
  %cmp.n1044 = icmp eq i64 %176, %n.vec1040
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %193 = udiv i64 %indvars.iv902, 3
  %194 = mul nuw nsw i64 %193, 96
  %195 = add i64 %indvars.iv900, %194
  %196 = sub nsw i64 %indvars.iv907, %194
  %197 = shl nsw i64 %polly.indvar561, 8
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit572.7
  %indvars.iv909 = phi i64 [ %indvars.iv.next910, %polly.loop_exit589 ], [ %196, %polly.loop_exit572.7 ]
  %indvars.iv904 = phi i64 [ %indvars.iv.next905, %polly.loop_exit589 ], [ %195, %polly.loop_exit572.7 ]
  ...
  %199 = add i64 %smax906, %indvars.iv909
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  %indvars.iv911 = phi i64 [ %199, %polly.loop_header587 ], [ %indvars.iv.next912, %polly.loop_exit604 ]
  ...
  %210 = add i64 %polly.indvar598, %200
  %211 = add i64 %210, %336
  %polly.loop_guard605953 = icmp sgt i64 %211, -1
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin975 = call i64 @llvm.smin.i64(i64 %222, i64 -1168)
  %223 = add nsw i64 %smin975, 1200
  %smin942 = call i64 @llvm.smin.i64(i64 %indvars.iv940, i64 -1168)
  %224 = shl nsw i64 %polly.indvar761, 5
  %225 = add nsw i64 %smin942, 1199
...
vector.ph976:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert983 = insertelement <4 x i64> poison, i64 %224, i32 0
  %broadcast.splat984 = shufflevector <4 x i64> %broadcast.splatinsert983, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert985 = insertelement <4 x i32> poison, i32 %227, i32 0
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  %229 = add nuw nsw <4 x i64> %vec.ind981, %broadcast.splat984
  %230 = trunc <4 x i64> %229 to <4 x i32>
  %231 = mul <4 x i32> %broadcast.splat986, %230
  ...
  %241 = icmp eq i64 %index.next978, %223
  br i1 %241, label %polly.loop_exit772, label %vector.body974, !llvm.loop !104

polly.loop_exit772:                               ; preds = %vector.body974, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond947.not = icmp eq i64 %polly.indvar767, %221
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond943.not = icmp eq i64 %polly.indvar773, %225
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin990 = call i64 @llvm.smin.i64(i64 %251, i64 -968)
  %252 = add nsw i64 %smin990, 1000
  %smin932 = call i64 @llvm.smin.i64(i64 %indvars.iv930, i64 -968)
  %253 = shl nsw i64 %polly.indvar788, 5
  %254 = add nsw i64 %smin932, 999
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph992
  ...
  %258 = add nuw nsw <4 x i64> %vec.ind999, %broadcast.splat1002
  %259 = trunc <4 x i64> %258 to <4 x i32>
  %260 = mul <4 x i32> %broadcast.splat1004, %259
  ...
  %270 = icmp eq i64 %index.next996, %252
  br i1 %270, label %polly.loop_exit799, label %vector.body989, !llvm.loop !107

polly.loop_exit799:                               ; preds = %vector.body989, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond937.not = icmp eq i64 %polly.indvar794, %250
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond933.not = icmp eq i64 %polly.indvar800, %254
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1008 = call i64 @llvm.smin.i64(i64 %280, i64 -968)
  %281 = add nsw i64 %smin1008, 1000
  %smin922 = call i64 @llvm.smin.i64(i64 %indvars.iv920, i64 -968)
  %282 = shl nsw i64 %polly.indvar814, 5
  %283 = add nsw i64 %smin922, 999
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1010
  ...
  %287 = add nuw nsw <4 x i64> %vec.ind1017, %broadcast.splat1020
  %288 = trunc <4 x i64> %287 to <4 x i32>
  %289 = mul <4 x i32> %broadcast.splat1022, %288
  ...
  %299 = icmp eq i64 %index.next1014, %281
  br i1 %299, label %polly.loop_exit825, label %vector.body1007, !llvm.loop !110

polly.loop_exit825:                               ; preds = %vector.body1007, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond927.not = icmp eq i64 %polly.indvar820, %279
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond923.not = icmp eq i64 %polly.indvar826, %283
...
polly.loop_exit219.7:                             ; preds = %polly.loop_header217.7
  %314 = mul nsw i64 %polly.indvar208, -256
  %315 = mul nuw nsw i64 %polly.indvar208, 3
  %316 = add nuw nsw i64 %polly.indvar208, 2
  %pexp.p_div_q = udiv i64 %316, 3
  %317 = sub nsw i64 %315, %pexp.p_div_q
...
polly.loop_header392.1:                           ; preds = %polly.loop_header392, %polly.loop_header392.1
  ...
  %318 = add nuw nsw i64 %polly.indvar395.1, %153
...
polly.loop_header392.2:                           ; preds = %polly.loop_header392.1, %polly.loop_header392.2
  ...
  %319 = add nuw nsw i64 %polly.indvar395.2, %153
...
polly.loop_header392.3:                           ; preds = %polly.loop_header392.2, %polly.loop_header392.3
  ...
  %320 = add nuw nsw i64 %polly.indvar395.3, %153
...
polly.loop_header392.4:                           ; preds = %polly.loop_header392.3, %polly.loop_header392.4
  ...
  %321 = add nuw nsw i64 %polly.indvar395.4, %153
...
polly.loop_header392.5:                           ; preds = %polly.loop_header392.4, %polly.loop_header392.5
  ...
  %322 = add nuw nsw i64 %polly.indvar395.5, %153
...
polly.loop_header392.6:                           ; preds = %polly.loop_header392.5, %polly.loop_header392.6
  ...
  %323 = add nuw nsw i64 %polly.indvar395.6, %153
...
polly.loop_header392.7:                           ; preds = %polly.loop_header392.6, %polly.loop_header392.7
  ...
  %324 = add nuw nsw i64 %polly.indvar395.7, %153
...
polly.loop_exit394.7:                             ; preds = %polly.loop_header392.7
  %325 = mul nsw i64 %polly.indvar383, -256
  %326 = mul nuw nsw i64 %polly.indvar383, 3
  %327 = add nuw nsw i64 %polly.indvar383, 2
  %pexp.p_div_q402 = udiv i64 %327, 3
  %328 = sub nsw i64 %326, %pexp.p_div_q402
...
polly.loop_header570.1:                           ; preds = %polly.loop_header570, %polly.loop_header570.1
  ...
  %329 = add nuw nsw i64 %polly.indvar573.1, %197
  %polly.access.mul.call2577.1 = mul nuw nsw i64 %329, 1000
...
polly.loop_header570.2:                           ; preds = %polly.loop_header570.1, %polly.loop_header570.2
  ...
  %330 = add nuw nsw i64 %polly.indvar573.2, %197
  %polly.access.mul.call2577.2 = mul nuw nsw i64 %330, 1000
...
polly.loop_header570.3:                           ; preds = %polly.loop_header570.2, %polly.loop_header570.3
  ...
  %331 = add nuw nsw i64 %polly.indvar573.3, %197
  %polly.access.mul.call2577.3 = mul nuw nsw i64 %331, 1000
...
polly.loop_header570.4:                           ; preds = %polly.loop_header570.3, %polly.loop_header570.4
  ...
  %332 = add nuw nsw i64 %polly.indvar573.4, %197
  %polly.access.mul.call2577.4 = mul nuw nsw i64 %332, 1000
...
polly.loop_header570.5:                           ; preds = %polly.loop_header570.4, %polly.loop_header570.5
  ...
  %333 = add nuw nsw i64 %polly.indvar573.5, %197
  %polly.access.mul.call2577.5 = mul nuw nsw i64 %333, 1000
...
polly.loop_header570.6:                           ; preds = %polly.loop_header570.5, %polly.loop_header570.6
  ...
  %334 = add nuw nsw i64 %polly.indvar573.6, %197
  %polly.access.mul.call2577.6 = mul nuw nsw i64 %334, 1000
...
polly.loop_header570.7:                           ; preds = %polly.loop_header570.6, %polly.loop_header570.7
  ...
  %335 = add nuw nsw i64 %polly.indvar573.7, %197
  %polly.access.mul.call2577.7 = mul nuw nsw i64 %335, 1000
...
polly.loop_exit572.7:                             ; preds = %polly.loop_header570.7
  %336 = mul nsw i64 %polly.indvar561, -256
  %337 = mul nuw nsw i64 %polly.indvar561, 3
  %338 = add nuw nsw i64 %polly.indvar561, 2
  %pexp.p_div_q580 = udiv i64 %338, 3
  %339 = sub nsw i64 %337, %pexp.p_div_q580
