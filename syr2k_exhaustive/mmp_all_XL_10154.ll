; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10154.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10154.c"
...
vector.body890:                                   ; preds = %vector.body890, %vector.ph891
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call714, i64 %indvars.iv7.i, i64 %index892
...
vector.body953:                                   ; preds = %vector.body953, %vector.ph955
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call714, i64 %indvars.iv21.i, i64 %index958
...
vector.body976:                                   ; preds = %vector.body976, %vector.ph978
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call714, i64 %indvars.iv21.i52, i64 %index981
...
vector.body1002:                                  ; preds = %vector.body1002, %vector.ph1004
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call714, i64 %indvars.iv21.i91, i64 %index1007
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %98 = add nuw i64 %indvars.iv791, %97
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next785 = add nuw nsw i64 %indvars.iv784, 64
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %exitcond793.not = icmp eq i64 %polly.indvar208, %104
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %polly.loop_guard227873 = icmp sgt i64 %111, -1
  %112 = add nuw nsw i64 %polly.indvar214, %103
  %113 = mul i64 %112, 8000
  %114 = mul i64 %112, 9600
  br i1 %polly.loop_guard227873, label %polly.loop_header217.us, label %polly.loop_exit219
...
polly.loop_header336:                             ; preds = %kernel_syr2k.exit, %polly.loop_exit344
  %indvar989 = phi i64 [ %indvar.next990, %polly.loop_exit344 ], [ 0, %kernel_syr2k.exit ]
  %polly.indvar339 = phi i64 [ %polly.indvar_next340, %polly.loop_exit344 ], [ 1, %kernel_syr2k.exit ]
  %120 = add i64 %indvar989, 1
  %121 = mul nuw nsw i64 %polly.indvar339, 9600
  %scevgep348 = getelementptr i8, i8* %call, i64 %121
  %min.iters.check991 = icmp ult i64 %120, 4
  br i1 %min.iters.check991, label %polly.loop_header342.preheader, label %vector.ph992

vector.ph992:                                     ; preds = %polly.loop_header336
  %n.vec994 = and i64 %120, -4
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph992
  ...
  %122 = shl nuw nsw i64 %index995, 3
  %123 = getelementptr i8, i8* %scevgep348, i64 %122
  %124 = bitcast i8* %123 to <4 x double>*
  %wide.load999 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !69, !noalias !71
  %125 = fmul fast <4 x double> %wide.load999, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %127 = icmp eq i64 %index.next996, %n.vec994
  br i1 %127, label %middle.block986, label %vector.body988, !llvm.loop !74

middle.block986:                                  ; preds = %vector.body988
  %cmp.n998 = icmp eq i64 %120, %n.vec994
  br i1 %cmp.n998, label %polly.loop_exit344, label %polly.loop_header342.preheader

polly.loop_header342.preheader:                   ; preds = %polly.loop_header336, %middle.block986
  %polly.indvar345.ph = phi i64 [ 0, %polly.loop_header336 ], [ %n.vec994, %middle.block986 ]
  br label %polly.loop_header342

polly.loop_exit344:                               ; preds = %polly.loop_header342, %middle.block986
  %polly.indvar_next340 = add nuw nsw i64 %polly.indvar339, 1
  %exitcond817.not = icmp eq i64 %polly.indvar_next340, 1200
  %indvar.next990 = add i64 %indvar989, 1
  br i1 %exitcond817.not, label %polly.loop_header352, label %polly.loop_header336
...
polly.loop_header342:                             ; preds = %polly.loop_header342.preheader, %polly.loop_header342
  ...
  %exitcond816.not = icmp eq i64 %polly.indvar_next346, %polly.indvar339
  br i1 %exitcond816.not, label %polly.loop_exit344, label %polly.loop_header342, !llvm.loop !75

polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  %indvars.iv811 = phi i64 [ %indvars.iv.next812, %polly.loop_exit361 ], [ 0, %polly.loop_exit344 ]
  ...
  %129 = udiv i64 %polly.indvar355, 5
  %130 = add nuw i64 %indvars.iv811, %129
  %umin813 = call i64 @llvm.umin.i64(i64 %130, i64 56)
  %131 = mul nsw i64 %polly.indvar355, -64
  %132 = icmp slt i64 %131, -1136
  %133 = select i1 %132, i64 %131, i64 -1136
  %134 = add nsw i64 %133, 1199
  %135 = shl nsw i64 %polly.indvar355, 6
  %136 = add nuw nsw i64 %umin813, 3
...
polly.loop_exit361:                               ; preds = %polly.loop_exit368
  ...
  %exitcond815.not = icmp eq i64 %polly.indvar_next356, 19
  br i1 %exitcond815.not, label %kernel_syr2k.exit90, label %polly.loop_header352
...
polly.loop_header366.preheader:                   ; preds = %polly.loop_header359
  ...
  %141 = add i64 %smax801, %indvars.iv804
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375, %polly.loop_header359
  ...
  %indvars.iv.next800 = add nsw i64 %indvars.iv799, 20
  %indvars.iv.next805 = add nsw i64 %indvars.iv804, -20
  %exitcond814.not = icmp eq i64 %polly.indvar362, %136
  br i1 %exitcond814.not, label %polly.loop_exit361, label %polly.loop_header359

polly.loop_header366:                             ; preds = %polly.loop_header366.preheader, %polly.loop_exit375
  %indvars.iv806 = phi i64 [ %141, %polly.loop_header366.preheader ], [ %indvars.iv.next807, %polly.loop_exit375 ]
  %polly.indvar370 = phi i64 [ %140, %polly.loop_header366.preheader ], [ %polly.indvar_next371, %polly.loop_exit375 ]
  %smin808 = call i64 @llvm.smin.i64(i64 %indvars.iv806, i64 19)
  %143 = add nsw i64 %polly.indvar370, %142
  %polly.loop_guard383874 = icmp sgt i64 %143, -1
  %144 = add nuw nsw i64 %polly.indvar370, %135
  %145 = mul i64 %144, 8000
  %146 = mul i64 %144, 9600
  br i1 %polly.loop_guard383874, label %polly.loop_header373.us, label %polly.loop_exit375
...
polly.loop_header492:                             ; preds = %init_array.exit, %polly.loop_exit500
  ...
  %min.iters.check965 = icmp ult i64 %152, 4
  br i1 %min.iters.check965, label %polly.loop_header498.preheader, label %vector.ph966

vector.ph966:                                     ; preds = %polly.loop_header492
  %n.vec968 = and i64 %152, -4
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph966
  ...
  %154 = shl nuw nsw i64 %index969, 3
  %155 = getelementptr i8, i8* %scevgep504, i64 %154
  %156 = bitcast i8* %155 to <4 x double>*
  %wide.load973 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !78, !noalias !80
  %157 = fmul fast <4 x double> %wide.load973, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %159 = icmp eq i64 %index.next970, %n.vec968
  br i1 %159, label %middle.block962, label %vector.body964, !llvm.loop !83

middle.block962:                                  ; preds = %vector.body964
  %cmp.n972 = icmp eq i64 %152, %n.vec968
  br i1 %cmp.n972, label %polly.loop_exit500, label %polly.loop_header498.preheader

polly.loop_header498.preheader:                   ; preds = %polly.loop_header492, %middle.block962
  %polly.indvar501.ph = phi i64 [ 0, %polly.loop_header492 ], [ %n.vec968, %middle.block962 ]
  br label %polly.loop_header498

polly.loop_exit500:                               ; preds = %polly.loop_header498, %middle.block962
  %polly.indvar_next496 = add nuw nsw i64 %polly.indvar495, 1
  %exitcond838.not = icmp eq i64 %polly.indvar_next496, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond838.not, label %polly.loop_header508, label %polly.loop_header492
...
polly.loop_header498:                             ; preds = %polly.loop_header498.preheader, %polly.loop_header498
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar_next502, %polly.indvar495
  br i1 %exitcond837.not, label %polly.loop_exit500, label %polly.loop_header498, !llvm.loop !84

polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  %indvars.iv832 = phi i64 [ %indvars.iv.next833, %polly.loop_exit517 ], [ 0, %polly.loop_exit500 ]
  %indvars.iv823 = phi i64 [ %indvars.iv.next824, %polly.loop_exit517 ], [ 0, %polly.loop_exit500 ]
  %indvars.iv818 = phi i64 [ %indvars.iv.next819, %polly.loop_exit517 ], [ 0, %polly.loop_exit500 ]
  %polly.indvar511 = phi i64 [ %polly.indvar_next512, %polly.loop_exit517 ], [ 0, %polly.loop_exit500 ]
  %161 = udiv i64 %polly.indvar511, 5
  %162 = add nuw i64 %indvars.iv832, %161
  %umin834 = call i64 @llvm.umin.i64(i64 %162, i64 56)
  %163 = mul nsw i64 %polly.indvar511, -64
  %164 = icmp slt i64 %163, -1136
  %165 = select i1 %164, i64 %163, i64 -1136
  %166 = add nsw i64 %165, 1199
  %167 = shl nsw i64 %polly.indvar511, 6
  %168 = add nuw nsw i64 %umin834, 3
...
polly.loop_exit517:                               ; preds = %polly.loop_exit524
  ...
  %indvars.iv.next833 = add nuw nsw i64 %indvars.iv832, 3
  %exitcond836.not = icmp eq i64 %polly.indvar_next512, 19
  br i1 %exitcond836.not, label %kernel_syr2k.exit, label %polly.loop_header508
...
polly.loop_header515:                             ; preds = %polly.loop_exit524, %polly.loop_header508
  ...
  %indvars.iv820 = phi i64 [ %indvars.iv.next821, %polly.loop_exit524 ], [ %indvars.iv818, %polly.loop_header508 ]
...
polly.loop_header522.preheader:                   ; preds = %polly.loop_header515
  ...
  %173 = add i64 %smax822, %indvars.iv825
...
polly.loop_exit524:                               ; preds = %polly.loop_exit531, %polly.loop_header515
  ...
  %indvars.iv.next821 = add nsw i64 %indvars.iv820, 20
  %indvars.iv.next826 = add nsw i64 %indvars.iv825, -20
  %exitcond835.not = icmp eq i64 %polly.indvar518, %168
  br i1 %exitcond835.not, label %polly.loop_exit517, label %polly.loop_header515

polly.loop_header522:                             ; preds = %polly.loop_header522.preheader, %polly.loop_exit531
  %indvars.iv827 = phi i64 [ %173, %polly.loop_header522.preheader ], [ %indvars.iv.next828, %polly.loop_exit531 ]
  %polly.indvar526 = phi i64 [ %172, %polly.loop_header522.preheader ], [ %polly.indvar_next527, %polly.loop_exit531 ]
  %smin829 = call i64 @llvm.smin.i64(i64 %indvars.iv827, i64 19)
  %175 = add nsw i64 %polly.indvar526, %174
  %polly.loop_guard539875 = icmp sgt i64 %175, -1
  %176 = add nuw nsw i64 %polly.indvar526, %167
  %177 = mul i64 %176, 8000
  %178 = mul i64 %176, 9600
  br i1 %polly.loop_guard539875, label %polly.loop_header529.us, label %polly.loop_exit531
...
polly.loop_header536.us:                          ; preds = %polly.loop_header536.us, %polly.loop_header529.us
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar540.us, %smin829
  br i1 %exitcond830.not, label %polly.loop_exit538.loopexit.us, label %polly.loop_header536.us

polly.loop_exit538.loopexit.us:                   ; preds = %polly.loop_header536.us
  %polly.indvar_next533.us = add nuw nsw i64 %polly.indvar532.us, 1
  %exitcond831.not = icmp eq i64 %polly.indvar_next533.us, 1000
  br i1 %exitcond831.not, label %polly.loop_exit531, label %polly.loop_header529.us
...
polly.loop_header688:                             ; preds = %entry, %polly.loop_exit696
  %indvars.iv863 = phi i64 [ %indvars.iv.next864, %polly.loop_exit696 ], [ 0, %entry ]
...
polly.loop_exit696:                               ; preds = %polly.loop_exit702
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar_next692, 38
  br i1 %exitcond868.not, label %polly.loop_header715, label %polly.loop_header688

polly.loop_header694:                             ; preds = %polly.loop_exit702, %polly.loop_header688
  %indvars.iv859 = phi i64 [ %indvars.iv.next860, %polly.loop_exit702 ], [ 0, %polly.loop_header688 ]
  %polly.indvar697 = phi i64 [ %polly.indvar_next698, %polly.loop_exit702 ], [ 0, %polly.loop_header688 ]
  %186 = mul nsw i64 %polly.indvar697, -32
  %smin903 = call i64 @llvm.smin.i64(i64 %186, i64 -1168)
  %187 = add nsw i64 %smin903, 1200
  %smin861 = call i64 @llvm.smin.i64(i64 %indvars.iv859, i64 -1168)
  %188 = shl nsw i64 %polly.indvar697, 5
  %189 = add nsw i64 %smin861, 1199
...
polly.loop_exit702:                               ; preds = %polly.loop_exit708
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next698, 38
  br i1 %exitcond867.not, label %polly.loop_exit696, label %polly.loop_header694
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  br i1 %min.iters.check, label %polly.loop_header706, label %vector.ph904

vector.ph904:                                     ; preds = %polly.loop_header700
  %broadcast.splatinsert911 = insertelement <4 x i64> poison, i64 %188, i32 0
  %broadcast.splat912 = shufflevector <4 x i64> %broadcast.splatinsert911, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert913 = insertelement <4 x i32> poison, i32 %191, i32 0
...
vector.body902:                                   ; preds = %vector.body902, %vector.ph904
  ...
  %193 = add nuw nsw <4 x i64> %vec.ind909, %broadcast.splat912
  %194 = trunc <4 x i64> %193 to <4 x i32>
  %195 = mul <4 x i32> %broadcast.splat914, %194
  ...
  %205 = icmp eq i64 %index.next906, %187
  br i1 %205, label %polly.loop_exit708, label %vector.body902, !llvm.loop !92

polly.loop_exit708:                               ; preds = %vector.body902, %polly.loop_header706
  %polly.indvar_next704 = add nuw nsw i64 %polly.indvar703, 1
  %exitcond866.not = icmp eq i64 %polly.indvar703, %185
  br i1 %exitcond866.not, label %polly.loop_exit702, label %polly.loop_header700
...
polly.loop_header706:                             ; preds = %polly.loop_header700, %polly.loop_header706
  ...
  %exitcond862.not = icmp eq i64 %polly.indvar709, %189
  br i1 %exitcond862.not, label %polly.loop_exit708, label %polly.loop_header706, !llvm.loop !93

polly.loop_header715:                             ; preds = %polly.loop_exit696, %polly.loop_exit723
  %indvars.iv853 = phi i64 [ %indvars.iv.next854, %polly.loop_exit723 ], [ 0, %polly.loop_exit696 ]
...
polly.loop_exit723:                               ; preds = %polly.loop_exit729
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar_next719, 38
  br i1 %exitcond858.not, label %polly.loop_header741, label %polly.loop_header715

polly.loop_header721:                             ; preds = %polly.loop_exit729, %polly.loop_header715
  %indvars.iv849 = phi i64 [ %indvars.iv.next850, %polly.loop_exit729 ], [ 0, %polly.loop_header715 ]
  %polly.indvar724 = phi i64 [ %polly.indvar_next725, %polly.loop_exit729 ], [ 0, %polly.loop_header715 ]
  %215 = mul nsw i64 %polly.indvar724, -32
  %smin918 = call i64 @llvm.smin.i64(i64 %215, i64 -968)
  %216 = add nsw i64 %smin918, 1000
  %smin851 = call i64 @llvm.smin.i64(i64 %indvars.iv849, i64 -968)
  %217 = shl nsw i64 %polly.indvar724, 5
  %218 = add nsw i64 %smin851, 999
...
polly.loop_exit729:                               ; preds = %polly.loop_exit735
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar_next725, 32
  br i1 %exitcond857.not, label %polly.loop_exit723, label %polly.loop_header721
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %min.iters.check919 = icmp eq i64 %216, 0
  br i1 %min.iters.check919, label %polly.loop_header733, label %vector.ph920

vector.ph920:                                     ; preds = %polly.loop_header727
  %broadcast.splatinsert929 = insertelement <4 x i64> poison, i64 %217, i32 0
  %broadcast.splat930 = shufflevector <4 x i64> %broadcast.splatinsert929, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert931 = insertelement <4 x i32> poison, i32 %220, i32 0
...
vector.body917:                                   ; preds = %vector.body917, %vector.ph920
  ...
  %222 = add nuw nsw <4 x i64> %vec.ind927, %broadcast.splat930
  %223 = trunc <4 x i64> %222 to <4 x i32>
  %224 = mul <4 x i32> %broadcast.splat932, %223
  ...
  %234 = icmp eq i64 %index.next924, %216
  br i1 %234, label %polly.loop_exit735, label %vector.body917, !llvm.loop !95

polly.loop_exit735:                               ; preds = %vector.body917, %polly.loop_header733
  %polly.indvar_next731 = add nuw nsw i64 %polly.indvar730, 1
  %exitcond856.not = icmp eq i64 %polly.indvar730, %214
  br i1 %exitcond856.not, label %polly.loop_exit729, label %polly.loop_header727
...
polly.loop_header733:                             ; preds = %polly.loop_header727, %polly.loop_header733
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar736, %218
  br i1 %exitcond852.not, label %polly.loop_exit735, label %polly.loop_header733, !llvm.loop !96

polly.loop_header741:                             ; preds = %polly.loop_exit723, %polly.loop_exit749
  %indvars.iv843 = phi i64 [ %indvars.iv.next844, %polly.loop_exit749 ], [ 0, %polly.loop_exit723 ]
...
polly.loop_exit749:                               ; preds = %polly.loop_exit755
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next745, 38
  br i1 %exitcond848.not, label %init_array.exit, label %polly.loop_header741

polly.loop_header747:                             ; preds = %polly.loop_exit755, %polly.loop_header741
  %indvars.iv839 = phi i64 [ %indvars.iv.next840, %polly.loop_exit755 ], [ 0, %polly.loop_header741 ]
  %polly.indvar750 = phi i64 [ %polly.indvar_next751, %polly.loop_exit755 ], [ 0, %polly.loop_header741 ]
  %244 = mul nsw i64 %polly.indvar750, -32
  %smin936 = call i64 @llvm.smin.i64(i64 %244, i64 -968)
  %245 = add nsw i64 %smin936, 1000
  %smin841 = call i64 @llvm.smin.i64(i64 %indvars.iv839, i64 -968)
  %246 = shl nsw i64 %polly.indvar750, 5
  %247 = add nsw i64 %smin841, 999
...
polly.loop_exit755:                               ; preds = %polly.loop_exit761
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar_next751, 32
  br i1 %exitcond847.not, label %polly.loop_exit749, label %polly.loop_header747
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %min.iters.check937 = icmp eq i64 %245, 0
  br i1 %min.iters.check937, label %polly.loop_header759, label %vector.ph938

vector.ph938:                                     ; preds = %polly.loop_header753
  %broadcast.splatinsert947 = insertelement <4 x i64> poison, i64 %246, i32 0
  %broadcast.splat948 = shufflevector <4 x i64> %broadcast.splatinsert947, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert949 = insertelement <4 x i32> poison, i32 %249, i32 0
...
vector.body935:                                   ; preds = %vector.body935, %vector.ph938
  ...
  %251 = add nuw nsw <4 x i64> %vec.ind945, %broadcast.splat948
  %252 = trunc <4 x i64> %251 to <4 x i32>
  %253 = mul <4 x i32> %broadcast.splat950, %252
  ...
  %263 = icmp eq i64 %index.next942, %245
  br i1 %263, label %polly.loop_exit761, label %vector.body935, !llvm.loop !98

polly.loop_exit761:                               ; preds = %vector.body935, %polly.loop_header759
  %polly.indvar_next757 = add nuw nsw i64 %polly.indvar756, 1
  %exitcond846.not = icmp eq i64 %polly.indvar756, %243
  br i1 %exitcond846.not, label %polly.loop_exit755, label %polly.loop_header753
...
polly.loop_header759:                             ; preds = %polly.loop_header753, %polly.loop_header759
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar762, %247
  br i1 %exitcond842.not, label %polly.loop_exit761, label %polly.loop_header759, !llvm.loop !99
}
