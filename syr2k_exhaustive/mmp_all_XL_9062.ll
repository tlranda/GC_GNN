; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9062.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9062.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond791.not = icmp eq i64 %polly.indvar_next203, 300
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %indvars.iv782 = phi i64 [ %indvars.iv.next783, %polly.loop_exit213 ], [ %99, %polly.loop_header199 ]
  ...
  %103 = add i64 %smax, %indvars.iv786
  %104 = mul nuw nsw i64 %polly.indvar208, 96
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %indvars.iv.next783 = add i64 %indvars.iv782, -96
  %indvars.iv.next787 = add i64 %indvars.iv786, 96
...
polly.loop_exit219:                               ; preds = %polly.loop_exit226
  ...
  %exitcond790.not = icmp eq i64 %polly.indvar_next215, 1000
  br i1 %exitcond790.not, label %polly.loop_exit213, label %polly.loop_header211

polly.loop_header217:                             ; preds = %polly.loop_exit226, %polly.loop_header211
  %indvars.iv788 = phi i64 [ %indvars.iv.next789, %polly.loop_exit226 ], [ %103, %polly.loop_header211 ]
  %polly.indvar220 = phi i64 [ %polly.indvar_next221, %polly.loop_exit226 ], [ %107, %polly.loop_header211 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv788, i64 3)
...
polly.loop_header342:                             ; preds = %polly.loop_header342.preheader, %polly.loop_header342
  ...
  br i1 %exitcond809.not, label %polly.loop_exit344, label %polly.loop_header342, !llvm.loop !78
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %130 = udiv i64 %polly.indvar355, 24
  %131 = mul nuw nsw i64 %130, 96
  %132 = sub nsw i64 %indvars.iv794, %131
  %133 = add i64 %indvars.iv799, %131
  %pexp.p_div_q358.lhs.trunc = trunc i64 %polly.indvar355 to i16
  %pexp.p_div_q358769 = udiv i16 %pexp.p_div_q358.lhs.trunc, 24
  %pexp.p_div_q358.zext = zext i16 %pexp.p_div_q358769 to i64
  %134 = shl nsw i64 %polly.indvar355, 2
  %135 = mul nsw i64 %polly.indvar355, -4
...
polly.loop_header359:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  %indvars.iv801 = phi i64 [ %indvars.iv.next802, %polly.loop_exit367 ], [ %133, %polly.loop_header352 ]
  %indvars.iv796 = phi i64 [ %indvars.iv.next797, %polly.loop_exit367 ], [ %132, %polly.loop_header352 ]
  ...
  %136 = add i64 %smax798, %indvars.iv801
  %137 = mul nuw nsw i64 %polly.indvar362, 96
  %138 = sub nsw i64 %134, %137
  %139 = icmp sgt i64 %138, 0
  %140 = select i1 %139, i64 %138, i64 0
  %141 = mul nsw i64 %polly.indvar362, -96
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header359
  ...
  %indvars.iv.next802 = add i64 %indvars.iv801, 96
...
polly.loop_exit374:                               ; preds = %polly.loop_exit382
  ...
  %exitcond807.not = icmp eq i64 %polly.indvar_next369, 1000
  br i1 %exitcond807.not, label %polly.loop_exit367, label %polly.loop_header365

polly.loop_header372:                             ; preds = %polly.loop_exit382, %polly.loop_header365
  %indvars.iv803 = phi i64 [ %indvars.iv.next804, %polly.loop_exit382 ], [ %136, %polly.loop_header365 ]
  %polly.indvar376 = phi i64 [ %polly.indvar_next377, %polly.loop_exit382 ], [ %140, %polly.loop_header365 ]
  %smin805 = call i64 @llvm.smin.i64(i64 %indvars.iv803, i64 3)
...
polly.loop_header380:                             ; preds = %polly.loop_header380.preheader, %polly.loop_header380
  ...
  %exitcond806.not = icmp eq i64 %polly.indvar384, %smin805
  br i1 %exitcond806.not, label %polly.loop_exit382, label %polly.loop_header380
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %163 = udiv i64 %polly.indvar511, 24
  %164 = mul nuw nsw i64 %163, 96
  %165 = sub nsw i64 %indvars.iv811, %164
  %166 = add i64 %indvars.iv816, %164
  %pexp.p_div_q514.lhs.trunc = trunc i64 %polly.indvar511 to i16
  %pexp.p_div_q514768 = udiv i16 %pexp.p_div_q514.lhs.trunc, 24
  %pexp.p_div_q514.zext = zext i16 %pexp.p_div_q514768 to i64
  %167 = shl nsw i64 %polly.indvar511, 2
  %168 = mul nsw i64 %polly.indvar511, -4
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next817 = add nsw i64 %indvars.iv816, -4
...
polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  %indvars.iv818 = phi i64 [ %indvars.iv.next819, %polly.loop_exit523 ], [ %166, %polly.loop_header508 ]
  %indvars.iv813 = phi i64 [ %indvars.iv.next814, %polly.loop_exit523 ], [ %165, %polly.loop_header508 ]
  ...
  %169 = add i64 %smax815, %indvars.iv818
  %170 = mul nuw nsw i64 %polly.indvar518, 96
  %171 = sub nsw i64 %167, %170
  %172 = icmp sgt i64 %171, 0
  %173 = select i1 %172, i64 %171, i64 0
  %174 = mul nsw i64 %polly.indvar518, -96
...
polly.loop_exit530:                               ; preds = %polly.loop_exit538
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next525, 1000
...
polly.loop_header528:                             ; preds = %polly.loop_exit538, %polly.loop_header521
  %indvars.iv820 = phi i64 [ %indvars.iv.next821, %polly.loop_exit538 ], [ %169, %polly.loop_header521 ]
...
polly.loop_header536:                             ; preds = %polly.loop_header536.preheader, %polly.loop_header536
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar540, %smin822
  br i1 %exitcond823.not, label %polly.loop_exit538, label %polly.loop_header536
