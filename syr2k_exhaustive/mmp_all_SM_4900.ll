; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4900.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4900.c"
...
vector.body1192:                                  ; preds = %vector.body1192, %vector.ph1196
  ...
  %wide.load1203 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %132, label %middle.block1190, label %vector.body1192, !llvm.loop !79
...
polly.loop_header399.preheader:                   ; preds = %polly.loop_header391
  %139 = mul nuw nsw i64 %polly.indvar394, 50
...
vector.body1168:                                  ; preds = %vector.body1168, %vector.ph1170
  ...
  %wide.load1177 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %169, label %middle.block1166, label %vector.body1168, !llvm.loop !89
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %176 = mul nuw nsw i64 %polly.indvar587, 50
...
vector.body1107:                                  ; preds = %vector.body1107, %vector.ph1108
  ...
  br i1 %220, label %polly.loop_exit813, label %vector.body1107, !llvm.loop !98
...
vector.body1121:                                  ; preds = %vector.body1121, %vector.ph1124
  ...
  br i1 %249, label %polly.loop_exit840, label %vector.body1121, !llvm.loop !101
...
vector.body1139:                                  ; preds = %vector.body1139, %vector.ph1142
  ...
  br i1 %278, label %polly.loop_exit866, label %vector.body1139, !llvm.loop !104
