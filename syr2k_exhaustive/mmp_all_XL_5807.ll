; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5807.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5807.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit223
  ...
  %indvars.iv838 = phi i64 [ 4, %polly.loop_header199.preheader ], [ %indvars.iv.next839, %polly.loop_exit223 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %103 = mul nuw nsw i64 %polly.indvar202, 13
  %104 = add nuw nsw i64 %polly.indvar202, 4
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %108 = mul nsw i64 %polly.indvar224, 20
...
polly.loop_header233.us:                          ; preds = %polly.loop_exit242.us, %polly.loop_header227.us
  ...
  %113 = add i64 %polly.indvar236.us, %108
  %114 = add i64 %113, %102
...
polly.loop_header240.us:                          ; preds = %polly.loop_header240.preheader.us, %polly.loop_header240.us
  ...
  %115 = add nuw nsw i64 %polly.indvar244.us, %101
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %indvars.iv859 = phi i64 [ 4, %polly.loop_header370.preheader ], [ %indvars.iv.next860, %polly.loop_exit395 ]
  ...
  %130 = udiv i64 %indvars.iv859, 5
  %131 = mul nuw nsw i64 %130, 20
  %132 = add i64 %indvars.iv857, %131
  %133 = sub nsw i64 %indvars.iv864, %131
  %134 = shl nsw i64 %polly.indvar373, 8
  br label %polly.loop_header376

polly.loop_exit378:                               ; preds = %polly.loop_exit384
  %135 = mul nsw i64 %polly.indvar373, -256
  %136 = mul nuw nsw i64 %polly.indvar373, 13
  %137 = add nuw nsw i64 %polly.indvar373, 4
  %pexp.p_div_q392 = udiv i64 %137, 5
  %138 = sub nsw i64 %136, %pexp.p_div_q392
...
polly.loop_header382:                             ; preds = %polly.loop_header382, %polly.loop_header376
  ...
  %139 = add nuw nsw i64 %polly.indvar385, %134
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  %indvars.iv866 = phi i64 [ %indvars.iv.next867, %polly.loop_exit401 ], [ %133, %polly.loop_exit378 ]
  %indvars.iv861 = phi i64 [ %indvars.iv.next862, %polly.loop_exit401 ], [ %132, %polly.loop_exit378 ]
  ...
  %141 = mul nsw i64 %polly.indvar396, 20
...
polly.loop_header406.us:                          ; preds = %polly.loop_exit416.us, %polly.loop_header399.us
  ...
  %146 = add i64 %polly.indvar410.us, %141
  %147 = add i64 %146, %135
...
polly.loop_header414.us:                          ; preds = %polly.loop_header414.preheader.us, %polly.loop_header414.us
  ...
  %148 = add nuw nsw i64 %polly.indvar418.us, %134
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408.loopexit.us, %polly.loop_header393
  ...
  %polly.loop_cond398 = icmp slt i64 %polly.indvar396, 59
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %indvars.iv882 = phi i64 [ 4, %polly.loop_header544.preheader ], [ %indvars.iv.next883, %polly.loop_exit569 ]
  ...
  %163 = udiv i64 %indvars.iv882, 5
  %164 = mul nuw nsw i64 %163, 20
  %165 = add i64 %indvars.iv880, %164
  %166 = sub nsw i64 %indvars.iv887, %164
  %167 = shl nsw i64 %polly.indvar547, 8
  br label %polly.loop_header550

polly.loop_exit552:                               ; preds = %polly.loop_exit558
  %168 = mul nsw i64 %polly.indvar547, -256
  %169 = mul nuw nsw i64 %polly.indvar547, 13
  %170 = add nuw nsw i64 %polly.indvar547, 4
  %pexp.p_div_q566 = udiv i64 %170, 5
  %171 = sub nsw i64 %169, %pexp.p_div_q566
...
polly.loop_header556:                             ; preds = %polly.loop_header556, %polly.loop_header550
  ...
  %172 = add nuw nsw i64 %polly.indvar559, %167
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  %indvars.iv889 = phi i64 [ %indvars.iv.next890, %polly.loop_exit575 ], [ %166, %polly.loop_exit552 ]
  %indvars.iv884 = phi i64 [ %indvars.iv.next885, %polly.loop_exit575 ], [ %165, %polly.loop_exit552 ]
  ...
  %174 = mul nsw i64 %polly.indvar570, 20
...
polly.loop_header580.us:                          ; preds = %polly.loop_exit590.us, %polly.loop_header573.us
  ...
  %179 = add i64 %polly.indvar584.us, %174
  %180 = add i64 %179, %168
...
polly.loop_header588.us:                          ; preds = %polly.loop_header588.preheader.us, %polly.loop_header588.us
  ...
  %181 = add nuw nsw i64 %polly.indvar592.us, %167
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582.loopexit.us, %polly.loop_header567
  ...
  %polly.loop_cond572 = icmp slt i64 %polly.indvar570, 59
