; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9581.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9581.c"
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph972
  ...
  br i1 %57, label %middle.block968, label %vector.body970, !llvm.loop !49
...
vector.body996:                                   ; preds = %vector.body996, %vector.ph998
  ...
  br i1 %68, label %middle.block994, label %vector.body996, !llvm.loop !51
...
vector.body1008:                                  ; preds = %vector.body1008, %vector.ph1012
  ...
  %wide.load1019 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !57, !noalias !59
  ...
  br i1 %95, label %middle.block1006, label %vector.body1008, !llvm.loop !62
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond791.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !63
...
polly.loop_exit225:                               ; preds = %polly.loop_exit231.loopexit.us, %polly.loop_header217
  ...
  %exitcond785.not = icmp eq i64 %polly.indvar_next221, 16
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph986
  ...
  %wide.load993 = load <4 x double>, <4 x double>* %118, align 8, !alias.scope !67, !noalias !69
  ...
  store <4 x double> %119, <4 x double>* %120, align 8, !alias.scope !67, !noalias !69
  %index.next990 = add i64 %index989, 4
  %121 = icmp eq i64 %index.next990, %n.vec988
  br i1 %121, label %middle.block980, label %vector.body982, !llvm.loop !72
...
polly.loop_header342:                             ; preds = %polly.loop_header342.preheader, %polly.loop_header342
  ...
  br i1 %exitcond811.not, label %polly.loop_exit344, label %polly.loop_header342, !llvm.loop !73
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %123 = shl nsw i64 %polly.indvar355, 4
...
polly.loop_exit360:                               ; preds = %polly.loop_exit366
  ...
  %exitcond810.not = icmp eq i64 %polly.indvar_next356, 75
...
polly.loop_header370:                             ; preds = %polly.loop_exit378, %polly.loop_header364
  ...
  %smin799 = call i64 @llvm.smin.i64(i64 %indvars.iv797, i64 15)
...
polly.loop_exit378:                               ; preds = %polly.loop_exit385.loopexit.us, %polly.loop_header370
  ...
  %exitcond805.not = icmp eq i64 %polly.indvar_next374, 16
...
vector.body958:                                   ; preds = %vector.body958, %vector.ph960
  ...
  %wide.load967 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !76, !noalias !78
  ...
  store <4 x double> %145, <4 x double>* %146, align 8, !alias.scope !76, !noalias !78
  %index.next964 = add i64 %index963, 4
  %147 = icmp eq i64 %index.next964, %n.vec962
  br i1 %147, label %middle.block956, label %vector.body958, !llvm.loop !81
...
polly.loop_header497:                             ; preds = %polly.loop_header497.preheader, %polly.loop_header497
  ...
  br i1 %exitcond831.not, label %polly.loop_exit499, label %polly.loop_header497, !llvm.loop !82
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %149 = shl nsw i64 %polly.indvar510, 4
...
polly.loop_exit515:                               ; preds = %polly.loop_exit521
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar_next511, 75
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %152 = shl nsw i64 %polly.indvar522, 4
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header519
  ...
  %smin819 = call i64 @llvm.smin.i64(i64 %indvars.iv817, i64 15)
...
polly.loop_exit533:                               ; preds = %polly.loop_exit540.loopexit.us, %polly.loop_header525
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next529, 16
...
vector.body896:                                   ; preds = %vector.body896, %vector.ph898
  ...
  store <4 x double> %181, <4 x double>* %186, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %187, label %polly.loop_exit706, label %vector.body896, !llvm.loop !90
...
polly.loop_header704:                             ; preds = %polly.loop_header698, %polly.loop_header704
  ...
  br i1 %exitcond856.not, label %polly.loop_exit706, label %polly.loop_header704, !llvm.loop !91
...
vector.body911:                                   ; preds = %vector.body911, %vector.ph914
  ...
  store <4 x double> %210, <4 x double>* %215, align 8, !alias.scope !89, !noalias !92
  ...
  br i1 %216, label %polly.loop_exit733, label %vector.body911, !llvm.loop !93
...
polly.loop_header731:                             ; preds = %polly.loop_header725, %polly.loop_header731
  ...
  br i1 %exitcond846.not, label %polly.loop_exit733, label %polly.loop_header731, !llvm.loop !94
...
vector.body929:                                   ; preds = %vector.body929, %vector.ph932
  ...
  store <4 x double> %239, <4 x double>* %244, align 8, !alias.scope !88, !noalias !95
  ...
  br i1 %245, label %polly.loop_exit759, label %vector.body929, !llvm.loop !96
...
polly.loop_header757:                             ; preds = %polly.loop_header751, %polly.loop_header757
  ...
  br i1 %exitcond836.not, label %polly.loop_exit759, label %polly.loop_header757, !llvm.loop !97
}
