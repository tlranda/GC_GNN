; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6044.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6044.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_header233:                             ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv823, i64 49)
...
polly.loop_exit392:                               ; preds = %polly.loop_exit398
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar_next372, 24
...
polly.loop_header390.preheader:                   ; preds = %polly.loop_exit382
  %120 = mul nsw i64 %polly.indvar371, -50
...
polly.loop_header390:                             ; preds = %polly.loop_header390.preheader, %polly.loop_exit398
  ...
  %122 = mul nuw nsw i64 %polly.indvar393, 50
...
polly.loop_header402:                             ; preds = %polly.loop_exit410, %polly.loop_header396
  ...
  %smin840 = call i64 @llvm.smin.i64(i64 %indvars.iv838, i64 49)
...
polly.loop_exit561:                               ; preds = %polly.loop_exit567
  ...
  %indvars.iv.next849 = add nsw i64 %indvars.iv848, -50
  %exitcond861.not = icmp eq i64 %polly.indvar_next541, 24
...
polly.loop_header559.preheader:                   ; preds = %polly.loop_exit551
  %142 = mul nsw i64 %polly.indvar540, -50
...
polly.loop_header559:                             ; preds = %polly.loop_header559.preheader, %polly.loop_exit567
  ...
  %144 = mul nuw nsw i64 %polly.indvar562, 50
