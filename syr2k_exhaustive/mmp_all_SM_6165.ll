; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6165.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6165.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit223
  ...
  %indvars.iv844 = phi i64 [ 31, %polly.loop_header199.preheader ], [ %indvars.iv.next845, %polly.loop_exit223 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %103 = mul nuw nsw i64 %polly.indvar202, 7
  %104 = add nuw nsw i64 %103, 31
  %pexp.p_div_q = lshr i64 %104, 5
  %105 = sub nsw i64 %polly.indvar202, %pexp.p_div_q
  %polly.loop_guard = icmp slt i64 %105, 19
...
polly.loop_header211:                             ; preds = %polly.loop_header211, %polly.loop_header205
  ...
  %106 = add nuw nsw i64 %polly.indvar214, %101
...
polly.loop_header221:                             ; preds = %polly.loop_exit207, %polly.loop_exit229
  ...
  %107 = add i64 %smax, %indvars.iv850
  %108 = shl nsw i64 %polly.indvar224, 6
  %109 = sub nsw i64 %101, %108
  %110 = icmp sgt i64 %109, 0
  %111 = select i1 %110, i64 %109, i64 0
  %112 = mul nsw i64 %polly.indvar224, -64
  %113 = icmp slt i64 %112, -1136
  %114 = select i1 %113, i64 %112, i64 -1136
  %115 = add nsw i64 %114, 1199
  %polly.loop_guard237.not = icmp sgt i64 %111, %115
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %polly.loop_cond226 = icmp slt i64 %polly.indvar224, 18
  %indvars.iv.next847 = add i64 %indvars.iv846, -64
  %indvars.iv.next851 = add i64 %indvars.iv850, 64
...
polly.loop_header227:                             ; preds = %polly.loop_header221, %polly.loop_exit236
  ...
  %scevgep249 = getelementptr i8, i8* %call1, i64 %116
...
polly.loop_header234:                             ; preds = %polly.loop_exit244, %polly.loop_header227
  %indvars.iv852 = phi i64 [ %indvars.iv.next853, %polly.loop_exit244 ], [ %107, %polly.loop_header227 ]
  %polly.indvar238 = phi i64 [ %polly.indvar_next239, %polly.loop_exit244 ], [ %111, %polly.loop_header227 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 49)
  %117 = add i64 %polly.indvar238, %108
  %118 = add i64 %117, %102
  %polly.loop_guard245936 = icmp sgt i64 %118, -1
...
polly.loop_header242.preheader:                   ; preds = %polly.loop_header234
  %polly.access.add.Packed_MemRef_call2254 = add nsw i64 %polly.access.mul.Packed_MemRef_call2253, %118
  ...
  %scevgep262 = getelementptr i8, i8* %scevgep249, i64 %119
...
polly.loop_header242:                             ; preds = %polly.loop_header242.preheader, %polly.loop_header242
  ...
  %121 = add nuw nsw i64 %polly.indvar246, %101
  %122 = mul nuw nsw i64 %121, 8000
  %scevgep250 = getelementptr i8, i8* %scevgep249, i64 %122
  ...
  %123 = shl i64 %121, 3
  %124 = add i64 %123, %120
  %scevgep265 = getelementptr i8, i8* %call, i64 %124
...
polly.loop_header356:                             ; preds = %polly.loop_exit364, %polly.start270
  ...
  %125 = add i64 %indvar1046, 1
  %126 = mul nuw nsw i64 %polly.indvar359, 9600
  %scevgep368 = getelementptr i8, i8* %call, i64 %126
  %min.iters.check1048 = icmp ult i64 %125, 4
...
vector.body1045:                                  ; preds = %vector.body1045, %vector.ph1049
  ...
  %127 = shl nuw nsw i64 %index1052, 3
  %128 = getelementptr i8, i8* %scevgep368, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1056 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !79, !noalias !81
  %130 = fmul fast <4 x double> %wide.load1056, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1053, %n.vec1051
  br i1 %132, label %middle.block1043, label %vector.body1045, !llvm.loop !85

middle.block1043:                                 ; preds = %vector.body1045
  %cmp.n1055 = icmp eq i64 %125, %n.vec1051
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_header362
  ...
  %133 = shl nuw nsw i64 %polly.indvar365, 3
  %scevgep369 = getelementptr i8, i8* %scevgep368, i64 %133
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit398
  ...
  %indvars.iv865 = phi i64 [ 31, %polly.loop_header372.preheader ], [ %indvars.iv.next866, %polly.loop_exit398 ]
  ...
  %134 = shl nuw nsw i64 %indvars.iv865, 1
  %135 = and i64 %134, 9223372036854775744
  %136 = add i64 %indvars.iv863, %135
  %137 = sub nsw i64 %indvars.iv870, %135
  %138 = mul nuw nsw i64 %polly.indvar375, 50
  br label %polly.loop_header378

polly.loop_exit380:                               ; preds = %polly.loop_exit386
  %139 = mul nsw i64 %polly.indvar375, -50
  %140 = mul nuw nsw i64 %polly.indvar375, 7
  %141 = add nuw nsw i64 %140, 31
  %pexp.p_div_q394 = lshr i64 %141, 5
  %142 = sub nsw i64 %polly.indvar375, %pexp.p_div_q394
  %polly.loop_guard399 = icmp slt i64 %142, 19
...
polly.loop_header384:                             ; preds = %polly.loop_header384, %polly.loop_header378
  ...
  %143 = add nuw nsw i64 %polly.indvar387, %138
  %polly.access.mul.call2391 = mul nuw nsw i64 %143, 1000
...
polly.loop_header396:                             ; preds = %polly.loop_exit380, %polly.loop_exit405
  %indvars.iv872 = phi i64 [ %indvars.iv.next873, %polly.loop_exit405 ], [ %137, %polly.loop_exit380 ]
  %indvars.iv867 = phi i64 [ %indvars.iv.next868, %polly.loop_exit405 ], [ %136, %polly.loop_exit380 ]
  %polly.indvar400 = phi i64 [ %polly.indvar_next401, %polly.loop_exit405 ], [ %142, %polly.loop_exit380 ]
  %smax869 = call i64 @llvm.smax.i64(i64 %indvars.iv867, i64 0)
  %144 = add i64 %smax869, %indvars.iv872
  %145 = shl nsw i64 %polly.indvar400, 6
  %146 = sub nsw i64 %138, %145
  %147 = icmp sgt i64 %146, 0
  %148 = select i1 %147, i64 %146, i64 0
  %149 = mul nsw i64 %polly.indvar400, -64
  %150 = icmp slt i64 %149, -1136
  %151 = select i1 %150, i64 %149, i64 -1136
  %152 = add nsw i64 %151, 1199
  %polly.loop_guard413.not = icmp sgt i64 %148, %152
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %polly.loop_cond402 = icmp slt i64 %polly.indvar400, 18
  %indvars.iv.next868 = add i64 %indvars.iv867, -64
  %indvars.iv.next873 = add i64 %indvars.iv872, 64
...
polly.loop_header403:                             ; preds = %polly.loop_header396, %polly.loop_exit412
  ...
  %153 = shl nuw nsw i64 %polly.indvar406, 3
  %scevgep425 = getelementptr i8, i8* %call1, i64 %153
...
polly.loop_header410:                             ; preds = %polly.loop_exit420, %polly.loop_header403
  %indvars.iv874 = phi i64 [ %indvars.iv.next875, %polly.loop_exit420 ], [ %144, %polly.loop_header403 ]
  %polly.indvar414 = phi i64 [ %polly.indvar_next415, %polly.loop_exit420 ], [ %148, %polly.loop_header403 ]
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv874, i64 49)
  %154 = add i64 %polly.indvar414, %145
  %155 = add i64 %154, %139
  %polly.loop_guard421937 = icmp sgt i64 %155, -1
...
polly.loop_header418.preheader:                   ; preds = %polly.loop_header410
  %polly.access.add.Packed_MemRef_call2273430 = add nsw i64 %polly.access.mul.Packed_MemRef_call2273429, %155
  ...
  %scevgep438 = getelementptr i8, i8* %scevgep425, i64 %156
...
polly.loop_exit420:                               ; preds = %polly.loop_header418, %polly.loop_header410
  ...
  %polly.loop_cond416.not.not = icmp slt i64 %polly.indvar414, %152
...
polly.loop_header418:                             ; preds = %polly.loop_header418.preheader, %polly.loop_header418
  ...
  %158 = add nuw nsw i64 %polly.indvar422, %138
  %159 = mul nuw nsw i64 %158, 8000
  %scevgep426 = getelementptr i8, i8* %scevgep425, i64 %159
  ...
  %160 = shl i64 %158, 3
  %161 = add i64 %160, %157
  %scevgep441 = getelementptr i8, i8* %call, i64 %161
...
polly.loop_header532:                             ; preds = %polly.loop_exit540, %polly.start446
  ...
  %163 = mul nuw nsw i64 %polly.indvar535, 9600
  %scevgep544 = getelementptr i8, i8* %call, i64 %163
  %min.iters.check1022 = icmp ult i64 %162, 4
...
vector.body1021:                                  ; preds = %vector.body1021, %vector.ph1023
  ...
  %164 = shl nuw nsw i64 %index1026, 3
  %165 = getelementptr i8, i8* %scevgep544, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load1030 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !89, !noalias !91
  %167 = fmul fast <4 x double> %wide.load1030, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next1027, %n.vec1025
  br i1 %169, label %middle.block1019, label %vector.body1021, !llvm.loop !95

middle.block1019:                                 ; preds = %vector.body1021
  %cmp.n1029 = icmp eq i64 %162, %n.vec1025
...
polly.loop_header538:                             ; preds = %polly.loop_header538.preheader, %polly.loop_header538
  ...
  %170 = shl nuw nsw i64 %polly.indvar541, 3
  %scevgep545 = getelementptr i8, i8* %scevgep544, i64 %170
...
polly.loop_header548:                             ; preds = %polly.loop_header548.preheader, %polly.loop_exit574
  ...
  %indvars.iv888 = phi i64 [ 31, %polly.loop_header548.preheader ], [ %indvars.iv.next889, %polly.loop_exit574 ]
  ...
  %171 = shl nuw nsw i64 %indvars.iv888, 1
  %172 = and i64 %171, 9223372036854775744
  %173 = add i64 %indvars.iv886, %172
  %174 = sub nsw i64 %indvars.iv893, %172
  %175 = mul nuw nsw i64 %polly.indvar551, 50
  br label %polly.loop_header554

polly.loop_exit556:                               ; preds = %polly.loop_exit562
  %176 = mul nsw i64 %polly.indvar551, -50
  %177 = mul nuw nsw i64 %polly.indvar551, 7
  %178 = add nuw nsw i64 %177, 31
  %pexp.p_div_q570 = lshr i64 %178, 5
  %179 = sub nsw i64 %polly.indvar551, %pexp.p_div_q570
  %polly.loop_guard575 = icmp slt i64 %179, 19
...
polly.loop_header560:                             ; preds = %polly.loop_header560, %polly.loop_header554
  ...
  %180 = add nuw nsw i64 %polly.indvar563, %175
  %polly.access.mul.call2567 = mul nuw nsw i64 %180, 1000
...
polly.loop_header572:                             ; preds = %polly.loop_exit556, %polly.loop_exit581
  %indvars.iv895 = phi i64 [ %indvars.iv.next896, %polly.loop_exit581 ], [ %174, %polly.loop_exit556 ]
  %indvars.iv890 = phi i64 [ %indvars.iv.next891, %polly.loop_exit581 ], [ %173, %polly.loop_exit556 ]
  %polly.indvar576 = phi i64 [ %polly.indvar_next577, %polly.loop_exit581 ], [ %179, %polly.loop_exit556 ]
  %smax892 = call i64 @llvm.smax.i64(i64 %indvars.iv890, i64 0)
  %181 = add i64 %smax892, %indvars.iv895
  %182 = shl nsw i64 %polly.indvar576, 6
  %183 = sub nsw i64 %175, %182
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %186 = mul nsw i64 %polly.indvar576, -64
  %187 = icmp slt i64 %186, -1136
  %188 = select i1 %187, i64 %186, i64 -1136
  %189 = add nsw i64 %188, 1199
  %polly.loop_guard589.not = icmp sgt i64 %185, %189
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588, %polly.loop_header572
  ...
  %polly.loop_cond578 = icmp slt i64 %polly.indvar576, 18
  %indvars.iv.next891 = add i64 %indvars.iv890, -64
  %indvars.iv.next896 = add i64 %indvars.iv895, 64
...
polly.loop_header579:                             ; preds = %polly.loop_header572, %polly.loop_exit588
  ...
  %190 = shl nuw nsw i64 %polly.indvar582, 3
  %scevgep601 = getelementptr i8, i8* %call1, i64 %190
...
polly.loop_header586:                             ; preds = %polly.loop_exit596, %polly.loop_header579
  %indvars.iv897 = phi i64 [ %indvars.iv.next898, %polly.loop_exit596 ], [ %181, %polly.loop_header579 ]
  %polly.indvar590 = phi i64 [ %polly.indvar_next591, %polly.loop_exit596 ], [ %185, %polly.loop_header579 ]
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 49)
  %191 = add i64 %polly.indvar590, %182
  %192 = add i64 %191, %176
  %polly.loop_guard597938 = icmp sgt i64 %192, -1
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header586
  %polly.access.add.Packed_MemRef_call2449606 = add nsw i64 %polly.access.mul.Packed_MemRef_call2449605, %192
  ...
  %scevgep614 = getelementptr i8, i8* %scevgep601, i64 %193
...
polly.loop_exit596:                               ; preds = %polly.loop_header594, %polly.loop_header586
  ...
  %polly.loop_cond592.not.not = icmp slt i64 %polly.indvar590, %189
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_header594
  ...
  %195 = add nuw nsw i64 %polly.indvar598, %175
  %196 = mul nuw nsw i64 %195, 8000
  %scevgep602 = getelementptr i8, i8* %scevgep601, i64 %196
  ...
  %197 = shl i64 %195, 3
  %198 = add i64 %197, %194
  %scevgep617 = getelementptr i8, i8* %call, i64 %198
...
polly.loop_header746:                             ; preds = %entry, %polly.loop_exit754
  ...
  %199 = shl nsw i64 %polly.indvar749, 5
  %200 = add nsw i64 %smin931, 1199
...
polly.loop_header752:                             ; preds = %polly.loop_exit760, %polly.loop_header746
  ...
  %201 = mul nsw i64 %polly.indvar755, -32
  %smin960 = call i64 @llvm.smin.i64(i64 %201, i64 -1168)
  %202 = add nsw i64 %smin960, 1200
  %smin927 = call i64 @llvm.smin.i64(i64 %indvars.iv925, i64 -1168)
  %203 = shl nsw i64 %polly.indvar755, 5
  %204 = add nsw i64 %smin927, 1199
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %205 = add nuw nsw i64 %polly.indvar761, %199
...
vector.ph961:                                     ; preds = %polly.loop_header758
  %broadcast.splatinsert968 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat969 = shufflevector <4 x i64> %broadcast.splatinsert968, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert970 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body959:                                   ; preds = %vector.body959, %vector.ph961
  ...
  %208 = add nuw nsw <4 x i64> %vec.ind966, %broadcast.splat969
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat971, %209
  ...
  %220 = icmp eq i64 %index.next963, %202
  br i1 %220, label %polly.loop_exit766, label %vector.body959, !llvm.loop !104

polly.loop_exit766:                               ; preds = %vector.body959, %polly.loop_header764
  %polly.indvar_next762 = add nuw nsw i64 %polly.indvar761, 1
  %exitcond932.not = icmp eq i64 %polly.indvar761, %200
...
polly.loop_header764:                             ; preds = %polly.loop_header758, %polly.loop_header764
  ...
  %221 = add nuw nsw i64 %polly.indvar767, %203
  ...
  %scevgep770 = getelementptr i8, i8* %call, i64 %227
  ...
  %exitcond928.not = icmp eq i64 %polly.indvar767, %204
...
polly.loop_header773:                             ; preds = %polly.loop_exit754, %polly.loop_exit781
  ...
  %228 = shl nsw i64 %polly.indvar776, 5
  %229 = add nsw i64 %smin921, 1199
...
polly.loop_header779:                             ; preds = %polly.loop_exit787, %polly.loop_header773
  ...
  %230 = mul nsw i64 %polly.indvar782, -32
  %smin975 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin975, 1000
  %smin917 = call i64 @llvm.smin.i64(i64 %indvars.iv915, i64 -968)
  %232 = shl nsw i64 %polly.indvar782, 5
  %233 = add nsw i64 %smin917, 999
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph977
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind984, %broadcast.splat987
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat989, %238
  ...
  %249 = icmp eq i64 %index.next981, %231
  br i1 %249, label %polly.loop_exit793, label %vector.body974, !llvm.loop !107

polly.loop_exit793:                               ; preds = %vector.body974, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond922.not = icmp eq i64 %polly.indvar788, %229
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %250 = add nuw nsw i64 %polly.indvar794, %232
  ...
  %scevgep797 = getelementptr i8, i8* %call2, i64 %256
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar794, %233
...
polly.loop_header799:                             ; preds = %polly.loop_exit781, %polly.loop_exit807
  ...
  %257 = shl nsw i64 %polly.indvar802, 5
  %258 = add nsw i64 %smin911, 1199
...
polly.loop_header805:                             ; preds = %polly.loop_exit813, %polly.loop_header799
  ...
  %259 = mul nsw i64 %polly.indvar808, -32
  %smin993 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin993, 1000
  %smin907 = call i64 @llvm.smin.i64(i64 %indvars.iv905, i64 -968)
  %261 = shl nsw i64 %polly.indvar808, 5
  %262 = add nsw i64 %smin907, 999
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph995
  ...
  %266 = add nuw nsw <4 x i64> %vec.ind1002, %broadcast.splat1005
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat1007, %267
  ...
  %278 = icmp eq i64 %index.next999, %260
  br i1 %278, label %polly.loop_exit819, label %vector.body992, !llvm.loop !110

polly.loop_exit819:                               ; preds = %vector.body992, %polly.loop_header817
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %exitcond912.not = icmp eq i64 %polly.indvar814, %258
...
polly.loop_header817:                             ; preds = %polly.loop_header811, %polly.loop_header817
  ...
  %279 = add nuw nsw i64 %polly.indvar820, %261
  ...
  %scevgep824 = getelementptr i8, i8* %call1, i64 %285
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar820, %262
