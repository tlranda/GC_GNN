; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3264.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3264.c"
...
polly.loop_header394:                             ; preds = %polly.loop_exit435, %polly.loop_header387
  ...
  %.inv871 = icmp sgt i64 %157, 99
  %159 = select i1 %.inv871, i64 99, i64 %158
...
polly.loop_header585:                             ; preds = %polly.loop_exit626, %polly.loop_header578
  ...
  %.inv872 = icmp sgt i64 %205, 99
  %207 = select i1 %.inv872, i64 99, i64 %206
