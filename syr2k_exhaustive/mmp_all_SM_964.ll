; ModuleID = 'syr2k_exhaustive/mmp_all_SM_964.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_964.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit259
  ...
  %exitcond944.not = icmp eq i64 %polly.indvar_next204, 15
...
polly.loop_header222.preheader:                   ; preds = %polly.loop_exit214
  %98 = mul nsw i64 %polly.indvar203, -80
...
polly.loop_header222:                             ; preds = %polly.loop_header222.preheader, %polly.loop_exit259
  ...
  %100 = mul nuw nsw i64 %indvar1216, 80
...
polly.loop_header234.us:                          ; preds = %polly.loop_header234.us, %polly.loop_header228.us
  ...
  %exitcond934.not = icmp eq i64 %polly.indvar_next238.us, 80
...
polly.loop_exit259:                               ; preds = %polly.loop_exit265
  ...
  %indvars.iv.next937 = add nuw nsw i64 %indvars.iv936, 80
  %exitcond943.not = icmp eq i64 %polly.indvar_next226, 15
...
polly.loop_header234:                             ; preds = %polly.loop_header234, %polly.loop_header228
  ...
  %exitcond932.not = icmp eq i64 %polly.indvar_next238, 80
...
polly.loop_header263:                             ; preds = %polly.loop_exit271, %polly.loop_header257
  ...
  %smin1218 = call i64 @llvm.smin.i64(i64 %109, i64 79)
  %110 = add nuw nsw i64 %smin1218, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv938, i64 79)
...
polly.loop_exit271:                               ; preds = %polly.loop_header269, %middle.block1213
  ...
  %exitcond941.not = icmp eq i64 %polly.indvar_next267, 80
...
polly.loop_header422.preheader:                   ; preds = %polly.loop_exit414
  %144 = mul nsw i64 %polly.indvar403, -80
...
polly.loop_header422:                             ; preds = %polly.loop_header422.preheader, %polly.loop_exit461
  ...
  %146 = mul nuw nsw i64 %indvar1169, 80
  %147 = mul nuw nsw i64 %polly.indvar425, 80
  %148 = add nsw i64 %147, %144
  %149 = icmp ugt i64 %148, 80
  %150 = select i1 %149, i64 %148, i64 80
  %151 = add nuw nsw i64 %148, 79
...
polly.loop_header434.us:                          ; preds = %polly.loop_header434.us, %polly.loop_header428.us
  ...
  %exitcond953.not = icmp eq i64 %polly.indvar_next438.us, 80
...
polly.loop_exit461:                               ; preds = %polly.loop_exit467
  ...
  %indvars.iv.next956 = add nuw nsw i64 %indvars.iv955, 80
  %exitcond963.not = icmp eq i64 %polly.indvar_next426, 15
...
polly.loop_header434:                             ; preds = %polly.loop_header434, %polly.loop_header428
  ...
  %exitcond951.not = icmp eq i64 %polly.indvar_next438, 80
...
polly.loop_header465:                             ; preds = %polly.loop_exit473, %polly.loop_header459
  ...
  %smin1171 = call i64 @llvm.smin.i64(i64 %155, i64 79)
  %156 = add nuw nsw i64 %smin1171, 1
  %smin959 = call i64 @llvm.smin.i64(i64 %indvars.iv957, i64 79)
...
polly.loop_exit473:                               ; preds = %polly.loop_header471, %middle.block1166
  ...
  %exitcond961.not = icmp eq i64 %polly.indvar_next469, 80
...
polly.loop_header602:                             ; preds = %polly.loop_header602.preheader, %polly.loop_exit626
  ...
  %189 = mul nuw nsw i64 %polly.indvar605, 80
...
polly.loop_exit626:                               ; preds = %polly.loop_exit663
  ...
  %exitcond984.not = icmp eq i64 %polly.indvar_next606, 15
...
polly.loop_header624.preheader:                   ; preds = %polly.loop_exit616
  %190 = mul nsw i64 %polly.indvar605, -80
...
polly.loop_header624:                             ; preds = %polly.loop_header624.preheader, %polly.loop_exit663
  ...
  %192 = mul nuw nsw i64 %indvar1122, 80
  %193 = mul nuw nsw i64 %polly.indvar627, 80
  %194 = add nsw i64 %193, %190
  %195 = icmp ugt i64 %194, 80
  %196 = select i1 %195, i64 %194, i64 80
  %197 = add nuw nsw i64 %194, 79
...
polly.loop_header636.us:                          ; preds = %polly.loop_header636.us, %polly.loop_header630.us
  ...
  %exitcond973.not = icmp eq i64 %polly.indvar_next640.us, 80
...
polly.loop_exit663:                               ; preds = %polly.loop_exit669
  ...
  %indvars.iv.next976 = add nuw nsw i64 %indvars.iv975, 80
  %exitcond983.not = icmp eq i64 %polly.indvar_next628, 15
...
polly.loop_header636:                             ; preds = %polly.loop_header636, %polly.loop_header630
  ...
  %exitcond971.not = icmp eq i64 %polly.indvar_next640, 80
...
polly.loop_header667:                             ; preds = %polly.loop_exit675, %polly.loop_header661
  ...
  %smin1124 = call i64 @llvm.smin.i64(i64 %201, i64 79)
  %202 = add nuw nsw i64 %smin1124, 1
  %smin979 = call i64 @llvm.smin.i64(i64 %indvars.iv977, i64 79)
...
polly.loop_exit675:                               ; preds = %polly.loop_header673, %middle.block1119
  ...
  %exitcond981.not = icmp eq i64 %polly.indvar_next671, 80
