; ModuleID = 'syr2k_exhaustive/mmp_all_SM_102.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_102.c"
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  %100 = mul nsw i64 %polly.indvar209, -20
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %exitcond981.not = icmp eq i64 %polly.indvar_next210, 60
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us
  ...
  %smin975.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next974, i64 19)
  %127 = or i64 %115, 1
  %128 = or i64 %114, 1
  %129 = mul nuw nsw i64 %128, 9600
  %indvars.iv.next974.1 = add nuw nsw i64 %indvars.iv.next974, 1
  %smin975.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next974.1, i64 19)
  %130 = or i64 %115, 2
  %131 = or i64 %114, 2
...
polly.loop_header414:                             ; preds = %polly.loop_exit438, %polly.loop_header408
  ...
  %184 = mul nuw nsw i64 %polly.indvar417, 20
  br label %polly.loop_header420

polly.loop_exit422:                               ; preds = %polly.loop_exit428
  %185 = mul nsw i64 %polly.indvar417, -20
  %186 = mul nuw nsw i64 %polly.indvar417, 5
...
polly.loop_exit438:                               ; preds = %polly.loop_exit477
  ...
  %exitcond1007.not = icmp eq i64 %polly.indvar_next418, 60
...
polly.loop_header475.preheader:                   ; preds = %polly.loop_exit463, %polly.loop_exit463.us
  %smin1001 = call i64 @llvm.smin.i64(i64 %indvars.iv997, i64 19)
  %211 = mul nsw i64 %polly.indvar439, 38400
  %indvars.iv.next1000 = or i64 %indvars.iv997, 1
  %smin1001.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next1000, i64 19)
  %212 = or i64 %200, 1
  %213 = or i64 %199, 1
  %214 = mul nuw nsw i64 %213, 9600
  %indvars.iv.next1000.1 = add nuw nsw i64 %indvars.iv.next1000, 1
  %smin1001.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next1000.1, i64 19)
  %215 = or i64 %200, 2
  %216 = or i64 %199, 2
...
polly.loop_header624:                             ; preds = %polly.loop_exit648, %polly.loop_header618
  ...
  %269 = mul nuw nsw i64 %polly.indvar627, 20
  br label %polly.loop_header630

polly.loop_exit632:                               ; preds = %polly.loop_exit638
  %270 = mul nsw i64 %polly.indvar627, -20
  %271 = mul nuw nsw i64 %polly.indvar627, 5
...
polly.loop_exit648:                               ; preds = %polly.loop_exit687
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next628, 60
...
polly.loop_header685.preheader:                   ; preds = %polly.loop_exit673, %polly.loop_exit673.us
  %smin1027 = call i64 @llvm.smin.i64(i64 %indvars.iv1023, i64 19)
  %296 = mul nsw i64 %polly.indvar649, 38400
  %indvars.iv.next1026 = or i64 %indvars.iv1023, 1
  %smin1027.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next1026, i64 19)
  %297 = or i64 %285, 1
  %298 = or i64 %284, 1
  %299 = mul nuw nsw i64 %298, 9600
  %indvars.iv.next1026.1 = add nuw nsw i64 %indvars.iv.next1026, 1
  %smin1027.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next1026.1, i64 19)
  %300 = or i64 %285, 2
  %301 = or i64 %284, 2
