; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10519.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10519.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv786 = phi i64 [ %indvars.iv.next787, %polly.loop_exit207 ], [ 5, %polly.loop_exit193 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next787 = add nuw nsw i64 %indvars.iv786, 5
  %exitcond789.not = icmp eq i64 %polly.indvar_next203, 12
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv783, i64 19)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  %indvars.iv806 = phi i64 [ %indvars.iv.next807, %polly.loop_exit360 ], [ 5, %polly.loop_exit344 ]
  ...
  %123 = mul nsw i64 %polly.indvar355, -100
  %124 = mul nuw nsw i64 %polly.indvar355, 100
  br label %polly.loop_header358

polly.loop_exit360:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next793 = add nsw i64 %indvars.iv792, -100
  %indvars.iv.next798 = add nuw nsw i64 %indvars.iv797, 100
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %125 = mul nuw nsw i64 %polly.indvar361, 20
  %126 = add nsw i64 %125, %123
  %127 = icmp sgt i64 %126, 0
  %128 = select i1 %127, i64 %126, i64 0
  %polly.loop_guard368 = icmp slt i64 %128, 100
...
polly.loop_header365:                             ; preds = %polly.loop_header365.preheader, %polly.loop_exit374
  ...
  %smin803 = call i64 @llvm.smin.i64(i64 %indvars.iv801, i64 19)
...
polly.loop_exit374:                               ; preds = %polly.loop_exit381.loopexit.us, %polly.loop_header365
  ...
  %polly.loop_cond371 = icmp ult i64 %polly.indvar369, 99
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  %indvars.iv826 = phi i64 [ %indvars.iv.next827, %polly.loop_exit515 ], [ 5, %polly.loop_exit499 ]
  ...
  %149 = mul nsw i64 %polly.indvar510, -100
  %150 = mul nuw nsw i64 %polly.indvar510, 100
...
polly.loop_exit515:                               ; preds = %polly.loop_exit522
  ...
  %indvars.iv.next813 = add nsw i64 %indvars.iv812, -100
  %indvars.iv.next818 = add nuw nsw i64 %indvars.iv817, 100
  %indvars.iv.next827 = add nuw nsw i64 %indvars.iv826, 5
  %exitcond829.not = icmp eq i64 %polly.indvar_next511, 12
...
polly.loop_header513:                             ; preds = %polly.loop_exit522, %polly.loop_header507
  ...
  %151 = mul nuw nsw i64 %polly.indvar516, 20
  %152 = add nsw i64 %151, %149
  %153 = icmp sgt i64 %152, 0
  %154 = select i1 %153, i64 %152, i64 0
  %polly.loop_guard523 = icmp slt i64 %154, 100
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit529
  ...
  %smin823 = call i64 @llvm.smin.i64(i64 %indvars.iv821, i64 19)
...
polly.loop_exit529:                               ; preds = %polly.loop_exit536.loopexit.us, %polly.loop_header520
  ...
  %polly.loop_cond526 = icmp ult i64 %polly.indvar524, 99
