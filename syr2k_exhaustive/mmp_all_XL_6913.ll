; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6913.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6913.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %98 = mul nsw i64 %polly.indvar218, -16
  %99 = shl nsw i64 %polly.indvar218, 4
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next219, 75
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %polly.loop_guard = icmp slt i64 %119, 16
...
polly.loop_exit241:                               ; preds = %polly.loop_header246.us.7, %polly.loop_header233
  ...
  %polly.loop_cond238 = icmp ult i64 %polly.indvar236, 15
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %143 = mul nsw i64 %polly.indvar393, -16
  %144 = shl nsw i64 %polly.indvar393, 4
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit405
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next856 = add nsw i64 %indvars.iv855, -16
  %indvars.iv.next861 = add nuw nsw i64 %indvars.iv860, 16
  %indvars.iv.next870 = add nuw nsw i64 %indvars.iv869, 8
  %exitcond873.not = icmp eq i64 %polly.indvar_next394, 75
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %polly.loop_guard413 = icmp slt i64 %164, 16
...
polly.loop_exit419:                               ; preds = %polly.loop_header424.us.7, %polly.loop_header410
  ...
  %polly.loop_cond416 = icmp ult i64 %polly.indvar414, 15
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit576 ], [ 7, %polly.loop_exit560 ]
  ...
  %188 = mul nsw i64 %polly.indvar571, -16
  %189 = shl nsw i64 %polly.indvar571, 4
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next893 = add nuw nsw i64 %indvars.iv892, 8
  %exitcond896.not = icmp eq i64 %polly.indvar_next572, 75
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %polly.loop_guard591 = icmp slt i64 %209, 16
...
polly.loop_exit597:                               ; preds = %polly.loop_header602.us.7, %polly.loop_header588
  ...
  %polly.loop_cond594 = icmp ult i64 %polly.indvar592, 15
