; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4596.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4596.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin976 = call i64 @llvm.smin.i64(i64 %indvars.iv974, i64 -1168)
...
polly.loop_header377:                             ; preds = %polly.loop_header377.preheader, %polly.loop_exit386
  ...
  %123 = shl nsw i64 %polly.indvar380, 5
...
polly.loop_exit386:                               ; preds = %polly.loop_exit392
  ...
  %exitcond1000.not = icmp eq i64 %polly.indvar_next381, 38
...
polly.loop_header384:                             ; preds = %polly.loop_exit392, %polly.loop_header377
  ...
  %125 = shl nsw i64 %polly.indvar387, 7
  %126 = sub nsw i64 %123, %125
  %127 = add nuw nsw i64 %125, 128
...
polly.loop_header390:                             ; preds = %polly.loop_exit427, %polly.loop_header384
  ...
  %smin992 = call i64 @llvm.smin.i64(i64 %indvars.iv987, i64 127)
...
polly.loop_header562:                             ; preds = %polly.loop_header562.preheader, %polly.loop_exit571
  ...
  %148 = shl nsw i64 %polly.indvar565, 5
...
polly.loop_exit571:                               ; preds = %polly.loop_exit577
  ...
  %exitcond1021.not = icmp eq i64 %polly.indvar_next566, 38
...
polly.loop_header575:                             ; preds = %polly.loop_exit612, %polly.loop_header569
  ...
  %smin1013 = call i64 @llvm.smin.i64(i64 %indvars.iv1008, i64 127)
