; ModuleID = 'syr2k_exhaustive/mmp_all_XL_357.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_357.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %99 = lshr i64 %polly.indvar203, 3
  %100 = add nuw i64 %98, %99
  %101 = shl nuw nsw i64 %100, 4
  %102 = sub i64 %97, %101
  %103 = mul nsw i64 %polly.indvar203, -50
  %104 = add i64 %103, %101
  %105 = lshr i64 %polly.indvar203, 3
...
polly.loop_exit224:                               ; preds = %polly.loop_exit261
  ...
  %indvars.iv.next1063 = add nuw nsw i64 %indvars.iv1062, 50
  %indvars.iv.next1065 = add nuw nsw i64 %indvars.iv1064, 3
  %indvars.iv.next1069 = add nsw i64 %indvars.iv1068, -50
  %exitcond1076.not = icmp eq i64 %polly.indvar_next204, 24
...
polly.loop_header222:                             ; preds = %polly.loop_exit261, %polly.loop_exit208
  ...
  %115 = mul nsw i64 %indvar1369, -16
  %116 = add i64 %102, %115
  %smax1371 = call i64 @llvm.smax.i64(i64 %116, i64 0)
  %117 = shl nuw nsw i64 %indvar1369, 4
  %118 = add i64 %104, %117
...
polly.loop_exit261:                               ; preds = %polly.loop_exit268.loopexit.us, %polly.loop_header259.preheader
  ...
  %indvars.iv.next1067 = add i64 %indvars.iv1066, -16
  %indvars.iv.next1071 = add i64 %indvars.iv1070, 16
...
polly.loop_header259.preheader:                   ; preds = %polly.loop_exit247, %polly.loop_exit247.us, %polly.loop_header222.split
  ...
  %polly.loop_guard269 = icmp slt i64 %132, 16
...
polly.loop_header266.us:                          ; preds = %polly.loop_header259.us, %polly.loop_exit276.us
  ...
  %smin1374 = call i64 @llvm.smin.i64(i64 %133, i64 49)
  %134 = add nsw i64 %smin1374, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1072, i64 49)
...
polly.loop_exit276.us:                            ; preds = %polly.loop_header274.us, %middle.block1366, %polly.loop_header266.us
  ...
  %polly.loop_cond272.us = icmp ult i64 %polly.indvar270.us, 15
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit431
  ...
  %168 = mul nuw nsw i64 %polly.indvar409, 50
  %169 = mul nuw nsw i64 %polly.indvar409, 3
  %170 = lshr i64 %polly.indvar409, 3
  %171 = add nuw i64 %169, %170
  %172 = shl nuw nsw i64 %171, 4
  %173 = sub i64 %168, %172
  %174 = mul nsw i64 %polly.indvar409, -50
  %175 = add i64 %174, %172
  %176 = lshr i64 %polly.indvar409, 3
  %177 = add nuw i64 %indvars.iv1088, %176
  %178 = shl nuw nsw i64 %177, 4
  %179 = sub i64 %indvars.iv1086, %178
  %180 = add i64 %indvars.iv1093, %178
  %181 = mul nuw nsw i64 %polly.indvar409, 50
  br label %polly.loop_header412

polly.loop_exit414:                               ; preds = %polly.loop_exit420
  %182 = mul nsw i64 %polly.indvar409, -50
  %183 = mul nuw nsw i64 %polly.indvar409, 3
...
polly.loop_exit431:                               ; preds = %polly.loop_exit470
  ...
  %exitcond1102.not = icmp eq i64 %polly.indvar_next410, 24
...
polly.loop_exit470:                               ; preds = %polly.loop_exit477.loopexit.us, %polly.loop_header468.preheader
  ...
  %polly.loop_cond434 = icmp ult i64 %polly.indvar432, 74
...
polly.loop_header468.preheader:                   ; preds = %polly.loop_exit456, %polly.loop_exit456.us, %polly.loop_header429.split
  ...
  %polly.loop_guard478 = icmp slt i64 %203, 16
...
polly.loop_header475.us:                          ; preds = %polly.loop_header468.us, %polly.loop_exit485.us
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %204, i64 49)
  %205 = add nsw i64 %smin1324, 1
  %smin1099 = call i64 @llvm.smin.i64(i64 %indvars.iv1097, i64 49)
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %240 = mul nuw nsw i64 %polly.indvar618, 3
  %241 = lshr i64 %polly.indvar618, 3
  %242 = add nuw i64 %240, %241
  %243 = shl nuw nsw i64 %242, 4
  %244 = sub i64 %239, %243
  %245 = mul nsw i64 %polly.indvar618, -50
  %246 = add i64 %245, %243
  %247 = lshr i64 %polly.indvar618, 3
  %248 = add nuw i64 %indvars.iv1114, %247
  %249 = shl nuw nsw i64 %248, 4
  %250 = sub i64 %indvars.iv1112, %249
  %251 = add i64 %indvars.iv1119, %249
  %252 = mul nuw nsw i64 %polly.indvar618, 50
  br label %polly.loop_header621

polly.loop_exit623:                               ; preds = %polly.loop_exit629
  %253 = mul nsw i64 %polly.indvar618, -50
  %254 = mul nuw nsw i64 %polly.indvar618, 3
  %255 = add nuw nsw i64 %254, %247
  br label %polly.loop_header638

polly.loop_exit640:                               ; preds = %polly.loop_exit679
  %polly.indvar_next619 = add nuw nsw i64 %polly.indvar618, 1
  %indvars.iv.next1106 = add nsw i64 %indvars.iv1105, -50
  %indvars.iv.next1113 = add nuw nsw i64 %indvars.iv1112, 50
  %indvars.iv.next1115 = add nuw nsw i64 %indvars.iv1114, 3
  %indvars.iv.next1120 = add nsw i64 %indvars.iv1119, -50
  %exitcond1128.not = icmp eq i64 %polly.indvar_next619, 24
...
polly.loop_exit679:                               ; preds = %polly.loop_exit686.loopexit.us, %polly.loop_header677.preheader
  ...
  %polly.loop_cond643 = icmp ult i64 %polly.indvar641, 74
  %indvars.iv.next1117 = add i64 %indvars.iv1116, -16
  %indvars.iv.next1122 = add i64 %indvars.iv1121, 16
...
polly.loop_header677.preheader:                   ; preds = %polly.loop_exit665, %polly.loop_exit665.us, %polly.loop_header638.split
  ...
  %polly.loop_guard687 = icmp slt i64 %274, 16
...
polly.loop_header684.us:                          ; preds = %polly.loop_header677.us, %polly.loop_exit694.us
  ...
  %smin1274 = call i64 @llvm.smin.i64(i64 %275, i64 49)
  %276 = add nsw i64 %smin1274, 1
  %smin1125 = call i64 @llvm.smin.i64(i64 %indvars.iv1123, i64 49)
...
polly.loop_exit694.us:                            ; preds = %polly.loop_header692.us, %middle.block1266, %polly.loop_header684.us
  ...
  %polly.loop_cond690.us = icmp ult i64 %polly.indvar688.us, 15
