; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1202.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1202.c"
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1248, label %for.body3.i46.preheader1436, label %vector.ph1249
...
middle.block1245:                                 ; preds = %vector.body1247
  ...
  br i1 %cmp.n1255, label %for.inc6.i, label %for.body3.i46.preheader1436

for.body3.i46.preheader1436:                      ; preds = %for.body3.i46.preheader, %middle.block1245
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec1251, %middle.block1245 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1436, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1436 ]
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  ...
  br i1 %min.iters.check1308, label %for.body3.i60.preheader1434, label %vector.ph1309
...
vector.body1307:                                  ; preds = %vector.body1307, %vector.ph1309
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call872, i64 %indvars.iv21.i52, i64 %index1312
...
middle.block1305:                                 ; preds = %vector.body1307
  ...
  br i1 %cmp.n1315, label %for.inc6.i63, label %for.body3.i60.preheader1434

for.body3.i60.preheader1434:                      ; preds = %for.body3.i60.preheader, %middle.block1305
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1371 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1371, label %for.body3.i99.preheader1432, label %vector.ph1372

vector.ph1372:                                    ; preds = %for.body3.i99.preheader
  %n.vec1374 = and i64 %indvars.iv21.i91, 9223372036854775804
...
vector.body1370:                                  ; preds = %vector.body1370, %vector.ph1372
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call872, i64 %indvars.iv21.i91, i64 %index1375
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1379 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1379, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1376 = add i64 %index1375, 4
  %68 = icmp eq i64 %index.next1376, %n.vec1374
  br i1 %68, label %middle.block1368, label %vector.body1370, !llvm.loop !66

middle.block1368:                                 ; preds = %vector.body1370
  %cmp.n1378 = icmp eq i64 %indvars.iv21.i91, %n.vec1374
  br i1 %cmp.n1378, label %for.inc6.i102, label %for.body3.i99.preheader1432

for.body3.i99.preheader1432:                      ; preds = %for.body3.i99.preheader, %middle.block1368
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1374, %middle.block1368 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1368, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit194, %polly.start
  %indvar1383 = phi i64 [ %indvar.next1384, %polly.loop_exit194 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit194 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1383, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1385 = icmp ult i64 %88, 4
  br i1 %min.iters.check1385, label %polly.loop_header192.preheader, label %vector.ph1386

vector.ph1386:                                    ; preds = %polly.loop_header
  %n.vec1388 = and i64 %88, -4
...
vector.body1382:                                  ; preds = %vector.body1382, %vector.ph1386
  ...
  %90 = shl nuw nsw i64 %index1389, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1393 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !72, !noalias !74
  %93 = fmul fast <4 x double> %wide.load1393, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !72, !noalias !74
  %index.next1390 = add i64 %index1389, 4
  %95 = icmp eq i64 %index.next1390, %n.vec1388
  br i1 %95, label %middle.block1380, label %vector.body1382, !llvm.loop !79

middle.block1380:                                 ; preds = %vector.body1382
  %cmp.n1392 = icmp eq i64 %88, %n.vec1388
  br i1 %cmp.n1392, label %polly.loop_exit194, label %polly.loop_header192.preheader

polly.loop_header192.preheader:                   ; preds = %polly.loop_header, %middle.block1380
  %polly.indvar195.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1388, %middle.block1380 ]
  br label %polly.loop_header192

polly.loop_exit194:                               ; preds = %polly.loop_header192, %middle.block1380
...
polly.loop_exit224:                               ; preds = %polly.loop_exit259
  ...
  %exitcond1082.not = icmp eq i64 %136, 60
...
polly.loop_header222:                             ; preds = %polly.loop_exit259, %polly.loop_exit208
  %indvar1395 = phi i64 [ %indvar.next1396, %polly.loop_exit259 ], [ 0, %polly.loop_exit208 ]
  ...
  %138 = mul nsw i64 %indvar1395, -100
  %139 = add i64 %100, %138
  %smax1414 = call i64 @llvm.smax.i64(i64 %139, i64 0)
  %140 = mul nuw nsw i64 %indvar1395, 100
  %141 = add i64 %102, %140
  %142 = add i64 %smax1414, %141
  %143 = mul nsw i64 %indvar1395, -100
  %144 = add i64 %107, %143
  %smax1397 = call i64 @llvm.smax.i64(i64 %144, i64 0)
  %145 = mul nuw nsw i64 %indvar1395, 100
  %146 = add i64 %106, %145
  %147 = add i64 %smax1397, %146
  %148 = mul nsw i64 %147, 9600
  %149 = add i64 %103, %148
  %150 = add i64 %108, %148
  %151 = add i64 %110, %145
  %152 = add i64 %smax1397, %151
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1072, i64 0)
  %153 = add i64 %smax, %indvars.iv1076
  %154 = mul nuw nsw i64 %polly.indvar225, 5
  %.not.not = icmp ugt i64 %154, %polly.indvar203
  %155 = mul nuw nsw i64 %polly.indvar225, 100
  %156 = add nsw i64 %155, %116
  %157 = icmp sgt i64 %156, 0
  %158 = select i1 %157, i64 %156, i64 0
  %159 = add nsw i64 %156, 99
...
polly.loop_header257.preheader:                   ; preds = %polly.loop_exit246, %polly.loop_exit246.us, %polly.loop_header222.split
  ...
  %polly.loop_guard267 = icmp slt i64 %163, 100
...
polly.loop_header257.us:                          ; preds = %polly.loop_header257.preheader, %polly.loop_exit266.loopexit.us
  ...
  %scevgep1404 = getelementptr i8, i8* %malloccall, i64 %164
  %165 = or i64 %164, 8
  %scevgep1405 = getelementptr i8, i8* %malloccall, i64 %165
...
polly.loop_header264.us:                          ; preds = %polly.loop_header257.us, %polly.loop_exit274.us
  %indvar1398 = phi i64 [ 0, %polly.loop_header257.us ], [ %indvar.next1399, %polly.loop_exit274.us ]
  ...
  %166 = add i64 %142, %indvar1398
  %smin1415 = call i64 @llvm.smin.i64(i64 %166, i64 19)
  %167 = add nsw i64 %smin1415, 1
  %168 = mul nuw nsw i64 %indvar1398, 9600
  %169 = add i64 %149, %168
  %scevgep1400 = getelementptr i8, i8* %call, i64 %169
  %170 = add i64 %150, %168
  %scevgep1401 = getelementptr i8, i8* %call, i64 %170
  %171 = add i64 %152, %indvar1398
  %smin1402 = call i64 @llvm.smin.i64(i64 %171, i64 19)
  %172 = shl nsw i64 %smin1402, 3
  %scevgep1403 = getelementptr i8, i8* %scevgep1401, i64 %172
  %scevgep1406 = getelementptr i8, i8* %scevgep1405, i64 %172
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1078, i64 19)
  %173 = add nsw i64 %polly.indvar268.us, %156
  %polly.loop_guard275.us1167 = icmp sgt i64 %173, -1
...
polly.loop_exit274.us:                            ; preds = %polly.loop_header272.us, %middle.block1411, %polly.loop_header264.us
...
polly.loop_header272.preheader.us:                ; preds = %polly.loop_header264.us
  ...
  %min.iters.check1416 = icmp ult i64 %167, 4
  br i1 %min.iters.check1416, label %polly.loop_header272.us.preheader, label %vector.memcheck1394

vector.memcheck1394:                              ; preds = %polly.loop_header272.preheader.us
  %bound01407 = icmp ult i8* %scevgep1400, %scevgep1406
  %bound11408 = icmp ult i8* %scevgep1404, %scevgep1403
  %found.conflict1409 = and i1 %bound01407, %bound11408
  br i1 %found.conflict1409, label %polly.loop_header272.us.preheader, label %vector.ph1417

vector.ph1417:                                    ; preds = %vector.memcheck1394
  %n.vec1419 = and i64 %167, -4
  %broadcast.splatinsert1425 = insertelement <4 x double> poison, double %_p_scalar_286.us, i32 0
...
vector.body1413:                                  ; preds = %vector.body1413, %vector.ph1417
  ...
  %179 = add nuw nsw i64 %index1420, %115
  %180 = add nuw nsw i64 %index1420, %polly.access.mul.Packed_MemRef_call1279.us
  %181 = getelementptr double, double* %Packed_MemRef_call1, i64 %180
  %182 = bitcast double* %181 to <4 x double>*
  %wide.load1424 = load <4 x double>, <4 x double>* %182, align 8, !alias.scope !85
  %183 = fmul fast <4 x double> %broadcast.splat1426, %wide.load1424
  %184 = getelementptr double, double* %Packed_MemRef_call2, i64 %180
  %185 = bitcast double* %184 to <4 x double>*
  %wide.load1427 = load <4 x double>, <4 x double>* %185, align 8
  %186 = fmul fast <4 x double> %broadcast.splat1429, %wide.load1427
  %187 = shl i64 %179, 3
  %188 = add i64 %187, %178
  %189 = getelementptr i8, i8* %call, i64 %188
  %190 = bitcast i8* %189 to <4 x double>*
  %wide.load1430 = load <4 x double>, <4 x double>* %190, align 8, !alias.scope !88, !noalias !90
  ...
  %193 = fadd fast <4 x double> %192, %wide.load1430
  ...
  %195 = icmp eq i64 %index.next1421, %n.vec1419
  br i1 %195, label %middle.block1411, label %vector.body1413, !llvm.loop !91

middle.block1411:                                 ; preds = %vector.body1413
  %cmp.n1423 = icmp eq i64 %167, %n.vec1419
  br i1 %cmp.n1423, label %polly.loop_exit274.us, label %polly.loop_header272.us.preheader

polly.loop_header272.us.preheader:                ; preds = %vector.memcheck1394, %polly.loop_header272.preheader.us, %middle.block1411
  %polly.indvar276.us.ph = phi i64 [ 0, %vector.memcheck1394 ], [ 0, %polly.loop_header272.preheader.us ], [ %n.vec1419, %middle.block1411 ]
...
polly.loop_header388:                             ; preds = %polly.loop_exit396, %polly.start300
  %indvar1320 = phi i64 [ %indvar.next1321, %polly.loop_exit396 ], [ 0, %polly.start300 ]
  %polly.indvar391 = phi i64 [ %polly.indvar_next392, %polly.loop_exit396 ], [ 1, %polly.start300 ]
  %197 = add i64 %indvar1320, 1
  %198 = mul nuw nsw i64 %polly.indvar391, 9600
  %scevgep400 = getelementptr i8, i8* %call, i64 %198
  %min.iters.check1322 = icmp ult i64 %197, 4
  br i1 %min.iters.check1322, label %polly.loop_header394.preheader, label %vector.ph1323

vector.ph1323:                                    ; preds = %polly.loop_header388
  %n.vec1325 = and i64 %197, -4
...
vector.body1319:                                  ; preds = %vector.body1319, %vector.ph1323
  ...
  %199 = shl nuw nsw i64 %index1326, 3
  %200 = getelementptr i8, i8* %scevgep400, i64 %199
  %201 = bitcast i8* %200 to <4 x double>*
  %wide.load1330 = load <4 x double>, <4 x double>* %201, align 8, !alias.scope !92, !noalias !94
  %202 = fmul fast <4 x double> %wide.load1330, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %204 = icmp eq i64 %index.next1327, %n.vec1325
  br i1 %204, label %middle.block1317, label %vector.body1319, !llvm.loop !99

middle.block1317:                                 ; preds = %vector.body1319
  %cmp.n1329 = icmp eq i64 %197, %n.vec1325
  br i1 %cmp.n1329, label %polly.loop_exit396, label %polly.loop_header394.preheader

polly.loop_header394.preheader:                   ; preds = %polly.loop_header388, %middle.block1317
  %polly.indvar397.ph = phi i64 [ 0, %polly.loop_header388 ], [ %n.vec1325, %middle.block1317 ]
  br label %polly.loop_header394

polly.loop_exit396:                               ; preds = %polly.loop_header394, %middle.block1317
...
polly.loop_header394:                             ; preds = %polly.loop_header394.preheader, %polly.loop_header394
  ...
  br i1 %exitcond1107.not, label %polly.loop_exit396, label %polly.loop_header394, !llvm.loop !100
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit429
  ...
  %207 = udiv i64 %polly.indvar407, 5
  ...
  %214 = udiv i64 %polly.indvar407, 5
  %215 = mul nuw nsw i64 %214, 100
  %216 = sub nsw i64 %213, %215
  %217 = or i64 %212, 8
  %218 = mul nsw i64 %polly.indvar407, -20
  %219 = add i64 %218, %215
  %220 = udiv i64 %polly.indvar407, 5
  %221 = mul nuw nsw i64 %220, 100
  %222 = sub nsw i64 %indvars.iv1092, %221
  %223 = add i64 %indvars.iv1097, %221
...
polly.loop_exit429:                               ; preds = %polly.loop_exit470
  ...
  %exitcond1106.not = icmp eq i64 %245, 60
...
polly.loop_header427:                             ; preds = %polly.loop_exit470, %polly.loop_exit412
  %indvar1332 = phi i64 [ %indvar.next1333, %polly.loop_exit470 ], [ 0, %polly.loop_exit412 ]
  %indvars.iv1099 = phi i64 [ %indvars.iv.next1100, %polly.loop_exit470 ], [ %223, %polly.loop_exit412 ]
  %indvars.iv1094 = phi i64 [ %indvars.iv.next1095, %polly.loop_exit470 ], [ %222, %polly.loop_exit412 ]
  %polly.indvar430 = phi i64 [ %polly.indvar_next431, %polly.loop_exit470 ], [ %220, %polly.loop_exit412 ]
  %247 = mul nsw i64 %indvar1332, -100
  %248 = add i64 %209, %247
  %smax1351 = call i64 @llvm.smax.i64(i64 %248, i64 0)
  %249 = mul nuw nsw i64 %indvar1332, 100
  %250 = add i64 %211, %249
  %251 = add i64 %smax1351, %250
  %252 = mul nsw i64 %indvar1332, -100
  %253 = add i64 %216, %252
  %smax1334 = call i64 @llvm.smax.i64(i64 %253, i64 0)
  %254 = mul nuw nsw i64 %indvar1332, 100
  %255 = add i64 %215, %254
  %256 = add i64 %smax1334, %255
  %257 = mul nsw i64 %256, 9600
  %258 = add i64 %212, %257
  %259 = add i64 %217, %257
  %260 = add i64 %219, %254
  %261 = add i64 %smax1334, %260
  %smax1096 = call i64 @llvm.smax.i64(i64 %indvars.iv1094, i64 0)
  %262 = add i64 %smax1096, %indvars.iv1099
  %263 = mul nuw nsw i64 %polly.indvar430, 5
  %.not.not926 = icmp ugt i64 %263, %polly.indvar407
  %264 = mul nuw nsw i64 %polly.indvar430, 100
  %265 = add nsw i64 %264, %225
  %266 = icmp sgt i64 %265, 0
  %267 = select i1 %266, i64 %265, i64 0
  %268 = add nsw i64 %265, 99
...
polly.loop_header468.preheader:                   ; preds = %polly.loop_exit456, %polly.loop_exit456.us, %polly.loop_header427.split
  ...
  %polly.loop_guard478 = icmp slt i64 %272, 100
...
polly.loop_header468.us:                          ; preds = %polly.loop_header468.preheader, %polly.loop_exit477.loopexit.us
  ...
  %scevgep1341 = getelementptr i8, i8* %malloccall302, i64 %273
  %274 = or i64 %273, 8
  %scevgep1342 = getelementptr i8, i8* %malloccall302, i64 %274
...
polly.loop_header475.us:                          ; preds = %polly.loop_header468.us, %polly.loop_exit485.us
  %indvar1335 = phi i64 [ 0, %polly.loop_header468.us ], [ %indvar.next1336, %polly.loop_exit485.us ]
  %indvars.iv1101 = phi i64 [ %262, %polly.loop_header468.us ], [ %indvars.iv.next1102, %polly.loop_exit485.us ]
  %polly.indvar479.us = phi i64 [ %272, %polly.loop_header468.us ], [ %polly.indvar_next480.us, %polly.loop_exit485.us ]
  %275 = add i64 %251, %indvar1335
  %smin1352 = call i64 @llvm.smin.i64(i64 %275, i64 19)
  %276 = add nsw i64 %smin1352, 1
  %277 = mul nuw nsw i64 %indvar1335, 9600
  %278 = add i64 %258, %277
  %scevgep1337 = getelementptr i8, i8* %call, i64 %278
  %279 = add i64 %259, %277
  %scevgep1338 = getelementptr i8, i8* %call, i64 %279
  %280 = add i64 %261, %indvar1335
  %smin1339 = call i64 @llvm.smin.i64(i64 %280, i64 19)
  %281 = shl nsw i64 %smin1339, 3
  %scevgep1340 = getelementptr i8, i8* %scevgep1338, i64 %281
  %scevgep1343 = getelementptr i8, i8* %scevgep1342, i64 %281
  %smin1103 = call i64 @llvm.smin.i64(i64 %indvars.iv1101, i64 19)
  %282 = add nsw i64 %polly.indvar479.us, %265
  %polly.loop_guard486.us1168 = icmp sgt i64 %282, -1
...
polly.loop_header483.us:                          ; preds = %polly.loop_header483.us.preheader, %polly.loop_header483.us
  ...
  br i1 %exitcond1104.not, label %polly.loop_exit485.us, label %polly.loop_header483.us, !llvm.loop !103

polly.loop_exit485.us:                            ; preds = %polly.loop_header483.us, %middle.block1348, %polly.loop_header475.us
...
polly.loop_header483.preheader.us:                ; preds = %polly.loop_header475.us
  ...
  %min.iters.check1353 = icmp ult i64 %276, 4
  br i1 %min.iters.check1353, label %polly.loop_header483.us.preheader, label %vector.memcheck1331

vector.memcheck1331:                              ; preds = %polly.loop_header483.preheader.us
  ...
  br i1 %found.conflict1346, label %polly.loop_header483.us.preheader, label %vector.ph1354

vector.ph1354:                                    ; preds = %vector.memcheck1331
  %n.vec1356 = and i64 %276, -4
  %broadcast.splatinsert1362 = insertelement <4 x double> poison, double %_p_scalar_497.us, i32 0
  %broadcast.splat1363 = shufflevector <4 x double> %broadcast.splatinsert1362, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1365 = insertelement <4 x double> poison, double %_p_scalar_505.us, i32 0
...
vector.body1350:                                  ; preds = %vector.body1350, %vector.ph1354
  ...
  %288 = add nuw nsw i64 %index1357, %224
  %289 = add nuw nsw i64 %index1357, %polly.access.mul.Packed_MemRef_call1303490.us
  %290 = getelementptr double, double* %Packed_MemRef_call1303, i64 %289
  %291 = bitcast double* %290 to <4 x double>*
  %wide.load1361 = load <4 x double>, <4 x double>* %291, align 8, !alias.scope !104
  %292 = fmul fast <4 x double> %broadcast.splat1363, %wide.load1361
  %293 = getelementptr double, double* %Packed_MemRef_call2305, i64 %289
  %294 = bitcast double* %293 to <4 x double>*
  %wide.load1364 = load <4 x double>, <4 x double>* %294, align 8
  %295 = fmul fast <4 x double> %broadcast.splat1366, %wide.load1364
  %296 = shl i64 %288, 3
  %297 = add i64 %296, %287
  %298 = getelementptr i8, i8* %call, i64 %297
  %299 = bitcast i8* %298 to <4 x double>*
  %wide.load1367 = load <4 x double>, <4 x double>* %299, align 8, !alias.scope !107, !noalias !109
  ...
  %302 = fadd fast <4 x double> %301, %wide.load1367
  ...
  %304 = icmp eq i64 %index.next1358, %n.vec1356
  br i1 %304, label %middle.block1348, label %vector.body1350, !llvm.loop !110

middle.block1348:                                 ; preds = %vector.body1350
  %cmp.n1360 = icmp eq i64 %276, %n.vec1356
  br i1 %cmp.n1360, label %polly.loop_exit485.us, label %polly.loop_header483.us.preheader

polly.loop_header483.us.preheader:                ; preds = %vector.memcheck1331, %polly.loop_header483.preheader.us, %middle.block1348
  %polly.indvar487.us.ph = phi i64 [ 0, %vector.memcheck1331 ], [ 0, %polly.loop_header483.preheader.us ], [ %n.vec1356, %middle.block1348 ]
...
polly.loop_header599:                             ; preds = %polly.loop_exit607, %polly.start511
  ...
  %min.iters.check1259 = icmp ult i64 %306, 4
...
vector.body1258:                                  ; preds = %vector.body1258, %vector.ph1260
  ...
  %308 = shl nuw nsw i64 %index1263, 3
  %309 = getelementptr i8, i8* %scevgep611, i64 %308
  %310 = bitcast i8* %309 to <4 x double>*
  %wide.load1267 = load <4 x double>, <4 x double>* %310, align 8, !alias.scope !111, !noalias !113
  %311 = fmul fast <4 x double> %wide.load1267, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %313 = icmp eq i64 %index.next1264, %n.vec1262
  br i1 %313, label %middle.block1256, label %vector.body1258, !llvm.loop !118

middle.block1256:                                 ; preds = %vector.body1258
  %cmp.n1266 = icmp eq i64 %306, %n.vec1262
...
polly.loop_header605:                             ; preds = %polly.loop_header605.preheader, %polly.loop_header605
  ...
  br i1 %exitcond1131.not, label %polly.loop_exit607, label %polly.loop_header605, !llvm.loop !119
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %316 = udiv i64 %polly.indvar618, 5
  ...
  %323 = udiv i64 %polly.indvar618, 5
  %324 = mul nuw nsw i64 %323, 100
  %325 = sub nsw i64 %322, %324
  %326 = or i64 %321, 8
  %327 = mul nsw i64 %polly.indvar618, -20
  %328 = add i64 %327, %324
  %329 = udiv i64 %polly.indvar618, 5
  %330 = mul nuw nsw i64 %329, 100
  %331 = sub nsw i64 %indvars.iv1116, %330
  %332 = add i64 %indvars.iv1121, %330
...
polly.loop_exit640:                               ; preds = %polly.loop_exit681
  ...
  %exitcond1130.not = icmp eq i64 %354, 60
...
polly.loop_header638:                             ; preds = %polly.loop_exit681, %polly.loop_exit623
  %indvar1269 = phi i64 [ %indvar.next1270, %polly.loop_exit681 ], [ 0, %polly.loop_exit623 ]
  %indvars.iv1123 = phi i64 [ %indvars.iv.next1124, %polly.loop_exit681 ], [ %332, %polly.loop_exit623 ]
  %indvars.iv1118 = phi i64 [ %indvars.iv.next1119, %polly.loop_exit681 ], [ %331, %polly.loop_exit623 ]
  %polly.indvar641 = phi i64 [ %polly.indvar_next642, %polly.loop_exit681 ], [ %329, %polly.loop_exit623 ]
  %356 = mul nsw i64 %indvar1269, -100
  %357 = add i64 %318, %356
  %smax1288 = call i64 @llvm.smax.i64(i64 %357, i64 0)
  %358 = mul nuw nsw i64 %indvar1269, 100
  %359 = add i64 %320, %358
  %360 = add i64 %smax1288, %359
  %361 = mul nsw i64 %indvar1269, -100
  %362 = add i64 %325, %361
  %smax1271 = call i64 @llvm.smax.i64(i64 %362, i64 0)
  %363 = mul nuw nsw i64 %indvar1269, 100
  %364 = add i64 %324, %363
  %365 = add i64 %smax1271, %364
  %366 = mul nsw i64 %365, 9600
  %367 = add i64 %321, %366
  %368 = add i64 %326, %366
  %369 = add i64 %328, %363
  %370 = add i64 %smax1271, %369
  %smax1120 = call i64 @llvm.smax.i64(i64 %indvars.iv1118, i64 0)
  %371 = add i64 %smax1120, %indvars.iv1123
  %372 = mul nuw nsw i64 %polly.indvar641, 5
  %.not.not927 = icmp ugt i64 %372, %polly.indvar618
  %373 = mul nuw nsw i64 %polly.indvar641, 100
  %374 = add nsw i64 %373, %334
  %375 = icmp sgt i64 %374, 0
  %376 = select i1 %375, i64 %374, i64 0
  %377 = add nsw i64 %374, 99
...
polly.loop_header679.preheader:                   ; preds = %polly.loop_exit667, %polly.loop_exit667.us, %polly.loop_header638.split
  ...
  %polly.loop_guard689 = icmp slt i64 %381, 100
...
polly.loop_header679.us:                          ; preds = %polly.loop_header679.preheader, %polly.loop_exit688.loopexit.us
  ...
  %scevgep1278 = getelementptr i8, i8* %malloccall513, i64 %382
  %383 = or i64 %382, 8
  %scevgep1279 = getelementptr i8, i8* %malloccall513, i64 %383
...
polly.loop_header686.us:                          ; preds = %polly.loop_header679.us, %polly.loop_exit696.us
  %indvar1272 = phi i64 [ 0, %polly.loop_header679.us ], [ %indvar.next1273, %polly.loop_exit696.us ]
  %indvars.iv1125 = phi i64 [ %371, %polly.loop_header679.us ], [ %indvars.iv.next1126, %polly.loop_exit696.us ]
  %polly.indvar690.us = phi i64 [ %381, %polly.loop_header679.us ], [ %polly.indvar_next691.us, %polly.loop_exit696.us ]
  %384 = add i64 %360, %indvar1272
  %smin1289 = call i64 @llvm.smin.i64(i64 %384, i64 19)
  %385 = add nsw i64 %smin1289, 1
  %386 = mul nuw nsw i64 %indvar1272, 9600
  %387 = add i64 %367, %386
  %scevgep1274 = getelementptr i8, i8* %call, i64 %387
  %388 = add i64 %368, %386
  %scevgep1275 = getelementptr i8, i8* %call, i64 %388
  %389 = add i64 %370, %indvar1272
  %smin1276 = call i64 @llvm.smin.i64(i64 %389, i64 19)
  %390 = shl nsw i64 %smin1276, 3
  %scevgep1277 = getelementptr i8, i8* %scevgep1275, i64 %390
  %scevgep1280 = getelementptr i8, i8* %scevgep1279, i64 %390
  %smin1127 = call i64 @llvm.smin.i64(i64 %indvars.iv1125, i64 19)
  %391 = add nsw i64 %polly.indvar690.us, %374
  %polly.loop_guard697.us1169 = icmp sgt i64 %391, -1
...
polly.loop_header694.us:                          ; preds = %polly.loop_header694.us.preheader, %polly.loop_header694.us
  ...
  br i1 %exitcond1128.not, label %polly.loop_exit696.us, label %polly.loop_header694.us, !llvm.loop !122

polly.loop_exit696.us:                            ; preds = %polly.loop_header694.us, %middle.block1285, %polly.loop_header686.us
...
polly.loop_header694.preheader.us:                ; preds = %polly.loop_header686.us
  ...
  %min.iters.check1290 = icmp ult i64 %385, 4
  br i1 %min.iters.check1290, label %polly.loop_header694.us.preheader, label %vector.memcheck1268

vector.memcheck1268:                              ; preds = %polly.loop_header694.preheader.us
  ...
  br i1 %found.conflict1283, label %polly.loop_header694.us.preheader, label %vector.ph1291

vector.ph1291:                                    ; preds = %vector.memcheck1268
  %n.vec1293 = and i64 %385, -4
  %broadcast.splatinsert1299 = insertelement <4 x double> poison, double %_p_scalar_708.us, i32 0
  %broadcast.splat1300 = shufflevector <4 x double> %broadcast.splatinsert1299, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1302 = insertelement <4 x double> poison, double %_p_scalar_716.us, i32 0
...
vector.body1287:                                  ; preds = %vector.body1287, %vector.ph1291
  ...
  %397 = add nuw nsw i64 %index1294, %333
  %398 = add nuw nsw i64 %index1294, %polly.access.mul.Packed_MemRef_call1514701.us
  %399 = getelementptr double, double* %Packed_MemRef_call1514, i64 %398
  %400 = bitcast double* %399 to <4 x double>*
  %wide.load1298 = load <4 x double>, <4 x double>* %400, align 8, !alias.scope !123
  %401 = fmul fast <4 x double> %broadcast.splat1300, %wide.load1298
  %402 = getelementptr double, double* %Packed_MemRef_call2516, i64 %398
  %403 = bitcast double* %402 to <4 x double>*
  %wide.load1301 = load <4 x double>, <4 x double>* %403, align 8
  %404 = fmul fast <4 x double> %broadcast.splat1303, %wide.load1301
  %405 = shl i64 %397, 3
  %406 = add i64 %405, %396
  %407 = getelementptr i8, i8* %call, i64 %406
  %408 = bitcast i8* %407 to <4 x double>*
  %wide.load1304 = load <4 x double>, <4 x double>* %408, align 8, !alias.scope !126, !noalias !128
  ...
  %411 = fadd fast <4 x double> %410, %wide.load1304
  ...
  %413 = icmp eq i64 %index.next1295, %n.vec1293
  br i1 %413, label %middle.block1285, label %vector.body1287, !llvm.loop !129

middle.block1285:                                 ; preds = %vector.body1287
  %cmp.n1297 = icmp eq i64 %385, %n.vec1293
  br i1 %cmp.n1297, label %polly.loop_exit696.us, label %polly.loop_header694.us.preheader

polly.loop_header694.us.preheader:                ; preds = %vector.memcheck1268, %polly.loop_header694.preheader.us, %middle.block1285
  %polly.indvar698.us.ph = phi i64 [ 0, %vector.memcheck1268 ], [ 0, %polly.loop_header694.preheader.us ], [ %n.vec1293, %middle.block1285 ]
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %smin1197 = call i64 @llvm.smin.i64(i64 %417, i64 -1168)
  %418 = add nsw i64 %smin1197, 1200
  %smin1155 = call i64 @llvm.smin.i64(i64 %indvars.iv1153, i64 -1168)
  %419 = shl nsw i64 %polly.indvar855, 5
  %420 = add nsw i64 %smin1155, 1199
...
vector.ph1198:                                    ; preds = %polly.loop_header858
  %broadcast.splatinsert1205 = insertelement <4 x i64> poison, i64 %419, i32 0
  %broadcast.splat1206 = shufflevector <4 x i64> %broadcast.splatinsert1205, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1207 = insertelement <4 x i32> poison, i32 %422, i32 0
...
vector.body1196:                                  ; preds = %vector.body1196, %vector.ph1198
  ...
  %424 = add nuw nsw <4 x i64> %vec.ind1203, %broadcast.splat1206
  %425 = trunc <4 x i64> %424 to <4 x i32>
  %426 = mul <4 x i32> %broadcast.splat1208, %425
  ...
  %436 = icmp eq i64 %index.next1200, %418
  br i1 %436, label %polly.loop_exit866, label %vector.body1196, !llvm.loop !135

polly.loop_exit866:                               ; preds = %vector.body1196, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1160.not = icmp eq i64 %polly.indvar861, %416
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1156.not = icmp eq i64 %polly.indvar867, %420
  br i1 %exitcond1156.not, label %polly.loop_exit866, label %polly.loop_header864, !llvm.loop !136
...
polly.loop_header879:                             ; preds = %polly.loop_exit887, %polly.loop_header873
  ...
  %smin1212 = call i64 @llvm.smin.i64(i64 %446, i64 -968)
  %447 = add nsw i64 %smin1212, 1000
  %smin1145 = call i64 @llvm.smin.i64(i64 %indvars.iv1143, i64 -968)
  %448 = shl nsw i64 %polly.indvar882, 5
  %449 = add nsw i64 %smin1145, 999
...
vector.body1211:                                  ; preds = %vector.body1211, %vector.ph1214
  ...
  %453 = add nuw nsw <4 x i64> %vec.ind1221, %broadcast.splat1224
  %454 = trunc <4 x i64> %453 to <4 x i32>
  %455 = mul <4 x i32> %broadcast.splat1226, %454
  ...
  %465 = icmp eq i64 %index.next1218, %447
  br i1 %465, label %polly.loop_exit893, label %vector.body1211, !llvm.loop !138

polly.loop_exit893:                               ; preds = %vector.body1211, %polly.loop_header891
  %polly.indvar_next889 = add nuw nsw i64 %polly.indvar888, 1
  %exitcond1150.not = icmp eq i64 %polly.indvar888, %445
...
polly.loop_header891:                             ; preds = %polly.loop_header885, %polly.loop_header891
  ...
  %exitcond1146.not = icmp eq i64 %polly.indvar894, %449
  br i1 %exitcond1146.not, label %polly.loop_exit893, label %polly.loop_header891, !llvm.loop !139
...
polly.loop_header905:                             ; preds = %polly.loop_exit913, %polly.loop_header899
  ...
  %smin1230 = call i64 @llvm.smin.i64(i64 %475, i64 -968)
  %476 = add nsw i64 %smin1230, 1000
  %smin1135 = call i64 @llvm.smin.i64(i64 %indvars.iv1133, i64 -968)
  %477 = shl nsw i64 %polly.indvar908, 5
  %478 = add nsw i64 %smin1135, 999
...
vector.body1229:                                  ; preds = %vector.body1229, %vector.ph1232
  ...
  %482 = add nuw nsw <4 x i64> %vec.ind1239, %broadcast.splat1242
  %483 = trunc <4 x i64> %482 to <4 x i32>
  %484 = mul <4 x i32> %broadcast.splat1244, %483
  ...
  %494 = icmp eq i64 %index.next1236, %476
  br i1 %494, label %polly.loop_exit919, label %vector.body1229, !llvm.loop !141

polly.loop_exit919:                               ; preds = %vector.body1229, %polly.loop_header917
  %polly.indvar_next915 = add nuw nsw i64 %polly.indvar914, 1
  %exitcond1140.not = icmp eq i64 %polly.indvar914, %474
...
polly.loop_header917:                             ; preds = %polly.loop_header911, %polly.loop_header917
  ...
  %exitcond1136.not = icmp eq i64 %polly.indvar920, %478
  br i1 %exitcond1136.not, label %polly.loop_exit919, label %polly.loop_header917, !llvm.loop !142
}
