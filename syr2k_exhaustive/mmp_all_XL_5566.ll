; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5566.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5566.c"
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %143 = lshr i64 %polly.indvar383, 2
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit572.3
  ...
  %188 = shl nsw i64 %polly.indvar584, 4
  %189 = sub nsw i64 %185, %188
  %190 = icmp sgt i64 %189, 0
  %191 = select i1 %190, i64 %189, i64 0
  %polly.loop_guard597 = icmp slt i64 %191, 16
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  br i1 %223, label %polly.loop_exit772, label %vector.body980, !llvm.loop !103
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  br i1 %exitcond940.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !104
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %252, label %polly.loop_exit799, label %vector.body995, !llvm.loop !106
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  br i1 %exitcond930.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !107
...
vector.body1013:                                  ; preds = %vector.body1013, %vector.ph1016
  ...
  br i1 %281, label %polly.loop_exit825, label %vector.body1013, !llvm.loop !109
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  br i1 %exitcond920.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !110
