; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8600.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8600.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %115 = mul nsw i64 %polly.indvar214, 50
  %116 = sub nsw i64 %112, %115
  %117 = icmp sgt i64 %116, 0
  %118 = select i1 %117, i64 %116, i64 0
  %polly.loop_guard227 = icmp slt i64 %118, 50
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %polly.loop_guard373 = icmp slt i64 %150, 24
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %153 = shl nsw i64 %polly.indvar365, 7
  %154 = mul nsw i64 %polly.indvar365, -128
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %156 = mul nsw i64 %polly.indvar374, 50
  %157 = sub nsw i64 %153, %156
  %158 = icmp sgt i64 %157, 0
  %159 = select i1 %158, i64 %157, i64 0
  %polly.loop_guard387 = icmp slt i64 %159, 50
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %polly.loop_guard533 = icmp slt i64 %191, 24
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  ...
  %194 = shl nsw i64 %polly.indvar525, 7
  %195 = mul nsw i64 %polly.indvar525, -128
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %197 = mul nsw i64 %polly.indvar534, 50
  %198 = sub nsw i64 %194, %197
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %polly.loop_guard547 = icmp slt i64 %200, 50
...
polly.loop_header224.us.1:                        ; preds = %polly.loop_exit234.us, %polly.loop_exit234.us.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv802.1, i64 127)
...
polly.loop_header224.us.2:                        ; preds = %polly.loop_exit234.us.1, %polly.loop_exit234.us.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv802.2, i64 127)
...
polly.loop_header224.us.3:                        ; preds = %polly.loop_exit234.us.2, %polly.loop_exit234.us.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv802.3, i64 127)
...
polly.loop_header384.us.1:                        ; preds = %polly.loop_exit394.us, %polly.loop_exit394.us.1
  ...
  %smin822.1 = call i64 @llvm.smin.i64(i64 %indvars.iv820.1, i64 127)
...
polly.loop_header384.us.2:                        ; preds = %polly.loop_exit394.us.1, %polly.loop_exit394.us.2
  ...
  %smin822.2 = call i64 @llvm.smin.i64(i64 %indvars.iv820.2, i64 127)
...
polly.loop_header384.us.3:                        ; preds = %polly.loop_exit394.us.2, %polly.loop_exit394.us.3
  ...
  %smin822.3 = call i64 @llvm.smin.i64(i64 %indvars.iv820.3, i64 127)
