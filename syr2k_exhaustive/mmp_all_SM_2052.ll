; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2052.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2052.c"
...
polly.loop_header222.preheader:                   ; preds = %polly.loop_header216
  %102 = mul nsw i64 %polly.indvar219, -50
...
polly.loop_exit224:                               ; preds = %polly.loop_exit231, %polly.loop_header216
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar_next220, 24
...
polly.loop_header222:                             ; preds = %polly.loop_header222.preheader, %polly.loop_exit231
  ...
  %104 = shl nuw nsw i64 %polly.indvar225, 6
  %105 = add i64 %97, %104
  %smax1321 = call i64 @llvm.smax.i64(i64 %105, i64 0)
  %106 = mul nsw i64 %polly.indvar225, -64
  %107 = add i64 %98, %106
  ...
  %polly.loop_guard232 = icmp slt i64 %112, 50
...
polly.loop_exit231:                               ; preds = %polly.loop_exit263, %polly.loop_header222
  ...
  %indvars.iv.next1029 = add nsw i64 %indvars.iv1028, -64
...
polly.loop_header229:                             ; preds = %polly.loop_header229.preheader, %polly.loop_exit263
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %116, i64 63)
  %117 = add nsw i64 %smin1324, 1
  %smin1034 = call i64 @llvm.smin.i64(i64 %indvars.iv1030, i64 63)
...
polly.loop_exit263:                               ; preds = %polly.loop_exit270.loopexit.us, %polly.loop_header229.split, %polly.loop_header261.preheader
  ...
  %polly.loop_cond235 = icmp ult i64 %polly.indvar233, 49
...
polly.loop_header416:                             ; preds = %polly.loop_exit408, %polly.loop_exit426
  ...
  %152 = mul nsw i64 %polly.indvar419, -50
  %153 = mul nuw nsw i64 %polly.indvar419, 50
...
polly.loop_header424.preheader:                   ; preds = %polly.loop_header416
  %157 = mul nsw i64 %polly.indvar419, -50
  %158 = mul nuw nsw i64 %polly.indvar419, 50
...
polly.loop_exit426:                               ; preds = %polly.loop_exit434, %polly.loop_header416
  ...
  %indvars.iv.next1049 = add nuw nsw i64 %indvars.iv1048, 50
  %exitcond1060.not = icmp eq i64 %polly.indvar_next420, 24
...
polly.loop_header424:                             ; preds = %polly.loop_header424.preheader, %polly.loop_exit434
  ...
  %159 = shl nuw nsw i64 %polly.indvar428, 6
  %160 = add i64 %152, %159
  %smax1273 = call i64 @llvm.smax.i64(i64 %160, i64 0)
  %161 = mul nsw i64 %polly.indvar428, -64
  %162 = add i64 %153, %161
  %163 = add i64 %smax1273, %162
  %164 = shl nsw i64 %polly.indvar428, 6
  %165 = add nsw i64 %164, %157
  %166 = icmp sgt i64 %165, 0
  %167 = select i1 %166, i64 %165, i64 0
  %polly.loop_guard435 = icmp slt i64 %167, 50
...
polly.loop_header432:                             ; preds = %polly.loop_header432.preheader, %polly.loop_exit470
  ...
  %smin1276 = call i64 @llvm.smin.i64(i64 %171, i64 63)
  %172 = add nsw i64 %smin1276, 1
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1052, i64 63)
...
polly.loop_exit470:                               ; preds = %polly.loop_exit477.loopexit.us, %polly.loop_header432.split, %polly.loop_header468.preheader
  ...
  %polly.loop_cond438 = icmp ult i64 %polly.indvar436, 49
...
polly.loop_header623:                             ; preds = %polly.loop_exit615, %polly.loop_exit633
  ...
  %207 = mul nsw i64 %polly.indvar626, -50
  %208 = mul nuw nsw i64 %polly.indvar626, 50
...
polly.loop_header631.preheader:                   ; preds = %polly.loop_header623
  %212 = mul nsw i64 %polly.indvar626, -50
  %213 = mul nuw nsw i64 %polly.indvar626, 50
...
polly.loop_exit633:                               ; preds = %polly.loop_exit641, %polly.loop_header623
  ...
  %indvars.iv.next1072 = add nuw nsw i64 %indvars.iv1071, 50
  %exitcond1083.not = icmp eq i64 %polly.indvar_next627, 24
...
polly.loop_exit641:                               ; preds = %polly.loop_exit677, %polly.loop_header631
  ...
  %indvars.iv.next1069 = add nsw i64 %indvars.iv1068, 64
...
polly.loop_header639:                             ; preds = %polly.loop_header639.preheader, %polly.loop_exit677
  ...
  %smin1228 = call i64 @llvm.smin.i64(i64 %226, i64 63)
  %227 = add nsw i64 %smin1228, 1
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 63)
...
polly.loop_exit677:                               ; preds = %polly.loop_exit684.loopexit.us, %polly.loop_header639.split, %polly.loop_header675.preheader
  ...
  %polly.loop_cond645 = icmp ult i64 %polly.indvar643, 49
