; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1219.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1219.c"
...
polly.loop_header416:                             ; preds = %polly.loop_exit440, %polly.loop_header410
  ...
  %178 = mul nuw nsw i64 %polly.indvar419, 1229824
  %179 = or i64 %178, 8
  %180 = mul nuw nsw i64 %polly.indvar419, 1229824
  %181 = or i64 %180, 8
  %182 = mul nuw nsw i64 %polly.indvar419, 1229824
  %183 = or i64 %182, 8
  %184 = mul nsw i64 %polly.indvar419, -128
  %185 = shl nsw i64 %polly.indvar419, 7
...
polly.loop_header438:                             ; preds = %polly.loop_exit430.3, %polly.loop_exit479
  ...
  %187 = shl nuw nsw i64 %indvar1430, 7
  %188 = mul nuw nsw i64 %indvar1430, 1228800
  %189 = add i64 %178, %188
  %190 = add i64 %179, %188
  %191 = shl nuw nsw i64 %indvar1430, 7
  %192 = shl nuw nsw i64 %indvar1430, 7
  %193 = mul nuw nsw i64 %indvar1430, 1228800
  %194 = add i64 %180, %193
  %195 = add i64 %181, %193
  %196 = shl nuw nsw i64 %indvar1430, 7
  %197 = shl nuw nsw i64 %indvar1430, 7
  %198 = mul nuw nsw i64 %indvar1430, 1228800
  %199 = add i64 %182, %198
  %200 = add i64 %183, %198
  %201 = shl nuw nsw i64 %indvar1430, 7
  %202 = shl nuw nsw i64 %indvar1430, 7
  ...
  %204 = shl nsw i64 %polly.indvar441, 7
...
polly.loop_header477.preheader:                   ; preds = %polly.loop_header463.us.3, %polly.loop_header463.3, %polly.loop_exit453.loopexit.us.3, %polly.loop_header438.split
  %211 = mul nsw i64 %polly.indvar441, -128
...
polly.loop_header628:                             ; preds = %polly.loop_exit652, %polly.loop_header622
  ...
  %255 = mul nuw nsw i64 %polly.indvar631, 1229824
  %256 = or i64 %255, 8
  %257 = mul nuw nsw i64 %polly.indvar631, 1229824
  %258 = or i64 %257, 8
  %259 = mul nuw nsw i64 %polly.indvar631, 1229824
  %260 = or i64 %259, 8
  %261 = mul nsw i64 %polly.indvar631, -128
  %262 = shl nsw i64 %polly.indvar631, 7
...
polly.loop_header650:                             ; preds = %polly.loop_exit642.3, %polly.loop_exit691
  ...
  %264 = shl nuw nsw i64 %indvar1291, 7
  %265 = mul nuw nsw i64 %indvar1291, 1228800
  %266 = add i64 %255, %265
  %267 = add i64 %256, %265
  %268 = shl nuw nsw i64 %indvar1291, 7
  %269 = shl nuw nsw i64 %indvar1291, 7
  %270 = mul nuw nsw i64 %indvar1291, 1228800
  %271 = add i64 %257, %270
  %272 = add i64 %258, %270
  %273 = shl nuw nsw i64 %indvar1291, 7
  %274 = shl nuw nsw i64 %indvar1291, 7
  %275 = mul nuw nsw i64 %indvar1291, 1228800
  %276 = add i64 %259, %275
  %277 = add i64 %260, %275
  %278 = shl nuw nsw i64 %indvar1291, 7
  %279 = shl nuw nsw i64 %indvar1291, 7
  ...
  %281 = shl nsw i64 %polly.indvar653, 7
...
polly.loop_header689.preheader:                   ; preds = %polly.loop_header675.us.3, %polly.loop_header675.3, %polly.loop_exit665.loopexit.us.3, %polly.loop_header650.split
  %288 = mul nsw i64 %polly.indvar653, -128
...
polly.loop_header272.us.3:                        ; preds = %polly.loop_exit281.us.2, %polly.loop_exit281.us.3
  ...
  %smin1571 = call i64 @llvm.smin.i64(i64 %479, i64 127)
...
polly.loop_header484.us.3:                        ; preds = %polly.loop_exit493.us.2, %polly.loop_exit493.us.3
  ...
  %smin1432 = call i64 @llvm.smin.i64(i64 %577, i64 127)
...
polly.loop_header696.us.3:                        ; preds = %polly.loop_exit705.us.2, %polly.loop_exit705.us.3
  ...
  %smin1293 = call i64 @llvm.smin.i64(i64 %675, i64 127)
