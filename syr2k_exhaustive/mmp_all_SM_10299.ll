; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10299.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10299.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %146 = udiv i64 %indvars.iv820, 5
  %147 = sub nsw i64 %indvars.iv818, %146
  %smin822 = call i64 @llvm.smin.i64(i64 %147, i64 54)
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %195 = udiv i64 %indvars.iv844, 5
  %196 = sub nsw i64 %indvars.iv842, %195
  %smin846 = call i64 @llvm.smin.i64(i64 %196, i64 54)
