; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4829.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4829.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv976 = phi i64 [ 15, %polly.loop_header199.preheader ], [ %indvars.iv.next977, %polly.loop_exit207 ]
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv976, i64 299)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next966 = add nuw nsw i64 %indvars.iv965, 64
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit387
  %indvars.iv1000 = phi i64 [ 15, %polly.loop_header379.preheader ], [ %indvars.iv.next1001, %polly.loop_exit387 ]
  ...
  %umin1002 = call i64 @llvm.umin.i64(i64 %indvars.iv1000, i64 299)
  %128 = mul nsw i64 %polly.indvar382, -64
  %129 = icmp slt i64 %128, -1136
  %130 = select i1 %129, i64 %128, i64 -1136
  %131 = add nsw i64 %130, 1199
  %132 = shl nsw i64 %polly.indvar382, 6
...
polly.loop_exit387:                               ; preds = %polly.loop_exit394
  ...
  %indvars.iv.next989 = add nuw nsw i64 %indvars.iv988, 64
  %indvars.iv.next1001 = add nuw nsw i64 %indvars.iv1000, 16
  %exitcond1004.not = icmp eq i64 %polly.indvar_next383, 19
...
polly.loop_header385:                             ; preds = %polly.loop_exit394, %polly.loop_header379
  ...
  %133 = shl nsw i64 %polly.indvar388, 2
...
polly.loop_header565:                             ; preds = %polly.loop_header565.preheader, %polly.loop_exit573
  %indvars.iv1025 = phi i64 [ 15, %polly.loop_header565.preheader ], [ %indvars.iv.next1026, %polly.loop_exit573 ]
  ...
  %umin1027 = call i64 @llvm.umin.i64(i64 %indvars.iv1025, i64 299)
  %159 = mul nsw i64 %polly.indvar568, -64
  %160 = icmp slt i64 %159, -1136
  %161 = select i1 %160, i64 %159, i64 -1136
  %162 = add nsw i64 %161, 1199
  %163 = shl nsw i64 %polly.indvar568, 6
...
polly.loop_exit573:                               ; preds = %polly.loop_exit580
  ...
  %indvars.iv.next1014 = add nuw nsw i64 %indvars.iv1013, 64
  %indvars.iv.next1026 = add nuw nsw i64 %indvars.iv1025, 16
  %exitcond1029.not = icmp eq i64 %polly.indvar_next569, 19
...
polly.loop_header571:                             ; preds = %polly.loop_exit580, %polly.loop_header565
  ...
  %164 = shl nsw i64 %polly.indvar574, 2
