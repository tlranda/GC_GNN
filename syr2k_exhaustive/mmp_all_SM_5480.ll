; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5480.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5480.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %smin.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.3, i64 15)
  %119 = or i64 %103, 4
  ...
  %smin.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.4, i64 15)
  %123 = or i64 %103, 5
  ...
  %smin.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.5, i64 15)
  %127 = or i64 %103, 6
  ...
  %smin.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.6, i64 15)
  %131 = or i64 %103, 7
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %154 = shl nsw i64 %polly.indvar381, 4
  br label %polly.loop_header384

polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %155 = mul nsw i64 %polly.indvar381, -16
  %156 = shl nuw nsw i64 %polly.indvar381, 1
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %smin859.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.3, i64 15)
  %175 = or i64 %159, 4
  ...
  %smin859.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.4, i64 15)
  %179 = or i64 %159, 5
  ...
  %smin859.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.5, i64 15)
  %183 = or i64 %159, 6
  ...
  %smin859.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.6, i64 15)
  %187 = or i64 %159, 7
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %210 = shl nsw i64 %polly.indvar554, 4
  br label %polly.loop_header557

polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %211 = mul nsw i64 %polly.indvar554, -16
  %212 = shl nuw nsw i64 %polly.indvar554, 1
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit559
  ...
  %smin876.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.3, i64 15)
  %231 = or i64 %215, 4
  ...
  %smin876.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.4, i64 15)
  %235 = or i64 %215, 5
  ...
  %smin876.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.5, i64 15)
  %239 = or i64 %215, 6
  ...
  %smin876.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.6, i64 15)
  %243 = or i64 %215, 7
