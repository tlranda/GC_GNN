; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2540.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2540.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit224 ], [ 24, %polly.loop_exit208 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1032 = add nuw nsw i64 %indvars.iv1031, 25
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %102 = shl nuw nsw i64 %polly.indvar225, 8
  %103 = add i64 %97, %102
  %smax1324 = call i64 @llvm.smax.i64(i64 %103, i64 0)
  %104 = mul nsw i64 %polly.indvar225, -256
  %105 = add i64 %98, %104
  %106 = add i64 %smax1324, %105
  %107 = shl nsw i64 %polly.indvar225, 8
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %114, i64 255)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit423 ], [ 24, %polly.loop_exit406 ]
  ...
  %151 = mul nuw nsw i64 %polly.indvar417, 100
  %152 = lshr i64 %indvars.iv1057, 6
  %153 = mul nsw i64 %polly.indvar417, -100
  %154 = mul nuw nsw i64 %polly.indvar417, 100
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %indvars.iv.next1058 = add nuw nsw i64 %indvars.iv1057, 25
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %155 = shl nuw nsw i64 %polly.indvar424, 8
  %156 = add i64 %150, %155
  %smax1276 = call i64 @llvm.smax.i64(i64 %156, i64 0)
  %157 = mul nsw i64 %polly.indvar424, -256
  %158 = add i64 %151, %157
  %159 = add i64 %smax1276, %158
  %160 = shl nsw i64 %polly.indvar424, 8
  %161 = add nsw i64 %160, %153
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %polly.loop_guard431 = icmp slt i64 %163, 100
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %167, i64 255)
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  %indvars.iv1083 = phi i64 [ %indvars.iv.next1084, %polly.loop_exit628 ], [ 24, %polly.loop_exit611 ]
  ...
  %203 = mul nsw i64 %polly.indvar622, -100
  %204 = mul nuw nsw i64 %polly.indvar622, 100
  %205 = lshr i64 %indvars.iv1083, 6
  %206 = mul nsw i64 %polly.indvar622, -100
  %207 = mul nuw nsw i64 %polly.indvar622, 100
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 25
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %208 = shl nuw nsw i64 %polly.indvar629, 8
  %209 = add i64 %203, %208
  %smax1228 = call i64 @llvm.smax.i64(i64 %209, i64 0)
  %210 = mul nsw i64 %polly.indvar629, -256
  %211 = add i64 %204, %210
  %212 = add i64 %smax1228, %211
  %213 = shl nsw i64 %polly.indvar629, 8
  %214 = add nsw i64 %213, %206
  %215 = icmp sgt i64 %214, 0
  %216 = select i1 %215, i64 %214, i64 0
  %polly.loop_guard636 = icmp slt i64 %216, 100
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %220, i64 255)
