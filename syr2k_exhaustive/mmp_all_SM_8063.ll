; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8063.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8063.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond778.not = icmp eq i64 %polly.indvar_next209, 300
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph964
  ...
  %123 = shl nuw nsw i64 %index967, 3
  %124 = getelementptr i8, i8* %scevgep348, i64 %123
  %125 = bitcast i8* %124 to <4 x double>*
  %wide.load971 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !71, !noalias !73
  %126 = fmul fast <4 x double> %wide.load971, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %128 = icmp eq i64 %index.next968, %n.vec966
  br i1 %128, label %middle.block958, label %vector.body960, !llvm.loop !76

middle.block958:                                  ; preds = %vector.body960
  %cmp.n970 = icmp eq i64 %121, %n.vec966
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %130 = mul nuw nsw i64 %polly.indvar355, 80
  %131 = add nsw i64 %smin791, 999
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %132 = shl nsw i64 %polly.indvar361, 2
  br label %polly.loop_header364

polly.loop_exit366:                               ; preds = %polly.loop_exit372
  %polly.indvar_next362 = add nuw nsw i64 %polly.indvar361, 1
  %exitcond794.not = icmp eq i64 %polly.indvar_next362, 300
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  %156 = shl nuw nsw i64 %index941, 3
  %157 = getelementptr i8, i8* %scevgep501, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load945 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !80, !noalias !82
  %159 = fmul fast <4 x double> %wide.load945, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next942, %n.vec940
  br i1 %161, label %middle.block934, label %vector.body936, !llvm.loop !85

middle.block934:                                  ; preds = %vector.body936
  %cmp.n944 = icmp eq i64 %154, %n.vec940
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit513
  ...
  %163 = mul nuw nsw i64 %polly.indvar508, 80
  %164 = add nsw i64 %smin807, 999
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %165 = shl nsw i64 %polly.indvar514, 2
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond810.not = icmp eq i64 %polly.indvar_next515, 300
...
polly.loop_header688:                             ; preds = %polly.loop_exit696, %polly.loop_header682
  ...
  %smin875 = call i64 @llvm.smin.i64(i64 %189, i64 -1168)
  %190 = add nsw i64 %smin875, 1200
  %smin836 = call i64 @llvm.smin.i64(i64 %indvars.iv834, i64 -1168)
  %191 = shl nsw i64 %polly.indvar691, 5
  %192 = add nsw i64 %smin836, 1199
...
vector.ph876:                                     ; preds = %polly.loop_header694
  %broadcast.splatinsert883 = insertelement <4 x i64> poison, i64 %191, i32 0
  %broadcast.splat884 = shufflevector <4 x i64> %broadcast.splatinsert883, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert885 = insertelement <4 x i32> poison, i32 %194, i32 0
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph876
  ...
  %196 = add nuw nsw <4 x i64> %vec.ind881, %broadcast.splat884
  %197 = trunc <4 x i64> %196 to <4 x i32>
  %198 = mul <4 x i32> %broadcast.splat886, %197
  ...
  %208 = icmp eq i64 %index.next878, %190
  br i1 %208, label %polly.loop_exit702, label %vector.body874, !llvm.loop !94

polly.loop_exit702:                               ; preds = %vector.body874, %polly.loop_header700
  %polly.indvar_next698 = add nuw nsw i64 %polly.indvar697, 1
  %exitcond841.not = icmp eq i64 %polly.indvar697, %188
...
polly.loop_header700:                             ; preds = %polly.loop_header694, %polly.loop_header700
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar703, %192
...
polly.loop_header715:                             ; preds = %polly.loop_exit723, %polly.loop_header709
  ...
  %smin890 = call i64 @llvm.smin.i64(i64 %218, i64 -968)
  %219 = add nsw i64 %smin890, 1000
  %smin826 = call i64 @llvm.smin.i64(i64 %indvars.iv824, i64 -968)
  %220 = shl nsw i64 %polly.indvar718, 5
  %221 = add nsw i64 %smin826, 999
...
vector.body889:                                   ; preds = %vector.body889, %vector.ph892
  ...
  %225 = add nuw nsw <4 x i64> %vec.ind899, %broadcast.splat902
  %226 = trunc <4 x i64> %225 to <4 x i32>
  %227 = mul <4 x i32> %broadcast.splat904, %226
  ...
  %237 = icmp eq i64 %index.next896, %219
  br i1 %237, label %polly.loop_exit729, label %vector.body889, !llvm.loop !97

polly.loop_exit729:                               ; preds = %vector.body889, %polly.loop_header727
  %polly.indvar_next725 = add nuw nsw i64 %polly.indvar724, 1
  %exitcond831.not = icmp eq i64 %polly.indvar724, %217
...
polly.loop_header727:                             ; preds = %polly.loop_header721, %polly.loop_header727
  ...
  %exitcond827.not = icmp eq i64 %polly.indvar730, %221
...
polly.loop_header741:                             ; preds = %polly.loop_exit749, %polly.loop_header735
  ...
  %smin908 = call i64 @llvm.smin.i64(i64 %247, i64 -968)
  %248 = add nsw i64 %smin908, 1000
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 -968)
  %249 = shl nsw i64 %polly.indvar744, 5
  %250 = add nsw i64 %smin816, 999
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  %254 = add nuw nsw <4 x i64> %vec.ind917, %broadcast.splat920
  %255 = trunc <4 x i64> %254 to <4 x i32>
  %256 = mul <4 x i32> %broadcast.splat922, %255
  ...
  %266 = icmp eq i64 %index.next914, %248
  br i1 %266, label %polly.loop_exit755, label %vector.body907, !llvm.loop !100

polly.loop_exit755:                               ; preds = %vector.body907, %polly.loop_header753
  %polly.indvar_next751 = add nuw nsw i64 %polly.indvar750, 1
  %exitcond821.not = icmp eq i64 %polly.indvar750, %246
...
polly.loop_header753:                             ; preds = %polly.loop_header747, %polly.loop_header753
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar756, %250
...
polly.loop_header382.3:                           ; preds = %polly.loop_header382.3, %polly.loop_exit384.2
  ...
  %exitcond787.3.not = icmp eq i64 %polly.indvar_next386.3, 4
...
polly.loop_exit384.3:                             ; preds = %polly.loop_header382.3
  ...
  %exitcond792.not = icmp eq i64 %polly.indvar373, %131
...
polly.loop_header535.3:                           ; preds = %polly.loop_header535.3, %polly.loop_exit537.2
  ...
  %exitcond803.3.not = icmp eq i64 %polly.indvar_next539.3, 4
...
polly.loop_exit537.3:                             ; preds = %polly.loop_header535.3
  ...
  %exitcond808.not = icmp eq i64 %polly.indvar526, %164
