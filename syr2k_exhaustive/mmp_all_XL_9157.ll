; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9157.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9157.c"
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1011
  ...
  %wide.load1018 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %131, label %middle.block1005, label %vector.body1007, !llvm.loop !76
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %141 = mul nuw nsw i64 %polly.indvar365, 80
  %142 = mul nsw i64 %polly.indvar365, -80
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph985
  ...
  %wide.load992 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %167, label %middle.block981, label %vector.body983, !llvm.loop !85
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  ...
  %177 = mul nuw nsw i64 %polly.indvar525, 80
  %178 = mul nsw i64 %polly.indvar525, -80
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph923
  ...
  br i1 %217, label %polly.loop_exit720, label %vector.body921, !llvm.loop !94
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph939
  ...
  br i1 %246, label %polly.loop_exit747, label %vector.body936, !llvm.loop !97
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph957
  ...
  br i1 %275, label %polly.loop_exit773, label %vector.body954, !llvm.loop !100
