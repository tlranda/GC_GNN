; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8831.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8831.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %104 = udiv i64 %polly.indvar208, 20
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond797.not = icmp eq i64 %polly.indvar_next209, 300
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond817.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !77
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %141 = udiv i64 %polly.indvar363, 20
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %indvars.iv.next802 = add nuw nsw i64 %indvars.iv801, 4
  %indvars.iv.next807 = add nsw i64 %indvars.iv806, -4
  %exitcond815.not = icmp eq i64 %polly.indvar_next364, 300
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %178 = udiv i64 %polly.indvar521, 20
...
polly.loop_header538.us:                          ; preds = %polly.loop_header525, %polly.loop_exit548.us
  ...
  %smin830 = call i64 @llvm.smin.i64(i64 %indvars.iv828, i64 3)
...
polly.loop_header223.us.1:                        ; preds = %polly.loop_exit232.us, %polly.loop_exit232.us.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv794.1, i64 3)
...
polly.loop_header223.us.2:                        ; preds = %polly.loop_exit232.us.1, %polly.loop_exit232.us.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv794.2, i64 3)
...
polly.loop_header223.us.3:                        ; preds = %polly.loop_exit232.us.2, %polly.loop_exit232.us.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv794.3, i64 3)
...
polly.loop_header380.us.1:                        ; preds = %polly.loop_exit390.us, %polly.loop_exit390.us.1
  ...
  %smin812.1 = call i64 @llvm.smin.i64(i64 %indvars.iv810.1, i64 3)
...
polly.loop_header380.us.2:                        ; preds = %polly.loop_exit390.us.1, %polly.loop_exit390.us.2
  ...
  %smin812.2 = call i64 @llvm.smin.i64(i64 %indvars.iv810.2, i64 3)
...
polly.loop_header380.us.3:                        ; preds = %polly.loop_exit390.us.2, %polly.loop_exit390.us.3
  ...
  %smin812.3 = call i64 @llvm.smin.i64(i64 %indvars.iv810.3, i64 3)
...
polly.loop_header538.us.1:                        ; preds = %polly.loop_exit548.us, %polly.loop_exit548.us.1
  ...
  %smin830.1 = call i64 @llvm.smin.i64(i64 %indvars.iv828.1, i64 3)
...
polly.loop_header538.us.2:                        ; preds = %polly.loop_exit548.us.1, %polly.loop_exit548.us.2
  ...
  %smin830.2 = call i64 @llvm.smin.i64(i64 %indvars.iv828.2, i64 3)
...
polly.loop_header538.us.3:                        ; preds = %polly.loop_exit548.us.2, %polly.loop_exit548.us.3
  ...
  %smin830.3 = call i64 @llvm.smin.i64(i64 %indvars.iv828.3, i64 3)
