; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10381.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10381.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %104 = shl nsw i64 %polly.indvar214, 8
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233877 = icmp sgt i64 %110, -1
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %124 = shl nuw nsw i64 %index999, 3
  %125 = getelementptr i8, i8* %scevgep350, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1003 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !69, !noalias !71
  %127 = fmul fast <4 x double> %wide.load1003, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1000, %n.vec998
  br i1 %129, label %middle.block990, label %vector.body992, !llvm.loop !74

middle.block990:                                  ; preds = %vector.body992
  %cmp.n1002 = icmp eq i64 %122, %n.vec998
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %138 = shl nsw i64 %polly.indvar370, 8
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar370, %131
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  ...
  %polly.loop_guard391878 = icmp sgt i64 %144, -1
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %158 = shl nuw nsw i64 %index973, 3
  %159 = getelementptr i8, i8* %scevgep508, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load977 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !78, !noalias !80
  %161 = fmul fast <4 x double> %wide.load977, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next974, %n.vec972
  br i1 %163, label %middle.block966, label %vector.body968, !llvm.loop !83

middle.block966:                                  ; preds = %vector.body968
  %cmp.n976 = icmp eq i64 %156, %n.vec972
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %165 = lshr i64 %indvars.iv836, 3
  %166 = mul nsw i64 %polly.indvar515, -96
  %167 = icmp slt i64 %166, -1104
  %168 = select i1 %167, i64 %166, i64 -1104
  %169 = add nsw i64 %168, 1199
  %170 = mul nuw nsw i64 %polly.indvar515, 96
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %172 = shl nsw i64 %polly.indvar528, 8
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar528, %165
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv831 = phi i64 [ %176, %polly.loop_header532.preheader ], [ %indvars.iv.next832, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549879 = icmp sgt i64 %178, -1
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin907 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin907, 1200
  %smin865 = call i64 @llvm.smin.i64(i64 %indvars.iv863, i64 -1168)
  %194 = shl nsw i64 %polly.indvar703, 5
  %195 = add nsw i64 %smin865, 1199
...
vector.ph908:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert915 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat916 = shufflevector <4 x i64> %broadcast.splatinsert915, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert917 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind913, %broadcast.splat916
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat918, %200
  ...
  %211 = icmp eq i64 %index.next910, %193
  br i1 %211, label %polly.loop_exit714, label %vector.body906, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body906, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond870.not = icmp eq i64 %polly.indvar709, %191
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar715, %195
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin922 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin922, 1000
  %smin855 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -968)
  %223 = shl nsw i64 %polly.indvar730, 5
  %224 = add nsw i64 %smin855, 999
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind931, %broadcast.splat934
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat936, %229
  ...
  %240 = icmp eq i64 %index.next928, %222
  br i1 %240, label %polly.loop_exit741, label %vector.body921, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body921, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond860.not = icmp eq i64 %polly.indvar736, %220
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar742, %224
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin940 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin940, 1000
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 -968)
  %252 = shl nsw i64 %polly.indvar756, 5
  %253 = add nsw i64 %smin845, 999
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind949, %broadcast.splat952
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat954, %258
  ...
  %269 = icmp eq i64 %index.next946, %251
  br i1 %269, label %polly.loop_exit767, label %vector.body939, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body939, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond850.not = icmp eq i64 %polly.indvar762, %249
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar768, %253
