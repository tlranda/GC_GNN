; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2082.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2082.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next220, 19
...
polly.loop_exit230:                               ; preds = %polly.loop_exit236
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next226, 63
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %110 = add i64 %97, %109
  %smax1362 = call i64 @llvm.smax.i64(i64 %110, i64 0)
  %111 = mul nsw i64 %polly.indvar231, -20
  %112 = add i64 %98, %111
  %113 = add i64 %smax1362, %112
...
polly.loop_exit236:                               ; preds = %polly.loop_exit267, %polly.loop_header228
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar231, %106
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %121 = add i64 %113, %indvar1363
  %smin1365 = call i64 @llvm.smin.i64(i64 %121, i64 19)
  %122 = add nsw i64 %smin1365, 1
  %smin1050 = call i64 @llvm.smin.i64(i64 %indvars.iv1044, i64 19)
  %123 = add nsw i64 %polly.indvar237, %119
  %polly.loop_guard2501163 = icmp sgt i64 %123, -1
...
polly.loop_header265.us:                          ; preds = %polly.loop_header265.preheader, %polly.loop_exit274.loopexit.us
  ...
  %min.iters.check1366 = icmp ult i64 %122, 4
...
vector.body1361:                                  ; preds = %vector.body1361, %vector.ph1367
  ...
  %130 = add nuw nsw i64 %index1370, %114
  %131 = add nuw nsw i64 %index1370, %polly.access.mul.Packed_MemRef_call1279.us
  %132 = getelementptr double, double* %Packed_MemRef_call1, i64 %131
  %133 = bitcast double* %132 to <4 x double>*
  %wide.load1374 = load <4 x double>, <4 x double>* %133, align 8
  %134 = fmul fast <4 x double> %broadcast.splat1376, %wide.load1374
  ...
  %wide.load1377 = load <4 x double>, <4 x double>* %137, align 8
  %138 = fmul fast <4 x double> %broadcast.splat1379, %wide.load1377
  %139 = shl i64 %130, 3
  %140 = add i64 %139, %128
  %141 = getelementptr i8, i8* %call, i64 %140
  %142 = bitcast i8* %141 to <4 x double>*
  %wide.load1380 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !65, !noalias !67
  ...
  %145 = fadd fast <4 x double> %144, %wide.load1380
  ...
  %147 = icmp eq i64 %index.next1371, %n.vec1369
  br i1 %147, label %middle.block1359, label %vector.body1361, !llvm.loop !77

middle.block1359:                                 ; preds = %vector.body1361
  %cmp.n1373 = icmp eq i64 %122, %n.vec1369
...
vector.body1299:                                  ; preds = %vector.body1299, %vector.ph1303
  ...
  %153 = shl nuw nsw i64 %index1306, 3
  %154 = getelementptr i8, i8* %scevgep400, i64 %153
  %155 = bitcast i8* %154 to <4 x double>*
  %wide.load1310 = load <4 x double>, <4 x double>* %155, align 8, !alias.scope !79, !noalias !81
  %156 = fmul fast <4 x double> %wide.load1310, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %158 = icmp eq i64 %index.next1307, %n.vec1305
  br i1 %158, label %middle.block1297, label %vector.body1299, !llvm.loop !86

middle.block1297:                                 ; preds = %vector.body1299
  %cmp.n1309 = icmp eq i64 %151, %n.vec1305
...
polly.loop_header394:                             ; preds = %polly.loop_header394.preheader, %polly.loop_header394
  ...
  br i1 %exitcond1094.not, label %polly.loop_exit396, label %polly.loop_header394, !llvm.loop !87
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  %indvars.iv1086 = phi i64 [ %indvars.iv.next1087, %polly.loop_exit428 ], [ 0, %polly.loop_exit412 ]
  ...
  %162 = udiv i64 %polly.indvar423, 5
  %163 = add nuw i64 %indvars.iv1086, %162
  %umin1088 = call i64 @llvm.umin.i64(i64 %163, i64 56)
  %164 = mul nsw i64 %polly.indvar423, -64
  %165 = icmp slt i64 %164, -1136
  %166 = select i1 %165, i64 %164, i64 -1136
  %167 = add nsw i64 %166, 1199
  %168 = shl nsw i64 %polly.indvar423, 6
  %169 = add nuw nsw i64 %umin1088, 3
...
polly.loop_exit428:                               ; preds = %polly.loop_exit435
  ...
  %exitcond1091.not = icmp eq i64 %polly.indvar_next424, 19
...
polly.loop_header426:                             ; preds = %polly.loop_exit435, %polly.loop_header420
  ...
  %smin1084 = call i64 @llvm.smin.i64(i64 %indvars.iv1063, i64 -984)
  %170 = add nsw i64 %smin1084, 1000
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442
  ...
  %exitcond1090.not = icmp eq i64 %polly.indvar_next430, 63
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %173 = add i64 %160, %172
  %smax1314 = call i64 @llvm.smax.i64(i64 %173, i64 0)
  %174 = mul nsw i64 %polly.indvar436, -20
  %175 = add i64 %161, %174
  %176 = add i64 %smax1314, %175
...
polly.loop_header440.preheader:                   ; preds = %polly.loop_header433
  ...
  %181 = add i64 %smax1071, %indvars.iv1074
...
polly.loop_exit442:                               ; preds = %polly.loop_exit478, %polly.loop_header433
  ...
  %exitcond1089.not = icmp eq i64 %polly.indvar436, %169
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %indvars.iv1076 = phi i64 [ %181, %polly.loop_header440.preheader ], [ %indvars.iv.next1077, %polly.loop_exit478 ]
  %polly.indvar444 = phi i64 [ %180, %polly.loop_header440.preheader ], [ %polly.indvar_next445, %polly.loop_exit478 ]
  %184 = add i64 %176, %indvar1315
  %smin1317 = call i64 @llvm.smin.i64(i64 %184, i64 19)
  %185 = add nsw i64 %smin1317, 1
  %smin1082 = call i64 @llvm.smin.i64(i64 %indvars.iv1076, i64 19)
  %186 = add nsw i64 %polly.indvar444, %182
  %polly.loop_guard4571164 = icmp sgt i64 %186, -1
...
polly.merge466.us:                                ; preds = %polly.then467.us, %polly.cond465.loopexit.us
  ...
  %exitcond1081.not = icmp eq i64 %polly.indvar_next451.us, %170
...
polly.loop_header447:                             ; preds = %polly.loop_header440.split, %polly.loop_header447
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next451, %170
...
polly.loop_header476.us:                          ; preds = %polly.loop_header476.preheader, %polly.loop_exit485.loopexit.us
  ...
  %min.iters.check1318 = icmp ult i64 %185, 4
...
vector.body1313:                                  ; preds = %vector.body1313, %vector.ph1319
  ...
  %193 = add nuw nsw i64 %index1322, %177
  %194 = add nuw nsw i64 %index1322, %polly.access.mul.Packed_MemRef_call1303490.us
  %195 = getelementptr double, double* %Packed_MemRef_call1303, i64 %194
  %196 = bitcast double* %195 to <4 x double>*
  %wide.load1326 = load <4 x double>, <4 x double>* %196, align 8
  %197 = fmul fast <4 x double> %broadcast.splat1328, %wide.load1326
  ...
  %wide.load1329 = load <4 x double>, <4 x double>* %200, align 8
  %201 = fmul fast <4 x double> %broadcast.splat1331, %wide.load1329
  %202 = shl i64 %193, 3
  %203 = add i64 %202, %191
  %204 = getelementptr i8, i8* %call, i64 %203
  %205 = bitcast i8* %204 to <4 x double>*
  %wide.load1332 = load <4 x double>, <4 x double>* %205, align 8, !alias.scope !79, !noalias !81
  ...
  %208 = fadd fast <4 x double> %207, %wide.load1332
  ...
  %210 = icmp eq i64 %index.next1323, %n.vec1321
  br i1 %210, label %middle.block1311, label %vector.body1313, !llvm.loop !90

middle.block1311:                                 ; preds = %vector.body1313
  %cmp.n1325 = icmp eq i64 %185, %n.vec1321
...
polly.loop_exit485.loopexit.us:                   ; preds = %polly.loop_header483.us, %middle.block1311
  ...
  %exitcond1085.not = icmp eq i64 %polly.indvar_next480.us, %170
...
polly.loop_header599:                             ; preds = %polly.loop_exit607, %polly.start511
  ...
  %min.iters.check1254 = icmp ult i64 %214, 4
...
vector.body1253:                                  ; preds = %vector.body1253, %vector.ph1255
  ...
  %216 = shl nuw nsw i64 %index1258, 3
  %217 = getelementptr i8, i8* %scevgep611, i64 %216
  %218 = bitcast i8* %217 to <4 x double>*
  %wide.load1262 = load <4 x double>, <4 x double>* %218, align 8, !alias.scope !92, !noalias !94
  %219 = fmul fast <4 x double> %wide.load1262, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %221 = icmp eq i64 %index.next1259, %n.vec1257
  br i1 %221, label %middle.block1251, label %vector.body1253, !llvm.loop !99

middle.block1251:                                 ; preds = %vector.body1253
  %cmp.n1261 = icmp eq i64 %214, %n.vec1257
...
polly.loop_header605:                             ; preds = %polly.loop_header605.preheader, %polly.loop_header605
  ...
  br i1 %exitcond1127.not, label %polly.loop_exit607, label %polly.loop_header605, !llvm.loop !100
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  %indvars.iv1119 = phi i64 [ %indvars.iv.next1120, %polly.loop_exit639 ], [ 0, %polly.loop_exit623 ]
  ...
  %225 = udiv i64 %polly.indvar634, 5
  %226 = add nuw i64 %indvars.iv1119, %225
  %umin1121 = call i64 @llvm.umin.i64(i64 %226, i64 56)
  %227 = mul nsw i64 %polly.indvar634, -64
  %228 = icmp slt i64 %227, -1136
  %229 = select i1 %228, i64 %227, i64 -1136
  %230 = add nsw i64 %229, 1199
  %231 = shl nsw i64 %polly.indvar634, 6
  %232 = add nuw nsw i64 %umin1121, 3
  br label %polly.loop_header637

polly.loop_exit639:                               ; preds = %polly.loop_exit646
  %polly.indvar_next635 = add nuw nsw i64 %polly.indvar634, 1
  %indvars.iv.next1101 = add nsw i64 %indvars.iv1100, -64
  %indvars.iv.next1106 = add nuw nsw i64 %indvars.iv1105, 64
  %indvars.iv.next1120 = add nuw nsw i64 %indvars.iv1119, 3
  %exitcond1124.not = icmp eq i64 %polly.indvar_next635, 19
...
polly.loop_header637:                             ; preds = %polly.loop_exit646, %polly.loop_header631
  ...
  %smin1117 = call i64 @llvm.smin.i64(i64 %indvars.iv1096, i64 -984)
  %233 = add nsw i64 %smin1117, 1000
...
polly.loop_exit646:                               ; preds = %polly.loop_exit653
  ...
  %exitcond1123.not = icmp eq i64 %polly.indvar_next641, 63
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %236 = add i64 %223, %235
  %smax1266 = call i64 @llvm.smax.i64(i64 %236, i64 0)
  %237 = mul nsw i64 %polly.indvar647, -20
  %238 = add i64 %224, %237
  %239 = add i64 %smax1266, %238
...
polly.loop_header651.preheader:                   ; preds = %polly.loop_header644
  ...
  %244 = add i64 %smax1104, %indvars.iv1107
...
polly.loop_exit653:                               ; preds = %polly.loop_exit689, %polly.loop_header644
  ...
  %exitcond1122.not = icmp eq i64 %polly.indvar647, %232
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %indvars.iv1109 = phi i64 [ %244, %polly.loop_header651.preheader ], [ %indvars.iv.next1110, %polly.loop_exit689 ]
  %polly.indvar655 = phi i64 [ %243, %polly.loop_header651.preheader ], [ %polly.indvar_next656, %polly.loop_exit689 ]
  %247 = add i64 %239, %indvar1267
  %smin1269 = call i64 @llvm.smin.i64(i64 %247, i64 19)
  %248 = add nsw i64 %smin1269, 1
  %smin1115 = call i64 @llvm.smin.i64(i64 %indvars.iv1109, i64 19)
  %249 = add nsw i64 %polly.indvar655, %245
  %polly.loop_guard6681165 = icmp sgt i64 %249, -1
...
polly.merge677.us:                                ; preds = %polly.then678.us, %polly.cond676.loopexit.us
  ...
  %exitcond1114.not = icmp eq i64 %polly.indvar_next662.us, %233
...
polly.loop_header658:                             ; preds = %polly.loop_header651.split, %polly.loop_header658
  ...
  %exitcond1099.not = icmp eq i64 %polly.indvar_next662, %233
...
polly.loop_header687.us:                          ; preds = %polly.loop_header687.preheader, %polly.loop_exit696.loopexit.us
  ...
  %min.iters.check1270 = icmp ult i64 %248, 4
...
vector.body1265:                                  ; preds = %vector.body1265, %vector.ph1271
  ...
  %256 = add nuw nsw i64 %index1274, %240
  %257 = add nuw nsw i64 %index1274, %polly.access.mul.Packed_MemRef_call1514701.us
  %258 = getelementptr double, double* %Packed_MemRef_call1514, i64 %257
  %259 = bitcast double* %258 to <4 x double>*
  %wide.load1278 = load <4 x double>, <4 x double>* %259, align 8
  %260 = fmul fast <4 x double> %broadcast.splat1280, %wide.load1278
  ...
  %wide.load1281 = load <4 x double>, <4 x double>* %263, align 8
  %264 = fmul fast <4 x double> %broadcast.splat1283, %wide.load1281
  %265 = shl i64 %256, 3
  %266 = add i64 %265, %254
  %267 = getelementptr i8, i8* %call, i64 %266
  %268 = bitcast i8* %267 to <4 x double>*
  %wide.load1284 = load <4 x double>, <4 x double>* %268, align 8, !alias.scope !92, !noalias !94
  ...
  %271 = fadd fast <4 x double> %270, %wide.load1284
  ...
  %273 = icmp eq i64 %index.next1275, %n.vec1273
  br i1 %273, label %middle.block1263, label %vector.body1265, !llvm.loop !103

middle.block1263:                                 ; preds = %vector.body1265
  %cmp.n1277 = icmp eq i64 %248, %n.vec1273
...
polly.loop_header694.us:                          ; preds = %polly.loop_header694.us.preheader, %polly.loop_header694.us
  ...
  br i1 %exitcond1116.not, label %polly.loop_exit696.loopexit.us, label %polly.loop_header694.us, !llvm.loop !104
...
polly.loop_exit696.loopexit.us:                   ; preds = %polly.loop_header694.us, %middle.block1263
  ...
  %exitcond1118.not = icmp eq i64 %polly.indvar_next691.us, %233
...
vector.ph1193:                                    ; preds = %polly.loop_header858
  %broadcast.splatinsert1200 = insertelement <4 x i64> poison, i64 %281, i32 0
  %broadcast.splat1201 = shufflevector <4 x i64> %broadcast.splatinsert1200, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1202 = insertelement <4 x i32> poison, i32 %284, i32 0
...
vector.body1192:                                  ; preds = %vector.body1192, %vector.ph1193
  ...
  %286 = add nuw nsw <4 x i64> %vec.ind1198, %broadcast.splat1201
  %287 = trunc <4 x i64> %286 to <4 x i32>
  %288 = mul <4 x i32> %broadcast.splat1203, %287
  ...
  %298 = icmp eq i64 %index.next1195, %280
  br i1 %298, label %polly.loop_exit866, label %vector.body1192, !llvm.loop !110

polly.loop_exit866:                               ; preds = %vector.body1192, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1156.not = icmp eq i64 %polly.indvar861, %278
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1152.not = icmp eq i64 %polly.indvar867, %282
  br i1 %exitcond1152.not, label %polly.loop_exit866, label %polly.loop_header864, !llvm.loop !111
...
polly.loop_header879:                             ; preds = %polly.loop_exit887, %polly.loop_header873
  ...
  %smin1207 = call i64 @llvm.smin.i64(i64 %308, i64 -968)
  %309 = add nsw i64 %smin1207, 1000
  %smin1141 = call i64 @llvm.smin.i64(i64 %indvars.iv1139, i64 -968)
  %310 = shl nsw i64 %polly.indvar882, 5
  %311 = add nsw i64 %smin1141, 999
...
vector.body1206:                                  ; preds = %vector.body1206, %vector.ph1209
  ...
  %315 = add nuw nsw <4 x i64> %vec.ind1216, %broadcast.splat1219
  %316 = trunc <4 x i64> %315 to <4 x i32>
  %317 = mul <4 x i32> %broadcast.splat1221, %316
  ...
  %327 = icmp eq i64 %index.next1213, %309
  br i1 %327, label %polly.loop_exit893, label %vector.body1206, !llvm.loop !113

polly.loop_exit893:                               ; preds = %vector.body1206, %polly.loop_header891
  %polly.indvar_next889 = add nuw nsw i64 %polly.indvar888, 1
  %exitcond1146.not = icmp eq i64 %polly.indvar888, %307
...
polly.loop_header891:                             ; preds = %polly.loop_header885, %polly.loop_header891
  ...
  %exitcond1142.not = icmp eq i64 %polly.indvar894, %311
  br i1 %exitcond1142.not, label %polly.loop_exit893, label %polly.loop_header891, !llvm.loop !114
...
polly.loop_header905:                             ; preds = %polly.loop_exit913, %polly.loop_header899
  ...
  %smin1225 = call i64 @llvm.smin.i64(i64 %337, i64 -968)
  %338 = add nsw i64 %smin1225, 1000
  %smin1131 = call i64 @llvm.smin.i64(i64 %indvars.iv1129, i64 -968)
  %339 = shl nsw i64 %polly.indvar908, 5
  %340 = add nsw i64 %smin1131, 999
...
vector.body1224:                                  ; preds = %vector.body1224, %vector.ph1227
  ...
  %344 = add nuw nsw <4 x i64> %vec.ind1234, %broadcast.splat1237
  %345 = trunc <4 x i64> %344 to <4 x i32>
  %346 = mul <4 x i32> %broadcast.splat1239, %345
  ...
  %356 = icmp eq i64 %index.next1231, %338
  br i1 %356, label %polly.loop_exit919, label %vector.body1224, !llvm.loop !116

polly.loop_exit919:                               ; preds = %vector.body1224, %polly.loop_header917
  %polly.indvar_next915 = add nuw nsw i64 %polly.indvar914, 1
  %exitcond1136.not = icmp eq i64 %polly.indvar914, %336
...
polly.loop_header917:                             ; preds = %polly.loop_header911, %polly.loop_header917
  ...
  %exitcond1132.not = icmp eq i64 %polly.indvar920, %340
  br i1 %exitcond1132.not, label %polly.loop_exit919, label %polly.loop_header917, !llvm.loop !117
}
