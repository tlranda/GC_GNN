; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10276.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10276.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv785, i64 31)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %127 = mul nsw i64 %polly.indvar355, -80
  %128 = mul nuw nsw i64 %polly.indvar355, 80
...
polly.loop_header359:                             ; preds = %polly.loop_exit368, %polly.loop_header352
  ...
  %129 = shl nsw i64 %polly.indvar362, 5
  %130 = add nsw i64 %129, %127
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %polly.loop_guard369 = icmp slt i64 %132, 80
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %155 = mul nsw i64 %polly.indvar511, -80
  %156 = mul nuw nsw i64 %polly.indvar511, 80
...
polly.loop_header515:                             ; preds = %polly.loop_exit524, %polly.loop_header508
  ...
  %157 = shl nsw i64 %polly.indvar518, 5
  %158 = add nsw i64 %157, %155
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard525 = icmp slt i64 %160, 80
