; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10301.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10301.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv796 = phi i64 [ %indvars.iv.next797, %polly.loop_exit207 ], [ 27, %polly.loop_exit193 ]
  ...
  %smin798 = call i64 @llvm.smin.i64(i64 %98, i64 21)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond800.not = icmp eq i64 %polly.indvar_next209, 125
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233886 = icmp sgt i64 %126, -1
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %141, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %144, label %middle.block999, label %vector.body1001, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv820 = phi i64 [ %indvars.iv.next821, %polly.loop_exit362 ], [ 27, %polly.loop_exit346 ]
  ...
  %146 = udiv i64 %indvars.iv820, 25
  %147 = sub nsw i64 %indvars.iv818, %146
  %smin822 = call i64 @llvm.smin.i64(i64 %147, i64 21)
  %148 = mul nsw i64 %polly.indvar357, -96
  %149 = icmp slt i64 %148, -1104
  %150 = select i1 %149, i64 %148, i64 -1104
  %151 = add nsw i64 %150, 1199
  %152 = mul nuw nsw i64 %polly.indvar357, 96
  %153 = add nsw i64 %smin822, 2
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next364, 125
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %173 = add i64 %smax808, %indvars.iv811
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar370, %153
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv813 = phi i64 [ %173, %polly.loop_header374.preheader ], [ %indvars.iv.next814, %polly.loop_exit383 ]
  ...
  %polly.loop_guard391887 = icmp sgt i64 %175, -1
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %wide.load986 = load <4 x double>, <4 x double>* %190, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %193, label %middle.block975, label %vector.body977, !llvm.loop !83
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv844 = phi i64 [ %indvars.iv.next845, %polly.loop_exit520 ], [ 27, %polly.loop_exit504 ]
  ...
  %195 = udiv i64 %indvars.iv844, 25
  %196 = sub nsw i64 %indvars.iv842, %195
  %smin846 = call i64 @llvm.smin.i64(i64 %196, i64 21)
  %197 = mul nsw i64 %polly.indvar515, -96
  %198 = icmp slt i64 %197, -1104
  %199 = select i1 %198, i64 %197, i64 -1104
  %200 = add nsw i64 %199, 1199
  %201 = mul nuw nsw i64 %polly.indvar515, 96
  %202 = add nsw i64 %smin846, 2
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next843 = add nuw nsw i64 %indvars.iv842, 2
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next522, 125
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %222 = add i64 %smax832, %indvars.iv835
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar528, %202
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv837 = phi i64 [ %222, %polly.loop_header532.preheader ], [ %indvars.iv.next838, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549888 = icmp sgt i64 %224, -1
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  br i1 %256, label %polly.loop_exit714, label %vector.body915, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body915, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond879.not = icmp eq i64 %polly.indvar709, %236
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond875.not = icmp eq i64 %polly.indvar715, %240
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %285, label %polly.loop_exit741, label %vector.body930, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body930, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond869.not = icmp eq i64 %polly.indvar736, %265
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond865.not = icmp eq i64 %polly.indvar742, %269
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  br i1 %314, label %polly.loop_exit767, label %vector.body948, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body948, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond859.not = icmp eq i64 %polly.indvar762, %294
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar768, %298
...
polly.loop_header388.us.3:                        ; preds = %polly.loop_header388.us.3, %polly.loop_exit390.loopexit.us.2
  ...
  br i1 %exitcond816.3.not, label %polly.loop_exit390.loopexit.us.3, label %polly.loop_header388.us.3
...
polly.loop_header388.us.4:                        ; preds = %polly.loop_header388.us.4, %polly.loop_exit390.loopexit.us.3
  ...
  %exitcond816.4.not = icmp eq i64 %polly.indvar392.us.4, %smin815
  br i1 %exitcond816.4.not, label %polly.loop_exit390.loopexit.us.4, label %polly.loop_header388.us.4
...
polly.loop_header388.us.5:                        ; preds = %polly.loop_header388.us.5, %polly.loop_exit390.loopexit.us.4
  ...
  %exitcond816.5.not = icmp eq i64 %polly.indvar392.us.5, %smin815
  br i1 %exitcond816.5.not, label %polly.loop_exit390.loopexit.us.5, label %polly.loop_header388.us.5
...
polly.loop_header388.us.6:                        ; preds = %polly.loop_header388.us.6, %polly.loop_exit390.loopexit.us.5
  ...
  %exitcond816.6.not = icmp eq i64 %polly.indvar392.us.6, %smin815
  br i1 %exitcond816.6.not, label %polly.loop_exit390.loopexit.us.6, label %polly.loop_header388.us.6
...
polly.loop_header388.us.7:                        ; preds = %polly.loop_header388.us.7, %polly.loop_exit390.loopexit.us.6
  ...
  %exitcond816.7.not = icmp eq i64 %polly.indvar392.us.7, %smin815
  br i1 %exitcond816.7.not, label %polly.loop_exit383, label %polly.loop_header388.us.7
...
polly.loop_header546.us.3:                        ; preds = %polly.loop_header546.us.3, %polly.loop_exit548.loopexit.us.2
  ...
  br i1 %exitcond840.3.not, label %polly.loop_exit548.loopexit.us.3, label %polly.loop_header546.us.3
...
polly.loop_header546.us.4:                        ; preds = %polly.loop_header546.us.4, %polly.loop_exit548.loopexit.us.3
  ...
  %exitcond840.4.not = icmp eq i64 %polly.indvar550.us.4, %smin839
  br i1 %exitcond840.4.not, label %polly.loop_exit548.loopexit.us.4, label %polly.loop_header546.us.4
...
polly.loop_header546.us.5:                        ; preds = %polly.loop_header546.us.5, %polly.loop_exit548.loopexit.us.4
  ...
  %exitcond840.5.not = icmp eq i64 %polly.indvar550.us.5, %smin839
  br i1 %exitcond840.5.not, label %polly.loop_exit548.loopexit.us.5, label %polly.loop_header546.us.5
...
polly.loop_header546.us.6:                        ; preds = %polly.loop_header546.us.6, %polly.loop_exit548.loopexit.us.5
  ...
  %exitcond840.6.not = icmp eq i64 %polly.indvar550.us.6, %smin839
  br i1 %exitcond840.6.not, label %polly.loop_exit548.loopexit.us.6, label %polly.loop_header546.us.6
...
polly.loop_header546.us.7:                        ; preds = %polly.loop_header546.us.7, %polly.loop_exit548.loopexit.us.6
  ...
  %exitcond840.7.not = icmp eq i64 %polly.indvar550.us.7, %smin839
  br i1 %exitcond840.7.not, label %polly.loop_exit541, label %polly.loop_header546.us.7
}
