; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10646.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10646.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv839 = phi i64 [ %indvars.iv.next840, %polly.loop_exit223 ], [ 6, %polly.loop_exit207 ]
  ...
  %97 = udiv i64 %indvars.iv839, 5
  %98 = sub nsw i64 %indvars.iv837, %97
  %smin841 = call i64 @llvm.smin.i64(i64 %98, i64 54)
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  %indvars.iv864 = phi i64 [ %indvars.iv.next865, %polly.loop_exit395 ], [ 6, %polly.loop_exit378 ]
  ...
  %129 = udiv i64 %indvars.iv864, 5
  %130 = sub nsw i64 %indvars.iv862, %129
  %smin866 = call i64 @llvm.smin.i64(i64 %130, i64 54)
...
polly.loop_exit395:                               ; preds = %polly.loop_exit402
  ...
  %indvars.iv.next863 = add nuw nsw i64 %indvars.iv862, 5
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  %indvars.iv889 = phi i64 [ %indvars.iv.next890, %polly.loop_exit569 ], [ 6, %polly.loop_exit552 ]
  ...
  %161 = udiv i64 %indvars.iv889, 5
  %162 = sub nsw i64 %indvars.iv887, %161
  %smin891 = call i64 @llvm.smin.i64(i64 %162, i64 54)
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576
  ...
  %indvars.iv.next888 = add nuw nsw i64 %indvars.iv887, 5
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit583
  ...
  %smin884 = call i64 @llvm.smin.i64(i64 %indvars.iv882, i64 19)
