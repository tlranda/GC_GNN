; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5135.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5135.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin999 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -968)
...
polly.loop_header399.preheader:                   ; preds = %polly.loop_header391
  %141 = shl nsw i64 %polly.indvar394, 5
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409, %polly.loop_header391
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next395, 32
...
polly.start476:                                   ; preds = %init_array.exit
  %malloccall478 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header584:                             ; preds = %polly.loop_exit594, %polly.loop_header578
  ...
  %smin1053 = call i64 @llvm.smin.i64(i64 %indvars.iv1032, i64 -968)
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %179 = shl nsw i64 %polly.indvar587, 5
...
polly.loop_exit594:                               ; preds = %polly.loop_exit602, %polly.loop_header584
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar_next588, 32
