; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7288.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7288.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next219, 24
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %polly.loop_guard237 = icmp slt i64 %107, 50
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %131 = mul nuw nsw i64 %polly.indvar395, 7
  %132 = add nuw nsw i64 %131, 39
  %pexp.p_div_q404 = lshr i64 %132, 5
  %133 = sub nsw i64 %polly.indvar395, %pexp.p_div_q404
  %polly.loop_guard409 = icmp sgt i64 %133, -2
  %134 = mul nsw i64 %polly.indvar395, -50
  %135 = mul nuw nsw i64 %polly.indvar395, 50
  br label %polly.loop_header398

polly.loop_exit400:                               ; preds = %polly.loop_exit408
  %polly.indvar_next396 = add nuw nsw i64 %polly.indvar395, 1
  %indvars.iv.next862 = add nsw i64 %indvars.iv861, -50
  %indvars.iv.next867 = add nuw nsw i64 %indvars.iv866, 50
  %exitcond879.not = icmp eq i64 %polly.indvar_next396, 24
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %polly.loop_guard417 = icmp slt i64 %141, 50
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  ...
  %smin872 = call i64 @llvm.smin.i64(i64 %indvars.iv870, i64 63)
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %165 = mul nuw nsw i64 %polly.indvar575, 7
  %166 = add nuw nsw i64 %165, 39
  %pexp.p_div_q584 = lshr i64 %166, 5
  %167 = sub nsw i64 %polly.indvar575, %pexp.p_div_q584
  %polly.loop_guard589 = icmp sgt i64 %167, -2
  %168 = mul nsw i64 %polly.indvar575, -50
  %169 = mul nuw nsw i64 %polly.indvar575, 50
...
polly.loop_exit580:                               ; preds = %polly.loop_exit588
  ...
  %indvars.iv.next890 = add nuw nsw i64 %indvars.iv889, 50
  %exitcond902.not = icmp eq i64 %polly.indvar_next576, 24
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %polly.loop_guard597 = icmp slt i64 %175, 50
...
polly.loop_exit596:                               ; preds = %polly.loop_exit603, %polly.loop_header586
  ...
  %indvars.iv.next892 = add nsw i64 %indvars.iv891, -64
