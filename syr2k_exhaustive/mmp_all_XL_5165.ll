; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5165.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5165.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit220
  ...
  %polly.loop_guard221 = icmp slt i64 %108, 100
...
polly.loop_header218:                             ; preds = %polly.loop_header218.preheader, %polly.loop_exit252
  ...
  %polly.loop_guard2351093 = icmp sgt i64 %112, -1
...
vector.body1207:                                  ; preds = %vector.body1207, %vector.ph1211
  ...
  %129 = shl nuw nsw i64 %index1214, 3
  %130 = getelementptr i8, i8* %scevgep381, i64 %129
  %131 = bitcast i8* %130 to <4 x double>*
  %wide.load1218 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !74, !noalias !76
  %132 = fmul fast <4 x double> %wide.load1218, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %134 = icmp eq i64 %index.next1215, %n.vec1213
  br i1 %134, label %middle.block1205, label %vector.body1207, !llvm.loop !80

middle.block1205:                                 ; preds = %vector.body1207
  %cmp.n1217 = icmp eq i64 %127, %n.vec1213
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %136 = shl nuw nsw i64 %polly.indvar388, 1
  %137 = mul nuw nsw i64 %polly.indvar388, 7
  %138 = add nuw nsw i64 %137, 7
  %pexp.p_div_q397 = lshr i64 %138, 4
  %139 = sub nsw i64 %136, %pexp.p_div_q397
  %polly.loop_guard402 = icmp sgt i64 %139, -2
  %140 = mul nsw i64 %polly.indvar388, -100
  %141 = mul nuw nsw i64 %polly.indvar388, 100
...
polly.loop_header399.preheader:                   ; preds = %polly.loop_header391
  %143 = mul nuw nsw i64 %polly.indvar394, 80
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %144 = shl nsw i64 %polly.indvar403, 6
  %145 = add nsw i64 %144, %140
  %146 = icmp sgt i64 %145, 0
  %147 = select i1 %146, i64 %145, i64 0
  %polly.loop_guard410 = icmp slt i64 %147, 100
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  ...
  %148 = add i64 %smax1013, %indvars.iv1016
...
polly.loop_exit409:                               ; preds = %polly.loop_exit445, %polly.loop_header399
  ...
  %polly.loop_cond405.not = icmp sgt i64 %polly.indvar403, %139
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit445
  %indvars.iv1018 = phi i64 [ %148, %polly.loop_header407.preheader ], [ %indvars.iv.next1019, %polly.loop_exit445 ]
  ...
  %polly.loop_guard4241094 = icmp sgt i64 %151, -1
...
polly.merge433.us:                                ; preds = %polly.then434.us, %polly.cond432.loopexit.us
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next418.us, %142
...
polly.loop_header414:                             ; preds = %polly.loop_header407.split, %polly.loop_header414
  ...
  %exitcond1008.not = icmp eq i64 %polly.indvar_next418, %142
...
polly.loop_exit452.loopexit.us:                   ; preds = %polly.loop_header450.us
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next447.us, %142
...
polly.loop_header562:                             ; preds = %polly.loop_exit570, %polly.start476
  ...
  %min.iters.check1184 = icmp ult i64 %166, 4
...
vector.body1183:                                  ; preds = %vector.body1183, %vector.ph1185
  ...
  %168 = shl nuw nsw i64 %index1188, 3
  %169 = getelementptr i8, i8* %scevgep574, i64 %168
  %170 = bitcast i8* %169 to <4 x double>*
  %wide.load1192 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !84, !noalias !86
  %171 = fmul fast <4 x double> %wide.load1192, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %173 = icmp eq i64 %index.next1189, %n.vec1187
  br i1 %173, label %middle.block1181, label %vector.body1183, !llvm.loop !90

middle.block1181:                                 ; preds = %vector.body1183
  %cmp.n1191 = icmp eq i64 %166, %n.vec1187
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %175 = shl nuw nsw i64 %polly.indvar581, 1
  %176 = mul nuw nsw i64 %polly.indvar581, 7
  %177 = add nuw nsw i64 %176, 7
  %pexp.p_div_q590 = lshr i64 %177, 4
  %178 = sub nsw i64 %175, %pexp.p_div_q590
  %polly.loop_guard595 = icmp sgt i64 %178, -2
  %179 = mul nsw i64 %polly.indvar581, -100
  %180 = mul nuw nsw i64 %polly.indvar581, 100
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %182 = mul nuw nsw i64 %polly.indvar587, 80
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %183 = shl nsw i64 %polly.indvar596, 6
  %184 = add nsw i64 %183, %179
  %185 = icmp sgt i64 %184, 0
  %186 = select i1 %185, i64 %184, i64 0
  %polly.loop_guard603 = icmp slt i64 %186, 100
...
polly.loop_header600.preheader:                   ; preds = %polly.loop_header592
  ...
  %187 = add i64 %smax1040, %indvars.iv1043
...
polly.loop_exit602:                               ; preds = %polly.loop_exit638, %polly.loop_header592
  ...
  %polly.loop_cond598.not = icmp sgt i64 %polly.indvar596, %178
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_exit638
  %indvars.iv1045 = phi i64 [ %187, %polly.loop_header600.preheader ], [ %indvars.iv.next1046, %polly.loop_exit638 ]
  ...
  %polly.loop_guard6171095 = icmp sgt i64 %190, -1
...
polly.merge626.us:                                ; preds = %polly.then627.us, %polly.cond625.loopexit.us
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar_next611.us, %181
...
polly.loop_header607:                             ; preds = %polly.loop_header600.split, %polly.loop_header607
  ...
  %exitcond1035.not = icmp eq i64 %polly.indvar_next611, %181
...
polly.loop_exit645.loopexit.us:                   ; preds = %polly.loop_header643.us
  ...
  %exitcond1054.not = icmp eq i64 %polly.indvar_next640.us, %181
...
vector.ph1123:                                    ; preds = %polly.loop_header805
  %broadcast.splatinsert1130 = insertelement <4 x i64> poison, i64 %209, i32 0
  %broadcast.splat1131 = shufflevector <4 x i64> %broadcast.splatinsert1130, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1132 = insertelement <4 x i32> poison, i32 %212, i32 0
...
vector.body1122:                                  ; preds = %vector.body1122, %vector.ph1123
  ...
  %214 = add nuw nsw <4 x i64> %vec.ind1128, %broadcast.splat1131
  %215 = trunc <4 x i64> %214 to <4 x i32>
  %216 = mul <4 x i32> %broadcast.splat1133, %215
  ...
  %226 = icmp eq i64 %index.next1125, %208
  br i1 %226, label %polly.loop_exit813, label %vector.body1122, !llvm.loop !99

polly.loop_exit813:                               ; preds = %vector.body1122, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond1086.not = icmp eq i64 %polly.indvar808, %206
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar814, %210
...
polly.loop_header826:                             ; preds = %polly.loop_exit834, %polly.loop_header820
  ...
  %smin1137 = call i64 @llvm.smin.i64(i64 %236, i64 -968)
  %237 = add nsw i64 %smin1137, 1000
  %smin1071 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 -968)
  %238 = shl nsw i64 %polly.indvar829, 5
  %239 = add nsw i64 %smin1071, 999
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  %243 = add nuw nsw <4 x i64> %vec.ind1146, %broadcast.splat1149
  %244 = trunc <4 x i64> %243 to <4 x i32>
  %245 = mul <4 x i32> %broadcast.splat1151, %244
  ...
  %255 = icmp eq i64 %index.next1143, %237
  br i1 %255, label %polly.loop_exit840, label %vector.body1136, !llvm.loop !102

polly.loop_exit840:                               ; preds = %vector.body1136, %polly.loop_header838
  %polly.indvar_next836 = add nuw nsw i64 %polly.indvar835, 1
  %exitcond1076.not = icmp eq i64 %polly.indvar835, %235
...
polly.loop_header838:                             ; preds = %polly.loop_header832, %polly.loop_header838
  ...
  %exitcond1072.not = icmp eq i64 %polly.indvar841, %239
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %smin1155 = call i64 @llvm.smin.i64(i64 %265, i64 -968)
  %266 = add nsw i64 %smin1155, 1000
  %smin1061 = call i64 @llvm.smin.i64(i64 %indvars.iv1059, i64 -968)
  %267 = shl nsw i64 %polly.indvar855, 5
  %268 = add nsw i64 %smin1061, 999
...
vector.body1154:                                  ; preds = %vector.body1154, %vector.ph1157
  ...
  %272 = add nuw nsw <4 x i64> %vec.ind1164, %broadcast.splat1167
  %273 = trunc <4 x i64> %272 to <4 x i32>
  %274 = mul <4 x i32> %broadcast.splat1169, %273
  ...
  %284 = icmp eq i64 %index.next1161, %266
  br i1 %284, label %polly.loop_exit866, label %vector.body1154, !llvm.loop !105

polly.loop_exit866:                               ; preds = %vector.body1154, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1066.not = icmp eq i64 %polly.indvar861, %264
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar867, %268
