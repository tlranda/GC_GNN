; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8786.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8786.c"
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph994
  ...
  br i1 %57, label %middle.block990, label %vector.body992, !llvm.loop !53
...
vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1020
  ...
  br i1 %68, label %middle.block1016, label %vector.body1018, !llvm.loop !55
...
vector.body1030:                                  ; preds = %vector.body1030, %vector.ph1034
  ...
  %wide.load1041 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !61, !noalias !63
  ...
  br i1 %95, label %middle.block1028, label %vector.body1030, !llvm.loop !66
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %exitcond805.not = icmp eq i64 %polly.indvar_next209, 12
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  %indvars.iv797 = phi i64 [ %105, %polly.loop_header211.preheader ], [ %indvars.iv.next798, %polly.loop_exit219 ]
  %indvars.iv793 = phi i64 [ %106, %polly.loop_header211.preheader ], [ %indvars.iv.next794, %polly.loop_exit219 ]
  ...
  %109 = add i64 %smax, %indvars.iv797
  ...
  %polly.loop_guard227.not = icmp sgt i64 %113, %117
...
polly.loop_header224:                             ; preds = %polly.loop_header217, %polly.loop_exit234
  %indvars.iv799 = phi i64 [ %109, %polly.loop_header217 ], [ %indvars.iv.next800, %polly.loop_exit234 ]
  %polly.indvar228 = phi i64 [ %113, %polly.loop_header217 ], [ %polly.indvar_next229, %polly.loop_exit234 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv799, i64 99)
  %120 = add i64 %polly.indvar228, %110
  %121 = add i64 %120, %108
  %polly.loop_guard235889 = icmp sgt i64 %121, -1
...
polly.loop_header232.preheader:                   ; preds = %polly.loop_header224
  ...
  %123 = add i64 %122, %119
  %scevgep242 = getelementptr i8, i8* %call2, i64 %123
  %scevgep242243 = bitcast i8* %scevgep242 to double*
  %_p_scalar_244 = load double, double* %scevgep242243, align 8, !alias.scope !65, !noalias !69
  %scevgep248 = getelementptr i8, i8* %call1, i64 %123
  %scevgep248249 = bitcast i8* %scevgep248 to double*
  %_p_scalar_250 = load double, double* %scevgep248249, align 8, !alias.scope !64, !noalias !70
...
polly.loop_exit234:                               ; preds = %polly.loop_header232, %polly.loop_header224
  ...
  %polly.loop_cond230.not.not = icmp slt i64 %polly.indvar228, %117
...
polly.loop_header232:                             ; preds = %polly.loop_header232.preheader, %polly.loop_header232
  ...
  %125 = add nuw nsw i64 %polly.indvar236, %107
  %126 = mul nuw nsw i64 %125, 8000
  %127 = add nuw nsw i64 %126, %119
  %scevgep239 = getelementptr i8, i8* %call1, i64 %127
  %scevgep239240 = bitcast i8* %scevgep239 to double*
  %_p_scalar_241 = load double, double* %scevgep239240, align 8, !alias.scope !64, !noalias !70
  %p_mul27.i112 = fmul fast double %_p_scalar_244, %_p_scalar_241
  %scevgep245 = getelementptr i8, i8* %call2, i64 %127
  %scevgep245246 = bitcast i8* %scevgep245 to double*
  %_p_scalar_247 = load double, double* %scevgep245246, align 8, !alias.scope !65, !noalias !69
  %p_mul37.i114 = fmul fast double %_p_scalar_250, %_p_scalar_247
  %128 = shl i64 %125, 3
  %129 = add i64 %128, %124
  %scevgep251 = getelementptr i8, i8* %call, i64 %129
  %scevgep251252 = bitcast i8* %scevgep251 to double*
  %_p_scalar_253 = load double, double* %scevgep251252, align 8, !alias.scope !61, !noalias !63
  %p_reass.add.i116 = fadd fast double %p_mul37.i114, %p_mul27.i112
  %p_reass.mul.i117 = fmul fast double %p_reass.add.i116, 1.500000e+00
  %p_add42.i118 = fadd fast double %p_reass.mul.i117, %_p_scalar_253
  store double %p_add42.i118, double* %scevgep251252, align 8, !alias.scope !61, !noalias !63
...
polly.loop_header340:                             ; preds = %kernel_syr2k.exit, %polly.loop_exit348
  ...
  %130 = add i64 %indvar1005, 1
  %131 = mul nuw nsw i64 %polly.indvar343, 9600
  %scevgep352 = getelementptr i8, i8* %call, i64 %131
  %min.iters.check1007 = icmp ult i64 %130, 4
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1008
  ...
  %132 = shl nuw nsw i64 %index1011, 3
  %133 = getelementptr i8, i8* %scevgep352, i64 %132
  %134 = bitcast i8* %133 to <4 x double>*
  %wide.load1015 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !71, !noalias !73
  %135 = fmul fast <4 x double> %wide.load1015, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %137 = icmp eq i64 %index.next1012, %n.vec1010
  br i1 %137, label %middle.block1002, label %vector.body1004, !llvm.loop !76

middle.block1002:                                 ; preds = %vector.body1004
  %cmp.n1014 = icmp eq i64 %130, %n.vec1010
...
polly.loop_header346:                             ; preds = %polly.loop_header346.preheader, %polly.loop_header346
  ...
  %138 = shl nuw nsw i64 %polly.indvar349, 3
  %scevgep353 = getelementptr i8, i8* %scevgep352, i64 %138
  ...
  br i1 %exitcond830.not, label %polly.loop_exit348, label %polly.loop_header346, !llvm.loop !77
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %139 = shl nsw i64 %polly.indvar359, 6
  %140 = add nsw i64 %smin826, 999
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %indvars.iv811 = phi i64 [ %indvars.iv.next812, %polly.loop_exit372 ], [ 15, %polly.loop_header356 ]
  ...
  %141 = shl nuw nsw i64 %indvars.iv811, 2
  %142 = and i64 %141, 9223372036854775744
  %143 = shl nuw nsw i64 %polly.indvar365, 1
  %144 = mul nuw nsw i64 %polly.indvar365, 7
  %145 = add nuw nsw i64 %144, 15
  %pexp.p_div_q368 = lshr i64 %145, 4
  %146 = sub nsw i64 %143, %pexp.p_div_q368
  %polly.loop_guard373 = icmp slt i64 %146, 19
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  %147 = sub nsw i64 %indvars.iv816, %142
  %148 = add i64 %indvars.iv809, %142
  %149 = mul nuw nsw i64 %polly.indvar365, 100
  %150 = mul nsw i64 %polly.indvar365, -100
  br label %polly.loop_header370

polly.loop_exit372:                               ; preds = %polly.loop_exit379, %polly.loop_header362
  %polly.indvar_next366 = add nuw nsw i64 %polly.indvar365, 1
  %indvars.iv.next810 = add nsw i64 %indvars.iv809, -28
  %indvars.iv.next812 = add nuw nsw i64 %indvars.iv811, 7
  %indvars.iv.next817 = add nuw nsw i64 %indvars.iv816, 28
  %exitcond828.not = icmp eq i64 %polly.indvar_next366, 12
...
polly.loop_header377:                             ; preds = %polly.loop_header370, %polly.loop_exit386
  ...
  %160 = add nuw nsw i64 %polly.indvar380, %139
  %161 = shl i64 %160, 3
...
polly.loop_exit386:                               ; preds = %polly.loop_exit394
  ...
  %exitcond827.not = icmp eq i64 %polly.indvar380, %140
...
polly.loop_header384:                             ; preds = %polly.loop_header377, %polly.loop_exit394
  %indvars.iv820 = phi i64 [ %151, %polly.loop_header377 ], [ %indvars.iv.next821, %polly.loop_exit394 ]
  %polly.indvar388 = phi i64 [ %155, %polly.loop_header377 ], [ %polly.indvar_next389, %polly.loop_exit394 ]
  %smin822 = call i64 @llvm.smin.i64(i64 %indvars.iv820, i64 99)
  %162 = add i64 %polly.indvar388, %152
  %163 = add i64 %162, %150
  %polly.loop_guard395890 = icmp sgt i64 %163, -1
...
polly.loop_header392.preheader:                   ; preds = %polly.loop_header384
  ...
  %165 = add i64 %164, %161
  %scevgep402 = getelementptr i8, i8* %call2, i64 %165
  %scevgep402403 = bitcast i8* %scevgep402 to double*
  %_p_scalar_404 = load double, double* %scevgep402403, align 8, !alias.scope !75, !noalias !78
  %scevgep408 = getelementptr i8, i8* %call1, i64 %165
  %scevgep408409 = bitcast i8* %scevgep408 to double*
  %_p_scalar_410 = load double, double* %scevgep408409, align 8, !alias.scope !74, !noalias !79
...
polly.loop_exit394:                               ; preds = %polly.loop_header392, %polly.loop_header384
  ...
  %polly.loop_cond390.not.not = icmp slt i64 %polly.indvar388, %159
...
polly.loop_header392:                             ; preds = %polly.loop_header392.preheader, %polly.loop_header392
  ...
  %167 = add nuw nsw i64 %polly.indvar396, %149
  %168 = mul nuw nsw i64 %167, 8000
  %169 = add nuw nsw i64 %168, %161
  %scevgep399 = getelementptr i8, i8* %call1, i64 %169
  ...
  %scevgep405 = getelementptr i8, i8* %call2, i64 %169
  %scevgep405406 = bitcast i8* %scevgep405 to double*
  %_p_scalar_407 = load double, double* %scevgep405406, align 8, !alias.scope !75, !noalias !78
  %p_mul37.i75 = fmul fast double %_p_scalar_410, %_p_scalar_407
  %170 = shl i64 %167, 3
  %171 = add i64 %170, %166
  %scevgep411 = getelementptr i8, i8* %call, i64 %171
  %scevgep411412 = bitcast i8* %scevgep411 to double*
  %_p_scalar_413 = load double, double* %scevgep411412, align 8, !alias.scope !71, !noalias !73
  %p_reass.add.i77 = fadd fast double %p_mul37.i75, %p_mul27.i73
  %p_reass.mul.i78 = fmul fast double %p_reass.add.i77, 1.500000e+00
  %p_add42.i79 = fadd fast double %p_reass.mul.i78, %_p_scalar_413
  store double %p_add42.i79, double* %scevgep411412, align 8, !alias.scope !71, !noalias !73
...
polly.loop_header500:                             ; preds = %init_array.exit, %polly.loop_exit508
  ...
  %173 = mul nuw nsw i64 %polly.indvar503, 9600
  %scevgep512 = getelementptr i8, i8* %call, i64 %173
  %min.iters.check981 = icmp ult i64 %172, 4
  br i1 %min.iters.check981, label %polly.loop_header506.preheader, label %vector.ph982

vector.ph982:                                     ; preds = %polly.loop_header500
  %n.vec984 = and i64 %172, -4
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  %174 = shl nuw nsw i64 %index985, 3
  %175 = getelementptr i8, i8* %scevgep512, i64 %174
  %176 = bitcast i8* %175 to <4 x double>*
  %wide.load989 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !80, !noalias !82
  %177 = fmul fast <4 x double> %wide.load989, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %178 = bitcast i8* %175 to <4 x double>*
  store <4 x double> %177, <4 x double>* %178, align 8, !alias.scope !80, !noalias !82
  %index.next986 = add i64 %index985, 4
  %179 = icmp eq i64 %index.next986, %n.vec984
  br i1 %179, label %middle.block978, label %vector.body980, !llvm.loop !85

middle.block978:                                  ; preds = %vector.body980
  %cmp.n988 = icmp eq i64 %172, %n.vec984
...
polly.loop_header506:                             ; preds = %polly.loop_header506.preheader, %polly.loop_header506
  ...
  %180 = shl nuw nsw i64 %polly.indvar509, 3
  %scevgep513 = getelementptr i8, i8* %scevgep512, i64 %180
  ...
  br i1 %exitcond853.not, label %polly.loop_exit508, label %polly.loop_header506, !llvm.loop !86
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %indvars.iv834 = phi i64 [ %indvars.iv.next835, %polly.loop_exit532 ], [ 15, %polly.loop_header516 ]
  ...
  %183 = shl nuw nsw i64 %indvars.iv834, 2
  %184 = and i64 %183, 9223372036854775744
  %185 = shl nuw nsw i64 %polly.indvar525, 1
  %186 = mul nuw nsw i64 %polly.indvar525, 7
  %187 = add nuw nsw i64 %186, 15
  %pexp.p_div_q528 = lshr i64 %187, 4
  %188 = sub nsw i64 %185, %pexp.p_div_q528
  %polly.loop_guard533 = icmp slt i64 %188, 19
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  %189 = sub nsw i64 %indvars.iv839, %184
  %190 = add i64 %indvars.iv832, %184
  %191 = mul nuw nsw i64 %polly.indvar525, 100
  %192 = mul nsw i64 %polly.indvar525, -100
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header522
  ...
  %indvars.iv.next833 = add nsw i64 %indvars.iv832, -28
  %indvars.iv.next835 = add nuw nsw i64 %indvars.iv834, 7
  %indvars.iv.next840 = add nuw nsw i64 %indvars.iv839, 28
  %exitcond851.not = icmp eq i64 %polly.indvar_next526, 12
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  %indvars.iv841 = phi i64 [ %189, %polly.loop_header530.preheader ], [ %indvars.iv.next842, %polly.loop_exit539 ]
  %indvars.iv836 = phi i64 [ %190, %polly.loop_header530.preheader ], [ %indvars.iv.next837, %polly.loop_exit539 ]
  ...
  %193 = add i64 %smax838, %indvars.iv841
  %194 = shl nsw i64 %polly.indvar534, 6
  %195 = sub nsw i64 %191, %194
  %196 = icmp sgt i64 %195, 0
  %197 = select i1 %196, i64 %195, i64 0
  %198 = mul nsw i64 %polly.indvar534, -64
  %199 = icmp slt i64 %198, -1136
  %200 = select i1 %199, i64 %198, i64 -1136
  %201 = add nsw i64 %200, 1199
  %polly.loop_guard547.not = icmp sgt i64 %197, %201
...
polly.loop_exit539:                               ; preds = %polly.loop_exit546, %polly.loop_header530
  ...
  %indvars.iv.next837 = add i64 %indvars.iv836, -64
  %indvars.iv.next842 = add i64 %indvars.iv841, 64
...
polly.loop_header537:                             ; preds = %polly.loop_header530, %polly.loop_exit546
  ...
  %202 = add nuw nsw i64 %polly.indvar540, %181
  %203 = shl i64 %202, 3
...
polly.loop_exit546:                               ; preds = %polly.loop_exit554
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar540, %182
...
polly.loop_header544:                             ; preds = %polly.loop_header537, %polly.loop_exit554
  %indvars.iv843 = phi i64 [ %193, %polly.loop_header537 ], [ %indvars.iv.next844, %polly.loop_exit554 ]
  %polly.indvar548 = phi i64 [ %197, %polly.loop_header537 ], [ %polly.indvar_next549, %polly.loop_exit554 ]
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 99)
  %204 = add i64 %polly.indvar548, %194
  %205 = add i64 %204, %192
  %polly.loop_guard555891 = icmp sgt i64 %205, -1
...
polly.loop_header552.preheader:                   ; preds = %polly.loop_header544
  ...
  %207 = add i64 %206, %203
  %scevgep562 = getelementptr i8, i8* %call2, i64 %207
  %scevgep562563 = bitcast i8* %scevgep562 to double*
  %_p_scalar_564 = load double, double* %scevgep562563, align 8, !alias.scope !84, !noalias !87
  %scevgep568 = getelementptr i8, i8* %call1, i64 %207
  %scevgep568569 = bitcast i8* %scevgep568 to double*
  %_p_scalar_570 = load double, double* %scevgep568569, align 8, !alias.scope !83, !noalias !88
...
polly.loop_exit554:                               ; preds = %polly.loop_header552, %polly.loop_header544
  ...
  %polly.loop_cond550.not.not = icmp slt i64 %polly.indvar548, %201
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_header552
  ...
  %209 = add nuw nsw i64 %polly.indvar556, %191
  %210 = mul nuw nsw i64 %209, 8000
  %211 = add nuw nsw i64 %210, %203
  %scevgep559 = getelementptr i8, i8* %call1, i64 %211
  %scevgep559560 = bitcast i8* %scevgep559 to double*
  %_p_scalar_561 = load double, double* %scevgep559560, align 8, !alias.scope !83, !noalias !88
  %p_mul27.i = fmul fast double %_p_scalar_564, %_p_scalar_561
  %scevgep565 = getelementptr i8, i8* %call2, i64 %211
  %scevgep565566 = bitcast i8* %scevgep565 to double*
  %_p_scalar_567 = load double, double* %scevgep565566, align 8, !alias.scope !84, !noalias !87
  %p_mul37.i = fmul fast double %_p_scalar_570, %_p_scalar_567
  %212 = shl i64 %209, 3
  %213 = add i64 %212, %208
  %scevgep571 = getelementptr i8, i8* %call, i64 %213
  %scevgep571572 = bitcast i8* %scevgep571 to double*
  %_p_scalar_573 = load double, double* %scevgep571572, align 8, !alias.scope !80, !noalias !82
  %p_reass.add.i = fadd fast double %p_mul37.i, %p_mul27.i
  %p_reass.mul.i = fmul fast double %p_reass.add.i, 1.500000e+00
  %p_add42.i = fadd fast double %p_reass.mul.i, %_p_scalar_573
  store double %p_add42.i, double* %scevgep571572, align 8, !alias.scope !80, !noalias !82
...
polly.loop_header700:                             ; preds = %entry, %polly.loop_exit708
  ...
  %214 = shl nsw i64 %polly.indvar703, 5
  %215 = add nsw i64 %smin881, 1199
...
polly.loop_header706:                             ; preds = %polly.loop_exit714, %polly.loop_header700
  ...
  %216 = mul nsw i64 %polly.indvar709, -32
  %smin919 = call i64 @llvm.smin.i64(i64 %216, i64 -1168)
  %217 = add nsw i64 %smin919, 1200
  %smin877 = call i64 @llvm.smin.i64(i64 %indvars.iv875, i64 -1168)
  %218 = shl nsw i64 %polly.indvar709, 5
  %219 = add nsw i64 %smin877, 1199
...
polly.loop_header712:                             ; preds = %polly.loop_exit720, %polly.loop_header706
  ...
  %220 = add nuw nsw i64 %polly.indvar715, %214
...
vector.ph920:                                     ; preds = %polly.loop_header712
  %broadcast.splatinsert927 = insertelement <4 x i64> poison, i64 %218, i32 0
  %broadcast.splat928 = shufflevector <4 x i64> %broadcast.splatinsert927, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert929 = insertelement <4 x i32> poison, i32 %221, i32 0
...
vector.body918:                                   ; preds = %vector.body918, %vector.ph920
  ...
  %223 = add nuw nsw <4 x i64> %vec.ind925, %broadcast.splat928
  %224 = trunc <4 x i64> %223 to <4 x i32>
  %225 = mul <4 x i32> %broadcast.splat930, %224
  ...
  store <4 x double> %229, <4 x double>* %234, align 8, !alias.scope !89, !noalias !91
  %index.next922 = add i64 %index921, 4
  %vec.ind.next926 = add <4 x i64> %vec.ind925, <i64 4, i64 4, i64 4, i64 4>
  %235 = icmp eq i64 %index.next922, %217
  br i1 %235, label %polly.loop_exit720, label %vector.body918, !llvm.loop !94

polly.loop_exit720:                               ; preds = %vector.body918, %polly.loop_header718
  %polly.indvar_next716 = add nuw nsw i64 %polly.indvar715, 1
  %exitcond882.not = icmp eq i64 %polly.indvar715, %215
...
polly.loop_header718:                             ; preds = %polly.loop_header712, %polly.loop_header718
  ...
  %236 = add nuw nsw i64 %polly.indvar721, %218
  ...
  %scevgep724 = getelementptr i8, i8* %call, i64 %242
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar721, %219
  br i1 %exitcond878.not, label %polly.loop_exit720, label %polly.loop_header718, !llvm.loop !95
...
polly.loop_header727:                             ; preds = %polly.loop_exit708, %polly.loop_exit735
  ...
  %243 = shl nsw i64 %polly.indvar730, 5
  %244 = add nsw i64 %smin871, 1199
...
polly.loop_header733:                             ; preds = %polly.loop_exit741, %polly.loop_header727
  ...
  %245 = mul nsw i64 %polly.indvar736, -32
  %smin934 = call i64 @llvm.smin.i64(i64 %245, i64 -968)
  %246 = add nsw i64 %smin934, 1000
  %smin867 = call i64 @llvm.smin.i64(i64 %indvars.iv865, i64 -968)
  %247 = shl nsw i64 %polly.indvar736, 5
  %248 = add nsw i64 %smin867, 999
...
vector.body933:                                   ; preds = %vector.body933, %vector.ph936
  ...
  %252 = add nuw nsw <4 x i64> %vec.ind943, %broadcast.splat946
  %253 = trunc <4 x i64> %252 to <4 x i32>
  %254 = mul <4 x i32> %broadcast.splat948, %253
  ...
  store <4 x double> %258, <4 x double>* %263, align 8, !alias.scope !93, !noalias !96
  %index.next940 = add i64 %index939, 4
  %vec.ind.next944 = add <4 x i64> %vec.ind943, <i64 4, i64 4, i64 4, i64 4>
  %264 = icmp eq i64 %index.next940, %246
  br i1 %264, label %polly.loop_exit747, label %vector.body933, !llvm.loop !97

polly.loop_exit747:                               ; preds = %vector.body933, %polly.loop_header745
  %polly.indvar_next743 = add nuw nsw i64 %polly.indvar742, 1
  %exitcond872.not = icmp eq i64 %polly.indvar742, %244
...
polly.loop_header745:                             ; preds = %polly.loop_header739, %polly.loop_header745
  ...
  %265 = add nuw nsw i64 %polly.indvar748, %247
  ...
  %scevgep751 = getelementptr i8, i8* %call2, i64 %271
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar748, %248
  br i1 %exitcond868.not, label %polly.loop_exit747, label %polly.loop_header745, !llvm.loop !98
...
polly.loop_header753:                             ; preds = %polly.loop_exit735, %polly.loop_exit761
  ...
  %272 = shl nsw i64 %polly.indvar756, 5
  %273 = add nsw i64 %smin861, 1199
...
polly.loop_header759:                             ; preds = %polly.loop_exit767, %polly.loop_header753
  ...
  %274 = mul nsw i64 %polly.indvar762, -32
  %smin952 = call i64 @llvm.smin.i64(i64 %274, i64 -968)
  %275 = add nsw i64 %smin952, 1000
  %smin857 = call i64 @llvm.smin.i64(i64 %indvars.iv855, i64 -968)
  %276 = shl nsw i64 %polly.indvar762, 5
  %277 = add nsw i64 %smin857, 999
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  %281 = add nuw nsw <4 x i64> %vec.ind961, %broadcast.splat964
  %282 = trunc <4 x i64> %281 to <4 x i32>
  %283 = mul <4 x i32> %broadcast.splat966, %282
  ...
  store <4 x double> %287, <4 x double>* %292, align 8, !alias.scope !92, !noalias !99
  %index.next958 = add i64 %index957, 4
  %vec.ind.next962 = add <4 x i64> %vec.ind961, <i64 4, i64 4, i64 4, i64 4>
  %293 = icmp eq i64 %index.next958, %275
  br i1 %293, label %polly.loop_exit773, label %vector.body951, !llvm.loop !100

polly.loop_exit773:                               ; preds = %vector.body951, %polly.loop_header771
  %polly.indvar_next769 = add nuw nsw i64 %polly.indvar768, 1
  %exitcond862.not = icmp eq i64 %polly.indvar768, %273
...
polly.loop_header771:                             ; preds = %polly.loop_header765, %polly.loop_header771
  ...
  %294 = add nuw nsw i64 %polly.indvar774, %276
  ...
  %scevgep778 = getelementptr i8, i8* %call1, i64 %300
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar774, %277
  br i1 %exitcond858.not, label %polly.loop_exit773, label %polly.loop_header771, !llvm.loop !101
}
