; ModuleID = 'syr2k_exhaustive/mmp_all_XL_929.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_929.c"
...
vector.body1446:                                  ; preds = %vector.body1446, %vector.ph1448
  ...
  br i1 %57, label %middle.block1444, label %vector.body1446, !llvm.loop !63
...
vector.body1496:                                  ; preds = %vector.body1496, %vector.ph1498
  ...
  br i1 %68, label %middle.block1494, label %vector.body1496, !llvm.loop !65
...
vector.body1508:                                  ; preds = %vector.body1508, %vector.ph1512
  ...
  %wide.load1519 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1506, label %vector.body1508, !llvm.loop !78
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond1206.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !79
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1202 = call i64 @llvm.smin.i64(i64 %indvars.iv1174, i64 -920)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1205.not = icmp eq i64 %polly.indvar_next204, 13
...
polly.loop_header295.us:                          ; preds = %polly.loop_header295.us.preheader, %polly.loop_header295.us
  ...
  br i1 %exitcond1201.not, label %polly.loop_exit297.us, label %polly.loop_header295.us, !llvm.loop !83
...
vector.body1522:                                  ; preds = %vector.body1522, %vector.ph1530
  ...
  %wide.load1543 = load <4 x double>, <4 x double>* %159, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %164, label %middle.block1520, label %vector.body1522, !llvm.loop !84
...
vector.body1458:                                  ; preds = %vector.body1458, %vector.ph1462
  ...
  %wide.load1469 = load <4 x double>, <4 x double>* %169, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %172, label %middle.block1456, label %vector.body1458, !llvm.loop !92
...
polly.loop_header417:                             ; preds = %polly.loop_header417.preheader, %polly.loop_header417
  ...
  br i1 %exitcond1245.not, label %polly.loop_exit419, label %polly.loop_header417, !llvm.loop !93
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit435
  ...
  %smin1241 = call i64 @llvm.smin.i64(i64 %indvars.iv1211, i64 -920)
  %174 = add nsw i64 %smin1241, 1000
  %175 = mul nuw nsw i64 %polly.indvar430, 80
...
polly.loop_exit435:                               ; preds = %polly.loop_exit459
  ...
  %exitcond1244.not = icmp eq i64 %polly.indvar_next431, 13
...
polly.loop_header529.us:                          ; preds = %polly.loop_header529.us.preheader, %polly.loop_header529.us
  ...
  br i1 %exitcond1240.not, label %polly.loop_exit531.us, label %polly.loop_header529.us, !llvm.loop !96
...
vector.body1472:                                  ; preds = %vector.body1472, %vector.ph1480
  ...
  %wide.load1493 = load <4 x double>, <4 x double>* %236, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %241, label %middle.block1470, label %vector.body1472, !llvm.loop !97
...
vector.body1410:                                  ; preds = %vector.body1410, %vector.ph1412
  ...
  %wide.load1419 = load <4 x double>, <4 x double>* %246, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %249, label %middle.block1408, label %vector.body1410, !llvm.loop !105
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_header651
  ...
  br i1 %exitcond1284.not, label %polly.loop_exit653, label %polly.loop_header651, !llvm.loop !106
...
polly.loop_header661:                             ; preds = %polly.loop_header661.preheader, %polly.loop_exit669
  ...
  %smin1280 = call i64 @llvm.smin.i64(i64 %indvars.iv1250, i64 -920)
  %251 = add nsw i64 %smin1280, 1000
  %252 = mul nuw nsw i64 %polly.indvar664, 80
...
polly.loop_exit669:                               ; preds = %polly.loop_exit693
  ...
  %exitcond1283.not = icmp eq i64 %polly.indvar_next665, 13
...
polly.loop_header763.us:                          ; preds = %polly.loop_header763.us.preheader, %polly.loop_header763.us
  ...
  br i1 %exitcond1279.not, label %polly.loop_exit765.us, label %polly.loop_header763.us, !llvm.loop !109
...
vector.body1422:                                  ; preds = %vector.body1422, %vector.ph1430
  ...
  %wide.load1443 = load <4 x double>, <4 x double>* %313, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %318, label %middle.block1420, label %vector.body1422, !llvm.loop !110
...
vector.body1349:                                  ; preds = %vector.body1349, %vector.ph1350
  ...
  br i1 %340, label %polly.loop_exit935, label %vector.body1349, !llvm.loop !116
...
polly.loop_header933:                             ; preds = %polly.loop_header927, %polly.loop_header933
  ...
  br i1 %exitcond1309.not, label %polly.loop_exit935, label %polly.loop_header933, !llvm.loop !117
...
vector.body1363:                                  ; preds = %vector.body1363, %vector.ph1366
  ...
  br i1 %369, label %polly.loop_exit962, label %vector.body1363, !llvm.loop !119
...
polly.loop_header960:                             ; preds = %polly.loop_header954, %polly.loop_header960
  ...
  br i1 %exitcond1299.not, label %polly.loop_exit962, label %polly.loop_header960, !llvm.loop !120
...
vector.body1381:                                  ; preds = %vector.body1381, %vector.ph1384
  ...
  br i1 %398, label %polly.loop_exit988, label %vector.body1381, !llvm.loop !122
...
polly.loop_header986:                             ; preds = %polly.loop_header980, %polly.loop_header986
  ...
  br i1 %exitcond1289.not, label %polly.loop_exit988, label %polly.loop_header986, !llvm.loop !123
}
