; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8129.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8129.c"
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph964
  ...
  %wide.load971 = load <4 x double>, <4 x double>* %138, align 8, !alias.scope !71, !noalias !73
  ...
  store <4 x double> %139, <4 x double>* %140, align 8, !alias.scope !71, !noalias !73
  %index.next968 = add i64 %index967, 4
  %141 = icmp eq i64 %index.next968, %n.vec966
  br i1 %141, label %middle.block958, label %vector.body960, !llvm.loop !76
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %143 = shl nsw i64 %polly.indvar355, 4
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %145 = shl nuw nsw i64 %polly.indvar361, 1
  %146 = shl nsw i64 %polly.indvar361, 4
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  %wide.load945 = load <4 x double>, <4 x double>* %184, align 8, !alias.scope !80, !noalias !82
  ...
  store <4 x double> %185, <4 x double>* %186, align 8, !alias.scope !80, !noalias !82
  %index.next942 = add i64 %index941, 4
  %187 = icmp eq i64 %index.next942, %n.vec940
  br i1 %187, label %middle.block934, label %vector.body936, !llvm.loop !85
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit513
  ...
  %189 = shl nsw i64 %polly.indvar508, 4
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %191 = shl nuw nsw i64 %polly.indvar514, 1
  %192 = shl nsw i64 %polly.indvar514, 4
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph876
  ...
  store <4 x double> %241, <4 x double>* %246, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %247, label %polly.loop_exit702, label %vector.body874, !llvm.loop !94
...
vector.body889:                                   ; preds = %vector.body889, %vector.ph892
  ...
  store <4 x double> %270, <4 x double>* %275, align 8, !alias.scope !93, !noalias !96
  ...
  br i1 %276, label %polly.loop_exit729, label %vector.body889, !llvm.loop !97
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  store <4 x double> %299, <4 x double>* %304, align 8, !alias.scope !92, !noalias !99
  ...
  br i1 %305, label %polly.loop_exit755, label %vector.body907, !llvm.loop !100
