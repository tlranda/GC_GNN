; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5261.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5261.c"
...
for.cond1.preheader.i:                            ; preds = %entry, %for.inc17.i
  ...
  %scevgep1103 = getelementptr i8, i8* %call2, i64 %12
  %scevgep1102 = getelementptr i8, i8* %call2, i64 %11
  %scevgep1101 = getelementptr i8, i8* %call1, i64 %12
  %scevgep1100 = getelementptr i8, i8* %call1, i64 %11
  %bound0 = icmp ult i8* %scevgep1100, %scevgep1103
  %bound1 = icmp ult i8* %scevgep1102, %scevgep1101
...
for.inc17.i:                                      ; preds = %vector.body, %for.body3.i
  ...
  br i1 %exitcond18.not.i, label %vector.ph1107, label %for.cond1.preheader.i, !llvm.loop !15

vector.ph1107:                                    ; preds = %for.inc17.i, %for.inc41.i
  %indvars.iv7.i = phi i64 [ %indvars.iv.next8.i, %for.inc41.i ], [ 0, %for.inc17.i ]
  %broadcast.splatinsert1114 = insertelement <4 x i64> poison, i64 %indvars.iv7.i, i32 0
...
vector.body1106:                                  ; preds = %vector.body1106, %vector.ph1107
  ...
  %32 = mul nuw nsw <4 x i64> %vec.ind1112, %broadcast.splat1115
  %33 = trunc <4 x i64> %32 to <4 x i32>
  %34 = add <4 x i32> %33, <i32 3, i32 3, i32 3, i32 3>
  %35 = urem <4 x i32> %34, <i32 1200, i32 1200, i32 1200, i32 1200>
  %36 = sitofp <4 x i32> %35 to <4 x double>
  %37 = fmul fast <4 x double> %36, <double 1.000000e-03, double 1.000000e-03, double 1.000000e-03, double 1.000000e-03>
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call813, i64 %indvars.iv7.i, i64 %index1108
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next1109 = add i64 %index1108, 4
  %vec.ind.next1113 = add <4 x i64> %vec.ind1112, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next1109, 1200
  br i1 %40, label %for.inc41.i, label %vector.body1106, !llvm.loop !16

for.inc41.i:                                      ; preds = %vector.body1106
  %indvars.iv.next8.i = add nuw nsw i64 %indvars.iv7.i, 1
  %exitcond9.not.i = icmp eq i64 %indvars.iv.next8.i, 1200
  br i1 %exitcond9.not.i, label %init_array.exit, label %vector.ph1107, !llvm.loop !17
...
vector.body1168:                                  ; preds = %vector.body1168, %vector.ph1170
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call813, i64 %indvars.iv21.i, i64 %index1173
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1193
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call813, i64 %indvars.iv21.i52, i64 %index1196
  ...
  br i1 %57, label %middle.block1189, label %vector.body1191, !llvm.loop !55
...
vector.body1217:                                  ; preds = %vector.body1217, %vector.ph1219
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call813, i64 %indvars.iv21.i91, i64 %index1222
  ...
  br i1 %68, label %middle.block1215, label %vector.body1217, !llvm.loop !57
...
vector.body1229:                                  ; preds = %vector.body1229, %vector.ph1233
  ...
  %wide.load1240 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  ...
  br i1 %95, label %middle.block1227, label %vector.body1229, !llvm.loop !69
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond995.not = icmp eq i64 %polly.indvar_next209, 20
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %polly.loop_guard2331089 = icmp sgt i64 %113, -1
  ...
  br i1 %polly.loop_guard2331089, label %polly.loop_header223.us, label %polly.loop_header217.split
...
polly.loop_header223:                             ; preds = %polly.loop_header217.split, %polly.loop_header223
  ...
  %polly.access.add.call1243 = add nuw nsw i64 %115, %polly.indvar226
  ...
  %polly.access.add.Packed_MemRef_call1246 = add nsw i64 %polly.access.mul.Packed_MemRef_call1245, %113
...
polly.loop_header248.preheader:                   ; preds = %polly.loop_header223, %polly.merge.us
  ...
  br i1 %polly.loop_guard2331089, label %polly.loop_header248.us, label %polly.loop_exit250
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.start281
  %indvar1204 = phi i64 [ %indvar.next1205, %polly.loop_exit375 ], [ 0, %polly.start281 ]
  %polly.indvar370 = phi i64 [ %polly.indvar_next371, %polly.loop_exit375 ], [ 1, %polly.start281 ]
  %128 = add i64 %indvar1204, 1
  %129 = mul nuw nsw i64 %polly.indvar370, 9600
  %scevgep379 = getelementptr i8, i8* %call, i64 %129
  %min.iters.check1206 = icmp ult i64 %128, 4
  br i1 %min.iters.check1206, label %polly.loop_header373.preheader, label %vector.ph1207

vector.ph1207:                                    ; preds = %polly.loop_header367
  %n.vec1209 = and i64 %128, -4
...
vector.body1203:                                  ; preds = %vector.body1203, %vector.ph1207
  ...
  %130 = shl nuw nsw i64 %index1210, 3
  %131 = getelementptr i8, i8* %scevgep379, i64 %130
  %132 = bitcast i8* %131 to <4 x double>*
  %wide.load1214 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !74, !noalias !76
  %133 = fmul fast <4 x double> %wide.load1214, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %135 = icmp eq i64 %index.next1211, %n.vec1209
  br i1 %135, label %middle.block1201, label %vector.body1203, !llvm.loop !80

middle.block1201:                                 ; preds = %vector.body1203
  %cmp.n1213 = icmp eq i64 %128, %n.vec1209
  br i1 %cmp.n1213, label %polly.loop_exit375, label %polly.loop_header373.preheader

polly.loop_header373.preheader:                   ; preds = %polly.loop_header367, %middle.block1201
  %polly.indvar376.ph = phi i64 [ 0, %polly.loop_header367 ], [ %n.vec1209, %middle.block1201 ]
  br label %polly.loop_header373

polly.loop_exit375:                               ; preds = %polly.loop_header373, %middle.block1201
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %137 = udiv i64 %indvars.iv1019, 5
  %138 = add nuw i64 %indvars.iv1017, %137
  %umin1021 = call i64 @llvm.umin.i64(i64 %138, i64 53)
  %139 = mul nsw i64 %polly.indvar386, -128
  %140 = icmp slt i64 %139, -1072
  %141 = select i1 %140, i64 %139, i64 -1072
  %142 = add nsw i64 %141, 1199
  %143 = shl nsw i64 %polly.indvar386, 7
  %144 = add nuw nsw i64 %umin1021, 6
...
polly.loop_header389:                             ; preds = %polly.loop_exit398, %polly.loop_header383
  ...
  %145 = mul nuw nsw i64 %polly.indvar392, 50
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit405
  %polly.indvar_next393 = add nuw nsw i64 %polly.indvar392, 1
  %exitcond1023.not = icmp eq i64 %polly.indvar_next393, 20
...
polly.loop_header403.preheader:                   ; preds = %polly.loop_header396
  ...
  %150 = add i64 %smax1004, %indvars.iv1007
...
polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  ...
  %exitcond1022.not = icmp eq i64 %polly.indvar399, %144
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  %indvars.iv1009 = phi i64 [ %150, %polly.loop_header403.preheader ], [ %indvars.iv.next1010, %polly.loop_exit441 ]
  ...
  %polly.loop_guard4201090 = icmp sgt i64 %153, -1
  ...
  br i1 %polly.loop_guard4201090, label %polly.loop_header410.us, label %polly.loop_header403.split
...
polly.merge429.us:                                ; preds = %polly.then430.us, %polly.cond428.loopexit.us
  ...
  %exitcond1013.not = icmp eq i64 %polly.indvar_next414.us, 50
  br i1 %exitcond1013.not, label %polly.loop_header439.preheader, label %polly.loop_header410.us
...
polly.loop_header410:                             ; preds = %polly.loop_header403.split, %polly.loop_header410
  ...
  %polly.access.add.call1434 = add nuw nsw i64 %155, %polly.indvar413
  ...
  %polly.access.add.Packed_MemRef_call1284437 = add nsw i64 %polly.access.mul.Packed_MemRef_call1284436, %153
  ...
  %exitcond999.not = icmp eq i64 %polly.indvar_next414, 50
  br i1 %exitcond999.not, label %polly.loop_header439.preheader, label %polly.loop_header410

polly.loop_header439.preheader:                   ; preds = %polly.loop_header410, %polly.merge429.us
  %158 = mul i64 %154, 8000
  %159 = mul i64 %154, 9600
  br i1 %polly.loop_guard4201090, label %polly.loop_header439.us, label %polly.loop_exit441
...
polly.loop_exit448.loopexit.us:                   ; preds = %polly.loop_header446.us
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar_next443.us, 50
  br i1 %exitcond1016.not, label %polly.loop_exit441, label %polly.loop_header439.us

polly.start472:                                   ; preds = %init_array.exit
  %malloccall474 = tail call dereferenceable_or_null(480000) i8* @malloc(i64 480000) #6
...
polly.loop_header558:                             ; preds = %polly.loop_exit566, %polly.start472
  ...
  %min.iters.check1180 = icmp ult i64 %168, 4
  br i1 %min.iters.check1180, label %polly.loop_header564.preheader, label %vector.ph1181

vector.ph1181:                                    ; preds = %polly.loop_header558
  %n.vec1183 = and i64 %168, -4
...
vector.body1179:                                  ; preds = %vector.body1179, %vector.ph1181
  ...
  %170 = shl nuw nsw i64 %index1184, 3
  %171 = getelementptr i8, i8* %scevgep570, i64 %170
  %172 = bitcast i8* %171 to <4 x double>*
  %wide.load1188 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !84, !noalias !86
  %173 = fmul fast <4 x double> %wide.load1188, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %175 = icmp eq i64 %index.next1185, %n.vec1183
  br i1 %175, label %middle.block1177, label %vector.body1179, !llvm.loop !90

middle.block1177:                                 ; preds = %vector.body1179
  %cmp.n1187 = icmp eq i64 %168, %n.vec1183
  br i1 %cmp.n1187, label %polly.loop_exit566, label %polly.loop_header564.preheader

polly.loop_header564.preheader:                   ; preds = %polly.loop_header558, %middle.block1177
  %polly.indvar567.ph = phi i64 [ 0, %polly.loop_header558 ], [ %n.vec1183, %middle.block1177 ]
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_header564, %middle.block1177
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %177 = udiv i64 %indvars.iv1047, 5
  %178 = add nuw i64 %indvars.iv1045, %177
  %umin1049 = call i64 @llvm.umin.i64(i64 %178, i64 53)
  %179 = mul nsw i64 %polly.indvar577, -128
  %180 = icmp slt i64 %179, -1072
  %181 = select i1 %180, i64 %179, i64 -1072
  %182 = add nsw i64 %181, 1199
  %183 = shl nsw i64 %polly.indvar577, 7
  %184 = add nuw nsw i64 %umin1049, 6
...
polly.loop_header580:                             ; preds = %polly.loop_exit589, %polly.loop_header574
  ...
  %185 = mul nuw nsw i64 %polly.indvar583, 50
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar_next584, 20
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header587
  ...
  %190 = add i64 %smax1032, %indvars.iv1035
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar590, %184
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1037 = phi i64 [ %190, %polly.loop_header594.preheader ], [ %indvars.iv.next1038, %polly.loop_exit632 ]
  ...
  %polly.loop_guard6111091 = icmp sgt i64 %193, -1
  ...
  br i1 %polly.loop_guard6111091, label %polly.loop_header601.us, label %polly.loop_header594.split
...
polly.merge620.us:                                ; preds = %polly.then621.us, %polly.cond619.loopexit.us
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next605.us, 50
  br i1 %exitcond1041.not, label %polly.loop_header630.preheader, label %polly.loop_header601.us
...
polly.loop_header601:                             ; preds = %polly.loop_header594.split, %polly.loop_header601
  ...
  %polly.access.add.call1625 = add nuw nsw i64 %195, %polly.indvar604
  ...
  %polly.access.add.Packed_MemRef_call1475628 = add nsw i64 %polly.access.mul.Packed_MemRef_call1475627, %193
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next605, 50
  br i1 %exitcond1027.not, label %polly.loop_header630.preheader, label %polly.loop_header601

polly.loop_header630.preheader:                   ; preds = %polly.loop_header601, %polly.merge620.us
  %198 = mul i64 %194, 8000
  %199 = mul i64 %194, 9600
  br i1 %polly.loop_guard6111091, label %polly.loop_header630.us, label %polly.loop_exit632
...
polly.loop_exit639.loopexit.us:                   ; preds = %polly.loop_header637.us
  ...
  %exitcond1044.not = icmp eq i64 %polly.indvar_next634.us, 50
  br i1 %exitcond1044.not, label %polly.loop_exit632, label %polly.loop_header630.us
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  br i1 %min.iters.check, label %polly.loop_header805, label %vector.ph1119

vector.ph1119:                                    ; preds = %polly.loop_header799
  %broadcast.splatinsert1126 = insertelement <4 x i64> poison, i64 %212, i32 0
  %broadcast.splat1127 = shufflevector <4 x i64> %broadcast.splatinsert1126, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1128 = insertelement <4 x i32> poison, i32 %215, i32 0
...
vector.body1118:                                  ; preds = %vector.body1118, %vector.ph1119
  %index1120 = phi i64 [ 0, %vector.ph1119 ], [ %index.next1121, %vector.body1118 ]
  %vec.ind1124 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph1119 ], [ %vec.ind.next1125, %vector.body1118 ]
  %217 = add nuw nsw <4 x i64> %vec.ind1124, %broadcast.splat1127
  %218 = trunc <4 x i64> %217 to <4 x i32>
  %219 = mul <4 x i32> %broadcast.splat1129, %218
  ...
  %229 = icmp eq i64 %index.next1121, %211
  br i1 %229, label %polly.loop_exit807, label %vector.body1118, !llvm.loop !99

polly.loop_exit807:                               ; preds = %vector.body1118, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1082.not = icmp eq i64 %polly.indvar802, %209
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1078.not = icmp eq i64 %polly.indvar808, %213
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %smin1133 = call i64 @llvm.smin.i64(i64 %239, i64 -968)
  %240 = add nsw i64 %smin1133, 1000
  %smin1067 = call i64 @llvm.smin.i64(i64 %indvars.iv1065, i64 -968)
  %241 = shl nsw i64 %polly.indvar823, 5
  %242 = add nsw i64 %smin1067, 999
...
polly.loop_header826:                             ; preds = %polly.loop_exit834, %polly.loop_header820
  ...
  %min.iters.check1134 = icmp eq i64 %240, 0
  br i1 %min.iters.check1134, label %polly.loop_header832, label %vector.ph1135

vector.ph1135:                                    ; preds = %polly.loop_header826
  %broadcast.splatinsert1144 = insertelement <4 x i64> poison, i64 %241, i32 0
  %broadcast.splat1145 = shufflevector <4 x i64> %broadcast.splatinsert1144, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1146 = insertelement <4 x i32> poison, i32 %244, i32 0
...
vector.body1132:                                  ; preds = %vector.body1132, %vector.ph1135
  ...
  %246 = add nuw nsw <4 x i64> %vec.ind1142, %broadcast.splat1145
  %247 = trunc <4 x i64> %246 to <4 x i32>
  %248 = mul <4 x i32> %broadcast.splat1147, %247
  ...
  %258 = icmp eq i64 %index.next1139, %240
  br i1 %258, label %polly.loop_exit834, label %vector.body1132, !llvm.loop !102

polly.loop_exit834:                               ; preds = %vector.body1132, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1072.not = icmp eq i64 %polly.indvar829, %238
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1068.not = icmp eq i64 %polly.indvar835, %242
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %smin1151 = call i64 @llvm.smin.i64(i64 %268, i64 -968)
  %269 = add nsw i64 %smin1151, 1000
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1055, i64 -968)
  %270 = shl nsw i64 %polly.indvar849, 5
  %271 = add nsw i64 %smin1057, 999
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %min.iters.check1152 = icmp eq i64 %269, 0
  br i1 %min.iters.check1152, label %polly.loop_header858, label %vector.ph1153

vector.ph1153:                                    ; preds = %polly.loop_header852
  %broadcast.splatinsert1162 = insertelement <4 x i64> poison, i64 %270, i32 0
  %broadcast.splat1163 = shufflevector <4 x i64> %broadcast.splatinsert1162, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1164 = insertelement <4 x i32> poison, i32 %273, i32 0
...
vector.body1150:                                  ; preds = %vector.body1150, %vector.ph1153
  ...
  %275 = add nuw nsw <4 x i64> %vec.ind1160, %broadcast.splat1163
  %276 = trunc <4 x i64> %275 to <4 x i32>
  %277 = mul <4 x i32> %broadcast.splat1165, %276
  ...
  %287 = icmp eq i64 %index.next1157, %269
  br i1 %287, label %polly.loop_exit860, label %vector.body1150, !llvm.loop !105

polly.loop_exit860:                               ; preds = %vector.body1150, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1062.not = icmp eq i64 %polly.indvar855, %267
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar861, %271
