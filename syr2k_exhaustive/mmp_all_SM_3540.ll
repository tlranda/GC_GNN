; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3540.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3540.c"
...
vector.body1241:                                  ; preds = %vector.body1241, %vector.ph1245
  ...
  %wide.load1252 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %143, label %middle.block1239, label %vector.body1241, !llvm.loop !85
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %146 = shl nsw i64 %polly.indvar396, 4
...
vector.body1217:                                  ; preds = %vector.body1217, %vector.ph1219
  ...
  %wide.load1226 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %191, label %middle.block1215, label %vector.body1217, !llvm.loop !95
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %194 = shl nsw i64 %polly.indvar593, 4
...
vector.body1156:                                  ; preds = %vector.body1156, %vector.ph1157
  ...
  br i1 %253, label %polly.loop_exit829, label %vector.body1156, !llvm.loop !104
...
vector.body1170:                                  ; preds = %vector.body1170, %vector.ph1173
  ...
  br i1 %282, label %polly.loop_exit856, label %vector.body1170, !llvm.loop !107
...
vector.body1188:                                  ; preds = %vector.body1188, %vector.ph1191
  ...
  br i1 %311, label %polly.loop_exit882, label %vector.body1188, !llvm.loop !110
