; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3073.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3073.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -968)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next203, 32
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %polly.loop_guard = icmp slt i64 %103, 60
...
polly.loop_exit213:                               ; preds = %polly.loop_exit252, %polly.loop_header205
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next209, 38
...
polly.loop_exit252:                               ; preds = %polly.loop_exit259.loopexit.us, %polly.loop_header250.preheader
  ...
  %indvars.iv.next1022 = add i64 %indvars.iv1021, -20
  %indvars.iv.next1026 = add i64 %indvars.iv1025, 20
...
polly.loop_header250.preheader:                   ; preds = %polly.loop_exit238, %polly.loop_exit238.us, %polly.loop_header211.split
  ...
  %polly.loop_guard260 = icmp slt i64 %122, 20
...
polly.loop_header257.us:                          ; preds = %polly.loop_header250.us, %polly.loop_exit267.us
  ...
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 31)
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %smin1059 = call i64 @llvm.smin.i64(i64 %indvars.iv1037, i64 -968)
  %145 = add nsw i64 %smin1059, 1000
  %146 = shl nsw i64 %polly.indvar396, 5
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar_next397, 32
...
polly.loop_header399:                             ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %polly.loop_guard410 = icmp slt i64 %151, 60
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  ...
  %154 = mul nsw i64 %polly.indvar402, -32
  %155 = shl nsw i64 %polly.indvar402, 5
...
polly.loop_exit409:                               ; preds = %polly.loop_exit449, %polly.loop_header399
  ...
  %indvars.iv.next1052 = add nuw nsw i64 %indvars.iv1051, 8
  %exitcond1061.not = icmp eq i64 %polly.indvar_next403, 38
...
polly.loop_exit449:                               ; preds = %polly.loop_exit456.loopexit.us, %polly.loop_header447.preheader
  ...
  %indvars.iv.next1049 = add i64 %indvars.iv1048, -20
  %indvars.iv.next1054 = add i64 %indvars.iv1053, 20
...
polly.loop_header447.preheader:                   ; preds = %polly.loop_exit435, %polly.loop_exit435.us, %polly.loop_header407.split
  ...
  %polly.loop_guard457 = icmp slt i64 %170, 20
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %smin1087 = call i64 @llvm.smin.i64(i64 %indvars.iv1065, i64 -968)
  %193 = add nsw i64 %smin1087, 1000
  %194 = shl nsw i64 %polly.indvar593, 5
...
polly.loop_exit598:                               ; preds = %polly.loop_exit606
  ...
  %exitcond1090.not = icmp eq i64 %polly.indvar_next594, 32
...
polly.loop_header596:                             ; preds = %polly.loop_exit606, %polly.loop_header590
  ...
  %polly.loop_guard607 = icmp slt i64 %199, 60
...
polly.loop_header604.preheader:                   ; preds = %polly.loop_header596
  ...
  %202 = mul nsw i64 %polly.indvar599, -32
  %203 = shl nsw i64 %polly.indvar599, 5
...
polly.loop_exit606:                               ; preds = %polly.loop_exit646, %polly.loop_header596
  ...
  %indvars.iv.next1080 = add nuw nsw i64 %indvars.iv1079, 8
  %exitcond1089.not = icmp eq i64 %polly.indvar_next600, 38
...
polly.loop_exit646:                               ; preds = %polly.loop_exit653.loopexit.us, %polly.loop_header644.preheader
  ...
  %indvars.iv.next1082 = add i64 %indvars.iv1081, 20
...
polly.loop_header644.preheader:                   ; preds = %polly.loop_exit632, %polly.loop_exit632.us, %polly.loop_header604.split
  ...
  %polly.loop_guard654 = icmp slt i64 %218, 20
...
polly.loop_header651.us:                          ; preds = %polly.loop_header644.us, %polly.loop_exit661.us
  ...
  %smin1085 = call i64 @llvm.smin.i64(i64 %indvars.iv1083, i64 31)
