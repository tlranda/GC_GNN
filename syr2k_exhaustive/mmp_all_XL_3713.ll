; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3713.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3713.c"
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %106 = shl nsw i64 %polly.indvar208, 6
...
polly.loop_exit213:                               ; preds = %polly.loop_exit252, %polly.loop_header205
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next209, 19
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit252
  ...
  %.inv = icmp sgt i64 %110, 63
  %112 = select i1 %.inv, i64 63, i64 %111
...
polly.loop_header399:                             ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %indvars.iv1046 = phi i64 [ %indvars.iv.next1047, %polly.loop_exit409 ], [ 2, %polly.loop_header393 ]
  ...
  %153 = udiv i64 %indvars.iv1046, 3
  %154 = mul nuw nsw i64 %153, 96
  %155 = trunc i64 %polly.indvar402 to i8
  %pexp.p_div_q405.lhs.trunc = add i8 %155, 2
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  ...
  %159 = mul nsw i64 %polly.indvar402, -64
  %160 = shl nsw i64 %polly.indvar402, 6
...
polly.loop_exit409:                               ; preds = %polly.loop_exit449, %polly.loop_header399
  ...
  %exitcond1061.not = icmp eq i64 %polly.indvar_next403, 19
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit449
  ...
  %.inv889 = icmp sgt i64 %164, 63
  %166 = select i1 %.inv889, i64 63, i64 %165
...
polly.loop_header596:                             ; preds = %polly.loop_exit606, %polly.loop_header590
  ...
  %indvars.iv1074 = phi i64 [ %indvars.iv.next1075, %polly.loop_exit606 ], [ 2, %polly.loop_header590 ]
  ...
  %207 = udiv i64 %indvars.iv1074, 3
  %208 = mul nuw nsw i64 %207, 96
  %209 = trunc i64 %polly.indvar599 to i8
  %pexp.p_div_q602.lhs.trunc = add i8 %209, 2
...
polly.loop_header604.preheader:                   ; preds = %polly.loop_header596
  ...
  %213 = mul nsw i64 %polly.indvar599, -64
  %214 = shl nsw i64 %polly.indvar599, 6
...
polly.loop_exit606:                               ; preds = %polly.loop_exit646, %polly.loop_header596
  ...
  %exitcond1089.not = icmp eq i64 %polly.indvar_next600, 19
...
polly.loop_header604:                             ; preds = %polly.loop_header604.preheader, %polly.loop_exit646
  ...
  %.inv890 = icmp sgt i64 %218, 63
  %220 = select i1 %.inv890, i64 63, i64 %219
...
polly.loop_header651:                             ; preds = %polly.loop_header644, %polly.loop_exit661
  ...
  %smin1085 = call i64 @llvm.smin.i64(i64 %indvars.iv1083, i64 63)
