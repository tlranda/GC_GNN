; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10115.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10115.c"
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph981
  ...
  br i1 %57, label %middle.block977, label %vector.body979, !llvm.loop !49
...
vector.body1005:                                  ; preds = %vector.body1005, %vector.ph1007
  ...
  br i1 %68, label %middle.block1003, label %vector.body1005, !llvm.loop !51
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1021
  ...
  %wide.load1028 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !57, !noalias !59
  ...
  br i1 %95, label %middle.block1015, label %vector.body1017, !llvm.loop !62
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond794.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !63
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin787 = call i64 @llvm.smin.i64(i64 %indvars.iv785, i64 -1136)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond792.not = icmp eq i64 %polly.indvar_next209, 16
...
vector.body991:                                   ; preds = %vector.body991, %vector.ph995
  ...
  %wide.load1002 = load <4 x double>, <4 x double>* %119, align 8, !alias.scope !67, !noalias !69
  ...
  store <4 x double> %120, <4 x double>* %121, align 8, !alias.scope !67, !noalias !69
  %index.next999 = add i64 %index998, 4
  %122 = icmp eq i64 %index.next999, %n.vec997
  br i1 %122, label %middle.block989, label %vector.body991, !llvm.loop !72
...
polly.loop_header342:                             ; preds = %polly.loop_header342.preheader, %polly.loop_header342
  ...
  br i1 %exitcond817.not, label %polly.loop_exit344, label %polly.loop_header342, !llvm.loop !73
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %124 = shl nsw i64 %polly.indvar355, 6
...
polly.loop_exit360:                               ; preds = %polly.loop_exit366
  ...
  %exitcond816.not = icmp eq i64 %polly.indvar_next356, 19
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %smin806 = call i64 @llvm.smin.i64(i64 %indvars.iv804, i64 -936)
  %126 = shl nsw i64 %polly.indvar361, 6
...
polly.loop_exit366:                               ; preds = %polly.loop_exit372
  ...
  %exitcond815.not = icmp eq i64 %polly.indvar_next362, 16
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %128 = shl nsw i64 %polly.indvar367, 6
...
polly.loop_header370:                             ; preds = %polly.loop_exit378, %polly.loop_header364
  ...
  %smin802 = call i64 @llvm.smin.i64(i64 %indvars.iv800, i64 63)
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph969
  ...
  %wide.load976 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !76, !noalias !78
  ...
  store <4 x double> %147, <4 x double>* %148, align 8, !alias.scope !76, !noalias !78
  %index.next973 = add i64 %index972, 4
  %149 = icmp eq i64 %index.next973, %n.vec971
  br i1 %149, label %middle.block965, label %vector.body967, !llvm.loop !81
...
polly.loop_header497:                             ; preds = %polly.loop_header497.preheader, %polly.loop_header497
  ...
  br i1 %exitcond840.not, label %polly.loop_exit499, label %polly.loop_header497, !llvm.loop !82
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %smin833 = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 -1136)
  %151 = shl nsw i64 %polly.indvar510, 6
...
polly.loop_exit515:                               ; preds = %polly.loop_exit521
  ...
  %indvars.iv.next820 = add nuw nsw i64 %indvars.iv819, 64
  %indvars.iv.next832 = add nsw i64 %indvars.iv831, -64
  %indvars.iv.next836 = add nuw nsw i64 %indvars.iv835, 1
  %exitcond839.not = icmp eq i64 %polly.indvar_next511, 19
...
polly.loop_header513:                             ; preds = %polly.loop_exit521, %polly.loop_header507
  ...
  %smin829 = call i64 @llvm.smin.i64(i64 %indvars.iv827, i64 -936)
  %153 = shl nsw i64 %polly.indvar516, 6
...
polly.loop_exit521:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next828 = add nsw i64 %indvars.iv827, -64
  %exitcond838.not = icmp eq i64 %polly.indvar_next517, 16
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %155 = shl nsw i64 %polly.indvar522, 6
...
vector.body905:                                   ; preds = %vector.body905, %vector.ph907
  ...
  store <4 x double> %184, <4 x double>* %189, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %190, label %polly.loop_exit706, label %vector.body905, !llvm.loop !90
...
polly.loop_header704:                             ; preds = %polly.loop_header698, %polly.loop_header704
  ...
  br i1 %exitcond865.not, label %polly.loop_exit706, label %polly.loop_header704, !llvm.loop !91
...
vector.body920:                                   ; preds = %vector.body920, %vector.ph923
  ...
  store <4 x double> %213, <4 x double>* %218, align 8, !alias.scope !89, !noalias !92
  ...
  br i1 %219, label %polly.loop_exit733, label %vector.body920, !llvm.loop !93
...
polly.loop_header731:                             ; preds = %polly.loop_header725, %polly.loop_header731
  ...
  br i1 %exitcond855.not, label %polly.loop_exit733, label %polly.loop_header731, !llvm.loop !94
...
vector.body938:                                   ; preds = %vector.body938, %vector.ph941
  ...
  store <4 x double> %242, <4 x double>* %247, align 8, !alias.scope !88, !noalias !95
  ...
  br i1 %248, label %polly.loop_exit759, label %vector.body938, !llvm.loop !96
...
polly.loop_header757:                             ; preds = %polly.loop_header751, %polly.loop_header757
  ...
  br i1 %exitcond845.not, label %polly.loop_exit759, label %polly.loop_header757, !llvm.loop !97
}
