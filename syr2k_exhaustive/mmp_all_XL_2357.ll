; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2357.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2357.c"
...
vector.body1172:                                  ; preds = %vector.body1172, %vector.ph1173
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call872, i64 %indvars.iv7.i, i64 %index1174
...
vector.body1234:                                  ; preds = %vector.body1234, %vector.ph1236
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call872, i64 %indvars.iv21.i, i64 %index1239
...
vector.body1279:                                  ; preds = %vector.body1279, %vector.ph1281
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call872, i64 %indvars.iv21.i52, i64 %index1284
...
vector.body1327:                                  ; preds = %vector.body1327, %vector.ph1329
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call872, i64 %indvars.iv21.i91, i64 %index1332
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit224 ], [ 6, %polly.loop_exit208 ]
  ...
  %smin1053 = call i64 @llvm.smin.i64(i64 %100, i64 54)
...
polly.loop_exit230:                               ; preds = %polly.loop_exit236
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar_next226, 20
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %109 = add i64 %97, %108
  %smax1354 = call i64 @llvm.smax.i64(i64 %109, i64 0)
  %110 = mul nsw i64 %polly.indvar231, -20
  %111 = add i64 %98, %110
  %112 = add i64 %smax1354, %111
...
polly.loop_exit236:                               ; preds = %polly.loop_exit267, %polly.loop_header228
  ...
  %exitcond1054.not = icmp eq i64 %polly.indvar231, %106
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %120 = add i64 %112, %indvar1355
  %smin1357 = call i64 @llvm.smin.i64(i64 %120, i64 19)
  %121 = add nsw i64 %smin1357, 1
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv1042, i64 19)
  %122 = add nsw i64 %polly.indvar237, %118
  %polly.loop_guard2501155 = icmp sgt i64 %122, -1
...
polly.loop_header265.us:                          ; preds = %polly.loop_header265.preheader, %polly.loop_exit274.loopexit.us
  ...
  %min.iters.check1358 = icmp ult i64 %121, 4
...
vector.body1353:                                  ; preds = %vector.body1353, %vector.ph1359
  ...
  %129 = add nuw nsw i64 %index1362, %113
  %130 = add nuw nsw i64 %index1362, %polly.access.mul.Packed_MemRef_call1279.us
  %131 = getelementptr double, double* %Packed_MemRef_call1, i64 %130
  %132 = bitcast double* %131 to <4 x double>*
  %wide.load1366 = load <4 x double>, <4 x double>* %132, align 8
  %133 = fmul fast <4 x double> %broadcast.splat1368, %wide.load1366
  ...
  %wide.load1369 = load <4 x double>, <4 x double>* %136, align 8
  %137 = fmul fast <4 x double> %broadcast.splat1371, %wide.load1369
  %138 = shl i64 %129, 3
  %139 = add i64 %138, %127
  %140 = getelementptr i8, i8* %call, i64 %139
  %141 = bitcast i8* %140 to <4 x double>*
  %wide.load1372 = load <4 x double>, <4 x double>* %141, align 8, !alias.scope !65, !noalias !67
  ...
  %144 = fadd fast <4 x double> %143, %wide.load1372
  ...
  %146 = icmp eq i64 %index.next1363, %n.vec1361
  br i1 %146, label %middle.block1351, label %vector.body1353, !llvm.loop !77

middle.block1351:                                 ; preds = %vector.body1353
  %cmp.n1365 = icmp eq i64 %121, %n.vec1361
...
vector.body1291:                                  ; preds = %vector.body1291, %vector.ph1295
  ...
  %152 = shl nuw nsw i64 %index1298, 3
  %153 = getelementptr i8, i8* %scevgep400, i64 %152
  %154 = bitcast i8* %153 to <4 x double>*
  %wide.load1302 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !79, !noalias !81
  %155 = fmul fast <4 x double> %wide.load1302, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %157 = icmp eq i64 %index.next1299, %n.vec1297
  br i1 %157, label %middle.block1289, label %vector.body1291, !llvm.loop !86

middle.block1289:                                 ; preds = %vector.body1291
  %cmp.n1301 = icmp eq i64 %150, %n.vec1297
...
polly.loop_header394:                             ; preds = %polly.loop_header394.preheader, %polly.loop_header394
  ...
  br i1 %exitcond1089.not, label %polly.loop_exit396, label %polly.loop_header394, !llvm.loop !87
...
polly.loop_exit412:                               ; preds = %polly.loop_header410
  ...
  br i1 %exitcond1088.not, label %polly.loop_header420, label %polly.loop_header404
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  %indvars.iv1081 = phi i64 [ %indvars.iv.next1082, %polly.loop_exit428 ], [ 6, %polly.loop_exit412 ]
  %indvars.iv1079 = phi i64 [ %indvars.iv.next1080, %polly.loop_exit428 ], [ 0, %polly.loop_exit412 ]
  ...
  %160 = mul nuw nsw i64 %polly.indvar423, 96
  %161 = udiv i64 %indvars.iv1081, 5
  %162 = sub nsw i64 %indvars.iv1079, %161
  %smin1083 = call i64 @llvm.smin.i64(i64 %162, i64 54)
  %163 = mul nsw i64 %polly.indvar423, -96
  %164 = icmp slt i64 %163, -1104
  %165 = select i1 %164, i64 %163, i64 -1104
  %166 = add nsw i64 %165, 1199
  %167 = mul nuw nsw i64 %polly.indvar423, 96
  %168 = add nsw i64 %smin1083, 5
...
polly.loop_exit428:                               ; preds = %polly.loop_exit435
  ...
  %indvars.iv.next1080 = add nuw nsw i64 %indvars.iv1079, 5
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442
  ...
  %exitcond1085.not = icmp eq i64 %polly.indvar_next430, 20
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %171 = add i64 %159, %170
  %smax1306 = call i64 @llvm.smax.i64(i64 %171, i64 0)
  %172 = mul nsw i64 %polly.indvar436, -20
  %173 = add i64 %160, %172
  %174 = add i64 %smax1306, %173
...
polly.loop_header440.preheader:                   ; preds = %polly.loop_header433
  ...
  %179 = add i64 %smax1066, %indvars.iv1069
...
polly.loop_exit442:                               ; preds = %polly.loop_exit478, %polly.loop_header433
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar436, %168
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  %indvar1307 = phi i64 [ 0, %polly.loop_header440.preheader ], [ %indvar.next1308, %polly.loop_exit478 ]
  %indvars.iv1071 = phi i64 [ %179, %polly.loop_header440.preheader ], [ %indvars.iv.next1072, %polly.loop_exit478 ]
  %polly.indvar444 = phi i64 [ %178, %polly.loop_header440.preheader ], [ %polly.indvar_next445, %polly.loop_exit478 ]
  %182 = add i64 %174, %indvar1307
  %smin1309 = call i64 @llvm.smin.i64(i64 %182, i64 19)
  %183 = add nsw i64 %smin1309, 1
  %smin1076 = call i64 @llvm.smin.i64(i64 %indvars.iv1071, i64 19)
  %184 = add nsw i64 %polly.indvar444, %180
  %polly.loop_guard4571156 = icmp sgt i64 %184, -1
  ...
  br i1 %polly.loop_guard4571156, label %polly.loop_header447.us, label %polly.loop_header440.split
...
polly.merge466.us:                                ; preds = %polly.then467.us, %polly.cond465.loopexit.us
  ...
  %exitcond1075.not = icmp eq i64 %polly.indvar_next451.us, 50
  br i1 %exitcond1075.not, label %polly.loop_header476.preheader, label %polly.loop_header447.us
...
polly.loop_header447:                             ; preds = %polly.loop_header440.split, %polly.loop_header447
  ...
  %exitcond1061.not = icmp eq i64 %polly.indvar_next451, 50
  br i1 %exitcond1061.not, label %polly.loop_header476.preheader, label %polly.loop_header447

polly.loop_header476.preheader:                   ; preds = %polly.loop_header447, %polly.merge466.us
  %189 = mul i64 %185, 9600
  br i1 %polly.loop_guard4571156, label %polly.loop_header476.us, label %polly.loop_exit478
...
polly.loop_header476.us:                          ; preds = %polly.loop_header476.preheader, %polly.loop_exit485.loopexit.us
  ...
  %min.iters.check1310 = icmp ult i64 %183, 4
  br i1 %min.iters.check1310, label %polly.loop_header483.us.preheader, label %vector.ph1311

vector.ph1311:                                    ; preds = %polly.loop_header476.us
  %n.vec1313 = and i64 %183, -4
  %broadcast.splatinsert1319 = insertelement <4 x double> poison, double %_p_scalar_497.us, i32 0
  %broadcast.splat1320 = shufflevector <4 x double> %broadcast.splatinsert1319, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1322 = insertelement <4 x double> poison, double %_p_scalar_505.us, i32 0
...
vector.body1305:                                  ; preds = %vector.body1305, %vector.ph1311
  ...
  %191 = add nuw nsw i64 %index1314, %175
  %192 = add nuw nsw i64 %index1314, %polly.access.mul.Packed_MemRef_call1303490.us
  %193 = getelementptr double, double* %Packed_MemRef_call1303, i64 %192
  %194 = bitcast double* %193 to <4 x double>*
  %wide.load1318 = load <4 x double>, <4 x double>* %194, align 8
  %195 = fmul fast <4 x double> %broadcast.splat1320, %wide.load1318
  ...
  %wide.load1321 = load <4 x double>, <4 x double>* %198, align 8
  %199 = fmul fast <4 x double> %broadcast.splat1323, %wide.load1321
  %200 = shl i64 %191, 3
  %201 = add i64 %200, %189
  %202 = getelementptr i8, i8* %call, i64 %201
  %203 = bitcast i8* %202 to <4 x double>*
  %wide.load1324 = load <4 x double>, <4 x double>* %203, align 8, !alias.scope !79, !noalias !81
  ...
  %206 = fadd fast <4 x double> %205, %wide.load1324
  ...
  %208 = icmp eq i64 %index.next1315, %n.vec1313
  br i1 %208, label %middle.block1303, label %vector.body1305, !llvm.loop !90

middle.block1303:                                 ; preds = %vector.body1305
  %cmp.n1317 = icmp eq i64 %183, %n.vec1313
  br i1 %cmp.n1317, label %polly.loop_exit485.loopexit.us, label %polly.loop_header483.us.preheader

polly.loop_header483.us.preheader:                ; preds = %polly.loop_header476.us, %middle.block1303
  %polly.indvar487.us.ph = phi i64 [ 0, %polly.loop_header476.us ], [ %n.vec1313, %middle.block1303 ]
...
polly.loop_header483.us:                          ; preds = %polly.loop_header483.us.preheader, %polly.loop_header483.us
  ...
  br i1 %exitcond1077.not, label %polly.loop_exit485.loopexit.us, label %polly.loop_header483.us, !llvm.loop !91

polly.loop_exit485.loopexit.us:                   ; preds = %polly.loop_header483.us, %middle.block1303
  %polly.indvar_next480.us = add nuw nsw i64 %polly.indvar479.us, 1
  %exitcond1078.not = icmp eq i64 %polly.indvar_next480.us, 50
  br i1 %exitcond1078.not, label %polly.loop_exit478, label %polly.loop_header476.us
...
polly.loop_header599:                             ; preds = %polly.loop_exit607, %polly.start511
  ...
  %min.iters.check1246 = icmp ult i64 %212, 4
  br i1 %min.iters.check1246, label %polly.loop_header605.preheader, label %vector.ph1247

vector.ph1247:                                    ; preds = %polly.loop_header599
  %n.vec1249 = and i64 %212, -4
...
vector.body1245:                                  ; preds = %vector.body1245, %vector.ph1247
  ...
  %214 = shl nuw nsw i64 %index1250, 3
  %215 = getelementptr i8, i8* %scevgep611, i64 %214
  %216 = bitcast i8* %215 to <4 x double>*
  %wide.load1254 = load <4 x double>, <4 x double>* %216, align 8, !alias.scope !92, !noalias !94
  %217 = fmul fast <4 x double> %wide.load1254, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %219 = icmp eq i64 %index.next1251, %n.vec1249
  br i1 %219, label %middle.block1243, label %vector.body1245, !llvm.loop !99

middle.block1243:                                 ; preds = %vector.body1245
  %cmp.n1253 = icmp eq i64 %212, %n.vec1249
  br i1 %cmp.n1253, label %polly.loop_exit607, label %polly.loop_header605.preheader

polly.loop_header605.preheader:                   ; preds = %polly.loop_header599, %middle.block1243
  %polly.indvar608.ph = phi i64 [ 0, %polly.loop_header599 ], [ %n.vec1249, %middle.block1243 ]
  br label %polly.loop_header605

polly.loop_exit607:                               ; preds = %polly.loop_header605, %middle.block1243
...
polly.loop_header605:                             ; preds = %polly.loop_header605.preheader, %polly.loop_header605
  ...
  br i1 %exitcond1119.not, label %polly.loop_exit607, label %polly.loop_header605, !llvm.loop !100
...
polly.loop_exit623:                               ; preds = %polly.loop_header621
  ...
  br i1 %exitcond1118.not, label %polly.loop_header631, label %polly.loop_header615
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  %indvars.iv1111 = phi i64 [ %indvars.iv.next1112, %polly.loop_exit639 ], [ 6, %polly.loop_exit623 ]
  ...
  %221 = mul nsw i64 %polly.indvar634, -96
  %222 = mul nuw nsw i64 %polly.indvar634, 96
  %223 = udiv i64 %indvars.iv1111, 5
  %224 = sub nsw i64 %indvars.iv1109, %223
  %smin1113 = call i64 @llvm.smin.i64(i64 %224, i64 54)
  %225 = mul nsw i64 %polly.indvar634, -96
  %226 = icmp slt i64 %225, -1104
  %227 = select i1 %226, i64 %225, i64 -1104
  %228 = add nsw i64 %227, 1199
  %229 = mul nuw nsw i64 %polly.indvar634, 96
  %230 = add nsw i64 %smin1113, 5
...
polly.loop_exit639:                               ; preds = %polly.loop_exit646
  ...
  %indvars.iv.next1110 = add nuw nsw i64 %indvars.iv1109, 5
...
polly.loop_exit646:                               ; preds = %polly.loop_exit653
  ...
  %exitcond1115.not = icmp eq i64 %polly.indvar_next641, 20
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %233 = add i64 %221, %232
  %smax1258 = call i64 @llvm.smax.i64(i64 %233, i64 0)
  %234 = mul nsw i64 %polly.indvar647, -20
  %235 = add i64 %222, %234
  %236 = add i64 %smax1258, %235
...
polly.loop_header651.preheader:                   ; preds = %polly.loop_header644
  ...
  %241 = add i64 %smax1096, %indvars.iv1099
...
polly.loop_exit653:                               ; preds = %polly.loop_exit689, %polly.loop_header644
  ...
  %exitcond1114.not = icmp eq i64 %polly.indvar647, %230
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  %indvar1259 = phi i64 [ 0, %polly.loop_header651.preheader ], [ %indvar.next1260, %polly.loop_exit689 ]
  %indvars.iv1101 = phi i64 [ %241, %polly.loop_header651.preheader ], [ %indvars.iv.next1102, %polly.loop_exit689 ]
  %polly.indvar655 = phi i64 [ %240, %polly.loop_header651.preheader ], [ %polly.indvar_next656, %polly.loop_exit689 ]
  %244 = add i64 %236, %indvar1259
  %smin1261 = call i64 @llvm.smin.i64(i64 %244, i64 19)
  %245 = add nsw i64 %smin1261, 1
  %smin1106 = call i64 @llvm.smin.i64(i64 %indvars.iv1101, i64 19)
  %246 = add nsw i64 %polly.indvar655, %242
  %polly.loop_guard6681157 = icmp sgt i64 %246, -1
  ...
  br i1 %polly.loop_guard6681157, label %polly.loop_header658.us, label %polly.loop_header651.split
...
polly.merge677.us:                                ; preds = %polly.then678.us, %polly.cond676.loopexit.us
  ...
  %exitcond1105.not = icmp eq i64 %polly.indvar_next662.us, 50
  br i1 %exitcond1105.not, label %polly.loop_header687.preheader, label %polly.loop_header658.us
...
polly.loop_header658:                             ; preds = %polly.loop_header651.split, %polly.loop_header658
  ...
  %exitcond1091.not = icmp eq i64 %polly.indvar_next662, 50
  br i1 %exitcond1091.not, label %polly.loop_header687.preheader, label %polly.loop_header658

polly.loop_header687.preheader:                   ; preds = %polly.loop_header658, %polly.merge677.us
  %251 = mul i64 %247, 9600
  br i1 %polly.loop_guard6681157, label %polly.loop_header687.us, label %polly.loop_exit689
...
polly.loop_header687.us:                          ; preds = %polly.loop_header687.preheader, %polly.loop_exit696.loopexit.us
  ...
  %min.iters.check1262 = icmp ult i64 %245, 4
  br i1 %min.iters.check1262, label %polly.loop_header694.us.preheader, label %vector.ph1263

vector.ph1263:                                    ; preds = %polly.loop_header687.us
  %n.vec1265 = and i64 %245, -4
  %broadcast.splatinsert1271 = insertelement <4 x double> poison, double %_p_scalar_708.us, i32 0
  %broadcast.splat1272 = shufflevector <4 x double> %broadcast.splatinsert1271, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1274 = insertelement <4 x double> poison, double %_p_scalar_716.us, i32 0
...
vector.body1257:                                  ; preds = %vector.body1257, %vector.ph1263
  ...
  %253 = add nuw nsw i64 %index1266, %237
  %254 = add nuw nsw i64 %index1266, %polly.access.mul.Packed_MemRef_call1514701.us
  %255 = getelementptr double, double* %Packed_MemRef_call1514, i64 %254
  %256 = bitcast double* %255 to <4 x double>*
  %wide.load1270 = load <4 x double>, <4 x double>* %256, align 8
  %257 = fmul fast <4 x double> %broadcast.splat1272, %wide.load1270
  ...
  %wide.load1273 = load <4 x double>, <4 x double>* %260, align 8
  %261 = fmul fast <4 x double> %broadcast.splat1275, %wide.load1273
  %262 = shl i64 %253, 3
  %263 = add i64 %262, %251
  %264 = getelementptr i8, i8* %call, i64 %263
  %265 = bitcast i8* %264 to <4 x double>*
  %wide.load1276 = load <4 x double>, <4 x double>* %265, align 8, !alias.scope !92, !noalias !94
  ...
  %268 = fadd fast <4 x double> %267, %wide.load1276
  ...
  %270 = icmp eq i64 %index.next1267, %n.vec1265
  br i1 %270, label %middle.block1255, label %vector.body1257, !llvm.loop !103

middle.block1255:                                 ; preds = %vector.body1257
  %cmp.n1269 = icmp eq i64 %245, %n.vec1265
  br i1 %cmp.n1269, label %polly.loop_exit696.loopexit.us, label %polly.loop_header694.us.preheader

polly.loop_header694.us.preheader:                ; preds = %polly.loop_header687.us, %middle.block1255
  %polly.indvar698.us.ph = phi i64 [ 0, %polly.loop_header687.us ], [ %n.vec1265, %middle.block1255 ]
...
polly.loop_header694.us:                          ; preds = %polly.loop_header694.us.preheader, %polly.loop_header694.us
  ...
  br i1 %exitcond1107.not, label %polly.loop_exit696.loopexit.us, label %polly.loop_header694.us, !llvm.loop !104

polly.loop_exit696.loopexit.us:                   ; preds = %polly.loop_header694.us, %middle.block1255
  %polly.indvar_next691.us = add nuw nsw i64 %polly.indvar690.us, 1
  %exitcond1108.not = icmp eq i64 %polly.indvar_next691.us, 50
  br i1 %exitcond1108.not, label %polly.loop_exit689, label %polly.loop_header687.us
...
polly.loop_header858:                             ; preds = %polly.loop_exit866, %polly.loop_header852
  ...
  br i1 %min.iters.check, label %polly.loop_header864, label %vector.ph1185

vector.ph1185:                                    ; preds = %polly.loop_header858
  %broadcast.splatinsert1192 = insertelement <4 x i64> poison, i64 %278, i32 0
  %broadcast.splat1193 = shufflevector <4 x i64> %broadcast.splatinsert1192, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1194 = insertelement <4 x i32> poison, i32 %281, i32 0
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1185
  ...
  %283 = add nuw nsw <4 x i64> %vec.ind1190, %broadcast.splat1193
  %284 = trunc <4 x i64> %283 to <4 x i32>
  %285 = mul <4 x i32> %broadcast.splat1195, %284
  ...
  %295 = icmp eq i64 %index.next1187, %277
  br i1 %295, label %polly.loop_exit866, label %vector.body1184, !llvm.loop !110

polly.loop_exit866:                               ; preds = %vector.body1184, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1148.not = icmp eq i64 %polly.indvar861, %275
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1144.not = icmp eq i64 %polly.indvar867, %279
  br i1 %exitcond1144.not, label %polly.loop_exit866, label %polly.loop_header864, !llvm.loop !111
...
polly.loop_header879:                             ; preds = %polly.loop_exit887, %polly.loop_header873
  ...
  %smin1199 = call i64 @llvm.smin.i64(i64 %305, i64 -968)
  %306 = add nsw i64 %smin1199, 1000
  %smin1133 = call i64 @llvm.smin.i64(i64 %indvars.iv1131, i64 -968)
  %307 = shl nsw i64 %polly.indvar882, 5
  %308 = add nsw i64 %smin1133, 999
...
polly.loop_header885:                             ; preds = %polly.loop_exit893, %polly.loop_header879
  ...
  %min.iters.check1200 = icmp eq i64 %306, 0
  br i1 %min.iters.check1200, label %polly.loop_header891, label %vector.ph1201

vector.ph1201:                                    ; preds = %polly.loop_header885
  %broadcast.splatinsert1210 = insertelement <4 x i64> poison, i64 %307, i32 0
  %broadcast.splat1211 = shufflevector <4 x i64> %broadcast.splatinsert1210, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1212 = insertelement <4 x i32> poison, i32 %310, i32 0
...
vector.body1198:                                  ; preds = %vector.body1198, %vector.ph1201
  ...
  %312 = add nuw nsw <4 x i64> %vec.ind1208, %broadcast.splat1211
  %313 = trunc <4 x i64> %312 to <4 x i32>
  %314 = mul <4 x i32> %broadcast.splat1213, %313
  ...
  %324 = icmp eq i64 %index.next1205, %306
  br i1 %324, label %polly.loop_exit893, label %vector.body1198, !llvm.loop !113

polly.loop_exit893:                               ; preds = %vector.body1198, %polly.loop_header891
  %polly.indvar_next889 = add nuw nsw i64 %polly.indvar888, 1
  %exitcond1138.not = icmp eq i64 %polly.indvar888, %304
...
polly.loop_header891:                             ; preds = %polly.loop_header885, %polly.loop_header891
  ...
  %exitcond1134.not = icmp eq i64 %polly.indvar894, %308
  br i1 %exitcond1134.not, label %polly.loop_exit893, label %polly.loop_header891, !llvm.loop !114
...
polly.loop_header905:                             ; preds = %polly.loop_exit913, %polly.loop_header899
  ...
  %smin1217 = call i64 @llvm.smin.i64(i64 %334, i64 -968)
  %335 = add nsw i64 %smin1217, 1000
  %smin1123 = call i64 @llvm.smin.i64(i64 %indvars.iv1121, i64 -968)
  %336 = shl nsw i64 %polly.indvar908, 5
  %337 = add nsw i64 %smin1123, 999
...
polly.loop_header911:                             ; preds = %polly.loop_exit919, %polly.loop_header905
  ...
  %min.iters.check1218 = icmp eq i64 %335, 0
  br i1 %min.iters.check1218, label %polly.loop_header917, label %vector.ph1219

vector.ph1219:                                    ; preds = %polly.loop_header911
  %broadcast.splatinsert1228 = insertelement <4 x i64> poison, i64 %336, i32 0
  %broadcast.splat1229 = shufflevector <4 x i64> %broadcast.splatinsert1228, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1230 = insertelement <4 x i32> poison, i32 %339, i32 0
...
vector.body1216:                                  ; preds = %vector.body1216, %vector.ph1219
  ...
  %341 = add nuw nsw <4 x i64> %vec.ind1226, %broadcast.splat1229
  %342 = trunc <4 x i64> %341 to <4 x i32>
  %343 = mul <4 x i32> %broadcast.splat1231, %342
  ...
  %353 = icmp eq i64 %index.next1223, %335
  br i1 %353, label %polly.loop_exit919, label %vector.body1216, !llvm.loop !116

polly.loop_exit919:                               ; preds = %vector.body1216, %polly.loop_header917
  %polly.indvar_next915 = add nuw nsw i64 %polly.indvar914, 1
  %exitcond1128.not = icmp eq i64 %polly.indvar914, %333
...
polly.loop_header917:                             ; preds = %polly.loop_header911, %polly.loop_header917
  ...
  %exitcond1124.not = icmp eq i64 %polly.indvar920, %337
  br i1 %exitcond1124.not, label %polly.loop_exit919, label %polly.loop_header917, !llvm.loop !117
}
