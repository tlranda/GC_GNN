; ModuleID = 'syr2k_exhaustive/mmp_all_XL_599.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_599.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %97 = mul nsw i64 %polly.indvar203, -14
  %98 = mul nuw nsw i64 %polly.indvar203, 14
  %99 = add nuw i64 %98, 30
  %100 = and i64 %99, -32
  %101 = add i64 %97, %100
  %102 = sub i64 %98, %100
  %103 = shl nuw nsw i64 %indvars.iv1076, 1
  %104 = and i64 %103, 9223372036854775776
  %105 = add i64 %indvars.iv1074, %104
  %106 = sub nsw i64 %indvars.iv1080, %104
  %107 = mul nsw i64 %polly.indvar203, -50
  %108 = mul nuw nsw i64 %polly.indvar203, 50
...
polly.loop_exit224:                               ; preds = %polly.loop_exit263, %polly.loop_exit208
  ...
  %indvars.iv.next1075 = add nsw i64 %indvars.iv1074, -14
  %indvars.iv.next1077 = add nuw nsw i64 %indvars.iv1076, 7
  %indvars.iv.next1081 = add nuw nsw i64 %indvars.iv1080, 14
...
polly.loop_exit263:                               ; preds = %polly.loop_exit270, %polly.loop_header261.preheader
  ...
  %polly.loop_cond227 = icmp slt i64 %polly.indvar225, 37
  %indvars.iv.next1079 = add i64 %indvars.iv1078, -32
  %indvars.iv.next1083 = add i64 %indvars.iv1082, 32
...
polly.loop_header261.preheader:                   ; preds = %polly.loop_exit249, %polly.loop_exit249.us, %polly.loop_header222.split
  ...
  %135 = mul nsw i64 %polly.indvar225, -32
  %136 = icmp slt i64 %135, -1168
  %137 = select i1 %136, i64 %135, i64 -1168
...
polly.loop_header268:                             ; preds = %polly.loop_header261, %polly.loop_exit278
  ...
  %smin1392 = call i64 @llvm.smin.i64(i64 %140, i64 49)
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit434
  ...
  %174 = mul nsw i64 %polly.indvar411, -14
  %175 = mul nuw nsw i64 %polly.indvar411, 14
  %176 = add nuw i64 %175, 30
  %177 = and i64 %176, -32
  %178 = add i64 %174, %177
  %179 = sub i64 %175, %177
  %180 = shl nuw nsw i64 %indvars.iv1100, 1
  %181 = and i64 %180, 9223372036854775776
  %182 = add i64 %indvars.iv1098, %181
  %183 = sub nsw i64 %indvars.iv1105, %181
  %184 = mul nsw i64 %polly.indvar411, -50
  %185 = mul nuw nsw i64 %polly.indvar411, 50
...
polly.loop_exit416:                               ; preds = %polly.loop_exit422
  ...
  %polly.loop_guard435 = icmp slt i64 %190, 38
...
polly.loop_exit434:                               ; preds = %polly.loop_exit474, %polly.loop_exit416
  ...
  %indvars.iv.next1106 = add nuw nsw i64 %indvars.iv1105, 14
...
polly.loop_exit474:                               ; preds = %polly.loop_exit481, %polly.loop_header472.preheader
  ...
  %polly.loop_cond438 = icmp slt i64 %polly.indvar436, 37
  %indvars.iv.next1103 = add i64 %indvars.iv1102, -32
  %indvars.iv.next1108 = add i64 %indvars.iv1107, 32
...
polly.loop_header472.preheader:                   ; preds = %polly.loop_exit460, %polly.loop_exit460.us, %polly.loop_header432.split
  ...
  %212 = mul nsw i64 %polly.indvar436, -32
...
polly.loop_header479:                             ; preds = %polly.loop_header472, %polly.loop_exit489
  ...
  %smin1342 = call i64 @llvm.smin.i64(i64 %217, i64 49)
...
polly.loop_header619:                             ; preds = %polly.loop_header619.preheader, %polly.loop_exit645
  ...
  %251 = mul nsw i64 %polly.indvar622, -14
  %252 = mul nuw nsw i64 %polly.indvar622, 14
  %253 = add nuw i64 %252, 30
  %254 = and i64 %253, -32
  %255 = add i64 %251, %254
  %256 = sub i64 %252, %254
  %257 = shl nuw nsw i64 %indvars.iv1126, 1
  %258 = and i64 %257, 9223372036854775776
  %259 = add i64 %indvars.iv1124, %258
  %260 = sub nsw i64 %indvars.iv1131, %258
  %261 = mul nsw i64 %polly.indvar622, -50
  %262 = mul nuw nsw i64 %polly.indvar622, 50
...
polly.loop_exit627:                               ; preds = %polly.loop_exit633
  ...
  %polly.loop_guard646 = icmp slt i64 %267, 38
...
polly.loop_exit645:                               ; preds = %polly.loop_exit685, %polly.loop_exit627
  ...
  %indvars.iv.next1125 = add nsw i64 %indvars.iv1124, -14
  %indvars.iv.next1127 = add nuw nsw i64 %indvars.iv1126, 7
  %indvars.iv.next1132 = add nuw nsw i64 %indvars.iv1131, 14
...
polly.loop_exit685:                               ; preds = %polly.loop_exit692, %polly.loop_header683.preheader
  ...
  %polly.loop_cond649 = icmp slt i64 %polly.indvar647, 37
  %indvars.iv.next1129 = add i64 %indvars.iv1128, -32
  %indvars.iv.next1134 = add i64 %indvars.iv1133, 32
...
polly.loop_header683.preheader:                   ; preds = %polly.loop_exit671, %polly.loop_exit671.us, %polly.loop_header643.split
  ...
  %289 = mul nsw i64 %polly.indvar647, -32
  %290 = icmp slt i64 %289, -1168
  %291 = select i1 %290, i64 %289, i64 -1168
...
polly.loop_header690:                             ; preds = %polly.loop_header683, %polly.loop_exit700
  ...
  %smin1292 = call i64 @llvm.smin.i64(i64 %294, i64 49)
