; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10288.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10288.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond800.not = icmp eq i64 %polly.indvar_next209, 250
...
polly.loop_header217.preheader:                   ; preds = %polly.loop_header211
  ...
  %116 = add i64 %smax, %indvars.iv789
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv791 = phi i64 [ %116, %polly.loop_header217.preheader ], [ %indvars.iv.next792, %polly.loop_exit225 ]
  %polly.indvar220 = phi i64 [ %115, %polly.loop_header217.preheader ], [ %polly.indvar_next221, %polly.loop_exit225 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv791, i64 19)
  %118 = add nsw i64 %polly.indvar220, %117
  %polly.loop_guard233886 = icmp sgt i64 %118, -1
  %119 = add nuw nsw i64 %polly.indvar220, %103
  %120 = mul i64 %119, 8000
  %121 = mul i64 %119, 9600
  br i1 %polly.loop_guard233886, label %polly.loop_header223.us.preheader, label %polly.loop_exit225
...
polly.loop_header230.us:                          ; preds = %polly.loop_header223.us.preheader, %polly.loop_header230.us
  ...
  %123 = add nuw nsw i64 %polly.indvar234.us, %112
  %124 = mul nuw nsw i64 %123, 8000
  %125 = add nuw nsw i64 %124, %106
  %scevgep237.us = getelementptr i8, i8* %call1, i64 %125
  ...
  %scevgep243.us = getelementptr i8, i8* %call2, i64 %125
  ...
  %126 = shl i64 %123, 3
  %127 = add i64 %126, %121
  %scevgep249.us = getelementptr i8, i8* %call, i64 %127
...
polly.loop_exit232.loopexit.us:                   ; preds = %polly.loop_header230.us
  %128 = add i64 %108, %120
  %scevgep240.us.1 = getelementptr i8, i8* %call2, i64 %128
  ...
  %scevgep246.us.1 = getelementptr i8, i8* %call1, i64 %128
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %131 = shl nuw nsw i64 %index1008, 3
  %132 = getelementptr i8, i8* %scevgep350, i64 %131
  %133 = bitcast i8* %132 to <4 x double>*
  %wide.load1012 = load <4 x double>, <4 x double>* %133, align 8, !alias.scope !69, !noalias !71
  %134 = fmul fast <4 x double> %wide.load1012, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %136 = icmp eq i64 %index.next1009, %n.vec1007
  br i1 %136, label %middle.block999, label %vector.body1001, !llvm.loop !74

middle.block999:                                  ; preds = %vector.body1001
  %cmp.n1011 = icmp eq i64 %129, %n.vec1007
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond826.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !75
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %138 = udiv i64 %indvars.iv820, 5
  %139 = sub nsw i64 %indvars.iv818, %138
  %smin822 = call i64 @llvm.smin.i64(i64 %139, i64 54)
  %140 = mul nsw i64 %polly.indvar357, -96
  %141 = icmp slt i64 %140, -1104
  %142 = select i1 %141, i64 %140, i64 -1104
  %143 = add nsw i64 %142, 1199
  %144 = mul nuw nsw i64 %polly.indvar357, 96
  %145 = add nsw i64 %smin822, 5
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %147 = shl i64 %polly.indvar363, 5
  %148 = shl i64 %polly.indvar363, 5
  %149 = or i64 %148, 8
  %150 = shl i64 %polly.indvar363, 5
  %151 = or i64 %150, 16
  %152 = or i64 %146, 24
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next364, 250
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %153 = mul nuw nsw i64 %polly.indvar370, 20
  %154 = add nsw i64 %153, %140
  %155 = icmp sgt i64 %154, 0
  %156 = select i1 %155, i64 %154, i64 0
  %polly.loop_guard377.not = icmp sgt i64 %156, %143
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %157 = add i64 %smax808, %indvars.iv811
  %158 = sub nsw i64 %144, %153
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar370, %145
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv813 = phi i64 [ %157, %polly.loop_header374.preheader ], [ %indvars.iv.next814, %polly.loop_exit383 ]
  %polly.indvar378 = phi i64 [ %156, %polly.loop_header374.preheader ], [ %polly.indvar_next379, %polly.loop_exit383 ]
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 19)
  %159 = add nsw i64 %polly.indvar378, %158
  %polly.loop_guard391887 = icmp sgt i64 %159, -1
  %160 = add nuw nsw i64 %polly.indvar378, %144
  %161 = mul i64 %160, 8000
  %162 = mul i64 %160, 9600
  br i1 %polly.loop_guard391887, label %polly.loop_header381.us.preheader, label %polly.loop_exit383

polly.loop_header381.us.preheader:                ; preds = %polly.loop_header374
  %163 = add i64 %147, %161
  %scevgep398.us = getelementptr i8, i8* %call2, i64 %163
  ...
  %scevgep404.us = getelementptr i8, i8* %call1, i64 %163
...
polly.loop_header388.us:                          ; preds = %polly.loop_header381.us.preheader, %polly.loop_header388.us
  ...
  %164 = add nuw nsw i64 %polly.indvar392.us, %153
  %165 = mul nuw nsw i64 %164, 8000
  %166 = add nuw nsw i64 %165, %147
  %scevgep395.us = getelementptr i8, i8* %call1, i64 %166
  ...
  %scevgep401.us = getelementptr i8, i8* %call2, i64 %166
  ...
  %167 = shl i64 %164, 3
  %168 = add i64 %167, %162
  %scevgep407.us = getelementptr i8, i8* %call, i64 %168
...
polly.loop_exit390.loopexit.us:                   ; preds = %polly.loop_header388.us
  %169 = add i64 %149, %161
  %scevgep398.us.1 = getelementptr i8, i8* %call2, i64 %169
  ...
  %scevgep404.us.1 = getelementptr i8, i8* %call1, i64 %169
...
polly.loop_exit383:                               ; preds = %polly.loop_header388.us.3, %polly.loop_header374
  ...
  %polly.loop_cond380.not.not = icmp ult i64 %polly.indvar378, %143
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %172 = shl nuw nsw i64 %index982, 3
  %173 = getelementptr i8, i8* %scevgep508, i64 %172
  %174 = bitcast i8* %173 to <4 x double>*
  %wide.load986 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !78, !noalias !80
  %175 = fmul fast <4 x double> %wide.load986, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %177 = icmp eq i64 %index.next983, %n.vec981
  br i1 %177, label %middle.block975, label %vector.body977, !llvm.loop !83

middle.block975:                                  ; preds = %vector.body977
  %cmp.n985 = icmp eq i64 %170, %n.vec981
...
polly.loop_header502:                             ; preds = %polly.loop_header502.preheader, %polly.loop_header502
  ...
  br i1 %exitcond850.not, label %polly.loop_exit504, label %polly.loop_header502, !llvm.loop !84
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %179 = udiv i64 %indvars.iv844, 5
  %180 = sub nsw i64 %indvars.iv842, %179
  %smin846 = call i64 @llvm.smin.i64(i64 %180, i64 54)
  %181 = mul nsw i64 %polly.indvar515, -96
  %182 = icmp slt i64 %181, -1104
  %183 = select i1 %182, i64 %181, i64 -1104
  %184 = add nsw i64 %183, 1199
  %185 = mul nuw nsw i64 %polly.indvar515, 96
  %186 = add nsw i64 %smin846, 5
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %187 = shl i64 %polly.indvar521, 5
  %188 = shl i64 %polly.indvar521, 5
  %189 = shl i64 %polly.indvar521, 5
  %190 = or i64 %189, 8
  %191 = shl i64 %polly.indvar521, 5
  %192 = or i64 %191, 16
  %193 = or i64 %187, 24
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next522, 250
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %polly.loop_guard535.not = icmp sgt i64 %197, %184
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %198 = add i64 %smax832, %indvars.iv835
  %199 = sub nsw i64 %185, %194
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar528, %186
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv837 = phi i64 [ %198, %polly.loop_header532.preheader ], [ %indvars.iv.next838, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %197, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin839 = call i64 @llvm.smin.i64(i64 %indvars.iv837, i64 19)
  %200 = add nsw i64 %polly.indvar536, %199
  %polly.loop_guard549888 = icmp sgt i64 %200, -1
  %201 = add nuw nsw i64 %polly.indvar536, %185
  %202 = mul i64 %201, 8000
  %203 = mul i64 %201, 9600
  br i1 %polly.loop_guard549888, label %polly.loop_header539.us.preheader, label %polly.loop_exit541

polly.loop_header539.us.preheader:                ; preds = %polly.loop_header532
  %204 = add i64 %188, %202
  %scevgep556.us = getelementptr i8, i8* %call2, i64 %204
  ...
  %scevgep562.us = getelementptr i8, i8* %call1, i64 %204
...
polly.loop_header546.us:                          ; preds = %polly.loop_header539.us.preheader, %polly.loop_header546.us
  ...
  %205 = add nuw nsw i64 %polly.indvar550.us, %194
  %206 = mul nuw nsw i64 %205, 8000
  %207 = add nuw nsw i64 %206, %188
  %scevgep553.us = getelementptr i8, i8* %call1, i64 %207
  ...
  %scevgep559.us = getelementptr i8, i8* %call2, i64 %207
  ...
  %208 = shl i64 %205, 3
  %209 = add i64 %208, %203
  %scevgep565.us = getelementptr i8, i8* %call, i64 %209
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  %210 = add i64 %190, %202
  %scevgep556.us.1 = getelementptr i8, i8* %call2, i64 %210
  ...
  %scevgep562.us.1 = getelementptr i8, i8* %call1, i64 %210
...
polly.loop_exit541:                               ; preds = %polly.loop_header546.us.3, %polly.loop_header532
  ...
  %polly.loop_cond538.not.not = icmp ult i64 %polly.indvar536, %184
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin916 = call i64 @llvm.smin.i64(i64 %213, i64 -1168)
  %214 = add nsw i64 %smin916, 1200
  %smin874 = call i64 @llvm.smin.i64(i64 %indvars.iv872, i64 -1168)
  %215 = shl nsw i64 %polly.indvar703, 5
  %216 = add nsw i64 %smin874, 1199
...
vector.ph917:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert924 = insertelement <4 x i64> poison, i64 %215, i32 0
  %broadcast.splat925 = shufflevector <4 x i64> %broadcast.splatinsert924, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert926 = insertelement <4 x i32> poison, i32 %218, i32 0
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  %220 = add nuw nsw <4 x i64> %vec.ind922, %broadcast.splat925
  %221 = trunc <4 x i64> %220 to <4 x i32>
  %222 = mul <4 x i32> %broadcast.splat927, %221
  ...
  %232 = icmp eq i64 %index.next919, %214
  br i1 %232, label %polly.loop_exit714, label %vector.body915, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body915, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond879.not = icmp eq i64 %polly.indvar709, %212
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond875.not = icmp eq i64 %polly.indvar715, %216
  br i1 %exitcond875.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !93
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin931 = call i64 @llvm.smin.i64(i64 %242, i64 -968)
  %243 = add nsw i64 %smin931, 1000
  %smin864 = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 -968)
  %244 = shl nsw i64 %polly.indvar730, 5
  %245 = add nsw i64 %smin864, 999
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  %249 = add nuw nsw <4 x i64> %vec.ind940, %broadcast.splat943
  %250 = trunc <4 x i64> %249 to <4 x i32>
  %251 = mul <4 x i32> %broadcast.splat945, %250
  ...
  %261 = icmp eq i64 %index.next937, %243
  br i1 %261, label %polly.loop_exit741, label %vector.body930, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body930, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond869.not = icmp eq i64 %polly.indvar736, %241
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond865.not = icmp eq i64 %polly.indvar742, %245
  br i1 %exitcond865.not, label %polly.loop_exit741, label %polly.loop_header739, !llvm.loop !96
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin949 = call i64 @llvm.smin.i64(i64 %271, i64 -968)
  %272 = add nsw i64 %smin949, 1000
  %smin854 = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 -968)
  %273 = shl nsw i64 %polly.indvar756, 5
  %274 = add nsw i64 %smin854, 999
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  %278 = add nuw nsw <4 x i64> %vec.ind958, %broadcast.splat961
  %279 = trunc <4 x i64> %278 to <4 x i32>
  %280 = mul <4 x i32> %broadcast.splat963, %279
  ...
  %290 = icmp eq i64 %index.next955, %272
  br i1 %290, label %polly.loop_exit767, label %vector.body948, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body948, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond859.not = icmp eq i64 %polly.indvar762, %270
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar768, %274
  br i1 %exitcond855.not, label %polly.loop_exit767, label %polly.loop_header765, !llvm.loop !99
...
polly.loop_header230.us.1:                        ; preds = %polly.loop_header230.us.1, %polly.loop_exit232.loopexit.us
  ...
  %298 = add nuw nsw i64 %polly.indvar234.us.1, %112
  %299 = mul nuw nsw i64 %298, 8000
  %300 = add nuw nsw i64 %299, %108
  %scevgep237.us.1 = getelementptr i8, i8* %call1, i64 %300
  ...
  %scevgep243.us.1 = getelementptr i8, i8* %call2, i64 %300
  ...
  %301 = shl i64 %298, 3
  %302 = add i64 %301, %121
  %scevgep249.us.1 = getelementptr i8, i8* %call, i64 %302
...
polly.loop_exit232.loopexit.us.1:                 ; preds = %polly.loop_header230.us.1
  %303 = add i64 %110, %120
  %scevgep240.us.2 = getelementptr i8, i8* %call2, i64 %303
  ...
  %scevgep246.us.2 = getelementptr i8, i8* %call1, i64 %303
...
polly.loop_header230.us.2:                        ; preds = %polly.loop_header230.us.2, %polly.loop_exit232.loopexit.us.1
  ...
  %304 = add nuw nsw i64 %polly.indvar234.us.2, %112
...
polly.loop_header230.us.3:                        ; preds = %polly.loop_header230.us.3, %polly.loop_exit232.loopexit.us.2
  ...
  %310 = add nuw nsw i64 %polly.indvar234.us.3, %112
  %311 = mul nuw nsw i64 %310, 8000
  %312 = add nuw nsw i64 %311, %111
  %scevgep237.us.3 = getelementptr i8, i8* %call1, i64 %312
  ...
  %scevgep243.us.3 = getelementptr i8, i8* %call2, i64 %312
  ...
  %313 = shl i64 %310, 3
  %314 = add i64 %313, %121
  %scevgep249.us.3 = getelementptr i8, i8* %call, i64 %314
...
polly.loop_header388.us.1:                        ; preds = %polly.loop_header388.us.1, %polly.loop_exit390.loopexit.us
  ...
  %315 = add nuw nsw i64 %polly.indvar392.us.1, %153
  %316 = mul nuw nsw i64 %315, 8000
  %317 = add nuw nsw i64 %316, %149
  %scevgep395.us.1 = getelementptr i8, i8* %call1, i64 %317
  ...
  %scevgep401.us.1 = getelementptr i8, i8* %call2, i64 %317
  ...
  %318 = shl i64 %315, 3
  %319 = add i64 %318, %162
  %scevgep407.us.1 = getelementptr i8, i8* %call, i64 %319
  ...
  %exitcond816.1.not = icmp eq i64 %polly.indvar392.us.1, %smin815
  br i1 %exitcond816.1.not, label %polly.loop_exit390.loopexit.us.1, label %polly.loop_header388.us.1

polly.loop_exit390.loopexit.us.1:                 ; preds = %polly.loop_header388.us.1
  %320 = add i64 %151, %161
  %scevgep398.us.2 = getelementptr i8, i8* %call2, i64 %320
  ...
  %scevgep404.us.2 = getelementptr i8, i8* %call1, i64 %320
...
polly.loop_header388.us.2:                        ; preds = %polly.loop_header388.us.2, %polly.loop_exit390.loopexit.us.1
  ...
  %321 = add nuw nsw i64 %polly.indvar392.us.2, %153
  %322 = mul nuw nsw i64 %321, 8000
  %323 = add nuw nsw i64 %322, %151
  %scevgep395.us.2 = getelementptr i8, i8* %call1, i64 %323
  ...
  %scevgep401.us.2 = getelementptr i8, i8* %call2, i64 %323
  ...
  %324 = shl i64 %321, 3
  %325 = add i64 %324, %162
  %scevgep407.us.2 = getelementptr i8, i8* %call, i64 %325
  ...
  %exitcond816.2.not = icmp eq i64 %polly.indvar392.us.2, %smin815
  br i1 %exitcond816.2.not, label %polly.loop_exit390.loopexit.us.2, label %polly.loop_header388.us.2

polly.loop_exit390.loopexit.us.2:                 ; preds = %polly.loop_header388.us.2
  %326 = add i64 %152, %161
  %scevgep398.us.3 = getelementptr i8, i8* %call2, i64 %326
  ...
  %scevgep404.us.3 = getelementptr i8, i8* %call1, i64 %326
...
polly.loop_header388.us.3:                        ; preds = %polly.loop_header388.us.3, %polly.loop_exit390.loopexit.us.2
  ...
  %327 = add nuw nsw i64 %polly.indvar392.us.3, %153
  %328 = mul nuw nsw i64 %327, 8000
  %329 = add nuw nsw i64 %328, %152
  %scevgep395.us.3 = getelementptr i8, i8* %call1, i64 %329
  ...
  %scevgep401.us.3 = getelementptr i8, i8* %call2, i64 %329
  ...
  %330 = shl i64 %327, 3
  %331 = add i64 %330, %162
  %scevgep407.us.3 = getelementptr i8, i8* %call, i64 %331
  ...
  %exitcond816.3.not = icmp eq i64 %polly.indvar392.us.3, %smin815
  br i1 %exitcond816.3.not, label %polly.loop_exit383, label %polly.loop_header388.us.3
...
polly.loop_header546.us.1:                        ; preds = %polly.loop_header546.us.1, %polly.loop_exit548.loopexit.us
  ...
  %332 = add nuw nsw i64 %polly.indvar550.us.1, %194
  %333 = mul nuw nsw i64 %332, 8000
  %334 = add nuw nsw i64 %333, %190
  %scevgep553.us.1 = getelementptr i8, i8* %call1, i64 %334
  ...
  %scevgep559.us.1 = getelementptr i8, i8* %call2, i64 %334
  ...
  %335 = shl i64 %332, 3
  %336 = add i64 %335, %203
  %scevgep565.us.1 = getelementptr i8, i8* %call, i64 %336
  ...
  %exitcond840.1.not = icmp eq i64 %polly.indvar550.us.1, %smin839
  br i1 %exitcond840.1.not, label %polly.loop_exit548.loopexit.us.1, label %polly.loop_header546.us.1

polly.loop_exit548.loopexit.us.1:                 ; preds = %polly.loop_header546.us.1
  %337 = add i64 %192, %202
  %scevgep556.us.2 = getelementptr i8, i8* %call2, i64 %337
  ...
  %scevgep562.us.2 = getelementptr i8, i8* %call1, i64 %337
...
polly.loop_header546.us.2:                        ; preds = %polly.loop_header546.us.2, %polly.loop_exit548.loopexit.us.1
  ...
  %338 = add nuw nsw i64 %polly.indvar550.us.2, %194
  %339 = mul nuw nsw i64 %338, 8000
  %340 = add nuw nsw i64 %339, %192
  %scevgep553.us.2 = getelementptr i8, i8* %call1, i64 %340
  ...
  %scevgep559.us.2 = getelementptr i8, i8* %call2, i64 %340
  ...
  %341 = shl i64 %338, 3
  %342 = add i64 %341, %203
  %scevgep565.us.2 = getelementptr i8, i8* %call, i64 %342
  ...
  %exitcond840.2.not = icmp eq i64 %polly.indvar550.us.2, %smin839
  br i1 %exitcond840.2.not, label %polly.loop_exit548.loopexit.us.2, label %polly.loop_header546.us.2

polly.loop_exit548.loopexit.us.2:                 ; preds = %polly.loop_header546.us.2
  %343 = add i64 %193, %202
  %scevgep556.us.3 = getelementptr i8, i8* %call2, i64 %343
  ...
  %scevgep562.us.3 = getelementptr i8, i8* %call1, i64 %343
...
polly.loop_header546.us.3:                        ; preds = %polly.loop_header546.us.3, %polly.loop_exit548.loopexit.us.2
  ...
  %344 = add nuw nsw i64 %polly.indvar550.us.3, %194
  %345 = mul nuw nsw i64 %344, 8000
  %346 = add nuw nsw i64 %345, %193
  %scevgep553.us.3 = getelementptr i8, i8* %call1, i64 %346
  ...
  %scevgep559.us.3 = getelementptr i8, i8* %call2, i64 %346
  ...
  %347 = shl i64 %344, 3
  %348 = add i64 %347, %203
  %scevgep565.us.3 = getelementptr i8, i8* %call, i64 %348
  ...
  %exitcond840.3.not = icmp eq i64 %polly.indvar550.us.3, %smin839
  br i1 %exitcond840.3.not, label %polly.loop_exit541, label %polly.loop_header546.us.3
}
