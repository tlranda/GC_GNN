; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2863.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2863.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit250
  ...
  %exitcond1024.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %152 = shl nuw nsw i64 %polly.indvar400, 1
  %153 = add nuw nsw i64 %152, %147
  %154 = mul nsw i64 %polly.indvar400, -20
  %155 = mul nuw nsw i64 %polly.indvar400, 20
...
polly.loop_exit406:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar_next401, 60
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  ...
  %.inv883 = icmp sgt i64 %158, 19
  %160 = select i1 %.inv883, i64 19, i64 %159
...
polly.loop_header450.us:                          ; preds = %polly.loop_header443.us, %polly.loop_exit460.us
  ...
  %smin1048 = call i64 @llvm.smin.i64(i64 %indvars.iv1046, i64 19)
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %200 = shl nuw nsw i64 %polly.indvar595, 1
  %201 = add nuw nsw i64 %200, %195
  %202 = mul nsw i64 %polly.indvar595, -20
  %203 = mul nuw nsw i64 %polly.indvar595, 20
  br label %polly.loop_header599

polly.loop_exit601:                               ; preds = %polly.loop_exit640
  %polly.indvar_next596 = add nuw nsw i64 %polly.indvar595, 1
  %indvars.iv.next1064 = add nuw nsw i64 %indvars.iv1063, 20
  %indvars.iv.next1066 = add nuw nsw i64 %indvars.iv1065, 2
  %indvars.iv.next1071 = add nsw i64 %indvars.iv1070, -20
  %exitcond1080.not = icmp eq i64 %polly.indvar_next596, 60
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  ...
  %.inv884 = icmp sgt i64 %206, 19
  %208 = select i1 %.inv884, i64 19, i64 %207
...
polly.loop_header645.us:                          ; preds = %polly.loop_header638.us, %polly.loop_exit655.us
  ...
  %smin1076 = call i64 @llvm.smin.i64(i64 %indvars.iv1074, i64 19)
