; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4337.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4337.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next988 = add nuw nsw i64 %indvars.iv987, 16
  %exitcond1002.not = icmp eq i64 %polly.indvar_next203, 75
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit220
  ...
  %103 = mul nuw nsw i64 %polly.indvar214, 20
  %104 = add nsw i64 %103, %99
  %105 = icmp sgt i64 %104, 0
  %106 = select i1 %105, i64 %104, i64 0
  %polly.loop_guard221 = icmp slt i64 %106, 16
...
polly.loop_header218.preheader:                   ; preds = %polly.loop_header211
  ...
  %107 = add i64 %smax, %indvars.iv989
  %108 = sub nsw i64 %100, %103
  %109 = add nuw nsw i64 %103, 20
...
polly.loop_header218:                             ; preds = %polly.loop_header218.preheader, %polly.loop_exit252
  %indvars.iv991 = phi i64 [ %107, %polly.loop_header218.preheader ], [ %indvars.iv.next992, %polly.loop_exit252 ]
  %polly.indvar222 = phi i64 [ %106, %polly.loop_header218.preheader ], [ %polly.indvar_next223, %polly.loop_exit252 ]
  %smin997 = call i64 @llvm.smin.i64(i64 %indvars.iv991, i64 19)
  %110 = add nsw i64 %polly.indvar222, %108
  %polly.loop_guard2351093 = icmp sgt i64 %110, -1
  %111 = add nuw nsw i64 %polly.indvar222, %100
...
polly.merge.us:                                   ; preds = %polly.then.us, %polly.cond.loopexit.us
  ...
  %exitcond996.not = icmp eq i64 %polly.indvar_next229.us, %101
...
polly.loop_header225:                             ; preds = %polly.loop_header218.split, %polly.loop_header225
  ...
  %exitcond.not = icmp eq i64 %polly.indvar_next229, %101
...
polly.loop_exit259.loopexit.us:                   ; preds = %polly.loop_header257.us
  ...
  %exitcond1000.not = icmp eq i64 %polly.indvar_next254.us, %101
...
vector.body1207:                                  ; preds = %vector.body1207, %vector.ph1211
  ...
  %wide.load1218 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %132, label %middle.block1205, label %vector.body1207, !llvm.loop !80
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %134 = add nuw nsw i64 %polly.indvar388, 6
  %pexp.p_div_q397 = udiv i64 %134, 5
  %135 = sub nsw i64 %polly.indvar388, %pexp.p_div_q397
  %polly.loop_guard402 = icmp sgt i64 %135, -2
  %136 = mul nsw i64 %polly.indvar388, -16
  %137 = shl nsw i64 %polly.indvar388, 4
...
polly.loop_exit393:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next1010 = add nsw i64 %indvars.iv1009, -16
  %indvars.iv.next1015 = add nuw nsw i64 %indvars.iv1014, 16
  %exitcond1029.not = icmp eq i64 %polly.indvar_next389, 75
...
polly.loop_header399.preheader:                   ; preds = %polly.loop_header391
  %139 = shl nsw i64 %polly.indvar394, 7
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %140 = mul nuw nsw i64 %polly.indvar403, 20
  %141 = add nsw i64 %140, %136
  %142 = icmp sgt i64 %141, 0
  %143 = select i1 %142, i64 %141, i64 0
  %polly.loop_guard410 = icmp slt i64 %143, 16
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit445
  %indvars.iv1018 = phi i64 [ %144, %polly.loop_header407.preheader ], [ %indvars.iv.next1019, %polly.loop_exit445 ]
  ...
  %polly.loop_guard4241094 = icmp sgt i64 %147, -1
  %148 = add nuw nsw i64 %polly.indvar411, %137
...
polly.merge433.us:                                ; preds = %polly.then434.us, %polly.cond432.loopexit.us
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next418.us, %138
...
polly.loop_header414:                             ; preds = %polly.loop_header407.split, %polly.loop_header414
  ...
  %exitcond1008.not = icmp eq i64 %polly.indvar_next418, %138
...
polly.loop_exit452.loopexit.us:                   ; preds = %polly.loop_header450.us
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next447.us, %138
...
vector.body1183:                                  ; preds = %vector.body1183, %vector.ph1185
  ...
  %wide.load1192 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %169, label %middle.block1181, label %vector.body1183, !llvm.loop !90
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %171 = add nuw nsw i64 %polly.indvar581, 6
  %pexp.p_div_q590 = udiv i64 %171, 5
  %172 = sub nsw i64 %polly.indvar581, %pexp.p_div_q590
  %polly.loop_guard595 = icmp sgt i64 %172, -2
  %173 = mul nsw i64 %polly.indvar581, -16
  %174 = shl nsw i64 %polly.indvar581, 4
...
polly.loop_exit586:                               ; preds = %polly.loop_exit594
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next582, 75
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %176 = shl nsw i64 %polly.indvar587, 7
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %177 = mul nuw nsw i64 %polly.indvar596, 20
  %178 = add nsw i64 %177, %173
  %179 = icmp sgt i64 %178, 0
  %180 = select i1 %179, i64 %178, i64 0
  %polly.loop_guard603 = icmp slt i64 %180, 16
...
polly.loop_exit602:                               ; preds = %polly.loop_exit638, %polly.loop_header592
  ...
  %polly.loop_cond598.not = icmp sgt i64 %polly.indvar596, %172
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_exit638
  %indvars.iv1045 = phi i64 [ %181, %polly.loop_header600.preheader ], [ %indvars.iv.next1046, %polly.loop_exit638 ]
  %polly.indvar604 = phi i64 [ %180, %polly.loop_header600.preheader ], [ %polly.indvar_next605, %polly.loop_exit638 ]
  %smin1051 = call i64 @llvm.smin.i64(i64 %indvars.iv1045, i64 19)
  %184 = add nsw i64 %polly.indvar604, %182
  %polly.loop_guard6171095 = icmp sgt i64 %184, -1
  %185 = add nuw nsw i64 %polly.indvar604, %174
...
polly.merge626.us:                                ; preds = %polly.then627.us, %polly.cond625.loopexit.us
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar_next611.us, %175
...
polly.loop_header607:                             ; preds = %polly.loop_header600.split, %polly.loop_header607
  ...
  %exitcond1035.not = icmp eq i64 %polly.indvar_next611, %175
...
polly.loop_exit645.loopexit.us:                   ; preds = %polly.loop_header643.us
  ...
  %exitcond1054.not = icmp eq i64 %polly.indvar_next640.us, %175
...
vector.body1122:                                  ; preds = %vector.body1122, %vector.ph1123
  ...
  br i1 %220, label %polly.loop_exit813, label %vector.body1122, !llvm.loop !99

polly.loop_exit813:                               ; preds = %vector.body1122, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond1086.not = icmp eq i64 %polly.indvar808, %200
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar814, %204
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  br i1 %249, label %polly.loop_exit840, label %vector.body1136, !llvm.loop !102

polly.loop_exit840:                               ; preds = %vector.body1136, %polly.loop_header838
  %polly.indvar_next836 = add nuw nsw i64 %polly.indvar835, 1
  %exitcond1076.not = icmp eq i64 %polly.indvar835, %229
...
polly.loop_header838:                             ; preds = %polly.loop_header832, %polly.loop_header838
  ...
  %exitcond1072.not = icmp eq i64 %polly.indvar841, %233
...
vector.body1154:                                  ; preds = %vector.body1154, %vector.ph1157
  ...
  br i1 %278, label %polly.loop_exit866, label %vector.body1154, !llvm.loop !105

polly.loop_exit866:                               ; preds = %vector.body1154, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1066.not = icmp eq i64 %polly.indvar861, %258
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar867, %262
