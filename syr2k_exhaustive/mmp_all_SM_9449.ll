; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9449.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9449.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next786 = add nuw nsw i64 %indvars.iv785, 8
  %indvars.iv.next793 = add nuw nsw i64 %indvars.iv792, 2
  %exitcond796.not = icmp eq i64 %polly.indvar_next203, 150
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %polly.loop_guard = icmp slt i64 %117, 8
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %140 = mul nsw i64 %polly.indvar357, -8
  %141 = shl nsw i64 %polly.indvar357, 3
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit368
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next800 = add nsw i64 %indvars.iv799, -8
  %indvars.iv.next805 = add nuw nsw i64 %indvars.iv804, 8
  %indvars.iv.next814 = add nuw nsw i64 %indvars.iv813, 2
  %exitcond817.not = icmp eq i64 %polly.indvar_next358, 150
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %polly.loop_guard376 = icmp slt i64 %160, 8
...
polly.loop_exit382:                               ; preds = %polly.loop_header387.us.7, %polly.loop_header373
  ...
  %polly.loop_cond379 = icmp ult i64 %polly.indvar377, 7
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %183 = mul nsw i64 %polly.indvar514, -8
  %184 = shl nsw i64 %polly.indvar514, 3
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %polly.loop_guard533 = icmp slt i64 %203, 8
...
polly.loop_exit539:                               ; preds = %polly.loop_header544.us.7, %polly.loop_header530
  ...
  %polly.loop_cond536 = icmp ult i64 %polly.indvar534, 7
