; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10124.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10124.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar_next209, 13
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1003
  ...
  %wide.load1010 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %129, label %middle.block997, label %vector.body999, !llvm.loop !74
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.loop_header354
  ...
  %smin817 = call i64 @llvm.smin.i64(i64 %indvars.iv815, i64 -920)
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375
  ...
  %indvars.iv.next816 = add nsw i64 %indvars.iv815, -80
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph977
  ...
  %wide.load984 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %163, label %middle.block973, label %vector.body975, !llvm.loop !83
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar_next521, 13
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph915
  ...
  br i1 %211, label %polly.loop_exit712, label %vector.body913, !llvm.loop !92
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph931
  ...
  br i1 %240, label %polly.loop_exit739, label %vector.body928, !llvm.loop !95
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph949
  ...
  br i1 %269, label %polly.loop_exit765, label %vector.body946, !llvm.loop !98
