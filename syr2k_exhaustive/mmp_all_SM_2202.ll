; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2202.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2202.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1052 = phi i64 [ %indvars.iv.next1053, %polly.loop_exit224 ], [ 5, %polly.loop_exit208 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1053 = add nuw nsw i64 %indvars.iv1052, 5
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %105 = mul nsw i64 %polly.indvar231, -16
  %106 = add i64 %98, %105
  %107 = add i64 %smax1358, %106
  %108 = shl nsw i64 %polly.indvar231, 4
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1361 = call i64 @llvm.smin.i64(i64 %115, i64 15)
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  %indvars.iv1084 = phi i64 [ %indvars.iv.next1085, %polly.loop_exit428 ], [ 5, %polly.loop_exit412 ]
...
polly.loop_exit428:                               ; preds = %polly.loop_exit434
  ...
  %indvars.iv.next1085 = add nuw nsw i64 %indvars.iv1084, 5
...
polly.loop_header432:                             ; preds = %polly.loop_exit441, %polly.loop_header426
  ...
  %160 = shl nuw nsw i64 %polly.indvar435, 4
  %161 = add i64 %154, %160
  %smax1310 = call i64 @llvm.smax.i64(i64 %161, i64 0)
  %162 = mul nsw i64 %polly.indvar435, -16
  %163 = add i64 %155, %162
  %164 = add i64 %smax1310, %163
  %165 = shl nsw i64 %polly.indvar435, 4
...
polly.loop_header439:                             ; preds = %polly.loop_header439.preheader, %polly.loop_exit477
  ...
  %smin1313 = call i64 @llvm.smin.i64(i64 %172, i64 15)
...
polly.loop_header630:                             ; preds = %polly.loop_exit622, %polly.loop_exit638
  %indvars.iv1116 = phi i64 [ %indvars.iv.next1117, %polly.loop_exit638 ], [ 5, %polly.loop_exit622 ]
...
polly.loop_exit638:                               ; preds = %polly.loop_exit644
  ...
  %indvars.iv.next1117 = add nuw nsw i64 %indvars.iv1116, 5
...
polly.loop_header642:                             ; preds = %polly.loop_exit651, %polly.loop_header636
  ...
  %217 = shl nuw nsw i64 %polly.indvar645, 4
  %218 = add i64 %211, %217
  %smax1262 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar645, -16
  %220 = add i64 %212, %219
  %221 = add i64 %smax1262, %220
  %222 = shl nsw i64 %polly.indvar645, 4
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit687
  ...
  %smin1265 = call i64 @llvm.smin.i64(i64 %229, i64 15)
  %230 = add nsw i64 %smin1265, 1
  %smin1112 = call i64 @llvm.smin.i64(i64 %indvars.iv1106, i64 15)
