; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7378.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7378.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond826.not = icmp eq i64 %polly.indvar_next219, 24
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header227
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next231, 50
...
polly.loop_header384:                             ; preds = %polly.loop_exit376, %polly.loop_exit393
  ...
  %119 = lshr i64 %polly.indvar387, 1
  %120 = mul nuw nsw i64 %polly.indvar387, 50
...
polly.loop_exit393:                               ; preds = %polly.loop_exit399
  ...
  %indvars.iv.next832 = add nuw nsw i64 %indvars.iv831, 50
  %exitcond842.not = icmp eq i64 %polly.indvar_next388, 24
...
polly.loop_header391:                             ; preds = %polly.loop_exit399, %polly.loop_header384
  ...
  %121 = mul nuw nsw i64 %polly.indvar394, 100
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412.loopexit.us, %polly.loop_header397
  ...
  %exitcond840.not = icmp eq i64 %polly.indvar_next401, 50
...
polly.loop_header556:                             ; preds = %polly.loop_exit548, %polly.loop_exit565
  ...
  %141 = lshr i64 %polly.indvar559, 1
  %142 = mul nuw nsw i64 %polly.indvar559, 50
...
polly.loop_exit565:                               ; preds = %polly.loop_exit571
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar_next560, 24
...
polly.loop_header563:                             ; preds = %polly.loop_exit571, %polly.loop_header556
  ...
  %143 = mul nuw nsw i64 %polly.indvar566, 100
...
polly.loop_exit577:                               ; preds = %polly.loop_exit584.loopexit.us, %polly.loop_header569
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next573, 50
