; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7644.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7644.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %119 = shl nsw i64 %polly.indvar230, 8
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %145 = lshr i64 %indvars.iv869, 3
  %146 = mul nsw i64 %polly.indvar393, -96
  %147 = icmp slt i64 %146, -1104
  %148 = select i1 %147, i64 %146, i64 -1104
  %149 = add nsw i64 %148, 1199
  %150 = mul nuw nsw i64 %polly.indvar393, 96
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %167 = shl nsw i64 %polly.indvar406, 8
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar406, %145
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  ...
  %polly.loop_guard427933 = icmp sgt i64 %173, -1
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %193 = lshr i64 %indvars.iv892, 3
  %194 = mul nsw i64 %polly.indvar571, -96
  %195 = icmp slt i64 %194, -1104
  %196 = select i1 %195, i64 %194, i64 -1104
  %197 = add nsw i64 %196, 1199
  %198 = mul nuw nsw i64 %polly.indvar571, 96
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %215 = shl nsw i64 %polly.indvar584, 8
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %exitcond894.not = icmp eq i64 %polly.indvar584, %193
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv887 = phi i64 [ %219, %polly.loop_header588.preheader ], [ %indvars.iv.next888, %polly.loop_exit597 ]
  ...
  %polly.loop_guard605934 = icmp sgt i64 %221, -1
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph957
  ...
  br i1 %253, label %polly.loop_exit772, label %vector.body955, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body955, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond928.not = icmp eq i64 %polly.indvar767, %233
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond924.not = icmp eq i64 %polly.indvar773, %237
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  br i1 %282, label %polly.loop_exit799, label %vector.body970, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body970, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond918.not = icmp eq i64 %polly.indvar794, %262
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond914.not = icmp eq i64 %polly.indvar800, %266
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  br i1 %311, label %polly.loop_exit825, label %vector.body988, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body988, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond908.not = icmp eq i64 %polly.indvar820, %291
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar826, %295
