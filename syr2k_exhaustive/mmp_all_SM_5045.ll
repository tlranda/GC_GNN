; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5045.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5045.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next980 = add nsw i64 %indvars.iv979, -96
  %indvars.iv.next984 = add nuw nsw i64 %indvars.iv983, 96
  %exitcond999.not = icmp eq i64 %polly.indvar_next203, 13
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %106 = mul nsw i64 %polly.indvar214, 80
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  %indvars.iv987 = phi i64 [ %110, %polly.loop_header217.preheader ], [ %indvars.iv.next988, %polly.loop_exit250 ]
  %polly.indvar220 = phi i64 [ %109, %polly.loop_header217.preheader ], [ %polly.indvar_next221, %polly.loop_exit250 ]
  %smin993 = call i64 @llvm.smin.i64(i64 %indvars.iv987, i64 79)
  %113 = add nsw i64 %polly.indvar220, %111
  %polly.loop_guard2331092 = icmp sgt i64 %113, -1
  %114 = add nuw nsw i64 %polly.indvar220, %102
...
polly.then.us:                                    ; preds = %polly.cond.loopexit.us
  %polly.access.add.call1243.us = add i64 %115, %polly.indvar226.us
...
polly.merge.us:                                   ; preds = %polly.then.us, %polly.cond.loopexit.us
  ...
  %exitcond992.not = icmp eq i64 %polly.indvar_next227.us, %104
...
polly.loop_header223:                             ; preds = %polly.loop_header217.split, %polly.loop_header223
  ...
  %polly.access.add.call1243 = add i64 %115, %polly.indvar226
  ...
  %exitcond.not = icmp eq i64 %polly.indvar_next227, %104
...
polly.loop_exit257.loopexit.us:                   ; preds = %polly.loop_header255.us
  ...
  %exitcond996.not = icmp eq i64 %polly.indvar_next252.us, %104
...
vector.body1208:                                  ; preds = %vector.body1208, %vector.ph1212
  ...
  %wide.load1219 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %135, label %middle.block1206, label %vector.body1208, !llvm.loop !79
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %137 = add nuw nsw i64 %pexp.p_div_q395, %polly.indvar386
  %.inv867 = icmp ult i64 %137, 14
  %138 = mul nsw i64 %polly.indvar386, -96
  %139 = icmp slt i64 %138, -1104
  %140 = select i1 %139, i64 %138, i64 -1104
  %141 = add nsw i64 %140, 1199
  %142 = mul nuw nsw i64 %polly.indvar386, 96
  %.op1093 = add nuw i64 %137, 2
  %143 = select i1 %.inv867, i64 %.op1093, i64 15
  br label %polly.loop_header389

polly.loop_exit391:                               ; preds = %polly.loop_exit398
  %polly.indvar_next387 = add nuw nsw i64 %polly.indvar386, 1
  %indvars.iv.next1007 = add nsw i64 %indvars.iv1006, -96
  %indvars.iv.next1012 = add nuw nsw i64 %indvars.iv1011, 96
  %exitcond1027.not = icmp eq i64 %polly.indvar_next387, 13
...
polly.loop_header389:                             ; preds = %polly.loop_exit398, %polly.loop_header383
  ...
  %144 = add nsw i64 %smin1023, 1000
  %145 = mul nuw nsw i64 %polly.indvar392, 80
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %146 = mul nsw i64 %polly.indvar399, 80
  %147 = add nsw i64 %146, %138
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %polly.loop_guard406.not = icmp sgt i64 %149, %141
...
polly.loop_header403.preheader:                   ; preds = %polly.loop_header396
  ...
  %150 = add i64 %smax1010, %indvars.iv1013
  %151 = sub nsw i64 %142, %146
  %152 = add nuw nsw i64 %146, 80
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  %polly.indvar_next400 = add nuw i64 %polly.indvar399, 1
  %indvars.iv.next1009 = add i64 %indvars.iv1008, 80
  %indvars.iv.next1014 = add i64 %indvars.iv1013, -80
  %exitcond1025.not = icmp eq i64 %polly.indvar_next400, %143
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  %indvars.iv1015 = phi i64 [ %150, %polly.loop_header403.preheader ], [ %indvars.iv.next1016, %polly.loop_exit441 ]
  ...
  %154 = add nuw nsw i64 %polly.indvar407, %142
  %.not868 = icmp ult i64 %154, %152
...
polly.loop_header417.us:                          ; preds = %polly.loop_header410.us, %polly.loop_header417.us
  ...
  %polly.access.mul.call1425.us = mul nsw i64 %157, 1000
...
polly.then430.us:                                 ; preds = %polly.cond428.loopexit.us
  %polly.access.add.call1434.us = add i64 %155, %polly.indvar413.us
...
polly.merge429.us:                                ; preds = %polly.then430.us, %polly.cond428.loopexit.us
  ...
  %exitcond1020.not = icmp eq i64 %polly.indvar_next414.us, %144
...
polly.loop_exit441:                               ; preds = %polly.loop_exit448.loopexit.us, %polly.loop_header403.split, %polly.loop_header439.preheader
  ...
  %polly.loop_cond409.not.not = icmp ult i64 %polly.indvar407, %141
...
polly.loop_header410:                             ; preds = %polly.loop_header403.split, %polly.loop_header410
  ...
  %polly.access.add.call1434 = add i64 %155, %polly.indvar413
  ...
  %exitcond1005.not = icmp eq i64 %polly.indvar_next414, %144
...
polly.loop_exit448.loopexit.us:                   ; preds = %polly.loop_header446.us
  ...
  %exitcond1024.not = icmp eq i64 %polly.indvar_next443.us, %144
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1186
  ...
  %wide.load1193 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %175, label %middle.block1182, label %vector.body1184, !llvm.loop !89
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %177 = add nuw nsw i64 %pexp.p_div_q586, %polly.indvar577
  %.inv869 = icmp ult i64 %177, 14
  %178 = mul nsw i64 %polly.indvar577, -96
  %179 = icmp slt i64 %178, -1104
  %180 = select i1 %179, i64 %178, i64 -1104
  %181 = add nsw i64 %180, 1199
  %182 = mul nuw nsw i64 %polly.indvar577, 96
  %.op1095 = add nuw i64 %177, 2
  %183 = select i1 %.inv869, i64 %.op1095, i64 15
...
polly.loop_exit582:                               ; preds = %polly.loop_exit589
  ...
  %indvars.iv.next1040 = add nuw nsw i64 %indvars.iv1039, 96
  %exitcond1055.not = icmp eq i64 %polly.indvar_next578, 13
...
polly.loop_header580:                             ; preds = %polly.loop_exit589, %polly.loop_header574
  ...
  %184 = add nsw i64 %smin1051, 1000
  %185 = mul nuw nsw i64 %polly.indvar583, 80
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %polly.loop_guard597.not = icmp sgt i64 %189, %181
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %indvars.iv.next1037 = add i64 %indvars.iv1036, 80
  %indvars.iv.next1042 = add i64 %indvars.iv1041, -80
  %exitcond1053.not = icmp eq i64 %polly.indvar_next591, %183
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1043 = phi i64 [ %190, %polly.loop_header594.preheader ], [ %indvars.iv.next1044, %polly.loop_exit632 ]
  %polly.indvar598 = phi i64 [ %189, %polly.loop_header594.preheader ], [ %polly.indvar_next599, %polly.loop_exit632 ]
  %smin1049 = call i64 @llvm.smin.i64(i64 %indvars.iv1043, i64 79)
  %193 = add nsw i64 %polly.indvar598, %191
  %polly.loop_guard6111096 = icmp sgt i64 %193, -1
  %194 = add nuw nsw i64 %polly.indvar598, %182
  %.not870 = icmp ult i64 %194, %192
...
polly.loop_header608.us:                          ; preds = %polly.loop_header601.us, %polly.loop_header608.us
  ...
  %polly.access.mul.call1616.us = mul nsw i64 %197, 1000
...
polly.then621.us:                                 ; preds = %polly.cond619.loopexit.us
  %polly.access.add.call1625.us = add i64 %195, %polly.indvar604.us
...
polly.merge620.us:                                ; preds = %polly.then621.us, %polly.cond619.loopexit.us
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar_next605.us, %184
...
polly.loop_header601:                             ; preds = %polly.loop_header594.split, %polly.loop_header601
  ...
  %polly.access.add.call1625 = add i64 %195, %polly.indvar604
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next605, %184
...
polly.loop_exit639.loopexit.us:                   ; preds = %polly.loop_header637.us
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar_next634.us, %184
...
vector.body1123:                                  ; preds = %vector.body1123, %vector.ph1124
  ...
  br i1 %229, label %polly.loop_exit807, label %vector.body1123, !llvm.loop !98

polly.loop_exit807:                               ; preds = %vector.body1123, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1085.not = icmp eq i64 %polly.indvar802, %209
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1081.not = icmp eq i64 %polly.indvar808, %213
...
vector.body1137:                                  ; preds = %vector.body1137, %vector.ph1140
  ...
  br i1 %258, label %polly.loop_exit834, label %vector.body1137, !llvm.loop !101

polly.loop_exit834:                               ; preds = %vector.body1137, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1075.not = icmp eq i64 %polly.indvar829, %238
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1071.not = icmp eq i64 %polly.indvar835, %242
...
vector.body1155:                                  ; preds = %vector.body1155, %vector.ph1158
  ...
  br i1 %287, label %polly.loop_exit860, label %vector.body1155, !llvm.loop !104

polly.loop_exit860:                               ; preds = %vector.body1155, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1065.not = icmp eq i64 %polly.indvar855, %267
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1061.not = icmp eq i64 %polly.indvar861, %271
