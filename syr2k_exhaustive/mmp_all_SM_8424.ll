; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8424.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8424.c"
...
vector.body909:                                   ; preds = %vector.body909, %vector.ph910
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call720, i64 %indvars.iv7.i, i64 %index911
...
vector.body972:                                   ; preds = %vector.body972, %vector.ph974
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call720, i64 %indvars.iv21.i, i64 %index977
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph997
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call720, i64 %indvars.iv21.i52, i64 %index1000
...
vector.body1021:                                  ; preds = %vector.body1021, %vector.ph1023
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call720, i64 %indvars.iv21.i91, i64 %index1026
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond806.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !68

polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv800 = phi i64 [ %indvars.iv.next801, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %polly.indvar202 = phi i64 [ %polly.indvar_next203, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %smin802 = call i64 @llvm.smin.i64(i64 %indvars.iv800, i64 -936)
  %97 = shl nsw i64 %polly.indvar202, 6
  %98 = add nsw i64 %smin802, 999
  br label %polly.loop_header205

polly.loop_exit207:                               ; preds = %polly.loop_exit213
  %polly.indvar_next203 = add nuw nsw i64 %polly.indvar202, 1
  %indvars.iv.next801 = add nsw i64 %indvars.iv800, -64
  %exitcond805.not = icmp eq i64 %polly.indvar_next203, 16
  br i1 %exitcond805.not, label %kernel_syr2k.exit129, label %polly.loop_header199

polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  %indvars.iv794 = phi i64 [ %indvars.iv.next795, %polly.loop_exit213 ], [ 0, %polly.loop_header199 ]
  ...
  %99 = udiv i64 %indvars.iv790, 5
  %100 = add nuw i64 %indvars.iv788, %99
  %101 = mul nuw nsw i64 %100, 20
  %102 = sub i64 %indvars.iv, %101
  %103 = add i64 %indvars.iv794, %101
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %indvars.iv.next795 = add nsw i64 %indvars.iv794, -128
  %exitcond804.not = icmp eq i64 %polly.indvar_next209, 10
  br i1 %exitcond804.not, label %polly.loop_exit207, label %polly.loop_header205

polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  %indvars.iv796 = phi i64 [ %indvars.iv.next797, %polly.loop_exit219 ], [ %103, %polly.loop_header205 ]
  %indvars.iv792 = phi i64 [ %indvars.iv.next793, %polly.loop_exit219 ], [ %102, %polly.loop_header205 ]
  %polly.indvar214 = phi i64 [ %polly.indvar_next215, %polly.loop_exit219 ], [ %105, %polly.loop_header205 ]
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv792, i64 0)
  %108 = add i64 %smax, %indvars.iv796
...
polly.loop_header223.us:                          ; preds = %polly.loop_header217.us, %polly.loop_exit232.us
  %indvars.iv798 = phi i64 [ %108, %polly.loop_header217.us ], [ %indvars.iv.next799, %polly.loop_exit232.us ]
  %polly.indvar226.us = phi i64 [ %112, %polly.loop_header217.us ], [ %polly.indvar_next227.us, %polly.loop_exit232.us ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv798, i64 127)
  %115 = add nuw i64 %polly.indvar226.us, %109
  %116 = add i64 %115, %107
  %polly.loop_guard233.us892 = icmp sgt i64 %116, -1
  br i1 %polly.loop_guard233.us892, label %polly.loop_header230.preheader.us, label %polly.loop_exit232.us
...
polly.loop_exit225.loopexit.us:                   ; preds = %polly.loop_exit232.us
  ...
  %exitcond803.not = icmp eq i64 %polly.indvar220.us, %98
  br i1 %exitcond803.not, label %polly.loop_exit219, label %polly.loop_header217.us
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225.loopexit.us, %polly.loop_header211
  ...
  %indvars.iv.next793 = add i64 %indvars.iv792, -20
...
polly.loop_header338:                             ; preds = %kernel_syr2k.exit, %polly.loop_exit346
  %indvar1008 = phi i64 [ %indvar.next1009, %polly.loop_exit346 ], [ 0, %kernel_syr2k.exit ]
  %polly.indvar341 = phi i64 [ %polly.indvar_next342, %polly.loop_exit346 ], [ 1, %kernel_syr2k.exit ]
  %125 = add i64 %indvar1008, 1
  %126 = mul nuw nsw i64 %polly.indvar341, 9600
  %scevgep350 = getelementptr i8, i8* %call, i64 %126
  %min.iters.check1010 = icmp ult i64 %125, 4
  br i1 %min.iters.check1010, label %polly.loop_header344.preheader, label %vector.ph1011

vector.ph1011:                                    ; preds = %polly.loop_header338
  %n.vec1013 = and i64 %125, -4
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1011
  ...
  %127 = shl nuw nsw i64 %index1014, 3
  %128 = getelementptr i8, i8* %scevgep350, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1018 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !72, !noalias !74
  %130 = fmul fast <4 x double> %wide.load1018, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1015, %n.vec1013
  br i1 %132, label %middle.block1005, label %vector.body1007, !llvm.loop !77

middle.block1005:                                 ; preds = %vector.body1007
  %cmp.n1017 = icmp eq i64 %125, %n.vec1013
  br i1 %cmp.n1017, label %polly.loop_exit346, label %polly.loop_header344.preheader

polly.loop_header344.preheader:                   ; preds = %polly.loop_header338, %middle.block1005
  %polly.indvar347.ph = phi i64 [ 0, %polly.loop_header338 ], [ %n.vec1013, %middle.block1005 ]
  br label %polly.loop_header344

polly.loop_exit346:                               ; preds = %polly.loop_header344, %middle.block1005
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond831.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !78
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %smin827 = call i64 @llvm.smin.i64(i64 %indvars.iv825, i64 -936)
  %134 = shl nsw i64 %polly.indvar357, 6
  %135 = add nsw i64 %smin827, 999
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit369
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next826 = add nsw i64 %indvars.iv825, -64
  %exitcond830.not = icmp eq i64 %polly.indvar_next358, 16
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %indvars.iv812 = phi i64 [ %indvars.iv.next813, %polly.loop_exit369 ], [ 0, %polly.loop_header354 ]
  ...
  %136 = udiv i64 %indvars.iv812, 5
  %137 = add nuw i64 %indvars.iv810, %136
  %138 = mul nuw nsw i64 %137, 20
  %139 = sub i64 %indvars.iv808, %138
  %140 = add i64 %indvars.iv817, %138
  %141 = mul nuw nsw i64 %polly.indvar363, 6
  %polly.indvar363.tr = trunc i64 %polly.indvar363 to i8
  %pexp.p_div_q366.lhs.trunc = shl i8 %polly.indvar363.tr, 1
  %pexp.p_div_q366775 = udiv i8 %pexp.p_div_q366.lhs.trunc, 5
  %pexp.p_div_q366.zext = zext i8 %pexp.p_div_q366775 to i64
  %142 = add nuw nsw i64 %141, %pexp.p_div_q366.zext
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next364, 10
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv819 = phi i64 [ %indvars.iv.next820, %polly.loop_exit375 ], [ %140, %polly.loop_header360 ]
  %indvars.iv814 = phi i64 [ %indvars.iv.next815, %polly.loop_exit375 ], [ %139, %polly.loop_header360 ]
  ...
  %145 = add i64 %smax816, %indvars.iv819
  %146 = mul nuw nsw i64 %polly.indvar370, 20
  %147 = sub nsw i64 %143, %146
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %polly.loop_guard383 = icmp slt i64 %149, 20
...
polly.loop_header380.us:                          ; preds = %polly.loop_header373.us, %polly.loop_exit390.us
  %indvars.iv821 = phi i64 [ %145, %polly.loop_header373.us ], [ %indvars.iv.next822, %polly.loop_exit390.us ]
  %polly.indvar384.us = phi i64 [ %149, %polly.loop_header373.us ], [ %polly.indvar_next385.us, %polly.loop_exit390.us ]
  %smin823 = call i64 @llvm.smin.i64(i64 %indvars.iv821, i64 127)
  %152 = add nuw i64 %polly.indvar384.us, %146
  %153 = add i64 %152, %144
  %polly.loop_guard391.us893 = icmp sgt i64 %153, -1
  br i1 %polly.loop_guard391.us893, label %polly.loop_header388.preheader.us, label %polly.loop_exit390.us
...
polly.loop_header388.us:                          ; preds = %polly.loop_header388.preheader.us, %polly.loop_header388.us
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar392.us, %smin823
  br i1 %exitcond824.not, label %polly.loop_exit390.us, label %polly.loop_header388.us
...
polly.loop_exit382.loopexit.us:                   ; preds = %polly.loop_exit390.us
  ...
  %exitcond828.not = icmp eq i64 %polly.indvar376.us, %135
  br i1 %exitcond828.not, label %polly.loop_exit375, label %polly.loop_header373.us
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382.loopexit.us, %polly.loop_header367
  ...
  %indvars.iv.next815 = add i64 %indvars.iv814, -20
...
polly.loop_header496:                             ; preds = %init_array.exit, %polly.loop_exit504
  ...
  %min.iters.check984 = icmp ult i64 %162, 4
  br i1 %min.iters.check984, label %polly.loop_header502.preheader, label %vector.ph985

vector.ph985:                                     ; preds = %polly.loop_header496
  %n.vec987 = and i64 %162, -4
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph985
  ...
  %164 = shl nuw nsw i64 %index988, 3
  %165 = getelementptr i8, i8* %scevgep508, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load992 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !81, !noalias !83
  %167 = fmul fast <4 x double> %wide.load992, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next989, %n.vec987
  br i1 %169, label %middle.block981, label %vector.body983, !llvm.loop !86

middle.block981:                                  ; preds = %vector.body983
  %cmp.n991 = icmp eq i64 %162, %n.vec987
  br i1 %cmp.n991, label %polly.loop_exit504, label %polly.loop_header502.preheader

polly.loop_header502.preheader:                   ; preds = %polly.loop_header496, %middle.block981
  %polly.indvar505.ph = phi i64 [ 0, %polly.loop_header496 ], [ %n.vec987, %middle.block981 ]
  br label %polly.loop_header502

polly.loop_exit504:                               ; preds = %polly.loop_header502, %middle.block981
  %polly.indvar_next500 = add nuw nsw i64 %polly.indvar499, 1
  %exitcond857.not = icmp eq i64 %polly.indvar_next500, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond857.not, label %polly.loop_header512, label %polly.loop_header496
...
polly.loop_header502:                             ; preds = %polly.loop_header502.preheader, %polly.loop_header502
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next506, %polly.indvar499
  br i1 %exitcond856.not, label %polly.loop_exit504, label %polly.loop_header502, !llvm.loop !87
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %smin852 = call i64 @llvm.smin.i64(i64 %indvars.iv850, i64 -936)
  %171 = shl nsw i64 %polly.indvar515, 6
  %172 = add nsw i64 %smin852, 999
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next851 = add nsw i64 %indvars.iv850, -64
  %exitcond855.not = icmp eq i64 %polly.indvar_next516, 16
  br i1 %exitcond855.not, label %kernel_syr2k.exit, label %polly.loop_header512
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %indvars.iv837 = phi i64 [ %indvars.iv.next838, %polly.loop_exit527 ], [ 0, %polly.loop_header512 ]
  ...
  %173 = udiv i64 %indvars.iv837, 5
  %174 = add nuw i64 %indvars.iv835, %173
  %175 = mul nuw nsw i64 %174, 20
  %176 = sub i64 %indvars.iv833, %175
  %177 = add i64 %indvars.iv842, %175
  %178 = mul nuw nsw i64 %polly.indvar521, 6
  %polly.indvar521.tr = trunc i64 %polly.indvar521 to i8
  %pexp.p_div_q524.lhs.trunc = shl i8 %polly.indvar521.tr, 1
  %pexp.p_div_q524774 = udiv i8 %pexp.p_div_q524.lhs.trunc, 5
  %pexp.p_div_q524.zext = zext i8 %pexp.p_div_q524774 to i64
  %179 = add nuw nsw i64 %178, %pexp.p_div_q524.zext
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next834 = add nuw nsw i64 %indvars.iv833, 128
  %indvars.iv.next836 = add nuw nsw i64 %indvars.iv835, 6
  %indvars.iv.next838 = add nuw nsw i64 %indvars.iv837, 2
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -128
  %exitcond854.not = icmp eq i64 %polly.indvar_next522, 10
  br i1 %exitcond854.not, label %polly.loop_exit520, label %polly.loop_header518

polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv844 = phi i64 [ %indvars.iv.next845, %polly.loop_exit533 ], [ %177, %polly.loop_header518 ]
  %indvars.iv839 = phi i64 [ %indvars.iv.next840, %polly.loop_exit533 ], [ %176, %polly.loop_header518 ]
  ...
  %182 = add i64 %smax841, %indvars.iv844
  %183 = mul nuw nsw i64 %polly.indvar528, 20
  %184 = sub nsw i64 %180, %183
  %185 = icmp sgt i64 %184, 0
  %186 = select i1 %185, i64 %184, i64 0
  %polly.loop_guard541 = icmp slt i64 %186, 20
...
polly.loop_header538.us:                          ; preds = %polly.loop_header531.us, %polly.loop_exit548.us
  %indvars.iv846 = phi i64 [ %182, %polly.loop_header531.us ], [ %indvars.iv.next847, %polly.loop_exit548.us ]
  ...
  %190 = add i64 %189, %181
  %polly.loop_guard549.us894 = icmp sgt i64 %190, -1
  br i1 %polly.loop_guard549.us894, label %polly.loop_header546.preheader.us, label %polly.loop_exit548.us
...
polly.loop_header546.us:                          ; preds = %polly.loop_header546.preheader.us, %polly.loop_header546.us
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar550.us, %smin848
  br i1 %exitcond849.not, label %polly.loop_exit548.us, label %polly.loop_header546.us
...
polly.loop_exit540.loopexit.us:                   ; preds = %polly.loop_exit548.us
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar534.us, %172
  br i1 %exitcond853.not, label %polly.loop_exit533, label %polly.loop_header531.us
...
polly.loop_header694:                             ; preds = %entry, %polly.loop_exit702
  %indvars.iv882 = phi i64 [ %indvars.iv.next883, %polly.loop_exit702 ], [ 0, %entry ]
...
polly.loop_exit702:                               ; preds = %polly.loop_exit708
  ...
  %exitcond887.not = icmp eq i64 %polly.indvar_next698, 38
  br i1 %exitcond887.not, label %polly.loop_header721, label %polly.loop_header694

polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  %indvars.iv878 = phi i64 [ %indvars.iv.next879, %polly.loop_exit708 ], [ 0, %polly.loop_header694 ]
  %polly.indvar703 = phi i64 [ %polly.indvar_next704, %polly.loop_exit708 ], [ 0, %polly.loop_header694 ]
  %201 = mul nsw i64 %polly.indvar703, -32
  %smin922 = call i64 @llvm.smin.i64(i64 %201, i64 -1168)
  %202 = add nsw i64 %smin922, 1200
  %smin880 = call i64 @llvm.smin.i64(i64 %indvars.iv878, i64 -1168)
  %203 = shl nsw i64 %polly.indvar703, 5
  %204 = add nsw i64 %smin880, 1199
...
polly.loop_exit708:                               ; preds = %polly.loop_exit714
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar_next704, 38
  br i1 %exitcond886.not, label %polly.loop_exit702, label %polly.loop_header700
...
polly.loop_header706:                             ; preds = %polly.loop_exit714, %polly.loop_header700
  ...
  br i1 %min.iters.check, label %polly.loop_header712, label %vector.ph923

vector.ph923:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert930 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat931 = shufflevector <4 x i64> %broadcast.splatinsert930, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert932 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph923
  ...
  %208 = add nuw nsw <4 x i64> %vec.ind928, %broadcast.splat931
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat933, %209
  ...
  %220 = icmp eq i64 %index.next925, %202
  br i1 %220, label %polly.loop_exit714, label %vector.body921, !llvm.loop !95

polly.loop_exit714:                               ; preds = %vector.body921, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond885.not = icmp eq i64 %polly.indvar709, %200
  br i1 %exitcond885.not, label %polly.loop_exit708, label %polly.loop_header706
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar715, %204
  br i1 %exitcond881.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !96

polly.loop_header721:                             ; preds = %polly.loop_exit702, %polly.loop_exit729
  %indvars.iv872 = phi i64 [ %indvars.iv.next873, %polly.loop_exit729 ], [ 0, %polly.loop_exit702 ]
...
polly.loop_exit729:                               ; preds = %polly.loop_exit735
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar_next725, 38
  br i1 %exitcond877.not, label %polly.loop_header747, label %polly.loop_header721

polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  %indvars.iv868 = phi i64 [ %indvars.iv.next869, %polly.loop_exit735 ], [ 0, %polly.loop_header721 ]
  %polly.indvar730 = phi i64 [ %polly.indvar_next731, %polly.loop_exit735 ], [ 0, %polly.loop_header721 ]
  %230 = mul nsw i64 %polly.indvar730, -32
  %smin937 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin937, 1000
  %smin870 = call i64 @llvm.smin.i64(i64 %indvars.iv868, i64 -968)
  %232 = shl nsw i64 %polly.indvar730, 5
  %233 = add nsw i64 %smin870, 999
...
polly.loop_exit735:                               ; preds = %polly.loop_exit741
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar_next731, 32
  br i1 %exitcond876.not, label %polly.loop_exit729, label %polly.loop_header727
...
polly.loop_header733:                             ; preds = %polly.loop_exit741, %polly.loop_header727
  ...
  %min.iters.check938 = icmp eq i64 %231, 0
  br i1 %min.iters.check938, label %polly.loop_header739, label %vector.ph939

vector.ph939:                                     ; preds = %polly.loop_header733
  %broadcast.splatinsert948 = insertelement <4 x i64> poison, i64 %232, i32 0
  %broadcast.splat949 = shufflevector <4 x i64> %broadcast.splatinsert948, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert950 = insertelement <4 x i32> poison, i32 %235, i32 0
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph939
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind946, %broadcast.splat949
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat951, %238
  ...
  %249 = icmp eq i64 %index.next943, %231
  br i1 %249, label %polly.loop_exit741, label %vector.body936, !llvm.loop !98

polly.loop_exit741:                               ; preds = %vector.body936, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond875.not = icmp eq i64 %polly.indvar736, %229
  br i1 %exitcond875.not, label %polly.loop_exit735, label %polly.loop_header733
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar742, %233
  br i1 %exitcond871.not, label %polly.loop_exit741, label %polly.loop_header739, !llvm.loop !99

polly.loop_header747:                             ; preds = %polly.loop_exit729, %polly.loop_exit755
  %indvars.iv862 = phi i64 [ %indvars.iv.next863, %polly.loop_exit755 ], [ 0, %polly.loop_exit729 ]
...
polly.loop_exit755:                               ; preds = %polly.loop_exit761
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next751, 38
  br i1 %exitcond867.not, label %init_array.exit, label %polly.loop_header747

polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  %indvars.iv858 = phi i64 [ %indvars.iv.next859, %polly.loop_exit761 ], [ 0, %polly.loop_header747 ]
  %polly.indvar756 = phi i64 [ %polly.indvar_next757, %polly.loop_exit761 ], [ 0, %polly.loop_header747 ]
  %259 = mul nsw i64 %polly.indvar756, -32
  %smin955 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin955, 1000
  %smin860 = call i64 @llvm.smin.i64(i64 %indvars.iv858, i64 -968)
  %261 = shl nsw i64 %polly.indvar756, 5
  %262 = add nsw i64 %smin860, 999
...
polly.loop_exit761:                               ; preds = %polly.loop_exit767
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar_next757, 32
  br i1 %exitcond866.not, label %polly.loop_exit755, label %polly.loop_header753
...
polly.loop_header759:                             ; preds = %polly.loop_exit767, %polly.loop_header753
  ...
  %min.iters.check956 = icmp eq i64 %260, 0
  br i1 %min.iters.check956, label %polly.loop_header765, label %vector.ph957

vector.ph957:                                     ; preds = %polly.loop_header759
  %broadcast.splatinsert966 = insertelement <4 x i64> poison, i64 %261, i32 0
  %broadcast.splat967 = shufflevector <4 x i64> %broadcast.splatinsert966, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert968 = insertelement <4 x i32> poison, i32 %264, i32 0
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph957
  ...
  %266 = add nuw nsw <4 x i64> %vec.ind964, %broadcast.splat967
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat969, %267
  ...
  %278 = icmp eq i64 %index.next961, %260
  br i1 %278, label %polly.loop_exit767, label %vector.body954, !llvm.loop !101

polly.loop_exit767:                               ; preds = %vector.body954, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond865.not = icmp eq i64 %polly.indvar762, %258
  br i1 %exitcond865.not, label %polly.loop_exit761, label %polly.loop_header759
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar768, %262
  br i1 %exitcond861.not, label %polly.loop_exit767, label %polly.loop_header765, !llvm.loop !102
}
