; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3885.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3885.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1026.not = icmp eq i64 %127, 75
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %128 = add i64 %smax, %indvars.iv1019
  %129 = shl nsw i64 %polly.indvar214, 3
  %.not.not = icmp ugt i64 %129, %polly.indvar208
  %130 = shl nsw i64 %polly.indvar214, 7
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_header233.7, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %142 = mul nsw i64 %polly.indvar214, -128
...
polly.loop_header253:                             ; preds = %polly.loop_header246, %polly.loop_exit263
  %indvars.iv1021 = phi i64 [ %128, %polly.loop_header246 ], [ %indvars.iv.next1022, %polly.loop_exit263 ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %176 = lshr i64 %polly.indvar398, 3
  %177 = shl nuw nsw i64 %176, 7
  %178 = sub nsw i64 %indvars.iv1033, %177
  %179 = add i64 %indvars.iv1038, %177
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1048.not = icmp eq i64 %198, 75
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1040 = phi i64 [ %indvars.iv.next1041, %polly.loop_exit445 ], [ %179, %polly.loop_header395 ]
  %indvars.iv1035 = phi i64 [ %indvars.iv.next1036, %polly.loop_exit445 ], [ %178, %polly.loop_header395 ]
  %polly.indvar405 = phi i64 [ %polly.indvar_next406, %polly.loop_exit445 ], [ %176, %polly.loop_header395 ]
  %smax1037 = call i64 @llvm.smax.i64(i64 %indvars.iv1035, i64 0)
  %199 = add i64 %smax1037, %indvars.iv1040
  %200 = shl nsw i64 %polly.indvar405, 3
  %.not.not885 = icmp ugt i64 %200, %polly.indvar398
  %201 = shl nsw i64 %polly.indvar405, 7
  %202 = add nsw i64 %201, %181
  %203 = icmp sgt i64 %202, 0
  %204 = select i1 %203, i64 %202, i64 0
  %205 = add nsw i64 %202, 127
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_header429.7, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %213 = mul nsw i64 %polly.indvar405, -128
  %214 = icmp slt i64 %213, -1072
  %215 = select i1 %214, i64 %213, i64 -1072
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1042 = phi i64 [ %199, %polly.loop_header443 ], [ %indvars.iv.next1043, %polly.loop_exit460 ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %247 = lshr i64 %polly.indvar595, 3
  %248 = shl nuw nsw i64 %247, 7
  %249 = sub nsw i64 %indvars.iv1055, %248
  %250 = add i64 %indvars.iv1060, %248
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1062 = phi i64 [ %indvars.iv.next1063, %polly.loop_exit642 ], [ %250, %polly.loop_header592 ]
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit642 ], [ %249, %polly.loop_header592 ]
  %polly.indvar602 = phi i64 [ %polly.indvar_next603, %polly.loop_exit642 ], [ %247, %polly.loop_header592 ]
  %smax1059 = call i64 @llvm.smax.i64(i64 %indvars.iv1057, i64 0)
  %270 = add i64 %smax1059, %indvars.iv1062
  %271 = shl nsw i64 %polly.indvar602, 3
  %.not.not886 = icmp ugt i64 %271, %polly.indvar595
  %272 = shl nsw i64 %polly.indvar602, 7
  %273 = add nsw i64 %272, %252
  %274 = icmp sgt i64 %273, 0
  %275 = select i1 %274, i64 %273, i64 0
  %276 = add nsw i64 %273, 127
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_header626.7, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %284 = mul nsw i64 %polly.indvar602, -128
  %285 = icmp slt i64 %284, -1072
  %286 = select i1 %285, i64 %284, i64 -1072
...
polly.loop_header647:                             ; preds = %polly.loop_header640, %polly.loop_exit657
  %indvars.iv1064 = phi i64 [ %270, %polly.loop_header640 ], [ %indvars.iv.next1065, %polly.loop_exit657 ]
