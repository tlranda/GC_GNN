; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3868.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3868.c"
...
polly.loop_header205.preheader:                   ; preds = %polly.loop_header199
  ...
  %105 = or i64 %104, 1
  %106 = mul nuw nsw i64 %polly.indvar202, 80
  %107 = mul nsw i64 %polly.indvar202, -80
...
polly.loop_exit207:                               ; preds = %polly.loop_exit259, %polly.loop_header199
  ...
  %exitcond1110.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header205:                             ; preds = %polly.loop_header205.preheader, %polly.loop_exit259
  ...
  %112 = icmp sgt i64 %111, 80
  %113 = select i1 %112, i64 %111, i64 80
  %114 = add nsw i64 %111, 99
  %polly.loop_guard246 = icmp sgt i64 %111, -100
...
polly.loop_header217.us939:                       ; preds = %polly.loop_header211.us937, %polly.loop_header217.us939
  ...
  %exitcond1089.not = icmp eq i64 %polly.indvar_next221.us947, 80
...
polly.loop_header257.preheader:                   ; preds = %polly.merge, %polly.merge.us973, %polly.merge.us
  ...
  %polly.loop_guard267 = icmp slt i64 %119, 100
...
polly.loop_header264.us:                          ; preds = %polly.loop_exit274.us, %polly.loop_header257.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1106, i64 79)
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_exit412
  ...
  %indvars.iv1117 = phi i64 [ 99, %polly.loop_header402.preheader ], [ %indvars.iv.next1118, %polly.loop_exit412 ]
  ...
  %polly.loop_guard413 = icmp slt i64 %143, 12
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header402
  ...
  %148 = or i64 %147, 1
  %149 = mul nuw nsw i64 %polly.indvar405, 80
  %150 = mul nsw i64 %polly.indvar405, -80
...
polly.loop_exit412:                               ; preds = %polly.loop_exit469, %polly.loop_header402
  ...
  %exitcond1140.not = icmp eq i64 %polly.indvar_next406, 15
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit469
  ...
  %153 = mul nsw i64 %polly.indvar414, 100
  %154 = add nsw i64 %153, %150
  %155 = icmp sgt i64 %154, 80
  %156 = select i1 %155, i64 %154, i64 80
  %157 = add nsw i64 %154, 99
  %polly.loop_guard456 = icmp sgt i64 %154, -100
...
polly.loop_header427.us985:                       ; preds = %polly.loop_header417.us983, %polly.loop_header427.us985
  ...
  %exitcond1115.not = icmp eq i64 %polly.indvar_next431.us993, 80
...
polly.loop_exit469:                               ; preds = %polly.loop_exit476.loopexit.us, %polly.loop_header467.preheader
  ...
  %polly.loop_cond416 = icmp slt i64 %polly.indvar414, 11
  %indvars.iv.next1122 = add i64 %indvars.iv1121, 100
  %indvars.iv.next1129 = add i64 %indvars.iv1128, -100
  %indvars.iv.next1134 = add i64 %indvars.iv1133, 100
...
polly.loop_header467.preheader:                   ; preds = %polly.merge424, %polly.merge424.us1019, %polly.merge424.us
  ...
  %polly.loop_guard477 = icmp slt i64 %162, 100
...
polly.loop_exit484.us:                            ; preds = %polly.loop_header482.us, %polly.loop_header474.us
  ...
  %polly.loop_cond480.us = icmp ult i64 %polly.indvar478.us, 99
...
polly.loop_header427:                             ; preds = %polly.loop_header417, %polly.loop_header427
  ...
  %exitcond1113.not = icmp eq i64 %polly.indvar_next431, 80
...
polly.loop_header612:                             ; preds = %polly.loop_header612.preheader, %polly.loop_exit622
  ...
  %indvars.iv1147 = phi i64 [ 99, %polly.loop_header612.preheader ], [ %indvars.iv.next1148, %polly.loop_exit622 ]
  ...
  %polly.loop_guard623 = icmp slt i64 %186, 12
...
polly.loop_header620.preheader:                   ; preds = %polly.loop_header612
  ...
  %191 = or i64 %190, 1
  %192 = mul nuw nsw i64 %polly.indvar615, 80
  %193 = mul nsw i64 %polly.indvar615, -80
...
polly.loop_exit622:                               ; preds = %polly.loop_exit679, %polly.loop_header612
  ...
  %indvars.iv.next1148 = add nuw nsw i64 %indvars.iv1147, 20
  %indvars.iv.next1150 = add nuw nsw i64 %indvars.iv1149, 1
  %indvars.iv.next1157 = add nsw i64 %indvars.iv1156, -20
  %indvars.iv.next1162 = add nuw nsw i64 %indvars.iv1161, 20
  %exitcond1170.not = icmp eq i64 %polly.indvar_next616, 15
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit679
  ...
  %198 = icmp sgt i64 %197, 80
  %199 = select i1 %198, i64 %197, i64 80
  %200 = add nsw i64 %197, 99
  %polly.loop_guard666 = icmp sgt i64 %197, -100
...
polly.loop_header637.us1031:                      ; preds = %polly.loop_header627.us1029, %polly.loop_header637.us1031
  ...
  %exitcond1145.not = icmp eq i64 %polly.indvar_next641.us1039, 80
...
polly.loop_exit679:                               ; preds = %polly.loop_exit686.loopexit.us, %polly.loop_header677.preheader
  ...
  %polly.loop_cond626 = icmp slt i64 %polly.indvar624, 11
  %indvars.iv.next1152 = add i64 %indvars.iv1151, 100
  %indvars.iv.next1159 = add i64 %indvars.iv1158, -100
...
polly.loop_header677.preheader:                   ; preds = %polly.merge634, %polly.merge634.us1065, %polly.merge634.us
  ...
  %polly.loop_guard687 = icmp slt i64 %205, 100
...
polly.loop_header684.us:                          ; preds = %polly.loop_exit694.us, %polly.loop_header677.us
  ...
  %smin1167 = call i64 @llvm.smin.i64(i64 %indvars.iv1165, i64 79)
...
polly.loop_header637:                             ; preds = %polly.loop_header627, %polly.loop_header637
  ...
  %exitcond1143.not = icmp eq i64 %polly.indvar_next641, 80
