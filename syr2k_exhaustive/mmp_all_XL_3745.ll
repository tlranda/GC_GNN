; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3745.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3745.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %indvars.iv1004 = phi i64 [ 47, %polly.loop_header199.preheader ], [ %indvars.iv.next1005, %polly.loop_exit207 ]
  %indvars.iv = phi i64 [ 0, %polly.loop_header199.preheader ], [ %indvars.iv.next, %polly.loop_exit207 ]
  %polly.indvar202 = phi i64 [ 0, %polly.loop_header199.preheader ], [ %polly.indvar_next203, %polly.loop_exit207 ]
  %97 = udiv i64 %indvars.iv1004, 48
  %98 = mul nuw nsw i64 %97, 96
  %99 = trunc i64 %polly.indvar202 to i16
  %100 = mul i16 %99, 23
  %pexp.p_div_q.lhs.trunc = add i16 %100, 47
  %pexp.p_div_q881 = udiv i16 %pexp.p_div_q.lhs.trunc, 48
  %pexp.p_div_q.zext = zext i16 %pexp.p_div_q881 to i64
...
polly.loop_exit207:                               ; preds = %polly.loop_exit246, %polly.loop_header199
  ...
  %indvars.iv.next1005 = add nuw nsw i64 %indvars.iv1004, 23
  %indvars.iv.next1009 = add nuw nsw i64 %indvars.iv1008, 46
  %exitcond1016.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_header251:                             ; preds = %polly.loop_exit261, %polly.loop_header244
  %indvars.iv1012 = phi i64 [ %indvars.iv.next1013, %polly.loop_exit261 ], [ %107, %polly.loop_header244 ]
  %polly.indvar255 = phi i64 [ %polly.indvar_next256, %polly.loop_exit261 ], [ %121, %polly.loop_header244 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1012, i64 49)
  %128 = add nsw i64 %polly.indvar255, %109
  %polly.loop_guard2621100 = icmp sgt i64 %128, -1
...
vector.body1218:                                  ; preds = %vector.body1218, %vector.ph1222
  ...
  %138 = shl nuw nsw i64 %index1225, 3
  %139 = getelementptr i8, i8* %scevgep385, i64 %138
  %140 = bitcast i8* %139 to <4 x double>*
  %wide.load1229 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !79, !noalias !81
  %141 = fmul fast <4 x double> %wide.load1229, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %143 = icmp eq i64 %index.next1226, %n.vec1224
  br i1 %143, label %middle.block1216, label %vector.body1218, !llvm.loop !85

middle.block1216:                                 ; preds = %vector.body1218
  %cmp.n1228 = icmp eq i64 %136, %n.vec1224
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit399
  ...
  %indvars.iv1024 = phi i64 [ 47, %polly.loop_header389.preheader ], [ %indvars.iv.next1025, %polly.loop_exit399 ]
  ...
  %145 = udiv i64 %indvars.iv1024, 48
  %146 = mul nuw nsw i64 %145, 96
  %147 = trunc i64 %polly.indvar392 to i16
  %148 = mul i16 %147, 23
  %pexp.p_div_q395.lhs.trunc = add i16 %148, 47
  %pexp.p_div_q395880 = udiv i16 %pexp.p_div_q395.lhs.trunc, 48
  %pexp.p_div_q395.zext = zext i16 %pexp.p_div_q395880 to i64
  %149 = sub nsw i64 %polly.indvar392, %pexp.p_div_q395.zext
  %polly.loop_guard400 = icmp slt i64 %149, 13
...
polly.loop_header397.preheader:                   ; preds = %polly.loop_header389
  %150 = sub nsw i64 %indvars.iv1029, %146
  %151 = add i64 %indvars.iv1022, %146
  %152 = mul nsw i64 %polly.indvar392, -50
  %153 = mul nuw nsw i64 %polly.indvar392, 50
...
polly.loop_exit399:                               ; preds = %polly.loop_exit439, %polly.loop_header389
  ...
  %indvars.iv.next1023 = add nsw i64 %indvars.iv1022, -46
  %indvars.iv.next1025 = add nuw nsw i64 %indvars.iv1024, 23
  %indvars.iv.next1030 = add nuw nsw i64 %indvars.iv1029, 46
  %exitcond1038.not = icmp eq i64 %polly.indvar_next393, 24
...
polly.loop_header397:                             ; preds = %polly.loop_header397.preheader, %polly.loop_exit439
  %indvars.iv1031 = phi i64 [ %150, %polly.loop_header397.preheader ], [ %indvars.iv.next1032, %polly.loop_exit439 ]
  %indvars.iv1026 = phi i64 [ %151, %polly.loop_header397.preheader ], [ %indvars.iv.next1027, %polly.loop_exit439 ]
  ...
  %155 = add i64 %smax1028, %indvars.iv1031
  %156 = mul nsw i64 %polly.indvar401, 96
  %157 = add nsw i64 %156, %152
  %158 = add nsw i64 %157, -1
  %.inv877 = icmp sgt i64 %157, 49
  %159 = select i1 %.inv877, i64 49, i64 %158
...
polly.loop_header411.us:                          ; preds = %polly.loop_header404.us, %polly.loop_header411.us
  ...
  %exitcond1020.not = icmp eq i64 %polly.indvar415.us, %159
...
polly.loop_header437.preheader:                   ; preds = %polly.loop_exit425, %polly.loop_exit425.us, %polly.loop_header397.split
  ...
  %170 = mul nsw i64 %polly.indvar401, -96
...
polly.loop_header444:                             ; preds = %polly.loop_exit454, %polly.loop_header437
  %indvars.iv1033 = phi i64 [ %indvars.iv.next1034, %polly.loop_exit454 ], [ %155, %polly.loop_header437 ]
  %polly.indvar448 = phi i64 [ %polly.indvar_next449, %polly.loop_exit454 ], [ %169, %polly.loop_header437 ]
  %smin1035 = call i64 @llvm.smin.i64(i64 %indvars.iv1033, i64 49)
  %176 = add nsw i64 %polly.indvar448, %157
  %polly.loop_guard4551101 = icmp sgt i64 %176, -1
...
polly.loop_header566:                             ; preds = %polly.loop_exit574, %polly.start480
  ...
  %min.iters.check1195 = icmp ult i64 %184, 4
...
vector.body1194:                                  ; preds = %vector.body1194, %vector.ph1196
  ...
  %186 = shl nuw nsw i64 %index1199, 3
  %187 = getelementptr i8, i8* %scevgep578, i64 %186
  %188 = bitcast i8* %187 to <4 x double>*
  %wide.load1203 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !89, !noalias !91
  %189 = fmul fast <4 x double> %wide.load1203, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %191 = icmp eq i64 %index.next1200, %n.vec1198
  br i1 %191, label %middle.block1192, label %vector.body1194, !llvm.loop !95

middle.block1192:                                 ; preds = %vector.body1194
  %cmp.n1202 = icmp eq i64 %184, %n.vec1198
...
polly.loop_header582:                             ; preds = %polly.loop_header582.preheader, %polly.loop_exit592
  ...
  %indvars.iv1046 = phi i64 [ 47, %polly.loop_header582.preheader ], [ %indvars.iv.next1047, %polly.loop_exit592 ]
  ...
  %193 = udiv i64 %indvars.iv1046, 48
  %194 = mul nuw nsw i64 %193, 96
  %195 = trunc i64 %polly.indvar585 to i16
  %196 = mul i16 %195, 23
  %pexp.p_div_q588.lhs.trunc = add i16 %196, 47
  %pexp.p_div_q588879 = udiv i16 %pexp.p_div_q588.lhs.trunc, 48
  %pexp.p_div_q588.zext = zext i16 %pexp.p_div_q588879 to i64
  %197 = sub nsw i64 %polly.indvar585, %pexp.p_div_q588.zext
  %polly.loop_guard593 = icmp slt i64 %197, 13
...
polly.loop_header590.preheader:                   ; preds = %polly.loop_header582
  %198 = sub nsw i64 %indvars.iv1051, %194
  %199 = add i64 %indvars.iv1044, %194
  %200 = mul nsw i64 %polly.indvar585, -50
  %201 = mul nuw nsw i64 %polly.indvar585, 50
...
polly.loop_exit592:                               ; preds = %polly.loop_exit632, %polly.loop_header582
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next586, 24
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit632
  %indvars.iv1053 = phi i64 [ %198, %polly.loop_header590.preheader ], [ %indvars.iv.next1054, %polly.loop_exit632 ]
  %indvars.iv1048 = phi i64 [ %199, %polly.loop_header590.preheader ], [ %indvars.iv.next1049, %polly.loop_exit632 ]
  ...
  %203 = add i64 %smax1050, %indvars.iv1053
  %204 = mul nsw i64 %polly.indvar594, 96
  %205 = add nsw i64 %204, %200
  %206 = add nsw i64 %205, -1
  %.inv878 = icmp sgt i64 %205, 49
  %207 = select i1 %.inv878, i64 49, i64 %206
...
polly.loop_header604.us:                          ; preds = %polly.loop_header597.us, %polly.loop_header604.us
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar608.us, %207
...
polly.loop_header630.preheader:                   ; preds = %polly.loop_exit618, %polly.loop_exit618.us, %polly.loop_header590.split
  ...
  %218 = mul nsw i64 %polly.indvar594, -96
...
polly.loop_header637:                             ; preds = %polly.loop_exit647, %polly.loop_header630
  %indvars.iv1055 = phi i64 [ %indvars.iv.next1056, %polly.loop_exit647 ], [ %203, %polly.loop_header630 ]
  ...
  %polly.loop_guard6481102 = icmp sgt i64 %224, -1
...
polly.loop_header803:                             ; preds = %polly.loop_exit811, %polly.loop_header797
  ...
  %smin1133 = call i64 @llvm.smin.i64(i64 %234, i64 -1168)
  %235 = add nsw i64 %smin1133, 1200
  %smin1085 = call i64 @llvm.smin.i64(i64 %indvars.iv1083, i64 -1168)
  %236 = shl nsw i64 %polly.indvar806, 5
  %237 = add nsw i64 %smin1085, 1199
...
vector.ph1134:                                    ; preds = %polly.loop_header809
  %broadcast.splatinsert1141 = insertelement <4 x i64> poison, i64 %236, i32 0
  %broadcast.splat1142 = shufflevector <4 x i64> %broadcast.splatinsert1141, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1143 = insertelement <4 x i32> poison, i32 %239, i32 0
...
vector.body1132:                                  ; preds = %vector.body1132, %vector.ph1134
  ...
  %241 = add nuw nsw <4 x i64> %vec.ind1139, %broadcast.splat1142
  %242 = trunc <4 x i64> %241 to <4 x i32>
  %243 = mul <4 x i32> %broadcast.splat1144, %242
  ...
  %253 = icmp eq i64 %index.next1136, %235
  br i1 %253, label %polly.loop_exit817, label %vector.body1132, !llvm.loop !104

polly.loop_exit817:                               ; preds = %vector.body1132, %polly.loop_header815
  %polly.indvar_next813 = add nuw nsw i64 %polly.indvar812, 1
  %exitcond1090.not = icmp eq i64 %polly.indvar812, %233
...
polly.loop_header815:                             ; preds = %polly.loop_header809, %polly.loop_header815
  ...
  %exitcond1086.not = icmp eq i64 %polly.indvar818, %237
...
polly.loop_header830:                             ; preds = %polly.loop_exit838, %polly.loop_header824
  ...
  %smin1148 = call i64 @llvm.smin.i64(i64 %263, i64 -968)
  %264 = add nsw i64 %smin1148, 1000
  %smin1075 = call i64 @llvm.smin.i64(i64 %indvars.iv1073, i64 -968)
  %265 = shl nsw i64 %polly.indvar833, 5
  %266 = add nsw i64 %smin1075, 999
...
vector.body1147:                                  ; preds = %vector.body1147, %vector.ph1150
  ...
  %270 = add nuw nsw <4 x i64> %vec.ind1157, %broadcast.splat1160
  %271 = trunc <4 x i64> %270 to <4 x i32>
  %272 = mul <4 x i32> %broadcast.splat1162, %271
  ...
  %282 = icmp eq i64 %index.next1154, %264
  br i1 %282, label %polly.loop_exit844, label %vector.body1147, !llvm.loop !107

polly.loop_exit844:                               ; preds = %vector.body1147, %polly.loop_header842
  %polly.indvar_next840 = add nuw nsw i64 %polly.indvar839, 1
  %exitcond1080.not = icmp eq i64 %polly.indvar839, %262
...
polly.loop_header842:                             ; preds = %polly.loop_header836, %polly.loop_header842
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar845, %266
...
polly.loop_header856:                             ; preds = %polly.loop_exit864, %polly.loop_header850
  ...
  %smin1166 = call i64 @llvm.smin.i64(i64 %292, i64 -968)
  %293 = add nsw i64 %smin1166, 1000
  %smin1065 = call i64 @llvm.smin.i64(i64 %indvars.iv1063, i64 -968)
  %294 = shl nsw i64 %polly.indvar859, 5
  %295 = add nsw i64 %smin1065, 999
...
vector.body1165:                                  ; preds = %vector.body1165, %vector.ph1168
  ...
  %299 = add nuw nsw <4 x i64> %vec.ind1175, %broadcast.splat1178
  %300 = trunc <4 x i64> %299 to <4 x i32>
  %301 = mul <4 x i32> %broadcast.splat1180, %300
  ...
  %311 = icmp eq i64 %index.next1172, %293
  br i1 %311, label %polly.loop_exit870, label %vector.body1165, !llvm.loop !110

polly.loop_exit870:                               ; preds = %vector.body1165, %polly.loop_header868
  %polly.indvar_next866 = add nuw nsw i64 %polly.indvar865, 1
  %exitcond1070.not = icmp eq i64 %polly.indvar865, %291
...
polly.loop_header868:                             ; preds = %polly.loop_header862, %polly.loop_header868
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar871, %295
