; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5009.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5009.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv993, i64 35)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next994 = add nuw nsw i64 %indvars.iv993, 3
...
vector.body1210:                                  ; preds = %vector.body1210, %vector.ph1214
  ...
  %wide.load1221 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %134, label %middle.block1208, label %vector.body1210, !llvm.loop !79
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %umin1025 = call i64 @llvm.umin.i64(i64 %indvars.iv1023, i64 35)
  ...
  %141 = add nuw nsw i64 %umin1025, 2
...
polly.loop_exit391:                               ; preds = %polly.loop_exit397
  ...
  %indvars.iv.next1024 = add nuw nsw i64 %indvars.iv1023, 3
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %144 = shl nsw i64 %polly.indvar398, 5
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1188
  ...
  %wide.load1195 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %173, label %middle.block1184, label %vector.body1186, !llvm.loop !89
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %umin1056 = call i64 @llvm.umin.i64(i64 %indvars.iv1054, i64 35)
  ...
  %180 = add nuw nsw i64 %umin1056, 2
...
polly.loop_header579:                             ; preds = %polly.loop_exit587, %polly.loop_header573
  ...
  %182 = shl nsw i64 %polly.indvar582, 5
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %183 = shl nsw i64 %polly.indvar588, 5
...
vector.body1125:                                  ; preds = %vector.body1125, %vector.ph1126
  ...
  br i1 %226, label %polly.loop_exit805, label %vector.body1125, !llvm.loop !98
...
vector.body1139:                                  ; preds = %vector.body1139, %vector.ph1142
  ...
  br i1 %255, label %polly.loop_exit832, label %vector.body1139, !llvm.loop !101
...
vector.body1157:                                  ; preds = %vector.body1157, %vector.ph1160
  ...
  br i1 %284, label %polly.loop_exit858, label %vector.body1157, !llvm.loop !104
