; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1565.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1565.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit224 ], [ 1, %polly.loop_exit208 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next220, 150
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %104 = mul nsw i64 %polly.indvar225, -20
  %105 = add i64 %98, %104
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %114, i64 19)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit423 ], [ 1, %polly.loop_exit406 ]
  ...
  %150 = mul nsw i64 %polly.indvar417, -8
  %151 = shl nuw nsw i64 %polly.indvar417, 3
  %152 = udiv i64 %indvars.iv1057, 5
  %153 = mul nsw i64 %polly.indvar417, -8
  %154 = shl nsw i64 %polly.indvar417, 3
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %indvars.iv.next1046 = add nuw nsw i64 %indvars.iv1045, 8
  %indvars.iv.next1058 = add nuw nsw i64 %indvars.iv1057, 2
  %exitcond1060.not = icmp eq i64 %polly.indvar_next418, 150
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %155 = mul nuw nsw i64 %polly.indvar424, 20
  %156 = add i64 %150, %155
  %smax1276 = call i64 @llvm.smax.i64(i64 %156, i64 0)
  %157 = mul nsw i64 %polly.indvar424, -20
  %158 = add i64 %151, %157
  %159 = add i64 %smax1276, %158
  %160 = mul nuw nsw i64 %polly.indvar424, 20
  %161 = add nsw i64 %160, %153
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %polly.loop_guard431 = icmp slt i64 %163, 8
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %167, i64 19)
...
polly.loop_exit466:                               ; preds = %polly.loop_exit473.loopexit.us, %polly.loop_header428.split, %polly.loop_header464.preheader
  ...
  %polly.loop_cond434 = icmp ult i64 %polly.indvar432, 7
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  %indvars.iv1083 = phi i64 [ %indvars.iv.next1084, %polly.loop_exit628 ], [ 1, %polly.loop_exit611 ]
  ...
  %203 = mul nsw i64 %polly.indvar622, -8
  %204 = shl nuw nsw i64 %polly.indvar622, 3
  %205 = udiv i64 %indvars.iv1083, 5
  %206 = mul nsw i64 %polly.indvar622, -8
  %207 = shl nsw i64 %polly.indvar622, 3
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1072 = add nuw nsw i64 %indvars.iv1071, 8
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 2
  %exitcond1086.not = icmp eq i64 %polly.indvar_next623, 150
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %208 = mul nuw nsw i64 %polly.indvar629, 20
  %209 = add i64 %203, %208
  %smax1228 = call i64 @llvm.smax.i64(i64 %209, i64 0)
  %210 = mul nsw i64 %polly.indvar629, -20
  %211 = add i64 %204, %210
  %212 = add i64 %smax1228, %211
  %213 = mul nuw nsw i64 %polly.indvar629, 20
  %214 = add nsw i64 %213, %206
  %215 = icmp sgt i64 %214, 0
  %216 = select i1 %215, i64 %214, i64 0
  %polly.loop_guard636 = icmp slt i64 %216, 8
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %220, i64 19)
...
polly.loop_exit671:                               ; preds = %polly.loop_exit678.loopexit.us, %polly.loop_header633.split, %polly.loop_header669.preheader
  ...
  %polly.loop_cond639 = icmp ult i64 %polly.indvar637, 7
