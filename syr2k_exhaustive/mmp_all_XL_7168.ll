; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7168.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7168.c"
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph955
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv7.i, i64 %index956
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i, i64 %index1022
...
vector.body1040:                                  ; preds = %vector.body1040, %vector.ph1042
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i52, i64 %index1045
...
vector.body1066:                                  ; preds = %vector.body1066, %vector.ph1068
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i91, i64 %index1071
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next219, 38
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %104 = add nsw i64 %smin847, 999
  br label %polly.loop_header227

polly.loop_exit229:                               ; preds = %polly.loop_exit235
  %polly.indvar_next225 = add nuw nsw i64 %polly.indvar224, 1
  %indvars.iv.next846 = add nsw i64 %indvars.iv845, -16
  %exitcond852.not = icmp eq i64 %polly.indvar_next225, 63
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %105 = mul nuw nsw i64 %polly.indvar230, 80
...
polly.loop_header233.preheader:                   ; preds = %polly.loop_header227
  ...
  %109 = add i64 %smax, %indvars.iv841
  %110 = sub nsw i64 %102, %105
  br label %polly.loop_header233

polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  %polly.indvar_next231 = add nuw nsw i64 %polly.indvar230, 1
  %indvars.iv.next838 = add nsw i64 %indvars.iv837, 80
  %indvars.iv.next842 = add nsw i64 %indvars.iv841, -80
  %exitcond851.not = icmp eq i64 %polly.indvar230, %umin
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  %indvars.iv843 = phi i64 [ %109, %polly.loop_header233.preheader ], [ %indvars.iv.next844, %polly.loop_exit241 ]
  %polly.indvar236 = phi i64 [ %108, %polly.loop_header233.preheader ], [ %polly.indvar_next237, %polly.loop_exit241 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 79)
  %111 = add nsw i64 %polly.indvar236, %110
  %polly.loop_guard249943 = icmp sgt i64 %111, -1
  %112 = add nuw nsw i64 %polly.indvar236, %102
  %113 = mul i64 %112, 8000
  %114 = mul i64 %112, 9600
  br i1 %polly.loop_guard249943, label %polly.loop_header239.us, label %polly.loop_exit241
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233, %polly.loop_exit248.loopexit.us
  ...
  %115 = add nuw nsw i64 %polly.indvar242.us, %103
  %116 = shl i64 %115, 3
  %polly.access.mul.Packed_MemRef_call2256.us = mul nuw nsw i64 %115, 1200
  %polly.access.add.Packed_MemRef_call2257.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2256.us, %112
...
polly.loop_header246.us:                          ; preds = %polly.loop_header239.us, %polly.loop_header246.us
  ...
  %118 = add nuw nsw i64 %polly.indvar250.us, %105
...
polly.loop_exit248.loopexit.us:                   ; preds = %polly.loop_header246.us
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar242.us, %104
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.start272
  %indvar1053 = phi i64 [ %indvar.next1054, %polly.loop_exit366 ], [ 0, %polly.start272 ]
  %polly.indvar361 = phi i64 [ %polly.indvar_next362, %polly.loop_exit366 ], [ 1, %polly.start272 ]
  %123 = add i64 %indvar1053, 1
  %124 = mul nuw nsw i64 %polly.indvar361, 9600
  %scevgep370 = getelementptr i8, i8* %call, i64 %124
  %min.iters.check1055 = icmp ult i64 %123, 4
  br i1 %min.iters.check1055, label %polly.loop_header364.preheader, label %vector.ph1056

vector.ph1056:                                    ; preds = %polly.loop_header358
  %n.vec1058 = and i64 %123, -4
...
vector.body1052:                                  ; preds = %vector.body1052, %vector.ph1056
  ...
  %125 = shl nuw nsw i64 %index1059, 3
  %126 = getelementptr i8, i8* %scevgep370, i64 %125
  %127 = bitcast i8* %126 to <4 x double>*
  %wide.load1063 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !74, !noalias !76
  %128 = fmul fast <4 x double> %wide.load1063, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %130 = icmp eq i64 %index.next1060, %n.vec1058
  br i1 %130, label %middle.block1050, label %vector.body1052, !llvm.loop !80

middle.block1050:                                 ; preds = %vector.body1052
  %cmp.n1062 = icmp eq i64 %123, %n.vec1058
  br i1 %cmp.n1062, label %polly.loop_exit366, label %polly.loop_header364.preheader

polly.loop_header364.preheader:                   ; preds = %polly.loop_header358, %middle.block1050
  %polly.indvar367.ph = phi i64 [ 0, %polly.loop_header358 ], [ %n.vec1058, %middle.block1050 ]
  br label %polly.loop_header364

polly.loop_exit366:                               ; preds = %polly.loop_header364, %middle.block1050
  %polly.indvar_next362 = add nuw nsw i64 %polly.indvar361, 1
  %exitcond884.not = icmp eq i64 %polly.indvar_next362, 1200
  %indvar.next1054 = add i64 %indvar1053, 1
  br i1 %exitcond884.not, label %polly.loop_header374.preheader, label %polly.loop_header358
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  %exitcond883.not = icmp eq i64 %polly.indvar_next368, %polly.indvar361
  br i1 %exitcond883.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !81
...
polly.loop_exit382:                               ; preds = %polly.loop_header380
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next378, 1000
  br i1 %exitcond882.not, label %polly.loop_header390, label %polly.loop_header374
...
polly.loop_header380:                             ; preds = %polly.loop_header380, %polly.loop_header374
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next384, 1200
  br i1 %exitcond881.not, label %polly.loop_exit382, label %polly.loop_header380

polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv875 = phi i64 [ %indvars.iv.next876, %polly.loop_exit398 ], [ 1, %polly.loop_exit382 ]
  ...
  %132 = udiv i64 %indvars.iv875, 5
  %umin877 = call i64 @llvm.umin.i64(i64 %132, i64 14)
  %133 = mul nsw i64 %polly.indvar393, -32
  %134 = icmp slt i64 %133, -1168
  %135 = select i1 %134, i64 %133, i64 -1168
  %136 = add nsw i64 %135, 1199
  %137 = shl nsw i64 %polly.indvar393, 5
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit405
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next859 = add nsw i64 %indvars.iv858, -32
  %indvars.iv.next864 = add nuw nsw i64 %indvars.iv863, 32
  %indvars.iv.next876 = add nuw nsw i64 %indvars.iv875, 2
  %exitcond880.not = icmp eq i64 %polly.indvar_next394, 38
  br i1 %exitcond880.not, label %polly.exiting273, label %polly.loop_header390
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  ...
  %smin873 = call i64 @llvm.smin.i64(i64 %indvars.iv871, i64 -984)
  %138 = shl nsw i64 %polly.indvar399, 4
  %139 = add nsw i64 %smin873, 999
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit412
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %indvars.iv.next872 = add nsw i64 %indvars.iv871, -16
  %exitcond879.not = icmp eq i64 %polly.indvar_next400, 63
  br i1 %exitcond879.not, label %polly.loop_exit398, label %polly.loop_header396
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %140 = mul nuw nsw i64 %polly.indvar406, 80
  %141 = add nsw i64 %140, %133
  %142 = icmp sgt i64 %141, 0
  %143 = select i1 %142, i64 %141, i64 0
  %polly.loop_guard413.not = icmp sgt i64 %143, %136
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv867 = phi i64 [ %144, %polly.loop_header410.preheader ], [ %indvars.iv.next868, %polly.loop_exit419 ]
  %polly.indvar414 = phi i64 [ %143, %polly.loop_header410.preheader ], [ %polly.indvar_next415, %polly.loop_exit419 ]
  %smin869 = call i64 @llvm.smin.i64(i64 %indvars.iv867, i64 79)
  %146 = add nsw i64 %polly.indvar414, %145
  %polly.loop_guard427944 = icmp sgt i64 %146, -1
  %147 = add nuw nsw i64 %polly.indvar414, %137
  %148 = mul i64 %147, 8000
  %149 = mul i64 %147, 9600
  br i1 %polly.loop_guard427944, label %polly.loop_header417.us, label %polly.loop_exit419
...
polly.loop_header417.us:                          ; preds = %polly.loop_header410, %polly.loop_exit426.loopexit.us
  ...
  %150 = add nuw nsw i64 %polly.indvar420.us, %138
  %151 = shl i64 %150, 3
  %polly.access.mul.Packed_MemRef_call2275434.us = mul nuw nsw i64 %150, 1200
  %polly.access.add.Packed_MemRef_call2275435.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2275434.us, %147
  ...
  %152 = add i64 %151, %148
  %scevgep442.us = getelementptr i8, i8* %call1, i64 %152
...
polly.loop_header424.us:                          ; preds = %polly.loop_header417.us, %polly.loop_header424.us
  ...
  %153 = add nuw nsw i64 %polly.indvar428.us, %140
  %154 = mul nuw nsw i64 %153, 8000
  %155 = add nuw nsw i64 %154, %151
  %scevgep431.us = getelementptr i8, i8* %call1, i64 %155
  ...
  %polly.access.add.Packed_MemRef_call2275439.us = add nuw nsw i64 %153, %polly.access.mul.Packed_MemRef_call2275434.us
  ...
  %156 = shl i64 %153, 3
  %157 = add i64 %156, %149
  %scevgep445.us = getelementptr i8, i8* %call, i64 %157
...
polly.loop_exit426.loopexit.us:                   ; preds = %polly.loop_header424.us
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar420.us, %139
...
polly.loop_exit419:                               ; preds = %polly.loop_exit426.loopexit.us, %polly.loop_header410
  ...
  %polly.loop_cond416.not.not = icmp ult i64 %polly.indvar414, %136
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1029 = icmp ult i64 %158, 4
  br i1 %min.iters.check1029, label %polly.loop_header542.preheader, label %vector.ph1030

vector.ph1030:                                    ; preds = %polly.loop_header536
  %n.vec1032 = and i64 %158, -4
...
vector.body1028:                                  ; preds = %vector.body1028, %vector.ph1030
  ...
  %160 = shl nuw nsw i64 %index1033, 3
  %161 = getelementptr i8, i8* %scevgep548, i64 %160
  %162 = bitcast i8* %161 to <4 x double>*
  %wide.load1037 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !84, !noalias !86
  %163 = fmul fast <4 x double> %wide.load1037, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %165 = icmp eq i64 %index.next1034, %n.vec1032
  br i1 %165, label %middle.block1026, label %vector.body1028, !llvm.loop !90

middle.block1026:                                 ; preds = %vector.body1028
  %cmp.n1036 = icmp eq i64 %158, %n.vec1032
  br i1 %cmp.n1036, label %polly.loop_exit544, label %polly.loop_header542.preheader

polly.loop_header542.preheader:                   ; preds = %polly.loop_header536, %middle.block1026
  %polly.indvar545.ph = phi i64 [ 0, %polly.loop_header536 ], [ %n.vec1032, %middle.block1026 ]
  br label %polly.loop_header542

polly.loop_exit544:                               ; preds = %polly.loop_header542, %middle.block1026
  %polly.indvar_next540 = add nuw nsw i64 %polly.indvar539, 1
  %exitcond911.not = icmp eq i64 %polly.indvar_next540, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond911.not, label %polly.loop_header552.preheader, label %polly.loop_header536
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  %exitcond910.not = icmp eq i64 %polly.indvar_next546, %polly.indvar539
  br i1 %exitcond910.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !91
...
polly.loop_exit560:                               ; preds = %polly.loop_header558
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar_next556, 1000
  br i1 %exitcond909.not, label %polly.loop_header568, label %polly.loop_header552
...
polly.loop_header558:                             ; preds = %polly.loop_header558, %polly.loop_header552
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar_next562, 1200
  br i1 %exitcond908.not, label %polly.loop_exit560, label %polly.loop_header558

polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv902 = phi i64 [ %indvars.iv.next903, %polly.loop_exit576 ], [ 1, %polly.loop_exit560 ]
  %indvars.iv890 = phi i64 [ %indvars.iv.next891, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %polly.indvar571 = phi i64 [ %polly.indvar_next572, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %167 = udiv i64 %indvars.iv902, 5
  %umin904 = call i64 @llvm.umin.i64(i64 %167, i64 14)
  %168 = mul nsw i64 %polly.indvar571, -32
  %169 = icmp slt i64 %168, -1168
  %170 = select i1 %169, i64 %168, i64 -1168
  %171 = add nsw i64 %170, 1199
  %172 = shl nsw i64 %polly.indvar571, 5
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next572, 38
  br i1 %exitcond907.not, label %polly.exiting451, label %polly.loop_header568

polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  %indvars.iv898 = phi i64 [ %indvars.iv.next899, %polly.loop_exit583 ], [ 0, %polly.loop_header568 ]
  %polly.indvar577 = phi i64 [ %polly.indvar_next578, %polly.loop_exit583 ], [ 0, %polly.loop_header568 ]
  %smin900 = call i64 @llvm.smin.i64(i64 %indvars.iv898, i64 -984)
  %173 = shl nsw i64 %polly.indvar577, 4
  %174 = add nsw i64 %smin900, 999
  br label %polly.loop_header581

polly.loop_exit583:                               ; preds = %polly.loop_exit590
  %polly.indvar_next578 = add nuw nsw i64 %polly.indvar577, 1
  %indvars.iv.next899 = add nsw i64 %indvars.iv898, -16
  %exitcond906.not = icmp eq i64 %polly.indvar_next578, 63
  br i1 %exitcond906.not, label %polly.loop_exit576, label %polly.loop_header574
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %indvars.iv887 = phi i64 [ %indvars.iv.next888, %polly.loop_exit590 ], [ %indvars.iv885, %polly.loop_header574 ]
  %polly.indvar584 = phi i64 [ %polly.indvar_next585, %polly.loop_exit590 ], [ 0, %polly.loop_header574 ]
  %175 = mul nuw nsw i64 %polly.indvar584, 80
  %176 = add nsw i64 %175, %168
  %177 = icmp sgt i64 %176, 0
  %178 = select i1 %177, i64 %176, i64 0
  %polly.loop_guard591.not = icmp sgt i64 %178, %171
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  ...
  %179 = add i64 %smax889, %indvars.iv892
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %indvars.iv.next893 = add nsw i64 %indvars.iv892, -80
  %exitcond905.not = icmp eq i64 %polly.indvar584, %umin904
  br i1 %exitcond905.not, label %polly.loop_exit583, label %polly.loop_header581

polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv894 = phi i64 [ %179, %polly.loop_header588.preheader ], [ %indvars.iv.next895, %polly.loop_exit597 ]
  %polly.indvar592 = phi i64 [ %178, %polly.loop_header588.preheader ], [ %polly.indvar_next593, %polly.loop_exit597 ]
  %smin896 = call i64 @llvm.smin.i64(i64 %indvars.iv894, i64 79)
  %181 = add nsw i64 %polly.indvar592, %180
  %polly.loop_guard605945 = icmp sgt i64 %181, -1
  %182 = add nuw nsw i64 %polly.indvar592, %172
  %183 = mul i64 %182, 8000
  %184 = mul i64 %182, 9600
  br i1 %polly.loop_guard605945, label %polly.loop_header595.us, label %polly.loop_exit597
...
polly.loop_header595.us:                          ; preds = %polly.loop_header588, %polly.loop_exit604.loopexit.us
  ...
  %186 = shl i64 %185, 3
  %polly.access.mul.Packed_MemRef_call2453612.us = mul nuw nsw i64 %185, 1200
  %polly.access.add.Packed_MemRef_call2453613.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2453612.us, %182
  ...
  %187 = add i64 %186, %183
  %scevgep620.us = getelementptr i8, i8* %call1, i64 %187
...
polly.loop_header602.us:                          ; preds = %polly.loop_header595.us, %polly.loop_header602.us
  ...
  %188 = add nuw nsw i64 %polly.indvar606.us, %175
  %189 = mul nuw nsw i64 %188, 8000
  %190 = add nuw nsw i64 %189, %186
  %scevgep609.us = getelementptr i8, i8* %call1, i64 %190
  ...
  %polly.access.add.Packed_MemRef_call2453617.us = add nuw nsw i64 %188, %polly.access.mul.Packed_MemRef_call2453612.us
  ...
  %191 = shl i64 %188, 3
  %192 = add i64 %191, %184
  %scevgep623.us = getelementptr i8, i8* %call, i64 %192
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar606.us, %smin896
  br i1 %exitcond897.not, label %polly.loop_exit604.loopexit.us, label %polly.loop_header602.us

polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  %polly.indvar_next599.us = add nuw nsw i64 %polly.indvar598.us, 1
  %exitcond901.not = icmp eq i64 %polly.indvar598.us, %174
  br i1 %exitcond901.not, label %polly.loop_exit597, label %polly.loop_header595.us
...
polly.loop_exit597:                               ; preds = %polly.loop_exit604.loopexit.us, %polly.loop_header588
  ...
  %polly.loop_cond594.not.not = icmp ult i64 %polly.indvar592, %171
...
polly.loop_header752:                             ; preds = %entry, %polly.loop_exit760
  %indvars.iv936 = phi i64 [ %indvars.iv.next937, %polly.loop_exit760 ], [ 0, %entry ]
...
polly.loop_exit760:                               ; preds = %polly.loop_exit766
  ...
  %exitcond941.not = icmp eq i64 %polly.indvar_next756, 38
  br i1 %exitcond941.not, label %polly.loop_header779, label %polly.loop_header752

polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  %indvars.iv932 = phi i64 [ %indvars.iv.next933, %polly.loop_exit766 ], [ 0, %polly.loop_header752 ]
  %polly.indvar761 = phi i64 [ %polly.indvar_next762, %polly.loop_exit766 ], [ 0, %polly.loop_header752 ]
  %195 = mul nsw i64 %polly.indvar761, -32
  %smin967 = call i64 @llvm.smin.i64(i64 %195, i64 -1168)
  %196 = add nsw i64 %smin967, 1200
  %smin934 = call i64 @llvm.smin.i64(i64 %indvars.iv932, i64 -1168)
  %197 = shl nsw i64 %polly.indvar761, 5
  %198 = add nsw i64 %smin934, 1199
...
polly.loop_exit766:                               ; preds = %polly.loop_exit772
  ...
  br i1 %exitcond940.not, label %polly.loop_exit760, label %polly.loop_header758
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  br i1 %min.iters.check, label %polly.loop_header770, label %vector.ph968

vector.ph968:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert975 = insertelement <4 x i64> poison, i64 %197, i32 0
  %broadcast.splat976 = shufflevector <4 x i64> %broadcast.splatinsert975, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert977 = insertelement <4 x i32> poison, i32 %200, i32 0
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  %202 = add nuw nsw <4 x i64> %vec.ind973, %broadcast.splat976
  %203 = trunc <4 x i64> %202 to <4 x i32>
  %204 = mul <4 x i32> %broadcast.splat978, %203
  ...
  %214 = icmp eq i64 %index.next970, %196
  br i1 %214, label %polly.loop_exit772, label %vector.body966, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body966, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond939.not = icmp eq i64 %polly.indvar767, %194
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar773, %198
  br i1 %exitcond935.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !100

polly.loop_header779:                             ; preds = %polly.loop_exit760, %polly.loop_exit787
  %indvars.iv926 = phi i64 [ %indvars.iv.next927, %polly.loop_exit787 ], [ 0, %polly.loop_exit760 ]
...
polly.loop_exit787:                               ; preds = %polly.loop_exit793
  ...
  %exitcond931.not = icmp eq i64 %polly.indvar_next783, 38
  br i1 %exitcond931.not, label %polly.loop_header805, label %polly.loop_header779

polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  %indvars.iv922 = phi i64 [ %indvars.iv.next923, %polly.loop_exit793 ], [ 0, %polly.loop_header779 ]
  %polly.indvar788 = phi i64 [ %polly.indvar_next789, %polly.loop_exit793 ], [ 0, %polly.loop_header779 ]
  %224 = mul nsw i64 %polly.indvar788, -32
  %smin982 = call i64 @llvm.smin.i64(i64 %224, i64 -968)
  %225 = add nsw i64 %smin982, 1000
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 -968)
  %226 = shl nsw i64 %polly.indvar788, 5
  %227 = add nsw i64 %smin924, 999
  br label %polly.loop_header791

polly.loop_exit793:                               ; preds = %polly.loop_exit799
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %indvars.iv.next923 = add nsw i64 %indvars.iv922, -32
  %exitcond930.not = icmp eq i64 %polly.indvar_next789, 32
  br i1 %exitcond930.not, label %polly.loop_exit787, label %polly.loop_header785
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %min.iters.check983 = icmp eq i64 %225, 0
  br i1 %min.iters.check983, label %polly.loop_header797, label %vector.ph984

vector.ph984:                                     ; preds = %polly.loop_header791
  %broadcast.splatinsert993 = insertelement <4 x i64> poison, i64 %226, i32 0
  %broadcast.splat994 = shufflevector <4 x i64> %broadcast.splatinsert993, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert995 = insertelement <4 x i32> poison, i32 %229, i32 0
...
vector.body981:                                   ; preds = %vector.body981, %vector.ph984
  ...
  %231 = add nuw nsw <4 x i64> %vec.ind991, %broadcast.splat994
  %232 = trunc <4 x i64> %231 to <4 x i32>
  %233 = mul <4 x i32> %broadcast.splat996, %232
  ...
  %243 = icmp eq i64 %index.next988, %225
  br i1 %243, label %polly.loop_exit799, label %vector.body981, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body981, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond929.not = icmp eq i64 %polly.indvar794, %223
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond925.not = icmp eq i64 %polly.indvar800, %227
  br i1 %exitcond925.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !103

polly.loop_header805:                             ; preds = %polly.loop_exit787, %polly.loop_exit813
  %indvars.iv916 = phi i64 [ %indvars.iv.next917, %polly.loop_exit813 ], [ 0, %polly.loop_exit787 ]
  ...
  %252 = add nsw i64 %smin918, 1199
  br label %polly.loop_header811

polly.loop_exit813:                               ; preds = %polly.loop_exit819
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %indvars.iv.next917 = add nsw i64 %indvars.iv916, -32
  %exitcond921.not = icmp eq i64 %polly.indvar_next809, 38
  br i1 %exitcond921.not, label %init_array.exit, label %polly.loop_header805

polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  %indvars.iv912 = phi i64 [ %indvars.iv.next913, %polly.loop_exit819 ], [ 0, %polly.loop_header805 ]
  %polly.indvar814 = phi i64 [ %polly.indvar_next815, %polly.loop_exit819 ], [ 0, %polly.loop_header805 ]
  %253 = mul nsw i64 %polly.indvar814, -32
  %smin1000 = call i64 @llvm.smin.i64(i64 %253, i64 -968)
  %254 = add nsw i64 %smin1000, 1000
  %smin914 = call i64 @llvm.smin.i64(i64 %indvars.iv912, i64 -968)
  %255 = shl nsw i64 %polly.indvar814, 5
  %256 = add nsw i64 %smin914, 999
  br label %polly.loop_header817

polly.loop_exit819:                               ; preds = %polly.loop_exit825
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %indvars.iv.next913 = add nsw i64 %indvars.iv912, -32
  %exitcond920.not = icmp eq i64 %polly.indvar_next815, 32
  br i1 %exitcond920.not, label %polly.loop_exit813, label %polly.loop_header811
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %min.iters.check1001 = icmp eq i64 %254, 0
  br i1 %min.iters.check1001, label %polly.loop_header823, label %vector.ph1002

vector.ph1002:                                    ; preds = %polly.loop_header817
  %broadcast.splatinsert1011 = insertelement <4 x i64> poison, i64 %255, i32 0
  %broadcast.splat1012 = shufflevector <4 x i64> %broadcast.splatinsert1011, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1013 = insertelement <4 x i32> poison, i32 %258, i32 0
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1002
  ...
  %260 = add nuw nsw <4 x i64> %vec.ind1009, %broadcast.splat1012
  %261 = trunc <4 x i64> %260 to <4 x i32>
  %262 = mul <4 x i32> %broadcast.splat1014, %261
  ...
  %272 = icmp eq i64 %index.next1006, %254
  br i1 %272, label %polly.loop_exit825, label %vector.body999, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body999, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond919.not = icmp eq i64 %polly.indvar820, %252
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar826, %256
  br i1 %exitcond915.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !106
}
