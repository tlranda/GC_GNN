; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7188.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7188.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next219, 38
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  ...
  %107 = shl nsw i64 %polly.indvar224, 5
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %109 = mul nsw i64 %polly.indvar230, 50
...
vector.body1052:                                  ; preds = %vector.body1052, %vector.ph1056
  ...
  %wide.load1063 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %134, label %middle.block1050, label %vector.body1052, !llvm.loop !79
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  ...
  %146 = shl nsw i64 %polly.indvar401, 5
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %indvars.iv.next872 = add i64 %indvars.iv871, -50
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  ...
  %smin875 = call i64 @llvm.smin.i64(i64 %indvars.iv873, i64 49)
...
vector.body1028:                                  ; preds = %vector.body1028, %vector.ph1030
  ...
  %wide.load1037 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %173, label %middle.block1026, label %vector.body1028, !llvm.loop !89
...
polly.loop_exit580:                               ; preds = %polly.loop_exit588
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next576, 38
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  ...
  %185 = shl nsw i64 %polly.indvar581, 5
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %187 = mul nsw i64 %polly.indvar590, 50
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  br i1 %226, label %polly.loop_exit778, label %vector.body966, !llvm.loop !98
...
vector.body981:                                   ; preds = %vector.body981, %vector.ph984
  ...
  br i1 %255, label %polly.loop_exit805, label %vector.body981, !llvm.loop !101
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1002
  ...
  br i1 %284, label %polly.loop_exit831, label %vector.body999, !llvm.loop !104
