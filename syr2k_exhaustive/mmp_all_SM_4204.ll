; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4204.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4204.c"
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header387
  ...
  %130 = shl nsw i64 %polly.indvar397, 4
  %131 = sub nsw i64 %128, %130
  %132 = add nuw nsw i64 %130, 16
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header576
  ...
  %160 = shl nsw i64 %polly.indvar586, 4
  %161 = sub nsw i64 %158, %160
  %162 = add nuw nsw i64 %160, 16
...
polly.loop_header589:                             ; preds = %polly.loop_exit626, %polly.loop_header583
  ...
  %smin1021 = call i64 @llvm.smin.i64(i64 %indvars.iv1016, i64 15)
