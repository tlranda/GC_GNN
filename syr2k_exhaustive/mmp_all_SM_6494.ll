; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6494.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6494.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %indvars.iv.next857 = add nuw nsw i64 %indvars.iv856, 32
  %indvars.iv.next859 = add nuw nsw i64 %indvars.iv858, 8
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -32
  %exitcond872.not = icmp eq i64 %polly.indvar_next209, 38
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233.us, %polly.loop_exit248.us
  ...
  %smin868 = call i64 @llvm.smin.i64(i64 %indvars.iv866, i64 31)
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %140 = shl nsw i64 %polly.indvar383, 5
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %141 = mul nsw i64 %polly.indvar383, -32
  %142 = shl nsw i64 %polly.indvar383, 3
...
polly.loop_exit405:                               ; preds = %polly.loop_exit411
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar_next384, 38
...
polly.loop_header416.us:                          ; preds = %polly.loop_header409.us, %polly.loop_exit426.us
  ...
  %smin896 = call i64 @llvm.smin.i64(i64 %indvars.iv894, i64 31)
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %177 = shl nsw i64 %polly.indvar561, 5
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %178 = mul nsw i64 %polly.indvar561, -32
  %179 = shl nsw i64 %polly.indvar561, 3
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %indvars.iv.next912 = add nuw nsw i64 %indvars.iv911, 32
  %indvars.iv.next914 = add nuw nsw i64 %indvars.iv913, 8
  %indvars.iv.next919 = add nsw i64 %indvars.iv918, -32
  %exitcond928.not = icmp eq i64 %polly.indvar_next562, 38
