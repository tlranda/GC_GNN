; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7450.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7450.c"
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249943 = icmp sgt i64 %113, -1
...
vector.body1052:                                  ; preds = %vector.body1052, %vector.ph1056
  ...
  %127 = shl nuw nsw i64 %index1059, 3
  %128 = getelementptr i8, i8* %scevgep370, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1063 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !73, !noalias !75
  %130 = fmul fast <4 x double> %wide.load1063, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1060, %n.vec1058
  br i1 %132, label %middle.block1050, label %vector.body1052, !llvm.loop !79

middle.block1050:                                 ; preds = %vector.body1052
  %cmp.n1062 = icmp eq i64 %125, %n.vec1058
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv875 = phi i64 [ %indvars.iv.next876, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  ...
  %134 = udiv i64 %polly.indvar393, 5
  %135 = add nuw i64 %indvars.iv875, %134
  %umin877 = call i64 @llvm.umin.i64(i64 %135, i64 56)
  %136 = mul nsw i64 %polly.indvar393, -64
  %137 = icmp slt i64 %136, -1136
  %138 = select i1 %137, i64 %136, i64 -1136
  %139 = add nsw i64 %138, 1199
  %140 = shl nsw i64 %polly.indvar393, 6
  %141 = add nuw nsw i64 %umin877, 3
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %indvars.iv.next876 = add nuw nsw i64 %indvars.iv875, 3
  %exitcond880.not = icmp eq i64 %polly.indvar_next394, 19
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %148 = add i64 %smax862, %indvars.iv865
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar406, %141
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv867 = phi i64 [ %148, %polly.loop_header410.preheader ], [ %indvars.iv.next868, %polly.loop_exit419 ]
  ...
  %polly.loop_guard427944 = icmp sgt i64 %150, -1
...
polly.loop_exit426.loopexit.us:                   ; preds = %polly.loop_header424.us
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar420.us, %143
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1029 = icmp ult i64 %162, 4
...
vector.body1028:                                  ; preds = %vector.body1028, %vector.ph1030
  ...
  %164 = shl nuw nsw i64 %index1033, 3
  %165 = getelementptr i8, i8* %scevgep548, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load1037 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !83, !noalias !85
  %167 = fmul fast <4 x double> %wide.load1037, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next1034, %n.vec1032
  br i1 %169, label %middle.block1026, label %vector.body1028, !llvm.loop !89

middle.block1026:                                 ; preds = %vector.body1028
  %cmp.n1036 = icmp eq i64 %162, %n.vec1032
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv902 = phi i64 [ %indvars.iv.next903, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  ...
  %171 = udiv i64 %polly.indvar571, 5
  %172 = add nuw i64 %indvars.iv902, %171
  %umin904 = call i64 @llvm.umin.i64(i64 %172, i64 56)
  %173 = mul nsw i64 %polly.indvar571, -64
  %174 = icmp slt i64 %173, -1136
  %175 = select i1 %174, i64 %173, i64 -1136
  %176 = add nsw i64 %175, 1199
  %177 = shl nsw i64 %polly.indvar571, 6
  %178 = add nuw nsw i64 %umin904, 3
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next572, 19
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  ...
  %185 = add i64 %smax889, %indvars.iv892
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, 20
  %indvars.iv.next893 = add nsw i64 %indvars.iv892, -20
  %exitcond905.not = icmp eq i64 %polly.indvar584, %178
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv894 = phi i64 [ %185, %polly.loop_header588.preheader ], [ %indvars.iv.next895, %polly.loop_exit597 ]
  ...
  %polly.loop_guard605945 = icmp sgt i64 %187, -1
...
polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar598.us, %180
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin967 = call i64 @llvm.smin.i64(i64 %201, i64 -1168)
  %202 = add nsw i64 %smin967, 1200
  %smin934 = call i64 @llvm.smin.i64(i64 %indvars.iv932, i64 -1168)
  %203 = shl nsw i64 %polly.indvar761, 5
  %204 = add nsw i64 %smin934, 1199
...
vector.ph968:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert975 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat976 = shufflevector <4 x i64> %broadcast.splatinsert975, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert977 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  %208 = add nuw nsw <4 x i64> %vec.ind973, %broadcast.splat976
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat978, %209
  ...
  %220 = icmp eq i64 %index.next970, %202
  br i1 %220, label %polly.loop_exit772, label %vector.body966, !llvm.loop !98

polly.loop_exit772:                               ; preds = %vector.body966, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond939.not = icmp eq i64 %polly.indvar767, %200
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar773, %204
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin982 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin982, 1000
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 -968)
  %232 = shl nsw i64 %polly.indvar788, 5
  %233 = add nsw i64 %smin924, 999
...
vector.body981:                                   ; preds = %vector.body981, %vector.ph984
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind991, %broadcast.splat994
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat996, %238
  ...
  %249 = icmp eq i64 %index.next988, %231
  br i1 %249, label %polly.loop_exit799, label %vector.body981, !llvm.loop !101

polly.loop_exit799:                               ; preds = %vector.body981, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond929.not = icmp eq i64 %polly.indvar794, %229
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond925.not = icmp eq i64 %polly.indvar800, %233
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1000 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin1000, 1000
  %smin914 = call i64 @llvm.smin.i64(i64 %indvars.iv912, i64 -968)
  %261 = shl nsw i64 %polly.indvar814, 5
  %262 = add nsw i64 %smin914, 999
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1002
  ...
  %266 = add nuw nsw <4 x i64> %vec.ind1009, %broadcast.splat1012
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat1014, %267
  ...
  %278 = icmp eq i64 %index.next1006, %260
  br i1 %278, label %polly.loop_exit825, label %vector.body999, !llvm.loop !104

polly.loop_exit825:                               ; preds = %vector.body999, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond919.not = icmp eq i64 %polly.indvar820, %258
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar826, %262
