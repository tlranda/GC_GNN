; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4365.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4365.c"
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %140 = lshr i64 %indvars.iv1015, 5
  %141 = mul nsw i64 %polly.indvar386, -20
  %142 = mul nuw nsw i64 %polly.indvar386, 20
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %154 = shl nsw i64 %polly.indvar399, 7
  %155 = add nsw i64 %154, %141
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %polly.loop_guard406 = icmp slt i64 %157, 20
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %183 = lshr i64 %indvars.iv1040, 5
  %184 = mul nsw i64 %polly.indvar577, -20
  %185 = mul nuw nsw i64 %polly.indvar577, 20
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %polly.loop_guard597 = icmp slt i64 %200, 20
