; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5308.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5308.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv993, i64 18)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next994 = add nuw nsw i64 %indvars.iv993, 2
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin991 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -872)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond996.not = icmp eq i64 %polly.indvar_next209, 8
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  %indvars.iv1023 = phi i64 [ 1, %polly.loop_header383.preheader ], [ %indvars.iv.next1024, %polly.loop_exit391 ]
  ...
  %umin1025 = call i64 @llvm.umin.i64(i64 %indvars.iv1023, i64 18)
  %135 = mul nsw i64 %polly.indvar386, -128
  %136 = icmp slt i64 %135, -1072
  %137 = select i1 %136, i64 %135, i64 -1072
  %138 = add nsw i64 %137, 1199
  %139 = shl nsw i64 %polly.indvar386, 7
...
polly.loop_exit391:                               ; preds = %polly.loop_exit397
  ...
  %indvars.iv.next1010 = add nuw nsw i64 %indvars.iv1009, 128
  %indvars.iv.next1024 = add nuw nsw i64 %indvars.iv1023, 2
  %exitcond1028.not = icmp eq i64 %polly.indvar_next387, 10
...
polly.loop_header389:                             ; preds = %polly.loop_exit397, %polly.loop_header383
  ...
  %smin1021 = call i64 @llvm.smin.i64(i64 %indvars.iv1000, i64 -872)
  %140 = add nsw i64 %smin1021, 1000
  %141 = shl nsw i64 %polly.indvar392, 7
...
polly.loop_exit397:                               ; preds = %polly.loop_exit404
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next393, 8
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  %indvars.iv1054 = phi i64 [ 1, %polly.loop_header573.preheader ], [ %indvars.iv.next1055, %polly.loop_exit581 ]
  ...
  %umin1056 = call i64 @llvm.umin.i64(i64 %indvars.iv1054, i64 18)
  %173 = mul nsw i64 %polly.indvar576, -128
  %174 = icmp slt i64 %173, -1072
  %175 = select i1 %174, i64 %173, i64 -1072
  %176 = add nsw i64 %175, 1199
  %177 = shl nsw i64 %polly.indvar576, 7
...
polly.loop_exit581:                               ; preds = %polly.loop_exit587
  ...
  %exitcond1059.not = icmp eq i64 %polly.indvar_next577, 10
...
polly.loop_header579:                             ; preds = %polly.loop_exit587, %polly.loop_header573
  ...
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1031, i64 -872)
  %178 = add nsw i64 %smin1052, 1000
  %179 = shl nsw i64 %polly.indvar582, 7
...
polly.loop_exit587:                               ; preds = %polly.loop_exit594
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next583, 8
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %180 = shl nsw i64 %polly.indvar588, 6
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit630
  ...
  %smin1050 = call i64 @llvm.smin.i64(i64 %indvars.iv1044, i64 63)
