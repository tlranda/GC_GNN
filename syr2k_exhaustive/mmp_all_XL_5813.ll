; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5813.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5813.c"
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  ...
  %polly.loop_guard = icmp slt i64 %308, 38
...
polly.loop_exit396.3:                             ; preds = %polly.loop_header394.3
  %342 = mul nsw i64 %polly.indvar385, -50
  ...
  %polly.loop_guard409 = icmp slt i64 %346, 38
...
polly.loop_exit576.3:                             ; preds = %polly.loop_header574.3
  %380 = mul nsw i64 %polly.indvar565, -50
  ...
  %polly.loop_guard589 = icmp slt i64 %384, 38
