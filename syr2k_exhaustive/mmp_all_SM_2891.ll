; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2891.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2891.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin908 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -872)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond912.not = icmp eq i64 %polly.indvar_next203, 8
...
polly.start285:                                   ; preds = %kernel_syr2k.exit
  %malloccall287 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
polly.loop_header387:                             ; preds = %polly.loop_header387.preheader, %polly.loop_exit395
  ...
  %167 = shl nsw i64 %polly.indvar390, 7
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond933.not = icmp eq i64 %polly.indvar_next391, 8
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %168 = shl nuw nsw i64 %polly.indvar396, 4
  %169 = mul nsw i64 %polly.indvar396, -128
  %170 = shl nsw i64 %polly.indvar396, 7
...
polly.loop_header399:                             ; preds = %polly.loop_exit440, %polly.loop_header393
  ...
  %.inv869 = icmp ugt i64 %172, 127
  %174 = select i1 %.inv869, i64 127, i64 %173
...
polly.start475:                                   ; preds = %init_array.exit
  %malloccall477 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
polly.loop_header577:                             ; preds = %polly.loop_header577.preheader, %polly.loop_exit585
  ...
  %smin950 = call i64 @llvm.smin.i64(i64 %indvars.iv936, i64 -872)
  %235 = add nsw i64 %smin950, 1000
  %236 = shl nsw i64 %polly.indvar580, 7
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %exitcond954.not = icmp eq i64 %polly.indvar_next581, 8
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %237 = shl nuw nsw i64 %polly.indvar586, 4
  %238 = mul nsw i64 %polly.indvar586, -128
  %239 = shl nsw i64 %polly.indvar586, 7
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %241, 127
  %243 = select i1 %.inv870, i64 127, i64 %242
