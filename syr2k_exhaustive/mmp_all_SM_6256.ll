; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6256.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6256.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next209, 12
...
vector.body1065:                                  ; preds = %vector.body1065, %vector.ph1069
  ...
  %wide.load1076 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %132, label %middle.block1063, label %vector.body1065, !llvm.loop !84
...
polly.loop_header416.us:                          ; preds = %polly.loop_header409.us, %polly.loop_exit426.us
  ...
  %smin892 = call i64 @llvm.smin.i64(i64 %indvars.iv890, i64 99)
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1043
  ...
  %wide.load1050 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %169, label %middle.block1039, label %vector.body1041, !llvm.loop !94
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %178 = mul nuw nsw i64 %polly.indvar561, 100
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %179 = mul nsw i64 %polly.indvar561, -100
  br label %polly.loop_header581

polly.loop_exit583:                               ; preds = %polly.loop_exit589
  %polly.indvar_next562 = add nuw nsw i64 %polly.indvar561, 1
  %indvars.iv.next901 = add nsw i64 %indvars.iv900, -100
  %indvars.iv.next908 = add nuw nsw i64 %indvars.iv907, 100
  %indvars.iv.next913 = add nsw i64 %indvars.iv912, -100
  %exitcond922.not = icmp eq i64 %polly.indvar_next562, 12
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph981
  ...
  br i1 %220, label %polly.loop_exit772, label %vector.body980, !llvm.loop !103
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph997
  ...
  br i1 %249, label %polly.loop_exit799, label %vector.body994, !llvm.loop !106
...
vector.body1012:                                  ; preds = %vector.body1012, %vector.ph1015
  ...
  br i1 %278, label %polly.loop_exit825, label %vector.body1012, !llvm.loop !109
