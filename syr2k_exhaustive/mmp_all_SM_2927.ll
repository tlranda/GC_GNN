; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2927.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2927.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1031.not = icmp eq i64 %112, 150
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %polly.loop_guard256 = icmp slt i64 %125, 16
...
polly.loop_header253.us:                          ; preds = %polly.loop_header246.us, %polly.loop_exit263.us
  %indvars.iv1024 = phi i64 [ %113, %polly.loop_header246.us ], [ %indvars.iv.next1025, %polly.loop_exit263.us ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %150 = lshr i64 %polly.indvar398, 1
  %151 = shl nuw nsw i64 %150, 4
  %152 = sub nsw i64 %indvars.iv1042, %151
  %153 = add i64 %indvars.iv1047, %151
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1058.not = icmp eq i64 %163, 150
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1049 = phi i64 [ %indvars.iv.next1050, %polly.loop_exit445 ], [ %153, %polly.loop_header395 ]
  %indvars.iv1044 = phi i64 [ %indvars.iv.next1045, %polly.loop_exit445 ], [ %152, %polly.loop_header395 ]
  %polly.indvar405 = phi i64 [ %polly.indvar_next406, %polly.loop_exit445 ], [ %150, %polly.loop_header395 ]
  %smax1046 = call i64 @llvm.smax.i64(i64 %indvars.iv1044, i64 0)
  %164 = add i64 %smax1046, %indvars.iv1049
  %165 = shl nuw nsw i64 %polly.indvar405, 1
  %.not.not885 = icmp ugt i64 %165, %polly.indvar398
  %166 = shl nsw i64 %polly.indvar405, 4
  %167 = add nsw i64 %166, %155
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %170 = add nsw i64 %167, 15
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_header408.us
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next412.us, %148
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1038.not = icmp eq i64 %polly.indvar_next412, %148
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %polly.loop_guard453 = icmp slt i64 %176, 16
...
polly.loop_header450.us:                          ; preds = %polly.loop_header443.us, %polly.loop_exit460.us
  %indvars.iv1051 = phi i64 [ %164, %polly.loop_header443.us ], [ %indvars.iv.next1052, %polly.loop_exit460.us ]
...
polly.loop_exit452.loopexit.us:                   ; preds = %polly.loop_exit460.us
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next447.us, %148
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %201 = lshr i64 %polly.indvar595, 1
  %202 = shl nuw nsw i64 %201, 4
  %203 = sub nsw i64 %indvars.iv1069, %202
  %204 = add i64 %indvars.iv1074, %202
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1076 = phi i64 [ %indvars.iv.next1077, %polly.loop_exit642 ], [ %204, %polly.loop_header592 ]
  %indvars.iv1071 = phi i64 [ %indvars.iv.next1072, %polly.loop_exit642 ], [ %203, %polly.loop_header592 ]
  %polly.indvar602 = phi i64 [ %polly.indvar_next603, %polly.loop_exit642 ], [ %201, %polly.loop_header592 ]
  %smax1073 = call i64 @llvm.smax.i64(i64 %indvars.iv1071, i64 0)
  %215 = add i64 %smax1073, %indvars.iv1076
  %216 = shl nuw nsw i64 %polly.indvar602, 1
  %.not.not886 = icmp ugt i64 %216, %polly.indvar595
  %217 = shl nsw i64 %polly.indvar602, 4
  %218 = add nsw i64 %217, %206
  %219 = icmp sgt i64 %218, 0
  %220 = select i1 %219, i64 %218, i64 0
  %221 = add nsw i64 %218, 15
...
polly.loop_exit628.us:                            ; preds = %polly.loop_header626.us, %polly.loop_header605.us
  ...
  %exitcond1068.not = icmp eq i64 %polly.indvar_next609.us, %199
...
polly.loop_exit628:                               ; preds = %polly.loop_header626
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next609, %199
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %polly.loop_guard650 = icmp slt i64 %227, 16
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.us, %polly.loop_exit657.us
  %indvars.iv1078 = phi i64 [ %215, %polly.loop_header640.us ], [ %indvars.iv.next1079, %polly.loop_exit657.us ]
...
polly.loop_exit649.loopexit.us:                   ; preds = %polly.loop_exit657.us
  ...
  %exitcond1083.not = icmp eq i64 %polly.indvar_next644.us, %199
