; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7406.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7406.c"
...
vector.body1052:                                  ; preds = %vector.body1052, %vector.ph1056
  ...
  %wide.load1063 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %132, label %middle.block1050, label %vector.body1052, !llvm.loop !80
...
vector.body1028:                                  ; preds = %vector.body1028, %vector.ph1030
  ...
  %wide.load1037 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %169, label %middle.block1026, label %vector.body1028, !llvm.loop !90
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  br i1 %220, label %polly.loop_exit772, label %vector.body966, !llvm.loop !99
...
vector.body981:                                   ; preds = %vector.body981, %vector.ph984
  ...
  br i1 %249, label %polly.loop_exit799, label %vector.body981, !llvm.loop !102
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1002
  ...
  br i1 %278, label %polly.loop_exit825, label %vector.body999, !llvm.loop !105
