; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10635.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10635.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin787 = call i64 @llvm.smin.i64(i64 %indvars.iv785, i64 -1072)
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin783 = call i64 @llvm.smin.i64(i64 %indvars.iv781, i64 -872)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond792.not = icmp eq i64 %polly.indvar_next209, 8
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %smin810 = call i64 @llvm.smin.i64(i64 %indvars.iv808, i64 -1072)
  %124 = shl nsw i64 %polly.indvar355, 7
  %125 = add nsw i64 %smin810, 1199
  br label %polly.loop_header358

polly.loop_exit360:                               ; preds = %polly.loop_exit366
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next797 = add nuw nsw i64 %indvars.iv796, 128
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %126 = shl nsw i64 %polly.indvar361, 7
...
polly.loop_exit366:                               ; preds = %polly.loop_exit372
  ...
  %exitcond815.not = icmp eq i64 %polly.indvar_next362, 8
...
polly.loop_header370:                             ; preds = %polly.loop_exit378, %polly.loop_header364
  ...
  %smin802 = call i64 @llvm.smin.i64(i64 %indvars.iv800, i64 127)
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %smin833 = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 -1072)
  %151 = shl nsw i64 %polly.indvar510, 7
...
polly.loop_exit515:                               ; preds = %polly.loop_exit521
  ...
  %exitcond839.not = icmp eq i64 %polly.indvar_next511, 10
...
polly.loop_header513:                             ; preds = %polly.loop_exit521, %polly.loop_header507
  ...
  %153 = shl nsw i64 %polly.indvar516, 7
...
polly.loop_exit521:                               ; preds = %polly.loop_exit527
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar_next517, 8
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %155 = shl nsw i64 %polly.indvar522, 7
