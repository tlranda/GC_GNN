; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4243.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4243.c"
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %140 = udiv i64 %indvars.iv1015, 25
  %141 = mul nsw i64 %polly.indvar386, -16
  %142 = shl nsw i64 %polly.indvar386, 4
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %154 = mul nuw nsw i64 %polly.indvar399, 100
  %155 = add nsw i64 %154, %141
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %polly.loop_guard406 = icmp slt i64 %157, 16
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %183 = udiv i64 %indvars.iv1040, 25
  %184 = mul nsw i64 %polly.indvar577, -16
  %185 = shl nsw i64 %polly.indvar577, 4
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %197 = mul nuw nsw i64 %polly.indvar590, 100
  %198 = add nsw i64 %197, %184
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %polly.loop_guard597 = icmp slt i64 %200, 16
