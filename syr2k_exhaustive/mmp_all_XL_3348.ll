; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3348.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3348.c"
...
vector.body1372:                                  ; preds = %vector.body1372, %vector.ph1376
  ...
  %wide.load1383 = load <4 x double>, <4 x double>* %204, align 8, !alias.scope !79, !noalias !81
  ...
  store <4 x double> %205, <4 x double>* %206, align 8, !alias.scope !79, !noalias !81
  %index.next1380 = add i64 %index1379, 4
  %207 = icmp eq i64 %index.next1380, %n.vec1378
  br i1 %207, label %middle.block1370, label %vector.body1372, !llvm.loop !85
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %210 = mul nuw nsw i64 %polly.indvar409, 80
...
vector.body1348:                                  ; preds = %vector.body1348, %vector.ph1350
  ...
  %wide.load1357 = load <4 x double>, <4 x double>* %316, align 8, !alias.scope !89, !noalias !91
  ...
  store <4 x double> %317, <4 x double>* %318, align 8, !alias.scope !89, !noalias !91
  %index.next1354 = add i64 %index1353, 4
  %319 = icmp eq i64 %index.next1354, %n.vec1352
  br i1 %319, label %middle.block1346, label %vector.body1348, !llvm.loop !95
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %322 = mul nuw nsw i64 %polly.indvar623, 80
...
vector.body1287:                                  ; preds = %vector.body1287, %vector.ph1288
  ...
  br i1 %445, label %polly.loop_exit876, label %vector.body1287, !llvm.loop !104
...
vector.body1301:                                  ; preds = %vector.body1301, %vector.ph1304
  ...
  store <4 x double> %468, <4 x double>* %473, align 8, !alias.scope !103, !noalias !106
  ...
  br i1 %474, label %polly.loop_exit903, label %vector.body1301, !llvm.loop !107
...
vector.body1319:                                  ; preds = %vector.body1319, %vector.ph1322
  ...
  store <4 x double> %497, <4 x double>* %502, align 8, !alias.scope !102, !noalias !109
  ...
  br i1 %503, label %polly.loop_exit929, label %vector.body1319, !llvm.loop !110
