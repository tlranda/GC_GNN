; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9066.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9066.c"
...
polly.loop_header217:                             ; preds = %polly.loop_exit226, %polly.loop_header211
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv788, i64 31)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %130 = udiv i64 %polly.indvar355, 3
  ...
  %134 = shl nsw i64 %polly.indvar355, 5
  %135 = mul nsw i64 %polly.indvar355, -32
...
polly.loop_header372:                             ; preds = %polly.loop_exit382, %polly.loop_header365
  ...
  %smin805 = call i64 @llvm.smin.i64(i64 %indvars.iv803, i64 31)
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %163 = udiv i64 %polly.indvar511, 3
  ...
  %167 = shl nsw i64 %polly.indvar511, 5
  %168 = mul nsw i64 %polly.indvar511, -32
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next512, 38
...
polly.loop_header528:                             ; preds = %polly.loop_exit538, %polly.loop_header521
  ...
  %smin822 = call i64 @llvm.smin.i64(i64 %indvars.iv820, i64 31)
