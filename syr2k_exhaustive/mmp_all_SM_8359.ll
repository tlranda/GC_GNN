; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8359.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8359.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %108 = mul nuw nsw i64 %polly.indvar208, 13
  %109 = trunc i64 %polly.indvar208 to i8
  %pexp.p_div_q.lhs.trunc = add i8 %109, 4
...
polly.loop_header223.us:                          ; preds = %polly.loop_header211, %polly.loop_exit232.us
  ...
  %118 = add i64 %polly.indvar226.us, %114
  %119 = add i64 %118, %112
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %144 = udiv i64 %indvars.iv805, 5
  %145 = mul nuw nsw i64 %144, 20
  %146 = add i64 %indvars.iv803, %145
  %147 = sub nsw i64 %indvars.iv810, %145
  %148 = mul nuw nsw i64 %polly.indvar363, 13
  %149 = trunc i64 %polly.indvar363 to i8
  %pexp.p_div_q366.lhs.trunc = add i8 %149, 4
  %pexp.p_div_q366775 = udiv i8 %pexp.p_div_q366.lhs.trunc, 5
  %pexp.p_div_q366.zext = zext i8 %pexp.p_div_q366775 to i64
  %150 = sub nsw i64 %148, %pexp.p_div_q366.zext
  %151 = shl nsw i64 %polly.indvar363, 8
  %152 = mul nsw i64 %polly.indvar363, -256
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv812 = phi i64 [ %indvars.iv.next813, %polly.loop_exit375 ], [ %147, %polly.loop_header360 ]
  %indvars.iv807 = phi i64 [ %indvars.iv.next808, %polly.loop_exit375 ], [ %146, %polly.loop_header360 ]
  ...
  %154 = mul nsw i64 %polly.indvar370, 20
...
polly.loop_header380.us:                          ; preds = %polly.loop_header367, %polly.loop_exit390.us
  ...
  %158 = add i64 %polly.indvar384.us, %154
  %159 = add i64 %158, %152
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %184 = udiv i64 %indvars.iv825, 5
  %185 = mul nuw nsw i64 %184, 20
  %186 = add i64 %indvars.iv823, %185
  %187 = sub nsw i64 %indvars.iv830, %185
  %188 = mul nuw nsw i64 %polly.indvar521, 13
  %189 = trunc i64 %polly.indvar521 to i8
  %pexp.p_div_q524.lhs.trunc = add i8 %189, 4
  %pexp.p_div_q524774 = udiv i8 %pexp.p_div_q524.lhs.trunc, 5
  %pexp.p_div_q524.zext = zext i8 %pexp.p_div_q524774 to i64
  %190 = sub nsw i64 %188, %pexp.p_div_q524.zext
  %191 = shl nsw i64 %polly.indvar521, 8
  %192 = mul nsw i64 %polly.indvar521, -256
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv832 = phi i64 [ %indvars.iv.next833, %polly.loop_exit533 ], [ %187, %polly.loop_header518 ]
  %indvars.iv827 = phi i64 [ %indvars.iv.next828, %polly.loop_exit533 ], [ %186, %polly.loop_header518 ]
  ...
  %194 = mul nsw i64 %polly.indvar528, 20
...
polly.loop_header538.us:                          ; preds = %polly.loop_header525, %polly.loop_exit548.us
  ...
  %198 = add i64 %polly.indvar542.us, %194
  %199 = add i64 %198, %192
...
polly.loop_header223.us.1:                        ; preds = %polly.loop_exit232.us, %polly.loop_exit232.us.1
  ...
  %295 = add i64 %polly.indvar226.us.1, %114
  %296 = add i64 %295, %112
...
polly.loop_header223.us.2:                        ; preds = %polly.loop_exit232.us.1, %polly.loop_exit232.us.2
  ...
  %305 = add i64 %polly.indvar226.us.2, %114
  %306 = add i64 %305, %112
...
polly.loop_header223.us.3:                        ; preds = %polly.loop_exit232.us.2, %polly.loop_exit232.us.3
  ...
  %315 = add i64 %polly.indvar226.us.3, %114
  %316 = add i64 %315, %112
...
polly.loop_header380.us.1:                        ; preds = %polly.loop_exit390.us, %polly.loop_exit390.us.1
  ...
  %325 = add i64 %polly.indvar384.us.1, %154
  %326 = add i64 %325, %152
...
polly.loop_header380.us.2:                        ; preds = %polly.loop_exit390.us.1, %polly.loop_exit390.us.2
  ...
  %335 = add i64 %polly.indvar384.us.2, %154
  %336 = add i64 %335, %152
...
polly.loop_header380.us.3:                        ; preds = %polly.loop_exit390.us.2, %polly.loop_exit390.us.3
  ...
  %345 = add i64 %polly.indvar384.us.3, %154
  %346 = add i64 %345, %152
...
polly.loop_header538.us.1:                        ; preds = %polly.loop_exit548.us, %polly.loop_exit548.us.1
  ...
  %355 = add i64 %polly.indvar542.us.1, %194
  %356 = add i64 %355, %192
...
polly.loop_header538.us.2:                        ; preds = %polly.loop_exit548.us.1, %polly.loop_exit548.us.2
  ...
  %365 = add i64 %polly.indvar542.us.2, %194
  %366 = add i64 %365, %192
...
polly.loop_header538.us.3:                        ; preds = %polly.loop_exit548.us.2, %polly.loop_exit548.us.3
  ...
  %375 = add i64 %polly.indvar542.us.3, %194
  %376 = add i64 %375, %192
