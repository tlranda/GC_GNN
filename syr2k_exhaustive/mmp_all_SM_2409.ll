; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2409.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2409.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv1029, i64 276)
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1030 = add nuw nsw i64 %indvars.iv1029, 24
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %105 = shl nuw nsw i64 %polly.indvar225, 2
  %106 = add i64 %97, %105
  %smax1324 = call i64 @llvm.smax.i64(i64 %106, i64 0)
  %107 = mul nsw i64 %polly.indvar225, -4
  %108 = add i64 %98, %107
  %109 = add i64 %smax1324, %108
  %110 = shl nsw i64 %polly.indvar225, 2
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %117, i64 3)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  ...
  %umin1057 = call i64 @llvm.umin.i64(i64 %indvars.iv1055, i64 276)
  ...
  %160 = add nuw nsw i64 %umin1057, 23
...
polly.loop_exit422:                               ; preds = %polly.loop_exit429
  ...
  %indvars.iv.next1056 = add nuw nsw i64 %indvars.iv1055, 24
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %161 = shl nuw nsw i64 %polly.indvar423, 2
  %162 = add i64 %153, %161
  %smax1276 = call i64 @llvm.smax.i64(i64 %162, i64 0)
  %163 = mul nsw i64 %polly.indvar423, -4
  %164 = add i64 %154, %163
  %165 = add i64 %smax1276, %164
  %166 = shl nsw i64 %polly.indvar423, 2
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %173, i64 3)
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  ...
  %umin1084 = call i64 @llvm.umin.i64(i64 %indvars.iv1082, i64 276)
  ...
  %216 = add nuw nsw i64 %umin1084, 23
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %indvars.iv.next1083 = add nuw nsw i64 %indvars.iv1082, 24
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %217 = shl nuw nsw i64 %polly.indvar627, 2
  %218 = add i64 %209, %217
  %smax1228 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar627, -4
  %220 = add i64 %210, %219
  %221 = add i64 %smax1228, %220
  %222 = shl nsw i64 %polly.indvar627, 2
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %229, i64 3)
