; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5329.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5329.c"
...
vector.body1057:                                  ; preds = %vector.body1057, %vector.ph1059
  ...
  br i1 %57, label %middle.block1055, label %vector.body1057, !llvm.loop !59
...
vector.body1083:                                  ; preds = %vector.body1083, %vector.ph1085
  ...
  br i1 %68, label %middle.block1081, label %vector.body1083, !llvm.loop !61
...
vector.body1095:                                  ; preds = %vector.body1095, %vector.ph1099
  ...
  %wide.load1106 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !67, !noalias !69
  ...
  br i1 %95, label %middle.block1093, label %vector.body1095, !llvm.loop !73
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit219.3
  ...
  %113 = shl nsw i64 %polly.indvar230, 2
  %114 = sub nsw i64 %110, %113
  %115 = icmp sgt i64 %114, 0
  %116 = select i1 %115, i64 %114, i64 0
  %polly.loop_guard = icmp slt i64 %116, 4
...
vector.body1069:                                  ; preds = %vector.body1069, %vector.ph1073
  ...
  %wide.load1080 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %134, label %middle.block1067, label %vector.body1069, !llvm.loop !84
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit394.3
  ...
  %152 = shl nsw i64 %polly.indvar406, 2
  %153 = sub nsw i64 %149, %152
  %154 = icmp sgt i64 %153, 0
  %155 = select i1 %154, i64 %153, i64 0
  %polly.loop_guard419 = icmp slt i64 %155, 4
...
vector.body1045:                                  ; preds = %vector.body1045, %vector.ph1047
  ...
  %wide.load1054 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %173, label %middle.block1043, label %vector.body1045, !llvm.loop !94
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit572.3
  ...
  %191 = shl nsw i64 %polly.indvar584, 2
  %192 = sub nsw i64 %188, %191
  %193 = icmp sgt i64 %192, 0
  %194 = select i1 %193, i64 %192, i64 0
  %polly.loop_guard597 = icmp slt i64 %194, 4
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph985
  ...
  br i1 %226, label %polly.loop_exit772, label %vector.body983, !llvm.loop !103
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1001
  ...
  br i1 %255, label %polly.loop_exit799, label %vector.body998, !llvm.loop !106
...
vector.body1016:                                  ; preds = %vector.body1016, %vector.ph1019
  ...
  br i1 %284, label %polly.loop_exit825, label %vector.body1016, !llvm.loop !109
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  %295 = mul nsw i64 %polly.indvar208, -50
  %296 = mul nuw nsw i64 %polly.indvar208, 12
...
polly.loop_exit248.us.1:                          ; preds = %polly.loop_header246.us.1, %polly.loop_header239.us.1
  ...
  %polly.loop_cond244.us.1 = icmp ult i64 %polly.indvar242.us.1, 3
...
polly.loop_exit248.us.2:                          ; preds = %polly.loop_header246.us.2, %polly.loop_header239.us.2
  ...
  %polly.loop_cond244.us.2 = icmp ult i64 %polly.indvar242.us.2, 3
...
polly.loop_exit248.us.3:                          ; preds = %polly.loop_header246.us.3, %polly.loop_header239.us.3
  ...
  %polly.loop_cond244.us.3 = icmp ult i64 %polly.indvar242.us.3, 3
...
polly.loop_exit394.3:                             ; preds = %polly.loop_header392.3
  %331 = mul nsw i64 %polly.indvar383, -50
  %332 = mul nuw nsw i64 %polly.indvar383, 12
...
polly.loop_header416.us.1:                        ; preds = %polly.loop_exit426.us, %polly.loop_exit426.us.1
  ...
  %smin889.1 = call i64 @llvm.smin.i64(i64 %indvars.iv887.1, i64 49)
...
polly.loop_exit426.us.1:                          ; preds = %polly.loop_header424.us.1, %polly.loop_header416.us.1
  ...
  %polly.loop_cond422.us.1 = icmp ult i64 %polly.indvar420.us.1, 3
...
polly.loop_header416.us.2:                        ; preds = %polly.loop_exit426.us.1, %polly.loop_exit426.us.2
  ...
  %smin889.2 = call i64 @llvm.smin.i64(i64 %indvars.iv887.2, i64 49)
...
polly.loop_exit426.us.2:                          ; preds = %polly.loop_header424.us.2, %polly.loop_header416.us.2
  ...
  %polly.loop_cond422.us.2 = icmp ult i64 %polly.indvar420.us.2, 3
...
polly.loop_header416.us.3:                        ; preds = %polly.loop_exit426.us.2, %polly.loop_exit426.us.3
  ...
  %smin889.3 = call i64 @llvm.smin.i64(i64 %indvars.iv887.3, i64 49)
...
polly.loop_exit426.us.3:                          ; preds = %polly.loop_header424.us.3, %polly.loop_header416.us.3
  ...
  %polly.loop_cond422.us.3 = icmp ult i64 %polly.indvar420.us.3, 3
...
polly.loop_exit572.3:                             ; preds = %polly.loop_header570.3
  %367 = mul nsw i64 %polly.indvar561, -50
  %368 = mul nuw nsw i64 %polly.indvar561, 12
...
polly.loop_header594.us.1:                        ; preds = %polly.loop_exit604.us, %polly.loop_exit604.us.1
  ...
  %smin913.1 = call i64 @llvm.smin.i64(i64 %indvars.iv911.1, i64 49)
...
polly.loop_exit604.us.1:                          ; preds = %polly.loop_header602.us.1, %polly.loop_header594.us.1
  ...
  %polly.loop_cond600.us.1 = icmp ult i64 %polly.indvar598.us.1, 3
...
polly.loop_header594.us.2:                        ; preds = %polly.loop_exit604.us.1, %polly.loop_exit604.us.2
  ...
  %smin913.2 = call i64 @llvm.smin.i64(i64 %indvars.iv911.2, i64 49)
...
polly.loop_exit604.us.2:                          ; preds = %polly.loop_header602.us.2, %polly.loop_header594.us.2
  ...
  %polly.loop_cond600.us.2 = icmp ult i64 %polly.indvar598.us.2, 3
...
polly.loop_header594.us.3:                        ; preds = %polly.loop_exit604.us.2, %polly.loop_exit604.us.3
  ...
  %smin913.3 = call i64 @llvm.smin.i64(i64 %indvars.iv911.3, i64 49)
...
polly.loop_exit604.us.3:                          ; preds = %polly.loop_header602.us.3, %polly.loop_header594.us.3
  ...
  %polly.loop_cond600.us.3 = icmp ult i64 %polly.indvar598.us.3, 3
