; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7128.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7128.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv832 = phi i64 [ %indvars.iv.next833, %polly.loop_exit223 ], [ 5, %polly.loop_exit207 ]
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next833 = add nuw nsw i64 %indvars.iv832, 5
  %exitcond835.not = icmp eq i64 %polly.indvar_next219, 60
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit394
  %indvars.iv854 = phi i64 [ %indvars.iv.next855, %polly.loop_exit394 ], [ 5, %polly.loop_exit378 ]
  ...
  %123 = mul nsw i64 %polly.indvar389, -20
  %124 = mul nuw nsw i64 %polly.indvar389, 20
...
polly.loop_exit394:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next855 = add nuw nsw i64 %indvars.iv854, 5
  %exitcond857.not = icmp eq i64 %polly.indvar_next390, 60
...
polly.loop_header392:                             ; preds = %polly.loop_exit401, %polly.loop_header386
  ...
  %125 = shl nsw i64 %polly.indvar395, 2
  %126 = add nsw i64 %125, %123
  %127 = icmp sgt i64 %126, 0
  %128 = select i1 %127, i64 %126, i64 0
  %polly.loop_guard402 = icmp slt i64 %128, 20
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415.loopexit.us, %polly.loop_header399
  ...
  %polly.loop_cond405 = icmp ult i64 %polly.indvar403, 19
...
polly.loop_header559:                             ; preds = %polly.loop_exit551, %polly.loop_exit567
  %indvars.iv876 = phi i64 [ %indvars.iv.next877, %polly.loop_exit567 ], [ 5, %polly.loop_exit551 ]
  ...
  %149 = mul nsw i64 %polly.indvar562, -20
  %150 = mul nuw nsw i64 %polly.indvar562, 20
...
polly.loop_exit567:                               ; preds = %polly.loop_exit574
  ...
  %indvars.iv.next877 = add nuw nsw i64 %indvars.iv876, 5
  %exitcond879.not = icmp eq i64 %polly.indvar_next563, 60
...
polly.loop_header565:                             ; preds = %polly.loop_exit574, %polly.loop_header559
  ...
  %151 = shl nsw i64 %polly.indvar568, 2
  %152 = add nsw i64 %151, %149
  %153 = icmp sgt i64 %152, 0
  %154 = select i1 %153, i64 %152, i64 0
  %polly.loop_guard575 = icmp slt i64 %154, 20
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_header565
  ...
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, 4
  %indvars.iv.next870 = add nsw i64 %indvars.iv869, -4
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit581
  ...
  %smin873 = call i64 @llvm.smin.i64(i64 %indvars.iv871, i64 3)
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588.loopexit.us, %polly.loop_header572
  ...
  %polly.loop_cond578 = icmp ult i64 %polly.indvar576, 19
