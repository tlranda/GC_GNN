; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3155.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3155.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %.inv = icmp ugt i64 %117, 127
  %119 = select i1 %.inv, i64 127, i64 %118
...
polly.loop_header395:                             ; preds = %polly.loop_exit403, %polly.loop_header389
  ...
  %161 = mul nsw i64 %polly.indvar398, -128
  %162 = shl nsw i64 %polly.indvar398, 7
...
polly.loop_header401:                             ; preds = %polly.loop_exit442, %polly.loop_header395
  ...
  %.inv875 = icmp ugt i64 %166, 127
  %168 = select i1 %.inv875, i64 127, i64 %167
...
polly.loop_header587:                             ; preds = %polly.loop_exit595, %polly.loop_header581
  ...
  %210 = mul nsw i64 %polly.indvar590, -128
  %211 = shl nsw i64 %polly.indvar590, 7
...
polly.loop_header593:                             ; preds = %polly.loop_exit634, %polly.loop_header587
  ...
  %.inv876 = icmp ugt i64 %215, 127
  %217 = select i1 %.inv876, i64 127, i64 %216
