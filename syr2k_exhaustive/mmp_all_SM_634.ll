; ModuleID = 'syr2k_exhaustive/mmp_all_SM_634.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_634.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1110 = call i64 @llvm.smin.i64(i64 %indvars.iv1088, i64 -984)
...
polly.loop_exit230:                               ; preds = %polly.loop_exit269, %polly.loop_exit214
  ...
  %indvars.iv.next1103 = add nuw nsw i64 %indvars.iv1102, 20
...
polly.loop_header228:                             ; preds = %polly.loop_exit214, %polly.loop_exit269
  ...
  %118 = mul nsw i64 %indvar1419, -50
  %119 = add i64 %104, %118
  %smax1421 = call i64 @llvm.smax.i64(i64 %119, i64 0)
  %120 = mul nuw nsw i64 %indvar1419, 50
  %121 = add i64 %106, %120
  ...
  %.inv = icmp sgt i64 %125, 79
  %127 = select i1 %.inv, i64 79, i64 %126
...
polly.loop_header274.us:                          ; preds = %polly.loop_header267.us, %polly.loop_exit284.us
  ...
  %smin1424 = call i64 @llvm.smin.i64(i64 %138, i64 79)
...
vector.body1418:                                  ; preds = %vector.body1418, %vector.ph1426
  ...
  %wide.load1439 = load <4 x double>, <4 x double>* %157, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %162, label %middle.block1416, label %vector.body1418, !llvm.loop !85
...
vector.body1354:                                  ; preds = %vector.body1354, %vector.ph1358
  ...
  %wide.load1365 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %171, label %middle.block1352, label %vector.body1354, !llvm.loop !93
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit422
  ...
  %smin1143 = call i64 @llvm.smin.i64(i64 %indvars.iv1119, i64 -984)
  %173 = add nsw i64 %smin1143, 1000
  %174 = shl nsw i64 %polly.indvar417, 4
  br label %polly.loop_header420

polly.loop_exit422:                               ; preds = %polly.loop_exit446
  %polly.indvar_next418 = add nuw nsw i64 %polly.indvar417, 1
  %indvars.iv.next1120 = add nsw i64 %indvars.iv1119, -16
  %exitcond1146.not = icmp eq i64 %polly.indvar_next418, 63
...
polly.loop_header444:                             ; preds = %polly.loop_exit428, %polly.loop_exit486
  ...
  %194 = mul nsw i64 %indvar1369, -50
  %195 = add i64 %180, %194
  %smax1371 = call i64 @llvm.smax.i64(i64 %195, i64 0)
  %196 = mul nuw nsw i64 %indvar1369, 50
  %197 = add i64 %182, %196
  ...
  %.inv948 = icmp sgt i64 %201, 79
  %203 = select i1 %.inv948, i64 79, i64 %202
...
polly.loop_exit486:                               ; preds = %polly.loop_exit493.loopexit.us, %polly.loop_header484.preheader
  ...
  %indvars.iv.next1133 = add i64 %indvars.iv1132, -50
...
polly.loop_header491.us:                          ; preds = %polly.loop_header484.us, %polly.loop_exit501.us
  ...
  %smin1374 = call i64 @llvm.smin.i64(i64 %214, i64 79)
...
vector.body1368:                                  ; preds = %vector.body1368, %vector.ph1376
  ...
  %wide.load1389 = load <4 x double>, <4 x double>* %233, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %238, label %middle.block1366, label %vector.body1368, !llvm.loop !98
...
vector.body1306:                                  ; preds = %vector.body1306, %vector.ph1308
  ...
  %wide.load1315 = load <4 x double>, <4 x double>* %244, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %247, label %middle.block1304, label %vector.body1306, !llvm.loop !106
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit639
  ...
  %smin1176 = call i64 @llvm.smin.i64(i64 %indvars.iv1152, i64 -984)
  %249 = add nsw i64 %smin1176, 1000
  %250 = shl nsw i64 %polly.indvar634, 4
...
polly.loop_exit639:                               ; preds = %polly.loop_exit663
  ...
  %exitcond1179.not = icmp eq i64 %polly.indvar_next635, 63
...
polly.loop_exit663:                               ; preds = %polly.loop_exit703, %polly.loop_exit645
  ...
  %indvars.iv.next1162 = add nsw i64 %indvars.iv1161, -20
  %indvars.iv.next1164 = add nuw nsw i64 %indvars.iv1163, 2
  %indvars.iv.next1169 = add nuw nsw i64 %indvars.iv1168, 20
  %exitcond1178.not = icmp eq i64 %polly.indvar_next641, 15
...
polly.loop_header661:                             ; preds = %polly.loop_exit645, %polly.loop_exit703
  ...
  %270 = mul nsw i64 %indvar1319, -50
  %271 = add i64 %256, %270
  %smax1321 = call i64 @llvm.smax.i64(i64 %271, i64 0)
  %272 = mul nuw nsw i64 %indvar1319, 50
  %273 = add i64 %258, %272
  ...
  %.inv949 = icmp sgt i64 %277, 79
  %279 = select i1 %.inv949, i64 79, i64 %278
...
polly.loop_exit703:                               ; preds = %polly.loop_exit710.loopexit.us, %polly.loop_header701.preheader
  ...
  %indvars.iv.next1166 = add i64 %indvars.iv1165, -50
  %indvars.iv.next1171 = add i64 %indvars.iv1170, 50
...
polly.loop_header708.us:                          ; preds = %polly.loop_header701.us, %polly.loop_exit718.us
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %290, i64 79)
...
vector.body1318:                                  ; preds = %vector.body1318, %vector.ph1326
  ...
  %wide.load1339 = load <4 x double>, <4 x double>* %309, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %314, label %middle.block1316, label %vector.body1318, !llvm.loop !111
...
vector.body1245:                                  ; preds = %vector.body1245, %vector.ph1246
  ...
  br i1 %337, label %polly.loop_exit888, label %vector.body1245, !llvm.loop !117
...
vector.body1259:                                  ; preds = %vector.body1259, %vector.ph1262
  ...
  br i1 %366, label %polly.loop_exit915, label %vector.body1259, !llvm.loop !120
...
vector.body1277:                                  ; preds = %vector.body1277, %vector.ph1280
  ...
  br i1 %395, label %polly.loop_exit941, label %vector.body1277, !llvm.loop !123
