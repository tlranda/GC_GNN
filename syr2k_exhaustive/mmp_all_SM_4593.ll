; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4593.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4593.c"
...
polly.loop_header384:                             ; preds = %polly.loop_exit392, %polly.loop_header377
  ...
  %125 = shl nsw i64 %polly.indvar387, 6
  %126 = sub nsw i64 %123, %125
  %127 = add nuw nsw i64 %125, 64
...
polly.loop_header575:                             ; preds = %polly.loop_exit612, %polly.loop_header569
  ...
  %smin1013 = call i64 @llvm.smin.i64(i64 %indvars.iv1008, i64 63)
