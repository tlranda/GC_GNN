; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1647.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1647.c"
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1363 = call i64 @llvm.smin.i64(i64 %116, i64 99)
...
polly.loop_exit428:                               ; preds = %polly.loop_exit435
  ...
  %indvars.iv.next1087 = add nuw nsw i64 %indvars.iv1086, 4
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %162 = mul nuw nsw i64 %polly.indvar436, 100
  %163 = add i64 %155, %162
  %smax1312 = call i64 @llvm.smax.i64(i64 %163, i64 0)
  %164 = mul nsw i64 %polly.indvar436, -100
  %165 = add i64 %156, %164
  %166 = add i64 %smax1312, %165
  %167 = mul nuw nsw i64 %polly.indvar436, 100
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1315 = call i64 @llvm.smin.i64(i64 %174, i64 99)
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %220 = mul nuw nsw i64 %polly.indvar647, 100
  %221 = add i64 %213, %220
  %smax1264 = call i64 @llvm.smax.i64(i64 %221, i64 0)
  %222 = mul nsw i64 %polly.indvar647, -100
  %223 = add i64 %214, %222
  %224 = add i64 %smax1264, %223
  %225 = mul nuw nsw i64 %polly.indvar647, 100
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1267 = call i64 @llvm.smin.i64(i64 %232, i64 99)
