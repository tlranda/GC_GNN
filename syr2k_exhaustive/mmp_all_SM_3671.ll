; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3671.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3671.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond967.not = icmp eq i64 %polly.indvar_next203, 50
...
polly.merge.us:                                   ; preds = %polly.loop_header234.us, %polly.loop_exit225.us
  ...
  %exitcond952.not = icmp eq i64 %polly.indvar_next221.us, 20
...
polly.merge:                                      ; preds = %polly.loop_header248
  ...
  %exitcond950.not = icmp eq i64 %polly.indvar_next221, 20
...
polly.loop_exit270:                               ; preds = %polly.loop_exit278
  ...
  %exitcond964.not = icmp eq i64 %polly.indvar_next265, 20
...
vector.body1175:                                  ; preds = %vector.body1175, %vector.ph1179
  ...
  %wide.load1186 = load <4 x double>, <4 x double>* %139, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %142, label %middle.block1173, label %vector.body1175, !llvm.loop !85
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit412
  ...
  %144 = mul nuw nsw i64 %polly.indvar407, 20
  br label %polly.loop_header410

polly.loop_exit412:                               ; preds = %polly.loop_exit418
  %polly.indvar_next408 = add nuw nsw i64 %polly.indvar407, 1
  %exitcond992.not = icmp eq i64 %polly.indvar_next408, 50
...
polly.merge429.us:                                ; preds = %polly.loop_header445.us, %polly.loop_exit435.us
  ...
  %exitcond975.not = icmp eq i64 %polly.indvar_next426.us, 20
...
polly.merge429:                                   ; preds = %polly.loop_header459
  ...
  %exitcond973.not = icmp eq i64 %polly.indvar_next426, 20
...
polly.loop_exit481:                               ; preds = %polly.loop_exit489
  ...
  %exitcond989.not = icmp eq i64 %polly.indvar_next476, 20
...
polly.start513:                                   ; preds = %init_array.exit
  %malloccall515 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body1151:                                  ; preds = %vector.body1151, %vector.ph1153
  ...
  %wide.load1160 = load <4 x double>, <4 x double>* %186, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %189, label %middle.block1149, label %vector.body1151, !llvm.loop !95
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit623
  ...
  %191 = mul nuw nsw i64 %polly.indvar618, 20
  br label %polly.loop_header621

polly.loop_exit623:                               ; preds = %polly.loop_exit629
  %polly.indvar_next619 = add nuw nsw i64 %polly.indvar618, 1
  %exitcond1017.not = icmp eq i64 %polly.indvar_next619, 50
...
polly.merge640.us:                                ; preds = %polly.loop_header656.us, %polly.loop_exit646.us
  ...
  %exitcond1000.not = icmp eq i64 %polly.indvar_next637.us, 20
...
polly.merge640:                                   ; preds = %polly.loop_header670
  ...
  %exitcond998.not = icmp eq i64 %polly.indvar_next637, 20
...
polly.loop_exit692:                               ; preds = %polly.loop_exit700
  ...
  %exitcond1014.not = icmp eq i64 %polly.indvar_next687, 20
...
vector.body1089:                                  ; preds = %vector.body1089, %vector.ph1091
  ...
  br i1 %250, label %polly.loop_exit868, label %vector.body1089, !llvm.loop !104
...
vector.body1104:                                  ; preds = %vector.body1104, %vector.ph1107
  ...
  br i1 %279, label %polly.loop_exit895, label %vector.body1104, !llvm.loop !107
...
vector.body1122:                                  ; preds = %vector.body1122, %vector.ph1125
  ...
  br i1 %308, label %polly.loop_exit921, label %vector.body1122, !llvm.loop !110
