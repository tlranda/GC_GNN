; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5929.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5929.c"
...
vector.body1069:                                  ; preds = %vector.body1069, %vector.ph1073
  ...
  %wide.load1080 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %133, label %middle.block1067, label %vector.body1069, !llvm.loop !84
...
vector.body1045:                                  ; preds = %vector.body1045, %vector.ph1047
  ...
  %wide.load1054 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %171, label %middle.block1043, label %vector.body1045, !llvm.loop !94
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph985
  ...
  br i1 %223, label %polly.loop_exit772, label %vector.body983, !llvm.loop !103
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1001
  ...
  br i1 %252, label %polly.loop_exit799, label %vector.body998, !llvm.loop !106
...
vector.body1016:                                  ; preds = %vector.body1016, %vector.ph1019
  ...
  br i1 %281, label %polly.loop_exit825, label %vector.body1016, !llvm.loop !109
...
polly.loop_header239.us.1:                        ; preds = %polly.loop_exit248.us, %polly.loop_exit248.us.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv864.1, i64 3)
...
polly.loop_header239.us.2:                        ; preds = %polly.loop_exit248.us.1, %polly.loop_exit248.us.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv864.2, i64 3)
...
polly.loop_header239.us.3:                        ; preds = %polly.loop_exit248.us.2, %polly.loop_exit248.us.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv864.3, i64 3)
...
polly.loop_exit394.3:                             ; preds = %polly.loop_header392.3
  %327 = mul nsw i64 %polly.indvar383, -4
...
polly.loop_header416.us.1:                        ; preds = %polly.loop_exit426.us, %polly.loop_exit426.us.1
  ...
  %smin889.1 = call i64 @llvm.smin.i64(i64 %indvars.iv887.1, i64 3)
...
polly.loop_header416.us.2:                        ; preds = %polly.loop_exit426.us.1, %polly.loop_exit426.us.2
  ...
  %smin889.2 = call i64 @llvm.smin.i64(i64 %indvars.iv887.2, i64 3)
...
polly.loop_header416.us.3:                        ; preds = %polly.loop_exit426.us.2, %polly.loop_exit426.us.3
  ...
  %smin889.3 = call i64 @llvm.smin.i64(i64 %indvars.iv887.3, i64 3)
...
polly.loop_exit572.3:                             ; preds = %polly.loop_header570.3
  %362 = mul nsw i64 %polly.indvar561, -4
...
polly.loop_header594.us.1:                        ; preds = %polly.loop_exit604.us, %polly.loop_exit604.us.1
  ...
  %smin913.1 = call i64 @llvm.smin.i64(i64 %indvars.iv911.1, i64 3)
...
polly.loop_header594.us.2:                        ; preds = %polly.loop_exit604.us.1, %polly.loop_exit604.us.2
  ...
  %smin913.2 = call i64 @llvm.smin.i64(i64 %indvars.iv911.2, i64 3)
...
polly.loop_header594.us.3:                        ; preds = %polly.loop_exit604.us.2, %polly.loop_exit604.us.3
  ...
  %smin913.3 = call i64 @llvm.smin.i64(i64 %indvars.iv911.3, i64 3)
