; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2296.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2296.c"
...
polly.loop_header222:                             ; preds = %polly.loop_header222.preheader, %polly.loop_exit231
  ...
  %105 = mul nsw i64 %polly.indvar225, -100
  %106 = add i64 %98, %105
  %107 = add i64 %smax1324, %106
  %108 = mul nuw nsw i64 %polly.indvar225, 100
  %109 = add nsw i64 %108, %101
  %110 = icmp sgt i64 %109, 0
  %111 = select i1 %110, i64 %109, i64 0
  %polly.loop_guard232 = icmp slt i64 %111, 80
...
polly.loop_exit231:                               ; preds = %polly.loop_exit263, %polly.loop_header222
  ...
  %indvars.iv.next1028 = add nsw i64 %indvars.iv1027, 100
...
polly.loop_header229:                             ; preds = %polly.loop_header229.preheader, %polly.loop_exit263
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %115, i64 99)
  %116 = add nsw i64 %smin1327, 1
  %smin1037 = call i64 @llvm.smin.i64(i64 %indvars.iv1033, i64 99)
...
polly.loop_header416:                             ; preds = %polly.loop_exit408, %polly.loop_exit426
  ...
  %151 = mul nsw i64 %polly.indvar419, -80
  %152 = mul nuw nsw i64 %polly.indvar419, 80
...
polly.loop_header424.preheader:                   ; preds = %polly.loop_header416
  %155 = mul nsw i64 %polly.indvar419, -80
  %156 = mul nuw nsw i64 %polly.indvar419, 80
...
polly.loop_header424:                             ; preds = %polly.loop_header424.preheader, %polly.loop_exit434
  ...
  %157 = mul nuw nsw i64 %polly.indvar428, 100
  %158 = add i64 %151, %157
  %smax1276 = call i64 @llvm.smax.i64(i64 %158, i64 0)
  %159 = mul nsw i64 %polly.indvar428, -100
  %160 = add i64 %152, %159
  %161 = add i64 %smax1276, %160
  %162 = mul nuw nsw i64 %polly.indvar428, 100
  %163 = add nsw i64 %162, %155
  %164 = icmp sgt i64 %163, 0
  %165 = select i1 %164, i64 %163, i64 0
  %polly.loop_guard435 = icmp slt i64 %165, 80
...
polly.loop_exit434:                               ; preds = %polly.loop_exit470, %polly.loop_header424
  ...
  %indvars.iv.next1054 = add nsw i64 %indvars.iv1053, -100
...
polly.loop_header432:                             ; preds = %polly.loop_header432.preheader, %polly.loop_exit470
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %169, i64 99)
  %170 = add nsw i64 %smin1279, 1
  %smin1060 = call i64 @llvm.smin.i64(i64 %indvars.iv1055, i64 99)
...
polly.loop_header623:                             ; preds = %polly.loop_exit615, %polly.loop_exit633
  ...
  %205 = mul nsw i64 %polly.indvar626, -80
  %206 = mul nuw nsw i64 %polly.indvar626, 80
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit641
  ...
  %211 = mul nuw nsw i64 %polly.indvar635, 100
  %212 = add i64 %205, %211
  %smax1228 = call i64 @llvm.smax.i64(i64 %212, i64 0)
  %213 = mul nsw i64 %polly.indvar635, -100
  %214 = add i64 %206, %213
  %215 = add i64 %smax1228, %214
  %216 = mul nuw nsw i64 %polly.indvar635, 100
  %217 = add nsw i64 %216, %209
  %218 = icmp sgt i64 %217, 0
  %219 = select i1 %218, i64 %217, i64 0
  %polly.loop_guard642 = icmp slt i64 %219, 80
...
polly.loop_exit641:                               ; preds = %polly.loop_exit677, %polly.loop_header631
  ...
  %indvars.iv.next1072 = add nsw i64 %indvars.iv1071, 100
  %indvars.iv.next1077 = add nsw i64 %indvars.iv1076, -100
...
polly.loop_header639:                             ; preds = %polly.loop_header639.preheader, %polly.loop_exit677
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %223, i64 99)
  %224 = add nsw i64 %smin1231, 1
  %smin1083 = call i64 @llvm.smin.i64(i64 %indvars.iv1078, i64 99)
