; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3696.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3696.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %99 = udiv i64 %polly.indvar208, 24
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %indvars.iv.next1020 = add nuw nsw i64 %indvars.iv1019, 4
  %indvars.iv.next1024 = add nsw i64 %indvars.iv1023, -4
  %exitcond1033.not = icmp eq i64 %109, 300
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %110 = add i64 %smax, %indvars.iv1025
  %111 = mul nuw nsw i64 %polly.indvar214, 24
...
polly.loop_header253:                             ; preds = %polly.loop_header246, %polly.loop_exit263
  %indvars.iv1027 = phi i64 [ %110, %polly.loop_header246 ], [ %indvars.iv.next1028, %polly.loop_exit263 ]
  %polly.indvar257 = phi i64 [ %124, %polly.loop_header246 ], [ %polly.indvar_next258, %polly.loop_exit263 ]
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 3)
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %151 = add nsw i64 %smin1057, 1000
  %152 = shl nsw i64 %polly.indvar392, 6
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %153 = udiv i64 %polly.indvar398, 24
  %154 = mul nuw nsw i64 %153, 96
  %155 = sub nsw i64 %indvars.iv1044, %154
  %156 = add i64 %indvars.iv1049, %154
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %indvars.iv.next1050 = add nsw i64 %indvars.iv1049, -4
  %exitcond1059.not = icmp eq i64 %163, 300
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit445 ], [ %156, %polly.loop_header395 ]
  %indvars.iv1046 = phi i64 [ %indvars.iv.next1047, %polly.loop_exit445 ], [ %155, %polly.loop_header395 ]
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_header408.us
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next412.us, %151
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next412, %151
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %179 = mul nsw i64 %polly.indvar405, -96
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next447, %151
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1053 = phi i64 [ %164, %polly.loop_header443 ], [ %indvars.iv.next1054, %polly.loop_exit460 ]
  %polly.indvar454 = phi i64 [ %178, %polly.loop_header443 ], [ %polly.indvar_next455, %polly.loop_exit460 ]
  %smin1055 = call i64 @llvm.smin.i64(i64 %indvars.iv1053, i64 3)
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %205 = add nsw i64 %smin1083, 1000
  %206 = shl nsw i64 %polly.indvar589, 6
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %207 = udiv i64 %polly.indvar595, 24
  %208 = mul nuw nsw i64 %207, 96
  %209 = sub nsw i64 %indvars.iv1070, %208
  %210 = add i64 %indvars.iv1075, %208
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1077 = phi i64 [ %indvars.iv.next1078, %polly.loop_exit642 ], [ %210, %polly.loop_header592 ]
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit642 ], [ %209, %polly.loop_header592 ]
  ...
  %218 = add i64 %smax1074, %indvars.iv1077
  %219 = mul nuw nsw i64 %polly.indvar602, 24
  %.not.not886 = icmp ugt i64 %219, %polly.indvar595
  %220 = mul nuw nsw i64 %polly.indvar602, 96
  %221 = add nsw i64 %220, %212
  %222 = icmp sgt i64 %221, 0
  %223 = select i1 %222, i64 %221, i64 0
  %224 = add nsw i64 %221, 95
...
polly.loop_exit628.us:                            ; preds = %polly.loop_header626.us, %polly.loop_header605.us
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next609.us, %205
...
polly.loop_exit628:                               ; preds = %polly.loop_header626
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next609, %205
...
polly.loop_exit649:                               ; preds = %polly.loop_exit657
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next644, %205
...
polly.loop_header647:                             ; preds = %polly.loop_header640, %polly.loop_exit657
  %indvars.iv1079 = phi i64 [ %218, %polly.loop_header640 ], [ %indvars.iv.next1080, %polly.loop_exit657 ]
  %polly.indvar651 = phi i64 [ %232, %polly.loop_header640 ], [ %polly.indvar_next652, %polly.loop_exit657 ]
  %smin1081 = call i64 @llvm.smin.i64(i64 %indvars.iv1079, i64 3)
