; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4237.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4237.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %109 = shl nsw i64 %polly.indvar214, 4
  %110 = sub nsw i64 %97, %109
  %111 = add nuw nsw i64 %109, 16
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin981 = call i64 @llvm.smin.i64(i64 %indvars.iv977, i64 15)
...
polly.loop_exit248:                               ; preds = %polly.loop_header253.us.3, %polly.loop_header217.split, %polly.loop_header223.preheader, %polly.loop_header246.preheader
  ...
  %exitcond984.not = icmp eq i64 %polly.indvar_next221, 16
...
vector.body1176:                                  ; preds = %vector.body1176, %vector.ph1180
  ...
  %wide.load1187 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %132, label %middle.block1174, label %vector.body1176, !llvm.loop !79
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %134 = shl nsw i64 %polly.indvar384, 4
...
polly.loop_exit389:                               ; preds = %polly.loop_exit395
  ...
  %exitcond1010.not = icmp eq i64 %polly.indvar_next385, 75
...
polly.loop_exit401:                               ; preds = %polly.loop_exit436
  ...
  %indvars.iv.next996 = add nsw i64 %indvars.iv995, -16
...
polly.loop_header399:                             ; preds = %polly.loop_exit436, %polly.loop_header393
  ...
  %smin1002 = call i64 @llvm.smin.i64(i64 %indvars.iv997, i64 15)
...
polly.loop_exit436:                               ; preds = %polly.loop_header441.us.3, %polly.loop_header399.split, %polly.loop_header405.preheader, %polly.loop_header434.preheader
  ...
  %exitcond1005.not = icmp eq i64 %polly.indvar_next403, 16
...
vector.body1152:                                  ; preds = %vector.body1152, %vector.ph1154
  ...
  %wide.load1161 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %169, label %middle.block1150, label %vector.body1152, !llvm.loop !89
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %171 = shl nsw i64 %polly.indvar572, 4
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next1015 = add nuw nsw i64 %indvars.iv1014, 16
  %indvars.iv.next1028 = add nuw nsw i64 %indvars.iv1027, 1
  %exitcond1031.not = icmp eq i64 %polly.indvar_next573, 75
...
polly.loop_header587:                             ; preds = %polly.loop_exit624, %polly.loop_header581
  ...
  %smin1023 = call i64 @llvm.smin.i64(i64 %indvars.iv1018, i64 15)
...
polly.loop_exit624:                               ; preds = %polly.loop_header629.us.3, %polly.loop_header587.split, %polly.loop_header593.preheader, %polly.loop_header622.preheader
  ...
  %exitcond1026.not = icmp eq i64 %polly.indvar_next591, 16
...
vector.body1091:                                  ; preds = %vector.body1091, %vector.ph1092
  ...
  br i1 %220, label %polly.loop_exit799, label %vector.body1091, !llvm.loop !98
...
vector.body1105:                                  ; preds = %vector.body1105, %vector.ph1108
  ...
  br i1 %249, label %polly.loop_exit826, label %vector.body1105, !llvm.loop !101
...
vector.body1123:                                  ; preds = %vector.body1123, %vector.ph1126
  ...
  br i1 %278, label %polly.loop_exit852, label %vector.body1123, !llvm.loop !104
