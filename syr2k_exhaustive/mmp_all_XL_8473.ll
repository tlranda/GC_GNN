; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8473.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8473.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %104 = shl nuw nsw i64 %indvars.iv791, 1
  ...
  %polly.loop_guard = icmp slt i64 %109, 38
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %119 = mul nsw i64 %polly.indvar214, -32
  %120 = icmp slt i64 %119, -1168
  %121 = select i1 %120, i64 %119, i64 -1168
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %149 = shl nuw nsw i64 %indvars.iv808, 1
  %150 = and i64 %149, 9223372036854775776
  ...
  %polly.loop_guard373 = icmp slt i64 %154, 38
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %157 = mul nuw nsw i64 %polly.indvar365, 50
  %158 = mul nsw i64 %polly.indvar365, -50
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %160 = shl nsw i64 %polly.indvar374, 5
  %161 = sub nsw i64 %157, %160
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %164 = mul nsw i64 %polly.indvar374, -32
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %194 = shl nuw nsw i64 %indvars.iv828, 1
  ...
  %polly.loop_guard533 = icmp slt i64 %199, 38
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  ...
  %202 = mul nuw nsw i64 %polly.indvar525, 50
  %203 = mul nsw i64 %polly.indvar525, -50
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %205 = shl nsw i64 %polly.indvar534, 5
  %206 = sub nsw i64 %202, %205
  %207 = icmp sgt i64 %206, 0
  %208 = select i1 %207, i64 %206, i64 0
  %209 = mul nsw i64 %polly.indvar534, -32
  %210 = icmp slt i64 %209, -1168
  %211 = select i1 %210, i64 %209, i64 -1168
