; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10390.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10390.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond796.not = icmp eq i64 %polly.indvar_next209, 8
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.loop_header354
  ...
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 -872)
  %136 = shl nsw i64 %polly.indvar363, 7
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375
  ...
  %exitcond819.not = icmp eq i64 %polly.indvar_next364, 8
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %smin838 = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 -872)
  %170 = shl nsw i64 %polly.indvar520, 7
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next521, 8
