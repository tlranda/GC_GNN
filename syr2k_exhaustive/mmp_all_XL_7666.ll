; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7666.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7666.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %103 = mul nuw nsw i64 %polly.indvar224, 20
  br label %polly.loop_header227

polly.loop_exit229:                               ; preds = %polly.loop_exit235
  %polly.indvar_next225 = add nuw nsw i64 %polly.indvar224, 1
  %exitcond849.not = icmp eq i64 %polly.indvar_next225, 50
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %104 = shl nsw i64 %polly.indvar230, 8
...
polly.loop_header233.preheader:                   ; preds = %polly.loop_header227
  ...
  %108 = add i64 %smax, %indvars.iv841
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  %indvars.iv843 = phi i64 [ %108, %polly.loop_header233.preheader ], [ %indvars.iv.next844, %polly.loop_exit241 ]
  ...
  %polly.loop_guard249932 = icmp sgt i64 %110, -1
  %111 = add nuw nsw i64 %polly.indvar236, %102
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233, %polly.loop_exit248.loopexit.us
  ...
  %114 = add nuw nsw i64 %polly.indvar242.us, %103
  %115 = shl i64 %114, 3
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1045
  ...
  %124 = shl nuw nsw i64 %index1048, 3
  %125 = getelementptr i8, i8* %scevgep370, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1052 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  %127 = fmul fast <4 x double> %wide.load1052, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1049, %n.vec1047
  br i1 %129, label %middle.block1039, label %vector.body1041, !llvm.loop !80

middle.block1039:                                 ; preds = %vector.body1041
  %cmp.n1051 = icmp eq i64 %122, %n.vec1047
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  ...
  %137 = mul nuw nsw i64 %polly.indvar399, 20
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit412
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %exitcond872.not = icmp eq i64 %polly.indvar_next400, 50
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %138 = shl nsw i64 %polly.indvar406, 8
  %139 = add nsw i64 %138, %132
  %140 = icmp sgt i64 %139, 0
  %141 = select i1 %140, i64 %139, i64 0
  %polly.loop_guard413.not = icmp sgt i64 %141, %135
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %142 = add i64 %smax859, %indvars.iv862
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar406, %131
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv864 = phi i64 [ %142, %polly.loop_header410.preheader ], [ %indvars.iv.next865, %polly.loop_exit419 ]
  %polly.indvar414 = phi i64 [ %141, %polly.loop_header410.preheader ], [ %polly.indvar_next415, %polly.loop_exit419 ]
  %smin866 = call i64 @llvm.smin.i64(i64 %indvars.iv864, i64 255)
  %144 = add nsw i64 %polly.indvar414, %143
  %polly.loop_guard427933 = icmp sgt i64 %144, -1
  %145 = add nuw nsw i64 %polly.indvar414, %136
...
polly.loop_header417.us:                          ; preds = %polly.loop_header410, %polly.loop_exit426.loopexit.us
  ...
  %148 = add nuw nsw i64 %polly.indvar420.us, %137
  %149 = shl i64 %148, 3
  %polly.access.mul.Packed_MemRef_call2275434.us = mul nuw nsw i64 %148, 1200
  %polly.access.add.Packed_MemRef_call2275435.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2275434.us, %145
...
polly.loop_header424.us:                          ; preds = %polly.loop_header417.us, %polly.loop_header424.us
  ...
  %151 = add nuw nsw i64 %polly.indvar428.us, %138
  %152 = mul nuw nsw i64 %151, 8000
  %153 = add nuw nsw i64 %152, %149
  %scevgep431.us = getelementptr i8, i8* %call1, i64 %153
  ...
  %polly.access.add.Packed_MemRef_call2275439.us = add nuw nsw i64 %151, %polly.access.mul.Packed_MemRef_call2275434.us
  ...
  %154 = shl i64 %151, 3
  %155 = add i64 %154, %147
  %scevgep445.us = getelementptr i8, i8* %call, i64 %155
...
polly.loop_exit426.loopexit.us:                   ; preds = %polly.loop_header424.us
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar_next421.us, 20
...
polly.loop_exit419:                               ; preds = %polly.loop_exit426.loopexit.us, %polly.loop_header410
  ...
  %polly.loop_cond416.not.not = icmp ult i64 %polly.indvar414, %135
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %157 = mul nuw nsw i64 %polly.indvar539, 9600
  %scevgep548 = getelementptr i8, i8* %call, i64 %157
  %min.iters.check1018 = icmp ult i64 %156, 4
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  %158 = shl nuw nsw i64 %index1022, 3
  %159 = getelementptr i8, i8* %scevgep548, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load1026 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  %161 = fmul fast <4 x double> %wide.load1026, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next1023, %n.vec1021
  br i1 %163, label %middle.block1015, label %vector.body1017, !llvm.loop !90

middle.block1015:                                 ; preds = %vector.body1017
  %cmp.n1025 = icmp eq i64 %156, %n.vec1021
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  %164 = shl nuw nsw i64 %polly.indvar545, 3
  %scevgep549 = getelementptr i8, i8* %scevgep548, i64 %164
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %165 = lshr i64 %indvars.iv892, 3
  %166 = mul nsw i64 %polly.indvar571, -96
  %167 = icmp slt i64 %166, -1104
  %168 = select i1 %167, i64 %166, i64 -1104
  %169 = add nsw i64 %168, 1199
  %170 = mul nuw nsw i64 %polly.indvar571, 96
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %172 = shl nsw i64 %polly.indvar584, 8
  %173 = add nsw i64 %172, %166
  %174 = icmp sgt i64 %173, 0
  %175 = select i1 %174, i64 %173, i64 0
  %polly.loop_guard591.not = icmp sgt i64 %175, %169
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %exitcond894.not = icmp eq i64 %polly.indvar584, %165
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv887 = phi i64 [ %176, %polly.loop_header588.preheader ], [ %indvars.iv.next888, %polly.loop_exit597 ]
  %polly.indvar592 = phi i64 [ %175, %polly.loop_header588.preheader ], [ %polly.indvar_next593, %polly.loop_exit597 ]
  %smin889 = call i64 @llvm.smin.i64(i64 %indvars.iv887, i64 255)
  %178 = add nsw i64 %polly.indvar592, %177
  %polly.loop_guard605934 = icmp sgt i64 %178, -1
  %179 = add nuw nsw i64 %polly.indvar592, %170
...
polly.loop_header595.us:                          ; preds = %polly.loop_header588, %polly.loop_exit604.loopexit.us
  ...
  %182 = add nuw nsw i64 %polly.indvar598.us, %171
  %183 = shl i64 %182, 3
  %polly.access.mul.Packed_MemRef_call2453612.us = mul nuw nsw i64 %182, 1200
  %polly.access.add.Packed_MemRef_call2453613.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2453612.us, %179
  ...
  %184 = add i64 %183, %180
  %scevgep620.us = getelementptr i8, i8* %call1, i64 %184
...
polly.loop_header602.us:                          ; preds = %polly.loop_header595.us, %polly.loop_header602.us
  ...
  %polly.access.add.Packed_MemRef_call2453617.us = add nuw nsw i64 %185, %polly.access.mul.Packed_MemRef_call2453612.us
...
polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar_next599.us, 20
...
polly.loop_exit597:                               ; preds = %polly.loop_exit604.loopexit.us, %polly.loop_header588
  ...
  %polly.loop_cond594.not.not = icmp ult i64 %polly.indvar592, %169
...
polly.loop_header752:                             ; preds = %entry, %polly.loop_exit760
  ...
  %190 = shl nsw i64 %polly.indvar755, 5
  %191 = add nsw i64 %smin927, 1199
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %192 = mul nsw i64 %polly.indvar761, -32
  %smin956 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin956, 1200
  %smin923 = call i64 @llvm.smin.i64(i64 %indvars.iv921, i64 -1168)
  %194 = shl nsw i64 %polly.indvar761, 5
  %195 = add nsw i64 %smin923, 1199
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %196 = add nuw nsw i64 %polly.indvar767, %190
...
vector.ph957:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert964 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat965 = shufflevector <4 x i64> %broadcast.splatinsert964, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert966 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph957
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind962, %broadcast.splat965
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat967, %200
  ...
  %211 = icmp eq i64 %index.next959, %193
  br i1 %211, label %polly.loop_exit772, label %vector.body955, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body955, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond928.not = icmp eq i64 %polly.indvar767, %191
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %212 = add nuw nsw i64 %polly.indvar773, %194
  ...
  %scevgep776 = getelementptr i8, i8* %call, i64 %218
  ...
  %exitcond924.not = icmp eq i64 %polly.indvar773, %195
...
polly.loop_header779:                             ; preds = %polly.loop_exit760, %polly.loop_exit787
  ...
  %219 = shl nsw i64 %polly.indvar782, 5
  %220 = add nsw i64 %smin917, 1199
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %221 = mul nsw i64 %polly.indvar788, -32
  %smin971 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin971, 1000
  %smin913 = call i64 @llvm.smin.i64(i64 %indvars.iv911, i64 -968)
  %223 = shl nsw i64 %polly.indvar788, 5
  %224 = add nsw i64 %smin913, 999
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind980, %broadcast.splat983
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat985, %229
  ...
  %240 = icmp eq i64 %index.next977, %222
  br i1 %240, label %polly.loop_exit799, label %vector.body970, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body970, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond918.not = icmp eq i64 %polly.indvar794, %220
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %241 = add nuw nsw i64 %polly.indvar800, %223
  ...
  %scevgep803 = getelementptr i8, i8* %call2, i64 %247
  ...
  %exitcond914.not = icmp eq i64 %polly.indvar800, %224
...
polly.loop_header805:                             ; preds = %polly.loop_exit787, %polly.loop_exit813
  ...
  %248 = shl nsw i64 %polly.indvar808, 5
  %249 = add nsw i64 %smin907, 1199
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %250 = mul nsw i64 %polly.indvar814, -32
  %smin989 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin989, 1000
  %smin903 = call i64 @llvm.smin.i64(i64 %indvars.iv901, i64 -968)
  %252 = shl nsw i64 %polly.indvar814, 5
  %253 = add nsw i64 %smin903, 999
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind998, %broadcast.splat1001
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat1003, %258
  ...
  %269 = icmp eq i64 %index.next995, %251
  br i1 %269, label %polly.loop_exit825, label %vector.body988, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body988, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond908.not = icmp eq i64 %polly.indvar820, %249
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %270 = add nuw nsw i64 %polly.indvar826, %252
  ...
  %scevgep830 = getelementptr i8, i8* %call1, i64 %276
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar826, %253
