; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1208.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1208.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %98 = mul nuw nsw i64 %polly.indvar203, 7
  %99 = udiv i64 %98, 25
  %100 = add nuw i64 %polly.indvar203, %99
  %101 = mul nuw nsw i64 %100, 100
  %102 = sub i64 %97, %101
  %103 = mul nsw i64 %polly.indvar203, -128
  %104 = add i64 %103, %101
  %105 = udiv i64 %indvars.iv1064, 25
  %106 = add nuw i64 %polly.indvar203, %105
...
polly.loop_exit208:                               ; preds = %polly.loop_exit214
  %111 = mul nsw i64 %polly.indvar203, -128
  %112 = mul nuw nsw i64 %polly.indvar203, 7
  %pexp.p_div_q = udiv i64 %112, 25
  %113 = add nuw nsw i64 %pexp.p_div_q, %polly.indvar203
...
polly.loop_exit224:                               ; preds = %polly.loop_exit261
  ...
  %indvars.iv.next1065 = add nuw nsw i64 %indvars.iv1064, 7
  %indvars.iv.next1069 = add nsw i64 %indvars.iv1068, -128
  %exitcond1076.not = icmp eq i64 %polly.indvar_next204, 10
...
polly.loop_header222:                             ; preds = %polly.loop_exit261, %polly.loop_exit208
  ...
  %115 = mul nsw i64 %indvar1369, -100
  %116 = add i64 %102, %115
  %smax1371 = call i64 @llvm.smax.i64(i64 %116, i64 0)
  %117 = mul nuw nsw i64 %indvar1369, 100
  %118 = add i64 %104, %117
...
polly.loop_header259.preheader:                   ; preds = %polly.loop_exit247, %polly.loop_exit247.us, %polly.loop_header222.split
  ...
  %polly.loop_guard269 = icmp slt i64 %132, 100
...
polly.loop_header266.us:                          ; preds = %polly.loop_header259.us, %polly.loop_exit276.us
  ...
  %smin1374 = call i64 @llvm.smin.i64(i64 %133, i64 127)
  %134 = add nsw i64 %smin1374, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1072, i64 127)
...
polly.loop_exit276.us:                            ; preds = %polly.loop_header274.us, %middle.block1366, %polly.loop_header266.us
  ...
  %polly.loop_cond272.us = icmp ult i64 %polly.indvar270.us, 99
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit431
  ...
  %168 = shl nuw nsw i64 %polly.indvar409, 7
  %169 = mul nuw nsw i64 %polly.indvar409, 7
  %170 = udiv i64 %169, 25
  %171 = add nuw i64 %polly.indvar409, %170
  %172 = mul nuw nsw i64 %171, 100
  %173 = sub i64 %168, %172
  %174 = mul nsw i64 %polly.indvar409, -128
  %175 = add i64 %174, %172
  %176 = udiv i64 %indvars.iv1088, 25
  %177 = add nuw i64 %polly.indvar409, %176
  %178 = mul nuw nsw i64 %177, 100
  %179 = sub i64 %indvars.iv1086, %178
  %180 = add i64 %indvars.iv1093, %178
  %181 = shl nsw i64 %polly.indvar409, 7
  br label %polly.loop_header412

polly.loop_exit414:                               ; preds = %polly.loop_exit420
  %182 = mul nsw i64 %polly.indvar409, -128
  %183 = mul nuw nsw i64 %polly.indvar409, 7
  %pexp.p_div_q428 = udiv i64 %183, 25
  %184 = add nuw nsw i64 %pexp.p_div_q428, %polly.indvar409
...
polly.loop_exit431:                               ; preds = %polly.loop_exit470
  ...
  %exitcond1102.not = icmp eq i64 %polly.indvar_next410, 10
...
polly.loop_exit470:                               ; preds = %polly.loop_exit477.loopexit.us, %polly.loop_header468.preheader
  ...
  %polly.loop_cond434 = icmp ult i64 %polly.indvar432, 11
...
polly.loop_header468.preheader:                   ; preds = %polly.loop_exit456, %polly.loop_exit456.us, %polly.loop_header429.split
  ...
  %polly.loop_guard478 = icmp slt i64 %203, 100
...
polly.loop_header475.us:                          ; preds = %polly.loop_header468.us, %polly.loop_exit485.us
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %204, i64 127)
  %205 = add nsw i64 %smin1324, 1
  %smin1099 = call i64 @llvm.smin.i64(i64 %indvars.iv1097, i64 127)
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %239 = shl nuw nsw i64 %polly.indvar618, 7
  %240 = mul nuw nsw i64 %polly.indvar618, 7
  %241 = udiv i64 %240, 25
  %242 = add nuw i64 %polly.indvar618, %241
  %243 = mul nuw nsw i64 %242, 100
  %244 = sub i64 %239, %243
  %245 = mul nsw i64 %polly.indvar618, -128
  %246 = add i64 %245, %243
  %247 = udiv i64 %indvars.iv1114, 25
  %248 = add nuw i64 %polly.indvar618, %247
  %249 = mul nuw nsw i64 %248, 100
  %250 = sub i64 %indvars.iv1112, %249
  %251 = add i64 %indvars.iv1119, %249
  %252 = shl nsw i64 %polly.indvar618, 7
  br label %polly.loop_header621

polly.loop_exit623:                               ; preds = %polly.loop_exit629
  %253 = mul nsw i64 %polly.indvar618, -128
  %254 = mul nuw nsw i64 %polly.indvar618, 7
  %pexp.p_div_q637 = udiv i64 %254, 25
  %255 = add nuw nsw i64 %pexp.p_div_q637, %polly.indvar618
...
polly.loop_exit640:                               ; preds = %polly.loop_exit679
  ...
  %indvars.iv.next1115 = add nuw nsw i64 %indvars.iv1114, 7
...
polly.loop_exit679:                               ; preds = %polly.loop_exit686.loopexit.us, %polly.loop_header677.preheader
  ...
  %indvars.iv.next1117 = add i64 %indvars.iv1116, -100
...
polly.loop_header677.preheader:                   ; preds = %polly.loop_exit665, %polly.loop_exit665.us, %polly.loop_header638.split
  ...
  %polly.loop_guard687 = icmp slt i64 %274, 100
...
polly.loop_header684.us:                          ; preds = %polly.loop_header677.us, %polly.loop_exit694.us
  ...
  %smin1274 = call i64 @llvm.smin.i64(i64 %275, i64 127)
...
polly.loop_exit694.us:                            ; preds = %polly.loop_header692.us, %middle.block1266, %polly.loop_header684.us
  ...
  %polly.loop_cond690.us = icmp ult i64 %polly.indvar688.us, 99
