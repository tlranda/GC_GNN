; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8460.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8460.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond769.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_header217:                             ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv764, i64 19)
...
polly.loop_header356:                             ; preds = %polly.loop_exit364, %polly.loop_header350
  ...
  %117 = mul nuw nsw i64 %polly.indvar359, 20
...
polly.loop_header368:                             ; preds = %polly.loop_exit376, %polly.loop_header362
  ...
  %smin776 = call i64 @llvm.smin.i64(i64 %indvars.iv774, i64 19)
...
polly.loop_header501:                             ; preds = %polly.loop_exit493, %polly.loop_exit509
  ...
  %135 = mul nuw nsw i64 %polly.indvar504, 20
...
polly.loop_exit509:                               ; preds = %polly.loop_exit515
  ...
  %exitcond793.not = icmp eq i64 %polly.indvar_next505, 60
...
polly.loop_header507:                             ; preds = %polly.loop_exit515, %polly.loop_header501
  ...
  %136 = mul nuw nsw i64 %polly.indvar510, 20
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %smin788 = call i64 @llvm.smin.i64(i64 %indvars.iv786, i64 19)
