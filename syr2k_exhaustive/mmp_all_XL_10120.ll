; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10120.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10120.c"
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next364, 13
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %smin842 = call i64 @llvm.smin.i64(i64 %indvars.iv840, i64 -920)
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %indvars.iv.next841 = add nsw i64 %indvars.iv840, -80
  %exitcond848.not = icmp eq i64 %polly.indvar_next521, 13
