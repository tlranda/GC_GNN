; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8513.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8513.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond800.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !67
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next203, 32
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar_next209, 150
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %106 = shl nsw i64 %polly.indvar214, 5
  %107 = sub nsw i64 %103, %106
  %108 = icmp sgt i64 %107, 0
  %109 = select i1 %108, i64 %107, i64 0
  %110 = mul nsw i64 %polly.indvar214, -32
  %111 = icmp slt i64 %110, -1168
  %112 = select i1 %111, i64 %110, i64 -1168
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond797.not = icmp eq i64 %polly.indvar_next215, 38
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond822.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !77
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond821.not = icmp eq i64 %polly.indvar_next358, 32
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %137 = lshr i64 %polly.indvar363, 2
  %138 = shl nuw nsw i64 %137, 5
  %139 = sub nsw i64 %indvars.iv802, %138
  %140 = add i64 %indvars.iv807, %138
  %141 = shl nsw i64 %polly.indvar363, 3
  %142 = mul nsw i64 %polly.indvar363, -8
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit375
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %indvars.iv.next803 = add nuw nsw i64 %indvars.iv802, 8
  %indvars.iv.next808 = add nsw i64 %indvars.iv807, -8
  %exitcond820.not = icmp eq i64 %polly.indvar_next364, 150
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %144 = shl nsw i64 %polly.indvar370, 5
  %145 = sub nsw i64 %141, %144
  %146 = icmp sgt i64 %145, 0
  %147 = select i1 %146, i64 %145, i64 0
  %148 = mul nsw i64 %polly.indvar370, -32
  %149 = icmp slt i64 %148, -1168
  %150 = select i1 %149, i64 %148, i64 -1168
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382, %polly.loop_header367
  ...
  %exitcond819.not = icmp eq i64 %polly.indvar_next371, 38
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %173 = shl nsw i64 %polly.indvar515, 5
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %175 = lshr i64 %polly.indvar521, 2
  %176 = shl nuw nsw i64 %175, 5
  %177 = sub nsw i64 %indvars.iv824, %176
  %178 = add i64 %indvars.iv829, %176
  %179 = shl nsw i64 %polly.indvar521, 3
  %180 = mul nsw i64 %polly.indvar521, -8
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next825 = add nuw nsw i64 %indvars.iv824, 8
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  ...
  %182 = shl nsw i64 %polly.indvar528, 5
  %183 = sub nsw i64 %179, %182
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %186 = mul nsw i64 %polly.indvar528, -32
...
polly.loop_exit533:                               ; preds = %polly.loop_exit540, %polly.loop_header525
  ...
  %indvars.iv.next827 = add i64 %indvars.iv826, -32
  %indvars.iv.next832 = add i64 %indvars.iv831, 32
  %exitcond841.not = icmp eq i64 %polly.indvar_next529, 38
...
polly.loop_header538:                             ; preds = %polly.loop_header531, %polly.loop_exit548
  ...
  %smin835 = call i64 @llvm.smin.i64(i64 %indvars.iv833, i64 7)
