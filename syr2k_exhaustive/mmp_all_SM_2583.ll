; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2583.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2583.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %101 = shl nsw i64 %polly.indvar219, 7
...
polly.loop_header234:                             ; preds = %polly.loop_exit265, %polly.loop_header228
  ...
  %smin1362 = call i64 @llvm.smin.i64(i64 %114, i64 127)
  ...
  %smin1351 = call i64 @llvm.smin.i64(i64 %119, i64 127)
...
polly.loop_header418:                             ; preds = %polly.loop_exit410, %polly.loop_exit426
  ...
  %161 = shl nuw nsw i64 %polly.indvar421, 7
  %162 = mul nuw nsw i64 %polly.indvar421, 1228800
  %163 = or i64 %162, 8
  %164 = shl nuw nsw i64 %polly.indvar421, 7
  %smin1071 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 -1072)
  %165 = shl nsw i64 %polly.indvar421, 7
...
polly.loop_header430:                             ; preds = %polly.loop_exit438, %polly.loop_header424
  ...
  %168 = mul nsw i64 %polly.indvar433, -128
  %169 = add i64 %161, %168
  %170 = shl nuw nsw i64 %polly.indvar433, 10
  %171 = add nuw i64 %162, %170
  %172 = add nuw i64 %163, %170
  %173 = mul nsw i64 %polly.indvar433, -128
  %174 = add i64 %164, %173
  %175 = shl nsw i64 %polly.indvar433, 7
...
polly.loop_header436:                             ; preds = %polly.loop_exit473, %polly.loop_header430
  ...
  %smin1306 = call i64 @llvm.smin.i64(i64 %178, i64 127)
  ...
  %smin1295 = call i64 @llvm.smin.i64(i64 %183, i64 127)
...
polly.loop_header626:                             ; preds = %polly.loop_exit618, %polly.loop_exit634
  ...
  %225 = shl nuw nsw i64 %polly.indvar629, 7
  %226 = mul nuw nsw i64 %polly.indvar629, 1228800
  %227 = or i64 %226, 8
  %228 = shl nuw nsw i64 %polly.indvar629, 7
  %smin1097 = call i64 @llvm.smin.i64(i64 %indvars.iv1095, i64 -1072)
  %229 = shl nsw i64 %polly.indvar629, 7
...
polly.loop_header638:                             ; preds = %polly.loop_exit646, %polly.loop_header632
  ...
  %232 = mul nsw i64 %polly.indvar641, -128
  %233 = add i64 %225, %232
  %234 = shl nuw nsw i64 %polly.indvar641, 10
  %235 = add nuw i64 %226, %234
  %236 = add nuw i64 %227, %234
  %237 = mul nsw i64 %polly.indvar641, -128
  %238 = add i64 %228, %237
  %239 = shl nsw i64 %polly.indvar641, 7
...
polly.loop_header644:                             ; preds = %polly.loop_exit681, %polly.loop_header638
  ...
  %smin1250 = call i64 @llvm.smin.i64(i64 %242, i64 127)
  ...
  %smin1239 = call i64 @llvm.smin.i64(i64 %247, i64 127)
