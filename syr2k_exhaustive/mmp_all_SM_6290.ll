; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6290.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6290.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %105 = sub nsw i64 %103, %pexp.p_div_q
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_header234.us:                          ; preds = %polly.loop_exit244.us, %polly.loop_header227.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 127)
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit398
  ...
  %130 = udiv i64 %indvars.iv865, 5
  %131 = mul nuw nsw i64 %130, 80
  %132 = add i64 %indvars.iv863, %131
  %133 = sub nsw i64 %indvars.iv870, %131
  %134 = shl nsw i64 %polly.indvar375, 7
  br label %polly.loop_header378

polly.loop_exit380:                               ; preds = %polly.loop_exit386
  %135 = mul nsw i64 %polly.indvar375, -128
  %136 = shl nuw nsw i64 %polly.indvar375, 1
  %137 = add nuw nsw i64 %136, 4
  %pexp.p_div_q394 = udiv i64 %137, 5
  %138 = sub nsw i64 %136, %pexp.p_div_q394
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405, %polly.loop_exit380
  ...
  %indvars.iv.next866 = add nuw nsw i64 %indvars.iv865, 2
  %indvars.iv.next871 = add nuw nsw i64 %indvars.iv870, 32
  %exitcond879.not = icmp eq i64 %polly.indvar_next376, 10
...
polly.loop_header548:                             ; preds = %polly.loop_header548.preheader, %polly.loop_exit574
  ...
  %163 = udiv i64 %indvars.iv888, 5
  %164 = mul nuw nsw i64 %163, 80
  %165 = add i64 %indvars.iv886, %164
  %166 = sub nsw i64 %indvars.iv893, %164
  %167 = shl nsw i64 %polly.indvar551, 7
  br label %polly.loop_header554

polly.loop_exit556:                               ; preds = %polly.loop_exit562
  %168 = mul nsw i64 %polly.indvar551, -128
  %169 = shl nuw nsw i64 %polly.indvar551, 1
  %170 = add nuw nsw i64 %169, 4
  %pexp.p_div_q570 = udiv i64 %170, 5
  %171 = sub nsw i64 %169, %pexp.p_div_q570
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_exit556
  ...
  %exitcond902.not = icmp eq i64 %polly.indvar_next552, 10
