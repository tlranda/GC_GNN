; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8241.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8241.c"
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %147 = shl nsw i64 %polly.indvar361, 4
...
polly.loop_header364:                             ; preds = %polly.loop_exit378.7, %polly.loop_header358
  ...
  %148 = shl nsw i64 %polly.indvar367, 4
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %182 = shl nsw i64 %polly.indvar514, 4
...
polly.loop_header517:                             ; preds = %polly.loop_exit531.7, %polly.loop_header511
  ...
  %183 = shl nsw i64 %polly.indvar520, 4
...
polly.loop_header223.4:                           ; preds = %polly.loop_exit231.3, %polly.loop_exit231.4
  ...
  %smin.4 = call i64 @llvm.smin.i64(i64 %indvars.iv770.4, i64 15)
...
polly.loop_header223.5:                           ; preds = %polly.loop_exit231.4, %polly.loop_exit231.5
  ...
  %smin.5 = call i64 @llvm.smin.i64(i64 %indvars.iv770.5, i64 15)
...
polly.loop_header223.6:                           ; preds = %polly.loop_exit231.5, %polly.loop_exit231.6
  ...
  %smin.6 = call i64 @llvm.smin.i64(i64 %indvars.iv770.6, i64 15)
...
polly.loop_header223.7:                           ; preds = %polly.loop_exit231.6, %polly.loop_exit231.7
  ...
  %smin.7 = call i64 @llvm.smin.i64(i64 %indvars.iv770.7, i64 15)
...
polly.loop_header376.4:                           ; preds = %polly.loop_exit384.3, %polly.loop_exit384.4
  ...
  %smin783.4 = call i64 @llvm.smin.i64(i64 %indvars.iv781.4, i64 15)
...
polly.loop_header376.5:                           ; preds = %polly.loop_exit384.4, %polly.loop_exit384.5
  ...
  %smin783.5 = call i64 @llvm.smin.i64(i64 %indvars.iv781.5, i64 15)
...
polly.loop_header376.6:                           ; preds = %polly.loop_exit384.5, %polly.loop_exit384.6
  ...
  %smin783.6 = call i64 @llvm.smin.i64(i64 %indvars.iv781.6, i64 15)
...
polly.loop_header376.7:                           ; preds = %polly.loop_exit384.6, %polly.loop_exit384.7
  ...
  %smin783.7 = call i64 @llvm.smin.i64(i64 %indvars.iv781.7, i64 15)
...
polly.loop_header529.4:                           ; preds = %polly.loop_exit537.3, %polly.loop_exit537.4
  ...
  %smin796.4 = call i64 @llvm.smin.i64(i64 %indvars.iv794.4, i64 15)
...
polly.loop_header529.5:                           ; preds = %polly.loop_exit537.4, %polly.loop_exit537.5
  ...
  %smin796.5 = call i64 @llvm.smin.i64(i64 %indvars.iv794.5, i64 15)
...
polly.loop_header529.6:                           ; preds = %polly.loop_exit537.5, %polly.loop_exit537.6
  ...
  %smin796.6 = call i64 @llvm.smin.i64(i64 %indvars.iv794.6, i64 15)
...
polly.loop_header529.7:                           ; preds = %polly.loop_exit537.6, %polly.loop_exit537.7
  ...
  %smin796.7 = call i64 @llvm.smin.i64(i64 %indvars.iv794.7, i64 15)
