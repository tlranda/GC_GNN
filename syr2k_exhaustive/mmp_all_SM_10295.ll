; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10295.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10295.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %110 = shl nsw i64 %polly.indvar214, 8
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %136 = lshr i64 %indvars.iv815, 3
  %137 = mul nsw i64 %polly.indvar357, -96
  %138 = icmp slt i64 %137, -1104
  %139 = select i1 %138, i64 %137, i64 -1104
  %140 = add nsw i64 %139, 1199
  %141 = mul nuw nsw i64 %polly.indvar357, 96
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %149 = shl nsw i64 %polly.indvar370, 8
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar370, %136
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %175 = lshr i64 %indvars.iv836, 3
  %176 = mul nsw i64 %polly.indvar515, -96
  %177 = icmp slt i64 %176, -1104
  %178 = select i1 %177, i64 %176, i64 -1104
  %179 = add nsw i64 %178, 1199
  %180 = mul nuw nsw i64 %polly.indvar515, 96
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %188 = shl nsw i64 %polly.indvar528, 8
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %192 = add i64 %smax826, %indvars.iv829
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar528, %175
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv831 = phi i64 [ %192, %polly.loop_header532.preheader ], [ %indvars.iv.next832, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549879 = icmp sgt i64 %194, -1
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  br i1 %226, label %polly.loop_exit714, label %vector.body906, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body906, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond870.not = icmp eq i64 %polly.indvar709, %206
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar715, %210
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  br i1 %255, label %polly.loop_exit741, label %vector.body921, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body921, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond860.not = icmp eq i64 %polly.indvar736, %235
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar742, %239
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  br i1 %284, label %polly.loop_exit767, label %vector.body939, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body939, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond850.not = icmp eq i64 %polly.indvar762, %264
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar768, %268
