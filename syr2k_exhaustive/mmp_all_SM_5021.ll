; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5021.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5021.c"
...
vector.body1107:                                  ; preds = %vector.body1107, %vector.ph1108
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call813, i64 %indvars.iv7.i, i64 %index1109
...
vector.body1169:                                  ; preds = %vector.body1169, %vector.ph1171
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call813, i64 %indvars.iv21.i, i64 %index1174
...
vector.body1192:                                  ; preds = %vector.body1192, %vector.ph1194
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call813, i64 %indvars.iv21.i52, i64 %index1197
  ...
  br i1 %57, label %middle.block1190, label %vector.body1192, !llvm.loop !54
...
vector.body1218:                                  ; preds = %vector.body1218, %vector.ph1220
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call813, i64 %indvars.iv21.i91, i64 %index1223
  ...
  br i1 %68, label %middle.block1216, label %vector.body1218, !llvm.loop !56
...
vector.body1230:                                  ; preds = %vector.body1230, %vector.ph1234
  ...
  %wide.load1241 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !62, !noalias !64
  ...
  br i1 %95, label %middle.block1228, label %vector.body1230, !llvm.loop !68
...
vector.body1204:                                  ; preds = %vector.body1204, %vector.ph1208
  ...
  %130 = shl nuw nsw i64 %index1211, 3
  %131 = getelementptr i8, i8* %scevgep379, i64 %130
  %132 = bitcast i8* %131 to <4 x double>*
  %wide.load1215 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !73, !noalias !75
  %133 = fmul fast <4 x double> %wide.load1215, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %135 = icmp eq i64 %index.next1212, %n.vec1210
  br i1 %135, label %middle.block1202, label %vector.body1204, !llvm.loop !79

middle.block1202:                                 ; preds = %vector.body1204
  %cmp.n1214 = icmp eq i64 %128, %n.vec1210
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %137 = udiv i64 %indvars.iv1020, 25
  %138 = sub nsw i64 %indvars.iv1018, %137
  %smin1022 = call i64 @llvm.smin.i64(i64 %138, i64 21)
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond1024.not = icmp eq i64 %polly.indvar_next393, 20
...
polly.merge429.us:                                ; preds = %polly.then430.us, %polly.cond428.loopexit.us
  ...
  %exitcond1014.not = icmp eq i64 %polly.indvar_next414.us, 50
...
polly.loop_header410:                             ; preds = %polly.loop_header403.split, %polly.loop_header410
  ...
  %exitcond1000.not = icmp eq i64 %polly.indvar_next414, 50
  br i1 %exitcond1000.not, label %polly.loop_header439.preheader, label %polly.loop_header410
...
polly.loop_exit448.loopexit.us:                   ; preds = %polly.loop_header446.us
  ...
  %exitcond1017.not = icmp eq i64 %polly.indvar_next443.us, 50
...
polly.loop_header558:                             ; preds = %polly.loop_exit566, %polly.start472
  ...
  %min.iters.check1181 = icmp ult i64 %168, 4
  br i1 %min.iters.check1181, label %polly.loop_header564.preheader, label %vector.ph1182

vector.ph1182:                                    ; preds = %polly.loop_header558
  %n.vec1184 = and i64 %168, -4
...
vector.body1180:                                  ; preds = %vector.body1180, %vector.ph1182
  ...
  %170 = shl nuw nsw i64 %index1185, 3
  %171 = getelementptr i8, i8* %scevgep570, i64 %170
  %172 = bitcast i8* %171 to <4 x double>*
  %wide.load1189 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !83, !noalias !85
  %173 = fmul fast <4 x double> %wide.load1189, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %175 = icmp eq i64 %index.next1186, %n.vec1184
  br i1 %175, label %middle.block1178, label %vector.body1180, !llvm.loop !89

middle.block1178:                                 ; preds = %vector.body1180
  %cmp.n1188 = icmp eq i64 %168, %n.vec1184
  br i1 %cmp.n1188, label %polly.loop_exit566, label %polly.loop_header564.preheader

polly.loop_header564.preheader:                   ; preds = %polly.loop_header558, %middle.block1178
  %polly.indvar567.ph = phi i64 [ 0, %polly.loop_header558 ], [ %n.vec1184, %middle.block1178 ]
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_header564, %middle.block1178
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %177 = udiv i64 %indvars.iv1048, 25
  %178 = sub nsw i64 %indvars.iv1046, %177
  %smin1050 = call i64 @llvm.smin.i64(i64 %178, i64 21)
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar_next584, 20
...
polly.merge620.us:                                ; preds = %polly.then621.us, %polly.cond619.loopexit.us
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar_next605.us, 50
...
polly.loop_header601:                             ; preds = %polly.loop_header594.split, %polly.loop_header601
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next605, 50
  br i1 %exitcond1028.not, label %polly.loop_header630.preheader, label %polly.loop_header601
...
polly.loop_exit639.loopexit.us:                   ; preds = %polly.loop_header637.us
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar_next634.us, 50
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  br i1 %min.iters.check, label %polly.loop_header805, label %vector.ph1120

vector.ph1120:                                    ; preds = %polly.loop_header799
  %broadcast.splatinsert1127 = insertelement <4 x i64> poison, i64 %212, i32 0
  %broadcast.splat1128 = shufflevector <4 x i64> %broadcast.splatinsert1127, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1129 = insertelement <4 x i32> poison, i32 %215, i32 0
...
vector.body1119:                                  ; preds = %vector.body1119, %vector.ph1120
  ...
  %217 = add nuw nsw <4 x i64> %vec.ind1125, %broadcast.splat1128
  %218 = trunc <4 x i64> %217 to <4 x i32>
  %219 = mul <4 x i32> %broadcast.splat1130, %218
  ...
  %229 = icmp eq i64 %index.next1122, %211
  br i1 %229, label %polly.loop_exit807, label %vector.body1119, !llvm.loop !98

polly.loop_exit807:                               ; preds = %vector.body1119, %polly.loop_header805
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %smin1134 = call i64 @llvm.smin.i64(i64 %239, i64 -968)
  %240 = add nsw i64 %smin1134, 1000
...
polly.loop_header826:                             ; preds = %polly.loop_exit834, %polly.loop_header820
  ...
  %min.iters.check1135 = icmp eq i64 %240, 0
  br i1 %min.iters.check1135, label %polly.loop_header832, label %vector.ph1136

vector.ph1136:                                    ; preds = %polly.loop_header826
  %broadcast.splatinsert1145 = insertelement <4 x i64> poison, i64 %241, i32 0
  %broadcast.splat1146 = shufflevector <4 x i64> %broadcast.splatinsert1145, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1147 = insertelement <4 x i32> poison, i32 %244, i32 0
...
vector.body1133:                                  ; preds = %vector.body1133, %vector.ph1136
  ...
  %246 = add nuw nsw <4 x i64> %vec.ind1143, %broadcast.splat1146
  %247 = trunc <4 x i64> %246 to <4 x i32>
  %248 = mul <4 x i32> %broadcast.splat1148, %247
  ...
  %258 = icmp eq i64 %index.next1140, %240
  br i1 %258, label %polly.loop_exit834, label %vector.body1133, !llvm.loop !101

polly.loop_exit834:                               ; preds = %vector.body1133, %polly.loop_header832
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %smin1152 = call i64 @llvm.smin.i64(i64 %268, i64 -968)
  %269 = add nsw i64 %smin1152, 1000
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %min.iters.check1153 = icmp eq i64 %269, 0
  br i1 %min.iters.check1153, label %polly.loop_header858, label %vector.ph1154

vector.ph1154:                                    ; preds = %polly.loop_header852
  %broadcast.splatinsert1163 = insertelement <4 x i64> poison, i64 %270, i32 0
  %broadcast.splat1164 = shufflevector <4 x i64> %broadcast.splatinsert1163, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1165 = insertelement <4 x i32> poison, i32 %273, i32 0
...
vector.body1151:                                  ; preds = %vector.body1151, %vector.ph1154
  ...
  %275 = add nuw nsw <4 x i64> %vec.ind1161, %broadcast.splat1164
  %276 = trunc <4 x i64> %275 to <4 x i32>
  %277 = mul <4 x i32> %broadcast.splat1166, %276
  ...
  %287 = icmp eq i64 %index.next1158, %269
  br i1 %287, label %polly.loop_exit860, label %vector.body1151, !llvm.loop !104

polly.loop_exit860:                               ; preds = %vector.body1151, %polly.loop_header858
