; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5267.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5267.c"
...
vector.body1094:                                  ; preds = %vector.body1094, %vector.ph1095
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call805, i64 %indvars.iv7.i, i64 %index1096
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1157, label %for.body3.i46.preheader1234, label %vector.ph1158
...
vector.body1156:                                  ; preds = %vector.body1156, %vector.ph1158
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call805, i64 %indvars.iv21.i, i64 %index1161
...
for.body3.i46.preheader1234:                      ; preds = %for.body3.i46.preheader, %middle.block1154
...
vector.body1179:                                  ; preds = %vector.body1179, %vector.ph1181
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call805, i64 %indvars.iv21.i52, i64 %index1184
...
vector.body1205:                                  ; preds = %vector.body1205, %vector.ph1207
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call805, i64 %indvars.iv21.i91, i64 %index1210
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin986 = call i64 @llvm.smin.i64(i64 %indvars.iv984, i64 -1072)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next985 = add nsw i64 %indvars.iv984, -128
...
polly.loop_header365:                             ; preds = %polly.loop_exit373, %polly.start279
  %indvar1192 = phi i64 [ %indvar.next1193, %polly.loop_exit373 ], [ 0, %polly.start279 ]
  %polly.indvar368 = phi i64 [ %polly.indvar_next369, %polly.loop_exit373 ], [ 1, %polly.start279 ]
  %118 = add i64 %indvar1192, 1
  %119 = mul nuw nsw i64 %polly.indvar368, 9600
  %scevgep377 = getelementptr i8, i8* %call, i64 %119
  %min.iters.check1194 = icmp ult i64 %118, 4
  br i1 %min.iters.check1194, label %polly.loop_header371.preheader, label %vector.ph1195

vector.ph1195:                                    ; preds = %polly.loop_header365
  %n.vec1197 = and i64 %118, -4
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1195
  ...
  %120 = shl nuw nsw i64 %index1198, 3
  %121 = getelementptr i8, i8* %scevgep377, i64 %120
  %122 = bitcast i8* %121 to <4 x double>*
  %wide.load1202 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !73, !noalias !75
  %123 = fmul fast <4 x double> %wide.load1202, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %125 = icmp eq i64 %index.next1199, %n.vec1197
  br i1 %125, label %middle.block1189, label %vector.body1191, !llvm.loop !79

middle.block1189:                                 ; preds = %vector.body1191
  %cmp.n1201 = icmp eq i64 %118, %n.vec1197
  br i1 %cmp.n1201, label %polly.loop_exit373, label %polly.loop_header371.preheader

polly.loop_header371.preheader:                   ; preds = %polly.loop_header365, %middle.block1189
  %polly.indvar374.ph = phi i64 [ 0, %polly.loop_header365 ], [ %n.vec1197, %middle.block1189 ]
  br label %polly.loop_header371

polly.loop_exit373:                               ; preds = %polly.loop_header371, %middle.block1189
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %127 = shl nsw i64 %polly.indvar384, 7
...
polly.loop_exit389:                               ; preds = %polly.loop_exit395
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar_next385, 10
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1015.not = icmp eq i64 %polly.indvar_next391, 20
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %130 = shl nsw i64 %polly.indvar396, 7
...
polly.merge424.us:                                ; preds = %polly.then425.us, %polly.cond423.loopexit.us
  ...
  %exitcond1004.not = icmp eq i64 %polly.indvar_next409.us, 50
...
polly.loop_header405:                             ; preds = %polly.loop_header399.split, %polly.loop_header405
  ...
  %exitcond995.not = icmp eq i64 %polly.indvar_next409, 50
  br i1 %exitcond995.not, label %polly.loop_header434.preheader, label %polly.loop_header405
...
polly.loop_exit443.loopexit.us:                   ; preds = %polly.loop_header441.us
  ...
  %exitcond1007.not = icmp eq i64 %polly.indvar_next438.us, 50
  br i1 %exitcond1007.not, label %polly.loop_exit436, label %polly.loop_header434.us

polly.start467:                                   ; preds = %init_array.exit
  %malloccall469 = tail call dereferenceable_or_null(480000) i8* @malloc(i64 480000) #6
...
polly.loop_header553:                             ; preds = %polly.loop_exit561, %polly.start467
  ...
  %min.iters.check1168 = icmp ult i64 %148, 4
  br i1 %min.iters.check1168, label %polly.loop_header559.preheader, label %vector.ph1169

vector.ph1169:                                    ; preds = %polly.loop_header553
  %n.vec1171 = and i64 %148, -4
...
vector.body1167:                                  ; preds = %vector.body1167, %vector.ph1169
  ...
  %150 = shl nuw nsw i64 %index1172, 3
  %151 = getelementptr i8, i8* %scevgep565, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load1176 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !83, !noalias !85
  %153 = fmul fast <4 x double> %wide.load1176, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next1173, %n.vec1171
  br i1 %155, label %middle.block1165, label %vector.body1167, !llvm.loop !89

middle.block1165:                                 ; preds = %vector.body1167
  %cmp.n1175 = icmp eq i64 %148, %n.vec1171
  br i1 %cmp.n1175, label %polly.loop_exit561, label %polly.loop_header559.preheader

polly.loop_header559.preheader:                   ; preds = %polly.loop_header553, %middle.block1165
  %polly.indvar562.ph = phi i64 [ 0, %polly.loop_header553 ], [ %n.vec1171, %middle.block1165 ]
  br label %polly.loop_header559

polly.loop_exit561:                               ; preds = %polly.loop_header559, %middle.block1165
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %smin1034 = call i64 @llvm.smin.i64(i64 %indvars.iv1032, i64 -1072)
  %157 = shl nsw i64 %polly.indvar572, 7
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next573, 10
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_header575
  ...
  %160 = shl nsw i64 %polly.indvar584, 7
...
polly.loop_header587:                             ; preds = %polly.loop_exit624, %polly.loop_header581
  ...
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1024, i64 127)
...
polly.merge612.us:                                ; preds = %polly.then613.us, %polly.cond611.loopexit.us
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next597.us, 50
...
polly.loop_header593:                             ; preds = %polly.loop_header587.split, %polly.loop_header593
  ...
  %exitcond1019.not = icmp eq i64 %polly.indvar_next597, 50
  br i1 %exitcond1019.not, label %polly.loop_header622.preheader, label %polly.loop_header593
...
polly.loop_exit631.loopexit.us:                   ; preds = %polly.loop_header629.us
  ...
  %exitcond1031.not = icmp eq i64 %polly.indvar_next626.us, 50
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  br i1 %min.iters.check, label %polly.loop_header797, label %vector.ph1107

vector.ph1107:                                    ; preds = %polly.loop_header791
  %broadcast.splatinsert1114 = insertelement <4 x i64> poison, i64 %182, i32 0
  %broadcast.splat1115 = shufflevector <4 x i64> %broadcast.splatinsert1114, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1116 = insertelement <4 x i32> poison, i32 %185, i32 0
...
vector.body1106:                                  ; preds = %vector.body1106, %vector.ph1107
  ...
  %187 = add nuw nsw <4 x i64> %vec.ind1112, %broadcast.splat1115
  %188 = trunc <4 x i64> %187 to <4 x i32>
  %189 = mul <4 x i32> %broadcast.splat1117, %188
  ...
  %199 = icmp eq i64 %index.next1109, %181
  br i1 %199, label %polly.loop_exit799, label %vector.body1106, !llvm.loop !98

polly.loop_exit799:                               ; preds = %vector.body1106, %polly.loop_header797
...
polly.loop_header812:                             ; preds = %polly.loop_exit820, %polly.loop_header806
  ...
  %smin1121 = call i64 @llvm.smin.i64(i64 %209, i64 -968)
  %210 = add nsw i64 %smin1121, 1000
...
polly.loop_header818:                             ; preds = %polly.loop_exit826, %polly.loop_header812
  ...
  %min.iters.check1122 = icmp eq i64 %210, 0
  br i1 %min.iters.check1122, label %polly.loop_header824, label %vector.ph1123

vector.ph1123:                                    ; preds = %polly.loop_header818
  %broadcast.splatinsert1132 = insertelement <4 x i64> poison, i64 %211, i32 0
  %broadcast.splat1133 = shufflevector <4 x i64> %broadcast.splatinsert1132, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1134 = insertelement <4 x i32> poison, i32 %214, i32 0
...
vector.body1120:                                  ; preds = %vector.body1120, %vector.ph1123
  ...
  %216 = add nuw nsw <4 x i64> %vec.ind1130, %broadcast.splat1133
  %217 = trunc <4 x i64> %216 to <4 x i32>
  %218 = mul <4 x i32> %broadcast.splat1135, %217
  ...
  %228 = icmp eq i64 %index.next1127, %210
  br i1 %228, label %polly.loop_exit826, label %vector.body1120, !llvm.loop !101

polly.loop_exit826:                               ; preds = %vector.body1120, %polly.loop_header824
...
polly.loop_header838:                             ; preds = %polly.loop_exit846, %polly.loop_header832
  ...
  %smin1139 = call i64 @llvm.smin.i64(i64 %238, i64 -968)
  %239 = add nsw i64 %smin1139, 1000
...
polly.loop_header844:                             ; preds = %polly.loop_exit852, %polly.loop_header838
  ...
  %min.iters.check1140 = icmp eq i64 %239, 0
  br i1 %min.iters.check1140, label %polly.loop_header850, label %vector.ph1141

vector.ph1141:                                    ; preds = %polly.loop_header844
  %broadcast.splatinsert1150 = insertelement <4 x i64> poison, i64 %240, i32 0
  %broadcast.splat1151 = shufflevector <4 x i64> %broadcast.splatinsert1150, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1152 = insertelement <4 x i32> poison, i32 %243, i32 0
...
vector.body1138:                                  ; preds = %vector.body1138, %vector.ph1141
  ...
  %245 = add nuw nsw <4 x i64> %vec.ind1148, %broadcast.splat1151
  %246 = trunc <4 x i64> %245 to <4 x i32>
  %247 = mul <4 x i32> %broadcast.splat1153, %246
  ...
  %257 = icmp eq i64 %index.next1145, %239
  br i1 %257, label %polly.loop_exit852, label %vector.body1138, !llvm.loop !104

polly.loop_exit852:                               ; preds = %vector.body1138, %polly.loop_header850
