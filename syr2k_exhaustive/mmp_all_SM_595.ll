; ModuleID = 'syr2k_exhaustive/mmp_all_SM_595.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_595.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %102 = add i64 %101, %99
  %103 = lshr i64 %polly.indvar203, 2
...
polly.loop_exit224:                               ; preds = %polly.loop_exit259
  ...
  %exitcond1089.not = icmp eq i64 %117, 150
...
polly.loop_header222:                             ; preds = %polly.loop_exit259, %polly.loop_exit208
  ...
  %119 = mul nsw i64 %indvar1386, -32
  %120 = add i64 %100, %119
  %smax1388 = call i64 @llvm.smax.i64(i64 %120, i64 0)
  %121 = shl nuw nsw i64 %indvar1386, 5
  %122 = add i64 %102, %121
  %123 = add i64 %smax1388, %122
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1078, i64 0)
  %124 = add i64 %smax, %indvars.iv1082
  %125 = shl nsw i64 %polly.indvar225, 2
  %.not.not = icmp ugt i64 %125, %polly.indvar203
  %126 = shl nsw i64 %polly.indvar225, 5
...
polly.loop_header257.preheader:                   ; preds = %polly.loop_exit246, %polly.loop_exit246.us, %polly.loop_header222.split
  ...
  %137 = mul nsw i64 %polly.indvar225, -32
...
polly.loop_header264:                             ; preds = %polly.loop_header257, %polly.loop_exit274
  ...
  %142 = add i64 %123, %indvar1389
  %smin1391 = call i64 @llvm.smin.i64(i64 %142, i64 7)
  %143 = add nsw i64 %smin1391, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1084, i64 7)
  %144 = add nsw i64 %polly.indvar268, %127
  %polly.loop_guard2751179 = icmp sgt i64 %144, -1
...
polly.loop_header272.preheader:                   ; preds = %polly.loop_header264
  ...
  %min.iters.check1392 = icmp ult i64 %143, 4
...
vector.body1385:                                  ; preds = %vector.body1385, %vector.ph1393
  ...
  %147 = add nuw nsw i64 %index1396, %108
  %148 = add nuw nsw i64 %index1396, %polly.access.mul.Packed_MemRef_call1279
  %149 = getelementptr double, double* %Packed_MemRef_call1, i64 %148
  %150 = bitcast double* %149 to <4 x double>*
  %wide.load1400 = load <4 x double>, <4 x double>* %150, align 8
  %151 = fmul fast <4 x double> %broadcast.splat1402, %wide.load1400
  %152 = getelementptr double, double* %Packed_MemRef_call2, i64 %148
  %153 = bitcast double* %152 to <4 x double>*
  %wide.load1403 = load <4 x double>, <4 x double>* %153, align 8
  %154 = fmul fast <4 x double> %broadcast.splat1405, %wide.load1403
  %155 = shl i64 %147, 3
  %156 = add i64 %155, %146
  %157 = getelementptr i8, i8* %call, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load1406 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !72, !noalias !74
  ...
  %161 = fadd fast <4 x double> %160, %wide.load1406
  ...
  %163 = icmp eq i64 %index.next1397, %n.vec1395
  br i1 %163, label %middle.block1383, label %vector.body1385, !llvm.loop !84

middle.block1383:                                 ; preds = %vector.body1385
  %cmp.n1399 = icmp eq i64 %143, %n.vec1395
...
vector.body1321:                                  ; preds = %vector.body1321, %vector.ph1325
  ...
  %169 = shl nuw nsw i64 %index1328, 3
  %170 = getelementptr i8, i8* %scevgep400, i64 %169
  %171 = bitcast i8* %170 to <4 x double>*
  %wide.load1332 = load <4 x double>, <4 x double>* %171, align 8, !alias.scope !86, !noalias !88
  %172 = fmul fast <4 x double> %wide.load1332, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %174 = icmp eq i64 %index.next1329, %n.vec1327
  br i1 %174, label %middle.block1319, label %vector.body1321, !llvm.loop !93

middle.block1319:                                 ; preds = %vector.body1321
  %cmp.n1331 = icmp eq i64 %167, %n.vec1327
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit429
  ...
  %178 = and i64 %177, 9223372036854775776
  %179 = sub nsw i64 %176, %178
  %180 = mul nsw i64 %polly.indvar407, -8
  %181 = add i64 %180, %178
  %182 = lshr i64 %polly.indvar407, 2
  %183 = shl nuw nsw i64 %182, 5
  %184 = sub nsw i64 %indvars.iv1099, %183
  %185 = add i64 %indvars.iv1104, %183
...
polly.loop_exit429:                               ; preds = %polly.loop_exit470
  ...
  %exitcond1114.not = icmp eq i64 %196, 150
...
polly.loop_header427:                             ; preds = %polly.loop_exit470, %polly.loop_exit412
  ...
  %indvars.iv1106 = phi i64 [ %indvars.iv.next1107, %polly.loop_exit470 ], [ %185, %polly.loop_exit412 ]
  %indvars.iv1101 = phi i64 [ %indvars.iv.next1102, %polly.loop_exit470 ], [ %184, %polly.loop_exit412 ]
  %polly.indvar430 = phi i64 [ %polly.indvar_next431, %polly.loop_exit470 ], [ %182, %polly.loop_exit412 ]
  %198 = mul nsw i64 %indvar1336, -32
  %199 = add i64 %179, %198
  %smax1338 = call i64 @llvm.smax.i64(i64 %199, i64 0)
  %200 = shl nuw nsw i64 %indvar1336, 5
  %201 = add i64 %181, %200
  %202 = add i64 %smax1338, %201
  %smax1103 = call i64 @llvm.smax.i64(i64 %indvars.iv1101, i64 0)
  %203 = add i64 %smax1103, %indvars.iv1106
  %204 = shl nsw i64 %polly.indvar430, 2
  %.not.not926 = icmp ugt i64 %204, %polly.indvar407
  %205 = shl nsw i64 %polly.indvar430, 5
  %206 = add nsw i64 %205, %186
  %207 = icmp sgt i64 %206, 0
  %208 = select i1 %207, i64 %206, i64 0
  %209 = add nsw i64 %206, 31
...
polly.loop_header468.preheader:                   ; preds = %polly.loop_exit456, %polly.loop_exit456.us, %polly.loop_header427.split
  ...
  %216 = mul nsw i64 %polly.indvar430, -32
...
polly.loop_header475:                             ; preds = %polly.loop_header468, %polly.loop_exit485
  ...
  %indvars.iv1108 = phi i64 [ %203, %polly.loop_header468 ], [ %indvars.iv.next1109, %polly.loop_exit485 ]
  %polly.indvar479 = phi i64 [ %215, %polly.loop_header468 ], [ %polly.indvar_next480, %polly.loop_exit485 ]
  %221 = add i64 %202, %indvar1339
  %smin1341 = call i64 @llvm.smin.i64(i64 %221, i64 7)
  %222 = add nsw i64 %smin1341, 1
  %smin1110 = call i64 @llvm.smin.i64(i64 %indvars.iv1108, i64 7)
  %223 = add nsw i64 %polly.indvar479, %206
  %polly.loop_guard4861180 = icmp sgt i64 %223, -1
...
polly.loop_header483.preheader:                   ; preds = %polly.loop_header475
  ...
  %min.iters.check1342 = icmp ult i64 %222, 4
...
vector.body1335:                                  ; preds = %vector.body1335, %vector.ph1343
  ...
  %226 = add nuw nsw i64 %index1346, %187
  %227 = add nuw nsw i64 %index1346, %polly.access.mul.Packed_MemRef_call1303490
  %228 = getelementptr double, double* %Packed_MemRef_call1303, i64 %227
  %229 = bitcast double* %228 to <4 x double>*
  %wide.load1350 = load <4 x double>, <4 x double>* %229, align 8
  %230 = fmul fast <4 x double> %broadcast.splat1352, %wide.load1350
  %231 = getelementptr double, double* %Packed_MemRef_call2305, i64 %227
  %232 = bitcast double* %231 to <4 x double>*
  %wide.load1353 = load <4 x double>, <4 x double>* %232, align 8
  %233 = fmul fast <4 x double> %broadcast.splat1355, %wide.load1353
  %234 = shl i64 %226, 3
  %235 = add i64 %234, %225
  %236 = getelementptr i8, i8* %call, i64 %235
  %237 = bitcast i8* %236 to <4 x double>*
  %wide.load1356 = load <4 x double>, <4 x double>* %237, align 8, !alias.scope !86, !noalias !88
  ...
  %240 = fadd fast <4 x double> %239, %wide.load1356
  ...
  %242 = icmp eq i64 %index.next1347, %n.vec1345
  br i1 %242, label %middle.block1333, label %vector.body1335, !llvm.loop !97

middle.block1333:                                 ; preds = %vector.body1335
  %cmp.n1349 = icmp eq i64 %222, %n.vec1345
...
polly.loop_header599:                             ; preds = %polly.loop_exit607, %polly.start511
  ...
  %min.iters.check1274 = icmp ult i64 %246, 4
...
vector.body1273:                                  ; preds = %vector.body1273, %vector.ph1275
  ...
  %248 = shl nuw nsw i64 %index1278, 3
  %249 = getelementptr i8, i8* %scevgep611, i64 %248
  %250 = bitcast i8* %249 to <4 x double>*
  %wide.load1282 = load <4 x double>, <4 x double>* %250, align 8, !alias.scope !99, !noalias !101
  %251 = fmul fast <4 x double> %wide.load1282, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %253 = icmp eq i64 %index.next1279, %n.vec1277
  br i1 %253, label %middle.block1271, label %vector.body1273, !llvm.loop !106

middle.block1271:                                 ; preds = %vector.body1273
  %cmp.n1281 = icmp eq i64 %246, %n.vec1277
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %256 = shl nuw nsw i64 %polly.indvar618, 3
  %257 = and i64 %256, 9223372036854775776
  %258 = sub nsw i64 %255, %257
  %259 = mul nsw i64 %polly.indvar618, -8
  %260 = add i64 %259, %257
  %261 = lshr i64 %polly.indvar618, 2
  %262 = shl nuw nsw i64 %261, 5
  %263 = sub nsw i64 %indvars.iv1124, %262
  %264 = add i64 %indvars.iv1129, %262
...
polly.loop_exit640:                               ; preds = %polly.loop_exit681
  ...
  %exitcond1139.not = icmp eq i64 %275, 150
...
polly.loop_header638:                             ; preds = %polly.loop_exit681, %polly.loop_exit623
  ...
  %indvars.iv1131 = phi i64 [ %indvars.iv.next1132, %polly.loop_exit681 ], [ %264, %polly.loop_exit623 ]
  %indvars.iv1126 = phi i64 [ %indvars.iv.next1127, %polly.loop_exit681 ], [ %263, %polly.loop_exit623 ]
  %polly.indvar641 = phi i64 [ %polly.indvar_next642, %polly.loop_exit681 ], [ %261, %polly.loop_exit623 ]
  %277 = mul nsw i64 %indvar1286, -32
  %278 = add i64 %258, %277
  %smax1288 = call i64 @llvm.smax.i64(i64 %278, i64 0)
  %279 = shl nuw nsw i64 %indvar1286, 5
  %280 = add i64 %260, %279
  %281 = add i64 %smax1288, %280
  %smax1128 = call i64 @llvm.smax.i64(i64 %indvars.iv1126, i64 0)
  %282 = add i64 %smax1128, %indvars.iv1131
  %283 = shl nsw i64 %polly.indvar641, 2
  %.not.not927 = icmp ugt i64 %283, %polly.indvar618
  %284 = shl nsw i64 %polly.indvar641, 5
  %285 = add nsw i64 %284, %265
  %286 = icmp sgt i64 %285, 0
  %287 = select i1 %286, i64 %285, i64 0
  %288 = add nsw i64 %285, 31
...
polly.loop_header679.preheader:                   ; preds = %polly.loop_exit667, %polly.loop_exit667.us, %polly.loop_header638.split
  ...
  %295 = mul nsw i64 %polly.indvar641, -32
...
polly.loop_header686:                             ; preds = %polly.loop_header679, %polly.loop_exit696
  ...
  %indvars.iv1133 = phi i64 [ %282, %polly.loop_header679 ], [ %indvars.iv.next1134, %polly.loop_exit696 ]
  %polly.indvar690 = phi i64 [ %294, %polly.loop_header679 ], [ %polly.indvar_next691, %polly.loop_exit696 ]
  %300 = add i64 %281, %indvar1289
  %smin1291 = call i64 @llvm.smin.i64(i64 %300, i64 7)
  %301 = add nsw i64 %smin1291, 1
  %smin1135 = call i64 @llvm.smin.i64(i64 %indvars.iv1133, i64 7)
  %302 = add nsw i64 %polly.indvar690, %285
  %polly.loop_guard6971181 = icmp sgt i64 %302, -1
...
polly.loop_header694.preheader:                   ; preds = %polly.loop_header686
  ...
  %min.iters.check1292 = icmp ult i64 %301, 4
...
vector.body1285:                                  ; preds = %vector.body1285, %vector.ph1293
  ...
  %305 = add nuw nsw i64 %index1296, %266
  %306 = add nuw nsw i64 %index1296, %polly.access.mul.Packed_MemRef_call1514701
  %307 = getelementptr double, double* %Packed_MemRef_call1514, i64 %306
  %308 = bitcast double* %307 to <4 x double>*
  %wide.load1300 = load <4 x double>, <4 x double>* %308, align 8
  %309 = fmul fast <4 x double> %broadcast.splat1302, %wide.load1300
  %310 = getelementptr double, double* %Packed_MemRef_call2516, i64 %306
  %311 = bitcast double* %310 to <4 x double>*
  %wide.load1303 = load <4 x double>, <4 x double>* %311, align 8
  %312 = fmul fast <4 x double> %broadcast.splat1305, %wide.load1303
  %313 = shl i64 %305, 3
  %314 = add i64 %313, %304
  %315 = getelementptr i8, i8* %call, i64 %314
  %316 = bitcast i8* %315 to <4 x double>*
  %wide.load1306 = load <4 x double>, <4 x double>* %316, align 8, !alias.scope !99, !noalias !101
  ...
  %319 = fadd fast <4 x double> %318, %wide.load1306
  ...
  %321 = icmp eq i64 %index.next1297, %n.vec1295
  br i1 %321, label %middle.block1283, label %vector.body1285, !llvm.loop !110

middle.block1283:                                 ; preds = %vector.body1285
  %cmp.n1299 = icmp eq i64 %301, %n.vec1295
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %smin1212 = call i64 @llvm.smin.i64(i64 %327, i64 -1168)
  %328 = add nsw i64 %smin1212, 1200
  %smin1164 = call i64 @llvm.smin.i64(i64 %indvars.iv1162, i64 -1168)
  %329 = shl nsw i64 %polly.indvar855, 5
  %330 = add nsw i64 %smin1164, 1199
...
vector.ph1213:                                    ; preds = %polly.loop_header858
  %broadcast.splatinsert1220 = insertelement <4 x i64> poison, i64 %329, i32 0
  %broadcast.splat1221 = shufflevector <4 x i64> %broadcast.splatinsert1220, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1222 = insertelement <4 x i32> poison, i32 %332, i32 0
...
vector.body1211:                                  ; preds = %vector.body1211, %vector.ph1213
  ...
  %334 = add nuw nsw <4 x i64> %vec.ind1218, %broadcast.splat1221
  %335 = trunc <4 x i64> %334 to <4 x i32>
  %336 = mul <4 x i32> %broadcast.splat1223, %335
  ...
  %346 = icmp eq i64 %index.next1215, %328
  br i1 %346, label %polly.loop_exit866, label %vector.body1211, !llvm.loop !117

polly.loop_exit866:                               ; preds = %vector.body1211, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1169.not = icmp eq i64 %polly.indvar861, %326
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1165.not = icmp eq i64 %polly.indvar867, %330
...
polly.loop_header879:                             ; preds = %polly.loop_exit887, %polly.loop_header873
  ...
  %smin1227 = call i64 @llvm.smin.i64(i64 %356, i64 -968)
  %357 = add nsw i64 %smin1227, 1000
  %smin1154 = call i64 @llvm.smin.i64(i64 %indvars.iv1152, i64 -968)
  %358 = shl nsw i64 %polly.indvar882, 5
  %359 = add nsw i64 %smin1154, 999
...
vector.body1226:                                  ; preds = %vector.body1226, %vector.ph1229
  ...
  %363 = add nuw nsw <4 x i64> %vec.ind1236, %broadcast.splat1239
  %364 = trunc <4 x i64> %363 to <4 x i32>
  %365 = mul <4 x i32> %broadcast.splat1241, %364
  ...
  %375 = icmp eq i64 %index.next1233, %357
  br i1 %375, label %polly.loop_exit893, label %vector.body1226, !llvm.loop !120

polly.loop_exit893:                               ; preds = %vector.body1226, %polly.loop_header891
  %polly.indvar_next889 = add nuw nsw i64 %polly.indvar888, 1
  %exitcond1159.not = icmp eq i64 %polly.indvar888, %355
...
polly.loop_header891:                             ; preds = %polly.loop_header885, %polly.loop_header891
  ...
  %exitcond1155.not = icmp eq i64 %polly.indvar894, %359
...
polly.loop_header905:                             ; preds = %polly.loop_exit913, %polly.loop_header899
  ...
  %smin1245 = call i64 @llvm.smin.i64(i64 %385, i64 -968)
  %386 = add nsw i64 %smin1245, 1000
  %smin1144 = call i64 @llvm.smin.i64(i64 %indvars.iv1142, i64 -968)
  %387 = shl nsw i64 %polly.indvar908, 5
  %388 = add nsw i64 %smin1144, 999
...
vector.body1244:                                  ; preds = %vector.body1244, %vector.ph1247
  ...
  %392 = add nuw nsw <4 x i64> %vec.ind1254, %broadcast.splat1257
  %393 = trunc <4 x i64> %392 to <4 x i32>
  %394 = mul <4 x i32> %broadcast.splat1259, %393
  ...
  %404 = icmp eq i64 %index.next1251, %386
  br i1 %404, label %polly.loop_exit919, label %vector.body1244, !llvm.loop !123

polly.loop_exit919:                               ; preds = %vector.body1244, %polly.loop_header917
  %polly.indvar_next915 = add nuw nsw i64 %polly.indvar914, 1
  %exitcond1149.not = icmp eq i64 %polly.indvar914, %384
...
polly.loop_header917:                             ; preds = %polly.loop_header911, %polly.loop_header917
  ...
  %exitcond1145.not = icmp eq i64 %polly.indvar920, %388
