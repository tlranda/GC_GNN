; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1184.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1184.c"
...
vector.body1520:                                  ; preds = %vector.body1520, %vector.ph1528
  ...
  %wide.load1541 = load <4 x double>, <4 x double>* %157, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %162, label %middle.block1518, label %vector.body1520, !llvm.loop !84
...
vector.body1456:                                  ; preds = %vector.body1456, %vector.ph1460
  ...
  %wide.load1467 = load <4 x double>, <4 x double>* %169, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %172, label %middle.block1454, label %vector.body1456, !llvm.loop !92
...
vector.body1470:                                  ; preds = %vector.body1470, %vector.ph1478
  ...
  %wide.load1491 = load <4 x double>, <4 x double>* %234, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %239, label %middle.block1468, label %vector.body1470, !llvm.loop !97
...
vector.body1408:                                  ; preds = %vector.body1408, %vector.ph1410
  ...
  %wide.load1417 = load <4 x double>, <4 x double>* %246, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %249, label %middle.block1406, label %vector.body1408, !llvm.loop !105
...
vector.body1420:                                  ; preds = %vector.body1420, %vector.ph1428
  ...
  %wide.load1441 = load <4 x double>, <4 x double>* %311, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %314, <4 x double>* %315, align 8, !alias.scope !98, !noalias !100
  %index.next1432 = add i64 %index1431, 4
  %316 = icmp eq i64 %index.next1432, %n.vec1430
  br i1 %316, label %middle.block1418, label %vector.body1420, !llvm.loop !110
...
vector.body1346:                                  ; preds = %vector.body1346, %vector.ph1348
  ...
  br i1 %340, label %polly.loop_exit935, label %vector.body1346, !llvm.loop !116
...
vector.body1361:                                  ; preds = %vector.body1361, %vector.ph1364
  ...
  br i1 %369, label %polly.loop_exit962, label %vector.body1361, !llvm.loop !119
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1382
  ...
  br i1 %398, label %polly.loop_exit988, label %vector.body1379, !llvm.loop !122
