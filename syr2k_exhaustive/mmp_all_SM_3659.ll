; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3659.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3659.c"
...
vector.body1247:                                  ; preds = %vector.body1247, %vector.ph1251
  ...
  %wide.load1258 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %149, label %middle.block1245, label %vector.body1247, !llvm.loop !85
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %152 = shl nsw i64 %polly.indvar396, 4
...
vector.body1223:                                  ; preds = %vector.body1223, %vector.ph1225
  ...
  %wide.load1232 = load <4 x double>, <4 x double>* %200, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %203, label %middle.block1221, label %vector.body1223, !llvm.loop !95
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %206 = shl nsw i64 %polly.indvar593, 4
...
vector.body1162:                                  ; preds = %vector.body1162, %vector.ph1163
  ...
  br i1 %271, label %polly.loop_exit829, label %vector.body1162, !llvm.loop !104
...
vector.body1176:                                  ; preds = %vector.body1176, %vector.ph1179
  ...
  br i1 %300, label %polly.loop_exit856, label %vector.body1176, !llvm.loop !107
...
vector.body1194:                                  ; preds = %vector.body1194, %vector.ph1197
  ...
  br i1 %329, label %polly.loop_exit882, label %vector.body1194, !llvm.loop !110
