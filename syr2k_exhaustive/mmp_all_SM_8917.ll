; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8917.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8917.c"
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph950
  ...
  br i1 %57, label %middle.block946, label %vector.body948, !llvm.loop !52
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  br i1 %68, label %middle.block972, label %vector.body974, !llvm.loop !54
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph990
  ...
  %wide.load997 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !60, !noalias !62
  ...
  br i1 %95, label %middle.block984, label %vector.body986, !llvm.loop !65
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond780.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !66
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225
  ...
  %exitcond777.not = icmp eq i64 %polly.indvar_next215, 15
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph964
  ...
  %114 = shl nuw nsw i64 %index967, 3
  %115 = getelementptr i8, i8* %scevgep348, i64 %114
  %116 = bitcast i8* %115 to <4 x double>*
  %wide.load971 = load <4 x double>, <4 x double>* %116, align 8, !alias.scope !70, !noalias !72
  %117 = fmul fast <4 x double> %wide.load971, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %118 = bitcast i8* %115 to <4 x double>*
  store <4 x double> %117, <4 x double>* %118, align 8, !alias.scope !70, !noalias !72
  %index.next968 = add i64 %index967, 4
  %119 = icmp eq i64 %index.next968, %n.vec966
  br i1 %119, label %middle.block958, label %vector.body960, !llvm.loop !75

middle.block958:                                  ; preds = %vector.body960
  %cmp.n970 = icmp eq i64 %112, %n.vec966
...
polly.loop_header342:                             ; preds = %polly.loop_header342.preheader, %polly.loop_header342
  ...
  br i1 %exitcond796.not, label %polly.loop_exit344, label %polly.loop_header342, !llvm.loop !76
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %121 = mul nuw nsw i64 %polly.indvar355, 80
  %122 = add nsw i64 %smin791, 999
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %123 = mul nuw nsw i64 %polly.indvar361, 80
...
polly.loop_exit372:                               ; preds = %polly.loop_exit378
  ...
  %indvars.iv.next783 = add nuw nsw i64 %indvars.iv782, 80
  %exitcond793.not = icmp eq i64 %polly.indvar_next368, 15
...
polly.loop_exit378:                               ; preds = %polly.loop_exit384
  ...
  %exitcond792.not = icmp eq i64 %polly.indvar373, %122
...
polly.loop_exit384:                               ; preds = %polly.loop_header382
  ...
  %exitcond788.not = icmp eq i64 %polly.indvar_next380, 80
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  %138 = shl nuw nsw i64 %index941, 3
  %139 = getelementptr i8, i8* %scevgep501, i64 %138
  %140 = bitcast i8* %139 to <4 x double>*
  %wide.load945 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !79, !noalias !81
  %141 = fmul fast <4 x double> %wide.load945, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %143 = icmp eq i64 %index.next942, %n.vec940
  br i1 %143, label %middle.block934, label %vector.body936, !llvm.loop !84

middle.block934:                                  ; preds = %vector.body936
  %cmp.n944 = icmp eq i64 %136, %n.vec940
...
polly.loop_header495:                             ; preds = %polly.loop_header495.preheader, %polly.loop_header495
  ...
  br i1 %exitcond812.not, label %polly.loop_exit497, label %polly.loop_header495, !llvm.loop !85
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit513
  ...
  %145 = mul nuw nsw i64 %polly.indvar508, 80
  %146 = add nsw i64 %smin807, 999
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %147 = mul nuw nsw i64 %polly.indvar514, 80
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %148 = mul nuw nsw i64 %polly.indvar520, 80
...
polly.loop_exit525:                               ; preds = %polly.loop_exit531
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next521, 15
...
polly.loop_exit531:                               ; preds = %polly.loop_exit537
  ...
  %exitcond808.not = icmp eq i64 %polly.indvar526, %146
...
polly.loop_exit537:                               ; preds = %polly.loop_header535
  ...
  %exitcond804.not = icmp eq i64 %polly.indvar_next533, 80
...
polly.loop_header688:                             ; preds = %polly.loop_exit696, %polly.loop_header682
  ...
  %smin875 = call i64 @llvm.smin.i64(i64 %162, i64 -1168)
  %163 = add nsw i64 %smin875, 1200
  %smin836 = call i64 @llvm.smin.i64(i64 %indvars.iv834, i64 -1168)
  %164 = shl nsw i64 %polly.indvar691, 5
  %165 = add nsw i64 %smin836, 1199
...
vector.ph876:                                     ; preds = %polly.loop_header694
  %broadcast.splatinsert883 = insertelement <4 x i64> poison, i64 %164, i32 0
  %broadcast.splat884 = shufflevector <4 x i64> %broadcast.splatinsert883, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert885 = insertelement <4 x i32> poison, i32 %167, i32 0
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph876
  ...
  %169 = add nuw nsw <4 x i64> %vec.ind881, %broadcast.splat884
  %170 = trunc <4 x i64> %169 to <4 x i32>
  %171 = mul <4 x i32> %broadcast.splat886, %170
  ...
  store <4 x double> %175, <4 x double>* %180, align 8, !alias.scope !88, !noalias !90
  %index.next878 = add i64 %index877, 4
  %vec.ind.next882 = add <4 x i64> %vec.ind881, <i64 4, i64 4, i64 4, i64 4>
  %181 = icmp eq i64 %index.next878, %163
  br i1 %181, label %polly.loop_exit702, label %vector.body874, !llvm.loop !93

polly.loop_exit702:                               ; preds = %vector.body874, %polly.loop_header700
  %polly.indvar_next698 = add nuw nsw i64 %polly.indvar697, 1
  %exitcond841.not = icmp eq i64 %polly.indvar697, %161
...
polly.loop_header700:                             ; preds = %polly.loop_header694, %polly.loop_header700
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar703, %165
  br i1 %exitcond837.not, label %polly.loop_exit702, label %polly.loop_header700, !llvm.loop !94
...
polly.loop_header715:                             ; preds = %polly.loop_exit723, %polly.loop_header709
  ...
  %smin890 = call i64 @llvm.smin.i64(i64 %191, i64 -968)
  %192 = add nsw i64 %smin890, 1000
  %smin826 = call i64 @llvm.smin.i64(i64 %indvars.iv824, i64 -968)
  %193 = shl nsw i64 %polly.indvar718, 5
  %194 = add nsw i64 %smin826, 999
...
vector.body889:                                   ; preds = %vector.body889, %vector.ph892
  ...
  %198 = add nuw nsw <4 x i64> %vec.ind899, %broadcast.splat902
  %199 = trunc <4 x i64> %198 to <4 x i32>
  %200 = mul <4 x i32> %broadcast.splat904, %199
  ...
  store <4 x double> %204, <4 x double>* %209, align 8, !alias.scope !92, !noalias !95
  %index.next896 = add i64 %index895, 4
  %vec.ind.next900 = add <4 x i64> %vec.ind899, <i64 4, i64 4, i64 4, i64 4>
  %210 = icmp eq i64 %index.next896, %192
  br i1 %210, label %polly.loop_exit729, label %vector.body889, !llvm.loop !96

polly.loop_exit729:                               ; preds = %vector.body889, %polly.loop_header727
  %polly.indvar_next725 = add nuw nsw i64 %polly.indvar724, 1
  %exitcond831.not = icmp eq i64 %polly.indvar724, %190
...
polly.loop_header727:                             ; preds = %polly.loop_header721, %polly.loop_header727
  ...
  %exitcond827.not = icmp eq i64 %polly.indvar730, %194
  br i1 %exitcond827.not, label %polly.loop_exit729, label %polly.loop_header727, !llvm.loop !97
...
polly.loop_header741:                             ; preds = %polly.loop_exit749, %polly.loop_header735
  ...
  %smin908 = call i64 @llvm.smin.i64(i64 %220, i64 -968)
  %221 = add nsw i64 %smin908, 1000
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 -968)
  %222 = shl nsw i64 %polly.indvar744, 5
  %223 = add nsw i64 %smin816, 999
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  %227 = add nuw nsw <4 x i64> %vec.ind917, %broadcast.splat920
  %228 = trunc <4 x i64> %227 to <4 x i32>
  %229 = mul <4 x i32> %broadcast.splat922, %228
  ...
  store <4 x double> %233, <4 x double>* %238, align 8, !alias.scope !91, !noalias !98
  %index.next914 = add i64 %index913, 4
  %vec.ind.next918 = add <4 x i64> %vec.ind917, <i64 4, i64 4, i64 4, i64 4>
  %239 = icmp eq i64 %index.next914, %221
  br i1 %239, label %polly.loop_exit755, label %vector.body907, !llvm.loop !99

polly.loop_exit755:                               ; preds = %vector.body907, %polly.loop_header753
  %polly.indvar_next751 = add nuw nsw i64 %polly.indvar750, 1
  %exitcond821.not = icmp eq i64 %polly.indvar750, %219
...
polly.loop_header753:                             ; preds = %polly.loop_header747, %polly.loop_header753
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar756, %223
  br i1 %exitcond817.not, label %polly.loop_exit755, label %polly.loop_header753, !llvm.loop !100
}
