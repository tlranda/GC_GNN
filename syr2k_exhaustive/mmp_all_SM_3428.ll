; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3428.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3428.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar_next203, 50
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %102 = add i64 %indvars.iv1009, %100
  %103 = mul nsw i64 %polly.indvar208, -80
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  %indvars.iv1011 = phi i64 [ %indvars.iv.next1012, %polly.loop_exit250 ], [ %102, %polly.loop_header205 ]
  %indvars.iv1007 = phi i64 [ %indvars.iv.next1008, %polly.loop_exit250 ], [ %101, %polly.loop_header205 ]
  ...
  %106 = add i64 %smax, %indvars.iv1011
...
polly.loop_exit236.us:                            ; preds = %polly.loop_header234.us, %polly.loop_exit225.loopexit.us
  ...
  %exitcond1006.not = icmp eq i64 %polly.indvar_next221.us, 20
...
polly.loop_exit257:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar_next252, 20
...
polly.loop_header255:                             ; preds = %polly.loop_header248, %polly.loop_exit265
  %indvars.iv1013 = phi i64 [ %106, %polly.loop_header248 ], [ %indvars.iv.next1014, %polly.loop_exit265 ]
  ...
  %polly.loop_guard2661100 = icmp sgt i64 %130, -1
...
vector.body1218:                                  ; preds = %vector.body1218, %vector.ph1222
  ...
  %142 = shl nuw nsw i64 %index1225, 3
  %143 = getelementptr i8, i8* %scevgep387, i64 %142
  %144 = bitcast i8* %143 to <4 x double>*
  %wide.load1229 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !79, !noalias !81
  %145 = fmul fast <4 x double> %wide.load1229, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %147 = icmp eq i64 %index.next1226, %n.vec1224
  br i1 %147, label %middle.block1216, label %vector.body1218, !llvm.loop !85

middle.block1216:                                 ; preds = %vector.body1218
  %cmp.n1228 = icmp eq i64 %140, %n.vec1224
...
polly.loop_exit399:                               ; preds = %polly.loop_exit406
  ...
  %exitcond1039.not = icmp eq i64 %polly.indvar_next395, 50
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %150 = lshr i64 %polly.indvar400, 2
  %151 = add nuw i64 %polly.indvar400, %150
  %152 = shl nuw nsw i64 %151, 6
  %153 = sub i64 %indvars.iv1024, %152
  %154 = add i64 %indvars.iv1029, %152
  %155 = mul nsw i64 %polly.indvar400, -80
  %156 = mul nuw nsw i64 %polly.indvar400, 80
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit445 ], [ %154, %polly.loop_header397 ]
  %indvars.iv1026 = phi i64 [ %indvars.iv.next1027, %polly.loop_exit445 ], [ %153, %polly.loop_header397 ]
  ...
  %158 = add i64 %smax1028, %indvars.iv1031
  %159 = shl nsw i64 %polly.indvar407, 6
  %160 = add nsw i64 %159, %155
  %161 = add nsw i64 %160, -1
  %.inv883 = icmp sgt i64 %160, 79
  %162 = select i1 %.inv883, i64 79, i64 %161
...
polly.loop_header417.us:                          ; preds = %polly.loop_header410.us, %polly.loop_header417.us
  ...
  %exitcond1022.not = icmp eq i64 %polly.indvar421.us, %162
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_exit419.loopexit.us
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next414.us, 20
  br i1 %exitcond1023.not, label %polly.loop_header443.preheader, label %polly.loop_header410.us
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1021.not = icmp eq i64 %polly.indvar_next414, 20
  br i1 %exitcond1021.not, label %polly.loop_header443.preheader, label %polly.loop_header410
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar_next447, 20
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1033 = phi i64 [ %158, %polly.loop_header443 ], [ %indvars.iv.next1034, %polly.loop_exit460 ]
  ...
  %polly.loop_guard4611101 = icmp sgt i64 %182, -1
...
polly.loop_header570:                             ; preds = %polly.loop_exit578, %polly.start484
  ...
  %min.iters.check1195 = icmp ult i64 %192, 4
...
vector.body1194:                                  ; preds = %vector.body1194, %vector.ph1196
  ...
  %194 = shl nuw nsw i64 %index1199, 3
  %195 = getelementptr i8, i8* %scevgep582, i64 %194
  %196 = bitcast i8* %195 to <4 x double>*
  %wide.load1203 = load <4 x double>, <4 x double>* %196, align 8, !alias.scope !89, !noalias !91
  %197 = fmul fast <4 x double> %wide.load1203, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %199 = icmp eq i64 %index.next1200, %n.vec1198
  br i1 %199, label %middle.block1192, label %vector.body1194, !llvm.loop !95

middle.block1192:                                 ; preds = %vector.body1194
  %cmp.n1202 = icmp eq i64 %192, %n.vec1198
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %202 = lshr i64 %polly.indvar595, 2
  %203 = add nuw i64 %polly.indvar595, %202
  %204 = shl nuw nsw i64 %203, 6
  %205 = sub i64 %indvars.iv1045, %204
  %206 = add i64 %indvars.iv1050, %204
  %207 = mul nsw i64 %polly.indvar595, -80
  %208 = mul nuw nsw i64 %polly.indvar595, 80
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  %indvars.iv1052 = phi i64 [ %indvars.iv.next1053, %polly.loop_exit640 ], [ %206, %polly.loop_header592 ]
  %indvars.iv1047 = phi i64 [ %indvars.iv.next1048, %polly.loop_exit640 ], [ %205, %polly.loop_header592 ]
  %polly.indvar602 = phi i64 [ %polly.indvar_next603, %polly.loop_exit640 ], [ %203, %polly.loop_header592 ]
  %smax1049 = call i64 @llvm.smax.i64(i64 %indvars.iv1047, i64 0)
  %210 = add i64 %smax1049, %indvars.iv1052
  %211 = shl nsw i64 %polly.indvar602, 6
  %212 = add nsw i64 %211, %207
  %213 = add nsw i64 %212, -1
  %.inv884 = icmp sgt i64 %212, 79
  %214 = select i1 %.inv884, i64 79, i64 %213
...
polly.loop_header612.us:                          ; preds = %polly.loop_header605.us, %polly.loop_header612.us
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar616.us, %214
...
polly.loop_exit626.us:                            ; preds = %polly.loop_header624.us, %polly.loop_exit614.loopexit.us
  ...
  %exitcond1044.not = icmp eq i64 %polly.indvar_next609.us, 20
  br i1 %exitcond1044.not, label %polly.loop_header638.preheader, label %polly.loop_header605.us
...
polly.loop_exit626:                               ; preds = %polly.loop_header624
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar_next609, 20
  br i1 %exitcond1042.not, label %polly.loop_header638.preheader, label %polly.loop_header605
...
polly.loop_exit647:                               ; preds = %polly.loop_exit655
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next642, 20
...
polly.loop_header645:                             ; preds = %polly.loop_header638, %polly.loop_exit655
  %indvars.iv1054 = phi i64 [ %210, %polly.loop_header638 ], [ %indvars.iv.next1055, %polly.loop_exit655 ]
  ...
  %polly.loop_guard6561102 = icmp sgt i64 %234, -1
...
polly.loop_header809:                             ; preds = %polly.loop_exit817, %polly.loop_header803
  ...
  %smin1133 = call i64 @llvm.smin.i64(i64 %246, i64 -1168)
  %247 = add nsw i64 %smin1133, 1200
  %smin1085 = call i64 @llvm.smin.i64(i64 %indvars.iv1083, i64 -1168)
  %248 = shl nsw i64 %polly.indvar812, 5
  %249 = add nsw i64 %smin1085, 1199
...
vector.ph1134:                                    ; preds = %polly.loop_header815
  %broadcast.splatinsert1141 = insertelement <4 x i64> poison, i64 %248, i32 0
...
vector.body1132:                                  ; preds = %vector.body1132, %vector.ph1134
  ...
  %253 = add nuw nsw <4 x i64> %vec.ind1139, %broadcast.splat1142
  %254 = trunc <4 x i64> %253 to <4 x i32>
  %255 = mul <4 x i32> %broadcast.splat1144, %254
  ...
  %265 = icmp eq i64 %index.next1136, %247
  br i1 %265, label %polly.loop_exit823, label %vector.body1132, !llvm.loop !104

polly.loop_exit823:                               ; preds = %vector.body1132, %polly.loop_header821
  %polly.indvar_next819 = add nuw nsw i64 %polly.indvar818, 1
  %exitcond1090.not = icmp eq i64 %polly.indvar818, %245
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  %exitcond1086.not = icmp eq i64 %polly.indvar824, %249
...
polly.loop_header836:                             ; preds = %polly.loop_exit844, %polly.loop_header830
  ...
  %smin1148 = call i64 @llvm.smin.i64(i64 %275, i64 -968)
  %276 = add nsw i64 %smin1148, 1000
  %smin1075 = call i64 @llvm.smin.i64(i64 %indvars.iv1073, i64 -968)
  %277 = shl nsw i64 %polly.indvar839, 5
  %278 = add nsw i64 %smin1075, 999
...
vector.body1147:                                  ; preds = %vector.body1147, %vector.ph1150
  ...
  %282 = add nuw nsw <4 x i64> %vec.ind1157, %broadcast.splat1160
  %283 = trunc <4 x i64> %282 to <4 x i32>
  %284 = mul <4 x i32> %broadcast.splat1162, %283
  ...
  %294 = icmp eq i64 %index.next1154, %276
  br i1 %294, label %polly.loop_exit850, label %vector.body1147, !llvm.loop !107

polly.loop_exit850:                               ; preds = %vector.body1147, %polly.loop_header848
  %polly.indvar_next846 = add nuw nsw i64 %polly.indvar845, 1
  %exitcond1080.not = icmp eq i64 %polly.indvar845, %274
...
polly.loop_header848:                             ; preds = %polly.loop_header842, %polly.loop_header848
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar851, %278
...
polly.loop_header862:                             ; preds = %polly.loop_exit870, %polly.loop_header856
  ...
  %smin1166 = call i64 @llvm.smin.i64(i64 %304, i64 -968)
  %305 = add nsw i64 %smin1166, 1000
  %smin1065 = call i64 @llvm.smin.i64(i64 %indvars.iv1063, i64 -968)
  %306 = shl nsw i64 %polly.indvar865, 5
  %307 = add nsw i64 %smin1065, 999
...
vector.body1165:                                  ; preds = %vector.body1165, %vector.ph1168
  ...
  %311 = add nuw nsw <4 x i64> %vec.ind1175, %broadcast.splat1178
  %312 = trunc <4 x i64> %311 to <4 x i32>
  %313 = mul <4 x i32> %broadcast.splat1180, %312
  ...
  %323 = icmp eq i64 %index.next1172, %305
  br i1 %323, label %polly.loop_exit876, label %vector.body1165, !llvm.loop !110

polly.loop_exit876:                               ; preds = %vector.body1165, %polly.loop_header874
  %polly.indvar_next872 = add nuw nsw i64 %polly.indvar871, 1
  %exitcond1070.not = icmp eq i64 %polly.indvar871, %303
...
polly.loop_header874:                             ; preds = %polly.loop_header868, %polly.loop_header874
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar877, %307
