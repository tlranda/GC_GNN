; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2413.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2413.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv1029, i64 35)
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %117, i64 31)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  ...
  %umin1057 = call i64 @llvm.umin.i64(i64 %indvars.iv1055, i64 35)
  ...
  %160 = add nuw nsw i64 %umin1057, 2
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %161 = shl nuw nsw i64 %polly.indvar423, 5
  %162 = add i64 %153, %161
  %smax1276 = call i64 @llvm.smax.i64(i64 %162, i64 0)
  %163 = mul nsw i64 %polly.indvar423, -32
  %164 = add i64 %154, %163
  %165 = add i64 %smax1276, %164
  %166 = shl nsw i64 %polly.indvar423, 5
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %173, i64 31)
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  ...
  %umin1084 = call i64 @llvm.umin.i64(i64 %indvars.iv1082, i64 35)
  ...
  %216 = add nuw nsw i64 %umin1084, 2
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %indvars.iv.next1083 = add nuw nsw i64 %indvars.iv1082, 3
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %217 = shl nuw nsw i64 %polly.indvar627, 5
  %218 = add i64 %209, %217
  %smax1228 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar627, -32
  %220 = add i64 %210, %219
  %221 = add i64 %smax1228, %220
  %222 = shl nsw i64 %polly.indvar627, 5
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %229, i64 31)
