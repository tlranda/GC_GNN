; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9852.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9852.c"
...
vector.body991:                                   ; preds = %vector.body991, %vector.ph993
  ...
  br i1 %57, label %middle.block989, label %vector.body991, !llvm.loop !50
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  br i1 %68, label %middle.block1015, label %vector.body1017, !llvm.loop !52
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1033
  ...
  %wide.load1040 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !58, !noalias !60
  ...
  br i1 %95, label %middle.block1027, label %vector.body1029, !llvm.loop !63
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond801.not = icmp eq i64 %polly.indvar_next203, 38
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar214, %umin
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv791 = phi i64 [ %109, %polly.loop_header217.preheader ], [ %indvars.iv.next792, %polly.loop_exit225 ]
  ...
  %polly.loop_guard233888 = icmp sgt i64 %111, -1
...
polly.loop_exit232.loopexit.us:                   ; preds = %polly.loop_header230.us
  ...
  %exitcond796.not = icmp eq i64 %polly.indvar226.us, %104
...
vector.body1003:                                  ; preds = %vector.body1003, %vector.ph1007
  ...
  %125 = shl nuw nsw i64 %index1010, 3
  %126 = getelementptr i8, i8* %scevgep350, i64 %125
  %127 = bitcast i8* %126 to <4 x double>*
  %wide.load1014 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !68, !noalias !70
  %128 = fmul fast <4 x double> %wide.load1014, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %130 = icmp eq i64 %index.next1011, %n.vec1009
  br i1 %130, label %middle.block1001, label %vector.body1003, !llvm.loop !73

middle.block1001:                                 ; preds = %vector.body1003
  %cmp.n1013 = icmp eq i64 %123, %n.vec1009
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond827.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %132 = udiv i64 %indvars.iv821, 5
  %umin823 = call i64 @llvm.umin.i64(i64 %132, i64 14)
  %133 = mul nsw i64 %polly.indvar357, -32
  %134 = icmp slt i64 %133, -1168
  %135 = select i1 %134, i64 %133, i64 -1168
  %136 = add nsw i64 %135, 1199
  %137 = shl nsw i64 %polly.indvar357, 5
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond826.not = icmp eq i64 %polly.indvar_next358, 38
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %140 = mul nuw nsw i64 %polly.indvar370, 80
  %141 = add nsw i64 %140, %133
  %142 = icmp sgt i64 %141, 0
  %143 = select i1 %142, i64 %141, i64 0
  %polly.loop_guard377.not = icmp sgt i64 %143, %136
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %144 = add i64 %smax808, %indvars.iv811
  %145 = sub nsw i64 %137, %140
  br label %polly.loop_header374

polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  %polly.indvar_next371 = add nuw nsw i64 %polly.indvar370, 1
  %indvars.iv.next807 = add nsw i64 %indvars.iv806, 80
  %indvars.iv.next812 = add nsw i64 %indvars.iv811, -80
  %exitcond824.not = icmp eq i64 %polly.indvar370, %umin823
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv813 = phi i64 [ %144, %polly.loop_header374.preheader ], [ %indvars.iv.next814, %polly.loop_exit383 ]
  %polly.indvar378 = phi i64 [ %143, %polly.loop_header374.preheader ], [ %polly.indvar_next379, %polly.loop_exit383 ]
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 79)
  %146 = add nsw i64 %polly.indvar378, %145
  %polly.loop_guard391889 = icmp sgt i64 %146, -1
  %147 = add nuw nsw i64 %polly.indvar378, %137
...
polly.loop_header381.us:                          ; preds = %polly.loop_header374, %polly.loop_exit390.loopexit.us
  ...
  %150 = add nuw nsw i64 %polly.indvar384.us, %138
  %151 = shl i64 %150, 3
  %152 = add i64 %151, %148
...
polly.loop_header388.us:                          ; preds = %polly.loop_header381.us, %polly.loop_header388.us
  ...
  %153 = add nuw nsw i64 %polly.indvar392.us, %140
  %154 = mul nuw nsw i64 %153, 8000
  %155 = add nuw nsw i64 %154, %151
  %scevgep395.us = getelementptr i8, i8* %call1, i64 %155
  ...
  %scevgep401.us = getelementptr i8, i8* %call2, i64 %155
  ...
  %156 = shl i64 %153, 3
  %157 = add i64 %156, %149
  %scevgep407.us = getelementptr i8, i8* %call, i64 %157
...
polly.loop_exit390.loopexit.us:                   ; preds = %polly.loop_header388.us
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar384.us, %139
...
polly.loop_exit383:                               ; preds = %polly.loop_exit390.loopexit.us, %polly.loop_header374
  ...
  %polly.loop_cond380.not.not = icmp ult i64 %polly.indvar378, %136
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph981
  ...
  %160 = shl nuw nsw i64 %index984, 3
  %161 = getelementptr i8, i8* %scevgep508, i64 %160
  %162 = bitcast i8* %161 to <4 x double>*
  %wide.load988 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !77, !noalias !79
  %163 = fmul fast <4 x double> %wide.load988, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %165 = icmp eq i64 %index.next985, %n.vec983
  br i1 %165, label %middle.block977, label %vector.body979, !llvm.loop !82

middle.block977:                                  ; preds = %vector.body979
  %cmp.n987 = icmp eq i64 %158, %n.vec983
...
polly.loop_header502:                             ; preds = %polly.loop_header502.preheader, %polly.loop_header502
  ...
  br i1 %exitcond852.not, label %polly.loop_exit504, label %polly.loop_header502, !llvm.loop !83

polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv846 = phi i64 [ %indvars.iv.next847, %polly.loop_exit520 ], [ 1, %polly.loop_exit504 ]
  ...
  %167 = udiv i64 %indvars.iv846, 5
  %umin848 = call i64 @llvm.umin.i64(i64 %167, i64 14)
  %168 = mul nsw i64 %polly.indvar515, -32
  %169 = icmp slt i64 %168, -1168
  %170 = select i1 %169, i64 %168, i64 -1168
  %171 = add nsw i64 %170, 1199
  %172 = shl nsw i64 %polly.indvar515, 5
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next835 = add nuw nsw i64 %indvars.iv834, 32
  %indvars.iv.next847 = add nuw nsw i64 %indvars.iv846, 2
  %exitcond851.not = icmp eq i64 %polly.indvar_next516, 38
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %173 = shl nsw i64 %polly.indvar521, 5
  %174 = add nsw i64 %smin844, 999
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next522, 32
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %175 = mul nuw nsw i64 %polly.indvar528, 80
  %176 = add nsw i64 %175, %168
  %177 = icmp sgt i64 %176, 0
  %178 = select i1 %177, i64 %176, i64 0
  %polly.loop_guard535.not = icmp sgt i64 %178, %171
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %179 = add i64 %smax833, %indvars.iv836
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar528, %umin848
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv838 = phi i64 [ %179, %polly.loop_header532.preheader ], [ %indvars.iv.next839, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %178, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin840 = call i64 @llvm.smin.i64(i64 %indvars.iv838, i64 79)
  %181 = add nsw i64 %polly.indvar536, %180
  %polly.loop_guard549890 = icmp sgt i64 %181, -1
  %182 = add nuw nsw i64 %polly.indvar536, %172
...
polly.loop_header539.us:                          ; preds = %polly.loop_header532, %polly.loop_exit548.loopexit.us
  ...
  %185 = add nuw nsw i64 %polly.indvar542.us, %173
  %186 = shl i64 %185, 3
  %187 = add i64 %186, %183
  %scevgep556.us = getelementptr i8, i8* %call2, i64 %187
  ...
  %scevgep562.us = getelementptr i8, i8* %call1, i64 %187
...
polly.loop_header546.us:                          ; preds = %polly.loop_header539.us, %polly.loop_header546.us
  ...
  %188 = add nuw nsw i64 %polly.indvar550.us, %175
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar542.us, %174
...
polly.loop_exit541:                               ; preds = %polly.loop_exit548.loopexit.us, %polly.loop_header532
  ...
  %polly.loop_cond538.not.not = icmp ult i64 %polly.indvar536, %171
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin918 = call i64 @llvm.smin.i64(i64 %195, i64 -1168)
  %196 = add nsw i64 %smin918, 1200
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv874, i64 -1168)
  %197 = shl nsw i64 %polly.indvar703, 5
  %198 = add nsw i64 %smin876, 1199
...
vector.ph919:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert926 = insertelement <4 x i64> poison, i64 %197, i32 0
  %broadcast.splat927 = shufflevector <4 x i64> %broadcast.splatinsert926, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert928 = insertelement <4 x i32> poison, i32 %200, i32 0
...
vector.body917:                                   ; preds = %vector.body917, %vector.ph919
  ...
  %202 = add nuw nsw <4 x i64> %vec.ind924, %broadcast.splat927
  %203 = trunc <4 x i64> %202 to <4 x i32>
  %204 = mul <4 x i32> %broadcast.splat929, %203
  ...
  %214 = icmp eq i64 %index.next921, %196
  br i1 %214, label %polly.loop_exit714, label %vector.body917, !llvm.loop !91

polly.loop_exit714:                               ; preds = %vector.body917, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond881.not = icmp eq i64 %polly.indvar709, %194
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar715, %198
  br i1 %exitcond877.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !92
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin933 = call i64 @llvm.smin.i64(i64 %224, i64 -968)
  %225 = add nsw i64 %smin933, 1000
  %smin866 = call i64 @llvm.smin.i64(i64 %indvars.iv864, i64 -968)
  %226 = shl nsw i64 %polly.indvar730, 5
  %227 = add nsw i64 %smin866, 999
...
vector.body932:                                   ; preds = %vector.body932, %vector.ph935
  ...
  %231 = add nuw nsw <4 x i64> %vec.ind942, %broadcast.splat945
  %232 = trunc <4 x i64> %231 to <4 x i32>
  %233 = mul <4 x i32> %broadcast.splat947, %232
  ...
  %243 = icmp eq i64 %index.next939, %225
  br i1 %243, label %polly.loop_exit741, label %vector.body932, !llvm.loop !94

polly.loop_exit741:                               ; preds = %vector.body932, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond871.not = icmp eq i64 %polly.indvar736, %223
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar742, %227
  br i1 %exitcond867.not, label %polly.loop_exit741, label %polly.loop_header739, !llvm.loop !95
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin951 = call i64 @llvm.smin.i64(i64 %253, i64 -968)
  %254 = add nsw i64 %smin951, 1000
  %smin856 = call i64 @llvm.smin.i64(i64 %indvars.iv854, i64 -968)
  %255 = shl nsw i64 %polly.indvar756, 5
  %256 = add nsw i64 %smin856, 999
...
vector.body950:                                   ; preds = %vector.body950, %vector.ph953
  ...
  %260 = add nuw nsw <4 x i64> %vec.ind960, %broadcast.splat963
  %261 = trunc <4 x i64> %260 to <4 x i32>
  %262 = mul <4 x i32> %broadcast.splat965, %261
  ...
  %272 = icmp eq i64 %index.next957, %254
  br i1 %272, label %polly.loop_exit767, label %vector.body950, !llvm.loop !97

polly.loop_exit767:                               ; preds = %vector.body950, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond861.not = icmp eq i64 %polly.indvar762, %252
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar768, %256
  br i1 %exitcond857.not, label %polly.loop_exit767, label %polly.loop_header765, !llvm.loop !98
}
