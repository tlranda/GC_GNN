; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6539.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6539.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %105 = shl nuw nsw i64 %indvars.iv856, 1
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %147 = shl nuw nsw i64 %indvars.iv879, 1
  %148 = and i64 %147, 9223372036854775680
  %149 = sub nsw i64 %indvars.iv877, %148
  %150 = add i64 %indvars.iv884, %148
  %151 = mul nuw nsw i64 %polly.indvar383, 50
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit394.3
  ...
  %154 = shl nsw i64 %polly.indvar406, 7
  %155 = sub nsw i64 %151, %154
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %158 = mul nsw i64 %polly.indvar406, -128
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit572.3
  ...
  %196 = shl nsw i64 %polly.indvar584, 7
  %197 = sub nsw i64 %193, %196
  %198 = icmp sgt i64 %197, 0
  %199 = select i1 %198, i64 %197, i64 0
  %200 = mul nsw i64 %polly.indvar584, -128
  %201 = icmp slt i64 %200, -1072
  %202 = select i1 %201, i64 %200, i64 -1072
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  %304 = mul nsw i64 %polly.indvar208, -50
  %305 = mul nuw nsw i64 %polly.indvar208, 25
  %pexp.p_div_q = lshr i64 %305, 6
...
polly.loop_header239.1:                           ; preds = %polly.loop_exit248, %polly.loop_exit248.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv864.1, i64 49)
...
polly.loop_header239.2:                           ; preds = %polly.loop_exit248.1, %polly.loop_exit248.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv864.2, i64 49)
...
polly.loop_header239.3:                           ; preds = %polly.loop_exit248.2, %polly.loop_exit248.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv864.3, i64 49)
...
polly.loop_exit394.3:                             ; preds = %polly.loop_header392.3
  %339 = mul nsw i64 %polly.indvar383, -50
  %340 = mul nuw nsw i64 %polly.indvar383, 25
  %pexp.p_div_q402 = lshr i64 %340, 6
...
polly.loop_header416.1:                           ; preds = %polly.loop_exit426, %polly.loop_exit426.1
  ...
  %smin890.1 = call i64 @llvm.smin.i64(i64 %indvars.iv888.1, i64 49)
...
polly.loop_header416.2:                           ; preds = %polly.loop_exit426.1, %polly.loop_exit426.2
  ...
  %smin890.2 = call i64 @llvm.smin.i64(i64 %indvars.iv888.2, i64 49)
...
polly.loop_header416.3:                           ; preds = %polly.loop_exit426.2, %polly.loop_exit426.3
  ...
  %smin890.3 = call i64 @llvm.smin.i64(i64 %indvars.iv888.3, i64 49)
...
polly.loop_exit572.3:                             ; preds = %polly.loop_header570.3
  %374 = mul nsw i64 %polly.indvar561, -50
  %375 = mul nuw nsw i64 %polly.indvar561, 25
  %pexp.p_div_q580 = lshr i64 %375, 6
...
polly.loop_header594.1:                           ; preds = %polly.loop_exit604, %polly.loop_exit604.1
  ...
  %smin915.1 = call i64 @llvm.smin.i64(i64 %indvars.iv913.1, i64 49)
...
polly.loop_header594.2:                           ; preds = %polly.loop_exit604.1, %polly.loop_exit604.2
  ...
  %smin915.2 = call i64 @llvm.smin.i64(i64 %indvars.iv913.2, i64 49)
...
polly.loop_header594.3:                           ; preds = %polly.loop_exit604.2, %polly.loop_exit604.3
  ...
  %smin915.3 = call i64 @llvm.smin.i64(i64 %indvars.iv913.3, i64 49)
