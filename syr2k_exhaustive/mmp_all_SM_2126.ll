; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2126.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2126.c"
...
vector.body1361:                                  ; preds = %vector.body1361, %vector.ph1367
  ...
  %wide.load1380 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !64, !noalias !66
  ...
  br i1 %147, label %middle.block1359, label %vector.body1361, !llvm.loop !76
...
vector.body1299:                                  ; preds = %vector.body1299, %vector.ph1303
  ...
  %wide.load1310 = load <4 x double>, <4 x double>* %155, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %158, label %middle.block1297, label %vector.body1299, !llvm.loop !85
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442
  ...
  %exitcond1090.not = icmp eq i64 %polly.indvar_next430, 16
...
vector.body1313:                                  ; preds = %vector.body1313, %vector.ph1319
  ...
  %wide.load1332 = load <4 x double>, <4 x double>* %205, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %210, label %middle.block1311, label %vector.body1313, !llvm.loop !89
...
vector.body1253:                                  ; preds = %vector.body1253, %vector.ph1255
  ...
  %wide.load1262 = load <4 x double>, <4 x double>* %218, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %221, label %middle.block1251, label %vector.body1253, !llvm.loop !98
...
polly.loop_header637:                             ; preds = %polly.loop_exit646, %polly.loop_header631
  ...
  %smin1117 = call i64 @llvm.smin.i64(i64 %indvars.iv1096, i64 -936)
...
polly.loop_exit646:                               ; preds = %polly.loop_exit653
  ...
  %exitcond1123.not = icmp eq i64 %polly.indvar_next641, 16
...
vector.body1265:                                  ; preds = %vector.body1265, %vector.ph1271
  ...
  %wide.load1284 = load <4 x double>, <4 x double>* %268, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %273, label %middle.block1263, label %vector.body1265, !llvm.loop !102
...
vector.body1192:                                  ; preds = %vector.body1192, %vector.ph1193
  ...
  br i1 %298, label %polly.loop_exit866, label %vector.body1192, !llvm.loop !109
...
vector.body1206:                                  ; preds = %vector.body1206, %vector.ph1209
  ...
  br i1 %327, label %polly.loop_exit893, label %vector.body1206, !llvm.loop !112
...
vector.body1224:                                  ; preds = %vector.body1224, %vector.ph1227
  ...
  br i1 %356, label %polly.loop_exit919, label %vector.body1224, !llvm.loop !115
