; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9984.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9984.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next795 = add nuw nsw i64 %indvars.iv794, 25
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv791 = phi i64 [ %105, %polly.loop_header217.preheader ], [ %indvars.iv.next792, %polly.loop_exit225 ]
  ...
  %polly.loop_guard233877 = icmp sgt i64 %107, -1
  %108 = add nuw nsw i64 %polly.indvar220, %99
  %109 = mul i64 %108, 8000
  %110 = mul i64 %108, 9600
  br i1 %polly.loop_guard233877, label %polly.loop_header223.us, label %polly.loop_exit225
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %121 = shl nuw nsw i64 %index999, 3
  %122 = getelementptr i8, i8* %scevgep350, i64 %121
  %123 = bitcast i8* %122 to <4 x double>*
  %wide.load1003 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !68, !noalias !70
  %124 = fmul fast <4 x double> %wide.load1003, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %125 = bitcast i8* %122 to <4 x double>*
  store <4 x double> %124, <4 x double>* %125, align 8, !alias.scope !68, !noalias !70
  %index.next1000 = add i64 %index999, 4
  %126 = icmp eq i64 %index.next1000, %n.vec998
  br i1 %126, label %middle.block990, label %vector.body992, !llvm.loop !73

middle.block990:                                  ; preds = %vector.body992
  %cmp.n1002 = icmp eq i64 %119, %n.vec998
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv815 = phi i64 [ %indvars.iv.next816, %polly.loop_exit362 ], [ 24, %polly.loop_exit346 ]
  ...
  %128 = lshr i64 %indvars.iv815, 6
  %129 = mul nsw i64 %polly.indvar357, -50
  %130 = mul nuw nsw i64 %polly.indvar357, 50
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %indvars.iv.next816 = add nuw nsw i64 %indvars.iv815, 25
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %131 = mul nuw nsw i64 %polly.indvar363, 50
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit376
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %exitcond818.not = icmp eq i64 %polly.indvar_next364, 20
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %132 = shl nsw i64 %polly.indvar370, 7
  %133 = add nsw i64 %132, %129
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard377 = icmp slt i64 %135, 50
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %136 = add i64 %smax805, %indvars.iv808
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar370, %128
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv810 = phi i64 [ %136, %polly.loop_header374.preheader ], [ %indvars.iv.next811, %polly.loop_exit383 ]
  %polly.indvar378 = phi i64 [ %135, %polly.loop_header374.preheader ], [ %polly.indvar_next379, %polly.loop_exit383 ]
  %smin812 = call i64 @llvm.smin.i64(i64 %indvars.iv810, i64 127)
  %138 = add nsw i64 %polly.indvar378, %137
  %polly.loop_guard391878 = icmp sgt i64 %138, -1
  %139 = add nuw nsw i64 %polly.indvar378, %130
  %140 = mul i64 %139, 8000
  %141 = mul i64 %139, 9600
  br i1 %polly.loop_guard391878, label %polly.loop_header381.us, label %polly.loop_exit383
...
polly.loop_header381.us:                          ; preds = %polly.loop_header374, %polly.loop_exit390.loopexit.us
  ...
  %142 = add nuw nsw i64 %polly.indvar384.us, %131
  %143 = shl i64 %142, 3
  %144 = add i64 %143, %140
  %scevgep398.us = getelementptr i8, i8* %call2, i64 %144
  ...
  %scevgep404.us = getelementptr i8, i8* %call1, i64 %144
...
polly.loop_header388.us:                          ; preds = %polly.loop_header381.us, %polly.loop_header388.us
  ...
  %145 = add nuw nsw i64 %polly.indvar392.us, %132
  %146 = mul nuw nsw i64 %145, 8000
  %147 = add nuw nsw i64 %146, %143
  %scevgep395.us = getelementptr i8, i8* %call1, i64 %147
  ...
  %scevgep401.us = getelementptr i8, i8* %call2, i64 %147
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %152 = shl nuw nsw i64 %index973, 3
  %153 = getelementptr i8, i8* %scevgep508, i64 %152
  %154 = bitcast i8* %153 to <4 x double>*
  %wide.load977 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !77, !noalias !79
  %155 = fmul fast <4 x double> %wide.load977, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %156 = bitcast i8* %153 to <4 x double>*
  store <4 x double> %155, <4 x double>* %156, align 8, !alias.scope !77, !noalias !79
  %index.next974 = add i64 %index973, 4
  %157 = icmp eq i64 %index.next974, %n.vec972
  br i1 %157, label %middle.block966, label %vector.body968, !llvm.loop !82

middle.block966:                                  ; preds = %vector.body968
  %cmp.n976 = icmp eq i64 %150, %n.vec972
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv836 = phi i64 [ %indvars.iv.next837, %polly.loop_exit520 ], [ 24, %polly.loop_exit504 ]
  ...
  %159 = lshr i64 %indvars.iv836, 6
  %160 = mul nsw i64 %polly.indvar515, -50
  %161 = mul nuw nsw i64 %polly.indvar515, 50
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next837 = add nuw nsw i64 %indvars.iv836, 25
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %162 = mul nuw nsw i64 %polly.indvar521, 50
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond839.not = icmp eq i64 %polly.indvar_next522, 20
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %163 = shl nsw i64 %polly.indvar528, 7
  %164 = add nsw i64 %163, %160
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard535 = icmp slt i64 %166, 50
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %167 = add i64 %smax826, %indvars.iv829
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar528, %159
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv831 = phi i64 [ %167, %polly.loop_header532.preheader ], [ %indvars.iv.next832, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %166, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin833 = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 127)
  %169 = add nsw i64 %polly.indvar536, %168
  %polly.loop_guard549879 = icmp sgt i64 %169, -1
  %170 = add nuw nsw i64 %polly.indvar536, %161
  %171 = mul i64 %170, 8000
  %172 = mul i64 %170, 9600
  br i1 %polly.loop_guard549879, label %polly.loop_header539.us, label %polly.loop_exit541
...
polly.loop_header539.us:                          ; preds = %polly.loop_header532, %polly.loop_exit548.loopexit.us
  ...
  %173 = add nuw nsw i64 %polly.indvar542.us, %162
  %174 = shl i64 %173, 3
  %175 = add i64 %174, %171
  %scevgep556.us = getelementptr i8, i8* %call2, i64 %175
  ...
  %scevgep562.us = getelementptr i8, i8* %call1, i64 %175
...
polly.loop_header546.us:                          ; preds = %polly.loop_header539.us, %polly.loop_header546.us
  ...
  %176 = add nuw nsw i64 %polly.indvar550.us, %163
  %177 = mul nuw nsw i64 %176, 8000
  %178 = add nuw nsw i64 %177, %174
  %scevgep553.us = getelementptr i8, i8* %call1, i64 %178
  ...
  %scevgep559.us = getelementptr i8, i8* %call2, i64 %178
  ...
  %179 = shl i64 %176, 3
  %180 = add i64 %179, %172
  %scevgep565.us = getelementptr i8, i8* %call, i64 %180
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next543.us, 50
  br i1 %exitcond835.not, label %polly.loop_exit541, label %polly.loop_header539.us
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin907 = call i64 @llvm.smin.i64(i64 %183, i64 -1168)
  %184 = add nsw i64 %smin907, 1200
  %smin865 = call i64 @llvm.smin.i64(i64 %indvars.iv863, i64 -1168)
  %185 = shl nsw i64 %polly.indvar703, 5
  %186 = add nsw i64 %smin865, 1199
...
vector.ph908:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert915 = insertelement <4 x i64> poison, i64 %185, i32 0
  %broadcast.splat916 = shufflevector <4 x i64> %broadcast.splatinsert915, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert917 = insertelement <4 x i32> poison, i32 %188, i32 0
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  %190 = add nuw nsw <4 x i64> %vec.ind913, %broadcast.splat916
  %191 = trunc <4 x i64> %190 to <4 x i32>
  %192 = mul <4 x i32> %broadcast.splat918, %191
  ...
  store <4 x double> %196, <4 x double>* %201, align 8, !alias.scope !86, !noalias !88
  %index.next910 = add i64 %index909, 4
  %vec.ind.next914 = add <4 x i64> %vec.ind913, <i64 4, i64 4, i64 4, i64 4>
  %202 = icmp eq i64 %index.next910, %184
  br i1 %202, label %polly.loop_exit714, label %vector.body906, !llvm.loop !91

polly.loop_exit714:                               ; preds = %vector.body906, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond870.not = icmp eq i64 %polly.indvar709, %182
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar715, %186
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin922 = call i64 @llvm.smin.i64(i64 %212, i64 -968)
  %213 = add nsw i64 %smin922, 1000
  %smin855 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -968)
  %214 = shl nsw i64 %polly.indvar730, 5
  %215 = add nsw i64 %smin855, 999
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  %219 = add nuw nsw <4 x i64> %vec.ind931, %broadcast.splat934
  %220 = trunc <4 x i64> %219 to <4 x i32>
  %221 = mul <4 x i32> %broadcast.splat936, %220
  ...
  store <4 x double> %225, <4 x double>* %230, align 8, !alias.scope !90, !noalias !93
  %index.next928 = add i64 %index927, 4
  %vec.ind.next932 = add <4 x i64> %vec.ind931, <i64 4, i64 4, i64 4, i64 4>
  %231 = icmp eq i64 %index.next928, %213
  br i1 %231, label %polly.loop_exit741, label %vector.body921, !llvm.loop !94

polly.loop_exit741:                               ; preds = %vector.body921, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond860.not = icmp eq i64 %polly.indvar736, %211
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar742, %215
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin940 = call i64 @llvm.smin.i64(i64 %241, i64 -968)
  %242 = add nsw i64 %smin940, 1000
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 -968)
  %243 = shl nsw i64 %polly.indvar756, 5
  %244 = add nsw i64 %smin845, 999
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  %248 = add nuw nsw <4 x i64> %vec.ind949, %broadcast.splat952
  %249 = trunc <4 x i64> %248 to <4 x i32>
  %250 = mul <4 x i32> %broadcast.splat954, %249
  ...
  store <4 x double> %254, <4 x double>* %259, align 8, !alias.scope !89, !noalias !96
  %index.next946 = add i64 %index945, 4
  %vec.ind.next950 = add <4 x i64> %vec.ind949, <i64 4, i64 4, i64 4, i64 4>
  %260 = icmp eq i64 %index.next946, %242
  br i1 %260, label %polly.loop_exit767, label %vector.body939, !llvm.loop !97

polly.loop_exit767:                               ; preds = %vector.body939, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond850.not = icmp eq i64 %polly.indvar762, %240
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar768, %244
