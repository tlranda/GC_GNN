; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3461.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3461.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1020 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -936)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next203, 16
...
vector.body1232:                                  ; preds = %vector.body1232, %vector.ph1236
  ...
  %wide.load1243 = load <4 x double>, <4 x double>* %145, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %148, label %middle.block1230, label %vector.body1232, !llvm.loop !84
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_header381
  ...
  br i1 %exitcond1050.not, label %polly.loop_exit383, label %polly.loop_header381, !llvm.loop !85
...
polly.loop_header391:                             ; preds = %polly.loop_header391.preheader, %polly.loop_exit399
  ...
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv1026, i64 -936)
...
polly.loop_exit399:                               ; preds = %polly.loop_exit406
  ...
  %exitcond1049.not = icmp eq i64 %polly.indvar_next395, 16
...
vector.body1208:                                  ; preds = %vector.body1208, %vector.ph1210
  ...
  %wide.load1217 = load <4 x double>, <4 x double>* %198, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %201, label %middle.block1206, label %vector.body1208, !llvm.loop !94
...
polly.loop_header576:                             ; preds = %polly.loop_header576.preheader, %polly.loop_header576
  ...
  br i1 %exitcond1076.not, label %polly.loop_exit578, label %polly.loop_header576, !llvm.loop !95
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %smin1072 = call i64 @llvm.smin.i64(i64 %indvars.iv1052, i64 -936)
...
polly.loop_exit594:                               ; preds = %polly.loop_exit601
  ...
  %indvars.iv.next1053 = add nsw i64 %indvars.iv1052, -64
  %exitcond1075.not = icmp eq i64 %polly.indvar_next590, 16
...
vector.body1147:                                  ; preds = %vector.body1147, %vector.ph1148
  ...
  br i1 %268, label %polly.loop_exit823, label %vector.body1147, !llvm.loop !103
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  br i1 %exitcond1101.not, label %polly.loop_exit823, label %polly.loop_header821, !llvm.loop !104
...
vector.body1161:                                  ; preds = %vector.body1161, %vector.ph1164
  ...
  br i1 %297, label %polly.loop_exit850, label %vector.body1161, !llvm.loop !106
...
polly.loop_header848:                             ; preds = %polly.loop_header842, %polly.loop_header848
  ...
  br i1 %exitcond1091.not, label %polly.loop_exit850, label %polly.loop_header848, !llvm.loop !107
...
vector.body1179:                                  ; preds = %vector.body1179, %vector.ph1182
  ...
  br i1 %326, label %polly.loop_exit876, label %vector.body1179, !llvm.loop !109
...
polly.loop_header874:                             ; preds = %polly.loop_header868, %polly.loop_header874
  ...
  br i1 %exitcond1081.not, label %polly.loop_exit876, label %polly.loop_header874, !llvm.loop !110
}
