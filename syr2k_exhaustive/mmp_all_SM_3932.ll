; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3932.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3932.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond1022.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !74
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %98 = shl nuw nsw i64 %indvars.iv1007, 1
  %99 = and i64 %98, 9223372036854775680
  %100 = sub nsw i64 %indvars.iv, %99
  %101 = add i64 %indvars.iv1011, %99
  %102 = mul nuw nsw i64 %polly.indvar208, 25
  %pexp.p_div_q = lshr i64 %102, 6
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_header381
  ...
  br i1 %exitcond1046.not, label %polly.loop_exit383, label %polly.loop_header381, !llvm.loop !85
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %150 = shl nuw nsw i64 %indvars.iv1029, 1
  %151 = and i64 %150, 9223372036854775680
  %152 = sub nsw i64 %indvars.iv1027, %151
  %153 = add i64 %indvars.iv1034, %151
  %154 = mul nuw nsw i64 %polly.indvar400, 25
  %pexp.p_div_q403 = lshr i64 %154, 6
  %155 = mul nsw i64 %polly.indvar400, -50
  %156 = mul nuw nsw i64 %polly.indvar400, 50
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header404.split
  ...
  %175 = mul nsw i64 %polly.indvar407, -128
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %202 = shl nuw nsw i64 %indvars.iv1053, 1
  %203 = and i64 %202, 9223372036854775680
  %204 = sub nsw i64 %indvars.iv1051, %203
  %205 = add i64 %indvars.iv1058, %203
  %206 = mul nuw nsw i64 %polly.indvar595, 25
  %pexp.p_div_q598 = lshr i64 %206, 6
  %207 = mul nsw i64 %polly.indvar595, -50
  %208 = mul nuw nsw i64 %polly.indvar595, 50
