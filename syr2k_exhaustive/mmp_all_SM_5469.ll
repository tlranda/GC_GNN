; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5469.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5469.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %smin845.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.3, i64 15)
  %120 = or i64 %104, 4
  ...
  %smin845.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.4, i64 15)
  %124 = or i64 %104, 5
  ...
  %smin845.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.5, i64 15)
  %128 = or i64 %104, 6
  ...
  %smin845.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.6, i64 15)
  %132 = or i64 %104, 7
...
polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %157 = mul nsw i64 %polly.indvar381, -16
  %158 = shl nuw nsw i64 %polly.indvar381, 1
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %smin866.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.3, i64 15)
  %177 = or i64 %161, 4
  ...
  %smin866.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.4, i64 15)
  %181 = or i64 %161, 5
  ...
  %smin866.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.5, i64 15)
  %185 = or i64 %161, 6
  ...
  %smin866.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.6, i64 15)
  %189 = or i64 %161, 7
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %213 = shl nsw i64 %polly.indvar554, 4
  br label %polly.loop_header557

polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %214 = mul nsw i64 %polly.indvar554, -16
  %215 = shl nuw nsw i64 %polly.indvar554, 1
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit559
  ...
  %smin887.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.3, i64 15)
  %234 = or i64 %218, 4
  ...
  %smin887.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.4, i64 15)
  %238 = or i64 %218, 5
  ...
  %smin887.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.5, i64 15)
  %242 = or i64 %218, 6
  ...
  %smin887.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.6, i64 15)
  %246 = or i64 %218, 7
