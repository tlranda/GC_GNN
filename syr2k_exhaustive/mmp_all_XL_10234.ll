; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10234.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10234.c"
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %128, label %middle.block999, label %vector.body1001, !llvm.loop !73
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %wide.load986 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %161, label %middle.block975, label %vector.body977, !llvm.loop !82
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  br i1 %208, label %polly.loop_exit714, label %vector.body915, !llvm.loop !91
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %237, label %polly.loop_exit741, label %vector.body930, !llvm.loop !94
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  br i1 %266, label %polly.loop_exit767, label %vector.body948, !llvm.loop !97
