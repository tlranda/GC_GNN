; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6295.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6295.c"
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %147 = udiv i64 %indvars.iv878, 24
  %148 = mul nuw nsw i64 %147, 96
  %149 = sub nsw i64 %indvars.iv876, %148
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %189 = udiv i64 %indvars.iv902, 24
  %190 = mul nuw nsw i64 %189, 96
  %191 = sub nsw i64 %indvars.iv900, %190
  %192 = add i64 %indvars.iv907, %190
...
polly.loop_header239.1:                           ; preds = %polly.loop_exit248, %polly.loop_exit248.1
  ...
  %307 = add i64 %306, %304
  %polly.loop_guard249.1952 = icmp sgt i64 %307, -1
...
polly.loop_header239.2:                           ; preds = %polly.loop_exit248.1, %polly.loop_exit248.2
  ...
  %317 = add i64 %316, %304
  %polly.loop_guard249.2953 = icmp sgt i64 %317, -1
...
polly.loop_header239.3:                           ; preds = %polly.loop_exit248.2, %polly.loop_exit248.3
  ...
  %327 = add i64 %326, %304
  %polly.loop_guard249.3954 = icmp sgt i64 %327, -1
...
polly.loop_exit394.3:                             ; preds = %polly.loop_header392.3
  ...
  %pexp.p_div_q402 = udiv i64 %340, 24
...
polly.loop_header416.1:                           ; preds = %polly.loop_exit426, %polly.loop_exit426.1
  ...
  %smin889.1 = call i64 @llvm.smin.i64(i64 %indvars.iv887.1, i64 19)
  %341 = add nuw i64 %polly.indvar420.1, %154
  %342 = add i64 %341, %339
  %polly.loop_guard427.1956 = icmp sgt i64 %342, -1
...
polly.loop_header416.2:                           ; preds = %polly.loop_exit426.1, %polly.loop_exit426.2
  ...
  %smin889.2 = call i64 @llvm.smin.i64(i64 %indvars.iv887.2, i64 19)
  %351 = add nuw i64 %polly.indvar420.2, %154
  %352 = add i64 %351, %339
  %polly.loop_guard427.2957 = icmp sgt i64 %352, -1
...
polly.loop_header416.3:                           ; preds = %polly.loop_exit426.2, %polly.loop_exit426.3
  ...
  %smin889.3 = call i64 @llvm.smin.i64(i64 %indvars.iv887.3, i64 19)
  %361 = add nuw i64 %polly.indvar420.3, %154
  %362 = add i64 %361, %339
  %polly.loop_guard427.3958 = icmp sgt i64 %362, -1
...
polly.loop_exit572.3:                             ; preds = %polly.loop_header570.3
  ...
  %pexp.p_div_q580 = udiv i64 %375, 24
...
polly.loop_header594.1:                           ; preds = %polly.loop_exit604, %polly.loop_exit604.1
  ...
  %smin913.1 = call i64 @llvm.smin.i64(i64 %indvars.iv911.1, i64 19)
  %376 = add nuw i64 %polly.indvar598.1, %196
  %377 = add i64 %376, %374
  %polly.loop_guard605.1960 = icmp sgt i64 %377, -1
...
polly.loop_header594.2:                           ; preds = %polly.loop_exit604.1, %polly.loop_exit604.2
  ...
  %smin913.2 = call i64 @llvm.smin.i64(i64 %indvars.iv911.2, i64 19)
  %386 = add nuw i64 %polly.indvar598.2, %196
  %387 = add i64 %386, %374
  %polly.loop_guard605.2961 = icmp sgt i64 %387, -1
...
polly.loop_header594.3:                           ; preds = %polly.loop_exit604.2, %polly.loop_exit604.3
  ...
  %smin913.3 = call i64 @llvm.smin.i64(i64 %indvars.iv911.3, i64 19)
  %396 = add nuw i64 %polly.indvar598.3, %196
  %397 = add i64 %396, %374
  %polly.loop_guard605.3962 = icmp sgt i64 %397, -1
