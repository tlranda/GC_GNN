; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9030.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9030.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin800 = call i64 @llvm.smin.i64(i64 %indvars.iv798, i64 -936)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next799 = add nsw i64 %indvars.iv798, -64
  %exitcond803.not = icmp eq i64 %polly.indvar_next203, 16
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %99 = udiv i64 %indvars.iv788, 3
  %100 = mul nuw nsw i64 %99, 96
  %101 = add i64 %indvars.iv, %100
  %102 = sub nsw i64 %indvars.iv792, %100
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond802.not = icmp eq i64 %polly.indvar_next209, 5
...
polly.loop_exit225:                               ; preds = %polly.loop_exit232
  ...
  %exitcond801.not = icmp eq i64 %polly.indvar220, %98
...
polly.loop_header223:                             ; preds = %polly.loop_header217, %polly.loop_exit232
  %indvars.iv796 = phi i64 [ %108, %polly.loop_header217 ], [ %indvars.iv.next797, %polly.loop_exit232 ]
  ...
  %119 = add i64 %polly.indvar226, %109
  %120 = add i64 %119, %107
  %polly.loop_guard233886 = icmp sgt i64 %120, -1
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %133, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %136, label %middle.block999, label %vector.body1001, !llvm.loop !77
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %indvars.iv808 = phi i64 [ %indvars.iv.next809, %polly.loop_exit369 ], [ 2, %polly.loop_header354 ]
  ...
  %140 = udiv i64 %indvars.iv808, 3
  %141 = mul nuw nsw i64 %140, 96
  %142 = add i64 %indvars.iv806, %141
  %143 = sub nsw i64 %indvars.iv813, %141
  %144 = mul nuw nsw i64 %polly.indvar363, 3
  %145 = trunc i64 %polly.indvar363 to i8
  %pexp.p_div_q366.lhs.trunc = add i8 %145, 2
  %pexp.p_div_q366775 = udiv i8 %pexp.p_div_q366.lhs.trunc, 3
  %pexp.p_div_q366.zext = zext i8 %pexp.p_div_q366775 to i64
  %146 = sub nsw i64 %144, %pexp.p_div_q366.zext
  %147 = shl nsw i64 %polly.indvar363, 8
  %148 = mul nsw i64 %polly.indvar363, -256
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next364, 5
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv815 = phi i64 [ %indvars.iv.next816, %polly.loop_exit375 ], [ %143, %polly.loop_header360 ]
  %indvars.iv810 = phi i64 [ %indvars.iv.next811, %polly.loop_exit375 ], [ %142, %polly.loop_header360 ]
  ...
  %149 = add i64 %smax812, %indvars.iv815
  %150 = mul nsw i64 %polly.indvar370, 96
  %151 = sub nsw i64 %147, %150
  %152 = icmp sgt i64 %151, 0
  %153 = select i1 %152, i64 %151, i64 0
  %154 = mul nsw i64 %polly.indvar370, -96
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382, %polly.loop_header367
  ...
  %indvars.iv.next811 = add i64 %indvars.iv810, -96
  %indvars.iv.next816 = add i64 %indvars.iv815, 96
...
polly.loop_exit382:                               ; preds = %polly.loop_exit390
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar376, %139
  br i1 %exitcond824.not, label %polly.loop_exit375, label %polly.loop_header373

polly.loop_header380:                             ; preds = %polly.loop_header373, %polly.loop_exit390
  %indvars.iv817 = phi i64 [ %149, %polly.loop_header373 ], [ %indvars.iv.next818, %polly.loop_exit390 ]
  %polly.indvar384 = phi i64 [ %153, %polly.loop_header373 ], [ %polly.indvar_next385, %polly.loop_exit390 ]
  %smin819 = call i64 @llvm.smin.i64(i64 %indvars.iv817, i64 255)
  %160 = add i64 %polly.indvar384, %150
  %161 = add i64 %160, %148
  %polly.loop_guard391887 = icmp sgt i64 %161, -1
...
polly.loop_header388:                             ; preds = %polly.loop_header388.preheader, %polly.loop_header388
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar392, %smin819
  br i1 %exitcond820.not, label %polly.loop_exit390, label %polly.loop_header388
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %wide.load986 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !81, !noalias !83
  ...
  br i1 %177, label %middle.block975, label %vector.body977, !llvm.loop !86
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %smin846 = call i64 @llvm.smin.i64(i64 %indvars.iv844, i64 -936)
  %179 = shl nsw i64 %polly.indvar515, 6
  %180 = add nsw i64 %smin846, 999
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar_next516, 16
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %indvars.iv831 = phi i64 [ %indvars.iv.next832, %polly.loop_exit527 ], [ 2, %polly.loop_header512 ]
  ...
  %181 = udiv i64 %indvars.iv831, 3
  %182 = mul nuw nsw i64 %181, 96
  %183 = add i64 %indvars.iv829, %182
  %184 = sub nsw i64 %indvars.iv836, %182
  %185 = mul nuw nsw i64 %polly.indvar521, 3
  %186 = trunc i64 %polly.indvar521 to i8
  %pexp.p_div_q524.lhs.trunc = add i8 %186, 2
  %pexp.p_div_q524774 = udiv i8 %pexp.p_div_q524.lhs.trunc, 3
  %pexp.p_div_q524.zext = zext i8 %pexp.p_div_q524774 to i64
  %187 = sub nsw i64 %185, %pexp.p_div_q524.zext
  %188 = shl nsw i64 %polly.indvar521, 8
  %189 = mul nsw i64 %polly.indvar521, -256
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next522, 5
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv838 = phi i64 [ %indvars.iv.next839, %polly.loop_exit533 ], [ %184, %polly.loop_header518 ]
  %indvars.iv833 = phi i64 [ %indvars.iv.next834, %polly.loop_exit533 ], [ %183, %polly.loop_header518 ]
  ...
  %191 = mul nsw i64 %polly.indvar528, 96
  %192 = sub nsw i64 %188, %191
  %193 = icmp sgt i64 %192, 0
  %194 = select i1 %193, i64 %192, i64 0
  %195 = mul nsw i64 %polly.indvar528, -96
...
polly.loop_exit540:                               ; preds = %polly.loop_exit548
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar534, %180
  br i1 %exitcond847.not, label %polly.loop_exit533, label %polly.loop_header531

polly.loop_header538:                             ; preds = %polly.loop_header531, %polly.loop_exit548
  %indvars.iv840 = phi i64 [ %190, %polly.loop_header531 ], [ %indvars.iv.next841, %polly.loop_exit548 ]
  ...
  %201 = add i64 %polly.indvar542, %191
  %202 = add i64 %201, %189
  %polly.loop_guard549888 = icmp sgt i64 %202, -1
...
polly.loop_header546:                             ; preds = %polly.loop_header546.preheader, %polly.loop_header546
  ...
  %exitcond843.not = icmp eq i64 %polly.indvar550, %smin842
  br i1 %exitcond843.not, label %polly.loop_exit548, label %polly.loop_header546
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  br i1 %232, label %polly.loop_exit714, label %vector.body915, !llvm.loop !95
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %261, label %polly.loop_exit741, label %vector.body930, !llvm.loop !98
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  br i1 %290, label %polly.loop_exit767, label %vector.body948, !llvm.loop !101
