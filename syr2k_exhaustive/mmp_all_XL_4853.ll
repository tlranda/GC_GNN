; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4853.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4853.c"
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %151 = mul nsw i64 %polly.indvar386, -80
  %152 = mul nuw nsw i64 %polly.indvar386, 80
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %176 = shl nsw i64 %polly.indvar398, 4
  %177 = add nsw i64 %176, %151
  %178 = icmp sgt i64 %177, 0
  %179 = select i1 %178, i64 %177, i64 0
  %polly.loop_guard405 = icmp slt i64 %179, 80
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %205 = mul nsw i64 %polly.indvar576, -80
  %206 = mul nuw nsw i64 %polly.indvar576, 80
