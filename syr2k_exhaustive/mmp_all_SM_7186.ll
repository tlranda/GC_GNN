; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7186.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7186.c"
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %.inv838 = icmp slt i64 %138, 59
  %140 = select i1 %.inv838, i64 %139, i64 59
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %indvars.iv.next872 = add i64 %indvars.iv871, -20
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %.inv839 = icmp slt i64 %177, 59
  %179 = select i1 %.inv839, i64 %178, i64 59
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %187 = mul nsw i64 %polly.indvar590, 20
