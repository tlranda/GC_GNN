; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3032.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3032.c"
...
polly.loop_header254:                             ; preds = %polly.loop_header254.preheader, %polly.loop_exit262
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv900, i64 79)
...
polly.loop_exit262:                               ; preds = %polly.loop_header260
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar_next258, 20
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %155 = shl nuw nsw i64 %polly.indvar396, 2
  %156 = mul nsw i64 %polly.indvar396, -80
  %157 = mul nuw nsw i64 %polly.indvar396, 80
...
polly.loop_header399:                             ; preds = %polly.loop_exit446.3, %polly.loop_header393
  ...
  %158 = mul nuw nsw i64 %polly.indvar402, 20
  %159 = add nsw i64 %158, %156
  %160 = add nsw i64 %159, -1
  %.inv869 = icmp ugt i64 %159, 79
  %161 = select i1 %.inv869, i64 79, i64 %160
  %polly.loop_guard415 = icmp sgt i64 %161, -1
  %162 = add nuw nsw i64 %159, 19
...
polly.loop_exit452:                               ; preds = %polly.loop_header450
  ...
  %exitcond919.not = icmp eq i64 %polly.indvar_next448, 20
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %199 = shl nuw nsw i64 %polly.indvar586, 2
  %200 = mul nsw i64 %polly.indvar586, -80
  %201 = mul nuw nsw i64 %polly.indvar586, 80
...
polly.loop_header589:                             ; preds = %polly.loop_exit636.3, %polly.loop_header583
  ...
  %202 = mul nuw nsw i64 %polly.indvar592, 20
  %203 = add nsw i64 %202, %200
  %204 = add nsw i64 %203, -1
  %.inv870 = icmp ugt i64 %203, 79
  %205 = select i1 %.inv870, i64 79, i64 %204
  %polly.loop_guard605 = icmp sgt i64 %205, -1
  %206 = add nuw nsw i64 %203, 19
...
polly.loop_header634:                             ; preds = %polly.loop_header634.preheader, %polly.loop_exit642
  ...
  %smin933 = call i64 @llvm.smin.i64(i64 %indvars.iv931, i64 79)
...
polly.loop_exit642:                               ; preds = %polly.loop_header640
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar_next638, 20
...
polly.loop_header254.1:                           ; preds = %polly.loop_exit262, %polly.loop_exit262.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv900.1, i64 79)
...
polly.loop_exit262.1:                             ; preds = %polly.loop_header260.1
  ...
  %exitcond903.1.not = icmp eq i64 %polly.indvar_next258.1, 20
...
polly.loop_header254.2:                           ; preds = %polly.loop_exit262.1, %polly.loop_exit262.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv900.2, i64 79)
...
polly.loop_exit262.2:                             ; preds = %polly.loop_header260.2
  ...
  %exitcond903.2.not = icmp eq i64 %polly.indvar_next258.2, 20
...
polly.loop_header254.3:                           ; preds = %polly.loop_exit262.2, %polly.loop_exit262.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv900.3, i64 79)
...
polly.loop_exit262.3:                             ; preds = %polly.loop_header260.3
  ...
  %exitcond903.3.not = icmp eq i64 %polly.indvar_next258.3, 20
...
polly.loop_exit256.3:                             ; preds = %polly.loop_exit262.3
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next215, 60
...
polly.loop_exit452.1:                             ; preds = %polly.loop_header450.1
  ...
  %exitcond919.1.not = icmp eq i64 %polly.indvar_next448.1, 20
...
polly.loop_exit452.2:                             ; preds = %polly.loop_header450.2
  ...
  %exitcond919.2.not = icmp eq i64 %polly.indvar_next448.2, 20
...
polly.loop_exit452.3:                             ; preds = %polly.loop_header450.3
  ...
  %exitcond919.3.not = icmp eq i64 %polly.indvar_next448.3, 20
...
polly.loop_exit446.3:                             ; preds = %polly.loop_exit452.3
  ...
  %exitcond921.not = icmp eq i64 %polly.indvar_next403, 60
...
polly.loop_header634.1:                           ; preds = %polly.loop_exit642, %polly.loop_exit642.1
  ...
  %smin933.1 = call i64 @llvm.smin.i64(i64 %indvars.iv931.1, i64 79)
...
polly.loop_exit642.1:                             ; preds = %polly.loop_header640.1
  ...
  %exitcond935.1.not = icmp eq i64 %polly.indvar_next638.1, 20
...
polly.loop_header634.2:                           ; preds = %polly.loop_exit642.1, %polly.loop_exit642.2
  ...
  %smin933.2 = call i64 @llvm.smin.i64(i64 %indvars.iv931.2, i64 79)
...
polly.loop_exit642.2:                             ; preds = %polly.loop_header640.2
  ...
  %exitcond935.2.not = icmp eq i64 %polly.indvar_next638.2, 20
...
polly.loop_header634.3:                           ; preds = %polly.loop_exit642.2, %polly.loop_exit642.3
  ...
  %smin933.3 = call i64 @llvm.smin.i64(i64 %indvars.iv931.3, i64 79)
...
polly.loop_exit642.3:                             ; preds = %polly.loop_header640.3
  ...
  %exitcond935.3.not = icmp eq i64 %polly.indvar_next638.3, 20
...
polly.loop_exit636.3:                             ; preds = %polly.loop_exit642.3
  ...
  %indvars.iv.next930 = add nuw nsw i64 %indvars.iv929, 20
  %exitcond937.not = icmp eq i64 %polly.indvar_next593, 60
