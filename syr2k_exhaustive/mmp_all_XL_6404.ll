; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6404.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6404.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %105 = mul nuw nsw i64 %polly.indvar224, 96
  %106 = sub nsw i64 %101, %105
  %107 = icmp sgt i64 %106, 0
  %108 = select i1 %107, i64 %106, i64 0
  %109 = mul nsw i64 %polly.indvar224, -96
...
polly.loop_header233:                             ; preds = %polly.loop_exit242, %polly.loop_header227
  ...
  %115 = add i64 %114, %102
  %polly.loop_guard243924 = icmp sgt i64 %115, -1
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1037
  ...
  %124 = shl nuw nsw i64 %index1040, 3
  %125 = getelementptr i8, i8* %scevgep366, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1044 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !79, !noalias !81
  %127 = fmul fast <4 x double> %wide.load1044, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1041, %n.vec1039
  br i1 %129, label %middle.block1031, label %vector.body1033, !llvm.loop !85

middle.block1031:                                 ; preds = %vector.body1033
  %cmp.n1043 = icmp eq i64 %122, %n.vec1039
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %131 = udiv i64 %polly.indvar373, 6
  %132 = mul nuw nsw i64 %131, 96
  %133 = sub nsw i64 %indvars.iv855, %132
  %134 = add i64 %indvars.iv860, %132
  %135 = shl nsw i64 %polly.indvar373, 4
  br label %polly.loop_header376

polly.loop_exit378:                               ; preds = %polly.loop_exit384
  %136 = mul nsw i64 %polly.indvar373, -16
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  ...
  %indvars.iv857 = phi i64 [ %indvars.iv.next858, %polly.loop_exit401 ], [ %133, %polly.loop_exit378 ]
  ...
  %139 = mul nuw nsw i64 %polly.indvar396, 96
  %140 = sub nsw i64 %135, %139
  %141 = icmp sgt i64 %140, 0
  %142 = select i1 %141, i64 %140, i64 0
  %143 = mul nsw i64 %polly.indvar396, -96
...
polly.loop_header406:                             ; preds = %polly.loop_exit416, %polly.loop_header399
  %indvars.iv864 = phi i64 [ %indvars.iv.next865, %polly.loop_exit416 ], [ %138, %polly.loop_header399 ]
  ...
  %149 = add i64 %148, %136
  %polly.loop_guard417925 = icmp sgt i64 %149, -1
...
polly.loop_header528:                             ; preds = %polly.loop_exit536, %polly.start442
  ...
  %min.iters.check1010 = icmp ult i64 %156, 4
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %158 = shl nuw nsw i64 %index1014, 3
  %159 = getelementptr i8, i8* %scevgep540, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load1018 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !89, !noalias !91
  %161 = fmul fast <4 x double> %wide.load1018, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next1015, %n.vec1013
  br i1 %163, label %middle.block1007, label %vector.body1009, !llvm.loop !95

middle.block1007:                                 ; preds = %vector.body1009
  %cmp.n1017 = icmp eq i64 %156, %n.vec1013
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %165 = udiv i64 %polly.indvar547, 6
  %166 = mul nuw nsw i64 %165, 96
  %167 = sub nsw i64 %indvars.iv876, %166
  %168 = add i64 %indvars.iv881, %166
  %169 = shl nsw i64 %polly.indvar547, 4
  br label %polly.loop_header550

polly.loop_exit552:                               ; preds = %polly.loop_exit558
  %170 = mul nsw i64 %polly.indvar547, -16
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  %indvars.iv883 = phi i64 [ %indvars.iv.next884, %polly.loop_exit575 ], [ %168, %polly.loop_exit552 ]
  %indvars.iv878 = phi i64 [ %indvars.iv.next879, %polly.loop_exit575 ], [ %167, %polly.loop_exit552 ]
  ...
  %172 = add i64 %smax880, %indvars.iv883
  %173 = mul nuw nsw i64 %polly.indvar570, 96
...
polly.loop_header580:                             ; preds = %polly.loop_exit590, %polly.loop_header573
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit590 ], [ %172, %polly.loop_header573 ]
  ...
  %183 = add i64 %182, %170
  %polly.loop_guard591926 = icmp sgt i64 %183, -1
...
polly.loop_header746:                             ; preds = %polly.loop_exit754, %polly.loop_header740
  ...
  %smin948 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin948, 1200
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -1168)
  %194 = shl nsw i64 %polly.indvar749, 5
  %195 = add nsw i64 %smin915, 1199
...
vector.ph949:                                     ; preds = %polly.loop_header752
  %broadcast.splatinsert956 = insertelement <4 x i64> poison, i64 %194, i32 0
...
vector.body947:                                   ; preds = %vector.body947, %vector.ph949
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind954, %broadcast.splat957
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat959, %200
  ...
  %211 = icmp eq i64 %index.next951, %193
  br i1 %211, label %polly.loop_exit760, label %vector.body947, !llvm.loop !104

polly.loop_exit760:                               ; preds = %vector.body947, %polly.loop_header758
  %polly.indvar_next756 = add nuw nsw i64 %polly.indvar755, 1
  %exitcond920.not = icmp eq i64 %polly.indvar755, %191
...
polly.loop_header758:                             ; preds = %polly.loop_header752, %polly.loop_header758
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar761, %195
...
polly.loop_header773:                             ; preds = %polly.loop_exit781, %polly.loop_header767
  ...
  %smin963 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin963, 1000
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 -968)
  %223 = shl nsw i64 %polly.indvar776, 5
  %224 = add nsw i64 %smin905, 999
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph965
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind972, %broadcast.splat975
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat977, %229
  ...
  %240 = icmp eq i64 %index.next969, %222
  br i1 %240, label %polly.loop_exit787, label %vector.body962, !llvm.loop !107

polly.loop_exit787:                               ; preds = %vector.body962, %polly.loop_header785
  %polly.indvar_next783 = add nuw nsw i64 %polly.indvar782, 1
  %exitcond910.not = icmp eq i64 %polly.indvar782, %220
...
polly.loop_header785:                             ; preds = %polly.loop_header779, %polly.loop_header785
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar788, %224
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  %smin981 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin981, 1000
  %smin895 = call i64 @llvm.smin.i64(i64 %indvars.iv893, i64 -968)
  %252 = shl nsw i64 %polly.indvar802, 5
  %253 = add nsw i64 %smin895, 999
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph983
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind990, %broadcast.splat993
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat995, %258
  ...
  %269 = icmp eq i64 %index.next987, %251
  br i1 %269, label %polly.loop_exit813, label %vector.body980, !llvm.loop !110

polly.loop_exit813:                               ; preds = %vector.body980, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond900.not = icmp eq i64 %polly.indvar808, %249
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond896.not = icmp eq i64 %polly.indvar814, %253
