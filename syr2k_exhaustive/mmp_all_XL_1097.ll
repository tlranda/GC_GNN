; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1097.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1097.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit220.3, %polly.loop_exit271.3
  ...
  %109 = mul nuw nsw i64 %indvar1433, 100
  %110 = mul nuw nsw i64 %indvar1433, 960000
  %111 = add i64 %101, %110
  %112 = add i64 %102, %110
  %113 = mul nuw nsw i64 %indvar1433, 100
  %114 = mul nuw nsw i64 %indvar1433, 100
  %115 = mul nuw nsw i64 %indvar1433, 960000
  %116 = add i64 %103, %115
  %117 = add i64 %104, %115
  %118 = mul nuw nsw i64 %indvar1433, 100
  %119 = mul nuw nsw i64 %indvar1433, 100
  %120 = mul nuw nsw i64 %indvar1433, 960000
  %121 = add i64 %105, %120
  %122 = add i64 %106, %120
  %123 = mul nuw nsw i64 %indvar1433, 100
  %124 = mul nuw nsw i64 %indvar1433, 100
  %125 = mul nuw nsw i64 %polly.indvar231, 100
  %126 = add nsw i64 %125, %400
  %127 = icmp ugt i64 %126, 100
  %128 = select i1 %127, i64 %126, i64 100
  %129 = add nuw nsw i64 %126, 99
...
polly.loop_header412:                             ; preds = %polly.loop_exit436, %polly.loop_header406
  ...
  %175 = mul nuw nsw i64 %polly.indvar415, 960800
  %176 = or i64 %175, 8
  %177 = mul nuw nsw i64 %polly.indvar415, 960800
  %178 = or i64 %177, 8
  %179 = mul nuw nsw i64 %polly.indvar415, 960800
  %180 = or i64 %179, 8
  %181 = mul nuw nsw i64 %polly.indvar415, 100
...
polly.loop_header434:                             ; preds = %polly.loop_exit426.3, %polly.loop_exit479.3
  ...
  %183 = mul nuw nsw i64 %indvar1294, 100
  %184 = mul nuw nsw i64 %indvar1294, 960000
  %185 = add i64 %175, %184
  %186 = add i64 %176, %184
  %187 = mul nuw nsw i64 %indvar1294, 100
  %188 = mul nuw nsw i64 %indvar1294, 100
  %189 = mul nuw nsw i64 %indvar1294, 960000
  %190 = add i64 %177, %189
  %191 = add i64 %178, %189
  %192 = mul nuw nsw i64 %indvar1294, 100
  %193 = mul nuw nsw i64 %indvar1294, 100
  %194 = mul nuw nsw i64 %indvar1294, 960000
  %195 = add i64 %179, %194
  %196 = add i64 %180, %194
  %197 = mul nuw nsw i64 %indvar1294, 100
  %198 = mul nuw nsw i64 %indvar1294, 100
  %199 = mul nuw nsw i64 %polly.indvar437, 100
...
polly.loop_header620:                             ; preds = %polly.loop_exit644, %polly.loop_header614
  ...
  %249 = mul nuw nsw i64 %polly.indvar623, 960800
  %250 = or i64 %249, 8
  %251 = mul nuw nsw i64 %polly.indvar623, 960800
  %252 = or i64 %251, 8
  %253 = mul nuw nsw i64 %polly.indvar623, 960800
  %254 = or i64 %253, 8
  %255 = mul nuw nsw i64 %polly.indvar623, 100
...
polly.loop_header642:                             ; preds = %polly.loop_exit634.3, %polly.loop_exit687.3
  ...
  %257 = mul nuw nsw i64 %indvar1155, 100
  %258 = mul nuw nsw i64 %indvar1155, 960000
  %259 = add i64 %249, %258
  %260 = add i64 %250, %258
  %261 = mul nuw nsw i64 %indvar1155, 100
  %262 = mul nuw nsw i64 %indvar1155, 100
  %263 = mul nuw nsw i64 %indvar1155, 960000
  %264 = add i64 %251, %263
  %265 = add i64 %252, %263
  %266 = mul nuw nsw i64 %indvar1155, 100
  %267 = mul nuw nsw i64 %indvar1155, 100
  %268 = mul nuw nsw i64 %indvar1155, 960000
  %269 = add i64 %253, %268
  %270 = add i64 %254, %268
  %271 = mul nuw nsw i64 %indvar1155, 100
  %272 = mul nuw nsw i64 %indvar1155, 100
  %273 = mul nuw nsw i64 %polly.indvar645, 100
  %274 = add nsw i64 %273, %596
  %275 = icmp ugt i64 %274, 100
  %276 = select i1 %275, i64 %274, i64 100
  %277 = add nuw nsw i64 %274, 99
...
polly.loop_header269.3:                           ; preds = %polly.loop_exit277.2, %polly.loop_exit277.3
  ...
  %smin1435 = call i64 @llvm.smin.i64(i64 %470, i64 99)
...
polly.loop_exit426.3:                             ; preds = %polly.loop_header424.3
  %498 = mul nsw i64 %polly.indvar415, -100
...
polly.loop_header477.3:                           ; preds = %polly.loop_exit485.2, %polly.loop_exit485.3
  ...
  %smin1296 = call i64 @llvm.smin.i64(i64 %568, i64 99)
...
polly.loop_exit634.3:                             ; preds = %polly.loop_header632.3
  %596 = mul nsw i64 %polly.indvar623, -100
...
polly.loop_header685.3:                           ; preds = %polly.loop_exit693.2, %polly.loop_exit693.3
  ...
  %smin1157 = call i64 @llvm.smin.i64(i64 %666, i64 99)
