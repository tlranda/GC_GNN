; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4466.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4466.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv976 = phi i64 [ 5, %polly.loop_header199.preheader ], [ %indvars.iv.next977, %polly.loop_exit207 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next966 = add nuw nsw i64 %indvars.iv965, 20
  %indvars.iv.next977 = add nuw nsw i64 %indvars.iv976, 5
  %exitcond979.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %polly.loop_guard = icmp slt i64 %102, 20
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit387
  %indvars.iv1000 = phi i64 [ 5, %polly.loop_header379.preheader ], [ %indvars.iv.next1001, %polly.loop_exit387 ]
  ...
  %125 = mul nsw i64 %polly.indvar382, -20
  %126 = mul nuw nsw i64 %polly.indvar382, 20
...
polly.loop_exit387:                               ; preds = %polly.loop_exit394
  ...
  %indvars.iv.next1001 = add nuw nsw i64 %indvars.iv1000, 5
  %exitcond1003.not = icmp eq i64 %polly.indvar_next383, 60
...
polly.loop_header385:                             ; preds = %polly.loop_exit394, %polly.loop_header379
  ...
  %127 = shl nsw i64 %polly.indvar388, 2
  %128 = add nsw i64 %127, %125
  %129 = icmp sgt i64 %128, 0
  %130 = select i1 %129, i64 %128, i64 0
  %polly.loop_guard395 = icmp slt i64 %130, 20
...
polly.loop_exit430:                               ; preds = %polly.loop_exit437.loopexit.us, %polly.loop_header392.split, %polly.loop_header428.preheader
  ...
  %polly.loop_cond398 = icmp ult i64 %polly.indvar396, 19
...
polly.loop_header565:                             ; preds = %polly.loop_header565.preheader, %polly.loop_exit573
  %indvars.iv1024 = phi i64 [ 5, %polly.loop_header565.preheader ], [ %indvars.iv.next1025, %polly.loop_exit573 ]
  ...
  %153 = mul nsw i64 %polly.indvar568, -20
  %154 = mul nuw nsw i64 %polly.indvar568, 20
...
polly.loop_exit573:                               ; preds = %polly.loop_exit580
  ...
  %indvars.iv.next1025 = add nuw nsw i64 %indvars.iv1024, 5
  %exitcond1027.not = icmp eq i64 %polly.indvar_next569, 60
...
polly.loop_header571:                             ; preds = %polly.loop_exit580, %polly.loop_header565
  ...
  %155 = shl nsw i64 %polly.indvar574, 2
  %156 = add nsw i64 %155, %153
  %157 = icmp sgt i64 %156, 0
  %158 = select i1 %157, i64 %156, i64 0
  %polly.loop_guard581 = icmp slt i64 %158, 20
...
polly.loop_exit580:                               ; preds = %polly.loop_exit616, %polly.loop_header571
  ...
  %indvars.iv.next1010 = add nsw i64 %indvars.iv1009, 4
  %indvars.iv.next1015 = add nsw i64 %indvars.iv1014, -4
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit616
  ...
  %smin1021 = call i64 @llvm.smin.i64(i64 %indvars.iv1016, i64 3)
...
polly.loop_exit616:                               ; preds = %polly.loop_exit623.loopexit.us, %polly.loop_header578.split, %polly.loop_header614.preheader
  ...
  %polly.loop_cond584 = icmp ult i64 %polly.indvar582, 19
