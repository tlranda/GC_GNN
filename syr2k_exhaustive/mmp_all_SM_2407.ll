; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2407.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2407.c"
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond1073.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !72
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %smin1064 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -872)
...
vector.body1371:                                  ; preds = %vector.body1371, %vector.ph1377
  ...
  %wide.load1390 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !64, !noalias !66
  ...
  store <4 x double> %145, <4 x double>* %146, align 8, !alias.scope !64, !noalias !66
  %index.next1381 = add i64 %index1380, 4
  %147 = icmp eq i64 %index.next1381, %n.vec1379
  br i1 %147, label %middle.block1369, label %vector.body1371, !llvm.loop !76
...
polly.loop_header274.us:                          ; preds = %polly.loop_header274.us.preheader, %polly.loop_header274.us
  ...
  br i1 %exitcond1063.not, label %polly.loop_exit276.loopexit.us, label %polly.loop_header274.us, !llvm.loop !77
...
vector.body1309:                                  ; preds = %vector.body1309, %vector.ph1313
  ...
  %wide.load1320 = load <4 x double>, <4 x double>* %155, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %158, label %middle.block1307, label %vector.body1309, !llvm.loop !85
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_header396
  ...
  br i1 %exitcond1105.not, label %polly.loop_exit398, label %polly.loop_header396, !llvm.loop !86
...
polly.loop_header428:                             ; preds = %polly.loop_exit438, %polly.loop_header422
  ...
  %smin1096 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 -872)
...
polly.loop_header436.preheader:                   ; preds = %polly.loop_header428
  %171 = shl nsw i64 %polly.indvar431, 7
  br label %polly.loop_header436

polly.loop_exit438:                               ; preds = %polly.loop_exit446, %polly.loop_header428
  %polly.indvar_next432 = add nuw nsw i64 %polly.indvar431, 1
  %indvars.iv.next1076 = add nsw i64 %indvars.iv1075, -128
  %exitcond1101.not = icmp eq i64 %polly.indvar_next432, 8
...
vector.body1323:                                  ; preds = %vector.body1323, %vector.ph1329
  ...
  %wide.load1342 = load <4 x double>, <4 x double>* %205, align 8, !alias.scope !78, !noalias !80
  ...
  store <4 x double> %208, <4 x double>* %209, align 8, !alias.scope !78, !noalias !80
  %index.next1333 = add i64 %index1332, 4
  %210 = icmp eq i64 %index.next1333, %n.vec1331
  br i1 %210, label %middle.block1321, label %vector.body1323, !llvm.loop !89
...
polly.loop_header487.us:                          ; preds = %polly.loop_header487.us.preheader, %polly.loop_header487.us
  ...
  br i1 %exitcond1095.not, label %polly.loop_exit489.loopexit.us, label %polly.loop_header487.us, !llvm.loop !90
...
vector.body1263:                                  ; preds = %vector.body1263, %vector.ph1265
  ...
  %wide.load1272 = load <4 x double>, <4 x double>* %218, align 8, !alias.scope !91, !noalias !93
  ...
  store <4 x double> %219, <4 x double>* %220, align 8, !alias.scope !91, !noalias !93
  %index.next1269 = add i64 %index1268, 4
  %221 = icmp eq i64 %index.next1269, %n.vec1267
  br i1 %221, label %middle.block1261, label %vector.body1263, !llvm.loop !98
...
polly.loop_header641:                             ; preds = %polly.loop_exit651, %polly.loop_header635
  ...
  %smin1128 = call i64 @llvm.smin.i64(i64 %indvars.iv1107, i64 -872)
...
polly.loop_header649.preheader:                   ; preds = %polly.loop_header641
  %234 = shl nsw i64 %polly.indvar644, 7
...
vector.body1275:                                  ; preds = %vector.body1275, %vector.ph1281
  ...
  %wide.load1294 = load <4 x double>, <4 x double>* %268, align 8, !alias.scope !91, !noalias !93
  ...
  store <4 x double> %271, <4 x double>* %272, align 8, !alias.scope !91, !noalias !93
  %index.next1285 = add i64 %index1284, 4
  %273 = icmp eq i64 %index.next1285, %n.vec1283
  br i1 %273, label %middle.block1273, label %vector.body1275, !llvm.loop !102
...
polly.loop_header700.us:                          ; preds = %polly.loop_header700.us.preheader, %polly.loop_header700.us
  ...
  br i1 %exitcond1127.not, label %polly.loop_exit702.loopexit.us, label %polly.loop_header700.us, !llvm.loop !103
...
vector.body1202:                                  ; preds = %vector.body1202, %vector.ph1203
  ...
  store <4 x double> %292, <4 x double>* %297, align 8, !alias.scope !104, !noalias !106
  ...
  br i1 %298, label %polly.loop_exit872, label %vector.body1202, !llvm.loop !109
...
vector.body1216:                                  ; preds = %vector.body1216, %vector.ph1219
  ...
  store <4 x double> %321, <4 x double>* %326, align 8, !alias.scope !108, !noalias !111
  ...
  br i1 %327, label %polly.loop_exit899, label %vector.body1216, !llvm.loop !112
...
vector.body1234:                                  ; preds = %vector.body1234, %vector.ph1237
  ...
  store <4 x double> %350, <4 x double>* %355, align 8, !alias.scope !107, !noalias !114
  ...
  br i1 %356, label %polly.loop_exit925, label %vector.body1234, !llvm.loop !115
