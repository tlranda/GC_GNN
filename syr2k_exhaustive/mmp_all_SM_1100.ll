; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1100.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1100.c"
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1106.not = icmp eq i64 %116, 300
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_header250.7, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %polly.loop_guard273 = icmp slt i64 %134, 100
...
polly.loop_header270.us:                          ; preds = %polly.loop_header263.us, %polly.loop_exit280.us
  ...
  %smin1403 = call i64 @llvm.smin.i64(i64 %135, i64 3)
...
vector.body1397:                                  ; preds = %vector.body1397, %vector.ph1405
  ...
  %wide.load1418 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %159, label %middle.block1395, label %vector.body1397, !llvm.loop !85
...
vector.body1333:                                  ; preds = %vector.body1333, %vector.ph1337
  ...
  %wide.load1344 = load <4 x double>, <4 x double>* %165, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %168, label %middle.block1331, label %vector.body1333, !llvm.loop !93
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %exitcond1131.not = icmp eq i64 %189, 300
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_header466.7, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %polly.loop_guard490 = icmp slt i64 %207, 100
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1353 = call i64 @llvm.smin.i64(i64 %208, i64 3)
...
vector.body1347:                                  ; preds = %vector.body1347, %vector.ph1355
  ...
  %wide.load1368 = load <4 x double>, <4 x double>* %227, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %232, label %middle.block1345, label %vector.body1347, !llvm.loop !98
...
vector.body1285:                                  ; preds = %vector.body1285, %vector.ph1287
  ...
  %wide.load1294 = load <4 x double>, <4 x double>* %238, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %241, label %middle.block1283, label %vector.body1285, !llvm.loop !106
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %252 = udiv i64 %polly.indvar636, 25
  %253 = mul nuw nsw i64 %252, 100
  %254 = sub nsw i64 %251, %253
  %255 = mul nsw i64 %polly.indvar636, -4
  %256 = add i64 %255, %253
  %257 = udiv i64 %polly.indvar636, 25
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %exitcond1156.not = icmp eq i64 %262, 300
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_header683.7, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %polly.loop_guard707 = icmp slt i64 %280, 100
...
polly.loop_header704.us:                          ; preds = %polly.loop_header697.us, %polly.loop_exit714.us
  ...
  %smin1303 = call i64 @llvm.smin.i64(i64 %281, i64 3)
...
vector.body1297:                                  ; preds = %vector.body1297, %vector.ph1305
  ...
  %wide.load1318 = load <4 x double>, <4 x double>* %300, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %305, label %middle.block1295, label %vector.body1297, !llvm.loop !111
...
vector.body1223:                                  ; preds = %vector.body1223, %vector.ph1225
  ...
  br i1 %328, label %polly.loop_exit884, label %vector.body1223, !llvm.loop !117
...
vector.body1238:                                  ; preds = %vector.body1238, %vector.ph1241
  ...
  br i1 %357, label %polly.loop_exit911, label %vector.body1238, !llvm.loop !120
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1259
  ...
  br i1 %386, label %polly.loop_exit937, label %vector.body1256, !llvm.loop !123
