; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1530.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1530.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1035 = add nuw nsw i64 %indvars.iv1034, 8
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %101 = mul nsw i64 %polly.indvar231, -8
  %102 = add i64 %97, %101
  %103 = shl nsw i64 %polly.indvar231, 3
  %104 = sub nsw i64 %98, %103
  %105 = add nuw nsw i64 %103, 8
...
polly.loop_header234:                             ; preds = %polly.loop_exit265, %polly.loop_header228
  ...
  %smin1341 = call i64 @llvm.smin.i64(i64 %106, i64 7)
  %107 = add nsw i64 %smin1341, 1
  %smin1044 = call i64 @llvm.smin.i64(i64 %indvars.iv1038, i64 7)
...
polly.loop_exit265:                               ; preds = %polly.loop_exit272.loopexit.us, %polly.loop_header234.split, %polly.loop_header263.preheader
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar_next238, 8
...
polly.loop_header418:                             ; preds = %polly.loop_exit410, %polly.loop_exit426
  ...
  %145 = shl nuw nsw i64 %polly.indvar421, 3
  %146 = shl nsw i64 %polly.indvar421, 3
...
polly.loop_exit426:                               ; preds = %polly.loop_exit432
  ...
  %exitcond1081.not = icmp eq i64 %polly.indvar_next422, 150
...
polly.loop_header430:                             ; preds = %polly.loop_exit438, %polly.loop_header424
  ...
  %149 = mul nsw i64 %polly.indvar433, -8
  %150 = add i64 %145, %149
  %151 = shl nsw i64 %polly.indvar433, 3
  %152 = sub nsw i64 %146, %151
  %153 = add nuw nsw i64 %151, 8
...
polly.loop_header436:                             ; preds = %polly.loop_exit473, %polly.loop_header430
  ...
  %smin1296 = call i64 @llvm.smin.i64(i64 %154, i64 7)
...
polly.loop_exit473:                               ; preds = %polly.loop_exit480.loopexit.us, %polly.loop_header436.split, %polly.loop_header471.preheader
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar_next440, 8
...
polly.loop_header626:                             ; preds = %polly.loop_exit618, %polly.loop_exit634
  ...
  %193 = shl nuw nsw i64 %polly.indvar629, 3
  %194 = shl nsw i64 %polly.indvar629, 3
...
polly.loop_exit634:                               ; preds = %polly.loop_exit640
  ...
  %indvars.iv.next1091 = add nuw nsw i64 %indvars.iv1090, 8
  %indvars.iv.next1106 = add nuw nsw i64 %indvars.iv1105, 1
  %exitcond1109.not = icmp eq i64 %polly.indvar_next630, 150
...
polly.loop_header638:                             ; preds = %polly.loop_exit646, %polly.loop_header632
  ...
  %197 = mul nsw i64 %polly.indvar641, -8
  %198 = add i64 %193, %197
  %199 = shl nsw i64 %polly.indvar641, 3
...
polly.loop_header644:                             ; preds = %polly.loop_exit681, %polly.loop_header638
  ...
  %smin1251 = call i64 @llvm.smin.i64(i64 %202, i64 7)
  %203 = add nsw i64 %smin1251, 1
  %smin1100 = call i64 @llvm.smin.i64(i64 %indvars.iv1094, i64 7)
...
polly.loop_exit681:                               ; preds = %polly.loop_exit688.loopexit.us, %polly.loop_header644.split, %polly.loop_header679.preheader
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar_next648, 8
