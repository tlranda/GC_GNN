; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1010.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1010.c"
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1105.not = icmp eq i64 %polly.indvar_next204, 50
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %102 = sub i64 %98, %101
  %103 = mul nsw i64 %polly.indvar209, -128
  %104 = add i64 %103, %101
  %105 = udiv i64 %polly.indvar209, 3
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %115 = mul nsw i64 %indvar1402, -96
  %116 = add i64 %102, %115
  %smax1404 = call i64 @llvm.smax.i64(i64 %116, i64 0)
  %117 = mul nuw nsw i64 %indvar1402, 96
  %118 = add i64 %104, %117
...
polly.loop_exit274:                               ; preds = %polly.loop_exit282
  ...
  %exitcond1103.not = icmp eq i64 %polly.indvar_next269, 20
...
polly.loop_header272:                             ; preds = %polly.loop_header265, %polly.loop_exit282
  ...
  %smin1407 = call i64 @llvm.smin.i64(i64 %142, i64 127)
...
polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  ...
  %176 = mul nuw nsw i64 %polly.indvar415, 20
  br label %polly.loop_header418

polly.loop_exit420:                               ; preds = %polly.loop_exit443
  %polly.indvar_next416 = add nuw nsw i64 %polly.indvar415, 1
  %exitcond1130.not = icmp eq i64 %polly.indvar_next416, 50
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %190 = shl nsw i64 %polly.indvar421, 7
...
polly.loop_exit432:                               ; preds = %polly.loop_header430
  ...
  %exitcond1111.not = icmp eq i64 %polly.indvar_next428, 20
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit426
  ...
  %194 = mul nsw i64 %indvar1352, -96
  %195 = add i64 %181, %194
  %smax1354 = call i64 @llvm.smax.i64(i64 %195, i64 0)
  %196 = mul nuw nsw i64 %indvar1352, 96
  %197 = add i64 %183, %196
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_exit456.loopexit.us
  ...
  %exitcond1114.not = icmp eq i64 %polly.indvar_next451.us, 20
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1112.not = icmp eq i64 %polly.indvar_next451, 20
...
polly.loop_exit489:                               ; preds = %polly.loop_exit497
  ...
  %exitcond1128.not = icmp eq i64 %polly.indvar_next484, 20
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %smin1357 = call i64 @llvm.smin.i64(i64 %221, i64 127)
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %255 = mul nuw nsw i64 %polly.indvar630, 20
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %256 = shl nuw nsw i64 %polly.indvar636, 7
  %257 = udiv i64 %polly.indvar636, 3
  %258 = add nuw i64 %polly.indvar636, %257
  %259 = mul nuw nsw i64 %258, 96
  %260 = sub i64 %256, %259
  %261 = mul nsw i64 %polly.indvar636, -128
  %262 = add i64 %261, %259
  %263 = udiv i64 %polly.indvar636, 3
  ...
  %268 = mul nsw i64 %polly.indvar636, -128
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1136.not = icmp eq i64 %polly.indvar_next643, 20
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit641
  ...
  %273 = mul nsw i64 %indvar1302, -96
  %274 = add i64 %260, %273
  %smax1304 = call i64 @llvm.smax.i64(i64 %274, i64 0)
  %275 = mul nuw nsw i64 %indvar1302, 96
  %276 = add i64 %262, %275
...
polly.loop_exit683.us:                            ; preds = %polly.loop_header681.us, %polly.loop_exit671.loopexit.us
  ...
  %exitcond1139.not = icmp eq i64 %polly.indvar_next666.us, 20
...
polly.loop_exit683:                               ; preds = %polly.loop_header681
  ...
  %exitcond1137.not = icmp eq i64 %polly.indvar_next666, 20
...
polly.loop_exit704:                               ; preds = %polly.loop_exit712
  ...
  %exitcond1153.not = icmp eq i64 %polly.indvar_next699, 20
...
polly.loop_header702:                             ; preds = %polly.loop_header695, %polly.loop_exit712
  ...
  %smin1307 = call i64 @llvm.smin.i64(i64 %300, i64 127)
