; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10530.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10530.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next209, 250
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233885 = icmp sgt i64 %118, -1
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1004
  ...
  %131 = shl nuw nsw i64 %index1007, 3
  %132 = getelementptr i8, i8* %scevgep350, i64 %131
  %133 = bitcast i8* %132 to <4 x double>*
  %wide.load1011 = load <4 x double>, <4 x double>* %133, align 8, !alias.scope !69, !noalias !71
  %134 = fmul fast <4 x double> %wide.load1011, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %136 = icmp eq i64 %index.next1008, %n.vec1006
  br i1 %136, label %middle.block998, label %vector.body1000, !llvm.loop !74

middle.block998:                                  ; preds = %vector.body1000
  %cmp.n1010 = icmp eq i64 %129, %n.vec1006
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %138 = udiv i64 %indvars.iv819, 5
  %139 = add nuw i64 %indvars.iv817, %138
  %umin821 = call i64 @llvm.umin.i64(i64 %139, i64 53)
  %140 = mul nsw i64 %polly.indvar357, -128
  %141 = icmp slt i64 %140, -1072
  %142 = select i1 %141, i64 %140, i64 -1072
  %143 = add nsw i64 %142, 1199
  %144 = shl nsw i64 %polly.indvar357, 7
  %145 = add nuw nsw i64 %umin821, 6
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next364, 250
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %157 = add i64 %smax807, %indvars.iv810
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond822.not = icmp eq i64 %polly.indvar370, %145
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv812 = phi i64 [ %157, %polly.loop_header374.preheader ], [ %indvars.iv.next813, %polly.loop_exit383 ]
  ...
  %polly.loop_guard391886 = icmp sgt i64 %159, -1
...
vector.body976:                                   ; preds = %vector.body976, %vector.ph978
  ...
  %172 = shl nuw nsw i64 %index981, 3
  %173 = getelementptr i8, i8* %scevgep508, i64 %172
  %174 = bitcast i8* %173 to <4 x double>*
  %wide.load985 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !78, !noalias !80
  %175 = fmul fast <4 x double> %wide.load985, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %177 = icmp eq i64 %index.next982, %n.vec980
  br i1 %177, label %middle.block974, label %vector.body976, !llvm.loop !83

middle.block974:                                  ; preds = %vector.body976
  %cmp.n984 = icmp eq i64 %170, %n.vec980
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %179 = udiv i64 %indvars.iv843, 5
  %180 = add nuw i64 %indvars.iv841, %179
  %umin845 = call i64 @llvm.umin.i64(i64 %180, i64 53)
  %181 = mul nsw i64 %polly.indvar515, -128
  %182 = icmp slt i64 %181, -1072
  %183 = select i1 %182, i64 %181, i64 -1072
  %184 = add nsw i64 %183, 1199
  %185 = shl nsw i64 %polly.indvar515, 7
  %186 = add nuw nsw i64 %umin845, 6
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar_next522, 250
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %198 = add i64 %smax831, %indvars.iv834
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar528, %186
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv836 = phi i64 [ %198, %polly.loop_header532.preheader ], [ %indvars.iv.next837, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549887 = icmp sgt i64 %200, -1
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin915 = call i64 @llvm.smin.i64(i64 %213, i64 -1168)
  %214 = add nsw i64 %smin915, 1200
  %smin873 = call i64 @llvm.smin.i64(i64 %indvars.iv871, i64 -1168)
  %215 = shl nsw i64 %polly.indvar703, 5
  %216 = add nsw i64 %smin873, 1199
...
vector.ph916:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert923 = insertelement <4 x i64> poison, i64 %215, i32 0
  %broadcast.splat924 = shufflevector <4 x i64> %broadcast.splatinsert923, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert925 = insertelement <4 x i32> poison, i32 %218, i32 0
...
vector.body914:                                   ; preds = %vector.body914, %vector.ph916
  ...
  %220 = add nuw nsw <4 x i64> %vec.ind921, %broadcast.splat924
  %221 = trunc <4 x i64> %220 to <4 x i32>
  %222 = mul <4 x i32> %broadcast.splat926, %221
  ...
  %232 = icmp eq i64 %index.next918, %214
  br i1 %232, label %polly.loop_exit714, label %vector.body914, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body914, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond878.not = icmp eq i64 %polly.indvar709, %212
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar715, %216
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin930 = call i64 @llvm.smin.i64(i64 %242, i64 -968)
  %243 = add nsw i64 %smin930, 1000
  %smin863 = call i64 @llvm.smin.i64(i64 %indvars.iv861, i64 -968)
  %244 = shl nsw i64 %polly.indvar730, 5
  %245 = add nsw i64 %smin863, 999
...
vector.body929:                                   ; preds = %vector.body929, %vector.ph932
  ...
  %249 = add nuw nsw <4 x i64> %vec.ind939, %broadcast.splat942
  %250 = trunc <4 x i64> %249 to <4 x i32>
  %251 = mul <4 x i32> %broadcast.splat944, %250
  ...
  %261 = icmp eq i64 %index.next936, %243
  br i1 %261, label %polly.loop_exit741, label %vector.body929, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body929, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond868.not = icmp eq i64 %polly.indvar736, %241
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar742, %245
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin948 = call i64 @llvm.smin.i64(i64 %271, i64 -968)
  %272 = add nsw i64 %smin948, 1000
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 -968)
  %273 = shl nsw i64 %polly.indvar756, 5
  %274 = add nsw i64 %smin853, 999
...
vector.body947:                                   ; preds = %vector.body947, %vector.ph950
  ...
  %278 = add nuw nsw <4 x i64> %vec.ind957, %broadcast.splat960
  %279 = trunc <4 x i64> %278 to <4 x i32>
  %280 = mul <4 x i32> %broadcast.splat962, %279
  ...
  %290 = icmp eq i64 %index.next954, %272
  br i1 %290, label %polly.loop_exit767, label %vector.body947, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body947, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond858.not = icmp eq i64 %polly.indvar762, %270
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar768, %274
...
polly.loop_header388.us.3:                        ; preds = %polly.loop_header388.us.3, %polly.loop_exit390.loopexit.us.2
  ...
  br i1 %exitcond815.3.not, label %polly.loop_exit383, label %polly.loop_header388.us.3
...
polly.loop_header546.us.3:                        ; preds = %polly.loop_header546.us.3, %polly.loop_exit548.loopexit.us.2
  ...
  br i1 %exitcond839.3.not, label %polly.loop_exit541, label %polly.loop_header546.us.3
}
