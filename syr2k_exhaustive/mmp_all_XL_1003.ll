; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1003.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1003.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %129 = mul nsw i64 %indvar1410, -96
  %130 = add i64 %101, %129
  %smax1412 = call i64 @llvm.smax.i64(i64 %130, i64 0)
  %131 = mul nuw nsw i64 %indvar1410, 96
  %132 = add i64 %103, %131
  %133 = add i64 %smax1412, %132
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1102, i64 0)
  %134 = add i64 %smax, %indvars.iv1106
  %135 = mul nuw nsw i64 %polly.indvar231, 6
  %.not.not = icmp ugt i64 %135, %polly.indvar209
  %136 = mul nuw nsw i64 %polly.indvar231, 96
  %137 = add nsw i64 %136, %108
  %138 = icmp sgt i64 %137, 0
  %139 = select i1 %138, i64 %137, i64 0
  %140 = add nsw i64 %137, 95
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %149 = mul nsw i64 %polly.indvar231, -96
...
polly.loop_header270:                             ; preds = %polly.loop_header263, %polly.loop_exit280
  ...
  %154 = add i64 %133, %indvar1413
  %smin1415 = call i64 @llvm.smin.i64(i64 %154, i64 15)
  %155 = add nsw i64 %smin1415, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1108, i64 15)
  %156 = add nsw i64 %polly.indvar274, %137
  %polly.loop_guard2811203 = icmp sgt i64 %156, -1
...
polly.loop_header278.preheader:                   ; preds = %polly.loop_header270
  ...
  %min.iters.check1416 = icmp ult i64 %155, 4
...
vector.body1409:                                  ; preds = %vector.body1409, %vector.ph1417
  ...
  %159 = add nuw nsw i64 %index1420, %109
  %160 = add nuw nsw i64 %index1420, %polly.access.mul.Packed_MemRef_call1285
  %161 = getelementptr double, double* %Packed_MemRef_call1, i64 %160
  %162 = bitcast double* %161 to <4 x double>*
  %wide.load1424 = load <4 x double>, <4 x double>* %162, align 8
  %163 = fmul fast <4 x double> %broadcast.splat1426, %wide.load1424
  %164 = getelementptr double, double* %Packed_MemRef_call2, i64 %160
  %165 = bitcast double* %164 to <4 x double>*
  %wide.load1427 = load <4 x double>, <4 x double>* %165, align 8
  %166 = fmul fast <4 x double> %broadcast.splat1429, %wide.load1427
  %167 = shl i64 %159, 3
  %168 = add i64 %167, %158
  %169 = getelementptr i8, i8* %call, i64 %168
  %170 = bitcast i8* %169 to <4 x double>*
  %wide.load1430 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !72, !noalias !74
  ...
  %173 = fadd fast <4 x double> %172, %wide.load1430
  ...
  %175 = icmp eq i64 %index.next1421, %n.vec1419
  br i1 %175, label %middle.block1407, label %vector.body1409, !llvm.loop !84

middle.block1407:                                 ; preds = %vector.body1409
  %cmp.n1423 = icmp eq i64 %155, %n.vec1419
...
vector.body1345:                                  ; preds = %vector.body1345, %vector.ph1349
  ...
  %181 = shl nuw nsw i64 %index1352, 3
  %182 = getelementptr i8, i8* %scevgep406, i64 %181
  %183 = bitcast i8* %182 to <4 x double>*
  %wide.load1356 = load <4 x double>, <4 x double>* %183, align 8, !alias.scope !86, !noalias !88
  %184 = fmul fast <4 x double> %wide.load1356, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %186 = icmp eq i64 %index.next1353, %n.vec1351
  br i1 %186, label %middle.block1343, label %vector.body1345, !llvm.loop !93

middle.block1343:                                 ; preds = %vector.body1345
  %cmp.n1355 = icmp eq i64 %179, %n.vec1351
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %188 = mul nuw nsw i64 %polly.indvar413, 20
  br label %polly.loop_header416

polly.loop_exit418:                               ; preds = %polly.loop_exit441
  %polly.indvar_next414 = add nuw nsw i64 %polly.indvar413, 1
  %exitcond1138.not = icmp eq i64 %polly.indvar_next414, 50
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %190 = udiv i64 %polly.indvar419, 6
  %191 = mul nuw nsw i64 %190, 96
  %192 = sub nsw i64 %189, %191
  %193 = mul nsw i64 %polly.indvar419, -16
  %194 = add i64 %193, %191
  %195 = udiv i64 %polly.indvar419, 6
  %196 = mul nuw nsw i64 %195, 96
  %197 = sub nsw i64 %indvars.iv1123, %196
  %198 = add i64 %indvars.iv1128, %196
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %exitcond1137.not = icmp eq i64 %217, 75
...
polly.loop_exit430:                               ; preds = %polly.loop_header428
  ...
  %exitcond1119.not = icmp eq i64 %polly.indvar_next426, 20
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %indvars.iv1130 = phi i64 [ %indvars.iv.next1131, %polly.loop_exit482 ], [ %198, %polly.loop_exit424 ]
  %indvars.iv1125 = phi i64 [ %indvars.iv.next1126, %polly.loop_exit482 ], [ %197, %polly.loop_exit424 ]
  %polly.indvar442 = phi i64 [ %polly.indvar_next443, %polly.loop_exit482 ], [ %195, %polly.loop_exit424 ]
  %220 = mul nsw i64 %indvar1360, -96
  %221 = add i64 %192, %220
  %smax1362 = call i64 @llvm.smax.i64(i64 %221, i64 0)
  %222 = mul nuw nsw i64 %indvar1360, 96
  %223 = add i64 %194, %222
  %224 = add i64 %smax1362, %223
  %smax1127 = call i64 @llvm.smax.i64(i64 %indvars.iv1125, i64 0)
  %225 = add i64 %smax1127, %indvars.iv1130
  %226 = mul nuw nsw i64 %polly.indvar442, 6
  %.not.not944 = icmp ugt i64 %226, %polly.indvar419
  %227 = mul nuw nsw i64 %polly.indvar442, 96
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_header445.us
  ...
  %exitcond1122.not = icmp eq i64 %polly.indvar_next449.us, 20
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1120.not = icmp eq i64 %polly.indvar_next449, 20
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %240 = mul nsw i64 %polly.indvar442, -96
  %241 = icmp slt i64 %240, -1104
  %242 = select i1 %241, i64 %240, i64 -1104
...
polly.loop_exit489:                               ; preds = %polly.loop_exit497
  ...
  %exitcond1136.not = icmp eq i64 %polly.indvar_next484, 20
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %indvars.iv1132 = phi i64 [ %225, %polly.loop_header480 ], [ %indvars.iv.next1133, %polly.loop_exit497 ]
  %polly.indvar491 = phi i64 [ %239, %polly.loop_header480 ], [ %polly.indvar_next492, %polly.loop_exit497 ]
  %245 = add i64 %224, %indvar1363
  %smin1365 = call i64 @llvm.smin.i64(i64 %245, i64 15)
  %246 = add nsw i64 %smin1365, 1
  %smin1134 = call i64 @llvm.smin.i64(i64 %indvars.iv1132, i64 15)
  %247 = add nsw i64 %polly.indvar491, %228
  %polly.loop_guard4981204 = icmp sgt i64 %247, -1
...
polly.loop_header495.preheader:                   ; preds = %polly.loop_header487
  ...
  %min.iters.check1366 = icmp ult i64 %246, 4
...
vector.body1359:                                  ; preds = %vector.body1359, %vector.ph1367
  ...
  %250 = add nuw nsw i64 %index1370, %200
  %251 = add nuw nsw i64 %index1370, %polly.access.mul.Packed_MemRef_call1309502
  %252 = getelementptr double, double* %Packed_MemRef_call1309, i64 %251
  %253 = bitcast double* %252 to <4 x double>*
  %wide.load1374 = load <4 x double>, <4 x double>* %253, align 8
  %254 = fmul fast <4 x double> %broadcast.splat1376, %wide.load1374
  %255 = getelementptr double, double* %Packed_MemRef_call2311, i64 %251
  %256 = bitcast double* %255 to <4 x double>*
  %wide.load1377 = load <4 x double>, <4 x double>* %256, align 8
  %257 = fmul fast <4 x double> %broadcast.splat1379, %wide.load1377
  %258 = shl i64 %250, 3
  %259 = add i64 %258, %249
  %260 = getelementptr i8, i8* %call, i64 %259
  %261 = bitcast i8* %260 to <4 x double>*
  %wide.load1380 = load <4 x double>, <4 x double>* %261, align 8, !alias.scope !86, !noalias !88
  ...
  %264 = fadd fast <4 x double> %263, %wide.load1380
  ...
  %266 = icmp eq i64 %index.next1371, %n.vec1369
  br i1 %266, label %middle.block1357, label %vector.body1359, !llvm.loop !97

middle.block1357:                                 ; preds = %vector.body1359
  %cmp.n1373 = icmp eq i64 %246, %n.vec1369
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1298 = icmp ult i64 %270, 4
...
vector.body1297:                                  ; preds = %vector.body1297, %vector.ph1299
  ...
  %272 = shl nuw nsw i64 %index1302, 3
  %273 = getelementptr i8, i8* %scevgep623, i64 %272
  %274 = bitcast i8* %273 to <4 x double>*
  %wide.load1306 = load <4 x double>, <4 x double>* %274, align 8, !alias.scope !99, !noalias !101
  %275 = fmul fast <4 x double> %wide.load1306, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %277 = icmp eq i64 %index.next1303, %n.vec1301
  br i1 %277, label %middle.block1295, label %vector.body1297, !llvm.loop !106

middle.block1295:                                 ; preds = %vector.body1297
  %cmp.n1305 = icmp eq i64 %270, %n.vec1301
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %279 = mul nuw nsw i64 %polly.indvar630, 20
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %exitcond1163.not = icmp eq i64 %polly.indvar_next631, 50
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %281 = udiv i64 %polly.indvar636, 6
  %282 = mul nuw nsw i64 %281, 96
  %283 = sub nsw i64 %280, %282
  %284 = mul nsw i64 %polly.indvar636, -16
  %285 = add i64 %284, %282
  %286 = udiv i64 %polly.indvar636, 6
  %287 = mul nuw nsw i64 %286, 96
  %288 = sub nsw i64 %indvars.iv1148, %287
  %289 = add i64 %indvars.iv1153, %287
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %exitcond1162.not = icmp eq i64 %308, 75
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1144.not = icmp eq i64 %polly.indvar_next643, 20
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %indvars.iv1155 = phi i64 [ %indvars.iv.next1156, %polly.loop_exit699 ], [ %289, %polly.loop_exit641 ]
  %indvars.iv1150 = phi i64 [ %indvars.iv.next1151, %polly.loop_exit699 ], [ %288, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit699 ], [ %286, %polly.loop_exit641 ]
  %311 = mul nsw i64 %indvar1310, -96
  %312 = add i64 %283, %311
  %smax1312 = call i64 @llvm.smax.i64(i64 %312, i64 0)
  %313 = mul nuw nsw i64 %indvar1310, 96
  %314 = add i64 %285, %313
  %315 = add i64 %smax1312, %314
  %smax1152 = call i64 @llvm.smax.i64(i64 %indvars.iv1150, i64 0)
  %316 = add i64 %smax1152, %indvars.iv1155
  %317 = mul nuw nsw i64 %polly.indvar659, 6
  %.not.not945 = icmp ugt i64 %317, %polly.indvar636
  %318 = mul nuw nsw i64 %polly.indvar659, 96
...
polly.loop_exit685.us:                            ; preds = %polly.loop_header683.us, %polly.loop_header662.us
  ...
  %exitcond1147.not = icmp eq i64 %polly.indvar_next666.us, 20
...
polly.loop_exit685:                               ; preds = %polly.loop_header683
  ...
  %exitcond1145.not = icmp eq i64 %polly.indvar_next666, 20
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %331 = mul nsw i64 %polly.indvar659, -96
  %332 = icmp slt i64 %331, -1104
  %333 = select i1 %332, i64 %331, i64 -1104
...
polly.loop_exit706:                               ; preds = %polly.loop_exit714
  ...
  %exitcond1161.not = icmp eq i64 %polly.indvar_next701, 20
...
polly.loop_header704:                             ; preds = %polly.loop_header697, %polly.loop_exit714
  ...
  %indvars.iv1157 = phi i64 [ %316, %polly.loop_header697 ], [ %indvars.iv.next1158, %polly.loop_exit714 ]
  %polly.indvar708 = phi i64 [ %330, %polly.loop_header697 ], [ %polly.indvar_next709, %polly.loop_exit714 ]
  %336 = add i64 %315, %indvar1313
  %smin1315 = call i64 @llvm.smin.i64(i64 %336, i64 15)
  %337 = add nsw i64 %smin1315, 1
  %smin1159 = call i64 @llvm.smin.i64(i64 %indvars.iv1157, i64 15)
  %338 = add nsw i64 %polly.indvar708, %319
  %polly.loop_guard7151205 = icmp sgt i64 %338, -1
...
polly.loop_header712.preheader:                   ; preds = %polly.loop_header704
  ...
  %min.iters.check1316 = icmp ult i64 %337, 4
...
vector.body1309:                                  ; preds = %vector.body1309, %vector.ph1317
  ...
  %341 = add nuw nsw i64 %index1320, %291
  %342 = add nuw nsw i64 %index1320, %polly.access.mul.Packed_MemRef_call1526719
  %343 = getelementptr double, double* %Packed_MemRef_call1526, i64 %342
  %344 = bitcast double* %343 to <4 x double>*
  %wide.load1324 = load <4 x double>, <4 x double>* %344, align 8
  %345 = fmul fast <4 x double> %broadcast.splat1326, %wide.load1324
  %346 = getelementptr double, double* %Packed_MemRef_call2528, i64 %342
  %347 = bitcast double* %346 to <4 x double>*
  %wide.load1327 = load <4 x double>, <4 x double>* %347, align 8
  %348 = fmul fast <4 x double> %broadcast.splat1329, %wide.load1327
  %349 = shl i64 %341, 3
  %350 = add i64 %349, %340
  %351 = getelementptr i8, i8* %call, i64 %350
  %352 = bitcast i8* %351 to <4 x double>*
  %wide.load1330 = load <4 x double>, <4 x double>* %352, align 8, !alias.scope !99, !noalias !101
  ...
  %355 = fadd fast <4 x double> %354, %wide.load1330
  ...
  %357 = icmp eq i64 %index.next1321, %n.vec1319
  br i1 %357, label %middle.block1307, label %vector.body1309, !llvm.loop !110

middle.block1307:                                 ; preds = %vector.body1309
  %cmp.n1323 = icmp eq i64 %337, %n.vec1319
...
polly.loop_header870:                             ; preds = %polly.loop_exit878, %polly.loop_header864
  ...
  %smin1236 = call i64 @llvm.smin.i64(i64 %363, i64 -1168)
  %364 = add nsw i64 %smin1236, 1200
  %smin1188 = call i64 @llvm.smin.i64(i64 %indvars.iv1186, i64 -1168)
  %365 = shl nsw i64 %polly.indvar873, 5
  %366 = add nsw i64 %smin1188, 1199
...
vector.ph1237:                                    ; preds = %polly.loop_header876
  %broadcast.splatinsert1244 = insertelement <4 x i64> poison, i64 %365, i32 0
  %broadcast.splat1245 = shufflevector <4 x i64> %broadcast.splatinsert1244, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1246 = insertelement <4 x i32> poison, i32 %368, i32 0
...
vector.body1235:                                  ; preds = %vector.body1235, %vector.ph1237
  ...
  %370 = add nuw nsw <4 x i64> %vec.ind1242, %broadcast.splat1245
  %371 = trunc <4 x i64> %370 to <4 x i32>
  %372 = mul <4 x i32> %broadcast.splat1247, %371
  ...
  %382 = icmp eq i64 %index.next1239, %364
  br i1 %382, label %polly.loop_exit884, label %vector.body1235, !llvm.loop !117

polly.loop_exit884:                               ; preds = %vector.body1235, %polly.loop_header882
  %polly.indvar_next880 = add nuw nsw i64 %polly.indvar879, 1
  %exitcond1193.not = icmp eq i64 %polly.indvar879, %362
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  %exitcond1189.not = icmp eq i64 %polly.indvar885, %366
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %smin1251 = call i64 @llvm.smin.i64(i64 %392, i64 -968)
  %393 = add nsw i64 %smin1251, 1000
  %smin1178 = call i64 @llvm.smin.i64(i64 %indvars.iv1176, i64 -968)
  %394 = shl nsw i64 %polly.indvar900, 5
  %395 = add nsw i64 %smin1178, 999
...
vector.body1250:                                  ; preds = %vector.body1250, %vector.ph1253
  ...
  %399 = add nuw nsw <4 x i64> %vec.ind1260, %broadcast.splat1263
  %400 = trunc <4 x i64> %399 to <4 x i32>
  %401 = mul <4 x i32> %broadcast.splat1265, %400
  ...
  %411 = icmp eq i64 %index.next1257, %393
  br i1 %411, label %polly.loop_exit911, label %vector.body1250, !llvm.loop !120

polly.loop_exit911:                               ; preds = %vector.body1250, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1183.not = icmp eq i64 %polly.indvar906, %391
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %exitcond1179.not = icmp eq i64 %polly.indvar912, %395
...
polly.loop_header923:                             ; preds = %polly.loop_exit931, %polly.loop_header917
  ...
  %smin1269 = call i64 @llvm.smin.i64(i64 %421, i64 -968)
  %422 = add nsw i64 %smin1269, 1000
  %smin1168 = call i64 @llvm.smin.i64(i64 %indvars.iv1166, i64 -968)
  %423 = shl nsw i64 %polly.indvar926, 5
  %424 = add nsw i64 %smin1168, 999
...
vector.body1268:                                  ; preds = %vector.body1268, %vector.ph1271
  ...
  %428 = add nuw nsw <4 x i64> %vec.ind1278, %broadcast.splat1281
  %429 = trunc <4 x i64> %428 to <4 x i32>
  %430 = mul <4 x i32> %broadcast.splat1283, %429
  ...
  %440 = icmp eq i64 %index.next1275, %422
  br i1 %440, label %polly.loop_exit937, label %vector.body1268, !llvm.loop !123

polly.loop_exit937:                               ; preds = %vector.body1268, %polly.loop_header935
  %polly.indvar_next933 = add nuw nsw i64 %polly.indvar932, 1
  %exitcond1173.not = icmp eq i64 %polly.indvar932, %420
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  %exitcond1169.not = icmp eq i64 %polly.indvar938, %424
