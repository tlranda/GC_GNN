; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10535.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10535.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %.inv774 = icmp ult i64 %141, 11
  %142 = mul nsw i64 %polly.indvar357, -128
  %143 = icmp slt i64 %142, -1072
  %144 = select i1 %143, i64 %142, i64 -1072
  %145 = add nsw i64 %144, 1199
  %146 = shl nsw i64 %polly.indvar357, 7
  %.op874 = add nuw i64 %141, 2
  %147 = select i1 %.inv774, i64 %.op874, i64 12
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %155 = mul nsw i64 %polly.indvar370, 100
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %.inv775 = icmp ult i64 %183, 11
  %184 = mul nsw i64 %polly.indvar515, -128
  %185 = icmp slt i64 %184, -1072
  %186 = select i1 %185, i64 %184, i64 -1072
  %187 = add nsw i64 %186, 1199
  %188 = shl nsw i64 %polly.indvar515, 7
  %.op876 = add nuw i64 %183, 2
  %189 = select i1 %.inv775, i64 %.op876, i64 12
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %197 = mul nsw i64 %polly.indvar528, 100
