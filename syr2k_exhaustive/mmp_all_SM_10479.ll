; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10479.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10479.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv797 = phi i64 [ %indvars.iv.next798, %polly.loop_exit207 ], [ 2, %polly.loop_exit193 ]
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %103 = mul nuw nsw i64 %polly.indvar214, 80
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond799 = icmp eq i64 %polly.indvar_next215, %98
  br i1 %exitcond799, label %polly.loop_exit213, label %polly.loop_header211
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv821 = phi i64 [ %indvars.iv.next822, %polly.loop_exit362 ], [ 2, %polly.loop_exit346 ]
  ...
  %132 = mul nsw i64 %polly.indvar357, -100
  %133 = mul nuw nsw i64 %polly.indvar357, 100
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %136 = mul nuw nsw i64 %polly.indvar370, 80
  %137 = add nsw i64 %136, %132
  %138 = icmp sgt i64 %137, 0
  %139 = select i1 %138, i64 %137, i64 0
  %polly.loop_guard377 = icmp slt i64 %139, 100
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond823 = icmp eq i64 %polly.indvar_next371, %131
  br i1 %exitcond823, label %polly.loop_exit369, label %polly.loop_header367
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv845 = phi i64 [ %indvars.iv.next846, %polly.loop_exit520 ], [ 2, %polly.loop_exit504 ]
  ...
  %165 = mul nsw i64 %polly.indvar515, -100
  %166 = mul nuw nsw i64 %polly.indvar515, 100
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %169 = mul nuw nsw i64 %polly.indvar528, 80
  %170 = add nsw i64 %169, %165
  %171 = icmp sgt i64 %170, 0
  %172 = select i1 %171, i64 %170, i64 0
  %polly.loop_guard535 = icmp slt i64 %172, 100
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond847 = icmp eq i64 %polly.indvar_next529, %164
  br i1 %exitcond847, label %polly.loop_exit527, label %polly.loop_header525
