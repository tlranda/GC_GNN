; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4259.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4259.c"
...
vector.body1185:                                  ; preds = %vector.body1185, %vector.ph1187
  ...
  br i1 %57, label %middle.block1183, label %vector.body1185, !llvm.loop !53
...
vector.body1211:                                  ; preds = %vector.body1211, %vector.ph1213
  ...
  br i1 %68, label %middle.block1209, label %vector.body1211, !llvm.loop !55
...
vector.body1223:                                  ; preds = %vector.body1223, %vector.ph1227
  ...
  %wide.load1234 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !61, !noalias !63
  ...
  br i1 %95, label %middle.block1221, label %vector.body1223, !llvm.loop !67
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond995.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !68
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin987 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -984)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond993.not = icmp eq i64 %polly.indvar_next209, 63
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin985 = call i64 @llvm.smin.i64(i64 %indvars.iv979, i64 15)
...
polly.loop_exit248:                               ; preds = %polly.loop_exit255.loopexit.us, %polly.loop_header217.split, %polly.loop_header246.preheader
  ...
  %exitcond989.not = icmp eq i64 %polly.indvar_next221, 16
...
polly.start279:                                   ; preds = %kernel_syr2k.exit
  %malloccall281 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1201
  ...
  %wide.load1208 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %125, label %middle.block1195, label %vector.body1197, !llvm.loop !78
...
polly.loop_header371:                             ; preds = %polly.loop_header371.preheader, %polly.loop_header371
  ...
  br i1 %exitcond1021.not, label %polly.loop_exit373, label %polly.loop_header371, !llvm.loop !79
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %127 = shl nsw i64 %polly.indvar384, 4
...
polly.loop_exit389:                               ; preds = %polly.loop_exit395
  ...
  %indvars.iv.next1002 = add nuw nsw i64 %indvars.iv1001, 16
  %indvars.iv.next1017 = add nuw nsw i64 %indvars.iv1016, 1
  %exitcond1020.not = icmp eq i64 %polly.indvar_next385, 75
...
polly.loop_header387:                             ; preds = %polly.loop_exit395, %polly.loop_header381
  ...
  %smin1013 = call i64 @llvm.smin.i64(i64 %indvars.iv997, i64 -984)
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1019.not = icmp eq i64 %polly.indvar_next391, 63
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %130 = shl nsw i64 %polly.indvar396, 4
...
polly.loop_header399:                             ; preds = %polly.loop_exit436, %polly.loop_header393
  ...
  %smin1011 = call i64 @llvm.smin.i64(i64 %indvars.iv1005, i64 15)
...
polly.loop_exit436:                               ; preds = %polly.loop_exit443.loopexit.us, %polly.loop_header399.split, %polly.loop_header434.preheader
  ...
  %exitcond1015.not = icmp eq i64 %polly.indvar_next403, 16
...
polly.start467:                                   ; preds = %init_array.exit
  %malloccall469 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1175
  ...
  %wide.load1182 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !82, !noalias !84
  ...
  store <4 x double> %153, <4 x double>* %154, align 8, !alias.scope !82, !noalias !84
  %index.next1179 = add i64 %index1178, 4
  %155 = icmp eq i64 %index.next1179, %n.vec1177
  br i1 %155, label %middle.block1171, label %vector.body1173, !llvm.loop !88
...
polly.loop_header559:                             ; preds = %polly.loop_header559.preheader, %polly.loop_header559
  ...
  br i1 %exitcond1047.not, label %polly.loop_exit561, label %polly.loop_header559, !llvm.loop !89
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %157 = shl nsw i64 %polly.indvar572, 4
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next1028 = add nuw nsw i64 %indvars.iv1027, 16
  %indvars.iv.next1043 = add nuw nsw i64 %indvars.iv1042, 1
  %exitcond1046.not = icmp eq i64 %polly.indvar_next573, 75
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %smin1039 = call i64 @llvm.smin.i64(i64 %indvars.iv1023, i64 -984)
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar_next579, 63
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_header575
  ...
  %160 = shl nsw i64 %polly.indvar584, 4
...
polly.loop_header587:                             ; preds = %polly.loop_exit624, %polly.loop_header581
  ...
  %smin1037 = call i64 @llvm.smin.i64(i64 %indvars.iv1031, i64 15)
...
polly.loop_exit624:                               ; preds = %polly.loop_exit631.loopexit.us, %polly.loop_header587.split, %polly.loop_header622.preheader
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next591, 16
...
vector.body1112:                                  ; preds = %vector.body1112, %vector.ph1113
  ...
  store <4 x double> %193, <4 x double>* %198, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %199, label %polly.loop_exit799, label %vector.body1112, !llvm.loop !97
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  br i1 %exitcond1072.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !98
...
vector.body1126:                                  ; preds = %vector.body1126, %vector.ph1129
  ...
  store <4 x double> %222, <4 x double>* %227, align 8, !alias.scope !96, !noalias !99
  ...
  br i1 %228, label %polly.loop_exit826, label %vector.body1126, !llvm.loop !100
...
polly.loop_header824:                             ; preds = %polly.loop_header818, %polly.loop_header824
  ...
  br i1 %exitcond1062.not, label %polly.loop_exit826, label %polly.loop_header824, !llvm.loop !101
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1147
  ...
  store <4 x double> %251, <4 x double>* %256, align 8, !alias.scope !95, !noalias !102
  ...
  br i1 %257, label %polly.loop_exit852, label %vector.body1144, !llvm.loop !103
...
polly.loop_header850:                             ; preds = %polly.loop_header844, %polly.loop_header850
  ...
  br i1 %exitcond1052.not, label %polly.loop_exit852, label %polly.loop_header850, !llvm.loop !104
}
