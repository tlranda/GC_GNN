; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3046.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3046.c"
...
polly.loop_header263.preheader.us:                ; preds = %polly.loop_header255.us
  %142 = add nsw i64 %polly.indvar259.us, %122
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %171 = udiv i64 %indvars.iv1031, 5
  %172 = mul nuw nsw i64 %171, 20
  %173 = add i64 %indvars.iv1029, %172
  %174 = sub nsw i64 %indvars.iv1036, %172
  %175 = mul nuw nsw i64 %polly.indvar400, 13
  %176 = trunc i64 %polly.indvar400 to i8
  %pexp.p_div_q403.lhs.trunc = add i8 %176, 4
  %pexp.p_div_q403886 = udiv i8 %pexp.p_div_q403.lhs.trunc, 5
  %pexp.p_div_q403.zext = zext i8 %pexp.p_div_q403886 to i64
  %177 = sub nsw i64 %175, %pexp.p_div_q403.zext
  %178 = mul nsw i64 %polly.indvar400, -256
  %179 = shl nsw i64 %polly.indvar400, 8
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039, %polly.loop_exit445 ], [ %174, %polly.loop_header397 ]
  %indvars.iv1033 = phi i64 [ %indvars.iv.next1034, %polly.loop_exit445 ], [ %173, %polly.loop_header397 ]
  ...
  %181 = mul nsw i64 %polly.indvar407, 20
  %182 = add nsw i64 %181, %178
  %183 = add nsw i64 %182, -1
  %.inv883 = icmp sgt i64 %182, 255
  %184 = select i1 %.inv883, i64 255, i64 %183
...
polly.loop_header458.preheader.us:                ; preds = %polly.loop_header450.us
  %201 = add nsw i64 %polly.indvar454.us, %181
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %230 = udiv i64 %indvars.iv1054, 5
  %231 = mul nuw nsw i64 %230, 20
  %232 = add i64 %indvars.iv1052, %231
  %233 = sub nsw i64 %indvars.iv1059, %231
  %234 = mul nuw nsw i64 %polly.indvar595, 13
  %235 = trunc i64 %polly.indvar595 to i8
  %pexp.p_div_q598.lhs.trunc = add i8 %235, 4
  %pexp.p_div_q598885 = udiv i8 %pexp.p_div_q598.lhs.trunc, 5
  %pexp.p_div_q598.zext = zext i8 %pexp.p_div_q598885 to i64
  %236 = sub nsw i64 %234, %pexp.p_div_q598.zext
  %237 = mul nsw i64 %polly.indvar595, -256
  %238 = shl nsw i64 %polly.indvar595, 8
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  %indvars.iv1061 = phi i64 [ %indvars.iv.next1062, %polly.loop_exit640 ], [ %233, %polly.loop_header592 ]
  %indvars.iv1056 = phi i64 [ %indvars.iv.next1057, %polly.loop_exit640 ], [ %232, %polly.loop_header592 ]
  ...
  %240 = mul nsw i64 %polly.indvar602, 20
  %241 = add nsw i64 %240, %237
  %242 = add nsw i64 %241, -1
  %.inv884 = icmp sgt i64 %241, 255
  %243 = select i1 %.inv884, i64 255, i64 %242
...
polly.loop_header653.preheader.us:                ; preds = %polly.loop_header645.us
  %260 = add nsw i64 %polly.indvar649.us, %240
