; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5861.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5861.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin860 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -968)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar_next203, 32
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %105 = mul nsw i64 %polly.indvar230, -32
  %polly.loop_guard952 = icmp sgt i64 %105, -1200
  %106 = shl nsw i64 %polly.indvar230, 5
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv870, i64 -968)
  %128 = add nsw i64 %smin887, 1000
  %129 = shl nsw i64 %polly.indvar375, 5
...
polly.loop_exit380:                               ; preds = %polly.loop_exit402
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar_next376, 32
...
polly.loop_exit386:                               ; preds = %polly.loop_exit392
  ...
  %132 = shl nsw i64 %polly.indvar381, 2
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %136 = mul nsw i64 %polly.indvar403, -32
  %polly.loop_guard416953 = icmp sgt i64 %136, -1200
  %137 = shl nsw i64 %polly.indvar403, 5
...
polly.start445:                                   ; preds = %init_array.exit
  %malloccall447 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header547:                             ; preds = %polly.loop_header547.preheader, %polly.loop_exit555
  ...
  %smin914 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 -968)
  %159 = add nsw i64 %smin914, 1000
  %160 = shl nsw i64 %polly.indvar550, 5
...
polly.loop_exit555:                               ; preds = %polly.loop_exit577
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar_next551, 32
...
polly.loop_exit561:                               ; preds = %polly.loop_exit567
  ...
  %163 = shl nsw i64 %polly.indvar556, 2
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_exit561
  ...
  %167 = mul nsw i64 %polly.indvar578, -32
  %polly.loop_guard591954 = icmp sgt i64 %167, -1200
  %168 = shl nsw i64 %polly.indvar578, 5
