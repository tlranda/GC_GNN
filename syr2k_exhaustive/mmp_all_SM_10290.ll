; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10290.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10290.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %138 = udiv i64 %indvars.iv820, 25
  %139 = sub nsw i64 %indvars.iv818, %138
  %smin822 = call i64 @llvm.smin.i64(i64 %139, i64 21)
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %179 = udiv i64 %indvars.iv844, 25
  %180 = sub nsw i64 %indvars.iv842, %179
  %smin846 = call i64 @llvm.smin.i64(i64 %180, i64 21)
