; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2140.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2140.c"
...
polly.loop_exit432:                               ; preds = %polly.loop_exit438
  ...
  %exitcond1086.not = icmp eq i64 %polly.indvar_next428, 13
...
polly.loop_header632:                             ; preds = %polly.loop_exit640, %polly.loop_header626
  ...
  %smin1108 = call i64 @llvm.smin.i64(i64 %indvars.iv1092, i64 -920)
  %198 = add nsw i64 %smin1108, 1000
  %199 = mul nuw nsw i64 %polly.indvar635, 80
...
polly.loop_exit640:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1117.not = icmp eq i64 %polly.indvar_next636, 13
