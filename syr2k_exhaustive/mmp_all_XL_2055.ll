; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2055.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2055.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %102 = shl nuw nsw i64 %polly.indvar225, 7
  %103 = add i64 %97, %102
  %smax1324 = call i64 @llvm.smax.i64(i64 %103, i64 0)
  %104 = mul nsw i64 %polly.indvar225, -128
  %105 = add i64 %98, %104
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %114, i64 127)
  %115 = add nsw i64 %smin1327, 1
  %smin1028 = call i64 @llvm.smin.i64(i64 %indvars.iv1024, i64 127)
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %155 = shl nuw nsw i64 %polly.indvar424, 7
  %156 = add i64 %150, %155
  %smax1276 = call i64 @llvm.smax.i64(i64 %156, i64 0)
  %157 = mul nsw i64 %polly.indvar424, -128
  %158 = add i64 %151, %157
  %159 = add i64 %smax1276, %158
  %160 = shl nsw i64 %polly.indvar424, 7
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %167, i64 127)
  %168 = add nsw i64 %smin1279, 1
  %smin1054 = call i64 @llvm.smin.i64(i64 %indvars.iv1049, i64 127)
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %208 = shl nuw nsw i64 %polly.indvar629, 7
  %209 = add i64 %203, %208
  %smax1228 = call i64 @llvm.smax.i64(i64 %209, i64 0)
  %210 = mul nsw i64 %polly.indvar629, -128
  %211 = add i64 %204, %210
  %212 = add i64 %smax1228, %211
  %213 = shl nsw i64 %polly.indvar629, 7
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %220, i64 127)
