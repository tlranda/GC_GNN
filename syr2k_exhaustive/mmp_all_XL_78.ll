; ModuleID = 'syr2k_exhaustive/mmp_all_XL_78.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_78.c"
...
polly.start304:                                   ; preds = %kernel_syr2k.exit
  ...
  %malloccall308 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #8
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit416
  ...
  %141 = mul nuw nsw i64 %polly.indvar411, 80
...
polly.start514:                                   ; preds = %init_array.exit
  %malloccall516 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #8
  %malloccall518 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #8
...
polly.loop_header618:                             ; preds = %polly.loop_header618.preheader, %polly.loop_exit626
  ...
  %184 = mul nuw nsw i64 %polly.indvar621, 80
