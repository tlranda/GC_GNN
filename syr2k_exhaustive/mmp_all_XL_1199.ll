; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1199.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1199.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit259
  ...
  %exitcond1082.not = icmp eq i64 %112, 300
...
polly.loop_header257.preheader:                   ; preds = %polly.loop_exit246, %polly.loop_exit246.us, %polly.loop_header222.split
  ...
  %polly.loop_guard267 = icmp slt i64 %129, 100
...
polly.loop_header264.us:                          ; preds = %polly.loop_header257.us, %polly.loop_exit274.us
  ...
  %130 = add i64 %118, %indvar1374
  %smin1376 = call i64 @llvm.smin.i64(i64 %130, i64 3)
  %131 = add nsw i64 %smin1376, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1078, i64 3)
  %132 = add nsw i64 %polly.indvar268.us, %122
  %polly.loop_guard275.us1167 = icmp sgt i64 %132, -1
...
vector.body1370:                                  ; preds = %vector.body1370, %vector.ph1378
  ...
  %138 = add nuw nsw i64 %index1381, %107
  %139 = add nuw nsw i64 %index1381, %polly.access.mul.Packed_MemRef_call1279.us
  %140 = getelementptr double, double* %Packed_MemRef_call1, i64 %139
  %141 = bitcast double* %140 to <4 x double>*
  %wide.load1385 = load <4 x double>, <4 x double>* %141, align 8
  %142 = fmul fast <4 x double> %broadcast.splat1387, %wide.load1385
  %143 = getelementptr double, double* %Packed_MemRef_call2, i64 %139
  %144 = bitcast double* %143 to <4 x double>*
  %wide.load1388 = load <4 x double>, <4 x double>* %144, align 8
  %145 = fmul fast <4 x double> %broadcast.splat1390, %wide.load1388
  %146 = shl i64 %138, 3
  %147 = add i64 %146, %137
  %148 = getelementptr i8, i8* %call, i64 %147
  %149 = bitcast i8* %148 to <4 x double>*
  %wide.load1391 = load <4 x double>, <4 x double>* %149, align 8, !alias.scope !72, !noalias !74
  ...
  %152 = fadd fast <4 x double> %151, %wide.load1391
  ...
  %154 = icmp eq i64 %index.next1382, %n.vec1380
  br i1 %154, label %middle.block1368, label %vector.body1370, !llvm.loop !85
...
vector.body1306:                                  ; preds = %vector.body1306, %vector.ph1310
  ...
  %158 = shl nuw nsw i64 %index1313, 3
  %159 = getelementptr i8, i8* %scevgep400, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load1317 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !86, !noalias !88
  %161 = fmul fast <4 x double> %wide.load1317, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next1314, %n.vec1312
  br i1 %163, label %middle.block1304, label %vector.body1306, !llvm.loop !93

middle.block1304:                                 ; preds = %vector.body1306
  %cmp.n1316 = icmp eq i64 %156, %n.vec1312
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit429
  ...
  %166 = udiv i64 %polly.indvar407, 25
  %167 = mul nuw nsw i64 %166, 100
  %168 = sub nsw i64 %165, %167
  %169 = mul nsw i64 %polly.indvar407, -4
  %170 = add i64 %169, %167
  %171 = udiv i64 %polly.indvar407, 25
  %172 = mul nuw nsw i64 %171, 100
  %173 = sub nsw i64 %indvars.iv1092, %172
  %174 = add i64 %indvars.iv1097, %172
...
polly.loop_header427:                             ; preds = %polly.loop_exit470, %polly.loop_exit412
  ...
  %indvars.iv1099 = phi i64 [ %indvars.iv.next1100, %polly.loop_exit470 ], [ %174, %polly.loop_exit412 ]
  %indvars.iv1094 = phi i64 [ %indvars.iv.next1095, %polly.loop_exit470 ], [ %173, %polly.loop_exit412 ]
  %polly.indvar430 = phi i64 [ %polly.indvar_next431, %polly.loop_exit470 ], [ %171, %polly.loop_exit412 ]
  %182 = mul nsw i64 %indvar1321, -100
  %183 = add i64 %168, %182
  %smax1323 = call i64 @llvm.smax.i64(i64 %183, i64 0)
  %184 = mul nuw nsw i64 %indvar1321, 100
  %185 = add i64 %170, %184
  %186 = add i64 %smax1323, %185
  %smax1096 = call i64 @llvm.smax.i64(i64 %indvars.iv1094, i64 0)
  %187 = add i64 %smax1096, %indvars.iv1099
  %188 = mul nuw nsw i64 %polly.indvar430, 25
  %.not.not926 = icmp ugt i64 %188, %polly.indvar407
  %189 = mul nuw nsw i64 %polly.indvar430, 100
  %190 = add nsw i64 %189, %176
  %191 = icmp sgt i64 %190, 0
  %192 = select i1 %191, i64 %190, i64 0
  %193 = add nsw i64 %190, 99
...
polly.loop_exit470:                               ; preds = %polly.loop_exit477.loopexit.us, %polly.loop_header468.preheader
  ...
  %polly.loop_cond432 = icmp ult i64 %polly.indvar430, 11
...
polly.loop_header468.preheader:                   ; preds = %polly.loop_exit456, %polly.loop_exit456.us, %polly.loop_header427.split
  ...
  %polly.loop_guard478 = icmp slt i64 %197, 100
...
polly.loop_header475.us:                          ; preds = %polly.loop_header468.us, %polly.loop_exit485.us
  ...
  %indvars.iv1101 = phi i64 [ %187, %polly.loop_header468.us ], [ %indvars.iv.next1102, %polly.loop_exit485.us ]
  %polly.indvar479.us = phi i64 [ %197, %polly.loop_header468.us ], [ %polly.indvar_next480.us, %polly.loop_exit485.us ]
  %198 = add i64 %186, %indvar1324
  %smin1326 = call i64 @llvm.smin.i64(i64 %198, i64 3)
  %199 = add nsw i64 %smin1326, 1
  %smin1103 = call i64 @llvm.smin.i64(i64 %indvars.iv1101, i64 3)
  %200 = add nsw i64 %polly.indvar479.us, %190
  %polly.loop_guard486.us1168 = icmp sgt i64 %200, -1
...
polly.loop_header483.preheader.us:                ; preds = %polly.loop_header475.us
  ...
  %min.iters.check1327 = icmp ult i64 %199, 4
...
vector.body1320:                                  ; preds = %vector.body1320, %vector.ph1328
  ...
  %206 = add nuw nsw i64 %index1331, %175
  %207 = add nuw nsw i64 %index1331, %polly.access.mul.Packed_MemRef_call1303490.us
  %208 = getelementptr double, double* %Packed_MemRef_call1303, i64 %207
  %209 = bitcast double* %208 to <4 x double>*
  %wide.load1335 = load <4 x double>, <4 x double>* %209, align 8
  %210 = fmul fast <4 x double> %broadcast.splat1337, %wide.load1335
  %211 = getelementptr double, double* %Packed_MemRef_call2305, i64 %207
  %212 = bitcast double* %211 to <4 x double>*
  %wide.load1338 = load <4 x double>, <4 x double>* %212, align 8
  %213 = fmul fast <4 x double> %broadcast.splat1340, %wide.load1338
  %214 = shl i64 %206, 3
  %215 = add i64 %214, %205
  %216 = getelementptr i8, i8* %call, i64 %215
  %217 = bitcast i8* %216 to <4 x double>*
  %wide.load1341 = load <4 x double>, <4 x double>* %217, align 8, !alias.scope !86, !noalias !88
  ...
  %220 = fadd fast <4 x double> %219, %wide.load1341
  ...
  %222 = icmp eq i64 %index.next1332, %n.vec1330
  br i1 %222, label %middle.block1318, label %vector.body1320, !llvm.loop !98

middle.block1318:                                 ; preds = %vector.body1320
  %cmp.n1334 = icmp eq i64 %199, %n.vec1330
...
polly.loop_header599:                             ; preds = %polly.loop_exit607, %polly.start511
  ...
  %min.iters.check1259 = icmp ult i64 %224, 4
...
vector.body1258:                                  ; preds = %vector.body1258, %vector.ph1260
  ...
  %226 = shl nuw nsw i64 %index1263, 3
  %227 = getelementptr i8, i8* %scevgep611, i64 %226
  %228 = bitcast i8* %227 to <4 x double>*
  %wide.load1267 = load <4 x double>, <4 x double>* %228, align 8, !alias.scope !99, !noalias !101
  %229 = fmul fast <4 x double> %wide.load1267, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %231 = icmp eq i64 %index.next1264, %n.vec1262
  br i1 %231, label %middle.block1256, label %vector.body1258, !llvm.loop !106

middle.block1256:                                 ; preds = %vector.body1258
  %cmp.n1266 = icmp eq i64 %224, %n.vec1262
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %234 = udiv i64 %polly.indvar618, 25
  %235 = mul nuw nsw i64 %234, 100
  %236 = sub nsw i64 %233, %235
  %237 = mul nsw i64 %polly.indvar618, -4
  %238 = add i64 %237, %235
  %239 = udiv i64 %polly.indvar618, 25
  %240 = mul nuw nsw i64 %239, 100
  %241 = sub nsw i64 %indvars.iv1116, %240
  %242 = add i64 %indvars.iv1121, %240
...
polly.loop_header638:                             ; preds = %polly.loop_exit681, %polly.loop_exit623
  ...
  %indvars.iv1123 = phi i64 [ %indvars.iv.next1124, %polly.loop_exit681 ], [ %242, %polly.loop_exit623 ]
  %indvars.iv1118 = phi i64 [ %indvars.iv.next1119, %polly.loop_exit681 ], [ %241, %polly.loop_exit623 ]
  %polly.indvar641 = phi i64 [ %polly.indvar_next642, %polly.loop_exit681 ], [ %239, %polly.loop_exit623 ]
  %250 = mul nsw i64 %indvar1271, -100
  %251 = add i64 %236, %250
  %smax1273 = call i64 @llvm.smax.i64(i64 %251, i64 0)
  %252 = mul nuw nsw i64 %indvar1271, 100
  %253 = add i64 %238, %252
  %254 = add i64 %smax1273, %253
  %smax1120 = call i64 @llvm.smax.i64(i64 %indvars.iv1118, i64 0)
  %255 = add i64 %smax1120, %indvars.iv1123
  %256 = mul nuw nsw i64 %polly.indvar641, 25
  %.not.not927 = icmp ugt i64 %256, %polly.indvar618
  %257 = mul nuw nsw i64 %polly.indvar641, 100
  %258 = add nsw i64 %257, %244
  %259 = icmp sgt i64 %258, 0
  %260 = select i1 %259, i64 %258, i64 0
  %261 = add nsw i64 %258, 99
...
polly.loop_exit681:                               ; preds = %polly.loop_exit688.loopexit.us, %polly.loop_header679.preheader
  ...
  %polly.loop_cond643 = icmp ult i64 %polly.indvar641, 11
...
polly.loop_header679.preheader:                   ; preds = %polly.loop_exit667, %polly.loop_exit667.us, %polly.loop_header638.split
  ...
  %polly.loop_guard689 = icmp slt i64 %265, 100
...
polly.loop_header686.us:                          ; preds = %polly.loop_header679.us, %polly.loop_exit696.us
  ...
  %indvars.iv1125 = phi i64 [ %255, %polly.loop_header679.us ], [ %indvars.iv.next1126, %polly.loop_exit696.us ]
  %polly.indvar690.us = phi i64 [ %265, %polly.loop_header679.us ], [ %polly.indvar_next691.us, %polly.loop_exit696.us ]
  %266 = add i64 %254, %indvar1274
  %smin1276 = call i64 @llvm.smin.i64(i64 %266, i64 3)
  %267 = add nsw i64 %smin1276, 1
  %smin1127 = call i64 @llvm.smin.i64(i64 %indvars.iv1125, i64 3)
  %268 = add nsw i64 %polly.indvar690.us, %258
  %polly.loop_guard697.us1169 = icmp sgt i64 %268, -1
...
polly.loop_header694.preheader.us:                ; preds = %polly.loop_header686.us
  ...
  %min.iters.check1277 = icmp ult i64 %267, 4
...
vector.body1270:                                  ; preds = %vector.body1270, %vector.ph1278
  ...
  %274 = add nuw nsw i64 %index1281, %243
  %275 = add nuw nsw i64 %index1281, %polly.access.mul.Packed_MemRef_call1514701.us
  %276 = getelementptr double, double* %Packed_MemRef_call1514, i64 %275
  %277 = bitcast double* %276 to <4 x double>*
  %wide.load1285 = load <4 x double>, <4 x double>* %277, align 8
  %278 = fmul fast <4 x double> %broadcast.splat1287, %wide.load1285
  %279 = getelementptr double, double* %Packed_MemRef_call2516, i64 %275
  %280 = bitcast double* %279 to <4 x double>*
  %wide.load1288 = load <4 x double>, <4 x double>* %280, align 8
  %281 = fmul fast <4 x double> %broadcast.splat1290, %wide.load1288
  %282 = shl i64 %274, 3
  %283 = add i64 %282, %273
  %284 = getelementptr i8, i8* %call, i64 %283
  %285 = bitcast i8* %284 to <4 x double>*
  %wide.load1291 = load <4 x double>, <4 x double>* %285, align 8, !alias.scope !99, !noalias !101
  ...
  %288 = fadd fast <4 x double> %287, %wide.load1291
  ...
  %290 = icmp eq i64 %index.next1282, %n.vec1280
  br i1 %290, label %middle.block1268, label %vector.body1270, !llvm.loop !111

middle.block1268:                                 ; preds = %vector.body1270
  %cmp.n1284 = icmp eq i64 %267, %n.vec1280
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %smin1197 = call i64 @llvm.smin.i64(i64 %294, i64 -1168)
  %295 = add nsw i64 %smin1197, 1200
  %smin1155 = call i64 @llvm.smin.i64(i64 %indvars.iv1153, i64 -1168)
  %296 = shl nsw i64 %polly.indvar855, 5
  %297 = add nsw i64 %smin1155, 1199
...
vector.ph1198:                                    ; preds = %polly.loop_header858
  %broadcast.splatinsert1205 = insertelement <4 x i64> poison, i64 %296, i32 0
  %broadcast.splat1206 = shufflevector <4 x i64> %broadcast.splatinsert1205, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1207 = insertelement <4 x i32> poison, i32 %299, i32 0
...
vector.body1196:                                  ; preds = %vector.body1196, %vector.ph1198
  ...
  %301 = add nuw nsw <4 x i64> %vec.ind1203, %broadcast.splat1206
  %302 = trunc <4 x i64> %301 to <4 x i32>
  %303 = mul <4 x i32> %broadcast.splat1208, %302
  ...
  %313 = icmp eq i64 %index.next1200, %295
  br i1 %313, label %polly.loop_exit866, label %vector.body1196, !llvm.loop !117

polly.loop_exit866:                               ; preds = %vector.body1196, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1160.not = icmp eq i64 %polly.indvar861, %293
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1156.not = icmp eq i64 %polly.indvar867, %297
...
polly.loop_header879:                             ; preds = %polly.loop_exit887, %polly.loop_header873
  ...
  %smin1212 = call i64 @llvm.smin.i64(i64 %323, i64 -968)
  %324 = add nsw i64 %smin1212, 1000
  %smin1145 = call i64 @llvm.smin.i64(i64 %indvars.iv1143, i64 -968)
  %325 = shl nsw i64 %polly.indvar882, 5
  %326 = add nsw i64 %smin1145, 999
...
vector.body1211:                                  ; preds = %vector.body1211, %vector.ph1214
  ...
  %330 = add nuw nsw <4 x i64> %vec.ind1221, %broadcast.splat1224
  %331 = trunc <4 x i64> %330 to <4 x i32>
  %332 = mul <4 x i32> %broadcast.splat1226, %331
  ...
  %342 = icmp eq i64 %index.next1218, %324
  br i1 %342, label %polly.loop_exit893, label %vector.body1211, !llvm.loop !120

polly.loop_exit893:                               ; preds = %vector.body1211, %polly.loop_header891
  %polly.indvar_next889 = add nuw nsw i64 %polly.indvar888, 1
  %exitcond1150.not = icmp eq i64 %polly.indvar888, %322
...
polly.loop_header891:                             ; preds = %polly.loop_header885, %polly.loop_header891
  ...
  %exitcond1146.not = icmp eq i64 %polly.indvar894, %326
...
polly.loop_header905:                             ; preds = %polly.loop_exit913, %polly.loop_header899
  ...
  %smin1230 = call i64 @llvm.smin.i64(i64 %352, i64 -968)
  %353 = add nsw i64 %smin1230, 1000
  %smin1135 = call i64 @llvm.smin.i64(i64 %indvars.iv1133, i64 -968)
  %354 = shl nsw i64 %polly.indvar908, 5
  %355 = add nsw i64 %smin1135, 999
...
vector.body1229:                                  ; preds = %vector.body1229, %vector.ph1232
  ...
  %359 = add nuw nsw <4 x i64> %vec.ind1239, %broadcast.splat1242
  %360 = trunc <4 x i64> %359 to <4 x i32>
  %361 = mul <4 x i32> %broadcast.splat1244, %360
  ...
  %371 = icmp eq i64 %index.next1236, %353
  br i1 %371, label %polly.loop_exit919, label %vector.body1229, !llvm.loop !123

polly.loop_exit919:                               ; preds = %vector.body1229, %polly.loop_header917
  %polly.indvar_next915 = add nuw nsw i64 %polly.indvar914, 1
  %exitcond1140.not = icmp eq i64 %polly.indvar914, %351
...
polly.loop_header917:                             ; preds = %polly.loop_header911, %polly.loop_header917
  ...
  %exitcond1136.not = icmp eq i64 %polly.indvar920, %355
