; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6379.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6379.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin870 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -920)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar_next203, 13
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %indvars.iv858 = phi i64 [ %indvars.iv.next859, %polly.loop_exit229 ], [ 2, %polly.loop_header199 ]
  ...
  %99 = udiv i64 %indvars.iv858, 3
  %100 = mul nuw nsw i64 %99, 96
  %101 = add i64 %indvars.iv856, %100
  %102 = sub nsw i64 %indvars.iv862, %100
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %106 = add nuw nsw i64 %polly.indvar208, 2
  %pexp.p_div_q = udiv i64 %106, 3
  %107 = sub nsw i64 %105, %pexp.p_div_q
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %indvars.iv.next863 = add nuw nsw i64 %indvars.iv862, 32
  %exitcond872.not = icmp eq i64 %polly.indvar_next209, 5
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %111 = mul nsw i64 %polly.indvar230, 96
  %112 = sub nsw i64 %103, %111
  %113 = icmp sgt i64 %112, 0
  %114 = select i1 %113, i64 %112, i64 0
  %115 = mul nsw i64 %polly.indvar230, -96
  %116 = icmp slt i64 %115, -1104
  %117 = select i1 %116, i64 %115, i64 -1104
...
polly.loop_header239:                             ; preds = %polly.loop_header233, %polly.loop_exit248
  ...
  %smin868 = call i64 @llvm.smin.i64(i64 %indvars.iv866, i64 255)
  %121 = add i64 %polly.indvar242, %111
  %122 = add i64 %121, %104
...
polly.loop_header246:                             ; preds = %polly.loop_header246.preheader, %polly.loop_header246
  ...
  %126 = add nuw nsw i64 %polly.indvar250, %103
...
polly.start272:                                   ; preds = %kernel_syr2k.exit
  %malloccall274 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %smin898 = call i64 @llvm.smin.i64(i64 %indvars.iv879, i64 -920)
  %140 = add nsw i64 %smin898, 1000
  %141 = mul nuw nsw i64 %polly.indvar377, 80
  br label %polly.loop_header380

polly.loop_exit382:                               ; preds = %polly.loop_exit405
  %polly.indvar_next378 = add nuw nsw i64 %polly.indvar377, 1
  %indvars.iv.next880 = add nsw i64 %indvars.iv879, -80
  %exitcond901.not = icmp eq i64 %polly.indvar_next378, 13
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit405 ], [ 2, %polly.loop_header374 ]
  ...
  %142 = udiv i64 %indvars.iv885, 3
  %143 = mul nuw nsw i64 %142, 96
  %144 = add i64 %indvars.iv883, %143
  %145 = sub nsw i64 %indvars.iv890, %143
  %146 = shl nsw i64 %polly.indvar383, 8
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %147 = mul nsw i64 %polly.indvar383, -256
  %148 = mul nuw nsw i64 %polly.indvar383, 3
  %149 = add nuw nsw i64 %polly.indvar383, 2
  %pexp.p_div_q402 = udiv i64 %149, 3
  %150 = sub nsw i64 %148, %pexp.p_div_q402
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit411
  %polly.indvar_next384 = add nuw nsw i64 %polly.indvar383, 1
  %indvars.iv.next877 = add nsw i64 %indvars.iv876, -256
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar_next384, 5
...
polly.loop_header392:                             ; preds = %polly.loop_header392, %polly.loop_header386
  ...
  %152 = add nuw nsw i64 %polly.indvar395, %146
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit411 ], [ %145, %polly.loop_exit388 ]
  %indvars.iv887 = phi i64 [ %indvars.iv.next888, %polly.loop_exit411 ], [ %144, %polly.loop_exit388 ]
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418, %polly.loop_header403
  ...
  %indvars.iv.next888 = add i64 %indvars.iv887, -96
  %indvars.iv.next893 = add i64 %indvars.iv892, 96
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  ...
  %smin896 = call i64 @llvm.smin.i64(i64 %indvars.iv894, i64 255)
  %164 = add i64 %polly.indvar420, %154
  %165 = add i64 %164, %147
...
polly.loop_header424:                             ; preds = %polly.loop_header424.preheader, %polly.loop_header424
  ...
  %169 = add nuw nsw i64 %polly.indvar428, %146
...
polly.start450:                                   ; preds = %init_array.exit
  %malloccall452 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %smin926 = call i64 @llvm.smin.i64(i64 %indvars.iv907, i64 -920)
  %183 = add nsw i64 %smin926, 1000
  %184 = mul nuw nsw i64 %polly.indvar555, 80
...
polly.loop_exit560:                               ; preds = %polly.loop_exit583
  ...
  %exitcond929.not = icmp eq i64 %polly.indvar_next556, 13
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %indvars.iv913 = phi i64 [ %indvars.iv.next914, %polly.loop_exit583 ], [ 2, %polly.loop_header552 ]
  ...
  %185 = udiv i64 %indvars.iv913, 3
  %186 = mul nuw nsw i64 %185, 96
  %187 = add i64 %indvars.iv911, %186
  %188 = sub nsw i64 %indvars.iv918, %186
  %189 = shl nsw i64 %polly.indvar561, 8
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %190 = mul nsw i64 %polly.indvar561, -256
  %191 = mul nuw nsw i64 %polly.indvar561, 3
  %192 = add nuw nsw i64 %polly.indvar561, 2
  %pexp.p_div_q580 = udiv i64 %192, 3
  %193 = sub nsw i64 %191, %pexp.p_div_q580
  br label %polly.loop_header581

polly.loop_exit583:                               ; preds = %polly.loop_exit589
  %polly.indvar_next562 = add nuw nsw i64 %polly.indvar561, 1
  %indvars.iv.next905 = add nsw i64 %indvars.iv904, -256
  %indvars.iv.next912 = add nsw i64 %indvars.iv911, -32
  %indvars.iv.next914 = add nuw nsw i64 %indvars.iv913, 1
  %indvars.iv.next919 = add nuw nsw i64 %indvars.iv918, 32
  %exitcond928.not = icmp eq i64 %polly.indvar_next562, 5
...
polly.loop_header570:                             ; preds = %polly.loop_header570, %polly.loop_header564
  ...
  %195 = add nuw nsw i64 %polly.indvar573, %189
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  %indvars.iv920 = phi i64 [ %indvars.iv.next921, %polly.loop_exit589 ], [ %188, %polly.loop_exit566 ]
  %indvars.iv915 = phi i64 [ %indvars.iv.next916, %polly.loop_exit589 ], [ %187, %polly.loop_exit566 ]
  ...
  %197 = mul nsw i64 %polly.indvar584, 96
  %198 = sub nsw i64 %189, %197
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %201 = mul nsw i64 %polly.indvar584, -96
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596, %polly.loop_header581
  ...
  %indvars.iv.next921 = add i64 %indvars.iv920, 96
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  ...
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 255)
  %207 = add i64 %polly.indvar598, %197
  %208 = add i64 %207, %190
...
polly.loop_header602:                             ; preds = %polly.loop_header602.preheader, %polly.loop_header602
  ...
  %212 = add nuw nsw i64 %polly.indvar606, %189
