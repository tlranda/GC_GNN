; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9487.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9487.c"
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %124 = udiv i64 %polly.indvar355, 10
  %125 = shl nsw i64 %polly.indvar355, 3
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %151 = udiv i64 %polly.indvar511, 10
  %152 = shl nsw i64 %polly.indvar511, 3
...
polly.loop_exit516:                               ; preds = %polly.loop_exit523
  ...
  %exitcond826.not = icmp eq i64 %polly.indvar_next512, 150
