; ModuleID = 'syr2k_recreations//mmp_syr2k_M_161.c'
source_filename = "syr2k_recreations//mmp_syr2k_M_161.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %97 = udiv i64 %indvars.iv998, 24
  %98 = mul nuw nsw i64 %97, 96
  %99 = sub nsw i64 %indvars.iv, %98
  %100 = add i64 %indvars.iv1002, %98
  %101 = trunc i64 %polly.indvar202 to i16
  %pexp.p_div_q.lhs.trunc = mul i16 %101, 5
  %pexp.p_div_q875 = udiv i16 %pexp.p_div_q.lhs.trunc, 24
  %pexp.p_div_q.zext = zext i16 %pexp.p_div_q875 to i64
...
polly.loop_exit207:                               ; preds = %polly.loop_exit244
  ...
  %indvars.iv.next999 = add nuw nsw i64 %indvars.iv998, 5
  %indvars.iv.next1003 = add nsw i64 %indvars.iv1002, -20
  %exitcond1010.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_header205:                             ; preds = %polly.loop_exit244, %polly.loop_header199
  ...
  %polly.indvar208 = phi i64 [ %polly.indvar_next209, %polly.loop_exit244 ], [ %pexp.p_div_q.zext, %polly.loop_header199 ]
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1000, i64 0)
  %105 = add i64 %smax, %indvars.iv1004
  %106 = mul nuw nsw i64 %polly.indvar208, 96
...
polly.loop_header217.us:                          ; preds = %polly.loop_header211.us, %polly.loop_header217.us
  ...
  %exitcond996.not = icmp eq i64 %polly.indvar220.us, %109
...
polly.loop_header242.preheader:                   ; preds = %polly.loop_exit230, %polly.loop_exit230.us, %polly.loop_header205.split
  ...
  %120 = mul nsw i64 %polly.indvar208, -96
  %121 = icmp slt i64 %120, -1104
  %122 = select i1 %121, i64 %120, i64 -1104
...
polly.loop_header249:                             ; preds = %polly.loop_exit259, %polly.loop_header242
  %indvars.iv1006 = phi i64 [ %indvars.iv.next1007, %polly.loop_exit259 ], [ %105, %polly.loop_header242 ]
  %polly.indvar253 = phi i64 [ %polly.indvar_next254, %polly.loop_exit259 ], [ %119, %polly.loop_header242 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1006, i64 19)
...
polly.loop_header387:                             ; preds = %polly.loop_header387.preheader, %polly.loop_exit396
  ...
  %143 = udiv i64 %indvars.iv1018, 24
  %144 = mul nuw nsw i64 %143, 96
  %145 = sub nsw i64 %indvars.iv1016, %144
  %146 = add i64 %indvars.iv1023, %144
  %147 = trunc i64 %polly.indvar390 to i16
  %pexp.p_div_q393.lhs.trunc = mul i16 %147, 5
  %pexp.p_div_q393874 = udiv i16 %pexp.p_div_q393.lhs.trunc, 24
  %pexp.p_div_q393.zext = zext i16 %pexp.p_div_q393874 to i64
...
polly.loop_exit396:                               ; preds = %polly.loop_exit435
  ...
  %exitcond1032.not = icmp eq i64 %polly.indvar_next391, 60
...
polly.loop_header394:                             ; preds = %polly.loop_exit435, %polly.loop_header387
  %indvars.iv1025 = phi i64 [ %indvars.iv.next1026, %polly.loop_exit435 ], [ %146, %polly.loop_header387 ]
  %indvars.iv1020 = phi i64 [ %indvars.iv.next1021, %polly.loop_exit435 ], [ %145, %polly.loop_header387 ]
  %polly.indvar397 = phi i64 [ %polly.indvar_next398, %polly.loop_exit435 ], [ %pexp.p_div_q393.zext, %polly.loop_header387 ]
  %smax1022 = call i64 @llvm.smax.i64(i64 %indvars.iv1020, i64 0)
  %151 = add i64 %smax1022, %indvars.iv1025
  %152 = mul nuw nsw i64 %polly.indvar397, 96
...
polly.loop_header407.us:                          ; preds = %polly.loop_header400.us, %polly.loop_header407.us
  ...
  %exitcond1014.not = icmp eq i64 %polly.indvar411.us, %155
...
polly.loop_header433.preheader:                   ; preds = %polly.loop_exit421, %polly.loop_exit421.us, %polly.loop_header394.split
  ...
  %166 = mul nsw i64 %polly.indvar397, -96
...
polly.loop_header440:                             ; preds = %polly.loop_exit450, %polly.loop_header433
  %indvars.iv1027 = phi i64 [ %indvars.iv.next1028, %polly.loop_exit450 ], [ %151, %polly.loop_header433 ]
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  ...
  %189 = udiv i64 %indvars.iv1040, 24
  %190 = mul nuw nsw i64 %189, 96
  %191 = sub nsw i64 %indvars.iv1038, %190
  %192 = add i64 %indvars.iv1045, %190
  %193 = trunc i64 %polly.indvar581 to i16
  %pexp.p_div_q584.lhs.trunc = mul i16 %193, 5
  %pexp.p_div_q584873 = udiv i16 %pexp.p_div_q584.lhs.trunc, 24
  %pexp.p_div_q584.zext = zext i16 %pexp.p_div_q584873 to i64
...
polly.loop_header585:                             ; preds = %polly.loop_exit626, %polly.loop_header578
  %indvars.iv1047 = phi i64 [ %indvars.iv.next1048, %polly.loop_exit626 ], [ %192, %polly.loop_header578 ]
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit626 ], [ %191, %polly.loop_header578 ]
  %polly.indvar588 = phi i64 [ %polly.indvar_next589, %polly.loop_exit626 ], [ %pexp.p_div_q584.zext, %polly.loop_header578 ]
  %smax1044 = call i64 @llvm.smax.i64(i64 %indvars.iv1042, i64 0)
  %197 = add i64 %smax1044, %indvars.iv1047
  %198 = mul nuw nsw i64 %polly.indvar588, 96
...
polly.loop_header598.us:                          ; preds = %polly.loop_header591.us, %polly.loop_header598.us
  ...
  %exitcond1036.not = icmp eq i64 %polly.indvar602.us, %201
...
polly.loop_header624.preheader:                   ; preds = %polly.loop_exit612, %polly.loop_exit612.us, %polly.loop_header585.split
  ...
  %212 = mul nsw i64 %polly.indvar588, -96
...
polly.loop_header631:                             ; preds = %polly.loop_exit641, %polly.loop_header624
  %indvars.iv1049 = phi i64 [ %indvars.iv.next1050, %polly.loop_exit641 ], [ %197, %polly.loop_header624 ]
