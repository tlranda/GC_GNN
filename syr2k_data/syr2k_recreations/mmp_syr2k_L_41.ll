; ModuleID = 'syr2k_recreations//mmp_syr2k_L_41.c'
source_filename = "syr2k_recreations//mmp_syr2k_L_41.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %99 = udiv i64 %indvars.iv1013, 24
  %100 = mul nuw nsw i64 %99, 96
  %101 = sub nsw i64 %indvars.iv1011, %100
  %102 = add i64 %indvars.iv1017, %100
  %103 = trunc i64 %polly.indvar208 to i16
  %pexp.p_div_q.lhs.trunc = mul i16 %103, 5
...
polly.loop_exit213:                               ; preds = %polly.loop_exit250
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %107 = add i64 %smax, %indvars.iv1019
...
polly.loop_header255:                             ; preds = %polly.loop_header248, %polly.loop_exit265
  %indvars.iv1021 = phi i64 [ %107, %polly.loop_header248 ], [ %indvars.iv.next1022, %polly.loop_exit265 ]
  %polly.indvar259 = phi i64 [ %123, %polly.loop_header248 ], [ %polly.indvar_next260, %polly.loop_exit265 ]
  %smin1023 = call i64 @llvm.smin.i64(i64 %indvars.iv1021, i64 19)
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %152 = udiv i64 %indvars.iv1040, 24
  %153 = mul nuw nsw i64 %152, 96
  %154 = sub nsw i64 %indvars.iv1038, %153
  %155 = add i64 %indvars.iv1045, %153
  %156 = trunc i64 %polly.indvar400 to i16
  %pexp.p_div_q403.lhs.trunc = mul i16 %156, 5
...
polly.loop_exit406:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar_next401, 60
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  %indvars.iv1047 = phi i64 [ %indvars.iv.next1048, %polly.loop_exit445 ], [ %155, %polly.loop_header397 ]
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit445 ], [ %154, %polly.loop_header397 ]
  ...
  %160 = add i64 %smax1044, %indvars.iv1047
...
polly.loop_header417.us:                          ; preds = %polly.loop_header410.us, %polly.loop_header417.us
  ...
  %exitcond1035.not = icmp eq i64 %polly.indvar421.us, %164
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_exit419.loopexit.us
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar_next414.us, %150
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next414, %150
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1054.not = icmp eq i64 %polly.indvar_next447, %150
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1049 = phi i64 [ %160, %polly.loop_header443 ], [ %indvars.iv.next1050, %polly.loop_exit460 ]
  %polly.indvar454 = phi i64 [ %176, %polly.loop_header443 ], [ %polly.indvar_next455, %polly.loop_exit460 ]
  %smin1051 = call i64 @llvm.smin.i64(i64 %indvars.iv1049, i64 19)
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %205 = udiv i64 %indvars.iv1068, 24
  %206 = mul nuw nsw i64 %205, 96
  %207 = sub nsw i64 %indvars.iv1066, %206
  %208 = add i64 %indvars.iv1073, %206
  %209 = trunc i64 %polly.indvar595 to i16
  %pexp.p_div_q598.lhs.trunc = mul i16 %209, 5
...
polly.loop_exit601:                               ; preds = %polly.loop_exit640
  ...
  %indvars.iv.next1067 = add nuw nsw i64 %indvars.iv1066, 20
  %indvars.iv.next1069 = add nuw nsw i64 %indvars.iv1068, 5
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  %indvars.iv1075 = phi i64 [ %indvars.iv.next1076, %polly.loop_exit640 ], [ %208, %polly.loop_header592 ]
  %indvars.iv1070 = phi i64 [ %indvars.iv.next1071, %polly.loop_exit640 ], [ %207, %polly.loop_header592 ]
  ...
  %213 = add i64 %smax1072, %indvars.iv1075
...
polly.loop_header612.us:                          ; preds = %polly.loop_header605.us, %polly.loop_header612.us
  ...
  %exitcond1063.not = icmp eq i64 %polly.indvar616.us, %217
...
polly.loop_exit626.us:                            ; preds = %polly.loop_header624.us, %polly.loop_exit614.loopexit.us
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next609.us, %203
...
polly.loop_exit626:                               ; preds = %polly.loop_header624
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar_next609, %203
...
polly.loop_exit647:                               ; preds = %polly.loop_exit655
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar_next642, %203
...
polly.loop_header645:                             ; preds = %polly.loop_header638, %polly.loop_exit655
  %indvars.iv1077 = phi i64 [ %213, %polly.loop_header638 ], [ %indvars.iv.next1078, %polly.loop_exit655 ]
  %polly.indvar649 = phi i64 [ %229, %polly.loop_header638 ], [ %polly.indvar_next650, %polly.loop_exit655 ]
  %smin1079 = call i64 @llvm.smin.i64(i64 %indvars.iv1077, i64 19)
