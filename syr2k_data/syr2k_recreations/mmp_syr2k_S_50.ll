; ModuleID = 'syr2k_recreations//mmp_syr2k_S_50.c'
source_filename = "syr2k_recreations//mmp_syr2k_S_50.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit208, %polly.loop_exit230
  ...
  %97 = shl nuw nsw i64 %polly.indvar225, 3
  %98 = mul nsw i64 %polly.indvar225, -8
  %99 = add nuw nsw i64 %97, 8
  br label %polly.loop_header228

polly.loop_exit230:                               ; preds = %polly.loop_exit259
  %polly.indvar_next226 = add nuw nsw i64 %polly.indvar225, 1
  %indvars.iv.next930 = add nsw i64 %indvars.iv929, -8
  %exitcond932.not = icmp eq i64 %polly.indvar_next226, 10
...
polly.loop_header228:                             ; preds = %polly.loop_exit259, %polly.loop_header222
  ...
  %smin1475 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 7)
  %smin926 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 7)
...
polly.loop_header257:                             ; preds = %polly.loop_exit265, %polly.loop_exit236
  ...
  %n.rnd.up1477 = add nuw nsw i64 %smin1475, 4
  %n.vec1479 = and i64 %n.rnd.up1477, 12
...
vector.body1474:                                  ; preds = %vector.body1474, %polly.loop_header257
  ...
  %121 = icmp eq i64 %index.next1481, %n.vec1479
...
polly.loop_header417:                             ; preds = %polly.loop_exit403, %polly.loop_exit425
  ...
  %131 = shl nuw nsw i64 %polly.indvar420, 3
  %132 = mul nsw i64 %polly.indvar420, -8
...
polly.loop_exit425:                               ; preds = %polly.loop_exit458
  ...
  %indvars.iv.next949 = add nsw i64 %indvars.iv948, -8
  %exitcond951.not = icmp eq i64 %polly.indvar_next421, 10
...
polly.loop_header423:                             ; preds = %polly.loop_exit458, %polly.loop_header417
  ...
  %smin1425 = call i64 @llvm.smin.i64(i64 %indvars.iv937, i64 7)
  %smin945 = call i64 @llvm.smin.i64(i64 %indvars.iv937, i64 7)
...
polly.loop_header456:                             ; preds = %polly.loop_exit464, %polly.loop_exit431
  ...
  %n.rnd.up1427 = add nuw nsw i64 %smin1425, 4
  %n.vec1429 = and i64 %n.rnd.up1427, 12
...
vector.body1424:                                  ; preds = %vector.body1424, %polly.loop_header456
  ...
  %155 = icmp eq i64 %index.next1431, %n.vec1429
...
polly.loop_header616:                             ; preds = %polly.loop_exit602, %polly.loop_exit624
  ...
  %165 = shl nuw nsw i64 %polly.indvar619, 3
  %166 = mul nsw i64 %polly.indvar619, -8
...
polly.loop_exit624:                               ; preds = %polly.loop_exit657
  ...
  %exitcond970.not = icmp eq i64 %polly.indvar_next620, 10
...
polly.loop_header622:                             ; preds = %polly.loop_exit657, %polly.loop_header616
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv956, i64 7)
  %smin964 = call i64 @llvm.smin.i64(i64 %indvars.iv956, i64 7)
...
polly.loop_header222.1:                           ; preds = %polly.loop_exit230, %polly.loop_exit230.1
  ...
  %226 = shl nuw nsw i64 %polly.indvar225.1, 3
  %227 = mul nsw i64 %polly.indvar225.1, -8
  %228 = add nuw nsw i64 %226, 8
...
polly.loop_header228.1:                           ; preds = %polly.loop_exit259.1, %polly.loop_header222.1
  ...
  %smin926.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.1, i64 7)
...
polly.loop_exit230.1:                             ; preds = %polly.loop_exit259.1
  ...
  %indvars.iv.next930.1 = add nsw i64 %indvars.iv929.1, -8
  %exitcond932.1.not = icmp eq i64 %polly.indvar_next226.1, 10
...
polly.loop_header417.1:                           ; preds = %polly.loop_exit425, %polly.loop_exit425.1
  ...
  %238 = shl nuw nsw i64 %polly.indvar420.1, 3
  %239 = mul nsw i64 %polly.indvar420.1, -8
  %240 = add nuw nsw i64 %238, 8
...
polly.loop_header423.1:                           ; preds = %polly.loop_exit458.1, %polly.loop_header417.1
  ...
  %smin945.1 = call i64 @llvm.smin.i64(i64 %indvars.iv937.1, i64 7)
...
polly.loop_exit425.1:                             ; preds = %polly.loop_exit458.1
  ...
  %indvars.iv.next949.1 = add nsw i64 %indvars.iv948.1, -8
  %exitcond951.1.not = icmp eq i64 %polly.indvar_next421.1, 10
...
polly.loop_header616.1:                           ; preds = %polly.loop_exit624, %polly.loop_exit624.1
  ...
  %250 = shl nuw nsw i64 %polly.indvar619.1, 3
  %251 = mul nsw i64 %polly.indvar619.1, -8
  %252 = add nuw nsw i64 %250, 8
...
polly.loop_header622.1:                           ; preds = %polly.loop_exit657.1, %polly.loop_header616.1
  ...
  %smin964.1 = call i64 @llvm.smin.i64(i64 %indvars.iv956.1, i64 7)
...
polly.loop_exit624.1:                             ; preds = %polly.loop_exit657.1
  ...
  %indvars.iv.next968.1 = add nsw i64 %indvars.iv967.1, -8
  %exitcond970.1.not = icmp eq i64 %polly.indvar_next620.1, 10
