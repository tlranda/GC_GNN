; ModuleID = 'syr2k_recreations//mmp_syr2k_M_86.c'
source_filename = "syr2k_recreations//mmp_syr2k_M_86.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin972 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -872)
  %97 = add nsw i64 %smin972, 1000
  %98 = mul nsw i64 %polly.indvar202, -128
  %99 = icmp slt i64 %98, -872
  %100 = select i1 %99, i64 %98, i64 -872
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond989.not = icmp eq i64 %polly.indvar_next203, 8
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit416
  ...
  %smin1005 = call i64 @llvm.smin.i64(i64 %indvars.iv992, i64 -872)
  %146 = add nsw i64 %smin1005, 1000
  %147 = mul nsw i64 %polly.indvar411, -128
  %148 = icmp slt i64 %147, -872
  %149 = select i1 %148, i64 %147, i64 -872
...
polly.loop_exit416:                               ; preds = %polly.loop_exit422
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next412, 8
...
polly.start521:                                   ; preds = %init_array.exit
  %malloccall523 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
polly.loop_header623:                             ; preds = %polly.loop_header623.preheader, %polly.loop_exit631
  ...
  %smin1039 = call i64 @llvm.smin.i64(i64 %indvars.iv1026, i64 -872)
  %195 = add nsw i64 %smin1039, 1000
  %196 = mul nsw i64 %polly.indvar626, -128
  %197 = icmp slt i64 %196, -872
  %198 = select i1 %197, i64 %196, i64 -872
  %199 = shl nsw i64 %polly.indvar626, 7
...
polly.loop_exit631:                               ; preds = %polly.loop_exit637
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next627, 8
