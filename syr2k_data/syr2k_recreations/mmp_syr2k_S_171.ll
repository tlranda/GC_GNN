; ModuleID = 'syr2k_recreations//mmp_syr2k_S_171.c'
source_filename = "syr2k_recreations//mmp_syr2k_S_171.c"
...
polly.loop_header355:                             ; preds = %polly.loop_exit369.3, %polly.loop_header349
  ...
  %127 = mul nuw nsw i64 %polly.indvar358, 20
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header355
  ...
  %smin771 = call i64 @llvm.smin.i64(i64 %indvars.iv769, i64 19)
...
polly.loop_header505:                             ; preds = %polly.loop_exit519.3, %polly.loop_header499
  ...
  %150 = mul nuw nsw i64 %polly.indvar508, 20
...
polly.loop_exit219.3:                             ; preds = %polly.loop_exit225.3
  ...
  %indvars.iv.next762 = add nsw i64 %indvars.iv761, -20
  %exitcond765.not = icmp eq i64 %polly.indvar_next209, 4
...
polly.loop_header367.1:                           ; preds = %polly.loop_exit375, %polly.loop_exit375.1
  ...
  %smin771.1 = call i64 @llvm.smin.i64(i64 %indvars.iv769.1, i64 19)
...
polly.loop_header367.2:                           ; preds = %polly.loop_exit375.1, %polly.loop_exit375.2
  ...
  %smin771.2 = call i64 @llvm.smin.i64(i64 %indvars.iv769.2, i64 19)
...
polly.loop_header367.3:                           ; preds = %polly.loop_exit375.2, %polly.loop_exit375.3
  ...
  %smin771.3 = call i64 @llvm.smin.i64(i64 %indvars.iv769.3, i64 19)
...
polly.loop_exit369.3:                             ; preds = %polly.loop_exit375.3
  ...
  %indvars.iv.next774 = add nsw i64 %indvars.iv773, -20
  %exitcond777.not = icmp eq i64 %polly.indvar_next359, 4
...
polly.loop_exit519.3:                             ; preds = %polly.loop_exit525.3
  ...
  %exitcond789.not = icmp eq i64 %polly.indvar_next509, 4
