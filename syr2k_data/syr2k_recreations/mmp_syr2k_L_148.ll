; ModuleID = 'syr2k_recreations//mmp_syr2k_L_148.c'
source_filename = "syr2k_recreations//mmp_syr2k_L_148.c"
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1296, label %for.body3.i46.preheader1451, label %vector.ph1297
...
middle.block1293:                                 ; preds = %vector.body1295
  ...
  br i1 %cmp.n1303, label %for.inc6.i, label %for.body3.i46.preheader1451

for.body3.i46.preheader1451:                      ; preds = %for.body3.i46.preheader, %middle.block1293
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec1299, %middle.block1293 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1451, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1451 ]
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  ...
  br i1 %min.iters.check1343, label %for.body3.i60.preheader1447, label %vector.ph1344
...
middle.block1340:                                 ; preds = %vector.body1342
  ...
  br i1 %cmp.n1350, label %for.inc6.i63, label %for.body3.i60.preheader1447

for.body3.i60.preheader1447:                      ; preds = %for.body3.i60.preheader, %middle.block1340
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1346, %middle.block1340 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1447, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1447 ]
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  ...
  br i1 %min.iters.check1393, label %for.body3.i99.preheader1443, label %vector.ph1394
...
middle.block1390:                                 ; preds = %vector.body1392
  ...
  br i1 %cmp.n1400, label %for.inc6.i102, label %for.body3.i99.preheader1443

for.body3.i99.preheader1443:                      ; preds = %for.body3.i99.preheader, %middle.block1390
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1396, %middle.block1390 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1443, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1443 ]
...
polly.loop_exit194:                               ; preds = %polly.loop_header192, %middle.block1402
  ...
  %exitcond1113.not = icmp eq i64 %polly.indvar_next, 1200
  %indvar.next1406 = add i64 %indvar1405, 1
  br i1 %exitcond1113.not, label %polly.loop_header200.preheader, label %polly.loop_header
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  %exitcond1112.not = icmp eq i64 %polly.indvar_next196, %polly.indvar
  br i1 %exitcond1112.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !79
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1108 = call i64 @llvm.smin.i64(i64 %indvars.iv1088, i64 -936)
  %97 = add nsw i64 %smin1108, 1000
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1111.not = icmp eq i64 %polly.indvar_next204, 16
  br i1 %exitcond1111.not, label %polly.exiting, label %polly.loop_header200
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %102 = shl nuw nsw i64 %101, 6
  %103 = sub i64 %99, %102
  %104 = mul nsw i64 %polly.indvar209, -80
  %105 = add i64 %104, %102
  %106 = lshr i64 %polly.indvar209, 2
  %107 = add nuw i64 %polly.indvar209, %106
  %108 = shl nuw nsw i64 %107, 6
  %109 = sub i64 %indvars.iv1096, %108
  %110 = add i64 %indvars.iv1100, %108
  %111 = mul nsw i64 %polly.indvar209, -80
  %112 = mul nuw nsw i64 %polly.indvar209, 80
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %exitcond1110.not = icmp eq i64 %polly.indvar_next210, 15
  br i1 %exitcond1110.not, label %polly.loop_exit208, label %polly.loop_header206
...
polly.loop_header218:                             ; preds = %polly.loop_header218, %polly.loop_header212
  ...
  %115 = add nuw nsw i64 %polly.indvar221, %112
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %indvars.iv1102 = phi i64 [ %indvars.iv.next1103, %polly.loop_exit267 ], [ %110, %polly.loop_exit214 ]
  %indvars.iv1098 = phi i64 [ %indvars.iv.next1099, %polly.loop_exit267 ], [ %109, %polly.loop_exit214 ]
  %polly.indvar231 = phi i64 [ %polly.indvar_next232, %polly.loop_exit267 ], [ %107, %polly.loop_exit214 ]
  %116 = mul nsw i64 %indvar1419, -64
  %117 = add i64 %103, %116
  %smax1421 = call i64 @llvm.smax.i64(i64 %117, i64 0)
  %118 = shl nuw nsw i64 %indvar1419, 6
  %119 = add i64 %105, %118
  %120 = add i64 %smax1421, %119
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1098, i64 0)
  %121 = add i64 %smax, %indvars.iv1102
  %122 = shl nsw i64 %polly.indvar231, 6
  ...
  %128 = add nsw i64 %123, 63
  %129 = icmp slt i64 %113, %128
  %130 = select i1 %129, i64 %113, i64 %128
...
polly.loop_header251:                             ; preds = %polly.loop_header234, %polly.loop_header251
  ...
  %142 = add nuw nsw i64 %polly.indvar255, %112
...
polly.loop_exit274:                               ; preds = %polly.loop_exit282
  ...
  %exitcond1109.not = icmp eq i64 %polly.indvar_next269, %97
  br i1 %exitcond1109.not, label %polly.loop_exit267, label %polly.loop_header265

polly.loop_header272:                             ; preds = %polly.loop_header265, %polly.loop_exit282
  %indvar1422 = phi i64 [ 0, %polly.loop_header265 ], [ %indvar.next1423, %polly.loop_exit282 ]
  %indvars.iv1104 = phi i64 [ %121, %polly.loop_header265 ], [ %indvars.iv.next1105, %polly.loop_exit282 ]
  %polly.indvar276 = phi i64 [ %137, %polly.loop_header265 ], [ %polly.indvar_next277, %polly.loop_exit282 ]
  %143 = add i64 %120, %indvar1422
  %smin1424 = call i64 @llvm.smin.i64(i64 %143, i64 79)
  %144 = add nsw i64 %smin1424, 1
  %smin1106 = call i64 @llvm.smin.i64(i64 %indvars.iv1104, i64 79)
  %145 = add nsw i64 %polly.indvar276, %123
  %polly.loop_guard2831213 = icmp sgt i64 %145, -1
  br i1 %polly.loop_guard2831213, label %polly.loop_header280.preheader, label %polly.loop_exit282
...
polly.loop_header280.preheader:                   ; preds = %polly.loop_header272
  ...
  %min.iters.check1425 = icmp ult i64 %144, 4
  br i1 %min.iters.check1425, label %polly.loop_header280.preheader1440, label %vector.ph1426

vector.ph1426:                                    ; preds = %polly.loop_header280.preheader
  %n.vec1428 = and i64 %144, -4
  %broadcast.splatinsert1434 = insertelement <4 x double> poison, double %_p_scalar_294, i32 0
  %broadcast.splat1435 = shufflevector <4 x double> %broadcast.splatinsert1434, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1437 = insertelement <4 x double> poison, double %_p_scalar_302, i32 0
...
vector.body1418:                                  ; preds = %vector.body1418, %vector.ph1426
  ...
  %148 = add nuw nsw i64 %index1429, %112
  %149 = add nuw nsw i64 %index1429, %polly.access.mul.Packed_MemRef_call1287
  ...
  %wide.load1439 = load <4 x double>, <4 x double>* %159, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %164, label %middle.block1416, label %vector.body1418, !llvm.loop !83

middle.block1416:                                 ; preds = %vector.body1418
  %cmp.n1432 = icmp eq i64 %144, %n.vec1428
  br i1 %cmp.n1432, label %polly.loop_exit282, label %polly.loop_header280.preheader1440

polly.loop_header280.preheader1440:               ; preds = %polly.loop_header280.preheader, %middle.block1416
  %polly.indvar284.ph = phi i64 [ 0, %polly.loop_header280.preheader ], [ %n.vec1428, %middle.block1416 ]
  br label %polly.loop_header280

polly.loop_exit282:                               ; preds = %polly.loop_header280, %middle.block1416, %polly.loop_header272
...
polly.loop_header280:                             ; preds = %polly.loop_header280.preheader1440, %polly.loop_header280
  %polly.indvar284 = phi i64 [ %polly.indvar_next285, %polly.loop_header280 ], [ %polly.indvar284.ph, %polly.loop_header280.preheader1440 ]
  %165 = add nuw nsw i64 %polly.indvar284, %112
  ...
  %exitcond1107.not = icmp eq i64 %polly.indvar284, %smin1106
  br i1 %exitcond1107.not, label %polly.loop_exit282, label %polly.loop_header280, !llvm.loop !84
...
vector.body1354:                                  ; preds = %vector.body1354, %vector.ph1358
  ...
  %170 = shl nuw nsw i64 %index1361, 3
  %171 = getelementptr i8, i8* %scevgep408, i64 %170
  %172 = bitcast i8* %171 to <4 x double>*
  %wide.load1365 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !85, !noalias !87
  %173 = fmul fast <4 x double> %wide.load1365, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %175 = icmp eq i64 %index.next1362, %n.vec1360
  br i1 %175, label %middle.block1352, label %vector.body1354, !llvm.loop !92

middle.block1352:                                 ; preds = %vector.body1354
  %cmp.n1364 = icmp eq i64 %168, %n.vec1360
...
polly.loop_exit404:                               ; preds = %polly.loop_header402, %middle.block1352
  ...
  %exitcond1144.not = icmp eq i64 %polly.indvar_next400, 1200
  %indvar.next1356 = add i64 %indvar1355, 1
  br i1 %exitcond1144.not, label %polly.loop_header412.preheader, label %polly.loop_header396
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_header402
  ...
  %exitcond1143.not = icmp eq i64 %polly.indvar_next406, %polly.indvar399
  br i1 %exitcond1143.not, label %polly.loop_exit404, label %polly.loop_header402, !llvm.loop !93

polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  %indvars.iv1117 = phi i64 [ 0, %polly.loop_header412.preheader ], [ %indvars.iv.next1118, %polly.loop_exit420 ]
  %polly.indvar415 = phi i64 [ 0, %polly.loop_header412.preheader ], [ %polly.indvar_next416, %polly.loop_exit420 ]
  %smin1139 = call i64 @llvm.smin.i64(i64 %indvars.iv1117, i64 -936)
  %177 = add nsw i64 %smin1139, 1000
  %178 = shl nsw i64 %polly.indvar415, 6
  br label %polly.loop_header418

polly.loop_exit420:                               ; preds = %polly.loop_exit443
  %polly.indvar_next416 = add nuw nsw i64 %polly.indvar415, 1
  %indvars.iv.next1118 = add nsw i64 %indvars.iv1117, -64
  %exitcond1142.not = icmp eq i64 %polly.indvar_next416, 16
  br i1 %exitcond1142.not, label %polly.exiting309, label %polly.loop_header412
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %indvars.iv1114 = phi i64 [ %indvars.iv.next1115, %polly.loop_exit443 ], [ 1200, %polly.loop_header412 ]
  %polly.indvar421 = phi i64 [ %polly.indvar_next422, %polly.loop_exit443 ], [ 0, %polly.loop_header412 ]
  %179 = mul nuw nsw i64 %polly.indvar421, 80
  %180 = lshr i64 %polly.indvar421, 2
  %181 = add nuw i64 %polly.indvar421, %180
  %182 = shl nuw nsw i64 %181, 6
  %183 = sub i64 %179, %182
  %184 = mul nsw i64 %polly.indvar421, -80
  %185 = add i64 %184, %182
  %186 = lshr i64 %polly.indvar421, 2
  %187 = add nuw i64 %polly.indvar421, %186
  %188 = shl nuw nsw i64 %187, 6
  %189 = sub i64 %indvars.iv1126, %188
  %190 = add i64 %indvars.iv1131, %188
  %191 = mul nsw i64 %polly.indvar421, -80
  %192 = mul nuw nsw i64 %polly.indvar421, 80
...
polly.loop_exit443:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1115 = add nsw i64 %indvars.iv1114, -80
  %indvars.iv.next1127 = add nuw nsw i64 %indvars.iv1126, 80
  %indvars.iv.next1132 = add nsw i64 %indvars.iv1131, -80
  %exitcond1141.not = icmp eq i64 %polly.indvar_next422, 15
  br i1 %exitcond1141.not, label %polly.loop_exit420, label %polly.loop_header418
...
polly.loop_exit432:                               ; preds = %polly.loop_header430
  ...
  %exitcond1120.not = icmp eq i64 %polly.indvar_next428, %177
  br i1 %exitcond1120.not, label %polly.loop_exit426, label %polly.loop_header424
...
polly.loop_header430:                             ; preds = %polly.loop_header430, %polly.loop_header424
  ...
  %195 = add nuw nsw i64 %polly.indvar433, %192
  ...
  %exitcond1116.not = icmp eq i64 %polly.indvar_next434, %indvars.iv1114
  br i1 %exitcond1116.not, label %polly.loop_exit432, label %polly.loop_header430
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit426
  ...
  %indvars.iv1133 = phi i64 [ %indvars.iv.next1134, %polly.loop_exit482 ], [ %190, %polly.loop_exit426 ]
  %indvars.iv1128 = phi i64 [ %indvars.iv.next1129, %polly.loop_exit482 ], [ %189, %polly.loop_exit426 ]
  %polly.indvar444 = phi i64 [ %polly.indvar_next445, %polly.loop_exit482 ], [ %187, %polly.loop_exit426 ]
  %196 = mul nsw i64 %indvar1369, -64
  %197 = add i64 %183, %196
  %smax1371 = call i64 @llvm.smax.i64(i64 %197, i64 0)
  %198 = shl nuw nsw i64 %indvar1369, 6
  %199 = add i64 %185, %198
  %200 = add i64 %smax1371, %199
  %smax1130 = call i64 @llvm.smax.i64(i64 %indvars.iv1128, i64 0)
  %201 = add i64 %smax1130, %indvars.iv1133
  %202 = shl nsw i64 %polly.indvar444, 6
  %203 = add nsw i64 %202, %191
  %204 = add nsw i64 %203, -1
  %.inv942 = icmp sgt i64 %203, 79
  %205 = select i1 %.inv942, i64 79, i64 %204
  %polly.loop_guard457 = icmp sgt i64 %205, -1
  %206 = icmp sgt i64 %203, 0
  %207 = select i1 %206, i64 %203, i64 0
  %208 = add nsw i64 %203, 63
  %209 = icmp slt i64 %193, %208
  %210 = select i1 %209, i64 %193, i64 %208
...
polly.loop_header454.us:                          ; preds = %polly.loop_header447.us, %polly.loop_header454.us
  ...
  %212 = add nuw nsw i64 %polly.indvar458.us, %192
  ...
  %exitcond1123.not = icmp eq i64 %polly.indvar458.us, %205
  br i1 %exitcond1123.not, label %polly.loop_exit456.loopexit.us, label %polly.loop_header454.us
...
polly.loop_header466.us:                          ; preds = %polly.loop_exit456.loopexit.us, %polly.loop_header466.us
  ...
  %213 = add nuw nsw i64 %polly.indvar470.us, %192
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_exit456.loopexit.us
  ...
  %exitcond1125.not = icmp eq i64 %polly.indvar_next451.us, %177
  br i1 %exitcond1125.not, label %polly.loop_header480.preheader, label %polly.loop_header447.us
...
polly.loop_exit482:                               ; preds = %polly.loop_exit489, %polly.loop_header480.preheader
  ...
  %indvars.iv.next1129 = add i64 %indvars.iv1128, -64
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1122.not = icmp eq i64 %polly.indvar_next451, %177
  br i1 %exitcond1122.not, label %polly.loop_header480.preheader, label %polly.loop_header447
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header441.split
  ...
  %218 = mul nsw i64 %polly.indvar444, -64
...
polly.loop_header466:                             ; preds = %polly.loop_header447, %polly.loop_header466
  ...
  %222 = add nuw nsw i64 %polly.indvar470, %192
...
polly.loop_exit489:                               ; preds = %polly.loop_exit497
  ...
  %exitcond1140.not = icmp eq i64 %polly.indvar_next484, %177
  br i1 %exitcond1140.not, label %polly.loop_exit482, label %polly.loop_header480
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %indvars.iv1135 = phi i64 [ %201, %polly.loop_header480 ], [ %indvars.iv.next1136, %polly.loop_exit497 ]
  %polly.indvar491 = phi i64 [ %217, %polly.loop_header480 ], [ %polly.indvar_next492, %polly.loop_exit497 ]
  %223 = add i64 %200, %indvar1372
  %smin1374 = call i64 @llvm.smin.i64(i64 %223, i64 79)
  %224 = add nsw i64 %smin1374, 1
  %smin1137 = call i64 @llvm.smin.i64(i64 %indvars.iv1135, i64 79)
  %225 = add nsw i64 %polly.indvar491, %203
  %polly.loop_guard4981214 = icmp sgt i64 %225, -1
  br i1 %polly.loop_guard4981214, label %polly.loop_header495.preheader, label %polly.loop_exit497
...
polly.loop_header495.preheader:                   ; preds = %polly.loop_header487
  ...
  %min.iters.check1375 = icmp ult i64 %224, 4
  br i1 %min.iters.check1375, label %polly.loop_header495.preheader1444, label %vector.ph1376

vector.ph1376:                                    ; preds = %polly.loop_header495.preheader
  %n.vec1378 = and i64 %224, -4
  %broadcast.splatinsert1384 = insertelement <4 x double> poison, double %_p_scalar_509, i32 0
  %broadcast.splat1385 = shufflevector <4 x double> %broadcast.splatinsert1384, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1387 = insertelement <4 x double> poison, double %_p_scalar_517, i32 0
...
vector.body1368:                                  ; preds = %vector.body1368, %vector.ph1376
  ...
  %228 = add nuw nsw i64 %index1379, %192
  %229 = add nuw nsw i64 %index1379, %polly.access.mul.Packed_MemRef_call1311502
  %230 = getelementptr double, double* %Packed_MemRef_call1311, i64 %229
  %231 = bitcast double* %230 to <4 x double>*
  %wide.load1383 = load <4 x double>, <4 x double>* %231, align 8
  %232 = fmul fast <4 x double> %broadcast.splat1385, %wide.load1383
  %233 = getelementptr double, double* %Packed_MemRef_call2313, i64 %229
  %234 = bitcast double* %233 to <4 x double>*
  %wide.load1386 = load <4 x double>, <4 x double>* %234, align 8
  %235 = fmul fast <4 x double> %broadcast.splat1388, %wide.load1386
  %236 = shl i64 %228, 3
  %237 = add i64 %236, %227
  %238 = getelementptr i8, i8* %call, i64 %237
  %239 = bitcast i8* %238 to <4 x double>*
  %wide.load1389 = load <4 x double>, <4 x double>* %239, align 8, !alias.scope !85, !noalias !87
  ...
  %242 = fadd fast <4 x double> %241, %wide.load1389
  ...
  %244 = icmp eq i64 %index.next1380, %n.vec1378
  br i1 %244, label %middle.block1366, label %vector.body1368, !llvm.loop !96

middle.block1366:                                 ; preds = %vector.body1368
  %cmp.n1382 = icmp eq i64 %224, %n.vec1378
  br i1 %cmp.n1382, label %polly.loop_exit497, label %polly.loop_header495.preheader1444

polly.loop_header495.preheader1444:               ; preds = %polly.loop_header495.preheader, %middle.block1366
  %polly.indvar499.ph = phi i64 [ 0, %polly.loop_header495.preheader ], [ %n.vec1378, %middle.block1366 ]
  br label %polly.loop_header495

polly.loop_exit497:                               ; preds = %polly.loop_header495, %middle.block1366, %polly.loop_header487
...
polly.loop_header495:                             ; preds = %polly.loop_header495.preheader1444, %polly.loop_header495
  %polly.indvar499 = phi i64 [ %polly.indvar_next500, %polly.loop_header495 ], [ %polly.indvar499.ph, %polly.loop_header495.preheader1444 ]
  %245 = add nuw nsw i64 %polly.indvar499, %192
  ...
  %exitcond1138.not = icmp eq i64 %polly.indvar499, %smin1137
  br i1 %exitcond1138.not, label %polly.loop_exit497, label %polly.loop_header495, !llvm.loop !97
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1307 = icmp ult i64 %248, 4
...
vector.body1306:                                  ; preds = %vector.body1306, %vector.ph1308
  ...
  %250 = shl nuw nsw i64 %index1311, 3
  %251 = getelementptr i8, i8* %scevgep623, i64 %250
  %252 = bitcast i8* %251 to <4 x double>*
  %wide.load1315 = load <4 x double>, <4 x double>* %252, align 8, !alias.scope !98, !noalias !100
  %253 = fmul fast <4 x double> %wide.load1315, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %255 = icmp eq i64 %index.next1312, %n.vec1310
  br i1 %255, label %middle.block1304, label %vector.body1306, !llvm.loop !105

middle.block1304:                                 ; preds = %vector.body1306
  %cmp.n1314 = icmp eq i64 %248, %n.vec1310
...
polly.loop_header617:                             ; preds = %polly.loop_header617.preheader, %polly.loop_header617
  ...
  br i1 %exitcond1174.not, label %polly.loop_exit619, label %polly.loop_header617, !llvm.loop !106

polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  %indvars.iv1148 = phi i64 [ 0, %polly.loop_header627.preheader ], [ %indvars.iv.next1149, %polly.loop_exit635 ]
  %polly.indvar630 = phi i64 [ 0, %polly.loop_header627.preheader ], [ %polly.indvar_next631, %polly.loop_exit635 ]
  %smin1170 = call i64 @llvm.smin.i64(i64 %indvars.iv1148, i64 -936)
  %257 = add nsw i64 %smin1170, 1000
  %258 = shl nsw i64 %polly.indvar630, 6
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %indvars.iv.next1149 = add nsw i64 %indvars.iv1148, -64
  %exitcond1173.not = icmp eq i64 %polly.indvar_next631, 16
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %indvars.iv1145 = phi i64 [ %indvars.iv.next1146, %polly.loop_exit658 ], [ 1200, %polly.loop_header627 ]
  %polly.indvar636 = phi i64 [ %polly.indvar_next637, %polly.loop_exit658 ], [ 0, %polly.loop_header627 ]
  %259 = mul nuw nsw i64 %polly.indvar636, 80
  %260 = lshr i64 %polly.indvar636, 2
  %261 = add nuw i64 %polly.indvar636, %260
  %262 = shl nuw nsw i64 %261, 6
  %263 = sub i64 %259, %262
  %264 = mul nsw i64 %polly.indvar636, -80
  %265 = add i64 %264, %262
  %266 = lshr i64 %polly.indvar636, 2
  %267 = add nuw i64 %polly.indvar636, %266
  %268 = shl nuw nsw i64 %267, 6
  %269 = sub i64 %indvars.iv1157, %268
  %270 = add i64 %indvars.iv1162, %268
  %271 = mul nsw i64 %polly.indvar636, -80
  %272 = mul nuw nsw i64 %polly.indvar636, 80
...
polly.loop_exit658:                               ; preds = %polly.loop_exit697
  ...
  %indvars.iv.next1158 = add nuw nsw i64 %indvars.iv1157, 80
  %indvars.iv.next1163 = add nsw i64 %indvars.iv1162, -80
  %exitcond1172.not = icmp eq i64 %polly.indvar_next637, 15
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1151.not = icmp eq i64 %polly.indvar_next643, %257
  br i1 %exitcond1151.not, label %polly.loop_exit641, label %polly.loop_header639
...
polly.loop_header645:                             ; preds = %polly.loop_header645, %polly.loop_header639
  ...
  %275 = add nuw nsw i64 %polly.indvar648, %272
  ...
  %exitcond1147.not = icmp eq i64 %polly.indvar_next649, %indvars.iv1145
  br i1 %exitcond1147.not, label %polly.loop_exit647, label %polly.loop_header645
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit641
  ...
  %indvars.iv1164 = phi i64 [ %indvars.iv.next1165, %polly.loop_exit697 ], [ %270, %polly.loop_exit641 ]
  %indvars.iv1159 = phi i64 [ %indvars.iv.next1160, %polly.loop_exit697 ], [ %269, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit697 ], [ %267, %polly.loop_exit641 ]
  %276 = mul nsw i64 %indvar1319, -64
  %277 = add i64 %263, %276
  %smax1321 = call i64 @llvm.smax.i64(i64 %277, i64 0)
  %278 = shl nuw nsw i64 %indvar1319, 6
  %279 = add i64 %265, %278
  %280 = add i64 %smax1321, %279
  %smax1161 = call i64 @llvm.smax.i64(i64 %indvars.iv1159, i64 0)
  %281 = add i64 %smax1161, %indvars.iv1164
  %282 = shl nsw i64 %polly.indvar659, 6
  %283 = add nsw i64 %282, %271
  %284 = add nsw i64 %283, -1
  %.inv943 = icmp sgt i64 %283, 79
  %285 = select i1 %.inv943, i64 79, i64 %284
  %polly.loop_guard672 = icmp sgt i64 %285, -1
  %286 = icmp sgt i64 %283, 0
  %287 = select i1 %286, i64 %283, i64 0
  %288 = add nsw i64 %283, 63
  %289 = icmp slt i64 %273, %288
  %290 = select i1 %289, i64 %273, i64 %288
...
polly.loop_header669.us:                          ; preds = %polly.loop_header662.us, %polly.loop_header669.us
  ...
  %292 = add nuw nsw i64 %polly.indvar673.us, %272
  ...
  %exitcond1154.not = icmp eq i64 %polly.indvar673.us, %285
  br i1 %exitcond1154.not, label %polly.loop_exit671.loopexit.us, label %polly.loop_header669.us
...
polly.loop_header681.us:                          ; preds = %polly.loop_exit671.loopexit.us, %polly.loop_header681.us
  ...
  %293 = add nuw nsw i64 %polly.indvar685.us, %272
...
polly.loop_exit683.us:                            ; preds = %polly.loop_header681.us, %polly.loop_exit671.loopexit.us
  ...
  %exitcond1156.not = icmp eq i64 %polly.indvar_next666.us, %257
  br i1 %exitcond1156.not, label %polly.loop_header695.preheader, label %polly.loop_header662.us
...
polly.loop_exit697:                               ; preds = %polly.loop_exit704, %polly.loop_header695.preheader
  ...
  %indvars.iv.next1165 = add i64 %indvars.iv1164, 64
...
polly.loop_exit683:                               ; preds = %polly.loop_header681
  ...
  %exitcond1153.not = icmp eq i64 %polly.indvar_next666, %257
  br i1 %exitcond1153.not, label %polly.loop_header695.preheader, label %polly.loop_header662

polly.loop_header695.preheader:                   ; preds = %polly.loop_exit683, %polly.loop_exit683.us, %polly.loop_header656.split
  %295 = sub nsw i64 %272, %282
...
polly.loop_header681:                             ; preds = %polly.loop_header662, %polly.loop_header681
  ...
  %302 = add nuw nsw i64 %polly.indvar685, %272
...
polly.loop_exit704:                               ; preds = %polly.loop_exit712
  ...
  %exitcond1171.not = icmp eq i64 %polly.indvar_next699, %257
  br i1 %exitcond1171.not, label %polly.loop_exit697, label %polly.loop_header695

polly.loop_header702:                             ; preds = %polly.loop_header695, %polly.loop_exit712
  %indvar1322 = phi i64 [ 0, %polly.loop_header695 ], [ %indvar.next1323, %polly.loop_exit712 ]
  %indvars.iv1166 = phi i64 [ %281, %polly.loop_header695 ], [ %indvars.iv.next1167, %polly.loop_exit712 ]
  %polly.indvar706 = phi i64 [ %297, %polly.loop_header695 ], [ %polly.indvar_next707, %polly.loop_exit712 ]
  %303 = add i64 %280, %indvar1322
  %smin1324 = call i64 @llvm.smin.i64(i64 %303, i64 79)
  %304 = add nsw i64 %smin1324, 1
  %smin1168 = call i64 @llvm.smin.i64(i64 %indvars.iv1166, i64 79)
  %305 = add nsw i64 %polly.indvar706, %283
  %polly.loop_guard7131215 = icmp sgt i64 %305, -1
  br i1 %polly.loop_guard7131215, label %polly.loop_header710.preheader, label %polly.loop_exit712
...
polly.loop_header710.preheader:                   ; preds = %polly.loop_header702
  ...
  %min.iters.check1325 = icmp ult i64 %304, 4
  br i1 %min.iters.check1325, label %polly.loop_header710.preheader1448, label %vector.ph1326

vector.ph1326:                                    ; preds = %polly.loop_header710.preheader
  %n.vec1328 = and i64 %304, -4
  %broadcast.splatinsert1334 = insertelement <4 x double> poison, double %_p_scalar_724, i32 0
  %broadcast.splat1335 = shufflevector <4 x double> %broadcast.splatinsert1334, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1337 = insertelement <4 x double> poison, double %_p_scalar_732, i32 0
...
vector.body1318:                                  ; preds = %vector.body1318, %vector.ph1326
  ...
  %308 = add nuw nsw i64 %index1329, %272
  %309 = add nuw nsw i64 %index1329, %polly.access.mul.Packed_MemRef_call1526717
  %310 = getelementptr double, double* %Packed_MemRef_call1526, i64 %309
  %311 = bitcast double* %310 to <4 x double>*
  %wide.load1333 = load <4 x double>, <4 x double>* %311, align 8
  %312 = fmul fast <4 x double> %broadcast.splat1335, %wide.load1333
  %313 = getelementptr double, double* %Packed_MemRef_call2528, i64 %309
  %314 = bitcast double* %313 to <4 x double>*
  %wide.load1336 = load <4 x double>, <4 x double>* %314, align 8
  %315 = fmul fast <4 x double> %broadcast.splat1338, %wide.load1336
  %316 = shl i64 %308, 3
  %317 = add i64 %316, %307
  %318 = getelementptr i8, i8* %call, i64 %317
  %319 = bitcast i8* %318 to <4 x double>*
  %wide.load1339 = load <4 x double>, <4 x double>* %319, align 8, !alias.scope !98, !noalias !100
  ...
  %322 = fadd fast <4 x double> %321, %wide.load1339
  ...
  %324 = icmp eq i64 %index.next1330, %n.vec1328
  br i1 %324, label %middle.block1316, label %vector.body1318, !llvm.loop !109

middle.block1316:                                 ; preds = %vector.body1318
  %cmp.n1332 = icmp eq i64 %304, %n.vec1328
  br i1 %cmp.n1332, label %polly.loop_exit712, label %polly.loop_header710.preheader1448

polly.loop_header710.preheader1448:               ; preds = %polly.loop_header710.preheader, %middle.block1316
  %polly.indvar714.ph = phi i64 [ 0, %polly.loop_header710.preheader ], [ %n.vec1328, %middle.block1316 ]
...
polly.loop_header710:                             ; preds = %polly.loop_header710.preheader1448, %polly.loop_header710
  %polly.indvar714 = phi i64 [ %polly.indvar_next715, %polly.loop_header710 ], [ %polly.indvar714.ph, %polly.loop_header710.preheader1448 ]
  %325 = add nuw nsw i64 %polly.indvar714, %272
  ...
  %exitcond1169.not = icmp eq i64 %polly.indvar714, %smin1168
  br i1 %exitcond1169.not, label %polly.loop_exit712, label %polly.loop_header710, !llvm.loop !110
...
vector.ph1246:                                    ; preds = %polly.loop_header874
  %broadcast.splatinsert1253 = insertelement <4 x i64> poison, i64 %332, i32 0
  %broadcast.splat1254 = shufflevector <4 x i64> %broadcast.splatinsert1253, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1255 = insertelement <4 x i32> poison, i32 %335, i32 0
...
vector.body1245:                                  ; preds = %vector.body1245, %vector.ph1246
  ...
  %337 = add nuw nsw <4 x i64> %vec.ind1251, %broadcast.splat1254
  %338 = trunc <4 x i64> %337 to <4 x i32>
  %339 = mul <4 x i32> %broadcast.splat1256, %338
  ...
  %349 = icmp eq i64 %index.next1248, %331
  br i1 %349, label %polly.loop_exit882, label %vector.body1245, !llvm.loop !116

polly.loop_exit882:                               ; preds = %vector.body1245, %polly.loop_header880
  %polly.indvar_next878 = add nuw nsw i64 %polly.indvar877, 1
  %exitcond1203.not = icmp eq i64 %polly.indvar877, %329
...
polly.loop_header880:                             ; preds = %polly.loop_header874, %polly.loop_header880
  ...
  %exitcond1199.not = icmp eq i64 %polly.indvar883, %333
  br i1 %exitcond1199.not, label %polly.loop_exit882, label %polly.loop_header880, !llvm.loop !117
...
polly.loop_header895:                             ; preds = %polly.loop_exit903, %polly.loop_header889
  ...
  %smin1260 = call i64 @llvm.smin.i64(i64 %359, i64 -968)
  %360 = add nsw i64 %smin1260, 1000
  %smin1188 = call i64 @llvm.smin.i64(i64 %indvars.iv1186, i64 -968)
  %361 = shl nsw i64 %polly.indvar898, 5
  %362 = add nsw i64 %smin1188, 999
...
vector.body1259:                                  ; preds = %vector.body1259, %vector.ph1262
  ...
  %366 = add nuw nsw <4 x i64> %vec.ind1269, %broadcast.splat1272
  %367 = trunc <4 x i64> %366 to <4 x i32>
  %368 = mul <4 x i32> %broadcast.splat1274, %367
  ...
  %378 = icmp eq i64 %index.next1266, %360
  br i1 %378, label %polly.loop_exit909, label %vector.body1259, !llvm.loop !119

polly.loop_exit909:                               ; preds = %vector.body1259, %polly.loop_header907
  %polly.indvar_next905 = add nuw nsw i64 %polly.indvar904, 1
  %exitcond1193.not = icmp eq i64 %polly.indvar904, %358
...
polly.loop_header907:                             ; preds = %polly.loop_header901, %polly.loop_header907
  ...
  %exitcond1189.not = icmp eq i64 %polly.indvar910, %362
  br i1 %exitcond1189.not, label %polly.loop_exit909, label %polly.loop_header907, !llvm.loop !120
...
polly.loop_header921:                             ; preds = %polly.loop_exit929, %polly.loop_header915
  ...
  %smin1278 = call i64 @llvm.smin.i64(i64 %388, i64 -968)
  %389 = add nsw i64 %smin1278, 1000
  %smin1178 = call i64 @llvm.smin.i64(i64 %indvars.iv1176, i64 -968)
  %390 = shl nsw i64 %polly.indvar924, 5
  %391 = add nsw i64 %smin1178, 999
...
vector.body1277:                                  ; preds = %vector.body1277, %vector.ph1280
  ...
  %395 = add nuw nsw <4 x i64> %vec.ind1287, %broadcast.splat1290
  %396 = trunc <4 x i64> %395 to <4 x i32>
  %397 = mul <4 x i32> %broadcast.splat1292, %396
  ...
  %407 = icmp eq i64 %index.next1284, %389
  br i1 %407, label %polly.loop_exit935, label %vector.body1277, !llvm.loop !122

polly.loop_exit935:                               ; preds = %vector.body1277, %polly.loop_header933
  %polly.indvar_next931 = add nuw nsw i64 %polly.indvar930, 1
  %exitcond1183.not = icmp eq i64 %polly.indvar930, %387
...
polly.loop_header933:                             ; preds = %polly.loop_header927, %polly.loop_header933
  ...
  %exitcond1179.not = icmp eq i64 %polly.indvar936, %391
  br i1 %exitcond1179.not, label %polly.loop_exit935, label %polly.loop_header933, !llvm.loop !123
}
