; ModuleID = 'syr2k_recreations//mmp_syr2k_S_1.c'
source_filename = "syr2k_recreations//mmp_syr2k_S_1.c"
...
kernel_syr2k.exit:                                ; preds = %for.inc49.i, %polly.loop_exit497
...
kernel_syr2k.exit90:                              ; preds = %for.inc49.i89, %polly.loop_exit352
  tail call void (...) @polybench_timer_stop() #5
  tail call void (...) @polybench_timer_print() #5
  tail call void (...) @polybench_timer_start() #5
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond751.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !68
...
polly.loop_header205:                             ; preds = %polly.loop_exit219.3, %polly.loop_header199
  %polly.indvar208 = phi i64 [ 0, %polly.loop_header199 ], [ %polly.indvar_next209, %polly.loop_exit219.3 ]
  %110 = shl nuw nsw i64 %polly.indvar208, 3
  %scevgep223 = getelementptr i8, i8* %call1, i64 %110
  %scevgep227 = getelementptr i8, i8* %call2, i64 %110
  %scevgep228 = getelementptr i8, i8* %scevgep227, i64 %98
  %scevgep228229 = bitcast i8* %scevgep228 to double*
  %_p_scalar_230 = load double, double* %scevgep228229, align 8, !alias.scope !66, !noalias !70
  %scevgep236 = getelementptr i8, i8* %scevgep223, i64 %98
  %scevgep236237 = bitcast i8* %scevgep236 to double*
  %_p_scalar_238 = load double, double* %scevgep236237, align 8, !alias.scope !65, !noalias !71
  br label %polly.loop_header217

polly.loop_exit219:                               ; preds = %polly.loop_header217
  %scevgep228.1 = getelementptr i8, i8* %scevgep227, i64 %101
  %scevgep228229.1 = bitcast i8* %scevgep228.1 to double*
  %_p_scalar_230.1 = load double, double* %scevgep228229.1, align 8, !alias.scope !66, !noalias !70
  %scevgep236.1 = getelementptr i8, i8* %scevgep223, i64 %101
  %scevgep236237.1 = bitcast i8* %scevgep236.1 to double*
  %_p_scalar_238.1 = load double, double* %scevgep236237.1, align 8, !alias.scope !65, !noalias !71
...
polly.loop_header217:                             ; preds = %polly.loop_header217, %polly.loop_header205
  ...
  %111 = mul nuw nsw i64 %polly.indvar220, 480
  %scevgep224 = getelementptr i8, i8* %scevgep223, i64 %111
  ...
  %scevgep232 = getelementptr i8, i8* %scevgep227, i64 %111
  ...
  %112 = shl nuw nsw i64 %polly.indvar220, 3
  %113 = add nuw nsw i64 %112, %99
  %scevgep239 = getelementptr i8, i8* %call, i64 %113
  %scevgep239240 = bitcast i8* %scevgep239 to double*
  %_p_scalar_241 = load double, double* %scevgep239240, align 8, !alias.scope !62, !noalias !64
  %p_reass.add.i116 = fadd fast double %p_mul37.i114, %p_mul27.i112
  %p_reass.mul.i117 = fmul fast double %p_reass.add.i116, 1.500000e+00
  %p_add42.i118 = fadd fast double %p_reass.mul.i117, %_p_scalar_241
  store double %p_add42.i118, double* %scevgep239240, align 8, !alias.scope !62, !noalias !64
...
polly.loop_header328:                             ; preds = %kernel_syr2k.exit, %polly.loop_exit336
  ...
  %114 = add i64 %indvar1183, 1
  %115 = mul nuw nsw i64 %polly.indvar331, 640
  %scevgep340 = getelementptr i8, i8* %call, i64 %115
  %min.iters.check1185 = icmp ult i64 %114, 4
...
vector.body1182:                                  ; preds = %vector.body1182, %vector.ph1186
  ...
  %116 = shl nuw nsw i64 %index1189, 3
  %117 = getelementptr i8, i8* %scevgep340, i64 %116
  %118 = bitcast i8* %117 to <4 x double>*
  %wide.load1193 = load <4 x double>, <4 x double>* %118, align 8, !alias.scope !72, !noalias !74
  %119 = fmul fast <4 x double> %wide.load1193, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %121 = icmp eq i64 %index.next1190, %n.vec1188
  br i1 %121, label %middle.block1180, label %vector.body1182, !llvm.loop !77

middle.block1180:                                 ; preds = %vector.body1182
  %cmp.n1192 = icmp eq i64 %114, %n.vec1188
...
polly.loop_header334:                             ; preds = %polly.loop_header334.preheader, %polly.loop_header334
  ...
  %122 = shl nuw nsw i64 %polly.indvar337, 3
  %scevgep341 = getelementptr i8, i8* %scevgep340, i64 %122
  %scevgep341342 = bitcast i8* %scevgep341 to double*
  %_p_scalar_343 = load double, double* %scevgep341342, align 8, !alias.scope !72, !noalias !74
  %p_mul.i57 = fmul fast double %_p_scalar_343, 1.200000e+00
  store double %p_mul.i57, double* %scevgep341342, align 8, !alias.scope !72, !noalias !74
  %polly.indvar_next338 = add nuw nsw i64 %polly.indvar337, 1
  %exitcond761.not = icmp eq i64 %polly.indvar_next338, %polly.indvar331
  br i1 %exitcond761.not, label %polly.loop_exit336, label %polly.loop_header334, !llvm.loop !78

polly.loop_header344:                             ; preds = %polly.loop_exit336, %polly.loop_exit352
  %indvars.iv753 = phi i64 [ %indvars.iv.next754, %polly.loop_exit352 ], [ 1, %polly.loop_exit336 ]
  %polly.indvar347 = phi i64 [ %polly.indvar_next348, %polly.loop_exit352 ], [ 0, %polly.loop_exit336 ]
  %123 = shl nsw i64 %polly.indvar347, 2
  %124 = mul nsw i64 %polly.indvar347, 1920
  %125 = mul nsw i64 %polly.indvar347, 2560
  %126 = or i64 %123, 1
  ...
  %135 = add nuw nsw i64 %indvars.iv753, 2
  br label %polly.loop_header350

polly.loop_exit352:                               ; preds = %polly.loop_exit364.3
...
polly.loop_header350:                             ; preds = %polly.loop_exit364.3, %polly.loop_header344
  %polly.indvar353 = phi i64 [ 0, %polly.loop_header344 ], [ %polly.indvar_next354, %polly.loop_exit364.3 ]
  %136 = shl nuw nsw i64 %polly.indvar353, 3
  %scevgep368 = getelementptr i8, i8* %call1, i64 %136
  %scevgep372 = getelementptr i8, i8* %call2, i64 %136
  %scevgep373 = getelementptr i8, i8* %scevgep372, i64 %124
  %scevgep373374 = bitcast i8* %scevgep373 to double*
  %_p_scalar_375 = load double, double* %scevgep373374, align 8, !alias.scope !76, !noalias !79
  %scevgep381 = getelementptr i8, i8* %scevgep368, i64 %124
...
polly.loop_exit364:                               ; preds = %polly.loop_header362
  %scevgep373.1 = getelementptr i8, i8* %scevgep372, i64 %127
  %scevgep373374.1 = bitcast i8* %scevgep373.1 to double*
  %_p_scalar_375.1 = load double, double* %scevgep373374.1, align 8, !alias.scope !76, !noalias !79
  %scevgep381.1 = getelementptr i8, i8* %scevgep368, i64 %127
...
polly.loop_header362:                             ; preds = %polly.loop_header362, %polly.loop_header350
  %polly.indvar365 = phi i64 [ 0, %polly.loop_header350 ], [ %polly.indvar_next366, %polly.loop_header362 ]
  %137 = mul nuw nsw i64 %polly.indvar365, 480
  %scevgep369 = getelementptr i8, i8* %scevgep368, i64 %137
  %scevgep369370 = bitcast i8* %scevgep369 to double*
  %_p_scalar_371 = load double, double* %scevgep369370, align 8, !alias.scope !75, !noalias !80
  %p_mul27.i73 = fmul fast double %_p_scalar_375, %_p_scalar_371
  %scevgep377 = getelementptr i8, i8* %scevgep372, i64 %137
  %scevgep377378 = bitcast i8* %scevgep377 to double*
  %_p_scalar_379 = load double, double* %scevgep377378, align 8, !alias.scope !76, !noalias !79
  %p_mul37.i75 = fmul fast double %_p_scalar_383, %_p_scalar_379
  %138 = shl nuw nsw i64 %polly.indvar365, 3
  %139 = add nuw nsw i64 %138, %125
  %scevgep384 = getelementptr i8, i8* %call, i64 %139
  %scevgep384385 = bitcast i8* %scevgep384 to double*
  %_p_scalar_386 = load double, double* %scevgep384385, align 8, !alias.scope !72, !noalias !74
  %p_reass.add.i77 = fadd fast double %p_mul37.i75, %p_mul27.i73
  %p_reass.mul.i78 = fmul fast double %p_reass.add.i77, 1.500000e+00
  %p_add42.i79 = fadd fast double %p_reass.mul.i78, %_p_scalar_386
  store double %p_add42.i79, double* %scevgep384385, align 8, !alias.scope !72, !noalias !74
...
polly.loop_header473:                             ; preds = %init_array.exit, %polly.loop_exit481
  ...
  %141 = mul nuw nsw i64 %polly.indvar476, 640
  %scevgep485 = getelementptr i8, i8* %call, i64 %141
  %min.iters.check1159 = icmp ult i64 %140, 4
...
vector.body1158:                                  ; preds = %vector.body1158, %vector.ph1160
  ...
  %142 = shl nuw nsw i64 %index1163, 3
  %143 = getelementptr i8, i8* %scevgep485, i64 %142
  %144 = bitcast i8* %143 to <4 x double>*
  %wide.load1167 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !81, !noalias !83
  %145 = fmul fast <4 x double> %wide.load1167, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %147 = icmp eq i64 %index.next1164, %n.vec1162
  br i1 %147, label %middle.block1156, label %vector.body1158, !llvm.loop !86

middle.block1156:                                 ; preds = %vector.body1158
  %cmp.n1166 = icmp eq i64 %140, %n.vec1162
...
polly.loop_header479:                             ; preds = %polly.loop_header479.preheader, %polly.loop_header479
  ...
  %148 = shl nuw nsw i64 %polly.indvar482, 3
  %scevgep486 = getelementptr i8, i8* %scevgep485, i64 %148
  %scevgep486487 = bitcast i8* %scevgep486 to double*
  %_p_scalar_488 = load double, double* %scevgep486487, align 8, !alias.scope !81, !noalias !83
  %p_mul.i = fmul fast double %_p_scalar_488, 1.200000e+00
  store double %p_mul.i, double* %scevgep486487, align 8, !alias.scope !81, !noalias !83
  %polly.indvar_next483 = add nuw nsw i64 %polly.indvar482, 1
  %exitcond771.not = icmp eq i64 %polly.indvar_next483, %polly.indvar476
  br i1 %exitcond771.not, label %polly.loop_exit481, label %polly.loop_header479, !llvm.loop !87

polly.loop_header489:                             ; preds = %polly.loop_exit481, %polly.loop_exit497
  %indvars.iv763 = phi i64 [ %indvars.iv.next764, %polly.loop_exit497 ], [ 1, %polly.loop_exit481 ]
  %polly.indvar492 = phi i64 [ %polly.indvar_next493, %polly.loop_exit497 ], [ 0, %polly.loop_exit481 ]
  %149 = shl nsw i64 %polly.indvar492, 2
  %150 = mul nsw i64 %polly.indvar492, 1920
  %151 = mul nsw i64 %polly.indvar492, 2560
  %152 = or i64 %149, 1
  ...
  %161 = add nuw nsw i64 %indvars.iv763, 2
  br label %polly.loop_header495

polly.loop_exit497:                               ; preds = %polly.loop_exit509.3
...
polly.loop_header495:                             ; preds = %polly.loop_exit509.3, %polly.loop_header489
  %polly.indvar498 = phi i64 [ 0, %polly.loop_header489 ], [ %polly.indvar_next499, %polly.loop_exit509.3 ]
  %162 = shl nuw nsw i64 %polly.indvar498, 3
  %scevgep513 = getelementptr i8, i8* %call1, i64 %162
  %scevgep517 = getelementptr i8, i8* %call2, i64 %162
  %scevgep518 = getelementptr i8, i8* %scevgep517, i64 %150
  %scevgep518519 = bitcast i8* %scevgep518 to double*
  %_p_scalar_520 = load double, double* %scevgep518519, align 8, !alias.scope !85, !noalias !88
  %scevgep526 = getelementptr i8, i8* %scevgep513, i64 %150
  %scevgep526527 = bitcast i8* %scevgep526 to double*
  %_p_scalar_528 = load double, double* %scevgep526527, align 8, !alias.scope !84, !noalias !89
  br label %polly.loop_header507

polly.loop_exit509:                               ; preds = %polly.loop_header507
  %scevgep518.1 = getelementptr i8, i8* %scevgep517, i64 %153
  %scevgep518519.1 = bitcast i8* %scevgep518.1 to double*
  %_p_scalar_520.1 = load double, double* %scevgep518519.1, align 8, !alias.scope !85, !noalias !88
  %scevgep526.1 = getelementptr i8, i8* %scevgep513, i64 %153
  %scevgep526527.1 = bitcast i8* %scevgep526.1 to double*
  %_p_scalar_528.1 = load double, double* %scevgep526527.1, align 8, !alias.scope !84, !noalias !89
  br label %polly.loop_header507.1

polly.loop_header507:                             ; preds = %polly.loop_header507, %polly.loop_header495
  %polly.indvar510 = phi i64 [ 0, %polly.loop_header495 ], [ %polly.indvar_next511, %polly.loop_header507 ]
  %163 = mul nuw nsw i64 %polly.indvar510, 480
  %scevgep514 = getelementptr i8, i8* %scevgep513, i64 %163
  %scevgep514515 = bitcast i8* %scevgep514 to double*
  %_p_scalar_516 = load double, double* %scevgep514515, align 8, !alias.scope !84, !noalias !89
  %p_mul27.i = fmul fast double %_p_scalar_520, %_p_scalar_516
  %scevgep522 = getelementptr i8, i8* %scevgep517, i64 %163
  %scevgep522523 = bitcast i8* %scevgep522 to double*
  %_p_scalar_524 = load double, double* %scevgep522523, align 8, !alias.scope !85, !noalias !88
  %p_mul37.i = fmul fast double %_p_scalar_528, %_p_scalar_524
  %164 = shl nuw nsw i64 %polly.indvar510, 3
  %165 = add nuw nsw i64 %164, %151
  %scevgep529 = getelementptr i8, i8* %call, i64 %165
  %scevgep529530 = bitcast i8* %scevgep529 to double*
  %_p_scalar_531 = load double, double* %scevgep529530, align 8, !alias.scope !81, !noalias !83
  %p_reass.add.i = fadd fast double %p_mul37.i, %p_mul27.i
  %p_reass.mul.i = fmul fast double %p_reass.add.i, 1.500000e+00
  %p_add42.i = fadd fast double %p_reass.mul.i, %_p_scalar_531
  store double %p_add42.i, double* %scevgep529530, align 8, !alias.scope !81, !noalias !83
...
polly.loop_header670:                             ; preds = %entry, %polly.loop_exit678
  ...
  %166 = mul nuw nsw i64 %polly.indvar673, 640
  %167 = trunc i64 %polly.indvar673 to i32
  %broadcast.splatinsert890 = insertelement <4 x i32> poison, i32 %167, i32 0
...
vector.body880:                                   ; preds = %vector.body880, %polly.loop_header670
  ...
  %168 = mul <4 x i32> %vec.ind888, %broadcast.splat891
  ...
  %173 = shl i64 %index882, 3
  %174 = add nuw nsw i64 %173, %166
  %175 = getelementptr i8, i8* %call, i64 %174
  %176 = bitcast i8* %175 to <4 x double>*
  store <4 x double> %172, <4 x double>* %176, align 8, !alias.scope !90, !noalias !92
  %index.next883 = add i64 %index882, 4
  %vec.ind.next889 = add <4 x i32> %vec.ind888, <i32 4, i32 4, i32 4, i32 4>
  %177 = icmp eq i64 %index.next883, 32
  br i1 %177, label %polly.loop_exit678, label %vector.body880, !llvm.loop !95
...
polly.loop_header697:                             ; preds = %polly.loop_exit678.2.2, %polly.loop_exit705
  ...
  %178 = mul nuw nsw i64 %polly.indvar700, 480
  %179 = trunc i64 %polly.indvar700 to i32
  %broadcast.splatinsert1004 = insertelement <4 x i32> poison, i32 %179, i32 0
...
vector.body994:                                   ; preds = %vector.body994, %polly.loop_header697
  ...
  %180 = mul <4 x i32> %vec.ind1002, %broadcast.splat1005
  ...
  %185 = shl i64 %index996, 3
  %186 = add i64 %185, %178
  %187 = getelementptr i8, i8* %call2, i64 %186
  %188 = bitcast i8* %187 to <4 x double>*
  store <4 x double> %184, <4 x double>* %188, align 8, !alias.scope !94, !noalias !96
  %index.next997 = add i64 %index996, 4
  %vec.ind.next1003 = add <4 x i32> %vec.ind1002, <i32 4, i32 4, i32 4, i32 4>
  %189 = icmp eq i64 %index.next997, 32
  br i1 %189, label %polly.loop_exit705, label %vector.body994, !llvm.loop !97
...
polly.loop_header723:                             ; preds = %polly.loop_exit705.1.2, %polly.loop_exit731
  ...
  %190 = mul nuw nsw i64 %polly.indvar726, 480
  %191 = trunc i64 %polly.indvar726 to i32
...
vector.body1072:                                  ; preds = %vector.body1072, %polly.loop_header723
  ...
  %192 = mul <4 x i32> %vec.ind1080, %broadcast.splat1083
  ...
  %197 = shl i64 %index1074, 3
  %198 = add i64 %197, %190
  %199 = getelementptr i8, i8* %call1, i64 %198
  %200 = bitcast i8* %199 to <4 x double>*
  store <4 x double> %196, <4 x double>* %200, align 8, !alias.scope !93, !noalias !98
  %index.next1075 = add i64 %index1074, 4
  %vec.ind.next1081 = add <4 x i32> %vec.ind1080, <i32 4, i32 4, i32 4, i32 4>
  %201 = icmp eq i64 %index.next1075, 32
  br i1 %201, label %polly.loop_exit731, label %vector.body1072, !llvm.loop !99
...
polly.loop_header217.1:                           ; preds = %polly.loop_header217.1, %polly.loop_exit219
  %polly.indvar220.1 = phi i64 [ 0, %polly.loop_exit219 ], [ %polly.indvar_next221.1, %polly.loop_header217.1 ]
  %202 = mul nuw nsw i64 %polly.indvar220.1, 480
  %scevgep224.1 = getelementptr i8, i8* %scevgep223, i64 %202
  ...
  %scevgep232.1 = getelementptr i8, i8* %scevgep227, i64 %202
  ...
  %203 = shl nuw nsw i64 %polly.indvar220.1, 3
  %204 = add nuw nsw i64 %203, %102
  %scevgep239.1 = getelementptr i8, i8* %call, i64 %204
  %scevgep239240.1 = bitcast i8* %scevgep239.1 to double*
  %_p_scalar_241.1 = load double, double* %scevgep239240.1, align 8, !alias.scope !62, !noalias !64
  %p_reass.add.i116.1 = fadd fast double %p_mul37.i114.1, %p_mul27.i112.1
  %p_reass.mul.i117.1 = fmul fast double %p_reass.add.i116.1, 1.500000e+00
  %p_add42.i118.1 = fadd fast double %p_reass.mul.i117.1, %_p_scalar_241.1
  store double %p_add42.i118.1, double* %scevgep239240.1, align 8, !alias.scope !62, !noalias !64
...
polly.loop_exit219.1:                             ; preds = %polly.loop_header217.1
  %scevgep228.2 = getelementptr i8, i8* %scevgep227, i64 %104
  %scevgep228229.2 = bitcast i8* %scevgep228.2 to double*
  %_p_scalar_230.2 = load double, double* %scevgep228229.2, align 8, !alias.scope !66, !noalias !70
  %scevgep236.2 = getelementptr i8, i8* %scevgep223, i64 %104
  %scevgep236237.2 = bitcast i8* %scevgep236.2 to double*
  %_p_scalar_238.2 = load double, double* %scevgep236237.2, align 8, !alias.scope !65, !noalias !71
  br label %polly.loop_header217.2

polly.loop_header217.2:                           ; preds = %polly.loop_header217.2, %polly.loop_exit219.1
  %polly.indvar220.2 = phi i64 [ 0, %polly.loop_exit219.1 ], [ %polly.indvar_next221.2, %polly.loop_header217.2 ]
  %205 = mul nuw nsw i64 %polly.indvar220.2, 480
  %scevgep224.2 = getelementptr i8, i8* %scevgep223, i64 %205
  ...
  %scevgep232.2 = getelementptr i8, i8* %scevgep227, i64 %205
  ...
  %206 = shl nuw nsw i64 %polly.indvar220.2, 3
  %207 = add nuw nsw i64 %206, %105
  %scevgep239.2 = getelementptr i8, i8* %call, i64 %207
  %scevgep239240.2 = bitcast i8* %scevgep239.2 to double*
  %_p_scalar_241.2 = load double, double* %scevgep239240.2, align 8, !alias.scope !62, !noalias !64
  %p_reass.add.i116.2 = fadd fast double %p_mul37.i114.2, %p_mul27.i112.2
  %p_reass.mul.i117.2 = fmul fast double %p_reass.add.i116.2, 1.500000e+00
  %p_add42.i118.2 = fadd fast double %p_reass.mul.i117.2, %_p_scalar_241.2
  store double %p_add42.i118.2, double* %scevgep239240.2, align 8, !alias.scope !62, !noalias !64
  %polly.indvar_next221.2 = add nuw nsw i64 %polly.indvar220.2, 1
  %208 = add nuw nsw i64 %indvars.iv, 1
  %exitcond.2.not = icmp eq i64 %polly.indvar220.2, %208
...
polly.loop_exit219.2:                             ; preds = %polly.loop_header217.2
  %scevgep228.3 = getelementptr i8, i8* %scevgep227, i64 %107
  %scevgep228229.3 = bitcast i8* %scevgep228.3 to double*
  %_p_scalar_230.3 = load double, double* %scevgep228229.3, align 8, !alias.scope !66, !noalias !70
  %scevgep236.3 = getelementptr i8, i8* %scevgep223, i64 %107
  %scevgep236237.3 = bitcast i8* %scevgep236.3 to double*
  %_p_scalar_238.3 = load double, double* %scevgep236237.3, align 8, !alias.scope !65, !noalias !71
  br label %polly.loop_header217.3

polly.loop_header217.3:                           ; preds = %polly.loop_header217.3, %polly.loop_exit219.2
  %polly.indvar220.3 = phi i64 [ 0, %polly.loop_exit219.2 ], [ %polly.indvar_next221.3, %polly.loop_header217.3 ]
  %209 = mul nuw nsw i64 %polly.indvar220.3, 480
  %scevgep224.3 = getelementptr i8, i8* %scevgep223, i64 %209
  ...
  %scevgep232.3 = getelementptr i8, i8* %scevgep227, i64 %209
  ...
  %210 = shl nuw nsw i64 %polly.indvar220.3, 3
  %211 = add nuw nsw i64 %210, %108
  %scevgep239.3 = getelementptr i8, i8* %call, i64 %211
  %scevgep239240.3 = bitcast i8* %scevgep239.3 to double*
  %_p_scalar_241.3 = load double, double* %scevgep239240.3, align 8, !alias.scope !62, !noalias !64
  %p_reass.add.i116.3 = fadd fast double %p_mul37.i114.3, %p_mul27.i112.3
  %p_reass.mul.i117.3 = fmul fast double %p_reass.add.i116.3, 1.500000e+00
  %p_add42.i118.3 = fadd fast double %p_reass.mul.i117.3, %_p_scalar_241.3
  store double %p_add42.i118.3, double* %scevgep239240.3, align 8, !alias.scope !62, !noalias !64
  %polly.indvar_next221.3 = add nuw nsw i64 %polly.indvar220.3, 1
  %exitcond.3.not = icmp eq i64 %polly.indvar220.3, %109
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  ...
  %exitcond749.not = icmp eq i64 %polly.indvar_next209, 60
  br i1 %exitcond749.not, label %polly.loop_exit207, label %polly.loop_header205

polly.loop_header362.1:                           ; preds = %polly.loop_header362.1, %polly.loop_exit364
  %polly.indvar365.1 = phi i64 [ 0, %polly.loop_exit364 ], [ %polly.indvar_next366.1, %polly.loop_header362.1 ]
  %212 = mul nuw nsw i64 %polly.indvar365.1, 480
  %scevgep369.1 = getelementptr i8, i8* %scevgep368, i64 %212
  %scevgep369370.1 = bitcast i8* %scevgep369.1 to double*
  %_p_scalar_371.1 = load double, double* %scevgep369370.1, align 8, !alias.scope !75, !noalias !80
  %p_mul27.i73.1 = fmul fast double %_p_scalar_375.1, %_p_scalar_371.1
  %scevgep377.1 = getelementptr i8, i8* %scevgep372, i64 %212
  %scevgep377378.1 = bitcast i8* %scevgep377.1 to double*
  %_p_scalar_379.1 = load double, double* %scevgep377378.1, align 8, !alias.scope !76, !noalias !79
  %p_mul37.i75.1 = fmul fast double %_p_scalar_383.1, %_p_scalar_379.1
  %213 = shl nuw nsw i64 %polly.indvar365.1, 3
  %214 = add nuw nsw i64 %213, %128
  %scevgep384.1 = getelementptr i8, i8* %call, i64 %214
  %scevgep384385.1 = bitcast i8* %scevgep384.1 to double*
  %_p_scalar_386.1 = load double, double* %scevgep384385.1, align 8, !alias.scope !72, !noalias !74
  %p_reass.add.i77.1 = fadd fast double %p_mul37.i75.1, %p_mul27.i73.1
  %p_reass.mul.i78.1 = fmul fast double %p_reass.add.i77.1, 1.500000e+00
  %p_add42.i79.1 = fadd fast double %p_reass.mul.i78.1, %_p_scalar_386.1
  store double %p_add42.i79.1, double* %scevgep384385.1, align 8, !alias.scope !72, !noalias !74
...
polly.loop_exit364.1:                             ; preds = %polly.loop_header362.1
  %scevgep373.2 = getelementptr i8, i8* %scevgep372, i64 %130
  %scevgep373374.2 = bitcast i8* %scevgep373.2 to double*
  %_p_scalar_375.2 = load double, double* %scevgep373374.2, align 8, !alias.scope !76, !noalias !79
  %scevgep381.2 = getelementptr i8, i8* %scevgep368, i64 %130
...
polly.loop_header362.2:                           ; preds = %polly.loop_header362.2, %polly.loop_exit364.1
  %polly.indvar365.2 = phi i64 [ 0, %polly.loop_exit364.1 ], [ %polly.indvar_next366.2, %polly.loop_header362.2 ]
  %215 = mul nuw nsw i64 %polly.indvar365.2, 480
  %scevgep369.2 = getelementptr i8, i8* %scevgep368, i64 %215
  %scevgep369370.2 = bitcast i8* %scevgep369.2 to double*
  %_p_scalar_371.2 = load double, double* %scevgep369370.2, align 8, !alias.scope !75, !noalias !80
  %p_mul27.i73.2 = fmul fast double %_p_scalar_375.2, %_p_scalar_371.2
  %scevgep377.2 = getelementptr i8, i8* %scevgep372, i64 %215
  %scevgep377378.2 = bitcast i8* %scevgep377.2 to double*
  %_p_scalar_379.2 = load double, double* %scevgep377378.2, align 8, !alias.scope !76, !noalias !79
  %p_mul37.i75.2 = fmul fast double %_p_scalar_383.2, %_p_scalar_379.2
  %216 = shl nuw nsw i64 %polly.indvar365.2, 3
  %217 = add nuw nsw i64 %216, %131
  %scevgep384.2 = getelementptr i8, i8* %call, i64 %217
  %scevgep384385.2 = bitcast i8* %scevgep384.2 to double*
  %_p_scalar_386.2 = load double, double* %scevgep384385.2, align 8, !alias.scope !72, !noalias !74
  %p_reass.add.i77.2 = fadd fast double %p_mul37.i75.2, %p_mul27.i73.2
  %p_reass.mul.i78.2 = fmul fast double %p_reass.add.i77.2, 1.500000e+00
  %p_add42.i79.2 = fadd fast double %p_reass.mul.i78.2, %_p_scalar_386.2
  store double %p_add42.i79.2, double* %scevgep384385.2, align 8, !alias.scope !72, !noalias !74
  %polly.indvar_next366.2 = add nuw nsw i64 %polly.indvar365.2, 1
  %218 = add nuw nsw i64 %indvars.iv753, 1
  %exitcond757.2.not = icmp eq i64 %polly.indvar365.2, %218
...
polly.loop_exit364.2:                             ; preds = %polly.loop_header362.2
  %scevgep373.3 = getelementptr i8, i8* %scevgep372, i64 %133
  %scevgep373374.3 = bitcast i8* %scevgep373.3 to double*
  %_p_scalar_375.3 = load double, double* %scevgep373374.3, align 8, !alias.scope !76, !noalias !79
  %scevgep381.3 = getelementptr i8, i8* %scevgep368, i64 %133
...
polly.loop_header362.3:                           ; preds = %polly.loop_header362.3, %polly.loop_exit364.2
  %polly.indvar365.3 = phi i64 [ 0, %polly.loop_exit364.2 ], [ %polly.indvar_next366.3, %polly.loop_header362.3 ]
  %219 = mul nuw nsw i64 %polly.indvar365.3, 480
  %scevgep369.3 = getelementptr i8, i8* %scevgep368, i64 %219
  %scevgep369370.3 = bitcast i8* %scevgep369.3 to double*
  %_p_scalar_371.3 = load double, double* %scevgep369370.3, align 8, !alias.scope !75, !noalias !80
  %p_mul27.i73.3 = fmul fast double %_p_scalar_375.3, %_p_scalar_371.3
  %scevgep377.3 = getelementptr i8, i8* %scevgep372, i64 %219
  %scevgep377378.3 = bitcast i8* %scevgep377.3 to double*
  %_p_scalar_379.3 = load double, double* %scevgep377378.3, align 8, !alias.scope !76, !noalias !79
  %p_mul37.i75.3 = fmul fast double %_p_scalar_383.3, %_p_scalar_379.3
  %220 = shl nuw nsw i64 %polly.indvar365.3, 3
  %221 = add nuw nsw i64 %220, %134
  %scevgep384.3 = getelementptr i8, i8* %call, i64 %221
  %scevgep384385.3 = bitcast i8* %scevgep384.3 to double*
  %_p_scalar_386.3 = load double, double* %scevgep384385.3, align 8, !alias.scope !72, !noalias !74
  %p_reass.add.i77.3 = fadd fast double %p_mul37.i75.3, %p_mul27.i73.3
  %p_reass.mul.i78.3 = fmul fast double %p_reass.add.i77.3, 1.500000e+00
  %p_add42.i79.3 = fadd fast double %p_reass.mul.i78.3, %_p_scalar_386.3
  store double %p_add42.i79.3, double* %scevgep384385.3, align 8, !alias.scope !72, !noalias !74
  %polly.indvar_next366.3 = add nuw nsw i64 %polly.indvar365.3, 1
  %exitcond757.3.not = icmp eq i64 %polly.indvar365.3, %135
...
polly.loop_exit364.3:                             ; preds = %polly.loop_header362.3
  ...
  %exitcond759.not = icmp eq i64 %polly.indvar_next354, 60
  br i1 %exitcond759.not, label %polly.loop_exit352, label %polly.loop_header350

polly.loop_header507.1:                           ; preds = %polly.loop_header507.1, %polly.loop_exit509
  %polly.indvar510.1 = phi i64 [ 0, %polly.loop_exit509 ], [ %polly.indvar_next511.1, %polly.loop_header507.1 ]
  %222 = mul nuw nsw i64 %polly.indvar510.1, 480
  %scevgep514.1 = getelementptr i8, i8* %scevgep513, i64 %222
  %scevgep514515.1 = bitcast i8* %scevgep514.1 to double*
  %_p_scalar_516.1 = load double, double* %scevgep514515.1, align 8, !alias.scope !84, !noalias !89
  %p_mul27.i.1 = fmul fast double %_p_scalar_520.1, %_p_scalar_516.1
  %scevgep522.1 = getelementptr i8, i8* %scevgep517, i64 %222
  %scevgep522523.1 = bitcast i8* %scevgep522.1 to double*
  %_p_scalar_524.1 = load double, double* %scevgep522523.1, align 8, !alias.scope !85, !noalias !88
  ...
  %_p_scalar_531.1 = load double, double* %scevgep529530.1, align 8, !alias.scope !81, !noalias !83
  %p_reass.add.i.1 = fadd fast double %p_mul37.i.1, %p_mul27.i.1
  %p_reass.mul.i.1 = fmul fast double %p_reass.add.i.1, 1.500000e+00
  %p_add42.i.1 = fadd fast double %p_reass.mul.i.1, %_p_scalar_531.1
  store double %p_add42.i.1, double* %scevgep529530.1, align 8, !alias.scope !81, !noalias !83
...
polly.loop_exit509.1:                             ; preds = %polly.loop_header507.1
  %scevgep518.2 = getelementptr i8, i8* %scevgep517, i64 %156
  %scevgep518519.2 = bitcast i8* %scevgep518.2 to double*
  %_p_scalar_520.2 = load double, double* %scevgep518519.2, align 8, !alias.scope !85, !noalias !88
  %scevgep526.2 = getelementptr i8, i8* %scevgep513, i64 %156
  %scevgep526527.2 = bitcast i8* %scevgep526.2 to double*
  %_p_scalar_528.2 = load double, double* %scevgep526527.2, align 8, !alias.scope !84, !noalias !89
  br label %polly.loop_header507.2

polly.loop_header507.2:                           ; preds = %polly.loop_header507.2, %polly.loop_exit509.1
  %polly.indvar510.2 = phi i64 [ 0, %polly.loop_exit509.1 ], [ %polly.indvar_next511.2, %polly.loop_header507.2 ]
  %225 = mul nuw nsw i64 %polly.indvar510.2, 480
  %scevgep514.2 = getelementptr i8, i8* %scevgep513, i64 %225
  %scevgep514515.2 = bitcast i8* %scevgep514.2 to double*
  %_p_scalar_516.2 = load double, double* %scevgep514515.2, align 8, !alias.scope !84, !noalias !89
  %p_mul27.i.2 = fmul fast double %_p_scalar_520.2, %_p_scalar_516.2
  %scevgep522.2 = getelementptr i8, i8* %scevgep517, i64 %225
  %scevgep522523.2 = bitcast i8* %scevgep522.2 to double*
  %_p_scalar_524.2 = load double, double* %scevgep522523.2, align 8, !alias.scope !85, !noalias !88
  %p_mul37.i.2 = fmul fast double %_p_scalar_528.2, %_p_scalar_524.2
  %226 = shl nuw nsw i64 %polly.indvar510.2, 3
  %227 = add nuw nsw i64 %226, %157
  %scevgep529.2 = getelementptr i8, i8* %call, i64 %227
  %scevgep529530.2 = bitcast i8* %scevgep529.2 to double*
  %_p_scalar_531.2 = load double, double* %scevgep529530.2, align 8, !alias.scope !81, !noalias !83
  %p_reass.add.i.2 = fadd fast double %p_mul37.i.2, %p_mul27.i.2
  %p_reass.mul.i.2 = fmul fast double %p_reass.add.i.2, 1.500000e+00
  %p_add42.i.2 = fadd fast double %p_reass.mul.i.2, %_p_scalar_531.2
  store double %p_add42.i.2, double* %scevgep529530.2, align 8, !alias.scope !81, !noalias !83
  %polly.indvar_next511.2 = add nuw nsw i64 %polly.indvar510.2, 1
  %228 = add nuw nsw i64 %indvars.iv763, 1
  %exitcond767.2.not = icmp eq i64 %polly.indvar510.2, %228
...
polly.loop_exit509.2:                             ; preds = %polly.loop_header507.2
  %scevgep518.3 = getelementptr i8, i8* %scevgep517, i64 %159
  %scevgep518519.3 = bitcast i8* %scevgep518.3 to double*
  %_p_scalar_520.3 = load double, double* %scevgep518519.3, align 8, !alias.scope !85, !noalias !88
  %scevgep526.3 = getelementptr i8, i8* %scevgep513, i64 %159
  %scevgep526527.3 = bitcast i8* %scevgep526.3 to double*
  %_p_scalar_528.3 = load double, double* %scevgep526527.3, align 8, !alias.scope !84, !noalias !89
  br label %polly.loop_header507.3

polly.loop_header507.3:                           ; preds = %polly.loop_header507.3, %polly.loop_exit509.2
  %polly.indvar510.3 = phi i64 [ 0, %polly.loop_exit509.2 ], [ %polly.indvar_next511.3, %polly.loop_header507.3 ]
  %229 = mul nuw nsw i64 %polly.indvar510.3, 480
  %scevgep514.3 = getelementptr i8, i8* %scevgep513, i64 %229
  %scevgep514515.3 = bitcast i8* %scevgep514.3 to double*
  %_p_scalar_516.3 = load double, double* %scevgep514515.3, align 8, !alias.scope !84, !noalias !89
  %p_mul27.i.3 = fmul fast double %_p_scalar_520.3, %_p_scalar_516.3
  %scevgep522.3 = getelementptr i8, i8* %scevgep517, i64 %229
  %scevgep522523.3 = bitcast i8* %scevgep522.3 to double*
  %_p_scalar_524.3 = load double, double* %scevgep522523.3, align 8, !alias.scope !85, !noalias !88
  %p_mul37.i.3 = fmul fast double %_p_scalar_528.3, %_p_scalar_524.3
  %230 = shl nuw nsw i64 %polly.indvar510.3, 3
  %231 = add nuw nsw i64 %230, %160
  %scevgep529.3 = getelementptr i8, i8* %call, i64 %231
  %scevgep529530.3 = bitcast i8* %scevgep529.3 to double*
  %_p_scalar_531.3 = load double, double* %scevgep529530.3, align 8, !alias.scope !81, !noalias !83
  %p_reass.add.i.3 = fadd fast double %p_mul37.i.3, %p_mul27.i.3
  %p_reass.mul.i.3 = fmul fast double %p_reass.add.i.3, 1.500000e+00
  %p_add42.i.3 = fadd fast double %p_reass.mul.i.3, %_p_scalar_531.3
  store double %p_add42.i.3, double* %scevgep529530.3, align 8, !alias.scope !81, !noalias !83
  %polly.indvar_next511.3 = add nuw nsw i64 %polly.indvar510.3, 1
  %exitcond767.3.not = icmp eq i64 %polly.indvar510.3, %161
...
polly.loop_exit509.3:                             ; preds = %polly.loop_header507.3
  ...
  %exitcond769.not = icmp eq i64 %polly.indvar_next499, 60
  br i1 %exitcond769.not, label %polly.loop_exit497, label %polly.loop_header495
...
polly.loop_header723.1:                           ; preds = %polly.loop_exit731, %polly.loop_exit731.1
  ...
  %232 = mul nuw nsw i64 %polly.indvar726.1, 480
  %233 = trunc i64 %polly.indvar726.1 to i32
...
vector.body1086:                                  ; preds = %vector.body1086, %polly.loop_header723.1
  ...
  br i1 %246, label %polly.loop_exit731.1, label %vector.body1086, !llvm.loop !100
...
polly.loop_header723.1799:                        ; preds = %polly.loop_exit731.1, %polly.loop_exit731.1810
  ...
  %247 = add nuw nsw i64 %polly.indvar726.1798, 32
...
vector.body1098:                                  ; preds = %vector.body1098, %polly.loop_header723.1799
  ...
  br i1 %259, label %polly.loop_exit731.1810, label %vector.body1098, !llvm.loop !101
...
polly.loop_header723.1.1:                         ; preds = %polly.loop_exit731.1810, %polly.loop_exit731.1.1
  ...
  %260 = add nuw nsw i64 %polly.indvar726.1.1, 32
...
vector.body1112:                                  ; preds = %vector.body1112, %polly.loop_header723.1.1
  ...
  br i1 %275, label %polly.loop_exit731.1.1, label %vector.body1112, !llvm.loop !102
...
polly.loop_header723.2:                           ; preds = %polly.loop_exit731.1.1, %polly.loop_exit731.2
  ...
  %276 = add nuw nsw i64 %polly.indvar726.2, 64
...
vector.body1124:                                  ; preds = %vector.body1124, %polly.loop_header723.2
  ...
  br i1 %288, label %polly.loop_exit731.2, label %vector.body1124, !llvm.loop !103
...
polly.loop_header723.1.2:                         ; preds = %polly.loop_exit731.2, %polly.loop_exit731.1.2
  ...
  %289 = add nuw nsw i64 %polly.indvar726.1.2, 64
...
vector.body1138:                                  ; preds = %vector.body1138, %polly.loop_header723.1.2
  ...
  br i1 %304, label %polly.loop_exit731.1.2, label %vector.body1138, !llvm.loop !104
...
polly.loop_header697.1:                           ; preds = %polly.loop_exit705, %polly.loop_exit705.1
  ...
  %305 = mul nuw nsw i64 %polly.indvar700.1, 480
  %306 = trunc i64 %polly.indvar700.1 to i32
...
vector.body1008:                                  ; preds = %vector.body1008, %polly.loop_header697.1
  ...
  br i1 %319, label %polly.loop_exit705.1, label %vector.body1008, !llvm.loop !105
...
polly.loop_header697.1813:                        ; preds = %polly.loop_exit705.1, %polly.loop_exit705.1824
  ...
  %320 = add nuw nsw i64 %polly.indvar700.1812, 32
...
vector.body1020:                                  ; preds = %vector.body1020, %polly.loop_header697.1813
  ...
  br i1 %332, label %polly.loop_exit705.1824, label %vector.body1020, !llvm.loop !106
...
polly.loop_header697.1.1:                         ; preds = %polly.loop_exit705.1824, %polly.loop_exit705.1.1
  ...
  %333 = add nuw nsw i64 %polly.indvar700.1.1, 32
...
vector.body1034:                                  ; preds = %vector.body1034, %polly.loop_header697.1.1
  ...
  br i1 %348, label %polly.loop_exit705.1.1, label %vector.body1034, !llvm.loop !107
...
polly.loop_header697.2:                           ; preds = %polly.loop_exit705.1.1, %polly.loop_exit705.2
  ...
  %349 = add nuw nsw i64 %polly.indvar700.2, 64
...
vector.body1046:                                  ; preds = %vector.body1046, %polly.loop_header697.2
  ...
  br i1 %361, label %polly.loop_exit705.2, label %vector.body1046, !llvm.loop !108
...
polly.loop_header697.1.2:                         ; preds = %polly.loop_exit705.2, %polly.loop_exit705.1.2
  ...
  %362 = add nuw nsw i64 %polly.indvar700.1.2, 64
...
vector.body1060:                                  ; preds = %vector.body1060, %polly.loop_header697.1.2
  ...
  br i1 %377, label %polly.loop_exit705.1.2, label %vector.body1060, !llvm.loop !109
...
polly.loop_header670.1:                           ; preds = %polly.loop_exit678, %polly.loop_exit678.1
  ...
  %378 = mul nuw nsw i64 %polly.indvar673.1, 640
  %379 = trunc i64 %polly.indvar673.1 to i32
...
vector.body894:                                   ; preds = %vector.body894, %polly.loop_header670.1
  ...
  br i1 %392, label %polly.loop_exit678.1, label %vector.body894, !llvm.loop !110
...
polly.loop_header670.2:                           ; preds = %polly.loop_exit678.1, %polly.loop_exit678.2
  ...
  %393 = mul nuw nsw i64 %polly.indvar673.2, 640
  %394 = trunc i64 %polly.indvar673.2 to i32
...
vector.body906:                                   ; preds = %vector.body906, %polly.loop_header670.2
  ...
  br i1 %407, label %polly.loop_exit678.2, label %vector.body906, !llvm.loop !111
...
polly.loop_header670.1827:                        ; preds = %polly.loop_exit678.2, %polly.loop_exit678.1838
  ...
  %408 = add nuw nsw i64 %polly.indvar673.1826, 32
...
vector.body918:                                   ; preds = %vector.body918, %polly.loop_header670.1827
  ...
  br i1 %420, label %polly.loop_exit678.1838, label %vector.body918, !llvm.loop !112
...
polly.loop_header670.1.1:                         ; preds = %polly.loop_exit678.1838, %polly.loop_exit678.1.1
  ...
  %421 = add nuw nsw i64 %polly.indvar673.1.1, 32
...
vector.body932:                                   ; preds = %vector.body932, %polly.loop_header670.1.1
  ...
  br i1 %436, label %polly.loop_exit678.1.1, label %vector.body932, !llvm.loop !113
...
polly.loop_header670.2.1:                         ; preds = %polly.loop_exit678.1.1, %polly.loop_exit678.2.1
  ...
  %437 = add nuw nsw i64 %polly.indvar673.2.1, 32
...
vector.body944:                                   ; preds = %vector.body944, %polly.loop_header670.2.1
  ...
  br i1 %452, label %polly.loop_exit678.2.1, label %vector.body944, !llvm.loop !114
...
polly.loop_header670.2841:                        ; preds = %polly.loop_exit678.2.1, %polly.loop_exit678.2852
  ...
  %453 = add nuw nsw i64 %polly.indvar673.2840, 64
...
vector.body956:                                   ; preds = %vector.body956, %polly.loop_header670.2841
  ...
  br i1 %465, label %polly.loop_exit678.2852, label %vector.body956, !llvm.loop !115
...
polly.loop_header670.1.2:                         ; preds = %polly.loop_exit678.2852, %polly.loop_exit678.1.2
  ...
  %466 = add nuw nsw i64 %polly.indvar673.1.2, 64
...
vector.body970:                                   ; preds = %vector.body970, %polly.loop_header670.1.2
  ...
  br i1 %481, label %polly.loop_exit678.1.2, label %vector.body970, !llvm.loop !116
...
polly.loop_header670.2.2:                         ; preds = %polly.loop_exit678.1.2, %polly.loop_exit678.2.2
  ...
  %482 = add nuw nsw i64 %polly.indvar673.2.2, 64
...
vector.body982:                                   ; preds = %vector.body982, %polly.loop_header670.2.2
  ...
  br i1 %497, label %polly.loop_exit678.2.2, label %vector.body982, !llvm.loop !117
