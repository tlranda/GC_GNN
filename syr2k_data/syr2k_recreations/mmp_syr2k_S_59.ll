; ModuleID = 'syr2k_recreations//mmp_syr2k_S_59.c'
source_filename = "syr2k_recreations//mmp_syr2k_S_59.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond807.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !69
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %_p_scalar_246 = load double, double* %scevgep244245, align 8, !alias.scope !66, !noalias !71
...
polly.loop_header233:                             ; preds = %polly.loop_header233, %polly.loop_header227
  ...
  %_p_scalar_249 = load double, double* %scevgep247248, align 8, !alias.scope !66, !noalias !71
  ...
  %_p_scalar_257 = load double, double* %scevgep255256, align 8, !alias.scope !62, !noalias !64
  %p_reass.add.i116 = fadd fast double %p_mul37.i114, %p_mul27.i112
  %p_reass.mul.i117 = fmul fast double %p_reass.add.i116, 1.500000e+00
  %p_add42.i118 = fadd fast double %p_reass.mul.i117, %_p_scalar_257
  store double %p_add42.i118, double* %scevgep255256, align 8, !alias.scope !62, !noalias !64
...
vector.body1231:                                  ; preds = %vector.body1231, %vector.ph1235
  ...
  %wide.load1242 = load <4 x double>, <4 x double>* %109, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %112, label %middle.block1229, label %vector.body1231, !llvm.loop !78
...
polly.loop_header352:                             ; preds = %polly.loop_header352.preheader, %polly.loop_header352
  ...
  %_p_scalar_361 = load double, double* %scevgep359360, align 8, !alias.scope !72, !noalias !74
  %p_mul.i57 = fmul fast double %_p_scalar_361, 1.200000e+00
  store double %p_mul.i57, double* %scevgep359360, align 8, !alias.scope !72, !noalias !74
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %exitcond818.not = icmp eq i64 %polly.indvar_next356, %polly.indvar349
  br i1 %exitcond818.not, label %polly.loop_exit354, label %polly.loop_header352, !llvm.loop !79
...
polly.loop_header390:                             ; preds = %polly.loop_exit398, %polly.loop_exit376
  ...
  %_p_scalar_409 = load double, double* %scevgep407408, align 8, !alias.scope !76, !noalias !80
...
polly.loop_header396:                             ; preds = %polly.loop_header396, %polly.loop_header390
  ...
  %_p_scalar_412 = load double, double* %scevgep410411, align 8, !alias.scope !76, !noalias !80
  ...
  %_p_scalar_420 = load double, double* %scevgep418419, align 8, !alias.scope !72, !noalias !74
  %p_reass.add.i77 = fadd fast double %p_mul37.i75, %p_mul27.i73
  %p_reass.mul.i78 = fmul fast double %p_reass.add.i77, 1.500000e+00
  %p_add42.i79 = fadd fast double %p_reass.mul.i78, %_p_scalar_420
  store double %p_add42.i79, double* %scevgep418419, align 8, !alias.scope !72, !noalias !74
...
vector.body1207:                                  ; preds = %vector.body1207, %vector.ph1209
  ...
  %wide.load1216 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !81, !noalias !83
  ...
  br i1 %129, label %middle.block1205, label %vector.body1207, !llvm.loop !87
...
polly.loop_header515:                             ; preds = %polly.loop_header515.preheader, %polly.loop_header515
  ...
  %_p_scalar_524 = load double, double* %scevgep522523, align 8, !alias.scope !81, !noalias !83
  %p_mul.i = fmul fast double %_p_scalar_524, 1.200000e+00
  store double %p_mul.i, double* %scevgep522523, align 8, !alias.scope !81, !noalias !83
  %polly.indvar_next519 = add nuw nsw i64 %polly.indvar518, 1
  %exitcond829.not = icmp eq i64 %polly.indvar_next519, %polly.indvar512
  br i1 %exitcond829.not, label %polly.loop_exit517, label %polly.loop_header515, !llvm.loop !88
...
polly.loop_header553:                             ; preds = %polly.loop_exit561, %polly.loop_exit539
  ...
  %_p_scalar_572 = load double, double* %scevgep570571, align 8, !alias.scope !85, !noalias !89
...
polly.loop_header559:                             ; preds = %polly.loop_header559, %polly.loop_header553
  ...
  %_p_scalar_575 = load double, double* %scevgep573574, align 8, !alias.scope !85, !noalias !89
  ...
  %_p_scalar_583 = load double, double* %scevgep581582, align 8, !alias.scope !81, !noalias !83
  %p_reass.add.i = fadd fast double %p_mul37.i, %p_mul27.i
  %p_reass.mul.i = fmul fast double %p_reass.add.i, 1.500000e+00
  %p_add42.i = fadd fast double %p_reass.mul.i, %_p_scalar_583
  store double %p_add42.i, double* %scevgep581582, align 8, !alias.scope !81, !noalias !83
...
vector.body929:                                   ; preds = %vector.body929, %polly.loop_header722
  ...
  br i1 %150, label %polly.loop_exit730, label %vector.body929, !llvm.loop !95
...
vector.body1043:                                  ; preds = %vector.body1043, %polly.loop_header749
  ...
  br i1 %162, label %polly.loop_exit757, label %vector.body1043, !llvm.loop !97
...
vector.body1121:                                  ; preds = %vector.body1121, %polly.loop_header775
  ...
  br i1 %174, label %polly.loop_exit783, label %vector.body1121, !llvm.loop !99
...
polly.loop_header227.1:                           ; preds = %polly.loop_exit235.1, %polly.loop_exit213.1
  ...
  %_p_scalar_246.1 = load double, double* %scevgep244245.1, align 8, !alias.scope !66, !noalias !71
...
polly.loop_header233.1:                           ; preds = %polly.loop_header233.1, %polly.loop_header227.1
  ...
  %_p_scalar_249.1 = load double, double* %scevgep247248.1, align 8, !alias.scope !66, !noalias !71
  ...
  %_p_scalar_257.1 = load double, double* %scevgep255256.1, align 8, !alias.scope !62, !noalias !64
  %p_reass.add.i116.1 = fadd fast double %p_mul37.i114.1, %p_mul27.i112.1
  %p_reass.mul.i117.1 = fmul fast double %p_reass.add.i116.1, 1.500000e+00
  %p_add42.i118.1 = fadd fast double %p_reass.mul.i117.1, %_p_scalar_257.1
  store double %p_add42.i118.1, double* %scevgep255256.1, align 8, !alias.scope !62, !noalias !64
...
polly.loop_header390.1:                           ; preds = %polly.loop_exit398.1, %polly.loop_exit376.1
  ...
  %_p_scalar_409.1 = load double, double* %scevgep407408.1, align 8, !alias.scope !76, !noalias !80
...
polly.loop_header396.1:                           ; preds = %polly.loop_header396.1, %polly.loop_header390.1
  ...
  %_p_scalar_412.1 = load double, double* %scevgep410411.1, align 8, !alias.scope !76, !noalias !80
  ...
  %_p_scalar_420.1 = load double, double* %scevgep418419.1, align 8, !alias.scope !72, !noalias !74
  %p_reass.add.i77.1 = fadd fast double %p_mul37.i75.1, %p_mul27.i73.1
  %p_reass.mul.i78.1 = fmul fast double %p_reass.add.i77.1, 1.500000e+00
  %p_add42.i79.1 = fadd fast double %p_reass.mul.i78.1, %_p_scalar_420.1
  store double %p_add42.i79.1, double* %scevgep418419.1, align 8, !alias.scope !72, !noalias !74
...
polly.loop_header553.1:                           ; preds = %polly.loop_exit561.1, %polly.loop_exit539.1
  ...
  %_p_scalar_572.1 = load double, double* %scevgep570571.1, align 8, !alias.scope !85, !noalias !89
...
polly.loop_header559.1:                           ; preds = %polly.loop_header559.1, %polly.loop_header553.1
  ...
  %_p_scalar_575.1 = load double, double* %scevgep573574.1, align 8, !alias.scope !85, !noalias !89
  ...
  %_p_scalar_583.1 = load double, double* %scevgep581582.1, align 8, !alias.scope !81, !noalias !83
  %p_reass.add.i.1 = fadd fast double %p_mul37.i.1, %p_mul27.i.1
  %p_reass.mul.i.1 = fmul fast double %p_reass.add.i.1, 1.500000e+00
  %p_add42.i.1 = fadd fast double %p_reass.mul.i.1, %_p_scalar_583.1
  store double %p_add42.i.1, double* %scevgep581582.1, align 8, !alias.scope !81, !noalias !83
...
vector.body1135:                                  ; preds = %vector.body1135, %polly.loop_header775.1
  ...
  store <4 x double> %213, <4 x double>* %218, align 8, !alias.scope !93, !noalias !98
  ...
  br i1 %219, label %polly.loop_exit783.1, label %vector.body1135, !llvm.loop !100
...
vector.body1147:                                  ; preds = %vector.body1147, %polly.loop_header775.1854
  ...
  store <4 x double> %227, <4 x double>* %231, align 8, !alias.scope !93, !noalias !98
  ...
  br i1 %232, label %polly.loop_exit783.1865, label %vector.body1147, !llvm.loop !101
...
vector.body1161:                                  ; preds = %vector.body1161, %polly.loop_header775.1.1
  ...
  store <4 x double> %242, <4 x double>* %247, align 8, !alias.scope !93, !noalias !98
  ...
  br i1 %248, label %polly.loop_exit783.1.1, label %vector.body1161, !llvm.loop !102
...
vector.body1173:                                  ; preds = %vector.body1173, %polly.loop_header775.2
  ...
  store <4 x double> %256, <4 x double>* %260, align 8, !alias.scope !93, !noalias !98
  ...
  br i1 %261, label %polly.loop_exit783.2, label %vector.body1173, !llvm.loop !103
...
vector.body1187:                                  ; preds = %vector.body1187, %polly.loop_header775.1.2
  ...
  store <4 x double> %271, <4 x double>* %276, align 8, !alias.scope !93, !noalias !98
  ...
  br i1 %277, label %polly.loop_exit783.1.2, label %vector.body1187, !llvm.loop !104
...
vector.body1057:                                  ; preds = %vector.body1057, %polly.loop_header749.1
  ...
  br i1 %292, label %polly.loop_exit757.1, label %vector.body1057, !llvm.loop !105
...
vector.body1069:                                  ; preds = %vector.body1069, %polly.loop_header749.1868
  ...
  store <4 x double> %300, <4 x double>* %304, align 8, !alias.scope !94, !noalias !96
  ...
  br i1 %305, label %polly.loop_exit757.1879, label %vector.body1069, !llvm.loop !106
...
vector.body1083:                                  ; preds = %vector.body1083, %polly.loop_header749.1.1
  ...
  store <4 x double> %315, <4 x double>* %320, align 8, !alias.scope !94, !noalias !96
  ...
  br i1 %321, label %polly.loop_exit757.1.1, label %vector.body1083, !llvm.loop !107
...
vector.body1095:                                  ; preds = %vector.body1095, %polly.loop_header749.2
  ...
  store <4 x double> %329, <4 x double>* %333, align 8, !alias.scope !94, !noalias !96
  ...
  br i1 %334, label %polly.loop_exit757.2, label %vector.body1095, !llvm.loop !108
...
vector.body1109:                                  ; preds = %vector.body1109, %polly.loop_header749.1.2
  ...
  br i1 %350, label %polly.loop_exit757.1.2, label %vector.body1109, !llvm.loop !109
...
vector.body943:                                   ; preds = %vector.body943, %polly.loop_header722.1
  ...
  store <4 x double> %359, <4 x double>* %364, align 8, !alias.scope !90, !noalias !92
  ...
  br i1 %365, label %polly.loop_exit730.1, label %vector.body943, !llvm.loop !110
...
vector.body955:                                   ; preds = %vector.body955, %polly.loop_header722.2
  ...
  br i1 %380, label %polly.loop_exit730.2, label %vector.body955, !llvm.loop !111
...
vector.body967:                                   ; preds = %vector.body967, %polly.loop_header722.1882
  ...
  store <4 x double> %388, <4 x double>* %392, align 8, !alias.scope !90, !noalias !92
  ...
  br i1 %393, label %polly.loop_exit730.1893, label %vector.body967, !llvm.loop !112
...
vector.body981:                                   ; preds = %vector.body981, %polly.loop_header722.1.1
  ...
  store <4 x double> %403, <4 x double>* %408, align 8, !alias.scope !90, !noalias !92
  ...
  br i1 %409, label %polly.loop_exit730.1.1, label %vector.body981, !llvm.loop !113
...
vector.body993:                                   ; preds = %vector.body993, %polly.loop_header722.2.1
  ...
  store <4 x double> %419, <4 x double>* %424, align 8, !alias.scope !90, !noalias !92
  ...
  br i1 %425, label %polly.loop_exit730.2.1, label %vector.body993, !llvm.loop !114
...
vector.body1005:                                  ; preds = %vector.body1005, %polly.loop_header722.2896
  ...
  store <4 x double> %433, <4 x double>* %437, align 8, !alias.scope !90, !noalias !92
  ...
  br i1 %438, label %polly.loop_exit730.2907, label %vector.body1005, !llvm.loop !115
...
vector.body1019:                                  ; preds = %vector.body1019, %polly.loop_header722.1.2
  ...
  store <4 x double> %448, <4 x double>* %453, align 8, !alias.scope !90, !noalias !92
  ...
  br i1 %454, label %polly.loop_exit730.1.2, label %vector.body1019, !llvm.loop !116
...
vector.body1031:                                  ; preds = %vector.body1031, %polly.loop_header722.2.2
  ...
  store <4 x double> %464, <4 x double>* %469, align 8, !alias.scope !90, !noalias !92
  ...
  br i1 %470, label %polly.loop_exit730.2.2, label %vector.body1031, !llvm.loop !117
