; ModuleID = 'syr2k_recreations//mmp_syr2k_L_143.c'
source_filename = "syr2k_recreations//mmp_syr2k_L_143.c"
...
vector.body1071:                                  ; preds = %vector.body1071, %vector.ph1075
  ...
  %wide.load1082 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %134, label %middle.block1069, label %vector.body1071, !llvm.loop !84
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %137 = shl nsw i64 %polly.indvar377, 6
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1049
  ...
  %wide.load1056 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %173, label %middle.block1045, label %vector.body1047, !llvm.loop !94
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %176 = shl nsw i64 %polly.indvar555, 6
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph987
  ...
  br i1 %226, label %polly.loop_exit772, label %vector.body986, !llvm.loop !103
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  br i1 %255, label %polly.loop_exit799, label %vector.body1000, !llvm.loop !106
...
vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1021
  ...
  br i1 %284, label %polly.loop_exit825, label %vector.body1018, !llvm.loop !109
