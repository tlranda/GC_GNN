; ModuleID = 'syr2k_recreations//mmp_syr2k_M_156.c'
source_filename = "syr2k_recreations//mmp_syr2k_M_156.c"
...
vector.body1201:                                  ; preds = %vector.body1201, %vector.ph1205
  ...
  %wide.load1212 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %133, label %middle.block1199, label %vector.body1201, !llvm.loop !80
...
vector.body1177:                                  ; preds = %vector.body1177, %vector.ph1179
  ...
  %wide.load1186 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %171, label %middle.block1175, label %vector.body1177, !llvm.loop !90
...
vector.body1116:                                  ; preds = %vector.body1116, %vector.ph1117
  ...
  br i1 %223, label %polly.loop_exit813, label %vector.body1116, !llvm.loop !99
...
vector.body1130:                                  ; preds = %vector.body1130, %vector.ph1133
  ...
  br i1 %252, label %polly.loop_exit840, label %vector.body1130, !llvm.loop !102
...
vector.body1148:                                  ; preds = %vector.body1148, %vector.ph1151
  ...
  br i1 %281, label %polly.loop_exit866, label %vector.body1148, !llvm.loop !105
