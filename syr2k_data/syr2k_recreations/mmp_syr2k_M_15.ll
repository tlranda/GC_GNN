; ModuleID = 'syr2k_recreations//mmp_syr2k_M_15.c'
source_filename = "syr2k_recreations//mmp_syr2k_M_15.c"
...
polly.loop_header416:                             ; preds = %polly.loop_exit440, %polly.loop_header410
  ...
  %178 = mul nuw nsw i64 %polly.indvar419, 307456
  %179 = or i64 %178, 8
  %180 = mul nuw nsw i64 %polly.indvar419, 307456
  %181 = or i64 %180, 8
  %182 = mul nuw nsw i64 %polly.indvar419, 307456
  %183 = or i64 %182, 8
...
polly.loop_header438:                             ; preds = %polly.loop_exit430.3, %polly.loop_exit479
  ...
  %187 = shl nuw nsw i64 %indvar1430, 5
  %188 = mul nuw nsw i64 %indvar1430, 307200
  %189 = add i64 %178, %188
  %190 = add i64 %179, %188
  %191 = shl nuw nsw i64 %indvar1430, 5
  %192 = shl nuw nsw i64 %indvar1430, 5
  %193 = mul nuw nsw i64 %indvar1430, 307200
  %194 = add i64 %180, %193
  %195 = add i64 %181, %193
  %196 = shl nuw nsw i64 %indvar1430, 5
  %197 = shl nuw nsw i64 %indvar1430, 5
  %198 = mul nuw nsw i64 %indvar1430, 307200
  %199 = add i64 %182, %198
  %200 = add i64 %183, %198
  %201 = shl nuw nsw i64 %indvar1430, 5
  %202 = shl nuw nsw i64 %indvar1430, 5
...
polly.loop_header628:                             ; preds = %polly.loop_exit652, %polly.loop_header622
  ...
  %255 = mul nuw nsw i64 %polly.indvar631, 307456
  %256 = or i64 %255, 8
  %257 = mul nuw nsw i64 %polly.indvar631, 307456
  %258 = or i64 %257, 8
  %259 = mul nuw nsw i64 %polly.indvar631, 307456
  %260 = or i64 %259, 8
...
polly.loop_header650:                             ; preds = %polly.loop_exit642.3, %polly.loop_exit691
  ...
  %264 = shl nuw nsw i64 %indvar1291, 5
  %265 = mul nuw nsw i64 %indvar1291, 307200
  %266 = add i64 %255, %265
  %267 = add i64 %256, %265
  %268 = shl nuw nsw i64 %indvar1291, 5
  %269 = shl nuw nsw i64 %indvar1291, 5
  %270 = mul nuw nsw i64 %indvar1291, 307200
  %271 = add i64 %257, %270
  %272 = add i64 %258, %270
  %273 = shl nuw nsw i64 %indvar1291, 5
  %274 = shl nuw nsw i64 %indvar1291, 5
  %275 = mul nuw nsw i64 %indvar1291, 307200
  %276 = add i64 %259, %275
  %277 = add i64 %260, %275
  %278 = shl nuw nsw i64 %indvar1291, 5
  %279 = shl nuw nsw i64 %indvar1291, 5
...
polly.loop_header272.us.3:                        ; preds = %polly.loop_exit281.us.2, %polly.loop_exit281.us.3
  ...
  %smin1571 = call i64 @llvm.smin.i64(i64 %479, i64 31)
...
polly.loop_header484.us.3:                        ; preds = %polly.loop_exit493.us.2, %polly.loop_exit493.us.3
  ...
  %smin1432 = call i64 @llvm.smin.i64(i64 %577, i64 31)
...
polly.loop_header696.us.3:                        ; preds = %polly.loop_exit705.us.2, %polly.loop_exit705.us.3
  ...
  %smin1293 = call i64 @llvm.smin.i64(i64 %675, i64 31)
