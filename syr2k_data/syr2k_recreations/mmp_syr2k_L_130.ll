; ModuleID = 'syr2k_recreations//mmp_syr2k_L_130.c'
source_filename = "syr2k_recreations//mmp_syr2k_L_130.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin989 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -920)
...
polly.start279:                                   ; preds = %kernel_syr2k.exit
  %malloccall281 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header387:                             ; preds = %polly.loop_exit396, %polly.loop_header381
  ...
  %smin1016 = call i64 @llvm.smin.i64(i64 %indvars.iv1000, i64 -920)
  %132 = add nsw i64 %smin1016, 1000
  %133 = mul nuw nsw i64 %polly.indvar390, 80
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next391, 13
...
polly.start468:                                   ; preds = %init_array.exit
  %malloccall470 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header576:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %smin1043 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 -920)
  %164 = add nsw i64 %smin1043, 1000
  %165 = mul nuw nsw i64 %polly.indvar579, 80
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar_next580, 13
