; ModuleID = 'syr2k_recreations//mmp_syr2k_L_172.c'
source_filename = "syr2k_recreations//mmp_syr2k_L_172.c"
...
polly.loop_header205.us:                          ; preds = %polly.loop_header199, %polly.loop_exit213.loopexit.us
  ...
  %smin903 = call i64 @llvm.smin.i64(i64 %indvars.iv901, i64 -872)
  %101 = shl nsw i64 %polly.indvar208.us, 7
...
polly.loop_exit213.loopexit.us:                   ; preds = %polly.loop_exit220.us
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next209.us, 8
...
vector.body1100:                                  ; preds = %vector.body1100, %vector.ph1104
  ...
  %wide.load1111 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %128, label %middle.block1098, label %vector.body1100, !llvm.loop !74
...
polly.loop_header362.us:                          ; preds = %polly.loop_header356, %polly.loop_exit372.loopexit.us
  ...
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 -872)
  %134 = shl nsw i64 %polly.indvar365.us, 7
...
polly.loop_exit372.loopexit.us:                   ; preds = %polly.loop_exit380.us
  ...
  %indvars.iv.next923 = add nsw i64 %indvars.iv922, -128
  %exitcond926.not = icmp eq i64 %polly.indvar_next366.us, 8
...
vector.body1076:                                  ; preds = %vector.body1076, %vector.ph1078
  ...
  %wide.load1085 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %161, label %middle.block1074, label %vector.body1076, !llvm.loop !83
...
polly.loop_header522.us:                          ; preds = %polly.loop_header516, %polly.loop_exit532.loopexit.us
  ...
  %smin945 = call i64 @llvm.smin.i64(i64 %indvars.iv943, i64 -872)
  %167 = shl nsw i64 %polly.indvar525.us, 7
...
polly.loop_exit532.loopexit.us:                   ; preds = %polly.loop_exit540.us
  ...
  %indvars.iv.next944 = add nsw i64 %indvars.iv943, -128
  %exitcond947.not = icmp eq i64 %polly.indvar_next526.us, 8
...
vector.body1014:                                  ; preds = %vector.body1014, %vector.ph1016
  ...
  br i1 %208, label %polly.loop_exit720, label %vector.body1014, !llvm.loop !92
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1032
  ...
  br i1 %237, label %polly.loop_exit747, label %vector.body1029, !llvm.loop !95
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1050
  ...
  br i1 %266, label %polly.loop_exit773, label %vector.body1047, !llvm.loop !98
