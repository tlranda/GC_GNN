; ModuleID = 'syr2k_recreations//mmp_syr2k_S_9.c'
source_filename = "syr2k_recreations//mmp_syr2k_S_9.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit229.3
  ...
  %smin812 = call i64 @llvm.smin.i64(i64 %indvars.iv810, i64 -44)
...
polly.loop_header384:                             ; preds = %polly.loop_exit376, %polly.loop_exit398.3
  ...
  %smin829 = call i64 @llvm.smin.i64(i64 %indvars.iv827, i64 -44)
  %115 = add nsw i64 %smin829, 60
  %116 = shl nsw i64 %polly.indvar387, 4
...
polly.loop_header553:                             ; preds = %polly.loop_exit545, %polly.loop_exit567.3
  ...
  %smin846 = call i64 @llvm.smin.i64(i64 %indvars.iv844, i64 -44)
  %133 = add nsw i64 %smin846, 60
  %134 = shl nsw i64 %polly.indvar556, 4
...
polly.loop_exit229.3:                             ; preds = %polly.loop_exit235.3
  ...
  %exitcond818.not = icmp eq i64 %polly.indvar_next219, 4
...
polly.loop_exit398.3:                             ; preds = %polly.loop_exit404.3
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next388, 4
...
polly.loop_exit567.3:                             ; preds = %polly.loop_exit573.3
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar_next557, 4
