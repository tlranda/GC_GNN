; ModuleID = 'syr2k_recreations//mmp_syr2k_S_148.c'
source_filename = "syr2k_recreations//mmp_syr2k_S_148.c"
...
vector.body1274:                                  ; preds = %vector.body1274, %vector.ph1276
  ...
  br i1 %57, label %middle.block1272, label %vector.body1274, !llvm.loop !63
...
vector.body1300:                                  ; preds = %vector.body1300, %vector.ph1302
  ...
  br i1 %68, label %middle.block1298, label %vector.body1300, !llvm.loop !65
...
vector.body1312:                                  ; preds = %vector.body1312, %vector.ph1316
  ...
  %wide.load1323 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1310, label %vector.body1312, !llvm.loop !78
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond854.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !79
...
polly.loop_header250:                             ; preds = %polly.loop_header250, %polly.loop_header244
  ...
  %_p_scalar_274 = load double, double* %scevgep272273, align 8, !alias.scope !71, !noalias !73
  %p_reass.add.i116 = fadd fast double %p_mul37.i114, %p_mul27.i112
  %p_reass.mul.i117 = fmul fast double %p_reass.add.i116, 1.500000e+00
  %p_add42.i118 = fadd fast double %p_reass.mul.i117, %_p_scalar_274
  store double %p_add42.i118, double* %scevgep272273, align 8, !alias.scope !71, !noalias !73
...
vector.body1286:                                  ; preds = %vector.body1286, %vector.ph1290
  ...
  %wide.load1297 = load <4 x double>, <4 x double>* %105, align 8, !alias.scope !81, !noalias !83
  ...
  store <4 x double> %106, <4 x double>* %107, align 8, !alias.scope !81, !noalias !83
  %index.next1294 = add i64 %index1293, 4
  %108 = icmp eq i64 %index.next1294, %n.vec1292
  br i1 %108, label %middle.block1284, label %vector.body1286, !llvm.loop !88
...
polly.loop_header371:                             ; preds = %polly.loop_header371.preheader, %polly.loop_header371
  ...
  %_p_scalar_380 = load double, double* %scevgep378379, align 8, !alias.scope !81, !noalias !83
  %p_mul.i57 = fmul fast double %_p_scalar_380, 1.200000e+00
  store double %p_mul.i57, double* %scevgep378379, align 8, !alias.scope !81, !noalias !83
  %polly.indvar_next375 = add nuw nsw i64 %polly.indvar374, 1
  %exitcond869.not = icmp eq i64 %polly.indvar_next375, %polly.indvar368
  br i1 %exitcond869.not, label %polly.loop_exit373, label %polly.loop_header371, !llvm.loop !89
...
polly.loop_header431:                             ; preds = %polly.loop_header431, %polly.loop_header425
  ...
  %_p_scalar_455 = load double, double* %scevgep453454, align 8, !alias.scope !81, !noalias !83
  %p_reass.add.i77 = fadd fast double %p_mul37.i75, %p_mul27.i73
  %p_reass.mul.i78 = fmul fast double %p_reass.add.i77, 1.500000e+00
  %p_add42.i79 = fadd fast double %p_reass.mul.i78, %_p_scalar_455
  store double %p_add42.i79, double* %scevgep453454, align 8, !alias.scope !81, !noalias !83
...
vector.body1262:                                  ; preds = %vector.body1262, %vector.ph1264
  ...
  %wide.load1271 = load <4 x double>, <4 x double>* %118, align 8, !alias.scope !90, !noalias !92
  ...
  store <4 x double> %119, <4 x double>* %120, align 8, !alias.scope !90, !noalias !92
  %index.next1268 = add i64 %index1267, 4
  %121 = icmp eq i64 %index.next1268, %n.vec1266
  br i1 %121, label %middle.block1260, label %vector.body1262, !llvm.loop !97
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_header552
  ...
  %_p_scalar_561 = load double, double* %scevgep559560, align 8, !alias.scope !90, !noalias !92
  %p_mul.i = fmul fast double %_p_scalar_561, 1.200000e+00
  store double %p_mul.i, double* %scevgep559560, align 8, !alias.scope !90, !noalias !92
  %polly.indvar_next556 = add nuw nsw i64 %polly.indvar555, 1
  %exitcond884.not = icmp eq i64 %polly.indvar_next556, %polly.indvar549
  br i1 %exitcond884.not, label %polly.loop_exit554, label %polly.loop_header552, !llvm.loop !98
...
polly.loop_header612:                             ; preds = %polly.loop_header612, %polly.loop_header606
  ...
  %_p_scalar_636 = load double, double* %scevgep634635, align 8, !alias.scope !90, !noalias !92
  %p_reass.add.i = fadd fast double %p_mul37.i, %p_mul27.i
  %p_reass.mul.i = fmul fast double %p_reass.add.i, 1.500000e+00
  %p_add42.i = fadd fast double %p_reass.mul.i, %_p_scalar_636
  store double %p_add42.i, double* %scevgep634635, align 8, !alias.scope !90, !noalias !92
...
vector.body984:                                   ; preds = %vector.body984, %polly.loop_header775
  ...
  store <4 x double> %133, <4 x double>* %137, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %138, label %polly.loop_exit783, label %vector.body984, !llvm.loop !104
...
vector.body1098:                                  ; preds = %vector.body1098, %polly.loop_header802
  ...
  store <4 x double> %145, <4 x double>* %149, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %150, label %polly.loop_exit810, label %vector.body1098, !llvm.loop !106
...
vector.body1176:                                  ; preds = %vector.body1176, %polly.loop_header828
  ...
  store <4 x double> %157, <4 x double>* %161, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %162, label %polly.loop_exit836, label %vector.body1176, !llvm.loop !108
...
polly.loop_header250.1:                           ; preds = %polly.loop_header250.1, %polly.loop_header244.1
  ...
  %_p_scalar_274.1 = load double, double* %scevgep272273.1, align 8, !alias.scope !71, !noalias !73
  %p_reass.add.i116.1 = fadd fast double %p_mul37.i114.1, %p_mul27.i112.1
  %p_reass.mul.i117.1 = fmul fast double %p_reass.add.i116.1, 1.500000e+00
  %p_add42.i118.1 = fadd fast double %p_reass.mul.i117.1, %_p_scalar_274.1
  store double %p_add42.i118.1, double* %scevgep272273.1, align 8, !alias.scope !71, !noalias !73
...
polly.loop_header431.1:                           ; preds = %polly.loop_header431.1, %polly.loop_header425.1
  ...
  %_p_scalar_455.1 = load double, double* %scevgep453454.1, align 8, !alias.scope !81, !noalias !83
  %p_reass.add.i77.1 = fadd fast double %p_mul37.i75.1, %p_mul27.i73.1
  %p_reass.mul.i78.1 = fmul fast double %p_reass.add.i77.1, 1.500000e+00
  %p_add42.i79.1 = fadd fast double %p_reass.mul.i78.1, %_p_scalar_455.1
  store double %p_add42.i79.1, double* %scevgep453454.1, align 8, !alias.scope !81, !noalias !83
...
polly.loop_header612.1:                           ; preds = %polly.loop_header612.1, %polly.loop_header606.1
  ...
  %_p_scalar_636.1 = load double, double* %scevgep634635.1, align 8, !alias.scope !90, !noalias !92
  %p_reass.add.i.1 = fadd fast double %p_mul37.i.1, %p_mul27.i.1
  %p_reass.mul.i.1 = fmul fast double %p_reass.add.i.1, 1.500000e+00
  %p_add42.i.1 = fadd fast double %p_reass.mul.i.1, %_p_scalar_636.1
  store double %p_add42.i.1, double* %scevgep634635.1, align 8, !alias.scope !90, !noalias !92
...
vector.body1190:                                  ; preds = %vector.body1190, %polly.loop_header828.1
  ...
  store <4 x double> %186, <4 x double>* %191, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %192, label %polly.loop_exit836.1, label %vector.body1190, !llvm.loop !109
...
vector.body1202:                                  ; preds = %vector.body1202, %polly.loop_header828.1909
  ...
  store <4 x double> %200, <4 x double>* %204, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %205, label %polly.loop_exit836.1920, label %vector.body1202, !llvm.loop !110
...
vector.body1216:                                  ; preds = %vector.body1216, %polly.loop_header828.1.1
  ...
  store <4 x double> %215, <4 x double>* %220, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %221, label %polly.loop_exit836.1.1, label %vector.body1216, !llvm.loop !111
...
vector.body1228:                                  ; preds = %vector.body1228, %polly.loop_header828.2
  ...
  store <4 x double> %229, <4 x double>* %233, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %234, label %polly.loop_exit836.2, label %vector.body1228, !llvm.loop !112
...
vector.body1242:                                  ; preds = %vector.body1242, %polly.loop_header828.1.2
  ...
  store <4 x double> %244, <4 x double>* %249, align 8, !alias.scope !102, !noalias !107
  ...
  br i1 %250, label %polly.loop_exit836.1.2, label %vector.body1242, !llvm.loop !113
...
vector.body1112:                                  ; preds = %vector.body1112, %polly.loop_header802.1
  ...
  store <4 x double> %259, <4 x double>* %264, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %265, label %polly.loop_exit810.1, label %vector.body1112, !llvm.loop !114
...
vector.body1124:                                  ; preds = %vector.body1124, %polly.loop_header802.1923
  ...
  store <4 x double> %273, <4 x double>* %277, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %278, label %polly.loop_exit810.1934, label %vector.body1124, !llvm.loop !115
...
vector.body1138:                                  ; preds = %vector.body1138, %polly.loop_header802.1.1
  ...
  store <4 x double> %288, <4 x double>* %293, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %294, label %polly.loop_exit810.1.1, label %vector.body1138, !llvm.loop !116
...
vector.body1150:                                  ; preds = %vector.body1150, %polly.loop_header802.2
  ...
  store <4 x double> %302, <4 x double>* %306, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %307, label %polly.loop_exit810.2, label %vector.body1150, !llvm.loop !117
...
vector.body1164:                                  ; preds = %vector.body1164, %polly.loop_header802.1.2
  ...
  store <4 x double> %317, <4 x double>* %322, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %323, label %polly.loop_exit810.1.2, label %vector.body1164, !llvm.loop !118
...
vector.body998:                                   ; preds = %vector.body998, %polly.loop_header775.1
  ...
  store <4 x double> %332, <4 x double>* %337, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %338, label %polly.loop_exit783.1, label %vector.body998, !llvm.loop !119
...
vector.body1010:                                  ; preds = %vector.body1010, %polly.loop_header775.2
  ...
  store <4 x double> %347, <4 x double>* %352, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %353, label %polly.loop_exit783.2, label %vector.body1010, !llvm.loop !120
...
vector.body1022:                                  ; preds = %vector.body1022, %polly.loop_header775.1937
  ...
  store <4 x double> %361, <4 x double>* %365, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %366, label %polly.loop_exit783.1948, label %vector.body1022, !llvm.loop !121
...
vector.body1036:                                  ; preds = %vector.body1036, %polly.loop_header775.1.1
  ...
  br i1 %382, label %polly.loop_exit783.1.1, label %vector.body1036, !llvm.loop !122
...
vector.body1048:                                  ; preds = %vector.body1048, %polly.loop_header775.2.1
  ...
  br i1 %398, label %polly.loop_exit783.2.1, label %vector.body1048, !llvm.loop !123
...
vector.body1060:                                  ; preds = %vector.body1060, %polly.loop_header775.2951
  ...
  br i1 %411, label %polly.loop_exit783.2962, label %vector.body1060, !llvm.loop !124
...
vector.body1074:                                  ; preds = %vector.body1074, %polly.loop_header775.1.2
  ...
  br i1 %427, label %polly.loop_exit783.1.2, label %vector.body1074, !llvm.loop !125
...
vector.body1086:                                  ; preds = %vector.body1086, %polly.loop_header775.2.2
  ...
  br i1 %443, label %polly.loop_exit783.2.2, label %vector.body1086, !llvm.loop !126
