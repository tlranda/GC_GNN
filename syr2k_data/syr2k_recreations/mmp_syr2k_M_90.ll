; ModuleID = 'syr2k_recreations//mmp_syr2k_M_90.c'
source_filename = "syr2k_recreations//mmp_syr2k_M_90.c"
...
vector.body1237:                                  ; preds = %vector.body1237, %vector.ph1241
  ...
  %wide.load1248 = load <4 x double>, <4 x double>* %151, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %154, label %middle.block1235, label %vector.body1237, !llvm.loop !84
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %157 = mul nuw nsw i64 %polly.indvar392, 80
...
vector.body1213:                                  ; preds = %vector.body1213, %vector.ph1215
  ...
  %wide.load1222 = load <4 x double>, <4 x double>* %210, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %213, label %middle.block1211, label %vector.body1213, !llvm.loop !94
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %216 = mul nuw nsw i64 %polly.indvar589, 80
...
vector.body1152:                                  ; preds = %vector.body1152, %vector.ph1153
  ...
  br i1 %286, label %polly.loop_exit825, label %vector.body1152, !llvm.loop !103
...
vector.body1166:                                  ; preds = %vector.body1166, %vector.ph1169
  ...
  br i1 %315, label %polly.loop_exit852, label %vector.body1166, !llvm.loop !106
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1187
  ...
  br i1 %344, label %polly.loop_exit878, label %vector.body1184, !llvm.loop !109
