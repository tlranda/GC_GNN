; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7256.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7256.c"
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  ...
  %127 = udiv i64 %indvars.iv856, 5
  %umin858 = call i64 @llvm.umin.i64(i64 %127, i64 14)
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %133 = mul nuw nsw i64 %polly.indvar396, 80
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  %indvars.iv879 = phi i64 [ %indvars.iv.next880, %polly.loop_exit569 ], [ 1, %polly.loop_exit552 ]
  ...
  %157 = udiv i64 %indvars.iv879, 5
  %umin881 = call i64 @llvm.umin.i64(i64 %157, i64 14)
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %163 = mul nuw nsw i64 %polly.indvar570, 80
