; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3967.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3967.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %98 = shl nuw nsw i64 %indvars.iv1013, 4
...
polly.loop_exit213:                               ; preds = %polly.loop_exit252, %polly.loop_header205
  ...
  %indvars.iv.next1018 = add nuw nsw i64 %indvars.iv1017, 48
  %exitcond1025.not = icmp eq i64 %polly.indvar_next209, 15
...
polly.loop_header257:                             ; preds = %polly.loop_header250, %polly.loop_exit267
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1021, i64 79)
...
vector.body1230:                                  ; preds = %vector.body1230, %vector.ph1234
  ...
  %wide.load1241 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %149, label %middle.block1228, label %vector.body1230, !llvm.loop !85
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %151 = mul nuw nsw i64 %polly.indvar396, 100
...
polly.loop_header399:                             ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %152 = shl nuw nsw i64 %indvars.iv1034, 4
  %153 = and i64 %152, 9223372036854775680
  %154 = mul nuw nsw i64 %polly.indvar402, 3
  %155 = add nuw nsw i64 %154, 7
  %pexp.p_div_q405 = lshr i64 %155, 3
  %156 = sub nsw i64 %polly.indvar402, %pexp.p_div_q405
  %polly.loop_guard410 = icmp slt i64 %156, 10
...
polly.loop_exit409:                               ; preds = %polly.loop_exit449, %polly.loop_header399
  ...
  %indvars.iv.next1033 = add nsw i64 %indvars.iv1032, -48
  %indvars.iv.next1035 = add nuw nsw i64 %indvars.iv1034, 3
  %indvars.iv.next1040 = add nuw nsw i64 %indvars.iv1039, 48
  %exitcond1048.not = icmp eq i64 %polly.indvar_next403, 15
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit449
  ...
  %163 = shl nsw i64 %polly.indvar411, 7
...
polly.loop_header447.preheader:                   ; preds = %polly.loop_exit435, %polly.loop_exit435.us, %polly.loop_header407.split
  ...
  %179 = mul nsw i64 %polly.indvar411, -128
...
polly.loop_header454:                             ; preds = %polly.loop_header447, %polly.loop_exit464
  ...
  %smin1045 = call i64 @llvm.smin.i64(i64 %indvars.iv1043, i64 79)
...
vector.body1206:                                  ; preds = %vector.body1206, %vector.ph1208
  ...
  %wide.load1215 = load <4 x double>, <4 x double>* %200, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %203, label %middle.block1204, label %vector.body1206, !llvm.loop !95
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %205 = mul nuw nsw i64 %polly.indvar593, 100
...
polly.loop_header596:                             ; preds = %polly.loop_exit606, %polly.loop_header590
  ...
  %206 = shl nuw nsw i64 %indvars.iv1057, 4
  %207 = and i64 %206, 9223372036854775680
  %208 = mul nuw nsw i64 %polly.indvar599, 3
  %209 = add nuw nsw i64 %208, 7
  %pexp.p_div_q602 = lshr i64 %209, 3
  %210 = sub nsw i64 %polly.indvar599, %pexp.p_div_q602
  %polly.loop_guard607 = icmp slt i64 %210, 10
...
polly.loop_exit606:                               ; preds = %polly.loop_exit646, %polly.loop_header596
  ...
  %indvars.iv.next1056 = add nsw i64 %indvars.iv1055, -48
  %indvars.iv.next1058 = add nuw nsw i64 %indvars.iv1057, 3
  %indvars.iv.next1063 = add nuw nsw i64 %indvars.iv1062, 48
  %exitcond1071.not = icmp eq i64 %polly.indvar_next600, 15
...
polly.loop_header604:                             ; preds = %polly.loop_header604.preheader, %polly.loop_exit646
  ...
  %217 = shl nsw i64 %polly.indvar608, 7
...
polly.loop_exit646:                               ; preds = %polly.loop_exit653, %polly.loop_header644.preheader
  ...
  %indvars.iv.next1060 = add i64 %indvars.iv1059, -128
  %indvars.iv.next1065 = add i64 %indvars.iv1064, 128
...
polly.loop_header644.preheader:                   ; preds = %polly.loop_exit632, %polly.loop_exit632.us, %polly.loop_header604.split
  ...
  %233 = mul nsw i64 %polly.indvar608, -128
...
polly.loop_header651:                             ; preds = %polly.loop_header644, %polly.loop_exit661
  ...
  %smin1068 = call i64 @llvm.smin.i64(i64 %indvars.iv1066, i64 79)
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1146
  ...
  br i1 %271, label %polly.loop_exit829, label %vector.body1144, !llvm.loop !104
...
vector.body1159:                                  ; preds = %vector.body1159, %vector.ph1162
  ...
  br i1 %300, label %polly.loop_exit856, label %vector.body1159, !llvm.loop !107
...
vector.body1177:                                  ; preds = %vector.body1177, %vector.ph1180
  ...
  br i1 %329, label %polly.loop_exit882, label %vector.body1177, !llvm.loop !110
