; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6124.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6124.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %polly.loop_guard = icmp slt i64 %108, 19
...
polly.loop_exit235:                               ; preds = %polly.loop_exit242, %polly.loop_header227
  ...
  %indvars.iv.next867 = add i64 %indvars.iv866, -64
  %indvars.iv.next871 = add i64 %indvars.iv870, 64
...
polly.loop_header376:                             ; preds = %polly.loop_header376.preheader, %polly.loop_exit384
  ...
  %142 = shl nsw i64 %polly.indvar379, 6
...
polly.loop_header382:                             ; preds = %polly.loop_exit408, %polly.loop_header376
  ...
  %143 = shl nuw nsw i64 %indvars.iv891, 2
  %144 = and i64 %143, 9223372036854775744
  %145 = add i64 %indvars.iv889, %144
  %146 = sub nsw i64 %indvars.iv896, %144
  %147 = mul nuw nsw i64 %polly.indvar385, 100
  br label %polly.loop_header388

polly.loop_exit390:                               ; preds = %polly.loop_exit396
  %148 = mul nsw i64 %polly.indvar385, -100
  ...
  %polly.loop_guard409 = icmp slt i64 %152, 19
...
polly.loop_header406:                             ; preds = %polly.loop_exit390, %polly.loop_exit415
  ...
  %156 = shl nsw i64 %polly.indvar410, 6
  %157 = sub nsw i64 %147, %156
  %158 = icmp sgt i64 %157, 0
  %159 = select i1 %158, i64 %157, i64 0
  %160 = mul nsw i64 %polly.indvar410, -64
  %161 = icmp slt i64 %160, -1136
  %162 = select i1 %161, i64 %160, i64 -1136
...
polly.loop_exit415:                               ; preds = %polly.loop_exit422, %polly.loop_header406
  ...
  %indvars.iv.next894 = add i64 %indvars.iv893, -64
  %indvars.iv.next899 = add i64 %indvars.iv898, 64
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_exit564
  ...
  %186 = shl nsw i64 %polly.indvar559, 6
...
polly.loop_exit570:                               ; preds = %polly.loop_exit576
  ...
  %polly.loop_guard589 = icmp slt i64 %196, 19
...
polly.loop_header586:                             ; preds = %polly.loop_exit570, %polly.loop_exit595
  ...
  %204 = mul nsw i64 %polly.indvar590, -64
...
polly.loop_exit595:                               ; preds = %polly.loop_exit602, %polly.loop_header586
  ...
  %indvars.iv.next922 = add i64 %indvars.iv921, -64
  %indvars.iv.next927 = add i64 %indvars.iv926, 64
