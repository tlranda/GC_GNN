; ModuleID = 'syr2k_exhaustive/mmp_all_XL_841.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_841.c"
...
polly.loop_exit208:                               ; preds = %polly.loop_exit214
  ...
  %polly.loop_guard = icmp slt i64 %112, 19
...
polly.loop_header261.preheader:                   ; preds = %polly.loop_exit249, %polly.loop_exit249.us, %polly.loop_header222.split
  ...
  %134 = mul nsw i64 %polly.indvar225, -64
...
polly.loop_header268:                             ; preds = %polly.loop_header261, %polly.loop_exit278
  ...
  %smin1392 = call i64 @llvm.smin.i64(i64 %139, i64 49)
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit434
  ...
  %173 = mul nsw i64 %polly.indvar411, -14
  %174 = mul nuw nsw i64 %polly.indvar411, 14
  %175 = add nuw i64 %174, 62
  %176 = and i64 %175, -64
  %177 = add i64 %173, %176
  %178 = sub i64 %174, %176
  %179 = shl nuw nsw i64 %indvars.iv1100, 1
  %180 = and i64 %179, 9223372036854775744
  %181 = add i64 %indvars.iv1098, %180
  %182 = sub nsw i64 %indvars.iv1105, %180
  %183 = mul nsw i64 %polly.indvar411, -50
  %184 = mul nuw nsw i64 %polly.indvar411, 50
...
polly.loop_exit416:                               ; preds = %polly.loop_exit422
  ...
  %polly.loop_guard435 = icmp slt i64 %188, 19
...
polly.loop_header472.preheader:                   ; preds = %polly.loop_exit460, %polly.loop_exit460.us, %polly.loop_header432.split
  ...
  %210 = mul nsw i64 %polly.indvar436, -64
  %211 = icmp slt i64 %210, -1136
  %212 = select i1 %211, i64 %210, i64 -1136
...
polly.loop_header479:                             ; preds = %polly.loop_header472, %polly.loop_exit489
  ...
  %smin1342 = call i64 @llvm.smin.i64(i64 %215, i64 49)
...
polly.loop_header619:                             ; preds = %polly.loop_header619.preheader, %polly.loop_exit645
  ...
  %249 = mul nsw i64 %polly.indvar622, -14
  %250 = mul nuw nsw i64 %polly.indvar622, 14
  %251 = add nuw i64 %250, 62
  %252 = and i64 %251, -64
  %253 = add i64 %249, %252
  %254 = sub i64 %250, %252
  %255 = shl nuw nsw i64 %indvars.iv1126, 1
  %256 = and i64 %255, 9223372036854775744
  %257 = add i64 %indvars.iv1124, %256
  %258 = sub nsw i64 %indvars.iv1131, %256
  %259 = mul nsw i64 %polly.indvar622, -50
  %260 = mul nuw nsw i64 %polly.indvar622, 50
...
polly.loop_exit627:                               ; preds = %polly.loop_exit633
  ...
  %polly.loop_guard646 = icmp slt i64 %264, 19
...
polly.loop_header683.preheader:                   ; preds = %polly.loop_exit671, %polly.loop_exit671.us, %polly.loop_header643.split
  ...
  %286 = mul nsw i64 %polly.indvar647, -64
  %287 = icmp slt i64 %286, -1136
  %288 = select i1 %287, i64 %286, i64 -1136
...
polly.loop_header690:                             ; preds = %polly.loop_header683, %polly.loop_exit700
  ...
  %smin1292 = call i64 @llvm.smin.i64(i64 %291, i64 49)
