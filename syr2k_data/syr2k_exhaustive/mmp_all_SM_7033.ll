; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7033.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7033.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar_next225, 125
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %119 = shl nsw i64 %polly.indvar230, 5
  %120 = add nsw i64 %119, %101
  %121 = icmp sgt i64 %120, 0
  %122 = select i1 %121, i64 %120, i64 0
  %polly.loop_guard237 = icmp slt i64 %122, 20
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  ...
  %polly.loop_guard251944 = icmp sgt i64 %125, -1
...
vector.body1053:                                  ; preds = %vector.body1053, %vector.ph1057
  ...
  %138 = shl nuw nsw i64 %index1060, 3
  %139 = getelementptr i8, i8* %scevgep372, i64 %138
  %140 = bitcast i8* %139 to <4 x double>*
  %wide.load1064 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !74, !noalias !76
  %141 = fmul fast <4 x double> %wide.load1064, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %143 = icmp eq i64 %index.next1061, %n.vec1059
  br i1 %143, label %middle.block1051, label %vector.body1053, !llvm.loop !80

middle.block1051:                                 ; preds = %vector.body1053
  %cmp.n1063 = icmp eq i64 %136, %n.vec1059
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %145 = lshr i64 %indvars.iv879, 3
  %146 = sub nsw i64 %indvars.iv877, %145
  %147 = mul nuw nsw i64 %polly.indvar395, 3
  %148 = add nuw nsw i64 %147, 3
  %pexp.p_div_q404 = lshr i64 %148, 3
  %polly.loop_guard409.not = icmp ult i64 %polly.indvar395, %pexp.p_div_q404
  %149 = mul nsw i64 %polly.indvar395, -20
  %150 = mul nuw nsw i64 %polly.indvar395, 20
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %167 = shl nsw i64 %polly.indvar410, 5
  %168 = add nsw i64 %167, %149
  %169 = icmp sgt i64 %168, 0
  %170 = select i1 %169, i64 %168, i64 0
  %polly.loop_guard417 = icmp slt i64 %170, 20
...
polly.loop_header414.preheader:                   ; preds = %polly.loop_header406
  ...
  %171 = add i64 %smax867, %indvars.iv870
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next411, %146
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  %indvars.iv872 = phi i64 [ %171, %polly.loop_header414.preheader ], [ %indvars.iv.next873, %polly.loop_exit423 ]
  ...
  %polly.loop_guard431945 = icmp sgt i64 %173, -1
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %min.iters.check1030 = icmp ult i64 %184, 4
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1031
  ...
  %186 = shl nuw nsw i64 %index1034, 3
  %187 = getelementptr i8, i8* %scevgep552, i64 %186
  %188 = bitcast i8* %187 to <4 x double>*
  %wide.load1038 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !84, !noalias !86
  %189 = fmul fast <4 x double> %wide.load1038, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %191 = icmp eq i64 %index.next1035, %n.vec1033
  br i1 %191, label %middle.block1027, label %vector.body1029, !llvm.loop !90

middle.block1027:                                 ; preds = %vector.body1029
  %cmp.n1037 = icmp eq i64 %184, %n.vec1033
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %193 = lshr i64 %indvars.iv904, 3
  %194 = sub nsw i64 %indvars.iv902, %193
  %195 = mul nuw nsw i64 %polly.indvar575, 3
  %196 = add nuw nsw i64 %195, 3
  %pexp.p_div_q584 = lshr i64 %196, 3
  %polly.loop_guard589.not = icmp ult i64 %polly.indvar575, %pexp.p_div_q584
  %197 = mul nsw i64 %polly.indvar575, -20
  %198 = mul nuw nsw i64 %polly.indvar575, 20
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next582, 125
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header586
  ...
  %219 = add i64 %smax892, %indvars.iv895
...
polly.loop_exit596:                               ; preds = %polly.loop_exit603, %polly.loop_header586
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar_next591, %194
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit603
  %indvars.iv897 = phi i64 [ %219, %polly.loop_header594.preheader ], [ %indvars.iv.next898, %polly.loop_exit603 ]
  ...
  %polly.loop_guard611946 = icmp sgt i64 %221, -1
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %smin968 = call i64 @llvm.smin.i64(i64 %234, i64 -1168)
  %235 = add nsw i64 %smin968, 1200
  %smin935 = call i64 @llvm.smin.i64(i64 %indvars.iv933, i64 -1168)
  %236 = shl nsw i64 %polly.indvar767, 5
  %237 = add nsw i64 %smin935, 1199
...
vector.ph969:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert976 = insertelement <4 x i64> poison, i64 %236, i32 0
  %broadcast.splat977 = shufflevector <4 x i64> %broadcast.splatinsert976, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert978 = insertelement <4 x i32> poison, i32 %239, i32 0
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph969
  ...
  %241 = add nuw nsw <4 x i64> %vec.ind974, %broadcast.splat977
  %242 = trunc <4 x i64> %241 to <4 x i32>
  %243 = mul <4 x i32> %broadcast.splat979, %242
  ...
  %253 = icmp eq i64 %index.next971, %235
  br i1 %253, label %polly.loop_exit778, label %vector.body967, !llvm.loop !99

polly.loop_exit778:                               ; preds = %vector.body967, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond940.not = icmp eq i64 %polly.indvar773, %233
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %exitcond936.not = icmp eq i64 %polly.indvar779, %237
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %263, i64 -968)
  %264 = add nsw i64 %smin983, 1000
  %smin925 = call i64 @llvm.smin.i64(i64 %indvars.iv923, i64 -968)
  %265 = shl nsw i64 %polly.indvar794, 5
  %266 = add nsw i64 %smin925, 999
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph985
  ...
  %270 = add nuw nsw <4 x i64> %vec.ind992, %broadcast.splat995
  %271 = trunc <4 x i64> %270 to <4 x i32>
  %272 = mul <4 x i32> %broadcast.splat997, %271
  ...
  %282 = icmp eq i64 %index.next989, %264
  br i1 %282, label %polly.loop_exit805, label %vector.body982, !llvm.loop !102

polly.loop_exit805:                               ; preds = %vector.body982, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond930.not = icmp eq i64 %polly.indvar800, %262
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond926.not = icmp eq i64 %polly.indvar806, %266
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %smin1001 = call i64 @llvm.smin.i64(i64 %292, i64 -968)
  %293 = add nsw i64 %smin1001, 1000
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -968)
  %294 = shl nsw i64 %polly.indvar820, 5
  %295 = add nsw i64 %smin915, 999
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  %299 = add nuw nsw <4 x i64> %vec.ind1010, %broadcast.splat1013
  %300 = trunc <4 x i64> %299 to <4 x i32>
  %301 = mul <4 x i32> %broadcast.splat1015, %300
  ...
  %311 = icmp eq i64 %index.next1007, %293
  br i1 %311, label %polly.loop_exit831, label %vector.body1000, !llvm.loop !105

polly.loop_exit831:                               ; preds = %vector.body1000, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond920.not = icmp eq i64 %polly.indvar826, %291
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar832, %295
...
polly.loop_header428.us.3:                        ; preds = %polly.loop_header428.us.3, %polly.loop_exit430.loopexit.us.2
  ...
  br i1 %exitcond875.3.not, label %polly.loop_exit430.loopexit.us.3, label %polly.loop_header428.us.3
...
polly.loop_header428.us.4:                        ; preds = %polly.loop_header428.us.4, %polly.loop_exit430.loopexit.us.3
  ...
  %exitcond875.4.not = icmp eq i64 %polly.indvar432.us.4, %smin874
  br i1 %exitcond875.4.not, label %polly.loop_exit430.loopexit.us.4, label %polly.loop_header428.us.4
...
polly.loop_header428.us.5:                        ; preds = %polly.loop_header428.us.5, %polly.loop_exit430.loopexit.us.4
  ...
  %exitcond875.5.not = icmp eq i64 %polly.indvar432.us.5, %smin874
  br i1 %exitcond875.5.not, label %polly.loop_exit430.loopexit.us.5, label %polly.loop_header428.us.5
...
polly.loop_header428.us.6:                        ; preds = %polly.loop_header428.us.6, %polly.loop_exit430.loopexit.us.5
  ...
  %exitcond875.6.not = icmp eq i64 %polly.indvar432.us.6, %smin874
  br i1 %exitcond875.6.not, label %polly.loop_exit430.loopexit.us.6, label %polly.loop_header428.us.6
...
polly.loop_header428.us.7:                        ; preds = %polly.loop_header428.us.7, %polly.loop_exit430.loopexit.us.6
  ...
  %exitcond875.7.not = icmp eq i64 %polly.indvar432.us.7, %smin874
  br i1 %exitcond875.7.not, label %polly.loop_exit423, label %polly.loop_header428.us.7
