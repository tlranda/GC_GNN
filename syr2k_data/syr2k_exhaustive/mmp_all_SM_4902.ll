; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4902.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4902.c"
...
vector.body1170:                                  ; preds = %vector.body1170, %vector.ph1172
  ...
  br i1 %57, label %middle.block1168, label %vector.body1170, !llvm.loop !54
...
vector.body1196:                                  ; preds = %vector.body1196, %vector.ph1198
  ...
  br i1 %68, label %middle.block1194, label %vector.body1196, !llvm.loop !56
...
vector.body1208:                                  ; preds = %vector.body1208, %vector.ph1212
  ...
  %wide.load1219 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !62, !noalias !64
  ...
  br i1 %95, label %middle.block1206, label %vector.body1208, !llvm.loop !68
...
vector.body1182:                                  ; preds = %vector.body1182, %vector.ph1186
  ...
  %wide.load1193 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %124, label %middle.block1180, label %vector.body1182, !llvm.loop !79
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %126 = mul nuw nsw i64 %polly.indvar384, 80
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1009.not = icmp eq i64 %polly.indvar_next391, 20
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %128 = mul nuw nsw i64 %polly.indvar396, 80
  %129 = sub nsw i64 %126, %128
  %130 = add nuw nsw i64 %128, 80
...
polly.merge424.us:                                ; preds = %polly.then425.us, %polly.cond423.loopexit.us
  ...
  %exitcond1001.not = icmp eq i64 %polly.indvar_next409.us, 50
...
polly.loop_header405:                             ; preds = %polly.loop_header399.split, %polly.loop_header405
  ...
  %exitcond992.not = icmp eq i64 %polly.indvar_next409, 50
...
polly.loop_exit443.loopexit.us:                   ; preds = %polly.loop_header441.us
  ...
  %exitcond1004.not = icmp eq i64 %polly.indvar_next438.us, 50
...
vector.body1158:                                  ; preds = %vector.body1158, %vector.ph1160
  ...
  %wide.load1167 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %153, label %middle.block1156, label %vector.body1158, !llvm.loop !89
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %155 = mul nuw nsw i64 %polly.indvar572, 80
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_header575
  ...
  %157 = mul nuw nsw i64 %polly.indvar584, 80
  %158 = sub nsw i64 %155, %157
  %159 = add nuw nsw i64 %157, 80
...
polly.merge612.us:                                ; preds = %polly.then613.us, %polly.cond611.loopexit.us
  ...
  %exitcond1022.not = icmp eq i64 %polly.indvar_next597.us, 50
...
polly.loop_header593:                             ; preds = %polly.loop_header587.split, %polly.loop_header593
  ...
  %exitcond1013.not = icmp eq i64 %polly.indvar_next597, 50
...
polly.loop_exit631.loopexit.us:                   ; preds = %polly.loop_header629.us
  ...
  %exitcond1025.not = icmp eq i64 %polly.indvar_next626.us, 50
...
vector.body1097:                                  ; preds = %vector.body1097, %vector.ph1098
  ...
  br i1 %196, label %polly.loop_exit799, label %vector.body1097, !llvm.loop !98
...
vector.body1111:                                  ; preds = %vector.body1111, %vector.ph1114
  ...
  br i1 %225, label %polly.loop_exit826, label %vector.body1111, !llvm.loop !101
...
vector.body1129:                                  ; preds = %vector.body1129, %vector.ph1132
  ...
  br i1 %254, label %polly.loop_exit852, label %vector.body1129, !llvm.loop !104
