; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1142.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1142.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %118 = mul nsw i64 %indvar1413, -100
  %119 = add i64 %104, %118
  %smax1415 = call i64 @llvm.smax.i64(i64 %119, i64 0)
  %120 = mul nuw nsw i64 %indvar1413, 100
  %121 = add i64 %106, %120
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us, %polly.loop_header228.split
  ...
  %polly.loop_guard275 = icmp slt i64 %137, 100
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  ...
  %smin1418 = call i64 @llvm.smin.i64(i64 %138, i64 127)
  %139 = add nsw i64 %smin1418, 1
  %smin1102 = call i64 @llvm.smin.i64(i64 %indvars.iv1100, i64 127)
...
polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  ...
  %174 = shl nsw i64 %polly.indvar415, 5
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %180 = sub i64 %175, %179
  %181 = mul nsw i64 %polly.indvar421, -128
  %182 = add i64 %181, %179
  ...
  %188 = shl nsw i64 %polly.indvar421, 7
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %189 = mul nsw i64 %polly.indvar421, -128
...
polly.loop_exit443:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1123 = add nuw nsw i64 %indvars.iv1122, 128
  %indvars.iv.next1125 = add nuw nsw i64 %indvars.iv1124, 7
  %indvars.iv.next1130 = add nsw i64 %indvars.iv1129, -128
  %exitcond1139.not = icmp eq i64 %polly.indvar_next422, 10
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header441.split
  ...
  %polly.loop_guard490 = icmp slt i64 %213, 100
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1368 = call i64 @llvm.smin.i64(i64 %214, i64 127)
  %215 = add nsw i64 %smin1368, 1
  %smin1135 = call i64 @llvm.smin.i64(i64 %indvars.iv1133, i64 127)
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %250 = shl nsw i64 %polly.indvar630, 5
...
polly.loop_exit658:                               ; preds = %polly.loop_exit697
  ...
  %indvars.iv.next1144 = add nsw i64 %indvars.iv1143, -128
  %indvars.iv.next1156 = add nuw nsw i64 %indvars.iv1155, 128
...
polly.loop_exit697:                               ; preds = %polly.loop_exit704.loopexit.us, %polly.loop_header695.preheader
  ...
  %indvars.iv.next1160 = add i64 %indvars.iv1159, -100
  %indvars.iv.next1165 = add i64 %indvars.iv1164, 100
...
polly.loop_header695.preheader:                   ; preds = %polly.loop_exit683, %polly.loop_exit683.us, %polly.loop_header656.split
  ...
  %polly.loop_guard705 = icmp slt i64 %289, 100
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  ...
  %smin1318 = call i64 @llvm.smin.i64(i64 %290, i64 127)
