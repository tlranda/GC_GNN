; ModuleID = 'syr2k_exhaustive/mmp_all_XL_936.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_936.c"
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1106.not = icmp eq i64 %117, 150
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %120 = mul nsw i64 %indvar1398, -80
  %121 = add i64 %101, %120
  %smax1400 = call i64 @llvm.smax.i64(i64 %121, i64 0)
  %122 = mul nuw nsw i64 %indvar1398, 80
  %123 = add i64 %103, %122
  %124 = add i64 %smax1400, %123
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1096, i64 0)
  %125 = add i64 %smax, %indvars.iv1100
  %126 = mul nuw nsw i64 %polly.indvar231, 10
  %.not.not = icmp ugt i64 %126, %polly.indvar209
  %127 = mul nuw nsw i64 %polly.indvar231, 80
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %polly.loop_guard273 = icmp slt i64 %137, 80
...
polly.loop_header270.us:                          ; preds = %polly.loop_header263.us, %polly.loop_exit280.us
  ...
  %138 = add i64 %124, %indvar1401
  %smin1403 = call i64 @llvm.smin.i64(i64 %138, i64 7)
  %139 = add nsw i64 %smin1403, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1102, i64 7)
  %140 = add nsw i64 %polly.indvar274.us, %128
  %polly.loop_guard281.us1194 = icmp sgt i64 %140, -1
...
polly.loop_header278.preheader.us:                ; preds = %polly.loop_header270.us
  ...
  %min.iters.check1404 = icmp ult i64 %139, 4
...
vector.body1397:                                  ; preds = %vector.body1397, %vector.ph1405
  ...
  %146 = add nuw nsw i64 %index1408, %108
  %147 = add nuw nsw i64 %index1408, %polly.access.mul.Packed_MemRef_call1285.us
  %148 = getelementptr double, double* %Packed_MemRef_call1, i64 %147
  %149 = bitcast double* %148 to <4 x double>*
  %wide.load1412 = load <4 x double>, <4 x double>* %149, align 8
  %150 = fmul fast <4 x double> %broadcast.splat1414, %wide.load1412
  %151 = getelementptr double, double* %Packed_MemRef_call2, i64 %147
  %152 = bitcast double* %151 to <4 x double>*
  %wide.load1415 = load <4 x double>, <4 x double>* %152, align 8
  %153 = fmul fast <4 x double> %broadcast.splat1417, %wide.load1415
  %154 = shl i64 %146, 3
  %155 = add i64 %154, %145
  %156 = getelementptr i8, i8* %call, i64 %155
  %157 = bitcast i8* %156 to <4 x double>*
  %wide.load1418 = load <4 x double>, <4 x double>* %157, align 8, !alias.scope !72, !noalias !74
  ...
  %160 = fadd fast <4 x double> %159, %wide.load1418
  ...
  %162 = icmp eq i64 %index.next1409, %n.vec1407
  br i1 %162, label %middle.block1395, label %vector.body1397, !llvm.loop !85

middle.block1395:                                 ; preds = %vector.body1397
  %cmp.n1411 = icmp eq i64 %139, %n.vec1407
...
vector.body1333:                                  ; preds = %vector.body1333, %vector.ph1337
  ...
  %166 = shl nuw nsw i64 %index1340, 3
  %167 = getelementptr i8, i8* %scevgep406, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load1344 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !86, !noalias !88
  %169 = fmul fast <4 x double> %wide.load1344, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next1341, %n.vec1339
  br i1 %171, label %middle.block1331, label %vector.body1333, !llvm.loop !93

middle.block1331:                                 ; preds = %vector.body1333
  %cmp.n1343 = icmp eq i64 %164, %n.vec1339
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %173 = mul nuw nsw i64 %polly.indvar413, 100
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %175 = udiv i64 %polly.indvar419, 10
  %176 = mul nuw nsw i64 %175, 80
  %177 = sub nsw i64 %174, %176
  %178 = mul nsw i64 %polly.indvar419, -8
  %179 = add i64 %178, %176
  %180 = udiv i64 %polly.indvar419, 10
  %181 = mul nuw nsw i64 %180, 80
  %182 = sub nsw i64 %indvars.iv1117, %181
  %183 = add i64 %indvars.iv1122, %181
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %exitcond1131.not = icmp eq i64 %193, 150
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %indvars.iv1124 = phi i64 [ %indvars.iv.next1125, %polly.loop_exit482 ], [ %183, %polly.loop_exit424 ]
  %indvars.iv1119 = phi i64 [ %indvars.iv.next1120, %polly.loop_exit482 ], [ %182, %polly.loop_exit424 ]
  %polly.indvar442 = phi i64 [ %polly.indvar_next443, %polly.loop_exit482 ], [ %180, %polly.loop_exit424 ]
  %196 = mul nsw i64 %indvar1348, -80
  %197 = add i64 %177, %196
  %smax1350 = call i64 @llvm.smax.i64(i64 %197, i64 0)
  %198 = mul nuw nsw i64 %indvar1348, 80
  %199 = add i64 %179, %198
  %200 = add i64 %smax1350, %199
  %smax1121 = call i64 @llvm.smax.i64(i64 %indvars.iv1119, i64 0)
  %201 = add i64 %smax1121, %indvars.iv1124
  %202 = mul nuw nsw i64 %polly.indvar442, 10
  %.not.not944 = icmp ugt i64 %202, %polly.indvar419
  %203 = mul nuw nsw i64 %polly.indvar442, 80
  %204 = add nsw i64 %203, %185
  %205 = icmp sgt i64 %204, 0
  %206 = select i1 %205, i64 %204, i64 0
  %207 = add nsw i64 %204, 79
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %polly.loop_guard490 = icmp slt i64 %213, 80
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %214 = add i64 %200, %indvar1351
  %smin1353 = call i64 @llvm.smin.i64(i64 %214, i64 7)
  %215 = add nsw i64 %smin1353, 1
  %smin1128 = call i64 @llvm.smin.i64(i64 %indvars.iv1126, i64 7)
  %216 = add nsw i64 %polly.indvar491.us, %204
  %polly.loop_guard498.us1195 = icmp sgt i64 %216, -1
...
polly.loop_header495.preheader.us:                ; preds = %polly.loop_header487.us
  ...
  %min.iters.check1354 = icmp ult i64 %215, 4
...
vector.body1347:                                  ; preds = %vector.body1347, %vector.ph1355
  ...
  %222 = add nuw nsw i64 %index1358, %184
  %223 = add nuw nsw i64 %index1358, %polly.access.mul.Packed_MemRef_call1309502.us
  %224 = getelementptr double, double* %Packed_MemRef_call1309, i64 %223
  %225 = bitcast double* %224 to <4 x double>*
  %wide.load1362 = load <4 x double>, <4 x double>* %225, align 8
  %226 = fmul fast <4 x double> %broadcast.splat1364, %wide.load1362
  %227 = getelementptr double, double* %Packed_MemRef_call2311, i64 %223
  %228 = bitcast double* %227 to <4 x double>*
  %wide.load1365 = load <4 x double>, <4 x double>* %228, align 8
  %229 = fmul fast <4 x double> %broadcast.splat1367, %wide.load1365
  %230 = shl i64 %222, 3
  %231 = add i64 %230, %221
  %232 = getelementptr i8, i8* %call, i64 %231
  %233 = bitcast i8* %232 to <4 x double>*
  %wide.load1368 = load <4 x double>, <4 x double>* %233, align 8, !alias.scope !86, !noalias !88
  ...
  %236 = fadd fast <4 x double> %235, %wide.load1368
  ...
  %238 = icmp eq i64 %index.next1359, %n.vec1357
  br i1 %238, label %middle.block1345, label %vector.body1347, !llvm.loop !98

middle.block1345:                                 ; preds = %vector.body1347
  %cmp.n1361 = icmp eq i64 %215, %n.vec1357
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1286 = icmp ult i64 %240, 4
...
vector.body1285:                                  ; preds = %vector.body1285, %vector.ph1287
  ...
  %242 = shl nuw nsw i64 %index1290, 3
  %243 = getelementptr i8, i8* %scevgep623, i64 %242
  %244 = bitcast i8* %243 to <4 x double>*
  %wide.load1294 = load <4 x double>, <4 x double>* %244, align 8, !alias.scope !99, !noalias !101
  %245 = fmul fast <4 x double> %wide.load1294, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %247 = icmp eq i64 %index.next1291, %n.vec1289
  br i1 %247, label %middle.block1283, label %vector.body1285, !llvm.loop !106

middle.block1283:                                 ; preds = %vector.body1285
  %cmp.n1293 = icmp eq i64 %240, %n.vec1289
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %249 = mul nuw nsw i64 %polly.indvar630, 100
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %251 = udiv i64 %polly.indvar636, 10
  %252 = mul nuw nsw i64 %251, 80
  %253 = sub nsw i64 %250, %252
  %254 = mul nsw i64 %polly.indvar636, -8
  %255 = add i64 %254, %252
  %256 = udiv i64 %polly.indvar636, 10
  %257 = mul nuw nsw i64 %256, 80
  %258 = sub nsw i64 %indvars.iv1142, %257
  %259 = add i64 %indvars.iv1147, %257
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %exitcond1156.not = icmp eq i64 %269, 150
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %indvars.iv1149 = phi i64 [ %indvars.iv.next1150, %polly.loop_exit699 ], [ %259, %polly.loop_exit641 ]
  %indvars.iv1144 = phi i64 [ %indvars.iv.next1145, %polly.loop_exit699 ], [ %258, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit699 ], [ %256, %polly.loop_exit641 ]
  %272 = mul nsw i64 %indvar1298, -80
  %273 = add i64 %253, %272
  %smax1300 = call i64 @llvm.smax.i64(i64 %273, i64 0)
  %274 = mul nuw nsw i64 %indvar1298, 80
  %275 = add i64 %255, %274
  %276 = add i64 %smax1300, %275
  %smax1146 = call i64 @llvm.smax.i64(i64 %indvars.iv1144, i64 0)
  %277 = add i64 %smax1146, %indvars.iv1149
  %278 = mul nuw nsw i64 %polly.indvar659, 10
  %.not.not945 = icmp ugt i64 %278, %polly.indvar636
  %279 = mul nuw nsw i64 %polly.indvar659, 80
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %polly.loop_guard707 = icmp slt i64 %289, 80
...
polly.loop_header704.us:                          ; preds = %polly.loop_header697.us, %polly.loop_exit714.us
  ...
  %indvars.iv1151 = phi i64 [ %277, %polly.loop_header697.us ], [ %indvars.iv.next1152, %polly.loop_exit714.us ]
  %polly.indvar708.us = phi i64 [ %289, %polly.loop_header697.us ], [ %polly.indvar_next709.us, %polly.loop_exit714.us ]
  %290 = add i64 %276, %indvar1301
  %smin1303 = call i64 @llvm.smin.i64(i64 %290, i64 7)
  %291 = add nsw i64 %smin1303, 1
  %smin1153 = call i64 @llvm.smin.i64(i64 %indvars.iv1151, i64 7)
  %292 = add nsw i64 %polly.indvar708.us, %280
  %polly.loop_guard715.us1196 = icmp sgt i64 %292, -1
...
polly.loop_header712.preheader.us:                ; preds = %polly.loop_header704.us
  ...
  %min.iters.check1304 = icmp ult i64 %291, 4
...
vector.body1297:                                  ; preds = %vector.body1297, %vector.ph1305
  ...
  %298 = add nuw nsw i64 %index1308, %260
  %299 = add nuw nsw i64 %index1308, %polly.access.mul.Packed_MemRef_call1526719.us
  %300 = getelementptr double, double* %Packed_MemRef_call1526, i64 %299
  %301 = bitcast double* %300 to <4 x double>*
  %wide.load1312 = load <4 x double>, <4 x double>* %301, align 8
  %302 = fmul fast <4 x double> %broadcast.splat1314, %wide.load1312
  %303 = getelementptr double, double* %Packed_MemRef_call2528, i64 %299
  %304 = bitcast double* %303 to <4 x double>*
  %wide.load1315 = load <4 x double>, <4 x double>* %304, align 8
  %305 = fmul fast <4 x double> %broadcast.splat1317, %wide.load1315
  %306 = shl i64 %298, 3
  %307 = add i64 %306, %297
  %308 = getelementptr i8, i8* %call, i64 %307
  %309 = bitcast i8* %308 to <4 x double>*
  %wide.load1318 = load <4 x double>, <4 x double>* %309, align 8, !alias.scope !99, !noalias !101
  ...
  %312 = fadd fast <4 x double> %311, %wide.load1318
  ...
  %314 = icmp eq i64 %index.next1309, %n.vec1307
  br i1 %314, label %middle.block1295, label %vector.body1297, !llvm.loop !111

middle.block1295:                                 ; preds = %vector.body1297
  %cmp.n1311 = icmp eq i64 %291, %n.vec1307
...
polly.loop_header870:                             ; preds = %polly.loop_exit878, %polly.loop_header864
  ...
  %smin1224 = call i64 @llvm.smin.i64(i64 %318, i64 -1168)
  %319 = add nsw i64 %smin1224, 1200
...
vector.ph1225:                                    ; preds = %polly.loop_header876
  %broadcast.splatinsert1232 = insertelement <4 x i64> poison, i64 %320, i32 0
  %broadcast.splat1233 = shufflevector <4 x i64> %broadcast.splatinsert1232, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1234 = insertelement <4 x i32> poison, i32 %323, i32 0
...
vector.body1223:                                  ; preds = %vector.body1223, %vector.ph1225
  ...
  %325 = add nuw nsw <4 x i64> %vec.ind1230, %broadcast.splat1233
  %326 = trunc <4 x i64> %325 to <4 x i32>
  %327 = mul <4 x i32> %broadcast.splat1235, %326
  ...
  %337 = icmp eq i64 %index.next1227, %319
  br i1 %337, label %polly.loop_exit884, label %vector.body1223, !llvm.loop !117

polly.loop_exit884:                               ; preds = %vector.body1223, %polly.loop_header882
  %polly.indvar_next880 = add nuw nsw i64 %polly.indvar879, 1
  %exitcond1187.not = icmp eq i64 %polly.indvar879, %317
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  %exitcond1183.not = icmp eq i64 %polly.indvar885, %321
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %smin1239 = call i64 @llvm.smin.i64(i64 %347, i64 -968)
  %348 = add nsw i64 %smin1239, 1000
  %smin1172 = call i64 @llvm.smin.i64(i64 %indvars.iv1170, i64 -968)
  %349 = shl nsw i64 %polly.indvar900, 5
  %350 = add nsw i64 %smin1172, 999
...
vector.body1238:                                  ; preds = %vector.body1238, %vector.ph1241
  ...
  %354 = add nuw nsw <4 x i64> %vec.ind1248, %broadcast.splat1251
  %355 = trunc <4 x i64> %354 to <4 x i32>
  %356 = mul <4 x i32> %broadcast.splat1253, %355
  ...
  %366 = icmp eq i64 %index.next1245, %348
  br i1 %366, label %polly.loop_exit911, label %vector.body1238, !llvm.loop !120

polly.loop_exit911:                               ; preds = %vector.body1238, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1177.not = icmp eq i64 %polly.indvar906, %346
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %exitcond1173.not = icmp eq i64 %polly.indvar912, %350
...
polly.loop_header923:                             ; preds = %polly.loop_exit931, %polly.loop_header917
  ...
  %smin1257 = call i64 @llvm.smin.i64(i64 %376, i64 -968)
  %377 = add nsw i64 %smin1257, 1000
  %smin1162 = call i64 @llvm.smin.i64(i64 %indvars.iv1160, i64 -968)
  %378 = shl nsw i64 %polly.indvar926, 5
  %379 = add nsw i64 %smin1162, 999
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1259
  ...
  %383 = add nuw nsw <4 x i64> %vec.ind1266, %broadcast.splat1269
  %384 = trunc <4 x i64> %383 to <4 x i32>
  %385 = mul <4 x i32> %broadcast.splat1271, %384
  ...
  %395 = icmp eq i64 %index.next1263, %377
  br i1 %395, label %polly.loop_exit937, label %vector.body1256, !llvm.loop !123

polly.loop_exit937:                               ; preds = %vector.body1256, %polly.loop_header935
  %polly.indvar_next933 = add nuw nsw i64 %polly.indvar932, 1
  %exitcond1167.not = icmp eq i64 %polly.indvar932, %375
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  %exitcond1163.not = icmp eq i64 %polly.indvar938, %379
