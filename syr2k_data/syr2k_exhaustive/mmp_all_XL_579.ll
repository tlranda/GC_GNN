; ModuleID = 'syr2k_exhaustive/mmp_all_XL_579.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_579.c"
...
polly.loop_header272:                             ; preds = %polly.loop_header265, %polly.loop_exit282
  ...
  %smin1413 = call i64 @llvm.smin.i64(i64 %145, i64 79)
...
polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  ...
  %179 = mul nuw nsw i64 %polly.indvar415, 100
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %180 = mul nuw nsw i64 %polly.indvar421, 80
  %181 = shl nuw nsw i64 %polly.indvar421, 1
  %182 = lshr i64 %polly.indvar421, 1
  %183 = add nuw i64 %181, %182
  %184 = shl nuw nsw i64 %183, 5
  %185 = sub i64 %180, %184
  %186 = mul nsw i64 %polly.indvar421, -80
  %187 = add i64 %186, %184
  %188 = lshr i64 %polly.indvar421, 1
  %189 = add nuw i64 %indvars.iv1119, %188
  %190 = shl nuw nsw i64 %189, 5
  %191 = sub i64 %indvars.iv1117, %190
  %192 = add i64 %indvars.iv1124, %190
  %193 = mul nsw i64 %polly.indvar421, -80
  %194 = mul nuw nsw i64 %polly.indvar421, 80
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %195 = add nsw i64 %193, 1199
  %196 = shl nuw nsw i64 %polly.indvar421, 1
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit426
  ...
  %.inv942 = icmp sgt i64 %207, 79
  %209 = select i1 %.inv942, i64 79, i64 %208
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %smin1363 = call i64 @llvm.smin.i64(i64 %227, i64 79)
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %261 = mul nuw nsw i64 %polly.indvar630, 100
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit641
  ...
  %.inv943 = icmp sgt i64 %289, 79
  %291 = select i1 %.inv943, i64 79, i64 %290
...
polly.loop_header702:                             ; preds = %polly.loop_header695, %polly.loop_exit712
  ...
  %smin1313 = call i64 @llvm.smin.i64(i64 %309, i64 79)
