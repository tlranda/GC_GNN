; ModuleID = 'syr2k_exhaustive/mmp_all_XL_714.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_714.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1061 = call i64 @llvm.smin.i64(i64 %indvars.iv1033, i64 -872)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next204, 8
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %indvars.iv1039 = phi i64 [ %indvars.iv.next1040, %polly.loop_exit230 ], [ 50, %polly.loop_header200 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit230 ], [ 1200, %polly.loop_header200 ]
  %polly.indvar209 = phi i64 [ %polly.indvar_next210, %polly.loop_exit230 ], [ 0, %polly.loop_header200 ]
  %99 = mul nuw nsw i64 %polly.indvar209, 6
  %100 = mul nsw i64 %polly.indvar209, -6
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %104 = shl nsw i64 %polly.indvar209, 7
  %105 = or i64 %104, 1
...
polly.loop_exit230:                               ; preds = %polly.loop_exit286
  ...
  %indvars.iv.next1040 = add nsw i64 %indvars.iv1039, -6
  %indvars.iv.next1050 = add nuw nsw i64 %indvars.iv1049, 6
  %indvars.iv.next1054 = add nsw i64 %indvars.iv1053, -6
...
polly.loop_header234.preheader:                   ; preds = %polly.loop_header228
  %115 = mul nuw nsw i64 %polly.indvar231, 50
...
polly.merge.loopexit:                             ; preds = %polly.loop_exit273
  %.pre1190 = mul nuw nsw i64 %polly.indvar231, 50
...
polly.loop_exit286:                               ; preds = %polly.loop_exit292
  ...
  %indvars.iv.next1056 = add nsw i64 %indvars.iv1055, 50
  %exitcond1063.not = icmp eq i64 %polly.indvar_next232, 24
...
polly.start325:                                   ; preds = %kernel_syr2k.exit
  ...
  %malloccall329 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
polly.loop_header429:                             ; preds = %polly.loop_header429.preheader, %polly.loop_exit437
  ...
  %smin1101 = call i64 @llvm.smin.i64(i64 %indvars.iv1071, i64 -872)
  %164 = add nsw i64 %smin1101, 1000
  %165 = shl nsw i64 %polly.indvar432, 7
...
polly.loop_exit437:                               ; preds = %polly.loop_exit459
  ...
  %exitcond1105.not = icmp eq i64 %polly.indvar_next433, 8
...
polly.loop_header435:                             ; preds = %polly.loop_exit459, %polly.loop_header429
  ...
  %indvars.iv1078 = phi i64 [ %indvars.iv.next1079, %polly.loop_exit459 ], [ 50, %polly.loop_header429 ]
  ...
  %166 = mul nuw nsw i64 %polly.indvar438, 6
  %167 = mul nsw i64 %polly.indvar438, -6
...
polly.loop_exit443:                               ; preds = %polly.loop_exit449
  ...
  %170 = mul nuw nsw i64 %polly.indvar438, 5
  %171 = shl nsw i64 %polly.indvar438, 7
  %172 = or i64 %171, 1
...
polly.loop_exit459:                               ; preds = %polly.loop_exit521
  ...
  %indvars.iv.next1079 = add nsw i64 %indvars.iv1078, -6
  %indvars.iv.next1089 = add nuw nsw i64 %indvars.iv1088, 6
  %indvars.iv.next1094 = add nsw i64 %indvars.iv1093, -6
...
polly.loop_header467.preheader:                   ; preds = %polly.loop_header457
  %182 = mul nuw nsw i64 %polly.indvar460, 50
...
polly.merge464.loopexit:                          ; preds = %polly.loop_exit508
  %.pre1188 = mul nuw nsw i64 %polly.indvar460, 50
...
polly.loop_exit521:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next1091 = add nsw i64 %indvars.iv1090, -50
  %indvars.iv.next1096 = add nsw i64 %indvars.iv1095, 50
  %exitcond1103.not = icmp eq i64 %polly.indvar_next461, 24
...
polly.start560:                                   ; preds = %init_array.exit
  %malloccall562 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
  %malloccall564 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
polly.loop_header664:                             ; preds = %polly.loop_header664.preheader, %polly.loop_exit672
  ...
  %smin1141 = call i64 @llvm.smin.i64(i64 %indvars.iv1111, i64 -872)
  %231 = add nsw i64 %smin1141, 1000
  %232 = shl nsw i64 %polly.indvar667, 7
...
polly.loop_exit672:                               ; preds = %polly.loop_exit694
  ...
  %exitcond1145.not = icmp eq i64 %polly.indvar_next668, 8
...
polly.loop_header670:                             ; preds = %polly.loop_exit694, %polly.loop_header664
  ...
  %indvars.iv1118 = phi i64 [ %indvars.iv.next1119, %polly.loop_exit694 ], [ 50, %polly.loop_header664 ]
  ...
  %233 = mul nuw nsw i64 %polly.indvar673, 6
  %234 = mul nsw i64 %polly.indvar673, -6
...
polly.loop_exit678:                               ; preds = %polly.loop_exit684
  ...
  %237 = mul nuw nsw i64 %polly.indvar673, 5
  %238 = shl nsw i64 %polly.indvar673, 7
  %239 = or i64 %238, 1
...
polly.loop_exit694:                               ; preds = %polly.loop_exit756
  ...
  %indvars.iv.next1119 = add nsw i64 %indvars.iv1118, -6
  %indvars.iv.next1129 = add nuw nsw i64 %indvars.iv1128, 6
  %indvars.iv.next1134 = add nsw i64 %indvars.iv1133, -6
...
polly.loop_header702.preheader:                   ; preds = %polly.loop_header692
  %249 = mul nuw nsw i64 %polly.indvar695, 50
...
polly.loop_exit756:                               ; preds = %polly.loop_exit762
  ...
  %indvars.iv.next1131 = add nsw i64 %indvars.iv1130, -50
  %indvars.iv.next1136 = add nsw i64 %indvars.iv1135, 50
  %exitcond1143.not = icmp eq i64 %polly.indvar_next696, 24
