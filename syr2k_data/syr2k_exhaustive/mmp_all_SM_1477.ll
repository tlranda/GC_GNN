; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1477.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1477.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next220, 150
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1363 = call i64 @llvm.smin.i64(i64 %116, i64 19)
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  ...
  %156 = shl nuw nsw i64 %polly.indvar423, 3
  %157 = udiv i64 %indvars.iv1086, 5
  %158 = mul nsw i64 %polly.indvar423, -8
  %159 = shl nsw i64 %polly.indvar423, 3
  br label %polly.loop_header426

polly.loop_exit428:                               ; preds = %polly.loop_exit435
  %polly.indvar_next424 = add nuw nsw i64 %polly.indvar423, 1
  %indvars.iv.next1068 = add nsw i64 %indvars.iv1067, -8
  %indvars.iv.next1073 = add nuw nsw i64 %indvars.iv1072, 8
  %indvars.iv.next1087 = add nuw nsw i64 %indvars.iv1086, 2
  %exitcond1090.not = icmp eq i64 %polly.indvar_next424, 150
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %polly.loop_guard443 = icmp slt i64 %170, 8
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1315 = call i64 @llvm.smin.i64(i64 %174, i64 19)
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  ...
  %213 = mul nsw i64 %polly.indvar634, -8
  %214 = shl nuw nsw i64 %polly.indvar634, 3
  %215 = udiv i64 %indvars.iv1118, 5
  %216 = mul nsw i64 %polly.indvar634, -8
  %217 = shl nsw i64 %polly.indvar634, 3
...
polly.loop_exit639:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1122.not = icmp eq i64 %polly.indvar_next635, 150
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %polly.loop_guard654 = icmp slt i64 %228, 8
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1267 = call i64 @llvm.smin.i64(i64 %232, i64 19)
