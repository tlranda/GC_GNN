; ModuleID = 'syr2k_exhaustive/mmp_all_SM_116.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_116.c"
...
polly.loop_exit410:                               ; preds = %polly.loop_exit416
  %178 = mul nsw i64 %polly.indvar405, -64
  %179 = shl nsw i64 %polly.indvar405, 4
...
polly.loop_header606:                             ; preds = %polly.loop_header606.preheader, %polly.loop_exit630
  ...
  %257 = shl nsw i64 %polly.indvar609, 6
  br label %polly.loop_header612

polly.loop_exit614:                               ; preds = %polly.loop_exit620
  %258 = mul nsw i64 %polly.indvar609, -64
  %259 = shl nsw i64 %polly.indvar609, 4
