; ModuleID = 'syr2k_exhaustive/mmp_all_XL_378.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_378.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %129 = shl nsw i64 %polly.indvar209, 5
...
polly.loop_header228:                             ; preds = %polly.loop_exit220.7, %polly.loop_exit269
  ...
  %131 = mul nsw i64 %indvar1426, -20
  %132 = add i64 %110, %131
  %smax1445 = call i64 @llvm.smax.i64(i64 %132, i64 0)
  %133 = mul nuw nsw i64 %indvar1426, 20
  %134 = add i64 %112, %133
  %135 = add i64 %smax1445, %134
  %136 = mul nsw i64 %indvar1426, -20
  %137 = add i64 %119, %136
  %smax1428 = call i64 @llvm.smax.i64(i64 %137, i64 0)
  %138 = mul nuw nsw i64 %indvar1426, 20
  %139 = add i64 %121, %138
...
polly.loop_header267.preheader:                   ; preds = %polly.loop_header253.7, %polly.loop_header253.us.7, %polly.loop_exit243.loopexit.us.7, %polly.loop_header228.split
  ...
  %polly.loop_guard277 = icmp slt i64 %158, 20
...
polly.loop_header274.us:                          ; preds = %polly.loop_header267.us, %polly.loop_exit284.us
  ...
  %smin1446 = call i64 @llvm.smin.i64(i64 %161, i64 31)
  ...
  %smin1433 = call i64 @llvm.smin.i64(i64 %166, i64 31)
...
polly.loop_header444:                             ; preds = %polly.loop_exit434.7, %polly.loop_exit486
  ...
  %235 = mul nsw i64 %indvar1363, -20
  %236 = add i64 %214, %235
  %smax1382 = call i64 @llvm.smax.i64(i64 %236, i64 0)
  %237 = mul nuw nsw i64 %indvar1363, 20
  %238 = add i64 %216, %237
  %239 = add i64 %smax1382, %238
  %240 = mul nsw i64 %indvar1363, -20
  %241 = add i64 %223, %240
  %smax1365 = call i64 @llvm.smax.i64(i64 %241, i64 0)
  %242 = mul nuw nsw i64 %indvar1363, 20
  %243 = add i64 %225, %242
...
polly.loop_header484.preheader:                   ; preds = %polly.loop_header470.7, %polly.loop_header470.us.7, %polly.loop_exit460.loopexit.us.7, %polly.loop_header444.split
  ...
  %polly.loop_guard494 = icmp slt i64 %262, 20
...
polly.loop_header491.us:                          ; preds = %polly.loop_header484.us, %polly.loop_exit501.us
  ...
  %smin1383 = call i64 @llvm.smin.i64(i64 %265, i64 31)
  ...
  %smin1370 = call i64 @llvm.smin.i64(i64 %270, i64 31)
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %313 = mul nsw i64 %polly.indvar640, -8
  %314 = shl nuw nsw i64 %polly.indvar640, 1
  %315 = add nuw i64 %314, 4
  %316 = udiv i64 %315, 5
  %317 = mul nuw nsw i64 %316, 20
  %318 = add i64 %313, %317
  %319 = shl nuw nsw i64 %polly.indvar640, 3
  %320 = sub nsw i64 %319, %317
  %321 = shl nuw nsw i64 %polly.indvar640, 8
  %322 = mul nsw i64 %polly.indvar640, -8
  %323 = shl nuw nsw i64 %polly.indvar640, 1
  %324 = add nuw i64 %323, 4
  %325 = udiv i64 %324, 5
  %326 = mul nuw nsw i64 %325, 20
  %327 = add i64 %322, %326
  %328 = mul nuw nsw i64 %polly.indvar640, 40
  %329 = sub nsw i64 %328, %326
  %330 = or i64 %321, 8
  %331 = shl nuw nsw i64 %polly.indvar640, 3
  ...
  %337 = shl nsw i64 %polly.indvar640, 5
...
polly.loop_header661:                             ; preds = %polly.loop_exit651.7, %polly.loop_exit703
  ...
  %339 = mul nsw i64 %indvar1300, -20
  %340 = add i64 %318, %339
  %smax1319 = call i64 @llvm.smax.i64(i64 %340, i64 0)
  %341 = mul nuw nsw i64 %indvar1300, 20
  %342 = add i64 %320, %341
  %343 = add i64 %smax1319, %342
  %344 = mul nsw i64 %indvar1300, -20
  %345 = add i64 %327, %344
  %smax1302 = call i64 @llvm.smax.i64(i64 %345, i64 0)
  %346 = mul nuw nsw i64 %indvar1300, 20
  %347 = add i64 %329, %346
...
polly.loop_header701.preheader:                   ; preds = %polly.loop_header687.7, %polly.loop_header687.us.7, %polly.loop_exit677.loopexit.us.7, %polly.loop_header661.split
  ...
  %polly.loop_guard711 = icmp slt i64 %366, 20
...
polly.loop_header708.us:                          ; preds = %polly.loop_header701.us, %polly.loop_exit718.us
  ...
  %smin1320 = call i64 @llvm.smin.i64(i64 %369, i64 31)
  ...
  %smin1307 = call i64 @llvm.smin.i64(i64 %374, i64 31)
...
polly.loop_exit220.7:                             ; preds = %polly.loop_header218.7
  %494 = mul nsw i64 %polly.indvar209, -32
  ...
  %polly.loop_guard = icmp slt i64 %497, 60
...
polly.loop_exit434.7:                             ; preds = %polly.loop_header432.7
  %526 = mul nsw i64 %polly.indvar423, -32
  ...
  %polly.loop_guard447 = icmp slt i64 %529, 60
...
polly.loop_exit651.7:                             ; preds = %polly.loop_header649.7
  %558 = mul nsw i64 %polly.indvar640, -32
  ...
  %polly.loop_guard664 = icmp slt i64 %561, 60
