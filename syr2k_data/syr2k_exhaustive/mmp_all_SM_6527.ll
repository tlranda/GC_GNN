; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6527.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6527.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %103 = shl nsw i64 %polly.indvar202, 3
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next203, 38
...
polly.loop_header233.us:                          ; preds = %polly.loop_exit242.us, %polly.loop_header227.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 31)
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %132 = shl nsw i64 %polly.indvar373, 5
  br label %polly.loop_header376

polly.loop_exit378:                               ; preds = %polly.loop_exit384
  %133 = mul nsw i64 %polly.indvar373, -32
  %134 = shl nsw i64 %polly.indvar373, 3
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next858 = add nuw nsw i64 %indvars.iv857, 32
  %indvars.iv.next860 = add nuw nsw i64 %indvars.iv859, 8
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, -32
  %exitcond873.not = icmp eq i64 %polly.indvar_next374, 38
...
polly.loop_header406.us:                          ; preds = %polly.loop_exit416.us, %polly.loop_header399.us
  ...
  %smin870 = call i64 @llvm.smin.i64(i64 %indvars.iv868, i64 31)
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %163 = shl nsw i64 %polly.indvar547, 5
  br label %polly.loop_header550

polly.loop_exit552:                               ; preds = %polly.loop_exit558
  %164 = mul nsw i64 %polly.indvar547, -32
  %165 = shl nsw i64 %polly.indvar547, 3
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %indvars.iv.next881 = add nuw nsw i64 %indvars.iv880, 32
  %indvars.iv.next883 = add nuw nsw i64 %indvars.iv882, 8
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, -32
  %exitcond896.not = icmp eq i64 %polly.indvar_next548, 38
