; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6286.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6286.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -30
  %indvars.iv.next845 = add nuw nsw i64 %indvars.iv844, 3
  %indvars.iv.next849 = add nuw nsw i64 %indvars.iv848, 30
...
polly.loop_header221:                             ; preds = %polly.loop_exit207, %polly.loop_exit229
  ...
  %108 = mul nsw i64 %polly.indvar224, 80
  %109 = sub nsw i64 %101, %108
  %110 = icmp sgt i64 %109, 0
  %111 = select i1 %110, i64 %109, i64 0
  %polly.loop_guard237 = icmp slt i64 %111, 80
...
polly.loop_header234.us:                          ; preds = %polly.loop_exit244.us, %polly.loop_header227.us
  %indvars.iv852 = phi i64 [ %indvars.iv.next853, %polly.loop_exit244.us ], [ %107, %polly.loop_header227.us ]
  %polly.indvar238.us = phi i64 [ %polly.indvar_next239.us, %polly.loop_exit244.us ], [ %111, %polly.loop_header227.us ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 49)
  %113 = add i64 %polly.indvar238.us, %108
  %114 = add i64 %113, %102
  %polly.loop_guard245.us936 = icmp sgt i64 %114, -1
...
polly.loop_header242.us:                          ; preds = %polly.loop_header242.preheader.us, %polly.loop_header242.us
  ...
  %115 = add nuw nsw i64 %polly.indvar246.us, %101
  %116 = mul nuw nsw i64 %115, 8000
  %scevgep250.us = getelementptr i8, i8* %scevgep249.us, i64 %116
...
polly.loop_exit244.us:                            ; preds = %polly.loop_header242.us, %polly.loop_header234.us
  ...
  %polly.loop_cond240.us = icmp ult i64 %polly.indvar238.us, 79
...
polly.loop_header242.preheader.us:                ; preds = %polly.loop_header234.us
  %polly.access.add.Packed_MemRef_call2254.us = add nsw i64 %polly.access.mul.Packed_MemRef_call2253.us, %114
  ...
  %scevgep262.us = getelementptr i8, i8* %scevgep249.us, i64 %119
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236.loopexit.us, %polly.loop_header221
  ...
  %polly.loop_cond226 = icmp slt i64 %polly.indvar224, 14
  %indvars.iv.next847 = add i64 %indvars.iv846, -80
  %indvars.iv.next851 = add i64 %indvars.iv850, 80
...
vector.body1045:                                  ; preds = %vector.body1045, %vector.ph1049
  ...
  %123 = shl nuw nsw i64 %index1052, 3
  %124 = getelementptr i8, i8* %scevgep368, i64 %123
  %125 = bitcast i8* %124 to <4 x double>*
  %wide.load1056 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !79, !noalias !81
  %126 = fmul fast <4 x double> %wide.load1056, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %128 = icmp eq i64 %index.next1053, %n.vec1051
  br i1 %128, label %middle.block1043, label %vector.body1045, !llvm.loop !85

middle.block1043:                                 ; preds = %vector.body1045
  %cmp.n1055 = icmp eq i64 %121, %n.vec1051
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit398
  ...
  %130 = lshr i64 %indvars.iv865, 3
  %131 = mul nuw nsw i64 %130, 80
  %132 = add i64 %indvars.iv863, %131
  %133 = sub nsw i64 %indvars.iv870, %131
  %134 = mul nuw nsw i64 %polly.indvar375, 50
  br label %polly.loop_header378

polly.loop_exit380:                               ; preds = %polly.loop_exit386
  %135 = mul nsw i64 %polly.indvar375, -50
  %136 = mul nuw nsw i64 %polly.indvar375, 3
  %137 = add nuw nsw i64 %136, 7
  %pexp.p_div_q394 = lshr i64 %137, 3
  %138 = sub nsw i64 %polly.indvar375, %pexp.p_div_q394
  %polly.loop_guard399 = icmp slt i64 %138, 15
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405, %polly.loop_exit380
  ...
  %indvars.iv.next864 = add nsw i64 %indvars.iv863, -30
  %indvars.iv.next866 = add nuw nsw i64 %indvars.iv865, 3
  %indvars.iv.next871 = add nuw nsw i64 %indvars.iv870, 30
...
polly.loop_header384:                             ; preds = %polly.loop_header384, %polly.loop_header378
  ...
  %139 = add nuw nsw i64 %polly.indvar387, %134
  %polly.access.mul.call2391 = mul nuw nsw i64 %139, 1000
...
polly.loop_header396:                             ; preds = %polly.loop_exit380, %polly.loop_exit405
  %indvars.iv872 = phi i64 [ %indvars.iv.next873, %polly.loop_exit405 ], [ %133, %polly.loop_exit380 ]
  %indvars.iv867 = phi i64 [ %indvars.iv.next868, %polly.loop_exit405 ], [ %132, %polly.loop_exit380 ]
  %polly.indvar400 = phi i64 [ %polly.indvar_next401, %polly.loop_exit405 ], [ %138, %polly.loop_exit380 ]
  %smax869 = call i64 @llvm.smax.i64(i64 %indvars.iv867, i64 0)
  %140 = add i64 %smax869, %indvars.iv872
  %141 = mul nsw i64 %polly.indvar400, 80
  %142 = sub nsw i64 %134, %141
  %143 = icmp sgt i64 %142, 0
  %144 = select i1 %143, i64 %142, i64 0
  %polly.loop_guard413 = icmp slt i64 %144, 80
...
polly.loop_header403.us:                          ; preds = %polly.loop_header396, %polly.loop_exit412.loopexit.us
  ...
  %145 = shl nuw nsw i64 %polly.indvar406.us, 3
  %scevgep425.us = getelementptr i8, i8* %call1, i64 %145
...
polly.loop_header410.us:                          ; preds = %polly.loop_exit420.us, %polly.loop_header403.us
  %indvars.iv874 = phi i64 [ %indvars.iv.next875, %polly.loop_exit420.us ], [ %140, %polly.loop_header403.us ]
  %polly.indvar414.us = phi i64 [ %polly.indvar_next415.us, %polly.loop_exit420.us ], [ %144, %polly.loop_header403.us ]
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv874, i64 49)
  %146 = add i64 %polly.indvar414.us, %141
  %147 = add i64 %146, %135
  %polly.loop_guard421.us937 = icmp sgt i64 %147, -1
...
polly.loop_header418.us:                          ; preds = %polly.loop_header418.preheader.us, %polly.loop_header418.us
  ...
  %148 = add nuw nsw i64 %polly.indvar422.us, %134
...
polly.loop_exit420.us:                            ; preds = %polly.loop_header418.us, %polly.loop_header410.us
  ...
  %polly.loop_cond416.us = icmp ult i64 %polly.indvar414.us, 79
...
polly.loop_header418.preheader.us:                ; preds = %polly.loop_header410.us
  %polly.access.add.Packed_MemRef_call2273430.us = add nsw i64 %polly.access.mul.Packed_MemRef_call2273429.us, %147
  ...
  %scevgep438.us = getelementptr i8, i8* %scevgep425.us, i64 %152
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412.loopexit.us, %polly.loop_header396
  ...
  %polly.loop_cond402 = icmp slt i64 %polly.indvar400, 14
  %indvars.iv.next868 = add i64 %indvars.iv867, -80
  %indvars.iv.next873 = add i64 %indvars.iv872, 80
...
polly.loop_header532:                             ; preds = %polly.loop_exit540, %polly.start446
  ...
  %min.iters.check1022 = icmp ult i64 %154, 4
...
vector.body1021:                                  ; preds = %vector.body1021, %vector.ph1023
  ...
  %156 = shl nuw nsw i64 %index1026, 3
  %157 = getelementptr i8, i8* %scevgep544, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load1030 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !89, !noalias !91
  %159 = fmul fast <4 x double> %wide.load1030, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next1027, %n.vec1025
  br i1 %161, label %middle.block1019, label %vector.body1021, !llvm.loop !95

middle.block1019:                                 ; preds = %vector.body1021
  %cmp.n1029 = icmp eq i64 %154, %n.vec1025
...
polly.loop_header548:                             ; preds = %polly.loop_header548.preheader, %polly.loop_exit574
  ...
  %163 = lshr i64 %indvars.iv888, 3
  %164 = mul nuw nsw i64 %163, 80
  %165 = add i64 %indvars.iv886, %164
  %166 = sub nsw i64 %indvars.iv893, %164
  %167 = mul nuw nsw i64 %polly.indvar551, 50
  br label %polly.loop_header554

polly.loop_exit556:                               ; preds = %polly.loop_exit562
  %168 = mul nsw i64 %polly.indvar551, -50
  %169 = mul nuw nsw i64 %polly.indvar551, 3
  %170 = add nuw nsw i64 %169, 7
  %pexp.p_div_q570 = lshr i64 %170, 3
  %171 = sub nsw i64 %polly.indvar551, %pexp.p_div_q570
  %polly.loop_guard575 = icmp slt i64 %171, 15
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_exit556
  ...
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, -30
  %indvars.iv.next889 = add nuw nsw i64 %indvars.iv888, 3
  %indvars.iv.next894 = add nuw nsw i64 %indvars.iv893, 30
...
polly.loop_header560:                             ; preds = %polly.loop_header560, %polly.loop_header554
  ...
  %172 = add nuw nsw i64 %polly.indvar563, %167
  %polly.access.mul.call2567 = mul nuw nsw i64 %172, 1000
...
polly.loop_header572:                             ; preds = %polly.loop_exit556, %polly.loop_exit581
  %indvars.iv895 = phi i64 [ %indvars.iv.next896, %polly.loop_exit581 ], [ %166, %polly.loop_exit556 ]
  %indvars.iv890 = phi i64 [ %indvars.iv.next891, %polly.loop_exit581 ], [ %165, %polly.loop_exit556 ]
  %polly.indvar576 = phi i64 [ %polly.indvar_next577, %polly.loop_exit581 ], [ %171, %polly.loop_exit556 ]
  %smax892 = call i64 @llvm.smax.i64(i64 %indvars.iv890, i64 0)
  %173 = add i64 %smax892, %indvars.iv895
  %174 = mul nsw i64 %polly.indvar576, 80
  %175 = sub nsw i64 %167, %174
  %176 = icmp sgt i64 %175, 0
  %177 = select i1 %176, i64 %175, i64 0
  %polly.loop_guard589 = icmp slt i64 %177, 80
...
polly.loop_header579.us:                          ; preds = %polly.loop_header572, %polly.loop_exit588.loopexit.us
  ...
  %178 = shl nuw nsw i64 %polly.indvar582.us, 3
...
polly.loop_header586.us:                          ; preds = %polly.loop_exit596.us, %polly.loop_header579.us
  %indvars.iv897 = phi i64 [ %indvars.iv.next898, %polly.loop_exit596.us ], [ %173, %polly.loop_header579.us ]
  %polly.indvar590.us = phi i64 [ %polly.indvar_next591.us, %polly.loop_exit596.us ], [ %177, %polly.loop_header579.us ]
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 49)
  %179 = add i64 %polly.indvar590.us, %174
  %180 = add i64 %179, %168
  %polly.loop_guard597.us938 = icmp sgt i64 %180, -1
...
polly.loop_header594.us:                          ; preds = %polly.loop_header594.preheader.us, %polly.loop_header594.us
  ...
  %181 = add nuw nsw i64 %polly.indvar598.us, %167
  %182 = mul nuw nsw i64 %181, 8000
  %scevgep602.us = getelementptr i8, i8* %scevgep601.us, i64 %182
  ...
  %183 = shl i64 %181, 3
  %184 = add i64 %183, %186
  %scevgep617.us = getelementptr i8, i8* %call, i64 %184
...
polly.loop_exit596.us:                            ; preds = %polly.loop_header594.us, %polly.loop_header586.us
  ...
  %polly.loop_cond592.us = icmp ult i64 %polly.indvar590.us, 79
...
polly.loop_header594.preheader.us:                ; preds = %polly.loop_header586.us
  %polly.access.add.Packed_MemRef_call2449606.us = add nsw i64 %polly.access.mul.Packed_MemRef_call2449605.us, %180
  ...
  %scevgep614.us = getelementptr i8, i8* %scevgep601.us, i64 %185
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588.loopexit.us, %polly.loop_header572
  ...
  %polly.loop_cond578 = icmp slt i64 %polly.indvar576, 14
...
polly.loop_header752:                             ; preds = %polly.loop_exit760, %polly.loop_header746
  ...
  %smin960 = call i64 @llvm.smin.i64(i64 %189, i64 -1168)
  %190 = add nsw i64 %smin960, 1200
  %smin927 = call i64 @llvm.smin.i64(i64 %indvars.iv925, i64 -1168)
  %191 = shl nsw i64 %polly.indvar755, 5
  %192 = add nsw i64 %smin927, 1199
...
vector.ph961:                                     ; preds = %polly.loop_header758
  %broadcast.splatinsert968 = insertelement <4 x i64> poison, i64 %191, i32 0
  %broadcast.splat969 = shufflevector <4 x i64> %broadcast.splatinsert968, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert970 = insertelement <4 x i32> poison, i32 %194, i32 0
...
vector.body959:                                   ; preds = %vector.body959, %vector.ph961
  ...
  %196 = add nuw nsw <4 x i64> %vec.ind966, %broadcast.splat969
  %197 = trunc <4 x i64> %196 to <4 x i32>
  %198 = mul <4 x i32> %broadcast.splat971, %197
  ...
  %208 = icmp eq i64 %index.next963, %190
  br i1 %208, label %polly.loop_exit766, label %vector.body959, !llvm.loop !104

polly.loop_exit766:                               ; preds = %vector.body959, %polly.loop_header764
  %polly.indvar_next762 = add nuw nsw i64 %polly.indvar761, 1
  %exitcond932.not = icmp eq i64 %polly.indvar761, %188
...
polly.loop_header764:                             ; preds = %polly.loop_header758, %polly.loop_header764
  ...
  %exitcond928.not = icmp eq i64 %polly.indvar767, %192
...
polly.loop_header779:                             ; preds = %polly.loop_exit787, %polly.loop_header773
  ...
  %smin975 = call i64 @llvm.smin.i64(i64 %218, i64 -968)
  %219 = add nsw i64 %smin975, 1000
  %smin917 = call i64 @llvm.smin.i64(i64 %indvars.iv915, i64 -968)
  %220 = shl nsw i64 %polly.indvar782, 5
  %221 = add nsw i64 %smin917, 999
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph977
  ...
  %225 = add nuw nsw <4 x i64> %vec.ind984, %broadcast.splat987
  %226 = trunc <4 x i64> %225 to <4 x i32>
  %227 = mul <4 x i32> %broadcast.splat989, %226
  ...
  %237 = icmp eq i64 %index.next981, %219
  br i1 %237, label %polly.loop_exit793, label %vector.body974, !llvm.loop !107

polly.loop_exit793:                               ; preds = %vector.body974, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond922.not = icmp eq i64 %polly.indvar788, %217
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar794, %221
...
polly.loop_header805:                             ; preds = %polly.loop_exit813, %polly.loop_header799
  ...
  %smin993 = call i64 @llvm.smin.i64(i64 %247, i64 -968)
  %248 = add nsw i64 %smin993, 1000
  %smin907 = call i64 @llvm.smin.i64(i64 %indvars.iv905, i64 -968)
  %249 = shl nsw i64 %polly.indvar808, 5
  %250 = add nsw i64 %smin907, 999
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph995
  ...
  %254 = add nuw nsw <4 x i64> %vec.ind1002, %broadcast.splat1005
  %255 = trunc <4 x i64> %254 to <4 x i32>
  %256 = mul <4 x i32> %broadcast.splat1007, %255
  ...
  %266 = icmp eq i64 %index.next999, %248
  br i1 %266, label %polly.loop_exit819, label %vector.body992, !llvm.loop !110

polly.loop_exit819:                               ; preds = %vector.body992, %polly.loop_header817
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %exitcond912.not = icmp eq i64 %polly.indvar814, %246
...
polly.loop_header817:                             ; preds = %polly.loop_header811, %polly.loop_header817
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar820, %250
