; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7828.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7828.c"
...
vector.body1050:                                  ; preds = %vector.body1050, %vector.ph1054
  ...
  %wide.load1061 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %128, label %middle.block1048, label %vector.body1050, !llvm.loop !79
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1028
  ...
  %wide.load1035 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %161, label %middle.block1024, label %vector.body1026, !llvm.loop !89
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph966
  ...
  br i1 %208, label %polly.loop_exit772, label %vector.body964, !llvm.loop !98
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph982
  ...
  br i1 %237, label %polly.loop_exit799, label %vector.body979, !llvm.loop !101
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph1000
  ...
  br i1 %266, label %polly.loop_exit825, label %vector.body997, !llvm.loop !104
