; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2924.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2924.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %.inv = icmp ugt i64 %116, 127
  %118 = select i1 %.inv, i64 127, i64 %117
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %206 = shl nuw nsw i64 %polly.indvar586, 3
  %207 = mul nsw i64 %polly.indvar586, -128
  %208 = shl nsw i64 %polly.indvar586, 7
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %210, 127
  %212 = select i1 %.inv870, i64 127, i64 %211
