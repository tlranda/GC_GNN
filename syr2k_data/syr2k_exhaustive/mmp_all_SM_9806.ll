; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9806.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9806.c"
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %114 = mul nsw i64 %polly.indvar214.us, 50
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %140 = mul nuw nsw i64 %polly.indvar359, 9
  %141 = add nuw nsw i64 %140, 34
  %pexp.p_div_q368 = udiv i64 %141, 25
  %142 = sub nsw i64 %polly.indvar359, %pexp.p_div_q368
  %143 = add nsw i64 %142, 1
  %.inv780 = icmp slt i64 %142, 23
  %144 = select i1 %.inv780, i64 %143, i64 23
  %polly.loop_guard373 = icmp sgt i64 %144, -1
  %145 = mul nsw i64 %polly.indvar359, -32
  %146 = icmp slt i64 %145, -1168
  %147 = select i1 %146, i64 %145, i64 -1168
  %148 = add nsw i64 %147, 1199
  %149 = shl nsw i64 %polly.indvar359, 5
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %157 = mul nsw i64 %polly.indvar374.us, 50
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %183 = mul nuw nsw i64 %polly.indvar519, 9
  %184 = add nuw nsw i64 %183, 34
  %pexp.p_div_q528 = udiv i64 %184, 25
  %185 = sub nsw i64 %polly.indvar519, %pexp.p_div_q528
  %186 = add nsw i64 %185, 1
  %.inv781 = icmp slt i64 %185, 23
  %187 = select i1 %.inv781, i64 %186, i64 23
  %polly.loop_guard533 = icmp sgt i64 %187, -1
  %188 = mul nsw i64 %polly.indvar519, -32
  %189 = icmp slt i64 %188, -1168
  %190 = select i1 %189, i64 %188, i64 -1168
  %191 = add nsw i64 %190, 1199
  %192 = shl nsw i64 %polly.indvar519, 5
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %200 = mul nsw i64 %polly.indvar534.us, 50
