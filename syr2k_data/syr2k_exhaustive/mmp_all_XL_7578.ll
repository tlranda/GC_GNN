; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7578.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7578.c"
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %129 = lshr i64 %indvars.iv875, 4
  %130 = mul nsw i64 %polly.indvar393, -80
  %131 = mul nuw nsw i64 %polly.indvar393, 80
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %indvars.iv.next876 = add nuw nsw i64 %indvars.iv875, 5
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  ...
  %132 = shl nsw i64 %polly.indvar399, 6
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %polly.loop_guard413 = icmp slt i64 %137, 80
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %161 = lshr i64 %indvars.iv901, 4
  %162 = mul nsw i64 %polly.indvar571, -80
  %163 = mul nuw nsw i64 %polly.indvar571, 80
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next902 = add nuw nsw i64 %indvars.iv901, 5
...
polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  ...
  %164 = shl nsw i64 %polly.indvar577, 6
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %polly.loop_guard591 = icmp slt i64 %169, 80
