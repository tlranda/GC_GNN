; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7010.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7010.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit230, %polly.loop_header215
  ...
  %exitcond843.not = icmp eq i64 %polly.indvar_next219, 75
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit230
  ...
  %101 = mul nuw nsw i64 %polly.indvar224, 20
  %102 = add nsw i64 %101, %99
  %103 = icmp sgt i64 %102, 0
  %104 = select i1 %103, i64 %102, i64 0
  %polly.loop_guard231 = icmp slt i64 %104, 16
...
polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header221
  ...
  %indvars.iv.next839 = add nsw i64 %indvars.iv838, -20
...
polly.loop_exit237:                               ; preds = %polly.loop_exit244.loopexit.us, %polly.loop_header228
  ...
  %polly.loop_cond234 = icmp ult i64 %polly.indvar232, 15
...
polly.loop_header396.preheader:                   ; preds = %polly.loop_header388
  %127 = mul nsw i64 %polly.indvar391, -16
...
polly.loop_exit398:                               ; preds = %polly.loop_exit406, %polly.loop_header388
  ...
  %indvars.iv.next854 = add nuw nsw i64 %indvars.iv853, 16
  %exitcond862.not = icmp eq i64 %polly.indvar_next392, 75
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_exit406
  ...
  %129 = mul nuw nsw i64 %polly.indvar400, 20
  %130 = add nsw i64 %129, %127
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %polly.loop_guard407 = icmp slt i64 %132, 16
...
polly.loop_exit413:                               ; preds = %polly.loop_exit420.loopexit.us, %polly.loop_header404
  ...
  %polly.loop_cond410 = icmp ult i64 %polly.indvar408, 15
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header564
  %155 = mul nsw i64 %polly.indvar567, -16
  %156 = shl nsw i64 %polly.indvar567, 4
...
polly.loop_exit574:                               ; preds = %polly.loop_exit582, %polly.loop_header564
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next568, 75
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit582
  ...
  %157 = mul nuw nsw i64 %polly.indvar576, 20
  %158 = add nsw i64 %157, %155
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard583 = icmp slt i64 %160, 16
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit589
  ...
  %smin878 = call i64 @llvm.smin.i64(i64 %indvars.iv876, i64 19)
