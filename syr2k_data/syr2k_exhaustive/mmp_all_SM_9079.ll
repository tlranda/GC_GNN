; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9079.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9079.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next209, 38
...
polly.loop_header223.us:                          ; preds = %polly.loop_header211, %polly.loop_exit232.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv796, i64 31)
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %145 = shl nsw i64 %polly.indvar363, 5
  %146 = mul nsw i64 %polly.indvar363, -32
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %exitcond819.not = icmp eq i64 %polly.indvar_next364, 38
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %183 = mul nsw i64 %polly.indvar521, -32
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next824 = add nuw nsw i64 %indvars.iv823, 32
  %indvars.iv.next826 = add nuw nsw i64 %indvars.iv825, 8
  %indvars.iv.next831 = add nsw i64 %indvars.iv830, -32
  %exitcond839.not = icmp eq i64 %polly.indvar_next522, 38
...
polly.loop_header538.us:                          ; preds = %polly.loop_header525, %polly.loop_exit548.us
  ...
  %smin836 = call i64 @llvm.smin.i64(i64 %indvars.iv834, i64 31)
...
polly.loop_header223.us.1:                        ; preds = %polly.loop_exit232.us, %polly.loop_exit232.us.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv796.1, i64 31)
...
polly.loop_header223.us.2:                        ; preds = %polly.loop_exit232.us.1, %polly.loop_exit232.us.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv796.2, i64 31)
...
polly.loop_header223.us.3:                        ; preds = %polly.loop_exit232.us.2, %polly.loop_exit232.us.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv796.3, i64 31)
...
polly.loop_header380.us.1:                        ; preds = %polly.loop_exit390.us, %polly.loop_exit390.us.1
  ...
  %smin816.1 = call i64 @llvm.smin.i64(i64 %indvars.iv814.1, i64 31)
...
polly.loop_header380.us.2:                        ; preds = %polly.loop_exit390.us.1, %polly.loop_exit390.us.2
  ...
  %smin816.2 = call i64 @llvm.smin.i64(i64 %indvars.iv814.2, i64 31)
...
polly.loop_header380.us.3:                        ; preds = %polly.loop_exit390.us.2, %polly.loop_exit390.us.3
  ...
  %smin816.3 = call i64 @llvm.smin.i64(i64 %indvars.iv814.3, i64 31)
...
polly.loop_header538.us.1:                        ; preds = %polly.loop_exit548.us, %polly.loop_exit548.us.1
  ...
  %smin836.1 = call i64 @llvm.smin.i64(i64 %indvars.iv834.1, i64 31)
...
polly.loop_header538.us.2:                        ; preds = %polly.loop_exit548.us.1, %polly.loop_exit548.us.2
  ...
  %smin836.2 = call i64 @llvm.smin.i64(i64 %indvars.iv834.2, i64 31)
...
polly.loop_header538.us.3:                        ; preds = %polly.loop_exit548.us.2, %polly.loop_exit548.us.3
  ...
  %smin836.3 = call i64 @llvm.smin.i64(i64 %indvars.iv834.3, i64 31)
