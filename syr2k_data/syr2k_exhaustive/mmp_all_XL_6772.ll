; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6772.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6772.c"
...
vector.body917:                                   ; preds = %vector.body917, %vector.ph918
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call760, i64 %indvars.iv7.i, i64 %index919
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next920 = add i64 %index919, 4
  %vec.ind.next924 = add <4 x i64> %vec.ind923, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next920, 1200
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check981 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check981, label %for.body3.i46.preheader1055, label %vector.ph982

vector.ph982:                                     ; preds = %for.body3.i46.preheader
  %n.vec984 = and i64 %indvars.iv21.i, 9223372036854775804
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call760, i64 %indvars.iv21.i, i64 %index985
  ...
  %46 = icmp eq i64 %index.next986, %n.vec984
  br i1 %46, label %middle.block978, label %vector.body980, !llvm.loop !18

middle.block978:                                  ; preds = %vector.body980
  %cmp.n988 = icmp eq i64 %indvars.iv21.i, %n.vec984
  br i1 %cmp.n988, label %for.inc6.i, label %for.body3.i46.preheader1055

for.body3.i46.preheader1055:                      ; preds = %for.body3.i46.preheader, %middle.block978
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec984, %middle.block978 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1055, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1055 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block978, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1004 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1004, label %for.body3.i60.preheader1054, label %vector.ph1005

vector.ph1005:                                    ; preds = %for.body3.i60.preheader
  %n.vec1007 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1003:                                  ; preds = %vector.body1003, %vector.ph1005
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call760, i64 %indvars.iv21.i52, i64 %index1008
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1012 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1012, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1009 = add i64 %index1008, 4
  %57 = icmp eq i64 %index.next1009, %n.vec1007
  br i1 %57, label %middle.block1001, label %vector.body1003, !llvm.loop !55

middle.block1001:                                 ; preds = %vector.body1003
  %cmp.n1011 = icmp eq i64 %indvars.iv21.i52, %n.vec1007
  br i1 %cmp.n1011, label %for.inc6.i63, label %for.body3.i60.preheader1054

for.body3.i60.preheader1054:                      ; preds = %for.body3.i60.preheader, %middle.block1001
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1007, %middle.block1001 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1001, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1030 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1030, label %for.body3.i99.preheader1053, label %vector.ph1031

vector.ph1031:                                    ; preds = %for.body3.i99.preheader
  %n.vec1033 = and i64 %indvars.iv21.i91, 9223372036854775804
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1031
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call760, i64 %indvars.iv21.i91, i64 %index1034
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1038 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1038, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1035 = add i64 %index1034, 4
  %68 = icmp eq i64 %index.next1035, %n.vec1033
  br i1 %68, label %middle.block1027, label %vector.body1029, !llvm.loop !57

middle.block1027:                                 ; preds = %vector.body1029
  %cmp.n1037 = icmp eq i64 %indvars.iv21.i91, %n.vec1033
  br i1 %cmp.n1037, label %for.inc6.i102, label %for.body3.i99.preheader1053

for.body3.i99.preheader1053:                      ; preds = %for.body3.i99.preheader, %middle.block1027
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1033, %middle.block1027 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1053, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1053 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1027, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit193, %polly.start
  %indvar1042 = phi i64 [ %indvar.next1043, %polly.loop_exit193 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1042, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1044 = icmp ult i64 %88, 4
  br i1 %min.iters.check1044, label %polly.loop_header191.preheader, label %vector.ph1045

vector.ph1045:                                    ; preds = %polly.loop_header
  %n.vec1047 = and i64 %88, -4
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1045
  ...
  %90 = shl nuw nsw i64 %index1048, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1052 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  %93 = fmul fast <4 x double> %wide.load1052, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !63, !noalias !65
  %index.next1049 = add i64 %index1048, 4
  %95 = icmp eq i64 %index.next1049, %n.vec1047
  br i1 %95, label %middle.block1039, label %vector.body1041, !llvm.loop !69

middle.block1039:                                 ; preds = %vector.body1041
  %cmp.n1051 = icmp eq i64 %88, %n.vec1047
  br i1 %cmp.n1051, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block1039
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1047, %middle.block1039 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1039
...
polly.loop_exit223:                               ; preds = %polly.loop_exit235.3
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next219, 300
...
polly.loop_header221:                             ; preds = %polly.loop_exit235.3, %polly.loop_header215
  ...
  %110 = mul nuw nsw i64 %polly.indvar224, 80
  %111 = sub nsw i64 %98, %110
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv822, i64 79)
  %polly.loop_guard897 = icmp sgt i64 %111, -1
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header221
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next825, i64 79)
  %polly.loop_guard.1898 = icmp sgt i64 %111, -1
  br i1 %polly.loop_guard.1898, label %polly.loop_header233.us.1, label %polly.loop_exit235.1
...
polly.loop_header352:                             ; preds = %polly.loop_exit360, %polly.start266
  %indvar1016 = phi i64 [ %indvar.next1017, %polly.loop_exit360 ], [ 0, %polly.start266 ]
  %polly.indvar355 = phi i64 [ %polly.indvar_next356, %polly.loop_exit360 ], [ 1, %polly.start266 ]
  %117 = add i64 %indvar1016, 1
  %118 = mul nuw nsw i64 %polly.indvar355, 9600
  %scevgep364 = getelementptr i8, i8* %call, i64 %118
  %min.iters.check1018 = icmp ult i64 %117, 4
  br i1 %min.iters.check1018, label %polly.loop_header358.preheader, label %vector.ph1019

vector.ph1019:                                    ; preds = %polly.loop_header352
  %n.vec1021 = and i64 %117, -4
...
vector.body1015:                                  ; preds = %vector.body1015, %vector.ph1019
  ...
  %119 = shl nuw nsw i64 %index1022, 3
  %120 = getelementptr i8, i8* %scevgep364, i64 %119
  %121 = bitcast i8* %120 to <4 x double>*
  %wide.load1026 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !74, !noalias !76
  %122 = fmul fast <4 x double> %wide.load1026, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %124 = icmp eq i64 %index.next1023, %n.vec1021
  br i1 %124, label %middle.block1013, label %vector.body1015, !llvm.loop !80

middle.block1013:                                 ; preds = %vector.body1015
  %cmp.n1025 = icmp eq i64 %117, %n.vec1021
  br i1 %cmp.n1025, label %polly.loop_exit360, label %polly.loop_header358.preheader

polly.loop_header358.preheader:                   ; preds = %polly.loop_header352, %middle.block1013
  %polly.indvar361.ph = phi i64 [ 0, %polly.loop_header352 ], [ %n.vec1021, %middle.block1013 ]
  br label %polly.loop_header358

polly.loop_exit360:                               ; preds = %polly.loop_header358, %middle.block1013
...
polly.loop_header384:                             ; preds = %polly.loop_exit376, %polly.loop_exit393
  ...
  %126 = udiv i64 %polly.indvar387, 20
...
polly.loop_exit393:                               ; preds = %polly.loop_exit405.3
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar_next388, 300
...
polly.loop_header391:                             ; preds = %polly.loop_exit405.3, %polly.loop_header384
  ...
  %139 = mul nuw nsw i64 %polly.indvar394, 80
  %140 = sub nsw i64 %127, %139
  %smin840 = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 79)
  %polly.loop_guard413901 = icmp sgt i64 %140, -1
  br i1 %polly.loop_guard413901, label %polly.loop_header403.us, label %polly.loop_exit405
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412.loopexit.us, %polly.loop_header391
  ...
  %smin840.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839, i64 79)
  %polly.loop_guard413.1902 = icmp sgt i64 %140, -1
  br i1 %polly.loop_guard413.1902, label %polly.loop_header403.us.1, label %polly.loop_exit405.1
...
polly.loop_header524:                             ; preds = %polly.loop_exit532, %polly.start438
  ...
  %min.iters.check992 = icmp ult i64 %146, 4
  br i1 %min.iters.check992, label %polly.loop_header530.preheader, label %vector.ph993

vector.ph993:                                     ; preds = %polly.loop_header524
  %n.vec995 = and i64 %146, -4
...
vector.body991:                                   ; preds = %vector.body991, %vector.ph993
  ...
  %148 = shl nuw nsw i64 %index996, 3
  %149 = getelementptr i8, i8* %scevgep536, i64 %148
  %150 = bitcast i8* %149 to <4 x double>*
  %wide.load1000 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !84, !noalias !86
  %151 = fmul fast <4 x double> %wide.load1000, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %153 = icmp eq i64 %index.next997, %n.vec995
  br i1 %153, label %middle.block989, label %vector.body991, !llvm.loop !90

middle.block989:                                  ; preds = %vector.body991
  %cmp.n999 = icmp eq i64 %146, %n.vec995
  br i1 %cmp.n999, label %polly.loop_exit532, label %polly.loop_header530.preheader

polly.loop_header530.preheader:                   ; preds = %polly.loop_header524, %middle.block989
  %polly.indvar533.ph = phi i64 [ 0, %polly.loop_header524 ], [ %n.vec995, %middle.block989 ]
  br label %polly.loop_header530

polly.loop_exit532:                               ; preds = %polly.loop_header530, %middle.block989
...
polly.loop_header556:                             ; preds = %polly.loop_exit548, %polly.loop_exit565
  ...
  %155 = udiv i64 %polly.indvar559, 20
...
polly.loop_exit565:                               ; preds = %polly.loop_exit577.3
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar_next560, 300
...
polly.loop_header563:                             ; preds = %polly.loop_exit577.3, %polly.loop_header556
  ...
  %168 = mul nuw nsw i64 %polly.indvar566, 80
  %169 = sub nsw i64 %156, %168
  %smin856 = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 79)
  %polly.loop_guard585905 = icmp sgt i64 %169, -1
...
polly.loop_exit577:                               ; preds = %polly.loop_exit584.loopexit.us, %polly.loop_header563
  ...
  %smin856.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855, i64 79)
  %polly.loop_guard585.1906 = icmp sgt i64 %169, -1
  br i1 %polly.loop_guard585.1906, label %polly.loop_header575.us.1, label %polly.loop_exit577.1
...
polly.loop_header740:                             ; preds = %polly.loop_exit748, %polly.loop_header734
  ...
  %smin930 = call i64 @llvm.smin.i64(i64 %177, i64 -1168)
  %178 = add nsw i64 %smin930, 1200
  %smin888 = call i64 @llvm.smin.i64(i64 %indvars.iv886, i64 -1168)
  %179 = shl nsw i64 %polly.indvar743, 5
  %180 = add nsw i64 %smin888, 1199
...
polly.loop_header746:                             ; preds = %polly.loop_exit754, %polly.loop_header740
  ...
  br i1 %min.iters.check, label %polly.loop_header752, label %vector.ph931

vector.ph931:                                     ; preds = %polly.loop_header746
  %broadcast.splatinsert938 = insertelement <4 x i64> poison, i64 %179, i32 0
  %broadcast.splat939 = shufflevector <4 x i64> %broadcast.splatinsert938, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert940 = insertelement <4 x i32> poison, i32 %182, i32 0
...
vector.body929:                                   ; preds = %vector.body929, %vector.ph931
  %index932 = phi i64 [ 0, %vector.ph931 ], [ %index.next933, %vector.body929 ]
  %vec.ind936 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph931 ], [ %vec.ind.next937, %vector.body929 ]
  %184 = add nuw nsw <4 x i64> %vec.ind936, %broadcast.splat939
  %185 = trunc <4 x i64> %184 to <4 x i32>
  %186 = mul <4 x i32> %broadcast.splat941, %185
  ...
  %196 = icmp eq i64 %index.next933, %178
  br i1 %196, label %polly.loop_exit754, label %vector.body929, !llvm.loop !99

polly.loop_exit754:                               ; preds = %vector.body929, %polly.loop_header752
  %polly.indvar_next750 = add nuw nsw i64 %polly.indvar749, 1
  %exitcond893.not = icmp eq i64 %polly.indvar749, %176
...
polly.loop_header752:                             ; preds = %polly.loop_header746, %polly.loop_header752
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar755, %180
...
polly.loop_header767:                             ; preds = %polly.loop_exit775, %polly.loop_header761
  ...
  %smin945 = call i64 @llvm.smin.i64(i64 %206, i64 -968)
  %207 = add nsw i64 %smin945, 1000
  %smin878 = call i64 @llvm.smin.i64(i64 %indvars.iv876, i64 -968)
  %208 = shl nsw i64 %polly.indvar770, 5
  %209 = add nsw i64 %smin878, 999
...
polly.loop_header773:                             ; preds = %polly.loop_exit781, %polly.loop_header767
  ...
  %min.iters.check946 = icmp eq i64 %207, 0
  br i1 %min.iters.check946, label %polly.loop_header779, label %vector.ph947

vector.ph947:                                     ; preds = %polly.loop_header773
  %broadcast.splatinsert956 = insertelement <4 x i64> poison, i64 %208, i32 0
  %broadcast.splat957 = shufflevector <4 x i64> %broadcast.splatinsert956, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert958 = insertelement <4 x i32> poison, i32 %211, i32 0
...
vector.body944:                                   ; preds = %vector.body944, %vector.ph947
  %index950 = phi i64 [ 0, %vector.ph947 ], [ %index.next951, %vector.body944 ]
  %vec.ind954 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph947 ], [ %vec.ind.next955, %vector.body944 ]
  %213 = add nuw nsw <4 x i64> %vec.ind954, %broadcast.splat957
  %214 = trunc <4 x i64> %213 to <4 x i32>
  %215 = mul <4 x i32> %broadcast.splat959, %214
  ...
  %225 = icmp eq i64 %index.next951, %207
  br i1 %225, label %polly.loop_exit781, label %vector.body944, !llvm.loop !102

polly.loop_exit781:                               ; preds = %vector.body944, %polly.loop_header779
  %polly.indvar_next777 = add nuw nsw i64 %polly.indvar776, 1
  %exitcond883.not = icmp eq i64 %polly.indvar776, %205
...
polly.loop_header779:                             ; preds = %polly.loop_header773, %polly.loop_header779
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar782, %209
...
polly.loop_header793:                             ; preds = %polly.loop_exit801, %polly.loop_header787
  ...
  %smin963 = call i64 @llvm.smin.i64(i64 %235, i64 -968)
  %236 = add nsw i64 %smin963, 1000
  %smin868 = call i64 @llvm.smin.i64(i64 %indvars.iv866, i64 -968)
  %237 = shl nsw i64 %polly.indvar796, 5
  %238 = add nsw i64 %smin868, 999
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  %min.iters.check964 = icmp eq i64 %236, 0
  br i1 %min.iters.check964, label %polly.loop_header805, label %vector.ph965

vector.ph965:                                     ; preds = %polly.loop_header799
  %broadcast.splatinsert974 = insertelement <4 x i64> poison, i64 %237, i32 0
  %broadcast.splat975 = shufflevector <4 x i64> %broadcast.splatinsert974, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert976 = insertelement <4 x i32> poison, i32 %240, i32 0
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph965
  ...
  %242 = add nuw nsw <4 x i64> %vec.ind972, %broadcast.splat975
  %243 = trunc <4 x i64> %242 to <4 x i32>
  %244 = mul <4 x i32> %broadcast.splat977, %243
  ...
  %254 = icmp eq i64 %index.next969, %236
  br i1 %254, label %polly.loop_exit807, label %vector.body962, !llvm.loop !105

polly.loop_exit807:                               ; preds = %vector.body962, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond873.not = icmp eq i64 %polly.indvar802, %234
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar808, %238
...
polly.loop_exit241.loopexit.us.1:                 ; preds = %polly.loop_header239.us.1
  ...
  %exitcond826.1.not = icmp eq i64 %polly.indvar_next237.us.1, 1000
...
polly.loop_exit235.1:                             ; preds = %polly.loop_exit241.loopexit.us.1, %polly.loop_exit235
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next825.1, i64 79)
  %polly.loop_guard.2899 = icmp sgt i64 %111, -1
  br i1 %polly.loop_guard.2899, label %polly.loop_header233.us.2, label %polly.loop_exit235.2
...
polly.loop_exit241.loopexit.us.2:                 ; preds = %polly.loop_header239.us.2
  ...
  %exitcond826.2.not = icmp eq i64 %polly.indvar_next237.us.2, 1000
...
polly.loop_exit235.2:                             ; preds = %polly.loop_exit241.loopexit.us.2, %polly.loop_exit235.1
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next825.2, i64 79)
  %polly.loop_guard.3900 = icmp sgt i64 %111, -1
  br i1 %polly.loop_guard.3900, label %polly.loop_header233.us.3, label %polly.loop_exit235.3
...
polly.loop_exit241.loopexit.us.3:                 ; preds = %polly.loop_header239.us.3
  ...
  %exitcond826.3.not = icmp eq i64 %polly.indvar_next237.us.3, 1000
...
polly.loop_exit412.loopexit.us.1:                 ; preds = %polly.loop_header410.us.1
  ...
  %exitcond842.1.not = icmp eq i64 %polly.indvar_next407.us.1, 1000
...
polly.loop_exit405.1:                             ; preds = %polly.loop_exit412.loopexit.us.1, %polly.loop_exit405
  ...
  %smin840.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839.1, i64 79)
  %polly.loop_guard413.2903 = icmp sgt i64 %140, -1
  br i1 %polly.loop_guard413.2903, label %polly.loop_header403.us.2, label %polly.loop_exit405.2
...
polly.loop_exit412.loopexit.us.2:                 ; preds = %polly.loop_header410.us.2
  ...
  %exitcond842.2.not = icmp eq i64 %polly.indvar_next407.us.2, 1000
...
polly.loop_exit405.2:                             ; preds = %polly.loop_exit412.loopexit.us.2, %polly.loop_exit405.1
  ...
  %smin840.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839.2, i64 79)
  %polly.loop_guard413.3904 = icmp sgt i64 %140, -1
  br i1 %polly.loop_guard413.3904, label %polly.loop_header403.us.3, label %polly.loop_exit405.3
...
polly.loop_exit412.loopexit.us.3:                 ; preds = %polly.loop_header410.us.3
  ...
  %exitcond842.3.not = icmp eq i64 %polly.indvar_next407.us.3, 1000
...
polly.loop_exit584.loopexit.us.1:                 ; preds = %polly.loop_header582.us.1
  ...
  %exitcond858.1.not = icmp eq i64 %polly.indvar_next579.us.1, 1000
...
polly.loop_exit577.1:                             ; preds = %polly.loop_exit584.loopexit.us.1, %polly.loop_exit577
  ...
  %smin856.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855.1, i64 79)
  %polly.loop_guard585.2907 = icmp sgt i64 %169, -1
  br i1 %polly.loop_guard585.2907, label %polly.loop_header575.us.2, label %polly.loop_exit577.2
...
polly.loop_exit584.loopexit.us.2:                 ; preds = %polly.loop_header582.us.2
  ...
  %exitcond858.2.not = icmp eq i64 %polly.indvar_next579.us.2, 1000
...
polly.loop_exit577.2:                             ; preds = %polly.loop_exit584.loopexit.us.2, %polly.loop_exit577.1
  ...
  %smin856.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855.2, i64 79)
  %polly.loop_guard585.3908 = icmp sgt i64 %169, -1
  br i1 %polly.loop_guard585.3908, label %polly.loop_header575.us.3, label %polly.loop_exit577.3
...
polly.loop_exit584.loopexit.us.3:                 ; preds = %polly.loop_header582.us.3
  ...
  %exitcond858.3.not = icmp eq i64 %polly.indvar_next579.us.3, 1000
