; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2171.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2171.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %104 = shl nuw nsw i64 %polly.indvar225, 5
  %105 = add i64 %97, %104
  %smax1322 = call i64 @llvm.smax.i64(i64 %105, i64 0)
  %106 = mul nsw i64 %polly.indvar225, -32
  %107 = add i64 %98, %106
  %108 = add i64 %smax1322, %107
  %109 = shl nsw i64 %polly.indvar225, 5
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %116 = add i64 %108, %indvar1323
  %smin1325 = call i64 @llvm.smin.i64(i64 %116, i64 31)
  %117 = add nsw i64 %smin1325, 1
  %smin1026 = call i64 @llvm.smin.i64(i64 %indvars.iv1022, i64 31)
  %118 = add nsw i64 %polly.indvar231, %114
  %polly.loop_guard2441123 = icmp sgt i64 %118, -1
...
polly.loop_header259.us:                          ; preds = %polly.loop_header259.preheader, %polly.loop_exit268.loopexit.us
  ...
  %min.iters.check1326 = icmp ult i64 %117, 4
...
vector.body1321:                                  ; preds = %vector.body1321, %vector.ph1327
  ...
  %122 = add nuw nsw i64 %index1330, %109
  %123 = add nuw nsw i64 %index1330, %polly.access.mul.Packed_MemRef_call1273.us
  %124 = getelementptr double, double* %Packed_MemRef_call1, i64 %123
  %125 = bitcast double* %124 to <4 x double>*
  %wide.load1334 = load <4 x double>, <4 x double>* %125, align 8
  %126 = fmul fast <4 x double> %broadcast.splat1336, %wide.load1334
  ...
  %wide.load1340 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !65, !noalias !67
  ...
  %137 = fadd fast <4 x double> %136, %wide.load1340
  ...
  %139 = icmp eq i64 %index.next1331, %n.vec1329
  br i1 %139, label %middle.block1319, label %vector.body1321, !llvm.loop !77

middle.block1319:                                 ; preds = %vector.body1321
  %cmp.n1333 = icmp eq i64 %117, %n.vec1329
...
vector.body1259:                                  ; preds = %vector.body1259, %vector.ph1263
  ...
  %145 = shl nuw nsw i64 %index1266, 3
  %146 = getelementptr i8, i8* %scevgep394, i64 %145
  %147 = bitcast i8* %146 to <4 x double>*
  %wide.load1270 = load <4 x double>, <4 x double>* %147, align 8, !alias.scope !79, !noalias !81
  %148 = fmul fast <4 x double> %wide.load1270, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %150 = icmp eq i64 %index.next1267, %n.vec1265
  br i1 %150, label %middle.block1257, label %vector.body1259, !llvm.loop !86

middle.block1257:                                 ; preds = %vector.body1259
  %cmp.n1269 = icmp eq i64 %143, %n.vec1265
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  ...
  %152 = mul nsw i64 %polly.indvar417, -64
  %153 = shl nuw nsw i64 %polly.indvar417, 6
  %154 = mul nsw i64 %polly.indvar417, -64
  %155 = icmp slt i64 %154, -1136
  %156 = select i1 %155, i64 %154, i64 -1136
  %157 = add nsw i64 %156, 1199
  %158 = shl nsw i64 %polly.indvar417, 6
  br label %polly.loop_header420

polly.loop_exit422:                               ; preds = %polly.loop_exit429
  %polly.indvar_next418 = add nuw nsw i64 %polly.indvar417, 1
  %indvars.iv.next1039 = add nsw i64 %indvars.iv1038, -64
  %indvars.iv.next1044 = add nuw nsw i64 %indvars.iv1043, 64
  %indvars.iv.next1056 = add nuw nsw i64 %indvars.iv1055, 2
  %exitcond1058.not = icmp eq i64 %polly.indvar_next418, 19
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %160 = add i64 %152, %159
  %smax1274 = call i64 @llvm.smax.i64(i64 %160, i64 0)
  %161 = mul nsw i64 %polly.indvar423, -32
  %162 = add i64 %153, %161
  %163 = add i64 %smax1274, %162
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %171 = add i64 %163, %indvar1275
  %smin1277 = call i64 @llvm.smin.i64(i64 %171, i64 31)
  %172 = add nsw i64 %smin1277, 1
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1047, i64 31)
  %173 = add nsw i64 %polly.indvar431, %169
  %polly.loop_guard4441124 = icmp sgt i64 %173, -1
...
polly.loop_header463.us:                          ; preds = %polly.loop_header463.preheader, %polly.loop_exit472.loopexit.us
  ...
  %min.iters.check1278 = icmp ult i64 %172, 4
...
vector.body1273:                                  ; preds = %vector.body1273, %vector.ph1279
  ...
  %177 = add nuw nsw i64 %index1282, %164
  %178 = add nuw nsw i64 %index1282, %polly.access.mul.Packed_MemRef_call1297477.us
  %179 = getelementptr double, double* %Packed_MemRef_call1297, i64 %178
  %180 = bitcast double* %179 to <4 x double>*
  %wide.load1286 = load <4 x double>, <4 x double>* %180, align 8
  %181 = fmul fast <4 x double> %broadcast.splat1288, %wide.load1286
  ...
  %wide.load1292 = load <4 x double>, <4 x double>* %189, align 8, !alias.scope !79, !noalias !81
  ...
  %192 = fadd fast <4 x double> %191, %wide.load1292
  ...
  %194 = icmp eq i64 %index.next1283, %n.vec1281
  br i1 %194, label %middle.block1271, label %vector.body1273, !llvm.loop !90

middle.block1271:                                 ; preds = %vector.body1273
  %cmp.n1285 = icmp eq i64 %172, %n.vec1281
...
polly.loop_header586:                             ; preds = %polly.loop_exit594, %polly.start498
  ...
  %min.iters.check1214 = icmp ult i64 %198, 4
...
vector.body1213:                                  ; preds = %vector.body1213, %vector.ph1215
  ...
  %200 = shl nuw nsw i64 %index1218, 3
  %201 = getelementptr i8, i8* %scevgep598, i64 %200
  %202 = bitcast i8* %201 to <4 x double>*
  %wide.load1222 = load <4 x double>, <4 x double>* %202, align 8, !alias.scope !92, !noalias !94
  %203 = fmul fast <4 x double> %wide.load1222, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %205 = icmp eq i64 %index.next1219, %n.vec1217
  br i1 %205, label %middle.block1211, label %vector.body1213, !llvm.loop !99

middle.block1211:                                 ; preds = %vector.body1213
  %cmp.n1221 = icmp eq i64 %198, %n.vec1217
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  ...
  %207 = mul nsw i64 %polly.indvar621, -64
  %208 = shl nuw nsw i64 %polly.indvar621, 6
  %209 = mul nsw i64 %polly.indvar621, -64
  %210 = icmp slt i64 %209, -1136
  %211 = select i1 %210, i64 %209, i64 -1136
  %212 = add nsw i64 %211, 1199
  %213 = shl nsw i64 %polly.indvar621, 6
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next622, 19
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %214 = shl nuw nsw i64 %polly.indvar627, 5
  %215 = add i64 %207, %214
  %smax1226 = call i64 @llvm.smax.i64(i64 %215, i64 0)
  %216 = mul nsw i64 %polly.indvar627, -32
  %217 = add i64 %208, %216
  %218 = add i64 %smax1226, %217
  %219 = shl nsw i64 %polly.indvar627, 5
...
polly.loop_header631.preheader:                   ; preds = %polly.loop_header624
  ...
  %223 = add i64 %smax1068, %indvars.iv1071
  %224 = sub nsw i64 %213, %219
  %225 = add nuw nsw i64 %219, 32
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %indvars.iv1073 = phi i64 [ %223, %polly.loop_header631.preheader ], [ %indvars.iv.next1074, %polly.loop_exit669 ]
  %polly.indvar635 = phi i64 [ %222, %polly.loop_header631.preheader ], [ %polly.indvar_next636, %polly.loop_exit669 ]
  %226 = add i64 %218, %indvar1227
  %smin1229 = call i64 @llvm.smin.i64(i64 %226, i64 31)
  %227 = add nsw i64 %smin1229, 1
  %smin1078 = call i64 @llvm.smin.i64(i64 %indvars.iv1073, i64 31)
  %228 = add nsw i64 %polly.indvar635, %224
  %polly.loop_guard6481125 = icmp sgt i64 %228, -1
...
polly.loop_header667.us:                          ; preds = %polly.loop_header667.preheader, %polly.loop_exit676.loopexit.us
  ...
  %min.iters.check1230 = icmp ult i64 %227, 4
...
vector.body1225:                                  ; preds = %vector.body1225, %vector.ph1231
  ...
  %232 = add nuw nsw i64 %index1234, %219
  %233 = add nuw nsw i64 %index1234, %polly.access.mul.Packed_MemRef_call1501681.us
  %234 = getelementptr double, double* %Packed_MemRef_call1501, i64 %233
  %235 = bitcast double* %234 to <4 x double>*
  %wide.load1238 = load <4 x double>, <4 x double>* %235, align 8
  %236 = fmul fast <4 x double> %broadcast.splat1240, %wide.load1238
  ...
  %wide.load1241 = load <4 x double>, <4 x double>* %239, align 8
  %240 = fmul fast <4 x double> %broadcast.splat1243, %wide.load1241
  %241 = shl i64 %232, 3
  %242 = add i64 %241, %231
  %243 = getelementptr i8, i8* %call, i64 %242
  %244 = bitcast i8* %243 to <4 x double>*
  %wide.load1244 = load <4 x double>, <4 x double>* %244, align 8, !alias.scope !92, !noalias !94
  ...
  %247 = fadd fast <4 x double> %246, %wide.load1244
  ...
  %249 = icmp eq i64 %index.next1235, %n.vec1233
  br i1 %249, label %middle.block1223, label %vector.body1225, !llvm.loop !103

middle.block1223:                                 ; preds = %vector.body1225
  %cmp.n1237 = icmp eq i64 %227, %n.vec1233
...
vector.ph1153:                                    ; preds = %polly.loop_header838
  %broadcast.splatinsert1160 = insertelement <4 x i64> poison, i64 %257, i32 0
  %broadcast.splat1161 = shufflevector <4 x i64> %broadcast.splatinsert1160, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1162 = insertelement <4 x i32> poison, i32 %260, i32 0
...
vector.body1152:                                  ; preds = %vector.body1152, %vector.ph1153
  ...
  %262 = add nuw nsw <4 x i64> %vec.ind1158, %broadcast.splat1161
  %263 = trunc <4 x i64> %262 to <4 x i32>
  %264 = mul <4 x i32> %broadcast.splat1163, %263
  ...
  %274 = icmp eq i64 %index.next1155, %256
  br i1 %274, label %polly.loop_exit846, label %vector.body1152, !llvm.loop !110

polly.loop_exit846:                               ; preds = %vector.body1152, %polly.loop_header844
  %polly.indvar_next842 = add nuw nsw i64 %polly.indvar841, 1
  %exitcond1116.not = icmp eq i64 %polly.indvar841, %254
...
polly.loop_header844:                             ; preds = %polly.loop_header838, %polly.loop_header844
  ...
  %exitcond1112.not = icmp eq i64 %polly.indvar847, %258
...
polly.loop_header859:                             ; preds = %polly.loop_exit867, %polly.loop_header853
  ...
  %smin1167 = call i64 @llvm.smin.i64(i64 %284, i64 -968)
  %285 = add nsw i64 %smin1167, 1000
  %smin1101 = call i64 @llvm.smin.i64(i64 %indvars.iv1099, i64 -968)
  %286 = shl nsw i64 %polly.indvar862, 5
  %287 = add nsw i64 %smin1101, 999
...
vector.body1166:                                  ; preds = %vector.body1166, %vector.ph1169
  ...
  %291 = add nuw nsw <4 x i64> %vec.ind1176, %broadcast.splat1179
  %292 = trunc <4 x i64> %291 to <4 x i32>
  %293 = mul <4 x i32> %broadcast.splat1181, %292
  ...
  %303 = icmp eq i64 %index.next1173, %285
  br i1 %303, label %polly.loop_exit873, label %vector.body1166, !llvm.loop !113

polly.loop_exit873:                               ; preds = %vector.body1166, %polly.loop_header871
  %polly.indvar_next869 = add nuw nsw i64 %polly.indvar868, 1
  %exitcond1106.not = icmp eq i64 %polly.indvar868, %283
...
polly.loop_header871:                             ; preds = %polly.loop_header865, %polly.loop_header871
  ...
  %exitcond1102.not = icmp eq i64 %polly.indvar874, %287
...
polly.loop_header885:                             ; preds = %polly.loop_exit893, %polly.loop_header879
  ...
  %smin1185 = call i64 @llvm.smin.i64(i64 %313, i64 -968)
  %314 = add nsw i64 %smin1185, 1000
  %smin1091 = call i64 @llvm.smin.i64(i64 %indvars.iv1089, i64 -968)
  %315 = shl nsw i64 %polly.indvar888, 5
  %316 = add nsw i64 %smin1091, 999
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1187
  ...
  %320 = add nuw nsw <4 x i64> %vec.ind1194, %broadcast.splat1197
  %321 = trunc <4 x i64> %320 to <4 x i32>
  %322 = mul <4 x i32> %broadcast.splat1199, %321
  ...
  %332 = icmp eq i64 %index.next1191, %314
  br i1 %332, label %polly.loop_exit899, label %vector.body1184, !llvm.loop !116

polly.loop_exit899:                               ; preds = %vector.body1184, %polly.loop_header897
  %polly.indvar_next895 = add nuw nsw i64 %polly.indvar894, 1
  %exitcond1096.not = icmp eq i64 %polly.indvar894, %312
...
polly.loop_header897:                             ; preds = %polly.loop_header891, %polly.loop_header897
  ...
  %exitcond1092.not = icmp eq i64 %polly.indvar900, %316
