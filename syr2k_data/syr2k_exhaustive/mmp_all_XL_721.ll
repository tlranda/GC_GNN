; ModuleID = 'syr2k_exhaustive/mmp_all_XL_721.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_721.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %102 = sub i64 %97, %101
  %103 = mul nsw i64 %polly.indvar203, -64
  %104 = add i64 %103, %101
...
polly.loop_exit224:                               ; preds = %polly.loop_exit261
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar_next204, 19
...
polly.loop_header259.preheader:                   ; preds = %polly.loop_exit247, %polly.loop_exit247.us, %polly.loop_header222.split
  ...
  %polly.loop_guard269 = icmp slt i64 %132, 50
...
polly.loop_header266.us:                          ; preds = %polly.loop_header259.us, %polly.loop_exit276.us
  ...
  %smin1374 = call i64 @llvm.smin.i64(i64 %133, i64 63)
  %134 = add nsw i64 %smin1374, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1072, i64 63)
...
polly.loop_exit276.us:                            ; preds = %polly.loop_header274.us, %middle.block1366, %polly.loop_header266.us
  ...
  %polly.loop_cond272.us = icmp ult i64 %polly.indvar270.us, 49
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit431
  ...
  %181 = shl nsw i64 %polly.indvar409, 6
  br label %polly.loop_header412

polly.loop_exit414:                               ; preds = %polly.loop_exit420
  %182 = mul nsw i64 %polly.indvar409, -64
...
polly.loop_exit431:                               ; preds = %polly.loop_exit470
  ...
  %exitcond1102.not = icmp eq i64 %polly.indvar_next410, 19
...
polly.loop_exit470:                               ; preds = %polly.loop_exit477.loopexit.us, %polly.loop_header468.preheader
  ...
  %polly.loop_cond434 = icmp ult i64 %polly.indvar432, 23
  %indvars.iv.next1091 = add i64 %indvars.iv1090, -50
  %indvars.iv.next1096 = add i64 %indvars.iv1095, 50
...
polly.loop_header468.preheader:                   ; preds = %polly.loop_exit456, %polly.loop_exit456.us, %polly.loop_header429.split
  ...
  %polly.loop_guard478 = icmp slt i64 %203, 50
...
polly.loop_header475.us:                          ; preds = %polly.loop_header468.us, %polly.loop_exit485.us
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %204, i64 63)
  %205 = add nsw i64 %smin1324, 1
  %smin1099 = call i64 @llvm.smin.i64(i64 %indvars.iv1097, i64 63)
...
polly.loop_exit485.us:                            ; preds = %polly.loop_header483.us, %middle.block1316, %polly.loop_header475.us
  ...
  %polly.loop_cond481.us = icmp ult i64 %polly.indvar479.us, 49
...
polly.loop_exit640:                               ; preds = %polly.loop_exit679
  ...
  %indvars.iv.next1113 = add nuw nsw i64 %indvars.iv1112, 64
  %indvars.iv.next1115 = add nuw nsw i64 %indvars.iv1114, 7
  %indvars.iv.next1120 = add nsw i64 %indvars.iv1119, -64
  %exitcond1128.not = icmp eq i64 %polly.indvar_next619, 19
...
polly.loop_exit679:                               ; preds = %polly.loop_exit686.loopexit.us, %polly.loop_header677.preheader
  ...
  %polly.loop_cond643 = icmp ult i64 %polly.indvar641, 23
  %indvars.iv.next1117 = add i64 %indvars.iv1116, -50
...
polly.loop_header677.preheader:                   ; preds = %polly.loop_exit665, %polly.loop_exit665.us, %polly.loop_header638.split
  ...
  %polly.loop_guard687 = icmp slt i64 %274, 50
...
polly.loop_header684.us:                          ; preds = %polly.loop_header677.us, %polly.loop_exit694.us
  ...
  %smin1274 = call i64 @llvm.smin.i64(i64 %275, i64 63)
  %276 = add nsw i64 %smin1274, 1
  %smin1125 = call i64 @llvm.smin.i64(i64 %indvars.iv1123, i64 63)
