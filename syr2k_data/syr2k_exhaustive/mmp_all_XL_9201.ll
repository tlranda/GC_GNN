; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9201.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9201.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %104 = shl nuw nsw i64 %indvars.iv791, 4
  ...
  %polly.loop_guard = icmp slt i64 %108, 10
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %118 = mul nsw i64 %polly.indvar214, -128
  %119 = icmp slt i64 %118, -1072
  %120 = select i1 %119, i64 %118, i64 -1072
...
polly.loop_header224:                             ; preds = %polly.loop_header211, %polly.loop_exit234
  %indvars.iv799 = phi i64 [ %indvars.iv.next800, %polly.loop_exit234 ], [ %113, %polly.loop_header211 ]
  ...
  %123 = add i64 %122, %112
  %polly.loop_guard235880 = icmp sgt i64 %123, -1
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1008
  ...
  %134 = shl nuw nsw i64 %index1011, 3
  %135 = getelementptr i8, i8* %scevgep352, i64 %134
  %136 = bitcast i8* %135 to <4 x double>*
  %wide.load1015 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !72, !noalias !74
  %137 = fmul fast <4 x double> %wide.load1015, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %139 = icmp eq i64 %index.next1012, %n.vec1010
  br i1 %139, label %middle.block1002, label %vector.body1004, !llvm.loop !77

middle.block1002:                                 ; preds = %vector.body1004
  %cmp.n1014 = icmp eq i64 %132, %n.vec1010
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %148 = shl nuw nsw i64 %indvars.iv808, 4
  %149 = and i64 %148, 9223372036854775680
  %150 = mul nuw nsw i64 %polly.indvar365, 3
  %151 = add nuw nsw i64 %150, 7
  %pexp.p_div_q368 = lshr i64 %151, 3
  %152 = sub nsw i64 %polly.indvar365, %pexp.p_div_q368
  %polly.loop_guard373 = icmp slt i64 %152, 10
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  %153 = sub nsw i64 %indvars.iv813, %149
  %154 = add i64 %indvars.iv806, %149
  %155 = mul nuw nsw i64 %polly.indvar365, 80
  %156 = mul nsw i64 %polly.indvar365, -80
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  %indvars.iv815 = phi i64 [ %153, %polly.loop_header370.preheader ], [ %indvars.iv.next816, %polly.loop_exit379 ]
  %indvars.iv810 = phi i64 [ %154, %polly.loop_header370.preheader ], [ %indvars.iv.next811, %polly.loop_exit379 ]
  ...
  %158 = shl nsw i64 %polly.indvar374, 7
  %159 = sub nsw i64 %155, %158
  %160 = icmp sgt i64 %159, 0
  %161 = select i1 %160, i64 %159, i64 0
  %162 = mul nsw i64 %polly.indvar374, -128
  %163 = icmp slt i64 %162, -1072
  %164 = select i1 %163, i64 %162, i64 -1072
...
polly.loop_header384:                             ; preds = %polly.loop_header370, %polly.loop_exit394
  %indvars.iv817 = phi i64 [ %indvars.iv.next818, %polly.loop_exit394 ], [ %157, %polly.loop_header370 ]
  ...
  %167 = add i64 %166, %156
  %polly.loop_guard395884 = icmp sgt i64 %167, -1
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  %178 = shl nuw nsw i64 %index985, 3
  %179 = getelementptr i8, i8* %scevgep512, i64 %178
  %180 = bitcast i8* %179 to <4 x double>*
  %wide.load989 = load <4 x double>, <4 x double>* %180, align 8, !alias.scope !81, !noalias !83
  %181 = fmul fast <4 x double> %wide.load989, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %183 = icmp eq i64 %index.next986, %n.vec984
  br i1 %183, label %middle.block978, label %vector.body980, !llvm.loop !86

middle.block978:                                  ; preds = %vector.body980
  %cmp.n988 = icmp eq i64 %176, %n.vec984
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %192 = shl nuw nsw i64 %indvars.iv828, 4
  %193 = and i64 %192, 9223372036854775680
  %194 = mul nuw nsw i64 %polly.indvar525, 3
  %195 = add nuw nsw i64 %194, 7
  %pexp.p_div_q528 = lshr i64 %195, 3
  %196 = sub nsw i64 %polly.indvar525, %pexp.p_div_q528
  %polly.loop_guard533 = icmp slt i64 %196, 10
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  %197 = sub nsw i64 %indvars.iv833, %193
  %198 = add i64 %indvars.iv826, %193
  %199 = mul nuw nsw i64 %polly.indvar525, 80
  %200 = mul nsw i64 %polly.indvar525, -80
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  %indvars.iv835 = phi i64 [ %197, %polly.loop_header530.preheader ], [ %indvars.iv.next836, %polly.loop_exit539 ]
  %indvars.iv830 = phi i64 [ %198, %polly.loop_header530.preheader ], [ %indvars.iv.next831, %polly.loop_exit539 ]
  ...
  %201 = add i64 %smax832, %indvars.iv835
  %202 = shl nsw i64 %polly.indvar534, 7
  %203 = sub nsw i64 %199, %202
  %204 = icmp sgt i64 %203, 0
  %205 = select i1 %204, i64 %203, i64 0
  %206 = mul nsw i64 %polly.indvar534, -128
...
polly.loop_header544:                             ; preds = %polly.loop_header530, %polly.loop_exit554
  %indvars.iv837 = phi i64 [ %indvars.iv.next838, %polly.loop_exit554 ], [ %201, %polly.loop_header530 ]
  ...
  %211 = add i64 %210, %200
  %polly.loop_guard555888 = icmp sgt i64 %211, -1
...
polly.loop_header706:                             ; preds = %polly.loop_exit714, %polly.loop_header700
  ...
  %smin919 = call i64 @llvm.smin.i64(i64 %222, i64 -1168)
  %223 = add nsw i64 %smin919, 1200
  %smin868 = call i64 @llvm.smin.i64(i64 %indvars.iv866, i64 -1168)
  %224 = shl nsw i64 %polly.indvar709, 5
  %225 = add nsw i64 %smin868, 1199
...
vector.ph920:                                     ; preds = %polly.loop_header712
  %broadcast.splatinsert927 = insertelement <4 x i64> poison, i64 %224, i32 0
  %broadcast.splat928 = shufflevector <4 x i64> %broadcast.splatinsert927, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert929 = insertelement <4 x i32> poison, i32 %227, i32 0
...
vector.body918:                                   ; preds = %vector.body918, %vector.ph920
  ...
  %229 = add nuw nsw <4 x i64> %vec.ind925, %broadcast.splat928
  %230 = trunc <4 x i64> %229 to <4 x i32>
  %231 = mul <4 x i32> %broadcast.splat930, %230
  ...
  %241 = icmp eq i64 %index.next922, %223
  br i1 %241, label %polly.loop_exit720, label %vector.body918, !llvm.loop !95

polly.loop_exit720:                               ; preds = %vector.body918, %polly.loop_header718
  %polly.indvar_next716 = add nuw nsw i64 %polly.indvar715, 1
  %exitcond873.not = icmp eq i64 %polly.indvar715, %221
...
polly.loop_header718:                             ; preds = %polly.loop_header712, %polly.loop_header718
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar721, %225
...
polly.loop_header733:                             ; preds = %polly.loop_exit741, %polly.loop_header727
  ...
  %smin934 = call i64 @llvm.smin.i64(i64 %251, i64 -968)
  %252 = add nsw i64 %smin934, 1000
  %smin858 = call i64 @llvm.smin.i64(i64 %indvars.iv856, i64 -968)
  %253 = shl nsw i64 %polly.indvar736, 5
  %254 = add nsw i64 %smin858, 999
...
vector.body933:                                   ; preds = %vector.body933, %vector.ph936
  ...
  %258 = add nuw nsw <4 x i64> %vec.ind943, %broadcast.splat946
  %259 = trunc <4 x i64> %258 to <4 x i32>
  %260 = mul <4 x i32> %broadcast.splat948, %259
  ...
  %270 = icmp eq i64 %index.next940, %252
  br i1 %270, label %polly.loop_exit747, label %vector.body933, !llvm.loop !98

polly.loop_exit747:                               ; preds = %vector.body933, %polly.loop_header745
  %polly.indvar_next743 = add nuw nsw i64 %polly.indvar742, 1
  %exitcond863.not = icmp eq i64 %polly.indvar742, %250
...
polly.loop_header745:                             ; preds = %polly.loop_header739, %polly.loop_header745
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar748, %254
...
polly.loop_header759:                             ; preds = %polly.loop_exit767, %polly.loop_header753
  ...
  %smin952 = call i64 @llvm.smin.i64(i64 %280, i64 -968)
  %281 = add nsw i64 %smin952, 1000
  %smin848 = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 -968)
  %282 = shl nsw i64 %polly.indvar762, 5
  %283 = add nsw i64 %smin848, 999
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  %287 = add nuw nsw <4 x i64> %vec.ind961, %broadcast.splat964
  %288 = trunc <4 x i64> %287 to <4 x i32>
  %289 = mul <4 x i32> %broadcast.splat966, %288
  ...
  %299 = icmp eq i64 %index.next958, %281
  br i1 %299, label %polly.loop_exit773, label %vector.body951, !llvm.loop !101

polly.loop_exit773:                               ; preds = %vector.body951, %polly.loop_header771
  %polly.indvar_next769 = add nuw nsw i64 %polly.indvar768, 1
  %exitcond853.not = icmp eq i64 %polly.indvar768, %279
...
polly.loop_header771:                             ; preds = %polly.loop_header765, %polly.loop_header771
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar774, %283
...
polly.loop_header224.1:                           ; preds = %polly.loop_exit234, %polly.loop_exit234.1
  %indvars.iv799.1 = phi i64 [ %indvars.iv.next800.1, %polly.loop_exit234.1 ], [ %113, %polly.loop_exit234 ]
  %polly.indvar228.1 = phi i64 [ %polly.indvar_next229.1, %polly.loop_exit234.1 ], [ %117, %polly.loop_exit234 ]
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv799.1, i64 79)
  %307 = add i64 %polly.indvar228.1, %114
  %308 = add i64 %307, %112
  %polly.loop_guard235.1881 = icmp sgt i64 %308, -1
...
polly.loop_header224.2:                           ; preds = %polly.loop_exit234.1, %polly.loop_exit234.2
  %indvars.iv799.2 = phi i64 [ %indvars.iv.next800.2, %polly.loop_exit234.2 ], [ %113, %polly.loop_exit234.1 ]
  %polly.indvar228.2 = phi i64 [ %polly.indvar_next229.2, %polly.loop_exit234.2 ], [ %117, %polly.loop_exit234.1 ]
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv799.2, i64 79)
  %317 = add i64 %polly.indvar228.2, %114
  %318 = add i64 %317, %112
  %polly.loop_guard235.2882 = icmp sgt i64 %318, -1
...
polly.loop_header224.3:                           ; preds = %polly.loop_exit234.2, %polly.loop_exit234.3
  %indvars.iv799.3 = phi i64 [ %indvars.iv.next800.3, %polly.loop_exit234.3 ], [ %113, %polly.loop_exit234.2 ]
  %polly.indvar228.3 = phi i64 [ %polly.indvar_next229.3, %polly.loop_exit234.3 ], [ %117, %polly.loop_exit234.2 ]
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv799.3, i64 79)
  %327 = add i64 %polly.indvar228.3, %114
  %328 = add i64 %327, %112
  %polly.loop_guard235.3883 = icmp sgt i64 %328, -1
...
polly.loop_header384.1:                           ; preds = %polly.loop_exit394, %polly.loop_exit394.1
  %indvars.iv817.1 = phi i64 [ %indvars.iv.next818.1, %polly.loop_exit394.1 ], [ %157, %polly.loop_exit394 ]
  %polly.indvar388.1 = phi i64 [ %polly.indvar_next389.1, %polly.loop_exit394.1 ], [ %161, %polly.loop_exit394 ]
  %smin819.1 = call i64 @llvm.smin.i64(i64 %indvars.iv817.1, i64 79)
  %337 = add i64 %polly.indvar388.1, %158
  %338 = add i64 %337, %156
  %polly.loop_guard395.1885 = icmp sgt i64 %338, -1
...
polly.loop_header384.2:                           ; preds = %polly.loop_exit394.1, %polly.loop_exit394.2
  %indvars.iv817.2 = phi i64 [ %indvars.iv.next818.2, %polly.loop_exit394.2 ], [ %157, %polly.loop_exit394.1 ]
  %polly.indvar388.2 = phi i64 [ %polly.indvar_next389.2, %polly.loop_exit394.2 ], [ %161, %polly.loop_exit394.1 ]
  %smin819.2 = call i64 @llvm.smin.i64(i64 %indvars.iv817.2, i64 79)
  %347 = add i64 %polly.indvar388.2, %158
  %348 = add i64 %347, %156
  %polly.loop_guard395.2886 = icmp sgt i64 %348, -1
...
polly.loop_header384.3:                           ; preds = %polly.loop_exit394.2, %polly.loop_exit394.3
  %indvars.iv817.3 = phi i64 [ %indvars.iv.next818.3, %polly.loop_exit394.3 ], [ %157, %polly.loop_exit394.2 ]
  %polly.indvar388.3 = phi i64 [ %polly.indvar_next389.3, %polly.loop_exit394.3 ], [ %161, %polly.loop_exit394.2 ]
  %smin819.3 = call i64 @llvm.smin.i64(i64 %indvars.iv817.3, i64 79)
  %357 = add i64 %polly.indvar388.3, %158
  %358 = add i64 %357, %156
  %polly.loop_guard395.3887 = icmp sgt i64 %358, -1
...
polly.loop_header544.1:                           ; preds = %polly.loop_exit554, %polly.loop_exit554.1
  %indvars.iv837.1 = phi i64 [ %indvars.iv.next838.1, %polly.loop_exit554.1 ], [ %201, %polly.loop_exit554 ]
  %polly.indvar548.1 = phi i64 [ %polly.indvar_next549.1, %polly.loop_exit554.1 ], [ %205, %polly.loop_exit554 ]
  %smin839.1 = call i64 @llvm.smin.i64(i64 %indvars.iv837.1, i64 79)
  %367 = add i64 %polly.indvar548.1, %202
  %368 = add i64 %367, %200
  %polly.loop_guard555.1889 = icmp sgt i64 %368, -1
...
polly.loop_header544.2:                           ; preds = %polly.loop_exit554.1, %polly.loop_exit554.2
  %indvars.iv837.2 = phi i64 [ %indvars.iv.next838.2, %polly.loop_exit554.2 ], [ %201, %polly.loop_exit554.1 ]
  %polly.indvar548.2 = phi i64 [ %polly.indvar_next549.2, %polly.loop_exit554.2 ], [ %205, %polly.loop_exit554.1 ]
  %smin839.2 = call i64 @llvm.smin.i64(i64 %indvars.iv837.2, i64 79)
  %377 = add i64 %polly.indvar548.2, %202
  %378 = add i64 %377, %200
  %polly.loop_guard555.2890 = icmp sgt i64 %378, -1
...
polly.loop_header544.3:                           ; preds = %polly.loop_exit554.2, %polly.loop_exit554.3
  %indvars.iv837.3 = phi i64 [ %indvars.iv.next838.3, %polly.loop_exit554.3 ], [ %201, %polly.loop_exit554.2 ]
  %polly.indvar548.3 = phi i64 [ %polly.indvar_next549.3, %polly.loop_exit554.3 ], [ %205, %polly.loop_exit554.2 ]
  %smin839.3 = call i64 @llvm.smin.i64(i64 %indvars.iv837.3, i64 79)
  %387 = add i64 %polly.indvar548.3, %202
  %388 = add i64 %387, %200
  %polly.loop_guard555.3891 = icmp sgt i64 %388, -1
