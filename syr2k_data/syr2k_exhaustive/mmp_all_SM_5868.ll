; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5868.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5868.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %98 = shl nuw nsw i64 %indvars.iv862, 1
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %pexp.p_div_q = lshr i64 %106, 4
  %107 = sub nsw i64 %104, %pexp.p_div_q
  %polly.loop_guard = icmp slt i64 %107, 38
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %indvars.iv.next861 = add nsw i64 %indvars.iv860, -14
  %indvars.iv.next863 = add nuw nsw i64 %indvars.iv862, 7
  %indvars.iv.next867 = add nuw nsw i64 %indvars.iv866, 14
...
polly.loop_header217:                             ; preds = %polly.loop_header217, %polly.loop_header211
  ...
  %109 = add nuw nsw i64 %polly.indvar220, %102
...
polly.loop_header227:                             ; preds = %polly.loop_exit213, %polly.loop_exit235
  ...
  %110 = add i64 %smax, %indvars.iv868
...
polly.loop_header240:                             ; preds = %polly.loop_header233, %polly.loop_exit250
  %indvars.iv870 = phi i64 [ %110, %polly.loop_header233 ], [ %indvars.iv.next871, %polly.loop_exit250 ]
  ...
  %122 = add i64 %121, %103
  %polly.loop_guard251957 = icmp sgt i64 %122, -1
...
polly.loop_header248:                             ; preds = %polly.loop_header248.preheader, %polly.loop_header248
  ...
  %126 = add nuw nsw i64 %polly.indvar252, %102
...
vector.body1066:                                  ; preds = %vector.body1066, %vector.ph1070
  ...
  %133 = shl nuw nsw i64 %index1073, 3
  %134 = getelementptr i8, i8* %scevgep372, i64 %133
  %135 = bitcast i8* %134 to <4 x double>*
  %wide.load1077 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !78, !noalias !80
  %136 = fmul fast <4 x double> %wide.load1077, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %138 = icmp eq i64 %index.next1074, %n.vec1072
  br i1 %138, label %middle.block1064, label %vector.body1066, !llvm.loop !84

middle.block1064:                                 ; preds = %vector.body1066
  %cmp.n1076 = icmp eq i64 %131, %n.vec1072
...
polly.loop_header376:                             ; preds = %polly.loop_header376.preheader, %polly.loop_exit384
  ...
  %140 = mul nuw nsw i64 %polly.indvar379, 50
...
polly.loop_header382:                             ; preds = %polly.loop_exit408, %polly.loop_header376
  ...
  %141 = shl nuw nsw i64 %indvars.iv884, 1
  %142 = and i64 %141, 9223372036854775776
  %143 = add i64 %indvars.iv882, %142
  %144 = sub nsw i64 %indvars.iv889, %142
  %145 = mul nuw nsw i64 %polly.indvar385, 50
  br label %polly.loop_header388

polly.loop_exit390:                               ; preds = %polly.loop_exit396
  %146 = mul nsw i64 %polly.indvar385, -50
  %147 = shl nuw nsw i64 %polly.indvar385, 1
  %148 = mul nuw nsw i64 %polly.indvar385, 7
  %149 = add nuw nsw i64 %148, 15
  %pexp.p_div_q404 = lshr i64 %149, 4
  %150 = sub nsw i64 %147, %pexp.p_div_q404
  %polly.loop_guard409 = icmp slt i64 %150, 38
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415, %polly.loop_exit390
  ...
  %indvars.iv.next883 = add nsw i64 %indvars.iv882, -14
  %indvars.iv.next885 = add nuw nsw i64 %indvars.iv884, 7
  %indvars.iv.next890 = add nuw nsw i64 %indvars.iv889, 14
...
polly.loop_header388:                             ; preds = %polly.loop_exit396, %polly.loop_header382
  ...
  %151 = add nuw nsw i64 %polly.indvar391, %140
...
polly.loop_header394:                             ; preds = %polly.loop_header394, %polly.loop_header388
  ...
  %152 = add nuw nsw i64 %polly.indvar397, %145
...
polly.loop_header406:                             ; preds = %polly.loop_exit390, %polly.loop_exit415
  %indvars.iv891 = phi i64 [ %indvars.iv.next892, %polly.loop_exit415 ], [ %144, %polly.loop_exit390 ]
  %indvars.iv886 = phi i64 [ %indvars.iv.next887, %polly.loop_exit415 ], [ %143, %polly.loop_exit390 ]
  ...
  %154 = shl nsw i64 %polly.indvar410, 5
  %155 = sub nsw i64 %145, %154
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %158 = mul nsw i64 %polly.indvar410, -32
...
polly.loop_header413:                             ; preds = %polly.loop_header406, %polly.loop_exit422
  ...
  %162 = add nuw nsw i64 %polly.indvar416, %140
  %163 = shl i64 %162, 3
...
polly.loop_header420:                             ; preds = %polly.loop_header413, %polly.loop_exit430
  %indvars.iv893 = phi i64 [ %153, %polly.loop_header413 ], [ %indvars.iv.next894, %polly.loop_exit430 ]
  ...
  %165 = add i64 %164, %146
  %polly.loop_guard431958 = icmp sgt i64 %165, -1
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_header428
  ...
  %169 = add nuw nsw i64 %polly.indvar432, %145
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %min.iters.check1043 = icmp ult i64 %174, 4
...
vector.body1042:                                  ; preds = %vector.body1042, %vector.ph1044
  ...
  %176 = shl nuw nsw i64 %index1047, 3
  %177 = getelementptr i8, i8* %scevgep552, i64 %176
  %178 = bitcast i8* %177 to <4 x double>*
  %wide.load1051 = load <4 x double>, <4 x double>* %178, align 8, !alias.scope !88, !noalias !90
  %179 = fmul fast <4 x double> %wide.load1051, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %181 = icmp eq i64 %index.next1048, %n.vec1046
  br i1 %181, label %middle.block1040, label %vector.body1042, !llvm.loop !94

middle.block1040:                                 ; preds = %vector.body1042
  %cmp.n1050 = icmp eq i64 %174, %n.vec1046
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_exit564
  ...
  %183 = mul nuw nsw i64 %polly.indvar559, 50
...
polly.loop_header562:                             ; preds = %polly.loop_exit588, %polly.loop_header556
  ...
  %184 = shl nuw nsw i64 %indvars.iv908, 1
  %185 = and i64 %184, 9223372036854775776
  %186 = add i64 %indvars.iv906, %185
  %187 = sub nsw i64 %indvars.iv913, %185
  %188 = mul nuw nsw i64 %polly.indvar565, 50
  br label %polly.loop_header568

polly.loop_exit570:                               ; preds = %polly.loop_exit576
  %189 = mul nsw i64 %polly.indvar565, -50
  %190 = shl nuw nsw i64 %polly.indvar565, 1
  %191 = mul nuw nsw i64 %polly.indvar565, 7
  %192 = add nuw nsw i64 %191, 15
  %pexp.p_div_q584 = lshr i64 %192, 4
  %193 = sub nsw i64 %190, %pexp.p_div_q584
  %polly.loop_guard589 = icmp slt i64 %193, 38
...
polly.loop_exit588:                               ; preds = %polly.loop_exit595, %polly.loop_exit570
  ...
  %indvars.iv.next907 = add nsw i64 %indvars.iv906, -14
  %indvars.iv.next909 = add nuw nsw i64 %indvars.iv908, 7
  %indvars.iv.next914 = add nuw nsw i64 %indvars.iv913, 14
...
polly.loop_header568:                             ; preds = %polly.loop_exit576, %polly.loop_header562
  ...
  %194 = add nuw nsw i64 %polly.indvar571, %183
...
polly.loop_header574:                             ; preds = %polly.loop_header574, %polly.loop_header568
  ...
  %195 = add nuw nsw i64 %polly.indvar577, %188
...
polly.loop_header586:                             ; preds = %polly.loop_exit570, %polly.loop_exit595
  %indvars.iv915 = phi i64 [ %indvars.iv.next916, %polly.loop_exit595 ], [ %187, %polly.loop_exit570 ]
  %indvars.iv910 = phi i64 [ %indvars.iv.next911, %polly.loop_exit595 ], [ %186, %polly.loop_exit570 ]
  ...
  %196 = add i64 %smax912, %indvars.iv915
  %197 = shl nsw i64 %polly.indvar590, 5
  %198 = sub nsw i64 %188, %197
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %201 = mul nsw i64 %polly.indvar590, -32
...
polly.loop_header593:                             ; preds = %polly.loop_header586, %polly.loop_exit602
  ...
  %205 = add nuw nsw i64 %polly.indvar596, %183
  %206 = shl i64 %205, 3
...
polly.loop_header600:                             ; preds = %polly.loop_header593, %polly.loop_exit610
  %indvars.iv917 = phi i64 [ %196, %polly.loop_header593 ], [ %indvars.iv.next918, %polly.loop_exit610 ]
  ...
  %208 = add i64 %207, %189
  %polly.loop_guard611959 = icmp sgt i64 %208, -1
...
polly.loop_header608:                             ; preds = %polly.loop_header608.preheader, %polly.loop_header608
  ...
  %212 = add nuw nsw i64 %polly.indvar612, %188
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %smin981 = call i64 @llvm.smin.i64(i64 %219, i64 -1168)
  %220 = add nsw i64 %smin981, 1200
  %smin948 = call i64 @llvm.smin.i64(i64 %indvars.iv946, i64 -1168)
  %221 = shl nsw i64 %polly.indvar767, 5
  %222 = add nsw i64 %smin948, 1199
...
vector.ph982:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert989 = insertelement <4 x i64> poison, i64 %221, i32 0
  %broadcast.splat990 = shufflevector <4 x i64> %broadcast.splatinsert989, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert991 = insertelement <4 x i32> poison, i32 %224, i32 0
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  %226 = add nuw nsw <4 x i64> %vec.ind987, %broadcast.splat990
  %227 = trunc <4 x i64> %226 to <4 x i32>
  %228 = mul <4 x i32> %broadcast.splat992, %227
  ...
  %238 = icmp eq i64 %index.next984, %220
  br i1 %238, label %polly.loop_exit778, label %vector.body980, !llvm.loop !103

polly.loop_exit778:                               ; preds = %vector.body980, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond953.not = icmp eq i64 %polly.indvar773, %218
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %exitcond949.not = icmp eq i64 %polly.indvar779, %222
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %smin996 = call i64 @llvm.smin.i64(i64 %248, i64 -968)
  %249 = add nsw i64 %smin996, 1000
  %smin938 = call i64 @llvm.smin.i64(i64 %indvars.iv936, i64 -968)
  %250 = shl nsw i64 %polly.indvar794, 5
  %251 = add nsw i64 %smin938, 999
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  %255 = add nuw nsw <4 x i64> %vec.ind1005, %broadcast.splat1008
  %256 = trunc <4 x i64> %255 to <4 x i32>
  %257 = mul <4 x i32> %broadcast.splat1010, %256
  ...
  %267 = icmp eq i64 %index.next1002, %249
  br i1 %267, label %polly.loop_exit805, label %vector.body995, !llvm.loop !106

polly.loop_exit805:                               ; preds = %vector.body995, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond943.not = icmp eq i64 %polly.indvar800, %247
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond939.not = icmp eq i64 %polly.indvar806, %251
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %smin1014 = call i64 @llvm.smin.i64(i64 %277, i64 -968)
  %278 = add nsw i64 %smin1014, 1000
  %smin928 = call i64 @llvm.smin.i64(i64 %indvars.iv926, i64 -968)
  %279 = shl nsw i64 %polly.indvar820, 5
  %280 = add nsw i64 %smin928, 999
...
vector.body1013:                                  ; preds = %vector.body1013, %vector.ph1016
  ...
  %284 = add nuw nsw <4 x i64> %vec.ind1023, %broadcast.splat1026
  %285 = trunc <4 x i64> %284 to <4 x i32>
  %286 = mul <4 x i32> %broadcast.splat1028, %285
  ...
  %296 = icmp eq i64 %index.next1020, %278
  br i1 %296, label %polly.loop_exit831, label %vector.body1013, !llvm.loop !109

polly.loop_exit831:                               ; preds = %vector.body1013, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond933.not = icmp eq i64 %polly.indvar826, %276
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %exitcond929.not = icmp eq i64 %polly.indvar832, %280
