; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6651.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6651.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit223
  ...
  %97 = shl nuw nsw i64 %indvars.iv844, 4
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %polly.loop_guard = icmp slt i64 %105, 10
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -48
  %indvars.iv.next845 = add nuw nsw i64 %indvars.iv844, 3
  %indvars.iv.next849 = add nuw nsw i64 %indvars.iv848, 48
...
polly.loop_header221:                             ; preds = %polly.loop_exit207, %polly.loop_exit229
  ...
  %108 = shl nsw i64 %polly.indvar224, 7
  %109 = sub nsw i64 %101, %108
  %110 = icmp sgt i64 %109, 0
  %111 = select i1 %110, i64 %109, i64 0
  %112 = mul nsw i64 %polly.indvar224, -128
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %polly.loop_cond226 = icmp slt i64 %polly.indvar224, 9
  %indvars.iv.next847 = add i64 %indvars.iv846, -128
  %indvars.iv.next851 = add i64 %indvars.iv850, 128
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit398
  ...
  %134 = shl nuw nsw i64 %indvars.iv865, 4
  %135 = and i64 %134, 9223372036854775680
...
polly.loop_exit380:                               ; preds = %polly.loop_exit386
  %139 = mul nsw i64 %polly.indvar375, -80
  ...
  %polly.loop_guard399 = icmp slt i64 %142, 10
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405, %polly.loop_exit380
  ...
  %indvars.iv.next864 = add nsw i64 %indvars.iv863, -48
  %indvars.iv.next866 = add nuw nsw i64 %indvars.iv865, 3
  %indvars.iv.next871 = add nuw nsw i64 %indvars.iv870, 48
...
polly.loop_header396:                             ; preds = %polly.loop_exit380, %polly.loop_exit405
  ...
  %145 = shl nsw i64 %polly.indvar400, 7
  %146 = sub nsw i64 %138, %145
  %147 = icmp sgt i64 %146, 0
  %148 = select i1 %147, i64 %146, i64 0
  %149 = mul nsw i64 %polly.indvar400, -128
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %polly.loop_cond402 = icmp slt i64 %polly.indvar400, 9
  %indvars.iv.next868 = add i64 %indvars.iv867, -128
  %indvars.iv.next873 = add i64 %indvars.iv872, 128
...
polly.loop_exit556:                               ; preds = %polly.loop_exit562
  ...
  %polly.loop_guard575 = icmp slt i64 %179, 10
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_exit556
  ...
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, -48
  %indvars.iv.next889 = add nuw nsw i64 %indvars.iv888, 3
  %indvars.iv.next894 = add nuw nsw i64 %indvars.iv893, 48
...
polly.loop_header572:                             ; preds = %polly.loop_exit556, %polly.loop_exit581
  ...
  %182 = shl nsw i64 %polly.indvar576, 7
  %183 = sub nsw i64 %175, %182
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %186 = mul nsw i64 %polly.indvar576, -128
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588, %polly.loop_header572
  ...
  %polly.loop_cond578 = icmp slt i64 %polly.indvar576, 9
  %indvars.iv.next891 = add i64 %indvars.iv890, -128
  %indvars.iv.next896 = add i64 %indvars.iv895, 128
