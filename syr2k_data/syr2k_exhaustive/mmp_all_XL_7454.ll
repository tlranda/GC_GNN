; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7454.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7454.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond862.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !69
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next219, 19
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  %smin855 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -936)
  %106 = shl nsw i64 %polly.indvar224, 6
  %107 = add nsw i64 %smin855, 999
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar_next225, 16
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %108 = mul nsw i64 %polly.indvar230, 80
  %109 = add nsw i64 %108, %101
  %110 = icmp sgt i64 %109, 0
  %111 = select i1 %110, i64 %109, i64 0
  %polly.loop_guard237.not = icmp sgt i64 %111, %104
...
polly.loop_exit236:                               ; preds = %polly.loop_exit243, %polly.loop_header227
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar230, %100
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  ...
  %polly.loop_guard251943 = icmp sgt i64 %114, -1
  %115 = add nuw nsw i64 %polly.indvar238, %105
...
polly.loop_header241.us:                          ; preds = %polly.loop_header234, %polly.loop_exit250.loopexit.us
  ...
  %118 = add nuw nsw i64 %polly.indvar244.us, %106
  %119 = shl i64 %118, 3
...
polly.loop_exit250.loopexit.us:                   ; preds = %polly.loop_header248.us
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar244.us, %107
...
vector.body1052:                                  ; preds = %vector.body1052, %vector.ph1056
  ...
  %128 = shl nuw nsw i64 %index1059, 3
  %129 = getelementptr i8, i8* %scevgep372, i64 %128
  %130 = bitcast i8* %129 to <4 x double>*
  %wide.load1063 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !73, !noalias !75
  %131 = fmul fast <4 x double> %wide.load1063, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %133 = icmp eq i64 %index.next1060, %n.vec1058
  br i1 %133, label %middle.block1050, label %vector.body1052, !llvm.loop !79

middle.block1050:                                 ; preds = %vector.body1052
  %cmp.n1062 = icmp eq i64 %126, %n.vec1058
...
polly.loop_header366:                             ; preds = %polly.loop_header366.preheader, %polly.loop_header366
  ...
  br i1 %exitcond886.not, label %polly.loop_exit368, label %polly.loop_header366, !llvm.loop !80
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %.inv838 = icmp slt i64 %136, 14
  %138 = select i1 %.inv838, i64 %137, i64 14
  %polly.loop_guard409 = icmp sgt i64 %138, -1
  %139 = mul nsw i64 %polly.indvar395, -64
  %140 = icmp slt i64 %139, -1136
  %141 = select i1 %140, i64 %139, i64 -1136
  %142 = add nsw i64 %141, 1199
  %143 = shl nsw i64 %polly.indvar395, 6
  br label %polly.loop_header398

polly.loop_exit400:                               ; preds = %polly.loop_exit408
  %polly.indvar_next396 = add nuw nsw i64 %polly.indvar395, 1
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, -64
  %indvars.iv.next870 = add nuw nsw i64 %indvars.iv869, 64
  %exitcond883.not = icmp eq i64 %polly.indvar_next396, 19
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  ...
  %144 = shl nsw i64 %polly.indvar401, 6
  %145 = add nsw i64 %smin879, 999
...
polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next402, 16
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %polly.loop_guard417.not = icmp sgt i64 %149, %142
...
polly.loop_header414.preheader:                   ; preds = %polly.loop_header406
  ...
  %150 = add i64 %smax868, %indvars.iv871
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar410, %138
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  %indvars.iv873 = phi i64 [ %150, %polly.loop_header414.preheader ], [ %indvars.iv.next874, %polly.loop_exit423 ]
  ...
  %polly.loop_guard431944 = icmp sgt i64 %152, -1
  %153 = add nuw nsw i64 %polly.indvar418, %143
...
polly.loop_header421.us:                          ; preds = %polly.loop_header414, %polly.loop_exit430.loopexit.us
  ...
  %156 = add nuw nsw i64 %polly.indvar424.us, %144
  %157 = shl i64 %156, 3
...
polly.loop_exit430.loopexit.us:                   ; preds = %polly.loop_header428.us
  ...
  %exitcond880.not = icmp eq i64 %polly.indvar424.us, %145
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430.loopexit.us, %polly.loop_header414
  ...
  %polly.loop_cond420.not.not = icmp ult i64 %polly.indvar418, %142
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %min.iters.check1029 = icmp ult i64 %164, 4
...
vector.body1028:                                  ; preds = %vector.body1028, %vector.ph1030
  ...
  %166 = shl nuw nsw i64 %index1033, 3
  %167 = getelementptr i8, i8* %scevgep552, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load1037 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !83, !noalias !85
  %169 = fmul fast <4 x double> %wide.load1037, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next1034, %n.vec1032
  br i1 %171, label %middle.block1026, label %vector.body1028, !llvm.loop !89

middle.block1026:                                 ; preds = %vector.body1028
  %cmp.n1036 = icmp eq i64 %164, %n.vec1032
...
polly.loop_header546:                             ; preds = %polly.loop_header546.preheader, %polly.loop_header546
  ...
  br i1 %exitcond910.not, label %polly.loop_exit548, label %polly.loop_header546, !llvm.loop !90
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %.inv839 = icmp slt i64 %174, 14
  %176 = select i1 %.inv839, i64 %175, i64 14
  %polly.loop_guard589 = icmp sgt i64 %176, -1
  %177 = mul nsw i64 %polly.indvar575, -64
  %178 = icmp slt i64 %177, -1136
  %179 = select i1 %178, i64 %177, i64 -1136
  %180 = add nsw i64 %179, 1199
  %181 = shl nsw i64 %polly.indvar575, 6
...
polly.loop_exit580:                               ; preds = %polly.loop_exit588
  ...
  %indvars.iv.next889 = add nsw i64 %indvars.iv888, -64
  %indvars.iv.next894 = add nuw nsw i64 %indvars.iv893, 64
  %exitcond907.not = icmp eq i64 %polly.indvar_next576, 19
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  ...
  %182 = shl nsw i64 %polly.indvar581, 6
  %183 = add nsw i64 %smin903, 999
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar_next582, 16
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %184 = mul nsw i64 %polly.indvar590, 80
  %185 = add nsw i64 %184, %177
  %186 = icmp sgt i64 %185, 0
  %187 = select i1 %186, i64 %185, i64 0
  %polly.loop_guard597.not = icmp sgt i64 %187, %180
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header586
  ...
  %188 = add i64 %smax892, %indvars.iv895
  %189 = sub nsw i64 %181, %184
...
polly.loop_exit596:                               ; preds = %polly.loop_exit603, %polly.loop_header586
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar590, %176
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit603
  %indvars.iv897 = phi i64 [ %188, %polly.loop_header594.preheader ], [ %indvars.iv.next898, %polly.loop_exit603 ]
  ...
  %polly.loop_guard611945 = icmp sgt i64 %190, -1
  %191 = add nuw nsw i64 %polly.indvar598, %181
...
polly.loop_header601.us:                          ; preds = %polly.loop_header594, %polly.loop_exit610.loopexit.us
  ...
  %194 = add nuw nsw i64 %polly.indvar604.us, %182
  %195 = shl i64 %194, 3
...
polly.loop_exit610.loopexit.us:                   ; preds = %polly.loop_header608.us
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar604.us, %183
...
polly.loop_exit603:                               ; preds = %polly.loop_exit610.loopexit.us, %polly.loop_header594
  ...
  %polly.loop_cond600.not.not = icmp ult i64 %polly.indvar598, %180
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %smin967 = call i64 @llvm.smin.i64(i64 %204, i64 -1168)
  %205 = add nsw i64 %smin967, 1200
  %smin934 = call i64 @llvm.smin.i64(i64 %indvars.iv932, i64 -1168)
  %206 = shl nsw i64 %polly.indvar767, 5
  %207 = add nsw i64 %smin934, 1199
...
vector.ph968:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert975 = insertelement <4 x i64> poison, i64 %206, i32 0
  %broadcast.splat976 = shufflevector <4 x i64> %broadcast.splatinsert975, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert977 = insertelement <4 x i32> poison, i32 %209, i32 0
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  %211 = add nuw nsw <4 x i64> %vec.ind973, %broadcast.splat976
  %212 = trunc <4 x i64> %211 to <4 x i32>
  %213 = mul <4 x i32> %broadcast.splat978, %212
  ...
  %223 = icmp eq i64 %index.next970, %205
  br i1 %223, label %polly.loop_exit778, label %vector.body966, !llvm.loop !98

polly.loop_exit778:                               ; preds = %vector.body966, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond939.not = icmp eq i64 %polly.indvar773, %203
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar779, %207
  br i1 %exitcond935.not, label %polly.loop_exit778, label %polly.loop_header776, !llvm.loop !99
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %smin982 = call i64 @llvm.smin.i64(i64 %233, i64 -968)
  %234 = add nsw i64 %smin982, 1000
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 -968)
  %235 = shl nsw i64 %polly.indvar794, 5
  %236 = add nsw i64 %smin924, 999
...
vector.body981:                                   ; preds = %vector.body981, %vector.ph984
  ...
  %240 = add nuw nsw <4 x i64> %vec.ind991, %broadcast.splat994
  %241 = trunc <4 x i64> %240 to <4 x i32>
  %242 = mul <4 x i32> %broadcast.splat996, %241
  ...
  %252 = icmp eq i64 %index.next988, %234
  br i1 %252, label %polly.loop_exit805, label %vector.body981, !llvm.loop !101

polly.loop_exit805:                               ; preds = %vector.body981, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond929.not = icmp eq i64 %polly.indvar800, %232
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond925.not = icmp eq i64 %polly.indvar806, %236
  br i1 %exitcond925.not, label %polly.loop_exit805, label %polly.loop_header803, !llvm.loop !102
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %smin1000 = call i64 @llvm.smin.i64(i64 %262, i64 -968)
  %263 = add nsw i64 %smin1000, 1000
  %smin914 = call i64 @llvm.smin.i64(i64 %indvars.iv912, i64 -968)
  %264 = shl nsw i64 %polly.indvar820, 5
  %265 = add nsw i64 %smin914, 999
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1002
  ...
  %269 = add nuw nsw <4 x i64> %vec.ind1009, %broadcast.splat1012
  %270 = trunc <4 x i64> %269 to <4 x i32>
  %271 = mul <4 x i32> %broadcast.splat1014, %270
  ...
  %281 = icmp eq i64 %index.next1006, %263
  br i1 %281, label %polly.loop_exit831, label %vector.body999, !llvm.loop !104

polly.loop_exit831:                               ; preds = %vector.body999, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond919.not = icmp eq i64 %polly.indvar826, %261
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar832, %265
  br i1 %exitcond915.not, label %polly.loop_exit831, label %polly.loop_header829, !llvm.loop !105
}
