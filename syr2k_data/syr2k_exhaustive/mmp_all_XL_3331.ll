; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3331.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3331.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit252, %polly.loop_header205
  ...
  %indvars.iv.next1021 = add nuw nsw i64 %indvars.iv1020, 22
  %exitcond1028.not = icmp eq i64 %polly.indvar_next209, 10
...
polly.loop_header257.us:                          ; preds = %polly.loop_header250.us, %polly.loop_exit267.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1024, i64 127)
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %145 = mul nuw nsw i64 %polly.indvar396, 50
...
polly.loop_exit409:                               ; preds = %polly.loop_exit449, %polly.loop_header399
  ...
  %indvars.iv.next1036 = add nsw i64 %indvars.iv1035, -22
  %indvars.iv.next1038 = add nuw nsw i64 %indvars.iv1037, 11
  %indvars.iv.next1043 = add nuw nsw i64 %indvars.iv1042, 22
  %exitcond1051.not = icmp eq i64 %polly.indvar_next403, 10
...
polly.loop_header454.us:                          ; preds = %polly.loop_header447.us, %polly.loop_exit464.us
  ...
  %smin1048 = call i64 @llvm.smin.i64(i64 %indvars.iv1046, i64 127)
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %193 = mul nuw nsw i64 %polly.indvar593, 50
...
polly.loop_exit606:                               ; preds = %polly.loop_exit646, %polly.loop_header596
  ...
  %indvars.iv.next1059 = add nsw i64 %indvars.iv1058, -22
  %indvars.iv.next1061 = add nuw nsw i64 %indvars.iv1060, 11
  %indvars.iv.next1066 = add nuw nsw i64 %indvars.iv1065, 22
  %exitcond1074.not = icmp eq i64 %polly.indvar_next600, 10
