; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1631.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1631.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %102 = shl nsw i64 %polly.indvar219, 4
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %104 = mul nuw nsw i64 %polly.indvar231, 20
  %105 = add i64 %97, %104
  %smax1342 = call i64 @llvm.smax.i64(i64 %105, i64 0)
  %106 = mul nsw i64 %polly.indvar231, -20
  %107 = add i64 %98, %106
  ...
  %polly.loop_guard238 = icmp slt i64 %112, 16
...
polly.loop_header235:                             ; preds = %polly.loop_header235.preheader, %polly.loop_exit269
  ...
  %smin1345 = call i64 @llvm.smin.i64(i64 %116, i64 19)
...
polly.loop_header422:                             ; preds = %polly.loop_exit414, %polly.loop_exit430
  ...
  %155 = mul nsw i64 %polly.indvar425, -16
  %156 = shl nuw nsw i64 %polly.indvar425, 4
  ...
  %159 = mul nsw i64 %polly.indvar425, -16
  %160 = shl nsw i64 %polly.indvar425, 4
...
polly.loop_header436:                             ; preds = %polly.loop_header436.preheader, %polly.loop_exit446
  ...
  %162 = mul nuw nsw i64 %polly.indvar440, 20
  %163 = add i64 %155, %162
  %smax1294 = call i64 @llvm.smax.i64(i64 %163, i64 0)
  %164 = mul nsw i64 %polly.indvar440, -20
  %165 = add i64 %156, %164
  %166 = add i64 %smax1294, %165
  %167 = mul nuw nsw i64 %polly.indvar440, 20
  %168 = add nsw i64 %167, %159
  %169 = icmp sgt i64 %168, 0
  %170 = select i1 %169, i64 %168, i64 0
  %polly.loop_guard447 = icmp slt i64 %170, 16
...
polly.loop_header444:                             ; preds = %polly.loop_header444.preheader, %polly.loop_exit482
  ...
  %smin1297 = call i64 @llvm.smin.i64(i64 %174, i64 19)
...
polly.loop_header635:                             ; preds = %polly.loop_exit627, %polly.loop_exit643
  ...
  %213 = mul nsw i64 %polly.indvar638, -16
  %214 = shl nuw nsw i64 %polly.indvar638, 4
  ...
  %217 = mul nsw i64 %polly.indvar638, -16
  %218 = shl nsw i64 %polly.indvar638, 4
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit659
  ...
  %220 = mul nuw nsw i64 %polly.indvar653, 20
  %221 = add i64 %213, %220
  %smax1246 = call i64 @llvm.smax.i64(i64 %221, i64 0)
  %222 = mul nsw i64 %polly.indvar653, -20
  %223 = add i64 %214, %222
  %224 = add i64 %smax1246, %223
  %225 = mul nuw nsw i64 %polly.indvar653, 20
  %226 = add nsw i64 %225, %217
  %227 = icmp sgt i64 %226, 0
  %228 = select i1 %227, i64 %226, i64 0
  %polly.loop_guard660 = icmp slt i64 %228, 16
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit695
  ...
  %smin1249 = call i64 @llvm.smin.i64(i64 %232, i64 19)
