; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10016.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10016.c"
...
polly.loop_exit225:                               ; preds = %polly.loop_exit231.loopexit.us, %polly.loop_header217
  ...
  %exitcond784.not = icmp eq i64 %polly.indvar_next221, 50
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph973
  ...
  %wide.load980 = load <4 x double>, <4 x double>* %118, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %121, label %middle.block967, label %vector.body969, !llvm.loop !73
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %123 = lshr i64 %polly.indvar355, 1
  %124 = mul nuw nsw i64 %polly.indvar355, 50
  br label %polly.loop_header358

polly.loop_exit360:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next791 = add nuw nsw i64 %indvars.iv790, 50
  %exitcond802.not = icmp eq i64 %polly.indvar_next356, 24
...
polly.loop_header365:                             ; preds = %polly.loop_exit373, %polly.loop_header358
  ...
  %126 = mul nuw nsw i64 %polly.indvar368, 100
...
polly.loop_exit379:                               ; preds = %polly.loop_exit386.loopexit.us, %polly.loop_header371
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next375, 50
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph947
  ...
  %wide.load954 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %147, label %middle.block943, label %vector.body945, !llvm.loop !82
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %149 = lshr i64 %polly.indvar511, 1
  %150 = mul nuw nsw i64 %polly.indvar511, 50
...
polly.loop_exit516:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next806 = add nuw nsw i64 %indvars.iv805, 50
  %exitcond817.not = icmp eq i64 %polly.indvar_next512, 24
...
polly.loop_header514:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %151 = mul nuw nsw i64 %polly.indvar517, 100
...
polly.loop_header521:                             ; preds = %polly.loop_exit529, %polly.loop_header514
  ...
  %152 = mul nuw nsw i64 %polly.indvar524, 100
...
polly.loop_exit535:                               ; preds = %polly.loop_exit542.loopexit.us, %polly.loop_header527
  ...
  %exitcond814.not = icmp eq i64 %polly.indvar_next531, 50
...
vector.body883:                                   ; preds = %vector.body883, %vector.ph885
  ...
  br i1 %187, label %polly.loop_exit708, label %vector.body883, !llvm.loop !91
...
vector.body898:                                   ; preds = %vector.body898, %vector.ph901
  ...
  br i1 %216, label %polly.loop_exit735, label %vector.body898, !llvm.loop !94
...
vector.body916:                                   ; preds = %vector.body916, %vector.ph919
  ...
  br i1 %245, label %polly.loop_exit761, label %vector.body916, !llvm.loop !97
