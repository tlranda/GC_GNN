; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4263.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4263.c"
...
polly.loop_exit248:                               ; preds = %polly.loop_exit255.loopexit.us, %polly.loop_header217.split, %polly.loop_header246.preheader
  ...
  %exitcond991.not = icmp eq i64 %polly.indvar_next221, 16
...
vector.body1193:                                  ; preds = %vector.body1193, %vector.ph1197
  ...
  %wide.load1204 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %126, label %middle.block1191, label %vector.body1193, !llvm.loop !79
...
polly.loop_header371:                             ; preds = %polly.loop_header371.preheader, %polly.loop_header371
  ...
  br i1 %exitcond1019.not, label %polly.loop_exit373, label %polly.loop_header371, !llvm.loop !80
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %129 = shl nsw i64 %polly.indvar384, 4
...
polly.loop_exit389:                               ; preds = %polly.loop_exit396
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar_next385, 75
...
polly.loop_header387:                             ; preds = %polly.loop_exit396, %polly.loop_header381
  ...
  %131 = shl nsw i64 %polly.indvar390, 4
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond1017.not = icmp eq i64 %polly.indvar_next391, 63
...
polly.loop_header400:                             ; preds = %polly.loop_exit437, %polly.loop_header394
  ...
  %smin1011 = call i64 @llvm.smin.i64(i64 %indvars.iv1005, i64 63)
...
polly.loop_exit437:                               ; preds = %polly.loop_exit444.loopexit.us, %polly.loop_header400.split, %polly.loop_header435.preheader
  ...
  %exitcond1015.not = icmp eq i64 %polly.indvar_next404, 16
...
vector.body1169:                                  ; preds = %vector.body1169, %vector.ph1171
  ...
  %wide.load1178 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %157, label %middle.block1167, label %vector.body1169, !llvm.loop !89
...
polly.loop_header560:                             ; preds = %polly.loop_header560.preheader, %polly.loop_header560
  ...
  br i1 %exitcond1043.not, label %polly.loop_exit562, label %polly.loop_header560, !llvm.loop !90
...
polly.loop_exit578:                               ; preds = %polly.loop_exit585
  ...
  %indvars.iv.next1026 = add nuw nsw i64 %indvars.iv1025, 16
  %exitcond1042.not = icmp eq i64 %polly.indvar_next574, 75
...
polly.loop_header576:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %smin1037 = call i64 @llvm.smin.i64(i64 %indvars.iv1021, i64 -984)
  %161 = add nsw i64 %smin1037, 1000
  %162 = shl nsw i64 %polly.indvar579, 4
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next580, 63
...
polly.loop_header589:                             ; preds = %polly.loop_exit626, %polly.loop_header583
  ...
  %smin1035 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 63)
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633.loopexit.us, %polly.loop_header589.split, %polly.loop_header624.preheader
  ...
  %exitcond1039.not = icmp eq i64 %polly.indvar_next593, 16
...
vector.body1108:                                  ; preds = %vector.body1108, %vector.ph1109
  ...
  br i1 %202, label %polly.loop_exit801, label %vector.body1108, !llvm.loop !98
...
polly.loop_header799:                             ; preds = %polly.loop_header793, %polly.loop_header799
  ...
  br i1 %exitcond1068.not, label %polly.loop_exit801, label %polly.loop_header799, !llvm.loop !99
...
vector.body1122:                                  ; preds = %vector.body1122, %vector.ph1125
  ...
  br i1 %231, label %polly.loop_exit828, label %vector.body1122, !llvm.loop !101
...
polly.loop_header826:                             ; preds = %polly.loop_header820, %polly.loop_header826
  ...
  br i1 %exitcond1058.not, label %polly.loop_exit828, label %polly.loop_header826, !llvm.loop !102
...
vector.body1140:                                  ; preds = %vector.body1140, %vector.ph1143
  ...
  br i1 %260, label %polly.loop_exit854, label %vector.body1140, !llvm.loop !104
...
polly.loop_header852:                             ; preds = %polly.loop_header846, %polly.loop_header852
  ...
  br i1 %exitcond1048.not, label %polly.loop_exit854, label %polly.loop_header852, !llvm.loop !105
}
