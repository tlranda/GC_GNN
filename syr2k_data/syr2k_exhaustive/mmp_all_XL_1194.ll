; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1194.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1194.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1205 = call i64 @llvm.smin.i64(i64 %indvars.iv1174, i64 -872)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1175 = add nsw i64 %indvars.iv1174, -128
  %exitcond1208.not = icmp eq i64 %polly.indvar_next204, 8
...
vector.body1540:                                  ; preds = %vector.body1540, %vector.ph1548
  ...
  %wide.load1561 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %165, label %middle.block1538, label %vector.body1540, !llvm.loop !85
...
polly.start323:                                   ; preds = %kernel_syr2k.exit
  ...
  %malloccall327 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
vector.body1476:                                  ; preds = %vector.body1476, %vector.ph1480
  ...
  %wide.load1487 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %175, label %middle.block1474, label %vector.body1476, !llvm.loop !93
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit435
  ...
  %smin1247 = call i64 @llvm.smin.i64(i64 %indvars.iv1214, i64 -872)
  %177 = add nsw i64 %smin1247, 1000
  %178 = shl nsw i64 %polly.indvar430, 7
...
polly.loop_exit435:                               ; preds = %polly.loop_exit459
  ...
  %indvars.iv.next1215 = add nsw i64 %indvars.iv1214, -128
  %exitcond1250.not = icmp eq i64 %polly.indvar_next431, 8
...
vector.body1490:                                  ; preds = %vector.body1490, %vector.ph1498
  ...
  %wide.load1511 = load <4 x double>, <4 x double>* %240, align 8, !alias.scope !86, !noalias !88
  ...
  store <4 x double> %243, <4 x double>* %244, align 8, !alias.scope !86, !noalias !88
  %index.next1502 = add i64 %index1501, 4
  %245 = icmp eq i64 %index.next1502, %n.vec1500
  br i1 %245, label %middle.block1488, label %vector.body1490, !llvm.loop !98
...
polly.start557:                                   ; preds = %init_array.exit
  %malloccall559 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
  %malloccall561 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
vector.body1428:                                  ; preds = %vector.body1428, %vector.ph1430
  ...
  %wide.load1437 = load <4 x double>, <4 x double>* %252, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %255, label %middle.block1426, label %vector.body1428, !llvm.loop !106
...
polly.loop_header661:                             ; preds = %polly.loop_header661.preheader, %polly.loop_exit669
  ...
  %smin1289 = call i64 @llvm.smin.i64(i64 %indvars.iv1256, i64 -872)
  %257 = add nsw i64 %smin1289, 1000
  %258 = shl nsw i64 %polly.indvar664, 7
...
polly.loop_exit669:                               ; preds = %polly.loop_exit693
  ...
  %indvars.iv.next1257 = add nsw i64 %indvars.iv1256, -128
  %exitcond1292.not = icmp eq i64 %polly.indvar_next665, 8
...
vector.body1440:                                  ; preds = %vector.body1440, %vector.ph1448
  ...
  %wide.load1461 = load <4 x double>, <4 x double>* %320, align 8, !alias.scope !99, !noalias !101
  ...
  store <4 x double> %323, <4 x double>* %324, align 8, !alias.scope !99, !noalias !101
  %index.next1452 = add i64 %index1451, 4
  %325 = icmp eq i64 %index.next1452, %n.vec1450
  br i1 %325, label %middle.block1438, label %vector.body1440, !llvm.loop !111
...
vector.body1367:                                  ; preds = %vector.body1367, %vector.ph1368
  ...
  br i1 %349, label %polly.loop_exit935, label %vector.body1367, !llvm.loop !117
...
vector.body1381:                                  ; preds = %vector.body1381, %vector.ph1384
  ...
  br i1 %378, label %polly.loop_exit962, label %vector.body1381, !llvm.loop !120
...
vector.body1399:                                  ; preds = %vector.body1399, %vector.ph1402
  ...
  br i1 %407, label %polly.loop_exit988, label %vector.body1399, !llvm.loop !123
