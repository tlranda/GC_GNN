; ModuleID = 'syr2k_exhaustive/mmp_all_XL_45.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_45.c"
...
polly.start:                                      ; preds = %kernel_syr2k.exit90
  %malloccall = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #8
  %malloccall136 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #8
...
polly.start304:                                   ; preds = %kernel_syr2k.exit
  %malloccall306 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #8
  %malloccall308 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #8
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit416
  ...
  %141 = shl nsw i64 %polly.indvar411, 5
...
polly.start514:                                   ; preds = %init_array.exit
  %malloccall516 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #8
  %malloccall518 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #8
...
polly.loop_header618:                             ; preds = %polly.loop_header618.preheader, %polly.loop_exit626
  ...
  %184 = shl nsw i64 %polly.indvar621, 5
