; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6411.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6411.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next841 = add nsw i64 %indvars.iv840, -128
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %106 = mul nuw nsw i64 %polly.indvar224, 96
  %107 = sub nsw i64 %102, %106
  %108 = icmp sgt i64 %107, 0
  %109 = select i1 %108, i64 %107, i64 0
  %110 = mul nsw i64 %polly.indvar224, -96
  %111 = icmp slt i64 %110, -1104
  %112 = select i1 %111, i64 %110, i64 -1104
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %polly.loop_cond226 = icmp ult i64 %polly.indvar224, 12
  %indvars.iv.next839 = add i64 %indvars.iv838, -96
  %indvars.iv.next843 = add i64 %indvars.iv842, 96
...
polly.loop_header233:                             ; preds = %polly.loop_exit242, %polly.loop_header227
  %indvars.iv844 = phi i64 [ %indvars.iv.next845, %polly.loop_exit242 ], [ %105, %polly.loop_header227 ]
  %polly.indvar236 = phi i64 [ %polly.indvar_next237, %polly.loop_exit242 ], [ %109, %polly.loop_header227 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv844, i64 127)
  %115 = add nuw i64 %polly.indvar236, %106
  %116 = add i64 %115, %103
  %polly.loop_guard243924 = icmp sgt i64 %116, -1
  br i1 %polly.loop_guard243924, label %polly.loop_header240.preheader, label %polly.loop_exit242
...
polly.loop_header240:                             ; preds = %polly.loop_header240.preheader, %polly.loop_header240
  ...
  %119 = add nuw nsw i64 %polly.indvar244, %102
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1037
  ...
  %125 = shl nuw nsw i64 %index1040, 3
  %126 = getelementptr i8, i8* %scevgep366, i64 %125
  %127 = bitcast i8* %126 to <4 x double>*
  %wide.load1044 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !79, !noalias !81
  %128 = fmul fast <4 x double> %wide.load1044, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %130 = icmp eq i64 %index.next1041, %n.vec1039
  br i1 %130, label %middle.block1031, label %vector.body1033, !llvm.loop !85

middle.block1031:                                 ; preds = %vector.body1033
  %cmp.n1043 = icmp eq i64 %123, %n.vec1039
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %132 = udiv i64 %polly.indvar373, 3
  %133 = add nuw i64 %polly.indvar373, %132
  %134 = mul nuw nsw i64 %133, 96
  %135 = sub i64 %indvars.iv855, %134
  %136 = add i64 %indvars.iv860, %134
  %137 = shl nsw i64 %polly.indvar373, 7
  br label %polly.loop_header376

polly.loop_exit378:                               ; preds = %polly.loop_exit384
  %138 = mul nsw i64 %polly.indvar373, -128
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar_next374, 10
...
polly.loop_header382:                             ; preds = %polly.loop_header382, %polly.loop_header376
  ...
  %139 = add nuw nsw i64 %polly.indvar385, %137
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  %indvars.iv862 = phi i64 [ %indvars.iv.next863, %polly.loop_exit401 ], [ %136, %polly.loop_exit378 ]
  %indvars.iv857 = phi i64 [ %indvars.iv.next858, %polly.loop_exit401 ], [ %135, %polly.loop_exit378 ]
  %polly.indvar396 = phi i64 [ %polly.indvar_next397, %polly.loop_exit401 ], [ %133, %polly.loop_exit378 ]
  %smax859 = call i64 @llvm.smax.i64(i64 %indvars.iv857, i64 0)
  %140 = add i64 %smax859, %indvars.iv862
  %141 = mul nuw nsw i64 %polly.indvar396, 96
  %142 = sub nsw i64 %137, %141
  %143 = icmp sgt i64 %142, 0
  %144 = select i1 %143, i64 %142, i64 0
  %145 = mul nsw i64 %polly.indvar396, -96
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408, %polly.loop_header393
  ...
  %polly.loop_cond398 = icmp ult i64 %polly.indvar396, 12
  %indvars.iv.next858 = add i64 %indvars.iv857, -96
...
polly.loop_exit408:                               ; preds = %polly.loop_exit416
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar_next403, 1000
  br i1 %exitcond868.not, label %polly.loop_exit401, label %polly.loop_header399

polly.loop_header406:                             ; preds = %polly.loop_exit416, %polly.loop_header399
  %indvars.iv864 = phi i64 [ %indvars.iv.next865, %polly.loop_exit416 ], [ %140, %polly.loop_header399 ]
  ...
  %151 = add i64 %150, %138
  %polly.loop_guard417925 = icmp sgt i64 %151, -1
  br i1 %polly.loop_guard417925, label %polly.loop_header414.preheader, label %polly.loop_exit416
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_header414
  ...
  %154 = add nuw nsw i64 %polly.indvar418, %137
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar418, %smin866
  br i1 %exitcond867.not, label %polly.loop_exit416, label %polly.loop_header414
...
polly.loop_header528:                             ; preds = %polly.loop_exit536, %polly.start442
  ...
  %min.iters.check1010 = icmp ult i64 %158, 4
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %160 = shl nuw nsw i64 %index1014, 3
  %161 = getelementptr i8, i8* %scevgep540, i64 %160
  %162 = bitcast i8* %161 to <4 x double>*
  %wide.load1018 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !89, !noalias !91
  %163 = fmul fast <4 x double> %wide.load1018, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %165 = icmp eq i64 %index.next1015, %n.vec1013
  br i1 %165, label %middle.block1007, label %vector.body1009, !llvm.loop !95

middle.block1007:                                 ; preds = %vector.body1009
  %cmp.n1017 = icmp eq i64 %158, %n.vec1013
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %167 = udiv i64 %polly.indvar547, 3
  %168 = add nuw i64 %polly.indvar547, %167
  %169 = mul nuw nsw i64 %168, 96
  %170 = sub i64 %indvars.iv876, %169
  %171 = add i64 %indvars.iv881, %169
  %172 = shl nsw i64 %polly.indvar547, 7
  br label %polly.loop_header550

polly.loop_exit552:                               ; preds = %polly.loop_exit558
  %173 = mul nsw i64 %polly.indvar547, -128
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %exitcond890.not = icmp eq i64 %polly.indvar_next548, 10
...
polly.loop_header556:                             ; preds = %polly.loop_header556, %polly.loop_header550
  ...
  %174 = add nuw nsw i64 %polly.indvar559, %172
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  %indvars.iv883 = phi i64 [ %indvars.iv.next884, %polly.loop_exit575 ], [ %171, %polly.loop_exit552 ]
  %indvars.iv878 = phi i64 [ %indvars.iv.next879, %polly.loop_exit575 ], [ %170, %polly.loop_exit552 ]
  %polly.indvar570 = phi i64 [ %polly.indvar_next571, %polly.loop_exit575 ], [ %168, %polly.loop_exit552 ]
  %smax880 = call i64 @llvm.smax.i64(i64 %indvars.iv878, i64 0)
  %175 = add i64 %smax880, %indvars.iv883
  %176 = mul nuw nsw i64 %polly.indvar570, 96
  %177 = sub nsw i64 %172, %176
  %178 = icmp sgt i64 %177, 0
  %179 = select i1 %178, i64 %177, i64 0
  %180 = mul nsw i64 %polly.indvar570, -96
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582, %polly.loop_header567
  ...
  %polly.loop_cond572 = icmp ult i64 %polly.indvar570, 12
  %indvars.iv.next879 = add i64 %indvars.iv878, -96
...
polly.loop_exit582:                               ; preds = %polly.loop_exit590
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar_next577, 1000
...
polly.loop_header580:                             ; preds = %polly.loop_exit590, %polly.loop_header573
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit590 ], [ %175, %polly.loop_header573 ]
  %polly.indvar584 = phi i64 [ %polly.indvar_next585, %polly.loop_exit590 ], [ %179, %polly.loop_header573 ]
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv885, i64 127)
  %185 = add nuw i64 %polly.indvar584, %176
  %186 = add i64 %185, %173
  %polly.loop_guard591926 = icmp sgt i64 %186, -1
  br i1 %polly.loop_guard591926, label %polly.loop_header588.preheader, label %polly.loop_exit590
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_header588
  ...
  %189 = add nuw nsw i64 %polly.indvar592, %172
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar592, %smin887
  br i1 %exitcond888.not, label %polly.loop_exit590, label %polly.loop_header588
...
polly.loop_header746:                             ; preds = %polly.loop_exit754, %polly.loop_header740
  ...
  %smin948 = call i64 @llvm.smin.i64(i64 %195, i64 -1168)
  %196 = add nsw i64 %smin948, 1200
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -1168)
  %197 = shl nsw i64 %polly.indvar749, 5
  %198 = add nsw i64 %smin915, 1199
...
vector.ph949:                                     ; preds = %polly.loop_header752
  %broadcast.splatinsert956 = insertelement <4 x i64> poison, i64 %197, i32 0
  %broadcast.splat957 = shufflevector <4 x i64> %broadcast.splatinsert956, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert958 = insertelement <4 x i32> poison, i32 %200, i32 0
...
vector.body947:                                   ; preds = %vector.body947, %vector.ph949
  ...
  %202 = add nuw nsw <4 x i64> %vec.ind954, %broadcast.splat957
  %203 = trunc <4 x i64> %202 to <4 x i32>
  %204 = mul <4 x i32> %broadcast.splat959, %203
  ...
  %214 = icmp eq i64 %index.next951, %196
  br i1 %214, label %polly.loop_exit760, label %vector.body947, !llvm.loop !104

polly.loop_exit760:                               ; preds = %vector.body947, %polly.loop_header758
  %polly.indvar_next756 = add nuw nsw i64 %polly.indvar755, 1
  %exitcond920.not = icmp eq i64 %polly.indvar755, %194
...
polly.loop_header758:                             ; preds = %polly.loop_header752, %polly.loop_header758
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar761, %198
...
polly.loop_header773:                             ; preds = %polly.loop_exit781, %polly.loop_header767
  ...
  %smin963 = call i64 @llvm.smin.i64(i64 %224, i64 -968)
  %225 = add nsw i64 %smin963, 1000
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 -968)
  %226 = shl nsw i64 %polly.indvar776, 5
  %227 = add nsw i64 %smin905, 999
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph965
  ...
  %231 = add nuw nsw <4 x i64> %vec.ind972, %broadcast.splat975
  %232 = trunc <4 x i64> %231 to <4 x i32>
  %233 = mul <4 x i32> %broadcast.splat977, %232
  ...
  %243 = icmp eq i64 %index.next969, %225
  br i1 %243, label %polly.loop_exit787, label %vector.body962, !llvm.loop !107

polly.loop_exit787:                               ; preds = %vector.body962, %polly.loop_header785
  %polly.indvar_next783 = add nuw nsw i64 %polly.indvar782, 1
  %exitcond910.not = icmp eq i64 %polly.indvar782, %223
...
polly.loop_header785:                             ; preds = %polly.loop_header779, %polly.loop_header785
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar788, %227
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  %smin981 = call i64 @llvm.smin.i64(i64 %253, i64 -968)
  %254 = add nsw i64 %smin981, 1000
  %smin895 = call i64 @llvm.smin.i64(i64 %indvars.iv893, i64 -968)
  %255 = shl nsw i64 %polly.indvar802, 5
  %256 = add nsw i64 %smin895, 999
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph983
  ...
  %260 = add nuw nsw <4 x i64> %vec.ind990, %broadcast.splat993
  %261 = trunc <4 x i64> %260 to <4 x i32>
  %262 = mul <4 x i32> %broadcast.splat995, %261
  ...
  %272 = icmp eq i64 %index.next987, %254
  br i1 %272, label %polly.loop_exit813, label %vector.body980, !llvm.loop !110

polly.loop_exit813:                               ; preds = %vector.body980, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond900.not = icmp eq i64 %polly.indvar808, %252
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond896.not = icmp eq i64 %polly.indvar814, %256
