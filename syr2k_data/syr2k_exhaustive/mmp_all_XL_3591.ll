; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3591.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3591.c"
...
vector.body1339:                                  ; preds = %vector.body1339, %vector.ph1341
  ...
  br i1 %57, label %middle.block1337, label %vector.body1339, !llvm.loop !59
...
vector.body1365:                                  ; preds = %vector.body1365, %vector.ph1367
  ...
  br i1 %68, label %middle.block1363, label %vector.body1365, !llvm.loop !61
...
vector.body1377:                                  ; preds = %vector.body1377, %vector.ph1381
  ...
  %wide.load1388 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !67, !noalias !69
  ...
  br i1 %95, label %middle.block1375, label %vector.body1377, !llvm.loop !73
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1129 = call i64 @llvm.smin.i64(i64 %indvars.iv1110, i64 -920)
...
vector.body1351:                                  ; preds = %vector.body1351, %vector.ph1355
  ...
  %wide.load1362 = load <4 x double>, <4 x double>* %141, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %144, label %middle.block1349, label %vector.body1351, !llvm.loop !84
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_header396
  ...
  br i1 %exitcond1167.not, label %polly.loop_exit398, label %polly.loop_header396, !llvm.loop !85
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %smin1163 = call i64 @llvm.smin.i64(i64 %indvars.iv1143, i64 -920)
  %146 = add nsw i64 %smin1163, 1000
  %147 = mul nuw nsw i64 %polly.indvar409, 80
  br label %polly.loop_header412

polly.loop_exit414:                               ; preds = %polly.loop_exit422
  %polly.indvar_next410 = add nuw nsw i64 %polly.indvar409, 1
  %indvars.iv.next1144 = add nsw i64 %indvars.iv1143, -80
  %exitcond1166.not = icmp eq i64 %polly.indvar_next410, 13
...
vector.body1327:                                  ; preds = %vector.body1327, %vector.ph1329
  ...
  %wide.load1336 = load <4 x double>, <4 x double>* %190, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %193, label %middle.block1325, label %vector.body1327, !llvm.loop !94
...
polly.loop_header610:                             ; preds = %polly.loop_header610.preheader, %polly.loop_header610
  ...
  br i1 %exitcond1201.not, label %polly.loop_exit612, label %polly.loop_header610, !llvm.loop !95
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %smin1197 = call i64 @llvm.smin.i64(i64 %indvars.iv1177, i64 -920)
  %195 = add nsw i64 %smin1197, 1000
  %196 = mul nuw nsw i64 %polly.indvar623, 80
...
polly.loop_exit628:                               ; preds = %polly.loop_exit636
  ...
  %indvars.iv.next1178 = add nsw i64 %indvars.iv1177, -80
  %exitcond1200.not = icmp eq i64 %polly.indvar_next624, 13
...
vector.body1266:                                  ; preds = %vector.body1266, %vector.ph1267
  ...
  br i1 %256, label %polly.loop_exit876, label %vector.body1266, !llvm.loop !103
...
polly.loop_header874:                             ; preds = %polly.loop_header868, %polly.loop_header874
  ...
  br i1 %exitcond1226.not, label %polly.loop_exit876, label %polly.loop_header874, !llvm.loop !104
...
vector.body1280:                                  ; preds = %vector.body1280, %vector.ph1283
  ...
  br i1 %285, label %polly.loop_exit903, label %vector.body1280, !llvm.loop !106
...
polly.loop_header901:                             ; preds = %polly.loop_header895, %polly.loop_header901
  ...
  br i1 %exitcond1216.not, label %polly.loop_exit903, label %polly.loop_header901, !llvm.loop !107
...
vector.body1298:                                  ; preds = %vector.body1298, %vector.ph1301
  ...
  br i1 %314, label %polly.loop_exit929, label %vector.body1298, !llvm.loop !109
...
polly.loop_header927:                             ; preds = %polly.loop_header921, %polly.loop_header927
  ...
  br i1 %exitcond1206.not, label %polly.loop_exit929, label %polly.loop_header927, !llvm.loop !110
}
