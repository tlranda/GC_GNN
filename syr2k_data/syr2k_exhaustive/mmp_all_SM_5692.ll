; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5692.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5692.c"
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit572.3
  ...
  %191 = mul nuw nsw i64 %polly.indvar584, 20
  %192 = sub nsw i64 %188, %191
  %193 = icmp sgt i64 %192, 0
  %194 = select i1 %193, i64 %192, i64 0
  %polly.loop_guard597 = icmp slt i64 %194, 20
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  ...
  %296 = shl nuw nsw i64 %polly.indvar208, 1
...
polly.loop_exit394.3:                             ; preds = %polly.loop_header392.3
  ...
  %332 = shl nuw nsw i64 %polly.indvar383, 1
...
polly.loop_exit572.3:                             ; preds = %polly.loop_header570.3
  ...
  %368 = shl nuw nsw i64 %polly.indvar561, 1
