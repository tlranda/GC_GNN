; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1543.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1543.c"
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1348 = call i64 @llvm.smin.i64(i64 %115, i64 19)
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %160 = mul nuw nsw i64 %polly.indvar436, 20
  %161 = add i64 %154, %160
  %smax1297 = call i64 @llvm.smax.i64(i64 %161, i64 0)
  %162 = mul nsw i64 %polly.indvar436, -20
  %163 = add i64 %155, %162
  %164 = add i64 %smax1297, %163
  %165 = mul nuw nsw i64 %polly.indvar436, 20
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1300 = call i64 @llvm.smin.i64(i64 %172, i64 19)
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %217 = mul nuw nsw i64 %polly.indvar647, 20
  %218 = add i64 %211, %217
  %smax1249 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar647, -20
  %220 = add i64 %212, %219
  %221 = add i64 %smax1249, %220
  %222 = mul nuw nsw i64 %polly.indvar647, 20
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1252 = call i64 @llvm.smin.i64(i64 %229, i64 19)
