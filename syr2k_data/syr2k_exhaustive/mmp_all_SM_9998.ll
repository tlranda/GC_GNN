; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9998.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9998.c"
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %132 = shl nsw i64 %polly.indvar363, 6
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next364, 16
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %smin843 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 -936)
  %164 = shl nsw i64 %polly.indvar521, 6
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next522, 16
