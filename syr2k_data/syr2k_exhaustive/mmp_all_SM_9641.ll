; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9641.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9641.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv797 = phi i64 [ %indvars.iv.next798, %polly.loop_exit207 ], [ 7, %polly.loop_exit193 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond801.not = icmp eq i64 %polly.indvar_next203, 75
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %polly.loop_guard = icmp slt i64 %105, 16
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv821 = phi i64 [ %indvars.iv.next822, %polly.loop_exit362 ], [ 7, %polly.loop_exit346 ]
  ...
  %130 = mul nsw i64 %polly.indvar357, -16
  %131 = shl nsw i64 %polly.indvar357, 4
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit369
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next805 = add nsw i64 %indvars.iv804, -16
  %indvars.iv.next810 = add nuw nsw i64 %indvars.iv809, 16
  %indvars.iv.next822 = add nuw nsw i64 %indvars.iv821, 8
  %exitcond825.not = icmp eq i64 %polly.indvar_next358, 75
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %polly.loop_guard377 = icmp slt i64 %137, 16
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv845 = phi i64 [ %indvars.iv.next846, %polly.loop_exit520 ], [ 7, %polly.loop_exit504 ]
  ...
  %162 = mul nsw i64 %polly.indvar515, -16
  %163 = shl nsw i64 %polly.indvar515, 4
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next834 = add nuw nsw i64 %indvars.iv833, 16
  %indvars.iv.next846 = add nuw nsw i64 %indvars.iv845, 8
  %exitcond849.not = icmp eq i64 %polly.indvar_next516, 75
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %polly.loop_guard535 = icmp slt i64 %169, 16
