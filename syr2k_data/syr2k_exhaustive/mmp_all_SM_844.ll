; ModuleID = 'syr2k_exhaustive/mmp_all_SM_844.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_844.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %indvars.iv1076 = phi i64 [ 15, %polly.loop_header200.preheader ], [ %indvars.iv.next1077, %polly.loop_exit224 ]
  ...
  %97 = mul nsw i64 %polly.indvar203, -28
  %98 = mul nuw nsw i64 %polly.indvar203, 28
  %99 = add nuw i64 %98, 60
  %100 = and i64 %99, -64
  %101 = add i64 %97, %100
  %102 = sub i64 %98, %100
  %103 = shl nuw nsw i64 %indvars.iv1076, 2
  %104 = and i64 %103, 9223372036854775744
  %105 = add i64 %indvars.iv1074, %104
  %106 = sub nsw i64 %indvars.iv1080, %104
  %107 = mul nsw i64 %polly.indvar203, -100
  %108 = mul nuw nsw i64 %polly.indvar203, 100
  br label %polly.loop_header206

polly.loop_exit208:                               ; preds = %polly.loop_exit214
  %109 = add nsw i64 %107, 1199
  %110 = shl nuw nsw i64 %polly.indvar203, 1
  %111 = mul nuw nsw i64 %polly.indvar203, 7
  %112 = add nuw nsw i64 %111, 15
  %pexp.p_div_q = lshr i64 %112, 4
  %113 = sub nsw i64 %110, %pexp.p_div_q
  %polly.loop_guard = icmp slt i64 %113, 19
...
polly.loop_exit224:                               ; preds = %polly.loop_exit263, %polly.loop_exit208
  ...
  %indvars.iv.next1075 = add nsw i64 %indvars.iv1074, -28
  %indvars.iv.next1077 = add nuw nsw i64 %indvars.iv1076, 7
  %indvars.iv.next1081 = add nuw nsw i64 %indvars.iv1080, 28
  %exitcond1088.not = icmp eq i64 %polly.indvar_next204, 12
...
polly.loop_header222:                             ; preds = %polly.loop_exit208, %polly.loop_exit263
  ...
  %indvars.iv1082 = phi i64 [ %indvars.iv.next1083, %polly.loop_exit263 ], [ %106, %polly.loop_exit208 ]
  %indvars.iv1078 = phi i64 [ %indvars.iv.next1079, %polly.loop_exit263 ], [ %105, %polly.loop_exit208 ]
  %polly.indvar225 = phi i64 [ %polly.indvar_next226, %polly.loop_exit263 ], [ %113, %polly.loop_exit208 ]
  %115 = mul nsw i64 %indvar1387, -64
  %116 = add i64 %101, %115
  %smax1389 = call i64 @llvm.smax.i64(i64 %116, i64 0)
  %117 = shl nuw nsw i64 %indvar1387, 6
  %118 = add i64 %102, %117
  %119 = add i64 %smax1389, %118
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1078, i64 0)
  %120 = add i64 %smax, %indvars.iv1082
  %121 = shl nsw i64 %polly.indvar225, 6
  ...
  %129 = select i1 %128, i64 %109, i64 %127
  %polly.loop_guard250.not = icmp sgt i64 %126, %129
...
polly.loop_header235.us:                          ; preds = %polly.loop_header228.us, %polly.loop_header235.us
  ...
  %130 = add nuw nsw i64 %polly.indvar239.us, %108
  %polly.access.mul.call1243.us = mul nuw nsw i64 %130, 1000
  ...
  %exitcond1072.not = icmp eq i64 %polly.indvar239.us, %124
...
polly.loop_header247.us:                          ; preds = %polly.loop_exit237.loopexit.us, %polly.loop_header247.us
  ...
  %131 = add nuw nsw i64 %polly.indvar251.us, %108
  %polly.access.mul.call1255.us = mul nsw i64 %131, 1000
  ...
  %polly.loop_cond253.not.not.us = icmp slt i64 %polly.indvar251.us, %129
...
polly.loop_exit263:                               ; preds = %polly.loop_exit270, %polly.loop_header261.preheader
  ...
  %polly.loop_cond227 = icmp slt i64 %polly.indvar225, 18
  %indvars.iv.next1079 = add i64 %indvars.iv1078, -64
  %indvars.iv.next1083 = add i64 %indvars.iv1082, 64
...
polly.loop_header247:                             ; preds = %polly.loop_header228, %polly.loop_header247
  ...
  %139 = add nuw nsw i64 %polly.indvar251, %108
  %polly.access.mul.call1255 = mul nsw i64 %139, 1000
  ...
  %polly.loop_cond253.not.not = icmp slt i64 %polly.indvar251, %129
...
polly.loop_header268:                             ; preds = %polly.loop_header261, %polly.loop_exit278
  ...
  %indvars.iv1084 = phi i64 [ %120, %polly.loop_header261 ], [ %indvars.iv.next1085, %polly.loop_exit278 ]
  %polly.indvar272 = phi i64 [ %134, %polly.loop_header261 ], [ %polly.indvar_next273, %polly.loop_exit278 ]
  %140 = add i64 %119, %indvar1390
  %smin1392 = call i64 @llvm.smin.i64(i64 %140, i64 99)
  %141 = add nsw i64 %smin1392, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1084, i64 99)
  %142 = add nsw i64 %polly.indvar272, %122
  %polly.loop_guard2791180 = icmp sgt i64 %142, -1
...
polly.loop_header276.preheader:                   ; preds = %polly.loop_header268
  %143 = add nsw i64 %polly.indvar272, %121
  %polly.access.add.Packed_MemRef_call2288 = add nsw i64 %142, %polly.access.mul.Packed_MemRef_call1283
  ...
  %min.iters.check1393 = icmp ult i64 %141, 4
...
vector.body1386:                                  ; preds = %vector.body1386, %vector.ph1394
  ...
  %145 = add nuw nsw i64 %index1397, %108
  %146 = add nuw nsw i64 %index1397, %polly.access.mul.Packed_MemRef_call1283
  %147 = getelementptr double, double* %Packed_MemRef_call1, i64 %146
  %148 = bitcast double* %147 to <4 x double>*
  %wide.load1401 = load <4 x double>, <4 x double>* %148, align 8
  %149 = fmul fast <4 x double> %broadcast.splat1403, %wide.load1401
  %150 = getelementptr double, double* %Packed_MemRef_call2, i64 %146
  %151 = bitcast double* %150 to <4 x double>*
  %wide.load1404 = load <4 x double>, <4 x double>* %151, align 8
  %152 = fmul fast <4 x double> %broadcast.splat1406, %wide.load1404
  %153 = shl i64 %145, 3
  %154 = add i64 %153, %144
  %155 = getelementptr i8, i8* %call, i64 %154
  %156 = bitcast i8* %155 to <4 x double>*
  %wide.load1407 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !72, !noalias !74
  ...
  %159 = fadd fast <4 x double> %158, %wide.load1407
  ...
  %161 = icmp eq i64 %index.next1398, %n.vec1396
  br i1 %161, label %middle.block1384, label %vector.body1386, !llvm.loop !84

middle.block1384:                                 ; preds = %vector.body1386
  %cmp.n1400 = icmp eq i64 %141, %n.vec1396
...
polly.loop_exit278:                               ; preds = %polly.loop_header276, %middle.block1384, %polly.loop_header268
  ...
  %polly.loop_cond274.not.not = icmp slt i64 %polly.indvar272, %138
...
polly.loop_header276:                             ; preds = %polly.loop_header276.preheader1408, %polly.loop_header276
  ...
  %162 = add nuw nsw i64 %polly.indvar280, %108
  ...
  %163 = shl i64 %162, 3
  %164 = add i64 %163, %144
  %scevgep299 = getelementptr i8, i8* %call, i64 %164
...
polly.loop_header392:                             ; preds = %polly.loop_exit400, %polly.start304
  ...
  %165 = add i64 %indvar1323, 1
  %166 = mul nuw nsw i64 %polly.indvar395, 9600
  %scevgep404 = getelementptr i8, i8* %call, i64 %166
  %min.iters.check1325 = icmp ult i64 %165, 4
...
vector.body1322:                                  ; preds = %vector.body1322, %vector.ph1326
  ...
  %167 = shl nuw nsw i64 %index1329, 3
  %168 = getelementptr i8, i8* %scevgep404, i64 %167
  %169 = bitcast i8* %168 to <4 x double>*
  %wide.load1333 = load <4 x double>, <4 x double>* %169, align 8, !alias.scope !86, !noalias !88
  %170 = fmul fast <4 x double> %wide.load1333, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %172 = icmp eq i64 %index.next1330, %n.vec1328
  br i1 %172, label %middle.block1320, label %vector.body1322, !llvm.loop !93

middle.block1320:                                 ; preds = %vector.body1322
  %cmp.n1332 = icmp eq i64 %165, %n.vec1328
...
polly.loop_header398:                             ; preds = %polly.loop_header398.preheader, %polly.loop_header398
  ...
  %173 = shl nuw nsw i64 %polly.indvar401, 3
  %scevgep405 = getelementptr i8, i8* %scevgep404, i64 %173
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit434
  ...
  %indvars.iv1100 = phi i64 [ 15, %polly.loop_header408.preheader ], [ %indvars.iv.next1101, %polly.loop_exit434 ]
  ...
  %174 = mul nsw i64 %polly.indvar411, -28
  %175 = mul nuw nsw i64 %polly.indvar411, 28
  %176 = add nuw i64 %175, 60
  %177 = and i64 %176, -64
  %178 = add i64 %174, %177
  %179 = sub i64 %175, %177
  %180 = shl nuw nsw i64 %indvars.iv1100, 2
  %181 = and i64 %180, 9223372036854775744
  %182 = add i64 %indvars.iv1098, %181
  %183 = sub nsw i64 %indvars.iv1105, %181
  %184 = mul nsw i64 %polly.indvar411, -100
  %185 = mul nuw nsw i64 %polly.indvar411, 100
  br label %polly.loop_header414

polly.loop_exit416:                               ; preds = %polly.loop_exit422
  %186 = add nsw i64 %184, 1199
  %187 = shl nuw nsw i64 %polly.indvar411, 1
  %188 = mul nuw nsw i64 %polly.indvar411, 7
  %189 = add nuw nsw i64 %188, 15
  %pexp.p_div_q430 = lshr i64 %189, 4
  %190 = sub nsw i64 %187, %pexp.p_div_q430
  %polly.loop_guard435 = icmp slt i64 %190, 19
...
polly.loop_exit434:                               ; preds = %polly.loop_exit474, %polly.loop_exit416
  ...
  %indvars.iv.next1092 = add nsw i64 %indvars.iv1091, -100
  %indvars.iv.next1099 = add nsw i64 %indvars.iv1098, -28
  %indvars.iv.next1101 = add nuw nsw i64 %indvars.iv1100, 7
  %indvars.iv.next1106 = add nuw nsw i64 %indvars.iv1105, 28
  %exitcond1114.not = icmp eq i64 %polly.indvar_next412, 12
...
polly.loop_header420:                             ; preds = %polly.loop_header420, %polly.loop_header414
  ...
  %191 = add nuw nsw i64 %polly.indvar423, %185
  %polly.access.mul.call2427 = mul nuw nsw i64 %191, 1000
...
polly.loop_header432:                             ; preds = %polly.loop_exit416, %polly.loop_exit474
  ...
  %polly.indvar436 = phi i64 [ %polly.indvar_next437, %polly.loop_exit474 ], [ %190, %polly.loop_exit416 ]
  %192 = mul nsw i64 %indvar1337, -64
  %193 = add i64 %178, %192
  %smax1339 = call i64 @llvm.smax.i64(i64 %193, i64 0)
  %194 = shl nuw nsw i64 %indvar1337, 6
  %195 = add i64 %179, %194
  %196 = add i64 %smax1339, %195
  %smax1104 = call i64 @llvm.smax.i64(i64 %indvars.iv1102, i64 0)
  %197 = add i64 %smax1104, %indvars.iv1107
  %198 = shl nsw i64 %polly.indvar436, 6
  %199 = add nsw i64 %198, %184
  %200 = add nsw i64 %199, -1
  %.inv930 = icmp sgt i64 %199, 99
  %201 = select i1 %.inv930, i64 99, i64 %200
  %polly.loop_guard449 = icmp sgt i64 %201, -1
  %202 = icmp sgt i64 %199, 0
  %203 = select i1 %202, i64 %199, i64 0
  %204 = add nsw i64 %199, 63
  %205 = icmp slt i64 %186, %204
  %206 = select i1 %205, i64 %186, i64 %204
  %polly.loop_guard461.not = icmp sgt i64 %203, %206
...
polly.loop_header446.us:                          ; preds = %polly.loop_header439.us, %polly.loop_header446.us
  ...
  %207 = add nuw nsw i64 %polly.indvar450.us, %185
  %polly.access.mul.call1454.us = mul nuw nsw i64 %207, 1000
  ...
  %exitcond1096.not = icmp eq i64 %polly.indvar450.us, %201
...
polly.loop_header458.us:                          ; preds = %polly.loop_exit448.loopexit.us, %polly.loop_header458.us
  %polly.indvar462.us = phi i64 [ %polly.indvar_next463.us, %polly.loop_header458.us ], [ %203, %polly.loop_exit448.loopexit.us ]
  %208 = add nuw nsw i64 %polly.indvar462.us, %185
  %polly.access.mul.call1466.us = mul nsw i64 %208, 1000
  ...
  %polly.loop_cond464.not.not.us = icmp slt i64 %polly.indvar462.us, %206
...
polly.loop_exit474:                               ; preds = %polly.loop_exit481, %polly.loop_header472.preheader
  ...
  %polly.loop_cond438 = icmp slt i64 %polly.indvar436, 18
  %indvars.iv.next1103 = add i64 %indvars.iv1102, -64
  %indvars.iv.next1108 = add i64 %indvars.iv1107, 64
...
polly.loop_header458:                             ; preds = %polly.loop_header439, %polly.loop_header458
  %polly.indvar462 = phi i64 [ %polly.indvar_next463, %polly.loop_header458 ], [ %203, %polly.loop_header439 ]
  %216 = add nuw nsw i64 %polly.indvar462, %185
  %polly.access.mul.call1466 = mul nsw i64 %216, 1000
  ...
  %polly.loop_cond464.not.not = icmp slt i64 %polly.indvar462, %206
...
polly.loop_header479:                             ; preds = %polly.loop_header472, %polly.loop_exit489
  ...
  %indvars.iv1109 = phi i64 [ %197, %polly.loop_header472 ], [ %indvars.iv.next1110, %polly.loop_exit489 ]
  %polly.indvar483 = phi i64 [ %211, %polly.loop_header472 ], [ %polly.indvar_next484, %polly.loop_exit489 ]
  %217 = add i64 %196, %indvar1340
  %smin1342 = call i64 @llvm.smin.i64(i64 %217, i64 99)
  %218 = add nsw i64 %smin1342, 1
  %smin1111 = call i64 @llvm.smin.i64(i64 %indvars.iv1109, i64 99)
  %219 = add nsw i64 %polly.indvar483, %199
  %polly.loop_guard4901181 = icmp sgt i64 %219, -1
...
polly.loop_header487.preheader:                   ; preds = %polly.loop_header479
  %220 = add nsw i64 %polly.indvar483, %198
  %polly.access.add.Packed_MemRef_call2309499 = add nsw i64 %219, %polly.access.mul.Packed_MemRef_call1307494
  ...
  %min.iters.check1343 = icmp ult i64 %218, 4
...
vector.body1336:                                  ; preds = %vector.body1336, %vector.ph1344
  ...
  %222 = add nuw nsw i64 %index1347, %185
  %223 = add nuw nsw i64 %index1347, %polly.access.mul.Packed_MemRef_call1307494
  %224 = getelementptr double, double* %Packed_MemRef_call1307, i64 %223
  %225 = bitcast double* %224 to <4 x double>*
  %wide.load1351 = load <4 x double>, <4 x double>* %225, align 8
  %226 = fmul fast <4 x double> %broadcast.splat1353, %wide.load1351
  %227 = getelementptr double, double* %Packed_MemRef_call2309, i64 %223
  %228 = bitcast double* %227 to <4 x double>*
  %wide.load1354 = load <4 x double>, <4 x double>* %228, align 8
  %229 = fmul fast <4 x double> %broadcast.splat1356, %wide.load1354
  %230 = shl i64 %222, 3
  %231 = add i64 %230, %221
  %232 = getelementptr i8, i8* %call, i64 %231
  %233 = bitcast i8* %232 to <4 x double>*
  %wide.load1357 = load <4 x double>, <4 x double>* %233, align 8, !alias.scope !86, !noalias !88
  ...
  %236 = fadd fast <4 x double> %235, %wide.load1357
  ...
  %238 = icmp eq i64 %index.next1348, %n.vec1346
  br i1 %238, label %middle.block1334, label %vector.body1336, !llvm.loop !97

middle.block1334:                                 ; preds = %vector.body1336
  %cmp.n1350 = icmp eq i64 %218, %n.vec1346
...
polly.loop_exit489:                               ; preds = %polly.loop_header487, %middle.block1334, %polly.loop_header479
  ...
  %polly.loop_cond485.not.not = icmp slt i64 %polly.indvar483, %215
...
polly.loop_header487:                             ; preds = %polly.loop_header487.preheader1412, %polly.loop_header487
  ...
  %239 = add nuw nsw i64 %polly.indvar491, %185
  ...
  %240 = shl i64 %239, 3
  %241 = add i64 %240, %221
  %scevgep510 = getelementptr i8, i8* %call, i64 %241
...
polly.loop_header603:                             ; preds = %polly.loop_exit611, %polly.start515
  ...
  %243 = mul nuw nsw i64 %polly.indvar606, 9600
  %scevgep615 = getelementptr i8, i8* %call, i64 %243
  %min.iters.check1275 = icmp ult i64 %242, 4
...
vector.body1274:                                  ; preds = %vector.body1274, %vector.ph1276
  ...
  %244 = shl nuw nsw i64 %index1279, 3
  %245 = getelementptr i8, i8* %scevgep615, i64 %244
  %246 = bitcast i8* %245 to <4 x double>*
  %wide.load1283 = load <4 x double>, <4 x double>* %246, align 8, !alias.scope !99, !noalias !101
  %247 = fmul fast <4 x double> %wide.load1283, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %249 = icmp eq i64 %index.next1280, %n.vec1278
  br i1 %249, label %middle.block1272, label %vector.body1274, !llvm.loop !106

middle.block1272:                                 ; preds = %vector.body1274
  %cmp.n1282 = icmp eq i64 %242, %n.vec1278
...
polly.loop_header609:                             ; preds = %polly.loop_header609.preheader, %polly.loop_header609
  ...
  %250 = shl nuw nsw i64 %polly.indvar612, 3
  %scevgep616 = getelementptr i8, i8* %scevgep615, i64 %250
...
polly.loop_header619:                             ; preds = %polly.loop_header619.preheader, %polly.loop_exit645
  ...
  %indvars.iv1126 = phi i64 [ 15, %polly.loop_header619.preheader ], [ %indvars.iv.next1127, %polly.loop_exit645 ]
  ...
  %251 = mul nsw i64 %polly.indvar622, -28
  %252 = mul nuw nsw i64 %polly.indvar622, 28
  %253 = add nuw i64 %252, 60
  %254 = and i64 %253, -64
  %255 = add i64 %251, %254
  %256 = sub i64 %252, %254
  %257 = shl nuw nsw i64 %indvars.iv1126, 2
  %258 = and i64 %257, 9223372036854775744
  %259 = add i64 %indvars.iv1124, %258
  %260 = sub nsw i64 %indvars.iv1131, %258
  %261 = mul nsw i64 %polly.indvar622, -100
  %262 = mul nuw nsw i64 %polly.indvar622, 100
  br label %polly.loop_header625

polly.loop_exit627:                               ; preds = %polly.loop_exit633
  %263 = add nsw i64 %261, 1199
  %264 = shl nuw nsw i64 %polly.indvar622, 1
  %265 = mul nuw nsw i64 %polly.indvar622, 7
  %266 = add nuw nsw i64 %265, 15
  %pexp.p_div_q641 = lshr i64 %266, 4
  %267 = sub nsw i64 %264, %pexp.p_div_q641
  %polly.loop_guard646 = icmp slt i64 %267, 19
...
polly.loop_exit645:                               ; preds = %polly.loop_exit685, %polly.loop_exit627
  ...
  %indvars.iv.next1118 = add nsw i64 %indvars.iv1117, -100
  %indvars.iv.next1125 = add nsw i64 %indvars.iv1124, -28
  %indvars.iv.next1127 = add nuw nsw i64 %indvars.iv1126, 7
  %indvars.iv.next1132 = add nuw nsw i64 %indvars.iv1131, 28
  %exitcond1140.not = icmp eq i64 %polly.indvar_next623, 12
...
polly.loop_header631:                             ; preds = %polly.loop_header631, %polly.loop_header625
  ...
  %268 = add nuw nsw i64 %polly.indvar634, %262
  %polly.access.mul.call2638 = mul nuw nsw i64 %268, 1000
...
polly.loop_header643:                             ; preds = %polly.loop_exit627, %polly.loop_exit685
  ...
  %indvars.iv1133 = phi i64 [ %indvars.iv.next1134, %polly.loop_exit685 ], [ %260, %polly.loop_exit627 ]
  %indvars.iv1128 = phi i64 [ %indvars.iv.next1129, %polly.loop_exit685 ], [ %259, %polly.loop_exit627 ]
  %polly.indvar647 = phi i64 [ %polly.indvar_next648, %polly.loop_exit685 ], [ %267, %polly.loop_exit627 ]
  %269 = mul nsw i64 %indvar1287, -64
  %270 = add i64 %255, %269
  %smax1289 = call i64 @llvm.smax.i64(i64 %270, i64 0)
  %271 = shl nuw nsw i64 %indvar1287, 6
  %272 = add i64 %256, %271
  %273 = add i64 %smax1289, %272
  %smax1130 = call i64 @llvm.smax.i64(i64 %indvars.iv1128, i64 0)
  %274 = add i64 %smax1130, %indvars.iv1133
  %275 = shl nsw i64 %polly.indvar647, 6
  %276 = add nsw i64 %275, %261
  %277 = add nsw i64 %276, -1
  %.inv931 = icmp sgt i64 %276, 99
  %278 = select i1 %.inv931, i64 99, i64 %277
  %polly.loop_guard660 = icmp sgt i64 %278, -1
  %279 = icmp sgt i64 %276, 0
  %280 = select i1 %279, i64 %276, i64 0
  %281 = add nsw i64 %276, 63
  %282 = icmp slt i64 %263, %281
  %283 = select i1 %282, i64 %263, i64 %281
  %polly.loop_guard672.not = icmp sgt i64 %280, %283
...
polly.loop_header657.us:                          ; preds = %polly.loop_header650.us, %polly.loop_header657.us
  ...
  %284 = add nuw nsw i64 %polly.indvar661.us, %262
  %polly.access.mul.call1665.us = mul nuw nsw i64 %284, 1000
  ...
  %exitcond1122.not = icmp eq i64 %polly.indvar661.us, %278
...
polly.loop_header669.us:                          ; preds = %polly.loop_exit659.loopexit.us, %polly.loop_header669.us
  %polly.indvar673.us = phi i64 [ %polly.indvar_next674.us, %polly.loop_header669.us ], [ %280, %polly.loop_exit659.loopexit.us ]
  %285 = add nuw nsw i64 %polly.indvar673.us, %262
  %polly.access.mul.call1677.us = mul nsw i64 %285, 1000
  ...
  %polly.loop_cond675.not.not.us = icmp slt i64 %polly.indvar673.us, %283
...
polly.loop_exit685:                               ; preds = %polly.loop_exit692, %polly.loop_header683.preheader
  ...
  %polly.loop_cond649 = icmp slt i64 %polly.indvar647, 18
...
polly.loop_header669:                             ; preds = %polly.loop_header650, %polly.loop_header669
  %polly.indvar673 = phi i64 [ %polly.indvar_next674, %polly.loop_header669 ], [ %280, %polly.loop_header650 ]
  %293 = add nuw nsw i64 %polly.indvar673, %262
  %polly.access.mul.call1677 = mul nsw i64 %293, 1000
  ...
  %polly.loop_cond675.not.not = icmp slt i64 %polly.indvar673, %283
...
polly.loop_header690:                             ; preds = %polly.loop_header683, %polly.loop_exit700
  ...
  %indvars.iv1135 = phi i64 [ %274, %polly.loop_header683 ], [ %indvars.iv.next1136, %polly.loop_exit700 ]
  %polly.indvar694 = phi i64 [ %288, %polly.loop_header683 ], [ %polly.indvar_next695, %polly.loop_exit700 ]
  %294 = add i64 %273, %indvar1290
  %smin1292 = call i64 @llvm.smin.i64(i64 %294, i64 99)
  %295 = add nsw i64 %smin1292, 1
  %smin1137 = call i64 @llvm.smin.i64(i64 %indvars.iv1135, i64 99)
  %296 = add nsw i64 %polly.indvar694, %276
  %polly.loop_guard7011182 = icmp sgt i64 %296, -1
...
polly.loop_header698.preheader:                   ; preds = %polly.loop_header690
  %297 = add nsw i64 %polly.indvar694, %275
  %polly.access.add.Packed_MemRef_call2520710 = add nsw i64 %296, %polly.access.mul.Packed_MemRef_call1518705
  ...
  %min.iters.check1293 = icmp ult i64 %295, 4
...
vector.body1286:                                  ; preds = %vector.body1286, %vector.ph1294
  ...
  %299 = add nuw nsw i64 %index1297, %262
  %300 = add nuw nsw i64 %index1297, %polly.access.mul.Packed_MemRef_call1518705
  %301 = getelementptr double, double* %Packed_MemRef_call1518, i64 %300
  %302 = bitcast double* %301 to <4 x double>*
  %wide.load1301 = load <4 x double>, <4 x double>* %302, align 8
  %303 = fmul fast <4 x double> %broadcast.splat1303, %wide.load1301
  %304 = getelementptr double, double* %Packed_MemRef_call2520, i64 %300
  %305 = bitcast double* %304 to <4 x double>*
  %wide.load1304 = load <4 x double>, <4 x double>* %305, align 8
  %306 = fmul fast <4 x double> %broadcast.splat1306, %wide.load1304
  %307 = shl i64 %299, 3
  %308 = add i64 %307, %298
  %309 = getelementptr i8, i8* %call, i64 %308
  %310 = bitcast i8* %309 to <4 x double>*
  %wide.load1307 = load <4 x double>, <4 x double>* %310, align 8, !alias.scope !99, !noalias !101
  ...
  %313 = fadd fast <4 x double> %312, %wide.load1307
  ...
  %315 = icmp eq i64 %index.next1298, %n.vec1296
  br i1 %315, label %middle.block1284, label %vector.body1286, !llvm.loop !110

middle.block1284:                                 ; preds = %vector.body1286
  %cmp.n1300 = icmp eq i64 %295, %n.vec1296
...
polly.loop_exit700:                               ; preds = %polly.loop_header698, %middle.block1284, %polly.loop_header690
  ...
  %polly.loop_cond696.not.not = icmp slt i64 %polly.indvar694, %292
...
polly.loop_header698:                             ; preds = %polly.loop_header698.preheader1416, %polly.loop_header698
  ...
  %316 = add nuw nsw i64 %polly.indvar702, %262
  ...
  %317 = shl i64 %316, 3
  %318 = add i64 %317, %298
  %scevgep721 = getelementptr i8, i8* %call, i64 %318
...
polly.loop_header856:                             ; preds = %polly.loop_exit864, %polly.loop_header850
  ...
  %smin1213 = call i64 @llvm.smin.i64(i64 %321, i64 -1168)
  %322 = add nsw i64 %smin1213, 1200
  %smin1165 = call i64 @llvm.smin.i64(i64 %indvars.iv1163, i64 -1168)
  %323 = shl nsw i64 %polly.indvar859, 5
  %324 = add nsw i64 %smin1165, 1199
...
vector.ph1214:                                    ; preds = %polly.loop_header862
  %broadcast.splatinsert1221 = insertelement <4 x i64> poison, i64 %323, i32 0
  %broadcast.splat1222 = shufflevector <4 x i64> %broadcast.splatinsert1221, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1223 = insertelement <4 x i32> poison, i32 %326, i32 0
...
vector.body1212:                                  ; preds = %vector.body1212, %vector.ph1214
  ...
  %328 = add nuw nsw <4 x i64> %vec.ind1219, %broadcast.splat1222
  %329 = trunc <4 x i64> %328 to <4 x i32>
  %330 = mul <4 x i32> %broadcast.splat1224, %329
  ...
  %340 = icmp eq i64 %index.next1216, %322
  br i1 %340, label %polly.loop_exit870, label %vector.body1212, !llvm.loop !117

polly.loop_exit870:                               ; preds = %vector.body1212, %polly.loop_header868
  %polly.indvar_next866 = add nuw nsw i64 %polly.indvar865, 1
  %exitcond1170.not = icmp eq i64 %polly.indvar865, %320
...
polly.loop_header868:                             ; preds = %polly.loop_header862, %polly.loop_header868
  ...
  %exitcond1166.not = icmp eq i64 %polly.indvar871, %324
...
polly.loop_header883:                             ; preds = %polly.loop_exit891, %polly.loop_header877
  ...
  %smin1228 = call i64 @llvm.smin.i64(i64 %350, i64 -968)
  %351 = add nsw i64 %smin1228, 1000
  %smin1155 = call i64 @llvm.smin.i64(i64 %indvars.iv1153, i64 -968)
  %352 = shl nsw i64 %polly.indvar886, 5
  %353 = add nsw i64 %smin1155, 999
...
vector.body1227:                                  ; preds = %vector.body1227, %vector.ph1230
  ...
  %357 = add nuw nsw <4 x i64> %vec.ind1237, %broadcast.splat1240
  %358 = trunc <4 x i64> %357 to <4 x i32>
  %359 = mul <4 x i32> %broadcast.splat1242, %358
  ...
  %369 = icmp eq i64 %index.next1234, %351
  br i1 %369, label %polly.loop_exit897, label %vector.body1227, !llvm.loop !120

polly.loop_exit897:                               ; preds = %vector.body1227, %polly.loop_header895
  %polly.indvar_next893 = add nuw nsw i64 %polly.indvar892, 1
  %exitcond1160.not = icmp eq i64 %polly.indvar892, %349
...
polly.loop_header895:                             ; preds = %polly.loop_header889, %polly.loop_header895
  ...
  %exitcond1156.not = icmp eq i64 %polly.indvar898, %353
...
polly.loop_header909:                             ; preds = %polly.loop_exit917, %polly.loop_header903
  ...
  %smin1246 = call i64 @llvm.smin.i64(i64 %379, i64 -968)
  %380 = add nsw i64 %smin1246, 1000
  %smin1145 = call i64 @llvm.smin.i64(i64 %indvars.iv1143, i64 -968)
  %381 = shl nsw i64 %polly.indvar912, 5
  %382 = add nsw i64 %smin1145, 999
...
vector.body1245:                                  ; preds = %vector.body1245, %vector.ph1248
  ...
  %386 = add nuw nsw <4 x i64> %vec.ind1255, %broadcast.splat1258
  %387 = trunc <4 x i64> %386 to <4 x i32>
  %388 = mul <4 x i32> %broadcast.splat1260, %387
  ...
  %398 = icmp eq i64 %index.next1252, %380
  br i1 %398, label %polly.loop_exit923, label %vector.body1245, !llvm.loop !123

polly.loop_exit923:                               ; preds = %vector.body1245, %polly.loop_header921
  %polly.indvar_next919 = add nuw nsw i64 %polly.indvar918, 1
  %exitcond1150.not = icmp eq i64 %polly.indvar918, %378
...
polly.loop_header921:                             ; preds = %polly.loop_header915, %polly.loop_header921
  ...
  %exitcond1146.not = icmp eq i64 %polly.indvar924, %382
