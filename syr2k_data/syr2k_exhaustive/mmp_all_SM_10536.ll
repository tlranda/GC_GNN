; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10536.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10536.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin784 = call i64 @llvm.smin.i64(i64 %indvars.iv782, i64 -1072)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next783 = add nsw i64 %indvars.iv782, -128
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225
  ...
  %indvars.iv.next778 = add nsw i64 %indvars.iv777, -128
...
polly.loop_header217:                             ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %polly.loop_guard867 = icmp sgt i64 %108, -1
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph986
  ...
  %121 = shl nuw nsw i64 %index989, 3
  %122 = getelementptr i8, i8* %scevgep348, i64 %121
  %123 = bitcast i8* %122 to <4 x double>*
  %wide.load993 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !68, !noalias !70
  %124 = fmul fast <4 x double> %wide.load993, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %126 = icmp eq i64 %index.next990, %n.vec988
  br i1 %126, label %middle.block980, label %vector.body982, !llvm.loop !73

middle.block980:                                  ; preds = %vector.body982
  %cmp.n992 = icmp eq i64 %119, %n.vec988
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %128 = shl nsw i64 %polly.indvar355, 7
  %129 = add nsw i64 %smin804, 1199
  br label %polly.loop_header358

polly.loop_exit360:                               ; preds = %polly.loop_exit366
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next794 = add nuw nsw i64 %indvars.iv793, 128
  %indvars.iv.next803 = add nsw i64 %indvars.iv802, -128
  %indvars.iv.next807 = add nuw nsw i64 %indvars.iv806, 1
  %exitcond810.not = icmp eq i64 %polly.indvar_next356, 10
...
polly.loop_exit366:                               ; preds = %polly.loop_exit372
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next362, 250
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %137 = shl nsw i64 %polly.indvar367, 7
...
polly.loop_header370:                             ; preds = %polly.loop_exit378, %polly.loop_header364
  ...
  %139 = add nsw i64 %polly.indvar373, %138
  %polly.loop_guard386868 = icmp sgt i64 %139, -1
  %140 = add nuw nsw i64 %polly.indvar373, %128
...
polly.loop_header376.us.preheader:                ; preds = %polly.loop_header370
  ...
  %scevgep393.us = getelementptr i8, i8* %call2, i64 %143
  ...
  %scevgep399.us = getelementptr i8, i8* %call1, i64 %143
...
polly.loop_header383.us:                          ; preds = %polly.loop_header376.us.preheader, %polly.loop_header383.us
  ...
  %144 = add nuw nsw i64 %polly.indvar387.us, %137
  %145 = mul nuw nsw i64 %144, 8000
  %146 = add nuw nsw i64 %145, %131
  %scevgep390.us = getelementptr i8, i8* %call1, i64 %146
  ...
  %scevgep396.us = getelementptr i8, i8* %call2, i64 %146
  ...
  %scevgep402.us = getelementptr i8, i8* %call, i64 %148
...
polly.loop_exit385.loopexit.us:                   ; preds = %polly.loop_header383.us
  ...
  %scevgep393.us.1 = getelementptr i8, i8* %call2, i64 %149
  ...
  %scevgep399.us.1 = getelementptr i8, i8* %call1, i64 %149
...
polly.loop_exit378:                               ; preds = %polly.loop_header383.us.3, %polly.loop_header370
  ...
  %exitcond805.not = icmp eq i64 %polly.indvar373, %129
...
vector.body958:                                   ; preds = %vector.body958, %vector.ph960
  ...
  %152 = shl nuw nsw i64 %index963, 3
  %153 = getelementptr i8, i8* %scevgep503, i64 %152
  %154 = bitcast i8* %153 to <4 x double>*
  %wide.load967 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !77, !noalias !79
  %155 = fmul fast <4 x double> %wide.load967, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %157 = icmp eq i64 %index.next964, %n.vec962
  br i1 %157, label %middle.block956, label %vector.body958, !llvm.loop !82

middle.block956:                                  ; preds = %vector.body958
  %cmp.n966 = icmp eq i64 %150, %n.vec962
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %159 = shl nsw i64 %polly.indvar510, 7
  %160 = add nsw i64 %smin824, 1199
...
polly.loop_exit515:                               ; preds = %polly.loop_exit521
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar_next511, 10
...
polly.loop_header513:                             ; preds = %polly.loop_exit521, %polly.loop_header507
  ...
  %161 = shl i64 %polly.indvar516, 5
  %162 = shl i64 %polly.indvar516, 5
  %163 = shl i64 %polly.indvar516, 5
  %164 = or i64 %163, 8
  %165 = shl i64 %polly.indvar516, 5
  %166 = or i64 %165, 16
  %167 = or i64 %161, 24
...
polly.loop_exit521:                               ; preds = %polly.loop_exit527
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next517, 250
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %168 = shl nsw i64 %polly.indvar522, 7
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header519
  ...
  %170 = add nsw i64 %polly.indvar528, %169
  %polly.loop_guard541869 = icmp sgt i64 %170, -1
  %171 = add nuw nsw i64 %polly.indvar528, %159
...
polly.loop_header531.us.preheader:                ; preds = %polly.loop_header525
  ...
  %scevgep548.us = getelementptr i8, i8* %call2, i64 %174
  ...
  %scevgep554.us = getelementptr i8, i8* %call1, i64 %174
...
polly.loop_header538.us:                          ; preds = %polly.loop_header531.us.preheader, %polly.loop_header538.us
  ...
  %175 = add nuw nsw i64 %polly.indvar542.us, %168
  %176 = mul nuw nsw i64 %175, 8000
  %177 = add nuw nsw i64 %176, %162
  %scevgep545.us = getelementptr i8, i8* %call1, i64 %177
  ...
  %scevgep551.us = getelementptr i8, i8* %call2, i64 %177
  ...
  %scevgep557.us = getelementptr i8, i8* %call, i64 %179
...
polly.loop_exit540.loopexit.us:                   ; preds = %polly.loop_header538.us
  ...
  %scevgep548.us.1 = getelementptr i8, i8* %call2, i64 %180
  ...
  %scevgep554.us.1 = getelementptr i8, i8* %call1, i64 %180
...
polly.loop_exit533:                               ; preds = %polly.loop_header538.us.3, %polly.loop_header525
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar528, %160
...
polly.loop_header692:                             ; preds = %polly.loop_exit700, %polly.loop_header686
  ...
  %smin897 = call i64 @llvm.smin.i64(i64 %183, i64 -1168)
  %184 = add nsw i64 %smin897, 1200
...
vector.ph898:                                     ; preds = %polly.loop_header698
  %broadcast.splatinsert905 = insertelement <4 x i64> poison, i64 %185, i32 0
  %broadcast.splat906 = shufflevector <4 x i64> %broadcast.splatinsert905, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert907 = insertelement <4 x i32> poison, i32 %188, i32 0
...
vector.body896:                                   ; preds = %vector.body896, %vector.ph898
  ...
  %190 = add nuw nsw <4 x i64> %vec.ind903, %broadcast.splat906
  %191 = trunc <4 x i64> %190 to <4 x i32>
  %192 = mul <4 x i32> %broadcast.splat908, %191
  ...
  %202 = icmp eq i64 %index.next900, %184
  br i1 %202, label %polly.loop_exit706, label %vector.body896, !llvm.loop !91

polly.loop_exit706:                               ; preds = %vector.body896, %polly.loop_header704
  %polly.indvar_next702 = add nuw nsw i64 %polly.indvar701, 1
  %exitcond860.not = icmp eq i64 %polly.indvar701, %182
...
polly.loop_header704:                             ; preds = %polly.loop_header698, %polly.loop_header704
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar707, %186
...
polly.loop_header719:                             ; preds = %polly.loop_exit727, %polly.loop_header713
  ...
  %smin912 = call i64 @llvm.smin.i64(i64 %212, i64 -968)
  %213 = add nsw i64 %smin912, 1000
...
vector.body911:                                   ; preds = %vector.body911, %vector.ph914
  ...
  %219 = add nuw nsw <4 x i64> %vec.ind921, %broadcast.splat924
  %220 = trunc <4 x i64> %219 to <4 x i32>
  %221 = mul <4 x i32> %broadcast.splat926, %220
  ...
  %231 = icmp eq i64 %index.next918, %213
  br i1 %231, label %polly.loop_exit733, label %vector.body911, !llvm.loop !94

polly.loop_exit733:                               ; preds = %vector.body911, %polly.loop_header731
  %polly.indvar_next729 = add nuw nsw i64 %polly.indvar728, 1
  %exitcond850.not = icmp eq i64 %polly.indvar728, %211
...
polly.loop_header731:                             ; preds = %polly.loop_header725, %polly.loop_header731
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar734, %215
...
polly.loop_header745:                             ; preds = %polly.loop_exit753, %polly.loop_header739
  ...
  %smin930 = call i64 @llvm.smin.i64(i64 %241, i64 -968)
  %242 = add nsw i64 %smin930, 1000
...
vector.body929:                                   ; preds = %vector.body929, %vector.ph932
  ...
  %248 = add nuw nsw <4 x i64> %vec.ind939, %broadcast.splat942
  %249 = trunc <4 x i64> %248 to <4 x i32>
  %250 = mul <4 x i32> %broadcast.splat944, %249
  ...
  %260 = icmp eq i64 %index.next936, %242
  br i1 %260, label %polly.loop_exit759, label %vector.body929, !llvm.loop !97

polly.loop_exit759:                               ; preds = %vector.body929, %polly.loop_header757
  %polly.indvar_next755 = add nuw nsw i64 %polly.indvar754, 1
  %exitcond840.not = icmp eq i64 %polly.indvar754, %240
...
polly.loop_header757:                             ; preds = %polly.loop_header751, %polly.loop_header757
  ...
  %exitcond836.not = icmp eq i64 %polly.indvar760, %244
...
polly.loop_header383.us.1:                        ; preds = %polly.loop_header383.us.1, %polly.loop_exit385.loopexit.us
  ...
  %285 = add nuw nsw i64 %polly.indvar387.us.1, %137
  %286 = mul nuw nsw i64 %285, 8000
  %287 = add nuw nsw i64 %286, %133
  %scevgep390.us.1 = getelementptr i8, i8* %call1, i64 %287
  ...
  %scevgep396.us.1 = getelementptr i8, i8* %call2, i64 %287
  ...
  %scevgep402.us.1 = getelementptr i8, i8* %call, i64 %289
...
polly.loop_exit385.loopexit.us.1:                 ; preds = %polly.loop_header383.us.1
  ...
  %scevgep393.us.2 = getelementptr i8, i8* %call2, i64 %290
  ...
  %scevgep399.us.2 = getelementptr i8, i8* %call1, i64 %290
...
polly.loop_header383.us.2:                        ; preds = %polly.loop_header383.us.2, %polly.loop_exit385.loopexit.us.1
  ...
  %291 = add nuw nsw i64 %polly.indvar387.us.2, %137
  %292 = mul nuw nsw i64 %291, 8000
  %293 = add nuw nsw i64 %292, %135
  %scevgep390.us.2 = getelementptr i8, i8* %call1, i64 %293
  ...
  %scevgep396.us.2 = getelementptr i8, i8* %call2, i64 %293
  ...
  %scevgep402.us.2 = getelementptr i8, i8* %call, i64 %295
...
polly.loop_exit385.loopexit.us.2:                 ; preds = %polly.loop_header383.us.2
  ...
  %scevgep393.us.3 = getelementptr i8, i8* %call2, i64 %296
  ...
  %scevgep399.us.3 = getelementptr i8, i8* %call1, i64 %296
...
polly.loop_header383.us.3:                        ; preds = %polly.loop_header383.us.3, %polly.loop_exit385.loopexit.us.2
  ...
  %297 = add nuw nsw i64 %polly.indvar387.us.3, %137
  %298 = mul nuw nsw i64 %297, 8000
  %299 = add nuw nsw i64 %298, %136
  %scevgep390.us.3 = getelementptr i8, i8* %call1, i64 %299
  ...
  %scevgep396.us.3 = getelementptr i8, i8* %call2, i64 %299
  ...
  %scevgep402.us.3 = getelementptr i8, i8* %call, i64 %301
  ...
  br i1 %exitcond800.3.not, label %polly.loop_exit378, label %polly.loop_header383.us.3
...
polly.loop_header538.us.1:                        ; preds = %polly.loop_header538.us.1, %polly.loop_exit540.loopexit.us
  ...
  %302 = add nuw nsw i64 %polly.indvar542.us.1, %168
  %303 = mul nuw nsw i64 %302, 8000
  %304 = add nuw nsw i64 %303, %164
  %scevgep545.us.1 = getelementptr i8, i8* %call1, i64 %304
  ...
  %scevgep551.us.1 = getelementptr i8, i8* %call2, i64 %304
  ...
  %scevgep557.us.1 = getelementptr i8, i8* %call, i64 %306
...
polly.loop_exit540.loopexit.us.1:                 ; preds = %polly.loop_header538.us.1
  ...
  %scevgep548.us.2 = getelementptr i8, i8* %call2, i64 %307
  ...
  %scevgep554.us.2 = getelementptr i8, i8* %call1, i64 %307
...
polly.loop_header538.us.2:                        ; preds = %polly.loop_header538.us.2, %polly.loop_exit540.loopexit.us.1
  ...
  %308 = add nuw nsw i64 %polly.indvar542.us.2, %168
  %309 = mul nuw nsw i64 %308, 8000
  %310 = add nuw nsw i64 %309, %166
  %scevgep545.us.2 = getelementptr i8, i8* %call1, i64 %310
  ...
  %scevgep551.us.2 = getelementptr i8, i8* %call2, i64 %310
  ...
  %scevgep557.us.2 = getelementptr i8, i8* %call, i64 %312
...
polly.loop_exit540.loopexit.us.2:                 ; preds = %polly.loop_header538.us.2
  ...
  %scevgep548.us.3 = getelementptr i8, i8* %call2, i64 %313
  ...
  %scevgep554.us.3 = getelementptr i8, i8* %call1, i64 %313
...
polly.loop_header538.us.3:                        ; preds = %polly.loop_header538.us.3, %polly.loop_exit540.loopexit.us.2
  ...
  %314 = add nuw nsw i64 %polly.indvar542.us.3, %168
  %315 = mul nuw nsw i64 %314, 8000
  %316 = add nuw nsw i64 %315, %167
  %scevgep545.us.3 = getelementptr i8, i8* %call1, i64 %316
  ...
  %scevgep551.us.3 = getelementptr i8, i8* %call2, i64 %316
  ...
  %scevgep557.us.3 = getelementptr i8, i8* %call, i64 %318
  ...
  br i1 %exitcond820.3.not, label %polly.loop_exit533, label %polly.loop_header538.us.3
}
