; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7626.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7626.c"
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %139 = udiv i64 %indvars.iv874, 5
  %140 = sub nsw i64 %indvars.iv872, %139
  %smin876 = call i64 @llvm.smin.i64(i64 %140, i64 54)
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %181 = udiv i64 %indvars.iv900, 5
  %182 = sub nsw i64 %indvars.iv898, %181
  %smin902 = call i64 @llvm.smin.i64(i64 %182, i64 54)
