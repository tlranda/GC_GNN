; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7763.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7763.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv846 = phi i64 [ %indvars.iv.next847, %polly.loop_exit223 ], [ 24, %polly.loop_exit207 ]
  %indvars.iv839 = phi i64 [ %indvars.iv.next840, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %polly.indvar218 = phi i64 [ %polly.indvar_next219, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %97 = lshr i64 %indvars.iv846, 6
  %98 = mul nsw i64 %polly.indvar218, -100
  %99 = mul nuw nsw i64 %polly.indvar218, 100
  br label %polly.loop_header221

polly.loop_exit223:                               ; preds = %polly.loop_exit229
  %polly.indvar_next219 = add nuw nsw i64 %polly.indvar218, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -100
  %indvars.iv.next840 = add nuw nsw i64 %indvars.iv839, 100
  %indvars.iv.next847 = add nuw nsw i64 %indvars.iv846, 25
  %exitcond850.not = icmp eq i64 %polly.indvar_next219, 12
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %polly.loop_guard = icmp slt i64 %119, 100
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %indvars.iv.next838 = add nsw i64 %indvars.iv837, 256
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 255)
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1045
  ...
  %wide.load1052 = load <4 x double>, <4 x double>* %137, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %140, label %middle.block1039, label %vector.body1041, !llvm.loop !80
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv869 = phi i64 [ %indvars.iv.next870, %polly.loop_exit398 ], [ 24, %polly.loop_exit382 ]
  ...
  %142 = lshr i64 %indvars.iv869, 6
  %143 = mul nsw i64 %polly.indvar393, -100
  %144 = mul nuw nsw i64 %polly.indvar393, 100
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit405
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next856 = add nsw i64 %indvars.iv855, -100
  %indvars.iv.next861 = add nuw nsw i64 %indvars.iv860, 100
  %indvars.iv.next870 = add nuw nsw i64 %indvars.iv869, 25
  %exitcond873.not = icmp eq i64 %polly.indvar_next394, 12
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %161 = shl nsw i64 %polly.indvar406, 8
  %162 = add nsw i64 %161, %143
  %163 = icmp sgt i64 %162, 0
  %164 = select i1 %163, i64 %162, i64 0
  %polly.loop_guard413 = icmp slt i64 %164, 100
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %indvars.iv.next858 = add nsw i64 %indvars.iv857, 256
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -256
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  ...
  %smin866 = call i64 @llvm.smin.i64(i64 %indvars.iv864, i64 255)
...
polly.loop_exit419:                               ; preds = %polly.loop_header424.us.7, %polly.loop_header410
  ...
  %polly.loop_cond416 = icmp ult i64 %polly.indvar414, 99
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  %wide.load1026 = load <4 x double>, <4 x double>* %182, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %185, label %middle.block1015, label %vector.body1017, !llvm.loop !90
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit576 ], [ 24, %polly.loop_exit560 ]
  ...
  %187 = lshr i64 %indvars.iv892, 6
  %188 = mul nsw i64 %polly.indvar571, -100
  %189 = mul nuw nsw i64 %polly.indvar571, 100
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next893 = add nuw nsw i64 %indvars.iv892, 25
  %exitcond896.not = icmp eq i64 %polly.indvar_next572, 12
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %206 = shl nsw i64 %polly.indvar584, 8
  %207 = add nsw i64 %206, %188
  %208 = icmp sgt i64 %207, 0
  %209 = select i1 %208, i64 %207, i64 0
  %polly.loop_guard591 = icmp slt i64 %209, 100
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %indvars.iv.next886 = add nsw i64 %indvars.iv885, -256
...
polly.loop_exit597:                               ; preds = %polly.loop_header602.us.7, %polly.loop_header588
  ...
  %polly.loop_cond594 = icmp ult i64 %polly.indvar592, 99
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph957
  ...
  br i1 %244, label %polly.loop_exit772, label %vector.body955, !llvm.loop !99
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  br i1 %273, label %polly.loop_exit799, label %vector.body970, !llvm.loop !102
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  br i1 %302, label %polly.loop_exit825, label %vector.body988, !llvm.loop !105
