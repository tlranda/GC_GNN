; ModuleID = 'syr2k_exhaustive/mmp_all_XL_623.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_623.c"
...
polly.loop_header274.us:                          ; preds = %polly.loop_header267.us, %polly.loop_exit284.us
  ...
  %smin1446 = call i64 @llvm.smin.i64(i64 %161, i64 79)
  ...
  %smin1433 = call i64 @llvm.smin.i64(i64 %166, i64 79)
...
polly.loop_header420:                             ; preds = %polly.loop_exit446, %polly.loop_header414
  ...
  %209 = mul nsw i64 %polly.indvar423, -20
  %210 = shl nuw nsw i64 %polly.indvar423, 1
  %211 = add nuw i64 %210, 4
  %212 = udiv i64 %211, 5
  %213 = mul nuw nsw i64 %212, 50
  %214 = add i64 %209, %213
  %215 = mul nuw nsw i64 %polly.indvar423, 20
  %216 = sub nsw i64 %215, %213
  %217 = mul nuw nsw i64 %polly.indvar423, 640
  %218 = mul nsw i64 %polly.indvar423, -20
  %219 = shl nuw nsw i64 %polly.indvar423, 1
  %220 = add nuw i64 %219, 4
  %221 = udiv i64 %220, 5
  %222 = mul nuw nsw i64 %221, 50
  %223 = add i64 %218, %222
  %224 = mul nuw nsw i64 %polly.indvar423, 100
  %225 = sub nsw i64 %224, %222
  %226 = or i64 %217, 8
  %227 = mul nuw nsw i64 %polly.indvar423, 20
  ...
  %233 = mul nuw nsw i64 %polly.indvar423, 80
...
polly.loop_header444:                             ; preds = %polly.loop_exit434.7, %polly.loop_exit486
  ...
  %.inv948 = icmp sgt i64 %252, 79
  %254 = select i1 %.inv948, i64 79, i64 %253
...
polly.loop_header491.us:                          ; preds = %polly.loop_header484.us, %polly.loop_exit501.us
  ...
  %smin1383 = call i64 @llvm.smin.i64(i64 %265, i64 79)
  ...
  %smin1370 = call i64 @llvm.smin.i64(i64 %270, i64 79)
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %313 = mul nsw i64 %polly.indvar640, -20
  %314 = shl nuw nsw i64 %polly.indvar640, 1
  %315 = add nuw i64 %314, 4
  %316 = udiv i64 %315, 5
  %317 = mul nuw nsw i64 %316, 50
  %318 = add i64 %313, %317
  %319 = mul nuw nsw i64 %polly.indvar640, 20
  %320 = sub nsw i64 %319, %317
  %321 = mul nuw nsw i64 %polly.indvar640, 640
  %322 = mul nsw i64 %polly.indvar640, -20
  %323 = shl nuw nsw i64 %polly.indvar640, 1
  %324 = add nuw i64 %323, 4
  %325 = udiv i64 %324, 5
  %326 = mul nuw nsw i64 %325, 50
  %327 = add i64 %322, %326
  %328 = mul nuw nsw i64 %polly.indvar640, 100
  %329 = sub nsw i64 %328, %326
  %330 = or i64 %321, 8
  %331 = mul nuw nsw i64 %polly.indvar640, 20
  ...
  %337 = mul nuw nsw i64 %polly.indvar640, 80
...
polly.loop_header661:                             ; preds = %polly.loop_exit651.7, %polly.loop_exit703
  ...
  %.inv949 = icmp sgt i64 %356, 79
  %358 = select i1 %.inv949, i64 79, i64 %357
...
polly.loop_header708.us:                          ; preds = %polly.loop_header701.us, %polly.loop_exit718.us
  ...
  %smin1320 = call i64 @llvm.smin.i64(i64 %369, i64 79)
  ...
  %smin1307 = call i64 @llvm.smin.i64(i64 %374, i64 79)
...
polly.loop_exit220.7:                             ; preds = %polly.loop_header218.7
  %494 = mul nsw i64 %polly.indvar209, -80
  ...
  %polly.loop_guard = icmp slt i64 %497, 24
...
polly.loop_exit434.7:                             ; preds = %polly.loop_header432.7
  %526 = mul nsw i64 %polly.indvar423, -80
  ...
  %polly.loop_guard447 = icmp slt i64 %529, 24
...
polly.loop_exit651.7:                             ; preds = %polly.loop_header649.7
  %558 = mul nsw i64 %polly.indvar640, -80
  ...
  %polly.loop_guard664 = icmp slt i64 %561, 24
