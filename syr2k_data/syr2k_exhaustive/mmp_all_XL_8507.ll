; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8507.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8507.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %101 = mul nsw i64 %polly.indvar214, -32
  %polly.loop_guard863 = icmp sgt i64 %101, -1200
...
vector.body978:                                   ; preds = %vector.body978, %vector.ph982
  ...
  %116 = shl nuw nsw i64 %index985, 3
  %117 = getelementptr i8, i8* %scevgep348, i64 %116
  %118 = bitcast i8* %117 to <4 x double>*
  %wide.load989 = load <4 x double>, <4 x double>* %118, align 8, !alias.scope !72, !noalias !74
  %119 = fmul fast <4 x double> %wide.load989, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %120 = bitcast i8* %117 to <4 x double>*
  store <4 x double> %119, <4 x double>* %120, align 8, !alias.scope !72, !noalias !74
  %index.next986 = add i64 %index985, 4
  %121 = icmp eq i64 %index.next986, %n.vec984
  br i1 %121, label %middle.block976, label %vector.body978, !llvm.loop !77

middle.block976:                                  ; preds = %vector.body978
  %cmp.n988 = icmp eq i64 %114, %n.vec984
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %123 = mul nuw nsw i64 %polly.indvar355, 20
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %124 = shl nuw nsw i64 %polly.indvar361, 1
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %126 = add nsw i64 %smin801, 1199
  %smax802 = call i64 @llvm.smax.i64(i64 %126, i64 0)
  %127 = mul nsw i64 %polly.indvar367, -32
  %polly.loop_guard380864 = icmp sgt i64 %127, -1200
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph956
  ...
  %142 = shl nuw nsw i64 %index959, 3
  %143 = getelementptr i8, i8* %scevgep503, i64 %142
  %144 = bitcast i8* %143 to <4 x double>*
  %wide.load963 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !81, !noalias !83
  %145 = fmul fast <4 x double> %wide.load963, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %146 = bitcast i8* %143 to <4 x double>*
  store <4 x double> %145, <4 x double>* %146, align 8, !alias.scope !81, !noalias !83
  %index.next960 = add i64 %index959, 4
  %147 = icmp eq i64 %index.next960, %n.vec958
  br i1 %147, label %middle.block952, label %vector.body954, !llvm.loop !86

middle.block952:                                  ; preds = %vector.body954
  %cmp.n962 = icmp eq i64 %140, %n.vec958
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %149 = mul nuw nsw i64 %polly.indvar510, 20
...
polly.loop_header513:                             ; preds = %polly.loop_exit521, %polly.loop_header507
  ...
  %150 = shl nuw nsw i64 %polly.indvar516, 1
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %polly.indvar522 = phi i64 [ %polly.indvar_next523, %polly.loop_exit527 ], [ %150, %polly.loop_header513 ]
  %smin820 = call i64 @llvm.smin.i64(i64 %indvars.iv818, i64 -1168)
  %152 = add nsw i64 %smin820, 1199
  %smax821 = call i64 @llvm.smax.i64(i64 %152, i64 0)
  %153 = mul nsw i64 %polly.indvar522, -32
  %polly.loop_guard535865 = icmp sgt i64 %153, -1200
  %154 = shl nsw i64 %polly.indvar522, 5
...
polly.loop_header692:                             ; preds = %polly.loop_exit700, %polly.loop_header686
  ...
  %smin893 = call i64 @llvm.smin.i64(i64 %168, i64 -1168)
  %169 = add nsw i64 %smin893, 1200
  %smin851 = call i64 @llvm.smin.i64(i64 %indvars.iv849, i64 -1168)
  %170 = shl nsw i64 %polly.indvar695, 5
  %171 = add nsw i64 %smin851, 1199
...
vector.ph894:                                     ; preds = %polly.loop_header698
  %broadcast.splatinsert901 = insertelement <4 x i64> poison, i64 %170, i32 0
  %broadcast.splat902 = shufflevector <4 x i64> %broadcast.splatinsert901, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert903 = insertelement <4 x i32> poison, i32 %173, i32 0
...
vector.body892:                                   ; preds = %vector.body892, %vector.ph894
  ...
  %175 = add nuw nsw <4 x i64> %vec.ind899, %broadcast.splat902
  %176 = trunc <4 x i64> %175 to <4 x i32>
  %177 = mul <4 x i32> %broadcast.splat904, %176
  ...
  store <4 x double> %181, <4 x double>* %186, align 8, !alias.scope !90, !noalias !92
  %index.next896 = add i64 %index895, 4
  %vec.ind.next900 = add <4 x i64> %vec.ind899, <i64 4, i64 4, i64 4, i64 4>
  %187 = icmp eq i64 %index.next896, %169
  br i1 %187, label %polly.loop_exit706, label %vector.body892, !llvm.loop !95

polly.loop_exit706:                               ; preds = %vector.body892, %polly.loop_header704
  %polly.indvar_next702 = add nuw nsw i64 %polly.indvar701, 1
  %exitcond856.not = icmp eq i64 %polly.indvar701, %167
...
polly.loop_header704:                             ; preds = %polly.loop_header698, %polly.loop_header704
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar707, %171
...
polly.loop_header719:                             ; preds = %polly.loop_exit727, %polly.loop_header713
  ...
  %smin908 = call i64 @llvm.smin.i64(i64 %197, i64 -968)
  %198 = add nsw i64 %smin908, 1000
  %smin841 = call i64 @llvm.smin.i64(i64 %indvars.iv839, i64 -968)
  %199 = shl nsw i64 %polly.indvar722, 5
  %200 = add nsw i64 %smin841, 999
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  %204 = add nuw nsw <4 x i64> %vec.ind917, %broadcast.splat920
  %205 = trunc <4 x i64> %204 to <4 x i32>
  %206 = mul <4 x i32> %broadcast.splat922, %205
  ...
  store <4 x double> %210, <4 x double>* %215, align 8, !alias.scope !94, !noalias !97
  %index.next914 = add i64 %index913, 4
  %vec.ind.next918 = add <4 x i64> %vec.ind917, <i64 4, i64 4, i64 4, i64 4>
  %216 = icmp eq i64 %index.next914, %198
  br i1 %216, label %polly.loop_exit733, label %vector.body907, !llvm.loop !98

polly.loop_exit733:                               ; preds = %vector.body907, %polly.loop_header731
  %polly.indvar_next729 = add nuw nsw i64 %polly.indvar728, 1
  %exitcond846.not = icmp eq i64 %polly.indvar728, %196
...
polly.loop_header731:                             ; preds = %polly.loop_header725, %polly.loop_header731
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar734, %200
...
polly.loop_header745:                             ; preds = %polly.loop_exit753, %polly.loop_header739
  ...
  %smin926 = call i64 @llvm.smin.i64(i64 %226, i64 -968)
  %227 = add nsw i64 %smin926, 1000
  %smin831 = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 -968)
  %228 = shl nsw i64 %polly.indvar748, 5
  %229 = add nsw i64 %smin831, 999
...
vector.body925:                                   ; preds = %vector.body925, %vector.ph928
  ...
  %233 = add nuw nsw <4 x i64> %vec.ind935, %broadcast.splat938
  %234 = trunc <4 x i64> %233 to <4 x i32>
  %235 = mul <4 x i32> %broadcast.splat940, %234
  ...
  store <4 x double> %239, <4 x double>* %244, align 8, !alias.scope !93, !noalias !100
  %index.next932 = add i64 %index931, 4
  %vec.ind.next936 = add <4 x i64> %vec.ind935, <i64 4, i64 4, i64 4, i64 4>
  %245 = icmp eq i64 %index.next932, %227
  br i1 %245, label %polly.loop_exit759, label %vector.body925, !llvm.loop !101

polly.loop_exit759:                               ; preds = %vector.body925, %polly.loop_header757
  %polly.indvar_next755 = add nuw nsw i64 %polly.indvar754, 1
  %exitcond836.not = icmp eq i64 %polly.indvar754, %225
...
polly.loop_header757:                             ; preds = %polly.loop_header751, %polly.loop_header757
  ...
  %exitcond832.not = icmp eq i64 %polly.indvar760, %229
