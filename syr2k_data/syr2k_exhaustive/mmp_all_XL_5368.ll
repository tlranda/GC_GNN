; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5368.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5368.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin848 = call i64 @llvm.smin.i64(i64 %indvars.iv838, i64 -968)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar_next203, 32
...
polly.start270:                                   ; preds = %kernel_syr2k.exit
  %malloccall272 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %smin869 = call i64 @llvm.smin.i64(i64 %indvars.iv858, i64 -968)
  %137 = add nsw i64 %smin869, 1000
  %138 = shl nsw i64 %polly.indvar375, 5
...
polly.loop_exit380:                               ; preds = %polly.loop_exit402
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar_next376, 32
...
polly.start443:                                   ; preds = %init_array.exit
  %malloccall445 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %smin890 = call i64 @llvm.smin.i64(i64 %indvars.iv879, i64 -968)
  %177 = add nsw i64 %smin890, 1000
  %178 = shl nsw i64 %polly.indvar548, 5
...
polly.loop_exit553:                               ; preds = %polly.loop_exit575
  ...
  %exitcond894.not = icmp eq i64 %polly.indvar_next549, 32
