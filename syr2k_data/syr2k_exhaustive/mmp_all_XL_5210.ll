; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5210.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5210.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit220
  ...
  %118 = mul nsw i64 %polly.indvar214, 80
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %147 = shl nuw nsw i64 %polly.indvar388, 1
  %148 = add nuw nsw i64 %147, 2
  %pexp.p_div_q397 = udiv i64 %148, 5
  %149 = sub nsw i64 %147, %pexp.p_div_q397
  %150 = add nsw i64 %149, 1
  %.inv873 = icmp slt i64 %149, 14
  %151 = select i1 %.inv873, i64 %150, i64 14
  %polly.loop_guard402 = icmp sgt i64 %151, -1
  %152 = mul nsw i64 %polly.indvar388, -128
  %153 = icmp slt i64 %152, -1072
  %154 = select i1 %153, i64 %152, i64 -1072
  %155 = add nsw i64 %154, 1199
  %156 = shl nsw i64 %polly.indvar388, 7
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %168 = mul nsw i64 %polly.indvar403, 80
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %197 = shl nuw nsw i64 %polly.indvar581, 1
  %198 = add nuw nsw i64 %197, 2
  %pexp.p_div_q590 = udiv i64 %198, 5
  %199 = sub nsw i64 %197, %pexp.p_div_q590
  %200 = add nsw i64 %199, 1
  %.inv875 = icmp slt i64 %199, 14
  %201 = select i1 %.inv875, i64 %200, i64 14
  %polly.loop_guard595 = icmp sgt i64 %201, -1
  %202 = mul nsw i64 %polly.indvar581, -128
  %203 = icmp slt i64 %202, -1072
  %204 = select i1 %203, i64 %202, i64 -1072
  %205 = add nsw i64 %204, 1199
  %206 = shl nsw i64 %polly.indvar581, 7
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %218 = mul nsw i64 %polly.indvar596, 80
