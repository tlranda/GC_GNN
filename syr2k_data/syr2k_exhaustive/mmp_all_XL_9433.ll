; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9433.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9433.c"
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph875
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call708, i64 %indvars.iv7.i, i64 %index876
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next877 = add i64 %index876, 4
  %vec.ind.next881 = add <4 x i64> %vec.ind880, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next877, 1200
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check938 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check938, label %for.body3.i46.preheader1015, label %vector.ph939

vector.ph939:                                     ; preds = %for.body3.i46.preheader
  %n.vec941 = and i64 %indvars.iv21.i, 9223372036854775804
  br label %vector.body937

vector.body937:                                   ; preds = %vector.body937, %vector.ph939
  %index942 = phi i64 [ 0, %vector.ph939 ], [ %index.next943, %vector.body937 ]
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call708, i64 %indvars.iv21.i, i64 %index942
  ...
  %46 = icmp eq i64 %index.next943, %n.vec941
  br i1 %46, label %middle.block935, label %vector.body937, !llvm.loop !18

middle.block935:                                  ; preds = %vector.body937
  %cmp.n945 = icmp eq i64 %indvars.iv21.i, %n.vec941
  br i1 %cmp.n945, label %for.inc6.i, label %for.body3.i46.preheader1015

for.body3.i46.preheader1015:                      ; preds = %for.body3.i46.preheader, %middle.block935
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec941, %middle.block935 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1015, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1015 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block935, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check961 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check961, label %for.body3.i60.preheader1013, label %vector.ph962

vector.ph962:                                     ; preds = %for.body3.i60.preheader
  %n.vec964 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph962
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call708, i64 %indvars.iv21.i52, i64 %index965
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load969 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load969, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next966 = add i64 %index965, 4
  %57 = icmp eq i64 %index.next966, %n.vec964
  br i1 %57, label %middle.block958, label %vector.body960, !llvm.loop !51

middle.block958:                                  ; preds = %vector.body960
  %cmp.n968 = icmp eq i64 %indvars.iv21.i52, %n.vec964
  br i1 %cmp.n968, label %for.inc6.i63, label %for.body3.i60.preheader1013

for.body3.i60.preheader1013:                      ; preds = %for.body3.i60.preheader, %middle.block958
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec964, %middle.block958 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1013, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1013 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block958, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check987 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check987, label %for.body3.i99.preheader1011, label %vector.ph988

vector.ph988:                                     ; preds = %for.body3.i99.preheader
  %n.vec990 = and i64 %indvars.iv21.i91, 9223372036854775804
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph988
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call708, i64 %indvars.iv21.i91, i64 %index991
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load995 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load995, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next992 = add i64 %index991, 4
  %68 = icmp eq i64 %index.next992, %n.vec990
  br i1 %68, label %middle.block984, label %vector.body986, !llvm.loop !53

middle.block984:                                  ; preds = %vector.body986
  %cmp.n994 = icmp eq i64 %indvars.iv21.i91, %n.vec990
  br i1 %cmp.n994, label %for.inc6.i102, label %for.body3.i99.preheader1011

for.body3.i99.preheader1011:                      ; preds = %for.body3.i99.preheader, %middle.block984
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec990, %middle.block984 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1011, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1011 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block984, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %kernel_syr2k.exit90, %polly.loop_exit193
  %indvar999 = phi i64 [ %indvar.next1000, %polly.loop_exit193 ], [ 0, %kernel_syr2k.exit90 ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %kernel_syr2k.exit90 ]
  %88 = add i64 %indvar999, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1001 = icmp ult i64 %88, 4
  br i1 %min.iters.check1001, label %polly.loop_header191.preheader, label %vector.ph1002

vector.ph1002:                                    ; preds = %polly.loop_header
  %n.vec1004 = and i64 %88, -4
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1002
  ...
  %90 = shl nuw nsw i64 %index1005, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1009 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !59, !noalias !61
  %93 = fmul fast <4 x double> %wide.load1009, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !59, !noalias !61
  %index.next1006 = add i64 %index1005, 4
  %95 = icmp eq i64 %index.next1006, %n.vec1004
  br i1 %95, label %middle.block996, label %vector.body998, !llvm.loop !64

middle.block996:                                  ; preds = %vector.body998
  %cmp.n1008 = icmp eq i64 %88, %n.vec1004
  br i1 %cmp.n1008, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block996
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1004, %middle.block996 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block996
...
polly.loop_exit207:                               ; preds = %polly.loop_exit219.3
  ...
  %exitcond783.not = icmp eq i64 %polly.indvar_next203, 300
...
polly.loop_header205:                             ; preds = %polly.loop_exit219.3, %polly.loop_header199
  %indvars.iv776 = phi i64 [ %indvars.iv.next777, %polly.loop_exit219.3 ], [ %indvars.iv, %polly.loop_header199 ]
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv776, i64 99)
  %polly.loop_guard848 = icmp sgt i64 %111, -1
  br i1 %polly.loop_guard848, label %polly.loop_header217.us, label %polly.loop_exit219
...
polly.loop_exit225.loopexit.us:                   ; preds = %polly.loop_header223.us
  ...
  %exitcond780.not = icmp eq i64 %polly.indvar_next221.us, 1000
  br i1 %exitcond780.not, label %polly.loop_exit219, label %polly.loop_header217.us

polly.loop_exit219:                               ; preds = %polly.loop_exit225.loopexit.us, %polly.loop_header205
  %indvars.iv.next779 = or i64 %indvars.iv776, 1
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next779, i64 99)
  %polly.loop_guard.1849 = icmp sgt i64 %111, -1
  br i1 %polly.loop_guard.1849, label %polly.loop_header217.us.1, label %polly.loop_exit219.1

polly.loop_header334:                             ; preds = %kernel_syr2k.exit, %polly.loop_exit342
  %indvar973 = phi i64 [ %indvar.next974, %polly.loop_exit342 ], [ 0, %kernel_syr2k.exit ]
  %polly.indvar337 = phi i64 [ %polly.indvar_next338, %polly.loop_exit342 ], [ 1, %kernel_syr2k.exit ]
  %117 = add i64 %indvar973, 1
  %118 = mul nuw nsw i64 %polly.indvar337, 9600
  %scevgep346 = getelementptr i8, i8* %call, i64 %118
  %min.iters.check975 = icmp ult i64 %117, 4
  br i1 %min.iters.check975, label %polly.loop_header340.preheader, label %vector.ph976

vector.ph976:                                     ; preds = %polly.loop_header334
  %n.vec978 = and i64 %117, -4
  br label %vector.body972

vector.body972:                                   ; preds = %vector.body972, %vector.ph976
  %index979 = phi i64 [ 0, %vector.ph976 ], [ %index.next980, %vector.body972 ]
  %119 = shl nuw nsw i64 %index979, 3
  %120 = getelementptr i8, i8* %scevgep346, i64 %119
  %121 = bitcast i8* %120 to <4 x double>*
  %wide.load983 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !69, !noalias !71
  %122 = fmul fast <4 x double> %wide.load983, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %124 = icmp eq i64 %index.next980, %n.vec978
  br i1 %124, label %middle.block970, label %vector.body972, !llvm.loop !74

middle.block970:                                  ; preds = %vector.body972
  %cmp.n982 = icmp eq i64 %117, %n.vec978
  br i1 %cmp.n982, label %polly.loop_exit342, label %polly.loop_header340.preheader

polly.loop_header340.preheader:                   ; preds = %polly.loop_header334, %middle.block970
  %polly.indvar343.ph = phi i64 [ 0, %polly.loop_header334 ], [ %n.vec978, %middle.block970 ]
  br label %polly.loop_header340

polly.loop_exit342:                               ; preds = %polly.loop_header340, %middle.block970
  %polly.indvar_next338 = add nuw nsw i64 %polly.indvar337, 1
  %exitcond799.not = icmp eq i64 %polly.indvar_next338, 1200
  %indvar.next974 = add i64 %indvar973, 1
  br i1 %exitcond799.not, label %polly.loop_header350, label %polly.loop_header334
...
polly.loop_header340:                             ; preds = %polly.loop_header340.preheader, %polly.loop_header340
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar_next344, %polly.indvar337
  br i1 %exitcond798.not, label %polly.loop_exit342, label %polly.loop_header340, !llvm.loop !75
...
polly.loop_header350:                             ; preds = %polly.loop_exit342, %polly.loop_exit359
  ...
  %126 = udiv i64 %polly.indvar353, 25
...
polly.loop_exit359:                               ; preds = %polly.loop_exit371.3
  ...
  %exitcond797.not = icmp eq i64 %polly.indvar_next354, 300
  br i1 %exitcond797.not, label %kernel_syr2k.exit90, label %polly.loop_header350

polly.loop_header357:                             ; preds = %polly.loop_exit371.3, %polly.loop_header350
  %indvars.iv788 = phi i64 [ %indvars.iv.next789, %polly.loop_exit371.3 ], [ %indvars.iv786, %polly.loop_header350 ]
  %polly.indvar360 = phi i64 [ %polly.indvar_next361, %polly.loop_exit371.3 ], [ 0, %polly.loop_header350 ]
  %139 = mul nuw nsw i64 %polly.indvar360, 100
  %140 = sub nsw i64 %127, %139
  %smin792 = call i64 @llvm.smin.i64(i64 %indvars.iv788, i64 99)
  %polly.loop_guard379852 = icmp sgt i64 %140, -1
  br i1 %polly.loop_guard379852, label %polly.loop_header369.us, label %polly.loop_exit371
...
polly.loop_exit371:                               ; preds = %polly.loop_exit378.loopexit.us, %polly.loop_header357
  ...
  %smin792.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next791, i64 99)
  %polly.loop_guard379.1853 = icmp sgt i64 %140, -1
  br i1 %polly.loop_guard379.1853, label %polly.loop_header369.us.1, label %polly.loop_exit371.1
...
polly.loop_header488:                             ; preds = %init_array.exit, %polly.loop_exit496
  ...
  %min.iters.check949 = icmp ult i64 %146, 4
  br i1 %min.iters.check949, label %polly.loop_header494.preheader, label %vector.ph950

vector.ph950:                                     ; preds = %polly.loop_header488
  %n.vec952 = and i64 %146, -4
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph950
  ...
  %148 = shl nuw nsw i64 %index953, 3
  %149 = getelementptr i8, i8* %scevgep500, i64 %148
  %150 = bitcast i8* %149 to <4 x double>*
  %wide.load957 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !78, !noalias !80
  %151 = fmul fast <4 x double> %wide.load957, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %153 = icmp eq i64 %index.next954, %n.vec952
  br i1 %153, label %middle.block946, label %vector.body948, !llvm.loop !83

middle.block946:                                  ; preds = %vector.body948
  %cmp.n956 = icmp eq i64 %146, %n.vec952
  br i1 %cmp.n956, label %polly.loop_exit496, label %polly.loop_header494.preheader

polly.loop_header494.preheader:                   ; preds = %polly.loop_header488, %middle.block946
  %polly.indvar497.ph = phi i64 [ 0, %polly.loop_header488 ], [ %n.vec952, %middle.block946 ]
  br label %polly.loop_header494

polly.loop_exit496:                               ; preds = %polly.loop_header494, %middle.block946
  %polly.indvar_next492 = add nuw nsw i64 %polly.indvar491, 1
  %exitcond813.not = icmp eq i64 %polly.indvar_next492, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond813.not, label %polly.loop_header504, label %polly.loop_header488
...
polly.loop_header494:                             ; preds = %polly.loop_header494.preheader, %polly.loop_header494
  ...
  %exitcond812.not = icmp eq i64 %polly.indvar_next498, %polly.indvar491
  br i1 %exitcond812.not, label %polly.loop_exit496, label %polly.loop_header494, !llvm.loop !84

polly.loop_header504:                             ; preds = %polly.loop_exit496, %polly.loop_exit513
  %indvars.iv800 = phi i64 [ %indvars.iv.next801, %polly.loop_exit513 ], [ 0, %polly.loop_exit496 ]
  %polly.indvar507 = phi i64 [ %polly.indvar_next508, %polly.loop_exit513 ], [ 0, %polly.loop_exit496 ]
  %155 = udiv i64 %polly.indvar507, 25
...
polly.loop_exit513:                               ; preds = %polly.loop_exit525.3
  ...
  %exitcond811.not = icmp eq i64 %polly.indvar_next508, 300
  br i1 %exitcond811.not, label %kernel_syr2k.exit, label %polly.loop_header504

polly.loop_header511:                             ; preds = %polly.loop_exit525.3, %polly.loop_header504
  %indvars.iv802 = phi i64 [ %indvars.iv.next803, %polly.loop_exit525.3 ], [ %indvars.iv800, %polly.loop_header504 ]
  %polly.indvar514 = phi i64 [ %polly.indvar_next515, %polly.loop_exit525.3 ], [ 0, %polly.loop_header504 ]
  %168 = mul nuw nsw i64 %polly.indvar514, 100
  %169 = sub nsw i64 %156, %168
  %smin806 = call i64 @llvm.smin.i64(i64 %indvars.iv802, i64 99)
  %polly.loop_guard533856 = icmp sgt i64 %169, -1
...
polly.loop_header530.us:                          ; preds = %polly.loop_header530.us, %polly.loop_header523.us
  ...
  %exitcond807.not = icmp eq i64 %polly.indvar534.us, %smin806
  br i1 %exitcond807.not, label %polly.loop_exit532.loopexit.us, label %polly.loop_header530.us

polly.loop_exit532.loopexit.us:                   ; preds = %polly.loop_header530.us
  %polly.indvar_next527.us = add nuw nsw i64 %polly.indvar526.us, 1
  %exitcond808.not = icmp eq i64 %polly.indvar_next527.us, 1000
  br i1 %exitcond808.not, label %polly.loop_exit525, label %polly.loop_header523.us

polly.loop_exit525:                               ; preds = %polly.loop_exit532.loopexit.us, %polly.loop_header511
  %indvars.iv.next805 = or i64 %indvars.iv802, 1
  %smin806.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next805, i64 99)
  %polly.loop_guard533.1857 = icmp sgt i64 %169, -1
  br i1 %polly.loop_guard533.1857, label %polly.loop_header523.us.1, label %polly.loop_exit525.1
...
polly.loop_header688:                             ; preds = %polly.loop_exit696, %polly.loop_header682
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %177, i64 -1168)
  %178 = add nsw i64 %smin887, 1200
  %smin836 = call i64 @llvm.smin.i64(i64 %indvars.iv834, i64 -1168)
  %179 = shl nsw i64 %polly.indvar691, 5
  %180 = add nsw i64 %smin836, 1199
...
polly.loop_header694:                             ; preds = %polly.loop_exit702, %polly.loop_header688
  ...
  br i1 %min.iters.check, label %polly.loop_header700, label %vector.ph888

vector.ph888:                                     ; preds = %polly.loop_header694
  %broadcast.splatinsert895 = insertelement <4 x i64> poison, i64 %179, i32 0
  %broadcast.splat896 = shufflevector <4 x i64> %broadcast.splatinsert895, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert897 = insertelement <4 x i32> poison, i32 %182, i32 0
  %broadcast.splat898 = shufflevector <4 x i32> %broadcast.splatinsert897, <4 x i32> poison, <4 x i32> zeroinitializer
  br label %vector.body886

vector.body886:                                   ; preds = %vector.body886, %vector.ph888
  %index889 = phi i64 [ 0, %vector.ph888 ], [ %index.next890, %vector.body886 ]
  %vec.ind893 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph888 ], [ %vec.ind.next894, %vector.body886 ]
  %184 = add nuw nsw <4 x i64> %vec.ind893, %broadcast.splat896
  %185 = trunc <4 x i64> %184 to <4 x i32>
  %186 = mul <4 x i32> %broadcast.splat898, %185
  ...
  %196 = icmp eq i64 %index.next890, %178
  br i1 %196, label %polly.loop_exit702, label %vector.body886, !llvm.loop !92

polly.loop_exit702:                               ; preds = %vector.body886, %polly.loop_header700
  %polly.indvar_next698 = add nuw nsw i64 %polly.indvar697, 1
  %exitcond841.not = icmp eq i64 %polly.indvar697, %176
...
polly.loop_header700:                             ; preds = %polly.loop_header694, %polly.loop_header700
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar703, %180
  br i1 %exitcond837.not, label %polly.loop_exit702, label %polly.loop_header700, !llvm.loop !93
...
polly.loop_header715:                             ; preds = %polly.loop_exit723, %polly.loop_header709
  ...
  %smin902 = call i64 @llvm.smin.i64(i64 %206, i64 -968)
  %207 = add nsw i64 %smin902, 1000
  %smin826 = call i64 @llvm.smin.i64(i64 %indvars.iv824, i64 -968)
  %208 = shl nsw i64 %polly.indvar718, 5
  %209 = add nsw i64 %smin826, 999
...
polly.loop_header721:                             ; preds = %polly.loop_exit729, %polly.loop_header715
  ...
  %min.iters.check903 = icmp eq i64 %207, 0
  br i1 %min.iters.check903, label %polly.loop_header727, label %vector.ph904

vector.ph904:                                     ; preds = %polly.loop_header721
  %broadcast.splatinsert913 = insertelement <4 x i64> poison, i64 %208, i32 0
  %broadcast.splat914 = shufflevector <4 x i64> %broadcast.splatinsert913, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert915 = insertelement <4 x i32> poison, i32 %211, i32 0
...
vector.body901:                                   ; preds = %vector.body901, %vector.ph904
  %index907 = phi i64 [ 0, %vector.ph904 ], [ %index.next908, %vector.body901 ]
  %vec.ind911 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph904 ], [ %vec.ind.next912, %vector.body901 ]
  %213 = add nuw nsw <4 x i64> %vec.ind911, %broadcast.splat914
  %214 = trunc <4 x i64> %213 to <4 x i32>
  %215 = mul <4 x i32> %broadcast.splat916, %214
  ...
  %225 = icmp eq i64 %index.next908, %207
  br i1 %225, label %polly.loop_exit729, label %vector.body901, !llvm.loop !95

polly.loop_exit729:                               ; preds = %vector.body901, %polly.loop_header727
  %polly.indvar_next725 = add nuw nsw i64 %polly.indvar724, 1
  %exitcond831.not = icmp eq i64 %polly.indvar724, %205
...
polly.loop_header727:                             ; preds = %polly.loop_header721, %polly.loop_header727
  ...
  %exitcond827.not = icmp eq i64 %polly.indvar730, %209
  br i1 %exitcond827.not, label %polly.loop_exit729, label %polly.loop_header727, !llvm.loop !96
...
polly.loop_header741:                             ; preds = %polly.loop_exit749, %polly.loop_header735
  ...
  %smin920 = call i64 @llvm.smin.i64(i64 %235, i64 -968)
  %236 = add nsw i64 %smin920, 1000
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 -968)
  %237 = shl nsw i64 %polly.indvar744, 5
  %238 = add nsw i64 %smin816, 999
...
polly.loop_header747:                             ; preds = %polly.loop_exit755, %polly.loop_header741
  ...
  %min.iters.check921 = icmp eq i64 %236, 0
  br i1 %min.iters.check921, label %polly.loop_header753, label %vector.ph922

vector.ph922:                                     ; preds = %polly.loop_header747
  %broadcast.splatinsert931 = insertelement <4 x i64> poison, i64 %237, i32 0
  %broadcast.splat932 = shufflevector <4 x i64> %broadcast.splatinsert931, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert933 = insertelement <4 x i32> poison, i32 %240, i32 0
...
vector.body919:                                   ; preds = %vector.body919, %vector.ph922
  ...
  %242 = add nuw nsw <4 x i64> %vec.ind929, %broadcast.splat932
  %243 = trunc <4 x i64> %242 to <4 x i32>
  %244 = mul <4 x i32> %broadcast.splat934, %243
  ...
  %254 = icmp eq i64 %index.next926, %236
  br i1 %254, label %polly.loop_exit755, label %vector.body919, !llvm.loop !98

polly.loop_exit755:                               ; preds = %vector.body919, %polly.loop_header753
  %polly.indvar_next751 = add nuw nsw i64 %polly.indvar750, 1
  %exitcond821.not = icmp eq i64 %polly.indvar750, %234
...
polly.loop_header753:                             ; preds = %polly.loop_header747, %polly.loop_header753
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar756, %238
  br i1 %exitcond817.not, label %polly.loop_exit755, label %polly.loop_header753, !llvm.loop !99
...
polly.loop_exit225.loopexit.us.1:                 ; preds = %polly.loop_header223.us.1
  ...
  %exitcond780.1.not = icmp eq i64 %polly.indvar_next221.us.1, 1000
  br i1 %exitcond780.1.not, label %polly.loop_exit219.1, label %polly.loop_header217.us.1

polly.loop_exit219.1:                             ; preds = %polly.loop_exit225.loopexit.us.1, %polly.loop_exit219
  %indvars.iv.next779.1 = add nuw nsw i64 %indvars.iv.next779, 1
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next779.1, i64 99)
  %polly.loop_guard.2850 = icmp sgt i64 %111, -1
  br i1 %polly.loop_guard.2850, label %polly.loop_header217.us.2, label %polly.loop_exit219.2
...
polly.loop_exit225.loopexit.us.2:                 ; preds = %polly.loop_header223.us.2
  ...
  %exitcond780.2.not = icmp eq i64 %polly.indvar_next221.us.2, 1000
  br i1 %exitcond780.2.not, label %polly.loop_exit219.2, label %polly.loop_header217.us.2

polly.loop_exit219.2:                             ; preds = %polly.loop_exit225.loopexit.us.2, %polly.loop_exit219.1
  %indvars.iv.next779.2 = or i64 %indvars.iv776, 3
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next779.2, i64 99)
  %polly.loop_guard.3851 = icmp sgt i64 %111, -1
  br i1 %polly.loop_guard.3851, label %polly.loop_header217.us.3, label %polly.loop_exit219.3
...
polly.loop_exit225.loopexit.us.3:                 ; preds = %polly.loop_header223.us.3
  ...
  %exitcond780.3.not = icmp eq i64 %polly.indvar_next221.us.3, 1000
  br i1 %exitcond780.3.not, label %polly.loop_exit219.3, label %polly.loop_header217.us.3

polly.loop_exit219.3:                             ; preds = %polly.loop_exit225.loopexit.us.3, %polly.loop_exit219.2
  %polly.indvar_next209 = add nuw nsw i64 %polly.indvar208, 1
  %indvars.iv.next777 = add nsw i64 %indvars.iv776, -100
...
polly.loop_header376.us.1:                        ; preds = %polly.loop_header376.us.1, %polly.loop_header369.us.1
  ...
  %exitcond793.1.not = icmp eq i64 %polly.indvar380.us.1, %smin792.1
  br i1 %exitcond793.1.not, label %polly.loop_exit378.loopexit.us.1, label %polly.loop_header376.us.1
...
polly.loop_exit378.loopexit.us.1:                 ; preds = %polly.loop_header376.us.1
  ...
  %exitcond794.1.not = icmp eq i64 %polly.indvar_next373.us.1, 1000
  br i1 %exitcond794.1.not, label %polly.loop_exit371.1, label %polly.loop_header369.us.1
...
polly.loop_exit371.1:                             ; preds = %polly.loop_exit378.loopexit.us.1, %polly.loop_exit371
  ...
  %smin792.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next791.1, i64 99)
  %polly.loop_guard379.2854 = icmp sgt i64 %140, -1
  br i1 %polly.loop_guard379.2854, label %polly.loop_header369.us.2, label %polly.loop_exit371.2
...
polly.loop_header376.us.2:                        ; preds = %polly.loop_header376.us.2, %polly.loop_header369.us.2
  ...
  %exitcond793.2.not = icmp eq i64 %polly.indvar380.us.2, %smin792.2
  br i1 %exitcond793.2.not, label %polly.loop_exit378.loopexit.us.2, label %polly.loop_header376.us.2
...
polly.loop_exit378.loopexit.us.2:                 ; preds = %polly.loop_header376.us.2
  ...
  %exitcond794.2.not = icmp eq i64 %polly.indvar_next373.us.2, 1000
  br i1 %exitcond794.2.not, label %polly.loop_exit371.2, label %polly.loop_header369.us.2
...
polly.loop_exit371.2:                             ; preds = %polly.loop_exit378.loopexit.us.2, %polly.loop_exit371.1
  ...
  %smin792.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next791.2, i64 99)
  %polly.loop_guard379.3855 = icmp sgt i64 %140, -1
  br i1 %polly.loop_guard379.3855, label %polly.loop_header369.us.3, label %polly.loop_exit371.3
...
polly.loop_header376.us.3:                        ; preds = %polly.loop_header376.us.3, %polly.loop_header369.us.3
  ...
  %exitcond793.3.not = icmp eq i64 %polly.indvar380.us.3, %smin792.3
  br i1 %exitcond793.3.not, label %polly.loop_exit378.loopexit.us.3, label %polly.loop_header376.us.3
...
polly.loop_exit378.loopexit.us.3:                 ; preds = %polly.loop_header376.us.3
  ...
  %exitcond794.3.not = icmp eq i64 %polly.indvar_next373.us.3, 1000
  br i1 %exitcond794.3.not, label %polly.loop_exit371.3, label %polly.loop_header369.us.3
...
polly.loop_exit371.3:                             ; preds = %polly.loop_exit378.loopexit.us.3, %polly.loop_exit371.2
  ...
  %indvars.iv.next789 = add nsw i64 %indvars.iv788, -100
  %exitcond796.not = icmp eq i64 %polly.indvar360, %126
  br i1 %exitcond796.not, label %polly.loop_exit359, label %polly.loop_header357
...
polly.loop_header530.us.1:                        ; preds = %polly.loop_header530.us.1, %polly.loop_header523.us.1
  ...
  %exitcond807.1.not = icmp eq i64 %polly.indvar534.us.1, %smin806.1
  br i1 %exitcond807.1.not, label %polly.loop_exit532.loopexit.us.1, label %polly.loop_header530.us.1
...
polly.loop_exit532.loopexit.us.1:                 ; preds = %polly.loop_header530.us.1
  ...
  %exitcond808.1.not = icmp eq i64 %polly.indvar_next527.us.1, 1000
  br i1 %exitcond808.1.not, label %polly.loop_exit525.1, label %polly.loop_header523.us.1

polly.loop_exit525.1:                             ; preds = %polly.loop_exit532.loopexit.us.1, %polly.loop_exit525
  %indvars.iv.next805.1 = add nuw nsw i64 %indvars.iv.next805, 1
  %smin806.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next805.1, i64 99)
  %polly.loop_guard533.2858 = icmp sgt i64 %169, -1
  br i1 %polly.loop_guard533.2858, label %polly.loop_header523.us.2, label %polly.loop_exit525.2
...
polly.loop_header530.us.2:                        ; preds = %polly.loop_header530.us.2, %polly.loop_header523.us.2
  ...
  %exitcond807.2.not = icmp eq i64 %polly.indvar534.us.2, %smin806.2
  br i1 %exitcond807.2.not, label %polly.loop_exit532.loopexit.us.2, label %polly.loop_header530.us.2
...
polly.loop_exit532.loopexit.us.2:                 ; preds = %polly.loop_header530.us.2
  ...
  %exitcond808.2.not = icmp eq i64 %polly.indvar_next527.us.2, 1000
  br i1 %exitcond808.2.not, label %polly.loop_exit525.2, label %polly.loop_header523.us.2

polly.loop_exit525.2:                             ; preds = %polly.loop_exit532.loopexit.us.2, %polly.loop_exit525.1
  %indvars.iv.next805.2 = or i64 %indvars.iv802, 3
  %smin806.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next805.2, i64 99)
  %polly.loop_guard533.3859 = icmp sgt i64 %169, -1
  br i1 %polly.loop_guard533.3859, label %polly.loop_header523.us.3, label %polly.loop_exit525.3
...
polly.loop_header530.us.3:                        ; preds = %polly.loop_header530.us.3, %polly.loop_header523.us.3
  ...
  %exitcond807.3.not = icmp eq i64 %polly.indvar534.us.3, %smin806.3
  br i1 %exitcond807.3.not, label %polly.loop_exit532.loopexit.us.3, label %polly.loop_header530.us.3
...
polly.loop_exit532.loopexit.us.3:                 ; preds = %polly.loop_header530.us.3
  ...
  %exitcond808.3.not = icmp eq i64 %polly.indvar_next527.us.3, 1000
  br i1 %exitcond808.3.not, label %polly.loop_exit525.3, label %polly.loop_header523.us.3
...
polly.loop_exit525.3:                             ; preds = %polly.loop_exit532.loopexit.us.3, %polly.loop_exit525.2
  ...
  %indvars.iv.next803 = add nsw i64 %indvars.iv802, -100
  %exitcond810.not = icmp eq i64 %polly.indvar514, %155
