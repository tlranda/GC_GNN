; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7617.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7617.c"
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit230
  ...
  %polly.loop_guard231 = icmp slt i64 %105, 80
...
polly.loop_header228.preheader:                   ; preds = %polly.loop_header221
  ...
  %106 = add i64 %smax, %indvars.iv838
...
polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header221
  ...
  %indvars.iv.next835 = add nsw i64 %indvars.iv834, 50
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  %indvars.iv840 = phi i64 [ %106, %polly.loop_header228.preheader ], [ %indvars.iv.next841, %polly.loop_exit237 ]
  %polly.indvar232 = phi i64 [ %105, %polly.loop_header228.preheader ], [ %polly.indvar_next233, %polly.loop_exit237 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv840, i64 49)
  %108 = add nsw i64 %polly.indvar232, %107
  %polly.loop_guard245917 = icmp sgt i64 %108, -1
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit398
  ...
  %126 = shl nuw nsw i64 %polly.indvar391, 1
  %127 = trunc i64 %126 to i8
  %pexp.p_div_q394.lhs.trunc = add i8 %127, 2
  %pexp.p_div_q394827 = udiv i8 %pexp.p_div_q394.lhs.trunc, 5
  %pexp.p_div_q394.zext = zext i8 %pexp.p_div_q394827 to i64
  %128 = sub nsw i64 %126, %pexp.p_div_q394.zext
...
polly.loop_header396.preheader:                   ; preds = %polly.loop_header388
  %129 = mul nsw i64 %polly.indvar391, -80
  %130 = mul nuw nsw i64 %polly.indvar391, 80
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_exit406
  ...
  %131 = mul nuw nsw i64 %polly.indvar400, 50
  %132 = add nsw i64 %131, %129
  %133 = icmp sgt i64 %132, 0
  %134 = select i1 %133, i64 %132, i64 0
  %polly.loop_guard407 = icmp slt i64 %134, 80
...
polly.loop_header404.preheader:                   ; preds = %polly.loop_header396
  ...
  %135 = add i64 %smax852, %indvars.iv855
...
polly.loop_exit406:                               ; preds = %polly.loop_exit413, %polly.loop_header396
  ...
  %indvars.iv.next851 = add nsw i64 %indvars.iv850, 50
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit413
  %indvars.iv857 = phi i64 [ %135, %polly.loop_header404.preheader ], [ %indvars.iv.next858, %polly.loop_exit413 ]
  ...
  %polly.loop_guard421918 = icmp sgt i64 %137, -1
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit574
  ...
  %155 = shl nuw nsw i64 %polly.indvar567, 1
  %156 = trunc i64 %155 to i8
  %pexp.p_div_q570.lhs.trunc = add i8 %156, 2
  %pexp.p_div_q570826 = udiv i8 %pexp.p_div_q570.lhs.trunc, 5
  %pexp.p_div_q570.zext = zext i8 %pexp.p_div_q570826 to i64
  %157 = sub nsw i64 %155, %pexp.p_div_q570.zext
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header564
  %158 = mul nsw i64 %polly.indvar567, -80
  %159 = mul nuw nsw i64 %polly.indvar567, 80
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit582
  ...
  %160 = mul nuw nsw i64 %polly.indvar576, 50
  %161 = add nsw i64 %160, %158
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %polly.loop_guard583 = icmp slt i64 %163, 80
...
polly.loop_header580.preheader:                   ; preds = %polly.loop_header572
  ...
  %164 = add i64 %smax871, %indvars.iv874
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit589
  %indvars.iv876 = phi i64 [ %164, %polly.loop_header580.preheader ], [ %indvars.iv.next877, %polly.loop_exit589 ]
  %polly.indvar584 = phi i64 [ %163, %polly.loop_header580.preheader ], [ %polly.indvar_next585, %polly.loop_exit589 ]
  %smin878 = call i64 @llvm.smin.i64(i64 %indvars.iv876, i64 49)
  %166 = add nsw i64 %polly.indvar584, %165
  %polly.loop_guard597919 = icmp sgt i64 %166, -1
...
vector.body940:                                   ; preds = %vector.body940, %vector.ph942
  ...
  br i1 %196, label %polly.loop_exit766, label %vector.body940, !llvm.loop !99

polly.loop_exit766:                               ; preds = %vector.body940, %polly.loop_header764
  %polly.indvar_next762 = add nuw nsw i64 %polly.indvar761, 1
  %exitcond913.not = icmp eq i64 %polly.indvar761, %176
...
polly.loop_header764:                             ; preds = %polly.loop_header758, %polly.loop_header764
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar767, %180
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph958
  ...
  br i1 %225, label %polly.loop_exit793, label %vector.body955, !llvm.loop !102

polly.loop_exit793:                               ; preds = %vector.body955, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond903.not = icmp eq i64 %polly.indvar788, %205
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar794, %209
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph976
  ...
  br i1 %254, label %polly.loop_exit819, label %vector.body973, !llvm.loop !105

polly.loop_exit819:                               ; preds = %vector.body973, %polly.loop_header817
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %exitcond893.not = icmp eq i64 %polly.indvar814, %234
...
polly.loop_header817:                             ; preds = %polly.loop_header811, %polly.loop_header817
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar820, %238
