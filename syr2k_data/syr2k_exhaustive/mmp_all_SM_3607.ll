; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3607.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3607.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %98 = mul nuw nsw i64 %polly.indvar208, 3
...
polly.loop_header211:                             ; preds = %polly.loop_exit269, %polly.loop_header205
  ...
  %104 = mul nuw nsw i64 %polly.indvar214, 5
...
polly.loop_exit236.us:                            ; preds = %polly.loop_header234.us
  ...
  %exitcond962.not = icmp eq i64 %polly.indvar_next221.us, 100
...
polly.loop_exit256:                               ; preds = %polly.loop_header254
  ...
  %exitcond964.not = icmp eq i64 %polly.indvar_next252, 100
...
polly.loop_exit275:                               ; preds = %polly.loop_exit282
  ...
  %exitcond976.not = icmp eq i64 %polly.indvar_next271, 100
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit416
  ...
  %141 = mul nuw nsw i64 %polly.indvar411, 100
  br label %polly.loop_header414

polly.loop_exit416:                               ; preds = %polly.loop_exit422
  %polly.indvar_next412 = add nuw nsw i64 %polly.indvar411, 1
  %exitcond1008.not = icmp eq i64 %polly.indvar_next412, 10
...
polly.loop_header414:                             ; preds = %polly.loop_exit422, %polly.loop_header408
  ...
  %142 = mul nuw nsw i64 %polly.indvar417, 3
  %143 = shl nsw i64 %polly.indvar417, 4
  %144 = or i64 %143, 1
...
polly.loop_header420:                             ; preds = %polly.loop_exit484, %polly.loop_header414
  ...
  %148 = mul nuw nsw i64 %polly.indvar423, 5
...
polly.loop_header430.preheader:                   ; preds = %polly.loop_header420
  %149 = mul nuw nsw i64 %polly.indvar423, 80
...
polly.loop_exit451.us:                            ; preds = %polly.loop_header449.us
  ...
  %exitcond989.not = icmp eq i64 %polly.indvar_next434.us, 100
...
polly.loop_exit451:                               ; preds = %polly.loop_header449
  ...
  %exitcond982.not = icmp eq i64 %polly.indvar_next434, 100
...
polly.loop_exit471:                               ; preds = %polly.loop_header469
  ...
  %exitcond991.not = icmp eq i64 %polly.indvar_next467, 100
...
polly.loop_exit490:                               ; preds = %polly.loop_exit497
  ...
  %exitcond1005.not = icmp eq i64 %polly.indvar_next486, 100
...
polly.start521:                                   ; preds = %init_array.exit
  %malloccall523 = tail call dereferenceable_or_null(960000) i8* @malloc(i64 960000) #6
...
polly.loop_header623:                             ; preds = %polly.loop_header623.preheader, %polly.loop_exit631
  ...
  %185 = mul nuw nsw i64 %polly.indvar626, 100
...
polly.loop_exit631:                               ; preds = %polly.loop_exit637
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar_next627, 10
...
polly.loop_header629:                             ; preds = %polly.loop_exit637, %polly.loop_header623
  ...
  %186 = mul nuw nsw i64 %polly.indvar632, 3
  %187 = shl nsw i64 %polly.indvar632, 4
  %188 = or i64 %187, 1
...
polly.loop_header635:                             ; preds = %polly.loop_exit699, %polly.loop_header629
  ...
  %192 = mul nuw nsw i64 %polly.indvar638, 5
...
polly.loop_header645.preheader:                   ; preds = %polly.loop_header635
  %193 = mul nuw nsw i64 %polly.indvar638, 80
...
polly.loop_exit666.us:                            ; preds = %polly.loop_header664.us
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar_next649.us, 100
...
polly.loop_exit666:                               ; preds = %polly.loop_header664
  ...
  %exitcond1011.not = icmp eq i64 %polly.indvar_next649, 100
...
polly.loop_exit686:                               ; preds = %polly.loop_header684
  ...
  %exitcond1020.not = icmp eq i64 %polly.indvar_next682, 100
...
polly.loop_exit705:                               ; preds = %polly.loop_exit712
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next701, 100
...
vector.body1122:                                  ; preds = %vector.body1122, %vector.ph1124
  ...
  br i1 %241, label %polly.loop_exit880, label %vector.body1122, !llvm.loop !104
...
vector.body1137:                                  ; preds = %vector.body1137, %vector.ph1140
  ...
  br i1 %270, label %polly.loop_exit907, label %vector.body1137, !llvm.loop !107
...
vector.body1155:                                  ; preds = %vector.body1155, %vector.ph1158
  ...
  br i1 %299, label %polly.loop_exit933, label %vector.body1155, !llvm.loop !110
