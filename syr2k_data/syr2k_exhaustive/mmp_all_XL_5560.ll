; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5560.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5560.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %135 = mul nuw nsw i64 %polly.indvar373, 50
  br label %polly.loop_header376

polly.loop_exit378:                               ; preds = %polly.loop_exit384
  %136 = mul nsw i64 %polly.indvar373, -50
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next854 = add nsw i64 %indvars.iv853, -50
  %indvars.iv.next858 = add nuw nsw i64 %indvars.iv857, 50
  %indvars.iv.next860 = add nuw nsw i64 %indvars.iv859, 6
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, -50
  %exitcond873.not = icmp eq i64 %polly.indvar_next374, 24
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %168 = mul nuw nsw i64 %polly.indvar547, 50
  br label %polly.loop_header550

polly.loop_exit552:                               ; preds = %polly.loop_exit558
  %169 = mul nsw i64 %polly.indvar547, -50
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %indvars.iv.next881 = add nuw nsw i64 %indvars.iv880, 50
  %indvars.iv.next883 = add nuw nsw i64 %indvars.iv882, 6
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, -50
  %exitcond896.not = icmp eq i64 %polly.indvar_next548, 24
