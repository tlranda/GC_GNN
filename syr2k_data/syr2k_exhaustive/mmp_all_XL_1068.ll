; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1068.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1068.c"
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1118.not = icmp eq i64 %119, 150
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %122 = mul nsw i64 %indvar1427, -96
  %123 = add i64 %102, %122
  %smax1429 = call i64 @llvm.smax.i64(i64 %123, i64 0)
  %124 = mul nuw nsw i64 %indvar1427, 96
  %125 = add i64 %104, %124
  %126 = add i64 %smax1429, %125
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1106, i64 0)
  %127 = add i64 %smax, %indvars.iv1110
  %128 = mul nuw nsw i64 %polly.indvar231, 12
  %.not.not = icmp ugt i64 %128, %polly.indvar209
  %129 = mul nuw nsw i64 %polly.indvar231, 96
  %130 = add nsw i64 %129, %109
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %133 = add nsw i64 %130, 95
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %142 = mul nsw i64 %polly.indvar231, -96
...
polly.loop_header270:                             ; preds = %polly.loop_header263, %polly.loop_exit280
  ...
  %147 = add i64 %126, %indvar1430
  %smin1432 = call i64 @llvm.smin.i64(i64 %147, i64 7)
  %148 = add nsw i64 %smin1432, 1
  %smin1114 = call i64 @llvm.smin.i64(i64 %indvars.iv1112, i64 7)
  %149 = add nsw i64 %polly.indvar274, %130
  %polly.loop_guard2811221 = icmp sgt i64 %149, -1
...
polly.loop_header278.preheader:                   ; preds = %polly.loop_header270
  ...
  %min.iters.check1433 = icmp ult i64 %148, 4
...
vector.body1426:                                  ; preds = %vector.body1426, %vector.ph1434
  ...
  %152 = add nuw nsw i64 %index1437, %110
  %153 = add nuw nsw i64 %index1437, %polly.access.mul.Packed_MemRef_call1285
  %154 = getelementptr double, double* %Packed_MemRef_call1, i64 %153
  %155 = bitcast double* %154 to <4 x double>*
  %wide.load1441 = load <4 x double>, <4 x double>* %155, align 8
  %156 = fmul fast <4 x double> %broadcast.splat1443, %wide.load1441
  %157 = getelementptr double, double* %Packed_MemRef_call2, i64 %153
  %158 = bitcast double* %157 to <4 x double>*
  %wide.load1444 = load <4 x double>, <4 x double>* %158, align 8
  %159 = fmul fast <4 x double> %broadcast.splat1446, %wide.load1444
  %160 = shl i64 %152, 3
  %161 = add i64 %160, %151
  %162 = getelementptr i8, i8* %call, i64 %161
  %163 = bitcast i8* %162 to <4 x double>*
  %wide.load1447 = load <4 x double>, <4 x double>* %163, align 8, !alias.scope !72, !noalias !74
  ...
  %166 = fadd fast <4 x double> %165, %wide.load1447
  ...
  %168 = icmp eq i64 %index.next1438, %n.vec1436
  br i1 %168, label %middle.block1424, label %vector.body1426, !llvm.loop !84

middle.block1424:                                 ; preds = %vector.body1426
  %cmp.n1440 = icmp eq i64 %148, %n.vec1436
...
vector.body1362:                                  ; preds = %vector.body1362, %vector.ph1366
  ...
  %174 = shl nuw nsw i64 %index1369, 3
  %175 = getelementptr i8, i8* %scevgep406, i64 %174
  %176 = bitcast i8* %175 to <4 x double>*
  %wide.load1373 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !86, !noalias !88
  %177 = fmul fast <4 x double> %wide.load1373, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %179 = icmp eq i64 %index.next1370, %n.vec1368
  br i1 %179, label %middle.block1360, label %vector.body1362, !llvm.loop !93

middle.block1360:                                 ; preds = %vector.body1362
  %cmp.n1372 = icmp eq i64 %172, %n.vec1368
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %smin1147 = call i64 @llvm.smin.i64(i64 %indvars.iv1125, i64 -872)
  %181 = add nsw i64 %smin1147, 1000
  %182 = shl nsw i64 %polly.indvar413, 7
  br label %polly.loop_header416

polly.loop_exit418:                               ; preds = %polly.loop_exit441
  %polly.indvar_next414 = add nuw nsw i64 %polly.indvar413, 1
  %indvars.iv.next1126 = add nsw i64 %indvars.iv1125, -128
  %exitcond1150.not = icmp eq i64 %polly.indvar_next414, 8
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %184 = udiv i64 %polly.indvar419, 12
  %185 = mul nuw nsw i64 %184, 96
  %186 = sub nsw i64 %183, %185
  %187 = mul nsw i64 %polly.indvar419, -8
  %188 = add i64 %187, %185
  %189 = udiv i64 %polly.indvar419, 12
  %190 = mul nuw nsw i64 %189, 96
  %191 = sub nsw i64 %indvars.iv1134, %190
  %192 = add i64 %indvars.iv1139, %190
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1135 = add nuw nsw i64 %indvars.iv1134, 8
  %indvars.iv.next1140 = add nsw i64 %indvars.iv1139, -8
  %exitcond1149.not = icmp eq i64 %203, 150
...
polly.loop_exit430:                               ; preds = %polly.loop_header428
  ...
  %exitcond1128.not = icmp eq i64 %polly.indvar_next426, %181
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %indvars.iv1141 = phi i64 [ %indvars.iv.next1142, %polly.loop_exit482 ], [ %192, %polly.loop_exit424 ]
  %indvars.iv1136 = phi i64 [ %indvars.iv.next1137, %polly.loop_exit482 ], [ %191, %polly.loop_exit424 ]
  %polly.indvar442 = phi i64 [ %polly.indvar_next443, %polly.loop_exit482 ], [ %189, %polly.loop_exit424 ]
  %206 = mul nsw i64 %indvar1377, -96
  %207 = add i64 %186, %206
  %smax1379 = call i64 @llvm.smax.i64(i64 %207, i64 0)
  %208 = mul nuw nsw i64 %indvar1377, 96
  %209 = add i64 %188, %208
  %210 = add i64 %smax1379, %209
  %smax1138 = call i64 @llvm.smax.i64(i64 %indvars.iv1136, i64 0)
  %211 = add i64 %smax1138, %indvars.iv1141
  %212 = mul nuw nsw i64 %polly.indvar442, 12
  %.not.not944 = icmp ugt i64 %212, %polly.indvar419
  %213 = mul nuw nsw i64 %polly.indvar442, 96
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_header445.us
  ...
  %exitcond1133.not = icmp eq i64 %polly.indvar_next449.us, %181
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1130.not = icmp eq i64 %polly.indvar_next449, %181
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %226 = mul nsw i64 %polly.indvar442, -96
...
polly.loop_exit489:                               ; preds = %polly.loop_exit497
  ...
  %exitcond1148.not = icmp eq i64 %polly.indvar_next484, %181
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %indvars.iv1143 = phi i64 [ %211, %polly.loop_header480 ], [ %indvars.iv.next1144, %polly.loop_exit497 ]
  %polly.indvar491 = phi i64 [ %225, %polly.loop_header480 ], [ %polly.indvar_next492, %polly.loop_exit497 ]
  %231 = add i64 %210, %indvar1380
  %smin1382 = call i64 @llvm.smin.i64(i64 %231, i64 7)
  %232 = add nsw i64 %smin1382, 1
  %smin1145 = call i64 @llvm.smin.i64(i64 %indvars.iv1143, i64 7)
  %233 = add nsw i64 %polly.indvar491, %214
  %polly.loop_guard4981222 = icmp sgt i64 %233, -1
...
polly.loop_header495.preheader:                   ; preds = %polly.loop_header487
  ...
  %min.iters.check1383 = icmp ult i64 %232, 4
...
vector.body1376:                                  ; preds = %vector.body1376, %vector.ph1384
  ...
  %236 = add nuw nsw i64 %index1387, %194
  %237 = add nuw nsw i64 %index1387, %polly.access.mul.Packed_MemRef_call1309502
  %238 = getelementptr double, double* %Packed_MemRef_call1309, i64 %237
  %239 = bitcast double* %238 to <4 x double>*
  %wide.load1391 = load <4 x double>, <4 x double>* %239, align 8
  %240 = fmul fast <4 x double> %broadcast.splat1393, %wide.load1391
  %241 = getelementptr double, double* %Packed_MemRef_call2311, i64 %237
  %242 = bitcast double* %241 to <4 x double>*
  %wide.load1394 = load <4 x double>, <4 x double>* %242, align 8
  %243 = fmul fast <4 x double> %broadcast.splat1396, %wide.load1394
  %244 = shl i64 %236, 3
  %245 = add i64 %244, %235
  %246 = getelementptr i8, i8* %call, i64 %245
  %247 = bitcast i8* %246 to <4 x double>*
  %wide.load1397 = load <4 x double>, <4 x double>* %247, align 8, !alias.scope !86, !noalias !88
  ...
  %250 = fadd fast <4 x double> %249, %wide.load1397
  ...
  %252 = icmp eq i64 %index.next1388, %n.vec1386
  br i1 %252, label %middle.block1374, label %vector.body1376, !llvm.loop !97

middle.block1374:                                 ; preds = %vector.body1376
  %cmp.n1390 = icmp eq i64 %232, %n.vec1386
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1315 = icmp ult i64 %256, 4
...
vector.body1314:                                  ; preds = %vector.body1314, %vector.ph1316
  ...
  %258 = shl nuw nsw i64 %index1319, 3
  %259 = getelementptr i8, i8* %scevgep623, i64 %258
  %260 = bitcast i8* %259 to <4 x double>*
  %wide.load1323 = load <4 x double>, <4 x double>* %260, align 8, !alias.scope !99, !noalias !101
  %261 = fmul fast <4 x double> %wide.load1323, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %263 = icmp eq i64 %index.next1320, %n.vec1318
  br i1 %263, label %middle.block1312, label %vector.body1314, !llvm.loop !106

middle.block1312:                                 ; preds = %vector.body1314
  %cmp.n1322 = icmp eq i64 %256, %n.vec1318
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %smin1178 = call i64 @llvm.smin.i64(i64 %indvars.iv1156, i64 -872)
  %265 = add nsw i64 %smin1178, 1000
  %266 = shl nsw i64 %polly.indvar630, 7
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %indvars.iv.next1157 = add nsw i64 %indvars.iv1156, -128
  %exitcond1181.not = icmp eq i64 %polly.indvar_next631, 8
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %268 = udiv i64 %polly.indvar636, 12
  %269 = mul nuw nsw i64 %268, 96
  %270 = sub nsw i64 %267, %269
  %271 = mul nsw i64 %polly.indvar636, -8
  %272 = add i64 %271, %269
  %273 = udiv i64 %polly.indvar636, 12
  %274 = mul nuw nsw i64 %273, 96
  %275 = sub nsw i64 %indvars.iv1165, %274
  %276 = add i64 %indvars.iv1170, %274
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %indvars.iv.next1166 = add nuw nsw i64 %indvars.iv1165, 8
  %indvars.iv.next1171 = add nsw i64 %indvars.iv1170, -8
  %exitcond1180.not = icmp eq i64 %287, 150
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1159.not = icmp eq i64 %polly.indvar_next643, %265
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %indvars.iv1172 = phi i64 [ %indvars.iv.next1173, %polly.loop_exit699 ], [ %276, %polly.loop_exit641 ]
  %indvars.iv1167 = phi i64 [ %indvars.iv.next1168, %polly.loop_exit699 ], [ %275, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit699 ], [ %273, %polly.loop_exit641 ]
  %290 = mul nsw i64 %indvar1327, -96
  %291 = add i64 %270, %290
  %smax1329 = call i64 @llvm.smax.i64(i64 %291, i64 0)
  %292 = mul nuw nsw i64 %indvar1327, 96
  %293 = add i64 %272, %292
  %294 = add i64 %smax1329, %293
  %smax1169 = call i64 @llvm.smax.i64(i64 %indvars.iv1167, i64 0)
  %295 = add i64 %smax1169, %indvars.iv1172
  %296 = mul nuw nsw i64 %polly.indvar659, 12
  %.not.not945 = icmp ugt i64 %296, %polly.indvar636
  %297 = mul nuw nsw i64 %polly.indvar659, 96
  %298 = add nsw i64 %297, %277
  %299 = icmp sgt i64 %298, 0
  %300 = select i1 %299, i64 %298, i64 0
  %301 = add nsw i64 %298, 95
...
polly.loop_exit685.us:                            ; preds = %polly.loop_header683.us, %polly.loop_header662.us
  ...
  %exitcond1164.not = icmp eq i64 %polly.indvar_next666.us, %265
...
polly.loop_exit685:                               ; preds = %polly.loop_header683
  ...
  %exitcond1161.not = icmp eq i64 %polly.indvar_next666, %265
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %310 = mul nsw i64 %polly.indvar659, -96
  %311 = icmp slt i64 %310, -1104
  %312 = select i1 %311, i64 %310, i64 -1104
...
polly.loop_exit706:                               ; preds = %polly.loop_exit714
  ...
  %exitcond1179.not = icmp eq i64 %polly.indvar_next701, %265
...
polly.loop_header704:                             ; preds = %polly.loop_header697, %polly.loop_exit714
  ...
  %indvars.iv1174 = phi i64 [ %295, %polly.loop_header697 ], [ %indvars.iv.next1175, %polly.loop_exit714 ]
  %polly.indvar708 = phi i64 [ %309, %polly.loop_header697 ], [ %polly.indvar_next709, %polly.loop_exit714 ]
  %315 = add i64 %294, %indvar1330
  %smin1332 = call i64 @llvm.smin.i64(i64 %315, i64 7)
  %316 = add nsw i64 %smin1332, 1
  %smin1176 = call i64 @llvm.smin.i64(i64 %indvars.iv1174, i64 7)
  %317 = add nsw i64 %polly.indvar708, %298
  %polly.loop_guard7151223 = icmp sgt i64 %317, -1
...
polly.loop_header712.preheader:                   ; preds = %polly.loop_header704
  ...
  %min.iters.check1333 = icmp ult i64 %316, 4
...
vector.body1326:                                  ; preds = %vector.body1326, %vector.ph1334
  ...
  %320 = add nuw nsw i64 %index1337, %278
  %321 = add nuw nsw i64 %index1337, %polly.access.mul.Packed_MemRef_call1526719
  %322 = getelementptr double, double* %Packed_MemRef_call1526, i64 %321
  %323 = bitcast double* %322 to <4 x double>*
  %wide.load1341 = load <4 x double>, <4 x double>* %323, align 8
  %324 = fmul fast <4 x double> %broadcast.splat1343, %wide.load1341
  %325 = getelementptr double, double* %Packed_MemRef_call2528, i64 %321
  %326 = bitcast double* %325 to <4 x double>*
  %wide.load1344 = load <4 x double>, <4 x double>* %326, align 8
  %327 = fmul fast <4 x double> %broadcast.splat1346, %wide.load1344
  %328 = shl i64 %320, 3
  %329 = add i64 %328, %319
  %330 = getelementptr i8, i8* %call, i64 %329
  %331 = bitcast i8* %330 to <4 x double>*
  %wide.load1347 = load <4 x double>, <4 x double>* %331, align 8, !alias.scope !99, !noalias !101
  ...
  %334 = fadd fast <4 x double> %333, %wide.load1347
  ...
  %336 = icmp eq i64 %index.next1338, %n.vec1336
  br i1 %336, label %middle.block1324, label %vector.body1326, !llvm.loop !110

middle.block1324:                                 ; preds = %vector.body1326
  %cmp.n1340 = icmp eq i64 %316, %n.vec1336
...
vector.ph1254:                                    ; preds = %polly.loop_header876
  %broadcast.splatinsert1261 = insertelement <4 x i64> poison, i64 %344, i32 0
  %broadcast.splat1262 = shufflevector <4 x i64> %broadcast.splatinsert1261, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1263 = insertelement <4 x i32> poison, i32 %347, i32 0
...
vector.body1253:                                  ; preds = %vector.body1253, %vector.ph1254
  ...
  %349 = add nuw nsw <4 x i64> %vec.ind1259, %broadcast.splat1262
  %350 = trunc <4 x i64> %349 to <4 x i32>
  %351 = mul <4 x i32> %broadcast.splat1264, %350
  ...
  %361 = icmp eq i64 %index.next1256, %343
  br i1 %361, label %polly.loop_exit884, label %vector.body1253, !llvm.loop !117

polly.loop_exit884:                               ; preds = %vector.body1253, %polly.loop_header882
  %polly.indvar_next880 = add nuw nsw i64 %polly.indvar879, 1
  %exitcond1211.not = icmp eq i64 %polly.indvar879, %341
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  %exitcond1207.not = icmp eq i64 %polly.indvar885, %345
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %smin1268 = call i64 @llvm.smin.i64(i64 %371, i64 -968)
  %372 = add nsw i64 %smin1268, 1000
  %smin1196 = call i64 @llvm.smin.i64(i64 %indvars.iv1194, i64 -968)
  %373 = shl nsw i64 %polly.indvar900, 5
  %374 = add nsw i64 %smin1196, 999
...
vector.body1267:                                  ; preds = %vector.body1267, %vector.ph1270
  ...
  %378 = add nuw nsw <4 x i64> %vec.ind1277, %broadcast.splat1280
  %379 = trunc <4 x i64> %378 to <4 x i32>
  %380 = mul <4 x i32> %broadcast.splat1282, %379
  ...
  %390 = icmp eq i64 %index.next1274, %372
  br i1 %390, label %polly.loop_exit911, label %vector.body1267, !llvm.loop !120

polly.loop_exit911:                               ; preds = %vector.body1267, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1201.not = icmp eq i64 %polly.indvar906, %370
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %exitcond1197.not = icmp eq i64 %polly.indvar912, %374
...
polly.loop_header923:                             ; preds = %polly.loop_exit931, %polly.loop_header917
  ...
  %smin1286 = call i64 @llvm.smin.i64(i64 %400, i64 -968)
  %401 = add nsw i64 %smin1286, 1000
  %smin1186 = call i64 @llvm.smin.i64(i64 %indvars.iv1184, i64 -968)
  %402 = shl nsw i64 %polly.indvar926, 5
  %403 = add nsw i64 %smin1186, 999
...
vector.body1285:                                  ; preds = %vector.body1285, %vector.ph1288
  ...
  %407 = add nuw nsw <4 x i64> %vec.ind1295, %broadcast.splat1298
  %408 = trunc <4 x i64> %407 to <4 x i32>
  %409 = mul <4 x i32> %broadcast.splat1300, %408
  ...
  %419 = icmp eq i64 %index.next1292, %401
  br i1 %419, label %polly.loop_exit937, label %vector.body1285, !llvm.loop !123

polly.loop_exit937:                               ; preds = %vector.body1285, %polly.loop_header935
  %polly.indvar_next933 = add nuw nsw i64 %polly.indvar932, 1
  %exitcond1191.not = icmp eq i64 %polly.indvar932, %399
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  %exitcond1187.not = icmp eq i64 %polly.indvar938, %403
