; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6449.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6449.c"
...
vector.body1054:                                  ; preds = %vector.body1054, %vector.ph1058
  ...
  %wide.load1065 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %130, label %middle.block1052, label %vector.body1054, !llvm.loop !84
...
vector.body1030:                                  ; preds = %vector.body1030, %vector.ph1032
  ...
  %wide.load1039 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %165, label %middle.block1028, label %vector.body1030, !llvm.loop !94
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  br i1 %214, label %polly.loop_exit772, label %vector.body968, !llvm.loop !103
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph986
  ...
  br i1 %243, label %polly.loop_exit799, label %vector.body983, !llvm.loop !106
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1004
  ...
  br i1 %272, label %polly.loop_exit825, label %vector.body1001, !llvm.loop !109
