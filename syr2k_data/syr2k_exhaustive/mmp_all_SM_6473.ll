; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6473.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6473.c"
...
vector.body1045:                                  ; preds = %vector.body1045, %vector.ph1047
  ...
  br i1 %57, label %middle.block1043, label %vector.body1045, !llvm.loop !59
...
vector.body1071:                                  ; preds = %vector.body1071, %vector.ph1073
  ...
  br i1 %68, label %middle.block1069, label %vector.body1071, !llvm.loop !61
...
vector.body1083:                                  ; preds = %vector.body1083, %vector.ph1087
  ...
  %wide.load1094 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !67, !noalias !69
  ...
  br i1 %95, label %middle.block1081, label %vector.body1083, !llvm.loop !73
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar_next203, 20
...
vector.body1057:                                  ; preds = %vector.body1057, %vector.ph1061
  ...
  %wide.load1068 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %130, label %middle.block1055, label %vector.body1057, !llvm.loop !84
...
polly.loop_exit382:                               ; preds = %polly.loop_exit405
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar_next378, 20
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %137 = mul nuw nsw i64 %polly.indvar383, 50
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %138 = mul nsw i64 %polly.indvar383, -50
...
polly.loop_exit394:                               ; preds = %polly.loop_header392
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar_next390, 50
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  ...
  %142 = mul nuw nsw i64 %polly.indvar406, 100
  %143 = sub nsw i64 %137, %142
  %144 = icmp sgt i64 %143, 0
  %145 = select i1 %144, i64 %143, i64 0
  %polly.loop_guard419 = icmp slt i64 %145, 100
...
polly.loop_exit418.loopexit.us:                   ; preds = %polly.loop_exit426.us
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next413.us, 50
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1035
  ...
  %wide.load1042 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %165, label %middle.block1031, label %vector.body1033, !llvm.loop !94
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %172 = mul nuw nsw i64 %polly.indvar561, 50
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %173 = mul nsw i64 %polly.indvar561, -50
...
polly.loop_exit572:                               ; preds = %polly.loop_header570
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar_next568, 50
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  ...
  %177 = mul nuw nsw i64 %polly.indvar584, 100
...
polly.loop_exit596.loopexit.us:                   ; preds = %polly.loop_exit604.us
  ...
  %exitcond911.not = icmp eq i64 %polly.indvar_next591.us, 50
...
vector.body971:                                   ; preds = %vector.body971, %vector.ph973
  ...
  br i1 %214, label %polly.loop_exit772, label %vector.body971, !llvm.loop !103
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph989
  ...
  br i1 %243, label %polly.loop_exit799, label %vector.body986, !llvm.loop !106
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1007
  ...
  br i1 %272, label %polly.loop_exit825, label %vector.body1004, !llvm.loop !109
