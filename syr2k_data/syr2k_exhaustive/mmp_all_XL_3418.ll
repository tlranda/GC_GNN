; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3418.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3418.c"
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %108 = mul nuw nsw i64 %polly.indvar208, 100
...
polly.loop_header250.preheader:                   ; preds = %polly.loop_exit238, %polly.loop_exit238.us, %polly.loop_header211.split
  ...
  %127 = mul nsw i64 %polly.indvar214, -64
  %128 = icmp slt i64 %127, -1136
  %129 = select i1 %128, i64 %127, i64 -1136
...
vector.body1244:                                  ; preds = %vector.body1244, %vector.ph1248
  ...
  %wide.load1255 = load <4 x double>, <4 x double>* %148, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %151, label %middle.block1242, label %vector.body1244, !llvm.loop !85
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %154 = shl nsw i64 %polly.indvar396, 4
...
polly.loop_header399:                             ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %155 = shl nuw nsw i64 %indvars.iv1043, 2
  %156 = and i64 %155, 9223372036854775744
  ...
  %polly.loop_guard410 = icmp slt i64 %160, 19
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  ...
  %163 = mul nsw i64 %polly.indvar402, -100
  %164 = mul nuw nsw i64 %polly.indvar402, 100
...
polly.loop_header447.preheader:                   ; preds = %polly.loop_exit435, %polly.loop_exit435.us, %polly.loop_header407.split
  ...
  %183 = mul nsw i64 %polly.indvar411, -64
...
vector.body1220:                                  ; preds = %vector.body1220, %vector.ph1222
  ...
  %wide.load1229 = load <4 x double>, <4 x double>* %204, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %207, label %middle.block1218, label %vector.body1220, !llvm.loop !95
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %210 = shl nsw i64 %polly.indvar593, 4
...
polly.loop_header596:                             ; preds = %polly.loop_exit606, %polly.loop_header590
  ...
  %211 = shl nuw nsw i64 %indvars.iv1071, 2
  ...
  %polly.loop_guard607 = icmp slt i64 %216, 19
...
polly.loop_header604.preheader:                   ; preds = %polly.loop_header596
  ...
  %219 = mul nsw i64 %polly.indvar599, -100
  %220 = mul nuw nsw i64 %polly.indvar599, 100
...
polly.loop_exit646:                               ; preds = %polly.loop_exit653, %polly.loop_header644.preheader
  ...
  %indvars.iv.next1074 = add i64 %indvars.iv1073, -64
...
polly.loop_header644.preheader:                   ; preds = %polly.loop_exit632, %polly.loop_exit632.us, %polly.loop_header604.split
  ...
  %239 = mul nsw i64 %polly.indvar608, -64
...
vector.body1159:                                  ; preds = %vector.body1159, %vector.ph1160
  ...
  br i1 %277, label %polly.loop_exit829, label %vector.body1159, !llvm.loop !104
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1176
  ...
  br i1 %306, label %polly.loop_exit856, label %vector.body1173, !llvm.loop !107
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1194
  ...
  br i1 %335, label %polly.loop_exit882, label %vector.body1191, !llvm.loop !110
