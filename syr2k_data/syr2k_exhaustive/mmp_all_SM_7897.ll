; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7897.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7897.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %smin841 = call i64 @llvm.smin.i64(i64 %indvars.iv839, i64 -1072)
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar_next219, 10
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar_next225, 63
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1040
  ...
  %wide.load1047 = load <4 x double>, <4 x double>* %120, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %123, label %middle.block1034, label %vector.body1036, !llvm.loop !80
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_header362
  ...
  br i1 %exitcond871.not, label %polly.loop_exit364, label %polly.loop_header362, !llvm.loop !81
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %126 = shl nsw i64 %polly.indvar391, 7
...
polly.loop_exit396:                               ; preds = %polly.loop_exit403
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar_next392, 10
...
polly.loop_header394:                             ; preds = %polly.loop_exit403, %polly.loop_header388
  ...
  %smin860 = call i64 @llvm.smin.i64(i64 %indvars.iv858, i64 -984)
  %128 = shl nsw i64 %polly.indvar397, 4
...
polly.loop_exit403:                               ; preds = %polly.loop_exit409
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next398, 63
...
polly.loop_header401:                             ; preds = %polly.loop_exit409, %polly.loop_header394
  ...
  %130 = shl nsw i64 %polly.indvar404, 8
...
polly.loop_exit409:                               ; preds = %polly.loop_exit415
  ...
  %indvars.iv.next853 = add nsw i64 %indvars.iv852, -256
...
vector.body1012:                                  ; preds = %vector.body1012, %vector.ph1014
  ...
  %wide.load1021 = load <4 x double>, <4 x double>* %148, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %151, label %middle.block1010, label %vector.body1012, !llvm.loop !90
...
polly.loop_header538:                             ; preds = %polly.loop_header538.preheader, %polly.loop_header538
  ...
  br i1 %exitcond894.not, label %polly.loop_exit540, label %polly.loop_header538, !llvm.loop !91
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit572
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv885, i64 -1072)
  %154 = shl nsw i64 %polly.indvar567, 7
...
polly.loop_exit572:                               ; preds = %polly.loop_exit579
  ...
  %indvars.iv.next874 = add nuw nsw i64 %indvars.iv873, 128
  %indvars.iv.next886 = add nsw i64 %indvars.iv885, -128
  %exitcond891.not = icmp eq i64 %polly.indvar_next568, 10
...
polly.loop_header570:                             ; preds = %polly.loop_exit579, %polly.loop_header564
  ...
  %smin883 = call i64 @llvm.smin.i64(i64 %indvars.iv881, i64 -984)
  %156 = shl nsw i64 %polly.indvar573, 4
...
polly.loop_exit579:                               ; preds = %polly.loop_exit585
  ...
  %exitcond890.not = icmp eq i64 %polly.indvar_next574, 63
...
polly.loop_header577:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %158 = shl nsw i64 %polly.indvar580, 8
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %indvars.iv.next876 = add nsw i64 %indvars.iv875, -256
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %smin879 = call i64 @llvm.smin.i64(i64 %indvars.iv877, i64 255)
...
vector.body950:                                   ; preds = %vector.body950, %vector.ph952
  ...
  br i1 %193, label %polly.loop_exit766, label %vector.body950, !llvm.loop !99
...
polly.loop_header764:                             ; preds = %polly.loop_header758, %polly.loop_header764
  ...
  br i1 %exitcond919.not, label %polly.loop_exit766, label %polly.loop_header764, !llvm.loop !100
...
vector.body965:                                   ; preds = %vector.body965, %vector.ph968
  ...
  br i1 %222, label %polly.loop_exit793, label %vector.body965, !llvm.loop !102
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  br i1 %exitcond909.not, label %polly.loop_exit793, label %polly.loop_header791, !llvm.loop !103
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph986
  ...
  br i1 %251, label %polly.loop_exit819, label %vector.body983, !llvm.loop !105
...
polly.loop_header817:                             ; preds = %polly.loop_header811, %polly.loop_header817
  ...
  br i1 %exitcond899.not, label %polly.loop_exit819, label %polly.loop_header817, !llvm.loop !106
}
