; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3186.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3186.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1020.not = icmp eq i64 %polly.indvar_next203, 50
...
polly.loop_exit257:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar_next252, 20
...
vector.body1224:                                  ; preds = %vector.body1224, %vector.ph1228
  ...
  %wide.load1235 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %149, label %middle.block1222, label %vector.body1224, !llvm.loop !85
...
polly.loop_header391:                             ; preds = %polly.loop_header391.preheader, %polly.loop_exit399
  ...
  %151 = mul nuw nsw i64 %polly.indvar394, 20
...
polly.loop_exit399:                               ; preds = %polly.loop_exit406
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next395, 50
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  ...
  %.inv883 = icmp sgt i64 %164, 79
  %166 = select i1 %.inv883, i64 79, i64 %165
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_exit419.loopexit.us
  ...
  %exitcond1025.not = icmp eq i64 %polly.indvar_next414.us, 20
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next414, 20
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next447, 20
...
vector.body1200:                                  ; preds = %vector.body1200, %vector.ph1202
  ...
  %wide.load1209 = load <4 x double>, <4 x double>* %200, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %203, label %middle.block1198, label %vector.body1200, !llvm.loop !95
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  ...
  %.inv884 = icmp sgt i64 %218, 79
  %220 = select i1 %.inv884, i64 79, i64 %219
...
polly.loop_exit626.us:                            ; preds = %polly.loop_header624.us, %polly.loop_exit614.loopexit.us
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar_next609.us, 20
...
polly.loop_exit626:                               ; preds = %polly.loop_header624
  ...
  %exitcond1046.not = icmp eq i64 %polly.indvar_next609, 20
...
polly.loop_exit647:                               ; preds = %polly.loop_exit655
  ...
  %exitcond1064.not = icmp eq i64 %polly.indvar_next642, 20
...
vector.body1138:                                  ; preds = %vector.body1138, %vector.ph1140
  ...
  br i1 %271, label %polly.loop_exit823, label %vector.body1138, !llvm.loop !104
...
vector.body1153:                                  ; preds = %vector.body1153, %vector.ph1156
  ...
  br i1 %300, label %polly.loop_exit850, label %vector.body1153, !llvm.loop !107
...
vector.body1171:                                  ; preds = %vector.body1171, %vector.ph1174
  ...
  br i1 %329, label %polly.loop_exit876, label %vector.body1171, !llvm.loop !110
