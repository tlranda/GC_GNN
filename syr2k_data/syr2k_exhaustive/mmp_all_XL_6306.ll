; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6306.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6306.c"
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %149 = udiv i64 %indvars.iv878, 24
  %150 = mul nuw nsw i64 %149, 96
  %151 = sub nsw i64 %indvars.iv876, %150
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %193 = udiv i64 %indvars.iv902, 24
  %194 = mul nuw nsw i64 %193, 96
  %195 = sub nsw i64 %indvars.iv900, %194
  %196 = add i64 %indvars.iv907, %194
...
polly.loop_exit394.7:                             ; preds = %polly.loop_header392.7
  ...
  %pexp.p_div_q402 = udiv i64 %324, 24
...
polly.loop_exit572.7:                             ; preds = %polly.loop_header570.7
  ...
  %pexp.p_div_q580 = udiv i64 %333, 24
