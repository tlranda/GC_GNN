; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8918.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8918.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin784 = call i64 @llvm.smin.i64(i64 %indvars.iv782, i64 -920)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next783 = add nsw i64 %indvars.iv782, -80
  %exitcond788.not = icmp eq i64 %polly.indvar_next203, 13
...
vector.body984:                                   ; preds = %vector.body984, %vector.ph988
  ...
  %wide.load995 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !71, !noalias !73
  ...
  store <4 x double> %124, <4 x double>* %125, align 8, !alias.scope !71, !noalias !73
  %index.next992 = add i64 %index991, 4
  %126 = icmp eq i64 %index.next992, %n.vec990
  br i1 %126, label %middle.block982, label %vector.body984, !llvm.loop !76
...
polly.loop_header342:                             ; preds = %polly.loop_header342.preheader, %polly.loop_header342
  ...
  br i1 %exitcond811.not, label %polly.loop_exit344, label %polly.loop_header342, !llvm.loop !77
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph962
  ...
  %wide.load969 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !80, !noalias !82
  ...
  store <4 x double> %155, <4 x double>* %156, align 8, !alias.scope !80, !noalias !82
  %index.next966 = add i64 %index965, 4
  %157 = icmp eq i64 %index.next966, %n.vec964
  br i1 %157, label %middle.block958, label %vector.body960, !llvm.loop !85
...
polly.loop_header497:                             ; preds = %polly.loop_header497.preheader, %polly.loop_header497
  ...
  br i1 %exitcond833.not, label %polly.loop_exit499, label %polly.loop_header497, !llvm.loop !86
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %smin828 = call i64 @llvm.smin.i64(i64 %indvars.iv826, i64 -920)
  %159 = mul nuw nsw i64 %polly.indvar510, 80
...
polly.loop_exit515:                               ; preds = %polly.loop_exit521
  ...
  %exitcond832.not = icmp eq i64 %polly.indvar_next511, 13
...
vector.body898:                                   ; preds = %vector.body898, %vector.ph900
  ...
  store <4 x double> %196, <4 x double>* %201, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %202, label %polly.loop_exit706, label %vector.body898, !llvm.loop !94
...
polly.loop_header704:                             ; preds = %polly.loop_header698, %polly.loop_header704
  ...
  br i1 %exitcond858.not, label %polly.loop_exit706, label %polly.loop_header704, !llvm.loop !95
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph916
  ...
  store <4 x double> %225, <4 x double>* %230, align 8, !alias.scope !93, !noalias !96
  ...
  br i1 %231, label %polly.loop_exit733, label %vector.body913, !llvm.loop !97
...
polly.loop_header731:                             ; preds = %polly.loop_header725, %polly.loop_header731
  ...
  br i1 %exitcond848.not, label %polly.loop_exit733, label %polly.loop_header731, !llvm.loop !98
...
vector.body931:                                   ; preds = %vector.body931, %vector.ph934
  ...
  store <4 x double> %254, <4 x double>* %259, align 8, !alias.scope !92, !noalias !99
  ...
  br i1 %260, label %polly.loop_exit759, label %vector.body931, !llvm.loop !100
...
polly.loop_header757:                             ; preds = %polly.loop_header751, %polly.loop_header757
  ...
  br i1 %exitcond838.not, label %polly.loop_exit759, label %polly.loop_header757, !llvm.loop !101
}
