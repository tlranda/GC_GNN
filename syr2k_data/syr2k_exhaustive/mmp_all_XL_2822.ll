; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2822.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2822.c"
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %166 = shl nuw nsw i64 %polly.indvar396, 3
  %167 = mul nsw i64 %polly.indvar396, -64
  %168 = shl nsw i64 %polly.indvar396, 6
...
polly.loop_header399:                             ; preds = %polly.loop_exit440, %polly.loop_header393
  ...
  %.inv869 = icmp ugt i64 %170, 63
  %172 = select i1 %.inv869, i64 63, i64 %171
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %234 = shl nuw nsw i64 %polly.indvar586, 3
  %235 = mul nsw i64 %polly.indvar586, -64
  %236 = shl nsw i64 %polly.indvar586, 6
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %238, 63
  %240 = select i1 %.inv870, i64 63, i64 %239
