; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10644.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10644.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit214, %polly.loop_header199
  ...
  %indvars.iv.next793 = add nuw nsw i64 %indvars.iv792, 128
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit364
  ...
  %pexp.p_div_q360.lhs.trunc = add i8 %132, 2
  ...
  %.inv774 = icmp slt i64 %133, 14
  %135 = select i1 %.inv774, i64 %134, i64 14
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_exit372
  ...
  %141 = mul nsw i64 %polly.indvar366, 80
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit522
  ...
  %165 = shl nuw nsw i64 %polly.indvar515, 1
  %166 = trunc i64 %165 to i8
  %pexp.p_div_q518.lhs.trunc = add i8 %166, 2
  %pexp.p_div_q518776 = udiv i8 %pexp.p_div_q518.lhs.trunc, 5
  %pexp.p_div_q518.zext = zext i8 %pexp.p_div_q518776 to i64
  %167 = sub nsw i64 %165, %pexp.p_div_q518.zext
  %168 = add nsw i64 %167, 1
  %.inv775 = icmp slt i64 %167, 14
  %169 = select i1 %.inv775, i64 %168, i64 14
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit530
  ...
  %175 = mul nsw i64 %polly.indvar524, 80
