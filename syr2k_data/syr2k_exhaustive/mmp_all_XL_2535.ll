; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2535.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2535.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %103 = mul nsw i64 %polly.indvar225, -50
  %104 = add i64 %98, %103
  %105 = add i64 %smax1322, %104
  %106 = mul nuw nsw i64 %polly.indvar225, 50
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1325 = call i64 @llvm.smin.i64(i64 %113, i64 49)
  %114 = add nsw i64 %smin1325, 1
  %smin1026 = call i64 @llvm.smin.i64(i64 %indvars.iv1022, i64 49)
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %153 = mul nuw nsw i64 %polly.indvar423, 50
  %154 = add i64 %149, %153
...
polly.loop_exit429:                               ; preds = %polly.loop_exit465, %polly.loop_header420
  ...
  %indvars.iv.next1046 = add nsw i64 %indvars.iv1045, -50
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %smin1277 = call i64 @llvm.smin.i64(i64 %165, i64 49)
  %166 = add nsw i64 %smin1277, 1
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1047, i64 49)
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %205 = mul nuw nsw i64 %polly.indvar627, 50
  %206 = add i64 %201, %205
  %smax1226 = call i64 @llvm.smax.i64(i64 %206, i64 0)
  %207 = mul nsw i64 %polly.indvar627, -50
  %208 = add i64 %202, %207
  %209 = add i64 %smax1226, %208
  %210 = mul nuw nsw i64 %polly.indvar627, 50
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %smin1229 = call i64 @llvm.smin.i64(i64 %217, i64 49)
  %218 = add nsw i64 %smin1229, 1
  %smin1078 = call i64 @llvm.smin.i64(i64 %indvars.iv1073, i64 49)
