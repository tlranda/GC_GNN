; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2928.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2928.c"
...
vector.body1091:                                  ; preds = %vector.body1091, %vector.ph1093
  ...
  br i1 %57, label %middle.block1089, label %vector.body1091, !llvm.loop !58
...
vector.body1117:                                  ; preds = %vector.body1117, %vector.ph1119
  ...
  br i1 %68, label %middle.block1115, label %vector.body1117, !llvm.loop !60
...
vector.body1129:                                  ; preds = %vector.body1129, %vector.ph1133
  ...
  %wide.load1140 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !66, !noalias !68
  ...
  br i1 %95, label %middle.block1127, label %vector.body1129, !llvm.loop !72
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond912.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !73
...
vector.body1103:                                  ; preds = %vector.body1103, %vector.ph1107
  ...
  %wide.load1114 = load <4 x double>, <4 x double>* %155, align 8, !alias.scope !77, !noalias !79
  ...
  store <4 x double> %156, <4 x double>* %157, align 8, !alias.scope !77, !noalias !79
  %index.next1111 = add i64 %index1110, 4
  %158 = icmp eq i64 %index.next1111, %n.vec1109
  br i1 %158, label %middle.block1101, label %vector.body1103, !llvm.loop !83
...
polly.loop_header375:                             ; preds = %polly.loop_header375.preheader, %polly.loop_header375
  ...
  br i1 %exitcond934.not, label %polly.loop_exit377, label %polly.loop_header375, !llvm.loop !84
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %161 = shl nsw i64 %polly.indvar388, 4
...
vector.body1079:                                  ; preds = %vector.body1079, %vector.ph1081
  ...
  %wide.load1088 = load <4 x double>, <4 x double>* %218, align 8, !alias.scope !87, !noalias !89
  ...
  br i1 %221, label %middle.block1077, label %vector.body1079, !llvm.loop !93
...
polly.loop_header563:                             ; preds = %polly.loop_header563.preheader, %polly.loop_header563
  ...
  br i1 %exitcond956.not, label %polly.loop_exit565, label %polly.loop_header563, !llvm.loop !94
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %224 = shl nsw i64 %polly.indvar576, 4
...
vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1019
  ...
  store <4 x double> %292, <4 x double>* %297, align 8, !alias.scope !97, !noalias !99
  ...
  br i1 %298, label %polly.loop_exit803, label %vector.body1018, !llvm.loop !102
...
polly.loop_header801:                             ; preds = %polly.loop_header795, %polly.loop_header801
  ...
  br i1 %exitcond981.not, label %polly.loop_exit803, label %polly.loop_header801, !llvm.loop !103
...
vector.body1032:                                  ; preds = %vector.body1032, %vector.ph1035
  ...
  store <4 x double> %321, <4 x double>* %326, align 8, !alias.scope !101, !noalias !104
  ...
  br i1 %327, label %polly.loop_exit830, label %vector.body1032, !llvm.loop !105
...
polly.loop_header828:                             ; preds = %polly.loop_header822, %polly.loop_header828
  ...
  br i1 %exitcond971.not, label %polly.loop_exit830, label %polly.loop_header828, !llvm.loop !106
...
vector.body1050:                                  ; preds = %vector.body1050, %vector.ph1053
  ...
  store <4 x double> %350, <4 x double>* %355, align 8, !alias.scope !100, !noalias !107
  ...
  br i1 %356, label %polly.loop_exit856, label %vector.body1050, !llvm.loop !108
...
polly.loop_header854:                             ; preds = %polly.loop_header848, %polly.loop_header854
  ...
  br i1 %exitcond961.not, label %polly.loop_exit856, label %polly.loop_header854, !llvm.loop !109
}
