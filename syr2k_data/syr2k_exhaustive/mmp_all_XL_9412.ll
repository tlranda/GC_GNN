; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9412.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9412.c"
...
polly.loop_header365:                             ; preds = %polly.loop_exit379.3, %polly.loop_header358
  ...
  %144 = shl nsw i64 %polly.indvar368, 7
...
polly.loop_header521:                             ; preds = %polly.loop_exit535.3, %polly.loop_header514
  ...
  %177 = shl nsw i64 %polly.indvar524, 7
  %178 = sub nsw i64 %164, %177
  %smin811 = call i64 @llvm.smin.i64(i64 %indvars.iv807, i64 127)
...
polly.loop_exit535:                               ; preds = %polly.loop_exit542.loopexit.us, %polly.loop_header521
  ...
  %smin811.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next810, i64 127)
...
polly.loop_exit535.1:                             ; preds = %polly.loop_exit542.loopexit.us.1, %polly.loop_exit535
  ...
  %smin811.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next810.1, i64 127)
...
polly.loop_exit535.2:                             ; preds = %polly.loop_exit542.loopexit.us.2, %polly.loop_exit535.1
  ...
  %smin811.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next810.2, i64 127)
