; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4982.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4982.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %126 = shl nsw i64 %polly.indvar214, 8
...
vector.body1189:                                  ; preds = %vector.body1189, %vector.ph1193
  ...
  %wide.load1200 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %153, label %middle.block1187, label %vector.body1189, !llvm.loop !80
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %155 = lshr i64 %indvars.iv1015, 3
  %156 = mul nsw i64 %polly.indvar386, -96
  %157 = icmp slt i64 %156, -1104
  %158 = select i1 %157, i64 %156, i64 -1104
  %159 = add nsw i64 %158, 1199
  %160 = mul nuw nsw i64 %polly.indvar386, 96
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %184 = shl nsw i64 %polly.indvar399, 8
...
polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  ...
  %exitcond1017.not = icmp eq i64 %polly.indvar399, %155
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  ...
  %polly.loop_guard4201082 = icmp sgt i64 %191, -1
...
vector.body1165:                                  ; preds = %vector.body1165, %vector.ph1167
  ...
  %wide.load1174 = load <4 x double>, <4 x double>* %208, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %211, label %middle.block1163, label %vector.body1165, !llvm.loop !90
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %213 = lshr i64 %indvars.iv1040, 3
  %214 = mul nsw i64 %polly.indvar577, -96
  %215 = icmp slt i64 %214, -1104
  %216 = select i1 %215, i64 %214, i64 -1104
  %217 = add nsw i64 %216, 1199
  %218 = mul nuw nsw i64 %polly.indvar577, 96
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %242 = shl nsw i64 %polly.indvar590, 8
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar590, %213
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1032 = phi i64 [ %246, %polly.loop_header594.preheader ], [ %indvars.iv.next1033, %polly.loop_exit632 ]
  ...
  %polly.loop_guard6111083 = icmp sgt i64 %249, -1
...
vector.body1104:                                  ; preds = %vector.body1104, %vector.ph1105
  ...
  br i1 %283, label %polly.loop_exit807, label %vector.body1104, !llvm.loop !99

polly.loop_exit807:                               ; preds = %vector.body1104, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1074.not = icmp eq i64 %polly.indvar802, %263
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar808, %267
...
vector.body1118:                                  ; preds = %vector.body1118, %vector.ph1121
  ...
  br i1 %312, label %polly.loop_exit834, label %vector.body1118, !llvm.loop !102

polly.loop_exit834:                               ; preds = %vector.body1118, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1064.not = icmp eq i64 %polly.indvar829, %292
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar835, %296
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  br i1 %341, label %polly.loop_exit860, label %vector.body1136, !llvm.loop !105

polly.loop_exit860:                               ; preds = %vector.body1136, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1054.not = icmp eq i64 %polly.indvar855, %321
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar861, %325
