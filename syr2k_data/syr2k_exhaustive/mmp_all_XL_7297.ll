; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7297.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7297.c"
...
vector.body1038:                                  ; preds = %vector.body1038, %vector.ph1042
  ...
  %wide.load1049 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %129, label %middle.block1036, label %vector.body1038, !llvm.loop !80
...
vector.body1014:                                  ; preds = %vector.body1014, %vector.ph1016
  ...
  %wide.load1023 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %163, label %middle.block1012, label %vector.body1014, !llvm.loop !90
...
vector.body952:                                   ; preds = %vector.body952, %vector.ph954
  ...
  br i1 %211, label %polly.loop_exit778, label %vector.body952, !llvm.loop !99
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph970
  ...
  br i1 %240, label %polly.loop_exit805, label %vector.body967, !llvm.loop !102
...
vector.body985:                                   ; preds = %vector.body985, %vector.ph988
  ...
  br i1 %269, label %polly.loop_exit831, label %vector.body985, !llvm.loop !105
