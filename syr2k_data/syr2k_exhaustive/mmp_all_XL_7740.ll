; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7740.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7740.c"
...
for.cond1.preheader.i:                            ; preds = %entry, %for.inc17.i
  ...
  %scevgep931 = getelementptr i8, i8* %call2, i64 %12
  %scevgep930 = getelementptr i8, i8* %call2, i64 %11
  %scevgep929 = getelementptr i8, i8* %call1, i64 %12
  %scevgep928 = getelementptr i8, i8* %call1, i64 %11
  %bound0 = icmp ult i8* %scevgep928, %scevgep931
  %bound1 = icmp ult i8* %scevgep930, %scevgep929
...
for.inc17.i:                                      ; preds = %vector.body, %for.body3.i
  ...
  br i1 %exitcond18.not.i, label %vector.ph935, label %for.cond1.preheader.i, !llvm.loop !15

vector.ph935:                                     ; preds = %for.inc17.i, %for.inc41.i
  %indvars.iv7.i = phi i64 [ %indvars.iv.next8.i, %for.inc41.i ], [ 0, %for.inc17.i ]
  %broadcast.splatinsert942 = insertelement <4 x i64> poison, i64 %indvars.iv7.i, i32 0
...
vector.body934:                                   ; preds = %vector.body934, %vector.ph935
  %index936 = phi i64 [ 0, %vector.ph935 ], [ %index.next937, %vector.body934 ]
  %vec.ind940 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph935 ], [ %vec.ind.next941, %vector.body934 ]
  %32 = mul nuw nsw <4 x i64> %vec.ind940, %broadcast.splat943
  %33 = trunc <4 x i64> %32 to <4 x i32>
  %34 = add <4 x i32> %33, <i32 3, i32 3, i32 3, i32 3>
  %35 = urem <4 x i32> %34, <i32 1200, i32 1200, i32 1200, i32 1200>
  %36 = sitofp <4 x i32> %35 to <4 x double>
  %37 = fmul fast <4 x double> %36, <double 1.000000e-03, double 1.000000e-03, double 1.000000e-03, double 1.000000e-03>
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv7.i, i64 %index936
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next937 = add i64 %index936, 4
  %vec.ind.next941 = add <4 x i64> %vec.ind940, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next937, 1200
  br i1 %40, label %for.inc41.i, label %vector.body934, !llvm.loop !16

for.inc41.i:                                      ; preds = %vector.body934
  %indvars.iv.next8.i = add nuw nsw i64 %indvars.iv7.i, 1
  %exitcond9.not.i = icmp eq i64 %indvars.iv.next8.i, 1200
  br i1 %exitcond9.not.i, label %init_array.exit, label %vector.ph935, !llvm.loop !17
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check998 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check998, label %for.body3.i46.preheader1072, label %vector.ph999

vector.ph999:                                     ; preds = %for.body3.i46.preheader
  %n.vec1001 = and i64 %indvars.iv21.i, 9223372036854775804
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph999
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i, i64 %index1002
  ...
  %46 = icmp eq i64 %index.next1003, %n.vec1001
  br i1 %46, label %middle.block995, label %vector.body997, !llvm.loop !18

middle.block995:                                  ; preds = %vector.body997
  %cmp.n1005 = icmp eq i64 %indvars.iv21.i, %n.vec1001
  br i1 %cmp.n1005, label %for.inc6.i, label %for.body3.i46.preheader1072

for.body3.i46.preheader1072:                      ; preds = %for.body3.i46.preheader, %middle.block995
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec1001, %middle.block995 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1072, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1072 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block995, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1021 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1021, label %for.body3.i60.preheader1071, label %vector.ph1022

vector.ph1022:                                    ; preds = %for.body3.i60.preheader
  %n.vec1024 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1020:                                  ; preds = %vector.body1020, %vector.ph1022
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i52, i64 %index1025
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1029 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1029, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1026 = add i64 %index1025, 4
  %57 = icmp eq i64 %index.next1026, %n.vec1024
  br i1 %57, label %middle.block1018, label %vector.body1020, !llvm.loop !55

middle.block1018:                                 ; preds = %vector.body1020
  %cmp.n1028 = icmp eq i64 %indvars.iv21.i52, %n.vec1024
  br i1 %cmp.n1028, label %for.inc6.i63, label %for.body3.i60.preheader1071

for.body3.i60.preheader1071:                      ; preds = %for.body3.i60.preheader, %middle.block1018
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1024, %middle.block1018 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1071, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1071 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1018, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1047 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1047, label %for.body3.i99.preheader1070, label %vector.ph1048

vector.ph1048:                                    ; preds = %for.body3.i99.preheader
  %n.vec1050 = and i64 %indvars.iv21.i91, 9223372036854775804
  br label %vector.body1046

vector.body1046:                                  ; preds = %vector.body1046, %vector.ph1048
  %index1051 = phi i64 [ 0, %vector.ph1048 ], [ %index.next1052, %vector.body1046 ]
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i91, i64 %index1051
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1055 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1055, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1052 = add i64 %index1051, 4
  %68 = icmp eq i64 %index.next1052, %n.vec1050
  br i1 %68, label %middle.block1044, label %vector.body1046, !llvm.loop !57

middle.block1044:                                 ; preds = %vector.body1046
  %cmp.n1054 = icmp eq i64 %indvars.iv21.i91, %n.vec1050
  br i1 %cmp.n1054, label %for.inc6.i102, label %for.body3.i99.preheader1070

for.body3.i99.preheader1070:                      ; preds = %for.body3.i99.preheader, %middle.block1044
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1050, %middle.block1044 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1070, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1070 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1044, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit193, %polly.start
  %indvar1059 = phi i64 [ %indvar.next1060, %polly.loop_exit193 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1059, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1061 = icmp ult i64 %88, 4
  br i1 %min.iters.check1061, label %polly.loop_header191.preheader, label %vector.ph1062

vector.ph1062:                                    ; preds = %polly.loop_header
  %n.vec1064 = and i64 %88, -4
  br label %vector.body1058

vector.body1058:                                  ; preds = %vector.body1058, %vector.ph1062
  %index1065 = phi i64 [ 0, %vector.ph1062 ], [ %index.next1066, %vector.body1058 ]
  %90 = shl nuw nsw i64 %index1065, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1069 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  %93 = fmul fast <4 x double> %wide.load1069, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !63, !noalias !65
  %index.next1066 = add i64 %index1065, 4
  %95 = icmp eq i64 %index.next1066, %n.vec1064
  br i1 %95, label %middle.block1056, label %vector.body1058, !llvm.loop !69

middle.block1056:                                 ; preds = %vector.body1058
  %cmp.n1068 = icmp eq i64 %88, %n.vec1064
  br i1 %cmp.n1068, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block1056
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1064, %middle.block1056 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1056
  %polly.indvar_next = add nuw nsw i64 %polly.indvar, 1
  %exitcond847.not = icmp eq i64 %polly.indvar_next, 1200
  %indvar.next1060 = add i64 %indvar1059, 1
  br i1 %exitcond847.not, label %polly.loop_header199.preheader, label %polly.loop_header
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar_next195, %polly.indvar
  br i1 %exitcond846.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !70
...
polly.loop_exit207:                               ; preds = %polly.loop_header205
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar_next203, 1000
  br i1 %exitcond845.not, label %polly.loop_header215, label %polly.loop_header199
...
polly.loop_header205:                             ; preds = %polly.loop_header205, %polly.loop_header199
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar_next209, 1200
  br i1 %exitcond844.not, label %polly.loop_exit207, label %polly.loop_header205
...
polly.loop_exit223:                               ; preds = %polly.loop_exit230, %polly.loop_header215
  ...
  %exitcond843.not = icmp eq i64 %99, 13
  br i1 %exitcond843.not, label %polly.exiting, label %polly.loop_header215
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit230
  ...
  %polly.loop_guard231.not = icmp sgt i64 %108, %103
...
polly.loop_header228.preheader:                   ; preds = %polly.loop_header221
  ...
  %109 = add i64 %smax, %indvars.iv835
...
polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header221
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next225, %98
  br i1 %exitcond842.not, label %polly.loop_exit223, label %polly.loop_header221

polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  %indvars.iv837 = phi i64 [ %109, %polly.loop_header228.preheader ], [ %indvars.iv.next838, %polly.loop_exit237 ]
  %polly.indvar232 = phi i64 [ %108, %polly.loop_header228.preheader ], [ %polly.indvar_next233, %polly.loop_exit237 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv837, i64 127)
  %111 = add nsw i64 %polly.indvar232, %110
  %polly.loop_guard245923 = icmp sgt i64 %111, -1
  %112 = add nuw nsw i64 %polly.indvar232, %104
  %113 = mul i64 %112, 8000
  %114 = mul i64 %112, 9600
  br i1 %polly.loop_guard245923, label %polly.loop_header235.us, label %polly.loop_exit237
...
polly.loop_header235.us:                          ; preds = %polly.loop_header228, %polly.loop_exit244.loopexit.us
  ...
  %115 = shl nuw nsw i64 %polly.indvar238.us, 3
  %scevgep249.us = getelementptr i8, i8* %call1, i64 %115
  %polly.access.mul.Packed_MemRef_call2253.us = mul nuw nsw i64 %polly.indvar238.us, 1200
  %polly.access.add.Packed_MemRef_call2254.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2253.us, %112
  ...
  %scevgep262.us = getelementptr i8, i8* %scevgep249.us, i64 %113
...
polly.loop_header242.us:                          ; preds = %polly.loop_header242.us, %polly.loop_header235.us
  ...
  %116 = add nuw nsw i64 %polly.indvar246.us, %105
  ...
  %polly.access.add.Packed_MemRef_call2258.us = add nuw nsw i64 %116, %polly.access.mul.Packed_MemRef_call2253.us
...
polly.loop_exit237:                               ; preds = %polly.loop_exit244.loopexit.us, %polly.loop_header228
  ...
  %polly.loop_cond234.not.not = icmp ult i64 %polly.indvar232, %103
...
polly.loop_header356:                             ; preds = %polly.loop_exit364, %polly.start270
  %indvar1033 = phi i64 [ %indvar.next1034, %polly.loop_exit364 ], [ 0, %polly.start270 ]
  %polly.indvar359 = phi i64 [ %polly.indvar_next360, %polly.loop_exit364 ], [ 1, %polly.start270 ]
  %120 = add i64 %indvar1033, 1
  %121 = mul nuw nsw i64 %polly.indvar359, 9600
  %scevgep368 = getelementptr i8, i8* %call, i64 %121
  %min.iters.check1035 = icmp ult i64 %120, 4
  br i1 %min.iters.check1035, label %polly.loop_header362.preheader, label %vector.ph1036

vector.ph1036:                                    ; preds = %polly.loop_header356
  %n.vec1038 = and i64 %120, -4
...
vector.body1032:                                  ; preds = %vector.body1032, %vector.ph1036
  ...
  %122 = shl nuw nsw i64 %index1039, 3
  %123 = getelementptr i8, i8* %scevgep368, i64 %122
  %124 = bitcast i8* %123 to <4 x double>*
  %wide.load1043 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !74, !noalias !76
  %125 = fmul fast <4 x double> %wide.load1043, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %127 = icmp eq i64 %index.next1040, %n.vec1038
  br i1 %127, label %middle.block1030, label %vector.body1032, !llvm.loop !80

middle.block1030:                                 ; preds = %vector.body1032
  %cmp.n1042 = icmp eq i64 %120, %n.vec1038
  br i1 %cmp.n1042, label %polly.loop_exit364, label %polly.loop_header362.preheader

polly.loop_header362.preheader:                   ; preds = %polly.loop_header356, %middle.block1030
  %polly.indvar365.ph = phi i64 [ 0, %polly.loop_header356 ], [ %n.vec1038, %middle.block1030 ]
  br label %polly.loop_header362

polly.loop_exit364:                               ; preds = %polly.loop_header362, %middle.block1030
  %polly.indvar_next360 = add nuw nsw i64 %polly.indvar359, 1
  %exitcond869.not = icmp eq i64 %polly.indvar_next360, 1200
  %indvar.next1034 = add i64 %indvar1033, 1
  br i1 %exitcond869.not, label %polly.loop_header372.preheader, label %polly.loop_header356
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_header362
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar_next366, %polly.indvar359
  br i1 %exitcond868.not, label %polly.loop_exit364, label %polly.loop_header362, !llvm.loop !81
...
polly.loop_exit380:                               ; preds = %polly.loop_header378
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next376, 1000
  br i1 %exitcond867.not, label %polly.loop_header388, label %polly.loop_header372
...
polly.loop_header378:                             ; preds = %polly.loop_header378, %polly.loop_header372
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar_next382, 1200
  br i1 %exitcond866.not, label %polly.loop_exit380, label %polly.loop_header378

polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit398
  %indvars.iv862 = phi i64 [ %indvars.iv.next863, %polly.loop_exit398 ], [ 1, %polly.loop_exit380 ]
  %indvars.iv853 = phi i64 [ %indvars.iv.next854, %polly.loop_exit398 ], [ 0, %polly.loop_exit380 ]
  %indvars.iv848 = phi i64 [ %indvars.iv.next849, %polly.loop_exit398 ], [ 0, %polly.loop_exit380 ]
  %polly.indvar391 = phi i64 [ %131, %polly.loop_exit398 ], [ 0, %polly.loop_exit380 ]
  %129 = lshr i64 %indvars.iv862, 2
  %130 = sub nsw i64 %indvars.iv862, %129
  %131 = add nuw nsw i64 %polly.indvar391, 1
  %pexp.p_div_q394 = lshr i64 %131, 2
...
polly.loop_header396.preheader:                   ; preds = %polly.loop_header388
  %132 = mul nsw i64 %polly.indvar391, -96
  %133 = icmp slt i64 %132, -1104
  %134 = select i1 %133, i64 %132, i64 -1104
  %135 = add nsw i64 %134, 1199
  %136 = mul nuw nsw i64 %polly.indvar391, 96
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit406, %polly.loop_header388
  %indvars.iv.next849 = add nsw i64 %indvars.iv848, -96
  %indvars.iv.next854 = add nuw nsw i64 %indvars.iv853, 96
  %indvars.iv.next863 = add nuw nsw i64 %indvars.iv862, 1
  %exitcond865.not = icmp eq i64 %131, 13
  br i1 %exitcond865.not, label %polly.exiting271, label %polly.loop_header388

polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_exit406
  %indvars.iv855 = phi i64 [ %indvars.iv853, %polly.loop_header396.preheader ], [ %indvars.iv.next856, %polly.loop_exit406 ]
  %indvars.iv850 = phi i64 [ %indvars.iv848, %polly.loop_header396.preheader ], [ %indvars.iv.next851, %polly.loop_exit406 ]
  %polly.indvar400 = phi i64 [ 0, %polly.loop_header396.preheader ], [ %polly.indvar_next401, %polly.loop_exit406 ]
  %137 = shl nsw i64 %polly.indvar400, 7
  %138 = add nsw i64 %137, %132
  %139 = icmp sgt i64 %138, 0
  %140 = select i1 %139, i64 %138, i64 0
  %polly.loop_guard407.not = icmp sgt i64 %140, %135
...
polly.loop_header404.preheader:                   ; preds = %polly.loop_header396
  %smax852 = call i64 @llvm.smax.i64(i64 %indvars.iv850, i64 0)
  %141 = add i64 %smax852, %indvars.iv855
...
polly.loop_exit406:                               ; preds = %polly.loop_exit413, %polly.loop_header396
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar_next401, %130
  br i1 %exitcond864.not, label %polly.loop_exit398, label %polly.loop_header396

polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit413
  %indvars.iv857 = phi i64 [ %141, %polly.loop_header404.preheader ], [ %indvars.iv.next858, %polly.loop_exit413 ]
  %polly.indvar408 = phi i64 [ %140, %polly.loop_header404.preheader ], [ %polly.indvar_next409, %polly.loop_exit413 ]
  %smin859 = call i64 @llvm.smin.i64(i64 %indvars.iv857, i64 127)
  %143 = add nsw i64 %polly.indvar408, %142
  %polly.loop_guard421924 = icmp sgt i64 %143, -1
  %144 = add nuw nsw i64 %polly.indvar408, %136
  %145 = mul i64 %144, 8000
  %146 = mul i64 %144, 9600
  br i1 %polly.loop_guard421924, label %polly.loop_header411.us, label %polly.loop_exit413
...
polly.loop_header411.us:                          ; preds = %polly.loop_header404, %polly.loop_exit420.loopexit.us
  ...
  %147 = shl nuw nsw i64 %polly.indvar414.us, 3
  ...
  %polly.access.add.Packed_MemRef_call2273430.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2273429.us, %144
  ...
  %scevgep438.us = getelementptr i8, i8* %scevgep425.us, i64 %145
...
polly.loop_header418.us:                          ; preds = %polly.loop_header418.us, %polly.loop_header411.us
  ...
  %148 = add nuw nsw i64 %polly.indvar422.us, %137
  %149 = mul nuw nsw i64 %148, 8000
  %scevgep426.us = getelementptr i8, i8* %scevgep425.us, i64 %149
  ...
  %polly.access.add.Packed_MemRef_call2273434.us = add nuw nsw i64 %148, %polly.access.mul.Packed_MemRef_call2273429.us
  ...
  %150 = shl i64 %148, 3
  %151 = add i64 %150, %146
  %scevgep441.us = getelementptr i8, i8* %call, i64 %151
  ...
  %exitcond860.not = icmp eq i64 %polly.indvar422.us, %smin859
  br i1 %exitcond860.not, label %polly.loop_exit420.loopexit.us, label %polly.loop_header418.us

polly.loop_exit420.loopexit.us:                   ; preds = %polly.loop_header418.us
  %polly.indvar_next415.us = add nuw nsw i64 %polly.indvar414.us, 1
  %exitcond861.not = icmp eq i64 %polly.indvar_next415.us, 1000
  br i1 %exitcond861.not, label %polly.loop_exit413, label %polly.loop_header411.us
...
polly.loop_exit413:                               ; preds = %polly.loop_exit420.loopexit.us, %polly.loop_header404
  ...
  %polly.loop_cond410.not.not = icmp ult i64 %polly.indvar408, %135
...
polly.loop_header532:                             ; preds = %polly.loop_exit540, %polly.start446
  ...
  %min.iters.check1009 = icmp ult i64 %152, 4
  br i1 %min.iters.check1009, label %polly.loop_header538.preheader, label %vector.ph1010

vector.ph1010:                                    ; preds = %polly.loop_header532
  %n.vec1012 = and i64 %152, -4
...
vector.body1008:                                  ; preds = %vector.body1008, %vector.ph1010
  ...
  %154 = shl nuw nsw i64 %index1013, 3
  %155 = getelementptr i8, i8* %scevgep544, i64 %154
  %156 = bitcast i8* %155 to <4 x double>*
  %wide.load1017 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !84, !noalias !86
  %157 = fmul fast <4 x double> %wide.load1017, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %159 = icmp eq i64 %index.next1014, %n.vec1012
  br i1 %159, label %middle.block1006, label %vector.body1008, !llvm.loop !90

middle.block1006:                                 ; preds = %vector.body1008
  %cmp.n1016 = icmp eq i64 %152, %n.vec1012
  br i1 %cmp.n1016, label %polly.loop_exit540, label %polly.loop_header538.preheader

polly.loop_header538.preheader:                   ; preds = %polly.loop_header532, %middle.block1006
  %polly.indvar541.ph = phi i64 [ 0, %polly.loop_header532 ], [ %n.vec1012, %middle.block1006 ]
  br label %polly.loop_header538

polly.loop_exit540:                               ; preds = %polly.loop_header538, %middle.block1006
  %polly.indvar_next536 = add nuw nsw i64 %polly.indvar535, 1
  %exitcond891.not = icmp eq i64 %polly.indvar_next536, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond891.not, label %polly.loop_header548.preheader, label %polly.loop_header532
...
polly.loop_header538:                             ; preds = %polly.loop_header538.preheader, %polly.loop_header538
  ...
  %exitcond890.not = icmp eq i64 %polly.indvar_next542, %polly.indvar535
  br i1 %exitcond890.not, label %polly.loop_exit540, label %polly.loop_header538, !llvm.loop !91
...
polly.loop_exit556:                               ; preds = %polly.loop_header554
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar_next552, 1000
  br i1 %exitcond889.not, label %polly.loop_header564, label %polly.loop_header548
...
polly.loop_header554:                             ; preds = %polly.loop_header554, %polly.loop_header548
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next558, 1200
  br i1 %exitcond888.not, label %polly.loop_exit556, label %polly.loop_header554

polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit574
  %indvars.iv884 = phi i64 [ %indvars.iv.next885, %polly.loop_exit574 ], [ 1, %polly.loop_exit556 ]
  %indvars.iv875 = phi i64 [ %indvars.iv.next876, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %indvars.iv870 = phi i64 [ %indvars.iv.next871, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %polly.indvar567 = phi i64 [ %163, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %161 = lshr i64 %indvars.iv884, 2
  %162 = sub nsw i64 %indvars.iv884, %161
  %163 = add nuw nsw i64 %polly.indvar567, 1
  %pexp.p_div_q570 = lshr i64 %163, 2
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header564
  %164 = mul nsw i64 %polly.indvar567, -96
  %165 = icmp slt i64 %164, -1104
  %166 = select i1 %165, i64 %164, i64 -1104
  %167 = add nsw i64 %166, 1199
  %168 = mul nuw nsw i64 %polly.indvar567, 96
  br label %polly.loop_header572

polly.loop_exit574:                               ; preds = %polly.loop_exit582, %polly.loop_header564
  %indvars.iv.next871 = add nsw i64 %indvars.iv870, -96
  %indvars.iv.next876 = add nuw nsw i64 %indvars.iv875, 96
  %indvars.iv.next885 = add nuw nsw i64 %indvars.iv884, 1
  %exitcond887.not = icmp eq i64 %163, 13
  br i1 %exitcond887.not, label %polly.exiting447, label %polly.loop_header564

polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit582
  %indvars.iv877 = phi i64 [ %indvars.iv875, %polly.loop_header572.preheader ], [ %indvars.iv.next878, %polly.loop_exit582 ]
  %indvars.iv872 = phi i64 [ %indvars.iv870, %polly.loop_header572.preheader ], [ %indvars.iv.next873, %polly.loop_exit582 ]
  %polly.indvar576 = phi i64 [ 0, %polly.loop_header572.preheader ], [ %polly.indvar_next577, %polly.loop_exit582 ]
  %169 = shl nsw i64 %polly.indvar576, 7
  %170 = add nsw i64 %169, %164
  %171 = icmp sgt i64 %170, 0
  %172 = select i1 %171, i64 %170, i64 0
  %polly.loop_guard583.not = icmp sgt i64 %172, %167
...
polly.loop_header580.preheader:                   ; preds = %polly.loop_header572
  %smax874 = call i64 @llvm.smax.i64(i64 %indvars.iv872, i64 0)
  %173 = add i64 %smax874, %indvars.iv877
...
polly.loop_exit582:                               ; preds = %polly.loop_exit589, %polly.loop_header572
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar_next577, %162
  br i1 %exitcond886.not, label %polly.loop_exit574, label %polly.loop_header572

polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit589
  %indvars.iv879 = phi i64 [ %173, %polly.loop_header580.preheader ], [ %indvars.iv.next880, %polly.loop_exit589 ]
  %polly.indvar584 = phi i64 [ %172, %polly.loop_header580.preheader ], [ %polly.indvar_next585, %polly.loop_exit589 ]
  %smin881 = call i64 @llvm.smin.i64(i64 %indvars.iv879, i64 127)
  %175 = add nsw i64 %polly.indvar584, %174
  %polly.loop_guard597925 = icmp sgt i64 %175, -1
  %176 = add nuw nsw i64 %polly.indvar584, %168
  %177 = mul i64 %176, 8000
  %178 = mul i64 %176, 9600
  br i1 %polly.loop_guard597925, label %polly.loop_header587.us, label %polly.loop_exit589
...
polly.loop_header587.us:                          ; preds = %polly.loop_header580, %polly.loop_exit596.loopexit.us
  ...
  %179 = shl nuw nsw i64 %polly.indvar590.us, 3
  %scevgep601.us = getelementptr i8, i8* %call1, i64 %179
  %polly.access.mul.Packed_MemRef_call2449605.us = mul nuw nsw i64 %polly.indvar590.us, 1200
  %polly.access.add.Packed_MemRef_call2449606.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2449605.us, %176
  ...
  %scevgep614.us = getelementptr i8, i8* %scevgep601.us, i64 %177
...
polly.loop_header594.us:                          ; preds = %polly.loop_header594.us, %polly.loop_header587.us
  ...
  %180 = add nuw nsw i64 %polly.indvar598.us, %169
  %181 = mul nuw nsw i64 %180, 8000
  %scevgep602.us = getelementptr i8, i8* %scevgep601.us, i64 %181
  ...
  %polly.access.add.Packed_MemRef_call2449610.us = add nuw nsw i64 %180, %polly.access.mul.Packed_MemRef_call2449605.us
  ...
  %182 = shl i64 %180, 3
  %183 = add i64 %182, %178
  %scevgep617.us = getelementptr i8, i8* %call, i64 %183
...
polly.loop_exit596.loopexit.us:                   ; preds = %polly.loop_header594.us
  ...
  %exitcond883.not = icmp eq i64 %polly.indvar_next591.us, 1000
  br i1 %exitcond883.not, label %polly.loop_exit589, label %polly.loop_header587.us
...
polly.loop_header746:                             ; preds = %entry, %polly.loop_exit754
  %indvars.iv916 = phi i64 [ %indvars.iv.next917, %polly.loop_exit754 ], [ 0, %entry ]
...
polly.loop_exit754:                               ; preds = %polly.loop_exit760
  ...
  %exitcond921.not = icmp eq i64 %polly.indvar_next750, 38
  br i1 %exitcond921.not, label %polly.loop_header773, label %polly.loop_header746

polly.loop_header752:                             ; preds = %polly.loop_exit760, %polly.loop_header746
  %indvars.iv912 = phi i64 [ %indvars.iv.next913, %polly.loop_exit760 ], [ 0, %polly.loop_header746 ]
  %polly.indvar755 = phi i64 [ %polly.indvar_next756, %polly.loop_exit760 ], [ 0, %polly.loop_header746 ]
  %186 = mul nsw i64 %polly.indvar755, -32
  %smin947 = call i64 @llvm.smin.i64(i64 %186, i64 -1168)
  %187 = add nsw i64 %smin947, 1200
  %smin914 = call i64 @llvm.smin.i64(i64 %indvars.iv912, i64 -1168)
  %188 = shl nsw i64 %polly.indvar755, 5
  %189 = add nsw i64 %smin914, 1199
...
polly.loop_exit760:                               ; preds = %polly.loop_exit766
  ...
  %exitcond920.not = icmp eq i64 %polly.indvar_next756, 38
  br i1 %exitcond920.not, label %polly.loop_exit754, label %polly.loop_header752
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  br i1 %min.iters.check, label %polly.loop_header764, label %vector.ph948

vector.ph948:                                     ; preds = %polly.loop_header758
  %broadcast.splatinsert955 = insertelement <4 x i64> poison, i64 %188, i32 0
  %broadcast.splat956 = shufflevector <4 x i64> %broadcast.splatinsert955, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert957 = insertelement <4 x i32> poison, i32 %191, i32 0
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph948
  %index949 = phi i64 [ 0, %vector.ph948 ], [ %index.next950, %vector.body946 ]
  %vec.ind953 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph948 ], [ %vec.ind.next954, %vector.body946 ]
  %193 = add nuw nsw <4 x i64> %vec.ind953, %broadcast.splat956
  %194 = trunc <4 x i64> %193 to <4 x i32>
  %195 = mul <4 x i32> %broadcast.splat958, %194
  ...
  %205 = icmp eq i64 %index.next950, %187
  br i1 %205, label %polly.loop_exit766, label %vector.body946, !llvm.loop !99

polly.loop_exit766:                               ; preds = %vector.body946, %polly.loop_header764
  %polly.indvar_next762 = add nuw nsw i64 %polly.indvar761, 1
  %exitcond919.not = icmp eq i64 %polly.indvar761, %185
  br i1 %exitcond919.not, label %polly.loop_exit760, label %polly.loop_header758
...
polly.loop_header764:                             ; preds = %polly.loop_header758, %polly.loop_header764
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar767, %189
  br i1 %exitcond915.not, label %polly.loop_exit766, label %polly.loop_header764, !llvm.loop !100

polly.loop_header773:                             ; preds = %polly.loop_exit754, %polly.loop_exit781
  %indvars.iv906 = phi i64 [ %indvars.iv.next907, %polly.loop_exit781 ], [ 0, %polly.loop_exit754 ]
...
polly.loop_exit781:                               ; preds = %polly.loop_exit787
  ...
  %exitcond911.not = icmp eq i64 %polly.indvar_next777, 38
  br i1 %exitcond911.not, label %polly.loop_header799, label %polly.loop_header773

polly.loop_header779:                             ; preds = %polly.loop_exit787, %polly.loop_header773
  %indvars.iv902 = phi i64 [ %indvars.iv.next903, %polly.loop_exit787 ], [ 0, %polly.loop_header773 ]
  %polly.indvar782 = phi i64 [ %polly.indvar_next783, %polly.loop_exit787 ], [ 0, %polly.loop_header773 ]
  %215 = mul nsw i64 %polly.indvar782, -32
  %smin962 = call i64 @llvm.smin.i64(i64 %215, i64 -968)
  %216 = add nsw i64 %smin962, 1000
  %smin904 = call i64 @llvm.smin.i64(i64 %indvars.iv902, i64 -968)
  %217 = shl nsw i64 %polly.indvar782, 5
  %218 = add nsw i64 %smin904, 999
...
polly.loop_exit787:                               ; preds = %polly.loop_exit793
  ...
  %exitcond910.not = icmp eq i64 %polly.indvar_next783, 32
  br i1 %exitcond910.not, label %polly.loop_exit781, label %polly.loop_header779
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %min.iters.check963 = icmp eq i64 %216, 0
  br i1 %min.iters.check963, label %polly.loop_header791, label %vector.ph964

vector.ph964:                                     ; preds = %polly.loop_header785
  %broadcast.splatinsert973 = insertelement <4 x i64> poison, i64 %217, i32 0
  %broadcast.splat974 = shufflevector <4 x i64> %broadcast.splatinsert973, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert975 = insertelement <4 x i32> poison, i32 %220, i32 0
...
vector.body961:                                   ; preds = %vector.body961, %vector.ph964
  %index967 = phi i64 [ 0, %vector.ph964 ], [ %index.next968, %vector.body961 ]
  %vec.ind971 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph964 ], [ %vec.ind.next972, %vector.body961 ]
  %222 = add nuw nsw <4 x i64> %vec.ind971, %broadcast.splat974
  %223 = trunc <4 x i64> %222 to <4 x i32>
  %224 = mul <4 x i32> %broadcast.splat976, %223
  ...
  %234 = icmp eq i64 %index.next968, %216
  br i1 %234, label %polly.loop_exit793, label %vector.body961, !llvm.loop !102

polly.loop_exit793:                               ; preds = %vector.body961, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond909.not = icmp eq i64 %polly.indvar788, %214
  br i1 %exitcond909.not, label %polly.loop_exit787, label %polly.loop_header785
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar794, %218
  br i1 %exitcond905.not, label %polly.loop_exit793, label %polly.loop_header791, !llvm.loop !103

polly.loop_header799:                             ; preds = %polly.loop_exit781, %polly.loop_exit807
  %indvars.iv896 = phi i64 [ %indvars.iv.next897, %polly.loop_exit807 ], [ 0, %polly.loop_exit781 ]
...
polly.loop_exit807:                               ; preds = %polly.loop_exit813
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar_next803, 38
  br i1 %exitcond901.not, label %init_array.exit, label %polly.loop_header799

polly.loop_header805:                             ; preds = %polly.loop_exit813, %polly.loop_header799
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit813 ], [ 0, %polly.loop_header799 ]
  %polly.indvar808 = phi i64 [ %polly.indvar_next809, %polly.loop_exit813 ], [ 0, %polly.loop_header799 ]
  %244 = mul nsw i64 %polly.indvar808, -32
  %smin980 = call i64 @llvm.smin.i64(i64 %244, i64 -968)
  %245 = add nsw i64 %smin980, 1000
  %smin894 = call i64 @llvm.smin.i64(i64 %indvars.iv892, i64 -968)
  %246 = shl nsw i64 %polly.indvar808, 5
  %247 = add nsw i64 %smin894, 999
  br label %polly.loop_header811

polly.loop_exit813:                               ; preds = %polly.loop_exit819
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %indvars.iv.next893 = add nsw i64 %indvars.iv892, -32
  %exitcond900.not = icmp eq i64 %polly.indvar_next809, 32
  br i1 %exitcond900.not, label %polly.loop_exit807, label %polly.loop_header805
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %min.iters.check981 = icmp eq i64 %245, 0
  br i1 %min.iters.check981, label %polly.loop_header817, label %vector.ph982

vector.ph982:                                     ; preds = %polly.loop_header811
  %broadcast.splatinsert991 = insertelement <4 x i64> poison, i64 %246, i32 0
  %broadcast.splat992 = shufflevector <4 x i64> %broadcast.splatinsert991, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert993 = insertelement <4 x i32> poison, i32 %249, i32 0
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph982
  ...
  %251 = add nuw nsw <4 x i64> %vec.ind989, %broadcast.splat992
  %252 = trunc <4 x i64> %251 to <4 x i32>
  %253 = mul <4 x i32> %broadcast.splat994, %252
  ...
  %263 = icmp eq i64 %index.next986, %245
  br i1 %263, label %polly.loop_exit819, label %vector.body979, !llvm.loop !105

polly.loop_exit819:                               ; preds = %vector.body979, %polly.loop_header817
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %exitcond899.not = icmp eq i64 %polly.indvar814, %243
  br i1 %exitcond899.not, label %polly.loop_exit813, label %polly.loop_header811
...
polly.loop_header817:                             ; preds = %polly.loop_header811, %polly.loop_header817
  ...
  %exitcond895.not = icmp eq i64 %polly.indvar820, %247
  br i1 %exitcond895.not, label %polly.loop_exit819, label %polly.loop_header817, !llvm.loop !106
}
