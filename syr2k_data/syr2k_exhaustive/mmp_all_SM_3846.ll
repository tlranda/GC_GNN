; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3846.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3846.c"
...
vector.body1343:                                  ; preds = %vector.body1343, %vector.ph1345
  ...
  br i1 %57, label %middle.block1341, label %vector.body1343, !llvm.loop !59
...
vector.body1369:                                  ; preds = %vector.body1369, %vector.ph1371
  ...
  br i1 %68, label %middle.block1367, label %vector.body1369, !llvm.loop !61
...
vector.body1381:                                  ; preds = %vector.body1381, %vector.ph1385
  ...
  %wide.load1392 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !67, !noalias !69
  ...
  br i1 %95, label %middle.block1379, label %vector.body1381, !llvm.loop !73
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1132.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %108 = mul nsw i64 %polly.indvar208, -80
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit265
  ...
  %109 = add i64 %smax1122, %indvars.iv1125
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1114, i64 0)
  %110 = mul nsw i64 %polly.indvar214, 5
  %.not = icmp slt i64 %110, %106
  %111 = mul nsw i64 %polly.indvar214, 100
  %112 = add nsw i64 %111, %108
  %113 = icmp sgt i64 %112, 80
  %114 = select i1 %113, i64 %112, i64 80
  %115 = add nsw i64 %112, 99
  %polly.loop_guard252 = icmp sgt i64 %112, -100
...
polly.loop_header249.us:                          ; preds = %polly.loop_header249.preheader.us, %polly.loop_header249.us
  ...
  %116 = add nuw nsw i64 %polly.indvar253.us, %107
  %polly.access.mul.call1257.us = mul nuw nsw i64 %116, 1000
...
polly.merge.us:                                   ; preds = %polly.loop_header249.us, %polly.loop_header217.us
  ...
  %exitcond1117.not = icmp eq i64 %polly.indvar_next221.us, 100
...
polly.loop_header217.us955:                       ; preds = %polly.loop_header211.split, %polly.merge.us992
  ...
  %118 = add nuw nsw i64 %polly.indvar220.us956, %97
...
polly.loop_header223.us957:                       ; preds = %polly.loop_header217.us955, %polly.loop_header223.us957
  ...
  %119 = add nuw nsw i64 %polly.indvar226.us958, %107
  %polly.access.mul.call1230.us959 = mul nuw nsw i64 %119, 1000
  %polly.access.add.call1231.us960 = add nuw nsw i64 %polly.access.mul.call1230.us959, %118
...
polly.merge.us992:                                ; preds = %polly.loop_header223.us957
  ...
  %exitcond1111.not = icmp eq i64 %polly.indvar_next221.us993, 100
...
polly.merge:                                      ; preds = %polly.loop_header234
  ...
  %exitcond1109.not = icmp eq i64 %polly.indvar_next221, 100
...
polly.loop_header263.preheader:                   ; preds = %polly.merge, %polly.merge.us992, %polly.merge.us
  %121 = sub nsw i64 %107, %111
  %122 = icmp sgt i64 %121, 0
  %123 = select i1 %122, i64 %121, i64 0
  %polly.loop_guard273 = icmp slt i64 %123, 100
...
polly.loop_header270.us:                          ; preds = %polly.loop_header263.us, %polly.loop_exit280.us
  %indvars.iv1127 = phi i64 [ %109, %polly.loop_header263.us ], [ %indvars.iv.next1128, %polly.loop_exit280.us ]
  ...
  %127 = add i64 %126, %108
  %polly.loop_guard281.us1234 = icmp sgt i64 %127, -1
...
polly.loop_header278.us:                          ; preds = %polly.loop_header278.preheader.us, %polly.loop_header278.us
  ...
  %128 = add nuw nsw i64 %polly.indvar282.us, %107
...
polly.loop_exit272.loopexit.us:                   ; preds = %polly.loop_exit280.us
  ...
  %exitcond1130.not = icmp eq i64 %polly.indvar_next267.us, 100
...
polly.loop_header223:                             ; preds = %polly.loop_header217, %polly.loop_header223
  ...
  %136 = add nuw nsw i64 %polly.indvar226, %107
  %polly.access.mul.call1230 = mul nuw nsw i64 %136, 1000
...
polly.loop_header234:                             ; preds = %polly.loop_header223, %polly.loop_header234
  %polly.indvar238 = phi i64 [ %polly.indvar_next239, %polly.loop_header234 ], [ %114, %polly.loop_header223 ]
  %137 = add nuw nsw i64 %polly.indvar238, %107
  %polly.access.mul.call1242 = mul nsw i64 %137, 1000
  %polly.access.add.call1243 = add nuw nsw i64 %polly.access.mul.call1242, %120
...
vector.body1355:                                  ; preds = %vector.body1355, %vector.ph1359
  ...
  %140 = shl nuw nsw i64 %index1362, 3
  %141 = getelementptr i8, i8* %scevgep402, i64 %140
  %142 = bitcast i8* %141 to <4 x double>*
  %wide.load1366 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !78, !noalias !80
  %143 = fmul fast <4 x double> %wide.load1366, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %145 = icmp eq i64 %index.next1363, %n.vec1361
  br i1 %145, label %middle.block1353, label %vector.body1355, !llvm.loop !84

middle.block1353:                                 ; preds = %vector.body1355
  %cmp.n1365 = icmp eq i64 %138, %n.vec1361
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_header396
  ...
  br i1 %exitcond1164.not, label %polly.loop_exit398, label %polly.loop_header396, !llvm.loop !85
...
polly.loop_exit414:                               ; preds = %polly.loop_exit422
  ...
  %exitcond1163.not = icmp eq i64 %polly.indvar_next410, 10
...
polly.loop_header412:                             ; preds = %polly.loop_exit422, %polly.loop_header406
  ...
  %148 = udiv i64 %indvars.iv1141, 5
  %149 = mul nuw nsw i64 %148, 100
  %150 = trunc i64 %polly.indvar415 to i8
  %pexp.p_div_q418.lhs.trunc = add i8 %150, 4
  %pexp.p_div_q418939 = udiv i8 %pexp.p_div_q418.lhs.trunc, 5
  %pexp.p_div_q418.zext = zext i8 %pexp.p_div_q418939 to i64
  %151 = sub nsw i64 %polly.indvar415, %pexp.p_div_q418.zext
  %polly.loop_guard423 = icmp slt i64 %151, 12
...
polly.loop_header420.preheader:                   ; preds = %polly.loop_header412
  %152 = sub nsw i64 %indvars.iv1139, %149
  %153 = sub nsw i64 %indvars.iv1153, %149
  %154 = add i64 %indvars.iv1148, %149
  %155 = shl nsw i64 %polly.indvar415, 2
  %156 = or i64 %155, 1
  %157 = mul nuw nsw i64 %polly.indvar415, 80
  %158 = mul nsw i64 %polly.indvar415, -80
...
polly.loop_header420:                             ; preds = %polly.loop_header420.preheader, %polly.loop_exit479
  %indvars.iv1155 = phi i64 [ %153, %polly.loop_header420.preheader ], [ %indvars.iv.next1156, %polly.loop_exit479 ]
  %indvars.iv1150 = phi i64 [ %154, %polly.loop_header420.preheader ], [ %indvars.iv.next1151, %polly.loop_exit479 ]
  %indvars.iv1143 = phi i64 [ %152, %polly.loop_header420.preheader ], [ %indvars.iv.next1144, %polly.loop_exit479 ]
  %polly.indvar424 = phi i64 [ %151, %polly.loop_header420.preheader ], [ %polly.indvar_next425, %polly.loop_exit479 ]
  %smax1152 = call i64 @llvm.smax.i64(i64 %indvars.iv1150, i64 0)
  %159 = add i64 %smax1152, %indvars.iv1155
  %smax1145 = call i64 @llvm.smax.i64(i64 %indvars.iv1143, i64 0)
  %160 = mul nsw i64 %polly.indvar424, 5
  %.not936 = icmp slt i64 %160, %156
  %161 = mul nsw i64 %polly.indvar424, 100
  %162 = add nsw i64 %161, %158
  %163 = icmp sgt i64 %162, 80
  %164 = select i1 %163, i64 %162, i64 80
  %165 = add nsw i64 %162, 99
  %polly.loop_guard466 = icmp sgt i64 %162, -100
...
polly.loop_header463.us:                          ; preds = %polly.loop_header463.preheader.us, %polly.loop_header463.us
  ...
  %166 = add nuw nsw i64 %polly.indvar467.us, %157
  %polly.access.mul.call1471.us = mul nuw nsw i64 %166, 1000
  %polly.access.add.call1472.us = add nuw nsw i64 %167, %polly.access.mul.call1471.us
...
polly.merge434.us:                                ; preds = %polly.loop_header463.us, %polly.loop_header427.us
  ...
  %exitcond1147.not = icmp eq i64 %polly.indvar_next431.us, 100
...
polly.loop_header463.preheader.us:                ; preds = %polly.loop_header427.us
  %167 = add nuw nsw i64 %polly.indvar430.us, %147
...
polly.loop_header427.us1002:                      ; preds = %polly.loop_header420.split, %polly.merge434.us1039
  ...
  %168 = add nuw nsw i64 %polly.indvar430.us1003, %147
...
polly.loop_header437.us1004:                      ; preds = %polly.loop_header427.us1002, %polly.loop_header437.us1004
  ...
  %169 = add nuw nsw i64 %polly.indvar440.us1005, %157
  %polly.access.mul.call1444.us1006 = mul nuw nsw i64 %169, 1000
  %polly.access.add.call1445.us1007 = add nuw nsw i64 %polly.access.mul.call1444.us1006, %168
  ...
  br i1 %exitcond1137.not, label %polly.merge434.us1039, label %polly.loop_header437.us1004
...
polly.merge434.us1039:                            ; preds = %polly.loop_header437.us1004
  ...
  %exitcond1138.not = icmp eq i64 %polly.indvar_next431.us1040, 100
...
polly.loop_header427:                             ; preds = %polly.loop_header420.split, %polly.merge434
  ...
  %170 = add nuw nsw i64 %polly.indvar430, %147
...
polly.merge434:                                   ; preds = %polly.loop_header448
  ...
  %exitcond1136.not = icmp eq i64 %polly.indvar_next431, 100
...
polly.loop_header477.preheader:                   ; preds = %polly.merge434, %polly.merge434.us1039, %polly.merge434.us
  %171 = sub nsw i64 %157, %161
  %172 = icmp sgt i64 %171, 0
  %173 = select i1 %172, i64 %171, i64 0
  %polly.loop_guard487 = icmp slt i64 %173, 100
...
polly.loop_header484.us:                          ; preds = %polly.loop_header477.us, %polly.loop_exit494.us
  %indvars.iv1157 = phi i64 [ %159, %polly.loop_header477.us ], [ %indvars.iv.next1158, %polly.loop_exit494.us ]
  ...
  %177 = add i64 %176, %158
  %polly.loop_guard495.us1235 = icmp sgt i64 %177, -1
...
polly.loop_header492.us:                          ; preds = %polly.loop_header492.preheader.us, %polly.loop_header492.us
  ...
  %178 = add nuw nsw i64 %polly.indvar496.us, %157
...
polly.loop_exit486.loopexit.us:                   ; preds = %polly.loop_exit494.us
  ...
  %exitcond1161.not = icmp eq i64 %polly.indvar_next481.us, 100
...
polly.loop_header437:                             ; preds = %polly.loop_header427, %polly.loop_header437
  ...
  %186 = add nuw nsw i64 %polly.indvar440, %157
  %polly.access.mul.call1444 = mul nuw nsw i64 %186, 1000
  %polly.access.add.call1445 = add nuw nsw i64 %polly.access.mul.call1444, %170
...
polly.loop_header448:                             ; preds = %polly.loop_header437, %polly.loop_header448
  %polly.indvar452 = phi i64 [ %polly.indvar_next453, %polly.loop_header448 ], [ %164, %polly.loop_header437 ]
  %187 = add nuw nsw i64 %polly.indvar452, %157
  %polly.access.mul.call1456 = mul nsw i64 %187, 1000
  %polly.access.add.call1457 = add nuw nsw i64 %polly.access.mul.call1456, %170
  ...
  %polly.loop_cond454.not.not = icmp slt i64 %polly.indvar452, %165
...
polly.loop_header604:                             ; preds = %polly.loop_exit612, %polly.start518
  ...
  %189 = mul nuw nsw i64 %polly.indvar607, 9600
  %scevgep616 = getelementptr i8, i8* %call, i64 %189
  %min.iters.check1332 = icmp ult i64 %188, 4
...
vector.body1331:                                  ; preds = %vector.body1331, %vector.ph1333
  ...
  %190 = shl nuw nsw i64 %index1336, 3
  %191 = getelementptr i8, i8* %scevgep616, i64 %190
  %192 = bitcast i8* %191 to <4 x double>*
  %wide.load1340 = load <4 x double>, <4 x double>* %192, align 8, !alias.scope !88, !noalias !90
  %193 = fmul fast <4 x double> %wide.load1340, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %195 = icmp eq i64 %index.next1337, %n.vec1335
  br i1 %195, label %middle.block1329, label %vector.body1331, !llvm.loop !94

middle.block1329:                                 ; preds = %vector.body1331
  %cmp.n1339 = icmp eq i64 %188, %n.vec1335
...
polly.loop_header610:                             ; preds = %polly.loop_header610.preheader, %polly.loop_header610
  ...
  %196 = shl nuw nsw i64 %polly.indvar613, 3
  %scevgep617 = getelementptr i8, i8* %scevgep616, i64 %196
  ...
  br i1 %exitcond1195.not, label %polly.loop_exit612, label %polly.loop_header610, !llvm.loop !95
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %197 = mul nuw nsw i64 %polly.indvar623, 100
...
polly.loop_exit628:                               ; preds = %polly.loop_exit636
  ...
  %exitcond1194.not = icmp eq i64 %polly.indvar_next624, 10
...
polly.loop_header626:                             ; preds = %polly.loop_exit636, %polly.loop_header620
  ...
  %198 = udiv i64 %indvars.iv1172, 5
  %199 = mul nuw nsw i64 %198, 100
  %200 = trunc i64 %polly.indvar629 to i8
  %pexp.p_div_q632.lhs.trunc = add i8 %200, 4
  %pexp.p_div_q632938 = udiv i8 %pexp.p_div_q632.lhs.trunc, 5
  %pexp.p_div_q632.zext = zext i8 %pexp.p_div_q632938 to i64
  %201 = sub nsw i64 %polly.indvar629, %pexp.p_div_q632.zext
  %polly.loop_guard637 = icmp slt i64 %201, 12
...
polly.loop_header634.preheader:                   ; preds = %polly.loop_header626
  %202 = sub nsw i64 %indvars.iv1170, %199
  %203 = sub nsw i64 %indvars.iv1184, %199
  %204 = add i64 %indvars.iv1179, %199
  %205 = shl nsw i64 %polly.indvar629, 2
  %206 = or i64 %205, 1
  %207 = mul nuw nsw i64 %polly.indvar629, 80
  %208 = mul nsw i64 %polly.indvar629, -80
...
polly.loop_header634:                             ; preds = %polly.loop_header634.preheader, %polly.loop_exit693
  %indvars.iv1186 = phi i64 [ %203, %polly.loop_header634.preheader ], [ %indvars.iv.next1187, %polly.loop_exit693 ]
  %indvars.iv1181 = phi i64 [ %204, %polly.loop_header634.preheader ], [ %indvars.iv.next1182, %polly.loop_exit693 ]
  %indvars.iv1174 = phi i64 [ %202, %polly.loop_header634.preheader ], [ %indvars.iv.next1175, %polly.loop_exit693 ]
  ...
  %209 = add i64 %smax1183, %indvars.iv1186
  %smax1176 = call i64 @llvm.smax.i64(i64 %indvars.iv1174, i64 0)
  %210 = mul nsw i64 %polly.indvar638, 5
  %.not937 = icmp slt i64 %210, %206
  %211 = mul nsw i64 %polly.indvar638, 100
  %212 = add nsw i64 %211, %208
  %213 = icmp sgt i64 %212, 80
  %214 = select i1 %213, i64 %212, i64 80
  %215 = add nsw i64 %212, 99
  %polly.loop_guard680 = icmp sgt i64 %212, -100
...
polly.loop_header677.us:                          ; preds = %polly.loop_header677.preheader.us, %polly.loop_header677.us
  ...
  %216 = add nuw nsw i64 %polly.indvar681.us, %207
  %polly.access.mul.call1685.us = mul nuw nsw i64 %216, 1000
  %polly.access.add.call1686.us = add nuw nsw i64 %217, %polly.access.mul.call1685.us
...
polly.merge648.us:                                ; preds = %polly.loop_header677.us, %polly.loop_header641.us
  ...
  %exitcond1178.not = icmp eq i64 %polly.indvar_next645.us, 100
...
polly.loop_header677.preheader.us:                ; preds = %polly.loop_header641.us
  %217 = add nuw nsw i64 %polly.indvar644.us, %197
...
polly.loop_header634.split:                       ; preds = %polly.loop_header634
  %polly.loop_guard665.not = icmp sgt i64 %214, %215
...
polly.loop_header641.us1049:                      ; preds = %polly.loop_header634.split, %polly.merge648.us1086
  ...
  %218 = add nuw nsw i64 %polly.indvar644.us1050, %197
...
polly.loop_header651.us1051:                      ; preds = %polly.loop_header641.us1049, %polly.loop_header651.us1051
  ...
  %219 = add nuw nsw i64 %polly.indvar654.us1052, %207
  %polly.access.mul.call1658.us1053 = mul nuw nsw i64 %219, 1000
  %polly.access.add.call1659.us1054 = add nuw nsw i64 %polly.access.mul.call1658.us1053, %218
  ...
  br i1 %exitcond1168.not, label %polly.merge648.us1086, label %polly.loop_header651.us1051
...
polly.merge648.us1086:                            ; preds = %polly.loop_header651.us1051
  ...
  %exitcond1169.not = icmp eq i64 %polly.indvar_next645.us1087, 100
...
polly.loop_header641:                             ; preds = %polly.loop_header634.split, %polly.merge648
  ...
  %220 = add nuw nsw i64 %polly.indvar644, %197
...
polly.merge648:                                   ; preds = %polly.loop_header662
  ...
  %exitcond1167.not = icmp eq i64 %polly.indvar_next645, 100
...
polly.loop_header691.preheader:                   ; preds = %polly.merge648, %polly.merge648.us1086, %polly.merge648.us
  ...
  %polly.loop_guard701 = icmp slt i64 %223, 100
...
polly.loop_header691.us:                          ; preds = %polly.loop_header691.preheader, %polly.loop_exit700.loopexit.us
  ...
  %224 = add nuw nsw i64 %polly.indvar694.us, %197
...
polly.loop_header698.us:                          ; preds = %polly.loop_header691.us, %polly.loop_exit708.us
  %indvars.iv1188 = phi i64 [ %209, %polly.loop_header691.us ], [ %indvars.iv.next1189, %polly.loop_exit708.us ]
  %polly.indvar702.us = phi i64 [ %223, %polly.loop_header691.us ], [ %polly.indvar_next703.us, %polly.loop_exit708.us ]
  %smin1190 = call i64 @llvm.smin.i64(i64 %indvars.iv1188, i64 79)
  %226 = add i64 %polly.indvar702.us, %211
  %227 = add i64 %226, %208
  %polly.loop_guard709.us1236 = icmp sgt i64 %227, -1
...
polly.loop_header706.us:                          ; preds = %polly.loop_header706.preheader.us, %polly.loop_header706.us
  ...
  %228 = add nuw nsw i64 %polly.indvar710.us, %207
  ...
  %scevgep720.us = getelementptr i8, i8* %call2, i64 %230
  ...
  %231 = shl i64 %228, 3
  %232 = add i64 %231, %235
  %scevgep727.us = getelementptr i8, i8* %call, i64 %232
...
polly.loop_header706.preheader.us:                ; preds = %polly.loop_header698.us
  %233 = mul i64 %226, 8000
  %234 = add i64 %233, %225
  %scevgep717.us = getelementptr i8, i8* %call2, i64 %234
  ...
  %polly.access.add.Packed_MemRef_call1521724.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1521713.us, %227
...
polly.loop_exit700.loopexit.us:                   ; preds = %polly.loop_exit708.us
  ...
  %exitcond1192.not = icmp eq i64 %polly.indvar_next695.us, 100
...
polly.loop_header651:                             ; preds = %polly.loop_header641, %polly.loop_header651
  ...
  %236 = add nuw nsw i64 %polly.indvar654, %207
  %polly.access.mul.call1658 = mul nuw nsw i64 %236, 1000
  %polly.access.add.call1659 = add nuw nsw i64 %polly.access.mul.call1658, %220
...
polly.loop_header662:                             ; preds = %polly.loop_header651, %polly.loop_header662
  %polly.indvar666 = phi i64 [ %polly.indvar_next667, %polly.loop_header662 ], [ %214, %polly.loop_header651 ]
  %237 = add nuw nsw i64 %polly.indvar666, %207
  %polly.access.mul.call1670 = mul nsw i64 %237, 1000
  %polly.access.add.call1671 = add nuw nsw i64 %polly.access.mul.call1670, %220
  ...
  %polly.loop_cond668.not.not = icmp slt i64 %polly.indvar666, %215
...
polly.loop_header856:                             ; preds = %entry, %polly.loop_exit864
  ...
  %238 = shl nsw i64 %polly.indvar859, 5
  %239 = add nsw i64 %smin1223, 1199
...
polly.loop_header862:                             ; preds = %polly.loop_exit870, %polly.loop_header856
  ...
  %240 = mul nsw i64 %polly.indvar865, -32
  %smin1270 = call i64 @llvm.smin.i64(i64 %240, i64 -1168)
  %241 = add nsw i64 %smin1270, 1200
  %smin1219 = call i64 @llvm.smin.i64(i64 %indvars.iv1217, i64 -1168)
  %242 = shl nsw i64 %polly.indvar865, 5
  %243 = add nsw i64 %smin1219, 1199
...
polly.loop_header868:                             ; preds = %polly.loop_exit876, %polly.loop_header862
  ...
  %244 = add nuw nsw i64 %polly.indvar871, %238
...
vector.ph1271:                                    ; preds = %polly.loop_header868
  %broadcast.splatinsert1278 = insertelement <4 x i64> poison, i64 %242, i32 0
  %broadcast.splat1279 = shufflevector <4 x i64> %broadcast.splatinsert1278, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1280 = insertelement <4 x i32> poison, i32 %245, i32 0
...
vector.body1269:                                  ; preds = %vector.body1269, %vector.ph1271
  ...
  %247 = add nuw nsw <4 x i64> %vec.ind1276, %broadcast.splat1279
  %248 = trunc <4 x i64> %247 to <4 x i32>
  %249 = mul <4 x i32> %broadcast.splat1281, %248
  ...
  %259 = icmp eq i64 %index.next1273, %241
  br i1 %259, label %polly.loop_exit876, label %vector.body1269, !llvm.loop !103

polly.loop_exit876:                               ; preds = %vector.body1269, %polly.loop_header874
  %polly.indvar_next872 = add nuw nsw i64 %polly.indvar871, 1
  %exitcond1224.not = icmp eq i64 %polly.indvar871, %239
...
polly.loop_header874:                             ; preds = %polly.loop_header868, %polly.loop_header874
  ...
  %260 = add nuw nsw i64 %polly.indvar877, %242
  ...
  %scevgep880 = getelementptr i8, i8* %call, i64 %266
  ...
  %exitcond1220.not = icmp eq i64 %polly.indvar877, %243
  br i1 %exitcond1220.not, label %polly.loop_exit876, label %polly.loop_header874, !llvm.loop !104
...
polly.loop_header889:                             ; preds = %polly.loop_exit897, %polly.loop_header883
  ...
  %269 = mul nsw i64 %polly.indvar892, -32
  %smin1285 = call i64 @llvm.smin.i64(i64 %269, i64 -968)
  %270 = add nsw i64 %smin1285, 1000
  %smin1209 = call i64 @llvm.smin.i64(i64 %indvars.iv1207, i64 -968)
  %271 = shl nsw i64 %polly.indvar892, 5
  %272 = add nsw i64 %smin1209, 999
...
vector.body1284:                                  ; preds = %vector.body1284, %vector.ph1287
  ...
  %276 = add nuw nsw <4 x i64> %vec.ind1294, %broadcast.splat1297
  %277 = trunc <4 x i64> %276 to <4 x i32>
  %278 = mul <4 x i32> %broadcast.splat1299, %277
  ...
  %288 = icmp eq i64 %index.next1291, %270
  br i1 %288, label %polly.loop_exit903, label %vector.body1284, !llvm.loop !106

polly.loop_exit903:                               ; preds = %vector.body1284, %polly.loop_header901
  %polly.indvar_next899 = add nuw nsw i64 %polly.indvar898, 1
  %exitcond1214.not = icmp eq i64 %polly.indvar898, %268
...
polly.loop_header901:                             ; preds = %polly.loop_header895, %polly.loop_header901
  ...
  %289 = add nuw nsw i64 %polly.indvar904, %271
  ...
  %scevgep907 = getelementptr i8, i8* %call2, i64 %295
  ...
  %exitcond1210.not = icmp eq i64 %polly.indvar904, %272
  br i1 %exitcond1210.not, label %polly.loop_exit903, label %polly.loop_header901, !llvm.loop !107
...
polly.loop_header909:                             ; preds = %polly.loop_exit891, %polly.loop_exit917
  ...
  %296 = shl nsw i64 %polly.indvar912, 5
  %297 = add nsw i64 %smin1203, 1199
...
polly.loop_header915:                             ; preds = %polly.loop_exit923, %polly.loop_header909
  ...
  %298 = mul nsw i64 %polly.indvar918, -32
  %smin1303 = call i64 @llvm.smin.i64(i64 %298, i64 -968)
  %299 = add nsw i64 %smin1303, 1000
  %smin1199 = call i64 @llvm.smin.i64(i64 %indvars.iv1197, i64 -968)
  %300 = shl nsw i64 %polly.indvar918, 5
  %301 = add nsw i64 %smin1199, 999
...
vector.body1302:                                  ; preds = %vector.body1302, %vector.ph1305
  ...
  %305 = add nuw nsw <4 x i64> %vec.ind1312, %broadcast.splat1315
  %306 = trunc <4 x i64> %305 to <4 x i32>
  %307 = mul <4 x i32> %broadcast.splat1317, %306
  ...
  %317 = icmp eq i64 %index.next1309, %299
  br i1 %317, label %polly.loop_exit929, label %vector.body1302, !llvm.loop !109

polly.loop_exit929:                               ; preds = %vector.body1302, %polly.loop_header927
  %polly.indvar_next925 = add nuw nsw i64 %polly.indvar924, 1
  %exitcond1204.not = icmp eq i64 %polly.indvar924, %297
...
polly.loop_header927:                             ; preds = %polly.loop_header921, %polly.loop_header927
  ...
  %318 = add nuw nsw i64 %polly.indvar930, %300
  ...
  %scevgep934 = getelementptr i8, i8* %call1, i64 %324
  ...
  %exitcond1200.not = icmp eq i64 %polly.indvar930, %301
  br i1 %exitcond1200.not, label %polly.loop_exit929, label %polly.loop_header927, !llvm.loop !110
}
