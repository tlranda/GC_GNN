; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5265.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5265.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next988 = add nuw nsw i64 %indvars.iv987, 128
  %exitcond1000.not = icmp eq i64 %polly.indvar_next203, 10
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1201
  ...
  %wide.load1208 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %137, label %middle.block1195, label %vector.body1197, !llvm.loop !80
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %.inv873 = icmp slt i64 %141, 14
  %143 = select i1 %.inv873, i64 %142, i64 14
  %polly.loop_guard402 = icmp sgt i64 %143, -1
  %144 = mul nsw i64 %polly.indvar388, -128
  %145 = icmp slt i64 %144, -1072
  %146 = select i1 %145, i64 %144, i64 -1072
  %147 = add nsw i64 %146, 1199
  %148 = shl nsw i64 %polly.indvar388, 7
...
polly.loop_exit393:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next389, 10
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1175
  ...
  %wide.load1182 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %179, label %middle.block1171, label %vector.body1173, !llvm.loop !90
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %.inv875 = icmp slt i64 %183, 14
  %185 = select i1 %.inv875, i64 %184, i64 14
  ...
  %190 = shl nsw i64 %polly.indvar581, 7
...
polly.loop_exit586:                               ; preds = %polly.loop_exit594
  ...
  %indvars.iv.next1033 = add nuw nsw i64 %indvars.iv1032, 128
  %exitcond1046.not = icmp eq i64 %polly.indvar_next582, 10
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %191 = mul nuw nsw i64 %polly.indvar587, 50
...
vector.body1112:                                  ; preds = %vector.body1112, %vector.ph1113
  ...
  br i1 %235, label %polly.loop_exit813, label %vector.body1112, !llvm.loop !99
...
vector.body1126:                                  ; preds = %vector.body1126, %vector.ph1129
  ...
  br i1 %264, label %polly.loop_exit840, label %vector.body1126, !llvm.loop !102
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1147
  ...
  br i1 %293, label %polly.loop_exit866, label %vector.body1144, !llvm.loop !105
