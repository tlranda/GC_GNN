; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4521.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4521.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv993 = phi i64 [ 7, %polly.loop_header199.preheader ], [ %indvars.iv.next994, %polly.loop_exit207 ]
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv993, i64 299)
...
polly.loop_exit219:                               ; preds = %polly.loop_exit250, %polly.loop_header211
  ...
  %exitcond995.not = icmp eq i64 %polly.indvar214, %umin
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %smin989 = call i64 @llvm.smin.i64(i64 %indvars.iv983, i64 3)
  %111 = add nsw i64 %polly.indvar220, %109
  %polly.loop_guard2331096 = icmp sgt i64 %111, -1
...
vector.body1210:                                  ; preds = %vector.body1210, %vector.ph1214
  ...
  %128 = shl nuw nsw i64 %index1217, 3
  %129 = getelementptr i8, i8* %scevgep379, i64 %128
  %130 = bitcast i8* %129 to <4 x double>*
  %wide.load1221 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !73, !noalias !75
  %131 = fmul fast <4 x double> %wide.load1221, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %133 = icmp eq i64 %index.next1218, %n.vec1216
  br i1 %133, label %middle.block1208, label %vector.body1210, !llvm.loop !79

middle.block1208:                                 ; preds = %vector.body1210
  %cmp.n1220 = icmp eq i64 %126, %n.vec1216
...
polly.loop_header373:                             ; preds = %polly.loop_header373.preheader, %polly.loop_header373
  ...
  br i1 %exitcond1029.not, label %polly.loop_exit375, label %polly.loop_header373, !llvm.loop !80

polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  %indvars.iv1023 = phi i64 [ 7, %polly.loop_header383.preheader ], [ %indvars.iv.next1024, %polly.loop_exit391 ]
  ...
  %umin1025 = call i64 @llvm.umin.i64(i64 %indvars.iv1023, i64 299)
  %135 = mul nsw i64 %polly.indvar386, -32
  %136 = icmp slt i64 %135, -1168
  %137 = select i1 %136, i64 %135, i64 -1168
  %138 = add nsw i64 %137, 1199
  %139 = shl nsw i64 %polly.indvar386, 5
...
polly.loop_exit391:                               ; preds = %polly.loop_exit397
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next387, 38
...
polly.loop_header389:                             ; preds = %polly.loop_exit397, %polly.loop_header383
  ...
  %smin1021 = call i64 @llvm.smin.i64(i64 %indvars.iv1000, i64 -968)
  %140 = add nsw i64 %smin1021, 1000
  %141 = shl nsw i64 %polly.indvar392, 5
...
polly.loop_exit397:                               ; preds = %polly.loop_exit404
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next393, 32
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %142 = shl nsw i64 %polly.indvar398, 2
...
polly.loop_header402.preheader:                   ; preds = %polly.loop_header395
  ...
  %146 = add i64 %smax1008, %indvars.iv1011
  %147 = sub nsw i64 %139, %142
  %148 = add nuw nsw i64 %142, 4
...
polly.loop_exit404:                               ; preds = %polly.loop_exit440, %polly.loop_header395
  ...
  %exitcond1026.not = icmp eq i64 %polly.indvar398, %umin1025
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_exit440
  %indvars.iv1013 = phi i64 [ %146, %polly.loop_header402.preheader ], [ %indvars.iv.next1014, %polly.loop_exit440 ]
  %polly.indvar406 = phi i64 [ %145, %polly.loop_header402.preheader ], [ %polly.indvar_next407, %polly.loop_exit440 ]
  %smin1019 = call i64 @llvm.smin.i64(i64 %indvars.iv1013, i64 3)
  %149 = add nsw i64 %polly.indvar406, %147
  %polly.loop_guard4191097 = icmp sgt i64 %149, -1
...
polly.merge428.us:                                ; preds = %polly.then429.us, %polly.cond427.loopexit.us
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar_next413.us, %140
...
polly.loop_header409:                             ; preds = %polly.loop_header402.split, %polly.loop_header409
  ...
  %exitcond1003.not = icmp eq i64 %polly.indvar_next413, %140
...
polly.loop_exit447.loopexit.us:                   ; preds = %polly.loop_header445.us
  ...
  %exitcond1022.not = icmp eq i64 %polly.indvar_next442.us, %140
...
polly.loop_header557:                             ; preds = %polly.loop_exit565, %polly.start471
  ...
  %min.iters.check1187 = icmp ult i64 %164, 4
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1188
  ...
  %166 = shl nuw nsw i64 %index1191, 3
  %167 = getelementptr i8, i8* %scevgep569, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load1195 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !83, !noalias !85
  %169 = fmul fast <4 x double> %wide.load1195, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next1192, %n.vec1190
  br i1 %171, label %middle.block1184, label %vector.body1186, !llvm.loop !89

middle.block1184:                                 ; preds = %vector.body1186
  %cmp.n1194 = icmp eq i64 %164, %n.vec1190
...
polly.loop_header563:                             ; preds = %polly.loop_header563.preheader, %polly.loop_header563
  ...
  br i1 %exitcond1060.not, label %polly.loop_exit565, label %polly.loop_header563, !llvm.loop !90

polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  %indvars.iv1054 = phi i64 [ 7, %polly.loop_header573.preheader ], [ %indvars.iv.next1055, %polly.loop_exit581 ]
  ...
  %umin1056 = call i64 @llvm.umin.i64(i64 %indvars.iv1054, i64 299)
  %173 = mul nsw i64 %polly.indvar576, -32
  %174 = icmp slt i64 %173, -1168
  %175 = select i1 %174, i64 %173, i64 -1168
  %176 = add nsw i64 %175, 1199
  %177 = shl nsw i64 %polly.indvar576, 5
...
polly.loop_exit581:                               ; preds = %polly.loop_exit587
  ...
  %exitcond1059.not = icmp eq i64 %polly.indvar_next577, 38
...
polly.loop_header579:                             ; preds = %polly.loop_exit587, %polly.loop_header573
  ...
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1031, i64 -968)
  %178 = add nsw i64 %smin1052, 1000
  %179 = shl nsw i64 %polly.indvar582, 5
...
polly.loop_exit587:                               ; preds = %polly.loop_exit594
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next583, 32
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %180 = shl nsw i64 %polly.indvar588, 2
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header585
  ...
  %184 = add i64 %smax1039, %indvars.iv1042
...
polly.loop_exit594:                               ; preds = %polly.loop_exit630, %polly.loop_header585
  ...
  %indvars.iv.next1038 = add nsw i64 %indvars.iv1037, 4
  %indvars.iv.next1043 = add nsw i64 %indvars.iv1042, -4
  %exitcond1057.not = icmp eq i64 %polly.indvar588, %umin1056
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit630
  %indvars.iv1044 = phi i64 [ %184, %polly.loop_header592.preheader ], [ %indvars.iv.next1045, %polly.loop_exit630 ]
  ...
  %polly.loop_guard6091098 = icmp sgt i64 %187, -1
...
polly.merge618.us:                                ; preds = %polly.then619.us, %polly.cond617.loopexit.us
  ...
  %exitcond1049.not = icmp eq i64 %polly.indvar_next603.us, %178
...
polly.loop_header599:                             ; preds = %polly.loop_header592.split, %polly.loop_header599
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next603, %178
...
polly.loop_exit637.loopexit.us:                   ; preds = %polly.loop_header635.us
  ...
  %exitcond1053.not = icmp eq i64 %polly.indvar_next632.us, %178
...
vector.ph1126:                                    ; preds = %polly.loop_header797
  %broadcast.splatinsert1133 = insertelement <4 x i64> poison, i64 %206, i32 0
  %broadcast.splat1134 = shufflevector <4 x i64> %broadcast.splatinsert1133, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1135 = insertelement <4 x i32> poison, i32 %209, i32 0
...
vector.body1125:                                  ; preds = %vector.body1125, %vector.ph1126
  ...
  %211 = add nuw nsw <4 x i64> %vec.ind1131, %broadcast.splat1134
  %212 = trunc <4 x i64> %211 to <4 x i32>
  %213 = mul <4 x i32> %broadcast.splat1136, %212
  ...
  %223 = icmp eq i64 %index.next1128, %205
  br i1 %223, label %polly.loop_exit805, label %vector.body1125, !llvm.loop !98

polly.loop_exit805:                               ; preds = %vector.body1125, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond1089.not = icmp eq i64 %polly.indvar800, %203
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond1085.not = icmp eq i64 %polly.indvar806, %207
  br i1 %exitcond1085.not, label %polly.loop_exit805, label %polly.loop_header803, !llvm.loop !99
...
polly.loop_header818:                             ; preds = %polly.loop_exit826, %polly.loop_header812
  ...
  %smin1140 = call i64 @llvm.smin.i64(i64 %233, i64 -968)
  %234 = add nsw i64 %smin1140, 1000
  %smin1074 = call i64 @llvm.smin.i64(i64 %indvars.iv1072, i64 -968)
  %235 = shl nsw i64 %polly.indvar821, 5
  %236 = add nsw i64 %smin1074, 999
...
vector.body1139:                                  ; preds = %vector.body1139, %vector.ph1142
  ...
  %240 = add nuw nsw <4 x i64> %vec.ind1149, %broadcast.splat1152
  ...
  %252 = icmp eq i64 %index.next1146, %234
  br i1 %252, label %polly.loop_exit832, label %vector.body1139, !llvm.loop !101

polly.loop_exit832:                               ; preds = %vector.body1139, %polly.loop_header830
  %polly.indvar_next828 = add nuw nsw i64 %polly.indvar827, 1
  %exitcond1079.not = icmp eq i64 %polly.indvar827, %232
...
polly.loop_header830:                             ; preds = %polly.loop_header824, %polly.loop_header830
  ...
  %exitcond1075.not = icmp eq i64 %polly.indvar833, %236
  br i1 %exitcond1075.not, label %polly.loop_exit832, label %polly.loop_header830, !llvm.loop !102
...
polly.loop_header844:                             ; preds = %polly.loop_exit852, %polly.loop_header838
  ...
  %smin1158 = call i64 @llvm.smin.i64(i64 %262, i64 -968)
  %263 = add nsw i64 %smin1158, 1000
  %smin1064 = call i64 @llvm.smin.i64(i64 %indvars.iv1062, i64 -968)
  %264 = shl nsw i64 %polly.indvar847, 5
  %265 = add nsw i64 %smin1064, 999
...
vector.body1157:                                  ; preds = %vector.body1157, %vector.ph1160
  ...
  %269 = add nuw nsw <4 x i64> %vec.ind1167, %broadcast.splat1170
  ...
  %281 = icmp eq i64 %index.next1164, %263
  br i1 %281, label %polly.loop_exit858, label %vector.body1157, !llvm.loop !104

polly.loop_exit858:                               ; preds = %vector.body1157, %polly.loop_header856
  %polly.indvar_next854 = add nuw nsw i64 %polly.indvar853, 1
  %exitcond1069.not = icmp eq i64 %polly.indvar853, %261
...
polly.loop_header856:                             ; preds = %polly.loop_header850, %polly.loop_header856
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar859, %265
  br i1 %exitcond1065.not, label %polly.loop_exit858, label %polly.loop_header856, !llvm.loop !105
}
