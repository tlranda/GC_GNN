; ModuleID = 'syr2k_exhaustive/mmp_all_XL_818.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_818.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %153 = mul nsw i64 %indvar1437, -64
  %154 = add i64 %101, %153
  %smax1456 = call i64 @llvm.smax.i64(i64 %154, i64 0)
  %155 = shl nuw nsw i64 %indvar1437, 6
  %156 = add i64 %103, %155
  %157 = add i64 %smax1456, %156
  %158 = mul nsw i64 %indvar1437, -64
  %159 = add i64 %108, %158
  %smax1439 = call i64 @llvm.smax.i64(i64 %159, i64 0)
  %160 = shl nuw nsw i64 %indvar1437, 6
  %161 = add i64 %107, %160
  ...
  %169 = shl nuw nsw i64 %polly.indvar231, 1
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %183 = mul nsw i64 %polly.indvar231, -64
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %229 = mul nuw nsw i64 %polly.indvar413, 100
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %232 = and i64 %231, 9223372036854775744
  ...
  %239 = and i64 %238, 9223372036854775744
  %240 = sub nsw i64 %237, %239
  %241 = or i64 %236, 8
  %242 = mul nsw i64 %polly.indvar419, -32
  %243 = add i64 %242, %239
  %244 = lshr i64 %polly.indvar419, 1
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %285 = mul nsw i64 %indvar1374, -64
  %286 = add i64 %233, %285
  %smax1393 = call i64 @llvm.smax.i64(i64 %286, i64 0)
  %287 = shl nuw nsw i64 %indvar1374, 6
  %288 = add i64 %235, %287
  %289 = add i64 %smax1393, %288
  %290 = mul nsw i64 %indvar1374, -64
  %291 = add i64 %240, %290
  %smax1376 = call i64 @llvm.smax.i64(i64 %291, i64 0)
  %292 = shl nuw nsw i64 %indvar1374, 6
  %293 = add i64 %239, %292
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %315 = mul nsw i64 %polly.indvar442, -64
  %316 = icmp slt i64 %315, -1136
  %317 = select i1 %316, i64 %315, i64 -1136
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %361 = mul nuw nsw i64 %polly.indvar630, 100
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %364 = and i64 %363, 9223372036854775744
  ...
  %371 = and i64 %370, 9223372036854775744
  %372 = sub nsw i64 %369, %371
  %373 = or i64 %368, 8
  %374 = mul nsw i64 %polly.indvar636, -32
  %375 = add i64 %374, %371
  %376 = lshr i64 %polly.indvar636, 1
  %377 = shl nuw nsw i64 %376, 6
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %417 = mul nsw i64 %indvar1311, -64
  %418 = add i64 %365, %417
  %smax1330 = call i64 @llvm.smax.i64(i64 %418, i64 0)
  %419 = shl nuw nsw i64 %indvar1311, 6
  %420 = add i64 %367, %419
  %421 = add i64 %smax1330, %420
  %422 = mul nsw i64 %indvar1311, -64
  %423 = add i64 %372, %422
  %smax1313 = call i64 @llvm.smax.i64(i64 %423, i64 0)
  %424 = shl nuw nsw i64 %indvar1311, 6
  %425 = add i64 %371, %424
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %447 = mul nsw i64 %polly.indvar659, -64
  %448 = icmp slt i64 %447, -1136
  %449 = select i1 %448, i64 %447, i64 -1136
