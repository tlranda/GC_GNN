; ModuleID = 'syr2k_exhaustive/mmp_all_XL_143.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_143.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %101 = and i64 %100, 9223372036854775800
...
polly.loop_exit265:                               ; preds = %polly.loop_exit272.loopexit.us, %polly.loop_header263.preheader
  ...
  %indvars.iv.next1105 = add i64 %indvars.iv1104, 8
  %exitcond1112.not = icmp eq i64 %polly.indvar_next232, 150
...
vector.body1417:                                  ; preds = %vector.body1417, %vector.ph1425
  ...
  %wide.load1438 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %159, label %middle.block1415, label %vector.body1417, !llvm.loop !85
...
vector.body1353:                                  ; preds = %vector.body1353, %vector.ph1357
  ...
  %wide.load1364 = load <4 x double>, <4 x double>* %165, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %168, label %middle.block1351, label %vector.body1353, !llvm.loop !93
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %174 = and i64 %173, 9223372036854775800
  %175 = sub nsw i64 %172, %174
  %176 = mul nsw i64 %polly.indvar419, -4
  %177 = add i64 %176, %174
  %178 = lshr i64 %polly.indvar419, 1
...
polly.loop_exit482:                               ; preds = %polly.loop_exit489.loopexit.us, %polly.loop_header480.preheader
  ...
  %indvars.iv.next1132 = add i64 %indvars.iv1131, -8
  %indvars.iv.next1137 = add i64 %indvars.iv1136, 8
  %exitcond1144.not = icmp eq i64 %polly.indvar_next443, 150
...
vector.body1367:                                  ; preds = %vector.body1367, %vector.ph1375
  ...
  %wide.load1388 = load <4 x double>, <4 x double>* %227, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %232, label %middle.block1365, label %vector.body1367, !llvm.loop !98
...
vector.body1305:                                  ; preds = %vector.body1305, %vector.ph1307
  ...
  %wide.load1314 = load <4 x double>, <4 x double>* %238, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %241, label %middle.block1303, label %vector.body1305, !llvm.loop !106
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %247 = and i64 %246, 9223372036854775800
  %248 = sub nsw i64 %245, %247
  %249 = mul nsw i64 %polly.indvar636, -4
  %250 = add i64 %249, %247
  %251 = lshr i64 %polly.indvar636, 1
...
polly.loop_exit699:                               ; preds = %polly.loop_exit706.loopexit.us, %polly.loop_header697.preheader
  ...
  %indvars.iv.next1164 = add i64 %indvars.iv1163, -8
  %indvars.iv.next1169 = add i64 %indvars.iv1168, 8
  %exitcond1176.not = icmp eq i64 %polly.indvar_next660, 150
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1325
  ...
  %wide.load1338 = load <4 x double>, <4 x double>* %300, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %305, label %middle.block1315, label %vector.body1317, !llvm.loop !111
...
vector.body1244:                                  ; preds = %vector.body1244, %vector.ph1245
  ...
  br i1 %328, label %polly.loop_exit884, label %vector.body1244, !llvm.loop !117
...
vector.body1258:                                  ; preds = %vector.body1258, %vector.ph1261
  ...
  br i1 %357, label %polly.loop_exit911, label %vector.body1258, !llvm.loop !120
...
vector.body1276:                                  ; preds = %vector.body1276, %vector.ph1279
  ...
  br i1 %386, label %polly.loop_exit937, label %vector.body1276, !llvm.loop !123
