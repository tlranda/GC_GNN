; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8417.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8417.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %polly.loop_guard227 = icmp slt i64 %112, 20
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %136 = udiv i64 %indvars.iv814, 5
  %137 = mul nuw nsw i64 %136, 20
  %138 = shl nuw nsw i64 %polly.indvar365, 1
  %139 = trunc i64 %138 to i8
  %pexp.p_div_q368.lhs.trunc = add i8 %139, 4
  %pexp.p_div_q368781 = udiv i8 %pexp.p_div_q368.lhs.trunc, 5
  %pexp.p_div_q368.zext = zext i8 %pexp.p_div_q368781 to i64
  %140 = sub nsw i64 %138, %pexp.p_div_q368.zext
  %polly.loop_guard373 = icmp slt i64 %140, 60
...
polly.loop_exit372:                               ; preds = %polly.loop_exit379, %polly.loop_header362
  ...
  %indvars.iv.next813 = add nsw i64 %indvars.iv812, -8
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %146 = mul nsw i64 %polly.indvar374, 20
  %147 = sub nsw i64 %143, %146
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %polly.loop_guard387 = icmp slt i64 %149, 20
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %175 = shl nuw nsw i64 %polly.indvar525, 1
  %176 = trunc i64 %175 to i8
  %pexp.p_div_q528.lhs.trunc = add i8 %176, 4
  %pexp.p_div_q528780 = udiv i8 %pexp.p_div_q528.lhs.trunc, 5
  %pexp.p_div_q528.zext = zext i8 %pexp.p_div_q528780 to i64
  %177 = sub nsw i64 %175, %pexp.p_div_q528.zext
  %polly.loop_guard533 = icmp slt i64 %177, 60
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header522
  ...
  %indvars.iv.next843 = add nuw nsw i64 %indvars.iv842, 8
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %183 = mul nsw i64 %polly.indvar534, 20
  %184 = sub nsw i64 %180, %183
  %185 = icmp sgt i64 %184, 0
  %186 = select i1 %185, i64 %184, i64 0
  %polly.loop_guard547 = icmp slt i64 %186, 20
