; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6418.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6418.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next209, 24
...
polly.loop_header239.us:                          ; preds = %polly.loop_header227, %polly.loop_exit248.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 49)
  %116 = add nuw i64 %polly.indvar242.us, %112
  %117 = add i64 %116, %292
  %polly.loop_guard249.us948 = icmp sgt i64 %117, -1
...
polly.loop_exit235:                               ; preds = %polly.loop_exit248.us.3, %polly.loop_header227
  ...
  %indvars.iv.next857 = add i64 %indvars.iv856, -100
  %indvars.iv.next861 = add i64 %indvars.iv860, 100
  %exitcond866.not = icmp eq i64 %polly.indvar_next231, 12
...
polly.loop_exit411:                               ; preds = %polly.loop_exit426.us.3, %polly.loop_header403
  ...
  %indvars.iv.next878 = add i64 %indvars.iv877, -100
  %indvars.iv.next883 = add i64 %indvars.iv882, 100
  %exitcond889.not = icmp eq i64 %polly.indvar_next407, 12
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %185 = mul nuw nsw i64 %polly.indvar561, 50
  br label %polly.loop_header570

polly.loop_exit583:                               ; preds = %polly.loop_exit589
  %polly.indvar_next562 = add nuw nsw i64 %polly.indvar561, 1
  %indvars.iv.next895 = add nsw i64 %indvars.iv894, -50
  %indvars.iv.next899 = add nuw nsw i64 %indvars.iv898, 50
  %indvars.iv.next904 = add nsw i64 %indvars.iv903, -50
  %exitcond913.not = icmp eq i64 %polly.indvar_next562, 24
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit572.3
  ...
  %188 = mul nuw nsw i64 %polly.indvar584, 100
...
polly.loop_header594.us:                          ; preds = %polly.loop_header581, %polly.loop_exit604.us
  ...
  %smin909 = call i64 @llvm.smin.i64(i64 %indvars.iv907, i64 49)
  %192 = add nuw i64 %polly.indvar598.us, %188
  %193 = add i64 %192, %360
  %polly.loop_guard605.us956 = icmp sgt i64 %193, -1
  br i1 %polly.loop_guard605.us956, label %polly.loop_header602.preheader.us, label %polly.loop_exit604.us
...
polly.loop_exit589:                               ; preds = %polly.loop_exit604.us.3, %polly.loop_header581
  ...
  %indvars.iv.next901 = add i64 %indvars.iv900, -100
  %indvars.iv.next906 = add i64 %indvars.iv905, 100
  %exitcond912.not = icmp eq i64 %polly.indvar_next585, 12
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  br i1 %223, label %polly.loop_exit772, label %vector.body980, !llvm.loop !104

polly.loop_exit772:                               ; preds = %vector.body980, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond944.not = icmp eq i64 %polly.indvar767, %203
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond940.not = icmp eq i64 %polly.indvar773, %207
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %252, label %polly.loop_exit799, label %vector.body995, !llvm.loop !107

polly.loop_exit799:                               ; preds = %vector.body995, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond934.not = icmp eq i64 %polly.indvar794, %232
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond930.not = icmp eq i64 %polly.indvar800, %236
...
vector.body1013:                                  ; preds = %vector.body1013, %vector.ph1016
  ...
  br i1 %281, label %polly.loop_exit825, label %vector.body1013, !llvm.loop !110

polly.loop_exit825:                               ; preds = %vector.body1013, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond924.not = icmp eq i64 %polly.indvar820, %261
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond920.not = icmp eq i64 %polly.indvar826, %265
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  %292 = mul nsw i64 %polly.indvar208, -50
...
polly.loop_header239.us.1:                        ; preds = %polly.loop_exit248.us, %polly.loop_exit248.us.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv862.1, i64 49)
  %293 = add nuw i64 %polly.indvar242.us.1, %112
  %294 = add i64 %293, %292
  %polly.loop_guard249.us.1949 = icmp sgt i64 %294, -1
  br i1 %polly.loop_guard249.us.1949, label %polly.loop_header246.preheader.us.1, label %polly.loop_exit248.us.1
...
polly.loop_exit248.us.1:                          ; preds = %polly.loop_header246.us.1, %polly.loop_header239.us.1
  ...
  %polly.loop_cond244.us.1 = icmp ult i64 %polly.indvar242.us.1, 99
...
polly.loop_header239.us.2:                        ; preds = %polly.loop_exit248.us.1, %polly.loop_exit248.us.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv862.2, i64 49)
  %303 = add nuw i64 %polly.indvar242.us.2, %112
  %304 = add i64 %303, %292
  %polly.loop_guard249.us.2950 = icmp sgt i64 %304, -1
  br i1 %polly.loop_guard249.us.2950, label %polly.loop_header246.preheader.us.2, label %polly.loop_exit248.us.2
...
polly.loop_exit248.us.2:                          ; preds = %polly.loop_header246.us.2, %polly.loop_header239.us.2
  ...
  %polly.loop_cond244.us.2 = icmp ult i64 %polly.indvar242.us.2, 99
...
polly.loop_header239.us.3:                        ; preds = %polly.loop_exit248.us.2, %polly.loop_exit248.us.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv862.3, i64 49)
  %313 = add nuw i64 %polly.indvar242.us.3, %112
  %314 = add i64 %313, %292
  %polly.loop_guard249.us.3951 = icmp sgt i64 %314, -1
  br i1 %polly.loop_guard249.us.3951, label %polly.loop_header246.preheader.us.3, label %polly.loop_exit248.us.3
...
polly.loop_exit248.us.3:                          ; preds = %polly.loop_header246.us.3, %polly.loop_header239.us.3
  ...
  %polly.loop_cond244.us.3 = icmp ult i64 %polly.indvar242.us.3, 99
...
polly.loop_exit394.3:                             ; preds = %polly.loop_header392.3
  %326 = mul nsw i64 %polly.indvar383, -50
...
polly.loop_header416.us.1:                        ; preds = %polly.loop_exit426.us, %polly.loop_exit426.us.1
  ...
  %smin886.1 = call i64 @llvm.smin.i64(i64 %indvars.iv884.1, i64 49)
  %327 = add nuw i64 %polly.indvar420.us.1, %150
  %328 = add i64 %327, %326
  %polly.loop_guard427.us.1953 = icmp sgt i64 %328, -1
  br i1 %polly.loop_guard427.us.1953, label %polly.loop_header424.preheader.us.1, label %polly.loop_exit426.us.1
...
polly.loop_exit426.us.1:                          ; preds = %polly.loop_header424.us.1, %polly.loop_header416.us.1
  ...
  %polly.loop_cond422.us.1 = icmp ult i64 %polly.indvar420.us.1, 99
...
polly.loop_header416.us.2:                        ; preds = %polly.loop_exit426.us.1, %polly.loop_exit426.us.2
  ...
  %smin886.2 = call i64 @llvm.smin.i64(i64 %indvars.iv884.2, i64 49)
  %337 = add nuw i64 %polly.indvar420.us.2, %150
  %338 = add i64 %337, %326
  %polly.loop_guard427.us.2954 = icmp sgt i64 %338, -1
  br i1 %polly.loop_guard427.us.2954, label %polly.loop_header424.preheader.us.2, label %polly.loop_exit426.us.2
...
polly.loop_exit426.us.2:                          ; preds = %polly.loop_header424.us.2, %polly.loop_header416.us.2
  ...
  %polly.loop_cond422.us.2 = icmp ult i64 %polly.indvar420.us.2, 99
...
polly.loop_header416.us.3:                        ; preds = %polly.loop_exit426.us.2, %polly.loop_exit426.us.3
  ...
  %smin886.3 = call i64 @llvm.smin.i64(i64 %indvars.iv884.3, i64 49)
  %347 = add nuw i64 %polly.indvar420.us.3, %150
  %348 = add i64 %347, %326
  %polly.loop_guard427.us.3955 = icmp sgt i64 %348, -1
  br i1 %polly.loop_guard427.us.3955, label %polly.loop_header424.preheader.us.3, label %polly.loop_exit426.us.3
...
polly.loop_exit426.us.3:                          ; preds = %polly.loop_header424.us.3, %polly.loop_header416.us.3
  ...
  %polly.loop_cond422.us.3 = icmp ult i64 %polly.indvar420.us.3, 99
...
polly.loop_exit572.3:                             ; preds = %polly.loop_header570.3
  %360 = mul nsw i64 %polly.indvar561, -50
...
polly.loop_header594.us.1:                        ; preds = %polly.loop_exit604.us, %polly.loop_exit604.us.1
  ...
  %smin909.1 = call i64 @llvm.smin.i64(i64 %indvars.iv907.1, i64 49)
  %361 = add nuw i64 %polly.indvar598.us.1, %188
  %362 = add i64 %361, %360
  %polly.loop_guard605.us.1957 = icmp sgt i64 %362, -1
  br i1 %polly.loop_guard605.us.1957, label %polly.loop_header602.preheader.us.1, label %polly.loop_exit604.us.1
...
polly.loop_exit604.us.1:                          ; preds = %polly.loop_header602.us.1, %polly.loop_header594.us.1
  ...
  %polly.loop_cond600.us.1 = icmp ult i64 %polly.indvar598.us.1, 99
...
polly.loop_header594.us.2:                        ; preds = %polly.loop_exit604.us.1, %polly.loop_exit604.us.2
  ...
  %smin909.2 = call i64 @llvm.smin.i64(i64 %indvars.iv907.2, i64 49)
  %371 = add nuw i64 %polly.indvar598.us.2, %188
  %372 = add i64 %371, %360
  %polly.loop_guard605.us.2958 = icmp sgt i64 %372, -1
  br i1 %polly.loop_guard605.us.2958, label %polly.loop_header602.preheader.us.2, label %polly.loop_exit604.us.2
...
polly.loop_exit604.us.2:                          ; preds = %polly.loop_header602.us.2, %polly.loop_header594.us.2
  ...
  %polly.loop_cond600.us.2 = icmp ult i64 %polly.indvar598.us.2, 99
...
polly.loop_header594.us.3:                        ; preds = %polly.loop_exit604.us.2, %polly.loop_exit604.us.3
  ...
  %smin909.3 = call i64 @llvm.smin.i64(i64 %indvars.iv907.3, i64 49)
  %381 = add nuw i64 %polly.indvar598.us.3, %188
  %382 = add i64 %381, %360
  %polly.loop_guard605.us.3959 = icmp sgt i64 %382, -1
  br i1 %polly.loop_guard605.us.3959, label %polly.loop_header602.preheader.us.3, label %polly.loop_exit604.us.3
...
polly.loop_exit604.us.3:                          ; preds = %polly.loop_header602.us.3, %polly.loop_header594.us.3
  ...
  %polly.loop_cond600.us.3 = icmp ult i64 %polly.indvar598.us.3, 99
