; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2648.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2648.c"
...
vector.body1357:                                  ; preds = %vector.body1357, %vector.ph1363
  ...
  %wide.load1376 = load <4 x double>, <4 x double>* %143, align 8, !alias.scope !64, !noalias !66
  ...
  br i1 %148, label %middle.block1355, label %vector.body1357, !llvm.loop !76
...
vector.body1295:                                  ; preds = %vector.body1295, %vector.ph1299
  ...
  %wide.load1306 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %159, label %middle.block1293, label %vector.body1295, !llvm.loop !85
...
polly.loop_header426:                             ; preds = %polly.loop_exit435, %polly.loop_header420
  ...
  %173 = shl nsw i64 %polly.indvar429, 7
...
vector.body1309:                                  ; preds = %vector.body1309, %vector.ph1315
  ...
  %wide.load1328 = load <4 x double>, <4 x double>* %207, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %212, label %middle.block1307, label %vector.body1309, !llvm.loop !89
...
vector.body1249:                                  ; preds = %vector.body1249, %vector.ph1251
  ...
  %wide.load1258 = load <4 x double>, <4 x double>* %220, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %223, label %middle.block1247, label %vector.body1249, !llvm.loop !98
...
polly.loop_header637:                             ; preds = %polly.loop_exit646, %polly.loop_header631
  ...
  %237 = shl nsw i64 %polly.indvar640, 7
...
vector.body1261:                                  ; preds = %vector.body1261, %vector.ph1267
  ...
  %wide.load1280 = load <4 x double>, <4 x double>* %271, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %276, label %middle.block1259, label %vector.body1261, !llvm.loop !102
...
vector.body1188:                                  ; preds = %vector.body1188, %vector.ph1189
  ...
  br i1 %301, label %polly.loop_exit866, label %vector.body1188, !llvm.loop !109
...
vector.body1202:                                  ; preds = %vector.body1202, %vector.ph1205
  ...
  br i1 %330, label %polly.loop_exit893, label %vector.body1202, !llvm.loop !112
...
vector.body1220:                                  ; preds = %vector.body1220, %vector.ph1223
  ...
  br i1 %359, label %polly.loop_exit919, label %vector.body1220, !llvm.loop !115
