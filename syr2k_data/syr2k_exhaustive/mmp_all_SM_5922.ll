; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5922.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5922.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond841.not = icmp eq i64 %polly.indvar_next203, 38
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit229
  ...
  %101 = mul nsw i64 %polly.indvar224, -32
...
polly.loop_header233.us:                          ; preds = %polly.loop_exit241.us, %polly.loop_header227.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv830, i64 31)
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235.loopexit.us, %polly.loop_header221
  ...
  %exitcond840.not = icmp eq i64 %polly.indvar_next225, 38
...
polly.loop_header368:                             ; preds = %polly.loop_header368.preheader, %polly.loop_exit392
  ...
  %121 = shl nsw i64 %polly.indvar371, 5
...
polly.loop_exit392:                               ; preds = %polly.loop_exit398
  ...
  %exitcond863.not = icmp eq i64 %polly.indvar_next372, 38
...
polly.loop_header390.preheader:                   ; preds = %polly.loop_exit382
  %122 = mul nsw i64 %polly.indvar371, -32
...
polly.loop_header390:                             ; preds = %polly.loop_header390.preheader, %polly.loop_exit398
  ...
  %125 = mul nsw i64 %polly.indvar393, -32
  %polly.loop_guard406920 = icmp sgt i64 %125, -1200
  %126 = shl nsw i64 %polly.indvar393, 5
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405.loopexit.us, %polly.loop_header390
  ...
  %exitcond862.not = icmp eq i64 %polly.indvar_next394, 38
...
polly.loop_header539:                             ; preds = %polly.loop_header539.preheader, %polly.loop_exit563
  ...
  %145 = shl nsw i64 %polly.indvar542, 5
...
polly.loop_exit563:                               ; preds = %polly.loop_exit569
  ...
  %exitcond885.not = icmp eq i64 %polly.indvar_next543, 38
...
polly.loop_header561.preheader:                   ; preds = %polly.loop_exit553
  %146 = mul nsw i64 %polly.indvar542, -32
...
polly.loop_header561:                             ; preds = %polly.loop_header561.preheader, %polly.loop_exit569
  ...
  %149 = mul nsw i64 %polly.indvar564, -32
  %polly.loop_guard577921 = icmp sgt i64 %149, -1200
  %150 = shl nsw i64 %polly.indvar564, 5
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576.loopexit.us, %polly.loop_header561
  ...
  %exitcond884.not = icmp eq i64 %polly.indvar_next565, 38
