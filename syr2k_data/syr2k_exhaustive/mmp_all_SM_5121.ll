; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5121.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5121.c"
...
polly.loop_header218:                             ; preds = %polly.loop_header218.preheader, %polly.loop_exit252
  ...
  %polly.loop_guard2351078 = icmp sgt i64 %111, -1
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1190
  ...
  %128 = shl nuw nsw i64 %index1193, 3
  %129 = getelementptr i8, i8* %scevgep381, i64 %128
  %130 = bitcast i8* %129 to <4 x double>*
  %wide.load1197 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  %131 = fmul fast <4 x double> %wide.load1197, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %133 = icmp eq i64 %index.next1194, %n.vec1192
  br i1 %133, label %middle.block1184, label %vector.body1186, !llvm.loop !80

middle.block1184:                                 ; preds = %vector.body1186
  %cmp.n1196 = icmp eq i64 %126, %n.vec1192
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %136 = mul nuw nsw i64 %polly.indvar388, 7
  %137 = add nuw nsw i64 %136, 7
  %pexp.p_div_q397 = lshr i64 %137, 4
  %138 = sub nsw i64 %135, %pexp.p_div_q397
  %polly.loop_guard402 = icmp sgt i64 %138, -2
  %139 = mul nsw i64 %polly.indvar388, -100
  %140 = mul nuw nsw i64 %polly.indvar388, 100
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  ...
  %146 = add i64 %smax1005, %indvars.iv1008
...
polly.loop_exit409:                               ; preds = %polly.loop_exit445, %polly.loop_header399
  ...
  %polly.loop_cond405.not = icmp sgt i64 %polly.indvar403, %138
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit445
  %indvars.iv1010 = phi i64 [ %146, %polly.loop_header407.preheader ], [ %indvars.iv.next1011, %polly.loop_exit445 ]
  ...
  %polly.loop_guard4241079 = icmp sgt i64 %149, -1
...
polly.loop_header562:                             ; preds = %polly.loop_exit570, %polly.start476
  ...
  %min.iters.check1163 = icmp ult i64 %164, 4
...
vector.body1162:                                  ; preds = %vector.body1162, %vector.ph1164
  ...
  %166 = shl nuw nsw i64 %index1167, 3
  %167 = getelementptr i8, i8* %scevgep574, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load1171 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  %169 = fmul fast <4 x double> %wide.load1171, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next1168, %n.vec1166
  br i1 %171, label %middle.block1160, label %vector.body1162, !llvm.loop !90

middle.block1160:                                 ; preds = %vector.body1162
  %cmp.n1170 = icmp eq i64 %164, %n.vec1166
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %174 = mul nuw nsw i64 %polly.indvar581, 7
  %175 = add nuw nsw i64 %174, 7
  %pexp.p_div_q590 = lshr i64 %175, 4
  %176 = sub nsw i64 %173, %pexp.p_div_q590
  %polly.loop_guard595 = icmp sgt i64 %176, -2
  %177 = mul nsw i64 %polly.indvar581, -100
  %178 = mul nuw nsw i64 %polly.indvar581, 100
...
polly.loop_header600.preheader:                   ; preds = %polly.loop_header592
  ...
  %184 = add i64 %smax1027, %indvars.iv1030
...
polly.loop_exit602:                               ; preds = %polly.loop_exit638, %polly.loop_header592
  ...
  %polly.loop_cond598.not = icmp sgt i64 %polly.indvar596, %176
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_exit638
  %indvars.iv1032 = phi i64 [ %184, %polly.loop_header600.preheader ], [ %indvars.iv.next1033, %polly.loop_exit638 ]
  ...
  %polly.loop_guard6171080 = icmp sgt i64 %187, -1
...
vector.ph1102:                                    ; preds = %polly.loop_header805
  %broadcast.splatinsert1109 = insertelement <4 x i64> poison, i64 %206, i32 0
  %broadcast.splat1110 = shufflevector <4 x i64> %broadcast.splatinsert1109, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1111 = insertelement <4 x i32> poison, i32 %209, i32 0
...
vector.body1101:                                  ; preds = %vector.body1101, %vector.ph1102
  ...
  %211 = add nuw nsw <4 x i64> %vec.ind1107, %broadcast.splat1110
  %212 = trunc <4 x i64> %211 to <4 x i32>
  %213 = mul <4 x i32> %broadcast.splat1112, %212
  ...
  %223 = icmp eq i64 %index.next1104, %205
  br i1 %223, label %polly.loop_exit813, label %vector.body1101, !llvm.loop !99

polly.loop_exit813:                               ; preds = %vector.body1101, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond1071.not = icmp eq i64 %polly.indvar808, %203
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond1067.not = icmp eq i64 %polly.indvar814, %207
...
polly.loop_header826:                             ; preds = %polly.loop_exit834, %polly.loop_header820
  ...
  %smin1116 = call i64 @llvm.smin.i64(i64 %233, i64 -968)
  %234 = add nsw i64 %smin1116, 1000
  %smin1056 = call i64 @llvm.smin.i64(i64 %indvars.iv1054, i64 -968)
  %235 = shl nsw i64 %polly.indvar829, 5
  %236 = add nsw i64 %smin1056, 999
...
vector.body1115:                                  ; preds = %vector.body1115, %vector.ph1118
  ...
  %240 = add nuw nsw <4 x i64> %vec.ind1125, %broadcast.splat1128
  %241 = trunc <4 x i64> %240 to <4 x i32>
  %242 = mul <4 x i32> %broadcast.splat1130, %241
  ...
  %252 = icmp eq i64 %index.next1122, %234
  br i1 %252, label %polly.loop_exit840, label %vector.body1115, !llvm.loop !102

polly.loop_exit840:                               ; preds = %vector.body1115, %polly.loop_header838
  %polly.indvar_next836 = add nuw nsw i64 %polly.indvar835, 1
  %exitcond1061.not = icmp eq i64 %polly.indvar835, %232
...
polly.loop_header838:                             ; preds = %polly.loop_header832, %polly.loop_header838
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar841, %236
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %smin1134 = call i64 @llvm.smin.i64(i64 %262, i64 -968)
  %263 = add nsw i64 %smin1134, 1000
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv1044, i64 -968)
  %264 = shl nsw i64 %polly.indvar855, 5
  %265 = add nsw i64 %smin1046, 999
...
vector.body1133:                                  ; preds = %vector.body1133, %vector.ph1136
  ...
  %269 = add nuw nsw <4 x i64> %vec.ind1143, %broadcast.splat1146
  %270 = trunc <4 x i64> %269 to <4 x i32>
  %271 = mul <4 x i32> %broadcast.splat1148, %270
  ...
  %281 = icmp eq i64 %index.next1140, %263
  br i1 %281, label %polly.loop_exit866, label %vector.body1133, !llvm.loop !105

polly.loop_exit866:                               ; preds = %vector.body1133, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1051.not = icmp eq i64 %polly.indvar861, %261
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1047.not = icmp eq i64 %polly.indvar867, %265
