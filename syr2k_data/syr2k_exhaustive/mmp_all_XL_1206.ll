; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1206.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1206.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %97 = mul nsw i64 %polly.indvar203, -20
  %98 = add nuw i64 %polly.indvar203, 4
  %99 = udiv i64 %98, 5
  %100 = mul nuw nsw i64 %99, 100
  %101 = add i64 %97, %100
  %102 = mul nuw nsw i64 %polly.indvar203, 20
...
polly.loop_exit208:                               ; preds = %polly.loop_exit214
  ...
  %polly.loop_guard = icmp slt i64 %112, 12
...
polly.loop_exit224:                               ; preds = %polly.loop_exit276, %polly.loop_exit208
  ...
  %indvars.iv.next1155 = add nsw i64 %indvars.iv1154, -20
  %indvars.iv.next1160 = add nuw nsw i64 %indvars.iv1159, 20
  %exitcond1167.not = icmp eq i64 %polly.indvar_next204, 15
...
polly.loop_header222:                             ; preds = %polly.loop_header222.preheader, %polly.loop_exit276
  ...
  %116 = mul nsw i64 %indvar1485, -100
  %117 = add i64 %101, %116
  %smax1487 = call i64 @llvm.smax.i64(i64 %117, i64 0)
  %118 = mul nuw nsw i64 %indvar1485, 100
  %119 = add i64 %103, %118
  ...
  %123 = mul nsw i64 %polly.indvar225, 100
  %124 = add nsw i64 %123, %110
  %125 = icmp sgt i64 %124, 80
  %126 = select i1 %125, i64 %124, i64 80
  %127 = add nsw i64 %124, 99
  %polly.loop_guard263 = icmp sgt i64 %124, -100
...
polly.loop_header234.us995:                       ; preds = %polly.loop_header228.us993, %polly.loop_header234.us995
  ...
  %exitcond1144.not = icmp eq i64 %polly.indvar_next238.us1003, 80
...
polly.loop_header274.preheader:                   ; preds = %polly.merge, %polly.merge.us1028, %polly.merge.us
  ...
  %polly.loop_guard284 = icmp slt i64 %132, 100
...
polly.loop_header281.us:                          ; preds = %polly.loop_header274.us, %polly.loop_exit291.us
  ...
  %smin1490 = call i64 @llvm.smin.i64(i64 %133, i64 79)
  %134 = add nsw i64 %smin1490, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1163, i64 79)
...
polly.loop_header234:                             ; preds = %polly.loop_header228, %polly.loop_header234
  ...
  %exitcond1142.not = icmp eq i64 %polly.indvar_next238, 80
...
polly.loop_header421:                             ; preds = %polly.loop_header421.preheader, %polly.loop_exit447
  ...
  %169 = mul nsw i64 %polly.indvar424, -20
  %170 = add nuw i64 %polly.indvar424, 4
  %171 = udiv i64 %170, 5
  %172 = mul nuw nsw i64 %171, 100
  %173 = add i64 %169, %172
  %174 = mul nuw nsw i64 %polly.indvar424, 20
...
polly.loop_exit447:                               ; preds = %polly.loop_exit504, %polly.loop_exit429
  ...
  %indvars.iv.next1171 = add nsw i64 %indvars.iv1170, -80
  %indvars.iv.next1179 = add nuw nsw i64 %indvars.iv1178, 20
  ...
  %exitcond1201.not = icmp eq i64 %polly.indvar_next425, 15
...
polly.loop_header445:                             ; preds = %polly.loop_header445.preheader, %polly.loop_exit504
  ...
  %188 = mul nsw i64 %indvar1435, -100
  %189 = add i64 %173, %188
  %smax1437 = call i64 @llvm.smax.i64(i64 %189, i64 0)
  %190 = mul nuw nsw i64 %indvar1435, 100
  %191 = add i64 %175, %190
  ...
  %195 = mul nsw i64 %polly.indvar449, 100
  %196 = add nsw i64 %195, %182
  %197 = icmp sgt i64 %196, 80
  %198 = select i1 %197, i64 %196, i64 80
  %199 = add nsw i64 %196, 99
  %polly.loop_guard491 = icmp sgt i64 %196, -100
...
polly.loop_header462.us1040:                      ; preds = %polly.loop_header452.us1038, %polly.loop_header462.us1040
  ...
  %exitcond1176.not = icmp eq i64 %polly.indvar_next466.us1048, 80
...
polly.loop_header502.preheader:                   ; preds = %polly.merge459, %polly.merge459.us1073, %polly.merge459.us
  ...
  %polly.loop_guard512 = icmp slt i64 %204, 100
...
polly.loop_header509.us:                          ; preds = %polly.loop_header502.us, %polly.loop_exit519.us
  ...
  %smin1440 = call i64 @llvm.smin.i64(i64 %205, i64 79)
  %206 = add nsw i64 %smin1440, 1
  %smin1198 = call i64 @llvm.smin.i64(i64 %indvars.iv1196, i64 79)
...
polly.loop_header462:                             ; preds = %polly.loop_header452, %polly.loop_header462
  ...
  %exitcond1174.not = icmp eq i64 %polly.indvar_next466, 80
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit675
  ...
  %241 = mul nsw i64 %polly.indvar652, -20
  %242 = add nuw i64 %polly.indvar652, 4
  %243 = udiv i64 %242, 5
  %244 = mul nuw nsw i64 %243, 100
  %245 = add i64 %241, %244
  %246 = mul nuw nsw i64 %polly.indvar652, 20
...
polly.loop_exit675:                               ; preds = %polly.loop_exit732, %polly.loop_exit657
  ...
  %exitcond1235.not = icmp eq i64 %polly.indvar_next653, 15
...
polly.loop_header673:                             ; preds = %polly.loop_header673.preheader, %polly.loop_exit732
  ...
  %260 = mul nsw i64 %indvar1385, -100
  %261 = add i64 %245, %260
  %smax1387 = call i64 @llvm.smax.i64(i64 %261, i64 0)
  %262 = mul nuw nsw i64 %indvar1385, 100
  %263 = add i64 %247, %262
  ...
  %267 = mul nsw i64 %polly.indvar677, 100
  %268 = add nsw i64 %267, %254
  %269 = icmp sgt i64 %268, 80
  %270 = select i1 %269, i64 %268, i64 80
  %271 = add nsw i64 %268, 99
  %polly.loop_guard719 = icmp sgt i64 %268, -100
...
polly.loop_header690.us1085:                      ; preds = %polly.loop_header680.us1083, %polly.loop_header690.us1085
  ...
  %exitcond1210.not = icmp eq i64 %polly.indvar_next694.us1093, 80
...
polly.loop_header730.preheader:                   ; preds = %polly.merge687, %polly.merge687.us1118, %polly.merge687.us
  ...
  %polly.loop_guard740 = icmp slt i64 %276, 100
...
polly.loop_header737.us:                          ; preds = %polly.loop_header730.us, %polly.loop_exit747.us
  ...
  %smin1390 = call i64 @llvm.smin.i64(i64 %277, i64 79)
...
polly.loop_header690:                             ; preds = %polly.loop_header680, %polly.loop_header690
  ...
  %exitcond1208.not = icmp eq i64 %polly.indvar_next694, 80
