; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3079.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3079.c"
...
polly.loop_header263.preheader.us:                ; preds = %polly.loop_header255.us
  %131 = add nsw i64 %polly.indvar259.us, %109
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %indvars.iv1040 = phi i64 [ %indvars.iv.next1041, %polly.loop_exit406 ], [ 4, %polly.loop_header391 ]
  ...
  %147 = udiv i64 %indvars.iv1040, 5
  %148 = mul nuw nsw i64 %147, 20
  %149 = add i64 %indvars.iv1038, %148
  %150 = sub nsw i64 %indvars.iv1045, %148
  %151 = mul nuw nsw i64 %polly.indvar400, 13
  %152 = trunc i64 %polly.indvar400 to i8
  %pexp.p_div_q403.lhs.trunc = add i8 %152, 4
  %pexp.p_div_q403886 = udiv i8 %pexp.p_div_q403.lhs.trunc, 5
  %pexp.p_div_q403.zext = zext i8 %pexp.p_div_q403886 to i64
  %153 = sub nsw i64 %151, %pexp.p_div_q403.zext
  %154 = mul nsw i64 %polly.indvar400, -256
  %155 = shl nsw i64 %polly.indvar400, 8
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  %indvars.iv1047 = phi i64 [ %indvars.iv.next1048, %polly.loop_exit445 ], [ %150, %polly.loop_header397 ]
  ...
  %157 = mul nsw i64 %polly.indvar407, 20
  %158 = add nsw i64 %157, %154
  %159 = add nsw i64 %158, -1
  %.inv883 = icmp sgt i64 %158, 255
  %160 = select i1 %.inv883, i64 255, i64 %159
...
polly.loop_header458.preheader.us:                ; preds = %polly.loop_header450.us
  %179 = add nsw i64 %polly.indvar454.us, %157
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %indvars.iv1068 = phi i64 [ %indvars.iv.next1069, %polly.loop_exit601 ], [ 4, %polly.loop_header586 ]
  ...
  %195 = udiv i64 %indvars.iv1068, 5
  %196 = mul nuw nsw i64 %195, 20
  %197 = add i64 %indvars.iv1066, %196
  %198 = sub nsw i64 %indvars.iv1073, %196
  %199 = mul nuw nsw i64 %polly.indvar595, 13
  %200 = trunc i64 %polly.indvar595 to i8
  %pexp.p_div_q598.lhs.trunc = add i8 %200, 4
  %pexp.p_div_q598885 = udiv i8 %pexp.p_div_q598.lhs.trunc, 5
  %pexp.p_div_q598.zext = zext i8 %pexp.p_div_q598885 to i64
  %201 = sub nsw i64 %199, %pexp.p_div_q598.zext
  %202 = mul nsw i64 %polly.indvar595, -256
  %203 = shl nsw i64 %polly.indvar595, 8
...
polly.loop_exit601:                               ; preds = %polly.loop_exit640
  ...
  %indvars.iv.next1074 = add nuw nsw i64 %indvars.iv1073, 4
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  %indvars.iv1075 = phi i64 [ %indvars.iv.next1076, %polly.loop_exit640 ], [ %198, %polly.loop_header592 ]
  %indvars.iv1070 = phi i64 [ %indvars.iv.next1071, %polly.loop_exit640 ], [ %197, %polly.loop_header592 ]
  ...
  %205 = mul nsw i64 %polly.indvar602, 20
  %206 = add nsw i64 %205, %202
  %207 = add nsw i64 %206, -1
  %.inv884 = icmp sgt i64 %206, 255
  %208 = select i1 %.inv884, i64 255, i64 %207
...
polly.loop_header653.preheader.us:                ; preds = %polly.loop_header645.us
  %227 = add nsw i64 %polly.indvar649.us, %205
