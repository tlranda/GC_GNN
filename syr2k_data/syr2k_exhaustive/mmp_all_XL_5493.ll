; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5493.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5493.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next209, 38
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 31)
  ...
  %smin845.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844, i64 31)
  %108 = or i64 %104, 1
  ...
  %smin845.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.1, i64 31)
  %112 = or i64 %104, 2
  ...
  %smin845.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.2, i64 31)
  %116 = or i64 %104, 3
  ...
  %smin845.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.3, i64 31)
  %120 = or i64 %104, 4
  ...
  %smin845.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.4, i64 31)
  %124 = or i64 %104, 5
  ...
  %smin845.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.5, i64 31)
  %128 = or i64 %104, 6
  ...
  %smin845.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.6, i64 31)
  %132 = or i64 %104, 7
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1037
  ...
  %wide.load1044 = load <4 x double>, <4 x double>* %149, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %152, label %middle.block1031, label %vector.body1033, !llvm.loop !84
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %155 = shl nsw i64 %polly.indvar375, 5
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %156 = shl nsw i64 %polly.indvar381, 5
  br label %polly.loop_header384

polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %157 = mul nsw i64 %polly.indvar381, -32
  %158 = shl nsw i64 %polly.indvar381, 2
...
polly.loop_exit402:                               ; preds = %polly.loop_exit408
  ...
  %exitcond872.not = icmp eq i64 %polly.indvar_next382, 38
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %smin866 = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 31)
  ...
  %smin866.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865, i64 31)
  %165 = or i64 %161, 1
  ...
  %smin866.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.1, i64 31)
  %169 = or i64 %161, 2
  ...
  %smin866.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.2, i64 31)
  %173 = or i64 %161, 3
  ...
  %smin866.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.3, i64 31)
  %177 = or i64 %161, 4
  ...
  %smin866.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.4, i64 31)
  %181 = or i64 %161, 5
  ...
  %smin866.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.5, i64 31)
  %185 = or i64 %161, 6
  ...
  %smin866.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.6, i64 31)
  %189 = or i64 %161, 7
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %wide.load1018 = load <4 x double>, <4 x double>* %206, align 8, !alias.scope !88, !noalias !90
  ...
  store <4 x double> %207, <4 x double>* %208, align 8, !alias.scope !88, !noalias !90
  %index.next1015 = add i64 %index1014, 4
  %209 = icmp eq i64 %index.next1015, %n.vec1013
  br i1 %209, label %middle.block1007, label %vector.body1009, !llvm.loop !94
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %212 = shl nsw i64 %polly.indvar548, 5
...
polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %214 = mul nsw i64 %polly.indvar554, -32
  %215 = shl nsw i64 %polly.indvar554, 2
...
polly.loop_exit575:                               ; preds = %polly.loop_exit581
  ...
  %exitcond893.not = icmp eq i64 %polly.indvar_next555, 38
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit559
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 31)
  ...
  %smin887.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886, i64 31)
  %222 = or i64 %218, 1
  ...
  %smin887.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.1, i64 31)
  %226 = or i64 %218, 2
  ...
  %smin887.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.2, i64 31)
  %230 = or i64 %218, 3
  ...
  %smin887.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.3, i64 31)
  %234 = or i64 %218, 4
  ...
  %smin887.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.4, i64 31)
  %238 = or i64 %218, 5
  ...
  %smin887.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.5, i64 31)
  %242 = or i64 %218, 6
  ...
  %smin887.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.6, i64 31)
  %246 = or i64 %218, 7
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph949
  ...
  store <4 x double> %274, <4 x double>* %279, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %280, label %polly.loop_exit760, label %vector.body948, !llvm.loop !103
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph965
  ...
  store <4 x double> %303, <4 x double>* %308, align 8, !alias.scope !102, !noalias !105
  ...
  br i1 %309, label %polly.loop_exit787, label %vector.body962, !llvm.loop !106
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph983
  ...
  store <4 x double> %332, <4 x double>* %337, align 8, !alias.scope !101, !noalias !108
  ...
  br i1 %338, label %polly.loop_exit813, label %vector.body980, !llvm.loop !109
