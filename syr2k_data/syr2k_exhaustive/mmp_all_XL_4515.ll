; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4515.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4515.c"
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1195
  ...
  %wide.load1202 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %137, label %middle.block1189, label %vector.body1191, !llvm.loop !80
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %.inv873 = icmp slt i64 %141, 23
  %143 = select i1 %.inv873, i64 %142, i64 23
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %150 = mul nsw i64 %polly.indvar403, 50
...
vector.body1167:                                  ; preds = %vector.body1167, %vector.ph1169
  ...
  %wide.load1176 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %179, label %middle.block1165, label %vector.body1167, !llvm.loop !90
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %.inv875 = icmp slt i64 %183, 23
  %185 = select i1 %.inv875, i64 %184, i64 23
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %192 = mul nsw i64 %polly.indvar596, 50
...
vector.body1106:                                  ; preds = %vector.body1106, %vector.ph1107
  ...
  br i1 %235, label %polly.loop_exit813, label %vector.body1106, !llvm.loop !99
...
vector.body1120:                                  ; preds = %vector.body1120, %vector.ph1123
  ...
  br i1 %264, label %polly.loop_exit840, label %vector.body1120, !llvm.loop !102
...
vector.body1138:                                  ; preds = %vector.body1138, %vector.ph1141
  ...
  br i1 %293, label %polly.loop_exit866, label %vector.body1138, !llvm.loop !105
