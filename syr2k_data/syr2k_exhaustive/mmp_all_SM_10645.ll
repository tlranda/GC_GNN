; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10645.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10645.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv790, i64 99)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %.inv768 = icmp ult i64 %132, 11
  %133 = mul nsw i64 %polly.indvar355, -128
  %134 = icmp slt i64 %133, -1072
  %135 = select i1 %134, i64 %133, i64 -1072
  %136 = add nsw i64 %135, 1199
  %137 = shl nsw i64 %polly.indvar355, 7
  %.op868 = add nuw i64 %132, 2
  %138 = select i1 %.inv768, i64 %.op868, i64 12
...
polly.loop_header359:                             ; preds = %polly.loop_exit368, %polly.loop_header352
  ...
  %139 = mul nsw i64 %polly.indvar362, 100
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %.inv769 = icmp ult i64 %165, 11
  %166 = mul nsw i64 %polly.indvar511, -128
  %167 = icmp slt i64 %166, -1072
  %168 = select i1 %167, i64 %166, i64 -1072
  %169 = add nsw i64 %168, 1199
  %170 = shl nsw i64 %polly.indvar511, 7
  %.op870 = add nuw i64 %165, 2
  %171 = select i1 %.inv769, i64 %.op870, i64 12
...
polly.loop_exit517:                               ; preds = %polly.loop_exit524
  ...
  %indvars.iv.next821 = add nuw nsw i64 %indvars.iv820, 128
  %exitcond830.not = icmp eq i64 %polly.indvar_next512, 10
...
polly.loop_header515:                             ; preds = %polly.loop_exit524, %polly.loop_header508
  ...
  %172 = mul nsw i64 %polly.indvar518, 100
