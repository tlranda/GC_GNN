; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3454.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3454.c"
...
vector.body1243:                                  ; preds = %vector.body1243, %vector.ph1247
  ...
  %wide.load1254 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %149, label %middle.block1241, label %vector.body1243, !llvm.loop !84
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %153 = lshr i64 %polly.indvar398, 4
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %179 = mul nsw i64 %polly.indvar405, -64
...
vector.body1219:                                  ; preds = %vector.body1219, %vector.ph1221
  ...
  %wide.load1228 = load <4 x double>, <4 x double>* %200, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %203, label %middle.block1217, label %vector.body1219, !llvm.loop !94
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %207 = lshr i64 %polly.indvar595, 4
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  ...
  %219 = shl nsw i64 %polly.indvar602, 4
  %.not.not886 = icmp ugt i64 %219, %polly.indvar595
  %220 = shl nsw i64 %polly.indvar602, 6
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %233 = mul nsw i64 %polly.indvar602, -64
...
vector.body1158:                                  ; preds = %vector.body1158, %vector.ph1159
  ...
  br i1 %271, label %polly.loop_exit825, label %vector.body1158, !llvm.loop !103
...
vector.body1172:                                  ; preds = %vector.body1172, %vector.ph1175
  ...
  br i1 %300, label %polly.loop_exit852, label %vector.body1172, !llvm.loop !106
...
vector.body1190:                                  ; preds = %vector.body1190, %vector.ph1193
  ...
  br i1 %329, label %polly.loop_exit878, label %vector.body1190, !llvm.loop !109
