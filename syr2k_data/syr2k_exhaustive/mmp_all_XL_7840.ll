; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7840.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7840.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %101 = shl nsw i64 %polly.indvar230, 8
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1045
  ...
  %wide.load1052 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %126, label %middle.block1039, label %vector.body1041, !llvm.loop !79
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %128 = lshr i64 %indvars.iv869, 6
  %129 = mul nsw i64 %polly.indvar393, -100
  %130 = mul nuw nsw i64 %polly.indvar393, 100
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %132 = shl nsw i64 %polly.indvar406, 8
  %133 = add nsw i64 %132, %129
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard413 = icmp slt i64 %135, 100
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  %wide.load1026 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %157, label %middle.block1015, label %vector.body1017, !llvm.loop !89
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %159 = lshr i64 %indvars.iv892, 6
  %160 = mul nsw i64 %polly.indvar571, -100
  %161 = mul nuw nsw i64 %polly.indvar571, 100
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %163 = shl nsw i64 %polly.indvar584, 8
  %164 = add nsw i64 %163, %160
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard591 = icmp slt i64 %166, 100
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph957
  ...
  br i1 %202, label %polly.loop_exit772, label %vector.body955, !llvm.loop !98
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  br i1 %231, label %polly.loop_exit799, label %vector.body970, !llvm.loop !101
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  br i1 %260, label %polly.loop_exit825, label %vector.body988, !llvm.loop !104
