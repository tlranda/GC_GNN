; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3986.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3986.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit242
  ...
  %exitcond1014.not = icmp eq i64 %135, 38
...
polly.loop_header205:                             ; preds = %polly.loop_exit242, %polly.loop_header199
  ...
  %136 = add i64 %smax, %indvars.iv1007
  %137 = shl nsw i64 %polly.indvar208, 2
  %.not.not = icmp ugt i64 %137, %polly.indvar202
  %138 = shl nsw i64 %polly.indvar208, 7
  %139 = add nsw i64 %138, %102
  %140 = icmp sgt i64 %139, 0
  %141 = select i1 %140, i64 %139, i64 0
  %142 = add nsw i64 %139, 127
...
polly.loop_header240.preheader:                   ; preds = %polly.loop_exit229, %polly.loop_exit229.us, %polly.loop_header205.split
  ...
  %149 = mul nsw i64 %polly.indvar208, -128
...
polly.loop_header247:                             ; preds = %polly.loop_exit257, %polly.loop_header240
  %indvars.iv1009 = phi i64 [ %indvars.iv.next1010, %polly.loop_exit257 ], [ %136, %polly.loop_header240 ]
  %polly.indvar251 = phi i64 [ %polly.indvar_next252, %polly.loop_exit257 ], [ %148, %polly.loop_header240 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1009, i64 31)
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit394
  ...
  %172 = lshr i64 %polly.indvar388, 2
  %173 = shl nuw nsw i64 %172, 7
  %174 = sub nsw i64 %indvars.iv1020, %173
  %175 = add i64 %indvars.iv1025, %173
...
polly.loop_exit394:                               ; preds = %polly.loop_exit435
  ...
  %exitcond1035.not = icmp eq i64 %210, 38
...
polly.loop_header392:                             ; preds = %polly.loop_exit435, %polly.loop_header385
  %indvars.iv1027 = phi i64 [ %indvars.iv.next1028, %polly.loop_exit435 ], [ %175, %polly.loop_header385 ]
  %indvars.iv1022 = phi i64 [ %indvars.iv.next1023, %polly.loop_exit435 ], [ %174, %polly.loop_header385 ]
  %polly.indvar395 = phi i64 [ %polly.indvar_next396, %polly.loop_exit435 ], [ %172, %polly.loop_header385 ]
  %smax1024 = call i64 @llvm.smax.i64(i64 %indvars.iv1022, i64 0)
  %211 = add i64 %smax1024, %indvars.iv1027
  %212 = shl nsw i64 %polly.indvar395, 2
  %.not.not873 = icmp ugt i64 %212, %polly.indvar388
  %213 = shl nsw i64 %polly.indvar395, 7
...
polly.loop_header433.preheader:                   ; preds = %polly.loop_exit421, %polly.loop_exit421.us, %polly.loop_header392.split
  ...
  %224 = mul nsw i64 %polly.indvar395, -128
...
polly.loop_header440:                             ; preds = %polly.loop_exit450, %polly.loop_header433
  %indvars.iv1029 = phi i64 [ %indvars.iv.next1030, %polly.loop_exit450 ], [ %211, %polly.loop_header433 ]
  %polly.indvar444 = phi i64 [ %polly.indvar_next445, %polly.loop_exit450 ], [ %223, %polly.loop_header433 ]
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 31)
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  ...
  %247 = lshr i64 %polly.indvar581, 2
  %248 = shl nuw nsw i64 %247, 7
  %249 = sub nsw i64 %indvars.iv1041, %248
  %250 = add i64 %indvars.iv1046, %248
...
polly.loop_exit587:                               ; preds = %polly.loop_exit628
  ...
  %indvars.iv.next1042 = add nuw nsw i64 %indvars.iv1041, 32
...
polly.loop_header585:                             ; preds = %polly.loop_exit628, %polly.loop_header578
  %indvars.iv1048 = phi i64 [ %indvars.iv.next1049, %polly.loop_exit628 ], [ %250, %polly.loop_header578 ]
  %indvars.iv1043 = phi i64 [ %indvars.iv.next1044, %polly.loop_exit628 ], [ %249, %polly.loop_header578 ]
  %polly.indvar588 = phi i64 [ %polly.indvar_next589, %polly.loop_exit628 ], [ %247, %polly.loop_header578 ]
  %smax1045 = call i64 @llvm.smax.i64(i64 %indvars.iv1043, i64 0)
  %286 = add i64 %smax1045, %indvars.iv1048
  %287 = shl nsw i64 %polly.indvar588, 2
  %.not.not874 = icmp ugt i64 %287, %polly.indvar581
  %288 = shl nsw i64 %polly.indvar588, 7
  %289 = add nsw i64 %288, %252
  %290 = icmp sgt i64 %289, 0
  %291 = select i1 %290, i64 %289, i64 0
  %292 = add nsw i64 %289, 127
...
polly.loop_header626.preheader:                   ; preds = %polly.loop_exit614, %polly.loop_exit614.us, %polly.loop_header585.split
  ...
  %299 = mul nsw i64 %polly.indvar588, -128
  %300 = icmp slt i64 %299, -1072
  %301 = select i1 %300, i64 %299, i64 -1072
...
polly.loop_header633:                             ; preds = %polly.loop_exit643, %polly.loop_header626
  %indvars.iv1050 = phi i64 [ %indvars.iv.next1051, %polly.loop_exit643 ], [ %286, %polly.loop_header626 ]
  %polly.indvar637 = phi i64 [ %polly.indvar_next638, %polly.loop_exit643 ], [ %298, %polly.loop_header626 ]
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1050, i64 31)
