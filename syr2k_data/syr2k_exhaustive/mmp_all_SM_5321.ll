; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5321.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5321.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next973 = add nuw nsw i64 %indvars.iv972, 128
  %exitcond984.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit244
  ...
  %smin980 = call i64 @llvm.smin.i64(i64 %indvars.iv976, i64 99)
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit388
  ...
  %.inv855 = icmp ult i64 %134, 11
  %135 = mul nsw i64 %polly.indvar382, -128
  %136 = icmp slt i64 %135, -1072
  %137 = select i1 %136, i64 %135, i64 -1072
  %138 = add nsw i64 %137, 1199
  %139 = shl nsw i64 %polly.indvar382, 7
  %.op1066 = add nuw i64 %134, 2
  %140 = select i1 %.inv855, i64 %.op1066, i64 12
...
polly.loop_exit388:                               ; preds = %polly.loop_exit395
  ...
  %indvars.iv.next994 = add nuw nsw i64 %indvars.iv993, 128
  %exitcond1006.not = icmp eq i64 %polly.indvar_next383, 10
...
polly.loop_header386:                             ; preds = %polly.loop_exit395, %polly.loop_header379
  ...
  %141 = mul nsw i64 %polly.indvar389, 100
...
polly.loop_exit395:                               ; preds = %polly.loop_exit431, %polly.loop_header386
  ...
  %indvars.iv.next991 = add i64 %indvars.iv990, 100
  %indvars.iv.next996 = add i64 %indvars.iv995, -100
...
polly.loop_header566:                             ; preds = %polly.loop_header566.preheader, %polly.loop_exit575
  ...
  %.inv857 = icmp ult i64 %169, 11
  %170 = mul nsw i64 %polly.indvar569, -128
  %171 = icmp slt i64 %170, -1072
  %172 = select i1 %171, i64 %170, i64 -1072
  %173 = add nsw i64 %172, 1199
  %174 = shl nsw i64 %polly.indvar569, 7
  %.op1068 = add nuw i64 %169, 2
  %175 = select i1 %.inv857, i64 %.op1068, i64 12
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next570, 10
...
polly.loop_header573:                             ; preds = %polly.loop_exit582, %polly.loop_header566
  ...
  %176 = mul nsw i64 %polly.indvar576, 100
...
polly.loop_exit582:                               ; preds = %polly.loop_exit618, %polly.loop_header573
  ...
  %indvars.iv.next1018 = add i64 %indvars.iv1017, -100
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit618
  ...
  %smin1024 = call i64 @llvm.smin.i64(i64 %indvars.iv1019, i64 99)
