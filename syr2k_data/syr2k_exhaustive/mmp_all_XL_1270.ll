; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1270.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1270.c"
...
vector.body1334:                                  ; preds = %vector.body1334, %vector.ph1336
  ...
  br i1 %57, label %middle.block1332, label %vector.body1334, !llvm.loop !63
...
vector.body1384:                                  ; preds = %vector.body1384, %vector.ph1386
  ...
  br i1 %68, label %middle.block1382, label %vector.body1384, !llvm.loop !65
...
vector.body1396:                                  ; preds = %vector.body1396, %vector.ph1400
  ...
  %wide.load1407 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1394, label %vector.body1396, !llvm.loop !78
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %102 = add i64 %101, %99
  %103 = shl nuw nsw i64 %indvars.iv1094, 1
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %110 = mul nuw nsw i64 %polly.indvar209, 25
  %pexp.p_div_q = lshr i64 %110, 6
...
polly.loop_header272:                             ; preds = %polly.loop_header265, %polly.loop_exit282
  ...
  %smin1416 = call i64 @llvm.smin.i64(i64 %140, i64 49)
...
vector.body1410:                                  ; preds = %vector.body1410, %vector.ph1418
  ...
  %wide.load1431 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %161, label %middle.block1408, label %vector.body1410, !llvm.loop !83
...
polly.loop_header280:                             ; preds = %polly.loop_header280.preheader1432, %polly.loop_header280
  ...
  br i1 %exitcond1104.not, label %polly.loop_exit282, label %polly.loop_header280, !llvm.loop !84
...
vector.body1346:                                  ; preds = %vector.body1346, %vector.ph1350
  ...
  %wide.load1357 = load <4 x double>, <4 x double>* %169, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %172, label %middle.block1344, label %vector.body1346, !llvm.loop !92
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_header402
  ...
  br i1 %exitcond1137.not, label %polly.loop_exit404, label %polly.loop_header402, !llvm.loop !93
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %177 = and i64 %175, 126
  %178 = mul nsw i64 %polly.indvar421, -50
  %179 = add i64 %178, %176
  %180 = shl nuw nsw i64 %indvars.iv1120, 1
  %181 = and i64 %180, 9223372036854775680
  %182 = sub nsw i64 %indvars.iv1118, %181
  %183 = add i64 %indvars.iv1125, %181
  %184 = mul nsw i64 %polly.indvar421, -50
  %185 = mul nuw nsw i64 %polly.indvar421, 50
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %186 = add nsw i64 %184, 1199
  %187 = mul nuw nsw i64 %polly.indvar421, 25
  %pexp.p_div_q440 = lshr i64 %187, 6
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header441.split
  ...
  %212 = mul nsw i64 %polly.indvar444, -128
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %smin1366 = call i64 @llvm.smin.i64(i64 %217, i64 49)
...
vector.body1360:                                  ; preds = %vector.body1360, %vector.ph1368
  ...
  %wide.load1381 = load <4 x double>, <4 x double>* %233, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %238, label %middle.block1358, label %vector.body1360, !llvm.loop !96
...
polly.loop_header495:                             ; preds = %polly.loop_header495.preheader1436, %polly.loop_header495
  ...
  br i1 %exitcond1132.not, label %polly.loop_exit497, label %polly.loop_header495, !llvm.loop !97
...
vector.body1298:                                  ; preds = %vector.body1298, %vector.ph1300
  ...
  %wide.load1307 = load <4 x double>, <4 x double>* %246, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %249, label %middle.block1296, label %vector.body1298, !llvm.loop !105
...
polly.loop_header617:                             ; preds = %polly.loop_header617.preheader, %polly.loop_header617
  ...
  br i1 %exitcond1165.not, label %polly.loop_exit619, label %polly.loop_header617, !llvm.loop !106
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %252 = mul nuw nsw i64 %polly.indvar636, 50
  %253 = and i64 %252, 9223372036854775680
  %254 = and i64 %252, 126
  %255 = mul nsw i64 %polly.indvar636, -50
  %256 = add i64 %255, %253
  %257 = shl nuw nsw i64 %indvars.iv1148, 1
  %258 = and i64 %257, 9223372036854775680
  %259 = sub nsw i64 %indvars.iv1146, %258
  %260 = add i64 %indvars.iv1153, %258
  %261 = mul nsw i64 %polly.indvar636, -50
  %262 = mul nuw nsw i64 %polly.indvar636, 50
  br label %polly.loop_header639

polly.loop_exit641:                               ; preds = %polly.loop_exit647
  %263 = add nsw i64 %261, 1199
  %264 = mul nuw nsw i64 %polly.indvar636, 25
  %pexp.p_div_q655 = lshr i64 %264, 6
...
polly.loop_header702:                             ; preds = %polly.loop_header695, %polly.loop_exit712
  ...
  %smin1316 = call i64 @llvm.smin.i64(i64 %294, i64 49)
...
vector.body1310:                                  ; preds = %vector.body1310, %vector.ph1318
  ...
  %wide.load1331 = load <4 x double>, <4 x double>* %310, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %315, label %middle.block1308, label %vector.body1310, !llvm.loop !109
...
polly.loop_header710:                             ; preds = %polly.loop_header710.preheader1440, %polly.loop_header710
  ...
  br i1 %exitcond1160.not, label %polly.loop_exit712, label %polly.loop_header710, !llvm.loop !110
...
vector.body1236:                                  ; preds = %vector.body1236, %vector.ph1238
  ...
  br i1 %340, label %polly.loop_exit882, label %vector.body1236, !llvm.loop !116
...
polly.loop_header880:                             ; preds = %polly.loop_header874, %polly.loop_header880
  ...
  br i1 %exitcond1190.not, label %polly.loop_exit882, label %polly.loop_header880, !llvm.loop !117
...
vector.body1251:                                  ; preds = %vector.body1251, %vector.ph1254
  ...
  br i1 %369, label %polly.loop_exit909, label %vector.body1251, !llvm.loop !119
...
polly.loop_header907:                             ; preds = %polly.loop_header901, %polly.loop_header907
  ...
  br i1 %exitcond1180.not, label %polly.loop_exit909, label %polly.loop_header907, !llvm.loop !120
...
vector.body1269:                                  ; preds = %vector.body1269, %vector.ph1272
  ...
  br i1 %398, label %polly.loop_exit935, label %vector.body1269, !llvm.loop !122
...
polly.loop_header933:                             ; preds = %polly.loop_header927, %polly.loop_header933
  ...
  br i1 %exitcond1170.not, label %polly.loop_exit935, label %polly.loop_header933, !llvm.loop !123
}
