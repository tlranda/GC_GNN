; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6255.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6255.c"
...
vector.body1021:                                  ; preds = %vector.body1021, %vector.ph1023
  ...
  br i1 %57, label %middle.block1019, label %vector.body1021, !llvm.loop !58
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1049
  ...
  br i1 %68, label %middle.block1045, label %vector.body1047, !llvm.loop !60
...
vector.body1059:                                  ; preds = %vector.body1059, %vector.ph1063
  ...
  %wide.load1070 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !66, !noalias !68
  ...
  br i1 %95, label %middle.block1057, label %vector.body1059, !llvm.loop !72
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond853.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !73
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin848 = call i64 @llvm.smin.i64(i64 %indvars.iv838, i64 -920)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next839 = add nsw i64 %indvars.iv838, -80
  %exitcond852.not = icmp eq i64 %polly.indvar_next203, 13
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next209, 15
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_exit219
  %101 = mul nsw i64 %polly.indvar208, -80
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241
  ...
  %indvars.iv.next842 = add nuw nsw i64 %indvars.iv841, 80
  %exitcond850.not = icmp eq i64 %polly.indvar_next231, 15
...
polly.loop_header239:                             ; preds = %polly.loop_exit247, %polly.loop_header233
  ...
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 79)
...
polly.loop_exit247:                               ; preds = %polly.loop_header245
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar_next243, 80
...
polly.loop_header245:                             ; preds = %polly.loop_header245, %polly.loop_header239
  ...
  %111 = add nuw nsw i64 %polly.indvar248, %99
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1037
  ...
  %118 = shl nuw nsw i64 %index1040, 3
  %119 = getelementptr i8, i8* %scevgep368, i64 %118
  %120 = bitcast i8* %119 to <4 x double>*
  %wide.load1044 = load <4 x double>, <4 x double>* %120, align 8, !alias.scope !77, !noalias !79
  %121 = fmul fast <4 x double> %wide.load1044, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %122 = bitcast i8* %119 to <4 x double>*
  store <4 x double> %121, <4 x double>* %122, align 8, !alias.scope !77, !noalias !79
  %index.next1041 = add i64 %index1040, 4
  %123 = icmp eq i64 %index.next1041, %n.vec1039
  br i1 %123, label %middle.block1031, label %vector.body1033, !llvm.loop !83

middle.block1031:                                 ; preds = %vector.body1033
  %cmp.n1043 = icmp eq i64 %116, %n.vec1039
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_header362
  ...
  br i1 %exitcond874.not, label %polly.loop_exit364, label %polly.loop_header362, !llvm.loop !84
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %smin869 = call i64 @llvm.smin.i64(i64 %indvars.iv858, i64 -920)
  %125 = add nsw i64 %smin869, 1000
  %126 = mul nuw nsw i64 %polly.indvar375, 80
...
polly.loop_exit380:                               ; preds = %polly.loop_exit402
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar_next376, 13
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %127 = mul nuw nsw i64 %polly.indvar381, 80
...
polly.loop_exit402:                               ; preds = %polly.loop_exit408
  ...
  %exitcond872.not = icmp eq i64 %polly.indvar_next382, 15
...
polly.loop_exit392:                               ; preds = %polly.loop_header390
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar_next388, %125
...
polly.loop_header400.preheader:                   ; preds = %polly.loop_exit392
  %129 = mul nsw i64 %polly.indvar381, -80
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit408
  ...
  %131 = mul nuw nsw i64 %polly.indvar403, 80
  br label %polly.loop_header406

polly.loop_exit408:                               ; preds = %polly.loop_exit414
  %polly.indvar_next404 = add nuw nsw i64 %polly.indvar403, 1
  %indvars.iv.next863 = add nuw nsw i64 %indvars.iv862, 80
  %exitcond871.not = icmp eq i64 %polly.indvar_next404, 15
...
polly.loop_header406:                             ; preds = %polly.loop_exit414, %polly.loop_header400
  ...
  %132 = add nuw nsw i64 %polly.indvar409, %126
  %133 = shl i64 %132, 3
...
polly.loop_exit414:                               ; preds = %polly.loop_exit420
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next410, %125
...
polly.loop_exit420:                               ; preds = %polly.loop_header418
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar_next416, 80
...
polly.loop_header418:                             ; preds = %polly.loop_header418, %polly.loop_header412
  ...
  %139 = add nuw nsw i64 %polly.indvar421, %127
...
polly.start443:                                   ; preds = %init_array.exit
  %malloccall445 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header529:                             ; preds = %polly.loop_exit537, %polly.start443
  ...
  %min.iters.check1010 = icmp ult i64 %144, 4
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %146 = shl nuw nsw i64 %index1014, 3
  %147 = getelementptr i8, i8* %scevgep541, i64 %146
  %148 = bitcast i8* %147 to <4 x double>*
  %wide.load1018 = load <4 x double>, <4 x double>* %148, align 8, !alias.scope !87, !noalias !89
  %149 = fmul fast <4 x double> %wide.load1018, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %150 = bitcast i8* %147 to <4 x double>*
  store <4 x double> %149, <4 x double>* %150, align 8, !alias.scope !87, !noalias !89
  %index.next1015 = add i64 %index1014, 4
  %151 = icmp eq i64 %index.next1015, %n.vec1013
  br i1 %151, label %middle.block1007, label %vector.body1009, !llvm.loop !93

middle.block1007:                                 ; preds = %vector.body1009
  %cmp.n1017 = icmp eq i64 %144, %n.vec1013
...
polly.loop_header535:                             ; preds = %polly.loop_header535.preheader, %polly.loop_header535
  ...
  br i1 %exitcond895.not, label %polly.loop_exit537, label %polly.loop_header535, !llvm.loop !94
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %smin890 = call i64 @llvm.smin.i64(i64 %indvars.iv879, i64 -920)
  %153 = add nsw i64 %smin890, 1000
  %154 = mul nuw nsw i64 %polly.indvar548, 80
...
polly.loop_exit553:                               ; preds = %polly.loop_exit575
  ...
  %exitcond894.not = icmp eq i64 %polly.indvar_next549, 13
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %155 = mul nuw nsw i64 %polly.indvar554, 80
...
polly.loop_exit575:                               ; preds = %polly.loop_exit581
  ...
  %exitcond893.not = icmp eq i64 %polly.indvar_next555, 15
...
polly.loop_header557:                             ; preds = %polly.loop_exit565, %polly.loop_header551
  ...
  %156 = add nuw nsw i64 %polly.indvar560, %154
...
polly.loop_exit565:                               ; preds = %polly.loop_header563
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next561, %153
...
polly.loop_header573.preheader:                   ; preds = %polly.loop_exit565
  %157 = mul nsw i64 %polly.indvar554, -80
...
polly.loop_header563:                             ; preds = %polly.loop_header563, %polly.loop_header557
  ...
  %158 = add nuw nsw i64 %polly.indvar566, %155
  %polly.access.mul.call2570 = mul nuw nsw i64 %158, 1000
  %polly.access.add.call2571 = add nuw nsw i64 %156, %polly.access.mul.call2570
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %159 = mul nuw nsw i64 %polly.indvar576, 80
...
polly.loop_exit581:                               ; preds = %polly.loop_exit587
  ...
  %exitcond892.not = icmp eq i64 %polly.indvar_next577, 15
...
polly.loop_header579:                             ; preds = %polly.loop_exit587, %polly.loop_header573
  ...
  %160 = add nuw nsw i64 %polly.indvar582, %154
  %161 = shl i64 %160, 3
...
polly.loop_exit587:                               ; preds = %polly.loop_exit593
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar_next583, %153
...
polly.loop_exit593:                               ; preds = %polly.loop_header591
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar_next589, 80
...
polly.loop_header591:                             ; preds = %polly.loop_header591, %polly.loop_header585
  ...
  %167 = add nuw nsw i64 %polly.indvar594, %155
...
vector.ph949:                                     ; preds = %polly.loop_header752
  %broadcast.splatinsert956 = insertelement <4 x i64> poison, i64 %176, i32 0
  %broadcast.splat957 = shufflevector <4 x i64> %broadcast.splatinsert956, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert958 = insertelement <4 x i32> poison, i32 %179, i32 0
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph949
  ...
  %181 = add nuw nsw <4 x i64> %vec.ind954, %broadcast.splat957
  %182 = trunc <4 x i64> %181 to <4 x i32>
  %183 = mul <4 x i32> %broadcast.splat959, %182
  ...
  store <4 x double> %187, <4 x double>* %192, align 8, !alias.scope !97, !noalias !99
  %index.next951 = add i64 %index950, 4
  %vec.ind.next955 = add <4 x i64> %vec.ind954, <i64 4, i64 4, i64 4, i64 4>
  %193 = icmp eq i64 %index.next951, %175
  br i1 %193, label %polly.loop_exit760, label %vector.body948, !llvm.loop !102

polly.loop_exit760:                               ; preds = %vector.body948, %polly.loop_header758
  %polly.indvar_next756 = add nuw nsw i64 %polly.indvar755, 1
  %exitcond924.not = icmp eq i64 %polly.indvar755, %173
...
polly.loop_header758:                             ; preds = %polly.loop_header752, %polly.loop_header758
  ...
  %exitcond920.not = icmp eq i64 %polly.indvar761, %177
  br i1 %exitcond920.not, label %polly.loop_exit760, label %polly.loop_header758, !llvm.loop !103
...
polly.loop_header773:                             ; preds = %polly.loop_exit781, %polly.loop_header767
  ...
  %smin963 = call i64 @llvm.smin.i64(i64 %203, i64 -968)
  %204 = add nsw i64 %smin963, 1000
  %smin909 = call i64 @llvm.smin.i64(i64 %indvars.iv907, i64 -968)
  %205 = shl nsw i64 %polly.indvar776, 5
  %206 = add nsw i64 %smin909, 999
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph965
  ...
  %210 = add nuw nsw <4 x i64> %vec.ind972, %broadcast.splat975
  %211 = trunc <4 x i64> %210 to <4 x i32>
  %212 = mul <4 x i32> %broadcast.splat977, %211
  ...
  store <4 x double> %216, <4 x double>* %221, align 8, !alias.scope !101, !noalias !104
  %index.next969 = add i64 %index968, 4
  %vec.ind.next973 = add <4 x i64> %vec.ind972, <i64 4, i64 4, i64 4, i64 4>
  %222 = icmp eq i64 %index.next969, %204
  br i1 %222, label %polly.loop_exit787, label %vector.body962, !llvm.loop !105

polly.loop_exit787:                               ; preds = %vector.body962, %polly.loop_header785
  %polly.indvar_next783 = add nuw nsw i64 %polly.indvar782, 1
  %exitcond914.not = icmp eq i64 %polly.indvar782, %202
...
polly.loop_header785:                             ; preds = %polly.loop_header779, %polly.loop_header785
  ...
  %exitcond910.not = icmp eq i64 %polly.indvar788, %206
  br i1 %exitcond910.not, label %polly.loop_exit787, label %polly.loop_header785, !llvm.loop !106
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  %smin981 = call i64 @llvm.smin.i64(i64 %232, i64 -968)
  %233 = add nsw i64 %smin981, 1000
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 -968)
  %234 = shl nsw i64 %polly.indvar802, 5
  %235 = add nsw i64 %smin899, 999
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph983
  ...
  %239 = add nuw nsw <4 x i64> %vec.ind990, %broadcast.splat993
  %240 = trunc <4 x i64> %239 to <4 x i32>
  %241 = mul <4 x i32> %broadcast.splat995, %240
  ...
  store <4 x double> %245, <4 x double>* %250, align 8, !alias.scope !100, !noalias !107
  %index.next987 = add i64 %index986, 4
  %vec.ind.next991 = add <4 x i64> %vec.ind990, <i64 4, i64 4, i64 4, i64 4>
  %251 = icmp eq i64 %index.next987, %233
  br i1 %251, label %polly.loop_exit813, label %vector.body980, !llvm.loop !108

polly.loop_exit813:                               ; preds = %vector.body980, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond904.not = icmp eq i64 %polly.indvar808, %231
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar814, %235
  br i1 %exitcond900.not, label %polly.loop_exit813, label %polly.loop_header811, !llvm.loop !109
}
