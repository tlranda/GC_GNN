; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6921.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6921.c"
...
vector.body1019:                                  ; preds = %vector.body1019, %vector.ph1021
  ...
  br i1 %57, label %middle.block1017, label %vector.body1019, !llvm.loop !53
...
vector.body1045:                                  ; preds = %vector.body1045, %vector.ph1047
  ...
  br i1 %68, label %middle.block1043, label %vector.body1045, !llvm.loop !55
...
vector.body1057:                                  ; preds = %vector.body1057, %vector.ph1061
  ...
  %wide.load1068 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !61, !noalias !63
  ...
  br i1 %95, label %middle.block1055, label %vector.body1057, !llvm.loop !67
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond845.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !68
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next219, 75
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %smin835 = call i64 @llvm.smin.i64(i64 %indvars.iv833, i64 -984)
  %98 = shl nsw i64 %polly.indvar224, 4
...
polly.loop_exit241:                               ; preds = %polly.loop_exit247.loopexit.us, %polly.loop_header233
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar_next237, 16
...
vector.body1031:                                  ; preds = %vector.body1031, %vector.ph1035
  ...
  %wide.load1042 = load <4 x double>, <4 x double>* %118, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %121, label %middle.block1029, label %vector.body1031, !llvm.loop !78
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_header362
  ...
  br i1 %exitcond867.not, label %polly.loop_exit364, label %polly.loop_header362, !llvm.loop !79
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %123 = shl nsw i64 %polly.indvar391, 4
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar_next392, 75
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header388
  ...
  %124 = shl nsw i64 %polly.indvar397, 4
...
polly.loop_exit402:                               ; preds = %polly.loop_exit408
  ...
  %exitcond863.not = icmp eq i64 %polly.indvar_next398, 63
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_header394
  ...
  %126 = shl nsw i64 %polly.indvar403, 4
...
polly.loop_exit414:                               ; preds = %polly.loop_exit421.loopexit.us, %polly.loop_header406
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next410, 16
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1009
  ...
  %wide.load1016 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !82, !noalias !84
  ...
  br i1 %147, label %middle.block1005, label %vector.body1007, !llvm.loop !88
...
polly.loop_header537:                             ; preds = %polly.loop_header537.preheader, %polly.loop_header537
  ...
  br i1 %exitcond889.not, label %polly.loop_exit539, label %polly.loop_header537, !llvm.loop !89
...
polly.loop_header563:                             ; preds = %polly.loop_exit555, %polly.loop_exit571
  ...
  %149 = shl nsw i64 %polly.indvar566, 4
...
polly.loop_exit571:                               ; preds = %polly.loop_exit577
  ...
  %indvars.iv.next870 = add nuw nsw i64 %indvars.iv869, 16
  %indvars.iv.next883 = add nuw nsw i64 %indvars.iv882, 1
  %exitcond886.not = icmp eq i64 %polly.indvar_next567, 75
...
polly.loop_header569:                             ; preds = %polly.loop_exit577, %polly.loop_header563
  ...
  %150 = shl nsw i64 %polly.indvar572, 4
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %exitcond885.not = icmp eq i64 %polly.indvar_next573, 63
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %152 = shl nsw i64 %polly.indvar578, 4
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header581
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next585, 16
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph947
  ...
  store <4 x double> %181, <4 x double>* %186, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %187, label %polly.loop_exit764, label %vector.body945, !llvm.loop !97
...
polly.loop_header762:                             ; preds = %polly.loop_header756, %polly.loop_header762
  ...
  br i1 %exitcond914.not, label %polly.loop_exit764, label %polly.loop_header762, !llvm.loop !98
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph963
  ...
  store <4 x double> %210, <4 x double>* %215, align 8, !alias.scope !96, !noalias !99
  ...
  br i1 %216, label %polly.loop_exit791, label %vector.body960, !llvm.loop !100
...
polly.loop_header789:                             ; preds = %polly.loop_header783, %polly.loop_header789
  ...
  br i1 %exitcond904.not, label %polly.loop_exit791, label %polly.loop_header789, !llvm.loop !101
...
vector.body978:                                   ; preds = %vector.body978, %vector.ph981
  ...
  store <4 x double> %239, <4 x double>* %244, align 8, !alias.scope !95, !noalias !102
  ...
  br i1 %245, label %polly.loop_exit817, label %vector.body978, !llvm.loop !103
...
polly.loop_header815:                             ; preds = %polly.loop_header809, %polly.loop_header815
  ...
  br i1 %exitcond894.not, label %polly.loop_exit817, label %polly.loop_header815, !llvm.loop !104
}
