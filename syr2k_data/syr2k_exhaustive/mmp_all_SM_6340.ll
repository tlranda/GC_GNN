; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6340.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6340.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next209, 38
...
vector.body1065:                                  ; preds = %vector.body1065, %vector.ph1069
  ...
  %wide.load1076 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %135, label %middle.block1063, label %vector.body1065, !llvm.loop !84
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %139 = udiv i64 %polly.indvar383, 3
...
polly.loop_exit405:                               ; preds = %polly.loop_exit411
  ...
  %indvars.iv.next882 = add nuw nsw i64 %indvars.iv881, 32
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, -32
  %exitcond896.not = icmp eq i64 %polly.indvar_next384, 38
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  ...
  %smin892 = call i64 @llvm.smin.i64(i64 %indvars.iv890, i64 31)
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1043
  ...
  %wide.load1050 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %175, label %middle.block1039, label %vector.body1041, !llvm.loop !94
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %179 = udiv i64 %polly.indvar561, 3
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %exitcond922.not = icmp eq i64 %polly.indvar_next562, 38
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  ...
  %smin918 = call i64 @llvm.smin.i64(i64 %indvars.iv916, i64 31)
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph981
  ...
  br i1 %229, label %polly.loop_exit772, label %vector.body980, !llvm.loop !103
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph997
  ...
  br i1 %258, label %polly.loop_exit799, label %vector.body994, !llvm.loop !106
...
vector.body1012:                                  ; preds = %vector.body1012, %vector.ph1015
  ...
  br i1 %287, label %polly.loop_exit825, label %vector.body1012, !llvm.loop !109
