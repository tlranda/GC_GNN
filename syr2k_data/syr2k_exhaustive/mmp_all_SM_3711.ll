; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3711.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3711.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %indvars.iv.next1020 = add nuw nsw i64 %indvars.iv1019, 32
  %indvars.iv.next1024 = add nsw i64 %indvars.iv1023, -32
  %exitcond1033.not = icmp eq i64 %137, 38
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %138 = add i64 %smax, %indvars.iv1025
  %139 = mul nuw nsw i64 %polly.indvar214, 3
  %.not.not = icmp ugt i64 %139, %polly.indvar208
  %140 = mul nuw nsw i64 %polly.indvar214, 96
  %141 = add nsw i64 %140, %104
  %142 = icmp sgt i64 %141, 0
  %143 = select i1 %142, i64 %141, i64 0
  %144 = add nsw i64 %141, 95
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %153 = mul nsw i64 %polly.indvar214, -96
  %154 = icmp slt i64 %153, -1104
  %155 = select i1 %154, i64 %153, i64 -1104
...
polly.loop_exit255:                               ; preds = %polly.loop_exit263
  ...
  %exitcond1032.not = icmp eq i64 %polly.indvar_next250, %97
  br i1 %exitcond1032.not, label %polly.loop_exit248, label %polly.loop_header246

polly.loop_header253:                             ; preds = %polly.loop_header246, %polly.loop_exit263
  %indvars.iv1027 = phi i64 [ %138, %polly.loop_header246 ], [ %indvars.iv.next1028, %polly.loop_exit263 ]
...
polly.loop_header261:                             ; preds = %polly.loop_header261.preheader, %polly.loop_header261
  ...
  %exitcond1030.not = icmp eq i64 %polly.indvar265, %smin1029
  br i1 %exitcond1030.not, label %polly.loop_exit263, label %polly.loop_header261
...
vector.body1243:                                  ; preds = %vector.body1243, %vector.ph1247
  ...
  %wide.load1254 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %177, label %middle.block1241, label %vector.body1243, !llvm.loop !85
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %179 = add nsw i64 %smin1057, 1000
  %180 = mul nuw nsw i64 %polly.indvar392, 80
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %181 = udiv i64 %polly.indvar398, 3
  %182 = mul nuw nsw i64 %181, 96
  %183 = sub nsw i64 %indvars.iv1044, %182
  %184 = add i64 %indvars.iv1049, %182
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %indvars.iv.next1045 = add nuw nsw i64 %indvars.iv1044, 32
  %indvars.iv.next1050 = add nsw i64 %indvars.iv1049, -32
  %exitcond1059.not = icmp eq i64 %219, 38
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit445 ], [ %184, %polly.loop_header395 ]
  %indvars.iv1046 = phi i64 [ %indvars.iv.next1047, %polly.loop_exit445 ], [ %183, %polly.loop_header395 ]
  ...
  %220 = add i64 %smax1048, %indvars.iv1051
  %221 = mul nuw nsw i64 %polly.indvar405, 3
  %.not.not885 = icmp ugt i64 %221, %polly.indvar398
  %222 = mul nuw nsw i64 %polly.indvar405, 96
  %223 = add nsw i64 %222, %186
  %224 = icmp sgt i64 %223, 0
  %225 = select i1 %224, i64 %223, i64 0
  %226 = add nsw i64 %223, 95
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_header408.us
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next412.us, %179
...
polly.loop_exit445:                               ; preds = %polly.loop_exit452, %polly.loop_header443.preheader
  ...
  %indvars.iv.next1047 = add i64 %indvars.iv1046, -96
  %indvars.iv.next1052 = add i64 %indvars.iv1051, 96
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next412, %179
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %235 = mul nsw i64 %polly.indvar405, -96
  %236 = icmp slt i64 %235, -1104
  %237 = select i1 %236, i64 %235, i64 -1104
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next447, %179
  br i1 %exitcond1058.not, label %polly.loop_exit445, label %polly.loop_header443

polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1053 = phi i64 [ %220, %polly.loop_header443 ], [ %indvars.iv.next1054, %polly.loop_exit460 ]
  %polly.indvar454 = phi i64 [ %234, %polly.loop_header443 ], [ %polly.indvar_next455, %polly.loop_exit460 ]
  %smin1055 = call i64 @llvm.smin.i64(i64 %indvars.iv1053, i64 31)
...
polly.loop_header458:                             ; preds = %polly.loop_header458.preheader, %polly.loop_header458
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar462, %smin1055
  br i1 %exitcond1056.not, label %polly.loop_exit460, label %polly.loop_header458
...
vector.body1219:                                  ; preds = %vector.body1219, %vector.ph1221
  ...
  %wide.load1228 = load <4 x double>, <4 x double>* %256, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %259, label %middle.block1217, label %vector.body1219, !llvm.loop !95
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %261 = add nsw i64 %smin1083, 1000
  %262 = mul nuw nsw i64 %polly.indvar589, 80
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %263 = udiv i64 %polly.indvar595, 3
  %264 = mul nuw nsw i64 %263, 96
  %265 = sub nsw i64 %indvars.iv1070, %264
  %266 = add i64 %indvars.iv1075, %264
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1077 = phi i64 [ %indvars.iv.next1078, %polly.loop_exit642 ], [ %266, %polly.loop_header592 ]
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit642 ], [ %265, %polly.loop_header592 ]
  ...
  %302 = add i64 %smax1074, %indvars.iv1077
  %303 = mul nuw nsw i64 %polly.indvar602, 3
  %.not.not886 = icmp ugt i64 %303, %polly.indvar595
  %304 = mul nuw nsw i64 %polly.indvar602, 96
...
polly.loop_exit628.us:                            ; preds = %polly.loop_header626.us, %polly.loop_header605.us
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next609.us, %261
...
polly.loop_exit642:                               ; preds = %polly.loop_exit649, %polly.loop_header640.preheader
  ...
  %indvars.iv.next1078 = add i64 %indvars.iv1077, 96
...
polly.loop_exit628:                               ; preds = %polly.loop_header626
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next609, %261
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %317 = mul nsw i64 %polly.indvar602, -96
...
polly.loop_exit649:                               ; preds = %polly.loop_exit657
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next644, %261
  br i1 %exitcond1084.not, label %polly.loop_exit642, label %polly.loop_header640

polly.loop_header647:                             ; preds = %polly.loop_header640, %polly.loop_exit657
  %indvars.iv1079 = phi i64 [ %302, %polly.loop_header640 ], [ %indvars.iv.next1080, %polly.loop_exit657 ]
  %polly.indvar651 = phi i64 [ %316, %polly.loop_header640 ], [ %polly.indvar_next652, %polly.loop_exit657 ]
  %smin1081 = call i64 @llvm.smin.i64(i64 %indvars.iv1079, i64 31)
...
polly.loop_header655:                             ; preds = %polly.loop_header655.preheader, %polly.loop_header655
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar659, %smin1081
  br i1 %exitcond1082.not, label %polly.loop_exit657, label %polly.loop_header655
...
vector.body1158:                                  ; preds = %vector.body1158, %vector.ph1159
  ...
  br i1 %355, label %polly.loop_exit825, label %vector.body1158, !llvm.loop !104
...
vector.body1172:                                  ; preds = %vector.body1172, %vector.ph1175
  ...
  br i1 %384, label %polly.loop_exit852, label %vector.body1172, !llvm.loop !107
...
vector.body1190:                                  ; preds = %vector.body1190, %vector.ph1193
  ...
  br i1 %413, label %polly.loop_exit878, label %vector.body1190, !llvm.loop !110
