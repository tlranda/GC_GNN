; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7631.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7631.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar_next225, 250
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249926 = icmp sgt i64 %116, -1
...
vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1039
  ...
  %129 = shl nuw nsw i64 %index1042, 3
  %130 = getelementptr i8, i8* %scevgep370, i64 %129
  %131 = bitcast i8* %130 to <4 x double>*
  %wide.load1046 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !74, !noalias !76
  %132 = fmul fast <4 x double> %wide.load1046, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %134 = icmp eq i64 %index.next1043, %n.vec1041
  br i1 %134, label %middle.block1033, label %vector.body1035, !llvm.loop !80

middle.block1033:                                 ; preds = %vector.body1035
  %cmp.n1045 = icmp eq i64 %127, %n.vec1041
...
polly.loop_exit404:                               ; preds = %polly.loop_exit411
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next400, 250
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %149 = mul nuw nsw i64 %polly.indvar405, 100
...
polly.loop_header409.preheader:                   ; preds = %polly.loop_header402
  ...
  %153 = add i64 %smax855, %indvars.iv858
...
polly.loop_header409:                             ; preds = %polly.loop_header409.preheader, %polly.loop_exit418
  %indvars.iv860 = phi i64 [ %153, %polly.loop_header409.preheader ], [ %indvars.iv.next861, %polly.loop_exit418 ]
  ...
  %polly.loop_guard426927 = icmp sgt i64 %155, -1
...
polly.loop_header535:                             ; preds = %polly.loop_exit543, %polly.start449
  ...
  %min.iters.check1012 = icmp ult i64 %166, 4
...
vector.body1011:                                  ; preds = %vector.body1011, %vector.ph1013
  ...
  %168 = shl nuw nsw i64 %index1016, 3
  %169 = getelementptr i8, i8* %scevgep547, i64 %168
  %170 = bitcast i8* %169 to <4 x double>*
  %wide.load1020 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !84, !noalias !86
  %171 = fmul fast <4 x double> %wide.load1020, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %173 = icmp eq i64 %index.next1017, %n.vec1015
  br i1 %173, label %middle.block1009, label %vector.body1011, !llvm.loop !90

middle.block1009:                                 ; preds = %vector.body1011
  %cmp.n1019 = icmp eq i64 %166, %n.vec1015
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar_next577, 250
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %188 = mul nuw nsw i64 %polly.indvar582, 100
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header579
  ...
  %192 = add i64 %smax877, %indvars.iv880
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit595
  %indvars.iv882 = phi i64 [ %192, %polly.loop_header586.preheader ], [ %indvars.iv.next883, %polly.loop_exit595 ]
  ...
  %polly.loop_guard603928 = icmp sgt i64 %194, -1
...
polly.loop_header756:                             ; preds = %polly.loop_exit764, %polly.loop_header750
  ...
  %smin950 = call i64 @llvm.smin.i64(i64 %207, i64 -1168)
  %208 = add nsw i64 %smin950, 1200
  %smin917 = call i64 @llvm.smin.i64(i64 %indvars.iv915, i64 -1168)
  %209 = shl nsw i64 %polly.indvar759, 5
  %210 = add nsw i64 %smin917, 1199
...
vector.ph951:                                     ; preds = %polly.loop_header762
  %broadcast.splatinsert958 = insertelement <4 x i64> poison, i64 %209, i32 0
  %broadcast.splat959 = shufflevector <4 x i64> %broadcast.splatinsert958, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert960 = insertelement <4 x i32> poison, i32 %212, i32 0
...
vector.body949:                                   ; preds = %vector.body949, %vector.ph951
  ...
  %214 = add nuw nsw <4 x i64> %vec.ind956, %broadcast.splat959
  %215 = trunc <4 x i64> %214 to <4 x i32>
  %216 = mul <4 x i32> %broadcast.splat961, %215
  ...
  %226 = icmp eq i64 %index.next953, %208
  br i1 %226, label %polly.loop_exit770, label %vector.body949, !llvm.loop !99

polly.loop_exit770:                               ; preds = %vector.body949, %polly.loop_header768
  %polly.indvar_next766 = add nuw nsw i64 %polly.indvar765, 1
  %exitcond922.not = icmp eq i64 %polly.indvar765, %206
...
polly.loop_header768:                             ; preds = %polly.loop_header762, %polly.loop_header768
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar771, %210
...
polly.loop_header783:                             ; preds = %polly.loop_exit791, %polly.loop_header777
  ...
  %smin965 = call i64 @llvm.smin.i64(i64 %236, i64 -968)
  %237 = add nsw i64 %smin965, 1000
  %smin907 = call i64 @llvm.smin.i64(i64 %indvars.iv905, i64 -968)
  %238 = shl nsw i64 %polly.indvar786, 5
  %239 = add nsw i64 %smin907, 999
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph967
  ...
  %243 = add nuw nsw <4 x i64> %vec.ind974, %broadcast.splat977
  %244 = trunc <4 x i64> %243 to <4 x i32>
  %245 = mul <4 x i32> %broadcast.splat979, %244
  ...
  %255 = icmp eq i64 %index.next971, %237
  br i1 %255, label %polly.loop_exit797, label %vector.body964, !llvm.loop !102

polly.loop_exit797:                               ; preds = %vector.body964, %polly.loop_header795
  %polly.indvar_next793 = add nuw nsw i64 %polly.indvar792, 1
  %exitcond912.not = icmp eq i64 %polly.indvar792, %235
...
polly.loop_header795:                             ; preds = %polly.loop_header789, %polly.loop_header795
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar798, %239
...
polly.loop_header809:                             ; preds = %polly.loop_exit817, %polly.loop_header803
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %265, i64 -968)
  %266 = add nsw i64 %smin983, 1000
  %smin897 = call i64 @llvm.smin.i64(i64 %indvars.iv895, i64 -968)
  %267 = shl nsw i64 %polly.indvar812, 5
  %268 = add nsw i64 %smin897, 999
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph985
  ...
  %272 = add nuw nsw <4 x i64> %vec.ind992, %broadcast.splat995
  %273 = trunc <4 x i64> %272 to <4 x i32>
  %274 = mul <4 x i32> %broadcast.splat997, %273
  ...
  %284 = icmp eq i64 %index.next989, %266
  br i1 %284, label %polly.loop_exit823, label %vector.body982, !llvm.loop !105

polly.loop_exit823:                               ; preds = %vector.body982, %polly.loop_header821
  %polly.indvar_next819 = add nuw nsw i64 %polly.indvar818, 1
  %exitcond902.not = icmp eq i64 %polly.indvar818, %264
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  %exitcond898.not = icmp eq i64 %polly.indvar824, %268
...
polly.loop_header423.us.3:                        ; preds = %polly.loop_header423.us.3, %polly.loop_exit425.loopexit.us.2
  ...
  br i1 %exitcond863.3.not, label %polly.loop_exit418, label %polly.loop_header423.us.3
...
polly.loop_header600.us.3:                        ; preds = %polly.loop_header600.us.3, %polly.loop_exit602.loopexit.us.2
  ...
  br i1 %exitcond885.3.not, label %polly.loop_exit595, label %polly.loop_header600.us.3
}
