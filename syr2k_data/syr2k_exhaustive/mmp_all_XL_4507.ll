; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4507.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4507.c"
...
vector.body1212:                                  ; preds = %vector.body1212, %vector.ph1216
  ...
  %wide.load1223 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %134, label %middle.block1210, label %vector.body1212, !llvm.loop !80
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %136 = udiv i64 %indvars.iv1025, 25
  %umin1027 = call i64 @llvm.umin.i64(i64 %136, i64 11)
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %144 = mul nuw nsw i64 %polly.indvar399, 100
...
vector.body1188:                                  ; preds = %vector.body1188, %vector.ph1190
  ...
  %wide.load1197 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %173, label %middle.block1186, label %vector.body1188, !llvm.loop !90
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  %indvars.iv1056 = phi i64 [ 7, %polly.loop_header574.preheader ], [ %indvars.iv.next1057, %polly.loop_exit582 ]
  ...
  %175 = udiv i64 %indvars.iv1056, 25
  %umin1058 = call i64 @llvm.umin.i64(i64 %175, i64 11)
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %183 = mul nuw nsw i64 %polly.indvar590, 100
...
vector.body1127:                                  ; preds = %vector.body1127, %vector.ph1128
  ...
  br i1 %226, label %polly.loop_exit807, label %vector.body1127, !llvm.loop !99
...
vector.body1141:                                  ; preds = %vector.body1141, %vector.ph1144
  ...
  br i1 %255, label %polly.loop_exit834, label %vector.body1141, !llvm.loop !102
...
vector.body1159:                                  ; preds = %vector.body1159, %vector.ph1162
  ...
  br i1 %284, label %polly.loop_exit860, label %vector.body1159, !llvm.loop !105
