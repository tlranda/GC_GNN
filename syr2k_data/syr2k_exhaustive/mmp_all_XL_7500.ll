; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7500.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7500.c"
...
polly.loop_header384:                             ; preds = %polly.loop_exit376, %polly.loop_exit393
  ...
  %121 = shl nsw i64 %polly.indvar387, 6
...
polly.loop_exit393:                               ; preds = %polly.loop_exit399
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next388, 19
...
polly.loop_header391:                             ; preds = %polly.loop_exit399, %polly.loop_header384
  ...
  %123 = shl nsw i64 %polly.indvar394, 7
...
polly.loop_header556:                             ; preds = %polly.loop_exit548, %polly.loop_exit565
  ...
  %144 = shl nsw i64 %polly.indvar559, 6
...
polly.loop_exit565:                               ; preds = %polly.loop_exit571
  ...
  %indvars.iv.next854 = add nuw nsw i64 %indvars.iv853, 64
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -64
  %exitcond867.not = icmp eq i64 %polly.indvar_next560, 19
...
polly.loop_header563:                             ; preds = %polly.loop_exit571, %polly.loop_header556
  ...
  %146 = shl nsw i64 %polly.indvar566, 7
