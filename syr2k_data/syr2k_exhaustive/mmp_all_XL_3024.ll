; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3024.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3024.c"
...
polly.loop_header248:                             ; preds = %polly.loop_exit256, %polly.loop_header242
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv882, i64 255)
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %126 = shl nuw nsw i64 %polly.indvar386, 4
  %127 = mul nsw i64 %polly.indvar386, -256
  %128 = shl nsw i64 %polly.indvar386, 8
...
polly.loop_header389:                             ; preds = %polly.loop_exit430, %polly.loop_header383
  ...
  %.inv857 = icmp ugt i64 %130, 255
  %132 = select i1 %.inv857, i64 255, i64 %131
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %155 = shl nuw nsw i64 %polly.indvar572, 4
  %156 = mul nsw i64 %polly.indvar572, -256
  %157 = shl nsw i64 %polly.indvar572, 8
...
polly.loop_header575:                             ; preds = %polly.loop_exit616, %polly.loop_header569
  ...
  %.inv858 = icmp ugt i64 %159, 255
  %161 = select i1 %.inv858, i64 255, i64 %160
