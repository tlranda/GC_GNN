; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5505.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5505.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %110 = shl nsw i64 %polly.indvar230, 3
  %111 = sub nsw i64 %103, %110
  %112 = icmp sgt i64 %111, 0
  %113 = select i1 %112, i64 %111, i64 0
  %polly.loop_guard = icmp slt i64 %113, 8
...
polly.loop_exit388:                               ; preds = %polly.loop_exit394
  ...
  %143 = mul nuw nsw i64 %polly.indvar383, 6
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  ...
  %148 = shl nsw i64 %polly.indvar406, 3
  %149 = sub nsw i64 %141, %148
  %150 = icmp sgt i64 %149, 0
  %151 = select i1 %150, i64 %149, i64 0
  %polly.loop_guard419 = icmp slt i64 %151, 8
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %174 = lshr i64 %polly.indvar561, 2
...
polly.loop_exit566:                               ; preds = %polly.loop_exit572
  ...
  %181 = mul nuw nsw i64 %polly.indvar561, 6
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  ...
  %186 = shl nsw i64 %polly.indvar584, 3
  %187 = sub nsw i64 %179, %186
  %188 = icmp sgt i64 %187, 0
  %189 = select i1 %188, i64 %187, i64 0
  %polly.loop_guard597 = icmp slt i64 %189, 8
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header581
  ...
  %indvars.iv.next905 = add i64 %indvars.iv904, -8
  %indvars.iv.next910 = add i64 %indvars.iv909, 8
