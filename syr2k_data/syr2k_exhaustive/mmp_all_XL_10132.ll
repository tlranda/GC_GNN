; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10132.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10132.c"
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph998
  ...
  %wide.load1005 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %131, label %middle.block992, label %vector.body994, !llvm.loop !74
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph972
  ...
  %wide.load979 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %167, label %middle.block968, label %vector.body970, !llvm.loop !83
...
vector.body908:                                   ; preds = %vector.body908, %vector.ph910
  ...
  br i1 %217, label %polly.loop_exit714, label %vector.body908, !llvm.loop !92
...
vector.body923:                                   ; preds = %vector.body923, %vector.ph926
  ...
  br i1 %246, label %polly.loop_exit741, label %vector.body923, !llvm.loop !95
...
vector.body941:                                   ; preds = %vector.body941, %vector.ph944
  ...
  br i1 %275, label %polly.loop_exit767, label %vector.body941, !llvm.loop !98
