; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6045.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6045.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit223
  ...
  %102 = shl nsw i64 %polly.indvar202, 6
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %105 = add nuw nsw i64 %pexp.p_div_q, %polly.indvar202
  br label %polly.loop_header221

polly.loop_exit223:                               ; preds = %polly.loop_exit229
  %polly.indvar_next203 = add nuw nsw i64 %polly.indvar202, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -64
  %indvars.iv.next837 = add nuw nsw i64 %indvars.iv836, 64
  %indvars.iv.next839 = add nuw nsw i64 %indvars.iv838, 7
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -64
  %exitcond850.not = icmp eq i64 %polly.indvar_next203, 19
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %108 = mul nuw nsw i64 %polly.indvar224, 50
...
polly.loop_header233.us:                          ; preds = %polly.loop_exit242.us, %polly.loop_header227.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 63)
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %130 = udiv i64 %indvars.iv859, 25
  %131 = add nuw i64 %polly.indvar373, %130
  %132 = mul nuw nsw i64 %131, 50
  %133 = sub i64 %indvars.iv857, %132
  %134 = add i64 %indvars.iv864, %132
  %135 = shl nsw i64 %polly.indvar373, 6
  br label %polly.loop_header376

polly.loop_exit378:                               ; preds = %polly.loop_exit384
  %136 = mul nsw i64 %polly.indvar373, -64
  %137 = mul nuw nsw i64 %polly.indvar373, 7
  %pexp.p_div_q392 = udiv i64 %137, 25
  %138 = add nuw nsw i64 %pexp.p_div_q392, %polly.indvar373
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next858 = add nuw nsw i64 %indvars.iv857, 64
  %indvars.iv.next860 = add nuw nsw i64 %indvars.iv859, 7
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, -64
  %exitcond873.not = icmp eq i64 %polly.indvar_next374, 19
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  ...
  %141 = mul nuw nsw i64 %polly.indvar396, 50
  %142 = sub nsw i64 %135, %141
  %143 = icmp sgt i64 %142, 0
  %144 = select i1 %143, i64 %142, i64 0
  %polly.loop_guard409 = icmp slt i64 %144, 50
...
polly.loop_header406.us:                          ; preds = %polly.loop_exit416.us, %polly.loop_header399.us
  ...
  %smin870 = call i64 @llvm.smin.i64(i64 %indvars.iv868, i64 63)
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %163 = udiv i64 %indvars.iv882, 25
  %164 = add nuw i64 %polly.indvar547, %163
  %165 = mul nuw nsw i64 %164, 50
  %166 = sub i64 %indvars.iv880, %165
  %167 = add i64 %indvars.iv887, %165
  %168 = shl nsw i64 %polly.indvar547, 6
  br label %polly.loop_header550

polly.loop_exit552:                               ; preds = %polly.loop_exit558
  %169 = mul nsw i64 %polly.indvar547, -64
  %170 = mul nuw nsw i64 %polly.indvar547, 7
  %pexp.p_div_q566 = udiv i64 %170, 25
  %171 = add nuw nsw i64 %pexp.p_div_q566, %polly.indvar547
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %indvars.iv.next881 = add nuw nsw i64 %indvars.iv880, 64
  %indvars.iv.next883 = add nuw nsw i64 %indvars.iv882, 7
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, -64
  %exitcond896.not = icmp eq i64 %polly.indvar_next548, 19
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  ...
  %174 = mul nuw nsw i64 %polly.indvar570, 50
  %175 = sub nsw i64 %168, %174
  %176 = icmp sgt i64 %175, 0
  %177 = select i1 %176, i64 %175, i64 0
  %polly.loop_guard583 = icmp slt i64 %177, 50
