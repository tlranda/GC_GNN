; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6715.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6715.c"
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %128 = udiv i64 %indvars.iv869, 25
  %129 = mul nsw i64 %polly.indvar393, -4
  %130 = shl nsw i64 %polly.indvar393, 2
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %132 = mul nuw nsw i64 %polly.indvar406, 50
  %133 = add nsw i64 %132, %129
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard413 = icmp slt i64 %135, 4
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %159 = udiv i64 %indvars.iv892, 25
  %160 = mul nsw i64 %polly.indvar571, -4
  %161 = shl nsw i64 %polly.indvar571, 2
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %163 = mul nuw nsw i64 %polly.indvar584, 50
  %164 = add nsw i64 %163, %160
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard591 = icmp slt i64 %166, 4
