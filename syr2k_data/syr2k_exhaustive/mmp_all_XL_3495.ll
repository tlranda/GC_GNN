; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3495.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3495.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1031.not = icmp eq i64 %polly.indvar_next203, 8
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %smin1056 = call i64 @llvm.smin.i64(i64 %indvars.iv1034, i64 -872)
  %153 = add nsw i64 %smin1056, 1000
  %154 = shl nsw i64 %polly.indvar396, 7
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409
  ...
  %exitcond1059.not = icmp eq i64 %polly.indvar_next397, 8
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %smin1084 = call i64 @llvm.smin.i64(i64 %indvars.iv1062, i64 -872)
  %209 = add nsw i64 %smin1084, 1000
  %210 = shl nsw i64 %polly.indvar593, 7
...
polly.loop_exit598:                               ; preds = %polly.loop_exit606
  ...
  %exitcond1087.not = icmp eq i64 %polly.indvar_next594, 8
