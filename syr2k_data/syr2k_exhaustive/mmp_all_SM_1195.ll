; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1195.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1195.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %99 = mul nsw i64 %polly.indvar209, -20
...
polly.loop_exit230:                               ; preds = %polly.loop_exit282, %polly.loop_exit214
  ...
  %indvars.iv.next1184 = add nuw nsw i64 %indvars.iv1183, 20
  %indvars.iv.next1186 = add nuw nsw i64 %indvars.iv1185, 1
  %indvars.iv.next1193 = add nsw i64 %indvars.iv1192, -20
  %indvars.iv.next1198 = add nuw nsw i64 %indvars.iv1197, 20
  %exitcond1207.not = icmp eq i64 %polly.indvar_next210, 15
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit282
  ...
  %119 = mul nsw i64 %indvar1541, -100
  %120 = add i64 %103, %119
  %smax1543 = call i64 @llvm.smax.i64(i64 %120, i64 0)
  %121 = mul nuw nsw i64 %indvar1541, 100
  %122 = add i64 %105, %121
  ...
  %128 = icmp sgt i64 %127, 80
  %129 = select i1 %128, i64 %127, i64 80
  %130 = add nsw i64 %127, 99
  %polly.loop_guard269 = icmp sgt i64 %127, -100
...
polly.loop_header240.us1025:                      ; preds = %polly.loop_header234.us1023, %polly.loop_header240.us1025
  ...
  %exitcond1180.not = icmp eq i64 %polly.indvar_next244.us1033, 80
...
polly.loop_header280.preheader:                   ; preds = %polly.merge, %polly.merge.us1059, %polly.merge.us
  ...
  %polly.loop_guard290 = icmp slt i64 %138, 100
...
polly.loop_header287.us:                          ; preds = %polly.loop_header280.us, %polly.loop_exit297.us
  ...
  %smin1546 = call i64 @llvm.smin.i64(i64 %139, i64 79)
  %140 = add nsw i64 %smin1546, 1
  %smin1203 = call i64 @llvm.smin.i64(i64 %indvars.iv1201, i64 79)
...
polly.loop_header240:                             ; preds = %polly.loop_header234, %polly.loop_header240
  ...
  %exitcond1177.not = icmp eq i64 %polly.indvar_next244, 80
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit435
  ...
  %176 = shl nsw i64 %polly.indvar430, 7
...
polly.loop_header433:                             ; preds = %polly.loop_exit459, %polly.loop_header427
  ...
  %177 = mul nsw i64 %polly.indvar436, -20
  %178 = add nuw i64 %polly.indvar436, 4
  %179 = udiv i64 %178, 5
  %180 = mul nuw nsw i64 %179, 100
  %181 = add i64 %177, %180
  %182 = mul nuw nsw i64 %polly.indvar436, 20
...
polly.loop_exit459:                               ; preds = %polly.loop_exit516, %polly.loop_exit441
  ...
  %indvars.iv.next1212 = add nsw i64 %indvars.iv1211, -80
  %indvars.iv.next1225 = add nuw nsw i64 %indvars.iv1224, 20
  %indvars.iv.next1227 = add nuw nsw i64 %indvars.iv1226, 1
  %indvars.iv.next1235 = add nsw i64 %indvars.iv1234, -20
  %indvars.iv.next1240 = add nuw nsw i64 %indvars.iv1239, 20
  %exitcond1249.not = icmp eq i64 %polly.indvar_next437, 15
...
polly.loop_header457:                             ; preds = %polly.loop_header457.preheader, %polly.loop_exit516
  ...
  %197 = mul nsw i64 %indvar1491, -100
  %198 = add i64 %181, %197
  %smax1493 = call i64 @llvm.smax.i64(i64 %198, i64 0)
  %199 = mul nuw nsw i64 %indvar1491, 100
  %200 = add i64 %183, %199
  ...
  %204 = mul nsw i64 %polly.indvar461, 100
  %205 = add nsw i64 %204, %190
  %206 = icmp sgt i64 %205, 80
  %207 = select i1 %206, i64 %205, i64 80
  %208 = add nsw i64 %205, 99
  %polly.loop_guard503 = icmp sgt i64 %205, -100
...
polly.loop_header474.us1071:                      ; preds = %polly.loop_header464.us1069, %polly.loop_header474.us1071
  ...
  %exitcond1221.not = icmp eq i64 %polly.indvar_next478.us1079, 80
...
polly.loop_header514.preheader:                   ; preds = %polly.merge471, %polly.merge471.us1105, %polly.merge471.us
  ...
  %polly.loop_guard524 = icmp slt i64 %216, 100
...
polly.loop_header521.us:                          ; preds = %polly.loop_header514.us, %polly.loop_exit531.us
  ...
  %smin1496 = call i64 @llvm.smin.i64(i64 %217, i64 79)
  %218 = add nsw i64 %smin1496, 1
  %smin1245 = call i64 @llvm.smin.i64(i64 %indvars.iv1243, i64 79)
...
polly.loop_header474:                             ; preds = %polly.loop_header464, %polly.loop_header474
  ...
  %exitcond1218.not = icmp eq i64 %polly.indvar_next478, 80
...
polly.loop_header661:                             ; preds = %polly.loop_header661.preheader, %polly.loop_exit669
  ...
  %254 = shl nsw i64 %polly.indvar664, 7
...
polly.loop_header667:                             ; preds = %polly.loop_exit693, %polly.loop_header661
  ...
  %255 = mul nsw i64 %polly.indvar670, -20
  %256 = add nuw i64 %polly.indvar670, 4
  %257 = udiv i64 %256, 5
  %258 = mul nuw nsw i64 %257, 100
  %259 = add i64 %255, %258
  %260 = mul nuw nsw i64 %polly.indvar670, 20
...
polly.loop_exit693:                               ; preds = %polly.loop_exit750, %polly.loop_exit675
  ...
  %indvars.iv.next1254 = add nsw i64 %indvars.iv1253, -80
  %indvars.iv.next1267 = add nuw nsw i64 %indvars.iv1266, 20
  %indvars.iv.next1269 = add nuw nsw i64 %indvars.iv1268, 1
  %indvars.iv.next1277 = add nsw i64 %indvars.iv1276, -20
  %indvars.iv.next1282 = add nuw nsw i64 %indvars.iv1281, 20
  %exitcond1291.not = icmp eq i64 %polly.indvar_next671, 15
...
polly.loop_header691:                             ; preds = %polly.loop_header691.preheader, %polly.loop_exit750
  ...
  %275 = mul nsw i64 %indvar1441, -100
  %276 = add i64 %259, %275
  %smax1443 = call i64 @llvm.smax.i64(i64 %276, i64 0)
  %277 = mul nuw nsw i64 %indvar1441, 100
  %278 = add i64 %261, %277
  ...
  %282 = mul nsw i64 %polly.indvar695, 100
  %283 = add nsw i64 %282, %268
  %284 = icmp sgt i64 %283, 80
  %285 = select i1 %284, i64 %283, i64 80
  %286 = add nsw i64 %283, 99
  %polly.loop_guard737 = icmp sgt i64 %283, -100
...
polly.loop_header708.us1117:                      ; preds = %polly.loop_header698.us1115, %polly.loop_header708.us1117
  ...
  %exitcond1263.not = icmp eq i64 %polly.indvar_next712.us1125, 80
...
polly.loop_header748.preheader:                   ; preds = %polly.merge705, %polly.merge705.us1151, %polly.merge705.us
  ...
  %polly.loop_guard758 = icmp slt i64 %294, 100
...
polly.loop_header755.us:                          ; preds = %polly.loop_header748.us, %polly.loop_exit765.us
  ...
  %smin1446 = call i64 @llvm.smin.i64(i64 %295, i64 79)
  %296 = add nsw i64 %smin1446, 1
  %smin1287 = call i64 @llvm.smin.i64(i64 %indvars.iv1285, i64 79)
...
polly.loop_header708:                             ; preds = %polly.loop_header698, %polly.loop_header708
  ...
  %exitcond1260.not = icmp eq i64 %polly.indvar_next712, 80
