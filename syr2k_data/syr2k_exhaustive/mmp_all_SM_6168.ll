; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6168.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6168.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit223
  ...
  %97 = shl nuw nsw i64 %indvars.iv844, 2
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  %102 = mul nsw i64 %polly.indvar202, -100
  ...
  %polly.loop_guard = icmp slt i64 %106, 19
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -28
  %indvars.iv.next845 = add nuw nsw i64 %indvars.iv844, 7
  %indvars.iv.next849 = add nuw nsw i64 %indvars.iv848, 28
  %exitcond856.not = icmp eq i64 %polly.indvar_next203, 12
...
polly.loop_header221:                             ; preds = %polly.loop_exit207, %polly.loop_exit229
  ...
  %109 = shl nsw i64 %polly.indvar224, 6
  %110 = sub nsw i64 %101, %109
  %111 = icmp sgt i64 %110, 0
  %112 = select i1 %111, i64 %110, i64 0
  %113 = mul nsw i64 %polly.indvar224, -64
...
polly.loop_header234:                             ; preds = %polly.loop_exit244, %polly.loop_header227
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 99)
...
polly.loop_exit380:                               ; preds = %polly.loop_exit386
  ...
  %polly.loop_guard399 = icmp slt i64 %144, 19
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405, %polly.loop_exit380
  ...
  %indvars.iv.next860 = add nsw i64 %indvars.iv859, -100
  %indvars.iv.next864 = add nsw i64 %indvars.iv863, -28
  %indvars.iv.next866 = add nuw nsw i64 %indvars.iv865, 7
  %indvars.iv.next871 = add nuw nsw i64 %indvars.iv870, 28
  %exitcond879.not = icmp eq i64 %polly.indvar_next376, 12
...
polly.loop_header396:                             ; preds = %polly.loop_exit380, %polly.loop_exit405
  ...
  %147 = shl nsw i64 %polly.indvar400, 6
  %148 = sub nsw i64 %139, %147
  %149 = icmp sgt i64 %148, 0
  %150 = select i1 %149, i64 %148, i64 0
  %151 = mul nsw i64 %polly.indvar400, -64
...
polly.loop_header548:                             ; preds = %polly.loop_header548.preheader, %polly.loop_exit574
  ...
  %173 = shl nuw nsw i64 %indvars.iv888, 2
  %174 = and i64 %173, 9223372036854775744
  %175 = add i64 %indvars.iv886, %174
  %176 = sub nsw i64 %indvars.iv893, %174
  %177 = mul nuw nsw i64 %polly.indvar551, 100
  br label %polly.loop_header554

polly.loop_exit556:                               ; preds = %polly.loop_exit562
  %178 = mul nsw i64 %polly.indvar551, -100
  ...
  %polly.loop_guard575 = icmp slt i64 %182, 19
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_exit556
  ...
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, -28
  %indvars.iv.next889 = add nuw nsw i64 %indvars.iv888, 7
  %indvars.iv.next894 = add nuw nsw i64 %indvars.iv893, 28
  %exitcond902.not = icmp eq i64 %polly.indvar_next552, 12
...
polly.loop_header572:                             ; preds = %polly.loop_exit556, %polly.loop_exit581
  ...
  %185 = shl nsw i64 %polly.indvar576, 6
  %186 = sub nsw i64 %177, %185
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %189 = mul nsw i64 %polly.indvar576, -64
...
polly.loop_header586:                             ; preds = %polly.loop_exit596, %polly.loop_header579
  ...
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 99)
