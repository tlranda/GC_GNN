; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5686.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5686.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next203, 5
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %indvars.iv.next822 = add nuw nsw i64 %indvars.iv821, 16
  %exitcond828.not = icmp eq i64 %polly.indvar_next225, 75
...
polly.loop_header233:                             ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv823, i64 255)
...
polly.loop_exit241:                               ; preds = %polly.loop_header239
  ...
  %exitcond826.not = icmp eq i64 %polly.indvar_next237, 16
...
polly.loop_header368:                             ; preds = %polly.loop_header368.preheader, %polly.loop_exit392
  ...
  %120 = shl nsw i64 %polly.indvar371, 8
  br label %polly.loop_header374

polly.loop_exit376:                               ; preds = %polly.loop_exit382
  %121 = mul nsw i64 %polly.indvar371, -256
  %122 = shl nsw i64 %polly.indvar371, 4
  br label %polly.loop_header390

polly.loop_exit392:                               ; preds = %polly.loop_exit398
  %polly.indvar_next372 = add nuw nsw i64 %polly.indvar371, 1
  %indvars.iv.next833 = add nsw i64 %indvars.iv832, -256
  %exitcond845.not = icmp eq i64 %polly.indvar_next372, 5
...
polly.loop_exit410:                               ; preds = %polly.loop_header408
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next406, 16
...
polly.loop_header537:                             ; preds = %polly.loop_header537.preheader, %polly.loop_exit561
  ...
  %143 = shl nsw i64 %polly.indvar540, 8
  br label %polly.loop_header543

polly.loop_exit545:                               ; preds = %polly.loop_exit551
  %144 = mul nsw i64 %polly.indvar540, -256
  %145 = shl nsw i64 %polly.indvar540, 4
...
polly.loop_exit561:                               ; preds = %polly.loop_exit567
  ...
  %indvars.iv.next849 = add nsw i64 %indvars.iv848, -256
  %exitcond861.not = icmp eq i64 %polly.indvar_next541, 5
...
polly.loop_header559:                             ; preds = %polly.loop_exit567, %polly.loop_exit545
  ...
  %147 = shl nsw i64 %polly.indvar562, 4
...
polly.loop_exit567:                               ; preds = %polly.loop_exit573
  ...
  %indvars.iv.next853 = add nuw nsw i64 %indvars.iv852, 16
  %exitcond860.not = icmp eq i64 %polly.indvar_next563, 75
...
polly.loop_exit579:                               ; preds = %polly.loop_header577
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar_next575, 16
