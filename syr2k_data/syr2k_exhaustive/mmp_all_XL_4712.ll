; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4712.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4712.c"
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit246
  ...
  %polly.loop_guard2291063 = icmp sgt i64 %110, -1
...
vector.body1177:                                  ; preds = %vector.body1177, %vector.ph1181
  ...
  %122 = shl nuw nsw i64 %index1184, 3
  %123 = getelementptr i8, i8* %scevgep377, i64 %122
  %124 = bitcast i8* %123 to <4 x double>*
  %wide.load1188 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !74, !noalias !76
  %125 = fmul fast <4 x double> %wide.load1188, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %127 = icmp eq i64 %index.next1185, %n.vec1183
  br i1 %127, label %middle.block1175, label %vector.body1177, !llvm.loop !80

middle.block1175:                                 ; preds = %vector.body1177
  %cmp.n1187 = icmp eq i64 %120, %n.vec1183
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit391
  ...
  %129 = shl nuw nsw i64 %polly.indvar384, 1
  %130 = mul nuw nsw i64 %polly.indvar384, 7
  %131 = add nuw nsw i64 %130, 7
  %pexp.p_div_q387 = lshr i64 %131, 4
  %132 = sub nsw i64 %129, %pexp.p_div_q387
  %polly.loop_guard392 = icmp sgt i64 %132, -2
...
polly.loop_header389.preheader:                   ; preds = %polly.loop_header381
  %133 = mul nsw i64 %polly.indvar384, -50
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit399
  ...
  %135 = shl nsw i64 %polly.indvar393, 5
  %136 = add nsw i64 %135, %133
  %137 = icmp sgt i64 %136, 0
  %138 = select i1 %137, i64 %136, i64 0
  %polly.loop_guard400 = icmp slt i64 %138, 50
...
polly.loop_header397.preheader:                   ; preds = %polly.loop_header389
  ...
  %139 = add i64 %smax992, %indvars.iv995
...
polly.loop_exit399:                               ; preds = %polly.loop_exit435, %polly.loop_header389
  ...
  %polly.loop_cond395.not = icmp sgt i64 %polly.indvar393, %132
...
polly.loop_header397:                             ; preds = %polly.loop_header397.preheader, %polly.loop_exit435
  %indvars.iv997 = phi i64 [ %139, %polly.loop_header397.preheader ], [ %indvars.iv.next998, %polly.loop_exit435 ]
  ...
  %polly.loop_guard4141064 = icmp sgt i64 %142, -1
...
polly.loop_header554:                             ; preds = %polly.loop_exit562, %polly.start468
  ...
  %min.iters.check1154 = icmp ult i64 %152, 4
...
vector.body1153:                                  ; preds = %vector.body1153, %vector.ph1155
  ...
  %154 = shl nuw nsw i64 %index1158, 3
  %155 = getelementptr i8, i8* %scevgep566, i64 %154
  %156 = bitcast i8* %155 to <4 x double>*
  %wide.load1162 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !84, !noalias !86
  %157 = fmul fast <4 x double> %wide.load1162, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %159 = icmp eq i64 %index.next1159, %n.vec1157
  br i1 %159, label %middle.block1151, label %vector.body1153, !llvm.loop !90

middle.block1151:                                 ; preds = %vector.body1153
  %cmp.n1161 = icmp eq i64 %152, %n.vec1157
...
polly.loop_header570:                             ; preds = %polly.loop_header570.preheader, %polly.loop_exit580
  ...
  %161 = shl nuw nsw i64 %polly.indvar573, 1
  %162 = mul nuw nsw i64 %polly.indvar573, 7
  %163 = add nuw nsw i64 %162, 7
  %pexp.p_div_q576 = lshr i64 %163, 4
  %164 = sub nsw i64 %161, %pexp.p_div_q576
  %polly.loop_guard581 = icmp sgt i64 %164, -2
...
polly.loop_header578.preheader:                   ; preds = %polly.loop_header570
  %165 = mul nsw i64 %polly.indvar573, -50
  %166 = mul nuw nsw i64 %polly.indvar573, 50
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit588
  ...
  %167 = shl nsw i64 %polly.indvar582, 5
  %168 = add nsw i64 %167, %165
  %169 = icmp sgt i64 %168, 0
  %170 = select i1 %169, i64 %168, i64 0
  %polly.loop_guard589 = icmp slt i64 %170, 50
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  ...
  %171 = add i64 %smax1013, %indvars.iv1016
...
polly.loop_exit588:                               ; preds = %polly.loop_exit624, %polly.loop_header578
  ...
  %polly.loop_cond584.not = icmp sgt i64 %polly.indvar582, %164
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit624
  %indvars.iv1018 = phi i64 [ %171, %polly.loop_header586.preheader ], [ %indvars.iv.next1019, %polly.loop_exit624 ]
  ...
  %polly.loop_guard6031065 = icmp sgt i64 %174, -1
...
vector.ph1093:                                    ; preds = %polly.loop_header793
  %broadcast.splatinsert1100 = insertelement <4 x i64> poison, i64 %188, i32 0
  %broadcast.splat1101 = shufflevector <4 x i64> %broadcast.splatinsert1100, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1102 = insertelement <4 x i32> poison, i32 %191, i32 0
...
vector.body1092:                                  ; preds = %vector.body1092, %vector.ph1093
  ...
  %193 = add nuw nsw <4 x i64> %vec.ind1098, %broadcast.splat1101
  %194 = trunc <4 x i64> %193 to <4 x i32>
  %195 = mul <4 x i32> %broadcast.splat1103, %194
  ...
  %205 = icmp eq i64 %index.next1095, %187
  br i1 %205, label %polly.loop_exit801, label %vector.body1092, !llvm.loop !99

polly.loop_exit801:                               ; preds = %vector.body1092, %polly.loop_header799
  %polly.indvar_next797 = add nuw nsw i64 %polly.indvar796, 1
  %exitcond1056.not = icmp eq i64 %polly.indvar796, %185
...
polly.loop_header799:                             ; preds = %polly.loop_header793, %polly.loop_header799
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar802, %189
...
polly.loop_header814:                             ; preds = %polly.loop_exit822, %polly.loop_header808
  ...
  %smin1107 = call i64 @llvm.smin.i64(i64 %215, i64 -968)
  %216 = add nsw i64 %smin1107, 1000
  %smin1041 = call i64 @llvm.smin.i64(i64 %indvars.iv1039, i64 -968)
  %217 = shl nsw i64 %polly.indvar817, 5
  %218 = add nsw i64 %smin1041, 999
...
vector.body1106:                                  ; preds = %vector.body1106, %vector.ph1109
  ...
  %222 = add nuw nsw <4 x i64> %vec.ind1116, %broadcast.splat1119
  %223 = trunc <4 x i64> %222 to <4 x i32>
  %224 = mul <4 x i32> %broadcast.splat1121, %223
  ...
  %234 = icmp eq i64 %index.next1113, %216
  br i1 %234, label %polly.loop_exit828, label %vector.body1106, !llvm.loop !102

polly.loop_exit828:                               ; preds = %vector.body1106, %polly.loop_header826
  %polly.indvar_next824 = add nuw nsw i64 %polly.indvar823, 1
  %exitcond1046.not = icmp eq i64 %polly.indvar823, %214
...
polly.loop_header826:                             ; preds = %polly.loop_header820, %polly.loop_header826
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar829, %218
...
polly.loop_header840:                             ; preds = %polly.loop_exit848, %polly.loop_header834
  ...
  %smin1125 = call i64 @llvm.smin.i64(i64 %244, i64 -968)
  %245 = add nsw i64 %smin1125, 1000
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 -968)
  %246 = shl nsw i64 %polly.indvar843, 5
  %247 = add nsw i64 %smin1031, 999
...
vector.body1124:                                  ; preds = %vector.body1124, %vector.ph1127
  ...
  %251 = add nuw nsw <4 x i64> %vec.ind1134, %broadcast.splat1137
  %252 = trunc <4 x i64> %251 to <4 x i32>
  %253 = mul <4 x i32> %broadcast.splat1139, %252
  ...
  %263 = icmp eq i64 %index.next1131, %245
  br i1 %263, label %polly.loop_exit854, label %vector.body1124, !llvm.loop !105

polly.loop_exit854:                               ; preds = %vector.body1124, %polly.loop_header852
  %polly.indvar_next850 = add nuw nsw i64 %polly.indvar849, 1
  %exitcond1036.not = icmp eq i64 %polly.indvar849, %243
...
polly.loop_header852:                             ; preds = %polly.loop_header846, %polly.loop_header852
  ...
  %exitcond1032.not = icmp eq i64 %polly.indvar855, %247
