; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1600.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1600.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1041 = add nuw nsw i64 %indvars.iv1040, 16
  %indvars.iv.next1055 = add nuw nsw i64 %indvars.iv1054, 8
  %exitcond1058.not = icmp eq i64 %polly.indvar_next220, 75
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %103 = shl nsw i64 %polly.indvar225, 4
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  ...
  %155 = mul nsw i64 %polly.indvar423, -16
  %156 = shl nuw nsw i64 %polly.indvar423, 4
  %157 = udiv i64 %indvars.iv1086, 25
  %158 = mul nsw i64 %polly.indvar423, -16
  %159 = shl nsw i64 %polly.indvar423, 4
  br label %polly.loop_header426

polly.loop_exit428:                               ; preds = %polly.loop_exit435
  %polly.indvar_next424 = add nuw nsw i64 %polly.indvar423, 1
  %indvars.iv.next1068 = add nsw i64 %indvars.iv1067, -16
  %indvars.iv.next1073 = add nuw nsw i64 %indvars.iv1072, 16
  %indvars.iv.next1087 = add nuw nsw i64 %indvars.iv1086, 8
  %exitcond1090.not = icmp eq i64 %polly.indvar_next424, 75
...
polly.loop_header426:                             ; preds = %polly.loop_exit435, %polly.loop_header420
  ...
  %161 = shl nsw i64 %polly.indvar429, 4
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %polly.loop_guard443 = icmp slt i64 %170, 16
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  %indvars.iv1118 = phi i64 [ %indvars.iv.next1119, %polly.loop_exit639 ], [ 7, %polly.loop_exit623 ]
  ...
  %213 = mul nsw i64 %polly.indvar634, -16
  %214 = shl nuw nsw i64 %polly.indvar634, 4
  %215 = udiv i64 %indvars.iv1118, 25
  %216 = mul nsw i64 %polly.indvar634, -16
  %217 = shl nsw i64 %polly.indvar634, 4
...
polly.loop_exit639:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1122.not = icmp eq i64 %polly.indvar_next635, 75
...
polly.loop_header637:                             ; preds = %polly.loop_exit646, %polly.loop_header631
  ...
  %219 = shl nsw i64 %polly.indvar640, 4
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %polly.loop_guard654 = icmp slt i64 %228, 16
