; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8174.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8174.c"
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %exitcond822.not = icmp eq i64 %polly.indvar_next364, 60
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %181 = mul nsw i64 %polly.indvar521, -20
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next827 = add nuw nsw i64 %indvars.iv826, 20
  %indvars.iv.next829 = add nuw nsw i64 %indvars.iv828, 2
  %indvars.iv.next834 = add nsw i64 %indvars.iv833, -20
  %exitcond845.not = icmp eq i64 %polly.indvar_next522, 60
