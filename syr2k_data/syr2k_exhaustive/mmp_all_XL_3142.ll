; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3142.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3142.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit244
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header205:                             ; preds = %polly.loop_exit244, %polly.loop_header199
  ...
  %.inv = icmp ugt i64 %101, 79
  %103 = select i1 %.inv, i64 79, i64 %102
  %polly.loop_guard = icmp sgt i64 %103, -1
  %104 = add nuw nsw i64 %101, 19
...
polly.loop_exit244:                               ; preds = %polly.loop_exit250
  ...
  %exitcond887.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_header248:                             ; preds = %polly.loop_exit256, %polly.loop_header242
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv882, i64 79)
...
polly.loop_exit256:                               ; preds = %polly.loop_header254
  ...
  %exitcond885.not = icmp eq i64 %polly.indvar_next252, 20
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %126 = shl nuw nsw i64 %polly.indvar386, 2
  %127 = mul nsw i64 %polly.indvar386, -80
  %128 = mul nuw nsw i64 %polly.indvar386, 80
  br label %polly.loop_header389

polly.loop_exit391:                               ; preds = %polly.loop_exit430
  %polly.indvar_next387 = add nuw nsw i64 %polly.indvar386, 1
  %exitcond903.not = icmp eq i64 %polly.indvar_next387, 15
...
polly.loop_header389:                             ; preds = %polly.loop_exit430, %polly.loop_header383
  ...
  %129 = mul nuw nsw i64 %polly.indvar392, 20
  %130 = add nsw i64 %129, %127
  %131 = add nsw i64 %130, -1
  %.inv857 = icmp ugt i64 %130, 79
  %132 = select i1 %.inv857, i64 79, i64 %131
  %polly.loop_guard405 = icmp sgt i64 %132, -1
  %133 = add nuw nsw i64 %130, 19
...
polly.loop_exit430:                               ; preds = %polly.loop_exit436
  ...
  %indvars.iv.next895 = add nuw nsw i64 %indvars.iv894, 20
  %exitcond902.not = icmp eq i64 %polly.indvar_next393, 60
...
polly.loop_header434:                             ; preds = %polly.loop_exit442, %polly.loop_header428
  ...
  %smin898 = call i64 @llvm.smin.i64(i64 %indvars.iv896, i64 79)
...
polly.loop_exit442:                               ; preds = %polly.loop_header440
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar_next438, 20
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %155 = shl nuw nsw i64 %polly.indvar572, 2
  %156 = mul nsw i64 %polly.indvar572, -80
  %157 = mul nuw nsw i64 %polly.indvar572, 80
...
polly.loop_exit577:                               ; preds = %polly.loop_exit616
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar_next573, 15
...
polly.loop_header575:                             ; preds = %polly.loop_exit616, %polly.loop_header569
  ...
  %158 = mul nuw nsw i64 %polly.indvar578, 20
  %159 = add nsw i64 %158, %156
  %160 = add nsw i64 %159, -1
  %.inv858 = icmp ugt i64 %159, 79
  %161 = select i1 %.inv858, i64 79, i64 %160
...
polly.loop_exit616:                               ; preds = %polly.loop_exit622
  ...
  %exitcond917.not = icmp eq i64 %polly.indvar_next579, 60
...
polly.loop_exit628:                               ; preds = %polly.loop_header626
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar_next624, 20
