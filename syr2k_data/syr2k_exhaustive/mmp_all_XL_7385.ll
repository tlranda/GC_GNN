; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7385.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7385.c"
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249930 = icmp sgt i64 %116, -1
...
vector.body1039:                                  ; preds = %vector.body1039, %vector.ph1043
  ...
  %129 = shl nuw nsw i64 %index1046, 3
  %130 = getelementptr i8, i8* %scevgep370, i64 %129
  %131 = bitcast i8* %130 to <4 x double>*
  %wide.load1050 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !74, !noalias !76
  %132 = fmul fast <4 x double> %wide.load1050, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %134 = icmp eq i64 %index.next1047, %n.vec1045
  br i1 %134, label %middle.block1037, label %vector.body1039, !llvm.loop !80

middle.block1037:                                 ; preds = %vector.body1039
  %cmp.n1049 = icmp eq i64 %127, %n.vec1045
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %149 = shl nsw i64 %polly.indvar405, 5
...
polly.loop_header409:                             ; preds = %polly.loop_header409.preheader, %polly.loop_exit418
  ...
  %polly.loop_guard426931 = icmp sgt i64 %155, -1
...
polly.loop_header535:                             ; preds = %polly.loop_exit543, %polly.start449
  ...
  %min.iters.check1016 = icmp ult i64 %166, 4
...
vector.body1015:                                  ; preds = %vector.body1015, %vector.ph1017
  ...
  %168 = shl nuw nsw i64 %index1020, 3
  %169 = getelementptr i8, i8* %scevgep547, i64 %168
  %170 = bitcast i8* %169 to <4 x double>*
  %wide.load1024 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !84, !noalias !86
  %171 = fmul fast <4 x double> %wide.load1024, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %173 = icmp eq i64 %index.next1021, %n.vec1019
  br i1 %173, label %middle.block1013, label %vector.body1015, !llvm.loop !90

middle.block1013:                                 ; preds = %vector.body1015
  %cmp.n1023 = icmp eq i64 %166, %n.vec1019
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %188 = shl nsw i64 %polly.indvar582, 5
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header579
  ...
  %192 = add i64 %smax880, %indvars.iv883
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit595
  %indvars.iv885 = phi i64 [ %192, %polly.loop_header586.preheader ], [ %indvars.iv.next886, %polly.loop_exit595 ]
  ...
  %polly.loop_guard603932 = icmp sgt i64 %194, -1
...
polly.loop_header756:                             ; preds = %polly.loop_exit764, %polly.loop_header750
  ...
  %smin954 = call i64 @llvm.smin.i64(i64 %207, i64 -1168)
  %208 = add nsw i64 %smin954, 1200
  %smin921 = call i64 @llvm.smin.i64(i64 %indvars.iv919, i64 -1168)
  %209 = shl nsw i64 %polly.indvar759, 5
  %210 = add nsw i64 %smin921, 1199
...
vector.ph955:                                     ; preds = %polly.loop_header762
  %broadcast.splatinsert962 = insertelement <4 x i64> poison, i64 %209, i32 0
  %broadcast.splat963 = shufflevector <4 x i64> %broadcast.splatinsert962, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert964 = insertelement <4 x i32> poison, i32 %212, i32 0
...
vector.body953:                                   ; preds = %vector.body953, %vector.ph955
  ...
  %214 = add nuw nsw <4 x i64> %vec.ind960, %broadcast.splat963
  %215 = trunc <4 x i64> %214 to <4 x i32>
  %216 = mul <4 x i32> %broadcast.splat965, %215
  ...
  %226 = icmp eq i64 %index.next957, %208
  br i1 %226, label %polly.loop_exit770, label %vector.body953, !llvm.loop !99

polly.loop_exit770:                               ; preds = %vector.body953, %polly.loop_header768
  %polly.indvar_next766 = add nuw nsw i64 %polly.indvar765, 1
  %exitcond926.not = icmp eq i64 %polly.indvar765, %206
...
polly.loop_header768:                             ; preds = %polly.loop_header762, %polly.loop_header768
  ...
  %exitcond922.not = icmp eq i64 %polly.indvar771, %210
...
polly.loop_header783:                             ; preds = %polly.loop_exit791, %polly.loop_header777
  ...
  %smin969 = call i64 @llvm.smin.i64(i64 %236, i64 -968)
  %237 = add nsw i64 %smin969, 1000
  %smin911 = call i64 @llvm.smin.i64(i64 %indvars.iv909, i64 -968)
  %238 = shl nsw i64 %polly.indvar786, 5
  %239 = add nsw i64 %smin911, 999
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph971
  ...
  %243 = add nuw nsw <4 x i64> %vec.ind978, %broadcast.splat981
  %244 = trunc <4 x i64> %243 to <4 x i32>
  %245 = mul <4 x i32> %broadcast.splat983, %244
  ...
  %255 = icmp eq i64 %index.next975, %237
  br i1 %255, label %polly.loop_exit797, label %vector.body968, !llvm.loop !102

polly.loop_exit797:                               ; preds = %vector.body968, %polly.loop_header795
  %polly.indvar_next793 = add nuw nsw i64 %polly.indvar792, 1
  %exitcond916.not = icmp eq i64 %polly.indvar792, %235
...
polly.loop_header795:                             ; preds = %polly.loop_header789, %polly.loop_header795
  ...
  %exitcond912.not = icmp eq i64 %polly.indvar798, %239
...
polly.loop_header809:                             ; preds = %polly.loop_exit817, %polly.loop_header803
  ...
  %smin987 = call i64 @llvm.smin.i64(i64 %265, i64 -968)
  %266 = add nsw i64 %smin987, 1000
  %smin901 = call i64 @llvm.smin.i64(i64 %indvars.iv899, i64 -968)
  %267 = shl nsw i64 %polly.indvar812, 5
  %268 = add nsw i64 %smin901, 999
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph989
  ...
  %272 = add nuw nsw <4 x i64> %vec.ind996, %broadcast.splat999
  %273 = trunc <4 x i64> %272 to <4 x i32>
  %274 = mul <4 x i32> %broadcast.splat1001, %273
  ...
  %284 = icmp eq i64 %index.next993, %266
  br i1 %284, label %polly.loop_exit823, label %vector.body986, !llvm.loop !105

polly.loop_exit823:                               ; preds = %vector.body986, %polly.loop_header821
  %polly.indvar_next819 = add nuw nsw i64 %polly.indvar818, 1
  %exitcond906.not = icmp eq i64 %polly.indvar818, %264
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  %exitcond902.not = icmp eq i64 %polly.indvar824, %268
