; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7255.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7255.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next219, 38
...
polly.loop_header384:                             ; preds = %polly.loop_exit376, %polly.loop_exit393
  ...
  %121 = shl nsw i64 %polly.indvar387, 5
...
polly.loop_exit393:                               ; preds = %polly.loop_exit399
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next388, 38
...
polly.loop_header391:                             ; preds = %polly.loop_exit399, %polly.loop_header384
  ...
  %123 = shl nsw i64 %polly.indvar394, 6
...
polly.loop_header556:                             ; preds = %polly.loop_exit548, %polly.loop_exit565
  ...
  %144 = shl nsw i64 %polly.indvar559, 5
...
polly.loop_exit565:                               ; preds = %polly.loop_exit571
  ...
  %indvars.iv.next854 = add nuw nsw i64 %indvars.iv853, 32
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -32
  %exitcond867.not = icmp eq i64 %polly.indvar_next560, 38
...
polly.loop_header563:                             ; preds = %polly.loop_exit571, %polly.loop_header556
  ...
  %146 = shl nsw i64 %polly.indvar566, 6
