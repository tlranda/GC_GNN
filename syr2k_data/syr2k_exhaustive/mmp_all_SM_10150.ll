; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10150.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10150.c"
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %109 = mul nsw i64 %polly.indvar214.us, 100
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %.inv780 = icmp slt i64 %138, 11
  %140 = select i1 %.inv780, i64 %139, i64 11
  %polly.loop_guard373 = icmp sgt i64 %140, -1
  %141 = mul nsw i64 %polly.indvar359, -64
  %142 = icmp slt i64 %141, -1136
  %143 = select i1 %142, i64 %141, i64 -1136
  %144 = add nsw i64 %143, 1199
  %145 = shl nsw i64 %polly.indvar359, 6
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %148 = mul nsw i64 %polly.indvar374.us, 100
...
polly.loop_header378.us:                          ; preds = %polly.loop_header378.preheader.us, %polly.loop_exit387.us
  ...
  %smin923 = call i64 @llvm.smin.i64(i64 %indvars.iv921, i64 99)
...
polly.loop_exit380.us:                            ; preds = %polly.loop_exit387.us, %polly.loop_header370.us
  ...
  %indvars.iv.next920 = add i64 %indvars.iv919, -100
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %.inv781 = icmp slt i64 %177, 11
  %179 = select i1 %.inv781, i64 %178, i64 11
  %polly.loop_guard533 = icmp sgt i64 %179, -1
  %180 = mul nsw i64 %polly.indvar519, -64
  %181 = icmp slt i64 %180, -1136
  %182 = select i1 %181, i64 %180, i64 -1136
  %183 = add nsw i64 %182, 1199
  %184 = shl nsw i64 %polly.indvar519, 6
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %187 = mul nsw i64 %polly.indvar534.us, 100
...
polly.loop_header538.us:                          ; preds = %polly.loop_header538.preheader.us, %polly.loop_exit547.us
  ...
  %smin945 = call i64 @llvm.smin.i64(i64 %indvars.iv943, i64 99)
...
polly.loop_exit540.us:                            ; preds = %polly.loop_exit547.us, %polly.loop_header530.us
  ...
  %indvars.iv.next937 = add i64 %indvars.iv936, 100
  %indvars.iv.next942 = add i64 %indvars.iv941, -100
