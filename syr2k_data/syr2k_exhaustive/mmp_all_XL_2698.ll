; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2698.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2698.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next203, 50
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %.inv = icmp ugt i64 %102, 19
  %104 = select i1 %.inv, i64 19, i64 %103
...
polly.loop_exit236.us:                            ; preds = %polly.loop_header234.us.1, %polly.loop_exit225.loopexit.us
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar_next221.us, 20
...
polly.start285:                                   ; preds = %kernel_syr2k.exit
  %malloccall287 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body1088:                                  ; preds = %vector.body1088, %vector.ph1092
  ...
  %wide.load1099 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %143, label %middle.block1086, label %vector.body1088, !llvm.loop !84
...
polly.loop_header387:                             ; preds = %polly.loop_header387.preheader, %polly.loop_exit395
  ...
  %145 = mul nuw nsw i64 %polly.indvar390, 20
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond923.not = icmp eq i64 %polly.indvar_next391, 50
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %146 = mul nuw nsw i64 %polly.indvar396, 5
  %147 = mul nsw i64 %polly.indvar396, -20
  %148 = mul nuw nsw i64 %polly.indvar396, 20
...
polly.loop_header399:                             ; preds = %polly.loop_exit440, %polly.loop_header393
  ...
  %.inv869 = icmp ugt i64 %150, 19
  %152 = select i1 %.inv869, i64 19, i64 %151
...
polly.loop_exit426.us:                            ; preds = %polly.loop_header424.us.1, %polly.loop_exit414.loopexit.us
  ...
  %exitcond912.not = icmp eq i64 %polly.indvar_next409.us, 20
...
polly.loop_exit426:                               ; preds = %polly.loop_header424.1, %polly.loop_header405
  ...
  %exitcond910.not = icmp eq i64 %polly.indvar_next409, 20
...
polly.start475:                                   ; preds = %init_array.exit
  %malloccall477 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body1064:                                  ; preds = %vector.body1064, %vector.ph1066
  ...
  %wide.load1073 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %191, label %middle.block1062, label %vector.body1064, !llvm.loop !94
...
polly.loop_header577:                             ; preds = %polly.loop_header577.preheader, %polly.loop_exit585
  ...
  %193 = mul nuw nsw i64 %polly.indvar580, 20
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %exitcond939.not = icmp eq i64 %polly.indvar_next581, 50
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %194 = mul nuw nsw i64 %polly.indvar586, 5
  %195 = mul nsw i64 %polly.indvar586, -20
  %196 = mul nuw nsw i64 %polly.indvar586, 20
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %198, 19
  %200 = select i1 %.inv870, i64 19, i64 %199
...
polly.loop_exit616.us:                            ; preds = %polly.loop_header614.us.1, %polly.loop_exit604.loopexit.us
  ...
  %exitcond928.not = icmp eq i64 %polly.indvar_next599.us, 20
...
polly.loop_exit616:                               ; preds = %polly.loop_header614.1, %polly.loop_header595
  ...
  %exitcond926.not = icmp eq i64 %polly.indvar_next599, 20
...
vector.body1002:                                  ; preds = %vector.body1002, %vector.ph1004
  ...
  br i1 %253, label %polly.loop_exit809, label %vector.body1002, !llvm.loop !103
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1020
  ...
  br i1 %282, label %polly.loop_exit836, label %vector.body1017, !llvm.loop !106
...
vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1038
  ...
  br i1 %311, label %polly.loop_exit862, label %vector.body1035, !llvm.loop !109
...
polly.loop_exit262.3:                             ; preds = %polly.loop_header260.3
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar_next252, 20
...
polly.loop_exit452.3:                             ; preds = %polly.loop_header450.3
  ...
  %exitcond920.not = icmp eq i64 %polly.indvar_next442, 20
