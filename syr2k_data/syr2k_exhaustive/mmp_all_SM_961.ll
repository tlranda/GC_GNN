; ModuleID = 'syr2k_exhaustive/mmp_all_SM_961.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_961.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %indvars.iv1140 = phi i64 [ 79, %polly.loop_header200.preheader ], [ %indvars.iv.next1141, %polly.loop_exit224 ]
...
polly.loop_header222:                             ; preds = %polly.loop_exit274, %polly.loop_exit208
  ...
  %185 = mul nsw i64 %indvar1503, -80
  %186 = add i64 %101, %185
  %smax1522 = call i64 @llvm.smax.i64(i64 %186, i64 0)
  %187 = mul nuw nsw i64 %indvar1503, 80
  %188 = add i64 %103, %187
  %189 = add i64 %smax1522, %188
  %190 = mul nsw i64 %indvar1503, -80
  %191 = add i64 %109, %190
  %smax1505 = call i64 @llvm.smax.i64(i64 %191, i64 0)
  %192 = mul nuw nsw i64 %indvar1503, 80
  %193 = add i64 %108, %192
...
polly.loop_header272.preheader:                   ; preds = %polly.merge, %polly.loop_header228.us987, %polly.merge.us
  ...
  %polly.loop_guard282 = icmp slt i64 %210, 80
...
polly.loop_header419:                             ; preds = %polly.loop_header419.preheader, %polly.loop_exit444
  ...
  %indvars.iv1172 = phi i64 [ 79, %polly.loop_header419.preheader ], [ %indvars.iv.next1173, %polly.loop_exit444 ]
  ...
  %254 = shl nuw nsw i64 %polly.indvar422, 1
  %255 = udiv i64 %254, 5
  ...
  %262 = shl nuw nsw i64 %polly.indvar422, 1
  %263 = udiv i64 %262, 5
...
polly.loop_exit427:                               ; preds = %polly.loop_exit433
  ...
  %276 = shl nuw nsw i64 %polly.indvar422, 1
  %pexp.p_div_q441 = udiv i64 %276, 5
  %277 = or i64 %276, 1
...
polly.loop_header442:                             ; preds = %polly.loop_exit500, %polly.loop_exit427
  ...
  %341 = mul nsw i64 %indvar1440, -80
  %342 = add i64 %257, %341
  %smax1459 = call i64 @llvm.smax.i64(i64 %342, i64 0)
  %343 = mul nuw nsw i64 %indvar1440, 80
  %344 = add i64 %259, %343
  %345 = add i64 %smax1459, %344
  %346 = mul nsw i64 %indvar1440, -80
  %347 = add i64 %265, %346
  %smax1442 = call i64 @llvm.smax.i64(i64 %347, i64 0)
  %348 = mul nuw nsw i64 %indvar1440, 80
  %349 = add i64 %264, %348
  ...
  %357 = mul nuw nsw i64 %polly.indvar445, 5
  %.not971 = icmp ult i64 %357, %277
  %358 = mul nuw nsw i64 %polly.indvar445, 80
  %359 = add nsw i64 %358, %275
  %360 = icmp sgt i64 %359, 32
  %361 = select i1 %360, i64 %359, i64 32
  %362 = add nsw i64 %359, 79
  %polly.loop_guard487 = icmp sgt i64 %359, -80
...
polly.loop_header498.preheader:                   ; preds = %polly.merge455, %polly.loop_header448.us1032, %polly.merge455.us
  ...
  %polly.loop_guard508 = icmp slt i64 %366, 80
...
polly.loop_header645:                             ; preds = %polly.loop_header645.preheader, %polly.loop_exit670
  ...
  %indvars.iv1206 = phi i64 [ 79, %polly.loop_header645.preheader ], [ %indvars.iv.next1207, %polly.loop_exit670 ]
  ...
  %410 = shl nuw nsw i64 %polly.indvar648, 1
  %411 = udiv i64 %410, 5
  %412 = mul nuw nsw i64 %411, 80
  ...
  %418 = shl nuw nsw i64 %polly.indvar648, 1
  %419 = udiv i64 %418, 5
  %420 = mul nuw nsw i64 %419, 80
  %421 = sub nsw i64 %417, %420
  %422 = or i64 %416, 8
  %423 = mul nsw i64 %polly.indvar648, -32
  %424 = add i64 %423, %420
  %425 = udiv i64 %indvars.iv1208, 5
...
polly.loop_exit653:                               ; preds = %polly.loop_exit659
  ...
  %432 = shl nuw nsw i64 %polly.indvar648, 1
  %pexp.p_div_q667 = udiv i64 %432, 5
  %433 = or i64 %432, 1
...
polly.loop_header668:                             ; preds = %polly.loop_exit726, %polly.loop_exit653
  ...
  %497 = mul nsw i64 %indvar1377, -80
  %498 = add i64 %413, %497
  %smax1396 = call i64 @llvm.smax.i64(i64 %498, i64 0)
  %499 = mul nuw nsw i64 %indvar1377, 80
  %500 = add i64 %415, %499
  %501 = add i64 %smax1396, %500
  %502 = mul nsw i64 %indvar1377, -80
  %503 = add i64 %421, %502
  %smax1379 = call i64 @llvm.smax.i64(i64 %503, i64 0)
  %504 = mul nuw nsw i64 %indvar1377, 80
  %505 = add i64 %420, %504
  ...
  %513 = mul nuw nsw i64 %polly.indvar671, 5
  %.not972 = icmp ult i64 %513, %433
  %514 = mul nuw nsw i64 %polly.indvar671, 80
  %515 = add nsw i64 %514, %431
  %516 = icmp sgt i64 %515, 32
  %517 = select i1 %516, i64 %515, i64 32
  %518 = add nsw i64 %515, 79
  %polly.loop_guard713 = icmp sgt i64 %515, -80
...
polly.loop_header724.preheader:                   ; preds = %polly.merge681, %polly.loop_header674.us1077, %polly.merge681.us
  ...
  %polly.loop_guard734 = icmp slt i64 %522, 80
