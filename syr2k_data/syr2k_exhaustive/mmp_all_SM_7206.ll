; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7206.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7206.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv847 = phi i64 [ %indvars.iv.next848, %polly.loop_exit223 ], [ 3, %polly.loop_exit207 ]
  %indvars.iv837 = phi i64 [ %indvars.iv.next838, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %polly.indvar218 = phi i64 [ %polly.indvar_next219, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv847, i64 149)
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next219, 38
...
vector.body1050:                                  ; preds = %vector.body1050, %vector.ph1054
  ...
  %wide.load1061 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %129, label %middle.block1048, label %vector.body1050, !llvm.loop !80
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv873 = phi i64 [ %indvars.iv.next874, %polly.loop_exit398 ], [ 3, %polly.loop_exit382 ]
  ...
  %umin875 = call i64 @llvm.umin.i64(i64 %indvars.iv873, i64 149)
  %131 = mul nsw i64 %polly.indvar393, -32
...
polly.loop_exit398:                               ; preds = %polly.loop_exit404
  ...
  %indvars.iv.next862 = add nuw nsw i64 %indvars.iv861, 32
  %indvars.iv.next874 = add nuw nsw i64 %indvars.iv873, 4
  %exitcond878.not = icmp eq i64 %polly.indvar_next394, 38
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1028
  ...
  %wide.load1035 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %163, label %middle.block1024, label %vector.body1026, !llvm.loop !90
...
polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  %indvars.iv900 = phi i64 [ %indvars.iv.next901, %polly.loop_exit575 ], [ 3, %polly.loop_exit559 ]
  ...
  %umin902 = call i64 @llvm.umin.i64(i64 %indvars.iv900, i64 149)
  %165 = mul nsw i64 %polly.indvar570, -32
  %166 = icmp slt i64 %165, -1168
  %167 = select i1 %166, i64 %165, i64 -1168
  %168 = add nsw i64 %167, 1199
  %169 = shl nsw i64 %polly.indvar570, 5
...
polly.loop_exit575:                               ; preds = %polly.loop_exit581
  ...
  %indvars.iv.next889 = add nuw nsw i64 %indvars.iv888, 32
  %indvars.iv.next901 = add nuw nsw i64 %indvars.iv900, 4
  %exitcond905.not = icmp eq i64 %polly.indvar_next571, 38
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph966
  ...
  br i1 %211, label %polly.loop_exit770, label %vector.body964, !llvm.loop !99
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph982
  ...
  br i1 %240, label %polly.loop_exit797, label %vector.body979, !llvm.loop !102
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph1000
  ...
  br i1 %269, label %polly.loop_exit823, label %vector.body997, !llvm.loop !105
