; ModuleID = 'syr2k_exhaustive/mmp_all_SM_330.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_330.c"
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1108.not = icmp eq i64 %polly.indvar_next204, 10
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %103 = add i64 %102, %100
  %104 = lshr i64 %polly.indvar209, 2
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1107.not = icmp eq i64 %113, 300
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %116 = mul nsw i64 %indvar1401, -16
  %117 = add i64 %101, %116
  %smax1403 = call i64 @llvm.smax.i64(i64 %117, i64 0)
  %118 = shl nuw nsw i64 %indvar1401, 4
  %119 = add i64 %103, %118
  %120 = add i64 %smax1403, %119
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %polly.loop_guard273 = icmp slt i64 %133, 16
...
polly.loop_header270.us:                          ; preds = %polly.loop_header263.us, %polly.loop_exit280.us
  ...
  %134 = add i64 %120, %indvar1404
  %smin1406 = call i64 @llvm.smin.i64(i64 %134, i64 3)
  %135 = add nsw i64 %smin1406, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1102, i64 3)
  %136 = add nsw i64 %polly.indvar274.us, %124
  %polly.loop_guard281.us1197 = icmp sgt i64 %136, -1
...
polly.loop_header278.preheader.us:                ; preds = %polly.loop_header270.us
  ...
  %min.iters.check1407 = icmp ult i64 %135, 4
...
vector.body1400:                                  ; preds = %vector.body1400, %vector.ph1408
  ...
  %142 = add nuw nsw i64 %index1411, %108
  %143 = add nuw nsw i64 %index1411, %polly.access.mul.Packed_MemRef_call1285.us
  %144 = getelementptr double, double* %Packed_MemRef_call1, i64 %143
  %145 = bitcast double* %144 to <4 x double>*
  %wide.load1415 = load <4 x double>, <4 x double>* %145, align 8
  %146 = fmul fast <4 x double> %broadcast.splat1417, %wide.load1415
  %147 = getelementptr double, double* %Packed_MemRef_call2, i64 %143
  %148 = bitcast double* %147 to <4 x double>*
  %wide.load1418 = load <4 x double>, <4 x double>* %148, align 8
  %149 = fmul fast <4 x double> %broadcast.splat1420, %wide.load1418
  %150 = shl i64 %142, 3
  %151 = add i64 %150, %141
  %152 = getelementptr i8, i8* %call, i64 %151
  %153 = bitcast i8* %152 to <4 x double>*
  %wide.load1421 = load <4 x double>, <4 x double>* %153, align 8, !alias.scope !72, !noalias !74
  ...
  %156 = fadd fast <4 x double> %155, %wide.load1421
  ...
  %158 = icmp eq i64 %index.next1412, %n.vec1410
  br i1 %158, label %middle.block1398, label %vector.body1400, !llvm.loop !85

middle.block1398:                                 ; preds = %vector.body1400
  %cmp.n1414 = icmp eq i64 %135, %n.vec1410
...
vector.body1336:                                  ; preds = %vector.body1336, %vector.ph1340
  ...
  %162 = shl nuw nsw i64 %index1343, 3
  %163 = getelementptr i8, i8* %scevgep406, i64 %162
  %164 = bitcast i8* %163 to <4 x double>*
  %wide.load1347 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !86, !noalias !88
  %165 = fmul fast <4 x double> %wide.load1347, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %167 = icmp eq i64 %index.next1344, %n.vec1342
  br i1 %167, label %middle.block1334, label %vector.body1336, !llvm.loop !93

middle.block1334:                                 ; preds = %vector.body1336
  %cmp.n1346 = icmp eq i64 %160, %n.vec1342
...
polly.loop_exit418:                               ; preds = %polly.loop_exit441
  ...
  %exitcond1134.not = icmp eq i64 %polly.indvar_next414, 10
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %171 = shl nuw nsw i64 %polly.indvar419, 2
  %172 = and i64 %171, 9223372036854775792
  %173 = sub nsw i64 %170, %172
  %174 = mul nsw i64 %polly.indvar419, -4
  %175 = add i64 %174, %172
  %176 = lshr i64 %polly.indvar419, 2
  %177 = shl nuw nsw i64 %176, 4
  %178 = sub nsw i64 %indvars.iv1118, %177
  %179 = add i64 %indvars.iv1123, %177
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %exitcond1133.not = icmp eq i64 %185, 300
...
polly.loop_exit430:                               ; preds = %polly.loop_header428
  ...
  %exitcond1114.not = icmp eq i64 %polly.indvar_next426, 100
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %indvars.iv1125 = phi i64 [ %indvars.iv.next1126, %polly.loop_exit482 ], [ %179, %polly.loop_exit424 ]
  %indvars.iv1120 = phi i64 [ %indvars.iv.next1121, %polly.loop_exit482 ], [ %178, %polly.loop_exit424 ]
  %polly.indvar442 = phi i64 [ %polly.indvar_next443, %polly.loop_exit482 ], [ %176, %polly.loop_exit424 ]
  %188 = mul nsw i64 %indvar1351, -16
  %189 = add i64 %173, %188
  %smax1353 = call i64 @llvm.smax.i64(i64 %189, i64 0)
  %190 = shl nuw nsw i64 %indvar1351, 4
  %191 = add i64 %175, %190
  %192 = add i64 %smax1353, %191
  %smax1122 = call i64 @llvm.smax.i64(i64 %indvars.iv1120, i64 0)
  %193 = add i64 %smax1122, %indvars.iv1125
  %194 = shl nsw i64 %polly.indvar442, 2
  %.not.not944 = icmp ugt i64 %194, %polly.indvar419
  %195 = shl nsw i64 %polly.indvar442, 4
  %196 = add nsw i64 %195, %181
  %197 = icmp sgt i64 %196, 0
  %198 = select i1 %197, i64 %196, i64 0
  %199 = add nsw i64 %196, 15
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_header445.us
  ...
  %exitcond1117.not = icmp eq i64 %polly.indvar_next449.us, 100
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1115.not = icmp eq i64 %polly.indvar_next449, 100
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %polly.loop_guard490 = icmp slt i64 %205, 16
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %indvars.iv1127 = phi i64 [ %193, %polly.loop_header480.us ], [ %indvars.iv.next1128, %polly.loop_exit497.us ]
  %polly.indvar491.us = phi i64 [ %205, %polly.loop_header480.us ], [ %polly.indvar_next492.us, %polly.loop_exit497.us ]
  %206 = add i64 %192, %indvar1354
  %smin1356 = call i64 @llvm.smin.i64(i64 %206, i64 3)
  %207 = add nsw i64 %smin1356, 1
  %smin1129 = call i64 @llvm.smin.i64(i64 %indvars.iv1127, i64 3)
  %208 = add nsw i64 %polly.indvar491.us, %196
  %polly.loop_guard498.us1198 = icmp sgt i64 %208, -1
...
polly.loop_header495.preheader.us:                ; preds = %polly.loop_header487.us
  ...
  %min.iters.check1357 = icmp ult i64 %207, 4
...
vector.body1350:                                  ; preds = %vector.body1350, %vector.ph1358
  ...
  %214 = add nuw nsw i64 %index1361, %180
  %215 = add nuw nsw i64 %index1361, %polly.access.mul.Packed_MemRef_call1309502.us
  %216 = getelementptr double, double* %Packed_MemRef_call1309, i64 %215
  %217 = bitcast double* %216 to <4 x double>*
  %wide.load1365 = load <4 x double>, <4 x double>* %217, align 8
  %218 = fmul fast <4 x double> %broadcast.splat1367, %wide.load1365
  %219 = getelementptr double, double* %Packed_MemRef_call2311, i64 %215
  %220 = bitcast double* %219 to <4 x double>*
  %wide.load1368 = load <4 x double>, <4 x double>* %220, align 8
  %221 = fmul fast <4 x double> %broadcast.splat1370, %wide.load1368
  %222 = shl i64 %214, 3
  %223 = add i64 %222, %213
  %224 = getelementptr i8, i8* %call, i64 %223
  %225 = bitcast i8* %224 to <4 x double>*
  %wide.load1371 = load <4 x double>, <4 x double>* %225, align 8, !alias.scope !86, !noalias !88
  ...
  %228 = fadd fast <4 x double> %227, %wide.load1371
  ...
  %230 = icmp eq i64 %index.next1362, %n.vec1360
  br i1 %230, label %middle.block1348, label %vector.body1350, !llvm.loop !98

middle.block1348:                                 ; preds = %vector.body1350
  %cmp.n1364 = icmp eq i64 %207, %n.vec1360
...
polly.loop_exit489.loopexit.us:                   ; preds = %polly.loop_exit497.us
  ...
  %exitcond1131.not = icmp eq i64 %polly.indvar_next484.us, 100
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1289 = icmp ult i64 %232, 4
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1290
  ...
  %234 = shl nuw nsw i64 %index1293, 3
  %235 = getelementptr i8, i8* %scevgep623, i64 %234
  %236 = bitcast i8* %235 to <4 x double>*
  %wide.load1297 = load <4 x double>, <4 x double>* %236, align 8, !alias.scope !99, !noalias !101
  %237 = fmul fast <4 x double> %wide.load1297, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %239 = icmp eq i64 %index.next1294, %n.vec1292
  br i1 %239, label %middle.block1286, label %vector.body1288, !llvm.loop !106

middle.block1286:                                 ; preds = %vector.body1288
  %cmp.n1296 = icmp eq i64 %232, %n.vec1292
...
polly.loop_exit635:                               ; preds = %polly.loop_exit658
  ...
  %exitcond1160.not = icmp eq i64 %polly.indvar_next631, 10
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %243 = shl nuw nsw i64 %polly.indvar636, 2
  %244 = and i64 %243, 9223372036854775792
  %245 = sub nsw i64 %242, %244
  %246 = mul nsw i64 %polly.indvar636, -4
  %247 = add i64 %246, %244
  %248 = lshr i64 %polly.indvar636, 2
  %249 = shl nuw nsw i64 %248, 4
  %250 = sub nsw i64 %indvars.iv1144, %249
  %251 = add i64 %indvars.iv1149, %249
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %exitcond1159.not = icmp eq i64 %257, 300
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %indvars.iv1151 = phi i64 [ %indvars.iv.next1152, %polly.loop_exit699 ], [ %251, %polly.loop_exit641 ]
  %indvars.iv1146 = phi i64 [ %indvars.iv.next1147, %polly.loop_exit699 ], [ %250, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit699 ], [ %248, %polly.loop_exit641 ]
  %260 = mul nsw i64 %indvar1301, -16
  %261 = add i64 %245, %260
  %smax1303 = call i64 @llvm.smax.i64(i64 %261, i64 0)
  %262 = shl nuw nsw i64 %indvar1301, 4
  %263 = add i64 %247, %262
  %264 = add i64 %smax1303, %263
  %smax1148 = call i64 @llvm.smax.i64(i64 %indvars.iv1146, i64 0)
  %265 = add i64 %smax1148, %indvars.iv1151
  %266 = shl nsw i64 %polly.indvar659, 2
  %.not.not945 = icmp ugt i64 %266, %polly.indvar636
  %267 = shl nsw i64 %polly.indvar659, 4
  %268 = add nsw i64 %267, %253
  %269 = icmp sgt i64 %268, 0
  %270 = select i1 %269, i64 %268, i64 0
  %271 = add nsw i64 %268, 15
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %polly.loop_guard707 = icmp slt i64 %277, 16
...
polly.loop_header704.us:                          ; preds = %polly.loop_header697.us, %polly.loop_exit714.us
  ...
  %indvars.iv1153 = phi i64 [ %265, %polly.loop_header697.us ], [ %indvars.iv.next1154, %polly.loop_exit714.us ]
  %polly.indvar708.us = phi i64 [ %277, %polly.loop_header697.us ], [ %polly.indvar_next709.us, %polly.loop_exit714.us ]
  %278 = add i64 %264, %indvar1304
  %smin1306 = call i64 @llvm.smin.i64(i64 %278, i64 3)
  %279 = add nsw i64 %smin1306, 1
  %smin1155 = call i64 @llvm.smin.i64(i64 %indvars.iv1153, i64 3)
  %280 = add nsw i64 %polly.indvar708.us, %268
  %polly.loop_guard715.us1199 = icmp sgt i64 %280, -1
...
polly.loop_header712.preheader.us:                ; preds = %polly.loop_header704.us
  ...
  %min.iters.check1307 = icmp ult i64 %279, 4
...
vector.body1300:                                  ; preds = %vector.body1300, %vector.ph1308
  ...
  %286 = add nuw nsw i64 %index1311, %252
  %287 = add nuw nsw i64 %index1311, %polly.access.mul.Packed_MemRef_call1526719.us
  %288 = getelementptr double, double* %Packed_MemRef_call1526, i64 %287
  %289 = bitcast double* %288 to <4 x double>*
  %wide.load1315 = load <4 x double>, <4 x double>* %289, align 8
  %290 = fmul fast <4 x double> %broadcast.splat1317, %wide.load1315
  %291 = getelementptr double, double* %Packed_MemRef_call2528, i64 %287
  %292 = bitcast double* %291 to <4 x double>*
  %wide.load1318 = load <4 x double>, <4 x double>* %292, align 8
  %293 = fmul fast <4 x double> %broadcast.splat1320, %wide.load1318
  %294 = shl i64 %286, 3
  %295 = add i64 %294, %285
  %296 = getelementptr i8, i8* %call, i64 %295
  %297 = bitcast i8* %296 to <4 x double>*
  %wide.load1321 = load <4 x double>, <4 x double>* %297, align 8, !alias.scope !99, !noalias !101
  ...
  %300 = fadd fast <4 x double> %299, %wide.load1321
  ...
  %302 = icmp eq i64 %index.next1312, %n.vec1310
  br i1 %302, label %middle.block1298, label %vector.body1300, !llvm.loop !111

middle.block1298:                                 ; preds = %vector.body1300
  %cmp.n1314 = icmp eq i64 %279, %n.vec1310
...
polly.loop_exit706.loopexit.us:                   ; preds = %polly.loop_exit714.us
  ...
  %exitcond1157.not = icmp eq i64 %polly.indvar_next701.us, 100
...
polly.loop_header870:                             ; preds = %polly.loop_exit878, %polly.loop_header864
  ...
  %smin1227 = call i64 @llvm.smin.i64(i64 %306, i64 -1168)
  %307 = add nsw i64 %smin1227, 1200
  %smin1185 = call i64 @llvm.smin.i64(i64 %indvars.iv1183, i64 -1168)
  %308 = shl nsw i64 %polly.indvar873, 5
  %309 = add nsw i64 %smin1185, 1199
...
vector.ph1228:                                    ; preds = %polly.loop_header876
  %broadcast.splatinsert1235 = insertelement <4 x i64> poison, i64 %308, i32 0
  %broadcast.splat1236 = shufflevector <4 x i64> %broadcast.splatinsert1235, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1237 = insertelement <4 x i32> poison, i32 %311, i32 0
...
vector.body1226:                                  ; preds = %vector.body1226, %vector.ph1228
  ...
  %313 = add nuw nsw <4 x i64> %vec.ind1233, %broadcast.splat1236
  %314 = trunc <4 x i64> %313 to <4 x i32>
  %315 = mul <4 x i32> %broadcast.splat1238, %314
  ...
  %325 = icmp eq i64 %index.next1230, %307
  br i1 %325, label %polly.loop_exit884, label %vector.body1226, !llvm.loop !117

polly.loop_exit884:                               ; preds = %vector.body1226, %polly.loop_header882
  %polly.indvar_next880 = add nuw nsw i64 %polly.indvar879, 1
  %exitcond1190.not = icmp eq i64 %polly.indvar879, %305
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  %exitcond1186.not = icmp eq i64 %polly.indvar885, %309
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %smin1242 = call i64 @llvm.smin.i64(i64 %335, i64 -968)
  %336 = add nsw i64 %smin1242, 1000
  %smin1175 = call i64 @llvm.smin.i64(i64 %indvars.iv1173, i64 -968)
  %337 = shl nsw i64 %polly.indvar900, 5
  %338 = add nsw i64 %smin1175, 999
...
vector.body1241:                                  ; preds = %vector.body1241, %vector.ph1244
  ...
  %342 = add nuw nsw <4 x i64> %vec.ind1251, %broadcast.splat1254
  %343 = trunc <4 x i64> %342 to <4 x i32>
  %344 = mul <4 x i32> %broadcast.splat1256, %343
  ...
  %354 = icmp eq i64 %index.next1248, %336
  br i1 %354, label %polly.loop_exit911, label %vector.body1241, !llvm.loop !120

polly.loop_exit911:                               ; preds = %vector.body1241, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1180.not = icmp eq i64 %polly.indvar906, %334
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %exitcond1176.not = icmp eq i64 %polly.indvar912, %338
...
polly.loop_header923:                             ; preds = %polly.loop_exit931, %polly.loop_header917
  ...
  %smin1260 = call i64 @llvm.smin.i64(i64 %364, i64 -968)
  %365 = add nsw i64 %smin1260, 1000
  %smin1165 = call i64 @llvm.smin.i64(i64 %indvars.iv1163, i64 -968)
  %366 = shl nsw i64 %polly.indvar926, 5
  %367 = add nsw i64 %smin1165, 999
...
vector.body1259:                                  ; preds = %vector.body1259, %vector.ph1262
  ...
  %371 = add nuw nsw <4 x i64> %vec.ind1269, %broadcast.splat1272
  %372 = trunc <4 x i64> %371 to <4 x i32>
  %373 = mul <4 x i32> %broadcast.splat1274, %372
  ...
  %383 = icmp eq i64 %index.next1266, %365
  br i1 %383, label %polly.loop_exit937, label %vector.body1259, !llvm.loop !123

polly.loop_exit937:                               ; preds = %vector.body1259, %polly.loop_header935
  %polly.indvar_next933 = add nuw nsw i64 %polly.indvar932, 1
  %exitcond1170.not = icmp eq i64 %polly.indvar932, %363
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  %exitcond1166.not = icmp eq i64 %polly.indvar938, %367
