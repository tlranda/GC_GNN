; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3617.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3617.c"
...
polly.start291:                                   ; preds = %kernel_syr2k.exit
  %malloccall293 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %smin1059 = call i64 @llvm.smin.i64(i64 %indvars.iv1037, i64 -872)
  %145 = add nsw i64 %smin1059, 1000
  %146 = shl nsw i64 %polly.indvar396, 7
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar_next397, 8
...
polly.start488:                                   ; preds = %init_array.exit
  %malloccall490 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %smin1087 = call i64 @llvm.smin.i64(i64 %indvars.iv1065, i64 -872)
  %193 = add nsw i64 %smin1087, 1000
  %194 = shl nsw i64 %polly.indvar593, 7
...
polly.loop_exit598:                               ; preds = %polly.loop_exit606
  ...
  %exitcond1090.not = icmp eq i64 %polly.indvar_next594, 8
