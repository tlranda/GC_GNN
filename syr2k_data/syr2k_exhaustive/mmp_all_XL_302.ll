; ModuleID = 'syr2k_exhaustive/mmp_all_XL_302.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_302.c"
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1101.not = icmp eq i64 %polly.indvar_next204, 20
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %103 = sub i64 %98, %102
  %104 = mul nsw i64 %polly.indvar209, -50
  %105 = add i64 %104, %102
  %106 = lshr i64 %polly.indvar209, 3
  %107 = add nuw i64 %indvars.iv1088, %106
...
polly.loop_exit220:                               ; preds = %polly.loop_header218
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar_next216, 50
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %117 = mul nsw i64 %indvar1396, -16
  %118 = add i64 %103, %117
  %smax1398 = call i64 @llvm.smax.i64(i64 %118, i64 0)
  %119 = shl nuw nsw i64 %indvar1396, 4
  %120 = add i64 %105, %119
...
polly.loop_exit253.us:                            ; preds = %polly.loop_header251.us, %polly.loop_exit242.loopexit.us
  ...
  %exitcond1085.not = icmp eq i64 %polly.indvar_next238.us, 50
...
polly.loop_exit267:                               ; preds = %polly.loop_exit274.loopexit.us, %polly.loop_header265.preheader
  ...
  %indvars.iv.next1091 = add i64 %indvars.iv1090, -16
...
polly.loop_exit253:                               ; preds = %polly.loop_header251
  ...
  %exitcond1083.not = icmp eq i64 %polly.indvar_next238, 50
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us, %polly.loop_header228.split
  ...
  %polly.loop_guard275 = icmp slt i64 %136, 16
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  ...
  %smin1401 = call i64 @llvm.smin.i64(i64 %137, i64 49)
...
vector.body1395:                                  ; preds = %vector.body1395, %vector.ph1403
  ...
  %wide.load1416 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %161, label %middle.block1393, label %vector.body1395, !llvm.loop !84
...
polly.loop_exit274.loopexit.us:                   ; preds = %polly.loop_exit282.us
  ...
  %exitcond1099.not = icmp eq i64 %polly.indvar_next269.us, 50
...
vector.body1331:                                  ; preds = %vector.body1331, %vector.ph1335
  ...
  %wide.load1342 = load <4 x double>, <4 x double>* %167, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %168, <4 x double>* %169, align 8, !alias.scope !85, !noalias !87
  %index.next1339 = add i64 %index1338, 4
  %170 = icmp eq i64 %index.next1339, %n.vec1337
  br i1 %170, label %middle.block1329, label %vector.body1331, !llvm.loop !92
...
polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  ...
  %172 = mul nuw nsw i64 %polly.indvar415, 50
  br label %polly.loop_header418

polly.loop_exit420:                               ; preds = %polly.loop_exit443
  %polly.indvar_next416 = add nuw nsw i64 %polly.indvar415, 1
  %exitcond1128.not = icmp eq i64 %polly.indvar_next416, 20
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %173 = mul nuw nsw i64 %polly.indvar421, 50
  %174 = mul nuw nsw i64 %polly.indvar421, 3
  %175 = lshr i64 %polly.indvar421, 3
  %176 = add nuw i64 %174, %175
  %177 = shl nuw nsw i64 %176, 4
  %178 = sub i64 %173, %177
  %179 = mul nsw i64 %polly.indvar421, -50
  %180 = add i64 %179, %177
  %181 = lshr i64 %polly.indvar421, 3
  %182 = add nuw i64 %indvars.iv1113, %181
  %183 = shl nuw nsw i64 %182, 4
  %184 = sub i64 %indvars.iv1111, %183
  %185 = add i64 %indvars.iv1118, %183
  %186 = mul nuw nsw i64 %polly.indvar421, 50
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %187 = mul nsw i64 %polly.indvar421, -50
  %188 = mul nuw nsw i64 %polly.indvar421, 3
...
polly.loop_exit432:                               ; preds = %polly.loop_header430
  ...
  %exitcond1107.not = icmp eq i64 %polly.indvar_next428, 50
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_exit456.loopexit.us
  ...
  %exitcond1110.not = icmp eq i64 %polly.indvar_next451.us, 50
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1108.not = icmp eq i64 %polly.indvar_next451, 50
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header441.split
  ...
  %polly.loop_guard490 = icmp slt i64 %211, 16
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1351 = call i64 @llvm.smin.i64(i64 %212, i64 49)
...
vector.body1345:                                  ; preds = %vector.body1345, %vector.ph1353
  ...
  %wide.load1366 = load <4 x double>, <4 x double>* %231, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %234, <4 x double>* %235, align 8, !alias.scope !85, !noalias !87
  %index.next1357 = add i64 %index1356, 4
  %236 = icmp eq i64 %index.next1357, %n.vec1355
  br i1 %236, label %middle.block1343, label %vector.body1345, !llvm.loop !97
...
polly.loop_exit489.loopexit.us:                   ; preds = %polly.loop_exit497.us
  ...
  %exitcond1126.not = icmp eq i64 %polly.indvar_next484.us, 50
...
vector.body1283:                                  ; preds = %vector.body1283, %vector.ph1285
  ...
  %wide.load1292 = load <4 x double>, <4 x double>* %242, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %245, label %middle.block1281, label %vector.body1283, !llvm.loop !105
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %247 = mul nuw nsw i64 %polly.indvar630, 50
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %exitcond1155.not = icmp eq i64 %polly.indvar_next631, 20
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %249 = mul nuw nsw i64 %polly.indvar636, 3
  %250 = lshr i64 %polly.indvar636, 3
  %251 = add nuw i64 %249, %250
  %252 = shl nuw nsw i64 %251, 4
  %253 = sub i64 %248, %252
  %254 = mul nsw i64 %polly.indvar636, -50
  %255 = add i64 %254, %252
  %256 = lshr i64 %polly.indvar636, 3
  %257 = add nuw i64 %indvars.iv1140, %256
  %258 = shl nuw nsw i64 %257, 4
  %259 = sub i64 %indvars.iv1138, %258
  %260 = add i64 %indvars.iv1145, %258
  %261 = mul nuw nsw i64 %polly.indvar636, 50
  br label %polly.loop_header639

polly.loop_exit641:                               ; preds = %polly.loop_exit647
  %262 = mul nsw i64 %polly.indvar636, -50
  %263 = mul nuw nsw i64 %polly.indvar636, 3
  %264 = add nuw nsw i64 %263, %256
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1134.not = icmp eq i64 %polly.indvar_next643, 50
...
polly.loop_exit683.us:                            ; preds = %polly.loop_header681.us, %polly.loop_exit671.loopexit.us
  ...
  %exitcond1137.not = icmp eq i64 %polly.indvar_next666.us, 50
...
polly.loop_exit683:                               ; preds = %polly.loop_header681
  ...
  %exitcond1135.not = icmp eq i64 %polly.indvar_next666, 50
...
polly.loop_header695.preheader:                   ; preds = %polly.loop_exit683, %polly.loop_exit683.us, %polly.loop_header656.split
  ...
  %polly.loop_guard705 = icmp slt i64 %286, 16
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  ...
  %smin1301 = call i64 @llvm.smin.i64(i64 %287, i64 49)
...
vector.body1295:                                  ; preds = %vector.body1295, %vector.ph1303
  ...
  %wide.load1316 = load <4 x double>, <4 x double>* %306, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %309, <4 x double>* %310, align 8, !alias.scope !98, !noalias !100
  %index.next1307 = add i64 %index1306, 4
  %311 = icmp eq i64 %index.next1307, %n.vec1305
  br i1 %311, label %middle.block1293, label %vector.body1295, !llvm.loop !110
...
polly.loop_exit704.loopexit.us:                   ; preds = %polly.loop_exit712.us
  ...
  %exitcond1153.not = icmp eq i64 %polly.indvar_next699.us, 50
...
vector.body1221:                                  ; preds = %vector.body1221, %vector.ph1223
  ...
  store <4 x double> %328, <4 x double>* %333, align 8, !alias.scope !111, !noalias !113
  ...
  br i1 %334, label %polly.loop_exit882, label %vector.body1221, !llvm.loop !116
...
vector.body1236:                                  ; preds = %vector.body1236, %vector.ph1239
  ...
  store <4 x double> %357, <4 x double>* %362, align 8, !alias.scope !115, !noalias !118
  ...
  br i1 %363, label %polly.loop_exit909, label %vector.body1236, !llvm.loop !119
...
vector.body1254:                                  ; preds = %vector.body1254, %vector.ph1257
  ...
  store <4 x double> %386, <4 x double>* %391, align 8, !alias.scope !114, !noalias !121
  ...
  br i1 %392, label %polly.loop_exit935, label %vector.body1254, !llvm.loop !122
