; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4657.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4657.c"
...
vector.body1180:                                  ; preds = %vector.body1180, %vector.ph1182
  ...
  br i1 %57, label %middle.block1178, label %vector.body1180, !llvm.loop !54
...
vector.body1206:                                  ; preds = %vector.body1206, %vector.ph1208
  ...
  br i1 %68, label %middle.block1204, label %vector.body1206, !llvm.loop !56
...
vector.body1218:                                  ; preds = %vector.body1218, %vector.ph1222
  ...
  %wide.load1229 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !62, !noalias !64
  ...
  br i1 %95, label %middle.block1216, label %vector.body1218, !llvm.loop !68
...
polly.loop_exit213:                               ; preds = %polly.loop_exit220, %polly.loop_header205
  ...
  %exitcond996.not = icmp eq i64 %polly.indvar_next209, 20
...
vector.body1192:                                  ; preds = %vector.body1192, %vector.ph1196
  ...
  %128 = shl nuw nsw i64 %index1199, 3
  %129 = getelementptr i8, i8* %scevgep381, i64 %128
  %130 = bitcast i8* %129 to <4 x double>*
  %wide.load1203 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !73, !noalias !75
  %131 = fmul fast <4 x double> %wide.load1203, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %133 = icmp eq i64 %index.next1200, %n.vec1198
  br i1 %133, label %middle.block1190, label %vector.body1192, !llvm.loop !79

middle.block1190:                                 ; preds = %vector.body1192
  %cmp.n1202 = icmp eq i64 %126, %n.vec1198
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409, %polly.loop_header391
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar_next395, 20
...
polly.merge433.us:                                ; preds = %polly.then434.us, %polly.cond432.loopexit.us
  ...
  %exitcond1014.not = icmp eq i64 %polly.indvar_next418.us, 50
...
polly.loop_header414:                             ; preds = %polly.loop_header407.split, %polly.loop_header414
  ...
  %exitcond1000.not = icmp eq i64 %polly.indvar_next418, 50
...
polly.loop_exit452.loopexit.us:                   ; preds = %polly.loop_header450.us
  ...
  %exitcond1017.not = icmp eq i64 %polly.indvar_next447.us, 50
...
polly.loop_header562:                             ; preds = %polly.loop_exit570, %polly.start476
  ...
  %min.iters.check1169 = icmp ult i64 %164, 4
...
vector.body1168:                                  ; preds = %vector.body1168, %vector.ph1170
  ...
  %166 = shl nuw nsw i64 %index1173, 3
  %167 = getelementptr i8, i8* %scevgep574, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load1177 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !83, !noalias !85
  %169 = fmul fast <4 x double> %wide.load1177, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next1174, %n.vec1172
  br i1 %171, label %middle.block1166, label %vector.body1168, !llvm.loop !89

middle.block1166:                                 ; preds = %vector.body1168
  %cmp.n1176 = icmp eq i64 %164, %n.vec1172
...
polly.loop_exit594:                               ; preds = %polly.loop_exit602, %polly.loop_header584
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next588, 20
...
polly.merge626.us:                                ; preds = %polly.then627.us, %polly.cond625.loopexit.us
  ...
  %exitcond1036.not = icmp eq i64 %polly.indvar_next611.us, 50
...
polly.loop_header607:                             ; preds = %polly.loop_header600.split, %polly.loop_header607
  ...
  %exitcond1022.not = icmp eq i64 %polly.indvar_next611, 50
...
polly.loop_exit645.loopexit.us:                   ; preds = %polly.loop_header643.us
  ...
  %exitcond1039.not = icmp eq i64 %polly.indvar_next640.us, 50
...
vector.ph1108:                                    ; preds = %polly.loop_header805
  %broadcast.splatinsert1115 = insertelement <4 x i64> poison, i64 %206, i32 0
  %broadcast.splat1116 = shufflevector <4 x i64> %broadcast.splatinsert1115, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1117 = insertelement <4 x i32> poison, i32 %209, i32 0
...
vector.body1107:                                  ; preds = %vector.body1107, %vector.ph1108
  ...
  %211 = add nuw nsw <4 x i64> %vec.ind1113, %broadcast.splat1116
  %212 = trunc <4 x i64> %211 to <4 x i32>
  %213 = mul <4 x i32> %broadcast.splat1118, %212
  ...
  %223 = icmp eq i64 %index.next1110, %205
  br i1 %223, label %polly.loop_exit813, label %vector.body1107, !llvm.loop !98
...
polly.loop_header826:                             ; preds = %polly.loop_exit834, %polly.loop_header820
  ...
  %smin1122 = call i64 @llvm.smin.i64(i64 %233, i64 -968)
  %234 = add nsw i64 %smin1122, 1000
...
vector.body1121:                                  ; preds = %vector.body1121, %vector.ph1124
  ...
  %240 = add nuw nsw <4 x i64> %vec.ind1131, %broadcast.splat1134
  %241 = trunc <4 x i64> %240 to <4 x i32>
  %242 = mul <4 x i32> %broadcast.splat1136, %241
  ...
  %252 = icmp eq i64 %index.next1128, %234
  br i1 %252, label %polly.loop_exit840, label %vector.body1121, !llvm.loop !101
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %smin1140 = call i64 @llvm.smin.i64(i64 %262, i64 -968)
  %263 = add nsw i64 %smin1140, 1000
...
vector.body1139:                                  ; preds = %vector.body1139, %vector.ph1142
  ...
  %269 = add nuw nsw <4 x i64> %vec.ind1149, %broadcast.splat1152
  %270 = trunc <4 x i64> %269 to <4 x i32>
  %271 = mul <4 x i32> %broadcast.splat1154, %270
  ...
  %281 = icmp eq i64 %index.next1146, %263
  br i1 %281, label %polly.loop_exit866, label %vector.body1139, !llvm.loop !104
