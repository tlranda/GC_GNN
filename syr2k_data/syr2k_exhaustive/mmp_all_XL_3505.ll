; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3505.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3505.c"
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1169, label %for.body3.i46.preheader1249, label %vector.ph1170
...
middle.block1166:                                 ; preds = %vector.body1168
  ...
  br i1 %cmp.n1176, label %for.inc6.i, label %for.body3.i46.preheader1249

for.body3.i46.preheader1249:                      ; preds = %for.body3.i46.preheader, %middle.block1166
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  ...
  br i1 %min.iters.check1192, label %for.body3.i60.preheader1246, label %vector.ph1193
...
middle.block1189:                                 ; preds = %vector.body1191
  ...
  br i1 %cmp.n1199, label %for.inc6.i63, label %for.body3.i60.preheader1246

for.body3.i60.preheader1246:                      ; preds = %for.body3.i60.preheader, %middle.block1189
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  ...
  br i1 %min.iters.check1218, label %for.body3.i99.preheader1243, label %vector.ph1219
...
middle.block1215:                                 ; preds = %vector.body1217
  ...
  br i1 %cmp.n1225, label %for.inc6.i102, label %for.body3.i99.preheader1243

for.body3.i99.preheader1243:                      ; preds = %for.body3.i99.preheader, %middle.block1215
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv997 = phi i64 [ 0, %polly.loop_header199.preheader ], [ %indvars.iv.next998, %polly.loop_exit207 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit244
  ...
  %exitcond1005.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header205:                             ; preds = %polly.loop_exit244, %polly.loop_header199
  %indvars.iv999 = phi i64 [ %indvars.iv.next1000, %polly.loop_exit244 ], [ %101, %polly.loop_header199 ]
  %indvars.iv995 = phi i64 [ %indvars.iv.next996, %polly.loop_exit244 ], [ %100, %polly.loop_header199 ]
  %polly.indvar208 = phi i64 [ %polly.indvar_next209, %polly.loop_exit244 ], [ %98, %polly.loop_header199 ]
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv995, i64 0)
  %105 = add i64 %smax, %indvars.iv999
  %106 = shl nsw i64 %polly.indvar208, 6
  %107 = add nsw i64 %106, %102
  %108 = add nsw i64 %107, -1
  %.inv = icmp sgt i64 %107, 79
  %109 = select i1 %.inv, i64 79, i64 %108
  %polly.loop_guard = icmp sgt i64 %109, -1
  %110 = icmp sgt i64 %107, 0
  %111 = select i1 %110, i64 %107, i64 0
  %112 = add nsw i64 %107, 63
...
polly.loop_exit244:                               ; preds = %polly.loop_exit251, %polly.loop_header242.preheader
  ...
  %polly.loop_cond210 = icmp ult i64 %polly.indvar208, 18
  %indvars.iv.next996 = add i64 %indvars.iv995, -64
  %indvars.iv.next1000 = add i64 %indvars.iv999, 64
...
polly.loop_header242.preheader:                   ; preds = %polly.loop_exit230, %polly.loop_exit230.us, %polly.loop_header205.split
  ...
  %120 = mul nsw i64 %polly.indvar208, -64
  %121 = icmp slt i64 %120, -1136
  %122 = select i1 %121, i64 %120, i64 -1136
...
polly.loop_exit251:                               ; preds = %polly.loop_exit259
  ...
  %exitcond1004.not = icmp eq i64 %polly.indvar_next246, 1000
  br i1 %exitcond1004.not, label %polly.loop_exit244, label %polly.loop_header242

polly.loop_header249:                             ; preds = %polly.loop_exit259, %polly.loop_header242
  %indvars.iv1001 = phi i64 [ %indvars.iv.next1002, %polly.loop_exit259 ], [ %105, %polly.loop_header242 ]
  %polly.indvar253 = phi i64 [ %polly.indvar_next254, %polly.loop_exit259 ], [ %119, %polly.loop_header242 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1001, i64 79)
  %126 = add nsw i64 %polly.indvar253, %107
  %polly.loop_guard2601085 = icmp sgt i64 %126, -1
  br i1 %polly.loop_guard2601085, label %polly.loop_header257.preheader, label %polly.loop_exit259
...
polly.loop_header257:                             ; preds = %polly.loop_header257.preheader, %polly.loop_header257
  ...
  %exitcond1003.not = icmp eq i64 %polly.indvar261, %smin
  br i1 %exitcond1003.not, label %polly.loop_exit259, label %polly.loop_header257
...
vector.body1203:                                  ; preds = %vector.body1203, %vector.ph1207
  ...
  %136 = shl nuw nsw i64 %index1210, 3
  %137 = getelementptr i8, i8* %scevgep383, i64 %136
  %138 = bitcast i8* %137 to <4 x double>*
  %wide.load1214 = load <4 x double>, <4 x double>* %138, align 8, !alias.scope !79, !noalias !81
  %139 = fmul fast <4 x double> %wide.load1214, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %141 = icmp eq i64 %index.next1211, %n.vec1209
  br i1 %141, label %middle.block1201, label %vector.body1203, !llvm.loop !85

middle.block1201:                                 ; preds = %vector.body1203
  %cmp.n1213 = icmp eq i64 %134, %n.vec1209
...
polly.loop_exit379:                               ; preds = %polly.loop_header377, %middle.block1201
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next375, 1200
  %indvar.next1205 = add i64 %indvar1204, 1
  br i1 %exitcond1027.not, label %polly.loop_header387.preheader, label %polly.loop_header371
...
polly.loop_header377:                             ; preds = %polly.loop_header377.preheader, %polly.loop_header377
  ...
  %exitcond1026.not = icmp eq i64 %polly.indvar_next381, %polly.indvar374
  br i1 %exitcond1026.not, label %polly.loop_exit379, label %polly.loop_header377, !llvm.loop !86
...
polly.loop_header387:                             ; preds = %polly.loop_header387.preheader, %polly.loop_exit396
  ...
  %indvars.iv1011 = phi i64 [ 0, %polly.loop_header387.preheader ], [ %indvars.iv.next1012, %polly.loop_exit396 ]
  %polly.indvar390 = phi i64 [ 0, %polly.loop_header387.preheader ], [ %polly.indvar_next391, %polly.loop_exit396 ]
  %143 = lshr i64 %polly.indvar390, 2
  %144 = add nuw i64 %polly.indvar390, %143
  %145 = shl nuw nsw i64 %144, 6
  %146 = sub i64 %indvars.iv1011, %145
  %147 = add i64 %indvars.iv1016, %145
  %148 = mul nsw i64 %polly.indvar390, -80
  %149 = mul nuw nsw i64 %polly.indvar390, 80
...
polly.loop_exit396:                               ; preds = %polly.loop_exit435
  ...
  %exitcond1025.not = icmp eq i64 %polly.indvar_next391, 15
  br i1 %exitcond1025.not, label %polly.exiting286, label %polly.loop_header387

polly.loop_header394:                             ; preds = %polly.loop_exit435, %polly.loop_header387
  %indvars.iv1018 = phi i64 [ %indvars.iv.next1019, %polly.loop_exit435 ], [ %147, %polly.loop_header387 ]
  %indvars.iv1013 = phi i64 [ %indvars.iv.next1014, %polly.loop_exit435 ], [ %146, %polly.loop_header387 ]
  %polly.indvar397 = phi i64 [ %polly.indvar_next398, %polly.loop_exit435 ], [ %144, %polly.loop_header387 ]
  %smax1015 = call i64 @llvm.smax.i64(i64 %indvars.iv1013, i64 0)
  %151 = add i64 %smax1015, %indvars.iv1018
  %152 = shl nsw i64 %polly.indvar397, 6
  %153 = add nsw i64 %152, %148
  %154 = add nsw i64 %153, -1
  %.inv871 = icmp sgt i64 %153, 79
  %155 = select i1 %.inv871, i64 79, i64 %154
  %polly.loop_guard410 = icmp sgt i64 %155, -1
  %156 = icmp sgt i64 %153, 0
  %157 = select i1 %156, i64 %153, i64 0
  %158 = add nsw i64 %153, 63
...
polly.loop_header407.us:                          ; preds = %polly.loop_header400.us, %polly.loop_header407.us
  ...
  %exitcond1009.not = icmp eq i64 %polly.indvar411.us, %155
  br i1 %exitcond1009.not, label %polly.loop_exit409.loopexit.us, label %polly.loop_header407.us
...
polly.loop_exit421.us:                            ; preds = %polly.loop_header419.us, %polly.loop_exit409.loopexit.us
  ...
  %exitcond1010.not = icmp eq i64 %polly.indvar_next404.us, 1000
  br i1 %exitcond1010.not, label %polly.loop_header433.preheader, label %polly.loop_header400.us
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442, %polly.loop_header433.preheader
  ...
  %polly.loop_cond399 = icmp ult i64 %polly.indvar397, 18
...
polly.loop_exit421:                               ; preds = %polly.loop_header419
  ...
  %exitcond1008.not = icmp eq i64 %polly.indvar_next404, 1000
  br i1 %exitcond1008.not, label %polly.loop_header433.preheader, label %polly.loop_header400
...
polly.loop_header433.preheader:                   ; preds = %polly.loop_exit421, %polly.loop_exit421.us, %polly.loop_header394.split
  ...
  %166 = mul nsw i64 %polly.indvar397, -64
...
polly.loop_exit442:                               ; preds = %polly.loop_exit450
  ...
  %exitcond1024.not = icmp eq i64 %polly.indvar_next437, 1000
  br i1 %exitcond1024.not, label %polly.loop_exit435, label %polly.loop_header433

polly.loop_header440:                             ; preds = %polly.loop_exit450, %polly.loop_header433
  %indvars.iv1020 = phi i64 [ %indvars.iv.next1021, %polly.loop_exit450 ], [ %151, %polly.loop_header433 ]
  %polly.indvar444 = phi i64 [ %polly.indvar_next445, %polly.loop_exit450 ], [ %165, %polly.loop_header433 ]
  %smin1022 = call i64 @llvm.smin.i64(i64 %indvars.iv1020, i64 79)
  %172 = add nsw i64 %polly.indvar444, %153
  %polly.loop_guard4511086 = icmp sgt i64 %172, -1
  br i1 %polly.loop_guard4511086, label %polly.loop_header448.preheader, label %polly.loop_exit450
...
polly.loop_header448:                             ; preds = %polly.loop_header448.preheader, %polly.loop_header448
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar452, %smin1022
  br i1 %exitcond1023.not, label %polly.loop_exit450, label %polly.loop_header448
...
polly.loop_header562:                             ; preds = %polly.loop_exit570, %polly.start476
  ...
  %min.iters.check1180 = icmp ult i64 %180, 4
...
vector.body1179:                                  ; preds = %vector.body1179, %vector.ph1181
  ...
  %182 = shl nuw nsw i64 %index1184, 3
  %183 = getelementptr i8, i8* %scevgep574, i64 %182
  %184 = bitcast i8* %183 to <4 x double>*
  %wide.load1188 = load <4 x double>, <4 x double>* %184, align 8, !alias.scope !89, !noalias !91
  %185 = fmul fast <4 x double> %wide.load1188, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %187 = icmp eq i64 %index.next1185, %n.vec1183
  br i1 %187, label %middle.block1177, label %vector.body1179, !llvm.loop !95

middle.block1177:                                 ; preds = %vector.body1179
  %cmp.n1187 = icmp eq i64 %180, %n.vec1183
...
polly.loop_exit570:                               ; preds = %polly.loop_header568, %middle.block1177
  ...
  %exitcond1047.not = icmp eq i64 %polly.indvar_next566, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond1047.not, label %polly.loop_header578.preheader, label %polly.loop_header562
...
polly.loop_header568:                             ; preds = %polly.loop_header568.preheader, %polly.loop_header568
  ...
  %exitcond1046.not = icmp eq i64 %polly.indvar_next572, %polly.indvar565
  br i1 %exitcond1046.not, label %polly.loop_exit570, label %polly.loop_header568, !llvm.loop !96

polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  %indvars.iv1036 = phi i64 [ 0, %polly.loop_header578.preheader ], [ %indvars.iv.next1037, %polly.loop_exit587 ]
  %indvars.iv1031 = phi i64 [ 0, %polly.loop_header578.preheader ], [ %indvars.iv.next1032, %polly.loop_exit587 ]
  %polly.indvar581 = phi i64 [ 0, %polly.loop_header578.preheader ], [ %polly.indvar_next582, %polly.loop_exit587 ]
  %189 = lshr i64 %polly.indvar581, 2
  %190 = add nuw i64 %polly.indvar581, %189
  %191 = shl nuw nsw i64 %190, 6
  %192 = sub i64 %indvars.iv1031, %191
  %193 = add i64 %indvars.iv1036, %191
  %194 = mul nsw i64 %polly.indvar581, -80
  %195 = mul nuw nsw i64 %polly.indvar581, 80
...
polly.loop_exit587:                               ; preds = %polly.loop_exit626
  ...
  %indvars.iv.next1032 = add nuw nsw i64 %indvars.iv1031, 80
  %indvars.iv.next1037 = add nsw i64 %indvars.iv1036, -80
  %exitcond1045.not = icmp eq i64 %polly.indvar_next582, 15
  br i1 %exitcond1045.not, label %polly.exiting477, label %polly.loop_header578

polly.loop_header585:                             ; preds = %polly.loop_exit626, %polly.loop_header578
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039, %polly.loop_exit626 ], [ %193, %polly.loop_header578 ]
  %indvars.iv1033 = phi i64 [ %indvars.iv.next1034, %polly.loop_exit626 ], [ %192, %polly.loop_header578 ]
  %polly.indvar588 = phi i64 [ %polly.indvar_next589, %polly.loop_exit626 ], [ %190, %polly.loop_header578 ]
  %smax1035 = call i64 @llvm.smax.i64(i64 %indvars.iv1033, i64 0)
  %197 = add i64 %smax1035, %indvars.iv1038
  %198 = shl nsw i64 %polly.indvar588, 6
  %199 = add nsw i64 %198, %194
  %200 = add nsw i64 %199, -1
  %.inv872 = icmp sgt i64 %199, 79
  %201 = select i1 %.inv872, i64 79, i64 %200
...
polly.loop_header598.us:                          ; preds = %polly.loop_header591.us, %polly.loop_header598.us
  ...
  %exitcond1029.not = icmp eq i64 %polly.indvar602.us, %201
  br i1 %exitcond1029.not, label %polly.loop_exit600.loopexit.us, label %polly.loop_header598.us
...
polly.loop_exit612.us:                            ; preds = %polly.loop_header610.us, %polly.loop_exit600.loopexit.us
  ...
  %exitcond1030.not = icmp eq i64 %polly.indvar_next595.us, 1000
  br i1 %exitcond1030.not, label %polly.loop_header624.preheader, label %polly.loop_header591.us
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633, %polly.loop_header624.preheader
  ...
  %polly.loop_cond590 = icmp ult i64 %polly.indvar588, 18
  %indvars.iv.next1034 = add i64 %indvars.iv1033, -64
...
polly.loop_exit612:                               ; preds = %polly.loop_header610
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next595, 1000
  br i1 %exitcond1028.not, label %polly.loop_header624.preheader, label %polly.loop_header591
...
polly.loop_header624.preheader:                   ; preds = %polly.loop_exit612, %polly.loop_exit612.us, %polly.loop_header585.split
  ...
  %212 = mul nsw i64 %polly.indvar588, -64
...
polly.loop_exit633:                               ; preds = %polly.loop_exit641
  ...
  %exitcond1044.not = icmp eq i64 %polly.indvar_next628, 1000
  br i1 %exitcond1044.not, label %polly.loop_exit626, label %polly.loop_header624

polly.loop_header631:                             ; preds = %polly.loop_exit641, %polly.loop_header624
  %indvars.iv1040 = phi i64 [ %indvars.iv.next1041, %polly.loop_exit641 ], [ %197, %polly.loop_header624 ]
  %polly.indvar635 = phi i64 [ %polly.indvar_next636, %polly.loop_exit641 ], [ %211, %polly.loop_header624 ]
  %smin1042 = call i64 @llvm.smin.i64(i64 %indvars.iv1040, i64 79)
  %218 = add nsw i64 %polly.indvar635, %199
  %polly.loop_guard6421087 = icmp sgt i64 %218, -1
  br i1 %polly.loop_guard6421087, label %polly.loop_header639.preheader, label %polly.loop_exit641
...
polly.loop_header639:                             ; preds = %polly.loop_header639.preheader, %polly.loop_header639
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar643, %smin1042
  br i1 %exitcond1043.not, label %polly.loop_exit641, label %polly.loop_header639

polly.loop_header791:                             ; preds = %entry, %polly.loop_exit799
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit799 ], [ 0, %entry ]
...
polly.loop_exit799:                               ; preds = %polly.loop_exit805
  ...
  %exitcond1077.not = icmp eq i64 %polly.indvar_next795, 38
  br i1 %exitcond1077.not, label %polly.loop_header818, label %polly.loop_header791

polly.loop_header797:                             ; preds = %polly.loop_exit805, %polly.loop_header791
  %indvars.iv1068 = phi i64 [ %indvars.iv.next1069, %polly.loop_exit805 ], [ 0, %polly.loop_header791 ]
  %polly.indvar800 = phi i64 [ %polly.indvar_next801, %polly.loop_exit805 ], [ 0, %polly.loop_header791 ]
  %228 = mul nsw i64 %polly.indvar800, -32
  %smin1118 = call i64 @llvm.smin.i64(i64 %228, i64 -1168)
  %229 = add nsw i64 %smin1118, 1200
  %smin1070 = call i64 @llvm.smin.i64(i64 %indvars.iv1068, i64 -1168)
  %230 = shl nsw i64 %polly.indvar800, 5
  %231 = add nsw i64 %smin1070, 1199
...
polly.loop_exit805:                               ; preds = %polly.loop_exit811
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar_next801, 38
  br i1 %exitcond1076.not, label %polly.loop_exit799, label %polly.loop_header797
...
vector.ph1119:                                    ; preds = %polly.loop_header803
  %broadcast.splatinsert1126 = insertelement <4 x i64> poison, i64 %230, i32 0
  %broadcast.splat1127 = shufflevector <4 x i64> %broadcast.splatinsert1126, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1128 = insertelement <4 x i32> poison, i32 %233, i32 0
...
vector.body1117:                                  ; preds = %vector.body1117, %vector.ph1119
  ...
  %235 = add nuw nsw <4 x i64> %vec.ind1124, %broadcast.splat1127
  %236 = trunc <4 x i64> %235 to <4 x i32>
  %237 = mul <4 x i32> %broadcast.splat1129, %236
  ...
  %247 = icmp eq i64 %index.next1121, %229
  br i1 %247, label %polly.loop_exit811, label %vector.body1117, !llvm.loop !104

polly.loop_exit811:                               ; preds = %vector.body1117, %polly.loop_header809
  %polly.indvar_next807 = add nuw nsw i64 %polly.indvar806, 1
  %exitcond1075.not = icmp eq i64 %polly.indvar806, %227
  br i1 %exitcond1075.not, label %polly.loop_exit805, label %polly.loop_header803
...
polly.loop_header809:                             ; preds = %polly.loop_header803, %polly.loop_header809
  ...
  %exitcond1071.not = icmp eq i64 %polly.indvar812, %231
  br i1 %exitcond1071.not, label %polly.loop_exit811, label %polly.loop_header809, !llvm.loop !105

polly.loop_header818:                             ; preds = %polly.loop_exit799, %polly.loop_exit826
  %indvars.iv1062 = phi i64 [ %indvars.iv.next1063, %polly.loop_exit826 ], [ 0, %polly.loop_exit799 ]
...
polly.loop_exit826:                               ; preds = %polly.loop_exit832
  ...
  %exitcond1067.not = icmp eq i64 %polly.indvar_next822, 38
  br i1 %exitcond1067.not, label %polly.loop_header844, label %polly.loop_header818

polly.loop_header824:                             ; preds = %polly.loop_exit832, %polly.loop_header818
  %indvars.iv1058 = phi i64 [ %indvars.iv.next1059, %polly.loop_exit832 ], [ 0, %polly.loop_header818 ]
  %polly.indvar827 = phi i64 [ %polly.indvar_next828, %polly.loop_exit832 ], [ 0, %polly.loop_header818 ]
  %257 = mul nsw i64 %polly.indvar827, -32
  %smin1133 = call i64 @llvm.smin.i64(i64 %257, i64 -968)
  %258 = add nsw i64 %smin1133, 1000
  %smin1060 = call i64 @llvm.smin.i64(i64 %indvars.iv1058, i64 -968)
  %259 = shl nsw i64 %polly.indvar827, 5
  %260 = add nsw i64 %smin1060, 999
...
polly.loop_exit832:                               ; preds = %polly.loop_exit838
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next828, 32
  br i1 %exitcond1066.not, label %polly.loop_exit826, label %polly.loop_header824
...
vector.body1132:                                  ; preds = %vector.body1132, %vector.ph1135
  ...
  %264 = add nuw nsw <4 x i64> %vec.ind1142, %broadcast.splat1145
  %265 = trunc <4 x i64> %264 to <4 x i32>
  %266 = mul <4 x i32> %broadcast.splat1147, %265
  ...
  %276 = icmp eq i64 %index.next1139, %258
  br i1 %276, label %polly.loop_exit838, label %vector.body1132, !llvm.loop !107

polly.loop_exit838:                               ; preds = %vector.body1132, %polly.loop_header836
  %polly.indvar_next834 = add nuw nsw i64 %polly.indvar833, 1
  %exitcond1065.not = icmp eq i64 %polly.indvar833, %256
  br i1 %exitcond1065.not, label %polly.loop_exit832, label %polly.loop_header830
...
polly.loop_header836:                             ; preds = %polly.loop_header830, %polly.loop_header836
  ...
  %exitcond1061.not = icmp eq i64 %polly.indvar839, %260
  br i1 %exitcond1061.not, label %polly.loop_exit838, label %polly.loop_header836, !llvm.loop !108

polly.loop_header844:                             ; preds = %polly.loop_exit826, %polly.loop_exit852
  %indvars.iv1052 = phi i64 [ %indvars.iv.next1053, %polly.loop_exit852 ], [ 0, %polly.loop_exit826 ]
...
polly.loop_exit852:                               ; preds = %polly.loop_exit858
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next848, 38
  br i1 %exitcond1057.not, label %init_array.exit, label %polly.loop_header844

polly.loop_header850:                             ; preds = %polly.loop_exit858, %polly.loop_header844
  %indvars.iv1048 = phi i64 [ %indvars.iv.next1049, %polly.loop_exit858 ], [ 0, %polly.loop_header844 ]
  %polly.indvar853 = phi i64 [ %polly.indvar_next854, %polly.loop_exit858 ], [ 0, %polly.loop_header844 ]
  %286 = mul nsw i64 %polly.indvar853, -32
  %smin1151 = call i64 @llvm.smin.i64(i64 %286, i64 -968)
  %287 = add nsw i64 %smin1151, 1000
  %smin1050 = call i64 @llvm.smin.i64(i64 %indvars.iv1048, i64 -968)
  %288 = shl nsw i64 %polly.indvar853, 5
  %289 = add nsw i64 %smin1050, 999
...
polly.loop_exit858:                               ; preds = %polly.loop_exit864
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next854, 32
  br i1 %exitcond1056.not, label %polly.loop_exit852, label %polly.loop_header850
...
vector.body1150:                                  ; preds = %vector.body1150, %vector.ph1153
  ...
  %293 = add nuw nsw <4 x i64> %vec.ind1160, %broadcast.splat1163
  %294 = trunc <4 x i64> %293 to <4 x i32>
  %295 = mul <4 x i32> %broadcast.splat1165, %294
  ...
  %305 = icmp eq i64 %index.next1157, %287
  br i1 %305, label %polly.loop_exit864, label %vector.body1150, !llvm.loop !110

polly.loop_exit864:                               ; preds = %vector.body1150, %polly.loop_header862
  %polly.indvar_next860 = add nuw nsw i64 %polly.indvar859, 1
  %exitcond1055.not = icmp eq i64 %polly.indvar859, %285
  br i1 %exitcond1055.not, label %polly.loop_exit858, label %polly.loop_header856
...
polly.loop_header862:                             ; preds = %polly.loop_header856, %polly.loop_header862
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar865, %289
  br i1 %exitcond1051.not, label %polly.loop_exit864, label %polly.loop_header862, !llvm.loop !111
}
