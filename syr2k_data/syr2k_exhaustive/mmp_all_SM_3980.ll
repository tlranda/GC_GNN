; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3980.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3980.c"
...
vector.body1209:                                  ; preds = %vector.body1209, %vector.ph1211
  ...
  br i1 %57, label %middle.block1207, label %vector.body1209, !llvm.loop !58
...
vector.body1235:                                  ; preds = %vector.body1235, %vector.ph1237
  ...
  br i1 %68, label %middle.block1233, label %vector.body1235, !llvm.loop !60
...
vector.body1247:                                  ; preds = %vector.body1247, %vector.ph1251
  ...
  %wide.load1258 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !66, !noalias !68
  ...
  br i1 %95, label %middle.block1245, label %vector.body1247, !llvm.loop !72
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond1017.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !73
...
polly.loop_header234.us:                          ; preds = %polly.loop_exit225.loopexit.us, %polly.loop_header234.us
  ...
  %polly.access.call1244.load.us = load double, double* %polly.access.call1244.us, align 8, !alias.scope !69, !noalias !75
...
polly.loop_header255.us:                          ; preds = %polly.loop_header248.us, %polly.loop_exit264.us
  ...
  %_p_scalar_274.us = load double, double* %scevgep272273.us, align 8, !alias.scope !70, !noalias !76
...
polly.loop_header262.us:                          ; preds = %polly.loop_header262.us, %polly.loop_header255.us
  ...
  %_p_scalar_277.us = load double, double* %scevgep275276.us, align 8, !alias.scope !70, !noalias !76
  ...
  %_p_scalar_284.us = load double, double* %scevgep282283.us, align 8, !alias.scope !66, !noalias !68
  %p_reass.add.i116.us = fadd fast double %p_mul37.i114.us, %p_mul27.i112.us
  %p_reass.mul.i117.us = fmul fast double %p_reass.add.i116.us, 1.500000e+00
  %p_add42.i118.us = fadd fast double %p_reass.mul.i117.us, %_p_scalar_284.us
  store double %p_add42.i118.us, double* %scevgep282283.us, align 8, !alias.scope !66, !noalias !68
...
polly.loop_header234:                             ; preds = %polly.loop_header217, %polly.loop_header234
  ...
  %polly.access.call1244.load = load double, double* %polly.access.call1244, align 8, !alias.scope !69, !noalias !75
...
vector.body1221:                                  ; preds = %vector.body1221, %vector.ph1225
  ...
  %wide.load1232 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %133, label %middle.block1219, label %vector.body1221, !llvm.loop !83
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_header379
  ...
  %_p_scalar_388 = load double, double* %scevgep386387, align 8, !alias.scope !77, !noalias !79
  %p_mul.i57 = fmul fast double %_p_scalar_388, 1.200000e+00
  store double %p_mul.i57, double* %scevgep386387, align 8, !alias.scope !77, !noalias !79
  %polly.indvar_next383 = add nuw nsw i64 %polly.indvar382, 1
  %exitcond1044.not = icmp eq i64 %polly.indvar_next383, %polly.indvar376
  br i1 %exitcond1044.not, label %polly.loop_exit381, label %polly.loop_header379, !llvm.loop !84
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %136 = shl nsw i64 %polly.indvar392, 7
...
polly.loop_header395:                             ; preds = %polly.loop_exit403, %polly.loop_header389
  ...
  %137 = mul nsw i64 %polly.indvar398, -128
  %138 = shl nsw i64 %polly.indvar398, 7
...
polly.loop_header401:                             ; preds = %polly.loop_exit442, %polly.loop_header395
  ...
  %141 = shl nsw i64 %polly.indvar404, 7
...
polly.loop_header414.us:                          ; preds = %polly.loop_header407.us, %polly.loop_header414.us
  ...
  %polly.access.call1424.load.us = load double, double* %polly.access.call1424.us, align 8, !alias.scope !80, !noalias !85
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next419.us, 128
...
polly.loop_header426.us:                          ; preds = %polly.loop_exit416.loopexit.us, %polly.loop_header426.us
  ...
  %polly.access.call1436.load.us = load double, double* %polly.access.call1436.us, align 8, !alias.scope !80, !noalias !85
...
polly.loop_header440.preheader:                   ; preds = %polly.loop_exit428.us, %polly.loop_exit428, %polly.loop_header401.split
  %150 = mul nsw i64 %polly.indvar404, -128
...
polly.loop_header447.us:                          ; preds = %polly.loop_header440.us, %polly.loop_exit456.us
  ...
  %_p_scalar_466.us = load double, double* %scevgep464465.us, align 8, !alias.scope !81, !noalias !86
...
polly.loop_header454.us:                          ; preds = %polly.loop_header454.us, %polly.loop_header447.us
  ...
  %_p_scalar_469.us = load double, double* %scevgep467468.us, align 8, !alias.scope !81, !noalias !86
  ...
  %_p_scalar_476.us = load double, double* %scevgep474475.us, align 8, !alias.scope !77, !noalias !79
  %p_reass.add.i77.us = fadd fast double %p_mul37.i75.us, %p_mul27.i73.us
  %p_reass.mul.i78.us = fmul fast double %p_reass.add.i77.us, 1.500000e+00
  %p_add42.i79.us = fadd fast double %p_reass.mul.i78.us, %_p_scalar_476.us
  store double %p_add42.i79.us, double* %scevgep474475.us, align 8, !alias.scope !77, !noalias !79
...
polly.loop_header426:                             ; preds = %polly.loop_header407, %polly.loop_header426
  ...
  %polly.access.call1436.load = load double, double* %polly.access.call1436, align 8, !alias.scope !80, !noalias !85
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1199
  ...
  %wide.load1206 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !87, !noalias !89
  ...
  store <4 x double> %169, <4 x double>* %170, align 8, !alias.scope !87, !noalias !89
  %index.next1203 = add i64 %index1202, 4
  %171 = icmp eq i64 %index.next1203, %n.vec1201
  br i1 %171, label %middle.block1195, label %vector.body1197, !llvm.loop !93
...
polly.loop_header571:                             ; preds = %polly.loop_header571.preheader, %polly.loop_header571
  ...
  %_p_scalar_580 = load double, double* %scevgep578579, align 8, !alias.scope !87, !noalias !89
  %p_mul.i = fmul fast double %_p_scalar_580, 1.200000e+00
  store double %p_mul.i, double* %scevgep578579, align 8, !alias.scope !87, !noalias !89
  %polly.indvar_next575 = add nuw nsw i64 %polly.indvar574, 1
  %exitcond1071.not = icmp eq i64 %polly.indvar_next575, %polly.indvar568
  br i1 %exitcond1071.not, label %polly.loop_exit573, label %polly.loop_header571, !llvm.loop !94
...
polly.loop_header581:                             ; preds = %polly.loop_header581.preheader, %polly.loop_exit589
  ...
  %174 = shl nsw i64 %polly.indvar584, 7
...
polly.loop_header587:                             ; preds = %polly.loop_exit595, %polly.loop_header581
  ...
  %175 = mul nsw i64 %polly.indvar590, -128
  %176 = shl nsw i64 %polly.indvar590, 7
...
polly.loop_header593:                             ; preds = %polly.loop_exit634, %polly.loop_header587
  ...
  %179 = shl nsw i64 %polly.indvar596, 7
...
polly.loop_header606.us:                          ; preds = %polly.loop_header599.us, %polly.loop_header606.us
  ...
  %polly.access.call1616.load.us = load double, double* %polly.access.call1616.us, align 8, !alias.scope !90, !noalias !95
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar_next611.us, 128
...
polly.loop_header618.us:                          ; preds = %polly.loop_exit608.loopexit.us, %polly.loop_header618.us
  ...
  %polly.access.call1628.load.us = load double, double* %polly.access.call1628.us, align 8, !alias.scope !90, !noalias !95
...
polly.loop_header632.preheader:                   ; preds = %polly.loop_exit620.us, %polly.loop_exit620, %polly.loop_header593.split
  %188 = mul nsw i64 %polly.indvar596, -128
...
polly.loop_header639.us:                          ; preds = %polly.loop_header632.us, %polly.loop_exit648.us
  ...
  %_p_scalar_658.us = load double, double* %scevgep656657.us, align 8, !alias.scope !91, !noalias !96
...
polly.loop_header646.us:                          ; preds = %polly.loop_header646.us, %polly.loop_header639.us
  ...
  %_p_scalar_661.us = load double, double* %scevgep659660.us, align 8, !alias.scope !91, !noalias !96
  ...
  %_p_scalar_668.us = load double, double* %scevgep666667.us, align 8, !alias.scope !87, !noalias !89
  %p_reass.add.i.us = fadd fast double %p_mul37.i.us, %p_mul27.i.us
  %p_reass.mul.i.us = fmul fast double %p_reass.add.i.us, 1.500000e+00
  %p_add42.i.us = fadd fast double %p_reass.mul.i.us, %_p_scalar_668.us
  store double %p_add42.i.us, double* %scevgep666667.us, align 8, !alias.scope !87, !noalias !89
...
polly.loop_header618:                             ; preds = %polly.loop_header599, %polly.loop_header618
  ...
  %polly.access.call1628.load = load double, double* %polly.access.call1628, align 8, !alias.scope !90, !noalias !95
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1137
  ...
  store <4 x double> %217, <4 x double>* %222, align 8, !alias.scope !97, !noalias !99
  ...
  br i1 %223, label %polly.loop_exit815, label %vector.body1136, !llvm.loop !102
...
polly.loop_header813:                             ; preds = %polly.loop_header807, %polly.loop_header813
  ...
  store double %p_div33.i, double* %scevgep819820, align 8, !alias.scope !97, !noalias !99
  %polly.indvar_next817 = add nuw nsw i64 %polly.indvar816, 1
  %exitcond1096.not = icmp eq i64 %polly.indvar816, %207
  br i1 %exitcond1096.not, label %polly.loop_exit815, label %polly.loop_header813, !llvm.loop !103
...
vector.body1150:                                  ; preds = %vector.body1150, %vector.ph1153
  ...
  store <4 x double> %246, <4 x double>* %251, align 8, !alias.scope !101, !noalias !104
  ...
  br i1 %252, label %polly.loop_exit842, label %vector.body1150, !llvm.loop !105
...
polly.loop_header840:                             ; preds = %polly.loop_header834, %polly.loop_header840
  ...
  store double %p_div12.i, double* %scevgep846847, align 8, !alias.scope !101, !noalias !104
  %polly.indvar_next844 = add nuw nsw i64 %polly.indvar843, 1
  %exitcond1086.not = icmp eq i64 %polly.indvar843, %236
  br i1 %exitcond1086.not, label %polly.loop_exit842, label %polly.loop_header840, !llvm.loop !106
...
vector.body1168:                                  ; preds = %vector.body1168, %vector.ph1171
  ...
  store <4 x double> %275, <4 x double>* %280, align 8, !alias.scope !100, !noalias !107
  ...
  br i1 %281, label %polly.loop_exit868, label %vector.body1168, !llvm.loop !108
...
polly.loop_header866:                             ; preds = %polly.loop_header860, %polly.loop_header866
  ...
  store double %p_div.i, double* %scevgep873874, align 8, !alias.scope !100, !noalias !107
  %polly.indvar_next870 = add nuw nsw i64 %polly.indvar869, 1
  %exitcond1076.not = icmp eq i64 %polly.indvar869, %265
  br i1 %exitcond1076.not, label %polly.loop_exit868, label %polly.loop_header866, !llvm.loop !109
}
