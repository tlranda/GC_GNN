; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10030.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10030.c"
...
polly.loop_header359:                             ; preds = %polly.loop_exit368, %polly.loop_header352
  ...
  %129 = shl nsw i64 %polly.indvar362, 2
...
polly.loop_header515:                             ; preds = %polly.loop_exit524, %polly.loop_header508
  ...
  %157 = shl nsw i64 %polly.indvar518, 2
...
polly.loop_header522:                             ; preds = %polly.loop_header522.preheader, %polly.loop_exit531
  ...
  %smin825 = call i64 @llvm.smin.i64(i64 %indvars.iv823, i64 3)
