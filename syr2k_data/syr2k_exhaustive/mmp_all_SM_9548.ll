; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9548.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9548.c"
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %123 = mul nsw i64 %polly.indvar355, -8
  %124 = shl nsw i64 %polly.indvar355, 3
...
polly.loop_exit360:                               ; preds = %polly.loop_exit367
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next356, 150
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %polly.loop_guard368 = icmp slt i64 %128, 8
...
polly.loop_exit374:                               ; preds = %polly.loop_exit381.loopexit.us, %polly.loop_header365
  ...
  %polly.loop_cond371 = icmp ult i64 %polly.indvar369, 7
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %149 = mul nsw i64 %polly.indvar510, -8
  %150 = shl nsw i64 %polly.indvar510, 3
...
polly.loop_exit515:                               ; preds = %polly.loop_exit522
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next511, 150
...
polly.loop_header513:                             ; preds = %polly.loop_exit522, %polly.loop_header507
  ...
  %polly.loop_guard523 = icmp slt i64 %154, 8
...
polly.loop_exit529:                               ; preds = %polly.loop_exit536.loopexit.us, %polly.loop_header520
  ...
  %polly.loop_cond526 = icmp ult i64 %polly.indvar524, 7
