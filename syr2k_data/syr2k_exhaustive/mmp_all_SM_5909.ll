; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5909.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5909.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar_next209, 75
...
polly.loop_exit405:                               ; preds = %polly.loop_exit411
  ...
  %indvars.iv.next883 = add nuw nsw i64 %indvars.iv882, 16
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, -16
  %exitcond898.not = icmp eq i64 %polly.indvar_next384, 75
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  ...
  %smin893 = call i64 @llvm.smin.i64(i64 %indvars.iv891, i64 15)
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %indvars.iv.next910 = add nuw nsw i64 %indvars.iv909, 16
  %indvars.iv.next915 = add nsw i64 %indvars.iv914, -16
  %exitcond925.not = icmp eq i64 %polly.indvar_next562, 75
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  ...
  %smin920 = call i64 @llvm.smin.i64(i64 %indvars.iv918, i64 15)
