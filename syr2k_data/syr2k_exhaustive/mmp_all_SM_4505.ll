; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4505.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4505.c"
...
vector.body1190:                                  ; preds = %vector.body1190, %vector.ph1192
  ...
  br i1 %57, label %middle.block1188, label %vector.body1190, !llvm.loop !55
...
vector.body1216:                                  ; preds = %vector.body1216, %vector.ph1218
  ...
  br i1 %68, label %middle.block1214, label %vector.body1216, !llvm.loop !57
...
vector.body1228:                                  ; preds = %vector.body1228, %vector.ph1232
  ...
  %wide.load1239 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  ...
  br i1 %95, label %middle.block1226, label %vector.body1228, !llvm.loop !69
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin989 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -984)
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin987 = call i64 @llvm.smin.i64(i64 %indvars.iv981, i64 63)
...
vector.body1202:                                  ; preds = %vector.body1202, %vector.ph1206
  ...
  %wide.load1213 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %127, label %middle.block1200, label %vector.body1202, !llvm.loop !80
...
polly.loop_header371:                             ; preds = %polly.loop_header371.preheader, %polly.loop_header371
  ...
  br i1 %exitcond1025.not, label %polly.loop_exit373, label %polly.loop_header371, !llvm.loop !81
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %129 = lshr i64 %polly.indvar384, 1
  %smin1020 = call i64 @llvm.smin.i64(i64 %indvars.iv1018, i64 -1168)
  %130 = shl nsw i64 %polly.indvar384, 5
...
polly.loop_exit389:                               ; preds = %polly.loop_exit396
  ...
  %exitcond1024.not = icmp eq i64 %polly.indvar_next385, 38
...
polly.loop_header387:                             ; preds = %polly.loop_exit396, %polly.loop_header381
  ...
  %smin1016 = call i64 @llvm.smin.i64(i64 %indvars.iv1000, i64 -984)
  %132 = add nsw i64 %smin1016, 1000
  %133 = shl nsw i64 %polly.indvar390, 4
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next391, 63
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header387
  ...
  %134 = shl nsw i64 %polly.indvar397, 6
  %135 = sub nsw i64 %130, %134
  %136 = add nuw nsw i64 %134, 64
...
polly.start468:                                   ; preds = %init_array.exit
  %malloccall470 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
vector.body1178:                                  ; preds = %vector.body1178, %vector.ph1180
  ...
  %wide.load1187 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %159, label %middle.block1176, label %vector.body1178, !llvm.loop !90
...
polly.loop_header560:                             ; preds = %polly.loop_header560.preheader, %polly.loop_header560
  ...
  br i1 %exitcond1052.not, label %polly.loop_exit562, label %polly.loop_header560, !llvm.loop !91
...
polly.loop_header576:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %smin1043 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 -984)
  %164 = add nsw i64 %smin1043, 1000
  %165 = shl nsw i64 %polly.indvar579, 4
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar_next580, 63
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header576
  ...
  %166 = shl nsw i64 %polly.indvar586, 6
  %167 = sub nsw i64 %162, %166
  %168 = add nuw nsw i64 %166, 64
...
polly.loop_header589:                             ; preds = %polly.loop_exit626, %polly.loop_header583
  ...
  %smin1041 = call i64 @llvm.smin.i64(i64 %indvars.iv1035, i64 63)
...
vector.body1117:                                  ; preds = %vector.body1117, %vector.ph1118
  ...
  br i1 %205, label %polly.loop_exit801, label %vector.body1117, !llvm.loop !99
...
polly.loop_header799:                             ; preds = %polly.loop_header793, %polly.loop_header799
  ...
  br i1 %exitcond1077.not, label %polly.loop_exit801, label %polly.loop_header799, !llvm.loop !100
...
vector.body1131:                                  ; preds = %vector.body1131, %vector.ph1134
  ...
  br i1 %234, label %polly.loop_exit828, label %vector.body1131, !llvm.loop !102
...
polly.loop_header826:                             ; preds = %polly.loop_header820, %polly.loop_header826
  ...
  br i1 %exitcond1067.not, label %polly.loop_exit828, label %polly.loop_header826, !llvm.loop !103
...
vector.body1149:                                  ; preds = %vector.body1149, %vector.ph1152
  ...
  br i1 %263, label %polly.loop_exit854, label %vector.body1149, !llvm.loop !105
...
polly.loop_header852:                             ; preds = %polly.loop_header846, %polly.loop_header852
  ...
  br i1 %exitcond1057.not, label %polly.loop_exit854, label %polly.loop_header852, !llvm.loop !106
}
