; ModuleID = 'syr2k_exhaustive/mmp_all_XL_233.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_233.c"
...
polly.loop_exit208:                               ; preds = %polly.loop_exit214
  ...
  %122 = shl nuw nsw i64 %polly.indvar203, 1
  br label %polly.loop_header222

polly.loop_exit224:                               ; preds = %polly.loop_exit261
  %polly.indvar_next204 = add nuw nsw i64 %polly.indvar203, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -16
  %exitcond951.not = icmp eq i64 %polly.indvar_next204, 75
...
polly.loop_header222:                             ; preds = %polly.loop_exit261, %polly.loop_exit208
  ...
  %smin1957 = call i64 @llvm.smin.i64(i64 %124, i64 15)
  ...
  %smin1940 = call i64 @llvm.smin.i64(i64 %129, i64 15)
  ...
  %133 = or i64 %132, 1
  %smin1921 = call i64 @llvm.smin.i64(i64 %133, i64 15)
  ...
  %139 = or i64 %138, 1
  %smin1904 = call i64 @llvm.smin.i64(i64 %139, i64 15)
  ...
  %143 = or i64 %142, 2
  %smin1885 = call i64 @llvm.smin.i64(i64 %143, i64 15)
  ...
  %149 = or i64 %148, 2
  %smin1868 = call i64 @llvm.smin.i64(i64 %149, i64 15)
  ...
  %153 = or i64 %152, 3
  %smin1849 = call i64 @llvm.smin.i64(i64 %153, i64 15)
  ...
  %158 = or i64 %157, 3
  %smin1832 = call i64 @llvm.smin.i64(i64 %158, i64 15)
  ...
  %162 = or i64 %161, 4
  %smin1813 = call i64 @llvm.smin.i64(i64 %162, i64 15)
  ...
  %168 = or i64 %167, 4
  %smin1802 = call i64 @llvm.smin.i64(i64 %168, i64 15)
  ...
  %172 = or i64 %171, 5
  %smin1783 = call i64 @llvm.smin.i64(i64 %172, i64 15)
  ...
  %178 = or i64 %177, 5
  %smin1772 = call i64 @llvm.smin.i64(i64 %178, i64 15)
  ...
  %182 = or i64 %181, 6
  %smin1753 = call i64 @llvm.smin.i64(i64 %182, i64 15)
  ...
  %188 = or i64 %187, 6
  %smin1742 = call i64 @llvm.smin.i64(i64 %188, i64 15)
  ...
  %192 = or i64 %191, 7
  %smin1723 = call i64 @llvm.smin.i64(i64 %192, i64 15)
  ...
  %197 = or i64 %196, 7
  %smin1712 = call i64 @llvm.smin.i64(i64 %197, i64 15)
  ...
  %.inv = icmp ugt i64 %201, 15
  %203 = select i1 %.inv, i64 15, i64 %202
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_exit426
  ...
  %298 = mul nuw nsw i64 %polly.indvar405, 153728
  %299 = or i64 %298, 8
  %300 = mul nuw nsw i64 %polly.indvar405, 153728
  %301 = add nuw i64 %300, 9600
  %302 = add nuw i64 %300, 9608
  %303 = mul nuw nsw i64 %polly.indvar405, 153728
  %304 = add nuw i64 %303, 19200
  %305 = add nuw i64 %303, 19208
  %306 = mul nuw nsw i64 %polly.indvar405, 153728
  %307 = add nuw i64 %306, 28800
  %308 = add nuw i64 %306, 28808
  %309 = mul nuw nsw i64 %polly.indvar405, 153728
  %310 = add nuw i64 %309, 38400
  %311 = add nuw i64 %309, 38408
  %312 = mul nuw nsw i64 %polly.indvar405, 153728
  %313 = add nuw i64 %312, 48000
  %314 = add nuw i64 %312, 48008
  %315 = mul nuw nsw i64 %polly.indvar405, 153728
  %316 = add nuw i64 %315, 57600
  %317 = add nuw i64 %315, 57608
  %318 = mul nuw nsw i64 %polly.indvar405, 153728
  %319 = add nuw i64 %318, 67200
  %320 = add nuw i64 %318, 67208
  %321 = shl nsw i64 %polly.indvar405, 4
  br label %polly.loop_header408

polly.loop_exit410:                               ; preds = %polly.loop_exit416
  %322 = mul nsw i64 %polly.indvar405, -16
  %323 = shl nuw nsw i64 %polly.indvar405, 1
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit465
  %polly.indvar_next406 = add nuw nsw i64 %polly.indvar405, 1
  %indvars.iv.next955 = add nsw i64 %indvars.iv954, -16
  %exitcond970.not = icmp eq i64 %polly.indvar_next406, 75
...
polly.loop_header424:                             ; preds = %polly.loop_exit465, %polly.loop_exit410
  ...
  %smin1665 = call i64 @llvm.smin.i64(i64 %325, i64 15)
  ...
  %smin1648 = call i64 @llvm.smin.i64(i64 %330, i64 15)
  ...
  %334 = or i64 %333, 1
  %smin1629 = call i64 @llvm.smin.i64(i64 %334, i64 15)
  ...
  %340 = or i64 %339, 1
  %smin1612 = call i64 @llvm.smin.i64(i64 %340, i64 15)
  ...
  %344 = or i64 %343, 2
  %smin1593 = call i64 @llvm.smin.i64(i64 %344, i64 15)
  ...
  %350 = or i64 %349, 2
  %smin1576 = call i64 @llvm.smin.i64(i64 %350, i64 15)
  ...
  %354 = or i64 %353, 3
  %smin1557 = call i64 @llvm.smin.i64(i64 %354, i64 15)
  ...
  %359 = or i64 %358, 3
  %smin1540 = call i64 @llvm.smin.i64(i64 %359, i64 15)
  ...
  %363 = or i64 %362, 4
  %smin1521 = call i64 @llvm.smin.i64(i64 %363, i64 15)
  ...
  %369 = or i64 %368, 4
  %smin1510 = call i64 @llvm.smin.i64(i64 %369, i64 15)
  ...
  %373 = or i64 %372, 5
  %smin1491 = call i64 @llvm.smin.i64(i64 %373, i64 15)
  ...
  %379 = or i64 %378, 5
  %smin1480 = call i64 @llvm.smin.i64(i64 %379, i64 15)
  ...
  %383 = or i64 %382, 6
  %smin1461 = call i64 @llvm.smin.i64(i64 %383, i64 15)
  ...
  %389 = or i64 %388, 6
  %smin1450 = call i64 @llvm.smin.i64(i64 %389, i64 15)
  ...
  %393 = or i64 %392, 7
  %smin1431 = call i64 @llvm.smin.i64(i64 %393, i64 15)
  ...
  %398 = or i64 %397, 7
  %smin1420 = call i64 @llvm.smin.i64(i64 %398, i64 15)
  ...
  %.inv910 = icmp ugt i64 %402, 15
  %404 = select i1 %.inv910, i64 15, i64 %403
...
polly.loop_header606:                             ; preds = %polly.loop_header606.preheader, %polly.loop_exit630
  ...
  %499 = mul nuw nsw i64 %polly.indvar609, 153728
  %500 = or i64 %499, 8
  %501 = mul nuw nsw i64 %polly.indvar609, 153728
  %502 = add nuw i64 %501, 9600
  %503 = add nuw i64 %501, 9608
  %504 = mul nuw nsw i64 %polly.indvar609, 153728
  %505 = add nuw i64 %504, 19200
  %506 = add nuw i64 %504, 19208
  %507 = mul nuw nsw i64 %polly.indvar609, 153728
  %508 = add nuw i64 %507, 28800
  %509 = add nuw i64 %507, 28808
  %510 = mul nuw nsw i64 %polly.indvar609, 153728
  %511 = add nuw i64 %510, 38400
  %512 = add nuw i64 %510, 38408
  %513 = mul nuw nsw i64 %polly.indvar609, 153728
  %514 = add nuw i64 %513, 48000
  %515 = add nuw i64 %513, 48008
  %516 = mul nuw nsw i64 %polly.indvar609, 153728
  %517 = add nuw i64 %516, 57600
  %518 = add nuw i64 %516, 57608
  %519 = mul nuw nsw i64 %polly.indvar609, 153728
  %520 = add nuw i64 %519, 67200
  %521 = add nuw i64 %519, 67208
  %522 = shl nsw i64 %polly.indvar609, 4
  br label %polly.loop_header612

polly.loop_exit614:                               ; preds = %polly.loop_exit620
  %523 = mul nsw i64 %polly.indvar609, -16
  %524 = shl nuw nsw i64 %polly.indvar609, 1
...
polly.loop_exit630:                               ; preds = %polly.loop_exit669
  ...
  %indvars.iv.next974 = add nsw i64 %indvars.iv973, -16
  %exitcond989.not = icmp eq i64 %polly.indvar_next610, 75
...
polly.loop_header628:                             ; preds = %polly.loop_exit669, %polly.loop_exit614
  ...
  %smin1373 = call i64 @llvm.smin.i64(i64 %526, i64 15)
  ...
  %smin1356 = call i64 @llvm.smin.i64(i64 %531, i64 15)
  ...
  %535 = or i64 %534, 1
  %smin1337 = call i64 @llvm.smin.i64(i64 %535, i64 15)
  ...
  %541 = or i64 %540, 1
  %smin1320 = call i64 @llvm.smin.i64(i64 %541, i64 15)
  ...
  %545 = or i64 %544, 2
  %smin1301 = call i64 @llvm.smin.i64(i64 %545, i64 15)
  ...
  %551 = or i64 %550, 2
  %smin1284 = call i64 @llvm.smin.i64(i64 %551, i64 15)
  ...
  %555 = or i64 %554, 3
  %smin1265 = call i64 @llvm.smin.i64(i64 %555, i64 15)
  ...
  %560 = or i64 %559, 3
  %smin1249 = call i64 @llvm.smin.i64(i64 %560, i64 15)
  ...
  %564 = or i64 %563, 4
  %smin1230 = call i64 @llvm.smin.i64(i64 %564, i64 15)
  ...
  %570 = or i64 %569, 4
  %smin1219 = call i64 @llvm.smin.i64(i64 %570, i64 15)
  ...
  %574 = or i64 %573, 5
  %smin1200 = call i64 @llvm.smin.i64(i64 %574, i64 15)
  ...
  %580 = or i64 %579, 5
  %smin1189 = call i64 @llvm.smin.i64(i64 %580, i64 15)
  ...
  %584 = or i64 %583, 6
  %smin1170 = call i64 @llvm.smin.i64(i64 %584, i64 15)
  ...
  %590 = or i64 %589, 6
  %smin1159 = call i64 @llvm.smin.i64(i64 %590, i64 15)
  ...
  %594 = or i64 %593, 7
  %smin1140 = call i64 @llvm.smin.i64(i64 %594, i64 15)
  ...
  %599 = or i64 %598, 7
  %smin1129 = call i64 @llvm.smin.i64(i64 %599, i64 15)
  ...
  %.inv911 = icmp ugt i64 %603, 15
  %605 = select i1 %.inv911, i64 15, i64 %604
