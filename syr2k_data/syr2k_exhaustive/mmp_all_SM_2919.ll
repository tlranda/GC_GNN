; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2919.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2919.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %.inv = icmp ugt i64 %116, 31
  %118 = select i1 %.inv, i64 31, i64 %117
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %207 = mul nsw i64 %polly.indvar586, -32
  %208 = shl nsw i64 %polly.indvar586, 5
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %210, 31
  %212 = select i1 %.inv870, i64 31, i64 %211
