; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10050.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10050.c"
...
polly.loop_header205.us:                          ; preds = %polly.loop_header199, %polly.loop_exit213.loopexit.us
  ...
  %109 = or i64 %108, 8
  %110 = shl i64 %polly.indvar208.us, 5
  %111 = or i64 %110, 16
  %112 = or i64 %106, 24
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %113 = mul nsw i64 %polly.indvar214.us, 80
  %114 = add nsw i64 %113, %101
  %115 = icmp sgt i64 %114, 0
  %116 = select i1 %115, i64 %114, i64 0
  %polly.loop_guard221.not.us = icmp sgt i64 %116, %104
...
polly.loop_header218.us:                          ; preds = %polly.loop_header218.preheader.us, %polly.loop_exit227.us
  %indvars.iv901 = phi i64 [ %122, %polly.loop_header218.preheader.us ], [ %indvars.iv.next902, %polly.loop_exit227.us ]
  %polly.indvar222.us = phi i64 [ %116, %polly.loop_header218.preheader.us ], [ %polly.indvar_next223.us, %polly.loop_exit227.us ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv901, i64 79)
  %117 = add nsw i64 %polly.indvar222.us, %123
  %polly.loop_guard235.us981 = icmp sgt i64 %117, -1
  %118 = add nuw nsw i64 %polly.indvar222.us, %105
...
polly.loop_header218.preheader.us:                ; preds = %polly.loop_header211.us
  ...
  %122 = add i64 %smax, %indvars.iv899
  %123 = sub nsw i64 %105, %113
...
polly.loop_exit234.loopexit.us.us:                ; preds = %polly.loop_header232.us.us
  %124 = add i64 %109, %119
  %scevgep242.us.us.1 = getelementptr i8, i8* %call2, i64 %124
  ...
  %scevgep248.us.us.1 = getelementptr i8, i8* %call1, i64 %124
...
polly.loop_header232.us.us:                       ; preds = %polly.loop_header232.us.us, %polly.loop_header225.us.us.preheader
  ...
  %125 = add nuw nsw i64 %polly.indvar236.us.us, %113
  %126 = mul i64 %125, 8000
  %127 = add i64 %126, %107
  %scevgep239.us.us = getelementptr i8, i8* %call1, i64 %127
  ...
  %scevgep245.us.us = getelementptr i8, i8* %call2, i64 %127
  ...
  %128 = shl i64 %125, 3
  %129 = add i64 %128, %120
  %scevgep251.us.us = getelementptr i8, i8* %call, i64 %129
...
vector.body1096:                                  ; preds = %vector.body1096, %vector.ph1100
  ...
  %132 = shl nuw nsw i64 %index1103, 3
  %133 = getelementptr i8, i8* %scevgep352, i64 %132
  %134 = bitcast i8* %133 to <4 x double>*
  %wide.load1107 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !69, !noalias !71
  %135 = fmul fast <4 x double> %wide.load1107, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %136 = bitcast i8* %133 to <4 x double>*
  store <4 x double> %135, <4 x double>* %136, align 8, !alias.scope !69, !noalias !71
  %index.next1104 = add i64 %index1103, 4
  %137 = icmp eq i64 %index.next1104, %n.vec1102
  br i1 %137, label %middle.block1094, label %vector.body1096, !llvm.loop !74

middle.block1094:                                 ; preds = %vector.body1096
  %cmp.n1106 = icmp eq i64 %130, %n.vec1102
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %139 = add nuw nsw i64 %polly.indvar359, 6
  %pexp.p_div_q368 = udiv i64 %139, 5
  %140 = sub nsw i64 %polly.indvar359, %pexp.p_div_q368
  %141 = add nsw i64 %140, 1
  %.inv780 = icmp slt i64 %140, 14
  %142 = select i1 %.inv780, i64 %141, i64 14
  %polly.loop_guard373 = icmp sgt i64 %142, -1
  %143 = mul nsw i64 %polly.indvar359, -64
  %144 = icmp slt i64 %143, -1136
  %145 = select i1 %144, i64 %143, i64 -1136
  %146 = add nsw i64 %145, 1199
  %147 = shl nsw i64 %polly.indvar359, 6
...
polly.loop_header362.us:                          ; preds = %polly.loop_header356, %polly.loop_exit372.loopexit.us
  ...
  %148 = shl i64 %polly.indvar365.us, 5
  %149 = shl i64 %polly.indvar365.us, 5
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %155 = mul nsw i64 %polly.indvar374.us, 80
  %156 = add nsw i64 %155, %143
  %157 = icmp sgt i64 %156, 0
  %158 = select i1 %157, i64 %156, i64 0
  %polly.loop_guard381.not.us = icmp sgt i64 %158, %146
...
polly.loop_header378.us:                          ; preds = %polly.loop_header378.preheader.us, %polly.loop_exit387.us
  %indvars.iv918 = phi i64 [ %164, %polly.loop_header378.preheader.us ], [ %indvars.iv.next919, %polly.loop_exit387.us ]
  %polly.indvar382.us = phi i64 [ %158, %polly.loop_header378.preheader.us ], [ %polly.indvar_next383.us, %polly.loop_exit387.us ]
  %smin920 = call i64 @llvm.smin.i64(i64 %indvars.iv918, i64 79)
  %159 = add nsw i64 %polly.indvar382.us, %165
  %polly.loop_guard395.us982 = icmp sgt i64 %159, -1
  %160 = add nuw nsw i64 %polly.indvar382.us, %147
...
polly.loop_header385.us.us.preheader:             ; preds = %polly.loop_header378.us
  %163 = add i64 %149, %161
  %scevgep402.us.us = getelementptr i8, i8* %call2, i64 %163
  ...
  %scevgep408.us.us = getelementptr i8, i8* %call1, i64 %163
...
polly.loop_exit387.us:                            ; preds = %polly.loop_header392.us.us.3, %polly.loop_header378.us
  ...
  %polly.loop_cond384.not.not.us = icmp ult i64 %polly.indvar382.us, %146
...
polly.loop_exit380.us:                            ; preds = %polly.loop_exit387.us, %polly.loop_header370.us
  ...
  %exitcond923.not = icmp eq i64 %polly.indvar374.us, %142
...
polly.loop_header378.preheader.us:                ; preds = %polly.loop_header370.us
  ...
  %164 = add i64 %smax913, %indvars.iv916
  %165 = sub nsw i64 %147, %155
...
polly.loop_exit394.loopexit.us.us:                ; preds = %polly.loop_header392.us.us
  %166 = add i64 %151, %161
  %scevgep402.us.us.1 = getelementptr i8, i8* %call2, i64 %166
  ...
  %scevgep408.us.us.1 = getelementptr i8, i8* %call1, i64 %166
...
polly.loop_header392.us.us:                       ; preds = %polly.loop_header392.us.us, %polly.loop_header385.us.us.preheader
  ...
  %167 = add nuw nsw i64 %polly.indvar396.us.us, %155
  %168 = mul i64 %167, 8000
  %169 = add i64 %168, %149
  %scevgep399.us.us = getelementptr i8, i8* %call1, i64 %169
  ...
  %scevgep405.us.us = getelementptr i8, i8* %call2, i64 %169
  ...
  %170 = shl i64 %167, 3
  %171 = add i64 %170, %162
  %scevgep411.us.us = getelementptr i8, i8* %call, i64 %171
...
polly.loop_header500:                             ; preds = %init_array.exit, %polly.loop_exit508
  ...
  %min.iters.check1073 = icmp ult i64 %172, 4
...
vector.body1072:                                  ; preds = %vector.body1072, %vector.ph1074
  ...
  %174 = shl nuw nsw i64 %index1077, 3
  %175 = getelementptr i8, i8* %scevgep512, i64 %174
  %176 = bitcast i8* %175 to <4 x double>*
  %wide.load1081 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !78, !noalias !80
  %177 = fmul fast <4 x double> %wide.load1081, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %179 = icmp eq i64 %index.next1078, %n.vec1076
  br i1 %179, label %middle.block1070, label %vector.body1072, !llvm.loop !83

middle.block1070:                                 ; preds = %vector.body1072
  %cmp.n1080 = icmp eq i64 %172, %n.vec1076
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %181 = add nuw nsw i64 %polly.indvar519, 6
  %pexp.p_div_q528 = udiv i64 %181, 5
  %182 = sub nsw i64 %polly.indvar519, %pexp.p_div_q528
  %183 = add nsw i64 %182, 1
  %.inv781 = icmp slt i64 %182, 14
  %184 = select i1 %.inv781, i64 %183, i64 14
  %polly.loop_guard533 = icmp sgt i64 %184, -1
  %185 = mul nsw i64 %polly.indvar519, -64
  %186 = icmp slt i64 %185, -1136
  %187 = select i1 %186, i64 %185, i64 -1136
  %188 = add nsw i64 %187, 1199
  %189 = shl nsw i64 %polly.indvar519, 6
...
polly.loop_header522.us:                          ; preds = %polly.loop_header516, %polly.loop_exit532.loopexit.us
  ...
  %190 = shl i64 %polly.indvar525.us, 5
  %191 = shl i64 %polly.indvar525.us, 5
  %192 = shl i64 %polly.indvar525.us, 5
  %193 = or i64 %192, 8
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %197 = mul nsw i64 %polly.indvar534.us, 80
  %198 = add nsw i64 %197, %185
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %polly.loop_guard541.not.us = icmp sgt i64 %200, %188
...
polly.loop_header538.us:                          ; preds = %polly.loop_header538.preheader.us, %polly.loop_exit547.us
  %indvars.iv937 = phi i64 [ %206, %polly.loop_header538.preheader.us ], [ %indvars.iv.next938, %polly.loop_exit547.us ]
  %polly.indvar542.us = phi i64 [ %200, %polly.loop_header538.preheader.us ], [ %polly.indvar_next543.us, %polly.loop_exit547.us ]
  %smin939 = call i64 @llvm.smin.i64(i64 %indvars.iv937, i64 79)
  %201 = add nsw i64 %polly.indvar542.us, %207
  %polly.loop_guard555.us983 = icmp sgt i64 %201, -1
  %202 = add nuw nsw i64 %polly.indvar542.us, %189
  %203 = mul i64 %202, 8000
  %204 = mul i64 %202, 9600
...
polly.loop_header545.us.us.preheader:             ; preds = %polly.loop_header538.us
  %205 = add i64 %191, %203
  %scevgep562.us.us = getelementptr i8, i8* %call2, i64 %205
  ...
  %scevgep568.us.us = getelementptr i8, i8* %call1, i64 %205
...
polly.loop_exit547.us:                            ; preds = %polly.loop_header552.us.us.3, %polly.loop_header538.us
  ...
  %polly.loop_cond544.not.not.us = icmp ult i64 %polly.indvar542.us, %188
...
polly.loop_exit540.us:                            ; preds = %polly.loop_exit547.us, %polly.loop_header530.us
  ...
  %exitcond942.not = icmp eq i64 %polly.indvar534.us, %184
...
polly.loop_header538.preheader.us:                ; preds = %polly.loop_header530.us
  ...
  %206 = add i64 %smax932, %indvars.iv935
  %207 = sub nsw i64 %189, %197
...
polly.loop_exit554.loopexit.us.us:                ; preds = %polly.loop_header552.us.us
  %208 = add i64 %193, %203
  %scevgep562.us.us.1 = getelementptr i8, i8* %call2, i64 %208
  ...
  %scevgep568.us.us.1 = getelementptr i8, i8* %call1, i64 %208
...
polly.loop_header552.us.us:                       ; preds = %polly.loop_header552.us.us, %polly.loop_header545.us.us.preheader
  ...
  %209 = add nuw nsw i64 %polly.indvar556.us.us, %197
  %210 = mul i64 %209, 8000
  %211 = add i64 %210, %191
  %scevgep559.us.us = getelementptr i8, i8* %call1, i64 %211
  ...
  %scevgep565.us.us = getelementptr i8, i8* %call2, i64 %211
  ...
  %212 = shl i64 %209, 3
  %213 = add i64 %212, %204
  %scevgep571.us.us = getelementptr i8, i8* %call, i64 %213
...
polly.loop_header706:                             ; preds = %polly.loop_exit714, %polly.loop_header700
  ...
  %smin1011 = call i64 @llvm.smin.i64(i64 %216, i64 -1168)
  %217 = add nsw i64 %smin1011, 1200
  %smin969 = call i64 @llvm.smin.i64(i64 %indvars.iv967, i64 -1168)
  %218 = shl nsw i64 %polly.indvar709, 5
  %219 = add nsw i64 %smin969, 1199
...
vector.ph1012:                                    ; preds = %polly.loop_header712
  %broadcast.splatinsert1019 = insertelement <4 x i64> poison, i64 %218, i32 0
  %broadcast.splat1020 = shufflevector <4 x i64> %broadcast.splatinsert1019, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1021 = insertelement <4 x i32> poison, i32 %221, i32 0
...
vector.body1010:                                  ; preds = %vector.body1010, %vector.ph1012
  ...
  %223 = add nuw nsw <4 x i64> %vec.ind1017, %broadcast.splat1020
  %224 = trunc <4 x i64> %223 to <4 x i32>
  %225 = mul <4 x i32> %broadcast.splat1022, %224
  ...
  store <4 x double> %229, <4 x double>* %234, align 8, !alias.scope !87, !noalias !89
  %index.next1014 = add i64 %index1013, 4
  %vec.ind.next1018 = add <4 x i64> %vec.ind1017, <i64 4, i64 4, i64 4, i64 4>
  %235 = icmp eq i64 %index.next1014, %217
  br i1 %235, label %polly.loop_exit720, label %vector.body1010, !llvm.loop !92

polly.loop_exit720:                               ; preds = %vector.body1010, %polly.loop_header718
  %polly.indvar_next716 = add nuw nsw i64 %polly.indvar715, 1
  %exitcond974.not = icmp eq i64 %polly.indvar715, %215
...
polly.loop_header718:                             ; preds = %polly.loop_header712, %polly.loop_header718
  ...
  %exitcond970.not = icmp eq i64 %polly.indvar721, %219
...
polly.loop_header733:                             ; preds = %polly.loop_exit741, %polly.loop_header727
  ...
  %smin1026 = call i64 @llvm.smin.i64(i64 %245, i64 -968)
  %246 = add nsw i64 %smin1026, 1000
  %smin959 = call i64 @llvm.smin.i64(i64 %indvars.iv957, i64 -968)
  %247 = shl nsw i64 %polly.indvar736, 5
  %248 = add nsw i64 %smin959, 999
...
vector.body1025:                                  ; preds = %vector.body1025, %vector.ph1028
  ...
  %252 = add nuw nsw <4 x i64> %vec.ind1035, %broadcast.splat1038
  %253 = trunc <4 x i64> %252 to <4 x i32>
  %254 = mul <4 x i32> %broadcast.splat1040, %253
  ...
  store <4 x double> %258, <4 x double>* %263, align 8, !alias.scope !91, !noalias !94
  %index.next1032 = add i64 %index1031, 4
  %vec.ind.next1036 = add <4 x i64> %vec.ind1035, <i64 4, i64 4, i64 4, i64 4>
  %264 = icmp eq i64 %index.next1032, %246
  br i1 %264, label %polly.loop_exit747, label %vector.body1025, !llvm.loop !95

polly.loop_exit747:                               ; preds = %vector.body1025, %polly.loop_header745
  %polly.indvar_next743 = add nuw nsw i64 %polly.indvar742, 1
  %exitcond964.not = icmp eq i64 %polly.indvar742, %244
...
polly.loop_header745:                             ; preds = %polly.loop_header739, %polly.loop_header745
  ...
  %exitcond960.not = icmp eq i64 %polly.indvar748, %248
...
polly.loop_header759:                             ; preds = %polly.loop_exit767, %polly.loop_header753
  ...
  %smin1044 = call i64 @llvm.smin.i64(i64 %274, i64 -968)
  %275 = add nsw i64 %smin1044, 1000
  %smin949 = call i64 @llvm.smin.i64(i64 %indvars.iv947, i64 -968)
  %276 = shl nsw i64 %polly.indvar762, 5
  %277 = add nsw i64 %smin949, 999
...
vector.body1043:                                  ; preds = %vector.body1043, %vector.ph1046
  ...
  %281 = add nuw nsw <4 x i64> %vec.ind1053, %broadcast.splat1056
  %282 = trunc <4 x i64> %281 to <4 x i32>
  %283 = mul <4 x i32> %broadcast.splat1058, %282
  ...
  store <4 x double> %287, <4 x double>* %292, align 8, !alias.scope !90, !noalias !97
  %index.next1050 = add i64 %index1049, 4
  %vec.ind.next1054 = add <4 x i64> %vec.ind1053, <i64 4, i64 4, i64 4, i64 4>
  %293 = icmp eq i64 %index.next1050, %275
  br i1 %293, label %polly.loop_exit773, label %vector.body1043, !llvm.loop !98

polly.loop_exit773:                               ; preds = %vector.body1043, %polly.loop_header771
  %polly.indvar_next769 = add nuw nsw i64 %polly.indvar768, 1
  %exitcond954.not = icmp eq i64 %polly.indvar768, %273
...
polly.loop_header771:                             ; preds = %polly.loop_header765, %polly.loop_header771
  ...
  %exitcond950.not = icmp eq i64 %polly.indvar774, %277
...
polly.loop_header232.us.us.1:                     ; preds = %polly.loop_header232.us.us.1, %polly.loop_exit234.loopexit.us.us
  ...
  %301 = add nuw nsw i64 %polly.indvar236.us.us.1, %113
  %302 = mul i64 %301, 8000
  %303 = add i64 %302, %109
  %scevgep239.us.us.1 = getelementptr i8, i8* %call1, i64 %303
  ...
  %scevgep245.us.us.1 = getelementptr i8, i8* %call2, i64 %303
  ...
  %304 = shl i64 %301, 3
  %305 = add i64 %304, %120
  %scevgep251.us.us.1 = getelementptr i8, i8* %call, i64 %305
...
polly.loop_exit234.loopexit.us.us.1:              ; preds = %polly.loop_header232.us.us.1
  %306 = add i64 %111, %119
  %scevgep242.us.us.2 = getelementptr i8, i8* %call2, i64 %306
  ...
  %scevgep248.us.us.2 = getelementptr i8, i8* %call1, i64 %306
...
polly.loop_header232.us.us.2:                     ; preds = %polly.loop_header232.us.us.2, %polly.loop_exit234.loopexit.us.us.1
  ...
  %307 = add nuw nsw i64 %polly.indvar236.us.us.2, %113
  %308 = mul i64 %307, 8000
  %309 = add i64 %308, %111
  %scevgep239.us.us.2 = getelementptr i8, i8* %call1, i64 %309
  ...
  %scevgep245.us.us.2 = getelementptr i8, i8* %call2, i64 %309
  ...
  %310 = shl i64 %307, 3
  %311 = add i64 %310, %120
  %scevgep251.us.us.2 = getelementptr i8, i8* %call, i64 %311
...
polly.loop_exit234.loopexit.us.us.2:              ; preds = %polly.loop_header232.us.us.2
  %312 = add i64 %112, %119
  %scevgep242.us.us.3 = getelementptr i8, i8* %call2, i64 %312
  ...
  %scevgep248.us.us.3 = getelementptr i8, i8* %call1, i64 %312
...
polly.loop_header232.us.us.3:                     ; preds = %polly.loop_header232.us.us.3, %polly.loop_exit234.loopexit.us.us.2
  ...
  %313 = add nuw nsw i64 %polly.indvar236.us.us.3, %113
  %314 = mul i64 %313, 8000
  %315 = add i64 %314, %112
  %scevgep239.us.us.3 = getelementptr i8, i8* %call1, i64 %315
  ...
  %scevgep245.us.us.3 = getelementptr i8, i8* %call2, i64 %315
  ...
  %316 = shl i64 %313, 3
  %317 = add i64 %316, %120
  %scevgep251.us.us.3 = getelementptr i8, i8* %call, i64 %317
...
polly.loop_header392.us.us.1:                     ; preds = %polly.loop_header392.us.us.1, %polly.loop_exit394.loopexit.us.us
  ...
  %318 = add nuw nsw i64 %polly.indvar396.us.us.1, %155
  %319 = mul i64 %318, 8000
  %320 = add i64 %319, %151
  %scevgep399.us.us.1 = getelementptr i8, i8* %call1, i64 %320
  ...
  %scevgep405.us.us.1 = getelementptr i8, i8* %call2, i64 %320
  ...
  %321 = shl i64 %318, 3
  %322 = add i64 %321, %162
  %scevgep411.us.us.1 = getelementptr i8, i8* %call, i64 %322
...
polly.loop_exit394.loopexit.us.us.1:              ; preds = %polly.loop_header392.us.us.1
  %323 = add i64 %153, %161
  %scevgep402.us.us.2 = getelementptr i8, i8* %call2, i64 %323
  ...
  %scevgep408.us.us.2 = getelementptr i8, i8* %call1, i64 %323
...
polly.loop_header392.us.us.2:                     ; preds = %polly.loop_header392.us.us.2, %polly.loop_exit394.loopexit.us.us.1
  ...
  %324 = add nuw nsw i64 %polly.indvar396.us.us.2, %155
  %325 = mul i64 %324, 8000
  %326 = add i64 %325, %153
  %scevgep399.us.us.2 = getelementptr i8, i8* %call1, i64 %326
  ...
  %scevgep405.us.us.2 = getelementptr i8, i8* %call2, i64 %326
  ...
  %327 = shl i64 %324, 3
  %328 = add i64 %327, %162
  %scevgep411.us.us.2 = getelementptr i8, i8* %call, i64 %328
...
polly.loop_exit394.loopexit.us.us.2:              ; preds = %polly.loop_header392.us.us.2
  %329 = add i64 %154, %161
  %scevgep402.us.us.3 = getelementptr i8, i8* %call2, i64 %329
  ...
  %scevgep408.us.us.3 = getelementptr i8, i8* %call1, i64 %329
...
polly.loop_header392.us.us.3:                     ; preds = %polly.loop_header392.us.us.3, %polly.loop_exit394.loopexit.us.us.2
  ...
  %330 = add nuw nsw i64 %polly.indvar396.us.us.3, %155
  %331 = mul i64 %330, 8000
  %332 = add i64 %331, %154
  %scevgep399.us.us.3 = getelementptr i8, i8* %call1, i64 %332
  ...
  %scevgep405.us.us.3 = getelementptr i8, i8* %call2, i64 %332
  ...
  %333 = shl i64 %330, 3
  %334 = add i64 %333, %162
  %scevgep411.us.us.3 = getelementptr i8, i8* %call, i64 %334
...
polly.loop_header552.us.us.1:                     ; preds = %polly.loop_header552.us.us.1, %polly.loop_exit554.loopexit.us.us
  ...
  %335 = add nuw nsw i64 %polly.indvar556.us.us.1, %197
  %336 = mul i64 %335, 8000
  %337 = add i64 %336, %193
  %scevgep559.us.us.1 = getelementptr i8, i8* %call1, i64 %337
  ...
  %scevgep565.us.us.1 = getelementptr i8, i8* %call2, i64 %337
  ...
  %338 = shl i64 %335, 3
  %339 = add i64 %338, %204
  %scevgep571.us.us.1 = getelementptr i8, i8* %call, i64 %339
...
polly.loop_exit554.loopexit.us.us.1:              ; preds = %polly.loop_header552.us.us.1
  %340 = add i64 %195, %203
  %scevgep562.us.us.2 = getelementptr i8, i8* %call2, i64 %340
  ...
  %scevgep568.us.us.2 = getelementptr i8, i8* %call1, i64 %340
...
polly.loop_header552.us.us.2:                     ; preds = %polly.loop_header552.us.us.2, %polly.loop_exit554.loopexit.us.us.1
  ...
  %341 = add nuw nsw i64 %polly.indvar556.us.us.2, %197
  %342 = mul i64 %341, 8000
  %343 = add i64 %342, %195
  %scevgep559.us.us.2 = getelementptr i8, i8* %call1, i64 %343
  ...
  %scevgep565.us.us.2 = getelementptr i8, i8* %call2, i64 %343
  ...
  %344 = shl i64 %341, 3
  %345 = add i64 %344, %204
  %scevgep571.us.us.2 = getelementptr i8, i8* %call, i64 %345
...
polly.loop_exit554.loopexit.us.us.2:              ; preds = %polly.loop_header552.us.us.2
  %346 = add i64 %196, %203
  %scevgep562.us.us.3 = getelementptr i8, i8* %call2, i64 %346
  ...
  %scevgep568.us.us.3 = getelementptr i8, i8* %call1, i64 %346
...
polly.loop_header552.us.us.3:                     ; preds = %polly.loop_header552.us.us.3, %polly.loop_exit554.loopexit.us.us.2
  ...
  %347 = add nuw nsw i64 %polly.indvar556.us.us.3, %197
  %348 = mul i64 %347, 8000
  %349 = add i64 %348, %196
  %scevgep559.us.us.3 = getelementptr i8, i8* %call1, i64 %349
  ...
  %scevgep565.us.us.3 = getelementptr i8, i8* %call2, i64 %349
  ...
  %350 = shl i64 %347, 3
  %351 = add i64 %350, %204
  %scevgep571.us.us.3 = getelementptr i8, i8* %call, i64 %351
