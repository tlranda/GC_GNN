; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6611.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6611.c"
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next231, 10
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %138 = mul nuw nsw i64 %polly.indvar377, 80
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %139 = lshr i64 %polly.indvar383, 5
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418, %polly.loop_header403
  ...
  %indvars.iv.next885 = add i64 %indvars.iv884, -128
  %indvars.iv.next890 = add i64 %indvars.iv889, 128
  %exitcond897.not = icmp eq i64 %polly.indvar_next407, 10
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %178 = mul nuw nsw i64 %polly.indvar555, 80
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %179 = lshr i64 %polly.indvar561, 5
  %180 = shl nuw nsw i64 %179, 7
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596, %polly.loop_header581
  ...
  %indvars.iv.next917 = add i64 %indvars.iv916, 128
  %exitcond924.not = icmp eq i64 %polly.indvar_next585, 10
