; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8606.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8606.c"
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %polly.loop_guard383 = icmp slt i64 %147, 50
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  ...
  %180 = mul nuw nsw i64 %polly.indvar528, 50
  %181 = sub nsw i64 %177, %180
  %182 = icmp sgt i64 %181, 0
  %183 = select i1 %182, i64 %181, i64 0
  %polly.loop_guard541 = icmp slt i64 %183, 50
