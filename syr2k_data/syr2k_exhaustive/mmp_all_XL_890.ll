; ModuleID = 'syr2k_exhaustive/mmp_all_XL_890.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_890.c"
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next204, 50
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %103 = shl nsw i64 %polly.indvar209, 4
  %104 = or i64 %103, 1
...
polly.loop_exit220:                               ; preds = %polly.loop_header218
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next216, 20
...
polly.loop_exit253.us:                            ; preds = %polly.loop_header251.us
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next238.us, 20
...
polly.loop_exit253:                               ; preds = %polly.loop_header251
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next238, 20
...
polly.loop_exit273:                               ; preds = %polly.loop_header271
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next269, 20
...
polly.loop_exit292:                               ; preds = %polly.loop_exit299
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar_next288, 20
...
vector.body1383:                                  ; preds = %vector.body1383, %vector.ph1391
  ...
  %wide.load1404 = load <4 x double>, <4 x double>* %145, align 8, !alias.scope !72, !noalias !74
  ...
  store <4 x double> %148, <4 x double>* %149, align 8, !alias.scope !72, !noalias !74
  %index.next1395 = add i64 %index1394, 4
  %150 = icmp eq i64 %index.next1395, %n.vec1393
  br i1 %150, label %middle.block1381, label %vector.body1383, !llvm.loop !84
...
polly.loop_header297:                             ; preds = %polly.loop_header297.preheader1405, %polly.loop_header297
  ...
  br i1 %exitcond1054.not, label %polly.loop_exit299, label %polly.loop_header297, !llvm.loop !85

polly.start325:                                   ; preds = %kernel_syr2k.exit
  %malloccall327 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
  %malloccall329 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body1319:                                  ; preds = %vector.body1319, %vector.ph1323
  ...
  %wide.load1330 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %161, label %middle.block1317, label %vector.body1319, !llvm.loop !93
...
polly.loop_header419:                             ; preds = %polly.loop_header419.preheader, %polly.loop_header419
  ...
  br i1 %exitcond1092.not, label %polly.loop_exit421, label %polly.loop_header419, !llvm.loop !94
...
polly.loop_header429:                             ; preds = %polly.loop_header429.preheader, %polly.loop_exit437
  ...
  %163 = mul nuw nsw i64 %polly.indvar432, 20
...
polly.loop_exit437:                               ; preds = %polly.loop_exit459
  ...
  %exitcond1091.not = icmp eq i64 %polly.indvar_next433, 50
...
polly.loop_header435:                             ; preds = %polly.loop_exit459, %polly.loop_header429
  ...
  %164 = shl nuw nsw i64 %polly.indvar438, 4
  %165 = mul nsw i64 %polly.indvar438, -16
...
polly.loop_exit443:                               ; preds = %polly.loop_exit449
  ...
  %168 = mul nuw nsw i64 %polly.indvar438, 3
  %169 = shl nsw i64 %polly.indvar438, 4
  %170 = or i64 %169, 1
...
polly.loop_exit449:                               ; preds = %polly.loop_header447
  ...
  %exitcond1064.not = icmp eq i64 %polly.indvar_next445, 20
...
polly.loop_header467.preheader:                   ; preds = %polly.loop_header457
  %180 = mul nuw nsw i64 %polly.indvar460, 80
...
polly.loop_exit488.us:                            ; preds = %polly.loop_header486.us
  ...
  %exitcond1072.not = icmp eq i64 %polly.indvar_next471.us, 20
...
polly.loop_exit488:                               ; preds = %polly.loop_header486
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next471, 20
...
polly.loop_exit508:                               ; preds = %polly.loop_header506
  ...
  %exitcond1074.not = icmp eq i64 %polly.indvar_next504, 20
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond1088.not = icmp eq i64 %polly.indvar_next523, 20
...
vector.body1333:                                  ; preds = %vector.body1333, %vector.ph1341
  ...
  %wide.load1354 = load <4 x double>, <4 x double>* %211, align 8, !alias.scope !86, !noalias !88
  ...
  store <4 x double> %214, <4 x double>* %215, align 8, !alias.scope !86, !noalias !88
  %index.next1345 = add i64 %index1344, 4
  %216 = icmp eq i64 %index.next1345, %n.vec1343
  br i1 %216, label %middle.block1331, label %vector.body1333, !llvm.loop !97
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader1410, %polly.loop_header532
  ...
  br i1 %exitcond1087.not, label %polly.loop_exit534, label %polly.loop_header532, !llvm.loop !98

polly.start560:                                   ; preds = %init_array.exit
  %malloccall562 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
  %malloccall564 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body1271:                                  ; preds = %vector.body1271, %vector.ph1273
  ...
  %wide.load1280 = load <4 x double>, <4 x double>* %224, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %227, label %middle.block1269, label %vector.body1271, !llvm.loop !106
...
polly.loop_header654:                             ; preds = %polly.loop_header654.preheader, %polly.loop_header654
  ...
  br i1 %exitcond1125.not, label %polly.loop_exit656, label %polly.loop_header654, !llvm.loop !107
...
polly.loop_header664:                             ; preds = %polly.loop_header664.preheader, %polly.loop_exit672
  ...
  %229 = mul nuw nsw i64 %polly.indvar667, 20
...
polly.loop_exit672:                               ; preds = %polly.loop_exit694
  ...
  %exitcond1124.not = icmp eq i64 %polly.indvar_next668, 50
...
polly.loop_header670:                             ; preds = %polly.loop_exit694, %polly.loop_header664
  ...
  %230 = shl nuw nsw i64 %polly.indvar673, 4
  %231 = mul nsw i64 %polly.indvar673, -16
...
polly.loop_exit678:                               ; preds = %polly.loop_exit684
  ...
  %234 = mul nuw nsw i64 %polly.indvar673, 3
  %235 = shl nsw i64 %polly.indvar673, 4
  %236 = or i64 %235, 1
...
polly.loop_exit684:                               ; preds = %polly.loop_header682
  ...
  %exitcond1097.not = icmp eq i64 %polly.indvar_next680, 20
...
polly.loop_header702.preheader:                   ; preds = %polly.loop_header692
  %246 = mul nuw nsw i64 %polly.indvar695, 80
...
polly.loop_exit723.us:                            ; preds = %polly.loop_header721.us
  ...
  %exitcond1105.not = icmp eq i64 %polly.indvar_next706.us, 20
...
polly.loop_exit723:                               ; preds = %polly.loop_header721
  ...
  %exitcond1098.not = icmp eq i64 %polly.indvar_next706, 20
...
polly.loop_exit743:                               ; preds = %polly.loop_header741
  ...
  %exitcond1107.not = icmp eq i64 %polly.indvar_next739, 20
...
polly.loop_exit762:                               ; preds = %polly.loop_exit769
  ...
  %exitcond1121.not = icmp eq i64 %polly.indvar_next758, 20
...
vector.body1283:                                  ; preds = %vector.body1283, %vector.ph1291
  ...
  %wide.load1304 = load <4 x double>, <4 x double>* %277, align 8, !alias.scope !99, !noalias !101
  ...
  store <4 x double> %280, <4 x double>* %281, align 8, !alias.scope !99, !noalias !101
  %index.next1295 = add i64 %index1294, 4
  %282 = icmp eq i64 %index.next1295, %n.vec1293
  br i1 %282, label %middle.block1281, label %vector.body1283, !llvm.loop !110
...
polly.loop_header767:                             ; preds = %polly.loop_header767.preheader1415, %polly.loop_header767
  ...
  br i1 %exitcond1120.not, label %polly.loop_exit769, label %polly.loop_header767, !llvm.loop !111
...
vector.body1209:                                  ; preds = %vector.body1209, %vector.ph1211
  ...
  br i1 %307, label %polly.loop_exit939, label %vector.body1209, !llvm.loop !117
...
polly.loop_header937:                             ; preds = %polly.loop_header931, %polly.loop_header937
  ...
  br i1 %exitcond1150.not, label %polly.loop_exit939, label %polly.loop_header937, !llvm.loop !118
...
vector.body1224:                                  ; preds = %vector.body1224, %vector.ph1227
  ...
  br i1 %336, label %polly.loop_exit966, label %vector.body1224, !llvm.loop !120
...
polly.loop_header964:                             ; preds = %polly.loop_header958, %polly.loop_header964
  ...
  br i1 %exitcond1140.not, label %polly.loop_exit966, label %polly.loop_header964, !llvm.loop !121
...
vector.body1242:                                  ; preds = %vector.body1242, %vector.ph1245
  ...
  br i1 %365, label %polly.loop_exit992, label %vector.body1242, !llvm.loop !123
...
polly.loop_header990:                             ; preds = %polly.loop_header984, %polly.loop_header990
  ...
  br i1 %exitcond1130.not, label %polly.loop_exit992, label %polly.loop_header990, !llvm.loop !124
}
