; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4404.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4404.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond1008.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !69
...
polly.loop_exit213:                               ; preds = %polly.loop_exit220, %polly.loop_header205
  ...
  %exitcond1006.not = icmp eq i64 %polly.indvar_next209, 32
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit220
  ...
  %polly.loop_guard221 = icmp slt i64 %108, 20
...
vector.body1222:                                  ; preds = %vector.body1222, %vector.ph1226
  ...
  %wide.load1233 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %134, label %middle.block1220, label %vector.body1222, !llvm.loop !79
...
polly.loop_header375:                             ; preds = %polly.loop_header375.preheader, %polly.loop_header375
  ...
  br i1 %exitcond1040.not, label %polly.loop_exit377, label %polly.loop_header375, !llvm.loop !80
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %140 = mul nsw i64 %polly.indvar388, -20
  %141 = mul nuw nsw i64 %polly.indvar388, 20
...
polly.loop_exit393:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1039.not = icmp eq i64 %polly.indvar_next389, 60
...
polly.loop_header391:                             ; preds = %polly.loop_exit401, %polly.loop_header385
  ...
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv1010, i64 -968)
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409, %polly.loop_header391
  ...
  %exitcond1038.not = icmp eq i64 %polly.indvar_next395, 32
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %polly.loop_guard410 = icmp slt i64 %147, 20
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit445
  ...
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1023, i64 31)
...
vector.body1198:                                  ; preds = %vector.body1198, %vector.ph1200
  ...
  br i1 %173, label %middle.block1196, label %vector.body1198, !llvm.loop !89
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %179 = mul nsw i64 %polly.indvar581, -20
...
polly.loop_exit586:                               ; preds = %polly.loop_exit594
  ...
  %exitcond1071.not = icmp eq i64 %polly.indvar_next582, 60
...
polly.loop_header584:                             ; preds = %polly.loop_exit594, %polly.loop_header578
  ...
  %smin1063 = call i64 @llvm.smin.i64(i64 %indvars.iv1042, i64 -968)
...
polly.loop_exit594:                               ; preds = %polly.loop_exit602, %polly.loop_header584
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar_next588, 32
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_exit638
  ...
  %smin1061 = call i64 @llvm.smin.i64(i64 %indvars.iv1055, i64 31)
...
vector.body1137:                                  ; preds = %vector.body1137, %vector.ph1138
  ...
  br i1 %226, label %polly.loop_exit813, label %vector.body1137, !llvm.loop !98
...
vector.body1151:                                  ; preds = %vector.body1151, %vector.ph1154
  ...
  br i1 %255, label %polly.loop_exit840, label %vector.body1151, !llvm.loop !101
...
vector.body1169:                                  ; preds = %vector.body1169, %vector.ph1172
  ...
  br i1 %284, label %polly.loop_exit866, label %vector.body1169, !llvm.loop !104
