; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4592.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4592.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %pexp.p_div_q867 = udiv i16 %pexp.p_div_q.lhs.trunc, 25
  %pexp.p_div_q.zext = zext i16 %pexp.p_div_q867 to i64
...
polly.loop_exit207:                               ; preds = %polly.loop_exit214, %polly.loop_header199
  ...
  %indvars.iv.next979 = add nuw nsw i64 %indvars.iv978, 32
  %exitcond990.not = icmp eq i64 %polly.indvar_next203, 38
...
polly.loop_exit214:                               ; preds = %polly.loop_exit246, %polly.loop_header205
  ...
  %indvars.iv.next977 = add i64 %indvars.iv976, 50
  %indvars.iv.next981 = add i64 %indvars.iv980, -50
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit246
  ...
  %smin986 = call i64 @llvm.smin.i64(i64 %indvars.iv982, i64 49)
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit391
  ...
  %133 = trunc i64 %polly.indvar384 to i16
  %134 = mul i16 %133, 9
  %pexp.p_div_q387.lhs.trunc = add i16 %134, 34
  %pexp.p_div_q387866 = udiv i16 %pexp.p_div_q387.lhs.trunc, 25
  %pexp.p_div_q387.zext = zext i16 %pexp.p_div_q387866 to i64
  %135 = sub nsw i64 %polly.indvar384, %pexp.p_div_q387.zext
  %136 = add nsw i64 %135, 1
  %.inv861 = icmp slt i64 %135, 23
  %137 = select i1 %.inv861, i64 %136, i64 23
...
polly.loop_exit391:                               ; preds = %polly.loop_exit399, %polly.loop_header381
  ...
  %indvars.iv.next995 = add nsw i64 %indvars.iv994, -32
  %indvars.iv.next1000 = add nuw nsw i64 %indvars.iv999, 32
  %exitcond1012.not = icmp eq i64 %polly.indvar_next385, 38
...
polly.loop_exit399:                               ; preds = %polly.loop_exit435, %polly.loop_header389
  ...
  %indvars.iv.next997 = add i64 %indvars.iv996, 50
  %indvars.iv.next1002 = add i64 %indvars.iv1001, -50
...
polly.loop_header397:                             ; preds = %polly.loop_header397.preheader, %polly.loop_exit435
  ...
  %smin1008 = call i64 @llvm.smin.i64(i64 %indvars.iv1003, i64 49)
...
polly.loop_header570:                             ; preds = %polly.loop_header570.preheader, %polly.loop_exit580
  ...
  %169 = trunc i64 %polly.indvar573 to i16
  %170 = mul i16 %169, 9
  %pexp.p_div_q576.lhs.trunc = add i16 %170, 34
  %pexp.p_div_q576865 = udiv i16 %pexp.p_div_q576.lhs.trunc, 25
  %pexp.p_div_q576.zext = zext i16 %pexp.p_div_q576865 to i64
  %171 = sub nsw i64 %polly.indvar573, %pexp.p_div_q576.zext
  %172 = add nsw i64 %171, 1
  %.inv863 = icmp slt i64 %171, 23
  %173 = select i1 %.inv863, i64 %172, i64 23
...
polly.loop_exit580:                               ; preds = %polly.loop_exit588, %polly.loop_header570
  ...
  %indvars.iv.next1022 = add nuw nsw i64 %indvars.iv1021, 32
  %exitcond1034.not = icmp eq i64 %polly.indvar_next574, 38
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit588
  ...
  %179 = mul nsw i64 %polly.indvar582, 50
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit624
  ...
  %smin1030 = call i64 @llvm.smin.i64(i64 %indvars.iv1025, i64 49)
