; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8588.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8588.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit193, %polly.loop_exit213
  ...
  %98 = mul nsw i64 %polly.indvar208, -32
...
polly.loop_header356:                             ; preds = %polly.loop_exit342, %polly.loop_exit364
  ...
  %117 = mul nsw i64 %polly.indvar359, -32
  %polly.loop_guard372859 = icmp sgt i64 %117, -1200
  %118 = shl nsw i64 %polly.indvar359, 5
...
polly.loop_header509:                             ; preds = %polly.loop_exit495, %polly.loop_exit517
  ...
  %136 = mul nsw i64 %polly.indvar512, -32
  %polly.loop_guard525864 = icmp sgt i64 %136, -1200
  %137 = shl nsw i64 %polly.indvar512, 5
...
polly.loop_header205.1:                           ; preds = %polly.loop_exit213, %polly.loop_exit213.1
  ...
  %polly.indvar208.1 = phi i64 [ %polly.indvar_next209.1, %polly.loop_exit213.1 ], [ 8, %polly.loop_exit213 ]
  %smin777.1 = call i64 @llvm.smin.i64(i64 %indvars.iv775.1, i64 -1168)
  %232 = add nsw i64 %smin777.1, 1199
  %smax.1 = call i64 @llvm.smax.i64(i64 %232, i64 0)
  %233 = mul nsw i64 %polly.indvar208.1, -32
  %polly.loop_guard.1855 = icmp sgt i64 %233, -1200
  %234 = shl nsw i64 %polly.indvar208.1, 5
...
polly.loop_exit213.1:                             ; preds = %polly.loop_exit219.loopexit.us.1, %polly.loop_header205.1
  ...
  %indvars.iv.next776.1 = add nsw i64 %indvars.iv775.1, -32
  %exitcond780.1.not = icmp eq i64 %polly.indvar_next209.1, 38
...
polly.loop_header205.2:                           ; preds = %polly.loop_exit213.1, %polly.loop_exit213.2
  ...
  %polly.indvar208.2 = phi i64 [ %polly.indvar_next209.2, %polly.loop_exit213.2 ], [ 16, %polly.loop_exit213.1 ]
  %smin777.2 = call i64 @llvm.smin.i64(i64 %indvars.iv775.2, i64 -1168)
  %243 = add nsw i64 %smin777.2, 1199
  %smax.2 = call i64 @llvm.smax.i64(i64 %243, i64 0)
  %244 = mul nsw i64 %polly.indvar208.2, -32
  %polly.loop_guard.2856 = icmp sgt i64 %244, -1200
  %245 = shl nsw i64 %polly.indvar208.2, 5
...
polly.loop_exit213.2:                             ; preds = %polly.loop_exit219.loopexit.us.2, %polly.loop_header205.2
  ...
  %indvars.iv.next776.2 = add nsw i64 %indvars.iv775.2, -32
  %exitcond780.2.not = icmp eq i64 %polly.indvar_next209.2, 38
...
polly.loop_header205.3:                           ; preds = %polly.loop_exit213.2, %polly.loop_exit213.3
  ...
  %polly.indvar208.3 = phi i64 [ %polly.indvar_next209.3, %polly.loop_exit213.3 ], [ 24, %polly.loop_exit213.2 ]
  %smin777.3 = call i64 @llvm.smin.i64(i64 %indvars.iv775.3, i64 -1168)
  %254 = add nsw i64 %smin777.3, 1199
  %smax.3 = call i64 @llvm.smax.i64(i64 %254, i64 0)
  %255 = mul nsw i64 %polly.indvar208.3, -32
  %polly.loop_guard.3857 = icmp sgt i64 %255, -1200
  %256 = shl nsw i64 %polly.indvar208.3, 5
...
polly.loop_exit213.3:                             ; preds = %polly.loop_exit219.loopexit.us.3, %polly.loop_header205.3
  ...
  %indvars.iv.next776.3 = add nsw i64 %indvars.iv775.3, -32
  %exitcond780.3.not = icmp eq i64 %polly.indvar_next209.3, 38
...
polly.loop_header205.4:                           ; preds = %polly.loop_exit213.3, %polly.loop_exit213.4
  ...
  %polly.indvar208.4 = phi i64 [ %polly.indvar_next209.4, %polly.loop_exit213.4 ], [ 32, %polly.loop_exit213.3 ]
  %smin777.4 = call i64 @llvm.smin.i64(i64 %indvars.iv775.4, i64 -1168)
  %265 = add nsw i64 %smin777.4, 1199
  %smax.4 = call i64 @llvm.smax.i64(i64 %265, i64 0)
  %266 = mul nsw i64 %polly.indvar208.4, -32
  %polly.loop_guard.4858 = icmp sgt i64 %266, -1200
  %267 = shl nsw i64 %polly.indvar208.4, 5
...
polly.loop_exit213.4:                             ; preds = %polly.loop_exit219.loopexit.us.4, %polly.loop_header205.4
  ...
  %indvars.iv.next776.4 = add nsw i64 %indvars.iv775.4, -32
  %exitcond780.4.not = icmp eq i64 %polly.indvar_next209.4, 38
...
polly.loop_header356.1:                           ; preds = %polly.loop_exit364, %polly.loop_exit364.1
  ...
  %polly.indvar359.1 = phi i64 [ %polly.indvar_next360.1, %polly.loop_exit364.1 ], [ 8, %polly.loop_exit364 ]
  %smin794.1 = call i64 @llvm.smin.i64(i64 %indvars.iv792.1, i64 -1168)
  %276 = add nsw i64 %smin794.1, 1199
  %smax795.1 = call i64 @llvm.smax.i64(i64 %276, i64 0)
  %277 = mul nsw i64 %polly.indvar359.1, -32
  %polly.loop_guard372.1860 = icmp sgt i64 %277, -1200
  %278 = shl nsw i64 %polly.indvar359.1, 5
...
polly.loop_exit364.1:                             ; preds = %polly.loop_exit371.loopexit.us.1, %polly.loop_header356.1
  ...
  %indvars.iv.next785.1 = add nuw nsw i64 %indvars.iv784.1, 32
  %indvars.iv.next793.1 = add nsw i64 %indvars.iv792.1, -32
  %exitcond798.1.not = icmp eq i64 %polly.indvar_next360.1, 38
...
polly.loop_header356.2:                           ; preds = %polly.loop_exit364.1, %polly.loop_exit364.2
  ...
  %polly.indvar359.2 = phi i64 [ %polly.indvar_next360.2, %polly.loop_exit364.2 ], [ 16, %polly.loop_exit364.1 ]
  %smin794.2 = call i64 @llvm.smin.i64(i64 %indvars.iv792.2, i64 -1168)
  %287 = add nsw i64 %smin794.2, 1199
  %smax795.2 = call i64 @llvm.smax.i64(i64 %287, i64 0)
  %288 = mul nsw i64 %polly.indvar359.2, -32
  %polly.loop_guard372.2861 = icmp sgt i64 %288, -1200
  %289 = shl nsw i64 %polly.indvar359.2, 5
...
polly.loop_exit364.2:                             ; preds = %polly.loop_exit371.loopexit.us.2, %polly.loop_header356.2
  ...
  %indvars.iv.next785.2 = add nuw nsw i64 %indvars.iv784.2, 32
  %indvars.iv.next793.2 = add nsw i64 %indvars.iv792.2, -32
  %exitcond798.2.not = icmp eq i64 %polly.indvar_next360.2, 38
...
polly.loop_header356.3:                           ; preds = %polly.loop_exit364.2, %polly.loop_exit364.3
  ...
  %polly.indvar359.3 = phi i64 [ %polly.indvar_next360.3, %polly.loop_exit364.3 ], [ 24, %polly.loop_exit364.2 ]
  %smin794.3 = call i64 @llvm.smin.i64(i64 %indvars.iv792.3, i64 -1168)
  %298 = add nsw i64 %smin794.3, 1199
  %smax795.3 = call i64 @llvm.smax.i64(i64 %298, i64 0)
  %299 = mul nsw i64 %polly.indvar359.3, -32
  %polly.loop_guard372.3862 = icmp sgt i64 %299, -1200
  %300 = shl nsw i64 %polly.indvar359.3, 5
...
polly.loop_exit364.3:                             ; preds = %polly.loop_exit371.loopexit.us.3, %polly.loop_header356.3
  ...
  %indvars.iv.next785.3 = add nuw nsw i64 %indvars.iv784.3, 32
  %indvars.iv.next793.3 = add nsw i64 %indvars.iv792.3, -32
  %exitcond798.3.not = icmp eq i64 %polly.indvar_next360.3, 38
...
polly.loop_header356.4:                           ; preds = %polly.loop_exit364.3, %polly.loop_exit364.4
  ...
  %polly.indvar359.4 = phi i64 [ %polly.indvar_next360.4, %polly.loop_exit364.4 ], [ 32, %polly.loop_exit364.3 ]
  %smin794.4 = call i64 @llvm.smin.i64(i64 %indvars.iv792.4, i64 -1168)
  %309 = add nsw i64 %smin794.4, 1199
  %smax795.4 = call i64 @llvm.smax.i64(i64 %309, i64 0)
  %310 = mul nsw i64 %polly.indvar359.4, -32
  %polly.loop_guard372.4863 = icmp sgt i64 %310, -1200
  %311 = shl nsw i64 %polly.indvar359.4, 5
...
polly.loop_exit364.4:                             ; preds = %polly.loop_exit371.loopexit.us.4, %polly.loop_header356.4
  ...
  %indvars.iv.next785.4 = add nuw nsw i64 %indvars.iv784.4, 32
  %indvars.iv.next793.4 = add nsw i64 %indvars.iv792.4, -32
  %exitcond798.4.not = icmp eq i64 %polly.indvar_next360.4, 38
...
polly.loop_header509.1:                           ; preds = %polly.loop_exit517, %polly.loop_exit517.1
  ...
  %polly.indvar512.1 = phi i64 [ %polly.indvar_next513.1, %polly.loop_exit517.1 ], [ 8, %polly.loop_exit517 ]
  %smin812.1 = call i64 @llvm.smin.i64(i64 %indvars.iv810.1, i64 -1168)
  %320 = add nsw i64 %smin812.1, 1199
  %smax813.1 = call i64 @llvm.smax.i64(i64 %320, i64 0)
  %321 = mul nsw i64 %polly.indvar512.1, -32
  %polly.loop_guard525.1865 = icmp sgt i64 %321, -1200
  %322 = shl nsw i64 %polly.indvar512.1, 5
...
polly.loop_exit517.1:                             ; preds = %polly.loop_exit524.loopexit.us.1, %polly.loop_header509.1
  ...
  %indvars.iv.next803.1 = add nuw nsw i64 %indvars.iv802.1, 32
  %indvars.iv.next811.1 = add nsw i64 %indvars.iv810.1, -32
  %exitcond816.1.not = icmp eq i64 %polly.indvar_next513.1, 38
...
polly.loop_header509.2:                           ; preds = %polly.loop_exit517.1, %polly.loop_exit517.2
  ...
  %polly.indvar512.2 = phi i64 [ %polly.indvar_next513.2, %polly.loop_exit517.2 ], [ 16, %polly.loop_exit517.1 ]
  %smin812.2 = call i64 @llvm.smin.i64(i64 %indvars.iv810.2, i64 -1168)
  %331 = add nsw i64 %smin812.2, 1199
  %smax813.2 = call i64 @llvm.smax.i64(i64 %331, i64 0)
  %332 = mul nsw i64 %polly.indvar512.2, -32
  %polly.loop_guard525.2866 = icmp sgt i64 %332, -1200
  %333 = shl nsw i64 %polly.indvar512.2, 5
...
polly.loop_exit517.2:                             ; preds = %polly.loop_exit524.loopexit.us.2, %polly.loop_header509.2
  ...
  %indvars.iv.next803.2 = add nuw nsw i64 %indvars.iv802.2, 32
  %indvars.iv.next811.2 = add nsw i64 %indvars.iv810.2, -32
  %exitcond816.2.not = icmp eq i64 %polly.indvar_next513.2, 38
...
polly.loop_header509.3:                           ; preds = %polly.loop_exit517.2, %polly.loop_exit517.3
  ...
  %polly.indvar512.3 = phi i64 [ %polly.indvar_next513.3, %polly.loop_exit517.3 ], [ 24, %polly.loop_exit517.2 ]
  %smin812.3 = call i64 @llvm.smin.i64(i64 %indvars.iv810.3, i64 -1168)
  %342 = add nsw i64 %smin812.3, 1199
  %smax813.3 = call i64 @llvm.smax.i64(i64 %342, i64 0)
  %343 = mul nsw i64 %polly.indvar512.3, -32
  %polly.loop_guard525.3867 = icmp sgt i64 %343, -1200
  %344 = shl nsw i64 %polly.indvar512.3, 5
...
polly.loop_exit517.3:                             ; preds = %polly.loop_exit524.loopexit.us.3, %polly.loop_header509.3
  ...
  %indvars.iv.next803.3 = add nuw nsw i64 %indvars.iv802.3, 32
  %indvars.iv.next811.3 = add nsw i64 %indvars.iv810.3, -32
  %exitcond816.3.not = icmp eq i64 %polly.indvar_next513.3, 38
...
polly.loop_header509.4:                           ; preds = %polly.loop_exit517.3, %polly.loop_exit517.4
  ...
  %polly.indvar512.4 = phi i64 [ %polly.indvar_next513.4, %polly.loop_exit517.4 ], [ 32, %polly.loop_exit517.3 ]
  %smin812.4 = call i64 @llvm.smin.i64(i64 %indvars.iv810.4, i64 -1168)
  %353 = add nsw i64 %smin812.4, 1199
  %smax813.4 = call i64 @llvm.smax.i64(i64 %353, i64 0)
  %354 = mul nsw i64 %polly.indvar512.4, -32
  %polly.loop_guard525.4868 = icmp sgt i64 %354, -1200
  %355 = shl nsw i64 %polly.indvar512.4, 5
...
polly.loop_exit517.4:                             ; preds = %polly.loop_exit524.loopexit.us.4, %polly.loop_header509.4
  ...
  %indvars.iv.next803.4 = add nuw nsw i64 %indvars.iv802.4, 32
  %indvars.iv.next811.4 = add nsw i64 %indvars.iv810.4, -32
  %exitcond816.4.not = icmp eq i64 %polly.indvar_next513.4, 38
