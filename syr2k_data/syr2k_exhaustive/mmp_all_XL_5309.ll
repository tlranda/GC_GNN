; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5309.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5309.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next990 = add nuw nsw i64 %indvars.iv989, 128
  %exitcond1005.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %.inv873 = icmp slt i64 %142, 14
  %144 = select i1 %.inv873, i64 %143, i64 14
  %polly.loop_guard402 = icmp sgt i64 %144, -1
  %145 = mul nsw i64 %polly.indvar388, -128
  %146 = icmp slt i64 %145, -1072
  %147 = select i1 %146, i64 %145, i64 -1072
  %148 = add nsw i64 %147, 1199
  %149 = shl nsw i64 %polly.indvar388, 7
...
polly.loop_exit393:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next389, 10
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %152 = mul nsw i64 %polly.indvar403, 80
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %.inv875 = icmp slt i64 %185, 14
  %187 = select i1 %.inv875, i64 %186, i64 14
  %polly.loop_guard595 = icmp sgt i64 %187, -1
  %188 = mul nsw i64 %polly.indvar581, -128
  %189 = icmp slt i64 %188, -1072
  %190 = select i1 %189, i64 %188, i64 -1072
  %191 = add nsw i64 %190, 1199
  %192 = shl nsw i64 %polly.indvar581, 7
...
polly.loop_exit586:                               ; preds = %polly.loop_exit594
  ...
  %indvars.iv.next1046 = add nuw nsw i64 %indvars.iv1045, 128
  %exitcond1061.not = icmp eq i64 %polly.indvar_next582, 10
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %195 = mul nsw i64 %polly.indvar596, 80
