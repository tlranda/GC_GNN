; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5320.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5320.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit214, %polly.loop_header199
  ...
  %indvars.iv.next979 = add nuw nsw i64 %indvars.iv978, 128
  %exitcond990.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit391
  ...
  %133 = shl nuw nsw i64 %polly.indvar384, 1
  %134 = trunc i64 %133 to i8
  %pexp.p_div_q387.lhs.trunc = add i8 %134, 2
  %pexp.p_div_q387866 = udiv i8 %pexp.p_div_q387.lhs.trunc, 5
  %pexp.p_div_q387.zext = zext i8 %pexp.p_div_q387866 to i64
  %135 = sub nsw i64 %133, %pexp.p_div_q387.zext
  %136 = add nsw i64 %135, 1
  %.inv861 = icmp slt i64 %135, 14
  %137 = select i1 %.inv861, i64 %136, i64 14
...
polly.loop_exit391:                               ; preds = %polly.loop_exit399, %polly.loop_header381
  ...
  %indvars.iv.next995 = add nsw i64 %indvars.iv994, -128
  %indvars.iv.next1000 = add nuw nsw i64 %indvars.iv999, 128
  %exitcond1012.not = icmp eq i64 %polly.indvar_next385, 10
...
polly.loop_header570:                             ; preds = %polly.loop_header570.preheader, %polly.loop_exit580
  ...
  %169 = shl nuw nsw i64 %polly.indvar573, 1
  %170 = trunc i64 %169 to i8
  %pexp.p_div_q576.lhs.trunc = add i8 %170, 2
  %pexp.p_div_q576865 = udiv i8 %pexp.p_div_q576.lhs.trunc, 5
  %pexp.p_div_q576.zext = zext i8 %pexp.p_div_q576865 to i64
  %171 = sub nsw i64 %169, %pexp.p_div_q576.zext
  %172 = add nsw i64 %171, 1
  %.inv863 = icmp slt i64 %171, 14
  %173 = select i1 %.inv863, i64 %172, i64 14
...
polly.loop_exit580:                               ; preds = %polly.loop_exit588, %polly.loop_header570
  ...
  %indvars.iv.next1022 = add nuw nsw i64 %indvars.iv1021, 128
  %exitcond1034.not = icmp eq i64 %polly.indvar_next574, 10
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit588
  ...
  %179 = mul nsw i64 %polly.indvar582, 80
