; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2704.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2704.c"
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %146 = shl nuw nsw i64 %polly.indvar396, 5
  %147 = mul nsw i64 %polly.indvar396, -128
  %148 = shl nsw i64 %polly.indvar396, 7
...
polly.loop_header399:                             ; preds = %polly.loop_exit440, %polly.loop_header393
  ...
  %.inv869 = icmp ugt i64 %150, 127
  %152 = select i1 %.inv869, i64 127, i64 %151
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %194 = shl nuw nsw i64 %polly.indvar586, 5
  %195 = mul nsw i64 %polly.indvar586, -128
  %196 = shl nsw i64 %polly.indvar586, 7
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %198, 127
  %200 = select i1 %.inv870, i64 127, i64 %199
