; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2604.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2604.c"
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1346 = call i64 @llvm.smin.i64(i64 %121, i64 99)
...
vector.body1342:                                  ; preds = %vector.body1342, %vector.ph1348
  ...
  %wide.load1361 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !65, !noalias !67
  ...
  br i1 %147, label %middle.block1340, label %vector.body1342, !llvm.loop !77
...
vector.body1280:                                  ; preds = %vector.body1280, %vector.ph1284
  ...
  %wide.load1291 = load <4 x double>, <4 x double>* %155, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %158, label %middle.block1278, label %vector.body1280, !llvm.loop !86
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  ...
  %170 = select i1 %.inv926, i64 %.op1143, i64 12
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1298 = call i64 @llvm.smin.i64(i64 %184, i64 99)
...
vector.body1294:                                  ; preds = %vector.body1294, %vector.ph1300
  ...
  %wide.load1313 = load <4 x double>, <4 x double>* %205, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %210, label %middle.block1292, label %vector.body1294, !llvm.loop !90
...
vector.body1234:                                  ; preds = %vector.body1234, %vector.ph1236
  ...
  %wide.load1243 = load <4 x double>, <4 x double>* %218, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %221, label %middle.block1232, label %vector.body1234, !llvm.loop !99
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  ...
  %233 = select i1 %.inv928, i64 %.op1145, i64 12
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %235 = mul i64 %polly.indvar647, 100
  %236 = add i64 %223, %235
  %smax1247 = call i64 @llvm.smax.i64(i64 %236, i64 0)
  %237 = mul i64 %polly.indvar647, -100
  %238 = add i64 %224, %237
  %239 = add i64 %smax1247, %238
  %240 = mul nsw i64 %polly.indvar647, 100
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1250 = call i64 @llvm.smin.i64(i64 %247, i64 99)
...
vector.body1246:                                  ; preds = %vector.body1246, %vector.ph1252
  ...
  %wide.load1265 = load <4 x double>, <4 x double>* %268, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %273, label %middle.block1244, label %vector.body1246, !llvm.loop !103
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1174
  ...
  br i1 %298, label %polly.loop_exit866, label %vector.body1173, !llvm.loop !110
...
vector.body1187:                                  ; preds = %vector.body1187, %vector.ph1190
  ...
  br i1 %327, label %polly.loop_exit893, label %vector.body1187, !llvm.loop !113
...
vector.body1205:                                  ; preds = %vector.body1205, %vector.ph1208
  ...
  br i1 %356, label %polly.loop_exit919, label %vector.body1205, !llvm.loop !116
