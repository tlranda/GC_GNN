; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8446.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8446.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  %indvars.iv796 = phi i64 [ %indvars.iv.next797, %polly.loop_exit219 ], [ %102, %polly.loop_header205 ]
  ...
  %107 = add i64 %smax, %indvars.iv796
...
polly.loop_header223.us:                          ; preds = %polly.loop_header217.us, %polly.loop_exit232.us
  %indvars.iv798 = phi i64 [ %107, %polly.loop_header217.us ], [ %indvars.iv.next799, %polly.loop_exit232.us ]
  ...
  %115 = add i64 %114, %106
  %polly.loop_guard233.us883 = icmp sgt i64 %115, -1
...
polly.loop_exit225.loopexit.us:                   ; preds = %polly.loop_exit232.us
  ...
  %exitcond800.not = icmp eq i64 %polly.indvar_next221.us, 100
  br i1 %exitcond800.not, label %polly.loop_exit219, label %polly.loop_header217.us
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %134 = udiv i64 %indvars.iv809, 5
  %135 = add nuw i64 %indvars.iv807, %134
  %136 = mul nuw nsw i64 %135, 20
  %137 = sub i64 %indvars.iv805, %136
  %138 = add i64 %indvars.iv814, %136
  %139 = mul nuw nsw i64 %polly.indvar363, 6
  ...
  %141 = shl nsw i64 %polly.indvar363, 7
  %142 = mul nsw i64 %polly.indvar363, -128
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv816 = phi i64 [ %indvars.iv.next817, %polly.loop_exit375 ], [ %138, %polly.loop_header360 ]
  %indvars.iv811 = phi i64 [ %indvars.iv.next812, %polly.loop_exit375 ], [ %137, %polly.loop_header360 ]
  ...
  %143 = add i64 %smax813, %indvars.iv816
...
polly.loop_header380.us:                          ; preds = %polly.loop_header373.us, %polly.loop_exit390.us
  %indvars.iv818 = phi i64 [ %143, %polly.loop_header373.us ], [ %indvars.iv.next819, %polly.loop_exit390.us ]
  ...
  %151 = add i64 %150, %142
  %polly.loop_guard391.us884 = icmp sgt i64 %151, -1
...
polly.loop_exit382.loopexit.us:                   ; preds = %polly.loop_exit390.us
  ...
  %exitcond822.not = icmp eq i64 %polly.indvar_next377.us, 100
  br i1 %exitcond822.not, label %polly.loop_exit375, label %polly.loop_header373.us
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %169 = mul nuw nsw i64 %polly.indvar515, 100
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar_next516, 10
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %171 = add nuw i64 %indvars.iv829, %170
  %172 = mul nuw nsw i64 %171, 20
  %173 = sub i64 %indvars.iv827, %172
  %174 = add i64 %indvars.iv836, %172
  %175 = mul nuw nsw i64 %polly.indvar521, 6
  ...
  %177 = shl nsw i64 %polly.indvar521, 7
  %178 = mul nsw i64 %polly.indvar521, -128
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv838 = phi i64 [ %indvars.iv.next839, %polly.loop_exit533 ], [ %174, %polly.loop_header518 ]
  %indvars.iv833 = phi i64 [ %indvars.iv.next834, %polly.loop_exit533 ], [ %173, %polly.loop_header518 ]
...
polly.loop_header538.us:                          ; preds = %polly.loop_header531.us, %polly.loop_exit548.us
  %indvars.iv840 = phi i64 [ %179, %polly.loop_header531.us ], [ %indvars.iv.next841, %polly.loop_exit548.us ]
  ...
  %187 = add i64 %186, %178
  %polly.loop_guard549.us885 = icmp sgt i64 %187, -1
...
polly.loop_exit540.loopexit.us:                   ; preds = %polly.loop_exit548.us
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar_next535.us, 100
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph914
  ...
  br i1 %217, label %polly.loop_exit714, label %vector.body912, !llvm.loop !95

polly.loop_exit714:                               ; preds = %vector.body912, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond876.not = icmp eq i64 %polly.indvar709, %197
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond872.not = icmp eq i64 %polly.indvar715, %201
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph930
  ...
  br i1 %246, label %polly.loop_exit741, label %vector.body927, !llvm.loop !98

polly.loop_exit741:                               ; preds = %vector.body927, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond866.not = icmp eq i64 %polly.indvar736, %226
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond862.not = icmp eq i64 %polly.indvar742, %230
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph948
  ...
  br i1 %275, label %polly.loop_exit767, label %vector.body945, !llvm.loop !101

polly.loop_exit767:                               ; preds = %vector.body945, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond856.not = icmp eq i64 %polly.indvar762, %255
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar768, %259
