; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4314.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4314.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin987 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -920)
...
polly.loop_header387:                             ; preds = %polly.loop_exit395, %polly.loop_header381
  ...
  %129 = mul nuw nsw i64 %polly.indvar390, 80
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1019.not = icmp eq i64 %polly.indvar_next391, 13
...
polly.start467:                                   ; preds = %init_array.exit
  %malloccall469 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %smin1039 = call i64 @llvm.smin.i64(i64 %indvars.iv1023, i64 -920)
  %158 = add nsw i64 %smin1039, 1000
  %159 = mul nuw nsw i64 %polly.indvar578, 80
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar_next579, 13
