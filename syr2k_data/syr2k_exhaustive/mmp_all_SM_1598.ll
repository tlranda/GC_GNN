; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1598.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1598.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1047 = add nuw nsw i64 %indvars.iv1046, 16
  %exitcond1061.not = icmp eq i64 %polly.indvar_next220, 75
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %107 = mul nsw i64 %polly.indvar231, -20
  %108 = add i64 %98, %107
  ...
  %polly.loop_guard238 = icmp slt i64 %113, 16
...
polly.loop_header235:                             ; preds = %polly.loop_header235.preheader, %polly.loop_exit269
  ...
  %smin1360 = call i64 @llvm.smin.i64(i64 %117, i64 19)
...
vector.body1356:                                  ; preds = %vector.body1356, %vector.ph1362
  ...
  %wide.load1375 = load <4 x double>, <4 x double>* %138, align 8, !alias.scope !64, !noalias !66
  ...
  br i1 %143, label %middle.block1354, label %vector.body1356, !llvm.loop !76
...
vector.body1294:                                  ; preds = %vector.body1294, %vector.ph1298
  ...
  %wide.load1305 = load <4 x double>, <4 x double>* %151, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %154, label %middle.block1292, label %vector.body1294, !llvm.loop !85
...
polly.loop_header422:                             ; preds = %polly.loop_exit414, %polly.loop_exit430
  ...
  %156 = mul nsw i64 %polly.indvar425, -16
  %157 = shl nuw nsw i64 %polly.indvar425, 4
  ...
  %160 = mul nsw i64 %polly.indvar425, -16
  %161 = shl nsw i64 %polly.indvar425, 4
  br label %polly.loop_header428

polly.loop_exit430:                               ; preds = %polly.loop_exit438
  %polly.indvar_next426 = add nuw nsw i64 %polly.indvar425, 1
  %indvars.iv.next1071 = add nsw i64 %indvars.iv1070, -16
  %indvars.iv.next1076 = add nuw nsw i64 %indvars.iv1075, 16
  %exitcond1090.not = icmp eq i64 %polly.indvar_next426, 75
...
polly.loop_header436.preheader:                   ; preds = %polly.loop_header428
  %163 = shl nsw i64 %polly.indvar431, 4
...
polly.loop_header436:                             ; preds = %polly.loop_header436.preheader, %polly.loop_exit446
  ...
  %164 = mul nuw nsw i64 %polly.indvar440, 20
  %165 = add i64 %156, %164
  %smax1309 = call i64 @llvm.smax.i64(i64 %165, i64 0)
  %166 = mul nsw i64 %polly.indvar440, -20
  %167 = add i64 %157, %166
  %168 = add i64 %smax1309, %167
  %169 = mul nuw nsw i64 %polly.indvar440, 20
  %170 = add nsw i64 %169, %160
  %171 = icmp sgt i64 %170, 0
  %172 = select i1 %171, i64 %170, i64 0
  %polly.loop_guard447 = icmp slt i64 %172, 16
...
polly.loop_header444:                             ; preds = %polly.loop_header444.preheader, %polly.loop_exit482
  ...
  %smin1312 = call i64 @llvm.smin.i64(i64 %176, i64 19)
...
vector.body1308:                                  ; preds = %vector.body1308, %vector.ph1314
  ...
  %wide.load1327 = load <4 x double>, <4 x double>* %197, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %202, label %middle.block1306, label %vector.body1308, !llvm.loop !89
...
vector.body1248:                                  ; preds = %vector.body1248, %vector.ph1250
  ...
  %wide.load1257 = load <4 x double>, <4 x double>* %210, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %213, label %middle.block1246, label %vector.body1248, !llvm.loop !98
...
polly.loop_header635:                             ; preds = %polly.loop_exit627, %polly.loop_exit643
  ...
  %215 = mul nsw i64 %polly.indvar638, -16
  %216 = shl nuw nsw i64 %polly.indvar638, 4
  ...
  %219 = mul nsw i64 %polly.indvar638, -16
  %220 = shl nsw i64 %polly.indvar638, 4
...
polly.loop_exit643:                               ; preds = %polly.loop_exit651
  ...
  %exitcond1119.not = icmp eq i64 %polly.indvar_next639, 75
...
polly.loop_header649.preheader:                   ; preds = %polly.loop_header641
  %222 = shl nsw i64 %polly.indvar644, 4
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit659
  ...
  %223 = mul nuw nsw i64 %polly.indvar653, 20
  %224 = add i64 %215, %223
  %smax1261 = call i64 @llvm.smax.i64(i64 %224, i64 0)
  %225 = mul nsw i64 %polly.indvar653, -20
  %226 = add i64 %216, %225
  %227 = add i64 %smax1261, %226
  %228 = mul nuw nsw i64 %polly.indvar653, 20
  %229 = add nsw i64 %228, %219
  %230 = icmp sgt i64 %229, 0
  %231 = select i1 %230, i64 %229, i64 0
  %polly.loop_guard660 = icmp slt i64 %231, 16
...
polly.loop_exit659:                               ; preds = %polly.loop_exit695, %polly.loop_header649
  ...
  %indvars.iv.next1102 = add nsw i64 %indvars.iv1101, 20
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit695
  ...
  %smin1264 = call i64 @llvm.smin.i64(i64 %235, i64 19)
  %236 = add nsw i64 %smin1264, 1
  %smin1114 = call i64 @llvm.smin.i64(i64 %indvars.iv1108, i64 19)
...
vector.body1260:                                  ; preds = %vector.body1260, %vector.ph1266
  ...
  %wide.load1279 = load <4 x double>, <4 x double>* %256, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %261, label %middle.block1258, label %vector.body1260, !llvm.loop !102
...
vector.body1187:                                  ; preds = %vector.body1187, %vector.ph1188
  ...
  br i1 %286, label %polly.loop_exit872, label %vector.body1187, !llvm.loop !109
...
vector.body1201:                                  ; preds = %vector.body1201, %vector.ph1204
  ...
  br i1 %315, label %polly.loop_exit899, label %vector.body1201, !llvm.loop !112
...
vector.body1219:                                  ; preds = %vector.body1219, %vector.ph1222
  ...
  br i1 %344, label %polly.loop_exit925, label %vector.body1219, !llvm.loop !115
