; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10610.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10610.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin797 = call i64 @llvm.smin.i64(i64 %indvars.iv795, i64 -920)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond800.not = icmp eq i64 %polly.indvar_next209, 13
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1003
  ...
  %wide.load1010 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %133, label %middle.block997, label %vector.body999, !llvm.loop !74
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %smin819 = call i64 @llvm.smin.i64(i64 %indvars.iv817, i64 -920)
  %144 = mul nuw nsw i64 %polly.indvar363, 80
  %145 = add nsw i64 %smin819, 999
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit376
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %indvars.iv.next818 = add nsw i64 %indvars.iv817, -80
  %exitcond822.not = icmp eq i64 %polly.indvar_next364, 13
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph977
  ...
  %wide.load984 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %171, label %middle.block973, label %vector.body975, !llvm.loop !83
...
polly.loop_header502:                             ; preds = %polly.loop_header502.preheader, %polly.loop_header502
  ...
  br i1 %exitcond846.not, label %polly.loop_exit504, label %polly.loop_header502, !llvm.loop !84
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %smin841 = call i64 @llvm.smin.i64(i64 %indvars.iv839, i64 -920)
  %182 = mul nuw nsw i64 %polly.indvar521, 80
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %indvars.iv.next840 = add nsw i64 %indvars.iv839, -80
  %exitcond844.not = icmp eq i64 %polly.indvar_next522, 13
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph915
  ...
  br i1 %223, label %polly.loop_exit714, label %vector.body913, !llvm.loop !92
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  br i1 %exitcond871.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !93
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph931
  ...
  br i1 %252, label %polly.loop_exit741, label %vector.body928, !llvm.loop !95
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  br i1 %exitcond861.not, label %polly.loop_exit741, label %polly.loop_header739, !llvm.loop !96
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph949
  ...
  br i1 %281, label %polly.loop_exit767, label %vector.body946, !llvm.loop !98
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  br i1 %exitcond851.not, label %polly.loop_exit767, label %polly.loop_header765, !llvm.loop !99
}
