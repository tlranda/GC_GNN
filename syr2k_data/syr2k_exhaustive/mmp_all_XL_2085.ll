; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2085.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2085.c"
...
polly.loop_exit432:                               ; preds = %polly.loop_exit438
  ...
  %exitcond1086.not = icmp eq i64 %polly.indvar_next428, 63
...
polly.loop_header632:                             ; preds = %polly.loop_exit640, %polly.loop_header626
  ...
  %smin1108 = call i64 @llvm.smin.i64(i64 %indvars.iv1092, i64 -984)
  %198 = add nsw i64 %smin1108, 1000
  %199 = shl nsw i64 %polly.indvar635, 4
...
polly.loop_exit640:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1117.not = icmp eq i64 %polly.indvar_next636, 63
