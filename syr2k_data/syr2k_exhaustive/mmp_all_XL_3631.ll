; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3631.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3631.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %108 = udiv i64 %polly.indvar208, 12
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1028.not = icmp eq i64 %122, 150
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %123 = add i64 %smax, %indvars.iv1022
  %124 = mul nuw nsw i64 %polly.indvar214, 12
  %.not.not = icmp ugt i64 %124, %polly.indvar208
  %125 = mul nuw nsw i64 %polly.indvar214, 96
...
polly.loop_header253:                             ; preds = %polly.loop_header246.preheader, %polly.loop_exit263
  %indvars.iv1024 = phi i64 [ %indvars.iv.next1025, %polly.loop_exit263 ], [ %123, %polly.loop_header246.preheader ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %172 = udiv i64 %polly.indvar398, 12
  %173 = mul nuw nsw i64 %172, 96
  %174 = sub nsw i64 %indvars.iv1035, %173
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1049.not = icmp eq i64 %186, 150
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit445 ], [ %175, %polly.loop_header395 ]
  %indvars.iv1037 = phi i64 [ %indvars.iv.next1038, %polly.loop_exit445 ], [ %174, %polly.loop_header395 ]
  ...
  %188 = mul nuw nsw i64 %polly.indvar405, 12
  %.not.not885 = icmp ugt i64 %188, %polly.indvar398
  %189 = mul nuw nsw i64 %polly.indvar405, 96
...
polly.loop_header450:                             ; preds = %polly.loop_header443.preheader, %polly.loop_exit460
  %indvars.iv1044 = phi i64 [ %indvars.iv.next1045, %polly.loop_exit460 ], [ %187, %polly.loop_header443.preheader ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %236 = udiv i64 %polly.indvar595, 12
  %237 = mul nuw nsw i64 %236, 96
  %238 = sub nsw i64 %indvars.iv1056, %237
  %239 = add i64 %indvars.iv1061, %237
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1063 = phi i64 [ %indvars.iv.next1064, %polly.loop_exit642 ], [ %239, %polly.loop_header592 ]
  %indvars.iv1058 = phi i64 [ %indvars.iv.next1059, %polly.loop_exit642 ], [ %238, %polly.loop_header592 ]
  ...
  %252 = mul nuw nsw i64 %polly.indvar602, 12
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_header626.3, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %265 = mul nsw i64 %polly.indvar602, -96
...
polly.loop_header647:                             ; preds = %polly.loop_header640.preheader, %polly.loop_exit657
  %indvars.iv1065 = phi i64 [ %indvars.iv.next1066, %polly.loop_exit657 ], [ %251, %polly.loop_header640.preheader ]
...
polly.loop_header253.1:                           ; preds = %polly.loop_exit263, %polly.loop_exit263.1
  %indvars.iv1024.1 = phi i64 [ %indvars.iv.next1025.1, %polly.loop_exit263.1 ], [ %123, %polly.loop_exit263 ]
  %polly.indvar257.1 = phi i64 [ %polly.indvar_next258.1, %polly.loop_exit263.1 ], [ %136, %polly.loop_exit263 ]
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv1024.1, i64 7)
...
polly.loop_header253.2:                           ; preds = %polly.loop_exit263.1, %polly.loop_exit263.2
  %indvars.iv1024.2 = phi i64 [ %indvars.iv.next1025.2, %polly.loop_exit263.2 ], [ %123, %polly.loop_exit263.1 ]
  %polly.indvar257.2 = phi i64 [ %polly.indvar_next258.2, %polly.loop_exit263.2 ], [ %136, %polly.loop_exit263.1 ]
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv1024.2, i64 7)
...
polly.loop_header253.3:                           ; preds = %polly.loop_exit263.2, %polly.loop_exit263.3
  %indvars.iv1024.3 = phi i64 [ %indvars.iv.next1025.3, %polly.loop_exit263.3 ], [ %123, %polly.loop_exit263.2 ]
  %polly.indvar257.3 = phi i64 [ %polly.indvar_next258.3, %polly.loop_exit263.3 ], [ %136, %polly.loop_exit263.2 ]
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv1024.3, i64 7)
...
polly.loop_header450.1:                           ; preds = %polly.loop_exit460, %polly.loop_exit460.1
  %indvars.iv1044.1 = phi i64 [ %indvars.iv.next1045.1, %polly.loop_exit460.1 ], [ %187, %polly.loop_exit460 ]
  %polly.indvar454.1 = phi i64 [ %polly.indvar_next455.1, %polly.loop_exit460.1 ], [ %200, %polly.loop_exit460 ]
  %smin1046.1 = call i64 @llvm.smin.i64(i64 %indvars.iv1044.1, i64 7)
...
polly.loop_header450.2:                           ; preds = %polly.loop_exit460.1, %polly.loop_exit460.2
  %indvars.iv1044.2 = phi i64 [ %indvars.iv.next1045.2, %polly.loop_exit460.2 ], [ %187, %polly.loop_exit460.1 ]
  %polly.indvar454.2 = phi i64 [ %polly.indvar_next455.2, %polly.loop_exit460.2 ], [ %200, %polly.loop_exit460.1 ]
  %smin1046.2 = call i64 @llvm.smin.i64(i64 %indvars.iv1044.2, i64 7)
...
polly.loop_header450.3:                           ; preds = %polly.loop_exit460.2, %polly.loop_exit460.3
  %indvars.iv1044.3 = phi i64 [ %indvars.iv.next1045.3, %polly.loop_exit460.3 ], [ %187, %polly.loop_exit460.2 ]
  %polly.indvar454.3 = phi i64 [ %polly.indvar_next455.3, %polly.loop_exit460.3 ], [ %200, %polly.loop_exit460.2 ]
  %smin1046.3 = call i64 @llvm.smin.i64(i64 %indvars.iv1044.3, i64 7)
...
polly.loop_header647.1:                           ; preds = %polly.loop_exit657, %polly.loop_exit657.1
  %indvars.iv1065.1 = phi i64 [ %indvars.iv.next1066.1, %polly.loop_exit657.1 ], [ %251, %polly.loop_exit657 ]
  %polly.indvar651.1 = phi i64 [ %polly.indvar_next652.1, %polly.loop_exit657.1 ], [ %264, %polly.loop_exit657 ]
  %smin1067.1 = call i64 @llvm.smin.i64(i64 %indvars.iv1065.1, i64 7)
...
polly.loop_header647.2:                           ; preds = %polly.loop_exit657.1, %polly.loop_exit657.2
  %indvars.iv1065.2 = phi i64 [ %indvars.iv.next1066.2, %polly.loop_exit657.2 ], [ %251, %polly.loop_exit657.1 ]
  %polly.indvar651.2 = phi i64 [ %polly.indvar_next652.2, %polly.loop_exit657.2 ], [ %264, %polly.loop_exit657.1 ]
  %smin1067.2 = call i64 @llvm.smin.i64(i64 %indvars.iv1065.2, i64 7)
...
polly.loop_header647.3:                           ; preds = %polly.loop_exit657.2, %polly.loop_exit657.3
  %indvars.iv1065.3 = phi i64 [ %indvars.iv.next1066.3, %polly.loop_exit657.3 ], [ %251, %polly.loop_exit657.2 ]
  %polly.indvar651.3 = phi i64 [ %polly.indvar_next652.3, %polly.loop_exit657.3 ], [ %264, %polly.loop_exit657.2 ]
  %smin1067.3 = call i64 @llvm.smin.i64(i64 %indvars.iv1065.3, i64 7)
