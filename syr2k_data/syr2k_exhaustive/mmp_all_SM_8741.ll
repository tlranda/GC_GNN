; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8741.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8741.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar_next203, 63
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %134, label %middle.block990, label %vector.body992, !llvm.loop !77
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 -984)
  %136 = shl nsw i64 %polly.indvar357, 4
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond819.not = icmp eq i64 %polly.indvar_next358, 63
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %wide.load977 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !81, !noalias !83
  ...
  br i1 %173, label %middle.block966, label %vector.body968, !llvm.loop !86
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %175 = shl nsw i64 %polly.indvar515, 4
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %exitcond840.not = icmp eq i64 %polly.indvar_next516, 63
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  br i1 %226, label %polly.loop_exit714, label %vector.body906, !llvm.loop !95
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  br i1 %255, label %polly.loop_exit741, label %vector.body921, !llvm.loop !98
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  br i1 %284, label %polly.loop_exit767, label %vector.body939, !llvm.loop !101
