; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6407.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6407.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit223
  ...
  %indvars.iv844 = phi i64 [ 47, %polly.loop_header199.preheader ], [ %indvars.iv.next845, %polly.loop_exit223 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %103 = mul nuw nsw i64 %polly.indvar202, 23
  %104 = add nuw nsw i64 %103, 47
  %pexp.p_div_q = udiv i64 %104, 48
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -46
  %indvars.iv.next845 = add nuw nsw i64 %indvars.iv844, 23
  %indvars.iv.next849 = add nuw nsw i64 %indvars.iv848, 46
...
polly.loop_header221:                             ; preds = %polly.loop_exit207, %polly.loop_exit229
  ...
  %108 = mul nsw i64 %polly.indvar224, 96
  %109 = sub nsw i64 %101, %108
  %110 = icmp sgt i64 %109, 0
  %111 = select i1 %110, i64 %109, i64 0
  %112 = mul nsw i64 %polly.indvar224, -96
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit398
  ...
  %indvars.iv865 = phi i64 [ 47, %polly.loop_header372.preheader ], [ %indvars.iv.next866, %polly.loop_exit398 ]
...
polly.loop_exit380:                               ; preds = %polly.loop_exit386
  ...
  %140 = mul nuw nsw i64 %polly.indvar375, 23
  %141 = add nuw nsw i64 %140, 47
  %pexp.p_div_q394 = udiv i64 %141, 48
  %142 = sub nsw i64 %polly.indvar375, %pexp.p_div_q394
  %polly.loop_guard399 = icmp slt i64 %142, 13
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405, %polly.loop_exit380
  ...
  %indvars.iv.next864 = add nsw i64 %indvars.iv863, -46
  %indvars.iv.next866 = add nuw nsw i64 %indvars.iv865, 23
  %indvars.iv.next871 = add nuw nsw i64 %indvars.iv870, 46
...
polly.loop_header396:                             ; preds = %polly.loop_exit380, %polly.loop_exit405
  ...
  %145 = mul nsw i64 %polly.indvar400, 96
  %146 = sub nsw i64 %138, %145
  %147 = icmp sgt i64 %146, 0
  %148 = select i1 %147, i64 %146, i64 0
  %149 = mul nsw i64 %polly.indvar400, -96
...
polly.loop_header548:                             ; preds = %polly.loop_header548.preheader, %polly.loop_exit574
  ...
  %indvars.iv888 = phi i64 [ 47, %polly.loop_header548.preheader ], [ %indvars.iv.next889, %polly.loop_exit574 ]
  ...
  %171 = udiv i64 %indvars.iv888, 48
  %172 = mul nuw nsw i64 %171, 96
...
polly.loop_exit556:                               ; preds = %polly.loop_exit562
  ...
  %177 = mul nuw nsw i64 %polly.indvar551, 23
  %178 = add nuw nsw i64 %177, 47
  %pexp.p_div_q570 = udiv i64 %178, 48
  %179 = sub nsw i64 %polly.indvar551, %pexp.p_div_q570
  %polly.loop_guard575 = icmp slt i64 %179, 13
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_exit556
  ...
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, -46
  %indvars.iv.next889 = add nuw nsw i64 %indvars.iv888, 23
  %indvars.iv.next894 = add nuw nsw i64 %indvars.iv893, 46
...
polly.loop_header572:                             ; preds = %polly.loop_exit556, %polly.loop_exit581
  ...
  %182 = mul nsw i64 %polly.indvar576, 96
  %183 = sub nsw i64 %175, %182
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %186 = mul nsw i64 %polly.indvar576, -96
