; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6006.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6006.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %indvars.iv.next857 = add nuw nsw i64 %indvars.iv856, 4
  %indvars.iv.next859 = add nuw nsw i64 %indvars.iv858, 2
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -4
  %exitcond872.not = icmp eq i64 %polly.indvar_next209, 300
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %109 = mul nuw nsw i64 %polly.indvar230, 50
  %110 = sub nsw i64 %103, %109
  %111 = icmp sgt i64 %110, 0
  %112 = select i1 %111, i64 %110, i64 0
  %polly.loop_guard = icmp slt i64 %112, 50
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233.us, %polly.loop_exit248.us
  %indvars.iv866 = phi i64 [ %108, %polly.loop_header233.us ], [ %indvars.iv.next867, %polly.loop_exit248.us ]
  %polly.indvar242.us = phi i64 [ %112, %polly.loop_header233.us ], [ %polly.indvar_next243.us, %polly.loop_exit248.us ]
  %smin868 = call i64 @llvm.smin.i64(i64 %indvars.iv866, i64 3)
  %115 = add nuw i64 %polly.indvar242.us, %109
  %116 = add i64 %115, %104
  %polly.loop_guard249.us963 = icmp sgt i64 %116, -1
...
polly.loop_header246.us:                          ; preds = %polly.loop_header246.preheader.us, %polly.loop_header246.us
  ...
  %117 = add nuw nsw i64 %polly.indvar250.us, %103
...
vector.body1071:                                  ; preds = %vector.body1071, %vector.ph1075
  ...
  %127 = shl nuw nsw i64 %index1078, 3
  %128 = getelementptr i8, i8* %scevgep370, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1082 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !79, !noalias !81
  %130 = fmul fast <4 x double> %wide.load1082, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1079, %n.vec1077
  br i1 %132, label %middle.block1069, label %vector.body1071, !llvm.loop !85

middle.block1069:                                 ; preds = %vector.body1071
  %cmp.n1081 = icmp eq i64 %125, %n.vec1077
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %134 = add nsw i64 %smin898, 1000
  %135 = mul nuw nsw i64 %polly.indvar377, 80
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %136 = udiv i64 %indvars.iv885, 25
  %137 = mul nuw nsw i64 %136, 50
  %138 = sub nsw i64 %indvars.iv883, %137
  %139 = add i64 %indvars.iv890, %137
  %140 = shl nsw i64 %polly.indvar383, 2
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %141 = mul nsw i64 %polly.indvar383, -4
  %142 = shl nuw nsw i64 %polly.indvar383, 1
  %pexp.p_div_q402 = udiv i64 %142, 25
...
polly.loop_exit405:                               ; preds = %polly.loop_exit411
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar_next384, 300
...
polly.loop_exit394:                               ; preds = %polly.loop_header392
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next390, %134
...
polly.loop_header392:                             ; preds = %polly.loop_header392, %polly.loop_header386
  ...
  %144 = add nuw nsw i64 %polly.indvar395, %140
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit411 ], [ %139, %polly.loop_exit388 ]
  %indvars.iv887 = phi i64 [ %indvars.iv.next888, %polly.loop_exit411 ], [ %138, %polly.loop_exit388 ]
  ...
  %145 = add i64 %smax889, %indvars.iv892
  %146 = mul nuw nsw i64 %polly.indvar406, 50
  %147 = sub nsw i64 %140, %146
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %polly.loop_guard419 = icmp slt i64 %149, 50
...
polly.loop_header416.us:                          ; preds = %polly.loop_header409.us, %polly.loop_exit426.us
  %indvars.iv894 = phi i64 [ %145, %polly.loop_header409.us ], [ %indvars.iv.next895, %polly.loop_exit426.us ]
  %polly.indvar420.us = phi i64 [ %149, %polly.loop_header409.us ], [ %polly.indvar_next421.us, %polly.loop_exit426.us ]
  %smin896 = call i64 @llvm.smin.i64(i64 %indvars.iv894, i64 3)
  %152 = add nuw i64 %polly.indvar420.us, %146
  %153 = add i64 %152, %141
  %polly.loop_guard427.us964 = icmp sgt i64 %153, -1
...
polly.loop_header424.us:                          ; preds = %polly.loop_header424.preheader.us, %polly.loop_header424.us
  ...
  %154 = add nuw nsw i64 %polly.indvar428.us, %140
...
polly.loop_exit418.loopexit.us:                   ; preds = %polly.loop_exit426.us
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar_next413.us, %134
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1048 = icmp ult i64 %162, 4
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1049
  ...
  %164 = shl nuw nsw i64 %index1052, 3
  %165 = getelementptr i8, i8* %scevgep548, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load1056 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !89, !noalias !91
  %167 = fmul fast <4 x double> %wide.load1056, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next1053, %n.vec1051
  br i1 %169, label %middle.block1045, label %vector.body1047, !llvm.loop !95

middle.block1045:                                 ; preds = %vector.body1047
  %cmp.n1055 = icmp eq i64 %162, %n.vec1051
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %171 = add nsw i64 %smin926, 1000
  %172 = mul nuw nsw i64 %polly.indvar555, 80
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %173 = udiv i64 %indvars.iv913, 25
  %174 = mul nuw nsw i64 %173, 50
  %175 = sub nsw i64 %indvars.iv911, %174
  %176 = add i64 %indvars.iv918, %174
  %177 = shl nsw i64 %polly.indvar561, 2
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %178 = mul nsw i64 %polly.indvar561, -4
  %179 = shl nuw nsw i64 %polly.indvar561, 1
  %pexp.p_div_q580 = udiv i64 %179, 25
  br label %polly.loop_header581

polly.loop_exit583:                               ; preds = %polly.loop_exit589
  %polly.indvar_next562 = add nuw nsw i64 %polly.indvar561, 1
  %indvars.iv.next905 = add nsw i64 %indvars.iv904, -4
  %indvars.iv.next912 = add nuw nsw i64 %indvars.iv911, 4
  %indvars.iv.next914 = add nuw nsw i64 %indvars.iv913, 2
  %indvars.iv.next919 = add nsw i64 %indvars.iv918, -4
  %exitcond928.not = icmp eq i64 %polly.indvar_next562, 300
...
polly.loop_exit572:                               ; preds = %polly.loop_header570
  ...
  %exitcond910.not = icmp eq i64 %polly.indvar_next568, %171
...
polly.loop_header570:                             ; preds = %polly.loop_header570, %polly.loop_header564
  ...
  %181 = add nuw nsw i64 %polly.indvar573, %177
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  %indvars.iv920 = phi i64 [ %indvars.iv.next921, %polly.loop_exit589 ], [ %176, %polly.loop_exit566 ]
  %indvars.iv915 = phi i64 [ %indvars.iv.next916, %polly.loop_exit589 ], [ %175, %polly.loop_exit566 ]
  ...
  %182 = add i64 %smax917, %indvars.iv920
  %183 = mul nuw nsw i64 %polly.indvar584, 50
  %184 = sub nsw i64 %177, %183
  %185 = icmp sgt i64 %184, 0
  %186 = select i1 %185, i64 %184, i64 0
  %polly.loop_guard597 = icmp slt i64 %186, 50
...
polly.loop_header594.us:                          ; preds = %polly.loop_header587.us, %polly.loop_exit604.us
  %indvars.iv922 = phi i64 [ %182, %polly.loop_header587.us ], [ %indvars.iv.next923, %polly.loop_exit604.us ]
  %polly.indvar598.us = phi i64 [ %186, %polly.loop_header587.us ], [ %polly.indvar_next599.us, %polly.loop_exit604.us ]
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 3)
  %189 = add nuw i64 %polly.indvar598.us, %183
  %190 = add i64 %189, %178
  %polly.loop_guard605.us965 = icmp sgt i64 %190, -1
...
polly.loop_header602.us:                          ; preds = %polly.loop_header602.preheader.us, %polly.loop_header602.us
  ...
  %191 = add nuw nsw i64 %polly.indvar606.us, %177
...
polly.loop_exit596.loopexit.us:                   ; preds = %polly.loop_exit604.us
  ...
  %exitcond927.not = icmp eq i64 %polly.indvar_next591.us, %171
...
vector.ph987:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert994 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat995 = shufflevector <4 x i64> %broadcast.splatinsert994, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert996 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph987
  ...
  %208 = add nuw nsw <4 x i64> %vec.ind992, %broadcast.splat995
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat997, %209
  ...
  %220 = icmp eq i64 %index.next989, %202
  br i1 %220, label %polly.loop_exit772, label %vector.body986, !llvm.loop !104

polly.loop_exit772:                               ; preds = %vector.body986, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond959.not = icmp eq i64 %polly.indvar767, %200
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond955.not = icmp eq i64 %polly.indvar773, %204
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin1001 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin1001, 1000
  %smin944 = call i64 @llvm.smin.i64(i64 %indvars.iv942, i64 -968)
  %232 = shl nsw i64 %polly.indvar788, 5
  %233 = add nsw i64 %smin944, 999
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind1010, %broadcast.splat1013
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat1015, %238
  ...
  %249 = icmp eq i64 %index.next1007, %231
  br i1 %249, label %polly.loop_exit799, label %vector.body1000, !llvm.loop !107

polly.loop_exit799:                               ; preds = %vector.body1000, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond949.not = icmp eq i64 %polly.indvar794, %229
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond945.not = icmp eq i64 %polly.indvar800, %233
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1019 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin1019, 1000
  %smin934 = call i64 @llvm.smin.i64(i64 %indvars.iv932, i64 -968)
  %261 = shl nsw i64 %polly.indvar814, 5
  %262 = add nsw i64 %smin934, 999
...
vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1021
  ...
  %266 = add nuw nsw <4 x i64> %vec.ind1028, %broadcast.splat1031
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat1033, %267
  ...
  %278 = icmp eq i64 %index.next1025, %260
  br i1 %278, label %polly.loop_exit825, label %vector.body1018, !llvm.loop !110

polly.loop_exit825:                               ; preds = %vector.body1018, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond939.not = icmp eq i64 %polly.indvar820, %258
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar826, %262
