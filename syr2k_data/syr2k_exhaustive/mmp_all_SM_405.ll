; ModuleID = 'syr2k_exhaustive/mmp_all_SM_405.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_405.c"
...
vector.body1325:                                  ; preds = %vector.body1325, %vector.ph1327
  ...
  br i1 %57, label %middle.block1323, label %vector.body1325, !llvm.loop !63
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond1104.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !79
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1103.not = icmp eq i64 %polly.indvar_next204, 50
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %98 = shl nuw nsw i64 %polly.indvar209, 7
  %99 = mul nuw nsw i64 %polly.indvar209, 6
  %100 = shl nuw nsw i64 %polly.indvar209, 1
  %101 = udiv i64 %100, 5
  %102 = add nuw i64 %99, %101
  %103 = mul nuw nsw i64 %102, 20
  %104 = sub i64 %98, %103
  %105 = mul nsw i64 %polly.indvar209, -128
  %106 = add i64 %105, %103
  %107 = udiv i64 %indvars.iv1090, 5
  %108 = add nuw i64 %indvars.iv1088, %107
  %109 = mul nuw nsw i64 %108, 20
  %110 = sub i64 %indvars.iv1086, %109
  %111 = add i64 %indvars.iv1094, %109
  %112 = shl nsw i64 %polly.indvar209, 7
  br label %polly.loop_header212

polly.loop_exit214:                               ; preds = %polly.loop_exit220
  %113 = mul nsw i64 %polly.indvar209, -128
  %114 = mul nuw nsw i64 %polly.indvar209, 6
  %115 = shl nuw nsw i64 %polly.indvar209, 1
  %pexp.p_div_q = udiv i64 %115, 5
  %116 = add nuw nsw i64 %pexp.p_div_q, %114
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %indvars.iv1092 = phi i64 [ %indvars.iv.next1093, %polly.loop_exit267 ], [ %110, %polly.loop_exit214 ]
  %polly.indvar231 = phi i64 [ %polly.indvar_next232, %polly.loop_exit267 ], [ %116, %polly.loop_exit214 ]
  %119 = mul nsw i64 %indvar1402, -20
  %120 = add i64 %104, %119
  %smax1404 = call i64 @llvm.smax.i64(i64 %120, i64 0)
  %121 = mul nuw nsw i64 %indvar1402, 20
  %122 = add i64 %106, %121
  %123 = add i64 %smax1404, %122
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1092, i64 0)
  %124 = add i64 %smax, %indvars.iv1096
  %125 = mul nuw nsw i64 %polly.indvar231, 20
  %126 = add nsw i64 %125, %113
  %127 = add nsw i64 %126, -1
  %.inv = icmp sgt i64 %126, 127
  %128 = select i1 %.inv, i64 127, i64 %127
  %polly.loop_guard = icmp sgt i64 %128, -1
  %129 = icmp sgt i64 %126, 0
  %130 = select i1 %129, i64 %126, i64 0
  %131 = add nsw i64 %126, 19
...
polly.loop_header240.us:                          ; preds = %polly.loop_header234.us, %polly.loop_header240.us
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar243.us, %128
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us, %polly.loop_header228.split
  %136 = sub nsw i64 %112, %125
  %137 = icmp sgt i64 %136, 0
  %138 = select i1 %137, i64 %136, i64 0
  %polly.loop_guard275 = icmp slt i64 %138, 20
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  %indvar1405 = phi i64 [ 0, %polly.loop_header265.us ], [ %indvar.next1406, %polly.loop_exit282.us ]
  %indvars.iv1098 = phi i64 [ %124, %polly.loop_header265.us ], [ %indvars.iv.next1099, %polly.loop_exit282.us ]
  %polly.indvar276.us = phi i64 [ %138, %polly.loop_header265.us ], [ %polly.indvar_next277.us, %polly.loop_exit282.us ]
  %139 = add i64 %123, %indvar1405
  %smin1407 = call i64 @llvm.smin.i64(i64 %139, i64 127)
  %140 = add nsw i64 %smin1407, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1098, i64 127)
  %141 = add nsw i64 %polly.indvar276.us, %126
  %polly.loop_guard283.us1198 = icmp sgt i64 %141, -1
...
polly.loop_header280.us:                          ; preds = %polly.loop_header280.us.preheader, %polly.loop_header280.us
  ...
  %142 = add nuw nsw i64 %polly.indvar284.us, %112
  ...
  %143 = shl i64 %142, 3
  %144 = add i64 %143, %146
  %scevgep303.us = getelementptr i8, i8* %call, i64 %144
  ...
  br i1 %exitcond1100.not, label %polly.loop_exit282.us, label %polly.loop_header280.us, !llvm.loop !83

polly.loop_exit282.us:                            ; preds = %polly.loop_header280.us, %middle.block1399, %polly.loop_header272.us
...
polly.loop_header280.preheader.us:                ; preds = %polly.loop_header272.us
  %145 = add nuw nsw i64 %polly.indvar276.us, %125
  %polly.access.add.Packed_MemRef_call2292.us = add nsw i64 %141, %polly.access.mul.Packed_MemRef_call1287.us
  ...
  %min.iters.check1408 = icmp ult i64 %140, 4
  br i1 %min.iters.check1408, label %polly.loop_header280.us.preheader, label %vector.ph1409

vector.ph1409:                                    ; preds = %polly.loop_header280.preheader.us
  %n.vec1411 = and i64 %140, -4
  %broadcast.splatinsert1417 = insertelement <4 x double> poison, double %_p_scalar_294.us, i32 0
  %broadcast.splat1418 = shufflevector <4 x double> %broadcast.splatinsert1417, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1420 = insertelement <4 x double> poison, double %_p_scalar_302.us, i32 0
...
vector.body1401:                                  ; preds = %vector.body1401, %vector.ph1409
  ...
  %147 = add nuw nsw i64 %index1412, %112
  %148 = add nuw nsw i64 %index1412, %polly.access.mul.Packed_MemRef_call1287.us
  ...
  %wide.load1422 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !71, !noalias !73
  ...
  store <4 x double> %161, <4 x double>* %162, align 8, !alias.scope !71, !noalias !73
...
middle.block1399:                                 ; preds = %vector.body1401
  %cmp.n1415 = icmp eq i64 %140, %n.vec1411
  br i1 %cmp.n1415, label %polly.loop_exit282.us, label %polly.loop_header280.us.preheader

polly.loop_header280.us.preheader:                ; preds = %polly.loop_header280.preheader.us, %middle.block1399
  %polly.indvar284.us.ph = phi i64 [ 0, %polly.loop_header280.preheader.us ], [ %n.vec1411, %middle.block1399 ]
  br label %polly.loop_header280.us

polly.loop_exit274.loopexit.us:                   ; preds = %polly.loop_exit282.us
  %polly.indvar_next269.us = add nuw nsw i64 %polly.indvar268.us, 1
  %exitcond1101.not = icmp eq i64 %polly.indvar_next269.us, 20
...
polly.loop_header251:                             ; preds = %polly.loop_header234, %polly.loop_header251
  ...
  %164 = add nuw nsw i64 %polly.indvar255, %112
...
vector.body1337:                                  ; preds = %vector.body1337, %vector.ph1341
  ...
  %167 = shl nuw nsw i64 %index1344, 3
  %168 = getelementptr i8, i8* %scevgep408, i64 %167
  %169 = bitcast i8* %168 to <4 x double>*
  %wide.load1348 = load <4 x double>, <4 x double>* %169, align 8, !alias.scope !85, !noalias !87
  %170 = fmul fast <4 x double> %wide.load1348, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %172 = icmp eq i64 %index.next1345, %n.vec1343
  br i1 %172, label %middle.block1335, label %vector.body1337, !llvm.loop !92

middle.block1335:                                 ; preds = %vector.body1337
  %cmp.n1347 = icmp eq i64 %165, %n.vec1343
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_header402
  ...
  br i1 %exitcond1133.not, label %polly.loop_exit404, label %polly.loop_header402, !llvm.loop !93
...
polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  ...
  %174 = mul nuw nsw i64 %polly.indvar415, 20
  br label %polly.loop_header418

polly.loop_exit420:                               ; preds = %polly.loop_exit443
  %polly.indvar_next416 = add nuw nsw i64 %polly.indvar415, 1
  %exitcond1132.not = icmp eq i64 %polly.indvar_next416, 50
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %175 = shl nuw nsw i64 %polly.indvar421, 7
  %176 = mul nuw nsw i64 %polly.indvar421, 6
  %177 = shl nuw nsw i64 %polly.indvar421, 1
  %178 = udiv i64 %177, 5
  %179 = add nuw i64 %176, %178
  %180 = mul nuw nsw i64 %179, 20
  %181 = sub i64 %175, %180
  %182 = mul nsw i64 %polly.indvar421, -128
  %183 = add i64 %182, %180
  %184 = udiv i64 %indvars.iv1117, 5
  %185 = add nuw i64 %indvars.iv1115, %184
  %186 = mul nuw nsw i64 %185, 20
  %187 = sub i64 %indvars.iv1113, %186
  %188 = add i64 %indvars.iv1122, %186
  %189 = shl nsw i64 %polly.indvar421, 7
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %190 = mul nsw i64 %polly.indvar421, -128
  %191 = mul nuw nsw i64 %polly.indvar421, 6
  %192 = shl nuw nsw i64 %polly.indvar421, 1
  %pexp.p_div_q440 = udiv i64 %192, 5
  %193 = add nuw nsw i64 %pexp.p_div_q440, %191
...
polly.loop_header424:                             ; preds = %polly.loop_exit432, %polly.loop_header418
  ...
  %194 = add nuw nsw i64 %polly.indvar427, %174
...
polly.loop_exit432:                               ; preds = %polly.loop_header430
  ...
  %exitcond1109.not = icmp eq i64 %polly.indvar_next428, 20
  br i1 %exitcond1109.not, label %polly.loop_exit426, label %polly.loop_header424
...
polly.loop_header430:                             ; preds = %polly.loop_header430, %polly.loop_header424
  ...
  %195 = add nuw nsw i64 %polly.indvar433, %189
  ...
  br i1 %exitcond1108.not, label %polly.loop_exit432, label %polly.loop_header430
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit426
  ...
  %indvars.iv1124 = phi i64 [ %indvars.iv.next1125, %polly.loop_exit482 ], [ %188, %polly.loop_exit426 ]
  %indvars.iv1119 = phi i64 [ %indvars.iv.next1120, %polly.loop_exit482 ], [ %187, %polly.loop_exit426 ]
  %polly.indvar444 = phi i64 [ %polly.indvar_next445, %polly.loop_exit482 ], [ %193, %polly.loop_exit426 ]
  %196 = mul nsw i64 %indvar1352, -20
  %197 = add i64 %181, %196
  %smax1354 = call i64 @llvm.smax.i64(i64 %197, i64 0)
  %198 = mul nuw nsw i64 %indvar1352, 20
  %199 = add i64 %183, %198
  %200 = add i64 %smax1354, %199
  %smax1121 = call i64 @llvm.smax.i64(i64 %indvars.iv1119, i64 0)
  %201 = add i64 %smax1121, %indvars.iv1124
  %202 = mul nuw nsw i64 %polly.indvar444, 20
  ...
  %polly.loop_guard469.not = icmp sgt i64 %207, %208
...
polly.loop_header447.us:                          ; preds = %polly.loop_header441, %polly.loop_exit468.us
  ...
  %209 = add nuw nsw i64 %polly.indvar450.us, %174
...
polly.loop_header454.us:                          ; preds = %polly.loop_header447.us, %polly.loop_header454.us
  ...
  %exitcond1111.not = icmp eq i64 %polly.indvar458.us, %205
...
polly.loop_header466.us:                          ; preds = %polly.loop_exit456.loopexit.us, %polly.loop_header466.us
  ...
  %211 = add nuw nsw i64 %polly.indvar470.us, %189
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_exit456.loopexit.us
  ...
  %exitcond1112.not = icmp eq i64 %polly.indvar_next451.us, 20
  br i1 %exitcond1112.not, label %polly.loop_header480.preheader, label %polly.loop_header447.us
...
polly.loop_header447:                             ; preds = %polly.loop_header441.split, %polly.loop_exit468
  ...
  %212 = add nuw nsw i64 %polly.indvar450, %174
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1110.not = icmp eq i64 %polly.indvar_next451, 20
  br i1 %exitcond1110.not, label %polly.loop_header480.preheader, label %polly.loop_header447

polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header441.split
  %213 = sub nsw i64 %189, %202
  %214 = icmp sgt i64 %213, 0
  %215 = select i1 %214, i64 %213, i64 0
  %polly.loop_guard490 = icmp slt i64 %215, 20
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  %indvar1355 = phi i64 [ 0, %polly.loop_header480.us ], [ %indvar.next1356, %polly.loop_exit497.us ]
  %indvars.iv1126 = phi i64 [ %201, %polly.loop_header480.us ], [ %indvars.iv.next1127, %polly.loop_exit497.us ]
  %polly.indvar491.us = phi i64 [ %215, %polly.loop_header480.us ], [ %polly.indvar_next492.us, %polly.loop_exit497.us ]
  %216 = add i64 %200, %indvar1355
  %smin1357 = call i64 @llvm.smin.i64(i64 %216, i64 127)
  %217 = add nsw i64 %smin1357, 1
  %smin1128 = call i64 @llvm.smin.i64(i64 %indvars.iv1126, i64 127)
  %218 = add nsw i64 %polly.indvar491.us, %203
  %polly.loop_guard498.us1199 = icmp sgt i64 %218, -1
...
polly.loop_header495.us:                          ; preds = %polly.loop_header495.us.preheader, %polly.loop_header495.us
  ...
  %219 = add nuw nsw i64 %polly.indvar499.us, %189
...
polly.loop_exit497.us:                            ; preds = %polly.loop_header495.us, %middle.block1349, %polly.loop_header487.us
...
polly.loop_header495.preheader.us:                ; preds = %polly.loop_header487.us
  %222 = add nuw nsw i64 %polly.indvar491.us, %202
  %polly.access.add.Packed_MemRef_call2313507.us = add nsw i64 %218, %polly.access.mul.Packed_MemRef_call1311502.us
  ...
  %min.iters.check1358 = icmp ult i64 %217, 4
  br i1 %min.iters.check1358, label %polly.loop_header495.us.preheader, label %vector.ph1359

vector.ph1359:                                    ; preds = %polly.loop_header495.preheader.us
  %n.vec1361 = and i64 %217, -4
  %broadcast.splatinsert1367 = insertelement <4 x double> poison, double %_p_scalar_509.us, i32 0
  %broadcast.splat1368 = shufflevector <4 x double> %broadcast.splatinsert1367, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1370 = insertelement <4 x double> poison, double %_p_scalar_517.us, i32 0
...
vector.body1351:                                  ; preds = %vector.body1351, %vector.ph1359
  ...
  %224 = add nuw nsw i64 %index1362, %189
  %225 = add nuw nsw i64 %index1362, %polly.access.mul.Packed_MemRef_call1311502.us
  %226 = getelementptr double, double* %Packed_MemRef_call1311, i64 %225
  %227 = bitcast double* %226 to <4 x double>*
  %wide.load1366 = load <4 x double>, <4 x double>* %227, align 8
  %228 = fmul fast <4 x double> %broadcast.splat1368, %wide.load1366
  %229 = getelementptr double, double* %Packed_MemRef_call2313, i64 %225
  %230 = bitcast double* %229 to <4 x double>*
  %wide.load1369 = load <4 x double>, <4 x double>* %230, align 8
  %231 = fmul fast <4 x double> %broadcast.splat1371, %wide.load1369
  %232 = shl i64 %224, 3
  %233 = add i64 %232, %223
  %234 = getelementptr i8, i8* %call, i64 %233
  %235 = bitcast i8* %234 to <4 x double>*
  %wide.load1372 = load <4 x double>, <4 x double>* %235, align 8, !alias.scope !85, !noalias !87
  ...
  %238 = fadd fast <4 x double> %237, %wide.load1372
  ...
  %240 = icmp eq i64 %index.next1363, %n.vec1361
  br i1 %240, label %middle.block1349, label %vector.body1351, !llvm.loop !97

middle.block1349:                                 ; preds = %vector.body1351
  %cmp.n1365 = icmp eq i64 %217, %n.vec1361
  br i1 %cmp.n1365, label %polly.loop_exit497.us, label %polly.loop_header495.us.preheader

polly.loop_header495.us.preheader:                ; preds = %polly.loop_header495.preheader.us, %middle.block1349
  %polly.indvar499.us.ph = phi i64 [ 0, %polly.loop_header495.preheader.us ], [ %n.vec1361, %middle.block1349 ]
...
polly.loop_header466:                             ; preds = %polly.loop_header447, %polly.loop_header466
  ...
  %241 = add nuw nsw i64 %polly.indvar470, %189
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1290 = icmp ult i64 %242, 4
...
vector.body1289:                                  ; preds = %vector.body1289, %vector.ph1291
  ...
  %244 = shl nuw nsw i64 %index1294, 3
  %245 = getelementptr i8, i8* %scevgep623, i64 %244
  %246 = bitcast i8* %245 to <4 x double>*
  %wide.load1298 = load <4 x double>, <4 x double>* %246, align 8, !alias.scope !98, !noalias !100
  %247 = fmul fast <4 x double> %wide.load1298, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %248 = bitcast i8* %245 to <4 x double>*
  store <4 x double> %247, <4 x double>* %248, align 8, !alias.scope !98, !noalias !100
  %index.next1295 = add i64 %index1294, 4
  %249 = icmp eq i64 %index.next1295, %n.vec1293
  br i1 %249, label %middle.block1287, label %vector.body1289, !llvm.loop !105

middle.block1287:                                 ; preds = %vector.body1289
  %cmp.n1297 = icmp eq i64 %242, %n.vec1293
...
polly.loop_header617:                             ; preds = %polly.loop_header617.preheader, %polly.loop_header617
  ...
  br i1 %exitcond1162.not, label %polly.loop_exit619, label %polly.loop_header617, !llvm.loop !106

polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  %polly.indvar630 = phi i64 [ %polly.indvar_next631, %polly.loop_exit635 ], [ 0, %polly.loop_header627.preheader ]
  %251 = mul nuw nsw i64 %polly.indvar630, 20
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %252 = shl nuw nsw i64 %polly.indvar636, 7
  %253 = mul nuw nsw i64 %polly.indvar636, 6
  %254 = shl nuw nsw i64 %polly.indvar636, 1
  %255 = udiv i64 %254, 5
  %256 = add nuw i64 %253, %255
  %257 = mul nuw nsw i64 %256, 20
  %258 = sub i64 %252, %257
  %259 = mul nsw i64 %polly.indvar636, -128
  %260 = add i64 %259, %257
  %261 = udiv i64 %indvars.iv1146, 5
  %262 = add nuw i64 %indvars.iv1144, %261
  %263 = mul nuw nsw i64 %262, 20
  %264 = sub i64 %indvars.iv1142, %263
  %265 = add i64 %indvars.iv1151, %263
  %266 = shl nsw i64 %polly.indvar636, 7
  br label %polly.loop_header639

polly.loop_exit641:                               ; preds = %polly.loop_exit647
  %267 = mul nsw i64 %polly.indvar636, -128
  %268 = mul nuw nsw i64 %polly.indvar636, 6
  %269 = shl nuw nsw i64 %polly.indvar636, 1
  %pexp.p_div_q655 = udiv i64 %269, 5
  %270 = add nuw nsw i64 %pexp.p_div_q655, %268
...
polly.loop_header639:                             ; preds = %polly.loop_exit647, %polly.loop_header633
  ...
  %271 = add nuw nsw i64 %polly.indvar642, %251
...
polly.loop_header645:                             ; preds = %polly.loop_header645, %polly.loop_header639
  ...
  %272 = add nuw nsw i64 %polly.indvar648, %266
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit641
  ...
  %indvars.iv1153 = phi i64 [ %indvars.iv.next1154, %polly.loop_exit697 ], [ %265, %polly.loop_exit641 ]
  %indvars.iv1148 = phi i64 [ %indvars.iv.next1149, %polly.loop_exit697 ], [ %264, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit697 ], [ %270, %polly.loop_exit641 ]
  %273 = mul nsw i64 %indvar1302, -20
  %274 = add i64 %258, %273
  %smax1304 = call i64 @llvm.smax.i64(i64 %274, i64 0)
  %275 = mul nuw nsw i64 %indvar1302, 20
  %276 = add i64 %260, %275
  %277 = add i64 %smax1304, %276
  %smax1150 = call i64 @llvm.smax.i64(i64 %indvars.iv1148, i64 0)
  %278 = add i64 %smax1150, %indvars.iv1153
  %279 = mul nuw nsw i64 %polly.indvar659, 20
  %280 = add nsw i64 %279, %267
  %281 = add nsw i64 %280, -1
  %.inv943 = icmp sgt i64 %280, 127
  %282 = select i1 %.inv943, i64 127, i64 %281
  %polly.loop_guard672 = icmp sgt i64 %282, -1
  %283 = icmp sgt i64 %280, 0
  %284 = select i1 %283, i64 %280, i64 0
  %285 = add nsw i64 %280, 19
  %polly.loop_guard684.not = icmp sgt i64 %284, %285
...
polly.loop_header662.us:                          ; preds = %polly.loop_header656, %polly.loop_exit683.us
  ...
  %286 = add nuw nsw i64 %polly.indvar665.us, %251
...
polly.loop_header669.us:                          ; preds = %polly.loop_header662.us, %polly.loop_header669.us
  ...
  %287 = add nuw nsw i64 %polly.indvar673.us, %266
  %polly.access.mul.call1677.us = mul nuw nsw i64 %287, 1000
  %polly.access.add.call1678.us = add nuw nsw i64 %286, %polly.access.mul.call1677.us
  ...
  %exitcond1140.not = icmp eq i64 %polly.indvar673.us, %282
...
polly.loop_header681.us:                          ; preds = %polly.loop_exit671.loopexit.us, %polly.loop_header681.us
  ...
  %288 = add nuw nsw i64 %polly.indvar685.us, %266
  %polly.access.mul.call1689.us = mul nsw i64 %288, 1000
  %polly.access.add.call1690.us = add nuw nsw i64 %286, %polly.access.mul.call1689.us
  ...
  %polly.loop_cond687.not.not.us = icmp slt i64 %polly.indvar685.us, %285
...
polly.loop_exit683.us:                            ; preds = %polly.loop_header681.us, %polly.loop_exit671.loopexit.us
  ...
  br i1 %exitcond1141.not, label %polly.loop_header695.preheader, label %polly.loop_header662.us
...
polly.loop_header662:                             ; preds = %polly.loop_header656.split, %polly.loop_exit683
  ...
  %289 = add nuw nsw i64 %polly.indvar665, %251
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  %indvar1305 = phi i64 [ 0, %polly.loop_header695.us ], [ %indvar.next1306, %polly.loop_exit712.us ]
  %indvars.iv1155 = phi i64 [ %278, %polly.loop_header695.us ], [ %indvars.iv.next1156, %polly.loop_exit712.us ]
  %polly.indvar706.us = phi i64 [ %292, %polly.loop_header695.us ], [ %polly.indvar_next707.us, %polly.loop_exit712.us ]
  %293 = add i64 %277, %indvar1305
  %smin1307 = call i64 @llvm.smin.i64(i64 %293, i64 127)
  %294 = add nsw i64 %smin1307, 1
  %smin1157 = call i64 @llvm.smin.i64(i64 %indvars.iv1155, i64 127)
  %295 = add nsw i64 %polly.indvar706.us, %280
  %polly.loop_guard713.us1200 = icmp sgt i64 %295, -1
...
polly.loop_header710.us:                          ; preds = %polly.loop_header710.us.preheader, %polly.loop_header710.us
  ...
  %296 = add nuw nsw i64 %polly.indvar714.us, %266
  ...
  %297 = shl i64 %296, 3
  %298 = add i64 %297, %300
  %scevgep733.us = getelementptr i8, i8* %call, i64 %298
  ...
  br i1 %exitcond1158.not, label %polly.loop_exit712.us, label %polly.loop_header710.us, !llvm.loop !109

polly.loop_exit712.us:                            ; preds = %polly.loop_header710.us, %middle.block1299, %polly.loop_header702.us
...
polly.loop_header710.preheader.us:                ; preds = %polly.loop_header702.us
  %299 = add nuw nsw i64 %polly.indvar706.us, %279
  %polly.access.add.Packed_MemRef_call2528722.us = add nsw i64 %295, %polly.access.mul.Packed_MemRef_call1526717.us
  ...
  %min.iters.check1308 = icmp ult i64 %294, 4
  br i1 %min.iters.check1308, label %polly.loop_header710.us.preheader, label %vector.ph1309

vector.ph1309:                                    ; preds = %polly.loop_header710.preheader.us
  %n.vec1311 = and i64 %294, -4
  %broadcast.splatinsert1317 = insertelement <4 x double> poison, double %_p_scalar_724.us, i32 0
  %broadcast.splat1318 = shufflevector <4 x double> %broadcast.splatinsert1317, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1320 = insertelement <4 x double> poison, double %_p_scalar_732.us, i32 0
...
vector.body1301:                                  ; preds = %vector.body1301, %vector.ph1309
  ...
  %301 = add nuw nsw i64 %index1312, %266
  %302 = add nuw nsw i64 %index1312, %polly.access.mul.Packed_MemRef_call1526717.us
  %303 = getelementptr double, double* %Packed_MemRef_call1526, i64 %302
  %304 = bitcast double* %303 to <4 x double>*
  %wide.load1316 = load <4 x double>, <4 x double>* %304, align 8
  %305 = fmul fast <4 x double> %broadcast.splat1318, %wide.load1316
  %306 = getelementptr double, double* %Packed_MemRef_call2528, i64 %302
  %307 = bitcast double* %306 to <4 x double>*
  %wide.load1319 = load <4 x double>, <4 x double>* %307, align 8
  %308 = fmul fast <4 x double> %broadcast.splat1321, %wide.load1319
  %309 = shl i64 %301, 3
  %310 = add i64 %309, %300
  %311 = getelementptr i8, i8* %call, i64 %310
  %312 = bitcast i8* %311 to <4 x double>*
  %wide.load1322 = load <4 x double>, <4 x double>* %312, align 8, !alias.scope !98, !noalias !100
  ...
  %315 = fadd fast <4 x double> %314, %wide.load1322
  %316 = bitcast i8* %311 to <4 x double>*
  store <4 x double> %315, <4 x double>* %316, align 8, !alias.scope !98, !noalias !100
  %index.next1313 = add i64 %index1312, 4
  %317 = icmp eq i64 %index.next1313, %n.vec1311
  br i1 %317, label %middle.block1299, label %vector.body1301, !llvm.loop !110

middle.block1299:                                 ; preds = %vector.body1301
  %cmp.n1315 = icmp eq i64 %294, %n.vec1311
  br i1 %cmp.n1315, label %polly.loop_exit712.us, label %polly.loop_header710.us.preheader

polly.loop_header710.us.preheader:                ; preds = %polly.loop_header710.preheader.us, %middle.block1299
  %polly.indvar714.us.ph = phi i64 [ 0, %polly.loop_header710.preheader.us ], [ %n.vec1311, %middle.block1299 ]
...
polly.loop_exit704.loopexit.us:                   ; preds = %polly.loop_exit712.us
  ...
  %exitcond1159.not = icmp eq i64 %polly.indvar_next699.us, 20
...
polly.loop_header681:                             ; preds = %polly.loop_header662, %polly.loop_header681
  ...
  %318 = add nuw nsw i64 %polly.indvar685, %266
  %polly.access.mul.call1689 = mul nsw i64 %318, 1000
  %polly.access.add.call1690 = add nuw nsw i64 %289, %polly.access.mul.call1689
  ...
  %polly.loop_cond687.not.not = icmp slt i64 %polly.indvar685, %285
...
polly.loop_header868:                             ; preds = %polly.loop_exit876, %polly.loop_header862
  ...
  %smin1228 = call i64 @llvm.smin.i64(i64 %321, i64 -1168)
  %322 = add nsw i64 %smin1228, 1200
  %smin1186 = call i64 @llvm.smin.i64(i64 %indvars.iv1184, i64 -1168)
  %323 = shl nsw i64 %polly.indvar871, 5
  %324 = add nsw i64 %smin1186, 1199
...
vector.ph1229:                                    ; preds = %polly.loop_header874
  %broadcast.splatinsert1236 = insertelement <4 x i64> poison, i64 %323, i32 0
...
vector.body1227:                                  ; preds = %vector.body1227, %vector.ph1229
  ...
  %328 = add nuw nsw <4 x i64> %vec.ind1234, %broadcast.splat1237
  %329 = trunc <4 x i64> %328 to <4 x i32>
  %330 = mul <4 x i32> %broadcast.splat1239, %329
  ...
  store <4 x double> %334, <4 x double>* %339, align 8, !alias.scope !111, !noalias !113
  %index.next1231 = add i64 %index1230, 4
  %vec.ind.next1235 = add <4 x i64> %vec.ind1234, <i64 4, i64 4, i64 4, i64 4>
  %340 = icmp eq i64 %index.next1231, %322
  br i1 %340, label %polly.loop_exit882, label %vector.body1227, !llvm.loop !116

polly.loop_exit882:                               ; preds = %vector.body1227, %polly.loop_header880
  %polly.indvar_next878 = add nuw nsw i64 %polly.indvar877, 1
  %exitcond1191.not = icmp eq i64 %polly.indvar877, %320
...
polly.loop_header880:                             ; preds = %polly.loop_header874, %polly.loop_header880
  ...
  %exitcond1187.not = icmp eq i64 %polly.indvar883, %324
  br i1 %exitcond1187.not, label %polly.loop_exit882, label %polly.loop_header880, !llvm.loop !117
...
polly.loop_header895:                             ; preds = %polly.loop_exit903, %polly.loop_header889
  ...
  %smin1243 = call i64 @llvm.smin.i64(i64 %350, i64 -968)
  %351 = add nsw i64 %smin1243, 1000
  %smin1176 = call i64 @llvm.smin.i64(i64 %indvars.iv1174, i64 -968)
  %352 = shl nsw i64 %polly.indvar898, 5
  %353 = add nsw i64 %smin1176, 999
...
vector.body1242:                                  ; preds = %vector.body1242, %vector.ph1245
  ...
  %357 = add nuw nsw <4 x i64> %vec.ind1252, %broadcast.splat1255
  %358 = trunc <4 x i64> %357 to <4 x i32>
  %359 = mul <4 x i32> %broadcast.splat1257, %358
  ...
  store <4 x double> %363, <4 x double>* %368, align 8, !alias.scope !115, !noalias !118
  %index.next1249 = add i64 %index1248, 4
  %vec.ind.next1253 = add <4 x i64> %vec.ind1252, <i64 4, i64 4, i64 4, i64 4>
  %369 = icmp eq i64 %index.next1249, %351
  br i1 %369, label %polly.loop_exit909, label %vector.body1242, !llvm.loop !119

polly.loop_exit909:                               ; preds = %vector.body1242, %polly.loop_header907
  %polly.indvar_next905 = add nuw nsw i64 %polly.indvar904, 1
  %exitcond1181.not = icmp eq i64 %polly.indvar904, %349
...
polly.loop_header907:                             ; preds = %polly.loop_header901, %polly.loop_header907
  ...
  %exitcond1177.not = icmp eq i64 %polly.indvar910, %353
  br i1 %exitcond1177.not, label %polly.loop_exit909, label %polly.loop_header907, !llvm.loop !120
...
polly.loop_header921:                             ; preds = %polly.loop_exit929, %polly.loop_header915
  ...
  %smin1261 = call i64 @llvm.smin.i64(i64 %379, i64 -968)
  %380 = add nsw i64 %smin1261, 1000
  %smin1166 = call i64 @llvm.smin.i64(i64 %indvars.iv1164, i64 -968)
  %381 = shl nsw i64 %polly.indvar924, 5
  %382 = add nsw i64 %smin1166, 999
...
vector.body1260:                                  ; preds = %vector.body1260, %vector.ph1263
  ...
  %386 = add nuw nsw <4 x i64> %vec.ind1270, %broadcast.splat1273
  %387 = trunc <4 x i64> %386 to <4 x i32>
  %388 = mul <4 x i32> %broadcast.splat1275, %387
  ...
  store <4 x double> %392, <4 x double>* %397, align 8, !alias.scope !114, !noalias !121
  %index.next1267 = add i64 %index1266, 4
  %vec.ind.next1271 = add <4 x i64> %vec.ind1270, <i64 4, i64 4, i64 4, i64 4>
  %398 = icmp eq i64 %index.next1267, %380
  br i1 %398, label %polly.loop_exit935, label %vector.body1260, !llvm.loop !122

polly.loop_exit935:                               ; preds = %vector.body1260, %polly.loop_header933
  %polly.indvar_next931 = add nuw nsw i64 %polly.indvar930, 1
  %exitcond1171.not = icmp eq i64 %polly.indvar930, %378
...
polly.loop_header933:                             ; preds = %polly.loop_header927, %polly.loop_header933
  ...
  %exitcond1167.not = icmp eq i64 %polly.indvar936, %382
  br i1 %exitcond1167.not, label %polly.loop_exit935, label %polly.loop_header933, !llvm.loop !123
}
