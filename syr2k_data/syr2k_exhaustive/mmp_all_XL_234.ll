; ModuleID = 'syr2k_exhaustive/mmp_all_XL_234.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_234.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %102 = sub i64 %97, %101
  %103 = mul nsw i64 %polly.indvar203, -20
  %104 = add i64 %103, %101
...
polly.loop_exit224:                               ; preds = %polly.loop_exit261
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar_next204, 60
...
polly.loop_header266.us:                          ; preds = %polly.loop_header259.us, %polly.loop_exit276.us
  ...
  %smin1374 = call i64 @llvm.smin.i64(i64 %133, i64 19)
  %134 = add nsw i64 %smin1374, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1072, i64 19)
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit431
  ...
  %181 = mul nuw nsw i64 %polly.indvar409, 20
  br label %polly.loop_header412

polly.loop_exit414:                               ; preds = %polly.loop_exit420
  %182 = mul nsw i64 %polly.indvar409, -20
...
polly.loop_exit431:                               ; preds = %polly.loop_exit470
  ...
  %exitcond1102.not = icmp eq i64 %polly.indvar_next410, 60
...
polly.loop_header429:                             ; preds = %polly.loop_exit470, %polly.loop_exit414
  ...
  %.inv924 = icmp sgt i64 %193, 19
  %195 = select i1 %.inv924, i64 19, i64 %194
...
polly.loop_header475.us:                          ; preds = %polly.loop_header468.us, %polly.loop_exit485.us
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %204, i64 19)
  %205 = add nsw i64 %smin1324, 1
  %smin1099 = call i64 @llvm.smin.i64(i64 %indvars.iv1097, i64 19)
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %252 = mul nuw nsw i64 %polly.indvar618, 20
  br label %polly.loop_header621

polly.loop_exit623:                               ; preds = %polly.loop_exit629
  %253 = mul nsw i64 %polly.indvar618, -20
...
polly.loop_exit640:                               ; preds = %polly.loop_exit679
  ...
  %indvars.iv.next1106 = add nsw i64 %indvars.iv1105, -20
  %indvars.iv.next1113 = add nuw nsw i64 %indvars.iv1112, 20
  %indvars.iv.next1115 = add nuw nsw i64 %indvars.iv1114, 2
  %indvars.iv.next1120 = add nsw i64 %indvars.iv1119, -20
  %exitcond1128.not = icmp eq i64 %polly.indvar_next619, 60
...
polly.loop_header684.us:                          ; preds = %polly.loop_header677.us, %polly.loop_exit694.us
  ...
  %smin1274 = call i64 @llvm.smin.i64(i64 %275, i64 19)
  %276 = add nsw i64 %smin1274, 1
  %smin1125 = call i64 @llvm.smin.i64(i64 %indvars.iv1123, i64 19)
