; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2177.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2177.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 -1136)
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %101 = mul nsw i64 %polly.indvar225, -256
  %102 = add i64 %97, %101
  %103 = shl nsw i64 %polly.indvar225, 8
...
polly.loop_header228:                             ; preds = %polly.loop_exit259, %polly.loop_header222
  ...
  %smin1310 = call i64 @llvm.smin.i64(i64 %106, i64 255)
...
polly.loop_header412:                             ; preds = %polly.loop_exit404, %polly.loop_exit421
  ...
  %142 = shl nuw nsw i64 %polly.indvar415, 6
  %143 = lshr i64 %polly.indvar415, 2
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1050, i64 -1136)
  %144 = shl nsw i64 %polly.indvar415, 6
...
polly.loop_exit421:                               ; preds = %polly.loop_exit427
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar_next416, 19
...
polly.loop_header419:                             ; preds = %polly.loop_exit427, %polly.loop_header412
  ...
  %146 = mul nsw i64 %polly.indvar422, -256
  %147 = add i64 %142, %146
  %148 = shl nsw i64 %polly.indvar422, 8
...
polly.loop_header425:                             ; preds = %polly.loop_exit462, %polly.loop_header419
  ...
  %smin1265 = call i64 @llvm.smin.i64(i64 %151, i64 255)
  %152 = add nsw i64 %smin1265, 1
  %smin1047 = call i64 @llvm.smin.i64(i64 %indvars.iv1042, i64 255)
...
polly.loop_header615:                             ; preds = %polly.loop_exit607, %polly.loop_exit624
  ...
  %187 = shl nuw nsw i64 %polly.indvar618, 6
  %188 = lshr i64 %polly.indvar618, 2
  %smin1075 = call i64 @llvm.smin.i64(i64 %indvars.iv1073, i64 -1136)
  %189 = shl nsw i64 %polly.indvar618, 6
  %190 = add nsw i64 %smin1075, 1199
  br label %polly.loop_header622

polly.loop_exit624:                               ; preds = %polly.loop_exit630
  %polly.indvar_next619 = add nuw nsw i64 %polly.indvar618, 1
  %indvars.iv.next1062 = add nuw nsw i64 %indvars.iv1061, 64
  %indvars.iv.next1074 = add nsw i64 %indvars.iv1073, -64
  %exitcond1078.not = icmp eq i64 %polly.indvar_next619, 19
...
polly.loop_header622:                             ; preds = %polly.loop_exit630, %polly.loop_header615
  ...
  %191 = mul nsw i64 %polly.indvar625, -256
  %192 = add i64 %187, %191
  %193 = shl nsw i64 %polly.indvar625, 8
  %194 = sub nsw i64 %189, %193
  %195 = add nuw nsw i64 %193, 256
...
polly.loop_exit630:                               ; preds = %polly.loop_exit665
  ...
  %indvars.iv.next1064 = add nsw i64 %indvars.iv1063, -256
...
polly.loop_header628:                             ; preds = %polly.loop_exit665, %polly.loop_header622
  ...
  %smin1220 = call i64 @llvm.smin.i64(i64 %196, i64 255)
  %197 = add nsw i64 %smin1220, 1
  %smin1070 = call i64 @llvm.smin.i64(i64 %indvars.iv1065, i64 255)
