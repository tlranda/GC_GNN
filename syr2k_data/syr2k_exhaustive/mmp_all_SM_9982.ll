; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9982.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9982.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %99 = mul nuw nsw i64 %polly.indvar214, 50
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph977
  ...
  %wide.load984 = load <4 x double>, <4 x double>* %117, align 8, !alias.scope !67, !noalias !69
  ...
  store <4 x double> %118, <4 x double>* %119, align 8, !alias.scope !67, !noalias !69
  %index.next981 = add i64 %index980, 4
  %120 = icmp eq i64 %index.next981, %n.vec979
  br i1 %120, label %middle.block971, label %vector.body973, !llvm.loop !72
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %122 = mul nuw nsw i64 %polly.indvar355, 50
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %123 = mul nuw nsw i64 %polly.indvar361, 50
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %124 = mul nuw nsw i64 %polly.indvar367, 50
...
vector.body949:                                   ; preds = %vector.body949, %vector.ph951
  ...
  %wide.load958 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !76, !noalias !78
  ...
  store <4 x double> %143, <4 x double>* %144, align 8, !alias.scope !76, !noalias !78
  %index.next955 = add i64 %index954, 4
  %145 = icmp eq i64 %index.next955, %n.vec953
  br i1 %145, label %middle.block947, label %vector.body949, !llvm.loop !81
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %147 = mul nuw nsw i64 %polly.indvar510, 50
...
polly.loop_header513:                             ; preds = %polly.loop_exit521, %polly.loop_header507
  ...
  %148 = mul nuw nsw i64 %polly.indvar516, 50
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %149 = mul nuw nsw i64 %polly.indvar522, 50
...
vector.body887:                                   ; preds = %vector.body887, %vector.ph889
  ...
  store <4 x double> %178, <4 x double>* %183, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %184, label %polly.loop_exit706, label %vector.body887, !llvm.loop !90
...
vector.body902:                                   ; preds = %vector.body902, %vector.ph905
  ...
  store <4 x double> %207, <4 x double>* %212, align 8, !alias.scope !89, !noalias !92
  ...
  br i1 %213, label %polly.loop_exit733, label %vector.body902, !llvm.loop !93
...
vector.body920:                                   ; preds = %vector.body920, %vector.ph923
  ...
  store <4 x double> %236, <4 x double>* %241, align 8, !alias.scope !88, !noalias !95
  ...
  br i1 %242, label %polly.loop_exit759, label %vector.body920, !llvm.loop !96
