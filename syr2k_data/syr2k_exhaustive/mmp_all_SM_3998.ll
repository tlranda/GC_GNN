; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3998.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3998.c"
...
vector.body1189:                                  ; preds = %vector.body1189, %vector.ph1193
  ...
  %wide.load1200 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %138, label %middle.block1187, label %vector.body1189, !llvm.loop !79
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %141 = mul nsw i64 %polly.indvar386, -4
  %142 = shl nsw i64 %polly.indvar386, 2
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %polly.loop_guard406 = icmp slt i64 %157, 4
...
vector.body1165:                                  ; preds = %vector.body1165, %vector.ph1167
  ...
  %wide.load1174 = load <4 x double>, <4 x double>* %178, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %181, label %middle.block1163, label %vector.body1165, !llvm.loop !89
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %184 = mul nsw i64 %polly.indvar577, -4
  %185 = shl nsw i64 %polly.indvar577, 2
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %polly.loop_guard597 = icmp slt i64 %200, 4
...
vector.body1104:                                  ; preds = %vector.body1104, %vector.ph1105
  ...
  br i1 %238, label %polly.loop_exit807, label %vector.body1104, !llvm.loop !98
...
vector.body1118:                                  ; preds = %vector.body1118, %vector.ph1121
  ...
  br i1 %267, label %polly.loop_exit834, label %vector.body1118, !llvm.loop !101
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  br i1 %296, label %polly.loop_exit860, label %vector.body1136, !llvm.loop !104
