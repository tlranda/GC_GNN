; ModuleID = 'syr2k_exhaustive/mmp_all_SM_951.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_951.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1202 = call i64 @llvm.smin.i64(i64 %indvars.iv1174, i64 -872)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1205.not = icmp eq i64 %polly.indvar_next204, 8
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit435
  ...
  %smin1241 = call i64 @llvm.smin.i64(i64 %indvars.iv1211, i64 -872)
  %174 = add nsw i64 %smin1241, 1000
  %175 = shl nsw i64 %polly.indvar430, 7
...
polly.loop_exit435:                               ; preds = %polly.loop_exit459
  ...
  %indvars.iv.next1212 = add nsw i64 %indvars.iv1211, -128
  %exitcond1244.not = icmp eq i64 %polly.indvar_next431, 8
...
polly.loop_header661:                             ; preds = %polly.loop_header661.preheader, %polly.loop_exit669
  ...
  %smin1280 = call i64 @llvm.smin.i64(i64 %indvars.iv1250, i64 -872)
  %251 = add nsw i64 %smin1280, 1000
  %252 = shl nsw i64 %polly.indvar664, 7
...
polly.loop_exit669:                               ; preds = %polly.loop_exit693
  ...
  %exitcond1283.not = icmp eq i64 %polly.indvar_next665, 8
