; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5365.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5365.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %100 = mul nuw nsw i64 %polly.indvar208, 25
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv839, i64 99)
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842, i64 99)
  %107 = or i64 %103, 1
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.1, i64 99)
  %111 = or i64 %103, 2
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.2, i64 99)
  %115 = or i64 %103, 3
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %138 = mul nuw nsw i64 %polly.indvar381, 100
  br label %polly.loop_header384

polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %139 = mul nsw i64 %polly.indvar381, -100
  %140 = mul nuw nsw i64 %polly.indvar381, 25
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %smin859 = call i64 @llvm.smin.i64(i64 %indvars.iv855, i64 99)
  ...
  %smin859.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858, i64 99)
  %147 = or i64 %143, 1
  ...
  %smin859.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.1, i64 99)
  %151 = or i64 %143, 2
  ...
  %smin859.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.2, i64 99)
  %155 = or i64 %143, 3
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %178 = mul nuw nsw i64 %polly.indvar554, 100
  br label %polly.loop_header557

polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %179 = mul nsw i64 %polly.indvar554, -100
  %180 = mul nuw nsw i64 %polly.indvar554, 25
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit559
  ...
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv872, i64 99)
  ...
  %smin876.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875, i64 99)
  %187 = or i64 %183, 1
  ...
  %smin876.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.1, i64 99)
  %191 = or i64 %183, 2
  ...
  %smin876.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.2, i64 99)
  %195 = or i64 %183, 3
