; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2899.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2899.c"
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %160 = shl nsw i64 %polly.indvar386, 6
...
polly.loop_header389:                             ; preds = %polly.loop_exit430, %polly.loop_header383
  ...
  %.inv857 = icmp ugt i64 %162, 63
  %164 = select i1 %.inv857, i64 63, i64 %163
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %219 = shl nuw nsw i64 %polly.indvar572, 3
  %220 = mul nsw i64 %polly.indvar572, -64
  %221 = shl nsw i64 %polly.indvar572, 6
...
polly.loop_header575:                             ; preds = %polly.loop_exit616, %polly.loop_header569
  ...
  %.inv858 = icmp ugt i64 %223, 63
  %225 = select i1 %.inv858, i64 63, i64 %224
