; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9107.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9107.c"
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %108 = mul nsw i64 %polly.indvar208, -256
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %exitcond808.not = icmp eq i64 %polly.indvar_next209, 5
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %polly.loop_guard227 = icmp slt i64 %113, 100
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1011
  ...
  %wide.load1018 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %133, label %middle.block1005, label %vector.body1007, !llvm.loop !77
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %135 = shl nsw i64 %polly.indvar359, 4
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %polly.loop_guard373 = icmp slt i64 %142, 12
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %145 = shl nsw i64 %polly.indvar365, 8
  %146 = mul nsw i64 %polly.indvar365, -256
  br label %polly.loop_header370

polly.loop_exit372:                               ; preds = %polly.loop_exit379, %polly.loop_header362
  %polly.indvar_next366 = add nuw nsw i64 %polly.indvar365, 1
  %indvars.iv.next813 = add nsw i64 %indvars.iv812, -44
  %indvars.iv.next815 = add nuw nsw i64 %indvars.iv814, 11
  %indvars.iv.next820 = add nuw nsw i64 %indvars.iv819, 44
  %exitcond831.not = icmp eq i64 %polly.indvar_next366, 5
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %148 = mul nsw i64 %polly.indvar374, 100
  %149 = sub nsw i64 %145, %148
  %150 = icmp sgt i64 %149, 0
  %151 = select i1 %150, i64 %149, i64 0
  %polly.loop_guard387 = icmp slt i64 %151, 100
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph985
  ...
  %wide.load992 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !81, !noalias !83
  ...
  br i1 %171, label %middle.block981, label %vector.body983, !llvm.loop !86
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %173 = shl nsw i64 %polly.indvar519, 4
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %polly.loop_guard533 = icmp slt i64 %180, 12
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  ...
  %183 = shl nsw i64 %polly.indvar525, 8
  %184 = mul nsw i64 %polly.indvar525, -256
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header522
  ...
  %indvars.iv.next836 = add nsw i64 %indvars.iv835, -44
  %indvars.iv.next838 = add nuw nsw i64 %indvars.iv837, 11
  %indvars.iv.next843 = add nuw nsw i64 %indvars.iv842, 44
  %exitcond854.not = icmp eq i64 %polly.indvar_next526, 5
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %186 = mul nsw i64 %polly.indvar534, 100
  %187 = sub nsw i64 %183, %186
  %188 = icmp sgt i64 %187, 0
  %189 = select i1 %188, i64 %187, i64 0
  %polly.loop_guard547 = icmp slt i64 %189, 100
...
polly.loop_header544.us:                          ; preds = %polly.loop_header537.us, %polly.loop_exit554.us
  ...
  %smin848 = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 255)
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph923
  ...
  br i1 %223, label %polly.loop_exit720, label %vector.body921, !llvm.loop !95
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph939
  ...
  br i1 %252, label %polly.loop_exit747, label %vector.body936, !llvm.loop !98
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph957
  ...
  br i1 %281, label %polly.loop_exit773, label %vector.body954, !llvm.loop !101
