; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7584.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7584.c"
...
vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1037
  ...
  br i1 %57, label %middle.block1033, label %vector.body1035, !llvm.loop !54
...
vector.body1061:                                  ; preds = %vector.body1061, %vector.ph1063
  ...
  br i1 %68, label %middle.block1059, label %vector.body1061, !llvm.loop !56
...
vector.body1073:                                  ; preds = %vector.body1073, %vector.ph1077
  ...
  %wide.load1084 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !62, !noalias !64
  ...
  br i1 %95, label %middle.block1071, label %vector.body1073, !llvm.loop !68
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  ...
  %102 = mul nuw nsw i64 %polly.indvar224, 80
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1051
  ...
  %wide.load1058 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %129, label %middle.block1045, label %vector.body1047, !llvm.loop !79
...
polly.loop_header366:                             ; preds = %polly.loop_header366.preheader, %polly.loop_header366
  ...
  br i1 %exitcond882.not, label %polly.loop_exit368, label %polly.loop_header366, !llvm.loop !80
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  ...
  %136 = mul nuw nsw i64 %polly.indvar401, 80
...
polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar_next402, 13
...
vector.body1023:                                  ; preds = %vector.body1023, %vector.ph1025
  ...
  %wide.load1032 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %163, label %middle.block1021, label %vector.body1023, !llvm.loop !89
...
polly.loop_header546:                             ; preds = %polly.loop_header546.preheader, %polly.loop_header546
  ...
  br i1 %exitcond905.not, label %polly.loop_exit548, label %polly.loop_header546, !llvm.loop !90
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 -920)
  %170 = mul nuw nsw i64 %polly.indvar581, 80
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar_next582, 13
...
vector.body961:                                   ; preds = %vector.body961, %vector.ph963
  ...
  br i1 %211, label %polly.loop_exit778, label %vector.body961, !llvm.loop !98
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  br i1 %exitcond930.not, label %polly.loop_exit778, label %polly.loop_header776, !llvm.loop !99
...
vector.body976:                                   ; preds = %vector.body976, %vector.ph979
  ...
  br i1 %240, label %polly.loop_exit805, label %vector.body976, !llvm.loop !101
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  br i1 %exitcond920.not, label %polly.loop_exit805, label %polly.loop_header803, !llvm.loop !102
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph997
  ...
  br i1 %269, label %polly.loop_exit831, label %vector.body994, !llvm.loop !104
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  br i1 %exitcond910.not, label %polly.loop_exit831, label %polly.loop_header829, !llvm.loop !105
}
