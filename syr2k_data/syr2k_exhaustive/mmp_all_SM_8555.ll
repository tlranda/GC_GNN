; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8555.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8555.c"
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1002
  ...
  %wide.load1009 = load <4 x double>, <4 x double>* %133, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %136, label %middle.block996, label %vector.body998, !llvm.loop !77
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  %wide.load983 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !81, !noalias !83
  ...
  br i1 %177, label %middle.block972, label %vector.body974, !llvm.loop !86
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph914
  ...
  br i1 %232, label %polly.loop_exit714, label %vector.body912, !llvm.loop !95
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph930
  ...
  br i1 %261, label %polly.loop_exit741, label %vector.body927, !llvm.loop !98
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph948
  ...
  br i1 %290, label %polly.loop_exit767, label %vector.body945, !llvm.loop !101
