; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4966.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4966.c"
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %145 = udiv i64 %indvars.iv1020, 25
  %146 = sub nsw i64 %indvars.iv1018, %145
  %smin1022 = call i64 @llvm.smin.i64(i64 %146, i64 21)
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %193 = udiv i64 %indvars.iv1048, 25
  %194 = sub nsw i64 %indvars.iv1046, %193
  %smin1050 = call i64 @llvm.smin.i64(i64 %194, i64 21)
