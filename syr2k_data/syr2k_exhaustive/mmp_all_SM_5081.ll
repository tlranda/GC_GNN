; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5081.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5081.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next968 = add nuw nsw i64 %indvars.iv967, 96
...
polly.loop_exit213:                               ; preds = %polly.loop_exit244, %polly.loop_header205
  ...
  %indvars.iv.next970 = add nsw i64 %indvars.iv969, -256
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit388
  ...
  %129 = lshr i64 %indvars.iv1002, 3
  %130 = mul nsw i64 %polly.indvar382, -96
  %131 = icmp slt i64 %130, -1104
  %132 = select i1 %131, i64 %130, i64 -1104
  %133 = add nsw i64 %132, 1199
  %134 = mul nuw nsw i64 %polly.indvar382, 96
...
polly.loop_exit388:                               ; preds = %polly.loop_exit395
  ...
  %exitcond1005.not = icmp eq i64 %polly.indvar_next383, 13
...
polly.loop_header386:                             ; preds = %polly.loop_exit395, %polly.loop_header379
  ...
  %135 = shl nsw i64 %polly.indvar389, 8
...
polly.loop_header393.preheader:                   ; preds = %polly.loop_header386
  ...
  %141 = add nuw nsw i64 %135, 256
  br label %polly.loop_header393

polly.loop_exit395:                               ; preds = %polly.loop_exit431, %polly.loop_header386
  %polly.indvar_next390 = add nuw nsw i64 %polly.indvar389, 1
  %indvars.iv.next988 = add nsw i64 %indvars.iv987, 256
  %indvars.iv.next993 = add nsw i64 %indvars.iv992, -256
  %exitcond1004.not = icmp eq i64 %polly.indvar389, %129
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit431
  ...
  %smin999 = call i64 @llvm.smin.i64(i64 %indvars.iv994, i64 255)
  %142 = add nsw i64 %polly.indvar397, %140
  %polly.loop_guard4101067 = icmp sgt i64 %142, -1
...
polly.loop_header566:                             ; preds = %polly.loop_header566.preheader, %polly.loop_exit575
  ...
  %161 = lshr i64 %indvars.iv1026, 3
  %162 = mul nsw i64 %polly.indvar569, -96
  %163 = icmp slt i64 %162, -1104
  %164 = select i1 %163, i64 %162, i64 -1104
  %165 = add nsw i64 %164, 1199
  %166 = mul nuw nsw i64 %polly.indvar569, 96
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582
  ...
  %exitcond1029.not = icmp eq i64 %polly.indvar_next570, 13
...
polly.loop_exit582:                               ; preds = %polly.loop_exit618, %polly.loop_header573
  ...
  %indvars.iv.next1017 = add nsw i64 %indvars.iv1016, -256
  %exitcond1028.not = icmp eq i64 %polly.indvar576, %161
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit618
  %indvars.iv1018 = phi i64 [ %171, %polly.loop_header580.preheader ], [ %indvars.iv.next1019, %polly.loop_exit618 ]
  %polly.indvar584 = phi i64 [ %170, %polly.loop_header580.preheader ], [ %polly.indvar_next585, %polly.loop_exit618 ]
  %smin1023 = call i64 @llvm.smin.i64(i64 %indvars.iv1018, i64 255)
  %174 = add nsw i64 %polly.indvar584, %172
  %polly.loop_guard5971068 = icmp sgt i64 %174, -1
...
vector.body1095:                                  ; preds = %vector.body1095, %vector.ph1096
  ...
  br i1 %205, label %polly.loop_exit795, label %vector.body1095, !llvm.loop !99

polly.loop_exit795:                               ; preds = %vector.body1095, %polly.loop_header793
  %polly.indvar_next791 = add nuw nsw i64 %polly.indvar790, 1
  %exitcond1059.not = icmp eq i64 %polly.indvar790, %185
...
polly.loop_header793:                             ; preds = %polly.loop_header787, %polly.loop_header793
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar796, %189
...
vector.body1109:                                  ; preds = %vector.body1109, %vector.ph1112
  ...
  br i1 %234, label %polly.loop_exit822, label %vector.body1109, !llvm.loop !102

polly.loop_exit822:                               ; preds = %vector.body1109, %polly.loop_header820
  %polly.indvar_next818 = add nuw nsw i64 %polly.indvar817, 1
  %exitcond1049.not = icmp eq i64 %polly.indvar817, %214
...
polly.loop_header820:                             ; preds = %polly.loop_header814, %polly.loop_header820
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar823, %218
...
vector.body1127:                                  ; preds = %vector.body1127, %vector.ph1130
  ...
  br i1 %263, label %polly.loop_exit848, label %vector.body1127, !llvm.loop !105

polly.loop_exit848:                               ; preds = %vector.body1127, %polly.loop_header846
  %polly.indvar_next844 = add nuw nsw i64 %polly.indvar843, 1
  %exitcond1039.not = icmp eq i64 %polly.indvar843, %243
...
polly.loop_header846:                             ; preds = %polly.loop_header840, %polly.loop_header846
  ...
  %exitcond1035.not = icmp eq i64 %polly.indvar849, %247
