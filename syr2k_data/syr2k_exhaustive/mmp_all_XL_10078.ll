; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10078.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10078.c"
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233875 = icmp sgt i64 %109, -1
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph994
  ...
  %123 = shl nuw nsw i64 %index997, 3
  %124 = getelementptr i8, i8* %scevgep350, i64 %123
  %125 = bitcast i8* %124 to <4 x double>*
  %wide.load1001 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !69, !noalias !71
  %126 = fmul fast <4 x double> %wide.load1001, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %128 = icmp eq i64 %index.next998, %n.vec996
  br i1 %128, label %middle.block988, label %vector.body990, !llvm.loop !74

middle.block988:                                  ; preds = %vector.body990
  %cmp.n1000 = icmp eq i64 %121, %n.vec996
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %130 = mul nsw i64 %polly.indvar357, -64
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.loop_header354
  ...
  %135 = mul nuw nsw i64 %polly.indvar363, 20
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %136 = shl nsw i64 %polly.indvar369, 5
...
polly.loop_header373.preheader:                   ; preds = %polly.loop_header366
  ...
  %140 = add i64 %smax803, %indvars.iv806
...
polly.loop_header373:                             ; preds = %polly.loop_header373.preheader, %polly.loop_exit382
  %indvars.iv808 = phi i64 [ %140, %polly.loop_header373.preheader ], [ %indvars.iv.next809, %polly.loop_exit382 ]
  ...
  %polly.loop_guard390876 = icmp sgt i64 %142, -1
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  %156 = shl nuw nsw i64 %index971, 3
  %157 = getelementptr i8, i8* %scevgep507, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load975 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !78, !noalias !80
  %159 = fmul fast <4 x double> %wide.load975, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next972, %n.vec970
  br i1 %161, label %middle.block964, label %vector.body966, !llvm.loop !83

middle.block964:                                  ; preds = %vector.body966
  %cmp.n974 = icmp eq i64 %154, %n.vec970
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %168 = mul nuw nsw i64 %polly.indvar520, 20
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %169 = shl nsw i64 %polly.indvar526, 5
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  %indvars.iv829 = phi i64 [ %173, %polly.loop_header530.preheader ], [ %indvars.iv.next830, %polly.loop_exit539 ]
  ...
  %polly.loop_guard547877 = icmp sgt i64 %175, -1
...
polly.loop_header698:                             ; preds = %polly.loop_exit706, %polly.loop_header692
  ...
  %smin905 = call i64 @llvm.smin.i64(i64 %189, i64 -1168)
  %190 = add nsw i64 %smin905, 1200
  %smin863 = call i64 @llvm.smin.i64(i64 %indvars.iv861, i64 -1168)
  %191 = shl nsw i64 %polly.indvar701, 5
  %192 = add nsw i64 %smin863, 1199
...
vector.ph906:                                     ; preds = %polly.loop_header704
  %broadcast.splatinsert913 = insertelement <4 x i64> poison, i64 %191, i32 0
  %broadcast.splat914 = shufflevector <4 x i64> %broadcast.splatinsert913, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert915 = insertelement <4 x i32> poison, i32 %194, i32 0
...
vector.body904:                                   ; preds = %vector.body904, %vector.ph906
  ...
  %196 = add nuw nsw <4 x i64> %vec.ind911, %broadcast.splat914
  %197 = trunc <4 x i64> %196 to <4 x i32>
  %198 = mul <4 x i32> %broadcast.splat916, %197
  ...
  %208 = icmp eq i64 %index.next908, %190
  br i1 %208, label %polly.loop_exit712, label %vector.body904, !llvm.loop !92

polly.loop_exit712:                               ; preds = %vector.body904, %polly.loop_header710
  %polly.indvar_next708 = add nuw nsw i64 %polly.indvar707, 1
  %exitcond868.not = icmp eq i64 %polly.indvar707, %188
...
polly.loop_header710:                             ; preds = %polly.loop_header704, %polly.loop_header710
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar713, %192
...
polly.loop_header725:                             ; preds = %polly.loop_exit733, %polly.loop_header719
  ...
  %smin920 = call i64 @llvm.smin.i64(i64 %218, i64 -968)
  %219 = add nsw i64 %smin920, 1000
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 -968)
  %220 = shl nsw i64 %polly.indvar728, 5
  %221 = add nsw i64 %smin853, 999
...
vector.body919:                                   ; preds = %vector.body919, %vector.ph922
  ...
  %225 = add nuw nsw <4 x i64> %vec.ind929, %broadcast.splat932
  %226 = trunc <4 x i64> %225 to <4 x i32>
  %227 = mul <4 x i32> %broadcast.splat934, %226
  ...
  %237 = icmp eq i64 %index.next926, %219
  br i1 %237, label %polly.loop_exit739, label %vector.body919, !llvm.loop !95

polly.loop_exit739:                               ; preds = %vector.body919, %polly.loop_header737
  %polly.indvar_next735 = add nuw nsw i64 %polly.indvar734, 1
  %exitcond858.not = icmp eq i64 %polly.indvar734, %217
...
polly.loop_header737:                             ; preds = %polly.loop_header731, %polly.loop_header737
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar740, %221
...
polly.loop_header751:                             ; preds = %polly.loop_exit759, %polly.loop_header745
  ...
  %smin938 = call i64 @llvm.smin.i64(i64 %247, i64 -968)
  %248 = add nsw i64 %smin938, 1000
  %smin843 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 -968)
  %249 = shl nsw i64 %polly.indvar754, 5
  %250 = add nsw i64 %smin843, 999
...
vector.body937:                                   ; preds = %vector.body937, %vector.ph940
  ...
  %254 = add nuw nsw <4 x i64> %vec.ind947, %broadcast.splat950
  %255 = trunc <4 x i64> %254 to <4 x i32>
  %256 = mul <4 x i32> %broadcast.splat952, %255
  ...
  %266 = icmp eq i64 %index.next944, %248
  br i1 %266, label %polly.loop_exit765, label %vector.body937, !llvm.loop !98

polly.loop_exit765:                               ; preds = %vector.body937, %polly.loop_header763
  %polly.indvar_next761 = add nuw nsw i64 %polly.indvar760, 1
  %exitcond848.not = icmp eq i64 %polly.indvar760, %246
...
polly.loop_header763:                             ; preds = %polly.loop_header757, %polly.loop_header763
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar766, %250
