; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9201.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9201.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %104 = shl nuw nsw i64 %indvars.iv785, 1
  %105 = and i64 %104, 9223372036854775680
  %106 = sub nsw i64 %indvars.iv, %105
  %107 = add i64 %indvars.iv789, %105
  %108 = mul nuw nsw i64 %polly.indvar208, 25
  %pexp.p_div_q = lshr i64 %108, 6
  %109 = mul nuw nsw i64 %polly.indvar208, 50
  %110 = mul nsw i64 %polly.indvar208, -50
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %146 = shl nuw nsw i64 %indvars.iv803, 1
  %147 = and i64 %146, 9223372036854775680
  %148 = sub nsw i64 %indvars.iv801, %147
  %149 = add i64 %indvars.iv808, %147
  %150 = mul nuw nsw i64 %polly.indvar363, 25
  %pexp.p_div_q366 = lshr i64 %150, 6
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %188 = shl nuw nsw i64 %indvars.iv824, 1
  %189 = and i64 %188, 9223372036854775680
  %190 = sub nsw i64 %indvars.iv822, %189
  %191 = add i64 %indvars.iv829, %189
  %192 = mul nuw nsw i64 %polly.indvar521, 25
  %pexp.p_div_q524 = lshr i64 %192, 6
  %193 = mul nuw nsw i64 %polly.indvar521, 50
  %194 = mul nsw i64 %polly.indvar521, -50
...
polly.loop_header380.1:                           ; preds = %polly.loop_exit390, %polly.loop_exit390.1
  ...
  %smin814.1 = call i64 @llvm.smin.i64(i64 %indvars.iv812.1, i64 49)
...
polly.loop_header380.2:                           ; preds = %polly.loop_exit390.1, %polly.loop_exit390.2
  ...
  %smin814.2 = call i64 @llvm.smin.i64(i64 %indvars.iv812.2, i64 49)
...
polly.loop_header380.3:                           ; preds = %polly.loop_exit390.2, %polly.loop_exit390.3
  ...
  %smin814.3 = call i64 @llvm.smin.i64(i64 %indvars.iv812.3, i64 49)
...
polly.loop_header538.1:                           ; preds = %polly.loop_exit548, %polly.loop_exit548.1
  ...
  %smin835.1 = call i64 @llvm.smin.i64(i64 %indvars.iv833.1, i64 49)
...
polly.loop_header538.2:                           ; preds = %polly.loop_exit548.1, %polly.loop_exit548.2
  ...
  %smin835.2 = call i64 @llvm.smin.i64(i64 %indvars.iv833.2, i64 49)
...
polly.loop_header538.3:                           ; preds = %polly.loop_exit548.2, %polly.loop_exit548.3
  ...
  %smin835.3 = call i64 @llvm.smin.i64(i64 %indvars.iv833.3, i64 49)
