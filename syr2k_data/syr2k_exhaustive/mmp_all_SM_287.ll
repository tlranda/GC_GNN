; ModuleID = 'syr2k_exhaustive/mmp_all_SM_287.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_287.c"
...
vector.body1417:                                  ; preds = %vector.body1417, %vector.ph1425
  ...
  %wide.load1438 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %163, label %middle.block1415, label %vector.body1417, !llvm.loop !85
...
vector.body1353:                                  ; preds = %vector.body1353, %vector.ph1357
  ...
  %wide.load1364 = load <4 x double>, <4 x double>* %169, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %172, label %middle.block1351, label %vector.body1353, !llvm.loop !93
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %175 = shl nsw i64 %polly.indvar413, 5
...
vector.body1367:                                  ; preds = %vector.body1367, %vector.ph1375
  ...
  %wide.load1388 = load <4 x double>, <4 x double>* %235, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %240, label %middle.block1365, label %vector.body1367, !llvm.loop !98
...
vector.body1305:                                  ; preds = %vector.body1305, %vector.ph1307
  ...
  %wide.load1314 = load <4 x double>, <4 x double>* %246, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %249, label %middle.block1303, label %vector.body1305, !llvm.loop !106
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %252 = shl nsw i64 %polly.indvar630, 5
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1325
  ...
  %wide.load1338 = load <4 x double>, <4 x double>* %312, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %317, label %middle.block1315, label %vector.body1317, !llvm.loop !111
...
vector.body1244:                                  ; preds = %vector.body1244, %vector.ph1245
  ...
  br i1 %340, label %polly.loop_exit884, label %vector.body1244, !llvm.loop !117
...
vector.body1258:                                  ; preds = %vector.body1258, %vector.ph1261
  ...
  br i1 %369, label %polly.loop_exit911, label %vector.body1258, !llvm.loop !120
...
vector.body1276:                                  ; preds = %vector.body1276, %vector.ph1279
  ...
  br i1 %398, label %polly.loop_exit937, label %vector.body1276, !llvm.loop !123
