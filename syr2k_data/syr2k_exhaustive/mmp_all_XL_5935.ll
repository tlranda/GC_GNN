; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5935.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5935.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit219.3
  ...
  %113 = mul nuw nsw i64 %polly.indvar230, 50
  %114 = sub nsw i64 %110, %113
  %115 = icmp sgt i64 %114, 0
  %116 = select i1 %115, i64 %114, i64 0
  %polly.loop_guard = icmp slt i64 %116, 50
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit572.3
  ...
  %191 = mul nuw nsw i64 %polly.indvar584, 50
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  %295 = mul nsw i64 %polly.indvar208, -64
  %296 = mul nuw nsw i64 %polly.indvar208, 7
  %pexp.p_div_q = udiv i64 %296, 25
  %297 = add nuw nsw i64 %pexp.p_div_q, %polly.indvar208
...
polly.loop_header239.us.1:                        ; preds = %polly.loop_exit248.us, %polly.loop_exit248.us.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv864.1, i64 63)
...
polly.loop_header239.us.2:                        ; preds = %polly.loop_exit248.us.1, %polly.loop_exit248.us.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv864.2, i64 63)
...
polly.loop_header239.us.3:                        ; preds = %polly.loop_exit248.us.2, %polly.loop_exit248.us.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv864.3, i64 63)
...
polly.loop_exit394.3:                             ; preds = %polly.loop_header392.3
  %331 = mul nsw i64 %polly.indvar383, -64
  %332 = mul nuw nsw i64 %polly.indvar383, 7
  %pexp.p_div_q402 = udiv i64 %332, 25
  %333 = add nuw nsw i64 %pexp.p_div_q402, %polly.indvar383
...
polly.loop_header416.us.1:                        ; preds = %polly.loop_exit426.us, %polly.loop_exit426.us.1
  ...
  %smin889.1 = call i64 @llvm.smin.i64(i64 %indvars.iv887.1, i64 63)
...
polly.loop_header416.us.2:                        ; preds = %polly.loop_exit426.us.1, %polly.loop_exit426.us.2
  ...
  %smin889.2 = call i64 @llvm.smin.i64(i64 %indvars.iv887.2, i64 63)
...
polly.loop_header416.us.3:                        ; preds = %polly.loop_exit426.us.2, %polly.loop_exit426.us.3
  ...
  %smin889.3 = call i64 @llvm.smin.i64(i64 %indvars.iv887.3, i64 63)
...
polly.loop_exit572.3:                             ; preds = %polly.loop_header570.3
  %367 = mul nsw i64 %polly.indvar561, -64
  %368 = mul nuw nsw i64 %polly.indvar561, 7
  %pexp.p_div_q580 = udiv i64 %368, 25
  %369 = add nuw nsw i64 %pexp.p_div_q580, %polly.indvar561
...
polly.loop_header594.us.1:                        ; preds = %polly.loop_exit604.us, %polly.loop_exit604.us.1
  ...
  %smin913.1 = call i64 @llvm.smin.i64(i64 %indvars.iv911.1, i64 63)
...
polly.loop_header594.us.2:                        ; preds = %polly.loop_exit604.us.1, %polly.loop_exit604.us.2
  ...
  %smin913.2 = call i64 @llvm.smin.i64(i64 %indvars.iv911.2, i64 63)
...
polly.loop_header594.us.3:                        ; preds = %polly.loop_exit604.us.2, %polly.loop_exit604.us.3
  ...
  %smin913.3 = call i64 @llvm.smin.i64(i64 %indvars.iv911.3, i64 63)
