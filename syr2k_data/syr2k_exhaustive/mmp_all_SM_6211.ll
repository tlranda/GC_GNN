; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6211.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6211.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next203, 50
...
polly.loop_exit219:                               ; preds = %polly.loop_header217
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar_next215, 20
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  ...
  %102 = mul nuw nsw i64 %polly.indvar230, 80
...
polly.loop_exit241:                               ; preds = %polly.loop_exit247
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar_next237, 20
...
polly.start270:                                   ; preds = %kernel_syr2k.exit
  %malloccall272 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body1022:                                  ; preds = %vector.body1022, %vector.ph1026
  ...
  %wide.load1033 = load <4 x double>, <4 x double>* %119, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %122, label %middle.block1020, label %vector.body1022, !llvm.loop !84
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %124 = mul nuw nsw i64 %polly.indvar375, 20
...
polly.loop_exit380:                               ; preds = %polly.loop_exit402
  ...
  %exitcond865.not = icmp eq i64 %polly.indvar_next376, 50
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %125 = mul nuw nsw i64 %polly.indvar381, 80
...
polly.loop_exit392:                               ; preds = %polly.loop_header390
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar_next388, 20
...
polly.loop_header400.preheader:                   ; preds = %polly.loop_exit392
  %127 = mul nsw i64 %polly.indvar381, -80
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit408
  ...
  %129 = mul nuw nsw i64 %polly.indvar403, 80
...
polly.loop_exit414:                               ; preds = %polly.loop_exit420
  ...
  %exitcond862.not = icmp eq i64 %polly.indvar_next410, 20
...
polly.start443:                                   ; preds = %init_array.exit
  %malloccall445 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1000
  ...
  %wide.load1007 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !88, !noalias !90
  ...
  store <4 x double> %147, <4 x double>* %148, align 8, !alias.scope !88, !noalias !90
  %index.next1004 = add i64 %index1003, 4
  %149 = icmp eq i64 %index.next1004, %n.vec1002
  br i1 %149, label %middle.block996, label %vector.body998, !llvm.loop !94
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %151 = mul nuw nsw i64 %polly.indvar548, 20
...
polly.loop_exit553:                               ; preds = %polly.loop_exit575
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next549, 50
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %152 = mul nuw nsw i64 %polly.indvar554, 80
...
polly.loop_exit565:                               ; preds = %polly.loop_header563
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar_next561, 20
...
polly.loop_header573.preheader:                   ; preds = %polly.loop_exit565
  %154 = mul nsw i64 %polly.indvar554, -80
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %156 = mul nuw nsw i64 %polly.indvar576, 80
...
polly.loop_exit587:                               ; preds = %polly.loop_exit593
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar_next583, 20
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  store <4 x double> %184, <4 x double>* %189, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %190, label %polly.loop_exit760, label %vector.body936, !llvm.loop !103
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  store <4 x double> %213, <4 x double>* %218, align 8, !alias.scope !102, !noalias !105
  ...
  br i1 %219, label %polly.loop_exit787, label %vector.body951, !llvm.loop !106
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph972
  ...
  store <4 x double> %242, <4 x double>* %247, align 8, !alias.scope !101, !noalias !108
  ...
  br i1 %248, label %polly.loop_exit813, label %vector.body969, !llvm.loop !109
