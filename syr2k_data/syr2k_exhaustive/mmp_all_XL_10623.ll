; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10623.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10623.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin786 = call i64 @llvm.smin.i64(i64 %indvars.iv784, i64 -1072)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next785 = add nsw i64 %indvars.iv784, -128
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond789.not = icmp eq i64 %polly.indvar_next209, 10
...
polly.loop_exit231.loopexit.us:                   ; preds = %polly.loop_header229.us
  ...
  %exitcond783.not = icmp eq i64 %polly.indvar_next227.us, 100
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %125 = shl nsw i64 %polly.indvar355, 7
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %127 = mul nuw nsw i64 %polly.indvar361, 100
  br label %polly.loop_header365

polly.loop_exit367:                               ; preds = %polly.loop_exit373
  %polly.indvar_next362 = add nuw nsw i64 %polly.indvar361, 1
  %exitcond807.not = icmp eq i64 %polly.indvar_next362, 10
...
polly.loop_header365:                             ; preds = %polly.loop_exit373, %polly.loop_header358
  ...
  %128 = shl nsw i64 %polly.indvar368, 8
...
polly.loop_header377.us:                          ; preds = %polly.loop_header371, %polly.loop_exit386.loopexit.us
  ...
  %134 = add nuw nsw i64 %polly.indvar380.us, %127
  %135 = shl i64 %134, 3
...
polly.loop_exit386.loopexit.us:                   ; preds = %polly.loop_header384.us
  ...
  %exitcond801.not = icmp eq i64 %polly.indvar_next381.us, 100
  br i1 %exitcond801.not, label %polly.loop_exit379, label %polly.loop_header377.us
...
polly.loop_exit379:                               ; preds = %polly.loop_exit386.loopexit.us, %polly.loop_header371
  ...
  %exitcond805.not = icmp eq i64 %polly.indvar374, %126
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %smin822 = call i64 @llvm.smin.i64(i64 %indvars.iv820, i64 -1072)
  %152 = shl nsw i64 %polly.indvar511, 7
  %153 = add nsw i64 %smin822, 1199
...
polly.loop_header514:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %154 = mul nuw nsw i64 %polly.indvar517, 100
...
polly.loop_exit523:                               ; preds = %polly.loop_exit529
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next518, 10
...
polly.loop_header521:                             ; preds = %polly.loop_exit529, %polly.loop_header514
  ...
  %155 = shl nsw i64 %polly.indvar524, 8
...
polly.loop_header533.us:                          ; preds = %polly.loop_header527, %polly.loop_exit542.loopexit.us
  ...
  %161 = add nuw nsw i64 %polly.indvar536.us, %154
  %162 = shl i64 %161, 3
...
polly.loop_exit542.loopexit.us:                   ; preds = %polly.loop_header540.us
  ...
  %exitcond819.not = icmp eq i64 %polly.indvar_next537.us, 100
  br i1 %exitcond819.not, label %polly.loop_exit535, label %polly.loop_header533.us
...
polly.loop_exit535:                               ; preds = %polly.loop_exit542.loopexit.us, %polly.loop_header527
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar530, %153
