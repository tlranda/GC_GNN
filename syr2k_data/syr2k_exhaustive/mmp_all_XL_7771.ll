; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7771.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7771.c"
...
vector.body1038:                                  ; preds = %vector.body1038, %vector.ph1040
  ...
  br i1 %57, label %middle.block1036, label %vector.body1038, !llvm.loop !55
...
vector.body1064:                                  ; preds = %vector.body1064, %vector.ph1066
  ...
  br i1 %68, label %middle.block1062, label %vector.body1064, !llvm.loop !57
...
vector.body1076:                                  ; preds = %vector.body1076, %vector.ph1080
  ...
  %wide.load1087 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  ...
  br i1 %95, label %middle.block1074, label %vector.body1076, !llvm.loop !69
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv849 = phi i64 [ %indvars.iv.next850, %polly.loop_exit223 ], [ 2, %polly.loop_exit207 ]
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %103 = mul nuw nsw i64 %polly.indvar230, 80
...
polly.loop_header233.preheader:                   ; preds = %polly.loop_header227
  ...
  %107 = add i64 %smax, %indvars.iv841
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond851 = icmp eq i64 %polly.indvar_next231, %98
  br i1 %exitcond851, label %polly.loop_exit229, label %polly.loop_header227

polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  %indvars.iv843 = phi i64 [ %107, %polly.loop_header233.preheader ], [ %indvars.iv.next844, %polly.loop_exit241 ]
  ...
  %polly.loop_guard249941 = icmp sgt i64 %109, -1
  %110 = add nuw nsw i64 %polly.indvar236, %100
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233, %polly.loop_exit248.loopexit.us
  ...
  %113 = add nuw nsw i64 %polly.indvar242.us, %101
  %114 = shl i64 %113, 3
...
polly.loop_exit248.loopexit.us:                   ; preds = %polly.loop_header246.us
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar242.us, %102
...
vector.body1050:                                  ; preds = %vector.body1050, %vector.ph1054
  ...
  %123 = shl nuw nsw i64 %index1057, 3
  %124 = getelementptr i8, i8* %scevgep370, i64 %123
  %125 = bitcast i8* %124 to <4 x double>*
  %wide.load1061 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !74, !noalias !76
  %126 = fmul fast <4 x double> %wide.load1061, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %128 = icmp eq i64 %index.next1058, %n.vec1056
  br i1 %128, label %middle.block1048, label %vector.body1050, !llvm.loop !80

middle.block1048:                                 ; preds = %vector.body1050
  %cmp.n1060 = icmp eq i64 %121, %n.vec1056
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  br i1 %exitcond882.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !81
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv875 = phi i64 [ %indvars.iv.next876, %polly.loop_exit398 ], [ 2, %polly.loop_exit382 ]
  ...
  %130 = lshr i64 %polly.indvar393, 2
  %131 = add nuw i64 %indvars.iv875, %130
  %132 = mul nsw i64 %polly.indvar393, -100
  %133 = mul nuw nsw i64 %polly.indvar393, 100
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar_next394, 12
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  ...
  %134 = shl nsw i64 %polly.indvar399, 4
  %135 = add nsw i64 %smin873, 999
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit412
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %indvars.iv.next872 = add nsw i64 %indvars.iv871, -16
  %exitcond878.not = icmp eq i64 %polly.indvar_next400, 63
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %136 = mul nuw nsw i64 %polly.indvar406, 80
  %137 = add nsw i64 %136, %132
  %138 = icmp sgt i64 %137, 0
  %139 = select i1 %138, i64 %137, i64 0
  %polly.loop_guard413 = icmp slt i64 %139, 100
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond877 = icmp eq i64 %polly.indvar_next407, %131
  br i1 %exitcond877, label %polly.loop_exit405, label %polly.loop_header403

polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv867 = phi i64 [ %140, %polly.loop_header410.preheader ], [ %indvars.iv.next868, %polly.loop_exit419 ]
  %polly.indvar414 = phi i64 [ %139, %polly.loop_header410.preheader ], [ %polly.indvar_next415, %polly.loop_exit419 ]
  %smin869 = call i64 @llvm.smin.i64(i64 %indvars.iv867, i64 79)
  %142 = add nsw i64 %polly.indvar414, %141
  %polly.loop_guard427942 = icmp sgt i64 %142, -1
  %143 = add nuw nsw i64 %polly.indvar414, %133
...
polly.loop_header417.us:                          ; preds = %polly.loop_header410, %polly.loop_exit426.loopexit.us
  ...
  %146 = add nuw nsw i64 %polly.indvar420.us, %134
  %147 = shl i64 %146, 3
  %polly.access.mul.Packed_MemRef_call2275434.us = mul nuw nsw i64 %146, 1200
  %polly.access.add.Packed_MemRef_call2275435.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2275434.us, %143
  ...
  %148 = add i64 %147, %144
  %scevgep442.us = getelementptr i8, i8* %call1, i64 %148
...
polly.loop_header424.us:                          ; preds = %polly.loop_header417.us, %polly.loop_header424.us
  ...
  %149 = add nuw nsw i64 %polly.indvar428.us, %136
  %150 = mul nuw nsw i64 %149, 8000
  %151 = add nuw nsw i64 %150, %147
  %scevgep431.us = getelementptr i8, i8* %call1, i64 %151
  ...
  %polly.access.add.Packed_MemRef_call2275439.us = add nuw nsw i64 %149, %polly.access.mul.Packed_MemRef_call2275434.us
  ...
  %152 = shl i64 %149, 3
  %153 = add i64 %152, %145
  %scevgep445.us = getelementptr i8, i8* %call, i64 %153
...
polly.loop_exit426.loopexit.us:                   ; preds = %polly.loop_header424.us
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar420.us, %135
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %155 = mul nuw nsw i64 %polly.indvar539, 9600
  %scevgep548 = getelementptr i8, i8* %call, i64 %155
  %min.iters.check1027 = icmp ult i64 %154, 4
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1028
  ...
  %156 = shl nuw nsw i64 %index1031, 3
  %157 = getelementptr i8, i8* %scevgep548, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load1035 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !84, !noalias !86
  %159 = fmul fast <4 x double> %wide.load1035, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next1032, %n.vec1030
  br i1 %161, label %middle.block1024, label %vector.body1026, !llvm.loop !90

middle.block1024:                                 ; preds = %vector.body1026
  %cmp.n1034 = icmp eq i64 %154, %n.vec1030
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  %162 = shl nuw nsw i64 %polly.indvar545, 3
  %scevgep549 = getelementptr i8, i8* %scevgep548, i64 %162
  ...
  br i1 %exitcond908.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !91
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv901 = phi i64 [ %indvars.iv.next902, %polly.loop_exit576 ], [ 2, %polly.loop_exit560 ]
  ...
  %163 = lshr i64 %polly.indvar571, 2
  %164 = add nuw i64 %indvars.iv901, %163
  %165 = mul nsw i64 %polly.indvar571, -100
  %166 = mul nuw nsw i64 %polly.indvar571, 100
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next572, 12
...
polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  %indvars.iv897 = phi i64 [ %indvars.iv.next898, %polly.loop_exit583 ], [ 0, %polly.loop_header568 ]
  ...
  %167 = shl nsw i64 %polly.indvar577, 4
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar_next578, 63
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %169 = mul nuw nsw i64 %polly.indvar584, 80
  %170 = add nsw i64 %169, %165
  %171 = icmp sgt i64 %170, 0
  %172 = select i1 %171, i64 %170, i64 0
  %polly.loop_guard591 = icmp slt i64 %172, 100
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, 80
  %indvars.iv.next892 = add nsw i64 %indvars.iv891, -80
  %exitcond903 = icmp eq i64 %polly.indvar_next585, %164
  br i1 %exitcond903, label %polly.loop_exit583, label %polly.loop_header581

polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv893 = phi i64 [ %173, %polly.loop_header588.preheader ], [ %indvars.iv.next894, %polly.loop_exit597 ]
  %polly.indvar592 = phi i64 [ %172, %polly.loop_header588.preheader ], [ %polly.indvar_next593, %polly.loop_exit597 ]
  %smin895 = call i64 @llvm.smin.i64(i64 %indvars.iv893, i64 79)
  %175 = add nsw i64 %polly.indvar592, %174
  %polly.loop_guard605943 = icmp sgt i64 %175, -1
  %176 = add nuw nsw i64 %polly.indvar592, %166
...
polly.loop_header595.us:                          ; preds = %polly.loop_header588, %polly.loop_exit604.loopexit.us
  ...
  %179 = add nuw nsw i64 %polly.indvar598.us, %167
  %180 = shl i64 %179, 3
  %polly.access.mul.Packed_MemRef_call2453612.us = mul nuw nsw i64 %179, 1200
  %polly.access.add.Packed_MemRef_call2453613.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2453612.us, %176
  ...
  %181 = add i64 %180, %177
  %scevgep620.us = getelementptr i8, i8* %call1, i64 %181
...
polly.loop_header602.us:                          ; preds = %polly.loop_header595.us, %polly.loop_header602.us
  ...
  %182 = add nuw nsw i64 %polly.indvar606.us, %169
  %183 = mul nuw nsw i64 %182, 8000
  %184 = add nuw nsw i64 %183, %180
  %scevgep609.us = getelementptr i8, i8* %call1, i64 %184
  ...
  %polly.access.add.Packed_MemRef_call2453617.us = add nuw nsw i64 %182, %polly.access.mul.Packed_MemRef_call2453612.us
  ...
  %185 = shl i64 %182, 3
  %186 = add i64 %185, %178
  %scevgep623.us = getelementptr i8, i8* %call, i64 %186
...
polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar598.us, %168
  br i1 %exitcond900.not, label %polly.loop_exit597, label %polly.loop_header595.us
...
polly.loop_header752:                             ; preds = %entry, %polly.loop_exit760
  ...
  %187 = shl nsw i64 %polly.indvar755, 5
  %188 = add nsw i64 %smin936, 1199
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %189 = mul nsw i64 %polly.indvar761, -32
  %smin965 = call i64 @llvm.smin.i64(i64 %189, i64 -1168)
  %190 = add nsw i64 %smin965, 1200
  %smin932 = call i64 @llvm.smin.i64(i64 %indvars.iv930, i64 -1168)
  %191 = shl nsw i64 %polly.indvar761, 5
  %192 = add nsw i64 %smin932, 1199
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %193 = add nuw nsw i64 %polly.indvar767, %187
...
vector.ph966:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert973 = insertelement <4 x i64> poison, i64 %191, i32 0
  %broadcast.splat974 = shufflevector <4 x i64> %broadcast.splatinsert973, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert975 = insertelement <4 x i32> poison, i32 %194, i32 0
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph966
  ...
  %196 = add nuw nsw <4 x i64> %vec.ind971, %broadcast.splat974
  %197 = trunc <4 x i64> %196 to <4 x i32>
  %198 = mul <4 x i32> %broadcast.splat976, %197
  ...
  %208 = icmp eq i64 %index.next968, %190
  br i1 %208, label %polly.loop_exit772, label %vector.body964, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body964, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond937.not = icmp eq i64 %polly.indvar767, %188
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %209 = add nuw nsw i64 %polly.indvar773, %191
  ...
  %scevgep776 = getelementptr i8, i8* %call, i64 %215
  ...
  %exitcond933.not = icmp eq i64 %polly.indvar773, %192
  br i1 %exitcond933.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !100
...
polly.loop_header779:                             ; preds = %polly.loop_exit760, %polly.loop_exit787
  ...
  %216 = shl nsw i64 %polly.indvar782, 5
  %217 = add nsw i64 %smin926, 1199
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %218 = mul nsw i64 %polly.indvar788, -32
  %smin980 = call i64 @llvm.smin.i64(i64 %218, i64 -968)
  %219 = add nsw i64 %smin980, 1000
  %smin922 = call i64 @llvm.smin.i64(i64 %indvars.iv920, i64 -968)
  %220 = shl nsw i64 %polly.indvar788, 5
  %221 = add nsw i64 %smin922, 999
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph982
  ...
  %225 = add nuw nsw <4 x i64> %vec.ind989, %broadcast.splat992
  %226 = trunc <4 x i64> %225 to <4 x i32>
  %227 = mul <4 x i32> %broadcast.splat994, %226
  ...
  %237 = icmp eq i64 %index.next986, %219
  br i1 %237, label %polly.loop_exit799, label %vector.body979, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body979, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond927.not = icmp eq i64 %polly.indvar794, %217
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %238 = add nuw nsw i64 %polly.indvar800, %220
  ...
  %scevgep803 = getelementptr i8, i8* %call2, i64 %244
  ...
  %exitcond923.not = icmp eq i64 %polly.indvar800, %221
  br i1 %exitcond923.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !103
...
polly.loop_header805:                             ; preds = %polly.loop_exit787, %polly.loop_exit813
  ...
  %245 = shl nsw i64 %polly.indvar808, 5
  %246 = add nsw i64 %smin916, 1199
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %247 = mul nsw i64 %polly.indvar814, -32
  %smin998 = call i64 @llvm.smin.i64(i64 %247, i64 -968)
  %248 = add nsw i64 %smin998, 1000
  %smin912 = call i64 @llvm.smin.i64(i64 %indvars.iv910, i64 -968)
  %249 = shl nsw i64 %polly.indvar814, 5
  %250 = add nsw i64 %smin912, 999
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph1000
  ...
  %254 = add nuw nsw <4 x i64> %vec.ind1007, %broadcast.splat1010
  %255 = trunc <4 x i64> %254 to <4 x i32>
  %256 = mul <4 x i32> %broadcast.splat1012, %255
  ...
  %266 = icmp eq i64 %index.next1004, %248
  br i1 %266, label %polly.loop_exit825, label %vector.body997, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body997, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond917.not = icmp eq i64 %polly.indvar820, %246
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %267 = add nuw nsw i64 %polly.indvar826, %249
  ...
  %scevgep830 = getelementptr i8, i8* %call1, i64 %273
  ...
  %exitcond913.not = icmp eq i64 %polly.indvar826, %250
  br i1 %exitcond913.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !106
}
