; ModuleID = 'syr2k_exhaustive/mmp_all_XL_274.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_274.c"
...
polly.loop_header271:                             ; preds = %polly.loop_exit279, %polly.loop_header265
  ...
  %smin1267 = call i64 @llvm.smin.i64(i64 %115, i64 255)
  %116 = add nuw nsw i64 %smin1267, 1
  %smin975 = call i64 @llvm.smin.i64(i64 %indvars.iv973, i64 255)
...
polly.loop_header414:                             ; preds = %polly.loop_exit438, %polly.loop_header408
  ...
  %151 = shl nsw i64 %polly.indvar417, 8
  br label %polly.loop_header420

polly.loop_exit422:                               ; preds = %polly.loop_exit428
  %152 = mul nsw i64 %polly.indvar417, -256
  %153 = shl nsw i64 %polly.indvar417, 4
...
polly.loop_header436:                             ; preds = %polly.loop_exit477, %polly.loop_exit422
  ...
  %.inv928 = icmp ugt i64 %158, 255
  %160 = select i1 %.inv928, i64 255, i64 %159
...
polly.loop_header481:                             ; preds = %polly.loop_exit489, %polly.loop_header475
  ...
  %smin1220 = call i64 @llvm.smin.i64(i64 %167, i64 255)
  %168 = add nuw nsw i64 %smin1220, 1
  %smin1001 = call i64 @llvm.smin.i64(i64 %indvars.iv999, i64 255)
...
polly.loop_header624:                             ; preds = %polly.loop_exit648, %polly.loop_header618
  ...
  %203 = shl nsw i64 %polly.indvar627, 8
  br label %polly.loop_header630

polly.loop_exit632:                               ; preds = %polly.loop_exit638
  %204 = mul nsw i64 %polly.indvar627, -256
  %205 = shl nsw i64 %polly.indvar627, 4
...
polly.loop_header646:                             ; preds = %polly.loop_exit687, %polly.loop_exit632
  ...
  %.inv929 = icmp ugt i64 %210, 255
  %212 = select i1 %.inv929, i64 255, i64 %211
...
polly.loop_header691:                             ; preds = %polly.loop_exit699, %polly.loop_header685
  ...
  %smin1173 = call i64 @llvm.smin.i64(i64 %219, i64 255)
  %220 = add nuw nsw i64 %smin1173, 1
  %smin1027 = call i64 @llvm.smin.i64(i64 %indvars.iv1025, i64 255)
