; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9521.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9521.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond801.not = icmp eq i64 %polly.indvar_next203, 150
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %102 = mul nuw nsw i64 %polly.indvar214, 100
  %103 = add nsw i64 %102, %98
  %104 = icmp sgt i64 %103, 0
  %105 = select i1 %104, i64 %103, i64 0
  %polly.loop_guard = icmp slt i64 %105, 8
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %130 = mul nsw i64 %polly.indvar357, -8
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %indvars.iv.next810 = add nuw nsw i64 %indvars.iv809, 8
  %indvars.iv.next822 = add nuw nsw i64 %indvars.iv821, 2
  %exitcond825.not = icmp eq i64 %polly.indvar_next358, 150
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %134 = mul nuw nsw i64 %polly.indvar370, 100
  %135 = add nsw i64 %134, %130
  %136 = icmp sgt i64 %135, 0
  %137 = select i1 %136, i64 %135, i64 0
  %polly.loop_guard377 = icmp slt i64 %137, 8
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %indvars.iv.next812 = add nsw i64 %indvars.iv811, -100
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %162 = mul nsw i64 %polly.indvar515, -8
  %163 = shl nsw i64 %polly.indvar515, 3
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar_next516, 150
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %166 = mul nuw nsw i64 %polly.indvar528, 100
  %167 = add nsw i64 %166, %162
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %polly.loop_guard535 = icmp slt i64 %169, 8
