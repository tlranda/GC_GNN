; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4999.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4999.c"
...
vector.body1198:                                  ; preds = %vector.body1198, %vector.ph1202
  ...
  %wide.load1209 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %135, label %middle.block1196, label %vector.body1198, !llvm.loop !80
...
vector.body1174:                                  ; preds = %vector.body1174, %vector.ph1176
  ...
  %wide.load1183 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %175, label %middle.block1172, label %vector.body1174, !llvm.loop !90
...
vector.body1113:                                  ; preds = %vector.body1113, %vector.ph1114
  ...
  br i1 %229, label %polly.loop_exit807, label %vector.body1113, !llvm.loop !99
...
vector.body1127:                                  ; preds = %vector.body1127, %vector.ph1130
  ...
  br i1 %258, label %polly.loop_exit834, label %vector.body1127, !llvm.loop !102
...
vector.body1145:                                  ; preds = %vector.body1145, %vector.ph1148
  ...
  br i1 %287, label %polly.loop_exit860, label %vector.body1145, !llvm.loop !105
