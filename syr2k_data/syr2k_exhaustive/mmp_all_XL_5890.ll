; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5890.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5890.c"
...
vector.body1077:                                  ; preds = %vector.body1077, %vector.ph1081
  ...
  %wide.load1088 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %139, label %middle.block1075, label %vector.body1077, !llvm.loop !85
...
polly.loop_header376:                             ; preds = %polly.loop_header376.preheader, %polly.loop_exit384
  ...
  %142 = mul nuw nsw i64 %polly.indvar379, 80
...
vector.body1053:                                  ; preds = %vector.body1053, %vector.ph1055
  ...
  %wide.load1062 = load <4 x double>, <4 x double>* %180, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %183, label %middle.block1051, label %vector.body1053, !llvm.loop !95
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_exit564
  ...
  %186 = mul nuw nsw i64 %polly.indvar559, 80
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph993
  ...
  br i1 %241, label %polly.loop_exit778, label %vector.body992, !llvm.loop !104
...
vector.body1006:                                  ; preds = %vector.body1006, %vector.ph1009
  ...
  br i1 %270, label %polly.loop_exit805, label %vector.body1006, !llvm.loop !107
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1027
  ...
  br i1 %299, label %polly.loop_exit831, label %vector.body1024, !llvm.loop !110
