; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3576.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3576.c"
...
vector.body1237:                                  ; preds = %vector.body1237, %vector.ph1241
  ...
  %wide.load1248 = load <4 x double>, <4 x double>* %143, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %146, label %middle.block1235, label %vector.body1237, !llvm.loop !85
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1037, i64 -936)
...
polly.loop_exit397:                               ; preds = %polly.loop_exit404
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next393, 16
...
vector.body1213:                                  ; preds = %vector.body1213, %vector.ph1215
  ...
  %wide.load1222 = load <4 x double>, <4 x double>* %194, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %197, label %middle.block1211, label %vector.body1213, !llvm.loop !95
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %smin1083 = call i64 @llvm.smin.i64(i64 %indvars.iv1063, i64 -936)
  %199 = add nsw i64 %smin1083, 1000
  %200 = shl nsw i64 %polly.indvar589, 6
...
vector.body1152:                                  ; preds = %vector.body1152, %vector.ph1153
  ...
  br i1 %262, label %polly.loop_exit825, label %vector.body1152, !llvm.loop !104
...
vector.body1166:                                  ; preds = %vector.body1166, %vector.ph1169
  ...
  br i1 %291, label %polly.loop_exit852, label %vector.body1166, !llvm.loop !107
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1187
  ...
  br i1 %320, label %polly.loop_exit878, label %vector.body1184, !llvm.loop !110
