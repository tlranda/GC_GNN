; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4802.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4802.c"
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1025.not = icmp eq i64 %polly.indvar_next391, 13
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %smin1045 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 -920)
  %161 = add nsw i64 %smin1045, 1000
  %162 = mul nuw nsw i64 %polly.indvar578, 80
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %exitcond1054.not = icmp eq i64 %polly.indvar_next579, 13
