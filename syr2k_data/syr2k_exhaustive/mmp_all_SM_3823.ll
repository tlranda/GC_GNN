; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3823.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3823.c"
...
vector.body1372:                                  ; preds = %vector.body1372, %vector.ph1376
  ...
  %wide.load1383 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %147, label %middle.block1370, label %vector.body1372, !llvm.loop !84
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %150 = shl nsw i64 %polly.indvar409, 6
...
vector.body1348:                                  ; preds = %vector.body1348, %vector.ph1350
  ...
  %wide.load1357 = load <4 x double>, <4 x double>* %196, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %199, label %middle.block1346, label %vector.body1348, !llvm.loop !94
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %202 = shl nsw i64 %polly.indvar623, 6
...
vector.body1287:                                  ; preds = %vector.body1287, %vector.ph1288
  ...
  br i1 %265, label %polly.loop_exit876, label %vector.body1287, !llvm.loop !103
...
vector.body1301:                                  ; preds = %vector.body1301, %vector.ph1304
  ...
  br i1 %294, label %polly.loop_exit903, label %vector.body1301, !llvm.loop !106
...
vector.body1319:                                  ; preds = %vector.body1319, %vector.ph1322
  ...
  br i1 %323, label %polly.loop_exit929, label %vector.body1319, !llvm.loop !109
