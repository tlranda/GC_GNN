; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8550.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8550.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %99 = shl nuw nsw i64 %indvars.iv791, 1
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %indvars.iv.next796 = add nuw nsw i64 %indvars.iv795, 14
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %115 = icmp slt i64 %114, -1168
  %116 = select i1 %115, i64 %114, i64 -1168
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %141 = shl nuw nsw i64 %indvars.iv811, 1
  %142 = and i64 %141, 9223372036854775776
  ...
  %polly.loop_guard373 = icmp slt i64 %146, 38
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %149 = mul nuw nsw i64 %polly.indvar365, 50
  %150 = mul nsw i64 %polly.indvar365, -50
  br label %polly.loop_header370

polly.loop_exit372:                               ; preds = %polly.loop_exit379, %polly.loop_header362
  %polly.indvar_next366 = add nuw nsw i64 %polly.indvar365, 1
  %indvars.iv.next810 = add nsw i64 %indvars.iv809, -14
  %indvars.iv.next812 = add nuw nsw i64 %indvars.iv811, 7
  %indvars.iv.next817 = add nuw nsw i64 %indvars.iv816, 14
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %152 = shl nsw i64 %polly.indvar374, 5
  %153 = sub nsw i64 %149, %152
  %154 = icmp sgt i64 %153, 0
  %155 = select i1 %154, i64 %153, i64 0
  %156 = mul nsw i64 %polly.indvar374, -32
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %183 = shl nuw nsw i64 %indvars.iv834, 1
  %184 = and i64 %183, 9223372036854775776
  ...
  %polly.loop_guard533 = icmp slt i64 %188, 38
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header522
  ...
  %indvars.iv.next833 = add nsw i64 %indvars.iv832, -14
  %indvars.iv.next835 = add nuw nsw i64 %indvars.iv834, 7
  %indvars.iv.next840 = add nuw nsw i64 %indvars.iv839, 14
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %194 = shl nsw i64 %polly.indvar534, 5
  %195 = sub nsw i64 %191, %194
  %196 = icmp sgt i64 %195, 0
  %197 = select i1 %196, i64 %195, i64 0
  %198 = mul nsw i64 %polly.indvar534, -32
  %199 = icmp slt i64 %198, -1168
  %200 = select i1 %199, i64 %198, i64 -1168
