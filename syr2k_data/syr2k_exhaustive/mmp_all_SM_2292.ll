; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2292.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2292.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1021 = add nuw nsw i64 %indvars.iv1020, 80
  %indvars.iv.next1032 = add nuw nsw i64 %indvars.iv1031, 2
  %exitcond1034.not = icmp eq i64 %polly.indvar_next220, 15
...
polly.loop_exit261:                               ; preds = %polly.loop_exit268.loopexit.us, %polly.loop_header228.split, %polly.loop_header259.preheader
  ...
  %polly.loop_cond233 = icmp ult i64 %polly.indvar231, 79
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  ...
  %151 = mul nsw i64 %polly.indvar417, -80
  %152 = mul nuw nsw i64 %polly.indvar417, 80
  %153 = lshr i64 %polly.indvar417, 1
  %154 = add nuw i64 %indvars.iv1057, %153
  %155 = mul nsw i64 %polly.indvar417, -80
  %156 = mul nuw nsw i64 %polly.indvar417, 80
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next418, 15
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %polly.loop_guard431 = icmp slt i64 %165, 80
...
polly.loop_exit466:                               ; preds = %polly.loop_exit473.loopexit.us, %polly.loop_header428.split, %polly.loop_header464.preheader
  ...
  %polly.loop_cond434 = icmp ult i64 %polly.indvar432, 79
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  ...
  %205 = mul nsw i64 %polly.indvar622, -80
  %206 = mul nuw nsw i64 %polly.indvar622, 80
  %207 = lshr i64 %polly.indvar622, 1
  %208 = add nuw i64 %indvars.iv1083, %207
  %209 = mul nsw i64 %polly.indvar622, -80
  %210 = mul nuw nsw i64 %polly.indvar622, 80
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1072 = add nuw nsw i64 %indvars.iv1071, 80
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 2
  %exitcond1086.not = icmp eq i64 %polly.indvar_next623, 15
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %polly.loop_guard636 = icmp slt i64 %219, 80
...
polly.loop_exit671:                               ; preds = %polly.loop_exit678.loopexit.us, %polly.loop_header633.split, %polly.loop_header669.preheader
  ...
  %polly.loop_cond639 = icmp ult i64 %polly.indvar637, 79
