; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4343.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4343.c"
...
polly.loop_header387:                             ; preds = %polly.loop_exit396, %polly.loop_header381
  ...
  %131 = shl nsw i64 %polly.indvar390, 7
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond1017.not = icmp eq i64 %polly.indvar_next391, 8
...
polly.loop_header576:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %smin1037 = call i64 @llvm.smin.i64(i64 %indvars.iv1021, i64 -872)
  %161 = add nsw i64 %smin1037, 1000
  %162 = shl nsw i64 %polly.indvar579, 7
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next580, 8
