; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5206.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5206.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond995.not = icmp eq i64 %polly.indvar_next209, 250
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %polly.loop_guard2331089 = icmp sgt i64 %123, -1
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1201
  ...
  %138 = shl nuw nsw i64 %index1204, 3
  %139 = getelementptr i8, i8* %scevgep379, i64 %138
  %140 = bitcast i8* %139 to <4 x double>*
  %wide.load1208 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !74, !noalias !76
  %141 = fmul fast <4 x double> %wide.load1208, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %143 = icmp eq i64 %index.next1205, %n.vec1203
  br i1 %143, label %middle.block1195, label %vector.body1197, !llvm.loop !80

middle.block1195:                                 ; preds = %vector.body1197
  %cmp.n1207 = icmp eq i64 %136, %n.vec1203
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %145 = udiv i64 %indvars.iv1019, 5
  %146 = add nuw i64 %indvars.iv1017, %145
  %umin1021 = call i64 @llvm.umin.i64(i64 %146, i64 53)
  %147 = mul nsw i64 %polly.indvar386, -128
  %148 = icmp slt i64 %147, -1072
  %149 = select i1 %148, i64 %147, i64 -1072
  %150 = add nsw i64 %149, 1199
  %151 = shl nsw i64 %polly.indvar386, 7
  %152 = add nuw nsw i64 %umin1021, 6
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next393, 250
...
polly.loop_header403.preheader:                   ; preds = %polly.loop_header396
  ...
  %168 = add i64 %smax1004, %indvars.iv1007
...
polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  ...
  %exitcond1022.not = icmp eq i64 %polly.indvar399, %152
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  %indvars.iv1009 = phi i64 [ %168, %polly.loop_header403.preheader ], [ %indvars.iv.next1010, %polly.loop_exit441 ]
  ...
  %polly.loop_guard4201090 = icmp sgt i64 %171, -1
...
polly.loop_header558:                             ; preds = %polly.loop_exit566, %polly.start472
  ...
  %min.iters.check1174 = icmp ult i64 %184, 4
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1175
  ...
  %186 = shl nuw nsw i64 %index1178, 3
  %187 = getelementptr i8, i8* %scevgep570, i64 %186
  %188 = bitcast i8* %187 to <4 x double>*
  %wide.load1182 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !84, !noalias !86
  %189 = fmul fast <4 x double> %wide.load1182, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %191 = icmp eq i64 %index.next1179, %n.vec1177
  br i1 %191, label %middle.block1171, label %vector.body1173, !llvm.loop !90

middle.block1171:                                 ; preds = %vector.body1173
  %cmp.n1181 = icmp eq i64 %184, %n.vec1177
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %193 = udiv i64 %indvars.iv1047, 5
  %194 = add nuw i64 %indvars.iv1045, %193
  %umin1049 = call i64 @llvm.umin.i64(i64 %194, i64 53)
  %195 = mul nsw i64 %polly.indvar577, -128
  %196 = icmp slt i64 %195, -1072
  %197 = select i1 %196, i64 %195, i64 -1072
  %198 = add nsw i64 %197, 1199
  %199 = shl nsw i64 %polly.indvar577, 7
  %200 = add nuw nsw i64 %umin1049, 6
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar_next584, 250
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header587
  ...
  %216 = add i64 %smax1032, %indvars.iv1035
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar590, %200
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1037 = phi i64 [ %216, %polly.loop_header594.preheader ], [ %indvars.iv.next1038, %polly.loop_exit632 ]
  ...
  %polly.loop_guard6111091 = icmp sgt i64 %219, -1
...
vector.ph1113:                                    ; preds = %polly.loop_header799
  %broadcast.splatinsert1120 = insertelement <4 x i64> poison, i64 %236, i32 0
  %broadcast.splat1121 = shufflevector <4 x i64> %broadcast.splatinsert1120, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1122 = insertelement <4 x i32> poison, i32 %239, i32 0
...
vector.body1112:                                  ; preds = %vector.body1112, %vector.ph1113
  ...
  %241 = add nuw nsw <4 x i64> %vec.ind1118, %broadcast.splat1121
  %242 = trunc <4 x i64> %241 to <4 x i32>
  %243 = mul <4 x i32> %broadcast.splat1123, %242
  ...
  %253 = icmp eq i64 %index.next1115, %235
  br i1 %253, label %polly.loop_exit807, label %vector.body1112, !llvm.loop !99

polly.loop_exit807:                               ; preds = %vector.body1112, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1082.not = icmp eq i64 %polly.indvar802, %233
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1078.not = icmp eq i64 %polly.indvar808, %237
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %smin1127 = call i64 @llvm.smin.i64(i64 %263, i64 -968)
  %264 = add nsw i64 %smin1127, 1000
  %smin1067 = call i64 @llvm.smin.i64(i64 %indvars.iv1065, i64 -968)
  %265 = shl nsw i64 %polly.indvar823, 5
  %266 = add nsw i64 %smin1067, 999
...
vector.body1126:                                  ; preds = %vector.body1126, %vector.ph1129
  ...
  %270 = add nuw nsw <4 x i64> %vec.ind1136, %broadcast.splat1139
  %271 = trunc <4 x i64> %270 to <4 x i32>
  %272 = mul <4 x i32> %broadcast.splat1141, %271
  ...
  %282 = icmp eq i64 %index.next1133, %264
  br i1 %282, label %polly.loop_exit834, label %vector.body1126, !llvm.loop !102

polly.loop_exit834:                               ; preds = %vector.body1126, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1072.not = icmp eq i64 %polly.indvar829, %262
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1068.not = icmp eq i64 %polly.indvar835, %266
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %smin1145 = call i64 @llvm.smin.i64(i64 %292, i64 -968)
  %293 = add nsw i64 %smin1145, 1000
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1055, i64 -968)
  %294 = shl nsw i64 %polly.indvar849, 5
  %295 = add nsw i64 %smin1057, 999
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1147
  ...
  %299 = add nuw nsw <4 x i64> %vec.ind1154, %broadcast.splat1157
  %300 = trunc <4 x i64> %299 to <4 x i32>
  %301 = mul <4 x i32> %broadcast.splat1159, %300
  ...
  %311 = icmp eq i64 %index.next1151, %293
  br i1 %311, label %polly.loop_exit860, label %vector.body1144, !llvm.loop !105

polly.loop_exit860:                               ; preds = %vector.body1144, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1062.not = icmp eq i64 %polly.indvar855, %291
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar861, %295
...
polly.loop_header446.us.3:                        ; preds = %polly.loop_header446.us.3, %polly.loop_exit448.loopexit.us.2
  ...
  br i1 %exitcond1015.3.not, label %polly.loop_exit441, label %polly.loop_header446.us.3
...
polly.loop_header637.us.3:                        ; preds = %polly.loop_header637.us.3, %polly.loop_exit639.loopexit.us.2
  ...
  br i1 %exitcond1043.3.not, label %polly.loop_exit632, label %polly.loop_header637.us.3
}
