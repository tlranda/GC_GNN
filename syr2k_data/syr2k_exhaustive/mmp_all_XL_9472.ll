; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9472.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9472.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %101 = mul nuw nsw i64 %polly.indvar214, 20
  %102 = add nsw i64 %101, %98
  %103 = icmp sgt i64 %102, 0
  %104 = select i1 %103, i64 %102, i64 0
  %polly.loop_guard = icmp slt i64 %104, 8
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %128 = udiv i64 %indvars.iv815, 5
  %129 = mul nsw i64 %polly.indvar357, -8
  %130 = shl nsw i64 %polly.indvar357, 3
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %131 = mul nuw nsw i64 %polly.indvar363, 20
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit376
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %exitcond818.not = icmp eq i64 %polly.indvar_next364, 50
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %132 = mul nuw nsw i64 %polly.indvar370, 20
  %133 = add nsw i64 %132, %129
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard377 = icmp slt i64 %135, 8
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %159 = udiv i64 %indvars.iv836, 5
  %160 = mul nsw i64 %polly.indvar515, -8
  %161 = shl nsw i64 %polly.indvar515, 3
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %162 = mul nuw nsw i64 %polly.indvar521, 20
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond839.not = icmp eq i64 %polly.indvar_next522, 50
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %163 = mul nuw nsw i64 %polly.indvar528, 20
  %164 = add nsw i64 %163, %160
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard535 = icmp slt i64 %166, 8
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next543.us, 20
