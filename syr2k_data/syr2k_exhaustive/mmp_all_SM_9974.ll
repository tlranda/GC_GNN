; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9974.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9974.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond790.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_exit225:                               ; preds = %polly.loop_exit231.loopexit.us, %polly.loop_header217
  ...
  %exitcond787.not = icmp eq i64 %polly.indvar_next221, 50
...
vector.body978:                                   ; preds = %vector.body978, %vector.ph982
  ...
  %wide.load989 = load <4 x double>, <4 x double>* %119, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %122, label %middle.block976, label %vector.body978, !llvm.loop !74
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %124 = lshr i64 %polly.indvar355, 1
  %125 = mul nuw nsw i64 %polly.indvar355, 50
  br label %polly.loop_header358

polly.loop_exit360:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next794 = add nuw nsw i64 %indvars.iv793, 50
  %exitcond808.not = icmp eq i64 %polly.indvar_next356, 24
...
polly.loop_header365:                             ; preds = %polly.loop_exit373, %polly.loop_header358
  ...
  %128 = mul nuw nsw i64 %polly.indvar368, 100
...
polly.loop_header371:                             ; preds = %polly.loop_exit379, %polly.loop_header365
  ...
  %smin799 = call i64 @llvm.smin.i64(i64 %indvars.iv797, i64 99)
...
polly.loop_exit379:                               ; preds = %polly.loop_exit386.loopexit.us, %polly.loop_header371
  ...
  %exitcond805.not = icmp eq i64 %polly.indvar_next375, 50
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph956
  ...
  %wide.load963 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %149, label %middle.block952, label %vector.body954, !llvm.loop !83
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %151 = lshr i64 %polly.indvar511, 1
  %152 = mul nuw nsw i64 %polly.indvar511, 50
...
polly.loop_exit516:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next812 = add nuw nsw i64 %indvars.iv811, 50
  %exitcond826.not = icmp eq i64 %polly.indvar_next512, 24
...
polly.loop_header514:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %153 = shl nsw i64 %polly.indvar517, 5
...
polly.loop_header521:                             ; preds = %polly.loop_exit529, %polly.loop_header514
  ...
  %155 = mul nuw nsw i64 %polly.indvar524, 100
...
polly.loop_header527:                             ; preds = %polly.loop_exit535, %polly.loop_header521
  ...
  %smin817 = call i64 @llvm.smin.i64(i64 %indvars.iv815, i64 99)
...
polly.loop_exit535:                               ; preds = %polly.loop_exit542.loopexit.us, %polly.loop_header527
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next531, 50
...
vector.body892:                                   ; preds = %vector.body892, %vector.ph894
  ...
  br i1 %190, label %polly.loop_exit708, label %vector.body892, !llvm.loop !92
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  br i1 %219, label %polly.loop_exit735, label %vector.body907, !llvm.loop !95
...
vector.body925:                                   ; preds = %vector.body925, %vector.ph928
  ...
  br i1 %248, label %polly.loop_exit761, label %vector.body925, !llvm.loop !98
