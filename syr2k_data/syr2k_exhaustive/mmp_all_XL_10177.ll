; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10177.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10177.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %144 = mul nsw i64 %polly.indvar357, -80
  %145 = mul nuw nsw i64 %polly.indvar357, 80
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %161 = shl nsw i64 %polly.indvar370, 5
  %162 = add nsw i64 %161, %144
  %163 = icmp sgt i64 %162, 0
  %164 = select i1 %163, i64 %162, i64 0
  %polly.loop_guard377 = icmp slt i64 %164, 80
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %189 = mul nsw i64 %polly.indvar515, -80
  %190 = mul nuw nsw i64 %polly.indvar515, 80
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %206 = shl nsw i64 %polly.indvar528, 5
  %207 = add nsw i64 %206, %189
  %208 = icmp sgt i64 %207, 0
  %209 = select i1 %208, i64 %207, i64 0
  %polly.loop_guard535 = icmp slt i64 %209, 80
