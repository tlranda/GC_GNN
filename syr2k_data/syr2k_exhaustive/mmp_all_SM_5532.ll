; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5532.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5532.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next209, 5
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 255)
  ...
  %smin845.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844, i64 255)
  %108 = or i64 %104, 1
  ...
  %smin845.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.1, i64 255)
  %112 = or i64 %104, 2
  ...
  %smin845.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.2, i64 255)
  %116 = or i64 %104, 3
  ...
  %smin845.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.3, i64 255)
  %120 = or i64 %104, 4
  ...
  %smin845.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.4, i64 255)
  %124 = or i64 %104, 5
  ...
  %smin845.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.5, i64 255)
  %128 = or i64 %104, 6
  ...
  %smin845.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.6, i64 255)
  %132 = or i64 %104, 7
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %155 = mul nuw nsw i64 %polly.indvar375, 80
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %156 = shl nsw i64 %polly.indvar381, 8
  br label %polly.loop_header384

polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %157 = mul nsw i64 %polly.indvar381, -256
  %158 = shl nsw i64 %polly.indvar381, 5
...
polly.loop_exit402:                               ; preds = %polly.loop_exit408
  ...
  %exitcond872.not = icmp eq i64 %polly.indvar_next382, 5
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %smin866 = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 255)
  ...
  %smin866.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865, i64 255)
  %165 = or i64 %161, 1
  ...
  %smin866.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.1, i64 255)
  %169 = or i64 %161, 2
  ...
  %smin866.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.2, i64 255)
  %173 = or i64 %161, 3
  ...
  %smin866.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.3, i64 255)
  %177 = or i64 %161, 4
  ...
  %smin866.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.4, i64 255)
  %181 = or i64 %161, 5
  ...
  %smin866.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.5, i64 255)
  %185 = or i64 %161, 6
  ...
  %smin866.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.6, i64 255)
  %189 = or i64 %161, 7
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %212 = mul nuw nsw i64 %polly.indvar548, 80
...
polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %214 = mul nsw i64 %polly.indvar554, -256
  %215 = shl nsw i64 %polly.indvar554, 5
...
polly.loop_exit575:                               ; preds = %polly.loop_exit581
  ...
  %exitcond893.not = icmp eq i64 %polly.indvar_next555, 5
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit559
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 255)
  ...
  %smin887.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886, i64 255)
  %222 = or i64 %218, 1
  ...
  %smin887.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.1, i64 255)
  %226 = or i64 %218, 2
  ...
  %smin887.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.2, i64 255)
  %230 = or i64 %218, 3
  ...
  %smin887.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.3, i64 255)
  %234 = or i64 %218, 4
  ...
  %smin887.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.4, i64 255)
  %238 = or i64 %218, 5
  ...
  %smin887.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.5, i64 255)
  %242 = or i64 %218, 6
  ...
  %smin887.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.6, i64 255)
  %246 = or i64 %218, 7
