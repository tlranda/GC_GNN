; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1919.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1919.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %smin1060 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -872)
...
polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header222
  ...
  %exitcond1063.not = icmp eq i64 %polly.indvar_next226, 8
...
polly.loop_header428:                             ; preds = %polly.loop_exit438, %polly.loop_header422
  ...
  %smin1090 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 -872)
...
polly.loop_header436.preheader:                   ; preds = %polly.loop_header428
  %175 = shl nsw i64 %polly.indvar431, 7
...
polly.loop_exit438:                               ; preds = %polly.loop_exit446, %polly.loop_header428
  ...
  %exitcond1093.not = icmp eq i64 %polly.indvar_next432, 8
...
polly.loop_header641:                             ; preds = %polly.loop_exit651, %polly.loop_header635
  ...
  %smin1120 = call i64 @llvm.smin.i64(i64 %indvars.iv1099, i64 -872)
...
polly.loop_header649.preheader:                   ; preds = %polly.loop_header641
  %240 = shl nsw i64 %polly.indvar644, 7
...
polly.loop_exit651:                               ; preds = %polly.loop_exit659, %polly.loop_header641
  ...
  %indvars.iv.next1100 = add nsw i64 %indvars.iv1099, -128
  %exitcond1123.not = icmp eq i64 %polly.indvar_next645, 8
