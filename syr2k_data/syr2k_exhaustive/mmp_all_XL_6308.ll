; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6308.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6308.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %indvars.iv862 = phi i64 [ %indvars.iv.next863, %polly.loop_exit229 ], [ 47, %polly.loop_header199 ]
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_exit219.7
  ...
  %indvars.iv.next861 = add nsw i64 %indvars.iv860, -46
  %indvars.iv.next863 = add nuw nsw i64 %indvars.iv862, 23
  %indvars.iv.next867 = add nuw nsw i64 %indvars.iv866, 46
...
polly.loop_header382:                             ; preds = %polly.loop_exit408, %polly.loop_header376
  ...
  %indvars.iv884 = phi i64 [ %indvars.iv.next885, %polly.loop_exit408 ], [ 47, %polly.loop_header376 ]
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415, %polly.loop_exit396.7
  ...
  %indvars.iv.next883 = add nsw i64 %indvars.iv882, -46
  %indvars.iv.next885 = add nuw nsw i64 %indvars.iv884, 23
  %indvars.iv.next890 = add nuw nsw i64 %indvars.iv889, 46
...
polly.loop_header406:                             ; preds = %polly.loop_exit396.7, %polly.loop_exit415
  ...
  %160 = mul nsw i64 %polly.indvar410, -96
...
polly.loop_header562:                             ; preds = %polly.loop_exit588, %polly.loop_header556
  ...
  %indvars.iv908 = phi i64 [ %indvars.iv.next909, %polly.loop_exit588 ], [ 47, %polly.loop_header556 ]
...
polly.loop_exit588:                               ; preds = %polly.loop_exit595, %polly.loop_exit576.7
  ...
  %indvars.iv.next907 = add nsw i64 %indvars.iv906, -46
  %indvars.iv.next909 = add nuw nsw i64 %indvars.iv908, 23
  %indvars.iv.next914 = add nuw nsw i64 %indvars.iv913, 46
...
polly.loop_header586:                             ; preds = %polly.loop_exit576.7, %polly.loop_exit595
  ...
  %200 = mul nsw i64 %polly.indvar590, 96
  %201 = sub nsw i64 %197, %200
  %202 = icmp sgt i64 %201, 0
  %203 = select i1 %202, i64 %201, i64 0
  %204 = mul nsw i64 %polly.indvar590, -96
...
polly.loop_exit219.7:                             ; preds = %polly.loop_header217.7
  %314 = mul nsw i64 %polly.indvar208, -50
  %315 = mul nuw nsw i64 %polly.indvar208, 23
  %316 = add nuw nsw i64 %315, 47
  %pexp.p_div_q = udiv i64 %316, 48
  %317 = sub nsw i64 %polly.indvar208, %pexp.p_div_q
  %polly.loop_guard = icmp slt i64 %317, 13
...
polly.loop_exit396.7:                             ; preds = %polly.loop_header394.7
  %325 = mul nsw i64 %polly.indvar385, -50
  %326 = mul nuw nsw i64 %polly.indvar385, 23
  %327 = add nuw nsw i64 %326, 47
  %pexp.p_div_q404 = udiv i64 %327, 48
  %328 = sub nsw i64 %polly.indvar385, %pexp.p_div_q404
  %polly.loop_guard409 = icmp slt i64 %328, 13
...
polly.loop_exit576.7:                             ; preds = %polly.loop_header574.7
  %336 = mul nsw i64 %polly.indvar565, -50
  %337 = mul nuw nsw i64 %polly.indvar565, 23
  %338 = add nuw nsw i64 %337, 47
  %pexp.p_div_q584 = udiv i64 %338, 48
  %339 = sub nsw i64 %polly.indvar565, %pexp.p_div_q584
  %polly.loop_guard589 = icmp slt i64 %339, 13
