; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10111.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10111.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv795 = phi i64 [ %indvars.iv.next796, %polly.loop_exit207 ], [ 2, %polly.loop_exit193 ]
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233884 = icmp sgt i64 %110, -1
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1003
  ...
  %124 = shl nuw nsw i64 %index1006, 3
  %125 = getelementptr i8, i8* %scevgep350, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1010 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !68, !noalias !70
  %127 = fmul fast <4 x double> %wide.load1010, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1007, %n.vec1005
  br i1 %129, label %middle.block997, label %vector.body999, !llvm.loop !73

middle.block997:                                  ; preds = %vector.body999
  %cmp.n1009 = icmp eq i64 %122, %n.vec1005
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv819 = phi i64 [ %indvars.iv.next820, %polly.loop_exit362 ], [ 2, %polly.loop_exit346 ]
...
polly.loop_header373:                             ; preds = %polly.loop_header373.preheader, %polly.loop_exit382
  ...
  %polly.loop_guard390885 = icmp sgt i64 %144, -1
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph977
  ...
  %158 = shl nuw nsw i64 %index980, 3
  %159 = getelementptr i8, i8* %scevgep507, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load984 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !77, !noalias !79
  %161 = fmul fast <4 x double> %wide.load984, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next981, %n.vec979
  br i1 %163, label %middle.block973, label %vector.body975, !llvm.loop !82

middle.block973:                                  ; preds = %vector.body975
  %cmp.n983 = icmp eq i64 %156, %n.vec979
...
polly.loop_header501:                             ; preds = %polly.loop_header501.preheader, %polly.loop_header501
  ...
  br i1 %exitcond848.not, label %polly.loop_exit503, label %polly.loop_header501, !llvm.loop !83

polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  %indvars.iv843 = phi i64 [ %indvars.iv.next844, %polly.loop_exit519 ], [ 2, %polly.loop_exit503 ]
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar_next515, 19
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar_next521, 16
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header523
  ...
  %176 = add i64 %smax830, %indvars.iv833
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  %indvars.iv835 = phi i64 [ %176, %polly.loop_header530.preheader ], [ %indvars.iv.next836, %polly.loop_exit539 ]
  ...
  %polly.loop_guard547886 = icmp sgt i64 %178, -1
...
polly.loop_exit546.loopexit.us:                   ; preds = %polly.loop_header544.us
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar540.us, %171
...
polly.loop_header698:                             ; preds = %polly.loop_exit706, %polly.loop_header692
  ...
  %smin914 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin914, 1200
  %smin872 = call i64 @llvm.smin.i64(i64 %indvars.iv870, i64 -1168)
  %194 = shl nsw i64 %polly.indvar701, 5
  %195 = add nsw i64 %smin872, 1199
...
vector.ph915:                                     ; preds = %polly.loop_header704
  %broadcast.splatinsert922 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat923 = shufflevector <4 x i64> %broadcast.splatinsert922, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert924 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph915
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind920, %broadcast.splat923
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat925, %200
  ...
  %211 = icmp eq i64 %index.next917, %193
  br i1 %211, label %polly.loop_exit712, label %vector.body913, !llvm.loop !91

polly.loop_exit712:                               ; preds = %vector.body913, %polly.loop_header710
  %polly.indvar_next708 = add nuw nsw i64 %polly.indvar707, 1
  %exitcond877.not = icmp eq i64 %polly.indvar707, %191
...
polly.loop_header710:                             ; preds = %polly.loop_header704, %polly.loop_header710
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar713, %195
  br i1 %exitcond873.not, label %polly.loop_exit712, label %polly.loop_header710, !llvm.loop !92
...
polly.loop_header725:                             ; preds = %polly.loop_exit733, %polly.loop_header719
  ...
  %smin929 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin929, 1000
  %smin862 = call i64 @llvm.smin.i64(i64 %indvars.iv860, i64 -968)
  %223 = shl nsw i64 %polly.indvar728, 5
  %224 = add nsw i64 %smin862, 999
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph931
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind938, %broadcast.splat941
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat943, %229
  ...
  %240 = icmp eq i64 %index.next935, %222
  br i1 %240, label %polly.loop_exit739, label %vector.body928, !llvm.loop !94

polly.loop_exit739:                               ; preds = %vector.body928, %polly.loop_header737
  %polly.indvar_next735 = add nuw nsw i64 %polly.indvar734, 1
  %exitcond867.not = icmp eq i64 %polly.indvar734, %220
...
polly.loop_header737:                             ; preds = %polly.loop_header731, %polly.loop_header737
  ...
  %exitcond863.not = icmp eq i64 %polly.indvar740, %224
  br i1 %exitcond863.not, label %polly.loop_exit739, label %polly.loop_header737, !llvm.loop !95
...
polly.loop_header751:                             ; preds = %polly.loop_exit759, %polly.loop_header745
  ...
  %smin947 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin947, 1000
  %smin852 = call i64 @llvm.smin.i64(i64 %indvars.iv850, i64 -968)
  %252 = shl nsw i64 %polly.indvar754, 5
  %253 = add nsw i64 %smin852, 999
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph949
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind956, %broadcast.splat959
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat961, %258
  ...
  %269 = icmp eq i64 %index.next953, %251
  br i1 %269, label %polly.loop_exit765, label %vector.body946, !llvm.loop !97

polly.loop_exit765:                               ; preds = %vector.body946, %polly.loop_header763
  %polly.indvar_next761 = add nuw nsw i64 %polly.indvar760, 1
  %exitcond857.not = icmp eq i64 %polly.indvar760, %249
...
polly.loop_header763:                             ; preds = %polly.loop_header757, %polly.loop_header763
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar766, %253
  br i1 %exitcond853.not, label %polly.loop_exit765, label %polly.loop_header763, !llvm.loop !98
}
