; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7015.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7015.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar_next219, 75
...
polly.loop_exit235:                               ; preds = %polly.loop_exit242.loopexit.us, %polly.loop_header227
  ...
  %polly.loop_cond232 = icmp ult i64 %polly.indvar230, 15
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  ...
  %125 = mul nsw i64 %polly.indvar389, -16
  %126 = shl nsw i64 %polly.indvar389, 4
...
polly.loop_exit395:                               ; preds = %polly.loop_exit402
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next390, 75
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %127 = mul nuw nsw i64 %polly.indvar396, 100
  %128 = add nsw i64 %127, %125
  %129 = icmp sgt i64 %128, 0
  %130 = select i1 %129, i64 %128, i64 0
  %polly.loop_guard403 = icmp slt i64 %130, 16
...
polly.loop_exit409:                               ; preds = %polly.loop_exit416.loopexit.us, %polly.loop_header400
  ...
  %polly.loop_cond406 = icmp ult i64 %polly.indvar404, 15
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  ...
  %152 = mul nsw i64 %polly.indvar563, -16
  %153 = shl nsw i64 %polly.indvar563, 4
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next564, 75
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %154 = mul nuw nsw i64 %polly.indvar570, 100
  %155 = add nsw i64 %154, %152
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %polly.loop_guard577 = icmp slt i64 %157, 16
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583, %polly.loop_header567
  ...
  %indvars.iv.next867 = add nsw i64 %indvars.iv866, 100
  %indvars.iv.next872 = add nsw i64 %indvars.iv871, -100
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590.loopexit.us, %polly.loop_header574
  ...
  %polly.loop_cond580 = icmp ult i64 %polly.indvar578, 15
