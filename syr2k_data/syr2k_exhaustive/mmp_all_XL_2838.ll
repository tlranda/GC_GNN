; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2838.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2838.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1026.not = icmp eq i64 %107, 300
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %109 = shl nuw nsw i64 %polly.indvar214, 1
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %polly.loop_guard256 = icmp slt i64 %120, 8
...
polly.loop_header253.us:                          ; preds = %polly.loop_header246.us, %polly.loop_exit263.us
  %indvars.iv1021 = phi i64 [ %108, %polly.loop_header246.us ], [ %indvars.iv.next1022, %polly.loop_exit263.us ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %146 = sub nsw i64 %indvars.iv1033, %145
  %147 = add i64 %indvars.iv1038, %145
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1048.not = icmp eq i64 %153, 300
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1040 = phi i64 [ %indvars.iv.next1041, %polly.loop_exit445 ], [ %147, %polly.loop_header395 ]
  %indvars.iv1035 = phi i64 [ %indvars.iv.next1036, %polly.loop_exit445 ], [ %146, %polly.loop_header395 ]
  ...
  %154 = add i64 %smax1037, %indvars.iv1040
  %155 = shl nuw nsw i64 %polly.indvar405, 1
  %.not.not885 = icmp ugt i64 %155, %polly.indvar398
  %156 = shl nsw i64 %polly.indvar405, 3
  %157 = add nsw i64 %156, %149
  %158 = icmp sgt i64 %157, 0
  %159 = select i1 %158, i64 %157, i64 0
  %160 = add nsw i64 %157, 7
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %polly.loop_guard453 = icmp slt i64 %166, 8
...
polly.loop_header450.us:                          ; preds = %polly.loop_header443.us, %polly.loop_exit460.us
  %indvars.iv1042 = phi i64 [ %154, %polly.loop_header443.us ], [ %indvars.iv.next1043, %polly.loop_exit460.us ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %190 = lshr i64 %polly.indvar595, 1
  %191 = shl nuw nsw i64 %190, 3
  %192 = sub nsw i64 %indvars.iv1055, %191
  %193 = add i64 %indvars.iv1060, %191
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1062 = phi i64 [ %indvars.iv.next1063, %polly.loop_exit642 ], [ %193, %polly.loop_header592 ]
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit642 ], [ %192, %polly.loop_header592 ]
  %polly.indvar602 = phi i64 [ %polly.indvar_next603, %polly.loop_exit642 ], [ %190, %polly.loop_header592 ]
  %smax1059 = call i64 @llvm.smax.i64(i64 %indvars.iv1057, i64 0)
  %200 = add i64 %smax1059, %indvars.iv1062
  %201 = shl nuw nsw i64 %polly.indvar602, 1
  %.not.not886 = icmp ugt i64 %201, %polly.indvar595
  %202 = shl nsw i64 %polly.indvar602, 3
  %203 = add nsw i64 %202, %195
  %204 = icmp sgt i64 %203, 0
  %205 = select i1 %204, i64 %203, i64 0
  %206 = add nsw i64 %203, 7
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %polly.loop_guard650 = icmp slt i64 %212, 8
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.us, %polly.loop_exit657.us
  %indvars.iv1064 = phi i64 [ %200, %polly.loop_header640.us ], [ %indvars.iv.next1065, %polly.loop_exit657.us ]
