; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6043.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6043.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -18
  %indvars.iv.next845 = add nuw nsw i64 %indvars.iv844, 9
  %indvars.iv.next849 = add nuw nsw i64 %indvars.iv848, 18
  %exitcond856.not = icmp eq i64 %polly.indvar_next203, 38
...
polly.loop_header221:                             ; preds = %polly.loop_exit207, %polly.loop_exit229
  ...
  %108 = mul nsw i64 %polly.indvar224, 50
  %109 = sub nsw i64 %101, %108
  %110 = icmp sgt i64 %109, 0
  %111 = select i1 %110, i64 %109, i64 0
  %polly.loop_guard237 = icmp slt i64 %111, 50
...
polly.loop_header234.us:                          ; preds = %polly.loop_exit244.us, %polly.loop_header227.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 31)
...
polly.loop_exit244.us:                            ; preds = %polly.loop_header242.us, %polly.loop_header234.us
  ...
  %polly.loop_cond240.us = icmp ult i64 %polly.indvar238.us, 49
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236.loopexit.us, %polly.loop_header221
  ...
  %polly.loop_cond226 = icmp slt i64 %polly.indvar224, 23
  %indvars.iv.next847 = add i64 %indvars.iv846, -50
  %indvars.iv.next851 = add i64 %indvars.iv850, 50
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit398
  ...
  %130 = udiv i64 %indvars.iv865, 25
  %131 = mul nuw nsw i64 %130, 50
  %132 = add i64 %indvars.iv863, %131
  %133 = sub nsw i64 %indvars.iv870, %131
  %134 = shl nsw i64 %polly.indvar375, 5
  br label %polly.loop_header378

polly.loop_exit380:                               ; preds = %polly.loop_exit386
  %135 = mul nsw i64 %polly.indvar375, -32
  %136 = mul nuw nsw i64 %polly.indvar375, 9
  %137 = add nuw nsw i64 %136, 24
  %pexp.p_div_q394 = udiv i64 %137, 25
  %138 = sub nsw i64 %polly.indvar375, %pexp.p_div_q394
  %polly.loop_guard399 = icmp slt i64 %138, 24
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405, %polly.loop_exit380
  ...
  %indvars.iv.next864 = add nsw i64 %indvars.iv863, -18
  %indvars.iv.next866 = add nuw nsw i64 %indvars.iv865, 9
  %indvars.iv.next871 = add nuw nsw i64 %indvars.iv870, 18
  %exitcond879.not = icmp eq i64 %polly.indvar_next376, 38
...
polly.loop_header396:                             ; preds = %polly.loop_exit380, %polly.loop_exit405
  ...
  %141 = mul nsw i64 %polly.indvar400, 50
  %142 = sub nsw i64 %134, %141
  %143 = icmp sgt i64 %142, 0
  %144 = select i1 %143, i64 %142, i64 0
  %polly.loop_guard413 = icmp slt i64 %144, 50
...
polly.loop_header410.us:                          ; preds = %polly.loop_exit420.us, %polly.loop_header403.us
  ...
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv874, i64 31)
...
polly.loop_exit420.us:                            ; preds = %polly.loop_header418.us, %polly.loop_header410.us
  ...
  %polly.loop_cond416.us = icmp ult i64 %polly.indvar414.us, 49
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412.loopexit.us, %polly.loop_header396
  ...
  %polly.loop_cond402 = icmp slt i64 %polly.indvar400, 23
...
polly.loop_header548:                             ; preds = %polly.loop_header548.preheader, %polly.loop_exit574
  ...
  %163 = udiv i64 %indvars.iv888, 25
  %164 = mul nuw nsw i64 %163, 50
  %165 = add i64 %indvars.iv886, %164
  %166 = sub nsw i64 %indvars.iv893, %164
  %167 = shl nsw i64 %polly.indvar551, 5
  br label %polly.loop_header554

polly.loop_exit556:                               ; preds = %polly.loop_exit562
  %168 = mul nsw i64 %polly.indvar551, -32
  %169 = mul nuw nsw i64 %polly.indvar551, 9
  %170 = add nuw nsw i64 %169, 24
  %pexp.p_div_q570 = udiv i64 %170, 25
  %171 = sub nsw i64 %polly.indvar551, %pexp.p_div_q570
  %polly.loop_guard575 = icmp slt i64 %171, 24
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_exit556
  ...
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, -18
  %indvars.iv.next889 = add nuw nsw i64 %indvars.iv888, 9
  %indvars.iv.next894 = add nuw nsw i64 %indvars.iv893, 18
  %exitcond902.not = icmp eq i64 %polly.indvar_next552, 38
...
polly.loop_header572:                             ; preds = %polly.loop_exit556, %polly.loop_exit581
  ...
  %174 = mul nsw i64 %polly.indvar576, 50
  %175 = sub nsw i64 %167, %174
  %176 = icmp sgt i64 %175, 0
  %177 = select i1 %176, i64 %175, i64 0
  %polly.loop_guard589 = icmp slt i64 %177, 50
...
polly.loop_header586.us:                          ; preds = %polly.loop_exit596.us, %polly.loop_header579.us
  ...
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 31)
...
polly.loop_exit596.us:                            ; preds = %polly.loop_header594.us, %polly.loop_header586.us
  ...
  %polly.loop_cond592.us = icmp ult i64 %polly.indvar590.us, 49
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588.loopexit.us, %polly.loop_header572
  ...
  %polly.loop_cond578 = icmp slt i64 %polly.indvar576, 23
  %indvars.iv.next891 = add i64 %indvars.iv890, -50
