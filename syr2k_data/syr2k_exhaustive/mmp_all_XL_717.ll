; ModuleID = 'syr2k_exhaustive/mmp_all_XL_717.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_717.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit274, %polly.loop_exit208
  ...
  %153 = mul nsw i64 %indvar1503, -50
  %154 = add i64 %101, %153
  %smax1522 = call i64 @llvm.smax.i64(i64 %154, i64 0)
  %155 = mul nuw nsw i64 %indvar1503, 50
  %156 = add i64 %103, %155
  %157 = add i64 %smax1522, %156
  %158 = mul nsw i64 %indvar1503, -50
  %159 = add i64 %109, %158
  %smax1505 = call i64 @llvm.smax.i64(i64 %159, i64 0)
  %160 = mul nuw nsw i64 %indvar1503, 50
  %161 = add i64 %108, %160
  ...
  %170 = mul nuw nsw i64 %polly.indvar225, 50
  %171 = add nsw i64 %170, %119
  %172 = icmp sgt i64 %171, 16
  %173 = select i1 %172, i64 %171, i64 16
  %174 = add nsw i64 %171, 49
  %polly.loop_guard261 = icmp sgt i64 %171, -50
...
polly.loop_header272.preheader:                   ; preds = %polly.merge, %polly.loop_header228.us987, %polly.merge.us
  ...
  %polly.loop_guard282 = icmp slt i64 %178, 50
...
polly.loop_header419:                             ; preds = %polly.loop_header419.preheader, %polly.loop_exit444
  ...
  %222 = shl nuw nsw i64 %polly.indvar422, 3
  %223 = udiv i64 %222, 25
  %224 = mul nuw nsw i64 %223, 50
  ...
  %230 = shl nuw nsw i64 %polly.indvar422, 3
  %231 = udiv i64 %230, 25
...
polly.loop_exit427:                               ; preds = %polly.loop_exit433
  ...
  %244 = shl nsw i64 %polly.indvar422, 3
...
polly.loop_header442:                             ; preds = %polly.loop_exit500, %polly.loop_exit427
  ...
  %277 = mul nsw i64 %indvar1440, -50
  %278 = add i64 %225, %277
  %smax1459 = call i64 @llvm.smax.i64(i64 %278, i64 0)
  %279 = mul nuw nsw i64 %indvar1440, 50
  %280 = add i64 %227, %279
  %281 = add i64 %smax1459, %280
  %282 = mul nsw i64 %indvar1440, -50
  %283 = add i64 %233, %282
  %smax1442 = call i64 @llvm.smax.i64(i64 %283, i64 0)
  %284 = mul nuw nsw i64 %indvar1440, 50
  %285 = add i64 %232, %284
...
polly.loop_header498.preheader:                   ; preds = %polly.merge455, %polly.loop_header448.us1032, %polly.merge455.us
  ...
  %polly.loop_guard508 = icmp slt i64 %302, 50
...
polly.loop_header645:                             ; preds = %polly.loop_header645.preheader, %polly.loop_exit670
  ...
  %346 = shl nuw nsw i64 %polly.indvar648, 3
  %347 = udiv i64 %346, 25
  %348 = mul nuw nsw i64 %347, 50
  ...
  %354 = shl nuw nsw i64 %polly.indvar648, 3
  %355 = udiv i64 %354, 25
  %356 = mul nuw nsw i64 %355, 50
...
polly.loop_exit653:                               ; preds = %polly.loop_exit659
  ...
  %368 = shl nsw i64 %polly.indvar648, 3
...
polly.loop_header668:                             ; preds = %polly.loop_exit726, %polly.loop_exit653
  ...
  %401 = mul nsw i64 %indvar1377, -50
  %402 = add i64 %349, %401
  %smax1396 = call i64 @llvm.smax.i64(i64 %402, i64 0)
  %403 = mul nuw nsw i64 %indvar1377, 50
  %404 = add i64 %351, %403
  %405 = add i64 %smax1396, %404
  %406 = mul nsw i64 %indvar1377, -50
  %407 = add i64 %357, %406
  %smax1379 = call i64 @llvm.smax.i64(i64 %407, i64 0)
  %408 = mul nuw nsw i64 %indvar1377, 50
  %409 = add i64 %356, %408
  ...
  %418 = mul nuw nsw i64 %polly.indvar671, 50
  %419 = add nsw i64 %418, %367
  %420 = icmp sgt i64 %419, 16
  %421 = select i1 %420, i64 %419, i64 16
  %422 = add nsw i64 %419, 49
  %polly.loop_guard713 = icmp sgt i64 %419, -50
...
polly.loop_header724.preheader:                   ; preds = %polly.merge681, %polly.loop_header674.us1077, %polly.merge681.us
  ...
  %polly.loop_guard734 = icmp slt i64 %426, 50
