; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3251.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3251.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit250
  ...
  %exitcond1015.not = icmp eq i64 %polly.indvar_next209, 19
...
polly.loop_header255.us:                          ; preds = %polly.loop_header248.us, %polly.loop_exit264.us
  ...
  %smin1004 = call i64 @llvm.smin.i64(i64 %indvars.iv1002, i64 63)
...
polly.loop_header395:                             ; preds = %polly.loop_exit403, %polly.loop_header389
  ...
  %141 = mul nsw i64 %polly.indvar398, -64
  %142 = shl nsw i64 %polly.indvar398, 6
...
polly.loop_exit403:                               ; preds = %polly.loop_exit442
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar_next399, 19
...
polly.loop_header401:                             ; preds = %polly.loop_exit442, %polly.loop_header395
  ...
  %.inv875 = icmp ugt i64 %146, 63
  %148 = select i1 %.inv875, i64 63, i64 %147
...
polly.loop_header447.us:                          ; preds = %polly.loop_header440.us, %polly.loop_exit456.us
  ...
  %smin1030 = call i64 @llvm.smin.i64(i64 %indvars.iv1028, i64 63)
...
polly.loop_header587:                             ; preds = %polly.loop_exit595, %polly.loop_header581
  ...
  %182 = mul nsw i64 %polly.indvar590, -64
...
polly.loop_exit595:                               ; preds = %polly.loop_exit634
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next591, 19
...
polly.loop_header593:                             ; preds = %polly.loop_exit634, %polly.loop_header587
  ...
  %.inv876 = icmp ugt i64 %187, 63
  %189 = select i1 %.inv876, i64 63, i64 %188
