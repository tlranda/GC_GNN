; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5904.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5904.c"
...
vector.body1060:                                  ; preds = %vector.body1060, %vector.ph1064
  ...
  %wide.load1071 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %137, label %middle.block1058, label %vector.body1060, !llvm.loop !84
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1038
  ...
  %wide.load1045 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %179, label %middle.block1034, label %vector.body1036, !llvm.loop !94
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  br i1 %235, label %polly.loop_exit772, label %vector.body974, !llvm.loop !103
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph992
  ...
  br i1 %264, label %polly.loop_exit799, label %vector.body989, !llvm.loop !106
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1010
  ...
  br i1 %293, label %polly.loop_exit825, label %vector.body1007, !llvm.loop !109
