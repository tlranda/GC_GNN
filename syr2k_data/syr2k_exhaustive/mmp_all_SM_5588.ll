; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5588.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5588.c"
...
vector.body1068:                                  ; preds = %vector.body1068, %vector.ph1072
  ...
  %wide.load1079 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %131, label %middle.block1066, label %vector.body1068, !llvm.loop !84
...
vector.body1044:                                  ; preds = %vector.body1044, %vector.ph1046
  ...
  %wide.load1053 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !88, !noalias !90
  ...
  store <4 x double> %165, <4 x double>* %166, align 8, !alias.scope !88, !noalias !90
  %index.next1050 = add i64 %index1049, 4
  %167 = icmp eq i64 %index.next1050, %n.vec1048
  br i1 %167, label %middle.block1042, label %vector.body1044, !llvm.loop !94
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph984
  ...
  store <4 x double> %211, <4 x double>* %216, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %217, label %polly.loop_exit772, label %vector.body983, !llvm.loop !103
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph1000
  ...
  store <4 x double> %240, <4 x double>* %245, align 8, !alias.scope !102, !noalias !105
  ...
  br i1 %246, label %polly.loop_exit799, label %vector.body997, !llvm.loop !106
...
vector.body1015:                                  ; preds = %vector.body1015, %vector.ph1018
  ...
  store <4 x double> %269, <4 x double>* %274, align 8, !alias.scope !101, !noalias !108
  ...
  br i1 %275, label %polly.loop_exit825, label %vector.body1015, !llvm.loop !109
