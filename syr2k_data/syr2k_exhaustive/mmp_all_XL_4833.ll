; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4833.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4833.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit244
  ...
  %polly.loop_guard2271064 = icmp sgt i64 %109, -1
...
vector.body1178:                                  ; preds = %vector.body1178, %vector.ph1182
  ...
  %121 = shl nuw nsw i64 %index1185, 3
  %122 = getelementptr i8, i8* %scevgep375, i64 %121
  %123 = bitcast i8* %122 to <4 x double>*
  %wide.load1189 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !74, !noalias !76
  %124 = fmul fast <4 x double> %wide.load1189, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %126 = icmp eq i64 %index.next1186, %n.vec1184
  br i1 %126, label %middle.block1176, label %vector.body1178, !llvm.loop !80

middle.block1176:                                 ; preds = %vector.body1178
  %cmp.n1188 = icmp eq i64 %119, %n.vec1184
...
polly.loop_exit387:                               ; preds = %polly.loop_exit394
  ...
  %exitcond1003.not = icmp eq i64 %polly.indvar_next383, 19
...
polly.loop_header392:                             ; preds = %polly.loop_header392.preheader, %polly.loop_exit430
  ...
  %polly.loop_guard4091065 = icmp sgt i64 %140, -1
...
polly.loop_header549:                             ; preds = %polly.loop_exit557, %polly.start463
  ...
  %min.iters.check1155 = icmp ult i64 %150, 4
...
vector.body1154:                                  ; preds = %vector.body1154, %vector.ph1156
  ...
  %152 = shl nuw nsw i64 %index1159, 3
  %153 = getelementptr i8, i8* %scevgep561, i64 %152
  %154 = bitcast i8* %153 to <4 x double>*
  %wide.load1163 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !84, !noalias !86
  %155 = fmul fast <4 x double> %wide.load1163, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %157 = icmp eq i64 %index.next1160, %n.vec1158
  br i1 %157, label %middle.block1152, label %vector.body1154, !llvm.loop !90

middle.block1152:                                 ; preds = %vector.body1154
  %cmp.n1162 = icmp eq i64 %150, %n.vec1158
...
polly.loop_exit573:                               ; preds = %polly.loop_exit580
  ...
  %indvars.iv.next1008 = add nsw i64 %indvars.iv1007, -64
  %indvars.iv.next1013 = add nuw nsw i64 %indvars.iv1012, 64
  %indvars.iv.next1025 = add nuw nsw i64 %indvars.iv1024, 2
  %exitcond1027.not = icmp eq i64 %polly.indvar_next569, 19
...
polly.loop_header578.preheader:                   ; preds = %polly.loop_header571
  ...
  %168 = add i64 %smax1011, %indvars.iv1014
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit616
  %indvars.iv1016 = phi i64 [ %168, %polly.loop_header578.preheader ], [ %indvars.iv.next1017, %polly.loop_exit616 ]
  ...
  %polly.loop_guard5951066 = icmp sgt i64 %171, -1
...
vector.ph1094:                                    ; preds = %polly.loop_header785
  %broadcast.splatinsert1101 = insertelement <4 x i64> poison, i64 %185, i32 0
  %broadcast.splat1102 = shufflevector <4 x i64> %broadcast.splatinsert1101, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1103 = insertelement <4 x i32> poison, i32 %188, i32 0
...
vector.body1093:                                  ; preds = %vector.body1093, %vector.ph1094
  ...
  %190 = add nuw nsw <4 x i64> %vec.ind1099, %broadcast.splat1102
  %191 = trunc <4 x i64> %190 to <4 x i32>
  %192 = mul <4 x i32> %broadcast.splat1104, %191
  ...
  %202 = icmp eq i64 %index.next1096, %184
  br i1 %202, label %polly.loop_exit793, label %vector.body1093, !llvm.loop !99

polly.loop_exit793:                               ; preds = %vector.body1093, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond1057.not = icmp eq i64 %polly.indvar788, %182
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %exitcond1053.not = icmp eq i64 %polly.indvar794, %186
...
polly.loop_header806:                             ; preds = %polly.loop_exit814, %polly.loop_header800
  ...
  %smin1108 = call i64 @llvm.smin.i64(i64 %212, i64 -968)
  %213 = add nsw i64 %smin1108, 1000
  %smin1042 = call i64 @llvm.smin.i64(i64 %indvars.iv1040, i64 -968)
  %214 = shl nsw i64 %polly.indvar809, 5
  %215 = add nsw i64 %smin1042, 999
...
vector.body1107:                                  ; preds = %vector.body1107, %vector.ph1110
  ...
  %219 = add nuw nsw <4 x i64> %vec.ind1117, %broadcast.splat1120
  %220 = trunc <4 x i64> %219 to <4 x i32>
  %221 = mul <4 x i32> %broadcast.splat1122, %220
  ...
  %231 = icmp eq i64 %index.next1114, %213
  br i1 %231, label %polly.loop_exit820, label %vector.body1107, !llvm.loop !102

polly.loop_exit820:                               ; preds = %vector.body1107, %polly.loop_header818
  %polly.indvar_next816 = add nuw nsw i64 %polly.indvar815, 1
  %exitcond1047.not = icmp eq i64 %polly.indvar815, %211
...
polly.loop_header818:                             ; preds = %polly.loop_header812, %polly.loop_header818
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar821, %215
...
polly.loop_header832:                             ; preds = %polly.loop_exit840, %polly.loop_header826
  ...
  %smin1126 = call i64 @llvm.smin.i64(i64 %241, i64 -968)
  %242 = add nsw i64 %smin1126, 1000
  %smin1032 = call i64 @llvm.smin.i64(i64 %indvars.iv1030, i64 -968)
  %243 = shl nsw i64 %polly.indvar835, 5
  %244 = add nsw i64 %smin1032, 999
...
vector.body1125:                                  ; preds = %vector.body1125, %vector.ph1128
  ...
  %248 = add nuw nsw <4 x i64> %vec.ind1135, %broadcast.splat1138
  %249 = trunc <4 x i64> %248 to <4 x i32>
  %250 = mul <4 x i32> %broadcast.splat1140, %249
  ...
  %260 = icmp eq i64 %index.next1132, %242
  br i1 %260, label %polly.loop_exit846, label %vector.body1125, !llvm.loop !105

polly.loop_exit846:                               ; preds = %vector.body1125, %polly.loop_header844
  %polly.indvar_next842 = add nuw nsw i64 %polly.indvar841, 1
  %exitcond1037.not = icmp eq i64 %polly.indvar841, %240
...
polly.loop_header844:                             ; preds = %polly.loop_header838, %polly.loop_header844
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar847, %244
