; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3035.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3035.c"
...
polly.loop_header263.preheader.us:                ; preds = %polly.loop_header255.us
  %139 = add nsw i64 %polly.indvar259.us, %121
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %167 = udiv i64 %indvars.iv1031, 5
  %168 = mul nuw nsw i64 %167, 20
  %169 = add i64 %indvars.iv1029, %168
  %170 = sub nsw i64 %indvars.iv1036, %168
  %171 = mul nuw nsw i64 %polly.indvar400, 13
  %172 = trunc i64 %polly.indvar400 to i8
  %pexp.p_div_q403.lhs.trunc = add i8 %172, 4
  %pexp.p_div_q403886 = udiv i8 %pexp.p_div_q403.lhs.trunc, 5
  %pexp.p_div_q403.zext = zext i8 %pexp.p_div_q403886 to i64
  %173 = sub nsw i64 %171, %pexp.p_div_q403.zext
  %174 = mul nsw i64 %polly.indvar400, -256
  %175 = shl nsw i64 %polly.indvar400, 8
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039, %polly.loop_exit445 ], [ %170, %polly.loop_header397 ]
  %indvars.iv1033 = phi i64 [ %indvars.iv.next1034, %polly.loop_exit445 ], [ %169, %polly.loop_header397 ]
  ...
  %177 = mul nsw i64 %polly.indvar407, 20
  %178 = add nsw i64 %177, %174
  %179 = add nsw i64 %178, -1
  %.inv883 = icmp sgt i64 %178, 255
  %180 = select i1 %.inv883, i64 255, i64 %179
...
polly.loop_header458.preheader.us:                ; preds = %polly.loop_header450.us
  %195 = add nsw i64 %polly.indvar454.us, %177
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %223 = udiv i64 %indvars.iv1054, 5
  %224 = mul nuw nsw i64 %223, 20
  %225 = add i64 %indvars.iv1052, %224
  %226 = sub nsw i64 %indvars.iv1059, %224
  %227 = mul nuw nsw i64 %polly.indvar595, 13
  %228 = trunc i64 %polly.indvar595 to i8
  %pexp.p_div_q598.lhs.trunc = add i8 %228, 4
  %pexp.p_div_q598885 = udiv i8 %pexp.p_div_q598.lhs.trunc, 5
  %pexp.p_div_q598.zext = zext i8 %pexp.p_div_q598885 to i64
  %229 = sub nsw i64 %227, %pexp.p_div_q598.zext
  %230 = mul nsw i64 %polly.indvar595, -256
  %231 = shl nsw i64 %polly.indvar595, 8
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  %indvars.iv1061 = phi i64 [ %indvars.iv.next1062, %polly.loop_exit640 ], [ %226, %polly.loop_header592 ]
  %indvars.iv1056 = phi i64 [ %indvars.iv.next1057, %polly.loop_exit640 ], [ %225, %polly.loop_header592 ]
  ...
  %233 = mul nsw i64 %polly.indvar602, 20
  %234 = add nsw i64 %233, %230
  %235 = add nsw i64 %234, -1
  %.inv884 = icmp sgt i64 %234, 255
  %236 = select i1 %.inv884, i64 255, i64 %235
...
polly.loop_header653.preheader.us:                ; preds = %polly.loop_header645.us
  %251 = add nsw i64 %polly.indvar649.us, %233
...
polly.loop_header263.preheader.us.1:              ; preds = %polly.loop_header255.us.1
  %353 = add nsw i64 %polly.indvar259.us.1, %121
...
polly.loop_header263.preheader.us.2:              ; preds = %polly.loop_header255.us.2
  %363 = add nsw i64 %polly.indvar259.us.2, %121
...
polly.loop_header263.preheader.us.3:              ; preds = %polly.loop_header255.us.3
  %373 = add nsw i64 %polly.indvar259.us.3, %121
...
polly.loop_header458.preheader.us.1:              ; preds = %polly.loop_header450.us.1
  %392 = add nsw i64 %polly.indvar454.us.1, %177
...
polly.loop_header458.preheader.us.2:              ; preds = %polly.loop_header450.us.2
  %402 = add nsw i64 %polly.indvar454.us.2, %177
...
polly.loop_header458.preheader.us.3:              ; preds = %polly.loop_header450.us.3
  %412 = add nsw i64 %polly.indvar454.us.3, %177
...
polly.loop_header653.preheader.us.1:              ; preds = %polly.loop_header645.us.1
  %431 = add nsw i64 %polly.indvar649.us.1, %233
...
polly.loop_header653.preheader.us.2:              ; preds = %polly.loop_header645.us.2
  %441 = add nsw i64 %polly.indvar649.us.2, %233
...
polly.loop_header653.preheader.us.3:              ; preds = %polly.loop_header645.us.3
  %451 = add nsw i64 %polly.indvar649.us.3, %233
