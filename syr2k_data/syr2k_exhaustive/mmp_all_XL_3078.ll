; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3078.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3078.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond1031.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !75

polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv = phi i64 [ 0, %polly.loop_header199.preheader ], [ %indvars.iv.next, %polly.loop_exit207 ]
  %polly.indvar202 = phi i64 [ 0, %polly.loop_header199.preheader ], [ %polly.indvar_next203, %polly.loop_exit207 ]
  %smin1027 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -968)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1030.not = icmp eq i64 %polly.indvar_next203, 32
...
polly.start289:                                   ; preds = %kernel_syr2k.exit
  %malloccall291 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_header381
  ...
  br i1 %exitcond1061.not, label %polly.loop_exit383, label %polly.loop_header381, !llvm.loop !86
...
polly.loop_header391:                             ; preds = %polly.loop_header391.preheader, %polly.loop_exit399
  ...
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1033, i64 -968)
  %145 = add nsw i64 %smin1057, 1000
  %146 = shl nsw i64 %polly.indvar394, 5
...
polly.loop_exit399:                               ; preds = %polly.loop_exit406
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next395, 32
...
polly.loop_header576:                             ; preds = %polly.loop_header576.preheader, %polly.loop_header576
  ...
  br i1 %exitcond1091.not, label %polly.loop_exit578, label %polly.loop_header576, !llvm.loop !96
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %smin1087 = call i64 @llvm.smin.i64(i64 %indvars.iv1063, i64 -968)
  %193 = add nsw i64 %smin1087, 1000
  %194 = shl nsw i64 %polly.indvar589, 5
...
polly.loop_exit594:                               ; preds = %polly.loop_exit601
  ...
  %exitcond1090.not = icmp eq i64 %polly.indvar_next590, 32
...
vector.body1156:                                  ; preds = %vector.body1156, %vector.ph1157
  ...
  br i1 %253, label %polly.loop_exit823, label %vector.body1156, !llvm.loop !104
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  br i1 %exitcond1116.not, label %polly.loop_exit823, label %polly.loop_header821, !llvm.loop !105
...
vector.body1170:                                  ; preds = %vector.body1170, %vector.ph1173
  ...
  br i1 %282, label %polly.loop_exit850, label %vector.body1170, !llvm.loop !107
...
polly.loop_header848:                             ; preds = %polly.loop_header842, %polly.loop_header848
  ...
  br i1 %exitcond1106.not, label %polly.loop_exit850, label %polly.loop_header848, !llvm.loop !108
...
vector.body1188:                                  ; preds = %vector.body1188, %vector.ph1191
  ...
  br i1 %311, label %polly.loop_exit876, label %vector.body1188, !llvm.loop !110
...
polly.loop_header874:                             ; preds = %polly.loop_header868, %polly.loop_header874
  ...
  br i1 %exitcond1096.not, label %polly.loop_exit876, label %polly.loop_header874, !llvm.loop !111
}
