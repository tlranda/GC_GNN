; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7894.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7894.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %smin839 = call i64 @llvm.smin.i64(i64 %indvars.iv837, i64 -1072)
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %124 = shl nsw i64 %polly.indvar391, 7
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next392, 10
...
polly.loop_exit402:                               ; preds = %polly.loop_exit408
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar_next398, 63
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_header394
  ...
  %128 = shl nsw i64 %polly.indvar403, 7
...
polly.loop_header563:                             ; preds = %polly.loop_exit555, %polly.loop_exit571
  ...
  %smin889 = call i64 @llvm.smin.i64(i64 %indvars.iv887, i64 -1072)
  %151 = shl nsw i64 %polly.indvar566, 7
...
polly.loop_exit571:                               ; preds = %polly.loop_exit577
  ...
  %indvars.iv.next876 = add nuw nsw i64 %indvars.iv875, 128
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, -128
  %indvars.iv.next892 = add nuw nsw i64 %indvars.iv891, 1
  %exitcond895.not = icmp eq i64 %polly.indvar_next567, 10
...
polly.loop_header569:                             ; preds = %polly.loop_exit577, %polly.loop_header563
  ...
  %smin885 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 -984)
  %153 = shl nsw i64 %polly.indvar572, 4
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %exitcond894.not = icmp eq i64 %polly.indvar_next573, 63
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %155 = shl nsw i64 %polly.indvar578, 7
