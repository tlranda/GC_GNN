; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4975.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4975.c"
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %157 = udiv i64 %indvars.iv1020, 5
  %158 = sub nsw i64 %indvars.iv1018, %157
  %smin1022 = call i64 @llvm.smin.i64(i64 %158, i64 54)
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %217 = udiv i64 %indvars.iv1048, 5
  %218 = sub nsw i64 %indvars.iv1046, %217
  %smin1050 = call i64 @llvm.smin.i64(i64 %218, i64 54)
