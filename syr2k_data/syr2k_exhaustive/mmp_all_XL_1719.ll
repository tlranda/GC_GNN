; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1719.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1719.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %101 = mul nsw i64 %polly.indvar231, -20
  %102 = add i64 %97, %101
  %103 = mul nuw nsw i64 %polly.indvar231, 20
  %104 = sub nsw i64 %98, %103
  %105 = add nuw nsw i64 %103, 20
...
polly.loop_header234:                             ; preds = %polly.loop_exit265, %polly.loop_header228
  ...
  %smin1341 = call i64 @llvm.smin.i64(i64 %106, i64 19)
  %107 = add nsw i64 %smin1341, 1
  %smin1044 = call i64 @llvm.smin.i64(i64 %indvars.iv1038, i64 19)
...
polly.loop_exit265:                               ; preds = %polly.loop_exit272.loopexit.us, %polly.loop_header234.split, %polly.loop_header263.preheader
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar_next238, 20
...
polly.loop_exit426:                               ; preds = %polly.loop_exit432
  ...
  %exitcond1081.not = icmp eq i64 %polly.indvar_next422, 60
...
polly.loop_header430:                             ; preds = %polly.loop_exit438, %polly.loop_header424
  ...
  %149 = mul nsw i64 %polly.indvar433, -20
  %150 = add i64 %145, %149
  %151 = mul nuw nsw i64 %polly.indvar433, 20
  %152 = sub nsw i64 %146, %151
  %153 = add nuw nsw i64 %151, 20
...
polly.loop_header436:                             ; preds = %polly.loop_exit473, %polly.loop_header430
  ...
  %smin1296 = call i64 @llvm.smin.i64(i64 %154, i64 19)
...
polly.loop_exit473:                               ; preds = %polly.loop_exit480.loopexit.us, %polly.loop_header436.split, %polly.loop_header471.preheader
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar_next440, 20
...
polly.loop_header626:                             ; preds = %polly.loop_exit618, %polly.loop_exit634
  ...
  %193 = mul nuw nsw i64 %polly.indvar629, 20
  %194 = mul nuw nsw i64 %polly.indvar629, 20
...
polly.loop_exit634:                               ; preds = %polly.loop_exit640
  ...
  %exitcond1109.not = icmp eq i64 %polly.indvar_next630, 60
...
polly.loop_header638:                             ; preds = %polly.loop_exit646, %polly.loop_header632
  ...
  %197 = mul nsw i64 %polly.indvar641, -20
  %198 = add i64 %193, %197
  %199 = mul nuw nsw i64 %polly.indvar641, 20
  %200 = sub nsw i64 %194, %199
  %201 = add nuw nsw i64 %199, 20
...
polly.loop_header644:                             ; preds = %polly.loop_exit681, %polly.loop_header638
  ...
  %smin1251 = call i64 @llvm.smin.i64(i64 %202, i64 19)
  %203 = add nsw i64 %smin1251, 1
  %smin1100 = call i64 @llvm.smin.i64(i64 %indvars.iv1094, i64 19)
...
polly.loop_exit681:                               ; preds = %polly.loop_exit688.loopexit.us, %polly.loop_header644.split, %polly.loop_header679.preheader
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar_next648, 20
