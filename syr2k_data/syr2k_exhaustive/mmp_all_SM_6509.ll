; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6509.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6509.c"
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  ...
  %102 = mul nuw nsw i64 %polly.indvar230, 100
...
polly.loop_header239:                             ; preds = %polly.loop_exit247, %polly.loop_header233
  ...
  %105 = add nuw nsw i64 %polly.indvar242, %102
  %106 = add nsw i64 %105, %100
  %polly.access.add.Packed_MemRef_call2255 = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2254, %106
  ...
  %scevgep262 = getelementptr i8, i8* %call1, i64 %108
...
polly.loop_header245:                             ; preds = %polly.loop_header245, %polly.loop_header239
  ...
  %110 = add nuw nsw i64 %polly.indvar248, %98
  %111 = mul nuw nsw i64 %110, 8000
  %112 = add nuw nsw i64 %111, %104
  %scevgep251 = getelementptr i8, i8* %call1, i64 %112
  ...
  %scevgep265 = getelementptr i8, i8* %call, i64 %114
...
vector.body1022:                                  ; preds = %vector.body1022, %vector.ph1026
  ...
  %117 = shl nuw nsw i64 %index1029, 3
  %118 = getelementptr i8, i8* %scevgep368, i64 %117
  %119 = bitcast i8* %118 to <4 x double>*
  %wide.load1033 = load <4 x double>, <4 x double>* %119, align 8, !alias.scope !77, !noalias !79
  %120 = fmul fast <4 x double> %wide.load1033, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %121 = bitcast i8* %118 to <4 x double>*
  store <4 x double> %120, <4 x double>* %121, align 8, !alias.scope !77, !noalias !79
  %index.next1030 = add i64 %index1029, 4
  %122 = icmp eq i64 %index.next1030, %n.vec1028
  br i1 %122, label %middle.block1020, label %vector.body1022, !llvm.loop !83

middle.block1020:                                 ; preds = %vector.body1022
  %cmp.n1032 = icmp eq i64 %115, %n.vec1028
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %124 = mul nuw nsw i64 %polly.indvar375, 100
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %125 = mul nuw nsw i64 %polly.indvar381, 100
...
polly.loop_header384:                             ; preds = %polly.loop_exit392, %polly.loop_header378
  ...
  %126 = add nuw nsw i64 %polly.indvar387, %124
...
polly.loop_header390:                             ; preds = %polly.loop_header390, %polly.loop_header384
  ...
  %128 = add nuw nsw i64 %polly.indvar393, %125
  %polly.access.mul.call2397 = mul nuw nsw i64 %128, 1000
  %polly.access.add.call2398 = add nuw nsw i64 %126, %polly.access.mul.call2397
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit408
  ...
  %129 = mul nuw nsw i64 %polly.indvar403, 100
...
polly.loop_header406:                             ; preds = %polly.loop_exit414, %polly.loop_header400
  ...
  %130 = add nuw nsw i64 %polly.indvar409, %124
  %131 = shl i64 %130, 3
...
polly.loop_header412:                             ; preds = %polly.loop_exit420, %polly.loop_header406
  ...
  %132 = add nuw nsw i64 %polly.indvar415, %129
  %133 = add nsw i64 %132, %127
  %polly.access.add.Packed_MemRef_call2273428 = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2273427, %133
  ...
  %scevgep435 = getelementptr i8, i8* %call1, i64 %135
...
polly.loop_header418:                             ; preds = %polly.loop_header418, %polly.loop_header412
  ...
  %137 = add nuw nsw i64 %polly.indvar421, %125
  %138 = mul nuw nsw i64 %137, 8000
  %139 = add nuw nsw i64 %138, %131
  %scevgep424 = getelementptr i8, i8* %call1, i64 %139
  ...
  %scevgep438 = getelementptr i8, i8* %call, i64 %141
...
polly.loop_header529:                             ; preds = %polly.loop_exit537, %polly.start443
  ...
  %143 = mul nuw nsw i64 %polly.indvar532, 9600
  %scevgep541 = getelementptr i8, i8* %call, i64 %143
  %min.iters.check999 = icmp ult i64 %142, 4
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1000
  ...
  %144 = shl nuw nsw i64 %index1003, 3
  %145 = getelementptr i8, i8* %scevgep541, i64 %144
  %146 = bitcast i8* %145 to <4 x double>*
  %wide.load1007 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !87, !noalias !89
  %147 = fmul fast <4 x double> %wide.load1007, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %149 = icmp eq i64 %index.next1004, %n.vec1002
  br i1 %149, label %middle.block996, label %vector.body998, !llvm.loop !93

middle.block996:                                  ; preds = %vector.body998
  %cmp.n1006 = icmp eq i64 %142, %n.vec1002
...
polly.loop_header535:                             ; preds = %polly.loop_header535.preheader, %polly.loop_header535
  ...
  %150 = shl nuw nsw i64 %polly.indvar538, 3
  %scevgep542 = getelementptr i8, i8* %scevgep541, i64 %150
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %151 = mul nuw nsw i64 %polly.indvar548, 100
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %152 = mul nuw nsw i64 %polly.indvar554, 100
...
polly.loop_header557:                             ; preds = %polly.loop_exit565, %polly.loop_header551
  ...
  %153 = add nuw nsw i64 %polly.indvar560, %151
...
polly.loop_header573.preheader:                   ; preds = %polly.loop_exit565
  %154 = mul nsw i64 %polly.indvar554, -100
...
polly.loop_header563:                             ; preds = %polly.loop_header563, %polly.loop_header557
  ...
  %155 = add nuw nsw i64 %polly.indvar566, %152
  %polly.access.mul.call2570 = mul nuw nsw i64 %155, 1000
  %polly.access.add.call2571 = add nuw nsw i64 %153, %polly.access.mul.call2570
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %156 = mul nuw nsw i64 %polly.indvar576, 100
...
polly.loop_header579:                             ; preds = %polly.loop_exit587, %polly.loop_header573
  ...
  %157 = add nuw nsw i64 %polly.indvar582, %151
  %158 = shl i64 %157, 3
...
polly.loop_header585:                             ; preds = %polly.loop_exit593, %polly.loop_header579
  ...
  %159 = add nuw nsw i64 %polly.indvar588, %156
  %160 = add nsw i64 %159, %154
  %polly.access.add.Packed_MemRef_call2446601 = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2446600, %160
  ...
  %scevgep608 = getelementptr i8, i8* %call1, i64 %162
...
polly.loop_header591:                             ; preds = %polly.loop_header591, %polly.loop_header585
  ...
  %164 = add nuw nsw i64 %polly.indvar594, %152
  %165 = mul nuw nsw i64 %164, 8000
  %166 = add nuw nsw i64 %165, %158
  %scevgep597 = getelementptr i8, i8* %call1, i64 %166
  ...
  %scevgep611 = getelementptr i8, i8* %call, i64 %168
...
polly.loop_header746:                             ; preds = %polly.loop_exit754, %polly.loop_header740
  ...
  %smin937 = call i64 @llvm.smin.i64(i64 %171, i64 -1168)
  %172 = add nsw i64 %smin937, 1200
...
vector.ph938:                                     ; preds = %polly.loop_header752
  %broadcast.splatinsert945 = insertelement <4 x i64> poison, i64 %173, i32 0
  %broadcast.splat946 = shufflevector <4 x i64> %broadcast.splatinsert945, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert947 = insertelement <4 x i32> poison, i32 %176, i32 0
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  %178 = add nuw nsw <4 x i64> %vec.ind943, %broadcast.splat946
  %179 = trunc <4 x i64> %178 to <4 x i32>
  %180 = mul <4 x i32> %broadcast.splat948, %179
  ...
  store <4 x double> %184, <4 x double>* %189, align 8, !alias.scope !97, !noalias !99
  %index.next940 = add i64 %index939, 4
  %vec.ind.next944 = add <4 x i64> %vec.ind943, <i64 4, i64 4, i64 4, i64 4>
  %190 = icmp eq i64 %index.next940, %172
  br i1 %190, label %polly.loop_exit760, label %vector.body936, !llvm.loop !102

polly.loop_exit760:                               ; preds = %vector.body936, %polly.loop_header758
  %polly.indvar_next756 = add nuw nsw i64 %polly.indvar755, 1
  %exitcond912.not = icmp eq i64 %polly.indvar755, %170
...
polly.loop_header758:                             ; preds = %polly.loop_header752, %polly.loop_header758
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar761, %174
...
polly.loop_header773:                             ; preds = %polly.loop_exit781, %polly.loop_header767
  ...
  %smin952 = call i64 @llvm.smin.i64(i64 %200, i64 -968)
  %201 = add nsw i64 %smin952, 1000
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  %207 = add nuw nsw <4 x i64> %vec.ind961, %broadcast.splat964
  %208 = trunc <4 x i64> %207 to <4 x i32>
  %209 = mul <4 x i32> %broadcast.splat966, %208
  ...
  store <4 x double> %213, <4 x double>* %218, align 8, !alias.scope !101, !noalias !104
  %index.next958 = add i64 %index957, 4
  %vec.ind.next962 = add <4 x i64> %vec.ind961, <i64 4, i64 4, i64 4, i64 4>
  %219 = icmp eq i64 %index.next958, %201
  br i1 %219, label %polly.loop_exit787, label %vector.body951, !llvm.loop !105

polly.loop_exit787:                               ; preds = %vector.body951, %polly.loop_header785
  %polly.indvar_next783 = add nuw nsw i64 %polly.indvar782, 1
  %exitcond902.not = icmp eq i64 %polly.indvar782, %199
...
polly.loop_header785:                             ; preds = %polly.loop_header779, %polly.loop_header785
  ...
  %exitcond898.not = icmp eq i64 %polly.indvar788, %203
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  %smin970 = call i64 @llvm.smin.i64(i64 %229, i64 -968)
  %230 = add nsw i64 %smin970, 1000
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph972
  ...
  %236 = add nuw nsw <4 x i64> %vec.ind979, %broadcast.splat982
  %237 = trunc <4 x i64> %236 to <4 x i32>
  %238 = mul <4 x i32> %broadcast.splat984, %237
  ...
  store <4 x double> %242, <4 x double>* %247, align 8, !alias.scope !100, !noalias !107
  %index.next976 = add i64 %index975, 4
  %vec.ind.next980 = add <4 x i64> %vec.ind979, <i64 4, i64 4, i64 4, i64 4>
  %248 = icmp eq i64 %index.next976, %230
  br i1 %248, label %polly.loop_exit813, label %vector.body969, !llvm.loop !108

polly.loop_exit813:                               ; preds = %vector.body969, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond892.not = icmp eq i64 %polly.indvar808, %228
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar814, %232
