; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8249.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8249.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %112 = shl nuw nsw i64 %polly.indvar208, 4
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %148 = shl nuw nsw i64 %polly.indvar361, 4
  %149 = shl nsw i64 %polly.indvar361, 8
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %184 = shl nuw nsw i64 %polly.indvar514, 4
  %185 = shl nsw i64 %polly.indvar514, 8
...
polly.loop_header223.5:                           ; preds = %polly.loop_exit231.4, %polly.loop_exit231.5
  ...
  %smin.5 = call i64 @llvm.smin.i64(i64 %indvars.iv770.5, i64 255)
...
polly.loop_header223.6:                           ; preds = %polly.loop_exit231.5, %polly.loop_exit231.6
  ...
  %smin.6 = call i64 @llvm.smin.i64(i64 %indvars.iv770.6, i64 255)
...
polly.loop_header223.7:                           ; preds = %polly.loop_exit231.6, %polly.loop_exit231.7
  ...
  %smin.7 = call i64 @llvm.smin.i64(i64 %indvars.iv770.7, i64 255)
...
polly.loop_header376.5:                           ; preds = %polly.loop_exit384.4, %polly.loop_exit384.5
  ...
  %smin783.5 = call i64 @llvm.smin.i64(i64 %indvars.iv781.5, i64 255)
...
polly.loop_header376.6:                           ; preds = %polly.loop_exit384.5, %polly.loop_exit384.6
  ...
  %smin783.6 = call i64 @llvm.smin.i64(i64 %indvars.iv781.6, i64 255)
...
polly.loop_header376.7:                           ; preds = %polly.loop_exit384.6, %polly.loop_exit384.7
  ...
  %smin783.7 = call i64 @llvm.smin.i64(i64 %indvars.iv781.7, i64 255)
...
polly.loop_header529.5:                           ; preds = %polly.loop_exit537.4, %polly.loop_exit537.5
  ...
  %smin796.5 = call i64 @llvm.smin.i64(i64 %indvars.iv794.5, i64 255)
...
polly.loop_header529.6:                           ; preds = %polly.loop_exit537.5, %polly.loop_exit537.6
  ...
  %smin796.6 = call i64 @llvm.smin.i64(i64 %indvars.iv794.6, i64 255)
...
polly.loop_header529.7:                           ; preds = %polly.loop_exit537.6, %polly.loop_exit537.7
  ...
  %smin796.7 = call i64 @llvm.smin.i64(i64 %indvars.iv794.7, i64 255)
