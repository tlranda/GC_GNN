; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2046.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2046.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %103 = shl nuw nsw i64 %polly.indvar225, 2
  %104 = add i64 %97, %103
  %smax1324 = call i64 @llvm.smax.i64(i64 %104, i64 0)
  %105 = mul nsw i64 %polly.indvar225, -4
  %106 = add i64 %98, %105
...
polly.loop_header228.preheader:                   ; preds = %polly.loop_header222
  ...
  %114 = add nuw nsw i64 %108, 4
  br label %polly.loop_header228

polly.loop_exit230:                               ; preds = %polly.loop_exit261, %polly.loop_header222
  %polly.indvar_next226 = add nuw nsw i64 %polly.indvar225, 1
  %indvars.iv.next1019 = add nsw i64 %indvars.iv1018, 4
  %indvars.iv.next1023 = add nsw i64 %indvars.iv1022, -4
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %115, i64 3)
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %157 = shl nuw nsw i64 %polly.indvar424, 2
  %158 = add i64 %151, %157
  %smax1276 = call i64 @llvm.smax.i64(i64 %158, i64 0)
  %159 = mul nsw i64 %polly.indvar424, -4
  %160 = add i64 %152, %159
  %161 = add i64 %smax1276, %160
  %162 = shl nsw i64 %polly.indvar424, 2
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %169, i64 3)
  %170 = add nsw i64 %smin1279, 1
  %smin1054 = call i64 @llvm.smin.i64(i64 %indvars.iv1049, i64 3)
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %211 = shl nuw nsw i64 %polly.indvar629, 2
  %212 = add i64 %205, %211
  %smax1228 = call i64 @llvm.smax.i64(i64 %212, i64 0)
  %213 = mul nsw i64 %polly.indvar629, -4
  %214 = add i64 %206, %213
  %215 = add i64 %smax1228, %214
  %216 = shl nsw i64 %polly.indvar629, 2
...
polly.loop_exit635:                               ; preds = %polly.loop_exit671, %polly.loop_header626
  ...
  %indvars.iv.next1069 = add nsw i64 %indvars.iv1068, 4
  %indvars.iv.next1074 = add nsw i64 %indvars.iv1073, -4
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %223, i64 3)
  %224 = add nsw i64 %smin1231, 1
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 3)
