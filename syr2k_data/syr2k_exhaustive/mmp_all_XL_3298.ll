; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3298.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3298.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -984)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next203, 63
...
polly.start291:                                   ; preds = %kernel_syr2k.exit
  %malloccall293 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  ...
  %smin1059 = call i64 @llvm.smin.i64(i64 %indvars.iv1037, i64 -984)
  %146 = add nsw i64 %smin1059, 1000
  %147 = shl nsw i64 %polly.indvar396, 4
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar_next397, 63
...
polly.start488:                                   ; preds = %init_array.exit
  %malloccall490 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  ...
  %smin1087 = call i64 @llvm.smin.i64(i64 %indvars.iv1065, i64 -984)
  %195 = add nsw i64 %smin1087, 1000
  %196 = shl nsw i64 %polly.indvar593, 4
...
polly.loop_exit598:                               ; preds = %polly.loop_exit606
  ...
  %indvars.iv.next1066 = add nsw i64 %indvars.iv1065, -16
  %exitcond1090.not = icmp eq i64 %polly.indvar_next594, 63
