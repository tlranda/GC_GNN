; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6891.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6891.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar_next219, 150
...
polly.loop_exit235:                               ; preds = %polly.loop_exit242.loopexit.us, %polly.loop_header227
  ...
  %polly.loop_cond232 = icmp ult i64 %polly.indvar230, 7
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  ...
  %125 = mul nsw i64 %polly.indvar389, -8
  %126 = shl nsw i64 %polly.indvar389, 3
...
polly.loop_exit395:                               ; preds = %polly.loop_exit402
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next390, 150
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %polly.loop_guard403 = icmp slt i64 %130, 8
...
polly.loop_exit409:                               ; preds = %polly.loop_exit416.loopexit.us, %polly.loop_header400
  ...
  %polly.loop_cond406 = icmp ult i64 %polly.indvar404, 7
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  ...
  %152 = mul nsw i64 %polly.indvar563, -8
  %153 = shl nsw i64 %polly.indvar563, 3
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next564, 150
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %polly.loop_guard577 = icmp slt i64 %157, 8
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590.loopexit.us, %polly.loop_header574
  ...
  %polly.loop_cond580 = icmp ult i64 %polly.indvar578, 7
