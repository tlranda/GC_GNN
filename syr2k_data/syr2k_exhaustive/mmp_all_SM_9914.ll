; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9914.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9914.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit364
  ...
  %.inv774 = icmp slt i64 %133, 59
  %135 = select i1 %.inv774, i64 %134, i64 59
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_exit372
  ...
  %141 = mul nsw i64 %polly.indvar366, 20
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit522
  ...
  %.inv775 = icmp slt i64 %167, 59
  %169 = select i1 %.inv775, i64 %168, i64 59
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit530
  ...
  %175 = mul nsw i64 %polly.indvar524, 20
...
polly.loop_exit530:                               ; preds = %polly.loop_exit537, %polly.loop_header520
  ...
  %indvars.iv.next824 = add i64 %indvars.iv823, 20
  %indvars.iv.next829 = add i64 %indvars.iv828, -20
...
polly.loop_header528:                             ; preds = %polly.loop_header528.preheader, %polly.loop_exit537
  ...
  %smin832 = call i64 @llvm.smin.i64(i64 %indvars.iv830, i64 19)
