; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6553.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6553.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %indvars.iv862 = phi i64 [ %indvars.iv.next863, %polly.loop_exit229 ], [ 31, %polly.loop_header199 ]
...
polly.loop_header382:                             ; preds = %polly.loop_exit408, %polly.loop_header376
  ...
  %indvars.iv884 = phi i64 [ %indvars.iv.next885, %polly.loop_exit408 ], [ 31, %polly.loop_header376 ]
...
polly.loop_header562:                             ; preds = %polly.loop_exit588, %polly.loop_header556
  ...
  %indvars.iv908 = phi i64 [ %indvars.iv.next909, %polly.loop_exit588 ], [ 31, %polly.loop_header556 ]
...
polly.loop_exit219.7:                             ; preds = %polly.loop_header217.7
  %314 = mul nsw i64 %polly.indvar208, -100
  %315 = mul nuw nsw i64 %polly.indvar208, 7
  %316 = add nuw nsw i64 %315, 31
  %pexp.p_div_q = lshr i64 %316, 5
...
polly.loop_exit396.7:                             ; preds = %polly.loop_header394.7
  %325 = mul nsw i64 %polly.indvar385, -100
  %326 = mul nuw nsw i64 %polly.indvar385, 7
  %327 = add nuw nsw i64 %326, 31
  %pexp.p_div_q404 = lshr i64 %327, 5
...
polly.loop_exit576.7:                             ; preds = %polly.loop_header574.7
  %336 = mul nsw i64 %polly.indvar565, -100
  %337 = mul nuw nsw i64 %polly.indvar565, 7
  %338 = add nuw nsw i64 %337, 31
  %pexp.p_div_q584 = lshr i64 %338, 5
