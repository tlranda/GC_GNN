; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9298.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9298.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %99 = shl nuw nsw i64 %indvars.iv785, 1
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %indvars.iv.next786 = add nuw nsw i64 %indvars.iv785, 25
  %indvars.iv.next790 = add nsw i64 %indvars.iv789, -50
  %exitcond800.not = icmp eq i64 %polly.indvar_next209, 24
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %111 = mul nsw i64 %polly.indvar214, -128
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next215, 10
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %134, label %middle.block999, label %vector.body1001, !llvm.loop !76
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond826.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !77
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %138 = shl nuw nsw i64 %indvars.iv806, 1
  %139 = and i64 %138, 9223372036854775680
  %140 = sub nsw i64 %indvars.iv804, %139
  %141 = add i64 %indvars.iv811, %139
  %142 = mul nuw nsw i64 %polly.indvar363, 25
  %pexp.p_div_q366 = lshr i64 %142, 6
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %indvars.iv.next805 = add nuw nsw i64 %indvars.iv804, 50
  %indvars.iv.next807 = add nuw nsw i64 %indvars.iv806, 25
  %indvars.iv.next812 = add nsw i64 %indvars.iv811, -50
  %exitcond824.not = icmp eq i64 %polly.indvar_next364, 24
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %146 = shl nsw i64 %polly.indvar370, 7
  %147 = sub nsw i64 %143, %146
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %150 = mul nsw i64 %polly.indvar370, -128
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382, %polly.loop_header367
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next371, 10
...
polly.loop_header380:                             ; preds = %polly.loop_header373, %polly.loop_exit390
  ...
  %smin817 = call i64 @llvm.smin.i64(i64 %indvars.iv815, i64 49)
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %wide.load986 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %173, label %middle.block975, label %vector.body977, !llvm.loop !85
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %177 = shl nuw nsw i64 %indvars.iv830, 1
  %178 = and i64 %177, 9223372036854775680
  %179 = sub nsw i64 %indvars.iv828, %178
  %180 = add i64 %indvars.iv835, %178
  %181 = mul nuw nsw i64 %polly.indvar521, 25
  %pexp.p_div_q524 = lshr i64 %181, 6
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next829 = add nuw nsw i64 %indvars.iv828, 50
  %indvars.iv.next831 = add nuw nsw i64 %indvars.iv830, 25
  %indvars.iv.next836 = add nsw i64 %indvars.iv835, -50
  %exitcond848.not = icmp eq i64 %polly.indvar_next522, 24
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  ...
  %185 = shl nsw i64 %polly.indvar528, 7
  %186 = sub nsw i64 %182, %185
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %189 = mul nsw i64 %polly.indvar528, -128
...
polly.loop_exit533:                               ; preds = %polly.loop_exit540, %polly.loop_header525
  ...
  %indvars.iv.next833 = add i64 %indvars.iv832, -128
  %indvars.iv.next838 = add i64 %indvars.iv837, 128
  %exitcond847.not = icmp eq i64 %polly.indvar_next529, 10
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  br i1 %226, label %polly.loop_exit714, label %vector.body915, !llvm.loop !94
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %255, label %polly.loop_exit741, label %vector.body930, !llvm.loop !97
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  br i1 %284, label %polly.loop_exit767, label %vector.body948, !llvm.loop !100
