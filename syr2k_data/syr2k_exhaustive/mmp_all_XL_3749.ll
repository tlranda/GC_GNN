; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3749.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3749.c"
...
for.cond1.preheader.i:                            ; preds = %entry, %for.inc17.i
  ...
  %scevgep1105 = getelementptr i8, i8* %call2, i64 %12
  %scevgep1104 = getelementptr i8, i8* %call2, i64 %11
  %scevgep1103 = getelementptr i8, i8* %call1, i64 %12
  %scevgep1102 = getelementptr i8, i8* %call1, i64 %11
  %bound0 = icmp ult i8* %scevgep1102, %scevgep1105
  %bound1 = icmp ult i8* %scevgep1104, %scevgep1103
...
for.inc17.i:                                      ; preds = %vector.body, %for.body3.i
  ...
  br i1 %exitcond18.not.i, label %vector.ph1109, label %for.cond1.preheader.i, !llvm.loop !15

vector.ph1109:                                    ; preds = %for.inc17.i, %for.inc41.i
  %indvars.iv7.i = phi i64 [ %indvars.iv.next8.i, %for.inc41.i ], [ 0, %for.inc17.i ]
  %broadcast.splatinsert1116 = insertelement <4 x i64> poison, i64 %indvars.iv7.i, i32 0
...
vector.body1108:                                  ; preds = %vector.body1108, %vector.ph1109
  ...
  %32 = mul nuw nsw <4 x i64> %vec.ind1114, %broadcast.splat1117
  %33 = trunc <4 x i64> %32 to <4 x i32>
  %34 = add <4 x i32> %33, <i32 3, i32 3, i32 3, i32 3>
  %35 = urem <4 x i32> %34, <i32 1200, i32 1200, i32 1200, i32 1200>
  %36 = sitofp <4 x i32> %35 to <4 x double>
  %37 = fmul fast <4 x double> %36, <double 1.000000e-03, double 1.000000e-03, double 1.000000e-03, double 1.000000e-03>
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call817, i64 %indvars.iv7.i, i64 %index1110
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next1111 = add i64 %index1110, 4
  %vec.ind.next1115 = add <4 x i64> %vec.ind1114, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next1111, 1200
  br i1 %40, label %for.inc41.i, label %vector.body1108, !llvm.loop !16

for.inc41.i:                                      ; preds = %vector.body1108
  %indvars.iv.next8.i = add nuw nsw i64 %indvars.iv7.i, 1
  %exitcond9.not.i = icmp eq i64 %indvars.iv.next8.i, 1200
  br i1 %exitcond9.not.i, label %init_array.exit, label %vector.ph1109, !llvm.loop !17
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1172, label %for.body3.i46.preheader1252, label %vector.ph1173
...
vector.body1171:                                  ; preds = %vector.body1171, %vector.ph1173
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call817, i64 %indvars.iv21.i, i64 %index1176
...
middle.block1169:                                 ; preds = %vector.body1171
  ...
  br i1 %cmp.n1179, label %for.inc6.i, label %for.body3.i46.preheader1252

for.body3.i46.preheader1252:                      ; preds = %for.body3.i46.preheader, %middle.block1169
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec1175, %middle.block1169 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1252, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1252 ]
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  ...
  br i1 %min.iters.check1195, label %for.body3.i60.preheader1249, label %vector.ph1196
...
vector.body1194:                                  ; preds = %vector.body1194, %vector.ph1196
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call817, i64 %indvars.iv21.i52, i64 %index1199
  ...
  br i1 %57, label %middle.block1192, label %vector.body1194, !llvm.loop !60

middle.block1192:                                 ; preds = %vector.body1194
  %cmp.n1202 = icmp eq i64 %indvars.iv21.i52, %n.vec1198
  br i1 %cmp.n1202, label %for.inc6.i63, label %for.body3.i60.preheader1249

for.body3.i60.preheader1249:                      ; preds = %for.body3.i60.preheader, %middle.block1192
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  ...
  br i1 %min.iters.check1221, label %for.body3.i99.preheader1246, label %vector.ph1222
...
vector.body1220:                                  ; preds = %vector.body1220, %vector.ph1222
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call817, i64 %indvars.iv21.i91, i64 %index1225
  ...
  br i1 %68, label %middle.block1218, label %vector.body1220, !llvm.loop !62

middle.block1218:                                 ; preds = %vector.body1220
  %cmp.n1228 = icmp eq i64 %indvars.iv21.i91, %n.vec1224
  br i1 %cmp.n1228, label %for.inc6.i102, label %for.body3.i99.preheader1246

for.body3.i99.preheader1246:                      ; preds = %for.body3.i99.preheader, %middle.block1218
...
vector.body1232:                                  ; preds = %vector.body1232, %vector.ph1236
  ...
  %wide.load1243 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %95, label %middle.block1230, label %vector.body1232, !llvm.loop !74
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv1000 = phi i64 [ 0, %polly.loop_header199.preheader ], [ %indvars.iv.next1001, %polly.loop_exit207 ]
  ...
  %102 = add nuw nsw i64 %polly.indvar202, %pexp.p_div_q.zext
...
polly.loop_exit207:                               ; preds = %polly.loop_exit244
  ...
  %exitcond1008.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_header205:                             ; preds = %polly.loop_exit244, %polly.loop_header199
  %indvars.iv1002 = phi i64 [ %indvars.iv.next1003, %polly.loop_exit244 ], [ %101, %polly.loop_header199 ]
  %indvars.iv998 = phi i64 [ %indvars.iv.next999, %polly.loop_exit244 ], [ %100, %polly.loop_header199 ]
  %polly.indvar208 = phi i64 [ %polly.indvar_next209, %polly.loop_exit244 ], [ %102, %polly.loop_header199 ]
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv998, i64 0)
  %106 = add i64 %smax, %indvars.iv1002
  %107 = mul nuw nsw i64 %polly.indvar208, 96
  %108 = add nsw i64 %107, %103
  %109 = add nsw i64 %108, -1
  %.inv = icmp sgt i64 %108, 127
  ...
  %polly.loop_guard231.not = icmp sgt i64 %112, %115
...
polly.loop_header217.us:                          ; preds = %polly.loop_header211.us, %polly.loop_header217.us
  ...
  %116 = add nuw nsw i64 %polly.indvar220.us, %104
  %polly.access.mul.call1224.us = mul nuw nsw i64 %116, 1000
  ...
  %exitcond996.not = icmp eq i64 %polly.indvar220.us, %110
...
polly.loop_header228.us:                          ; preds = %polly.loop_exit219.loopexit.us, %polly.loop_header228.us
  ...
  %117 = add nuw nsw i64 %polly.indvar232.us, %104
  %polly.access.mul.call1236.us = mul nsw i64 %117, 1000
  ...
  %polly.loop_cond234.not.not.us = icmp slt i64 %polly.indvar232.us, %115
...
polly.loop_exit244:                               ; preds = %polly.loop_exit251, %polly.loop_header242.preheader
  ...
  %indvars.iv.next999 = add i64 %indvars.iv998, -96
  %indvars.iv.next1003 = add i64 %indvars.iv1002, 96
...
polly.loop_header242.preheader:                   ; preds = %polly.loop_exit230, %polly.loop_exit230.us, %polly.loop_header205.split
  ...
  %polly.loop_guard252.not = icmp sgt i64 %120, %124
...
polly.loop_header228:                             ; preds = %polly.loop_header211, %polly.loop_header228
  ...
  %125 = add nuw nsw i64 %polly.indvar232, %104
  %polly.access.mul.call1236 = mul nsw i64 %125, 1000
  ...
  %polly.loop_cond234.not.not = icmp slt i64 %polly.indvar232, %115
...
polly.loop_header242:                             ; preds = %polly.loop_header242.preheader, %polly.loop_exit251
  ...
  %126 = shl nuw nsw i64 %polly.indvar245, 3
  %scevgep268 = getelementptr i8, i8* %call2, i64 %126
...
polly.loop_exit251:                               ; preds = %polly.loop_exit259
  ...
  %exitcond1007.not = icmp eq i64 %polly.indvar_next246, 1000
  br i1 %exitcond1007.not, label %polly.loop_exit244, label %polly.loop_header242

polly.loop_header249:                             ; preds = %polly.loop_exit259, %polly.loop_header242
  %indvars.iv1004 = phi i64 [ %indvars.iv.next1005, %polly.loop_exit259 ], [ %106, %polly.loop_header242 ]
  %polly.indvar253 = phi i64 [ %polly.indvar_next254, %polly.loop_exit259 ], [ %120, %polly.loop_header242 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1004, i64 127)
  %127 = add nsw i64 %polly.indvar253, %108
  %polly.loop_guard2601088 = icmp sgt i64 %127, -1
  br i1 %polly.loop_guard2601088, label %polly.loop_header257.preheader, label %polly.loop_exit259

polly.loop_header257.preheader:                   ; preds = %polly.loop_header249
  %128 = add nuw nsw i64 %polly.indvar253, %107
  %129 = mul i64 %128, 8000
  %scevgep269 = getelementptr i8, i8* %scevgep268, i64 %129
  ...
  %polly.access.add.Packed_MemRef_call1277 = add nsw i64 %127, %polly.access.mul.Packed_MemRef_call1264
...
polly.loop_header257:                             ; preds = %polly.loop_header257.preheader, %polly.loop_header257
  ...
  %131 = add nuw nsw i64 %polly.indvar261, %104
  ...
  %scevgep273 = getelementptr i8, i8* %scevgep268, i64 %132
  ...
  %exitcond1006.not = icmp eq i64 %polly.indvar261, %smin
  br i1 %exitcond1006.not, label %polly.loop_exit259, label %polly.loop_header257
...
polly.loop_header371:                             ; preds = %polly.loop_exit379, %polly.start285
  %indvar1207 = phi i64 [ %indvar.next1208, %polly.loop_exit379 ], [ 0, %polly.start285 ]
  %polly.indvar374 = phi i64 [ %polly.indvar_next375, %polly.loop_exit379 ], [ 1, %polly.start285 ]
  %135 = add i64 %indvar1207, 1
  %136 = mul nuw nsw i64 %polly.indvar374, 9600
  %scevgep383 = getelementptr i8, i8* %call, i64 %136
  %min.iters.check1209 = icmp ult i64 %135, 4
  br i1 %min.iters.check1209, label %polly.loop_header377.preheader, label %vector.ph1210

vector.ph1210:                                    ; preds = %polly.loop_header371
  %n.vec1212 = and i64 %135, -4
...
vector.body1206:                                  ; preds = %vector.body1206, %vector.ph1210
  ...
  %137 = shl nuw nsw i64 %index1213, 3
  %138 = getelementptr i8, i8* %scevgep383, i64 %137
  %139 = bitcast i8* %138 to <4 x double>*
  %wide.load1217 = load <4 x double>, <4 x double>* %139, align 8, !alias.scope !79, !noalias !81
  %140 = fmul fast <4 x double> %wide.load1217, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %142 = icmp eq i64 %index.next1214, %n.vec1212
  br i1 %142, label %middle.block1204, label %vector.body1206, !llvm.loop !85

middle.block1204:                                 ; preds = %vector.body1206
  %cmp.n1216 = icmp eq i64 %135, %n.vec1212
  br i1 %cmp.n1216, label %polly.loop_exit379, label %polly.loop_header377.preheader

polly.loop_header377.preheader:                   ; preds = %polly.loop_header371, %middle.block1204
  %polly.indvar380.ph = phi i64 [ 0, %polly.loop_header371 ], [ %n.vec1212, %middle.block1204 ]
  br label %polly.loop_header377

polly.loop_exit379:                               ; preds = %polly.loop_header377, %middle.block1204
  %polly.indvar_next375 = add nuw nsw i64 %polly.indvar374, 1
  %exitcond1030.not = icmp eq i64 %polly.indvar_next375, 1200
  %indvar.next1208 = add i64 %indvar1207, 1
  br i1 %exitcond1030.not, label %polly.loop_header387.preheader, label %polly.loop_header371
...
polly.loop_header377:                             ; preds = %polly.loop_header377.preheader, %polly.loop_header377
  ...
  %exitcond1029.not = icmp eq i64 %polly.indvar_next381, %polly.indvar374
  br i1 %exitcond1029.not, label %polly.loop_exit379, label %polly.loop_header377, !llvm.loop !86

polly.loop_header387:                             ; preds = %polly.loop_header387.preheader, %polly.loop_exit396
  %indvars.iv1019 = phi i64 [ 0, %polly.loop_header387.preheader ], [ %indvars.iv.next1020, %polly.loop_exit396 ]
  ...
  %144 = udiv i64 %polly.indvar390, 3
  %145 = add nuw i64 %polly.indvar390, %144
  %146 = mul nuw nsw i64 %145, 96
  %147 = sub i64 %indvars.iv1014, %146
  %148 = add i64 %indvars.iv1019, %146
  %pexp.p_div_q393.lhs.trunc = trunc i64 %polly.indvar390 to i8
  %pexp.p_div_q393874 = udiv i8 %pexp.p_div_q393.lhs.trunc, 3
  %pexp.p_div_q393.zext = zext i8 %pexp.p_div_q393874 to i64
  %149 = add nuw nsw i64 %polly.indvar390, %pexp.p_div_q393.zext
  %150 = mul nsw i64 %polly.indvar390, -128
  %151 = shl nsw i64 %polly.indvar390, 7
...
polly.loop_exit396:                               ; preds = %polly.loop_exit435
  ...
  %indvars.iv.next1015 = add nuw nsw i64 %indvars.iv1014, 128
  %indvars.iv.next1020 = add nsw i64 %indvars.iv1019, -128
  %exitcond1028.not = icmp eq i64 %polly.indvar_next391, 10
  br i1 %exitcond1028.not, label %polly.exiting286, label %polly.loop_header387

polly.loop_header394:                             ; preds = %polly.loop_exit435, %polly.loop_header387
  %indvars.iv1021 = phi i64 [ %indvars.iv.next1022, %polly.loop_exit435 ], [ %148, %polly.loop_header387 ]
  %indvars.iv1016 = phi i64 [ %indvars.iv.next1017, %polly.loop_exit435 ], [ %147, %polly.loop_header387 ]
  %polly.indvar397 = phi i64 [ %polly.indvar_next398, %polly.loop_exit435 ], [ %149, %polly.loop_header387 ]
  %smax1018 = call i64 @llvm.smax.i64(i64 %indvars.iv1016, i64 0)
  %153 = add i64 %smax1018, %indvars.iv1021
  %154 = mul nuw nsw i64 %polly.indvar397, 96
  %155 = add nsw i64 %154, %150
  %156 = add nsw i64 %155, -1
  %.inv871 = icmp sgt i64 %155, 127
  %157 = select i1 %.inv871, i64 127, i64 %156
  %polly.loop_guard410 = icmp sgt i64 %157, -1
  ...
  %polly.loop_guard422.not = icmp sgt i64 %159, %162
...
polly.loop_header407.us:                          ; preds = %polly.loop_header400.us, %polly.loop_header407.us
  ...
  %163 = add nuw nsw i64 %polly.indvar411.us, %151
  %polly.access.mul.call1415.us = mul nuw nsw i64 %163, 1000
  ...
  %exitcond1012.not = icmp eq i64 %polly.indvar411.us, %157
...
polly.loop_header419.us:                          ; preds = %polly.loop_exit409.loopexit.us, %polly.loop_header419.us
  %polly.indvar423.us = phi i64 [ %polly.indvar_next424.us, %polly.loop_header419.us ], [ %159, %polly.loop_exit409.loopexit.us ]
  %164 = add nuw nsw i64 %polly.indvar423.us, %151
  %polly.access.mul.call1427.us = mul nsw i64 %164, 1000
  ...
  %polly.loop_cond425.not.not.us = icmp slt i64 %polly.indvar423.us, %162
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442, %polly.loop_header433.preheader
  ...
  %polly.loop_cond399 = icmp ult i64 %polly.indvar397, 12
  %indvars.iv.next1017 = add i64 %indvars.iv1016, -96
  %indvars.iv.next1022 = add i64 %indvars.iv1021, 96
...
polly.loop_header419:                             ; preds = %polly.loop_header400, %polly.loop_header419
  %polly.indvar423 = phi i64 [ %polly.indvar_next424, %polly.loop_header419 ], [ %159, %polly.loop_header400 ]
  %172 = add nuw nsw i64 %polly.indvar423, %151
  %polly.access.mul.call1427 = mul nsw i64 %172, 1000
  ...
  %polly.loop_cond425.not.not = icmp slt i64 %polly.indvar423, %162
...
polly.loop_header433:                             ; preds = %polly.loop_header433.preheader, %polly.loop_exit442
  ...
  %173 = shl nuw nsw i64 %polly.indvar436, 3
  %scevgep459 = getelementptr i8, i8* %call2, i64 %173
...
polly.loop_exit442:                               ; preds = %polly.loop_exit450
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next437, 1000
  br i1 %exitcond1027.not, label %polly.loop_exit435, label %polly.loop_header433

polly.loop_header440:                             ; preds = %polly.loop_exit450, %polly.loop_header433
  %indvars.iv1023 = phi i64 [ %indvars.iv.next1024, %polly.loop_exit450 ], [ %153, %polly.loop_header433 ]
  %polly.indvar444 = phi i64 [ %polly.indvar_next445, %polly.loop_exit450 ], [ %167, %polly.loop_header433 ]
  %smin1025 = call i64 @llvm.smin.i64(i64 %indvars.iv1023, i64 127)
  %174 = add nsw i64 %polly.indvar444, %155
  %polly.loop_guard4511089 = icmp sgt i64 %174, -1
  br i1 %polly.loop_guard4511089, label %polly.loop_header448.preheader, label %polly.loop_exit450

polly.loop_header448.preheader:                   ; preds = %polly.loop_header440
  %175 = add nuw nsw i64 %polly.indvar444, %154
  %176 = mul i64 %175, 8000
  %scevgep460 = getelementptr i8, i8* %scevgep459, i64 %176
  ...
  %polly.access.add.Packed_MemRef_call1288468 = add nsw i64 %174, %polly.access.mul.Packed_MemRef_call1288455
...
polly.loop_exit450:                               ; preds = %polly.loop_header448, %polly.loop_header440
  ...
  %polly.loop_cond446.not.not = icmp slt i64 %polly.indvar444, %171
...
polly.loop_header448:                             ; preds = %polly.loop_header448.preheader, %polly.loop_header448
  ...
  %178 = add nuw nsw i64 %polly.indvar452, %151
  ...
  %scevgep464 = getelementptr i8, i8* %scevgep459, i64 %179
  ...
  %180 = shl i64 %178, 3
  %181 = add i64 %180, %177
  %scevgep471 = getelementptr i8, i8* %call, i64 %181
  ...
  %exitcond1026.not = icmp eq i64 %polly.indvar452, %smin1025
  br i1 %exitcond1026.not, label %polly.loop_exit450, label %polly.loop_header448
...
polly.loop_header562:                             ; preds = %polly.loop_exit570, %polly.start476
  ...
  %183 = mul nuw nsw i64 %polly.indvar565, 9600
  %scevgep574 = getelementptr i8, i8* %call, i64 %183
  %min.iters.check1183 = icmp ult i64 %182, 4
  br i1 %min.iters.check1183, label %polly.loop_header568.preheader, label %vector.ph1184

vector.ph1184:                                    ; preds = %polly.loop_header562
  %n.vec1186 = and i64 %182, -4
...
vector.body1182:                                  ; preds = %vector.body1182, %vector.ph1184
  ...
  %184 = shl nuw nsw i64 %index1187, 3
  %185 = getelementptr i8, i8* %scevgep574, i64 %184
  %186 = bitcast i8* %185 to <4 x double>*
  %wide.load1191 = load <4 x double>, <4 x double>* %186, align 8, !alias.scope !89, !noalias !91
  %187 = fmul fast <4 x double> %wide.load1191, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %189 = icmp eq i64 %index.next1188, %n.vec1186
  br i1 %189, label %middle.block1180, label %vector.body1182, !llvm.loop !95

middle.block1180:                                 ; preds = %vector.body1182
  %cmp.n1190 = icmp eq i64 %182, %n.vec1186
  br i1 %cmp.n1190, label %polly.loop_exit570, label %polly.loop_header568.preheader

polly.loop_header568.preheader:                   ; preds = %polly.loop_header562, %middle.block1180
  %polly.indvar571.ph = phi i64 [ 0, %polly.loop_header562 ], [ %n.vec1186, %middle.block1180 ]
  br label %polly.loop_header568

polly.loop_exit570:                               ; preds = %polly.loop_header568, %middle.block1180
  %polly.indvar_next566 = add nuw nsw i64 %polly.indvar565, 1
  %exitcond1050.not = icmp eq i64 %polly.indvar_next566, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond1050.not, label %polly.loop_header578.preheader, label %polly.loop_header562
...
polly.loop_header568:                             ; preds = %polly.loop_header568.preheader, %polly.loop_header568
  ...
  %190 = shl nuw nsw i64 %polly.indvar571, 3
  %scevgep575 = getelementptr i8, i8* %scevgep574, i64 %190
  ...
  %exitcond1049.not = icmp eq i64 %polly.indvar_next572, %polly.indvar565
  br i1 %exitcond1049.not, label %polly.loop_exit570, label %polly.loop_header568, !llvm.loop !96
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  ...
  %indvars.iv1034 = phi i64 [ 0, %polly.loop_header578.preheader ], [ %indvars.iv.next1035, %polly.loop_exit587 ]
  %polly.indvar581 = phi i64 [ 0, %polly.loop_header578.preheader ], [ %polly.indvar_next582, %polly.loop_exit587 ]
  %191 = udiv i64 %polly.indvar581, 3
  %192 = add nuw i64 %polly.indvar581, %191
  %193 = mul nuw nsw i64 %192, 96
  %194 = sub i64 %indvars.iv1034, %193
  %195 = add i64 %indvars.iv1039, %193
  ...
  %196 = add nuw nsw i64 %polly.indvar581, %pexp.p_div_q584.zext
  %197 = mul nsw i64 %polly.indvar581, -128
  %198 = shl nsw i64 %polly.indvar581, 7
...
polly.loop_exit587:                               ; preds = %polly.loop_exit626
  ...
  %indvars.iv.next1040 = add nsw i64 %indvars.iv1039, -128
  %exitcond1048.not = icmp eq i64 %polly.indvar_next582, 10
  br i1 %exitcond1048.not, label %polly.exiting477, label %polly.loop_header578

polly.loop_header585:                             ; preds = %polly.loop_exit626, %polly.loop_header578
  %indvars.iv1041 = phi i64 [ %indvars.iv.next1042, %polly.loop_exit626 ], [ %195, %polly.loop_header578 ]
  %indvars.iv1036 = phi i64 [ %indvars.iv.next1037, %polly.loop_exit626 ], [ %194, %polly.loop_header578 ]
  %polly.indvar588 = phi i64 [ %polly.indvar_next589, %polly.loop_exit626 ], [ %196, %polly.loop_header578 ]
  %smax1038 = call i64 @llvm.smax.i64(i64 %indvars.iv1036, i64 0)
  %200 = add i64 %smax1038, %indvars.iv1041
  %201 = mul nuw nsw i64 %polly.indvar588, 96
  %202 = add nsw i64 %201, %197
  %203 = add nsw i64 %202, -1
  %.inv872 = icmp sgt i64 %202, 127
  %204 = select i1 %.inv872, i64 127, i64 %203
  %polly.loop_guard601 = icmp sgt i64 %204, -1
  ...
  %polly.loop_guard613.not = icmp sgt i64 %206, %209
...
polly.loop_header598.us:                          ; preds = %polly.loop_header591.us, %polly.loop_header598.us
  ...
  %210 = add nuw nsw i64 %polly.indvar602.us, %198
  %polly.access.mul.call1606.us = mul nuw nsw i64 %210, 1000
  ...
  %exitcond1032.not = icmp eq i64 %polly.indvar602.us, %204
  br i1 %exitcond1032.not, label %polly.loop_exit600.loopexit.us, label %polly.loop_header598.us

polly.loop_header610.us:                          ; preds = %polly.loop_exit600.loopexit.us, %polly.loop_header610.us
  %polly.indvar614.us = phi i64 [ %polly.indvar_next615.us, %polly.loop_header610.us ], [ %206, %polly.loop_exit600.loopexit.us ]
  %211 = add nuw nsw i64 %polly.indvar614.us, %198
  %polly.access.mul.call1618.us = mul nsw i64 %211, 1000
  ...
  %polly.loop_cond616.not.not.us = icmp slt i64 %polly.indvar614.us, %209
...
polly.loop_exit612.us:                            ; preds = %polly.loop_header610.us, %polly.loop_exit600.loopexit.us
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next595.us, 1000
  br i1 %exitcond1033.not, label %polly.loop_header624.preheader, label %polly.loop_header591.us
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633, %polly.loop_header624.preheader
  ...
  %indvars.iv.next1037 = add i64 %indvars.iv1036, -96
  %indvars.iv.next1042 = add i64 %indvars.iv1041, 96
...
polly.loop_exit612:                               ; preds = %polly.loop_header610
  ...
  %exitcond1031.not = icmp eq i64 %polly.indvar_next595, 1000
  br i1 %exitcond1031.not, label %polly.loop_header624.preheader, label %polly.loop_header591
...
polly.loop_header610:                             ; preds = %polly.loop_header591, %polly.loop_header610
  %polly.indvar614 = phi i64 [ %polly.indvar_next615, %polly.loop_header610 ], [ %206, %polly.loop_header591 ]
  %219 = add nuw nsw i64 %polly.indvar614, %198
  %polly.access.mul.call1618 = mul nsw i64 %219, 1000
  ...
  %polly.loop_cond616.not.not = icmp slt i64 %polly.indvar614, %209
...
polly.loop_header624:                             ; preds = %polly.loop_header624.preheader, %polly.loop_exit633
  ...
  %220 = shl nuw nsw i64 %polly.indvar627, 3
  %scevgep650 = getelementptr i8, i8* %call2, i64 %220
...
polly.loop_exit633:                               ; preds = %polly.loop_exit641
  ...
  %exitcond1047.not = icmp eq i64 %polly.indvar_next628, 1000
  br i1 %exitcond1047.not, label %polly.loop_exit626, label %polly.loop_header624

polly.loop_header631:                             ; preds = %polly.loop_exit641, %polly.loop_header624
  %indvars.iv1043 = phi i64 [ %indvars.iv.next1044, %polly.loop_exit641 ], [ %200, %polly.loop_header624 ]
  %polly.indvar635 = phi i64 [ %polly.indvar_next636, %polly.loop_exit641 ], [ %214, %polly.loop_header624 ]
  %smin1045 = call i64 @llvm.smin.i64(i64 %indvars.iv1043, i64 127)
  %221 = add nsw i64 %polly.indvar635, %202
  %polly.loop_guard6421090 = icmp sgt i64 %221, -1
  br i1 %polly.loop_guard6421090, label %polly.loop_header639.preheader, label %polly.loop_exit641

polly.loop_header639.preheader:                   ; preds = %polly.loop_header631
  %222 = add nuw nsw i64 %polly.indvar635, %201
  %223 = mul i64 %222, 8000
  %scevgep651 = getelementptr i8, i8* %scevgep650, i64 %223
  ...
  %polly.access.add.Packed_MemRef_call1479659 = add nsw i64 %221, %polly.access.mul.Packed_MemRef_call1479646
...
polly.loop_exit641:                               ; preds = %polly.loop_header639, %polly.loop_header631
  ...
  %polly.loop_cond637.not.not = icmp slt i64 %polly.indvar635, %218
...
polly.loop_header639:                             ; preds = %polly.loop_header639.preheader, %polly.loop_header639
  ...
  %225 = add nuw nsw i64 %polly.indvar643, %198
  ...
  %scevgep655 = getelementptr i8, i8* %scevgep650, i64 %226
  ...
  %227 = shl i64 %225, 3
  %228 = add i64 %227, %224
  %scevgep662 = getelementptr i8, i8* %call, i64 %228
  ...
  %exitcond1046.not = icmp eq i64 %polly.indvar643, %smin1045
  br i1 %exitcond1046.not, label %polly.loop_exit641, label %polly.loop_header639

polly.loop_header791:                             ; preds = %entry, %polly.loop_exit799
  %indvars.iv1075 = phi i64 [ %indvars.iv.next1076, %polly.loop_exit799 ], [ 0, %entry ]
  %polly.indvar794 = phi i64 [ %polly.indvar_next795, %polly.loop_exit799 ], [ 0, %entry ]
  %smin1077 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 -1168)
  %229 = shl nsw i64 %polly.indvar794, 5
  %230 = add nsw i64 %smin1077, 1199
...
polly.loop_exit799:                               ; preds = %polly.loop_exit805
  ...
  %exitcond1080.not = icmp eq i64 %polly.indvar_next795, 38
  br i1 %exitcond1080.not, label %polly.loop_header818, label %polly.loop_header791

polly.loop_header797:                             ; preds = %polly.loop_exit805, %polly.loop_header791
  %indvars.iv1071 = phi i64 [ %indvars.iv.next1072, %polly.loop_exit805 ], [ 0, %polly.loop_header791 ]
  %polly.indvar800 = phi i64 [ %polly.indvar_next801, %polly.loop_exit805 ], [ 0, %polly.loop_header791 ]
  %231 = mul nsw i64 %polly.indvar800, -32
  %smin1121 = call i64 @llvm.smin.i64(i64 %231, i64 -1168)
  %232 = add nsw i64 %smin1121, 1200
  %smin1073 = call i64 @llvm.smin.i64(i64 %indvars.iv1071, i64 -1168)
  %233 = shl nsw i64 %polly.indvar800, 5
  %234 = add nsw i64 %smin1073, 1199
...
polly.loop_exit805:                               ; preds = %polly.loop_exit811
  ...
  %exitcond1079.not = icmp eq i64 %polly.indvar_next801, 38
  br i1 %exitcond1079.not, label %polly.loop_exit799, label %polly.loop_header797
...
polly.loop_header803:                             ; preds = %polly.loop_exit811, %polly.loop_header797
  ...
  %235 = add nuw nsw i64 %polly.indvar806, %229
  %236 = trunc i64 %235 to i32
  %237 = mul nuw nsw i64 %235, 9600
  %min.iters.check = icmp eq i64 %232, 0
  br i1 %min.iters.check, label %polly.loop_header809, label %vector.ph1122

vector.ph1122:                                    ; preds = %polly.loop_header803
  %broadcast.splatinsert1129 = insertelement <4 x i64> poison, i64 %233, i32 0
  %broadcast.splat1130 = shufflevector <4 x i64> %broadcast.splatinsert1129, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1131 = insertelement <4 x i32> poison, i32 %236, i32 0
...
vector.body1120:                                  ; preds = %vector.body1120, %vector.ph1122
  %index1123 = phi i64 [ 0, %vector.ph1122 ], [ %index.next1124, %vector.body1120 ]
  %vec.ind1127 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph1122 ], [ %vec.ind.next1128, %vector.body1120 ]
  %238 = add nuw nsw <4 x i64> %vec.ind1127, %broadcast.splat1130
  %239 = trunc <4 x i64> %238 to <4 x i32>
  %240 = mul <4 x i32> %broadcast.splat1132, %239
  ...
  %250 = icmp eq i64 %index.next1124, %232
  br i1 %250, label %polly.loop_exit811, label %vector.body1120, !llvm.loop !104

polly.loop_exit811:                               ; preds = %vector.body1120, %polly.loop_header809
  %polly.indvar_next807 = add nuw nsw i64 %polly.indvar806, 1
  %exitcond1078.not = icmp eq i64 %polly.indvar806, %230
  br i1 %exitcond1078.not, label %polly.loop_exit805, label %polly.loop_header803
...
polly.loop_header809:                             ; preds = %polly.loop_header803, %polly.loop_header809
  ...
  %251 = add nuw nsw i64 %polly.indvar812, %233
  ...
  %scevgep815 = getelementptr i8, i8* %call, i64 %257
  ...
  %exitcond1074.not = icmp eq i64 %polly.indvar812, %234
  br i1 %exitcond1074.not, label %polly.loop_exit811, label %polly.loop_header809, !llvm.loop !105

polly.loop_header818:                             ; preds = %polly.loop_exit799, %polly.loop_exit826
  %indvars.iv1065 = phi i64 [ %indvars.iv.next1066, %polly.loop_exit826 ], [ 0, %polly.loop_exit799 ]
  ...
  %258 = shl nsw i64 %polly.indvar821, 5
  %259 = add nsw i64 %smin1067, 1199
...
polly.loop_exit826:                               ; preds = %polly.loop_exit832
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar_next822, 38
  br i1 %exitcond1070.not, label %polly.loop_header844, label %polly.loop_header818

polly.loop_header824:                             ; preds = %polly.loop_exit832, %polly.loop_header818
  %indvars.iv1061 = phi i64 [ %indvars.iv.next1062, %polly.loop_exit832 ], [ 0, %polly.loop_header818 ]
  %polly.indvar827 = phi i64 [ %polly.indvar_next828, %polly.loop_exit832 ], [ 0, %polly.loop_header818 ]
  %260 = mul nsw i64 %polly.indvar827, -32
  %smin1136 = call i64 @llvm.smin.i64(i64 %260, i64 -968)
  %261 = add nsw i64 %smin1136, 1000
  %smin1063 = call i64 @llvm.smin.i64(i64 %indvars.iv1061, i64 -968)
  %262 = shl nsw i64 %polly.indvar827, 5
  %263 = add nsw i64 %smin1063, 999
...
polly.loop_exit832:                               ; preds = %polly.loop_exit838
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next828, 32
  br i1 %exitcond1069.not, label %polly.loop_exit826, label %polly.loop_header824
...
polly.loop_header830:                             ; preds = %polly.loop_exit838, %polly.loop_header824
  ...
  %264 = add nuw nsw i64 %polly.indvar833, %258
  %265 = trunc i64 %264 to i32
  %266 = mul nuw nsw i64 %264, 8000
  %min.iters.check1137 = icmp eq i64 %261, 0
  br i1 %min.iters.check1137, label %polly.loop_header836, label %vector.ph1138

vector.ph1138:                                    ; preds = %polly.loop_header830
  %broadcast.splatinsert1147 = insertelement <4 x i64> poison, i64 %262, i32 0
  %broadcast.splat1148 = shufflevector <4 x i64> %broadcast.splatinsert1147, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1149 = insertelement <4 x i32> poison, i32 %265, i32 0
...
vector.body1135:                                  ; preds = %vector.body1135, %vector.ph1138
  ...
  %267 = add nuw nsw <4 x i64> %vec.ind1145, %broadcast.splat1148
  %268 = trunc <4 x i64> %267 to <4 x i32>
  %269 = mul <4 x i32> %broadcast.splat1150, %268
  ...
  %279 = icmp eq i64 %index.next1142, %261
  br i1 %279, label %polly.loop_exit838, label %vector.body1135, !llvm.loop !107

polly.loop_exit838:                               ; preds = %vector.body1135, %polly.loop_header836
  %polly.indvar_next834 = add nuw nsw i64 %polly.indvar833, 1
  %exitcond1068.not = icmp eq i64 %polly.indvar833, %259
  br i1 %exitcond1068.not, label %polly.loop_exit832, label %polly.loop_header830
...
polly.loop_header836:                             ; preds = %polly.loop_header830, %polly.loop_header836
  ...
  %280 = add nuw nsw i64 %polly.indvar839, %262
  ...
  %scevgep842 = getelementptr i8, i8* %call2, i64 %286
  ...
  %exitcond1064.not = icmp eq i64 %polly.indvar839, %263
  br i1 %exitcond1064.not, label %polly.loop_exit838, label %polly.loop_header836, !llvm.loop !108

polly.loop_header844:                             ; preds = %polly.loop_exit826, %polly.loop_exit852
  %indvars.iv1055 = phi i64 [ %indvars.iv.next1056, %polly.loop_exit852 ], [ 0, %polly.loop_exit826 ]
  ...
  %287 = shl nsw i64 %polly.indvar847, 5
  %288 = add nsw i64 %smin1057, 1199
...
polly.loop_exit852:                               ; preds = %polly.loop_exit858
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next848, 38
  br i1 %exitcond1060.not, label %init_array.exit, label %polly.loop_header844

polly.loop_header850:                             ; preds = %polly.loop_exit858, %polly.loop_header844
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit858 ], [ 0, %polly.loop_header844 ]
  %polly.indvar853 = phi i64 [ %polly.indvar_next854, %polly.loop_exit858 ], [ 0, %polly.loop_header844 ]
  %289 = mul nsw i64 %polly.indvar853, -32
  %smin1154 = call i64 @llvm.smin.i64(i64 %289, i64 -968)
  %290 = add nsw i64 %smin1154, 1000
  %smin1053 = call i64 @llvm.smin.i64(i64 %indvars.iv1051, i64 -968)
  %291 = shl nsw i64 %polly.indvar853, 5
  %292 = add nsw i64 %smin1053, 999
...
polly.loop_exit858:                               ; preds = %polly.loop_exit864
  ...
  %exitcond1059.not = icmp eq i64 %polly.indvar_next854, 32
  br i1 %exitcond1059.not, label %polly.loop_exit852, label %polly.loop_header850
...
polly.loop_header856:                             ; preds = %polly.loop_exit864, %polly.loop_header850
  ...
  %293 = add nuw nsw i64 %polly.indvar859, %287
  %294 = trunc i64 %293 to i32
  %295 = mul nuw nsw i64 %293, 8000
  %min.iters.check1155 = icmp eq i64 %290, 0
  br i1 %min.iters.check1155, label %polly.loop_header862, label %vector.ph1156

vector.ph1156:                                    ; preds = %polly.loop_header856
  %broadcast.splatinsert1165 = insertelement <4 x i64> poison, i64 %291, i32 0
  %broadcast.splat1166 = shufflevector <4 x i64> %broadcast.splatinsert1165, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1167 = insertelement <4 x i32> poison, i32 %294, i32 0
...
vector.body1153:                                  ; preds = %vector.body1153, %vector.ph1156
  ...
  %296 = add nuw nsw <4 x i64> %vec.ind1163, %broadcast.splat1166
  %297 = trunc <4 x i64> %296 to <4 x i32>
  %298 = mul <4 x i32> %broadcast.splat1168, %297
  ...
  %308 = icmp eq i64 %index.next1160, %290
  br i1 %308, label %polly.loop_exit864, label %vector.body1153, !llvm.loop !110

polly.loop_exit864:                               ; preds = %vector.body1153, %polly.loop_header862
  %polly.indvar_next860 = add nuw nsw i64 %polly.indvar859, 1
  %exitcond1058.not = icmp eq i64 %polly.indvar859, %288
  br i1 %exitcond1058.not, label %polly.loop_exit858, label %polly.loop_header856
...
polly.loop_header862:                             ; preds = %polly.loop_header856, %polly.loop_header862
  ...
  %309 = add nuw nsw i64 %polly.indvar865, %291
  ...
  %scevgep869 = getelementptr i8, i8* %call1, i64 %315
  ...
  %exitcond1054.not = icmp eq i64 %polly.indvar865, %292
  br i1 %exitcond1054.not, label %polly.loop_exit864, label %polly.loop_header862, !llvm.loop !111
}
