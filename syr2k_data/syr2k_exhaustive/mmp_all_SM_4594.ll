; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4594.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4594.c"
...
vector.body1085:                                  ; preds = %vector.body1085, %vector.ph1086
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call801, i64 %indvars.iv7.i, i64 %index1087
...
vector.body1147:                                  ; preds = %vector.body1147, %vector.ph1149
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call801, i64 %indvars.iv21.i, i64 %index1152
...
vector.body1170:                                  ; preds = %vector.body1170, %vector.ph1172
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call801, i64 %indvars.iv21.i52, i64 %index1175
  ...
  br i1 %57, label %middle.block1168, label %vector.body1170, !llvm.loop !55
...
vector.body1196:                                  ; preds = %vector.body1196, %vector.ph1198
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call801, i64 %indvars.iv21.i91, i64 %index1201
  ...
  br i1 %68, label %middle.block1194, label %vector.body1196, !llvm.loop !57
...
vector.body1208:                                  ; preds = %vector.body1208, %vector.ph1212
  ...
  %wide.load1219 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  ...
  br i1 %95, label %middle.block1206, label %vector.body1208, !llvm.loop !69
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next968 = add nuw nsw i64 %indvars.iv967, 32
  %indvars.iv.next979 = add nuw nsw i64 %indvars.iv978, 2
  %exitcond981.not = icmp eq i64 %polly.indvar_next203, 38
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %103 = mul nuw nsw i64 %polly.indvar208, 80
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %107 = add i64 %smax, %indvars.iv969
  %108 = sub nsw i64 %102, %103
  %109 = add nuw nsw i64 %103, 80
...
polly.loop_exit213:                               ; preds = %polly.loop_exit244, %polly.loop_header205
  ...
  %indvars.iv.next970 = add nsw i64 %indvars.iv969, -80
  %exitcond980.not = icmp eq i64 %polly.indvar208, %umin
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit244
  %indvars.iv971 = phi i64 [ %107, %polly.loop_header211.preheader ], [ %indvars.iv.next972, %polly.loop_exit244 ]
  %polly.indvar214 = phi i64 [ %106, %polly.loop_header211.preheader ], [ %polly.indvar_next215, %polly.loop_exit244 ]
  %smin975 = call i64 @llvm.smin.i64(i64 %indvars.iv971, i64 79)
  %110 = add nsw i64 %polly.indvar214, %108
  %polly.loop_guard2271068 = icmp sgt i64 %110, -1
  %111 = add nuw nsw i64 %polly.indvar214, %102
  %.not = icmp ult i64 %111, %109
  %polly.access.mul.call1236 = mul nsw i64 %111, 1000
  br i1 %polly.loop_guard2271068, label %polly.loop_header217.us, label %polly.loop_header211.split
...
polly.loop_header224.us:                          ; preds = %polly.loop_header217.us, %polly.loop_header224.us
  ...
  %112 = add nuw nsw i64 %polly.indvar228.us, %103
  %polly.access.mul.call1232.us = mul nuw nsw i64 %112, 1000
...
polly.then.us:                                    ; preds = %polly.cond.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1240.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1.us, %110
...
polly.loop_header217:                             ; preds = %polly.loop_header211.split, %polly.loop_header217
  ...
  %polly.access.add.Packed_MemRef_call1240 = add nsw i64 %polly.access.mul.Packed_MemRef_call1239, %110
...
polly.loop_header242.preheader:                   ; preds = %polly.loop_header217, %polly.merge.us
  ...
  br i1 %polly.loop_guard2271068, label %polly.loop_header242.us, label %polly.loop_exit244
...
polly.loop_header242.us:                          ; preds = %polly.loop_header242.preheader, %polly.loop_exit251.loopexit.us
  ...
  %115 = shl nuw nsw i64 %polly.indvar245.us, 3
  %scevgep260.us = getelementptr i8, i8* %call2, i64 %115
  %polly.access.mul.Packed_MemRef_call1256.us = mul nuw nsw i64 %polly.indvar245.us, 1200
  %scevgep261.us = getelementptr i8, i8* %scevgep260.us, i64 %113
  ...
  %polly.access.add.Packed_MemRef_call1269.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1256.us, %110
...
polly.loop_header249.us:                          ; preds = %polly.loop_header249.us, %polly.loop_header242.us
  ...
  %116 = add nuw nsw i64 %polly.indvar253.us, %103
  ...
  %scevgep265.us = getelementptr i8, i8* %scevgep260.us, i64 %117
  ...
  %118 = shl i64 %116, 3
  %119 = add i64 %118, %114
  %scevgep272.us = getelementptr i8, i8* %call, i64 %119
...
polly.loop_header363:                             ; preds = %polly.loop_exit371, %polly.start277
  %indvar1183 = phi i64 [ %indvar.next1184, %polly.loop_exit371 ], [ 0, %polly.start277 ]
  %polly.indvar366 = phi i64 [ %polly.indvar_next367, %polly.loop_exit371 ], [ 1, %polly.start277 ]
  %120 = add i64 %indvar1183, 1
  %121 = mul nuw nsw i64 %polly.indvar366, 9600
  %scevgep375 = getelementptr i8, i8* %call, i64 %121
  %min.iters.check1185 = icmp ult i64 %120, 4
  br i1 %min.iters.check1185, label %polly.loop_header369.preheader, label %vector.ph1186

vector.ph1186:                                    ; preds = %polly.loop_header363
  %n.vec1188 = and i64 %120, -4
...
vector.body1182:                                  ; preds = %vector.body1182, %vector.ph1186
  ...
  %122 = shl nuw nsw i64 %index1189, 3
  %123 = getelementptr i8, i8* %scevgep375, i64 %122
  %124 = bitcast i8* %123 to <4 x double>*
  %wide.load1193 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !74, !noalias !76
  %125 = fmul fast <4 x double> %wide.load1193, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %127 = icmp eq i64 %index.next1190, %n.vec1188
  br i1 %127, label %middle.block1180, label %vector.body1182, !llvm.loop !80

middle.block1180:                                 ; preds = %vector.body1182
  %cmp.n1192 = icmp eq i64 %120, %n.vec1188
  br i1 %cmp.n1192, label %polly.loop_exit371, label %polly.loop_header369.preheader

polly.loop_header369.preheader:                   ; preds = %polly.loop_header363, %middle.block1180
  %polly.indvar372.ph = phi i64 [ 0, %polly.loop_header363 ], [ %n.vec1188, %middle.block1180 ]
  br label %polly.loop_header369

polly.loop_exit371:                               ; preds = %polly.loop_header369, %middle.block1180
...
polly.loop_header369:                             ; preds = %polly.loop_header369.preheader, %polly.loop_header369
  ...
  %128 = shl nuw nsw i64 %polly.indvar372, 3
  %scevgep376 = getelementptr i8, i8* %scevgep375, i64 %128
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit388
  ...
  %129 = udiv i64 %indvars.iv1002, 5
  %umin1004 = call i64 @llvm.umin.i64(i64 %129, i64 14)
  %130 = mul nsw i64 %polly.indvar382, -32
  %131 = icmp slt i64 %130, -1168
  %132 = select i1 %131, i64 %130, i64 -1168
  %133 = add nsw i64 %132, 1199
  %134 = shl nsw i64 %polly.indvar382, 5
...
polly.loop_exit388:                               ; preds = %polly.loop_exit395
  ...
  %indvars.iv.next991 = add nuw nsw i64 %indvars.iv990, 32
  %indvars.iv.next1003 = add nuw nsw i64 %indvars.iv1002, 2
  %exitcond1006.not = icmp eq i64 %polly.indvar_next383, 38
...
polly.loop_header386:                             ; preds = %polly.loop_exit395, %polly.loop_header379
  ...
  %135 = mul nuw nsw i64 %polly.indvar389, 80
  %136 = add nsw i64 %135, %130
  %137 = icmp sgt i64 %136, 0
  %138 = select i1 %137, i64 %136, i64 0
  %polly.loop_guard396.not = icmp sgt i64 %138, %133
...
polly.loop_header393.preheader:                   ; preds = %polly.loop_header386
  ...
  %139 = add i64 %smax989, %indvars.iv992
  %140 = sub nsw i64 %134, %135
  %141 = add nuw nsw i64 %135, 80
...
polly.loop_exit395:                               ; preds = %polly.loop_exit431, %polly.loop_header386
  ...
  %indvars.iv.next993 = add nsw i64 %indvars.iv992, -80
  %exitcond1005.not = icmp eq i64 %polly.indvar389, %umin1004
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit431
  %indvars.iv994 = phi i64 [ %139, %polly.loop_header393.preheader ], [ %indvars.iv.next995, %polly.loop_exit431 ]
  %polly.indvar397 = phi i64 [ %138, %polly.loop_header393.preheader ], [ %polly.indvar_next398, %polly.loop_exit431 ]
  %smin999 = call i64 @llvm.smin.i64(i64 %indvars.iv994, i64 79)
  %142 = add nsw i64 %polly.indvar397, %140
  %polly.loop_guard4101069 = icmp sgt i64 %142, -1
  %143 = add nuw nsw i64 %polly.indvar397, %134
  %.not855 = icmp ult i64 %143, %141
  %polly.access.mul.call1423 = mul nsw i64 %143, 1000
  br i1 %polly.loop_guard4101069, label %polly.loop_header400.us, label %polly.loop_header393.split
...
polly.loop_header407.us:                          ; preds = %polly.loop_header400.us, %polly.loop_header407.us
  ...
  %144 = add nuw nsw i64 %polly.indvar411.us, %135
  %polly.access.mul.call1415.us = mul nuw nsw i64 %144, 1000
...
polly.then420.us:                                 ; preds = %polly.cond418.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1280427.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1280.us, %142
...
polly.loop_exit431:                               ; preds = %polly.loop_exit438.loopexit.us, %polly.loop_header393.split, %polly.loop_header429.preheader
  ...
  %polly.loop_cond399.not.not = icmp ult i64 %polly.indvar397, %133
...
polly.loop_header400:                             ; preds = %polly.loop_header393.split, %polly.loop_header400
  ...
  %polly.access.add.Packed_MemRef_call1280427 = add nsw i64 %polly.access.mul.Packed_MemRef_call1280426, %142
...
polly.loop_header429.preheader:                   ; preds = %polly.loop_header400, %polly.merge419.us
  ...
  br i1 %polly.loop_guard4101069, label %polly.loop_header429.us, label %polly.loop_exit431
...
polly.loop_header429.us:                          ; preds = %polly.loop_header429.preheader, %polly.loop_exit438.loopexit.us
  ...
  %147 = shl nuw nsw i64 %polly.indvar432.us, 3
  %scevgep447.us = getelementptr i8, i8* %call2, i64 %147
  %polly.access.mul.Packed_MemRef_call1280443.us = mul nuw nsw i64 %polly.indvar432.us, 1200
  %scevgep448.us = getelementptr i8, i8* %scevgep447.us, i64 %145
  ...
  %polly.access.add.Packed_MemRef_call1280456.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1280443.us, %142
...
polly.loop_header436.us:                          ; preds = %polly.loop_header436.us, %polly.loop_header429.us
  ...
  %148 = add nuw nsw i64 %polly.indvar440.us, %135
  ...
  %scevgep452.us = getelementptr i8, i8* %scevgep447.us, i64 %149
  ...
  %150 = shl i64 %148, 3
  %151 = add i64 %150, %146
  %scevgep459.us = getelementptr i8, i8* %call, i64 %151
...
polly.loop_header550:                             ; preds = %polly.loop_exit558, %polly.start464
  ...
  %153 = mul nuw nsw i64 %polly.indvar553, 9600
  %scevgep562 = getelementptr i8, i8* %call, i64 %153
  %min.iters.check1159 = icmp ult i64 %152, 4
  br i1 %min.iters.check1159, label %polly.loop_header556.preheader, label %vector.ph1160

vector.ph1160:                                    ; preds = %polly.loop_header550
  %n.vec1162 = and i64 %152, -4
...
vector.body1158:                                  ; preds = %vector.body1158, %vector.ph1160
  ...
  %154 = shl nuw nsw i64 %index1163, 3
  %155 = getelementptr i8, i8* %scevgep562, i64 %154
  %156 = bitcast i8* %155 to <4 x double>*
  %wide.load1167 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !84, !noalias !86
  %157 = fmul fast <4 x double> %wide.load1167, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %159 = icmp eq i64 %index.next1164, %n.vec1162
  br i1 %159, label %middle.block1156, label %vector.body1158, !llvm.loop !90

middle.block1156:                                 ; preds = %vector.body1158
  %cmp.n1166 = icmp eq i64 %152, %n.vec1162
  br i1 %cmp.n1166, label %polly.loop_exit558, label %polly.loop_header556.preheader

polly.loop_header556.preheader:                   ; preds = %polly.loop_header550, %middle.block1156
  %polly.indvar559.ph = phi i64 [ 0, %polly.loop_header550 ], [ %n.vec1162, %middle.block1156 ]
  br label %polly.loop_header556

polly.loop_exit558:                               ; preds = %polly.loop_header556, %middle.block1156
  %polly.indvar_next554 = add nuw nsw i64 %polly.indvar553, 1
  %exitcond1033.not = icmp eq i64 %polly.indvar_next554, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond1033.not, label %polly.loop_header566.preheader, label %polly.loop_header550
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_header556
  ...
  %160 = shl nuw nsw i64 %polly.indvar559, 3
  %scevgep563 = getelementptr i8, i8* %scevgep562, i64 %160
  ...
  %exitcond1032.not = icmp eq i64 %polly.indvar_next560, %polly.indvar553
  br i1 %exitcond1032.not, label %polly.loop_exit558, label %polly.loop_header556, !llvm.loop !91

polly.loop_header566:                             ; preds = %polly.loop_header566.preheader, %polly.loop_exit575
  %indvars.iv1027 = phi i64 [ 1, %polly.loop_header566.preheader ], [ %indvars.iv.next1028, %polly.loop_exit575 ]
  ...
  %161 = udiv i64 %indvars.iv1027, 5
  %umin1029 = call i64 @llvm.umin.i64(i64 %161, i64 14)
  %162 = mul nsw i64 %polly.indvar569, -32
  %163 = icmp slt i64 %162, -1168
  %164 = select i1 %163, i64 %162, i64 -1168
  %165 = add nsw i64 %164, 1199
  %166 = shl nsw i64 %polly.indvar569, 5
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582
  ...
  %indvars.iv.next1016 = add nuw nsw i64 %indvars.iv1015, 32
  %indvars.iv.next1028 = add nuw nsw i64 %indvars.iv1027, 2
  %exitcond1031.not = icmp eq i64 %polly.indvar_next570, 38
  br i1 %exitcond1031.not, label %polly.exiting465, label %polly.loop_header566
...
polly.loop_header573:                             ; preds = %polly.loop_exit582, %polly.loop_header566
  ...
  %polly.loop_guard583.not = icmp sgt i64 %170, %165
...
polly.loop_header580.preheader:                   ; preds = %polly.loop_header573
  ...
  %171 = add i64 %smax1014, %indvars.iv1017
  %172 = sub nsw i64 %166, %167
  %173 = add nuw nsw i64 %167, 80
...
polly.loop_exit582:                               ; preds = %polly.loop_exit618, %polly.loop_header573
  ...
  %indvars.iv.next1018 = add nsw i64 %indvars.iv1017, -80
  %exitcond1030.not = icmp eq i64 %polly.indvar576, %umin1029
  br i1 %exitcond1030.not, label %polly.loop_exit575, label %polly.loop_header573

polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit618
  %indvars.iv1019 = phi i64 [ %171, %polly.loop_header580.preheader ], [ %indvars.iv.next1020, %polly.loop_exit618 ]
  %polly.indvar584 = phi i64 [ %170, %polly.loop_header580.preheader ], [ %polly.indvar_next585, %polly.loop_exit618 ]
  %smin1024 = call i64 @llvm.smin.i64(i64 %indvars.iv1019, i64 79)
  %174 = add nsw i64 %polly.indvar584, %172
  %polly.loop_guard5971070 = icmp sgt i64 %174, -1
  %175 = add nuw nsw i64 %polly.indvar584, %166
  %.not856 = icmp ult i64 %175, %173
  %polly.access.mul.call1610 = mul nsw i64 %175, 1000
  br i1 %polly.loop_guard5971070, label %polly.loop_header587.us, label %polly.loop_header580.split
...
polly.loop_header594.us:                          ; preds = %polly.loop_header587.us, %polly.loop_header594.us
  ...
  %polly.access.mul.call1602.us = mul nuw nsw i64 %176, 1000
...
polly.then607.us:                                 ; preds = %polly.cond605.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1467614.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1467.us, %174
...
polly.loop_exit618:                               ; preds = %polly.loop_exit625.loopexit.us, %polly.loop_header580.split, %polly.loop_header616.preheader
  ...
  %polly.loop_cond586.not.not = icmp ult i64 %polly.indvar584, %165
...
polly.loop_header587:                             ; preds = %polly.loop_header580.split, %polly.loop_header587
  ...
  %polly.access.add.Packed_MemRef_call1467614 = add nsw i64 %polly.access.mul.Packed_MemRef_call1467613, %174
...
polly.loop_header616.preheader:                   ; preds = %polly.loop_header587, %polly.merge606.us
  ...
  br i1 %polly.loop_guard5971070, label %polly.loop_header616.us, label %polly.loop_exit618
...
polly.loop_header616.us:                          ; preds = %polly.loop_header616.preheader, %polly.loop_exit625.loopexit.us
  ...
  %179 = shl nuw nsw i64 %polly.indvar619.us, 3
  %scevgep634.us = getelementptr i8, i8* %call2, i64 %179
  %polly.access.mul.Packed_MemRef_call1467630.us = mul nuw nsw i64 %polly.indvar619.us, 1200
  %scevgep635.us = getelementptr i8, i8* %scevgep634.us, i64 %177
  ...
  %polly.access.add.Packed_MemRef_call1467643.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1467630.us, %174
...
polly.loop_header623.us:                          ; preds = %polly.loop_header623.us, %polly.loop_header616.us
  ...
  %180 = add nuw nsw i64 %polly.indvar627.us, %167
  ...
  %scevgep639.us = getelementptr i8, i8* %scevgep634.us, i64 %181
  ...
  %182 = shl i64 %180, 3
  %183 = add i64 %182, %178
  %scevgep646.us = getelementptr i8, i8* %call, i64 %183
...
polly.loop_header775:                             ; preds = %entry, %polly.loop_exit783
  %indvars.iv1058 = phi i64 [ %indvars.iv.next1059, %polly.loop_exit783 ], [ 0, %entry ]
  ...
  %184 = shl nsw i64 %polly.indvar778, 5
  %185 = add nsw i64 %smin1060, 1199
...
polly.loop_exit783:                               ; preds = %polly.loop_exit789
  ...
  %exitcond1063.not = icmp eq i64 %polly.indvar_next779, 38
  br i1 %exitcond1063.not, label %polly.loop_header802, label %polly.loop_header775

polly.loop_header781:                             ; preds = %polly.loop_exit789, %polly.loop_header775
  %indvars.iv1054 = phi i64 [ %indvars.iv.next1055, %polly.loop_exit789 ], [ 0, %polly.loop_header775 ]
  %polly.indvar784 = phi i64 [ %polly.indvar_next785, %polly.loop_exit789 ], [ 0, %polly.loop_header775 ]
  %186 = mul nsw i64 %polly.indvar784, -32
  ...
  %188 = shl nsw i64 %polly.indvar784, 5
  %189 = add nsw i64 %smin1056, 1199
...
polly.loop_exit789:                               ; preds = %polly.loop_exit795
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar_next785, 38
  br i1 %exitcond1062.not, label %polly.loop_exit783, label %polly.loop_header781
...
polly.loop_header787:                             ; preds = %polly.loop_exit795, %polly.loop_header781
  ...
  %190 = add nuw nsw i64 %polly.indvar790, %184
  %191 = trunc i64 %190 to i32
  %192 = mul nuw nsw i64 %190, 9600
  %min.iters.check = icmp eq i64 %187, 0
  br i1 %min.iters.check, label %polly.loop_header793, label %vector.ph1098

vector.ph1098:                                    ; preds = %polly.loop_header787
  %broadcast.splatinsert1105 = insertelement <4 x i64> poison, i64 %188, i32 0
  %broadcast.splat1106 = shufflevector <4 x i64> %broadcast.splatinsert1105, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1107 = insertelement <4 x i32> poison, i32 %191, i32 0
...
vector.body1097:                                  ; preds = %vector.body1097, %vector.ph1098
  ...
  %193 = add nuw nsw <4 x i64> %vec.ind1103, %broadcast.splat1106
  %194 = trunc <4 x i64> %193 to <4 x i32>
  %195 = mul <4 x i32> %broadcast.splat1108, %194
  ...
  %205 = icmp eq i64 %index.next1100, %187
  br i1 %205, label %polly.loop_exit795, label %vector.body1097, !llvm.loop !99

polly.loop_exit795:                               ; preds = %vector.body1097, %polly.loop_header793
  %polly.indvar_next791 = add nuw nsw i64 %polly.indvar790, 1
  %exitcond1061.not = icmp eq i64 %polly.indvar790, %185
  br i1 %exitcond1061.not, label %polly.loop_exit789, label %polly.loop_header787
...
polly.loop_header793:                             ; preds = %polly.loop_header787, %polly.loop_header793
  ...
  %206 = add nuw nsw i64 %polly.indvar796, %188
  ...
  %scevgep799 = getelementptr i8, i8* %call, i64 %212
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar796, %189
  br i1 %exitcond1057.not, label %polly.loop_exit795, label %polly.loop_header793, !llvm.loop !100

polly.loop_header802:                             ; preds = %polly.loop_exit783, %polly.loop_exit810
  %indvars.iv1048 = phi i64 [ %indvars.iv.next1049, %polly.loop_exit810 ], [ 0, %polly.loop_exit783 ]
  ...
  %213 = shl nsw i64 %polly.indvar805, 5
  %214 = add nsw i64 %smin1050, 1199
...
polly.loop_exit810:                               ; preds = %polly.loop_exit816
  ...
  %exitcond1053.not = icmp eq i64 %polly.indvar_next806, 38
  br i1 %exitcond1053.not, label %polly.loop_header828, label %polly.loop_header802

polly.loop_header808:                             ; preds = %polly.loop_exit816, %polly.loop_header802
  %indvars.iv1044 = phi i64 [ %indvars.iv.next1045, %polly.loop_exit816 ], [ 0, %polly.loop_header802 ]
  %polly.indvar811 = phi i64 [ %polly.indvar_next812, %polly.loop_exit816 ], [ 0, %polly.loop_header802 ]
  %215 = mul nsw i64 %polly.indvar811, -32
  %smin1112 = call i64 @llvm.smin.i64(i64 %215, i64 -968)
  %216 = add nsw i64 %smin1112, 1000
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv1044, i64 -968)
  %217 = shl nsw i64 %polly.indvar811, 5
  %218 = add nsw i64 %smin1046, 999
...
polly.loop_exit816:                               ; preds = %polly.loop_exit822
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar_next812, 32
  br i1 %exitcond1052.not, label %polly.loop_exit810, label %polly.loop_header808
...
polly.loop_header814:                             ; preds = %polly.loop_exit822, %polly.loop_header808
  ...
  %219 = add nuw nsw i64 %polly.indvar817, %213
  %220 = trunc i64 %219 to i32
  %221 = mul nuw nsw i64 %219, 8000
  %min.iters.check1113 = icmp eq i64 %216, 0
  br i1 %min.iters.check1113, label %polly.loop_header820, label %vector.ph1114

vector.ph1114:                                    ; preds = %polly.loop_header814
  %broadcast.splatinsert1123 = insertelement <4 x i64> poison, i64 %217, i32 0
  %broadcast.splat1124 = shufflevector <4 x i64> %broadcast.splatinsert1123, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1125 = insertelement <4 x i32> poison, i32 %220, i32 0
...
vector.body1111:                                  ; preds = %vector.body1111, %vector.ph1114
  ...
  %222 = add nuw nsw <4 x i64> %vec.ind1121, %broadcast.splat1124
  %223 = trunc <4 x i64> %222 to <4 x i32>
  %224 = mul <4 x i32> %broadcast.splat1126, %223
  ...
  %234 = icmp eq i64 %index.next1118, %216
  br i1 %234, label %polly.loop_exit822, label %vector.body1111, !llvm.loop !102

polly.loop_exit822:                               ; preds = %vector.body1111, %polly.loop_header820
  %polly.indvar_next818 = add nuw nsw i64 %polly.indvar817, 1
  %exitcond1051.not = icmp eq i64 %polly.indvar817, %214
  br i1 %exitcond1051.not, label %polly.loop_exit816, label %polly.loop_header814
...
polly.loop_header820:                             ; preds = %polly.loop_header814, %polly.loop_header820
  ...
  %235 = add nuw nsw i64 %polly.indvar823, %217
  ...
  %scevgep826 = getelementptr i8, i8* %call2, i64 %241
  ...
  %exitcond1047.not = icmp eq i64 %polly.indvar823, %218
  br i1 %exitcond1047.not, label %polly.loop_exit822, label %polly.loop_header820, !llvm.loop !103

polly.loop_header828:                             ; preds = %polly.loop_exit810, %polly.loop_exit836
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039, %polly.loop_exit836 ], [ 0, %polly.loop_exit810 ]
  ...
  %242 = shl nsw i64 %polly.indvar831, 5
  %243 = add nsw i64 %smin1040, 1199
...
polly.loop_exit836:                               ; preds = %polly.loop_exit842
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next832, 38
  br i1 %exitcond1043.not, label %init_array.exit, label %polly.loop_header828

polly.loop_header834:                             ; preds = %polly.loop_exit842, %polly.loop_header828
  %indvars.iv1034 = phi i64 [ %indvars.iv.next1035, %polly.loop_exit842 ], [ 0, %polly.loop_header828 ]
  %polly.indvar837 = phi i64 [ %polly.indvar_next838, %polly.loop_exit842 ], [ 0, %polly.loop_header828 ]
  %244 = mul nsw i64 %polly.indvar837, -32
  %smin1130 = call i64 @llvm.smin.i64(i64 %244, i64 -968)
  %245 = add nsw i64 %smin1130, 1000
  %smin1036 = call i64 @llvm.smin.i64(i64 %indvars.iv1034, i64 -968)
  %246 = shl nsw i64 %polly.indvar837, 5
  %247 = add nsw i64 %smin1036, 999
...
polly.loop_exit842:                               ; preds = %polly.loop_exit848
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar_next838, 32
  br i1 %exitcond1042.not, label %polly.loop_exit836, label %polly.loop_header834
...
polly.loop_header840:                             ; preds = %polly.loop_exit848, %polly.loop_header834
  ...
  %248 = add nuw nsw i64 %polly.indvar843, %242
  %249 = trunc i64 %248 to i32
  %250 = mul nuw nsw i64 %248, 8000
  %min.iters.check1131 = icmp eq i64 %245, 0
  br i1 %min.iters.check1131, label %polly.loop_header846, label %vector.ph1132

vector.ph1132:                                    ; preds = %polly.loop_header840
  %broadcast.splatinsert1141 = insertelement <4 x i64> poison, i64 %246, i32 0
  %broadcast.splat1142 = shufflevector <4 x i64> %broadcast.splatinsert1141, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1143 = insertelement <4 x i32> poison, i32 %249, i32 0
...
vector.body1129:                                  ; preds = %vector.body1129, %vector.ph1132
  ...
  %251 = add nuw nsw <4 x i64> %vec.ind1139, %broadcast.splat1142
  %252 = trunc <4 x i64> %251 to <4 x i32>
  %253 = mul <4 x i32> %broadcast.splat1144, %252
  ...
  %263 = icmp eq i64 %index.next1136, %245
  br i1 %263, label %polly.loop_exit848, label %vector.body1129, !llvm.loop !105

polly.loop_exit848:                               ; preds = %vector.body1129, %polly.loop_header846
  %polly.indvar_next844 = add nuw nsw i64 %polly.indvar843, 1
  %exitcond1041.not = icmp eq i64 %polly.indvar843, %243
  br i1 %exitcond1041.not, label %polly.loop_exit842, label %polly.loop_header840
...
polly.loop_header846:                             ; preds = %polly.loop_header840, %polly.loop_header846
  ...
  %264 = add nuw nsw i64 %polly.indvar849, %246
  ...
  %scevgep853 = getelementptr i8, i8* %call1, i64 %270
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar849, %247
  br i1 %exitcond1037.not, label %polly.loop_exit848, label %polly.loop_header846, !llvm.loop !106
}
