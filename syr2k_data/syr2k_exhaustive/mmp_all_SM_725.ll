; ModuleID = 'syr2k_exhaustive/mmp_all_SM_725.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_725.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %indvars.iv1012 = phi i64 [ 50, %polly.loop_header200.preheader ], [ %indvars.iv.next1013, %polly.loop_exit224 ]
  ...
  %97 = mul nuw nsw i64 %polly.indvar203, 6
  %98 = mul nsw i64 %polly.indvar203, -6
  %99 = shl nsw i64 %polly.indvar203, 8
  br label %polly.loop_header206

polly.loop_exit208:                               ; preds = %polly.loop_exit214
  %100 = mul nsw i64 %polly.indvar203, -256
  %101 = mul nuw nsw i64 %polly.indvar203, 5
  %102 = shl nsw i64 %polly.indvar203, 7
  %103 = or i64 %102, 1
...
polly.loop_exit224:                               ; preds = %polly.loop_exit280
  ...
  %indvars.iv.next1025 = add nsw i64 %indvars.iv1024, -6
...
polly.loop_exit280:                               ; preds = %polly.loop_exit286
  ...
  %indvars.iv.next1027 = add nsw i64 %indvars.iv1026, 50
  %exitcond1032.not = icmp eq i64 %polly.indvar_next226, 24
...
polly.loop_preheader279.loopexit:                 ; preds = %polly.loop_exit267
  %.pre1142 = mul nuw nsw i64 %polly.indvar225, 50
...
polly.loop_exit293:                               ; preds = %polly.loop_header291, %middle.block1354, %polly.loop_header284
  ...
  %polly.loop_cond289 = icmp ult i64 %polly.indvar287, 49
...
polly.loop_header423:                             ; preds = %polly.loop_header423.preheader, %polly.loop_exit447
  ...
  %indvars.iv1042 = phi i64 [ 50, %polly.loop_header423.preheader ], [ %indvars.iv.next1043, %polly.loop_exit447 ]
  ...
  %158 = mul nuw nsw i64 %polly.indvar426, 6
  %159 = mul nsw i64 %polly.indvar426, -6
...
polly.loop_exit431:                               ; preds = %polly.loop_exit437
  ...
  %162 = mul nuw nsw i64 %polly.indvar426, 5
  %163 = shl nsw i64 %polly.indvar426, 7
  %164 = or i64 %163, 1
...
polly.loop_exit447:                               ; preds = %polly.loop_exit509
  ...
  %indvars.iv.next1043 = add nsw i64 %indvars.iv1042, -6
  %indvars.iv.next1051 = add nuw nsw i64 %indvars.iv1050, 6
  %indvars.iv.next1056 = add nsw i64 %indvars.iv1055, -6
...
polly.loop_header455.preheader:                   ; preds = %polly.loop_header445
  %173 = mul nuw nsw i64 %polly.indvar448, 50
...
polly.loop_exit509:                               ; preds = %polly.loop_exit515
  ...
  %indvars.iv.next1053 = add nsw i64 %indvars.iv1052, -50
  %indvars.iv.next1058 = add nsw i64 %indvars.iv1057, 50
  %exitcond1064.not = icmp eq i64 %polly.indvar_next449, 24
...
polly.loop_preheader508.loopexit:                 ; preds = %polly.loop_exit496
  %.pre1140 = mul nuw nsw i64 %polly.indvar448, 50
...
polly.loop_exit522:                               ; preds = %polly.loop_header520, %middle.block1304, %polly.loop_header513
  ...
  %polly.loop_cond518 = icmp ult i64 %polly.indvar516, 49
...
polly.loop_header652:                             ; preds = %polly.loop_header652.preheader, %polly.loop_exit676
  ...
  %indvars.iv1074 = phi i64 [ 50, %polly.loop_header652.preheader ], [ %indvars.iv.next1075, %polly.loop_exit676 ]
  ...
  %219 = mul nuw nsw i64 %polly.indvar655, 6
  %220 = mul nsw i64 %polly.indvar655, -6
...
polly.loop_exit660:                               ; preds = %polly.loop_exit666
  ...
  %223 = mul nuw nsw i64 %polly.indvar655, 5
  %224 = shl nsw i64 %polly.indvar655, 7
  %225 = or i64 %224, 1
...
polly.loop_exit676:                               ; preds = %polly.loop_exit738
  ...
  %indvars.iv.next1075 = add nsw i64 %indvars.iv1074, -6
  %indvars.iv.next1083 = add nuw nsw i64 %indvars.iv1082, 6
  %indvars.iv.next1088 = add nsw i64 %indvars.iv1087, -6
...
polly.loop_header684.preheader:                   ; preds = %polly.loop_header674
  %234 = mul nuw nsw i64 %polly.indvar677, 50
...
polly.loop_exit738:                               ; preds = %polly.loop_exit744
  ...
  %indvars.iv.next1077 = add nuw nsw i64 %indvars.iv1076, 50
  %indvars.iv.next1085 = add nsw i64 %indvars.iv1084, -50
  %indvars.iv.next1090 = add nsw i64 %indvars.iv1089, 50
  %exitcond1096.not = icmp eq i64 %polly.indvar_next678, 24
...
polly.loop_preheader737.loopexit:                 ; preds = %polly.loop_exit725
  %.pre = mul nuw nsw i64 %polly.indvar677, 50
...
polly.loop_exit751:                               ; preds = %polly.loop_header749, %middle.block1254, %polly.loop_header742
  ...
  %polly.loop_cond747 = icmp ult i64 %polly.indvar745, 49
