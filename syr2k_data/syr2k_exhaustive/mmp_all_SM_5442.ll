; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5442.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5442.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %99 = mul nuw nsw i64 %polly.indvar202, 25
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next824.1, i64 99)
  %109 = or i64 %101, 2
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next824.2, i64 99)
  %113 = or i64 %101, 3
...
polly.loop_header368:                             ; preds = %polly.loop_header368.preheader, %polly.loop_exit392
  ...
  %131 = mul nuw nsw i64 %polly.indvar371, 100
  br label %polly.loop_header374

polly.loop_exit376:                               ; preds = %polly.loop_exit382
  %132 = mul nsw i64 %polly.indvar371, -100
  %133 = mul nuw nsw i64 %polly.indvar371, 25
...
polly.loop_header390:                             ; preds = %polly.loop_exit398, %polly.loop_exit376
  ...
  %smin840 = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 99)
  ...
  %smin840.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839, i64 99)
  %139 = or i64 %135, 1
  ...
  %smin840.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839.1, i64 99)
  %143 = or i64 %135, 2
  ...
  %smin840.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839.2, i64 99)
  %147 = or i64 %135, 3
...
polly.loop_header537:                             ; preds = %polly.loop_header537.preheader, %polly.loop_exit561
  ...
  %165 = mul nuw nsw i64 %polly.indvar540, 100
  br label %polly.loop_header543

polly.loop_exit545:                               ; preds = %polly.loop_exit551
  %166 = mul nsw i64 %polly.indvar540, -100
  %167 = mul nuw nsw i64 %polly.indvar540, 25
...
polly.loop_header559:                             ; preds = %polly.loop_exit567, %polly.loop_exit545
  ...
  %smin856 = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 99)
  ...
  %smin856.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855, i64 99)
  %173 = or i64 %169, 1
  ...
  %smin856.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855.1, i64 99)
  %177 = or i64 %169, 2
  ...
  %smin856.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855.2, i64 99)
  %181 = or i64 %169, 3
