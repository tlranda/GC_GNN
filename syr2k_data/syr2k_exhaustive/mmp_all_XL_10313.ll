; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10313.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10313.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin793 = call i64 @llvm.smin.i64(i64 %indvars.iv791, i64 -984)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond796.not = icmp eq i64 %polly.indvar_next209, 63
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.loop_header354
  ...
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 -984)
  %136 = shl nsw i64 %polly.indvar363, 4
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375
  ...
  %exitcond819.not = icmp eq i64 %polly.indvar_next364, 63
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %smin838 = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 -984)
  %170 = shl nsw i64 %polly.indvar520, 4
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %indvars.iv.next837 = add nsw i64 %indvars.iv836, -16
  %exitcond842.not = icmp eq i64 %polly.indvar_next521, 63
