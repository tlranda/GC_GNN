; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9571.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9571.c"
...
vector.body978:                                   ; preds = %vector.body978, %vector.ph980
  ...
  br i1 %57, label %middle.block976, label %vector.body978, !llvm.loop !50
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1006
  ...
  br i1 %68, label %middle.block1002, label %vector.body1004, !llvm.loop !52
...
vector.body1016:                                  ; preds = %vector.body1016, %vector.ph1020
  ...
  %wide.load1027 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !58, !noalias !60
  ...
  br i1 %95, label %middle.block1014, label %vector.body1016, !llvm.loop !63
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next786 = add nuw nsw i64 %indvars.iv785, 16
  %indvars.iv.next793 = add nuw nsw i64 %indvars.iv792, 2
  %exitcond796.not = icmp eq i64 %polly.indvar_next203, 75
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %polly.loop_guard = icmp slt i64 %117, 16
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph994
  ...
  %wide.load1001 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !68, !noalias !70
  ...
  store <4 x double> %136, <4 x double>* %137, align 8, !alias.scope !68, !noalias !70
  %index.next998 = add i64 %index997, 4
  %138 = icmp eq i64 %index.next998, %n.vec996
  br i1 %138, label %middle.block988, label %vector.body990, !llvm.loop !73
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond818.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %140 = mul nsw i64 %polly.indvar357, -16
  %141 = shl nsw i64 %polly.indvar357, 4
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit368
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next800 = add nsw i64 %indvars.iv799, -16
  %indvars.iv.next805 = add nuw nsw i64 %indvars.iv804, 16
  %indvars.iv.next814 = add nuw nsw i64 %indvars.iv813, 2
  %exitcond817.not = icmp eq i64 %polly.indvar_next358, 75
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %157 = shl nsw i64 %polly.indvar369, 3
  %158 = add nsw i64 %157, %140
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard376 = icmp slt i64 %160, 16
...
polly.loop_exit382:                               ; preds = %polly.loop_header387.us.7, %polly.loop_header373
  ...
  %polly.loop_cond379 = icmp ult i64 %polly.indvar377, 15
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  %wide.load975 = load <4 x double>, <4 x double>* %178, align 8, !alias.scope !77, !noalias !79
  ...
  store <4 x double> %179, <4 x double>* %180, align 8, !alias.scope !77, !noalias !79
  %index.next972 = add i64 %index971, 4
  %181 = icmp eq i64 %index.next972, %n.vec970
  br i1 %181, label %middle.block964, label %vector.body966, !llvm.loop !82
...
polly.loop_header501:                             ; preds = %polly.loop_header501.preheader, %polly.loop_header501
  ...
  br i1 %exitcond839.not, label %polly.loop_exit503, label %polly.loop_header501, !llvm.loop !83
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %183 = mul nsw i64 %polly.indvar514, -16
  %184 = shl nsw i64 %polly.indvar514, 4
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %indvars.iv.next821 = add nsw i64 %indvars.iv820, -16
  %indvars.iv.next826 = add nuw nsw i64 %indvars.iv825, 16
  %indvars.iv.next835 = add nuw nsw i64 %indvars.iv834, 2
  %exitcond838.not = icmp eq i64 %polly.indvar_next515, 75
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %200 = shl nsw i64 %polly.indvar526, 3
  %201 = add nsw i64 %200, %183
  %202 = icmp sgt i64 %201, 0
  %203 = select i1 %202, i64 %201, i64 0
  %polly.loop_guard533 = icmp slt i64 %203, 16
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %smin831 = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 7)
...
polly.loop_exit539:                               ; preds = %polly.loop_header544.us.7, %polly.loop_header530
  ...
  %polly.loop_cond536 = icmp ult i64 %polly.indvar534, 15
...
vector.body904:                                   ; preds = %vector.body904, %vector.ph906
  ...
  store <4 x double> %232, <4 x double>* %237, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %238, label %polly.loop_exit712, label %vector.body904, !llvm.loop !91
...
polly.loop_header710:                             ; preds = %polly.loop_header704, %polly.loop_header710
  ...
  br i1 %exitcond864.not, label %polly.loop_exit712, label %polly.loop_header710, !llvm.loop !92
...
vector.body919:                                   ; preds = %vector.body919, %vector.ph922
  ...
  store <4 x double> %261, <4 x double>* %266, align 8, !alias.scope !90, !noalias !93
  ...
  br i1 %267, label %polly.loop_exit739, label %vector.body919, !llvm.loop !94
...
polly.loop_header737:                             ; preds = %polly.loop_header731, %polly.loop_header737
  ...
  br i1 %exitcond854.not, label %polly.loop_exit739, label %polly.loop_header737, !llvm.loop !95
...
vector.body937:                                   ; preds = %vector.body937, %vector.ph940
  ...
  store <4 x double> %290, <4 x double>* %295, align 8, !alias.scope !89, !noalias !96
  ...
  br i1 %296, label %polly.loop_exit765, label %vector.body937, !llvm.loop !97
...
polly.loop_header763:                             ; preds = %polly.loop_header757, %polly.loop_header763
  ...
  br i1 %exitcond844.not, label %polly.loop_exit765, label %polly.loop_header763, !llvm.loop !98
