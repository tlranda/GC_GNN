; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6288.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6288.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %indvars.iv.next822 = add nuw nsw i64 %indvars.iv821, 80
  %exitcond828.not = icmp eq i64 %polly.indvar_next225, 15
...
polly.loop_exit241:                               ; preds = %polly.loop_header239
  ...
  %exitcond826.not = icmp eq i64 %polly.indvar_next237, 80
...
polly.loop_header368:                             ; preds = %polly.loop_header368.preheader, %polly.loop_exit392
  ...
  %119 = mul nuw nsw i64 %polly.indvar371, 80
...
polly.loop_header390.preheader:                   ; preds = %polly.loop_exit382
  %120 = mul nsw i64 %polly.indvar371, -80
...
polly.loop_exit410:                               ; preds = %polly.loop_header408
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next406, 80
...
polly.loop_header537:                             ; preds = %polly.loop_header537.preheader, %polly.loop_exit561
  ...
  %141 = mul nuw nsw i64 %polly.indvar540, 80
...
polly.loop_header559.preheader:                   ; preds = %polly.loop_exit551
  %142 = mul nsw i64 %polly.indvar540, -80
...
polly.loop_header559:                             ; preds = %polly.loop_header559.preheader, %polly.loop_exit567
  ...
  %144 = mul nuw nsw i64 %polly.indvar562, 80
...
polly.loop_exit567:                               ; preds = %polly.loop_exit573
  ...
  %indvars.iv.next853 = add nuw nsw i64 %indvars.iv852, 80
  %exitcond860.not = icmp eq i64 %polly.indvar_next563, 15
...
polly.loop_exit579:                               ; preds = %polly.loop_header577
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar_next575, 80
