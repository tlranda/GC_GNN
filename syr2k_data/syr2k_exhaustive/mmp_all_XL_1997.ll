; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1997.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1997.c"
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %polly.loop_guard238 = icmp slt i64 %113, 50
...
polly.loop_header235:                             ; preds = %polly.loop_header235.preheader, %polly.loop_exit269
  ...
  %smin1345 = call i64 @llvm.smin.i64(i64 %117, i64 63)
...
vector.body1341:                                  ; preds = %vector.body1341, %vector.ph1347
  ...
  %wide.load1360 = load <4 x double>, <4 x double>* %138, align 8, !alias.scope !64, !noalias !66
  ...
  br i1 %143, label %middle.block1339, label %vector.body1341, !llvm.loop !76
...
vector.body1279:                                  ; preds = %vector.body1279, %vector.ph1283
  ...
  %wide.load1290 = load <4 x double>, <4 x double>* %151, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %154, label %middle.block1277, label %vector.body1279, !llvm.loop !85
...
polly.loop_header422:                             ; preds = %polly.loop_exit414, %polly.loop_exit430
  ...
  %156 = mul nsw i64 %polly.indvar425, -50
  %157 = mul nuw nsw i64 %polly.indvar425, 50
  %158 = mul nuw nsw i64 %polly.indvar425, 7
  %159 = add nuw nsw i64 %158, 39
  %pexp.p_div_q434 = lshr i64 %159, 5
  %160 = sub nsw i64 %polly.indvar425, %pexp.p_div_q434
  %polly.loop_guard439 = icmp sgt i64 %160, -2
  %161 = mul nsw i64 %polly.indvar425, -50
  %162 = mul nuw nsw i64 %polly.indvar425, 50
...
polly.loop_header436.preheader:                   ; preds = %polly.loop_header428
  %163 = mul nuw nsw i64 %polly.indvar431, 50
...
polly.loop_header436:                             ; preds = %polly.loop_header436.preheader, %polly.loop_exit446
  ...
  %164 = shl nuw nsw i64 %polly.indvar440, 6
  %165 = add i64 %156, %164
  %smax1294 = call i64 @llvm.smax.i64(i64 %165, i64 0)
  %166 = mul nsw i64 %polly.indvar440, -64
  %167 = add i64 %157, %166
  %168 = add i64 %smax1294, %167
  %169 = shl nsw i64 %polly.indvar440, 6
  %170 = add nsw i64 %169, %161
  %171 = icmp sgt i64 %170, 0
  %172 = select i1 %171, i64 %170, i64 0
  %polly.loop_guard447 = icmp slt i64 %172, 50
...
polly.loop_header444:                             ; preds = %polly.loop_header444.preheader, %polly.loop_exit482
  ...
  %smin1297 = call i64 @llvm.smin.i64(i64 %176, i64 63)
...
vector.body1293:                                  ; preds = %vector.body1293, %vector.ph1299
  ...
  %wide.load1312 = load <4 x double>, <4 x double>* %197, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %202, label %middle.block1291, label %vector.body1293, !llvm.loop !89
...
vector.body1233:                                  ; preds = %vector.body1233, %vector.ph1235
  ...
  %wide.load1242 = load <4 x double>, <4 x double>* %210, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %213, label %middle.block1231, label %vector.body1233, !llvm.loop !98
...
polly.loop_header635:                             ; preds = %polly.loop_exit627, %polly.loop_exit643
  ...
  %215 = mul nsw i64 %polly.indvar638, -50
  %216 = mul nuw nsw i64 %polly.indvar638, 50
  %217 = mul nuw nsw i64 %polly.indvar638, 7
  %218 = add nuw nsw i64 %217, 39
  %pexp.p_div_q647 = lshr i64 %218, 5
  %219 = sub nsw i64 %polly.indvar638, %pexp.p_div_q647
  %polly.loop_guard652 = icmp sgt i64 %219, -2
  %220 = mul nsw i64 %polly.indvar638, -50
  %221 = mul nuw nsw i64 %polly.indvar638, 50
...
polly.loop_header649.preheader:                   ; preds = %polly.loop_header641
  %222 = mul nuw nsw i64 %polly.indvar644, 50
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit695
  ...
  %smin1249 = call i64 @llvm.smin.i64(i64 %235, i64 63)
...
vector.body1245:                                  ; preds = %vector.body1245, %vector.ph1251
  ...
  %wide.load1264 = load <4 x double>, <4 x double>* %256, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %261, label %middle.block1243, label %vector.body1245, !llvm.loop !102
...
vector.body1172:                                  ; preds = %vector.body1172, %vector.ph1173
  ...
  br i1 %286, label %polly.loop_exit872, label %vector.body1172, !llvm.loop !109
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1189
  ...
  br i1 %315, label %polly.loop_exit899, label %vector.body1186, !llvm.loop !112
...
vector.body1204:                                  ; preds = %vector.body1204, %vector.ph1207
  ...
  br i1 %344, label %polly.loop_exit925, label %vector.body1204, !llvm.loop !115
