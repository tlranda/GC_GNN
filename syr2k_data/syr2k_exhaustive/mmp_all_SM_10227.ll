; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10227.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10227.c"
...
polly.loop_header205.us:                          ; preds = %polly.loop_header199, %polly.loop_exit213.loopexit.us
  ...
  %101 = mul nuw nsw i64 %polly.indvar208.us, 50
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %102 = mul nuw nsw i64 %polly.indvar214.us, 100
  %103 = add nsw i64 %102, %99
  %104 = icmp sgt i64 %103, 0
  %105 = select i1 %104, i64 %103, i64 0
  %polly.loop_guard221.us = icmp slt i64 %105, 80
...
vector.body1091:                                  ; preds = %vector.body1091, %vector.ph1095
  ...
  %wide.load1102 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %127, label %middle.block1089, label %vector.body1091, !llvm.loop !74
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %131 = mul nsw i64 %polly.indvar359, -80
  %132 = mul nuw nsw i64 %polly.indvar359, 80
...
polly.loop_header362.us:                          ; preds = %polly.loop_header356, %polly.loop_exit372.loopexit.us
  ...
  %133 = mul nuw nsw i64 %polly.indvar365.us, 50
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %134 = mul nuw nsw i64 %polly.indvar374.us, 100
  %135 = add nsw i64 %134, %131
  %136 = icmp sgt i64 %135, 0
  %137 = select i1 %136, i64 %135, i64 0
  %polly.loop_guard381.us = icmp slt i64 %137, 80
...
vector.body1067:                                  ; preds = %vector.body1067, %vector.ph1069
  ...
  %wide.load1076 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %159, label %middle.block1065, label %vector.body1067, !llvm.loop !83
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %163 = mul nsw i64 %polly.indvar519, -80
  %164 = mul nuw nsw i64 %polly.indvar519, 80
...
polly.loop_header522.us:                          ; preds = %polly.loop_header516, %polly.loop_exit532.loopexit.us
  ...
  %165 = mul nuw nsw i64 %polly.indvar525.us, 50
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %166 = mul nuw nsw i64 %polly.indvar534.us, 100
  %167 = add nsw i64 %166, %163
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %polly.loop_guard541.us = icmp slt i64 %169, 80
...
vector.body1005:                                  ; preds = %vector.body1005, %vector.ph1007
  ...
  br i1 %205, label %polly.loop_exit720, label %vector.body1005, !llvm.loop !92
...
vector.body1020:                                  ; preds = %vector.body1020, %vector.ph1023
  ...
  br i1 %234, label %polly.loop_exit747, label %vector.body1020, !llvm.loop !95
...
vector.body1038:                                  ; preds = %vector.body1038, %vector.ph1041
  ...
  br i1 %263, label %polly.loop_exit773, label %vector.body1038, !llvm.loop !98
