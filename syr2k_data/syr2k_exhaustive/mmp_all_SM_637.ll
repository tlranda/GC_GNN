; ModuleID = 'syr2k_exhaustive/mmp_all_SM_637.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_637.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1061 = call i64 @llvm.smin.i64(i64 %indvars.iv1033, i64 -984)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next204, 63
...
polly.start325:                                   ; preds = %kernel_syr2k.exit
  ...
  %malloccall329 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
polly.loop_header429:                             ; preds = %polly.loop_header429.preheader, %polly.loop_exit437
  ...
  %smin1101 = call i64 @llvm.smin.i64(i64 %indvars.iv1071, i64 -984)
  %164 = add nsw i64 %smin1101, 1000
  %165 = shl nsw i64 %polly.indvar432, 4
...
polly.loop_exit437:                               ; preds = %polly.loop_exit459
  ...
  %exitcond1105.not = icmp eq i64 %polly.indvar_next433, 63
...
polly.start560:                                   ; preds = %init_array.exit
  %malloccall562 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
  %malloccall564 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
polly.loop_header664:                             ; preds = %polly.loop_header664.preheader, %polly.loop_exit672
  ...
  %smin1141 = call i64 @llvm.smin.i64(i64 %indvars.iv1111, i64 -984)
  %231 = add nsw i64 %smin1141, 1000
  %232 = shl nsw i64 %polly.indvar667, 4
...
polly.loop_exit672:                               ; preds = %polly.loop_exit694
  ...
  %exitcond1145.not = icmp eq i64 %polly.indvar_next668, 63
