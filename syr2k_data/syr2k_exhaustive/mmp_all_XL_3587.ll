; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3587.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3587.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %99 = udiv i64 %polly.indvar208, 10
  ...
  %pexp.p_div_q889 = udiv i8 %pexp.p_div_q.lhs.trunc, 10
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %indvars.iv.next1020 = add nuw nsw i64 %indvars.iv1019, 8
  %indvars.iv.next1024 = add nsw i64 %indvars.iv1023, -8
  %exitcond1033.not = icmp eq i64 %112, 150
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %113 = add i64 %smax, %indvars.iv1025
  %114 = mul nuw nsw i64 %polly.indvar214, 10
  %.not.not = icmp ugt i64 %114, %polly.indvar208
  %115 = mul nuw nsw i64 %polly.indvar214, 80
  %116 = add nsw i64 %115, %104
  %117 = icmp sgt i64 %116, 0
  %118 = select i1 %117, i64 %116, i64 0
  %119 = add nsw i64 %116, 79
  %polly.loop_guard.not = icmp sgt i64 %118, %119
...
polly.loop_header217.us:                          ; preds = %polly.loop_header211, %polly.loop_exit235.us
  ...
  %polly.access.add.call1231.us = add nuw nsw i64 %120, %polly.access.mul.call1230.us
  ...
  %polly.access.add.call1231.us.1 = add nuw nsw i64 %120, %polly.access.mul.call1230.us.1
  ...
  %polly.access.add.call1231.us.2 = add nuw nsw i64 %120, %polly.access.mul.call1230.us.2
  ...
  %polly.access.add.call1231.us.3 = add nuw nsw i64 %120, %polly.access.mul.call1230.us.3
  ...
  %polly.access.add.call1231.us.4 = add nuw nsw i64 %120, %polly.access.mul.call1230.us.4
  ...
  %polly.access.add.call1231.us.5 = add nuw nsw i64 %120, %polly.access.mul.call1230.us.5
  ...
  %polly.access.add.call1231.us.6 = add nuw nsw i64 %120, %polly.access.mul.call1230.us.6
  ...
  %polly.access.add.call1231.us.7 = add nuw nsw i64 %120, %polly.access.mul.call1230.us.7
...
polly.loop_header233.us:                          ; preds = %polly.loop_header217.us, %polly.loop_header233.us
  ...
  %121 = add nuw nsw i64 %polly.indvar236.us, %103
  %polly.access.mul.call1240.us = mul nsw i64 %121, 1000
  %polly.access.add.call1241.us = add nuw nsw i64 %120, %polly.access.mul.call1240.us
  ...
  %polly.loop_cond238.not.not.us = icmp slt i64 %polly.indvar236.us, %119
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %polly.loop_guard256 = icmp slt i64 %125, 80
...
polly.loop_header246.us:                          ; preds = %polly.loop_header246.preheader, %polly.loop_exit255.loopexit.us
  ...
  %126 = add nuw nsw i64 %polly.indvar249.us, %98
...
polly.loop_header253.us:                          ; preds = %polly.loop_header246.us, %polly.loop_exit263.us
  %indvars.iv1027 = phi i64 [ %113, %polly.loop_header246.us ], [ %indvars.iv.next1028, %polly.loop_exit263.us ]
  %polly.indvar257.us = phi i64 [ %125, %polly.loop_header246.us ], [ %polly.indvar_next258.us, %polly.loop_exit263.us ]
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 7)
  %128 = add nsw i64 %polly.indvar257.us, %116
  %polly.loop_guard264.us1123 = icmp sgt i64 %128, -1
...
polly.loop_header261.us:                          ; preds = %polly.loop_header261.preheader.us, %polly.loop_header261.us
  ...
  %129 = add nuw nsw i64 %polly.indvar265.us, %103
  ...
  %scevgep275.us = getelementptr i8, i8* %call2, i64 %131
  ...
  %132 = shl i64 %129, 3
  %133 = add i64 %132, %137
  %scevgep282.us = getelementptr i8, i8* %call, i64 %133
...
polly.loop_header261.preheader.us:                ; preds = %polly.loop_header253.us
  %134 = add nuw nsw i64 %polly.indvar257.us, %115
  %135 = mul i64 %134, 8000
  %136 = add i64 %135, %127
  %scevgep272.us = getelementptr i8, i8* %call2, i64 %136
  ...
  %polly.access.add.Packed_MemRef_call1279.us = add nsw i64 %128, %polly.access.mul.Packed_MemRef_call1268.us
...
polly.loop_header233:                             ; preds = %polly.loop_header217, %polly.loop_header233
  ...
  %138 = add nuw nsw i64 %polly.indvar236, %103
  %polly.access.mul.call1240 = mul nsw i64 %138, 1000
  %polly.access.add.call1241 = add nuw nsw i64 %122, %polly.access.mul.call1240
  ...
  %polly.loop_cond238.not.not = icmp slt i64 %polly.indvar236, %119
...
polly.loop_header373:                             ; preds = %polly.loop_exit381, %polly.start287
  ...
  %139 = add i64 %indvar1238, 1
  %140 = mul nuw nsw i64 %polly.indvar376, 9600
  %scevgep385 = getelementptr i8, i8* %call, i64 %140
  %min.iters.check1240 = icmp ult i64 %139, 4
...
vector.body1237:                                  ; preds = %vector.body1237, %vector.ph1241
  ...
  %141 = shl nuw nsw i64 %index1244, 3
  %142 = getelementptr i8, i8* %scevgep385, i64 %141
  %143 = bitcast i8* %142 to <4 x double>*
  %wide.load1248 = load <4 x double>, <4 x double>* %143, align 8, !alias.scope !78, !noalias !80
  %144 = fmul fast <4 x double> %wide.load1248, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %145 = bitcast i8* %142 to <4 x double>*
  store <4 x double> %144, <4 x double>* %145, align 8, !alias.scope !78, !noalias !80
  %index.next1245 = add i64 %index1244, 4
  %146 = icmp eq i64 %index.next1245, %n.vec1243
  br i1 %146, label %middle.block1235, label %vector.body1237, !llvm.loop !84

middle.block1235:                                 ; preds = %vector.body1237
  %cmp.n1247 = icmp eq i64 %139, %n.vec1243
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_header379
  ...
  %147 = shl nuw nsw i64 %polly.indvar382, 3
  %scevgep386 = getelementptr i8, i8* %scevgep385, i64 %147
  ...
  br i1 %exitcond1061.not, label %polly.loop_exit381, label %polly.loop_header379, !llvm.loop !85
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1037, i64 -920)
  %148 = add nsw i64 %smin1057, 1000
...
polly.loop_exit397:                               ; preds = %polly.loop_exit404
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next393, 13
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %150 = udiv i64 %polly.indvar398, 10
  %151 = mul nuw nsw i64 %150, 80
  %152 = sub nsw i64 %indvars.iv1044, %151
  %153 = add i64 %indvars.iv1049, %151
  %pexp.p_div_q401.lhs.trunc = trunc i64 %polly.indvar398 to i8
  %pexp.p_div_q401888 = udiv i8 %pexp.p_div_q401.lhs.trunc, 10
  %pexp.p_div_q401.zext = zext i8 %pexp.p_div_q401888 to i64
  %154 = shl nsw i64 %polly.indvar398, 3
  %155 = mul nsw i64 %polly.indvar398, -8
  %polly.access.mul.call1425.us = mul nsw i64 %polly.indvar398, 8000
  %156 = or i64 %154, 1
  %polly.access.mul.call1425.us.1 = mul nuw nsw i64 %156, 1000
  %157 = or i64 %154, 2
  %polly.access.mul.call1425.us.2 = mul nuw nsw i64 %157, 1000
  %158 = or i64 %154, 3
  %polly.access.mul.call1425.us.3 = mul nuw nsw i64 %158, 1000
  %159 = or i64 %154, 4
  %polly.access.mul.call1425.us.4 = mul nuw nsw i64 %159, 1000
  %160 = or i64 %154, 5
  %polly.access.mul.call1425.us.5 = mul nuw nsw i64 %160, 1000
  %161 = or i64 %154, 6
  %polly.access.mul.call1425.us.6 = mul nuw nsw i64 %161, 1000
  %162 = or i64 %154, 7
  %polly.access.mul.call1425.us.7 = mul nuw nsw i64 %162, 1000
  br label %polly.loop_header402

polly.loop_exit404:                               ; preds = %polly.loop_exit445
  %163 = add nuw nsw i64 %polly.indvar398, 1
  %indvars.iv.next1045 = add nuw nsw i64 %indvars.iv1044, 8
  %indvars.iv.next1050 = add nsw i64 %indvars.iv1049, -8
  %exitcond1059.not = icmp eq i64 %163, 150
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit445 ], [ %153, %polly.loop_header395 ]
  %indvars.iv1046 = phi i64 [ %indvars.iv.next1047, %polly.loop_exit445 ], [ %152, %polly.loop_header395 ]
  ...
  %164 = add i64 %smax1048, %indvars.iv1051
  %165 = mul nuw nsw i64 %polly.indvar405, 10
  %.not.not885 = icmp ugt i64 %165, %polly.indvar398
  %166 = mul nuw nsw i64 %polly.indvar405, 80
  %167 = add nsw i64 %166, %155
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %170 = add nsw i64 %167, 79
  %polly.loop_guard432.not = icmp sgt i64 %169, %170
...
polly.loop_header408.us:                          ; preds = %polly.loop_header402, %polly.loop_exit431.us
  ...
  %171 = add nuw nsw i64 %polly.indvar411.us, %149
  %polly.access.mul.Packed_MemRef_call1290.us = mul nuw nsw i64 %polly.indvar411.us, 1200
  %polly.access.add.call1426.us = add nuw nsw i64 %171, %polly.access.mul.call1425.us
  ...
  %polly.access.add.call1426.us.5 = add nuw nsw i64 %171, %polly.access.mul.call1425.us.5
  ...
  %polly.access.add.call1426.us.7 = add nuw nsw i64 %171, %polly.access.mul.call1425.us.7
...
polly.loop_header429.us:                          ; preds = %polly.loop_header408.us, %polly.loop_header429.us
  ...
  %172 = add nuw nsw i64 %polly.indvar433.us, %154
  %polly.access.mul.call1437.us = mul nsw i64 %172, 1000
  %polly.access.add.call1438.us = add nuw nsw i64 %171, %polly.access.mul.call1437.us
  ...
  %polly.loop_cond435.not.not.us = icmp slt i64 %polly.indvar433.us, %170
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_header408.us
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next412.us, %148
...
polly.loop_header408:                             ; preds = %polly.loop_header402.split, %polly.loop_exit431
  ...
  %173 = add nuw nsw i64 %polly.indvar411, %149
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next412, %148
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  %174 = sub nsw i64 %154, %166
  %175 = icmp sgt i64 %174, 0
  %176 = select i1 %175, i64 %174, i64 0
  %polly.loop_guard453 = icmp slt i64 %176, 80
...
polly.loop_header443.us:                          ; preds = %polly.loop_header443.preheader, %polly.loop_exit452.loopexit.us
  ...
  %177 = add nuw nsw i64 %polly.indvar446.us, %149
...
polly.loop_header450.us:                          ; preds = %polly.loop_header443.us, %polly.loop_exit460.us
  %indvars.iv1053 = phi i64 [ %164, %polly.loop_header443.us ], [ %indvars.iv.next1054, %polly.loop_exit460.us ]
  %polly.indvar454.us = phi i64 [ %176, %polly.loop_header443.us ], [ %polly.indvar_next455.us, %polly.loop_exit460.us ]
  %smin1055 = call i64 @llvm.smin.i64(i64 %indvars.iv1053, i64 7)
  %179 = add nsw i64 %polly.indvar454.us, %167
  %polly.loop_guard461.us1124 = icmp sgt i64 %179, -1
...
polly.loop_header458.us:                          ; preds = %polly.loop_header458.preheader.us, %polly.loop_header458.us
  ...
  %180 = add nuw nsw i64 %polly.indvar462.us, %154
  ...
  %scevgep472.us = getelementptr i8, i8* %call2, i64 %182
  ...
  %183 = shl i64 %180, 3
  %184 = add i64 %183, %188
  %scevgep479.us = getelementptr i8, i8* %call, i64 %184
...
polly.loop_header458.preheader.us:                ; preds = %polly.loop_header450.us
  %185 = add nuw nsw i64 %polly.indvar454.us, %166
  %186 = mul i64 %185, 8000
  %187 = add i64 %186, %178
  %scevgep469.us = getelementptr i8, i8* %call2, i64 %187
  ...
  %polly.access.add.Packed_MemRef_call1290476.us = add nsw i64 %179, %polly.access.mul.Packed_MemRef_call1290465.us
...
polly.loop_exit452.loopexit.us:                   ; preds = %polly.loop_exit460.us
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next447.us, %148
...
polly.loop_header429:                             ; preds = %polly.loop_header408, %polly.loop_header429
  ...
  %189 = add nuw nsw i64 %polly.indvar433, %154
  ...
  %polly.loop_cond435.not.not = icmp slt i64 %polly.indvar433, %170
...
polly.loop_header570:                             ; preds = %polly.loop_exit578, %polly.start484
  ...
  %191 = mul nuw nsw i64 %polly.indvar573, 9600
  %scevgep582 = getelementptr i8, i8* %call, i64 %191
  %min.iters.check1214 = icmp ult i64 %190, 4
...
vector.body1213:                                  ; preds = %vector.body1213, %vector.ph1215
  ...
  %192 = shl nuw nsw i64 %index1218, 3
  %193 = getelementptr i8, i8* %scevgep582, i64 %192
  %194 = bitcast i8* %193 to <4 x double>*
  %wide.load1222 = load <4 x double>, <4 x double>* %194, align 8, !alias.scope !88, !noalias !90
  %195 = fmul fast <4 x double> %wide.load1222, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %196 = bitcast i8* %193 to <4 x double>*
  store <4 x double> %195, <4 x double>* %196, align 8, !alias.scope !88, !noalias !90
  %index.next1219 = add i64 %index1218, 4
  %197 = icmp eq i64 %index.next1219, %n.vec1217
  br i1 %197, label %middle.block1211, label %vector.body1213, !llvm.loop !94

middle.block1211:                                 ; preds = %vector.body1213
  %cmp.n1221 = icmp eq i64 %190, %n.vec1217
...
polly.loop_header576:                             ; preds = %polly.loop_header576.preheader, %polly.loop_header576
  ...
  %198 = shl nuw nsw i64 %polly.indvar579, 3
  %scevgep583 = getelementptr i8, i8* %scevgep582, i64 %198
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %smin1083 = call i64 @llvm.smin.i64(i64 %indvars.iv1063, i64 -920)
  %199 = add nsw i64 %smin1083, 1000
  %200 = mul nuw nsw i64 %polly.indvar589, 80
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %polly.indvar595 = phi i64 [ %214, %polly.loop_exit601 ], [ 0, %polly.loop_header586 ]
  %201 = udiv i64 %polly.indvar595, 10
  %202 = mul nuw nsw i64 %201, 80
  %203 = sub nsw i64 %indvars.iv1070, %202
  %204 = add i64 %indvars.iv1075, %202
  %pexp.p_div_q598.lhs.trunc = trunc i64 %polly.indvar595 to i8
  %pexp.p_div_q598887 = udiv i8 %pexp.p_div_q598.lhs.trunc, 10
  %pexp.p_div_q598.zext = zext i8 %pexp.p_div_q598887 to i64
  %205 = shl nsw i64 %polly.indvar595, 3
  %206 = mul nsw i64 %polly.indvar595, -8
  %polly.access.mul.call1622.us = mul nsw i64 %polly.indvar595, 8000
  %207 = or i64 %205, 1
  %polly.access.mul.call1622.us.1 = mul nuw nsw i64 %207, 1000
  %208 = or i64 %205, 2
  %polly.access.mul.call1622.us.2 = mul nuw nsw i64 %208, 1000
  %209 = or i64 %205, 3
  %polly.access.mul.call1622.us.3 = mul nuw nsw i64 %209, 1000
  %210 = or i64 %205, 4
  %polly.access.mul.call1622.us.4 = mul nuw nsw i64 %210, 1000
  %211 = or i64 %205, 5
  %polly.access.mul.call1622.us.5 = mul nuw nsw i64 %211, 1000
  %212 = or i64 %205, 6
  %polly.access.mul.call1622.us.6 = mul nuw nsw i64 %212, 1000
  %213 = or i64 %205, 7
  %polly.access.mul.call1622.us.7 = mul nuw nsw i64 %213, 1000
  br label %polly.loop_header599

polly.loop_exit601:                               ; preds = %polly.loop_exit642
  %214 = add nuw nsw i64 %polly.indvar595, 1
  %indvars.iv.next1071 = add nuw nsw i64 %indvars.iv1070, 8
  %indvars.iv.next1076 = add nsw i64 %indvars.iv1075, -8
  %exitcond1085.not = icmp eq i64 %214, 150
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1077 = phi i64 [ %indvars.iv.next1078, %polly.loop_exit642 ], [ %204, %polly.loop_header592 ]
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit642 ], [ %203, %polly.loop_header592 ]
  ...
  %215 = add i64 %smax1074, %indvars.iv1077
  %216 = mul nuw nsw i64 %polly.indvar602, 10
  %.not.not886 = icmp ugt i64 %216, %polly.indvar595
  %217 = mul nuw nsw i64 %polly.indvar602, 80
  %218 = add nsw i64 %217, %206
  %219 = icmp sgt i64 %218, 0
  %220 = select i1 %219, i64 %218, i64 0
  %221 = add nsw i64 %218, 79
  %polly.loop_guard629.not = icmp sgt i64 %220, %221
...
polly.loop_header605.us:                          ; preds = %polly.loop_header599, %polly.loop_exit628.us
  ...
  %222 = add nuw nsw i64 %polly.indvar608.us, %200
  %polly.access.mul.Packed_MemRef_call1487.us = mul nuw nsw i64 %polly.indvar608.us, 1200
  %polly.access.add.call1623.us = add nuw nsw i64 %222, %polly.access.mul.call1622.us
  ...
  %polly.access.add.call1623.us.1 = add nuw nsw i64 %222, %polly.access.mul.call1622.us.1
  ...
  %polly.access.add.call1623.us.4 = add nuw nsw i64 %222, %polly.access.mul.call1622.us.4
  ...
  %polly.access.add.call1623.us.5 = add nuw nsw i64 %222, %polly.access.mul.call1622.us.5
  ...
  %polly.access.add.call1623.us.7 = add nuw nsw i64 %222, %polly.access.mul.call1622.us.7
...
polly.loop_header626.us:                          ; preds = %polly.loop_header605.us, %polly.loop_header626.us
  %polly.indvar630.us = phi i64 [ %polly.indvar_next631.us, %polly.loop_header626.us ], [ %220, %polly.loop_header605.us ]
  %223 = add nuw nsw i64 %polly.indvar630.us, %205
  %polly.access.mul.call1634.us = mul nsw i64 %223, 1000
  %polly.access.add.call1635.us = add nuw nsw i64 %222, %polly.access.mul.call1634.us
  ...
  %polly.loop_cond632.not.not.us = icmp slt i64 %polly.indvar630.us, %221
...
polly.loop_exit628.us:                            ; preds = %polly.loop_header626.us, %polly.loop_header605.us
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next609.us, %199
...
polly.loop_header605:                             ; preds = %polly.loop_header599.split, %polly.loop_exit628
  ...
  %224 = add nuw nsw i64 %polly.indvar608, %200
...
polly.loop_exit628:                               ; preds = %polly.loop_header626
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next609, %199
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  %225 = sub nsw i64 %205, %217
  %226 = icmp sgt i64 %225, 0
  %227 = select i1 %226, i64 %225, i64 0
  %polly.loop_guard650 = icmp slt i64 %227, 80
...
polly.loop_header640.us:                          ; preds = %polly.loop_header640.preheader, %polly.loop_exit649.loopexit.us
  ...
  %228 = add nuw nsw i64 %polly.indvar643.us, %200
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.us, %polly.loop_exit657.us
  %indvars.iv1079 = phi i64 [ %215, %polly.loop_header640.us ], [ %indvars.iv.next1080, %polly.loop_exit657.us ]
  %polly.indvar651.us = phi i64 [ %227, %polly.loop_header640.us ], [ %polly.indvar_next652.us, %polly.loop_exit657.us ]
  %smin1081 = call i64 @llvm.smin.i64(i64 %indvars.iv1079, i64 7)
  %230 = add nsw i64 %polly.indvar651.us, %218
  %polly.loop_guard658.us1125 = icmp sgt i64 %230, -1
...
polly.loop_header655.us:                          ; preds = %polly.loop_header655.preheader.us, %polly.loop_header655.us
  ...
  %231 = add nuw nsw i64 %polly.indvar659.us, %205
  ...
  %scevgep669.us = getelementptr i8, i8* %call2, i64 %233
  ...
  %234 = shl i64 %231, 3
  %235 = add i64 %234, %239
  %scevgep676.us = getelementptr i8, i8* %call, i64 %235
...
polly.loop_header655.preheader.us:                ; preds = %polly.loop_header647.us
  %236 = add nuw nsw i64 %polly.indvar651.us, %217
  %237 = mul i64 %236, 8000
  %238 = add i64 %237, %229
  %scevgep666.us = getelementptr i8, i8* %call2, i64 %238
  ...
  %polly.access.add.Packed_MemRef_call1487673.us = add nsw i64 %230, %polly.access.mul.Packed_MemRef_call1487662.us
...
polly.loop_exit649.loopexit.us:                   ; preds = %polly.loop_exit657.us
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next644.us, %199
...
polly.loop_header626:                             ; preds = %polly.loop_header605, %polly.loop_header626
  %polly.indvar630 = phi i64 [ %polly.indvar_next631, %polly.loop_header626 ], [ %220, %polly.loop_header605 ]
  %240 = add nuw nsw i64 %polly.indvar630, %205
  %polly.access.mul.call1634 = mul nsw i64 %240, 1000
  %polly.access.add.call1635 = add nuw nsw i64 %224, %polly.access.mul.call1634
  ...
  %polly.loop_cond632.not.not = icmp slt i64 %polly.indvar630, %221
...
polly.loop_header805:                             ; preds = %entry, %polly.loop_exit813
  ...
  %241 = shl nsw i64 %polly.indvar808, 5
  %242 = add nsw i64 %smin1115, 1199
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %243 = mul nsw i64 %polly.indvar814, -32
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %247 = add nuw nsw i64 %polly.indvar820, %241
...
vector.ph1153:                                    ; preds = %polly.loop_header817
  %broadcast.splatinsert1160 = insertelement <4 x i64> poison, i64 %245, i32 0
  %broadcast.splat1161 = shufflevector <4 x i64> %broadcast.splatinsert1160, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1162 = insertelement <4 x i32> poison, i32 %248, i32 0
...
vector.body1152:                                  ; preds = %vector.body1152, %vector.ph1153
  ...
  %250 = add nuw nsw <4 x i64> %vec.ind1158, %broadcast.splat1161
  %251 = trunc <4 x i64> %250 to <4 x i32>
  %252 = mul <4 x i32> %broadcast.splat1163, %251
  ...
  store <4 x double> %256, <4 x double>* %261, align 8, !alias.scope !98, !noalias !100
  %index.next1155 = add i64 %index1154, 4
  %vec.ind.next1159 = add <4 x i64> %vec.ind1158, <i64 4, i64 4, i64 4, i64 4>
  %262 = icmp eq i64 %index.next1155, %244
  br i1 %262, label %polly.loop_exit825, label %vector.body1152, !llvm.loop !103

polly.loop_exit825:                               ; preds = %vector.body1152, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond1116.not = icmp eq i64 %polly.indvar820, %242
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %263 = add nuw nsw i64 %polly.indvar826, %245
  ...
  %scevgep829 = getelementptr i8, i8* %call, i64 %269
  ...
  %exitcond1112.not = icmp eq i64 %polly.indvar826, %246
...
polly.loop_header832:                             ; preds = %polly.loop_exit813, %polly.loop_exit840
  ...
  %270 = shl nsw i64 %polly.indvar835, 5
  %271 = add nsw i64 %smin1105, 1199
...
polly.loop_header838:                             ; preds = %polly.loop_exit846, %polly.loop_header832
  ...
  %272 = mul nsw i64 %polly.indvar841, -32
  %smin1167 = call i64 @llvm.smin.i64(i64 %272, i64 -968)
  %273 = add nsw i64 %smin1167, 1000
  %smin1101 = call i64 @llvm.smin.i64(i64 %indvars.iv1099, i64 -968)
  %274 = shl nsw i64 %polly.indvar841, 5
  %275 = add nsw i64 %smin1101, 999
...
vector.body1166:                                  ; preds = %vector.body1166, %vector.ph1169
  ...
  %279 = add nuw nsw <4 x i64> %vec.ind1176, %broadcast.splat1179
  %280 = trunc <4 x i64> %279 to <4 x i32>
  %281 = mul <4 x i32> %broadcast.splat1181, %280
  ...
  store <4 x double> %285, <4 x double>* %290, align 8, !alias.scope !102, !noalias !105
  %index.next1173 = add i64 %index1172, 4
  %vec.ind.next1177 = add <4 x i64> %vec.ind1176, <i64 4, i64 4, i64 4, i64 4>
  %291 = icmp eq i64 %index.next1173, %273
  br i1 %291, label %polly.loop_exit852, label %vector.body1166, !llvm.loop !106

polly.loop_exit852:                               ; preds = %vector.body1166, %polly.loop_header850
  %polly.indvar_next848 = add nuw nsw i64 %polly.indvar847, 1
  %exitcond1106.not = icmp eq i64 %polly.indvar847, %271
...
polly.loop_header850:                             ; preds = %polly.loop_header844, %polly.loop_header850
  ...
  %292 = add nuw nsw i64 %polly.indvar853, %274
  ...
  %scevgep856 = getelementptr i8, i8* %call2, i64 %298
  ...
  %exitcond1102.not = icmp eq i64 %polly.indvar853, %275
...
polly.loop_header858:                             ; preds = %polly.loop_exit840, %polly.loop_exit866
  ...
  %299 = shl nsw i64 %polly.indvar861, 5
  %300 = add nsw i64 %smin1095, 1199
...
polly.loop_header864:                             ; preds = %polly.loop_exit872, %polly.loop_header858
  ...
  %301 = mul nsw i64 %polly.indvar867, -32
  %smin1185 = call i64 @llvm.smin.i64(i64 %301, i64 -968)
  %302 = add nsw i64 %smin1185, 1000
  %smin1091 = call i64 @llvm.smin.i64(i64 %indvars.iv1089, i64 -968)
  %303 = shl nsw i64 %polly.indvar867, 5
  %304 = add nsw i64 %smin1091, 999
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1187
  ...
  %308 = add nuw nsw <4 x i64> %vec.ind1194, %broadcast.splat1197
  %309 = trunc <4 x i64> %308 to <4 x i32>
  %310 = mul <4 x i32> %broadcast.splat1199, %309
  ...
  store <4 x double> %314, <4 x double>* %319, align 8, !alias.scope !101, !noalias !108
  %index.next1191 = add i64 %index1190, 4
  %vec.ind.next1195 = add <4 x i64> %vec.ind1194, <i64 4, i64 4, i64 4, i64 4>
  %320 = icmp eq i64 %index.next1191, %302
  br i1 %320, label %polly.loop_exit878, label %vector.body1184, !llvm.loop !109

polly.loop_exit878:                               ; preds = %vector.body1184, %polly.loop_header876
  %polly.indvar_next874 = add nuw nsw i64 %polly.indvar873, 1
  %exitcond1096.not = icmp eq i64 %polly.indvar873, %300
...
polly.loop_header876:                             ; preds = %polly.loop_header870, %polly.loop_header876
  ...
  %321 = add nuw nsw i64 %polly.indvar879, %303
  ...
  %scevgep883 = getelementptr i8, i8* %call1, i64 %327
  ...
  %exitcond1092.not = icmp eq i64 %polly.indvar879, %304
