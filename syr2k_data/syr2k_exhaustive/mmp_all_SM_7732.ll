; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7732.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7732.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %105 = shl nsw i64 %polly.indvar230, 8
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar230, %97
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249941 = icmp sgt i64 %111, -1
...
vector.body1050:                                  ; preds = %vector.body1050, %vector.ph1054
  ...
  %125 = shl nuw nsw i64 %index1057, 3
  %126 = getelementptr i8, i8* %scevgep370, i64 %125
  %127 = bitcast i8* %126 to <4 x double>*
  %wide.load1061 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !74, !noalias !76
  %128 = fmul fast <4 x double> %wide.load1061, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %130 = icmp eq i64 %index.next1058, %n.vec1056
  br i1 %130, label %middle.block1048, label %vector.body1050, !llvm.loop !80

middle.block1048:                                 ; preds = %vector.body1050
  %cmp.n1060 = icmp eq i64 %123, %n.vec1056
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %132 = lshr i64 %indvars.iv875, 3
  %133 = mul nsw i64 %polly.indvar393, -96
  %134 = icmp slt i64 %133, -1104
  %135 = select i1 %134, i64 %133, i64 -1104
  %136 = add nsw i64 %135, 1199
  %137 = mul nuw nsw i64 %polly.indvar393, 96
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %140 = shl nsw i64 %polly.indvar406, 8
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %indvars.iv.next866 = add nsw i64 %indvars.iv865, -256
  %exitcond877.not = icmp eq i64 %polly.indvar406, %132
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  ...
  %smin869 = call i64 @llvm.smin.i64(i64 %indvars.iv867, i64 255)
  %146 = add nsw i64 %polly.indvar414, %145
  %polly.loop_guard427942 = icmp sgt i64 %146, -1
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1027 = icmp ult i64 %158, 4
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1028
  ...
  %160 = shl nuw nsw i64 %index1031, 3
  %161 = getelementptr i8, i8* %scevgep548, i64 %160
  %162 = bitcast i8* %161 to <4 x double>*
  %wide.load1035 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !84, !noalias !86
  %163 = fmul fast <4 x double> %wide.load1035, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %165 = icmp eq i64 %index.next1032, %n.vec1030
  br i1 %165, label %middle.block1024, label %vector.body1026, !llvm.loop !90

middle.block1024:                                 ; preds = %vector.body1026
  %cmp.n1034 = icmp eq i64 %158, %n.vec1030
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %167 = lshr i64 %indvars.iv901, 3
  %168 = mul nsw i64 %polly.indvar571, -96
  %169 = icmp slt i64 %168, -1104
  %170 = select i1 %169, i64 %168, i64 -1104
  %171 = add nsw i64 %170, 1199
  %172 = mul nuw nsw i64 %polly.indvar571, 96
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %175 = shl nsw i64 %polly.indvar584, 8
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar584, %167
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv893 = phi i64 [ %179, %polly.loop_header588.preheader ], [ %indvars.iv.next894, %polly.loop_exit597 ]
  %polly.indvar592 = phi i64 [ %178, %polly.loop_header588.preheader ], [ %polly.indvar_next593, %polly.loop_exit597 ]
  %smin895 = call i64 @llvm.smin.i64(i64 %indvars.iv893, i64 255)
  %181 = add nsw i64 %polly.indvar592, %180
  %polly.loop_guard605943 = icmp sgt i64 %181, -1
...
polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar598.us, %174
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin965 = call i64 @llvm.smin.i64(i64 %195, i64 -1168)
  %196 = add nsw i64 %smin965, 1200
  %smin932 = call i64 @llvm.smin.i64(i64 %indvars.iv930, i64 -1168)
  %197 = shl nsw i64 %polly.indvar761, 5
  %198 = add nsw i64 %smin932, 1199
...
vector.ph966:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert973 = insertelement <4 x i64> poison, i64 %197, i32 0
  %broadcast.splat974 = shufflevector <4 x i64> %broadcast.splatinsert973, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert975 = insertelement <4 x i32> poison, i32 %200, i32 0
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph966
  ...
  %202 = add nuw nsw <4 x i64> %vec.ind971, %broadcast.splat974
  %203 = trunc <4 x i64> %202 to <4 x i32>
  %204 = mul <4 x i32> %broadcast.splat976, %203
  ...
  %214 = icmp eq i64 %index.next968, %196
  br i1 %214, label %polly.loop_exit772, label %vector.body964, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body964, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond937.not = icmp eq i64 %polly.indvar767, %194
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond933.not = icmp eq i64 %polly.indvar773, %198
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin980 = call i64 @llvm.smin.i64(i64 %224, i64 -968)
  %225 = add nsw i64 %smin980, 1000
  %smin922 = call i64 @llvm.smin.i64(i64 %indvars.iv920, i64 -968)
  %226 = shl nsw i64 %polly.indvar788, 5
  %227 = add nsw i64 %smin922, 999
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph982
  ...
  %231 = add nuw nsw <4 x i64> %vec.ind989, %broadcast.splat992
  %232 = trunc <4 x i64> %231 to <4 x i32>
  %233 = mul <4 x i32> %broadcast.splat994, %232
  ...
  %243 = icmp eq i64 %index.next986, %225
  br i1 %243, label %polly.loop_exit799, label %vector.body979, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body979, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond927.not = icmp eq i64 %polly.indvar794, %223
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond923.not = icmp eq i64 %polly.indvar800, %227
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin998 = call i64 @llvm.smin.i64(i64 %253, i64 -968)
  %254 = add nsw i64 %smin998, 1000
  %smin912 = call i64 @llvm.smin.i64(i64 %indvars.iv910, i64 -968)
  %255 = shl nsw i64 %polly.indvar814, 5
  %256 = add nsw i64 %smin912, 999
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph1000
  ...
  %260 = add nuw nsw <4 x i64> %vec.ind1007, %broadcast.splat1010
  %261 = trunc <4 x i64> %260 to <4 x i32>
  %262 = mul <4 x i32> %broadcast.splat1012, %261
  ...
  %272 = icmp eq i64 %index.next1004, %254
  br i1 %272, label %polly.loop_exit825, label %vector.body997, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body997, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond917.not = icmp eq i64 %polly.indvar820, %252
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond913.not = icmp eq i64 %polly.indvar826, %256
