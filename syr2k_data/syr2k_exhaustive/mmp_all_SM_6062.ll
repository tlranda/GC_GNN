; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6062.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6062.c"
...
vector.body1057:                                  ; preds = %vector.body1057, %vector.ph1061
  ...
  %wide.load1068 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %139, label %middle.block1055, label %vector.body1057, !llvm.loop !84
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %149 = lshr i64 %polly.indvar383, 3
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1035
  ...
  %wide.load1042 = load <4 x double>, <4 x double>* %180, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %183, label %middle.block1031, label %vector.body1033, !llvm.loop !94
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %193 = lshr i64 %polly.indvar561, 3
  %194 = shl nuw nsw i64 %193, 6
...
vector.body971:                                   ; preds = %vector.body971, %vector.ph973
  ...
  br i1 %241, label %polly.loop_exit772, label %vector.body971, !llvm.loop !103
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph989
  ...
  br i1 %270, label %polly.loop_exit799, label %vector.body986, !llvm.loop !106
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1007
  ...
  br i1 %299, label %polly.loop_exit825, label %vector.body1004, !llvm.loop !109
