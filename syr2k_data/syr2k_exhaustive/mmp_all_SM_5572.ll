; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5572.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5572.c"
...
polly.loop_header239:                             ; preds = %polly.loop_exit247, %polly.loop_header227
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 63)
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %135 = shl nsw i64 %polly.indvar381, 6
...
polly.loop_header412:                             ; preds = %polly.loop_exit420, %polly.loop_header400
  ...
  %smin859 = call i64 @llvm.smin.i64(i64 %indvars.iv857, i64 63)
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %165 = shl nsw i64 %polly.indvar554, 6
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  %268 = mul nsw i64 %polly.indvar208, -64
  %269 = shl nsw i64 %polly.indvar208, 2
...
polly.loop_header239.1:                           ; preds = %polly.loop_exit247, %polly.loop_exit247.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv841.1, i64 63)
...
polly.loop_header239.2:                           ; preds = %polly.loop_exit247.1, %polly.loop_exit247.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv841.2, i64 63)
...
polly.loop_header239.3:                           ; preds = %polly.loop_exit247.2, %polly.loop_exit247.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv841.3, i64 63)
...
polly.loop_exit392.3:                             ; preds = %polly.loop_header390.3
  %303 = mul nsw i64 %polly.indvar381, -64
  %304 = shl nsw i64 %polly.indvar381, 2
...
polly.loop_header412.1:                           ; preds = %polly.loop_exit420, %polly.loop_exit420.1
  ...
  %smin859.1 = call i64 @llvm.smin.i64(i64 %indvars.iv857.1, i64 63)
...
polly.loop_header412.2:                           ; preds = %polly.loop_exit420.1, %polly.loop_exit420.2
  ...
  %smin859.2 = call i64 @llvm.smin.i64(i64 %indvars.iv857.2, i64 63)
...
polly.loop_header412.3:                           ; preds = %polly.loop_exit420.2, %polly.loop_exit420.3
  ...
  %smin859.3 = call i64 @llvm.smin.i64(i64 %indvars.iv857.3, i64 63)
...
polly.loop_exit565.3:                             ; preds = %polly.loop_header563.3
  %338 = mul nsw i64 %polly.indvar554, -64
  %339 = shl nsw i64 %polly.indvar554, 2
...
polly.loop_header585.1:                           ; preds = %polly.loop_exit593, %polly.loop_exit593.1
  ...
  %smin876.1 = call i64 @llvm.smin.i64(i64 %indvars.iv874.1, i64 63)
...
polly.loop_header585.2:                           ; preds = %polly.loop_exit593.1, %polly.loop_exit593.2
  ...
  %smin876.2 = call i64 @llvm.smin.i64(i64 %indvars.iv874.2, i64 63)
...
polly.loop_header585.3:                           ; preds = %polly.loop_exit593.2, %polly.loop_exit593.3
  ...
  %smin876.3 = call i64 @llvm.smin.i64(i64 %indvars.iv874.3, i64 63)
