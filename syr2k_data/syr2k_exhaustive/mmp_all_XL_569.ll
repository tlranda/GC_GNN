; ModuleID = 'syr2k_exhaustive/mmp_all_XL_569.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_569.c"
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %indvars.iv.next1097 = add nuw nsw i64 %indvars.iv1096, 100
  %indvars.iv.next1099 = add nuw nsw i64 %indvars.iv1098, 3
...
polly.loop_header272:                             ; preds = %polly.loop_header265, %polly.loop_exit282
  ...
  %smin1430 = call i64 @llvm.smin.i64(i64 %146, i64 99)
  %147 = add nsw i64 %smin1430, 1
  %smin1108 = call i64 @llvm.smin.i64(i64 %indvars.iv1106, i64 99)
...
vector.body1424:                                  ; preds = %vector.body1424, %vector.ph1432
  ...
  %wide.load1445 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %167, label %middle.block1422, label %vector.body1424, !llvm.loop !84
...
vector.body1360:                                  ; preds = %vector.body1360, %vector.ph1364
  ...
  %wide.load1371 = load <4 x double>, <4 x double>* %175, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %178, label %middle.block1358, label %vector.body1360, !llvm.loop !93
...
polly.loop_exit420:                               ; preds = %polly.loop_exit443
  ...
  %exitcond1146.not = icmp eq i64 %polly.indvar_next416, 13
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %182 = mul nuw nsw i64 %polly.indvar421, 100
  %183 = mul nuw nsw i64 %polly.indvar421, 3
  %184 = lshr i64 %polly.indvar421, 3
  %185 = add nuw i64 %183, %184
  %186 = shl nuw nsw i64 %185, 5
  %187 = sub i64 %182, %186
  %188 = mul nsw i64 %polly.indvar421, -100
  %189 = add i64 %188, %186
  %190 = lshr i64 %polly.indvar421, 3
  %191 = add nuw i64 %indvars.iv1130, %190
  %192 = shl nuw nsw i64 %191, 5
  %193 = sub i64 %indvars.iv1128, %192
  %194 = add i64 %indvars.iv1135, %192
  %195 = mul nsw i64 %polly.indvar421, -100
  %196 = mul nuw nsw i64 %polly.indvar421, 100
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %197 = add nsw i64 %195, 1199
  %198 = mul nuw nsw i64 %polly.indvar421, 3
...
polly.loop_exit443:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1129 = add nuw nsw i64 %indvars.iv1128, 100
  %indvars.iv.next1131 = add nuw nsw i64 %indvars.iv1130, 3
  %indvars.iv.next1136 = add nsw i64 %indvars.iv1135, -100
  %exitcond1145.not = icmp eq i64 %polly.indvar_next422, 12
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit426
  ...
  %.inv942 = icmp sgt i64 %209, 99
  %211 = select i1 %.inv942, i64 99, i64 %210
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %smin1380 = call i64 @llvm.smin.i64(i64 %229, i64 99)
  %230 = add nsw i64 %smin1380, 1
  %smin1141 = call i64 @llvm.smin.i64(i64 %indvars.iv1139, i64 99)
...
vector.body1374:                                  ; preds = %vector.body1374, %vector.ph1382
  ...
  %wide.load1395 = load <4 x double>, <4 x double>* %245, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %250, label %middle.block1372, label %vector.body1374, !llvm.loop !97
...
vector.body1312:                                  ; preds = %vector.body1312, %vector.ph1314
  ...
  %wide.load1321 = load <4 x double>, <4 x double>* %258, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %261, label %middle.block1310, label %vector.body1312, !llvm.loop !106
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %264 = mul nuw nsw i64 %polly.indvar630, 80
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %indvars.iv.next1153 = add nsw i64 %indvars.iv1152, -80
  %exitcond1179.not = icmp eq i64 %polly.indvar_next631, 13
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %265 = mul nuw nsw i64 %polly.indvar636, 100
  %266 = mul nuw nsw i64 %polly.indvar636, 3
  %267 = lshr i64 %polly.indvar636, 3
  %268 = add nuw i64 %266, %267
  %269 = shl nuw nsw i64 %268, 5
  %270 = sub i64 %265, %269
  %271 = mul nsw i64 %polly.indvar636, -100
  %272 = add i64 %271, %269
  ...
  %278 = mul nsw i64 %polly.indvar636, -100
  %279 = mul nuw nsw i64 %polly.indvar636, 100
  br label %polly.loop_header639

polly.loop_exit641:                               ; preds = %polly.loop_exit647
  %280 = add nsw i64 %278, 1199
  %281 = mul nuw nsw i64 %polly.indvar636, 3
...
polly.loop_exit658:                               ; preds = %polly.loop_exit697
  ...
  %indvars.iv.next1162 = add nuw nsw i64 %indvars.iv1161, 100
  %indvars.iv.next1164 = add nuw nsw i64 %indvars.iv1163, 3
  %indvars.iv.next1169 = add nsw i64 %indvars.iv1168, -100
  %exitcond1178.not = icmp eq i64 %polly.indvar_next637, 12
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit641
  ...
  %.inv943 = icmp sgt i64 %292, 99
  %294 = select i1 %.inv943, i64 99, i64 %293
...
polly.loop_header702:                             ; preds = %polly.loop_header695, %polly.loop_exit712
  ...
  %smin1330 = call i64 @llvm.smin.i64(i64 %312, i64 99)
  %313 = add nsw i64 %smin1330, 1
  %smin1174 = call i64 @llvm.smin.i64(i64 %indvars.iv1172, i64 99)
...
vector.body1324:                                  ; preds = %vector.body1324, %vector.ph1332
  ...
  %wide.load1345 = load <4 x double>, <4 x double>* %328, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %333, label %middle.block1322, label %vector.body1324, !llvm.loop !110
...
vector.body1251:                                  ; preds = %vector.body1251, %vector.ph1252
  ...
  br i1 %358, label %polly.loop_exit882, label %vector.body1251, !llvm.loop !117
...
vector.body1265:                                  ; preds = %vector.body1265, %vector.ph1268
  ...
  br i1 %387, label %polly.loop_exit909, label %vector.body1265, !llvm.loop !120
...
vector.body1283:                                  ; preds = %vector.body1283, %vector.ph1286
  ...
  br i1 %416, label %polly.loop_exit935, label %vector.body1283, !llvm.loop !123
