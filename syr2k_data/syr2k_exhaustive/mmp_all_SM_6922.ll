; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6922.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6922.c"
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1051
  ...
  %wide.load1058 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %128, label %middle.block1045, label %vector.body1047, !llvm.loop !79
...
vector.body1023:                                  ; preds = %vector.body1023, %vector.ph1025
  ...
  %wide.load1032 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %161, label %middle.block1021, label %vector.body1023, !llvm.loop !89
...
vector.body961:                                   ; preds = %vector.body961, %vector.ph963
  ...
  br i1 %208, label %polly.loop_exit778, label %vector.body961, !llvm.loop !98
...
vector.body976:                                   ; preds = %vector.body976, %vector.ph979
  ...
  br i1 %237, label %polly.loop_exit805, label %vector.body976, !llvm.loop !101
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph997
  ...
  br i1 %266, label %polly.loop_exit831, label %vector.body994, !llvm.loop !104
