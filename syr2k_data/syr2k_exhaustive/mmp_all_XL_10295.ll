; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10295.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10295.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %118 = shl nsw i64 %polly.indvar214, 3
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %139, align 8, !alias.scope !68, !noalias !70
  ...
  store <4 x double> %140, <4 x double>* %141, align 8, !alias.scope !68, !noalias !70
  %index.next1000 = add i64 %index999, 4
  %142 = icmp eq i64 %index.next1000, %n.vec998
  br i1 %142, label %middle.block990, label %vector.body992, !llvm.loop !73
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %149 = add nuw nsw i64 %umin815, 11
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %165 = shl nsw i64 %polly.indvar369, 3
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %wide.load977 = load <4 x double>, <4 x double>* %186, align 8, !alias.scope !77, !noalias !79
  ...
  store <4 x double> %187, <4 x double>* %188, align 8, !alias.scope !77, !noalias !79
  %index.next974 = add i64 %index973, 4
  %189 = icmp eq i64 %index.next974, %n.vec972
  br i1 %189, label %middle.block966, label %vector.body968, !llvm.loop !82
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %196 = add nuw nsw i64 %umin837, 11
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %212 = shl nsw i64 %polly.indvar526, 3
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  store <4 x double> %244, <4 x double>* %249, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %250, label %polly.loop_exit712, label %vector.body906, !llvm.loop !91
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  store <4 x double> %273, <4 x double>* %278, align 8, !alias.scope !90, !noalias !93
  ...
  br i1 %279, label %polly.loop_exit739, label %vector.body921, !llvm.loop !94
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  store <4 x double> %302, <4 x double>* %307, align 8, !alias.scope !89, !noalias !96
  ...
  br i1 %308, label %polly.loop_exit765, label %vector.body939, !llvm.loop !97
