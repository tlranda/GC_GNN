; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3317.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3317.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1025 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -968)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next203, 32
...
vector.body1235:                                  ; preds = %vector.body1235, %vector.ph1239
  ...
  %wide.load1246 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %143, label %middle.block1233, label %vector.body1235, !llvm.loop !85
...
polly.loop_header391:                             ; preds = %polly.loop_header391.preheader, %polly.loop_exit399
  ...
  %smin1053 = call i64 @llvm.smin.i64(i64 %indvars.iv1031, i64 -968)
...
polly.loop_exit399:                               ; preds = %polly.loop_exit406
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next395, 32
...
vector.body1211:                                  ; preds = %vector.body1211, %vector.ph1213
  ...
  %wide.load1220 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %191, label %middle.block1209, label %vector.body1211, !llvm.loop !95
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %smin1081 = call i64 @llvm.smin.i64(i64 %indvars.iv1059, i64 -968)
...
vector.body1150:                                  ; preds = %vector.body1150, %vector.ph1151
  ...
  br i1 %253, label %polly.loop_exit823, label %vector.body1150, !llvm.loop !104
...
vector.body1164:                                  ; preds = %vector.body1164, %vector.ph1167
  ...
  br i1 %282, label %polly.loop_exit850, label %vector.body1164, !llvm.loop !107
...
vector.body1182:                                  ; preds = %vector.body1182, %vector.ph1185
  ...
  br i1 %311, label %polly.loop_exit876, label %vector.body1182, !llvm.loop !110
