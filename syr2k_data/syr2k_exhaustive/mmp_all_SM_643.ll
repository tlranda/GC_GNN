; ModuleID = 'syr2k_exhaustive/mmp_all_SM_643.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_643.c"
...
vector.body1175:                                  ; preds = %vector.body1175, %vector.ph1177
  ...
  br i1 %57, label %middle.block1173, label %vector.body1175, !llvm.loop !63
...
vector.body1222:                                  ; preds = %vector.body1222, %vector.ph1224
  ...
  br i1 %68, label %middle.block1220, label %vector.body1222, !llvm.loop !65
...
vector.body1234:                                  ; preds = %vector.body1234, %vector.ph1238
  ...
  %wide.load1245 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1232, label %vector.body1234, !llvm.loop !78
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  ...
  %exitcond974.not = icmp eq i64 %polly.indvar_next210, 24
...
polly.loop_header228.preheader:                   ; preds = %polly.loop_exit220
  %100 = mul nsw i64 %polly.indvar209, -50
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit265
  ...
  %102 = mul nuw nsw i64 %indvar1249, 50
  %103 = mul nuw nsw i64 %polly.indvar231, 50
  %104 = add nsw i64 %103, %100
  %105 = icmp ugt i64 %104, 50
  %106 = select i1 %105, i64 %104, i64 50
  %107 = add nuw nsw i64 %104, 49
...
polly.loop_header240.us:                          ; preds = %polly.loop_header240.us, %polly.loop_header234.us
  ...
  %exitcond964.not = icmp eq i64 %polly.indvar_next244.us, 50
...
polly.loop_exit265:                               ; preds = %polly.loop_exit271
  ...
  %exitcond973.not = icmp eq i64 %polly.indvar_next232, 24
...
polly.loop_header240:                             ; preds = %polly.loop_header240, %polly.loop_header234
  ...
  %exitcond962.not = icmp eq i64 %polly.indvar_next244, 50
...
polly.loop_header269:                             ; preds = %polly.loop_exit277, %polly.loop_header263
  ...
  %smin1251 = call i64 @llvm.smin.i64(i64 %113, i64 49)
  %114 = add nuw nsw i64 %smin1251, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv968, i64 49)
...
vector.body1248:                                  ; preds = %vector.body1248, %vector.ph1253
  ...
  %wide.load1266 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %134, label %middle.block1246, label %vector.body1248, !llvm.loop !83
...
polly.loop_exit277:                               ; preds = %polly.loop_header275, %middle.block1246
  ...
  %exitcond971.not = icmp eq i64 %polly.indvar_next273, 50
...
polly.loop_header275:                             ; preds = %polly.loop_header275.preheader, %polly.loop_header275
  ...
  br i1 %exitcond970.not, label %polly.loop_exit277, label %polly.loop_header275, !llvm.loop !84
...
vector.body1187:                                  ; preds = %vector.body1187, %vector.ph1191
  ...
  %wide.load1198 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %143, <4 x double>* %144, align 8, !alias.scope !85, !noalias !87
  %index.next1195 = add i64 %index1194, 4
  %145 = icmp eq i64 %index.next1195, %n.vec1193
  br i1 %145, label %middle.block1185, label %vector.body1187, !llvm.loop !92
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_header396
  ...
  br i1 %exitcond997.not, label %polly.loop_exit398, label %polly.loop_header396, !llvm.loop !93
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %147 = mul nuw nsw i64 %polly.indvar409, 20
...
polly.loop_header434.preheader:                   ; preds = %polly.loop_exit426
  %150 = mul nsw i64 %polly.indvar415, -50
...
polly.loop_header434:                             ; preds = %polly.loop_header434.preheader, %polly.loop_exit473
  ...
  %152 = mul nuw nsw i64 %indvar1202, 50
  %153 = mul nuw nsw i64 %polly.indvar437, 50
  %154 = add nsw i64 %153, %150
  %155 = icmp ugt i64 %154, 50
  %156 = select i1 %155, i64 %154, i64 50
  %157 = add nuw nsw i64 %154, 49
...
polly.loop_header446.us:                          ; preds = %polly.loop_header446.us, %polly.loop_header440.us
  ...
  %exitcond984.not = icmp eq i64 %polly.indvar_next450.us, 50
...
polly.loop_exit473:                               ; preds = %polly.loop_exit479
  ...
  %exitcond994.not = icmp eq i64 %polly.indvar_next438, 24
...
polly.loop_header446:                             ; preds = %polly.loop_header446, %polly.loop_header440
  ...
  %exitcond982.not = icmp eq i64 %polly.indvar_next450, 50
...
polly.loop_header477:                             ; preds = %polly.loop_exit485, %polly.loop_header471
  ...
  %smin1204 = call i64 @llvm.smin.i64(i64 %163, i64 49)
  %164 = add nuw nsw i64 %smin1204, 1
  %smin990 = call i64 @llvm.smin.i64(i64 %indvars.iv988, i64 49)
...
vector.body1201:                                  ; preds = %vector.body1201, %vector.ph1206
  ...
  %wide.load1219 = load <4 x double>, <4 x double>* %179, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %182, <4 x double>* %183, align 8, !alias.scope !85, !noalias !87
  %index.next1210 = add i64 %index1209, 4
  %184 = icmp eq i64 %index.next1210, %n.vec1208
  br i1 %184, label %middle.block1199, label %vector.body1201, !llvm.loop !96
...
polly.loop_exit485:                               ; preds = %polly.loop_header483, %middle.block1199
  ...
  %exitcond992.not = icmp eq i64 %polly.indvar_next481, 50
...
polly.loop_header483:                             ; preds = %polly.loop_header483.preheader, %polly.loop_header483
  ...
  br i1 %exitcond991.not, label %polly.loop_exit485, label %polly.loop_header483, !llvm.loop !97

polly.start510:                                   ; preds = %init_array.exit
  %malloccall512 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
  %malloccall514 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body1142:                                  ; preds = %vector.body1142, %vector.ph1144
  ...
  %wide.load1151 = load <4 x double>, <4 x double>* %192, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %193, <4 x double>* %194, align 8, !alias.scope !98, !noalias !100
  %index.next1148 = add i64 %index1147, 4
  %195 = icmp eq i64 %index.next1148, %n.vec1146
  br i1 %195, label %middle.block1140, label %vector.body1142, !llvm.loop !105
...
polly.loop_header604:                             ; preds = %polly.loop_header604.preheader, %polly.loop_header604
  ...
  br i1 %exitcond1018.not, label %polly.loop_exit606, label %polly.loop_header604, !llvm.loop !106
...
polly.loop_header614:                             ; preds = %polly.loop_header614.preheader, %polly.loop_exit622
  ...
  %197 = mul nuw nsw i64 %polly.indvar617, 20
...
polly.loop_header620:                             ; preds = %polly.loop_exit644, %polly.loop_header614
  ...
  %198 = mul nuw nsw i64 %polly.indvar623, 50
...
polly.loop_exit644:                               ; preds = %polly.loop_exit681
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar_next624, 24
...
polly.loop_header642.preheader:                   ; preds = %polly.loop_exit634
  %200 = mul nsw i64 %polly.indvar623, -50
...
polly.loop_header642:                             ; preds = %polly.loop_header642.preheader, %polly.loop_exit681
  ...
  %202 = mul nuw nsw i64 %indvar1155, 50
  %203 = mul nuw nsw i64 %polly.indvar645, 50
  %204 = add nsw i64 %203, %200
  %205 = icmp ugt i64 %204, 50
  %206 = select i1 %205, i64 %204, i64 50
  %207 = add nuw nsw i64 %204, 49
...
polly.loop_header654.us:                          ; preds = %polly.loop_header654.us, %polly.loop_header648.us
  ...
  %exitcond1005.not = icmp eq i64 %polly.indvar_next658.us, 50
...
polly.loop_exit681:                               ; preds = %polly.loop_exit687
  ...
  %indvars.iv.next1008 = add nuw nsw i64 %indvars.iv1007, 50
  %exitcond1015.not = icmp eq i64 %polly.indvar_next646, 24
...
polly.loop_header654:                             ; preds = %polly.loop_header654, %polly.loop_header648
  ...
  %exitcond1003.not = icmp eq i64 %polly.indvar_next658, 50
...
polly.loop_header685:                             ; preds = %polly.loop_exit693, %polly.loop_header679
  ...
  %smin1157 = call i64 @llvm.smin.i64(i64 %213, i64 49)
  %214 = add nuw nsw i64 %smin1157, 1
  %smin1011 = call i64 @llvm.smin.i64(i64 %indvars.iv1009, i64 49)
...
vector.body1154:                                  ; preds = %vector.body1154, %vector.ph1159
  ...
  %wide.load1172 = load <4 x double>, <4 x double>* %229, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %232, <4 x double>* %233, align 8, !alias.scope !98, !noalias !100
  %index.next1163 = add i64 %index1162, 4
  %234 = icmp eq i64 %index.next1163, %n.vec1161
  br i1 %234, label %middle.block1152, label %vector.body1154, !llvm.loop !109
...
polly.loop_header691:                             ; preds = %polly.loop_header691.preheader, %polly.loop_header691
  ...
  br i1 %exitcond1012.not, label %polly.loop_exit693, label %polly.loop_header691, !llvm.loop !110
...
vector.body1080:                                  ; preds = %vector.body1080, %vector.ph1082
  ...
  store <4 x double> %253, <4 x double>* %258, align 8, !alias.scope !111, !noalias !113
  ...
  br i1 %259, label %polly.loop_exit862, label %vector.body1080, !llvm.loop !116
...
polly.loop_header860:                             ; preds = %polly.loop_header854, %polly.loop_header860
  ...
  br i1 %exitcond1043.not, label %polly.loop_exit862, label %polly.loop_header860, !llvm.loop !117
...
vector.body1095:                                  ; preds = %vector.body1095, %vector.ph1098
  ...
  store <4 x double> %282, <4 x double>* %287, align 8, !alias.scope !115, !noalias !118
  ...
  br i1 %288, label %polly.loop_exit889, label %vector.body1095, !llvm.loop !119
...
polly.loop_header887:                             ; preds = %polly.loop_header881, %polly.loop_header887
  ...
  br i1 %exitcond1033.not, label %polly.loop_exit889, label %polly.loop_header887, !llvm.loop !120
...
vector.body1113:                                  ; preds = %vector.body1113, %vector.ph1116
  ...
  store <4 x double> %311, <4 x double>* %316, align 8, !alias.scope !114, !noalias !121
  ...
  br i1 %317, label %polly.loop_exit915, label %vector.body1113, !llvm.loop !122
...
polly.loop_header913:                             ; preds = %polly.loop_header907, %polly.loop_header913
  ...
  br i1 %exitcond1023.not, label %polly.loop_exit915, label %polly.loop_header913, !llvm.loop !123
}
