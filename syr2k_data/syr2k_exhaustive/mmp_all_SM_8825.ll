; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8825.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8825.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %97 = shl nuw nsw i64 %indvars.iv779, 2
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next780 = add nuw nsw i64 %indvars.iv779, 5
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %110 = icmp slt i64 %109, -1136
  %111 = select i1 %110, i64 %109, i64 -1136
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %131 = shl nuw nsw i64 %indvars.iv796, 2
  %132 = and i64 %131, 9223372036854775744
  %133 = sub nsw i64 %indvars.iv794, %132
  %134 = add i64 %indvars.iv801, %132
  %135 = mul nuw nsw i64 %polly.indvar355, 5
  %pexp.p_div_q358 = lshr i64 %135, 4
...
polly.loop_exit361:                               ; preds = %polly.loop_exit367
  ...
  %indvars.iv.next795 = add nuw nsw i64 %indvars.iv794, 20
  %indvars.iv.next797 = add nuw nsw i64 %indvars.iv796, 5
...
polly.loop_header359:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %139 = shl nsw i64 %polly.indvar362, 6
  %140 = sub nsw i64 %136, %139
  %141 = icmp sgt i64 %140, 0
  %142 = select i1 %141, i64 %140, i64 0
  %143 = mul nsw i64 %polly.indvar362, -64
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header359
  ...
  %indvars.iv.next799 = add i64 %indvars.iv798, -64
  %indvars.iv.next804 = add i64 %indvars.iv803, 64
  %exitcond810.not = icmp eq i64 %polly.indvar_next363, 19
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %165 = shl nuw nsw i64 %indvars.iv816, 2
  %166 = and i64 %165, 9223372036854775744
  %167 = sub nsw i64 %indvars.iv814, %166
  %168 = add i64 %indvars.iv821, %166
  %169 = mul nuw nsw i64 %polly.indvar511, 5
  %pexp.p_div_q514 = lshr i64 %169, 4
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next815 = add nuw nsw i64 %indvars.iv814, 20
  %indvars.iv.next817 = add nuw nsw i64 %indvars.iv816, 5
...
polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %173 = shl nsw i64 %polly.indvar518, 6
  %174 = sub nsw i64 %170, %173
  %175 = icmp sgt i64 %174, 0
  %176 = select i1 %175, i64 %174, i64 0
  %177 = mul nsw i64 %polly.indvar518, -64
...
polly.loop_exit523:                               ; preds = %polly.loop_exit530, %polly.loop_header515
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar_next519, 19
