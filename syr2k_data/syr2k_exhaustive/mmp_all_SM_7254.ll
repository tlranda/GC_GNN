; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7254.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7254.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %97 = trunc i64 %polly.indvar218 to i16
  %98 = mul i16 %97, 9
  %pexp.p_div_q.lhs.trunc = add i16 %98, 34
  %pexp.p_div_q830 = udiv i16 %pexp.p_div_q.lhs.trunc, 25
  %pexp.p_div_q.zext = zext i16 %pexp.p_div_q830 to i64
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit230
  ...
  %107 = mul nsw i64 %polly.indvar224, 50
...
polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header221
  ...
  %indvars.iv.next837 = add i64 %indvars.iv836, 50
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv842, i64 49)
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit398
  ...
  %131 = trunc i64 %polly.indvar391 to i16
  %132 = mul i16 %131, 9
  %pexp.p_div_q394.lhs.trunc = add i16 %132, 34
  %pexp.p_div_q394829 = udiv i16 %pexp.p_div_q394.lhs.trunc, 25
  %pexp.p_div_q394.zext = zext i16 %pexp.p_div_q394829 to i64
  %133 = sub nsw i64 %polly.indvar391, %pexp.p_div_q394.zext
  %134 = add nsw i64 %133, 1
  %.inv826 = icmp slt i64 %133, 23
  %135 = select i1 %.inv826, i64 %134, i64 23
...
polly.loop_exit406:                               ; preds = %polly.loop_exit413, %polly.loop_header396
  ...
  %indvars.iv.next854 = add i64 %indvars.iv853, 50
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit413
  ...
  %smin862 = call i64 @llvm.smin.i64(i64 %indvars.iv860, i64 49)
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit574
  ...
  %165 = trunc i64 %polly.indvar567 to i16
  %166 = mul i16 %165, 9
  %pexp.p_div_q570.lhs.trunc = add i16 %166, 34
  %pexp.p_div_q570828 = udiv i16 %pexp.p_div_q570.lhs.trunc, 25
  %pexp.p_div_q570.zext = zext i16 %pexp.p_div_q570828 to i64
  %167 = sub nsw i64 %polly.indvar567, %pexp.p_div_q570.zext
  %168 = add nsw i64 %167, 1
  %.inv827 = icmp slt i64 %167, 23
  %169 = select i1 %.inv827, i64 %168, i64 23
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit582
  ...
  %175 = mul nsw i64 %polly.indvar576, 50
...
polly.loop_exit582:                               ; preds = %polly.loop_exit589, %polly.loop_header572
  ...
  %indvars.iv.next874 = add i64 %indvars.iv873, 50
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit589
  ...
  %smin882 = call i64 @llvm.smin.i64(i64 %indvars.iv880, i64 49)
