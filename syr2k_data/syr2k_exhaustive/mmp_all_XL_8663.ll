; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8663.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8663.c"
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph964
  ...
  %wide.load971 = load <4 x double>, <4 x double>* %117, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %120, label %middle.block958, label %vector.body960, !llvm.loop !77
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %125 = mul nuw nsw i64 %polly.indvar361, 100
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %126 = mul nuw nsw i64 %polly.indvar367, 50
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  %wide.load945 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !81, !noalias !83
  ...
  store <4 x double> %143, <4 x double>* %144, align 8, !alias.scope !81, !noalias !83
  %index.next942 = add i64 %index941, 4
  %145 = icmp eq i64 %index.next942, %n.vec940
  br i1 %145, label %middle.block934, label %vector.body936, !llvm.loop !86
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit513
  ...
  %147 = shl nsw i64 %polly.indvar508, 6
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %149 = shl nuw nsw i64 %polly.indvar514, 1
  %150 = mul nuw nsw i64 %polly.indvar514, 100
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %151 = mul nuw nsw i64 %polly.indvar520, 50
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph876
  ...
  store <4 x double> %178, <4 x double>* %183, align 8, !alias.scope !90, !noalias !92
  ...
  br i1 %184, label %polly.loop_exit702, label %vector.body874, !llvm.loop !95
...
vector.body889:                                   ; preds = %vector.body889, %vector.ph892
  ...
  store <4 x double> %207, <4 x double>* %212, align 8, !alias.scope !94, !noalias !97
  ...
  br i1 %213, label %polly.loop_exit729, label %vector.body889, !llvm.loop !98
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  store <4 x double> %236, <4 x double>* %241, align 8, !alias.scope !93, !noalias !100
  ...
  br i1 %242, label %polly.loop_exit755, label %vector.body907, !llvm.loop !101
