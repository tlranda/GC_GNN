; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10280.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10280.c"
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit221
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv794, i64 99)
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_exit372
  ...
  %129 = mul nuw nsw i64 %polly.indvar366, 100
  %130 = add nsw i64 %129, %127
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %polly.loop_guard373 = icmp slt i64 %132, 80
...
polly.loop_header520.preheader:                   ; preds = %polly.loop_header512
  %155 = mul nsw i64 %polly.indvar515, -80
  %156 = mul nuw nsw i64 %polly.indvar515, 80
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit530
  ...
  %157 = mul nuw nsw i64 %polly.indvar524, 100
  %158 = add nsw i64 %157, %155
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard531 = icmp slt i64 %160, 80
