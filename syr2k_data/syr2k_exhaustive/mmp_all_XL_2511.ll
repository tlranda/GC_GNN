; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2511.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2511.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1047 = phi i64 [ %indvars.iv.next1048, %polly.loop_exit224 ], [ 5, %polly.loop_exit208 ]
  ...
  %99 = mul nsw i64 %polly.indvar219, -100
  %100 = mul nuw nsw i64 %polly.indvar219, 100
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1346 = call i64 @llvm.smin.i64(i64 %114, i64 19)
...
vector.body1342:                                  ; preds = %vector.body1342, %vector.ph1348
  ...
  %wide.load1361 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !64, !noalias !66
  ...
  store <4 x double> %138, <4 x double>* %139, align 8, !alias.scope !64, !noalias !66
  %index.next1352 = add i64 %index1351, 4
  %140 = icmp eq i64 %index.next1352, %n.vec1350
  br i1 %140, label %middle.block1340, label %vector.body1342, !llvm.loop !76
...
vector.body1280:                                  ; preds = %vector.body1280, %vector.ph1284
  ...
  %wide.load1291 = load <4 x double>, <4 x double>* %148, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %151, label %middle.block1278, label %vector.body1280, !llvm.loop !85
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  %indvars.iv1074 = phi i64 [ %indvars.iv.next1075, %polly.loop_exit428 ], [ 5, %polly.loop_exit412 ]
  ...
  %153 = mul nsw i64 %polly.indvar423, -100
  %154 = mul nuw nsw i64 %polly.indvar423, 100
  %155 = mul nsw i64 %polly.indvar423, -100
  %156 = mul nuw nsw i64 %polly.indvar423, 100
...
polly.loop_header426:                             ; preds = %polly.loop_exit434, %polly.loop_header420
  ...
  %157 = mul nuw nsw i64 %polly.indvar429, 100
...
polly.loop_header432:                             ; preds = %polly.loop_exit441, %polly.loop_header426
  ...
  %158 = mul nuw nsw i64 %polly.indvar435, 20
  %159 = add i64 %153, %158
  %smax1295 = call i64 @llvm.smax.i64(i64 %159, i64 0)
  %160 = mul nsw i64 %polly.indvar435, -20
  %161 = add i64 %154, %160
  %162 = add i64 %smax1295, %161
  %163 = mul nuw nsw i64 %polly.indvar435, 20
  %164 = add nsw i64 %163, %155
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard442 = icmp slt i64 %166, 100
...
polly.loop_header439:                             ; preds = %polly.loop_header439.preheader, %polly.loop_exit477
  ...
  %smin1298 = call i64 @llvm.smin.i64(i64 %170, i64 19)
...
vector.body1294:                                  ; preds = %vector.body1294, %vector.ph1300
  ...
  %wide.load1313 = load <4 x double>, <4 x double>* %191, align 8, !alias.scope !78, !noalias !80
  ...
  store <4 x double> %194, <4 x double>* %195, align 8, !alias.scope !78, !noalias !80
  %index.next1304 = add i64 %index1303, 4
  %196 = icmp eq i64 %index.next1304, %n.vec1302
  br i1 %196, label %middle.block1292, label %vector.body1294, !llvm.loop !89
...
polly.loop_header482.us:                          ; preds = %polly.loop_header482.us.preheader, %polly.loop_header482.us
  ...
  br i1 %exitcond1072.not, label %polly.loop_exit484.loopexit.us, label %polly.loop_header482.us, !llvm.loop !90
...
vector.body1234:                                  ; preds = %vector.body1234, %vector.ph1236
  ...
  %wide.load1243 = load <4 x double>, <4 x double>* %204, align 8, !alias.scope !91, !noalias !93
  ...
  store <4 x double> %205, <4 x double>* %206, align 8, !alias.scope !91, !noalias !93
  %index.next1240 = add i64 %index1239, 4
  %207 = icmp eq i64 %index.next1240, %n.vec1238
  br i1 %207, label %middle.block1232, label %vector.body1234, !llvm.loop !98
...
polly.loop_header604:                             ; preds = %polly.loop_header604.preheader, %polly.loop_header604
  ...
  br i1 %exitcond1108.not, label %polly.loop_exit606, label %polly.loop_header604, !llvm.loop !99
...
polly.loop_header630:                             ; preds = %polly.loop_exit622, %polly.loop_exit638
  %indvars.iv1101 = phi i64 [ %indvars.iv.next1102, %polly.loop_exit638 ], [ 5, %polly.loop_exit622 ]
  ...
  %209 = mul nsw i64 %polly.indvar633, -100
  %210 = mul nuw nsw i64 %polly.indvar633, 100
  %211 = mul nsw i64 %polly.indvar633, -100
  %212 = mul nuw nsw i64 %polly.indvar633, 100
...
polly.loop_header636:                             ; preds = %polly.loop_exit644, %polly.loop_header630
  ...
  %213 = mul nuw nsw i64 %polly.indvar639, 100
...
polly.loop_exit644:                               ; preds = %polly.loop_exit651
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar_next640, 10
...
polly.loop_header642:                             ; preds = %polly.loop_exit651, %polly.loop_header636
  ...
  %214 = mul nuw nsw i64 %polly.indvar645, 20
  %215 = add i64 %209, %214
  %smax1247 = call i64 @llvm.smax.i64(i64 %215, i64 0)
  %216 = mul nsw i64 %polly.indvar645, -20
  %217 = add i64 %210, %216
  %218 = add i64 %smax1247, %217
  %219 = mul nuw nsw i64 %polly.indvar645, 20
  %220 = add nsw i64 %219, %211
  %221 = icmp sgt i64 %220, 0
  %222 = select i1 %221, i64 %220, i64 0
  %polly.loop_guard652 = icmp slt i64 %222, 100
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit687
  ...
  %smin1250 = call i64 @llvm.smin.i64(i64 %226, i64 19)
...
polly.merge675.us:                                ; preds = %polly.then676.us, %polly.cond674.loopexit.us
  ...
  %exitcond1097.not = icmp eq i64 %polly.indvar_next660.us, 100
...
polly.loop_header656:                             ; preds = %polly.loop_header649.split, %polly.loop_header656
  ...
  %exitcond1083.not = icmp eq i64 %polly.indvar_next660, 100
...
vector.body1246:                                  ; preds = %vector.body1246, %vector.ph1252
  ...
  %wide.load1265 = load <4 x double>, <4 x double>* %247, align 8, !alias.scope !91, !noalias !93
  ...
  store <4 x double> %250, <4 x double>* %251, align 8, !alias.scope !91, !noalias !93
  %index.next1256 = add i64 %index1255, 4
  %252 = icmp eq i64 %index.next1256, %n.vec1254
  br i1 %252, label %middle.block1244, label %vector.body1246, !llvm.loop !102
...
polly.loop_header692.us:                          ; preds = %polly.loop_header692.us.preheader, %polly.loop_header692.us
  ...
  br i1 %exitcond1099.not, label %polly.loop_exit694.loopexit.us, label %polly.loop_header692.us, !llvm.loop !103
...
polly.loop_exit694.loopexit.us:                   ; preds = %polly.loop_header692.us, %middle.block1244
  ...
  %exitcond1100.not = icmp eq i64 %polly.indvar_next689.us, 100
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1174
  ...
  store <4 x double> %271, <4 x double>* %276, align 8, !alias.scope !104, !noalias !106
  ...
  br i1 %277, label %polly.loop_exit864, label %vector.body1173, !llvm.loop !109
...
polly.loop_header862:                             ; preds = %polly.loop_header856, %polly.loop_header862
  ...
  br i1 %exitcond1133.not, label %polly.loop_exit864, label %polly.loop_header862, !llvm.loop !110
...
vector.body1187:                                  ; preds = %vector.body1187, %vector.ph1190
  ...
  store <4 x double> %300, <4 x double>* %305, align 8, !alias.scope !108, !noalias !111
  ...
  br i1 %306, label %polly.loop_exit891, label %vector.body1187, !llvm.loop !112
...
polly.loop_header889:                             ; preds = %polly.loop_header883, %polly.loop_header889
  ...
  br i1 %exitcond1123.not, label %polly.loop_exit891, label %polly.loop_header889, !llvm.loop !113
...
vector.body1205:                                  ; preds = %vector.body1205, %vector.ph1208
  ...
  store <4 x double> %329, <4 x double>* %334, align 8, !alias.scope !107, !noalias !114
  ...
  br i1 %335, label %polly.loop_exit917, label %vector.body1205, !llvm.loop !115
...
polly.loop_header915:                             ; preds = %polly.loop_header909, %polly.loop_header915
  ...
  br i1 %exitcond1113.not, label %polly.loop_exit917, label %polly.loop_header915, !llvm.loop !116
}
