; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5555.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5555.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar_next203, 300
...
polly.loop_header233.us:                          ; preds = %polly.loop_exit242.us, %polly.loop_header227.us
  ...
  %111 = add i64 %110, %102
  %polly.loop_guard243.us927 = icmp sgt i64 %111, -1
  br i1 %polly.loop_guard243.us927, label %polly.loop_header240.preheader.us, label %polly.loop_exit242.us
...
polly.loop_exit242.us:                            ; preds = %polly.loop_header240.us, %polly.loop_header233.us
  ...
  %polly.loop_cond238.us = icmp ult i64 %polly.indvar236.us, 7
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235.loopexit.us, %polly.loop_header221
  ...
  %indvars.iv.next839 = add i64 %indvars.iv838, -8
  %indvars.iv.next843 = add i64 %indvars.iv842, 8
  %exitcond848.not = icmp eq i64 %polly.indvar_next225, 150
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1040
  ...
  %120 = shl nuw nsw i64 %index1043, 3
  %121 = getelementptr i8, i8* %scevgep366, i64 %120
  %122 = bitcast i8* %121 to <4 x double>*
  %wide.load1047 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !79, !noalias !81
  %123 = fmul fast <4 x double> %wide.load1047, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %125 = icmp eq i64 %index.next1044, %n.vec1042
  br i1 %125, label %middle.block1034, label %vector.body1036, !llvm.loop !85

middle.block1034:                                 ; preds = %vector.body1036
  %cmp.n1046 = icmp eq i64 %118, %n.vec1042
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %127 = lshr i64 %polly.indvar373, 1
  %128 = shl nuw nsw i64 %127, 3
  %129 = sub nsw i64 %indvars.iv856, %128
  %130 = add i64 %indvars.iv861, %128
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next862 = add nsw i64 %indvars.iv861, -4
  %exitcond871.not = icmp eq i64 %polly.indvar_next374, 300
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  %indvars.iv863 = phi i64 [ %indvars.iv.next864, %polly.loop_exit401 ], [ %130, %polly.loop_exit378 ]
  %indvars.iv858 = phi i64 [ %indvars.iv.next859, %polly.loop_exit401 ], [ %129, %polly.loop_exit378 ]
  ...
  %134 = add i64 %smax860, %indvars.iv863
  %135 = shl nsw i64 %polly.indvar396, 3
  %136 = sub nsw i64 %131, %135
  %137 = icmp sgt i64 %136, 0
  %138 = select i1 %137, i64 %136, i64 0
  %polly.loop_guard409 = icmp slt i64 %138, 8
...
polly.loop_header406.us:                          ; preds = %polly.loop_exit416.us, %polly.loop_header399.us
  %indvars.iv865 = phi i64 [ %indvars.iv.next866, %polly.loop_exit416.us ], [ %134, %polly.loop_header399.us ]
  ...
  %141 = add i64 %140, %132
  %polly.loop_guard417.us928 = icmp sgt i64 %141, -1
  br i1 %polly.loop_guard417.us928, label %polly.loop_header414.preheader.us, label %polly.loop_exit416.us
...
polly.loop_header414.us:                          ; preds = %polly.loop_header414.preheader.us, %polly.loop_header414.us
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar418.us, %smin867
  br i1 %exitcond868.not, label %polly.loop_exit416.us, label %polly.loop_header414.us
...
polly.loop_exit416.us:                            ; preds = %polly.loop_header414.us, %polly.loop_header406.us
  ...
  %polly.loop_cond412.us = icmp ult i64 %polly.indvar410.us, 7
...
polly.loop_exit408.loopexit.us:                   ; preds = %polly.loop_exit416.us
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar_next403.us, 1000
  br i1 %exitcond869.not, label %polly.loop_exit401, label %polly.loop_header399.us
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408.loopexit.us, %polly.loop_header393
  ...
  %indvars.iv.next864 = add i64 %indvars.iv863, 8
  %exitcond870.not = icmp eq i64 %polly.indvar_next397, 150
...
polly.loop_header528:                             ; preds = %polly.loop_exit536, %polly.start442
  ...
  %min.iters.check1013 = icmp ult i64 %148, 4
...
vector.body1012:                                  ; preds = %vector.body1012, %vector.ph1014
  ...
  %150 = shl nuw nsw i64 %index1017, 3
  %151 = getelementptr i8, i8* %scevgep540, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load1021 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !89, !noalias !91
  %153 = fmul fast <4 x double> %wide.load1021, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next1018, %n.vec1016
  br i1 %155, label %middle.block1010, label %vector.body1012, !llvm.loop !95

middle.block1010:                                 ; preds = %vector.body1012
  %cmp.n1020 = icmp eq i64 %148, %n.vec1016
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %157 = lshr i64 %polly.indvar547, 1
  %158 = shl nuw nsw i64 %157, 3
  %159 = sub nsw i64 %indvars.iv878, %158
  %160 = add i64 %indvars.iv883, %158
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %indvars.iv.next875 = add nsw i64 %indvars.iv874, -4
  %indvars.iv.next879 = add nuw nsw i64 %indvars.iv878, 4
  %indvars.iv.next884 = add nsw i64 %indvars.iv883, -4
  %exitcond893.not = icmp eq i64 %polly.indvar_next548, 300
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit575 ], [ %160, %polly.loop_exit552 ]
  %indvars.iv880 = phi i64 [ %indvars.iv.next881, %polly.loop_exit575 ], [ %159, %polly.loop_exit552 ]
  ...
  %164 = add i64 %smax882, %indvars.iv885
  %165 = shl nsw i64 %polly.indvar570, 3
  %166 = sub nsw i64 %161, %165
  %167 = icmp sgt i64 %166, 0
  %168 = select i1 %167, i64 %166, i64 0
  %polly.loop_guard583 = icmp slt i64 %168, 8
...
polly.loop_header580.us:                          ; preds = %polly.loop_exit590.us, %polly.loop_header573.us
  %indvars.iv887 = phi i64 [ %indvars.iv.next888, %polly.loop_exit590.us ], [ %164, %polly.loop_header573.us ]
  ...
  %171 = add i64 %170, %162
  %polly.loop_guard591.us929 = icmp sgt i64 %171, -1
  br i1 %polly.loop_guard591.us929, label %polly.loop_header588.preheader.us, label %polly.loop_exit590.us
...
polly.loop_header588.us:                          ; preds = %polly.loop_header588.preheader.us, %polly.loop_header588.us
  ...
  %exitcond890.not = icmp eq i64 %polly.indvar592.us, %smin889
  br i1 %exitcond890.not, label %polly.loop_exit590.us, label %polly.loop_header588.us
...
polly.loop_exit590.us:                            ; preds = %polly.loop_header588.us, %polly.loop_header580.us
  ...
  %polly.loop_cond586.us = icmp ult i64 %polly.indvar584.us, 7
...
polly.loop_exit582.loopexit.us:                   ; preds = %polly.loop_exit590.us
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar_next577.us, 1000
  br i1 %exitcond891.not, label %polly.loop_exit575, label %polly.loop_header573.us
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582.loopexit.us, %polly.loop_header567
  ...
  %indvars.iv.next881 = add i64 %indvars.iv880, -8
  %indvars.iv.next886 = add i64 %indvars.iv885, 8
  %exitcond892.not = icmp eq i64 %polly.indvar_next571, 150
...
polly.loop_header746:                             ; preds = %polly.loop_exit754, %polly.loop_header740
  ...
  %smin951 = call i64 @llvm.smin.i64(i64 %180, i64 -1168)
  %181 = add nsw i64 %smin951, 1200
  %smin918 = call i64 @llvm.smin.i64(i64 %indvars.iv916, i64 -1168)
  %182 = shl nsw i64 %polly.indvar749, 5
  %183 = add nsw i64 %smin918, 1199
...
vector.ph952:                                     ; preds = %polly.loop_header752
  %broadcast.splatinsert959 = insertelement <4 x i64> poison, i64 %182, i32 0
  %broadcast.splat960 = shufflevector <4 x i64> %broadcast.splatinsert959, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert961 = insertelement <4 x i32> poison, i32 %185, i32 0
...
vector.body950:                                   ; preds = %vector.body950, %vector.ph952
  ...
  %187 = add nuw nsw <4 x i64> %vec.ind957, %broadcast.splat960
  %188 = trunc <4 x i64> %187 to <4 x i32>
  %189 = mul <4 x i32> %broadcast.splat962, %188
  ...
  %199 = icmp eq i64 %index.next954, %181
  br i1 %199, label %polly.loop_exit760, label %vector.body950, !llvm.loop !104

polly.loop_exit760:                               ; preds = %vector.body950, %polly.loop_header758
  %polly.indvar_next756 = add nuw nsw i64 %polly.indvar755, 1
  %exitcond923.not = icmp eq i64 %polly.indvar755, %179
...
polly.loop_header758:                             ; preds = %polly.loop_header752, %polly.loop_header758
  ...
  %exitcond919.not = icmp eq i64 %polly.indvar761, %183
...
polly.loop_header773:                             ; preds = %polly.loop_exit781, %polly.loop_header767
  ...
  %smin966 = call i64 @llvm.smin.i64(i64 %209, i64 -968)
  %210 = add nsw i64 %smin966, 1000
  %smin908 = call i64 @llvm.smin.i64(i64 %indvars.iv906, i64 -968)
  %211 = shl nsw i64 %polly.indvar776, 5
  %212 = add nsw i64 %smin908, 999
...
vector.body965:                                   ; preds = %vector.body965, %vector.ph968
  ...
  %216 = add nuw nsw <4 x i64> %vec.ind975, %broadcast.splat978
  %217 = trunc <4 x i64> %216 to <4 x i32>
  %218 = mul <4 x i32> %broadcast.splat980, %217
  ...
  %228 = icmp eq i64 %index.next972, %210
  br i1 %228, label %polly.loop_exit787, label %vector.body965, !llvm.loop !107

polly.loop_exit787:                               ; preds = %vector.body965, %polly.loop_header785
  %polly.indvar_next783 = add nuw nsw i64 %polly.indvar782, 1
  %exitcond913.not = icmp eq i64 %polly.indvar782, %208
...
polly.loop_header785:                             ; preds = %polly.loop_header779, %polly.loop_header785
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar788, %212
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  %smin984 = call i64 @llvm.smin.i64(i64 %238, i64 -968)
  %239 = add nsw i64 %smin984, 1000
  %smin898 = call i64 @llvm.smin.i64(i64 %indvars.iv896, i64 -968)
  %240 = shl nsw i64 %polly.indvar802, 5
  %241 = add nsw i64 %smin898, 999
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph986
  ...
  %245 = add nuw nsw <4 x i64> %vec.ind993, %broadcast.splat996
  %246 = trunc <4 x i64> %245 to <4 x i32>
  %247 = mul <4 x i32> %broadcast.splat998, %246
  ...
  %257 = icmp eq i64 %index.next990, %239
  br i1 %257, label %polly.loop_exit813, label %vector.body983, !llvm.loop !110

polly.loop_exit813:                               ; preds = %vector.body983, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond903.not = icmp eq i64 %polly.indvar808, %237
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar814, %241
