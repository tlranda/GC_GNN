; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3151.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3151.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %111 = shl nuw nsw i64 %indvars.iv1013, 1
  ...
  %polly.loop_guard = icmp slt i64 %116, 38
...
polly.loop_header399:                             ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %175 = shl nuw nsw i64 %indvars.iv1034, 1
  %176 = and i64 %175, 9223372036854775776
  ...
  %polly.loop_guard410 = icmp slt i64 %180, 38
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  ...
  %183 = mul nsw i64 %polly.indvar402, -50
  %184 = mul nuw nsw i64 %polly.indvar402, 50
...
polly.loop_header447.preheader:                   ; preds = %polly.loop_header433.3, %polly.loop_header433.us.3, %polly.loop_exit423.loopexit.us.3, %polly.loop_header407.split
  ...
  %201 = mul nsw i64 %polly.indvar411, -32
...
polly.loop_header596:                             ; preds = %polly.loop_exit606, %polly.loop_header590
  ...
  %239 = shl nuw nsw i64 %indvars.iv1057, 1
  %240 = and i64 %239, 9223372036854775776
  ...
  %polly.loop_guard607 = icmp slt i64 %244, 38
...
polly.loop_header604.preheader:                   ; preds = %polly.loop_header596
  ...
  %247 = mul nsw i64 %polly.indvar599, -50
  %248 = mul nuw nsw i64 %polly.indvar599, 50
...
polly.loop_header644.preheader:                   ; preds = %polly.loop_header630.3, %polly.loop_header630.us.3, %polly.loop_exit620.loopexit.us.3, %polly.loop_header604.split
  ...
  %265 = mul nsw i64 %polly.indvar608, -32
...
polly.loop_header454.1:                           ; preds = %polly.loop_exit464, %polly.loop_exit464.1
  ...
  %smin1045.1 = call i64 @llvm.smin.i64(i64 %indvars.iv1043.1, i64 49)
...
polly.loop_header454.2:                           ; preds = %polly.loop_exit464.1, %polly.loop_exit464.2
  ...
  %smin1045.2 = call i64 @llvm.smin.i64(i64 %indvars.iv1043.2, i64 49)
...
polly.loop_header454.3:                           ; preds = %polly.loop_exit464.2, %polly.loop_exit464.3
  ...
  %smin1045.3 = call i64 @llvm.smin.i64(i64 %indvars.iv1043.3, i64 49)
...
polly.loop_header651.1:                           ; preds = %polly.loop_exit661, %polly.loop_exit661.1
  ...
  %smin1068.1 = call i64 @llvm.smin.i64(i64 %indvars.iv1066.1, i64 49)
...
polly.loop_header651.2:                           ; preds = %polly.loop_exit661.1, %polly.loop_exit661.2
  ...
  %smin1068.2 = call i64 @llvm.smin.i64(i64 %indvars.iv1066.2, i64 49)
...
polly.loop_header651.3:                           ; preds = %polly.loop_exit661.2, %polly.loop_exit661.3
  ...
  %smin1068.3 = call i64 @llvm.smin.i64(i64 %indvars.iv1066.3, i64 49)
