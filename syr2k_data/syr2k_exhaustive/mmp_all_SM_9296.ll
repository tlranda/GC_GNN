; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9296.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9296.c"
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond797.not = icmp eq i64 %polly.indvar_next215, 10
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %137 = lshr i64 %polly.indvar363, 4
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382, %polly.loop_header367
  ...
  %indvars.iv.next805 = add i64 %indvars.iv804, -128
  %indvars.iv.next810 = add i64 %indvars.iv809, 128
  %exitcond819.not = icmp eq i64 %polly.indvar_next371, 10
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %175 = lshr i64 %polly.indvar521, 4
...
polly.loop_exit533:                               ; preds = %polly.loop_exit540, %polly.loop_header525
  ...
  %exitcond841.not = icmp eq i64 %polly.indvar_next529, 10
