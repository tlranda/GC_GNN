; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7376.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7376.c"
...
vector.body925:                                   ; preds = %vector.body925, %vector.ph926
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv7.i, i64 %index927
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next928 = add i64 %index927, 4
  %vec.ind.next932 = add <4 x i64> %vec.ind931, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next928, 1200
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check989 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check989, label %for.body3.i46.preheader1063, label %vector.ph990

vector.ph990:                                     ; preds = %for.body3.i46.preheader
  %n.vec992 = and i64 %indvars.iv21.i, 9223372036854775804
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph990
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i, i64 %index993
  ...
  %46 = icmp eq i64 %index.next994, %n.vec992
  br i1 %46, label %middle.block986, label %vector.body988, !llvm.loop !18

middle.block986:                                  ; preds = %vector.body988
  %cmp.n996 = icmp eq i64 %indvars.iv21.i, %n.vec992
  br i1 %cmp.n996, label %for.inc6.i, label %for.body3.i46.preheader1063

for.body3.i46.preheader1063:                      ; preds = %for.body3.i46.preheader, %middle.block986
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec992, %middle.block986 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1063, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1063 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block986, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1012 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1012, label %for.body3.i60.preheader1062, label %vector.ph1013

vector.ph1013:                                    ; preds = %for.body3.i60.preheader
  %n.vec1015 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1011:                                  ; preds = %vector.body1011, %vector.ph1013
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i52, i64 %index1016
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1020 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1020, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1017 = add i64 %index1016, 4
  %57 = icmp eq i64 %index.next1017, %n.vec1015
  br i1 %57, label %middle.block1009, label %vector.body1011, !llvm.loop !55

middle.block1009:                                 ; preds = %vector.body1011
  %cmp.n1019 = icmp eq i64 %indvars.iv21.i52, %n.vec1015
  br i1 %cmp.n1019, label %for.inc6.i63, label %for.body3.i60.preheader1062

for.body3.i60.preheader1062:                      ; preds = %for.body3.i60.preheader, %middle.block1009
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1015, %middle.block1009 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1062, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1062 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1009, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1038 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1038, label %for.body3.i99.preheader1061, label %vector.ph1039

vector.ph1039:                                    ; preds = %for.body3.i99.preheader
  %n.vec1041 = and i64 %indvars.iv21.i91, 9223372036854775804
...
vector.body1037:                                  ; preds = %vector.body1037, %vector.ph1039
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i91, i64 %index1042
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1046 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1046, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1043 = add i64 %index1042, 4
  %68 = icmp eq i64 %index.next1043, %n.vec1041
  br i1 %68, label %middle.block1035, label %vector.body1037, !llvm.loop !57

middle.block1035:                                 ; preds = %vector.body1037
  %cmp.n1045 = icmp eq i64 %indvars.iv21.i91, %n.vec1041
  br i1 %cmp.n1045, label %for.inc6.i102, label %for.body3.i99.preheader1061

for.body3.i99.preheader1061:                      ; preds = %for.body3.i99.preheader, %middle.block1035
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1041, %middle.block1035 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1061, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1061 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1035, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit193, %polly.start
  %indvar1050 = phi i64 [ %indvar.next1051, %polly.loop_exit193 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1050, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1052 = icmp ult i64 %88, 4
  br i1 %min.iters.check1052, label %polly.loop_header191.preheader, label %vector.ph1053

vector.ph1053:                                    ; preds = %polly.loop_header
  %n.vec1055 = and i64 %88, -4
...
vector.body1049:                                  ; preds = %vector.body1049, %vector.ph1053
  ...
  %90 = shl nuw nsw i64 %index1056, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1060 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  %93 = fmul fast <4 x double> %wide.load1060, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !63, !noalias !65
  %index.next1057 = add i64 %index1056, 4
  %95 = icmp eq i64 %index.next1057, %n.vec1055
  br i1 %95, label %middle.block1047, label %vector.body1049, !llvm.loop !69

middle.block1047:                                 ; preds = %vector.body1049
  %cmp.n1059 = icmp eq i64 %88, %n.vec1055
  br i1 %cmp.n1059, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block1047
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1055, %middle.block1047 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1047
...
polly.loop_exit223:                               ; preds = %polly.loop_exit230, %polly.loop_header215
  ...
  %indvars.iv.next834 = add nuw nsw i64 %indvars.iv833, 50
  %exitcond840.not = icmp eq i64 %polly.indvar_next219, 24
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit230
  ...
  %polly.loop_guard231 = icmp slt i64 %105, 50
...
polly.loop_header228.preheader:                   ; preds = %polly.loop_header221
  ...
  %106 = add i64 %smax, %indvars.iv835
  %107 = sub nsw i64 %101, %102
  br label %polly.loop_header228

polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header221
  %polly.indvar_next225 = add nuw nsw i64 %polly.indvar224, 1
  %polly.loop_cond226.not = icmp sgt i64 %polly.indvar224, %99
  %indvars.iv.next832 = add nsw i64 %indvars.iv831, 64
  %indvars.iv.next836 = add nsw i64 %indvars.iv835, -64
  br i1 %polly.loop_cond226.not, label %polly.loop_exit223, label %polly.loop_header221

polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  %indvars.iv837 = phi i64 [ %106, %polly.loop_header228.preheader ], [ %indvars.iv.next838, %polly.loop_exit237 ]
  %polly.indvar232 = phi i64 [ %105, %polly.loop_header228.preheader ], [ %polly.indvar_next233, %polly.loop_exit237 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv837, i64 63)
  %108 = add nsw i64 %polly.indvar232, %107
  %polly.loop_guard245914 = icmp sgt i64 %108, -1
  %109 = add nuw nsw i64 %polly.indvar232, %101
  %110 = mul i64 %109, 8000
  %111 = mul i64 %109, 9600
  br i1 %polly.loop_guard245914, label %polly.loop_header235.us, label %polly.loop_exit237
...
polly.loop_header235.us:                          ; preds = %polly.loop_header228, %polly.loop_exit244.loopexit.us
  ...
  %112 = shl nuw nsw i64 %polly.indvar238.us, 3
  %scevgep249.us = getelementptr i8, i8* %call1, i64 %112
  %polly.access.mul.Packed_MemRef_call2253.us = mul nuw nsw i64 %polly.indvar238.us, 1200
  %polly.access.add.Packed_MemRef_call2254.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2253.us, %109
  ...
  %scevgep262.us = getelementptr i8, i8* %scevgep249.us, i64 %110
...
polly.loop_header242.us:                          ; preds = %polly.loop_header242.us, %polly.loop_header235.us
  ...
  %113 = add nuw nsw i64 %polly.indvar246.us, %102
  %114 = mul nuw nsw i64 %113, 8000
  %scevgep250.us = getelementptr i8, i8* %scevgep249.us, i64 %114
  ...
  %polly.access.add.Packed_MemRef_call2258.us = add nuw nsw i64 %113, %polly.access.mul.Packed_MemRef_call2253.us
...
polly.loop_exit237:                               ; preds = %polly.loop_exit244.loopexit.us, %polly.loop_header228
  ...
  %polly.loop_cond234 = icmp ult i64 %polly.indvar232, 49
...
polly.loop_header356:                             ; preds = %polly.loop_exit364, %polly.start270
  %indvar1024 = phi i64 [ %indvar.next1025, %polly.loop_exit364 ], [ 0, %polly.start270 ]
  %polly.indvar359 = phi i64 [ %polly.indvar_next360, %polly.loop_exit364 ], [ 1, %polly.start270 ]
  %117 = add i64 %indvar1024, 1
  %118 = mul nuw nsw i64 %polly.indvar359, 9600
  %scevgep368 = getelementptr i8, i8* %call, i64 %118
  %min.iters.check1026 = icmp ult i64 %117, 4
  br i1 %min.iters.check1026, label %polly.loop_header362.preheader, label %vector.ph1027

vector.ph1027:                                    ; preds = %polly.loop_header356
  %n.vec1029 = and i64 %117, -4
  br label %vector.body1023

vector.body1023:                                  ; preds = %vector.body1023, %vector.ph1027
  %index1030 = phi i64 [ 0, %vector.ph1027 ], [ %index.next1031, %vector.body1023 ]
  %119 = shl nuw nsw i64 %index1030, 3
  %120 = getelementptr i8, i8* %scevgep368, i64 %119
  %121 = bitcast i8* %120 to <4 x double>*
  %wide.load1034 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !74, !noalias !76
  %122 = fmul fast <4 x double> %wide.load1034, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %124 = icmp eq i64 %index.next1031, %n.vec1029
  br i1 %124, label %middle.block1021, label %vector.body1023, !llvm.loop !80

middle.block1021:                                 ; preds = %vector.body1023
  %cmp.n1033 = icmp eq i64 %117, %n.vec1029
  br i1 %cmp.n1033, label %polly.loop_exit364, label %polly.loop_header362.preheader

polly.loop_header362.preheader:                   ; preds = %polly.loop_header356, %middle.block1021
  %polly.indvar365.ph = phi i64 [ 0, %polly.loop_header356 ], [ %n.vec1029, %middle.block1021 ]
  br label %polly.loop_header362

polly.loop_exit364:                               ; preds = %polly.loop_header362, %middle.block1021
  %polly.indvar_next360 = add nuw nsw i64 %polly.indvar359, 1
  %exitcond863.not = icmp eq i64 %polly.indvar_next360, 1200
  %indvar.next1025 = add i64 %indvar1024, 1
  br i1 %exitcond863.not, label %polly.loop_header372.preheader, label %polly.loop_header356
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_header362
  ...
  %exitcond862.not = icmp eq i64 %polly.indvar_next366, %polly.indvar359
  br i1 %exitcond862.not, label %polly.loop_exit364, label %polly.loop_header362, !llvm.loop !81
...
polly.loop_exit380:                               ; preds = %polly.loop_header378
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar_next376, 1000
  br i1 %exitcond861.not, label %polly.loop_header388, label %polly.loop_header372
...
polly.loop_header378:                             ; preds = %polly.loop_header378, %polly.loop_header372
  ...
  %exitcond860.not = icmp eq i64 %polly.indvar_next382, 1200
  br i1 %exitcond860.not, label %polly.loop_exit380, label %polly.loop_header378
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit398
  ...
  %indvars.iv845 = phi i64 [ %indvars.iv.next846, %polly.loop_exit398 ], [ 0, %polly.loop_exit380 ]
  %polly.indvar391 = phi i64 [ %polly.indvar_next392, %polly.loop_exit398 ], [ 0, %polly.loop_exit380 ]
  %126 = mul nuw nsw i64 %polly.indvar391, 7
  %127 = add nuw nsw i64 %126, 39
  %pexp.p_div_q394 = lshr i64 %127, 5
  %128 = sub nsw i64 %polly.indvar391, %pexp.p_div_q394
  %polly.loop_guard399 = icmp sgt i64 %128, -2
...
polly.loop_header396.preheader:                   ; preds = %polly.loop_header388
  %129 = mul nsw i64 %polly.indvar391, -50
  %130 = mul nuw nsw i64 %polly.indvar391, 50
...
polly.loop_exit398:                               ; preds = %polly.loop_exit406, %polly.loop_header388
  ...
  %indvars.iv.next851 = add nuw nsw i64 %indvars.iv850, 50
  %exitcond859.not = icmp eq i64 %polly.indvar_next392, 24
  br i1 %exitcond859.not, label %polly.exiting271, label %polly.loop_header388
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_exit406
  ...
  %indvars.iv847 = phi i64 [ %indvars.iv845, %polly.loop_header396.preheader ], [ %indvars.iv.next848, %polly.loop_exit406 ]
  %polly.indvar400 = phi i64 [ 0, %polly.loop_header396.preheader ], [ %polly.indvar_next401, %polly.loop_exit406 ]
  %131 = shl nsw i64 %polly.indvar400, 6
  %132 = add nsw i64 %131, %129
  %133 = icmp sgt i64 %132, 0
  %134 = select i1 %133, i64 %132, i64 0
  %polly.loop_guard407 = icmp slt i64 %134, 50
...
polly.loop_header404.preheader:                   ; preds = %polly.loop_header396
  ...
  %135 = add i64 %smax849, %indvars.iv852
...
polly.loop_exit406:                               ; preds = %polly.loop_exit413, %polly.loop_header396
  ...
  %polly.loop_cond402.not = icmp sgt i64 %polly.indvar400, %128
  %indvars.iv.next848 = add nsw i64 %indvars.iv847, 64
  %indvars.iv.next853 = add nsw i64 %indvars.iv852, -64
  br i1 %polly.loop_cond402.not, label %polly.loop_exit398, label %polly.loop_header396

polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit413
  %indvars.iv854 = phi i64 [ %135, %polly.loop_header404.preheader ], [ %indvars.iv.next855, %polly.loop_exit413 ]
  %polly.indvar408 = phi i64 [ %134, %polly.loop_header404.preheader ], [ %polly.indvar_next409, %polly.loop_exit413 ]
  %smin856 = call i64 @llvm.smin.i64(i64 %indvars.iv854, i64 63)
  %137 = add nsw i64 %polly.indvar408, %136
  %polly.loop_guard421915 = icmp sgt i64 %137, -1
  %138 = add nuw nsw i64 %polly.indvar408, %130
  %139 = mul i64 %138, 8000
  %140 = mul i64 %138, 9600
  br i1 %polly.loop_guard421915, label %polly.loop_header411.us, label %polly.loop_exit413
...
polly.loop_header411.us:                          ; preds = %polly.loop_header404, %polly.loop_exit420.loopexit.us
  ...
  %141 = shl nuw nsw i64 %polly.indvar414.us, 3
  %scevgep425.us = getelementptr i8, i8* %call1, i64 %141
  %polly.access.mul.Packed_MemRef_call2273429.us = mul nuw nsw i64 %polly.indvar414.us, 1200
  %polly.access.add.Packed_MemRef_call2273430.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2273429.us, %138
  ...
  %scevgep438.us = getelementptr i8, i8* %scevgep425.us, i64 %139
...
polly.loop_header418.us:                          ; preds = %polly.loop_header418.us, %polly.loop_header411.us
  ...
  %142 = add nuw nsw i64 %polly.indvar422.us, %131
  %143 = mul nuw nsw i64 %142, 8000
  %scevgep426.us = getelementptr i8, i8* %scevgep425.us, i64 %143
  ...
  %polly.access.add.Packed_MemRef_call2273434.us = add nuw nsw i64 %142, %polly.access.mul.Packed_MemRef_call2273429.us
  ...
  %144 = shl i64 %142, 3
  %145 = add i64 %144, %140
  %scevgep441.us = getelementptr i8, i8* %call, i64 %145
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar422.us, %smin856
  br i1 %exitcond857.not, label %polly.loop_exit420.loopexit.us, label %polly.loop_header418.us

polly.loop_exit420.loopexit.us:                   ; preds = %polly.loop_header418.us
  %polly.indvar_next415.us = add nuw nsw i64 %polly.indvar414.us, 1
  %exitcond858.not = icmp eq i64 %polly.indvar_next415.us, 1000
  br i1 %exitcond858.not, label %polly.loop_exit413, label %polly.loop_header411.us
...
polly.loop_exit413:                               ; preds = %polly.loop_exit420.loopexit.us, %polly.loop_header404
  ...
  %polly.loop_cond410 = icmp ult i64 %polly.indvar408, 49
...
polly.loop_header532:                             ; preds = %polly.loop_exit540, %polly.start446
  ...
  %147 = mul nuw nsw i64 %polly.indvar535, 9600
  %scevgep544 = getelementptr i8, i8* %call, i64 %147
  %min.iters.check1000 = icmp ult i64 %146, 4
  br i1 %min.iters.check1000, label %polly.loop_header538.preheader, label %vector.ph1001

vector.ph1001:                                    ; preds = %polly.loop_header532
  %n.vec1003 = and i64 %146, -4
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1001
  ...
  %148 = shl nuw nsw i64 %index1004, 3
  %149 = getelementptr i8, i8* %scevgep544, i64 %148
  %150 = bitcast i8* %149 to <4 x double>*
  %wide.load1008 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !84, !noalias !86
  %151 = fmul fast <4 x double> %wide.load1008, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %153 = icmp eq i64 %index.next1005, %n.vec1003
  br i1 %153, label %middle.block997, label %vector.body999, !llvm.loop !90

middle.block997:                                  ; preds = %vector.body999
  %cmp.n1007 = icmp eq i64 %146, %n.vec1003
  br i1 %cmp.n1007, label %polly.loop_exit540, label %polly.loop_header538.preheader

polly.loop_header538.preheader:                   ; preds = %polly.loop_header532, %middle.block997
  %polly.indvar541.ph = phi i64 [ 0, %polly.loop_header532 ], [ %n.vec1003, %middle.block997 ]
  br label %polly.loop_header538

polly.loop_exit540:                               ; preds = %polly.loop_header538, %middle.block997
  %polly.indvar_next536 = add nuw nsw i64 %polly.indvar535, 1
  %exitcond882.not = icmp eq i64 %polly.indvar_next536, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond882.not, label %polly.loop_header548.preheader, label %polly.loop_header532
...
polly.loop_header538:                             ; preds = %polly.loop_header538.preheader, %polly.loop_header538
  ...
  %154 = shl nuw nsw i64 %polly.indvar541, 3
  %scevgep545 = getelementptr i8, i8* %scevgep544, i64 %154
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next542, %polly.indvar535
  br i1 %exitcond881.not, label %polly.loop_exit540, label %polly.loop_header538, !llvm.loop !91
...
polly.loop_exit556:                               ; preds = %polly.loop_header554
  ...
  %exitcond880.not = icmp eq i64 %polly.indvar_next552, 1000
  br i1 %exitcond880.not, label %polly.loop_header564, label %polly.loop_header548
...
polly.loop_header554:                             ; preds = %polly.loop_header554, %polly.loop_header548
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar_next558, 1200
  br i1 %exitcond879.not, label %polly.loop_exit556, label %polly.loop_header554

polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit574
  %indvars.iv869 = phi i64 [ %indvars.iv.next870, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %indvars.iv864 = phi i64 [ %indvars.iv.next865, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %polly.indvar567 = phi i64 [ %polly.indvar_next568, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %155 = mul nuw nsw i64 %polly.indvar567, 7
  %156 = add nuw nsw i64 %155, 39
  %pexp.p_div_q570 = lshr i64 %156, 5
  %157 = sub nsw i64 %polly.indvar567, %pexp.p_div_q570
  %polly.loop_guard575 = icmp sgt i64 %157, -2
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header564
  %158 = mul nsw i64 %polly.indvar567, -50
  %159 = mul nuw nsw i64 %polly.indvar567, 50
...
polly.loop_exit574:                               ; preds = %polly.loop_exit582, %polly.loop_header564
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar_next568, 24
  br i1 %exitcond878.not, label %polly.exiting447, label %polly.loop_header564

polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit582
  %indvars.iv871 = phi i64 [ %indvars.iv869, %polly.loop_header572.preheader ], [ %indvars.iv.next872, %polly.loop_exit582 ]
  %indvars.iv866 = phi i64 [ %indvars.iv864, %polly.loop_header572.preheader ], [ %indvars.iv.next867, %polly.loop_exit582 ]
  ...
  %polly.loop_guard583 = icmp slt i64 %163, 50
...
polly.loop_header580.preheader:                   ; preds = %polly.loop_header572
  ...
  %164 = add i64 %smax868, %indvars.iv871
...
polly.loop_exit582:                               ; preds = %polly.loop_exit589, %polly.loop_header572
  ...
  %polly.loop_cond578.not = icmp sgt i64 %polly.indvar576, %157
  %indvars.iv.next867 = add nsw i64 %indvars.iv866, 64
  %indvars.iv.next872 = add nsw i64 %indvars.iv871, -64
  br i1 %polly.loop_cond578.not, label %polly.loop_exit574, label %polly.loop_header572

polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit589
  %indvars.iv873 = phi i64 [ %164, %polly.loop_header580.preheader ], [ %indvars.iv.next874, %polly.loop_exit589 ]
  %polly.indvar584 = phi i64 [ %163, %polly.loop_header580.preheader ], [ %polly.indvar_next585, %polly.loop_exit589 ]
  %smin875 = call i64 @llvm.smin.i64(i64 %indvars.iv873, i64 63)
  %166 = add nsw i64 %polly.indvar584, %165
  %polly.loop_guard597916 = icmp sgt i64 %166, -1
  %167 = add nuw nsw i64 %polly.indvar584, %159
  %168 = mul i64 %167, 8000
  %169 = mul i64 %167, 9600
  br i1 %polly.loop_guard597916, label %polly.loop_header587.us, label %polly.loop_exit589
...
polly.loop_header587.us:                          ; preds = %polly.loop_header580, %polly.loop_exit596.loopexit.us
  ...
  %170 = shl nuw nsw i64 %polly.indvar590.us, 3
  %scevgep601.us = getelementptr i8, i8* %call1, i64 %170
  %polly.access.mul.Packed_MemRef_call2449605.us = mul nuw nsw i64 %polly.indvar590.us, 1200
  %polly.access.add.Packed_MemRef_call2449606.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2449605.us, %167
  ...
  %scevgep614.us = getelementptr i8, i8* %scevgep601.us, i64 %168
...
polly.loop_header594.us:                          ; preds = %polly.loop_header594.us, %polly.loop_header587.us
  ...
  %171 = add nuw nsw i64 %polly.indvar598.us, %160
  %172 = mul nuw nsw i64 %171, 8000
  %scevgep602.us = getelementptr i8, i8* %scevgep601.us, i64 %172
  ...
  %polly.access.add.Packed_MemRef_call2449610.us = add nuw nsw i64 %171, %polly.access.mul.Packed_MemRef_call2449605.us
  ...
  %173 = shl i64 %171, 3
  %174 = add i64 %173, %169
  %scevgep617.us = getelementptr i8, i8* %call, i64 %174
...
polly.loop_exit596.loopexit.us:                   ; preds = %polly.loop_header594.us
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar_next591.us, 1000
  br i1 %exitcond877.not, label %polly.loop_exit589, label %polly.loop_header587.us

polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header580
  %polly.indvar_next585 = add nuw nsw i64 %polly.indvar584, 1
  %polly.loop_cond586 = icmp ult i64 %polly.indvar584, 49
...
polly.loop_header746:                             ; preds = %entry, %polly.loop_exit754
  %indvars.iv907 = phi i64 [ %indvars.iv.next908, %polly.loop_exit754 ], [ 0, %entry ]
  ...
  %175 = shl nsw i64 %polly.indvar749, 5
  %176 = add nsw i64 %smin909, 1199
...
polly.loop_exit754:                               ; preds = %polly.loop_exit760
  ...
  %exitcond912.not = icmp eq i64 %polly.indvar_next750, 38
  br i1 %exitcond912.not, label %polly.loop_header773, label %polly.loop_header746

polly.loop_header752:                             ; preds = %polly.loop_exit760, %polly.loop_header746
  %indvars.iv903 = phi i64 [ %indvars.iv.next904, %polly.loop_exit760 ], [ 0, %polly.loop_header746 ]
  %polly.indvar755 = phi i64 [ %polly.indvar_next756, %polly.loop_exit760 ], [ 0, %polly.loop_header746 ]
  %177 = mul nsw i64 %polly.indvar755, -32
  %smin938 = call i64 @llvm.smin.i64(i64 %177, i64 -1168)
  %178 = add nsw i64 %smin938, 1200
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 -1168)
  %179 = shl nsw i64 %polly.indvar755, 5
  %180 = add nsw i64 %smin905, 1199
...
polly.loop_exit760:                               ; preds = %polly.loop_exit766
  ...
  %exitcond911.not = icmp eq i64 %polly.indvar_next756, 38
  br i1 %exitcond911.not, label %polly.loop_exit754, label %polly.loop_header752
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %181 = add nuw nsw i64 %polly.indvar761, %175
  %182 = trunc i64 %181 to i32
  %183 = mul nuw nsw i64 %181, 9600
  %min.iters.check = icmp eq i64 %178, 0
  br i1 %min.iters.check, label %polly.loop_header764, label %vector.ph939

vector.ph939:                                     ; preds = %polly.loop_header758
  %broadcast.splatinsert946 = insertelement <4 x i64> poison, i64 %179, i32 0
  %broadcast.splat947 = shufflevector <4 x i64> %broadcast.splatinsert946, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert948 = insertelement <4 x i32> poison, i32 %182, i32 0
...
vector.body937:                                   ; preds = %vector.body937, %vector.ph939
  %index940 = phi i64 [ 0, %vector.ph939 ], [ %index.next941, %vector.body937 ]
  %vec.ind944 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph939 ], [ %vec.ind.next945, %vector.body937 ]
  %184 = add nuw nsw <4 x i64> %vec.ind944, %broadcast.splat947
  %185 = trunc <4 x i64> %184 to <4 x i32>
  %186 = mul <4 x i32> %broadcast.splat949, %185
  ...
  %196 = icmp eq i64 %index.next941, %178
  br i1 %196, label %polly.loop_exit766, label %vector.body937, !llvm.loop !99

polly.loop_exit766:                               ; preds = %vector.body937, %polly.loop_header764
  %polly.indvar_next762 = add nuw nsw i64 %polly.indvar761, 1
  %exitcond910.not = icmp eq i64 %polly.indvar761, %176
  br i1 %exitcond910.not, label %polly.loop_exit760, label %polly.loop_header758
...
polly.loop_header764:                             ; preds = %polly.loop_header758, %polly.loop_header764
  ...
  %197 = add nuw nsw i64 %polly.indvar767, %179
  ...
  %scevgep770 = getelementptr i8, i8* %call, i64 %203
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar767, %180
  br i1 %exitcond906.not, label %polly.loop_exit766, label %polly.loop_header764, !llvm.loop !100

polly.loop_header773:                             ; preds = %polly.loop_exit754, %polly.loop_exit781
  %indvars.iv897 = phi i64 [ %indvars.iv.next898, %polly.loop_exit781 ], [ 0, %polly.loop_exit754 ]
  %polly.indvar776 = phi i64 [ %polly.indvar_next777, %polly.loop_exit781 ], [ 0, %polly.loop_exit754 ]
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 -1168)
  %204 = shl nsw i64 %polly.indvar776, 5
  %205 = add nsw i64 %smin899, 1199
...
polly.loop_exit781:                               ; preds = %polly.loop_exit787
  ...
  %exitcond902.not = icmp eq i64 %polly.indvar_next777, 38
  br i1 %exitcond902.not, label %polly.loop_header799, label %polly.loop_header773

polly.loop_header779:                             ; preds = %polly.loop_exit787, %polly.loop_header773
  %indvars.iv893 = phi i64 [ %indvars.iv.next894, %polly.loop_exit787 ], [ 0, %polly.loop_header773 ]
  %polly.indvar782 = phi i64 [ %polly.indvar_next783, %polly.loop_exit787 ], [ 0, %polly.loop_header773 ]
  %206 = mul nsw i64 %polly.indvar782, -32
  %smin953 = call i64 @llvm.smin.i64(i64 %206, i64 -968)
  %207 = add nsw i64 %smin953, 1000
  %smin895 = call i64 @llvm.smin.i64(i64 %indvars.iv893, i64 -968)
  %208 = shl nsw i64 %polly.indvar782, 5
  %209 = add nsw i64 %smin895, 999
...
polly.loop_exit787:                               ; preds = %polly.loop_exit793
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar_next783, 32
  br i1 %exitcond901.not, label %polly.loop_exit781, label %polly.loop_header779
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %210 = add nuw nsw i64 %polly.indvar788, %204
  %211 = trunc i64 %210 to i32
  %212 = mul nuw nsw i64 %210, 8000
  %min.iters.check954 = icmp eq i64 %207, 0
  br i1 %min.iters.check954, label %polly.loop_header791, label %vector.ph955

vector.ph955:                                     ; preds = %polly.loop_header785
  %broadcast.splatinsert964 = insertelement <4 x i64> poison, i64 %208, i32 0
  %broadcast.splat965 = shufflevector <4 x i64> %broadcast.splatinsert964, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert966 = insertelement <4 x i32> poison, i32 %211, i32 0
...
vector.body952:                                   ; preds = %vector.body952, %vector.ph955
  %index958 = phi i64 [ 0, %vector.ph955 ], [ %index.next959, %vector.body952 ]
  %vec.ind962 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph955 ], [ %vec.ind.next963, %vector.body952 ]
  %213 = add nuw nsw <4 x i64> %vec.ind962, %broadcast.splat965
  %214 = trunc <4 x i64> %213 to <4 x i32>
  %215 = mul <4 x i32> %broadcast.splat967, %214
  ...
  %225 = icmp eq i64 %index.next959, %207
  br i1 %225, label %polly.loop_exit793, label %vector.body952, !llvm.loop !102

polly.loop_exit793:                               ; preds = %vector.body952, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond900.not = icmp eq i64 %polly.indvar788, %205
  br i1 %exitcond900.not, label %polly.loop_exit787, label %polly.loop_header785
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %226 = add nuw nsw i64 %polly.indvar794, %208
  ...
  %scevgep797 = getelementptr i8, i8* %call2, i64 %232
  ...
  %exitcond896.not = icmp eq i64 %polly.indvar794, %209
  br i1 %exitcond896.not, label %polly.loop_exit793, label %polly.loop_header791, !llvm.loop !103

polly.loop_header799:                             ; preds = %polly.loop_exit781, %polly.loop_exit807
  %indvars.iv887 = phi i64 [ %indvars.iv.next888, %polly.loop_exit807 ], [ 0, %polly.loop_exit781 ]
  ...
  %233 = shl nsw i64 %polly.indvar802, 5
  %234 = add nsw i64 %smin889, 1199
...
polly.loop_exit807:                               ; preds = %polly.loop_exit813
  ...
  %exitcond892.not = icmp eq i64 %polly.indvar_next803, 38
  br i1 %exitcond892.not, label %init_array.exit, label %polly.loop_header799

polly.loop_header805:                             ; preds = %polly.loop_exit813, %polly.loop_header799
  %indvars.iv883 = phi i64 [ %indvars.iv.next884, %polly.loop_exit813 ], [ 0, %polly.loop_header799 ]
  %polly.indvar808 = phi i64 [ %polly.indvar_next809, %polly.loop_exit813 ], [ 0, %polly.loop_header799 ]
  %235 = mul nsw i64 %polly.indvar808, -32
  %smin971 = call i64 @llvm.smin.i64(i64 %235, i64 -968)
  %236 = add nsw i64 %smin971, 1000
  %smin885 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 -968)
  %237 = shl nsw i64 %polly.indvar808, 5
  %238 = add nsw i64 %smin885, 999
  br label %polly.loop_header811

polly.loop_exit813:                               ; preds = %polly.loop_exit819
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %indvars.iv.next884 = add nsw i64 %indvars.iv883, -32
  %exitcond891.not = icmp eq i64 %polly.indvar_next809, 32
  br i1 %exitcond891.not, label %polly.loop_exit807, label %polly.loop_header805

polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  %polly.indvar814 = phi i64 [ 0, %polly.loop_header805 ], [ %polly.indvar_next815, %polly.loop_exit819 ]
  %239 = add nuw nsw i64 %polly.indvar814, %233
  %240 = trunc i64 %239 to i32
  %241 = mul nuw nsw i64 %239, 8000
  %min.iters.check972 = icmp eq i64 %236, 0
  br i1 %min.iters.check972, label %polly.loop_header817, label %vector.ph973

vector.ph973:                                     ; preds = %polly.loop_header811
  %broadcast.splatinsert982 = insertelement <4 x i64> poison, i64 %237, i32 0
  %broadcast.splat983 = shufflevector <4 x i64> %broadcast.splatinsert982, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert984 = insertelement <4 x i32> poison, i32 %240, i32 0
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  %242 = add nuw nsw <4 x i64> %vec.ind980, %broadcast.splat983
  %243 = trunc <4 x i64> %242 to <4 x i32>
  %244 = mul <4 x i32> %broadcast.splat985, %243
  ...
  %254 = icmp eq i64 %index.next977, %236
  br i1 %254, label %polly.loop_exit819, label %vector.body970, !llvm.loop !105

polly.loop_exit819:                               ; preds = %vector.body970, %polly.loop_header817
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %exitcond890.not = icmp eq i64 %polly.indvar814, %234
  br i1 %exitcond890.not, label %polly.loop_exit813, label %polly.loop_header811
...
polly.loop_header817:                             ; preds = %polly.loop_header811, %polly.loop_header817
  ...
  %255 = add nuw nsw i64 %polly.indvar820, %237
  ...
  %scevgep824 = getelementptr i8, i8* %call1, i64 %261
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar820, %238
  br i1 %exitcond886.not, label %polly.loop_exit819, label %polly.loop_header817, !llvm.loop !106
}
