; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10525.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10525.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit214, %polly.loop_header199
  ...
  %exitcond794.not = icmp eq i64 %polly.indvar_next203, 12
...
polly.loop_header205:                             ; preds = %polly.loop_header205.preheader, %polly.loop_exit214
  ...
  %polly.loop_guard215 = icmp slt i64 %105, 100
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit221
  %indvars.iv791 = phi i64 [ %106, %polly.loop_header212.preheader ], [ %indvars.iv.next792, %polly.loop_exit221 ]
  %polly.indvar216 = phi i64 [ %105, %polly.loop_header212.preheader ], [ %polly.indvar_next217, %polly.loop_exit221 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv791, i64 127)
  %108 = add nsw i64 %polly.indvar216, %107
  %polly.loop_guard229865 = icmp sgt i64 %108, -1
  %109 = add nuw nsw i64 %polly.indvar216, %101
...
polly.loop_header219.us:                          ; preds = %polly.loop_header212, %polly.loop_exit228.loopexit.us
  ...
  %112 = shl nuw nsw i64 %polly.indvar222.us, 3
  %scevgep233.us = getelementptr i8, i8* %call1, i64 %112
  %scevgep237.us = getelementptr i8, i8* %call2, i64 %112
  %scevgep238.us = getelementptr i8, i8* %scevgep237.us, i64 %110
  ...
  %scevgep246.us = getelementptr i8, i8* %scevgep233.us, i64 %110
...
polly.loop_header226.us:                          ; preds = %polly.loop_header226.us, %polly.loop_header219.us
  ...
  %113 = add nuw nsw i64 %polly.indvar230.us, %102
...
polly.loop_exit221:                               ; preds = %polly.loop_exit228.loopexit.us, %polly.loop_header212
  ...
  %polly.loop_cond218 = icmp ult i64 %polly.indvar216, 99
...
polly.loop_header338:                             ; preds = %kernel_syr2k.exit, %polly.loop_exit346
  ...
  %117 = add i64 %indvar981, 1
  %118 = mul nuw nsw i64 %polly.indvar341, 9600
  %scevgep350 = getelementptr i8, i8* %call, i64 %118
  %min.iters.check983 = icmp ult i64 %117, 4
  br i1 %min.iters.check983, label %polly.loop_header344.preheader, label %vector.ph984

vector.ph984:                                     ; preds = %polly.loop_header338
  %n.vec986 = and i64 %117, -4
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph984
  ...
  %119 = shl nuw nsw i64 %index987, 3
  %120 = getelementptr i8, i8* %scevgep350, i64 %119
  %121 = bitcast i8* %120 to <4 x double>*
  %wide.load991 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !69, !noalias !71
  %122 = fmul fast <4 x double> %wide.load991, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %124 = icmp eq i64 %index.next988, %n.vec986
  br i1 %124, label %middle.block978, label %vector.body980, !llvm.loop !74

middle.block978:                                  ; preds = %vector.body980
  %cmp.n990 = icmp eq i64 %117, %n.vec986
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  %125 = shl nuw nsw i64 %polly.indvar347, 3
  %scevgep351 = getelementptr i8, i8* %scevgep350, i64 %125
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit364
  ...
  %126 = mul nuw nsw i64 %polly.indvar357, 7
  %127 = add nuw nsw i64 %126, 39
  %pexp.p_div_q360 = lshr i64 %127, 5
  %128 = sub nsw i64 %polly.indvar357, %pexp.p_div_q360
  %polly.loop_guard365 = icmp sgt i64 %128, -2
...
polly.loop_header362.preheader:                   ; preds = %polly.loop_header354
  %129 = mul nsw i64 %polly.indvar357, -100
  %130 = mul nuw nsw i64 %polly.indvar357, 100
  br label %polly.loop_header362

polly.loop_exit364:                               ; preds = %polly.loop_exit372, %polly.loop_header354
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next798 = add nsw i64 %indvars.iv797, -100
  %indvars.iv.next803 = add nuw nsw i64 %indvars.iv802, 100
  %exitcond811.not = icmp eq i64 %polly.indvar_next358, 12
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_exit372
  ...
  %131 = shl nsw i64 %polly.indvar366, 7
  %132 = add nsw i64 %131, %129
  %133 = icmp sgt i64 %132, 0
  %134 = select i1 %133, i64 %132, i64 0
  %polly.loop_guard373 = icmp slt i64 %134, 100
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %135 = add i64 %smax801, %indvars.iv804
...
polly.loop_exit372:                               ; preds = %polly.loop_exit379, %polly.loop_header362
  ...
  %polly.loop_cond368.not = icmp sgt i64 %polly.indvar366, %128
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  %indvars.iv806 = phi i64 [ %135, %polly.loop_header370.preheader ], [ %indvars.iv.next807, %polly.loop_exit379 ]
  %polly.indvar374 = phi i64 [ %134, %polly.loop_header370.preheader ], [ %polly.indvar_next375, %polly.loop_exit379 ]
  %smin808 = call i64 @llvm.smin.i64(i64 %indvars.iv806, i64 127)
  %137 = add nsw i64 %polly.indvar374, %136
  %polly.loop_guard387866 = icmp sgt i64 %137, -1
  %138 = add nuw nsw i64 %polly.indvar374, %130
...
polly.loop_header377.us:                          ; preds = %polly.loop_header370, %polly.loop_exit386.loopexit.us
  ...
  %141 = shl nuw nsw i64 %polly.indvar380.us, 3
  %scevgep391.us = getelementptr i8, i8* %call1, i64 %141
  %scevgep395.us = getelementptr i8, i8* %call2, i64 %141
  %scevgep396.us = getelementptr i8, i8* %scevgep395.us, i64 %139
  ...
  %scevgep404.us = getelementptr i8, i8* %scevgep391.us, i64 %139
...
polly.loop_header384.us:                          ; preds = %polly.loop_header384.us, %polly.loop_header377.us
  ...
  %142 = add nuw nsw i64 %polly.indvar388.us, %131
  ...
  %scevgep400.us = getelementptr i8, i8* %scevgep395.us, i64 %143
  ...
  %144 = shl i64 %142, 3
  %145 = add i64 %144, %140
  %scevgep407.us = getelementptr i8, i8* %call, i64 %145
...
polly.loop_exit379:                               ; preds = %polly.loop_exit386.loopexit.us, %polly.loop_header370
  ...
  %polly.loop_cond376 = icmp ult i64 %polly.indvar374, 99
...
polly.loop_header496:                             ; preds = %init_array.exit, %polly.loop_exit504
  ...
  %147 = mul nuw nsw i64 %polly.indvar499, 9600
  %scevgep508 = getelementptr i8, i8* %call, i64 %147
  %min.iters.check957 = icmp ult i64 %146, 4
  br i1 %min.iters.check957, label %polly.loop_header502.preheader, label %vector.ph958

vector.ph958:                                     ; preds = %polly.loop_header496
  %n.vec960 = and i64 %146, -4
...
vector.body956:                                   ; preds = %vector.body956, %vector.ph958
  ...
  %148 = shl nuw nsw i64 %index961, 3
  %149 = getelementptr i8, i8* %scevgep508, i64 %148
  %150 = bitcast i8* %149 to <4 x double>*
  %wide.load965 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !78, !noalias !80
  %151 = fmul fast <4 x double> %wide.load965, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %153 = icmp eq i64 %index.next962, %n.vec960
  br i1 %153, label %middle.block954, label %vector.body956, !llvm.loop !83

middle.block954:                                  ; preds = %vector.body956
  %cmp.n964 = icmp eq i64 %146, %n.vec960
...
polly.loop_header502:                             ; preds = %polly.loop_header502.preheader, %polly.loop_header502
  ...
  %154 = shl nuw nsw i64 %polly.indvar505, 3
  %scevgep509 = getelementptr i8, i8* %scevgep508, i64 %154
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit522
  ...
  %155 = mul nuw nsw i64 %polly.indvar515, 7
  %156 = add nuw nsw i64 %155, 39
  %pexp.p_div_q518 = lshr i64 %156, 5
  %157 = sub nsw i64 %polly.indvar515, %pexp.p_div_q518
  %polly.loop_guard523 = icmp sgt i64 %157, -2
...
polly.loop_header520.preheader:                   ; preds = %polly.loop_header512
  %158 = mul nsw i64 %polly.indvar515, -100
  %159 = mul nuw nsw i64 %polly.indvar515, 100
...
polly.loop_exit522:                               ; preds = %polly.loop_exit530, %polly.loop_header512
  ...
  %exitcond828.not = icmp eq i64 %polly.indvar_next516, 12
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit530
  ...
  %160 = shl nsw i64 %polly.indvar524, 7
  %161 = add nsw i64 %160, %158
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %polly.loop_guard531 = icmp slt i64 %163, 100
...
polly.loop_header528.preheader:                   ; preds = %polly.loop_header520
  ...
  %164 = add i64 %smax818, %indvars.iv821
...
polly.loop_exit530:                               ; preds = %polly.loop_exit537, %polly.loop_header520
  ...
  %polly.loop_cond526.not = icmp sgt i64 %polly.indvar524, %157
...
polly.loop_header528:                             ; preds = %polly.loop_header528.preheader, %polly.loop_exit537
  %indvars.iv823 = phi i64 [ %164, %polly.loop_header528.preheader ], [ %indvars.iv.next824, %polly.loop_exit537 ]
  %polly.indvar532 = phi i64 [ %163, %polly.loop_header528.preheader ], [ %polly.indvar_next533, %polly.loop_exit537 ]
  %smin825 = call i64 @llvm.smin.i64(i64 %indvars.iv823, i64 127)
  %166 = add nsw i64 %polly.indvar532, %165
  %polly.loop_guard545867 = icmp sgt i64 %166, -1
  %167 = add nuw nsw i64 %polly.indvar532, %159
...
polly.loop_header535.us:                          ; preds = %polly.loop_header528, %polly.loop_exit544.loopexit.us
  ...
  %170 = shl nuw nsw i64 %polly.indvar538.us, 3
  %scevgep549.us = getelementptr i8, i8* %call1, i64 %170
  %scevgep553.us = getelementptr i8, i8* %call2, i64 %170
  %scevgep554.us = getelementptr i8, i8* %scevgep553.us, i64 %168
  ...
  %scevgep562.us = getelementptr i8, i8* %scevgep549.us, i64 %168
...
polly.loop_header542.us:                          ; preds = %polly.loop_header542.us, %polly.loop_header535.us
  ...
  %171 = add nuw nsw i64 %polly.indvar546.us, %160
  %172 = mul nuw nsw i64 %171, 8000
  %scevgep550.us = getelementptr i8, i8* %scevgep549.us, i64 %172
  ...
  %scevgep558.us = getelementptr i8, i8* %scevgep553.us, i64 %172
  ...
  %173 = shl i64 %171, 3
  %174 = add i64 %173, %169
  %scevgep565.us = getelementptr i8, i8* %call, i64 %174
...
polly.loop_exit537:                               ; preds = %polly.loop_exit544.loopexit.us, %polly.loop_header528
  ...
  %polly.loop_cond534 = icmp ult i64 %polly.indvar532, 99
...
polly.loop_header694:                             ; preds = %entry, %polly.loop_exit702
  ...
  %175 = shl nsw i64 %polly.indvar697, 5
  %176 = add nsw i64 %smin857, 1199
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %177 = mul nsw i64 %polly.indvar703, -32
  %smin895 = call i64 @llvm.smin.i64(i64 %177, i64 -1168)
  %178 = add nsw i64 %smin895, 1200
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 -1168)
  %179 = shl nsw i64 %polly.indvar703, 5
  %180 = add nsw i64 %smin853, 1199
...
polly.loop_header706:                             ; preds = %polly.loop_exit714, %polly.loop_header700
  ...
  %181 = add nuw nsw i64 %polly.indvar709, %175
...
vector.ph896:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert903 = insertelement <4 x i64> poison, i64 %179, i32 0
  %broadcast.splat904 = shufflevector <4 x i64> %broadcast.splatinsert903, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert905 = insertelement <4 x i32> poison, i32 %182, i32 0
...
vector.body894:                                   ; preds = %vector.body894, %vector.ph896
  ...
  %184 = add nuw nsw <4 x i64> %vec.ind901, %broadcast.splat904
  %185 = trunc <4 x i64> %184 to <4 x i32>
  %186 = mul <4 x i32> %broadcast.splat906, %185
  ...
  %196 = icmp eq i64 %index.next898, %178
  br i1 %196, label %polly.loop_exit714, label %vector.body894, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body894, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond858.not = icmp eq i64 %polly.indvar709, %176
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %197 = add nuw nsw i64 %polly.indvar715, %179
  ...
  %scevgep718 = getelementptr i8, i8* %call, i64 %203
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar715, %180
...
polly.loop_header721:                             ; preds = %polly.loop_exit702, %polly.loop_exit729
  ...
  %204 = shl nsw i64 %polly.indvar724, 5
  %205 = add nsw i64 %smin847, 1199
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %206 = mul nsw i64 %polly.indvar730, -32
  %smin910 = call i64 @llvm.smin.i64(i64 %206, i64 -968)
  %207 = add nsw i64 %smin910, 1000
  %smin843 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 -968)
  %208 = shl nsw i64 %polly.indvar730, 5
  %209 = add nsw i64 %smin843, 999
...
vector.body909:                                   ; preds = %vector.body909, %vector.ph912
  ...
  %213 = add nuw nsw <4 x i64> %vec.ind919, %broadcast.splat922
  %214 = trunc <4 x i64> %213 to <4 x i32>
  %215 = mul <4 x i32> %broadcast.splat924, %214
  ...
  %225 = icmp eq i64 %index.next916, %207
  br i1 %225, label %polly.loop_exit741, label %vector.body909, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body909, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond848.not = icmp eq i64 %polly.indvar736, %205
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %226 = add nuw nsw i64 %polly.indvar742, %208
  ...
  %scevgep745 = getelementptr i8, i8* %call2, i64 %232
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar742, %209
...
polly.loop_header747:                             ; preds = %polly.loop_exit729, %polly.loop_exit755
  ...
  %233 = shl nsw i64 %polly.indvar750, 5
  %234 = add nsw i64 %smin837, 1199
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %235 = mul nsw i64 %polly.indvar756, -32
  %smin928 = call i64 @llvm.smin.i64(i64 %235, i64 -968)
  %236 = add nsw i64 %smin928, 1000
  %smin833 = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 -968)
  %237 = shl nsw i64 %polly.indvar756, 5
  %238 = add nsw i64 %smin833, 999
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph930
  ...
  %242 = add nuw nsw <4 x i64> %vec.ind937, %broadcast.splat940
  %243 = trunc <4 x i64> %242 to <4 x i32>
  %244 = mul <4 x i32> %broadcast.splat942, %243
  ...
  %254 = icmp eq i64 %index.next934, %236
  br i1 %254, label %polly.loop_exit767, label %vector.body927, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body927, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond838.not = icmp eq i64 %polly.indvar762, %234
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %255 = add nuw nsw i64 %polly.indvar768, %237
  ...
  %scevgep772 = getelementptr i8, i8* %call1, i64 %261
  ...
  %exitcond834.not = icmp eq i64 %polly.indvar768, %238
