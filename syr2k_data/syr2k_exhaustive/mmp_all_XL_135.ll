; ModuleID = 'syr2k_exhaustive/mmp_all_XL_135.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_135.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %112 = add i64 %111, %109
  %113 = mul nuw nsw i64 %polly.indvar209, 160
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit220.7
  ...
  %.inv = icmp sgt i64 %147, 19
  %149 = select i1 %.inv, i64 19, i64 %148
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  ...
  %smin1440 = call i64 @llvm.smin.i64(i64 %160, i64 19)
  ...
  %smin1427 = call i64 @llvm.smin.i64(i64 %165, i64 19)
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %208 = mul nuw nsw i64 %polly.indvar421, 20
  %209 = shl nuw nsw i64 %polly.indvar421, 1
  %210 = lshr i64 %polly.indvar421, 1
  %211 = add nuw i64 %209, %210
  %212 = shl nuw nsw i64 %211, 3
  %213 = sub i64 %208, %212
  %214 = mul nsw i64 %polly.indvar421, -20
  %215 = add i64 %214, %212
  %216 = mul nuw nsw i64 %polly.indvar421, 160
  %217 = mul nuw nsw i64 %polly.indvar421, 20
  %218 = shl nuw nsw i64 %polly.indvar421, 1
  %219 = lshr i64 %polly.indvar421, 1
  %220 = add nuw i64 %218, %219
  %221 = shl nuw nsw i64 %220, 3
  %222 = sub i64 %217, %221
  %223 = or i64 %216, 8
  %224 = mul nsw i64 %polly.indvar421, -20
  %225 = add i64 %224, %221
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit432.7
  ...
  %.inv942 = icmp sgt i64 %250, 19
  %252 = select i1 %.inv942, i64 19, i64 %251
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1377 = call i64 @llvm.smin.i64(i64 %263, i64 19)
  ...
  %smin1364 = call i64 @llvm.smin.i64(i64 %268, i64 19)
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %311 = mul nuw nsw i64 %polly.indvar636, 20
  %312 = shl nuw nsw i64 %polly.indvar636, 1
  %313 = lshr i64 %polly.indvar636, 1
  %314 = add nuw i64 %312, %313
  %315 = shl nuw nsw i64 %314, 3
  %316 = sub i64 %311, %315
  %317 = mul nsw i64 %polly.indvar636, -20
  %318 = add i64 %317, %315
  %319 = mul nuw nsw i64 %polly.indvar636, 160
  %320 = mul nuw nsw i64 %polly.indvar636, 20
  %321 = shl nuw nsw i64 %polly.indvar636, 1
  %322 = lshr i64 %polly.indvar636, 1
  %323 = add nuw i64 %321, %322
  %324 = shl nuw nsw i64 %323, 3
  %325 = sub i64 %320, %324
  %326 = or i64 %319, 8
  %327 = mul nsw i64 %polly.indvar636, -20
  %328 = add i64 %327, %324
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit647.7
  ...
  %.inv943 = icmp sgt i64 %353, 19
  %355 = select i1 %.inv943, i64 19, i64 %354
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  ...
  %smin1314 = call i64 @llvm.smin.i64(i64 %366, i64 19)
  ...
  %smin1301 = call i64 @llvm.smin.i64(i64 %371, i64 19)
...
polly.loop_exit220.7:                             ; preds = %polly.loop_header218.7
  %491 = mul nsw i64 %polly.indvar209, -20
  %492 = shl nuw nsw i64 %polly.indvar209, 1
...
polly.loop_exit432.7:                             ; preds = %polly.loop_header430.7
  %522 = mul nsw i64 %polly.indvar421, -20
  %523 = shl nuw nsw i64 %polly.indvar421, 1
...
polly.loop_exit647.7:                             ; preds = %polly.loop_header645.7
  %553 = mul nsw i64 %polly.indvar636, -20
  %554 = shl nuw nsw i64 %polly.indvar636, 1
