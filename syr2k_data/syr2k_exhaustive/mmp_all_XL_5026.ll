; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5026.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5026.c"
...
polly.loop_exit391:                               ; preds = %polly.loop_exit398
  ...
  %exitcond1019.not = icmp eq i64 %polly.indvar_next387, 13
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %142 = shl nsw i64 %polly.indvar399, 8
...
polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  ...
  %exitcond1017.not = icmp eq i64 %polly.indvar399, %135
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  ...
  %polly.loop_guard4201082 = icmp sgt i64 %149, -1
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %173 = lshr i64 %indvars.iv1040, 3
  %174 = mul nsw i64 %polly.indvar577, -96
  %175 = icmp slt i64 %174, -1104
  %176 = select i1 %175, i64 %174, i64 -1104
  %177 = add nsw i64 %176, 1199
  %178 = mul nuw nsw i64 %polly.indvar577, 96
...
polly.loop_exit582:                               ; preds = %polly.loop_exit589
  ...
  %indvars.iv.next1024 = add nsw i64 %indvars.iv1023, -96
  %indvars.iv.next1029 = add nuw nsw i64 %indvars.iv1028, 96
  %indvars.iv.next1041 = add nuw nsw i64 %indvars.iv1040, 3
  %exitcond1044.not = icmp eq i64 %polly.indvar_next578, 13
...
polly.loop_header580:                             ; preds = %polly.loop_exit589, %polly.loop_header574
  ...
  %179 = mul nuw nsw i64 %polly.indvar583, 50
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %180 = shl nsw i64 %polly.indvar590, 8
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar590, %173
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1032 = phi i64 [ %184, %polly.loop_header594.preheader ], [ %indvars.iv.next1033, %polly.loop_exit632 ]
  ...
  %polly.loop_guard6111083 = icmp sgt i64 %187, -1
...
vector.body1110:                                  ; preds = %vector.body1110, %vector.ph1111
  ...
  br i1 %223, label %polly.loop_exit807, label %vector.body1110, !llvm.loop !99

polly.loop_exit807:                               ; preds = %vector.body1110, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1074.not = icmp eq i64 %polly.indvar802, %203
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar808, %207
...
vector.body1124:                                  ; preds = %vector.body1124, %vector.ph1127
  ...
  br i1 %252, label %polly.loop_exit834, label %vector.body1124, !llvm.loop !102

polly.loop_exit834:                               ; preds = %vector.body1124, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1064.not = icmp eq i64 %polly.indvar829, %232
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar835, %236
...
vector.body1142:                                  ; preds = %vector.body1142, %vector.ph1145
  ...
  br i1 %281, label %polly.loop_exit860, label %vector.body1142, !llvm.loop !105

polly.loop_exit860:                               ; preds = %vector.body1142, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1054.not = icmp eq i64 %polly.indvar855, %261
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar861, %265
