; ModuleID = 'syr2k_exhaustive/mmp_all_SM_836.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_836.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %102 = add i64 %101, %99
  %103 = lshr i64 %polly.indvar203, 4
  %104 = shl nuw nsw i64 %103, 6
...
polly.loop_exit224:                               ; preds = %polly.loop_exit259
  ...
  %exitcond1089.not = icmp eq i64 %113, 300
...
polly.loop_header222:                             ; preds = %polly.loop_exit259, %polly.loop_exit208
  ...
  %115 = mul nsw i64 %indvar1386, -64
  %116 = add i64 %100, %115
  %smax1388 = call i64 @llvm.smax.i64(i64 %116, i64 0)
  %117 = shl nuw nsw i64 %indvar1386, 6
  %118 = add i64 %102, %117
  %119 = add i64 %smax1388, %118
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1078, i64 0)
  %120 = add i64 %smax, %indvars.iv1082
  %121 = shl nsw i64 %polly.indvar225, 4
  %.not.not = icmp ugt i64 %121, %polly.indvar203
  %122 = shl nsw i64 %polly.indvar225, 6
...
polly.loop_exit259:                               ; preds = %polly.loop_exit266, %polly.loop_header257.preheader
  ...
  %exitcond1088.not = icmp eq i64 %polly.indvar_next226, 19
...
polly.loop_header257.preheader:                   ; preds = %polly.loop_exit246, %polly.loop_exit246.us, %polly.loop_header222.split
  ...
  %133 = mul nsw i64 %polly.indvar225, -64
...
polly.loop_header264:                             ; preds = %polly.loop_header257, %polly.loop_exit274
  ...
  %138 = add i64 %119, %indvar1389
  %smin1391 = call i64 @llvm.smin.i64(i64 %138, i64 3)
  %139 = add nsw i64 %smin1391, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1084, i64 3)
  %140 = add nsw i64 %polly.indvar268, %123
  %polly.loop_guard2751179 = icmp sgt i64 %140, -1
...
polly.loop_header272.preheader:                   ; preds = %polly.loop_header264
  ...
  %min.iters.check1392 = icmp ult i64 %139, 4
...
vector.body1385:                                  ; preds = %vector.body1385, %vector.ph1393
  ...
  %143 = add nuw nsw i64 %index1396, %108
  %144 = add nuw nsw i64 %index1396, %polly.access.mul.Packed_MemRef_call1279
  %145 = getelementptr double, double* %Packed_MemRef_call1, i64 %144
  %146 = bitcast double* %145 to <4 x double>*
  %wide.load1400 = load <4 x double>, <4 x double>* %146, align 8
  %147 = fmul fast <4 x double> %broadcast.splat1402, %wide.load1400
  %148 = getelementptr double, double* %Packed_MemRef_call2, i64 %144
  %149 = bitcast double* %148 to <4 x double>*
  %wide.load1403 = load <4 x double>, <4 x double>* %149, align 8
  %150 = fmul fast <4 x double> %broadcast.splat1405, %wide.load1403
  %151 = shl i64 %143, 3
  %152 = add i64 %151, %142
  %153 = getelementptr i8, i8* %call, i64 %152
  %154 = bitcast i8* %153 to <4 x double>*
  %wide.load1406 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !72, !noalias !74
  ...
  %157 = fadd fast <4 x double> %156, %wide.load1406
  ...
  %159 = icmp eq i64 %index.next1397, %n.vec1395
  br i1 %159, label %middle.block1383, label %vector.body1385, !llvm.loop !84

middle.block1383:                                 ; preds = %vector.body1385
  %cmp.n1399 = icmp eq i64 %139, %n.vec1395
...
vector.body1321:                                  ; preds = %vector.body1321, %vector.ph1325
  ...
  %165 = shl nuw nsw i64 %index1328, 3
  %166 = getelementptr i8, i8* %scevgep400, i64 %165
  %167 = bitcast i8* %166 to <4 x double>*
  %wide.load1332 = load <4 x double>, <4 x double>* %167, align 8, !alias.scope !86, !noalias !88
  %168 = fmul fast <4 x double> %wide.load1332, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %170 = icmp eq i64 %index.next1329, %n.vec1327
  br i1 %170, label %middle.block1319, label %vector.body1321, !llvm.loop !93

middle.block1319:                                 ; preds = %vector.body1321
  %cmp.n1331 = icmp eq i64 %163, %n.vec1327
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit429
  ...
  %173 = shl nuw nsw i64 %polly.indvar407, 2
  %174 = and i64 %173, 9223372036854775744
  %175 = sub nsw i64 %172, %174
  %176 = mul nsw i64 %polly.indvar407, -4
  %177 = add i64 %176, %174
  %178 = lshr i64 %polly.indvar407, 4
  %179 = shl nuw nsw i64 %178, 6
  %180 = sub nsw i64 %indvars.iv1099, %179
  %181 = add i64 %indvars.iv1104, %179
...
polly.loop_exit429:                               ; preds = %polly.loop_exit470
  ...
  %indvars.iv.next1100 = add nuw nsw i64 %indvars.iv1099, 4
  %indvars.iv.next1105 = add nsw i64 %indvars.iv1104, -4
  %exitcond1114.not = icmp eq i64 %188, 300
...
polly.loop_header427:                             ; preds = %polly.loop_exit470, %polly.loop_exit412
  ...
  %indvars.iv1106 = phi i64 [ %indvars.iv.next1107, %polly.loop_exit470 ], [ %181, %polly.loop_exit412 ]
  %indvars.iv1101 = phi i64 [ %indvars.iv.next1102, %polly.loop_exit470 ], [ %180, %polly.loop_exit412 ]
  %polly.indvar430 = phi i64 [ %polly.indvar_next431, %polly.loop_exit470 ], [ %178, %polly.loop_exit412 ]
  %190 = mul nsw i64 %indvar1336, -64
  %191 = add i64 %175, %190
  %smax1338 = call i64 @llvm.smax.i64(i64 %191, i64 0)
  %192 = shl nuw nsw i64 %indvar1336, 6
  %193 = add i64 %177, %192
  %194 = add i64 %smax1338, %193
  %smax1103 = call i64 @llvm.smax.i64(i64 %indvars.iv1101, i64 0)
  %195 = add i64 %smax1103, %indvars.iv1106
  %196 = shl nsw i64 %polly.indvar430, 4
  %.not.not926 = icmp ugt i64 %196, %polly.indvar407
  %197 = shl nsw i64 %polly.indvar430, 6
  %198 = add nsw i64 %197, %182
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %201 = add nsw i64 %198, 63
...
polly.loop_exit470:                               ; preds = %polly.loop_exit477, %polly.loop_header468.preheader
  ...
  %indvars.iv.next1102 = add i64 %indvars.iv1101, -64
  %indvars.iv.next1107 = add i64 %indvars.iv1106, 64
  %exitcond1113.not = icmp eq i64 %polly.indvar_next431, 19
...
polly.loop_header468.preheader:                   ; preds = %polly.loop_exit456, %polly.loop_exit456.us, %polly.loop_header427.split
  ...
  %208 = mul nsw i64 %polly.indvar430, -64
  %209 = icmp slt i64 %208, -1136
  %210 = select i1 %209, i64 %208, i64 -1136
...
polly.loop_header475:                             ; preds = %polly.loop_header468, %polly.loop_exit485
  ...
  %indvars.iv1108 = phi i64 [ %195, %polly.loop_header468 ], [ %indvars.iv.next1109, %polly.loop_exit485 ]
  %polly.indvar479 = phi i64 [ %207, %polly.loop_header468 ], [ %polly.indvar_next480, %polly.loop_exit485 ]
  %213 = add i64 %194, %indvar1339
  %smin1341 = call i64 @llvm.smin.i64(i64 %213, i64 3)
  %214 = add nsw i64 %smin1341, 1
  %smin1110 = call i64 @llvm.smin.i64(i64 %indvars.iv1108, i64 3)
  %215 = add nsw i64 %polly.indvar479, %198
  %polly.loop_guard4861180 = icmp sgt i64 %215, -1
...
polly.loop_header483.preheader:                   ; preds = %polly.loop_header475
  ...
  %min.iters.check1342 = icmp ult i64 %214, 4
...
vector.body1335:                                  ; preds = %vector.body1335, %vector.ph1343
  ...
  %218 = add nuw nsw i64 %index1346, %183
  %219 = add nuw nsw i64 %index1346, %polly.access.mul.Packed_MemRef_call1303490
  %220 = getelementptr double, double* %Packed_MemRef_call1303, i64 %219
  %221 = bitcast double* %220 to <4 x double>*
  %wide.load1350 = load <4 x double>, <4 x double>* %221, align 8
  %222 = fmul fast <4 x double> %broadcast.splat1352, %wide.load1350
  %223 = getelementptr double, double* %Packed_MemRef_call2305, i64 %219
  %224 = bitcast double* %223 to <4 x double>*
  %wide.load1353 = load <4 x double>, <4 x double>* %224, align 8
  %225 = fmul fast <4 x double> %broadcast.splat1355, %wide.load1353
  %226 = shl i64 %218, 3
  %227 = add i64 %226, %217
  %228 = getelementptr i8, i8* %call, i64 %227
  %229 = bitcast i8* %228 to <4 x double>*
  %wide.load1356 = load <4 x double>, <4 x double>* %229, align 8, !alias.scope !86, !noalias !88
  ...
  %232 = fadd fast <4 x double> %231, %wide.load1356
  ...
  %234 = icmp eq i64 %index.next1347, %n.vec1345
  br i1 %234, label %middle.block1333, label %vector.body1335, !llvm.loop !97

middle.block1333:                                 ; preds = %vector.body1335
  %cmp.n1349 = icmp eq i64 %214, %n.vec1345
...
polly.loop_header599:                             ; preds = %polly.loop_exit607, %polly.start511
  ...
  %min.iters.check1274 = icmp ult i64 %238, 4
...
vector.body1273:                                  ; preds = %vector.body1273, %vector.ph1275
  ...
  %240 = shl nuw nsw i64 %index1278, 3
  %241 = getelementptr i8, i8* %scevgep611, i64 %240
  %242 = bitcast i8* %241 to <4 x double>*
  %wide.load1282 = load <4 x double>, <4 x double>* %242, align 8, !alias.scope !99, !noalias !101
  %243 = fmul fast <4 x double> %wide.load1282, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %245 = icmp eq i64 %index.next1279, %n.vec1277
  br i1 %245, label %middle.block1271, label %vector.body1273, !llvm.loop !106

middle.block1271:                                 ; preds = %vector.body1273
  %cmp.n1281 = icmp eq i64 %238, %n.vec1277
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %248 = shl nuw nsw i64 %polly.indvar618, 2
  %249 = and i64 %248, 9223372036854775744
  %250 = sub nsw i64 %247, %249
  %251 = mul nsw i64 %polly.indvar618, -4
  %252 = add i64 %251, %249
  %253 = lshr i64 %polly.indvar618, 4
  %254 = shl nuw nsw i64 %253, 6
  %255 = sub nsw i64 %indvars.iv1124, %254
  %256 = add i64 %indvars.iv1129, %254
...
polly.loop_exit640:                               ; preds = %polly.loop_exit681
  ...
  %exitcond1139.not = icmp eq i64 %263, 300
...
polly.loop_header638:                             ; preds = %polly.loop_exit681, %polly.loop_exit623
  ...
  %indvars.iv1131 = phi i64 [ %indvars.iv.next1132, %polly.loop_exit681 ], [ %256, %polly.loop_exit623 ]
  %indvars.iv1126 = phi i64 [ %indvars.iv.next1127, %polly.loop_exit681 ], [ %255, %polly.loop_exit623 ]
  %polly.indvar641 = phi i64 [ %polly.indvar_next642, %polly.loop_exit681 ], [ %253, %polly.loop_exit623 ]
  %265 = mul nsw i64 %indvar1286, -64
  %266 = add i64 %250, %265
  %smax1288 = call i64 @llvm.smax.i64(i64 %266, i64 0)
  %267 = shl nuw nsw i64 %indvar1286, 6
  %268 = add i64 %252, %267
  %269 = add i64 %smax1288, %268
  %smax1128 = call i64 @llvm.smax.i64(i64 %indvars.iv1126, i64 0)
  %270 = add i64 %smax1128, %indvars.iv1131
  %271 = shl nsw i64 %polly.indvar641, 4
  %.not.not927 = icmp ugt i64 %271, %polly.indvar618
  %272 = shl nsw i64 %polly.indvar641, 6
  %273 = add nsw i64 %272, %257
  %274 = icmp sgt i64 %273, 0
  %275 = select i1 %274, i64 %273, i64 0
  %276 = add nsw i64 %273, 63
...
polly.loop_exit681:                               ; preds = %polly.loop_exit688, %polly.loop_header679.preheader
  ...
  %exitcond1138.not = icmp eq i64 %polly.indvar_next642, 19
...
polly.loop_header679.preheader:                   ; preds = %polly.loop_exit667, %polly.loop_exit667.us, %polly.loop_header638.split
  ...
  %283 = mul nsw i64 %polly.indvar641, -64
  %284 = icmp slt i64 %283, -1136
  %285 = select i1 %284, i64 %283, i64 -1136
...
polly.loop_header686:                             ; preds = %polly.loop_header679, %polly.loop_exit696
  ...
  %indvars.iv1133 = phi i64 [ %270, %polly.loop_header679 ], [ %indvars.iv.next1134, %polly.loop_exit696 ]
  %polly.indvar690 = phi i64 [ %282, %polly.loop_header679 ], [ %polly.indvar_next691, %polly.loop_exit696 ]
  %288 = add i64 %269, %indvar1289
  %smin1291 = call i64 @llvm.smin.i64(i64 %288, i64 3)
  %289 = add nsw i64 %smin1291, 1
  %smin1135 = call i64 @llvm.smin.i64(i64 %indvars.iv1133, i64 3)
  %290 = add nsw i64 %polly.indvar690, %273
  %polly.loop_guard6971181 = icmp sgt i64 %290, -1
...
polly.loop_header694.preheader:                   ; preds = %polly.loop_header686
  ...
  %min.iters.check1292 = icmp ult i64 %289, 4
...
vector.body1285:                                  ; preds = %vector.body1285, %vector.ph1293
  ...
  %293 = add nuw nsw i64 %index1296, %258
  %294 = add nuw nsw i64 %index1296, %polly.access.mul.Packed_MemRef_call1514701
  %295 = getelementptr double, double* %Packed_MemRef_call1514, i64 %294
  %296 = bitcast double* %295 to <4 x double>*
  %wide.load1300 = load <4 x double>, <4 x double>* %296, align 8
  %297 = fmul fast <4 x double> %broadcast.splat1302, %wide.load1300
  %298 = getelementptr double, double* %Packed_MemRef_call2516, i64 %294
  %299 = bitcast double* %298 to <4 x double>*
  %wide.load1303 = load <4 x double>, <4 x double>* %299, align 8
  %300 = fmul fast <4 x double> %broadcast.splat1305, %wide.load1303
  %301 = shl i64 %293, 3
  %302 = add i64 %301, %292
  %303 = getelementptr i8, i8* %call, i64 %302
  %304 = bitcast i8* %303 to <4 x double>*
  %wide.load1306 = load <4 x double>, <4 x double>* %304, align 8, !alias.scope !99, !noalias !101
  ...
  %307 = fadd fast <4 x double> %306, %wide.load1306
  ...
  %309 = icmp eq i64 %index.next1297, %n.vec1295
  br i1 %309, label %middle.block1283, label %vector.body1285, !llvm.loop !110

middle.block1283:                                 ; preds = %vector.body1285
  %cmp.n1299 = icmp eq i64 %289, %n.vec1295
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %smin1212 = call i64 @llvm.smin.i64(i64 %315, i64 -1168)
  %316 = add nsw i64 %smin1212, 1200
  %smin1164 = call i64 @llvm.smin.i64(i64 %indvars.iv1162, i64 -1168)
  %317 = shl nsw i64 %polly.indvar855, 5
  %318 = add nsw i64 %smin1164, 1199
...
vector.ph1213:                                    ; preds = %polly.loop_header858
  %broadcast.splatinsert1220 = insertelement <4 x i64> poison, i64 %317, i32 0
  %broadcast.splat1221 = shufflevector <4 x i64> %broadcast.splatinsert1220, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1222 = insertelement <4 x i32> poison, i32 %320, i32 0
...
vector.body1211:                                  ; preds = %vector.body1211, %vector.ph1213
  ...
  %322 = add nuw nsw <4 x i64> %vec.ind1218, %broadcast.splat1221
  %323 = trunc <4 x i64> %322 to <4 x i32>
  %324 = mul <4 x i32> %broadcast.splat1223, %323
  ...
  %334 = icmp eq i64 %index.next1215, %316
  br i1 %334, label %polly.loop_exit866, label %vector.body1211, !llvm.loop !117

polly.loop_exit866:                               ; preds = %vector.body1211, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1169.not = icmp eq i64 %polly.indvar861, %314
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1165.not = icmp eq i64 %polly.indvar867, %318
...
polly.loop_header879:                             ; preds = %polly.loop_exit887, %polly.loop_header873
  ...
  %smin1227 = call i64 @llvm.smin.i64(i64 %344, i64 -968)
  %345 = add nsw i64 %smin1227, 1000
  %smin1154 = call i64 @llvm.smin.i64(i64 %indvars.iv1152, i64 -968)
  %346 = shl nsw i64 %polly.indvar882, 5
  %347 = add nsw i64 %smin1154, 999
...
vector.body1226:                                  ; preds = %vector.body1226, %vector.ph1229
  ...
  %351 = add nuw nsw <4 x i64> %vec.ind1236, %broadcast.splat1239
  %352 = trunc <4 x i64> %351 to <4 x i32>
  %353 = mul <4 x i32> %broadcast.splat1241, %352
  ...
  %363 = icmp eq i64 %index.next1233, %345
  br i1 %363, label %polly.loop_exit893, label %vector.body1226, !llvm.loop !120

polly.loop_exit893:                               ; preds = %vector.body1226, %polly.loop_header891
  %polly.indvar_next889 = add nuw nsw i64 %polly.indvar888, 1
  %exitcond1159.not = icmp eq i64 %polly.indvar888, %343
...
polly.loop_header891:                             ; preds = %polly.loop_header885, %polly.loop_header891
  ...
  %exitcond1155.not = icmp eq i64 %polly.indvar894, %347
...
polly.loop_header905:                             ; preds = %polly.loop_exit913, %polly.loop_header899
  ...
  %smin1245 = call i64 @llvm.smin.i64(i64 %373, i64 -968)
  %374 = add nsw i64 %smin1245, 1000
  %smin1144 = call i64 @llvm.smin.i64(i64 %indvars.iv1142, i64 -968)
  %375 = shl nsw i64 %polly.indvar908, 5
  %376 = add nsw i64 %smin1144, 999
...
vector.body1244:                                  ; preds = %vector.body1244, %vector.ph1247
  ...
  %380 = add nuw nsw <4 x i64> %vec.ind1254, %broadcast.splat1257
  %381 = trunc <4 x i64> %380 to <4 x i32>
  %382 = mul <4 x i32> %broadcast.splat1259, %381
  ...
  %392 = icmp eq i64 %index.next1251, %374
  br i1 %392, label %polly.loop_exit919, label %vector.body1244, !llvm.loop !123

polly.loop_exit919:                               ; preds = %vector.body1244, %polly.loop_header917
  %polly.indvar_next915 = add nuw nsw i64 %polly.indvar914, 1
  %exitcond1149.not = icmp eq i64 %polly.indvar914, %372
...
polly.loop_header917:                             ; preds = %polly.loop_header911, %polly.loop_header917
  ...
  %exitcond1145.not = icmp eq i64 %polly.indvar920, %376
