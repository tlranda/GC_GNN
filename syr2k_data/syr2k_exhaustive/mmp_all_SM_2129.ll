; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2129.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2129.c"
...
vector.body1278:                                  ; preds = %vector.body1278, %vector.ph1280
  ...
  br i1 %57, label %middle.block1276, label %vector.body1278, !llvm.loop !55
...
vector.body1323:                                  ; preds = %vector.body1323, %vector.ph1325
  ...
  br i1 %68, label %middle.block1321, label %vector.body1323, !llvm.loop !57
...
vector.body1335:                                  ; preds = %vector.body1335, %vector.ph1339
  ...
  %wide.load1346 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  ...
  br i1 %95, label %middle.block1333, label %vector.body1335, !llvm.loop !70
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond1059.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !71
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %smin1050 = call i64 @llvm.smin.i64(i64 %indvars.iv1048, i64 -1136)
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1035 = add nuw nsw i64 %indvars.iv1034, 64
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -936)
  %100 = add nsw i64 %smin1046, 1000
  %101 = shl nsw i64 %polly.indvar225, 6
...
polly.loop_header234:                             ; preds = %polly.loop_exit265, %polly.loop_header228
  ...
  %smin1350 = call i64 @llvm.smin.i64(i64 %107, i64 63)
  %108 = add nsw i64 %smin1350, 1
  %smin1044 = call i64 @llvm.smin.i64(i64 %indvars.iv1038, i64 63)
...
vector.body1349:                                  ; preds = %vector.body1349, %vector.ph1352
  ...
  %wide.load1365 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !63, !noalias !65
  ...
  store <4 x double> %131, <4 x double>* %132, align 8, !alias.scope !63, !noalias !65
  %index.next1356 = add i64 %index1355, 4
  %133 = icmp eq i64 %index.next1356, %n.vec1354
  br i1 %133, label %middle.block1347, label %vector.body1349, !llvm.loop !75
...
polly.loop_header270.us:                          ; preds = %polly.loop_header270.us.preheader, %polly.loop_header270.us
  ...
  br i1 %exitcond1045.not, label %polly.loop_exit272.loopexit.us, label %polly.loop_header270.us, !llvm.loop !76
...
polly.start298:                                   ; preds = %kernel_syr2k.exit
  %malloccall300 = tail call dereferenceable_or_null(614400) i8* @malloc(i64 614400) #6
...
vector.body1290:                                  ; preds = %vector.body1290, %vector.ph1294
  ...
  %wide.load1301 = load <4 x double>, <4 x double>* %141, align 8, !alias.scope !77, !noalias !79
  ...
  store <4 x double> %142, <4 x double>* %143, align 8, !alias.scope !77, !noalias !79
  %index.next1298 = add i64 %index1297, 4
  %144 = icmp eq i64 %index.next1298, %n.vec1296
  br i1 %144, label %middle.block1288, label %vector.body1290, !llvm.loop !84
...
polly.loop_header392:                             ; preds = %polly.loop_header392.preheader, %polly.loop_header392
  ...
  br i1 %exitcond1090.not, label %polly.loop_exit394, label %polly.loop_header392, !llvm.loop !85
...
polly.loop_header418:                             ; preds = %polly.loop_exit410, %polly.loop_exit426
  ...
  %146 = shl nuw nsw i64 %polly.indvar421, 6
  %smin1081 = call i64 @llvm.smin.i64(i64 %indvars.iv1079, i64 -1136)
  %147 = shl nsw i64 %polly.indvar421, 6
  %148 = add nsw i64 %smin1081, 1199
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %polly.indvar_next422 = add nuw nsw i64 %polly.indvar421, 1
  %indvars.iv.next1066 = add nuw nsw i64 %indvars.iv1065, 64
  %indvars.iv.next1080 = add nsw i64 %indvars.iv1079, -64
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 1
  %exitcond1087.not = icmp eq i64 %polly.indvar_next422, 19
...
polly.loop_header424:                             ; preds = %polly.loop_exit432, %polly.loop_header418
  ...
  %smin1077 = call i64 @llvm.smin.i64(i64 %indvars.iv1061, i64 -936)
  %149 = add nsw i64 %smin1077, 1000
  %150 = shl nsw i64 %polly.indvar427, 6
...
polly.loop_exit432:                               ; preds = %polly.loop_exit438
  ...
  %exitcond1086.not = icmp eq i64 %polly.indvar_next428, 16
...
polly.loop_header430:                             ; preds = %polly.loop_exit438, %polly.loop_header424
  ...
  %151 = mul nsw i64 %polly.indvar433, -64
  %152 = add i64 %146, %151
  %153 = shl nsw i64 %polly.indvar433, 6
...
polly.loop_header436:                             ; preds = %polly.loop_exit473, %polly.loop_header430
  ...
  %smin1305 = call i64 @llvm.smin.i64(i64 %156, i64 63)
  %157 = add nsw i64 %smin1305, 1
  %smin1075 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 63)
...
vector.body1304:                                  ; preds = %vector.body1304, %vector.ph1307
  ...
  %wide.load1320 = load <4 x double>, <4 x double>* %177, align 8, !alias.scope !77, !noalias !79
  ...
  store <4 x double> %180, <4 x double>* %181, align 8, !alias.scope !77, !noalias !79
  %index.next1311 = add i64 %index1310, 4
  %182 = icmp eq i64 %index.next1311, %n.vec1309
  br i1 %182, label %middle.block1302, label %vector.body1304, !llvm.loop !88
...
polly.loop_header478.us:                          ; preds = %polly.loop_header478.us.preheader, %polly.loop_header478.us
  ...
  br i1 %exitcond1076.not, label %polly.loop_exit480.loopexit.us, label %polly.loop_header478.us, !llvm.loop !89
...
polly.start506:                                   ; preds = %init_array.exit
  %malloccall508 = tail call dereferenceable_or_null(614400) i8* @malloc(i64 614400) #6
...
vector.body1247:                                  ; preds = %vector.body1247, %vector.ph1249
  ...
  %wide.load1256 = load <4 x double>, <4 x double>* %190, align 8, !alias.scope !90, !noalias !92
  ...
  store <4 x double> %191, <4 x double>* %192, align 8, !alias.scope !90, !noalias !92
  %index.next1253 = add i64 %index1252, 4
  %193 = icmp eq i64 %index.next1253, %n.vec1251
  br i1 %193, label %middle.block1245, label %vector.body1247, !llvm.loop !97
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_header600
  ...
  br i1 %exitcond1121.not, label %polly.loop_exit602, label %polly.loop_header600, !llvm.loop !98
...
polly.loop_header626:                             ; preds = %polly.loop_exit618, %polly.loop_exit634
  ...
  %195 = shl nuw nsw i64 %polly.indvar629, 6
  %smin1112 = call i64 @llvm.smin.i64(i64 %indvars.iv1110, i64 -1136)
  %196 = shl nsw i64 %polly.indvar629, 6
...
polly.loop_exit634:                               ; preds = %polly.loop_exit640
  ...
  %indvars.iv.next1097 = add nuw nsw i64 %indvars.iv1096, 64
  %indvars.iv.next1111 = add nsw i64 %indvars.iv1110, -64
  %indvars.iv.next1115 = add nuw nsw i64 %indvars.iv1114, 1
  %exitcond1118.not = icmp eq i64 %polly.indvar_next630, 19
...
polly.loop_header632:                             ; preds = %polly.loop_exit640, %polly.loop_header626
  ...
  %smin1108 = call i64 @llvm.smin.i64(i64 %indvars.iv1092, i64 -936)
  %198 = add nsw i64 %smin1108, 1000
  %199 = shl nsw i64 %polly.indvar635, 6
...
polly.loop_exit640:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1117.not = icmp eq i64 %polly.indvar_next636, 16
...
polly.loop_header638:                             ; preds = %polly.loop_exit646, %polly.loop_header632
  ...
  %200 = mul nsw i64 %polly.indvar641, -64
  %201 = add i64 %195, %200
  %202 = shl nsw i64 %polly.indvar641, 6
...
polly.loop_exit646:                               ; preds = %polly.loop_exit681
  ...
  %indvars.iv.next1099 = add nsw i64 %indvars.iv1098, -64
...
polly.loop_header644:                             ; preds = %polly.loop_exit681, %polly.loop_header638
  ...
  %smin1260 = call i64 @llvm.smin.i64(i64 %205, i64 63)
  %206 = add nsw i64 %smin1260, 1
  %smin1106 = call i64 @llvm.smin.i64(i64 %indvars.iv1100, i64 63)
...
vector.body1259:                                  ; preds = %vector.body1259, %vector.ph1262
  ...
  %wide.load1275 = load <4 x double>, <4 x double>* %226, align 8, !alias.scope !90, !noalias !92
  ...
  store <4 x double> %229, <4 x double>* %230, align 8, !alias.scope !90, !noalias !92
  %index.next1266 = add i64 %index1265, 4
  %231 = icmp eq i64 %index.next1266, %n.vec1264
  br i1 %231, label %middle.block1257, label %vector.body1259, !llvm.loop !101
...
polly.loop_header686.us:                          ; preds = %polly.loop_header686.us.preheader, %polly.loop_header686.us
  ...
  br i1 %exitcond1107.not, label %polly.loop_exit688.loopexit.us, label %polly.loop_header686.us, !llvm.loop !102
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1187
  ...
  store <4 x double> %250, <4 x double>* %255, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %256, label %polly.loop_exit858, label %vector.body1186, !llvm.loop !108
...
polly.loop_header856:                             ; preds = %polly.loop_header850, %polly.loop_header856
  ...
  br i1 %exitcond1146.not, label %polly.loop_exit858, label %polly.loop_header856, !llvm.loop !109
...
vector.body1200:                                  ; preds = %vector.body1200, %vector.ph1203
  ...
  store <4 x double> %279, <4 x double>* %284, align 8, !alias.scope !107, !noalias !110
  ...
  br i1 %285, label %polly.loop_exit885, label %vector.body1200, !llvm.loop !111
...
polly.loop_header883:                             ; preds = %polly.loop_header877, %polly.loop_header883
  ...
  br i1 %exitcond1136.not, label %polly.loop_exit885, label %polly.loop_header883, !llvm.loop !112
...
vector.body1218:                                  ; preds = %vector.body1218, %vector.ph1221
  ...
  store <4 x double> %308, <4 x double>* %313, align 8, !alias.scope !106, !noalias !113
  ...
  br i1 %314, label %polly.loop_exit911, label %vector.body1218, !llvm.loop !114
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  br i1 %exitcond1126.not, label %polly.loop_exit911, label %polly.loop_header909, !llvm.loop !115
}
