; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3523.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3523.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1026.not = icmp eq i64 %130, 60
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %133 = mul nuw nsw i64 %polly.indvar214, 80
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_header233.7, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %polly.loop_guard256 = icmp slt i64 %142, 80
...
polly.loop_header253.us:                          ; preds = %polly.loop_header246.us, %polly.loop_exit263.us
  %indvars.iv1021 = phi i64 [ %131, %polly.loop_header246.us ], [ %indvars.iv.next1022, %polly.loop_exit263.us ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %173 = lshr i64 %polly.indvar398, 2
  %174 = mul nuw nsw i64 %173, 80
  %175 = sub nsw i64 %indvars.iv1033, %174
  %176 = add i64 %indvars.iv1038, %174
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1048.not = icmp eq i64 %198, 60
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1040 = phi i64 [ %indvars.iv.next1041, %polly.loop_exit445 ], [ %176, %polly.loop_header395 ]
  %indvars.iv1035 = phi i64 [ %indvars.iv.next1036, %polly.loop_exit445 ], [ %175, %polly.loop_header395 ]
  %polly.indvar405 = phi i64 [ %polly.indvar_next406, %polly.loop_exit445 ], [ %173, %polly.loop_header395 ]
  %smax1037 = call i64 @llvm.smax.i64(i64 %indvars.iv1035, i64 0)
  %199 = add i64 %smax1037, %indvars.iv1040
  %200 = shl nsw i64 %polly.indvar405, 2
  %.not.not885 = icmp ugt i64 %200, %polly.indvar398
  %201 = mul nuw nsw i64 %polly.indvar405, 80
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_header429.7, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %polly.loop_guard453 = icmp slt i64 %210, 80
...
polly.loop_header450.us:                          ; preds = %polly.loop_header443.us, %polly.loop_exit460.us
  %indvars.iv1042 = phi i64 [ %199, %polly.loop_header443.us ], [ %indvars.iv.next1043, %polly.loop_exit460.us ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %241 = lshr i64 %polly.indvar595, 2
  %242 = mul nuw nsw i64 %241, 80
  %243 = sub nsw i64 %indvars.iv1055, %242
  %244 = add i64 %indvars.iv1060, %242
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1062 = phi i64 [ %indvars.iv.next1063, %polly.loop_exit642 ], [ %244, %polly.loop_header592 ]
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit642 ], [ %243, %polly.loop_header592 ]
  %polly.indvar602 = phi i64 [ %polly.indvar_next603, %polly.loop_exit642 ], [ %241, %polly.loop_header592 ]
  %smax1059 = call i64 @llvm.smax.i64(i64 %indvars.iv1057, i64 0)
  %267 = add i64 %smax1059, %indvars.iv1062
  %268 = shl nsw i64 %polly.indvar602, 2
  %.not.not886 = icmp ugt i64 %268, %polly.indvar595
  %269 = mul nuw nsw i64 %polly.indvar602, 80
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_header626.7, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %polly.loop_guard650 = icmp slt i64 %278, 80
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.us, %polly.loop_exit657.us
  %indvars.iv1064 = phi i64 [ %267, %polly.loop_header640.us ], [ %indvars.iv.next1065, %polly.loop_exit657.us ]
