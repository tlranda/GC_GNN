; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10065.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10065.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv795 = phi i64 [ %indvars.iv.next796, %polly.loop_exit207 ], [ 3, %polly.loop_exit193 ]
  %indvars.iv785 = phi i64 [ %indvars.iv.next786, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %polly.indvar202 = phi i64 [ %polly.indvar_next203, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv795, i64 74)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next796 = add nuw nsw i64 %indvars.iv795, 4
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %129, label %middle.block999, label %vector.body1001, !llvm.loop !73
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv819 = phi i64 [ %indvars.iv.next820, %polly.loop_exit362 ], [ 3, %polly.loop_exit346 ]
  ...
  %umin821 = call i64 @llvm.umin.i64(i64 %indvars.iv819, i64 74)
...
polly.loop_exit362:                               ; preds = %polly.loop_exit368
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next358, 19
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next364, 63
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %wide.load986 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %163, label %middle.block975, label %vector.body977, !llvm.loop !82
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  %indvars.iv844 = phi i64 [ %indvars.iv.next845, %polly.loop_exit519 ], [ 3, %polly.loop_exit503 ]
  ...
  %umin846 = call i64 @llvm.umin.i64(i64 %indvars.iv844, i64 74)
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar_next515, 19
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %smin842 = call i64 @llvm.smin.i64(i64 %indvars.iv840, i64 -984)
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next521, 63
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header523
  ...
  %indvars.iv.next835 = add nsw i64 %indvars.iv834, -16
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %smin838 = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 15)
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  br i1 %211, label %polly.loop_exit712, label %vector.body915, !llvm.loop !91
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %240, label %polly.loop_exit739, label %vector.body930, !llvm.loop !94
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  br i1 %269, label %polly.loop_exit765, label %vector.body948, !llvm.loop !97
