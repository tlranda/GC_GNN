; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7601.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7601.c"
...
polly.loop_header396:                             ; preds = %polly.loop_exit404, %polly.loop_header390
  ...
  %130 = shl nsw i64 %polly.indvar399, 7
...
polly.loop_exit404:                               ; preds = %polly.loop_exit411
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar_next400, 8
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_header567
  ...
  %smin897 = call i64 @llvm.smin.i64(i64 %indvars.iv895, i64 -872)
  %161 = shl nsw i64 %polly.indvar576, 7
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588
  ...
  %exitcond902.not = icmp eq i64 %polly.indvar_next577, 8
