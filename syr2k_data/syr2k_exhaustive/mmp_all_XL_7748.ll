; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7748.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7748.c"
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %polly.loop_guard237 = icmp slt i64 %114, 100
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  ...
  %polly.loop_guard251929 = icmp sgt i64 %117, -1
...
vector.body1038:                                  ; preds = %vector.body1038, %vector.ph1042
  ...
  %130 = shl nuw nsw i64 %index1045, 3
  %131 = getelementptr i8, i8* %scevgep372, i64 %130
  %132 = bitcast i8* %131 to <4 x double>*
  %wide.load1049 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !74, !noalias !76
  %133 = fmul fast <4 x double> %wide.load1049, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %135 = icmp eq i64 %index.next1046, %n.vec1044
  br i1 %135, label %middle.block1036, label %vector.body1038, !llvm.loop !80

middle.block1036:                                 ; preds = %vector.body1038
  %cmp.n1048 = icmp eq i64 %128, %n.vec1044
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %137 = shl nuw nsw i64 %polly.indvar395, 1
  %138 = mul nuw nsw i64 %polly.indvar395, 7
  %139 = add nuw nsw i64 %138, 7
  %pexp.p_div_q404 = lshr i64 %139, 4
  %140 = sub nsw i64 %137, %pexp.p_div_q404
  %polly.loop_guard409 = icmp sgt i64 %140, -2
  %141 = mul nsw i64 %polly.indvar395, -100
  %142 = mul nuw nsw i64 %polly.indvar395, 100
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %151 = shl nsw i64 %polly.indvar410, 6
  %152 = add nsw i64 %151, %141
  %153 = icmp sgt i64 %152, 0
  %154 = select i1 %153, i64 %152, i64 0
  %polly.loop_guard417 = icmp slt i64 %154, 100
...
polly.loop_header414.preheader:                   ; preds = %polly.loop_header406
  ...
  %155 = add i64 %smax862, %indvars.iv865
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %polly.loop_cond412.not = icmp sgt i64 %polly.indvar410, %140
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  %indvars.iv867 = phi i64 [ %155, %polly.loop_header414.preheader ], [ %indvars.iv.next868, %polly.loop_exit423 ]
  ...
  %polly.loop_guard431930 = icmp sgt i64 %157, -1
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %min.iters.check1015 = icmp ult i64 %168, 4
...
vector.body1014:                                  ; preds = %vector.body1014, %vector.ph1016
  ...
  %170 = shl nuw nsw i64 %index1019, 3
  %171 = getelementptr i8, i8* %scevgep552, i64 %170
  %172 = bitcast i8* %171 to <4 x double>*
  %wide.load1023 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !84, !noalias !86
  %173 = fmul fast <4 x double> %wide.load1023, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %175 = icmp eq i64 %index.next1020, %n.vec1018
  br i1 %175, label %middle.block1012, label %vector.body1014, !llvm.loop !90

middle.block1012:                                 ; preds = %vector.body1014
  %cmp.n1022 = icmp eq i64 %168, %n.vec1018
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %177 = shl nuw nsw i64 %polly.indvar575, 1
  %178 = mul nuw nsw i64 %polly.indvar575, 7
  %179 = add nuw nsw i64 %178, 7
  %pexp.p_div_q584 = lshr i64 %179, 4
  %180 = sub nsw i64 %177, %pexp.p_div_q584
  %polly.loop_guard589 = icmp sgt i64 %180, -2
  %181 = mul nsw i64 %polly.indvar575, -100
  %182 = mul nuw nsw i64 %polly.indvar575, 100
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %191 = shl nsw i64 %polly.indvar590, 6
  %192 = add nsw i64 %191, %181
  %193 = icmp sgt i64 %192, 0
  %194 = select i1 %193, i64 %192, i64 0
  %polly.loop_guard597 = icmp slt i64 %194, 100
...
polly.loop_exit596:                               ; preds = %polly.loop_exit603, %polly.loop_header586
  ...
  %polly.loop_cond592.not = icmp sgt i64 %polly.indvar590, %180
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit603
  %indvars.iv887 = phi i64 [ %195, %polly.loop_header594.preheader ], [ %indvars.iv.next888, %polly.loop_exit603 ]
  ...
  %polly.loop_guard611931 = icmp sgt i64 %197, -1
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %smin953 = call i64 @llvm.smin.i64(i64 %210, i64 -1168)
  %211 = add nsw i64 %smin953, 1200
  %smin920 = call i64 @llvm.smin.i64(i64 %indvars.iv918, i64 -1168)
  %212 = shl nsw i64 %polly.indvar767, 5
  %213 = add nsw i64 %smin920, 1199
...
vector.ph954:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert961 = insertelement <4 x i64> poison, i64 %212, i32 0
  %broadcast.splat962 = shufflevector <4 x i64> %broadcast.splatinsert961, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert963 = insertelement <4 x i32> poison, i32 %215, i32 0
...
vector.body952:                                   ; preds = %vector.body952, %vector.ph954
  ...
  %217 = add nuw nsw <4 x i64> %vec.ind959, %broadcast.splat962
  %218 = trunc <4 x i64> %217 to <4 x i32>
  %219 = mul <4 x i32> %broadcast.splat964, %218
  ...
  %229 = icmp eq i64 %index.next956, %211
  br i1 %229, label %polly.loop_exit778, label %vector.body952, !llvm.loop !99

polly.loop_exit778:                               ; preds = %vector.body952, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond925.not = icmp eq i64 %polly.indvar773, %209
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %exitcond921.not = icmp eq i64 %polly.indvar779, %213
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %smin968 = call i64 @llvm.smin.i64(i64 %239, i64 -968)
  %240 = add nsw i64 %smin968, 1000
  %smin910 = call i64 @llvm.smin.i64(i64 %indvars.iv908, i64 -968)
  %241 = shl nsw i64 %polly.indvar794, 5
  %242 = add nsw i64 %smin910, 999
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph970
  ...
  %246 = add nuw nsw <4 x i64> %vec.ind977, %broadcast.splat980
  %247 = trunc <4 x i64> %246 to <4 x i32>
  %248 = mul <4 x i32> %broadcast.splat982, %247
  ...
  %258 = icmp eq i64 %index.next974, %240
  br i1 %258, label %polly.loop_exit805, label %vector.body967, !llvm.loop !102

polly.loop_exit805:                               ; preds = %vector.body967, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond915.not = icmp eq i64 %polly.indvar800, %238
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond911.not = icmp eq i64 %polly.indvar806, %242
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %smin986 = call i64 @llvm.smin.i64(i64 %268, i64 -968)
  %269 = add nsw i64 %smin986, 1000
  %smin900 = call i64 @llvm.smin.i64(i64 %indvars.iv898, i64 -968)
  %270 = shl nsw i64 %polly.indvar820, 5
  %271 = add nsw i64 %smin900, 999
...
vector.body985:                                   ; preds = %vector.body985, %vector.ph988
  ...
  %275 = add nuw nsw <4 x i64> %vec.ind995, %broadcast.splat998
  %276 = trunc <4 x i64> %275 to <4 x i32>
  %277 = mul <4 x i32> %broadcast.splat1000, %276
  ...
  %287 = icmp eq i64 %index.next992, %269
  br i1 %287, label %polly.loop_exit831, label %vector.body985, !llvm.loop !105

polly.loop_exit831:                               ; preds = %vector.body985, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond905.not = icmp eq i64 %polly.indvar826, %267
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar832, %271
