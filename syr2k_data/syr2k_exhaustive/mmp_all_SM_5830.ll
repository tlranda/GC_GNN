; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5830.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5830.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %108 = shl nsw i64 %polly.indvar230, 5
  %109 = sub nsw i64 %103, %108
  %110 = icmp sgt i64 %109, 0
  %111 = select i1 %110, i64 %109, i64 0
  %112 = mul nsw i64 %polly.indvar230, -32
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next231, 38
...
vector.body1068:                                  ; preds = %vector.body1068, %vector.ph1072
  ...
  %wide.load1079 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %135, label %middle.block1066, label %vector.body1068, !llvm.loop !85
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %138 = shl nsw i64 %polly.indvar377, 4
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %143 = shl nsw i64 %polly.indvar383, 2
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %144 = mul nsw i64 %polly.indvar383, -4
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  ...
  %148 = shl nsw i64 %polly.indvar406, 5
  %149 = sub nsw i64 %143, %148
  %150 = icmp sgt i64 %149, 0
  %151 = select i1 %150, i64 %149, i64 0
  %152 = mul nsw i64 %polly.indvar406, -32
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418, %polly.loop_header403
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar_next407, 38
...
vector.body1044:                                  ; preds = %vector.body1044, %vector.ph1046
  ...
  %wide.load1053 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %175, label %middle.block1042, label %vector.body1044, !llvm.loop !95
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %178 = shl nsw i64 %polly.indvar555, 4
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  ...
  %188 = shl nsw i64 %polly.indvar584, 5
  %189 = sub nsw i64 %183, %188
  %190 = icmp sgt i64 %189, 0
  %191 = select i1 %190, i64 %189, i64 0
  %192 = mul nsw i64 %polly.indvar584, -32
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596, %polly.loop_header581
  ...
  %indvars.iv.next912 = add i64 %indvars.iv911, -32
  %indvars.iv.next917 = add i64 %indvars.iv916, 32
  %exitcond924.not = icmp eq i64 %polly.indvar_next585, 38
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph984
  ...
  br i1 %229, label %polly.loop_exit772, label %vector.body983, !llvm.loop !104
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph1000
  ...
  br i1 %258, label %polly.loop_exit799, label %vector.body997, !llvm.loop !107
...
vector.body1015:                                  ; preds = %vector.body1015, %vector.ph1018
  ...
  br i1 %287, label %polly.loop_exit825, label %vector.body1015, !llvm.loop !110
