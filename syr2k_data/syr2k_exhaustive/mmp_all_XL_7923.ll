; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7923.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7923.c"
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1043
  ...
  br i1 %57, label %middle.block1039, label %vector.body1041, !llvm.loop !54
...
vector.body1067:                                  ; preds = %vector.body1067, %vector.ph1069
  ...
  br i1 %68, label %middle.block1065, label %vector.body1067, !llvm.loop !56
...
vector.body1079:                                  ; preds = %vector.body1079, %vector.ph1083
  ...
  %wide.load1090 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !62, !noalias !64
  ...
  br i1 %95, label %middle.block1077, label %vector.body1079, !llvm.loop !68
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond857.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !69
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next225, 20
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249944 = icmp sgt i64 %112, -1
  %113 = add nuw nsw i64 %polly.indvar236, %104
  %114 = mul i64 %113, 8000
  %115 = mul i64 %113, 9600
  br i1 %polly.loop_guard249944, label %polly.loop_header239.us, label %polly.loop_exit241
...
vector.body1053:                                  ; preds = %vector.body1053, %vector.ph1057
  ...
  %126 = shl nuw nsw i64 %index1060, 3
  %127 = getelementptr i8, i8* %scevgep370, i64 %126
  %128 = bitcast i8* %127 to <4 x double>*
  %wide.load1064 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !73, !noalias !75
  %129 = fmul fast <4 x double> %wide.load1064, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %131 = icmp eq i64 %index.next1061, %n.vec1059
  br i1 %131, label %middle.block1051, label %vector.body1053, !llvm.loop !79

middle.block1051:                                 ; preds = %vector.body1053
  %cmp.n1063 = icmp eq i64 %124, %n.vec1059
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  br i1 %exitcond884.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !80
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %133 = udiv i64 %indvars.iv875, 25
  %134 = sub nsw i64 %indvars.iv873, %133
  %smin877 = call i64 @llvm.smin.i64(i64 %134, i64 20)
  %135 = add nsw i64 %smin877, 3
  %smax878 = call i64 @llvm.smax.i64(i64 %135, i64 0)
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412
  ...
  %exitcond880.not = icmp eq i64 %polly.indvar_next400, 20
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %polly.loop_guard413.not = icmp sgt i64 %145, %139
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %146 = add i64 %smax863, %indvars.iv866
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv868 = phi i64 [ %146, %polly.loop_header410.preheader ], [ %indvars.iv.next869, %polly.loop_exit419 ]
  ...
  %polly.loop_guard427945 = icmp sgt i64 %148, -1
  %149 = add nuw nsw i64 %polly.indvar414, %140
  %150 = mul i64 %149, 8000
  %151 = mul i64 %149, 9600
  br i1 %polly.loop_guard427945, label %polly.loop_header417.us, label %polly.loop_exit419
...
polly.loop_exit426.loopexit.us:                   ; preds = %polly.loop_header424.us
  ...
  %exitcond872.not = icmp eq i64 %polly.indvar_next421.us, 50
  br i1 %exitcond872.not, label %polly.loop_exit419, label %polly.loop_header417.us
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1030 = icmp ult i64 %160, 4
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1031
  ...
  %162 = shl nuw nsw i64 %index1034, 3
  %163 = getelementptr i8, i8* %scevgep548, i64 %162
  %164 = bitcast i8* %163 to <4 x double>*
  %wide.load1038 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !83, !noalias !85
  %165 = fmul fast <4 x double> %wide.load1038, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %167 = icmp eq i64 %index.next1035, %n.vec1033
  br i1 %167, label %middle.block1027, label %vector.body1029, !llvm.loop !89

middle.block1027:                                 ; preds = %vector.body1029
  %cmp.n1037 = icmp eq i64 %160, %n.vec1033
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  br i1 %exitcond911.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !90
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %169 = udiv i64 %indvars.iv902, 25
  %170 = sub nsw i64 %indvars.iv900, %169
  %smin904 = call i64 @llvm.smin.i64(i64 %170, i64 20)
  %171 = add nsw i64 %smin904, 3
  %smax905 = call i64 @llvm.smax.i64(i64 %171, i64 0)
  %172 = mul nsw i64 %polly.indvar571, -128
  %173 = icmp slt i64 %172, -1072
  %174 = select i1 %173, i64 %172, i64 -1072
  %175 = add nsw i64 %174, 1199
  %176 = shl nsw i64 %polly.indvar571, 7
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next578, 20
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %polly.loop_guard591.not = icmp sgt i64 %181, %175
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  ...
  %182 = add i64 %smax890, %indvars.iv893
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv895 = phi i64 [ %182, %polly.loop_header588.preheader ], [ %indvars.iv.next896, %polly.loop_exit597 ]
  ...
  %polly.loop_guard605946 = icmp sgt i64 %184, -1
  %185 = add nuw nsw i64 %polly.indvar592, %176
  %186 = mul i64 %185, 8000
  %187 = mul i64 %185, 9600
  br i1 %polly.loop_guard605946, label %polly.loop_header595.us, label %polly.loop_exit597
...
polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  ...
  br i1 %exitcond899.not, label %polly.loop_exit597, label %polly.loop_header595.us
...
polly.loop_exit597:                               ; preds = %polly.loop_exit604.loopexit.us, %polly.loop_header588
  ...
  %polly.loop_cond594.not.not = icmp ult i64 %polly.indvar592, %175
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin968 = call i64 @llvm.smin.i64(i64 %198, i64 -1168)
  %199 = add nsw i64 %smin968, 1200
  %smin935 = call i64 @llvm.smin.i64(i64 %indvars.iv933, i64 -1168)
  %200 = shl nsw i64 %polly.indvar761, 5
  %201 = add nsw i64 %smin935, 1199
...
vector.ph969:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert976 = insertelement <4 x i64> poison, i64 %200, i32 0
  %broadcast.splat977 = shufflevector <4 x i64> %broadcast.splatinsert976, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert978 = insertelement <4 x i32> poison, i32 %203, i32 0
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph969
  ...
  %205 = add nuw nsw <4 x i64> %vec.ind974, %broadcast.splat977
  %206 = trunc <4 x i64> %205 to <4 x i32>
  %207 = mul <4 x i32> %broadcast.splat979, %206
  ...
  %217 = icmp eq i64 %index.next971, %199
  br i1 %217, label %polly.loop_exit772, label %vector.body967, !llvm.loop !98

polly.loop_exit772:                               ; preds = %vector.body967, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond940.not = icmp eq i64 %polly.indvar767, %197
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond936.not = icmp eq i64 %polly.indvar773, %201
  br i1 %exitcond936.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !99
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %227, i64 -968)
  %228 = add nsw i64 %smin983, 1000
  %smin925 = call i64 @llvm.smin.i64(i64 %indvars.iv923, i64 -968)
  %229 = shl nsw i64 %polly.indvar788, 5
  %230 = add nsw i64 %smin925, 999
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph985
  ...
  %234 = add nuw nsw <4 x i64> %vec.ind992, %broadcast.splat995
  %235 = trunc <4 x i64> %234 to <4 x i32>
  %236 = mul <4 x i32> %broadcast.splat997, %235
  ...
  %246 = icmp eq i64 %index.next989, %228
  br i1 %246, label %polly.loop_exit799, label %vector.body982, !llvm.loop !101

polly.loop_exit799:                               ; preds = %vector.body982, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond930.not = icmp eq i64 %polly.indvar794, %226
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond926.not = icmp eq i64 %polly.indvar800, %230
  br i1 %exitcond926.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !102
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1001 = call i64 @llvm.smin.i64(i64 %256, i64 -968)
  %257 = add nsw i64 %smin1001, 1000
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -968)
  %258 = shl nsw i64 %polly.indvar814, 5
  %259 = add nsw i64 %smin915, 999
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  %263 = add nuw nsw <4 x i64> %vec.ind1010, %broadcast.splat1013
  %264 = trunc <4 x i64> %263 to <4 x i32>
  %265 = mul <4 x i32> %broadcast.splat1015, %264
  ...
  %275 = icmp eq i64 %index.next1007, %257
  br i1 %275, label %polly.loop_exit825, label %vector.body1000, !llvm.loop !104

polly.loop_exit825:                               ; preds = %vector.body1000, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond920.not = icmp eq i64 %polly.indvar820, %255
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar826, %259
  br i1 %exitcond916.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !105
}
