; ModuleID = 'syr2k_exhaustive/mmp_all_SM_512.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_512.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %99 = mul nsw i64 %polly.indvar209, -64
  %100 = shl nsw i64 %polly.indvar209, 6
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %exitcond1103.not = icmp eq i64 %polly.indvar_next210, 19
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %105 = shl nuw nsw i64 %indvar1402, 5
  ...
  %107 = shl nsw i64 %polly.indvar231, 5
  %108 = add nsw i64 %107, %99
  %109 = add nsw i64 %108, -1
  %.inv = icmp ugt i64 %108, 63
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us, %polly.loop_header228.split
  %118 = mul nsw i64 %polly.indvar231, -32
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit281.us
  ...
  %smin1404 = call i64 @llvm.smin.i64(i64 %119, i64 63)
  %120 = add nuw nsw i64 %smin1404, 1
  %smin1092 = call i64 @llvm.smin.i64(i64 %indvars.iv1090, i64 63)
...
polly.loop_header416:                             ; preds = %polly.loop_exit440, %polly.loop_header410
  ...
  %157 = shl nsw i64 %polly.indvar419, 6
...
polly.loop_exit440:                               ; preds = %polly.loop_exit479
  ...
  %indvars.iv.next1108 = add nsw i64 %indvars.iv1107, -64
  %indvars.iv.next1126 = add nsw i64 %indvars.iv1125, -64
  %exitcond1135.not = icmp eq i64 %polly.indvar_next420, 19
...
polly.loop_header438:                             ; preds = %polly.loop_exit479, %polly.loop_exit424
  ...
  %162 = shl nuw nsw i64 %indvar1355, 5
  ...
  %164 = shl nsw i64 %polly.indvar441, 5
  %165 = add nsw i64 %164, %156
  %166 = add nsw i64 %165, -1
  %.inv934 = icmp ugt i64 %165, 63
  %167 = select i1 %.inv934, i64 63, i64 %166
...
polly.loop_header477.preheader:                   ; preds = %polly.loop_exit465, %polly.loop_exit465.us, %polly.loop_header438.split
  %175 = mul nsw i64 %polly.indvar441, -32
...
polly.loop_header484.us:                          ; preds = %polly.loop_header477.us, %polly.loop_exit493.us
  ...
  %smin1357 = call i64 @llvm.smin.i64(i64 %176, i64 63)
  %177 = add nuw nsw i64 %smin1357, 1
  %smin1123 = call i64 @llvm.smin.i64(i64 %indvars.iv1121, i64 63)
...
polly.loop_header628:                             ; preds = %polly.loop_exit652, %polly.loop_header622
  ...
  %213 = mul nsw i64 %polly.indvar631, -64
  %214 = shl nsw i64 %polly.indvar631, 6
...
polly.loop_exit652:                               ; preds = %polly.loop_exit691
  ...
  %indvars.iv.next1140 = add nsw i64 %indvars.iv1139, -64
  %indvars.iv.next1158 = add nsw i64 %indvars.iv1157, -64
  %exitcond1167.not = icmp eq i64 %polly.indvar_next632, 19
...
polly.loop_header650:                             ; preds = %polly.loop_exit691, %polly.loop_exit636
  ...
  %219 = shl nuw nsw i64 %indvar1308, 5
  ...
  %221 = shl nsw i64 %polly.indvar653, 5
  %222 = add nsw i64 %221, %213
  %223 = add nsw i64 %222, -1
  %.inv935 = icmp ugt i64 %222, 63
  %224 = select i1 %.inv935, i64 63, i64 %223
...
polly.loop_header689.preheader:                   ; preds = %polly.loop_exit677, %polly.loop_exit677.us, %polly.loop_header650.split
  %232 = mul nsw i64 %polly.indvar653, -32
...
polly.loop_header696.us:                          ; preds = %polly.loop_header689.us, %polly.loop_exit705.us
  ...
  %smin1310 = call i64 @llvm.smin.i64(i64 %233, i64 63)
  %234 = add nuw nsw i64 %smin1310, 1
  %smin1155 = call i64 @llvm.smin.i64(i64 %indvars.iv1153, i64 63)
