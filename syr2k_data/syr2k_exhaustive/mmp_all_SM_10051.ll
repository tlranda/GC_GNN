; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10051.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10051.c"
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %114 = mul nsw i64 %polly.indvar214.us, 100
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %.inv780 = icmp slt i64 %142, 11
  %144 = select i1 %.inv780, i64 %143, i64 11
  %polly.loop_guard373 = icmp sgt i64 %144, -1
  %145 = mul nsw i64 %polly.indvar359, -64
  %146 = icmp slt i64 %145, -1136
  %147 = select i1 %146, i64 %145, i64 -1136
  %148 = add nsw i64 %147, 1199
  %149 = shl nsw i64 %polly.indvar359, 6
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %157 = mul nsw i64 %polly.indvar374.us, 100
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %.inv781 = icmp slt i64 %185, 11
  %187 = select i1 %.inv781, i64 %186, i64 11
  %polly.loop_guard533 = icmp sgt i64 %187, -1
  %188 = mul nsw i64 %polly.indvar519, -64
  %189 = icmp slt i64 %188, -1136
  %190 = select i1 %189, i64 %188, i64 -1136
  %191 = add nsw i64 %190, 1199
  %192 = shl nsw i64 %polly.indvar519, 6
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %200 = mul nsw i64 %polly.indvar534.us, 100
