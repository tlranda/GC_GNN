; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2118.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2118.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %smin1045 = call i64 @llvm.smin.i64(i64 %indvars.iv1043, i64 -1136)
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %101 = mul nsw i64 %polly.indvar231, -64
  %102 = add i64 %97, %101
  %103 = shl nsw i64 %polly.indvar231, 6
...
polly.loop_header234:                             ; preds = %polly.loop_exit265, %polly.loop_header228
  ...
  %smin1335 = call i64 @llvm.smin.i64(i64 %106, i64 63)
  %107 = add nsw i64 %smin1335, 1
  %smin1040 = call i64 @llvm.smin.i64(i64 %indvars.iv1036, i64 63)
...
polly.loop_header418:                             ; preds = %polly.loop_exit410, %polly.loop_exit426
  ...
  %145 = shl nuw nsw i64 %polly.indvar421, 6
  %smin1071 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 -1136)
...
polly.loop_exit426:                               ; preds = %polly.loop_exit432
  ...
  %indvars.iv.next1058 = add nuw nsw i64 %indvars.iv1057, 64
  %indvars.iv.next1070 = add nsw i64 %indvars.iv1069, -64
  %indvars.iv.next1074 = add nuw nsw i64 %indvars.iv1073, 1
  %exitcond1077.not = icmp eq i64 %polly.indvar_next422, 19
...
polly.loop_exit432:                               ; preds = %polly.loop_exit438
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar_next428, 20
...
polly.loop_header430:                             ; preds = %polly.loop_exit438, %polly.loop_header424
  ...
  %149 = mul nsw i64 %polly.indvar433, -64
  %150 = add i64 %145, %149
  %151 = shl nsw i64 %polly.indvar433, 6
  %152 = sub nsw i64 %146, %151
  %153 = add nuw nsw i64 %151, 64
...
polly.loop_header436:                             ; preds = %polly.loop_exit473, %polly.loop_header430
  ...
  %smin1290 = call i64 @llvm.smin.i64(i64 %154, i64 63)
...
polly.merge461.us:                                ; preds = %polly.then462.us, %polly.cond460.loopexit.us
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next446.us, 50
...
polly.loop_header442:                             ; preds = %polly.loop_header436.split, %polly.loop_header442
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next446, 50
...
polly.loop_exit480.loopexit.us:                   ; preds = %polly.loop_header478.us, %middle.block1287
  ...
  %exitcond1068.not = icmp eq i64 %polly.indvar_next475.us, 50
...
polly.loop_header626:                             ; preds = %polly.loop_exit618, %polly.loop_exit634
  ...
  %193 = shl nuw nsw i64 %polly.indvar629, 6
  %smin1097 = call i64 @llvm.smin.i64(i64 %indvars.iv1095, i64 -1136)
  %194 = shl nsw i64 %polly.indvar629, 6
...
polly.loop_exit634:                               ; preds = %polly.loop_exit640
  ...
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 64
  %indvars.iv.next1096 = add nsw i64 %indvars.iv1095, -64
  %indvars.iv.next1100 = add nuw nsw i64 %indvars.iv1099, 1
  %exitcond1103.not = icmp eq i64 %polly.indvar_next630, 19
...
polly.loop_header632:                             ; preds = %polly.loop_exit640, %polly.loop_header626
  ...
  %196 = mul nuw nsw i64 %polly.indvar635, 50
...
polly.loop_exit640:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1102.not = icmp eq i64 %polly.indvar_next636, 20
...
polly.loop_header638:                             ; preds = %polly.loop_exit646, %polly.loop_header632
  ...
  %197 = mul nsw i64 %polly.indvar641, -64
  %198 = add i64 %193, %197
  %199 = shl nsw i64 %polly.indvar641, 6
  %200 = sub nsw i64 %194, %199
  %201 = add nuw nsw i64 %199, 64
...
polly.loop_header644:                             ; preds = %polly.loop_exit681, %polly.loop_header638
  ...
  %smin1245 = call i64 @llvm.smin.i64(i64 %202, i64 63)
  %203 = add nsw i64 %smin1245, 1
  %smin1092 = call i64 @llvm.smin.i64(i64 %indvars.iv1087, i64 63)
...
polly.merge669.us:                                ; preds = %polly.then670.us, %polly.cond668.loopexit.us
  ...
  %exitcond1091.not = icmp eq i64 %polly.indvar_next654.us, 50
...
polly.loop_header650:                             ; preds = %polly.loop_header644.split, %polly.loop_header650
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar_next654, 50
...
polly.loop_exit688.loopexit.us:                   ; preds = %polly.loop_header686.us, %middle.block1242
  ...
  %exitcond1094.not = icmp eq i64 %polly.indvar_next683.us, 50
