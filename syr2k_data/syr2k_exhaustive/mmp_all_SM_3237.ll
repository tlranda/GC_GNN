; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3237.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3237.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit252
  ...
  %.inv = icmp sgt i64 %110, 19
  %112 = select i1 %.inv, i64 19, i64 %111
...
polly.loop_header399:                             ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %152 = shl nuw nsw i64 %indvars.iv1034, 2
  %153 = and i64 %152, 9223372036854775776
  ...
  %polly.loop_guard410 = icmp slt i64 %156, 38
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  ...
  %159 = mul nsw i64 %polly.indvar402, -20
  %160 = mul nuw nsw i64 %polly.indvar402, 20
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit449
  ...
  %163 = shl nsw i64 %polly.indvar411, 5
  %164 = add nsw i64 %163, %159
  %165 = add nsw i64 %164, -1
  %.inv889 = icmp sgt i64 %164, 19
  %166 = select i1 %.inv889, i64 19, i64 %165
...
polly.loop_header447.preheader:                   ; preds = %polly.loop_exit435, %polly.loop_exit435.us, %polly.loop_header407.split
  ...
  %179 = mul nsw i64 %polly.indvar411, -32
...
polly.loop_header596:                             ; preds = %polly.loop_exit606, %polly.loop_header590
  ...
  %206 = shl nuw nsw i64 %indvars.iv1057, 2
  %207 = and i64 %206, 9223372036854775776
  ...
  %polly.loop_guard607 = icmp slt i64 %210, 38
...
polly.loop_header604.preheader:                   ; preds = %polly.loop_header596
  ...
  %213 = mul nsw i64 %polly.indvar599, -20
  %214 = mul nuw nsw i64 %polly.indvar599, 20
...
polly.loop_header604:                             ; preds = %polly.loop_header604.preheader, %polly.loop_exit646
  ...
  %217 = shl nsw i64 %polly.indvar608, 5
  %218 = add nsw i64 %217, %213
  %219 = add nsw i64 %218, -1
  %.inv890 = icmp sgt i64 %218, 19
  %220 = select i1 %.inv890, i64 19, i64 %219
...
polly.loop_header644.preheader:                   ; preds = %polly.loop_exit632, %polly.loop_exit632.us, %polly.loop_header604.split
  ...
  %233 = mul nsw i64 %polly.indvar608, -32
