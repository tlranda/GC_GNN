; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8823.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8823.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond789.not = icmp eq i64 %polly.indvar_next203, 150
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %109 = icmp slt i64 %108, -1136
  %110 = select i1 %109, i64 %108, i64 -1136
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %indvars.iv.next780 = add i64 %indvars.iv779, -64
  %indvars.iv.next784 = add i64 %indvars.iv783, 64
  %exitcond788.not = icmp eq i64 %polly.indvar_next209, 19
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %130 = lshr i64 %polly.indvar355, 3
  %131 = shl nuw nsw i64 %130, 6
...
polly.loop_exit361:                               ; preds = %polly.loop_exit367
  ...
  %exitcond807.not = icmp eq i64 %polly.indvar_next356, 150
...
polly.loop_header359:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %137 = shl nsw i64 %polly.indvar362, 6
  %138 = sub nsw i64 %134, %137
  %139 = icmp sgt i64 %138, 0
  %140 = select i1 %139, i64 %138, i64 0
  %141 = mul nsw i64 %polly.indvar362, -64
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header359
  ...
  %indvars.iv.next795 = add i64 %indvars.iv794, -64
  %indvars.iv.next800 = add i64 %indvars.iv799, 64
  %exitcond806.not = icmp eq i64 %polly.indvar_next363, 19
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %163 = lshr i64 %polly.indvar511, 3
  %164 = shl nuw nsw i64 %163, 6
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next512, 150
...
polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %170 = shl nsw i64 %polly.indvar518, 6
  %171 = sub nsw i64 %167, %170
  %172 = icmp sgt i64 %171, 0
  %173 = select i1 %172, i64 %171, i64 0
  %174 = mul nsw i64 %polly.indvar518, -64
...
polly.loop_exit523:                               ; preds = %polly.loop_exit530, %polly.loop_header515
  ...
  %indvars.iv.next813 = add i64 %indvars.iv812, -64
  %indvars.iv.next818 = add i64 %indvars.iv817, 64
  %exitcond824.not = icmp eq i64 %polly.indvar_next519, 19
