; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5275.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5275.c"
...
polly.loop_header389:                             ; preds = %polly.loop_exit397, %polly.loop_header383
  ...
  %141 = shl nsw i64 %polly.indvar392, 6
...
polly.loop_exit397:                               ; preds = %polly.loop_exit404
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next393, 16
...
polly.loop_header579:                             ; preds = %polly.loop_exit587, %polly.loop_header573
  ...
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1031, i64 -936)
  %178 = add nsw i64 %smin1052, 1000
  %179 = shl nsw i64 %polly.indvar582, 6
...
polly.loop_exit587:                               ; preds = %polly.loop_exit594
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next583, 16
