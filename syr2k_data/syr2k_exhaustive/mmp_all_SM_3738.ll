; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3738.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3738.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1023 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -872)
...
vector.body1235:                                  ; preds = %vector.body1235, %vector.ph1239
  ...
  %wide.load1246 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %149, label %middle.block1233, label %vector.body1235, !llvm.loop !84
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_header381
  ...
  br i1 %exitcond1053.not, label %polly.loop_exit383, label %polly.loop_header381, !llvm.loop !85
...
polly.loop_header391:                             ; preds = %polly.loop_header391.preheader, %polly.loop_exit399
  ...
  %smin1049 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 -872)
  %151 = add nsw i64 %smin1049, 1000
  %152 = shl nsw i64 %polly.indvar394, 7
...
polly.loop_exit399:                               ; preds = %polly.loop_exit406
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar_next395, 8
...
vector.body1211:                                  ; preds = %vector.body1211, %vector.ph1213
  ...
  %wide.load1220 = load <4 x double>, <4 x double>* %200, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %203, label %middle.block1209, label %vector.body1211, !llvm.loop !94
...
polly.loop_header576:                             ; preds = %polly.loop_header576.preheader, %polly.loop_header576
  ...
  br i1 %exitcond1079.not, label %polly.loop_exit578, label %polly.loop_header576, !llvm.loop !95
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %smin1075 = call i64 @llvm.smin.i64(i64 %indvars.iv1055, i64 -872)
...
polly.loop_exit594:                               ; preds = %polly.loop_exit601
  ...
  %exitcond1078.not = icmp eq i64 %polly.indvar_next590, 8
...
vector.body1150:                                  ; preds = %vector.body1150, %vector.ph1151
  ...
  br i1 %271, label %polly.loop_exit823, label %vector.body1150, !llvm.loop !103
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  br i1 %exitcond1104.not, label %polly.loop_exit823, label %polly.loop_header821, !llvm.loop !104
...
vector.body1164:                                  ; preds = %vector.body1164, %vector.ph1167
  ...
  br i1 %300, label %polly.loop_exit850, label %vector.body1164, !llvm.loop !106
...
polly.loop_header848:                             ; preds = %polly.loop_header842, %polly.loop_header848
  ...
  br i1 %exitcond1094.not, label %polly.loop_exit850, label %polly.loop_header848, !llvm.loop !107
...
vector.body1182:                                  ; preds = %vector.body1182, %vector.ph1185
  ...
  br i1 %329, label %polly.loop_exit876, label %vector.body1182, !llvm.loop !109
...
polly.loop_header874:                             ; preds = %polly.loop_header868, %polly.loop_header874
  ...
  br i1 %exitcond1084.not, label %polly.loop_exit876, label %polly.loop_header874, !llvm.loop !110
}
