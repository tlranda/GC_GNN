; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5608.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5608.c"
...
vector.body1022:                                  ; preds = %vector.body1022, %vector.ph1026
  ...
  %wide.load1033 = load <4 x double>, <4 x double>* %120, align 8, !alias.scope !79, !noalias !81
  ...
  store <4 x double> %121, <4 x double>* %122, align 8, !alias.scope !79, !noalias !81
  %index.next1030 = add i64 %index1029, 4
  %123 = icmp eq i64 %index.next1030, %n.vec1028
  br i1 %123, label %middle.block1020, label %vector.body1022, !llvm.loop !85
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %125 = mul nuw nsw i64 %polly.indvar375, 20
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %126 = shl nsw i64 %polly.indvar381, 7
  br label %polly.loop_header384

polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %127 = mul nsw i64 %polly.indvar381, -128
  %128 = shl nsw i64 %polly.indvar381, 3
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1000
  ...
  %wide.load1007 = load <4 x double>, <4 x double>* %148, align 8, !alias.scope !89, !noalias !91
  ...
  store <4 x double> %149, <4 x double>* %150, align 8, !alias.scope !89, !noalias !91
  %index.next1004 = add i64 %index1003, 4
  %151 = icmp eq i64 %index.next1004, %n.vec1002
  br i1 %151, label %middle.block996, label %vector.body998, !llvm.loop !95
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %153 = mul nuw nsw i64 %polly.indvar548, 20
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %154 = shl nsw i64 %polly.indvar554, 7
  br label %polly.loop_header557

polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %155 = mul nsw i64 %polly.indvar554, -128
  %156 = shl nsw i64 %polly.indvar554, 3
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  store <4 x double> %187, <4 x double>* %192, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %193, label %polly.loop_exit760, label %vector.body936, !llvm.loop !104
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  store <4 x double> %216, <4 x double>* %221, align 8, !alias.scope !103, !noalias !106
  ...
  br i1 %222, label %polly.loop_exit787, label %vector.body951, !llvm.loop !107
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph972
  ...
  store <4 x double> %245, <4 x double>* %250, align 8, !alias.scope !102, !noalias !109
  ...
  br i1 %251, label %polly.loop_exit813, label %vector.body969, !llvm.loop !110
