; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7562.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7562.c"
...
vector.body1038:                                  ; preds = %vector.body1038, %vector.ph1042
  ...
  %wide.load1049 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %128, label %middle.block1036, label %vector.body1038, !llvm.loop !79
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %130 = shl nuw nsw i64 %polly.indvar395, 1
  %131 = add nuw nsw i64 %130, 2
  %pexp.p_div_q404 = udiv i64 %131, 5
  %132 = sub nsw i64 %130, %pexp.p_div_q404
  %polly.loop_guard409 = icmp sgt i64 %132, -2
  %133 = mul nsw i64 %polly.indvar395, -80
  %134 = mul nuw nsw i64 %polly.indvar395, 80
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  %135 = mul nuw nsw i64 %polly.indvar401, 50
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %136 = mul nuw nsw i64 %polly.indvar410, 50
...
vector.body1014:                                  ; preds = %vector.body1014, %vector.ph1016
  ...
  %wide.load1023 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %161, label %middle.block1012, label %vector.body1014, !llvm.loop !89
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %163 = shl nuw nsw i64 %polly.indvar575, 1
  %164 = add nuw nsw i64 %163, 2
  %pexp.p_div_q584 = udiv i64 %164, 5
  %165 = sub nsw i64 %163, %pexp.p_div_q584
  %polly.loop_guard589 = icmp sgt i64 %165, -2
  %166 = mul nsw i64 %polly.indvar575, -80
  %167 = mul nuw nsw i64 %polly.indvar575, 80
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  %168 = mul nuw nsw i64 %polly.indvar581, 50
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %169 = mul nuw nsw i64 %polly.indvar590, 50
...
vector.body952:                                   ; preds = %vector.body952, %vector.ph954
  ...
  br i1 %208, label %polly.loop_exit778, label %vector.body952, !llvm.loop !98
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph970
  ...
  br i1 %237, label %polly.loop_exit805, label %vector.body967, !llvm.loop !101
...
vector.body985:                                   ; preds = %vector.body985, %vector.ph988
  ...
  br i1 %266, label %polly.loop_exit831, label %vector.body985, !llvm.loop !104
