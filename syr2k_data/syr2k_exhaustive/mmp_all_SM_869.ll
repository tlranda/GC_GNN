; ModuleID = 'syr2k_exhaustive/mmp_all_SM_869.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_869.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %117 = mul nsw i64 %indvar1415, -80
  %118 = add i64 %102, %117
  %smax1417 = call i64 @llvm.smax.i64(i64 %118, i64 0)
  %119 = mul nuw nsw i64 %indvar1415, 80
  %120 = add i64 %104, %119
