; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9916.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9916.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv785, i64 79)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %127 = udiv i64 %indvars.iv808, 5
  %umin810 = call i64 @llvm.umin.i64(i64 %127, i64 14)
...
polly.loop_header366:                             ; preds = %polly.loop_header366.preheader, %polly.loop_exit375
  ...
  %smin805 = call i64 @llvm.smin.i64(i64 %indvars.iv803, i64 79)
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  %indvars.iv829 = phi i64 [ %indvars.iv.next830, %polly.loop_exit517 ], [ 1, %polly.loop_exit500 ]
  ...
  %157 = udiv i64 %indvars.iv829, 5
  %umin831 = call i64 @llvm.umin.i64(i64 %157, i64 14)
...
polly.loop_exit517:                               ; preds = %polly.loop_exit524
  ...
  %indvars.iv.next830 = add nuw nsw i64 %indvars.iv829, 2
...
polly.loop_header515:                             ; preds = %polly.loop_exit524, %polly.loop_header508
  ...
  %163 = mul nuw nsw i64 %polly.indvar518, 80
