; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1110.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1110.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %105 = mul nsw i64 %polly.indvar209, -44
  %106 = mul nuw nsw i64 %polly.indvar209, 11
  %107 = add nuw i64 %106, 24
  %108 = udiv i64 %107, 25
  %109 = mul nuw nsw i64 %108, 100
  %110 = add i64 %105, %109
  %111 = mul nuw nsw i64 %polly.indvar209, 44
  %112 = sub nsw i64 %111, %109
  %113 = shl nuw nsw i64 %polly.indvar209, 11
  %114 = mul nsw i64 %polly.indvar209, -44
  %115 = mul nuw nsw i64 %polly.indvar209, 11
  %116 = add nuw i64 %115, 24
  %117 = udiv i64 %116, 25
  %118 = mul nuw nsw i64 %117, 100
  %119 = add i64 %114, %118
  %120 = mul nuw nsw i64 %polly.indvar209, 300
  %121 = sub nsw i64 %120, %118
  %122 = or i64 %113, 8
  %123 = mul nuw nsw i64 %polly.indvar209, 44
  ...
  %129 = shl nsw i64 %polly.indvar209, 8
...
polly.loop_header228:                             ; preds = %polly.loop_exit220.7, %polly.loop_exit269
  ...
  %131 = mul nsw i64 %indvar1426, -100
  %132 = add i64 %110, %131
  %smax1445 = call i64 @llvm.smax.i64(i64 %132, i64 0)
  %133 = mul nuw nsw i64 %indvar1426, 100
  %134 = add i64 %112, %133
  %135 = add i64 %smax1445, %134
  %136 = mul nsw i64 %indvar1426, -100
  %137 = add i64 %119, %136
  %smax1428 = call i64 @llvm.smax.i64(i64 %137, i64 0)
  %138 = mul nuw nsw i64 %indvar1426, 100
  %139 = add i64 %121, %138
...
polly.loop_header267.preheader:                   ; preds = %polly.loop_header253.7, %polly.loop_header253.us.7, %polly.loop_exit243.loopexit.us.7, %polly.loop_header228.split
  ...
  %polly.loop_guard277 = icmp slt i64 %158, 100
...
polly.loop_header274.us:                          ; preds = %polly.loop_header267.us, %polly.loop_exit284.us
  ...
  %smin1446 = call i64 @llvm.smin.i64(i64 %161, i64 255)
  ...
  %smin1433 = call i64 @llvm.smin.i64(i64 %166, i64 255)
...
polly.loop_header420:                             ; preds = %polly.loop_exit446, %polly.loop_header414
  ...
  %209 = mul nsw i64 %polly.indvar423, -44
  %210 = mul nuw nsw i64 %polly.indvar423, 11
  %211 = add nuw i64 %210, 24
  %212 = udiv i64 %211, 25
  %213 = mul nuw nsw i64 %212, 100
  %214 = add i64 %209, %213
  %215 = mul nuw nsw i64 %polly.indvar423, 44
  %216 = sub nsw i64 %215, %213
  %217 = shl nuw nsw i64 %polly.indvar423, 11
  %218 = mul nsw i64 %polly.indvar423, -44
  %219 = mul nuw nsw i64 %polly.indvar423, 11
  %220 = add nuw i64 %219, 24
  %221 = udiv i64 %220, 25
  %222 = mul nuw nsw i64 %221, 100
  %223 = add i64 %218, %222
  %224 = mul nuw nsw i64 %polly.indvar423, 300
  %225 = sub nsw i64 %224, %222
  %226 = or i64 %217, 8
  %227 = mul nuw nsw i64 %polly.indvar423, 44
  ...
  %233 = shl nsw i64 %polly.indvar423, 8
...
polly.loop_header444:                             ; preds = %polly.loop_exit434.7, %polly.loop_exit486
  ...
  %235 = mul nsw i64 %indvar1363, -100
  %236 = add i64 %214, %235
  %smax1382 = call i64 @llvm.smax.i64(i64 %236, i64 0)
  %237 = mul nuw nsw i64 %indvar1363, 100
  %238 = add i64 %216, %237
  %239 = add i64 %smax1382, %238
  %240 = mul nsw i64 %indvar1363, -100
  %241 = add i64 %223, %240
  %smax1365 = call i64 @llvm.smax.i64(i64 %241, i64 0)
  %242 = mul nuw nsw i64 %indvar1363, 100
  %243 = add i64 %225, %242
  ...
  %251 = mul nsw i64 %polly.indvar448, 100
  %252 = add nsw i64 %251, %527
  %253 = add nsw i64 %252, -1
  %.inv948 = icmp sgt i64 %252, 255
  %254 = select i1 %.inv948, i64 255, i64 %253
  %polly.loop_guard461 = icmp sgt i64 %254, -1
  %255 = icmp sgt i64 %252, 0
  %256 = select i1 %255, i64 %252, i64 0
  %257 = add nsw i64 %252, 99
...
polly.loop_header484.preheader:                   ; preds = %polly.loop_header470.7, %polly.loop_header470.us.7, %polly.loop_exit460.loopexit.us.7, %polly.loop_header444.split
  ...
  %polly.loop_guard494 = icmp slt i64 %262, 100
...
polly.loop_header491.us:                          ; preds = %polly.loop_header484.us, %polly.loop_exit501.us
  ...
  %smin1383 = call i64 @llvm.smin.i64(i64 %265, i64 255)
  ...
  %smin1370 = call i64 @llvm.smin.i64(i64 %270, i64 255)
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %313 = mul nsw i64 %polly.indvar640, -44
  %314 = mul nuw nsw i64 %polly.indvar640, 11
  %315 = add nuw i64 %314, 24
  %316 = udiv i64 %315, 25
  %317 = mul nuw nsw i64 %316, 100
  %318 = add i64 %313, %317
  %319 = mul nuw nsw i64 %polly.indvar640, 44
  %320 = sub nsw i64 %319, %317
  %321 = shl nuw nsw i64 %polly.indvar640, 11
  %322 = mul nsw i64 %polly.indvar640, -44
  %323 = mul nuw nsw i64 %polly.indvar640, 11
  %324 = add nuw i64 %323, 24
  %325 = udiv i64 %324, 25
  %326 = mul nuw nsw i64 %325, 100
  %327 = add i64 %322, %326
  %328 = mul nuw nsw i64 %polly.indvar640, 300
  %329 = sub nsw i64 %328, %326
  %330 = or i64 %321, 8
  %331 = mul nuw nsw i64 %polly.indvar640, 44
  ...
  %337 = shl nsw i64 %polly.indvar640, 8
...
polly.loop_header661:                             ; preds = %polly.loop_exit651.7, %polly.loop_exit703
  ...
  %339 = mul nsw i64 %indvar1300, -100
  %340 = add i64 %318, %339
  %smax1319 = call i64 @llvm.smax.i64(i64 %340, i64 0)
  %341 = mul nuw nsw i64 %indvar1300, 100
  %342 = add i64 %320, %341
  %343 = add i64 %smax1319, %342
  %344 = mul nsw i64 %indvar1300, -100
  %345 = add i64 %327, %344
  %smax1302 = call i64 @llvm.smax.i64(i64 %345, i64 0)
  %346 = mul nuw nsw i64 %indvar1300, 100
  %347 = add i64 %329, %346
  ...
  %355 = mul nsw i64 %polly.indvar665, 100
  %356 = add nsw i64 %355, %560
  %357 = add nsw i64 %356, -1
  %.inv949 = icmp sgt i64 %356, 255
  %358 = select i1 %.inv949, i64 255, i64 %357
  %polly.loop_guard678 = icmp sgt i64 %358, -1
  %359 = icmp sgt i64 %356, 0
  %360 = select i1 %359, i64 %356, i64 0
  %361 = add nsw i64 %356, 99
...
polly.loop_header701.preheader:                   ; preds = %polly.loop_header687.7, %polly.loop_header687.us.7, %polly.loop_exit677.loopexit.us.7, %polly.loop_header661.split
  ...
  %polly.loop_guard711 = icmp slt i64 %366, 100
...
polly.loop_header708.us:                          ; preds = %polly.loop_header701.us, %polly.loop_exit718.us
  ...
  %smin1320 = call i64 @llvm.smin.i64(i64 %369, i64 255)
  ...
  %smin1307 = call i64 @llvm.smin.i64(i64 %374, i64 255)
...
polly.loop_exit220.7:                             ; preds = %polly.loop_header218.7
  %494 = mul nsw i64 %polly.indvar209, -256
  ...
  %polly.loop_guard = icmp slt i64 %498, 12
...
polly.loop_exit434.7:                             ; preds = %polly.loop_header432.7
  %527 = mul nsw i64 %polly.indvar423, -256
  ...
  %polly.loop_guard447 = icmp slt i64 %531, 12
...
polly.loop_exit651.7:                             ; preds = %polly.loop_header649.7
  %560 = mul nsw i64 %polly.indvar640, -256
  ...
  %polly.loop_guard664 = icmp slt i64 %564, 12
