; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8478.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8478.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %109 = mul nuw nsw i64 %polly.indvar208, 3
...
polly.loop_header223.1:                           ; preds = %polly.loop_exit232, %polly.loop_exit232.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv793.1, i64 99)
...
polly.loop_header223.2:                           ; preds = %polly.loop_exit232.1, %polly.loop_exit232.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv793.2, i64 99)
...
polly.loop_header223.3:                           ; preds = %polly.loop_exit232.2, %polly.loop_exit232.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv793.3, i64 99)
...
polly.loop_header380.1:                           ; preds = %polly.loop_exit390, %polly.loop_exit390.1
  ...
  %smin813.1 = call i64 @llvm.smin.i64(i64 %indvars.iv811.1, i64 99)
...
polly.loop_header380.2:                           ; preds = %polly.loop_exit390.1, %polly.loop_exit390.2
  ...
  %smin813.2 = call i64 @llvm.smin.i64(i64 %indvars.iv811.2, i64 99)
...
polly.loop_header380.3:                           ; preds = %polly.loop_exit390.2, %polly.loop_exit390.3
  ...
  %smin813.3 = call i64 @llvm.smin.i64(i64 %indvars.iv811.3, i64 99)
...
polly.loop_header538.1:                           ; preds = %polly.loop_exit548, %polly.loop_exit548.1
  ...
  %smin833.1 = call i64 @llvm.smin.i64(i64 %indvars.iv831.1, i64 99)
...
polly.loop_header538.2:                           ; preds = %polly.loop_exit548.1, %polly.loop_exit548.2
  ...
  %smin833.2 = call i64 @llvm.smin.i64(i64 %indvars.iv831.2, i64 99)
...
polly.loop_header538.3:                           ; preds = %polly.loop_exit548.2, %polly.loop_exit548.3
  ...
  %smin833.3 = call i64 @llvm.smin.i64(i64 %indvars.iv831.3, i64 99)
