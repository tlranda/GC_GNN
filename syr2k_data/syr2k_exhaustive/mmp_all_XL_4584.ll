; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4584.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4584.c"
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond1029.not = icmp eq i64 %polly.indvar_next393, 8
...
polly.loop_header580:                             ; preds = %polly.loop_exit589, %polly.loop_header574
  ...
  %smin1054 = call i64 @llvm.smin.i64(i64 %indvars.iv1033, i64 -872)
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next584, 8
