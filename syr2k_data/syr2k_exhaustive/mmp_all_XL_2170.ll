; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2170.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2170.c"
...
vector.body1147:                                  ; preds = %vector.body1147, %vector.ph1148
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call854, i64 %indvars.iv7.i, i64 %index1149
...
vector.body1209:                                  ; preds = %vector.body1209, %vector.ph1211
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call854, i64 %indvars.iv21.i, i64 %index1214
...
vector.body1254:                                  ; preds = %vector.body1254, %vector.ph1256
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call854, i64 %indvars.iv21.i52, i64 %index1259
...
vector.body1302:                                  ; preds = %vector.body1302, %vector.ph1304
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call854, i64 %indvars.iv21.i91, i64 %index1307
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %99 = udiv i64 %polly.indvar219, 5
  %100 = add nuw i64 %indvars.iv1034, %99
  %umin = call i64 @llvm.umin.i64(i64 %100, i64 56)
  %101 = mul nsw i64 %polly.indvar219, -64
  %102 = icmp slt i64 %101, -1136
  %103 = select i1 %102, i64 %101, i64 -1136
  %104 = add nsw i64 %103, 1199
  %105 = shl nsw i64 %polly.indvar219, 6
  %106 = add nuw nsw i64 %umin, 3
  br label %polly.loop_header222

polly.loop_exit224:                               ; preds = %polly.loop_exit230
  %polly.indvar_next220 = add nuw nsw i64 %polly.indvar219, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -64
  %indvars.iv.next1024 = add nuw nsw i64 %indvars.iv1023, 64
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %108 = add i64 %97, %107
  %smax1329 = call i64 @llvm.smax.i64(i64 %108, i64 0)
  %109 = mul nsw i64 %polly.indvar225, -20
  %110 = add i64 %98, %109
  %111 = add i64 %smax1329, %110
...
polly.loop_exit230:                               ; preds = %polly.loop_exit261, %polly.loop_header222
  ...
  %exitcond1036.not = icmp eq i64 %polly.indvar225, %106
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  %indvar1330 = phi i64 [ 0, %polly.loop_header228.preheader ], [ %indvar.next1331, %polly.loop_exit261 ]
  ...
  %119 = add i64 %111, %indvar1330
  %smin1332 = call i64 @llvm.smin.i64(i64 %119, i64 19)
  %120 = add nsw i64 %smin1332, 1
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 19)
  %121 = add nsw i64 %polly.indvar231, %117
  %polly.loop_guard2441130 = icmp sgt i64 %121, -1
  %122 = add nuw nsw i64 %polly.indvar231, %105
  %.not = icmp ult i64 %122, %118
  %polly.access.mul.call1253 = mul nsw i64 %122, 1000
  br i1 %polly.loop_guard2441130, label %polly.loop_header234.us, label %polly.loop_header228.split
...
polly.loop_header259.preheader:                   ; preds = %polly.loop_header234, %polly.merge.us
  ...
  br i1 %polly.loop_guard2441130, label %polly.loop_header259.us, label %polly.loop_exit261
...
polly.loop_header259.us:                          ; preds = %polly.loop_header259.preheader, %polly.loop_exit268.loopexit.us
  ...
  %min.iters.check1333 = icmp ult i64 %120, 4
  br i1 %min.iters.check1333, label %polly.loop_header266.us.preheader, label %vector.ph1334

vector.ph1334:                                    ; preds = %polly.loop_header259.us
  %n.vec1336 = and i64 %120, -4
  %broadcast.splatinsert1342 = insertelement <4 x double> poison, double %_p_scalar_280.us, i32 0
  %broadcast.splat1343 = shufflevector <4 x double> %broadcast.splatinsert1342, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1345 = insertelement <4 x double> poison, double %_p_scalar_288.us, i32 0
...
vector.body1328:                                  ; preds = %vector.body1328, %vector.ph1334
  ...
  %125 = add nuw nsw i64 %index1337, %112
  %126 = add nuw nsw i64 %index1337, %polly.access.mul.Packed_MemRef_call1273.us
  %127 = getelementptr double, double* %Packed_MemRef_call1, i64 %126
  %128 = bitcast double* %127 to <4 x double>*
  %wide.load1341 = load <4 x double>, <4 x double>* %128, align 8
  %129 = fmul fast <4 x double> %broadcast.splat1343, %wide.load1341
  ...
  %wide.load1344 = load <4 x double>, <4 x double>* %132, align 8
  %133 = fmul fast <4 x double> %broadcast.splat1346, %wide.load1344
  %134 = shl i64 %125, 3
  %135 = add i64 %134, %124
  %136 = getelementptr i8, i8* %call, i64 %135
  %137 = bitcast i8* %136 to <4 x double>*
  %wide.load1347 = load <4 x double>, <4 x double>* %137, align 8, !alias.scope !65, !noalias !67
  ...
  %140 = fadd fast <4 x double> %139, %wide.load1347
  ...
  %142 = icmp eq i64 %index.next1338, %n.vec1336
  br i1 %142, label %middle.block1326, label %vector.body1328, !llvm.loop !77

middle.block1326:                                 ; preds = %vector.body1328
  %cmp.n1340 = icmp eq i64 %120, %n.vec1336
  br i1 %cmp.n1340, label %polly.loop_exit268.loopexit.us, label %polly.loop_header266.us.preheader

polly.loop_header266.us.preheader:                ; preds = %polly.loop_header259.us, %middle.block1326
  %polly.indvar270.us.ph = phi i64 [ 0, %polly.loop_header259.us ], [ %n.vec1336, %middle.block1326 ]
...
polly.loop_exit268.loopexit.us:                   ; preds = %polly.loop_header266.us, %middle.block1326
...
polly.loop_header382:                             ; preds = %polly.loop_exit390, %polly.start294
  %indvar1267 = phi i64 [ %indvar.next1268, %polly.loop_exit390 ], [ 0, %polly.start294 ]
  %polly.indvar385 = phi i64 [ %polly.indvar_next386, %polly.loop_exit390 ], [ 1, %polly.start294 ]
  %146 = add i64 %indvar1267, 1
  %147 = mul nuw nsw i64 %polly.indvar385, 9600
  %scevgep394 = getelementptr i8, i8* %call, i64 %147
  %min.iters.check1269 = icmp ult i64 %146, 4
  br i1 %min.iters.check1269, label %polly.loop_header388.preheader, label %vector.ph1270

vector.ph1270:                                    ; preds = %polly.loop_header382
  %n.vec1272 = and i64 %146, -4
...
vector.body1266:                                  ; preds = %vector.body1266, %vector.ph1270
  ...
  %148 = shl nuw nsw i64 %index1273, 3
  %149 = getelementptr i8, i8* %scevgep394, i64 %148
  %150 = bitcast i8* %149 to <4 x double>*
  %wide.load1277 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !79, !noalias !81
  %151 = fmul fast <4 x double> %wide.load1277, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %153 = icmp eq i64 %index.next1274, %n.vec1272
  br i1 %153, label %middle.block1264, label %vector.body1266, !llvm.loop !86

middle.block1264:                                 ; preds = %vector.body1266
  %cmp.n1276 = icmp eq i64 %146, %n.vec1272
  br i1 %cmp.n1276, label %polly.loop_exit390, label %polly.loop_header388.preheader

polly.loop_header388.preheader:                   ; preds = %polly.loop_header382, %middle.block1264
  %polly.indvar391.ph = phi i64 [ 0, %polly.loop_header382 ], [ %n.vec1272, %middle.block1264 ]
  br label %polly.loop_header388

polly.loop_exit390:                               ; preds = %polly.loop_header388, %middle.block1264
  %polly.indvar_next386 = add nuw nsw i64 %polly.indvar385, 1
  %exitcond1068.not = icmp eq i64 %polly.indvar_next386, 1200
  %indvar.next1268 = add i64 %indvar1267, 1
  br i1 %exitcond1068.not, label %polly.loop_header398.preheader, label %polly.loop_header382
...
polly.loop_header388:                             ; preds = %polly.loop_header388.preheader, %polly.loop_header388
  ...
  %exitcond1067.not = icmp eq i64 %polly.indvar_next392, %polly.indvar385
  br i1 %exitcond1067.not, label %polly.loop_exit390, label %polly.loop_header388, !llvm.loop !87
...
polly.loop_exit406:                               ; preds = %polly.loop_header404
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next402, 1000
  br i1 %exitcond1066.not, label %polly.loop_header414, label %polly.loop_header398
...
polly.loop_header404:                             ; preds = %polly.loop_header404, %polly.loop_header398
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next408, 1200
  br i1 %exitcond1065.not, label %polly.loop_exit406, label %polly.loop_header404

polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  %indvars.iv1060 = phi i64 [ %indvars.iv.next1061, %polly.loop_exit423 ], [ 0, %polly.loop_exit406 ]
  ...
  %155 = mul nsw i64 %polly.indvar417, -64
  %156 = shl nuw nsw i64 %polly.indvar417, 6
  %157 = udiv i64 %polly.indvar417, 5
  %158 = add nuw i64 %indvars.iv1060, %157
  %umin1062 = call i64 @llvm.umin.i64(i64 %158, i64 56)
  %159 = mul nsw i64 %polly.indvar417, -64
  %160 = icmp slt i64 %159, -1136
  %161 = select i1 %160, i64 %159, i64 -1136
  %162 = add nsw i64 %161, 1199
  %163 = shl nsw i64 %polly.indvar417, 6
  %164 = add nuw nsw i64 %umin1062, 3
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %indvars.iv.next1061 = add nuw nsw i64 %indvars.iv1060, 3
  %exitcond1064.not = icmp eq i64 %polly.indvar_next418, 19
  br i1 %exitcond1064.not, label %polly.exiting295, label %polly.loop_header414
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %166 = add i64 %155, %165
  %smax1281 = call i64 @llvm.smax.i64(i64 %166, i64 0)
  %167 = mul nsw i64 %polly.indvar424, -20
  %168 = add i64 %156, %167
  %169 = add i64 %smax1281, %168
...
polly.loop_header428.preheader:                   ; preds = %polly.loop_header421
  ...
  %174 = add i64 %smax1047, %indvars.iv1050
...
polly.loop_exit430:                               ; preds = %polly.loop_exit466, %polly.loop_header421
  ...
  %indvars.iv.next1051 = add nsw i64 %indvars.iv1050, -20
  %exitcond1063.not = icmp eq i64 %polly.indvar424, %164
  br i1 %exitcond1063.not, label %polly.loop_exit423, label %polly.loop_header421

polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  %indvar1282 = phi i64 [ 0, %polly.loop_header428.preheader ], [ %indvar.next1283, %polly.loop_exit466 ]
  %indvars.iv1052 = phi i64 [ %174, %polly.loop_header428.preheader ], [ %indvars.iv.next1053, %polly.loop_exit466 ]
  %polly.indvar432 = phi i64 [ %173, %polly.loop_header428.preheader ], [ %polly.indvar_next433, %polly.loop_exit466 ]
  %177 = add i64 %169, %indvar1282
  %smin1284 = call i64 @llvm.smin.i64(i64 %177, i64 19)
  %178 = add nsw i64 %smin1284, 1
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1052, i64 19)
  %179 = add nsw i64 %polly.indvar432, %175
  %polly.loop_guard4451131 = icmp sgt i64 %179, -1
  %180 = add nuw nsw i64 %polly.indvar432, %163
  %.not908 = icmp ult i64 %180, %176
  %polly.access.mul.call1458 = mul nsw i64 %180, 1000
  br i1 %polly.loop_guard4451131, label %polly.loop_header435.us, label %polly.loop_header428.split
...
polly.loop_header464.preheader:                   ; preds = %polly.loop_header435, %polly.merge454.us
  ...
  br i1 %polly.loop_guard4451131, label %polly.loop_header464.us, label %polly.loop_exit466
...
polly.loop_header464.us:                          ; preds = %polly.loop_header464.preheader, %polly.loop_exit473.loopexit.us
  ...
  %min.iters.check1285 = icmp ult i64 %178, 4
  br i1 %min.iters.check1285, label %polly.loop_header471.us.preheader, label %vector.ph1286

vector.ph1286:                                    ; preds = %polly.loop_header464.us
  %n.vec1288 = and i64 %178, -4
  %broadcast.splatinsert1294 = insertelement <4 x double> poison, double %_p_scalar_485.us, i32 0
  %broadcast.splat1295 = shufflevector <4 x double> %broadcast.splatinsert1294, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1297 = insertelement <4 x double> poison, double %_p_scalar_493.us, i32 0
...
vector.body1280:                                  ; preds = %vector.body1280, %vector.ph1286
  ...
  %183 = add nuw nsw i64 %index1289, %170
  %184 = add nuw nsw i64 %index1289, %polly.access.mul.Packed_MemRef_call1297478.us
  ...
  %wide.load1296 = load <4 x double>, <4 x double>* %190, align 8
  %191 = fmul fast <4 x double> %broadcast.splat1298, %wide.load1296
  %192 = shl i64 %183, 3
  %193 = add i64 %192, %182
  %194 = getelementptr i8, i8* %call, i64 %193
  %195 = bitcast i8* %194 to <4 x double>*
  %wide.load1299 = load <4 x double>, <4 x double>* %195, align 8, !alias.scope !79, !noalias !81
  ...
  %198 = fadd fast <4 x double> %197, %wide.load1299
  ...
  %200 = icmp eq i64 %index.next1290, %n.vec1288
  br i1 %200, label %middle.block1278, label %vector.body1280, !llvm.loop !90

middle.block1278:                                 ; preds = %vector.body1280
  %cmp.n1292 = icmp eq i64 %178, %n.vec1288
  br i1 %cmp.n1292, label %polly.loop_exit473.loopexit.us, label %polly.loop_header471.us.preheader

polly.loop_header471.us.preheader:                ; preds = %polly.loop_header464.us, %middle.block1278
  %polly.indvar475.us.ph = phi i64 [ 0, %polly.loop_header464.us ], [ %n.vec1288, %middle.block1278 ]
...
polly.loop_exit473.loopexit.us:                   ; preds = %polly.loop_header471.us, %middle.block1278
...
polly.loop_header587:                             ; preds = %polly.loop_exit595, %polly.start499
  ...
  %min.iters.check1221 = icmp ult i64 %204, 4
  br i1 %min.iters.check1221, label %polly.loop_header593.preheader, label %vector.ph1222

vector.ph1222:                                    ; preds = %polly.loop_header587
  %n.vec1224 = and i64 %204, -4
...
vector.body1220:                                  ; preds = %vector.body1220, %vector.ph1222
  ...
  %206 = shl nuw nsw i64 %index1225, 3
  %207 = getelementptr i8, i8* %scevgep599, i64 %206
  %208 = bitcast i8* %207 to <4 x double>*
  %wide.load1229 = load <4 x double>, <4 x double>* %208, align 8, !alias.scope !92, !noalias !94
  %209 = fmul fast <4 x double> %wide.load1229, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %211 = icmp eq i64 %index.next1226, %n.vec1224
  br i1 %211, label %middle.block1218, label %vector.body1220, !llvm.loop !99

middle.block1218:                                 ; preds = %vector.body1220
  %cmp.n1228 = icmp eq i64 %204, %n.vec1224
  br i1 %cmp.n1228, label %polly.loop_exit595, label %polly.loop_header593.preheader

polly.loop_header593.preheader:                   ; preds = %polly.loop_header587, %middle.block1218
  %polly.indvar596.ph = phi i64 [ 0, %polly.loop_header587 ], [ %n.vec1224, %middle.block1218 ]
  br label %polly.loop_header593

polly.loop_exit595:                               ; preds = %polly.loop_header593, %middle.block1218
  %polly.indvar_next591 = add nuw nsw i64 %polly.indvar590, 1
  %exitcond1095.not = icmp eq i64 %polly.indvar_next591, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond1095.not, label %polly.loop_header603.preheader, label %polly.loop_header587
...
polly.loop_header593:                             ; preds = %polly.loop_header593.preheader, %polly.loop_header593
  ...
  %exitcond1094.not = icmp eq i64 %polly.indvar_next597, %polly.indvar590
  br i1 %exitcond1094.not, label %polly.loop_exit595, label %polly.loop_header593, !llvm.loop !100
...
polly.loop_exit611:                               ; preds = %polly.loop_header609
  ...
  %exitcond1093.not = icmp eq i64 %polly.indvar_next607, 1000
  br i1 %exitcond1093.not, label %polly.loop_header619, label %polly.loop_header603
...
polly.loop_header609:                             ; preds = %polly.loop_header609, %polly.loop_header603
  ...
  %exitcond1092.not = icmp eq i64 %polly.indvar_next613, 1200
  br i1 %exitcond1092.not, label %polly.loop_exit611, label %polly.loop_header609

polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  %indvars.iv1087 = phi i64 [ %indvars.iv.next1088, %polly.loop_exit628 ], [ 0, %polly.loop_exit611 ]
  %indvars.iv1075 = phi i64 [ %indvars.iv.next1076, %polly.loop_exit628 ], [ 0, %polly.loop_exit611 ]
  %indvars.iv1070 = phi i64 [ %indvars.iv.next1071, %polly.loop_exit628 ], [ 0, %polly.loop_exit611 ]
  %polly.indvar622 = phi i64 [ %polly.indvar_next623, %polly.loop_exit628 ], [ 0, %polly.loop_exit611 ]
  %213 = mul nsw i64 %polly.indvar622, -64
  %214 = shl nuw nsw i64 %polly.indvar622, 6
  %215 = udiv i64 %polly.indvar622, 5
  %216 = add nuw i64 %indvars.iv1087, %215
  %umin1089 = call i64 @llvm.umin.i64(i64 %216, i64 56)
  %217 = mul nsw i64 %polly.indvar622, -64
  %218 = icmp slt i64 %217, -1136
  %219 = select i1 %218, i64 %217, i64 -1136
  %220 = add nsw i64 %219, 1199
  %221 = shl nsw i64 %polly.indvar622, 6
  %222 = add nuw nsw i64 %umin1089, 3
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1071 = add nsw i64 %indvars.iv1070, -64
  %indvars.iv.next1076 = add nuw nsw i64 %indvars.iv1075, 64
  %indvars.iv.next1088 = add nuw nsw i64 %indvars.iv1087, 3
  %exitcond1091.not = icmp eq i64 %polly.indvar_next623, 19
  br i1 %exitcond1091.not, label %polly.exiting500, label %polly.loop_header619
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit635 ], [ %indvars.iv1070, %polly.loop_header619 ]
  ...
  %224 = add i64 %213, %223
  %smax1233 = call i64 @llvm.smax.i64(i64 %224, i64 0)
  %225 = mul nsw i64 %polly.indvar629, -20
  %226 = add i64 %214, %225
  %227 = add i64 %smax1233, %226
...
polly.loop_header633.preheader:                   ; preds = %polly.loop_header626
  ...
  %232 = add i64 %smax1074, %indvars.iv1077
...
polly.loop_exit635:                               ; preds = %polly.loop_exit671, %polly.loop_header626
  ...
  %exitcond1090.not = icmp eq i64 %polly.indvar629, %222
  br i1 %exitcond1090.not, label %polly.loop_exit628, label %polly.loop_header626

polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  %indvar1234 = phi i64 [ 0, %polly.loop_header633.preheader ], [ %indvar.next1235, %polly.loop_exit671 ]
  %indvars.iv1079 = phi i64 [ %232, %polly.loop_header633.preheader ], [ %indvars.iv.next1080, %polly.loop_exit671 ]
  %polly.indvar637 = phi i64 [ %231, %polly.loop_header633.preheader ], [ %polly.indvar_next638, %polly.loop_exit671 ]
  %235 = add i64 %227, %indvar1234
  %smin1236 = call i64 @llvm.smin.i64(i64 %235, i64 19)
  %236 = add nsw i64 %smin1236, 1
  %smin1084 = call i64 @llvm.smin.i64(i64 %indvars.iv1079, i64 19)
  %237 = add nsw i64 %polly.indvar637, %233
  %polly.loop_guard6501132 = icmp sgt i64 %237, -1
  %238 = add nuw nsw i64 %polly.indvar637, %221
  %.not909 = icmp ult i64 %238, %234
  %polly.access.mul.call1663 = mul nsw i64 %238, 1000
  br i1 %polly.loop_guard6501132, label %polly.loop_header640.us, label %polly.loop_header633.split
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.us, %polly.loop_header647.us
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar651.us, %smin1084
  br i1 %exitcond1082.not, label %polly.cond658.loopexit.us, label %polly.loop_header647.us
...
polly.merge659.us:                                ; preds = %polly.then660.us, %polly.cond658.loopexit.us
  ...
  %exitcond1083.not = icmp eq i64 %polly.indvar_next644.us, 1000
  br i1 %exitcond1083.not, label %polly.loop_header669.preheader, label %polly.loop_header640.us
...
polly.loop_header640:                             ; preds = %polly.loop_header633.split, %polly.loop_header640
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next644, 1000
  br i1 %exitcond1069.not, label %polly.loop_header669.preheader, label %polly.loop_header640

polly.loop_header669.preheader:                   ; preds = %polly.loop_header640, %polly.merge659.us
  %240 = mul i64 %238, 9600
  br i1 %polly.loop_guard6501132, label %polly.loop_header669.us, label %polly.loop_exit671
...
polly.loop_header669.us:                          ; preds = %polly.loop_header669.preheader, %polly.loop_exit678.loopexit.us
  ...
  %min.iters.check1237 = icmp ult i64 %236, 4
  br i1 %min.iters.check1237, label %polly.loop_header676.us.preheader, label %vector.ph1238

vector.ph1238:                                    ; preds = %polly.loop_header669.us
  %n.vec1240 = and i64 %236, -4
  %broadcast.splatinsert1246 = insertelement <4 x double> poison, double %_p_scalar_690.us, i32 0
  %broadcast.splat1247 = shufflevector <4 x double> %broadcast.splatinsert1246, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1249 = insertelement <4 x double> poison, double %_p_scalar_698.us, i32 0
...
vector.body1232:                                  ; preds = %vector.body1232, %vector.ph1238
  ...
  %241 = add nuw nsw i64 %index1241, %228
  %242 = add nuw nsw i64 %index1241, %polly.access.mul.Packed_MemRef_call1502683.us
  %243 = getelementptr double, double* %Packed_MemRef_call1502, i64 %242
  %244 = bitcast double* %243 to <4 x double>*
  %wide.load1245 = load <4 x double>, <4 x double>* %244, align 8
  %245 = fmul fast <4 x double> %broadcast.splat1247, %wide.load1245
  ...
  %wide.load1248 = load <4 x double>, <4 x double>* %248, align 8
  %249 = fmul fast <4 x double> %broadcast.splat1250, %wide.load1248
  %250 = shl i64 %241, 3
  %251 = add i64 %250, %240
  %252 = getelementptr i8, i8* %call, i64 %251
  %253 = bitcast i8* %252 to <4 x double>*
  %wide.load1251 = load <4 x double>, <4 x double>* %253, align 8, !alias.scope !92, !noalias !94
  ...
  %256 = fadd fast <4 x double> %255, %wide.load1251
  ...
  %258 = icmp eq i64 %index.next1242, %n.vec1240
  br i1 %258, label %middle.block1230, label %vector.body1232, !llvm.loop !103

middle.block1230:                                 ; preds = %vector.body1232
  %cmp.n1244 = icmp eq i64 %236, %n.vec1240
  br i1 %cmp.n1244, label %polly.loop_exit678.loopexit.us, label %polly.loop_header676.us.preheader

polly.loop_header676.us.preheader:                ; preds = %polly.loop_header669.us, %middle.block1230
  %polly.indvar680.us.ph = phi i64 [ 0, %polly.loop_header669.us ], [ %n.vec1240, %middle.block1230 ]
...
polly.loop_header676.us:                          ; preds = %polly.loop_header676.us.preheader, %polly.loop_header676.us
  ...
  %exitcond1085.not = icmp eq i64 %polly.indvar680.us, %smin1084
  br i1 %exitcond1085.not, label %polly.loop_exit678.loopexit.us, label %polly.loop_header676.us, !llvm.loop !104

polly.loop_exit678.loopexit.us:                   ; preds = %polly.loop_header676.us, %middle.block1230
  %polly.indvar_next673.us = add nuw nsw i64 %polly.indvar672.us, 1
  %exitcond1086.not = icmp eq i64 %polly.indvar_next673.us, 1000
  br i1 %exitcond1086.not, label %polly.loop_exit671, label %polly.loop_header669.us

polly.loop_header828:                             ; preds = %entry, %polly.loop_exit836
  %indvars.iv1120 = phi i64 [ %indvars.iv.next1121, %polly.loop_exit836 ], [ 0, %entry ]
...
polly.loop_exit836:                               ; preds = %polly.loop_exit842
  ...
  %exitcond1125.not = icmp eq i64 %polly.indvar_next832, 38
  br i1 %exitcond1125.not, label %polly.loop_header855, label %polly.loop_header828

polly.loop_header834:                             ; preds = %polly.loop_exit842, %polly.loop_header828
  %indvars.iv1116 = phi i64 [ %indvars.iv.next1117, %polly.loop_exit842 ], [ 0, %polly.loop_header828 ]
...
polly.loop_exit842:                               ; preds = %polly.loop_exit848
  ...
  %exitcond1124.not = icmp eq i64 %polly.indvar_next838, 38
  br i1 %exitcond1124.not, label %polly.loop_exit836, label %polly.loop_header834
...
polly.loop_header840:                             ; preds = %polly.loop_exit848, %polly.loop_header834
  ...
  br i1 %min.iters.check, label %polly.loop_header846, label %vector.ph1160

vector.ph1160:                                    ; preds = %polly.loop_header840
  %broadcast.splatinsert1167 = insertelement <4 x i64> poison, i64 %266, i32 0
  %broadcast.splat1168 = shufflevector <4 x i64> %broadcast.splatinsert1167, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1169 = insertelement <4 x i32> poison, i32 %269, i32 0
...
vector.body1159:                                  ; preds = %vector.body1159, %vector.ph1160
  ...
  %271 = add nuw nsw <4 x i64> %vec.ind1165, %broadcast.splat1168
  %272 = trunc <4 x i64> %271 to <4 x i32>
  %273 = mul <4 x i32> %broadcast.splat1170, %272
  ...
  %283 = icmp eq i64 %index.next1162, %265
  br i1 %283, label %polly.loop_exit848, label %vector.body1159, !llvm.loop !110

polly.loop_exit848:                               ; preds = %vector.body1159, %polly.loop_header846
  %polly.indvar_next844 = add nuw nsw i64 %polly.indvar843, 1
  %exitcond1123.not = icmp eq i64 %polly.indvar843, %263
  br i1 %exitcond1123.not, label %polly.loop_exit842, label %polly.loop_header840
...
polly.loop_header846:                             ; preds = %polly.loop_header840, %polly.loop_header846
  ...
  %exitcond1119.not = icmp eq i64 %polly.indvar849, %267
  br i1 %exitcond1119.not, label %polly.loop_exit848, label %polly.loop_header846, !llvm.loop !111

polly.loop_header855:                             ; preds = %polly.loop_exit836, %polly.loop_exit863
  %indvars.iv1110 = phi i64 [ %indvars.iv.next1111, %polly.loop_exit863 ], [ 0, %polly.loop_exit836 ]
...
polly.loop_exit863:                               ; preds = %polly.loop_exit869
  ...
  %exitcond1115.not = icmp eq i64 %polly.indvar_next859, 38
  br i1 %exitcond1115.not, label %polly.loop_header881, label %polly.loop_header855

polly.loop_header861:                             ; preds = %polly.loop_exit869, %polly.loop_header855
  %indvars.iv1106 = phi i64 [ %indvars.iv.next1107, %polly.loop_exit869 ], [ 0, %polly.loop_header855 ]
  %polly.indvar864 = phi i64 [ %polly.indvar_next865, %polly.loop_exit869 ], [ 0, %polly.loop_header855 ]
  %293 = mul nsw i64 %polly.indvar864, -32
  %smin1174 = call i64 @llvm.smin.i64(i64 %293, i64 -968)
  %294 = add nsw i64 %smin1174, 1000
  %smin1108 = call i64 @llvm.smin.i64(i64 %indvars.iv1106, i64 -968)
  %295 = shl nsw i64 %polly.indvar864, 5
  %296 = add nsw i64 %smin1108, 999
...
polly.loop_exit869:                               ; preds = %polly.loop_exit875
  ...
  %exitcond1114.not = icmp eq i64 %polly.indvar_next865, 32
  br i1 %exitcond1114.not, label %polly.loop_exit863, label %polly.loop_header861
...
polly.loop_header867:                             ; preds = %polly.loop_exit875, %polly.loop_header861
  ...
  %min.iters.check1175 = icmp eq i64 %294, 0
  br i1 %min.iters.check1175, label %polly.loop_header873, label %vector.ph1176

vector.ph1176:                                    ; preds = %polly.loop_header867
  %broadcast.splatinsert1185 = insertelement <4 x i64> poison, i64 %295, i32 0
  %broadcast.splat1186 = shufflevector <4 x i64> %broadcast.splatinsert1185, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1187 = insertelement <4 x i32> poison, i32 %298, i32 0
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1176
  ...
  %300 = add nuw nsw <4 x i64> %vec.ind1183, %broadcast.splat1186
  %301 = trunc <4 x i64> %300 to <4 x i32>
  %302 = mul <4 x i32> %broadcast.splat1188, %301
  ...
  %312 = icmp eq i64 %index.next1180, %294
  br i1 %312, label %polly.loop_exit875, label %vector.body1173, !llvm.loop !113

polly.loop_exit875:                               ; preds = %vector.body1173, %polly.loop_header873
  %polly.indvar_next871 = add nuw nsw i64 %polly.indvar870, 1
  %exitcond1113.not = icmp eq i64 %polly.indvar870, %292
  br i1 %exitcond1113.not, label %polly.loop_exit869, label %polly.loop_header867
...
polly.loop_header873:                             ; preds = %polly.loop_header867, %polly.loop_header873
  ...
  %exitcond1109.not = icmp eq i64 %polly.indvar876, %296
  br i1 %exitcond1109.not, label %polly.loop_exit875, label %polly.loop_header873, !llvm.loop !114

polly.loop_header881:                             ; preds = %polly.loop_exit863, %polly.loop_exit889
  %indvars.iv1100 = phi i64 [ %indvars.iv.next1101, %polly.loop_exit889 ], [ 0, %polly.loop_exit863 ]
...
polly.loop_exit889:                               ; preds = %polly.loop_exit895
  ...
  %exitcond1105.not = icmp eq i64 %polly.indvar_next885, 38
  br i1 %exitcond1105.not, label %init_array.exit, label %polly.loop_header881

polly.loop_header887:                             ; preds = %polly.loop_exit895, %polly.loop_header881
  %indvars.iv1096 = phi i64 [ %indvars.iv.next1097, %polly.loop_exit895 ], [ 0, %polly.loop_header881 ]
  %polly.indvar890 = phi i64 [ %polly.indvar_next891, %polly.loop_exit895 ], [ 0, %polly.loop_header881 ]
  %322 = mul nsw i64 %polly.indvar890, -32
  %smin1192 = call i64 @llvm.smin.i64(i64 %322, i64 -968)
  %323 = add nsw i64 %smin1192, 1000
  %smin1098 = call i64 @llvm.smin.i64(i64 %indvars.iv1096, i64 -968)
  %324 = shl nsw i64 %polly.indvar890, 5
  %325 = add nsw i64 %smin1098, 999
...
polly.loop_exit895:                               ; preds = %polly.loop_exit901
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar_next891, 32
  br i1 %exitcond1104.not, label %polly.loop_exit889, label %polly.loop_header887
...
polly.loop_header893:                             ; preds = %polly.loop_exit901, %polly.loop_header887
  ...
  %min.iters.check1193 = icmp eq i64 %323, 0
  br i1 %min.iters.check1193, label %polly.loop_header899, label %vector.ph1194

vector.ph1194:                                    ; preds = %polly.loop_header893
  %broadcast.splatinsert1203 = insertelement <4 x i64> poison, i64 %324, i32 0
  %broadcast.splat1204 = shufflevector <4 x i64> %broadcast.splatinsert1203, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1205 = insertelement <4 x i32> poison, i32 %327, i32 0
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1194
  ...
  %329 = add nuw nsw <4 x i64> %vec.ind1201, %broadcast.splat1204
  %330 = trunc <4 x i64> %329 to <4 x i32>
  %331 = mul <4 x i32> %broadcast.splat1206, %330
  ...
  %341 = icmp eq i64 %index.next1198, %323
  br i1 %341, label %polly.loop_exit901, label %vector.body1191, !llvm.loop !116

polly.loop_exit901:                               ; preds = %vector.body1191, %polly.loop_header899
  %polly.indvar_next897 = add nuw nsw i64 %polly.indvar896, 1
  %exitcond1103.not = icmp eq i64 %polly.indvar896, %321
  br i1 %exitcond1103.not, label %polly.loop_exit895, label %polly.loop_header893
...
polly.loop_header899:                             ; preds = %polly.loop_header893, %polly.loop_header899
  ...
  %exitcond1099.not = icmp eq i64 %polly.indvar902, %325
  br i1 %exitcond1099.not, label %polly.loop_exit901, label %polly.loop_header899, !llvm.loop !117
}
