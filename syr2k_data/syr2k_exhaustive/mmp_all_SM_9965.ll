; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9965.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9965.c"
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %126, label %middle.block990, label %vector.body992, !llvm.loop !74
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %wide.load977 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %157, label %middle.block966, label %vector.body968, !llvm.loop !83
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  br i1 %202, label %polly.loop_exit714, label %vector.body906, !llvm.loop !92
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  br i1 %231, label %polly.loop_exit741, label %vector.body921, !llvm.loop !95
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  br i1 %260, label %polly.loop_exit767, label %vector.body939, !llvm.loop !98
