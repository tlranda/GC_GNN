; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10057.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10057.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar_next203, 19
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond796.not = icmp eq i64 %polly.indvar214, %104
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233879 = icmp sgt i64 %126, -1
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph998
  ...
  %139 = shl nuw nsw i64 %index1001, 3
  %140 = getelementptr i8, i8* %scevgep350, i64 %139
  %141 = bitcast i8* %140 to <4 x double>*
  %wide.load1005 = load <4 x double>, <4 x double>* %141, align 8, !alias.scope !69, !noalias !71
  %142 = fmul fast <4 x double> %wide.load1005, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %144 = icmp eq i64 %index.next1002, %n.vec1000
  br i1 %144, label %middle.block992, label %vector.body994, !llvm.loop !74

middle.block992:                                  ; preds = %vector.body994
  %cmp.n1004 = icmp eq i64 %137, %n.vec1000
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %146 = udiv i64 %polly.indvar357, 5
  %147 = add nuw i64 %indvars.iv815, %146
  %umin817 = call i64 @llvm.umin.i64(i64 %147, i64 56)
  %148 = mul nsw i64 %polly.indvar357, -64
  %149 = icmp slt i64 %148, -1136
  %150 = select i1 %149, i64 %148, i64 -1136
  %151 = add nsw i64 %150, 1199
  %152 = shl nsw i64 %polly.indvar357, 6
  %153 = add nuw nsw i64 %umin817, 3
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit369
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next802 = add nsw i64 %indvars.iv801, -64
  %indvars.iv.next807 = add nuw nsw i64 %indvars.iv806, 64
  %indvars.iv.next816 = add nuw nsw i64 %indvars.iv815, 3
  %exitcond820.not = icmp eq i64 %polly.indvar_next358, 19
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %173 = add i64 %smax805, %indvars.iv808
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond818.not = icmp eq i64 %polly.indvar370, %153
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv810 = phi i64 [ %173, %polly.loop_header374.preheader ], [ %indvars.iv.next811, %polly.loop_exit383 ]
  ...
  %polly.loop_guard391880 = icmp sgt i64 %175, -1
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph972
  ...
  %188 = shl nuw nsw i64 %index975, 3
  %189 = getelementptr i8, i8* %scevgep508, i64 %188
  %190 = bitcast i8* %189 to <4 x double>*
  %wide.load979 = load <4 x double>, <4 x double>* %190, align 8, !alias.scope !78, !noalias !80
  %191 = fmul fast <4 x double> %wide.load979, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %193 = icmp eq i64 %index.next976, %n.vec974
  br i1 %193, label %middle.block968, label %vector.body970, !llvm.loop !83

middle.block968:                                  ; preds = %vector.body970
  %cmp.n978 = icmp eq i64 %186, %n.vec974
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %195 = udiv i64 %polly.indvar515, 5
  %196 = add nuw i64 %indvars.iv837, %195
  %umin839 = call i64 @llvm.umin.i64(i64 %196, i64 56)
  %197 = mul nsw i64 %polly.indvar515, -64
  %198 = icmp slt i64 %197, -1136
  %199 = select i1 %198, i64 %197, i64 -1136
  %200 = add nsw i64 %199, 1199
  %201 = shl nsw i64 %polly.indvar515, 6
  %202 = add nuw nsw i64 %umin839, 3
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %222 = add i64 %smax827, %indvars.iv830
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond840.not = icmp eq i64 %polly.indvar528, %202
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv832 = phi i64 [ %222, %polly.loop_header532.preheader ], [ %indvars.iv.next833, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %221, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin834 = call i64 @llvm.smin.i64(i64 %indvars.iv832, i64 19)
  %224 = add nsw i64 %polly.indvar536, %223
  %polly.loop_guard549881 = icmp sgt i64 %224, -1
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin909 = call i64 @llvm.smin.i64(i64 %237, i64 -1168)
  %238 = add nsw i64 %smin909, 1200
  %smin867 = call i64 @llvm.smin.i64(i64 %indvars.iv865, i64 -1168)
  %239 = shl nsw i64 %polly.indvar703, 5
  %240 = add nsw i64 %smin867, 1199
...
vector.ph910:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert917 = insertelement <4 x i64> poison, i64 %239, i32 0
  %broadcast.splat918 = shufflevector <4 x i64> %broadcast.splatinsert917, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert919 = insertelement <4 x i32> poison, i32 %242, i32 0
...
vector.body908:                                   ; preds = %vector.body908, %vector.ph910
  ...
  %244 = add nuw nsw <4 x i64> %vec.ind915, %broadcast.splat918
  %245 = trunc <4 x i64> %244 to <4 x i32>
  %246 = mul <4 x i32> %broadcast.splat920, %245
  ...
  %256 = icmp eq i64 %index.next912, %238
  br i1 %256, label %polly.loop_exit714, label %vector.body908, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body908, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond872.not = icmp eq i64 %polly.indvar709, %236
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar715, %240
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin924 = call i64 @llvm.smin.i64(i64 %266, i64 -968)
  %267 = add nsw i64 %smin924, 1000
  %smin857 = call i64 @llvm.smin.i64(i64 %indvars.iv855, i64 -968)
  %268 = shl nsw i64 %polly.indvar730, 5
  %269 = add nsw i64 %smin857, 999
...
vector.body923:                                   ; preds = %vector.body923, %vector.ph926
  ...
  %273 = add nuw nsw <4 x i64> %vec.ind933, %broadcast.splat936
  %274 = trunc <4 x i64> %273 to <4 x i32>
  %275 = mul <4 x i32> %broadcast.splat938, %274
  ...
  %285 = icmp eq i64 %index.next930, %267
  br i1 %285, label %polly.loop_exit741, label %vector.body923, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body923, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond862.not = icmp eq i64 %polly.indvar736, %265
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar742, %269
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin942 = call i64 @llvm.smin.i64(i64 %295, i64 -968)
  %296 = add nsw i64 %smin942, 1000
  %smin847 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -968)
  %297 = shl nsw i64 %polly.indvar756, 5
  %298 = add nsw i64 %smin847, 999
...
vector.body941:                                   ; preds = %vector.body941, %vector.ph944
  ...
  %302 = add nuw nsw <4 x i64> %vec.ind951, %broadcast.splat954
  %303 = trunc <4 x i64> %302 to <4 x i32>
  %304 = mul <4 x i32> %broadcast.splat956, %303
  ...
  %314 = icmp eq i64 %index.next948, %296
  br i1 %314, label %polly.loop_exit767, label %vector.body941, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body941, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond852.not = icmp eq i64 %polly.indvar762, %294
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar768, %298
