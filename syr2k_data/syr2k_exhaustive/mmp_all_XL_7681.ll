; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7681.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7681.c"
...
vector.body1050:                                  ; preds = %vector.body1050, %vector.ph1054
  ...
  %wide.load1061 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %131, label %middle.block1048, label %vector.body1050, !llvm.loop !80
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %133 = udiv i64 %indvars.iv874, 5
  %134 = sub nsw i64 %indvars.iv872, %133
  %smin876 = call i64 @llvm.smin.i64(i64 %134, i64 54)
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1028
  ...
  %wide.load1035 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %167, label %middle.block1024, label %vector.body1026, !llvm.loop !90
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %169 = udiv i64 %indvars.iv900, 5
  %170 = sub nsw i64 %indvars.iv898, %169
  %smin902 = call i64 @llvm.smin.i64(i64 %170, i64 54)
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph966
  ...
  br i1 %217, label %polly.loop_exit772, label %vector.body964, !llvm.loop !99
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph982
  ...
  br i1 %246, label %polly.loop_exit799, label %vector.body979, !llvm.loop !102
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph1000
  ...
  br i1 %275, label %polly.loop_exit825, label %vector.body997, !llvm.loop !105
