; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7883.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7883.c"
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %123 = mul nsw i64 %polly.indvar230, 80
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %149 = shl nuw nsw i64 %polly.indvar395, 1
  %150 = add nuw nsw i64 %149, 2
  %pexp.p_div_q404 = udiv i64 %150, 5
  %151 = sub nsw i64 %149, %pexp.p_div_q404
  %152 = add nsw i64 %151, 1
  %.inv838 = icmp slt i64 %151, 14
  %153 = select i1 %.inv838, i64 %152, i64 14
  %polly.loop_guard409 = icmp sgt i64 %153, -1
  %154 = mul nsw i64 %polly.indvar395, -128
  %155 = icmp slt i64 %154, -1072
  %156 = select i1 %155, i64 %154, i64 -1072
  %157 = add nsw i64 %156, 1199
  %158 = shl nsw i64 %polly.indvar395, 7
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %175 = mul nsw i64 %polly.indvar410, 80
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %201 = shl nuw nsw i64 %polly.indvar575, 1
  %202 = add nuw nsw i64 %201, 2
  %pexp.p_div_q584 = udiv i64 %202, 5
  %203 = sub nsw i64 %201, %pexp.p_div_q584
  %204 = add nsw i64 %203, 1
  %.inv839 = icmp slt i64 %203, 14
  %205 = select i1 %.inv839, i64 %204, i64 14
  %polly.loop_guard589 = icmp sgt i64 %205, -1
  %206 = mul nsw i64 %polly.indvar575, -128
  %207 = icmp slt i64 %206, -1072
  %208 = select i1 %207, i64 %206, i64 -1072
  %209 = add nsw i64 %208, 1199
  %210 = shl nsw i64 %polly.indvar575, 7
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %227 = mul nsw i64 %polly.indvar590, 80
