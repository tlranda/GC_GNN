; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9430.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9430.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv788 = phi i64 [ %indvars.iv.next789, %polly.loop_exit207 ], [ 1, %polly.loop_exit193 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next782 = add nuw nsw i64 %indvars.iv781, 4
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %polly.loop_guard = icmp slt i64 %103, 4
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %indvars.iv.next780 = add nsw i64 %indvars.iv779, 50
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  %indvars.iv785 = phi i64 [ %104, %polly.loop_header211.preheader ], [ %indvars.iv.next786, %polly.loop_exit219 ]
  %polly.indvar214 = phi i64 [ %103, %polly.loop_header211.preheader ], [ %polly.indvar_next215, %polly.loop_exit219 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv785, i64 49)
  %106 = add nsw i64 %polly.indvar214, %105
  %polly.loop_guard227868 = icmp sgt i64 %106, -1
  %107 = add nuw nsw i64 %polly.indvar214, %99
...
polly.loop_header217.us:                          ; preds = %polly.loop_header211, %polly.loop_exit226.loopexit.us
  ...
  %110 = shl nuw nsw i64 %polly.indvar220.us, 3
  %scevgep231.us = getelementptr i8, i8* %call1, i64 %110
  %scevgep235.us = getelementptr i8, i8* %call2, i64 %110
  %scevgep236.us = getelementptr i8, i8* %scevgep235.us, i64 %108
  ...
  %scevgep244.us = getelementptr i8, i8* %scevgep231.us, i64 %108
...
polly.loop_exit219:                               ; preds = %polly.loop_exit226.loopexit.us, %polly.loop_header211
  ...
  %polly.loop_cond216 = icmp ult i64 %polly.indvar214, 3
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph987
  ...
  %117 = shl nuw nsw i64 %index990, 3
  %118 = getelementptr i8, i8* %scevgep348, i64 %117
  %119 = bitcast i8* %118 to <4 x double>*
  %wide.load994 = load <4 x double>, <4 x double>* %119, align 8, !alias.scope !69, !noalias !71
  %120 = fmul fast <4 x double> %wide.load994, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %121 = bitcast i8* %118 to <4 x double>*
  store <4 x double> %120, <4 x double>* %121, align 8, !alias.scope !69, !noalias !71
  %index.next991 = add i64 %index990, 4
  %122 = icmp eq i64 %index.next991, %n.vec989
  br i1 %122, label %middle.block981, label %vector.body983, !llvm.loop !74

middle.block981:                                  ; preds = %vector.body983
  %cmp.n993 = icmp eq i64 %115, %n.vec989
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  %indvars.iv808 = phi i64 [ %indvars.iv.next809, %polly.loop_exit361 ], [ 1, %polly.loop_exit344 ]
  ...
  %124 = udiv i64 %indvars.iv808, 25
  %125 = mul nsw i64 %polly.indvar355, -4
  %126 = shl nsw i64 %polly.indvar355, 2
...
polly.loop_exit361:                               ; preds = %polly.loop_exit368
  ...
  %indvars.iv.next809 = add nuw nsw i64 %indvars.iv808, 2
  %exitcond811.not = icmp eq i64 %polly.indvar_next356, 300
...
polly.loop_header359:                             ; preds = %polly.loop_exit368, %polly.loop_header352
  ...
  %127 = mul nuw nsw i64 %polly.indvar362, 50
  %128 = add nsw i64 %127, %125
  %129 = icmp sgt i64 %128, 0
  %130 = select i1 %129, i64 %128, i64 0
  %polly.loop_guard369 = icmp slt i64 %130, 4
...
polly.loop_header366.preheader:                   ; preds = %polly.loop_header359
  ...
  %131 = add i64 %smax798, %indvars.iv801
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375, %polly.loop_header359
  ...
  %indvars.iv.next797 = add nsw i64 %indvars.iv796, 50
  %indvars.iv.next802 = add nsw i64 %indvars.iv801, -50
  %exitcond810.not = icmp eq i64 %polly.indvar362, %124
...
polly.loop_header366:                             ; preds = %polly.loop_header366.preheader, %polly.loop_exit375
  %indvars.iv803 = phi i64 [ %131, %polly.loop_header366.preheader ], [ %indvars.iv.next804, %polly.loop_exit375 ]
  %polly.indvar370 = phi i64 [ %130, %polly.loop_header366.preheader ], [ %polly.indvar_next371, %polly.loop_exit375 ]
  %smin805 = call i64 @llvm.smin.i64(i64 %indvars.iv803, i64 49)
  %133 = add nsw i64 %polly.indvar370, %132
  %polly.loop_guard383869 = icmp sgt i64 %133, -1
  %134 = add nuw nsw i64 %polly.indvar370, %126
...
polly.loop_header373.us:                          ; preds = %polly.loop_header366, %polly.loop_exit382.loopexit.us
  ...
  %137 = shl nuw nsw i64 %polly.indvar376.us, 3
  %scevgep387.us = getelementptr i8, i8* %call1, i64 %137
  %scevgep391.us = getelementptr i8, i8* %call2, i64 %137
  %scevgep392.us = getelementptr i8, i8* %scevgep391.us, i64 %135
  ...
  %scevgep400.us = getelementptr i8, i8* %scevgep387.us, i64 %135
...
polly.loop_header380.us:                          ; preds = %polly.loop_header380.us, %polly.loop_header373.us
  ...
  %138 = add nuw nsw i64 %polly.indvar384.us, %127
  %139 = mul nuw nsw i64 %138, 8000
  %scevgep388.us = getelementptr i8, i8* %scevgep387.us, i64 %139
  ...
  %scevgep396.us = getelementptr i8, i8* %scevgep391.us, i64 %139
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382.loopexit.us, %polly.loop_header366
  ...
  %polly.loop_cond372 = icmp ult i64 %polly.indvar370, 3
...
vector.body959:                                   ; preds = %vector.body959, %vector.ph961
  ...
  %144 = shl nuw nsw i64 %index964, 3
  %145 = getelementptr i8, i8* %scevgep504, i64 %144
  %146 = bitcast i8* %145 to <4 x double>*
  %wide.load968 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !78, !noalias !80
  %147 = fmul fast <4 x double> %wide.load968, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %149 = icmp eq i64 %index.next965, %n.vec963
  br i1 %149, label %middle.block957, label %vector.body959, !llvm.loop !83

middle.block957:                                  ; preds = %vector.body959
  %cmp.n967 = icmp eq i64 %142, %n.vec963
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  %indvars.iv828 = phi i64 [ %indvars.iv.next829, %polly.loop_exit517 ], [ 1, %polly.loop_exit500 ]
  ...
  %151 = udiv i64 %indvars.iv828, 25
  %152 = mul nsw i64 %polly.indvar511, -4
  %153 = shl nsw i64 %polly.indvar511, 2
...
polly.loop_header515:                             ; preds = %polly.loop_exit524, %polly.loop_header508
  ...
  %154 = mul nuw nsw i64 %polly.indvar518, 50
  %155 = add nsw i64 %154, %152
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %polly.loop_guard525 = icmp slt i64 %157, 4
...
polly.loop_header522.preheader:                   ; preds = %polly.loop_header515
  ...
  %158 = add i64 %smax818, %indvars.iv821
...
polly.loop_exit524:                               ; preds = %polly.loop_exit531, %polly.loop_header515
  ...
  %indvars.iv.next817 = add nsw i64 %indvars.iv816, 50
  %indvars.iv.next822 = add nsw i64 %indvars.iv821, -50
  %exitcond830.not = icmp eq i64 %polly.indvar518, %151
...
polly.loop_header522:                             ; preds = %polly.loop_header522.preheader, %polly.loop_exit531
  %indvars.iv823 = phi i64 [ %158, %polly.loop_header522.preheader ], [ %indvars.iv.next824, %polly.loop_exit531 ]
  %polly.indvar526 = phi i64 [ %157, %polly.loop_header522.preheader ], [ %polly.indvar_next527, %polly.loop_exit531 ]
  %smin825 = call i64 @llvm.smin.i64(i64 %indvars.iv823, i64 49)
  %160 = add nsw i64 %polly.indvar526, %159
  %polly.loop_guard539870 = icmp sgt i64 %160, -1
  %161 = add nuw nsw i64 %polly.indvar526, %153
...
polly.loop_header529.us:                          ; preds = %polly.loop_header522, %polly.loop_exit538.loopexit.us
  ...
  %164 = shl nuw nsw i64 %polly.indvar532.us, 3
  %scevgep543.us = getelementptr i8, i8* %call1, i64 %164
  %scevgep547.us = getelementptr i8, i8* %call2, i64 %164
  %scevgep548.us = getelementptr i8, i8* %scevgep547.us, i64 %162
  ...
  %scevgep556.us = getelementptr i8, i8* %scevgep543.us, i64 %162
...
polly.loop_header536.us:                          ; preds = %polly.loop_header536.us, %polly.loop_header529.us
  ...
  %165 = add nuw nsw i64 %polly.indvar540.us, %154
  %166 = mul nuw nsw i64 %165, 8000
  %scevgep544.us = getelementptr i8, i8* %scevgep543.us, i64 %166
  ...
  %scevgep552.us = getelementptr i8, i8* %scevgep547.us, i64 %166
...
polly.loop_exit531:                               ; preds = %polly.loop_exit538.loopexit.us, %polly.loop_header522
  ...
  %polly.loop_cond528 = icmp ult i64 %polly.indvar526, 3
...
polly.loop_header694:                             ; preds = %polly.loop_exit702, %polly.loop_header688
  ...
  %smin898 = call i64 @llvm.smin.i64(i64 %171, i64 -1168)
  %172 = add nsw i64 %smin898, 1200
  %smin856 = call i64 @llvm.smin.i64(i64 %indvars.iv854, i64 -1168)
  %173 = shl nsw i64 %polly.indvar697, 5
  %174 = add nsw i64 %smin856, 1199
...
vector.ph899:                                     ; preds = %polly.loop_header700
  %broadcast.splatinsert906 = insertelement <4 x i64> poison, i64 %173, i32 0
  %broadcast.splat907 = shufflevector <4 x i64> %broadcast.splatinsert906, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert908 = insertelement <4 x i32> poison, i32 %176, i32 0
...
vector.body897:                                   ; preds = %vector.body897, %vector.ph899
  ...
  %178 = add nuw nsw <4 x i64> %vec.ind904, %broadcast.splat907
  %179 = trunc <4 x i64> %178 to <4 x i32>
  %180 = mul <4 x i32> %broadcast.splat909, %179
  ...
  store <4 x double> %184, <4 x double>* %189, align 8, !alias.scope !87, !noalias !89
  %index.next901 = add i64 %index900, 4
  %vec.ind.next905 = add <4 x i64> %vec.ind904, <i64 4, i64 4, i64 4, i64 4>
  %190 = icmp eq i64 %index.next901, %172
  br i1 %190, label %polly.loop_exit708, label %vector.body897, !llvm.loop !92

polly.loop_exit708:                               ; preds = %vector.body897, %polly.loop_header706
  %polly.indvar_next704 = add nuw nsw i64 %polly.indvar703, 1
  %exitcond861.not = icmp eq i64 %polly.indvar703, %170
...
polly.loop_header706:                             ; preds = %polly.loop_header700, %polly.loop_header706
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar709, %174
...
polly.loop_header721:                             ; preds = %polly.loop_exit729, %polly.loop_header715
  ...
  %smin913 = call i64 @llvm.smin.i64(i64 %200, i64 -968)
  %201 = add nsw i64 %smin913, 1000
  %smin846 = call i64 @llvm.smin.i64(i64 %indvars.iv844, i64 -968)
  %202 = shl nsw i64 %polly.indvar724, 5
  %203 = add nsw i64 %smin846, 999
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph915
  ...
  %207 = add nuw nsw <4 x i64> %vec.ind922, %broadcast.splat925
  %208 = trunc <4 x i64> %207 to <4 x i32>
  %209 = mul <4 x i32> %broadcast.splat927, %208
  ...
  store <4 x double> %213, <4 x double>* %218, align 8, !alias.scope !91, !noalias !94
  %index.next919 = add i64 %index918, 4
  %vec.ind.next923 = add <4 x i64> %vec.ind922, <i64 4, i64 4, i64 4, i64 4>
  %219 = icmp eq i64 %index.next919, %201
  br i1 %219, label %polly.loop_exit735, label %vector.body912, !llvm.loop !95

polly.loop_exit735:                               ; preds = %vector.body912, %polly.loop_header733
  %polly.indvar_next731 = add nuw nsw i64 %polly.indvar730, 1
  %exitcond851.not = icmp eq i64 %polly.indvar730, %199
...
polly.loop_header733:                             ; preds = %polly.loop_header727, %polly.loop_header733
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar736, %203
...
polly.loop_header747:                             ; preds = %polly.loop_exit755, %polly.loop_header741
  ...
  %smin931 = call i64 @llvm.smin.i64(i64 %229, i64 -968)
  %230 = add nsw i64 %smin931, 1000
  %smin836 = call i64 @llvm.smin.i64(i64 %indvars.iv834, i64 -968)
  %231 = shl nsw i64 %polly.indvar750, 5
  %232 = add nsw i64 %smin836, 999
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  %236 = add nuw nsw <4 x i64> %vec.ind940, %broadcast.splat943
  %237 = trunc <4 x i64> %236 to <4 x i32>
  %238 = mul <4 x i32> %broadcast.splat945, %237
  ...
  store <4 x double> %242, <4 x double>* %247, align 8, !alias.scope !90, !noalias !97
  %index.next937 = add i64 %index936, 4
  %vec.ind.next941 = add <4 x i64> %vec.ind940, <i64 4, i64 4, i64 4, i64 4>
  %248 = icmp eq i64 %index.next937, %230
  br i1 %248, label %polly.loop_exit761, label %vector.body930, !llvm.loop !98

polly.loop_exit761:                               ; preds = %vector.body930, %polly.loop_header759
  %polly.indvar_next757 = add nuw nsw i64 %polly.indvar756, 1
  %exitcond841.not = icmp eq i64 %polly.indvar756, %228
...
polly.loop_header759:                             ; preds = %polly.loop_header753, %polly.loop_header759
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar762, %232
