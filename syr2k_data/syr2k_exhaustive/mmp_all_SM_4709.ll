; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4709.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4709.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv978 = phi i64 [ 7, %polly.loop_header199.preheader ], [ %indvars.iv.next979, %polly.loop_exit207 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond981.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %polly.loop_guard = icmp slt i64 %104, 50
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %105 = add i64 %smax, %indvars.iv969
  %106 = sub nsw i64 %100, %101
  %107 = add nuw nsw i64 %101, 8
  br label %polly.loop_header211

polly.loop_exit213:                               ; preds = %polly.loop_exit244, %polly.loop_header205
  %polly.indvar_next209 = add nuw nsw i64 %polly.indvar208, 1
  %indvars.iv.next966 = add nsw i64 %indvars.iv965, 8
  %indvars.iv.next970 = add nsw i64 %indvars.iv969, -8
  %exitcond980.not = icmp eq i64 %polly.indvar_next209, %98
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit244
  %indvars.iv971 = phi i64 [ %105, %polly.loop_header211.preheader ], [ %indvars.iv.next972, %polly.loop_exit244 ]
  %polly.indvar214 = phi i64 [ %104, %polly.loop_header211.preheader ], [ %polly.indvar_next215, %polly.loop_exit244 ]
  %smin975 = call i64 @llvm.smin.i64(i64 %indvars.iv971, i64 7)
  %108 = add nsw i64 %polly.indvar214, %106
  %polly.loop_guard2271066 = icmp sgt i64 %108, -1
  %109 = add nuw nsw i64 %polly.indvar214, %100
  %.not = icmp ult i64 %109, %107
  %polly.access.mul.call1236 = mul nsw i64 %109, 1000
...
polly.loop_header224.us:                          ; preds = %polly.loop_header217.us, %polly.loop_header224.us
  ...
  %110 = add nuw nsw i64 %polly.indvar228.us, %101
  %polly.access.mul.call1232.us = mul nuw nsw i64 %110, 1000
...
polly.then.us:                                    ; preds = %polly.cond.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1240.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1.us, %108
...
polly.loop_exit244:                               ; preds = %polly.loop_exit251.loopexit.us, %polly.loop_header211.split, %polly.loop_header242.preheader
  ...
  %polly.loop_cond216 = icmp ult i64 %polly.indvar214, 49
...
polly.loop_header217:                             ; preds = %polly.loop_header211.split, %polly.loop_header217
  ...
  %polly.access.add.Packed_MemRef_call1240 = add nsw i64 %polly.access.mul.Packed_MemRef_call1239, %108
...
polly.loop_header242.us:                          ; preds = %polly.loop_header242.preheader, %polly.loop_exit251.loopexit.us
  ...
  %113 = shl nuw nsw i64 %polly.indvar245.us, 3
  %scevgep260.us = getelementptr i8, i8* %call2, i64 %113
  %polly.access.mul.Packed_MemRef_call1256.us = mul nuw nsw i64 %polly.indvar245.us, 1200
  %scevgep261.us = getelementptr i8, i8* %scevgep260.us, i64 %111
  ...
  %polly.access.add.Packed_MemRef_call1269.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1256.us, %108
...
polly.loop_header249.us:                          ; preds = %polly.loop_header249.us, %polly.loop_header242.us
  ...
  %114 = add nuw nsw i64 %polly.indvar253.us, %101
  ...
  %scevgep265.us = getelementptr i8, i8* %scevgep260.us, i64 %115
  ...
  %116 = shl i64 %114, 3
  %117 = add i64 %116, %112
  %scevgep272.us = getelementptr i8, i8* %call, i64 %117
...
polly.loop_header363:                             ; preds = %polly.loop_exit371, %polly.start277
  ...
  %118 = add i64 %indvar1181, 1
  %119 = mul nuw nsw i64 %polly.indvar366, 9600
  %scevgep375 = getelementptr i8, i8* %call, i64 %119
...
vector.body1180:                                  ; preds = %vector.body1180, %vector.ph1184
  ...
  %121 = getelementptr i8, i8* %scevgep375, i64 %120
  %122 = bitcast i8* %121 to <4 x double>*
  %wide.load1191 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %125, label %middle.block1178, label %vector.body1180, !llvm.loop !80
...
polly.loop_header369:                             ; preds = %polly.loop_header369.preheader, %polly.loop_header369
  ...
  %126 = shl nuw nsw i64 %polly.indvar372, 3
  %scevgep376 = getelementptr i8, i8* %scevgep375, i64 %126
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit388
  %indvars.iv1002 = phi i64 [ 7, %polly.loop_header379.preheader ], [ %indvars.iv.next1003, %polly.loop_exit388 ]
  ...
  %127 = lshr i64 %polly.indvar382, 2
  %128 = add nuw i64 %indvars.iv1002, %127
  %129 = mul nsw i64 %polly.indvar382, -50
  %130 = mul nuw nsw i64 %polly.indvar382, 50
...
polly.loop_exit388:                               ; preds = %polly.loop_exit395
  ...
  %indvars.iv.next991 = add nuw nsw i64 %indvars.iv990, 50
  %indvars.iv.next1003 = add nuw nsw i64 %indvars.iv1002, 6
  %exitcond1005.not = icmp eq i64 %polly.indvar_next383, 24
...
polly.loop_header386:                             ; preds = %polly.loop_exit395, %polly.loop_header379
  ...
  %131 = shl nsw i64 %polly.indvar389, 3
  %132 = add nsw i64 %131, %129
  %133 = icmp sgt i64 %132, 0
  %134 = select i1 %133, i64 %132, i64 0
  %polly.loop_guard396 = icmp slt i64 %134, 50
...
polly.loop_header393.preheader:                   ; preds = %polly.loop_header386
  ...
  %135 = add i64 %smax989, %indvars.iv992
  %136 = sub nsw i64 %130, %131
  %137 = add nuw nsw i64 %131, 8
  br label %polly.loop_header393

polly.loop_exit395:                               ; preds = %polly.loop_exit431, %polly.loop_header386
  %polly.indvar_next390 = add nuw nsw i64 %polly.indvar389, 1
  %indvars.iv.next988 = add nsw i64 %indvars.iv987, 8
  %indvars.iv.next993 = add nsw i64 %indvars.iv992, -8
  %exitcond1004.not = icmp eq i64 %polly.indvar_next390, %128
...
polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit431
  %indvars.iv994 = phi i64 [ %135, %polly.loop_header393.preheader ], [ %indvars.iv.next995, %polly.loop_exit431 ]
  %polly.indvar397 = phi i64 [ %134, %polly.loop_header393.preheader ], [ %polly.indvar_next398, %polly.loop_exit431 ]
  %smin999 = call i64 @llvm.smin.i64(i64 %indvars.iv994, i64 7)
  %138 = add nsw i64 %polly.indvar397, %136
  %polly.loop_guard4101067 = icmp sgt i64 %138, -1
  %139 = add nuw nsw i64 %polly.indvar397, %130
  %.not855 = icmp ult i64 %139, %137
  %polly.access.mul.call1423 = mul nsw i64 %139, 1000
...
polly.loop_header407.us:                          ; preds = %polly.loop_header400.us, %polly.loop_header407.us
  ...
  %140 = add nuw nsw i64 %polly.indvar411.us, %131
  %polly.access.mul.call1415.us = mul nuw nsw i64 %140, 1000
...
polly.then420.us:                                 ; preds = %polly.cond418.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1280427.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1280.us, %138
...
polly.loop_exit431:                               ; preds = %polly.loop_exit438.loopexit.us, %polly.loop_header393.split, %polly.loop_header429.preheader
  ...
  %polly.loop_cond399 = icmp ult i64 %polly.indvar397, 49
...
polly.loop_header400:                             ; preds = %polly.loop_header393.split, %polly.loop_header400
  ...
  %polly.access.add.Packed_MemRef_call1280427 = add nsw i64 %polly.access.mul.Packed_MemRef_call1280426, %138
...
polly.loop_header429.us:                          ; preds = %polly.loop_header429.preheader, %polly.loop_exit438.loopexit.us
  ...
  %143 = shl nuw nsw i64 %polly.indvar432.us, 3
  %scevgep447.us = getelementptr i8, i8* %call2, i64 %143
  %polly.access.mul.Packed_MemRef_call1280443.us = mul nuw nsw i64 %polly.indvar432.us, 1200
  %scevgep448.us = getelementptr i8, i8* %scevgep447.us, i64 %141
...
polly.loop_header436.us:                          ; preds = %polly.loop_header436.us, %polly.loop_header429.us
  ...
  %144 = add nuw nsw i64 %polly.indvar440.us, %131
  ...
  %scevgep452.us = getelementptr i8, i8* %scevgep447.us, i64 %145
  ...
  %146 = shl i64 %144, 3
  %147 = add i64 %146, %142
  %scevgep459.us = getelementptr i8, i8* %call, i64 %147
...
polly.loop_header550:                             ; preds = %polly.loop_exit558, %polly.start464
  ...
  %149 = mul nuw nsw i64 %polly.indvar553, 9600
  %scevgep562 = getelementptr i8, i8* %call, i64 %149
  %min.iters.check1157 = icmp ult i64 %148, 4
...
vector.body1156:                                  ; preds = %vector.body1156, %vector.ph1158
  ...
  %150 = shl nuw nsw i64 %index1161, 3
  %151 = getelementptr i8, i8* %scevgep562, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load1165 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !84, !noalias !86
  %153 = fmul fast <4 x double> %wide.load1165, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next1162, %n.vec1160
  br i1 %155, label %middle.block1154, label %vector.body1156, !llvm.loop !90

middle.block1154:                                 ; preds = %vector.body1156
  %cmp.n1164 = icmp eq i64 %148, %n.vec1160
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_header556
  ...
  %156 = shl nuw nsw i64 %polly.indvar559, 3
  %scevgep563 = getelementptr i8, i8* %scevgep562, i64 %156
...
polly.loop_header566:                             ; preds = %polly.loop_header566.preheader, %polly.loop_exit575
  %indvars.iv1026 = phi i64 [ 7, %polly.loop_header566.preheader ], [ %indvars.iv.next1027, %polly.loop_exit575 ]
  ...
  %157 = lshr i64 %polly.indvar569, 2
  %158 = add nuw i64 %indvars.iv1026, %157
  %159 = mul nsw i64 %polly.indvar569, -50
  %160 = mul nuw nsw i64 %polly.indvar569, 50
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582
  ...
  %indvars.iv.next1027 = add nuw nsw i64 %indvars.iv1026, 6
  %exitcond1029.not = icmp eq i64 %polly.indvar_next570, 24
...
polly.loop_header573:                             ; preds = %polly.loop_exit582, %polly.loop_header566
  ...
  %161 = shl nsw i64 %polly.indvar576, 3
  %162 = add nsw i64 %161, %159
  %163 = icmp sgt i64 %162, 0
  %164 = select i1 %163, i64 %162, i64 0
  %polly.loop_guard583 = icmp slt i64 %164, 50
...
polly.loop_header580.preheader:                   ; preds = %polly.loop_header573
  ...
  %165 = add i64 %smax1013, %indvars.iv1016
  %166 = sub nsw i64 %160, %161
  %167 = add nuw nsw i64 %161, 8
...
polly.loop_exit582:                               ; preds = %polly.loop_exit618, %polly.loop_header573
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next577, %158
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit618
  %indvars.iv1018 = phi i64 [ %165, %polly.loop_header580.preheader ], [ %indvars.iv.next1019, %polly.loop_exit618 ]
  %polly.indvar584 = phi i64 [ %164, %polly.loop_header580.preheader ], [ %polly.indvar_next585, %polly.loop_exit618 ]
  %smin1023 = call i64 @llvm.smin.i64(i64 %indvars.iv1018, i64 7)
  %168 = add nsw i64 %polly.indvar584, %166
  %polly.loop_guard5971068 = icmp sgt i64 %168, -1
  %169 = add nuw nsw i64 %polly.indvar584, %160
  %.not856 = icmp ult i64 %169, %167
  %polly.access.mul.call1610 = mul nsw i64 %169, 1000
...
polly.loop_header594.us:                          ; preds = %polly.loop_header587.us, %polly.loop_header594.us
  ...
  %170 = add nuw nsw i64 %polly.indvar598.us, %161
  %polly.access.mul.call1602.us = mul nuw nsw i64 %170, 1000
...
polly.then607.us:                                 ; preds = %polly.cond605.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1467614.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1467.us, %168
...
polly.loop_header587:                             ; preds = %polly.loop_header580.split, %polly.loop_header587
  ...
  %polly.access.add.Packed_MemRef_call1467614 = add nsw i64 %polly.access.mul.Packed_MemRef_call1467613, %168
...
polly.loop_header616.preheader:                   ; preds = %polly.loop_header587, %polly.merge606.us
  %171 = mul i64 %169, 8000
  %172 = mul i64 %169, 9600
...
polly.loop_header616.us:                          ; preds = %polly.loop_header616.preheader, %polly.loop_exit625.loopexit.us
  ...
  %173 = shl nuw nsw i64 %polly.indvar619.us, 3
  %scevgep634.us = getelementptr i8, i8* %call2, i64 %173
  %polly.access.mul.Packed_MemRef_call1467630.us = mul nuw nsw i64 %polly.indvar619.us, 1200
  %scevgep635.us = getelementptr i8, i8* %scevgep634.us, i64 %171
  ...
  %polly.access.add.Packed_MemRef_call1467643.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1467630.us, %168
...
polly.loop_header623.us:                          ; preds = %polly.loop_header623.us, %polly.loop_header616.us
  ...
  %174 = add nuw nsw i64 %polly.indvar627.us, %161
  ...
  %scevgep639.us = getelementptr i8, i8* %scevgep634.us, i64 %175
  ...
  %176 = shl i64 %174, 3
  %177 = add i64 %176, %172
  %scevgep646.us = getelementptr i8, i8* %call, i64 %177
...
polly.loop_header775:                             ; preds = %entry, %polly.loop_exit783
  ...
  %178 = shl nsw i64 %polly.indvar778, 5
  %179 = add nsw i64 %smin1058, 1199
...
polly.loop_header781:                             ; preds = %polly.loop_exit789, %polly.loop_header775
  ...
  %180 = mul nsw i64 %polly.indvar784, -32
  ...
  %182 = shl nsw i64 %polly.indvar784, 5
  %183 = add nsw i64 %smin1054, 1199
...
polly.loop_header787:                             ; preds = %polly.loop_exit795, %polly.loop_header781
  ...
  %184 = add nuw nsw i64 %polly.indvar790, %178
...
vector.ph1096:                                    ; preds = %polly.loop_header787
  %broadcast.splatinsert1103 = insertelement <4 x i64> poison, i64 %182, i32 0
  %broadcast.splat1104 = shufflevector <4 x i64> %broadcast.splatinsert1103, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1105 = insertelement <4 x i32> poison, i32 %185, i32 0
...
vector.body1095:                                  ; preds = %vector.body1095, %vector.ph1096
  ...
  %187 = add nuw nsw <4 x i64> %vec.ind1101, %broadcast.splat1104
  %188 = trunc <4 x i64> %187 to <4 x i32>
  %189 = mul <4 x i32> %broadcast.splat1106, %188
  ...
  %199 = icmp eq i64 %index.next1098, %181
  br i1 %199, label %polly.loop_exit795, label %vector.body1095, !llvm.loop !99

polly.loop_exit795:                               ; preds = %vector.body1095, %polly.loop_header793
  %polly.indvar_next791 = add nuw nsw i64 %polly.indvar790, 1
  %exitcond1059.not = icmp eq i64 %polly.indvar790, %179
...
polly.loop_header793:                             ; preds = %polly.loop_header787, %polly.loop_header793
  ...
  %200 = add nuw nsw i64 %polly.indvar796, %182
  ...
  %scevgep799 = getelementptr i8, i8* %call, i64 %206
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar796, %183
...
polly.loop_header802:                             ; preds = %polly.loop_exit783, %polly.loop_exit810
  ...
  %207 = shl nsw i64 %polly.indvar805, 5
  %208 = add nsw i64 %smin1048, 1199
...
polly.loop_header808:                             ; preds = %polly.loop_exit816, %polly.loop_header802
  ...
  %209 = mul nsw i64 %polly.indvar811, -32
  %smin1110 = call i64 @llvm.smin.i64(i64 %209, i64 -968)
  %210 = add nsw i64 %smin1110, 1000
  %smin1044 = call i64 @llvm.smin.i64(i64 %indvars.iv1042, i64 -968)
  %211 = shl nsw i64 %polly.indvar811, 5
  %212 = add nsw i64 %smin1044, 999
...
vector.body1109:                                  ; preds = %vector.body1109, %vector.ph1112
  ...
  %216 = add nuw nsw <4 x i64> %vec.ind1119, %broadcast.splat1122
  %217 = trunc <4 x i64> %216 to <4 x i32>
  %218 = mul <4 x i32> %broadcast.splat1124, %217
  ...
  %228 = icmp eq i64 %index.next1116, %210
  br i1 %228, label %polly.loop_exit822, label %vector.body1109, !llvm.loop !102

polly.loop_exit822:                               ; preds = %vector.body1109, %polly.loop_header820
  %polly.indvar_next818 = add nuw nsw i64 %polly.indvar817, 1
  %exitcond1049.not = icmp eq i64 %polly.indvar817, %208
...
polly.loop_header820:                             ; preds = %polly.loop_header814, %polly.loop_header820
  ...
  %229 = add nuw nsw i64 %polly.indvar823, %211
  ...
  %scevgep826 = getelementptr i8, i8* %call2, i64 %235
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar823, %212
...
polly.loop_header828:                             ; preds = %polly.loop_exit810, %polly.loop_exit836
  ...
  %236 = shl nsw i64 %polly.indvar831, 5
  %237 = add nsw i64 %smin1038, 1199
...
polly.loop_header834:                             ; preds = %polly.loop_exit842, %polly.loop_header828
  ...
  %238 = mul nsw i64 %polly.indvar837, -32
  %smin1128 = call i64 @llvm.smin.i64(i64 %238, i64 -968)
  %239 = add nsw i64 %smin1128, 1000
  %smin1034 = call i64 @llvm.smin.i64(i64 %indvars.iv1032, i64 -968)
  %240 = shl nsw i64 %polly.indvar837, 5
  %241 = add nsw i64 %smin1034, 999
...
vector.body1127:                                  ; preds = %vector.body1127, %vector.ph1130
  ...
  %245 = add nuw nsw <4 x i64> %vec.ind1137, %broadcast.splat1140
  %246 = trunc <4 x i64> %245 to <4 x i32>
  %247 = mul <4 x i32> %broadcast.splat1142, %246
  ...
  %257 = icmp eq i64 %index.next1134, %239
  br i1 %257, label %polly.loop_exit848, label %vector.body1127, !llvm.loop !105

polly.loop_exit848:                               ; preds = %vector.body1127, %polly.loop_header846
  %polly.indvar_next844 = add nuw nsw i64 %polly.indvar843, 1
  %exitcond1039.not = icmp eq i64 %polly.indvar843, %237
...
polly.loop_header846:                             ; preds = %polly.loop_header840, %polly.loop_header846
  ...
  %258 = add nuw nsw i64 %polly.indvar849, %240
  ...
  %scevgep853 = getelementptr i8, i8* %call1, i64 %264
  ...
  %exitcond1035.not = icmp eq i64 %polly.indvar849, %241
