; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4516.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4516.c"
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %indvars.iv979, i64 63)
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header387
  ...
  %132 = shl nsw i64 %polly.indvar397, 6
  %133 = sub nsw i64 %129, %132
  %134 = add nuw nsw i64 %132, 64
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header576
  ...
  %163 = shl nsw i64 %polly.indvar586, 6
  %164 = sub nsw i64 %160, %163
  %165 = add nuw nsw i64 %163, 64
...
polly.loop_exit591:                               ; preds = %polly.loop_exit626
  ...
  %indvars.iv.next1021 = add nsw i64 %indvars.iv1020, -64
...
polly.loop_header589:                             ; preds = %polly.loop_exit626, %polly.loop_header583
  ...
  %smin1027 = call i64 @llvm.smin.i64(i64 %indvars.iv1022, i64 63)
