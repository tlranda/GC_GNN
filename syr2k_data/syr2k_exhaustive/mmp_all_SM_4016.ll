; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4016.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4016.c"
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin987 = call i64 @llvm.smin.i64(i64 %indvars.iv981, i64 7)
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header387
  ...
  %132 = shl nsw i64 %polly.indvar397, 3
  %133 = sub nsw i64 %129, %132
  %134 = add nuw nsw i64 %132, 8
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header576
  ...
  %163 = shl nsw i64 %polly.indvar586, 3
  %164 = sub nsw i64 %160, %163
  %165 = add nuw nsw i64 %163, 8
...
polly.loop_exit591:                               ; preds = %polly.loop_exit626
  ...
  %indvars.iv.next1028 = add nsw i64 %indvars.iv1027, -8
...
polly.loop_header589:                             ; preds = %polly.loop_exit626, %polly.loop_header583
  ...
  %smin1035 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 7)
