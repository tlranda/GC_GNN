; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2115.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2115.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %109 = add i64 %97, %108
  %smax1347 = call i64 @llvm.smax.i64(i64 %109, i64 0)
  %110 = mul nsw i64 %polly.indvar231, -20
  %111 = add i64 %98, %110
  %112 = add i64 %smax1347, %111
...
polly.loop_exit236:                               ; preds = %polly.loop_exit267, %polly.loop_header228
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar231, %106
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %120 = add i64 %112, %indvar1348
  %smin1350 = call i64 @llvm.smin.i64(i64 %120, i64 19)
  %121 = add nsw i64 %smin1350, 1
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv1042, i64 19)
  %122 = add nsw i64 %polly.indvar237, %118
  %polly.loop_guard2501148 = icmp sgt i64 %122, -1
...
polly.loop_header265.us:                          ; preds = %polly.loop_header265.preheader, %polly.loop_exit274.loopexit.us
  ...
  %min.iters.check1351 = icmp ult i64 %121, 4
...
vector.body1346:                                  ; preds = %vector.body1346, %vector.ph1352
  ...
  %129 = add nuw nsw i64 %index1355, %113
  %130 = add nuw nsw i64 %index1355, %polly.access.mul.Packed_MemRef_call1279.us
  %131 = getelementptr double, double* %Packed_MemRef_call1, i64 %130
  %132 = bitcast double* %131 to <4 x double>*
  %wide.load1359 = load <4 x double>, <4 x double>* %132, align 8
  %133 = fmul fast <4 x double> %broadcast.splat1361, %wide.load1359
  ...
  %wide.load1362 = load <4 x double>, <4 x double>* %136, align 8
  %137 = fmul fast <4 x double> %broadcast.splat1364, %wide.load1362
  %138 = shl i64 %129, 3
  %139 = add i64 %138, %127
  %140 = getelementptr i8, i8* %call, i64 %139
  %141 = bitcast i8* %140 to <4 x double>*
  %wide.load1365 = load <4 x double>, <4 x double>* %141, align 8, !alias.scope !65, !noalias !67
  ...
  %144 = fadd fast <4 x double> %143, %wide.load1365
  ...
  %146 = icmp eq i64 %index.next1356, %n.vec1354
  br i1 %146, label %middle.block1344, label %vector.body1346, !llvm.loop !77

middle.block1344:                                 ; preds = %vector.body1346
  %cmp.n1358 = icmp eq i64 %121, %n.vec1354
...
vector.body1284:                                  ; preds = %vector.body1284, %vector.ph1288
  ...
  %152 = shl nuw nsw i64 %index1291, 3
  %153 = getelementptr i8, i8* %scevgep400, i64 %152
  %154 = bitcast i8* %153 to <4 x double>*
  %wide.load1295 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !79, !noalias !81
  %155 = fmul fast <4 x double> %wide.load1295, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %157 = icmp eq i64 %index.next1292, %n.vec1290
  br i1 %157, label %middle.block1282, label %vector.body1284, !llvm.loop !86

middle.block1282:                                 ; preds = %vector.body1284
  %cmp.n1294 = icmp eq i64 %150, %n.vec1290
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  ...
  %159 = mul nsw i64 %polly.indvar423, -64
  %160 = shl nuw nsw i64 %polly.indvar423, 6
  %161 = udiv i64 %polly.indvar423, 5
  %162 = add nuw i64 %indvars.iv1076, %161
  %umin1078 = call i64 @llvm.umin.i64(i64 %162, i64 56)
  %163 = mul nsw i64 %polly.indvar423, -64
  %164 = icmp slt i64 %163, -1136
  %165 = select i1 %164, i64 %163, i64 -1136
  %166 = add nsw i64 %165, 1199
  %167 = shl nsw i64 %polly.indvar423, 6
  %168 = add nuw nsw i64 %umin1078, 3
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %171 = add i64 %159, %170
  %smax1299 = call i64 @llvm.smax.i64(i64 %171, i64 0)
  %172 = mul nsw i64 %polly.indvar436, -20
  %173 = add i64 %160, %172
  %174 = add i64 %smax1299, %173
...
polly.loop_header440.preheader:                   ; preds = %polly.loop_header433
  ...
  %179 = add i64 %smax1063, %indvars.iv1066
...
polly.loop_exit442:                               ; preds = %polly.loop_exit478, %polly.loop_header433
  ...
  %exitcond1079.not = icmp eq i64 %polly.indvar436, %168
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %indvars.iv1068 = phi i64 [ %179, %polly.loop_header440.preheader ], [ %indvars.iv.next1069, %polly.loop_exit478 ]
  %polly.indvar444 = phi i64 [ %178, %polly.loop_header440.preheader ], [ %polly.indvar_next445, %polly.loop_exit478 ]
  %182 = add i64 %174, %indvar1300
  %smin1302 = call i64 @llvm.smin.i64(i64 %182, i64 19)
  %183 = add nsw i64 %smin1302, 1
  %smin1073 = call i64 @llvm.smin.i64(i64 %indvars.iv1068, i64 19)
  %184 = add nsw i64 %polly.indvar444, %180
  %polly.loop_guard4571149 = icmp sgt i64 %184, -1
...
polly.loop_header476.us:                          ; preds = %polly.loop_header476.preheader, %polly.loop_exit485.loopexit.us
  ...
  %min.iters.check1303 = icmp ult i64 %183, 4
...
vector.body1298:                                  ; preds = %vector.body1298, %vector.ph1304
  ...
  %191 = add nuw nsw i64 %index1307, %175
  %192 = add nuw nsw i64 %index1307, %polly.access.mul.Packed_MemRef_call1303490.us
  %193 = getelementptr double, double* %Packed_MemRef_call1303, i64 %192
  %194 = bitcast double* %193 to <4 x double>*
  %wide.load1311 = load <4 x double>, <4 x double>* %194, align 8
  %195 = fmul fast <4 x double> %broadcast.splat1313, %wide.load1311
  ...
  %wide.load1314 = load <4 x double>, <4 x double>* %198, align 8
  %199 = fmul fast <4 x double> %broadcast.splat1316, %wide.load1314
  %200 = shl i64 %191, 3
  %201 = add i64 %200, %189
  %202 = getelementptr i8, i8* %call, i64 %201
  %203 = bitcast i8* %202 to <4 x double>*
  %wide.load1317 = load <4 x double>, <4 x double>* %203, align 8, !alias.scope !79, !noalias !81
  ...
  %206 = fadd fast <4 x double> %205, %wide.load1317
  ...
  %208 = icmp eq i64 %index.next1308, %n.vec1306
  br i1 %208, label %middle.block1296, label %vector.body1298, !llvm.loop !90

middle.block1296:                                 ; preds = %vector.body1298
  %cmp.n1310 = icmp eq i64 %183, %n.vec1306
...
polly.loop_header599:                             ; preds = %polly.loop_exit607, %polly.start511
  ...
  %min.iters.check1239 = icmp ult i64 %212, 4
...
vector.body1238:                                  ; preds = %vector.body1238, %vector.ph1240
  ...
  %214 = shl nuw nsw i64 %index1243, 3
  %215 = getelementptr i8, i8* %scevgep611, i64 %214
  %216 = bitcast i8* %215 to <4 x double>*
  %wide.load1247 = load <4 x double>, <4 x double>* %216, align 8, !alias.scope !92, !noalias !94
  %217 = fmul fast <4 x double> %wide.load1247, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %219 = icmp eq i64 %index.next1244, %n.vec1242
  br i1 %219, label %middle.block1236, label %vector.body1238, !llvm.loop !99

middle.block1236:                                 ; preds = %vector.body1238
  %cmp.n1246 = icmp eq i64 %212, %n.vec1242
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  ...
  %221 = mul nsw i64 %polly.indvar634, -64
  %222 = shl nuw nsw i64 %polly.indvar634, 6
  %223 = udiv i64 %polly.indvar634, 5
  %224 = add nuw i64 %indvars.iv1104, %223
  %umin1106 = call i64 @llvm.umin.i64(i64 %224, i64 56)
  %225 = mul nsw i64 %polly.indvar634, -64
  %226 = icmp slt i64 %225, -1136
  %227 = select i1 %226, i64 %225, i64 -1136
  %228 = add nsw i64 %227, 1199
  %229 = shl nsw i64 %polly.indvar634, 6
  %230 = add nuw nsw i64 %umin1106, 3
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %233 = add i64 %221, %232
  %smax1251 = call i64 @llvm.smax.i64(i64 %233, i64 0)
  %234 = mul nsw i64 %polly.indvar647, -20
  %235 = add i64 %222, %234
  %236 = add i64 %smax1251, %235
...
polly.loop_header651.preheader:                   ; preds = %polly.loop_header644
  ...
  %241 = add i64 %smax1091, %indvars.iv1094
...
polly.loop_exit653:                               ; preds = %polly.loop_exit689, %polly.loop_header644
  ...
  %exitcond1107.not = icmp eq i64 %polly.indvar647, %230
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %indvars.iv1096 = phi i64 [ %241, %polly.loop_header651.preheader ], [ %indvars.iv.next1097, %polly.loop_exit689 ]
  %polly.indvar655 = phi i64 [ %240, %polly.loop_header651.preheader ], [ %polly.indvar_next656, %polly.loop_exit689 ]
  %244 = add i64 %236, %indvar1252
  %smin1254 = call i64 @llvm.smin.i64(i64 %244, i64 19)
  %245 = add nsw i64 %smin1254, 1
  %smin1101 = call i64 @llvm.smin.i64(i64 %indvars.iv1096, i64 19)
  %246 = add nsw i64 %polly.indvar655, %242
  %polly.loop_guard6681150 = icmp sgt i64 %246, -1
...
polly.loop_header687.us:                          ; preds = %polly.loop_header687.preheader, %polly.loop_exit696.loopexit.us
  ...
  %min.iters.check1255 = icmp ult i64 %245, 4
...
vector.body1250:                                  ; preds = %vector.body1250, %vector.ph1256
  ...
  %253 = add nuw nsw i64 %index1259, %237
  %254 = add nuw nsw i64 %index1259, %polly.access.mul.Packed_MemRef_call1514701.us
  %255 = getelementptr double, double* %Packed_MemRef_call1514, i64 %254
  %256 = bitcast double* %255 to <4 x double>*
  %wide.load1263 = load <4 x double>, <4 x double>* %256, align 8
  %257 = fmul fast <4 x double> %broadcast.splat1265, %wide.load1263
  ...
  %wide.load1266 = load <4 x double>, <4 x double>* %260, align 8
  %261 = fmul fast <4 x double> %broadcast.splat1268, %wide.load1266
  %262 = shl i64 %253, 3
  %263 = add i64 %262, %251
  %264 = getelementptr i8, i8* %call, i64 %263
  %265 = bitcast i8* %264 to <4 x double>*
  %wide.load1269 = load <4 x double>, <4 x double>* %265, align 8, !alias.scope !92, !noalias !94
  ...
  %268 = fadd fast <4 x double> %267, %wide.load1269
  ...
  %270 = icmp eq i64 %index.next1260, %n.vec1258
  br i1 %270, label %middle.block1248, label %vector.body1250, !llvm.loop !103

middle.block1248:                                 ; preds = %vector.body1250
  %cmp.n1262 = icmp eq i64 %245, %n.vec1258
...
vector.ph1178:                                    ; preds = %polly.loop_header858
  %broadcast.splatinsert1185 = insertelement <4 x i64> poison, i64 %278, i32 0
  %broadcast.splat1186 = shufflevector <4 x i64> %broadcast.splatinsert1185, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1187 = insertelement <4 x i32> poison, i32 %281, i32 0
...
vector.body1177:                                  ; preds = %vector.body1177, %vector.ph1178
  ...
  %283 = add nuw nsw <4 x i64> %vec.ind1183, %broadcast.splat1186
  %284 = trunc <4 x i64> %283 to <4 x i32>
  %285 = mul <4 x i32> %broadcast.splat1188, %284
  ...
  %295 = icmp eq i64 %index.next1180, %277
  br i1 %295, label %polly.loop_exit866, label %vector.body1177, !llvm.loop !110

polly.loop_exit866:                               ; preds = %vector.body1177, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1141.not = icmp eq i64 %polly.indvar861, %275
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1137.not = icmp eq i64 %polly.indvar867, %279
...
polly.loop_header879:                             ; preds = %polly.loop_exit887, %polly.loop_header873
  ...
  %smin1192 = call i64 @llvm.smin.i64(i64 %305, i64 -968)
  %306 = add nsw i64 %smin1192, 1000
  %smin1126 = call i64 @llvm.smin.i64(i64 %indvars.iv1124, i64 -968)
  %307 = shl nsw i64 %polly.indvar882, 5
  %308 = add nsw i64 %smin1126, 999
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1194
  ...
  %312 = add nuw nsw <4 x i64> %vec.ind1201, %broadcast.splat1204
  %313 = trunc <4 x i64> %312 to <4 x i32>
  %314 = mul <4 x i32> %broadcast.splat1206, %313
  ...
  %324 = icmp eq i64 %index.next1198, %306
  br i1 %324, label %polly.loop_exit893, label %vector.body1191, !llvm.loop !113

polly.loop_exit893:                               ; preds = %vector.body1191, %polly.loop_header891
  %polly.indvar_next889 = add nuw nsw i64 %polly.indvar888, 1
  %exitcond1131.not = icmp eq i64 %polly.indvar888, %304
...
polly.loop_header891:                             ; preds = %polly.loop_header885, %polly.loop_header891
  ...
  %exitcond1127.not = icmp eq i64 %polly.indvar894, %308
...
polly.loop_header905:                             ; preds = %polly.loop_exit913, %polly.loop_header899
  ...
  %smin1210 = call i64 @llvm.smin.i64(i64 %334, i64 -968)
  %335 = add nsw i64 %smin1210, 1000
  %smin1116 = call i64 @llvm.smin.i64(i64 %indvars.iv1114, i64 -968)
  %336 = shl nsw i64 %polly.indvar908, 5
  %337 = add nsw i64 %smin1116, 999
...
vector.body1209:                                  ; preds = %vector.body1209, %vector.ph1212
  ...
  %341 = add nuw nsw <4 x i64> %vec.ind1219, %broadcast.splat1222
  %342 = trunc <4 x i64> %341 to <4 x i32>
  %343 = mul <4 x i32> %broadcast.splat1224, %342
  ...
  %353 = icmp eq i64 %index.next1216, %335
  br i1 %353, label %polly.loop_exit919, label %vector.body1209, !llvm.loop !116

polly.loop_exit919:                               ; preds = %vector.body1209, %polly.loop_header917
  %polly.indvar_next915 = add nuw nsw i64 %polly.indvar914, 1
  %exitcond1121.not = icmp eq i64 %polly.indvar914, %333
...
polly.loop_header917:                             ; preds = %polly.loop_header911, %polly.loop_header917
  ...
  %exitcond1117.not = icmp eq i64 %polly.indvar920, %337
