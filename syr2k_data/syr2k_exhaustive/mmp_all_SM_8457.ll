; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8457.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8457.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond806.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !67

polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv800 = phi i64 [ %indvars.iv.next801, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %polly.indvar202 = phi i64 [ %polly.indvar_next203, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %smin802 = call i64 @llvm.smin.i64(i64 %indvars.iv800, i64 -872)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond805.not = icmp eq i64 %polly.indvar_next203, 8
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1011
  ...
  %wide.load1018 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %132, label %middle.block1005, label %vector.body1007, !llvm.loop !76
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond831.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !77
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %smin827 = call i64 @llvm.smin.i64(i64 %indvars.iv825, i64 -872)
  %134 = shl nsw i64 %polly.indvar357, 7
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar_next358, 8
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph985
  ...
  %wide.load992 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %169, label %middle.block981, label %vector.body983, !llvm.loop !85
...
polly.loop_header502:                             ; preds = %polly.loop_header502.preheader, %polly.loop_header502
  ...
  br i1 %exitcond856.not, label %polly.loop_exit504, label %polly.loop_header502, !llvm.loop !86
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %171 = shl nsw i64 %polly.indvar515, 7
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar_next516, 8
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph923
  ...
  br i1 %220, label %polly.loop_exit714, label %vector.body921, !llvm.loop !94
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  br i1 %exitcond881.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !95
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph939
  ...
  br i1 %249, label %polly.loop_exit741, label %vector.body936, !llvm.loop !97
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  br i1 %exitcond871.not, label %polly.loop_exit741, label %polly.loop_header739, !llvm.loop !98
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph957
  ...
  br i1 %278, label %polly.loop_exit767, label %vector.body954, !llvm.loop !100
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  br i1 %exitcond861.not, label %polly.loop_exit767, label %polly.loop_header765, !llvm.loop !101
}
