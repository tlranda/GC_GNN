; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6655.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6655.c"
...
polly.loop_exit241:                               ; preds = %polly.loop_header245.us.3, %polly.loop_header233
  ...
  %exitcond834.not = icmp eq i64 %polly.indvar_next237, 4
...
vector.body1022:                                  ; preds = %vector.body1022, %vector.ph1026
  ...
  %wide.load1033 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %126, label %middle.block1020, label %vector.body1022, !llvm.loop !78
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %128 = shl nsw i64 %polly.indvar391, 2
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_header394
  ...
  %137 = shl nsw i64 %polly.indvar403, 2
...
polly.loop_header406:                             ; preds = %polly.loop_exit414, %polly.loop_header400
  ...
  %smin850 = call i64 @llvm.smin.i64(i64 %indvars.iv848, i64 3)
...
polly.loop_exit414:                               ; preds = %polly.loop_header419.us.3, %polly.loop_header406
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next410, 4
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1000
  ...
  %wide.load1007 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !82, !noalias !84
  ...
  br i1 %157, label %middle.block996, label %vector.body998, !llvm.loop !88
...
polly.loop_header563:                             ; preds = %polly.loop_exit555, %polly.loop_exit571
  ...
  %159 = shl nsw i64 %polly.indvar566, 2
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %168 = shl nsw i64 %polly.indvar578, 2
...
polly.loop_exit589:                               ; preds = %polly.loop_header594.us.3, %polly.loop_header581
  ...
  %exitcond872.not = icmp eq i64 %polly.indvar_next585, 4
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  br i1 %202, label %polly.loop_exit764, label %vector.body936, !llvm.loop !97
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  br i1 %231, label %polly.loop_exit791, label %vector.body951, !llvm.loop !100
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph972
  ...
  br i1 %260, label %polly.loop_exit817, label %vector.body969, !llvm.loop !103
