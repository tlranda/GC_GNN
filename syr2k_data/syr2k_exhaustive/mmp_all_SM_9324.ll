; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9324.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9324.c"
...
polly.loop_exit225:                               ; preds = %polly.loop_header229.us.3, %polly.loop_header217
  ...
  %exitcond784.not = icmp eq i64 %polly.indvar_next221, 4
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph973
  ...
  %wide.load980 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %126, label %middle.block967, label %vector.body969, !llvm.loop !73
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %128 = udiv i64 %polly.indvar355, 20
...
polly.loop_header365:                             ; preds = %polly.loop_exit373, %polly.loop_header358
  ...
  %137 = mul nuw nsw i64 %polly.indvar368, 80
...
polly.loop_exit379:                               ; preds = %polly.loop_header384.us.3, %polly.loop_header371
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next375, 4
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph947
  ...
  %wide.load954 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %157, label %middle.block943, label %vector.body945, !llvm.loop !82
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %159 = udiv i64 %polly.indvar511, 20
  %160 = shl nsw i64 %polly.indvar511, 2
...
polly.loop_header521:                             ; preds = %polly.loop_exit529, %polly.loop_header514
  ...
  %168 = mul nuw nsw i64 %polly.indvar524, 80
...
polly.loop_header527:                             ; preds = %polly.loop_exit535, %polly.loop_header521
  ...
  %smin811 = call i64 @llvm.smin.i64(i64 %indvars.iv809, i64 79)
...
polly.loop_exit535:                               ; preds = %polly.loop_header540.us.3, %polly.loop_header527
  ...
  %exitcond814.not = icmp eq i64 %polly.indvar_next531, 4
...
vector.body883:                                   ; preds = %vector.body883, %vector.ph885
  ...
  br i1 %202, label %polly.loop_exit708, label %vector.body883, !llvm.loop !91
...
vector.body898:                                   ; preds = %vector.body898, %vector.ph901
  ...
  br i1 %231, label %polly.loop_exit735, label %vector.body898, !llvm.loop !94
...
vector.body916:                                   ; preds = %vector.body916, %vector.ph919
  ...
  br i1 %260, label %polly.loop_exit761, label %vector.body916, !llvm.loop !97
