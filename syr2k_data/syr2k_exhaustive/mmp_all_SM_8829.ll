; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8829.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8829.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond788.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header217:                             ; preds = %polly.loop_exit226, %polly.loop_header211
  %indvars.iv785 = phi i64 [ %indvars.iv.next786, %polly.loop_exit226 ], [ %104, %polly.loop_header211 ]
  ...
  %115 = add i64 %114, %103
  %polly.loop_guard227859 = icmp sgt i64 %115, -1
  br i1 %polly.loop_guard227859, label %polly.loop_header224.preheader, label %polly.loop_exit226
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph978
  ...
  %124 = shl nuw nsw i64 %index981, 3
  %125 = getelementptr i8, i8* %scevgep348, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load985 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !72, !noalias !74
  %127 = fmul fast <4 x double> %wide.load985, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next982, %n.vec980
  br i1 %129, label %middle.block972, label %vector.body974, !llvm.loop !77

middle.block972:                                  ; preds = %vector.body974
  %cmp.n984 = icmp eq i64 %122, %n.vec980
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %132 = add nuw i64 %polly.indvar355, %131
  %133 = shl nuw nsw i64 %132, 6
  %134 = sub i64 %indvars.iv791, %133
  %135 = add i64 %indvars.iv796, %133
  %136 = mul nuw nsw i64 %polly.indvar355, 80
  %137 = mul nsw i64 %polly.indvar355, -80
  br label %polly.loop_header359

polly.loop_exit361:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next792 = add nuw nsw i64 %indvars.iv791, 80
  %indvars.iv.next797 = add nsw i64 %indvars.iv796, -80
  %exitcond805.not = icmp eq i64 %polly.indvar_next356, 15
...
polly.loop_header359:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  %indvars.iv798 = phi i64 [ %indvars.iv.next799, %polly.loop_exit367 ], [ %135, %polly.loop_header352 ]
  %indvars.iv793 = phi i64 [ %indvars.iv.next794, %polly.loop_exit367 ], [ %134, %polly.loop_header352 ]
  %polly.indvar362 = phi i64 [ %polly.indvar_next363, %polly.loop_exit367 ], [ %132, %polly.loop_header352 ]
  %smax795 = call i64 @llvm.smax.i64(i64 %indvars.iv793, i64 0)
  %138 = add i64 %smax795, %indvars.iv798
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header359
  ...
  %polly.loop_cond364 = icmp ult i64 %polly.indvar362, 18
...
polly.loop_exit374:                               ; preds = %polly.loop_exit382
  ...
  %exitcond804.not = icmp eq i64 %polly.indvar_next369, 1000
  br i1 %exitcond804.not, label %polly.loop_exit367, label %polly.loop_header365

polly.loop_header372:                             ; preds = %polly.loop_exit382, %polly.loop_header365
  %indvars.iv800 = phi i64 [ %indvars.iv.next801, %polly.loop_exit382 ], [ %138, %polly.loop_header365 ]
  ...
  %149 = add i64 %148, %137
  %polly.loop_guard383860 = icmp sgt i64 %149, -1
  br i1 %polly.loop_guard383860, label %polly.loop_header380.preheader, label %polly.loop_exit382
...
polly.loop_header380:                             ; preds = %polly.loop_header380.preheader, %polly.loop_header380
  ...
  %exitcond803.not = icmp eq i64 %polly.indvar384, %smin802
  br i1 %exitcond803.not, label %polly.loop_exit382, label %polly.loop_header380
...
vector.body950:                                   ; preds = %vector.body950, %vector.ph952
  ...
  %158 = shl nuw nsw i64 %index955, 3
  %159 = getelementptr i8, i8* %scevgep504, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load959 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !81, !noalias !83
  %161 = fmul fast <4 x double> %wide.load959, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next956, %n.vec954
  br i1 %163, label %middle.block948, label %vector.body950, !llvm.loop !86

middle.block948:                                  ; preds = %vector.body950
  %cmp.n958 = icmp eq i64 %156, %n.vec954
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %166 = add nuw i64 %polly.indvar511, %165
  %167 = shl nuw nsw i64 %166, 6
  %168 = sub i64 %indvars.iv808, %167
  %169 = add i64 %indvars.iv813, %167
  %170 = mul nuw nsw i64 %polly.indvar511, 80
  %171 = mul nsw i64 %polly.indvar511, -80
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next809 = add nuw nsw i64 %indvars.iv808, 80
  %indvars.iv.next814 = add nsw i64 %indvars.iv813, -80
  %exitcond822.not = icmp eq i64 %polly.indvar_next512, 15
...
polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  %indvars.iv815 = phi i64 [ %indvars.iv.next816, %polly.loop_exit523 ], [ %169, %polly.loop_header508 ]
  %indvars.iv810 = phi i64 [ %indvars.iv.next811, %polly.loop_exit523 ], [ %168, %polly.loop_header508 ]
  %polly.indvar518 = phi i64 [ %polly.indvar_next519, %polly.loop_exit523 ], [ %166, %polly.loop_header508 ]
  %smax812 = call i64 @llvm.smax.i64(i64 %indvars.iv810, i64 0)
  %172 = add i64 %smax812, %indvars.iv815
...
polly.loop_exit523:                               ; preds = %polly.loop_exit530, %polly.loop_header515
  ...
  %polly.loop_cond520 = icmp ult i64 %polly.indvar518, 18
...
polly.loop_exit530:                               ; preds = %polly.loop_exit538
  ...
  %exitcond821.not = icmp eq i64 %polly.indvar_next525, 1000
  br i1 %exitcond821.not, label %polly.loop_exit523, label %polly.loop_header521

polly.loop_header528:                             ; preds = %polly.loop_exit538, %polly.loop_header521
  %indvars.iv817 = phi i64 [ %indvars.iv.next818, %polly.loop_exit538 ], [ %172, %polly.loop_header521 ]
  ...
  %183 = add i64 %182, %171
  %polly.loop_guard539861 = icmp sgt i64 %183, -1
  br i1 %polly.loop_guard539861, label %polly.loop_header536.preheader, label %polly.loop_exit538
...
polly.loop_header536:                             ; preds = %polly.loop_header536.preheader, %polly.loop_header536
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar540, %smin819
  br i1 %exitcond820.not, label %polly.loop_exit538, label %polly.loop_header536
...
polly.loop_header694:                             ; preds = %polly.loop_exit702, %polly.loop_header688
  ...
  %smin889 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin889, 1200
  %smin847 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -1168)
  %194 = shl nsw i64 %polly.indvar697, 5
  %195 = add nsw i64 %smin847, 1199
...
vector.ph890:                                     ; preds = %polly.loop_header700
  %broadcast.splatinsert897 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat898 = shufflevector <4 x i64> %broadcast.splatinsert897, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert899 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body888:                                   ; preds = %vector.body888, %vector.ph890
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind895, %broadcast.splat898
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat900, %200
  ...
  %211 = icmp eq i64 %index.next892, %193
  br i1 %211, label %polly.loop_exit708, label %vector.body888, !llvm.loop !95

polly.loop_exit708:                               ; preds = %vector.body888, %polly.loop_header706
  %polly.indvar_next704 = add nuw nsw i64 %polly.indvar703, 1
  %exitcond852.not = icmp eq i64 %polly.indvar703, %191
...
polly.loop_header706:                             ; preds = %polly.loop_header700, %polly.loop_header706
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar709, %195
...
polly.loop_header721:                             ; preds = %polly.loop_exit729, %polly.loop_header715
  ...
  %smin904 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin904, 1000
  %smin837 = call i64 @llvm.smin.i64(i64 %indvars.iv835, i64 -968)
  %223 = shl nsw i64 %polly.indvar724, 5
  %224 = add nsw i64 %smin837, 999
...
vector.body903:                                   ; preds = %vector.body903, %vector.ph906
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind913, %broadcast.splat916
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat918, %229
  ...
  %240 = icmp eq i64 %index.next910, %222
  br i1 %240, label %polly.loop_exit735, label %vector.body903, !llvm.loop !98

polly.loop_exit735:                               ; preds = %vector.body903, %polly.loop_header733
  %polly.indvar_next731 = add nuw nsw i64 %polly.indvar730, 1
  %exitcond842.not = icmp eq i64 %polly.indvar730, %220
...
polly.loop_header733:                             ; preds = %polly.loop_header727, %polly.loop_header733
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar736, %224
...
polly.loop_header747:                             ; preds = %polly.loop_exit755, %polly.loop_header741
  ...
  %smin922 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin922, 1000
  %smin827 = call i64 @llvm.smin.i64(i64 %indvars.iv825, i64 -968)
  %252 = shl nsw i64 %polly.indvar750, 5
  %253 = add nsw i64 %smin827, 999
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind931, %broadcast.splat934
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat936, %258
  ...
  %269 = icmp eq i64 %index.next928, %251
  br i1 %269, label %polly.loop_exit761, label %vector.body921, !llvm.loop !101

polly.loop_exit761:                               ; preds = %vector.body921, %polly.loop_header759
  %polly.indvar_next757 = add nuw nsw i64 %polly.indvar756, 1
  %exitcond832.not = icmp eq i64 %polly.indvar756, %249
...
polly.loop_header759:                             ; preds = %polly.loop_header753, %polly.loop_header759
  ...
  %exitcond828.not = icmp eq i64 %polly.indvar762, %253
