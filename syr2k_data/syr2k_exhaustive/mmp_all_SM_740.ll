; ModuleID = 'syr2k_exhaustive/mmp_all_SM_740.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_740.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %109 = add i64 %108, %106
  %110 = mul nuw nsw i64 %polly.indvar209, 160
  %111 = mul nuw nsw i64 %polly.indvar209, 20
  %112 = mul i64 %polly.indvar209, 20
  %113 = and i64 %112, -64
  %114 = sub i64 %111, %113
  %115 = or i64 %110, 8
  %116 = and i64 %111, 9223372036854775744
  %117 = and i64 %111, 60
  %118 = mul nsw i64 %polly.indvar209, -20
  %119 = add i64 %118, %116
  %120 = shl nuw nsw i64 %indvars.iv1094, 2
  %121 = and i64 %120, 9223372036854775744
  %122 = sub nsw i64 %indvars.iv1092, %121
  %123 = add i64 %indvars.iv1098, %121
  %124 = mul nsw i64 %polly.indvar209, -20
...
polly.loop_header272:                             ; preds = %polly.loop_header265, %polly.loop_exit282
  ...
  %smin1458 = call i64 @llvm.smin.i64(i64 %165, i64 19)
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %213 = and i64 %212, 9223372036854775744
  %214 = and i64 %212, 60
  %215 = mul nsw i64 %polly.indvar421, -20
  %216 = add i64 %215, %213
  %217 = mul nuw nsw i64 %polly.indvar421, 160
  %218 = mul nuw nsw i64 %polly.indvar421, 20
  %219 = mul i64 %polly.indvar421, 20
  %220 = and i64 %219, -64
  %221 = sub i64 %218, %220
  %222 = or i64 %217, 8
  %223 = and i64 %218, 9223372036854775744
  %224 = and i64 %218, 60
  %225 = mul nsw i64 %polly.indvar421, -20
  %226 = add i64 %225, %223
  %227 = shl nuw nsw i64 %indvars.iv1120, 2
  %228 = and i64 %227, 9223372036854775744
  %229 = sub nsw i64 %indvars.iv1118, %228
  %230 = add i64 %indvars.iv1125, %228
  %231 = mul nsw i64 %polly.indvar421, -20
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit432.7
  ...
  %234 = mul nsw i64 %indvar1373, -64
  %235 = or i64 %214, %234
  %smax1393 = call i64 @llvm.smax.i64(i64 %235, i64 0)
  %236 = shl nuw nsw i64 %indvar1373, 6
  %237 = add i64 %216, %236
  %238 = add i64 %smax1393, %237
  %239 = mul nsw i64 %indvar1373, -64
  %240 = add i64 %221, %239
  %smax1375 = call i64 @llvm.smax.i64(i64 %240, i64 0)
  %241 = shl nuw nsw i64 %indvar1373, 6
  %242 = add i64 %220, %241
  ...
  %251 = shl nsw i64 %polly.indvar444, 6
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_header466.7, %polly.loop_header466.us.7, %polly.loop_exit456.loopexit.us.7, %polly.loop_header441.split
  ...
  %265 = mul nsw i64 %polly.indvar444, -64
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %smin1394 = call i64 @llvm.smin.i64(i64 %272, i64 19)
  ...
  %smin1381 = call i64 @llvm.smin.i64(i64 %277, i64 19)
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %320 = and i64 %319, 9223372036854775744
  %321 = and i64 %319, 60
  %322 = mul nsw i64 %polly.indvar636, -20
  %323 = add i64 %322, %320
  %324 = mul nuw nsw i64 %polly.indvar636, 160
  %325 = mul nuw nsw i64 %polly.indvar636, 20
  %326 = mul i64 %polly.indvar636, 20
  %327 = and i64 %326, -64
  %328 = sub i64 %325, %327
  %329 = or i64 %324, 8
  %330 = and i64 %325, 9223372036854775744
  %331 = and i64 %325, 60
  %332 = mul nsw i64 %polly.indvar636, -20
  %333 = add i64 %332, %330
  %334 = shl nuw nsw i64 %indvars.iv1148, 2
  %335 = and i64 %334, 9223372036854775744
  %336 = sub nsw i64 %indvars.iv1146, %335
  %337 = add i64 %indvars.iv1153, %335
  %338 = mul nsw i64 %polly.indvar636, -20
  %339 = mul nuw nsw i64 %polly.indvar636, 20
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit647.7
  ...
  %341 = mul nsw i64 %indvar1309, -64
  %342 = or i64 %321, %341
  %smax1329 = call i64 @llvm.smax.i64(i64 %342, i64 0)
  %343 = shl nuw nsw i64 %indvar1309, 6
  %344 = add i64 %323, %343
  %345 = add i64 %smax1329, %344
  %346 = mul nsw i64 %indvar1309, -64
  %347 = add i64 %328, %346
  %smax1311 = call i64 @llvm.smax.i64(i64 %347, i64 0)
  %348 = shl nuw nsw i64 %indvar1309, 6
  %349 = add i64 %327, %348
  ...
  %358 = shl nsw i64 %polly.indvar659, 6
...
polly.loop_header695.preheader:                   ; preds = %polly.loop_header681.7, %polly.loop_header681.us.7, %polly.loop_exit671.loopexit.us.7, %polly.loop_header656.split
  ...
  %372 = mul nsw i64 %polly.indvar659, -64
  %373 = icmp slt i64 %372, -1136
  %374 = select i1 %373, i64 %372, i64 -1136
...
polly.loop_header702:                             ; preds = %polly.loop_header695, %polly.loop_exit712
  ...
  %smin1330 = call i64 @llvm.smin.i64(i64 %379, i64 19)
  ...
  %smin1317 = call i64 @llvm.smin.i64(i64 %384, i64 19)
...
polly.loop_exit432.7:                             ; preds = %polly.loop_header430.7
  ...
  %pexp.p_div_q440 = lshr i64 %534, 4
...
polly.loop_exit647.7:                             ; preds = %polly.loop_header645.7
  ...
  %pexp.p_div_q655 = lshr i64 %564, 4
