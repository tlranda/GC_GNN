; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8796.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8796.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond797.not = icmp eq i64 %polly.indvar_next209, 15
...
polly.loop_header223:                             ; preds = %polly.loop_header217, %polly.loop_exit232
  %indvars.iv791 = phi i64 [ %106, %polly.loop_header217 ], [ %indvars.iv.next792, %polly.loop_exit232 ]
  ...
  %118 = add i64 %117, %105
  %polly.loop_guard233877 = icmp sgt i64 %118, -1
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %134, label %middle.block990, label %vector.body992, !llvm.loop !76
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %136 = mul nuw nsw i64 %polly.indvar357, 80
  %137 = add nsw i64 %smin816, 999
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %138 = lshr i64 %polly.indvar363, 2
  %139 = add nuw i64 %polly.indvar363, %138
  %140 = shl nuw nsw i64 %139, 6
  %141 = sub i64 %indvars.iv801, %140
  %142 = add i64 %indvars.iv806, %140
  %143 = mul nuw nsw i64 %polly.indvar363, 80
  %144 = mul nsw i64 %polly.indvar363, -80
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit375
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %indvars.iv.next802 = add nuw nsw i64 %indvars.iv801, 80
  %indvars.iv.next807 = add nsw i64 %indvars.iv806, -80
  %exitcond818.not = icmp eq i64 %polly.indvar_next364, 15
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv808 = phi i64 [ %indvars.iv.next809, %polly.loop_exit375 ], [ %142, %polly.loop_header360 ]
  %indvars.iv803 = phi i64 [ %indvars.iv.next804, %polly.loop_exit375 ], [ %141, %polly.loop_header360 ]
  %polly.indvar370 = phi i64 [ %polly.indvar_next371, %polly.loop_exit375 ], [ %139, %polly.loop_header360 ]
...
polly.loop_exit382:                               ; preds = %polly.loop_exit390
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar376, %137
  br i1 %exitcond817.not, label %polly.loop_exit375, label %polly.loop_header373
...
polly.loop_header380:                             ; preds = %polly.loop_header373, %polly.loop_exit390
  ...
  %157 = add i64 %156, %144
  %polly.loop_guard391878 = icmp sgt i64 %157, -1
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %wide.load977 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %173, label %middle.block966, label %vector.body968, !llvm.loop !85
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %175 = mul nuw nsw i64 %polly.indvar515, 80
  %176 = add nsw i64 %smin837, 999
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %177 = lshr i64 %polly.indvar521, 2
  %178 = add nuw i64 %polly.indvar521, %177
  %179 = shl nuw nsw i64 %178, 6
  %180 = sub i64 %indvars.iv822, %179
  %181 = add i64 %indvars.iv827, %179
  %182 = mul nuw nsw i64 %polly.indvar521, 80
  %183 = mul nsw i64 %polly.indvar521, -80
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %exitcond839.not = icmp eq i64 %polly.indvar_next522, 15
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv829 = phi i64 [ %indvars.iv.next830, %polly.loop_exit533 ], [ %181, %polly.loop_header518 ]
  %indvars.iv824 = phi i64 [ %indvars.iv.next825, %polly.loop_exit533 ], [ %180, %polly.loop_header518 ]
  ...
  %184 = add i64 %smax826, %indvars.iv829
...
polly.loop_exit533:                               ; preds = %polly.loop_exit540, %polly.loop_header525
  ...
  %indvars.iv.next825 = add i64 %indvars.iv824, -64
  %indvars.iv.next830 = add i64 %indvars.iv829, 64
...
polly.loop_exit540:                               ; preds = %polly.loop_exit548
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar534, %176
...
polly.loop_header538:                             ; preds = %polly.loop_header531, %polly.loop_exit548
  %indvars.iv831 = phi i64 [ %184, %polly.loop_header531 ], [ %indvars.iv.next832, %polly.loop_exit548 ]
  ...
  %196 = add i64 %195, %183
  %polly.loop_guard549879 = icmp sgt i64 %196, -1
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  br i1 %226, label %polly.loop_exit714, label %vector.body906, !llvm.loop !94
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  br i1 %255, label %polly.loop_exit741, label %vector.body921, !llvm.loop !97
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  br i1 %284, label %polly.loop_exit767, label %vector.body939, !llvm.loop !100
