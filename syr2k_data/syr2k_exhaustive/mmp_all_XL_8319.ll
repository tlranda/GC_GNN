; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8319.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8319.c"
...
polly.loop_exit225.loopexit.us:                   ; preds = %polly.loop_exit232.us
  ...
  %exitcond795.not = icmp eq i64 %polly.indvar_next221.us, 100
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph993
  ...
  %wide.load1000 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %131, label %middle.block987, label %vector.body989, !llvm.loop !77
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %134 = lshr i64 %polly.indvar363, 3
  ...
  %142 = mul nsw i64 %polly.indvar363, -50
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %144 = shl nsw i64 %polly.indvar370, 4
  %145 = sub nsw i64 %141, %144
  %146 = icmp sgt i64 %145, 0
  %147 = select i1 %146, i64 %145, i64 0
  %polly.loop_guard383 = icmp slt i64 %147, 16
...
polly.loop_exit382.loopexit.us:                   ; preds = %polly.loop_exit390.us
  ...
  %exitcond815.not = icmp eq i64 %polly.indvar_next377.us, 100
...
vector.body965:                                   ; preds = %vector.body965, %vector.ph967
  ...
  %wide.load974 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !81, !noalias !83
  ...
  br i1 %167, label %middle.block963, label %vector.body965, !llvm.loop !86
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %170 = lshr i64 %polly.indvar521, 3
  ...
  %178 = mul nsw i64 %polly.indvar521, -50
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  ...
  %180 = shl nsw i64 %polly.indvar528, 4
  %181 = sub nsw i64 %177, %180
  %182 = icmp sgt i64 %181, 0
  %183 = select i1 %182, i64 %181, i64 0
  %polly.loop_guard541 = icmp slt i64 %183, 16
...
polly.loop_exit540.loopexit.us:                   ; preds = %polly.loop_exit548.us
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next535.us, 100
...
vector.body903:                                   ; preds = %vector.body903, %vector.ph905
  ...
  br i1 %217, label %polly.loop_exit714, label %vector.body903, !llvm.loop !95
...
vector.body918:                                   ; preds = %vector.body918, %vector.ph921
  ...
  br i1 %246, label %polly.loop_exit741, label %vector.body918, !llvm.loop !98
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph939
  ...
  br i1 %275, label %polly.loop_exit767, label %vector.body936, !llvm.loop !101
