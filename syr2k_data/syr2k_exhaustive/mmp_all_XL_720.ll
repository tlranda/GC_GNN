; ModuleID = 'syr2k_exhaustive/mmp_all_XL_720.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_720.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit259
  ...
  %exitcond944.not = icmp eq i64 %polly.indvar_next204, 24
...
polly.loop_header222.preheader:                   ; preds = %polly.loop_exit214
  %98 = mul nsw i64 %polly.indvar203, -50
...
polly.loop_header222:                             ; preds = %polly.loop_header222.preheader, %polly.loop_exit259
  ...
  %100 = mul nuw nsw i64 %indvar1216, 50
  %101 = mul nuw nsw i64 %polly.indvar225, 50
  %102 = add nsw i64 %101, %98
  %103 = icmp ugt i64 %102, 50
  %104 = select i1 %103, i64 %102, i64 50
...
polly.loop_header234.us:                          ; preds = %polly.loop_header234.us, %polly.loop_header228.us
  ...
  %exitcond934.not = icmp eq i64 %polly.indvar_next238.us, 50
...
polly.loop_exit259:                               ; preds = %polly.loop_exit265
  ...
  %indvars.iv.next937 = add nuw nsw i64 %indvars.iv936, 50
  %exitcond943.not = icmp eq i64 %polly.indvar_next226, 24
...
polly.loop_header234:                             ; preds = %polly.loop_header234, %polly.loop_header228
  ...
  %exitcond932.not = icmp eq i64 %polly.indvar_next238, 50
...
polly.loop_header263:                             ; preds = %polly.loop_exit271, %polly.loop_header257
  ...
  %smin1218 = call i64 @llvm.smin.i64(i64 %109, i64 49)
  %110 = add nuw nsw i64 %smin1218, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv938, i64 49)
...
polly.loop_exit271:                               ; preds = %polly.loop_header269, %middle.block1213
  ...
  %exitcond941.not = icmp eq i64 %polly.indvar_next267, 50
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit424
  ...
  %143 = mul nuw nsw i64 %polly.indvar403, 50
  br label %polly.loop_header406

polly.loop_exit424:                               ; preds = %polly.loop_exit461
  %polly.indvar_next404 = add nuw nsw i64 %polly.indvar403, 1
  %indvars.iv.next948 = add nsw i64 %indvars.iv947, -50
  %exitcond964.not = icmp eq i64 %polly.indvar_next404, 24
...
polly.loop_header422.preheader:                   ; preds = %polly.loop_exit414
  %144 = mul nsw i64 %polly.indvar403, -50
...
polly.loop_header422:                             ; preds = %polly.loop_header422.preheader, %polly.loop_exit461
  ...
  %146 = mul nuw nsw i64 %indvar1169, 50
  %147 = mul nuw nsw i64 %polly.indvar425, 50
  %148 = add nsw i64 %147, %144
  %149 = icmp ugt i64 %148, 50
  %150 = select i1 %149, i64 %148, i64 50
  %151 = add nuw nsw i64 %148, 49
...
polly.loop_header434.us:                          ; preds = %polly.loop_header434.us, %polly.loop_header428.us
  ...
  %exitcond953.not = icmp eq i64 %polly.indvar_next438.us, 50
...
polly.loop_exit461:                               ; preds = %polly.loop_exit467
  ...
  %indvars.iv.next956 = add nuw nsw i64 %indvars.iv955, 50
  %exitcond963.not = icmp eq i64 %polly.indvar_next426, 24
...
polly.loop_header434:                             ; preds = %polly.loop_header434, %polly.loop_header428
  ...
  %exitcond951.not = icmp eq i64 %polly.indvar_next438, 50
...
polly.loop_header465:                             ; preds = %polly.loop_exit473, %polly.loop_header459
  ...
  %smin1171 = call i64 @llvm.smin.i64(i64 %155, i64 49)
  %156 = add nuw nsw i64 %smin1171, 1
  %smin959 = call i64 @llvm.smin.i64(i64 %indvars.iv957, i64 49)
...
polly.loop_exit473:                               ; preds = %polly.loop_header471, %middle.block1166
  ...
  %exitcond961.not = icmp eq i64 %polly.indvar_next469, 50
...
polly.loop_header602:                             ; preds = %polly.loop_header602.preheader, %polly.loop_exit626
  ...
  %189 = mul nuw nsw i64 %polly.indvar605, 50
...
polly.loop_exit626:                               ; preds = %polly.loop_exit663
  ...
  %exitcond984.not = icmp eq i64 %polly.indvar_next606, 24
...
polly.loop_header624.preheader:                   ; preds = %polly.loop_exit616
  %190 = mul nsw i64 %polly.indvar605, -50
...
polly.loop_header624:                             ; preds = %polly.loop_header624.preheader, %polly.loop_exit663
  ...
  %192 = mul nuw nsw i64 %indvar1122, 50
  %193 = mul nuw nsw i64 %polly.indvar627, 50
  %194 = add nsw i64 %193, %190
  %195 = icmp ugt i64 %194, 50
  %196 = select i1 %195, i64 %194, i64 50
  %197 = add nuw nsw i64 %194, 49
...
polly.loop_header636.us:                          ; preds = %polly.loop_header636.us, %polly.loop_header630.us
  ...
  %exitcond973.not = icmp eq i64 %polly.indvar_next640.us, 50
...
polly.loop_exit663:                               ; preds = %polly.loop_exit669
  ...
  %indvars.iv.next976 = add nuw nsw i64 %indvars.iv975, 50
  %exitcond983.not = icmp eq i64 %polly.indvar_next628, 24
...
polly.loop_header636:                             ; preds = %polly.loop_header636, %polly.loop_header630
  ...
  %exitcond971.not = icmp eq i64 %polly.indvar_next640, 50
...
polly.loop_header667:                             ; preds = %polly.loop_exit675, %polly.loop_header661
  ...
  %smin1124 = call i64 @llvm.smin.i64(i64 %201, i64 49)
  %202 = add nuw nsw i64 %smin1124, 1
  %smin979 = call i64 @llvm.smin.i64(i64 %indvars.iv977, i64 49)
...
polly.loop_exit675:                               ; preds = %polly.loop_header673, %middle.block1119
  ...
  %exitcond981.not = icmp eq i64 %polly.indvar_next671, 50
