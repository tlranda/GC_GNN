; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9955.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9955.c"
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %127, label %middle.block990, label %vector.body992, !llvm.loop !74
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %133 = mul nuw nsw i64 %polly.indvar363, 20
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %wide.load977 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %159, label %middle.block966, label %vector.body968, !llvm.loop !83
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %165 = mul nuw nsw i64 %polly.indvar521, 20
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  br i1 %205, label %polly.loop_exit714, label %vector.body906, !llvm.loop !92
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  br i1 %234, label %polly.loop_exit741, label %vector.body921, !llvm.loop !95
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  br i1 %263, label %polly.loop_exit767, label %vector.body939, !llvm.loop !98
