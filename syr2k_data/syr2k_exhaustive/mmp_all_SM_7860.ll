; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7860.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7860.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit230, %polly.loop_header215
  ...
  %indvars.iv.next834 = add nuw nsw i64 %indvars.iv833, 100
  %exitcond840.not = icmp eq i64 %polly.indvar_next219, 12
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit230
  ...
  %polly.loop_guard231 = icmp slt i64 %106, 100
...
polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header221
  ...
  %polly.loop_cond226.not = icmp sgt i64 %polly.indvar224, %100
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %polly.loop_guard245914 = icmp sgt i64 %109, -1
...
polly.loop_exit237:                               ; preds = %polly.loop_exit244.loopexit.us, %polly.loop_header228
  ...
  %polly.loop_cond234 = icmp ult i64 %polly.indvar232, 99
...
vector.body1023:                                  ; preds = %vector.body1023, %vector.ph1027
  ...
  %120 = shl nuw nsw i64 %index1030, 3
  %121 = getelementptr i8, i8* %scevgep368, i64 %120
  %122 = bitcast i8* %121 to <4 x double>*
  %wide.load1034 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !74, !noalias !76
  %123 = fmul fast <4 x double> %wide.load1034, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %125 = icmp eq i64 %index.next1031, %n.vec1029
  br i1 %125, label %middle.block1021, label %vector.body1023, !llvm.loop !80

middle.block1021:                                 ; preds = %vector.body1023
  %cmp.n1033 = icmp eq i64 %118, %n.vec1029
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit398
  ...
  %127 = shl nuw nsw i64 %polly.indvar391, 1
  %128 = mul nuw nsw i64 %polly.indvar391, 7
  %129 = add nuw nsw i64 %128, 7
  %pexp.p_div_q394 = lshr i64 %129, 4
  %130 = sub nsw i64 %127, %pexp.p_div_q394
  %polly.loop_guard399 = icmp sgt i64 %130, -2
...
polly.loop_header396.preheader:                   ; preds = %polly.loop_header388
  %131 = mul nsw i64 %polly.indvar391, -100
  %132 = mul nuw nsw i64 %polly.indvar391, 100
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit406, %polly.loop_header388
  %polly.indvar_next392 = add nuw nsw i64 %polly.indvar391, 1
  %indvars.iv.next846 = add nsw i64 %indvars.iv845, -100
  %indvars.iv.next851 = add nuw nsw i64 %indvars.iv850, 100
  %exitcond859.not = icmp eq i64 %polly.indvar_next392, 12
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_exit406
  ...
  %133 = shl nsw i64 %polly.indvar400, 6
  %134 = add nsw i64 %133, %131
  %135 = icmp sgt i64 %134, 0
  %136 = select i1 %135, i64 %134, i64 0
  %polly.loop_guard407 = icmp slt i64 %136, 100
...
polly.loop_header404.preheader:                   ; preds = %polly.loop_header396
  ...
  %137 = add i64 %smax849, %indvars.iv852
...
polly.loop_exit406:                               ; preds = %polly.loop_exit413, %polly.loop_header396
  ...
  %polly.loop_cond402.not = icmp sgt i64 %polly.indvar400, %130
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit413
  %indvars.iv854 = phi i64 [ %137, %polly.loop_header404.preheader ], [ %indvars.iv.next855, %polly.loop_exit413 ]
  ...
  %polly.loop_guard421915 = icmp sgt i64 %139, -1
...
polly.loop_exit413:                               ; preds = %polly.loop_exit420.loopexit.us, %polly.loop_header404
  ...
  %polly.loop_cond410 = icmp ult i64 %polly.indvar408, 99
...
polly.loop_header532:                             ; preds = %polly.loop_exit540, %polly.start446
  ...
  %min.iters.check1000 = icmp ult i64 %148, 4
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1001
  ...
  %150 = shl nuw nsw i64 %index1004, 3
  %151 = getelementptr i8, i8* %scevgep544, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load1008 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !84, !noalias !86
  %153 = fmul fast <4 x double> %wide.load1008, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next1005, %n.vec1003
  br i1 %155, label %middle.block997, label %vector.body999, !llvm.loop !90

middle.block997:                                  ; preds = %vector.body999
  %cmp.n1007 = icmp eq i64 %148, %n.vec1003
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit574
  ...
  %157 = shl nuw nsw i64 %polly.indvar567, 1
  %158 = mul nuw nsw i64 %polly.indvar567, 7
  %159 = add nuw nsw i64 %158, 7
  %pexp.p_div_q570 = lshr i64 %159, 4
  %160 = sub nsw i64 %157, %pexp.p_div_q570
  %polly.loop_guard575 = icmp sgt i64 %160, -2
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header564
  %161 = mul nsw i64 %polly.indvar567, -100
  %162 = mul nuw nsw i64 %polly.indvar567, 100
...
polly.loop_exit574:                               ; preds = %polly.loop_exit582, %polly.loop_header564
  ...
  %indvars.iv.next870 = add nuw nsw i64 %indvars.iv869, 100
  %exitcond878.not = icmp eq i64 %polly.indvar_next568, 12
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit582
  ...
  %163 = shl nsw i64 %polly.indvar576, 6
  %164 = add nsw i64 %163, %161
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard583 = icmp slt i64 %166, 100
...
polly.loop_header580.preheader:                   ; preds = %polly.loop_header572
  ...
  %167 = add i64 %smax868, %indvars.iv871
...
polly.loop_exit582:                               ; preds = %polly.loop_exit589, %polly.loop_header572
  ...
  %polly.loop_cond578.not = icmp sgt i64 %polly.indvar576, %160
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit589
  %indvars.iv873 = phi i64 [ %167, %polly.loop_header580.preheader ], [ %indvars.iv.next874, %polly.loop_exit589 ]
  ...
  %polly.loop_guard597916 = icmp sgt i64 %169, -1
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header580
  ...
  %polly.loop_cond586 = icmp ult i64 %polly.indvar584, 99
...
polly.loop_header752:                             ; preds = %polly.loop_exit760, %polly.loop_header746
  ...
  %smin938 = call i64 @llvm.smin.i64(i64 %180, i64 -1168)
  %181 = add nsw i64 %smin938, 1200
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 -1168)
  %182 = shl nsw i64 %polly.indvar755, 5
  %183 = add nsw i64 %smin905, 1199
...
vector.ph939:                                     ; preds = %polly.loop_header758
  %broadcast.splatinsert946 = insertelement <4 x i64> poison, i64 %182, i32 0
  %broadcast.splat947 = shufflevector <4 x i64> %broadcast.splatinsert946, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert948 = insertelement <4 x i32> poison, i32 %185, i32 0
...
vector.body937:                                   ; preds = %vector.body937, %vector.ph939
  ...
  %187 = add nuw nsw <4 x i64> %vec.ind944, %broadcast.splat947
  %188 = trunc <4 x i64> %187 to <4 x i32>
  %189 = mul <4 x i32> %broadcast.splat949, %188
  ...
  %199 = icmp eq i64 %index.next941, %181
  br i1 %199, label %polly.loop_exit766, label %vector.body937, !llvm.loop !99

polly.loop_exit766:                               ; preds = %vector.body937, %polly.loop_header764
  %polly.indvar_next762 = add nuw nsw i64 %polly.indvar761, 1
  %exitcond910.not = icmp eq i64 %polly.indvar761, %179
...
polly.loop_header764:                             ; preds = %polly.loop_header758, %polly.loop_header764
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar767, %183
...
polly.loop_header779:                             ; preds = %polly.loop_exit787, %polly.loop_header773
  ...
  %smin953 = call i64 @llvm.smin.i64(i64 %209, i64 -968)
  %210 = add nsw i64 %smin953, 1000
  %smin895 = call i64 @llvm.smin.i64(i64 %indvars.iv893, i64 -968)
  %211 = shl nsw i64 %polly.indvar782, 5
  %212 = add nsw i64 %smin895, 999
...
vector.body952:                                   ; preds = %vector.body952, %vector.ph955
  ...
  %216 = add nuw nsw <4 x i64> %vec.ind962, %broadcast.splat965
  %217 = trunc <4 x i64> %216 to <4 x i32>
  %218 = mul <4 x i32> %broadcast.splat967, %217
  ...
  %228 = icmp eq i64 %index.next959, %210
  br i1 %228, label %polly.loop_exit793, label %vector.body952, !llvm.loop !102

polly.loop_exit793:                               ; preds = %vector.body952, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond900.not = icmp eq i64 %polly.indvar788, %208
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %exitcond896.not = icmp eq i64 %polly.indvar794, %212
...
polly.loop_header805:                             ; preds = %polly.loop_exit813, %polly.loop_header799
  ...
  %smin971 = call i64 @llvm.smin.i64(i64 %238, i64 -968)
  %239 = add nsw i64 %smin971, 1000
  %smin885 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 -968)
  %240 = shl nsw i64 %polly.indvar808, 5
  %241 = add nsw i64 %smin885, 999
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  %245 = add nuw nsw <4 x i64> %vec.ind980, %broadcast.splat983
  %246 = trunc <4 x i64> %245 to <4 x i32>
  %247 = mul <4 x i32> %broadcast.splat985, %246
  ...
  %257 = icmp eq i64 %index.next977, %239
  br i1 %257, label %polly.loop_exit819, label %vector.body970, !llvm.loop !105

polly.loop_exit819:                               ; preds = %vector.body970, %polly.loop_header817
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %exitcond890.not = icmp eq i64 %polly.indvar814, %237
...
polly.loop_header817:                             ; preds = %polly.loop_header811, %polly.loop_header817
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar820, %241
