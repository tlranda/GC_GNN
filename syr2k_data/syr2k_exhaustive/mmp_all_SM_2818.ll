; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2818.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2818.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %.inv = icmp ugt i64 %102, 15
  %104 = select i1 %.inv, i64 15, i64 %103
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %166 = shl nuw nsw i64 %polly.indvar396, 1
  %167 = mul nsw i64 %polly.indvar396, -16
  %168 = shl nsw i64 %polly.indvar396, 4
...
polly.loop_header399:                             ; preds = %polly.loop_exit440, %polly.loop_header393
  ...
  %.inv869 = icmp ugt i64 %170, 15
  %172 = select i1 %.inv869, i64 15, i64 %171
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %234 = shl nuw nsw i64 %polly.indvar586, 1
  %235 = mul nsw i64 %polly.indvar586, -16
  %236 = shl nsw i64 %polly.indvar586, 4
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %238, 15
  %240 = select i1 %.inv870, i64 15, i64 %239
