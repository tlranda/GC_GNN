; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7169.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7169.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %105 = mul nuw nsw i64 %polly.indvar230, 100
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv875 = phi i64 [ %indvars.iv.next876, %polly.loop_exit398 ], [ 7, %polly.loop_exit382 ]
  ...
  %132 = udiv i64 %indvars.iv875, 25
  %umin877 = call i64 @llvm.umin.i64(i64 %132, i64 11)
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %140 = mul nuw nsw i64 %polly.indvar406, 100
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %indvars.iv.next866 = add nsw i64 %indvars.iv865, -100
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  ...
  %smin869 = call i64 @llvm.smin.i64(i64 %indvars.iv867, i64 99)
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv902 = phi i64 [ %indvars.iv.next903, %polly.loop_exit576 ], [ 7, %polly.loop_exit560 ]
  ...
  %167 = udiv i64 %indvars.iv902, 25
  %umin904 = call i64 @llvm.umin.i64(i64 %167, i64 11)
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next903 = add nuw nsw i64 %indvars.iv902, 8
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %175 = mul nuw nsw i64 %polly.indvar584, 100
