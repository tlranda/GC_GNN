; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7628.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7628.c"
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249941 = icmp sgt i64 %119, -1
...
vector.body1050:                                  ; preds = %vector.body1050, %vector.ph1054
  ...
  %132 = shl nuw nsw i64 %index1057, 3
  %133 = getelementptr i8, i8* %scevgep370, i64 %132
  %134 = bitcast i8* %133 to <4 x double>*
  %wide.load1061 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !74, !noalias !76
  %135 = fmul fast <4 x double> %wide.load1061, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %137 = icmp eq i64 %index.next1058, %n.vec1056
  br i1 %137, label %middle.block1048, label %vector.body1050, !llvm.loop !80

middle.block1048:                                 ; preds = %vector.body1050
  %cmp.n1060 = icmp eq i64 %130, %n.vec1056
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %139 = udiv i64 %indvars.iv874, 25
  %140 = sub nsw i64 %indvars.iv872, %139
  %smin876 = call i64 @llvm.smin.i64(i64 %140, i64 21)
  %141 = mul nsw i64 %polly.indvar393, -96
  %142 = icmp slt i64 %141, -1104
  %143 = select i1 %142, i64 %141, i64 -1104
  %144 = add nsw i64 %143, 1199
  %145 = mul nuw nsw i64 %polly.indvar393, 96
  %146 = add nsw i64 %smin876, 2
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar_next400, 250
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %159 = add i64 %smax862, %indvars.iv865
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar406, %146
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv867 = phi i64 [ %159, %polly.loop_header410.preheader ], [ %indvars.iv.next868, %polly.loop_exit419 ]
  ...
  %polly.loop_guard427942 = icmp sgt i64 %161, -1
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1027 = icmp ult i64 %172, 4
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1028
  ...
  %174 = shl nuw nsw i64 %index1031, 3
  %175 = getelementptr i8, i8* %scevgep548, i64 %174
  %176 = bitcast i8* %175 to <4 x double>*
  %wide.load1035 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !84, !noalias !86
  %177 = fmul fast <4 x double> %wide.load1035, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %179 = icmp eq i64 %index.next1032, %n.vec1030
  br i1 %179, label %middle.block1024, label %vector.body1026, !llvm.loop !90

middle.block1024:                                 ; preds = %vector.body1026
  %cmp.n1034 = icmp eq i64 %172, %n.vec1030
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %181 = udiv i64 %indvars.iv900, 25
  %182 = sub nsw i64 %indvars.iv898, %181
  %smin902 = call i64 @llvm.smin.i64(i64 %182, i64 21)
  %183 = mul nsw i64 %polly.indvar571, -96
  %184 = icmp slt i64 %183, -1104
  %185 = select i1 %184, i64 %183, i64 -1104
  %186 = add nsw i64 %185, 1199
  %187 = mul nuw nsw i64 %polly.indvar571, 96
  %188 = add nsw i64 %smin902, 2
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar_next578, 250
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  ...
  %201 = add i64 %smax888, %indvars.iv891
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar584, %188
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv893 = phi i64 [ %201, %polly.loop_header588.preheader ], [ %indvars.iv.next894, %polly.loop_exit597 ]
  ...
  %polly.loop_guard605943 = icmp sgt i64 %203, -1
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin965 = call i64 @llvm.smin.i64(i64 %216, i64 -1168)
  %217 = add nsw i64 %smin965, 1200
  %smin932 = call i64 @llvm.smin.i64(i64 %indvars.iv930, i64 -1168)
  %218 = shl nsw i64 %polly.indvar761, 5
  %219 = add nsw i64 %smin932, 1199
...
vector.ph966:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert973 = insertelement <4 x i64> poison, i64 %218, i32 0
  %broadcast.splat974 = shufflevector <4 x i64> %broadcast.splatinsert973, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert975 = insertelement <4 x i32> poison, i32 %221, i32 0
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph966
  ...
  %223 = add nuw nsw <4 x i64> %vec.ind971, %broadcast.splat974
  %224 = trunc <4 x i64> %223 to <4 x i32>
  %225 = mul <4 x i32> %broadcast.splat976, %224
  ...
  %235 = icmp eq i64 %index.next968, %217
  br i1 %235, label %polly.loop_exit772, label %vector.body964, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body964, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond937.not = icmp eq i64 %polly.indvar767, %215
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond933.not = icmp eq i64 %polly.indvar773, %219
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin980 = call i64 @llvm.smin.i64(i64 %245, i64 -968)
  %246 = add nsw i64 %smin980, 1000
  %smin922 = call i64 @llvm.smin.i64(i64 %indvars.iv920, i64 -968)
  %247 = shl nsw i64 %polly.indvar788, 5
  %248 = add nsw i64 %smin922, 999
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph982
  ...
  %252 = add nuw nsw <4 x i64> %vec.ind989, %broadcast.splat992
  %253 = trunc <4 x i64> %252 to <4 x i32>
  %254 = mul <4 x i32> %broadcast.splat994, %253
  ...
  %264 = icmp eq i64 %index.next986, %246
  br i1 %264, label %polly.loop_exit799, label %vector.body979, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body979, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond927.not = icmp eq i64 %polly.indvar794, %244
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond923.not = icmp eq i64 %polly.indvar800, %248
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin998 = call i64 @llvm.smin.i64(i64 %274, i64 -968)
  %275 = add nsw i64 %smin998, 1000
  %smin912 = call i64 @llvm.smin.i64(i64 %indvars.iv910, i64 -968)
  %276 = shl nsw i64 %polly.indvar814, 5
  %277 = add nsw i64 %smin912, 999
...
vector.body997:                                   ; preds = %vector.body997, %vector.ph1000
  ...
  %281 = add nuw nsw <4 x i64> %vec.ind1007, %broadcast.splat1010
  %282 = trunc <4 x i64> %281 to <4 x i32>
  %283 = mul <4 x i32> %broadcast.splat1012, %282
  ...
  %293 = icmp eq i64 %index.next1004, %275
  br i1 %293, label %polly.loop_exit825, label %vector.body997, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body997, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond917.not = icmp eq i64 %polly.indvar820, %273
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond913.not = icmp eq i64 %polly.indvar826, %277
...
polly.loop_header424.us.3:                        ; preds = %polly.loop_header424.us.3, %polly.loop_exit426.loopexit.us.2
  ...
  br i1 %exitcond870.3.not, label %polly.loop_exit419, label %polly.loop_header424.us.3
...
polly.loop_header602.us.3:                        ; preds = %polly.loop_header602.us.3, %polly.loop_exit604.loopexit.us.2
  ...
  br i1 %exitcond896.3.not, label %polly.loop_exit597, label %polly.loop_header602.us.3
}
