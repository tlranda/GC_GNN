; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7529.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7529.c"
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %polly.loop_guard237 = icmp slt i64 %107, 80
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  ...
  %polly.loop_guard251938 = icmp sgt i64 %110, -1
...
polly.loop_header241.us:                          ; preds = %polly.loop_header234, %polly.loop_exit250.loopexit.us
  ...
  %114 = add nuw nsw i64 %polly.indvar244.us, %102
  %115 = shl i64 %114, 3
...
polly.loop_exit250.loopexit.us:                   ; preds = %polly.loop_header248.us
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar244.us, %103
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1051
  ...
  %124 = shl nuw nsw i64 %index1054, 3
  %125 = getelementptr i8, i8* %scevgep372, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1058 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  %127 = fmul fast <4 x double> %wide.load1058, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1055, %n.vec1053
  br i1 %129, label %middle.block1045, label %vector.body1047, !llvm.loop !80

middle.block1045:                                 ; preds = %vector.body1047
  %cmp.n1057 = icmp eq i64 %122, %n.vec1053
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %pexp.p_div_q404 = udiv i64 %132, 5
  %133 = sub nsw i64 %131, %pexp.p_div_q404
  %polly.loop_guard409 = icmp sgt i64 %133, -2
  %134 = mul nsw i64 %polly.indvar395, -80
  %135 = mul nuw nsw i64 %polly.indvar395, 80
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  ...
  %136 = shl nsw i64 %polly.indvar401, 4
  %137 = add nsw i64 %smin876, 999
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %138 = mul nuw nsw i64 %polly.indvar410, 50
  %139 = add nsw i64 %138, %134
  %140 = icmp sgt i64 %139, 0
  %141 = select i1 %140, i64 %139, i64 0
  %polly.loop_guard417 = icmp slt i64 %141, 80
...
polly.loop_header414.preheader:                   ; preds = %polly.loop_header406
  ...
  %142 = add i64 %smax865, %indvars.iv868
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %polly.loop_cond412.not = icmp sgt i64 %polly.indvar410, %133
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  %indvars.iv870 = phi i64 [ %142, %polly.loop_header414.preheader ], [ %indvars.iv.next871, %polly.loop_exit423 ]
  ...
  %polly.loop_guard431939 = icmp sgt i64 %144, -1
  %145 = add nuw nsw i64 %polly.indvar418, %135
...
polly.loop_header421.us:                          ; preds = %polly.loop_header414, %polly.loop_exit430.loopexit.us
  ...
  %148 = add nuw nsw i64 %polly.indvar424.us, %136
  %149 = shl i64 %148, 3
...
polly.loop_exit430.loopexit.us:                   ; preds = %polly.loop_header428.us
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar424.us, %137
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %min.iters.check1024 = icmp ult i64 %156, 4
...
vector.body1023:                                  ; preds = %vector.body1023, %vector.ph1025
  ...
  %158 = shl nuw nsw i64 %index1028, 3
  %159 = getelementptr i8, i8* %scevgep552, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load1032 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  %161 = fmul fast <4 x double> %wide.load1032, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next1029, %n.vec1027
  br i1 %163, label %middle.block1021, label %vector.body1023, !llvm.loop !90

middle.block1021:                                 ; preds = %vector.body1023
  %cmp.n1031 = icmp eq i64 %156, %n.vec1027
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %pexp.p_div_q584 = udiv i64 %166, 5
  %167 = sub nsw i64 %165, %pexp.p_div_q584
  %polly.loop_guard589 = icmp sgt i64 %167, -2
  %168 = mul nsw i64 %polly.indvar575, -80
  %169 = mul nuw nsw i64 %polly.indvar575, 80
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  ...
  %170 = shl nsw i64 %polly.indvar581, 4
  %171 = add nsw i64 %smin899, 999
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %172 = mul nuw nsw i64 %polly.indvar590, 50
  %173 = add nsw i64 %172, %168
  %174 = icmp sgt i64 %173, 0
  %175 = select i1 %174, i64 %173, i64 0
  %polly.loop_guard597 = icmp slt i64 %175, 80
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit603
  %indvars.iv893 = phi i64 [ %176, %polly.loop_header594.preheader ], [ %indvars.iv.next894, %polly.loop_exit603 ]
  ...
  %polly.loop_guard611940 = icmp sgt i64 %178, -1
...
polly.loop_header601.us:                          ; preds = %polly.loop_header594, %polly.loop_exit610.loopexit.us
  ...
  %182 = add nuw nsw i64 %polly.indvar604.us, %170
  %183 = shl i64 %182, 3
...
polly.loop_exit610.loopexit.us:                   ; preds = %polly.loop_header608.us
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar604.us, %171
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %smin962 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin962, 1200
  %smin929 = call i64 @llvm.smin.i64(i64 %indvars.iv927, i64 -1168)
  %194 = shl nsw i64 %polly.indvar767, 5
  %195 = add nsw i64 %smin929, 1199
...
vector.ph963:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert970 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat971 = shufflevector <4 x i64> %broadcast.splatinsert970, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert972 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body961:                                   ; preds = %vector.body961, %vector.ph963
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind968, %broadcast.splat971
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat973, %200
  ...
  %211 = icmp eq i64 %index.next965, %193
  br i1 %211, label %polly.loop_exit778, label %vector.body961, !llvm.loop !99

polly.loop_exit778:                               ; preds = %vector.body961, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond934.not = icmp eq i64 %polly.indvar773, %191
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %exitcond930.not = icmp eq i64 %polly.indvar779, %195
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %smin977 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin977, 1000
  %smin919 = call i64 @llvm.smin.i64(i64 %indvars.iv917, i64 -968)
  %223 = shl nsw i64 %polly.indvar794, 5
  %224 = add nsw i64 %smin919, 999
...
vector.body976:                                   ; preds = %vector.body976, %vector.ph979
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind986, %broadcast.splat989
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat991, %229
  ...
  %240 = icmp eq i64 %index.next983, %222
  br i1 %240, label %polly.loop_exit805, label %vector.body976, !llvm.loop !102

polly.loop_exit805:                               ; preds = %vector.body976, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond924.not = icmp eq i64 %polly.indvar800, %220
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond920.not = icmp eq i64 %polly.indvar806, %224
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %smin995 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin995, 1000
  %smin909 = call i64 @llvm.smin.i64(i64 %indvars.iv907, i64 -968)
  %252 = shl nsw i64 %polly.indvar820, 5
  %253 = add nsw i64 %smin909, 999
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph997
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind1004, %broadcast.splat1007
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat1009, %258
  ...
  %269 = icmp eq i64 %index.next1001, %251
  br i1 %269, label %polly.loop_exit831, label %vector.body994, !llvm.loop !105

polly.loop_exit831:                               ; preds = %vector.body994, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond914.not = icmp eq i64 %polly.indvar826, %249
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %exitcond910.not = icmp eq i64 %polly.indvar832, %253
