; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7242.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7242.c"
...
polly.loop_exit402:                               ; preds = %polly.loop_exit408
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar_next398, 8
...
polly.loop_header569:                             ; preds = %polly.loop_exit577, %polly.loop_header563
  ...
  %smin885 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 -872)
  %153 = shl nsw i64 %polly.indvar572, 7
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %exitcond894.not = icmp eq i64 %polly.indvar_next573, 8
