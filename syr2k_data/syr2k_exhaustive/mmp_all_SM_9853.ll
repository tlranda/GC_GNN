; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9853.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9853.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %132 = udiv i64 %indvars.iv821, 25
  %umin823 = call i64 @llvm.umin.i64(i64 %132, i64 11)
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv846 = phi i64 [ %indvars.iv.next847, %polly.loop_exit520 ], [ 7, %polly.loop_exit504 ]
  ...
  %167 = udiv i64 %indvars.iv846, 25
  %umin848 = call i64 @llvm.umin.i64(i64 %167, i64 11)
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %175 = mul nuw nsw i64 %polly.indvar528, 100
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %indvars.iv.next837 = add nsw i64 %indvars.iv836, -100
