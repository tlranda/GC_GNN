; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6222.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6222.c"
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1037
  ...
  %wide.load1044 = load <4 x double>, <4 x double>* %120, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %123, label %middle.block1031, label %vector.body1033, !llvm.loop !84
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %126 = shl nsw i64 %polly.indvar375, 5
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %wide.load1018 = load <4 x double>, <4 x double>* %148, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %151, label %middle.block1007, label %vector.body1009, !llvm.loop !94
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %154 = shl nsw i64 %polly.indvar548, 5
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph949
  ...
  br i1 %193, label %polly.loop_exit760, label %vector.body948, !llvm.loop !103
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph965
  ...
  br i1 %222, label %polly.loop_exit787, label %vector.body962, !llvm.loop !106
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph983
  ...
  br i1 %251, label %polly.loop_exit813, label %vector.body980, !llvm.loop !109
