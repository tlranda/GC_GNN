; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4444.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4444.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond992.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %polly.loop_guard405 = icmp slt i64 %137, 20
...
polly.loop_exit440:                               ; preds = %polly.loop_exit447.loopexit.us, %polly.loop_header402.split, %polly.loop_header438.preheader
  ...
  %polly.loop_cond408 = icmp ult i64 %polly.indvar406, 19
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %165 = mul nsw i64 %polly.indvar576, -20
  %166 = mul nuw nsw i64 %polly.indvar576, 20
...
polly.loop_exit581:                               ; preds = %polly.loop_exit587
  ...
  %indvars.iv.next1027 = add nuw nsw i64 %indvars.iv1026, 20
  %indvars.iv.next1039 = add nuw nsw i64 %indvars.iv1038, 5
  %exitcond1042.not = icmp eq i64 %polly.indvar_next577, 60
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %polly.loop_guard595 = icmp slt i64 %171, 20
...
polly.loop_exit630:                               ; preds = %polly.loop_exit637.loopexit.us, %polly.loop_header592.split, %polly.loop_header628.preheader
  ...
  %polly.loop_cond598 = icmp ult i64 %polly.indvar596, 19
