; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9147.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9147.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next203, 16
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %107 = mul nsw i64 %polly.indvar208, -64
  br label %polly.loop_header211

polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  %polly.indvar_next209 = add nuw nsw i64 %polly.indvar208, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -36
  %indvars.iv.next795 = add nuw nsw i64 %indvars.iv794, 9
  %indvars.iv.next799 = add nuw nsw i64 %indvars.iv798, 36
  %exitcond808.not = icmp eq i64 %polly.indvar_next209, 19
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %polly.loop_guard227 = icmp slt i64 %112, 100
...
polly.loop_header224.us:                          ; preds = %polly.loop_header217.us, %polly.loop_exit234.us
  ...
  %116 = add i64 %115, %107
  %polly.loop_guard235.us892 = icmp sgt i64 %116, -1
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %polly.loop_guard373 = icmp slt i64 %140, 12
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  %141 = sub nsw i64 %indvars.iv819, %137
  %142 = add i64 %indvars.iv812, %137
...
polly.loop_exit372:                               ; preds = %polly.loop_exit379, %polly.loop_header362
  ...
  %indvars.iv.next813 = add nsw i64 %indvars.iv812, -36
  %indvars.iv.next815 = add nuw nsw i64 %indvars.iv814, 9
  %indvars.iv.next820 = add nuw nsw i64 %indvars.iv819, 36
  %exitcond831.not = icmp eq i64 %polly.indvar_next366, 19
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  %indvars.iv821 = phi i64 [ %141, %polly.loop_header370.preheader ], [ %indvars.iv.next822, %polly.loop_exit379 ]
  %indvars.iv816 = phi i64 [ %142, %polly.loop_header370.preheader ], [ %indvars.iv.next817, %polly.loop_exit379 ]
  ...
  %145 = add i64 %smax818, %indvars.iv821
  %146 = mul nsw i64 %polly.indvar374, 100
  %147 = sub nsw i64 %143, %146
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %polly.loop_guard387 = icmp slt i64 %149, 100
...
polly.loop_header384.us:                          ; preds = %polly.loop_header377.us, %polly.loop_exit394.us
  %indvars.iv823 = phi i64 [ %145, %polly.loop_header377.us ], [ %indvars.iv.next824, %polly.loop_exit394.us ]
  ...
  %153 = add i64 %152, %144
  %polly.loop_guard395.us893 = icmp sgt i64 %153, -1
...
polly.loop_exit386.loopexit.us:                   ; preds = %polly.loop_exit394.us
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar380.us, %135
...
polly.loop_exit379:                               ; preds = %polly.loop_exit386.loopexit.us, %polly.loop_header370
  ...
  %indvars.iv.next817 = add i64 %indvars.iv816, -100
...
polly.loop_exit524:                               ; preds = %polly.loop_exit532
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar_next520, 16
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %177 = sub nsw i64 %polly.indvar525, %pexp.p_div_q528.zext
  %polly.loop_guard533 = icmp slt i64 %177, 12
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  %178 = sub nsw i64 %indvars.iv842, %174
  %179 = add i64 %indvars.iv835, %174
  %180 = shl nsw i64 %polly.indvar525, 6
  %181 = mul nsw i64 %polly.indvar525, -64
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header522
  ...
  %indvars.iv.next836 = add nsw i64 %indvars.iv835, -36
  %indvars.iv.next838 = add nuw nsw i64 %indvars.iv837, 9
  %indvars.iv.next843 = add nuw nsw i64 %indvars.iv842, 36
  %exitcond854.not = icmp eq i64 %polly.indvar_next526, 19
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  %indvars.iv844 = phi i64 [ %178, %polly.loop_header530.preheader ], [ %indvars.iv.next845, %polly.loop_exit539 ]
  %indvars.iv839 = phi i64 [ %179, %polly.loop_header530.preheader ], [ %indvars.iv.next840, %polly.loop_exit539 ]
  ...
  %183 = mul nsw i64 %polly.indvar534, 100
  %184 = sub nsw i64 %180, %183
  %185 = icmp sgt i64 %184, 0
  %186 = select i1 %185, i64 %184, i64 0
  %polly.loop_guard547 = icmp slt i64 %186, 100
...
polly.loop_header544.us:                          ; preds = %polly.loop_header537.us, %polly.loop_exit554.us
  %indvars.iv846 = phi i64 [ %182, %polly.loop_header537.us ], [ %indvars.iv.next847, %polly.loop_exit554.us ]
  %polly.indvar548.us = phi i64 [ %186, %polly.loop_header537.us ], [ %polly.indvar_next549.us, %polly.loop_exit554.us ]
  %smin848 = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 63)
  %189 = add i64 %polly.indvar548.us, %183
  %190 = add i64 %189, %181
  %polly.loop_guard555.us894 = icmp sgt i64 %190, -1
...
polly.loop_exit546.loopexit.us:                   ; preds = %polly.loop_exit554.us
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar540.us, %172
...
polly.loop_exit539:                               ; preds = %polly.loop_exit546.loopexit.us, %polly.loop_header530
  ...
  %indvars.iv.next845 = add i64 %indvars.iv844, 100
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph923
  ...
  br i1 %220, label %polly.loop_exit720, label %vector.body921, !llvm.loop !94

polly.loop_exit720:                               ; preds = %vector.body921, %polly.loop_header718
  %polly.indvar_next716 = add nuw nsw i64 %polly.indvar715, 1
  %exitcond885.not = icmp eq i64 %polly.indvar715, %200
...
polly.loop_header718:                             ; preds = %polly.loop_header712, %polly.loop_header718
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar721, %204
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph939
  ...
  br i1 %249, label %polly.loop_exit747, label %vector.body936, !llvm.loop !97

polly.loop_exit747:                               ; preds = %vector.body936, %polly.loop_header745
  %polly.indvar_next743 = add nuw nsw i64 %polly.indvar742, 1
  %exitcond875.not = icmp eq i64 %polly.indvar742, %229
...
polly.loop_header745:                             ; preds = %polly.loop_header739, %polly.loop_header745
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar748, %233
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph957
  ...
  br i1 %278, label %polly.loop_exit773, label %vector.body954, !llvm.loop !100

polly.loop_exit773:                               ; preds = %vector.body954, %polly.loop_header771
  %polly.indvar_next769 = add nuw nsw i64 %polly.indvar768, 1
  %exitcond865.not = icmp eq i64 %polly.indvar768, %258
...
polly.loop_header771:                             ; preds = %polly.loop_header765, %polly.loop_header771
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar774, %262
