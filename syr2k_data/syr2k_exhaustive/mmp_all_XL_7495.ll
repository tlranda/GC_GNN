; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7495.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7495.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next219, 19
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  ...
  %polly.loop_guard243915 = icmp sgt i64 %108, -1
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1028
  ...
  %119 = shl nuw nsw i64 %index1031, 3
  %120 = getelementptr i8, i8* %scevgep366, i64 %119
  %121 = bitcast i8* %120 to <4 x double>*
  %wide.load1035 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !74, !noalias !76
  %122 = fmul fast <4 x double> %wide.load1035, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %124 = icmp eq i64 %index.next1032, %n.vec1030
  br i1 %124, label %middle.block1022, label %vector.body1024, !llvm.loop !80

middle.block1022:                                 ; preds = %vector.body1024
  %cmp.n1034 = icmp eq i64 %117, %n.vec1030
...
polly.loop_header392:                             ; preds = %polly.loop_exit401, %polly.loop_header386
  ...
  %131 = shl nsw i64 %polly.indvar395, 5
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit408
  ...
  %polly.loop_guard416916 = icmp sgt i64 %137, -1
...
polly.loop_header527:                             ; preds = %polly.loop_exit535, %polly.start441
  ...
  %min.iters.check1001 = icmp ult i64 %146, 4
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1002
  ...
  %148 = shl nuw nsw i64 %index1005, 3
  %149 = getelementptr i8, i8* %scevgep539, i64 %148
  %150 = bitcast i8* %149 to <4 x double>*
  %wide.load1009 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !84, !noalias !86
  %151 = fmul fast <4 x double> %wide.load1009, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %153 = icmp eq i64 %index.next1006, %n.vec1004
  br i1 %153, label %middle.block998, label %vector.body1000, !llvm.loop !90

middle.block998:                                  ; preds = %vector.body1000
  %cmp.n1008 = icmp eq i64 %146, %n.vec1004
...
polly.loop_exit567:                               ; preds = %polly.loop_exit574
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar_next563, 19
...
polly.loop_header565:                             ; preds = %polly.loop_exit574, %polly.loop_header559
  ...
  %160 = shl nsw i64 %polly.indvar568, 5
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header565
  ...
  %164 = add i64 %smax866, %indvars.iv869
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit581
  %indvars.iv871 = phi i64 [ %164, %polly.loop_header572.preheader ], [ %indvars.iv.next872, %polly.loop_exit581 ]
  %polly.indvar576 = phi i64 [ %163, %polly.loop_header572.preheader ], [ %polly.indvar_next577, %polly.loop_exit581 ]
  %smin873 = call i64 @llvm.smin.i64(i64 %indvars.iv871, i64 31)
  %166 = add nsw i64 %polly.indvar576, %165
  %polly.loop_guard589917 = icmp sgt i64 %166, -1
...
polly.loop_header744:                             ; preds = %polly.loop_exit752, %polly.loop_header738
  ...
  %smin939 = call i64 @llvm.smin.i64(i64 %177, i64 -1168)
  %178 = add nsw i64 %smin939, 1200
  %smin906 = call i64 @llvm.smin.i64(i64 %indvars.iv904, i64 -1168)
  %179 = shl nsw i64 %polly.indvar747, 5
  %180 = add nsw i64 %smin906, 1199
...
vector.ph940:                                     ; preds = %polly.loop_header750
  %broadcast.splatinsert947 = insertelement <4 x i64> poison, i64 %179, i32 0
  %broadcast.splat948 = shufflevector <4 x i64> %broadcast.splatinsert947, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert949 = insertelement <4 x i32> poison, i32 %182, i32 0
...
vector.body938:                                   ; preds = %vector.body938, %vector.ph940
  ...
  %184 = add nuw nsw <4 x i64> %vec.ind945, %broadcast.splat948
  %185 = trunc <4 x i64> %184 to <4 x i32>
  %186 = mul <4 x i32> %broadcast.splat950, %185
  ...
  %196 = icmp eq i64 %index.next942, %178
  br i1 %196, label %polly.loop_exit758, label %vector.body938, !llvm.loop !99

polly.loop_exit758:                               ; preds = %vector.body938, %polly.loop_header756
  %polly.indvar_next754 = add nuw nsw i64 %polly.indvar753, 1
  %exitcond911.not = icmp eq i64 %polly.indvar753, %176
...
polly.loop_header756:                             ; preds = %polly.loop_header750, %polly.loop_header756
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar759, %180
...
polly.loop_header771:                             ; preds = %polly.loop_exit779, %polly.loop_header765
  ...
  %smin954 = call i64 @llvm.smin.i64(i64 %206, i64 -968)
  %207 = add nsw i64 %smin954, 1000
  %smin896 = call i64 @llvm.smin.i64(i64 %indvars.iv894, i64 -968)
  %208 = shl nsw i64 %polly.indvar774, 5
  %209 = add nsw i64 %smin896, 999
...
vector.body953:                                   ; preds = %vector.body953, %vector.ph956
  ...
  %213 = add nuw nsw <4 x i64> %vec.ind963, %broadcast.splat966
  %214 = trunc <4 x i64> %213 to <4 x i32>
  %215 = mul <4 x i32> %broadcast.splat968, %214
  ...
  %225 = icmp eq i64 %index.next960, %207
  br i1 %225, label %polly.loop_exit785, label %vector.body953, !llvm.loop !102

polly.loop_exit785:                               ; preds = %vector.body953, %polly.loop_header783
  %polly.indvar_next781 = add nuw nsw i64 %polly.indvar780, 1
  %exitcond901.not = icmp eq i64 %polly.indvar780, %205
...
polly.loop_header783:                             ; preds = %polly.loop_header777, %polly.loop_header783
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar786, %209
...
polly.loop_header797:                             ; preds = %polly.loop_exit805, %polly.loop_header791
  ...
  %smin972 = call i64 @llvm.smin.i64(i64 %235, i64 -968)
  %236 = add nsw i64 %smin972, 1000
  %smin886 = call i64 @llvm.smin.i64(i64 %indvars.iv884, i64 -968)
  %237 = shl nsw i64 %polly.indvar800, 5
  %238 = add nsw i64 %smin886, 999
...
vector.body971:                                   ; preds = %vector.body971, %vector.ph974
  ...
  %242 = add nuw nsw <4 x i64> %vec.ind981, %broadcast.splat984
  %243 = trunc <4 x i64> %242 to <4 x i32>
  %244 = mul <4 x i32> %broadcast.splat986, %243
  ...
  %254 = icmp eq i64 %index.next978, %236
  br i1 %254, label %polly.loop_exit811, label %vector.body971, !llvm.loop !105

polly.loop_exit811:                               ; preds = %vector.body971, %polly.loop_header809
  %polly.indvar_next807 = add nuw nsw i64 %polly.indvar806, 1
  %exitcond891.not = icmp eq i64 %polly.indvar806, %234
...
polly.loop_header809:                             ; preds = %polly.loop_header803, %polly.loop_header809
  ...
  %exitcond887.not = icmp eq i64 %polly.indvar812, %238
