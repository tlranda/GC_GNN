; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6166.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6166.c"
...
vector.body1016:                                  ; preds = %vector.body1016, %vector.ph1018
  ...
  br i1 %57, label %middle.block1014, label %vector.body1016, !llvm.loop !59
...
vector.body1042:                                  ; preds = %vector.body1042, %vector.ph1044
  ...
  br i1 %68, label %middle.block1040, label %vector.body1042, !llvm.loop !61
...
vector.body1054:                                  ; preds = %vector.body1054, %vector.ph1058
  ...
  %wide.load1065 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !67, !noalias !69
  ...
  br i1 %95, label %middle.block1052, label %vector.body1054, !llvm.loop !73
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond842.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !74
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond841.not = icmp eq i64 %polly.indvar_next203, 19
...
polly.loop_exit213:                               ; preds = %polly.loop_header211
  ...
  br i1 %exitcond827.not, label %polly.loop_header221.preheader, label %polly.loop_header205

polly.loop_header221.preheader:                   ; preds = %polly.loop_exit213
  %98 = mul nsw i64 %polly.indvar202, -64
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit229
  %indvars.iv835 = phi i64 [ %indvars.iv833, %polly.loop_header221.preheader ], [ %indvars.iv.next836, %polly.loop_exit229 ]
  %indvars.iv828 = phi i64 [ 0, %polly.loop_header221.preheader ], [ %indvars.iv.next829, %polly.loop_exit229 ]
  ...
  %100 = add nsw i64 %smin837, 1199
  %smax = call i64 @llvm.smax.i64(i64 %100, i64 0)
  %101 = mul nsw i64 %polly.indvar224, -64
  %polly.loop_guard919 = icmp sgt i64 %101, -1200
...
polly.loop_header227.us:                          ; preds = %polly.loop_header221, %polly.loop_exit235.loopexit.us
  ...
  %103 = shl nuw nsw i64 %polly.indvar230.us, 3
  %scevgep245.us = getelementptr i8, i8* %call1, i64 %103
...
polly.loop_header233.us:                          ; preds = %polly.loop_exit241.us, %polly.loop_header227.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv830, i64 63)
  %104 = add nuw nsw i64 %polly.indvar236.us, %102
  %105 = add nsw i64 %104, %98
  %polly.access.add.Packed_MemRef_call2250.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2249.us, %105
  ...
  %scevgep258.us = getelementptr i8, i8* %scevgep245.us, i64 %106
  %scevgep258259.us = bitcast i8* %scevgep258.us to double*
  %_p_scalar_260.us = load double, double* %scevgep258259.us, align 8, !alias.scope !70, !noalias !77
...
polly.loop_header239.us:                          ; preds = %polly.loop_header239.us, %polly.loop_header233.us
  ...
  %108 = add nuw nsw i64 %polly.indvar242.us, %97
  %109 = mul nuw nsw i64 %108, 8000
  %scevgep246.us = getelementptr i8, i8* %scevgep245.us, i64 %109
  %scevgep246247.us = bitcast i8* %scevgep246.us to double*
  %_p_scalar_248.us = load double, double* %scevgep246247.us, align 8, !alias.scope !70, !noalias !77
  ...
  %scevgep261.us = getelementptr i8, i8* %call, i64 %111
  %scevgep261262.us = bitcast i8* %scevgep261.us to double*
  %_p_scalar_263.us = load double, double* %scevgep261262.us, align 8, !alias.scope !67, !noalias !69
  %p_reass.add.i116.us = fadd fast double %p_mul37.i114.us, %p_mul27.i112.us
  %p_reass.mul.i117.us = fmul fast double %p_reass.add.i116.us, 1.500000e+00
  %p_add42.i118.us = fadd fast double %p_reass.mul.i117.us, %_p_scalar_263.us
  store double %p_add42.i118.us, double* %scevgep261262.us, align 8, !alias.scope !67, !noalias !69
...
polly.loop_header352:                             ; preds = %polly.loop_exit360, %polly.start266
  ...
  %112 = add i64 %indvar1029, 1
  %113 = mul nuw nsw i64 %polly.indvar355, 9600
  %scevgep364 = getelementptr i8, i8* %call, i64 %113
  %min.iters.check1031 = icmp ult i64 %112, 4
...
vector.body1028:                                  ; preds = %vector.body1028, %vector.ph1032
  ...
  %114 = shl nuw nsw i64 %index1035, 3
  %115 = getelementptr i8, i8* %scevgep364, i64 %114
  %116 = bitcast i8* %115 to <4 x double>*
  %wide.load1039 = load <4 x double>, <4 x double>* %116, align 8, !alias.scope !78, !noalias !80
  %117 = fmul fast <4 x double> %wide.load1039, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %119 = icmp eq i64 %index.next1036, %n.vec1034
  br i1 %119, label %middle.block1026, label %vector.body1028, !llvm.loop !84

middle.block1026:                                 ; preds = %vector.body1028
  %cmp.n1038 = icmp eq i64 %112, %n.vec1034
...
polly.loop_header358:                             ; preds = %polly.loop_header358.preheader, %polly.loop_header358
  ...
  %120 = shl nuw nsw i64 %polly.indvar361, 3
  %scevgep365 = getelementptr i8, i8* %scevgep364, i64 %120
  ...
  br i1 %exitcond864.not, label %polly.loop_exit360, label %polly.loop_header358, !llvm.loop !85
...
polly.loop_header368:                             ; preds = %polly.loop_header368.preheader, %polly.loop_exit392
  ...
  %121 = shl nsw i64 %polly.indvar371, 6
  br label %polly.loop_header374

polly.loop_exit392:                               ; preds = %polly.loop_exit398
  %polly.indvar_next372 = add nuw nsw i64 %polly.indvar371, 1
  %indvars.iv.next845 = add nsw i64 %indvars.iv844, -64
  %indvars.iv.next855 = add nsw i64 %indvars.iv854, -64
  %exitcond863.not = icmp eq i64 %polly.indvar_next372, 19
...
polly.loop_exit382:                               ; preds = %polly.loop_header380
  ...
  br i1 %exitcond847.not, label %polly.loop_header390.preheader, label %polly.loop_header374

polly.loop_header390.preheader:                   ; preds = %polly.loop_exit382
  %122 = mul nsw i64 %polly.indvar371, -64
...
polly.loop_header380:                             ; preds = %polly.loop_header380, %polly.loop_header374
  ...
  %123 = add nuw nsw i64 %polly.indvar383, %121
  %polly.access.mul.call2387 = mul nuw nsw i64 %123, 1000
...
polly.loop_header390:                             ; preds = %polly.loop_header390.preheader, %polly.loop_exit398
  %indvars.iv856 = phi i64 [ %indvars.iv854, %polly.loop_header390.preheader ], [ %indvars.iv.next857, %polly.loop_exit398 ]
  %indvars.iv848 = phi i64 [ 0, %polly.loop_header390.preheader ], [ %indvars.iv.next849, %polly.loop_exit398 ]
  ...
  %124 = add nsw i64 %smin858, 1199
  %smax859 = call i64 @llvm.smax.i64(i64 %124, i64 0)
  %125 = mul nsw i64 %polly.indvar393, -64
  %polly.loop_guard406920 = icmp sgt i64 %125, -1200
  %126 = shl nsw i64 %polly.indvar393, 6
...
polly.loop_header396.us:                          ; preds = %polly.loop_header390, %polly.loop_exit405.loopexit.us
  ...
  %127 = shl nuw nsw i64 %polly.indvar399.us, 3
...
polly.loop_header403.us:                          ; preds = %polly.loop_exit412.us, %polly.loop_header396.us
  ...
  %smin852 = call i64 @llvm.smin.i64(i64 %indvars.iv850, i64 63)
  %128 = add nuw nsw i64 %polly.indvar407.us, %126
  %129 = add nsw i64 %128, %122
  %polly.access.add.Packed_MemRef_call2269421.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2269420.us, %129
  ...
  %scevgep429.us = getelementptr i8, i8* %scevgep416.us, i64 %130
  %scevgep429430.us = bitcast i8* %scevgep429.us to double*
  %_p_scalar_431.us = load double, double* %scevgep429430.us, align 8, !alias.scope !81, !noalias !87
...
polly.loop_header410.us:                          ; preds = %polly.loop_header410.us, %polly.loop_header403.us
  ...
  %132 = add nuw nsw i64 %polly.indvar413.us, %121
  %133 = mul nuw nsw i64 %132, 8000
  %scevgep417.us = getelementptr i8, i8* %scevgep416.us, i64 %133
  %scevgep417418.us = bitcast i8* %scevgep417.us to double*
  %_p_scalar_419.us = load double, double* %scevgep417418.us, align 8, !alias.scope !81, !noalias !87
  ...
  %scevgep432.us = getelementptr i8, i8* %call, i64 %135
  %scevgep432433.us = bitcast i8* %scevgep432.us to double*
  %_p_scalar_434.us = load double, double* %scevgep432433.us, align 8, !alias.scope !78, !noalias !80
  %p_reass.add.i77.us = fadd fast double %p_mul37.i75.us, %p_mul27.i73.us
  %p_reass.mul.i78.us = fmul fast double %p_reass.add.i77.us, 1.500000e+00
  %p_add42.i79.us = fadd fast double %p_reass.mul.i78.us, %_p_scalar_434.us
  store double %p_add42.i79.us, double* %scevgep432433.us, align 8, !alias.scope !78, !noalias !80
...
polly.loop_header523:                             ; preds = %polly.loop_exit531, %polly.start437
  ...
  %137 = mul nuw nsw i64 %polly.indvar526, 9600
  %scevgep535 = getelementptr i8, i8* %call, i64 %137
  %min.iters.check1005 = icmp ult i64 %136, 4
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1006
  ...
  %138 = shl nuw nsw i64 %index1009, 3
  %139 = getelementptr i8, i8* %scevgep535, i64 %138
  %140 = bitcast i8* %139 to <4 x double>*
  %wide.load1013 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !88, !noalias !90
  %141 = fmul fast <4 x double> %wide.load1013, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %143 = icmp eq i64 %index.next1010, %n.vec1008
  br i1 %143, label %middle.block1002, label %vector.body1004, !llvm.loop !94

middle.block1002:                                 ; preds = %vector.body1004
  %cmp.n1012 = icmp eq i64 %136, %n.vec1008
...
polly.loop_header529:                             ; preds = %polly.loop_header529.preheader, %polly.loop_header529
  ...
  %144 = shl nuw nsw i64 %polly.indvar532, 3
  %scevgep536 = getelementptr i8, i8* %scevgep535, i64 %144
  %scevgep536537 = bitcast i8* %scevgep536 to double*
  %_p_scalar_538 = load double, double* %scevgep536537, align 8, !alias.scope !88, !noalias !90
  %p_mul.i = fmul fast double %_p_scalar_538, 1.200000e+00
  store double %p_mul.i, double* %scevgep536537, align 8, !alias.scope !88, !noalias !90
  %polly.indvar_next533 = add nuw nsw i64 %polly.indvar532, 1
  %exitcond886.not = icmp eq i64 %polly.indvar_next533, %polly.indvar526
  br i1 %exitcond886.not, label %polly.loop_exit531, label %polly.loop_header529, !llvm.loop !95
...
polly.loop_header539:                             ; preds = %polly.loop_header539.preheader, %polly.loop_exit563
  ...
  %145 = shl nsw i64 %polly.indvar542, 6
...
polly.loop_exit563:                               ; preds = %polly.loop_exit569
  ...
  %exitcond885.not = icmp eq i64 %polly.indvar_next543, 19
...
polly.loop_exit553:                               ; preds = %polly.loop_header551
  ...
  br i1 %exitcond869.not, label %polly.loop_header561.preheader, label %polly.loop_header545

polly.loop_header561.preheader:                   ; preds = %polly.loop_exit553
  %146 = mul nsw i64 %polly.indvar542, -64
...
polly.loop_header551:                             ; preds = %polly.loop_header551, %polly.loop_header545
  ...
  %147 = add nuw nsw i64 %polly.indvar554, %145
  %polly.access.mul.call2558 = mul nuw nsw i64 %147, 1000
  ...
  %polly.access.call2560.load = load double, double* %polly.access.call2560, align 8, !alias.scope !92, !noalias !96
...
polly.loop_header561:                             ; preds = %polly.loop_header561.preheader, %polly.loop_exit569
  %indvars.iv878 = phi i64 [ %indvars.iv876, %polly.loop_header561.preheader ], [ %indvars.iv.next879, %polly.loop_exit569 ]
  %indvars.iv870 = phi i64 [ 0, %polly.loop_header561.preheader ], [ %indvars.iv.next871, %polly.loop_exit569 ]
  %polly.indvar564 = phi i64 [ %polly.indvar542, %polly.loop_header561.preheader ], [ %polly.indvar_next565, %polly.loop_exit569 ]
  %smin880 = call i64 @llvm.smin.i64(i64 %indvars.iv878, i64 -1136)
  %148 = add nsw i64 %smin880, 1199
  %smax881 = call i64 @llvm.smax.i64(i64 %148, i64 0)
  %149 = mul nsw i64 %polly.indvar564, -64
  %polly.loop_guard577921 = icmp sgt i64 %149, -1200
  %150 = shl nsw i64 %polly.indvar564, 6
...
polly.loop_header567.us:                          ; preds = %polly.loop_header561, %polly.loop_exit576.loopexit.us
  ...
  %151 = shl nuw nsw i64 %polly.indvar570.us, 3
  %scevgep587.us = getelementptr i8, i8* %call1, i64 %151
...
polly.loop_header574.us:                          ; preds = %polly.loop_exit583.us, %polly.loop_header567.us
  ...
  %152 = add nuw nsw i64 %polly.indvar578.us, %150
  ...
  %154 = mul nuw nsw i64 %152, 8000
  %scevgep600.us = getelementptr i8, i8* %scevgep587.us, i64 %154
  %scevgep600601.us = bitcast i8* %scevgep600.us to double*
  %_p_scalar_602.us = load double, double* %scevgep600601.us, align 8, !alias.scope !91, !noalias !97
...
polly.loop_header581.us:                          ; preds = %polly.loop_header581.us, %polly.loop_header574.us
  ...
  %156 = add nuw nsw i64 %polly.indvar584.us, %145
  %157 = mul nuw nsw i64 %156, 8000
  %scevgep588.us = getelementptr i8, i8* %scevgep587.us, i64 %157
  %scevgep588589.us = bitcast i8* %scevgep588.us to double*
  %_p_scalar_590.us = load double, double* %scevgep588589.us, align 8, !alias.scope !91, !noalias !97
  ...
  %scevgep603.us = getelementptr i8, i8* %call, i64 %159
  %scevgep603604.us = bitcast i8* %scevgep603.us to double*
  %_p_scalar_605.us = load double, double* %scevgep603604.us, align 8, !alias.scope !88, !noalias !90
  %p_reass.add.i.us = fadd fast double %p_mul37.i.us, %p_mul27.i.us
  %p_reass.mul.i.us = fmul fast double %p_reass.add.i.us, 1.500000e+00
  %p_add42.i.us = fadd fast double %p_reass.mul.i.us, %_p_scalar_605.us
  store double %p_add42.i.us, double* %scevgep603604.us, align 8, !alias.scope !88, !noalias !90
...
polly.loop_header732:                             ; preds = %entry, %polly.loop_exit740
  ...
  %160 = shl nsw i64 %polly.indvar735, 5
  %161 = add nsw i64 %smin914, 1199
...
polly.loop_header738:                             ; preds = %polly.loop_exit746, %polly.loop_header732
  ...
  %162 = mul nsw i64 %polly.indvar741, -32
  %smin943 = call i64 @llvm.smin.i64(i64 %162, i64 -1168)
  %163 = add nsw i64 %smin943, 1200
  %smin910 = call i64 @llvm.smin.i64(i64 %indvars.iv908, i64 -1168)
  %164 = shl nsw i64 %polly.indvar741, 5
  %165 = add nsw i64 %smin910, 1199
...
polly.loop_header744:                             ; preds = %polly.loop_exit752, %polly.loop_header738
  ...
  %166 = add nuw nsw i64 %polly.indvar747, %160
...
vector.ph944:                                     ; preds = %polly.loop_header744
  %broadcast.splatinsert951 = insertelement <4 x i64> poison, i64 %164, i32 0
...
vector.body942:                                   ; preds = %vector.body942, %vector.ph944
  ...
  %169 = add nuw nsw <4 x i64> %vec.ind949, %broadcast.splat952
  %170 = trunc <4 x i64> %169 to <4 x i32>
  %171 = mul <4 x i32> %broadcast.splat954, %170
  ...
  store <4 x double> %175, <4 x double>* %180, align 8, !alias.scope !98, !noalias !100
  %index.next946 = add i64 %index945, 4
  %vec.ind.next950 = add <4 x i64> %vec.ind949, <i64 4, i64 4, i64 4, i64 4>
  %181 = icmp eq i64 %index.next946, %163
  br i1 %181, label %polly.loop_exit752, label %vector.body942, !llvm.loop !103

polly.loop_exit752:                               ; preds = %vector.body942, %polly.loop_header750
  %polly.indvar_next748 = add nuw nsw i64 %polly.indvar747, 1
  %exitcond915.not = icmp eq i64 %polly.indvar747, %161
...
polly.loop_header750:                             ; preds = %polly.loop_header744, %polly.loop_header750
  ...
  %182 = add nuw nsw i64 %polly.indvar753, %164
  ...
  %scevgep756 = getelementptr i8, i8* %call, i64 %188
  %scevgep756757 = bitcast i8* %scevgep756 to double*
  store double %p_div33.i, double* %scevgep756757, align 8, !alias.scope !98, !noalias !100
  %polly.indvar_next754 = add nuw nsw i64 %polly.indvar753, 1
  %exitcond911.not = icmp eq i64 %polly.indvar753, %165
  br i1 %exitcond911.not, label %polly.loop_exit752, label %polly.loop_header750, !llvm.loop !104
...
polly.loop_header759:                             ; preds = %polly.loop_exit740, %polly.loop_exit767
  ...
  %189 = shl nsw i64 %polly.indvar762, 5
  %190 = add nsw i64 %smin904, 1199
...
polly.loop_header765:                             ; preds = %polly.loop_exit773, %polly.loop_header759
  ...
  %191 = mul nsw i64 %polly.indvar768, -32
  %smin958 = call i64 @llvm.smin.i64(i64 %191, i64 -968)
  %192 = add nsw i64 %smin958, 1000
  %smin900 = call i64 @llvm.smin.i64(i64 %indvars.iv898, i64 -968)
  %193 = shl nsw i64 %polly.indvar768, 5
  %194 = add nsw i64 %smin900, 999
...
vector.body957:                                   ; preds = %vector.body957, %vector.ph960
  ...
  %198 = add nuw nsw <4 x i64> %vec.ind967, %broadcast.splat970
  %199 = trunc <4 x i64> %198 to <4 x i32>
  %200 = mul <4 x i32> %broadcast.splat972, %199
  ...
  store <4 x double> %204, <4 x double>* %209, align 8, !alias.scope !102, !noalias !105
  %index.next964 = add i64 %index963, 4
  %vec.ind.next968 = add <4 x i64> %vec.ind967, <i64 4, i64 4, i64 4, i64 4>
  %210 = icmp eq i64 %index.next964, %192
  br i1 %210, label %polly.loop_exit779, label %vector.body957, !llvm.loop !106

polly.loop_exit779:                               ; preds = %vector.body957, %polly.loop_header777
  %polly.indvar_next775 = add nuw nsw i64 %polly.indvar774, 1
  %exitcond905.not = icmp eq i64 %polly.indvar774, %190
...
polly.loop_header777:                             ; preds = %polly.loop_header771, %polly.loop_header777
  ...
  %211 = add nuw nsw i64 %polly.indvar780, %193
  ...
  %scevgep783 = getelementptr i8, i8* %call2, i64 %217
  %scevgep783784 = bitcast i8* %scevgep783 to double*
  store double %p_div12.i, double* %scevgep783784, align 8, !alias.scope !102, !noalias !105
  %polly.indvar_next781 = add nuw nsw i64 %polly.indvar780, 1
  %exitcond901.not = icmp eq i64 %polly.indvar780, %194
  br i1 %exitcond901.not, label %polly.loop_exit779, label %polly.loop_header777, !llvm.loop !107
...
polly.loop_header785:                             ; preds = %polly.loop_exit767, %polly.loop_exit793
  ...
  %218 = shl nsw i64 %polly.indvar788, 5
  %219 = add nsw i64 %smin894, 1199
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %220 = mul nsw i64 %polly.indvar794, -32
  %smin976 = call i64 @llvm.smin.i64(i64 %220, i64 -968)
  %221 = add nsw i64 %smin976, 1000
  %smin890 = call i64 @llvm.smin.i64(i64 %indvars.iv888, i64 -968)
  %222 = shl nsw i64 %polly.indvar794, 5
  %223 = add nsw i64 %smin890, 999
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph978
  ...
  %227 = add nuw nsw <4 x i64> %vec.ind985, %broadcast.splat988
  %228 = trunc <4 x i64> %227 to <4 x i32>
  %229 = mul <4 x i32> %broadcast.splat990, %228
  ...
  store <4 x double> %233, <4 x double>* %238, align 8, !alias.scope !101, !noalias !108
  %index.next982 = add i64 %index981, 4
  %vec.ind.next986 = add <4 x i64> %vec.ind985, <i64 4, i64 4, i64 4, i64 4>
  %239 = icmp eq i64 %index.next982, %221
  br i1 %239, label %polly.loop_exit805, label %vector.body975, !llvm.loop !109

polly.loop_exit805:                               ; preds = %vector.body975, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond895.not = icmp eq i64 %polly.indvar800, %219
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %240 = add nuw nsw i64 %polly.indvar806, %222
  ...
  %scevgep810 = getelementptr i8, i8* %call1, i64 %246
  %scevgep810811 = bitcast i8* %scevgep810 to double*
  store double %p_div.i, double* %scevgep810811, align 8, !alias.scope !101, !noalias !108
  %polly.indvar_next807 = add nuw nsw i64 %polly.indvar806, 1
  %exitcond891.not = icmp eq i64 %polly.indvar806, %223
  br i1 %exitcond891.not, label %polly.loop_exit805, label %polly.loop_header803, !llvm.loop !110
}
