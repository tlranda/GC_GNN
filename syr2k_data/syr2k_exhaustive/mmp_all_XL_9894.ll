; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9894.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9894.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %104 = mul nuw nsw i64 %polly.indvar214, 80
...
polly.loop_header217.preheader:                   ; preds = %polly.loop_header211
  ...
  %108 = add i64 %smax, %indvars.iv789
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv791 = phi i64 [ %108, %polly.loop_header217.preheader ], [ %indvars.iv.next792, %polly.loop_exit225 ]
  ...
  %polly.loop_guard233879 = icmp sgt i64 %110, -1
  %111 = add nuw nsw i64 %polly.indvar220, %102
  %112 = mul i64 %111, 8000
  %113 = mul i64 %111, 9600
  br i1 %polly.loop_guard233879, label %polly.loop_header223.us, label %polly.loop_exit225
...
polly.loop_exit232.loopexit.us:                   ; preds = %polly.loop_header230.us
  ...
  %exitcond793.not = icmp eq i64 %polly.indvar_next227.us, 100
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph998
  ...
  %124 = shl nuw nsw i64 %index1001, 3
  %125 = getelementptr i8, i8* %scevgep350, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1005 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !69, !noalias !71
  %127 = fmul fast <4 x double> %wide.load1005, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1002, %n.vec1000
  br i1 %129, label %middle.block992, label %vector.body994, !llvm.loop !74

middle.block992:                                  ; preds = %vector.body994
  %cmp.n1004 = icmp eq i64 %122, %n.vec1000
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %131 = udiv i64 %indvars.iv815, 5
  %umin817 = call i64 @llvm.umin.i64(i64 %131, i64 14)
  %132 = mul nsw i64 %polly.indvar357, -32
  %133 = icmp slt i64 %132, -1168
  %134 = select i1 %133, i64 %132, i64 -1168
  %135 = add nsw i64 %134, 1199
  %136 = shl nsw i64 %polly.indvar357, 5
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %137 = mul nuw nsw i64 %polly.indvar363, 100
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit376
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %exitcond819.not = icmp eq i64 %polly.indvar_next364, 10
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %polly.loop_guard377.not = icmp sgt i64 %141, %135
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv810 = phi i64 [ %142, %polly.loop_header374.preheader ], [ %indvars.iv.next811, %polly.loop_exit383 ]
  %polly.indvar378 = phi i64 [ %141, %polly.loop_header374.preheader ], [ %polly.indvar_next379, %polly.loop_exit383 ]
  %smin812 = call i64 @llvm.smin.i64(i64 %indvars.iv810, i64 79)
  %144 = add nsw i64 %polly.indvar378, %143
  %polly.loop_guard391880 = icmp sgt i64 %144, -1
  %145 = add nuw nsw i64 %polly.indvar378, %136
  %146 = mul i64 %145, 8000
  %147 = mul i64 %145, 9600
  br i1 %polly.loop_guard391880, label %polly.loop_header381.us, label %polly.loop_exit383
...
polly.loop_header381.us:                          ; preds = %polly.loop_header374, %polly.loop_exit390.loopexit.us
  ...
  %149 = shl i64 %148, 3
  %150 = add i64 %149, %146
  %scevgep398.us = getelementptr i8, i8* %call2, i64 %150
  ...
  %scevgep404.us = getelementptr i8, i8* %call1, i64 %150
...
polly.loop_header388.us:                          ; preds = %polly.loop_header381.us, %polly.loop_header388.us
  ...
  %151 = add nuw nsw i64 %polly.indvar392.us, %138
  %152 = mul nuw nsw i64 %151, 8000
  %153 = add nuw nsw i64 %152, %149
  %scevgep395.us = getelementptr i8, i8* %call1, i64 %153
  ...
  %scevgep401.us = getelementptr i8, i8* %call2, i64 %153
...
polly.loop_exit390.loopexit.us:                   ; preds = %polly.loop_header388.us
  ...
  %exitcond814.not = icmp eq i64 %polly.indvar_next385.us, 100
  br i1 %exitcond814.not, label %polly.loop_exit383, label %polly.loop_header381.us

polly.loop_exit383:                               ; preds = %polly.loop_exit390.loopexit.us, %polly.loop_header374
  %polly.indvar_next379 = add nuw nsw i64 %polly.indvar378, 1
  %polly.loop_cond380.not.not = icmp ult i64 %polly.indvar378, %135
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph972
  ...
  %158 = shl nuw nsw i64 %index975, 3
  %159 = getelementptr i8, i8* %scevgep508, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load979 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !78, !noalias !80
  %161 = fmul fast <4 x double> %wide.load979, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next976, %n.vec974
  br i1 %163, label %middle.block968, label %vector.body970, !llvm.loop !83

middle.block968:                                  ; preds = %vector.body970
  %cmp.n978 = icmp eq i64 %156, %n.vec974
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %165 = udiv i64 %indvars.iv837, 5
  %umin839 = call i64 @llvm.umin.i64(i64 %165, i64 14)
  %166 = mul nsw i64 %polly.indvar515, -32
  %167 = icmp slt i64 %166, -1168
  %168 = select i1 %167, i64 %166, i64 -1168
  %169 = add nsw i64 %168, 1199
  %170 = shl nsw i64 %polly.indvar515, 5
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %171 = mul nuw nsw i64 %polly.indvar521, 100
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond841.not = icmp eq i64 %polly.indvar_next522, 10
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %172 = mul nuw nsw i64 %polly.indvar528, 80
  %173 = add nsw i64 %172, %166
  %174 = icmp sgt i64 %173, 0
  %175 = select i1 %174, i64 %173, i64 0
  %polly.loop_guard535.not = icmp sgt i64 %175, %169
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %176 = add i64 %smax827, %indvars.iv830
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv832 = phi i64 [ %176, %polly.loop_header532.preheader ], [ %indvars.iv.next833, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %175, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin834 = call i64 @llvm.smin.i64(i64 %indvars.iv832, i64 79)
  %178 = add nsw i64 %polly.indvar536, %177
  %polly.loop_guard549881 = icmp sgt i64 %178, -1
  %179 = add nuw nsw i64 %polly.indvar536, %170
  %180 = mul i64 %179, 8000
  %181 = mul i64 %179, 9600
  br i1 %polly.loop_guard549881, label %polly.loop_header539.us, label %polly.loop_exit541
...
polly.loop_header539.us:                          ; preds = %polly.loop_header532, %polly.loop_exit548.loopexit.us
  ...
  %182 = add nuw nsw i64 %polly.indvar542.us, %171
  %183 = shl i64 %182, 3
  %184 = add i64 %183, %180
  %scevgep556.us = getelementptr i8, i8* %call2, i64 %184
  ...
  %scevgep562.us = getelementptr i8, i8* %call1, i64 %184
...
polly.loop_header546.us:                          ; preds = %polly.loop_header539.us, %polly.loop_header546.us
  ...
  %185 = add nuw nsw i64 %polly.indvar550.us, %172
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond836.not = icmp eq i64 %polly.indvar_next543.us, 100
  br i1 %exitcond836.not, label %polly.loop_exit541, label %polly.loop_header539.us
...
polly.loop_exit541:                               ; preds = %polly.loop_exit548.loopexit.us, %polly.loop_header532
  ...
  %polly.loop_cond538.not.not = icmp ult i64 %polly.indvar536, %169
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin909 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin909, 1200
  %smin867 = call i64 @llvm.smin.i64(i64 %indvars.iv865, i64 -1168)
  %194 = shl nsw i64 %polly.indvar703, 5
  %195 = add nsw i64 %smin867, 1199
...
vector.ph910:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert917 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat918 = shufflevector <4 x i64> %broadcast.splatinsert917, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert919 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body908:                                   ; preds = %vector.body908, %vector.ph910
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind915, %broadcast.splat918
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat920, %200
  ...
  %211 = icmp eq i64 %index.next912, %193
  br i1 %211, label %polly.loop_exit714, label %vector.body908, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body908, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond872.not = icmp eq i64 %polly.indvar709, %191
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar715, %195
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin924 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin924, 1000
  %smin857 = call i64 @llvm.smin.i64(i64 %indvars.iv855, i64 -968)
  %223 = shl nsw i64 %polly.indvar730, 5
  %224 = add nsw i64 %smin857, 999
...
vector.body923:                                   ; preds = %vector.body923, %vector.ph926
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind933, %broadcast.splat936
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat938, %229
  ...
  %240 = icmp eq i64 %index.next930, %222
  br i1 %240, label %polly.loop_exit741, label %vector.body923, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body923, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond862.not = icmp eq i64 %polly.indvar736, %220
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar742, %224
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin942 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin942, 1000
  %smin847 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -968)
  %252 = shl nsw i64 %polly.indvar756, 5
  %253 = add nsw i64 %smin847, 999
...
vector.body941:                                   ; preds = %vector.body941, %vector.ph944
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind951, %broadcast.splat954
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat956, %258
  ...
  %269 = icmp eq i64 %index.next948, %251
  br i1 %269, label %polly.loop_exit767, label %vector.body941, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body941, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond852.not = icmp eq i64 %polly.indvar762, %249
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar768, %253
