; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2804.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2804.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit250
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar_next209, 5
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %.inv = icmp ugt i64 %102, 255
  %104 = select i1 %.inv, i64 255, i64 %103
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %166 = shl nuw nsw i64 %polly.indvar396, 5
  %167 = mul nsw i64 %polly.indvar396, -256
  %168 = shl nsw i64 %polly.indvar396, 8
  br label %polly.loop_header399

polly.loop_exit401:                               ; preds = %polly.loop_exit440
  %polly.indvar_next397 = add nuw nsw i64 %polly.indvar396, 1
  %exitcond922.not = icmp eq i64 %polly.indvar_next397, 5
...
polly.loop_header399:                             ; preds = %polly.loop_exit440, %polly.loop_header393
  ...
  %.inv869 = icmp ugt i64 %170, 255
  %172 = select i1 %.inv869, i64 255, i64 %171
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %234 = shl nuw nsw i64 %polly.indvar586, 5
  %235 = mul nsw i64 %polly.indvar586, -256
  %236 = shl nsw i64 %polly.indvar586, 8
...
polly.loop_exit591:                               ; preds = %polly.loop_exit630
  ...
  %exitcond938.not = icmp eq i64 %polly.indvar_next587, 5
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %238, 255
  %240 = select i1 %.inv870, i64 255, i64 %239
