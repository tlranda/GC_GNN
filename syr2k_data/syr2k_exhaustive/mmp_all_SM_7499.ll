; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7499.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7499.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %pexp.p_div_q830 = udiv i8 %pexp.p_div_q.lhs.trunc, 25
  %pexp.p_div_q.zext = zext i8 %pexp.p_div_q830 to i64
  %99 = sub nsw i64 %polly.indvar218, %pexp.p_div_q.zext
...
polly.loop_exit223:                               ; preds = %polly.loop_exit230, %polly.loop_header215
  ...
  %indvars.iv.next839 = add nuw nsw i64 %indvars.iv838, 64
  %exitcond846.not = icmp eq i64 %polly.indvar_next219, 19
...
polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header221
  ...
  %indvars.iv.next837 = add i64 %indvars.iv836, 100
  %indvars.iv.next841 = add i64 %indvars.iv840, -100
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit398
  ...
  %131 = trunc i64 %polly.indvar391 to i8
  %132 = mul i8 %131, 9
  %pexp.p_div_q394.lhs.trunc = add i8 %132, 34
  %pexp.p_div_q394829 = udiv i8 %pexp.p_div_q394.lhs.trunc, 25
  %pexp.p_div_q394.zext = zext i8 %pexp.p_div_q394829 to i64
  %133 = sub nsw i64 %polly.indvar391, %pexp.p_div_q394.zext
  %134 = add nsw i64 %133, 1
  %.inv826 = icmp slt i64 %133, 11
  %135 = select i1 %.inv826, i64 %134, i64 11
...
polly.loop_exit398:                               ; preds = %polly.loop_exit406, %polly.loop_header388
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar_next392, 19
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_exit406
  ...
  %141 = mul nsw i64 %polly.indvar400, 100
...
polly.loop_exit406:                               ; preds = %polly.loop_exit413, %polly.loop_header396
  ...
  %indvars.iv.next854 = add i64 %indvars.iv853, 100
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit574
  ...
  %165 = trunc i64 %polly.indvar567 to i8
  %166 = mul i8 %165, 9
  %pexp.p_div_q570.lhs.trunc = add i8 %166, 34
  %pexp.p_div_q570828 = udiv i8 %pexp.p_div_q570.lhs.trunc, 25
  %pexp.p_div_q570.zext = zext i8 %pexp.p_div_q570828 to i64
  %167 = sub nsw i64 %polly.indvar567, %pexp.p_div_q570.zext
  %168 = add nsw i64 %167, 1
  %.inv827 = icmp slt i64 %167, 11
  %169 = select i1 %.inv827, i64 %168, i64 11
...
polly.loop_exit574:                               ; preds = %polly.loop_exit582, %polly.loop_header564
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar_next568, 19
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit582
  ...
  %175 = mul nsw i64 %polly.indvar576, 100
...
polly.loop_exit582:                               ; preds = %polly.loop_exit589, %polly.loop_header572
  ...
  %indvars.iv.next874 = add i64 %indvars.iv873, 100
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit589
  ...
  %smin882 = call i64 @llvm.smin.i64(i64 %indvars.iv880, i64 99)
