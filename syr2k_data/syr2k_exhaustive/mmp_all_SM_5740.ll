; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5740.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5740.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin872 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -968)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond875.not = icmp eq i64 %polly.indvar_next203, 32
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %smin902 = call i64 @llvm.smin.i64(i64 %indvars.iv881, i64 -968)
...
polly.loop_exit382:                               ; preds = %polly.loop_exit405
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next378, 32
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %smin932 = call i64 @llvm.smin.i64(i64 %indvars.iv911, i64 -968)
...
polly.loop_exit560:                               ; preds = %polly.loop_exit583
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar_next556, 32
