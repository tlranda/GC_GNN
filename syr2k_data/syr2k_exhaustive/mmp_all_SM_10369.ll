; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10369.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10369.c"
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1003
  ...
  %wide.load1010 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %131, label %middle.block997, label %vector.body999, !llvm.loop !73
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph977
  ...
  %wide.load984 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %167, label %middle.block973, label %vector.body975, !llvm.loop !82
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph915
  ...
  br i1 %217, label %polly.loop_exit714, label %vector.body913, !llvm.loop !91
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph931
  ...
  br i1 %246, label %polly.loop_exit741, label %vector.body928, !llvm.loop !94
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph949
  ...
  br i1 %275, label %polly.loop_exit767, label %vector.body946, !llvm.loop !97
