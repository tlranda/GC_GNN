; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7890.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7890.c"
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph961
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv7.i, i64 %index962
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check1024 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check1024, label %for.body3.i46.preheader1098, label %vector.ph1025

vector.ph1025:                                    ; preds = %for.body3.i46.preheader
  %n.vec1027 = and i64 %indvars.iv21.i, 9223372036854775804
...
vector.body1023:                                  ; preds = %vector.body1023, %vector.ph1025
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i, i64 %index1028
  ...
  %46 = icmp eq i64 %index.next1029, %n.vec1027
  br i1 %46, label %middle.block1021, label %vector.body1023, !llvm.loop !18

middle.block1021:                                 ; preds = %vector.body1023
  %cmp.n1031 = icmp eq i64 %indvars.iv21.i, %n.vec1027
  br i1 %cmp.n1031, label %for.inc6.i, label %for.body3.i46.preheader1098

for.body3.i46.preheader1098:                      ; preds = %for.body3.i46.preheader, %middle.block1021
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec1027, %middle.block1021 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1098, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1098 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block1021, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1047 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1047, label %for.body3.i60.preheader1097, label %vector.ph1048

vector.ph1048:                                    ; preds = %for.body3.i60.preheader
  %n.vec1050 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1046:                                  ; preds = %vector.body1046, %vector.ph1048
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i52, i64 %index1051
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1055 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1055, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1052 = add i64 %index1051, 4
  %57 = icmp eq i64 %index.next1052, %n.vec1050
  br i1 %57, label %middle.block1044, label %vector.body1046, !llvm.loop !55

middle.block1044:                                 ; preds = %vector.body1046
  %cmp.n1054 = icmp eq i64 %indvars.iv21.i52, %n.vec1050
  br i1 %cmp.n1054, label %for.inc6.i63, label %for.body3.i60.preheader1097

for.body3.i60.preheader1097:                      ; preds = %for.body3.i60.preheader, %middle.block1044
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1050, %middle.block1044 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1097, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1097 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1044, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1073 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1073, label %for.body3.i99.preheader1096, label %vector.ph1074

vector.ph1074:                                    ; preds = %for.body3.i99.preheader
  %n.vec1076 = and i64 %indvars.iv21.i91, 9223372036854775804
...
vector.body1072:                                  ; preds = %vector.body1072, %vector.ph1074
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i91, i64 %index1077
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1081 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1081, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1078 = add i64 %index1077, 4
  %68 = icmp eq i64 %index.next1078, %n.vec1076
  br i1 %68, label %middle.block1070, label %vector.body1072, !llvm.loop !57

middle.block1070:                                 ; preds = %vector.body1072
  %cmp.n1080 = icmp eq i64 %indvars.iv21.i91, %n.vec1076
  br i1 %cmp.n1080, label %for.inc6.i102, label %for.body3.i99.preheader1096

for.body3.i99.preheader1096:                      ; preds = %for.body3.i99.preheader, %middle.block1070
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1076, %middle.block1070 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1096, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1096 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1070, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit193, %polly.start
  %indvar1085 = phi i64 [ %indvar.next1086, %polly.loop_exit193 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1085, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1087 = icmp ult i64 %88, 4
  br i1 %min.iters.check1087, label %polly.loop_header191.preheader, label %vector.ph1088

vector.ph1088:                                    ; preds = %polly.loop_header
  %n.vec1090 = and i64 %88, -4
  br label %vector.body1084

vector.body1084:                                  ; preds = %vector.body1084, %vector.ph1088
  %index1091 = phi i64 [ 0, %vector.ph1088 ], [ %index.next1092, %vector.body1084 ]
  %90 = shl nuw nsw i64 %index1091, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1095 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  %93 = fmul fast <4 x double> %wide.load1095, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !63, !noalias !65
  %index.next1092 = add i64 %index1091, 4
  %95 = icmp eq i64 %index.next1092, %n.vec1090
  br i1 %95, label %middle.block1082, label %vector.body1084, !llvm.loop !69

middle.block1082:                                 ; preds = %vector.body1084
  %cmp.n1094 = icmp eq i64 %88, %n.vec1090
  br i1 %cmp.n1094, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block1082
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1090, %middle.block1082 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1082
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond858.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !70
...
polly.loop_exit207:                               ; preds = %polly.loop_header205
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar_next203, 1000
  br i1 %exitcond857.not, label %polly.loop_header215, label %polly.loop_header199
...
polly.loop_header205:                             ; preds = %polly.loop_header205, %polly.loop_header199
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next209, 1200
  br i1 %exitcond856.not, label %polly.loop_exit207, label %polly.loop_header205

polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv851 = phi i64 [ %indvars.iv.next852, %polly.loop_exit223 ], [ 1, %polly.loop_exit207 ]
  ...
  %98 = add nuw i64 %indvars.iv849, %97
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next850 = add nuw nsw i64 %indvars.iv849, 6
  %indvars.iv.next852 = add nuw nsw i64 %indvars.iv851, 2
  %exitcond855.not = icmp eq i64 %polly.indvar_next219, 10
  br i1 %exitcond855.not, label %polly.exiting, label %polly.loop_header215
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %smin847 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -984)
  %105 = shl nsw i64 %polly.indvar224, 4
  %106 = add nsw i64 %smin847, 999
  br label %polly.loop_header227

polly.loop_exit229:                               ; preds = %polly.loop_exit235
  %polly.indvar_next225 = add nuw nsw i64 %polly.indvar224, 1
  %indvars.iv.next846 = add nsw i64 %indvars.iv845, -16
  %exitcond854.not = icmp eq i64 %polly.indvar_next225, 63
  br i1 %exitcond854.not, label %polly.loop_exit223, label %polly.loop_header221
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar230, %104
  br i1 %exitcond853.not, label %polly.loop_exit229, label %polly.loop_header227
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249949 = icmp sgt i64 %113, -1
  %114 = add nuw nsw i64 %polly.indvar236, %103
  %115 = mul i64 %114, 8000
  %116 = mul i64 %114, 9600
  br i1 %polly.loop_guard249949, label %polly.loop_header239.us, label %polly.loop_exit241
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.start272
  %indvar1059 = phi i64 [ %indvar.next1060, %polly.loop_exit366 ], [ 0, %polly.start272 ]
  %polly.indvar361 = phi i64 [ %polly.indvar_next362, %polly.loop_exit366 ], [ 1, %polly.start272 ]
  %125 = add i64 %indvar1059, 1
  %126 = mul nuw nsw i64 %polly.indvar361, 9600
  %scevgep370 = getelementptr i8, i8* %call, i64 %126
  %min.iters.check1061 = icmp ult i64 %125, 4
  br i1 %min.iters.check1061, label %polly.loop_header364.preheader, label %vector.ph1062

vector.ph1062:                                    ; preds = %polly.loop_header358
  %n.vec1064 = and i64 %125, -4
...
vector.body1058:                                  ; preds = %vector.body1058, %vector.ph1062
  ...
  %127 = shl nuw nsw i64 %index1065, 3
  %128 = getelementptr i8, i8* %scevgep370, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1069 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !74, !noalias !76
  %130 = fmul fast <4 x double> %wide.load1069, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1066, %n.vec1064
  br i1 %132, label %middle.block1056, label %vector.body1058, !llvm.loop !80

middle.block1056:                                 ; preds = %vector.body1058
  %cmp.n1068 = icmp eq i64 %125, %n.vec1064
  br i1 %cmp.n1068, label %polly.loop_exit366, label %polly.loop_header364.preheader

polly.loop_header364.preheader:                   ; preds = %polly.loop_header358, %middle.block1056
  %polly.indvar367.ph = phi i64 [ 0, %polly.loop_header358 ], [ %n.vec1064, %middle.block1056 ]
  br label %polly.loop_header364

polly.loop_exit366:                               ; preds = %polly.loop_header364, %middle.block1056
  %polly.indvar_next362 = add nuw nsw i64 %polly.indvar361, 1
  %exitcond888.not = icmp eq i64 %polly.indvar_next362, 1200
  %indvar.next1060 = add i64 %indvar1059, 1
  br i1 %exitcond888.not, label %polly.loop_header374.preheader, label %polly.loop_header358
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  %exitcond887.not = icmp eq i64 %polly.indvar_next368, %polly.indvar361
  br i1 %exitcond887.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !81
...
polly.loop_exit382:                               ; preds = %polly.loop_header380
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar_next378, 1000
  br i1 %exitcond886.not, label %polly.loop_header390, label %polly.loop_header374
...
polly.loop_header380:                             ; preds = %polly.loop_header380, %polly.loop_header374
  ...
  %exitcond885.not = icmp eq i64 %polly.indvar_next384, 1200
  br i1 %exitcond885.not, label %polly.loop_exit382, label %polly.loop_header380

polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv879 = phi i64 [ %indvars.iv.next880, %polly.loop_exit398 ], [ 1, %polly.loop_exit382 ]
  %indvars.iv877 = phi i64 [ %indvars.iv.next878, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  %indvars.iv865 = phi i64 [ %indvars.iv.next866, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  ...
  %134 = udiv i64 %indvars.iv879, 5
  %135 = add nuw i64 %indvars.iv877, %134
  %umin881 = call i64 @llvm.umin.i64(i64 %135, i64 53)
  ...
  %141 = add nuw nsw i64 %umin881, 6
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit405
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next861 = add nsw i64 %indvars.iv860, -128
  %indvars.iv.next866 = add nuw nsw i64 %indvars.iv865, 128
  %indvars.iv.next878 = add nuw nsw i64 %indvars.iv877, 6
  %indvars.iv.next880 = add nuw nsw i64 %indvars.iv879, 2
  %exitcond884.not = icmp eq i64 %polly.indvar_next394, 10
  br i1 %exitcond884.not, label %polly.exiting273, label %polly.loop_header390

polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  %indvars.iv873 = phi i64 [ %indvars.iv.next874, %polly.loop_exit405 ], [ 0, %polly.loop_header390 ]
  %polly.indvar399 = phi i64 [ %polly.indvar_next400, %polly.loop_exit405 ], [ 0, %polly.loop_header390 ]
  %smin875 = call i64 @llvm.smin.i64(i64 %indvars.iv873, i64 -984)
  %142 = shl nsw i64 %polly.indvar399, 4
  %143 = add nsw i64 %smin875, 999
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit412
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %indvars.iv.next874 = add nsw i64 %indvars.iv873, -16
  %exitcond883.not = icmp eq i64 %polly.indvar_next400, 63
  br i1 %exitcond883.not, label %polly.loop_exit398, label %polly.loop_header396

polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  %indvars.iv867 = phi i64 [ %indvars.iv.next868, %polly.loop_exit412 ], [ %indvars.iv865, %polly.loop_header396 ]
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %148 = add i64 %smax864, %indvars.iv867
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar406, %141
  br i1 %exitcond882.not, label %polly.loop_exit405, label %polly.loop_header403

polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv869 = phi i64 [ %148, %polly.loop_header410.preheader ], [ %indvars.iv.next870, %polly.loop_exit419 ]
  %polly.indvar414 = phi i64 [ %147, %polly.loop_header410.preheader ], [ %polly.indvar_next415, %polly.loop_exit419 ]
  %smin871 = call i64 @llvm.smin.i64(i64 %indvars.iv869, i64 19)
  %150 = add nsw i64 %polly.indvar414, %149
  %polly.loop_guard427950 = icmp sgt i64 %150, -1
  %151 = add nuw nsw i64 %polly.indvar414, %140
  %152 = mul i64 %151, 8000
  %153 = mul i64 %151, 9600
  br i1 %polly.loop_guard427950, label %polly.loop_header417.us, label %polly.loop_exit419
...
polly.loop_header424.us:                          ; preds = %polly.loop_header417.us, %polly.loop_header424.us
  ...
  %exitcond872.not = icmp eq i64 %polly.indvar428.us, %smin871
  br i1 %exitcond872.not, label %polly.loop_exit426.loopexit.us, label %polly.loop_header424.us

polly.loop_exit426.loopexit.us:                   ; preds = %polly.loop_header424.us
  %polly.indvar_next421.us = add nuw nsw i64 %polly.indvar420.us, 1
  %exitcond876.not = icmp eq i64 %polly.indvar420.us, %143
  br i1 %exitcond876.not, label %polly.loop_exit419, label %polly.loop_header417.us
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1035 = icmp ult i64 %162, 4
  br i1 %min.iters.check1035, label %polly.loop_header542.preheader, label %vector.ph1036

vector.ph1036:                                    ; preds = %polly.loop_header536
  %n.vec1038 = and i64 %162, -4
...
vector.body1034:                                  ; preds = %vector.body1034, %vector.ph1036
  ...
  %164 = shl nuw nsw i64 %index1039, 3
  %165 = getelementptr i8, i8* %scevgep548, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load1043 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !84, !noalias !86
  %167 = fmul fast <4 x double> %wide.load1043, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next1040, %n.vec1038
  br i1 %169, label %middle.block1032, label %vector.body1034, !llvm.loop !90

middle.block1032:                                 ; preds = %vector.body1034
  %cmp.n1042 = icmp eq i64 %162, %n.vec1038
  br i1 %cmp.n1042, label %polly.loop_exit544, label %polly.loop_header542.preheader

polly.loop_header542.preheader:                   ; preds = %polly.loop_header536, %middle.block1032
  %polly.indvar545.ph = phi i64 [ 0, %polly.loop_header536 ], [ %n.vec1038, %middle.block1032 ]
  br label %polly.loop_header542

polly.loop_exit544:                               ; preds = %polly.loop_header542, %middle.block1032
  %polly.indvar_next540 = add nuw nsw i64 %polly.indvar539, 1
  %exitcond917.not = icmp eq i64 %polly.indvar_next540, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond917.not, label %polly.loop_header552.preheader, label %polly.loop_header536
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar_next546, %polly.indvar539
  br i1 %exitcond916.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !91
...
polly.loop_exit560:                               ; preds = %polly.loop_header558
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar_next556, 1000
  br i1 %exitcond915.not, label %polly.loop_header568, label %polly.loop_header552
...
polly.loop_header558:                             ; preds = %polly.loop_header558, %polly.loop_header552
  ...
  %exitcond914.not = icmp eq i64 %polly.indvar_next562, 1200
  br i1 %exitcond914.not, label %polly.loop_exit560, label %polly.loop_header558

polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv908 = phi i64 [ %indvars.iv.next909, %polly.loop_exit576 ], [ 1, %polly.loop_exit560 ]
  %indvars.iv906 = phi i64 [ %indvars.iv.next907, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %indvars.iv894 = phi i64 [ %indvars.iv.next895, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  ...
  %171 = udiv i64 %indvars.iv908, 5
  %172 = add nuw i64 %indvars.iv906, %171
  %umin910 = call i64 @llvm.umin.i64(i64 %172, i64 53)
  %173 = mul nsw i64 %polly.indvar571, -128
  %174 = icmp slt i64 %173, -1072
  %175 = select i1 %174, i64 %173, i64 -1072
  %176 = add nsw i64 %175, 1199
  %177 = shl nsw i64 %polly.indvar571, 7
  %178 = add nuw nsw i64 %umin910, 6
  br label %polly.loop_header574

polly.loop_exit576:                               ; preds = %polly.loop_exit583
  %polly.indvar_next572 = add nuw nsw i64 %polly.indvar571, 1
  %indvars.iv.next890 = add nsw i64 %indvars.iv889, -128
  %indvars.iv.next895 = add nuw nsw i64 %indvars.iv894, 128
  %indvars.iv.next907 = add nuw nsw i64 %indvars.iv906, 6
  %indvars.iv.next909 = add nuw nsw i64 %indvars.iv908, 2
  %exitcond913.not = icmp eq i64 %polly.indvar_next572, 10
  br i1 %exitcond913.not, label %polly.exiting451, label %polly.loop_header568

polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  %indvars.iv902 = phi i64 [ %indvars.iv.next903, %polly.loop_exit583 ], [ 0, %polly.loop_header568 ]
  %polly.indvar577 = phi i64 [ %polly.indvar_next578, %polly.loop_exit583 ], [ 0, %polly.loop_header568 ]
  %smin904 = call i64 @llvm.smin.i64(i64 %indvars.iv902, i64 -984)
  %179 = shl nsw i64 %polly.indvar577, 4
  %180 = add nsw i64 %smin904, 999
  br label %polly.loop_header581

polly.loop_exit583:                               ; preds = %polly.loop_exit590
  %polly.indvar_next578 = add nuw nsw i64 %polly.indvar577, 1
  %indvars.iv.next903 = add nsw i64 %indvars.iv902, -16
  %exitcond912.not = icmp eq i64 %polly.indvar_next578, 63
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  %indvars.iv896 = phi i64 [ %indvars.iv.next897, %polly.loop_exit590 ], [ %indvars.iv894, %polly.loop_header574 ]
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  ...
  %185 = add i64 %smax893, %indvars.iv896
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %exitcond911.not = icmp eq i64 %polly.indvar584, %178
  br i1 %exitcond911.not, label %polly.loop_exit583, label %polly.loop_header581

polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv898 = phi i64 [ %185, %polly.loop_header588.preheader ], [ %indvars.iv.next899, %polly.loop_exit597 ]
  %polly.indvar592 = phi i64 [ %184, %polly.loop_header588.preheader ], [ %polly.indvar_next593, %polly.loop_exit597 ]
  %smin900 = call i64 @llvm.smin.i64(i64 %indvars.iv898, i64 19)
  %187 = add nsw i64 %polly.indvar592, %186
  %polly.loop_guard605951 = icmp sgt i64 %187, -1
  %188 = add nuw nsw i64 %polly.indvar592, %177
  %189 = mul i64 %188, 8000
  %190 = mul i64 %188, 9600
  br i1 %polly.loop_guard605951, label %polly.loop_header595.us, label %polly.loop_exit597
...
polly.loop_header602.us:                          ; preds = %polly.loop_header595.us, %polly.loop_header602.us
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar606.us, %smin900
  br i1 %exitcond901.not, label %polly.loop_exit604.loopexit.us, label %polly.loop_header602.us

polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  %polly.indvar_next599.us = add nuw nsw i64 %polly.indvar598.us, 1
  %exitcond905.not = icmp eq i64 %polly.indvar598.us, %180
  br i1 %exitcond905.not, label %polly.loop_exit597, label %polly.loop_header595.us
...
polly.loop_header752:                             ; preds = %entry, %polly.loop_exit760
  %indvars.iv942 = phi i64 [ %indvars.iv.next943, %polly.loop_exit760 ], [ 0, %entry ]
...
polly.loop_exit760:                               ; preds = %polly.loop_exit766
  ...
  %exitcond947.not = icmp eq i64 %polly.indvar_next756, 38
  br i1 %exitcond947.not, label %polly.loop_header779, label %polly.loop_header752

polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  %indvars.iv938 = phi i64 [ %indvars.iv.next939, %polly.loop_exit766 ], [ 0, %polly.loop_header752 ]
  %polly.indvar761 = phi i64 [ %polly.indvar_next762, %polly.loop_exit766 ], [ 0, %polly.loop_header752 ]
  %201 = mul nsw i64 %polly.indvar761, -32
  %smin973 = call i64 @llvm.smin.i64(i64 %201, i64 -1168)
  %202 = add nsw i64 %smin973, 1200
  %smin940 = call i64 @llvm.smin.i64(i64 %indvars.iv938, i64 -1168)
  %203 = shl nsw i64 %polly.indvar761, 5
  %204 = add nsw i64 %smin940, 1199
...
polly.loop_exit766:                               ; preds = %polly.loop_exit772
  ...
  %exitcond946.not = icmp eq i64 %polly.indvar_next762, 38
  br i1 %exitcond946.not, label %polly.loop_exit760, label %polly.loop_header758
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  br i1 %min.iters.check, label %polly.loop_header770, label %vector.ph974

vector.ph974:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert981 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat982 = shufflevector <4 x i64> %broadcast.splatinsert981, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert983 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body972:                                   ; preds = %vector.body972, %vector.ph974
  %index975 = phi i64 [ 0, %vector.ph974 ], [ %index.next976, %vector.body972 ]
  %vec.ind979 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph974 ], [ %vec.ind.next980, %vector.body972 ]
  %208 = add nuw nsw <4 x i64> %vec.ind979, %broadcast.splat982
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat984, %209
  ...
  %220 = icmp eq i64 %index.next976, %202
  br i1 %220, label %polly.loop_exit772, label %vector.body972, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body972, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond945.not = icmp eq i64 %polly.indvar767, %200
  br i1 %exitcond945.not, label %polly.loop_exit766, label %polly.loop_header764
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond941.not = icmp eq i64 %polly.indvar773, %204
  br i1 %exitcond941.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !100

polly.loop_header779:                             ; preds = %polly.loop_exit760, %polly.loop_exit787
  %indvars.iv932 = phi i64 [ %indvars.iv.next933, %polly.loop_exit787 ], [ 0, %polly.loop_exit760 ]
...
polly.loop_exit787:                               ; preds = %polly.loop_exit793
  ...
  %exitcond937.not = icmp eq i64 %polly.indvar_next783, 38
  br i1 %exitcond937.not, label %polly.loop_header805, label %polly.loop_header779

polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  %indvars.iv928 = phi i64 [ %indvars.iv.next929, %polly.loop_exit793 ], [ 0, %polly.loop_header779 ]
  %polly.indvar788 = phi i64 [ %polly.indvar_next789, %polly.loop_exit793 ], [ 0, %polly.loop_header779 ]
  %230 = mul nsw i64 %polly.indvar788, -32
  %smin988 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin988, 1000
  %smin930 = call i64 @llvm.smin.i64(i64 %indvars.iv928, i64 -968)
  %232 = shl nsw i64 %polly.indvar788, 5
  %233 = add nsw i64 %smin930, 999
  br label %polly.loop_header791

polly.loop_exit793:                               ; preds = %polly.loop_exit799
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %indvars.iv.next929 = add nsw i64 %indvars.iv928, -32
  %exitcond936.not = icmp eq i64 %polly.indvar_next789, 32
  br i1 %exitcond936.not, label %polly.loop_exit787, label %polly.loop_header785
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %min.iters.check989 = icmp eq i64 %231, 0
  br i1 %min.iters.check989, label %polly.loop_header797, label %vector.ph990

vector.ph990:                                     ; preds = %polly.loop_header791
  %broadcast.splatinsert999 = insertelement <4 x i64> poison, i64 %232, i32 0
  %broadcast.splat1000 = shufflevector <4 x i64> %broadcast.splatinsert999, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1001 = insertelement <4 x i32> poison, i32 %235, i32 0
...
vector.body987:                                   ; preds = %vector.body987, %vector.ph990
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind997, %broadcast.splat1000
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat1002, %238
  ...
  %249 = icmp eq i64 %index.next994, %231
  br i1 %249, label %polly.loop_exit799, label %vector.body987, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body987, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond935.not = icmp eq i64 %polly.indvar794, %229
  br i1 %exitcond935.not, label %polly.loop_exit793, label %polly.loop_header791
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond931.not = icmp eq i64 %polly.indvar800, %233
  br i1 %exitcond931.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !103

polly.loop_header805:                             ; preds = %polly.loop_exit787, %polly.loop_exit813
  %indvars.iv922 = phi i64 [ %indvars.iv.next923, %polly.loop_exit813 ], [ 0, %polly.loop_exit787 ]
  ...
  %258 = add nsw i64 %smin924, 1199
  br label %polly.loop_header811

polly.loop_exit813:                               ; preds = %polly.loop_exit819
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %indvars.iv.next923 = add nsw i64 %indvars.iv922, -32
  %exitcond927.not = icmp eq i64 %polly.indvar_next809, 38
  br i1 %exitcond927.not, label %init_array.exit, label %polly.loop_header805

polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  %indvars.iv918 = phi i64 [ %indvars.iv.next919, %polly.loop_exit819 ], [ 0, %polly.loop_header805 ]
  %polly.indvar814 = phi i64 [ %polly.indvar_next815, %polly.loop_exit819 ], [ 0, %polly.loop_header805 ]
  %259 = mul nsw i64 %polly.indvar814, -32
  %smin1006 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin1006, 1000
  %smin920 = call i64 @llvm.smin.i64(i64 %indvars.iv918, i64 -968)
  %261 = shl nsw i64 %polly.indvar814, 5
  %262 = add nsw i64 %smin920, 999
  br label %polly.loop_header817

polly.loop_exit819:                               ; preds = %polly.loop_exit825
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %indvars.iv.next919 = add nsw i64 %indvars.iv918, -32
  %exitcond926.not = icmp eq i64 %polly.indvar_next815, 32
  br i1 %exitcond926.not, label %polly.loop_exit813, label %polly.loop_header811
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %min.iters.check1007 = icmp eq i64 %260, 0
  br i1 %min.iters.check1007, label %polly.loop_header823, label %vector.ph1008

vector.ph1008:                                    ; preds = %polly.loop_header817
  %broadcast.splatinsert1017 = insertelement <4 x i64> poison, i64 %261, i32 0
  %broadcast.splat1018 = shufflevector <4 x i64> %broadcast.splatinsert1017, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1019 = insertelement <4 x i32> poison, i32 %264, i32 0
...
vector.body1005:                                  ; preds = %vector.body1005, %vector.ph1008
  %index1011 = phi i64 [ 0, %vector.ph1008 ], [ %index.next1012, %vector.body1005 ]
  %vec.ind1015 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph1008 ], [ %vec.ind.next1016, %vector.body1005 ]
  %266 = add nuw nsw <4 x i64> %vec.ind1015, %broadcast.splat1018
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat1020, %267
  ...
  %278 = icmp eq i64 %index.next1012, %260
  br i1 %278, label %polly.loop_exit825, label %vector.body1005, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body1005, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond925.not = icmp eq i64 %polly.indvar820, %258
  br i1 %exitcond925.not, label %polly.loop_exit819, label %polly.loop_header817
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond921.not = icmp eq i64 %polly.indvar826, %262
  br i1 %exitcond921.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !106
}
