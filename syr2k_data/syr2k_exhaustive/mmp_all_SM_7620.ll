; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7620.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7620.c"
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph929
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv7.i, i64 %index930
...
vector.body991:                                   ; preds = %vector.body991, %vector.ph993
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i, i64 %index996
...
vector.body1014:                                  ; preds = %vector.body1014, %vector.ph1016
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i52, i64 %index1019
...
vector.body1040:                                  ; preds = %vector.body1040, %vector.ph1042
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call772, i64 %indvars.iv21.i91, i64 %index1045
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %97 = trunc i64 %polly.indvar218 to i8
  %pexp.p_div_q.lhs.trunc = add i8 %97, 6
  %pexp.p_div_q828 = udiv i8 %pexp.p_div_q.lhs.trunc, 5
  %pexp.p_div_q.zext = zext i8 %pexp.p_div_q828 to i64
  %98 = sub nsw i64 %polly.indvar218, %pexp.p_div_q.zext
...
polly.loop_exit223:                               ; preds = %polly.loop_exit230, %polly.loop_header215
  ...
  %exitcond843.not = icmp eq i64 %polly.indvar_next219, 15
...
polly.loop_header221:                             ; preds = %polly.loop_header221.preheader, %polly.loop_exit230
  %indvars.iv838 = phi i64 [ %indvars.iv836, %polly.loop_header221.preheader ], [ %indvars.iv.next839, %polly.loop_exit230 ]
  %indvars.iv834 = phi i64 [ %indvars.iv, %polly.loop_header221.preheader ], [ %indvars.iv.next835, %polly.loop_exit230 ]
  %polly.indvar224 = phi i64 [ 0, %polly.loop_header221.preheader ], [ %polly.indvar_next225, %polly.loop_exit230 ]
  %101 = mul nuw nsw i64 %polly.indvar224, 100
  %102 = add nsw i64 %101, %99
  %103 = icmp sgt i64 %102, 0
  %104 = select i1 %103, i64 %102, i64 0
  %polly.loop_guard231 = icmp slt i64 %104, 80
...
polly.loop_header228.preheader:                   ; preds = %polly.loop_header221
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv834, i64 0)
  %105 = add i64 %smax, %indvars.iv838
  %106 = sub nsw i64 %100, %101
  br label %polly.loop_header228

polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header221
  %polly.indvar_next225 = add nuw nsw i64 %polly.indvar224, 1
  %polly.loop_cond226.not = icmp sgt i64 %polly.indvar224, %98
  %indvars.iv.next835 = add nsw i64 %indvars.iv834, 100
  %indvars.iv.next839 = add nsw i64 %indvars.iv838, -100
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  %indvars.iv840 = phi i64 [ %105, %polly.loop_header228.preheader ], [ %indvars.iv.next841, %polly.loop_exit237 ]
  %polly.indvar232 = phi i64 [ %104, %polly.loop_header228.preheader ], [ %polly.indvar_next233, %polly.loop_exit237 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv840, i64 99)
  %107 = add nsw i64 %polly.indvar232, %106
  %polly.loop_guard245917 = icmp sgt i64 %107, -1
  %108 = add nuw nsw i64 %polly.indvar232, %100
  %109 = mul i64 %108, 8000
  %110 = mul i64 %108, 9600
  br i1 %polly.loop_guard245917, label %polly.loop_header235.us, label %polly.loop_exit237
...
polly.loop_header235.us:                          ; preds = %polly.loop_header228, %polly.loop_exit244.loopexit.us
  ...
  %111 = shl nuw nsw i64 %polly.indvar238.us, 3
  %scevgep249.us = getelementptr i8, i8* %call1, i64 %111
  %polly.access.mul.Packed_MemRef_call2253.us = mul nuw nsw i64 %polly.indvar238.us, 1200
  %polly.access.add.Packed_MemRef_call2254.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2253.us, %108
  ...
  %scevgep262.us = getelementptr i8, i8* %scevgep249.us, i64 %109
...
polly.loop_header242.us:                          ; preds = %polly.loop_header242.us, %polly.loop_header235.us
  ...
  %112 = add nuw nsw i64 %polly.indvar246.us, %101
  %113 = mul nuw nsw i64 %112, 8000
  %scevgep250.us = getelementptr i8, i8* %scevgep249.us, i64 %113
  ...
  %polly.access.add.Packed_MemRef_call2258.us = add nuw nsw i64 %112, %polly.access.mul.Packed_MemRef_call2253.us
...
polly.loop_exit244.loopexit.us:                   ; preds = %polly.loop_header242.us
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next239.us, 1000
  br i1 %exitcond842.not, label %polly.loop_exit237, label %polly.loop_header235.us
...
polly.loop_header356:                             ; preds = %polly.loop_exit364, %polly.start270
  %indvar1027 = phi i64 [ %indvar.next1028, %polly.loop_exit364 ], [ 0, %polly.start270 ]
  %polly.indvar359 = phi i64 [ %polly.indvar_next360, %polly.loop_exit364 ], [ 1, %polly.start270 ]
  %116 = add i64 %indvar1027, 1
  %117 = mul nuw nsw i64 %polly.indvar359, 9600
  %scevgep368 = getelementptr i8, i8* %call, i64 %117
  %min.iters.check1029 = icmp ult i64 %116, 4
  br i1 %min.iters.check1029, label %polly.loop_header362.preheader, label %vector.ph1030

vector.ph1030:                                    ; preds = %polly.loop_header356
  %n.vec1032 = and i64 %116, -4
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1030
  ...
  %118 = shl nuw nsw i64 %index1033, 3
  %119 = getelementptr i8, i8* %scevgep368, i64 %118
  %120 = bitcast i8* %119 to <4 x double>*
  %wide.load1037 = load <4 x double>, <4 x double>* %120, align 8, !alias.scope !74, !noalias !76
  %121 = fmul fast <4 x double> %wide.load1037, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %123 = icmp eq i64 %index.next1034, %n.vec1032
  br i1 %123, label %middle.block1024, label %vector.body1026, !llvm.loop !80

middle.block1024:                                 ; preds = %vector.body1026
  %cmp.n1036 = icmp eq i64 %116, %n.vec1032
  br i1 %cmp.n1036, label %polly.loop_exit364, label %polly.loop_header362.preheader

polly.loop_header362.preheader:                   ; preds = %polly.loop_header356, %middle.block1024
  %polly.indvar365.ph = phi i64 [ 0, %polly.loop_header356 ], [ %n.vec1032, %middle.block1024 ]
  br label %polly.loop_header362

polly.loop_exit364:                               ; preds = %polly.loop_header362, %middle.block1024
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit398
  ...
  %125 = trunc i64 %polly.indvar391 to i8
  %pexp.p_div_q394.lhs.trunc = add i8 %125, 6
  %pexp.p_div_q394827 = udiv i8 %pexp.p_div_q394.lhs.trunc, 5
  %pexp.p_div_q394.zext = zext i8 %pexp.p_div_q394827 to i64
  %126 = sub nsw i64 %polly.indvar391, %pexp.p_div_q394.zext
  %polly.loop_guard399 = icmp sgt i64 %126, -2
...
polly.loop_header396.preheader:                   ; preds = %polly.loop_header388
  %127 = mul nsw i64 %polly.indvar391, -80
  %128 = mul nuw nsw i64 %polly.indvar391, 80
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit406, %polly.loop_header388
  %polly.indvar_next392 = add nuw nsw i64 %polly.indvar391, 1
  %indvars.iv.next849 = add nsw i64 %indvars.iv848, -80
  %indvars.iv.next854 = add nuw nsw i64 %indvars.iv853, 80
  %exitcond862.not = icmp eq i64 %polly.indvar_next392, 15
...
polly.loop_header396:                             ; preds = %polly.loop_header396.preheader, %polly.loop_exit406
  ...
  %129 = mul nuw nsw i64 %polly.indvar400, 100
  %130 = add nsw i64 %129, %127
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %polly.loop_guard407 = icmp slt i64 %132, 80
...
polly.loop_header404.preheader:                   ; preds = %polly.loop_header396
  ...
  %133 = add i64 %smax852, %indvars.iv855
...
polly.loop_exit406:                               ; preds = %polly.loop_exit413, %polly.loop_header396
  ...
  %polly.loop_cond402.not = icmp sgt i64 %polly.indvar400, %126
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit413
  %indvars.iv857 = phi i64 [ %133, %polly.loop_header404.preheader ], [ %indvars.iv.next858, %polly.loop_exit413 ]
  %polly.indvar408 = phi i64 [ %132, %polly.loop_header404.preheader ], [ %polly.indvar_next409, %polly.loop_exit413 ]
  %smin859 = call i64 @llvm.smin.i64(i64 %indvars.iv857, i64 99)
  %135 = add nsw i64 %polly.indvar408, %134
  %polly.loop_guard421918 = icmp sgt i64 %135, -1
  %136 = add nuw nsw i64 %polly.indvar408, %128
  %137 = mul i64 %136, 8000
  %138 = mul i64 %136, 9600
  br i1 %polly.loop_guard421918, label %polly.loop_header411.us, label %polly.loop_exit413
...
polly.loop_header411.us:                          ; preds = %polly.loop_header404, %polly.loop_exit420.loopexit.us
  ...
  %139 = shl nuw nsw i64 %polly.indvar414.us, 3
  %scevgep425.us = getelementptr i8, i8* %call1, i64 %139
  %polly.access.mul.Packed_MemRef_call2273429.us = mul nuw nsw i64 %polly.indvar414.us, 1200
  %polly.access.add.Packed_MemRef_call2273430.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2273429.us, %136
  ...
  %scevgep438.us = getelementptr i8, i8* %scevgep425.us, i64 %137
...
polly.loop_header418.us:                          ; preds = %polly.loop_header418.us, %polly.loop_header411.us
  ...
  %140 = add nuw nsw i64 %polly.indvar422.us, %129
  %141 = mul nuw nsw i64 %140, 8000
  %scevgep426.us = getelementptr i8, i8* %scevgep425.us, i64 %141
  ...
  %polly.access.add.Packed_MemRef_call2273434.us = add nuw nsw i64 %140, %polly.access.mul.Packed_MemRef_call2273429.us
...
polly.loop_header532:                             ; preds = %polly.loop_exit540, %polly.start446
  ...
  %min.iters.check1003 = icmp ult i64 %144, 4
  br i1 %min.iters.check1003, label %polly.loop_header538.preheader, label %vector.ph1004

vector.ph1004:                                    ; preds = %polly.loop_header532
  %n.vec1006 = and i64 %144, -4
...
vector.body1002:                                  ; preds = %vector.body1002, %vector.ph1004
  ...
  %146 = shl nuw nsw i64 %index1007, 3
  %147 = getelementptr i8, i8* %scevgep544, i64 %146
  %148 = bitcast i8* %147 to <4 x double>*
  %wide.load1011 = load <4 x double>, <4 x double>* %148, align 8, !alias.scope !84, !noalias !86
  %149 = fmul fast <4 x double> %wide.load1011, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %151 = icmp eq i64 %index.next1008, %n.vec1006
  br i1 %151, label %middle.block1000, label %vector.body1002, !llvm.loop !90

middle.block1000:                                 ; preds = %vector.body1002
  %cmp.n1010 = icmp eq i64 %144, %n.vec1006
  br i1 %cmp.n1010, label %polly.loop_exit540, label %polly.loop_header538.preheader

polly.loop_header538.preheader:                   ; preds = %polly.loop_header532, %middle.block1000
  %polly.indvar541.ph = phi i64 [ 0, %polly.loop_header532 ], [ %n.vec1006, %middle.block1000 ]
  br label %polly.loop_header538

polly.loop_exit540:                               ; preds = %polly.loop_header538, %middle.block1000
  %polly.indvar_next536 = add nuw nsw i64 %polly.indvar535, 1
  %exitcond885.not = icmp eq i64 %polly.indvar_next536, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond885.not, label %polly.loop_header548.preheader, label %polly.loop_header532
...
polly.loop_header538:                             ; preds = %polly.loop_header538.preheader, %polly.loop_header538
  ...
  %exitcond884.not = icmp eq i64 %polly.indvar_next542, %polly.indvar535
  br i1 %exitcond884.not, label %polly.loop_exit540, label %polly.loop_header538, !llvm.loop !91
...
polly.loop_exit556:                               ; preds = %polly.loop_header554
  ...
  %exitcond883.not = icmp eq i64 %polly.indvar_next552, 1000
  br i1 %exitcond883.not, label %polly.loop_header564, label %polly.loop_header548
...
polly.loop_header554:                             ; preds = %polly.loop_header554, %polly.loop_header548
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next558, 1200
  br i1 %exitcond882.not, label %polly.loop_exit556, label %polly.loop_header554

polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit574
  %indvars.iv872 = phi i64 [ %indvars.iv.next873, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %indvars.iv867 = phi i64 [ %indvars.iv.next868, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %polly.indvar567 = phi i64 [ %polly.indvar_next568, %polly.loop_exit574 ], [ 0, %polly.loop_exit556 ]
  %153 = trunc i64 %polly.indvar567 to i8
  %pexp.p_div_q570.lhs.trunc = add i8 %153, 6
  %pexp.p_div_q570826 = udiv i8 %pexp.p_div_q570.lhs.trunc, 5
  %pexp.p_div_q570.zext = zext i8 %pexp.p_div_q570826 to i64
  %154 = sub nsw i64 %polly.indvar567, %pexp.p_div_q570.zext
  %polly.loop_guard575 = icmp sgt i64 %154, -2
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header564
  %155 = mul nsw i64 %polly.indvar567, -80
  %156 = mul nuw nsw i64 %polly.indvar567, 80
...
polly.loop_exit574:                               ; preds = %polly.loop_exit582, %polly.loop_header564
  ...
  %indvars.iv.next868 = add nsw i64 %indvars.iv867, -80
  %indvars.iv.next873 = add nuw nsw i64 %indvars.iv872, 80
  %exitcond881.not = icmp eq i64 %polly.indvar_next568, 15
  br i1 %exitcond881.not, label %polly.exiting447, label %polly.loop_header564

polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit582
  %indvars.iv874 = phi i64 [ %indvars.iv872, %polly.loop_header572.preheader ], [ %indvars.iv.next875, %polly.loop_exit582 ]
  %indvars.iv869 = phi i64 [ %indvars.iv867, %polly.loop_header572.preheader ], [ %indvars.iv.next870, %polly.loop_exit582 ]
  %polly.indvar576 = phi i64 [ 0, %polly.loop_header572.preheader ], [ %polly.indvar_next577, %polly.loop_exit582 ]
  %157 = mul nuw nsw i64 %polly.indvar576, 100
  %158 = add nsw i64 %157, %155
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard583 = icmp slt i64 %160, 80
...
polly.loop_header580.preheader:                   ; preds = %polly.loop_header572
  ...
  %161 = add i64 %smax871, %indvars.iv874
...
polly.loop_exit582:                               ; preds = %polly.loop_exit589, %polly.loop_header572
  ...
  %polly.loop_cond578.not = icmp sgt i64 %polly.indvar576, %154
  %indvars.iv.next870 = add nsw i64 %indvars.iv869, 100
  %indvars.iv.next875 = add nsw i64 %indvars.iv874, -100
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_exit589
  %indvars.iv876 = phi i64 [ %161, %polly.loop_header580.preheader ], [ %indvars.iv.next877, %polly.loop_exit589 ]
  %polly.indvar584 = phi i64 [ %160, %polly.loop_header580.preheader ], [ %polly.indvar_next585, %polly.loop_exit589 ]
  %smin878 = call i64 @llvm.smin.i64(i64 %indvars.iv876, i64 99)
  %163 = add nsw i64 %polly.indvar584, %162
  %polly.loop_guard597919 = icmp sgt i64 %163, -1
  %164 = add nuw nsw i64 %polly.indvar584, %156
  %165 = mul i64 %164, 8000
  %166 = mul i64 %164, 9600
  br i1 %polly.loop_guard597919, label %polly.loop_header587.us, label %polly.loop_exit589
...
polly.loop_header587.us:                          ; preds = %polly.loop_header580, %polly.loop_exit596.loopexit.us
  ...
  %167 = shl nuw nsw i64 %polly.indvar590.us, 3
  %scevgep601.us = getelementptr i8, i8* %call1, i64 %167
  %polly.access.mul.Packed_MemRef_call2449605.us = mul nuw nsw i64 %polly.indvar590.us, 1200
  %polly.access.add.Packed_MemRef_call2449606.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2449605.us, %164
  ...
  %scevgep614.us = getelementptr i8, i8* %scevgep601.us, i64 %165
...
polly.loop_header594.us:                          ; preds = %polly.loop_header594.us, %polly.loop_header587.us
  ...
  %168 = add nuw nsw i64 %polly.indvar598.us, %157
  %169 = mul nuw nsw i64 %168, 8000
  %scevgep602.us = getelementptr i8, i8* %scevgep601.us, i64 %169
  ...
  %polly.access.add.Packed_MemRef_call2449610.us = add nuw nsw i64 %168, %polly.access.mul.Packed_MemRef_call2449605.us
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar598.us, %smin878
  br i1 %exitcond879.not, label %polly.loop_exit596.loopexit.us, label %polly.loop_header594.us

polly.loop_exit596.loopexit.us:                   ; preds = %polly.loop_header594.us
  %polly.indvar_next591.us = add nuw nsw i64 %polly.indvar590.us, 1
  %exitcond880.not = icmp eq i64 %polly.indvar_next591.us, 1000
...
polly.loop_header746:                             ; preds = %entry, %polly.loop_exit754
  %indvars.iv910 = phi i64 [ %indvars.iv.next911, %polly.loop_exit754 ], [ 0, %entry ]
...
polly.loop_exit754:                               ; preds = %polly.loop_exit760
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar_next750, 38
  br i1 %exitcond915.not, label %polly.loop_header773, label %polly.loop_header746

polly.loop_header752:                             ; preds = %polly.loop_exit760, %polly.loop_header746
  %indvars.iv906 = phi i64 [ %indvars.iv.next907, %polly.loop_exit760 ], [ 0, %polly.loop_header746 ]
  %polly.indvar755 = phi i64 [ %polly.indvar_next756, %polly.loop_exit760 ], [ 0, %polly.loop_header746 ]
  %174 = mul nsw i64 %polly.indvar755, -32
  %smin941 = call i64 @llvm.smin.i64(i64 %174, i64 -1168)
  %175 = add nsw i64 %smin941, 1200
  %smin908 = call i64 @llvm.smin.i64(i64 %indvars.iv906, i64 -1168)
  %176 = shl nsw i64 %polly.indvar755, 5
  %177 = add nsw i64 %smin908, 1199
...
polly.loop_exit760:                               ; preds = %polly.loop_exit766
  ...
  %exitcond914.not = icmp eq i64 %polly.indvar_next756, 38
  br i1 %exitcond914.not, label %polly.loop_exit754, label %polly.loop_header752
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  br i1 %min.iters.check, label %polly.loop_header764, label %vector.ph942

vector.ph942:                                     ; preds = %polly.loop_header758
  %broadcast.splatinsert949 = insertelement <4 x i64> poison, i64 %176, i32 0
  %broadcast.splat950 = shufflevector <4 x i64> %broadcast.splatinsert949, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert951 = insertelement <4 x i32> poison, i32 %179, i32 0
...
vector.body940:                                   ; preds = %vector.body940, %vector.ph942
  ...
  %181 = add nuw nsw <4 x i64> %vec.ind947, %broadcast.splat950
  %182 = trunc <4 x i64> %181 to <4 x i32>
  %183 = mul <4 x i32> %broadcast.splat952, %182
  ...
  %193 = icmp eq i64 %index.next944, %175
  br i1 %193, label %polly.loop_exit766, label %vector.body940, !llvm.loop !99

polly.loop_exit766:                               ; preds = %vector.body940, %polly.loop_header764
  %polly.indvar_next762 = add nuw nsw i64 %polly.indvar761, 1
  %exitcond913.not = icmp eq i64 %polly.indvar761, %173
  br i1 %exitcond913.not, label %polly.loop_exit760, label %polly.loop_header758
...
polly.loop_header764:                             ; preds = %polly.loop_header758, %polly.loop_header764
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar767, %177
  br i1 %exitcond909.not, label %polly.loop_exit766, label %polly.loop_header764, !llvm.loop !100

polly.loop_header773:                             ; preds = %polly.loop_exit754, %polly.loop_exit781
  %indvars.iv900 = phi i64 [ %indvars.iv.next901, %polly.loop_exit781 ], [ 0, %polly.loop_exit754 ]
...
polly.loop_exit781:                               ; preds = %polly.loop_exit787
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next777, 38
  br i1 %exitcond905.not, label %polly.loop_header799, label %polly.loop_header773

polly.loop_header779:                             ; preds = %polly.loop_exit787, %polly.loop_header773
  %indvars.iv896 = phi i64 [ %indvars.iv.next897, %polly.loop_exit787 ], [ 0, %polly.loop_header773 ]
  %polly.indvar782 = phi i64 [ %polly.indvar_next783, %polly.loop_exit787 ], [ 0, %polly.loop_header773 ]
  %203 = mul nsw i64 %polly.indvar782, -32
  %smin956 = call i64 @llvm.smin.i64(i64 %203, i64 -968)
  %204 = add nsw i64 %smin956, 1000
  %smin898 = call i64 @llvm.smin.i64(i64 %indvars.iv896, i64 -968)
  %205 = shl nsw i64 %polly.indvar782, 5
  %206 = add nsw i64 %smin898, 999
...
polly.loop_exit787:                               ; preds = %polly.loop_exit793
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar_next783, 32
  br i1 %exitcond904.not, label %polly.loop_exit781, label %polly.loop_header779
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %min.iters.check957 = icmp eq i64 %204, 0
  br i1 %min.iters.check957, label %polly.loop_header791, label %vector.ph958

vector.ph958:                                     ; preds = %polly.loop_header785
  %broadcast.splatinsert967 = insertelement <4 x i64> poison, i64 %205, i32 0
  %broadcast.splat968 = shufflevector <4 x i64> %broadcast.splatinsert967, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert969 = insertelement <4 x i32> poison, i32 %208, i32 0
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph958
  ...
  %210 = add nuw nsw <4 x i64> %vec.ind965, %broadcast.splat968
  %211 = trunc <4 x i64> %210 to <4 x i32>
  %212 = mul <4 x i32> %broadcast.splat970, %211
  ...
  %222 = icmp eq i64 %index.next962, %204
  br i1 %222, label %polly.loop_exit793, label %vector.body955, !llvm.loop !102

polly.loop_exit793:                               ; preds = %vector.body955, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond903.not = icmp eq i64 %polly.indvar788, %202
  br i1 %exitcond903.not, label %polly.loop_exit787, label %polly.loop_header785
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar794, %206
  br i1 %exitcond899.not, label %polly.loop_exit793, label %polly.loop_header791, !llvm.loop !103

polly.loop_header799:                             ; preds = %polly.loop_exit781, %polly.loop_exit807
  %indvars.iv890 = phi i64 [ %indvars.iv.next891, %polly.loop_exit807 ], [ 0, %polly.loop_exit781 ]
...
polly.loop_exit807:                               ; preds = %polly.loop_exit813
  ...
  %exitcond895.not = icmp eq i64 %polly.indvar_next803, 38
  br i1 %exitcond895.not, label %init_array.exit, label %polly.loop_header799

polly.loop_header805:                             ; preds = %polly.loop_exit813, %polly.loop_header799
  %indvars.iv886 = phi i64 [ %indvars.iv.next887, %polly.loop_exit813 ], [ 0, %polly.loop_header799 ]
  %polly.indvar808 = phi i64 [ %polly.indvar_next809, %polly.loop_exit813 ], [ 0, %polly.loop_header799 ]
  %232 = mul nsw i64 %polly.indvar808, -32
  %smin974 = call i64 @llvm.smin.i64(i64 %232, i64 -968)
  %233 = add nsw i64 %smin974, 1000
  %smin888 = call i64 @llvm.smin.i64(i64 %indvars.iv886, i64 -968)
  %234 = shl nsw i64 %polly.indvar808, 5
  %235 = add nsw i64 %smin888, 999
  br label %polly.loop_header811

polly.loop_exit813:                               ; preds = %polly.loop_exit819
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, -32
  %exitcond894.not = icmp eq i64 %polly.indvar_next809, 32
  br i1 %exitcond894.not, label %polly.loop_exit807, label %polly.loop_header805
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %min.iters.check975 = icmp eq i64 %233, 0
  br i1 %min.iters.check975, label %polly.loop_header817, label %vector.ph976

vector.ph976:                                     ; preds = %polly.loop_header811
  %broadcast.splatinsert985 = insertelement <4 x i64> poison, i64 %234, i32 0
  %broadcast.splat986 = shufflevector <4 x i64> %broadcast.splatinsert985, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert987 = insertelement <4 x i32> poison, i32 %237, i32 0
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph976
  ...
  %239 = add nuw nsw <4 x i64> %vec.ind983, %broadcast.splat986
  %240 = trunc <4 x i64> %239 to <4 x i32>
  %241 = mul <4 x i32> %broadcast.splat988, %240
  ...
  %251 = icmp eq i64 %index.next980, %233
  br i1 %251, label %polly.loop_exit819, label %vector.body973, !llvm.loop !105

polly.loop_exit819:                               ; preds = %vector.body973, %polly.loop_header817
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %exitcond893.not = icmp eq i64 %polly.indvar814, %231
  br i1 %exitcond893.not, label %polly.loop_exit813, label %polly.loop_header811
...
polly.loop_header817:                             ; preds = %polly.loop_header811, %polly.loop_header817
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar820, %235
  br i1 %exitcond889.not, label %polly.loop_exit819, label %polly.loop_header817, !llvm.loop !106
}
