; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1008.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1008.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %99 = add nuw i64 %polly.indvar209, 5
  %100 = udiv i64 %99, 6
  %101 = mul nuw nsw i64 %100, 96
  %102 = add i64 %98, %101
  %103 = shl nuw nsw i64 %polly.indvar209, 4
  %104 = sub nsw i64 %103, %101
  %105 = udiv i64 %indvars.iv1100, 6
  %106 = mul nuw nsw i64 %105, 96
  %107 = add i64 %indvars.iv1098, %106
  %108 = sub nsw i64 %indvars.iv1104, %106
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %112 = add nuw nsw i64 %polly.indvar209, 5
  %pexp.p_div_q = udiv i64 %112, 6
  %113 = sub nsw i64 %polly.indvar209, %pexp.p_div_q
  %polly.loop_guard = icmp slt i64 %113, 13
...
polly.loop_header218:                             ; preds = %polly.loop_header218, %polly.loop_header212
  ...
  %115 = add nuw nsw i64 %polly.indvar221, %110
...
polly.loop_header253:                             ; preds = %polly.loop_header234, %polly.loop_header253
  ...
  %142 = add nuw nsw i64 %polly.indvar257, %110
...
polly.loop_header274:                             ; preds = %polly.loop_header267, %polly.loop_exit284
  ...
  %smin1419 = call i64 @llvm.smin.i64(i64 %143, i64 79)
...
vector.body1413:                                  ; preds = %vector.body1413, %vector.ph1421
  ...
  %148 = add nuw nsw i64 %index1424, %110
...
polly.loop_header282:                             ; preds = %polly.loop_header282.preheader1435, %polly.loop_header282
  ...
  %165 = add nuw nsw i64 %polly.indvar286, %110
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit422
  ...
  %177 = mul nuw nsw i64 %polly.indvar417, 20
...
polly.loop_header420:                             ; preds = %polly.loop_exit446, %polly.loop_header414
  ...
  %178 = mul nsw i64 %polly.indvar423, -16
  %179 = add nuw i64 %polly.indvar423, 5
  %180 = udiv i64 %179, 6
  %181 = mul nuw nsw i64 %180, 96
  %182 = add i64 %178, %181
  %183 = shl nuw nsw i64 %polly.indvar423, 4
  %184 = sub nsw i64 %183, %181
  %185 = udiv i64 %indvars.iv1125, 6
  %186 = mul nuw nsw i64 %185, 96
  %187 = add i64 %indvars.iv1123, %186
  %188 = sub nsw i64 %indvars.iv1130, %186
  %189 = mul nsw i64 %polly.indvar423, -80
  %190 = mul nuw nsw i64 %polly.indvar423, 80
  br label %polly.loop_header426

polly.loop_exit428:                               ; preds = %polly.loop_exit434
  %191 = add nsw i64 %189, 1199
  %192 = add nuw nsw i64 %polly.indvar423, 5
  %pexp.p_div_q442 = udiv i64 %192, 6
  %193 = sub nsw i64 %polly.indvar423, %pexp.p_div_q442
  %polly.loop_guard447 = icmp slt i64 %193, 13
...
polly.loop_header432:                             ; preds = %polly.loop_header432, %polly.loop_header426
  ...
  %195 = add nuw nsw i64 %polly.indvar435, %190
...
polly.loop_header458.us:                          ; preds = %polly.loop_header451.us, %polly.loop_header458.us
  ...
  %212 = add nuw nsw i64 %polly.indvar462.us, %190
...
polly.loop_header470.us:                          ; preds = %polly.loop_exit460.loopexit.us, %polly.loop_header470.us
  ...
  %213 = add nuw nsw i64 %polly.indvar474.us, %190
...
polly.loop_header484.preheader:                   ; preds = %polly.loop_exit472, %polly.loop_exit472.us, %polly.loop_header444.split
  %215 = sub nsw i64 %190, %202
  %216 = icmp sgt i64 %215, 0
  %217 = select i1 %216, i64 %215, i64 0
  %218 = mul nsw i64 %polly.indvar448, -96
...
polly.loop_header470:                             ; preds = %polly.loop_header451, %polly.loop_header470
  ...
  %222 = add nuw nsw i64 %polly.indvar474, %190
...
polly.loop_header491:                             ; preds = %polly.loop_header484, %polly.loop_exit501
  ...
  %smin1369 = call i64 @llvm.smin.i64(i64 %223, i64 79)
...
vector.body1363:                                  ; preds = %vector.body1363, %vector.ph1371
  ...
  %228 = add nuw nsw i64 %index1374, %190
...
polly.loop_header499:                             ; preds = %polly.loop_header499.preheader1439, %polly.loop_header499
  ...
  %245 = add nuw nsw i64 %polly.indvar503, %190
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %258 = mul nsw i64 %polly.indvar640, -16
  %259 = add nuw i64 %polly.indvar640, 5
  %260 = udiv i64 %259, 6
  %261 = mul nuw nsw i64 %260, 96
  %262 = add i64 %258, %261
  %263 = shl nuw nsw i64 %polly.indvar640, 4
  %264 = sub nsw i64 %263, %261
  %265 = udiv i64 %indvars.iv1152, 6
  %266 = mul nuw nsw i64 %265, 96
  %267 = add i64 %indvars.iv1150, %266
  %268 = sub nsw i64 %indvars.iv1157, %266
  %269 = mul nsw i64 %polly.indvar640, -80
  %270 = mul nuw nsw i64 %polly.indvar640, 80
  br label %polly.loop_header643

polly.loop_exit645:                               ; preds = %polly.loop_exit651
  %271 = add nsw i64 %269, 1199
  %272 = add nuw nsw i64 %polly.indvar640, 5
  %pexp.p_div_q659 = udiv i64 %272, 6
  %273 = sub nsw i64 %polly.indvar640, %pexp.p_div_q659
  %polly.loop_guard664 = icmp slt i64 %273, 13
...
polly.loop_header649:                             ; preds = %polly.loop_header649, %polly.loop_header643
  ...
  %275 = add nuw nsw i64 %polly.indvar652, %270
...
polly.loop_header675.us:                          ; preds = %polly.loop_header668.us, %polly.loop_header675.us
  ...
  %292 = add nuw nsw i64 %polly.indvar679.us, %270
...
polly.loop_header687.us:                          ; preds = %polly.loop_exit677.loopexit.us, %polly.loop_header687.us
  ...
  %293 = add nuw nsw i64 %polly.indvar691.us, %270
...
polly.loop_header701.preheader:                   ; preds = %polly.loop_exit689, %polly.loop_exit689.us, %polly.loop_header661.split
  %295 = sub nsw i64 %270, %282
  %296 = icmp sgt i64 %295, 0
  %297 = select i1 %296, i64 %295, i64 0
  %298 = mul nsw i64 %polly.indvar665, -96
...
polly.loop_header687:                             ; preds = %polly.loop_header668, %polly.loop_header687
  ...
  %302 = add nuw nsw i64 %polly.indvar691, %270
...
polly.loop_header708:                             ; preds = %polly.loop_header701, %polly.loop_exit718
  ...
  %smin1319 = call i64 @llvm.smin.i64(i64 %303, i64 79)
...
vector.body1313:                                  ; preds = %vector.body1313, %vector.ph1321
  ...
  %308 = add nuw nsw i64 %index1324, %270
...
polly.loop_header716:                             ; preds = %polly.loop_header716.preheader1443, %polly.loop_header716
  ...
  %325 = add nuw nsw i64 %polly.indvar720, %270
