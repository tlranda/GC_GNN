; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9170.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9170.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next209, 10
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %indvars.iv.next804 = add nuw nsw i64 %indvars.iv803, 128
  %indvars.iv.next806 = add nuw nsw i64 %indvars.iv805, 7
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %144 = mul nuw nsw i64 %polly.indvar370, 100
  %145 = sub nsw i64 %141, %144
  %146 = icmp sgt i64 %145, 0
  %147 = select i1 %146, i64 %145, i64 0
  %polly.loop_guard383 = icmp slt i64 %147, 100
...
polly.loop_header380.us:                          ; preds = %polly.loop_header373.us, %polly.loop_exit390.us
  ...
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 127)
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next824 = add nuw nsw i64 %indvars.iv823, 128
  %indvars.iv.next826 = add nuw nsw i64 %indvars.iv825, 7
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  ...
  %180 = mul nuw nsw i64 %polly.indvar528, 100
  %181 = sub nsw i64 %177, %180
  %182 = icmp sgt i64 %181, 0
  %183 = select i1 %182, i64 %181, i64 0
  %polly.loop_guard541 = icmp slt i64 %183, 100
