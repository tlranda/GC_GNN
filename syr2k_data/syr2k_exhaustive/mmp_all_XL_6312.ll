; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6312.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6312.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit219.7
  %indvars.iv860 = phi i64 [ %indvars.iv.next861, %polly.loop_exit235 ], [ %109, %polly.loop_exit219.7 ]
  %indvars.iv856 = phi i64 [ %indvars.iv.next857, %polly.loop_exit235 ], [ %108, %polly.loop_exit219.7 ]
  %polly.indvar230 = phi i64 [ %polly.indvar_next231, %polly.loop_exit235 ], [ %106, %polly.loop_exit219.7 ]
...
polly.loop_header239:                             ; preds = %polly.loop_header233, %polly.loop_exit248
  %indvars.iv862 = phi i64 [ %112, %polly.loop_header233 ], [ %indvars.iv.next863, %polly.loop_exit248 ]
  ...
  %124 = add i64 %123, %317
  %polly.loop_guard249945 = icmp sgt i64 %124, -1
...
vector.body1054:                                  ; preds = %vector.body1054, %vector.ph1058
  ...
  %135 = shl nuw nsw i64 %index1061, 3
  %136 = getelementptr i8, i8* %scevgep370, i64 %135
  %137 = bitcast i8* %136 to <4 x double>*
  %wide.load1065 = load <4 x double>, <4 x double>* %137, align 8, !alias.scope !79, !noalias !81
  %138 = fmul fast <4 x double> %wide.load1065, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %140 = icmp eq i64 %index.next1062, %n.vec1060
  br i1 %140, label %middle.block1052, label %vector.body1054, !llvm.loop !85

middle.block1052:                                 ; preds = %vector.body1054
  %cmp.n1064 = icmp eq i64 %133, %n.vec1060
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %150 = udiv i64 %polly.indvar383, 3
  %151 = add nuw i64 %polly.indvar383, %150
  %152 = mul nuw nsw i64 %151, 96
  %153 = sub i64 %indvars.iv874, %152
  %154 = add i64 %indvars.iv879, %152
  %155 = shl nsw i64 %polly.indvar383, 7
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit394.7
  %indvars.iv881 = phi i64 [ %indvars.iv.next882, %polly.loop_exit411 ], [ %154, %polly.loop_exit394.7 ]
  %indvars.iv876 = phi i64 [ %indvars.iv.next877, %polly.loop_exit411 ], [ %153, %polly.loop_exit394.7 ]
  %polly.indvar406 = phi i64 [ %polly.indvar_next407, %polly.loop_exit411 ], [ %151, %polly.loop_exit394.7 ]
  %smax878 = call i64 @llvm.smax.i64(i64 %indvars.iv876, i64 0)
  %157 = add i64 %smax878, %indvars.iv881
  %158 = mul nuw nsw i64 %polly.indvar406, 96
  %159 = sub nsw i64 %155, %158
  %160 = icmp sgt i64 %159, 0
  %161 = select i1 %160, i64 %159, i64 0
  %162 = mul nsw i64 %polly.indvar406, -96
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  %indvars.iv883 = phi i64 [ %157, %polly.loop_header409 ], [ %indvars.iv.next884, %polly.loop_exit426 ]
  ...
  %169 = add i64 %168, %325
  %polly.loop_guard427946 = icmp sgt i64 %169, -1
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1031 = icmp ult i64 %178, 4
...
vector.body1030:                                  ; preds = %vector.body1030, %vector.ph1032
  ...
  %180 = shl nuw nsw i64 %index1035, 3
  %181 = getelementptr i8, i8* %scevgep548, i64 %180
  %182 = bitcast i8* %181 to <4 x double>*
  %wide.load1039 = load <4 x double>, <4 x double>* %182, align 8, !alias.scope !89, !noalias !91
  %183 = fmul fast <4 x double> %wide.load1039, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %185 = icmp eq i64 %index.next1036, %n.vec1034
  br i1 %185, label %middle.block1028, label %vector.body1030, !llvm.loop !95

middle.block1028:                                 ; preds = %vector.body1030
  %cmp.n1038 = icmp eq i64 %178, %n.vec1034
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %195 = udiv i64 %polly.indvar561, 3
  %196 = add nuw i64 %polly.indvar561, %195
  %197 = mul nuw nsw i64 %196, 96
  %198 = sub i64 %indvars.iv896, %197
  %199 = add i64 %indvars.iv901, %197
  %200 = shl nsw i64 %polly.indvar561, 7
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit572.7
  %indvars.iv903 = phi i64 [ %indvars.iv.next904, %polly.loop_exit589 ], [ %199, %polly.loop_exit572.7 ]
  %indvars.iv898 = phi i64 [ %indvars.iv.next899, %polly.loop_exit589 ], [ %198, %polly.loop_exit572.7 ]
  %polly.indvar584 = phi i64 [ %polly.indvar_next585, %polly.loop_exit589 ], [ %196, %polly.loop_exit572.7 ]
  %smax900 = call i64 @llvm.smax.i64(i64 %indvars.iv898, i64 0)
  %202 = add i64 %smax900, %indvars.iv903
  %203 = mul nuw nsw i64 %polly.indvar584, 96
  %204 = sub nsw i64 %200, %203
  %205 = icmp sgt i64 %204, 0
  %206 = select i1 %205, i64 %204, i64 0
  %207 = mul nsw i64 %polly.indvar584, -96
  %208 = icmp slt i64 %207, -1104
  %209 = select i1 %208, i64 %207, i64 -1104
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  %indvars.iv905 = phi i64 [ %202, %polly.loop_header587 ], [ %indvars.iv.next906, %polly.loop_exit604 ]
  ...
  %214 = add i64 %213, %333
  %polly.loop_guard605947 = icmp sgt i64 %214, -1
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin969 = call i64 @llvm.smin.i64(i64 %225, i64 -1168)
  %226 = add nsw i64 %smin969, 1200
  %smin936 = call i64 @llvm.smin.i64(i64 %indvars.iv934, i64 -1168)
  %227 = shl nsw i64 %polly.indvar761, 5
  %228 = add nsw i64 %smin936, 1199
...
vector.ph970:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert977 = insertelement <4 x i64> poison, i64 %227, i32 0
  %broadcast.splat978 = shufflevector <4 x i64> %broadcast.splatinsert977, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert979 = insertelement <4 x i32> poison, i32 %230, i32 0
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %232 = add nuw nsw <4 x i64> %vec.ind975, %broadcast.splat978
  %233 = trunc <4 x i64> %232 to <4 x i32>
  %234 = mul <4 x i32> %broadcast.splat980, %233
  ...
  %244 = icmp eq i64 %index.next972, %226
  br i1 %244, label %polly.loop_exit772, label %vector.body968, !llvm.loop !104

polly.loop_exit772:                               ; preds = %vector.body968, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond941.not = icmp eq i64 %polly.indvar767, %224
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond937.not = icmp eq i64 %polly.indvar773, %228
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin984 = call i64 @llvm.smin.i64(i64 %254, i64 -968)
  %255 = add nsw i64 %smin984, 1000
  %smin926 = call i64 @llvm.smin.i64(i64 %indvars.iv924, i64 -968)
  %256 = shl nsw i64 %polly.indvar788, 5
  %257 = add nsw i64 %smin926, 999
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph986
  ...
  %261 = add nuw nsw <4 x i64> %vec.ind993, %broadcast.splat996
  %262 = trunc <4 x i64> %261 to <4 x i32>
  %263 = mul <4 x i32> %broadcast.splat998, %262
  ...
  %273 = icmp eq i64 %index.next990, %255
  br i1 %273, label %polly.loop_exit799, label %vector.body983, !llvm.loop !107

polly.loop_exit799:                               ; preds = %vector.body983, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond931.not = icmp eq i64 %polly.indvar794, %253
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond927.not = icmp eq i64 %polly.indvar800, %257
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1002 = call i64 @llvm.smin.i64(i64 %283, i64 -968)
  %284 = add nsw i64 %smin1002, 1000
  %smin916 = call i64 @llvm.smin.i64(i64 %indvars.iv914, i64 -968)
  %285 = shl nsw i64 %polly.indvar814, 5
  %286 = add nsw i64 %smin916, 999
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1004
  ...
  %290 = add nuw nsw <4 x i64> %vec.ind1011, %broadcast.splat1014
  %291 = trunc <4 x i64> %290 to <4 x i32>
  %292 = mul <4 x i32> %broadcast.splat1016, %291
  ...
  %302 = icmp eq i64 %index.next1008, %284
  br i1 %302, label %polly.loop_exit825, label %vector.body1001, !llvm.loop !110

polly.loop_exit825:                               ; preds = %vector.body1001, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond921.not = icmp eq i64 %polly.indvar820, %282
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond917.not = icmp eq i64 %polly.indvar826, %286
...
polly.loop_exit219.7:                             ; preds = %polly.loop_header217.7
  %317 = mul nsw i64 %polly.indvar208, -128
...
polly.loop_header392.1:                           ; preds = %polly.loop_header392, %polly.loop_header392.1
  ...
  %318 = add nuw nsw i64 %polly.indvar395.1, %155
  %polly.access.mul.call2399.1 = mul nuw nsw i64 %318, 1000
...
polly.loop_header392.2:                           ; preds = %polly.loop_header392.1, %polly.loop_header392.2
  ...
  %319 = add nuw nsw i64 %polly.indvar395.2, %155
  %polly.access.mul.call2399.2 = mul nuw nsw i64 %319, 1000
...
polly.loop_header392.3:                           ; preds = %polly.loop_header392.2, %polly.loop_header392.3
  ...
  %320 = add nuw nsw i64 %polly.indvar395.3, %155
  %polly.access.mul.call2399.3 = mul nuw nsw i64 %320, 1000
...
polly.loop_header392.4:                           ; preds = %polly.loop_header392.3, %polly.loop_header392.4
  ...
  %321 = add nuw nsw i64 %polly.indvar395.4, %155
  %polly.access.mul.call2399.4 = mul nuw nsw i64 %321, 1000
...
polly.loop_header392.5:                           ; preds = %polly.loop_header392.4, %polly.loop_header392.5
  ...
  %322 = add nuw nsw i64 %polly.indvar395.5, %155
  %polly.access.mul.call2399.5 = mul nuw nsw i64 %322, 1000
...
polly.loop_header392.6:                           ; preds = %polly.loop_header392.5, %polly.loop_header392.6
  ...
  %323 = add nuw nsw i64 %polly.indvar395.6, %155
  %polly.access.mul.call2399.6 = mul nuw nsw i64 %323, 1000
...
polly.loop_header392.7:                           ; preds = %polly.loop_header392.6, %polly.loop_header392.7
  ...
  %324 = add nuw nsw i64 %polly.indvar395.7, %155
  %polly.access.mul.call2399.7 = mul nuw nsw i64 %324, 1000
...
polly.loop_exit394.7:                             ; preds = %polly.loop_header392.7
  %325 = mul nsw i64 %polly.indvar383, -128
...
polly.loop_header570.1:                           ; preds = %polly.loop_header570, %polly.loop_header570.1
  ...
  %326 = add nuw nsw i64 %polly.indvar573.1, %200
  %polly.access.mul.call2577.1 = mul nuw nsw i64 %326, 1000
...
polly.loop_header570.2:                           ; preds = %polly.loop_header570.1, %polly.loop_header570.2
  ...
  %327 = add nuw nsw i64 %polly.indvar573.2, %200
  %polly.access.mul.call2577.2 = mul nuw nsw i64 %327, 1000
...
polly.loop_header570.3:                           ; preds = %polly.loop_header570.2, %polly.loop_header570.3
  ...
  %328 = add nuw nsw i64 %polly.indvar573.3, %200
  %polly.access.mul.call2577.3 = mul nuw nsw i64 %328, 1000
...
polly.loop_header570.4:                           ; preds = %polly.loop_header570.3, %polly.loop_header570.4
  ...
  %329 = add nuw nsw i64 %polly.indvar573.4, %200
  %polly.access.mul.call2577.4 = mul nuw nsw i64 %329, 1000
...
polly.loop_header570.5:                           ; preds = %polly.loop_header570.4, %polly.loop_header570.5
  ...
  %330 = add nuw nsw i64 %polly.indvar573.5, %200
  %polly.access.mul.call2577.5 = mul nuw nsw i64 %330, 1000
...
polly.loop_header570.6:                           ; preds = %polly.loop_header570.5, %polly.loop_header570.6
  ...
  %331 = add nuw nsw i64 %polly.indvar573.6, %200
  %polly.access.mul.call2577.6 = mul nuw nsw i64 %331, 1000
...
polly.loop_header570.7:                           ; preds = %polly.loop_header570.6, %polly.loop_header570.7
  ...
  %332 = add nuw nsw i64 %polly.indvar573.7, %200
  %polly.access.mul.call2577.7 = mul nuw nsw i64 %332, 1000
...
polly.loop_exit572.7:                             ; preds = %polly.loop_header570.7
  %333 = mul nsw i64 %polly.indvar561, -128
