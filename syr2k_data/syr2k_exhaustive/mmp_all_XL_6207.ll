; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6207.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6207.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header227
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar_next231, 15
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  ...
  %142 = mul nuw nsw i64 %polly.indvar406, 80
  %143 = sub nsw i64 %137, %142
  %144 = icmp sgt i64 %143, 0
  %145 = select i1 %144, i64 %143, i64 0
  %polly.loop_guard419 = icmp slt i64 %145, 80
...
polly.loop_header416.us:                          ; preds = %polly.loop_header409.us, %polly.loop_exit426.us
  ...
  %smin886 = call i64 @llvm.smin.i64(i64 %indvars.iv884, i64 19)
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418.loopexit.us, %polly.loop_header403
  ...
  %indvars.iv.next878 = add i64 %indvars.iv877, -80
  %indvars.iv.next883 = add i64 %indvars.iv882, 80
  %exitcond889.not = icmp eq i64 %polly.indvar_next407, 15
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  ...
  %177 = mul nuw nsw i64 %polly.indvar584, 80
...
polly.loop_header594.us:                          ; preds = %polly.loop_header587.us, %polly.loop_exit604.us
  ...
  %smin909 = call i64 @llvm.smin.i64(i64 %indvars.iv907, i64 19)
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header581
  ...
  %indvars.iv.next901 = add i64 %indvars.iv900, -80
  %indvars.iv.next906 = add i64 %indvars.iv905, 80
  %exitcond912.not = icmp eq i64 %polly.indvar_next585, 15
