; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10366.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10366.c"
...
polly.loop_header217.preheader:                   ; preds = %polly.loop_header211
  ...
  %110 = add i64 %smax, %indvars.iv791
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next215, %103
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv793 = phi i64 [ %110, %polly.loop_header217.preheader ], [ %indvars.iv.next794, %polly.loop_exit225 ]
  ...
  %polly.loop_guard233882 = icmp sgt i64 %112, -1
...
polly.loop_header223.us:                          ; preds = %polly.loop_header217, %polly.loop_exit232.loopexit.us
  ...
  %116 = add nuw nsw i64 %polly.indvar226.us, %104
  %117 = shl i64 %116, 3
  %118 = add i64 %117, %114
...
polly.loop_exit232.loopexit.us:                   ; preds = %polly.loop_header230.us
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar226.us, %105
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1003
  ...
  %126 = shl nuw nsw i64 %index1006, 3
  %127 = getelementptr i8, i8* %scevgep350, i64 %126
  %128 = bitcast i8* %127 to <4 x double>*
  %wide.load1010 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !69, !noalias !71
  %129 = fmul fast <4 x double> %wide.load1010, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %131 = icmp eq i64 %index.next1007, %n.vec1005
  br i1 %131, label %middle.block997, label %vector.body999, !llvm.loop !74

middle.block997:                                  ; preds = %vector.body999
  %cmp.n1009 = icmp eq i64 %124, %n.vec1005
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %133 = add nuw nsw i64 %pexp.p_div_q366, %polly.indvar357
  %.inv774 = icmp ult i64 %133, 18
  %134 = mul nsw i64 %polly.indvar357, -96
  %135 = icmp slt i64 %134, -1104
  %136 = select i1 %135, i64 %134, i64 -1104
  %137 = add nsw i64 %136, 1199
  %138 = mul nuw nsw i64 %polly.indvar357, 96
  %.op883 = add nuw i64 %133, 2
  %139 = select i1 %.inv774, i64 %.op883, i64 19
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next358, 13
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %140 = mul nuw nsw i64 %polly.indvar363, 80
  %141 = add nsw i64 %smin819, 999
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %142 = shl nsw i64 %polly.indvar370, 6
  %143 = add nsw i64 %142, %134
  %144 = icmp sgt i64 %143, 0
  %145 = select i1 %144, i64 %143, i64 0
  %polly.loop_guard377.not = icmp sgt i64 %145, %137
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %indvars.iv.next807 = add i64 %indvars.iv806, 64
  %indvars.iv.next812 = add i64 %indvars.iv811, -64
  %exitcond821.not = icmp eq i64 %polly.indvar_next371, %139
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  ...
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 63)
  %148 = add nsw i64 %polly.indvar378, %147
  %polly.loop_guard391884 = icmp sgt i64 %148, -1
  %149 = add nuw nsw i64 %polly.indvar378, %138
...
polly.loop_header381.us:                          ; preds = %polly.loop_header374, %polly.loop_exit390.loopexit.us
  ...
  %152 = add nuw nsw i64 %polly.indvar384.us, %140
  %153 = shl i64 %152, 3
  %154 = add i64 %153, %150
...
polly.loop_exit390.loopexit.us:                   ; preds = %polly.loop_header388.us
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar384.us, %141
...
polly.loop_exit383:                               ; preds = %polly.loop_exit390.loopexit.us, %polly.loop_header374
  ...
  %polly.loop_cond380.not.not = icmp ult i64 %polly.indvar378, %137
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph977
  ...
  %162 = shl nuw nsw i64 %index980, 3
  %163 = getelementptr i8, i8* %scevgep508, i64 %162
  %164 = bitcast i8* %163 to <4 x double>*
  %wide.load984 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !78, !noalias !80
  %165 = fmul fast <4 x double> %wide.load984, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %167 = icmp eq i64 %index.next981, %n.vec979
  br i1 %167, label %middle.block973, label %vector.body975, !llvm.loop !83

middle.block973:                                  ; preds = %vector.body975
  %cmp.n983 = icmp eq i64 %160, %n.vec979
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %169 = add nuw nsw i64 %pexp.p_div_q524, %polly.indvar515
  %.inv775 = icmp ult i64 %169, 18
  %170 = mul nsw i64 %polly.indvar515, -96
  %171 = icmp slt i64 %170, -1104
  %172 = select i1 %171, i64 %170, i64 -1104
  %173 = add nsw i64 %172, 1199
  %174 = mul nuw nsw i64 %polly.indvar515, 96
  %.op885 = add nuw i64 %169, 2
  %175 = select i1 %.inv775, i64 %.op885, i64 19
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next827 = add nsw i64 %indvars.iv826, -96
  %indvars.iv.next832 = add nuw nsw i64 %indvars.iv831, 96
  %exitcond845.not = icmp eq i64 %polly.indvar_next516, 13
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %176 = mul nuw nsw i64 %polly.indvar521, 80
  %177 = add nsw i64 %smin841, 999
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %178 = shl nsw i64 %polly.indvar528, 6
  %179 = add nsw i64 %178, %170
  %180 = icmp sgt i64 %179, 0
  %181 = select i1 %180, i64 %179, i64 0
  %polly.loop_guard535.not = icmp sgt i64 %181, %173
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %182 = add i64 %smax830, %indvars.iv833
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %indvars.iv.next829 = add i64 %indvars.iv828, 64
  %indvars.iv.next834 = add i64 %indvars.iv833, -64
  %exitcond843.not = icmp eq i64 %polly.indvar_next529, %175
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv835 = phi i64 [ %182, %polly.loop_header532.preheader ], [ %indvars.iv.next836, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %181, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin837 = call i64 @llvm.smin.i64(i64 %indvars.iv835, i64 63)
  %184 = add nsw i64 %polly.indvar536, %183
  %polly.loop_guard549886 = icmp sgt i64 %184, -1
  %185 = add nuw nsw i64 %polly.indvar536, %174
...
polly.loop_header539.us:                          ; preds = %polly.loop_header532, %polly.loop_exit548.loopexit.us
  ...
  %188 = add nuw nsw i64 %polly.indvar542.us, %176
  %189 = shl i64 %188, 3
  %190 = add i64 %189, %186
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar542.us, %177
...
polly.loop_exit541:                               ; preds = %polly.loop_exit548.loopexit.us, %polly.loop_header532
  ...
  %polly.loop_cond538.not.not = icmp ult i64 %polly.indvar536, %173
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin914 = call i64 @llvm.smin.i64(i64 %198, i64 -1168)
  %199 = add nsw i64 %smin914, 1200
  %smin870 = call i64 @llvm.smin.i64(i64 %indvars.iv868, i64 -1168)
  %200 = shl nsw i64 %polly.indvar703, 5
  %201 = add nsw i64 %smin870, 1199
...
vector.ph915:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert922 = insertelement <4 x i64> poison, i64 %200, i32 0
  %broadcast.splat923 = shufflevector <4 x i64> %broadcast.splatinsert922, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert924 = insertelement <4 x i32> poison, i32 %203, i32 0
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph915
  ...
  %205 = add nuw nsw <4 x i64> %vec.ind920, %broadcast.splat923
  %206 = trunc <4 x i64> %205 to <4 x i32>
  %207 = mul <4 x i32> %broadcast.splat925, %206
  ...
  %217 = icmp eq i64 %index.next917, %199
  br i1 %217, label %polly.loop_exit714, label %vector.body913, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body913, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond875.not = icmp eq i64 %polly.indvar709, %197
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar715, %201
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin929 = call i64 @llvm.smin.i64(i64 %227, i64 -968)
  %228 = add nsw i64 %smin929, 1000
  %smin860 = call i64 @llvm.smin.i64(i64 %indvars.iv858, i64 -968)
  %229 = shl nsw i64 %polly.indvar730, 5
  %230 = add nsw i64 %smin860, 999
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph931
  ...
  %234 = add nuw nsw <4 x i64> %vec.ind938, %broadcast.splat941
  %235 = trunc <4 x i64> %234 to <4 x i32>
  %236 = mul <4 x i32> %broadcast.splat943, %235
  ...
  %246 = icmp eq i64 %index.next935, %228
  br i1 %246, label %polly.loop_exit741, label %vector.body928, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body928, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond865.not = icmp eq i64 %polly.indvar736, %226
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar742, %230
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin947 = call i64 @llvm.smin.i64(i64 %256, i64 -968)
  %257 = add nsw i64 %smin947, 1000
  %smin850 = call i64 @llvm.smin.i64(i64 %indvars.iv848, i64 -968)
  %258 = shl nsw i64 %polly.indvar756, 5
  %259 = add nsw i64 %smin850, 999
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph949
  ...
  %263 = add nuw nsw <4 x i64> %vec.ind956, %broadcast.splat959
  %264 = trunc <4 x i64> %263 to <4 x i32>
  %265 = mul <4 x i32> %broadcast.splat961, %264
  ...
  %275 = icmp eq i64 %index.next953, %257
  br i1 %275, label %polly.loop_exit767, label %vector.body946, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body946, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond855.not = icmp eq i64 %polly.indvar762, %255
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar768, %259
