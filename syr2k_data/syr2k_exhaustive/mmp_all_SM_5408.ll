; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5408.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5408.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 79)
  ...
  %smin845.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844, i64 79)
  %108 = or i64 %104, 1
  ...
  %smin845.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.1, i64 79)
  %112 = or i64 %104, 2
  ...
  %smin845.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.2, i64 79)
  %116 = or i64 %104, 3
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1037
  ...
  %wide.load1044 = load <4 x double>, <4 x double>* %133, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %136, label %middle.block1031, label %vector.body1033, !llvm.loop !84
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %139 = mul nuw nsw i64 %polly.indvar375, 80
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %140 = mul nuw nsw i64 %polly.indvar381, 80
  br label %polly.loop_header384

polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %141 = mul nsw i64 %polly.indvar381, -80
  %142 = mul nuw nsw i64 %polly.indvar381, 20
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %smin866 = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 79)
  ...
  %smin866.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865, i64 79)
  %149 = or i64 %145, 1
  ...
  %smin866.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.1, i64 79)
  %153 = or i64 %145, 2
  ...
  %smin866.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.2, i64 79)
  %157 = or i64 %145, 3
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %wide.load1018 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %177, label %middle.block1007, label %vector.body1009, !llvm.loop !94
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %180 = mul nuw nsw i64 %polly.indvar548, 80
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %181 = mul nuw nsw i64 %polly.indvar554, 80
  br label %polly.loop_header557

polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %182 = mul nsw i64 %polly.indvar554, -80
  %183 = mul nuw nsw i64 %polly.indvar554, 20
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit559
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 79)
  ...
  %smin887.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886, i64 79)
  %190 = or i64 %186, 1
  ...
  %smin887.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.1, i64 79)
  %194 = or i64 %186, 2
  ...
  %smin887.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.2, i64 79)
  %198 = or i64 %186, 3
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph949
  ...
  br i1 %232, label %polly.loop_exit760, label %vector.body948, !llvm.loop !103
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph965
  ...
  br i1 %261, label %polly.loop_exit787, label %vector.body962, !llvm.loop !106
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph983
  ...
  br i1 %290, label %polly.loop_exit813, label %vector.body980, !llvm.loop !109
