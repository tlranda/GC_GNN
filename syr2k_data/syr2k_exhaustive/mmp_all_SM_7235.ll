; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7235.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7235.c"
...
vector.body1043:                                  ; preds = %vector.body1043, %vector.ph1047
  ...
  %wide.load1054 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %129, label %middle.block1041, label %vector.body1043, !llvm.loop !79
...
vector.body1019:                                  ; preds = %vector.body1019, %vector.ph1021
  ...
  %wide.load1028 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %163, label %middle.block1017, label %vector.body1019, !llvm.loop !89
...
vector.body957:                                   ; preds = %vector.body957, %vector.ph959
  ...
  br i1 %211, label %polly.loop_exit772, label %vector.body957, !llvm.loop !98
...
vector.body972:                                   ; preds = %vector.body972, %vector.ph975
  ...
  br i1 %240, label %polly.loop_exit799, label %vector.body972, !llvm.loop !101
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph993
  ...
  br i1 %269, label %polly.loop_exit825, label %vector.body990, !llvm.loop !104
