; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7576.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7576.c"
...
vector.body949:                                   ; preds = %vector.body949, %vector.ph950
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call784, i64 %indvars.iv7.i, i64 %index951
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next952 = add i64 %index951, 4
  %vec.ind.next956 = add <4 x i64> %vec.ind955, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next952, 1200
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check1013 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check1013, label %for.body3.i46.preheader1087, label %vector.ph1014

vector.ph1014:                                    ; preds = %for.body3.i46.preheader
  %n.vec1016 = and i64 %indvars.iv21.i, 9223372036854775804
...
vector.body1012:                                  ; preds = %vector.body1012, %vector.ph1014
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call784, i64 %indvars.iv21.i, i64 %index1017
  ...
  %46 = icmp eq i64 %index.next1018, %n.vec1016
  br i1 %46, label %middle.block1010, label %vector.body1012, !llvm.loop !18

middle.block1010:                                 ; preds = %vector.body1012
  %cmp.n1020 = icmp eq i64 %indvars.iv21.i, %n.vec1016
  br i1 %cmp.n1020, label %for.inc6.i, label %for.body3.i46.preheader1087

for.body3.i46.preheader1087:                      ; preds = %for.body3.i46.preheader, %middle.block1010
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec1016, %middle.block1010 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1087, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1087 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block1010, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1036 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1036, label %for.body3.i60.preheader1086, label %vector.ph1037

vector.ph1037:                                    ; preds = %for.body3.i60.preheader
  %n.vec1039 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1037
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call784, i64 %indvars.iv21.i52, i64 %index1040
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1044 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1044, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1041 = add i64 %index1040, 4
  %57 = icmp eq i64 %index.next1041, %n.vec1039
  br i1 %57, label %middle.block1033, label %vector.body1035, !llvm.loop !55

middle.block1033:                                 ; preds = %vector.body1035
  %cmp.n1043 = icmp eq i64 %indvars.iv21.i52, %n.vec1039
  br i1 %cmp.n1043, label %for.inc6.i63, label %for.body3.i60.preheader1086

for.body3.i60.preheader1086:                      ; preds = %for.body3.i60.preheader, %middle.block1033
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1039, %middle.block1033 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1086, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1086 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1033, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1062 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1062, label %for.body3.i99.preheader1085, label %vector.ph1063

vector.ph1063:                                    ; preds = %for.body3.i99.preheader
  %n.vec1065 = and i64 %indvars.iv21.i91, 9223372036854775804
...
vector.body1061:                                  ; preds = %vector.body1061, %vector.ph1063
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call784, i64 %indvars.iv21.i91, i64 %index1066
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1070 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1070, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1067 = add i64 %index1066, 4
  %68 = icmp eq i64 %index.next1067, %n.vec1065
  br i1 %68, label %middle.block1059, label %vector.body1061, !llvm.loop !57

middle.block1059:                                 ; preds = %vector.body1061
  %cmp.n1069 = icmp eq i64 %indvars.iv21.i91, %n.vec1065
  br i1 %cmp.n1069, label %for.inc6.i102, label %for.body3.i99.preheader1085

for.body3.i99.preheader1085:                      ; preds = %for.body3.i99.preheader, %middle.block1059
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1065, %middle.block1059 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1085, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1085 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1059, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit193, %polly.start
  %indvar1074 = phi i64 [ %indvar.next1075, %polly.loop_exit193 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1074, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1076 = icmp ult i64 %88, 4
  br i1 %min.iters.check1076, label %polly.loop_header191.preheader, label %vector.ph1077

vector.ph1077:                                    ; preds = %polly.loop_header
  %n.vec1079 = and i64 %88, -4
  br label %vector.body1073

vector.body1073:                                  ; preds = %vector.body1073, %vector.ph1077
  %index1080 = phi i64 [ 0, %vector.ph1077 ], [ %index.next1081, %vector.body1073 ]
  %90 = shl nuw nsw i64 %index1080, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1084 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  %93 = fmul fast <4 x double> %wide.load1084, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !63, !noalias !65
  %index.next1081 = add i64 %index1080, 4
  %95 = icmp eq i64 %index.next1081, %n.vec1079
  br i1 %95, label %middle.block1071, label %vector.body1073, !llvm.loop !69

middle.block1071:                                 ; preds = %vector.body1073
  %cmp.n1083 = icmp eq i64 %88, %n.vec1079
  br i1 %cmp.n1083, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block1071
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1079, %middle.block1071 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1071
  %polly.indvar_next = add nuw nsw i64 %polly.indvar, 1
  %exitcond860.not = icmp eq i64 %polly.indvar_next, 1200
  %indvar.next1075 = add i64 %indvar1074, 1
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %99 = mul nsw i64 %polly.indvar218, -80
  %100 = mul nuw nsw i64 %polly.indvar218, 80
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next219, 15
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 -936)
  %101 = shl nsw i64 %polly.indvar224, 6
  %102 = add nsw i64 %smin853, 999
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %103 = mul nuw nsw i64 %polly.indvar230, 100
  %104 = add nsw i64 %103, %99
  %105 = icmp sgt i64 %104, 0
  %106 = select i1 %105, i64 %104, i64 0
  %polly.loop_guard237 = icmp slt i64 %106, 80
...
polly.loop_exit236:                               ; preds = %polly.loop_exit243, %polly.loop_header227
  ...
  %indvars.iv.next844 = add nsw i64 %indvars.iv843, 100
  %indvars.iv.next848 = add nsw i64 %indvars.iv847, -100
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv849, i64 99)
  %109 = add nsw i64 %polly.indvar238, %108
  %polly.loop_guard251938 = icmp sgt i64 %109, -1
  %110 = add nuw nsw i64 %polly.indvar238, %100
  %111 = mul i64 %110, 8000
  %112 = mul i64 %110, 9600
  br i1 %polly.loop_guard251938, label %polly.loop_header241.us, label %polly.loop_exit243
...
polly.loop_exit250.loopexit.us:                   ; preds = %polly.loop_header248.us
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar244.us, %102
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.start274
  %indvar1048 = phi i64 [ %indvar.next1049, %polly.loop_exit368 ], [ 0, %polly.start274 ]
  %polly.indvar363 = phi i64 [ %polly.indvar_next364, %polly.loop_exit368 ], [ 1, %polly.start274 ]
  %121 = add i64 %indvar1048, 1
  %122 = mul nuw nsw i64 %polly.indvar363, 9600
  %scevgep372 = getelementptr i8, i8* %call, i64 %122
  %min.iters.check1050 = icmp ult i64 %121, 4
  br i1 %min.iters.check1050, label %polly.loop_header366.preheader, label %vector.ph1051

vector.ph1051:                                    ; preds = %polly.loop_header360
  %n.vec1053 = and i64 %121, -4
  br label %vector.body1047

vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1051
  %index1054 = phi i64 [ 0, %vector.ph1051 ], [ %index.next1055, %vector.body1047 ]
  %123 = shl nuw nsw i64 %index1054, 3
  %124 = getelementptr i8, i8* %scevgep372, i64 %123
  %125 = bitcast i8* %124 to <4 x double>*
  %wide.load1058 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !74, !noalias !76
  %126 = fmul fast <4 x double> %wide.load1058, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %128 = icmp eq i64 %index.next1055, %n.vec1053
  br i1 %128, label %middle.block1045, label %vector.body1047, !llvm.loop !80

middle.block1045:                                 ; preds = %vector.body1047
  %cmp.n1057 = icmp eq i64 %121, %n.vec1053
  br i1 %cmp.n1057, label %polly.loop_exit368, label %polly.loop_header366.preheader

polly.loop_header366.preheader:                   ; preds = %polly.loop_header360, %middle.block1045
  %polly.indvar369.ph = phi i64 [ 0, %polly.loop_header360 ], [ %n.vec1053, %middle.block1045 ]
  br label %polly.loop_header366

polly.loop_exit368:                               ; preds = %polly.loop_header366, %middle.block1045
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %exitcond883.not = icmp eq i64 %polly.indvar_next364, 1200
  %indvar.next1049 = add i64 %indvar1048, 1
  br i1 %exitcond883.not, label %polly.loop_header376.preheader, label %polly.loop_header360
...
polly.loop_header366:                             ; preds = %polly.loop_header366.preheader, %polly.loop_header366
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next370, %polly.indvar363
  br i1 %exitcond882.not, label %polly.loop_exit368, label %polly.loop_header366, !llvm.loop !81
...
polly.loop_exit384:                               ; preds = %polly.loop_header382
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next380, 1000
  br i1 %exitcond881.not, label %polly.loop_header392, label %polly.loop_header376
...
polly.loop_header382:                             ; preds = %polly.loop_header382, %polly.loop_header376
  ...
  %exitcond880.not = icmp eq i64 %polly.indvar_next386, 1200
  br i1 %exitcond880.not, label %polly.loop_exit384, label %polly.loop_header382
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %130 = add nuw nsw i64 %polly.indvar395, 6
  %pexp.p_div_q404 = udiv i64 %130, 5
  %131 = sub nsw i64 %polly.indvar395, %pexp.p_div_q404
  %polly.loop_guard409 = icmp sgt i64 %131, -2
  %132 = mul nsw i64 %polly.indvar395, -80
  %133 = mul nuw nsw i64 %polly.indvar395, 80
  br label %polly.loop_header398

polly.loop_exit400:                               ; preds = %polly.loop_exit408
  %polly.indvar_next396 = add nuw nsw i64 %polly.indvar395, 1
  %indvars.iv.next862 = add nsw i64 %indvars.iv861, -80
  %indvars.iv.next867 = add nuw nsw i64 %indvars.iv866, 80
  %exitcond879.not = icmp eq i64 %polly.indvar_next396, 15
  br i1 %exitcond879.not, label %polly.exiting275, label %polly.loop_header392

polly.loop_header398:                             ; preds = %polly.loop_exit408, %polly.loop_header392
  %indvars.iv874 = phi i64 [ %indvars.iv.next875, %polly.loop_exit408 ], [ 0, %polly.loop_header392 ]
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  ...
  %134 = shl nsw i64 %polly.indvar401, 6
  %135 = add nsw i64 %smin876, 999
...
polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar_next402, 16
  br i1 %exitcond878.not, label %polly.loop_exit400, label %polly.loop_header398
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %136 = mul nuw nsw i64 %polly.indvar410, 100
  %137 = add nsw i64 %136, %132
  %138 = icmp sgt i64 %137, 0
  %139 = select i1 %138, i64 %137, i64 0
  %polly.loop_guard417 = icmp slt i64 %139, 80
...
polly.loop_header414.preheader:                   ; preds = %polly.loop_header406
  ...
  %140 = add i64 %smax865, %indvars.iv868
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %polly.loop_cond412.not = icmp sgt i64 %polly.indvar410, %131
  %indvars.iv.next864 = add nsw i64 %indvars.iv863, 100
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  %indvars.iv870 = phi i64 [ %140, %polly.loop_header414.preheader ], [ %indvars.iv.next871, %polly.loop_exit423 ]
  ...
  %polly.loop_guard431939 = icmp sgt i64 %142, -1
  %143 = add nuw nsw i64 %polly.indvar418, %133
  %144 = mul i64 %143, 8000
  %145 = mul i64 %143, 9600
  br i1 %polly.loop_guard431939, label %polly.loop_header421.us, label %polly.loop_exit423
...
polly.loop_header421.us:                          ; preds = %polly.loop_header414, %polly.loop_exit430.loopexit.us
  ...
  %146 = add nuw nsw i64 %polly.indvar424.us, %134
  %147 = shl i64 %146, 3
...
polly.loop_exit430.loopexit.us:                   ; preds = %polly.loop_header428.us
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar424.us, %135
  br i1 %exitcond877.not, label %polly.loop_exit423, label %polly.loop_header421.us
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %min.iters.check1024 = icmp ult i64 %154, 4
  br i1 %min.iters.check1024, label %polly.loop_header546.preheader, label %vector.ph1025

vector.ph1025:                                    ; preds = %polly.loop_header540
  %n.vec1027 = and i64 %154, -4
...
vector.body1023:                                  ; preds = %vector.body1023, %vector.ph1025
  ...
  %156 = shl nuw nsw i64 %index1028, 3
  %157 = getelementptr i8, i8* %scevgep552, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load1032 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !84, !noalias !86
  %159 = fmul fast <4 x double> %wide.load1032, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next1029, %n.vec1027
  br i1 %161, label %middle.block1021, label %vector.body1023, !llvm.loop !90

middle.block1021:                                 ; preds = %vector.body1023
  %cmp.n1031 = icmp eq i64 %154, %n.vec1027
  br i1 %cmp.n1031, label %polly.loop_exit548, label %polly.loop_header546.preheader

polly.loop_header546.preheader:                   ; preds = %polly.loop_header540, %middle.block1021
  %polly.indvar549.ph = phi i64 [ 0, %polly.loop_header540 ], [ %n.vec1027, %middle.block1021 ]
  br label %polly.loop_header546

polly.loop_exit548:                               ; preds = %polly.loop_header546, %middle.block1021
  %polly.indvar_next544 = add nuw nsw i64 %polly.indvar543, 1
  %exitcond906.not = icmp eq i64 %polly.indvar_next544, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond906.not, label %polly.loop_header556.preheader, label %polly.loop_header540
...
polly.loop_header546:                             ; preds = %polly.loop_header546.preheader, %polly.loop_header546
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next550, %polly.indvar543
  br i1 %exitcond905.not, label %polly.loop_exit548, label %polly.loop_header546, !llvm.loop !91
...
polly.loop_exit564:                               ; preds = %polly.loop_header562
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar_next560, 1000
  br i1 %exitcond904.not, label %polly.loop_header572, label %polly.loop_header556
...
polly.loop_header562:                             ; preds = %polly.loop_header562, %polly.loop_header556
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar_next566, 1200
  br i1 %exitcond903.not, label %polly.loop_exit564, label %polly.loop_header562

polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  %indvars.iv889 = phi i64 [ %indvars.iv.next890, %polly.loop_exit580 ], [ 0, %polly.loop_exit564 ]
  %indvars.iv884 = phi i64 [ %indvars.iv.next885, %polly.loop_exit580 ], [ 0, %polly.loop_exit564 ]
  %polly.indvar575 = phi i64 [ %polly.indvar_next576, %polly.loop_exit580 ], [ 0, %polly.loop_exit564 ]
  %163 = add nuw nsw i64 %polly.indvar575, 6
  %pexp.p_div_q584 = udiv i64 %163, 5
  %164 = sub nsw i64 %polly.indvar575, %pexp.p_div_q584
  %polly.loop_guard589 = icmp sgt i64 %164, -2
  %165 = mul nsw i64 %polly.indvar575, -80
  %166 = mul nuw nsw i64 %polly.indvar575, 80
...
polly.loop_exit580:                               ; preds = %polly.loop_exit588
  ...
  %indvars.iv.next885 = add nsw i64 %indvars.iv884, -80
  %indvars.iv.next890 = add nuw nsw i64 %indvars.iv889, 80
  %exitcond902.not = icmp eq i64 %polly.indvar_next576, 15
  br i1 %exitcond902.not, label %polly.exiting455, label %polly.loop_header572

polly.loop_header578:                             ; preds = %polly.loop_exit588, %polly.loop_header572
  %indvars.iv897 = phi i64 [ %indvars.iv.next898, %polly.loop_exit588 ], [ 0, %polly.loop_header572 ]
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 -936)
  %167 = shl nsw i64 %polly.indvar581, 6
  %168 = add nsw i64 %smin899, 999
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar_next582, 16
  br i1 %exitcond901.not, label %polly.loop_exit580, label %polly.loop_header578

polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  %indvars.iv891 = phi i64 [ %indvars.iv889, %polly.loop_header586.preheader ], [ %indvars.iv.next892, %polly.loop_exit596 ]
  %indvars.iv886 = phi i64 [ %indvars.iv884, %polly.loop_header586.preheader ], [ %indvars.iv.next887, %polly.loop_exit596 ]
  %polly.indvar590 = phi i64 [ 0, %polly.loop_header586.preheader ], [ %polly.indvar_next591, %polly.loop_exit596 ]
  %169 = mul nuw nsw i64 %polly.indvar590, 100
  %170 = add nsw i64 %169, %165
  %171 = icmp sgt i64 %170, 0
  %172 = select i1 %171, i64 %170, i64 0
  %polly.loop_guard597 = icmp slt i64 %172, 80
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit603
  %indvars.iv893 = phi i64 [ %173, %polly.loop_header594.preheader ], [ %indvars.iv.next894, %polly.loop_exit603 ]
  ...
  %polly.loop_guard611940 = icmp sgt i64 %175, -1
  %176 = add nuw nsw i64 %polly.indvar598, %166
  %177 = mul i64 %176, 8000
  %178 = mul i64 %176, 9600
  br i1 %polly.loop_guard611940, label %polly.loop_header601.us, label %polly.loop_exit603
...
polly.loop_header601.us:                          ; preds = %polly.loop_header594, %polly.loop_exit610.loopexit.us
  ...
  %179 = add nuw nsw i64 %polly.indvar604.us, %167
  %180 = shl i64 %179, 3
...
polly.loop_header608.us:                          ; preds = %polly.loop_header601.us, %polly.loop_header608.us
  ...
  %exitcond896.not = icmp eq i64 %polly.indvar612.us, %smin895
  br i1 %exitcond896.not, label %polly.loop_exit610.loopexit.us, label %polly.loop_header608.us

polly.loop_exit610.loopexit.us:                   ; preds = %polly.loop_header608.us
  %polly.indvar_next605.us = add nuw nsw i64 %polly.indvar604.us, 1
  %exitcond900.not = icmp eq i64 %polly.indvar604.us, %168
  br i1 %exitcond900.not, label %polly.loop_exit603, label %polly.loop_header601.us
...
polly.loop_header758:                             ; preds = %entry, %polly.loop_exit766
  %indvars.iv931 = phi i64 [ %indvars.iv.next932, %polly.loop_exit766 ], [ 0, %entry ]
...
polly.loop_exit766:                               ; preds = %polly.loop_exit772
  ...
  %exitcond936.not = icmp eq i64 %polly.indvar_next762, 38
  br i1 %exitcond936.not, label %polly.loop_header785, label %polly.loop_header758

polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  %indvars.iv927 = phi i64 [ %indvars.iv.next928, %polly.loop_exit772 ], [ 0, %polly.loop_header758 ]
  %polly.indvar767 = phi i64 [ %polly.indvar_next768, %polly.loop_exit772 ], [ 0, %polly.loop_header758 ]
  %189 = mul nsw i64 %polly.indvar767, -32
  %smin962 = call i64 @llvm.smin.i64(i64 %189, i64 -1168)
  %190 = add nsw i64 %smin962, 1200
  %smin929 = call i64 @llvm.smin.i64(i64 %indvars.iv927, i64 -1168)
  %191 = shl nsw i64 %polly.indvar767, 5
  %192 = add nsw i64 %smin929, 1199
...
polly.loop_exit772:                               ; preds = %polly.loop_exit778
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar_next768, 38
  br i1 %exitcond935.not, label %polly.loop_exit766, label %polly.loop_header764
...
polly.loop_header770:                             ; preds = %polly.loop_exit778, %polly.loop_header764
  ...
  br i1 %min.iters.check, label %polly.loop_header776, label %vector.ph963

vector.ph963:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert970 = insertelement <4 x i64> poison, i64 %191, i32 0
  %broadcast.splat971 = shufflevector <4 x i64> %broadcast.splatinsert970, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert972 = insertelement <4 x i32> poison, i32 %194, i32 0
...
vector.body961:                                   ; preds = %vector.body961, %vector.ph963
  %index964 = phi i64 [ 0, %vector.ph963 ], [ %index.next965, %vector.body961 ]
  %vec.ind968 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph963 ], [ %vec.ind.next969, %vector.body961 ]
  %196 = add nuw nsw <4 x i64> %vec.ind968, %broadcast.splat971
  %197 = trunc <4 x i64> %196 to <4 x i32>
  %198 = mul <4 x i32> %broadcast.splat973, %197
  ...
  %208 = icmp eq i64 %index.next965, %190
  br i1 %208, label %polly.loop_exit778, label %vector.body961, !llvm.loop !99

polly.loop_exit778:                               ; preds = %vector.body961, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond934.not = icmp eq i64 %polly.indvar773, %188
  br i1 %exitcond934.not, label %polly.loop_exit772, label %polly.loop_header770
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %exitcond930.not = icmp eq i64 %polly.indvar779, %192
  br i1 %exitcond930.not, label %polly.loop_exit778, label %polly.loop_header776, !llvm.loop !100

polly.loop_header785:                             ; preds = %polly.loop_exit766, %polly.loop_exit793
  %indvars.iv921 = phi i64 [ %indvars.iv.next922, %polly.loop_exit793 ], [ 0, %polly.loop_exit766 ]
  ...
  %217 = add nsw i64 %smin923, 1199
  br label %polly.loop_header791

polly.loop_exit793:                               ; preds = %polly.loop_exit799
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %indvars.iv.next922 = add nsw i64 %indvars.iv921, -32
  %exitcond926.not = icmp eq i64 %polly.indvar_next789, 38
  br i1 %exitcond926.not, label %polly.loop_header811, label %polly.loop_header785

polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  %indvars.iv917 = phi i64 [ %indvars.iv.next918, %polly.loop_exit799 ], [ 0, %polly.loop_header785 ]
  %polly.indvar794 = phi i64 [ %polly.indvar_next795, %polly.loop_exit799 ], [ 0, %polly.loop_header785 ]
  %218 = mul nsw i64 %polly.indvar794, -32
  %smin977 = call i64 @llvm.smin.i64(i64 %218, i64 -968)
  %219 = add nsw i64 %smin977, 1000
  %smin919 = call i64 @llvm.smin.i64(i64 %indvars.iv917, i64 -968)
  %220 = shl nsw i64 %polly.indvar794, 5
  %221 = add nsw i64 %smin919, 999
...
polly.loop_exit799:                               ; preds = %polly.loop_exit805
  ...
  %exitcond925.not = icmp eq i64 %polly.indvar_next795, 32
  br i1 %exitcond925.not, label %polly.loop_exit793, label %polly.loop_header791
...
polly.loop_header797:                             ; preds = %polly.loop_exit805, %polly.loop_header791
  ...
  %min.iters.check978 = icmp eq i64 %219, 0
  br i1 %min.iters.check978, label %polly.loop_header803, label %vector.ph979

vector.ph979:                                     ; preds = %polly.loop_header797
  %broadcast.splatinsert988 = insertelement <4 x i64> poison, i64 %220, i32 0
  %broadcast.splat989 = shufflevector <4 x i64> %broadcast.splatinsert988, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert990 = insertelement <4 x i32> poison, i32 %223, i32 0
...
vector.body976:                                   ; preds = %vector.body976, %vector.ph979
  %index982 = phi i64 [ 0, %vector.ph979 ], [ %index.next983, %vector.body976 ]
  %vec.ind986 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph979 ], [ %vec.ind.next987, %vector.body976 ]
  %225 = add nuw nsw <4 x i64> %vec.ind986, %broadcast.splat989
  %226 = trunc <4 x i64> %225 to <4 x i32>
  %227 = mul <4 x i32> %broadcast.splat991, %226
  ...
  %237 = icmp eq i64 %index.next983, %219
  br i1 %237, label %polly.loop_exit805, label %vector.body976, !llvm.loop !102

polly.loop_exit805:                               ; preds = %vector.body976, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond924.not = icmp eq i64 %polly.indvar800, %217
  br i1 %exitcond924.not, label %polly.loop_exit799, label %polly.loop_header797
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond920.not = icmp eq i64 %polly.indvar806, %221
  br i1 %exitcond920.not, label %polly.loop_exit805, label %polly.loop_header803, !llvm.loop !103

polly.loop_header811:                             ; preds = %polly.loop_exit793, %polly.loop_exit819
  %indvars.iv911 = phi i64 [ %indvars.iv.next912, %polly.loop_exit819 ], [ 0, %polly.loop_exit793 ]
  ...
  %246 = add nsw i64 %smin913, 1199
  br label %polly.loop_header817

polly.loop_exit819:                               ; preds = %polly.loop_exit825
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %indvars.iv.next912 = add nsw i64 %indvars.iv911, -32
  %exitcond916.not = icmp eq i64 %polly.indvar_next815, 38
  br i1 %exitcond916.not, label %init_array.exit, label %polly.loop_header811

polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  %indvars.iv907 = phi i64 [ %indvars.iv.next908, %polly.loop_exit825 ], [ 0, %polly.loop_header811 ]
  %polly.indvar820 = phi i64 [ %polly.indvar_next821, %polly.loop_exit825 ], [ 0, %polly.loop_header811 ]
  %247 = mul nsw i64 %polly.indvar820, -32
  %smin995 = call i64 @llvm.smin.i64(i64 %247, i64 -968)
  %248 = add nsw i64 %smin995, 1000
  %smin909 = call i64 @llvm.smin.i64(i64 %indvars.iv907, i64 -968)
  %249 = shl nsw i64 %polly.indvar820, 5
  %250 = add nsw i64 %smin909, 999
...
polly.loop_exit825:                               ; preds = %polly.loop_exit831
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar_next821, 32
  br i1 %exitcond915.not, label %polly.loop_exit819, label %polly.loop_header817
...
polly.loop_header823:                             ; preds = %polly.loop_exit831, %polly.loop_header817
  ...
  %min.iters.check996 = icmp eq i64 %248, 0
  br i1 %min.iters.check996, label %polly.loop_header829, label %vector.ph997

vector.ph997:                                     ; preds = %polly.loop_header823
  %broadcast.splatinsert1006 = insertelement <4 x i64> poison, i64 %249, i32 0
  %broadcast.splat1007 = shufflevector <4 x i64> %broadcast.splatinsert1006, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1008 = insertelement <4 x i32> poison, i32 %252, i32 0
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph997
  ...
  %254 = add nuw nsw <4 x i64> %vec.ind1004, %broadcast.splat1007
  %255 = trunc <4 x i64> %254 to <4 x i32>
  %256 = mul <4 x i32> %broadcast.splat1009, %255
  ...
  %266 = icmp eq i64 %index.next1001, %248
  br i1 %266, label %polly.loop_exit831, label %vector.body994, !llvm.loop !105

polly.loop_exit831:                               ; preds = %vector.body994, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond914.not = icmp eq i64 %polly.indvar826, %246
  br i1 %exitcond914.not, label %polly.loop_exit825, label %polly.loop_header823
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %exitcond910.not = icmp eq i64 %polly.indvar832, %250
  br i1 %exitcond910.not, label %polly.loop_exit831, label %polly.loop_header829, !llvm.loop !106
}
