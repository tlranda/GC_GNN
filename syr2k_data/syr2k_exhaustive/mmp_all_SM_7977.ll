; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7977.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7977.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv832 = phi i64 [ %indvars.iv.next833, %polly.loop_exit223 ], [ 7, %polly.loop_exit207 ]
  %indvars.iv825 = phi i64 [ %indvars.iv.next826, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %polly.indvar218 = phi i64 [ %polly.indvar_next219, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv832, i64 74)
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next833 = add nuw nsw i64 %indvars.iv832, 8
  %exitcond835.not = icmp eq i64 %polly.indvar_next219, 10
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit394
  %indvars.iv854 = phi i64 [ %indvars.iv.next855, %polly.loop_exit394 ], [ 7, %polly.loop_exit378 ]
...
polly.loop_header392:                             ; preds = %polly.loop_exit401, %polly.loop_header386
  ...
  %131 = shl nsw i64 %polly.indvar395, 4
...
polly.loop_header559:                             ; preds = %polly.loop_exit551, %polly.loop_exit567
  %indvars.iv877 = phi i64 [ %indvars.iv.next878, %polly.loop_exit567 ], [ 7, %polly.loop_exit551 ]
  ...
  %umin879 = call i64 @llvm.umin.i64(i64 %indvars.iv877, i64 74)
  %155 = mul nsw i64 %polly.indvar562, -128
  %156 = icmp slt i64 %155, -1072
  %157 = select i1 %156, i64 %155, i64 -1072
  %158 = add nsw i64 %157, 1199
  %159 = shl nsw i64 %polly.indvar562, 7
...
polly.loop_exit567:                               ; preds = %polly.loop_exit574
  ...
  %indvars.iv.next869 = add nuw nsw i64 %indvars.iv868, 128
  %indvars.iv.next878 = add nuw nsw i64 %indvars.iv877, 8
  %exitcond881.not = icmp eq i64 %polly.indvar_next563, 10
...
polly.loop_header565:                             ; preds = %polly.loop_exit574, %polly.loop_header559
  ...
  %160 = shl nsw i64 %polly.indvar568, 4
