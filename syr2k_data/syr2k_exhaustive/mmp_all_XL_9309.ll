; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9309.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9309.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %97 = shl nuw nsw i64 %indvars.iv779, 1
  %98 = and i64 %97, 9223372036854775680
  %99 = sub nsw i64 %indvars.iv, %98
  %100 = add i64 %indvars.iv783, %98
  %101 = mul nuw nsw i64 %polly.indvar202, 25
  %pexp.p_div_q = lshr i64 %101, 6
  %102 = mul nuw nsw i64 %polly.indvar202, 50
  %103 = mul nsw i64 %polly.indvar202, -50
  br label %polly.loop_header205

polly.loop_exit207:                               ; preds = %polly.loop_exit213
  %polly.indvar_next203 = add nuw nsw i64 %polly.indvar202, 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 50
  %indvars.iv.next780 = add nuw nsw i64 %indvars.iv779, 25
  %indvars.iv.next784 = add nsw i64 %indvars.iv783, -50
  %exitcond791.not = icmp eq i64 %polly.indvar_next203, 24
  br i1 %exitcond791.not, label %kernel_syr2k.exit129, label %polly.loop_header199

polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  %indvars.iv785 = phi i64 [ %indvars.iv.next786, %polly.loop_exit213 ], [ %100, %polly.loop_header199 ]
  %indvars.iv781 = phi i64 [ %indvars.iv.next782, %polly.loop_exit213 ], [ %99, %polly.loop_header199 ]
  %polly.indvar208 = phi i64 [ %polly.indvar_next209, %polly.loop_exit213 ], [ %pexp.p_div_q, %polly.loop_header199 ]
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv781, i64 0)
  %104 = add i64 %smax, %indvars.iv785
  %105 = shl nsw i64 %polly.indvar208, 7
  %106 = sub nsw i64 %102, %105
  %107 = icmp sgt i64 %106, 0
  %108 = select i1 %107, i64 %106, i64 0
  %109 = mul nsw i64 %polly.indvar208, -128
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %indvars.iv.next782 = add i64 %indvars.iv781, -128
...
polly.loop_header217:                             ; preds = %polly.loop_exit226, %polly.loop_header211
  %indvars.iv787 = phi i64 [ %indvars.iv.next788, %polly.loop_exit226 ], [ %104, %polly.loop_header211 ]
  %polly.indvar220 = phi i64 [ %polly.indvar_next221, %polly.loop_exit226 ], [ %108, %polly.loop_header211 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv787, i64 49)
...
polly.loop_header342:                             ; preds = %polly.loop_header342.preheader, %polly.loop_header342
  ...
  br i1 %exitcond812.not, label %polly.loop_exit344, label %polly.loop_header342, !llvm.loop !78
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %131 = shl nuw nsw i64 %indvars.iv796, 1
  %132 = and i64 %131, 9223372036854775680
  %133 = sub nsw i64 %indvars.iv794, %132
  %134 = add i64 %indvars.iv801, %132
  %135 = mul nuw nsw i64 %polly.indvar355, 25
  %pexp.p_div_q358 = lshr i64 %135, 6
  %136 = mul nuw nsw i64 %polly.indvar355, 50
  %137 = mul nsw i64 %polly.indvar355, -50
  br label %polly.loop_header359

polly.loop_exit361:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next795 = add nuw nsw i64 %indvars.iv794, 50
  %indvars.iv.next797 = add nuw nsw i64 %indvars.iv796, 25
  %indvars.iv.next802 = add nsw i64 %indvars.iv801, -50
  %exitcond811.not = icmp eq i64 %polly.indvar_next356, 24
...
polly.loop_header359:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  %indvars.iv803 = phi i64 [ %indvars.iv.next804, %polly.loop_exit367 ], [ %134, %polly.loop_header352 ]
  %indvars.iv798 = phi i64 [ %indvars.iv.next799, %polly.loop_exit367 ], [ %133, %polly.loop_header352 ]
  %polly.indvar362 = phi i64 [ %polly.indvar_next363, %polly.loop_exit367 ], [ %pexp.p_div_q358, %polly.loop_header352 ]
  %smax800 = call i64 @llvm.smax.i64(i64 %indvars.iv798, i64 0)
  %138 = add i64 %smax800, %indvars.iv803
  %139 = shl nsw i64 %polly.indvar362, 7
  %140 = sub nsw i64 %136, %139
  %141 = icmp sgt i64 %140, 0
  %142 = select i1 %141, i64 %140, i64 0
  %143 = mul nsw i64 %polly.indvar362, -128
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header359
  ...
  %indvars.iv.next799 = add i64 %indvars.iv798, -128
  %indvars.iv.next804 = add i64 %indvars.iv803, 128
  %exitcond810.not = icmp eq i64 %polly.indvar_next363, 10
...
polly.loop_exit374:                               ; preds = %polly.loop_exit382
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next369, 1000
  br i1 %exitcond809.not, label %polly.loop_exit367, label %polly.loop_header365

polly.loop_header372:                             ; preds = %polly.loop_exit382, %polly.loop_header365
  %indvars.iv805 = phi i64 [ %indvars.iv.next806, %polly.loop_exit382 ], [ %138, %polly.loop_header365 ]
  %polly.indvar376 = phi i64 [ %polly.indvar_next377, %polly.loop_exit382 ], [ %142, %polly.loop_header365 ]
  %smin807 = call i64 @llvm.smin.i64(i64 %indvars.iv805, i64 49)
...
polly.loop_header380:                             ; preds = %polly.loop_header380.preheader, %polly.loop_header380
  ...
  %exitcond808.not = icmp eq i64 %polly.indvar384, %smin807
  br i1 %exitcond808.not, label %polly.loop_exit382, label %polly.loop_header380
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %165 = shl nuw nsw i64 %indvars.iv816, 1
  %166 = and i64 %165, 9223372036854775680
  %167 = sub nsw i64 %indvars.iv814, %166
  %168 = add i64 %indvars.iv821, %166
  %169 = mul nuw nsw i64 %polly.indvar511, 25
  %pexp.p_div_q514 = lshr i64 %169, 6
  %170 = mul nuw nsw i64 %polly.indvar511, 50
  %171 = mul nsw i64 %polly.indvar511, -50
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next815 = add nuw nsw i64 %indvars.iv814, 50
  %indvars.iv.next817 = add nuw nsw i64 %indvars.iv816, 25
  %indvars.iv.next822 = add nsw i64 %indvars.iv821, -50
  %exitcond831.not = icmp eq i64 %polly.indvar_next512, 24
...
polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  %indvars.iv823 = phi i64 [ %indvars.iv.next824, %polly.loop_exit523 ], [ %168, %polly.loop_header508 ]
  %indvars.iv818 = phi i64 [ %indvars.iv.next819, %polly.loop_exit523 ], [ %167, %polly.loop_header508 ]
  %polly.indvar518 = phi i64 [ %polly.indvar_next519, %polly.loop_exit523 ], [ %pexp.p_div_q514, %polly.loop_header508 ]
  %smax820 = call i64 @llvm.smax.i64(i64 %indvars.iv818, i64 0)
  %172 = add i64 %smax820, %indvars.iv823
  %173 = shl nsw i64 %polly.indvar518, 7
  %174 = sub nsw i64 %170, %173
  %175 = icmp sgt i64 %174, 0
  %176 = select i1 %175, i64 %174, i64 0
  %177 = mul nsw i64 %polly.indvar518, -128
...
polly.loop_exit523:                               ; preds = %polly.loop_exit530, %polly.loop_header515
  ...
  %indvars.iv.next824 = add i64 %indvars.iv823, 128
  %exitcond830.not = icmp eq i64 %polly.indvar_next519, 10
...
polly.loop_exit530:                               ; preds = %polly.loop_exit538
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next525, 1000
  br i1 %exitcond829.not, label %polly.loop_exit523, label %polly.loop_header521

polly.loop_header528:                             ; preds = %polly.loop_exit538, %polly.loop_header521
  %indvars.iv825 = phi i64 [ %indvars.iv.next826, %polly.loop_exit538 ], [ %172, %polly.loop_header521 ]
  %polly.indvar532 = phi i64 [ %polly.indvar_next533, %polly.loop_exit538 ], [ %176, %polly.loop_header521 ]
  %smin827 = call i64 @llvm.smin.i64(i64 %indvars.iv825, i64 49)
...
polly.loop_header536:                             ; preds = %polly.loop_header536.preheader, %polly.loop_header536
  ...
  %exitcond828.not = icmp eq i64 %polly.indvar540, %smin827
  br i1 %exitcond828.not, label %polly.loop_exit538, label %polly.loop_header536
