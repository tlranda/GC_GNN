; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6595.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6595.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next209, 19
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %111 = mul nsw i64 %polly.indvar230, -128
...
polly.loop_header239:                             ; preds = %polly.loop_header233, %polly.loop_exit248
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 63)
...
polly.loop_exit405:                               ; preds = %polly.loop_exit411
  ...
  %exitcond890.not = icmp eq i64 %polly.indvar_next384, 19
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  ...
  %146 = shl nsw i64 %polly.indvar406, 7
  %147 = sub nsw i64 %141, %146
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %150 = mul nsw i64 %polly.indvar406, -128
...
polly.loop_exit418:                               ; preds = %polly.loop_exit426
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next413, 50
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  ...
  %smin886 = call i64 @llvm.smin.i64(i64 %indvars.iv884, i64 63)
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  ...
  %185 = shl nsw i64 %polly.indvar584, 7
  %186 = sub nsw i64 %180, %185
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %189 = mul nsw i64 %polly.indvar584, -128
...
polly.loop_exit596:                               ; preds = %polly.loop_exit604
  ...
  %exitcond911.not = icmp eq i64 %polly.indvar_next591, 50
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  ...
  %smin909 = call i64 @llvm.smin.i64(i64 %indvars.iv907, i64 63)
