; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1273.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1273.c"
...
polly.loop_header274:                             ; preds = %polly.loop_header267, %polly.loop_exit284
  ...
  %smin1419 = call i64 @llvm.smin.i64(i64 %143, i64 99)
...
polly.loop_header420:                             ; preds = %polly.loop_exit446, %polly.loop_header414
  ...
  %178 = mul nsw i64 %polly.indvar423, -28
  %179 = mul nuw nsw i64 %polly.indvar423, 28
  %180 = add nuw i64 %179, 124
  %181 = and i64 %180, -128
  %182 = add i64 %178, %181
  %183 = sub i64 %179, %181
  ...
  %188 = mul nsw i64 %polly.indvar423, -100
  %189 = mul nuw nsw i64 %polly.indvar423, 100
...
polly.loop_header444:                             ; preds = %polly.loop_exit428, %polly.loop_exit486
  ...
  %.inv948 = icmp sgt i64 %203, 99
  %205 = select i1 %.inv948, i64 99, i64 %204
...
polly.loop_header491:                             ; preds = %polly.loop_header484, %polly.loop_exit501
  ...
  %smin1369 = call i64 @llvm.smin.i64(i64 %223, i64 99)
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %258 = mul nsw i64 %polly.indvar640, -28
  %259 = mul nuw nsw i64 %polly.indvar640, 28
  %260 = add nuw i64 %259, 124
  %261 = and i64 %260, -128
  %262 = add i64 %258, %261
  %263 = sub i64 %259, %261
  ...
  %268 = mul nsw i64 %polly.indvar640, -100
  %269 = mul nuw nsw i64 %polly.indvar640, 100
...
polly.loop_header661:                             ; preds = %polly.loop_exit645, %polly.loop_exit703
  ...
  %.inv949 = icmp sgt i64 %283, 99
  %285 = select i1 %.inv949, i64 99, i64 %284
...
polly.loop_header708:                             ; preds = %polly.loop_header701, %polly.loop_exit718
  ...
  %smin1319 = call i64 @llvm.smin.i64(i64 %303, i64 99)
