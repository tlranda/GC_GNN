; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6214.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6214.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar_next203, 50
...
polly.loop_exit219:                               ; preds = %polly.loop_header217
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next215, 20
...
polly.loop_exit241:                               ; preds = %polly.loop_exit247
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar_next237, 20
...
vector.body1046:                                  ; preds = %vector.body1046, %vector.ph1050
  ...
  %wide.load1057 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %127, label %middle.block1044, label %vector.body1046, !llvm.loop !85
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %129 = mul nuw nsw i64 %polly.indvar375, 20
...
polly.loop_exit380:                               ; preds = %polly.loop_exit402
  ...
  %exitcond880.not = icmp eq i64 %polly.indvar_next376, 50
...
polly.loop_exit386:                               ; preds = %polly.loop_exit392
  ...
  %132 = mul nuw nsw i64 %polly.indvar381, 3
...
polly.loop_exit392:                               ; preds = %polly.loop_header390
  ...
  %exitcond863.not = icmp eq i64 %polly.indvar_next388, 20
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %136 = mul nuw nsw i64 %polly.indvar403, 80
...
polly.loop_exit414:                               ; preds = %polly.loop_exit421
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar_next410, 20
...
polly.start445:                                   ; preds = %init_array.exit
  %malloccall447 = tail call dereferenceable_or_null(192000) i8* @malloc(i64 192000) #6
...
vector.body1022:                                  ; preds = %vector.body1022, %vector.ph1024
  ...
  %wide.load1031 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %159, label %middle.block1020, label %vector.body1022, !llvm.loop !95
...
polly.loop_header547:                             ; preds = %polly.loop_header547.preheader, %polly.loop_exit555
  ...
  %161 = mul nuw nsw i64 %polly.indvar550, 20
...
polly.loop_exit555:                               ; preds = %polly.loop_exit577
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar_next551, 50
...
polly.loop_exit561:                               ; preds = %polly.loop_exit567
  ...
  %164 = mul nuw nsw i64 %polly.indvar556, 3
...
polly.loop_exit567:                               ; preds = %polly.loop_header565
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar_next563, 20
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_exit561
  ...
  %168 = mul nuw nsw i64 %polly.indvar578, 80
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar_next585, 20
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph962
  ...
  br i1 %205, label %polly.loop_exit764, label %vector.body960, !llvm.loop !104
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph978
  ...
  br i1 %234, label %polly.loop_exit791, label %vector.body975, !llvm.loop !107
...
vector.body993:                                   ; preds = %vector.body993, %vector.ph996
  ...
  br i1 %263, label %polly.loop_exit817, label %vector.body993, !llvm.loop !110
