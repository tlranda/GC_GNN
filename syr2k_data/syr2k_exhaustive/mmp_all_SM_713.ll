; ModuleID = 'syr2k_exhaustive/mmp_all_SM_713.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_713.c"
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %polly.loop_guard = icmp slt i64 %116, 24
...
polly.loop_exit230:                               ; preds = %polly.loop_exit269, %polly.loop_exit214
  ...
  %indvars.iv.next1097 = add nsw i64 %indvars.iv1096, -22
  %indvars.iv.next1099 = add nuw nsw i64 %indvars.iv1098, 11
  %indvars.iv.next1103 = add nuw nsw i64 %indvars.iv1102, 22
...
polly.loop_header228:                             ; preds = %polly.loop_exit214, %polly.loop_exit269
  ...
  %119 = mul nsw i64 %indvar1419, -50
  %120 = add i64 %104, %119
  %smax1421 = call i64 @llvm.smax.i64(i64 %120, i64 0)
  %121 = mul nuw nsw i64 %indvar1419, 50
  %122 = add i64 %106, %121
...
polly.loop_header267.preheader:                   ; preds = %polly.loop_exit255, %polly.loop_exit255.us, %polly.loop_header228.split
  ...
  %polly.loop_guard277 = icmp slt i64 %138, 50
...
polly.loop_header274.us:                          ; preds = %polly.loop_header267.us, %polly.loop_exit284.us
  ...
  %smin1424 = call i64 @llvm.smin.i64(i64 %139, i64 127)
...
vector.body1418:                                  ; preds = %vector.body1418, %vector.ph1426
  ...
  %wide.load1439 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %163, label %middle.block1416, label %vector.body1418, !llvm.loop !84
...
vector.body1354:                                  ; preds = %vector.body1354, %vector.ph1358
  ...
  %wide.load1365 = load <4 x double>, <4 x double>* %169, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %172, label %middle.block1352, label %vector.body1354, !llvm.loop !92
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit422
  ...
  %175 = shl nsw i64 %polly.indvar417, 7
...
polly.loop_header420:                             ; preds = %polly.loop_exit446, %polly.loop_header414
  ...
  %188 = shl nsw i64 %polly.indvar423, 7
  br label %polly.loop_header426

polly.loop_exit428:                               ; preds = %polly.loop_exit434
  %189 = mul nsw i64 %polly.indvar423, -128
  ...
  %polly.loop_guard447 = icmp slt i64 %193, 24
...
polly.loop_exit446:                               ; preds = %polly.loop_exit486, %polly.loop_exit428
  ...
  %indvars.iv.next1129 = add nsw i64 %indvars.iv1128, -22
  %indvars.iv.next1131 = add nuw nsw i64 %indvars.iv1130, 11
  %indvars.iv.next1136 = add nuw nsw i64 %indvars.iv1135, 22
...
polly.loop_header484.preheader:                   ; preds = %polly.loop_exit472, %polly.loop_exit472.us, %polly.loop_header444.split
  ...
  %polly.loop_guard494 = icmp slt i64 %215, 50
...
polly.loop_header491.us:                          ; preds = %polly.loop_header484.us, %polly.loop_exit501.us
  ...
  %smin1374 = call i64 @llvm.smin.i64(i64 %216, i64 127)
...
vector.body1368:                                  ; preds = %vector.body1368, %vector.ph1376
  ...
  %wide.load1389 = load <4 x double>, <4 x double>* %235, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %240, label %middle.block1366, label %vector.body1368, !llvm.loop !97
...
vector.body1306:                                  ; preds = %vector.body1306, %vector.ph1308
  ...
  %wide.load1315 = load <4 x double>, <4 x double>* %246, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %249, label %middle.block1304, label %vector.body1306, !llvm.loop !105
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit639
  ...
  %252 = shl nsw i64 %polly.indvar634, 7
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %253 = mul nsw i64 %polly.indvar640, -22
  %254 = mul nuw nsw i64 %polly.indvar640, 11
  %255 = add nuw i64 %254, 24
  %256 = udiv i64 %255, 25
  %257 = mul nuw nsw i64 %256, 50
  %258 = add i64 %253, %257
  %259 = mul nuw nsw i64 %polly.indvar640, 22
...
polly.loop_exit645:                               ; preds = %polly.loop_exit651
  ...
  %polly.loop_guard664 = icmp slt i64 %270, 24
...
polly.loop_exit663:                               ; preds = %polly.loop_exit703, %polly.loop_exit645
  ...
  %indvars.iv.next1162 = add nsw i64 %indvars.iv1161, -22
  %indvars.iv.next1164 = add nuw nsw i64 %indvars.iv1163, 11
  %indvars.iv.next1169 = add nuw nsw i64 %indvars.iv1168, 22
...
polly.loop_header701.preheader:                   ; preds = %polly.loop_exit689, %polly.loop_exit689.us, %polly.loop_header661.split
  ...
  %polly.loop_guard711 = icmp slt i64 %292, 50
...
polly.loop_header708.us:                          ; preds = %polly.loop_header701.us, %polly.loop_exit718.us
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %293, i64 127)
...
vector.body1318:                                  ; preds = %vector.body1318, %vector.ph1326
  ...
  %wide.load1339 = load <4 x double>, <4 x double>* %312, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %317, label %middle.block1316, label %vector.body1318, !llvm.loop !110
...
vector.body1245:                                  ; preds = %vector.body1245, %vector.ph1246
  ...
  br i1 %340, label %polly.loop_exit888, label %vector.body1245, !llvm.loop !116
...
vector.body1259:                                  ; preds = %vector.body1259, %vector.ph1262
  ...
  br i1 %369, label %polly.loop_exit915, label %vector.body1259, !llvm.loop !119
...
vector.body1277:                                  ; preds = %vector.body1277, %vector.ph1280
  ...
  br i1 %398, label %polly.loop_exit941, label %vector.body1277, !llvm.loop !122
