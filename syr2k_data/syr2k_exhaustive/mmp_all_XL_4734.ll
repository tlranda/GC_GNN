; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4734.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4734.c"
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %polly.loop_guard2331079 = icmp sgt i64 %132, -1
...
vector.body1187:                                  ; preds = %vector.body1187, %vector.ph1191
  ...
  %147 = shl nuw nsw i64 %index1194, 3
  %148 = getelementptr i8, i8* %scevgep379, i64 %147
  %149 = bitcast i8* %148 to <4 x double>*
  %wide.load1198 = load <4 x double>, <4 x double>* %149, align 8, !alias.scope !74, !noalias !76
  %150 = fmul fast <4 x double> %wide.load1198, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %152 = icmp eq i64 %index.next1195, %n.vec1193
  br i1 %152, label %middle.block1185, label %vector.body1187, !llvm.loop !80

middle.block1185:                                 ; preds = %vector.body1187
  %cmp.n1197 = icmp eq i64 %145, %n.vec1193
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %182 = shl nsw i64 %polly.indvar398, 5
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_exit440
  ...
  %polly.loop_guard4191080 = icmp sgt i64 %189, -1
...
polly.loop_header557:                             ; preds = %polly.loop_exit565, %polly.start471
  ...
  %min.iters.check1164 = icmp ult i64 %202, 4
...
vector.body1163:                                  ; preds = %vector.body1163, %vector.ph1165
  ...
  %204 = shl nuw nsw i64 %index1168, 3
  %205 = getelementptr i8, i8* %scevgep569, i64 %204
  %206 = bitcast i8* %205 to <4 x double>*
  %wide.load1172 = load <4 x double>, <4 x double>* %206, align 8, !alias.scope !84, !noalias !86
  %207 = fmul fast <4 x double> %wide.load1172, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %209 = icmp eq i64 %index.next1169, %n.vec1167
  br i1 %209, label %middle.block1161, label %vector.body1163, !llvm.loop !90

middle.block1161:                                 ; preds = %vector.body1163
  %cmp.n1171 = icmp eq i64 %202, %n.vec1167
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %211 = mul nsw i64 %polly.indvar576, -64
  %212 = icmp slt i64 %211, -1136
  %213 = select i1 %212, i64 %211, i64 -1136
  %214 = add nsw i64 %213, 1199
  %215 = shl nsw i64 %polly.indvar576, 6
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %239 = shl nsw i64 %polly.indvar588, 5
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header585
  ...
  %243 = add i64 %smax1025, %indvars.iv1028
  %244 = sub nsw i64 %215, %239
  %245 = add nuw nsw i64 %239, 32
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit630
  %indvars.iv1030 = phi i64 [ %243, %polly.loop_header592.preheader ], [ %indvars.iv.next1031, %polly.loop_exit630 ]
  ...
  %polly.loop_guard6091081 = icmp sgt i64 %246, -1
...
vector.ph1103:                                    ; preds = %polly.loop_header797
  %broadcast.splatinsert1110 = insertelement <4 x i64> poison, i64 %263, i32 0
  %broadcast.splat1111 = shufflevector <4 x i64> %broadcast.splatinsert1110, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1112 = insertelement <4 x i32> poison, i32 %266, i32 0
...
vector.body1102:                                  ; preds = %vector.body1102, %vector.ph1103
  ...
  %268 = add nuw nsw <4 x i64> %vec.ind1108, %broadcast.splat1111
  %269 = trunc <4 x i64> %268 to <4 x i32>
  %270 = mul <4 x i32> %broadcast.splat1113, %269
  ...
  %280 = icmp eq i64 %index.next1105, %262
  br i1 %280, label %polly.loop_exit805, label %vector.body1102, !llvm.loop !99

polly.loop_exit805:                               ; preds = %vector.body1102, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond1072.not = icmp eq i64 %polly.indvar800, %260
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond1068.not = icmp eq i64 %polly.indvar806, %264
...
polly.loop_header818:                             ; preds = %polly.loop_exit826, %polly.loop_header812
  ...
  %smin1117 = call i64 @llvm.smin.i64(i64 %290, i64 -968)
  %291 = add nsw i64 %smin1117, 1000
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1055, i64 -968)
  %292 = shl nsw i64 %polly.indvar821, 5
  %293 = add nsw i64 %smin1057, 999
...
vector.body1116:                                  ; preds = %vector.body1116, %vector.ph1119
  ...
  %297 = add nuw nsw <4 x i64> %vec.ind1126, %broadcast.splat1129
  %298 = trunc <4 x i64> %297 to <4 x i32>
  %299 = mul <4 x i32> %broadcast.splat1131, %298
  ...
  %309 = icmp eq i64 %index.next1123, %291
  br i1 %309, label %polly.loop_exit832, label %vector.body1116, !llvm.loop !102

polly.loop_exit832:                               ; preds = %vector.body1116, %polly.loop_header830
  %polly.indvar_next828 = add nuw nsw i64 %polly.indvar827, 1
  %exitcond1062.not = icmp eq i64 %polly.indvar827, %289
...
polly.loop_header830:                             ; preds = %polly.loop_header824, %polly.loop_header830
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar833, %293
...
polly.loop_header844:                             ; preds = %polly.loop_exit852, %polly.loop_header838
  ...
  %smin1135 = call i64 @llvm.smin.i64(i64 %319, i64 -968)
  %320 = add nsw i64 %smin1135, 1000
  %smin1047 = call i64 @llvm.smin.i64(i64 %indvars.iv1045, i64 -968)
  %321 = shl nsw i64 %polly.indvar847, 5
  %322 = add nsw i64 %smin1047, 999
...
vector.body1134:                                  ; preds = %vector.body1134, %vector.ph1137
  ...
  %326 = add nuw nsw <4 x i64> %vec.ind1144, %broadcast.splat1147
  %327 = trunc <4 x i64> %326 to <4 x i32>
  %328 = mul <4 x i32> %broadcast.splat1149, %327
  ...
  %338 = icmp eq i64 %index.next1141, %320
  br i1 %338, label %polly.loop_exit858, label %vector.body1134, !llvm.loop !105

polly.loop_exit858:                               ; preds = %vector.body1134, %polly.loop_header856
  %polly.indvar_next854 = add nuw nsw i64 %polly.indvar853, 1
  %exitcond1052.not = icmp eq i64 %polly.indvar853, %318
...
polly.loop_header856:                             ; preds = %polly.loop_header850, %polly.loop_header856
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar859, %322
