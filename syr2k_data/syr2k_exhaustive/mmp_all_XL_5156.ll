; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5156.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5156.c"
...
polly.loop_header387:                             ; preds = %polly.loop_exit395, %polly.loop_header381
  ...
  %129 = shl nsw i64 %polly.indvar390, 6
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1019.not = icmp eq i64 %polly.indvar_next391, 16
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %smin1039 = call i64 @llvm.smin.i64(i64 %indvars.iv1023, i64 -936)
  %158 = add nsw i64 %smin1039, 1000
  %159 = shl nsw i64 %polly.indvar578, 6
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar_next579, 16
