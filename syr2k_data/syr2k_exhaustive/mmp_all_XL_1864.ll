; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1864.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1864.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1049 = add nuw nsw i64 %indvars.iv1048, 32
  %exitcond1064.not = icmp eq i64 %polly.indvar_next220, 38
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %smin1060 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -968)
...
polly.loop_exit230:                               ; preds = %polly.loop_exit237, %polly.loop_header222
  ...
  %exitcond1063.not = icmp eq i64 %polly.indvar_next226, 32
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %116 = mul nsw i64 %polly.indvar231, 50
...
polly.loop_exit237:                               ; preds = %polly.loop_exit269, %polly.loop_header228
  ...
  %indvars.iv.next1047 = add i64 %indvars.iv1046, 50
...
polly.loop_header235:                             ; preds = %polly.loop_header235.preheader, %polly.loop_exit269
  ...
  %smin1365 = call i64 @llvm.smin.i64(i64 %123, i64 49)
  %124 = add nsw i64 %smin1365, 1
  %smin1058 = call i64 @llvm.smin.i64(i64 %indvars.iv1052, i64 49)
...
vector.body1361:                                  ; preds = %vector.body1361, %vector.ph1367
  ...
  %wide.load1380 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !64, !noalias !66
  ...
  store <4 x double> %147, <4 x double>* %148, align 8, !alias.scope !64, !noalias !66
  %index.next1371 = add i64 %index1370, 4
  %149 = icmp eq i64 %index.next1371, %n.vec1369
  br i1 %149, label %middle.block1359, label %vector.body1361, !llvm.loop !76
...
vector.body1299:                                  ; preds = %vector.body1299, %vector.ph1303
  ...
  %wide.load1310 = load <4 x double>, <4 x double>* %157, align 8, !alias.scope !78, !noalias !80
  ...
  store <4 x double> %158, <4 x double>* %159, align 8, !alias.scope !78, !noalias !80
  %index.next1307 = add i64 %index1306, 4
  %160 = icmp eq i64 %index.next1307, %n.vec1305
  br i1 %160, label %middle.block1297, label %vector.body1299, !llvm.loop !85
...
polly.loop_header422:                             ; preds = %polly.loop_exit414, %polly.loop_exit430
  ...
  %162 = mul nsw i64 %polly.indvar425, -32
  %163 = shl nuw nsw i64 %polly.indvar425, 5
  %164 = mul nuw nsw i64 %polly.indvar425, 9
  %165 = add nuw nsw i64 %164, 34
  %pexp.p_div_q434 = udiv i64 %165, 25
  %166 = sub nsw i64 %polly.indvar425, %pexp.p_div_q434
  %167 = add nsw i64 %166, 1
  %.inv932 = icmp slt i64 %166, 23
  %168 = select i1 %.inv932, i64 %167, i64 23
  %polly.loop_guard439 = icmp sgt i64 %168, -1
  %169 = mul nsw i64 %polly.indvar425, -32
  %170 = icmp slt i64 %169, -1168
  %171 = select i1 %170, i64 %169, i64 -1168
  %172 = add nsw i64 %171, 1199
  %173 = shl nsw i64 %polly.indvar425, 5
...
polly.loop_exit430:                               ; preds = %polly.loop_exit438
  ...
  %indvars.iv.next1079 = add nuw nsw i64 %indvars.iv1078, 32
  %exitcond1094.not = icmp eq i64 %polly.indvar_next426, 38
...
polly.loop_header428:                             ; preds = %polly.loop_exit438, %polly.loop_header422
  ...
  %smin1090 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 -968)
...
polly.loop_header436.preheader:                   ; preds = %polly.loop_header428
  %175 = shl nsw i64 %polly.indvar431, 5
...
polly.loop_exit438:                               ; preds = %polly.loop_exit446, %polly.loop_header428
  ...
  %exitcond1093.not = icmp eq i64 %polly.indvar_next432, 32
...
polly.loop_header436:                             ; preds = %polly.loop_header436.preheader, %polly.loop_exit446
  ...
  %178 = mul i64 %polly.indvar440, -50
  %179 = add i64 %163, %178
  %180 = add i64 %smax1314, %179
  %181 = mul nsw i64 %polly.indvar440, 50
...
polly.loop_exit446:                               ; preds = %polly.loop_exit482, %polly.loop_header436
  ...
  %indvars.iv.next1081 = add i64 %indvars.iv1080, -50
...
polly.loop_header444:                             ; preds = %polly.loop_header444.preheader, %polly.loop_exit482
  ...
  %smin1317 = call i64 @llvm.smin.i64(i64 %188, i64 49)
  %189 = add nsw i64 %smin1317, 1
  %smin1088 = call i64 @llvm.smin.i64(i64 %indvars.iv1082, i64 49)
...
vector.body1313:                                  ; preds = %vector.body1313, %vector.ph1319
  ...
  %wide.load1332 = load <4 x double>, <4 x double>* %209, align 8, !alias.scope !78, !noalias !80
  ...
  store <4 x double> %212, <4 x double>* %213, align 8, !alias.scope !78, !noalias !80
  %index.next1323 = add i64 %index1322, 4
  %214 = icmp eq i64 %index.next1323, %n.vec1321
  br i1 %214, label %middle.block1311, label %vector.body1313, !llvm.loop !89
...
vector.body1253:                                  ; preds = %vector.body1253, %vector.ph1255
  ...
  %wide.load1262 = load <4 x double>, <4 x double>* %222, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %225, label %middle.block1251, label %vector.body1253, !llvm.loop !98
...
polly.loop_header635:                             ; preds = %polly.loop_exit627, %polly.loop_exit643
  ...
  %227 = mul nsw i64 %polly.indvar638, -32
  %228 = shl nuw nsw i64 %polly.indvar638, 5
  %229 = mul nuw nsw i64 %polly.indvar638, 9
  %230 = add nuw nsw i64 %229, 34
  %pexp.p_div_q647 = udiv i64 %230, 25
  %231 = sub nsw i64 %polly.indvar638, %pexp.p_div_q647
  %232 = add nsw i64 %231, 1
  %.inv934 = icmp slt i64 %231, 23
  %233 = select i1 %.inv934, i64 %232, i64 23
  %polly.loop_guard652 = icmp sgt i64 %233, -1
  %234 = mul nsw i64 %polly.indvar638, -32
  %235 = icmp slt i64 %234, -1168
  %236 = select i1 %235, i64 %234, i64 -1168
  %237 = add nsw i64 %236, 1199
  %238 = shl nsw i64 %polly.indvar638, 5
...
polly.loop_exit643:                               ; preds = %polly.loop_exit651
  ...
  %exitcond1124.not = icmp eq i64 %polly.indvar_next639, 38
...
polly.loop_header641:                             ; preds = %polly.loop_exit651, %polly.loop_header635
  ...
  %smin1120 = call i64 @llvm.smin.i64(i64 %indvars.iv1099, i64 -968)
...
polly.loop_header649.preheader:                   ; preds = %polly.loop_header641
  %240 = shl nsw i64 %polly.indvar644, 5
...
polly.loop_exit651:                               ; preds = %polly.loop_exit659, %polly.loop_header641
  ...
  %exitcond1123.not = icmp eq i64 %polly.indvar_next645, 32
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit659
  ...
  %241 = mul i64 %polly.indvar653, 50
  %242 = add i64 %227, %241
  %smax1266 = call i64 @llvm.smax.i64(i64 %242, i64 0)
  %243 = mul i64 %polly.indvar653, -50
  %244 = add i64 %228, %243
  %245 = add i64 %smax1266, %244
  %246 = mul nsw i64 %polly.indvar653, 50
...
polly.loop_exit659:                               ; preds = %polly.loop_exit695, %polly.loop_header649
  ...
  %indvars.iv.next1106 = add i64 %indvars.iv1105, 50
  %indvars.iv.next1111 = add i64 %indvars.iv1110, -50
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit695
  ...
  %smin1269 = call i64 @llvm.smin.i64(i64 %253, i64 49)
  %254 = add nsw i64 %smin1269, 1
  %smin1118 = call i64 @llvm.smin.i64(i64 %indvars.iv1112, i64 49)
...
vector.body1265:                                  ; preds = %vector.body1265, %vector.ph1271
  ...
  %wide.load1284 = load <4 x double>, <4 x double>* %274, align 8, !alias.scope !91, !noalias !93
  ...
  store <4 x double> %277, <4 x double>* %278, align 8, !alias.scope !91, !noalias !93
  %index.next1275 = add i64 %index1274, 4
  %279 = icmp eq i64 %index.next1275, %n.vec1273
  br i1 %279, label %middle.block1263, label %vector.body1265, !llvm.loop !102
...
vector.body1192:                                  ; preds = %vector.body1192, %vector.ph1193
  ...
  store <4 x double> %298, <4 x double>* %303, align 8, !alias.scope !104, !noalias !106
  ...
  br i1 %304, label %polly.loop_exit872, label %vector.body1192, !llvm.loop !109
...
vector.body1206:                                  ; preds = %vector.body1206, %vector.ph1209
  ...
  store <4 x double> %327, <4 x double>* %332, align 8, !alias.scope !108, !noalias !111
  ...
  br i1 %333, label %polly.loop_exit899, label %vector.body1206, !llvm.loop !112
...
vector.body1224:                                  ; preds = %vector.body1224, %vector.ph1227
  ...
  store <4 x double> %356, <4 x double>* %361, align 8, !alias.scope !107, !noalias !114
  ...
  br i1 %362, label %polly.loop_exit925, label %vector.body1224, !llvm.loop !115
