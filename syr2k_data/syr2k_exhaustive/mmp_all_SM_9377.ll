; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9377.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9377.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %128 = udiv i64 %indvars.iv815, 25
  %129 = mul nsw i64 %polly.indvar357, -4
  %130 = shl nsw i64 %polly.indvar357, 2
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %132 = mul nuw nsw i64 %polly.indvar370, 50
  %133 = add nsw i64 %132, %129
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard377 = icmp slt i64 %135, 4
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %159 = udiv i64 %indvars.iv836, 25
  %160 = mul nsw i64 %polly.indvar515, -4
  %161 = shl nsw i64 %polly.indvar515, 2
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %163 = mul nuw nsw i64 %polly.indvar528, 50
  %164 = add nsw i64 %163, %160
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard535 = icmp slt i64 %166, 4
