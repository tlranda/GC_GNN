; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8964.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8964.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %105 = mul nuw nsw i64 %polly.indvar214, 96
...
polly.loop_header223:                             ; preds = %polly.loop_header217, %polly.loop_exit232
  %indvars.iv794 = phi i64 [ %104, %polly.loop_header217 ], [ %indvars.iv.next795, %polly.loop_exit232 ]
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph990
  ...
  %wide.load997 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %132, label %middle.block984, label %vector.body986, !llvm.loop !76
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %134 = shl nsw i64 %polly.indvar357, 3
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %135 = udiv i64 %polly.indvar363, 12
  %136 = mul nuw nsw i64 %135, 96
  %137 = sub nsw i64 %indvars.iv801, %136
  ...
  %139 = shl nsw i64 %polly.indvar363, 3
  %140 = mul nsw i64 %polly.indvar363, -8
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %142 = mul nuw nsw i64 %polly.indvar370, 96
  %143 = sub nsw i64 %139, %142
  %144 = icmp sgt i64 %143, 0
  %145 = select i1 %144, i64 %143, i64 0
  %146 = mul nsw i64 %polly.indvar370, -96
...
polly.loop_header380:                             ; preds = %polly.loop_header373, %polly.loop_exit390
  %indvars.iv810 = phi i64 [ %141, %polly.loop_header373 ], [ %indvars.iv.next811, %polly.loop_exit390 ]
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph964
  ...
  %wide.load971 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %169, label %middle.block960, label %vector.body962, !llvm.loop !85
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %172 = udiv i64 %polly.indvar521, 12
  %173 = mul nuw nsw i64 %172, 96
  %174 = sub nsw i64 %indvars.iv819, %173
  %175 = add i64 %indvars.iv824, %173
  ...
  %176 = shl nsw i64 %polly.indvar521, 3
  %177 = mul nsw i64 %polly.indvar521, -8
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv826 = phi i64 [ %indvars.iv.next827, %polly.loop_exit533 ], [ %175, %polly.loop_header518 ]
  %indvars.iv821 = phi i64 [ %indvars.iv.next822, %polly.loop_exit533 ], [ %174, %polly.loop_header518 ]
  ...
  %178 = add i64 %smax823, %indvars.iv826
  %179 = mul nuw nsw i64 %polly.indvar528, 96
  %180 = sub nsw i64 %176, %179
  %181 = icmp sgt i64 %180, 0
  %182 = select i1 %181, i64 %180, i64 0
  %183 = mul nsw i64 %polly.indvar528, -96
...
polly.loop_header538:                             ; preds = %polly.loop_header531, %polly.loop_exit548
  %indvars.iv828 = phi i64 [ %178, %polly.loop_header531 ], [ %indvars.iv.next829, %polly.loop_exit548 ]
...
vector.body900:                                   ; preds = %vector.body900, %vector.ph902
  ...
  br i1 %220, label %polly.loop_exit714, label %vector.body900, !llvm.loop !94
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph918
  ...
  br i1 %249, label %polly.loop_exit741, label %vector.body915, !llvm.loop !97
...
vector.body933:                                   ; preds = %vector.body933, %vector.ph936
  ...
  br i1 %278, label %polly.loop_exit767, label %vector.body933, !llvm.loop !100
