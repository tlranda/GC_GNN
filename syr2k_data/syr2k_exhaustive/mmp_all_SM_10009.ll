; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10009.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10009.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next798 = add nuw nsw i64 %indvars.iv797, 25
  %exitcond801.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar214, %97
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv791 = phi i64 [ %106, %polly.loop_header217.preheader ], [ %indvars.iv.next792, %polly.loop_exit225 ]
  %polly.indvar220 = phi i64 [ %105, %polly.loop_header217.preheader ], [ %polly.indvar_next221, %polly.loop_exit225 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv791, i64 255)
  %108 = add nsw i64 %polly.indvar220, %107
  %polly.loop_guard233886 = icmp sgt i64 %108, -1
...
polly.loop_header223.us:                          ; preds = %polly.loop_header217, %polly.loop_exit232.loopexit.us
  ...
  %112 = add nuw nsw i64 %polly.indvar226.us, %100
  %113 = shl i64 %112, 3
  %114 = add i64 %113, %110
  %scevgep240.us = getelementptr i8, i8* %call2, i64 %114
  ...
  %scevgep246.us = getelementptr i8, i8* %call1, i64 %114
...
polly.loop_header230.us:                          ; preds = %polly.loop_header223.us, %polly.loop_header230.us
  ...
  %115 = add nuw nsw i64 %polly.indvar234.us, %102
...
polly.loop_exit232.loopexit.us:                   ; preds = %polly.loop_header230.us
  ...
  %exitcond796.not = icmp eq i64 %polly.indvar226.us, %101
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %122 = shl nuw nsw i64 %index1008, 3
  %123 = getelementptr i8, i8* %scevgep350, i64 %122
  %124 = bitcast i8* %123 to <4 x double>*
  %wide.load1012 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !69, !noalias !71
  %125 = fmul fast <4 x double> %wide.load1012, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %127 = icmp eq i64 %index.next1009, %n.vec1007
  br i1 %127, label %middle.block999, label %vector.body1001, !llvm.loop !74

middle.block999:                                  ; preds = %vector.body1001
  %cmp.n1011 = icmp eq i64 %120, %n.vec1007
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv821 = phi i64 [ %indvars.iv.next822, %polly.loop_exit362 ], [ 24, %polly.loop_exit346 ]
  ...
  %129 = lshr i64 %indvars.iv821, 7
  %130 = mul nsw i64 %polly.indvar357, -50
  %131 = mul nuw nsw i64 %polly.indvar357, 50
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit369
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next805 = add nsw i64 %indvars.iv804, -50
  %indvars.iv.next810 = add nuw nsw i64 %indvars.iv809, 50
  %indvars.iv.next822 = add nuw nsw i64 %indvars.iv821, 25
  %exitcond825.not = icmp eq i64 %polly.indvar_next358, 24
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %132 = mul nuw nsw i64 %polly.indvar363, 80
  %133 = add nsw i64 %smin819, 999
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit376
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %indvars.iv.next818 = add nsw i64 %indvars.iv817, -80
  %exitcond824.not = icmp eq i64 %polly.indvar_next364, 13
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %134 = shl nsw i64 %polly.indvar370, 8
  %135 = add nsw i64 %134, %130
  %136 = icmp sgt i64 %135, 0
  %137 = select i1 %136, i64 %135, i64 0
  %polly.loop_guard377 = icmp slt i64 %137, 50
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %138 = add i64 %smax808, %indvars.iv811
  %139 = sub nsw i64 %131, %134
  br label %polly.loop_header374

polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  %polly.indvar_next371 = add nuw nsw i64 %polly.indvar370, 1
  %indvars.iv.next807 = add nsw i64 %indvars.iv806, 256
  %indvars.iv.next812 = add nsw i64 %indvars.iv811, -256
  %exitcond823.not = icmp eq i64 %polly.indvar370, %129
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv813 = phi i64 [ %138, %polly.loop_header374.preheader ], [ %indvars.iv.next814, %polly.loop_exit383 ]
  %polly.indvar378 = phi i64 [ %137, %polly.loop_header374.preheader ], [ %polly.indvar_next379, %polly.loop_exit383 ]
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 255)
  %140 = add nsw i64 %polly.indvar378, %139
  %polly.loop_guard391887 = icmp sgt i64 %140, -1
  %141 = add nuw nsw i64 %polly.indvar378, %131
...
polly.loop_header381.us:                          ; preds = %polly.loop_header374, %polly.loop_exit390.loopexit.us
  ...
  %144 = add nuw nsw i64 %polly.indvar384.us, %132
  %145 = shl i64 %144, 3
  %146 = add i64 %145, %142
  %scevgep398.us = getelementptr i8, i8* %call2, i64 %146
  ...
  %scevgep404.us = getelementptr i8, i8* %call1, i64 %146
...
polly.loop_header388.us:                          ; preds = %polly.loop_header381.us, %polly.loop_header388.us
  ...
  %147 = add nuw nsw i64 %polly.indvar392.us, %134
  %148 = mul nuw nsw i64 %147, 8000
  %149 = add nuw nsw i64 %148, %145
  %scevgep395.us = getelementptr i8, i8* %call1, i64 %149
  ...
  %scevgep401.us = getelementptr i8, i8* %call2, i64 %149
...
polly.loop_exit390.loopexit.us:                   ; preds = %polly.loop_header388.us
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar384.us, %133
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %154 = shl nuw nsw i64 %index982, 3
  %155 = getelementptr i8, i8* %scevgep508, i64 %154
  %156 = bitcast i8* %155 to <4 x double>*
  %wide.load986 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !78, !noalias !80
  %157 = fmul fast <4 x double> %wide.load986, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %159 = icmp eq i64 %index.next983, %n.vec981
  br i1 %159, label %middle.block975, label %vector.body977, !llvm.loop !83

middle.block975:                                  ; preds = %vector.body977
  %cmp.n985 = icmp eq i64 %152, %n.vec981
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv845 = phi i64 [ %indvars.iv.next846, %polly.loop_exit520 ], [ 24, %polly.loop_exit504 ]
  ...
  %161 = lshr i64 %indvars.iv845, 7
  %162 = mul nsw i64 %polly.indvar515, -50
  %163 = mul nuw nsw i64 %polly.indvar515, 50
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next846 = add nuw nsw i64 %indvars.iv845, 25
  %exitcond849.not = icmp eq i64 %polly.indvar_next516, 24
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  %indvars.iv841 = phi i64 [ %indvars.iv.next842, %polly.loop_exit527 ], [ 0, %polly.loop_header512 ]
  %polly.indvar521 = phi i64 [ %polly.indvar_next522, %polly.loop_exit527 ], [ 0, %polly.loop_header512 ]
  %smin843 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 -920)
  %164 = mul nuw nsw i64 %polly.indvar521, 80
  %165 = add nsw i64 %smin843, 999
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next522, 13
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %166 = shl nsw i64 %polly.indvar528, 8
  %167 = add nsw i64 %166, %162
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %polly.loop_guard535 = icmp slt i64 %169, 50
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %170 = add i64 %smax832, %indvars.iv835
  %171 = sub nsw i64 %163, %166
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %indvars.iv.next831 = add nsw i64 %indvars.iv830, 256
  %indvars.iv.next836 = add nsw i64 %indvars.iv835, -256
  %exitcond847.not = icmp eq i64 %polly.indvar528, %161
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv837 = phi i64 [ %170, %polly.loop_header532.preheader ], [ %indvars.iv.next838, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %169, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin839 = call i64 @llvm.smin.i64(i64 %indvars.iv837, i64 255)
  %172 = add nsw i64 %polly.indvar536, %171
  %polly.loop_guard549888 = icmp sgt i64 %172, -1
  %173 = add nuw nsw i64 %polly.indvar536, %163
...
polly.loop_header539.us:                          ; preds = %polly.loop_header532, %polly.loop_exit548.loopexit.us
  ...
  %176 = add nuw nsw i64 %polly.indvar542.us, %164
  %177 = shl i64 %176, 3
  %178 = add i64 %177, %174
  %scevgep556.us = getelementptr i8, i8* %call2, i64 %178
  ...
  %scevgep562.us = getelementptr i8, i8* %call1, i64 %178
...
polly.loop_header546.us:                          ; preds = %polly.loop_header539.us, %polly.loop_header546.us
  ...
  %179 = add nuw nsw i64 %polly.indvar550.us, %166
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar542.us, %165
  br i1 %exitcond844.not, label %polly.loop_exit541, label %polly.loop_header539.us
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin916 = call i64 @llvm.smin.i64(i64 %186, i64 -1168)
  %187 = add nsw i64 %smin916, 1200
  %smin874 = call i64 @llvm.smin.i64(i64 %indvars.iv872, i64 -1168)
  %188 = shl nsw i64 %polly.indvar703, 5
  %189 = add nsw i64 %smin874, 1199
...
vector.ph917:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert924 = insertelement <4 x i64> poison, i64 %188, i32 0
  %broadcast.splat925 = shufflevector <4 x i64> %broadcast.splatinsert924, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert926 = insertelement <4 x i32> poison, i32 %191, i32 0
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  %193 = add nuw nsw <4 x i64> %vec.ind922, %broadcast.splat925
  %194 = trunc <4 x i64> %193 to <4 x i32>
  %195 = mul <4 x i32> %broadcast.splat927, %194
  ...
  %205 = icmp eq i64 %index.next919, %187
  br i1 %205, label %polly.loop_exit714, label %vector.body915, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body915, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond879.not = icmp eq i64 %polly.indvar709, %185
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond875.not = icmp eq i64 %polly.indvar715, %189
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin931 = call i64 @llvm.smin.i64(i64 %215, i64 -968)
  %216 = add nsw i64 %smin931, 1000
  %smin864 = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 -968)
  %217 = shl nsw i64 %polly.indvar730, 5
  %218 = add nsw i64 %smin864, 999
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  %222 = add nuw nsw <4 x i64> %vec.ind940, %broadcast.splat943
  %223 = trunc <4 x i64> %222 to <4 x i32>
  %224 = mul <4 x i32> %broadcast.splat945, %223
  ...
  %234 = icmp eq i64 %index.next937, %216
  br i1 %234, label %polly.loop_exit741, label %vector.body930, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body930, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond869.not = icmp eq i64 %polly.indvar736, %214
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond865.not = icmp eq i64 %polly.indvar742, %218
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin949 = call i64 @llvm.smin.i64(i64 %244, i64 -968)
  %245 = add nsw i64 %smin949, 1000
  %smin854 = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 -968)
  %246 = shl nsw i64 %polly.indvar756, 5
  %247 = add nsw i64 %smin854, 999
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  %251 = add nuw nsw <4 x i64> %vec.ind958, %broadcast.splat961
  %252 = trunc <4 x i64> %251 to <4 x i32>
  %253 = mul <4 x i32> %broadcast.splat963, %252
  ...
  %263 = icmp eq i64 %index.next955, %245
  br i1 %263, label %polly.loop_exit767, label %vector.body948, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body948, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond859.not = icmp eq i64 %polly.indvar762, %243
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar768, %247
