; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2517.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2517.c"
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %105 = shl nuw nsw i64 %polly.indvar231, 7
  %106 = add i64 %97, %105
  %smax1342 = call i64 @llvm.smax.i64(i64 %106, i64 0)
  %107 = mul nsw i64 %polly.indvar231, -128
  %108 = add i64 %98, %107
  %109 = add i64 %smax1342, %108
  %110 = shl nsw i64 %polly.indvar231, 7
  %111 = add nsw i64 %110, %102
  %112 = icmp sgt i64 %111, 0
  %113 = select i1 %112, i64 %111, i64 0
  %polly.loop_guard238 = icmp slt i64 %113, 100
...
polly.loop_header235:                             ; preds = %polly.loop_header235.preheader, %polly.loop_exit269
  ...
  %smin1345 = call i64 @llvm.smin.i64(i64 %117, i64 127)
...
polly.loop_header422:                             ; preds = %polly.loop_exit414, %polly.loop_exit430
  ...
  %156 = mul nsw i64 %polly.indvar425, -100
  %157 = mul nuw nsw i64 %polly.indvar425, 100
  ...
  %161 = mul nsw i64 %polly.indvar425, -100
  %162 = mul nuw nsw i64 %polly.indvar425, 100
...
polly.loop_header436:                             ; preds = %polly.loop_header436.preheader, %polly.loop_exit446
  ...
  %164 = shl nuw nsw i64 %polly.indvar440, 7
  %165 = add i64 %156, %164
  %smax1294 = call i64 @llvm.smax.i64(i64 %165, i64 0)
  %166 = mul nsw i64 %polly.indvar440, -128
  %167 = add i64 %157, %166
  %168 = add i64 %smax1294, %167
  %169 = shl nsw i64 %polly.indvar440, 7
  %170 = add nsw i64 %169, %161
  %171 = icmp sgt i64 %170, 0
  %172 = select i1 %171, i64 %170, i64 0
  %polly.loop_guard447 = icmp slt i64 %172, 100
...
polly.loop_header444:                             ; preds = %polly.loop_header444.preheader, %polly.loop_exit482
  ...
  %smin1297 = call i64 @llvm.smin.i64(i64 %176, i64 127)
...
polly.loop_header635:                             ; preds = %polly.loop_exit627, %polly.loop_exit643
  ...
  %215 = mul nsw i64 %polly.indvar638, -100
  %216 = mul nuw nsw i64 %polly.indvar638, 100
  ...
  %220 = mul nsw i64 %polly.indvar638, -100
  %221 = mul nuw nsw i64 %polly.indvar638, 100
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit659
  ...
  %223 = shl nuw nsw i64 %polly.indvar653, 7
  %224 = add i64 %215, %223
  %smax1246 = call i64 @llvm.smax.i64(i64 %224, i64 0)
  %225 = mul nsw i64 %polly.indvar653, -128
  %226 = add i64 %216, %225
  %227 = add i64 %smax1246, %226
  %228 = shl nsw i64 %polly.indvar653, 7
  %229 = add nsw i64 %228, %220
  %230 = icmp sgt i64 %229, 0
  %231 = select i1 %230, i64 %229, i64 0
  %polly.loop_guard660 = icmp slt i64 %231, 100
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit695
  ...
  %smin1249 = call i64 @llvm.smin.i64(i64 %235, i64 127)
