; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6525.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6525.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next203, 75
...
polly.loop_header233.us:                          ; preds = %polly.loop_exit242.us, %polly.loop_header227.us
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 15)
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next858 = add nuw nsw i64 %indvars.iv857, 16
  %indvars.iv.next860 = add nuw nsw i64 %indvars.iv859, 4
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, -16
  %exitcond873.not = icmp eq i64 %polly.indvar_next374, 75
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  ...
  %polly.loop_guard409 = icmp slt i64 %140, 100
...
polly.loop_header406.us:                          ; preds = %polly.loop_exit416.us, %polly.loop_header399.us
  ...
  %smin870 = call i64 @llvm.smin.i64(i64 %indvars.iv868, i64 15)
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408.loopexit.us, %polly.loop_header393
  ...
  %indvars.iv.next862 = add i64 %indvars.iv861, -100
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %indvars.iv.next881 = add nuw nsw i64 %indvars.iv880, 16
  %indvars.iv.next883 = add nuw nsw i64 %indvars.iv882, 4
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, -16
  %exitcond896.not = icmp eq i64 %polly.indvar_next548, 75
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  ...
  %168 = mul nuw nsw i64 %polly.indvar570, 100
  %169 = sub nsw i64 %163, %168
  %170 = icmp sgt i64 %169, 0
  %171 = select i1 %170, i64 %169, i64 0
  %polly.loop_guard583 = icmp slt i64 %171, 100
