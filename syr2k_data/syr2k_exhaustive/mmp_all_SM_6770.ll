; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6770.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6770.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv834 = phi i64 [ %indvars.iv.next835, %polly.loop_exit223 ], [ 1, %polly.loop_exit207 ]
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar_next219, 300
...
polly.loop_exit235:                               ; preds = %polly.loop_exit242.loopexit.us, %polly.loop_header227
  ...
  %polly.loop_cond232 = icmp ult i64 %polly.indvar230, 3
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  %indvars.iv856 = phi i64 [ %indvars.iv.next857, %polly.loop_exit395 ], [ 1, %polly.loop_exit378 ]
  ...
  %124 = udiv i64 %indvars.iv856, 25
  %125 = mul nsw i64 %polly.indvar389, -4
  %126 = shl nsw i64 %polly.indvar389, 2
...
polly.loop_exit395:                               ; preds = %polly.loop_exit402
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next390, 300
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %127 = mul nuw nsw i64 %polly.indvar396, 50
  %128 = add nsw i64 %127, %125
  %129 = icmp sgt i64 %128, 0
  %130 = select i1 %129, i64 %128, i64 0
  %polly.loop_guard403 = icmp slt i64 %130, 4
...
polly.loop_exit402:                               ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %indvars.iv.next845 = add nsw i64 %indvars.iv844, 50
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit409
  ...
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 49)
...
polly.loop_exit409:                               ; preds = %polly.loop_exit416.loopexit.us, %polly.loop_header400
  ...
  %polly.loop_cond406 = icmp ult i64 %polly.indvar404, 3
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  %indvars.iv878 = phi i64 [ %indvars.iv.next879, %polly.loop_exit569 ], [ 1, %polly.loop_exit552 ]
  ...
  %151 = udiv i64 %indvars.iv878, 25
  %152 = mul nsw i64 %polly.indvar563, -4
  %153 = shl nsw i64 %polly.indvar563, 2
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next564, 300
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %154 = mul nuw nsw i64 %polly.indvar570, 50
  %155 = add nsw i64 %154, %152
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %polly.loop_guard577 = icmp slt i64 %157, 4
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590.loopexit.us, %polly.loop_header574
  ...
  %polly.loop_cond580 = icmp ult i64 %polly.indvar578, 3
