; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4755.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4755.c"
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1195
  ...
  %130 = shl nuw nsw i64 %index1198, 3
  %131 = getelementptr i8, i8* %scevgep379, i64 %130
  %132 = bitcast i8* %131 to <4 x double>*
  %wide.load1202 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !73, !noalias !75
  %133 = fmul fast <4 x double> %wide.load1202, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %135 = icmp eq i64 %index.next1199, %n.vec1197
  br i1 %135, label %middle.block1189, label %vector.body1191, !llvm.loop !79

middle.block1189:                                 ; preds = %vector.body1191
  %cmp.n1201 = icmp eq i64 %128, %n.vec1197
...
polly.loop_header558:                             ; preds = %polly.loop_exit566, %polly.start472
  ...
  %min.iters.check1168 = icmp ult i64 %168, 4
...
vector.body1167:                                  ; preds = %vector.body1167, %vector.ph1169
  ...
  %170 = shl nuw nsw i64 %index1172, 3
  %171 = getelementptr i8, i8* %scevgep570, i64 %170
  %172 = bitcast i8* %171 to <4 x double>*
  %wide.load1176 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !83, !noalias !85
  %173 = fmul fast <4 x double> %wide.load1176, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %175 = icmp eq i64 %index.next1173, %n.vec1171
  br i1 %175, label %middle.block1165, label %vector.body1167, !llvm.loop !89

middle.block1165:                                 ; preds = %vector.body1167
  %cmp.n1175 = icmp eq i64 %168, %n.vec1171
...
vector.ph1107:                                    ; preds = %polly.loop_header799
  %broadcast.splatinsert1114 = insertelement <4 x i64> poison, i64 %212, i32 0
  %broadcast.splat1115 = shufflevector <4 x i64> %broadcast.splatinsert1114, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1116 = insertelement <4 x i32> poison, i32 %215, i32 0
...
vector.body1106:                                  ; preds = %vector.body1106, %vector.ph1107
  ...
  %217 = add nuw nsw <4 x i64> %vec.ind1112, %broadcast.splat1115
  %218 = trunc <4 x i64> %217 to <4 x i32>
  %219 = mul <4 x i32> %broadcast.splat1117, %218
  ...
  %229 = icmp eq i64 %index.next1109, %211
  br i1 %229, label %polly.loop_exit807, label %vector.body1106, !llvm.loop !98
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %smin1121 = call i64 @llvm.smin.i64(i64 %239, i64 -968)
  %240 = add nsw i64 %smin1121, 1000
...
vector.body1120:                                  ; preds = %vector.body1120, %vector.ph1123
  ...
  %246 = add nuw nsw <4 x i64> %vec.ind1130, %broadcast.splat1133
  %247 = trunc <4 x i64> %246 to <4 x i32>
  %248 = mul <4 x i32> %broadcast.splat1135, %247
  ...
  %258 = icmp eq i64 %index.next1127, %240
  br i1 %258, label %polly.loop_exit834, label %vector.body1120, !llvm.loop !101
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %smin1139 = call i64 @llvm.smin.i64(i64 %268, i64 -968)
  %269 = add nsw i64 %smin1139, 1000
...
vector.body1138:                                  ; preds = %vector.body1138, %vector.ph1141
  ...
  %275 = add nuw nsw <4 x i64> %vec.ind1148, %broadcast.splat1151
  %276 = trunc <4 x i64> %275 to <4 x i32>
  %277 = mul <4 x i32> %broadcast.splat1153, %276
  ...
  %287 = icmp eq i64 %index.next1145, %269
  br i1 %287, label %polly.loop_exit860, label %vector.body1138, !llvm.loop !104
