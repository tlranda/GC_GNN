; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5454.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5454.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit219.3
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv839, i64 127)
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842, i64 127)
  %107 = or i64 %103, 1
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.1, i64 127)
  %111 = or i64 %103, 2
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.2, i64 127)
  %115 = or i64 %103, 3
  ...
  %smin.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.3, i64 127)
  %119 = or i64 %103, 4
  ...
  %smin.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.4, i64 127)
  %123 = or i64 %103, 5
  ...
  %smin.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.5, i64 127)
  %127 = or i64 %103, 6
  ...
  %smin.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next842.6, i64 127)
  %131 = or i64 %103, 7
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %157 = shl nsw i64 %polly.indvar381, 7
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit392.3
  ...
  %smin859 = call i64 @llvm.smin.i64(i64 %indvars.iv855, i64 127)
  ...
  %smin859.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858, i64 127)
  %163 = or i64 %159, 1
  ...
  %smin859.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.1, i64 127)
  %167 = or i64 %159, 2
  ...
  %smin859.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.2, i64 127)
  %171 = or i64 %159, 3
  ...
  %smin859.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.3, i64 127)
  %175 = or i64 %159, 4
  ...
  %smin859.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.4, i64 127)
  %179 = or i64 %159, 5
  ...
  %smin859.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.5, i64 127)
  %183 = or i64 %159, 6
  ...
  %smin859.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next858.6, i64 127)
  %187 = or i64 %159, 7
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %213 = shl nsw i64 %polly.indvar554, 7
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit565.3
  ...
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv872, i64 127)
  ...
  %smin876.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875, i64 127)
  %219 = or i64 %215, 1
  ...
  %smin876.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.1, i64 127)
  %223 = or i64 %215, 2
  ...
  %smin876.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.2, i64 127)
  %227 = or i64 %215, 3
  ...
  %smin876.4 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.3, i64 127)
  %231 = or i64 %215, 4
  ...
  %smin876.5 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.4, i64 127)
  %235 = or i64 %215, 5
  ...
  %smin876.6 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.5, i64 127)
  %239 = or i64 %215, 6
  ...
  %smin876.7 = call i64 @llvm.smin.i64(i64 %indvars.iv.next875.6, i64 127)
  %243 = or i64 %215, 7
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  %346 = mul nsw i64 %polly.indvar208, -128
  %347 = shl nsw i64 %polly.indvar208, 4
...
polly.loop_exit392.3:                             ; preds = %polly.loop_header390.3
  %392 = mul nsw i64 %polly.indvar381, -128
  %393 = shl nsw i64 %polly.indvar381, 4
...
polly.loop_exit565.3:                             ; preds = %polly.loop_header563.3
  %438 = mul nsw i64 %polly.indvar554, -128
  %439 = shl nsw i64 %polly.indvar554, 4
