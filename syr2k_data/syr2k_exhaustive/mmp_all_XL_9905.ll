; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9905.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9905.c"
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %138 = shl nsw i64 %polly.indvar363, 7
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next364, 8
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %smin844 = call i64 @llvm.smin.i64(i64 %indvars.iv842, i64 -872)
  %173 = shl nsw i64 %polly.indvar521, 7
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next522, 8
