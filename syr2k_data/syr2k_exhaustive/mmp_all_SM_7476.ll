; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7476.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7476.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar_next225, 10
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %107 = mul nsw i64 %polly.indvar230, 80
  %108 = add nsw i64 %107, %101
  %109 = icmp sgt i64 %108, 0
  %110 = select i1 %109, i64 %108, i64 0
  %polly.loop_guard237.not = icmp sgt i64 %110, %104
...
polly.loop_header234.preheader:                   ; preds = %polly.loop_header227
  ...
  %111 = add i64 %smax, %indvars.iv849
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  %indvars.iv851 = phi i64 [ %111, %polly.loop_header234.preheader ], [ %indvars.iv.next852, %polly.loop_exit243 ]
  ...
  %polly.loop_guard251934 = icmp sgt i64 %113, -1
  %114 = add nuw nsw i64 %polly.indvar238, %105
...
polly.loop_exit250.loopexit.us:                   ; preds = %polly.loop_header248.us
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next245.us, 100
...
vector.body1043:                                  ; preds = %vector.body1043, %vector.ph1047
  ...
  %127 = shl nuw nsw i64 %index1050, 3
  %128 = getelementptr i8, i8* %scevgep372, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1054 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !74, !noalias !76
  %130 = fmul fast <4 x double> %wide.load1054, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1051, %n.vec1049
  br i1 %132, label %middle.block1041, label %vector.body1043, !llvm.loop !80

middle.block1041:                                 ; preds = %vector.body1043
  %cmp.n1053 = icmp eq i64 %125, %n.vec1049
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %134 = add nuw nsw i64 %polly.indvar395, 6
  %pexp.p_div_q404 = udiv i64 %134, 5
  %135 = sub nsw i64 %polly.indvar395, %pexp.p_div_q404
  %136 = add nsw i64 %135, 1
  %.inv838 = icmp slt i64 %135, 14
  %137 = select i1 %.inv838, i64 %136, i64 14
  %polly.loop_guard409 = icmp sgt i64 %137, -1
  %138 = mul nsw i64 %polly.indvar395, -64
  %139 = icmp slt i64 %138, -1136
  %140 = select i1 %139, i64 %138, i64 -1136
  %141 = add nsw i64 %140, 1199
  %142 = shl nsw i64 %polly.indvar395, 6
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  %143 = mul nuw nsw i64 %polly.indvar401, 100
  br label %polly.loop_header406

polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  %polly.indvar_next402 = add nuw nsw i64 %polly.indvar401, 1
  %exitcond876.not = icmp eq i64 %polly.indvar_next402, 10
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %144 = mul nsw i64 %polly.indvar410, 80
  %145 = add nsw i64 %144, %138
  %146 = icmp sgt i64 %145, 0
  %147 = select i1 %146, i64 %145, i64 0
  %polly.loop_guard417.not = icmp sgt i64 %147, %141
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %exitcond875.not = icmp eq i64 %polly.indvar410, %137
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  %indvars.iv870 = phi i64 [ %148, %polly.loop_header414.preheader ], [ %indvars.iv.next871, %polly.loop_exit423 ]
  ...
  %polly.loop_guard431935 = icmp sgt i64 %150, -1
  %151 = add nuw nsw i64 %polly.indvar418, %142
...
polly.loop_header421.us:                          ; preds = %polly.loop_header414, %polly.loop_exit430.loopexit.us
  ...
  %154 = add nuw nsw i64 %polly.indvar424.us, %143
  %155 = shl i64 %154, 3
...
polly.loop_exit430.loopexit.us:                   ; preds = %polly.loop_header428.us
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar_next425.us, 100
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430.loopexit.us, %polly.loop_header414
  ...
  %polly.loop_cond420.not.not = icmp ult i64 %polly.indvar418, %141
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %min.iters.check1020 = icmp ult i64 %162, 4
...
vector.body1019:                                  ; preds = %vector.body1019, %vector.ph1021
  ...
  %164 = shl nuw nsw i64 %index1024, 3
  %165 = getelementptr i8, i8* %scevgep552, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load1028 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !84, !noalias !86
  %167 = fmul fast <4 x double> %wide.load1028, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next1025, %n.vec1023
  br i1 %169, label %middle.block1017, label %vector.body1019, !llvm.loop !90

middle.block1017:                                 ; preds = %vector.body1019
  %cmp.n1027 = icmp eq i64 %162, %n.vec1023
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %171 = add nuw nsw i64 %polly.indvar575, 6
  %pexp.p_div_q584 = udiv i64 %171, 5
  %172 = sub nsw i64 %polly.indvar575, %pexp.p_div_q584
  %173 = add nsw i64 %172, 1
  %.inv839 = icmp slt i64 %172, 14
  %174 = select i1 %.inv839, i64 %173, i64 14
  %polly.loop_guard589 = icmp sgt i64 %174, -1
  %175 = mul nsw i64 %polly.indvar575, -64
  %176 = icmp slt i64 %175, -1136
  %177 = select i1 %176, i64 %175, i64 -1136
  %178 = add nsw i64 %177, 1199
  %179 = shl nsw i64 %polly.indvar575, 6
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar_next582, 10
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %181 = mul nsw i64 %polly.indvar590, 80
  %182 = add nsw i64 %181, %175
  %183 = icmp sgt i64 %182, 0
  %184 = select i1 %183, i64 %182, i64 0
  %polly.loop_guard597.not = icmp sgt i64 %184, %178
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header586
  ...
  %185 = add i64 %smax886, %indvars.iv889
  %186 = sub nsw i64 %179, %181
...
polly.loop_exit596:                               ; preds = %polly.loop_exit603, %polly.loop_header586
  ...
  %exitcond896.not = icmp eq i64 %polly.indvar590, %174
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit603
  %indvars.iv891 = phi i64 [ %185, %polly.loop_header594.preheader ], [ %indvars.iv.next892, %polly.loop_exit603 ]
  ...
  %polly.loop_guard611936 = icmp sgt i64 %187, -1
  %188 = add nuw nsw i64 %polly.indvar598, %179
...
polly.loop_header601.us:                          ; preds = %polly.loop_header594, %polly.loop_exit610.loopexit.us
  ...
  %191 = add nuw nsw i64 %polly.indvar604.us, %180
  %192 = shl i64 %191, 3
...
polly.loop_exit610.loopexit.us:                   ; preds = %polly.loop_header608.us
  ...
  %exitcond895.not = icmp eq i64 %polly.indvar_next605.us, 100
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %smin958 = call i64 @llvm.smin.i64(i64 %201, i64 -1168)
  %202 = add nsw i64 %smin958, 1200
  %smin925 = call i64 @llvm.smin.i64(i64 %indvars.iv923, i64 -1168)
  %203 = shl nsw i64 %polly.indvar767, 5
  %204 = add nsw i64 %smin925, 1199
...
vector.ph959:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert966 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat967 = shufflevector <4 x i64> %broadcast.splatinsert966, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert968 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body957:                                   ; preds = %vector.body957, %vector.ph959
  ...
  %208 = add nuw nsw <4 x i64> %vec.ind964, %broadcast.splat967
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat969, %209
  ...
  %220 = icmp eq i64 %index.next961, %202
  br i1 %220, label %polly.loop_exit778, label %vector.body957, !llvm.loop !99

polly.loop_exit778:                               ; preds = %vector.body957, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond930.not = icmp eq i64 %polly.indvar773, %200
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %exitcond926.not = icmp eq i64 %polly.indvar779, %204
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %smin973 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin973, 1000
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -968)
  %232 = shl nsw i64 %polly.indvar794, 5
  %233 = add nsw i64 %smin915, 999
...
vector.body972:                                   ; preds = %vector.body972, %vector.ph975
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind982, %broadcast.splat985
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat987, %238
  ...
  %249 = icmp eq i64 %index.next979, %231
  br i1 %249, label %polly.loop_exit805, label %vector.body972, !llvm.loop !102

polly.loop_exit805:                               ; preds = %vector.body972, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond920.not = icmp eq i64 %polly.indvar800, %229
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar806, %233
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %smin991 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin991, 1000
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 -968)
  %261 = shl nsw i64 %polly.indvar820, 5
  %262 = add nsw i64 %smin905, 999
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph993
  ...
  %266 = add nuw nsw <4 x i64> %vec.ind1000, %broadcast.splat1003
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat1005, %267
  ...
  %278 = icmp eq i64 %index.next997, %260
  br i1 %278, label %polly.loop_exit831, label %vector.body990, !llvm.loop !105

polly.loop_exit831:                               ; preds = %vector.body990, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond910.not = icmp eq i64 %polly.indvar826, %258
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar832, %262
