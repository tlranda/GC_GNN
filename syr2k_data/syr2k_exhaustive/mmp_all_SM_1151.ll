; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1151.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1151.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %102 = add i64 %98, %101
  %103 = mul nuw nsw i64 %polly.indvar209, 20
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %polly.loop_guard = icmp slt i64 %113, 12
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit282
  ...
  %118 = mul nsw i64 %indvar1521, -100
  %119 = add i64 %102, %118
  %smax1523 = call i64 @llvm.smax.i64(i64 %119, i64 0)
  %120 = mul nuw nsw i64 %indvar1521, 100
  %121 = add i64 %104, %120
  ...
  %127 = icmp sgt i64 %126, 80
  %128 = select i1 %127, i64 %126, i64 80
  %129 = add nsw i64 %126, 99
  %polly.loop_guard269 = icmp sgt i64 %126, -100
...
polly.loop_header280.preheader:                   ; preds = %polly.merge, %polly.merge.us1059, %polly.merge.us
  ...
  %polly.loop_guard290 = icmp slt i64 %137, 100
...
polly.loop_header287.us:                          ; preds = %polly.loop_header280.us, %polly.loop_exit297.us
  ...
  %smin1526 = call i64 @llvm.smin.i64(i64 %138, i64 79)
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit435
  ...
  %174 = mul nuw nsw i64 %polly.indvar430, 50
...
polly.loop_header433:                             ; preds = %polly.loop_exit459, %polly.loop_header427
  ...
  %175 = mul nsw i64 %polly.indvar436, -20
  %176 = add nuw i64 %polly.indvar436, 4
  %177 = udiv i64 %176, 5
  %178 = mul nuw nsw i64 %177, 100
  %179 = add i64 %175, %178
  %180 = mul nuw nsw i64 %polly.indvar436, 20
...
polly.loop_header457:                             ; preds = %polly.loop_header457.preheader, %polly.loop_exit516
  ...
  %195 = mul nsw i64 %indvar1471, -100
  %196 = add i64 %179, %195
  %smax1473 = call i64 @llvm.smax.i64(i64 %196, i64 0)
  %197 = mul nuw nsw i64 %indvar1471, 100
  %198 = add i64 %181, %197
  ...
  %202 = mul nsw i64 %polly.indvar461, 100
  %203 = add nsw i64 %202, %188
  %204 = icmp sgt i64 %203, 80
  %205 = select i1 %204, i64 %203, i64 80
  %206 = add nsw i64 %203, 99
  %polly.loop_guard503 = icmp sgt i64 %203, -100
...
polly.loop_header514.preheader:                   ; preds = %polly.merge471, %polly.merge471.us1105, %polly.merge471.us
  ...
  %polly.loop_guard524 = icmp slt i64 %214, 100
...
polly.loop_header521.us:                          ; preds = %polly.loop_header514.us, %polly.loop_exit531.us
  ...
  %smin1476 = call i64 @llvm.smin.i64(i64 %215, i64 79)
...
polly.loop_header661:                             ; preds = %polly.loop_header661.preheader, %polly.loop_exit669
  ...
  %251 = mul nuw nsw i64 %polly.indvar664, 50
...
polly.loop_header667:                             ; preds = %polly.loop_exit693, %polly.loop_header661
  ...
  %252 = mul nsw i64 %polly.indvar670, -20
  %253 = add nuw i64 %polly.indvar670, 4
  %254 = udiv i64 %253, 5
  %255 = mul nuw nsw i64 %254, 100
  %256 = add i64 %252, %255
  %257 = mul nuw nsw i64 %polly.indvar670, 20
...
polly.loop_header691:                             ; preds = %polly.loop_header691.preheader, %polly.loop_exit750
  ...
  %272 = mul nsw i64 %indvar1421, -100
  %273 = add i64 %256, %272
  %smax1423 = call i64 @llvm.smax.i64(i64 %273, i64 0)
  %274 = mul nuw nsw i64 %indvar1421, 100
  %275 = add i64 %258, %274
  ...
  %279 = mul nsw i64 %polly.indvar695, 100
  %280 = add nsw i64 %279, %265
  %281 = icmp sgt i64 %280, 80
  %282 = select i1 %281, i64 %280, i64 80
  %283 = add nsw i64 %280, 99
  %polly.loop_guard737 = icmp sgt i64 %280, -100
...
polly.loop_header748.preheader:                   ; preds = %polly.merge705, %polly.merge705.us1151, %polly.merge705.us
  ...
  %polly.loop_guard758 = icmp slt i64 %291, 100
...
polly.loop_header755.us:                          ; preds = %polly.loop_header748.us, %polly.loop_exit765.us
  ...
  %smin1426 = call i64 @llvm.smin.i64(i64 %292, i64 79)
