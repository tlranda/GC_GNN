; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9582.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9582.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next203, 75
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1003
  ...
  %wide.load1010 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %126, label %middle.block997, label %vector.body999, !llvm.loop !73
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %128 = mul nsw i64 %polly.indvar357, -16
  %129 = shl nsw i64 %polly.indvar357, 4
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit368
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next803 = add nsw i64 %indvars.iv802, -16
  %indvars.iv.next808 = add nuw nsw i64 %indvars.iv807, 16
  %indvars.iv.next820 = add nuw nsw i64 %indvars.iv819, 2
  %exitcond823.not = icmp eq i64 %polly.indvar_next358, 75
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.loop_header354
  ...
  %130 = shl nsw i64 %polly.indvar363, 4
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %132 = shl nsw i64 %polly.indvar369, 3
  %133 = add nsw i64 %132, %128
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard376 = icmp slt i64 %135, 16
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph977
  ...
  %wide.load984 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %157, label %middle.block973, label %vector.body975, !llvm.loop !82
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %159 = mul nsw i64 %polly.indvar514, -16
  %160 = shl nsw i64 %polly.indvar514, 4
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar_next515, 75
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %161 = shl nsw i64 %polly.indvar520, 4
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %163 = shl nsw i64 %polly.indvar526, 3
  %164 = add nsw i64 %163, %159
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard533 = icmp slt i64 %166, 16
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph915
  ...
  br i1 %202, label %polly.loop_exit712, label %vector.body913, !llvm.loop !91
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph931
  ...
  br i1 %231, label %polly.loop_exit739, label %vector.body928, !llvm.loop !94
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph949
  ...
  br i1 %260, label %polly.loop_exit765, label %vector.body946, !llvm.loop !97
