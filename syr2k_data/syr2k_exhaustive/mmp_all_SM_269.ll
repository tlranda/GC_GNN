; ModuleID = 'syr2k_exhaustive/mmp_all_SM_269.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_269.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1104 = call i64 @llvm.smin.i64(i64 %indvars.iv1082, i64 -984)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1107.not = icmp eq i64 %polly.indvar_next204, 63
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %indvars.iv.next1091 = add nuw nsw i64 %indvars.iv1090, 50
  %indvars.iv.next1093 = add nuw nsw i64 %indvars.iv1092, 3
  %indvars.iv.next1097 = add nsw i64 %indvars.iv1096, -50
  %exitcond1106.not = icmp eq i64 %polly.indvar_next210, 24
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  ...
  %smin1418 = call i64 @llvm.smin.i64(i64 %138, i64 49)
  %139 = add nsw i64 %smin1418, 1
  %smin1102 = call i64 @llvm.smin.i64(i64 %indvars.iv1100, i64 49)
...
polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  ...
  %smin1137 = call i64 @llvm.smin.i64(i64 %indvars.iv1113, i64 -984)
  %173 = add nsw i64 %smin1137, 1000
  %174 = shl nsw i64 %polly.indvar415, 4
  br label %polly.loop_header418

polly.loop_exit420:                               ; preds = %polly.loop_exit443
  %polly.indvar_next416 = add nuw nsw i64 %polly.indvar415, 1
  %indvars.iv.next1114 = add nsw i64 %indvars.iv1113, -16
  %exitcond1140.not = icmp eq i64 %polly.indvar_next416, 63
...
polly.loop_exit443:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1123 = add nuw nsw i64 %indvars.iv1122, 50
  %indvars.iv.next1125 = add nuw nsw i64 %indvars.iv1124, 3
  %indvars.iv.next1130 = add nsw i64 %indvars.iv1129, -50
  %exitcond1139.not = icmp eq i64 %polly.indvar_next422, 24
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit426
  ...
  %.inv942 = icmp sgt i64 %201, 49
  %203 = select i1 %.inv942, i64 49, i64 %202
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1368 = call i64 @llvm.smin.i64(i64 %214, i64 49)
  %215 = add nsw i64 %smin1368, 1
  %smin1135 = call i64 @llvm.smin.i64(i64 %indvars.iv1133, i64 49)
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %smin1170 = call i64 @llvm.smin.i64(i64 %indvars.iv1146, i64 -984)
  %249 = add nsw i64 %smin1170, 1000
  %250 = shl nsw i64 %polly.indvar630, 4
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %indvars.iv.next1147 = add nsw i64 %indvars.iv1146, -16
...
polly.loop_exit658:                               ; preds = %polly.loop_exit697
  ...
  %indvars.iv.next1156 = add nuw nsw i64 %indvars.iv1155, 50
  %indvars.iv.next1158 = add nuw nsw i64 %indvars.iv1157, 3
  %indvars.iv.next1163 = add nsw i64 %indvars.iv1162, -50
  %exitcond1172.not = icmp eq i64 %polly.indvar_next637, 24
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  ...
  %smin1318 = call i64 @llvm.smin.i64(i64 %290, i64 49)
  %291 = add nsw i64 %smin1318, 1
  %smin1168 = call i64 @llvm.smin.i64(i64 %indvars.iv1166, i64 49)
