; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4738.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4738.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit220
  ...
  %130 = mul nsw i64 %polly.indvar214, 100
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %.inv873 = icmp slt i64 %161, 11
  %163 = select i1 %.inv873, i64 %162, i64 11
  %polly.loop_guard402 = icmp sgt i64 %163, -1
  %164 = mul nsw i64 %polly.indvar388, -64
  %165 = icmp slt i64 %164, -1136
  %166 = select i1 %165, i64 %164, i64 -1136
  %167 = add nsw i64 %166, 1199
  %168 = shl nsw i64 %polly.indvar388, 6
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %192 = mul nsw i64 %polly.indvar403, 100
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %.inv875 = icmp slt i64 %223, 11
  %225 = select i1 %.inv875, i64 %224, i64 11
  %polly.loop_guard595 = icmp sgt i64 %225, -1
  %226 = mul nsw i64 %polly.indvar581, -64
  %227 = icmp slt i64 %226, -1136
  %228 = select i1 %227, i64 %226, i64 -1136
  %229 = add nsw i64 %228, 1199
  %230 = shl nsw i64 %polly.indvar581, 6
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %254 = mul nsw i64 %polly.indvar596, 100
