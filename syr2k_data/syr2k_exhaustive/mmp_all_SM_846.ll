; ModuleID = 'syr2k_exhaustive/mmp_all_SM_846.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_846.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %97 = mul nsw i64 %polly.indvar203, -256
  %98 = shl nsw i64 %polly.indvar203, 8
  br label %polly.loop_header206

polly.loop_exit208:                               ; preds = %polly.loop_exit214
  %99 = add nsw i64 %97, 1199
  %100 = shl nsw i64 %polly.indvar203, 2
  br label %polly.loop_header222

polly.loop_exit224:                               ; preds = %polly.loop_exit261
  %polly.indvar_next204 = add nuw nsw i64 %polly.indvar203, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -256
  %indvars.iv.next1066 = add nsw i64 %indvars.iv1065, -256
  %exitcond1073.not = icmp eq i64 %polly.indvar_next204, 5
...
polly.loop_header222:                             ; preds = %polly.loop_exit261, %polly.loop_exit208
  ...
  %102 = shl nuw nsw i64 %indvar1358, 6
  %smin1069 = call i64 @llvm.smin.i64(i64 %indvars.iv1067, i64 -1136)
...
polly.loop_exit261:                               ; preds = %polly.loop_exit268.loopexit.us, %polly.loop_header259.preheader
  ...
  %indvars.iv.next1061 = add nuw nsw i64 %indvars.iv1060, 64
  %indvars.iv.next1068 = add nsw i64 %indvars.iv1067, -64
  %exitcond1072.not = icmp eq i64 %polly.indvar_next226, 19
...
polly.loop_header259.preheader:                   ; preds = %polly.loop_exit247, %polly.loop_exit247.us, %polly.loop_header222.split
  %113 = mul nsw i64 %polly.indvar225, -64
...
polly.loop_header266.us:                          ; preds = %polly.loop_header259.us, %polly.loop_exit275.us
  ...
  %smin1360 = call i64 @llvm.smin.i64(i64 %114, i64 255)
  %115 = add nuw nsw i64 %smin1360, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1062, i64 255)
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit428
  ...
  %149 = mul nsw i64 %polly.indvar407, -256
  %150 = shl nsw i64 %polly.indvar407, 8
...
polly.loop_exit428:                               ; preds = %polly.loop_exit467
  ...
  %indvars.iv.next1077 = add nsw i64 %indvars.iv1076, -256
  %indvars.iv.next1090 = add nsw i64 %indvars.iv1089, -256
  %exitcond1098.not = icmp eq i64 %polly.indvar_next408, 5
...
polly.loop_header426:                             ; preds = %polly.loop_exit467, %polly.loop_exit412
  ...
  %154 = shl nuw nsw i64 %indvar1311, 6
  ...
  %156 = shl nsw i64 %polly.indvar429, 6
  %157 = add nsw i64 %156, %149
  %158 = add nsw i64 %157, -1
  %.inv916 = icmp ugt i64 %157, 255
  %159 = select i1 %.inv916, i64 255, i64 %158
...
polly.loop_exit467:                               ; preds = %polly.loop_exit474.loopexit.us, %polly.loop_header465.preheader
  ...
  %exitcond1097.not = icmp eq i64 %polly.indvar_next430, 19
...
polly.loop_header465.preheader:                   ; preds = %polly.loop_exit453, %polly.loop_exit453.us, %polly.loop_header426.split
  %165 = mul nsw i64 %polly.indvar429, -64
...
polly.loop_header472.us:                          ; preds = %polly.loop_header465.us, %polly.loop_exit481.us
  ...
  %smin1313 = call i64 @llvm.smin.i64(i64 %166, i64 255)
  %167 = add nuw nsw i64 %smin1313, 1
  %smin1087 = call i64 @llvm.smin.i64(i64 %indvars.iv1085, i64 255)
...
polly.loop_header610:                             ; preds = %polly.loop_header610.preheader, %polly.loop_exit634
  ...
  %201 = mul nsw i64 %polly.indvar613, -256
  %202 = shl nsw i64 %polly.indvar613, 8
  br label %polly.loop_header616

polly.loop_exit618:                               ; preds = %polly.loop_exit624
  %203 = add nsw i64 %201, 1199
  %204 = shl nsw i64 %polly.indvar613, 2
...
polly.loop_exit634:                               ; preds = %polly.loop_exit673
  ...
  %exitcond1123.not = icmp eq i64 %polly.indvar_next614, 5
...
polly.loop_header632:                             ; preds = %polly.loop_exit673, %polly.loop_exit618
  ...
  %206 = shl nuw nsw i64 %indvar1264, 6
  ...
  %208 = shl nsw i64 %polly.indvar635, 6
  %209 = add nsw i64 %208, %201
  %210 = add nsw i64 %209, -1
  %.inv917 = icmp ugt i64 %209, 255
  %211 = select i1 %.inv917, i64 255, i64 %210
...
polly.loop_exit673:                               ; preds = %polly.loop_exit680.loopexit.us, %polly.loop_header671.preheader
  ...
  %exitcond1122.not = icmp eq i64 %polly.indvar_next636, 19
...
polly.loop_header671.preheader:                   ; preds = %polly.loop_exit659, %polly.loop_exit659.us, %polly.loop_header632.split
  %217 = mul nsw i64 %polly.indvar635, -64
...
polly.loop_header678.us:                          ; preds = %polly.loop_header671.us, %polly.loop_exit687.us
  ...
  %smin1266 = call i64 @llvm.smin.i64(i64 %218, i64 255)
