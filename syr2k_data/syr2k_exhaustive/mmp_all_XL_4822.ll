; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4822.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4822.c"
...
vector.body1208:                                  ; preds = %vector.body1208, %vector.ph1212
  ...
  %wide.load1219 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %133, label %middle.block1206, label %vector.body1208, !llvm.loop !80
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1186
  ...
  %wide.load1193 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %171, label %middle.block1182, label %vector.body1184, !llvm.loop !90
...
polly.loop_exit587:                               ; preds = %polly.loop_exit594
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next583, 8
...
vector.body1123:                                  ; preds = %vector.body1123, %vector.ph1124
  ...
  br i1 %223, label %polly.loop_exit805, label %vector.body1123, !llvm.loop !99
...
vector.body1137:                                  ; preds = %vector.body1137, %vector.ph1140
  ...
  br i1 %252, label %polly.loop_exit832, label %vector.body1137, !llvm.loop !102
...
vector.body1155:                                  ; preds = %vector.body1155, %vector.ph1158
  ...
  br i1 %281, label %polly.loop_exit858, label %vector.body1155, !llvm.loop !105
