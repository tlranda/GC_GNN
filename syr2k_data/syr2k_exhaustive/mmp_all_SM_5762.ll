; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5762.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5762.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin872 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -936)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond875.not = icmp eq i64 %polly.indvar_next203, 16
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  br i1 %exitcond906.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !86
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %smin902 = call i64 @llvm.smin.i64(i64 %indvars.iv881, i64 -936)
...
polly.loop_exit382:                               ; preds = %polly.loop_exit405
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next378, 16
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  br i1 %exitcond936.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !96
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %smin932 = call i64 @llvm.smin.i64(i64 %indvars.iv911, i64 -936)
...
polly.loop_exit560:                               ; preds = %polly.loop_exit583
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar_next556, 16
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph993
  ...
  br i1 %229, label %polly.loop_exit772, label %vector.body992, !llvm.loop !104
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  br i1 %exitcond961.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !105
...
vector.body1006:                                  ; preds = %vector.body1006, %vector.ph1009
  ...
  br i1 %258, label %polly.loop_exit799, label %vector.body1006, !llvm.loop !107
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  br i1 %exitcond951.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !108
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1027
  ...
  br i1 %287, label %polly.loop_exit825, label %vector.body1024, !llvm.loop !110
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  br i1 %exitcond941.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !111
}
