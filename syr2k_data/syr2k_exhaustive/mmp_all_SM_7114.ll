; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7114.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7114.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond839.not = icmp eq i64 %polly.indvar_next219, 60
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %100 = mul nuw nsw i64 %polly.indvar230, 100
...
polly.loop_header233:                             ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv833, i64 99)
...
polly.loop_exit241:                               ; preds = %polly.loop_exit247.loopexit.us, %polly.loop_header233
  ...
  %exitcond836.not = icmp eq i64 %polly.indvar_next237, 20
...
vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1022
  ...
  %wide.load1029 = load <4 x double>, <4 x double>* %118, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %121, label %middle.block1016, label %vector.body1018, !llvm.loop !79
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %123 = udiv i64 %polly.indvar391, 5
  %124 = mul nuw nsw i64 %polly.indvar391, 20
  br label %polly.loop_header394

polly.loop_exit396:                               ; preds = %polly.loop_exit403
  %polly.indvar_next392 = add nuw nsw i64 %polly.indvar391, 1
  %indvars.iv.next845 = add nuw nsw i64 %indvars.iv844, 20
  %exitcond856.not = icmp eq i64 %polly.indvar_next392, 60
...
polly.loop_header394:                             ; preds = %polly.loop_exit403, %polly.loop_header388
  ...
  %125 = mul nuw nsw i64 %polly.indvar397, 100
...
polly.loop_header401:                             ; preds = %polly.loop_exit409, %polly.loop_header394
  ...
  %126 = mul nuw nsw i64 %polly.indvar404, 100
...
polly.loop_exit415:                               ; preds = %polly.loop_exit422.loopexit.us, %polly.loop_header407
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next411, 20
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %147, label %middle.block992, label %vector.body994, !llvm.loop !89
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit572
  ...
  %149 = udiv i64 %polly.indvar567, 5
  %150 = mul nuw nsw i64 %polly.indvar567, 20
  br label %polly.loop_header570

polly.loop_exit572:                               ; preds = %polly.loop_exit579
  %polly.indvar_next568 = add nuw nsw i64 %polly.indvar567, 1
  %indvars.iv.next862 = add nuw nsw i64 %indvars.iv861, 20
  %exitcond873.not = icmp eq i64 %polly.indvar_next568, 60
...
polly.loop_header570:                             ; preds = %polly.loop_exit579, %polly.loop_header564
  ...
  %151 = mul nuw nsw i64 %polly.indvar573, 100
...
polly.loop_header577:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %152 = mul nuw nsw i64 %polly.indvar580, 100
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %smin867 = call i64 @llvm.smin.i64(i64 %indvars.iv865, i64 99)
...
polly.loop_exit591:                               ; preds = %polly.loop_exit598.loopexit.us, %polly.loop_header583
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next587, 20
...
vector.body932:                                   ; preds = %vector.body932, %vector.ph934
  ...
  br i1 %187, label %polly.loop_exit766, label %vector.body932, !llvm.loop !98
...
vector.body947:                                   ; preds = %vector.body947, %vector.ph950
  ...
  br i1 %216, label %polly.loop_exit793, label %vector.body947, !llvm.loop !101
...
vector.body965:                                   ; preds = %vector.body965, %vector.ph968
  ...
  br i1 %245, label %polly.loop_exit819, label %vector.body965, !llvm.loop !104
