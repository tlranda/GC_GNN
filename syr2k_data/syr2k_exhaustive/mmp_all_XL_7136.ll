; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7136.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7136.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next219, 60
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv824, i64 99)
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header227
  ...
  %exitcond827.not = icmp eq i64 %polly.indvar_next231, 20
...
polly.loop_header384:                             ; preds = %polly.loop_exit376, %polly.loop_exit393
  ...
  %120 = mul nuw nsw i64 %polly.indvar387, 20
...
polly.loop_exit393:                               ; preds = %polly.loop_exit399
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar_next388, 60
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412.loopexit.us, %polly.loop_header397
  ...
  %exitcond843.not = icmp eq i64 %polly.indvar_next401, 20
...
polly.loop_header556:                             ; preds = %polly.loop_exit548, %polly.loop_exit565
  ...
  %142 = mul nuw nsw i64 %polly.indvar559, 20
...
polly.loop_exit565:                               ; preds = %polly.loop_exit571
  ...
  %indvars.iv.next851 = add nuw nsw i64 %indvars.iv850, 20
  %exitcond861.not = icmp eq i64 %polly.indvar_next560, 60
...
polly.loop_exit571:                               ; preds = %polly.loop_exit577
  ...
  %indvars.iv.next853 = add nsw i64 %indvars.iv852, -100
...
polly.loop_exit577:                               ; preds = %polly.loop_exit584.loopexit.us, %polly.loop_header569
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next573, 20
