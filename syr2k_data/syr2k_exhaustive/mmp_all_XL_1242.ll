; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1242.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1242.c"
...
vector.body1328:                                  ; preds = %vector.body1328, %vector.ph1330
  ...
  br i1 %57, label %middle.block1326, label %vector.body1328, !llvm.loop !64
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond1105.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !80
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1100 = call i64 @llvm.smin.i64(i64 %indvars.iv1080, i64 -984)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar_next204, 63
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %exitcond1103.not = icmp eq i64 %polly.indvar_next210, 5
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %105 = shl nuw nsw i64 %indvar1402, 7
  ...
  %107 = shl nsw i64 %polly.indvar231, 7
  %108 = add nsw i64 %107, %99
  %109 = add nsw i64 %108, -1
  %.inv = icmp ugt i64 %108, 255
  %110 = select i1 %.inv, i64 255, i64 %109
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us, %polly.loop_header228.split
  %118 = mul nsw i64 %polly.indvar231, -128
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit281.us
  ...
  %smin1404 = call i64 @llvm.smin.i64(i64 %119, i64 255)
  %120 = add nuw nsw i64 %smin1404, 1
  %smin1092 = call i64 @llvm.smin.i64(i64 %indvars.iv1090, i64 255)
...
vector.body1401:                                  ; preds = %vector.body1401, %vector.ph1406
  ...
  %wide.load1419 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %140, label %middle.block1399, label %vector.body1401, !llvm.loop !84
...
polly.loop_header279.us:                          ; preds = %polly.loop_header279.us.preheader, %polly.loop_header279.us
  ...
  br i1 %exitcond1093.not, label %polly.loop_exit281.us, label %polly.loop_header279.us, !llvm.loop !85
...
vector.body1340:                                  ; preds = %vector.body1340, %vector.ph1344
  ...
  %wide.load1351 = load <4 x double>, <4 x double>* %149, align 8, !alias.scope !86, !noalias !88
  ...
  store <4 x double> %150, <4 x double>* %151, align 8, !alias.scope !86, !noalias !88
  %index.next1348 = add i64 %index1347, 4
  %152 = icmp eq i64 %index.next1348, %n.vec1346
  br i1 %152, label %middle.block1338, label %vector.body1340, !llvm.loop !93
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_header400
  ...
  br i1 %exitcond1137.not, label %polly.loop_exit402, label %polly.loop_header400, !llvm.loop !94
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %smin1132 = call i64 @llvm.smin.i64(i64 %indvars.iv1110, i64 -984)
  %154 = add nsw i64 %smin1132, 1000
  %155 = shl nsw i64 %polly.indvar413, 4
  br label %polly.loop_header416

polly.loop_exit418:                               ; preds = %polly.loop_exit440
  %polly.indvar_next414 = add nuw nsw i64 %polly.indvar413, 1
  %indvars.iv.next1111 = add nsw i64 %indvars.iv1110, -16
  %exitcond1136.not = icmp eq i64 %polly.indvar_next414, 63
...
polly.loop_header416:                             ; preds = %polly.loop_exit440, %polly.loop_header410
  ...
  %156 = mul nsw i64 %polly.indvar419, -256
  %157 = shl nsw i64 %polly.indvar419, 8
...
polly.loop_exit440:                               ; preds = %polly.loop_exit479
  ...
  %indvars.iv.next1108 = add nsw i64 %indvars.iv1107, -256
  %indvars.iv.next1126 = add nsw i64 %indvars.iv1125, -256
  %exitcond1135.not = icmp eq i64 %polly.indvar_next420, 5
...
polly.loop_header438:                             ; preds = %polly.loop_exit479, %polly.loop_exit424
  ...
  %162 = shl nuw nsw i64 %indvar1355, 7
  ...
  %164 = shl nsw i64 %polly.indvar441, 7
  %165 = add nsw i64 %164, %156
  %166 = add nsw i64 %165, -1
  %.inv934 = icmp ugt i64 %165, 255
  %167 = select i1 %.inv934, i64 255, i64 %166
...
polly.loop_header477.preheader:                   ; preds = %polly.loop_exit465, %polly.loop_exit465.us, %polly.loop_header438.split
  %175 = mul nsw i64 %polly.indvar441, -128
...
polly.loop_header484.us:                          ; preds = %polly.loop_header477.us, %polly.loop_exit493.us
  ...
  %smin1357 = call i64 @llvm.smin.i64(i64 %176, i64 255)
  %177 = add nuw nsw i64 %smin1357, 1
  %smin1123 = call i64 @llvm.smin.i64(i64 %indvars.iv1121, i64 255)
...
vector.body1354:                                  ; preds = %vector.body1354, %vector.ph1359
  ...
  %wide.load1372 = load <4 x double>, <4 x double>* %192, align 8, !alias.scope !86, !noalias !88
  ...
  store <4 x double> %195, <4 x double>* %196, align 8, !alias.scope !86, !noalias !88
  %index.next1363 = add i64 %index1362, 4
  %197 = icmp eq i64 %index.next1363, %n.vec1361
  br i1 %197, label %middle.block1352, label %vector.body1354, !llvm.loop !97
...
polly.loop_header491.us:                          ; preds = %polly.loop_header491.us.preheader, %polly.loop_header491.us
  ...
  br i1 %exitcond1124.not, label %polly.loop_exit493.us, label %polly.loop_header491.us, !llvm.loop !98
...
polly.start518:                                   ; preds = %init_array.exit
  %malloccall520 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
  %malloccall522 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
vector.body1295:                                  ; preds = %vector.body1295, %vector.ph1297
  ...
  %wide.load1304 = load <4 x double>, <4 x double>* %206, align 8, !alias.scope !99, !noalias !101
  ...
  store <4 x double> %207, <4 x double>* %208, align 8, !alias.scope !99, !noalias !101
  %index.next1301 = add i64 %index1300, 4
  %209 = icmp eq i64 %index.next1301, %n.vec1299
  br i1 %209, label %middle.block1293, label %vector.body1295, !llvm.loop !106
...
polly.loop_header612:                             ; preds = %polly.loop_header612.preheader, %polly.loop_header612
  ...
  br i1 %exitcond1169.not, label %polly.loop_exit614, label %polly.loop_header612, !llvm.loop !107
...
polly.loop_header622:                             ; preds = %polly.loop_header622.preheader, %polly.loop_exit630
  ...
  %smin1164 = call i64 @llvm.smin.i64(i64 %indvars.iv1142, i64 -984)
  %211 = add nsw i64 %smin1164, 1000
  %212 = shl nsw i64 %polly.indvar625, 4
...
polly.loop_exit630:                               ; preds = %polly.loop_exit652
  ...
  %indvars.iv.next1143 = add nsw i64 %indvars.iv1142, -16
  %exitcond1168.not = icmp eq i64 %polly.indvar_next626, 63
...
polly.loop_header628:                             ; preds = %polly.loop_exit652, %polly.loop_header622
  ...
  %213 = mul nsw i64 %polly.indvar631, -256
  %214 = shl nsw i64 %polly.indvar631, 8
...
polly.loop_exit652:                               ; preds = %polly.loop_exit691
  ...
  %indvars.iv.next1140 = add nsw i64 %indvars.iv1139, -256
  %indvars.iv.next1158 = add nsw i64 %indvars.iv1157, -256
  %exitcond1167.not = icmp eq i64 %polly.indvar_next632, 5
...
polly.loop_header650:                             ; preds = %polly.loop_exit691, %polly.loop_exit636
  ...
  %219 = shl nuw nsw i64 %indvar1308, 7
  ...
  %221 = shl nsw i64 %polly.indvar653, 7
  %222 = add nsw i64 %221, %213
  %223 = add nsw i64 %222, -1
  %.inv935 = icmp ugt i64 %222, 255
  %224 = select i1 %.inv935, i64 255, i64 %223
...
polly.loop_header689.preheader:                   ; preds = %polly.loop_exit677, %polly.loop_exit677.us, %polly.loop_header650.split
  %232 = mul nsw i64 %polly.indvar653, -128
...
polly.loop_header696.us:                          ; preds = %polly.loop_header689.us, %polly.loop_exit705.us
  ...
  %smin1310 = call i64 @llvm.smin.i64(i64 %233, i64 255)
  %234 = add nuw nsw i64 %smin1310, 1
  %smin1155 = call i64 @llvm.smin.i64(i64 %indvars.iv1153, i64 255)
...
vector.body1307:                                  ; preds = %vector.body1307, %vector.ph1312
  ...
  %wide.load1325 = load <4 x double>, <4 x double>* %249, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %254, label %middle.block1305, label %vector.body1307, !llvm.loop !110
...
polly.loop_header703.us:                          ; preds = %polly.loop_header703.us.preheader, %polly.loop_header703.us
  ...
  br i1 %exitcond1156.not, label %polly.loop_exit705.us, label %polly.loop_header703.us, !llvm.loop !111
...
vector.body1234:                                  ; preds = %vector.body1234, %vector.ph1235
  ...
  store <4 x double> %274, <4 x double>* %279, align 8, !alias.scope !112, !noalias !114
  ...
  br i1 %280, label %polly.loop_exit874, label %vector.body1234, !llvm.loop !117
...
polly.loop_header872:                             ; preds = %polly.loop_header866, %polly.loop_header872
  ...
  br i1 %exitcond1194.not, label %polly.loop_exit874, label %polly.loop_header872, !llvm.loop !118
...
vector.body1248:                                  ; preds = %vector.body1248, %vector.ph1251
  ...
  store <4 x double> %303, <4 x double>* %308, align 8, !alias.scope !116, !noalias !119
  ...
  br i1 %309, label %polly.loop_exit901, label %vector.body1248, !llvm.loop !120
...
polly.loop_header899:                             ; preds = %polly.loop_header893, %polly.loop_header899
  ...
  br i1 %exitcond1184.not, label %polly.loop_exit901, label %polly.loop_header899, !llvm.loop !121
...
vector.body1266:                                  ; preds = %vector.body1266, %vector.ph1269
  ...
  store <4 x double> %332, <4 x double>* %337, align 8, !alias.scope !115, !noalias !122
  ...
  br i1 %338, label %polly.loop_exit927, label %vector.body1266, !llvm.loop !123
...
polly.loop_header925:                             ; preds = %polly.loop_header919, %polly.loop_header925
  ...
  br i1 %exitcond1174.not, label %polly.loop_exit927, label %polly.loop_header925, !llvm.loop !124
}
