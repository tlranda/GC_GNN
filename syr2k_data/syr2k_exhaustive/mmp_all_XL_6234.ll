; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6234.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6234.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next203, 20
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar_next209, 12
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %indvars.iv856 = phi i64 [ %indvars.iv.next857, %polly.loop_exit235 ], [ %101, %polly.loop_exit213 ]
  ...
  %107 = add i64 %smax, %indvars.iv860
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233.us, %polly.loop_exit248.us
  %indvars.iv862 = phi i64 [ %107, %polly.loop_header233.us ], [ %indvars.iv.next863, %polly.loop_exit248.us ]
  %polly.indvar242.us = phi i64 [ %111, %polly.loop_header233.us ], [ %polly.indvar_next243.us, %polly.loop_exit248.us ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 99)
  %114 = add nuw i64 %polly.indvar242.us, %108
  %115 = add i64 %114, %104
  %polly.loop_guard249.us945 = icmp sgt i64 %115, -1
...
polly.loop_exit241.loopexit.us:                   ; preds = %polly.loop_exit248.us
  ...
  %exitcond865.not = icmp eq i64 %polly.indvar_next237.us, 50
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header227
  ...
  %indvars.iv.next857 = add i64 %indvars.iv856, -80
...
vector.body1054:                                  ; preds = %vector.body1054, %vector.ph1058
  ...
  %126 = shl nuw nsw i64 %index1061, 3
  %127 = getelementptr i8, i8* %scevgep370, i64 %126
  %128 = bitcast i8* %127 to <4 x double>*
  %wide.load1065 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !79, !noalias !81
  %129 = fmul fast <4 x double> %wide.load1065, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %131 = icmp eq i64 %index.next1062, %n.vec1060
  br i1 %131, label %middle.block1052, label %vector.body1054, !llvm.loop !85

middle.block1052:                                 ; preds = %vector.body1054
  %cmp.n1064 = icmp eq i64 %124, %n.vec1060
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %134 = lshr i64 %polly.indvar383, 2
  %135 = add nuw i64 %polly.indvar383, %134
  %136 = mul nuw nsw i64 %135, 80
  %137 = sub i64 %indvars.iv874, %136
  %138 = add i64 %indvars.iv879, %136
  %139 = mul nuw nsw i64 %polly.indvar383, 100
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %140 = mul nsw i64 %polly.indvar383, -100
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit411
  %polly.indvar_next384 = add nuw nsw i64 %polly.indvar383, 1
  %indvars.iv.next871 = add nsw i64 %indvars.iv870, -100
  %indvars.iv.next875 = add nuw nsw i64 %indvars.iv874, 100
  %indvars.iv.next880 = add nsw i64 %indvars.iv879, -100
...
polly.loop_exit394:                               ; preds = %polly.loop_header392
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar_next390, 50
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  %indvars.iv881 = phi i64 [ %indvars.iv.next882, %polly.loop_exit411 ], [ %138, %polly.loop_exit388 ]
  %indvars.iv876 = phi i64 [ %indvars.iv.next877, %polly.loop_exit411 ], [ %137, %polly.loop_exit388 ]
  ...
  %143 = add i64 %smax878, %indvars.iv881
...
polly.loop_header416.us:                          ; preds = %polly.loop_header409.us, %polly.loop_exit426.us
  %indvars.iv883 = phi i64 [ %143, %polly.loop_header409.us ], [ %indvars.iv.next884, %polly.loop_exit426.us ]
  %polly.indvar420.us = phi i64 [ %147, %polly.loop_header409.us ], [ %polly.indvar_next421.us, %polly.loop_exit426.us ]
  %smin885 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 99)
  %150 = add nuw i64 %polly.indvar420.us, %144
  %151 = add i64 %150, %140
  %polly.loop_guard427.us946 = icmp sgt i64 %151, -1
...
polly.loop_exit418.loopexit.us:                   ; preds = %polly.loop_exit426.us
  ...
  %exitcond887.not = icmp eq i64 %polly.indvar_next413.us, 50
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418.loopexit.us, %polly.loop_header403
  ...
  %indvars.iv.next877 = add i64 %indvars.iv876, -80
  %indvars.iv.next882 = add i64 %indvars.iv881, 80
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1031 = icmp ult i64 %160, 4
...
vector.body1030:                                  ; preds = %vector.body1030, %vector.ph1032
  ...
  %162 = shl nuw nsw i64 %index1035, 3
  %163 = getelementptr i8, i8* %scevgep548, i64 %162
  %164 = bitcast i8* %163 to <4 x double>*
  %wide.load1039 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !89, !noalias !91
  %165 = fmul fast <4 x double> %wide.load1039, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %167 = icmp eq i64 %index.next1036, %n.vec1034
  br i1 %167, label %middle.block1028, label %vector.body1030, !llvm.loop !95

middle.block1028:                                 ; preds = %vector.body1030
  %cmp.n1038 = icmp eq i64 %160, %n.vec1034
...
polly.loop_exit560:                               ; preds = %polly.loop_exit583
  ...
  %exitcond911.not = icmp eq i64 %polly.indvar_next556, 20
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %170 = lshr i64 %polly.indvar561, 2
  %171 = add nuw i64 %polly.indvar561, %170
  %172 = mul nuw nsw i64 %171, 80
  %173 = sub i64 %indvars.iv896, %172
  %174 = add i64 %indvars.iv901, %172
  %175 = mul nuw nsw i64 %polly.indvar561, 100
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %176 = mul nsw i64 %polly.indvar561, -100
  br label %polly.loop_header581

polly.loop_exit583:                               ; preds = %polly.loop_exit589
  %polly.indvar_next562 = add nuw nsw i64 %polly.indvar561, 1
  %indvars.iv.next893 = add nsw i64 %indvars.iv892, -100
  %indvars.iv.next897 = add nuw nsw i64 %indvars.iv896, 100
  %indvars.iv.next902 = add nsw i64 %indvars.iv901, -100
  %exitcond910.not = icmp eq i64 %polly.indvar_next562, 12
...
polly.loop_exit572:                               ; preds = %polly.loop_header570
  ...
  %exitcond895.not = icmp eq i64 %polly.indvar_next568, 50
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  %indvars.iv903 = phi i64 [ %indvars.iv.next904, %polly.loop_exit589 ], [ %174, %polly.loop_exit566 ]
  %indvars.iv898 = phi i64 [ %indvars.iv.next899, %polly.loop_exit589 ], [ %173, %polly.loop_exit566 ]
  ...
  %179 = add i64 %smax900, %indvars.iv903
...
polly.loop_header594.us:                          ; preds = %polly.loop_header587.us, %polly.loop_exit604.us
  %indvars.iv905 = phi i64 [ %179, %polly.loop_header587.us ], [ %indvars.iv.next906, %polly.loop_exit604.us ]
  ...
  %187 = add i64 %186, %176
  %polly.loop_guard605.us947 = icmp sgt i64 %187, -1
...
polly.loop_exit596.loopexit.us:                   ; preds = %polly.loop_exit604.us
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar_next591.us, 50
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header581
  ...
  %indvars.iv.next904 = add i64 %indvars.iv903, 80
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin969 = call i64 @llvm.smin.i64(i64 %198, i64 -1168)
  %199 = add nsw i64 %smin969, 1200
  %smin936 = call i64 @llvm.smin.i64(i64 %indvars.iv934, i64 -1168)
  %200 = shl nsw i64 %polly.indvar761, 5
  %201 = add nsw i64 %smin936, 1199
...
vector.ph970:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert977 = insertelement <4 x i64> poison, i64 %200, i32 0
  %broadcast.splat978 = shufflevector <4 x i64> %broadcast.splatinsert977, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert979 = insertelement <4 x i32> poison, i32 %203, i32 0
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %205 = add nuw nsw <4 x i64> %vec.ind975, %broadcast.splat978
  %206 = trunc <4 x i64> %205 to <4 x i32>
  %207 = mul <4 x i32> %broadcast.splat980, %206
  ...
  %217 = icmp eq i64 %index.next972, %199
  br i1 %217, label %polly.loop_exit772, label %vector.body968, !llvm.loop !104

polly.loop_exit772:                               ; preds = %vector.body968, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond941.not = icmp eq i64 %polly.indvar767, %197
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond937.not = icmp eq i64 %polly.indvar773, %201
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin984 = call i64 @llvm.smin.i64(i64 %227, i64 -968)
  %228 = add nsw i64 %smin984, 1000
  %smin926 = call i64 @llvm.smin.i64(i64 %indvars.iv924, i64 -968)
  %229 = shl nsw i64 %polly.indvar788, 5
  %230 = add nsw i64 %smin926, 999
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph986
  ...
  %234 = add nuw nsw <4 x i64> %vec.ind993, %broadcast.splat996
  %235 = trunc <4 x i64> %234 to <4 x i32>
  %236 = mul <4 x i32> %broadcast.splat998, %235
  ...
  %246 = icmp eq i64 %index.next990, %228
  br i1 %246, label %polly.loop_exit799, label %vector.body983, !llvm.loop !107

polly.loop_exit799:                               ; preds = %vector.body983, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond931.not = icmp eq i64 %polly.indvar794, %226
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond927.not = icmp eq i64 %polly.indvar800, %230
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1002 = call i64 @llvm.smin.i64(i64 %256, i64 -968)
  %257 = add nsw i64 %smin1002, 1000
  %smin916 = call i64 @llvm.smin.i64(i64 %indvars.iv914, i64 -968)
  %258 = shl nsw i64 %polly.indvar814, 5
  %259 = add nsw i64 %smin916, 999
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1004
  ...
  %263 = add nuw nsw <4 x i64> %vec.ind1011, %broadcast.splat1014
  %264 = trunc <4 x i64> %263 to <4 x i32>
  %265 = mul <4 x i32> %broadcast.splat1016, %264
  ...
  %275 = icmp eq i64 %index.next1008, %257
  br i1 %275, label %polly.loop_exit825, label %vector.body1001, !llvm.loop !110

polly.loop_exit825:                               ; preds = %vector.body1001, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond921.not = icmp eq i64 %polly.indvar820, %255
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond917.not = icmp eq i64 %polly.indvar826, %259
