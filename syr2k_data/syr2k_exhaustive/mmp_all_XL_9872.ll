; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9872.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9872.c"
...
vector.body1003:                                  ; preds = %vector.body1003, %vector.ph1007
  ...
  %wide.load1014 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %130, label %middle.block1001, label %vector.body1003, !llvm.loop !74
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %138 = shl nsw i64 %polly.indvar363, 6
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next364, 16
...
vector.body979:                                   ; preds = %vector.body979, %vector.ph981
  ...
  %wide.load988 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %165, label %middle.block977, label %vector.body979, !llvm.loop !83
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %smin844 = call i64 @llvm.smin.i64(i64 %indvars.iv842, i64 -936)
  %173 = shl nsw i64 %polly.indvar521, 6
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -64
  %exitcond850.not = icmp eq i64 %polly.indvar_next522, 16
...
vector.body917:                                   ; preds = %vector.body917, %vector.ph919
  ...
  br i1 %214, label %polly.loop_exit714, label %vector.body917, !llvm.loop !92
...
vector.body932:                                   ; preds = %vector.body932, %vector.ph935
  ...
  br i1 %243, label %polly.loop_exit741, label %vector.body932, !llvm.loop !95
...
vector.body950:                                   ; preds = %vector.body950, %vector.ph953
  ...
  br i1 %272, label %polly.loop_exit767, label %vector.body950, !llvm.loop !98
