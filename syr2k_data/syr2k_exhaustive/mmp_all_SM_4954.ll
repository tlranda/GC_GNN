; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4954.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4954.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv978 = phi i64 [ 3, %polly.loop_header199.preheader ], [ %indvars.iv.next979, %polly.loop_exit207 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next968 = add nuw nsw i64 %indvars.iv967, 80
  %indvars.iv.next979 = add nuw nsw i64 %indvars.iv978, 2
  %exitcond981.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit388
  %indvars.iv1002 = phi i64 [ 3, %polly.loop_header379.preheader ], [ %indvars.iv.next1003, %polly.loop_exit388 ]
  ...
  %129 = mul nsw i64 %polly.indvar382, -80
  %130 = mul nuw nsw i64 %polly.indvar382, 80
...
polly.loop_exit388:                               ; preds = %polly.loop_exit395
  ...
  %indvars.iv.next991 = add nuw nsw i64 %indvars.iv990, 80
  %indvars.iv.next1003 = add nuw nsw i64 %indvars.iv1002, 2
  %exitcond1005.not = icmp eq i64 %polly.indvar_next383, 15
...
polly.loop_header386:                             ; preds = %polly.loop_exit395, %polly.loop_header379
  ...
  %polly.loop_guard396 = icmp slt i64 %134, 80
...
polly.loop_exit431:                               ; preds = %polly.loop_exit438.loopexit.us, %polly.loop_header393.split, %polly.loop_header429.preheader
  ...
  %polly.loop_cond399 = icmp ult i64 %polly.indvar397, 79
...
polly.loop_header566:                             ; preds = %polly.loop_header566.preheader, %polly.loop_exit575
  %indvars.iv1026 = phi i64 [ 3, %polly.loop_header566.preheader ], [ %indvars.iv.next1027, %polly.loop_exit575 ]
  ...
  %159 = mul nsw i64 %polly.indvar569, -80
  %160 = mul nuw nsw i64 %polly.indvar569, 80
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582
  ...
  %exitcond1029.not = icmp eq i64 %polly.indvar_next570, 15
...
polly.loop_header573:                             ; preds = %polly.loop_exit582, %polly.loop_header566
  ...
  %polly.loop_guard583 = icmp slt i64 %164, 80
