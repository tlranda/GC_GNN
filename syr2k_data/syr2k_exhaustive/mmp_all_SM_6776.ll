; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6776.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6776.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %97 = mul nsw i64 %polly.indvar218, -8
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next219, 150
...
vector.body1039:                                  ; preds = %vector.body1039, %vector.ph1043
  ...
  %wide.load1050 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %131, label %middle.block1037, label %vector.body1039, !llvm.loop !79
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %133 = mul nsw i64 %polly.indvar393, -8
  %134 = shl nsw i64 %polly.indvar393, 3
...
polly.loop_exit398:                               ; preds = %polly.loop_exit404
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar_next394, 150
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %143 = shl nsw i64 %polly.indvar405, 2
  %144 = add nsw i64 %143, %133
  %145 = icmp sgt i64 %144, 0
  %146 = select i1 %145, i64 %144, i64 0
  %polly.loop_guard412 = icmp slt i64 %146, 8
...
polly.loop_exit418:                               ; preds = %polly.loop_header423.us.3, %polly.loop_header409
  ...
  %polly.loop_cond415 = icmp ult i64 %polly.indvar413, 7
...
vector.body1015:                                  ; preds = %vector.body1015, %vector.ph1017
  ...
  %wide.load1024 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %167, label %middle.block1013, label %vector.body1015, !llvm.loop !89
...
polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  ...
  %169 = mul nsw i64 %polly.indvar570, -8
  %170 = shl nsw i64 %polly.indvar570, 3
...
polly.loop_exit575:                               ; preds = %polly.loop_exit581
  ...
  %indvars.iv.next882 = add nuw nsw i64 %indvars.iv881, 8
  %indvars.iv.next891 = add nuw nsw i64 %indvars.iv890, 2
  %exitcond894.not = icmp eq i64 %polly.indvar_next571, 150
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %179 = shl nsw i64 %polly.indvar582, 2
  %180 = add nsw i64 %179, %169
  %181 = icmp sgt i64 %180, 0
  %182 = select i1 %181, i64 %180, i64 0
  %polly.loop_guard589 = icmp slt i64 %182, 8
...
polly.loop_exit595:                               ; preds = %polly.loop_header600.us.3, %polly.loop_header586
  ...
  %polly.loop_cond592 = icmp ult i64 %polly.indvar590, 7
...
vector.body953:                                   ; preds = %vector.body953, %vector.ph955
  ...
  br i1 %217, label %polly.loop_exit770, label %vector.body953, !llvm.loop !98
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph971
  ...
  br i1 %246, label %polly.loop_exit797, label %vector.body968, !llvm.loop !101
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph989
  ...
  br i1 %275, label %polly.loop_exit823, label %vector.body986, !llvm.loop !104
