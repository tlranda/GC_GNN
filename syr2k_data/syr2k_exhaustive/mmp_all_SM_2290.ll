; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2290.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2290.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1032.not = icmp eq i64 %polly.indvar_next220, 15
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %101 = shl nuw nsw i64 %polly.indvar225, 4
  %102 = add i64 %97, %101
  %smax1322 = call i64 @llvm.smax.i64(i64 %102, i64 0)
  %103 = mul nsw i64 %polly.indvar225, -16
  %104 = add i64 %98, %103
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1325 = call i64 @llvm.smin.i64(i64 %113, i64 15)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  ...
  %149 = mul nsw i64 %polly.indvar417, -80
  %150 = mul nuw nsw i64 %polly.indvar417, 80
...
polly.loop_exit422:                               ; preds = %polly.loop_exit429
  ...
  %indvars.iv.next1044 = add nuw nsw i64 %indvars.iv1043, 80
  %indvars.iv.next1056 = add nuw nsw i64 %indvars.iv1055, 5
  %exitcond1058.not = icmp eq i64 %polly.indvar_next418, 15
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %153 = shl nuw nsw i64 %polly.indvar423, 4
  %154 = add i64 %149, %153
  ...
  %polly.loop_guard430 = icmp slt i64 %161, 80
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %smin1277 = call i64 @llvm.smin.i64(i64 %165, i64 15)
...
polly.loop_exit465:                               ; preds = %polly.loop_exit472.loopexit.us, %polly.loop_header427.split, %polly.loop_header463.preheader
  ...
  %polly.loop_cond433 = icmp ult i64 %polly.indvar431, 79
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  ...
  %201 = mul nsw i64 %polly.indvar621, -80
  %202 = mul nuw nsw i64 %polly.indvar621, 80
  %203 = mul nsw i64 %polly.indvar621, -80
  %204 = mul nuw nsw i64 %polly.indvar621, 80
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next622, 15
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %205 = shl nuw nsw i64 %polly.indvar627, 4
  %206 = add i64 %201, %205
  %smax1226 = call i64 @llvm.smax.i64(i64 %206, i64 0)
  %207 = mul nsw i64 %polly.indvar627, -16
  %208 = add i64 %202, %207
  %209 = add i64 %smax1226, %208
  %210 = shl nsw i64 %polly.indvar627, 4
  %211 = add nsw i64 %210, %203
  %212 = icmp sgt i64 %211, 0
  %213 = select i1 %212, i64 %211, i64 0
  %polly.loop_guard634 = icmp slt i64 %213, 80
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %smin1229 = call i64 @llvm.smin.i64(i64 %217, i64 15)
  %218 = add nsw i64 %smin1229, 1
  %smin1078 = call i64 @llvm.smin.i64(i64 %indvars.iv1073, i64 15)
...
polly.loop_exit669:                               ; preds = %polly.loop_exit676.loopexit.us, %polly.loop_header631.split, %polly.loop_header667.preheader
  ...
  %polly.loop_cond637 = icmp ult i64 %polly.indvar635, 79
