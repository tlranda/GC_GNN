; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1684.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1684.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1019 = add nuw nsw i64 %indvars.iv1018, 16
  %indvars.iv.next1030 = add nuw nsw i64 %indvars.iv1029, 2
  %exitcond1032.not = icmp eq i64 %polly.indvar_next220, 75
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  ...
  %149 = mul nsw i64 %polly.indvar417, -16
  %150 = shl nuw nsw i64 %polly.indvar417, 4
  %151 = mul nsw i64 %polly.indvar417, -16
  %152 = shl nsw i64 %polly.indvar417, 4
  br label %polly.loop_header420

polly.loop_exit422:                               ; preds = %polly.loop_exit429
  %polly.indvar_next418 = add nuw nsw i64 %polly.indvar417, 1
  %indvars.iv.next1039 = add nsw i64 %indvars.iv1038, -16
  %indvars.iv.next1044 = add nuw nsw i64 %indvars.iv1043, 16
  %indvars.iv.next1056 = add nuw nsw i64 %indvars.iv1055, 2
  %exitcond1058.not = icmp eq i64 %polly.indvar_next418, 75
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %polly.loop_guard430 = icmp slt i64 %161, 16
...
polly.loop_exit465:                               ; preds = %polly.loop_exit472.loopexit.us, %polly.loop_header427.split, %polly.loop_header463.preheader
  ...
  %polly.loop_cond433 = icmp ult i64 %polly.indvar431, 15
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  ...
  %201 = mul nsw i64 %polly.indvar621, -16
  %202 = shl nuw nsw i64 %polly.indvar621, 4
  %203 = mul nsw i64 %polly.indvar621, -16
  %204 = shl nsw i64 %polly.indvar621, 4
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next622, 75
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %polly.loop_guard634 = icmp slt i64 %213, 16
...
polly.loop_exit669:                               ; preds = %polly.loop_exit676.loopexit.us, %polly.loop_header631.split, %polly.loop_header667.preheader
  ...
  %polly.loop_cond637 = icmp ult i64 %polly.indvar635, 15
