; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7389.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7389.c"
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %115 = mul nsw i64 %polly.indvar230, 100
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %141 = mul nuw nsw i64 %polly.indvar395, 9
  %142 = add nuw nsw i64 %141, 34
  %pexp.p_div_q404 = udiv i64 %142, 25
  %143 = sub nsw i64 %polly.indvar395, %pexp.p_div_q404
  %144 = add nsw i64 %143, 1
  %.inv838 = icmp slt i64 %143, 11
  %145 = select i1 %.inv838, i64 %144, i64 11
  %polly.loop_guard409 = icmp sgt i64 %145, -1
  %146 = mul nsw i64 %polly.indvar395, -64
  %147 = icmp slt i64 %146, -1136
  %148 = select i1 %147, i64 %146, i64 -1136
  %149 = add nsw i64 %148, 1199
  %150 = shl nsw i64 %polly.indvar395, 6
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %159 = mul nsw i64 %polly.indvar410, 100
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %185 = mul nuw nsw i64 %polly.indvar575, 9
  %186 = add nuw nsw i64 %185, 34
  %pexp.p_div_q584 = udiv i64 %186, 25
  %187 = sub nsw i64 %polly.indvar575, %pexp.p_div_q584
  %188 = add nsw i64 %187, 1
  %.inv839 = icmp slt i64 %187, 11
  %189 = select i1 %.inv839, i64 %188, i64 11
  %polly.loop_guard589 = icmp sgt i64 %189, -1
  %190 = mul nsw i64 %polly.indvar575, -64
  %191 = icmp slt i64 %190, -1136
  %192 = select i1 %191, i64 %190, i64 -1136
  %193 = add nsw i64 %192, 1199
  %194 = shl nsw i64 %polly.indvar575, 6
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %203 = mul nsw i64 %polly.indvar590, 100
