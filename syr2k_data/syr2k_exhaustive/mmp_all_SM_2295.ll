; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2295.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2295.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1029.not = icmp eq i64 %polly.indvar_next220, 15
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %99 = mul nsw i64 %polly.indvar225, -80
  %100 = add i64 %97, %99
...
polly.loop_header228:                             ; preds = %polly.loop_exit259, %polly.loop_header222
  ...
  %smin1305 = call i64 @llvm.smin.i64(i64 %104, i64 79)
  %105 = add nsw i64 %smin1305, 1
  %smin1022 = call i64 @llvm.smin.i64(i64 %indvars.iv1018, i64 79)
...
polly.loop_exit259:                               ; preds = %polly.loop_exit266.loopexit.us, %polly.loop_header228.split, %polly.loop_header257.preheader
  ...
  %exitcond1025.not = icmp eq i64 %polly.indvar_next232, 80
...
polly.loop_header412:                             ; preds = %polly.loop_exit404, %polly.loop_exit420
  ...
  %140 = mul nuw nsw i64 %polly.indvar415, 80
  %141 = mul nuw nsw i64 %polly.indvar415, 80
...
polly.loop_exit420:                               ; preds = %polly.loop_exit426
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar_next416, 15
...
polly.loop_header424:                             ; preds = %polly.loop_exit461, %polly.loop_header418
  ...
  %smin1260 = call i64 @llvm.smin.i64(i64 %147, i64 79)
...
polly.loop_exit461:                               ; preds = %polly.loop_exit468.loopexit.us, %polly.loop_header424.split, %polly.loop_header459.preheader
  ...
  %exitcond1047.not = icmp eq i64 %polly.indvar_next428, 80
...
polly.loop_header614:                             ; preds = %polly.loop_exit606, %polly.loop_exit622
  ...
  %183 = mul nuw nsw i64 %polly.indvar617, 80
  %184 = mul nuw nsw i64 %polly.indvar617, 80
...
polly.loop_exit622:                               ; preds = %polly.loop_exit628
  ...
  %indvars.iv.next1058 = add nuw nsw i64 %indvars.iv1057, 80
  %indvars.iv.next1071 = add nuw nsw i64 %indvars.iv1070, 1
  %exitcond1073.not = icmp eq i64 %polly.indvar_next618, 15
...
polly.loop_header620:                             ; preds = %polly.loop_exit628, %polly.loop_header614
  ...
  %185 = mul nsw i64 %polly.indvar623, -80
  %186 = add i64 %183, %185
  %187 = mul nuw nsw i64 %polly.indvar623, 80
  %188 = sub nsw i64 %184, %187
  %189 = add nuw nsw i64 %187, 80
...
polly.loop_header626:                             ; preds = %polly.loop_exit663, %polly.loop_header620
  ...
  %smin1215 = call i64 @llvm.smin.i64(i64 %190, i64 79)
  %191 = add nsw i64 %smin1215, 1
  %smin1066 = call i64 @llvm.smin.i64(i64 %indvars.iv1061, i64 79)
...
polly.loop_exit663:                               ; preds = %polly.loop_exit670.loopexit.us, %polly.loop_header626.split, %polly.loop_header661.preheader
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next630, 80
