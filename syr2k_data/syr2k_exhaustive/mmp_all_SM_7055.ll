; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7055.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7055.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond861.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !69
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %101 = mul nsw i64 %polly.indvar218, -20
  %102 = mul nuw nsw i64 %polly.indvar218, 20
  br label %polly.loop_header221

polly.loop_exit223:                               ; preds = %polly.loop_exit229
  %polly.indvar_next219 = add nuw nsw i64 %polly.indvar218, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -20
  %indvars.iv.next846 = add nuw nsw i64 %indvars.iv845, 20
  %indvars.iv.next853 = add nuw nsw i64 %indvars.iv852, 1
  %indvars.iv.next855 = add nuw nsw i64 %indvars.iv854, 3
  %exitcond858.not = icmp eq i64 %polly.indvar_next219, 60
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar_next225, 50
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %polly.loop_guard237 = icmp slt i64 %107, 20
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  ...
  %polly.loop_guard251944 = icmp sgt i64 %110, -1
  %111 = add nuw nsw i64 %polly.indvar238, %102
  %112 = mul i64 %111, 8000
  %113 = mul i64 %111, 9600
  br i1 %polly.loop_guard251944, label %polly.loop_header241.us, label %polly.loop_exit243
...
polly.loop_exit250.loopexit.us:                   ; preds = %polly.loop_header248.us
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next245.us, 20
...
polly.loop_exit243:                               ; preds = %polly.loop_exit250.loopexit.us, %polly.loop_header234
  ...
  %polly.loop_cond240 = icmp ult i64 %polly.indvar238, 19
...
vector.body1053:                                  ; preds = %vector.body1053, %vector.ph1057
  ...
  %124 = shl nuw nsw i64 %index1060, 3
  %125 = getelementptr i8, i8* %scevgep372, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1064 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !73, !noalias !75
  %127 = fmul fast <4 x double> %wide.load1064, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1061, %n.vec1059
  br i1 %129, label %middle.block1051, label %vector.body1053, !llvm.loop !79

middle.block1051:                                 ; preds = %vector.body1053
  %cmp.n1063 = icmp eq i64 %122, %n.vec1059
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %131 = lshr i64 %indvars.iv879, 3
  %132 = sub nsw i64 %indvars.iv877, %131
  %133 = mul nuw nsw i64 %polly.indvar395, 3
  %134 = add nuw nsw i64 %133, 3
  %pexp.p_div_q404 = lshr i64 %134, 3
  %polly.loop_guard409.not = icmp ult i64 %polly.indvar395, %pexp.p_div_q404
  %135 = mul nsw i64 %polly.indvar395, -20
  %136 = mul nuw nsw i64 %polly.indvar395, 20
...
polly.loop_exit400:                               ; preds = %polly.loop_exit408
  ...
  %exitcond883.not = icmp eq i64 %polly.indvar_next396, 60
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  %137 = mul nuw nsw i64 %polly.indvar401, 20
  br label %polly.loop_header406

polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  %polly.indvar_next402 = add nuw nsw i64 %polly.indvar401, 1
  %exitcond882.not = icmp eq i64 %polly.indvar_next402, 50
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %138 = shl nsw i64 %polly.indvar410, 5
  %139 = add nsw i64 %138, %135
  %140 = icmp sgt i64 %139, 0
  %141 = select i1 %140, i64 %139, i64 0
  %polly.loop_guard417 = icmp slt i64 %141, 20
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next411, %132
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  %indvars.iv872 = phi i64 [ %142, %polly.loop_header414.preheader ], [ %indvars.iv.next873, %polly.loop_exit423 ]
  ...
  %polly.loop_guard431945 = icmp sgt i64 %144, -1
  %145 = add nuw nsw i64 %polly.indvar418, %136
  %146 = mul i64 %145, 8000
  %147 = mul i64 %145, 9600
  br i1 %polly.loop_guard431945, label %polly.loop_header421.us, label %polly.loop_exit423
...
polly.loop_exit430.loopexit.us:                   ; preds = %polly.loop_header428.us
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar_next425.us, 20
  br i1 %exitcond876.not, label %polly.loop_exit423, label %polly.loop_header421.us
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430.loopexit.us, %polly.loop_header414
  ...
  %polly.loop_cond420 = icmp ult i64 %polly.indvar418, 19
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %min.iters.check1030 = icmp ult i64 %156, 4
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1031
  ...
  %158 = shl nuw nsw i64 %index1034, 3
  %159 = getelementptr i8, i8* %scevgep552, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load1038 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !83, !noalias !85
  %161 = fmul fast <4 x double> %wide.load1038, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next1035, %n.vec1033
  br i1 %163, label %middle.block1027, label %vector.body1029, !llvm.loop !89

middle.block1027:                                 ; preds = %vector.body1029
  %cmp.n1037 = icmp eq i64 %156, %n.vec1033
...
polly.loop_header546:                             ; preds = %polly.loop_header546.preheader, %polly.loop_header546
  ...
  br i1 %exitcond911.not, label %polly.loop_exit548, label %polly.loop_header546, !llvm.loop !90
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %165 = lshr i64 %indvars.iv904, 3
  %166 = sub nsw i64 %indvars.iv902, %165
  %167 = mul nuw nsw i64 %polly.indvar575, 3
  %168 = add nuw nsw i64 %167, 3
  %pexp.p_div_q584 = lshr i64 %168, 3
  %polly.loop_guard589.not = icmp ult i64 %polly.indvar575, %pexp.p_div_q584
  %169 = mul nsw i64 %polly.indvar575, -20
  %170 = mul nuw nsw i64 %polly.indvar575, 20
...
polly.loop_exit580:                               ; preds = %polly.loop_exit588
  ...
  %indvars.iv.next889 = add nsw i64 %indvars.iv888, -20
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar_next576, 60
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  %171 = mul nuw nsw i64 %polly.indvar581, 20
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next582, 50
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %172 = shl nsw i64 %polly.indvar590, 5
  %173 = add nsw i64 %172, %169
  %174 = icmp sgt i64 %173, 0
  %175 = select i1 %174, i64 %173, i64 0
  %polly.loop_guard597 = icmp slt i64 %175, 20
...
polly.loop_exit596:                               ; preds = %polly.loop_exit603, %polly.loop_header586
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar_next591, %166
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit603
  %indvars.iv897 = phi i64 [ %176, %polly.loop_header594.preheader ], [ %indvars.iv.next898, %polly.loop_exit603 ]
  ...
  %polly.loop_guard611946 = icmp sgt i64 %178, -1
  %179 = add nuw nsw i64 %polly.indvar598, %170
  %180 = mul i64 %179, 8000
  %181 = mul i64 %179, 9600
  br i1 %polly.loop_guard611946, label %polly.loop_header601.us, label %polly.loop_exit603
...
polly.loop_exit610.loopexit.us:                   ; preds = %polly.loop_header608.us
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar_next605.us, 20
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %smin968 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin968, 1200
  %smin935 = call i64 @llvm.smin.i64(i64 %indvars.iv933, i64 -1168)
  %194 = shl nsw i64 %polly.indvar767, 5
  %195 = add nsw i64 %smin935, 1199
...
vector.ph969:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert976 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat977 = shufflevector <4 x i64> %broadcast.splatinsert976, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert978 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph969
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind974, %broadcast.splat977
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat979, %200
  ...
  %211 = icmp eq i64 %index.next971, %193
  br i1 %211, label %polly.loop_exit778, label %vector.body967, !llvm.loop !98

polly.loop_exit778:                               ; preds = %vector.body967, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond940.not = icmp eq i64 %polly.indvar773, %191
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %exitcond936.not = icmp eq i64 %polly.indvar779, %195
  br i1 %exitcond936.not, label %polly.loop_exit778, label %polly.loop_header776, !llvm.loop !99
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin983, 1000
  %smin925 = call i64 @llvm.smin.i64(i64 %indvars.iv923, i64 -968)
  %223 = shl nsw i64 %polly.indvar794, 5
  %224 = add nsw i64 %smin925, 999
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph985
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind992, %broadcast.splat995
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat997, %229
  ...
  %240 = icmp eq i64 %index.next989, %222
  br i1 %240, label %polly.loop_exit805, label %vector.body982, !llvm.loop !101

polly.loop_exit805:                               ; preds = %vector.body982, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond930.not = icmp eq i64 %polly.indvar800, %220
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %exitcond926.not = icmp eq i64 %polly.indvar806, %224
  br i1 %exitcond926.not, label %polly.loop_exit805, label %polly.loop_header803, !llvm.loop !102
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %smin1001 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin1001, 1000
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -968)
  %252 = shl nsw i64 %polly.indvar820, 5
  %253 = add nsw i64 %smin915, 999
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind1010, %broadcast.splat1013
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat1015, %258
  ...
  %269 = icmp eq i64 %index.next1007, %251
  br i1 %269, label %polly.loop_exit831, label %vector.body1000, !llvm.loop !104

polly.loop_exit831:                               ; preds = %vector.body1000, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond920.not = icmp eq i64 %polly.indvar826, %249
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar832, %253
  br i1 %exitcond916.not, label %polly.loop_exit831, label %polly.loop_header829, !llvm.loop !105
}
