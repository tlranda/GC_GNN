; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8591.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8591.c"
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph991
  ...
  br i1 %57, label %middle.block987, label %vector.body989, !llvm.loop !53
...
vector.body1015:                                  ; preds = %vector.body1015, %vector.ph1017
  ...
  br i1 %68, label %middle.block1013, label %vector.body1015, !llvm.loop !55
...
vector.body1027:                                  ; preds = %vector.body1027, %vector.ph1031
  ...
  %wide.load1038 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !61, !noalias !63
  ...
  br i1 %95, label %middle.block1025, label %vector.body1027, !llvm.loop !66
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %pexp.p_div_q776 = udiv i16 %pexp.p_div_q.lhs.trunc, 25
  %pexp.p_div_q.zext = zext i16 %pexp.p_div_q776 to i64
  %108 = shl nsw i64 %polly.indvar208, 2
  %109 = mul nsw i64 %polly.indvar208, -4
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next209, 300
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %110 = add i64 %smax, %indvars.iv794
  %111 = mul nuw nsw i64 %polly.indvar214, 50
...
polly.loop_header223.us:                          ; preds = %polly.loop_header211, %polly.loop_exit232.us
  %indvars.iv796 = phi i64 [ %indvars.iv.next797, %polly.loop_exit232.us ], [ %110, %polly.loop_header211 ]
  %polly.indvar226.us = phi i64 [ %polly.indvar_next227.us, %polly.loop_exit232.us ], [ %114, %polly.loop_header211 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv796, i64 3)
  %115 = add nuw i64 %polly.indvar226.us, %111
  %116 = add i64 %115, %109
  %polly.loop_guard233.us877 = icmp sgt i64 %116, -1
...
polly.loop_exit232.us:                            ; preds = %polly.loop_header230.us, %polly.loop_header223.us
  ...
  %polly.loop_cond228.us = icmp ult i64 %polly.indvar226.us, 49
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %132, label %middle.block999, label %vector.body1001, !llvm.loop !76
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %141 = udiv i64 %indvars.iv805, 25
  %142 = mul nuw nsw i64 %141, 50
  %143 = sub nsw i64 %indvars.iv803, %142
  ...
  %pexp.p_div_q366775 = udiv i16 %pexp.p_div_q366.lhs.trunc, 25
  %pexp.p_div_q366.zext = zext i16 %pexp.p_div_q366775 to i64
  %145 = shl nsw i64 %polly.indvar363, 2
  %146 = mul nsw i64 %polly.indvar363, -4
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %indvars.iv.next811 = add nsw i64 %indvars.iv810, -4
  %exitcond819.not = icmp eq i64 %polly.indvar_next364, 300
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %147 = add i64 %smax809, %indvars.iv812
  %148 = mul nuw nsw i64 %polly.indvar370, 50
  %149 = sub nsw i64 %145, %148
  %150 = icmp sgt i64 %149, 0
  %151 = select i1 %150, i64 %149, i64 0
  %polly.loop_guard383 = icmp slt i64 %151, 50
...
polly.loop_header380.us:                          ; preds = %polly.loop_header367, %polly.loop_exit390.us
  %indvars.iv814 = phi i64 [ %indvars.iv.next815, %polly.loop_exit390.us ], [ %147, %polly.loop_header367 ]
  %polly.indvar384.us = phi i64 [ %polly.indvar_next385.us, %polly.loop_exit390.us ], [ %151, %polly.loop_header367 ]
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 3)
  %152 = add nuw i64 %polly.indvar384.us, %148
  %153 = add i64 %152, %146
  %polly.loop_guard391.us881 = icmp sgt i64 %153, -1
...
polly.loop_exit390.us:                            ; preds = %polly.loop_header388.us, %polly.loop_header380.us
  ...
  %polly.loop_cond386.us = icmp ult i64 %polly.indvar384.us, 49
...
polly.loop_exit375:                               ; preds = %polly.loop_exit390.us.3, %polly.loop_header367
  ...
  %polly.loop_cond372 = icmp ult i64 %polly.indvar370, 23
  %indvars.iv.next808 = add i64 %indvars.iv807, -50
  %indvars.iv.next813 = add i64 %indvars.iv812, 50
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %wide.load986 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %169, label %middle.block975, label %vector.body977, !llvm.loop !85
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %178 = udiv i64 %indvars.iv825, 25
  %179 = mul nuw nsw i64 %178, 50
  %180 = sub nsw i64 %indvars.iv823, %179
  %181 = add i64 %indvars.iv830, %179
  %polly.indvar521.tr = trunc i64 %polly.indvar521 to i16
  %pexp.p_div_q524.lhs.trunc = shl i16 %polly.indvar521.tr, 1
  %pexp.p_div_q524774 = udiv i16 %pexp.p_div_q524.lhs.trunc, 25
  %pexp.p_div_q524.zext = zext i16 %pexp.p_div_q524774 to i64
  %182 = shl nsw i64 %polly.indvar521, 2
  %183 = mul nsw i64 %polly.indvar521, -4
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next831 = add nsw i64 %indvars.iv830, -4
  %exitcond839.not = icmp eq i64 %polly.indvar_next522, 300
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv832 = phi i64 [ %indvars.iv.next833, %polly.loop_exit533 ], [ %181, %polly.loop_header518 ]
  %indvars.iv827 = phi i64 [ %indvars.iv.next828, %polly.loop_exit533 ], [ %180, %polly.loop_header518 ]
  ...
  %184 = add i64 %smax829, %indvars.iv832
  %185 = mul nuw nsw i64 %polly.indvar528, 50
  %186 = sub nsw i64 %182, %185
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %polly.loop_guard541 = icmp slt i64 %188, 50
...
polly.loop_header538.us:                          ; preds = %polly.loop_header525, %polly.loop_exit548.us
  %indvars.iv834 = phi i64 [ %indvars.iv.next835, %polly.loop_exit548.us ], [ %184, %polly.loop_header525 ]
  ...
  %190 = add i64 %189, %183
  %polly.loop_guard549.us885 = icmp sgt i64 %190, -1
...
polly.loop_exit533:                               ; preds = %polly.loop_exit548.us.3, %polly.loop_header525
  ...
  %polly.loop_cond530 = icmp ult i64 %polly.indvar528, 23
  %indvars.iv.next828 = add i64 %indvars.iv827, -50
  %indvars.iv.next833 = add i64 %indvars.iv832, 50
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  br i1 %220, label %polly.loop_exit714, label %vector.body915, !llvm.loop !94
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %249, label %polly.loop_exit741, label %vector.body930, !llvm.loop !97
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  br i1 %278, label %polly.loop_exit767, label %vector.body948, !llvm.loop !100
...
polly.loop_header223.us.1:                        ; preds = %polly.loop_exit232.us, %polly.loop_exit232.us.1
  %indvars.iv796.1 = phi i64 [ %indvars.iv.next797.1, %polly.loop_exit232.us.1 ], [ %110, %polly.loop_exit232.us ]
  %polly.indvar226.us.1 = phi i64 [ %polly.indvar_next227.us.1, %polly.loop_exit232.us.1 ], [ %114, %polly.loop_exit232.us ]
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv796.1, i64 3)
  %286 = add nuw i64 %polly.indvar226.us.1, %111
  %287 = add i64 %286, %109
  %polly.loop_guard233.us.1878 = icmp sgt i64 %287, -1
...
polly.loop_exit232.us.1:                          ; preds = %polly.loop_header230.us.1, %polly.loop_header223.us.1
  ...
  %polly.loop_cond228.us.1 = icmp ult i64 %polly.indvar226.us.1, 49
...
polly.loop_header223.us.2:                        ; preds = %polly.loop_exit232.us.1, %polly.loop_exit232.us.2
  %indvars.iv796.2 = phi i64 [ %indvars.iv.next797.2, %polly.loop_exit232.us.2 ], [ %110, %polly.loop_exit232.us.1 ]
  %polly.indvar226.us.2 = phi i64 [ %polly.indvar_next227.us.2, %polly.loop_exit232.us.2 ], [ %114, %polly.loop_exit232.us.1 ]
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv796.2, i64 3)
  %296 = add nuw i64 %polly.indvar226.us.2, %111
  %297 = add i64 %296, %109
  %polly.loop_guard233.us.2879 = icmp sgt i64 %297, -1
...
polly.loop_exit232.us.2:                          ; preds = %polly.loop_header230.us.2, %polly.loop_header223.us.2
  ...
  %polly.loop_cond228.us.2 = icmp ult i64 %polly.indvar226.us.2, 49
...
polly.loop_header223.us.3:                        ; preds = %polly.loop_exit232.us.2, %polly.loop_exit232.us.3
  %indvars.iv796.3 = phi i64 [ %indvars.iv.next797.3, %polly.loop_exit232.us.3 ], [ %110, %polly.loop_exit232.us.2 ]
  %polly.indvar226.us.3 = phi i64 [ %polly.indvar_next227.us.3, %polly.loop_exit232.us.3 ], [ %114, %polly.loop_exit232.us.2 ]
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv796.3, i64 3)
  %306 = add nuw i64 %polly.indvar226.us.3, %111
  %307 = add i64 %306, %109
  %polly.loop_guard233.us.3880 = icmp sgt i64 %307, -1
...
polly.loop_exit232.us.3:                          ; preds = %polly.loop_header230.us.3, %polly.loop_header223.us.3
  ...
  %polly.loop_cond228.us.3 = icmp ult i64 %polly.indvar226.us.3, 49
...
polly.loop_header380.us.1:                        ; preds = %polly.loop_exit390.us, %polly.loop_exit390.us.1
  %indvars.iv814.1 = phi i64 [ %indvars.iv.next815.1, %polly.loop_exit390.us.1 ], [ %147, %polly.loop_exit390.us ]
  %polly.indvar384.us.1 = phi i64 [ %polly.indvar_next385.us.1, %polly.loop_exit390.us.1 ], [ %151, %polly.loop_exit390.us ]
  %smin816.1 = call i64 @llvm.smin.i64(i64 %indvars.iv814.1, i64 3)
  %316 = add nuw i64 %polly.indvar384.us.1, %148
  %317 = add i64 %316, %146
  %polly.loop_guard391.us.1882 = icmp sgt i64 %317, -1
...
polly.loop_exit390.us.1:                          ; preds = %polly.loop_header388.us.1, %polly.loop_header380.us.1
  ...
  %polly.loop_cond386.us.1 = icmp ult i64 %polly.indvar384.us.1, 49
...
polly.loop_header380.us.2:                        ; preds = %polly.loop_exit390.us.1, %polly.loop_exit390.us.2
  %indvars.iv814.2 = phi i64 [ %indvars.iv.next815.2, %polly.loop_exit390.us.2 ], [ %147, %polly.loop_exit390.us.1 ]
  %polly.indvar384.us.2 = phi i64 [ %polly.indvar_next385.us.2, %polly.loop_exit390.us.2 ], [ %151, %polly.loop_exit390.us.1 ]
  %smin816.2 = call i64 @llvm.smin.i64(i64 %indvars.iv814.2, i64 3)
  %326 = add nuw i64 %polly.indvar384.us.2, %148
  %327 = add i64 %326, %146
  %polly.loop_guard391.us.2883 = icmp sgt i64 %327, -1
...
polly.loop_exit390.us.2:                          ; preds = %polly.loop_header388.us.2, %polly.loop_header380.us.2
  ...
  %polly.loop_cond386.us.2 = icmp ult i64 %polly.indvar384.us.2, 49
...
polly.loop_header380.us.3:                        ; preds = %polly.loop_exit390.us.2, %polly.loop_exit390.us.3
  %indvars.iv814.3 = phi i64 [ %indvars.iv.next815.3, %polly.loop_exit390.us.3 ], [ %147, %polly.loop_exit390.us.2 ]
  %polly.indvar384.us.3 = phi i64 [ %polly.indvar_next385.us.3, %polly.loop_exit390.us.3 ], [ %151, %polly.loop_exit390.us.2 ]
  %smin816.3 = call i64 @llvm.smin.i64(i64 %indvars.iv814.3, i64 3)
  %336 = add nuw i64 %polly.indvar384.us.3, %148
  %337 = add i64 %336, %146
  %polly.loop_guard391.us.3884 = icmp sgt i64 %337, -1
...
polly.loop_exit390.us.3:                          ; preds = %polly.loop_header388.us.3, %polly.loop_header380.us.3
  ...
  %polly.loop_cond386.us.3 = icmp ult i64 %polly.indvar384.us.3, 49
...
polly.loop_header538.us.1:                        ; preds = %polly.loop_exit548.us, %polly.loop_exit548.us.1
  %indvars.iv834.1 = phi i64 [ %indvars.iv.next835.1, %polly.loop_exit548.us.1 ], [ %184, %polly.loop_exit548.us ]
  ...
  %347 = add i64 %346, %183
  %polly.loop_guard549.us.1886 = icmp sgt i64 %347, -1
...
polly.loop_exit548.us.1:                          ; preds = %polly.loop_header546.us.1, %polly.loop_header538.us.1
  ...
  %polly.loop_cond544.us.1 = icmp ult i64 %polly.indvar542.us.1, 49
...
polly.loop_header538.us.2:                        ; preds = %polly.loop_exit548.us.1, %polly.loop_exit548.us.2
  %indvars.iv834.2 = phi i64 [ %indvars.iv.next835.2, %polly.loop_exit548.us.2 ], [ %184, %polly.loop_exit548.us.1 ]
  ...
  %357 = add i64 %356, %183
  %polly.loop_guard549.us.2887 = icmp sgt i64 %357, -1
...
polly.loop_exit548.us.2:                          ; preds = %polly.loop_header546.us.2, %polly.loop_header538.us.2
  ...
  %polly.loop_cond544.us.2 = icmp ult i64 %polly.indvar542.us.2, 49
...
polly.loop_header538.us.3:                        ; preds = %polly.loop_exit548.us.2, %polly.loop_exit548.us.3
  %indvars.iv834.3 = phi i64 [ %indvars.iv.next835.3, %polly.loop_exit548.us.3 ], [ %184, %polly.loop_exit548.us.2 ]
  %polly.indvar542.us.3 = phi i64 [ %polly.indvar_next543.us.3, %polly.loop_exit548.us.3 ], [ %188, %polly.loop_exit548.us.2 ]
  %smin836.3 = call i64 @llvm.smin.i64(i64 %indvars.iv834.3, i64 3)
  %366 = add nuw i64 %polly.indvar542.us.3, %185
  %367 = add i64 %366, %183
  %polly.loop_guard549.us.3888 = icmp sgt i64 %367, -1
...
polly.loop_exit548.us.3:                          ; preds = %polly.loop_header546.us.3, %polly.loop_header538.us.3
  ...
  %polly.loop_cond544.us.3 = icmp ult i64 %polly.indvar542.us.3, 49
