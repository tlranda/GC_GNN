; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1927.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1927.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv1029, i64 74)
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %104 = shl nuw nsw i64 %polly.indvar225, 4
  %105 = add i64 %97, %104
  %smax1324 = call i64 @llvm.smax.i64(i64 %105, i64 0)
  %106 = mul nsw i64 %polly.indvar225, -16
  %107 = add i64 %98, %106
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %116, i64 15)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  %indvars.iv1055 = phi i64 [ %indvars.iv.next1056, %polly.loop_exit422 ], [ 1, %polly.loop_exit406 ]
  ...
  %umin1057 = call i64 @llvm.umin.i64(i64 %indvars.iv1055, i64 74)
...
polly.loop_exit422:                               ; preds = %polly.loop_exit429
  ...
  %exitcond1059.not = icmp eq i64 %polly.indvar_next418, 38
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %159 = shl nuw nsw i64 %polly.indvar423, 4
  %160 = add i64 %152, %159
  %smax1276 = call i64 @llvm.smax.i64(i64 %160, i64 0)
  %161 = mul nsw i64 %polly.indvar423, -16
  %162 = add i64 %153, %161
  %163 = add i64 %smax1276, %162
  %164 = shl nsw i64 %polly.indvar423, 4
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %171, i64 15)
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  %indvars.iv1082 = phi i64 [ %indvars.iv.next1083, %polly.loop_exit626 ], [ 1, %polly.loop_exit610 ]
  ...
  %umin1084 = call i64 @llvm.umin.i64(i64 %indvars.iv1082, i64 74)
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %indvars.iv.next1083 = add nuw nsw i64 %indvars.iv1082, 2
  %exitcond1086.not = icmp eq i64 %polly.indvar_next622, 38
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %214 = shl nuw nsw i64 %polly.indvar627, 4
  %215 = add i64 %207, %214
  %smax1228 = call i64 @llvm.smax.i64(i64 %215, i64 0)
  %216 = mul nsw i64 %polly.indvar627, -16
  %217 = add i64 %208, %216
  %218 = add i64 %smax1228, %217
  %219 = shl nsw i64 %polly.indvar627, 4
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %226, i64 15)
