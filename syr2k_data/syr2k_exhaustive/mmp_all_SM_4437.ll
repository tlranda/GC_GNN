; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4437.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4437.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit220, %polly.loop_header205
  ...
  %exitcond1006.not = icmp eq i64 %polly.indvar_next209, 13
...
polly.loop_header391:                             ; preds = %polly.loop_exit401, %polly.loop_header385
  ...
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv1010, i64 -920)
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409, %polly.loop_header391
  ...
  %indvars.iv.next1011 = add nsw i64 %indvars.iv1010, -80
  %exitcond1038.not = icmp eq i64 %polly.indvar_next395, 13
...
polly.loop_header584:                             ; preds = %polly.loop_exit594, %polly.loop_header578
  ...
  %smin1063 = call i64 @llvm.smin.i64(i64 %indvars.iv1042, i64 -920)
...
polly.loop_exit594:                               ; preds = %polly.loop_exit602, %polly.loop_header584
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar_next588, 13
