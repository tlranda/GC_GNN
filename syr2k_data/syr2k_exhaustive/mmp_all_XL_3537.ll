; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3537.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3537.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1135 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -984)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1138.not = icmp eq i64 %polly.indvar_next203, 63
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %smin1172 = call i64 @llvm.smin.i64(i64 %indvars.iv1142, i64 -984)
  %148 = add nsw i64 %smin1172, 1000
  %149 = shl nsw i64 %polly.indvar409, 4
  br label %polly.loop_header412

polly.loop_exit414:                               ; preds = %polly.loop_exit422
  %polly.indvar_next410 = add nuw nsw i64 %polly.indvar409, 1
  %indvars.iv.next1143 = add nsw i64 %indvars.iv1142, -16
  %exitcond1175.not = icmp eq i64 %polly.indvar_next410, 63
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %smin1209 = call i64 @llvm.smin.i64(i64 %indvars.iv1179, i64 -984)
  %199 = add nsw i64 %smin1209, 1000
  %200 = shl nsw i64 %polly.indvar623, 4
...
polly.loop_exit628:                               ; preds = %polly.loop_exit636
  ...
  %exitcond1212.not = icmp eq i64 %polly.indvar_next624, 63
