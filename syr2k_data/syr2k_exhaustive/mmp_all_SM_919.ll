; ModuleID = 'syr2k_exhaustive/mmp_all_SM_919.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_919.c"
...
vector.body1540:                                  ; preds = %vector.body1540, %vector.ph1548
  ...
  %wide.load1561 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %163, label %middle.block1538, label %vector.body1540, !llvm.loop !84
...
vector.body1476:                                  ; preds = %vector.body1476, %vector.ph1480
  ...
  %wide.load1487 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %173, label %middle.block1474, label %vector.body1476, !llvm.loop !92
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit435
  ...
  %176 = shl nsw i64 %polly.indvar430, 6
...
vector.body1490:                                  ; preds = %vector.body1490, %vector.ph1498
  ...
  %wide.load1511 = load <4 x double>, <4 x double>* %236, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %239, <4 x double>* %240, align 8, !alias.scope !85, !noalias !87
  %index.next1502 = add i64 %index1501, 4
  %241 = icmp eq i64 %index.next1502, %n.vec1500
  br i1 %241, label %middle.block1488, label %vector.body1490, !llvm.loop !97
...
vector.body1428:                                  ; preds = %vector.body1428, %vector.ph1430
  ...
  %wide.load1437 = load <4 x double>, <4 x double>* %248, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %251, label %middle.block1426, label %vector.body1428, !llvm.loop !105
...
polly.loop_header661:                             ; preds = %polly.loop_header661.preheader, %polly.loop_exit669
  ...
  %254 = shl nsw i64 %polly.indvar664, 6
...
vector.body1440:                                  ; preds = %vector.body1440, %vector.ph1448
  ...
  %wide.load1461 = load <4 x double>, <4 x double>* %314, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %317, <4 x double>* %318, align 8, !alias.scope !98, !noalias !100
  %index.next1452 = add i64 %index1451, 4
  %319 = icmp eq i64 %index.next1452, %n.vec1450
  br i1 %319, label %middle.block1438, label %vector.body1440, !llvm.loop !110
...
vector.body1367:                                  ; preds = %vector.body1367, %vector.ph1368
  ...
  br i1 %343, label %polly.loop_exit935, label %vector.body1367, !llvm.loop !116
...
vector.body1381:                                  ; preds = %vector.body1381, %vector.ph1384
  ...
  br i1 %372, label %polly.loop_exit962, label %vector.body1381, !llvm.loop !119
...
vector.body1399:                                  ; preds = %vector.body1399, %vector.ph1402
  ...
  br i1 %401, label %polly.loop_exit988, label %vector.body1399, !llvm.loop !122
