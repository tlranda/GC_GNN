; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2414.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2414.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1036 = phi i64 [ %indvars.iv.next1037, %polly.loop_exit224 ], [ 27, %polly.loop_exit208 ]
  ...
  %smin1038 = call i64 @llvm.smin.i64(i64 %100, i64 21)
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1035 = add nuw nsw i64 %indvars.iv1034, 2
  %indvars.iv.next1037 = add nuw nsw i64 %indvars.iv1036, 2
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1339 = call i64 @llvm.smin.i64(i64 %119, i64 49)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  %indvars.iv1065 = phi i64 [ %indvars.iv.next1066, %polly.loop_exit423 ], [ 27, %polly.loop_exit406 ]
  ...
  %157 = udiv i64 %indvars.iv1065, 25
  %158 = sub nsw i64 %indvars.iv1063, %157
  %smin1067 = call i64 @llvm.smin.i64(i64 %158, i64 21)
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1291 = call i64 @llvm.smin.i64(i64 %177, i64 49)
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  %indvars.iv1094 = phi i64 [ %indvars.iv.next1095, %polly.loop_exit628 ], [ 27, %polly.loop_exit611 ]
  ...
  %215 = udiv i64 %indvars.iv1094, 25
  %216 = sub nsw i64 %indvars.iv1092, %215
  %smin1096 = call i64 @llvm.smin.i64(i64 %216, i64 21)
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1243 = call i64 @llvm.smin.i64(i64 %235, i64 49)
  %236 = add nsw i64 %smin1243, 1
  %smin1089 = call i64 @llvm.smin.i64(i64 %indvars.iv1084, i64 49)
