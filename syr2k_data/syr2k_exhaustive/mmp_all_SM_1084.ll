; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1084.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1084.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %indvars.iv1076 = phi i64 [ 2, %polly.loop_header200.preheader ], [ %indvars.iv.next1077, %polly.loop_exit224 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit263, %polly.loop_exit208
  ...
  %indvars.iv.next1081 = add nuw nsw i64 %indvars.iv1080, 32
  %exitcond1088.not = icmp eq i64 %polly.indvar_next204, 19
...
polly.loop_header222:                             ; preds = %polly.loop_exit208, %polly.loop_exit263
  ...
  %.inv = icmp sgt i64 %121, 63
  %123 = select i1 %.inv, i64 63, i64 %122
...
polly.loop_header268:                             ; preds = %polly.loop_header261, %polly.loop_exit278
  ...
  %smin1392 = call i64 @llvm.smin.i64(i64 %139, i64 63)
  %140 = add nsw i64 %smin1392, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1084, i64 63)
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit434
  ...
  %indvars.iv1100 = phi i64 [ 2, %polly.loop_header408.preheader ], [ %indvars.iv.next1101, %polly.loop_exit434 ]
  ...
  %173 = mul nsw i64 %polly.indvar411, -32
  %174 = add nuw i64 %polly.indvar411, 2
  %175 = udiv i64 %174, 3
  %176 = mul nuw nsw i64 %175, 96
  %177 = add i64 %173, %176
  %178 = shl nuw nsw i64 %polly.indvar411, 5
  %179 = sub nsw i64 %178, %176
  %180 = udiv i64 %indvars.iv1100, 3
  %181 = mul nuw nsw i64 %180, 96
  %182 = add i64 %indvars.iv1098, %181
  %183 = sub nsw i64 %indvars.iv1105, %181
  %184 = mul nsw i64 %polly.indvar411, -64
  %185 = shl nsw i64 %polly.indvar411, 6
  br label %polly.loop_header414

polly.loop_exit416:                               ; preds = %polly.loop_exit422
  %186 = add nsw i64 %184, 1199
  %187 = add nuw nsw i64 %polly.indvar411, 2
  %pexp.p_div_q430 = udiv i64 %187, 3
...
polly.loop_exit434:                               ; preds = %polly.loop_exit474, %polly.loop_exit416
  ...
  %exitcond1114.not = icmp eq i64 %polly.indvar_next412, 19
...
polly.loop_header432:                             ; preds = %polly.loop_exit416, %polly.loop_exit474
  ...
  %.inv930 = icmp sgt i64 %197, 63
  %199 = select i1 %.inv930, i64 63, i64 %198
...
polly.loop_header479:                             ; preds = %polly.loop_header472, %polly.loop_exit489
  ...
  %smin1342 = call i64 @llvm.smin.i64(i64 %215, i64 63)
  %216 = add nsw i64 %smin1342, 1
  %smin1111 = call i64 @llvm.smin.i64(i64 %indvars.iv1109, i64 63)
...
polly.loop_header619:                             ; preds = %polly.loop_header619.preheader, %polly.loop_exit645
  ...
  %indvars.iv1126 = phi i64 [ 2, %polly.loop_header619.preheader ], [ %indvars.iv.next1127, %polly.loop_exit645 ]
  ...
  %249 = mul nsw i64 %polly.indvar622, -32
  %250 = add nuw i64 %polly.indvar622, 2
  %251 = udiv i64 %250, 3
  %252 = mul nuw nsw i64 %251, 96
  %253 = add i64 %249, %252
  %254 = shl nuw nsw i64 %polly.indvar622, 5
  %255 = sub nsw i64 %254, %252
  %256 = udiv i64 %indvars.iv1126, 3
  %257 = mul nuw nsw i64 %256, 96
  %258 = add i64 %indvars.iv1124, %257
  %259 = sub nsw i64 %indvars.iv1131, %257
  %260 = mul nsw i64 %polly.indvar622, -64
  %261 = shl nsw i64 %polly.indvar622, 6
  br label %polly.loop_header625

polly.loop_exit627:                               ; preds = %polly.loop_exit633
  %262 = add nsw i64 %260, 1199
  %263 = add nuw nsw i64 %polly.indvar622, 2
  %pexp.p_div_q641 = udiv i64 %263, 3
...
polly.loop_exit645:                               ; preds = %polly.loop_exit685, %polly.loop_exit627
  ...
  %indvars.iv.next1132 = add nuw nsw i64 %indvars.iv1131, 32
  %exitcond1140.not = icmp eq i64 %polly.indvar_next623, 19
...
polly.loop_header643:                             ; preds = %polly.loop_exit627, %polly.loop_exit685
  ...
  %.inv931 = icmp sgt i64 %273, 63
  %275 = select i1 %.inv931, i64 63, i64 %274
...
polly.loop_header690:                             ; preds = %polly.loop_header683, %polly.loop_exit700
  ...
  %smin1292 = call i64 @llvm.smin.i64(i64 %291, i64 63)
