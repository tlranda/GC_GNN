; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7946.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7946.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv847 = phi i64 [ %indvars.iv.next848, %polly.loop_exit223 ], [ 1, %polly.loop_exit207 ]
  %indvars.iv837 = phi i64 [ %indvars.iv.next838, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %polly.indvar218 = phi i64 [ %polly.indvar_next219, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv847, i64 18)
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %umin875 = call i64 @llvm.umin.i64(i64 %indvars.iv873, i64 18)
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %138 = shl nsw i64 %polly.indvar405, 6
...
polly.loop_header409:                             ; preds = %polly.loop_header409.preheader, %polly.loop_exit418
  ...
  %smin867 = call i64 @llvm.smin.i64(i64 %indvars.iv865, i64 63)
...
polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  %indvars.iv900 = phi i64 [ %indvars.iv.next901, %polly.loop_exit575 ], [ 1, %polly.loop_exit559 ]
  ...
  %umin902 = call i64 @llvm.umin.i64(i64 %indvars.iv900, i64 18)
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %172 = shl nsw i64 %polly.indvar582, 6
