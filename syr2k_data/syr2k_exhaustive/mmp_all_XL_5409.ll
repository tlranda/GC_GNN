; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5409.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5409.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %101 = mul nuw nsw i64 %polly.indvar208, 25
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 99)
  ...
  %smin845.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844, i64 99)
  %108 = or i64 %104, 1
  ...
  %smin845.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.1, i64 99)
  %112 = or i64 %104, 2
  ...
  %smin845.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next844.2, i64 99)
  %116 = or i64 %104, 3
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %140 = mul nuw nsw i64 %polly.indvar381, 100
  br label %polly.loop_header384

polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %141 = mul nsw i64 %polly.indvar381, -100
  %142 = mul nuw nsw i64 %polly.indvar381, 25
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %smin866 = call i64 @llvm.smin.i64(i64 %indvars.iv862, i64 99)
  ...
  %smin866.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865, i64 99)
  %149 = or i64 %145, 1
  ...
  %smin866.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.1, i64 99)
  %153 = or i64 %145, 2
  ...
  %smin866.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next865.2, i64 99)
  %157 = or i64 %145, 3
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %181 = mul nuw nsw i64 %polly.indvar554, 100
  br label %polly.loop_header557

polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %182 = mul nsw i64 %polly.indvar554, -100
  %183 = mul nuw nsw i64 %polly.indvar554, 25
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit559
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv883, i64 99)
  ...
  %smin887.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886, i64 99)
  %190 = or i64 %186, 1
  ...
  %smin887.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.1, i64 99)
  %194 = or i64 %186, 2
  ...
  %smin887.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next886.2, i64 99)
  %198 = or i64 %186, 3
