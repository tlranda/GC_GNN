; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1007.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1007.c"
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %112 = add nuw nsw i64 %polly.indvar209, 2
...
polly.loop_header228:                             ; preds = %polly.loop_exit214, %polly.loop_exit269
  ...
  %.inv = icmp sgt i64 %123, 63
  %125 = select i1 %.inv, i64 63, i64 %124
...
polly.loop_header274:                             ; preds = %polly.loop_header267, %polly.loop_exit284
  ...
  %smin1419 = call i64 @llvm.smin.i64(i64 %143, i64 63)
...
polly.loop_header444:                             ; preds = %polly.loop_exit428, %polly.loop_exit486
  ...
  %.inv948 = icmp sgt i64 %203, 63
  %205 = select i1 %.inv948, i64 63, i64 %204
...
polly.loop_header491:                             ; preds = %polly.loop_header484, %polly.loop_exit501
  ...
  %smin1369 = call i64 @llvm.smin.i64(i64 %223, i64 63)
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %258 = mul nsw i64 %polly.indvar640, -32
  %259 = add nuw i64 %polly.indvar640, 2
  %260 = udiv i64 %259, 3
  %261 = mul nuw nsw i64 %260, 96
  %262 = add i64 %258, %261
  %263 = shl nuw nsw i64 %polly.indvar640, 5
  %264 = sub nsw i64 %263, %261
  %265 = udiv i64 %indvars.iv1152, 3
  %266 = mul nuw nsw i64 %265, 96
  %267 = add i64 %indvars.iv1150, %266
  %268 = sub nsw i64 %indvars.iv1157, %266
  %269 = mul nsw i64 %polly.indvar640, -64
  %270 = shl nsw i64 %polly.indvar640, 6
  br label %polly.loop_header643

polly.loop_exit645:                               ; preds = %polly.loop_exit651
  %271 = add nsw i64 %269, 1199
  %272 = add nuw nsw i64 %polly.indvar640, 2
  %pexp.p_div_q659 = udiv i64 %272, 3
...
polly.loop_header661:                             ; preds = %polly.loop_exit645, %polly.loop_exit703
  ...
  %.inv949 = icmp sgt i64 %283, 63
  %285 = select i1 %.inv949, i64 63, i64 %284
...
polly.loop_header708:                             ; preds = %polly.loop_header701, %polly.loop_exit718
  ...
  %smin1319 = call i64 @llvm.smin.i64(i64 %303, i64 63)
