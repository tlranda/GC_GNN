; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5143.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5143.c"
...
vector.body1192:                                  ; preds = %vector.body1192, %vector.ph1196
  ...
  %wide.load1203 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %133, label %middle.block1190, label %vector.body1192, !llvm.loop !80
...
vector.body1168:                                  ; preds = %vector.body1168, %vector.ph1170
  ...
  %wide.load1177 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %171, label %middle.block1166, label %vector.body1168, !llvm.loop !90
...
vector.body1107:                                  ; preds = %vector.body1107, %vector.ph1108
  ...
  br i1 %223, label %polly.loop_exit813, label %vector.body1107, !llvm.loop !99
...
vector.body1121:                                  ; preds = %vector.body1121, %vector.ph1124
  ...
  br i1 %252, label %polly.loop_exit840, label %vector.body1121, !llvm.loop !102
...
vector.body1139:                                  ; preds = %vector.body1139, %vector.ph1142
  ...
  br i1 %281, label %polly.loop_exit866, label %vector.body1139, !llvm.loop !105
