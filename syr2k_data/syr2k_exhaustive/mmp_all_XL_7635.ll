; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7635.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7635.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %119 = shl nsw i64 %polly.indvar230, 3
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1045
  ...
  %wide.load1052 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !73, !noalias !75
  ...
  store <4 x double> %141, <4 x double>* %142, align 8, !alias.scope !73, !noalias !75
  %index.next1049 = add i64 %index1048, 4
  %143 = icmp eq i64 %index.next1049, %n.vec1047
  br i1 %143, label %middle.block1039, label %vector.body1041, !llvm.loop !79
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %150 = add nuw nsw i64 %umin869, 11
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %167 = shl nsw i64 %polly.indvar405, 3
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  %wide.load1026 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !83, !noalias !85
  ...
  store <4 x double> %189, <4 x double>* %190, align 8, !alias.scope !83, !noalias !85
  %index.next1023 = add i64 %index1022, 4
  %191 = icmp eq i64 %index.next1023, %n.vec1021
  br i1 %191, label %middle.block1015, label %vector.body1017, !llvm.loop !89
...
polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  ...
  %198 = add nuw nsw i64 %umin893, 11
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %215 = shl nsw i64 %polly.indvar582, 3
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph957
  ...
  store <4 x double> %247, <4 x double>* %252, align 8, !alias.scope !93, !noalias !95
  ...
  br i1 %253, label %polly.loop_exit770, label %vector.body955, !llvm.loop !98
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  store <4 x double> %276, <4 x double>* %281, align 8, !alias.scope !97, !noalias !100
  ...
  br i1 %282, label %polly.loop_exit797, label %vector.body970, !llvm.loop !101
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  store <4 x double> %305, <4 x double>* %310, align 8, !alias.scope !96, !noalias !103
  ...
  br i1 %311, label %polly.loop_exit823, label %vector.body988, !llvm.loop !104
