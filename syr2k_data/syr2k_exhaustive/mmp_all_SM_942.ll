; ModuleID = 'syr2k_exhaustive/mmp_all_SM_942.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_942.c"
...
polly.loop_header269:                             ; preds = %polly.loop_exit277, %polly.loop_header263
  ...
  %smin1251 = call i64 @llvm.smin.i64(i64 %113, i64 79)
...
polly.loop_header412:                             ; preds = %polly.loop_exit436, %polly.loop_header406
  ...
  %148 = mul nuw nsw i64 %polly.indvar415, 80
...
polly.loop_header434.preheader:                   ; preds = %polly.loop_exit426
  %150 = mul nsw i64 %polly.indvar415, -80
...
polly.loop_header434:                             ; preds = %polly.loop_header434.preheader, %polly.loop_exit473
  ...
  %152 = mul nuw nsw i64 %indvar1202, 80
  %153 = mul nuw nsw i64 %polly.indvar437, 80
  %154 = add nsw i64 %153, %150
  %155 = icmp ugt i64 %154, 80
  %156 = select i1 %155, i64 %154, i64 80
  %157 = add nuw nsw i64 %154, 79
...
polly.loop_header477:                             ; preds = %polly.loop_exit485, %polly.loop_header471
  ...
  %smin1204 = call i64 @llvm.smin.i64(i64 %163, i64 79)
...
polly.loop_header620:                             ; preds = %polly.loop_exit644, %polly.loop_header614
  ...
  %198 = mul nuw nsw i64 %polly.indvar623, 80
...
polly.loop_header642.preheader:                   ; preds = %polly.loop_exit634
  %200 = mul nsw i64 %polly.indvar623, -80
...
polly.loop_header642:                             ; preds = %polly.loop_header642.preheader, %polly.loop_exit681
  ...
  %202 = mul nuw nsw i64 %indvar1155, 80
  %203 = mul nuw nsw i64 %polly.indvar645, 80
  %204 = add nsw i64 %203, %200
  %205 = icmp ugt i64 %204, 80
  %206 = select i1 %205, i64 %204, i64 80
  %207 = add nuw nsw i64 %204, 79
...
polly.loop_header685:                             ; preds = %polly.loop_exit693, %polly.loop_header679
  ...
  %smin1157 = call i64 @llvm.smin.i64(i64 %213, i64 79)
