; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4791.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4791.c"
...
vector.body1194:                                  ; preds = %vector.body1194, %vector.ph1196
  ...
  br i1 %57, label %middle.block1192, label %vector.body1194, !llvm.loop !53
...
vector.body1220:                                  ; preds = %vector.body1220, %vector.ph1222
  ...
  br i1 %68, label %middle.block1218, label %vector.body1220, !llvm.loop !55
...
vector.body1232:                                  ; preds = %vector.body1232, %vector.ph1236
  ...
  %wide.load1243 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !61, !noalias !63
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond998.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !68
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin991 = call i64 @llvm.smin.i64(i64 %indvars.iv989, i64 -1136)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next976 = add nuw nsw i64 %indvars.iv975, 64
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin987 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -936)
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin985 = call i64 @llvm.smin.i64(i64 %indvars.iv979, i64 63)
...
vector.body1206:                                  ; preds = %vector.body1206, %vector.ph1210
  ...
  %wide.load1217 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %126, label %middle.block1204, label %vector.body1206, !llvm.loop !78
...
polly.loop_header371:                             ; preds = %polly.loop_header371.preheader, %polly.loop_header371
  ...
  br i1 %exitcond1027.not, label %polly.loop_exit373, label %polly.loop_header371, !llvm.loop !79
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %128 = shl nsw i64 %polly.indvar384, 6
...
polly.loop_exit389:                               ; preds = %polly.loop_exit395
  ...
  %exitcond1026.not = icmp eq i64 %polly.indvar_next385, 19
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %exitcond1025.not = icmp eq i64 %polly.indvar_next391, 16
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %132 = shl nsw i64 %polly.indvar396, 6
...
polly.loop_header399:                             ; preds = %polly.loop_exit436, %polly.loop_header393
  ...
  %smin1014 = call i64 @llvm.smin.i64(i64 %indvars.iv1008, i64 63)
...
polly.start467:                                   ; preds = %init_array.exit
  %malloccall469 = tail call dereferenceable_or_null(614400) i8* @malloc(i64 614400) #6
...
vector.body1182:                                  ; preds = %vector.body1182, %vector.ph1184
  ...
  %wide.load1191 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !82, !noalias !84
  ...
  store <4 x double> %155, <4 x double>* %156, align 8, !alias.scope !82, !noalias !84
  %index.next1188 = add i64 %index1187, 4
  %157 = icmp eq i64 %index.next1188, %n.vec1186
  br i1 %157, label %middle.block1180, label %vector.body1182, !llvm.loop !88
...
polly.loop_header559:                             ; preds = %polly.loop_header559.preheader, %polly.loop_header559
  ...
  br i1 %exitcond1056.not, label %polly.loop_exit561, label %polly.loop_header559, !llvm.loop !89
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %159 = shl nsw i64 %polly.indvar572, 6
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar_next573, 19
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %smin1045 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 -936)
  %161 = add nsw i64 %smin1045, 1000
  %162 = shl nsw i64 %polly.indvar578, 6
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %exitcond1054.not = icmp eq i64 %polly.indvar_next579, 16
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_header575
  ...
  %163 = shl nsw i64 %polly.indvar584, 6
...
polly.loop_header587:                             ; preds = %polly.loop_exit624, %polly.loop_header581
  ...
  %smin1043 = call i64 @llvm.smin.i64(i64 %indvars.iv1037, i64 63)
...
vector.body1121:                                  ; preds = %vector.body1121, %vector.ph1122
  ...
  store <4 x double> %196, <4 x double>* %201, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %202, label %polly.loop_exit799, label %vector.body1121, !llvm.loop !97
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  br i1 %exitcond1081.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !98
...
vector.body1135:                                  ; preds = %vector.body1135, %vector.ph1138
  ...
  store <4 x double> %225, <4 x double>* %230, align 8, !alias.scope !96, !noalias !99
  ...
  br i1 %231, label %polly.loop_exit826, label %vector.body1135, !llvm.loop !100
...
polly.loop_header824:                             ; preds = %polly.loop_header818, %polly.loop_header824
  ...
  br i1 %exitcond1071.not, label %polly.loop_exit826, label %polly.loop_header824, !llvm.loop !101
...
vector.body1153:                                  ; preds = %vector.body1153, %vector.ph1156
  ...
  store <4 x double> %254, <4 x double>* %259, align 8, !alias.scope !95, !noalias !102
  ...
  br i1 %260, label %polly.loop_exit852, label %vector.body1153, !llvm.loop !103
...
polly.loop_header850:                             ; preds = %polly.loop_header844, %polly.loop_header850
  ...
  br i1 %exitcond1061.not, label %polly.loop_exit852, label %polly.loop_header850, !llvm.loop !104
}
