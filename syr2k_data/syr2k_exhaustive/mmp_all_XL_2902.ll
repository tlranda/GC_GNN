; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2902.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2902.c"
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %158 = shl nuw nsw i64 %polly.indvar386, 4
  %159 = mul nsw i64 %polly.indvar386, -128
  %160 = shl nsw i64 %polly.indvar386, 7
...
polly.loop_header389:                             ; preds = %polly.loop_exit430, %polly.loop_header383
  ...
  %.inv857 = icmp ugt i64 %162, 127
  %164 = select i1 %.inv857, i64 127, i64 %163
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %219 = shl nuw nsw i64 %polly.indvar572, 4
  %220 = mul nsw i64 %polly.indvar572, -128
  %221 = shl nsw i64 %polly.indvar572, 7
...
polly.loop_header575:                             ; preds = %polly.loop_exit616, %polly.loop_header569
  ...
  %.inv858 = icmp ugt i64 %223, 127
  %225 = select i1 %.inv858, i64 127, i64 %224
