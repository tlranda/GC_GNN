; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9584.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9584.c"
...
polly.loop_header205.us:                          ; preds = %polly.loop_header199, %polly.loop_exit213.loopexit.us
  ...
  %101 = shl nsw i64 %polly.indvar208.us, 4
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %103 = mul nuw nsw i64 %polly.indvar214.us, 20
  %104 = add nsw i64 %103, %99
  %105 = icmp sgt i64 %104, 0
  %106 = select i1 %105, i64 %104, i64 0
  %polly.loop_guard221.us = icmp slt i64 %106, 16
...
polly.loop_exit213.loopexit.us:                   ; preds = %polly.loop_exit220.us
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next209.us, 63
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213.loopexit.us, %polly.loop_header199
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar_next203, 75
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %132 = mul nsw i64 %polly.indvar359, -16
  %133 = shl nsw i64 %polly.indvar359, 4
...
polly.loop_header362.us:                          ; preds = %polly.loop_header356, %polly.loop_exit372.loopexit.us
  ...
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 -984)
  %134 = shl nsw i64 %polly.indvar365.us, 4
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %136 = mul nuw nsw i64 %polly.indvar374.us, 20
  %137 = add nsw i64 %136, %132
  %138 = icmp sgt i64 %137, 0
  %139 = select i1 %138, i64 %137, i64 0
  %polly.loop_guard381.us = icmp slt i64 %139, 16
...
polly.loop_exit380.us:                            ; preds = %polly.loop_exit387.us, %polly.loop_header370.us
  ...
  %indvars.iv.next917 = add nsw i64 %indvars.iv916, -20
...
polly.loop_exit372.loopexit.us:                   ; preds = %polly.loop_exit380.us
  ...
  %indvars.iv.next923 = add nsw i64 %indvars.iv922, -16
  %exitcond926.not = icmp eq i64 %polly.indvar_next366.us, 63
...
polly.loop_exit364:                               ; preds = %polly.loop_exit372.loopexit.us, %polly.loop_header356
  ...
  %indvars.iv.next910 = add nsw i64 %indvars.iv909, -16
  %indvars.iv.next915 = add nuw nsw i64 %indvars.iv914, 16
  %exitcond927.not = icmp eq i64 %polly.indvar_next360, 75
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %165 = mul nsw i64 %polly.indvar519, -16
  %166 = shl nsw i64 %polly.indvar519, 4
...
polly.loop_header522.us:                          ; preds = %polly.loop_header516, %polly.loop_exit532.loopexit.us
  ...
  %smin945 = call i64 @llvm.smin.i64(i64 %indvars.iv943, i64 -984)
  %167 = shl nsw i64 %polly.indvar525.us, 4
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %169 = mul nuw nsw i64 %polly.indvar534.us, 20
  %170 = add nsw i64 %169, %165
  %171 = icmp sgt i64 %170, 0
  %172 = select i1 %171, i64 %170, i64 0
  %polly.loop_guard541.us = icmp slt i64 %172, 16
...
polly.loop_header538.us:                          ; preds = %polly.loop_header538.preheader.us, %polly.loop_exit547.us
  ...
  %smin941 = call i64 @llvm.smin.i64(i64 %indvars.iv939, i64 19)
...
polly.loop_exit540.us:                            ; preds = %polly.loop_exit547.us, %polly.loop_header530.us
  ...
  %indvars.iv.next933 = add nsw i64 %indvars.iv932, 20
  %indvars.iv.next938 = add nsw i64 %indvars.iv937, -20
...
polly.loop_exit532.loopexit.us:                   ; preds = %polly.loop_exit540.us
  ...
  %indvars.iv.next944 = add nsw i64 %indvars.iv943, -16
  %exitcond947.not = icmp eq i64 %polly.indvar_next526.us, 63
...
polly.loop_exit524:                               ; preds = %polly.loop_exit532.loopexit.us, %polly.loop_header516
  ...
  %indvars.iv.next931 = add nsw i64 %indvars.iv930, -16
  %indvars.iv.next936 = add nuw nsw i64 %indvars.iv935, 16
  %exitcond948.not = icmp eq i64 %polly.indvar_next520, 75
