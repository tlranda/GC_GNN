; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9975.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9975.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %101 = mul nuw nsw i64 %polly.indvar208, 50
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %indvars.iv.next790 = add nsw i64 %indvars.iv789, -4
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233877 = icmp sgt i64 %108, -1
  %109 = add nuw nsw i64 %polly.indvar220, %100
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %122 = shl nuw nsw i64 %index999, 3
  %123 = getelementptr i8, i8* %scevgep350, i64 %122
  %124 = bitcast i8* %123 to <4 x double>*
  %wide.load1003 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !68, !noalias !70
  %125 = fmul fast <4 x double> %wide.load1003, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %127 = icmp eq i64 %index.next1000, %n.vec998
  br i1 %127, label %middle.block990, label %vector.body992, !llvm.loop !73

middle.block990:                                  ; preds = %vector.body992
  %cmp.n1002 = icmp eq i64 %120, %n.vec998
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %129 = lshr i64 %polly.indvar357, 1
  %130 = add nuw i64 %indvars.iv815, %129
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %133 = mul nuw nsw i64 %polly.indvar363, 50
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %134 = shl nsw i64 %polly.indvar370, 2
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %indvars.iv.next809 = add nsw i64 %indvars.iv808, -4
  %exitcond817.not = icmp eq i64 %polly.indvar_next371, %130
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv810 = phi i64 [ %138, %polly.loop_header374.preheader ], [ %indvars.iv.next811, %polly.loop_exit383 ]
  %polly.indvar378 = phi i64 [ %137, %polly.loop_header374.preheader ], [ %polly.indvar_next379, %polly.loop_exit383 ]
  %smin812 = call i64 @llvm.smin.i64(i64 %indvars.iv810, i64 3)
  %140 = add nsw i64 %polly.indvar378, %139
  %polly.loop_guard391878 = icmp sgt i64 %140, -1
  %141 = add nuw nsw i64 %polly.indvar378, %132
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %154 = shl nuw nsw i64 %index973, 3
  %155 = getelementptr i8, i8* %scevgep508, i64 %154
  %156 = bitcast i8* %155 to <4 x double>*
  %wide.load977 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !77, !noalias !79
  %157 = fmul fast <4 x double> %wide.load977, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %159 = icmp eq i64 %index.next974, %n.vec972
  br i1 %159, label %middle.block966, label %vector.body968, !llvm.loop !82

middle.block966:                                  ; preds = %vector.body968
  %cmp.n976 = icmp eq i64 %152, %n.vec972
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %161 = lshr i64 %polly.indvar515, 1
  %162 = add nuw i64 %indvars.iv836, %161
  %163 = mul nsw i64 %polly.indvar515, -50
  %164 = mul nuw nsw i64 %polly.indvar515, 50
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %165 = mul nuw nsw i64 %polly.indvar521, 50
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %166 = shl nsw i64 %polly.indvar528, 2
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %170 = add i64 %smax826, %indvars.iv829
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %indvars.iv.next825 = add nsw i64 %indvars.iv824, 4
  %indvars.iv.next830 = add nsw i64 %indvars.iv829, -4
  %exitcond838.not = icmp eq i64 %polly.indvar_next529, %162
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv831 = phi i64 [ %170, %polly.loop_header532.preheader ], [ %indvars.iv.next832, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %169, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin833 = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 3)
  %172 = add nsw i64 %polly.indvar536, %171
  %polly.loop_guard549879 = icmp sgt i64 %172, -1
  %173 = add nuw nsw i64 %polly.indvar536, %164
...
polly.loop_header539.us:                          ; preds = %polly.loop_header532, %polly.loop_exit548.loopexit.us
  ...
  %176 = add nuw nsw i64 %polly.indvar542.us, %165
  %177 = shl i64 %176, 3
  %178 = add i64 %177, %174
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin907 = call i64 @llvm.smin.i64(i64 %186, i64 -1168)
  %187 = add nsw i64 %smin907, 1200
  %smin865 = call i64 @llvm.smin.i64(i64 %indvars.iv863, i64 -1168)
  %188 = shl nsw i64 %polly.indvar703, 5
  %189 = add nsw i64 %smin865, 1199
...
vector.ph908:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert915 = insertelement <4 x i64> poison, i64 %188, i32 0
  %broadcast.splat916 = shufflevector <4 x i64> %broadcast.splatinsert915, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert917 = insertelement <4 x i32> poison, i32 %191, i32 0
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  %193 = add nuw nsw <4 x i64> %vec.ind913, %broadcast.splat916
  %194 = trunc <4 x i64> %193 to <4 x i32>
  %195 = mul <4 x i32> %broadcast.splat918, %194
  ...
  %205 = icmp eq i64 %index.next910, %187
  br i1 %205, label %polly.loop_exit714, label %vector.body906, !llvm.loop !91

polly.loop_exit714:                               ; preds = %vector.body906, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond870.not = icmp eq i64 %polly.indvar709, %185
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar715, %189
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin922 = call i64 @llvm.smin.i64(i64 %215, i64 -968)
  %216 = add nsw i64 %smin922, 1000
  %smin855 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -968)
  %217 = shl nsw i64 %polly.indvar730, 5
  %218 = add nsw i64 %smin855, 999
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  %222 = add nuw nsw <4 x i64> %vec.ind931, %broadcast.splat934
  %223 = trunc <4 x i64> %222 to <4 x i32>
  %224 = mul <4 x i32> %broadcast.splat936, %223
  ...
  %234 = icmp eq i64 %index.next928, %216
  br i1 %234, label %polly.loop_exit741, label %vector.body921, !llvm.loop !94

polly.loop_exit741:                               ; preds = %vector.body921, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond860.not = icmp eq i64 %polly.indvar736, %214
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar742, %218
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin940 = call i64 @llvm.smin.i64(i64 %244, i64 -968)
  %245 = add nsw i64 %smin940, 1000
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 -968)
  %246 = shl nsw i64 %polly.indvar756, 5
  %247 = add nsw i64 %smin845, 999
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  %251 = add nuw nsw <4 x i64> %vec.ind949, %broadcast.splat952
  %252 = trunc <4 x i64> %251 to <4 x i32>
  %253 = mul <4 x i32> %broadcast.splat954, %252
  ...
  %263 = icmp eq i64 %index.next946, %245
  br i1 %263, label %polly.loop_exit767, label %vector.body939, !llvm.loop !97

polly.loop_exit767:                               ; preds = %vector.body939, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond850.not = icmp eq i64 %polly.indvar762, %243
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar768, %247
