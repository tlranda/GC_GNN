; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4595.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4595.c"
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit388
  ...
  %129 = udiv i64 %indvars.iv1002, 25
  %umin1004 = call i64 @llvm.umin.i64(i64 %129, i64 11)
...
polly.loop_header386:                             ; preds = %polly.loop_exit395, %polly.loop_header379
  ...
  %135 = mul nuw nsw i64 %polly.indvar389, 100
...
polly.loop_header566:                             ; preds = %polly.loop_header566.preheader, %polly.loop_exit575
  %indvars.iv1027 = phi i64 [ 7, %polly.loop_header566.preheader ], [ %indvars.iv.next1028, %polly.loop_exit575 ]
  ...
  %161 = udiv i64 %indvars.iv1027, 25
  %umin1029 = call i64 @llvm.umin.i64(i64 %161, i64 11)
...
polly.loop_exit582:                               ; preds = %polly.loop_exit618, %polly.loop_header573
  ...
  %indvars.iv.next1013 = add nsw i64 %indvars.iv1012, 100
  %indvars.iv.next1018 = add nsw i64 %indvars.iv1017, -100
