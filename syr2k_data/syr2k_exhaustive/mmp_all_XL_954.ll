; ModuleID = 'syr2k_exhaustive/mmp_all_XL_954.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_954.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1194 = call i64 @llvm.smin.i64(i64 %indvars.iv1168, i64 -872)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1197.not = icmp eq i64 %polly.indvar_next204, 8
...
polly.loop_header425:                             ; preds = %polly.loop_header425.preheader, %polly.loop_exit433
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %indvars.iv1203, i64 -872)
  %171 = add nsw i64 %smin1231, 1000
  %172 = shl nsw i64 %polly.indvar428, 7
...
polly.loop_exit433:                               ; preds = %polly.loop_exit456
  ...
  %indvars.iv.next1204 = add nsw i64 %indvars.iv1203, -128
  %exitcond1234.not = icmp eq i64 %polly.indvar_next429, 8
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit665
  ...
  %smin1268 = call i64 @llvm.smin.i64(i64 %indvars.iv1240, i64 -872)
  %245 = add nsw i64 %smin1268, 1000
  %246 = shl nsw i64 %polly.indvar660, 7
...
polly.loop_exit665:                               ; preds = %polly.loop_exit688
  ...
  %indvars.iv.next1241 = add nsw i64 %indvars.iv1240, -128
  %exitcond1271.not = icmp eq i64 %polly.indvar_next661, 8
