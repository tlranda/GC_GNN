; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7735.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7735.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv832, i64 69)
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next833 = add nuw nsw i64 %indvars.iv832, 6
  %exitcond835.not = icmp eq i64 %polly.indvar_next219, 13
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  ...
  %107 = add i64 %smax, %indvars.iv827
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %exitcond834.not = icmp eq i64 %polly.indvar224, %102
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  %indvars.iv829 = phi i64 [ %107, %polly.loop_header227.preheader ], [ %indvars.iv.next830, %polly.loop_exit235 ]
  %polly.indvar230 = phi i64 [ %106, %polly.loop_header227.preheader ], [ %polly.indvar_next231, %polly.loop_exit235 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 15)
  %109 = add nsw i64 %polly.indvar230, %108
  %polly.loop_guard243917 = icmp sgt i64 %109, -1
  %110 = add nuw nsw i64 %polly.indvar230, %101
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1030
  ...
  %120 = shl nuw nsw i64 %index1033, 3
  %121 = getelementptr i8, i8* %scevgep366, i64 %120
  %122 = bitcast i8* %121 to <4 x double>*
  %wide.load1037 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !74, !noalias !76
  %123 = fmul fast <4 x double> %wide.load1037, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %125 = icmp eq i64 %index.next1034, %n.vec1032
  br i1 %125, label %middle.block1024, label %vector.body1026, !llvm.loop !80

middle.block1024:                                 ; preds = %vector.body1026
  %cmp.n1036 = icmp eq i64 %118, %n.vec1032
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit394
  %indvars.iv854 = phi i64 [ %indvars.iv.next855, %polly.loop_exit394 ], [ 0, %polly.loop_exit378 ]
  ...
  %umin856 = call i64 @llvm.umin.i64(i64 %indvars.iv854, i64 69)
  %127 = mul nsw i64 %polly.indvar389, -96
  %128 = icmp slt i64 %127, -1104
  %129 = select i1 %128, i64 %127, i64 -1104
  %130 = add nsw i64 %129, 1199
  %131 = mul nuw nsw i64 %polly.indvar389, 96
  %132 = add nuw nsw i64 %umin856, 5
  br label %polly.loop_header392

polly.loop_exit394:                               ; preds = %polly.loop_exit401
  %polly.indvar_next390 = add nuw nsw i64 %polly.indvar389, 1
  %indvars.iv.next841 = add nsw i64 %indvars.iv840, -96
  %indvars.iv.next846 = add nuw nsw i64 %indvars.iv845, 96
  %indvars.iv.next855 = add nuw nsw i64 %indvars.iv854, 6
  %exitcond858.not = icmp eq i64 %polly.indvar_next390, 13
...
polly.loop_header392:                             ; preds = %polly.loop_exit401, %polly.loop_header386
  ...
  %polly.loop_guard402.not = icmp sgt i64 %136, %130
...
polly.loop_header399.preheader:                   ; preds = %polly.loop_header392
  ...
  %137 = add i64 %smax844, %indvars.iv847
  %138 = sub nsw i64 %131, %133
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408, %polly.loop_header392
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar395, %132
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit408
  %indvars.iv849 = phi i64 [ %137, %polly.loop_header399.preheader ], [ %indvars.iv.next850, %polly.loop_exit408 ]
  %polly.indvar403 = phi i64 [ %136, %polly.loop_header399.preheader ], [ %polly.indvar_next404, %polly.loop_exit408 ]
  %smin851 = call i64 @llvm.smin.i64(i64 %indvars.iv849, i64 15)
  %139 = add nsw i64 %polly.indvar403, %138
  %polly.loop_guard416918 = icmp sgt i64 %139, -1
  %140 = add nuw nsw i64 %polly.indvar403, %131
...
polly.loop_header406.us:                          ; preds = %polly.loop_header399, %polly.loop_exit415.loopexit.us
  ...
  %143 = shl nuw nsw i64 %polly.indvar409.us, 3
  %scevgep420.us = getelementptr i8, i8* %call1, i64 %143
  %polly.access.mul.Packed_MemRef_call2271424.us = mul nuw nsw i64 %polly.indvar409.us, 1200
  %polly.access.add.Packed_MemRef_call2271425.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2271424.us, %140
  ...
  %scevgep433.us = getelementptr i8, i8* %scevgep420.us, i64 %141
...
polly.loop_header413.us:                          ; preds = %polly.loop_header413.us, %polly.loop_header406.us
  ...
  %144 = add nuw nsw i64 %polly.indvar417.us, %133
  %145 = mul nuw nsw i64 %144, 8000
  %scevgep421.us = getelementptr i8, i8* %scevgep420.us, i64 %145
  ...
  %polly.access.add.Packed_MemRef_call2271429.us = add nuw nsw i64 %144, %polly.access.mul.Packed_MemRef_call2271424.us
  ...
  %146 = shl i64 %144, 3
  %147 = add i64 %146, %142
  %scevgep436.us = getelementptr i8, i8* %call, i64 %147
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415.loopexit.us, %polly.loop_header399
  ...
  %polly.loop_cond405.not.not = icmp ult i64 %polly.indvar403, %130
...
polly.loop_header527:                             ; preds = %polly.loop_exit535, %polly.start441
  ...
  %min.iters.check1003 = icmp ult i64 %148, 4
...
vector.body1002:                                  ; preds = %vector.body1002, %vector.ph1004
  ...
  %150 = shl nuw nsw i64 %index1007, 3
  %151 = getelementptr i8, i8* %scevgep539, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load1011 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !84, !noalias !86
  %153 = fmul fast <4 x double> %wide.load1011, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next1008, %n.vec1006
  br i1 %155, label %middle.block1000, label %vector.body1002, !llvm.loop !90

middle.block1000:                                 ; preds = %vector.body1002
  %cmp.n1010 = icmp eq i64 %148, %n.vec1006
...
polly.loop_header559:                             ; preds = %polly.loop_exit551, %polly.loop_exit567
  %indvars.iv877 = phi i64 [ %indvars.iv.next878, %polly.loop_exit567 ], [ 0, %polly.loop_exit551 ]
  ...
  %umin879 = call i64 @llvm.umin.i64(i64 %indvars.iv877, i64 69)
  %157 = mul nsw i64 %polly.indvar562, -96
  %158 = icmp slt i64 %157, -1104
  %159 = select i1 %158, i64 %157, i64 -1104
  %160 = add nsw i64 %159, 1199
  %161 = mul nuw nsw i64 %polly.indvar562, 96
  %162 = add nuw nsw i64 %umin879, 5
...
polly.loop_exit567:                               ; preds = %polly.loop_exit574
  ...
  %indvars.iv.next864 = add nsw i64 %indvars.iv863, -96
  %indvars.iv.next869 = add nuw nsw i64 %indvars.iv868, 96
  %indvars.iv.next878 = add nuw nsw i64 %indvars.iv877, 6
  %exitcond881.not = icmp eq i64 %polly.indvar_next563, 13
...
polly.loop_header565:                             ; preds = %polly.loop_exit574, %polly.loop_header559
  ...
  %163 = shl nsw i64 %polly.indvar568, 4
  %164 = add nsw i64 %163, %157
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard575.not = icmp sgt i64 %166, %160
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header565
  ...
  %167 = add i64 %smax867, %indvars.iv870
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_header565
  ...
  %indvars.iv.next871 = add nsw i64 %indvars.iv870, -16
  %exitcond880.not = icmp eq i64 %polly.indvar568, %162
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit581
  %indvars.iv872 = phi i64 [ %167, %polly.loop_header572.preheader ], [ %indvars.iv.next873, %polly.loop_exit581 ]
  %polly.indvar576 = phi i64 [ %166, %polly.loop_header572.preheader ], [ %polly.indvar_next577, %polly.loop_exit581 ]
  %smin874 = call i64 @llvm.smin.i64(i64 %indvars.iv872, i64 15)
  %169 = add nsw i64 %polly.indvar576, %168
  %polly.loop_guard589919 = icmp sgt i64 %169, -1
  %170 = add nuw nsw i64 %polly.indvar576, %161
...
polly.loop_header579.us:                          ; preds = %polly.loop_header572, %polly.loop_exit588.loopexit.us
  ...
  %173 = shl nuw nsw i64 %polly.indvar582.us, 3
  %scevgep593.us = getelementptr i8, i8* %call1, i64 %173
  %polly.access.mul.Packed_MemRef_call2444597.us = mul nuw nsw i64 %polly.indvar582.us, 1200
  %polly.access.add.Packed_MemRef_call2444598.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2444597.us, %170
  ...
  %scevgep606.us = getelementptr i8, i8* %scevgep593.us, i64 %171
...
polly.loop_header586.us:                          ; preds = %polly.loop_header586.us, %polly.loop_header579.us
  ...
  %174 = add nuw nsw i64 %polly.indvar590.us, %163
  %175 = mul nuw nsw i64 %174, 8000
  %scevgep594.us = getelementptr i8, i8* %scevgep593.us, i64 %175
  ...
  %polly.access.add.Packed_MemRef_call2444602.us = add nuw nsw i64 %174, %polly.access.mul.Packed_MemRef_call2444597.us
  ...
  %176 = shl i64 %174, 3
  %177 = add i64 %176, %172
  %scevgep609.us = getelementptr i8, i8* %call, i64 %177
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588.loopexit.us, %polly.loop_header572
  ...
  %polly.loop_cond578.not.not = icmp ult i64 %polly.indvar576, %160
...
polly.loop_header744:                             ; preds = %polly.loop_exit752, %polly.loop_header738
  ...
  %smin941 = call i64 @llvm.smin.i64(i64 %180, i64 -1168)
  %181 = add nsw i64 %smin941, 1200
  %smin908 = call i64 @llvm.smin.i64(i64 %indvars.iv906, i64 -1168)
  %182 = shl nsw i64 %polly.indvar747, 5
  %183 = add nsw i64 %smin908, 1199
...
vector.ph942:                                     ; preds = %polly.loop_header750
  %broadcast.splatinsert949 = insertelement <4 x i64> poison, i64 %182, i32 0
  %broadcast.splat950 = shufflevector <4 x i64> %broadcast.splatinsert949, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert951 = insertelement <4 x i32> poison, i32 %185, i32 0
...
vector.body940:                                   ; preds = %vector.body940, %vector.ph942
  ...
  %187 = add nuw nsw <4 x i64> %vec.ind947, %broadcast.splat950
  %188 = trunc <4 x i64> %187 to <4 x i32>
  %189 = mul <4 x i32> %broadcast.splat952, %188
  ...
  %199 = icmp eq i64 %index.next944, %181
  br i1 %199, label %polly.loop_exit758, label %vector.body940, !llvm.loop !99

polly.loop_exit758:                               ; preds = %vector.body940, %polly.loop_header756
  %polly.indvar_next754 = add nuw nsw i64 %polly.indvar753, 1
  %exitcond913.not = icmp eq i64 %polly.indvar753, %179
...
polly.loop_header756:                             ; preds = %polly.loop_header750, %polly.loop_header756
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar759, %183
...
polly.loop_header771:                             ; preds = %polly.loop_exit779, %polly.loop_header765
  ...
  %smin956 = call i64 @llvm.smin.i64(i64 %209, i64 -968)
  %210 = add nsw i64 %smin956, 1000
  %smin898 = call i64 @llvm.smin.i64(i64 %indvars.iv896, i64 -968)
  %211 = shl nsw i64 %polly.indvar774, 5
  %212 = add nsw i64 %smin898, 999
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph958
  ...
  %216 = add nuw nsw <4 x i64> %vec.ind965, %broadcast.splat968
  %217 = trunc <4 x i64> %216 to <4 x i32>
  %218 = mul <4 x i32> %broadcast.splat970, %217
  ...
  %228 = icmp eq i64 %index.next962, %210
  br i1 %228, label %polly.loop_exit785, label %vector.body955, !llvm.loop !102

polly.loop_exit785:                               ; preds = %vector.body955, %polly.loop_header783
  %polly.indvar_next781 = add nuw nsw i64 %polly.indvar780, 1
  %exitcond903.not = icmp eq i64 %polly.indvar780, %208
...
polly.loop_header783:                             ; preds = %polly.loop_header777, %polly.loop_header783
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar786, %212
...
polly.loop_header797:                             ; preds = %polly.loop_exit805, %polly.loop_header791
  ...
  %smin974 = call i64 @llvm.smin.i64(i64 %238, i64 -968)
  %239 = add nsw i64 %smin974, 1000
  %smin888 = call i64 @llvm.smin.i64(i64 %indvars.iv886, i64 -968)
  %240 = shl nsw i64 %polly.indvar800, 5
  %241 = add nsw i64 %smin888, 999
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph976
  ...
  %245 = add nuw nsw <4 x i64> %vec.ind983, %broadcast.splat986
  %246 = trunc <4 x i64> %245 to <4 x i32>
  %247 = mul <4 x i32> %broadcast.splat988, %246
  ...
  %257 = icmp eq i64 %index.next980, %239
  br i1 %257, label %polly.loop_exit811, label %vector.body973, !llvm.loop !105

polly.loop_exit811:                               ; preds = %vector.body973, %polly.loop_header809
  %polly.indvar_next807 = add nuw nsw i64 %polly.indvar806, 1
  %exitcond893.not = icmp eq i64 %polly.indvar806, %237
...
polly.loop_header809:                             ; preds = %polly.loop_header803, %polly.loop_header809
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar812, %241
