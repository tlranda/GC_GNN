; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4777.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4777.c"
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %polly.loop_guard2331083 = icmp sgt i64 %113, -1
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1201
  ...
  %wide.load1208 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %135, label %middle.block1195, label %vector.body1197, !llvm.loop !80
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %137 = udiv i64 %polly.indvar386, 5
  %138 = add nuw i64 %indvars.iv1015, %137
  %umin1017 = call i64 @llvm.umin.i64(i64 %138, i64 56)
  %139 = mul nsw i64 %polly.indvar386, -64
  %140 = icmp slt i64 %139, -1136
  %141 = select i1 %140, i64 %139, i64 -1136
  %142 = add nsw i64 %141, 1199
  %143 = shl nsw i64 %polly.indvar386, 6
  %144 = add nuw nsw i64 %umin1017, 3
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond1019.not = icmp eq i64 %polly.indvar_next393, 20
...
polly.loop_header403.preheader:                   ; preds = %polly.loop_header396
  ...
  %150 = add i64 %smax1002, %indvars.iv1005
...
polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar399, %144
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  %indvars.iv1007 = phi i64 [ %150, %polly.loop_header403.preheader ], [ %indvars.iv.next1008, %polly.loop_exit441 ]
  ...
  %polly.loop_guard4201084 = icmp sgt i64 %153, -1
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1175
  ...
  %wide.load1182 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %175, label %middle.block1171, label %vector.body1173, !llvm.loop !90
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %177 = udiv i64 %polly.indvar577, 5
  %178 = add nuw i64 %indvars.iv1041, %177
  %umin1043 = call i64 @llvm.umin.i64(i64 %178, i64 56)
  %179 = mul nsw i64 %polly.indvar577, -64
  %180 = icmp slt i64 %179, -1136
  %181 = select i1 %180, i64 %179, i64 -1136
  %182 = add nsw i64 %181, 1199
  %183 = shl nsw i64 %polly.indvar577, 6
  %184 = add nuw nsw i64 %umin1043, 3
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar_next584, 20
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header587
  ...
  %190 = add i64 %smax1028, %indvars.iv1031
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %exitcond1044.not = icmp eq i64 %polly.indvar590, %184
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1033 = phi i64 [ %190, %polly.loop_header594.preheader ], [ %indvars.iv.next1034, %polly.loop_exit632 ]
  ...
  %polly.loop_guard6111085 = icmp sgt i64 %193, -1
...
polly.merge620.us:                                ; preds = %polly.then621.us, %polly.cond619.loopexit.us
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar_next605.us, 50
...
polly.loop_header601:                             ; preds = %polly.loop_header594.split, %polly.loop_header601
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next605, 50
...
polly.loop_exit639.loopexit.us:                   ; preds = %polly.loop_header637.us
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next634.us, 50
...
vector.body1112:                                  ; preds = %vector.body1112, %vector.ph1113
  ...
  br i1 %229, label %polly.loop_exit807, label %vector.body1112, !llvm.loop !99

polly.loop_exit807:                               ; preds = %vector.body1112, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1076.not = icmp eq i64 %polly.indvar802, %209
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1072.not = icmp eq i64 %polly.indvar808, %213
...
vector.body1126:                                  ; preds = %vector.body1126, %vector.ph1129
  ...
  br i1 %258, label %polly.loop_exit834, label %vector.body1126, !llvm.loop !102

polly.loop_exit834:                               ; preds = %vector.body1126, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1066.not = icmp eq i64 %polly.indvar829, %238
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar835, %242
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1147
  ...
  br i1 %287, label %polly.loop_exit860, label %vector.body1144, !llvm.loop !105

polly.loop_exit860:                               ; preds = %vector.body1144, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1056.not = icmp eq i64 %polly.indvar855, %267
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar861, %271
