; ModuleID = 'syr2k_exhaustive/mmp_all_SM_585.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_585.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1116 = call i64 @llvm.smin.i64(i64 %indvars.iv1096, i64 -872)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1120.not = icmp eq i64 %polly.indvar_next204, 8
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %101 = and i64 %100, 9223372036854775776
...
polly.loop_exit265:                               ; preds = %polly.loop_exit272, %polly.loop_header263.preheader
  ...
  %exitcond1118.not = icmp eq i64 %polly.indvar_next232, 38
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %150 = mul nsw i64 %polly.indvar231, -32
  %151 = icmp slt i64 %150, -1168
  %152 = select i1 %151, i64 %150, i64 -1168
...
vector.body1429:                                  ; preds = %vector.body1429, %vector.ph1437
  ...
  %wide.load1450 = load <4 x double>, <4 x double>* %171, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %176, label %middle.block1427, label %vector.body1429, !llvm.loop !84
...
vector.body1365:                                  ; preds = %vector.body1365, %vector.ph1369
  ...
  %wide.load1376 = load <4 x double>, <4 x double>* %184, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %187, label %middle.block1363, label %vector.body1365, !llvm.loop !93
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %smin1148 = call i64 @llvm.smin.i64(i64 %indvars.iv1126, i64 -872)
  %189 = add nsw i64 %smin1148, 1000
  %190 = shl nsw i64 %polly.indvar413, 7
  br label %polly.loop_header416

polly.loop_exit418:                               ; preds = %polly.loop_exit441
  %polly.indvar_next414 = add nuw nsw i64 %polly.indvar413, 1
  %indvars.iv.next1127 = add nsw i64 %indvars.iv1126, -128
  %exitcond1152.not = icmp eq i64 %polly.indvar_next414, 8
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %196 = add i64 %195, %193
  %197 = lshr i64 %polly.indvar419, 1
...
polly.loop_exit482:                               ; preds = %polly.loop_exit489, %polly.loop_header480.preheader
  ...
  %indvars.iv.next1143 = add i64 %indvars.iv1142, 32
  %exitcond1150.not = icmp eq i64 %polly.indvar_next443, 38
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %242 = mul nsw i64 %polly.indvar442, -32
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1387
  ...
  %wide.load1400 = load <4 x double>, <4 x double>* %263, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %268, label %middle.block1377, label %vector.body1379, !llvm.loop !97
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1319
  ...
  %wide.load1326 = load <4 x double>, <4 x double>* %276, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %279, label %middle.block1315, label %vector.body1317, !llvm.loop !106
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %smin1180 = call i64 @llvm.smin.i64(i64 %indvars.iv1158, i64 -872)
  %281 = add nsw i64 %smin1180, 1000
  %282 = shl nsw i64 %polly.indvar630, 7
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %indvars.iv.next1159 = add nsw i64 %indvars.iv1158, -128
  %exitcond1184.not = icmp eq i64 %polly.indvar_next631, 8
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %285 = and i64 %284, 9223372036854775776
  %286 = sub nsw i64 %283, %285
  %287 = mul nsw i64 %polly.indvar636, -16
  %288 = add i64 %287, %285
  %289 = lshr i64 %polly.indvar636, 1
  %290 = shl nuw nsw i64 %289, 5
...
polly.loop_exit699:                               ; preds = %polly.loop_exit706, %polly.loop_header697.preheader
  ...
  %indvars.iv.next1170 = add i64 %indvars.iv1169, -32
  %indvars.iv.next1175 = add i64 %indvars.iv1174, 32
  %exitcond1182.not = icmp eq i64 %polly.indvar_next660, 38
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %334 = mul nsw i64 %polly.indvar659, -32
  %335 = icmp slt i64 %334, -1168
  %336 = select i1 %335, i64 %334, i64 -1168
...
vector.body1329:                                  ; preds = %vector.body1329, %vector.ph1337
  ...
  %wide.load1350 = load <4 x double>, <4 x double>* %355, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %360, label %middle.block1327, label %vector.body1329, !llvm.loop !110
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1257
  ...
  br i1 %385, label %polly.loop_exit884, label %vector.body1256, !llvm.loop !117
...
vector.body1270:                                  ; preds = %vector.body1270, %vector.ph1273
  ...
  br i1 %414, label %polly.loop_exit911, label %vector.body1270, !llvm.loop !120
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1291
  ...
  br i1 %443, label %polly.loop_exit937, label %vector.body1288, !llvm.loop !123
