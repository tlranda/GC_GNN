; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7147.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7147.c"
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249934 = icmp sgt i64 %117, -1
...
vector.body1043:                                  ; preds = %vector.body1043, %vector.ph1047
  ...
  %130 = shl nuw nsw i64 %index1050, 3
  %131 = getelementptr i8, i8* %scevgep370, i64 %130
  %132 = bitcast i8* %131 to <4 x double>*
  %wide.load1054 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !74, !noalias !76
  %133 = fmul fast <4 x double> %wide.load1054, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %135 = icmp eq i64 %index.next1051, %n.vec1049
  br i1 %135, label %middle.block1041, label %vector.body1043, !llvm.loop !80

middle.block1041:                                 ; preds = %vector.body1043
  %cmp.n1053 = icmp eq i64 %128, %n.vec1049
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %137 = udiv i64 %indvars.iv869, 25
  %umin871 = call i64 @llvm.umin.i64(i64 %137, i64 11)
  %138 = mul nsw i64 %polly.indvar393, -32
  %139 = icmp slt i64 %138, -1168
  %140 = select i1 %139, i64 %138, i64 -1168
  %141 = add nsw i64 %140, 1199
  %142 = shl nsw i64 %polly.indvar393, 5
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %151 = mul nuw nsw i64 %polly.indvar406, 100
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  ...
  %polly.loop_guard427935 = icmp sgt i64 %157, -1
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1020 = icmp ult i64 %168, 4
...
vector.body1019:                                  ; preds = %vector.body1019, %vector.ph1021
  ...
  %170 = shl nuw nsw i64 %index1024, 3
  %171 = getelementptr i8, i8* %scevgep548, i64 %170
  %172 = bitcast i8* %171 to <4 x double>*
  %wide.load1028 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !84, !noalias !86
  %173 = fmul fast <4 x double> %wide.load1028, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %175 = icmp eq i64 %index.next1025, %n.vec1023
  br i1 %175, label %middle.block1017, label %vector.body1019, !llvm.loop !90

middle.block1017:                                 ; preds = %vector.body1019
  %cmp.n1027 = icmp eq i64 %168, %n.vec1023
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %177 = udiv i64 %indvars.iv893, 25
  %umin895 = call i64 @llvm.umin.i64(i64 %177, i64 11)
  %178 = mul nsw i64 %polly.indvar571, -32
  %179 = icmp slt i64 %178, -1168
  %180 = select i1 %179, i64 %178, i64 -1168
  %181 = add nsw i64 %180, 1199
  %182 = shl nsw i64 %polly.indvar571, 5
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %191 = mul nuw nsw i64 %polly.indvar584, 100
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  ...
  %195 = add i64 %smax883, %indvars.iv886
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv888 = phi i64 [ %195, %polly.loop_header588.preheader ], [ %indvars.iv.next889, %polly.loop_exit597 ]
  ...
  %polly.loop_guard605936 = icmp sgt i64 %197, -1
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin958 = call i64 @llvm.smin.i64(i64 %210, i64 -1168)
  %211 = add nsw i64 %smin958, 1200
  %smin925 = call i64 @llvm.smin.i64(i64 %indvars.iv923, i64 -1168)
  %212 = shl nsw i64 %polly.indvar761, 5
  %213 = add nsw i64 %smin925, 1199
...
vector.ph959:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert966 = insertelement <4 x i64> poison, i64 %212, i32 0
  %broadcast.splat967 = shufflevector <4 x i64> %broadcast.splatinsert966, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert968 = insertelement <4 x i32> poison, i32 %215, i32 0
...
vector.body957:                                   ; preds = %vector.body957, %vector.ph959
  ...
  %217 = add nuw nsw <4 x i64> %vec.ind964, %broadcast.splat967
  %218 = trunc <4 x i64> %217 to <4 x i32>
  %219 = mul <4 x i32> %broadcast.splat969, %218
  ...
  %229 = icmp eq i64 %index.next961, %211
  br i1 %229, label %polly.loop_exit772, label %vector.body957, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body957, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond930.not = icmp eq i64 %polly.indvar767, %209
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond926.not = icmp eq i64 %polly.indvar773, %213
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin973 = call i64 @llvm.smin.i64(i64 %239, i64 -968)
  %240 = add nsw i64 %smin973, 1000
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -968)
  %241 = shl nsw i64 %polly.indvar788, 5
  %242 = add nsw i64 %smin915, 999
...
vector.body972:                                   ; preds = %vector.body972, %vector.ph975
  ...
  %246 = add nuw nsw <4 x i64> %vec.ind982, %broadcast.splat985
  %247 = trunc <4 x i64> %246 to <4 x i32>
  %248 = mul <4 x i32> %broadcast.splat987, %247
  ...
  %258 = icmp eq i64 %index.next979, %240
  br i1 %258, label %polly.loop_exit799, label %vector.body972, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body972, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond920.not = icmp eq i64 %polly.indvar794, %238
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar800, %242
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin991 = call i64 @llvm.smin.i64(i64 %268, i64 -968)
  %269 = add nsw i64 %smin991, 1000
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 -968)
  %270 = shl nsw i64 %polly.indvar814, 5
  %271 = add nsw i64 %smin905, 999
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph993
  ...
  %275 = add nuw nsw <4 x i64> %vec.ind1000, %broadcast.splat1003
  %276 = trunc <4 x i64> %275 to <4 x i32>
  %277 = mul <4 x i32> %broadcast.splat1005, %276
  ...
  %287 = icmp eq i64 %index.next997, %269
  br i1 %287, label %polly.loop_exit825, label %vector.body990, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body990, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond910.not = icmp eq i64 %polly.indvar820, %267
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar826, %271
