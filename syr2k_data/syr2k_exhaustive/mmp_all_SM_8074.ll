; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8074.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8074.c"
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph955
  ...
  %wide.load962 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !71, !noalias !73
  ...
  store <4 x double> %125, <4 x double>* %126, align 8, !alias.scope !71, !noalias !73
  %index.next959 = add i64 %index958, 4
  %127 = icmp eq i64 %index.next959, %n.vec957
  br i1 %127, label %middle.block949, label %vector.body951, !llvm.loop !76
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %129 = mul nuw nsw i64 %polly.indvar355, 100
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph929
  ...
  %wide.load936 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !80, !noalias !82
  ...
  store <4 x double> %157, <4 x double>* %158, align 8, !alias.scope !80, !noalias !82
  %index.next933 = add i64 %index932, 4
  %159 = icmp eq i64 %index.next933, %n.vec931
  br i1 %159, label %middle.block925, label %vector.body927, !llvm.loop !85
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit513
  ...
  %161 = mul nuw nsw i64 %polly.indvar508, 100
...
vector.body865:                                   ; preds = %vector.body865, %vector.ph867
  ...
  store <4 x double> %199, <4 x double>* %204, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %205, label %polly.loop_exit702, label %vector.body865, !llvm.loop !94
...
vector.body880:                                   ; preds = %vector.body880, %vector.ph883
  ...
  store <4 x double> %228, <4 x double>* %233, align 8, !alias.scope !93, !noalias !96
  ...
  br i1 %234, label %polly.loop_exit729, label %vector.body880, !llvm.loop !97
...
vector.body898:                                   ; preds = %vector.body898, %vector.ph901
  ...
  store <4 x double> %257, <4 x double>* %262, align 8, !alias.scope !92, !noalias !99
  ...
  br i1 %263, label %polly.loop_exit755, label %vector.body898, !llvm.loop !100
