; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6574.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6574.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %98 = shl nuw nsw i64 %indvars.iv862, 4
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %polly.loop_guard = icmp slt i64 %106, 10
...
polly.loop_header227:                             ; preds = %polly.loop_exit213, %polly.loop_exit235
  ...
  %114 = mul nsw i64 %polly.indvar230, -128
...
polly.loop_exit390:                               ; preds = %polly.loop_exit396
  ...
  %polly.loop_guard409 = icmp slt i64 %148, 10
...
polly.loop_header406:                             ; preds = %polly.loop_exit390, %polly.loop_exit415
  ...
  %152 = shl nsw i64 %polly.indvar410, 7
  %153 = sub nsw i64 %144, %152
  %154 = icmp sgt i64 %153, 0
  %155 = select i1 %154, i64 %153, i64 0
  %156 = mul nsw i64 %polly.indvar410, -128
...
polly.loop_header562:                             ; preds = %polly.loop_exit588, %polly.loop_header556
  ...
  %182 = shl nuw nsw i64 %indvars.iv908, 4
  %183 = and i64 %182, 9223372036854775680
  %184 = add i64 %indvars.iv906, %183
  %185 = sub nsw i64 %indvars.iv913, %183
  %186 = mul nuw nsw i64 %polly.indvar565, 80
  br label %polly.loop_header568

polly.loop_exit570:                               ; preds = %polly.loop_exit576
  %187 = mul nsw i64 %polly.indvar565, -80
  ...
  %polly.loop_guard589 = icmp slt i64 %190, 10
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  br i1 %235, label %polly.loop_exit778, label %vector.body980, !llvm.loop !104
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %264, label %polly.loop_exit805, label %vector.body995, !llvm.loop !107
...
vector.body1013:                                  ; preds = %vector.body1013, %vector.ph1016
  ...
  br i1 %293, label %polly.loop_exit831, label %vector.body1013, !llvm.loop !110
