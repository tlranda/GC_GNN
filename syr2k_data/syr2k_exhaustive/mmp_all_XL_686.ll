; ModuleID = 'syr2k_exhaustive/mmp_all_XL_686.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_686.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1205 = call i64 @llvm.smin.i64(i64 %indvars.iv1174, i64 -920)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1175 = add nsw i64 %indvars.iv1174, -80
  %exitcond1208.not = icmp eq i64 %polly.indvar_next204, 13
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit435
  ...
  %smin1247 = call i64 @llvm.smin.i64(i64 %indvars.iv1214, i64 -920)
  %266 = add nsw i64 %smin1247, 1000
  %267 = mul nuw nsw i64 %polly.indvar430, 80
...
polly.loop_exit435:                               ; preds = %polly.loop_exit459
  ...
  %indvars.iv.next1215 = add nsw i64 %indvars.iv1214, -80
  %exitcond1250.not = icmp eq i64 %polly.indvar_next431, 13
...
polly.start557:                                   ; preds = %init_array.exit
  %malloccall559 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
  %malloccall561 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header661:                             ; preds = %polly.loop_header661.preheader, %polly.loop_exit669
  ...
  %smin1289 = call i64 @llvm.smin.i64(i64 %indvars.iv1256, i64 -920)
  %435 = add nsw i64 %smin1289, 1000
  %436 = mul nuw nsw i64 %polly.indvar664, 80
...
polly.loop_exit669:                               ; preds = %polly.loop_exit693
  ...
  %indvars.iv.next1257 = add nsw i64 %indvars.iv1256, -80
  %exitcond1292.not = icmp eq i64 %polly.indvar_next665, 13
