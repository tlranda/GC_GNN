; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7155.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7155.c"
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %123 = mul nsw i64 %polly.indvar230, 50
...
polly.loop_exit236:                               ; preds = %polly.loop_exit243, %polly.loop_header227
  ...
  %indvars.iv.next846 = add i64 %indvars.iv845, 50
  %indvars.iv.next850 = add i64 %indvars.iv849, -50
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 49)
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %.inv838 = icmp slt i64 %151, 23
  %153 = select i1 %.inv838, i64 %152, i64 23
  %polly.loop_guard409 = icmp sgt i64 %153, -1
  %154 = mul nsw i64 %polly.indvar395, -32
  %155 = icmp slt i64 %154, -1168
  %156 = select i1 %155, i64 %154, i64 -1168
  %157 = add nsw i64 %156, 1199
  %158 = shl nsw i64 %polly.indvar395, 5
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %175 = mul nsw i64 %polly.indvar410, 50
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %indvars.iv.next864 = add i64 %indvars.iv863, 50
  %indvars.iv.next869 = add i64 %indvars.iv868, -50
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %.inv839 = icmp slt i64 %203, 23
  %205 = select i1 %.inv839, i64 %204, i64 23
  %polly.loop_guard589 = icmp sgt i64 %205, -1
  %206 = mul nsw i64 %polly.indvar575, -32
  %207 = icmp slt i64 %206, -1168
  %208 = select i1 %207, i64 %206, i64 -1168
  %209 = add nsw i64 %208, 1199
  %210 = shl nsw i64 %polly.indvar575, 5
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %227 = mul nsw i64 %polly.indvar590, 50
