; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4772.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4772.c"
...
polly.loop_header387:                             ; preds = %polly.loop_exit396, %polly.loop_header381
  ...
  %133 = shl nsw i64 %polly.indvar390, 5
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next391, 32
...
polly.loop_header576:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %smin1043 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 -968)
  %164 = add nsw i64 %smin1043, 1000
  %165 = shl nsw i64 %polly.indvar579, 5
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar_next580, 32
