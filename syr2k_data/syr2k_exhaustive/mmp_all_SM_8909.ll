; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8909.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8909.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin784 = call i64 @llvm.smin.i64(i64 %indvars.iv782, i64 -936)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond788.not = icmp eq i64 %polly.indvar_next203, 16
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %99 = mul nuw nsw i64 %polly.indvar208, 3
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225
  ...
  %exitcond786.not = icmp eq i64 %polly.indvar_next215, 15
...
polly.loop_exit360:                               ; preds = %polly.loop_exit366
  ...
  %exitcond810.not = icmp eq i64 %polly.indvar_next356, 16
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %130 = mul nuw nsw i64 %polly.indvar361, 3
...
polly.loop_exit366:                               ; preds = %polly.loop_exit372
  ...
  %indvars.iv.next792 = add nuw nsw i64 %indvars.iv791, 16
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %134 = mul nuw nsw i64 %polly.indvar367, 80
...
polly.loop_exit372:                               ; preds = %polly.loop_exit378
  ...
  %exitcond808.not = icmp eq i64 %polly.indvar_next368, 15
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %smin828 = call i64 @llvm.smin.i64(i64 %indvars.iv826, i64 -936)
...
polly.loop_exit515:                               ; preds = %polly.loop_exit521
  ...
  %exitcond832.not = icmp eq i64 %polly.indvar_next511, 16
...
polly.loop_header513:                             ; preds = %polly.loop_exit521, %polly.loop_header507
  ...
  %161 = mul nuw nsw i64 %polly.indvar516, 3
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar_next523, 15
