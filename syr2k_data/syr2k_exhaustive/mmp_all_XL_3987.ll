; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3987.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3987.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %97 = shl nuw nsw i64 %indvars.iv995, 1
  ...
  %103 = mul nuw nsw i64 %polly.indvar202, 50
...
polly.loop_exit207:                               ; preds = %polly.loop_exit244
  ...
  %exitcond1008.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_header205:                             ; preds = %polly.loop_exit244, %polly.loop_header199
  ...
  %.inv = icmp sgt i64 %107, 49
  %109 = select i1 %.inv, i64 49, i64 %108
...
polly.loop_header387:                             ; preds = %polly.loop_header387.preheader, %polly.loop_exit396
  ...
  %143 = shl nuw nsw i64 %indvars.iv1016, 1
  %144 = and i64 %143, 9223372036854775680
  %145 = sub nsw i64 %indvars.iv1014, %144
  %146 = add i64 %indvars.iv1021, %144
  %147 = mul nuw nsw i64 %polly.indvar390, 25
  %pexp.p_div_q393 = lshr i64 %147, 6
  %148 = mul nsw i64 %polly.indvar390, -50
  %149 = mul nuw nsw i64 %polly.indvar390, 50
...
polly.loop_exit396:                               ; preds = %polly.loop_exit435
  ...
  %indvars.iv.next1017 = add nuw nsw i64 %indvars.iv1016, 25
  %indvars.iv.next1022 = add nsw i64 %indvars.iv1021, -50
  %exitcond1031.not = icmp eq i64 %polly.indvar_next391, 24
...
polly.loop_header394:                             ; preds = %polly.loop_exit435, %polly.loop_header387
  ...
  %.inv871 = icmp sgt i64 %153, 49
  %155 = select i1 %.inv871, i64 49, i64 %154
...
polly.loop_header440:                             ; preds = %polly.loop_exit450, %polly.loop_header433
  ...
  %smin1027 = call i64 @llvm.smin.i64(i64 %indvars.iv1025, i64 49)
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  ...
  %189 = shl nuw nsw i64 %indvars.iv1039, 1
  %190 = and i64 %189, 9223372036854775680
  %191 = sub nsw i64 %indvars.iv1037, %190
  %192 = add i64 %indvars.iv1044, %190
  %193 = mul nuw nsw i64 %polly.indvar581, 25
  %pexp.p_div_q584 = lshr i64 %193, 6
  %194 = mul nsw i64 %polly.indvar581, -50
  %195 = mul nuw nsw i64 %polly.indvar581, 50
...
polly.loop_exit587:                               ; preds = %polly.loop_exit626
  ...
  %indvars.iv.next1038 = add nuw nsw i64 %indvars.iv1037, 50
  %indvars.iv.next1040 = add nuw nsw i64 %indvars.iv1039, 25
  %indvars.iv.next1045 = add nsw i64 %indvars.iv1044, -50
  %exitcond1054.not = icmp eq i64 %polly.indvar_next582, 24
...
polly.loop_header585:                             ; preds = %polly.loop_exit626, %polly.loop_header578
  ...
  %.inv872 = icmp sgt i64 %199, 49
  %201 = select i1 %.inv872, i64 49, i64 %200
...
polly.loop_header631:                             ; preds = %polly.loop_exit641, %polly.loop_header624
  ...
  %smin1050 = call i64 @llvm.smin.i64(i64 %indvars.iv1048, i64 49)
