; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1691.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1691.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1032 = add nuw nsw i64 %indvars.iv1031, 4
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %104 = mul nsw i64 %polly.indvar225, -100
  %105 = add i64 %98, %104
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %114, i64 99)
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %155 = mul nuw nsw i64 %polly.indvar424, 100
  %156 = add i64 %150, %155
  %smax1276 = call i64 @llvm.smax.i64(i64 %156, i64 0)
  %157 = mul nsw i64 %polly.indvar424, -100
  %158 = add i64 %151, %157
  %159 = add i64 %smax1276, %158
  %160 = mul nuw nsw i64 %polly.indvar424, 100
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %167, i64 99)
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 4
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %208 = mul nuw nsw i64 %polly.indvar629, 100
  %209 = add i64 %203, %208
  %smax1228 = call i64 @llvm.smax.i64(i64 %209, i64 0)
  %210 = mul nsw i64 %polly.indvar629, -100
  %211 = add i64 %204, %210
  %212 = add i64 %smax1228, %211
  %213 = mul nuw nsw i64 %polly.indvar629, 100
...
polly.loop_exit635:                               ; preds = %polly.loop_exit671, %polly.loop_header626
  ...
  %indvars.iv.next1074 = add nsw i64 %indvars.iv1073, -100
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %220, i64 99)
  %221 = add nsw i64 %smin1231, 1
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 99)
