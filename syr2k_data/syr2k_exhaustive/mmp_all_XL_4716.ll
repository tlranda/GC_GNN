; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4716.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4716.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond976.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_header211:                             ; preds = %polly.loop_exit242, %polly.loop_header205
  ...
  %smin971 = call i64 @llvm.smin.i64(i64 %indvars.iv967, i64 99)
...
polly.loop_exit242:                               ; preds = %polly.loop_exit249.loopexit.us, %polly.loop_header211.split, %polly.loop_header240.preheader
  ...
  %exitcond974.not = icmp eq i64 %polly.indvar_next215, 50
...
polly.loop_header377:                             ; preds = %polly.loop_header377.preheader, %polly.loop_exit386
  ...
  %121 = lshr i64 %polly.indvar380, 1
  %122 = mul nuw nsw i64 %polly.indvar380, 50
...
polly.loop_exit386:                               ; preds = %polly.loop_exit392
  ...
  %indvars.iv.next981 = add nuw nsw i64 %indvars.iv980, 50
  %exitcond994.not = icmp eq i64 %polly.indvar_next381, 24
...
polly.loop_exit427:                               ; preds = %polly.loop_exit434.loopexit.us, %polly.loop_header390.split, %polly.loop_header425.preheader
  ...
  %exitcond992.not = icmp eq i64 %polly.indvar_next394, 50
...
polly.loop_header562:                             ; preds = %polly.loop_header562.preheader, %polly.loop_exit571
  ...
  %145 = lshr i64 %polly.indvar565, 1
  %146 = mul nuw nsw i64 %polly.indvar565, 50
...
polly.loop_exit571:                               ; preds = %polly.loop_exit577
  ...
  %indvars.iv.next999 = add nuw nsw i64 %indvars.iv998, 50
  %exitcond1012.not = icmp eq i64 %polly.indvar_next566, 24
...
polly.loop_header575:                             ; preds = %polly.loop_exit612, %polly.loop_header569
  ...
  %smin1007 = call i64 @llvm.smin.i64(i64 %indvars.iv1002, i64 99)
...
polly.loop_exit612:                               ; preds = %polly.loop_exit619.loopexit.us, %polly.loop_header575.split, %polly.loop_header610.preheader
  ...
  %exitcond1010.not = icmp eq i64 %polly.indvar_next579, 50
