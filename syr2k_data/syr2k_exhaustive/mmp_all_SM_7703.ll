; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7703.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7703.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv851 = phi i64 [ %indvars.iv.next852, %polly.loop_exit223 ], [ 6, %polly.loop_exit207 ]
  ...
  %97 = udiv i64 %indvars.iv851, 5
  %98 = sub nsw i64 %indvars.iv849, %97
  %smin853 = call i64 @llvm.smin.i64(i64 %98, i64 54)
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next850 = add nuw nsw i64 %indvars.iv849, 5
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv880 = phi i64 [ %indvars.iv.next881, %polly.loop_exit398 ], [ 6, %polly.loop_exit382 ]
  ...
  %134 = udiv i64 %indvars.iv880, 5
  %135 = sub nsw i64 %indvars.iv878, %134
  %smin882 = call i64 @llvm.smin.i64(i64 %135, i64 54)
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %144 = mul nuw nsw i64 %polly.indvar406, 20
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv909 = phi i64 [ %indvars.iv.next910, %polly.loop_exit576 ], [ 6, %polly.loop_exit560 ]
  ...
  %171 = udiv i64 %indvars.iv909, 5
  %172 = sub nsw i64 %indvars.iv907, %171
  %smin911 = call i64 @llvm.smin.i64(i64 %172, i64 54)
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next908 = add nuw nsw i64 %indvars.iv907, 5
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %181 = mul nuw nsw i64 %polly.indvar584, 20
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  ...
  %smin901 = call i64 @llvm.smin.i64(i64 %indvars.iv899, i64 19)
