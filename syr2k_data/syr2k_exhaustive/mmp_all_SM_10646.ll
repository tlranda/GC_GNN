; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10646.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10646.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin778 = call i64 @llvm.smin.i64(i64 %indvars.iv776, i64 -1072)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next777 = add nsw i64 %indvars.iv776, -128
  %indvars.iv.next781 = add nuw nsw i64 %indvars.iv780, 1
  %exitcond783.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %indvars.iv.next772 = add nsw i64 %indvars.iv771, -128
...
polly.loop_header350:                             ; preds = %polly.loop_exit342, %polly.loop_exit358
  ...
  %smin797 = call i64 @llvm.smin.i64(i64 %indvars.iv795, i64 -1072)
  %119 = shl nsw i64 %polly.indvar353, 7
...
polly.loop_exit358:                               ; preds = %polly.loop_exit364
  ...
  %indvars.iv.next787 = add nuw nsw i64 %indvars.iv786, 128
  %indvars.iv.next796 = add nsw i64 %indvars.iv795, -128
  %indvars.iv.next800 = add nuw nsw i64 %indvars.iv799, 1
  %exitcond802.not = icmp eq i64 %polly.indvar_next354, 10
...
polly.loop_header356:                             ; preds = %polly.loop_exit364, %polly.loop_header350
  ...
  %121 = shl nsw i64 %polly.indvar359, 7
...
polly.loop_header503:                             ; preds = %polly.loop_exit495, %polly.loop_exit511
  ...
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 -1072)
  %141 = shl nsw i64 %polly.indvar506, 7
...
polly.loop_exit511:                               ; preds = %polly.loop_exit517
  ...
  %exitcond821.not = icmp eq i64 %polly.indvar_next507, 10
...
polly.loop_header509:                             ; preds = %polly.loop_exit517, %polly.loop_header503
  ...
  %143 = shl nsw i64 %polly.indvar512, 7
