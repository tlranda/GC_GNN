; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2638.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2638.c"
...
vector.body1159:                                  ; preds = %vector.body1159, %vector.ph1160
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call864, i64 %indvars.iv7.i, i64 %index1161
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1222, label %for.body3.i46.preheader1356, label %vector.ph1223
...
vector.body1221:                                  ; preds = %vector.body1221, %vector.ph1223
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call864, i64 %indvars.iv21.i, i64 %index1226
...
middle.block1219:                                 ; preds = %vector.body1221
  ...
  br i1 %cmp.n1229, label %for.inc6.i, label %for.body3.i46.preheader1356

for.body3.i46.preheader1356:                      ; preds = %for.body3.i46.preheader, %middle.block1219
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1264 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1264, label %for.body3.i60.preheader1354, label %vector.ph1265

vector.ph1265:                                    ; preds = %for.body3.i60.preheader
  %n.vec1267 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1263:                                  ; preds = %vector.body1263, %vector.ph1265
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call864, i64 %indvars.iv21.i52, i64 %index1268
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1272 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1272, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1269 = add i64 %index1268, 4
  %57 = icmp eq i64 %index.next1269, %n.vec1267
  br i1 %57, label %middle.block1261, label %vector.body1263, !llvm.loop !56

middle.block1261:                                 ; preds = %vector.body1263
  %cmp.n1271 = icmp eq i64 %indvars.iv21.i52, %n.vec1267
  br i1 %cmp.n1271, label %for.inc6.i63, label %for.body3.i60.preheader1354

for.body3.i60.preheader1354:                      ; preds = %for.body3.i60.preheader, %middle.block1261
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1267, %middle.block1261 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1261, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  ...
  br i1 %min.iters.check1309, label %for.body3.i99.preheader1352, label %vector.ph1310
...
vector.body1308:                                  ; preds = %vector.body1308, %vector.ph1310
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call864, i64 %indvars.iv21.i91, i64 %index1313
  ...
  br i1 %68, label %middle.block1306, label %vector.body1308, !llvm.loop !58

middle.block1306:                                 ; preds = %vector.body1308
  %cmp.n1316 = icmp eq i64 %indvars.iv21.i91, %n.vec1312
  br i1 %cmp.n1316, label %for.inc6.i102, label %for.body3.i99.preheader1352

for.body3.i99.preheader1352:                      ; preds = %for.body3.i99.preheader, %middle.block1306
...
vector.body1320:                                  ; preds = %vector.body1320, %vector.ph1324
  ...
  %wide.load1331 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !64, !noalias !66
  ...
  br i1 %95, label %middle.block1318, label %vector.body1320, !llvm.loop !71
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %smin1045 = call i64 @llvm.smin.i64(i64 %indvars.iv1043, i64 -1072)
  %98 = shl nsw i64 %polly.indvar219, 7
  %99 = add nsw i64 %smin1045, 1199
  br label %polly.loop_header222

polly.loop_exit224:                               ; preds = %polly.loop_exit230
  %polly.indvar_next220 = add nuw nsw i64 %polly.indvar219, 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 128
  %indvars.iv.next1044 = add nsw i64 %indvars.iv1043, -128
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %100 = mul nuw nsw i64 %polly.indvar225, 100
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %101 = mul nsw i64 %polly.indvar231, -128
  %102 = add i64 %97, %101
  %103 = shl nsw i64 %polly.indvar231, 7
  %104 = sub nsw i64 %98, %103
  %105 = add nuw nsw i64 %103, 128
...
polly.loop_header234:                             ; preds = %polly.loop_exit265, %polly.loop_header228
  ...
  %smin1335 = call i64 @llvm.smin.i64(i64 %106, i64 127)
  %107 = add nsw i64 %smin1335, 1
  %smin1040 = call i64 @llvm.smin.i64(i64 %indvars.iv1036, i64 127)
  %108 = add nsw i64 %polly.indvar237, %104
  %polly.loop_guard1142 = icmp sgt i64 %108, -1
...
polly.merge.us:                                   ; preds = %polly.then.us, %polly.cond.loopexit.us
  ...
  %exitcond1039.not = icmp eq i64 %polly.indvar_next244.us, 100
...
polly.loop_exit265:                               ; preds = %polly.loop_exit272.loopexit.us, %polly.loop_header234.split, %polly.loop_header263.preheader
  ...
  %exitcond1046.not = icmp eq i64 %polly.indvar237, %99
...
polly.loop_header263.us:                          ; preds = %polly.loop_header263.preheader, %polly.loop_exit272.loopexit.us
  ...
  %min.iters.check1336 = icmp ult i64 %107, 4
  br i1 %min.iters.check1336, label %polly.loop_header270.us.preheader, label %vector.ph1337

vector.ph1337:                                    ; preds = %polly.loop_header263.us
  %n.vec1339 = and i64 %107, -4
  %broadcast.splatinsert1345 = insertelement <4 x double> poison, double %_p_scalar_284.us, i32 0
  %broadcast.splat1346 = shufflevector <4 x double> %broadcast.splatinsert1345, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1348 = insertelement <4 x double> poison, double %_p_scalar_292.us, i32 0
...
vector.body1334:                                  ; preds = %vector.body1334, %vector.ph1337
  ...
  %115 = add nuw nsw i64 %index1340, %103
  %116 = add nuw nsw i64 %index1340, %polly.access.mul.Packed_MemRef_call1277.us
  %117 = getelementptr double, double* %Packed_MemRef_call1, i64 %116
  %118 = bitcast double* %117 to <4 x double>*
  %wide.load1344 = load <4 x double>, <4 x double>* %118, align 8
  %119 = fmul fast <4 x double> %broadcast.splat1346, %wide.load1344
  ...
  %wide.load1347 = load <4 x double>, <4 x double>* %122, align 8
  %123 = fmul fast <4 x double> %broadcast.splat1349, %wide.load1347
  %124 = shl i64 %115, 3
  %125 = add nuw nsw i64 %124, %113
  %126 = getelementptr i8, i8* %call, i64 %125
  %127 = bitcast i8* %126 to <4 x double>*
  %wide.load1350 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !64, !noalias !66
  ...
  %130 = fadd fast <4 x double> %129, %wide.load1350
  ...
  %132 = icmp eq i64 %index.next1341, %n.vec1339
  br i1 %132, label %middle.block1332, label %vector.body1334, !llvm.loop !76

middle.block1332:                                 ; preds = %vector.body1334
  %cmp.n1343 = icmp eq i64 %107, %n.vec1339
  br i1 %cmp.n1343, label %polly.loop_exit272.loopexit.us, label %polly.loop_header270.us.preheader

polly.loop_header270.us.preheader:                ; preds = %polly.loop_header263.us, %middle.block1332
  %polly.indvar274.us.ph = phi i64 [ 0, %polly.loop_header263.us ], [ %n.vec1339, %middle.block1332 ]
...
polly.loop_exit272.loopexit.us:                   ; preds = %polly.loop_header270.us, %middle.block1332
  %polly.indvar_next267.us = add nuw nsw i64 %polly.indvar266.us, 1
  %exitcond1042.not = icmp eq i64 %polly.indvar_next267.us, 100
...
polly.loop_header386:                             ; preds = %polly.loop_exit394, %polly.start298
  %indvar1276 = phi i64 [ %indvar.next1277, %polly.loop_exit394 ], [ 0, %polly.start298 ]
  %polly.indvar389 = phi i64 [ %polly.indvar_next390, %polly.loop_exit394 ], [ 1, %polly.start298 ]
  %136 = add i64 %indvar1276, 1
  %137 = mul nuw nsw i64 %polly.indvar389, 9600
  %scevgep398 = getelementptr i8, i8* %call, i64 %137
  %min.iters.check1278 = icmp ult i64 %136, 4
  br i1 %min.iters.check1278, label %polly.loop_header392.preheader, label %vector.ph1279

vector.ph1279:                                    ; preds = %polly.loop_header386
  %n.vec1281 = and i64 %136, -4
...
vector.body1275:                                  ; preds = %vector.body1275, %vector.ph1279
  ...
  %138 = shl nuw nsw i64 %index1282, 3
  %139 = getelementptr i8, i8* %scevgep398, i64 %138
  %140 = bitcast i8* %139 to <4 x double>*
  %wide.load1286 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !78, !noalias !80
  %141 = fmul fast <4 x double> %wide.load1286, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %143 = icmp eq i64 %index.next1283, %n.vec1281
  br i1 %143, label %middle.block1273, label %vector.body1275, !llvm.loop !85

middle.block1273:                                 ; preds = %vector.body1275
  %cmp.n1285 = icmp eq i64 %136, %n.vec1281
  br i1 %cmp.n1285, label %polly.loop_exit394, label %polly.loop_header392.preheader

polly.loop_header392.preheader:                   ; preds = %polly.loop_header386, %middle.block1273
  %polly.indvar395.ph = phi i64 [ 0, %polly.loop_header386 ], [ %n.vec1281, %middle.block1273 ]
  br label %polly.loop_header392

polly.loop_exit394:                               ; preds = %polly.loop_header392, %middle.block1273
...
polly.loop_header392:                             ; preds = %polly.loop_header392.preheader, %polly.loop_header392
  ...
  br i1 %exitcond1080.not, label %polly.loop_exit394, label %polly.loop_header392, !llvm.loop !86
...
polly.loop_header418:                             ; preds = %polly.loop_exit410, %polly.loop_exit426
  ...
  %145 = shl nuw nsw i64 %polly.indvar421, 7
  %smin1071 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 -1072)
  %146 = shl nsw i64 %polly.indvar421, 7
  %147 = add nsw i64 %smin1071, 1199
...
polly.loop_exit426:                               ; preds = %polly.loop_exit432
  ...
  %exitcond1077.not = icmp eq i64 %polly.indvar_next422, 10
...
polly.loop_header424:                             ; preds = %polly.loop_exit432, %polly.loop_header418
  ...
  %148 = mul nuw nsw i64 %polly.indvar427, 100
  br label %polly.loop_header430

polly.loop_exit432:                               ; preds = %polly.loop_exit438
  %polly.indvar_next428 = add nuw nsw i64 %polly.indvar427, 1
  %exitcond1076.not = icmp eq i64 %polly.indvar_next428, 10
...
polly.loop_header430:                             ; preds = %polly.loop_exit438, %polly.loop_header424
  ...
  %149 = mul nsw i64 %polly.indvar433, -128
  %150 = add i64 %145, %149
  %151 = shl nsw i64 %polly.indvar433, 7
  %152 = sub nsw i64 %146, %151
  %153 = add nuw nsw i64 %151, 128
...
polly.loop_header436:                             ; preds = %polly.loop_exit473, %polly.loop_header430
  ...
  %smin1290 = call i64 @llvm.smin.i64(i64 %154, i64 127)
  %155 = add nsw i64 %smin1290, 1
  %smin1066 = call i64 @llvm.smin.i64(i64 %indvars.iv1061, i64 127)
  %156 = add nsw i64 %polly.indvar439, %152
  %polly.loop_guard4521143 = icmp sgt i64 %156, -1
...
polly.merge461.us:                                ; preds = %polly.then462.us, %polly.cond460.loopexit.us
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next446.us, 100
...
polly.loop_exit473:                               ; preds = %polly.loop_exit480.loopexit.us, %polly.loop_header436.split, %polly.loop_header471.preheader
  ...
  %exitcond1072.not = icmp eq i64 %polly.indvar439, %147
...
polly.loop_header442:                             ; preds = %polly.loop_header436.split, %polly.loop_header442
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next446, 100
  br i1 %exitcond1056.not, label %polly.loop_header471.preheader, label %polly.loop_header442
...
polly.loop_header471.us:                          ; preds = %polly.loop_header471.preheader, %polly.loop_exit480.loopexit.us
  ...
  %min.iters.check1291 = icmp ult i64 %155, 4
  br i1 %min.iters.check1291, label %polly.loop_header478.us.preheader, label %vector.ph1292

vector.ph1292:                                    ; preds = %polly.loop_header471.us
  %n.vec1294 = and i64 %155, -4
  %broadcast.splatinsert1300 = insertelement <4 x double> poison, double %_p_scalar_492.us, i32 0
  %broadcast.splat1301 = shufflevector <4 x double> %broadcast.splatinsert1300, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1303 = insertelement <4 x double> poison, double %_p_scalar_500.us, i32 0
...
vector.body1289:                                  ; preds = %vector.body1289, %vector.ph1292
  ...
  %163 = add nuw nsw i64 %index1295, %151
  %164 = add nuw nsw i64 %index1295, %polly.access.mul.Packed_MemRef_call1301485.us
  %165 = getelementptr double, double* %Packed_MemRef_call1301, i64 %164
  %166 = bitcast double* %165 to <4 x double>*
  %wide.load1299 = load <4 x double>, <4 x double>* %166, align 8
  %167 = fmul fast <4 x double> %broadcast.splat1301, %wide.load1299
  ...
  %wide.load1302 = load <4 x double>, <4 x double>* %170, align 8
  %171 = fmul fast <4 x double> %broadcast.splat1304, %wide.load1302
  %172 = shl i64 %163, 3
  %173 = add nuw nsw i64 %172, %161
  %174 = getelementptr i8, i8* %call, i64 %173
  %175 = bitcast i8* %174 to <4 x double>*
  %wide.load1305 = load <4 x double>, <4 x double>* %175, align 8, !alias.scope !78, !noalias !80
  ...
  %178 = fadd fast <4 x double> %177, %wide.load1305
  ...
  %180 = icmp eq i64 %index.next1296, %n.vec1294
  br i1 %180, label %middle.block1287, label %vector.body1289, !llvm.loop !89

middle.block1287:                                 ; preds = %vector.body1289
  %cmp.n1298 = icmp eq i64 %155, %n.vec1294
  br i1 %cmp.n1298, label %polly.loop_exit480.loopexit.us, label %polly.loop_header478.us.preheader

polly.loop_header478.us.preheader:                ; preds = %polly.loop_header471.us, %middle.block1287
  %polly.indvar482.us.ph = phi i64 [ 0, %polly.loop_header471.us ], [ %n.vec1294, %middle.block1287 ]
...
polly.loop_header478.us:                          ; preds = %polly.loop_header478.us.preheader, %polly.loop_header478.us
  ...
  br i1 %exitcond1067.not, label %polly.loop_exit480.loopexit.us, label %polly.loop_header478.us, !llvm.loop !90

polly.loop_exit480.loopexit.us:                   ; preds = %polly.loop_header478.us, %middle.block1287
  %polly.indvar_next475.us = add nuw nsw i64 %polly.indvar474.us, 1
  %exitcond1068.not = icmp eq i64 %polly.indvar_next475.us, 100
  br i1 %exitcond1068.not, label %polly.loop_exit473, label %polly.loop_header471.us

polly.start506:                                   ; preds = %init_array.exit
  %malloccall508 = tail call dereferenceable_or_null(960000) i8* @malloc(i64 960000) #6
...
polly.loop_header594:                             ; preds = %polly.loop_exit602, %polly.start506
  ...
  %min.iters.check1233 = icmp ult i64 %184, 4
  br i1 %min.iters.check1233, label %polly.loop_header600.preheader, label %vector.ph1234

vector.ph1234:                                    ; preds = %polly.loop_header594
  %n.vec1236 = and i64 %184, -4
...
vector.body1232:                                  ; preds = %vector.body1232, %vector.ph1234
  ...
  %186 = shl nuw nsw i64 %index1237, 3
  %187 = getelementptr i8, i8* %scevgep606, i64 %186
  %188 = bitcast i8* %187 to <4 x double>*
  %wide.load1241 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !91, !noalias !93
  %189 = fmul fast <4 x double> %wide.load1241, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %191 = icmp eq i64 %index.next1238, %n.vec1236
  br i1 %191, label %middle.block1230, label %vector.body1232, !llvm.loop !98

middle.block1230:                                 ; preds = %vector.body1232
  %cmp.n1240 = icmp eq i64 %184, %n.vec1236
  br i1 %cmp.n1240, label %polly.loop_exit602, label %polly.loop_header600.preheader

polly.loop_header600.preheader:                   ; preds = %polly.loop_header594, %middle.block1230
  %polly.indvar603.ph = phi i64 [ 0, %polly.loop_header594 ], [ %n.vec1236, %middle.block1230 ]
  br label %polly.loop_header600

polly.loop_exit602:                               ; preds = %polly.loop_header600, %middle.block1230
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_header600
  ...
  br i1 %exitcond1106.not, label %polly.loop_exit602, label %polly.loop_header600, !llvm.loop !99
...
polly.loop_header626:                             ; preds = %polly.loop_exit618, %polly.loop_exit634
  ...
  %193 = shl nuw nsw i64 %polly.indvar629, 7
  %smin1097 = call i64 @llvm.smin.i64(i64 %indvars.iv1095, i64 -1072)
  %194 = shl nsw i64 %polly.indvar629, 7
  %195 = add nsw i64 %smin1097, 1199
...
polly.loop_exit634:                               ; preds = %polly.loop_exit640
  ...
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 128
  %indvars.iv.next1096 = add nsw i64 %indvars.iv1095, -128
  %indvars.iv.next1100 = add nuw nsw i64 %indvars.iv1099, 1
  %exitcond1103.not = icmp eq i64 %polly.indvar_next630, 10
...
polly.loop_header632:                             ; preds = %polly.loop_exit640, %polly.loop_header626
  ...
  %196 = mul nuw nsw i64 %polly.indvar635, 100
...
polly.loop_exit640:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1102.not = icmp eq i64 %polly.indvar_next636, 10
...
polly.loop_header638:                             ; preds = %polly.loop_exit646, %polly.loop_header632
  ...
  %197 = mul nsw i64 %polly.indvar641, -128
  %198 = add i64 %193, %197
  %199 = shl nsw i64 %polly.indvar641, 7
  %200 = sub nsw i64 %194, %199
  %201 = add nuw nsw i64 %199, 128
...
polly.loop_header644:                             ; preds = %polly.loop_exit681, %polly.loop_header638
  ...
  %smin1245 = call i64 @llvm.smin.i64(i64 %202, i64 127)
  %203 = add nsw i64 %smin1245, 1
  %smin1092 = call i64 @llvm.smin.i64(i64 %indvars.iv1087, i64 127)
  %204 = add nsw i64 %polly.indvar647, %200
  %polly.loop_guard6601144 = icmp sgt i64 %204, -1
...
polly.merge669.us:                                ; preds = %polly.then670.us, %polly.cond668.loopexit.us
  ...
  %exitcond1091.not = icmp eq i64 %polly.indvar_next654.us, 100
...
polly.loop_exit681:                               ; preds = %polly.loop_exit688.loopexit.us, %polly.loop_header644.split, %polly.loop_header679.preheader
  ...
  %exitcond1098.not = icmp eq i64 %polly.indvar647, %195
...
polly.loop_header650:                             ; preds = %polly.loop_header644.split, %polly.loop_header650
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar_next654, 100
  br i1 %exitcond1082.not, label %polly.loop_header679.preheader, label %polly.loop_header650
...
polly.loop_header679.us:                          ; preds = %polly.loop_header679.preheader, %polly.loop_exit688.loopexit.us
  ...
  %min.iters.check1246 = icmp ult i64 %203, 4
  br i1 %min.iters.check1246, label %polly.loop_header686.us.preheader, label %vector.ph1247

vector.ph1247:                                    ; preds = %polly.loop_header679.us
  %n.vec1249 = and i64 %203, -4
  %broadcast.splatinsert1255 = insertelement <4 x double> poison, double %_p_scalar_700.us, i32 0
  %broadcast.splat1256 = shufflevector <4 x double> %broadcast.splatinsert1255, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1258 = insertelement <4 x double> poison, double %_p_scalar_708.us, i32 0
...
vector.body1244:                                  ; preds = %vector.body1244, %vector.ph1247
  ...
  %211 = add nuw nsw i64 %index1250, %199
  %212 = add nuw nsw i64 %index1250, %polly.access.mul.Packed_MemRef_call1509693.us
  %213 = getelementptr double, double* %Packed_MemRef_call1509, i64 %212
  %214 = bitcast double* %213 to <4 x double>*
  %wide.load1254 = load <4 x double>, <4 x double>* %214, align 8
  %215 = fmul fast <4 x double> %broadcast.splat1256, %wide.load1254
  ...
  %wide.load1257 = load <4 x double>, <4 x double>* %218, align 8
  %219 = fmul fast <4 x double> %broadcast.splat1259, %wide.load1257
  %220 = shl i64 %211, 3
  %221 = add nuw nsw i64 %220, %209
  %222 = getelementptr i8, i8* %call, i64 %221
  %223 = bitcast i8* %222 to <4 x double>*
  %wide.load1260 = load <4 x double>, <4 x double>* %223, align 8, !alias.scope !91, !noalias !93
  ...
  %226 = fadd fast <4 x double> %225, %wide.load1260
  ...
  %228 = icmp eq i64 %index.next1251, %n.vec1249
  br i1 %228, label %middle.block1242, label %vector.body1244, !llvm.loop !102

middle.block1242:                                 ; preds = %vector.body1244
  %cmp.n1253 = icmp eq i64 %203, %n.vec1249
  br i1 %cmp.n1253, label %polly.loop_exit688.loopexit.us, label %polly.loop_header686.us.preheader

polly.loop_header686.us.preheader:                ; preds = %polly.loop_header679.us, %middle.block1242
  %polly.indvar690.us.ph = phi i64 [ 0, %polly.loop_header679.us ], [ %n.vec1249, %middle.block1242 ]
...
polly.loop_header686.us:                          ; preds = %polly.loop_header686.us.preheader, %polly.loop_header686.us
  ...
  br i1 %exitcond1093.not, label %polly.loop_exit688.loopexit.us, label %polly.loop_header686.us, !llvm.loop !103

polly.loop_exit688.loopexit.us:                   ; preds = %polly.loop_header686.us, %middle.block1242
  %polly.indvar_next683.us = add nuw nsw i64 %polly.indvar682.us, 1
  %exitcond1094.not = icmp eq i64 %polly.indvar_next683.us, 100
...
polly.loop_header850:                             ; preds = %polly.loop_exit858, %polly.loop_header844
  ...
  br i1 %min.iters.check, label %polly.loop_header856, label %vector.ph1172

vector.ph1172:                                    ; preds = %polly.loop_header850
  %broadcast.splatinsert1179 = insertelement <4 x i64> poison, i64 %236, i32 0
  %broadcast.splat1180 = shufflevector <4 x i64> %broadcast.splatinsert1179, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1181 = insertelement <4 x i32> poison, i32 %239, i32 0
...
vector.body1171:                                  ; preds = %vector.body1171, %vector.ph1172
  ...
  %241 = add nuw nsw <4 x i64> %vec.ind1177, %broadcast.splat1180
  %242 = trunc <4 x i64> %241 to <4 x i32>
  %243 = mul <4 x i32> %broadcast.splat1182, %242
  ...
  %253 = icmp eq i64 %index.next1174, %235
  br i1 %253, label %polly.loop_exit858, label %vector.body1171, !llvm.loop !109

polly.loop_exit858:                               ; preds = %vector.body1171, %polly.loop_header856
  %polly.indvar_next854 = add nuw nsw i64 %polly.indvar853, 1
  %exitcond1135.not = icmp eq i64 %polly.indvar853, %233
...
polly.loop_header856:                             ; preds = %polly.loop_header850, %polly.loop_header856
  ...
  %exitcond1131.not = icmp eq i64 %polly.indvar859, %237
  br i1 %exitcond1131.not, label %polly.loop_exit858, label %polly.loop_header856, !llvm.loop !110
...
polly.loop_header871:                             ; preds = %polly.loop_exit879, %polly.loop_header865
  ...
  %smin1186 = call i64 @llvm.smin.i64(i64 %263, i64 -968)
  %264 = add nsw i64 %smin1186, 1000
  %smin1120 = call i64 @llvm.smin.i64(i64 %indvars.iv1118, i64 -968)
  %265 = shl nsw i64 %polly.indvar874, 5
  %266 = add nsw i64 %smin1120, 999
...
polly.loop_header877:                             ; preds = %polly.loop_exit885, %polly.loop_header871
  ...
  %min.iters.check1187 = icmp eq i64 %264, 0
  br i1 %min.iters.check1187, label %polly.loop_header883, label %vector.ph1188

vector.ph1188:                                    ; preds = %polly.loop_header877
  %broadcast.splatinsert1197 = insertelement <4 x i64> poison, i64 %265, i32 0
  %broadcast.splat1198 = shufflevector <4 x i64> %broadcast.splatinsert1197, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1199 = insertelement <4 x i32> poison, i32 %268, i32 0
...
vector.body1185:                                  ; preds = %vector.body1185, %vector.ph1188
  ...
  %270 = add nuw nsw <4 x i64> %vec.ind1195, %broadcast.splat1198
  %271 = trunc <4 x i64> %270 to <4 x i32>
  %272 = mul <4 x i32> %broadcast.splat1200, %271
  ...
  %282 = icmp eq i64 %index.next1192, %264
  br i1 %282, label %polly.loop_exit885, label %vector.body1185, !llvm.loop !112

polly.loop_exit885:                               ; preds = %vector.body1185, %polly.loop_header883
  %polly.indvar_next881 = add nuw nsw i64 %polly.indvar880, 1
  %exitcond1125.not = icmp eq i64 %polly.indvar880, %262
...
polly.loop_header883:                             ; preds = %polly.loop_header877, %polly.loop_header883
  ...
  %exitcond1121.not = icmp eq i64 %polly.indvar886, %266
  br i1 %exitcond1121.not, label %polly.loop_exit885, label %polly.loop_header883, !llvm.loop !113
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %smin1204 = call i64 @llvm.smin.i64(i64 %292, i64 -968)
  %293 = add nsw i64 %smin1204, 1000
  %smin1110 = call i64 @llvm.smin.i64(i64 %indvars.iv1108, i64 -968)
  %294 = shl nsw i64 %polly.indvar900, 5
  %295 = add nsw i64 %smin1110, 999
...
polly.loop_header903:                             ; preds = %polly.loop_exit911, %polly.loop_header897
  ...
  %min.iters.check1205 = icmp eq i64 %293, 0
  br i1 %min.iters.check1205, label %polly.loop_header909, label %vector.ph1206

vector.ph1206:                                    ; preds = %polly.loop_header903
  %broadcast.splatinsert1215 = insertelement <4 x i64> poison, i64 %294, i32 0
  %broadcast.splat1216 = shufflevector <4 x i64> %broadcast.splatinsert1215, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1217 = insertelement <4 x i32> poison, i32 %297, i32 0
...
vector.body1203:                                  ; preds = %vector.body1203, %vector.ph1206
  ...
  %299 = add nuw nsw <4 x i64> %vec.ind1213, %broadcast.splat1216
  %300 = trunc <4 x i64> %299 to <4 x i32>
  %301 = mul <4 x i32> %broadcast.splat1218, %300
  ...
  %311 = icmp eq i64 %index.next1210, %293
  br i1 %311, label %polly.loop_exit911, label %vector.body1203, !llvm.loop !115

polly.loop_exit911:                               ; preds = %vector.body1203, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1115.not = icmp eq i64 %polly.indvar906, %291
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %exitcond1111.not = icmp eq i64 %polly.indvar912, %295
  br i1 %exitcond1111.not, label %polly.loop_exit911, label %polly.loop_header909, !llvm.loop !116
}
