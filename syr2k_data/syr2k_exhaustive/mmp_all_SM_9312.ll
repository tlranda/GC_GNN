; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9312.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9312.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %109 = icmp slt i64 %108, -1072
  %110 = select i1 %109, i64 %108, i64 -1072
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %indvars.iv.next780 = add i64 %indvars.iv779, -128
  %indvars.iv.next784 = add i64 %indvars.iv783, 128
  %exitcond788.not = icmp eq i64 %polly.indvar_next209, 10
...
polly.loop_header217:                             ; preds = %polly.loop_exit226, %polly.loop_header211
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv785, i64 63)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %131 = shl nuw nsw i64 %130, 7
  %132 = sub nsw i64 %indvars.iv792, %131
  %133 = add i64 %indvars.iv797, %131
  %134 = shl nsw i64 %polly.indvar355, 6
  %135 = mul nsw i64 %polly.indvar355, -64
  br label %polly.loop_header359

polly.loop_exit361:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next793 = add nuw nsw i64 %indvars.iv792, 64
  %indvars.iv.next798 = add nsw i64 %indvars.iv797, -64
  %exitcond807.not = icmp eq i64 %polly.indvar_next356, 19
...
polly.loop_header359:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %137 = shl nsw i64 %polly.indvar362, 7
  %138 = sub nsw i64 %134, %137
  %139 = icmp sgt i64 %138, 0
  %140 = select i1 %139, i64 %138, i64 0
  %141 = mul nsw i64 %polly.indvar362, -128
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header359
  ...
  %indvars.iv.next795 = add i64 %indvars.iv794, -128
  %indvars.iv.next800 = add i64 %indvars.iv799, 128
  %exitcond806.not = icmp eq i64 %polly.indvar_next363, 10
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next512, 19
...
polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %170 = shl nsw i64 %polly.indvar518, 7
  %171 = sub nsw i64 %167, %170
  %172 = icmp sgt i64 %171, 0
  %173 = select i1 %172, i64 %171, i64 0
  %174 = mul nsw i64 %polly.indvar518, -128
...
polly.loop_exit523:                               ; preds = %polly.loop_exit530, %polly.loop_header515
  ...
  %indvars.iv.next813 = add i64 %indvars.iv812, -128
  %indvars.iv.next818 = add i64 %indvars.iv817, 128
  %exitcond824.not = icmp eq i64 %polly.indvar_next519, 10
...
polly.loop_header528:                             ; preds = %polly.loop_exit538, %polly.loop_header521
  ...
  %smin821 = call i64 @llvm.smin.i64(i64 %indvars.iv819, i64 63)
