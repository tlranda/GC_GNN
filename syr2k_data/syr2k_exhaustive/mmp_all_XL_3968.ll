; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3968.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3968.c"
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  ...
  %159 = mul nsw i64 %polly.indvar402, -100
  %160 = mul nuw nsw i64 %polly.indvar402, 100
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit449
  ...
  %.inv889 = icmp sgt i64 %164, 99
  %166 = select i1 %.inv889, i64 99, i64 %165
...
polly.loop_header604.preheader:                   ; preds = %polly.loop_header596
  ...
  %213 = mul nsw i64 %polly.indvar599, -100
  %214 = mul nuw nsw i64 %polly.indvar599, 100
...
polly.loop_header604:                             ; preds = %polly.loop_header604.preheader, %polly.loop_exit646
  ...
  %.inv890 = icmp sgt i64 %218, 99
  %220 = select i1 %.inv890, i64 99, i64 %219
