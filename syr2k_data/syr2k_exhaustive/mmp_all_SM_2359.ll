; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2359.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2359.c"
...
vector.body1279:                                  ; preds = %vector.body1279, %vector.ph1281
  ...
  br i1 %57, label %middle.block1277, label %vector.body1279, !llvm.loop !56
...
vector.body1327:                                  ; preds = %vector.body1327, %vector.ph1329
  ...
  br i1 %68, label %middle.block1325, label %vector.body1327, !llvm.loop !58
...
vector.body1339:                                  ; preds = %vector.body1339, %vector.ph1343
  ...
  %wide.load1350 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !64, !noalias !66
  ...
  br i1 %95, label %middle.block1337, label %vector.body1339, !llvm.loop !71
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit224 ], [ 27, %polly.loop_exit208 ]
  ...
  %smin1053 = call i64 @llvm.smin.i64(i64 %100, i64 21)
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1357 = call i64 @llvm.smin.i64(i64 %120, i64 49)
...
vector.body1353:                                  ; preds = %vector.body1353, %vector.ph1359
  ...
  %wide.load1372 = load <4 x double>, <4 x double>* %141, align 8, !alias.scope !64, !noalias !66
  ...
  br i1 %146, label %middle.block1351, label %vector.body1353, !llvm.loop !76
...
vector.body1291:                                  ; preds = %vector.body1291, %vector.ph1295
  ...
  %wide.load1302 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %157, label %middle.block1289, label %vector.body1291, !llvm.loop !85
...
polly.loop_header394:                             ; preds = %polly.loop_header394.preheader, %polly.loop_header394
  ...
  br i1 %exitcond1089.not, label %polly.loop_exit396, label %polly.loop_header394, !llvm.loop !86
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  %indvars.iv1081 = phi i64 [ %indvars.iv.next1082, %polly.loop_exit428 ], [ 27, %polly.loop_exit412 ]
  ...
  %161 = udiv i64 %indvars.iv1081, 25
  %162 = sub nsw i64 %indvars.iv1079, %161
  %smin1083 = call i64 @llvm.smin.i64(i64 %162, i64 21)
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1309 = call i64 @llvm.smin.i64(i64 %182, i64 49)
...
vector.body1305:                                  ; preds = %vector.body1305, %vector.ph1311
  ...
  %wide.load1324 = load <4 x double>, <4 x double>* %203, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %208, label %middle.block1303, label %vector.body1305, !llvm.loop !89
...
polly.loop_header483.us:                          ; preds = %polly.loop_header483.us.preheader, %polly.loop_header483.us
  ...
  br i1 %exitcond1077.not, label %polly.loop_exit485.loopexit.us, label %polly.loop_header483.us, !llvm.loop !90
...
vector.body1245:                                  ; preds = %vector.body1245, %vector.ph1247
  ...
  %wide.load1254 = load <4 x double>, <4 x double>* %216, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %219, label %middle.block1243, label %vector.body1245, !llvm.loop !98
...
polly.loop_header605:                             ; preds = %polly.loop_header605.preheader, %polly.loop_header605
  ...
  br i1 %exitcond1119.not, label %polly.loop_exit607, label %polly.loop_header605, !llvm.loop !99
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  %indvars.iv1111 = phi i64 [ %indvars.iv.next1112, %polly.loop_exit639 ], [ 27, %polly.loop_exit623 ]
  ...
  %223 = udiv i64 %indvars.iv1111, 25
  %224 = sub nsw i64 %indvars.iv1109, %223
  %smin1113 = call i64 @llvm.smin.i64(i64 %224, i64 21)
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1261 = call i64 @llvm.smin.i64(i64 %244, i64 49)
...
vector.body1257:                                  ; preds = %vector.body1257, %vector.ph1263
  ...
  %wide.load1276 = load <4 x double>, <4 x double>* %265, align 8, !alias.scope !91, !noalias !93
  ...
  br i1 %270, label %middle.block1255, label %vector.body1257, !llvm.loop !102
...
polly.loop_header694.us:                          ; preds = %polly.loop_header694.us.preheader, %polly.loop_header694.us
  ...
  br i1 %exitcond1107.not, label %polly.loop_exit696.loopexit.us, label %polly.loop_header694.us, !llvm.loop !103
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1185
  ...
  br i1 %295, label %polly.loop_exit866, label %vector.body1184, !llvm.loop !109
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  br i1 %exitcond1144.not, label %polly.loop_exit866, label %polly.loop_header864, !llvm.loop !110
...
vector.body1198:                                  ; preds = %vector.body1198, %vector.ph1201
  ...
  br i1 %324, label %polly.loop_exit893, label %vector.body1198, !llvm.loop !112
...
polly.loop_header891:                             ; preds = %polly.loop_header885, %polly.loop_header891
  ...
  br i1 %exitcond1134.not, label %polly.loop_exit893, label %polly.loop_header891, !llvm.loop !113
...
vector.body1216:                                  ; preds = %vector.body1216, %vector.ph1219
  ...
  br i1 %353, label %polly.loop_exit919, label %vector.body1216, !llvm.loop !115
...
polly.loop_header917:                             ; preds = %polly.loop_header911, %polly.loop_header917
  ...
  br i1 %exitcond1124.not, label %polly.loop_exit919, label %polly.loop_header917, !llvm.loop !116
}
