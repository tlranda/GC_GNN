; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10645.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10645.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin780 = call i64 @llvm.smin.i64(i64 %indvars.iv778, i64 -1072)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next779 = add nsw i64 %indvars.iv778, -128
...
polly.loop_header350:                             ; preds = %polly.loop_exit342, %polly.loop_exit359
  ...
  %121 = shl nsw i64 %polly.indvar353, 7
...
polly.loop_exit359:                               ; preds = %polly.loop_exit365
  ...
  %exitcond800.not = icmp eq i64 %polly.indvar_next354, 10
...
polly.loop_header504:                             ; preds = %polly.loop_exit496, %polly.loop_exit513
  ...
  %smin814 = call i64 @llvm.smin.i64(i64 %indvars.iv812, i64 -1072)
  %144 = shl nsw i64 %polly.indvar507, 7
...
polly.loop_exit513:                               ; preds = %polly.loop_exit519
  ...
  %indvars.iv.next813 = add nsw i64 %indvars.iv812, -128
  %exitcond817.not = icmp eq i64 %polly.indvar_next508, 10
