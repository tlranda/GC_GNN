; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7868.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7868.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next225, 250
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249944 = icmp sgt i64 %119, -1
  %120 = add nuw nsw i64 %polly.indvar236, %104
...
vector.body1053:                                  ; preds = %vector.body1053, %vector.ph1057
  ...
  %132 = shl nuw nsw i64 %index1060, 3
  %133 = getelementptr i8, i8* %scevgep370, i64 %132
  %134 = bitcast i8* %133 to <4 x double>*
  %wide.load1064 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !74, !noalias !76
  %135 = fmul fast <4 x double> %wide.load1064, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %137 = icmp eq i64 %index.next1061, %n.vec1059
  br i1 %137, label %middle.block1051, label %vector.body1053, !llvm.loop !80

middle.block1051:                                 ; preds = %vector.body1053
  %cmp.n1063 = icmp eq i64 %130, %n.vec1059
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %139 = udiv i64 %indvars.iv875, 25
  %140 = sub nsw i64 %indvars.iv873, %139
  %smin877 = call i64 @llvm.smin.i64(i64 %140, i64 20)
  %141 = add nsw i64 %smin877, 3
  %smax878 = call i64 @llvm.smax.i64(i64 %141, i64 0)
  %142 = mul nsw i64 %polly.indvar393, -128
  %143 = icmp slt i64 %142, -1072
  %144 = select i1 %143, i64 %142, i64 -1072
  %145 = add nsw i64 %144, 1199
  %146 = shl nsw i64 %polly.indvar393, 7
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412
  ...
  %exitcond880.not = icmp eq i64 %polly.indvar_next400, 250
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %155 = mul nuw nsw i64 %polly.indvar406, 50
  %156 = add nsw i64 %155, %142
  %157 = icmp sgt i64 %156, 0
  %158 = select i1 %157, i64 %156, i64 0
  %polly.loop_guard413.not = icmp sgt i64 %158, %145
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %159 = add i64 %smax863, %indvars.iv866
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv868 = phi i64 [ %159, %polly.loop_header410.preheader ], [ %indvars.iv.next869, %polly.loop_exit419 ]
  ...
  %polly.loop_guard427945 = icmp sgt i64 %161, -1
  %162 = add nuw nsw i64 %polly.indvar414, %146
...
polly.loop_exit419:                               ; preds = %polly.loop_header424.us.3, %polly.loop_header410
  ...
  %polly.loop_cond416.not.not = icmp ult i64 %polly.indvar414, %145
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1030 = icmp ult i64 %172, 4
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1031
  ...
  %174 = shl nuw nsw i64 %index1034, 3
  %175 = getelementptr i8, i8* %scevgep548, i64 %174
  %176 = bitcast i8* %175 to <4 x double>*
  %wide.load1038 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !84, !noalias !86
  %177 = fmul fast <4 x double> %wide.load1038, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %179 = icmp eq i64 %index.next1035, %n.vec1033
  br i1 %179, label %middle.block1027, label %vector.body1029, !llvm.loop !90

middle.block1027:                                 ; preds = %vector.body1029
  %cmp.n1037 = icmp eq i64 %172, %n.vec1033
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %182 = sub nsw i64 %indvars.iv900, %181
  %smin904 = call i64 @llvm.smin.i64(i64 %182, i64 20)
  %183 = add nsw i64 %smin904, 3
  %smax905 = call i64 @llvm.smax.i64(i64 %183, i64 0)
  %184 = mul nsw i64 %polly.indvar571, -128
  %185 = icmp slt i64 %184, -1072
  %186 = select i1 %185, i64 %184, i64 -1072
  %187 = add nsw i64 %186, 1199
  %188 = shl nsw i64 %polly.indvar571, 7
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar_next578, 250
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %197 = mul nuw nsw i64 %polly.indvar584, 50
  %198 = add nsw i64 %197, %184
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %polly.loop_guard591.not = icmp sgt i64 %200, %187
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  ...
  %201 = add i64 %smax890, %indvars.iv893
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv895 = phi i64 [ %201, %polly.loop_header588.preheader ], [ %indvars.iv.next896, %polly.loop_exit597 ]
  ...
  %polly.loop_guard605946 = icmp sgt i64 %203, -1
  %204 = add nuw nsw i64 %polly.indvar592, %188
...
polly.loop_exit597:                               ; preds = %polly.loop_header602.us.3, %polly.loop_header588
  ...
  %polly.loop_cond594.not.not = icmp ult i64 %polly.indvar592, %187
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin968 = call i64 @llvm.smin.i64(i64 %216, i64 -1168)
  %217 = add nsw i64 %smin968, 1200
  %smin935 = call i64 @llvm.smin.i64(i64 %indvars.iv933, i64 -1168)
  %218 = shl nsw i64 %polly.indvar761, 5
  %219 = add nsw i64 %smin935, 1199
...
vector.ph969:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert976 = insertelement <4 x i64> poison, i64 %218, i32 0
  %broadcast.splat977 = shufflevector <4 x i64> %broadcast.splatinsert976, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert978 = insertelement <4 x i32> poison, i32 %221, i32 0
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph969
  ...
  %223 = add nuw nsw <4 x i64> %vec.ind974, %broadcast.splat977
  %224 = trunc <4 x i64> %223 to <4 x i32>
  %225 = mul <4 x i32> %broadcast.splat979, %224
  ...
  %235 = icmp eq i64 %index.next971, %217
  br i1 %235, label %polly.loop_exit772, label %vector.body967, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body967, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond940.not = icmp eq i64 %polly.indvar767, %215
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond936.not = icmp eq i64 %polly.indvar773, %219
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %245, i64 -968)
  %246 = add nsw i64 %smin983, 1000
  %smin925 = call i64 @llvm.smin.i64(i64 %indvars.iv923, i64 -968)
  %247 = shl nsw i64 %polly.indvar788, 5
  %248 = add nsw i64 %smin925, 999
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph985
  ...
  %252 = add nuw nsw <4 x i64> %vec.ind992, %broadcast.splat995
  %253 = trunc <4 x i64> %252 to <4 x i32>
  %254 = mul <4 x i32> %broadcast.splat997, %253
  ...
  %264 = icmp eq i64 %index.next989, %246
  br i1 %264, label %polly.loop_exit799, label %vector.body982, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body982, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond930.not = icmp eq i64 %polly.indvar794, %244
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond926.not = icmp eq i64 %polly.indvar800, %248
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1001 = call i64 @llvm.smin.i64(i64 %274, i64 -968)
  %275 = add nsw i64 %smin1001, 1000
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -968)
  %276 = shl nsw i64 %polly.indvar814, 5
  %277 = add nsw i64 %smin915, 999
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  %281 = add nuw nsw <4 x i64> %vec.ind1010, %broadcast.splat1013
  %282 = trunc <4 x i64> %281 to <4 x i32>
  %283 = mul <4 x i32> %broadcast.splat1015, %282
  ...
  %293 = icmp eq i64 %index.next1007, %275
  br i1 %293, label %polly.loop_exit825, label %vector.body1000, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body1000, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond920.not = icmp eq i64 %polly.indvar820, %273
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar826, %277
...
polly.loop_header424.us.3:                        ; preds = %polly.loop_header424.us.3, %polly.loop_exit426.loopexit.us.2
  ...
  br i1 %exitcond871.3.not, label %polly.loop_exit419, label %polly.loop_header424.us.3
...
polly.loop_header602.us.3:                        ; preds = %polly.loop_header602.us.3, %polly.loop_exit604.loopexit.us.2
  ...
  br i1 %exitcond898.3.not, label %polly.loop_exit597, label %polly.loop_header602.us.3
}
