; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10244.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10244.c"
...
polly.loop_header205.us:                          ; preds = %polly.loop_header199, %polly.loop_exit213.loopexit.us
  ...
  %102 = mul nuw nsw i64 %polly.indvar208.us, 80
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %104 = mul nuw nsw i64 %polly.indvar214.us, 50
  %105 = add nsw i64 %104, %100
  %106 = icmp sgt i64 %105, 0
  %107 = select i1 %106, i64 %105, i64 0
  %polly.loop_guard221.us = icmp slt i64 %107, 80
...
vector.body1100:                                  ; preds = %vector.body1100, %vector.ph1104
  ...
  %wide.load1111 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %129, label %middle.block1098, label %vector.body1100, !llvm.loop !73
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %pexp.p_div_q368 = udiv i64 %132, 5
  %133 = sub nsw i64 %131, %pexp.p_div_q368
  %polly.loop_guard373 = icmp sgt i64 %133, -2
  %134 = mul nsw i64 %polly.indvar359, -80
  %135 = mul nuw nsw i64 %polly.indvar359, 80
...
polly.loop_header362.us:                          ; preds = %polly.loop_header356, %polly.loop_exit372.loopexit.us
  ...
  %136 = mul nuw nsw i64 %polly.indvar365.us, 80
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %138 = mul nuw nsw i64 %polly.indvar374.us, 50
  %139 = add nsw i64 %138, %134
  %140 = icmp sgt i64 %139, 0
  %141 = select i1 %140, i64 %139, i64 0
  %polly.loop_guard381.us = icmp slt i64 %141, 80
...
polly.loop_exit380.us:                            ; preds = %polly.loop_exit387.us, %polly.loop_header370.us
  ...
  %indvars.iv.next917 = add nsw i64 %indvars.iv916, -50
...
vector.body1076:                                  ; preds = %vector.body1076, %vector.ph1078
  ...
  %wide.load1085 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %163, label %middle.block1074, label %vector.body1076, !llvm.loop !82
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %pexp.p_div_q528 = udiv i64 %166, 5
  %167 = sub nsw i64 %165, %pexp.p_div_q528
  %polly.loop_guard533 = icmp sgt i64 %167, -2
  %168 = mul nsw i64 %polly.indvar519, -80
...
polly.loop_header522.us:                          ; preds = %polly.loop_header516, %polly.loop_exit532.loopexit.us
  ...
  %170 = mul nuw nsw i64 %polly.indvar525.us, 80
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %172 = mul nuw nsw i64 %polly.indvar534.us, 50
  %173 = add nsw i64 %172, %168
  %174 = icmp sgt i64 %173, 0
  %175 = select i1 %174, i64 %173, i64 0
  %polly.loop_guard541.us = icmp slt i64 %175, 80
...
polly.loop_header538.us:                          ; preds = %polly.loop_header538.preheader.us, %polly.loop_exit547.us
  ...
  %smin941 = call i64 @llvm.smin.i64(i64 %indvars.iv939, i64 49)
...
polly.loop_exit540.us:                            ; preds = %polly.loop_exit547.us, %polly.loop_header530.us
  ...
  %indvars.iv.next933 = add nsw i64 %indvars.iv932, 50
  %indvars.iv.next938 = add nsw i64 %indvars.iv937, -50
...
vector.body1014:                                  ; preds = %vector.body1014, %vector.ph1016
  ...
  br i1 %211, label %polly.loop_exit720, label %vector.body1014, !llvm.loop !91
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1032
  ...
  br i1 %240, label %polly.loop_exit747, label %vector.body1029, !llvm.loop !94
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1050
  ...
  br i1 %269, label %polly.loop_exit773, label %vector.body1047, !llvm.loop !97
