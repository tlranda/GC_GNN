; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6798.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6798.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next219, 150
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %128 = mul nsw i64 %polly.indvar393, -8
  %129 = shl nsw i64 %polly.indvar393, 3
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit404
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next857 = add nsw i64 %indvars.iv856, -8
  %indvars.iv.next862 = add nuw nsw i64 %indvars.iv861, 8
  %indvars.iv.next874 = add nuw nsw i64 %indvars.iv873, 2
  %exitcond877.not = icmp eq i64 %polly.indvar_next394, 150
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %polly.loop_guard412 = icmp slt i64 %135, 8
...
polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  ...
  %159 = mul nsw i64 %polly.indvar570, -8
  %160 = shl nsw i64 %polly.indvar570, 3
...
polly.loop_exit575:                               ; preds = %polly.loop_exit581
  ...
  %indvars.iv.next888 = add nuw nsw i64 %indvars.iv887, 8
  %indvars.iv.next900 = add nuw nsw i64 %indvars.iv899, 2
  %exitcond903.not = icmp eq i64 %polly.indvar_next571, 150
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %polly.loop_guard589 = icmp slt i64 %166, 8
