; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8797.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8797.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond806.not = icmp eq i64 %polly.indvar_next203, 13
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1008
  ...
  %wide.load1015 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %137, label %middle.block1002, label %vector.body1004, !llvm.loop !77
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %smin826 = call i64 @llvm.smin.i64(i64 %indvars.iv824, i64 -920)
  %139 = mul nuw nsw i64 %polly.indvar359, 80
  %140 = add nsw i64 %smin826, 999
  br label %polly.loop_header362

polly.loop_exit364:                               ; preds = %polly.loop_exit372
  %polly.indvar_next360 = add nuw nsw i64 %polly.indvar359, 1
  %indvars.iv.next825 = add nsw i64 %indvars.iv824, -80
  %exitcond829.not = icmp eq i64 %polly.indvar_next360, 13
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  %wide.load989 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !81, !noalias !83
  ...
  br i1 %179, label %middle.block978, label %vector.body980, !llvm.loop !86
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %smin849 = call i64 @llvm.smin.i64(i64 %indvars.iv847, i64 -920)
  %181 = mul nuw nsw i64 %polly.indvar519, 80
...
polly.loop_exit524:                               ; preds = %polly.loop_exit532
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar_next520, 13
...
vector.body918:                                   ; preds = %vector.body918, %vector.ph920
  ...
  br i1 %235, label %polly.loop_exit720, label %vector.body918, !llvm.loop !95
...
vector.body933:                                   ; preds = %vector.body933, %vector.ph936
  ...
  br i1 %264, label %polly.loop_exit747, label %vector.body933, !llvm.loop !98
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  br i1 %293, label %polly.loop_exit773, label %vector.body951, !llvm.loop !101
