; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10634.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10634.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin789 = call i64 @llvm.smin.i64(i64 %indvars.iv787, i64 -1072)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next788 = add nsw i64 %indvars.iv787, -128
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %126 = shl nsw i64 %polly.indvar355, 7
...
polly.loop_exit360:                               ; preds = %polly.loop_exit367
  ...
  %exitcond814.not = icmp eq i64 %polly.indvar_next356, 10
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %128 = shl nsw i64 %polly.indvar361, 7
...
polly.loop_exit367:                               ; preds = %polly.loop_exit373
  ...
  %exitcond813.not = icmp eq i64 %polly.indvar_next362, 8
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %smin831 = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 -1072)
  %154 = shl nsw i64 %polly.indvar511, 7
...
polly.loop_exit516:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next818 = add nuw nsw i64 %indvars.iv817, 128
  %indvars.iv.next830 = add nsw i64 %indvars.iv829, -128
  %exitcond835.not = icmp eq i64 %polly.indvar_next512, 10
...
polly.loop_header514:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %156 = shl nsw i64 %polly.indvar517, 7
...
polly.loop_exit523:                               ; preds = %polly.loop_exit529
  ...
  %exitcond834.not = icmp eq i64 %polly.indvar_next518, 8
