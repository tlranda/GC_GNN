; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3442.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3442.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1012 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -968)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar_next203, 32
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %smin1039 = call i64 @llvm.smin.i64(i64 %indvars.iv1019, i64 -968)
  %138 = add nsw i64 %smin1039, 1000
  %139 = shl nsw i64 %polly.indvar392, 5
...
polly.loop_exit397:                               ; preds = %polly.loop_exit403
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next393, 32
...
polly.start479:                                   ; preds = %init_array.exit
  %malloccall481 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header581:                             ; preds = %polly.loop_header581.preheader, %polly.loop_exit589
  ...
  %smin1066 = call i64 @llvm.smin.i64(i64 %indvars.iv1046, i64 -968)
  %179 = add nsw i64 %smin1066, 1000
  %180 = shl nsw i64 %polly.indvar584, 5
...
polly.loop_exit589:                               ; preds = %polly.loop_exit595
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar_next585, 32
