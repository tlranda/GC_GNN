; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7785.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7785.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %97 = mul nuw nsw i64 %polly.indvar218, 100
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond839.not = icmp eq i64 %polly.indvar_next219, 12
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %98 = mul nuw nsw i64 %polly.indvar224, 20
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %99 = mul nuw nsw i64 %polly.indvar230, 100
...
polly.loop_exit247.loopexit.us:                   ; preds = %polly.loop_header245.us
  ...
  %exitcond833.not = icmp eq i64 %polly.indvar_next243.us, 20
...
polly.loop_exit241:                               ; preds = %polly.loop_exit247.loopexit.us, %polly.loop_header233
  ...
  %exitcond834.not = icmp eq i64 %polly.indvar_next237, 100
...
vector.body1022:                                  ; preds = %vector.body1022, %vector.ph1026
  ...
  %wide.load1033 = load <4 x double>, <4 x double>* %117, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %120, label %middle.block1020, label %vector.body1022, !llvm.loop !79
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %122 = mul nuw nsw i64 %polly.indvar391, 100
  br label %polly.loop_header394

polly.loop_exit396:                               ; preds = %polly.loop_exit402
  %polly.indvar_next392 = add nuw nsw i64 %polly.indvar391, 1
  %indvars.iv.next845 = add nuw nsw i64 %indvars.iv844, 100
  %indvars.iv.next855 = add nuw nsw i64 %indvars.iv854, 1
  %exitcond858.not = icmp eq i64 %polly.indvar_next392, 12
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header388
  ...
  %123 = mul nuw nsw i64 %polly.indvar397, 20
  br label %polly.loop_header400

polly.loop_exit402:                               ; preds = %polly.loop_exit408
  %polly.indvar_next398 = add nuw nsw i64 %polly.indvar397, 1
  %exitcond857.not = icmp eq i64 %polly.indvar_next398, 50
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_header394
  ...
  %124 = mul nuw nsw i64 %polly.indvar403, 100
...
polly.loop_header406:                             ; preds = %polly.loop_exit414, %polly.loop_header400
  ...
  %smin850 = call i64 @llvm.smin.i64(i64 %indvars.iv848, i64 99)
...
polly.loop_exit421.loopexit.us:                   ; preds = %polly.loop_header419.us
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar_next416.us, 20
...
polly.loop_exit414:                               ; preds = %polly.loop_exit421.loopexit.us, %polly.loop_header406
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next410, 100
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1000
  ...
  %wide.load1007 = load <4 x double>, <4 x double>* %142, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %145, label %middle.block996, label %vector.body998, !llvm.loop !89
...
polly.loop_header563:                             ; preds = %polly.loop_exit555, %polly.loop_exit571
  ...
  %147 = mul nuw nsw i64 %polly.indvar566, 100
...
polly.loop_exit571:                               ; preds = %polly.loop_exit577
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar_next567, 12
...
polly.loop_header569:                             ; preds = %polly.loop_exit577, %polly.loop_header563
  ...
  %148 = mul nuw nsw i64 %polly.indvar572, 20
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar_next573, 50
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %149 = mul nuw nsw i64 %polly.indvar578, 100
...
polly.loop_exit596.loopexit.us:                   ; preds = %polly.loop_header594.us
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar_next591.us, 20
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header581
  ...
  %exitcond872.not = icmp eq i64 %polly.indvar_next585, 100
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  store <4 x double> %178, <4 x double>* %183, align 8, !alias.scope !93, !noalias !95
  ...
  br i1 %184, label %polly.loop_exit764, label %vector.body936, !llvm.loop !98
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  store <4 x double> %207, <4 x double>* %212, align 8, !alias.scope !97, !noalias !100
  ...
  br i1 %213, label %polly.loop_exit791, label %vector.body951, !llvm.loop !101
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph972
  ...
  store <4 x double> %236, <4 x double>* %241, align 8, !alias.scope !96, !noalias !103
  ...
  br i1 %242, label %polly.loop_exit817, label %vector.body969, !llvm.loop !104
