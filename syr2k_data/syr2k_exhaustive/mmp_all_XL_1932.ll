; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1932.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1932.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %107 = mul nsw i64 %polly.indvar225, -80
  %108 = add i64 %98, %107
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1329 = call i64 @llvm.smin.i64(i64 %117, i64 79)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  ...
  %155 = udiv i64 %indvars.iv1057, 5
  %umin1059 = call i64 @llvm.umin.i64(i64 %155, i64 14)
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1281 = call i64 @llvm.smin.i64(i64 %173, i64 79)
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  %indvars.iv1084 = phi i64 [ %indvars.iv.next1085, %polly.loop_exit628 ], [ 1, %polly.loop_exit611 ]
  ...
  %211 = udiv i64 %indvars.iv1084, 5
  %umin1086 = call i64 @llvm.umin.i64(i64 %211, i64 14)
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %217 = mul nuw nsw i64 %polly.indvar629, 80
  %218 = add i64 %209, %217
  %smax1230 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar629, -80
  %220 = add i64 %210, %219
  %221 = add i64 %smax1230, %220
  %222 = mul nuw nsw i64 %polly.indvar629, 80
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1233 = call i64 @llvm.smin.i64(i64 %229, i64 79)
