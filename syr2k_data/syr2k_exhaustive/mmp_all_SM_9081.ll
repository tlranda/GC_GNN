; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9081.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9081.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %107 = mul i8 %106, 9
  %pexp.p_div_q.lhs.trunc = add i8 %107, 24
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %114 = mul nsw i64 %polly.indvar214, 100
  %115 = sub nsw i64 %111, %114
  %116 = icmp sgt i64 %115, 0
  %117 = select i1 %116, i64 %115, i64 0
  %polly.loop_guard227 = icmp slt i64 %117, 100
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %144 = udiv i64 %indvars.iv811, 25
  %145 = mul nuw nsw i64 %144, 100
  %146 = trunc i64 %polly.indvar365 to i8
  %147 = mul i8 %146, 9
  %pexp.p_div_q368.lhs.trunc = add i8 %147, 24
  %pexp.p_div_q368781 = udiv i8 %pexp.p_div_q368.lhs.trunc, 25
  %pexp.p_div_q368.zext = zext i8 %pexp.p_div_q368781 to i64
  %148 = sub nsw i64 %polly.indvar365, %pexp.p_div_q368.zext
  %polly.loop_guard373 = icmp slt i64 %148, 12
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %151 = shl nsw i64 %polly.indvar365, 6
  %152 = mul nsw i64 %polly.indvar365, -64
  br label %polly.loop_header370

polly.loop_exit372:                               ; preds = %polly.loop_exit379, %polly.loop_header362
  %polly.indvar_next366 = add nuw nsw i64 %polly.indvar365, 1
  %indvars.iv.next810 = add nsw i64 %indvars.iv809, -36
  %indvars.iv.next812 = add nuw nsw i64 %indvars.iv811, 9
  %indvars.iv.next817 = add nuw nsw i64 %indvars.iv816, 36
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %154 = mul nsw i64 %polly.indvar374, 100
  %155 = sub nsw i64 %151, %154
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %polly.loop_guard387 = icmp slt i64 %157, 100
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %184 = udiv i64 %indvars.iv831, 25
  %185 = mul nuw nsw i64 %184, 100
  %186 = trunc i64 %polly.indvar525 to i8
  %187 = mul i8 %186, 9
  %pexp.p_div_q528.lhs.trunc = add i8 %187, 24
  %pexp.p_div_q528780 = udiv i8 %pexp.p_div_q528.lhs.trunc, 25
  %pexp.p_div_q528.zext = zext i8 %pexp.p_div_q528780 to i64
  %188 = sub nsw i64 %polly.indvar525, %pexp.p_div_q528.zext
  %polly.loop_guard533 = icmp slt i64 %188, 12
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  ...
  %191 = shl nsw i64 %polly.indvar525, 6
  %192 = mul nsw i64 %polly.indvar525, -64
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header522
  ...
  %indvars.iv.next830 = add nsw i64 %indvars.iv829, -36
  %indvars.iv.next832 = add nuw nsw i64 %indvars.iv831, 9
  %indvars.iv.next837 = add nuw nsw i64 %indvars.iv836, 36
