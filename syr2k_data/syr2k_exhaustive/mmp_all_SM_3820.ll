; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3820.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3820.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %indvars.iv.next1020 = add nuw nsw i64 %indvars.iv1019, 20
  %indvars.iv.next1024 = add nsw i64 %indvars.iv1023, -20
  %exitcond1033.not = icmp eq i64 %124, 60
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %125 = add i64 %smax, %indvars.iv1025
  %126 = mul nuw nsw i64 %polly.indvar214, 5
  %.not.not = icmp ugt i64 %126, %polly.indvar208
  %127 = mul nuw nsw i64 %polly.indvar214, 100
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %polly.loop_guard256 = icmp slt i64 %137, 100
...
polly.loop_header253.us:                          ; preds = %polly.loop_header246.us, %polly.loop_exit263.us
  %indvars.iv1027 = phi i64 [ %125, %polly.loop_header246.us ], [ %indvars.iv.next1028, %polly.loop_exit263.us ]
  %polly.indvar257.us = phi i64 [ %137, %polly.loop_header246.us ], [ %polly.indvar_next258.us, %polly.loop_exit263.us ]
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 19)
...
vector.body1237:                                  ; preds = %vector.body1237, %vector.ph1241
  ...
  %wide.load1248 = load <4 x double>, <4 x double>* %155, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %158, label %middle.block1235, label %vector.body1237, !llvm.loop !85
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %160 = add nsw i64 %smin1057, 1000
  %161 = shl nsw i64 %polly.indvar392, 6
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %162 = udiv i64 %polly.indvar398, 5
  %163 = mul nuw nsw i64 %162, 100
  %164 = sub nsw i64 %indvars.iv1044, %163
  %165 = add i64 %indvars.iv1049, %163
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1059.not = icmp eq i64 %187, 60
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit445 ], [ %165, %polly.loop_header395 ]
  %indvars.iv1046 = phi i64 [ %indvars.iv.next1047, %polly.loop_exit445 ], [ %164, %polly.loop_header395 ]
  ...
  %189 = mul nuw nsw i64 %polly.indvar405, 5
  %.not.not885 = icmp ugt i64 %189, %polly.indvar398
  %190 = mul nuw nsw i64 %polly.indvar405, 100
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_header408.us
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next412.us, %160
...
polly.loop_exit445:                               ; preds = %polly.loop_exit452.loopexit.us, %polly.loop_header443.preheader
  ...
  %indvars.iv.next1047 = add i64 %indvars.iv1046, -100
  %indvars.iv.next1052 = add i64 %indvars.iv1051, 100
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next412, %160
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %polly.loop_guard453 = icmp slt i64 %200, 100
...
polly.loop_header450.us:                          ; preds = %polly.loop_header443.us, %polly.loop_exit460.us
  %indvars.iv1053 = phi i64 [ %188, %polly.loop_header443.us ], [ %indvars.iv.next1054, %polly.loop_exit460.us ]
  %polly.indvar454.us = phi i64 [ %200, %polly.loop_header443.us ], [ %polly.indvar_next455.us, %polly.loop_exit460.us ]
  %smin1055 = call i64 @llvm.smin.i64(i64 %indvars.iv1053, i64 19)
...
polly.loop_exit452.loopexit.us:                   ; preds = %polly.loop_exit460.us
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next447.us, %160
...
vector.body1213:                                  ; preds = %vector.body1213, %vector.ph1215
  ...
  %wide.load1222 = load <4 x double>, <4 x double>* %218, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %221, label %middle.block1211, label %vector.body1213, !llvm.loop !95
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %223 = add nsw i64 %smin1083, 1000
  %224 = shl nsw i64 %polly.indvar589, 6
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %225 = udiv i64 %polly.indvar595, 5
  %226 = mul nuw nsw i64 %225, 100
  %227 = sub nsw i64 %indvars.iv1070, %226
  %228 = add i64 %indvars.iv1075, %226
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1077 = phi i64 [ %indvars.iv.next1078, %polly.loop_exit642 ], [ %228, %polly.loop_header592 ]
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit642 ], [ %227, %polly.loop_header592 ]
  ...
  %251 = add i64 %smax1074, %indvars.iv1077
  %252 = mul nuw nsw i64 %polly.indvar602, 5
  %.not.not886 = icmp ugt i64 %252, %polly.indvar595
  %253 = mul nuw nsw i64 %polly.indvar602, 100
  %254 = add nsw i64 %253, %230
  %255 = icmp sgt i64 %254, 0
  %256 = select i1 %255, i64 %254, i64 0
  %257 = add nsw i64 %254, 99
...
polly.loop_exit628.us:                            ; preds = %polly.loop_header626.us, %polly.loop_header605.us
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next609.us, %223
...
polly.loop_exit642:                               ; preds = %polly.loop_exit649.loopexit.us, %polly.loop_header640.preheader
  ...
  %indvars.iv.next1078 = add i64 %indvars.iv1077, 100
...
polly.loop_exit628:                               ; preds = %polly.loop_header626
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next609, %223
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %polly.loop_guard650 = icmp slt i64 %263, 100
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.us, %polly.loop_exit657.us
  %indvars.iv1079 = phi i64 [ %251, %polly.loop_header640.us ], [ %indvars.iv.next1080, %polly.loop_exit657.us ]
  %polly.indvar651.us = phi i64 [ %263, %polly.loop_header640.us ], [ %polly.indvar_next652.us, %polly.loop_exit657.us ]
  %smin1081 = call i64 @llvm.smin.i64(i64 %indvars.iv1079, i64 19)
...
polly.loop_exit649.loopexit.us:                   ; preds = %polly.loop_exit657.us
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next644.us, %223
...
vector.body1152:                                  ; preds = %vector.body1152, %vector.ph1153
  ...
  br i1 %298, label %polly.loop_exit825, label %vector.body1152, !llvm.loop !104
...
vector.body1166:                                  ; preds = %vector.body1166, %vector.ph1169
  ...
  br i1 %327, label %polly.loop_exit852, label %vector.body1166, !llvm.loop !107
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1187
  ...
  br i1 %356, label %polly.loop_exit878, label %vector.body1184, !llvm.loop !110
