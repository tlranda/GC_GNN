; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1309.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1309.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %104 = add i64 %103, %101
  %105 = lshr i64 %polly.indvar209, 5
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %118 = mul nsw i64 %indvar1430, -128
  %119 = add i64 %102, %118
  %smax1432 = call i64 @llvm.smax.i64(i64 %119, i64 0)
  %120 = shl nuw nsw i64 %indvar1430, 7
  %121 = add i64 %104, %120
  ...
  %125 = shl nsw i64 %polly.indvar231, 7
...
vector.body1429:                                  ; preds = %vector.body1429, %vector.ph1437
  ...
  %wide.load1450 = load <4 x double>, <4 x double>* %159, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %164, label %middle.block1427, label %vector.body1429, !llvm.loop !83
...
vector.body1365:                                  ; preds = %vector.body1365, %vector.ph1369
  ...
  %wide.load1376 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %175, label %middle.block1363, label %vector.body1365, !llvm.loop !92
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %184 = add i64 %183, %181
  %185 = lshr i64 %polly.indvar419, 5
  %186 = shl nuw nsw i64 %185, 7
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %218 = mul nsw i64 %polly.indvar442, -128
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1387
  ...
  %wide.load1400 = load <4 x double>, <4 x double>* %239, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %244, label %middle.block1377, label %vector.body1379, !llvm.loop !96
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1319
  ...
  %wide.load1326 = load <4 x double>, <4 x double>* %252, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %255, label %middle.block1315, label %vector.body1317, !llvm.loop !105
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %264 = add i64 %263, %261
  %265 = lshr i64 %polly.indvar636, 5
  %266 = shl nuw nsw i64 %265, 7
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %298 = mul nsw i64 %polly.indvar659, -128
  %299 = icmp slt i64 %298, -1072
  %300 = select i1 %299, i64 %298, i64 -1072
...
vector.body1329:                                  ; preds = %vector.body1329, %vector.ph1337
  ...
  %wide.load1350 = load <4 x double>, <4 x double>* %319, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %324, label %middle.block1327, label %vector.body1329, !llvm.loop !109
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1257
  ...
  br i1 %349, label %polly.loop_exit884, label %vector.body1256, !llvm.loop !116
...
vector.body1270:                                  ; preds = %vector.body1270, %vector.ph1273
  ...
  br i1 %378, label %polly.loop_exit911, label %vector.body1270, !llvm.loop !119
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1291
  ...
  br i1 %407, label %polly.loop_exit937, label %vector.body1288, !llvm.loop !122
