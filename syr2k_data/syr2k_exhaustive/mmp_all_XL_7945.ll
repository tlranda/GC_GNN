; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7945.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7945.c"
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph965
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv7.i, i64 %index966
...
vector.body1027:                                  ; preds = %vector.body1027, %vector.ph1029
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i, i64 %index1032
...
vector.body1050:                                  ; preds = %vector.body1050, %vector.ph1052
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i52, i64 %index1055
  ...
  br i1 %57, label %middle.block1048, label %vector.body1050, !llvm.loop !55
...
vector.body1076:                                  ; preds = %vector.body1076, %vector.ph1078
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i91, i64 %index1081
  ...
  br i1 %68, label %middle.block1074, label %vector.body1076, !llvm.loop !57
...
vector.body1088:                                  ; preds = %vector.body1088, %vector.ph1092
  ...
  %wide.load1099 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  ...
  br i1 %95, label %middle.block1086, label %vector.body1088, !llvm.loop !69
...
polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1086
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar_next, 1200
  %indvar.next1090 = add i64 %indvar1089, 1
  br i1 %exitcond861.not, label %polly.loop_header199.preheader, label %polly.loop_header
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  %exitcond860.not = icmp eq i64 %polly.indvar_next195, %polly.indvar
  br i1 %exitcond860.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !70
...
polly.loop_exit207:                               ; preds = %polly.loop_header205
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next203, 1000
  br i1 %exitcond859.not, label %polly.loop_header215, label %polly.loop_header199
...
polly.loop_header205:                             ; preds = %polly.loop_header205, %polly.loop_header199
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar_next209, 1200
  br i1 %exitcond858.not, label %polly.loop_exit207, label %polly.loop_header205

polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv851 = phi i64 [ %indvars.iv.next852, %polly.loop_exit223 ], [ 36, %polly.loop_exit207 ]
  ...
  %smin853 = call i64 @llvm.smin.i64(i64 %98, i64 20)
  %99 = add nsw i64 %smin853, 3
  %smax854 = call i64 @llvm.smax.i64(i64 %99, i64 0)
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next850 = add nuw nsw i64 %indvars.iv849, 3
  %indvars.iv.next852 = add nuw nsw i64 %indvars.iv851, 11
  %exitcond857.not = icmp eq i64 %polly.indvar_next219, 10
  br i1 %exitcond857.not, label %polly.exiting, label %polly.loop_header215
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next225, 13
  br i1 %exitcond856.not, label %polly.loop_exit223, label %polly.loop_header221
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar230, %smax854
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249953 = icmp sgt i64 %113, -1
  %114 = add nuw nsw i64 %polly.indvar236, %104
  %115 = mul i64 %114, 8000
  %116 = mul i64 %114, 9600
  br i1 %polly.loop_guard249953, label %polly.loop_header239.us, label %polly.loop_exit241
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.start272
  %indvar1063 = phi i64 [ %indvar.next1064, %polly.loop_exit366 ], [ 0, %polly.start272 ]
  %polly.indvar361 = phi i64 [ %polly.indvar_next362, %polly.loop_exit366 ], [ 1, %polly.start272 ]
  %125 = add i64 %indvar1063, 1
  %126 = mul nuw nsw i64 %polly.indvar361, 9600
  %scevgep370 = getelementptr i8, i8* %call, i64 %126
  %min.iters.check1065 = icmp ult i64 %125, 4
  br i1 %min.iters.check1065, label %polly.loop_header364.preheader, label %vector.ph1066

vector.ph1066:                                    ; preds = %polly.loop_header358
  %n.vec1068 = and i64 %125, -4
...
vector.body1062:                                  ; preds = %vector.body1062, %vector.ph1066
  ...
  %127 = shl nuw nsw i64 %index1069, 3
  %128 = getelementptr i8, i8* %scevgep370, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1073 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !74, !noalias !76
  %130 = fmul fast <4 x double> %wide.load1073, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1070, %n.vec1068
  br i1 %132, label %middle.block1060, label %vector.body1062, !llvm.loop !80

middle.block1060:                                 ; preds = %vector.body1062
  %cmp.n1072 = icmp eq i64 %125, %n.vec1068
  br i1 %cmp.n1072, label %polly.loop_exit366, label %polly.loop_header364.preheader

polly.loop_header364.preheader:                   ; preds = %polly.loop_header358, %middle.block1060
  %polly.indvar367.ph = phi i64 [ 0, %polly.loop_header358 ], [ %n.vec1068, %middle.block1060 ]
  br label %polly.loop_header364

polly.loop_exit366:                               ; preds = %polly.loop_header364, %middle.block1060
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  br i1 %exitcond890.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !81
...
polly.loop_exit382:                               ; preds = %polly.loop_header380
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar_next378, 1000
  br i1 %exitcond889.not, label %polly.loop_header390, label %polly.loop_header374
...
polly.loop_header380:                             ; preds = %polly.loop_header380, %polly.loop_header374
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next384, 1200
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv881 = phi i64 [ %indvars.iv.next882, %polly.loop_exit398 ], [ 36, %polly.loop_exit382 ]
  %indvars.iv879 = phi i64 [ %indvars.iv.next880, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  ...
  %134 = udiv i64 %indvars.iv881, 25
  %135 = sub nsw i64 %indvars.iv879, %134
  %smin883 = call i64 @llvm.smin.i64(i64 %135, i64 20)
  %136 = add nsw i64 %smin883, 3
  %smax884 = call i64 @llvm.smax.i64(i64 %136, i64 0)
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %indvars.iv.next882 = add nuw nsw i64 %indvars.iv881, 11
  %exitcond887.not = icmp eq i64 %polly.indvar_next394, 10
  br i1 %exitcond887.not, label %polly.exiting273, label %polly.loop_header390

polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  %indvars.iv875 = phi i64 [ %indvars.iv.next876, %polly.loop_exit405 ], [ 0, %polly.loop_header390 ]
  %polly.indvar399 = phi i64 [ %polly.indvar_next400, %polly.loop_exit405 ], [ 0, %polly.loop_header390 ]
  %smin877 = call i64 @llvm.smin.i64(i64 %indvars.iv875, i64 -920)
  %142 = mul nuw nsw i64 %polly.indvar399, 80
  %143 = add nsw i64 %smin877, 999
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit412
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %indvars.iv.next876 = add nsw i64 %indvars.iv875, -80
  %exitcond886.not = icmp eq i64 %polly.indvar_next400, 13
  br i1 %exitcond886.not, label %polly.loop_exit398, label %polly.loop_header396

polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  %indvars.iv869 = phi i64 [ %indvars.iv.next870, %polly.loop_exit412 ], [ %indvars.iv867, %polly.loop_header396 ]
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %148 = add i64 %smax866, %indvars.iv869
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %exitcond885.not = icmp eq i64 %polly.indvar406, %smax884
  br i1 %exitcond885.not, label %polly.loop_exit405, label %polly.loop_header403

polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv871 = phi i64 [ %148, %polly.loop_header410.preheader ], [ %indvars.iv.next872, %polly.loop_exit419 ]
  ...
  %polly.loop_guard427954 = icmp sgt i64 %150, -1
  %151 = add nuw nsw i64 %polly.indvar414, %141
  %152 = mul i64 %151, 8000
  %153 = mul i64 %151, 9600
  br i1 %polly.loop_guard427954, label %polly.loop_header417.us, label %polly.loop_exit419
...
polly.loop_header424.us:                          ; preds = %polly.loop_header417.us, %polly.loop_header424.us
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar428.us, %smin873
  br i1 %exitcond874.not, label %polly.loop_exit426.loopexit.us, label %polly.loop_header424.us

polly.loop_exit426.loopexit.us:                   ; preds = %polly.loop_header424.us
  %polly.indvar_next421.us = add nuw nsw i64 %polly.indvar420.us, 1
  %exitcond878.not = icmp eq i64 %polly.indvar420.us, %143
  br i1 %exitcond878.not, label %polly.loop_exit419, label %polly.loop_header417.us
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1039 = icmp ult i64 %162, 4
  br i1 %min.iters.check1039, label %polly.loop_header542.preheader, label %vector.ph1040

vector.ph1040:                                    ; preds = %polly.loop_header536
  %n.vec1042 = and i64 %162, -4
...
vector.body1038:                                  ; preds = %vector.body1038, %vector.ph1040
  ...
  %164 = shl nuw nsw i64 %index1043, 3
  %165 = getelementptr i8, i8* %scevgep548, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load1047 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !84, !noalias !86
  %167 = fmul fast <4 x double> %wide.load1047, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next1044, %n.vec1042
  br i1 %169, label %middle.block1036, label %vector.body1038, !llvm.loop !90

middle.block1036:                                 ; preds = %vector.body1038
  %cmp.n1046 = icmp eq i64 %162, %n.vec1042
  br i1 %cmp.n1046, label %polly.loop_exit544, label %polly.loop_header542.preheader

polly.loop_header542.preheader:                   ; preds = %polly.loop_header536, %middle.block1036
  %polly.indvar545.ph = phi i64 [ 0, %polly.loop_header536 ], [ %n.vec1042, %middle.block1036 ]
  br label %polly.loop_header542

polly.loop_exit544:                               ; preds = %polly.loop_header542, %middle.block1036
  %polly.indvar_next540 = add nuw nsw i64 %polly.indvar539, 1
  %exitcond921.not = icmp eq i64 %polly.indvar_next540, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond921.not, label %polly.loop_header552.preheader, label %polly.loop_header536
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  %exitcond920.not = icmp eq i64 %polly.indvar_next546, %polly.indvar539
  br i1 %exitcond920.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !91
...
polly.loop_exit560:                               ; preds = %polly.loop_header558
  ...
  %exitcond919.not = icmp eq i64 %polly.indvar_next556, 1000
  br i1 %exitcond919.not, label %polly.loop_header568, label %polly.loop_header552
...
polly.loop_header558:                             ; preds = %polly.loop_header558, %polly.loop_header552
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar_next562, 1200
  br i1 %exitcond918.not, label %polly.loop_exit560, label %polly.loop_header558

polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv911 = phi i64 [ %indvars.iv.next912, %polly.loop_exit576 ], [ 36, %polly.loop_exit560 ]
  %indvars.iv909 = phi i64 [ %indvars.iv.next910, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %indvars.iv897 = phi i64 [ %indvars.iv.next898, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %polly.indvar571 = phi i64 [ %polly.indvar_next572, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %171 = udiv i64 %indvars.iv911, 25
  %172 = sub nsw i64 %indvars.iv909, %171
  %smin913 = call i64 @llvm.smin.i64(i64 %172, i64 20)
  %173 = add nsw i64 %smin913, 3
  %smax914 = call i64 @llvm.smax.i64(i64 %173, i64 0)
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next910 = add nuw nsw i64 %indvars.iv909, 3
  %indvars.iv.next912 = add nuw nsw i64 %indvars.iv911, 11
  %exitcond917.not = icmp eq i64 %polly.indvar_next572, 10
  br i1 %exitcond917.not, label %polly.exiting451, label %polly.loop_header568

polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  %indvars.iv905 = phi i64 [ %indvars.iv.next906, %polly.loop_exit583 ], [ 0, %polly.loop_header568 ]
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar_next578, 13
  br i1 %exitcond916.not, label %polly.loop_exit576, label %polly.loop_header574

polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  %indvars.iv899 = phi i64 [ %indvars.iv.next900, %polly.loop_exit590 ], [ %indvars.iv897, %polly.loop_header574 ]
  %indvars.iv894 = phi i64 [ %indvars.iv.next895, %polly.loop_exit590 ], [ %indvars.iv892, %polly.loop_header574 ]
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  %smax896 = call i64 @llvm.smax.i64(i64 %indvars.iv894, i64 0)
  %185 = add i64 %smax896, %indvars.iv899
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %indvars.iv.next900 = add nsw i64 %indvars.iv899, -50
  %exitcond915.not = icmp eq i64 %polly.indvar584, %smax914
  br i1 %exitcond915.not, label %polly.loop_exit583, label %polly.loop_header581

polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv901 = phi i64 [ %185, %polly.loop_header588.preheader ], [ %indvars.iv.next902, %polly.loop_exit597 ]
  %polly.indvar592 = phi i64 [ %184, %polly.loop_header588.preheader ], [ %polly.indvar_next593, %polly.loop_exit597 ]
  %smin903 = call i64 @llvm.smin.i64(i64 %indvars.iv901, i64 49)
  %187 = add nsw i64 %polly.indvar592, %186
  %polly.loop_guard605955 = icmp sgt i64 %187, -1
  %188 = add nuw nsw i64 %polly.indvar592, %178
  %189 = mul i64 %188, 8000
  %190 = mul i64 %188, 9600
  br i1 %polly.loop_guard605955, label %polly.loop_header595.us, label %polly.loop_exit597
...
polly.loop_header602.us:                          ; preds = %polly.loop_header595.us, %polly.loop_header602.us
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar606.us, %smin903
  br i1 %exitcond904.not, label %polly.loop_exit604.loopexit.us, label %polly.loop_header602.us

polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  %polly.indvar_next599.us = add nuw nsw i64 %polly.indvar598.us, 1
  %exitcond908.not = icmp eq i64 %polly.indvar598.us, %180
  br i1 %exitcond908.not, label %polly.loop_exit597, label %polly.loop_header595.us
...
polly.loop_header752:                             ; preds = %entry, %polly.loop_exit760
  %indvars.iv946 = phi i64 [ %indvars.iv.next947, %polly.loop_exit760 ], [ 0, %entry ]
...
polly.loop_exit760:                               ; preds = %polly.loop_exit766
  ...
  %exitcond951.not = icmp eq i64 %polly.indvar_next756, 38
  br i1 %exitcond951.not, label %polly.loop_header779, label %polly.loop_header752

polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  %indvars.iv942 = phi i64 [ %indvars.iv.next943, %polly.loop_exit766 ], [ 0, %polly.loop_header752 ]
  %polly.indvar761 = phi i64 [ %polly.indvar_next762, %polly.loop_exit766 ], [ 0, %polly.loop_header752 ]
  %201 = mul nsw i64 %polly.indvar761, -32
  %smin977 = call i64 @llvm.smin.i64(i64 %201, i64 -1168)
  %202 = add nsw i64 %smin977, 1200
  %smin944 = call i64 @llvm.smin.i64(i64 %indvars.iv942, i64 -1168)
  %203 = shl nsw i64 %polly.indvar761, 5
  %204 = add nsw i64 %smin944, 1199
...
polly.loop_exit766:                               ; preds = %polly.loop_exit772
  ...
  %exitcond950.not = icmp eq i64 %polly.indvar_next762, 38
  br i1 %exitcond950.not, label %polly.loop_exit760, label %polly.loop_header758
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  br i1 %min.iters.check, label %polly.loop_header770, label %vector.ph978

vector.ph978:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert985 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat986 = shufflevector <4 x i64> %broadcast.splatinsert985, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert987 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body976:                                   ; preds = %vector.body976, %vector.ph978
  ...
  %208 = add nuw nsw <4 x i64> %vec.ind983, %broadcast.splat986
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat988, %209
  ...
  %220 = icmp eq i64 %index.next980, %202
  br i1 %220, label %polly.loop_exit772, label %vector.body976, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body976, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond949.not = icmp eq i64 %polly.indvar767, %200
  br i1 %exitcond949.not, label %polly.loop_exit766, label %polly.loop_header764
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond945.not = icmp eq i64 %polly.indvar773, %204
  br i1 %exitcond945.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !100

polly.loop_header779:                             ; preds = %polly.loop_exit760, %polly.loop_exit787
  %indvars.iv936 = phi i64 [ %indvars.iv.next937, %polly.loop_exit787 ], [ 0, %polly.loop_exit760 ]
...
polly.loop_exit787:                               ; preds = %polly.loop_exit793
  ...
  %exitcond941.not = icmp eq i64 %polly.indvar_next783, 38
  br i1 %exitcond941.not, label %polly.loop_header805, label %polly.loop_header779

polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  %indvars.iv932 = phi i64 [ %indvars.iv.next933, %polly.loop_exit793 ], [ 0, %polly.loop_header779 ]
  %polly.indvar788 = phi i64 [ %polly.indvar_next789, %polly.loop_exit793 ], [ 0, %polly.loop_header779 ]
  %230 = mul nsw i64 %polly.indvar788, -32
  %smin992 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin992, 1000
  %smin934 = call i64 @llvm.smin.i64(i64 %indvars.iv932, i64 -968)
  %232 = shl nsw i64 %polly.indvar788, 5
  %233 = add nsw i64 %smin934, 999
  br label %polly.loop_header791

polly.loop_exit793:                               ; preds = %polly.loop_exit799
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %indvars.iv.next933 = add nsw i64 %indvars.iv932, -32
  %exitcond940.not = icmp eq i64 %polly.indvar_next789, 32
  br i1 %exitcond940.not, label %polly.loop_exit787, label %polly.loop_header785
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %min.iters.check993 = icmp eq i64 %231, 0
  br i1 %min.iters.check993, label %polly.loop_header797, label %vector.ph994

vector.ph994:                                     ; preds = %polly.loop_header791
  %broadcast.splatinsert1003 = insertelement <4 x i64> poison, i64 %232, i32 0
  %broadcast.splat1004 = shufflevector <4 x i64> %broadcast.splatinsert1003, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1005 = insertelement <4 x i32> poison, i32 %235, i32 0
...
vector.body991:                                   ; preds = %vector.body991, %vector.ph994
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind1001, %broadcast.splat1004
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat1006, %238
  ...
  %249 = icmp eq i64 %index.next998, %231
  br i1 %249, label %polly.loop_exit799, label %vector.body991, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body991, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond939.not = icmp eq i64 %polly.indvar794, %229
  br i1 %exitcond939.not, label %polly.loop_exit793, label %polly.loop_header791
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond935.not = icmp eq i64 %polly.indvar800, %233
  br i1 %exitcond935.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !103

polly.loop_header805:                             ; preds = %polly.loop_exit787, %polly.loop_exit813
  %indvars.iv926 = phi i64 [ %indvars.iv.next927, %polly.loop_exit813 ], [ 0, %polly.loop_exit787 ]
  ...
  %258 = add nsw i64 %smin928, 1199
  br label %polly.loop_header811

polly.loop_exit813:                               ; preds = %polly.loop_exit819
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %indvars.iv.next927 = add nsw i64 %indvars.iv926, -32
  %exitcond931.not = icmp eq i64 %polly.indvar_next809, 38
  br i1 %exitcond931.not, label %init_array.exit, label %polly.loop_header805

polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  %indvars.iv922 = phi i64 [ %indvars.iv.next923, %polly.loop_exit819 ], [ 0, %polly.loop_header805 ]
  %polly.indvar814 = phi i64 [ %polly.indvar_next815, %polly.loop_exit819 ], [ 0, %polly.loop_header805 ]
  %259 = mul nsw i64 %polly.indvar814, -32
  %smin1010 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin1010, 1000
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 -968)
  %261 = shl nsw i64 %polly.indvar814, 5
  %262 = add nsw i64 %smin924, 999
  br label %polly.loop_header817

polly.loop_exit819:                               ; preds = %polly.loop_exit825
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %indvars.iv.next923 = add nsw i64 %indvars.iv922, -32
  %exitcond930.not = icmp eq i64 %polly.indvar_next815, 32
  br i1 %exitcond930.not, label %polly.loop_exit813, label %polly.loop_header811
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %min.iters.check1011 = icmp eq i64 %260, 0
  br i1 %min.iters.check1011, label %polly.loop_header823, label %vector.ph1012

vector.ph1012:                                    ; preds = %polly.loop_header817
  %broadcast.splatinsert1021 = insertelement <4 x i64> poison, i64 %261, i32 0
  %broadcast.splat1022 = shufflevector <4 x i64> %broadcast.splatinsert1021, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1023 = insertelement <4 x i32> poison, i32 %264, i32 0
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1012
  ...
  %266 = add nuw nsw <4 x i64> %vec.ind1019, %broadcast.splat1022
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat1024, %267
  ...
  %278 = icmp eq i64 %index.next1016, %260
  br i1 %278, label %polly.loop_exit825, label %vector.body1009, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body1009, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond929.not = icmp eq i64 %polly.indvar820, %258
  br i1 %exitcond929.not, label %polly.loop_exit819, label %polly.loop_header817
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond925.not = icmp eq i64 %polly.indvar826, %262
  br i1 %exitcond925.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !106
}
