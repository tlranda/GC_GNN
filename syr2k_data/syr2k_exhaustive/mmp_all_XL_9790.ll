; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9790.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9790.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %exitcond790 = icmp eq i64 %polly.indvar_next209, %98
  br i1 %exitcond790, label %polly.loop_exit207, label %polly.loop_header205
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %127 = mul nsw i64 %polly.indvar355, -20
  %128 = mul nuw nsw i64 %polly.indvar355, 20
...
polly.loop_header359:                             ; preds = %polly.loop_exit368, %polly.loop_header352
  ...
  %129 = shl nsw i64 %polly.indvar362, 4
  %130 = add nsw i64 %129, %127
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %polly.loop_guard369 = icmp slt i64 %132, 20
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375, %polly.loop_header359
  ...
  %exitcond810 = icmp eq i64 %polly.indvar_next363, %126
  br i1 %exitcond810, label %polly.loop_exit361, label %polly.loop_header359
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %155 = mul nsw i64 %polly.indvar511, -20
  %156 = mul nuw nsw i64 %polly.indvar511, 20
...
polly.loop_header515:                             ; preds = %polly.loop_exit524, %polly.loop_header508
  ...
  %157 = shl nsw i64 %polly.indvar518, 4
  %158 = add nsw i64 %157, %155
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard525 = icmp slt i64 %160, 20
...
polly.loop_exit524:                               ; preds = %polly.loop_exit531, %polly.loop_header515
  ...
  %exitcond830 = icmp eq i64 %polly.indvar_next519, %154
  br i1 %exitcond830, label %polly.loop_exit517, label %polly.loop_header515
