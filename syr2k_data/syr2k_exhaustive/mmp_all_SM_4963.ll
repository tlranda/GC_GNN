; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4963.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4963.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv988, i64 69)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next989 = add nuw nsw i64 %indvars.iv988, 6
...
vector.body1189:                                  ; preds = %vector.body1189, %vector.ph1193
  ...
  %wide.load1200 = load <4 x double>, <4 x double>* %138, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %141, label %middle.block1187, label %vector.body1189, !llvm.loop !80
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %umin1015 = call i64 @llvm.umin.i64(i64 %indvars.iv1013, i64 69)
  ...
  %148 = add nuw nsw i64 %umin1015, 5
...
vector.body1165:                                  ; preds = %vector.body1165, %vector.ph1167
  ...
  %wide.load1174 = load <4 x double>, <4 x double>* %184, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %187, label %middle.block1163, label %vector.body1165, !llvm.loop !90
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %umin1041 = call i64 @llvm.umin.i64(i64 %indvars.iv1039, i64 69)
  ...
  %194 = add nuw nsw i64 %umin1041, 5
...
polly.loop_exit581:                               ; preds = %polly.loop_exit587
  ...
  %indvars.iv.next1040 = add nuw nsw i64 %indvars.iv1039, 6
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %206 = shl nsw i64 %polly.indvar588, 4
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit630
  ...
  %smin1036 = call i64 @llvm.smin.i64(i64 %indvars.iv1031, i64 15)
...
vector.body1104:                                  ; preds = %vector.body1104, %vector.ph1105
  ...
  br i1 %247, label %polly.loop_exit805, label %vector.body1104, !llvm.loop !99
...
vector.body1118:                                  ; preds = %vector.body1118, %vector.ph1121
  ...
  br i1 %276, label %polly.loop_exit832, label %vector.body1118, !llvm.loop !102
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  br i1 %305, label %polly.loop_exit858, label %vector.body1136, !llvm.loop !105
