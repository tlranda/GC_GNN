; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2050.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2050.c"
...
polly.loop_header222:                             ; preds = %polly.loop_header222.preheader, %polly.loop_exit231
  ...
  %105 = shl nuw nsw i64 %polly.indvar225, 5
  %106 = add i64 %97, %105
  %smax1321 = call i64 @llvm.smax.i64(i64 %106, i64 0)
  %107 = mul nsw i64 %polly.indvar225, -32
  %108 = add i64 %98, %107
  %109 = add i64 %smax1321, %108
  %110 = shl nsw i64 %polly.indvar225, 5
  %111 = add nsw i64 %110, %103
  %112 = icmp sgt i64 %111, 0
  %113 = select i1 %112, i64 %111, i64 0
  %polly.loop_guard232 = icmp slt i64 %113, 50
...
polly.loop_header229:                             ; preds = %polly.loop_header229.preheader, %polly.loop_exit263
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %117, i64 31)
  %118 = add nsw i64 %smin1324, 1
  %smin1034 = call i64 @llvm.smin.i64(i64 %indvars.iv1030, i64 31)
...
polly.loop_header416:                             ; preds = %polly.loop_exit408, %polly.loop_exit426
  ...
  %153 = mul nsw i64 %polly.indvar419, -50
  %154 = mul nuw nsw i64 %polly.indvar419, 50
...
polly.loop_header424.preheader:                   ; preds = %polly.loop_header416
  %159 = mul nsw i64 %polly.indvar419, -50
  %160 = mul nuw nsw i64 %polly.indvar419, 50
...
polly.loop_header424:                             ; preds = %polly.loop_header424.preheader, %polly.loop_exit434
  ...
  %161 = shl nuw nsw i64 %polly.indvar428, 5
  %162 = add i64 %153, %161
  %smax1273 = call i64 @llvm.smax.i64(i64 %162, i64 0)
  %163 = mul nsw i64 %polly.indvar428, -32
  %164 = add i64 %154, %163
  %165 = add i64 %smax1273, %164
  %166 = shl nsw i64 %polly.indvar428, 5
  %167 = add nsw i64 %166, %159
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %polly.loop_guard435 = icmp slt i64 %169, 50
...
polly.loop_header432:                             ; preds = %polly.loop_header432.preheader, %polly.loop_exit470
  ...
  %smin1276 = call i64 @llvm.smin.i64(i64 %173, i64 31)
  %174 = add nsw i64 %smin1276, 1
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1052, i64 31)
...
polly.loop_header623:                             ; preds = %polly.loop_exit615, %polly.loop_exit633
  ...
  %209 = mul nsw i64 %polly.indvar626, -50
  %210 = mul nuw nsw i64 %polly.indvar626, 50
...
polly.loop_header631.preheader:                   ; preds = %polly.loop_header623
  %215 = mul nsw i64 %polly.indvar626, -50
  %216 = mul nuw nsw i64 %polly.indvar626, 50
...
polly.loop_header639:                             ; preds = %polly.loop_header639.preheader, %polly.loop_exit677
  ...
  %smin1228 = call i64 @llvm.smin.i64(i64 %229, i64 31)
  %230 = add nsw i64 %smin1228, 1
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 31)
