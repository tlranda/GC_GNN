; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5859.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5859.c"
...
vector.body1059:                                  ; preds = %vector.body1059, %vector.ph1061
  ...
  br i1 %57, label %middle.block1057, label %vector.body1059, !llvm.loop !59
...
vector.body1085:                                  ; preds = %vector.body1085, %vector.ph1087
  ...
  br i1 %68, label %middle.block1083, label %vector.body1085, !llvm.loop !61
...
vector.body1097:                                  ; preds = %vector.body1097, %vector.ph1101
  ...
  %wide.load1108 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !67, !noalias !69
  ...
  br i1 %95, label %middle.block1095, label %vector.body1097, !llvm.loop !73
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond874.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !74
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %indvars.iv.next857 = add nuw nsw i64 %indvars.iv856, 80
  %indvars.iv.next859 = add nuw nsw i64 %indvars.iv858, 2
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -80
  %exitcond872.not = icmp eq i64 %polly.indvar_next209, 15
...
polly.loop_header239:                             ; preds = %polly.loop_header233, %polly.loop_exit248
  ...
  %smin868 = call i64 @llvm.smin.i64(i64 %indvars.iv866, i64 79)
...
vector.body1071:                                  ; preds = %vector.body1071, %vector.ph1075
  ...
  %wide.load1082 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %138, label %middle.block1069, label %vector.body1071, !llvm.loop !84
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  br i1 %exitcond902.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !85
...
polly.loop_exit405:                               ; preds = %polly.loop_exit411
  ...
  %indvars.iv.next884 = add nuw nsw i64 %indvars.iv883, 80
  %indvars.iv.next886 = add nuw nsw i64 %indvars.iv885, 2
  %indvars.iv.next891 = add nsw i64 %indvars.iv890, -80
  %exitcond900.not = icmp eq i64 %polly.indvar_next384, 15
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  ...
  %smin896 = call i64 @llvm.smin.i64(i64 %indvars.iv894, i64 79)
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1049
  ...
  %wide.load1056 = load <4 x double>, <4 x double>* %178, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %181, label %middle.block1045, label %vector.body1047, !llvm.loop !94
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  br i1 %exitcond930.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !95
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %exitcond928.not = icmp eq i64 %polly.indvar_next562, 15
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  ...
  %smin924 = call i64 @llvm.smin.i64(i64 %indvars.iv922, i64 79)
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph987
  ...
  br i1 %238, label %polly.loop_exit772, label %vector.body986, !llvm.loop !103
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  br i1 %exitcond955.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !104
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  br i1 %267, label %polly.loop_exit799, label %vector.body1000, !llvm.loop !106
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  br i1 %exitcond945.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !107
...
vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1021
  ...
  br i1 %296, label %polly.loop_exit825, label %vector.body1018, !llvm.loop !109
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  br i1 %exitcond935.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !110
}
