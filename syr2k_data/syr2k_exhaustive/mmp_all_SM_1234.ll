; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1234.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1234.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %100 = shl nuw nsw i64 %polly.indvar209, 4
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1119.not = icmp eq i64 %127, 75
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %130 = mul nsw i64 %indvar1430, -128
  %131 = add i64 %102, %130
  %smax1432 = call i64 @llvm.smax.i64(i64 %131, i64 0)
  %132 = shl nuw nsw i64 %indvar1430, 7
  %133 = add i64 %104, %132
  %134 = add i64 %smax1432, %133
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1106, i64 0)
  %135 = add i64 %smax, %indvars.iv1110
  %136 = shl nsw i64 %polly.indvar231, 3
  %.not.not = icmp ugt i64 %136, %polly.indvar209
  %137 = shl nsw i64 %polly.indvar231, 7
  %138 = add nsw i64 %137, %109
  %139 = icmp sgt i64 %138, 0
  %140 = select i1 %139, i64 %138, i64 0
  %141 = add nsw i64 %138, 127
...
polly.loop_header270:                             ; preds = %polly.loop_header263, %polly.loop_exit280
  ...
  %155 = add i64 %134, %indvar1433
  %smin1435 = call i64 @llvm.smin.i64(i64 %155, i64 15)
  %156 = add nsw i64 %smin1435, 1
  %smin1114 = call i64 @llvm.smin.i64(i64 %indvars.iv1112, i64 15)
  %157 = add nsw i64 %polly.indvar274, %138
  %polly.loop_guard2811224 = icmp sgt i64 %157, -1
...
polly.loop_header278.preheader:                   ; preds = %polly.loop_header270
  ...
  %min.iters.check1436 = icmp ult i64 %156, 4
...
vector.body1429:                                  ; preds = %vector.body1429, %vector.ph1437
  ...
  %160 = add nuw nsw i64 %index1440, %110
  %161 = add nuw nsw i64 %index1440, %polly.access.mul.Packed_MemRef_call1285
  %162 = getelementptr double, double* %Packed_MemRef_call1, i64 %161
  %163 = bitcast double* %162 to <4 x double>*
  %wide.load1444 = load <4 x double>, <4 x double>* %163, align 8
  %164 = fmul fast <4 x double> %broadcast.splat1446, %wide.load1444
  %165 = getelementptr double, double* %Packed_MemRef_call2, i64 %161
  %166 = bitcast double* %165 to <4 x double>*
  %wide.load1447 = load <4 x double>, <4 x double>* %166, align 8
  %167 = fmul fast <4 x double> %broadcast.splat1449, %wide.load1447
  %168 = shl i64 %160, 3
  %169 = add i64 %168, %159
  %170 = getelementptr i8, i8* %call, i64 %169
  %171 = bitcast i8* %170 to <4 x double>*
  %wide.load1450 = load <4 x double>, <4 x double>* %171, align 8, !alias.scope !71, !noalias !73
  ...
  %174 = fadd fast <4 x double> %173, %wide.load1450
  %175 = bitcast i8* %170 to <4 x double>*
  store <4 x double> %174, <4 x double>* %175, align 8, !alias.scope !71, !noalias !73
  %index.next1441 = add i64 %index1440, 4
  %176 = icmp eq i64 %index.next1441, %n.vec1439
  br i1 %176, label %middle.block1427, label %vector.body1429, !llvm.loop !83

middle.block1427:                                 ; preds = %vector.body1429
  %cmp.n1443 = icmp eq i64 %156, %n.vec1439
...
vector.body1365:                                  ; preds = %vector.body1365, %vector.ph1369
  ...
  %182 = shl nuw nsw i64 %index1372, 3
  %183 = getelementptr i8, i8* %scevgep406, i64 %182
  %184 = bitcast i8* %183 to <4 x double>*
  %wide.load1376 = load <4 x double>, <4 x double>* %184, align 8, !alias.scope !85, !noalias !87
  %185 = fmul fast <4 x double> %wide.load1376, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %186 = bitcast i8* %183 to <4 x double>*
  store <4 x double> %185, <4 x double>* %186, align 8, !alias.scope !85, !noalias !87
  %index.next1373 = add i64 %index1372, 4
  %187 = icmp eq i64 %index.next1373, %n.vec1371
  br i1 %187, label %middle.block1363, label %vector.body1365, !llvm.loop !92

middle.block1363:                                 ; preds = %vector.body1365
  %cmp.n1375 = icmp eq i64 %180, %n.vec1371
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %189 = add nsw i64 %smin1148, 1000
  %190 = shl nsw i64 %polly.indvar413, 4
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %192 = shl nuw nsw i64 %polly.indvar419, 4
  %193 = and i64 %192, 9223372036854775680
  %194 = sub nsw i64 %191, %193
  %195 = mul nsw i64 %polly.indvar419, -16
  %196 = add i64 %195, %193
  %197 = lshr i64 %polly.indvar419, 3
  %198 = shl nuw nsw i64 %197, 7
  %199 = sub nsw i64 %indvars.iv1135, %198
  %200 = add i64 %indvars.iv1140, %198
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1136 = add nuw nsw i64 %indvars.iv1135, 16
  %indvars.iv.next1141 = add nsw i64 %indvars.iv1140, -16
  %exitcond1151.not = icmp eq i64 %219, 75
...
polly.loop_exit430:                               ; preds = %polly.loop_header428
  ...
  %exitcond1129.not = icmp eq i64 %polly.indvar_next426, %189
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %indvars.iv1142 = phi i64 [ %indvars.iv.next1143, %polly.loop_exit482 ], [ %200, %polly.loop_exit424 ]
  %indvars.iv1137 = phi i64 [ %indvars.iv.next1138, %polly.loop_exit482 ], [ %199, %polly.loop_exit424 ]
  %polly.indvar442 = phi i64 [ %polly.indvar_next443, %polly.loop_exit482 ], [ %197, %polly.loop_exit424 ]
  %222 = mul nsw i64 %indvar1380, -128
  %223 = add i64 %194, %222
  %smax1382 = call i64 @llvm.smax.i64(i64 %223, i64 0)
  %224 = shl nuw nsw i64 %indvar1380, 7
  %225 = add i64 %196, %224
  %226 = add i64 %smax1382, %225
  %smax1139 = call i64 @llvm.smax.i64(i64 %indvars.iv1137, i64 0)
  %227 = add i64 %smax1139, %indvars.iv1142
  %228 = shl nsw i64 %polly.indvar442, 3
  %.not.not944 = icmp ugt i64 %228, %polly.indvar419
  %229 = shl nsw i64 %polly.indvar442, 7
...
polly.loop_header445.us:                          ; preds = %polly.loop_header439, %polly.loop_exit468.us
  ...
  %polly.access.call1464.load.us.8 = load double, double* %polly.access.call1464.us.8, align 8, !alias.scope !88, !noalias !95
  ...
  %polly.access.call1464.load.us.9 = load double, double* %polly.access.call1464.us.9, align 8, !alias.scope !88, !noalias !95
  ...
  %polly.access.call1464.load.us.10 = load double, double* %polly.access.call1464.us.10, align 8, !alias.scope !88, !noalias !95
  ...
  %polly.access.call1464.load.us.11 = load double, double* %polly.access.call1464.us.11, align 8, !alias.scope !88, !noalias !95
  ...
  %polly.access.call1464.load.us.12 = load double, double* %polly.access.call1464.us.12, align 8, !alias.scope !88, !noalias !95
  ...
  %polly.access.call1464.load.us.13 = load double, double* %polly.access.call1464.us.13, align 8, !alias.scope !88, !noalias !95
  ...
  %polly.access.call1464.load.us.14 = load double, double* %polly.access.call1464.us.14, align 8, !alias.scope !88, !noalias !95
  ...
  %polly.access.call1464.load.us.15 = load double, double* %polly.access.call1464.us.15, align 8, !alias.scope !88, !noalias !95
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_header445.us
  ...
  %exitcond1134.not = icmp eq i64 %polly.indvar_next449.us, %189
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1131.not = icmp eq i64 %polly.indvar_next449, %189
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %242 = mul nsw i64 %polly.indvar442, -128
...
polly.loop_exit489:                               ; preds = %polly.loop_exit497
  ...
  %exitcond1149.not = icmp eq i64 %polly.indvar_next484, %189
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %indvars.iv1144 = phi i64 [ %227, %polly.loop_header480 ], [ %indvars.iv.next1145, %polly.loop_exit497 ]
  %polly.indvar491 = phi i64 [ %241, %polly.loop_header480 ], [ %polly.indvar_next492, %polly.loop_exit497 ]
  %247 = add i64 %226, %indvar1383
  %smin1385 = call i64 @llvm.smin.i64(i64 %247, i64 15)
  %248 = add nsw i64 %smin1385, 1
  %smin1146 = call i64 @llvm.smin.i64(i64 %indvars.iv1144, i64 15)
  %249 = add nsw i64 %polly.indvar491, %230
  %polly.loop_guard4981225 = icmp sgt i64 %249, -1
...
polly.loop_header495.preheader:                   ; preds = %polly.loop_header487
  ...
  %min.iters.check1386 = icmp ult i64 %248, 4
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1387
  ...
  %252 = add nuw nsw i64 %index1390, %202
  %253 = add nuw nsw i64 %index1390, %polly.access.mul.Packed_MemRef_call1309502
  %254 = getelementptr double, double* %Packed_MemRef_call1309, i64 %253
  %255 = bitcast double* %254 to <4 x double>*
  %wide.load1394 = load <4 x double>, <4 x double>* %255, align 8
  %256 = fmul fast <4 x double> %broadcast.splat1396, %wide.load1394
  %257 = getelementptr double, double* %Packed_MemRef_call2311, i64 %253
  %258 = bitcast double* %257 to <4 x double>*
  %wide.load1397 = load <4 x double>, <4 x double>* %258, align 8
  %259 = fmul fast <4 x double> %broadcast.splat1399, %wide.load1397
  %260 = shl i64 %252, 3
  %261 = add i64 %260, %251
  %262 = getelementptr i8, i8* %call, i64 %261
  %263 = bitcast i8* %262 to <4 x double>*
  %wide.load1400 = load <4 x double>, <4 x double>* %263, align 8, !alias.scope !85, !noalias !87
  ...
  %266 = fadd fast <4 x double> %265, %wide.load1400
  %267 = bitcast i8* %262 to <4 x double>*
  store <4 x double> %266, <4 x double>* %267, align 8, !alias.scope !85, !noalias !87
  %index.next1391 = add i64 %index1390, 4
  %268 = icmp eq i64 %index.next1391, %n.vec1389
  br i1 %268, label %middle.block1377, label %vector.body1379, !llvm.loop !96

middle.block1377:                                 ; preds = %vector.body1379
  %cmp.n1393 = icmp eq i64 %248, %n.vec1389
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1318 = icmp ult i64 %272, 4
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1319
  ...
  %274 = shl nuw nsw i64 %index1322, 3
  %275 = getelementptr i8, i8* %scevgep623, i64 %274
  %276 = bitcast i8* %275 to <4 x double>*
  %wide.load1326 = load <4 x double>, <4 x double>* %276, align 8, !alias.scope !98, !noalias !100
  %277 = fmul fast <4 x double> %wide.load1326, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %278 = bitcast i8* %275 to <4 x double>*
  store <4 x double> %277, <4 x double>* %278, align 8, !alias.scope !98, !noalias !100
  %index.next1323 = add i64 %index1322, 4
  %279 = icmp eq i64 %index.next1323, %n.vec1321
  br i1 %279, label %middle.block1315, label %vector.body1317, !llvm.loop !105

middle.block1315:                                 ; preds = %vector.body1317
  %cmp.n1325 = icmp eq i64 %272, %n.vec1321
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %281 = add nsw i64 %smin1180, 1000
  %282 = shl nsw i64 %polly.indvar630, 4
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %284 = shl nuw nsw i64 %polly.indvar636, 4
  %285 = and i64 %284, 9223372036854775680
  %286 = sub nsw i64 %283, %285
  %287 = mul nsw i64 %polly.indvar636, -16
  %288 = add i64 %287, %285
  %289 = lshr i64 %polly.indvar636, 3
  %290 = shl nuw nsw i64 %289, 7
  %291 = sub nsw i64 %indvars.iv1167, %290
  %292 = add i64 %indvars.iv1172, %290
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %indvars.iv.next1168 = add nuw nsw i64 %indvars.iv1167, 16
  %indvars.iv.next1173 = add nsw i64 %indvars.iv1172, -16
  %exitcond1183.not = icmp eq i64 %311, 75
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1161.not = icmp eq i64 %polly.indvar_next643, %281
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %indvars.iv1174 = phi i64 [ %indvars.iv.next1175, %polly.loop_exit699 ], [ %292, %polly.loop_exit641 ]
  %indvars.iv1169 = phi i64 [ %indvars.iv.next1170, %polly.loop_exit699 ], [ %291, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit699 ], [ %289, %polly.loop_exit641 ]
  %314 = mul nsw i64 %indvar1330, -128
  %315 = add i64 %286, %314
  %smax1332 = call i64 @llvm.smax.i64(i64 %315, i64 0)
  %316 = shl nuw nsw i64 %indvar1330, 7
  %317 = add i64 %288, %316
  %318 = add i64 %smax1332, %317
  %smax1171 = call i64 @llvm.smax.i64(i64 %indvars.iv1169, i64 0)
  %319 = add i64 %smax1171, %indvars.iv1174
  %320 = shl nsw i64 %polly.indvar659, 3
  %.not.not945 = icmp ugt i64 %320, %polly.indvar636
  %321 = shl nsw i64 %polly.indvar659, 7
  %322 = add nsw i64 %321, %293
  %323 = icmp sgt i64 %322, 0
  %324 = select i1 %323, i64 %322, i64 0
  %325 = add nsw i64 %322, 127
...
polly.loop_header662.us:                          ; preds = %polly.loop_header656, %polly.loop_exit685.us
  ...
  %polly.access.call1681.load.us.8 = load double, double* %polly.access.call1681.us.8, align 8, !alias.scope !101, !noalias !108
  ...
  %polly.access.call1681.load.us.9 = load double, double* %polly.access.call1681.us.9, align 8, !alias.scope !101, !noalias !108
  ...
  %polly.access.call1681.load.us.10 = load double, double* %polly.access.call1681.us.10, align 8, !alias.scope !101, !noalias !108
  ...
  %polly.access.call1681.load.us.11 = load double, double* %polly.access.call1681.us.11, align 8, !alias.scope !101, !noalias !108
  ...
  %polly.access.call1681.load.us.12 = load double, double* %polly.access.call1681.us.12, align 8, !alias.scope !101, !noalias !108
  ...
  %polly.access.call1681.load.us.13 = load double, double* %polly.access.call1681.us.13, align 8, !alias.scope !101, !noalias !108
  ...
  %polly.access.call1681.load.us.14 = load double, double* %polly.access.call1681.us.14, align 8, !alias.scope !101, !noalias !108
  ...
  %polly.access.call1681.load.us.15 = load double, double* %polly.access.call1681.us.15, align 8, !alias.scope !101, !noalias !108
...
polly.loop_exit685.us:                            ; preds = %polly.loop_header683.us, %polly.loop_header662.us
  ...
  %exitcond1166.not = icmp eq i64 %polly.indvar_next666.us, %281
...
polly.loop_exit685:                               ; preds = %polly.loop_header683
  ...
  %exitcond1163.not = icmp eq i64 %polly.indvar_next666, %281
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %334 = mul nsw i64 %polly.indvar659, -128
  %335 = icmp slt i64 %334, -1072
  %336 = select i1 %335, i64 %334, i64 -1072
...
polly.loop_exit706:                               ; preds = %polly.loop_exit714
  ...
  %exitcond1181.not = icmp eq i64 %polly.indvar_next701, %281
...
polly.loop_header704:                             ; preds = %polly.loop_header697, %polly.loop_exit714
  ...
  %indvars.iv1176 = phi i64 [ %319, %polly.loop_header697 ], [ %indvars.iv.next1177, %polly.loop_exit714 ]
  %polly.indvar708 = phi i64 [ %333, %polly.loop_header697 ], [ %polly.indvar_next709, %polly.loop_exit714 ]
  %339 = add i64 %318, %indvar1333
  %smin1335 = call i64 @llvm.smin.i64(i64 %339, i64 15)
  %340 = add nsw i64 %smin1335, 1
  %smin1178 = call i64 @llvm.smin.i64(i64 %indvars.iv1176, i64 15)
  %341 = add nsw i64 %polly.indvar708, %322
  %polly.loop_guard7151226 = icmp sgt i64 %341, -1
...
polly.loop_header712.preheader:                   ; preds = %polly.loop_header704
  ...
  %min.iters.check1336 = icmp ult i64 %340, 4
...
vector.body1329:                                  ; preds = %vector.body1329, %vector.ph1337
  ...
  %344 = add nuw nsw i64 %index1340, %294
  %345 = add nuw nsw i64 %index1340, %polly.access.mul.Packed_MemRef_call1526719
  %346 = getelementptr double, double* %Packed_MemRef_call1526, i64 %345
  %347 = bitcast double* %346 to <4 x double>*
  %wide.load1344 = load <4 x double>, <4 x double>* %347, align 8
  %348 = fmul fast <4 x double> %broadcast.splat1346, %wide.load1344
  %349 = getelementptr double, double* %Packed_MemRef_call2528, i64 %345
  %350 = bitcast double* %349 to <4 x double>*
  %wide.load1347 = load <4 x double>, <4 x double>* %350, align 8
  %351 = fmul fast <4 x double> %broadcast.splat1349, %wide.load1347
  %352 = shl i64 %344, 3
  %353 = add i64 %352, %343
  %354 = getelementptr i8, i8* %call, i64 %353
  %355 = bitcast i8* %354 to <4 x double>*
  %wide.load1350 = load <4 x double>, <4 x double>* %355, align 8, !alias.scope !98, !noalias !100
  ...
  %358 = fadd fast <4 x double> %357, %wide.load1350
  %359 = bitcast i8* %354 to <4 x double>*
  store <4 x double> %358, <4 x double>* %359, align 8, !alias.scope !98, !noalias !100
  %index.next1341 = add i64 %index1340, 4
  %360 = icmp eq i64 %index.next1341, %n.vec1339
  br i1 %360, label %middle.block1327, label %vector.body1329, !llvm.loop !109

middle.block1327:                                 ; preds = %vector.body1329
  %cmp.n1343 = icmp eq i64 %340, %n.vec1339
...
vector.ph1257:                                    ; preds = %polly.loop_header876
  %broadcast.splatinsert1264 = insertelement <4 x i64> poison, i64 %368, i32 0
  %broadcast.splat1265 = shufflevector <4 x i64> %broadcast.splatinsert1264, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1266 = insertelement <4 x i32> poison, i32 %371, i32 0
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1257
  ...
  %373 = add nuw nsw <4 x i64> %vec.ind1262, %broadcast.splat1265
  %374 = trunc <4 x i64> %373 to <4 x i32>
  %375 = mul <4 x i32> %broadcast.splat1267, %374
  ...
  store <4 x double> %379, <4 x double>* %384, align 8, !alias.scope !111, !noalias !113
  %index.next1259 = add i64 %index1258, 4
  %vec.ind.next1263 = add <4 x i64> %vec.ind1262, <i64 4, i64 4, i64 4, i64 4>
  %385 = icmp eq i64 %index.next1259, %367
  br i1 %385, label %polly.loop_exit884, label %vector.body1256, !llvm.loop !116

polly.loop_exit884:                               ; preds = %vector.body1256, %polly.loop_header882
  %polly.indvar_next880 = add nuw nsw i64 %polly.indvar879, 1
  %exitcond1214.not = icmp eq i64 %polly.indvar879, %365
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  %exitcond1210.not = icmp eq i64 %polly.indvar885, %369
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %smin1271 = call i64 @llvm.smin.i64(i64 %395, i64 -968)
  %396 = add nsw i64 %smin1271, 1000
  %smin1199 = call i64 @llvm.smin.i64(i64 %indvars.iv1197, i64 -968)
  %397 = shl nsw i64 %polly.indvar900, 5
  %398 = add nsw i64 %smin1199, 999
...
vector.body1270:                                  ; preds = %vector.body1270, %vector.ph1273
  ...
  %402 = add nuw nsw <4 x i64> %vec.ind1280, %broadcast.splat1283
  %403 = trunc <4 x i64> %402 to <4 x i32>
  %404 = mul <4 x i32> %broadcast.splat1285, %403
  ...
  store <4 x double> %408, <4 x double>* %413, align 8, !alias.scope !115, !noalias !118
  %index.next1277 = add i64 %index1276, 4
  %vec.ind.next1281 = add <4 x i64> %vec.ind1280, <i64 4, i64 4, i64 4, i64 4>
  %414 = icmp eq i64 %index.next1277, %396
  br i1 %414, label %polly.loop_exit911, label %vector.body1270, !llvm.loop !119

polly.loop_exit911:                               ; preds = %vector.body1270, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1204.not = icmp eq i64 %polly.indvar906, %394
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %exitcond1200.not = icmp eq i64 %polly.indvar912, %398
...
polly.loop_header923:                             ; preds = %polly.loop_exit931, %polly.loop_header917
  ...
  %smin1289 = call i64 @llvm.smin.i64(i64 %424, i64 -968)
  %425 = add nsw i64 %smin1289, 1000
  %smin1189 = call i64 @llvm.smin.i64(i64 %indvars.iv1187, i64 -968)
  %426 = shl nsw i64 %polly.indvar926, 5
  %427 = add nsw i64 %smin1189, 999
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1291
  ...
  %431 = add nuw nsw <4 x i64> %vec.ind1298, %broadcast.splat1301
  %432 = trunc <4 x i64> %431 to <4 x i32>
  %433 = mul <4 x i32> %broadcast.splat1303, %432
  ...
  store <4 x double> %437, <4 x double>* %442, align 8, !alias.scope !114, !noalias !121
  %index.next1295 = add i64 %index1294, 4
  %vec.ind.next1299 = add <4 x i64> %vec.ind1298, <i64 4, i64 4, i64 4, i64 4>
  %443 = icmp eq i64 %index.next1295, %425
  br i1 %443, label %polly.loop_exit937, label %vector.body1288, !llvm.loop !122

polly.loop_exit937:                               ; preds = %vector.body1288, %polly.loop_header935
  %polly.indvar_next933 = add nuw nsw i64 %polly.indvar932, 1
  %exitcond1194.not = icmp eq i64 %polly.indvar932, %423
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  %exitcond1190.not = icmp eq i64 %polly.indvar938, %427
