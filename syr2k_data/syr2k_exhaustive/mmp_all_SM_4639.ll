; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4639.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4639.c"
...
vector.body1172:                                  ; preds = %vector.body1172, %vector.ph1176
  ...
  %wide.load1183 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %125, label %middle.block1170, label %vector.body1172, !llvm.loop !80
...
vector.body1148:                                  ; preds = %vector.body1148, %vector.ph1150
  ...
  %wide.load1157 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %155, label %middle.block1146, label %vector.body1148, !llvm.loop !90
...
vector.body1087:                                  ; preds = %vector.body1087, %vector.ph1088
  ...
  br i1 %199, label %polly.loop_exit801, label %vector.body1087, !llvm.loop !99
...
vector.body1101:                                  ; preds = %vector.body1101, %vector.ph1104
  ...
  br i1 %228, label %polly.loop_exit828, label %vector.body1101, !llvm.loop !102
...
vector.body1119:                                  ; preds = %vector.body1119, %vector.ph1122
  ...
  br i1 %257, label %polly.loop_exit854, label %vector.body1119, !llvm.loop !105
