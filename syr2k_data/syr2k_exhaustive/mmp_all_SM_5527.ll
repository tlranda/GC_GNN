; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5527.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5527.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %111 = shl nsw i64 %polly.indvar230, 3
  %112 = sub nsw i64 %104, %111
  %113 = icmp sgt i64 %112, 0
  %114 = select i1 %113, i64 %112, i64 0
  %polly.loop_guard = icmp slt i64 %114, 8
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header227
  ...
  %polly.loop_cond232 = icmp ult i64 %polly.indvar230, 149
  %indvars.iv.next861 = add i64 %indvars.iv860, -8
  %indvars.iv.next865 = add i64 %indvars.iv864, 8
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %138 = lshr i64 %polly.indvar383, 2
...
polly.loop_exit388:                               ; preds = %polly.loop_exit394
  ...
  %145 = mul nuw nsw i64 %polly.indvar383, 6
...
polly.loop_exit405:                               ; preds = %polly.loop_exit411
  ...
  %indvars.iv.next886 = add nuw nsw i64 %indvars.iv885, 6
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418.loopexit.us, %polly.loop_header403
  ...
  %polly.loop_cond408 = icmp ult i64 %polly.indvar406, 149
  %indvars.iv.next888 = add i64 %indvars.iv887, -8
  %indvars.iv.next893 = add i64 %indvars.iv892, 8
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %177 = lshr i64 %polly.indvar561, 2
...
polly.loop_exit566:                               ; preds = %polly.loop_exit572
  ...
  %184 = mul nuw nsw i64 %polly.indvar561, 6
...
polly.loop_exit583:                               ; preds = %polly.loop_exit589
  ...
  %indvars.iv.next914 = add nuw nsw i64 %indvars.iv913, 6
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  ...
  %189 = shl nsw i64 %polly.indvar584, 3
  %190 = sub nsw i64 %182, %189
  %191 = icmp sgt i64 %190, 0
  %192 = select i1 %191, i64 %190, i64 0
  %polly.loop_guard597 = icmp slt i64 %192, 8
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header581
  ...
  %polly.loop_cond586 = icmp ult i64 %polly.indvar584, 149
  %indvars.iv.next916 = add i64 %indvars.iv915, -8
  %indvars.iv.next921 = add i64 %indvars.iv920, 8
