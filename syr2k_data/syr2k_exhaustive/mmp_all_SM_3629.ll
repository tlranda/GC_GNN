; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3629.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3629.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %indvars.iv = phi i64 [ 80, %polly.loop_header199.preheader ], [ %indvars.iv.next, %polly.loop_exit207 ]
  %polly.indvar202 = phi i64 [ 0, %polly.loop_header199.preheader ], [ %polly.indvar_next203, %polly.loop_exit207 ]
  %97 = mul nuw nsw i64 %polly.indvar202, 3
...
polly.loop_exit207:                               ; preds = %polly.loop_exit263
  ...
  %indvars.iv.next954 = add nuw nsw i64 %indvars.iv953, 16
  %indvars.iv.next958 = add nsw i64 %indvars.iv957, -16
...
polly.loop_exit263:                               ; preds = %polly.loop_exit269
  ...
  %indvars.iv.next948 = add nuw nsw i64 %indvars.iv947, 80
  %indvars.iv.next956 = add nsw i64 %indvars.iv955, -80
  %indvars.iv.next960 = add nsw i64 %indvars.iv959, 80
  %exitcond965.not = icmp eq i64 %polly.indvar_next209, 15
...
polly.loop_preheader262.loopexit:                 ; preds = %polly.loop_exit250
  %.pre1067 = mul nuw nsw i64 %polly.indvar208, 80
...
polly.loop_exit276:                               ; preds = %polly.loop_header274, %polly.loop_header267
  ...
  %polly.loop_cond272 = icmp ult i64 %polly.indvar270, 79
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit412
  ...
  %indvars.iv971 = phi i64 [ 80, %polly.loop_header404.preheader ], [ %indvars.iv.next972, %polly.loop_exit412 ]
  %polly.indvar407 = phi i64 [ 0, %polly.loop_header404.preheader ], [ %polly.indvar_next408, %polly.loop_exit412 ]
  %134 = mul nuw nsw i64 %polly.indvar407, 3
  %135 = shl nsw i64 %polly.indvar407, 4
  %136 = or i64 %135, 1
...
polly.loop_header410:                             ; preds = %polly.loop_exit474, %polly.loop_header404
  ...
  %140 = mul nuw nsw i64 %polly.indvar413, 5
...
polly.loop_header420.preheader:                   ; preds = %polly.loop_header410
  %141 = mul nuw nsw i64 %polly.indvar413, 80
...
polly.loop_exit474:                               ; preds = %polly.loop_exit480
  ...
  %indvars.iv.next987 = add nsw i64 %indvars.iv986, 80
  %exitcond993.not = icmp eq i64 %polly.indvar_next414, 15
...
polly.loop_preheader473.loopexit:                 ; preds = %polly.loop_exit461
  %.pre1065 = mul nuw nsw i64 %polly.indvar413, 80
...
polly.loop_exit487:                               ; preds = %polly.loop_header485, %polly.loop_header478
  ...
  %polly.loop_cond483 = icmp ult i64 %polly.indvar481, 79
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit623
  ...
  %indvars.iv999 = phi i64 [ 80, %polly.loop_header615.preheader ], [ %indvars.iv.next1000, %polly.loop_exit623 ]
  %polly.indvar618 = phi i64 [ 0, %polly.loop_header615.preheader ], [ %polly.indvar_next619, %polly.loop_exit623 ]
  %171 = mul nuw nsw i64 %polly.indvar618, 3
  %172 = shl nsw i64 %polly.indvar618, 4
  %173 = or i64 %172, 1
...
polly.loop_header621:                             ; preds = %polly.loop_exit685, %polly.loop_header615
  ...
  %177 = mul nuw nsw i64 %polly.indvar624, 5
...
polly.loop_header631.preheader:                   ; preds = %polly.loop_header621
  %178 = mul nuw nsw i64 %polly.indvar624, 80
...
polly.loop_exit685:                               ; preds = %polly.loop_exit691
  ...
  %exitcond1021.not = icmp eq i64 %polly.indvar_next625, 15
...
polly.loop_preheader684.loopexit:                 ; preds = %polly.loop_exit672
  %.pre = mul nuw nsw i64 %polly.indvar624, 80
...
polly.loop_exit698:                               ; preds = %polly.loop_header696, %polly.loop_header689
  ...
  %polly.loop_cond694 = icmp ult i64 %polly.indvar692, 79
