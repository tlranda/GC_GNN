; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2903.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2903.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit244
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next203, 5
...
polly.loop_header205:                             ; preds = %polly.loop_exit244, %polly.loop_header199
  ...
  %.inv = icmp ugt i64 %101, 255
  %103 = select i1 %.inv, i64 255, i64 %102
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %158 = shl nuw nsw i64 %polly.indvar386, 5
  %159 = mul nsw i64 %polly.indvar386, -256
  %160 = shl nsw i64 %polly.indvar386, 8
  br label %polly.loop_header389

polly.loop_exit391:                               ; preds = %polly.loop_exit430
  %polly.indvar_next387 = add nuw nsw i64 %polly.indvar386, 1
  %exitcond903.not = icmp eq i64 %polly.indvar_next387, 5
...
polly.loop_header389:                             ; preds = %polly.loop_exit430, %polly.loop_header383
  ...
  %.inv857 = icmp ugt i64 %162, 255
  %164 = select i1 %.inv857, i64 255, i64 %163
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %219 = shl nuw nsw i64 %polly.indvar572, 5
  %220 = mul nsw i64 %polly.indvar572, -256
  %221 = shl nsw i64 %polly.indvar572, 8
...
polly.loop_exit577:                               ; preds = %polly.loop_exit616
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar_next573, 5
...
polly.loop_header575:                             ; preds = %polly.loop_exit616, %polly.loop_header569
  ...
  %.inv858 = icmp ugt i64 %223, 255
  %225 = select i1 %.inv858, i64 255, i64 %224
