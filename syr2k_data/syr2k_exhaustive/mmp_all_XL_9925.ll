; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9925.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9925.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond787.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225
  ...
  %indvars.iv.next778 = add nsw i64 %indvars.iv777, -50
...
polly.loop_header217:                             ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv779, i64 49)
...
polly.loop_exit360:                               ; preds = %polly.loop_exit366
  ...
  %indvars.iv.next791 = add nuw nsw i64 %indvars.iv790, 50
  %indvars.iv.next801 = add nuw nsw i64 %indvars.iv800, 1
  %exitcond804.not = icmp eq i64 %polly.indvar_next356, 24
...
polly.loop_header370:                             ; preds = %polly.loop_exit378, %polly.loop_header364
  ...
  %smin796 = call i64 @llvm.smin.i64(i64 %indvars.iv794, i64 49)
...
polly.loop_exit378:                               ; preds = %polly.loop_header383.us.3, %polly.loop_header370
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next374, 50
...
polly.loop_exit515:                               ; preds = %polly.loop_exit521
  ...
  %indvars.iv.next808 = add nuw nsw i64 %indvars.iv807, 50
  %indvars.iv.next818 = add nuw nsw i64 %indvars.iv817, 1
  %exitcond821.not = icmp eq i64 %polly.indvar_next511, 24
...
polly.loop_exit533:                               ; preds = %polly.loop_header538.us.3, %polly.loop_header525
  ...
  %exitcond816.not = icmp eq i64 %polly.indvar_next529, 50
