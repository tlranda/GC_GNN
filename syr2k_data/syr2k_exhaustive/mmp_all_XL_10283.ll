; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10283.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10283.c"
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %134, label %middle.block990, label %vector.body992, !llvm.loop !73
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %141 = add nuw nsw i64 %umin815, 23
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %149 = shl nsw i64 %polly.indvar369, 2
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %wide.load977 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %173, label %middle.block966, label %vector.body968, !llvm.loop !82
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %180 = add nuw nsw i64 %umin837, 23
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %188 = shl nsw i64 %polly.indvar526, 2
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  br i1 %226, label %polly.loop_exit712, label %vector.body906, !llvm.loop !91
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  br i1 %255, label %polly.loop_exit739, label %vector.body921, !llvm.loop !94
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  br i1 %284, label %polly.loop_exit765, label %vector.body939, !llvm.loop !97
