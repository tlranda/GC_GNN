; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3651.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3651.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %122 = add i64 %smax, %indvars.iv1016
...
polly.loop_header223.us:                          ; preds = %polly.loop_header211, %polly.loop_header223.us
  ...
  %exitcond1008.not = icmp eq i64 %polly.indvar226.us, %126
...
polly.loop_header255:                             ; preds = %polly.loop_header248, %polly.loop_exit265
  %indvars.iv1018 = phi i64 [ %122, %polly.loop_header248 ], [ %indvars.iv.next1019, %polly.loop_exit265 ]
  ...
  %polly.loop_guard2661109 = icmp sgt i64 %144, -1
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_header255
  %145 = add nsw i64 %polly.indvar259, %123
...
vector.ph1231:                                    ; preds = %polly.loop_header375
  %n.vec1233 = and i64 %154, -4
  br label %vector.body1227

vector.body1227:                                  ; preds = %vector.body1227, %vector.ph1231
  %index1234 = phi i64 [ 0, %vector.ph1231 ], [ %index.next1235, %vector.body1227 ]
  %156 = shl nuw nsw i64 %index1234, 3
  %157 = getelementptr i8, i8* %scevgep387, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load1238 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !79, !noalias !81
  %159 = fmul fast <4 x double> %wide.load1238, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next1235, %n.vec1233
  br i1 %161, label %middle.block1225, label %vector.body1227, !llvm.loop !85

middle.block1225:                                 ; preds = %vector.body1227
  %cmp.n1237 = icmp eq i64 %154, %n.vec1233
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %178 = udiv i64 %indvars.iv1031, 3
  %179 = mul nuw nsw i64 %178, 96
  %180 = add i64 %indvars.iv1029, %179
  %181 = sub nsw i64 %indvars.iv1036, %179
  %182 = mul nuw nsw i64 %polly.indvar400, 3
  %183 = trunc i64 %polly.indvar400 to i8
  %pexp.p_div_q403.lhs.trunc = add i8 %183, 2
  %pexp.p_div_q403886 = udiv i8 %pexp.p_div_q403.lhs.trunc, 3
  %pexp.p_div_q403.zext = zext i8 %pexp.p_div_q403886 to i64
  %184 = sub nsw i64 %182, %pexp.p_div_q403.zext
  %185 = mul nsw i64 %polly.indvar400, -256
  %186 = shl nsw i64 %polly.indvar400, 8
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039, %polly.loop_exit445 ], [ %181, %polly.loop_header397 ]
  %indvars.iv1033 = phi i64 [ %indvars.iv.next1034, %polly.loop_exit445 ], [ %180, %polly.loop_header397 ]
  ...
  %188 = add i64 %smax1035, %indvars.iv1038
  %189 = mul nsw i64 %polly.indvar407, 96
  %190 = add nsw i64 %189, %185
  %191 = add nsw i64 %190, -1
  %.inv883 = icmp sgt i64 %190, 255
  %192 = select i1 %.inv883, i64 255, i64 %191
...
polly.loop_header417.us:                          ; preds = %polly.loop_header404, %polly.loop_header417.us
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar421.us, %192
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_header429.7, %polly.loop_header429.us.7, %polly.loop_exit419.loopexit.us.7, %polly.loop_header404.split
  ...
  %203 = mul nsw i64 %polly.indvar407, -96
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1040 = phi i64 [ %188, %polly.loop_header443 ], [ %indvars.iv.next1041, %polly.loop_exit460 ]
  ...
  %polly.loop_guard4611110 = icmp sgt i64 %210, -1
...
polly.loop_header458.preheader:                   ; preds = %polly.loop_header450
  %211 = add nsw i64 %polly.indvar454, %189
...
polly.loop_header570:                             ; preds = %polly.loop_exit578, %polly.start484
  ...
  %min.iters.check1204 = icmp ult i64 %220, 4
...
vector.body1203:                                  ; preds = %vector.body1203, %vector.ph1205
  ...
  %222 = shl nuw nsw i64 %index1208, 3
  %223 = getelementptr i8, i8* %scevgep582, i64 %222
  %224 = bitcast i8* %223 to <4 x double>*
  %wide.load1212 = load <4 x double>, <4 x double>* %224, align 8, !alias.scope !89, !noalias !91
  %225 = fmul fast <4 x double> %wide.load1212, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %227 = icmp eq i64 %index.next1209, %n.vec1207
  br i1 %227, label %middle.block1201, label %vector.body1203, !llvm.loop !95

middle.block1201:                                 ; preds = %vector.body1203
  %cmp.n1211 = icmp eq i64 %220, %n.vec1207
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %244 = udiv i64 %indvars.iv1054, 3
  %245 = mul nuw nsw i64 %244, 96
  %246 = add i64 %indvars.iv1052, %245
  %247 = sub nsw i64 %indvars.iv1059, %245
  %248 = mul nuw nsw i64 %polly.indvar595, 3
  %249 = trunc i64 %polly.indvar595 to i8
  %pexp.p_div_q598.lhs.trunc = add i8 %249, 2
  %pexp.p_div_q598885 = udiv i8 %pexp.p_div_q598.lhs.trunc, 3
  %pexp.p_div_q598.zext = zext i8 %pexp.p_div_q598885 to i64
  %250 = sub nsw i64 %248, %pexp.p_div_q598.zext
  %251 = mul nsw i64 %polly.indvar595, -256
  %252 = shl nsw i64 %polly.indvar595, 8
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  %indvars.iv1061 = phi i64 [ %indvars.iv.next1062, %polly.loop_exit640 ], [ %247, %polly.loop_header592 ]
  %indvars.iv1056 = phi i64 [ %indvars.iv.next1057, %polly.loop_exit640 ], [ %246, %polly.loop_header592 ]
  ...
  %254 = add i64 %smax1058, %indvars.iv1061
  %255 = mul nsw i64 %polly.indvar602, 96
  %256 = add nsw i64 %255, %251
  %257 = add nsw i64 %256, -1
  %.inv884 = icmp sgt i64 %256, 255
  %258 = select i1 %.inv884, i64 255, i64 %257
...
polly.loop_header612.us:                          ; preds = %polly.loop_header599, %polly.loop_header612.us
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar616.us, %258
...
polly.loop_header645:                             ; preds = %polly.loop_header638, %polly.loop_exit655
  %indvars.iv1063 = phi i64 [ %254, %polly.loop_header638 ], [ %indvars.iv.next1064, %polly.loop_exit655 ]
  ...
  %polly.loop_guard6561111 = icmp sgt i64 %276, -1
...
polly.loop_header653.preheader:                   ; preds = %polly.loop_header645
  %277 = add nsw i64 %polly.indvar649, %255
...
polly.loop_header809:                             ; preds = %polly.loop_exit817, %polly.loop_header803
  ...
  %smin1142 = call i64 @llvm.smin.i64(i64 %288, i64 -1168)
  %289 = add nsw i64 %smin1142, 1200
  %smin1094 = call i64 @llvm.smin.i64(i64 %indvars.iv1092, i64 -1168)
  %290 = shl nsw i64 %polly.indvar812, 5
  %291 = add nsw i64 %smin1094, 1199
...
vector.ph1143:                                    ; preds = %polly.loop_header815
  %broadcast.splatinsert1150 = insertelement <4 x i64> poison, i64 %290, i32 0
  %broadcast.splat1151 = shufflevector <4 x i64> %broadcast.splatinsert1150, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1152 = insertelement <4 x i32> poison, i32 %293, i32 0
...
vector.body1141:                                  ; preds = %vector.body1141, %vector.ph1143
  ...
  %295 = add nuw nsw <4 x i64> %vec.ind1148, %broadcast.splat1151
  %296 = trunc <4 x i64> %295 to <4 x i32>
  %297 = mul <4 x i32> %broadcast.splat1153, %296
  ...
  %307 = icmp eq i64 %index.next1145, %289
  br i1 %307, label %polly.loop_exit823, label %vector.body1141, !llvm.loop !104

polly.loop_exit823:                               ; preds = %vector.body1141, %polly.loop_header821
  %polly.indvar_next819 = add nuw nsw i64 %polly.indvar818, 1
  %exitcond1099.not = icmp eq i64 %polly.indvar818, %287
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  %exitcond1095.not = icmp eq i64 %polly.indvar824, %291
...
polly.loop_header836:                             ; preds = %polly.loop_exit844, %polly.loop_header830
  ...
  %smin1157 = call i64 @llvm.smin.i64(i64 %317, i64 -968)
  %318 = add nsw i64 %smin1157, 1000
  %smin1084 = call i64 @llvm.smin.i64(i64 %indvars.iv1082, i64 -968)
  %319 = shl nsw i64 %polly.indvar839, 5
  %320 = add nsw i64 %smin1084, 999
...
vector.body1156:                                  ; preds = %vector.body1156, %vector.ph1159
  ...
  %324 = add nuw nsw <4 x i64> %vec.ind1166, %broadcast.splat1169
  %325 = trunc <4 x i64> %324 to <4 x i32>
  %326 = mul <4 x i32> %broadcast.splat1171, %325
  ...
  %336 = icmp eq i64 %index.next1163, %318
  br i1 %336, label %polly.loop_exit850, label %vector.body1156, !llvm.loop !107

polly.loop_exit850:                               ; preds = %vector.body1156, %polly.loop_header848
  %polly.indvar_next846 = add nuw nsw i64 %polly.indvar845, 1
  %exitcond1089.not = icmp eq i64 %polly.indvar845, %316
...
polly.loop_header848:                             ; preds = %polly.loop_header842, %polly.loop_header848
  ...
  %exitcond1085.not = icmp eq i64 %polly.indvar851, %320
...
polly.loop_header862:                             ; preds = %polly.loop_exit870, %polly.loop_header856
  ...
  %smin1175 = call i64 @llvm.smin.i64(i64 %346, i64 -968)
  %347 = add nsw i64 %smin1175, 1000
  %smin1074 = call i64 @llvm.smin.i64(i64 %indvars.iv1072, i64 -968)
  %348 = shl nsw i64 %polly.indvar865, 5
  %349 = add nsw i64 %smin1074, 999
...
vector.body1174:                                  ; preds = %vector.body1174, %vector.ph1177
  ...
  %353 = add nuw nsw <4 x i64> %vec.ind1184, %broadcast.splat1187
  %354 = trunc <4 x i64> %353 to <4 x i32>
  %355 = mul <4 x i32> %broadcast.splat1189, %354
  ...
  %365 = icmp eq i64 %index.next1181, %347
  br i1 %365, label %polly.loop_exit876, label %vector.body1174, !llvm.loop !110

polly.loop_exit876:                               ; preds = %vector.body1174, %polly.loop_header874
  %polly.indvar_next872 = add nuw nsw i64 %polly.indvar871, 1
  %exitcond1079.not = icmp eq i64 %polly.indvar871, %345
...
polly.loop_header874:                             ; preds = %polly.loop_header868, %polly.loop_header874
  ...
  %exitcond1075.not = icmp eq i64 %polly.indvar877, %349
...
polly.loop_header223.us.1:                        ; preds = %polly.loop_header223.us.1.preheader, %polly.loop_header223.us.1
  ...
  %exitcond1008.1.not = icmp eq i64 %polly.indvar226.us.1, %126
...
polly.loop_header223.us.2:                        ; preds = %polly.loop_header223.us.2.preheader, %polly.loop_header223.us.2
  ...
  %exitcond1008.2.not = icmp eq i64 %polly.indvar226.us.2, %126
...
polly.loop_header223.us.3:                        ; preds = %polly.loop_header223.us.3.preheader, %polly.loop_header223.us.3
  ...
  %exitcond1008.3.not = icmp eq i64 %polly.indvar226.us.3, %126
...
polly.loop_header223.us.4:                        ; preds = %polly.loop_header223.us.4.preheader, %polly.loop_header223.us.4
  ...
  %exitcond1008.4.not = icmp eq i64 %polly.indvar226.us.4, %126
...
polly.loop_header223.us.5:                        ; preds = %polly.loop_header223.us.5.preheader, %polly.loop_header223.us.5
  ...
  %exitcond1008.5.not = icmp eq i64 %polly.indvar226.us.5, %126
...
polly.loop_header223.us.6:                        ; preds = %polly.loop_header223.us.6.preheader, %polly.loop_header223.us.6
  ...
  %exitcond1008.6.not = icmp eq i64 %polly.indvar226.us.6, %126
...
polly.loop_header223.us.7:                        ; preds = %polly.loop_header223.us.7.preheader, %polly.loop_header223.us.7
  ...
  %exitcond1008.7.not = icmp eq i64 %polly.indvar226.us.7, %126
...
polly.loop_header417.us.1:                        ; preds = %polly.loop_header417.us.1.preheader, %polly.loop_header417.us.1
  ...
  %exitcond1027.1.not = icmp eq i64 %polly.indvar421.us.1, %192
...
polly.loop_header417.us.2:                        ; preds = %polly.loop_header417.us.2.preheader, %polly.loop_header417.us.2
  ...
  %exitcond1027.2.not = icmp eq i64 %polly.indvar421.us.2, %192
...
polly.loop_header417.us.3:                        ; preds = %polly.loop_header417.us.3.preheader, %polly.loop_header417.us.3
  ...
  %exitcond1027.3.not = icmp eq i64 %polly.indvar421.us.3, %192
...
polly.loop_header417.us.4:                        ; preds = %polly.loop_header417.us.4.preheader, %polly.loop_header417.us.4
  ...
  %exitcond1027.4.not = icmp eq i64 %polly.indvar421.us.4, %192
...
polly.loop_header417.us.5:                        ; preds = %polly.loop_header417.us.5.preheader, %polly.loop_header417.us.5
  ...
  %exitcond1027.5.not = icmp eq i64 %polly.indvar421.us.5, %192
...
polly.loop_header417.us.6:                        ; preds = %polly.loop_header417.us.6.preheader, %polly.loop_header417.us.6
  ...
  %exitcond1027.6.not = icmp eq i64 %polly.indvar421.us.6, %192
...
polly.loop_header417.us.7:                        ; preds = %polly.loop_header417.us.7.preheader, %polly.loop_header417.us.7
  ...
  %exitcond1027.7.not = icmp eq i64 %polly.indvar421.us.7, %192
...
polly.loop_header612.us.1:                        ; preds = %polly.loop_header612.us.1.preheader, %polly.loop_header612.us.1
  ...
  %exitcond1050.1.not = icmp eq i64 %polly.indvar616.us.1, %258
...
polly.loop_header612.us.2:                        ; preds = %polly.loop_header612.us.2.preheader, %polly.loop_header612.us.2
  ...
  %exitcond1050.2.not = icmp eq i64 %polly.indvar616.us.2, %258
...
polly.loop_header612.us.3:                        ; preds = %polly.loop_header612.us.3.preheader, %polly.loop_header612.us.3
  ...
  %exitcond1050.3.not = icmp eq i64 %polly.indvar616.us.3, %258
...
polly.loop_header612.us.4:                        ; preds = %polly.loop_header612.us.4.preheader, %polly.loop_header612.us.4
  ...
  %exitcond1050.4.not = icmp eq i64 %polly.indvar616.us.4, %258
...
polly.loop_header612.us.5:                        ; preds = %polly.loop_header612.us.5.preheader, %polly.loop_header612.us.5
  ...
  %exitcond1050.5.not = icmp eq i64 %polly.indvar616.us.5, %258
...
polly.loop_header612.us.6:                        ; preds = %polly.loop_header612.us.6.preheader, %polly.loop_header612.us.6
  ...
  %exitcond1050.6.not = icmp eq i64 %polly.indvar616.us.6, %258
...
polly.loop_header612.us.7:                        ; preds = %polly.loop_header612.us.7.preheader, %polly.loop_header612.us.7
  ...
  %exitcond1050.7.not = icmp eq i64 %polly.indvar616.us.7, %258
