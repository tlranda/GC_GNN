; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2655.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2655.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1029 = phi i64 [ %indvars.iv.next1030, %polly.loop_exit224 ], [ 3, %polly.loop_exit208 ]
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv1029, i64 37)
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %116, i64 31)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  %indvars.iv1055 = phi i64 [ %indvars.iv.next1056, %polly.loop_exit422 ], [ 3, %polly.loop_exit406 ]
  ...
  %umin1057 = call i64 @llvm.umin.i64(i64 %indvars.iv1055, i64 37)
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %171, i64 31)
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  %indvars.iv1082 = phi i64 [ %indvars.iv.next1083, %polly.loop_exit626 ], [ 3, %polly.loop_exit610 ]
  ...
  %umin1084 = call i64 @llvm.umin.i64(i64 %indvars.iv1082, i64 37)
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %indvars.iv.next1083 = add nuw nsw i64 %indvars.iv1082, 4
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %226, i64 31)
  %227 = add nsw i64 %smin1231, 1
  %smin1079 = call i64 @llvm.smin.i64(i64 %indvars.iv1074, i64 31)
