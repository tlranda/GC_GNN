; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6178.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6178.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit219.3, %polly.loop_exit241.3
  ...
  %107 = mul nuw nsw i64 %polly.indvar230, 80
...
polly.loop_header239:                             ; preds = %polly.loop_exit247, %polly.loop_header227
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv841, i64 79)
...
polly.loop_exit247:                               ; preds = %polly.loop_header245
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar_next243, 80
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %135 = mul nuw nsw i64 %polly.indvar381, 80
...
polly.loop_header400:                             ; preds = %polly.loop_exit392.3, %polly.loop_exit414.3
  ...
  %137 = mul nuw nsw i64 %polly.indvar403, 80
...
polly.loop_header412:                             ; preds = %polly.loop_exit420, %polly.loop_header400
  ...
  %smin859 = call i64 @llvm.smin.i64(i64 %indvars.iv857, i64 79)
...
polly.loop_exit420:                               ; preds = %polly.loop_header418
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar_next416, 80
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %165 = mul nuw nsw i64 %polly.indvar554, 80
...
polly.loop_header573:                             ; preds = %polly.loop_exit565.3, %polly.loop_exit587.3
  ...
  %167 = mul nuw nsw i64 %polly.indvar576, 80
...
polly.loop_header585:                             ; preds = %polly.loop_exit593, %polly.loop_header573
  ...
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv874, i64 79)
...
polly.loop_exit593:                               ; preds = %polly.loop_header591
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar_next589, 80
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  %268 = mul nsw i64 %polly.indvar208, -80
...
polly.loop_header239.1:                           ; preds = %polly.loop_exit247, %polly.loop_exit247.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv841.1, i64 79)
...
polly.loop_exit247.1:                             ; preds = %polly.loop_header245.1
  ...
  %exitcond844.1.not = icmp eq i64 %polly.indvar_next243.1, 80
...
polly.loop_header239.2:                           ; preds = %polly.loop_exit247.1, %polly.loop_exit247.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv841.2, i64 79)
...
polly.loop_exit247.2:                             ; preds = %polly.loop_header245.2
  ...
  %exitcond844.2.not = icmp eq i64 %polly.indvar_next243.2, 80
...
polly.loop_header239.3:                           ; preds = %polly.loop_exit247.2, %polly.loop_exit247.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv841.3, i64 79)
...
polly.loop_exit247.3:                             ; preds = %polly.loop_header245.3
  ...
  %exitcond844.3.not = icmp eq i64 %polly.indvar_next243.3, 80
...
polly.loop_exit241.3:                             ; preds = %polly.loop_exit247.3
  ...
  %indvars.iv.next840 = add nuw nsw i64 %indvars.iv839, 80
  %exitcond846.not = icmp eq i64 %polly.indvar_next231, 15
...
polly.loop_exit392.3:                             ; preds = %polly.loop_header390.3
  %302 = mul nsw i64 %polly.indvar381, -80
...
polly.loop_header412.1:                           ; preds = %polly.loop_exit420, %polly.loop_exit420.1
  ...
  %smin859.1 = call i64 @llvm.smin.i64(i64 %indvars.iv857.1, i64 79)
...
polly.loop_exit420.1:                             ; preds = %polly.loop_header418.1
  ...
  %exitcond861.1.not = icmp eq i64 %polly.indvar_next416.1, 80
...
polly.loop_header412.2:                           ; preds = %polly.loop_exit420.1, %polly.loop_exit420.2
  ...
  %smin859.2 = call i64 @llvm.smin.i64(i64 %indvars.iv857.2, i64 79)
...
polly.loop_exit420.2:                             ; preds = %polly.loop_header418.2
  ...
  %exitcond861.2.not = icmp eq i64 %polly.indvar_next416.2, 80
...
polly.loop_header412.3:                           ; preds = %polly.loop_exit420.2, %polly.loop_exit420.3
  ...
  %smin859.3 = call i64 @llvm.smin.i64(i64 %indvars.iv857.3, i64 79)
...
polly.loop_exit420.3:                             ; preds = %polly.loop_header418.3
  ...
  %exitcond861.3.not = icmp eq i64 %polly.indvar_next416.3, 80
...
polly.loop_exit414.3:                             ; preds = %polly.loop_exit420.3
  ...
  %exitcond863.not = icmp eq i64 %polly.indvar_next404, 15
...
polly.loop_exit565.3:                             ; preds = %polly.loop_header563.3
  %336 = mul nsw i64 %polly.indvar554, -80
...
polly.loop_header585.1:                           ; preds = %polly.loop_exit593, %polly.loop_exit593.1
  ...
  %smin876.1 = call i64 @llvm.smin.i64(i64 %indvars.iv874.1, i64 79)
...
polly.loop_exit593.1:                             ; preds = %polly.loop_header591.1
  ...
  %exitcond878.1.not = icmp eq i64 %polly.indvar_next589.1, 80
...
polly.loop_header585.2:                           ; preds = %polly.loop_exit593.1, %polly.loop_exit593.2
  ...
  %smin876.2 = call i64 @llvm.smin.i64(i64 %indvars.iv874.2, i64 79)
...
polly.loop_exit593.2:                             ; preds = %polly.loop_header591.2
  ...
  %exitcond878.2.not = icmp eq i64 %polly.indvar_next589.2, 80
...
polly.loop_header585.3:                           ; preds = %polly.loop_exit593.2, %polly.loop_exit593.3
  ...
  %smin876.3 = call i64 @llvm.smin.i64(i64 %indvars.iv874.3, i64 79)
...
polly.loop_exit593.3:                             ; preds = %polly.loop_header591.3
  ...
  %exitcond878.3.not = icmp eq i64 %polly.indvar_next589.3, 80
...
polly.loop_exit587.3:                             ; preds = %polly.loop_exit593.3
  ...
  %indvars.iv.next873 = add nuw nsw i64 %indvars.iv872, 80
  %exitcond880.not = icmp eq i64 %polly.indvar_next577, 15
