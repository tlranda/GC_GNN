; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3565.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3565.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %98 = udiv i64 %polly.indvar208, 10
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1028.not = icmp eq i64 %111, 150
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %113 = mul nuw nsw i64 %polly.indvar214, 10
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %polly.loop_guard256 = icmp slt i64 %124, 80
...
polly.loop_header253.us:                          ; preds = %polly.loop_header246.us, %polly.loop_exit263.us
  %indvars.iv1024 = phi i64 [ %112, %polly.loop_header246.us ], [ %indvars.iv.next1025, %polly.loop_exit263.us ]
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %147 = mul nuw nsw i64 %polly.indvar392, 50
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %148 = udiv i64 %polly.indvar398, 10
  %149 = mul nuw nsw i64 %148, 80
  %150 = sub nsw i64 %indvars.iv1035, %149
  %151 = add i64 %indvars.iv1040, %149
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1049.not = icmp eq i64 %161, 150
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit445 ], [ %151, %polly.loop_header395 ]
  %indvars.iv1037 = phi i64 [ %indvars.iv.next1038, %polly.loop_exit445 ], [ %150, %polly.loop_header395 ]
  ...
  %162 = add i64 %smax1039, %indvars.iv1042
  %163 = mul nuw nsw i64 %polly.indvar405, 10
  %.not.not885 = icmp ugt i64 %163, %polly.indvar398
  %164 = mul nuw nsw i64 %polly.indvar405, 80
  %165 = add nsw i64 %164, %153
  %166 = icmp sgt i64 %165, 0
  %167 = select i1 %166, i64 %165, i64 0
  %168 = add nsw i64 %165, 79
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %polly.loop_guard453 = icmp slt i64 %174, 80
...
polly.loop_header450.us:                          ; preds = %polly.loop_header443.us, %polly.loop_exit460.us
  %indvars.iv1044 = phi i64 [ %162, %polly.loop_header443.us ], [ %indvars.iv.next1045, %polly.loop_exit460.us ]
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %197 = mul nuw nsw i64 %polly.indvar589, 50
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %198 = udiv i64 %polly.indvar595, 10
  %199 = mul nuw nsw i64 %198, 80
  %200 = sub nsw i64 %indvars.iv1056, %199
  %201 = add i64 %indvars.iv1061, %199
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1063 = phi i64 [ %indvars.iv.next1064, %polly.loop_exit642 ], [ %201, %polly.loop_header592 ]
  %indvars.iv1058 = phi i64 [ %indvars.iv.next1059, %polly.loop_exit642 ], [ %200, %polly.loop_header592 ]
  ...
  %212 = add i64 %smax1060, %indvars.iv1063
  %213 = mul nuw nsw i64 %polly.indvar602, 10
  %.not.not886 = icmp ugt i64 %213, %polly.indvar595
  %214 = mul nuw nsw i64 %polly.indvar602, 80
  %215 = add nsw i64 %214, %203
  %216 = icmp sgt i64 %215, 0
  %217 = select i1 %216, i64 %215, i64 0
  %218 = add nsw i64 %215, 79
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %polly.loop_guard650 = icmp slt i64 %224, 80
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.us, %polly.loop_exit657.us
  %indvars.iv1065 = phi i64 [ %212, %polly.loop_header640.us ], [ %indvars.iv.next1066, %polly.loop_exit657.us ]
