; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6160.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6160.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %109 = mul nsw i64 %polly.indvar224, -64
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %indvars.iv.next839 = add i64 %indvars.iv838, -64
  %indvars.iv.next843 = add i64 %indvars.iv842, 64
  %exitcond848.not = icmp eq i64 %polly.indvar_next225, 19
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  ...
  %139 = shl nsw i64 %polly.indvar396, 6
  %140 = sub nsw i64 %135, %139
  %141 = icmp sgt i64 %140, 0
  %142 = select i1 %141, i64 %140, i64 0
  %143 = mul nsw i64 %polly.indvar396, -64
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408, %polly.loop_header393
  ...
  %indvars.iv.next864 = add i64 %indvars.iv863, 64
  %exitcond870.not = icmp eq i64 %polly.indvar_next397, 19
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  ...
  %173 = shl nsw i64 %polly.indvar570, 6
  %174 = sub nsw i64 %169, %173
  %175 = icmp sgt i64 %174, 0
  %176 = select i1 %175, i64 %174, i64 0
  %177 = mul nsw i64 %polly.indvar570, -64
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582, %polly.loop_header567
  ...
  %indvars.iv.next881 = add i64 %indvars.iv880, -64
  %indvars.iv.next886 = add i64 %indvars.iv885, 64
  %exitcond892.not = icmp eq i64 %polly.indvar_next571, 19
