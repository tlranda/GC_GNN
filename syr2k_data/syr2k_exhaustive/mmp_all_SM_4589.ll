; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4589.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4589.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv976, i64 74)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next966 = add nuw nsw i64 %indvars.iv965, 32
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit387
  %indvars.iv1000 = phi i64 [ 1, %polly.loop_header379.preheader ], [ %indvars.iv.next1001, %polly.loop_exit387 ]
  ...
  %umin1002 = call i64 @llvm.umin.i64(i64 %indvars.iv1000, i64 74)
  %128 = mul nsw i64 %polly.indvar382, -32
  %129 = icmp slt i64 %128, -1168
  %130 = select i1 %129, i64 %128, i64 -1168
  %131 = add nsw i64 %130, 1199
  %132 = shl nsw i64 %polly.indvar382, 5
...
polly.loop_exit387:                               ; preds = %polly.loop_exit394
  ...
  %exitcond1004.not = icmp eq i64 %polly.indvar_next383, 38
...
polly.loop_header565:                             ; preds = %polly.loop_header565.preheader, %polly.loop_exit573
  %indvars.iv1025 = phi i64 [ 1, %polly.loop_header565.preheader ], [ %indvars.iv.next1026, %polly.loop_exit573 ]
  ...
  %umin1027 = call i64 @llvm.umin.i64(i64 %indvars.iv1025, i64 74)
  %159 = mul nsw i64 %polly.indvar568, -32
...
polly.loop_exit573:                               ; preds = %polly.loop_exit580
  ...
  %exitcond1029.not = icmp eq i64 %polly.indvar_next569, 38
...
polly.loop_header571:                             ; preds = %polly.loop_exit580, %polly.loop_header565
  ...
  %164 = shl nsw i64 %polly.indvar574, 4
