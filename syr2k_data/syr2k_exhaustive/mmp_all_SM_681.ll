; ModuleID = 'syr2k_exhaustive/mmp_all_SM_681.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_681.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1061 = call i64 @llvm.smin.i64(i64 %indvars.iv1033, i64 -936)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next204, 16
...
polly.start325:                                   ; preds = %kernel_syr2k.exit
  ...
  %malloccall329 = tail call dereferenceable_or_null(614400) i8* @malloc(i64 614400) #6
...
polly.loop_header429:                             ; preds = %polly.loop_header429.preheader, %polly.loop_exit437
  ...
  %smin1101 = call i64 @llvm.smin.i64(i64 %indvars.iv1071, i64 -936)
  %164 = add nsw i64 %smin1101, 1000
  %165 = shl nsw i64 %polly.indvar432, 6
...
polly.loop_exit437:                               ; preds = %polly.loop_exit459
  ...
  %exitcond1105.not = icmp eq i64 %polly.indvar_next433, 16
...
polly.start560:                                   ; preds = %init_array.exit
  %malloccall562 = tail call dereferenceable_or_null(614400) i8* @malloc(i64 614400) #6
  %malloccall564 = tail call dereferenceable_or_null(614400) i8* @malloc(i64 614400) #6
...
polly.loop_header664:                             ; preds = %polly.loop_header664.preheader, %polly.loop_exit672
  ...
  %smin1141 = call i64 @llvm.smin.i64(i64 %indvars.iv1111, i64 -936)
  %231 = add nsw i64 %smin1141, 1000
  %232 = shl nsw i64 %polly.indvar667, 6
...
polly.loop_exit672:                               ; preds = %polly.loop_exit694
  ...
  %indvars.iv.next1112 = add nsw i64 %indvars.iv1111, -64
  %exitcond1145.not = icmp eq i64 %polly.indvar_next668, 16
