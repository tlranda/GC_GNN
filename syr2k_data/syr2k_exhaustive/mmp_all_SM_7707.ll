; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7707.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7707.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %104 = mul nuw nsw i64 %polly.indvar224, 80
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %106 = mul nsw i64 %polly.indvar230, 80
...
vector.body1048:                                  ; preds = %vector.body1048, %vector.ph1052
  ...
  %wide.load1059 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %131, label %middle.block1046, label %vector.body1048, !llvm.loop !79
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %139 = select i1 %.inv832, i64 %.op938, i64 15
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  ...
  %140 = mul nuw nsw i64 %polly.indvar399, 80
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %142 = mul nsw i64 %polly.indvar406, 80
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %indvars.iv.next866 = add i64 %indvars.iv865, -80
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1026
  ...
  %wide.load1033 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %167, label %middle.block1022, label %vector.body1024, !llvm.loop !89
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %175 = select i1 %.inv833, i64 %.op940, i64 15
...
polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  ...
  %176 = mul nuw nsw i64 %polly.indvar577, 80
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %178 = mul nsw i64 %polly.indvar584, 80
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph964
  ...
  br i1 %217, label %polly.loop_exit772, label %vector.body962, !llvm.loop !98
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph980
  ...
  br i1 %246, label %polly.loop_exit799, label %vector.body977, !llvm.loop !101
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %275, label %polly.loop_exit825, label %vector.body995, !llvm.loop !104
