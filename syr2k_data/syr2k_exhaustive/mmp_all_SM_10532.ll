; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10532.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10532.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond801.not = icmp eq i64 %polly.indvar_next209, 250
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %112 = mul nuw nsw i64 %polly.indvar214, 50
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233889 = icmp sgt i64 %118, -1
  %119 = add nuw nsw i64 %polly.indvar220, %104
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1008
  ...
  %wide.load1015 = load <4 x double>, <4 x double>* %133, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %136, label %middle.block1002, label %vector.body1004, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %138 = udiv i64 %indvars.iv821, 25
  %139 = sub nsw i64 %indvars.iv819, %138
  %smin823 = call i64 @llvm.smin.i64(i64 %139, i64 20)
  %140 = add nsw i64 %smin823, 3
  %smax824 = call i64 @llvm.smax.i64(i64 %140, i64 0)
  %141 = mul nsw i64 %polly.indvar357, -128
  %142 = icmp slt i64 %141, -1072
  %143 = select i1 %142, i64 %141, i64 -1072
  %144 = add nsw i64 %143, 1199
  %145 = shl nsw i64 %polly.indvar357, 7
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond826.not = icmp eq i64 %polly.indvar_next364, 250
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %153 = mul nuw nsw i64 %polly.indvar370, 50
  %154 = add nsw i64 %153, %141
  %155 = icmp sgt i64 %154, 0
  %156 = select i1 %155, i64 %154, i64 0
  %polly.loop_guard377.not = icmp sgt i64 %156, %144
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv814 = phi i64 [ %157, %polly.loop_header374.preheader ], [ %indvars.iv.next815, %polly.loop_exit383 ]
  ...
  %polly.loop_guard391890 = icmp sgt i64 %159, -1
  %160 = add nuw nsw i64 %polly.indvar378, %145
...
polly.loop_exit383:                               ; preds = %polly.loop_header388.us.3, %polly.loop_header374
  ...
  %polly.loop_cond380.not.not = icmp ult i64 %polly.indvar378, %144
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  %wide.load989 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %177, label %middle.block978, label %vector.body980, !llvm.loop !83
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %179 = udiv i64 %indvars.iv846, 25
  %180 = sub nsw i64 %indvars.iv844, %179
  %smin848 = call i64 @llvm.smin.i64(i64 %180, i64 20)
  %181 = add nsw i64 %smin848, 3
  %smax849 = call i64 @llvm.smax.i64(i64 %181, i64 0)
  %182 = mul nsw i64 %polly.indvar515, -128
  %183 = icmp slt i64 %182, -1072
  %184 = select i1 %183, i64 %182, i64 -1072
  %185 = add nsw i64 %184, 1199
  %186 = shl nsw i64 %polly.indvar515, 7
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next522, 250
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %194 = mul nuw nsw i64 %polly.indvar528, 50
  %195 = add nsw i64 %194, %182
  %196 = icmp sgt i64 %195, 0
  %197 = select i1 %196, i64 %195, i64 0
  %polly.loop_guard535.not = icmp sgt i64 %197, %185
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %198 = add i64 %smax834, %indvars.iv837
  %199 = sub nsw i64 %186, %194
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv839 = phi i64 [ %198, %polly.loop_header532.preheader ], [ %indvars.iv.next840, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549891 = icmp sgt i64 %200, -1
  %201 = add nuw nsw i64 %polly.indvar536, %186
...
polly.loop_exit541:                               ; preds = %polly.loop_header546.us.3, %polly.loop_header532
  ...
  %polly.loop_cond538.not.not = icmp ult i64 %polly.indvar536, %185
...
vector.body918:                                   ; preds = %vector.body918, %vector.ph920
  ...
  br i1 %232, label %polly.loop_exit714, label %vector.body918, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body918, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond882.not = icmp eq i64 %polly.indvar709, %212
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar715, %216
...
vector.body933:                                   ; preds = %vector.body933, %vector.ph936
  ...
  br i1 %261, label %polly.loop_exit741, label %vector.body933, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body933, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond872.not = icmp eq i64 %polly.indvar736, %241
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar742, %245
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  br i1 %290, label %polly.loop_exit767, label %vector.body951, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body951, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond862.not = icmp eq i64 %polly.indvar762, %270
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar768, %274
...
polly.loop_header388.us.3:                        ; preds = %polly.loop_header388.us.3, %polly.loop_exit390.loopexit.us.2
  ...
  br i1 %exitcond817.3.not, label %polly.loop_exit383, label %polly.loop_header388.us.3
...
polly.loop_header546.us.3:                        ; preds = %polly.loop_header546.us.3, %polly.loop_exit548.loopexit.us.2
  ...
  br i1 %exitcond842.3.not, label %polly.loop_exit541, label %polly.loop_header546.us.3
}
