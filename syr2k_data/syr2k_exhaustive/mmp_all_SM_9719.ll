; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9719.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9719.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv815 = phi i64 [ %indvars.iv.next816, %polly.loop_exit362 ], [ 4, %polly.loop_exit346 ]
  ...
  %128 = lshr i64 %indvars.iv815, 4
  %129 = mul nsw i64 %polly.indvar357, -20
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %indvars.iv.next816 = add nuw nsw i64 %indvars.iv815, 5
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %132 = shl nsw i64 %polly.indvar370, 6
  %133 = add nsw i64 %132, %129
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard377 = icmp slt i64 %135, 20
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv836 = phi i64 [ %indvars.iv.next837, %polly.loop_exit520 ], [ 4, %polly.loop_exit504 ]
  ...
  %159 = lshr i64 %indvars.iv836, 4
  %160 = mul nsw i64 %polly.indvar515, -20
  %161 = mul nuw nsw i64 %polly.indvar515, 20
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next837 = add nuw nsw i64 %indvars.iv836, 5
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %163 = shl nsw i64 %polly.indvar528, 6
  %164 = add nsw i64 %163, %160
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard535 = icmp slt i64 %166, 20
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  ...
  %smin833 = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 63)
