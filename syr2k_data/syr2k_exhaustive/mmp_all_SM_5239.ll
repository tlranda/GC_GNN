; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5239.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5239.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond997.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !69
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond995.not = icmp eq i64 %polly.indvar_next209, 50
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1201
  ...
  %130 = shl nuw nsw i64 %index1204, 3
  %131 = getelementptr i8, i8* %scevgep379, i64 %130
  %132 = bitcast i8* %131 to <4 x double>*
  %wide.load1208 = load <4 x double>, <4 x double>* %132, align 8, !alias.scope !73, !noalias !75
  %133 = fmul fast <4 x double> %wide.load1208, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %135 = icmp eq i64 %index.next1205, %n.vec1203
  br i1 %135, label %middle.block1195, label %vector.body1197, !llvm.loop !79

middle.block1195:                                 ; preds = %vector.body1197
  %cmp.n1207 = icmp eq i64 %128, %n.vec1203
...
polly.loop_header373:                             ; preds = %polly.loop_header373.preheader, %polly.loop_header373
  ...
  br i1 %exitcond1025.not, label %polly.loop_exit375, label %polly.loop_header373, !llvm.loop !80
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next393, 50
...
polly.merge429.us:                                ; preds = %polly.then430.us, %polly.cond428.loopexit.us
  ...
  %exitcond1013.not = icmp eq i64 %polly.indvar_next414.us, 20
...
polly.loop_exit448.loopexit.us:                   ; preds = %polly.loop_header446.us
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar_next443.us, 20
...
polly.loop_header558:                             ; preds = %polly.loop_exit566, %polly.start472
  ...
  %min.iters.check1174 = icmp ult i64 %168, 4
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1175
  ...
  %170 = shl nuw nsw i64 %index1178, 3
  %171 = getelementptr i8, i8* %scevgep570, i64 %170
  %172 = bitcast i8* %171 to <4 x double>*
  %wide.load1182 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !83, !noalias !85
  %173 = fmul fast <4 x double> %wide.load1182, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %175 = icmp eq i64 %index.next1179, %n.vec1177
  br i1 %175, label %middle.block1171, label %vector.body1173, !llvm.loop !89

middle.block1171:                                 ; preds = %vector.body1173
  %cmp.n1181 = icmp eq i64 %168, %n.vec1177
...
polly.loop_header564:                             ; preds = %polly.loop_header564.preheader, %polly.loop_header564
  ...
  br i1 %exitcond1053.not, label %polly.loop_exit566, label %polly.loop_header564, !llvm.loop !90
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar_next584, 50
...
polly.merge620.us:                                ; preds = %polly.then621.us, %polly.cond619.loopexit.us
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next605.us, 20
...
polly.loop_exit639.loopexit.us:                   ; preds = %polly.loop_header637.us
  ...
  %exitcond1044.not = icmp eq i64 %polly.indvar_next634.us, 20
...
vector.ph1113:                                    ; preds = %polly.loop_header799
  %broadcast.splatinsert1120 = insertelement <4 x i64> poison, i64 %212, i32 0
  %broadcast.splat1121 = shufflevector <4 x i64> %broadcast.splatinsert1120, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1122 = insertelement <4 x i32> poison, i32 %215, i32 0
...
vector.body1112:                                  ; preds = %vector.body1112, %vector.ph1113
  ...
  %217 = add nuw nsw <4 x i64> %vec.ind1118, %broadcast.splat1121
  %218 = trunc <4 x i64> %217 to <4 x i32>
  %219 = mul <4 x i32> %broadcast.splat1123, %218
  ...
  %229 = icmp eq i64 %index.next1115, %211
  br i1 %229, label %polly.loop_exit807, label %vector.body1112, !llvm.loop !98
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  br i1 %exitcond1078.not, label %polly.loop_exit807, label %polly.loop_header805, !llvm.loop !99
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %smin1127 = call i64 @llvm.smin.i64(i64 %239, i64 -968)
  %240 = add nsw i64 %smin1127, 1000
...
vector.body1126:                                  ; preds = %vector.body1126, %vector.ph1129
  ...
  %246 = add nuw nsw <4 x i64> %vec.ind1136, %broadcast.splat1139
  ...
  %258 = icmp eq i64 %index.next1133, %240
  br i1 %258, label %polly.loop_exit834, label %vector.body1126, !llvm.loop !101
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  br i1 %exitcond1068.not, label %polly.loop_exit834, label %polly.loop_header832, !llvm.loop !102
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %smin1145 = call i64 @llvm.smin.i64(i64 %268, i64 -968)
  %269 = add nsw i64 %smin1145, 1000
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1147
  ...
  %275 = add nuw nsw <4 x i64> %vec.ind1154, %broadcast.splat1157
  %276 = trunc <4 x i64> %275 to <4 x i32>
  %277 = mul <4 x i32> %broadcast.splat1159, %276
  ...
  %287 = icmp eq i64 %index.next1151, %269
  br i1 %287, label %polly.loop_exit860, label %vector.body1144, !llvm.loop !104
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  br i1 %exitcond1058.not, label %polly.loop_exit860, label %polly.loop_header858, !llvm.loop !105
}
...
!47 = !{!"llvm.loop.tile.size", i32 128}
