; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3989.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3989.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %97 = shl nuw nsw i64 %indvars.iv1001, 4
...
polly.loop_exit207:                               ; preds = %polly.loop_exit246, %polly.loop_header199
  ...
  %indvars.iv.next1006 = add nuw nsw i64 %indvars.iv1005, 48
  %exitcond1013.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header251:                             ; preds = %polly.loop_exit261, %polly.loop_header244
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1009, i64 79)
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit399
  ...
  %145 = shl nuw nsw i64 %indvars.iv1021, 4
...
polly.loop_header397.preheader:                   ; preds = %polly.loop_header389
  ...
  %152 = mul nsw i64 %polly.indvar392, -80
  %153 = mul nuw nsw i64 %polly.indvar392, 80
...
polly.loop_exit399:                               ; preds = %polly.loop_exit439, %polly.loop_header389
  ...
  %indvars.iv.next1020 = add nsw i64 %indvars.iv1019, -48
  %indvars.iv.next1022 = add nuw nsw i64 %indvars.iv1021, 3
  %indvars.iv.next1027 = add nuw nsw i64 %indvars.iv1026, 48
  %exitcond1035.not = icmp eq i64 %polly.indvar_next393, 15
...
polly.loop_header397:                             ; preds = %polly.loop_header397.preheader, %polly.loop_exit439
  ...
  %.inv877 = icmp sgt i64 %157, 79
  %159 = select i1 %.inv877, i64 79, i64 %158
...
polly.loop_header444:                             ; preds = %polly.loop_exit454, %polly.loop_header437
  ...
  %smin1032 = call i64 @llvm.smin.i64(i64 %indvars.iv1030, i64 79)
...
polly.loop_header582:                             ; preds = %polly.loop_header582.preheader, %polly.loop_exit592
  ...
  %193 = shl nuw nsw i64 %indvars.iv1043, 4
...
polly.loop_header590.preheader:                   ; preds = %polly.loop_header582
  ...
  %200 = mul nsw i64 %polly.indvar585, -80
  %201 = mul nuw nsw i64 %polly.indvar585, 80
...
polly.loop_exit592:                               ; preds = %polly.loop_exit632, %polly.loop_header582
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next586, 15
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit632
  ...
  %.inv878 = icmp sgt i64 %205, 79
  %207 = select i1 %.inv878, i64 79, i64 %206
