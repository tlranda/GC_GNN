; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5844.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5844.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %98 = shl nuw nsw i64 %indvars.iv862, 2
  %99 = and i64 %98, 9223372036854775776
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %indvars.iv.next861 = add nsw i64 %indvars.iv860, -12
  %indvars.iv.next863 = add nuw nsw i64 %indvars.iv862, 3
  %indvars.iv.next867 = add nuw nsw i64 %indvars.iv866, 12
  %exitcond874.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_header227:                             ; preds = %polly.loop_exit213, %polly.loop_exit235
  ...
  %110 = shl nsw i64 %polly.indvar230, 5
  %111 = sub nsw i64 %102, %110
  %112 = icmp sgt i64 %111, 0
  %113 = select i1 %112, i64 %111, i64 0
  %114 = mul nsw i64 %polly.indvar230, -32
...
polly.loop_exit235:                               ; preds = %polly.loop_exit242, %polly.loop_header227
  ...
  %indvars.iv.next869 = add i64 %indvars.iv868, 32
...
polly.loop_exit242:                               ; preds = %polly.loop_exit250
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar_next237, 20
...
polly.loop_header240:                             ; preds = %polly.loop_header233, %polly.loop_exit250
  %indvars.iv870 = phi i64 [ %109, %polly.loop_header233 ], [ %indvars.iv.next871, %polly.loop_exit250 ]
  %polly.indvar244 = phi i64 [ %113, %polly.loop_header233 ], [ %polly.indvar_next245, %polly.loop_exit250 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv870, i64 19)
...
polly.loop_header248:                             ; preds = %polly.loop_header248.preheader, %polly.loop_header248
  ...
  %125 = add nuw nsw i64 %polly.indvar252, %102
...
vector.body1066:                                  ; preds = %vector.body1066, %vector.ph1070
  ...
  %wide.load1077 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %137, label %middle.block1064, label %vector.body1066, !llvm.loop !84
...
polly.loop_header376:                             ; preds = %polly.loop_header376.preheader, %polly.loop_exit384
  ...
  %139 = mul nuw nsw i64 %polly.indvar379, 20
...
polly.loop_header382:                             ; preds = %polly.loop_exit408, %polly.loop_header376
  ...
  %140 = shl nuw nsw i64 %indvars.iv884, 2
  %141 = and i64 %140, 9223372036854775776
  %142 = add i64 %indvars.iv882, %141
  %143 = sub nsw i64 %indvars.iv889, %141
  %144 = mul nuw nsw i64 %polly.indvar385, 20
  br label %polly.loop_header388

polly.loop_exit390:                               ; preds = %polly.loop_exit396
  %145 = mul nsw i64 %polly.indvar385, -20
  %146 = mul nuw nsw i64 %polly.indvar385, 3
  %147 = add nuw nsw i64 %146, 7
  %pexp.p_div_q404 = lshr i64 %147, 3
  %148 = sub nsw i64 %polly.indvar385, %pexp.p_div_q404
  %polly.loop_guard409 = icmp slt i64 %148, 38
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415, %polly.loop_exit390
  ...
  %indvars.iv.next890 = add nuw nsw i64 %indvars.iv889, 12
  %exitcond898.not = icmp eq i64 %polly.indvar_next386, 60
...
polly.loop_header388:                             ; preds = %polly.loop_exit396, %polly.loop_header382
  ...
  %149 = add nuw nsw i64 %polly.indvar391, %139
...
polly.loop_header394:                             ; preds = %polly.loop_header394, %polly.loop_header388
  ...
  %150 = add nuw nsw i64 %polly.indvar397, %144
...
polly.loop_header406:                             ; preds = %polly.loop_exit390, %polly.loop_exit415
  %indvars.iv891 = phi i64 [ %indvars.iv.next892, %polly.loop_exit415 ], [ %143, %polly.loop_exit390 ]
  %indvars.iv886 = phi i64 [ %indvars.iv.next887, %polly.loop_exit415 ], [ %142, %polly.loop_exit390 ]
  ...
  %152 = shl nsw i64 %polly.indvar410, 5
  %153 = sub nsw i64 %144, %152
  %154 = icmp sgt i64 %153, 0
  %155 = select i1 %154, i64 %153, i64 0
  %156 = mul nsw i64 %polly.indvar410, -32
...
polly.loop_exit415:                               ; preds = %polly.loop_exit422, %polly.loop_header406
  ...
  %indvars.iv.next887 = add i64 %indvars.iv886, -32
  %indvars.iv.next892 = add i64 %indvars.iv891, 32
...
polly.loop_header413:                             ; preds = %polly.loop_header406, %polly.loop_exit422
  ...
  %160 = add nuw nsw i64 %polly.indvar416, %139
  %161 = shl i64 %160, 3
...
polly.loop_exit422:                               ; preds = %polly.loop_exit430
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar_next417, 20
...
polly.loop_header420:                             ; preds = %polly.loop_header413, %polly.loop_exit430
  %indvars.iv893 = phi i64 [ %151, %polly.loop_header413 ], [ %indvars.iv.next894, %polly.loop_exit430 ]
  ...
  %163 = add i64 %162, %145
  %polly.loop_guard431958 = icmp sgt i64 %163, -1
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_header428
  ...
  %167 = add nuw nsw i64 %polly.indvar432, %144
...
vector.body1042:                                  ; preds = %vector.body1042, %vector.ph1044
  ...
  %wide.load1051 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %179, label %middle.block1040, label %vector.body1042, !llvm.loop !94
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_exit564
  ...
  %181 = mul nuw nsw i64 %polly.indvar559, 20
...
polly.loop_header562:                             ; preds = %polly.loop_exit588, %polly.loop_header556
  ...
  %182 = shl nuw nsw i64 %indvars.iv908, 2
  %183 = and i64 %182, 9223372036854775776
  %184 = add i64 %indvars.iv906, %183
  %185 = sub nsw i64 %indvars.iv913, %183
  %186 = mul nuw nsw i64 %polly.indvar565, 20
  br label %polly.loop_header568

polly.loop_exit570:                               ; preds = %polly.loop_exit576
  %187 = mul nsw i64 %polly.indvar565, -20
  %188 = mul nuw nsw i64 %polly.indvar565, 3
  %189 = add nuw nsw i64 %188, 7
  %pexp.p_div_q584 = lshr i64 %189, 3
  %190 = sub nsw i64 %polly.indvar565, %pexp.p_div_q584
  %polly.loop_guard589 = icmp slt i64 %190, 38
...
polly.loop_header568:                             ; preds = %polly.loop_exit576, %polly.loop_header562
  ...
  %191 = add nuw nsw i64 %polly.indvar571, %181
...
polly.loop_header574:                             ; preds = %polly.loop_header574, %polly.loop_header568
  ...
  %192 = add nuw nsw i64 %polly.indvar577, %186
...
polly.loop_header586:                             ; preds = %polly.loop_exit570, %polly.loop_exit595
  %indvars.iv915 = phi i64 [ %indvars.iv.next916, %polly.loop_exit595 ], [ %185, %polly.loop_exit570 ]
  %indvars.iv910 = phi i64 [ %indvars.iv.next911, %polly.loop_exit595 ], [ %184, %polly.loop_exit570 ]
  ...
  %193 = add i64 %smax912, %indvars.iv915
  %194 = shl nsw i64 %polly.indvar590, 5
  %195 = sub nsw i64 %186, %194
  %196 = icmp sgt i64 %195, 0
  %197 = select i1 %196, i64 %195, i64 0
  %198 = mul nsw i64 %polly.indvar590, -32
...
polly.loop_exit595:                               ; preds = %polly.loop_exit602, %polly.loop_header586
  ...
  %indvars.iv.next911 = add i64 %indvars.iv910, -32
...
polly.loop_header593:                             ; preds = %polly.loop_header586, %polly.loop_exit602
  ...
  %202 = add nuw nsw i64 %polly.indvar596, %181
  %203 = shl i64 %202, 3
...
polly.loop_exit602:                               ; preds = %polly.loop_exit610
  ...
  %exitcond921.not = icmp eq i64 %polly.indvar_next597, 20
...
polly.loop_header600:                             ; preds = %polly.loop_header593, %polly.loop_exit610
  %indvars.iv917 = phi i64 [ %193, %polly.loop_header593 ], [ %indvars.iv.next918, %polly.loop_exit610 ]
  %polly.indvar604 = phi i64 [ %197, %polly.loop_header593 ], [ %polly.indvar_next605, %polly.loop_exit610 ]
  %smin919 = call i64 @llvm.smin.i64(i64 %indvars.iv917, i64 19)
  %204 = add i64 %polly.indvar604, %194
  %205 = add i64 %204, %187
  %polly.loop_guard611959 = icmp sgt i64 %205, -1
...
polly.loop_header608:                             ; preds = %polly.loop_header608.preheader, %polly.loop_header608
  ...
  %209 = add nuw nsw i64 %polly.indvar612, %186
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  br i1 %235, label %polly.loop_exit778, label %vector.body980, !llvm.loop !103
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %264, label %polly.loop_exit805, label %vector.body995, !llvm.loop !106
...
vector.body1013:                                  ; preds = %vector.body1013, %vector.ph1016
  ...
  br i1 %293, label %polly.loop_exit831, label %vector.body1013, !llvm.loop !109
