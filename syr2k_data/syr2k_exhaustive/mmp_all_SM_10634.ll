; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10634.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10634.c"
...
vector.body901:                                   ; preds = %vector.body901, %vector.ph902
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call720, i64 %indvars.iv7.i, i64 %index903
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph966
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call720, i64 %indvars.iv21.i, i64 %index969
...
vector.body987:                                   ; preds = %vector.body987, %vector.ph989
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call720, i64 %indvars.iv21.i52, i64 %index992
  ...
  br i1 %57, label %middle.block985, label %vector.body987, !llvm.loop !50
...
vector.body1013:                                  ; preds = %vector.body1013, %vector.ph1015
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call720, i64 %indvars.iv21.i91, i64 %index1018
  ...
  br i1 %68, label %middle.block1011, label %vector.body1013, !llvm.loop !52
...
vector.body1025:                                  ; preds = %vector.body1025, %vector.ph1029
  ...
  %wide.load1036 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !58, !noalias !60
  ...
  br i1 %95, label %middle.block1023, label %vector.body1025, !llvm.loop !63
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next790 = add nuw nsw i64 %indvars.iv789, 128
  %exitcond801.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %107 = add nsw i64 %smin797, 999
  br label %polly.loop_header211

polly.loop_exit213:                               ; preds = %polly.loop_exit219
  %polly.indvar_next209 = add nuw nsw i64 %polly.indvar208, 1
  %indvars.iv.next796 = add nsw i64 %indvars.iv795, -128
  %exitcond800.not = icmp eq i64 %polly.indvar_next209, 8
...
polly.loop_header217.preheader:                   ; preds = %polly.loop_header211
  ...
  %112 = add i64 %smax, %indvars.iv791
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %indvars.iv.next788 = add i64 %indvars.iv787, 100
  %indvars.iv.next792 = add i64 %indvars.iv791, -100
  %exitcond799.not = icmp eq i64 %polly.indvar_next215, %105
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv793 = phi i64 [ %112, %polly.loop_header217.preheader ], [ %indvars.iv.next794, %polly.loop_exit225 ]
  ...
  %polly.loop_guard233882 = icmp sgt i64 %114, -1
  %115 = add nuw nsw i64 %polly.indvar220, %104
  %116 = mul i64 %115, 8000
  %117 = mul i64 %115, 9600
  br i1 %polly.loop_guard233882, label %polly.loop_header223.us, label %polly.loop_exit225
...
polly.loop_header223.us:                          ; preds = %polly.loop_header217, %polly.loop_exit232.loopexit.us
  ...
  %118 = add nuw nsw i64 %polly.indvar226.us, %106
  %119 = shl i64 %118, 3
  %120 = add i64 %119, %116
...
polly.loop_header230.us:                          ; preds = %polly.loop_header223.us, %polly.loop_header230.us
  ...
  %121 = add nuw nsw i64 %polly.indvar234.us, %108
...
polly.loop_exit232.loopexit.us:                   ; preds = %polly.loop_header230.us
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar226.us, %107
  br i1 %exitcond798.not, label %polly.loop_exit225, label %polly.loop_header223.us
...
vector.body999:                                   ; preds = %vector.body999, %vector.ph1003
  ...
  %128 = shl nuw nsw i64 %index1006, 3
  %129 = getelementptr i8, i8* %scevgep350, i64 %128
  %130 = bitcast i8* %129 to <4 x double>*
  %wide.load1010 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !68, !noalias !70
  %131 = fmul fast <4 x double> %wide.load1010, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %133 = icmp eq i64 %index.next1007, %n.vec1005
  br i1 %133, label %middle.block997, label %vector.body999, !llvm.loop !73

middle.block997:                                  ; preds = %vector.body999
  %cmp.n1009 = icmp eq i64 %126, %n.vec1005
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond824.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %135 = mul nuw nsw i64 %polly.indvar357, 7
  %136 = add nuw nsw i64 %135, 6
  %pexp.p_div_q366 = udiv i64 %136, 25
  %137 = add nuw nsw i64 %pexp.p_div_q366, %polly.indvar357
  %.inv774 = icmp ult i64 %137, 11
  %138 = mul nsw i64 %polly.indvar357, -128
  %139 = icmp slt i64 %138, -1072
  %140 = select i1 %139, i64 %138, i64 -1072
  %141 = add nsw i64 %140, 1199
  %142 = shl nsw i64 %polly.indvar357, 7
  %.op883 = add nuw i64 %137, 2
  %143 = select i1 %.inv774, i64 %.op883, i64 12
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit369
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next805 = add nsw i64 %indvars.iv804, -128
  %indvars.iv.next810 = add nuw nsw i64 %indvars.iv809, 128
  %exitcond823.not = icmp eq i64 %polly.indvar_next358, 10
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %smin819 = call i64 @llvm.smin.i64(i64 %indvars.iv817, i64 -872)
  %144 = shl nsw i64 %polly.indvar363, 7
  %145 = add nsw i64 %smin819, 999
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %146 = mul nsw i64 %polly.indvar370, 100
  %147 = add nsw i64 %146, %138
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %polly.loop_guard377.not = icmp sgt i64 %149, %141
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %150 = add i64 %smax808, %indvars.iv811
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond821.not = icmp eq i64 %polly.indvar_next371, %143
  br i1 %exitcond821.not, label %polly.loop_exit369, label %polly.loop_header367

polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv813 = phi i64 [ %150, %polly.loop_header374.preheader ], [ %indvars.iv.next814, %polly.loop_exit383 ]
  %polly.indvar378 = phi i64 [ %149, %polly.loop_header374.preheader ], [ %polly.indvar_next379, %polly.loop_exit383 ]
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 99)
  %152 = add nsw i64 %polly.indvar378, %151
  %polly.loop_guard391884 = icmp sgt i64 %152, -1
  %153 = add nuw nsw i64 %polly.indvar378, %142
  %154 = mul i64 %153, 8000
  %155 = mul i64 %153, 9600
  br i1 %polly.loop_guard391884, label %polly.loop_header381.us, label %polly.loop_exit383
...
polly.loop_header381.us:                          ; preds = %polly.loop_header374, %polly.loop_exit390.loopexit.us
  ...
  %156 = add nuw nsw i64 %polly.indvar384.us, %144
  %157 = shl i64 %156, 3
  %158 = add i64 %157, %154
...
polly.loop_header388.us:                          ; preds = %polly.loop_header381.us, %polly.loop_header388.us
  ...
  %159 = add nuw nsw i64 %polly.indvar392.us, %146
  %160 = mul i64 %159, 8000
  %161 = add i64 %160, %157
  %scevgep395.us = getelementptr i8, i8* %call1, i64 %161
  ...
  %scevgep401.us = getelementptr i8, i8* %call2, i64 %161
  ...
  %162 = shl i64 %159, 3
  %163 = add i64 %162, %155
  %scevgep407.us = getelementptr i8, i8* %call, i64 %163
...
polly.loop_exit390.loopexit.us:                   ; preds = %polly.loop_header388.us
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar384.us, %145
...
polly.loop_header496:                             ; preds = %init_array.exit, %polly.loop_exit504
  ...
  %min.iters.check976 = icmp ult i64 %164, 4
  br i1 %min.iters.check976, label %polly.loop_header502.preheader, label %vector.ph977

vector.ph977:                                     ; preds = %polly.loop_header496
  %n.vec979 = and i64 %164, -4
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph977
  ...
  %166 = shl nuw nsw i64 %index980, 3
  %167 = getelementptr i8, i8* %scevgep508, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load984 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !77, !noalias !79
  %169 = fmul fast <4 x double> %wide.load984, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next981, %n.vec979
  br i1 %171, label %middle.block973, label %vector.body975, !llvm.loop !82

middle.block973:                                  ; preds = %vector.body975
  %cmp.n983 = icmp eq i64 %164, %n.vec979
  br i1 %cmp.n983, label %polly.loop_exit504, label %polly.loop_header502.preheader

polly.loop_header502.preheader:                   ; preds = %polly.loop_header496, %middle.block973
  %polly.indvar505.ph = phi i64 [ 0, %polly.loop_header496 ], [ %n.vec979, %middle.block973 ]
  br label %polly.loop_header502

polly.loop_exit504:                               ; preds = %polly.loop_header502, %middle.block973
  %polly.indvar_next500 = add nuw nsw i64 %polly.indvar499, 1
  %exitcond847.not = icmp eq i64 %polly.indvar_next500, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond847.not, label %polly.loop_header512, label %polly.loop_header496
...
polly.loop_header502:                             ; preds = %polly.loop_header502.preheader, %polly.loop_header502
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar_next506, %polly.indvar499
  br i1 %exitcond846.not, label %polly.loop_exit504, label %polly.loop_header502, !llvm.loop !83

polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv831 = phi i64 [ %indvars.iv.next832, %polly.loop_exit520 ], [ 0, %polly.loop_exit504 ]
  %indvars.iv826 = phi i64 [ %indvars.iv.next827, %polly.loop_exit520 ], [ 0, %polly.loop_exit504 ]
  %polly.indvar515 = phi i64 [ %polly.indvar_next516, %polly.loop_exit520 ], [ 0, %polly.loop_exit504 ]
  %173 = mul nuw nsw i64 %polly.indvar515, 7
  %174 = add nuw nsw i64 %173, 6
  %pexp.p_div_q524 = udiv i64 %174, 25
  %175 = add nuw nsw i64 %pexp.p_div_q524, %polly.indvar515
  %.inv775 = icmp ult i64 %175, 11
  %176 = mul nsw i64 %polly.indvar515, -128
  %177 = icmp slt i64 %176, -1072
  %178 = select i1 %177, i64 %176, i64 -1072
  %179 = add nsw i64 %178, 1199
  %180 = shl nsw i64 %polly.indvar515, 7
  %.op885 = add nuw i64 %175, 2
  %181 = select i1 %.inv775, i64 %.op885, i64 12
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next827 = add nsw i64 %indvars.iv826, -128
  %indvars.iv.next832 = add nuw nsw i64 %indvars.iv831, 128
  %exitcond845.not = icmp eq i64 %polly.indvar_next516, 10
  br i1 %exitcond845.not, label %kernel_syr2k.exit, label %polly.loop_header512

polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  %indvars.iv839 = phi i64 [ %indvars.iv.next840, %polly.loop_exit527 ], [ 0, %polly.loop_header512 ]
  ...
  %182 = shl nsw i64 %polly.indvar521, 7
  %183 = add nsw i64 %smin841, 999
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar_next522, 8
  br i1 %exitcond844.not, label %polly.loop_exit520, label %polly.loop_header518

polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  %indvars.iv833 = phi i64 [ %indvars.iv.next834, %polly.loop_exit534 ], [ %indvars.iv831, %polly.loop_header518 ]
  %indvars.iv828 = phi i64 [ %indvars.iv.next829, %polly.loop_exit534 ], [ %indvars.iv826, %polly.loop_header518 ]
  %polly.indvar528 = phi i64 [ %polly.indvar_next529, %polly.loop_exit534 ], [ 0, %polly.loop_header518 ]
  %184 = mul nsw i64 %polly.indvar528, 100
  %185 = add nsw i64 %184, %176
  %186 = icmp sgt i64 %185, 0
  %187 = select i1 %186, i64 %185, i64 0
  %polly.loop_guard535.not = icmp sgt i64 %187, %179
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %188 = add i64 %smax830, %indvars.iv833
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %indvars.iv.next829 = add i64 %indvars.iv828, 100
  %indvars.iv.next834 = add i64 %indvars.iv833, -100
  %exitcond843.not = icmp eq i64 %polly.indvar_next529, %181
  br i1 %exitcond843.not, label %polly.loop_exit527, label %polly.loop_header525

polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv835 = phi i64 [ %188, %polly.loop_header532.preheader ], [ %indvars.iv.next836, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %187, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin837 = call i64 @llvm.smin.i64(i64 %indvars.iv835, i64 99)
  %190 = add nsw i64 %polly.indvar536, %189
  %polly.loop_guard549886 = icmp sgt i64 %190, -1
  %191 = add nuw nsw i64 %polly.indvar536, %180
  %192 = mul i64 %191, 8000
  %193 = mul i64 %191, 9600
  br i1 %polly.loop_guard549886, label %polly.loop_header539.us, label %polly.loop_exit541
...
polly.loop_header539.us:                          ; preds = %polly.loop_header532, %polly.loop_exit548.loopexit.us
  ...
  %194 = add nuw nsw i64 %polly.indvar542.us, %182
  %195 = shl i64 %194, 3
  %196 = add i64 %195, %192
  %scevgep556.us = getelementptr i8, i8* %call2, i64 %196
  ...
  %scevgep562.us = getelementptr i8, i8* %call1, i64 %196
...
polly.loop_header546.us:                          ; preds = %polly.loop_header539.us, %polly.loop_header546.us
  ...
  %197 = add nuw nsw i64 %polly.indvar550.us, %184
  %198 = mul i64 %197, 8000
  %199 = add i64 %198, %195
  %scevgep553.us = getelementptr i8, i8* %call1, i64 %199
  ...
  %scevgep559.us = getelementptr i8, i8* %call2, i64 %199
  ...
  %200 = shl i64 %197, 3
  %201 = add i64 %200, %193
  %scevgep565.us = getelementptr i8, i8* %call, i64 %201
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar550.us, %smin837
  br i1 %exitcond838.not, label %polly.loop_exit548.loopexit.us, label %polly.loop_header546.us

polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  %polly.indvar_next543.us = add nuw nsw i64 %polly.indvar542.us, 1
  %exitcond842.not = icmp eq i64 %polly.indvar542.us, %183
  br i1 %exitcond842.not, label %polly.loop_exit541, label %polly.loop_header539.us
...
polly.loop_header694:                             ; preds = %entry, %polly.loop_exit702
  %indvars.iv872 = phi i64 [ %indvars.iv.next873, %polly.loop_exit702 ], [ 0, %entry ]
...
polly.loop_exit708:                               ; preds = %polly.loop_exit714
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar_next704, 38
...
polly.loop_header706:                             ; preds = %polly.loop_exit714, %polly.loop_header700
  ...
  br i1 %min.iters.check, label %polly.loop_header712, label %vector.ph915

vector.ph915:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert922 = insertelement <4 x i64> poison, i64 %206, i32 0
  %broadcast.splat923 = shufflevector <4 x i64> %broadcast.splatinsert922, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert924 = insertelement <4 x i32> poison, i32 %209, i32 0
...
vector.body913:                                   ; preds = %vector.body913, %vector.ph915
  ...
  %211 = add nuw nsw <4 x i64> %vec.ind920, %broadcast.splat923
  %212 = trunc <4 x i64> %211 to <4 x i32>
  %213 = mul <4 x i32> %broadcast.splat925, %212
  ...
  %223 = icmp eq i64 %index.next917, %205
  br i1 %223, label %polly.loop_exit714, label %vector.body913, !llvm.loop !91

polly.loop_exit714:                               ; preds = %vector.body913, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond875.not = icmp eq i64 %polly.indvar709, %203
  br i1 %exitcond875.not, label %polly.loop_exit708, label %polly.loop_header706
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar715, %207
  br i1 %exitcond871.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !92

polly.loop_header721:                             ; preds = %polly.loop_exit702, %polly.loop_exit729
  %indvars.iv862 = phi i64 [ %indvars.iv.next863, %polly.loop_exit729 ], [ 0, %polly.loop_exit702 ]
...
polly.loop_exit729:                               ; preds = %polly.loop_exit735
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next725, 38
  br i1 %exitcond867.not, label %polly.loop_header747, label %polly.loop_header721

polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  %indvars.iv858 = phi i64 [ %indvars.iv.next859, %polly.loop_exit735 ], [ 0, %polly.loop_header721 ]
  %polly.indvar730 = phi i64 [ %polly.indvar_next731, %polly.loop_exit735 ], [ 0, %polly.loop_header721 ]
  %233 = mul nsw i64 %polly.indvar730, -32
  %smin929 = call i64 @llvm.smin.i64(i64 %233, i64 -968)
  %234 = add nsw i64 %smin929, 1000
  %smin860 = call i64 @llvm.smin.i64(i64 %indvars.iv858, i64 -968)
  %235 = shl nsw i64 %polly.indvar730, 5
  %236 = add nsw i64 %smin860, 999
...
polly.loop_exit735:                               ; preds = %polly.loop_exit741
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar_next731, 32
...
polly.loop_header733:                             ; preds = %polly.loop_exit741, %polly.loop_header727
  ...
  %min.iters.check930 = icmp eq i64 %234, 0
  br i1 %min.iters.check930, label %polly.loop_header739, label %vector.ph931

vector.ph931:                                     ; preds = %polly.loop_header733
  %broadcast.splatinsert940 = insertelement <4 x i64> poison, i64 %235, i32 0
  %broadcast.splat941 = shufflevector <4 x i64> %broadcast.splatinsert940, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert942 = insertelement <4 x i32> poison, i32 %238, i32 0
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph931
  ...
  %240 = add nuw nsw <4 x i64> %vec.ind938, %broadcast.splat941
  %241 = trunc <4 x i64> %240 to <4 x i32>
  %242 = mul <4 x i32> %broadcast.splat943, %241
  ...
  %252 = icmp eq i64 %index.next935, %234
  br i1 %252, label %polly.loop_exit741, label %vector.body928, !llvm.loop !94

polly.loop_exit741:                               ; preds = %vector.body928, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond865.not = icmp eq i64 %polly.indvar736, %232
  br i1 %exitcond865.not, label %polly.loop_exit735, label %polly.loop_header733
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond861.not = icmp eq i64 %polly.indvar742, %236
  br i1 %exitcond861.not, label %polly.loop_exit741, label %polly.loop_header739, !llvm.loop !95

polly.loop_header747:                             ; preds = %polly.loop_exit729, %polly.loop_exit755
  %indvars.iv852 = phi i64 [ %indvars.iv.next853, %polly.loop_exit755 ], [ 0, %polly.loop_exit729 ]
...
polly.loop_exit755:                               ; preds = %polly.loop_exit761
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar_next751, 38
  br i1 %exitcond857.not, label %init_array.exit, label %polly.loop_header747

polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  %indvars.iv848 = phi i64 [ %indvars.iv.next849, %polly.loop_exit761 ], [ 0, %polly.loop_header747 ]
  %polly.indvar756 = phi i64 [ %polly.indvar_next757, %polly.loop_exit761 ], [ 0, %polly.loop_header747 ]
  %262 = mul nsw i64 %polly.indvar756, -32
  %smin947 = call i64 @llvm.smin.i64(i64 %262, i64 -968)
  %263 = add nsw i64 %smin947, 1000
  %smin850 = call i64 @llvm.smin.i64(i64 %indvars.iv848, i64 -968)
  %264 = shl nsw i64 %polly.indvar756, 5
  %265 = add nsw i64 %smin850, 999
...
polly.loop_exit761:                               ; preds = %polly.loop_exit767
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next757, 32
...
polly.loop_header759:                             ; preds = %polly.loop_exit767, %polly.loop_header753
  ...
  %min.iters.check948 = icmp eq i64 %263, 0
  br i1 %min.iters.check948, label %polly.loop_header765, label %vector.ph949

vector.ph949:                                     ; preds = %polly.loop_header759
  %broadcast.splatinsert958 = insertelement <4 x i64> poison, i64 %264, i32 0
  %broadcast.splat959 = shufflevector <4 x i64> %broadcast.splatinsert958, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert960 = insertelement <4 x i32> poison, i32 %267, i32 0
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph949
  ...
  %269 = add nuw nsw <4 x i64> %vec.ind956, %broadcast.splat959
  %270 = trunc <4 x i64> %269 to <4 x i32>
  %271 = mul <4 x i32> %broadcast.splat961, %270
  ...
  %281 = icmp eq i64 %index.next953, %263
  br i1 %281, label %polly.loop_exit767, label %vector.body946, !llvm.loop !97

polly.loop_exit767:                               ; preds = %vector.body946, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond855.not = icmp eq i64 %polly.indvar762, %261
  br i1 %exitcond855.not, label %polly.loop_exit761, label %polly.loop_header759
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar768, %265
  br i1 %exitcond851.not, label %polly.loop_exit767, label %polly.loop_header765, !llvm.loop !98
}
