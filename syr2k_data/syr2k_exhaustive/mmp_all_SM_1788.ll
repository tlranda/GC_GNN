; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1788.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1788.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %103 = shl nuw nsw i64 %polly.indvar231, 6
  %104 = add i64 %97, %103
  %smax1345 = call i64 @llvm.smax.i64(i64 %104, i64 0)
  %105 = mul nsw i64 %polly.indvar231, -64
  %106 = add i64 %98, %105
  %107 = add i64 %smax1345, %106
  %108 = shl nsw i64 %polly.indvar231, 6
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1348 = call i64 @llvm.smin.i64(i64 %115, i64 63)
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %160 = shl nuw nsw i64 %polly.indvar436, 6
  %161 = add i64 %154, %160
  %smax1297 = call i64 @llvm.smax.i64(i64 %161, i64 0)
  %162 = mul nsw i64 %polly.indvar436, -64
  %163 = add i64 %155, %162
  %164 = add i64 %smax1297, %163
  %165 = shl nsw i64 %polly.indvar436, 6
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1300 = call i64 @llvm.smin.i64(i64 %172, i64 63)
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %217 = shl nuw nsw i64 %polly.indvar647, 6
  %218 = add i64 %211, %217
  %smax1249 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar647, -64
  %220 = add i64 %212, %219
  %221 = add i64 %smax1249, %220
  %222 = shl nsw i64 %polly.indvar647, 6
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1252 = call i64 @llvm.smin.i64(i64 %229, i64 63)
