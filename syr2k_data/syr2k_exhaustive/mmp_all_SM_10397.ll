; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10397.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10397.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv786, i64 69)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next780 = add nuw nsw i64 %indvars.iv779, 96
  %indvars.iv.next787 = add nuw nsw i64 %indvars.iv786, 6
  %exitcond789.not = icmp eq i64 %polly.indvar_next203, 13
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %107 = add i64 %smax, %indvars.iv781
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %exitcond788.not = icmp eq i64 %polly.indvar208, %102
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  %indvars.iv783 = phi i64 [ %107, %polly.loop_header211.preheader ], [ %indvars.iv.next784, %polly.loop_exit219 ]
  %polly.indvar214 = phi i64 [ %106, %polly.loop_header211.preheader ], [ %polly.indvar_next215, %polly.loop_exit219 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv783, i64 15)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  %indvars.iv806 = phi i64 [ %indvars.iv.next807, %polly.loop_exit360 ], [ 0, %polly.loop_exit344 ]
  ...
  %umin808 = call i64 @llvm.umin.i64(i64 %indvars.iv806, i64 69)
  %127 = mul nsw i64 %polly.indvar355, -96
  %128 = icmp slt i64 %127, -1104
  %129 = select i1 %128, i64 %127, i64 -1104
  %130 = add nsw i64 %129, 1199
  %131 = mul nuw nsw i64 %polly.indvar355, 96
  %132 = add nuw nsw i64 %umin808, 5
  br label %polly.loop_header358

polly.loop_exit360:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next793 = add nsw i64 %indvars.iv792, -96
  %indvars.iv.next798 = add nuw nsw i64 %indvars.iv797, 96
  %indvars.iv.next807 = add nuw nsw i64 %indvars.iv806, 6
  %exitcond810.not = icmp eq i64 %polly.indvar_next356, 13
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %133 = shl nsw i64 %polly.indvar361, 4
  %134 = add nsw i64 %133, %127
  %135 = icmp sgt i64 %134, 0
  %136 = select i1 %135, i64 %134, i64 0
  %polly.loop_guard368.not = icmp sgt i64 %136, %130
...
polly.loop_header365.preheader:                   ; preds = %polly.loop_header358
  ...
  %137 = add i64 %smax796, %indvars.iv799
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header358
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar361, %132
...
polly.loop_header365:                             ; preds = %polly.loop_header365.preheader, %polly.loop_exit374
  %indvars.iv801 = phi i64 [ %137, %polly.loop_header365.preheader ], [ %indvars.iv.next802, %polly.loop_exit374 ]
  %polly.indvar369 = phi i64 [ %136, %polly.loop_header365.preheader ], [ %polly.indvar_next370, %polly.loop_exit374 ]
  %smin803 = call i64 @llvm.smin.i64(i64 %indvars.iv801, i64 15)
  %139 = add nsw i64 %polly.indvar369, %138
  %polly.loop_guard382869 = icmp sgt i64 %139, -1
  %140 = add nuw nsw i64 %polly.indvar369, %131
...
polly.loop_header372.us:                          ; preds = %polly.loop_header365, %polly.loop_exit381.loopexit.us
  ...
  %143 = shl nuw nsw i64 %polly.indvar375.us, 3
  %scevgep386.us = getelementptr i8, i8* %call1, i64 %143
  %scevgep390.us = getelementptr i8, i8* %call2, i64 %143
  %scevgep391.us = getelementptr i8, i8* %scevgep390.us, i64 %141
  ...
  %scevgep399.us = getelementptr i8, i8* %scevgep386.us, i64 %141
...
polly.loop_header379.us:                          ; preds = %polly.loop_header379.us, %polly.loop_header372.us
  ...
  %144 = add nuw nsw i64 %polly.indvar383.us, %133
  %145 = mul nuw nsw i64 %144, 8000
  %scevgep387.us = getelementptr i8, i8* %scevgep386.us, i64 %145
  ...
  %scevgep395.us = getelementptr i8, i8* %scevgep390.us, i64 %145
...
polly.loop_exit374:                               ; preds = %polly.loop_exit381.loopexit.us, %polly.loop_header365
  ...
  %polly.loop_cond371.not.not = icmp ult i64 %polly.indvar369, %130
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  %indvars.iv827 = phi i64 [ %indvars.iv.next828, %polly.loop_exit515 ], [ 0, %polly.loop_exit499 ]
  ...
  %umin829 = call i64 @llvm.umin.i64(i64 %indvars.iv827, i64 69)
  %157 = mul nsw i64 %polly.indvar510, -96
  %158 = icmp slt i64 %157, -1104
  %159 = select i1 %158, i64 %157, i64 -1104
  %160 = add nsw i64 %159, 1199
  %161 = mul nuw nsw i64 %polly.indvar510, 96
  %162 = add nuw nsw i64 %umin829, 5
...
polly.loop_exit515:                               ; preds = %polly.loop_exit522
  ...
  %indvars.iv.next814 = add nsw i64 %indvars.iv813, -96
  %indvars.iv.next819 = add nuw nsw i64 %indvars.iv818, 96
  %indvars.iv.next828 = add nuw nsw i64 %indvars.iv827, 6
  %exitcond831.not = icmp eq i64 %polly.indvar_next511, 13
...
polly.loop_header513:                             ; preds = %polly.loop_exit522, %polly.loop_header507
  ...
  %163 = shl nsw i64 %polly.indvar516, 4
  %164 = add nsw i64 %163, %157
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard523.not = icmp sgt i64 %166, %160
...
polly.loop_header520.preheader:                   ; preds = %polly.loop_header513
  ...
  %167 = add i64 %smax817, %indvars.iv820
...
polly.loop_exit522:                               ; preds = %polly.loop_exit529, %polly.loop_header513
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar516, %162
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit529
  ...
  %polly.indvar524 = phi i64 [ %166, %polly.loop_header520.preheader ], [ %polly.indvar_next525, %polly.loop_exit529 ]
  %smin824 = call i64 @llvm.smin.i64(i64 %indvars.iv822, i64 15)
  %169 = add nsw i64 %polly.indvar524, %168
  %polly.loop_guard537870 = icmp sgt i64 %169, -1
  %170 = add nuw nsw i64 %polly.indvar524, %161
...
polly.loop_header527.us:                          ; preds = %polly.loop_header520, %polly.loop_exit536.loopexit.us
  ...
  %173 = shl nuw nsw i64 %polly.indvar530.us, 3
  %scevgep541.us = getelementptr i8, i8* %call1, i64 %173
  %scevgep545.us = getelementptr i8, i8* %call2, i64 %173
  %scevgep546.us = getelementptr i8, i8* %scevgep545.us, i64 %171
  ...
  %scevgep554.us = getelementptr i8, i8* %scevgep541.us, i64 %171
...
polly.loop_header534.us:                          ; preds = %polly.loop_header534.us, %polly.loop_header527.us
  ...
  %174 = add nuw nsw i64 %polly.indvar538.us, %163
  %175 = mul nuw nsw i64 %174, 8000
  %scevgep542.us = getelementptr i8, i8* %scevgep541.us, i64 %175
  ...
  %scevgep550.us = getelementptr i8, i8* %scevgep545.us, i64 %175
...
polly.loop_exit529:                               ; preds = %polly.loop_exit536.loopexit.us, %polly.loop_header520
  ...
  %polly.loop_cond526.not.not = icmp ult i64 %polly.indvar524, %160
...
vector.body897:                                   ; preds = %vector.body897, %vector.ph899
  ...
  br i1 %199, label %polly.loop_exit706, label %vector.body897, !llvm.loop !92

polly.loop_exit706:                               ; preds = %vector.body897, %polly.loop_header704
  %polly.indvar_next702 = add nuw nsw i64 %polly.indvar701, 1
  %exitcond861.not = icmp eq i64 %polly.indvar701, %179
...
polly.loop_header704:                             ; preds = %polly.loop_header698, %polly.loop_header704
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar707, %183
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph915
  ...
  br i1 %228, label %polly.loop_exit733, label %vector.body912, !llvm.loop !95

polly.loop_exit733:                               ; preds = %vector.body912, %polly.loop_header731
  %polly.indvar_next729 = add nuw nsw i64 %polly.indvar728, 1
  %exitcond851.not = icmp eq i64 %polly.indvar728, %208
...
polly.loop_header731:                             ; preds = %polly.loop_header725, %polly.loop_header731
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar734, %212
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %257, label %polly.loop_exit759, label %vector.body930, !llvm.loop !98

polly.loop_exit759:                               ; preds = %vector.body930, %polly.loop_header757
  %polly.indvar_next755 = add nuw nsw i64 %polly.indvar754, 1
  %exitcond841.not = icmp eq i64 %polly.indvar754, %237
...
polly.loop_header757:                             ; preds = %polly.loop_header751, %polly.loop_header757
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar760, %241
