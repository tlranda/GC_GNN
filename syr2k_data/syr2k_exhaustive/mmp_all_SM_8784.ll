; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8784.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8784.c"
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph977
  ...
  br i1 %57, label %middle.block973, label %vector.body975, !llvm.loop !52
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1003
  ...
  br i1 %68, label %middle.block999, label %vector.body1001, !llvm.loop !54
...
vector.body1013:                                  ; preds = %vector.body1013, %vector.ph1017
  ...
  %wide.load1024 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !60, !noalias !62
  ...
  br i1 %95, label %middle.block1011, label %vector.body1013, !llvm.loop !65
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond792.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !66
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %101 = mul nsw i64 %polly.indvar214, -64
...
polly.loop_header223.us:                          ; preds = %polly.loop_header217.us, %polly.loop_exit231.us
  ...
  %_p_scalar_240.us = load double, double* %scevgep238239.us, align 8, !alias.scope !64, !noalias !68
  %scevgep244.us = getelementptr i8, i8* %call1, i64 %107
  %scevgep244245.us = bitcast i8* %scevgep244.us to double*
  %_p_scalar_246.us = load double, double* %scevgep244245.us, align 8, !alias.scope !63, !noalias !69
...
polly.loop_header229.us:                          ; preds = %polly.loop_header229.us, %polly.loop_header223.us
  ...
  %_p_scalar_237.us = load double, double* %scevgep235236.us, align 8, !alias.scope !63, !noalias !69
  ...
  %_p_scalar_243.us = load double, double* %scevgep241242.us, align 8, !alias.scope !64, !noalias !68
  ...
  %_p_scalar_249.us = load double, double* %scevgep247248.us, align 8, !alias.scope !60, !noalias !62
  %p_reass.add.i116.us = fadd fast double %p_mul37.i114.us, %p_mul27.i112.us
  %p_reass.mul.i117.us = fmul fast double %p_reass.add.i116.us, 1.500000e+00
  %p_add42.i118.us = fadd fast double %p_reass.mul.i117.us, %_p_scalar_249.us
  store double %p_add42.i118.us, double* %scevgep247248.us, align 8, !alias.scope !60, !noalias !62
...
vector.body987:                                   ; preds = %vector.body987, %vector.ph991
  ...
  %wide.load998 = load <4 x double>, <4 x double>* %118, align 8, !alias.scope !70, !noalias !72
  ...
  store <4 x double> %119, <4 x double>* %120, align 8, !alias.scope !70, !noalias !72
  %index.next995 = add i64 %index994, 4
  %121 = icmp eq i64 %index.next995, %n.vec993
  br i1 %121, label %middle.block985, label %vector.body987, !llvm.loop !75
...
polly.loop_header342:                             ; preds = %polly.loop_header342.preheader, %polly.loop_header342
  ...
  br i1 %exitcond814.not, label %polly.loop_exit344, label %polly.loop_header342, !llvm.loop !76
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %123 = shl nsw i64 %polly.indvar355, 6
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %125 = shl nsw i64 %polly.indvar361, 6
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %127 = mul nsw i64 %polly.indvar367, -64
...
polly.loop_header377.us:                          ; preds = %polly.loop_header370.us, %polly.loop_exit386.us
  ...
  %_p_scalar_395.us = load double, double* %scevgep393394.us, align 8, !alias.scope !74, !noalias !77
  %scevgep399.us = getelementptr i8, i8* %call1, i64 %133
  %scevgep399400.us = bitcast i8* %scevgep399.us to double*
  %_p_scalar_401.us = load double, double* %scevgep399400.us, align 8, !alias.scope !73, !noalias !78
...
polly.loop_header384.us:                          ; preds = %polly.loop_header384.us, %polly.loop_header377.us
  ...
  %_p_scalar_392.us = load double, double* %scevgep390391.us, align 8, !alias.scope !73, !noalias !78
  ...
  %_p_scalar_398.us = load double, double* %scevgep396397.us, align 8, !alias.scope !74, !noalias !77
  ...
  %_p_scalar_404.us = load double, double* %scevgep402403.us, align 8, !alias.scope !70, !noalias !72
  %p_reass.add.i77.us = fadd fast double %p_mul37.i75.us, %p_mul27.i73.us
  %p_reass.mul.i78.us = fmul fast double %p_reass.add.i77.us, 1.500000e+00
  %p_add42.i79.us = fadd fast double %p_reass.mul.i78.us, %_p_scalar_404.us
  store double %p_add42.i79.us, double* %scevgep402403.us, align 8, !alias.scope !70, !noalias !72
...
vector.body963:                                   ; preds = %vector.body963, %vector.ph965
  ...
  %wide.load972 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %147, label %middle.block961, label %vector.body963, !llvm.loop !84
...
polly.loop_header497:                             ; preds = %polly.loop_header497.preheader, %polly.loop_header497
  ...
  %_p_scalar_506 = load double, double* %scevgep504505, align 8, !alias.scope !79, !noalias !81
  %p_mul.i = fmul fast double %_p_scalar_506, 1.200000e+00
  store double %p_mul.i, double* %scevgep504505, align 8, !alias.scope !79, !noalias !81
  %polly.indvar_next501 = add nuw nsw i64 %polly.indvar500, 1
  %exitcond836.not = icmp eq i64 %polly.indvar_next501, %polly.indvar494
  br i1 %exitcond836.not, label %polly.loop_exit499, label %polly.loop_header497, !llvm.loop !85
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %149 = shl nsw i64 %polly.indvar510, 6
...
polly.loop_header513:                             ; preds = %polly.loop_exit521, %polly.loop_header507
  ...
  %151 = shl nsw i64 %polly.indvar516, 6
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %153 = mul nsw i64 %polly.indvar522, -64
  %polly.loop_guard535874 = icmp sgt i64 %153, -1200
  %154 = shl nsw i64 %polly.indvar522, 6
...
polly.loop_header532.us:                          ; preds = %polly.loop_header525.us, %polly.loop_exit541.us
  ...
  %_p_scalar_550.us = load double, double* %scevgep548549.us, align 8, !alias.scope !83, !noalias !86
  %scevgep554.us = getelementptr i8, i8* %call1, i64 %159
  %scevgep554555.us = bitcast i8* %scevgep554.us to double*
  %_p_scalar_556.us = load double, double* %scevgep554555.us, align 8, !alias.scope !82, !noalias !87
...
polly.loop_header539.us:                          ; preds = %polly.loop_header539.us, %polly.loop_header532.us
  ...
  %_p_scalar_547.us = load double, double* %scevgep545546.us, align 8, !alias.scope !82, !noalias !87
  ...
  %_p_scalar_553.us = load double, double* %scevgep551552.us, align 8, !alias.scope !83, !noalias !86
  ...
  %_p_scalar_559.us = load double, double* %scevgep557558.us, align 8, !alias.scope !79, !noalias !81
  %p_reass.add.i.us = fadd fast double %p_mul37.i.us, %p_mul27.i.us
  %p_reass.mul.i.us = fmul fast double %p_reass.add.i.us, 1.500000e+00
  %p_add42.i.us = fadd fast double %p_reass.mul.i.us, %_p_scalar_559.us
  store double %p_add42.i.us, double* %scevgep557558.us, align 8, !alias.scope !79, !noalias !81
...
vector.body901:                                   ; preds = %vector.body901, %vector.ph903
  ...
  store <4 x double> %181, <4 x double>* %186, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %187, label %polly.loop_exit706, label %vector.body901, !llvm.loop !93
...
polly.loop_header704:                             ; preds = %polly.loop_header698, %polly.loop_header704
  ...
  store double %p_div33.i, double* %scevgep710711, align 8, !alias.scope !88, !noalias !90
  %polly.indvar_next708 = add nuw nsw i64 %polly.indvar707, 1
  %exitcond861.not = icmp eq i64 %polly.indvar707, %171
  br i1 %exitcond861.not, label %polly.loop_exit706, label %polly.loop_header704, !llvm.loop !94
...
vector.body916:                                   ; preds = %vector.body916, %vector.ph919
  ...
  store <4 x double> %210, <4 x double>* %215, align 8, !alias.scope !92, !noalias !95
  ...
  br i1 %216, label %polly.loop_exit733, label %vector.body916, !llvm.loop !96
...
polly.loop_header731:                             ; preds = %polly.loop_header725, %polly.loop_header731
  ...
  store double %p_div12.i, double* %scevgep737738, align 8, !alias.scope !92, !noalias !95
  %polly.indvar_next735 = add nuw nsw i64 %polly.indvar734, 1
  %exitcond851.not = icmp eq i64 %polly.indvar734, %200
  br i1 %exitcond851.not, label %polly.loop_exit733, label %polly.loop_header731, !llvm.loop !97
...
vector.body934:                                   ; preds = %vector.body934, %vector.ph937
  ...
  store <4 x double> %239, <4 x double>* %244, align 8, !alias.scope !91, !noalias !98
  ...
  br i1 %245, label %polly.loop_exit759, label %vector.body934, !llvm.loop !99
...
polly.loop_header757:                             ; preds = %polly.loop_header751, %polly.loop_header757
  ...
  store double %p_div.i, double* %scevgep764765, align 8, !alias.scope !91, !noalias !98
  %polly.indvar_next761 = add nuw nsw i64 %polly.indvar760, 1
  %exitcond841.not = icmp eq i64 %polly.indvar760, %229
  br i1 %exitcond841.not, label %polly.loop_exit759, label %polly.loop_header757, !llvm.loop !100
}
