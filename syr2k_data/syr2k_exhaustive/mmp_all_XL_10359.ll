; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10359.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10359.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %105 = shl nsw i64 %polly.indvar214, 8
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %130, label %middle.block999, label %vector.body1001, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %132 = lshr i64 %indvars.iv821, 3
  %133 = mul nsw i64 %polly.indvar357, -96
  %134 = icmp slt i64 %133, -1104
  %135 = select i1 %134, i64 %133, i64 -1104
  %136 = add nsw i64 %135, 1199
  %137 = mul nuw nsw i64 %polly.indvar357, 96
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %140 = shl nsw i64 %polly.indvar370, 8
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar370, %132
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  ...
  %polly.loop_guard391887 = icmp sgt i64 %146, -1
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  %wide.load986 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %165, label %middle.block975, label %vector.body977, !llvm.loop !83
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %167 = lshr i64 %indvars.iv845, 3
  %168 = mul nsw i64 %polly.indvar515, -96
  %169 = icmp slt i64 %168, -1104
  %170 = select i1 %169, i64 %168, i64 -1104
  %171 = add nsw i64 %170, 1199
  %172 = mul nuw nsw i64 %polly.indvar515, 96
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %175 = shl nsw i64 %polly.indvar528, 8
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar528, %167
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv837 = phi i64 [ %179, %polly.loop_header532.preheader ], [ %indvars.iv.next838, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549888 = icmp sgt i64 %181, -1
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar542.us, %174
...
vector.body915:                                   ; preds = %vector.body915, %vector.ph917
  ...
  br i1 %214, label %polly.loop_exit714, label %vector.body915, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body915, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond879.not = icmp eq i64 %polly.indvar709, %194
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond875.not = icmp eq i64 %polly.indvar715, %198
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %243, label %polly.loop_exit741, label %vector.body930, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body930, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond869.not = icmp eq i64 %polly.indvar736, %223
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond865.not = icmp eq i64 %polly.indvar742, %227
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph951
  ...
  br i1 %272, label %polly.loop_exit767, label %vector.body948, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body948, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond859.not = icmp eq i64 %polly.indvar762, %252
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar768, %256
