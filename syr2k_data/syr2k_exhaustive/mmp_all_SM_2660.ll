; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2660.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2660.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit259, %polly.loop_header222
  ...
  %smin1314 = call i64 @llvm.smin.i64(i64 %105, i64 127)
  %106 = add nsw i64 %smin1314, 1
  %smin1022 = call i64 @llvm.smin.i64(i64 %indvars.iv1018, i64 127)
...
polly.loop_header412:                             ; preds = %polly.loop_exit404, %polly.loop_exit420
  ...
  %141 = shl nuw nsw i64 %polly.indvar415, 7
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1050, i64 -1072)
  %142 = shl nsw i64 %polly.indvar415, 7
...
polly.loop_exit420:                               ; preds = %polly.loop_exit426
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next416, 10
...
polly.loop_header418:                             ; preds = %polly.loop_exit426, %polly.loop_header412
  ...
  %144 = mul nsw i64 %polly.indvar421, -128
  %145 = add i64 %141, %144
...
polly.loop_header424:                             ; preds = %polly.loop_exit461, %polly.loop_header418
  ...
  %smin1269 = call i64 @llvm.smin.i64(i64 %149, i64 127)
...
polly.loop_header614:                             ; preds = %polly.loop_exit606, %polly.loop_exit622
  ...
  %185 = shl nuw nsw i64 %polly.indvar617, 7
  %smin1077 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 -1072)
...
polly.loop_exit622:                               ; preds = %polly.loop_exit628
  ...
  %indvars.iv.next1064 = add nuw nsw i64 %indvars.iv1063, 128
  %indvars.iv.next1076 = add nsw i64 %indvars.iv1075, -128
  %indvars.iv.next1080 = add nuw nsw i64 %indvars.iv1079, 1
  %exitcond1082.not = icmp eq i64 %polly.indvar_next618, 10
...
polly.loop_header620:                             ; preds = %polly.loop_exit628, %polly.loop_header614
  ...
  %188 = mul nsw i64 %polly.indvar623, -128
  %189 = add i64 %185, %188
  %190 = shl nsw i64 %polly.indvar623, 7
...
polly.loop_header626:                             ; preds = %polly.loop_exit663, %polly.loop_header620
  ...
  %smin1224 = call i64 @llvm.smin.i64(i64 %193, i64 127)
  %194 = add nsw i64 %smin1224, 1
  %smin1072 = call i64 @llvm.smin.i64(i64 %indvars.iv1067, i64 127)
