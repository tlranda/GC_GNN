; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6081.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6081.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin860 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -984)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar_next203, 63
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv870, i64 -984)
  %128 = add nsw i64 %smin887, 1000
  %129 = shl nsw i64 %polly.indvar375, 4
...
polly.loop_exit380:                               ; preds = %polly.loop_exit402
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar_next376, 63
...
polly.loop_header547:                             ; preds = %polly.loop_header547.preheader, %polly.loop_exit555
  ...
  %smin914 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 -984)
  %159 = add nsw i64 %smin914, 1000
  %160 = shl nsw i64 %polly.indvar550, 4
...
polly.loop_exit555:                               ; preds = %polly.loop_exit577
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar_next551, 63
