; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4964.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4964.c"
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %polly.loop_guard2331090 = icmp sgt i64 %123, -1
...
vector.body1198:                                  ; preds = %vector.body1198, %vector.ph1202
  ...
  %138 = shl nuw nsw i64 %index1205, 3
  %139 = getelementptr i8, i8* %scevgep379, i64 %138
  %140 = bitcast i8* %139 to <4 x double>*
  %wide.load1209 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !74, !noalias !76
  %141 = fmul fast <4 x double> %wide.load1209, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %143 = icmp eq i64 %index.next1206, %n.vec1204
  br i1 %143, label %middle.block1196, label %vector.body1198, !llvm.loop !80

middle.block1196:                                 ; preds = %vector.body1198
  %cmp.n1208 = icmp eq i64 %136, %n.vec1204
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %145 = udiv i64 %indvars.iv1020, 5
  %146 = sub nsw i64 %indvars.iv1018, %145
  %smin1022 = call i64 @llvm.smin.i64(i64 %146, i64 54)
  %147 = mul nsw i64 %polly.indvar386, -96
  %148 = icmp slt i64 %147, -1104
  %149 = select i1 %148, i64 %147, i64 -1104
  %150 = add nsw i64 %149, 1199
  %151 = mul nuw nsw i64 %polly.indvar386, 96
  %152 = add nsw i64 %smin1022, 5
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond1024.not = icmp eq i64 %polly.indvar_next393, 250
...
polly.loop_header403.preheader:                   ; preds = %polly.loop_header396
  ...
  %168 = add i64 %smax1005, %indvars.iv1008
...
polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar399, %152
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  %indvars.iv1010 = phi i64 [ %168, %polly.loop_header403.preheader ], [ %indvars.iv.next1011, %polly.loop_exit441 ]
  ...
  %polly.loop_guard4201091 = icmp sgt i64 %171, -1
...
polly.loop_header558:                             ; preds = %polly.loop_exit566, %polly.start472
  ...
  %min.iters.check1175 = icmp ult i64 %184, 4
...
vector.body1174:                                  ; preds = %vector.body1174, %vector.ph1176
  ...
  %186 = shl nuw nsw i64 %index1179, 3
  %187 = getelementptr i8, i8* %scevgep570, i64 %186
  %188 = bitcast i8* %187 to <4 x double>*
  %wide.load1183 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !84, !noalias !86
  %189 = fmul fast <4 x double> %wide.load1183, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %191 = icmp eq i64 %index.next1180, %n.vec1178
  br i1 %191, label %middle.block1172, label %vector.body1174, !llvm.loop !90

middle.block1172:                                 ; preds = %vector.body1174
  %cmp.n1182 = icmp eq i64 %184, %n.vec1178
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %193 = udiv i64 %indvars.iv1048, 5
  %194 = sub nsw i64 %indvars.iv1046, %193
  %smin1050 = call i64 @llvm.smin.i64(i64 %194, i64 54)
  %195 = mul nsw i64 %polly.indvar577, -96
  %196 = icmp slt i64 %195, -1104
  %197 = select i1 %196, i64 %195, i64 -1104
  %198 = add nsw i64 %197, 1199
  %199 = mul nuw nsw i64 %polly.indvar577, 96
  %200 = add nsw i64 %smin1050, 5
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar_next584, 250
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header587
  ...
  %216 = add i64 %smax1033, %indvars.iv1036
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar590, %200
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1038 = phi i64 [ %216, %polly.loop_header594.preheader ], [ %indvars.iv.next1039, %polly.loop_exit632 ]
  ...
  %polly.loop_guard6111092 = icmp sgt i64 %219, -1
...
vector.ph1114:                                    ; preds = %polly.loop_header799
  %broadcast.splatinsert1121 = insertelement <4 x i64> poison, i64 %236, i32 0
  %broadcast.splat1122 = shufflevector <4 x i64> %broadcast.splatinsert1121, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1123 = insertelement <4 x i32> poison, i32 %239, i32 0
...
vector.body1113:                                  ; preds = %vector.body1113, %vector.ph1114
  ...
  %241 = add nuw nsw <4 x i64> %vec.ind1119, %broadcast.splat1122
  %242 = trunc <4 x i64> %241 to <4 x i32>
  %243 = mul <4 x i32> %broadcast.splat1124, %242
  ...
  %253 = icmp eq i64 %index.next1116, %235
  br i1 %253, label %polly.loop_exit807, label %vector.body1113, !llvm.loop !99

polly.loop_exit807:                               ; preds = %vector.body1113, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1083.not = icmp eq i64 %polly.indvar802, %233
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1079.not = icmp eq i64 %polly.indvar808, %237
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %smin1128 = call i64 @llvm.smin.i64(i64 %263, i64 -968)
  %264 = add nsw i64 %smin1128, 1000
  %smin1068 = call i64 @llvm.smin.i64(i64 %indvars.iv1066, i64 -968)
  %265 = shl nsw i64 %polly.indvar823, 5
  %266 = add nsw i64 %smin1068, 999
...
vector.body1127:                                  ; preds = %vector.body1127, %vector.ph1130
  ...
  %270 = add nuw nsw <4 x i64> %vec.ind1137, %broadcast.splat1140
  ...
  %282 = icmp eq i64 %index.next1134, %264
  br i1 %282, label %polly.loop_exit834, label %vector.body1127, !llvm.loop !102

polly.loop_exit834:                               ; preds = %vector.body1127, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1073.not = icmp eq i64 %polly.indvar829, %262
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar835, %266
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %smin1146 = call i64 @llvm.smin.i64(i64 %292, i64 -968)
  %293 = add nsw i64 %smin1146, 1000
  %smin1058 = call i64 @llvm.smin.i64(i64 %indvars.iv1056, i64 -968)
  %294 = shl nsw i64 %polly.indvar849, 5
  %295 = add nsw i64 %smin1058, 999
...
vector.body1145:                                  ; preds = %vector.body1145, %vector.ph1148
  ...
  %299 = add nuw nsw <4 x i64> %vec.ind1155, %broadcast.splat1158
  %300 = trunc <4 x i64> %299 to <4 x i32>
  %301 = mul <4 x i32> %broadcast.splat1160, %300
  ...
  %311 = icmp eq i64 %index.next1152, %293
  br i1 %311, label %polly.loop_exit860, label %vector.body1145, !llvm.loop !105

polly.loop_exit860:                               ; preds = %vector.body1145, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1063.not = icmp eq i64 %polly.indvar855, %291
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1059.not = icmp eq i64 %polly.indvar861, %295
...
polly.loop_header446.us.3:                        ; preds = %polly.loop_header446.us.3, %polly.loop_exit448.loopexit.us.2
  ...
  br i1 %exitcond1016.3.not, label %polly.loop_exit441, label %polly.loop_header446.us.3
...
polly.loop_header637.us.3:                        ; preds = %polly.loop_header637.us.3, %polly.loop_exit639.loopexit.us.2
  ...
  br i1 %exitcond1044.3.not, label %polly.loop_exit632, label %polly.loop_header637.us.3
}
