; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1884.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1884.c"
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit237
  ...
  %111 = mul i64 %polly.indvar231, 20
  %112 = add i64 %97, %111
  %smax1362 = call i64 @llvm.smax.i64(i64 %112, i64 0)
  %113 = mul i64 %polly.indvar231, -20
  %114 = add i64 %98, %113
  %115 = add i64 %smax1362, %114
  %116 = mul nsw i64 %polly.indvar231, 20
...
polly.loop_exit237:                               ; preds = %polly.loop_exit269, %polly.loop_header228
  ...
  %indvars.iv.next1051 = add i64 %indvars.iv1050, -20
...
polly.loop_header235:                             ; preds = %polly.loop_header235.preheader, %polly.loop_exit269
  ...
  %smin1365 = call i64 @llvm.smin.i64(i64 %123, i64 19)
  %124 = add nsw i64 %smin1365, 1
  %smin1058 = call i64 @llvm.smin.i64(i64 %indvars.iv1052, i64 19)
...
polly.loop_header422:                             ; preds = %polly.loop_exit414, %polly.loop_exit430
  ...
  %.inv932 = icmp slt i64 %166, 59
  %168 = select i1 %.inv932, i64 %167, i64 59
...
polly.loop_header436:                             ; preds = %polly.loop_header436.preheader, %polly.loop_exit446
  ...
  %178 = mul i64 %polly.indvar440, -20
  %179 = add i64 %163, %178
  %180 = add i64 %smax1314, %179
  %181 = mul nsw i64 %polly.indvar440, 20
...
polly.loop_exit446:                               ; preds = %polly.loop_exit482, %polly.loop_header436
  ...
  %indvars.iv.next1081 = add i64 %indvars.iv1080, -20
...
polly.loop_header444:                             ; preds = %polly.loop_header444.preheader, %polly.loop_exit482
  ...
  %smin1317 = call i64 @llvm.smin.i64(i64 %188, i64 19)
  %189 = add nsw i64 %smin1317, 1
  %smin1088 = call i64 @llvm.smin.i64(i64 %indvars.iv1082, i64 19)
...
polly.loop_header635:                             ; preds = %polly.loop_exit627, %polly.loop_exit643
  ...
  %.inv934 = icmp slt i64 %231, 59
  %233 = select i1 %.inv934, i64 %232, i64 59
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit659
  ...
  %241 = mul i64 %polly.indvar653, 20
  %242 = add i64 %227, %241
  %smax1266 = call i64 @llvm.smax.i64(i64 %242, i64 0)
  %243 = mul i64 %polly.indvar653, -20
  %244 = add i64 %228, %243
  %245 = add i64 %smax1266, %244
  %246 = mul nsw i64 %polly.indvar653, 20
...
polly.loop_exit659:                               ; preds = %polly.loop_exit695, %polly.loop_header649
  ...
  %indvars.iv.next1106 = add i64 %indvars.iv1105, 20
  %indvars.iv.next1111 = add i64 %indvars.iv1110, -20
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit695
  ...
  %smin1269 = call i64 @llvm.smin.i64(i64 %253, i64 19)
  %254 = add nsw i64 %smin1269, 1
  %smin1118 = call i64 @llvm.smin.i64(i64 %indvars.iv1112, i64 19)
