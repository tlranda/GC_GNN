; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9915.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9915.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond784.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !64

polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv780 = phi i64 [ %indvars.iv.next781, %polly.loop_exit207 ], [ 1, %polly.loop_exit193 ]
  %indvars.iv776 = phi i64 [ %indvars.iv.next777, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %polly.indvar202 = phi i64 [ %polly.indvar_next203, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %smin778 = call i64 @llvm.smin.i64(i64 %indvars.iv776, i64 -1168)
  %97 = shl nsw i64 %polly.indvar202, 5
  %98 = add nsw i64 %smin778, 1199
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond783.not = icmp eq i64 %polly.indvar_next203, 38
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %indvars.iv.next772 = add nsw i64 %indvars.iv771, -32
  %exitcond782.not = icmp eq i64 %polly.indvar_next209, %indvars.iv780
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv773, i64 31)
  ...
  br i1 %polly.loop_guard858, label %polly.loop_header217.us, label %polly.loop_exit219
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225.loopexit.us, %polly.loop_header211
  ...
  %exitcond779.not = icmp eq i64 %polly.indvar214, %98
  br i1 %exitcond779.not, label %polly.loop_exit213, label %polly.loop_header211
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph977
  ...
  %112 = shl nuw nsw i64 %index980, 3
  %113 = getelementptr i8, i8* %scevgep346, i64 %112
  %114 = bitcast i8* %113 to <4 x double>*
  %wide.load984 = load <4 x double>, <4 x double>* %114, align 8, !alias.scope !68, !noalias !70
  %115 = fmul fast <4 x double> %wide.load984, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %116 = bitcast i8* %113 to <4 x double>*
  store <4 x double> %115, <4 x double>* %116, align 8, !alias.scope !68, !noalias !70
  %index.next981 = add i64 %index980, 4
  %117 = icmp eq i64 %index.next981, %n.vec979
  br i1 %117, label %middle.block971, label %vector.body973, !llvm.loop !73

middle.block971:                                  ; preds = %vector.body973
  %cmp.n983 = icmp eq i64 %110, %n.vec979
...
polly.loop_exit342:                               ; preds = %polly.loop_header340, %middle.block971
  ...
  %exitcond804.not = icmp eq i64 %polly.indvar_next338, 1200
  %indvar.next975 = add i64 %indvar974, 1
  br i1 %exitcond804.not, label %polly.loop_header350, label %polly.loop_header334
...
polly.loop_header340:                             ; preds = %polly.loop_header340.preheader, %polly.loop_header340
  ...
  %exitcond803.not = icmp eq i64 %polly.indvar_next344, %polly.indvar337
  br i1 %exitcond803.not, label %polly.loop_exit342, label %polly.loop_header340, !llvm.loop !74

polly.loop_header350:                             ; preds = %polly.loop_exit342, %polly.loop_exit358
  %indvars.iv799 = phi i64 [ %indvars.iv.next800, %polly.loop_exit358 ], [ 1, %polly.loop_exit342 ]
  %indvars.iv795 = phi i64 [ %indvars.iv.next796, %polly.loop_exit358 ], [ 0, %polly.loop_exit342 ]
  %indvars.iv786 = phi i64 [ %indvars.iv.next787, %polly.loop_exit358 ], [ 0, %polly.loop_exit342 ]
  %polly.indvar353 = phi i64 [ %polly.indvar_next354, %polly.loop_exit358 ], [ 0, %polly.loop_exit342 ]
  %smin797 = call i64 @llvm.smin.i64(i64 %indvars.iv795, i64 -1168)
  %119 = shl nsw i64 %polly.indvar353, 5
  %120 = add nsw i64 %smin797, 1199
  br label %polly.loop_header356

polly.loop_exit358:                               ; preds = %polly.loop_exit364
  %polly.indvar_next354 = add nuw nsw i64 %polly.indvar353, 1
  %indvars.iv.next787 = add nuw nsw i64 %indvars.iv786, 32
  %indvars.iv.next796 = add nsw i64 %indvars.iv795, -32
  %indvars.iv.next800 = add nuw nsw i64 %indvars.iv799, 1
  %exitcond802.not = icmp eq i64 %polly.indvar_next354, 38
  br i1 %exitcond802.not, label %kernel_syr2k.exit90, label %polly.loop_header350

polly.loop_header356:                             ; preds = %polly.loop_exit364, %polly.loop_header350
  %indvars.iv788 = phi i64 [ %indvars.iv.next789, %polly.loop_exit364 ], [ %indvars.iv786, %polly.loop_header350 ]
...
polly.loop_exit364:                               ; preds = %polly.loop_exit370
  ...
  %indvars.iv.next789 = add nsw i64 %indvars.iv788, -32
  %exitcond801.not = icmp eq i64 %polly.indvar_next360, %indvars.iv799
  br i1 %exitcond801.not, label %polly.loop_exit358, label %polly.loop_header356

polly.loop_header362:                             ; preds = %polly.loop_exit370, %polly.loop_header356
  %indvars.iv790 = phi i64 [ %indvars.iv.next791, %polly.loop_exit370 ], [ %indvars.iv788, %polly.loop_header356 ]
  %polly.indvar365 = phi i64 [ %polly.indvar_next366, %polly.loop_exit370 ], [ 0, %polly.loop_header356 ]
  %smin792 = call i64 @llvm.smin.i64(i64 %indvars.iv790, i64 31)
  %123 = add nsw i64 %polly.indvar365, %122
  %polly.loop_guard378859 = icmp sgt i64 %123, -1
  %124 = add nuw nsw i64 %polly.indvar365, %119
  %125 = mul nuw nsw i64 %124, 8000
  %126 = mul nuw nsw i64 %124, 9600
  br i1 %polly.loop_guard378859, label %polly.loop_header368.us, label %polly.loop_exit370
...
polly.loop_header368.us:                          ; preds = %polly.loop_header362, %polly.loop_exit377.loopexit.us
  ...
  %127 = shl nuw nsw i64 %polly.indvar371.us, 3
  %scevgep382.us = getelementptr i8, i8* %call1, i64 %127
  %scevgep386.us = getelementptr i8, i8* %call2, i64 %127
  %scevgep387.us = getelementptr i8, i8* %scevgep386.us, i64 %125
  ...
  %scevgep395.us = getelementptr i8, i8* %scevgep382.us, i64 %125
...
polly.loop_header375.us:                          ; preds = %polly.loop_header375.us, %polly.loop_header368.us
  ...
  %128 = add nuw nsw i64 %polly.indvar379.us, %121
  %129 = mul nuw nsw i64 %128, 8000
  %scevgep383.us = getelementptr i8, i8* %scevgep382.us, i64 %129
  ...
  %scevgep391.us = getelementptr i8, i8* %scevgep386.us, i64 %129
  ...
  %scevgep398.us = getelementptr i8, i8* %call, i64 %131
  ...
  %exitcond793.not = icmp eq i64 %polly.indvar379.us, %smin792
  br i1 %exitcond793.not, label %polly.loop_exit377.loopexit.us, label %polly.loop_header375.us

polly.loop_exit377.loopexit.us:                   ; preds = %polly.loop_header375.us
  %polly.indvar_next372.us = add nuw nsw i64 %polly.indvar371.us, 1
  %exitcond794.not = icmp eq i64 %polly.indvar_next372.us, 1000
  br i1 %exitcond794.not, label %polly.loop_exit370, label %polly.loop_header368.us
...
polly.loop_exit370:                               ; preds = %polly.loop_exit377.loopexit.us, %polly.loop_header362
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar365, %120
  br i1 %exitcond798.not, label %polly.loop_exit364, label %polly.loop_header362
...
polly.loop_header487:                             ; preds = %init_array.exit, %polly.loop_exit495
  ...
  %133 = mul nuw nsw i64 %polly.indvar490, 9600
  %scevgep499 = getelementptr i8, i8* %call, i64 %133
  %min.iters.check950 = icmp ult i64 %132, 4
  br i1 %min.iters.check950, label %polly.loop_header493.preheader, label %vector.ph951

vector.ph951:                                     ; preds = %polly.loop_header487
  %n.vec953 = and i64 %132, -4
...
vector.body949:                                   ; preds = %vector.body949, %vector.ph951
  ...
  %134 = shl nuw nsw i64 %index954, 3
  %135 = getelementptr i8, i8* %scevgep499, i64 %134
  %136 = bitcast i8* %135 to <4 x double>*
  %wide.load958 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !77, !noalias !79
  %137 = fmul fast <4 x double> %wide.load958, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %138 = bitcast i8* %135 to <4 x double>*
  store <4 x double> %137, <4 x double>* %138, align 8, !alias.scope !77, !noalias !79
  %index.next955 = add i64 %index954, 4
  %139 = icmp eq i64 %index.next955, %n.vec953
  br i1 %139, label %middle.block947, label %vector.body949, !llvm.loop !82

middle.block947:                                  ; preds = %vector.body949
  %cmp.n957 = icmp eq i64 %132, %n.vec953
...
polly.loop_exit495:                               ; preds = %polly.loop_header493, %middle.block947
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next491, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond823.not, label %polly.loop_header503, label %polly.loop_header487
...
polly.loop_header493:                             ; preds = %polly.loop_header493.preheader, %polly.loop_header493
  ...
  %140 = shl nuw nsw i64 %polly.indvar496, 3
  %scevgep500 = getelementptr i8, i8* %scevgep499, i64 %140
  ...
  %exitcond822.not = icmp eq i64 %polly.indvar_next497, %polly.indvar490
  br i1 %exitcond822.not, label %polly.loop_exit495, label %polly.loop_header493, !llvm.loop !83

polly.loop_header503:                             ; preds = %polly.loop_exit495, %polly.loop_exit511
  %indvars.iv818 = phi i64 [ %indvars.iv.next819, %polly.loop_exit511 ], [ 1, %polly.loop_exit495 ]
  %indvars.iv814 = phi i64 [ %indvars.iv.next815, %polly.loop_exit511 ], [ 0, %polly.loop_exit495 ]
  %indvars.iv805 = phi i64 [ %indvars.iv.next806, %polly.loop_exit511 ], [ 0, %polly.loop_exit495 ]
  %polly.indvar506 = phi i64 [ %polly.indvar_next507, %polly.loop_exit511 ], [ 0, %polly.loop_exit495 ]
  %smin816 = call i64 @llvm.smin.i64(i64 %indvars.iv814, i64 -1168)
  %141 = shl nsw i64 %polly.indvar506, 5
  %142 = add nsw i64 %smin816, 1199
...
polly.loop_exit511:                               ; preds = %polly.loop_exit517
  ...
  %indvars.iv.next806 = add nuw nsw i64 %indvars.iv805, 32
  %indvars.iv.next815 = add nsw i64 %indvars.iv814, -32
  %indvars.iv.next819 = add nuw nsw i64 %indvars.iv818, 1
  %exitcond821.not = icmp eq i64 %polly.indvar_next507, 38
  br i1 %exitcond821.not, label %kernel_syr2k.exit, label %polly.loop_header503

polly.loop_header509:                             ; preds = %polly.loop_exit517, %polly.loop_header503
  %indvars.iv807 = phi i64 [ %indvars.iv.next808, %polly.loop_exit517 ], [ %indvars.iv805, %polly.loop_header503 ]
  %polly.indvar512 = phi i64 [ %polly.indvar_next513, %polly.loop_exit517 ], [ 0, %polly.loop_header503 ]
  %143 = shl nsw i64 %polly.indvar512, 5
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar_next513, %indvars.iv818
  br i1 %exitcond820.not, label %polly.loop_exit511, label %polly.loop_header509

polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header509
  %indvars.iv809 = phi i64 [ %indvars.iv.next810, %polly.loop_exit523 ], [ %indvars.iv807, %polly.loop_header509 ]
  ...
  %145 = add nsw i64 %polly.indvar518, %144
  %polly.loop_guard531860 = icmp sgt i64 %145, -1
  %146 = add nuw nsw i64 %polly.indvar518, %141
  %147 = mul nuw nsw i64 %146, 8000
  %148 = mul nuw nsw i64 %146, 9600
  br i1 %polly.loop_guard531860, label %polly.loop_header521.us, label %polly.loop_exit523
...
polly.loop_header521.us:                          ; preds = %polly.loop_header515, %polly.loop_exit530.loopexit.us
  ...
  %149 = shl nuw nsw i64 %polly.indvar524.us, 3
  %scevgep535.us = getelementptr i8, i8* %call1, i64 %149
  %scevgep539.us = getelementptr i8, i8* %call2, i64 %149
  %scevgep540.us = getelementptr i8, i8* %scevgep539.us, i64 %147
  ...
  %scevgep548.us = getelementptr i8, i8* %scevgep535.us, i64 %147
...
polly.loop_header528.us:                          ; preds = %polly.loop_header528.us, %polly.loop_header521.us
  ...
  %150 = add nuw nsw i64 %polly.indvar532.us, %143
  %151 = mul nuw nsw i64 %150, 8000
  %scevgep536.us = getelementptr i8, i8* %scevgep535.us, i64 %151
  ...
  %scevgep544.us = getelementptr i8, i8* %scevgep539.us, i64 %151
  ...
  %scevgep551.us = getelementptr i8, i8* %call, i64 %153
  ...
  %exitcond812.not = icmp eq i64 %polly.indvar532.us, %smin811
  br i1 %exitcond812.not, label %polly.loop_exit530.loopexit.us, label %polly.loop_header528.us

polly.loop_exit530.loopexit.us:                   ; preds = %polly.loop_header528.us
  %polly.indvar_next525.us = add nuw nsw i64 %polly.indvar524.us, 1
  %exitcond813.not = icmp eq i64 %polly.indvar_next525.us, 1000
  br i1 %exitcond813.not, label %polly.loop_exit523, label %polly.loop_header521.us
...
polly.loop_exit523:                               ; preds = %polly.loop_exit530.loopexit.us, %polly.loop_header515
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar518, %142
  br i1 %exitcond817.not, label %polly.loop_exit517, label %polly.loop_header515

polly.loop_header680:                             ; preds = %entry, %polly.loop_exit688
  %indvars.iv848 = phi i64 [ %indvars.iv.next849, %polly.loop_exit688 ], [ 0, %entry ]
  ...
  %154 = shl nsw i64 %polly.indvar683, 5
  %155 = add nsw i64 %smin850, 1199
...
polly.loop_exit688:                               ; preds = %polly.loop_exit694
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next684, 38
  br i1 %exitcond853.not, label %polly.loop_header707, label %polly.loop_header680

polly.loop_header686:                             ; preds = %polly.loop_exit694, %polly.loop_header680
  %indvars.iv844 = phi i64 [ %indvars.iv.next845, %polly.loop_exit694 ], [ 0, %polly.loop_header680 ]
  %polly.indvar689 = phi i64 [ %polly.indvar_next690, %polly.loop_exit694 ], [ 0, %polly.loop_header680 ]
  %156 = mul nsw i64 %polly.indvar689, -32
  %smin888 = call i64 @llvm.smin.i64(i64 %156, i64 -1168)
  %157 = add nsw i64 %smin888, 1200
  %smin846 = call i64 @llvm.smin.i64(i64 %indvars.iv844, i64 -1168)
  %158 = shl nsw i64 %polly.indvar689, 5
  %159 = add nsw i64 %smin846, 1199
...
polly.loop_exit694:                               ; preds = %polly.loop_exit700
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar_next690, 38
  br i1 %exitcond852.not, label %polly.loop_exit688, label %polly.loop_header686
...
polly.loop_header692:                             ; preds = %polly.loop_exit700, %polly.loop_header686
  ...
  %160 = add nuw nsw i64 %polly.indvar695, %154
...
vector.ph889:                                     ; preds = %polly.loop_header692
  %broadcast.splatinsert896 = insertelement <4 x i64> poison, i64 %158, i32 0
  %broadcast.splat897 = shufflevector <4 x i64> %broadcast.splatinsert896, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert898 = insertelement <4 x i32> poison, i32 %161, i32 0
...
vector.body887:                                   ; preds = %vector.body887, %vector.ph889
  ...
  %163 = add nuw nsw <4 x i64> %vec.ind894, %broadcast.splat897
  %164 = trunc <4 x i64> %163 to <4 x i32>
  %165 = mul <4 x i32> %broadcast.splat899, %164
  ...
  store <4 x double> %169, <4 x double>* %174, align 8, !alias.scope !86, !noalias !88
  %index.next891 = add i64 %index890, 4
  %vec.ind.next895 = add <4 x i64> %vec.ind894, <i64 4, i64 4, i64 4, i64 4>
  %175 = icmp eq i64 %index.next891, %157
  br i1 %175, label %polly.loop_exit700, label %vector.body887, !llvm.loop !91

polly.loop_exit700:                               ; preds = %vector.body887, %polly.loop_header698
  %polly.indvar_next696 = add nuw nsw i64 %polly.indvar695, 1
  %exitcond851.not = icmp eq i64 %polly.indvar695, %155
  br i1 %exitcond851.not, label %polly.loop_exit694, label %polly.loop_header692
...
polly.loop_header698:                             ; preds = %polly.loop_header692, %polly.loop_header698
  ...
  %176 = add nuw nsw i64 %polly.indvar701, %158
  ...
  %scevgep704 = getelementptr i8, i8* %call, i64 %182
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar701, %159
  br i1 %exitcond847.not, label %polly.loop_exit700, label %polly.loop_header698, !llvm.loop !92

polly.loop_header707:                             ; preds = %polly.loop_exit688, %polly.loop_exit715
  %indvars.iv838 = phi i64 [ %indvars.iv.next839, %polly.loop_exit715 ], [ 0, %polly.loop_exit688 ]
  ...
  %183 = shl nsw i64 %polly.indvar710, 5
  %184 = add nsw i64 %smin840, 1199
...
polly.loop_exit715:                               ; preds = %polly.loop_exit721
  ...
  %exitcond843.not = icmp eq i64 %polly.indvar_next711, 38
  br i1 %exitcond843.not, label %polly.loop_header733, label %polly.loop_header707

polly.loop_header713:                             ; preds = %polly.loop_exit721, %polly.loop_header707
  %indvars.iv834 = phi i64 [ %indvars.iv.next835, %polly.loop_exit721 ], [ 0, %polly.loop_header707 ]
  %polly.indvar716 = phi i64 [ %polly.indvar_next717, %polly.loop_exit721 ], [ 0, %polly.loop_header707 ]
  %185 = mul nsw i64 %polly.indvar716, -32
  %smin903 = call i64 @llvm.smin.i64(i64 %185, i64 -968)
  %186 = add nsw i64 %smin903, 1000
  %smin836 = call i64 @llvm.smin.i64(i64 %indvars.iv834, i64 -968)
  %187 = shl nsw i64 %polly.indvar716, 5
  %188 = add nsw i64 %smin836, 999
...
polly.loop_exit721:                               ; preds = %polly.loop_exit727
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next717, 32
  br i1 %exitcond842.not, label %polly.loop_exit715, label %polly.loop_header713
...
vector.body902:                                   ; preds = %vector.body902, %vector.ph905
  ...
  %192 = add nuw nsw <4 x i64> %vec.ind912, %broadcast.splat915
  %193 = trunc <4 x i64> %192 to <4 x i32>
  %194 = mul <4 x i32> %broadcast.splat917, %193
  ...
  store <4 x double> %198, <4 x double>* %203, align 8, !alias.scope !90, !noalias !93
  %index.next909 = add i64 %index908, 4
  %vec.ind.next913 = add <4 x i64> %vec.ind912, <i64 4, i64 4, i64 4, i64 4>
  %204 = icmp eq i64 %index.next909, %186
  br i1 %204, label %polly.loop_exit727, label %vector.body902, !llvm.loop !94

polly.loop_exit727:                               ; preds = %vector.body902, %polly.loop_header725
  %polly.indvar_next723 = add nuw nsw i64 %polly.indvar722, 1
  %exitcond841.not = icmp eq i64 %polly.indvar722, %184
  br i1 %exitcond841.not, label %polly.loop_exit721, label %polly.loop_header719
...
polly.loop_header725:                             ; preds = %polly.loop_header719, %polly.loop_header725
  ...
  %205 = add nuw nsw i64 %polly.indvar728, %187
  ...
  %scevgep731 = getelementptr i8, i8* %call2, i64 %211
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar728, %188
  br i1 %exitcond837.not, label %polly.loop_exit727, label %polly.loop_header725, !llvm.loop !95

polly.loop_header733:                             ; preds = %polly.loop_exit715, %polly.loop_exit741
  %indvars.iv828 = phi i64 [ %indvars.iv.next829, %polly.loop_exit741 ], [ 0, %polly.loop_exit715 ]
  ...
  %212 = shl nsw i64 %polly.indvar736, 5
  %213 = add nsw i64 %smin830, 1199
...
polly.loop_exit741:                               ; preds = %polly.loop_exit747
  ...
  %exitcond833.not = icmp eq i64 %polly.indvar_next737, 38
  br i1 %exitcond833.not, label %init_array.exit, label %polly.loop_header733

polly.loop_header739:                             ; preds = %polly.loop_exit747, %polly.loop_header733
  %indvars.iv824 = phi i64 [ %indvars.iv.next825, %polly.loop_exit747 ], [ 0, %polly.loop_header733 ]
  %polly.indvar742 = phi i64 [ %polly.indvar_next743, %polly.loop_exit747 ], [ 0, %polly.loop_header733 ]
  %214 = mul nsw i64 %polly.indvar742, -32
  %smin921 = call i64 @llvm.smin.i64(i64 %214, i64 -968)
  %215 = add nsw i64 %smin921, 1000
  %smin826 = call i64 @llvm.smin.i64(i64 %indvars.iv824, i64 -968)
  %216 = shl nsw i64 %polly.indvar742, 5
  %217 = add nsw i64 %smin826, 999
...
polly.loop_exit747:                               ; preds = %polly.loop_exit753
  ...
  %exitcond832.not = icmp eq i64 %polly.indvar_next743, 32
  br i1 %exitcond832.not, label %polly.loop_exit741, label %polly.loop_header739
...
vector.body920:                                   ; preds = %vector.body920, %vector.ph923
  ...
  %221 = add nuw nsw <4 x i64> %vec.ind930, %broadcast.splat933
  %222 = trunc <4 x i64> %221 to <4 x i32>
  %223 = mul <4 x i32> %broadcast.splat935, %222
  ...
  store <4 x double> %227, <4 x double>* %232, align 8, !alias.scope !89, !noalias !96
  %index.next927 = add i64 %index926, 4
  %vec.ind.next931 = add <4 x i64> %vec.ind930, <i64 4, i64 4, i64 4, i64 4>
  %233 = icmp eq i64 %index.next927, %215
  br i1 %233, label %polly.loop_exit753, label %vector.body920, !llvm.loop !97

polly.loop_exit753:                               ; preds = %vector.body920, %polly.loop_header751
  %polly.indvar_next749 = add nuw nsw i64 %polly.indvar748, 1
  %exitcond831.not = icmp eq i64 %polly.indvar748, %213
  br i1 %exitcond831.not, label %polly.loop_exit747, label %polly.loop_header745
...
polly.loop_header751:                             ; preds = %polly.loop_header745, %polly.loop_header751
  ...
  %234 = add nuw nsw i64 %polly.indvar754, %216
  ...
  %scevgep758 = getelementptr i8, i8* %call1, i64 %240
  ...
  %exitcond827.not = icmp eq i64 %polly.indvar754, %217
  br i1 %exitcond827.not, label %polly.loop_exit753, label %polly.loop_header751, !llvm.loop !98
}
