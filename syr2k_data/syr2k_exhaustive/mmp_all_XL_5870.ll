; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5870.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5870.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %polly.loop_guard.not = icmp sgt i64 %113, %117
...
polly.loop_exit241:                               ; preds = %polly.loop_exit248
  ...
  %exitcond867.not = icmp eq i64 %polly.indvar_next237, 50
...
polly.loop_header239:                             ; preds = %polly.loop_header233, %polly.loop_exit248
  %indvars.iv864 = phi i64 [ %109, %polly.loop_header233 ], [ %indvars.iv.next865, %polly.loop_exit248 ]
  %polly.indvar242 = phi i64 [ %113, %polly.loop_header233 ], [ %polly.indvar_next243, %polly.loop_exit248 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv864, i64 79)
  %120 = add nuw i64 %polly.indvar242, %110
  %121 = add i64 %120, %104
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_header239
  %polly.access.add.Packed_MemRef_call2257 = add nsw i64 %polly.access.mul.Packed_MemRef_call2256, %121
...
polly.loop_exit248:                               ; preds = %polly.loop_header246, %polly.loop_header239
  ...
  %polly.loop_cond244.not.not = icmp slt i64 %polly.indvar242, %117
...
polly.loop_header246:                             ; preds = %polly.loop_header246.preheader, %polly.loop_header246
  ...
  %125 = add nuw nsw i64 %polly.indvar250, %103
...
vector.body1060:                                  ; preds = %vector.body1060, %vector.ph1064
  ...
  %132 = shl nuw nsw i64 %index1067, 3
  %133 = getelementptr i8, i8* %scevgep370, i64 %132
  %134 = bitcast i8* %133 to <4 x double>*
  %wide.load1071 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !79, !noalias !81
  %135 = fmul fast <4 x double> %wide.load1071, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %137 = icmp eq i64 %index.next1068, %n.vec1066
  br i1 %137, label %middle.block1058, label %vector.body1060, !llvm.loop !85

middle.block1058:                                 ; preds = %vector.body1060
  %cmp.n1070 = icmp eq i64 %130, %n.vec1066
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %139 = mul nuw nsw i64 %polly.indvar377, 50
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %140 = lshr i64 %polly.indvar383, 1
  %141 = add nuw i64 %indvars.iv878, %140
  %142 = shl nuw nsw i64 %141, 5
  %143 = sub i64 %indvars.iv876, %142
  %144 = add i64 %indvars.iv883, %142
  %145 = mul nuw nsw i64 %polly.indvar383, 80
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %146 = mul nsw i64 %polly.indvar383, -80
...
polly.loop_header386:                             ; preds = %polly.loop_exit394, %polly.loop_header380
  ...
  %149 = add nuw nsw i64 %polly.indvar389, %139
...
polly.loop_header392:                             ; preds = %polly.loop_header392, %polly.loop_header386
  ...
  %150 = add nuw nsw i64 %polly.indvar395, %145
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit411 ], [ %144, %polly.loop_exit388 ]
  %indvars.iv880 = phi i64 [ %indvars.iv.next881, %polly.loop_exit411 ], [ %143, %polly.loop_exit388 ]
...
polly.loop_header409:                             ; preds = %polly.loop_header403, %polly.loop_exit418
  ...
  %160 = add nuw nsw i64 %polly.indvar412, %139
  %161 = shl i64 %160, 3
...
polly.loop_exit418:                               ; preds = %polly.loop_exit426
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar_next413, 50
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  %indvars.iv887 = phi i64 [ %151, %polly.loop_header409 ], [ %indvars.iv.next888, %polly.loop_exit426 ]
  %polly.indvar420 = phi i64 [ %155, %polly.loop_header409 ], [ %polly.indvar_next421, %polly.loop_exit426 ]
  %smin889 = call i64 @llvm.smin.i64(i64 %indvars.iv887, i64 79)
  %162 = add nuw i64 %polly.indvar420, %152
  %163 = add i64 %162, %146
...
polly.loop_header424.preheader:                   ; preds = %polly.loop_header416
  %polly.access.add.Packed_MemRef_call2275435 = add nsw i64 %polly.access.mul.Packed_MemRef_call2275434, %163
...
polly.loop_exit426:                               ; preds = %polly.loop_header424, %polly.loop_header416
  ...
  %polly.loop_cond422.not.not = icmp slt i64 %polly.indvar420, %159
...
polly.loop_header424:                             ; preds = %polly.loop_header424.preheader, %polly.loop_header424
  ...
  %167 = add nuw nsw i64 %polly.indvar428, %145
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1037 = icmp ult i64 %172, 4
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1038
  ...
  %174 = shl nuw nsw i64 %index1041, 3
  %175 = getelementptr i8, i8* %scevgep548, i64 %174
  %176 = bitcast i8* %175 to <4 x double>*
  %wide.load1045 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !89, !noalias !91
  %177 = fmul fast <4 x double> %wide.load1045, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %179 = icmp eq i64 %index.next1042, %n.vec1040
  br i1 %179, label %middle.block1034, label %vector.body1036, !llvm.loop !95

middle.block1034:                                 ; preds = %vector.body1036
  %cmp.n1044 = icmp eq i64 %172, %n.vec1040
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %181 = mul nuw nsw i64 %polly.indvar555, 50
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %182 = lshr i64 %polly.indvar561, 1
  %183 = add nuw i64 %indvars.iv902, %182
  %184 = shl nuw nsw i64 %183, 5
  %185 = sub i64 %indvars.iv900, %184
  %186 = add i64 %indvars.iv907, %184
  %187 = mul nuw nsw i64 %polly.indvar561, 80
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %188 = mul nsw i64 %polly.indvar561, -80
  %189 = shl nuw nsw i64 %polly.indvar561, 1
...
polly.loop_header564:                             ; preds = %polly.loop_exit572, %polly.loop_header558
  ...
  %191 = add nuw nsw i64 %polly.indvar567, %181
...
polly.loop_header570:                             ; preds = %polly.loop_header570, %polly.loop_header564
  ...
  %192 = add nuw nsw i64 %polly.indvar573, %187
  %polly.access.mul.call2577 = mul nuw nsw i64 %192, 1000
  %polly.access.add.call2578 = add nuw nsw i64 %191, %polly.access.mul.call2577
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  %indvars.iv909 = phi i64 [ %indvars.iv.next910, %polly.loop_exit589 ], [ %186, %polly.loop_exit566 ]
  %indvars.iv904 = phi i64 [ %indvars.iv.next905, %polly.loop_exit589 ], [ %185, %polly.loop_exit566 ]
  %polly.indvar584 = phi i64 [ %polly.indvar_next585, %polly.loop_exit589 ], [ %190, %polly.loop_exit566 ]
  %smax906 = call i64 @llvm.smax.i64(i64 %indvars.iv904, i64 0)
  %193 = add i64 %smax906, %indvars.iv909
  %194 = shl nsw i64 %polly.indvar584, 5
  %195 = sub nsw i64 %187, %194
  %196 = icmp sgt i64 %195, 0
  %197 = select i1 %196, i64 %195, i64 0
  %198 = mul nsw i64 %polly.indvar584, -32
  %199 = icmp slt i64 %198, -1168
  %200 = select i1 %199, i64 %198, i64 -1168
  %201 = add nsw i64 %200, 1199
  %polly.loop_guard597.not = icmp sgt i64 %197, %201
...
polly.loop_header587:                             ; preds = %polly.loop_header581, %polly.loop_exit596
  ...
  %202 = add nuw nsw i64 %polly.indvar590, %181
  %203 = shl i64 %202, 3
...
polly.loop_exit596:                               ; preds = %polly.loop_exit604
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar_next591, 50
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  %indvars.iv911 = phi i64 [ %193, %polly.loop_header587 ], [ %indvars.iv.next912, %polly.loop_exit604 ]
  %polly.indvar598 = phi i64 [ %197, %polly.loop_header587 ], [ %polly.indvar_next599, %polly.loop_exit604 ]
  %smin913 = call i64 @llvm.smin.i64(i64 %indvars.iv911, i64 79)
  %204 = add nuw i64 %polly.indvar598, %194
  %205 = add i64 %204, %188
...
polly.loop_header602.preheader:                   ; preds = %polly.loop_header594
  %polly.access.add.Packed_MemRef_call2453613 = add nsw i64 %polly.access.mul.Packed_MemRef_call2453612, %205
...
polly.loop_exit604:                               ; preds = %polly.loop_header602, %polly.loop_header594
  ...
  %polly.loop_cond600.not.not = icmp slt i64 %polly.indvar598, %201
...
polly.loop_header602:                             ; preds = %polly.loop_header602.preheader, %polly.loop_header602
  ...
  %209 = add nuw nsw i64 %polly.indvar606, %187
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin975 = call i64 @llvm.smin.i64(i64 %216, i64 -1168)
  %217 = add nsw i64 %smin975, 1200
...
vector.ph976:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert983 = insertelement <4 x i64> poison, i64 %218, i32 0
  %broadcast.splat984 = shufflevector <4 x i64> %broadcast.splatinsert983, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert985 = insertelement <4 x i32> poison, i32 %221, i32 0
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  %223 = add nuw nsw <4 x i64> %vec.ind981, %broadcast.splat984
  %224 = trunc <4 x i64> %223 to <4 x i32>
  %225 = mul <4 x i32> %broadcast.splat986, %224
  ...
  %235 = icmp eq i64 %index.next978, %217
  br i1 %235, label %polly.loop_exit772, label %vector.body974, !llvm.loop !104
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin990 = call i64 @llvm.smin.i64(i64 %245, i64 -968)
  %246 = add nsw i64 %smin990, 1000
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph992
  ...
  %252 = add nuw nsw <4 x i64> %vec.ind999, %broadcast.splat1002
  %253 = trunc <4 x i64> %252 to <4 x i32>
  %254 = mul <4 x i32> %broadcast.splat1004, %253
  ...
  %264 = icmp eq i64 %index.next996, %246
  br i1 %264, label %polly.loop_exit799, label %vector.body989, !llvm.loop !107
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1008 = call i64 @llvm.smin.i64(i64 %274, i64 -968)
  %275 = add nsw i64 %smin1008, 1000
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1010
  ...
  %281 = add nuw nsw <4 x i64> %vec.ind1017, %broadcast.splat1020
  %282 = trunc <4 x i64> %281 to <4 x i32>
  %283 = mul <4 x i32> %broadcast.splat1022, %282
  ...
  %293 = icmp eq i64 %index.next1014, %275
  br i1 %293, label %polly.loop_exit825, label %vector.body1007, !llvm.loop !110
