; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9756.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9756.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %130 = mul nsw i64 %polly.indvar357, -20
  %131 = mul nuw nsw i64 %polly.indvar357, 20
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar_next358, 60
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %polly.loop_guard377 = icmp slt i64 %137, 20
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %162 = mul nsw i64 %polly.indvar515, -20
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next834 = add nuw nsw i64 %indvars.iv833, 20
  %indvars.iv.next846 = add nuw nsw i64 %indvars.iv845, 5
  %exitcond849.not = icmp eq i64 %polly.indvar_next516, 60
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %polly.loop_guard535 = icmp slt i64 %169, 20
