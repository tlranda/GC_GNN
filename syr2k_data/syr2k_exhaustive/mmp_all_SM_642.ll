; ModuleID = 'syr2k_exhaustive/mmp_all_SM_642.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_642.c"
...
vector.body1563:                                  ; preds = %vector.body1563, %vector.ph1567
  ...
  %wide.load1574 = load <4 x double>, <4 x double>* %241, align 8, !alias.scope !85
  ...
  %wide.load1580 = load <4 x double>, <4 x double>* %249, align 8, !alias.scope !88, !noalias !90
  ...
  store <4 x double> %252, <4 x double>* %253, align 8, !alias.scope !88, !noalias !90
  %index.next1571 = add i64 %index1570, 4
  %254 = icmp eq i64 %index.next1571, %n.vec1569
  br i1 %254, label %middle.block1561, label %vector.body1563, !llvm.loop !91
...
vector.body1469:                                  ; preds = %vector.body1469, %vector.ph1473
  ...
  %wide.load1480 = load <4 x double>, <4 x double>* %260, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %263, label %middle.block1467, label %vector.body1469, !llvm.loop !99
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit435
  ...
  %265 = mul nuw nsw i64 %polly.indvar430, 20
...
vector.body1500:                                  ; preds = %vector.body1500, %vector.ph1504
  ...
  %wide.load1511 = load <4 x double>, <4 x double>* %409, align 8, !alias.scope !104
  ...
  %wide.load1517 = load <4 x double>, <4 x double>* %417, align 8, !alias.scope !107, !noalias !109
  ...
  store <4 x double> %420, <4 x double>* %421, align 8, !alias.scope !107, !noalias !109
  %index.next1508 = add i64 %index1507, 4
  %422 = icmp eq i64 %index.next1508, %n.vec1506
  br i1 %422, label %middle.block1498, label %vector.body1500, !llvm.loop !110
...
vector.body1408:                                  ; preds = %vector.body1408, %vector.ph1410
  ...
  %wide.load1417 = load <4 x double>, <4 x double>* %428, align 8, !alias.scope !111, !noalias !113
  ...
  br i1 %431, label %middle.block1406, label %vector.body1408, !llvm.loop !118
...
polly.loop_header661:                             ; preds = %polly.loop_header661.preheader, %polly.loop_exit669
  ...
  %433 = mul nuw nsw i64 %polly.indvar664, 20
...
vector.body1437:                                  ; preds = %vector.body1437, %vector.ph1441
  ...
  %wide.load1448 = load <4 x double>, <4 x double>* %577, align 8, !alias.scope !123
  ...
  %wide.load1454 = load <4 x double>, <4 x double>* %585, align 8, !alias.scope !126, !noalias !128
  ...
  store <4 x double> %588, <4 x double>* %589, align 8, !alias.scope !126, !noalias !128
  %index.next1445 = add i64 %index1444, 4
  %590 = icmp eq i64 %index.next1445, %n.vec1443
  br i1 %590, label %middle.block1435, label %vector.body1437, !llvm.loop !129
...
vector.body1346:                                  ; preds = %vector.body1346, %vector.ph1348
  ...
  br i1 %613, label %polly.loop_exit935, label %vector.body1346, !llvm.loop !135
...
vector.body1361:                                  ; preds = %vector.body1361, %vector.ph1364
  ...
  br i1 %642, label %polly.loop_exit962, label %vector.body1361, !llvm.loop !138
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1382
  ...
  br i1 %671, label %polly.loop_exit988, label %vector.body1379, !llvm.loop !141
