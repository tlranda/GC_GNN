; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3554.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3554.c"
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1037, i64 -968)
...
polly.loop_exit397:                               ; preds = %polly.loop_exit404
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next393, 32
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %smin1083 = call i64 @llvm.smin.i64(i64 %indvars.iv1063, i64 -968)
  %199 = add nsw i64 %smin1083, 1000
  %200 = shl nsw i64 %polly.indvar589, 5
