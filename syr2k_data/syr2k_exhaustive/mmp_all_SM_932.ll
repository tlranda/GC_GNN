; ModuleID = 'syr2k_exhaustive/mmp_all_SM_932.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_932.c"
...
vector.body1484:                                  ; preds = %vector.body1484, %vector.ph1486
  ...
  br i1 %68, label %middle.block1482, label %vector.body1484, !llvm.loop !65
...
vector.body1496:                                  ; preds = %vector.body1496, %vector.ph1500
  ...
  %wide.load1507 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1494, label %vector.body1496, !llvm.loop !78
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1194 = call i64 @llvm.smin.i64(i64 %indvars.iv1168, i64 -920)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1197.not = icmp eq i64 %polly.indvar_next204, 13
...
vector.body1510:                                  ; preds = %vector.body1510, %vector.ph1518
  ...
  %wide.load1531 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !71, !noalias !73
  ...
  store <4 x double> %159, <4 x double>* %160, align 8, !alias.scope !71, !noalias !73
  %index.next1522 = add i64 %index1521, 4
  %161 = icmp eq i64 %index.next1522, %n.vec1520
  br i1 %161, label %middle.block1508, label %vector.body1510, !llvm.loop !84
...
vector.body1446:                                  ; preds = %vector.body1446, %vector.ph1450
  ...
  %wide.load1457 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %169, label %middle.block1444, label %vector.body1446, !llvm.loop !92
...
polly.loop_header415:                             ; preds = %polly.loop_header415.preheader, %polly.loop_header415
  ...
  br i1 %exitcond1235.not, label %polly.loop_exit417, label %polly.loop_header415, !llvm.loop !93
...
polly.loop_header425:                             ; preds = %polly.loop_header425.preheader, %polly.loop_exit433
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %indvars.iv1203, i64 -920)
  %171 = add nsw i64 %smin1231, 1000
  %172 = mul nuw nsw i64 %polly.indvar428, 80
...
polly.loop_exit433:                               ; preds = %polly.loop_exit456
  ...
  %indvars.iv.next1204 = add nsw i64 %indvars.iv1203, -80
  %exitcond1234.not = icmp eq i64 %polly.indvar_next429, 13
...
polly.loop_header470.us:                          ; preds = %polly.loop_header460.us, %polly.loop_header470.us
  ...
  %polly.access.call1479.load.us = load double, double* %polly.access.call1479.us, align 8, !alias.scope !88, !noalias !95
...
polly.loop_header481.us:                          ; preds = %polly.loop_exit472.us, %polly.loop_header481.us
  ...
  %polly.access.call1491.load.us = load double, double* %polly.access.call1491.us, align 8, !alias.scope !88, !noalias !95
...
polly.loop_header496.us1066:                      ; preds = %polly.loop_header460.us1063, %polly.loop_header496.us1066
  ...
  %polly.access.call1506.load.us1071 = load double, double* %polly.access.call1506.us1070, align 8, !alias.scope !88, !noalias !95
...
polly.loop_header525.us:                          ; preds = %polly.loop_header525.us.preheader, %polly.loop_header525.us
  ...
  br i1 %exitcond1230.not, label %polly.loop_exit527.us, label %polly.loop_header525.us, !llvm.loop !96
...
vector.body1460:                                  ; preds = %vector.body1460, %vector.ph1468
  ...
  %wide.load1481 = load <4 x double>, <4 x double>* %230, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %233, <4 x double>* %234, align 8, !alias.scope !85, !noalias !87
  %index.next1472 = add i64 %index1471, 4
  %235 = icmp eq i64 %index.next1472, %n.vec1470
  br i1 %235, label %middle.block1458, label %vector.body1460, !llvm.loop !97
...
vector.body1398:                                  ; preds = %vector.body1398, %vector.ph1400
  ...
  %wide.load1407 = load <4 x double>, <4 x double>* %240, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %243, label %middle.block1396, label %vector.body1398, !llvm.loop !105
...
polly.loop_header647:                             ; preds = %polly.loop_header647.preheader, %polly.loop_header647
  ...
  br i1 %exitcond1272.not, label %polly.loop_exit649, label %polly.loop_header647, !llvm.loop !106
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit665
  ...
  %smin1268 = call i64 @llvm.smin.i64(i64 %indvars.iv1240, i64 -920)
  %245 = add nsw i64 %smin1268, 1000
  %246 = mul nuw nsw i64 %polly.indvar660, 80
...
polly.loop_exit665:                               ; preds = %polly.loop_exit688
  ...
  %indvars.iv.next1241 = add nsw i64 %indvars.iv1240, -80
  %exitcond1271.not = icmp eq i64 %polly.indvar_next661, 13
...
polly.loop_header728.us1112:                      ; preds = %polly.loop_header692.us1109, %polly.loop_header728.us1112
  ...
  %polly.access.call1738.load.us1117 = load double, double* %polly.access.call1738.us1116, align 8, !alias.scope !101, !noalias !108
...
polly.loop_header757.us:                          ; preds = %polly.loop_header757.us.preheader, %polly.loop_header757.us
  ...
  br i1 %exitcond1267.not, label %polly.loop_exit759.us, label %polly.loop_header757.us, !llvm.loop !109
...
vector.body1410:                                  ; preds = %vector.body1410, %vector.ph1418
  ...
  %wide.load1431 = load <4 x double>, <4 x double>* %304, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %307, <4 x double>* %308, align 8, !alias.scope !98, !noalias !100
  %index.next1422 = add i64 %index1421, 4
  %309 = icmp eq i64 %index.next1422, %n.vec1420
  br i1 %309, label %middle.block1408, label %vector.body1410, !llvm.loop !110
...
vector.body1337:                                  ; preds = %vector.body1337, %vector.ph1338
  ...
  br i1 %331, label %polly.loop_exit929, label %vector.body1337, !llvm.loop !116
...
polly.loop_header927:                             ; preds = %polly.loop_header921, %polly.loop_header927
  ...
  br i1 %exitcond1297.not, label %polly.loop_exit929, label %polly.loop_header927, !llvm.loop !117
...
vector.body1351:                                  ; preds = %vector.body1351, %vector.ph1354
  ...
  br i1 %360, label %polly.loop_exit956, label %vector.body1351, !llvm.loop !119
...
polly.loop_header954:                             ; preds = %polly.loop_header948, %polly.loop_header954
  ...
  br i1 %exitcond1287.not, label %polly.loop_exit956, label %polly.loop_header954, !llvm.loop !120
...
vector.body1369:                                  ; preds = %vector.body1369, %vector.ph1372
  ...
  br i1 %389, label %polly.loop_exit982, label %vector.body1369, !llvm.loop !122
...
polly.loop_header980:                             ; preds = %polly.loop_header974, %polly.loop_header980
  ...
  br i1 %exitcond1277.not, label %polly.loop_exit982, label %polly.loop_header980, !llvm.loop !123
}
