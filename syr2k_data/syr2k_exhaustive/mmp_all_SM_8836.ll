; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8836.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8836.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond795.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %111 = mul nuw nsw i64 %polly.indvar214, 80
  %112 = sub nsw i64 %108, %111
  %113 = icmp sgt i64 %112, 0
  %114 = select i1 %113, i64 %112, i64 0
  %polly.loop_guard = icmp slt i64 %114, 80
...
polly.loop_exit219:                               ; preds = %polly.loop_exit232.us.3, %polly.loop_header211
  ...
  %exitcond794.not = icmp eq i64 %polly.indvar_next215, 15
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %141 = lshr i64 %polly.indvar363, 2
  %142 = mul nuw nsw i64 %141, 80
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %exitcond814.not = icmp eq i64 %polly.indvar_next364, 60
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %148 = mul nuw nsw i64 %polly.indvar370, 80
  %149 = sub nsw i64 %145, %148
  %150 = icmp sgt i64 %149, 0
  %151 = select i1 %150, i64 %149, i64 0
  %polly.loop_guard383 = icmp slt i64 %151, 80
...
polly.loop_exit375:                               ; preds = %polly.loop_exit390.us.3, %polly.loop_header367
  ...
  %indvars.iv.next802 = add i64 %indvars.iv801, -80
  %indvars.iv.next807 = add i64 %indvars.iv806, 80
  %exitcond813.not = icmp eq i64 %polly.indvar_next371, 15
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %178 = lshr i64 %polly.indvar521, 2
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next819 = add nuw nsw i64 %indvars.iv818, 20
  %indvars.iv.next824 = add nsw i64 %indvars.iv823, -20
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  ...
  %185 = mul nuw nsw i64 %polly.indvar528, 80
  %186 = sub nsw i64 %182, %185
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %polly.loop_guard541 = icmp slt i64 %188, 80
...
polly.loop_exit533:                               ; preds = %polly.loop_exit548.us.3, %polly.loop_header525
  ...
  %indvars.iv.next821 = add i64 %indvars.iv820, -80
  %indvars.iv.next826 = add i64 %indvars.iv825, 80
  %exitcond832.not = icmp eq i64 %polly.indvar_next529, 15
...
polly.loop_header380.us.1:                        ; preds = %polly.loop_exit390.us, %polly.loop_exit390.us.1
  ...
  %smin810.1 = call i64 @llvm.smin.i64(i64 %indvars.iv808.1, i64 19)
...
polly.loop_header380.us.2:                        ; preds = %polly.loop_exit390.us.1, %polly.loop_exit390.us.2
  ...
  %smin810.2 = call i64 @llvm.smin.i64(i64 %indvars.iv808.2, i64 19)
...
polly.loop_header380.us.3:                        ; preds = %polly.loop_exit390.us.2, %polly.loop_exit390.us.3
  ...
  %smin810.3 = call i64 @llvm.smin.i64(i64 %indvars.iv808.3, i64 19)
...
polly.loop_header538.us.1:                        ; preds = %polly.loop_exit548.us, %polly.loop_exit548.us.1
  ...
  %smin829.1 = call i64 @llvm.smin.i64(i64 %indvars.iv827.1, i64 19)
...
polly.loop_header538.us.2:                        ; preds = %polly.loop_exit548.us.1, %polly.loop_exit548.us.2
  ...
  %smin829.2 = call i64 @llvm.smin.i64(i64 %indvars.iv827.2, i64 19)
...
polly.loop_header538.us.3:                        ; preds = %polly.loop_exit548.us.2, %polly.loop_exit548.us.3
  ...
  %smin829.3 = call i64 @llvm.smin.i64(i64 %indvars.iv827.3, i64 19)
