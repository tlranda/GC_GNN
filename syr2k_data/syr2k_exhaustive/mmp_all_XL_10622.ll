; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10622.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10622.c"
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %123 = shl nsw i64 %polly.indvar355, 7
  %124 = add nsw i64 %smin804, 1199
...
polly.loop_exit366:                               ; preds = %polly.loop_exit372
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next362, 10
...
polly.loop_header364:                             ; preds = %polly.loop_exit372, %polly.loop_header358
  ...
  %126 = shl nsw i64 %polly.indvar367, 7
...
polly.loop_header376.us:                          ; preds = %polly.loop_header370, %polly.loop_exit385.loopexit.us
  ...
  %132 = add nuw nsw i64 %polly.indvar379.us, %125
  %133 = shl i64 %132, 3
...
polly.loop_exit385.loopexit.us:                   ; preds = %polly.loop_header383.us
  ...
  %exitcond801.not = icmp eq i64 %polly.indvar_next380.us, 100
  br i1 %exitcond801.not, label %polly.loop_exit378, label %polly.loop_header376.us
...
polly.loop_exit378:                               ; preds = %polly.loop_exit385.loopexit.us, %polly.loop_header370
  ...
  %exitcond805.not = icmp eq i64 %polly.indvar373, %124
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  ...
  %149 = shl nsw i64 %polly.indvar510, 7
  %150 = add nsw i64 %smin824, 1199
...
polly.loop_header513:                             ; preds = %polly.loop_exit521, %polly.loop_header507
  ...
  %151 = mul nuw nsw i64 %polly.indvar516, 100
...
polly.loop_exit521:                               ; preds = %polly.loop_exit527
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next517, 10
...
polly.loop_header519:                             ; preds = %polly.loop_exit527, %polly.loop_header513
  ...
  %152 = shl nsw i64 %polly.indvar522, 7
...
polly.loop_header531.us:                          ; preds = %polly.loop_header525, %polly.loop_exit540.loopexit.us
  ...
  %158 = add nuw nsw i64 %polly.indvar534.us, %151
  %159 = shl i64 %158, 3
...
polly.loop_exit540.loopexit.us:                   ; preds = %polly.loop_header538.us
  ...
  %exitcond821.not = icmp eq i64 %polly.indvar_next535.us, 100
  br i1 %exitcond821.not, label %polly.loop_exit533, label %polly.loop_header531.us
...
polly.loop_exit533:                               ; preds = %polly.loop_exit540.loopexit.us, %polly.loop_header525
  ...
  %exitcond825.not = icmp eq i64 %polly.indvar528, %150
