; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7720.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7720.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next225, 10
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %polly.loop_guard237.not = icmp sgt i64 %109, %103
...
polly.loop_header234.preheader:                   ; preds = %polly.loop_header227
  ...
  %110 = add i64 %smax, %indvars.iv851
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit243
  %indvars.iv853 = phi i64 [ %110, %polly.loop_header234.preheader ], [ %indvars.iv.next854, %polly.loop_exit243 ]
  %polly.indvar238 = phi i64 [ %109, %polly.loop_header234.preheader ], [ %polly.indvar_next239, %polly.loop_exit243 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 127)
  %112 = add nsw i64 %polly.indvar238, %111
  %polly.loop_guard251942 = icmp sgt i64 %112, -1
  %113 = add nuw nsw i64 %polly.indvar238, %104
  %114 = mul i64 %113, 8000
  %115 = mul i64 %113, 9600
  br i1 %polly.loop_guard251942, label %polly.loop_header241.us, label %polly.loop_exit243
...
polly.loop_header241.us:                          ; preds = %polly.loop_header234, %polly.loop_exit250.loopexit.us
  ...
  %117 = shl i64 %116, 3
  %polly.access.mul.Packed_MemRef_call2258.us = mul nuw nsw i64 %116, 1200
  %polly.access.add.Packed_MemRef_call2259.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2258.us, %113
  ...
  %118 = add i64 %117, %114
  %scevgep266.us = getelementptr i8, i8* %call1, i64 %118
...
polly.loop_header248.us:                          ; preds = %polly.loop_header241.us, %polly.loop_header248.us
  ...
  %119 = add nuw nsw i64 %polly.indvar252.us, %106
  ...
  %polly.access.add.Packed_MemRef_call2263.us = add nuw nsw i64 %119, %polly.access.mul.Packed_MemRef_call2258.us
...
polly.loop_exit250.loopexit.us:                   ; preds = %polly.loop_header248.us
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar_next245.us, 100
  br i1 %exitcond855.not, label %polly.loop_exit243, label %polly.loop_header241.us
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.start274
  ...
  %124 = add i64 %indvar1052, 1
  %125 = mul nuw nsw i64 %polly.indvar363, 9600
  %scevgep372 = getelementptr i8, i8* %call, i64 %125
  %min.iters.check1054 = icmp ult i64 %124, 4
...
vector.body1051:                                  ; preds = %vector.body1051, %vector.ph1055
  ...
  %126 = shl nuw nsw i64 %index1058, 3
  %127 = getelementptr i8, i8* %scevgep372, i64 %126
  %128 = bitcast i8* %127 to <4 x double>*
  %wide.load1062 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !74, !noalias !76
  %129 = fmul fast <4 x double> %wide.load1062, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %131 = icmp eq i64 %index.next1059, %n.vec1057
  br i1 %131, label %middle.block1049, label %vector.body1051, !llvm.loop !80

middle.block1049:                                 ; preds = %vector.body1051
  %cmp.n1061 = icmp eq i64 %124, %n.vec1057
...
polly.loop_header366:                             ; preds = %polly.loop_header366.preheader, %polly.loop_header366
  ...
  %132 = shl nuw nsw i64 %polly.indvar369, 3
  %scevgep373 = getelementptr i8, i8* %scevgep372, i64 %132
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %polly.indvar395 = phi i64 [ %135, %polly.loop_exit400 ], [ 0, %polly.loop_exit384 ]
  %133 = lshr i64 %indvars.iv879, 2
  %134 = sub nsw i64 %indvars.iv879, %133
  %135 = add nuw nsw i64 %polly.indvar395, 1
  %pexp.p_div_q404 = lshr i64 %135, 2
  %polly.loop_guard409.not = icmp ult i64 %polly.indvar395, %pexp.p_div_q404
  %136 = mul nsw i64 %polly.indvar395, -96
  %137 = icmp slt i64 %136, -1104
  %138 = select i1 %137, i64 %136, i64 -1104
  %139 = add nsw i64 %138, 1199
  %140 = mul nuw nsw i64 %polly.indvar395, 96
...
polly.loop_exit400:                               ; preds = %polly.loop_exit408
  ...
  %exitcond883.not = icmp eq i64 %135, 13
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  %141 = mul nuw nsw i64 %polly.indvar401, 100
  br label %polly.loop_header406

polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  %polly.indvar_next402 = add nuw nsw i64 %polly.indvar401, 1
  %exitcond882.not = icmp eq i64 %polly.indvar_next402, 10
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %142 = shl nsw i64 %polly.indvar410, 7
  %143 = add nsw i64 %142, %136
  %144 = icmp sgt i64 %143, 0
  %145 = select i1 %144, i64 %143, i64 0
  %polly.loop_guard417.not = icmp sgt i64 %145, %139
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %exitcond881.not = icmp eq i64 %polly.indvar_next411, %134
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  %indvars.iv874 = phi i64 [ %146, %polly.loop_header414.preheader ], [ %indvars.iv.next875, %polly.loop_exit423 ]
  %polly.indvar418 = phi i64 [ %145, %polly.loop_header414.preheader ], [ %polly.indvar_next419, %polly.loop_exit423 ]
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv874, i64 127)
  %148 = add nsw i64 %polly.indvar418, %147
  %polly.loop_guard431943 = icmp sgt i64 %148, -1
  %149 = add nuw nsw i64 %polly.indvar418, %140
  %150 = mul i64 %149, 8000
  %151 = mul i64 %149, 9600
  br i1 %polly.loop_guard431943, label %polly.loop_header421.us, label %polly.loop_exit423
...
polly.loop_header421.us:                          ; preds = %polly.loop_header414, %polly.loop_exit430.loopexit.us
  ...
  %152 = add nuw nsw i64 %polly.indvar424.us, %141
  %153 = shl i64 %152, 3
  %polly.access.mul.Packed_MemRef_call2277438.us = mul nuw nsw i64 %152, 1200
  %polly.access.add.Packed_MemRef_call2277439.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2277438.us, %149
  ...
  %154 = add i64 %153, %150
  %scevgep446.us = getelementptr i8, i8* %call1, i64 %154
...
polly.loop_header428.us:                          ; preds = %polly.loop_header421.us, %polly.loop_header428.us
  ...
  %155 = add nuw nsw i64 %polly.indvar432.us, %142
  %156 = mul nuw nsw i64 %155, 8000
  %157 = add nuw nsw i64 %156, %153
  %scevgep435.us = getelementptr i8, i8* %call1, i64 %157
  ...
  %polly.access.add.Packed_MemRef_call2277443.us = add nuw nsw i64 %155, %polly.access.mul.Packed_MemRef_call2277438.us
  ...
  %158 = shl i64 %155, 3
  %159 = add i64 %158, %151
  %scevgep449.us = getelementptr i8, i8* %call, i64 %159
...
polly.loop_exit430.loopexit.us:                   ; preds = %polly.loop_header428.us
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar_next425.us, 100
  br i1 %exitcond878.not, label %polly.loop_exit423, label %polly.loop_header421.us
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430.loopexit.us, %polly.loop_header414
  ...
  %polly.loop_cond420.not.not = icmp ult i64 %polly.indvar418, %139
...
polly.loop_header540:                             ; preds = %polly.loop_exit548, %polly.start454
  ...
  %161 = mul nuw nsw i64 %polly.indvar543, 9600
  %scevgep552 = getelementptr i8, i8* %call, i64 %161
  %min.iters.check1028 = icmp ult i64 %160, 4
...
vector.body1027:                                  ; preds = %vector.body1027, %vector.ph1029
  ...
  %162 = shl nuw nsw i64 %index1032, 3
  %163 = getelementptr i8, i8* %scevgep552, i64 %162
  %164 = bitcast i8* %163 to <4 x double>*
  %wide.load1036 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !84, !noalias !86
  %165 = fmul fast <4 x double> %wide.load1036, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %167 = icmp eq i64 %index.next1033, %n.vec1031
  br i1 %167, label %middle.block1025, label %vector.body1027, !llvm.loop !90

middle.block1025:                                 ; preds = %vector.body1027
  %cmp.n1035 = icmp eq i64 %160, %n.vec1031
...
polly.loop_header546:                             ; preds = %polly.loop_header546.preheader, %polly.loop_header546
  ...
  %168 = shl nuw nsw i64 %polly.indvar549, 3
  %scevgep553 = getelementptr i8, i8* %scevgep552, i64 %168
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %polly.indvar575 = phi i64 [ %171, %polly.loop_exit580 ], [ 0, %polly.loop_exit564 ]
  %169 = lshr i64 %indvars.iv902, 2
  %170 = sub nsw i64 %indvars.iv902, %169
  %171 = add nuw nsw i64 %polly.indvar575, 1
  %pexp.p_div_q584 = lshr i64 %171, 2
  %polly.loop_guard589.not = icmp ult i64 %polly.indvar575, %pexp.p_div_q584
  %172 = mul nsw i64 %polly.indvar575, -96
  %173 = icmp slt i64 %172, -1104
  %174 = select i1 %173, i64 %172, i64 -1104
  %175 = add nsw i64 %174, 1199
  %176 = mul nuw nsw i64 %polly.indvar575, 96
...
polly.loop_exit580:                               ; preds = %polly.loop_exit588
  ...
  %exitcond906.not = icmp eq i64 %171, 13
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next582, 10
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %178 = shl nsw i64 %polly.indvar590, 7
  %179 = add nsw i64 %178, %172
  %180 = icmp sgt i64 %179, 0
  %181 = select i1 %180, i64 %179, i64 0
  %polly.loop_guard597.not = icmp sgt i64 %181, %175
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header586
  ...
  %182 = add i64 %smax892, %indvars.iv895
...
polly.loop_exit596:                               ; preds = %polly.loop_exit603, %polly.loop_header586
  ...
  %exitcond904.not = icmp eq i64 %polly.indvar_next591, %170
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit603
  %indvars.iv897 = phi i64 [ %182, %polly.loop_header594.preheader ], [ %indvars.iv.next898, %polly.loop_exit603 ]
  %polly.indvar598 = phi i64 [ %181, %polly.loop_header594.preheader ], [ %polly.indvar_next599, %polly.loop_exit603 ]
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 127)
  %184 = add nsw i64 %polly.indvar598, %183
  %polly.loop_guard611944 = icmp sgt i64 %184, -1
  %185 = add nuw nsw i64 %polly.indvar598, %176
  %186 = mul i64 %185, 8000
  %187 = mul i64 %185, 9600
  br i1 %polly.loop_guard611944, label %polly.loop_header601.us, label %polly.loop_exit603
...
polly.loop_header601.us:                          ; preds = %polly.loop_header594, %polly.loop_exit610.loopexit.us
  ...
  %188 = add nuw nsw i64 %polly.indvar604.us, %177
  %189 = shl i64 %188, 3
  %polly.access.mul.Packed_MemRef_call2457618.us = mul nuw nsw i64 %188, 1200
  %polly.access.add.Packed_MemRef_call2457619.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2457618.us, %185
  ...
  %190 = add i64 %189, %186
  %scevgep626.us = getelementptr i8, i8* %call1, i64 %190
...
polly.loop_header608.us:                          ; preds = %polly.loop_header601.us, %polly.loop_header608.us
  ...
  %191 = add nuw nsw i64 %polly.indvar612.us, %178
  ...
  %polly.access.add.Packed_MemRef_call2457623.us = add nuw nsw i64 %191, %polly.access.mul.Packed_MemRef_call2457618.us
...
polly.loop_exit610.loopexit.us:                   ; preds = %polly.loop_header608.us
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar_next605.us, 100
  br i1 %exitcond901.not, label %polly.loop_exit603, label %polly.loop_header601.us

polly.loop_exit603:                               ; preds = %polly.loop_exit610.loopexit.us, %polly.loop_header594
  %polly.indvar_next599 = add nuw nsw i64 %polly.indvar598, 1
  %polly.loop_cond600.not.not = icmp ult i64 %polly.indvar598, %175
...
polly.loop_header758:                             ; preds = %entry, %polly.loop_exit766
  ...
  %196 = shl nsw i64 %polly.indvar761, 5
  %197 = add nsw i64 %smin937, 1199
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  %198 = mul nsw i64 %polly.indvar767, -32
  %smin966 = call i64 @llvm.smin.i64(i64 %198, i64 -1168)
  %199 = add nsw i64 %smin966, 1200
  %smin933 = call i64 @llvm.smin.i64(i64 %indvars.iv931, i64 -1168)
  %200 = shl nsw i64 %polly.indvar767, 5
  %201 = add nsw i64 %smin933, 1199
...
polly.loop_header770:                             ; preds = %polly.loop_exit778, %polly.loop_header764
  ...
  %202 = add nuw nsw i64 %polly.indvar773, %196
...
vector.ph967:                                     ; preds = %polly.loop_header770
  %broadcast.splatinsert974 = insertelement <4 x i64> poison, i64 %200, i32 0
  %broadcast.splat975 = shufflevector <4 x i64> %broadcast.splatinsert974, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert976 = insertelement <4 x i32> poison, i32 %203, i32 0
...
vector.body965:                                   ; preds = %vector.body965, %vector.ph967
  ...
  %205 = add nuw nsw <4 x i64> %vec.ind972, %broadcast.splat975
  %206 = trunc <4 x i64> %205 to <4 x i32>
  %207 = mul <4 x i32> %broadcast.splat977, %206
  ...
  %217 = icmp eq i64 %index.next969, %199
  br i1 %217, label %polly.loop_exit778, label %vector.body965, !llvm.loop !99

polly.loop_exit778:                               ; preds = %vector.body965, %polly.loop_header776
  %polly.indvar_next774 = add nuw nsw i64 %polly.indvar773, 1
  %exitcond938.not = icmp eq i64 %polly.indvar773, %197
...
polly.loop_header776:                             ; preds = %polly.loop_header770, %polly.loop_header776
  ...
  %218 = add nuw nsw i64 %polly.indvar779, %200
  ...
  %scevgep782 = getelementptr i8, i8* %call, i64 %224
  ...
  %exitcond934.not = icmp eq i64 %polly.indvar779, %201
...
polly.loop_header785:                             ; preds = %polly.loop_exit766, %polly.loop_exit793
  ...
  %225 = shl nsw i64 %polly.indvar788, 5
  %226 = add nsw i64 %smin927, 1199
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %227 = mul nsw i64 %polly.indvar794, -32
  %smin981 = call i64 @llvm.smin.i64(i64 %227, i64 -968)
  %228 = add nsw i64 %smin981, 1000
  %smin923 = call i64 @llvm.smin.i64(i64 %indvars.iv921, i64 -968)
  %229 = shl nsw i64 %polly.indvar794, 5
  %230 = add nsw i64 %smin923, 999
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph983
  ...
  %234 = add nuw nsw <4 x i64> %vec.ind990, %broadcast.splat993
  %235 = trunc <4 x i64> %234 to <4 x i32>
  %236 = mul <4 x i32> %broadcast.splat995, %235
  ...
  %246 = icmp eq i64 %index.next987, %228
  br i1 %246, label %polly.loop_exit805, label %vector.body980, !llvm.loop !102

polly.loop_exit805:                               ; preds = %vector.body980, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond928.not = icmp eq i64 %polly.indvar800, %226
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %247 = add nuw nsw i64 %polly.indvar806, %229
  ...
  %scevgep809 = getelementptr i8, i8* %call2, i64 %253
  ...
  %exitcond924.not = icmp eq i64 %polly.indvar806, %230
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %256 = mul nsw i64 %polly.indvar820, -32
  %smin999 = call i64 @llvm.smin.i64(i64 %256, i64 -968)
  %257 = add nsw i64 %smin999, 1000
  %smin913 = call i64 @llvm.smin.i64(i64 %indvars.iv911, i64 -968)
  %258 = shl nsw i64 %polly.indvar820, 5
  %259 = add nsw i64 %smin913, 999
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1001
  ...
  %263 = add nuw nsw <4 x i64> %vec.ind1008, %broadcast.splat1011
  %264 = trunc <4 x i64> %263 to <4 x i32>
  %265 = mul <4 x i32> %broadcast.splat1013, %264
  ...
  %275 = icmp eq i64 %index.next1005, %257
  br i1 %275, label %polly.loop_exit831, label %vector.body998, !llvm.loop !105

polly.loop_exit831:                               ; preds = %vector.body998, %polly.loop_header829
  %polly.indvar_next827 = add nuw nsw i64 %polly.indvar826, 1
  %exitcond918.not = icmp eq i64 %polly.indvar826, %255
...
polly.loop_header829:                             ; preds = %polly.loop_header823, %polly.loop_header829
  ...
  %276 = add nuw nsw i64 %polly.indvar832, %258
  ...
  %scevgep836 = getelementptr i8, i8* %call1, i64 %282
  ...
  %exitcond914.not = icmp eq i64 %polly.indvar832, %259
