; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6374.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6374.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %indvars.iv864 = phi i64 [ %indvars.iv.next865, %polly.loop_exit229 ], [ 47, %polly.loop_header199 ]
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %105 = mul nuw nsw i64 %polly.indvar208, 23
  %106 = add nuw nsw i64 %105, 47
  %pexp.p_div_q = udiv i64 %106, 48
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -46
  %indvars.iv.next865 = add nuw nsw i64 %indvars.iv864, 23
  %indvars.iv.next869 = add nuw nsw i64 %indvars.iv868, 46
...
polly.loop_header382:                             ; preds = %polly.loop_exit408, %polly.loop_header376
  ...
  %indvars.iv891 = phi i64 [ %indvars.iv.next892, %polly.loop_exit408 ], [ 47, %polly.loop_header376 ]
...
polly.loop_exit390:                               ; preds = %polly.loop_exit396
  ...
  %148 = mul nuw nsw i64 %polly.indvar385, 23
  %149 = add nuw nsw i64 %148, 47
  %pexp.p_div_q404 = udiv i64 %149, 48
  %150 = sub nsw i64 %polly.indvar385, %pexp.p_div_q404
  %polly.loop_guard409 = icmp slt i64 %150, 13
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415, %polly.loop_exit390
  ...
  %indvars.iv.next890 = add nsw i64 %indvars.iv889, -46
  %indvars.iv.next892 = add nuw nsw i64 %indvars.iv891, 23
  %indvars.iv.next897 = add nuw nsw i64 %indvars.iv896, 46
...
polly.loop_header562:                             ; preds = %polly.loop_exit588, %polly.loop_header556
  ...
  %indvars.iv919 = phi i64 [ %indvars.iv.next920, %polly.loop_exit588 ], [ 47, %polly.loop_header556 ]
...
polly.loop_exit570:                               ; preds = %polly.loop_exit576
  ...
  %191 = mul nuw nsw i64 %polly.indvar565, 23
  %192 = add nuw nsw i64 %191, 47
  %pexp.p_div_q584 = udiv i64 %192, 48
  %193 = sub nsw i64 %polly.indvar565, %pexp.p_div_q584
  %polly.loop_guard589 = icmp slt i64 %193, 13
...
polly.loop_exit588:                               ; preds = %polly.loop_exit595, %polly.loop_exit570
  ...
  %indvars.iv.next918 = add nsw i64 %indvars.iv917, -46
  %indvars.iv.next920 = add nuw nsw i64 %indvars.iv919, 23
  %indvars.iv.next925 = add nuw nsw i64 %indvars.iv924, 46
...
polly.loop_header586:                             ; preds = %polly.loop_exit570, %polly.loop_exit595
  ...
  %197 = mul nsw i64 %polly.indvar590, 96
  %198 = sub nsw i64 %189, %197
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %201 = mul nsw i64 %polly.indvar590, -96
