; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8107.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8107.c"
...
polly.loop_header223.us:                          ; preds = %polly.loop_header211, %polly.loop_exit232.us
  %indvars.iv791 = phi i64 [ %indvars.iv.next792, %polly.loop_exit232.us ], [ %110, %polly.loop_header211 ]
...
polly.loop_exit219:                               ; preds = %polly.loop_exit232.us.3, %polly.loop_header211
  ...
  %indvars.iv.next790 = add i64 %indvars.iv789, 8
  %exitcond794.not = icmp eq i64 %polly.indvar_next215, 150
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph999
  ...
  %wide.load1006 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %132, label %middle.block993, label %vector.body995, !llvm.loop !76
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %141 = lshr i64 %polly.indvar363, 1
  %142 = shl nuw nsw i64 %141, 3
  %143 = sub nsw i64 %indvars.iv799, %142
  %144 = add i64 %indvars.iv804, %142
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv806 = phi i64 [ %indvars.iv.next807, %polly.loop_exit375 ], [ %144, %polly.loop_header360 ]
  %indvars.iv801 = phi i64 [ %indvars.iv.next802, %polly.loop_exit375 ], [ %143, %polly.loop_header360 ]
  %polly.indvar370 = phi i64 [ %polly.indvar_next371, %polly.loop_exit375 ], [ %141, %polly.loop_header360 ]
  %smax803 = call i64 @llvm.smax.i64(i64 %indvars.iv801, i64 0)
  %147 = add i64 %smax803, %indvars.iv806
  %148 = shl nsw i64 %polly.indvar370, 3
  %149 = sub nsw i64 %145, %148
  %150 = icmp sgt i64 %149, 0
  %151 = select i1 %150, i64 %149, i64 0
  %polly.loop_guard383 = icmp slt i64 %151, 8
...
polly.loop_header380.us:                          ; preds = %polly.loop_header367, %polly.loop_exit390.us
  %indvars.iv808 = phi i64 [ %indvars.iv.next809, %polly.loop_exit390.us ], [ %147, %polly.loop_header367 ]
...
polly.loop_header388.us:                          ; preds = %polly.loop_header388.preheader.us, %polly.loop_header388.us
  ...
  %exitcond811.not = icmp eq i64 %polly.indvar392.us, %smin810
  br i1 %exitcond811.not, label %polly.loop_exit390.us, label %polly.loop_header388.us
...
polly.loop_exit375:                               ; preds = %polly.loop_exit390.us.3, %polly.loop_header367
  ...
  %indvars.iv.next802 = add i64 %indvars.iv801, -8
  %indvars.iv.next807 = add i64 %indvars.iv806, 8
  %exitcond813.not = icmp eq i64 %polly.indvar_next371, 150
...
vector.body971:                                   ; preds = %vector.body971, %vector.ph973
  ...
  %wide.load980 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %169, label %middle.block969, label %vector.body971, !llvm.loop !85
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %178 = lshr i64 %polly.indvar521, 1
  %179 = shl nuw nsw i64 %178, 3
  %180 = sub nsw i64 %indvars.iv818, %179
  %181 = add i64 %indvars.iv823, %179
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv825 = phi i64 [ %indvars.iv.next826, %polly.loop_exit533 ], [ %181, %polly.loop_header518 ]
  %indvars.iv820 = phi i64 [ %indvars.iv.next821, %polly.loop_exit533 ], [ %180, %polly.loop_header518 ]
  %polly.indvar528 = phi i64 [ %polly.indvar_next529, %polly.loop_exit533 ], [ %178, %polly.loop_header518 ]
  %smax822 = call i64 @llvm.smax.i64(i64 %indvars.iv820, i64 0)
  %184 = add i64 %smax822, %indvars.iv825
  %185 = shl nsw i64 %polly.indvar528, 3
  %186 = sub nsw i64 %182, %185
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %polly.loop_guard541 = icmp slt i64 %188, 8
...
polly.loop_header538.us:                          ; preds = %polly.loop_header525, %polly.loop_exit548.us
  %indvars.iv827 = phi i64 [ %indvars.iv.next828, %polly.loop_exit548.us ], [ %184, %polly.loop_header525 ]
...
polly.loop_header546.us:                          ; preds = %polly.loop_header546.preheader.us, %polly.loop_header546.us
  ...
  %exitcond830.not = icmp eq i64 %polly.indvar550.us, %smin829
  br i1 %exitcond830.not, label %polly.loop_exit548.us, label %polly.loop_header546.us
...
polly.loop_exit533:                               ; preds = %polly.loop_exit548.us.3, %polly.loop_header525
  ...
  %indvars.iv.next821 = add i64 %indvars.iv820, -8
  %indvars.iv.next826 = add i64 %indvars.iv825, 8
  %exitcond832.not = icmp eq i64 %polly.indvar_next529, 150
...
vector.body909:                                   ; preds = %vector.body909, %vector.ph911
  ...
  br i1 %220, label %polly.loop_exit714, label %vector.body909, !llvm.loop !94
...
vector.body924:                                   ; preds = %vector.body924, %vector.ph927
  ...
  br i1 %249, label %polly.loop_exit741, label %vector.body924, !llvm.loop !97
...
vector.body942:                                   ; preds = %vector.body942, %vector.ph945
  ...
  br i1 %278, label %polly.loop_exit767, label %vector.body942, !llvm.loop !100
...
polly.loop_header223.us.1:                        ; preds = %polly.loop_exit232.us, %polly.loop_exit232.us.1
  %indvars.iv791.1 = phi i64 [ %indvars.iv.next792.1, %polly.loop_exit232.us.1 ], [ %110, %polly.loop_exit232.us ]
...
polly.loop_exit232.us.1:                          ; preds = %polly.loop_header230.us.1, %polly.loop_header223.us.1
  ...
  %polly.loop_cond228.us.1 = icmp ult i64 %polly.indvar226.us.1, 7
...
polly.loop_header223.us.2:                        ; preds = %polly.loop_exit232.us.1, %polly.loop_exit232.us.2
  %indvars.iv791.2 = phi i64 [ %indvars.iv.next792.2, %polly.loop_exit232.us.2 ], [ %110, %polly.loop_exit232.us.1 ]
...
polly.loop_exit232.us.2:                          ; preds = %polly.loop_header230.us.2, %polly.loop_header223.us.2
  ...
  %polly.loop_cond228.us.2 = icmp ult i64 %polly.indvar226.us.2, 7
...
polly.loop_header223.us.3:                        ; preds = %polly.loop_exit232.us.2, %polly.loop_exit232.us.3
  %indvars.iv791.3 = phi i64 [ %indvars.iv.next792.3, %polly.loop_exit232.us.3 ], [ %110, %polly.loop_exit232.us.2 ]
...
polly.loop_exit232.us.3:                          ; preds = %polly.loop_header230.us.3, %polly.loop_header223.us.3
  ...
  %polly.loop_cond228.us.3 = icmp ult i64 %polly.indvar226.us.3, 7
...
polly.loop_header380.us.1:                        ; preds = %polly.loop_exit390.us, %polly.loop_exit390.us.1
  %indvars.iv808.1 = phi i64 [ %indvars.iv.next809.1, %polly.loop_exit390.us.1 ], [ %147, %polly.loop_exit390.us ]
...
polly.loop_header388.us.1:                        ; preds = %polly.loop_header388.us.1, %polly.loop_header388.preheader.us.1
  ...
  %exitcond811.1.not = icmp eq i64 %polly.indvar392.us.1, %smin810.1
  br i1 %exitcond811.1.not, label %polly.loop_exit390.us.1, label %polly.loop_header388.us.1
...
polly.loop_exit390.us.1:                          ; preds = %polly.loop_header388.us.1, %polly.loop_header380.us.1
  ...
  %polly.loop_cond386.us.1 = icmp ult i64 %polly.indvar384.us.1, 7
...
polly.loop_header380.us.2:                        ; preds = %polly.loop_exit390.us.1, %polly.loop_exit390.us.2
  %indvars.iv808.2 = phi i64 [ %indvars.iv.next809.2, %polly.loop_exit390.us.2 ], [ %147, %polly.loop_exit390.us.1 ]
...
polly.loop_header388.us.2:                        ; preds = %polly.loop_header388.us.2, %polly.loop_header388.preheader.us.2
  ...
  %exitcond811.2.not = icmp eq i64 %polly.indvar392.us.2, %smin810.2
  br i1 %exitcond811.2.not, label %polly.loop_exit390.us.2, label %polly.loop_header388.us.2
...
polly.loop_exit390.us.2:                          ; preds = %polly.loop_header388.us.2, %polly.loop_header380.us.2
  ...
  %polly.loop_cond386.us.2 = icmp ult i64 %polly.indvar384.us.2, 7
...
polly.loop_header380.us.3:                        ; preds = %polly.loop_exit390.us.2, %polly.loop_exit390.us.3
  %indvars.iv808.3 = phi i64 [ %indvars.iv.next809.3, %polly.loop_exit390.us.3 ], [ %147, %polly.loop_exit390.us.2 ]
...
polly.loop_header388.us.3:                        ; preds = %polly.loop_header388.us.3, %polly.loop_header388.preheader.us.3
  ...
  %exitcond811.3.not = icmp eq i64 %polly.indvar392.us.3, %smin810.3
  br i1 %exitcond811.3.not, label %polly.loop_exit390.us.3, label %polly.loop_header388.us.3
...
polly.loop_exit390.us.3:                          ; preds = %polly.loop_header388.us.3, %polly.loop_header380.us.3
  ...
  %polly.loop_cond386.us.3 = icmp ult i64 %polly.indvar384.us.3, 7
...
polly.loop_header538.us.1:                        ; preds = %polly.loop_exit548.us, %polly.loop_exit548.us.1
  %indvars.iv827.1 = phi i64 [ %indvars.iv.next828.1, %polly.loop_exit548.us.1 ], [ %184, %polly.loop_exit548.us ]
...
polly.loop_header546.us.1:                        ; preds = %polly.loop_header546.us.1, %polly.loop_header546.preheader.us.1
  ...
  %exitcond830.1.not = icmp eq i64 %polly.indvar550.us.1, %smin829.1
  br i1 %exitcond830.1.not, label %polly.loop_exit548.us.1, label %polly.loop_header546.us.1
...
polly.loop_exit548.us.1:                          ; preds = %polly.loop_header546.us.1, %polly.loop_header538.us.1
  ...
  %polly.loop_cond544.us.1 = icmp ult i64 %polly.indvar542.us.1, 7
...
polly.loop_header538.us.2:                        ; preds = %polly.loop_exit548.us.1, %polly.loop_exit548.us.2
  %indvars.iv827.2 = phi i64 [ %indvars.iv.next828.2, %polly.loop_exit548.us.2 ], [ %184, %polly.loop_exit548.us.1 ]
...
polly.loop_header546.us.2:                        ; preds = %polly.loop_header546.us.2, %polly.loop_header546.preheader.us.2
  ...
  %exitcond830.2.not = icmp eq i64 %polly.indvar550.us.2, %smin829.2
  br i1 %exitcond830.2.not, label %polly.loop_exit548.us.2, label %polly.loop_header546.us.2
...
polly.loop_exit548.us.2:                          ; preds = %polly.loop_header546.us.2, %polly.loop_header538.us.2
  ...
  %polly.loop_cond544.us.2 = icmp ult i64 %polly.indvar542.us.2, 7
...
polly.loop_header538.us.3:                        ; preds = %polly.loop_exit548.us.2, %polly.loop_exit548.us.3
  %indvars.iv827.3 = phi i64 [ %indvars.iv.next828.3, %polly.loop_exit548.us.3 ], [ %184, %polly.loop_exit548.us.2 ]
...
polly.loop_header546.us.3:                        ; preds = %polly.loop_header546.us.3, %polly.loop_header546.preheader.us.3
  ...
  %exitcond830.3.not = icmp eq i64 %polly.indvar550.us.3, %smin829.3
  br i1 %exitcond830.3.not, label %polly.loop_exit548.us.3, label %polly.loop_header546.us.3
...
polly.loop_exit548.us.3:                          ; preds = %polly.loop_header546.us.3, %polly.loop_header538.us.3
  ...
  %polly.loop_cond544.us.3 = icmp ult i64 %polly.indvar542.us.3, 7
