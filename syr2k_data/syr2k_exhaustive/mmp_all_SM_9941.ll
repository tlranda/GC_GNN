; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9941.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9941.c"
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph973
  ...
  %wide.load980 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %134, label %middle.block967, label %vector.body969, !llvm.loop !74
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %136 = lshr i64 %polly.indvar355, 1
  %137 = mul nuw nsw i64 %polly.indvar355, 50
...
polly.loop_header365:                             ; preds = %polly.loop_exit373, %polly.loop_header358
  ...
  %153 = mul nuw nsw i64 %polly.indvar368, 100
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph947
  ...
  %wide.load954 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %173, label %middle.block943, label %vector.body945, !llvm.loop !83
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %175 = lshr i64 %polly.indvar511, 1
  %176 = mul nuw nsw i64 %polly.indvar511, 50
...
polly.loop_header521:                             ; preds = %polly.loop_exit529, %polly.loop_header514
  ...
  %192 = mul nuw nsw i64 %polly.indvar524, 100
...
vector.body883:                                   ; preds = %vector.body883, %vector.ph885
  ...
  br i1 %226, label %polly.loop_exit708, label %vector.body883, !llvm.loop !92
...
vector.body898:                                   ; preds = %vector.body898, %vector.ph901
  ...
  br i1 %255, label %polly.loop_exit735, label %vector.body898, !llvm.loop !95
...
vector.body916:                                   ; preds = %vector.body916, %vector.ph919
  ...
  br i1 %284, label %polly.loop_exit761, label %vector.body916, !llvm.loop !98
