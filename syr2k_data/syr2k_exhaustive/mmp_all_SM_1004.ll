; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1004.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1004.c"
...
vector.body1331:                                  ; preds = %vector.body1331, %vector.ph1333
  ...
  br i1 %57, label %middle.block1329, label %vector.body1331, !llvm.loop !63
...
vector.body1381:                                  ; preds = %vector.body1381, %vector.ph1383
  ...
  br i1 %68, label %middle.block1379, label %vector.body1381, !llvm.loop !65
...
vector.body1393:                                  ; preds = %vector.body1393, %vector.ph1397
  ...
  %wide.load1404 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1391, label %vector.body1393, !llvm.loop !78
...
vector.body1407:                                  ; preds = %vector.body1407, %vector.ph1415
  ...
  %wide.load1428 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %163, label %middle.block1405, label %vector.body1407, !llvm.loop !83
...
vector.body1343:                                  ; preds = %vector.body1343, %vector.ph1347
  ...
  %wide.load1354 = load <4 x double>, <4 x double>* %171, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %174, label %middle.block1341, label %vector.body1343, !llvm.loop !92
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_header402
  ...
  br i1 %exitcond1135.not, label %polly.loop_exit404, label %polly.loop_header402, !llvm.loop !93
...
vector.body1357:                                  ; preds = %vector.body1357, %vector.ph1365
  ...
  %wide.load1378 = load <4 x double>, <4 x double>* %237, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %242, label %middle.block1355, label %vector.body1357, !llvm.loop !96
...
polly.loop_header495:                             ; preds = %polly.loop_header495.preheader1433, %polly.loop_header495
  ...
  br i1 %exitcond1131.not, label %polly.loop_exit497, label %polly.loop_header495, !llvm.loop !97
...
vector.body1295:                                  ; preds = %vector.body1295, %vector.ph1297
  ...
  %wide.load1304 = load <4 x double>, <4 x double>* %250, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %253, label %middle.block1293, label %vector.body1295, !llvm.loop !105
...
vector.body1307:                                  ; preds = %vector.body1307, %vector.ph1315
  ...
  %wide.load1328 = load <4 x double>, <4 x double>* %316, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %319, <4 x double>* %320, align 8, !alias.scope !98, !noalias !100
  %index.next1319 = add i64 %index1318, 4
  %321 = icmp eq i64 %index.next1319, %n.vec1317
  br i1 %321, label %middle.block1305, label %vector.body1307, !llvm.loop !109
...
polly.loop_header710:                             ; preds = %polly.loop_header710.preheader1437, %polly.loop_header710
  ...
  br i1 %exitcond1158.not, label %polly.loop_exit712, label %polly.loop_header710, !llvm.loop !110
...
vector.body1233:                                  ; preds = %vector.body1233, %vector.ph1235
  ...
  br i1 %346, label %polly.loop_exit882, label %vector.body1233, !llvm.loop !116
...
vector.body1248:                                  ; preds = %vector.body1248, %vector.ph1251
  ...
  br i1 %375, label %polly.loop_exit909, label %vector.body1248, !llvm.loop !119
...
vector.body1266:                                  ; preds = %vector.body1266, %vector.ph1269
  ...
  br i1 %404, label %polly.loop_exit935, label %vector.body1266, !llvm.loop !122
