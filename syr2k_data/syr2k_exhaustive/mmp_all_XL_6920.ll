; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6920.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6920.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next219, 75
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %99 = shl nsw i64 %polly.indvar224, 4
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %128 = mul nsw i64 %polly.indvar393, -16
  %129 = shl nsw i64 %polly.indvar393, 4
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit404
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next857 = add nsw i64 %indvars.iv856, -16
  %indvars.iv.next862 = add nuw nsw i64 %indvars.iv861, 16
  %indvars.iv.next874 = add nuw nsw i64 %indvars.iv873, 2
  %exitcond877.not = icmp eq i64 %polly.indvar_next394, 75
...
polly.loop_header396:                             ; preds = %polly.loop_exit404, %polly.loop_header390
  ...
  %130 = shl nsw i64 %polly.indvar399, 4
...
polly.loop_exit404:                               ; preds = %polly.loop_exit411
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar_next400, 63
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %polly.loop_guard412 = icmp slt i64 %135, 16
...
polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  ...
  %159 = mul nsw i64 %polly.indvar570, -16
  %160 = shl nsw i64 %polly.indvar570, 4
...
polly.loop_exit575:                               ; preds = %polly.loop_exit581
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar_next571, 75
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_header567
  ...
  %smin897 = call i64 @llvm.smin.i64(i64 %indvars.iv895, i64 -984)
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588
  ...
  %indvars.iv.next896 = add nsw i64 %indvars.iv895, -16
  %exitcond902.not = icmp eq i64 %polly.indvar_next577, 63
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %polly.loop_guard589 = icmp slt i64 %166, 16
