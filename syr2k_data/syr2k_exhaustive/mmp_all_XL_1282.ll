; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1282.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1282.c"
...
vector.body1353:                                  ; preds = %vector.body1353, %vector.ph1355
  ...
  br i1 %57, label %middle.block1351, label %vector.body1353, !llvm.loop !63
...
vector.body1403:                                  ; preds = %vector.body1403, %vector.ph1405
  ...
  br i1 %68, label %middle.block1401, label %vector.body1403, !llvm.loop !65
...
vector.body1415:                                  ; preds = %vector.body1415, %vector.ph1419
  ...
  %wide.load1426 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1413, label %vector.body1415, !llvm.loop !78
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1120.not = icmp eq i64 %polly.indvar_next204, 16
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %polly.indvar209 = phi i64 [ %112, %polly.loop_exit230 ], [ 0, %polly.loop_header200 ]
  %99 = shl nuw nsw i64 %polly.indvar209, 6
  %100 = shl nuw nsw i64 %polly.indvar209, 6
  %101 = and i64 %100, 9223372036854775680
  %102 = sub nsw i64 %99, %101
  %103 = mul nsw i64 %polly.indvar209, -64
  %104 = add i64 %103, %101
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  %112 = add nuw nsw i64 %polly.indvar209, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -64
  %indvars.iv.next1105 = add nuw nsw i64 %indvars.iv1104, 64
  %indvars.iv.next1109 = add nsw i64 %indvars.iv1108, -64
  %exitcond1119.not = icmp eq i64 %112, 19
  br i1 %exitcond1119.not, label %polly.loop_exit208, label %polly.loop_header206

polly.loop_header212:                             ; preds = %polly.loop_exit220, %polly.loop_header206
  %polly.indvar215 = phi i64 [ 0, %polly.loop_header206 ], [ %polly.indvar_next216, %polly.loop_exit220 ]
  %113 = add nuw nsw i64 %polly.indvar215, %98
...
polly.loop_header218:                             ; preds = %polly.loop_header218, %polly.loop_header212
  ...
  %114 = add nuw nsw i64 %polly.indvar221, %110
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %115 = mul nsw i64 %indvar1430, -128
  %116 = add i64 %102, %115
  %smax1432 = call i64 @llvm.smax.i64(i64 %116, i64 0)
  %117 = shl nuw nsw i64 %indvar1430, 7
  %118 = add i64 %104, %117
  %119 = add i64 %smax1432, %118
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1106, i64 0)
  %120 = add i64 %smax, %indvars.iv1110
  %121 = shl nuw nsw i64 %polly.indvar231, 1
  %.not.not = icmp ugt i64 %121, %polly.indvar209
  %122 = shl nsw i64 %polly.indvar231, 7
  %123 = add nsw i64 %122, %109
  %124 = icmp sgt i64 %123, 0
  %125 = select i1 %124, i64 %123, i64 0
  %126 = add nsw i64 %123, 127
...
polly.loop_header240.us:                          ; preds = %polly.loop_header234.us, %polly.loop_header240.us
  ...
  %130 = add nuw nsw i64 %polly.indvar243.us, %110
  ...
  %exitcond1101.not = icmp eq i64 %polly.indvar_next244.us, 64
  br i1 %exitcond1101.not, label %polly.merge.loopexit.us, label %polly.loop_header240.us

polly.loop_header250.us:                          ; preds = %polly.merge.loopexit.us, %polly.loop_header250.us
  %polly.indvar253.us = phi i64 [ %polly.indvar_next254.us, %polly.loop_header250.us ], [ %125, %polly.merge.loopexit.us ]
  %131 = add nuw nsw i64 %polly.indvar253.us, %110
...
polly.loop_header250:                             ; preds = %polly.loop_header234, %polly.loop_header250
  %polly.indvar253 = phi i64 [ %polly.indvar_next254, %polly.loop_header250 ], [ %125, %polly.loop_header234 ]
  %140 = add nuw nsw i64 %polly.indvar253, %110
  %polly.access.mul.call1257 = mul nsw i64 %140, 1000
  %polly.access.add.call1258 = add nuw nsw i64 %132, %polly.access.mul.call1257
...
polly.loop_header270:                             ; preds = %polly.loop_header263, %polly.loop_exit280
  ...
  %indvars.iv1112 = phi i64 [ %120, %polly.loop_header263 ], [ %indvars.iv.next1113, %polly.loop_exit280 ]
  %polly.indvar274 = phi i64 [ %135, %polly.loop_header263 ], [ %polly.indvar_next275, %polly.loop_exit280 ]
  %141 = add i64 %119, %indvar1433
  %smin1435 = call i64 @llvm.smin.i64(i64 %141, i64 63)
  %142 = add nsw i64 %smin1435, 1
  %smin1114 = call i64 @llvm.smin.i64(i64 %indvars.iv1112, i64 63)
  %143 = add nsw i64 %polly.indvar274, %123
  %polly.loop_guard2811224 = icmp sgt i64 %143, -1
...
polly.loop_header278.preheader:                   ; preds = %polly.loop_header270
  %144 = add nuw nsw i64 %polly.indvar274, %122
  %polly.access.add.Packed_MemRef_call2290 = add nsw i64 %143, %polly.access.mul.Packed_MemRef_call1285
  ...
  %min.iters.check1436 = icmp ult i64 %142, 4
...
vector.body1429:                                  ; preds = %vector.body1429, %vector.ph1437
  ...
  %146 = add nuw nsw i64 %index1440, %110
  %147 = add nuw nsw i64 %index1440, %polly.access.mul.Packed_MemRef_call1285
  %148 = getelementptr double, double* %Packed_MemRef_call1, i64 %147
  %149 = bitcast double* %148 to <4 x double>*
  %wide.load1444 = load <4 x double>, <4 x double>* %149, align 8
  %150 = fmul fast <4 x double> %broadcast.splat1446, %wide.load1444
  %151 = getelementptr double, double* %Packed_MemRef_call2, i64 %147
  %152 = bitcast double* %151 to <4 x double>*
  %wide.load1447 = load <4 x double>, <4 x double>* %152, align 8
  %153 = fmul fast <4 x double> %broadcast.splat1449, %wide.load1447
  %154 = shl i64 %146, 3
  %155 = add i64 %154, %145
  %156 = getelementptr i8, i8* %call, i64 %155
  %157 = bitcast i8* %156 to <4 x double>*
  %wide.load1450 = load <4 x double>, <4 x double>* %157, align 8, !alias.scope !71, !noalias !73
  ...
  %160 = fadd fast <4 x double> %159, %wide.load1450
  ...
  %162 = icmp eq i64 %index.next1441, %n.vec1439
  br i1 %162, label %middle.block1427, label %vector.body1429, !llvm.loop !83

middle.block1427:                                 ; preds = %vector.body1429
  %cmp.n1443 = icmp eq i64 %142, %n.vec1439
...
polly.loop_exit280:                               ; preds = %polly.loop_header278, %middle.block1427, %polly.loop_header270
  ...
  %polly.loop_cond276.not.not = icmp slt i64 %polly.indvar274, %139
...
polly.loop_header278:                             ; preds = %polly.loop_header278.preheader1451, %polly.loop_header278
  ...
  %163 = add nuw nsw i64 %polly.indvar282, %110
  ...
  %164 = shl i64 %163, 3
  %165 = add i64 %164, %145
  %scevgep301 = getelementptr i8, i8* %call, i64 %165
  ...
  br i1 %exitcond1115.not, label %polly.loop_exit280, label %polly.loop_header278, !llvm.loop !84
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.start306
  ...
  %166 = add i64 %indvar1366, 1
  %167 = mul nuw nsw i64 %polly.indvar397, 9600
  %scevgep406 = getelementptr i8, i8* %call, i64 %167
  %min.iters.check1368 = icmp ult i64 %166, 4
...
vector.body1365:                                  ; preds = %vector.body1365, %vector.ph1369
  ...
  %168 = shl nuw nsw i64 %index1372, 3
  %169 = getelementptr i8, i8* %scevgep406, i64 %168
  %170 = bitcast i8* %169 to <4 x double>*
  %wide.load1376 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !85, !noalias !87
  %171 = fmul fast <4 x double> %wide.load1376, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %173 = icmp eq i64 %index.next1373, %n.vec1371
  br i1 %173, label %middle.block1363, label %vector.body1365, !llvm.loop !92

middle.block1363:                                 ; preds = %vector.body1365
  %cmp.n1375 = icmp eq i64 %166, %n.vec1371
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_header400
  ...
  %174 = shl nuw nsw i64 %polly.indvar403, 3
  %scevgep407 = getelementptr i8, i8* %scevgep406, i64 %174
  ...
  br i1 %exitcond1153.not, label %polly.loop_exit402, label %polly.loop_header400, !llvm.loop !93
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %smin1148 = call i64 @llvm.smin.i64(i64 %indvars.iv1126, i64 -936)
  %175 = add nsw i64 %smin1148, 1000
  %176 = shl nsw i64 %polly.indvar413, 6
  br label %polly.loop_header416

polly.loop_exit418:                               ; preds = %polly.loop_exit441
  %polly.indvar_next414 = add nuw nsw i64 %polly.indvar413, 1
  %indvars.iv.next1127 = add nsw i64 %indvars.iv1126, -64
  %exitcond1152.not = icmp eq i64 %polly.indvar_next414, 16
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %polly.indvar419 = phi i64 [ %190, %polly.loop_exit441 ], [ 0, %polly.loop_header410 ]
  %177 = shl nuw nsw i64 %polly.indvar419, 6
  %178 = shl nuw nsw i64 %polly.indvar419, 6
  %179 = and i64 %178, 9223372036854775680
  %180 = sub nsw i64 %177, %179
  %181 = mul nsw i64 %polly.indvar419, -64
  %182 = add i64 %181, %179
  %183 = lshr i64 %polly.indvar419, 1
  %184 = shl nuw nsw i64 %183, 7
  %185 = sub nsw i64 %indvars.iv1135, %184
  %186 = add i64 %indvars.iv1140, %184
  %187 = mul nsw i64 %polly.indvar419, -64
  %188 = shl nsw i64 %polly.indvar419, 6
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  %190 = add nuw nsw i64 %polly.indvar419, 1
  %indvars.iv.next1124 = add nsw i64 %indvars.iv1123, -64
  %indvars.iv.next1136 = add nuw nsw i64 %indvars.iv1135, 64
  %indvars.iv.next1141 = add nsw i64 %indvars.iv1140, -64
  %exitcond1151.not = icmp eq i64 %190, 19
...
polly.loop_header422:                             ; preds = %polly.loop_exit430, %polly.loop_header416
  ...
  %191 = add nuw nsw i64 %polly.indvar425, %176
...
polly.loop_exit430:                               ; preds = %polly.loop_header428
  ...
  %exitcond1129.not = icmp eq i64 %polly.indvar_next426, %175
...
polly.loop_header428:                             ; preds = %polly.loop_header428, %polly.loop_header422
  ...
  %192 = add nuw nsw i64 %polly.indvar431, %188
  %polly.access.mul.call2435 = mul nuw nsw i64 %192, 1000
  %polly.access.add.call2436 = add nuw nsw i64 %191, %polly.access.mul.call2435
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %indvars.iv1142 = phi i64 [ %indvars.iv.next1143, %polly.loop_exit482 ], [ %186, %polly.loop_exit424 ]
  %indvars.iv1137 = phi i64 [ %indvars.iv.next1138, %polly.loop_exit482 ], [ %185, %polly.loop_exit424 ]
  %polly.indvar442 = phi i64 [ %polly.indvar_next443, %polly.loop_exit482 ], [ %183, %polly.loop_exit424 ]
  %193 = mul nsw i64 %indvar1380, -128
  %194 = add i64 %180, %193
  %smax1382 = call i64 @llvm.smax.i64(i64 %194, i64 0)
  %195 = shl nuw nsw i64 %indvar1380, 7
  %196 = add i64 %182, %195
  %197 = add i64 %smax1382, %196
  %smax1139 = call i64 @llvm.smax.i64(i64 %indvars.iv1137, i64 0)
  %198 = add i64 %smax1139, %indvars.iv1142
  %199 = shl nuw nsw i64 %polly.indvar442, 1
  %.not.not944 = icmp ugt i64 %199, %polly.indvar419
  %200 = shl nsw i64 %polly.indvar442, 7
  %201 = add nsw i64 %200, %187
  %202 = icmp sgt i64 %201, 0
  %203 = select i1 %202, i64 %201, i64 0
  %204 = add nsw i64 %201, 127
  %205 = icmp slt i64 %189, %204
  %206 = select i1 %205, i64 %189, i64 %204
...
polly.loop_header445.us:                          ; preds = %polly.loop_header439, %polly.loop_exit468.us
  ...
  %207 = add nuw nsw i64 %polly.indvar448.us, %176
...
polly.loop_header455.us:                          ; preds = %polly.loop_header445.us, %polly.loop_header455.us
  ...
  %exitcond1132.not = icmp eq i64 %polly.indvar_next459.us, 64
  br i1 %exitcond1132.not, label %polly.merge452.loopexit.us, label %polly.loop_header455.us

polly.loop_header466.us:                          ; preds = %polly.merge452.loopexit.us, %polly.loop_header466.us
  %polly.indvar470.us = phi i64 [ %polly.indvar_next471.us, %polly.loop_header466.us ], [ %203, %polly.merge452.loopexit.us ]
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.merge452.loopexit.us
  ...
  %exitcond1134.not = icmp eq i64 %polly.indvar_next449.us, %175
...
polly.loop_header445:                             ; preds = %polly.loop_header439.split, %polly.loop_exit468
  ...
  %210 = add nuw nsw i64 %polly.indvar448, %176
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1131.not = icmp eq i64 %polly.indvar_next449, %175
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %214 = mul nsw i64 %polly.indvar442, -128
  %215 = icmp slt i64 %214, -1072
  %216 = select i1 %215, i64 %214, i64 -1072
...
polly.loop_header466:                             ; preds = %polly.loop_header445, %polly.loop_header466
  %polly.indvar470 = phi i64 [ %polly.indvar_next471, %polly.loop_header466 ], [ %203, %polly.loop_header445 ]
  %218 = add nuw nsw i64 %polly.indvar470, %188
...
polly.loop_exit489:                               ; preds = %polly.loop_exit497
  ...
  %exitcond1149.not = icmp eq i64 %polly.indvar_next484, %175
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %indvars.iv1144 = phi i64 [ %198, %polly.loop_header480 ], [ %indvars.iv.next1145, %polly.loop_exit497 ]
  %polly.indvar491 = phi i64 [ %213, %polly.loop_header480 ], [ %polly.indvar_next492, %polly.loop_exit497 ]
  %219 = add i64 %197, %indvar1383
  %smin1385 = call i64 @llvm.smin.i64(i64 %219, i64 63)
  %220 = add nsw i64 %smin1385, 1
  %smin1146 = call i64 @llvm.smin.i64(i64 %indvars.iv1144, i64 63)
  %221 = add nsw i64 %polly.indvar491, %201
  %polly.loop_guard4981225 = icmp sgt i64 %221, -1
...
polly.loop_header495.preheader:                   ; preds = %polly.loop_header487
  %222 = add nuw nsw i64 %polly.indvar491, %200
  %polly.access.add.Packed_MemRef_call2311507 = add nsw i64 %221, %polly.access.mul.Packed_MemRef_call1309502
  ...
  %min.iters.check1386 = icmp ult i64 %220, 4
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1387
  ...
  %224 = add nuw nsw i64 %index1390, %188
  %225 = add nuw nsw i64 %index1390, %polly.access.mul.Packed_MemRef_call1309502
  %226 = getelementptr double, double* %Packed_MemRef_call1309, i64 %225
  %227 = bitcast double* %226 to <4 x double>*
  %wide.load1394 = load <4 x double>, <4 x double>* %227, align 8
  %228 = fmul fast <4 x double> %broadcast.splat1396, %wide.load1394
  %229 = getelementptr double, double* %Packed_MemRef_call2311, i64 %225
  %230 = bitcast double* %229 to <4 x double>*
  %wide.load1397 = load <4 x double>, <4 x double>* %230, align 8
  %231 = fmul fast <4 x double> %broadcast.splat1399, %wide.load1397
  %232 = shl i64 %224, 3
  %233 = add i64 %232, %223
  %234 = getelementptr i8, i8* %call, i64 %233
  %235 = bitcast i8* %234 to <4 x double>*
  %wide.load1400 = load <4 x double>, <4 x double>* %235, align 8, !alias.scope !85, !noalias !87
  ...
  %238 = fadd fast <4 x double> %237, %wide.load1400
  %239 = bitcast i8* %234 to <4 x double>*
  store <4 x double> %238, <4 x double>* %239, align 8, !alias.scope !85, !noalias !87
  %index.next1391 = add i64 %index1390, 4
  %240 = icmp eq i64 %index.next1391, %n.vec1389
  br i1 %240, label %middle.block1377, label %vector.body1379, !llvm.loop !96

middle.block1377:                                 ; preds = %vector.body1379
  %cmp.n1393 = icmp eq i64 %220, %n.vec1389
...
polly.loop_header495:                             ; preds = %polly.loop_header495.preheader1455, %polly.loop_header495
  ...
  %241 = add nuw nsw i64 %polly.indvar499, %188
  ...
  br i1 %exitcond1147.not, label %polly.loop_exit497, label %polly.loop_header495, !llvm.loop !97
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1318 = icmp ult i64 %244, 4
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1319
  ...
  %246 = shl nuw nsw i64 %index1322, 3
  %247 = getelementptr i8, i8* %scevgep623, i64 %246
  %248 = bitcast i8* %247 to <4 x double>*
  %wide.load1326 = load <4 x double>, <4 x double>* %248, align 8, !alias.scope !98, !noalias !100
  %249 = fmul fast <4 x double> %wide.load1326, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %250 = bitcast i8* %247 to <4 x double>*
  store <4 x double> %249, <4 x double>* %250, align 8, !alias.scope !98, !noalias !100
  %index.next1323 = add i64 %index1322, 4
  %251 = icmp eq i64 %index.next1323, %n.vec1321
  br i1 %251, label %middle.block1315, label %vector.body1317, !llvm.loop !105

middle.block1315:                                 ; preds = %vector.body1317
  %cmp.n1325 = icmp eq i64 %244, %n.vec1321
...
polly.loop_header617:                             ; preds = %polly.loop_header617.preheader, %polly.loop_header617
  ...
  br i1 %exitcond1185.not, label %polly.loop_exit619, label %polly.loop_header617, !llvm.loop !106
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %smin1180 = call i64 @llvm.smin.i64(i64 %indvars.iv1158, i64 -936)
  %253 = add nsw i64 %smin1180, 1000
  %254 = shl nsw i64 %polly.indvar630, 6
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %indvars.iv.next1159 = add nsw i64 %indvars.iv1158, -64
  %exitcond1184.not = icmp eq i64 %polly.indvar_next631, 16
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %polly.indvar636 = phi i64 [ %268, %polly.loop_exit658 ], [ 0, %polly.loop_header627 ]
  %255 = shl nuw nsw i64 %polly.indvar636, 6
  %256 = shl nuw nsw i64 %polly.indvar636, 6
  %257 = and i64 %256, 9223372036854775680
  %258 = sub nsw i64 %255, %257
  %259 = mul nsw i64 %polly.indvar636, -64
  %260 = add i64 %259, %257
  %261 = lshr i64 %polly.indvar636, 1
  %262 = shl nuw nsw i64 %261, 7
  %263 = sub nsw i64 %indvars.iv1167, %262
  %264 = add i64 %indvars.iv1172, %262
  %265 = mul nsw i64 %polly.indvar636, -64
  %266 = shl nsw i64 %polly.indvar636, 6
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  %268 = add nuw nsw i64 %polly.indvar636, 1
  %indvars.iv.next1156 = add nsw i64 %indvars.iv1155, -64
  %indvars.iv.next1168 = add nuw nsw i64 %indvars.iv1167, 64
  %indvars.iv.next1173 = add nsw i64 %indvars.iv1172, -64
  %exitcond1183.not = icmp eq i64 %268, 19
...
polly.loop_header639:                             ; preds = %polly.loop_exit647, %polly.loop_header633
  ...
  %269 = add nuw nsw i64 %polly.indvar642, %254
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1161.not = icmp eq i64 %polly.indvar_next643, %253
...
polly.loop_header645:                             ; preds = %polly.loop_header645, %polly.loop_header639
  ...
  %270 = add nuw nsw i64 %polly.indvar648, %266
  %polly.access.mul.call2652 = mul nuw nsw i64 %270, 1000
  %polly.access.add.call2653 = add nuw nsw i64 %269, %polly.access.mul.call2652
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %indvars.iv1174 = phi i64 [ %indvars.iv.next1175, %polly.loop_exit699 ], [ %264, %polly.loop_exit641 ]
  %indvars.iv1169 = phi i64 [ %indvars.iv.next1170, %polly.loop_exit699 ], [ %263, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit699 ], [ %261, %polly.loop_exit641 ]
  %271 = mul nsw i64 %indvar1330, -128
  %272 = add i64 %258, %271
  %smax1332 = call i64 @llvm.smax.i64(i64 %272, i64 0)
  %273 = shl nuw nsw i64 %indvar1330, 7
  %274 = add i64 %260, %273
  %275 = add i64 %smax1332, %274
  %smax1171 = call i64 @llvm.smax.i64(i64 %indvars.iv1169, i64 0)
  %276 = add i64 %smax1171, %indvars.iv1174
  %277 = shl nuw nsw i64 %polly.indvar659, 1
  %.not.not945 = icmp ugt i64 %277, %polly.indvar636
  %278 = shl nsw i64 %polly.indvar659, 7
  %279 = add nsw i64 %278, %265
  %280 = icmp sgt i64 %279, 0
  %281 = select i1 %280, i64 %279, i64 0
  %282 = add nsw i64 %279, 127
  %283 = icmp slt i64 %267, %282
  %284 = select i1 %283, i64 %267, i64 %282
  %polly.loop_guard686.not = icmp sgt i64 %281, %284
...
polly.loop_header672.us:                          ; preds = %polly.loop_header662.us, %polly.loop_header672.us
  ...
  %286 = add nuw nsw i64 %polly.indvar675.us, %266
  %polly.access.mul.call1679.us = mul nuw nsw i64 %286, 1000
  %polly.access.add.call1680.us = add nuw nsw i64 %285, %polly.access.mul.call1679.us
  ...
  %exitcond1164.not = icmp eq i64 %polly.indvar_next676.us, 64
  br i1 %exitcond1164.not, label %polly.merge669.loopexit.us, label %polly.loop_header672.us

polly.loop_header683.us:                          ; preds = %polly.merge669.loopexit.us, %polly.loop_header683.us
  %polly.indvar687.us = phi i64 [ %polly.indvar_next688.us, %polly.loop_header683.us ], [ %281, %polly.merge669.loopexit.us ]
  %287 = add nuw nsw i64 %polly.indvar687.us, %266
  %polly.access.mul.call1691.us = mul nsw i64 %287, 1000
  %polly.access.add.call1692.us = add nuw nsw i64 %285, %polly.access.mul.call1691.us
  ...
  %polly.loop_cond689.not.not.us = icmp slt i64 %polly.indvar687.us, %284
...
polly.loop_exit685.us:                            ; preds = %polly.loop_header683.us, %polly.merge669.loopexit.us
  ...
  %exitcond1166.not = icmp eq i64 %polly.indvar_next666.us, %253
...
polly.loop_exit685:                               ; preds = %polly.loop_header683
  ...
  %exitcond1163.not = icmp eq i64 %polly.indvar_next666, %253
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %292 = mul nsw i64 %polly.indvar659, -128
  %293 = icmp slt i64 %292, -1072
  %294 = select i1 %293, i64 %292, i64 -1072
  %295 = add nsw i64 %294, 1199
  %polly.loop_guard707.not = icmp sgt i64 %291, %295
...
polly.loop_header683:                             ; preds = %polly.loop_header662, %polly.loop_header683
  %polly.indvar687 = phi i64 [ %polly.indvar_next688, %polly.loop_header683 ], [ %281, %polly.loop_header662 ]
  %296 = add nuw nsw i64 %polly.indvar687, %266
  %polly.access.mul.call1691 = mul nsw i64 %296, 1000
  %polly.access.add.call1692 = add nuw nsw i64 %288, %polly.access.mul.call1691
  ...
  %polly.loop_cond689.not.not = icmp slt i64 %polly.indvar687, %284
...
polly.loop_exit706:                               ; preds = %polly.loop_exit714
  ...
  %exitcond1181.not = icmp eq i64 %polly.indvar_next701, %253
...
polly.loop_header704:                             ; preds = %polly.loop_header697, %polly.loop_exit714
  ...
  %indvars.iv1176 = phi i64 [ %276, %polly.loop_header697 ], [ %indvars.iv.next1177, %polly.loop_exit714 ]
  %polly.indvar708 = phi i64 [ %291, %polly.loop_header697 ], [ %polly.indvar_next709, %polly.loop_exit714 ]
  %297 = add i64 %275, %indvar1333
  %smin1335 = call i64 @llvm.smin.i64(i64 %297, i64 63)
  %298 = add nsw i64 %smin1335, 1
  %smin1178 = call i64 @llvm.smin.i64(i64 %indvars.iv1176, i64 63)
  %299 = add nsw i64 %polly.indvar708, %279
  %polly.loop_guard7151226 = icmp sgt i64 %299, -1
...
polly.loop_header712.preheader:                   ; preds = %polly.loop_header704
  %300 = add nuw nsw i64 %polly.indvar708, %278
  %polly.access.add.Packed_MemRef_call2528724 = add nsw i64 %299, %polly.access.mul.Packed_MemRef_call1526719
  ...
  %min.iters.check1336 = icmp ult i64 %298, 4
...
vector.body1329:                                  ; preds = %vector.body1329, %vector.ph1337
  ...
  %302 = add nuw nsw i64 %index1340, %266
  %303 = add nuw nsw i64 %index1340, %polly.access.mul.Packed_MemRef_call1526719
  %304 = getelementptr double, double* %Packed_MemRef_call1526, i64 %303
  %305 = bitcast double* %304 to <4 x double>*
  %wide.load1344 = load <4 x double>, <4 x double>* %305, align 8
  %306 = fmul fast <4 x double> %broadcast.splat1346, %wide.load1344
  %307 = getelementptr double, double* %Packed_MemRef_call2528, i64 %303
  %308 = bitcast double* %307 to <4 x double>*
  %wide.load1347 = load <4 x double>, <4 x double>* %308, align 8
  %309 = fmul fast <4 x double> %broadcast.splat1349, %wide.load1347
  %310 = shl i64 %302, 3
  %311 = add i64 %310, %301
  %312 = getelementptr i8, i8* %call, i64 %311
  %313 = bitcast i8* %312 to <4 x double>*
  %wide.load1350 = load <4 x double>, <4 x double>* %313, align 8, !alias.scope !98, !noalias !100
  ...
  %316 = fadd fast <4 x double> %315, %wide.load1350
  %317 = bitcast i8* %312 to <4 x double>*
  store <4 x double> %316, <4 x double>* %317, align 8, !alias.scope !98, !noalias !100
  %index.next1341 = add i64 %index1340, 4
  %318 = icmp eq i64 %index.next1341, %n.vec1339
  br i1 %318, label %middle.block1327, label %vector.body1329, !llvm.loop !109

middle.block1327:                                 ; preds = %vector.body1329
  %cmp.n1343 = icmp eq i64 %298, %n.vec1339
...
polly.loop_exit714:                               ; preds = %polly.loop_header712, %middle.block1327, %polly.loop_header704
  ...
  %polly.loop_cond710.not.not = icmp slt i64 %polly.indvar708, %295
...
polly.loop_header712:                             ; preds = %polly.loop_header712.preheader1459, %polly.loop_header712
  ...
  %319 = add nuw nsw i64 %polly.indvar716, %266
  ...
  %320 = shl i64 %319, 3
  %321 = add i64 %320, %301
  %scevgep735 = getelementptr i8, i8* %call, i64 %321
  ...
  br i1 %exitcond1179.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !110
...
polly.loop_header864:                             ; preds = %entry, %polly.loop_exit872
  ...
  %322 = shl nsw i64 %polly.indvar867, 5
  %323 = add nsw i64 %smin1213, 1199
...
polly.loop_header870:                             ; preds = %polly.loop_exit878, %polly.loop_header864
  ...
  %324 = mul nsw i64 %polly.indvar873, -32
  ...
  %326 = shl nsw i64 %polly.indvar873, 5
  %327 = add nsw i64 %smin1209, 1199
...
polly.loop_header876:                             ; preds = %polly.loop_exit884, %polly.loop_header870
  ...
  %328 = add nuw nsw i64 %polly.indvar879, %322
...
vector.ph1257:                                    ; preds = %polly.loop_header876
  %broadcast.splatinsert1264 = insertelement <4 x i64> poison, i64 %326, i32 0
  %broadcast.splat1265 = shufflevector <4 x i64> %broadcast.splatinsert1264, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1266 = insertelement <4 x i32> poison, i32 %329, i32 0
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1257
  ...
  %331 = add nuw nsw <4 x i64> %vec.ind1262, %broadcast.splat1265
  %332 = trunc <4 x i64> %331 to <4 x i32>
  %333 = mul <4 x i32> %broadcast.splat1267, %332
  ...
  store <4 x double> %337, <4 x double>* %342, align 8, !alias.scope !111, !noalias !113
  %index.next1259 = add i64 %index1258, 4
  %vec.ind.next1263 = add <4 x i64> %vec.ind1262, <i64 4, i64 4, i64 4, i64 4>
  %343 = icmp eq i64 %index.next1259, %325
  br i1 %343, label %polly.loop_exit884, label %vector.body1256, !llvm.loop !116

polly.loop_exit884:                               ; preds = %vector.body1256, %polly.loop_header882
  %polly.indvar_next880 = add nuw nsw i64 %polly.indvar879, 1
  %exitcond1214.not = icmp eq i64 %polly.indvar879, %323
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  %344 = add nuw nsw i64 %polly.indvar885, %326
  ...
  %scevgep888 = getelementptr i8, i8* %call, i64 %350
  ...
  %exitcond1210.not = icmp eq i64 %polly.indvar885, %327
  br i1 %exitcond1210.not, label %polly.loop_exit884, label %polly.loop_header882, !llvm.loop !117
...
polly.loop_header891:                             ; preds = %polly.loop_exit872, %polly.loop_exit899
  ...
  %351 = shl nsw i64 %polly.indvar894, 5
  %352 = add nsw i64 %smin1203, 1199
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %353 = mul nsw i64 %polly.indvar900, -32
  %smin1271 = call i64 @llvm.smin.i64(i64 %353, i64 -968)
  %354 = add nsw i64 %smin1271, 1000
  %smin1199 = call i64 @llvm.smin.i64(i64 %indvars.iv1197, i64 -968)
  %355 = shl nsw i64 %polly.indvar900, 5
  %356 = add nsw i64 %smin1199, 999
...
vector.body1270:                                  ; preds = %vector.body1270, %vector.ph1273
  ...
  %360 = add nuw nsw <4 x i64> %vec.ind1280, %broadcast.splat1283
  %361 = trunc <4 x i64> %360 to <4 x i32>
  %362 = mul <4 x i32> %broadcast.splat1285, %361
  ...
  store <4 x double> %366, <4 x double>* %371, align 8, !alias.scope !115, !noalias !118
  %index.next1277 = add i64 %index1276, 4
  %vec.ind.next1281 = add <4 x i64> %vec.ind1280, <i64 4, i64 4, i64 4, i64 4>
  %372 = icmp eq i64 %index.next1277, %354
  br i1 %372, label %polly.loop_exit911, label %vector.body1270, !llvm.loop !119

polly.loop_exit911:                               ; preds = %vector.body1270, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1204.not = icmp eq i64 %polly.indvar906, %352
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %373 = add nuw nsw i64 %polly.indvar912, %355
  ...
  %scevgep915 = getelementptr i8, i8* %call2, i64 %379
  ...
  %exitcond1200.not = icmp eq i64 %polly.indvar912, %356
  br i1 %exitcond1200.not, label %polly.loop_exit911, label %polly.loop_header909, !llvm.loop !120
...
polly.loop_header917:                             ; preds = %polly.loop_exit899, %polly.loop_exit925
  ...
  %380 = shl nsw i64 %polly.indvar920, 5
  %381 = add nsw i64 %smin1193, 1199
...
polly.loop_header923:                             ; preds = %polly.loop_exit931, %polly.loop_header917
  ...
  %382 = mul nsw i64 %polly.indvar926, -32
  %smin1289 = call i64 @llvm.smin.i64(i64 %382, i64 -968)
  %383 = add nsw i64 %smin1289, 1000
  %smin1189 = call i64 @llvm.smin.i64(i64 %indvars.iv1187, i64 -968)
  %384 = shl nsw i64 %polly.indvar926, 5
  %385 = add nsw i64 %smin1189, 999
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1291
  ...
  %389 = add nuw nsw <4 x i64> %vec.ind1298, %broadcast.splat1301
  %390 = trunc <4 x i64> %389 to <4 x i32>
  %391 = mul <4 x i32> %broadcast.splat1303, %390
  ...
  store <4 x double> %395, <4 x double>* %400, align 8, !alias.scope !114, !noalias !121
  %index.next1295 = add i64 %index1294, 4
  %vec.ind.next1299 = add <4 x i64> %vec.ind1298, <i64 4, i64 4, i64 4, i64 4>
  %401 = icmp eq i64 %index.next1295, %383
  br i1 %401, label %polly.loop_exit937, label %vector.body1288, !llvm.loop !122

polly.loop_exit937:                               ; preds = %vector.body1288, %polly.loop_header935
  %polly.indvar_next933 = add nuw nsw i64 %polly.indvar932, 1
  %exitcond1194.not = icmp eq i64 %polly.indvar932, %381
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  %402 = add nuw nsw i64 %polly.indvar938, %384
  ...
  %scevgep942 = getelementptr i8, i8* %call1, i64 %408
  ...
  %exitcond1190.not = icmp eq i64 %polly.indvar938, %385
  br i1 %exitcond1190.not, label %polly.loop_exit937, label %polly.loop_header935, !llvm.loop !123
}
