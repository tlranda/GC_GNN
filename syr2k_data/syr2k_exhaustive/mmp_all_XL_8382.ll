; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8382.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8382.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %107 = mul nsw i64 %polly.indvar214, 20
  %108 = sub nsw i64 %104, %107
  %109 = icmp sgt i64 %108, 0
  %110 = select i1 %109, i64 %108, i64 0
  %polly.loop_guard227 = icmp slt i64 %110, 20
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1002
  ...
  %wide.load1009 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %130, label %middle.block996, label %vector.body998, !llvm.loop !76
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %polly.loop_guard373 = icmp slt i64 %136, 60
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %139 = shl nsw i64 %polly.indvar365, 4
  %140 = mul nsw i64 %polly.indvar365, -16
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %142 = mul nsw i64 %polly.indvar374, 20
  %143 = sub nsw i64 %139, %142
  %144 = icmp sgt i64 %143, 0
  %145 = select i1 %144, i64 %143, i64 0
  %polly.loop_guard387 = icmp slt i64 %145, 20
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  %wide.load983 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %165, label %middle.block972, label %vector.body974, !llvm.loop !85
...
polly.loop_header522:                             ; preds = %polly.loop_exit532, %polly.loop_header516
  ...
  %polly.loop_guard533 = icmp slt i64 %171, 60
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  ...
  %174 = shl nsw i64 %polly.indvar525, 4
  %175 = mul nsw i64 %polly.indvar525, -16
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  ...
  %177 = mul nsw i64 %polly.indvar534, 20
  %178 = sub nsw i64 %174, %177
  %179 = icmp sgt i64 %178, 0
  %180 = select i1 %179, i64 %178, i64 0
  %polly.loop_guard547 = icmp slt i64 %180, 20
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph914
  ...
  br i1 %214, label %polly.loop_exit720, label %vector.body912, !llvm.loop !94
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph930
  ...
  br i1 %243, label %polly.loop_exit747, label %vector.body927, !llvm.loop !97
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph948
  ...
  br i1 %272, label %polly.loop_exit773, label %vector.body945, !llvm.loop !100
