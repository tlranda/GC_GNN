; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9046.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9046.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond806.not = icmp eq i64 %polly.indvar_next203, 10
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %107 = mul nsw i64 %polly.indvar214, 96
  ...
  %polly.loop_guard227.not = icmp sgt i64 %110, %114
...
polly.loop_exit226:                               ; preds = %polly.loop_exit234
  ...
  %exitcond804.not = icmp eq i64 %polly.indvar_next221, 100
...
polly.loop_header224:                             ; preds = %polly.loop_header217, %polly.loop_exit234
  %indvars.iv802 = phi i64 [ %106, %polly.loop_header217 ], [ %indvars.iv.next803, %polly.loop_exit234 ]
  %polly.indvar228 = phi i64 [ %110, %polly.loop_header217 ], [ %polly.indvar_next229, %polly.loop_exit234 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv802, i64 63)
  %117 = add i64 %polly.indvar228, %107
  %118 = add i64 %117, %105
  %polly.loop_guard235883 = icmp sgt i64 %118, -1
...
polly.loop_header232.preheader:                   ; preds = %polly.loop_header224
  ...
  %120 = add i64 %119, %116
  %scevgep242 = getelementptr i8, i8* %call2, i64 %120
  ...
  %scevgep248 = getelementptr i8, i8* %call1, i64 %120
...
polly.loop_exit234:                               ; preds = %polly.loop_header232, %polly.loop_header224
  ...
  %polly.loop_cond230.not.not = icmp slt i64 %polly.indvar228, %114
...
polly.loop_header232:                             ; preds = %polly.loop_header232.preheader, %polly.loop_header232
  ...
  %122 = add nuw nsw i64 %polly.indvar236, %104
  %123 = mul nuw nsw i64 %122, 8000
  %124 = add nuw nsw i64 %123, %116
  %scevgep239 = getelementptr i8, i8* %call1, i64 %124
  ...
  %scevgep245 = getelementptr i8, i8* %call2, i64 %124
  ...
  %125 = shl i64 %122, 3
  %126 = add i64 %125, %121
  %scevgep251 = getelementptr i8, i8* %call, i64 %126
...
vector.body998:                                   ; preds = %vector.body998, %vector.ph1002
  ...
  %129 = shl nuw nsw i64 %index1005, 3
  %130 = getelementptr i8, i8* %scevgep352, i64 %129
  %131 = bitcast i8* %130 to <4 x double>*
  %wide.load1009 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !72, !noalias !74
  %132 = fmul fast <4 x double> %wide.load1009, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %134 = icmp eq i64 %index.next1006, %n.vec1004
  br i1 %134, label %middle.block996, label %vector.body998, !llvm.loop !77

middle.block996:                                  ; preds = %vector.body998
  %cmp.n1008 = icmp eq i64 %127, %n.vec1004
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %136 = mul nuw nsw i64 %polly.indvar359, 100
  br label %polly.loop_header362

polly.loop_exit364:                               ; preds = %polly.loop_exit372
  %polly.indvar_next360 = add nuw nsw i64 %polly.indvar359, 1
  %exitcond826.not = icmp eq i64 %polly.indvar_next360, 10
...
polly.loop_header362:                             ; preds = %polly.loop_exit372, %polly.loop_header356
  ...
  %137 = udiv i64 %indvars.iv811, 3
  %138 = mul nuw nsw i64 %137, 96
  %139 = trunc i64 %polly.indvar365 to i8
  %pexp.p_div_q368.lhs.trunc = add i8 %139, 2
  %pexp.p_div_q368781 = udiv i8 %pexp.p_div_q368.lhs.trunc, 3
  %pexp.p_div_q368.zext = zext i8 %pexp.p_div_q368781 to i64
  %140 = sub nsw i64 %polly.indvar365, %pexp.p_div_q368.zext
  %polly.loop_guard373 = icmp slt i64 %140, 13
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  %141 = sub nsw i64 %indvars.iv816, %138
  %142 = add i64 %indvars.iv809, %138
  %143 = shl nsw i64 %polly.indvar365, 6
  %144 = mul nsw i64 %polly.indvar365, -64
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %146 = mul nsw i64 %polly.indvar374, 96
  ...
  %polly.loop_guard387.not = icmp sgt i64 %149, %153
...
polly.loop_header377:                             ; preds = %polly.loop_header370, %polly.loop_exit386
  ...
  %154 = add nuw nsw i64 %polly.indvar380, %136
  %155 = shl i64 %154, 3
...
polly.loop_exit386:                               ; preds = %polly.loop_exit394
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next381, 100
...
polly.loop_header384:                             ; preds = %polly.loop_header377, %polly.loop_exit394
  %indvars.iv820 = phi i64 [ %145, %polly.loop_header377 ], [ %indvars.iv.next821, %polly.loop_exit394 ]
  %polly.indvar388 = phi i64 [ %149, %polly.loop_header377 ], [ %polly.indvar_next389, %polly.loop_exit394 ]
  %smin822 = call i64 @llvm.smin.i64(i64 %indvars.iv820, i64 63)
  %156 = add i64 %polly.indvar388, %146
  %157 = add i64 %156, %144
  %polly.loop_guard395884 = icmp sgt i64 %157, -1
...
polly.loop_header392.preheader:                   ; preds = %polly.loop_header384
  ...
  %159 = add i64 %158, %155
  %scevgep402 = getelementptr i8, i8* %call2, i64 %159
  ...
  %scevgep408 = getelementptr i8, i8* %call1, i64 %159
...
polly.loop_exit394:                               ; preds = %polly.loop_header392, %polly.loop_header384
  ...
  %polly.loop_cond390.not.not = icmp slt i64 %polly.indvar388, %153
...
polly.loop_header392:                             ; preds = %polly.loop_header392.preheader, %polly.loop_header392
  ...
  %161 = add nuw nsw i64 %polly.indvar396, %143
  %162 = mul nuw nsw i64 %161, 8000
  %163 = add nuw nsw i64 %162, %155
  %scevgep399 = getelementptr i8, i8* %call1, i64 %163
  ...
  %scevgep405 = getelementptr i8, i8* %call2, i64 %163
  ...
  %164 = shl i64 %161, 3
  %165 = add i64 %164, %160
  %scevgep411 = getelementptr i8, i8* %call, i64 %165
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  %168 = shl nuw nsw i64 %index979, 3
  %169 = getelementptr i8, i8* %scevgep512, i64 %168
  %170 = bitcast i8* %169 to <4 x double>*
  %wide.load983 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !81, !noalias !83
  %171 = fmul fast <4 x double> %wide.load983, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %173 = icmp eq i64 %index.next980, %n.vec978
  br i1 %173, label %middle.block972, label %vector.body974, !llvm.loop !86

middle.block972:                                  ; preds = %vector.body974
  %cmp.n982 = icmp eq i64 %166, %n.vec978
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %175 = mul nuw nsw i64 %polly.indvar519, 100
...
polly.loop_exit524:                               ; preds = %polly.loop_exit532
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar_next520, 10
...
polly.loop_header530.preheader:                   ; preds = %polly.loop_header522
  %180 = sub nsw i64 %indvars.iv836, %177
  %181 = add i64 %indvars.iv829, %177
  %182 = shl nsw i64 %polly.indvar525, 6
  %183 = mul nsw i64 %polly.indvar525, -64
...
polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  %indvars.iv838 = phi i64 [ %180, %polly.loop_header530.preheader ], [ %indvars.iv.next839, %polly.loop_exit539 ]
  %indvars.iv833 = phi i64 [ %181, %polly.loop_header530.preheader ], [ %indvars.iv.next834, %polly.loop_exit539 ]
  ...
  %184 = add i64 %smax835, %indvars.iv838
  %185 = mul nsw i64 %polly.indvar534, 96
  %186 = sub nsw i64 %182, %185
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %189 = mul nsw i64 %polly.indvar534, -96
  %190 = icmp slt i64 %189, -1104
  %191 = select i1 %190, i64 %189, i64 -1104
  %192 = add nsw i64 %191, 1199
  %polly.loop_guard547.not = icmp sgt i64 %188, %192
...
polly.loop_header537:                             ; preds = %polly.loop_header530, %polly.loop_exit546
  ...
  %193 = add nuw nsw i64 %polly.indvar540, %175
  %194 = shl i64 %193, 3
...
polly.loop_exit546:                               ; preds = %polly.loop_exit554
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar_next541, 100
...
polly.loop_header544:                             ; preds = %polly.loop_header537, %polly.loop_exit554
  %indvars.iv840 = phi i64 [ %184, %polly.loop_header537 ], [ %indvars.iv.next841, %polly.loop_exit554 ]
  %polly.indvar548 = phi i64 [ %188, %polly.loop_header537 ], [ %polly.indvar_next549, %polly.loop_exit554 ]
  %smin842 = call i64 @llvm.smin.i64(i64 %indvars.iv840, i64 63)
  %195 = add i64 %polly.indvar548, %185
  %196 = add i64 %195, %183
  %polly.loop_guard555885 = icmp sgt i64 %196, -1
...
polly.loop_header552.preheader:                   ; preds = %polly.loop_header544
  ...
  %198 = add i64 %197, %194
  %scevgep562 = getelementptr i8, i8* %call2, i64 %198
  ...
  %scevgep568 = getelementptr i8, i8* %call1, i64 %198
...
polly.loop_exit554:                               ; preds = %polly.loop_header552, %polly.loop_header544
  ...
  %polly.loop_cond550.not.not = icmp slt i64 %polly.indvar548, %192
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_header552
  ...
  %200 = add nuw nsw i64 %polly.indvar556, %182
  %201 = mul nuw nsw i64 %200, 8000
  %202 = add nuw nsw i64 %201, %194
  %scevgep559 = getelementptr i8, i8* %call1, i64 %202
  ...
  %scevgep565 = getelementptr i8, i8* %call2, i64 %202
  ...
  %203 = shl i64 %200, 3
  %204 = add i64 %203, %199
  %scevgep571 = getelementptr i8, i8* %call, i64 %204
...
polly.loop_header706:                             ; preds = %polly.loop_exit714, %polly.loop_header700
  ...
  %smin913 = call i64 @llvm.smin.i64(i64 %207, i64 -1168)
  %208 = add nsw i64 %smin913, 1200
...
vector.ph914:                                     ; preds = %polly.loop_header712
  %broadcast.splatinsert921 = insertelement <4 x i64> poison, i64 %209, i32 0
  %broadcast.splat922 = shufflevector <4 x i64> %broadcast.splatinsert921, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert923 = insertelement <4 x i32> poison, i32 %212, i32 0
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph914
  ...
  %214 = add nuw nsw <4 x i64> %vec.ind919, %broadcast.splat922
  %215 = trunc <4 x i64> %214 to <4 x i32>
  %216 = mul <4 x i32> %broadcast.splat924, %215
  ...
  %226 = icmp eq i64 %index.next916, %208
  br i1 %226, label %polly.loop_exit720, label %vector.body912, !llvm.loop !95
...
polly.loop_header733:                             ; preds = %polly.loop_exit741, %polly.loop_header727
  ...
  %smin928 = call i64 @llvm.smin.i64(i64 %236, i64 -968)
  %237 = add nsw i64 %smin928, 1000
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph930
  ...
  %243 = add nuw nsw <4 x i64> %vec.ind937, %broadcast.splat940
  %244 = trunc <4 x i64> %243 to <4 x i32>
  %245 = mul <4 x i32> %broadcast.splat942, %244
  ...
  %255 = icmp eq i64 %index.next934, %237
  br i1 %255, label %polly.loop_exit747, label %vector.body927, !llvm.loop !98
...
polly.loop_header759:                             ; preds = %polly.loop_exit767, %polly.loop_header753
  ...
  %smin946 = call i64 @llvm.smin.i64(i64 %265, i64 -968)
  %266 = add nsw i64 %smin946, 1000
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph948
  ...
  %272 = add nuw nsw <4 x i64> %vec.ind955, %broadcast.splat958
  %273 = trunc <4 x i64> %272 to <4 x i32>
  %274 = mul <4 x i32> %broadcast.splat960, %273
  ...
  %284 = icmp eq i64 %index.next952, %266
  br i1 %284, label %polly.loop_exit773, label %vector.body945, !llvm.loop !101
