; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1310.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1310.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %122 = mul nsw i64 %indvar1430, -128
  %123 = add i64 %102, %122
  %smax1432 = call i64 @llvm.smax.i64(i64 %123, i64 0)
  %124 = shl nuw nsw i64 %indvar1430, 7
  %125 = add i64 %104, %124
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %142 = mul nsw i64 %polly.indvar231, -128
...
vector.body1429:                                  ; preds = %vector.body1429, %vector.ph1437
  ...
  %wide.load1450 = load <4 x double>, <4 x double>* %163, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %168, label %middle.block1427, label %vector.body1429, !llvm.loop !83
...
vector.body1365:                                  ; preds = %vector.body1365, %vector.ph1369
  ...
  %wide.load1376 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %179, label %middle.block1363, label %vector.body1365, !llvm.loop !92
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %185 = and i64 %184, 9223372036854775680
  %186 = sub nsw i64 %183, %185
  %187 = mul nsw i64 %polly.indvar419, -8
  %188 = add i64 %187, %185
  %189 = lshr i64 %polly.indvar419, 4
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %226 = mul nsw i64 %polly.indvar442, -128
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1387
  ...
  %wide.load1400 = load <4 x double>, <4 x double>* %247, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %250, <4 x double>* %251, align 8, !alias.scope !85, !noalias !87
  %index.next1391 = add i64 %index1390, 4
  %252 = icmp eq i64 %index.next1391, %n.vec1389
  br i1 %252, label %middle.block1377, label %vector.body1379, !llvm.loop !96
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1319
  ...
  %wide.load1326 = load <4 x double>, <4 x double>* %260, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %261, <4 x double>* %262, align 8, !alias.scope !98, !noalias !100
  %index.next1323 = add i64 %index1322, 4
  %263 = icmp eq i64 %index.next1323, %n.vec1321
  br i1 %263, label %middle.block1315, label %vector.body1317, !llvm.loop !105
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %269 = and i64 %268, 9223372036854775680
  %270 = sub nsw i64 %267, %269
  %271 = mul nsw i64 %polly.indvar636, -8
  %272 = add i64 %271, %269
  %273 = lshr i64 %polly.indvar636, 4
  %274 = shl nuw nsw i64 %273, 7
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %310 = mul nsw i64 %polly.indvar659, -128
  %311 = icmp slt i64 %310, -1072
  %312 = select i1 %311, i64 %310, i64 -1072
...
vector.body1329:                                  ; preds = %vector.body1329, %vector.ph1337
  ...
  %wide.load1350 = load <4 x double>, <4 x double>* %331, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %334, <4 x double>* %335, align 8, !alias.scope !98, !noalias !100
  %index.next1341 = add i64 %index1340, 4
  %336 = icmp eq i64 %index.next1341, %n.vec1339
  br i1 %336, label %middle.block1327, label %vector.body1329, !llvm.loop !109
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1257
  ...
  store <4 x double> %355, <4 x double>* %360, align 8, !alias.scope !111, !noalias !113
  ...
  br i1 %361, label %polly.loop_exit884, label %vector.body1256, !llvm.loop !116
...
vector.body1270:                                  ; preds = %vector.body1270, %vector.ph1273
  ...
  store <4 x double> %384, <4 x double>* %389, align 8, !alias.scope !115, !noalias !118
  ...
  br i1 %390, label %polly.loop_exit911, label %vector.body1270, !llvm.loop !119
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1291
  ...
  store <4 x double> %413, <4 x double>* %418, align 8, !alias.scope !114, !noalias !121
  ...
  br i1 %419, label %polly.loop_exit937, label %vector.body1288, !llvm.loop !122
