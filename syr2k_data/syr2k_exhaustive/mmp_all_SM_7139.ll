; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7139.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7139.c"
...
polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  ...
  %175 = mul nsw i64 %polly.indvar570, -32
  %176 = icmp slt i64 %175, -1168
  %177 = select i1 %176, i64 %175, i64 -1168
  %178 = add nsw i64 %177, 1199
  %179 = shl nsw i64 %polly.indvar570, 5
