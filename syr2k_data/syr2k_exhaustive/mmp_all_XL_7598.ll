; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7598.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7598.c"
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit236
  ...
  %polly.loop_guard237 = icmp slt i64 %105, 80
...
vector.body1038:                                  ; preds = %vector.body1038, %vector.ph1042
  ...
  %wide.load1049 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %127, label %middle.block1036, label %vector.body1038, !llvm.loop !79
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %131 = mul nsw i64 %polly.indvar395, -80
  %132 = mul nuw nsw i64 %polly.indvar395, 80
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  %133 = mul nuw nsw i64 %polly.indvar401, 100
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit416
  ...
  %134 = mul nuw nsw i64 %polly.indvar410, 100
  %135 = add nsw i64 %134, %131
  %136 = icmp sgt i64 %135, 0
  %137 = select i1 %136, i64 %135, i64 0
  %polly.loop_guard417 = icmp slt i64 %137, 80
...
vector.body1014:                                  ; preds = %vector.body1014, %vector.ph1016
  ...
  %wide.load1023 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %159, label %middle.block1012, label %vector.body1014, !llvm.loop !89
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %163 = mul nsw i64 %polly.indvar575, -80
  %164 = mul nuw nsw i64 %polly.indvar575, 80
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  %165 = mul nuw nsw i64 %polly.indvar581, 100
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %166 = mul nuw nsw i64 %polly.indvar590, 100
  %167 = add nsw i64 %166, %163
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %polly.loop_guard597 = icmp slt i64 %169, 80
...
vector.body952:                                   ; preds = %vector.body952, %vector.ph954
  ...
  br i1 %205, label %polly.loop_exit778, label %vector.body952, !llvm.loop !98
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph970
  ...
  br i1 %234, label %polly.loop_exit805, label %vector.body967, !llvm.loop !101
...
vector.body985:                                   ; preds = %vector.body985, %vector.ph988
  ...
  br i1 %263, label %polly.loop_exit831, label %vector.body985, !llvm.loop !104
