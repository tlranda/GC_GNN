; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5411.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5411.c"
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %140 = shl nsw i64 %polly.indvar381, 8
  br label %polly.loop_header384

polly.loop_exit386:                               ; preds = %polly.loop_exit392
  %141 = mul nsw i64 %polly.indvar381, -256
  %142 = shl nsw i64 %polly.indvar381, 6
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %181 = shl nsw i64 %polly.indvar554, 8
  br label %polly.loop_header557

polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %182 = mul nsw i64 %polly.indvar554, -256
  %183 = shl nsw i64 %polly.indvar554, 6
