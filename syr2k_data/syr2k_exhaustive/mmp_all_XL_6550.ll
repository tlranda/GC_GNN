; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6550.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6550.c"
...
polly.loop_exit219.7:                             ; preds = %polly.loop_header217.7
  ...
  %315 = mul nuw nsw i64 %polly.indvar208, 25
  %pexp.p_div_q = lshr i64 %315, 6
...
polly.loop_exit394.7:                             ; preds = %polly.loop_header392.7
  %323 = mul nsw i64 %polly.indvar383, -50
  %324 = mul nuw nsw i64 %polly.indvar383, 25
  %pexp.p_div_q402 = lshr i64 %324, 6
...
polly.loop_exit572.7:                             ; preds = %polly.loop_header570.7
  %332 = mul nsw i64 %polly.indvar561, -50
  %333 = mul nuw nsw i64 %polly.indvar561, 25
  %pexp.p_div_q580 = lshr i64 %333, 6
