; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2904.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2904.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %126 = lshr i64 %polly.indvar208, 2
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1026.not = icmp eq i64 %135, 300
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %136 = add i64 %smax, %indvars.iv1019
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_header233.3, %polly.loop_header233.us.3, %polly.loop_header246.preheader.critedge, %polly.loop_exit235.us.2, %polly.loop_header211.split
  ...
  %polly.loop_guard256 = icmp slt i64 %146, 16
...
polly.loop_header253.us:                          ; preds = %polly.loop_header246.preheader, %polly.loop_exit263.us
  %indvars.iv1021 = phi i64 [ %indvars.iv.next1022, %polly.loop_exit263.us ], [ %136, %polly.loop_header246.preheader ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %196 = lshr i64 %polly.indvar398, 2
  %197 = shl nuw nsw i64 %196, 4
  %198 = sub nsw i64 %indvars.iv1033, %197
  %199 = add i64 %indvars.iv1038, %197
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1048.not = icmp eq i64 %205, 300
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1040 = phi i64 [ %indvars.iv.next1041, %polly.loop_exit445 ], [ %199, %polly.loop_header395 ]
  %indvars.iv1035 = phi i64 [ %indvars.iv.next1036, %polly.loop_exit445 ], [ %198, %polly.loop_header395 ]
  %polly.indvar405 = phi i64 [ %polly.indvar_next406, %polly.loop_exit445 ], [ %196, %polly.loop_header395 ]
  %smax1037 = call i64 @llvm.smax.i64(i64 %indvars.iv1035, i64 0)
  %206 = add i64 %smax1037, %indvars.iv1040
  %207 = shl nsw i64 %polly.indvar405, 2
  %.not.not885 = icmp ugt i64 %207, %polly.indvar398
  %208 = shl nsw i64 %polly.indvar405, 4
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_header429.3, %polly.loop_header429.us.3, %polly.loop_header443.preheader.critedge, %polly.loop_exit431.us.2, %polly.loop_header402.split
  ...
  %polly.loop_guard453 = icmp slt i64 %216, 16
...
polly.loop_header450.us:                          ; preds = %polly.loop_header443.preheader, %polly.loop_exit460.us
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit460.us ], [ %206, %polly.loop_header443.preheader ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %266 = lshr i64 %polly.indvar595, 2
  %267 = shl nuw nsw i64 %266, 4
  %268 = sub nsw i64 %indvars.iv1055, %267
  %269 = add i64 %indvars.iv1060, %267
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1062 = phi i64 [ %indvars.iv.next1063, %polly.loop_exit642 ], [ %269, %polly.loop_header592 ]
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit642 ], [ %268, %polly.loop_header592 ]
  %polly.indvar602 = phi i64 [ %polly.indvar_next603, %polly.loop_exit642 ], [ %266, %polly.loop_header592 ]
  %smax1059 = call i64 @llvm.smax.i64(i64 %indvars.iv1057, i64 0)
  %276 = add i64 %smax1059, %indvars.iv1062
  %277 = shl nsw i64 %polly.indvar602, 2
  %.not.not886 = icmp ugt i64 %277, %polly.indvar595
  %278 = shl nsw i64 %polly.indvar602, 4
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_header626.3, %polly.loop_header626.us.3, %polly.loop_header640.preheader.critedge, %polly.loop_exit628.us.2, %polly.loop_header599.split
  ...
  %polly.loop_guard650 = icmp slt i64 %286, 16
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.preheader, %polly.loop_exit657.us
  %indvars.iv1064 = phi i64 [ %indvars.iv.next1065, %polly.loop_exit657.us ], [ %276, %polly.loop_header640.preheader ]
...
polly.loop_header253.us.1:                        ; preds = %polly.loop_exit263.us, %polly.loop_exit263.us.1
  %indvars.iv1021.1 = phi i64 [ %indvars.iv.next1022.1, %polly.loop_exit263.us.1 ], [ %136, %polly.loop_exit263.us ]
...
polly.loop_header253.us.2:                        ; preds = %polly.loop_exit263.us.1, %polly.loop_exit263.us.2
  %indvars.iv1021.2 = phi i64 [ %indvars.iv.next1022.2, %polly.loop_exit263.us.2 ], [ %136, %polly.loop_exit263.us.1 ]
...
polly.loop_header253.us.3:                        ; preds = %polly.loop_exit263.us.2, %polly.loop_exit263.us.3
  %indvars.iv1021.3 = phi i64 [ %indvars.iv.next1022.3, %polly.loop_exit263.us.3 ], [ %136, %polly.loop_exit263.us.2 ]
...
polly.loop_header450.us.1:                        ; preds = %polly.loop_exit460.us, %polly.loop_exit460.us.1
  %indvars.iv1042.1 = phi i64 [ %indvars.iv.next1043.1, %polly.loop_exit460.us.1 ], [ %206, %polly.loop_exit460.us ]
...
polly.loop_header450.us.2:                        ; preds = %polly.loop_exit460.us.1, %polly.loop_exit460.us.2
  %indvars.iv1042.2 = phi i64 [ %indvars.iv.next1043.2, %polly.loop_exit460.us.2 ], [ %206, %polly.loop_exit460.us.1 ]
...
polly.loop_header450.us.3:                        ; preds = %polly.loop_exit460.us.2, %polly.loop_exit460.us.3
  %indvars.iv1042.3 = phi i64 [ %indvars.iv.next1043.3, %polly.loop_exit460.us.3 ], [ %206, %polly.loop_exit460.us.2 ]
...
polly.loop_header647.us.1:                        ; preds = %polly.loop_exit657.us, %polly.loop_exit657.us.1
  %indvars.iv1064.1 = phi i64 [ %indvars.iv.next1065.1, %polly.loop_exit657.us.1 ], [ %276, %polly.loop_exit657.us ]
...
polly.loop_header647.us.2:                        ; preds = %polly.loop_exit657.us.1, %polly.loop_exit657.us.2
  %indvars.iv1064.2 = phi i64 [ %indvars.iv.next1065.2, %polly.loop_exit657.us.2 ], [ %276, %polly.loop_exit657.us.1 ]
...
polly.loop_header647.us.3:                        ; preds = %polly.loop_exit657.us.2, %polly.loop_exit657.us.3
  %indvars.iv1064.3 = phi i64 [ %indvars.iv.next1065.3, %polly.loop_exit657.us.3 ], [ %276, %polly.loop_exit657.us.2 ]
