; ModuleID = 'syr2k_exhaustive/mmp_all_SM_991.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_991.c"
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %smin1147 = call i64 @llvm.smin.i64(i64 %indvars.iv1125, i64 -984)
  %181 = add nsw i64 %smin1147, 1000
  %182 = shl nsw i64 %polly.indvar413, 4
  br label %polly.loop_header416

polly.loop_exit418:                               ; preds = %polly.loop_exit441
  %polly.indvar_next414 = add nuw nsw i64 %polly.indvar413, 1
  %indvars.iv.next1126 = add nsw i64 %indvars.iv1125, -16
  %exitcond1150.not = icmp eq i64 %polly.indvar_next414, 63
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %smin1178 = call i64 @llvm.smin.i64(i64 %indvars.iv1156, i64 -984)
  %265 = add nsw i64 %smin1178, 1000
  %266 = shl nsw i64 %polly.indvar630, 4
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %indvars.iv.next1157 = add nsw i64 %indvars.iv1156, -16
  %exitcond1181.not = icmp eq i64 %polly.indvar_next631, 63
