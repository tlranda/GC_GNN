; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2659.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2659.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar_next220, 10
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %108 = mul i64 %polly.indvar225, 100
  %109 = add i64 %97, %108
  %smax1325 = call i64 @llvm.smax.i64(i64 %109, i64 0)
  %110 = mul i64 %polly.indvar225, -100
  %111 = add i64 %98, %110
  %112 = add i64 %smax1325, %111
  %113 = mul nsw i64 %polly.indvar225, 100
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1328 = call i64 @llvm.smin.i64(i64 %120, i64 99)
  %121 = add nsw i64 %smin1328, 1
  %smin1033 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 99)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  ...
  %156 = mul nsw i64 %polly.indvar417, -128
  %157 = shl nuw nsw i64 %polly.indvar417, 7
  ...
  %.inv908 = icmp ult i64 %160, 11
  %161 = mul nsw i64 %polly.indvar417, -128
  %162 = icmp slt i64 %161, -1072
  %163 = select i1 %162, i64 %161, i64 -1072
  %164 = add nsw i64 %163, 1199
  %165 = shl nsw i64 %polly.indvar417, 7
  %.op1125 = add nuw i64 %160, 2
  %166 = select i1 %.inv908, i64 %.op1125, i64 12
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %exitcond1061.not = icmp eq i64 %polly.indvar_next418, 10
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %167 = mul i64 %polly.indvar424, 100
  %168 = add i64 %156, %167
  %smax1277 = call i64 @llvm.smax.i64(i64 %168, i64 0)
  %169 = mul i64 %polly.indvar424, -100
  %170 = add i64 %157, %169
  %171 = add i64 %smax1277, %170
  %172 = mul nsw i64 %polly.indvar424, 100
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1280 = call i64 @llvm.smin.i64(i64 %179, i64 99)
  %180 = add nsw i64 %smin1280, 1
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1052, i64 99)
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  ...
  %215 = mul nsw i64 %polly.indvar622, -128
  %216 = shl nuw nsw i64 %polly.indvar622, 7
  ...
  %.inv910 = icmp ult i64 %219, 11
  %220 = mul nsw i64 %polly.indvar622, -128
  %221 = icmp slt i64 %220, -1072
  %222 = select i1 %221, i64 %220, i64 -1072
  %223 = add nsw i64 %222, 1199
  %224 = shl nsw i64 %polly.indvar622, 7
  %.op1127 = add nuw i64 %219, 2
  %225 = select i1 %.inv910, i64 %.op1127, i64 12
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %exitcond1085.not = icmp eq i64 %polly.indvar_next623, 10
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %226 = mul i64 %polly.indvar629, 100
  %227 = add i64 %215, %226
  %smax1229 = call i64 @llvm.smax.i64(i64 %227, i64 0)
  %228 = mul i64 %polly.indvar629, -100
  %229 = add i64 %216, %228
  %230 = add i64 %smax1229, %229
  %231 = mul nsw i64 %polly.indvar629, 100
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1232 = call i64 @llvm.smin.i64(i64 %238, i64 99)
