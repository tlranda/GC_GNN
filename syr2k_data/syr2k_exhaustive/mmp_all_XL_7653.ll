; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7653.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7653.c"
...
for.cond1.preheader.i:                            ; preds = %entry, %for.inc17.i
  ...
  %scevgep943 = getelementptr i8, i8* %call2, i64 %12
  %scevgep942 = getelementptr i8, i8* %call2, i64 %11
  %scevgep941 = getelementptr i8, i8* %call1, i64 %12
  %scevgep940 = getelementptr i8, i8* %call1, i64 %11
  %bound0 = icmp ult i8* %scevgep940, %scevgep943
  %bound1 = icmp ult i8* %scevgep942, %scevgep941
...
for.inc17.i:                                      ; preds = %vector.body, %for.body3.i
  ...
  br i1 %exitcond18.not.i, label %vector.ph947, label %for.cond1.preheader.i, !llvm.loop !15

vector.ph947:                                     ; preds = %for.inc17.i, %for.inc41.i
  %indvars.iv7.i = phi i64 [ %indvars.iv.next8.i, %for.inc41.i ], [ 0, %for.inc17.i ]
  %broadcast.splatinsert954 = insertelement <4 x i64> poison, i64 %indvars.iv7.i, i32 0
...
vector.body946:                                   ; preds = %vector.body946, %vector.ph947
  %index948 = phi i64 [ 0, %vector.ph947 ], [ %index.next949, %vector.body946 ]
  %vec.ind952 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph947 ], [ %vec.ind.next953, %vector.body946 ]
  %32 = mul nuw nsw <4 x i64> %vec.ind952, %broadcast.splat955
  %33 = trunc <4 x i64> %32 to <4 x i32>
  %34 = add <4 x i32> %33, <i32 3, i32 3, i32 3, i32 3>
  %35 = urem <4 x i32> %34, <i32 1200, i32 1200, i32 1200, i32 1200>
  %36 = sitofp <4 x i32> %35 to <4 x double>
  %37 = fmul fast <4 x double> %36, <double 1.000000e-03, double 1.000000e-03, double 1.000000e-03, double 1.000000e-03>
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call776, i64 %indvars.iv7.i, i64 %index948
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next949 = add i64 %index948, 4
  %vec.ind.next953 = add <4 x i64> %vec.ind952, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next949, 1200
  br i1 %40, label %for.inc41.i, label %vector.body946, !llvm.loop !16

for.inc41.i:                                      ; preds = %vector.body946
  %indvars.iv.next8.i = add nuw nsw i64 %indvars.iv7.i, 1
  %exitcond9.not.i = icmp eq i64 %indvars.iv.next8.i, 1200
  br i1 %exitcond9.not.i, label %init_array.exit, label %vector.ph947, !llvm.loop !17
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check1010 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check1010, label %for.body3.i46.preheader1084, label %vector.ph1011

vector.ph1011:                                    ; preds = %for.body3.i46.preheader
  %n.vec1013 = and i64 %indvars.iv21.i, 9223372036854775804
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call776, i64 %indvars.iv21.i, i64 %index1014
  ...
  %46 = icmp eq i64 %index.next1015, %n.vec1013
  br i1 %46, label %middle.block1007, label %vector.body1009, !llvm.loop !18

middle.block1007:                                 ; preds = %vector.body1009
  %cmp.n1017 = icmp eq i64 %indvars.iv21.i, %n.vec1013
  br i1 %cmp.n1017, label %for.inc6.i, label %for.body3.i46.preheader1084

for.body3.i46.preheader1084:                      ; preds = %for.body3.i46.preheader, %middle.block1007
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec1013, %middle.block1007 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1084, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1084 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block1007, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1033 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1033, label %for.body3.i60.preheader1083, label %vector.ph1034

vector.ph1034:                                    ; preds = %for.body3.i60.preheader
  %n.vec1036 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1032:                                  ; preds = %vector.body1032, %vector.ph1034
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call776, i64 %indvars.iv21.i52, i64 %index1037
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1041 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1041, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1038 = add i64 %index1037, 4
  %57 = icmp eq i64 %index.next1038, %n.vec1036
  br i1 %57, label %middle.block1030, label %vector.body1032, !llvm.loop !55

middle.block1030:                                 ; preds = %vector.body1032
  %cmp.n1040 = icmp eq i64 %indvars.iv21.i52, %n.vec1036
  br i1 %cmp.n1040, label %for.inc6.i63, label %for.body3.i60.preheader1083

for.body3.i60.preheader1083:                      ; preds = %for.body3.i60.preheader, %middle.block1030
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1036, %middle.block1030 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1083, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1083 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1030, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1059 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1059, label %for.body3.i99.preheader1082, label %vector.ph1060

vector.ph1060:                                    ; preds = %for.body3.i99.preheader
  %n.vec1062 = and i64 %indvars.iv21.i91, 9223372036854775804
  br label %vector.body1058

vector.body1058:                                  ; preds = %vector.body1058, %vector.ph1060
  %index1063 = phi i64 [ 0, %vector.ph1060 ], [ %index.next1064, %vector.body1058 ]
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call776, i64 %indvars.iv21.i91, i64 %index1063
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1067 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1067, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1064 = add i64 %index1063, 4
  %68 = icmp eq i64 %index.next1064, %n.vec1062
  br i1 %68, label %middle.block1056, label %vector.body1058, !llvm.loop !57

middle.block1056:                                 ; preds = %vector.body1058
  %cmp.n1066 = icmp eq i64 %indvars.iv21.i91, %n.vec1062
  br i1 %cmp.n1066, label %for.inc6.i102, label %for.body3.i99.preheader1082

for.body3.i99.preheader1082:                      ; preds = %for.body3.i99.preheader, %middle.block1056
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1062, %middle.block1056 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1082, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1082 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1056, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit193, %polly.start
  %indvar1071 = phi i64 [ %indvar.next1072, %polly.loop_exit193 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1071, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1073 = icmp ult i64 %88, 4
  br i1 %min.iters.check1073, label %polly.loop_header191.preheader, label %vector.ph1074

vector.ph1074:                                    ; preds = %polly.loop_header
  %n.vec1076 = and i64 %88, -4
  br label %vector.body1070

vector.body1070:                                  ; preds = %vector.body1070, %vector.ph1074
  %index1077 = phi i64 [ 0, %vector.ph1074 ], [ %index.next1078, %vector.body1070 ]
  %90 = shl nuw nsw i64 %index1077, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1081 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  %93 = fmul fast <4 x double> %wide.load1081, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !63, !noalias !65
  %index.next1078 = add i64 %index1077, 4
  %95 = icmp eq i64 %index.next1078, %n.vec1076
  br i1 %95, label %middle.block1068, label %vector.body1070, !llvm.loop !69

middle.block1068:                                 ; preds = %vector.body1070
  %cmp.n1080 = icmp eq i64 %88, %n.vec1076
  br i1 %cmp.n1080, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block1068
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1076, %middle.block1068 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1068
  %polly.indvar_next = add nuw nsw i64 %polly.indvar, 1
  %exitcond853.not = icmp eq i64 %polly.indvar_next, 1200
  %indvar.next1072 = add i64 %indvar1071, 1
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond852.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !70
...
polly.loop_exit207:                               ; preds = %polly.loop_header205
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar_next203, 1000
  br i1 %exitcond851.not, label %polly.loop_header215, label %polly.loop_header199
...
polly.loop_header205:                             ; preds = %polly.loop_header205, %polly.loop_header199
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next209, 1200
  br i1 %exitcond850.not, label %polly.loop_exit207, label %polly.loop_header205
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar_next219, 13
  br i1 %exitcond849.not, label %polly.exiting, label %polly.loop_header215
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 -984)
  %102 = shl nsw i64 %polly.indvar224, 4
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar_next225, 63
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %104 = mul nuw nsw i64 %polly.indvar230, 100
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar230, %umin
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249935 = icmp sgt i64 %110, -1
  %111 = add nuw nsw i64 %polly.indvar236, %101
  %112 = mul i64 %111, 8000
  %113 = mul i64 %111, 9600
  br i1 %polly.loop_guard249935, label %polly.loop_header239.us, label %polly.loop_exit241
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.start272
  %indvar1045 = phi i64 [ %indvar.next1046, %polly.loop_exit366 ], [ 0, %polly.start272 ]
  %polly.indvar361 = phi i64 [ %polly.indvar_next362, %polly.loop_exit366 ], [ 1, %polly.start272 ]
  %122 = add i64 %indvar1045, 1
  %123 = mul nuw nsw i64 %polly.indvar361, 9600
  %scevgep370 = getelementptr i8, i8* %call, i64 %123
  %min.iters.check1047 = icmp ult i64 %122, 4
  br i1 %min.iters.check1047, label %polly.loop_header364.preheader, label %vector.ph1048

vector.ph1048:                                    ; preds = %polly.loop_header358
  %n.vec1050 = and i64 %122, -4
...
vector.body1044:                                  ; preds = %vector.body1044, %vector.ph1048
  ...
  %124 = shl nuw nsw i64 %index1051, 3
  %125 = getelementptr i8, i8* %scevgep370, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1055 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  %127 = fmul fast <4 x double> %wide.load1055, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1052, %n.vec1050
  br i1 %129, label %middle.block1042, label %vector.body1044, !llvm.loop !80

middle.block1042:                                 ; preds = %vector.body1044
  %cmp.n1054 = icmp eq i64 %122, %n.vec1050
  br i1 %cmp.n1054, label %polly.loop_exit366, label %polly.loop_header364.preheader

polly.loop_header364.preheader:                   ; preds = %polly.loop_header358, %middle.block1042
  %polly.indvar367.ph = phi i64 [ 0, %polly.loop_header358 ], [ %n.vec1050, %middle.block1042 ]
  br label %polly.loop_header364

polly.loop_exit366:                               ; preds = %polly.loop_header364, %middle.block1042
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv859 = phi i64 [ %indvars.iv.next860, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  %indvars.iv854 = phi i64 [ %indvars.iv.next855, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  %polly.indvar393 = phi i64 [ %polly.indvar_next394, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  %umin871 = call i64 @llvm.umin.i64(i64 %polly.indvar393, i64 11)
  %131 = mul nsw i64 %polly.indvar393, -96
  %132 = icmp slt i64 %131, -1104
  %133 = select i1 %132, i64 %131, i64 -1104
  %134 = add nsw i64 %133, 1199
  %135 = mul nuw nsw i64 %polly.indvar393, 96
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit404
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next855 = add nsw i64 %indvars.iv854, -96
  %indvars.iv.next860 = add nuw nsw i64 %indvars.iv859, 96
  %exitcond874.not = icmp eq i64 %polly.indvar_next394, 13
...
polly.loop_header396:                             ; preds = %polly.loop_exit404, %polly.loop_header390
  %indvars.iv867 = phi i64 [ %indvars.iv.next868, %polly.loop_exit404 ], [ 0, %polly.loop_header390 ]
  %polly.indvar399 = phi i64 [ %polly.indvar_next400, %polly.loop_exit404 ], [ 0, %polly.loop_header390 ]
  %smin869 = call i64 @llvm.smin.i64(i64 %indvars.iv867, i64 -984)
  %136 = shl nsw i64 %polly.indvar399, 4
  %137 = add nsw i64 %smin869, 999
  br label %polly.loop_header402

polly.loop_exit404:                               ; preds = %polly.loop_exit411
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %indvars.iv.next868 = add nsw i64 %indvars.iv867, -16
  %exitcond873.not = icmp eq i64 %polly.indvar_next400, 63
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  %indvars.iv861 = phi i64 [ %indvars.iv.next862, %polly.loop_exit411 ], [ %indvars.iv859, %polly.loop_header396 ]
  %indvars.iv856 = phi i64 [ %indvars.iv.next857, %polly.loop_exit411 ], [ %indvars.iv854, %polly.loop_header396 ]
  %polly.indvar405 = phi i64 [ %polly.indvar_next406, %polly.loop_exit411 ], [ 0, %polly.loop_header396 ]
  %138 = mul nuw nsw i64 %polly.indvar405, 100
...
polly.loop_header409.preheader:                   ; preds = %polly.loop_header402
  ...
  %142 = add i64 %smax858, %indvars.iv861
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418, %polly.loop_header402
  ...
  %indvars.iv.next862 = add nsw i64 %indvars.iv861, -100
  %exitcond872.not = icmp eq i64 %polly.indvar405, %umin871
  br i1 %exitcond872.not, label %polly.loop_exit404, label %polly.loop_header402

polly.loop_header409:                             ; preds = %polly.loop_header409.preheader, %polly.loop_exit418
  %indvars.iv863 = phi i64 [ %142, %polly.loop_header409.preheader ], [ %indvars.iv.next864, %polly.loop_exit418 ]
  ...
  %polly.loop_guard426936 = icmp sgt i64 %144, -1
  %145 = add nuw nsw i64 %polly.indvar413, %135
  %146 = mul i64 %145, 8000
  %147 = mul i64 %145, 9600
  br i1 %polly.loop_guard426936, label %polly.loop_header416.us, label %polly.loop_exit418
...
polly.loop_header423.us:                          ; preds = %polly.loop_header416.us, %polly.loop_header423.us
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar427.us, %smin865
  br i1 %exitcond866.not, label %polly.loop_exit425.loopexit.us, label %polly.loop_header423.us

polly.loop_exit425.loopexit.us:                   ; preds = %polly.loop_header423.us
  %polly.indvar_next420.us = add nuw nsw i64 %polly.indvar419.us, 1
  %exitcond870.not = icmp eq i64 %polly.indvar419.us, %137
  br i1 %exitcond870.not, label %polly.loop_exit418, label %polly.loop_header416.us
...
polly.loop_header535:                             ; preds = %polly.loop_exit543, %polly.start449
  ...
  %min.iters.check1021 = icmp ult i64 %156, 4
  br i1 %min.iters.check1021, label %polly.loop_header541.preheader, label %vector.ph1022

vector.ph1022:                                    ; preds = %polly.loop_header535
  %n.vec1024 = and i64 %156, -4
...
vector.body1020:                                  ; preds = %vector.body1020, %vector.ph1022
  ...
  %158 = shl nuw nsw i64 %index1025, 3
  %159 = getelementptr i8, i8* %scevgep547, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load1029 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  %161 = fmul fast <4 x double> %wide.load1029, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next1026, %n.vec1024
  br i1 %163, label %middle.block1018, label %vector.body1020, !llvm.loop !90

middle.block1018:                                 ; preds = %vector.body1020
  %cmp.n1028 = icmp eq i64 %156, %n.vec1024
  br i1 %cmp.n1028, label %polly.loop_exit543, label %polly.loop_header541.preheader

polly.loop_header541.preheader:                   ; preds = %polly.loop_header535, %middle.block1018
  %polly.indvar544.ph = phi i64 [ 0, %polly.loop_header535 ], [ %n.vec1024, %middle.block1018 ]
  br label %polly.loop_header541

polly.loop_exit543:                               ; preds = %polly.loop_header541, %middle.block1018
  %polly.indvar_next539 = add nuw nsw i64 %polly.indvar538, 1
  %exitcond903.not = icmp eq i64 %polly.indvar_next539, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond903.not, label %polly.loop_header551.preheader, label %polly.loop_header535
...
polly.loop_header541:                             ; preds = %polly.loop_header541.preheader, %polly.loop_header541
  ...
  %exitcond902.not = icmp eq i64 %polly.indvar_next545, %polly.indvar538
  br i1 %exitcond902.not, label %polly.loop_exit543, label %polly.loop_header541, !llvm.loop !91
...
polly.loop_exit559:                               ; preds = %polly.loop_header557
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar_next555, 1000
  br i1 %exitcond901.not, label %polly.loop_header567, label %polly.loop_header551
...
polly.loop_header557:                             ; preds = %polly.loop_header557, %polly.loop_header551
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar_next561, 1200
  br i1 %exitcond900.not, label %polly.loop_exit559, label %polly.loop_header557

polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  %indvars.iv884 = phi i64 [ %indvars.iv.next885, %polly.loop_exit575 ], [ 0, %polly.loop_exit559 ]
  %indvars.iv879 = phi i64 [ %indvars.iv.next880, %polly.loop_exit575 ], [ 0, %polly.loop_exit559 ]
  %polly.indvar570 = phi i64 [ %polly.indvar_next571, %polly.loop_exit575 ], [ 0, %polly.loop_exit559 ]
  %umin896 = call i64 @llvm.umin.i64(i64 %polly.indvar570, i64 11)
  %165 = mul nsw i64 %polly.indvar570, -96
  %166 = icmp slt i64 %165, -1104
  %167 = select i1 %166, i64 %165, i64 -1104
  %168 = add nsw i64 %167, 1199
  %169 = mul nuw nsw i64 %polly.indvar570, 96
  br label %polly.loop_header573

polly.loop_exit575:                               ; preds = %polly.loop_exit581
  %polly.indvar_next571 = add nuw nsw i64 %polly.indvar570, 1
  %indvars.iv.next880 = add nsw i64 %indvars.iv879, -96
  %indvars.iv.next885 = add nuw nsw i64 %indvars.iv884, 96
  %exitcond899.not = icmp eq i64 %polly.indvar_next571, 13
  br i1 %exitcond899.not, label %polly.exiting450, label %polly.loop_header567

polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_header567
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit581 ], [ 0, %polly.loop_header567 ]
  %polly.indvar576 = phi i64 [ %polly.indvar_next577, %polly.loop_exit581 ], [ 0, %polly.loop_header567 ]
  %smin894 = call i64 @llvm.smin.i64(i64 %indvars.iv892, i64 -984)
  %170 = shl nsw i64 %polly.indvar576, 4
  %171 = add nsw i64 %smin894, 999
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588
  ...
  %exitcond898.not = icmp eq i64 %polly.indvar_next577, 63
  br i1 %exitcond898.not, label %polly.loop_exit575, label %polly.loop_header573

polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  %indvars.iv886 = phi i64 [ %indvars.iv.next887, %polly.loop_exit588 ], [ %indvars.iv884, %polly.loop_header573 ]
  %indvars.iv881 = phi i64 [ %indvars.iv.next882, %polly.loop_exit588 ], [ %indvars.iv879, %polly.loop_header573 ]
  %polly.indvar582 = phi i64 [ %polly.indvar_next583, %polly.loop_exit588 ], [ 0, %polly.loop_header573 ]
  %172 = mul nuw nsw i64 %polly.indvar582, 100
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header579
  ...
  %176 = add i64 %smax883, %indvars.iv886
...
polly.loop_exit588:                               ; preds = %polly.loop_exit595, %polly.loop_header579
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar582, %umin896
  br i1 %exitcond897.not, label %polly.loop_exit581, label %polly.loop_header579

polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit595
  %indvars.iv888 = phi i64 [ %176, %polly.loop_header586.preheader ], [ %indvars.iv.next889, %polly.loop_exit595 ]
  ...
  %polly.loop_guard603937 = icmp sgt i64 %178, -1
  %179 = add nuw nsw i64 %polly.indvar590, %169
  %180 = mul i64 %179, 8000
  %181 = mul i64 %179, 9600
  br i1 %polly.loop_guard603937, label %polly.loop_header593.us, label %polly.loop_exit595
...
polly.loop_header600.us:                          ; preds = %polly.loop_header593.us, %polly.loop_header600.us
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar604.us, %smin890
  br i1 %exitcond891.not, label %polly.loop_exit602.loopexit.us, label %polly.loop_header600.us

polly.loop_exit602.loopexit.us:                   ; preds = %polly.loop_header600.us
  %polly.indvar_next597.us = add nuw nsw i64 %polly.indvar596.us, 1
  %exitcond895.not = icmp eq i64 %polly.indvar596.us, %171
  br i1 %exitcond895.not, label %polly.loop_exit595, label %polly.loop_header593.us
...
polly.loop_header750:                             ; preds = %entry, %polly.loop_exit758
  %indvars.iv928 = phi i64 [ %indvars.iv.next929, %polly.loop_exit758 ], [ 0, %entry ]
...
polly.loop_exit758:                               ; preds = %polly.loop_exit764
  ...
  %exitcond933.not = icmp eq i64 %polly.indvar_next754, 38
  br i1 %exitcond933.not, label %polly.loop_header777, label %polly.loop_header750

polly.loop_header756:                             ; preds = %polly.loop_exit764, %polly.loop_header750
  %indvars.iv924 = phi i64 [ %indvars.iv.next925, %polly.loop_exit764 ], [ 0, %polly.loop_header750 ]
  %polly.indvar759 = phi i64 [ %polly.indvar_next760, %polly.loop_exit764 ], [ 0, %polly.loop_header750 ]
  %192 = mul nsw i64 %polly.indvar759, -32
  %smin959 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin959, 1200
  %smin926 = call i64 @llvm.smin.i64(i64 %indvars.iv924, i64 -1168)
  %194 = shl nsw i64 %polly.indvar759, 5
  %195 = add nsw i64 %smin926, 1199
...
polly.loop_exit764:                               ; preds = %polly.loop_exit770
  ...
  %exitcond932.not = icmp eq i64 %polly.indvar_next760, 38
  br i1 %exitcond932.not, label %polly.loop_exit758, label %polly.loop_header756
...
polly.loop_header762:                             ; preds = %polly.loop_exit770, %polly.loop_header756
  ...
  br i1 %min.iters.check, label %polly.loop_header768, label %vector.ph960

vector.ph960:                                     ; preds = %polly.loop_header762
  %broadcast.splatinsert967 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat968 = shufflevector <4 x i64> %broadcast.splatinsert967, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert969 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body958:                                   ; preds = %vector.body958, %vector.ph960
  %index961 = phi i64 [ 0, %vector.ph960 ], [ %index.next962, %vector.body958 ]
  %vec.ind965 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph960 ], [ %vec.ind.next966, %vector.body958 ]
  %199 = add nuw nsw <4 x i64> %vec.ind965, %broadcast.splat968
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat970, %200
  ...
  %211 = icmp eq i64 %index.next962, %193
  br i1 %211, label %polly.loop_exit770, label %vector.body958, !llvm.loop !99

polly.loop_exit770:                               ; preds = %vector.body958, %polly.loop_header768
  %polly.indvar_next766 = add nuw nsw i64 %polly.indvar765, 1
  %exitcond931.not = icmp eq i64 %polly.indvar765, %191
  br i1 %exitcond931.not, label %polly.loop_exit764, label %polly.loop_header762
...
polly.loop_header768:                             ; preds = %polly.loop_header762, %polly.loop_header768
  ...
  %exitcond927.not = icmp eq i64 %polly.indvar771, %195
  br i1 %exitcond927.not, label %polly.loop_exit770, label %polly.loop_header768, !llvm.loop !100

polly.loop_header777:                             ; preds = %polly.loop_exit758, %polly.loop_exit785
  %indvars.iv918 = phi i64 [ %indvars.iv.next919, %polly.loop_exit785 ], [ 0, %polly.loop_exit758 ]
...
polly.loop_exit785:                               ; preds = %polly.loop_exit791
  ...
  %exitcond923.not = icmp eq i64 %polly.indvar_next781, 38
  br i1 %exitcond923.not, label %polly.loop_header803, label %polly.loop_header777

polly.loop_header783:                             ; preds = %polly.loop_exit791, %polly.loop_header777
  %indvars.iv914 = phi i64 [ %indvars.iv.next915, %polly.loop_exit791 ], [ 0, %polly.loop_header777 ]
  %polly.indvar786 = phi i64 [ %polly.indvar_next787, %polly.loop_exit791 ], [ 0, %polly.loop_header777 ]
  %221 = mul nsw i64 %polly.indvar786, -32
  %smin974 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin974, 1000
  %smin916 = call i64 @llvm.smin.i64(i64 %indvars.iv914, i64 -968)
  %223 = shl nsw i64 %polly.indvar786, 5
  %224 = add nsw i64 %smin916, 999
...
polly.loop_exit791:                               ; preds = %polly.loop_exit797
  ...
  %exitcond922.not = icmp eq i64 %polly.indvar_next787, 32
  br i1 %exitcond922.not, label %polly.loop_exit785, label %polly.loop_header783
...
polly.loop_header789:                             ; preds = %polly.loop_exit797, %polly.loop_header783
  ...
  %min.iters.check975 = icmp eq i64 %222, 0
  br i1 %min.iters.check975, label %polly.loop_header795, label %vector.ph976

vector.ph976:                                     ; preds = %polly.loop_header789
  %broadcast.splatinsert985 = insertelement <4 x i64> poison, i64 %223, i32 0
  %broadcast.splat986 = shufflevector <4 x i64> %broadcast.splatinsert985, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert987 = insertelement <4 x i32> poison, i32 %226, i32 0
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph976
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind983, %broadcast.splat986
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat988, %229
  ...
  %240 = icmp eq i64 %index.next980, %222
  br i1 %240, label %polly.loop_exit797, label %vector.body973, !llvm.loop !102

polly.loop_exit797:                               ; preds = %vector.body973, %polly.loop_header795
  %polly.indvar_next793 = add nuw nsw i64 %polly.indvar792, 1
  %exitcond921.not = icmp eq i64 %polly.indvar792, %220
  br i1 %exitcond921.not, label %polly.loop_exit791, label %polly.loop_header789
...
polly.loop_header795:                             ; preds = %polly.loop_header789, %polly.loop_header795
  ...
  %exitcond917.not = icmp eq i64 %polly.indvar798, %224
  br i1 %exitcond917.not, label %polly.loop_exit797, label %polly.loop_header795, !llvm.loop !103

polly.loop_header803:                             ; preds = %polly.loop_exit785, %polly.loop_exit811
  %indvars.iv908 = phi i64 [ %indvars.iv.next909, %polly.loop_exit811 ], [ 0, %polly.loop_exit785 ]
...
polly.loop_exit811:                               ; preds = %polly.loop_exit817
  ...
  %exitcond913.not = icmp eq i64 %polly.indvar_next807, 38
  br i1 %exitcond913.not, label %init_array.exit, label %polly.loop_header803

polly.loop_header809:                             ; preds = %polly.loop_exit817, %polly.loop_header803
  %indvars.iv904 = phi i64 [ %indvars.iv.next905, %polly.loop_exit817 ], [ 0, %polly.loop_header803 ]
  %polly.indvar812 = phi i64 [ %polly.indvar_next813, %polly.loop_exit817 ], [ 0, %polly.loop_header803 ]
  %250 = mul nsw i64 %polly.indvar812, -32
  %smin992 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin992, 1000
  %smin906 = call i64 @llvm.smin.i64(i64 %indvars.iv904, i64 -968)
  %252 = shl nsw i64 %polly.indvar812, 5
  %253 = add nsw i64 %smin906, 999
...
polly.loop_exit817:                               ; preds = %polly.loop_exit823
  ...
  %exitcond912.not = icmp eq i64 %polly.indvar_next813, 32
  br i1 %exitcond912.not, label %polly.loop_exit811, label %polly.loop_header809
...
polly.loop_header815:                             ; preds = %polly.loop_exit823, %polly.loop_header809
  ...
  %min.iters.check993 = icmp eq i64 %251, 0
  br i1 %min.iters.check993, label %polly.loop_header821, label %vector.ph994

vector.ph994:                                     ; preds = %polly.loop_header815
  %broadcast.splatinsert1003 = insertelement <4 x i64> poison, i64 %252, i32 0
  %broadcast.splat1004 = shufflevector <4 x i64> %broadcast.splatinsert1003, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1005 = insertelement <4 x i32> poison, i32 %255, i32 0
...
vector.body991:                                   ; preds = %vector.body991, %vector.ph994
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind1001, %broadcast.splat1004
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat1006, %258
  ...
  %269 = icmp eq i64 %index.next998, %251
  br i1 %269, label %polly.loop_exit823, label %vector.body991, !llvm.loop !105

polly.loop_exit823:                               ; preds = %vector.body991, %polly.loop_header821
  %polly.indvar_next819 = add nuw nsw i64 %polly.indvar818, 1
  %exitcond911.not = icmp eq i64 %polly.indvar818, %249
  br i1 %exitcond911.not, label %polly.loop_exit817, label %polly.loop_header815
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  %exitcond907.not = icmp eq i64 %polly.indvar824, %253
  br i1 %exitcond907.not, label %polly.loop_exit823, label %polly.loop_header821, !llvm.loop !106
}
