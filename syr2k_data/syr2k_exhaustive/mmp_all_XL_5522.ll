; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5522.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5522.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar_next209, 300
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %108 = shl nsw i64 %polly.indvar230, 3
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header227
  ...
  %indvars.iv.next859 = add i64 %indvars.iv858, -8
  %indvars.iv.next863 = add i64 %indvars.iv862, 8
  %exitcond870.not = icmp eq i64 %polly.indvar_next231, 150
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %139 = shl nsw i64 %polly.indvar383, 2
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %140 = mul nsw i64 %polly.indvar383, -4
...
polly.loop_exit405:                               ; preds = %polly.loop_exit411
  ...
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, -4
  %exitcond898.not = icmp eq i64 %polly.indvar_next384, 300
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  ...
  %144 = shl nsw i64 %polly.indvar406, 3
  %145 = sub nsw i64 %139, %144
  %146 = icmp sgt i64 %145, 0
  %147 = select i1 %146, i64 %145, i64 0
  %polly.loop_guard419 = icmp slt i64 %147, 8
...
polly.loop_header416.us:                          ; preds = %polly.loop_header409.us, %polly.loop_exit426.us
  ...
  %smin893 = call i64 @llvm.smin.i64(i64 %indvars.iv891, i64 3)
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418.loopexit.us, %polly.loop_header403
  ...
  %indvars.iv.next885 = add i64 %indvars.iv884, -8
  %indvars.iv.next890 = add i64 %indvars.iv889, 8
  %exitcond897.not = icmp eq i64 %polly.indvar_next407, 150
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %175 = shl nsw i64 %polly.indvar561, 2
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %176 = mul nsw i64 %polly.indvar561, -4
  br label %polly.loop_header581

polly.loop_exit583:                               ; preds = %polly.loop_exit589
  %polly.indvar_next562 = add nuw nsw i64 %polly.indvar561, 1
  %indvars.iv.next903 = add nsw i64 %indvars.iv902, -4
  %indvars.iv.next910 = add nuw nsw i64 %indvars.iv909, 4
  %indvars.iv.next915 = add nsw i64 %indvars.iv914, -4
  %exitcond925.not = icmp eq i64 %polly.indvar_next562, 300
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  ...
  %180 = shl nsw i64 %polly.indvar584, 3
  %181 = sub nsw i64 %175, %180
  %182 = icmp sgt i64 %181, 0
  %183 = select i1 %182, i64 %181, i64 0
  %polly.loop_guard597 = icmp slt i64 %183, 8
...
polly.loop_header594.us:                          ; preds = %polly.loop_header587.us, %polly.loop_exit604.us
  ...
  %smin920 = call i64 @llvm.smin.i64(i64 %indvars.iv918, i64 3)
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header581
  ...
  %indvars.iv.next912 = add i64 %indvars.iv911, -8
  %indvars.iv.next917 = add i64 %indvars.iv916, 8
  %exitcond924.not = icmp eq i64 %polly.indvar_next585, 150
