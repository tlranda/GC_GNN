; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4727.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4727.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit220
  ...
  %118 = mul nsw i64 %polly.indvar214, 100
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %.inv873 = icmp slt i64 %149, 11
  %151 = select i1 %.inv873, i64 %150, i64 11
  %polly.loop_guard402 = icmp sgt i64 %151, -1
  %152 = mul nsw i64 %polly.indvar388, -64
  %153 = icmp slt i64 %152, -1136
  %154 = select i1 %153, i64 %152, i64 -1136
  %155 = add nsw i64 %154, 1199
  %156 = shl nsw i64 %polly.indvar388, 6
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %168 = mul nsw i64 %polly.indvar403, 100
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %.inv875 = icmp slt i64 %199, 11
  %201 = select i1 %.inv875, i64 %200, i64 11
  %polly.loop_guard595 = icmp sgt i64 %201, -1
  %202 = mul nsw i64 %polly.indvar581, -64
  %203 = icmp slt i64 %202, -1136
  %204 = select i1 %203, i64 %202, i64 -1136
  %205 = add nsw i64 %204, 1199
  %206 = shl nsw i64 %polly.indvar581, 6
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %218 = mul nsw i64 %polly.indvar596, 100
