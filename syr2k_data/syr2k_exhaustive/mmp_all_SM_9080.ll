; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9080.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9080.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %109 = mul nsw i64 %polly.indvar208, -50
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond795.not = icmp eq i64 %polly.indvar_next209, 24
...
polly.loop_exit219:                               ; preds = %polly.loop_exit232.us.3, %polly.loop_header211
  ...
  %exitcond794.not = icmp eq i64 %polly.indvar_next215, 12
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %145 = mul nuw nsw i64 %polly.indvar363, 50
  %146 = mul nsw i64 %polly.indvar363, -50
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit375
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %indvars.iv.next800 = add nuw nsw i64 %indvars.iv799, 50
  %indvars.iv.next805 = add nsw i64 %indvars.iv804, -50
  %exitcond814.not = icmp eq i64 %polly.indvar_next364, 24
...
polly.loop_exit375:                               ; preds = %polly.loop_exit390.us.3, %polly.loop_header367
  ...
  %indvars.iv.next802 = add i64 %indvars.iv801, -100
  %indvars.iv.next807 = add i64 %indvars.iv806, 100
  %exitcond813.not = icmp eq i64 %polly.indvar_next371, 12
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %182 = mul nuw nsw i64 %polly.indvar521, 50
  %183 = mul nsw i64 %polly.indvar521, -50
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next819 = add nuw nsw i64 %indvars.iv818, 50
  %indvars.iv.next824 = add nsw i64 %indvars.iv823, -50
  %exitcond833.not = icmp eq i64 %polly.indvar_next522, 24
...
polly.loop_exit533:                               ; preds = %polly.loop_exit548.us.3, %polly.loop_header525
  ...
  %indvars.iv.next821 = add i64 %indvars.iv820, -100
  %indvars.iv.next826 = add i64 %indvars.iv825, 100
  %exitcond832.not = icmp eq i64 %polly.indvar_next529, 12
...
polly.loop_header223.us.1:                        ; preds = %polly.loop_exit232.us, %polly.loop_exit232.us.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv791.1, i64 49)
...
polly.loop_header223.us.2:                        ; preds = %polly.loop_exit232.us.1, %polly.loop_exit232.us.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv791.2, i64 49)
...
polly.loop_header223.us.3:                        ; preds = %polly.loop_exit232.us.2, %polly.loop_exit232.us.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv791.3, i64 49)
...
polly.loop_header380.us.1:                        ; preds = %polly.loop_exit390.us, %polly.loop_exit390.us.1
  ...
  %smin810.1 = call i64 @llvm.smin.i64(i64 %indvars.iv808.1, i64 49)
...
polly.loop_header380.us.2:                        ; preds = %polly.loop_exit390.us.1, %polly.loop_exit390.us.2
  ...
  %smin810.2 = call i64 @llvm.smin.i64(i64 %indvars.iv808.2, i64 49)
...
polly.loop_header380.us.3:                        ; preds = %polly.loop_exit390.us.2, %polly.loop_exit390.us.3
  ...
  %smin810.3 = call i64 @llvm.smin.i64(i64 %indvars.iv808.3, i64 49)
...
polly.loop_header538.us.2:                        ; preds = %polly.loop_exit548.us.1, %polly.loop_exit548.us.2
  ...
  %smin829.2 = call i64 @llvm.smin.i64(i64 %indvars.iv827.2, i64 49)
...
polly.loop_header538.us.3:                        ; preds = %polly.loop_exit548.us.2, %polly.loop_exit548.us.3
  ...
  %smin829.3 = call i64 @llvm.smin.i64(i64 %indvars.iv827.3, i64 49)
