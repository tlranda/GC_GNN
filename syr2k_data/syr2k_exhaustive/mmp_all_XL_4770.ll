; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4770.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4770.c"
...
vector.body1212:                                  ; preds = %vector.body1212, %vector.ph1216
  ...
  %wide.load1223 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %137, label %middle.block1210, label %vector.body1212, !llvm.loop !80
...
polly.loop_header399.preheader:                   ; preds = %polly.loop_header391
  %149 = shl nsw i64 %polly.indvar394, 5
...
vector.body1188:                                  ; preds = %vector.body1188, %vector.ph1190
  ...
  %wide.load1197 = load <4 x double>, <4 x double>* %176, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %179, label %middle.block1186, label %vector.body1188, !llvm.loop !90
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %191 = shl nsw i64 %polly.indvar587, 5
...
vector.body1127:                                  ; preds = %vector.body1127, %vector.ph1128
  ...
  br i1 %235, label %polly.loop_exit813, label %vector.body1127, !llvm.loop !99
...
vector.body1141:                                  ; preds = %vector.body1141, %vector.ph1144
  ...
  br i1 %264, label %polly.loop_exit840, label %vector.body1141, !llvm.loop !102
...
vector.body1159:                                  ; preds = %vector.body1159, %vector.ph1162
  ...
  br i1 %293, label %polly.loop_exit866, label %vector.body1159, !llvm.loop !105
