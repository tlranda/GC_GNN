; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6751.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6751.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %110 = mul nuw nsw i64 %polly.indvar224, 100
...
polly.loop_exit247.loopexit.us:                   ; preds = %polly.loop_header245.us
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next243.us, 100
...
vector.body1027:                                  ; preds = %vector.body1027, %vector.ph1031
  ...
  %wide.load1038 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %128, label %middle.block1025, label %vector.body1027, !llvm.loop !79
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %130 = udiv i64 %polly.indvar391, 25
...
polly.loop_header394:                             ; preds = %polly.loop_exit403, %polly.loop_header388
  ...
  %143 = mul nuw nsw i64 %polly.indvar397, 100
  br label %polly.loop_header401

polly.loop_exit403:                               ; preds = %polly.loop_exit415.3
  %polly.indvar_next398 = add nuw nsw i64 %polly.indvar397, 1
  %exitcond855.not = icmp eq i64 %polly.indvar_next398, 10
...
polly.loop_header401:                             ; preds = %polly.loop_exit415.3, %polly.loop_header394
  ...
  %144 = mul nuw nsw i64 %polly.indvar404, 100
  %145 = sub nsw i64 %131, %144
  %smin850 = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 99)
...
polly.loop_exit422.loopexit.us:                   ; preds = %polly.loop_header420.us
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar_next417.us, 100
...
polly.loop_exit415:                               ; preds = %polly.loop_exit422.loopexit.us, %polly.loop_header401
  ...
  %smin850.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next849, i64 99)
...
vector.body1003:                                  ; preds = %vector.body1003, %vector.ph1005
  ...
  %wide.load1012 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %161, label %middle.block1001, label %vector.body1003, !llvm.loop !89
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit572
  ...
  %163 = udiv i64 %polly.indvar567, 25
...
polly.loop_header570:                             ; preds = %polly.loop_exit579, %polly.loop_header564
  ...
  %176 = mul nuw nsw i64 %polly.indvar573, 100
  br label %polly.loop_header577

polly.loop_exit579:                               ; preds = %polly.loop_exit591.3
  %polly.indvar_next574 = add nuw nsw i64 %polly.indvar573, 1
  %exitcond872.not = icmp eq i64 %polly.indvar_next574, 10
...
polly.loop_header577:                             ; preds = %polly.loop_exit591.3, %polly.loop_header570
  ...
  %177 = mul nuw nsw i64 %polly.indvar580, 100
  %178 = sub nsw i64 %164, %177
  %smin867 = call i64 @llvm.smin.i64(i64 %indvars.iv863, i64 99)
...
polly.loop_exit598.loopexit.us:                   ; preds = %polly.loop_header596.us
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar_next593.us, 100
...
polly.loop_exit591:                               ; preds = %polly.loop_exit598.loopexit.us, %polly.loop_header577
  ...
  %smin867.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next866, i64 99)
...
vector.body941:                                   ; preds = %vector.body941, %vector.ph943
  ...
  br i1 %208, label %polly.loop_exit766, label %vector.body941, !llvm.loop !98
...
vector.body956:                                   ; preds = %vector.body956, %vector.ph959
  ...
  br i1 %237, label %polly.loop_exit793, label %vector.body956, !llvm.loop !101
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph977
  ...
  br i1 %266, label %polly.loop_exit819, label %vector.body974, !llvm.loop !104
...
polly.loop_exit247.loopexit.us.1:                 ; preds = %polly.loop_header245.us.1
  ...
  %exitcond835.1.not = icmp eq i64 %polly.indvar_next243.us.1, 100
...
polly.loop_exit247.loopexit.us.2:                 ; preds = %polly.loop_header245.us.2
  ...
  %exitcond835.2.not = icmp eq i64 %polly.indvar_next243.us.2, 100
...
polly.loop_exit247.loopexit.us.3:                 ; preds = %polly.loop_header245.us.3
  ...
  %exitcond835.3.not = icmp eq i64 %polly.indvar_next243.us.3, 100
...
polly.loop_exit422.loopexit.us.1:                 ; preds = %polly.loop_header420.us.1
  ...
  %exitcond852.1.not = icmp eq i64 %polly.indvar_next417.us.1, 100
...
polly.loop_exit415.1:                             ; preds = %polly.loop_exit422.loopexit.us.1, %polly.loop_exit415
  ...
  %smin850.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next849.1, i64 99)
...
polly.loop_exit422.loopexit.us.2:                 ; preds = %polly.loop_header420.us.2
  ...
  %exitcond852.2.not = icmp eq i64 %polly.indvar_next417.us.2, 100
...
polly.loop_exit415.2:                             ; preds = %polly.loop_exit422.loopexit.us.2, %polly.loop_exit415.1
  ...
  %smin850.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next849.2, i64 99)
...
polly.loop_exit422.loopexit.us.3:                 ; preds = %polly.loop_header420.us.3
  ...
  %exitcond852.3.not = icmp eq i64 %polly.indvar_next417.us.3, 100
...
polly.loop_exit415.3:                             ; preds = %polly.loop_exit422.loopexit.us.3, %polly.loop_exit415.2
  ...
  %indvars.iv.next847 = add nsw i64 %indvars.iv846, -100
...
polly.loop_exit598.loopexit.us.1:                 ; preds = %polly.loop_header596.us.1
  ...
  %exitcond869.1.not = icmp eq i64 %polly.indvar_next593.us.1, 100
...
polly.loop_exit591.1:                             ; preds = %polly.loop_exit598.loopexit.us.1, %polly.loop_exit591
  ...
  %smin867.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next866.1, i64 99)
...
polly.loop_exit598.loopexit.us.2:                 ; preds = %polly.loop_header596.us.2
  ...
  %exitcond869.2.not = icmp eq i64 %polly.indvar_next593.us.2, 100
...
polly.loop_exit591.2:                             ; preds = %polly.loop_exit598.loopexit.us.2, %polly.loop_exit591.1
  ...
  %smin867.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next866.2, i64 99)
...
polly.loop_exit598.loopexit.us.3:                 ; preds = %polly.loop_header596.us.3
  ...
  %exitcond869.3.not = icmp eq i64 %polly.indvar_next593.us.3, 100
