; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3654.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3654.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1033.not = icmp eq i64 %121, 75
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %122 = add i64 %smax, %indvars.iv1025
  %123 = mul nuw nsw i64 %polly.indvar214, 6
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %137 = mul nsw i64 %polly.indvar214, -96
...
polly.loop_header253:                             ; preds = %polly.loop_header246, %polly.loop_exit263
  %indvars.iv1027 = phi i64 [ %122, %polly.loop_header246 ], [ %indvars.iv.next1028, %polly.loop_exit263 ]
...
vector.body1243:                                  ; preds = %vector.body1243, %vector.ph1247
  ...
  %wide.load1254 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %161, label %middle.block1241, label %vector.body1243, !llvm.loop !84
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %163 = add nsw i64 %smin1057, 1000
  %164 = shl nsw i64 %polly.indvar392, 4
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %165 = udiv i64 %polly.indvar398, 6
  %166 = mul nuw nsw i64 %165, 96
  %167 = sub nsw i64 %indvars.iv1044, %166
  %168 = add i64 %indvars.iv1049, %166
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1059.not = icmp eq i64 %187, 75
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit445 ], [ %168, %polly.loop_header395 ]
  %indvars.iv1046 = phi i64 [ %indvars.iv.next1047, %polly.loop_exit445 ], [ %167, %polly.loop_header395 ]
  ...
  %188 = add i64 %smax1048, %indvars.iv1051
  %189 = mul nuw nsw i64 %polly.indvar405, 6
  %.not.not885 = icmp ugt i64 %189, %polly.indvar398
  %190 = mul nuw nsw i64 %polly.indvar405, 96
  %191 = add nsw i64 %190, %170
  %192 = icmp sgt i64 %191, 0
  %193 = select i1 %192, i64 %191, i64 0
  %194 = add nsw i64 %191, 95
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_header408.us
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next412.us, %163
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next412, %163
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %203 = mul nsw i64 %polly.indvar405, -96
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next447, %163
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1053 = phi i64 [ %188, %polly.loop_header443 ], [ %indvars.iv.next1054, %polly.loop_exit460 ]
...
vector.body1219:                                  ; preds = %vector.body1219, %vector.ph1221
  ...
  %wide.load1228 = load <4 x double>, <4 x double>* %224, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %227, label %middle.block1217, label %vector.body1219, !llvm.loop !94
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %229 = add nsw i64 %smin1083, 1000
  %230 = shl nsw i64 %polly.indvar589, 4
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %231 = udiv i64 %polly.indvar595, 6
  %232 = mul nuw nsw i64 %231, 96
  %233 = sub nsw i64 %indvars.iv1070, %232
  %234 = add i64 %indvars.iv1075, %232
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1077 = phi i64 [ %indvars.iv.next1078, %polly.loop_exit642 ], [ %234, %polly.loop_header592 ]
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit642 ], [ %233, %polly.loop_header592 ]
  ...
  %254 = add i64 %smax1074, %indvars.iv1077
  %255 = mul nuw nsw i64 %polly.indvar602, 6
  %.not.not886 = icmp ugt i64 %255, %polly.indvar595
  %256 = mul nuw nsw i64 %polly.indvar602, 96
  %257 = add nsw i64 %256, %236
  %258 = icmp sgt i64 %257, 0
  %259 = select i1 %258, i64 %257, i64 0
  %260 = add nsw i64 %257, 95
...
polly.loop_exit628.us:                            ; preds = %polly.loop_header626.us, %polly.loop_header605.us
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next609.us, %229
...
polly.loop_exit628:                               ; preds = %polly.loop_header626
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next609, %229
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %269 = mul nsw i64 %polly.indvar602, -96
...
polly.loop_exit649:                               ; preds = %polly.loop_exit657
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next644, %229
...
polly.loop_header647:                             ; preds = %polly.loop_header640, %polly.loop_exit657
  %indvars.iv1079 = phi i64 [ %254, %polly.loop_header640 ], [ %indvars.iv.next1080, %polly.loop_exit657 ]
...
vector.body1158:                                  ; preds = %vector.body1158, %vector.ph1159
  ...
  br i1 %307, label %polly.loop_exit825, label %vector.body1158, !llvm.loop !103
...
vector.body1172:                                  ; preds = %vector.body1172, %vector.ph1175
  ...
  br i1 %336, label %polly.loop_exit852, label %vector.body1172, !llvm.loop !106
...
vector.body1190:                                  ; preds = %vector.body1190, %vector.ph1193
  ...
  br i1 %365, label %polly.loop_exit878, label %vector.body1190, !llvm.loop !109
