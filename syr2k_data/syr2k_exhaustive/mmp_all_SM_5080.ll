; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5080.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5080.c"
...
vector.body1089:                                  ; preds = %vector.body1089, %vector.ph1090
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call807, i64 %indvars.iv7.i, i64 %index1091
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1152, label %for.body3.i46.preheader1229, label %vector.ph1153
...
vector.body1151:                                  ; preds = %vector.body1151, %vector.ph1153
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call807, i64 %indvars.iv21.i, i64 %index1156
...
middle.block1149:                                 ; preds = %vector.body1151
  ...
  br i1 %cmp.n1159, label %for.inc6.i, label %for.body3.i46.preheader1229

for.body3.i46.preheader1229:                      ; preds = %for.body3.i46.preheader, %middle.block1149
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  ...
  br i1 %min.iters.check1175, label %for.body3.i60.preheader1227, label %vector.ph1176
...
vector.body1174:                                  ; preds = %vector.body1174, %vector.ph1176
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call807, i64 %indvars.iv21.i52, i64 %index1179
...
middle.block1172:                                 ; preds = %vector.body1174
  ...
  br i1 %cmp.n1182, label %for.inc6.i63, label %for.body3.i60.preheader1227

for.body3.i60.preheader1227:                      ; preds = %for.body3.i60.preheader, %middle.block1172
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1178, %middle.block1172 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1227, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1227 ]
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  ...
  br i1 %min.iters.check1201, label %for.body3.i99.preheader1225, label %vector.ph1202
...
vector.body1200:                                  ; preds = %vector.body1200, %vector.ph1202
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call807, i64 %indvars.iv21.i91, i64 %index1205
...
middle.block1198:                                 ; preds = %vector.body1200
  ...
  br i1 %cmp.n1208, label %for.inc6.i102, label %for.body3.i99.preheader1225

for.body3.i99.preheader1225:                      ; preds = %for.body3.i99.preheader, %middle.block1198
...
polly.loop_exit207:                               ; preds = %polly.loop_exit214, %polly.loop_header199
  ...
  %indvars.iv.next974 = add nuw nsw i64 %indvars.iv973, 96
  %indvars.iv.next985 = add nuw nsw i64 %indvars.iv984, 1
  %exitcond987.not = icmp eq i64 %99, 13
...
polly.loop_header212.preheader:                   ; preds = %polly.loop_header205
  ...
  %109 = add i64 %smax, %indvars.iv975
...
polly.loop_exit214:                               ; preds = %polly.loop_exit246, %polly.loop_header205
  ...
  %exitcond986.not = icmp eq i64 %polly.indvar_next209, %98
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit246
  %indvars.iv977 = phi i64 [ %109, %polly.loop_header212.preheader ], [ %indvars.iv.next978, %polly.loop_exit246 ]
  %polly.indvar216 = phi i64 [ %108, %polly.loop_header212.preheader ], [ %polly.indvar_next217, %polly.loop_exit246 ]
  %smin981 = call i64 @llvm.smin.i64(i64 %indvars.iv977, i64 127)
  %112 = add nsw i64 %polly.indvar216, %110
  %polly.loop_guard2291072 = icmp sgt i64 %112, -1
  %113 = add nuw nsw i64 %polly.indvar216, %104
  %.not = icmp ult i64 %113, %111
  %polly.access.mul.call1238 = mul nsw i64 %113, 1000
  br i1 %polly.loop_guard2291072, label %polly.loop_header219.us, label %polly.loop_header212.split
...
polly.loop_header226.us:                          ; preds = %polly.loop_header219.us, %polly.loop_header226.us
  ...
  %polly.access.mul.call1234.us = mul nuw nsw i64 %114, 1000
...
polly.then.us:                                    ; preds = %polly.cond.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1242.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1.us, %112
...
polly.loop_header219:                             ; preds = %polly.loop_header212.split, %polly.loop_header219
  ...
  %polly.access.add.Packed_MemRef_call1242 = add nsw i64 %polly.access.mul.Packed_MemRef_call1241, %112
...
polly.loop_header244.preheader:                   ; preds = %polly.loop_header219, %polly.merge.us
  ...
  br i1 %polly.loop_guard2291072, label %polly.loop_header244.us, label %polly.loop_exit246
...
polly.loop_header244.us:                          ; preds = %polly.loop_header244.preheader, %polly.loop_exit253.loopexit.us
  ...
  %117 = shl nuw nsw i64 %polly.indvar247.us, 3
  %scevgep262.us = getelementptr i8, i8* %call2, i64 %117
  %polly.access.mul.Packed_MemRef_call1258.us = mul nuw nsw i64 %polly.indvar247.us, 1200
  %scevgep263.us = getelementptr i8, i8* %scevgep262.us, i64 %115
  ...
  %polly.access.add.Packed_MemRef_call1271.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1258.us, %112
...
polly.loop_header251.us:                          ; preds = %polly.loop_header251.us, %polly.loop_header244.us
  ...
  %118 = add nuw nsw i64 %polly.indvar255.us, %105
  ...
  %scevgep267.us = getelementptr i8, i8* %scevgep262.us, i64 %119
  ...
  %120 = shl i64 %118, 3
  %121 = add i64 %120, %116
  %scevgep274.us = getelementptr i8, i8* %call, i64 %121
...
polly.loop_header365:                             ; preds = %polly.loop_exit373, %polly.start279
  %indvar1187 = phi i64 [ %indvar.next1188, %polly.loop_exit373 ], [ 0, %polly.start279 ]
  %polly.indvar368 = phi i64 [ %polly.indvar_next369, %polly.loop_exit373 ], [ 1, %polly.start279 ]
  %122 = add i64 %indvar1187, 1
  %123 = mul nuw nsw i64 %polly.indvar368, 9600
  %scevgep377 = getelementptr i8, i8* %call, i64 %123
  %min.iters.check1189 = icmp ult i64 %122, 4
  br i1 %min.iters.check1189, label %polly.loop_header371.preheader, label %vector.ph1190

vector.ph1190:                                    ; preds = %polly.loop_header365
  %n.vec1192 = and i64 %122, -4
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1190
  ...
  %124 = shl nuw nsw i64 %index1193, 3
  %125 = getelementptr i8, i8* %scevgep377, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1197 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  %127 = fmul fast <4 x double> %wide.load1197, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1194, %n.vec1192
  br i1 %129, label %middle.block1184, label %vector.body1186, !llvm.loop !80

middle.block1184:                                 ; preds = %vector.body1186
  %cmp.n1196 = icmp eq i64 %122, %n.vec1192
  br i1 %cmp.n1196, label %polly.loop_exit373, label %polly.loop_header371.preheader

polly.loop_header371.preheader:                   ; preds = %polly.loop_header365, %middle.block1184
  %polly.indvar374.ph = phi i64 [ 0, %polly.loop_header365 ], [ %n.vec1192, %middle.block1184 ]
  br label %polly.loop_header371

polly.loop_exit373:                               ; preds = %polly.loop_header371, %middle.block1184
  %polly.indvar_next369 = add nuw nsw i64 %polly.indvar368, 1
  %exitcond1013.not = icmp eq i64 %polly.indvar_next369, 1200
  %indvar.next1188 = add i64 %indvar1187, 1
  br i1 %exitcond1013.not, label %polly.loop_header381.preheader, label %polly.loop_header365
...
polly.loop_header371:                             ; preds = %polly.loop_header371.preheader, %polly.loop_header371
  ...
  %130 = shl nuw nsw i64 %polly.indvar374, 3
  %scevgep378 = getelementptr i8, i8* %scevgep377, i64 %130
  ...
  %exitcond1012.not = icmp eq i64 %polly.indvar_next375, %polly.indvar368
  br i1 %exitcond1012.not, label %polly.loop_exit373, label %polly.loop_header371, !llvm.loop !81

polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit391
  %indvars.iv1008 = phi i64 [ 1, %polly.loop_header381.preheader ], [ %indvars.iv.next1009, %polly.loop_exit391 ]
  ...
  %polly.indvar384 = phi i64 [ 0, %polly.loop_header381.preheader ], [ %133, %polly.loop_exit391 ]
  %131 = lshr i64 %indvars.iv1008, 2
  %132 = sub nsw i64 %indvars.iv1008, %131
  %133 = add nuw nsw i64 %polly.indvar384, 1
  %pexp.p_div_q387 = lshr i64 %133, 2
...
polly.loop_exit391:                               ; preds = %polly.loop_exit399, %polly.loop_header381
  ...
  %exitcond1011.not = icmp eq i64 %133, 13
  br i1 %exitcond1011.not, label %polly.exiting280, label %polly.loop_header381
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit399
  ...
  %polly.loop_guard400.not = icmp sgt i64 %142, %137
...
polly.loop_exit399:                               ; preds = %polly.loop_exit435, %polly.loop_header389
  ...
  %exitcond1010.not = icmp eq i64 %polly.indvar_next394, %132
  br i1 %exitcond1010.not, label %polly.loop_exit391, label %polly.loop_header389

polly.loop_header397:                             ; preds = %polly.loop_header397.preheader, %polly.loop_exit435
  %indvars.iv1000 = phi i64 [ %143, %polly.loop_header397.preheader ], [ %indvars.iv.next1001, %polly.loop_exit435 ]
  %polly.indvar401 = phi i64 [ %142, %polly.loop_header397.preheader ], [ %polly.indvar_next402, %polly.loop_exit435 ]
  %smin1005 = call i64 @llvm.smin.i64(i64 %indvars.iv1000, i64 127)
  %146 = add nsw i64 %polly.indvar401, %144
  %polly.loop_guard4141073 = icmp sgt i64 %146, -1
  %147 = add nuw nsw i64 %polly.indvar401, %138
  %.not861 = icmp ult i64 %147, %145
  %polly.access.mul.call1427 = mul nsw i64 %147, 1000
  br i1 %polly.loop_guard4141073, label %polly.loop_header404.us, label %polly.loop_header397.split
...
polly.loop_header411.us:                          ; preds = %polly.loop_header404.us, %polly.loop_header411.us
  ...
  %148 = add nuw nsw i64 %polly.indvar415.us, %139
  %polly.access.mul.call1419.us = mul nuw nsw i64 %148, 1000
...
polly.then424.us:                                 ; preds = %polly.cond422.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1282431.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1282.us, %146
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442.loopexit.us, %polly.loop_header397.split, %polly.loop_header433.preheader
  ...
  %polly.loop_cond403.not.not = icmp ult i64 %polly.indvar401, %137
...
polly.loop_header404:                             ; preds = %polly.loop_header397.split, %polly.loop_header404
  ...
  %polly.access.add.Packed_MemRef_call1282431 = add nsw i64 %polly.access.mul.Packed_MemRef_call1282430, %146
...
polly.loop_header433.preheader:                   ; preds = %polly.loop_header404, %polly.merge423.us
  ...
  br i1 %polly.loop_guard4141073, label %polly.loop_header433.us, label %polly.loop_exit435
...
polly.loop_header433.us:                          ; preds = %polly.loop_header433.preheader, %polly.loop_exit442.loopexit.us
  ...
  %151 = shl nuw nsw i64 %polly.indvar436.us, 3
  %scevgep451.us = getelementptr i8, i8* %call2, i64 %151
  %polly.access.mul.Packed_MemRef_call1282447.us = mul nuw nsw i64 %polly.indvar436.us, 1200
  %scevgep452.us = getelementptr i8, i8* %scevgep451.us, i64 %149
  ...
  %polly.access.add.Packed_MemRef_call1282460.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1282447.us, %146
...
polly.loop_header440.us:                          ; preds = %polly.loop_header440.us, %polly.loop_header433.us
  ...
  %152 = add nuw nsw i64 %polly.indvar444.us, %139
  ...
  %scevgep456.us = getelementptr i8, i8* %scevgep451.us, i64 %153
  ...
  %154 = shl i64 %152, 3
  %155 = add i64 %154, %150
  %scevgep463.us = getelementptr i8, i8* %call, i64 %155
...
polly.loop_header554:                             ; preds = %polly.loop_exit562, %polly.start468
  ...
  %157 = mul nuw nsw i64 %polly.indvar557, 9600
  %scevgep566 = getelementptr i8, i8* %call, i64 %157
  %min.iters.check1163 = icmp ult i64 %156, 4
  br i1 %min.iters.check1163, label %polly.loop_header560.preheader, label %vector.ph1164

vector.ph1164:                                    ; preds = %polly.loop_header554
  %n.vec1166 = and i64 %156, -4
...
vector.body1162:                                  ; preds = %vector.body1162, %vector.ph1164
  ...
  %158 = shl nuw nsw i64 %index1167, 3
  %159 = getelementptr i8, i8* %scevgep566, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load1171 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  %161 = fmul fast <4 x double> %wide.load1171, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next1168, %n.vec1166
  br i1 %163, label %middle.block1160, label %vector.body1162, !llvm.loop !90

middle.block1160:                                 ; preds = %vector.body1162
  %cmp.n1170 = icmp eq i64 %156, %n.vec1166
  br i1 %cmp.n1170, label %polly.loop_exit562, label %polly.loop_header560.preheader

polly.loop_header560.preheader:                   ; preds = %polly.loop_header554, %middle.block1160
  %polly.indvar563.ph = phi i64 [ 0, %polly.loop_header554 ], [ %n.vec1166, %middle.block1160 ]
  br label %polly.loop_header560

polly.loop_exit562:                               ; preds = %polly.loop_header560, %middle.block1160
  %polly.indvar_next558 = add nuw nsw i64 %polly.indvar557, 1
  %exitcond1037.not = icmp eq i64 %polly.indvar_next558, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond1037.not, label %polly.loop_header570.preheader, label %polly.loop_header554
...
polly.loop_header560:                             ; preds = %polly.loop_header560.preheader, %polly.loop_header560
  ...
  %164 = shl nuw nsw i64 %polly.indvar563, 3
  %scevgep567 = getelementptr i8, i8* %scevgep566, i64 %164
  ...
  %exitcond1036.not = icmp eq i64 %polly.indvar_next564, %polly.indvar557
  br i1 %exitcond1036.not, label %polly.loop_exit562, label %polly.loop_header560, !llvm.loop !91

polly.loop_header570:                             ; preds = %polly.loop_header570.preheader, %polly.loop_exit580
  %indvars.iv1032 = phi i64 [ 1, %polly.loop_header570.preheader ], [ %indvars.iv.next1033, %polly.loop_exit580 ]
  %indvars.iv1020 = phi i64 [ 0, %polly.loop_header570.preheader ], [ %indvars.iv.next1021, %polly.loop_exit580 ]
  %indvars.iv1015 = phi i64 [ 0, %polly.loop_header570.preheader ], [ %indvars.iv.next1016, %polly.loop_exit580 ]
  %polly.indvar573 = phi i64 [ 0, %polly.loop_header570.preheader ], [ %167, %polly.loop_exit580 ]
  %165 = lshr i64 %indvars.iv1032, 2
  %166 = sub nsw i64 %indvars.iv1032, %165
  %167 = add nuw nsw i64 %polly.indvar573, 1
  %pexp.p_div_q576 = lshr i64 %167, 2
...
polly.loop_header578.preheader:                   ; preds = %polly.loop_header570
  %168 = mul nsw i64 %polly.indvar573, -96
  %169 = icmp slt i64 %168, -1104
  %170 = select i1 %169, i64 %168, i64 -1104
  %171 = add nsw i64 %170, 1199
  %172 = mul nuw nsw i64 %polly.indvar573, 96
  br label %polly.loop_header578

polly.loop_exit580:                               ; preds = %polly.loop_exit588, %polly.loop_header570
  %indvars.iv.next1016 = add nsw i64 %indvars.iv1015, -96
  %indvars.iv.next1021 = add nuw nsw i64 %indvars.iv1020, 96
  %indvars.iv.next1033 = add nuw nsw i64 %indvars.iv1032, 1
  %exitcond1035.not = icmp eq i64 %167, 13
  br i1 %exitcond1035.not, label %polly.exiting469, label %polly.loop_header570

polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit588
  %indvars.iv1022 = phi i64 [ %indvars.iv1020, %polly.loop_header578.preheader ], [ %indvars.iv.next1023, %polly.loop_exit588 ]
  %indvars.iv1017 = phi i64 [ %indvars.iv1015, %polly.loop_header578.preheader ], [ %indvars.iv.next1018, %polly.loop_exit588 ]
  %polly.indvar582 = phi i64 [ 0, %polly.loop_header578.preheader ], [ %polly.indvar_next583, %polly.loop_exit588 ]
  %173 = shl nsw i64 %polly.indvar582, 7
  %174 = add nsw i64 %173, %168
  %175 = icmp sgt i64 %174, 0
  %176 = select i1 %175, i64 %174, i64 0
  %polly.loop_guard589.not = icmp sgt i64 %176, %171
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  ...
  %177 = add i64 %smax1019, %indvars.iv1022
...
polly.loop_exit588:                               ; preds = %polly.loop_exit624, %polly.loop_header578
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next583, %166
  br i1 %exitcond1034.not, label %polly.loop_exit580, label %polly.loop_header578

polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit624
  %indvars.iv1024 = phi i64 [ %177, %polly.loop_header586.preheader ], [ %indvars.iv.next1025, %polly.loop_exit624 ]
  %polly.indvar590 = phi i64 [ %176, %polly.loop_header586.preheader ], [ %polly.indvar_next591, %polly.loop_exit624 ]
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1024, i64 127)
  %180 = add nsw i64 %polly.indvar590, %178
  %polly.loop_guard6031074 = icmp sgt i64 %180, -1
  %181 = add nuw nsw i64 %polly.indvar590, %172
  %.not862 = icmp ult i64 %181, %179
  %polly.access.mul.call1616 = mul nsw i64 %181, 1000
  br i1 %polly.loop_guard6031074, label %polly.loop_header593.us, label %polly.loop_header586.split
...
polly.loop_header600.us:                          ; preds = %polly.loop_header593.us, %polly.loop_header600.us
  ...
  %182 = add nuw nsw i64 %polly.indvar604.us, %173
  %polly.access.mul.call1608.us = mul nuw nsw i64 %182, 1000
...
polly.then613.us:                                 ; preds = %polly.cond611.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1471620.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1471.us, %180
...
polly.merge612.us:                                ; preds = %polly.then613.us, %polly.cond611.loopexit.us
  ...
  %exitcond1028.not = icmp eq i64 %polly.indvar_next597.us, 1000
...
polly.loop_exit624:                               ; preds = %polly.loop_exit631.loopexit.us, %polly.loop_header586.split, %polly.loop_header622.preheader
  ...
  %polly.loop_cond592.not.not = icmp ult i64 %polly.indvar590, %171
...
polly.loop_header593:                             ; preds = %polly.loop_header586.split, %polly.loop_header593
  ...
  %polly.access.add.Packed_MemRef_call1471620 = add nsw i64 %polly.access.mul.Packed_MemRef_call1471619, %180
  ...
  %exitcond1014.not = icmp eq i64 %polly.indvar_next597, 1000
  br i1 %exitcond1014.not, label %polly.loop_header622.preheader, label %polly.loop_header593

polly.loop_header622.preheader:                   ; preds = %polly.loop_header593, %polly.merge612.us
  %183 = mul i64 %181, 8000
  %184 = mul i64 %181, 9600
  br i1 %polly.loop_guard6031074, label %polly.loop_header622.us, label %polly.loop_exit624
...
polly.loop_header622.us:                          ; preds = %polly.loop_header622.preheader, %polly.loop_exit631.loopexit.us
  ...
  %185 = shl nuw nsw i64 %polly.indvar625.us, 3
  %scevgep640.us = getelementptr i8, i8* %call2, i64 %185
  %polly.access.mul.Packed_MemRef_call1471636.us = mul nuw nsw i64 %polly.indvar625.us, 1200
  %scevgep641.us = getelementptr i8, i8* %scevgep640.us, i64 %183
  ...
  %polly.access.add.Packed_MemRef_call1471649.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1471636.us, %180
...
polly.loop_header629.us:                          ; preds = %polly.loop_header629.us, %polly.loop_header622.us
  ...
  %186 = add nuw nsw i64 %polly.indvar633.us, %173
  ...
  %scevgep645.us = getelementptr i8, i8* %scevgep640.us, i64 %187
  ...
  %188 = shl i64 %186, 3
  %189 = add i64 %188, %184
  %scevgep652.us = getelementptr i8, i8* %call, i64 %189
...
polly.loop_exit631.loopexit.us:                   ; preds = %polly.loop_header629.us
  ...
  %exitcond1031.not = icmp eq i64 %polly.indvar_next626.us, 1000
...
polly.loop_header781:                             ; preds = %entry, %polly.loop_exit789
  %indvars.iv1062 = phi i64 [ %indvars.iv.next1063, %polly.loop_exit789 ], [ 0, %entry ]
  ...
  %190 = shl nsw i64 %polly.indvar784, 5
  %191 = add nsw i64 %smin1064, 1199
...
polly.loop_exit789:                               ; preds = %polly.loop_exit795
  ...
  %exitcond1067.not = icmp eq i64 %polly.indvar_next785, 38
  br i1 %exitcond1067.not, label %polly.loop_header808, label %polly.loop_header781

polly.loop_header787:                             ; preds = %polly.loop_exit795, %polly.loop_header781
  %indvars.iv1058 = phi i64 [ %indvars.iv.next1059, %polly.loop_exit795 ], [ 0, %polly.loop_header781 ]
  %polly.indvar790 = phi i64 [ %polly.indvar_next791, %polly.loop_exit795 ], [ 0, %polly.loop_header781 ]
  %192 = mul nsw i64 %polly.indvar790, -32
  ...
  %194 = shl nsw i64 %polly.indvar790, 5
  %195 = add nsw i64 %smin1060, 1199
...
polly.loop_exit795:                               ; preds = %polly.loop_exit801
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next791, 38
  br i1 %exitcond1066.not, label %polly.loop_exit789, label %polly.loop_header787
...
polly.loop_header793:                             ; preds = %polly.loop_exit801, %polly.loop_header787
  ...
  %196 = add nuw nsw i64 %polly.indvar796, %190
  %197 = trunc i64 %196 to i32
  %198 = mul nuw nsw i64 %196, 9600
  %min.iters.check = icmp eq i64 %193, 0
  br i1 %min.iters.check, label %polly.loop_header799, label %vector.ph1102

vector.ph1102:                                    ; preds = %polly.loop_header793
  %broadcast.splatinsert1109 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat1110 = shufflevector <4 x i64> %broadcast.splatinsert1109, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1111 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body1101:                                  ; preds = %vector.body1101, %vector.ph1102
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind1107, %broadcast.splat1110
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat1112, %200
  ...
  %211 = icmp eq i64 %index.next1104, %193
  br i1 %211, label %polly.loop_exit801, label %vector.body1101, !llvm.loop !99

polly.loop_exit801:                               ; preds = %vector.body1101, %polly.loop_header799
  %polly.indvar_next797 = add nuw nsw i64 %polly.indvar796, 1
  %exitcond1065.not = icmp eq i64 %polly.indvar796, %191
  br i1 %exitcond1065.not, label %polly.loop_exit795, label %polly.loop_header793
...
polly.loop_header799:                             ; preds = %polly.loop_header793, %polly.loop_header799
  ...
  %212 = add nuw nsw i64 %polly.indvar802, %194
  ...
  %scevgep805 = getelementptr i8, i8* %call, i64 %218
  ...
  %exitcond1061.not = icmp eq i64 %polly.indvar802, %195
  br i1 %exitcond1061.not, label %polly.loop_exit801, label %polly.loop_header799, !llvm.loop !100

polly.loop_header808:                             ; preds = %polly.loop_exit789, %polly.loop_exit816
  %indvars.iv1052 = phi i64 [ %indvars.iv.next1053, %polly.loop_exit816 ], [ 0, %polly.loop_exit789 ]
  ...
  %219 = shl nsw i64 %polly.indvar811, 5
  %220 = add nsw i64 %smin1054, 1199
...
polly.loop_exit816:                               ; preds = %polly.loop_exit822
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next812, 38
  br i1 %exitcond1057.not, label %polly.loop_header834, label %polly.loop_header808

polly.loop_header814:                             ; preds = %polly.loop_exit822, %polly.loop_header808
  %indvars.iv1048 = phi i64 [ %indvars.iv.next1049, %polly.loop_exit822 ], [ 0, %polly.loop_header808 ]
  %polly.indvar817 = phi i64 [ %polly.indvar_next818, %polly.loop_exit822 ], [ 0, %polly.loop_header808 ]
  %221 = mul nsw i64 %polly.indvar817, -32
  %smin1116 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin1116, 1000
  %smin1050 = call i64 @llvm.smin.i64(i64 %indvars.iv1048, i64 -968)
  %223 = shl nsw i64 %polly.indvar817, 5
  %224 = add nsw i64 %smin1050, 999
...
polly.loop_exit822:                               ; preds = %polly.loop_exit828
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next818, 32
  br i1 %exitcond1056.not, label %polly.loop_exit816, label %polly.loop_header814
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %225 = add nuw nsw i64 %polly.indvar823, %219
  %226 = trunc i64 %225 to i32
  %227 = mul nuw nsw i64 %225, 8000
  %min.iters.check1117 = icmp eq i64 %222, 0
  br i1 %min.iters.check1117, label %polly.loop_header826, label %vector.ph1118

vector.ph1118:                                    ; preds = %polly.loop_header820
  %broadcast.splatinsert1127 = insertelement <4 x i64> poison, i64 %223, i32 0
  %broadcast.splat1128 = shufflevector <4 x i64> %broadcast.splatinsert1127, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1129 = insertelement <4 x i32> poison, i32 %226, i32 0
...
vector.body1115:                                  ; preds = %vector.body1115, %vector.ph1118
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind1125, %broadcast.splat1128
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat1130, %229
  ...
  %240 = icmp eq i64 %index.next1122, %222
  br i1 %240, label %polly.loop_exit828, label %vector.body1115, !llvm.loop !102

polly.loop_exit828:                               ; preds = %vector.body1115, %polly.loop_header826
  %polly.indvar_next824 = add nuw nsw i64 %polly.indvar823, 1
  %exitcond1055.not = icmp eq i64 %polly.indvar823, %220
  br i1 %exitcond1055.not, label %polly.loop_exit822, label %polly.loop_header820
...
polly.loop_header826:                             ; preds = %polly.loop_header820, %polly.loop_header826
  ...
  %241 = add nuw nsw i64 %polly.indvar829, %223
  ...
  %scevgep832 = getelementptr i8, i8* %call2, i64 %247
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar829, %224
  br i1 %exitcond1051.not, label %polly.loop_exit828, label %polly.loop_header826, !llvm.loop !103

polly.loop_header834:                             ; preds = %polly.loop_exit816, %polly.loop_exit842
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit842 ], [ 0, %polly.loop_exit816 ]
  ...
  %248 = shl nsw i64 %polly.indvar837, 5
  %249 = add nsw i64 %smin1044, 1199
...
polly.loop_exit842:                               ; preds = %polly.loop_exit848
  ...
  %exitcond1047.not = icmp eq i64 %polly.indvar_next838, 38
  br i1 %exitcond1047.not, label %init_array.exit, label %polly.loop_header834

polly.loop_header840:                             ; preds = %polly.loop_exit848, %polly.loop_header834
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039, %polly.loop_exit848 ], [ 0, %polly.loop_header834 ]
  %polly.indvar843 = phi i64 [ %polly.indvar_next844, %polly.loop_exit848 ], [ 0, %polly.loop_header834 ]
  %250 = mul nsw i64 %polly.indvar843, -32
  %smin1134 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin1134, 1000
  %smin1040 = call i64 @llvm.smin.i64(i64 %indvars.iv1038, i64 -968)
  %252 = shl nsw i64 %polly.indvar843, 5
  %253 = add nsw i64 %smin1040, 999
...
polly.loop_exit848:                               ; preds = %polly.loop_exit854
  ...
  %exitcond1046.not = icmp eq i64 %polly.indvar_next844, 32
  br i1 %exitcond1046.not, label %polly.loop_exit842, label %polly.loop_header840
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %254 = add nuw nsw i64 %polly.indvar849, %248
  %255 = trunc i64 %254 to i32
  %256 = mul nuw nsw i64 %254, 8000
  %min.iters.check1135 = icmp eq i64 %251, 0
  br i1 %min.iters.check1135, label %polly.loop_header852, label %vector.ph1136

vector.ph1136:                                    ; preds = %polly.loop_header846
  %broadcast.splatinsert1145 = insertelement <4 x i64> poison, i64 %252, i32 0
  %broadcast.splat1146 = shufflevector <4 x i64> %broadcast.splatinsert1145, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1147 = insertelement <4 x i32> poison, i32 %255, i32 0
...
vector.body1133:                                  ; preds = %vector.body1133, %vector.ph1136
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind1143, %broadcast.splat1146
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat1148, %258
  ...
  %269 = icmp eq i64 %index.next1140, %251
  br i1 %269, label %polly.loop_exit854, label %vector.body1133, !llvm.loop !105

polly.loop_exit854:                               ; preds = %vector.body1133, %polly.loop_header852
  %polly.indvar_next850 = add nuw nsw i64 %polly.indvar849, 1
  %exitcond1045.not = icmp eq i64 %polly.indvar849, %249
  br i1 %exitcond1045.not, label %polly.loop_exit848, label %polly.loop_header846
...
polly.loop_header852:                             ; preds = %polly.loop_header846, %polly.loop_header852
  ...
  %270 = add nuw nsw i64 %polly.indvar855, %252
  ...
  %scevgep859 = getelementptr i8, i8* %call1, i64 %276
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar855, %253
  br i1 %exitcond1041.not, label %polly.loop_exit854, label %polly.loop_header852, !llvm.loop !106
}
