; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3548.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3548.c"
...
polly.loop_header412:                             ; preds = %polly.loop_exit422, %polly.loop_header406
  ...
  %polly.loop_guard423 = icmp slt i64 %151, 15
...
polly.loop_header420.preheader:                   ; preds = %polly.loop_header412
  ...
  %156 = or i64 %155, 1
  %157 = shl nsw i64 %polly.indvar415, 6
  %158 = mul nsw i64 %polly.indvar415, -64
...
polly.loop_header420:                             ; preds = %polly.loop_header420.preheader, %polly.loop_exit479
  ...
  %163 = icmp sgt i64 %162, 64
  %164 = select i1 %163, i64 %162, i64 64
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %197 = mul nuw nsw i64 %polly.indvar623, 20
...
polly.loop_header634.preheader:                   ; preds = %polly.loop_header626
  ...
  %206 = or i64 %205, 1
  %207 = shl nsw i64 %polly.indvar629, 6
  %208 = mul nsw i64 %polly.indvar629, -64
...
polly.loop_header634:                             ; preds = %polly.loop_header634.preheader, %polly.loop_exit693
  ...
  %211 = mul nsw i64 %polly.indvar638, 80
  %212 = add nsw i64 %211, %208
  %213 = icmp sgt i64 %212, 64
  %214 = select i1 %213, i64 %212, i64 64
  %215 = add nsw i64 %212, 79
  %polly.loop_guard680 = icmp sgt i64 %212, -80
...
polly.loop_header691.preheader:                   ; preds = %polly.merge648, %polly.merge648.us1086, %polly.merge648.us
  ...
  %polly.loop_guard701 = icmp slt i64 %223, 80
