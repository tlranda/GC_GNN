; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3641.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3641.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1028.not = icmp eq i64 %115, 300
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %117 = mul nuw nsw i64 %polly.indvar214, 24
  %.not.not = icmp ugt i64 %117, %polly.indvar208
  %118 = mul nuw nsw i64 %polly.indvar214, 96
  %119 = add nsw i64 %118, %110
  %120 = icmp sgt i64 %119, 0
  %121 = select i1 %120, i64 %119, i64 0
  %122 = add nsw i64 %119, 95
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_header233.7, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %130 = mul nsw i64 %polly.indvar214, -96
...
polly.loop_header253:                             ; preds = %polly.loop_header246, %polly.loop_exit263
  %indvars.iv1024 = phi i64 [ %116, %polly.loop_header246 ], [ %indvars.iv.next1025, %polly.loop_exit263 ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %164 = udiv i64 %polly.indvar398, 24
  %165 = mul nuw nsw i64 %164, 96
  %166 = sub nsw i64 %indvars.iv1035, %165
  %167 = add i64 %indvars.iv1040, %165
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1049.not = icmp eq i64 %174, 300
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit445 ], [ %167, %polly.loop_header395 ]
  %indvars.iv1037 = phi i64 [ %indvars.iv.next1038, %polly.loop_exit445 ], [ %166, %polly.loop_header395 ]
  ...
  %176 = mul nuw nsw i64 %polly.indvar405, 24
  %.not.not885 = icmp ugt i64 %176, %polly.indvar398
  %177 = mul nuw nsw i64 %polly.indvar405, 96
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_header429.7, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %189 = mul nsw i64 %polly.indvar405, -96
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1044 = phi i64 [ %175, %polly.loop_header443 ], [ %indvars.iv.next1045, %polly.loop_exit460 ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %223 = udiv i64 %polly.indvar595, 24
  %224 = mul nuw nsw i64 %223, 96
  %225 = sub nsw i64 %indvars.iv1056, %224
  %226 = add i64 %indvars.iv1061, %224
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1063 = phi i64 [ %indvars.iv.next1064, %polly.loop_exit642 ], [ %226, %polly.loop_header592 ]
  %indvars.iv1058 = phi i64 [ %indvars.iv.next1059, %polly.loop_exit642 ], [ %225, %polly.loop_header592 ]
  ...
  %234 = add i64 %smax1060, %indvars.iv1063
  %235 = mul nuw nsw i64 %polly.indvar602, 24
  %.not.not886 = icmp ugt i64 %235, %polly.indvar595
  %236 = mul nuw nsw i64 %polly.indvar602, 96
  %237 = add nsw i64 %236, %228
  %238 = icmp sgt i64 %237, 0
  %239 = select i1 %238, i64 %237, i64 0
  %240 = add nsw i64 %237, 95
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_header626.7, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %249 = icmp slt i64 %248, -1104
  %250 = select i1 %249, i64 %248, i64 -1104
...
polly.loop_header647:                             ; preds = %polly.loop_header640, %polly.loop_exit657
  %indvars.iv1065 = phi i64 [ %234, %polly.loop_header640 ], [ %indvars.iv.next1066, %polly.loop_exit657 ]
