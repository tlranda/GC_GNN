; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6146.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6146.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  %103 = mul nsw i64 %polly.indvar208, -100
  ...
  %polly.loop_guard = icmp slt i64 %107, 19
...
polly.loop_header227:                             ; preds = %polly.loop_exit213, %polly.loop_exit235
  ...
  %111 = shl nsw i64 %polly.indvar230, 6
  %112 = sub nsw i64 %102, %111
  %113 = icmp sgt i64 %112, 0
  %114 = select i1 %113, i64 %112, i64 0
  %115 = mul nsw i64 %polly.indvar230, -64
...
polly.loop_exit242:                               ; preds = %polly.loop_exit250
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar_next237, 100
...
polly.loop_header376:                             ; preds = %polly.loop_header376.preheader, %polly.loop_exit384
  ...
  %140 = mul nuw nsw i64 %polly.indvar379, 100
...
polly.loop_exit390:                               ; preds = %polly.loop_exit396
  ...
  %polly.loop_guard409 = icmp slt i64 %150, 19
...
polly.loop_exit422:                               ; preds = %polly.loop_exit430
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar_next417, 100
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_exit564
  ...
  %183 = mul nuw nsw i64 %polly.indvar559, 100
...
polly.loop_exit570:                               ; preds = %polly.loop_exit576
  ...
  %polly.loop_guard589 = icmp slt i64 %193, 19
...
polly.loop_header586:                             ; preds = %polly.loop_exit570, %polly.loop_exit595
  ...
  %197 = shl nsw i64 %polly.indvar590, 6
  %198 = sub nsw i64 %188, %197
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %201 = mul nsw i64 %polly.indvar590, -64
...
polly.loop_exit602:                               ; preds = %polly.loop_exit610
  ...
  %exitcond921.not = icmp eq i64 %polly.indvar_next597, 100
