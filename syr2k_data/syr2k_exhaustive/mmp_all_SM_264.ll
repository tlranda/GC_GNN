; ModuleID = 'syr2k_exhaustive/mmp_all_SM_264.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_264.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %117 = mul nsw i64 %indvar1418, -16
  %118 = add i64 %102, %117
  %smax1420 = call i64 @llvm.smax.i64(i64 %118, i64 0)
  %119 = shl nuw nsw i64 %indvar1418, 4
  %120 = add i64 %104, %119
  %121 = add i64 %smax1420, %120
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %polly.loop_guard273 = icmp slt i64 %134, 16
...
polly.loop_header270.us:                          ; preds = %polly.loop_header263.us, %polly.loop_exit280.us
  ...
  %135 = add i64 %121, %indvar1421
  %smin1423 = call i64 @llvm.smin.i64(i64 %135, i64 3)
  %136 = add nsw i64 %smin1423, 1
  %smin1108 = call i64 @llvm.smin.i64(i64 %indvars.iv1106, i64 3)
  %137 = add nsw i64 %polly.indvar274.us, %125
  %polly.loop_guard281.us1215 = icmp sgt i64 %137, -1
...
polly.loop_header278.preheader.us:                ; preds = %polly.loop_header270.us
  ...
  %min.iters.check1424 = icmp ult i64 %136, 4
...
vector.body1417:                                  ; preds = %vector.body1417, %vector.ph1425
  ...
  %143 = add nuw nsw i64 %index1428, %109
  %144 = add nuw nsw i64 %index1428, %polly.access.mul.Packed_MemRef_call1285.us
  %145 = getelementptr double, double* %Packed_MemRef_call1, i64 %144
  %146 = bitcast double* %145 to <4 x double>*
  %wide.load1432 = load <4 x double>, <4 x double>* %146, align 8
  %147 = fmul fast <4 x double> %broadcast.splat1434, %wide.load1432
  %148 = getelementptr double, double* %Packed_MemRef_call2, i64 %144
  %149 = bitcast double* %148 to <4 x double>*
  %wide.load1435 = load <4 x double>, <4 x double>* %149, align 8
  %150 = fmul fast <4 x double> %broadcast.splat1437, %wide.load1435
  %151 = shl i64 %143, 3
  %152 = add i64 %151, %142
  %153 = getelementptr i8, i8* %call, i64 %152
  %154 = bitcast i8* %153 to <4 x double>*
  %wide.load1438 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !71, !noalias !73
  ...
  %157 = fadd fast <4 x double> %156, %wide.load1438
  ...
  %159 = icmp eq i64 %index.next1429, %n.vec1427
  br i1 %159, label %middle.block1415, label %vector.body1417, !llvm.loop !84

middle.block1415:                                 ; preds = %vector.body1417
  %cmp.n1431 = icmp eq i64 %136, %n.vec1427
...
vector.body1353:                                  ; preds = %vector.body1353, %vector.ph1357
  ...
  %163 = shl nuw nsw i64 %index1360, 3
  %164 = getelementptr i8, i8* %scevgep406, i64 %163
  %165 = bitcast i8* %164 to <4 x double>*
  %wide.load1364 = load <4 x double>, <4 x double>* %165, align 8, !alias.scope !85, !noalias !87
  %166 = fmul fast <4 x double> %wide.load1364, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %168 = icmp eq i64 %index.next1361, %n.vec1359
  br i1 %168, label %middle.block1351, label %vector.body1353, !llvm.loop !92

middle.block1351:                                 ; preds = %vector.body1353
  %cmp.n1363 = icmp eq i64 %161, %n.vec1359
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %170 = add nsw i64 %smin1142, 1000
  %171 = shl nsw i64 %polly.indvar413, 4
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %173 = shl nuw nsw i64 %polly.indvar419, 2
  %174 = and i64 %173, 9223372036854775792
  %175 = sub nsw i64 %172, %174
  %176 = mul nsw i64 %polly.indvar419, -4
  %177 = add i64 %176, %174
  %178 = lshr i64 %polly.indvar419, 2
  %179 = shl nuw nsw i64 %178, 4
  %180 = sub nsw i64 %indvars.iv1129, %179
  %181 = add i64 %indvars.iv1134, %179
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1135 = add nsw i64 %indvars.iv1134, -4
  %exitcond1145.not = icmp eq i64 %187, 300
...
polly.loop_exit430:                               ; preds = %polly.loop_header428
  ...
  %exitcond1123.not = icmp eq i64 %polly.indvar_next426, %170
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %indvars.iv1136 = phi i64 [ %indvars.iv.next1137, %polly.loop_exit482 ], [ %181, %polly.loop_exit424 ]
  %indvars.iv1131 = phi i64 [ %indvars.iv.next1132, %polly.loop_exit482 ], [ %180, %polly.loop_exit424 ]
  %polly.indvar442 = phi i64 [ %polly.indvar_next443, %polly.loop_exit482 ], [ %178, %polly.loop_exit424 ]
  %190 = mul nsw i64 %indvar1368, -16
  %191 = add i64 %175, %190
  %smax1370 = call i64 @llvm.smax.i64(i64 %191, i64 0)
  %192 = shl nuw nsw i64 %indvar1368, 4
  %193 = add i64 %177, %192
  %194 = add i64 %smax1370, %193
  %smax1133 = call i64 @llvm.smax.i64(i64 %indvars.iv1131, i64 0)
  %195 = add i64 %smax1133, %indvars.iv1136
  %196 = shl nsw i64 %polly.indvar442, 2
  %.not.not944 = icmp ugt i64 %196, %polly.indvar419
  %197 = shl nsw i64 %polly.indvar442, 4
  %198 = add nsw i64 %197, %183
  %199 = icmp sgt i64 %198, 0
  %200 = select i1 %199, i64 %198, i64 0
  %201 = add nsw i64 %198, 15
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_header445.us
  ...
  %exitcond1128.not = icmp eq i64 %polly.indvar_next449.us, %170
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1125.not = icmp eq i64 %polly.indvar_next449, %170
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %polly.loop_guard490 = icmp slt i64 %207, 16
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %indvars.iv1138 = phi i64 [ %195, %polly.loop_header480.us ], [ %indvars.iv.next1139, %polly.loop_exit497.us ]
  %polly.indvar491.us = phi i64 [ %207, %polly.loop_header480.us ], [ %polly.indvar_next492.us, %polly.loop_exit497.us ]
  %208 = add i64 %194, %indvar1371
  %smin1373 = call i64 @llvm.smin.i64(i64 %208, i64 3)
  %209 = add nsw i64 %smin1373, 1
  %smin1140 = call i64 @llvm.smin.i64(i64 %indvars.iv1138, i64 3)
  %210 = add nsw i64 %polly.indvar491.us, %198
  %polly.loop_guard498.us1216 = icmp sgt i64 %210, -1
...
polly.loop_header495.preheader.us:                ; preds = %polly.loop_header487.us
  ...
  %min.iters.check1374 = icmp ult i64 %209, 4
...
vector.body1367:                                  ; preds = %vector.body1367, %vector.ph1375
  ...
  %216 = add nuw nsw i64 %index1378, %182
  %217 = add nuw nsw i64 %index1378, %polly.access.mul.Packed_MemRef_call1309502.us
  %218 = getelementptr double, double* %Packed_MemRef_call1309, i64 %217
  %219 = bitcast double* %218 to <4 x double>*
  %wide.load1382 = load <4 x double>, <4 x double>* %219, align 8
  %220 = fmul fast <4 x double> %broadcast.splat1384, %wide.load1382
  %221 = getelementptr double, double* %Packed_MemRef_call2311, i64 %217
  %222 = bitcast double* %221 to <4 x double>*
  %wide.load1385 = load <4 x double>, <4 x double>* %222, align 8
  %223 = fmul fast <4 x double> %broadcast.splat1387, %wide.load1385
  %224 = shl i64 %216, 3
  %225 = add i64 %224, %215
  %226 = getelementptr i8, i8* %call, i64 %225
  %227 = bitcast i8* %226 to <4 x double>*
  %wide.load1388 = load <4 x double>, <4 x double>* %227, align 8, !alias.scope !85, !noalias !87
  ...
  %230 = fadd fast <4 x double> %229, %wide.load1388
  ...
  %232 = icmp eq i64 %index.next1379, %n.vec1377
  br i1 %232, label %middle.block1365, label %vector.body1367, !llvm.loop !97

middle.block1365:                                 ; preds = %vector.body1367
  %cmp.n1381 = icmp eq i64 %209, %n.vec1377
...
polly.loop_exit489.loopexit.us:                   ; preds = %polly.loop_exit497.us
  ...
  %exitcond1143.not = icmp eq i64 %polly.indvar_next484.us, %170
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1306 = icmp ult i64 %234, 4
...
vector.body1305:                                  ; preds = %vector.body1305, %vector.ph1307
  ...
  %236 = shl nuw nsw i64 %index1310, 3
  %237 = getelementptr i8, i8* %scevgep623, i64 %236
  %238 = bitcast i8* %237 to <4 x double>*
  %wide.load1314 = load <4 x double>, <4 x double>* %238, align 8, !alias.scope !98, !noalias !100
  %239 = fmul fast <4 x double> %wide.load1314, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %241 = icmp eq i64 %index.next1311, %n.vec1309
  br i1 %241, label %middle.block1303, label %vector.body1305, !llvm.loop !105

middle.block1303:                                 ; preds = %vector.body1305
  %cmp.n1313 = icmp eq i64 %234, %n.vec1309
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %243 = add nsw i64 %smin1174, 1000
  %244 = shl nsw i64 %polly.indvar630, 4
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %246 = shl nuw nsw i64 %polly.indvar636, 2
  %247 = and i64 %246, 9223372036854775792
  %248 = sub nsw i64 %245, %247
  %249 = mul nsw i64 %polly.indvar636, -4
  %250 = add i64 %249, %247
  %251 = lshr i64 %polly.indvar636, 2
  %252 = shl nuw nsw i64 %251, 4
  %253 = sub nsw i64 %indvars.iv1161, %252
  %254 = add i64 %indvars.iv1166, %252
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %indvars.iv.next1167 = add nsw i64 %indvars.iv1166, -4
  %exitcond1177.not = icmp eq i64 %260, 300
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1155.not = icmp eq i64 %polly.indvar_next643, %243
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %indvars.iv1168 = phi i64 [ %indvars.iv.next1169, %polly.loop_exit699 ], [ %254, %polly.loop_exit641 ]
  %indvars.iv1163 = phi i64 [ %indvars.iv.next1164, %polly.loop_exit699 ], [ %253, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit699 ], [ %251, %polly.loop_exit641 ]
  %263 = mul nsw i64 %indvar1318, -16
  %264 = add i64 %248, %263
  %smax1320 = call i64 @llvm.smax.i64(i64 %264, i64 0)
  %265 = shl nuw nsw i64 %indvar1318, 4
  %266 = add i64 %250, %265
  %267 = add i64 %smax1320, %266
  %smax1165 = call i64 @llvm.smax.i64(i64 %indvars.iv1163, i64 0)
  %268 = add i64 %smax1165, %indvars.iv1168
  %269 = shl nsw i64 %polly.indvar659, 2
  %.not.not945 = icmp ugt i64 %269, %polly.indvar636
  %270 = shl nsw i64 %polly.indvar659, 4
  %271 = add nsw i64 %270, %256
  %272 = icmp sgt i64 %271, 0
  %273 = select i1 %272, i64 %271, i64 0
  %274 = add nsw i64 %271, 15
...
polly.loop_exit685.us:                            ; preds = %polly.loop_header683.us, %polly.loop_header662.us
  ...
  %exitcond1160.not = icmp eq i64 %polly.indvar_next666.us, %243
...
polly.loop_exit685:                               ; preds = %polly.loop_header683
  ...
  %exitcond1157.not = icmp eq i64 %polly.indvar_next666, %243
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %polly.loop_guard707 = icmp slt i64 %280, 16
...
polly.loop_header704.us:                          ; preds = %polly.loop_header697.us, %polly.loop_exit714.us
  ...
  %indvars.iv1170 = phi i64 [ %268, %polly.loop_header697.us ], [ %indvars.iv.next1171, %polly.loop_exit714.us ]
  %polly.indvar708.us = phi i64 [ %280, %polly.loop_header697.us ], [ %polly.indvar_next709.us, %polly.loop_exit714.us ]
  %281 = add i64 %267, %indvar1321
  %smin1323 = call i64 @llvm.smin.i64(i64 %281, i64 3)
  %282 = add nsw i64 %smin1323, 1
  %smin1172 = call i64 @llvm.smin.i64(i64 %indvars.iv1170, i64 3)
  %283 = add nsw i64 %polly.indvar708.us, %271
  %polly.loop_guard715.us1217 = icmp sgt i64 %283, -1
...
polly.loop_header712.preheader.us:                ; preds = %polly.loop_header704.us
  ...
  %min.iters.check1324 = icmp ult i64 %282, 4
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1325
  ...
  %289 = add nuw nsw i64 %index1328, %255
  %290 = add nuw nsw i64 %index1328, %polly.access.mul.Packed_MemRef_call1526719.us
  %291 = getelementptr double, double* %Packed_MemRef_call1526, i64 %290
  %292 = bitcast double* %291 to <4 x double>*
  %wide.load1332 = load <4 x double>, <4 x double>* %292, align 8
  %293 = fmul fast <4 x double> %broadcast.splat1334, %wide.load1332
  %294 = getelementptr double, double* %Packed_MemRef_call2528, i64 %290
  %295 = bitcast double* %294 to <4 x double>*
  %wide.load1335 = load <4 x double>, <4 x double>* %295, align 8
  %296 = fmul fast <4 x double> %broadcast.splat1337, %wide.load1335
  %297 = shl i64 %289, 3
  %298 = add i64 %297, %288
  %299 = getelementptr i8, i8* %call, i64 %298
  %300 = bitcast i8* %299 to <4 x double>*
  %wide.load1338 = load <4 x double>, <4 x double>* %300, align 8, !alias.scope !98, !noalias !100
  ...
  %303 = fadd fast <4 x double> %302, %wide.load1338
  ...
  %305 = icmp eq i64 %index.next1329, %n.vec1327
  br i1 %305, label %middle.block1315, label %vector.body1317, !llvm.loop !110

middle.block1315:                                 ; preds = %vector.body1317
  %cmp.n1331 = icmp eq i64 %282, %n.vec1327
...
polly.loop_exit706.loopexit.us:                   ; preds = %polly.loop_exit714.us
  ...
  %exitcond1175.not = icmp eq i64 %polly.indvar_next701.us, %243
...
vector.ph1245:                                    ; preds = %polly.loop_header876
  %broadcast.splatinsert1252 = insertelement <4 x i64> poison, i64 %311, i32 0
  %broadcast.splat1253 = shufflevector <4 x i64> %broadcast.splatinsert1252, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1254 = insertelement <4 x i32> poison, i32 %314, i32 0
...
vector.body1244:                                  ; preds = %vector.body1244, %vector.ph1245
  ...
  %316 = add nuw nsw <4 x i64> %vec.ind1250, %broadcast.splat1253
  %317 = trunc <4 x i64> %316 to <4 x i32>
  %318 = mul <4 x i32> %broadcast.splat1255, %317
  ...
  %328 = icmp eq i64 %index.next1247, %310
  br i1 %328, label %polly.loop_exit884, label %vector.body1244, !llvm.loop !116

polly.loop_exit884:                               ; preds = %vector.body1244, %polly.loop_header882
  %polly.indvar_next880 = add nuw nsw i64 %polly.indvar879, 1
  %exitcond1208.not = icmp eq i64 %polly.indvar879, %308
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  %exitcond1204.not = icmp eq i64 %polly.indvar885, %312
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %smin1259 = call i64 @llvm.smin.i64(i64 %338, i64 -968)
  %339 = add nsw i64 %smin1259, 1000
  %smin1193 = call i64 @llvm.smin.i64(i64 %indvars.iv1191, i64 -968)
  %340 = shl nsw i64 %polly.indvar900, 5
  %341 = add nsw i64 %smin1193, 999
...
vector.body1258:                                  ; preds = %vector.body1258, %vector.ph1261
  ...
  %345 = add nuw nsw <4 x i64> %vec.ind1268, %broadcast.splat1271
  %346 = trunc <4 x i64> %345 to <4 x i32>
  %347 = mul <4 x i32> %broadcast.splat1273, %346
  ...
  %357 = icmp eq i64 %index.next1265, %339
  br i1 %357, label %polly.loop_exit911, label %vector.body1258, !llvm.loop !119

polly.loop_exit911:                               ; preds = %vector.body1258, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1198.not = icmp eq i64 %polly.indvar906, %337
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %exitcond1194.not = icmp eq i64 %polly.indvar912, %341
...
polly.loop_header923:                             ; preds = %polly.loop_exit931, %polly.loop_header917
  ...
  %smin1277 = call i64 @llvm.smin.i64(i64 %367, i64 -968)
  %368 = add nsw i64 %smin1277, 1000
  %smin1183 = call i64 @llvm.smin.i64(i64 %indvars.iv1181, i64 -968)
  %369 = shl nsw i64 %polly.indvar926, 5
  %370 = add nsw i64 %smin1183, 999
...
vector.body1276:                                  ; preds = %vector.body1276, %vector.ph1279
  ...
  %374 = add nuw nsw <4 x i64> %vec.ind1286, %broadcast.splat1289
  %375 = trunc <4 x i64> %374 to <4 x i32>
  %376 = mul <4 x i32> %broadcast.splat1291, %375
  ...
  %386 = icmp eq i64 %index.next1283, %368
  br i1 %386, label %polly.loop_exit937, label %vector.body1276, !llvm.loop !122

polly.loop_exit937:                               ; preds = %vector.body1276, %polly.loop_header935
  %polly.indvar_next933 = add nuw nsw i64 %polly.indvar932, 1
  %exitcond1188.not = icmp eq i64 %polly.indvar932, %366
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  %exitcond1184.not = icmp eq i64 %polly.indvar938, %370
