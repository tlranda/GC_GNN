; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2524.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2524.c"
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1361 = call i64 @llvm.smin.i64(i64 %115, i64 49)
  %116 = add nsw i64 %smin1361, 1
  %smin1048 = call i64 @llvm.smin.i64(i64 %indvars.iv1042, i64 49)
...
polly.loop_header432:                             ; preds = %polly.loop_exit441, %polly.loop_header426
  ...
  %160 = mul nuw nsw i64 %polly.indvar435, 50
  %161 = add i64 %154, %160
  %smax1310 = call i64 @llvm.smax.i64(i64 %161, i64 0)
  %162 = mul nsw i64 %polly.indvar435, -50
  %163 = add i64 %155, %162
  %164 = add i64 %smax1310, %163
  %165 = mul nuw nsw i64 %polly.indvar435, 50
...
polly.loop_header439:                             ; preds = %polly.loop_header439.preheader, %polly.loop_exit477
  ...
  %smin1313 = call i64 @llvm.smin.i64(i64 %172, i64 49)
  %173 = add nsw i64 %smin1313, 1
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1074, i64 49)
...
polly.loop_header642:                             ; preds = %polly.loop_exit651, %polly.loop_header636
  ...
  %217 = mul nuw nsw i64 %polly.indvar645, 50
  %218 = add i64 %211, %217
  %smax1262 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar645, -50
  %220 = add i64 %212, %219
  %221 = add i64 %smax1262, %220
  %222 = mul nuw nsw i64 %polly.indvar645, 50
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit687
  ...
  %smin1265 = call i64 @llvm.smin.i64(i64 %229, i64 49)
  %230 = add nsw i64 %smin1265, 1
  %smin1112 = call i64 @llvm.smin.i64(i64 %indvars.iv1106, i64 49)
