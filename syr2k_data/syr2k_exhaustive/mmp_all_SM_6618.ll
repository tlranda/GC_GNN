; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6618.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6618.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %99 = shl nuw nsw i64 %indvars.iv864, 4
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -48
  %indvars.iv.next865 = add nuw nsw i64 %indvars.iv864, 3
  %indvars.iv.next869 = add nuw nsw i64 %indvars.iv868, 48
...
polly.loop_header376:                             ; preds = %polly.loop_header376.preheader, %polly.loop_exit384
  ...
  %141 = mul nuw nsw i64 %polly.indvar379, 80
...
polly.loop_header382:                             ; preds = %polly.loop_exit408, %polly.loop_header376
  ...
  %142 = shl nuw nsw i64 %indvars.iv891, 4
  %143 = and i64 %142, 9223372036854775680
  %144 = add i64 %indvars.iv889, %143
  %145 = sub nsw i64 %indvars.iv896, %143
  %146 = mul nuw nsw i64 %polly.indvar385, 80
  br label %polly.loop_header388

polly.loop_exit390:                               ; preds = %polly.loop_exit396
  %147 = mul nsw i64 %polly.indvar385, -80
  %148 = mul nuw nsw i64 %polly.indvar385, 3
  %149 = add nuw nsw i64 %148, 7
  %pexp.p_div_q404 = lshr i64 %149, 3
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415, %polly.loop_exit390
  ...
  %indvars.iv.next890 = add nsw i64 %indvars.iv889, -48
  %indvars.iv.next892 = add nuw nsw i64 %indvars.iv891, 3
  %indvars.iv.next897 = add nuw nsw i64 %indvars.iv896, 48
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_exit564
  ...
  %184 = mul nuw nsw i64 %polly.indvar559, 80
...
polly.loop_exit588:                               ; preds = %polly.loop_exit595, %polly.loop_exit570
  ...
  %indvars.iv.next918 = add nsw i64 %indvars.iv917, -48
  %indvars.iv.next920 = add nuw nsw i64 %indvars.iv919, 3
  %indvars.iv.next925 = add nuw nsw i64 %indvars.iv924, 48
