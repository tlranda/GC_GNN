; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3747.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3747.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %indvars.iv1004 = phi i64 [ 5, %polly.loop_header199.preheader ], [ %indvars.iv.next1005, %polly.loop_exit207 ]
  %indvars.iv = phi i64 [ 0, %polly.loop_header199.preheader ], [ %indvars.iv.next, %polly.loop_exit207 ]
  %polly.indvar202 = phi i64 [ 0, %polly.loop_header199.preheader ], [ %polly.indvar_next203, %polly.loop_exit207 ]
  %97 = udiv i64 %indvars.iv1004, 6
  %98 = mul nuw nsw i64 %97, 96
  %99 = trunc i64 %polly.indvar202 to i8
  %pexp.p_div_q.lhs.trunc = add i8 %99, 5
  %pexp.p_div_q881 = udiv i8 %pexp.p_div_q.lhs.trunc, 6
...
polly.loop_exit207:                               ; preds = %polly.loop_exit246, %polly.loop_header199
  ...
  %indvars.iv.next1009 = add nuw nsw i64 %indvars.iv1008, 16
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit399
  ...
  %indvars.iv1024 = phi i64 [ 5, %polly.loop_header389.preheader ], [ %indvars.iv.next1025, %polly.loop_exit399 ]
  ...
  %144 = udiv i64 %indvars.iv1024, 6
  %145 = mul nuw nsw i64 %144, 96
  %146 = trunc i64 %polly.indvar392 to i8
  %pexp.p_div_q395.lhs.trunc = add i8 %146, 5
  %pexp.p_div_q395880 = udiv i8 %pexp.p_div_q395.lhs.trunc, 6
...
polly.loop_header397.preheader:                   ; preds = %polly.loop_header389
  ...
  %150 = mul nsw i64 %polly.indvar392, -80
  %151 = mul nuw nsw i64 %polly.indvar392, 80
...
polly.loop_header397:                             ; preds = %polly.loop_header397.preheader, %polly.loop_exit439
  ...
  %.inv877 = icmp sgt i64 %155, 79
  %157 = select i1 %.inv877, i64 79, i64 %156
...
polly.loop_header582:                             ; preds = %polly.loop_header582.preheader, %polly.loop_exit592
  ...
  %indvars.iv1046 = phi i64 [ 5, %polly.loop_header582.preheader ], [ %indvars.iv.next1047, %polly.loop_exit592 ]
  ...
  %191 = udiv i64 %indvars.iv1046, 6
  %192 = mul nuw nsw i64 %191, 96
  %193 = trunc i64 %polly.indvar585 to i8
  %pexp.p_div_q588.lhs.trunc = add i8 %193, 5
  %pexp.p_div_q588879 = udiv i8 %pexp.p_div_q588.lhs.trunc, 6
...
polly.loop_header590.preheader:                   ; preds = %polly.loop_header582
  ...
  %197 = mul nsw i64 %polly.indvar585, -80
  %198 = mul nuw nsw i64 %polly.indvar585, 80
...
polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit632
  ...
  %.inv878 = icmp sgt i64 %202, 79
  %204 = select i1 %.inv878, i64 79, i64 %203
