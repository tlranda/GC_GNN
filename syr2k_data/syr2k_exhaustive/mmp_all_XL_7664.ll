; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7664.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7664.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %102 = mul nuw nsw i64 %polly.indvar224, 20
  br label %polly.loop_header227

polly.loop_exit229:                               ; preds = %polly.loop_exit235
  %polly.indvar_next225 = add nuw nsw i64 %polly.indvar224, 1
  %exitcond845.not = icmp eq i64 %polly.indvar_next225, 50
...
polly.loop_exit248.loopexit.us:                   ; preds = %polly.loop_header246.us
  ...
  %exitcond843.not = icmp eq i64 %polly.indvar_next243.us, 20
...
vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1039
  ...
  %wide.load1046 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %128, label %middle.block1033, label %vector.body1035, !llvm.loop !80
...
polly.loop_header396:                             ; preds = %polly.loop_exit404, %polly.loop_header390
  ...
  %135 = mul nuw nsw i64 %polly.indvar399, 20
  br label %polly.loop_header402

polly.loop_exit404:                               ; preds = %polly.loop_exit411
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %exitcond867.not = icmp eq i64 %polly.indvar_next400, 50
...
polly.loop_exit425.loopexit.us:                   ; preds = %polly.loop_header423.us
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar_next420.us, 20
...
vector.body1011:                                  ; preds = %vector.body1011, %vector.ph1013
  ...
  %wide.load1020 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %161, label %middle.block1009, label %vector.body1011, !llvm.loop !90
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_header567
  ...
  %168 = mul nuw nsw i64 %polly.indvar576, 20
  br label %polly.loop_header579

polly.loop_exit581:                               ; preds = %polly.loop_exit588
  %polly.indvar_next577 = add nuw nsw i64 %polly.indvar576, 1
  %exitcond889.not = icmp eq i64 %polly.indvar_next577, 50
...
polly.loop_exit602.loopexit.us:                   ; preds = %polly.loop_header600.us
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar_next597.us, 20
...
vector.body949:                                   ; preds = %vector.body949, %vector.ph951
  ...
  br i1 %208, label %polly.loop_exit770, label %vector.body949, !llvm.loop !99
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph967
  ...
  br i1 %237, label %polly.loop_exit797, label %vector.body964, !llvm.loop !102
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph985
  ...
  br i1 %266, label %polly.loop_exit823, label %vector.body982, !llvm.loop !105
