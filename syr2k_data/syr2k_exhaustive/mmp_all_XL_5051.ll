; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5051.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5051.c"
...
vector.body1195:                                  ; preds = %vector.body1195, %vector.ph1199
  ...
  %128 = shl nuw nsw i64 %index1202, 3
  %129 = getelementptr i8, i8* %scevgep379, i64 %128
  %130 = bitcast i8* %129 to <4 x double>*
  %wide.load1206 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  %131 = fmul fast <4 x double> %wide.load1206, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %133 = icmp eq i64 %index.next1203, %n.vec1201
  br i1 %133, label %middle.block1193, label %vector.body1195, !llvm.loop !80

middle.block1193:                                 ; preds = %vector.body1195
  %cmp.n1205 = icmp eq i64 %126, %n.vec1201
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %140 = add nuw nsw i64 %umin1015, 5
...
polly.loop_header557:                             ; preds = %polly.loop_exit565, %polly.start471
  ...
  %min.iters.check1172 = icmp ult i64 %164, 4
...
vector.body1171:                                  ; preds = %vector.body1171, %vector.ph1173
  ...
  %166 = shl nuw nsw i64 %index1176, 3
  %167 = getelementptr i8, i8* %scevgep569, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load1180 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  %169 = fmul fast <4 x double> %wide.load1180, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next1177, %n.vec1175
  br i1 %171, label %middle.block1169, label %vector.body1171, !llvm.loop !90

middle.block1169:                                 ; preds = %vector.body1171
  %cmp.n1179 = icmp eq i64 %164, %n.vec1175
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %178 = add nuw nsw i64 %umin1041, 5
...
polly.loop_header579:                             ; preds = %polly.loop_exit587, %polly.loop_header573
  ...
  %179 = mul nuw nsw i64 %polly.indvar582, 100
...
vector.ph1111:                                    ; preds = %polly.loop_header797
  %broadcast.splatinsert1118 = insertelement <4 x i64> poison, i64 %206, i32 0
  %broadcast.splat1119 = shufflevector <4 x i64> %broadcast.splatinsert1118, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1120 = insertelement <4 x i32> poison, i32 %209, i32 0
...
vector.body1110:                                  ; preds = %vector.body1110, %vector.ph1111
  ...
  %211 = add nuw nsw <4 x i64> %vec.ind1116, %broadcast.splat1119
  %212 = trunc <4 x i64> %211 to <4 x i32>
  %213 = mul <4 x i32> %broadcast.splat1121, %212
  ...
  %223 = icmp eq i64 %index.next1113, %205
  br i1 %223, label %polly.loop_exit805, label %vector.body1110, !llvm.loop !99
...
polly.loop_header818:                             ; preds = %polly.loop_exit826, %polly.loop_header812
  ...
  %smin1125 = call i64 @llvm.smin.i64(i64 %233, i64 -968)
  %234 = add nsw i64 %smin1125, 1000
...
vector.body1124:                                  ; preds = %vector.body1124, %vector.ph1127
  ...
  %240 = add nuw nsw <4 x i64> %vec.ind1134, %broadcast.splat1137
  %241 = trunc <4 x i64> %240 to <4 x i32>
  %242 = mul <4 x i32> %broadcast.splat1139, %241
  ...
  %252 = icmp eq i64 %index.next1131, %234
  br i1 %252, label %polly.loop_exit832, label %vector.body1124, !llvm.loop !102
...
polly.loop_header844:                             ; preds = %polly.loop_exit852, %polly.loop_header838
  ...
  %smin1143 = call i64 @llvm.smin.i64(i64 %262, i64 -968)
  %263 = add nsw i64 %smin1143, 1000
...
vector.body1142:                                  ; preds = %vector.body1142, %vector.ph1145
  ...
  %269 = add nuw nsw <4 x i64> %vec.ind1152, %broadcast.splat1155
  %270 = trunc <4 x i64> %269 to <4 x i32>
  %271 = mul <4 x i32> %broadcast.splat1157, %270
  ...
  %281 = icmp eq i64 %index.next1149, %263
  br i1 %281, label %polly.loop_exit858, label %vector.body1142, !llvm.loop !105
