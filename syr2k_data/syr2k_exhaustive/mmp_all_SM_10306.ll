; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10306.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10306.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %118 = shl nsw i64 %polly.indvar214, 8
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %indvars.iv.next790 = add nsw i64 %indvars.iv789, -256
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv791, i64 255)
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %144 = lshr i64 %indvars.iv815, 3
  %145 = mul nsw i64 %polly.indvar357, -96
  %146 = icmp slt i64 %145, -1104
  %147 = select i1 %146, i64 %145, i64 -1104
  %148 = add nsw i64 %147, 1199
  %149 = mul nuw nsw i64 %polly.indvar357, 96
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %165 = shl nsw i64 %polly.indvar370, 8
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %indvars.iv.next804 = add nsw i64 %indvars.iv803, 256
  %indvars.iv.next809 = add nsw i64 %indvars.iv808, -256
  %exitcond817.not = icmp eq i64 %polly.indvar370, %144
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  ...
  %smin812 = call i64 @llvm.smin.i64(i64 %indvars.iv810, i64 255)
  %171 = add nsw i64 %polly.indvar378, %170
  %polly.loop_guard391878 = icmp sgt i64 %171, -1
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %191 = lshr i64 %indvars.iv836, 3
  %192 = mul nsw i64 %polly.indvar515, -96
  %193 = icmp slt i64 %192, -1104
  %194 = select i1 %193, i64 %192, i64 -1104
  %195 = add nsw i64 %194, 1199
  %196 = mul nuw nsw i64 %polly.indvar515, 96
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next823 = add nsw i64 %indvars.iv822, -96
  %indvars.iv.next828 = add nuw nsw i64 %indvars.iv827, 96
  %indvars.iv.next837 = add nuw nsw i64 %indvars.iv836, 3
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %212 = shl nsw i64 %polly.indvar528, 8
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %216 = add i64 %smax826, %indvars.iv829
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %indvars.iv.next825 = add nsw i64 %indvars.iv824, 256
  %indvars.iv.next830 = add nsw i64 %indvars.iv829, -256
  %exitcond838.not = icmp eq i64 %polly.indvar528, %191
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv831 = phi i64 [ %216, %polly.loop_header532.preheader ], [ %indvars.iv.next832, %polly.loop_exit541 ]
  %polly.indvar536 = phi i64 [ %215, %polly.loop_header532.preheader ], [ %polly.indvar_next537, %polly.loop_exit541 ]
  %smin833 = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 255)
  %218 = add nsw i64 %polly.indvar536, %217
  %polly.loop_guard549879 = icmp sgt i64 %218, -1
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  br i1 %250, label %polly.loop_exit714, label %vector.body906, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body906, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond870.not = icmp eq i64 %polly.indvar709, %230
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond866.not = icmp eq i64 %polly.indvar715, %234
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  br i1 %279, label %polly.loop_exit741, label %vector.body921, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body921, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond860.not = icmp eq i64 %polly.indvar736, %259
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar742, %263
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  br i1 %308, label %polly.loop_exit767, label %vector.body939, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body939, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond850.not = icmp eq i64 %polly.indvar762, %288
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond846.not = icmp eq i64 %polly.indvar768, %292
