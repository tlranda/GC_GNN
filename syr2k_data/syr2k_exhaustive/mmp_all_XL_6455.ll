; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6455.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6455.c"
...
vector.body1060:                                  ; preds = %vector.body1060, %vector.ph1064
  ...
  %wide.load1071 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %133, label %middle.block1058, label %vector.body1060, !llvm.loop !85
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %135 = mul nuw nsw i64 %polly.indvar377, 20
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1038
  ...
  %wide.load1045 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %171, label %middle.block1034, label %vector.body1036, !llvm.loop !95
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %173 = mul nuw nsw i64 %polly.indvar555, 20
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  br i1 %223, label %polly.loop_exit772, label %vector.body974, !llvm.loop !104
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph992
  ...
  br i1 %252, label %polly.loop_exit799, label %vector.body989, !llvm.loop !107
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1010
  ...
  br i1 %281, label %polly.loop_exit825, label %vector.body1007, !llvm.loop !110
