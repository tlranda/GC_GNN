; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8786.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8786.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit213.4
  ...
  %smin787 = call i64 @llvm.smin.i64(i64 %indvars.iv785, i64 -936)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit366.4
  ...
  %smin809 = call i64 @llvm.smin.i64(i64 %indvars.iv807, i64 -936)
  %121 = add nsw i64 %smin809, 1000
  %122 = shl nsw i64 %polly.indvar355, 6
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit521.4
  ...
  %smin831 = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 -936)
  %145 = add nsw i64 %smin831, 1000
  %146 = shl nsw i64 %polly.indvar510, 6
...
polly.loop_exit213.4:                             ; preds = %polly.loop_exit219.4
  ...
  %exitcond791.not = icmp eq i64 %polly.indvar_next203, 16
...
polly.loop_exit366.4:                             ; preds = %polly.loop_exit372.4
  ...
  %exitcond813.not = icmp eq i64 %polly.indvar_next356, 16
...
polly.loop_exit521.4:                             ; preds = %polly.loop_exit527.4
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next511, 16
