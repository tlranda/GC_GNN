; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2947.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2947.c"
...
polly.loop_header254:                             ; preds = %polly.loop_exit262, %polly.loop_header248
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv900, i64 255)
...
vector.body1088:                                  ; preds = %vector.body1088, %vector.ph1092
  ...
  %wide.load1099 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %130, label %middle.block1086, label %vector.body1088, !llvm.loop !85
...
polly.loop_header387:                             ; preds = %polly.loop_header387.preheader, %polly.loop_exit395
  ...
  %132 = mul nuw nsw i64 %polly.indvar390, 20
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %133 = shl nuw nsw i64 %polly.indvar396, 4
  %134 = mul nsw i64 %polly.indvar396, -256
  %135 = shl nsw i64 %polly.indvar396, 8
...
polly.loop_header399:                             ; preds = %polly.loop_exit440, %polly.loop_header393
  ...
  %136 = shl nsw i64 %polly.indvar402, 4
  %137 = add nsw i64 %136, %134
  %138 = add nsw i64 %137, -1
  %.inv869 = icmp ugt i64 %137, 255
  %139 = select i1 %.inv869, i64 255, i64 %138
...
polly.loop_header444:                             ; preds = %polly.loop_exit452, %polly.loop_header438
  ...
  %smin917 = call i64 @llvm.smin.i64(i64 %indvars.iv915, i64 255)
...
vector.body1064:                                  ; preds = %vector.body1064, %vector.ph1066
  ...
  %wide.load1073 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %165, label %middle.block1062, label %vector.body1064, !llvm.loop !95
...
polly.loop_header577:                             ; preds = %polly.loop_header577.preheader, %polly.loop_exit585
  ...
  %167 = mul nuw nsw i64 %polly.indvar580, 20
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %168 = shl nuw nsw i64 %polly.indvar586, 4
  %169 = mul nsw i64 %polly.indvar586, -256
  %170 = shl nsw i64 %polly.indvar586, 8
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %171 = shl nsw i64 %polly.indvar592, 4
  %172 = add nsw i64 %171, %169
  %173 = add nsw i64 %172, -1
  %.inv870 = icmp ugt i64 %172, 255
  %174 = select i1 %.inv870, i64 255, i64 %173
...
polly.loop_header634:                             ; preds = %polly.loop_exit642, %polly.loop_header628
  ...
  %smin933 = call i64 @llvm.smin.i64(i64 %indvars.iv931, i64 255)
...
vector.body1002:                                  ; preds = %vector.body1002, %vector.ph1004
  ...
  br i1 %214, label %polly.loop_exit809, label %vector.body1002, !llvm.loop !104
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1020
  ...
  br i1 %243, label %polly.loop_exit836, label %vector.body1017, !llvm.loop !107
...
vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1038
  ...
  br i1 %272, label %polly.loop_exit862, label %vector.body1035, !llvm.loop !110
