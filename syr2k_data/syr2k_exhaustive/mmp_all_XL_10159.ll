; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10159.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10159.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %pexp.p_div_q778 = udiv i8 %pexp.p_div_q.lhs.trunc, 25
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit221
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv796, i64 99)
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit364
  ...
  %132 = mul i8 %131, 9
  %pexp.p_div_q360.lhs.trunc = add i8 %132, 34
  %pexp.p_div_q360777 = udiv i8 %pexp.p_div_q360.lhs.trunc, 25
  %pexp.p_div_q360.zext = zext i8 %pexp.p_div_q360777 to i64
  %133 = sub nsw i64 %polly.indvar357, %pexp.p_div_q360.zext
  %134 = add nsw i64 %133, 1
  %.inv774 = icmp slt i64 %133, 11
  %135 = select i1 %.inv774, i64 %134, i64 11
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  ...
  %smin814 = call i64 @llvm.smin.i64(i64 %indvars.iv812, i64 99)
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit522
  ...
  %165 = trunc i64 %polly.indvar515 to i8
  %166 = mul i8 %165, 9
  %pexp.p_div_q518.lhs.trunc = add i8 %166, 34
  %pexp.p_div_q518776 = udiv i8 %pexp.p_div_q518.lhs.trunc, 25
  %pexp.p_div_q518.zext = zext i8 %pexp.p_div_q518776 to i64
  %167 = sub nsw i64 %polly.indvar515, %pexp.p_div_q518.zext
  %168 = add nsw i64 %167, 1
  %.inv775 = icmp slt i64 %167, 11
  %169 = select i1 %.inv775, i64 %168, i64 11
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit530
  ...
  %175 = mul nsw i64 %polly.indvar524, 100
...
polly.loop_exit530:                               ; preds = %polly.loop_exit537, %polly.loop_header520
  ...
  %indvars.iv.next824 = add i64 %indvars.iv823, 100
...
polly.loop_header528:                             ; preds = %polly.loop_header528.preheader, %polly.loop_exit537
  ...
  %smin832 = call i64 @llvm.smin.i64(i64 %indvars.iv830, i64 99)
