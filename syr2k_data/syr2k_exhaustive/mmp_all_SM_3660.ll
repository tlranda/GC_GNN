; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3660.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3660.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin968 = call i64 @llvm.smin.i64(i64 %indvars.iv950, i64 -984)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next951 = add nsw i64 %indvars.iv950, -16
  %exitcond972.not = icmp eq i64 %polly.indvar_next203, 63
...
polly.loop_header404:                             ; preds = %polly.loop_header404.preheader, %polly.loop_exit412
  ...
  %smin998 = call i64 @llvm.smin.i64(i64 %indvars.iv978, i64 -984)
  %145 = add nsw i64 %smin998, 1000
  %146 = shl nsw i64 %polly.indvar407, 4
  br label %polly.loop_header410

polly.loop_exit412:                               ; preds = %polly.loop_exit418
  %polly.indvar_next408 = add nuw nsw i64 %polly.indvar407, 1
  %indvars.iv.next979 = add nsw i64 %indvars.iv978, -16
  %exitcond1002.not = icmp eq i64 %polly.indvar_next408, 63
...
polly.start513:                                   ; preds = %init_array.exit
  %malloccall515 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit623
  ...
  %smin1028 = call i64 @llvm.smin.i64(i64 %indvars.iv1008, i64 -984)
  %193 = add nsw i64 %smin1028, 1000
  %194 = shl nsw i64 %polly.indvar618, 4
  br label %polly.loop_header621

polly.loop_exit623:                               ; preds = %polly.loop_exit629
  %polly.indvar_next619 = add nuw nsw i64 %polly.indvar618, 1
  %indvars.iv.next1009 = add nsw i64 %indvars.iv1008, -16
  %exitcond1032.not = icmp eq i64 %polly.indvar_next619, 63
