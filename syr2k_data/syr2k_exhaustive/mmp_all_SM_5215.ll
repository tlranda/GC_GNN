; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5215.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5215.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %125 = shl nsw i64 %polly.indvar214, 3
...
vector.body1189:                                  ; preds = %vector.body1189, %vector.ph1193
  ...
  %wide.load1200 = load <4 x double>, <4 x double>* %149, align 8, !alias.scope !73, !noalias !75
  ...
  store <4 x double> %150, <4 x double>* %151, align 8, !alias.scope !73, !noalias !75
  %index.next1197 = add i64 %index1196, 4
  %152 = icmp eq i64 %index.next1197, %n.vec1195
  br i1 %152, label %middle.block1187, label %vector.body1189, !llvm.loop !79
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %182 = shl nsw i64 %polly.indvar398, 3
...
vector.body1165:                                  ; preds = %vector.body1165, %vector.ph1167
  ...
  %wide.load1174 = load <4 x double>, <4 x double>* %206, align 8, !alias.scope !83, !noalias !85
  ...
  store <4 x double> %207, <4 x double>* %208, align 8, !alias.scope !83, !noalias !85
  %index.next1171 = add i64 %index1170, 4
  %209 = icmp eq i64 %index.next1171, %n.vec1169
  br i1 %209, label %middle.block1163, label %vector.body1165, !llvm.loop !89
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %211 = mul nsw i64 %polly.indvar576, -128
  %212 = icmp slt i64 %211, -1072
  %213 = select i1 %212, i64 %211, i64 -1072
  %214 = add nsw i64 %213, 1199
  %215 = shl nsw i64 %polly.indvar576, 7
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %239 = shl nsw i64 %polly.indvar588, 3
...
vector.body1104:                                  ; preds = %vector.body1104, %vector.ph1105
  ...
  store <4 x double> %274, <4 x double>* %279, align 8, !alias.scope !93, !noalias !95
  ...
  br i1 %280, label %polly.loop_exit805, label %vector.body1104, !llvm.loop !98
...
vector.body1118:                                  ; preds = %vector.body1118, %vector.ph1121
  ...
  store <4 x double> %303, <4 x double>* %308, align 8, !alias.scope !97, !noalias !100
  ...
  br i1 %309, label %polly.loop_exit832, label %vector.body1118, !llvm.loop !101
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  store <4 x double> %332, <4 x double>* %337, align 8, !alias.scope !96, !noalias !103
  ...
  br i1 %338, label %polly.loop_exit858, label %vector.body1136, !llvm.loop !104
