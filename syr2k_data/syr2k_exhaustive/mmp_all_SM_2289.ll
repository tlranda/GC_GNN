; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2289.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2289.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1029 = phi i64 [ %indvars.iv.next1030, %polly.loop_exit224 ], [ 10, %polly.loop_exit208 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1030 = add nuw nsw i64 %indvars.iv1029, 10
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %101 = shl nuw nsw i64 %polly.indvar225, 3
  %102 = add i64 %97, %101
  %smax1322 = call i64 @llvm.smax.i64(i64 %102, i64 0)
  %103 = mul nsw i64 %polly.indvar225, -8
  %104 = add i64 %98, %103
  %105 = add i64 %smax1322, %104
  %106 = shl nsw i64 %polly.indvar225, 3
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1325 = call i64 @llvm.smin.i64(i64 %113, i64 7)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  %indvars.iv1055 = phi i64 [ %indvars.iv.next1056, %polly.loop_exit422 ], [ 10, %polly.loop_exit406 ]
...
polly.loop_exit422:                               ; preds = %polly.loop_exit429
  ...
  %indvars.iv.next1056 = add nuw nsw i64 %indvars.iv1055, 10
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %153 = shl nuw nsw i64 %polly.indvar423, 3
  %154 = add i64 %149, %153
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %smin1277 = call i64 @llvm.smin.i64(i64 %165, i64 7)
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  %indvars.iv1081 = phi i64 [ %indvars.iv.next1082, %polly.loop_exit626 ], [ 10, %polly.loop_exit610 ]
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %indvars.iv.next1082 = add nuw nsw i64 %indvars.iv1081, 10
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %205 = shl nuw nsw i64 %polly.indvar627, 3
  %206 = add i64 %201, %205
  %smax1226 = call i64 @llvm.smax.i64(i64 %206, i64 0)
  %207 = mul nsw i64 %polly.indvar627, -8
  %208 = add i64 %202, %207
  %209 = add i64 %smax1226, %208
  %210 = shl nsw i64 %polly.indvar627, 3
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %smin1229 = call i64 @llvm.smin.i64(i64 %217, i64 7)
  %218 = add nsw i64 %smin1229, 1
  %smin1078 = call i64 @llvm.smin.i64(i64 %indvars.iv1073, i64 7)
