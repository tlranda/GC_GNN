; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1597.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1597.c"
...
vector.body1269:                                  ; preds = %vector.body1269, %vector.ph1271
  ...
  br i1 %57, label %middle.block1267, label %vector.body1269, !llvm.loop !55
...
vector.body1326:                                  ; preds = %vector.body1326, %vector.ph1330
  ...
  br i1 %95, label %middle.block1324, label %vector.body1326, !llvm.loop !70
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond1056.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !71
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %98 = shl nsw i64 %polly.indvar219, 4
  br label %polly.loop_header222

polly.loop_exit224:                               ; preds = %polly.loop_exit230
  %polly.indvar_next220 = add nuw nsw i64 %polly.indvar219, 1
  %indvars.iv.next1035 = add nuw nsw i64 %indvars.iv1034, 16
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -984)
  %99 = add nsw i64 %smin1046, 1000
  %100 = shl nsw i64 %polly.indvar225, 4
  br label %polly.loop_header228

polly.loop_exit230:                               ; preds = %polly.loop_exit236
  %polly.indvar_next226 = add nuw nsw i64 %polly.indvar225, 1
  %indvars.iv.next = add nsw i64 %indvars.iv, -16
  %exitcond1052.not = icmp eq i64 %polly.indvar_next226, 63
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %101 = mul nsw i64 %polly.indvar231, -16
  %102 = add i64 %97, %101
  %103 = shl nsw i64 %polly.indvar231, 4
  %104 = sub nsw i64 %98, %103
  %105 = add nuw nsw i64 %103, 16
...
polly.loop_header234:                             ; preds = %polly.loop_exit265, %polly.loop_header228
  ...
  %smin1341 = call i64 @llvm.smin.i64(i64 %106, i64 15)
  %107 = add nsw i64 %smin1341, 1
  %smin1044 = call i64 @llvm.smin.i64(i64 %indvars.iv1038, i64 15)
...
polly.loop_exit265:                               ; preds = %polly.loop_exit272.loopexit.us, %polly.loop_header234.split, %polly.loop_header263.preheader
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar_next238, 16
...
vector.body1340:                                  ; preds = %vector.body1340, %vector.ph1343
  ...
  %wide.load1356 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !63, !noalias !65
  ...
  store <4 x double> %130, <4 x double>* %131, align 8, !alias.scope !63, !noalias !65
  %index.next1347 = add i64 %index1346, 4
  %132 = icmp eq i64 %index.next1347, %n.vec1345
  br i1 %132, label %middle.block1338, label %vector.body1340, !llvm.loop !75
...
polly.start298:                                   ; preds = %kernel_syr2k.exit
  %malloccall300 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
vector.body1281:                                  ; preds = %vector.body1281, %vector.ph1285
  ...
  %wide.load1292 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !77, !noalias !79
  ...
  store <4 x double> %141, <4 x double>* %142, align 8, !alias.scope !77, !noalias !79
  %index.next1289 = add i64 %index1288, 4
  %143 = icmp eq i64 %index.next1289, %n.vec1287
  br i1 %143, label %middle.block1279, label %vector.body1281, !llvm.loop !84
...
polly.loop_header392:                             ; preds = %polly.loop_header392.preheader, %polly.loop_header392
  ...
  br i1 %exitcond1084.not, label %polly.loop_exit394, label %polly.loop_header392, !llvm.loop !85
...
polly.loop_header418:                             ; preds = %polly.loop_exit410, %polly.loop_exit426
  ...
  %145 = shl nuw nsw i64 %polly.indvar421, 4
  %146 = shl nsw i64 %polly.indvar421, 4
...
polly.loop_exit426:                               ; preds = %polly.loop_exit432
  ...
  %exitcond1081.not = icmp eq i64 %polly.indvar_next422, 75
...
polly.loop_header424:                             ; preds = %polly.loop_exit432, %polly.loop_header418
  ...
  %smin1074 = call i64 @llvm.smin.i64(i64 %indvars.iv1058, i64 -984)
  %147 = add nsw i64 %smin1074, 1000
  %148 = shl nsw i64 %polly.indvar427, 4
...
polly.loop_exit432:                               ; preds = %polly.loop_exit438
  ...
  %exitcond1080.not = icmp eq i64 %polly.indvar_next428, 63
...
polly.loop_header430:                             ; preds = %polly.loop_exit438, %polly.loop_header424
  ...
  %149 = mul nsw i64 %polly.indvar433, -16
  %150 = add i64 %145, %149
  %151 = shl nsw i64 %polly.indvar433, 4
...
polly.loop_header436:                             ; preds = %polly.loop_exit473, %polly.loop_header430
  ...
  %smin1296 = call i64 @llvm.smin.i64(i64 %154, i64 15)
  %155 = add nsw i64 %smin1296, 1
  %smin1072 = call i64 @llvm.smin.i64(i64 %indvars.iv1066, i64 15)
...
polly.loop_exit473:                               ; preds = %polly.loop_exit480.loopexit.us, %polly.loop_header436.split, %polly.loop_header471.preheader
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar_next440, 16
...
vector.body1295:                                  ; preds = %vector.body1295, %vector.ph1298
  ...
  %wide.load1311 = load <4 x double>, <4 x double>* %175, align 8, !alias.scope !77, !noalias !79
  ...
  store <4 x double> %178, <4 x double>* %179, align 8, !alias.scope !77, !noalias !79
  %index.next1302 = add i64 %index1301, 4
  %180 = icmp eq i64 %index.next1302, %n.vec1300
  br i1 %180, label %middle.block1293, label %vector.body1295, !llvm.loop !88
...
polly.loop_header478.us:                          ; preds = %polly.loop_header478.us.preheader, %polly.loop_header478.us
  ...
  br i1 %exitcond1073.not, label %polly.loop_exit480.loopexit.us, label %polly.loop_header478.us, !llvm.loop !89
...
polly.start506:                                   ; preds = %init_array.exit
  %malloccall508 = tail call dereferenceable_or_null(153600) i8* @malloc(i64 153600) #6
...
vector.body1238:                                  ; preds = %vector.body1238, %vector.ph1240
  ...
  %wide.load1247 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !90, !noalias !92
  ...
  store <4 x double> %189, <4 x double>* %190, align 8, !alias.scope !90, !noalias !92
  %index.next1244 = add i64 %index1243, 4
  %191 = icmp eq i64 %index.next1244, %n.vec1242
  br i1 %191, label %middle.block1236, label %vector.body1238, !llvm.loop !97
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_header600
  ...
  br i1 %exitcond1112.not, label %polly.loop_exit602, label %polly.loop_header600, !llvm.loop !98
...
polly.loop_header626:                             ; preds = %polly.loop_exit618, %polly.loop_exit634
  ...
  %193 = shl nuw nsw i64 %polly.indvar629, 4
  %194 = shl nsw i64 %polly.indvar629, 4
...
polly.loop_exit634:                               ; preds = %polly.loop_exit640
  ...
  %indvars.iv.next1091 = add nuw nsw i64 %indvars.iv1090, 16
  %indvars.iv.next1106 = add nuw nsw i64 %indvars.iv1105, 1
  %exitcond1109.not = icmp eq i64 %polly.indvar_next630, 75
...
polly.loop_header632:                             ; preds = %polly.loop_exit640, %polly.loop_header626
  ...
  %smin1102 = call i64 @llvm.smin.i64(i64 %indvars.iv1086, i64 -984)
  %195 = add nsw i64 %smin1102, 1000
  %196 = shl nsw i64 %polly.indvar635, 4
...
polly.loop_exit640:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1108.not = icmp eq i64 %polly.indvar_next636, 63
...
polly.loop_header638:                             ; preds = %polly.loop_exit646, %polly.loop_header632
  ...
  %197 = mul nsw i64 %polly.indvar641, -16
  %198 = add i64 %193, %197
  %199 = shl nsw i64 %polly.indvar641, 4
  %200 = sub nsw i64 %194, %199
  %201 = add nuw nsw i64 %199, 16
...
polly.loop_header644:                             ; preds = %polly.loop_exit681, %polly.loop_header638
  ...
  %smin1251 = call i64 @llvm.smin.i64(i64 %202, i64 15)
  %203 = add nsw i64 %smin1251, 1
  %smin1100 = call i64 @llvm.smin.i64(i64 %indvars.iv1094, i64 15)
...
polly.loop_exit681:                               ; preds = %polly.loop_exit688.loopexit.us, %polly.loop_header644.split, %polly.loop_header679.preheader
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar_next648, 16
...
vector.body1250:                                  ; preds = %vector.body1250, %vector.ph1253
  ...
  %wide.load1266 = load <4 x double>, <4 x double>* %223, align 8, !alias.scope !90, !noalias !92
  ...
  store <4 x double> %226, <4 x double>* %227, align 8, !alias.scope !90, !noalias !92
  %index.next1257 = add i64 %index1256, 4
  %228 = icmp eq i64 %index.next1257, %n.vec1255
  br i1 %228, label %middle.block1248, label %vector.body1250, !llvm.loop !101
...
polly.loop_header686.us:                          ; preds = %polly.loop_header686.us.preheader, %polly.loop_header686.us
  ...
  br i1 %exitcond1101.not, label %polly.loop_exit688.loopexit.us, label %polly.loop_header686.us, !llvm.loop !102
...
vector.body1177:                                  ; preds = %vector.body1177, %vector.ph1178
  ...
  store <4 x double> %247, <4 x double>* %252, align 8, !alias.scope !103, !noalias !105
  ...
  br i1 %253, label %polly.loop_exit858, label %vector.body1177, !llvm.loop !108
...
polly.loop_header856:                             ; preds = %polly.loop_header850, %polly.loop_header856
  ...
  br i1 %exitcond1137.not, label %polly.loop_exit858, label %polly.loop_header856, !llvm.loop !109
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1194
  ...
  store <4 x double> %276, <4 x double>* %281, align 8, !alias.scope !107, !noalias !110
  ...
  br i1 %282, label %polly.loop_exit885, label %vector.body1191, !llvm.loop !111
...
polly.loop_header883:                             ; preds = %polly.loop_header877, %polly.loop_header883
  ...
  br i1 %exitcond1127.not, label %polly.loop_exit885, label %polly.loop_header883, !llvm.loop !112
...
vector.body1209:                                  ; preds = %vector.body1209, %vector.ph1212
  ...
  store <4 x double> %305, <4 x double>* %310, align 8, !alias.scope !106, !noalias !113
  ...
  br i1 %311, label %polly.loop_exit911, label %vector.body1209, !llvm.loop !114
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  br i1 %exitcond1117.not, label %polly.loop_exit911, label %polly.loop_header909, !llvm.loop !115
}
