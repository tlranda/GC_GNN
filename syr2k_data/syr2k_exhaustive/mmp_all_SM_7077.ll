; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7077.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7077.c"
...
vector.body1053:                                  ; preds = %vector.body1053, %vector.ph1057
  ...
  %wide.load1064 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %129, label %middle.block1051, label %vector.body1053, !llvm.loop !80
...
vector.body1029:                                  ; preds = %vector.body1029, %vector.ph1031
  ...
  %wide.load1038 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %163, label %middle.block1027, label %vector.body1029, !llvm.loop !90
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph969
  ...
  br i1 %211, label %polly.loop_exit778, label %vector.body967, !llvm.loop !99
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph985
  ...
  br i1 %240, label %polly.loop_exit805, label %vector.body982, !llvm.loop !102
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  br i1 %269, label %polly.loop_exit831, label %vector.body1000, !llvm.loop !105
