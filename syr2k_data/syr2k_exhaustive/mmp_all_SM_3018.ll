; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3018.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3018.c"
...
polly.loop_header248:                             ; preds = %polly.loop_exit256, %polly.loop_header242
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv882, i64 31)
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %127 = mul nsw i64 %polly.indvar386, -32
  %128 = shl nsw i64 %polly.indvar386, 5
...
polly.loop_header389:                             ; preds = %polly.loop_exit430, %polly.loop_header383
  ...
  %.inv857 = icmp ugt i64 %130, 31
  %132 = select i1 %.inv857, i64 31, i64 %131
...
polly.loop_header434:                             ; preds = %polly.loop_exit442, %polly.loop_header428
  ...
  %smin898 = call i64 @llvm.smin.i64(i64 %indvars.iv896, i64 31)
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %156 = mul nsw i64 %polly.indvar572, -32
...
polly.loop_header575:                             ; preds = %polly.loop_exit616, %polly.loop_header569
  ...
  %.inv858 = icmp ugt i64 %159, 31
  %161 = select i1 %.inv858, i64 31, i64 %160
