; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6122.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6122.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond863.not = icmp eq i64 %polly.indvar_next209, 19
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_exit219
  %101 = mul nsw i64 %polly.indvar208, -64
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header227
  ...
  %exitcond862.not = icmp eq i64 %polly.indvar_next231, 19
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %128 = shl nsw i64 %polly.indvar375, 6
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %129 = shl nsw i64 %polly.indvar381, 6
...
polly.loop_exit402:                               ; preds = %polly.loop_exit408
  ...
  %exitcond890.not = icmp eq i64 %polly.indvar_next382, 19
...
polly.loop_header400.preheader:                   ; preds = %polly.loop_exit392
  %131 = mul nsw i64 %polly.indvar381, -64
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit408
  ...
  %smin884 = call i64 @llvm.smin.i64(i64 %indvars.iv882, i64 -1136)
...
polly.loop_header413.us:                          ; preds = %polly.loop_header406.us, %polly.loop_exit422.us
  ...
  %smin878 = call i64 @llvm.smin.i64(i64 %indvars.iv876, i64 63)
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415.loopexit.us, %polly.loop_header400
  ...
  %indvars.iv.next875 = add nuw nsw i64 %indvars.iv874, 64
  %indvars.iv.next883 = add nsw i64 %indvars.iv882, -64
  %exitcond889.not = icmp eq i64 %polly.indvar_next404, 19
...
polly.loop_header547:                             ; preds = %polly.loop_header547.preheader, %polly.loop_exit555
  ...
  %158 = shl nsw i64 %polly.indvar550, 6
...
polly.loop_header553:                             ; preds = %polly.loop_exit577, %polly.loop_header547
  ...
  %159 = shl nsw i64 %polly.indvar556, 6
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next895 = add nsw i64 %indvars.iv894, -64
  %indvars.iv.next908 = add nsw i64 %indvars.iv907, -64
  %exitcond917.not = icmp eq i64 %polly.indvar_next557, 19
...
polly.loop_header575.preheader:                   ; preds = %polly.loop_exit567
  %161 = mul nsw i64 %polly.indvar556, -64
...
polly.loop_header575:                             ; preds = %polly.loop_header575.preheader, %polly.loop_exit583
  ...
  %smin911 = call i64 @llvm.smin.i64(i64 %indvars.iv909, i64 -1136)
...
polly.loop_header588.us:                          ; preds = %polly.loop_header581.us, %polly.loop_exit597.us
  ...
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 63)
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590.loopexit.us, %polly.loop_header575
  ...
  %indvars.iv.next902 = add nuw nsw i64 %indvars.iv901, 64
  %indvars.iv.next910 = add nsw i64 %indvars.iv909, -64
  %exitcond916.not = icmp eq i64 %polly.indvar_next579, 19
