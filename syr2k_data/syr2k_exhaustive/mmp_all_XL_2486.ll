; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2486.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2486.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1052 = phi i64 [ %indvars.iv.next1053, %polly.loop_exit224 ], [ 25, %polly.loop_exit208 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1053 = add nuw nsw i64 %indvars.iv1052, 25
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %103 = shl nuw nsw i64 %polly.indvar231, 2
  %104 = add i64 %97, %103
  %smax1358 = call i64 @llvm.smax.i64(i64 %104, i64 0)
  %105 = mul nsw i64 %polly.indvar231, -4
  %106 = add i64 %98, %105
  %107 = add i64 %smax1358, %106
  %108 = shl nsw i64 %polly.indvar231, 2
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1361 = call i64 @llvm.smin.i64(i64 %115, i64 3)
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  %indvars.iv1084 = phi i64 [ %indvars.iv.next1085, %polly.loop_exit428 ], [ 25, %polly.loop_exit412 ]
...
polly.loop_exit428:                               ; preds = %polly.loop_exit434
  ...
  %indvars.iv.next1071 = add nuw nsw i64 %indvars.iv1070, 100
  %indvars.iv.next1085 = add nuw nsw i64 %indvars.iv1084, 25
  %exitcond1088.not = icmp eq i64 %polly.indvar_next424, 12
...
polly.loop_header426:                             ; preds = %polly.loop_exit434, %polly.loop_header420
  ...
  %159 = shl nsw i64 %polly.indvar429, 6
...
polly.loop_header432:                             ; preds = %polly.loop_exit441, %polly.loop_header426
  ...
  %160 = shl nuw nsw i64 %polly.indvar435, 2
  %161 = add i64 %154, %160
  %smax1310 = call i64 @llvm.smax.i64(i64 %161, i64 0)
  %162 = mul nsw i64 %polly.indvar435, -4
  %163 = add i64 %155, %162
  %164 = add i64 %smax1310, %163
  %165 = shl nsw i64 %polly.indvar435, 2
  %166 = add nsw i64 %165, %156
  %167 = icmp sgt i64 %166, 0
  %168 = select i1 %167, i64 %166, i64 0
  %polly.loop_guard442 = icmp slt i64 %168, 100
...
polly.loop_header439:                             ; preds = %polly.loop_header439.preheader, %polly.loop_exit477
  ...
  %smin1313 = call i64 @llvm.smin.i64(i64 %172, i64 3)
...
polly.loop_header630:                             ; preds = %polly.loop_exit622, %polly.loop_exit638
  %indvars.iv1116 = phi i64 [ %indvars.iv.next1117, %polly.loop_exit638 ], [ 25, %polly.loop_exit622 ]
  ...
  %213 = mul nsw i64 %polly.indvar633, -100
  %214 = mul nuw nsw i64 %polly.indvar633, 100
...
polly.loop_exit638:                               ; preds = %polly.loop_exit644
  ...
  %indvars.iv.next1098 = add nsw i64 %indvars.iv1097, -100
  %indvars.iv.next1103 = add nuw nsw i64 %indvars.iv1102, 100
  %indvars.iv.next1117 = add nuw nsw i64 %indvars.iv1116, 25
  %exitcond1120.not = icmp eq i64 %polly.indvar_next634, 12
...
polly.loop_header636:                             ; preds = %polly.loop_exit644, %polly.loop_header630
  ...
  %216 = shl nsw i64 %polly.indvar639, 6
...
polly.loop_exit644:                               ; preds = %polly.loop_exit651
  ...
  %exitcond1119.not = icmp eq i64 %polly.indvar_next640, 16
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit687
  ...
  %smin1265 = call i64 @llvm.smin.i64(i64 %229, i64 3)
  %230 = add nsw i64 %smin1265, 1
  %smin1112 = call i64 @llvm.smin.i64(i64 %indvars.iv1106, i64 3)
