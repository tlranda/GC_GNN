; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1238.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1238.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1116 = call i64 @llvm.smin.i64(i64 %indvars.iv1096, i64 -984)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1120.not = icmp eq i64 %polly.indvar_next204, 63
...
vector.body1429:                                  ; preds = %vector.body1429, %vector.ph1437
  ...
  %wide.load1450 = load <4 x double>, <4 x double>* %157, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %162, label %middle.block1427, label %vector.body1429, !llvm.loop !84
...
vector.body1365:                                  ; preds = %vector.body1365, %vector.ph1369
  ...
  %wide.load1376 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %173, label %middle.block1363, label %vector.body1365, !llvm.loop !93
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %smin1148 = call i64 @llvm.smin.i64(i64 %indvars.iv1126, i64 -984)
  %175 = add nsw i64 %smin1148, 1000
  %176 = shl nsw i64 %polly.indvar413, 4
  br label %polly.loop_header416

polly.loop_exit418:                               ; preds = %polly.loop_exit441
  %polly.indvar_next414 = add nuw nsw i64 %polly.indvar413, 1
  %indvars.iv.next1127 = add nsw i64 %indvars.iv1126, -16
  %exitcond1152.not = icmp eq i64 %polly.indvar_next414, 63
...
vector.body1379:                                  ; preds = %vector.body1379, %vector.ph1387
  ...
  %wide.load1400 = load <4 x double>, <4 x double>* %235, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %240, label %middle.block1377, label %vector.body1379, !llvm.loop !97
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1319
  ...
  %wide.load1326 = load <4 x double>, <4 x double>* %248, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %251, label %middle.block1315, label %vector.body1317, !llvm.loop !106
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %smin1180 = call i64 @llvm.smin.i64(i64 %indvars.iv1158, i64 -984)
...
polly.loop_exit635:                               ; preds = %polly.loop_exit658
  ...
  %exitcond1184.not = icmp eq i64 %polly.indvar_next631, 63
...
vector.body1329:                                  ; preds = %vector.body1329, %vector.ph1337
  ...
  %wide.load1350 = load <4 x double>, <4 x double>* %313, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %318, label %middle.block1327, label %vector.body1329, !llvm.loop !110
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1257
  ...
  br i1 %343, label %polly.loop_exit884, label %vector.body1256, !llvm.loop !117
...
vector.body1270:                                  ; preds = %vector.body1270, %vector.ph1273
  ...
  br i1 %372, label %polly.loop_exit911, label %vector.body1270, !llvm.loop !120
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1291
  ...
  br i1 %401, label %polly.loop_exit937, label %vector.body1288, !llvm.loop !123
