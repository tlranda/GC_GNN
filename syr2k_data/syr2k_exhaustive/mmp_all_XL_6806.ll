; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6806.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6806.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next219, 150
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %130 = mul nsw i64 %polly.indvar393, -8
  %131 = shl nsw i64 %polly.indvar393, 3
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar_next394, 150
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %polly.loop_guard413 = icmp slt i64 %137, 8
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv901 = phi i64 [ %indvars.iv.next902, %polly.loop_exit576 ], [ 1, %polly.loop_exit560 ]
  ...
  %162 = mul nsw i64 %polly.indvar571, -8
  %163 = shl nsw i64 %polly.indvar571, 3
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next572, 150
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %polly.loop_guard591 = icmp slt i64 %169, 8
