; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6346.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6346.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin870 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -968)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar_next203, 32
...
polly.start272:                                   ; preds = %kernel_syr2k.exit
  %malloccall274 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %smin898 = call i64 @llvm.smin.i64(i64 %indvars.iv879, i64 -968)
  %140 = add nsw i64 %smin898, 1000
  %141 = shl nsw i64 %polly.indvar377, 5
  br label %polly.loop_header380

polly.loop_exit382:                               ; preds = %polly.loop_exit405
  %polly.indvar_next378 = add nuw nsw i64 %polly.indvar377, 1
  %indvars.iv.next880 = add nsw i64 %indvars.iv879, -32
  %exitcond901.not = icmp eq i64 %polly.indvar_next378, 32
...
polly.start450:                                   ; preds = %init_array.exit
  %malloccall452 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %smin926 = call i64 @llvm.smin.i64(i64 %indvars.iv907, i64 -968)
  %183 = add nsw i64 %smin926, 1000
  %184 = shl nsw i64 %polly.indvar555, 5
...
polly.loop_exit560:                               ; preds = %polly.loop_exit583
  ...
  %exitcond929.not = icmp eq i64 %polly.indvar_next556, 32
