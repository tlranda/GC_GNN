; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10637.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10637.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv786 = phi i64 [ %indvars.iv.next787, %polly.loop_exit207 ], [ 7, %polly.loop_exit193 ]
  %indvars.iv779 = phi i64 [ %indvars.iv.next780, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %polly.indvar202 = phi i64 [ %polly.indvar_next203, %polly.loop_exit207 ], [ 0, %polly.loop_exit193 ]
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv786, i64 74)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next780 = add nuw nsw i64 %indvars.iv779, 128
  %indvars.iv.next787 = add nuw nsw i64 %indvars.iv786, 8
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  %indvars.iv806 = phi i64 [ %indvars.iv.next807, %polly.loop_exit360 ], [ 7, %polly.loop_exit344 ]
  ...
  %umin808 = call i64 @llvm.umin.i64(i64 %indvars.iv806, i64 74)
  %126 = mul nsw i64 %polly.indvar355, -128
...
polly.loop_exit360:                               ; preds = %polly.loop_exit367
  ...
  %indvars.iv.next798 = add nuw nsw i64 %indvars.iv797, 128
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  %indvars.iv827 = phi i64 [ %indvars.iv.next828, %polly.loop_exit515 ], [ 7, %polly.loop_exit499 ]
  ...
  %umin829 = call i64 @llvm.umin.i64(i64 %indvars.iv827, i64 74)
  %155 = mul nsw i64 %polly.indvar510, -128
...
polly.loop_exit515:                               ; preds = %polly.loop_exit522
  ...
  %indvars.iv.next819 = add nuw nsw i64 %indvars.iv818, 128
  %indvars.iv.next828 = add nuw nsw i64 %indvars.iv827, 8
  %exitcond831.not = icmp eq i64 %polly.indvar_next511, 10
...
polly.loop_header513:                             ; preds = %polly.loop_exit522, %polly.loop_header507
  ...
  %160 = shl nsw i64 %polly.indvar516, 4
