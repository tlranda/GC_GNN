; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7532.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7532.c"
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 -984)
  %101 = shl nsw i64 %polly.indvar224, 4
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar_next225, 63
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv874, i64 -984)
  %134 = shl nsw i64 %polly.indvar401, 4
...
polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar_next402, 63
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 -984)
  %167 = shl nsw i64 %polly.indvar581, 4
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %indvars.iv.next898 = add nsw i64 %indvars.iv897, -16
  %exitcond901.not = icmp eq i64 %polly.indvar_next582, 63
