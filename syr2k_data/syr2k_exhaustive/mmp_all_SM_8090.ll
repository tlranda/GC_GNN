; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8090.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8090.c"
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %146 = shl nsw i64 %polly.indvar370, 2
  %147 = sub nsw i64 %143, %146
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %polly.loop_guard383 = icmp slt i64 %149, 4
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382.loopexit.us, %polly.loop_header367
  ...
  %indvars.iv.next808 = add i64 %indvars.iv807, -4
  %indvars.iv.next813 = add i64 %indvars.iv812, 4
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  ...
  %183 = shl nsw i64 %polly.indvar528, 2
  %184 = sub nsw i64 %180, %183
  %185 = icmp sgt i64 %184, 0
  %186 = select i1 %185, i64 %184, i64 0
  %polly.loop_guard541 = icmp slt i64 %186, 4
...
polly.loop_exit533:                               ; preds = %polly.loop_exit540.loopexit.us, %polly.loop_header525
  ...
  %indvars.iv.next831 = add i64 %indvars.iv830, -4
  %indvars.iv.next836 = add i64 %indvars.iv835, 4
