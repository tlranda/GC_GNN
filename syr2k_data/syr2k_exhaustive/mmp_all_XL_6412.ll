; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6412.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6412.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit223
  ...
  %indvars.iv838 = phi i64 [ 2, %polly.loop_header199.preheader ], [ %indvars.iv.next839, %polly.loop_exit223 ]
  ...
  %97 = udiv i64 %indvars.iv838, 3
  %98 = mul nuw nsw i64 %97, 96
  %99 = add i64 %indvars.iv836, %98
  %100 = sub nsw i64 %indvars.iv842, %98
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %104 = add nuw nsw i64 %polly.indvar202, 2
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next203, 5
...
polly.loop_header233:                             ; preds = %polly.loop_exit242, %polly.loop_header227
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 255)
  %117 = add i64 %polly.indvar236, %108
  %118 = add i64 %117, %102
...
polly.loop_header240:                             ; preds = %polly.loop_header240.preheader, %polly.loop_header240
  ...
  %121 = add nuw nsw i64 %polly.indvar244, %101
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit395
  ...
  %indvars.iv859 = phi i64 [ 2, %polly.loop_header370.preheader ], [ %indvars.iv.next860, %polly.loop_exit395 ]
  ...
  %134 = udiv i64 %indvars.iv859, 3
  %135 = mul nuw nsw i64 %134, 96
  %136 = add i64 %indvars.iv857, %135
  %137 = sub nsw i64 %indvars.iv864, %135
  %138 = shl nsw i64 %polly.indvar373, 8
  br label %polly.loop_header376

polly.loop_exit378:                               ; preds = %polly.loop_exit384
  %139 = mul nsw i64 %polly.indvar373, -256
  %140 = mul nuw nsw i64 %polly.indvar373, 3
  %141 = add nuw nsw i64 %polly.indvar373, 2
  %pexp.p_div_q392 = udiv i64 %141, 3
  %142 = sub nsw i64 %140, %pexp.p_div_q392
...
polly.loop_exit395:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next854 = add nsw i64 %indvars.iv853, -256
  %indvars.iv.next858 = add nsw i64 %indvars.iv857, -32
  %indvars.iv.next860 = add nuw nsw i64 %indvars.iv859, 1
  %indvars.iv.next865 = add nuw nsw i64 %indvars.iv864, 32
  %exitcond873.not = icmp eq i64 %polly.indvar_next374, 5
...
polly.loop_header382:                             ; preds = %polly.loop_header382, %polly.loop_header376
  ...
  %143 = add nuw nsw i64 %polly.indvar385, %138
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_exit378
  %indvars.iv866 = phi i64 [ %indvars.iv.next867, %polly.loop_exit401 ], [ %137, %polly.loop_exit378 ]
  %indvars.iv861 = phi i64 [ %indvars.iv.next862, %polly.loop_exit401 ], [ %136, %polly.loop_exit378 ]
  ...
  %149 = mul nsw i64 %polly.indvar396, -96
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408, %polly.loop_header393
  %polly.indvar_next397 = add nsw i64 %polly.indvar396, 1
  %polly.loop_cond398 = icmp slt i64 %polly.indvar396, 12
...
polly.loop_header406:                             ; preds = %polly.loop_exit416, %polly.loop_header399
  ...
  %smin870 = call i64 @llvm.smin.i64(i64 %indvars.iv868, i64 255)
  %154 = add i64 %polly.indvar410, %145
  %155 = add i64 %154, %139
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_header414
  ...
  %158 = add nuw nsw i64 %polly.indvar418, %138
...
polly.loop_header544:                             ; preds = %polly.loop_header544.preheader, %polly.loop_exit569
  ...
  %indvars.iv882 = phi i64 [ 2, %polly.loop_header544.preheader ], [ %indvars.iv.next883, %polly.loop_exit569 ]
  ...
  %171 = udiv i64 %indvars.iv882, 3
  %172 = mul nuw nsw i64 %171, 96
  %173 = add i64 %indvars.iv880, %172
  %174 = sub nsw i64 %indvars.iv887, %172
  %175 = shl nsw i64 %polly.indvar547, 8
  br label %polly.loop_header550

polly.loop_exit552:                               ; preds = %polly.loop_exit558
  %176 = mul nsw i64 %polly.indvar547, -256
  %177 = mul nuw nsw i64 %polly.indvar547, 3
  %178 = add nuw nsw i64 %polly.indvar547, 2
  %pexp.p_div_q566 = udiv i64 %178, 3
  %179 = sub nsw i64 %177, %pexp.p_div_q566
...
polly.loop_exit569:                               ; preds = %polly.loop_exit575
  ...
  %exitcond896.not = icmp eq i64 %polly.indvar_next548, 5
...
polly.loop_header556:                             ; preds = %polly.loop_header556, %polly.loop_header550
  ...
  %180 = add nuw nsw i64 %polly.indvar559, %175
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_exit552
  %indvars.iv889 = phi i64 [ %indvars.iv.next890, %polly.loop_exit575 ], [ %174, %polly.loop_exit552 ]
  %indvars.iv884 = phi i64 [ %indvars.iv.next885, %polly.loop_exit575 ], [ %173, %polly.loop_exit552 ]
  ...
  %182 = mul nsw i64 %polly.indvar570, 96
  %183 = sub nsw i64 %175, %182
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %186 = mul nsw i64 %polly.indvar570, -96
...
polly.loop_exit575:                               ; preds = %polly.loop_exit582, %polly.loop_header567
  %polly.indvar_next571 = add nsw i64 %polly.indvar570, 1
  %polly.loop_cond572 = icmp slt i64 %polly.indvar570, 12
...
polly.loop_header580:                             ; preds = %polly.loop_exit590, %polly.loop_header573
  ...
  %smin893 = call i64 @llvm.smin.i64(i64 %indvars.iv891, i64 255)
  %191 = add i64 %polly.indvar584, %182
  %192 = add i64 %191, %176
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_header588
  ...
  %195 = add nuw nsw i64 %polly.indvar592, %175
