; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9399.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9399.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next798 = add nuw nsw i64 %indvars.iv797, 2
  %exitcond801.not = icmp eq i64 %polly.indvar_next203, 300
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %polly.loop_guard = icmp slt i64 %105, 4
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  %indvars.iv821 = phi i64 [ %indvars.iv.next822, %polly.loop_exit362 ], [ 1, %polly.loop_exit346 ]
  ...
  %129 = udiv i64 %indvars.iv821, 25
  %130 = mul nsw i64 %polly.indvar357, -4
  %131 = shl nsw i64 %polly.indvar357, 2
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_exit369
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next805 = add nsw i64 %indvars.iv804, -4
  %indvars.iv.next810 = add nuw nsw i64 %indvars.iv809, 4
  %indvars.iv.next822 = add nuw nsw i64 %indvars.iv821, 2
  %exitcond825.not = icmp eq i64 %polly.indvar_next358, 300
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %134 = mul nuw nsw i64 %polly.indvar370, 50
  %135 = add nsw i64 %134, %130
  %136 = icmp sgt i64 %135, 0
  %137 = select i1 %136, i64 %135, i64 0
  %polly.loop_guard377 = icmp slt i64 %137, 4
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %indvars.iv.next812 = add nsw i64 %indvars.iv811, -50
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  %indvars.iv845 = phi i64 [ %indvars.iv.next846, %polly.loop_exit520 ], [ 1, %polly.loop_exit504 ]
  ...
  %161 = udiv i64 %indvars.iv845, 25
  %162 = mul nsw i64 %polly.indvar515, -4
  %163 = shl nsw i64 %polly.indvar515, 2
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next834 = add nuw nsw i64 %indvars.iv833, 4
  %indvars.iv.next846 = add nuw nsw i64 %indvars.iv845, 2
  %exitcond849.not = icmp eq i64 %polly.indvar_next516, 300
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %166 = mul nuw nsw i64 %polly.indvar528, 50
  %167 = add nsw i64 %166, %162
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %polly.loop_guard535 = icmp slt i64 %169, 4
