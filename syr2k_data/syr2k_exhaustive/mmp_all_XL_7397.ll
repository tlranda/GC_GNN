; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7397.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7397.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %122 = mul nsw i64 %polly.indvar230, 50
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %.inv832 = icmp ult i64 %150, 23
  %151 = mul nsw i64 %polly.indvar393, -64
  %152 = icmp slt i64 %151, -1136
  %153 = select i1 %152, i64 %151, i64 -1136
  %154 = add nsw i64 %153, 1199
  %155 = shl nsw i64 %polly.indvar393, 6
  %.op929 = add nuw i64 %150, 2
  %156 = select i1 %.inv832, i64 %.op929, i64 24
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %173 = mul nsw i64 %polly.indvar406, 50
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %.inv833 = icmp ult i64 %201, 23
  %202 = mul nsw i64 %polly.indvar571, -64
  %203 = icmp slt i64 %202, -1136
  %204 = select i1 %203, i64 %202, i64 -1136
  %205 = add nsw i64 %204, 1199
  %206 = shl nsw i64 %polly.indvar571, 6
  %.op931 = add nuw i64 %201, 2
  %207 = select i1 %.inv833, i64 %.op931, i64 24
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %224 = mul nsw i64 %polly.indvar584, 50
