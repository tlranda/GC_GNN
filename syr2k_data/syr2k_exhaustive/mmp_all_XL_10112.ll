; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10112.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10112.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin797 = call i64 @llvm.smin.i64(i64 %indvars.iv795, i64 -936)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond800.not = icmp eq i64 %polly.indvar_next209, 16
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %.inv774 = icmp ult i64 %137, 23
  %138 = mul nsw i64 %polly.indvar357, -64
  %139 = icmp slt i64 %138, -1136
  %140 = select i1 %139, i64 %138, i64 -1136
  %141 = add nsw i64 %140, 1199
  %142 = shl nsw i64 %polly.indvar357, 6
  %.op883 = add nuw i64 %137, 2
  %143 = select i1 %.inv774, i64 %.op883, i64 24
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next358, 19
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %144 = shl nsw i64 %polly.indvar363, 6
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond822.not = icmp eq i64 %polly.indvar_next364, 16
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %146 = mul nsw i64 %polly.indvar370, 50
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %indvars.iv.next807 = add i64 %indvars.iv806, 50
  %indvars.iv.next812 = add i64 %indvars.iv811, -50
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  ...
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 49)
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %.inv775 = icmp ult i64 %175, 23
  %176 = mul nsw i64 %polly.indvar515, -64
  %177 = icmp slt i64 %176, -1136
  %178 = select i1 %177, i64 %176, i64 -1136
  %179 = add nsw i64 %178, 1199
  %180 = shl nsw i64 %polly.indvar515, 6
  %.op885 = add nuw i64 %175, 2
  %181 = select i1 %.inv775, i64 %.op885, i64 24
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %indvars.iv.next827 = add nsw i64 %indvars.iv826, -64
  %indvars.iv.next832 = add nuw nsw i64 %indvars.iv831, 64
  %exitcond845.not = icmp eq i64 %polly.indvar_next516, 19
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %smin841 = call i64 @llvm.smin.i64(i64 %indvars.iv839, i64 -936)
  %182 = shl nsw i64 %polly.indvar521, 6
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar_next522, 16
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %184 = mul nsw i64 %polly.indvar528, 50
