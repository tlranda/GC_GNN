; ModuleID = 'syr2k_exhaustive/mmp_all_SM_829.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_829.c"
...
vector.body1366:                                  ; preds = %vector.body1366, %vector.ph1368
  ...
  br i1 %57, label %middle.block1364, label %vector.body1366, !llvm.loop !64
...
vector.body1429:                                  ; preds = %vector.body1429, %vector.ph1431
  ...
  br i1 %68, label %middle.block1427, label %vector.body1429, !llvm.loop !66
...
vector.body1441:                                  ; preds = %vector.body1441, %vector.ph1445
  ...
  %wide.load1452 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %95, label %middle.block1439, label %vector.body1441, !llvm.loop !79
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %108 = and i64 %107, 9223372036854775744
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %154 = mul nsw i64 %indvar1454, -64
  %155 = add i64 %102, %154
  %smax1473 = call i64 @llvm.smax.i64(i64 %155, i64 0)
  %156 = shl nuw nsw i64 %indvar1454, 6
  %157 = add i64 %104, %156
  %158 = add i64 %smax1473, %157
  %159 = mul nsw i64 %indvar1454, -64
  %160 = add i64 %109, %159
  %smax1456 = call i64 @llvm.smax.i64(i64 %160, i64 0)
  %161 = shl nuw nsw i64 %indvar1454, 6
  %162 = add i64 %108, %161
...
vector.body1472:                                  ; preds = %vector.body1472, %vector.ph1476
  ...
  %wide.load1483 = load <4 x double>, <4 x double>* %204, align 8, !alias.scope !84
  ...
  %wide.load1489 = load <4 x double>, <4 x double>* %212, align 8, !alias.scope !87, !noalias !89
  ...
  br i1 %217, label %middle.block1470, label %vector.body1472, !llvm.loop !90
...
vector.body1378:                                  ; preds = %vector.body1378, %vector.ph1382
  ...
  %wide.load1389 = load <4 x double>, <4 x double>* %225, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %228, label %middle.block1376, label %vector.body1378, !llvm.loop !99
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_header400
  ...
  br i1 %exitcond1153.not, label %polly.loop_exit402, label %polly.loop_header400, !llvm.loop !100
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %231 = shl nsw i64 %polly.indvar413, 7
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %234 = and i64 %233, 9223372036854775744
  ...
  %241 = and i64 %240, 9223372036854775744
  %242 = sub nsw i64 %239, %241
  %243 = or i64 %238, 8
  %244 = mul nsw i64 %polly.indvar419, -32
  %245 = add i64 %244, %241
  %246 = lshr i64 %polly.indvar419, 1
  %247 = shl nuw nsw i64 %246, 6
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %287 = mul nsw i64 %indvar1391, -64
  %288 = add i64 %235, %287
  %smax1410 = call i64 @llvm.smax.i64(i64 %288, i64 0)
  %289 = shl nuw nsw i64 %indvar1391, 6
  %290 = add i64 %237, %289
  %291 = add i64 %smax1410, %290
  %292 = mul nsw i64 %indvar1391, -64
  %293 = add i64 %242, %292
  %smax1393 = call i64 @llvm.smax.i64(i64 %293, i64 0)
  %294 = shl nuw nsw i64 %indvar1391, 6
  %295 = add i64 %241, %294
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %317 = mul nsw i64 %polly.indvar442, -64
  %318 = icmp slt i64 %317, -1136
  %319 = select i1 %318, i64 %317, i64 -1136
...
vector.body1409:                                  ; preds = %vector.body1409, %vector.ph1413
  ...
  %wide.load1420 = load <4 x double>, <4 x double>* %337, align 8, !alias.scope !103
  ...
  %wide.load1426 = load <4 x double>, <4 x double>* %345, align 8, !alias.scope !106, !noalias !108
  ...
  br i1 %350, label %middle.block1407, label %vector.body1409, !llvm.loop !109
...
polly.loop_header495:                             ; preds = %polly.loop_header495.preheader1494, %polly.loop_header495
  ...
  br i1 %exitcond1147.not, label %polly.loop_exit497, label %polly.loop_header495, !llvm.loop !110
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1319
  ...
  %wide.load1326 = load <4 x double>, <4 x double>* %358, align 8, !alias.scope !111, !noalias !113
  ...
  br i1 %361, label %middle.block1315, label %vector.body1317, !llvm.loop !118
...
polly.loop_header617:                             ; preds = %polly.loop_header617.preheader, %polly.loop_header617
  ...
  br i1 %exitcond1185.not, label %polly.loop_exit619, label %polly.loop_header617, !llvm.loop !119
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %364 = shl nsw i64 %polly.indvar630, 7
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %367 = and i64 %366, 9223372036854775744
  ...
  %378 = add i64 %377, %374
  %379 = lshr i64 %polly.indvar636, 1
  %380 = shl nuw nsw i64 %379, 6
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %420 = mul nsw i64 %indvar1328, -64
  %421 = add i64 %368, %420
  %smax1347 = call i64 @llvm.smax.i64(i64 %421, i64 0)
  %422 = shl nuw nsw i64 %indvar1328, 6
  %423 = add i64 %370, %422
  %424 = add i64 %smax1347, %423
  %425 = mul nsw i64 %indvar1328, -64
  %426 = add i64 %375, %425
  %smax1330 = call i64 @llvm.smax.i64(i64 %426, i64 0)
  %427 = shl nuw nsw i64 %indvar1328, 6
  %428 = add i64 %374, %427
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %450 = mul nsw i64 %polly.indvar659, -64
...
vector.body1346:                                  ; preds = %vector.body1346, %vector.ph1350
  ...
  %wide.load1357 = load <4 x double>, <4 x double>* %470, align 8, !alias.scope !122
  ...
  %wide.load1363 = load <4 x double>, <4 x double>* %478, align 8, !alias.scope !125, !noalias !127
  ...
  br i1 %483, label %middle.block1344, label %vector.body1346, !llvm.loop !128
...
polly.loop_header712:                             ; preds = %polly.loop_header712.preheader1498, %polly.loop_header712
  ...
  br i1 %exitcond1179.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !129
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1257
  ...
  br i1 %508, label %polly.loop_exit884, label %vector.body1256, !llvm.loop !135
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  br i1 %exitcond1210.not, label %polly.loop_exit884, label %polly.loop_header882, !llvm.loop !136
...
vector.body1270:                                  ; preds = %vector.body1270, %vector.ph1273
  ...
  br i1 %537, label %polly.loop_exit911, label %vector.body1270, !llvm.loop !138
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  br i1 %exitcond1200.not, label %polly.loop_exit911, label %polly.loop_header909, !llvm.loop !139
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1291
  ...
  br i1 %566, label %polly.loop_exit937, label %vector.body1288, !llvm.loop !141
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  br i1 %exitcond1190.not, label %polly.loop_exit937, label %polly.loop_header935, !llvm.loop !142
}
