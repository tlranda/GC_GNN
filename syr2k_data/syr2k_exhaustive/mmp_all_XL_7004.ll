; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7004.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7004.c"
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %129 = udiv i64 %indvars.iv875, 25
  %130 = mul nsw i64 %polly.indvar393, -16
  %131 = shl nsw i64 %polly.indvar393, 4
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar_next394, 75
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %134 = mul nuw nsw i64 %polly.indvar406, 100
  %135 = add nsw i64 %134, %130
  %136 = icmp sgt i64 %135, 0
  %137 = select i1 %136, i64 %135, i64 0
  %polly.loop_guard413 = icmp slt i64 %137, 16
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %161 = udiv i64 %indvars.iv901, 25
  %162 = mul nsw i64 %polly.indvar571, -16
  %163 = shl nsw i64 %polly.indvar571, 4
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %exitcond905.not = icmp eq i64 %polly.indvar_next572, 75
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %166 = mul nuw nsw i64 %polly.indvar584, 100
  %167 = add nsw i64 %166, %162
  %168 = icmp sgt i64 %167, 0
  %169 = select i1 %168, i64 %167, i64 0
  %polly.loop_guard591 = icmp slt i64 %169, 16
