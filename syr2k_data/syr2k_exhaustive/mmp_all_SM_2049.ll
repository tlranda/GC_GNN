; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2049.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2049.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit224 ], [ 3, %polly.loop_exit208 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1032 = add nuw nsw i64 %indvars.iv1031, 2
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %105 = mul nsw i64 %polly.indvar225, -20
  %106 = add i64 %98, %105
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %115, i64 19)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  %indvars.iv1057 = phi i64 [ %indvars.iv.next1058, %polly.loop_exit423 ], [ 3, %polly.loop_exit406 ]
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %indvars.iv.next1058 = add nuw nsw i64 %indvars.iv1057, 2
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %157 = mul nuw nsw i64 %polly.indvar424, 20
  %158 = add i64 %151, %157
  %smax1276 = call i64 @llvm.smax.i64(i64 %158, i64 0)
  %159 = mul nsw i64 %polly.indvar424, -20
  %160 = add i64 %152, %159
  %161 = add i64 %smax1276, %160
  %162 = mul nuw nsw i64 %polly.indvar424, 20
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %169, i64 19)
  %170 = add nsw i64 %smin1279, 1
  %smin1054 = call i64 @llvm.smin.i64(i64 %indvars.iv1049, i64 19)
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  %indvars.iv1083 = phi i64 [ %indvars.iv.next1084, %polly.loop_exit628 ], [ 3, %polly.loop_exit611 ]
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 2
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %211 = mul nuw nsw i64 %polly.indvar629, 20
  %212 = add i64 %205, %211
  %smax1228 = call i64 @llvm.smax.i64(i64 %212, i64 0)
  %213 = mul nsw i64 %polly.indvar629, -20
  %214 = add i64 %206, %213
  %215 = add i64 %smax1228, %214
  %216 = mul nuw nsw i64 %polly.indvar629, 20
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %223, i64 19)
  %224 = add nsw i64 %smin1231, 1
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 19)
