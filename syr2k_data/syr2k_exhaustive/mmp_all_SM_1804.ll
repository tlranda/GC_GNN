; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1804.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1804.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1019 = add nuw nsw i64 %indvars.iv1018, 20
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  ...
  %149 = mul nsw i64 %polly.indvar417, -20
  %150 = mul nuw nsw i64 %polly.indvar417, 20
...
polly.loop_exit422:                               ; preds = %polly.loop_exit429
  ...
  %indvars.iv.next1044 = add nuw nsw i64 %indvars.iv1043, 20
  %indvars.iv.next1056 = add nuw nsw i64 %indvars.iv1055, 5
  %exitcond1058.not = icmp eq i64 %polly.indvar_next418, 60
...
polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  ...
  %polly.loop_guard430 = icmp slt i64 %161, 20
...
polly.loop_exit465:                               ; preds = %polly.loop_exit472.loopexit.us, %polly.loop_header427.split, %polly.loop_header463.preheader
  ...
  %polly.loop_cond433 = icmp ult i64 %polly.indvar431, 19
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  ...
  %201 = mul nsw i64 %polly.indvar621, -20
  %202 = mul nuw nsw i64 %polly.indvar621, 20
  %203 = mul nsw i64 %polly.indvar621, -20
  %204 = mul nuw nsw i64 %polly.indvar621, 20
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next622, 60
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %polly.loop_guard634 = icmp slt i64 %213, 20
...
polly.loop_exit669:                               ; preds = %polly.loop_exit676.loopexit.us, %polly.loop_header631.split, %polly.loop_header667.preheader
  ...
  %polly.loop_cond637 = icmp ult i64 %polly.indvar635, 19
