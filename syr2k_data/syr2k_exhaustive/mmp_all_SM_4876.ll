; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4876.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4876.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv988 = phi i64 [ 4, %polly.loop_header199.preheader ], [ %indvars.iv.next989, %polly.loop_exit207 ]
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %smin985 = call i64 @llvm.smin.i64(i64 %indvars.iv981, i64 19)
...
vector.body1187:                                  ; preds = %vector.body1187, %vector.ph1191
  ...
  %wide.load1198 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %129, label %middle.block1185, label %vector.body1187, !llvm.loop !79
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  %indvars.iv1013 = phi i64 [ 4, %polly.loop_header383.preheader ], [ %indvars.iv.next1014, %polly.loop_exit391 ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %134 = mul nuw nsw i64 %polly.indvar398, 20
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_exit440
  ...
  %smin1010 = call i64 @llvm.smin.i64(i64 %indvars.iv1005, i64 19)
...
polly.loop_header409.preheader:                   ; preds = %polly.loop_header402.split
  ...
  %polly.access.call1434.load.8 = load double, double* %polly.access.call1434.8, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.9 = load double, double* %polly.access.call1434.9, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.10 = load double, double* %polly.access.call1434.10, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.11 = load double, double* %polly.access.call1434.11, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.12 = load double, double* %polly.access.call1434.12, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.13 = load double, double* %polly.access.call1434.13, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.14 = load double, double* %polly.access.call1434.14, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.15 = load double, double* %polly.access.call1434.15, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.16 = load double, double* %polly.access.call1434.16, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.17 = load double, double* %polly.access.call1434.17, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.18 = load double, double* %polly.access.call1434.18, align 8, !alias.scope !76, !noalias !81
  ...
  %polly.access.call1434.load.19 = load double, double* %polly.access.call1434.19, align 8, !alias.scope !76, !noalias !81
...
vector.body1163:                                  ; preds = %vector.body1163, %vector.ph1165
  ...
  %wide.load1172 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %163, label %middle.block1161, label %vector.body1163, !llvm.loop !89
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  %indvars.iv1038 = phi i64 [ 4, %polly.loop_header573.preheader ], [ %indvars.iv.next1039, %polly.loop_exit581 ]
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %168 = mul nuw nsw i64 %polly.indvar588, 20
...
polly.loop_header599.preheader:                   ; preds = %polly.loop_header592.split
  ...
  %polly.access.call1624.load.8 = load double, double* %polly.access.call1624.8, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.9 = load double, double* %polly.access.call1624.9, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.10 = load double, double* %polly.access.call1624.10, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.11 = load double, double* %polly.access.call1624.11, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.12 = load double, double* %polly.access.call1624.12, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.13 = load double, double* %polly.access.call1624.13, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.14 = load double, double* %polly.access.call1624.14, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.15 = load double, double* %polly.access.call1624.15, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.16 = load double, double* %polly.access.call1624.16, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.17 = load double, double* %polly.access.call1624.17, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.18 = load double, double* %polly.access.call1624.18, align 8, !alias.scope !86, !noalias !91
  ...
  %polly.access.call1624.load.19 = load double, double* %polly.access.call1624.19, align 8, !alias.scope !86, !noalias !91
...
vector.body1102:                                  ; preds = %vector.body1102, %vector.ph1103
  ...
  br i1 %211, label %polly.loop_exit805, label %vector.body1102, !llvm.loop !98
...
vector.body1116:                                  ; preds = %vector.body1116, %vector.ph1119
  ...
  br i1 %240, label %polly.loop_exit832, label %vector.body1116, !llvm.loop !101
...
vector.body1134:                                  ; preds = %vector.body1134, %vector.ph1137
  ...
  br i1 %269, label %polly.loop_exit858, label %vector.body1134, !llvm.loop !104
