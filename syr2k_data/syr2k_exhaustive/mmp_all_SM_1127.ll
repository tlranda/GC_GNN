; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1127.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1127.c"
...
vector.body1400:                                  ; preds = %vector.body1400, %vector.ph1408
  ...
  %wide.load1421 = load <4 x double>, <4 x double>* %151, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %156, label %middle.block1398, label %vector.body1400, !llvm.loop !85
...
vector.body1336:                                  ; preds = %vector.body1336, %vector.ph1340
  ...
  %wide.load1347 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %165, label %middle.block1334, label %vector.body1336, !llvm.loop !93
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %167 = mul nuw nsw i64 %polly.indvar413, 20
...
vector.body1350:                                  ; preds = %vector.body1350, %vector.ph1358
  ...
  %wide.load1371 = load <4 x double>, <4 x double>* %221, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %226, label %middle.block1348, label %vector.body1350, !llvm.loop !98
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1290
  ...
  %wide.load1297 = load <4 x double>, <4 x double>* %232, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %235, label %middle.block1286, label %vector.body1288, !llvm.loop !106
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %237 = mul nuw nsw i64 %polly.indvar630, 20
...
vector.body1300:                                  ; preds = %vector.body1300, %vector.ph1308
  ...
  %wide.load1321 = load <4 x double>, <4 x double>* %291, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %296, label %middle.block1298, label %vector.body1300, !llvm.loop !111
...
vector.body1226:                                  ; preds = %vector.body1226, %vector.ph1228
  ...
  br i1 %319, label %polly.loop_exit884, label %vector.body1226, !llvm.loop !117
...
vector.body1241:                                  ; preds = %vector.body1241, %vector.ph1244
  ...
  br i1 %348, label %polly.loop_exit911, label %vector.body1241, !llvm.loop !120
...
vector.body1259:                                  ; preds = %vector.body1259, %vector.ph1262
  ...
  br i1 %377, label %polly.loop_exit937, label %vector.body1259, !llvm.loop !123
