; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7873.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7873.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %114 = mul nsw i64 %polly.indvar230, 100
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %.inv832 = icmp ult i64 %142, 11
  %143 = mul nsw i64 %polly.indvar393, -128
  %144 = icmp slt i64 %143, -1072
  %145 = select i1 %144, i64 %143, i64 -1072
  %146 = add nsw i64 %145, 1199
  %147 = shl nsw i64 %polly.indvar393, 7
  %.op929 = add nuw i64 %142, 2
  %148 = select i1 %.inv832, i64 %.op929, i64 12
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %157 = mul nsw i64 %polly.indvar406, 100
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %.inv833 = icmp ult i64 %185, 11
  %186 = mul nsw i64 %polly.indvar571, -128
  %187 = icmp slt i64 %186, -1072
  %188 = select i1 %187, i64 %186, i64 -1072
  %189 = add nsw i64 %188, 1199
  %190 = shl nsw i64 %polly.indvar571, 7
  %.op931 = add nuw i64 %185, 2
  %191 = select i1 %.inv833, i64 %.op931, i64 12
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %200 = mul nsw i64 %polly.indvar584, 100
