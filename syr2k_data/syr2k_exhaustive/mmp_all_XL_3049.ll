; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3049.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3049.c"
...
vector.body1372:                                  ; preds = %vector.body1372, %vector.ph1376
  ...
  %wide.load1383 = load <4 x double>, <4 x double>* %171, align 8, !alias.scope !78, !noalias !80
  ...
  store <4 x double> %172, <4 x double>* %173, align 8, !alias.scope !78, !noalias !80
  %index.next1380 = add i64 %index1379, 4
  %174 = icmp eq i64 %index.next1380, %n.vec1378
  br i1 %174, label %middle.block1370, label %vector.body1372, !llvm.loop !84
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %177 = shl nsw i64 %polly.indvar409, 4
...
vector.body1348:                                  ; preds = %vector.body1348, %vector.ph1350
  ...
  %wide.load1357 = load <4 x double>, <4 x double>* %250, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %253, label %middle.block1346, label %vector.body1348, !llvm.loop !94
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %256 = shl nsw i64 %polly.indvar623, 4
...
vector.body1287:                                  ; preds = %vector.body1287, %vector.ph1288
  ...
  store <4 x double> %340, <4 x double>* %345, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %346, label %polly.loop_exit876, label %vector.body1287, !llvm.loop !103
...
vector.body1301:                                  ; preds = %vector.body1301, %vector.ph1304
  ...
  store <4 x double> %369, <4 x double>* %374, align 8, !alias.scope !102, !noalias !105
  ...
  br i1 %375, label %polly.loop_exit903, label %vector.body1301, !llvm.loop !106
...
vector.body1319:                                  ; preds = %vector.body1319, %vector.ph1322
  ...
  store <4 x double> %398, <4 x double>* %403, align 8, !alias.scope !101, !noalias !108
  ...
  br i1 %404, label %polly.loop_exit929, label %vector.body1319, !llvm.loop !109
