; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3705.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3705.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1023 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -936)
...
polly.loop_header391:                             ; preds = %polly.loop_header391.preheader, %polly.loop_exit399
  ...
  %smin1049 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 -936)
  %151 = add nsw i64 %smin1049, 1000
  %152 = shl nsw i64 %polly.indvar394, 6
...
polly.loop_exit399:                               ; preds = %polly.loop_exit406
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar_next395, 16
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %smin1075 = call i64 @llvm.smin.i64(i64 %indvars.iv1055, i64 -936)
...
polly.loop_exit594:                               ; preds = %polly.loop_exit601
  ...
  %exitcond1078.not = icmp eq i64 %polly.indvar_next590, 16
