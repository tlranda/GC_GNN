; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8713.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8713.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  %indvars.iv791 = phi i64 [ %indvars.iv.next792, %polly.loop_exit219 ], [ %107, %polly.loop_header205 ]
  %indvars.iv787 = phi i64 [ %indvars.iv.next788, %polly.loop_exit219 ], [ %106, %polly.loop_header205 ]
  ...
  %111 = add i64 %smax, %indvars.iv791
...
polly.loop_exit219:                               ; preds = %polly.loop_exit232.3, %polly.loop_header211
  ...
  %exitcond796.not = icmp eq i64 %polly.indvar_next215, 19
...
polly.loop_header223:                             ; preds = %polly.loop_header211, %polly.loop_exit232
  %indvars.iv793 = phi i64 [ %indvars.iv.next794, %polly.loop_exit232 ], [ %111, %polly.loop_header211 ]
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond819.not = icmp eq i64 %polly.indvar_next358, 250
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %146 = shl nuw nsw i64 %indvars.iv803, 2
  %147 = and i64 %146, 9223372036854775744
  %148 = sub nsw i64 %indvars.iv801, %147
  %149 = add i64 %indvars.iv808, %147
  %150 = mul nuw nsw i64 %polly.indvar363, 5
  %pexp.p_div_q366 = lshr i64 %150, 4
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv810 = phi i64 [ %indvars.iv.next811, %polly.loop_exit375 ], [ %149, %polly.loop_header360 ]
  %indvars.iv805 = phi i64 [ %indvars.iv.next806, %polly.loop_exit375 ], [ %148, %polly.loop_header360 ]
  ...
  %153 = add i64 %smax807, %indvars.iv810
...
polly.loop_exit375:                               ; preds = %polly.loop_exit390.3, %polly.loop_header367
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar_next371, 19
...
polly.loop_header380:                             ; preds = %polly.loop_header367, %polly.loop_exit390
  %indvars.iv812 = phi i64 [ %indvars.iv.next813, %polly.loop_exit390 ], [ %153, %polly.loop_header367 ]
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %188 = shl nuw nsw i64 %indvars.iv824, 2
  %189 = and i64 %188, 9223372036854775744
  %190 = sub nsw i64 %indvars.iv822, %189
  %191 = add i64 %indvars.iv829, %189
  %192 = mul nuw nsw i64 %polly.indvar521, 5
  %pexp.p_div_q524 = lshr i64 %192, 4
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv831 = phi i64 [ %indvars.iv.next832, %polly.loop_exit533 ], [ %191, %polly.loop_header518 ]
  %indvars.iv826 = phi i64 [ %indvars.iv.next827, %polly.loop_exit533 ], [ %190, %polly.loop_header518 ]
  ...
  %195 = add i64 %smax828, %indvars.iv831
...
polly.loop_exit533:                               ; preds = %polly.loop_exit548.3, %polly.loop_header525
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar_next529, 19
...
polly.loop_header538:                             ; preds = %polly.loop_header525, %polly.loop_exit548
  %indvars.iv833 = phi i64 [ %indvars.iv.next834, %polly.loop_exit548 ], [ %195, %polly.loop_header525 ]
...
polly.loop_header223.1:                           ; preds = %polly.loop_exit232, %polly.loop_exit232.1
  %indvars.iv793.1 = phi i64 [ %indvars.iv.next794.1, %polly.loop_exit232.1 ], [ %111, %polly.loop_exit232 ]
  %polly.indvar226.1 = phi i64 [ %polly.indvar_next227.1, %polly.loop_exit232.1 ], [ %115, %polly.loop_exit232 ]
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv793.1, i64 19)
...
polly.loop_header223.2:                           ; preds = %polly.loop_exit232.1, %polly.loop_exit232.2
  %indvars.iv793.2 = phi i64 [ %indvars.iv.next794.2, %polly.loop_exit232.2 ], [ %111, %polly.loop_exit232.1 ]
  %polly.indvar226.2 = phi i64 [ %polly.indvar_next227.2, %polly.loop_exit232.2 ], [ %115, %polly.loop_exit232.1 ]
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv793.2, i64 19)
...
polly.loop_header223.3:                           ; preds = %polly.loop_exit232.2, %polly.loop_exit232.3
  %indvars.iv793.3 = phi i64 [ %indvars.iv.next794.3, %polly.loop_exit232.3 ], [ %111, %polly.loop_exit232.2 ]
  %polly.indvar226.3 = phi i64 [ %polly.indvar_next227.3, %polly.loop_exit232.3 ], [ %115, %polly.loop_exit232.2 ]
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv793.3, i64 19)
...
polly.loop_header380.1:                           ; preds = %polly.loop_exit390, %polly.loop_exit390.1
  %indvars.iv812.1 = phi i64 [ %indvars.iv.next813.1, %polly.loop_exit390.1 ], [ %153, %polly.loop_exit390 ]
  %polly.indvar384.1 = phi i64 [ %polly.indvar_next385.1, %polly.loop_exit390.1 ], [ %157, %polly.loop_exit390 ]
  %smin814.1 = call i64 @llvm.smin.i64(i64 %indvars.iv812.1, i64 19)
...
polly.loop_header388.1:                           ; preds = %polly.loop_header388.1, %polly.loop_header388.preheader.1
  ...
  %exitcond815.1.not = icmp eq i64 %polly.indvar392.1, %smin814.1
  br i1 %exitcond815.1.not, label %polly.loop_exit390.1, label %polly.loop_header388.1
...
polly.loop_exit390.1:                             ; preds = %polly.loop_header388.1, %polly.loop_header380.1
  ...
  %indvars.iv.next813.1 = add i64 %indvars.iv812.1, 1
...
polly.loop_header380.2:                           ; preds = %polly.loop_exit390.1, %polly.loop_exit390.2
  %indvars.iv812.2 = phi i64 [ %indvars.iv.next813.2, %polly.loop_exit390.2 ], [ %153, %polly.loop_exit390.1 ]
  %polly.indvar384.2 = phi i64 [ %polly.indvar_next385.2, %polly.loop_exit390.2 ], [ %157, %polly.loop_exit390.1 ]
  %smin814.2 = call i64 @llvm.smin.i64(i64 %indvars.iv812.2, i64 19)
...
polly.loop_header388.2:                           ; preds = %polly.loop_header388.2, %polly.loop_header388.preheader.2
  ...
  %exitcond815.2.not = icmp eq i64 %polly.indvar392.2, %smin814.2
  br i1 %exitcond815.2.not, label %polly.loop_exit390.2, label %polly.loop_header388.2
...
polly.loop_exit390.2:                             ; preds = %polly.loop_header388.2, %polly.loop_header380.2
  ...
  %indvars.iv.next813.2 = add i64 %indvars.iv812.2, 1
...
polly.loop_header380.3:                           ; preds = %polly.loop_exit390.2, %polly.loop_exit390.3
  %indvars.iv812.3 = phi i64 [ %indvars.iv.next813.3, %polly.loop_exit390.3 ], [ %153, %polly.loop_exit390.2 ]
  %polly.indvar384.3 = phi i64 [ %polly.indvar_next385.3, %polly.loop_exit390.3 ], [ %157, %polly.loop_exit390.2 ]
  %smin814.3 = call i64 @llvm.smin.i64(i64 %indvars.iv812.3, i64 19)
...
polly.loop_header388.3:                           ; preds = %polly.loop_header388.3, %polly.loop_header388.preheader.3
  ...
  %exitcond815.3.not = icmp eq i64 %polly.indvar392.3, %smin814.3
  br i1 %exitcond815.3.not, label %polly.loop_exit390.3, label %polly.loop_header388.3
...
polly.loop_exit390.3:                             ; preds = %polly.loop_header388.3, %polly.loop_header380.3
  ...
  %indvars.iv.next813.3 = add i64 %indvars.iv812.3, 1
...
polly.loop_header538.1:                           ; preds = %polly.loop_exit548, %polly.loop_exit548.1
  %indvars.iv833.1 = phi i64 [ %indvars.iv.next834.1, %polly.loop_exit548.1 ], [ %195, %polly.loop_exit548 ]
  %polly.indvar542.1 = phi i64 [ %polly.indvar_next543.1, %polly.loop_exit548.1 ], [ %199, %polly.loop_exit548 ]
  %smin835.1 = call i64 @llvm.smin.i64(i64 %indvars.iv833.1, i64 19)
...
polly.loop_header546.1:                           ; preds = %polly.loop_header546.1, %polly.loop_header546.preheader.1
  ...
  %exitcond836.1.not = icmp eq i64 %polly.indvar550.1, %smin835.1
  br i1 %exitcond836.1.not, label %polly.loop_exit548.1, label %polly.loop_header546.1
...
polly.loop_exit548.1:                             ; preds = %polly.loop_header546.1, %polly.loop_header538.1
  ...
  %indvars.iv.next834.1 = add i64 %indvars.iv833.1, 1
...
polly.loop_header538.2:                           ; preds = %polly.loop_exit548.1, %polly.loop_exit548.2
  %indvars.iv833.2 = phi i64 [ %indvars.iv.next834.2, %polly.loop_exit548.2 ], [ %195, %polly.loop_exit548.1 ]
  %polly.indvar542.2 = phi i64 [ %polly.indvar_next543.2, %polly.loop_exit548.2 ], [ %199, %polly.loop_exit548.1 ]
  %smin835.2 = call i64 @llvm.smin.i64(i64 %indvars.iv833.2, i64 19)
...
polly.loop_header546.2:                           ; preds = %polly.loop_header546.2, %polly.loop_header546.preheader.2
  ...
  %exitcond836.2.not = icmp eq i64 %polly.indvar550.2, %smin835.2
  br i1 %exitcond836.2.not, label %polly.loop_exit548.2, label %polly.loop_header546.2
...
polly.loop_exit548.2:                             ; preds = %polly.loop_header546.2, %polly.loop_header538.2
  ...
  %indvars.iv.next834.2 = add i64 %indvars.iv833.2, 1
...
polly.loop_header538.3:                           ; preds = %polly.loop_exit548.2, %polly.loop_exit548.3
  %indvars.iv833.3 = phi i64 [ %indvars.iv.next834.3, %polly.loop_exit548.3 ], [ %195, %polly.loop_exit548.2 ]
  %polly.indvar542.3 = phi i64 [ %polly.indvar_next543.3, %polly.loop_exit548.3 ], [ %199, %polly.loop_exit548.2 ]
  %smin835.3 = call i64 @llvm.smin.i64(i64 %indvars.iv833.3, i64 19)
...
polly.loop_header546.3:                           ; preds = %polly.loop_header546.3, %polly.loop_header546.preheader.3
  ...
  %exitcond836.3.not = icmp eq i64 %polly.indvar550.3, %smin835.3
  br i1 %exitcond836.3.not, label %polly.loop_exit548.3, label %polly.loop_header546.3
...
polly.loop_exit548.3:                             ; preds = %polly.loop_header546.3, %polly.loop_header538.3
  ...
  %indvars.iv.next834.3 = add i64 %indvars.iv833.3, 1
