; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10281.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10281.c"
...
polly.loop_exit364:                               ; preds = %polly.loop_exit372, %polly.loop_header354
  ...
  %exitcond821.not = icmp eq i64 %polly.indvar_next358, 15
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_exit372
  ...
  %133 = shl nsw i64 %polly.indvar366, 7
  %134 = add nsw i64 %133, %131
  %135 = icmp sgt i64 %134, 0
  %136 = select i1 %135, i64 %134, i64 0
  %polly.loop_guard373 = icmp slt i64 %136, 80
...
polly.loop_header520.preheader:                   ; preds = %polly.loop_header512
  %161 = mul nsw i64 %polly.indvar515, -80
  %162 = mul nuw nsw i64 %polly.indvar515, 80
...
polly.loop_exit522:                               ; preds = %polly.loop_exit530, %polly.loop_header512
  ...
  %indvars.iv.next830 = add nuw nsw i64 %indvars.iv829, 80
  %indvars.iv.next839 = add nuw nsw i64 %indvars.iv838, 1
  %indvars.iv.next841 = add nuw nsw i64 %indvars.iv840, 3
  %exitcond843.not = icmp eq i64 %polly.indvar_next516, 15
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit530
  ...
  %163 = shl nsw i64 %polly.indvar524, 7
  %164 = add nsw i64 %163, %161
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard531 = icmp slt i64 %166, 80
...
polly.loop_header528:                             ; preds = %polly.loop_header528.preheader, %polly.loop_exit537
  ...
  %smin835 = call i64 @llvm.smin.i64(i64 %indvars.iv833, i64 127)
