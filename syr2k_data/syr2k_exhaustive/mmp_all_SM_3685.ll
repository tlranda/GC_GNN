; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3685.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3685.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %98 = udiv i64 %polly.indvar208, 24
  ...
  %pexp.p_div_q889 = udiv i16 %pexp.p_div_q.lhs.trunc, 24
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1028.not = icmp eq i64 %108, 300
...
polly.loop_header211:                             ; preds = %polly.loop_exit248, %polly.loop_header205
  ...
  %110 = mul nuw nsw i64 %polly.indvar214, 24
  %.not.not = icmp ugt i64 %110, %polly.indvar208
  %111 = mul nuw nsw i64 %polly.indvar214, 96
  %112 = add nsw i64 %111, %103
  %113 = icmp sgt i64 %112, 0
  %114 = select i1 %113, i64 %112, i64 0
  %115 = add nsw i64 %112, 95
...
polly.loop_exit255:                               ; preds = %polly.loop_exit263
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar_next250, 50
...
polly.loop_header253:                             ; preds = %polly.loop_header246, %polly.loop_exit263
  %indvars.iv1024 = phi i64 [ %109, %polly.loop_header246 ], [ %indvars.iv.next1025, %polly.loop_exit263 ]
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %151 = udiv i64 %polly.indvar398, 24
  %152 = mul nuw nsw i64 %151, 96
  %153 = sub nsw i64 %indvars.iv1035, %152
  %154 = add i64 %indvars.iv1040, %152
  %pexp.p_div_q401.lhs.trunc = trunc i64 %polly.indvar398 to i16
  %pexp.p_div_q401888 = udiv i16 %pexp.p_div_q401.lhs.trunc, 24
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1049.not = icmp eq i64 %161, 300
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1042 = phi i64 [ %indvars.iv.next1043, %polly.loop_exit445 ], [ %154, %polly.loop_header395 ]
  %indvars.iv1037 = phi i64 [ %indvars.iv.next1038, %polly.loop_exit445 ], [ %153, %polly.loop_header395 ]
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %177 = mul nsw i64 %polly.indvar405, -96
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar_next447, 50
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1044 = phi i64 [ %162, %polly.loop_header443 ], [ %indvars.iv.next1045, %polly.loop_exit460 ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %204 = udiv i64 %polly.indvar595, 24
  %205 = mul nuw nsw i64 %204, 96
  %206 = sub nsw i64 %indvars.iv1056, %205
  %207 = add i64 %indvars.iv1061, %205
  %pexp.p_div_q598.lhs.trunc = trunc i64 %polly.indvar595 to i16
  %pexp.p_div_q598887 = udiv i16 %pexp.p_div_q598.lhs.trunc, 24
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1063 = phi i64 [ %indvars.iv.next1064, %polly.loop_exit642 ], [ %207, %polly.loop_header592 ]
  %indvars.iv1058 = phi i64 [ %indvars.iv.next1059, %polly.loop_exit642 ], [ %206, %polly.loop_header592 ]
  ...
  %215 = add i64 %smax1060, %indvars.iv1063
  %216 = mul nuw nsw i64 %polly.indvar602, 24
...
polly.loop_exit649:                               ; preds = %polly.loop_exit657
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next644, 50
...
polly.loop_header647:                             ; preds = %polly.loop_header640, %polly.loop_exit657
  %indvars.iv1065 = phi i64 [ %215, %polly.loop_header640 ], [ %indvars.iv.next1066, %polly.loop_exit657 ]
