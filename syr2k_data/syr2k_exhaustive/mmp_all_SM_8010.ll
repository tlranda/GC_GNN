; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8010.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8010.c"
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph964
  ...
  %wide.load971 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %129, label %middle.block958, label %vector.body960, !llvm.loop !76
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %131 = shl nsw i64 %polly.indvar355, 4
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %133 = shl nuw nsw i64 %polly.indvar361, 2
  %134 = shl nsw i64 %polly.indvar361, 4
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  %wide.load945 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %163, label %middle.block934, label %vector.body936, !llvm.loop !85
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit513
  ...
  %165 = shl nsw i64 %polly.indvar508, 4
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %167 = shl nuw nsw i64 %polly.indvar514, 2
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph876
  ...
  br i1 %211, label %polly.loop_exit702, label %vector.body874, !llvm.loop !94
...
vector.body889:                                   ; preds = %vector.body889, %vector.ph892
  ...
  br i1 %240, label %polly.loop_exit729, label %vector.body889, !llvm.loop !97
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  br i1 %269, label %polly.loop_exit755, label %vector.body907, !llvm.loop !100
