; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2452.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2452.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  %indvars.iv1054 = phi i64 [ %indvars.iv.next1055, %polly.loop_exit224 ], [ 24, %polly.loop_exit208 ]
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1055 = add nuw nsw i64 %indvars.iv1054, 25
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %104 = shl nuw nsw i64 %polly.indvar231, 8
  %105 = add i64 %97, %104
  %smax1360 = call i64 @llvm.smax.i64(i64 %105, i64 0)
  %106 = mul nsw i64 %polly.indvar231, -256
  %107 = add i64 %98, %106
  %108 = add i64 %smax1360, %107
  %109 = shl nsw i64 %polly.indvar231, 8
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1363 = call i64 @llvm.smin.i64(i64 %116, i64 255)
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  %indvars.iv1086 = phi i64 [ %indvars.iv.next1087, %polly.loop_exit428 ], [ 24, %polly.loop_exit412 ]
  ...
  %157 = lshr i64 %indvars.iv1086, 6
  %158 = mul nsw i64 %polly.indvar423, -100
...
polly.loop_exit428:                               ; preds = %polly.loop_exit435
  ...
  %indvars.iv.next1087 = add nuw nsw i64 %indvars.iv1086, 25
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %162 = shl nuw nsw i64 %polly.indvar436, 8
  %163 = add i64 %155, %162
  %smax1312 = call i64 @llvm.smax.i64(i64 %163, i64 0)
  %164 = mul nsw i64 %polly.indvar436, -256
  %165 = add i64 %156, %164
  %166 = add i64 %smax1312, %165
  %167 = shl nsw i64 %polly.indvar436, 8
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1315 = call i64 @llvm.smin.i64(i64 %174, i64 255)
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  %indvars.iv1118 = phi i64 [ %indvars.iv.next1119, %polly.loop_exit639 ], [ 24, %polly.loop_exit623 ]
  ...
  %215 = lshr i64 %indvars.iv1118, 6
  %216 = mul nsw i64 %polly.indvar634, -100
  %217 = mul nuw nsw i64 %polly.indvar634, 100
...
polly.loop_exit639:                               ; preds = %polly.loop_exit646
  ...
  %indvars.iv.next1119 = add nuw nsw i64 %indvars.iv1118, 25
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %220 = shl nuw nsw i64 %polly.indvar647, 8
  %221 = add i64 %213, %220
  %smax1264 = call i64 @llvm.smax.i64(i64 %221, i64 0)
  %222 = mul nsw i64 %polly.indvar647, -256
  %223 = add i64 %214, %222
  %224 = add i64 %smax1264, %223
  %225 = shl nsw i64 %polly.indvar647, 8
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1267 = call i64 @llvm.smin.i64(i64 %232, i64 255)
