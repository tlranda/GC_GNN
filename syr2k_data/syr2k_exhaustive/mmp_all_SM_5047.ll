; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5047.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5047.c"
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond1012.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !70
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin1005 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -920)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit220, %polly.loop_header205
  ...
  %exitcond1010.not = icmp eq i64 %polly.indvar_next209, 13
...
polly.loop_header375:                             ; preds = %polly.loop_header375.preheader, %polly.loop_header375
  ...
  br i1 %exitcond1042.not, label %polly.loop_exit377, label %polly.loop_header375, !llvm.loop !81
...
polly.loop_header391:                             ; preds = %polly.loop_exit401, %polly.loop_header385
  ...
  %smin1035 = call i64 @llvm.smin.i64(i64 %indvars.iv1014, i64 -920)
...
polly.loop_header399.preheader:                   ; preds = %polly.loop_header391
  %147 = mul nuw nsw i64 %polly.indvar394, 80
...
polly.loop_exit401:                               ; preds = %polly.loop_exit409, %polly.loop_header391
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next395, 13
...
polly.loop_header584:                             ; preds = %polly.loop_exit594, %polly.loop_header578
  ...
  %smin1065 = call i64 @llvm.smin.i64(i64 %indvars.iv1044, i64 -920)
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %188 = mul nuw nsw i64 %polly.indvar587, 80
...
vector.body1137:                                  ; preds = %vector.body1137, %vector.ph1138
  ...
  br i1 %232, label %polly.loop_exit813, label %vector.body1137, !llvm.loop !99
...
vector.body1151:                                  ; preds = %vector.body1151, %vector.ph1154
  ...
  br i1 %261, label %polly.loop_exit840, label %vector.body1151, !llvm.loop !102
...
vector.body1169:                                  ; preds = %vector.body1169, %vector.ph1172
  ...
  br i1 %290, label %polly.loop_exit866, label %vector.body1169, !llvm.loop !105
