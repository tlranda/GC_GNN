; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2773.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2773.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit244
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next203, 150
...
polly.loop_header205:                             ; preds = %polly.loop_exit244, %polly.loop_header199
  ...
  %.inv = icmp ugt i64 %101, 7
  %103 = select i1 %.inv, i64 7, i64 %102
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %138 = shl nuw nsw i64 %polly.indvar386, 1
  %139 = mul nsw i64 %polly.indvar386, -8
  %140 = shl nsw i64 %polly.indvar386, 3
  br label %polly.loop_header389

polly.loop_exit391:                               ; preds = %polly.loop_exit430
  %polly.indvar_next387 = add nuw nsw i64 %polly.indvar386, 1
  %exitcond903.not = icmp eq i64 %polly.indvar_next387, 150
...
polly.loop_header389:                             ; preds = %polly.loop_exit430, %polly.loop_header383
  ...
  %.inv857 = icmp ugt i64 %142, 7
  %144 = select i1 %.inv857, i64 7, i64 %143
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %179 = shl nuw nsw i64 %polly.indvar572, 1
  %180 = mul nsw i64 %polly.indvar572, -8
  %181 = shl nsw i64 %polly.indvar572, 3
...
polly.loop_exit577:                               ; preds = %polly.loop_exit616
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar_next573, 150
...
polly.loop_header575:                             ; preds = %polly.loop_exit616, %polly.loop_header569
  ...
  %.inv858 = icmp ugt i64 %183, 7
  %185 = select i1 %.inv858, i64 7, i64 %184
