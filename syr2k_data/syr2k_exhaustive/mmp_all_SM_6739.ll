; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6739.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6739.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %111 = mul nuw nsw i64 %polly.indvar224, 80
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1040
  ...
  %wide.load1047 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %129, label %middle.block1034, label %vector.body1036, !llvm.loop !79
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %131 = udiv i64 %polly.indvar391, 20
...
polly.loop_header394:                             ; preds = %polly.loop_exit403, %polly.loop_header388
  ...
  %145 = mul nuw nsw i64 %polly.indvar397, 80
...
polly.loop_header401:                             ; preds = %polly.loop_exit415.3, %polly.loop_header394
  ...
  %146 = mul nuw nsw i64 %polly.indvar404, 80
  %147 = sub nsw i64 %132, %146
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv849, i64 79)
...
polly.loop_exit415:                               ; preds = %polly.loop_exit422.loopexit.us, %polly.loop_header401
  ...
  %smin853.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next852, i64 79)
...
vector.body1012:                                  ; preds = %vector.body1012, %vector.ph1014
  ...
  %wide.load1021 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %163, label %middle.block1010, label %vector.body1012, !llvm.loop !89
...
polly.loop_header564:                             ; preds = %polly.loop_exit556, %polly.loop_exit572
  ...
  %165 = udiv i64 %polly.indvar567, 20
...
polly.loop_header570:                             ; preds = %polly.loop_exit579, %polly.loop_header564
  ...
  %179 = mul nuw nsw i64 %polly.indvar573, 80
...
polly.loop_header577:                             ; preds = %polly.loop_exit591.3, %polly.loop_header570
  ...
  %180 = mul nuw nsw i64 %polly.indvar580, 80
  %181 = sub nsw i64 %166, %180
  %smin873 = call i64 @llvm.smin.i64(i64 %indvars.iv869, i64 79)
...
polly.loop_exit591:                               ; preds = %polly.loop_exit598.loopexit.us, %polly.loop_header577
  ...
  %smin873.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next872, i64 79)
...
vector.body950:                                   ; preds = %vector.body950, %vector.ph952
  ...
  br i1 %211, label %polly.loop_exit766, label %vector.body950, !llvm.loop !98
...
vector.body965:                                   ; preds = %vector.body965, %vector.ph968
  ...
  br i1 %240, label %polly.loop_exit793, label %vector.body965, !llvm.loop !101
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph986
  ...
  br i1 %269, label %polly.loop_exit819, label %vector.body983, !llvm.loop !104
...
polly.loop_exit415.1:                             ; preds = %polly.loop_exit422.loopexit.us.1, %polly.loop_exit415
  ...
  %smin853.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next852.1, i64 79)
...
polly.loop_exit415.2:                             ; preds = %polly.loop_exit422.loopexit.us.2, %polly.loop_exit415.1
  ...
  %smin853.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next852.2, i64 79)
...
polly.loop_exit591.1:                             ; preds = %polly.loop_exit598.loopexit.us.1, %polly.loop_exit591
  ...
  %smin873.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next872.1, i64 79)
...
polly.loop_exit591.2:                             ; preds = %polly.loop_exit598.loopexit.us.2, %polly.loop_exit591.1
  ...
  %smin873.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next872.2, i64 79)
