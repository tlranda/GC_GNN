; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6121.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6121.c"
...
vector.body1077:                                  ; preds = %vector.body1077, %vector.ph1081
  ...
  %wide.load1088 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %138, label %middle.block1075, label %vector.body1077, !llvm.loop !84
...
polly.loop_header376:                             ; preds = %polly.loop_header376.preheader, %polly.loop_exit384
  ...
  %141 = shl nsw i64 %polly.indvar379, 6
...
polly.loop_header382:                             ; preds = %polly.loop_exit408, %polly.loop_header376
  ...
  %142 = shl nuw nsw i64 %indvars.iv891, 1
  %143 = and i64 %142, 9223372036854775744
  %144 = add i64 %indvars.iv889, %143
  %145 = sub nsw i64 %indvars.iv896, %143
  %146 = mul nuw nsw i64 %polly.indvar385, 50
  br label %polly.loop_header388

polly.loop_exit390:                               ; preds = %polly.loop_exit396
  %147 = mul nsw i64 %polly.indvar385, -50
...
vector.body1053:                                  ; preds = %vector.body1053, %vector.ph1055
  ...
  %wide.load1062 = load <4 x double>, <4 x double>* %178, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %181, label %middle.block1051, label %vector.body1053, !llvm.loop !94
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_exit564
  ...
  %184 = shl nsw i64 %polly.indvar559, 6
...
polly.loop_header562:                             ; preds = %polly.loop_exit588, %polly.loop_header556
  ...
  %185 = shl nuw nsw i64 %indvars.iv919, 1
...
polly.loop_exit570:                               ; preds = %polly.loop_exit576
  %190 = mul nsw i64 %polly.indvar565, -50
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph993
  ...
  br i1 %238, label %polly.loop_exit778, label %vector.body992, !llvm.loop !103
...
vector.body1006:                                  ; preds = %vector.body1006, %vector.ph1009
  ...
  br i1 %267, label %polly.loop_exit805, label %vector.body1006, !llvm.loop !106
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1027
  ...
  br i1 %296, label %polly.loop_exit831, label %vector.body1024, !llvm.loop !109
