; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9735.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9735.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %97 = mul nsw i64 %polly.indvar202, -20
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next786 = add nuw nsw i64 %indvars.iv785, 20
  %indvars.iv.next793 = add nuw nsw i64 %indvars.iv792, 5
  %exitcond796.not = icmp eq i64 %polly.indvar_next203, 60
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph994
  ...
  %wide.load1001 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %125, label %middle.block988, label %vector.body990, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %127 = mul nsw i64 %polly.indvar357, -20
  %128 = mul nuw nsw i64 %polly.indvar357, 20
...
polly.loop_exit362:                               ; preds = %polly.loop_exit368
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar_next358, 60
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %130 = shl nsw i64 %polly.indvar369, 2
  %131 = add nsw i64 %130, %127
  %132 = icmp sgt i64 %131, 0
  %133 = select i1 %132, i64 %131, i64 0
  %polly.loop_guard376 = icmp slt i64 %133, 20
...
polly.loop_exit382:                               ; preds = %polly.loop_exit389.loopexit.us, %polly.loop_header373
  ...
  %polly.loop_cond379 = icmp ult i64 %polly.indvar377, 19
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  %wide.load975 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %155, label %middle.block964, label %vector.body966, !llvm.loop !83
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %157 = mul nsw i64 %polly.indvar514, -20
  %158 = mul nuw nsw i64 %polly.indvar514, 20
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %indvars.iv.next826 = add nuw nsw i64 %indvars.iv825, 20
  %indvars.iv.next835 = add nuw nsw i64 %indvars.iv834, 5
  %exitcond838.not = icmp eq i64 %polly.indvar_next515, 60
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %160 = shl nsw i64 %polly.indvar526, 2
  %161 = add nsw i64 %160, %157
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %polly.loop_guard533 = icmp slt i64 %163, 20
...
polly.loop_exit539:                               ; preds = %polly.loop_exit546.loopexit.us, %polly.loop_header530
  ...
  %polly.loop_cond536 = icmp ult i64 %polly.indvar534, 19
...
vector.body904:                                   ; preds = %vector.body904, %vector.ph906
  ...
  br i1 %199, label %polly.loop_exit712, label %vector.body904, !llvm.loop !92
...
vector.body919:                                   ; preds = %vector.body919, %vector.ph922
  ...
  br i1 %228, label %polly.loop_exit739, label %vector.body919, !llvm.loop !95
...
vector.body937:                                   ; preds = %vector.body937, %vector.ph940
  ...
  br i1 %257, label %polly.loop_exit765, label %vector.body937, !llvm.loop !98
