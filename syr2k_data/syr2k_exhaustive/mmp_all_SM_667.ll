; ModuleID = 'syr2k_exhaustive/mmp_all_SM_667.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_667.c"
...
vector.body1401:                                  ; preds = %vector.body1401, %vector.ph1409
  ...
  %wide.load1422 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %161, label %middle.block1399, label %vector.body1401, !llvm.loop !84
...
vector.body1337:                                  ; preds = %vector.body1337, %vector.ph1341
  ...
  %wide.load1348 = load <4 x double>, <4 x double>* %167, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %170, label %middle.block1335, label %vector.body1337, !llvm.loop !92
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit422
  ...
  %172 = mul nuw nsw i64 %polly.indvar417, 50
...
vector.body1351:                                  ; preds = %vector.body1351, %vector.ph1359
  ...
  %wide.load1372 = load <4 x double>, <4 x double>* %231, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %236, label %middle.block1349, label %vector.body1351, !llvm.loop !97
...
vector.body1289:                                  ; preds = %vector.body1289, %vector.ph1291
  ...
  %wide.load1298 = load <4 x double>, <4 x double>* %242, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %245, label %middle.block1287, label %vector.body1289, !llvm.loop !105
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit639
  ...
  %247 = mul nuw nsw i64 %polly.indvar634, 50
...
vector.body1301:                                  ; preds = %vector.body1301, %vector.ph1309
  ...
  %wide.load1322 = load <4 x double>, <4 x double>* %306, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %311, label %middle.block1299, label %vector.body1301, !llvm.loop !110
...
vector.body1227:                                  ; preds = %vector.body1227, %vector.ph1229
  ...
  br i1 %334, label %polly.loop_exit888, label %vector.body1227, !llvm.loop !116
...
vector.body1242:                                  ; preds = %vector.body1242, %vector.ph1245
  ...
  br i1 %363, label %polly.loop_exit915, label %vector.body1242, !llvm.loop !119
...
vector.body1260:                                  ; preds = %vector.body1260, %vector.ph1263
  ...
  br i1 %392, label %polly.loop_exit941, label %vector.body1260, !llvm.loop !122
