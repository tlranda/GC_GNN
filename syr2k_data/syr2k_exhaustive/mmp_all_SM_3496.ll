; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3496.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3496.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1012 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -872)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar_next203, 8
...
vector.body1221:                                  ; preds = %vector.body1221, %vector.ph1225
  ...
  %wide.load1232 = load <4 x double>, <4 x double>* %133, align 8, !alias.scope !78, !noalias !80
  ...
  store <4 x double> %134, <4 x double>* %135, align 8, !alias.scope !78, !noalias !80
  %index.next1229 = add i64 %index1228, 4
  %136 = icmp eq i64 %index.next1229, %n.vec1227
  br i1 %136, label %middle.block1219, label %vector.body1221, !llvm.loop !84
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit397
  ...
  %smin1039 = call i64 @llvm.smin.i64(i64 %indvars.iv1019, i64 -872)
  %138 = add nsw i64 %smin1039, 1000
  %139 = shl nsw i64 %polly.indvar392, 7
...
polly.loop_exit397:                               ; preds = %polly.loop_exit403
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next393, 8
...
polly.start479:                                   ; preds = %init_array.exit
  %malloccall481 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1199
  ...
  %wide.load1206 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !88, !noalias !90
  ...
  store <4 x double> %175, <4 x double>* %176, align 8, !alias.scope !88, !noalias !90
  %index.next1203 = add i64 %index1202, 4
  %177 = icmp eq i64 %index.next1203, %n.vec1201
  br i1 %177, label %middle.block1195, label %vector.body1197, !llvm.loop !94
...
polly.loop_header581:                             ; preds = %polly.loop_header581.preheader, %polly.loop_exit589
  ...
  %smin1066 = call i64 @llvm.smin.i64(i64 %indvars.iv1046, i64 -872)
  %179 = add nsw i64 %smin1066, 1000
  %180 = shl nsw i64 %polly.indvar584, 7
...
polly.loop_exit589:                               ; preds = %polly.loop_exit595
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar_next585, 8
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1137
  ...
  store <4 x double> %226, <4 x double>* %231, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %232, label %polly.loop_exit815, label %vector.body1136, !llvm.loop !103
...
vector.body1150:                                  ; preds = %vector.body1150, %vector.ph1153
  ...
  store <4 x double> %255, <4 x double>* %260, align 8, !alias.scope !102, !noalias !105
  ...
  br i1 %261, label %polly.loop_exit842, label %vector.body1150, !llvm.loop !106
...
vector.body1168:                                  ; preds = %vector.body1168, %vector.ph1171
  ...
  store <4 x double> %284, <4 x double>* %289, align 8, !alias.scope !101, !noalias !108
  ...
  br i1 %290, label %polly.loop_exit868, label %vector.body1168, !llvm.loop !109
