; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7253.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7253.c"
...
polly.loop_header384:                             ; preds = %polly.loop_exit376, %polly.loop_exit392
  ...
  %119 = shl nsw i64 %polly.indvar387, 5
...
polly.loop_exit392:                               ; preds = %polly.loop_exit398
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next388, 38
...
polly.loop_header390:                             ; preds = %polly.loop_exit398, %polly.loop_header384
  ...
  %121 = shl nsw i64 %polly.indvar393, 5
...
polly.loop_header555:                             ; preds = %polly.loop_exit547, %polly.loop_exit563
  ...
  %141 = shl nsw i64 %polly.indvar558, 5
...
polly.loop_exit563:                               ; preds = %polly.loop_exit569
  ...
  %indvars.iv.next856 = add nuw nsw i64 %indvars.iv855, 32
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, -32
  %indvars.iv.next869 = add nuw nsw i64 %indvars.iv868, 1
  %exitcond871.not = icmp eq i64 %polly.indvar_next559, 38
...
polly.loop_header561:                             ; preds = %polly.loop_exit569, %polly.loop_header555
  ...
  %143 = shl nsw i64 %polly.indvar564, 5
