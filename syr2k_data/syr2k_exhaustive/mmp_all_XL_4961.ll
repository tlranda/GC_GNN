; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4961.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4961.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv988, i64 276)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next989 = add nuw nsw i64 %indvars.iv988, 24
...
polly.loop_header217.preheader:                   ; preds = %polly.loop_header211
  ...
  %118 = add i64 %smax, %indvars.iv979
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  %indvars.iv981 = phi i64 [ %118, %polly.loop_header217.preheader ], [ %indvars.iv.next982, %polly.loop_exit250 ]
  ...
  %polly.loop_guard2331081 = icmp sgt i64 %121, -1
...
vector.body1189:                                  ; preds = %vector.body1189, %vector.ph1193
  ...
  %136 = shl nuw nsw i64 %index1196, 3
  %137 = getelementptr i8, i8* %scevgep379, i64 %136
  %138 = bitcast i8* %137 to <4 x double>*
  %wide.load1200 = load <4 x double>, <4 x double>* %138, align 8, !alias.scope !73, !noalias !75
  %139 = fmul fast <4 x double> %wide.load1200, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %141 = icmp eq i64 %index.next1197, %n.vec1195
  br i1 %141, label %middle.block1187, label %vector.body1189, !llvm.loop !79

middle.block1187:                                 ; preds = %vector.body1189
  %cmp.n1199 = icmp eq i64 %134, %n.vec1195
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %umin1015 = call i64 @llvm.umin.i64(i64 %indvars.iv1013, i64 276)
  %143 = mul nsw i64 %polly.indvar386, -96
  %144 = icmp slt i64 %143, -1104
  %145 = select i1 %144, i64 %143, i64 -1104
  %146 = add nsw i64 %145, 1199
  %147 = mul nuw nsw i64 %polly.indvar386, 96
  %148 = add nuw nsw i64 %umin1015, 23
...
polly.loop_exit391:                               ; preds = %polly.loop_exit397
  ...
  %indvars.iv.next1014 = add nuw nsw i64 %indvars.iv1013, 24
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %160 = shl nsw i64 %polly.indvar398, 2
...
polly.loop_header402.preheader:                   ; preds = %polly.loop_header395
  ...
  %164 = add i64 %smax1000, %indvars.iv1003
  %165 = sub nsw i64 %147, %160
  %166 = add nuw nsw i64 %160, 4
...
polly.loop_exit404:                               ; preds = %polly.loop_exit440, %polly.loop_header395
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar398, %148
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_exit440
  %indvars.iv1005 = phi i64 [ %164, %polly.loop_header402.preheader ], [ %indvars.iv.next1006, %polly.loop_exit440 ]
  ...
  %polly.loop_guard4191082 = icmp sgt i64 %167, -1
  %168 = add nuw nsw i64 %polly.indvar406, %147
  %.not865 = icmp ult i64 %168, %166
  %polly.access.mul.call1432 = mul nsw i64 %168, 1000
...
polly.loop_header416.us:                          ; preds = %polly.loop_header402, %polly.loop_header416.us
  ...
  %polly.access.mul.call1424.us = mul nuw nsw i64 %170, 1000
...
polly.loop_header409.preheader:                   ; preds = %polly.loop_header402.split
  ...
  %polly.access.add.Packed_MemRef_call1284436.1 = add nsw i64 %167, 1200
  ...
  %polly.access.add.Packed_MemRef_call1284436.2 = add nsw i64 %167, 2400
  ...
  %polly.access.add.Packed_MemRef_call1284436.3 = add nsw i64 %167, 3600
...
polly.loop_exit447.loopexit.us:                   ; preds = %polly.loop_header445.us
  ...
  %polly.access.add.Packed_MemRef_call1284463.us.1 = add nsw i64 %167, 1200
...
polly.loop_header557:                             ; preds = %polly.loop_exit565, %polly.start471
  ...
  %min.iters.check1166 = icmp ult i64 %180, 4
...
vector.body1165:                                  ; preds = %vector.body1165, %vector.ph1167
  ...
  %182 = shl nuw nsw i64 %index1170, 3
  %183 = getelementptr i8, i8* %scevgep569, i64 %182
  %184 = bitcast i8* %183 to <4 x double>*
  %wide.load1174 = load <4 x double>, <4 x double>* %184, align 8, !alias.scope !83, !noalias !85
  %185 = fmul fast <4 x double> %wide.load1174, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %186 = bitcast i8* %183 to <4 x double>*
  store <4 x double> %185, <4 x double>* %186, align 8, !alias.scope !83, !noalias !85
  %index.next1171 = add i64 %index1170, 4
  %187 = icmp eq i64 %index.next1171, %n.vec1169
  br i1 %187, label %middle.block1163, label %vector.body1165, !llvm.loop !89

middle.block1163:                                 ; preds = %vector.body1165
  %cmp.n1173 = icmp eq i64 %180, %n.vec1169
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %umin1041 = call i64 @llvm.umin.i64(i64 %indvars.iv1039, i64 276)
  %189 = mul nsw i64 %polly.indvar576, -96
  %190 = icmp slt i64 %189, -1104
  %191 = select i1 %190, i64 %189, i64 -1104
  %192 = add nsw i64 %191, 1199
  %193 = mul nuw nsw i64 %polly.indvar576, 96
  %194 = add nuw nsw i64 %umin1041, 23
...
polly.loop_exit581:                               ; preds = %polly.loop_exit587
  ...
  %indvars.iv.next1040 = add nuw nsw i64 %indvars.iv1039, 24
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %206 = shl nsw i64 %polly.indvar588, 2
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header585
  ...
  %210 = add i64 %smax1026, %indvars.iv1029
  %211 = sub nsw i64 %193, %206
  %212 = add nuw nsw i64 %206, 4
...
polly.loop_exit594:                               ; preds = %polly.loop_exit630, %polly.loop_header585
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar588, %194
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit630
  %indvars.iv1031 = phi i64 [ %210, %polly.loop_header592.preheader ], [ %indvars.iv.next1032, %polly.loop_exit630 ]
  ...
  %polly.loop_guard6091083 = icmp sgt i64 %213, -1
  %214 = add nuw nsw i64 %polly.indvar596, %193
  %.not866 = icmp ult i64 %214, %212
  %polly.access.mul.call1622 = mul nsw i64 %214, 1000
...
polly.loop_header606.us:                          ; preds = %polly.loop_header592, %polly.loop_header606.us
  ...
  %polly.access.mul.call1614.us = mul nuw nsw i64 %216, 1000
...
polly.loop_header599.preheader:                   ; preds = %polly.loop_header592.split
  ...
  %polly.access.add.Packed_MemRef_call1474626.1 = add nsw i64 %213, 1200
  ...
  %polly.access.add.Packed_MemRef_call1474626.2 = add nsw i64 %213, 2400
  ...
  %polly.access.add.Packed_MemRef_call1474626.3 = add nsw i64 %213, 3600
...
polly.loop_exit637.loopexit.us:                   ; preds = %polly.loop_header635.us
  ...
  %polly.access.add.Packed_MemRef_call1474653.us.1 = add nsw i64 %213, 1200
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %228 = mul nsw i64 %polly.indvar794, -32
  ...
  %230 = shl nsw i64 %polly.indvar794, 5
  %231 = add nsw i64 %smin1069, 1199
...
polly.loop_header797:                             ; preds = %polly.loop_exit805, %polly.loop_header791
  ...
  %232 = add nuw nsw i64 %polly.indvar800, %226
...
vector.ph1105:                                    ; preds = %polly.loop_header797
  %broadcast.splatinsert1112 = insertelement <4 x i64> poison, i64 %230, i32 0
  %broadcast.splat1113 = shufflevector <4 x i64> %broadcast.splatinsert1112, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1114 = insertelement <4 x i32> poison, i32 %233, i32 0
...
vector.body1104:                                  ; preds = %vector.body1104, %vector.ph1105
  ...
  %235 = add nuw nsw <4 x i64> %vec.ind1110, %broadcast.splat1113
  %236 = trunc <4 x i64> %235 to <4 x i32>
  %237 = mul <4 x i32> %broadcast.splat1115, %236
  ...
  store <4 x double> %241, <4 x double>* %246, align 8, !alias.scope !93, !noalias !95
  %index.next1107 = add i64 %index1106, 4
  %vec.ind.next1111 = add <4 x i64> %vec.ind1110, <i64 4, i64 4, i64 4, i64 4>
  %247 = icmp eq i64 %index.next1107, %229
  br i1 %247, label %polly.loop_exit805, label %vector.body1104, !llvm.loop !98

polly.loop_exit805:                               ; preds = %vector.body1104, %polly.loop_header803
  %polly.indvar_next801 = add nuw nsw i64 %polly.indvar800, 1
  %exitcond1074.not = icmp eq i64 %polly.indvar800, %227
...
polly.loop_header803:                             ; preds = %polly.loop_header797, %polly.loop_header803
  ...
  %248 = add nuw nsw i64 %polly.indvar806, %230
  ...
  %scevgep809 = getelementptr i8, i8* %call, i64 %254
  ...
  %exitcond1070.not = icmp eq i64 %polly.indvar806, %231
...
polly.loop_header812:                             ; preds = %polly.loop_exit793, %polly.loop_exit820
  ...
  %255 = shl nsw i64 %polly.indvar815, 5
  %256 = add nsw i64 %smin1063, 1199
...
polly.loop_header818:                             ; preds = %polly.loop_exit826, %polly.loop_header812
  ...
  %257 = mul nsw i64 %polly.indvar821, -32
  %smin1119 = call i64 @llvm.smin.i64(i64 %257, i64 -968)
  %258 = add nsw i64 %smin1119, 1000
  %smin1059 = call i64 @llvm.smin.i64(i64 %indvars.iv1057, i64 -968)
  %259 = shl nsw i64 %polly.indvar821, 5
  %260 = add nsw i64 %smin1059, 999
...
vector.body1118:                                  ; preds = %vector.body1118, %vector.ph1121
  ...
  %264 = add nuw nsw <4 x i64> %vec.ind1128, %broadcast.splat1131
  %265 = trunc <4 x i64> %264 to <4 x i32>
  %266 = mul <4 x i32> %broadcast.splat1133, %265
  ...
  store <4 x double> %270, <4 x double>* %275, align 8, !alias.scope !97, !noalias !100
  %index.next1125 = add i64 %index1124, 4
  %vec.ind.next1129 = add <4 x i64> %vec.ind1128, <i64 4, i64 4, i64 4, i64 4>
  %276 = icmp eq i64 %index.next1125, %258
  br i1 %276, label %polly.loop_exit832, label %vector.body1118, !llvm.loop !101

polly.loop_exit832:                               ; preds = %vector.body1118, %polly.loop_header830
  %polly.indvar_next828 = add nuw nsw i64 %polly.indvar827, 1
  %exitcond1064.not = icmp eq i64 %polly.indvar827, %256
...
polly.loop_header830:                             ; preds = %polly.loop_header824, %polly.loop_header830
  ...
  %277 = add nuw nsw i64 %polly.indvar833, %259
  ...
  %scevgep836 = getelementptr i8, i8* %call2, i64 %283
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar833, %260
...
polly.loop_header838:                             ; preds = %polly.loop_exit820, %polly.loop_exit846
  ...
  %284 = shl nsw i64 %polly.indvar841, 5
  %285 = add nsw i64 %smin1053, 1199
...
polly.loop_header844:                             ; preds = %polly.loop_exit852, %polly.loop_header838
  ...
  %286 = mul nsw i64 %polly.indvar847, -32
  %smin1137 = call i64 @llvm.smin.i64(i64 %286, i64 -968)
  %287 = add nsw i64 %smin1137, 1000
  %smin1049 = call i64 @llvm.smin.i64(i64 %indvars.iv1047, i64 -968)
  %288 = shl nsw i64 %polly.indvar847, 5
  %289 = add nsw i64 %smin1049, 999
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  %293 = add nuw nsw <4 x i64> %vec.ind1146, %broadcast.splat1149
  %294 = trunc <4 x i64> %293 to <4 x i32>
  %295 = mul <4 x i32> %broadcast.splat1151, %294
  ...
  store <4 x double> %299, <4 x double>* %304, align 8, !alias.scope !96, !noalias !103
  %index.next1143 = add i64 %index1142, 4
  %vec.ind.next1147 = add <4 x i64> %vec.ind1146, <i64 4, i64 4, i64 4, i64 4>
  %305 = icmp eq i64 %index.next1143, %287
  br i1 %305, label %polly.loop_exit858, label %vector.body1136, !llvm.loop !104

polly.loop_exit858:                               ; preds = %vector.body1136, %polly.loop_header856
  %polly.indvar_next854 = add nuw nsw i64 %polly.indvar853, 1
  %exitcond1054.not = icmp eq i64 %polly.indvar853, %285
...
polly.loop_header856:                             ; preds = %polly.loop_header850, %polly.loop_header856
  ...
  %306 = add nuw nsw i64 %polly.indvar859, %288
  ...
  %scevgep863 = getelementptr i8, i8* %call1, i64 %312
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar859, %289
...
polly.loop_header416.us.1:                        ; preds = %polly.loop_header416.us.1.preheader, %polly.loop_header416.us.1
  ...
  %333 = add nuw nsw i64 %polly.indvar420.us.1, %160
  %polly.access.mul.call1424.us.1 = mul nuw nsw i64 %333, 1000
...
polly.then429.us.1:                               ; preds = %polly.cond427.loopexit.us.1
  ...
  %polly.access.add.Packed_MemRef_call1284436.us.1 = add nsw i64 %167, 1200
...
polly.loop_header416.us.2:                        ; preds = %polly.loop_header416.us.2.preheader, %polly.loop_header416.us.2
  ...
  %334 = add nuw nsw i64 %polly.indvar420.us.2, %160
  %polly.access.mul.call1424.us.2 = mul nuw nsw i64 %334, 1000
...
polly.then429.us.2:                               ; preds = %polly.cond427.loopexit.us.2
  ...
  %polly.access.add.Packed_MemRef_call1284436.us.2 = add nsw i64 %167, 2400
...
polly.loop_header416.us.3:                        ; preds = %polly.loop_header416.us.3.preheader, %polly.loop_header416.us.3
  ...
  %335 = add nuw nsw i64 %polly.indvar420.us.3, %160
  %polly.access.mul.call1424.us.3 = mul nuw nsw i64 %335, 1000
...
polly.then429.us.3:                               ; preds = %polly.cond427.loopexit.us.3
  ...
  %polly.access.add.Packed_MemRef_call1284436.us.3 = add nsw i64 %167, 3600
...
polly.loop_header445.us.1:                        ; preds = %polly.loop_header445.us.1, %polly.loop_exit447.loopexit.us
  ...
  %336 = add nuw nsw i64 %polly.indvar449.us.1, %160
  ...
  %scevgep459.us.1 = getelementptr i8, i8* %call2, i64 %338
  ...
  %339 = shl i64 %336, 3
  %340 = add i64 %339, %172
  %scevgep466.us.1 = getelementptr i8, i8* %call, i64 %340
...
polly.loop_exit447.loopexit.us.1:                 ; preds = %polly.loop_header445.us.1
  %341 = add i64 %157, %171
  %scevgep456.us.2 = getelementptr i8, i8* %call2, i64 %341
  ...
  %polly.access.add.Packed_MemRef_call1284463.us.2 = add nsw i64 %167, 2400
...
polly.loop_header445.us.2:                        ; preds = %polly.loop_header445.us.2, %polly.loop_exit447.loopexit.us.1
  ...
  %342 = add nuw nsw i64 %polly.indvar449.us.2, %160
  ...
  %scevgep459.us.2 = getelementptr i8, i8* %call2, i64 %344
  ...
  %345 = shl i64 %342, 3
  %346 = add i64 %345, %172
  %scevgep466.us.2 = getelementptr i8, i8* %call, i64 %346
...
polly.loop_exit447.loopexit.us.2:                 ; preds = %polly.loop_header445.us.2
  %347 = add i64 %159, %171
  %scevgep456.us.3 = getelementptr i8, i8* %call2, i64 %347
  ...
  %polly.access.add.Packed_MemRef_call1284463.us.3 = add nsw i64 %167, 3600
...
polly.loop_header445.us.3:                        ; preds = %polly.loop_header445.us.3, %polly.loop_exit447.loopexit.us.2
  ...
  %348 = add nuw nsw i64 %polly.indvar449.us.3, %160
  ...
  %scevgep459.us.3 = getelementptr i8, i8* %call2, i64 %350
  ...
  %351 = shl i64 %348, 3
  %352 = add i64 %351, %172
  %scevgep466.us.3 = getelementptr i8, i8* %call, i64 %352
...
polly.loop_header606.us.1:                        ; preds = %polly.loop_header606.us.1.preheader, %polly.loop_header606.us.1
  ...
  %353 = add nuw nsw i64 %polly.indvar610.us.1, %206
  %polly.access.mul.call1614.us.1 = mul nuw nsw i64 %353, 1000
...
polly.then619.us.1:                               ; preds = %polly.cond617.loopexit.us.1
  ...
  %polly.access.add.Packed_MemRef_call1474626.us.1 = add nsw i64 %213, 1200
...
polly.loop_header606.us.2:                        ; preds = %polly.loop_header606.us.2.preheader, %polly.loop_header606.us.2
  ...
  %354 = add nuw nsw i64 %polly.indvar610.us.2, %206
  %polly.access.mul.call1614.us.2 = mul nuw nsw i64 %354, 1000
...
polly.then619.us.2:                               ; preds = %polly.cond617.loopexit.us.2
  ...
  %polly.access.add.Packed_MemRef_call1474626.us.2 = add nsw i64 %213, 2400
...
polly.loop_header606.us.3:                        ; preds = %polly.loop_header606.us.3.preheader, %polly.loop_header606.us.3
  ...
  %355 = add nuw nsw i64 %polly.indvar610.us.3, %206
  %polly.access.mul.call1614.us.3 = mul nuw nsw i64 %355, 1000
...
polly.then619.us.3:                               ; preds = %polly.cond617.loopexit.us.3
  ...
  %polly.access.add.Packed_MemRef_call1474626.us.3 = add nsw i64 %213, 3600
...
polly.loop_header635.us.1:                        ; preds = %polly.loop_header635.us.1, %polly.loop_exit637.loopexit.us
  ...
  %356 = add nuw nsw i64 %polly.indvar639.us.1, %206
  ...
  %scevgep649.us.1 = getelementptr i8, i8* %call2, i64 %358
  ...
  %359 = shl i64 %356, 3
  %360 = add i64 %359, %218
  %scevgep656.us.1 = getelementptr i8, i8* %call, i64 %360
...
polly.loop_exit637.loopexit.us.1:                 ; preds = %polly.loop_header635.us.1
  %361 = add i64 %203, %217
  %scevgep646.us.2 = getelementptr i8, i8* %call2, i64 %361
  ...
  %polly.access.add.Packed_MemRef_call1474653.us.2 = add nsw i64 %213, 2400
...
polly.loop_header635.us.2:                        ; preds = %polly.loop_header635.us.2, %polly.loop_exit637.loopexit.us.1
  ...
  %362 = add nuw nsw i64 %polly.indvar639.us.2, %206
  ...
  %scevgep649.us.2 = getelementptr i8, i8* %call2, i64 %364
  ...
  %365 = shl i64 %362, 3
  %366 = add i64 %365, %218
  %scevgep656.us.2 = getelementptr i8, i8* %call, i64 %366
...
polly.loop_exit637.loopexit.us.2:                 ; preds = %polly.loop_header635.us.2
  %367 = add i64 %205, %217
  %scevgep646.us.3 = getelementptr i8, i8* %call2, i64 %367
  ...
  %polly.access.add.Packed_MemRef_call1474653.us.3 = add nsw i64 %213, 3600
...
polly.loop_header635.us.3:                        ; preds = %polly.loop_header635.us.3, %polly.loop_exit637.loopexit.us.2
  ...
  %368 = add nuw nsw i64 %polly.indvar639.us.3, %206
  ...
  %scevgep649.us.3 = getelementptr i8, i8* %call2, i64 %370
  ...
  %371 = shl i64 %368, 3
  %372 = add i64 %371, %218
  %scevgep656.us.3 = getelementptr i8, i8* %call, i64 %372
