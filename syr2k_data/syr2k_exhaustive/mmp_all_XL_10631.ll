; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10631.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10631.c"
...
polly.loop_header205.us:                          ; preds = %polly.loop_header199, %polly.loop_exit213.loopexit.us
  ...
  %107 = shl nsw i64 %polly.indvar208.us, 7
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %109 = mul nsw i64 %polly.indvar214.us, 80
...
polly.loop_exit213.loopexit.us:                   ; preds = %polly.loop_exit220.us
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar_next209.us, 8
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213.loopexit.us, %polly.loop_header199
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar_next203, 10
...
vector.body1105:                                  ; preds = %vector.body1105, %vector.ph1109
  ...
  %wide.load1116 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %134, label %middle.block1103, label %vector.body1105, !llvm.loop !73
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %pexp.p_div_q368 = udiv i64 %137, 5
  %138 = sub nsw i64 %136, %pexp.p_div_q368
  %139 = add nsw i64 %138, 1
  %.inv780 = icmp slt i64 %138, 14
  %140 = select i1 %.inv780, i64 %139, i64 14
  %polly.loop_guard373 = icmp sgt i64 %140, -1
  %141 = mul nsw i64 %polly.indvar359, -128
  %142 = icmp slt i64 %141, -1072
  %143 = select i1 %142, i64 %141, i64 -1072
  %144 = add nsw i64 %143, 1199
  %145 = shl nsw i64 %polly.indvar359, 7
...
polly.loop_header362.us:                          ; preds = %polly.loop_header356, %polly.loop_exit372.loopexit.us
  ...
  %smin927 = call i64 @llvm.smin.i64(i64 %indvars.iv925, i64 -872)
  %146 = shl nsw i64 %polly.indvar365.us, 7
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %148 = mul nsw i64 %polly.indvar374.us, 80
...
polly.loop_exit372.loopexit.us:                   ; preds = %polly.loop_exit380.us
  ...
  %indvars.iv.next926 = add nsw i64 %indvars.iv925, -128
  %exitcond930.not = icmp eq i64 %polly.indvar_next366.us, 8
...
polly.loop_exit364:                               ; preds = %polly.loop_exit372.loopexit.us, %polly.loop_header356
  ...
  %indvars.iv.next918 = add nuw nsw i64 %indvars.iv917, 128
  %exitcond931.not = icmp eq i64 %polly.indvar_next360, 10
...
vector.body1081:                                  ; preds = %vector.body1081, %vector.ph1083
  ...
  %wide.load1090 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %173, label %middle.block1079, label %vector.body1081, !llvm.loop !82
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %pexp.p_div_q528 = udiv i64 %176, 5
  %177 = sub nsw i64 %175, %pexp.p_div_q528
  %178 = add nsw i64 %177, 1
  %.inv781 = icmp slt i64 %177, 14
  %179 = select i1 %.inv781, i64 %178, i64 14
  %polly.loop_guard533 = icmp sgt i64 %179, -1
  %180 = mul nsw i64 %polly.indvar519, -128
  %181 = icmp slt i64 %180, -1072
  %182 = select i1 %181, i64 %180, i64 -1072
  %183 = add nsw i64 %182, 1199
  %184 = shl nsw i64 %polly.indvar519, 7
...
polly.loop_header522.us:                          ; preds = %polly.loop_header516, %polly.loop_exit532.loopexit.us
  ...
  %smin949 = call i64 @llvm.smin.i64(i64 %indvars.iv947, i64 -872)
  %185 = shl nsw i64 %polly.indvar525.us, 7
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %187 = mul nsw i64 %polly.indvar534.us, 80
...
polly.loop_exit532.loopexit.us:                   ; preds = %polly.loop_exit540.us
  ...
  %exitcond952.not = icmp eq i64 %polly.indvar_next526.us, 8
...
polly.loop_exit524:                               ; preds = %polly.loop_exit532.loopexit.us, %polly.loop_header516
  ...
  %indvars.iv.next935 = add nsw i64 %indvars.iv934, -128
  %indvars.iv.next940 = add nuw nsw i64 %indvars.iv939, 128
  %exitcond953.not = icmp eq i64 %polly.indvar_next520, 10
...
vector.body1019:                                  ; preds = %vector.body1019, %vector.ph1021
  ...
  br i1 %226, label %polly.loop_exit720, label %vector.body1019, !llvm.loop !91
...
vector.body1034:                                  ; preds = %vector.body1034, %vector.ph1037
  ...
  br i1 %255, label %polly.loop_exit747, label %vector.body1034, !llvm.loop !94
...
vector.body1052:                                  ; preds = %vector.body1052, %vector.ph1055
  ...
  br i1 %284, label %polly.loop_exit773, label %vector.body1052, !llvm.loop !97
