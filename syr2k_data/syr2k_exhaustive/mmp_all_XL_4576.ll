; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4576.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4576.c"
...
vector.body1210:                                  ; preds = %vector.body1210, %vector.ph1214
  ...
  %wide.load1221 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %133, label %middle.block1208, label %vector.body1210, !llvm.loop !80
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1188
  ...
  %wide.load1195 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %171, label %middle.block1184, label %vector.body1186, !llvm.loop !90
...
vector.body1125:                                  ; preds = %vector.body1125, %vector.ph1126
  ...
  br i1 %223, label %polly.loop_exit805, label %vector.body1125, !llvm.loop !99
...
vector.body1139:                                  ; preds = %vector.body1139, %vector.ph1142
  ...
  br i1 %252, label %polly.loop_exit832, label %vector.body1139, !llvm.loop !102
...
vector.body1157:                                  ; preds = %vector.body1157, %vector.ph1160
  ...
  br i1 %281, label %polly.loop_exit858, label %vector.body1157, !llvm.loop !105
