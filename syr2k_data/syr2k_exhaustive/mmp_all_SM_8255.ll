; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8255.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8255.c"
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph914
  ...
  br i1 %220, label %polly.loop_exit714, label %vector.body912, !llvm.loop !94
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph930
  ...
  br i1 %249, label %polly.loop_exit741, label %vector.body927, !llvm.loop !97
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph948
  ...
  br i1 %278, label %polly.loop_exit767, label %vector.body945, !llvm.loop !100
