; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5846.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5846.c"
...
vector.body1066:                                  ; preds = %vector.body1066, %vector.ph1070
  ...
  %wide.load1077 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %138, label %middle.block1064, label %vector.body1066, !llvm.loop !85
...
polly.loop_header376:                             ; preds = %polly.loop_header376.preheader, %polly.loop_exit384
  ...
  %140 = mul nuw nsw i64 %polly.indvar379, 20
...
vector.body1042:                                  ; preds = %vector.body1042, %vector.ph1044
  ...
  %wide.load1051 = load <4 x double>, <4 x double>* %178, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %181, label %middle.block1040, label %vector.body1042, !llvm.loop !95
...
polly.loop_header556:                             ; preds = %polly.loop_header556.preheader, %polly.loop_exit564
  ...
  %183 = mul nuw nsw i64 %polly.indvar559, 20
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  br i1 %238, label %polly.loop_exit778, label %vector.body980, !llvm.loop !104
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %267, label %polly.loop_exit805, label %vector.body995, !llvm.loop !107
...
vector.body1013:                                  ; preds = %vector.body1013, %vector.ph1016
  ...
  br i1 %296, label %polly.loop_exit831, label %vector.body1013, !llvm.loop !110
