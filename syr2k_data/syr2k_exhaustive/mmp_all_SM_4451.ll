; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4451.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4451.c"
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %indvars.iv979, i64 79)
...
vector.body1178:                                  ; preds = %vector.body1178, %vector.ph1182
  ...
  %wide.load1189 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %125, label %middle.block1176, label %vector.body1178, !llvm.loop !80
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %127 = lshr i64 %polly.indvar384, 2
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header387
  ...
  %130 = mul nuw nsw i64 %polly.indvar397, 80
  %131 = sub nsw i64 %128, %130
  %132 = add nuw nsw i64 %130, 80
...
vector.body1154:                                  ; preds = %vector.body1154, %vector.ph1156
  ...
  %wide.load1163 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %155, label %middle.block1152, label %vector.body1154, !llvm.loop !90
...
polly.loop_header570:                             ; preds = %polly.loop_header570.preheader, %polly.loop_exit578
  ...
  %157 = lshr i64 %polly.indvar573, 2
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header576
  ...
  %160 = mul nuw nsw i64 %polly.indvar586, 80
  %161 = sub nsw i64 %158, %160
  %162 = add nuw nsw i64 %160, 80
...
polly.loop_header589:                             ; preds = %polly.loop_exit626, %polly.loop_header583
  ...
  %smin1021 = call i64 @llvm.smin.i64(i64 %indvars.iv1016, i64 79)
...
vector.body1093:                                  ; preds = %vector.body1093, %vector.ph1094
  ...
  br i1 %199, label %polly.loop_exit801, label %vector.body1093, !llvm.loop !99
...
vector.body1107:                                  ; preds = %vector.body1107, %vector.ph1110
  ...
  br i1 %228, label %polly.loop_exit828, label %vector.body1107, !llvm.loop !102
...
vector.body1125:                                  ; preds = %vector.body1125, %vector.ph1128
  ...
  br i1 %257, label %polly.loop_exit854, label %vector.body1125, !llvm.loop !105
