; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3163.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3163.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %.inv = icmp ugt i64 %118, 63
  %120 = select i1 %.inv, i64 63, i64 %119
...
polly.loop_header395:                             ; preds = %polly.loop_exit403, %polly.loop_header389
  ...
  %165 = mul nsw i64 %polly.indvar398, -64
  %166 = shl nsw i64 %polly.indvar398, 6
...
polly.loop_header401:                             ; preds = %polly.loop_exit442, %polly.loop_header395
  ...
  %.inv875 = icmp ugt i64 %170, 63
  %172 = select i1 %.inv875, i64 63, i64 %171
...
polly.loop_header587:                             ; preds = %polly.loop_exit595, %polly.loop_header581
  ...
  %217 = mul nsw i64 %polly.indvar590, -64
  %218 = shl nsw i64 %polly.indvar590, 6
...
polly.loop_header593:                             ; preds = %polly.loop_exit634, %polly.loop_header587
  ...
  %.inv876 = icmp ugt i64 %222, 63
  %224 = select i1 %.inv876, i64 63, i64 %223
