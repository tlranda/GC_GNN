; ModuleID = 'syr2k_exhaustive/mmp_all_SM_58.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_58.c"
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %exitcond975.not = icmp eq i64 %polly.indvar_next210, 60
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv967, i64 19)
  %125 = mul nsw i64 %polly.indvar231, 38400
  %indvars.iv.next970 = or i64 %indvars.iv967, 1
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next970, i64 19)
  %126 = or i64 %114, 1
  %127 = or i64 %113, 1
  %128 = mul nuw nsw i64 %127, 9600
  %indvars.iv.next970.1 = add nuw nsw i64 %indvars.iv.next970, 1
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next970.1, i64 19)
  %129 = or i64 %114, 2
  %130 = or i64 %113, 2
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit416
  ...
  %181 = mul nuw nsw i64 %polly.indvar411, 50
...
polly.loop_header414:                             ; preds = %polly.loop_exit438, %polly.loop_header408
  ...
  %182 = mul nuw nsw i64 %polly.indvar417, 20
  br label %polly.loop_header420

polly.loop_exit422:                               ; preds = %polly.loop_exit428
  %183 = mul nsw i64 %polly.indvar417, -20
  %184 = mul nuw nsw i64 %polly.indvar417, 5
...
polly.loop_exit438:                               ; preds = %polly.loop_exit477
  ...
  %exitcond995.not = icmp eq i64 %polly.indvar_next418, 60
...
polly.loop_header475.preheader:                   ; preds = %polly.loop_exit463, %polly.loop_exit463.us
  %smin990 = call i64 @llvm.smin.i64(i64 %indvars.iv986, i64 19)
  %209 = mul nsw i64 %polly.indvar439, 38400
  %indvars.iv.next989 = or i64 %indvars.iv986, 1
  %smin990.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next989, i64 19)
  %210 = or i64 %198, 1
  %211 = or i64 %197, 1
  %212 = mul nuw nsw i64 %211, 9600
  %indvars.iv.next989.1 = add nuw nsw i64 %indvars.iv.next989, 1
  %smin990.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next989.1, i64 19)
  %213 = or i64 %198, 2
  %214 = or i64 %197, 2
...
polly.loop_header618:                             ; preds = %polly.loop_header618.preheader, %polly.loop_exit626
  ...
  %265 = mul nuw nsw i64 %polly.indvar621, 50
...
polly.loop_header624:                             ; preds = %polly.loop_exit648, %polly.loop_header618
  ...
  %266 = mul nuw nsw i64 %polly.indvar627, 20
  br label %polly.loop_header630

polly.loop_exit632:                               ; preds = %polly.loop_exit638
  %267 = mul nsw i64 %polly.indvar627, -20
  %268 = mul nuw nsw i64 %polly.indvar627, 5
...
polly.loop_exit648:                               ; preds = %polly.loop_exit687
  ...
  %exitcond1015.not = icmp eq i64 %polly.indvar_next628, 60
...
polly.loop_header685.preheader:                   ; preds = %polly.loop_exit673, %polly.loop_exit673.us
  %smin1010 = call i64 @llvm.smin.i64(i64 %indvars.iv1006, i64 19)
  %293 = mul nsw i64 %polly.indvar649, 38400
  %indvars.iv.next1009 = or i64 %indvars.iv1006, 1
  %smin1010.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next1009, i64 19)
  %294 = or i64 %282, 1
  %295 = or i64 %281, 1
  %296 = mul nuw nsw i64 %295, 9600
  %indvars.iv.next1009.1 = add nuw nsw i64 %indvars.iv.next1009, 1
  %smin1010.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next1009.1, i64 19)
  %297 = or i64 %282, 2
  %298 = or i64 %281, 2
