; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10641.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10641.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv786, i64 18)
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv783, i64 63)
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %umin808 = call i64 @llvm.umin.i64(i64 %indvars.iv806, i64 18)
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %131 = shl nsw i64 %polly.indvar361, 6
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header358
  ...
  %indvars.iv.next795 = add nsw i64 %indvars.iv794, 64
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  %indvars.iv827 = phi i64 [ %indvars.iv.next828, %polly.loop_exit515 ], [ 1, %polly.loop_exit499 ]
  ...
  %umin829 = call i64 @llvm.umin.i64(i64 %indvars.iv827, i64 18)
...
polly.loop_exit515:                               ; preds = %polly.loop_exit522
  ...
  %indvars.iv.next828 = add nuw nsw i64 %indvars.iv827, 2
...
polly.loop_header513:                             ; preds = %polly.loop_exit522, %polly.loop_header507
  ...
  %160 = shl nsw i64 %polly.indvar516, 6
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit529
  ...
  %smin824 = call i64 @llvm.smin.i64(i64 %indvars.iv822, i64 63)
