; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10157.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10157.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit219
  ...
  %polly.loop_guard227866 = icmp sgt i64 %108, -1
...
vector.body981:                                   ; preds = %vector.body981, %vector.ph985
  ...
  %119 = shl nuw nsw i64 %index988, 3
  %120 = getelementptr i8, i8* %scevgep348, i64 %119
  %121 = bitcast i8* %120 to <4 x double>*
  %wide.load992 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !69, !noalias !71
  %122 = fmul fast <4 x double> %wide.load992, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %124 = icmp eq i64 %index.next989, %n.vec987
  br i1 %124, label %middle.block979, label %vector.body981, !llvm.loop !74

middle.block979:                                  ; preds = %vector.body981
  %cmp.n991 = icmp eq i64 %117, %n.vec987
...
polly.loop_exit360:                               ; preds = %polly.loop_exit367
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next356, 19
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %131 = shl nsw i64 %polly.indvar361, 5
...
polly.loop_header365:                             ; preds = %polly.loop_header365.preheader, %polly.loop_exit374
  ...
  %polly.loop_guard382867 = icmp sgt i64 %137, -1
...
vector.body957:                                   ; preds = %vector.body957, %vector.ph959
  ...
  %148 = shl nuw nsw i64 %index962, 3
  %149 = getelementptr i8, i8* %scevgep503, i64 %148
  %150 = bitcast i8* %149 to <4 x double>*
  %wide.load966 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !78, !noalias !80
  %151 = fmul fast <4 x double> %wide.load966, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %153 = icmp eq i64 %index.next963, %n.vec961
  br i1 %153, label %middle.block955, label %vector.body957, !llvm.loop !83

middle.block955:                                  ; preds = %vector.body957
  %cmp.n965 = icmp eq i64 %146, %n.vec961
...
polly.loop_exit515:                               ; preds = %polly.loop_exit522
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next511, 19
...
polly.loop_header513:                             ; preds = %polly.loop_exit522, %polly.loop_header507
  ...
  %160 = shl nsw i64 %polly.indvar516, 5
...
polly.loop_header520.preheader:                   ; preds = %polly.loop_header513
  ...
  %164 = add i64 %smax816, %indvars.iv819
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit529
  %indvars.iv821 = phi i64 [ %164, %polly.loop_header520.preheader ], [ %indvars.iv.next822, %polly.loop_exit529 ]
  %polly.indvar524 = phi i64 [ %163, %polly.loop_header520.preheader ], [ %polly.indvar_next525, %polly.loop_exit529 ]
  %smin823 = call i64 @llvm.smin.i64(i64 %indvars.iv821, i64 31)
  %166 = add nsw i64 %polly.indvar524, %165
  %polly.loop_guard537868 = icmp sgt i64 %166, -1
...
polly.loop_header692:                             ; preds = %polly.loop_exit700, %polly.loop_header686
  ...
  %smin896 = call i64 @llvm.smin.i64(i64 %177, i64 -1168)
  %178 = add nsw i64 %smin896, 1200
  %smin854 = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 -1168)
  %179 = shl nsw i64 %polly.indvar695, 5
  %180 = add nsw i64 %smin854, 1199
...
vector.ph897:                                     ; preds = %polly.loop_header698
  %broadcast.splatinsert904 = insertelement <4 x i64> poison, i64 %179, i32 0
  %broadcast.splat905 = shufflevector <4 x i64> %broadcast.splatinsert904, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert906 = insertelement <4 x i32> poison, i32 %182, i32 0
...
vector.body895:                                   ; preds = %vector.body895, %vector.ph897
  ...
  %184 = add nuw nsw <4 x i64> %vec.ind902, %broadcast.splat905
  %185 = trunc <4 x i64> %184 to <4 x i32>
  %186 = mul <4 x i32> %broadcast.splat907, %185
  ...
  %196 = icmp eq i64 %index.next899, %178
  br i1 %196, label %polly.loop_exit706, label %vector.body895, !llvm.loop !92

polly.loop_exit706:                               ; preds = %vector.body895, %polly.loop_header704
  %polly.indvar_next702 = add nuw nsw i64 %polly.indvar701, 1
  %exitcond859.not = icmp eq i64 %polly.indvar701, %176
...
polly.loop_header704:                             ; preds = %polly.loop_header698, %polly.loop_header704
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar707, %180
...
polly.loop_header719:                             ; preds = %polly.loop_exit727, %polly.loop_header713
  ...
  %smin911 = call i64 @llvm.smin.i64(i64 %206, i64 -968)
  %207 = add nsw i64 %smin911, 1000
  %smin844 = call i64 @llvm.smin.i64(i64 %indvars.iv842, i64 -968)
  %208 = shl nsw i64 %polly.indvar722, 5
  %209 = add nsw i64 %smin844, 999
...
vector.body910:                                   ; preds = %vector.body910, %vector.ph913
  ...
  %213 = add nuw nsw <4 x i64> %vec.ind920, %broadcast.splat923
  %214 = trunc <4 x i64> %213 to <4 x i32>
  %215 = mul <4 x i32> %broadcast.splat925, %214
  ...
  %225 = icmp eq i64 %index.next917, %207
  br i1 %225, label %polly.loop_exit733, label %vector.body910, !llvm.loop !95

polly.loop_exit733:                               ; preds = %vector.body910, %polly.loop_header731
  %polly.indvar_next729 = add nuw nsw i64 %polly.indvar728, 1
  %exitcond849.not = icmp eq i64 %polly.indvar728, %205
...
polly.loop_header731:                             ; preds = %polly.loop_header725, %polly.loop_header731
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar734, %209
...
polly.loop_header745:                             ; preds = %polly.loop_exit753, %polly.loop_header739
  ...
  %smin929 = call i64 @llvm.smin.i64(i64 %235, i64 -968)
  %236 = add nsw i64 %smin929, 1000
  %smin834 = call i64 @llvm.smin.i64(i64 %indvars.iv832, i64 -968)
  %237 = shl nsw i64 %polly.indvar748, 5
  %238 = add nsw i64 %smin834, 999
...
vector.body928:                                   ; preds = %vector.body928, %vector.ph931
  ...
  %242 = add nuw nsw <4 x i64> %vec.ind938, %broadcast.splat941
  %243 = trunc <4 x i64> %242 to <4 x i32>
  %244 = mul <4 x i32> %broadcast.splat943, %243
  ...
  %254 = icmp eq i64 %index.next935, %236
  br i1 %254, label %polly.loop_exit759, label %vector.body928, !llvm.loop !98

polly.loop_exit759:                               ; preds = %vector.body928, %polly.loop_header757
  %polly.indvar_next755 = add nuw nsw i64 %polly.indvar754, 1
  %exitcond839.not = icmp eq i64 %polly.indvar754, %234
...
polly.loop_header757:                             ; preds = %polly.loop_header751, %polly.loop_header757
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar760, %238
