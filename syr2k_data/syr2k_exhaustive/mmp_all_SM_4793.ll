; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4793.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4793.c"
...
polly.loop_exit220:                               ; preds = %polly.loop_exit252, %polly.loop_header211
  ...
  %indvars.iv.next988 = add i64 %indvars.iv987, 100
  %indvars.iv.next992 = add i64 %indvars.iv991, -100
...
polly.loop_header218:                             ; preds = %polly.loop_header218.preheader, %polly.loop_exit252
  ...
  %smin999 = call i64 @llvm.smin.i64(i64 %indvars.iv993, i64 99)
...
vector.body1212:                                  ; preds = %vector.body1212, %vector.ph1216
  ...
  %wide.load1223 = load <4 x double>, <4 x double>* %135, align 8, !alias.scope !73, !noalias !75
  ...
  store <4 x double> %136, <4 x double>* %137, align 8, !alias.scope !73, !noalias !75
  %index.next1220 = add i64 %index1219, 4
  %138 = icmp eq i64 %index.next1220, %n.vec1218
  br i1 %138, label %middle.block1210, label %vector.body1212, !llvm.loop !79
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %140 = mul nuw nsw i64 %polly.indvar388, 9
  %141 = add nuw nsw i64 %140, 34
  %pexp.p_div_q397 = udiv i64 %141, 25
  %142 = sub nsw i64 %polly.indvar388, %pexp.p_div_q397
  %143 = add nsw i64 %142, 1
  %.inv873 = icmp slt i64 %142, 11
  %144 = select i1 %.inv873, i64 %143, i64 11
  %polly.loop_guard402 = icmp sgt i64 %144, -1
  %145 = mul nsw i64 %polly.indvar388, -64
  %146 = icmp slt i64 %145, -1136
  %147 = select i1 %146, i64 %145, i64 -1136
  %148 = add nsw i64 %147, 1199
  %149 = shl nsw i64 %polly.indvar388, 6
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %152 = mul nsw i64 %polly.indvar403, 100
...
polly.loop_exit409:                               ; preds = %polly.loop_exit445, %polly.loop_header399
  ...
  %indvars.iv.next1015 = add i64 %indvars.iv1014, 100
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit445
  ...
  %smin1027 = call i64 @llvm.smin.i64(i64 %indvars.iv1021, i64 99)
...
vector.body1188:                                  ; preds = %vector.body1188, %vector.ph1190
  ...
  %wide.load1197 = load <4 x double>, <4 x double>* %178, align 8, !alias.scope !83, !noalias !85
  ...
  store <4 x double> %179, <4 x double>* %180, align 8, !alias.scope !83, !noalias !85
  %index.next1194 = add i64 %index1193, 4
  %181 = icmp eq i64 %index.next1194, %n.vec1192
  br i1 %181, label %middle.block1186, label %vector.body1188, !llvm.loop !89
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %183 = mul nuw nsw i64 %polly.indvar581, 9
  %184 = add nuw nsw i64 %183, 34
  %pexp.p_div_q590 = udiv i64 %184, 25
  %185 = sub nsw i64 %polly.indvar581, %pexp.p_div_q590
  %186 = add nsw i64 %185, 1
  %.inv875 = icmp slt i64 %185, 11
  %187 = select i1 %.inv875, i64 %186, i64 11
  %polly.loop_guard595 = icmp sgt i64 %187, -1
  %188 = mul nsw i64 %polly.indvar581, -64
  %189 = icmp slt i64 %188, -1136
  %190 = select i1 %189, i64 %188, i64 -1136
  %191 = add nsw i64 %190, 1199
  %192 = shl nsw i64 %polly.indvar581, 6
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %194 = shl nsw i64 %polly.indvar587, 6
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %195 = mul nsw i64 %polly.indvar596, 100
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_exit638
  ...
  %smin1055 = call i64 @llvm.smin.i64(i64 %indvars.iv1049, i64 99)
...
vector.body1127:                                  ; preds = %vector.body1127, %vector.ph1128
  ...
  store <4 x double> %232, <4 x double>* %237, align 8, !alias.scope !93, !noalias !95
  ...
  br i1 %238, label %polly.loop_exit813, label %vector.body1127, !llvm.loop !98
...
vector.body1141:                                  ; preds = %vector.body1141, %vector.ph1144
  ...
  store <4 x double> %261, <4 x double>* %266, align 8, !alias.scope !97, !noalias !100
  ...
  br i1 %267, label %polly.loop_exit840, label %vector.body1141, !llvm.loop !101
...
vector.body1159:                                  ; preds = %vector.body1159, %vector.ph1162
  ...
  store <4 x double> %290, <4 x double>* %295, align 8, !alias.scope !96, !noalias !103
  ...
  br i1 %296, label %polly.loop_exit866, label %vector.body1159, !llvm.loop !104
