; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9757.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9757.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond799.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %128 = mul nsw i64 %polly.indvar357, -20
  %129 = mul nuw nsw i64 %polly.indvar357, 20
...
polly.loop_exit362:                               ; preds = %polly.loop_exit368
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next358, 60
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %polly.loop_guard376 = icmp slt i64 %135, 20
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %159 = mul nsw i64 %polly.indvar514, -20
  %160 = mul nuw nsw i64 %polly.indvar514, 20
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %indvars.iv.next832 = add nuw nsw i64 %indvars.iv831, 20
  %indvars.iv.next844 = add nuw nsw i64 %indvars.iv843, 5
  %exitcond847.not = icmp eq i64 %polly.indvar_next515, 60
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %polly.loop_guard533 = icmp slt i64 %166, 20
