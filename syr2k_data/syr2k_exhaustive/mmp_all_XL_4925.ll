; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4925.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4925.c"
...
polly.loop_exit220:                               ; preds = %polly.loop_exit252, %polly.loop_header211
  ...
  %indvars.iv.next990 = add nsw i64 %indvars.iv989, -100
...
polly.loop_header218:                             ; preds = %polly.loop_header218.preheader, %polly.loop_exit252
  ...
  %smin997 = call i64 @llvm.smin.i64(i64 %indvars.iv991, i64 99)
...
vector.body1207:                                  ; preds = %vector.body1207, %vector.ph1211
  ...
  %wide.load1218 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %132, label %middle.block1205, label %vector.body1207, !llvm.loop !79
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %136 = mul nsw i64 %polly.indvar388, -80
  %137 = mul nuw nsw i64 %polly.indvar388, 80
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %140 = mul nuw nsw i64 %polly.indvar403, 100
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit445
  ...
  %smin1024 = call i64 @llvm.smin.i64(i64 %indvars.iv1018, i64 99)
...
vector.body1183:                                  ; preds = %vector.body1183, %vector.ph1185
  ...
  %wide.load1192 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %169, label %middle.block1181, label %vector.body1183, !llvm.loop !89
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %173 = mul nsw i64 %polly.indvar581, -80
  %174 = mul nuw nsw i64 %polly.indvar581, 80
...
polly.loop_header592.preheader:                   ; preds = %polly.loop_header584
  %176 = mul nuw nsw i64 %polly.indvar587, 80
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %177 = mul nuw nsw i64 %polly.indvar596, 100
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_exit638
  ...
  %smin1051 = call i64 @llvm.smin.i64(i64 %indvars.iv1045, i64 99)
...
vector.body1122:                                  ; preds = %vector.body1122, %vector.ph1123
  ...
  br i1 %220, label %polly.loop_exit813, label %vector.body1122, !llvm.loop !98
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  br i1 %249, label %polly.loop_exit840, label %vector.body1136, !llvm.loop !101
...
vector.body1154:                                  ; preds = %vector.body1154, %vector.ph1157
  ...
  br i1 %278, label %polly.loop_exit866, label %vector.body1154, !llvm.loop !104
