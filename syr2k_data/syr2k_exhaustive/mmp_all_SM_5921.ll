; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5921.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5921.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit223
  ...
  %indvars.iv844 = phi i64 [ 7, %polly.loop_header199.preheader ], [ %indvars.iv.next845, %polly.loop_exit223 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %polly.loop_guard = icmp slt i64 %105, 38
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %indvars.iv.next843 = add nsw i64 %indvars.iv842, -12
  %indvars.iv.next845 = add nuw nsw i64 %indvars.iv844, 3
  %indvars.iv.next849 = add nuw nsw i64 %indvars.iv848, 12
  %exitcond856.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_header234:                             ; preds = %polly.loop_exit244, %polly.loop_header227
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 19)
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit398
  ...
  %indvars.iv865 = phi i64 [ 7, %polly.loop_header372.preheader ], [ %indvars.iv.next866, %polly.loop_exit398 ]
  ...
  %134 = shl nuw nsw i64 %indvars.iv865, 2
  %135 = and i64 %134, 9223372036854775776
  %136 = add i64 %indvars.iv863, %135
  %137 = sub nsw i64 %indvars.iv870, %135
  %138 = mul nuw nsw i64 %polly.indvar375, 20
  br label %polly.loop_header378

polly.loop_exit380:                               ; preds = %polly.loop_exit386
  %139 = mul nsw i64 %polly.indvar375, -20
  %140 = mul nuw nsw i64 %polly.indvar375, 3
  %141 = add nuw nsw i64 %140, 7
  %pexp.p_div_q394 = lshr i64 %141, 3
  %142 = sub nsw i64 %polly.indvar375, %pexp.p_div_q394
  %polly.loop_guard399 = icmp slt i64 %142, 38
...
polly.loop_exit398:                               ; preds = %polly.loop_exit405, %polly.loop_exit380
  ...
  %indvars.iv.next864 = add nsw i64 %indvars.iv863, -12
  %indvars.iv.next866 = add nuw nsw i64 %indvars.iv865, 3
  %indvars.iv.next871 = add nuw nsw i64 %indvars.iv870, 12
  %exitcond879.not = icmp eq i64 %polly.indvar_next376, 60
...
polly.loop_header396:                             ; preds = %polly.loop_exit380, %polly.loop_exit405
  ...
  %145 = shl nsw i64 %polly.indvar400, 5
  %146 = sub nsw i64 %138, %145
  %147 = icmp sgt i64 %146, 0
  %148 = select i1 %147, i64 %146, i64 0
  %149 = mul nsw i64 %polly.indvar400, -32
...
polly.loop_header548:                             ; preds = %polly.loop_header548.preheader, %polly.loop_exit574
  ...
  %indvars.iv888 = phi i64 [ 7, %polly.loop_header548.preheader ], [ %indvars.iv.next889, %polly.loop_exit574 ]
  ...
  %171 = shl nuw nsw i64 %indvars.iv888, 2
  %172 = and i64 %171, 9223372036854775776
  %173 = add i64 %indvars.iv886, %172
  %174 = sub nsw i64 %indvars.iv893, %172
  %175 = mul nuw nsw i64 %polly.indvar551, 20
  br label %polly.loop_header554

polly.loop_exit556:                               ; preds = %polly.loop_exit562
  %176 = mul nsw i64 %polly.indvar551, -20
  %177 = mul nuw nsw i64 %polly.indvar551, 3
  %178 = add nuw nsw i64 %177, 7
  %pexp.p_div_q570 = lshr i64 %178, 3
  %179 = sub nsw i64 %polly.indvar551, %pexp.p_div_q570
  %polly.loop_guard575 = icmp slt i64 %179, 38
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_exit556
  ...
  %indvars.iv.next887 = add nsw i64 %indvars.iv886, -12
  %indvars.iv.next889 = add nuw nsw i64 %indvars.iv888, 3
  %indvars.iv.next894 = add nuw nsw i64 %indvars.iv893, 12
  %exitcond902.not = icmp eq i64 %polly.indvar_next552, 60
...
polly.loop_header572:                             ; preds = %polly.loop_exit556, %polly.loop_exit581
  ...
  %182 = shl nsw i64 %polly.indvar576, 5
  %183 = sub nsw i64 %175, %182
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %186 = mul nsw i64 %polly.indvar576, -32
...
polly.loop_header586:                             ; preds = %polly.loop_exit596, %polly.loop_header579
  ...
  %smin899 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 19)
