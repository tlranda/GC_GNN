; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10277.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10277.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv786 = phi i64 [ %indvars.iv.next787, %polly.loop_exit207 ], [ 4, %polly.loop_exit193 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond789.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  %indvars.iv806 = phi i64 [ %indvars.iv.next807, %polly.loop_exit360 ], [ 4, %polly.loop_exit344 ]
  ...
  %123 = mul nsw i64 %polly.indvar355, -80
  %124 = mul nuw nsw i64 %polly.indvar355, 80
  br label %polly.loop_header358

polly.loop_exit360:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next793 = add nsw i64 %indvars.iv792, -80
  %indvars.iv.next798 = add nuw nsw i64 %indvars.iv797, 80
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %polly.loop_guard368 = icmp slt i64 %128, 80
...
polly.loop_exit374:                               ; preds = %polly.loop_exit381.loopexit.us, %polly.loop_header365
  ...
  %polly.loop_cond371 = icmp ult i64 %polly.indvar369, 79
...
polly.loop_header507:                             ; preds = %polly.loop_exit499, %polly.loop_exit515
  %indvars.iv826 = phi i64 [ %indvars.iv.next827, %polly.loop_exit515 ], [ 4, %polly.loop_exit499 ]
  ...
  %149 = mul nsw i64 %polly.indvar510, -80
  %150 = mul nuw nsw i64 %polly.indvar510, 80
...
polly.loop_exit515:                               ; preds = %polly.loop_exit522
  ...
  %indvars.iv.next813 = add nsw i64 %indvars.iv812, -80
  %indvars.iv.next818 = add nuw nsw i64 %indvars.iv817, 80
  %indvars.iv.next827 = add nuw nsw i64 %indvars.iv826, 4
  %exitcond829.not = icmp eq i64 %polly.indvar_next511, 15
...
polly.loop_header513:                             ; preds = %polly.loop_exit522, %polly.loop_header507
  ...
  %polly.loop_guard523 = icmp slt i64 %154, 80
