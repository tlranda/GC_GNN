; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1250.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1250.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %98 = mul nsw i64 %polly.indvar209, -48
  %99 = mul nuw nsw i64 %polly.indvar209, 48
  %100 = add nuw i64 %99, 112
  %101 = and i64 %100, -128
  %102 = add i64 %98, %101
  %103 = sub i64 %99, %101
  %104 = shl nuw nsw i64 %indvars.iv1100, 4
  %105 = and i64 %104, 9223372036854775680
  %106 = add i64 %indvars.iv1098, %105
  %107 = sub nsw i64 %indvars.iv1104, %105
  %108 = mul nsw i64 %polly.indvar209, -80
  %109 = mul nuw nsw i64 %polly.indvar209, 80
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %polly.loop_guard = icmp slt i64 %113, 10
...
polly.loop_header228:                             ; preds = %polly.loop_exit214, %polly.loop_exit269
  ...
  %116 = mul nsw i64 %indvar1414, -128
  %117 = add i64 %102, %116
  %smax1416 = call i64 @llvm.smax.i64(i64 %117, i64 0)
  %118 = shl nuw nsw i64 %indvar1414, 7
  %119 = add i64 %103, %118
...
polly.loop_header420:                             ; preds = %polly.loop_exit446, %polly.loop_header414
  ...
  %178 = mul nsw i64 %polly.indvar423, -48
  %179 = mul nuw nsw i64 %polly.indvar423, 48
  %180 = add nuw i64 %179, 112
  %181 = and i64 %180, -128
  %182 = add i64 %178, %181
  %183 = sub i64 %179, %181
  %184 = shl nuw nsw i64 %indvars.iv1125, 4
  ...
  %189 = mul nuw nsw i64 %polly.indvar423, 80
...
polly.loop_exit428:                               ; preds = %polly.loop_exit434
  ...
  %polly.loop_guard447 = icmp slt i64 %193, 10
...
polly.loop_header484.preheader:                   ; preds = %polly.loop_exit472, %polly.loop_exit472.us, %polly.loop_header444.split
  ...
  %218 = mul nsw i64 %polly.indvar448, -128
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %258 = mul nsw i64 %polly.indvar640, -48
  %259 = mul nuw nsw i64 %polly.indvar640, 48
  %260 = add nuw i64 %259, 112
  %261 = and i64 %260, -128
  %262 = add i64 %258, %261
  %263 = sub i64 %259, %261
  %264 = shl nuw nsw i64 %indvars.iv1152, 4
  %265 = and i64 %264, 9223372036854775680
  %266 = add i64 %indvars.iv1150, %265
  %267 = sub nsw i64 %indvars.iv1157, %265
  %268 = mul nsw i64 %polly.indvar640, -80
  %269 = mul nuw nsw i64 %polly.indvar640, 80
...
polly.loop_exit645:                               ; preds = %polly.loop_exit651
  ...
  %polly.loop_guard664 = icmp slt i64 %273, 10
...
polly.loop_header701.preheader:                   ; preds = %polly.loop_exit689, %polly.loop_exit689.us, %polly.loop_header661.split
  ...
  %298 = mul nsw i64 %polly.indvar665, -128
