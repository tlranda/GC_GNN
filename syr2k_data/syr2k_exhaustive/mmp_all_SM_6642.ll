; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6642.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6642.c"
...
vector.body1048:                                  ; preds = %vector.body1048, %vector.ph1050
  ...
  br i1 %57, label %middle.block1046, label %vector.body1048, !llvm.loop !58
...
vector.body1074:                                  ; preds = %vector.body1074, %vector.ph1076
  ...
  br i1 %68, label %middle.block1072, label %vector.body1074, !llvm.loop !60
...
vector.body1086:                                  ; preds = %vector.body1086, %vector.ph1090
  ...
  %wide.load1097 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !66, !noalias !68
  ...
  br i1 %95, label %middle.block1084, label %vector.body1086, !llvm.loop !72
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond865.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !73
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin860 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -872)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit229
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar_next203, 8
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond863.not = icmp eq i64 %polly.indvar_next209, 10
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_exit219
  %101 = mul nsw i64 %polly.indvar208, -128
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  ...
  %104 = mul nsw i64 %polly.indvar230, -128
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233.us, %polly.loop_exit247.us
  ...
  %_p_scalar_264.us = load double, double* %scevgep262263.us, align 8, !alias.scope !69, !noalias !76
...
polly.loop_header245.us:                          ; preds = %polly.loop_header245.us, %polly.loop_header239.us
  ...
  %_p_scalar_253.us = load double, double* %scevgep251252.us, align 8, !alias.scope !69, !noalias !76
  ...
  %_p_scalar_267.us = load double, double* %scevgep265266.us, align 8, !alias.scope !66, !noalias !68
  %p_reass.add.i116.us = fadd fast double %p_mul37.i114.us, %p_mul27.i112.us
  %p_reass.mul.i117.us = fmul fast double %p_reass.add.i116.us, 1.500000e+00
  %p_add42.i118.us = fadd fast double %p_reass.mul.i117.us, %_p_scalar_267.us
  store double %p_add42.i118.us, double* %scevgep265266.us, align 8, !alias.scope !66, !noalias !68
...
vector.body1060:                                  ; preds = %vector.body1060, %vector.ph1064
  ...
  %wide.load1071 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %125, label %middle.block1058, label %vector.body1060, !llvm.loop !83
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_header362
  ...
  br i1 %exitcond892.not, label %polly.loop_exit364, label %polly.loop_header362, !llvm.loop !84
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv870, i64 -872)
  %127 = add nsw i64 %smin887, 1000
  %128 = shl nsw i64 %polly.indvar375, 7
...
polly.loop_exit380:                               ; preds = %polly.loop_exit402
  ...
  %exitcond891.not = icmp eq i64 %polly.indvar_next376, 8
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %129 = shl nsw i64 %polly.indvar381, 7
...
polly.loop_exit402:                               ; preds = %polly.loop_exit408
  ...
  %exitcond890.not = icmp eq i64 %polly.indvar_next382, 10
...
polly.loop_header400.preheader:                   ; preds = %polly.loop_exit392
  %131 = mul nsw i64 %polly.indvar381, -128
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit408
  ...
  %134 = mul nsw i64 %polly.indvar403, -128
  %polly.loop_guard416953 = icmp sgt i64 %134, -1200
  %135 = shl nsw i64 %polly.indvar403, 7
...
polly.loop_header413.us:                          ; preds = %polly.loop_header406.us, %polly.loop_exit422.us
  ...
  %smin878 = call i64 @llvm.smin.i64(i64 %indvars.iv876, i64 127)
  ...
  %_p_scalar_439.us = load double, double* %scevgep437438.us, align 8, !alias.scope !80, !noalias !86
...
polly.loop_header420.us:                          ; preds = %polly.loop_header420.us, %polly.loop_header413.us
  ...
  %_p_scalar_428.us = load double, double* %scevgep426427.us, align 8, !alias.scope !80, !noalias !86
  ...
  %_p_scalar_442.us = load double, double* %scevgep440441.us, align 8, !alias.scope !77, !noalias !79
  %p_reass.add.i77.us = fadd fast double %p_mul37.i75.us, %p_mul27.i73.us
  %p_reass.mul.i78.us = fmul fast double %p_reass.add.i77.us, 1.500000e+00
  %p_add42.i79.us = fadd fast double %p_reass.mul.i78.us, %_p_scalar_442.us
  store double %p_add42.i79.us, double* %scevgep440441.us, align 8, !alias.scope !77, !noalias !79
...
polly.start445:                                   ; preds = %init_array.exit
  %malloccall447 = tail call dereferenceable_or_null(1228800) i8* @malloc(i64 1228800) #6
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1038
  ...
  %wide.load1045 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !87, !noalias !89
  ...
  store <4 x double> %153, <4 x double>* %154, align 8, !alias.scope !87, !noalias !89
  %index.next1042 = add i64 %index1041, 4
  %155 = icmp eq i64 %index.next1042, %n.vec1040
  br i1 %155, label %middle.block1034, label %vector.body1036, !llvm.loop !93
...
polly.loop_header537:                             ; preds = %polly.loop_header537.preheader, %polly.loop_header537
  ...
  %_p_scalar_546 = load double, double* %scevgep544545, align 8, !alias.scope !87, !noalias !89
  %p_mul.i = fmul fast double %_p_scalar_546, 1.200000e+00
  store double %p_mul.i, double* %scevgep544545, align 8, !alias.scope !87, !noalias !89
  %polly.indvar_next541 = add nuw nsw i64 %polly.indvar540, 1
  %exitcond919.not = icmp eq i64 %polly.indvar_next541, %polly.indvar534
  br i1 %exitcond919.not, label %polly.loop_exit539, label %polly.loop_header537, !llvm.loop !94
...
polly.loop_header547:                             ; preds = %polly.loop_header547.preheader, %polly.loop_exit555
  ...
  %smin914 = call i64 @llvm.smin.i64(i64 %indvars.iv897, i64 -872)
  %157 = add nsw i64 %smin914, 1000
  %158 = shl nsw i64 %polly.indvar550, 7
...
polly.loop_exit555:                               ; preds = %polly.loop_exit577
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar_next551, 8
...
polly.loop_header553:                             ; preds = %polly.loop_exit577, %polly.loop_header547
  ...
  %159 = shl nsw i64 %polly.indvar556, 7
...
polly.loop_exit577:                               ; preds = %polly.loop_exit583
  ...
  %exitcond917.not = icmp eq i64 %polly.indvar_next557, 10
...
polly.loop_header575.preheader:                   ; preds = %polly.loop_exit567
  %161 = mul nsw i64 %polly.indvar556, -128
...
polly.loop_header565:                             ; preds = %polly.loop_header565, %polly.loop_header559
  ...
  %polly.access.call2574.load = load double, double* %polly.access.call2574, align 8, !alias.scope !91, !noalias !95
...
polly.loop_header575:                             ; preds = %polly.loop_header575.preheader, %polly.loop_exit583
  ...
  %164 = mul nsw i64 %polly.indvar578, -128
  %polly.loop_guard591954 = icmp sgt i64 %164, -1200
  %165 = shl nsw i64 %polly.indvar578, 7
...
polly.loop_header588.us:                          ; preds = %polly.loop_header581.us, %polly.loop_exit597.us
  ...
  %_p_scalar_614.us = load double, double* %scevgep612613.us, align 8, !alias.scope !90, !noalias !96
...
polly.loop_header595.us:                          ; preds = %polly.loop_header595.us, %polly.loop_header588.us
  ...
  %_p_scalar_603.us = load double, double* %scevgep601602.us, align 8, !alias.scope !90, !noalias !96
  ...
  %_p_scalar_617.us = load double, double* %scevgep615616.us, align 8, !alias.scope !87, !noalias !89
  %p_reass.add.i.us = fadd fast double %p_mul37.i.us, %p_mul27.i.us
  %p_reass.mul.i.us = fmul fast double %p_reass.add.i.us, 1.500000e+00
  %p_add42.i.us = fadd fast double %p_reass.mul.i.us, %_p_scalar_617.us
  store double %p_add42.i.us, double* %scevgep615616.us, align 8, !alias.scope !87, !noalias !89
...
vector.body975:                                   ; preds = %vector.body975, %vector.ph976
  ...
  store <4 x double> %193, <4 x double>* %198, align 8, !alias.scope !97, !noalias !99
  ...
  br i1 %199, label %polly.loop_exit764, label %vector.body975, !llvm.loop !102
...
polly.loop_header762:                             ; preds = %polly.loop_header756, %polly.loop_header762
  ...
  store double %p_div33.i, double* %scevgep768769, align 8, !alias.scope !97, !noalias !99
  %polly.indvar_next766 = add nuw nsw i64 %polly.indvar765, 1
  %exitcond944.not = icmp eq i64 %polly.indvar765, %183
  br i1 %exitcond944.not, label %polly.loop_exit764, label %polly.loop_header762, !llvm.loop !103
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph992
  ...
  store <4 x double> %222, <4 x double>* %227, align 8, !alias.scope !101, !noalias !104
  ...
  br i1 %228, label %polly.loop_exit791, label %vector.body989, !llvm.loop !105
...
polly.loop_header789:                             ; preds = %polly.loop_header783, %polly.loop_header789
  ...
  store double %p_div12.i, double* %scevgep795796, align 8, !alias.scope !101, !noalias !104
  %polly.indvar_next793 = add nuw nsw i64 %polly.indvar792, 1
  %exitcond934.not = icmp eq i64 %polly.indvar792, %212
  br i1 %exitcond934.not, label %polly.loop_exit791, label %polly.loop_header789, !llvm.loop !106
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1010
  ...
  store <4 x double> %251, <4 x double>* %256, align 8, !alias.scope !100, !noalias !107
  ...
  br i1 %257, label %polly.loop_exit817, label %vector.body1007, !llvm.loop !108
...
polly.loop_header815:                             ; preds = %polly.loop_header809, %polly.loop_header815
  ...
  store double %p_div.i, double* %scevgep822823, align 8, !alias.scope !100, !noalias !107
  %polly.indvar_next819 = add nuw nsw i64 %polly.indvar818, 1
  %exitcond924.not = icmp eq i64 %polly.indvar818, %241
  br i1 %exitcond924.not, label %polly.loop_exit817, label %polly.loop_header815, !llvm.loop !109
}
