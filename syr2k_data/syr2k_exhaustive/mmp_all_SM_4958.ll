; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4958.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4958.c"
...
polly.loop_header205:                             ; preds = %polly.loop_header205.preheader, %polly.loop_exit214
  ...
  %polly.loop_guard215 = icmp slt i64 %104, 80
...
polly.loop_exit214:                               ; preds = %polly.loop_exit246, %polly.loop_header205
  ...
  %indvars.iv.next975 = add nsw i64 %indvars.iv974, 100
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit246
  ...
  %smin984 = call i64 @llvm.smin.i64(i64 %indvars.iv980, i64 99)
...
polly.loop_header389.preheader:                   ; preds = %polly.loop_header381
  %129 = mul nsw i64 %polly.indvar384, -80
  %130 = mul nuw nsw i64 %polly.indvar384, 80
...
polly.loop_header389:                             ; preds = %polly.loop_header389.preheader, %polly.loop_exit399
  ...
  %131 = mul nuw nsw i64 %polly.indvar393, 100
  %132 = add nsw i64 %131, %129
  %133 = icmp sgt i64 %132, 0
  %134 = select i1 %133, i64 %132, i64 0
  %polly.loop_guard400 = icmp slt i64 %134, 80
...
polly.loop_exit399:                               ; preds = %polly.loop_exit435, %polly.loop_header389
  ...
  %indvars.iv.next994 = add nsw i64 %indvars.iv993, 100
...
polly.loop_header397:                             ; preds = %polly.loop_header397.preheader, %polly.loop_exit435
  ...
  %smin1005 = call i64 @llvm.smin.i64(i64 %indvars.iv1000, i64 99)
...
polly.loop_header578.preheader:                   ; preds = %polly.loop_header570
  %159 = mul nsw i64 %polly.indvar573, -80
  %160 = mul nuw nsw i64 %polly.indvar573, 80
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit588
  ...
  %161 = mul nuw nsw i64 %polly.indvar582, 100
  %162 = add nsw i64 %161, %159
  %163 = icmp sgt i64 %162, 0
  %164 = select i1 %163, i64 %162, i64 0
  %polly.loop_guard589 = icmp slt i64 %164, 80
...
polly.loop_exit588:                               ; preds = %polly.loop_exit624, %polly.loop_header578
  ...
  %indvars.iv.next1020 = add nsw i64 %indvars.iv1019, -100
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit624
  ...
  %smin1026 = call i64 @llvm.smin.i64(i64 %indvars.iv1021, i64 99)
