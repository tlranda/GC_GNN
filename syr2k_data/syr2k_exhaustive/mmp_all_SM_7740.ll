; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7740.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7740.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %pexp.p_div_q.lhs.trunc = trunc i64 %polly.indvar218 to i8
  %pexp.p_div_q824 = udiv i8 %pexp.p_div_q.lhs.trunc, 5
  %pexp.p_div_q.zext = zext i8 %pexp.p_div_q824 to i64
  %97 = add nuw nsw i64 %polly.indvar218, %pexp.p_div_q.zext
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond840.not = icmp eq i64 %polly.indvar_next219, 13
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %104 = mul nsw i64 %polly.indvar224, 80
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  ...
  %108 = add i64 %smax, %indvars.iv834
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %indvars.iv.next835 = add i64 %indvars.iv834, -80
  %exitcond839.not = icmp eq i64 %polly.indvar_next225, %103
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  %indvars.iv836 = phi i64 [ %108, %polly.loop_header227.preheader ], [ %indvars.iv.next837, %polly.loop_exit235 ]
  %polly.indvar230 = phi i64 [ %107, %polly.loop_header227.preheader ], [ %polly.indvar_next231, %polly.loop_exit235 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 79)
  %110 = add nsw i64 %polly.indvar230, %109
  %polly.loop_guard243916 = icmp sgt i64 %110, -1
...
vector.body1027:                                  ; preds = %vector.body1027, %vector.ph1031
  ...
  %121 = shl nuw nsw i64 %index1034, 3
  %122 = getelementptr i8, i8* %scevgep366, i64 %121
  %123 = bitcast i8* %122 to <4 x double>*
  %wide.load1038 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !74, !noalias !76
  %124 = fmul fast <4 x double> %wide.load1038, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %126 = icmp eq i64 %index.next1035, %n.vec1033
  br i1 %126, label %middle.block1025, label %vector.body1027, !llvm.loop !80

middle.block1025:                                 ; preds = %vector.body1027
  %cmp.n1037 = icmp eq i64 %119, %n.vec1033
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  ...
  %pexp.p_div_q392.lhs.trunc = trunc i64 %polly.indvar389 to i8
  %pexp.p_div_q392823 = udiv i8 %pexp.p_div_q392.lhs.trunc, 5
  %pexp.p_div_q392.zext = zext i8 %pexp.p_div_q392823 to i64
  %128 = add nuw nsw i64 %polly.indvar389, %pexp.p_div_q392.zext
  %.inv820 = icmp ult i64 %128, 14
  ...
  %.op917 = add nuw i64 %128, 2
  %134 = select i1 %.inv820, i64 %.op917, i64 15
  br label %polly.loop_header393

polly.loop_exit395:                               ; preds = %polly.loop_exit402
  %polly.indvar_next390 = add nuw nsw i64 %polly.indvar389, 1
  %indvars.iv.next846 = add nsw i64 %indvars.iv845, -96
  %indvars.iv.next851 = add nuw nsw i64 %indvars.iv850, 96
  %exitcond860.not = icmp eq i64 %polly.indvar_next390, 13
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %135 = mul nsw i64 %polly.indvar396, 80
...
polly.loop_header400.preheader:                   ; preds = %polly.loop_header393
  ...
  %139 = add i64 %smax849, %indvars.iv852
...
polly.loop_exit402:                               ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %indvars.iv.next848 = add i64 %indvars.iv847, 80
  %indvars.iv.next853 = add i64 %indvars.iv852, -80
  %exitcond859.not = icmp eq i64 %polly.indvar_next397, %134
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit409
  %indvars.iv854 = phi i64 [ %139, %polly.loop_header400.preheader ], [ %indvars.iv.next855, %polly.loop_exit409 ]
  ...
  %polly.loop_guard417918 = icmp sgt i64 %141, -1
...
polly.loop_header528:                             ; preds = %polly.loop_exit536, %polly.start442
  ...
  %min.iters.check1004 = icmp ult i64 %150, 4
...
vector.body1003:                                  ; preds = %vector.body1003, %vector.ph1005
  ...
  %152 = shl nuw nsw i64 %index1008, 3
  %153 = getelementptr i8, i8* %scevgep540, i64 %152
  %154 = bitcast i8* %153 to <4 x double>*
  %wide.load1012 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !84, !noalias !86
  %155 = fmul fast <4 x double> %wide.load1012, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %157 = icmp eq i64 %index.next1009, %n.vec1007
  br i1 %157, label %middle.block1001, label %vector.body1003, !llvm.loop !90

middle.block1001:                                 ; preds = %vector.body1003
  %cmp.n1011 = icmp eq i64 %150, %n.vec1007
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  ...
  %pexp.p_div_q566.lhs.trunc = trunc i64 %polly.indvar563 to i8
  %pexp.p_div_q566822 = udiv i8 %pexp.p_div_q566.lhs.trunc, 5
  %pexp.p_div_q566.zext = zext i8 %pexp.p_div_q566822 to i64
  %159 = add nuw nsw i64 %polly.indvar563, %pexp.p_div_q566.zext
  %.inv821 = icmp ult i64 %159, 14
  ...
  %.op919 = add nuw i64 %159, 2
  %165 = select i1 %.inv821, i64 %.op919, i64 15
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576
  ...
  %exitcond880.not = icmp eq i64 %polly.indvar_next564, 13
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %166 = mul nsw i64 %polly.indvar570, 80
...
polly.loop_header574.preheader:                   ; preds = %polly.loop_header567
  ...
  %170 = add i64 %smax869, %indvars.iv872
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583, %polly.loop_header567
  ...
  %exitcond879.not = icmp eq i64 %polly.indvar_next571, %165
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit583
  %indvars.iv874 = phi i64 [ %170, %polly.loop_header574.preheader ], [ %indvars.iv.next875, %polly.loop_exit583 ]
  ...
  %polly.loop_guard591920 = icmp sgt i64 %172, -1
...
polly.loop_header746:                             ; preds = %polly.loop_exit754, %polly.loop_header740
  ...
  %smin942 = call i64 @llvm.smin.i64(i64 %183, i64 -1168)
  %184 = add nsw i64 %smin942, 1200
  %smin907 = call i64 @llvm.smin.i64(i64 %indvars.iv905, i64 -1168)
  %185 = shl nsw i64 %polly.indvar749, 5
  %186 = add nsw i64 %smin907, 1199
...
vector.ph943:                                     ; preds = %polly.loop_header752
  %broadcast.splatinsert950 = insertelement <4 x i64> poison, i64 %185, i32 0
  %broadcast.splat951 = shufflevector <4 x i64> %broadcast.splatinsert950, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert952 = insertelement <4 x i32> poison, i32 %188, i32 0
...
vector.body941:                                   ; preds = %vector.body941, %vector.ph943
  ...
  %190 = add nuw nsw <4 x i64> %vec.ind948, %broadcast.splat951
  %191 = trunc <4 x i64> %190 to <4 x i32>
  %192 = mul <4 x i32> %broadcast.splat953, %191
  ...
  %202 = icmp eq i64 %index.next945, %184
  br i1 %202, label %polly.loop_exit760, label %vector.body941, !llvm.loop !99

polly.loop_exit760:                               ; preds = %vector.body941, %polly.loop_header758
  %polly.indvar_next756 = add nuw nsw i64 %polly.indvar755, 1
  %exitcond912.not = icmp eq i64 %polly.indvar755, %182
...
polly.loop_header758:                             ; preds = %polly.loop_header752, %polly.loop_header758
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar761, %186
...
polly.loop_header773:                             ; preds = %polly.loop_exit781, %polly.loop_header767
  ...
  %smin957 = call i64 @llvm.smin.i64(i64 %212, i64 -968)
  %213 = add nsw i64 %smin957, 1000
  %smin897 = call i64 @llvm.smin.i64(i64 %indvars.iv895, i64 -968)
  %214 = shl nsw i64 %polly.indvar776, 5
  %215 = add nsw i64 %smin897, 999
...
vector.body956:                                   ; preds = %vector.body956, %vector.ph959
  ...
  %219 = add nuw nsw <4 x i64> %vec.ind966, %broadcast.splat969
  %220 = trunc <4 x i64> %219 to <4 x i32>
  %221 = mul <4 x i32> %broadcast.splat971, %220
  ...
  %231 = icmp eq i64 %index.next963, %213
  br i1 %231, label %polly.loop_exit787, label %vector.body956, !llvm.loop !102

polly.loop_exit787:                               ; preds = %vector.body956, %polly.loop_header785
  %polly.indvar_next783 = add nuw nsw i64 %polly.indvar782, 1
  %exitcond902.not = icmp eq i64 %polly.indvar782, %211
...
polly.loop_header785:                             ; preds = %polly.loop_header779, %polly.loop_header785
  ...
  %exitcond898.not = icmp eq i64 %polly.indvar788, %215
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  %smin975 = call i64 @llvm.smin.i64(i64 %241, i64 -968)
  %242 = add nsw i64 %smin975, 1000
  %smin887 = call i64 @llvm.smin.i64(i64 %indvars.iv885, i64 -968)
  %243 = shl nsw i64 %polly.indvar802, 5
  %244 = add nsw i64 %smin887, 999
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph977
  ...
  %248 = add nuw nsw <4 x i64> %vec.ind984, %broadcast.splat987
  %249 = trunc <4 x i64> %248 to <4 x i32>
  %250 = mul <4 x i32> %broadcast.splat989, %249
  ...
  %260 = icmp eq i64 %index.next981, %242
  br i1 %260, label %polly.loop_exit813, label %vector.body974, !llvm.loop !105

polly.loop_exit813:                               ; preds = %vector.body974, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond892.not = icmp eq i64 %polly.indvar808, %240
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar814, %244
