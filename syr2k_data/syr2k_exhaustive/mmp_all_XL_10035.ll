; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10035.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10035.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond780.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %indvars.iv.next772 = add nsw i64 %indvars.iv771, -50
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv773, i64 49)
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225.loopexit.us, %polly.loop_header211
  ...
  %exitcond776.not = icmp eq i64 %polly.indvar_next215, 50
...
polly.loop_header350:                             ; preds = %polly.loop_exit342, %polly.loop_exit358
  ...
  %118 = mul nuw nsw i64 %polly.indvar353, 50
  br label %polly.loop_header356

polly.loop_exit358:                               ; preds = %polly.loop_exit364
  %polly.indvar_next354 = add nuw nsw i64 %polly.indvar353, 1
  %indvars.iv.next784 = add nuw nsw i64 %indvars.iv783, 50
  %indvars.iv.next794 = add nuw nsw i64 %indvars.iv793, 1
  %exitcond796.not = icmp eq i64 %polly.indvar_next354, 24
...
polly.loop_header362:                             ; preds = %polly.loop_exit370, %polly.loop_header356
  ...
  %smin789 = call i64 @llvm.smin.i64(i64 %indvars.iv787, i64 49)
...
polly.loop_exit370:                               ; preds = %polly.loop_exit377.loopexit.us, %polly.loop_header362
  ...
  %exitcond792.not = icmp eq i64 %polly.indvar_next366, 50
...
polly.loop_header503:                             ; preds = %polly.loop_exit495, %polly.loop_exit511
  ...
  %139 = mul nuw nsw i64 %polly.indvar506, 50
...
polly.loop_exit511:                               ; preds = %polly.loop_exit517
  ...
  %exitcond812.not = icmp eq i64 %polly.indvar_next507, 24
...
polly.loop_header509:                             ; preds = %polly.loop_exit517, %polly.loop_header503
  ...
  %140 = mul nuw nsw i64 %polly.indvar512, 50
...
polly.loop_exit523:                               ; preds = %polly.loop_exit530.loopexit.us, %polly.loop_header515
  ...
  %exitcond808.not = icmp eq i64 %polly.indvar_next519, 50
