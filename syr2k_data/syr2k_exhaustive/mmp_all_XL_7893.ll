; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7893.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7893.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar_next219, 10
...
vector.body1048:                                  ; preds = %vector.body1048, %vector.ph1052
  ...
  %wide.load1059 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %133, label %middle.block1046, label %vector.body1048, !llvm.loop !80
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %.inv832 = icmp ult i64 %137, 11
  %138 = mul nsw i64 %polly.indvar393, -128
  %139 = icmp slt i64 %138, -1072
  %140 = select i1 %139, i64 %138, i64 -1072
  %141 = add nsw i64 %140, 1199
  %142 = shl nsw i64 %polly.indvar393, 7
  %.op938 = add nuw i64 %137, 2
  %143 = select i1 %.inv832, i64 %.op938, i64 12
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit405
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next859 = add nsw i64 %indvars.iv858, -128
  %indvars.iv.next864 = add nuw nsw i64 %indvars.iv863, 128
  %exitcond877.not = icmp eq i64 %polly.indvar_next394, 10
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  ...
  %144 = shl nsw i64 %polly.indvar399, 4
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %146 = mul nsw i64 %polly.indvar406, 100
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %indvars.iv.next866 = add i64 %indvars.iv865, -100
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1026
  ...
  %wide.load1033 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %171, label %middle.block1022, label %vector.body1024, !llvm.loop !90
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %.inv833 = icmp ult i64 %175, 11
  %176 = mul nsw i64 %polly.indvar571, -128
  %177 = icmp slt i64 %176, -1072
  %178 = select i1 %177, i64 %176, i64 -1072
  %179 = add nsw i64 %178, 1199
  %180 = shl nsw i64 %polly.indvar571, 7
  %.op940 = add nuw i64 %175, 2
  %181 = select i1 %.inv833, i64 %.op940, i64 12
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %exitcond901.not = icmp eq i64 %polly.indvar_next572, 10
...
polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  ...
  %182 = shl nsw i64 %polly.indvar577, 4
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond900.not = icmp eq i64 %polly.indvar_next578, 63
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %184 = mul nsw i64 %polly.indvar584, 100
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph964
  ...
  br i1 %223, label %polly.loop_exit772, label %vector.body962, !llvm.loop !99
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph980
  ...
  br i1 %252, label %polly.loop_exit799, label %vector.body977, !llvm.loop !102
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %281, label %polly.loop_exit825, label %vector.body995, !llvm.loop !105
