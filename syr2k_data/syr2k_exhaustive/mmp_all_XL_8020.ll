; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8020.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8020.c"
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph955
  ...
  %wide.load962 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %128, label %middle.block949, label %vector.body951, !llvm.loop !76
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.loop_header352
  ...
  %131 = mul nuw nsw i64 %polly.indvar361, 5
  %132 = mul nuw nsw i64 %polly.indvar361, 20
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph929
  ...
  %wide.load936 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %161, label %middle.block925, label %vector.body927, !llvm.loop !85
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit513
  ...
  %163 = mul nuw nsw i64 %polly.indvar508, 20
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %164 = mul nuw nsw i64 %polly.indvar514, 5
  %165 = mul nuw nsw i64 %polly.indvar514, 20
...
vector.body865:                                   ; preds = %vector.body865, %vector.ph867
  ...
  br i1 %208, label %polly.loop_exit702, label %vector.body865, !llvm.loop !94
...
vector.body880:                                   ; preds = %vector.body880, %vector.ph883
  ...
  br i1 %237, label %polly.loop_exit729, label %vector.body880, !llvm.loop !97
...
vector.body898:                                   ; preds = %vector.body898, %vector.ph901
  ...
  br i1 %266, label %polly.loop_exit755, label %vector.body898, !llvm.loop !100
