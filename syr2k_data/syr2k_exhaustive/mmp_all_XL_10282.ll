; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10282.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10282.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next782 = add nuw nsw i64 %indvars.iv781, 80
  %indvars.iv.next789 = add nuw nsw i64 %indvars.iv788, 5
  %exitcond791.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  %indvars.iv808 = phi i64 [ %indvars.iv.next809, %polly.loop_exit361 ], [ 4, %polly.loop_exit344 ]
  ...
  %124 = lshr i64 %indvars.iv808, 4
  %125 = mul nsw i64 %polly.indvar355, -80
  %126 = mul nuw nsw i64 %polly.indvar355, 80
  br label %polly.loop_header359

polly.loop_exit361:                               ; preds = %polly.loop_exit368
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next795 = add nsw i64 %indvars.iv794, -80
  %indvars.iv.next800 = add nuw nsw i64 %indvars.iv799, 80
  %indvars.iv.next809 = add nuw nsw i64 %indvars.iv808, 5
  %exitcond811.not = icmp eq i64 %polly.indvar_next356, 15
...
polly.loop_header359:                             ; preds = %polly.loop_exit368, %polly.loop_header352
  ...
  %127 = shl nsw i64 %polly.indvar362, 8
  %128 = add nsw i64 %127, %125
  %129 = icmp sgt i64 %128, 0
  %130 = select i1 %129, i64 %128, i64 0
  %polly.loop_guard369 = icmp slt i64 %130, 80
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382.loopexit.us, %polly.loop_header366
  ...
  %polly.loop_cond372 = icmp ult i64 %polly.indvar370, 79
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  %indvars.iv828 = phi i64 [ %indvars.iv.next829, %polly.loop_exit517 ], [ 4, %polly.loop_exit500 ]
  ...
  %151 = lshr i64 %indvars.iv828, 4
  %152 = mul nsw i64 %polly.indvar511, -80
  %153 = mul nuw nsw i64 %polly.indvar511, 80
...
polly.loop_exit517:                               ; preds = %polly.loop_exit524
  ...
  %indvars.iv.next820 = add nuw nsw i64 %indvars.iv819, 80
  %indvars.iv.next829 = add nuw nsw i64 %indvars.iv828, 5
  %exitcond831.not = icmp eq i64 %polly.indvar_next512, 15
...
polly.loop_header515:                             ; preds = %polly.loop_exit524, %polly.loop_header508
  ...
  %154 = shl nsw i64 %polly.indvar518, 8
  %155 = add nsw i64 %154, %152
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %polly.loop_guard525 = icmp slt i64 %157, 80
...
polly.loop_exit531:                               ; preds = %polly.loop_exit538.loopexit.us, %polly.loop_header522
  ...
  %polly.loop_cond528 = icmp ult i64 %polly.indvar526, 79
