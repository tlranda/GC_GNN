; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10136.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10136.c"
...
polly.loop_header205.us:                          ; preds = %polly.loop_header199, %polly.loop_exit213.loopexit.us
  ...
  %106 = mul nuw nsw i64 %polly.indvar208.us, 100
...
polly.loop_header211.us:                          ; preds = %polly.loop_header205.us, %polly.loop_exit220.us
  ...
  %107 = mul nsw i64 %polly.indvar214.us, 80
  %108 = add nsw i64 %107, %101
  %109 = icmp sgt i64 %108, 0
  %110 = select i1 %109, i64 %108, i64 0
  %polly.loop_guard221.not.us = icmp sgt i64 %110, %104
...
polly.loop_header218.us:                          ; preds = %polly.loop_header218.preheader.us, %polly.loop_exit227.us
  %indvars.iv901 = phi i64 [ %115, %polly.loop_header218.preheader.us ], [ %indvars.iv.next902, %polly.loop_exit227.us ]
  ...
  %polly.loop_guard235.us981 = icmp sgt i64 %111, -1
  %112 = add nuw nsw i64 %polly.indvar222.us, %105
...
polly.loop_header218.preheader.us:                ; preds = %polly.loop_header211.us
  ...
  %115 = add i64 %smax, %indvars.iv899
...
polly.loop_header225.us.us:                       ; preds = %polly.loop_header218.us, %polly.loop_exit234.loopexit.us.us
  ...
  %117 = add nuw nsw i64 %polly.indvar228.us.us, %106
  %118 = shl i64 %117, 3
  %119 = add i64 %118, %113
...
vector.body1096:                                  ; preds = %vector.body1096, %vector.ph1100
  ...
  %127 = shl nuw nsw i64 %index1103, 3
  %128 = getelementptr i8, i8* %scevgep352, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1107 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !69, !noalias !71
  %130 = fmul fast <4 x double> %wide.load1107, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1104, %n.vec1102
  br i1 %132, label %middle.block1094, label %vector.body1096, !llvm.loop !74

middle.block1094:                                 ; preds = %vector.body1096
  %cmp.n1106 = icmp eq i64 %125, %n.vec1102
...
polly.loop_header356:                             ; preds = %polly.loop_exit348, %polly.loop_exit364
  ...
  %.inv780 = icmp slt i64 %135, 14
  %137 = select i1 %.inv780, i64 %136, i64 14
  %polly.loop_guard373 = icmp sgt i64 %137, -1
  %138 = mul nsw i64 %polly.indvar359, -64
  %139 = icmp slt i64 %138, -1136
  %140 = select i1 %139, i64 %138, i64 -1136
  %141 = add nsw i64 %140, 1199
  %142 = shl nsw i64 %polly.indvar359, 6
...
polly.loop_header362.us:                          ; preds = %polly.loop_header356, %polly.loop_exit372.loopexit.us
  ...
  %143 = mul nuw nsw i64 %polly.indvar365.us, 100
...
polly.loop_header370.us:                          ; preds = %polly.loop_header362.us, %polly.loop_exit380.us
  ...
  %144 = mul nsw i64 %polly.indvar374.us, 80
  %145 = add nsw i64 %144, %138
  %146 = icmp sgt i64 %145, 0
  %147 = select i1 %146, i64 %145, i64 0
  %polly.loop_guard381.not.us = icmp sgt i64 %147, %141
...
polly.loop_header378.us:                          ; preds = %polly.loop_header378.preheader.us, %polly.loop_exit387.us
  %indvars.iv918 = phi i64 [ %152, %polly.loop_header378.preheader.us ], [ %indvars.iv.next919, %polly.loop_exit387.us ]
  ...
  %polly.loop_guard395.us982 = icmp sgt i64 %148, -1
  %149 = add nuw nsw i64 %polly.indvar382.us, %142
...
polly.loop_exit387.us:                            ; preds = %polly.loop_exit394.loopexit.us.us, %polly.loop_header378.us
  ...
  %polly.loop_cond384.not.not.us = icmp ult i64 %polly.indvar382.us, %141
...
polly.loop_exit380.us:                            ; preds = %polly.loop_exit387.us, %polly.loop_header370.us
  ...
  %exitcond923.not = icmp eq i64 %polly.indvar374.us, %137
...
polly.loop_header378.preheader.us:                ; preds = %polly.loop_header370.us
  ...
  %152 = add i64 %smax913, %indvars.iv916
  %153 = sub nsw i64 %142, %144
...
polly.loop_header385.us.us:                       ; preds = %polly.loop_header378.us, %polly.loop_exit394.loopexit.us.us
  ...
  %154 = add nuw nsw i64 %polly.indvar388.us.us, %143
  %155 = shl i64 %154, 3
  %156 = add i64 %155, %150
...
polly.loop_header500:                             ; preds = %init_array.exit, %polly.loop_exit508
  ...
  %min.iters.check1073 = icmp ult i64 %162, 4
...
vector.body1072:                                  ; preds = %vector.body1072, %vector.ph1074
  ...
  %164 = shl nuw nsw i64 %index1077, 3
  %165 = getelementptr i8, i8* %scevgep512, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load1081 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !78, !noalias !80
  %167 = fmul fast <4 x double> %wide.load1081, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next1078, %n.vec1076
  br i1 %169, label %middle.block1070, label %vector.body1072, !llvm.loop !83

middle.block1070:                                 ; preds = %vector.body1072
  %cmp.n1080 = icmp eq i64 %162, %n.vec1076
...
polly.loop_header516:                             ; preds = %polly.loop_exit508, %polly.loop_exit524
  ...
  %.inv781 = icmp slt i64 %172, 14
  %174 = select i1 %.inv781, i64 %173, i64 14
  %polly.loop_guard533 = icmp sgt i64 %174, -1
  %175 = mul nsw i64 %polly.indvar519, -64
  %176 = icmp slt i64 %175, -1136
  %177 = select i1 %176, i64 %175, i64 -1136
  %178 = add nsw i64 %177, 1199
  %179 = shl nsw i64 %polly.indvar519, 6
...
polly.loop_header522.us:                          ; preds = %polly.loop_header516, %polly.loop_exit532.loopexit.us
  ...
  %180 = mul nuw nsw i64 %polly.indvar525.us, 100
...
polly.loop_header530.us:                          ; preds = %polly.loop_header522.us, %polly.loop_exit540.us
  ...
  %181 = mul nsw i64 %polly.indvar534.us, 80
  %182 = add nsw i64 %181, %175
  %183 = icmp sgt i64 %182, 0
  %184 = select i1 %183, i64 %182, i64 0
  %polly.loop_guard541.not.us = icmp sgt i64 %184, %178
...
polly.loop_header538.us:                          ; preds = %polly.loop_header538.preheader.us, %polly.loop_exit547.us
  %indvars.iv937 = phi i64 [ %189, %polly.loop_header538.preheader.us ], [ %indvars.iv.next938, %polly.loop_exit547.us ]
  ...
  %polly.loop_guard555.us983 = icmp sgt i64 %185, -1
  %186 = add nuw nsw i64 %polly.indvar542.us, %179
...
polly.loop_exit547.us:                            ; preds = %polly.loop_exit554.loopexit.us.us, %polly.loop_header538.us
  ...
  %polly.loop_cond544.not.not.us = icmp ult i64 %polly.indvar542.us, %178
...
polly.loop_exit540.us:                            ; preds = %polly.loop_exit547.us, %polly.loop_header530.us
  ...
  %exitcond942.not = icmp eq i64 %polly.indvar534.us, %174
...
polly.loop_header538.preheader.us:                ; preds = %polly.loop_header530.us
  ...
  %189 = add i64 %smax932, %indvars.iv935
...
polly.loop_header545.us.us:                       ; preds = %polly.loop_header538.us, %polly.loop_exit554.loopexit.us.us
  ...
  %191 = add nuw nsw i64 %polly.indvar548.us.us, %180
  %192 = shl i64 %191, 3
  %193 = add i64 %192, %187
...
polly.loop_header706:                             ; preds = %polly.loop_exit714, %polly.loop_header700
  ...
  %smin1011 = call i64 @llvm.smin.i64(i64 %201, i64 -1168)
  %202 = add nsw i64 %smin1011, 1200
  %smin969 = call i64 @llvm.smin.i64(i64 %indvars.iv967, i64 -1168)
  %203 = shl nsw i64 %polly.indvar709, 5
  %204 = add nsw i64 %smin969, 1199
...
vector.ph1012:                                    ; preds = %polly.loop_header712
  %broadcast.splatinsert1019 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat1020 = shufflevector <4 x i64> %broadcast.splatinsert1019, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1021 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body1010:                                  ; preds = %vector.body1010, %vector.ph1012
  ...
  %208 = add nuw nsw <4 x i64> %vec.ind1017, %broadcast.splat1020
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat1022, %209
  ...
  %220 = icmp eq i64 %index.next1014, %202
  br i1 %220, label %polly.loop_exit720, label %vector.body1010, !llvm.loop !92

polly.loop_exit720:                               ; preds = %vector.body1010, %polly.loop_header718
  %polly.indvar_next716 = add nuw nsw i64 %polly.indvar715, 1
  %exitcond974.not = icmp eq i64 %polly.indvar715, %200
...
polly.loop_header718:                             ; preds = %polly.loop_header712, %polly.loop_header718
  ...
  %exitcond970.not = icmp eq i64 %polly.indvar721, %204
...
polly.loop_header733:                             ; preds = %polly.loop_exit741, %polly.loop_header727
  ...
  %smin1026 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin1026, 1000
  %smin959 = call i64 @llvm.smin.i64(i64 %indvars.iv957, i64 -968)
  %232 = shl nsw i64 %polly.indvar736, 5
  %233 = add nsw i64 %smin959, 999
...
vector.body1025:                                  ; preds = %vector.body1025, %vector.ph1028
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind1035, %broadcast.splat1038
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat1040, %238
  ...
  %249 = icmp eq i64 %index.next1032, %231
  br i1 %249, label %polly.loop_exit747, label %vector.body1025, !llvm.loop !95

polly.loop_exit747:                               ; preds = %vector.body1025, %polly.loop_header745
  %polly.indvar_next743 = add nuw nsw i64 %polly.indvar742, 1
  %exitcond964.not = icmp eq i64 %polly.indvar742, %229
...
polly.loop_header745:                             ; preds = %polly.loop_header739, %polly.loop_header745
  ...
  %exitcond960.not = icmp eq i64 %polly.indvar748, %233
...
polly.loop_header759:                             ; preds = %polly.loop_exit767, %polly.loop_header753
  ...
  %smin1044 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin1044, 1000
  %smin949 = call i64 @llvm.smin.i64(i64 %indvars.iv947, i64 -968)
  %261 = shl nsw i64 %polly.indvar762, 5
  %262 = add nsw i64 %smin949, 999
...
vector.body1043:                                  ; preds = %vector.body1043, %vector.ph1046
  ...
  %266 = add nuw nsw <4 x i64> %vec.ind1053, %broadcast.splat1056
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat1058, %267
  ...
  %278 = icmp eq i64 %index.next1050, %260
  br i1 %278, label %polly.loop_exit773, label %vector.body1043, !llvm.loop !98

polly.loop_exit773:                               ; preds = %vector.body1043, %polly.loop_header771
  %polly.indvar_next769 = add nuw nsw i64 %polly.indvar768, 1
  %exitcond954.not = icmp eq i64 %polly.indvar768, %258
...
polly.loop_header771:                             ; preds = %polly.loop_header765, %polly.loop_header771
  ...
  %exitcond950.not = icmp eq i64 %polly.indvar774, %262
