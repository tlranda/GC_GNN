; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3646.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3646.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %112 = udiv i64 %indvars.iv1016, 48
  %113 = mul nuw nsw i64 %112, 96
  %114 = trunc i64 %polly.indvar208 to i16
  %115 = mul i16 %114, 23
  %pexp.p_div_q.lhs.trunc = add i16 %115, 47
  %pexp.p_div_q893 = udiv i16 %pexp.p_div_q.lhs.trunc, 48
  %pexp.p_div_q.zext = zext i16 %pexp.p_div_q893 to i64
  %116 = sub nsw i64 %polly.indvar208, %pexp.p_div_q.zext
...
polly.loop_header257:                             ; preds = %polly.loop_header250, %polly.loop_exit267
  %indvars.iv1024 = phi i64 [ %122, %polly.loop_header250 ], [ %indvars.iv.next1025, %polly.loop_exit267 ]
  ...
  %polly.loop_guard2681115 = icmp sgt i64 %144, -1
...
vector.body1233:                                  ; preds = %vector.body1233, %vector.ph1237
  ...
  %156 = shl nuw nsw i64 %index1240, 3
  %157 = getelementptr i8, i8* %scevgep389, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load1244 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !79, !noalias !81
  %159 = fmul fast <4 x double> %wide.load1244, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next1241, %n.vec1239
  br i1 %161, label %middle.block1231, label %vector.body1233, !llvm.loop !85

middle.block1231:                                 ; preds = %vector.body1233
  %cmp.n1243 = icmp eq i64 %154, %n.vec1239
...
polly.loop_header399:                             ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %178 = udiv i64 %indvars.iv1037, 48
  %179 = mul nuw nsw i64 %178, 96
  %180 = trunc i64 %polly.indvar402 to i16
  %181 = mul i16 %180, 23
  %pexp.p_div_q405.lhs.trunc = add i16 %181, 47
  %pexp.p_div_q405892 = udiv i16 %pexp.p_div_q405.lhs.trunc, 48
  %pexp.p_div_q405.zext = zext i16 %pexp.p_div_q405892 to i64
  %182 = sub nsw i64 %polly.indvar402, %pexp.p_div_q405.zext
  %polly.loop_guard410 = icmp slt i64 %182, 13
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  %183 = sub nsw i64 %indvars.iv1042, %179
  %184 = add i64 %indvars.iv1035, %179
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit449
  %indvars.iv1044 = phi i64 [ %183, %polly.loop_header407.preheader ], [ %indvars.iv.next1045, %polly.loop_exit449 ]
  %indvars.iv1039 = phi i64 [ %184, %polly.loop_header407.preheader ], [ %indvars.iv.next1040, %polly.loop_exit449 ]
  ...
  %189 = mul nsw i64 %polly.indvar411, 96
...
polly.loop_header421.us:                          ; preds = %polly.loop_header407, %polly.loop_header421.us
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar425.us, %192
...
polly.loop_header447.preheader:                   ; preds = %polly.loop_header433.7, %polly.loop_header433.us.7, %polly.loop_exit423.loopexit.us.7, %polly.loop_header407.split
  ...
  %203 = mul nsw i64 %polly.indvar411, -96
...
polly.loop_header454:                             ; preds = %polly.loop_header447, %polly.loop_exit464
  %indvars.iv1046 = phi i64 [ %188, %polly.loop_header447 ], [ %indvars.iv.next1047, %polly.loop_exit464 ]
  ...
  %polly.loop_guard4651116 = icmp sgt i64 %210, -1
...
polly.loop_header574:                             ; preds = %polly.loop_exit582, %polly.start488
  ...
  %min.iters.check1210 = icmp ult i64 %220, 4
...
vector.body1209:                                  ; preds = %vector.body1209, %vector.ph1211
  ...
  %222 = shl nuw nsw i64 %index1214, 3
  %223 = getelementptr i8, i8* %scevgep586, i64 %222
  %224 = bitcast i8* %223 to <4 x double>*
  %wide.load1218 = load <4 x double>, <4 x double>* %224, align 8, !alias.scope !89, !noalias !91
  %225 = fmul fast <4 x double> %wide.load1218, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %227 = icmp eq i64 %index.next1215, %n.vec1213
  br i1 %227, label %middle.block1207, label %vector.body1209, !llvm.loop !95

middle.block1207:                                 ; preds = %vector.body1209
  %cmp.n1217 = icmp eq i64 %220, %n.vec1213
...
polly.loop_header596:                             ; preds = %polly.loop_exit606, %polly.loop_header590
  ...
  %244 = udiv i64 %indvars.iv1060, 48
  %245 = mul nuw nsw i64 %244, 96
  %246 = trunc i64 %polly.indvar599 to i16
  %247 = mul i16 %246, 23
  %pexp.p_div_q602.lhs.trunc = add i16 %247, 47
  %pexp.p_div_q602891 = udiv i16 %pexp.p_div_q602.lhs.trunc, 48
  %pexp.p_div_q602.zext = zext i16 %pexp.p_div_q602891 to i64
  %248 = sub nsw i64 %polly.indvar599, %pexp.p_div_q602.zext
  %polly.loop_guard607 = icmp slt i64 %248, 13
...
polly.loop_header604.preheader:                   ; preds = %polly.loop_header596
  %249 = sub nsw i64 %indvars.iv1065, %245
  %250 = add i64 %indvars.iv1058, %245
...
polly.loop_header604:                             ; preds = %polly.loop_header604.preheader, %polly.loop_exit646
  %indvars.iv1067 = phi i64 [ %249, %polly.loop_header604.preheader ], [ %indvars.iv.next1068, %polly.loop_exit646 ]
  %indvars.iv1062 = phi i64 [ %250, %polly.loop_header604.preheader ], [ %indvars.iv.next1063, %polly.loop_exit646 ]
  ...
  %254 = add i64 %smax1064, %indvars.iv1067
  %255 = mul nsw i64 %polly.indvar608, 96
...
polly.loop_header618.us:                          ; preds = %polly.loop_header604, %polly.loop_header618.us
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar622.us, %258
...
polly.loop_header644.preheader:                   ; preds = %polly.loop_header630.7, %polly.loop_header630.us.7, %polly.loop_exit620.loopexit.us.7, %polly.loop_header604.split
  ...
  %269 = mul nsw i64 %polly.indvar608, -96
...
polly.loop_header651:                             ; preds = %polly.loop_header644, %polly.loop_exit661
  %indvars.iv1069 = phi i64 [ %254, %polly.loop_header644 ], [ %indvars.iv.next1070, %polly.loop_exit661 ]
  ...
  %polly.loop_guard6621117 = icmp sgt i64 %276, -1
...
polly.loop_header815:                             ; preds = %polly.loop_exit823, %polly.loop_header809
  ...
  %smin1148 = call i64 @llvm.smin.i64(i64 %288, i64 -1168)
  %289 = add nsw i64 %smin1148, 1200
  %smin1100 = call i64 @llvm.smin.i64(i64 %indvars.iv1098, i64 -1168)
  %290 = shl nsw i64 %polly.indvar818, 5
  %291 = add nsw i64 %smin1100, 1199
...
vector.ph1149:                                    ; preds = %polly.loop_header821
  %broadcast.splatinsert1156 = insertelement <4 x i64> poison, i64 %290, i32 0
  %broadcast.splat1157 = shufflevector <4 x i64> %broadcast.splatinsert1156, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1158 = insertelement <4 x i32> poison, i32 %293, i32 0
...
vector.body1147:                                  ; preds = %vector.body1147, %vector.ph1149
  ...
  %295 = add nuw nsw <4 x i64> %vec.ind1154, %broadcast.splat1157
  ...
  %307 = icmp eq i64 %index.next1151, %289
  br i1 %307, label %polly.loop_exit829, label %vector.body1147, !llvm.loop !104

polly.loop_exit829:                               ; preds = %vector.body1147, %polly.loop_header827
  %polly.indvar_next825 = add nuw nsw i64 %polly.indvar824, 1
  %exitcond1105.not = icmp eq i64 %polly.indvar824, %287
...
polly.loop_header827:                             ; preds = %polly.loop_header821, %polly.loop_header827
  ...
  %exitcond1101.not = icmp eq i64 %polly.indvar830, %291
...
polly.loop_header842:                             ; preds = %polly.loop_exit850, %polly.loop_header836
  ...
  %smin1163 = call i64 @llvm.smin.i64(i64 %317, i64 -968)
  %318 = add nsw i64 %smin1163, 1000
  %smin1090 = call i64 @llvm.smin.i64(i64 %indvars.iv1088, i64 -968)
  %319 = shl nsw i64 %polly.indvar845, 5
  %320 = add nsw i64 %smin1090, 999
...
vector.body1162:                                  ; preds = %vector.body1162, %vector.ph1165
  ...
  %324 = add nuw nsw <4 x i64> %vec.ind1172, %broadcast.splat1175
  %325 = trunc <4 x i64> %324 to <4 x i32>
  %326 = mul <4 x i32> %broadcast.splat1177, %325
  ...
  %336 = icmp eq i64 %index.next1169, %318
  br i1 %336, label %polly.loop_exit856, label %vector.body1162, !llvm.loop !107

polly.loop_exit856:                               ; preds = %vector.body1162, %polly.loop_header854
  %polly.indvar_next852 = add nuw nsw i64 %polly.indvar851, 1
  %exitcond1095.not = icmp eq i64 %polly.indvar851, %316
...
polly.loop_header854:                             ; preds = %polly.loop_header848, %polly.loop_header854
  ...
  %exitcond1091.not = icmp eq i64 %polly.indvar857, %320
...
polly.loop_header868:                             ; preds = %polly.loop_exit876, %polly.loop_header862
  ...
  %smin1181 = call i64 @llvm.smin.i64(i64 %346, i64 -968)
  %347 = add nsw i64 %smin1181, 1000
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1078, i64 -968)
  %348 = shl nsw i64 %polly.indvar871, 5
  %349 = add nsw i64 %smin1080, 999
...
vector.body1180:                                  ; preds = %vector.body1180, %vector.ph1183
  ...
  %353 = add nuw nsw <4 x i64> %vec.ind1190, %broadcast.splat1193
  %354 = trunc <4 x i64> %353 to <4 x i32>
  %355 = mul <4 x i32> %broadcast.splat1195, %354
  ...
  %365 = icmp eq i64 %index.next1187, %347
  br i1 %365, label %polly.loop_exit882, label %vector.body1180, !llvm.loop !110

polly.loop_exit882:                               ; preds = %vector.body1180, %polly.loop_header880
  %polly.indvar_next878 = add nuw nsw i64 %polly.indvar877, 1
  %exitcond1085.not = icmp eq i64 %polly.indvar877, %345
...
polly.loop_header880:                             ; preds = %polly.loop_header874, %polly.loop_header880
  ...
  %exitcond1081.not = icmp eq i64 %polly.indvar883, %349
...
polly.loop_header421.us.1:                        ; preds = %polly.loop_header421.us.1.preheader, %polly.loop_header421.us.1
  ...
  %exitcond1033.1.not = icmp eq i64 %polly.indvar425.us.1, %192
...
polly.loop_header421.us.2:                        ; preds = %polly.loop_header421.us.2.preheader, %polly.loop_header421.us.2
  ...
  %exitcond1033.2.not = icmp eq i64 %polly.indvar425.us.2, %192
...
polly.loop_header421.us.3:                        ; preds = %polly.loop_header421.us.3.preheader, %polly.loop_header421.us.3
  ...
  %exitcond1033.3.not = icmp eq i64 %polly.indvar425.us.3, %192
...
polly.loop_header421.us.4:                        ; preds = %polly.loop_header421.us.4.preheader, %polly.loop_header421.us.4
  ...
  %exitcond1033.4.not = icmp eq i64 %polly.indvar425.us.4, %192
...
polly.loop_header421.us.5:                        ; preds = %polly.loop_header421.us.5.preheader, %polly.loop_header421.us.5
  ...
  %exitcond1033.5.not = icmp eq i64 %polly.indvar425.us.5, %192
...
polly.loop_header421.us.6:                        ; preds = %polly.loop_header421.us.6.preheader, %polly.loop_header421.us.6
  ...
  %exitcond1033.6.not = icmp eq i64 %polly.indvar425.us.6, %192
...
polly.loop_header421.us.7:                        ; preds = %polly.loop_header421.us.7.preheader, %polly.loop_header421.us.7
  ...
  %exitcond1033.7.not = icmp eq i64 %polly.indvar425.us.7, %192
...
polly.loop_header618.us.1:                        ; preds = %polly.loop_header618.us.1.preheader, %polly.loop_header618.us.1
  ...
  %exitcond1056.1.not = icmp eq i64 %polly.indvar622.us.1, %258
...
polly.loop_header618.us.2:                        ; preds = %polly.loop_header618.us.2.preheader, %polly.loop_header618.us.2
  ...
  %exitcond1056.2.not = icmp eq i64 %polly.indvar622.us.2, %258
...
polly.loop_header618.us.3:                        ; preds = %polly.loop_header618.us.3.preheader, %polly.loop_header618.us.3
  ...
  %exitcond1056.3.not = icmp eq i64 %polly.indvar622.us.3, %258
...
polly.loop_header618.us.4:                        ; preds = %polly.loop_header618.us.4.preheader, %polly.loop_header618.us.4
  ...
  %exitcond1056.4.not = icmp eq i64 %polly.indvar622.us.4, %258
...
polly.loop_header618.us.5:                        ; preds = %polly.loop_header618.us.5.preheader, %polly.loop_header618.us.5
  ...
  %exitcond1056.5.not = icmp eq i64 %polly.indvar622.us.5, %258
...
polly.loop_header618.us.6:                        ; preds = %polly.loop_header618.us.6.preheader, %polly.loop_header618.us.6
  ...
  %exitcond1056.6.not = icmp eq i64 %polly.indvar622.us.6, %258
...
polly.loop_header618.us.7:                        ; preds = %polly.loop_header618.us.7.preheader, %polly.loop_header618.us.7
  ...
  %exitcond1056.7.not = icmp eq i64 %polly.indvar622.us.7, %258
