; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8976.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8976.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %pexp.p_div_q776 = udiv i8 %pexp.p_div_q.lhs.trunc, 6
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %106 = mul nuw nsw i64 %polly.indvar214, 96
...
polly.loop_header223:                             ; preds = %polly.loop_header217, %polly.loop_exit232
  %indvars.iv794 = phi i64 [ %105, %polly.loop_header217 ], [ %indvars.iv.next795, %polly.loop_exit232 ]
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph999
  ...
  %wide.load1006 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %133, label %middle.block993, label %vector.body995, !llvm.loop !76
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %137 = udiv i64 %polly.indvar363, 6
  %138 = mul nuw nsw i64 %137, 96
  %139 = sub nsw i64 %indvars.iv804, %138
  %140 = add i64 %indvars.iv809, %138
  %pexp.p_div_q366.lhs.trunc = trunc i64 %polly.indvar363 to i8
  %pexp.p_div_q366775 = udiv i8 %pexp.p_div_q366.lhs.trunc, 6
  %pexp.p_div_q366.zext = zext i8 %pexp.p_div_q366775 to i64
  %141 = shl nsw i64 %polly.indvar363, 4
  %142 = mul nsw i64 %polly.indvar363, -16
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv811 = phi i64 [ %indvars.iv.next812, %polly.loop_exit375 ], [ %140, %polly.loop_header360 ]
  %indvars.iv806 = phi i64 [ %indvars.iv.next807, %polly.loop_exit375 ], [ %139, %polly.loop_header360 ]
  ...
  %143 = add i64 %smax808, %indvars.iv811
  %144 = mul nuw nsw i64 %polly.indvar370, 96
...
polly.loop_exit382:                               ; preds = %polly.loop_exit390
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar376, %136
...
polly.loop_header380:                             ; preds = %polly.loop_header373, %polly.loop_exit390
  %indvars.iv813 = phi i64 [ %143, %polly.loop_header373 ], [ %indvars.iv.next814, %polly.loop_exit390 ]
...
vector.body971:                                   ; preds = %vector.body971, %vector.ph973
  ...
  %wide.load980 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %171, label %middle.block969, label %vector.body971, !llvm.loop !85
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %175 = udiv i64 %polly.indvar521, 6
  %176 = mul nuw nsw i64 %175, 96
  %177 = sub nsw i64 %indvars.iv825, %176
  %178 = add i64 %indvars.iv830, %176
  %pexp.p_div_q524.lhs.trunc = trunc i64 %polly.indvar521 to i8
  %pexp.p_div_q524774 = udiv i8 %pexp.p_div_q524.lhs.trunc, 6
  %pexp.p_div_q524.zext = zext i8 %pexp.p_div_q524774 to i64
  %179 = shl nsw i64 %polly.indvar521, 4
  %180 = mul nsw i64 %polly.indvar521, -16
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv832 = phi i64 [ %indvars.iv.next833, %polly.loop_exit533 ], [ %178, %polly.loop_header518 ]
  %indvars.iv827 = phi i64 [ %indvars.iv.next828, %polly.loop_exit533 ], [ %177, %polly.loop_header518 ]
  ...
  %181 = add i64 %smax829, %indvars.iv832
  %182 = mul nuw nsw i64 %polly.indvar528, 96
  %183 = sub nsw i64 %179, %182
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %186 = mul nsw i64 %polly.indvar528, -96
...
polly.loop_exit540:                               ; preds = %polly.loop_exit548
  ...
  %exitcond841.not = icmp eq i64 %polly.indvar534, %174
...
polly.loop_header538:                             ; preds = %polly.loop_header531, %polly.loop_exit548
  %indvars.iv834 = phi i64 [ %181, %polly.loop_header531 ], [ %indvars.iv.next835, %polly.loop_exit548 ]
...
vector.body909:                                   ; preds = %vector.body909, %vector.ph911
  ...
  br i1 %223, label %polly.loop_exit714, label %vector.body909, !llvm.loop !94
...
vector.body924:                                   ; preds = %vector.body924, %vector.ph927
  ...
  br i1 %252, label %polly.loop_exit741, label %vector.body924, !llvm.loop !97
...
vector.body942:                                   ; preds = %vector.body942, %vector.ph945
  ...
  br i1 %281, label %polly.loop_exit767, label %vector.body942, !llvm.loop !100
