; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3666.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3666.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %98 = udiv i64 %indvars.iv1010, 24
  %99 = mul nuw nsw i64 %98, 96
  %100 = sub nsw i64 %indvars.iv, %99
  %101 = add i64 %indvars.iv1014, %99
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %106 = add i64 %smax, %indvars.iv1016
...
polly.loop_header223.us:                          ; preds = %polly.loop_header217.us, %polly.loop_header223.us
  ...
  %exitcond1008.not = icmp eq i64 %polly.indvar226.us, %110
...
polly.loop_header248.preheader:                   ; preds = %polly.loop_exit236, %polly.loop_exit236.us, %polly.loop_header211.split
  ...
  %123 = mul nsw i64 %polly.indvar214, -96
  %124 = icmp slt i64 %123, -1104
  %125 = select i1 %124, i64 %123, i64 -1104
...
polly.loop_exit257:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1021.not = icmp eq i64 %polly.indvar_next252, 20
...
polly.loop_header255:                             ; preds = %polly.loop_header248, %polly.loop_exit265
  %indvars.iv1018 = phi i64 [ %106, %polly.loop_header248 ], [ %indvars.iv.next1019, %polly.loop_exit265 ]
...
vector.body1227:                                  ; preds = %vector.body1227, %vector.ph1231
  ...
  %wide.load1238 = load <4 x double>, <4 x double>* %144, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %147, label %middle.block1225, label %vector.body1227, !llvm.loop !84
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %150 = udiv i64 %indvars.iv1031, 24
  %151 = mul nuw nsw i64 %150, 96
  %152 = sub nsw i64 %indvars.iv1029, %151
  %153 = add i64 %indvars.iv1036, %151
  %154 = trunc i64 %polly.indvar400 to i16
  %pexp.p_div_q403.lhs.trunc = mul i16 %154, 5
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039, %polly.loop_exit445 ], [ %153, %polly.loop_header397 ]
  %indvars.iv1033 = phi i64 [ %indvars.iv.next1034, %polly.loop_exit445 ], [ %152, %polly.loop_header397 ]
  ...
  %158 = add i64 %smax1035, %indvars.iv1038
  %159 = mul nuw nsw i64 %polly.indvar407, 96
...
polly.loop_header417.us:                          ; preds = %polly.loop_header410.us, %polly.loop_header417.us
  ...
  %exitcond1027.not = icmp eq i64 %polly.indvar421.us, %162
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header404.split
  ...
  %175 = mul nsw i64 %polly.indvar407, -96
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1044.not = icmp eq i64 %polly.indvar_next447, 20
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1040 = phi i64 [ %158, %polly.loop_header443 ], [ %indvars.iv.next1041, %polly.loop_exit460 ]
...
vector.body1203:                                  ; preds = %vector.body1203, %vector.ph1205
  ...
  %wide.load1212 = load <4 x double>, <4 x double>* %196, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %199, label %middle.block1201, label %vector.body1203, !llvm.loop !94
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %202 = udiv i64 %indvars.iv1054, 24
  %203 = mul nuw nsw i64 %202, 96
  %204 = sub nsw i64 %indvars.iv1052, %203
  %205 = add i64 %indvars.iv1059, %203
  %206 = trunc i64 %polly.indvar595 to i16
  %pexp.p_div_q598.lhs.trunc = mul i16 %206, 5
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  %indvars.iv1061 = phi i64 [ %indvars.iv.next1062, %polly.loop_exit640 ], [ %205, %polly.loop_header592 ]
  %indvars.iv1056 = phi i64 [ %indvars.iv.next1057, %polly.loop_exit640 ], [ %204, %polly.loop_header592 ]
  ...
  %210 = add i64 %smax1058, %indvars.iv1061
  %211 = mul nuw nsw i64 %polly.indvar602, 96
...
polly.loop_header612.us:                          ; preds = %polly.loop_header605.us, %polly.loop_header612.us
  ...
  %exitcond1050.not = icmp eq i64 %polly.indvar616.us, %214
...
polly.loop_header638.preheader:                   ; preds = %polly.loop_exit626, %polly.loop_exit626.us, %polly.loop_header599.split
  ...
  %227 = mul nsw i64 %polly.indvar602, -96
...
polly.loop_exit647:                               ; preds = %polly.loop_exit655
  ...
  %exitcond1067.not = icmp eq i64 %polly.indvar_next642, 20
...
polly.loop_header645:                             ; preds = %polly.loop_header638, %polly.loop_exit655
  %indvars.iv1063 = phi i64 [ %210, %polly.loop_header638 ], [ %indvars.iv.next1064, %polly.loop_exit655 ]
...
vector.body1141:                                  ; preds = %vector.body1141, %vector.ph1143
  ...
  br i1 %265, label %polly.loop_exit823, label %vector.body1141, !llvm.loop !103
...
vector.body1156:                                  ; preds = %vector.body1156, %vector.ph1159
  ...
  br i1 %294, label %polly.loop_exit850, label %vector.body1156, !llvm.loop !106
...
vector.body1174:                                  ; preds = %vector.body1174, %vector.ph1177
  ...
  br i1 %323, label %polly.loop_exit876, label %vector.body1174, !llvm.loop !109
