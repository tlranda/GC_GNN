; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8913.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8913.c"
...
vector.body1004:                                  ; preds = %vector.body1004, %vector.ph1008
  ...
  %wide.load1015 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %132, label %middle.block1002, label %vector.body1004, !llvm.loop !76
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph982
  ...
  %wide.load989 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %169, label %middle.block978, label %vector.body980, !llvm.loop !85
...
vector.body918:                                   ; preds = %vector.body918, %vector.ph920
  ...
  br i1 %220, label %polly.loop_exit720, label %vector.body918, !llvm.loop !94
...
vector.body933:                                   ; preds = %vector.body933, %vector.ph936
  ...
  br i1 %249, label %polly.loop_exit747, label %vector.body933, !llvm.loop !97
...
vector.body951:                                   ; preds = %vector.body951, %vector.ph954
  ...
  br i1 %278, label %polly.loop_exit773, label %vector.body951, !llvm.loop !100
