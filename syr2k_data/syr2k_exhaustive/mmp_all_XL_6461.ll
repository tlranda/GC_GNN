; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6461.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6461.c"
...
vector.body1071:                                  ; preds = %vector.body1071, %vector.ph1075
  ...
  %wide.load1082 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %132, label %middle.block1069, label %vector.body1071, !llvm.loop !84
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1049
  ...
  %wide.load1056 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %169, label %middle.block1045, label %vector.body1047, !llvm.loop !94
...
vector.body986:                                   ; preds = %vector.body986, %vector.ph987
  ...
  br i1 %220, label %polly.loop_exit772, label %vector.body986, !llvm.loop !103
...
vector.body1000:                                  ; preds = %vector.body1000, %vector.ph1003
  ...
  br i1 %249, label %polly.loop_exit799, label %vector.body1000, !llvm.loop !106
...
vector.body1018:                                  ; preds = %vector.body1018, %vector.ph1021
  ...
  br i1 %278, label %polly.loop_exit825, label %vector.body1018, !llvm.loop !109
