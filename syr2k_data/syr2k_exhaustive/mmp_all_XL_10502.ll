; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10502.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10502.c"
...
polly.loop_exit369:                               ; preds = %polly.loop_exit376
  ...
  %exitcond818.not = icmp eq i64 %polly.indvar_next364, 10
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %132 = shl nsw i64 %polly.indvar370, 8
  %133 = add nsw i64 %132, %129
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard377 = icmp slt i64 %135, 100
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %160 = mul nsw i64 %polly.indvar515, -100
  %161 = mul nuw nsw i64 %polly.indvar515, 100
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %162 = mul nuw nsw i64 %polly.indvar521, 100
...
polly.loop_exit527:                               ; preds = %polly.loop_exit534
  ...
  %exitcond839.not = icmp eq i64 %polly.indvar_next522, 10
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %163 = shl nsw i64 %polly.indvar528, 8
  %164 = add nsw i64 %163, %160
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard535 = icmp slt i64 %166, 100
...
polly.loop_exit548.loopexit.us:                   ; preds = %polly.loop_header546.us
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next543.us, 100
