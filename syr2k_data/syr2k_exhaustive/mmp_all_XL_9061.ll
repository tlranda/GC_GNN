; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9061.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9061.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin800 = call i64 @llvm.smin.i64(i64 %indvars.iv798, i64 -872)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next799 = add nsw i64 %indvars.iv798, -128
  %exitcond803.not = icmp eq i64 %polly.indvar_next203, 8
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond826.not = icmp eq i64 %polly.indvar_next358, 8
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %smin846 = call i64 @llvm.smin.i64(i64 %indvars.iv844, i64 -872)
  %179 = shl nsw i64 %polly.indvar515, 7
