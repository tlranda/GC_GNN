; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5855.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5855.c"
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -12
  %indvars.iv.next865 = add nuw nsw i64 %indvars.iv864, 3
  %indvars.iv.next869 = add nuw nsw i64 %indvars.iv868, 12
  %exitcond878.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_exit408:                               ; preds = %polly.loop_exit415, %polly.loop_exit390
  ...
  %indvars.iv.next890 = add nsw i64 %indvars.iv889, -12
  %indvars.iv.next892 = add nuw nsw i64 %indvars.iv891, 3
  %indvars.iv.next897 = add nuw nsw i64 %indvars.iv896, 12
  %exitcond906.not = icmp eq i64 %polly.indvar_next386, 60
...
polly.loop_header420:                             ; preds = %polly.loop_header413, %polly.loop_exit430
  ...
  %smin902 = call i64 @llvm.smin.i64(i64 %indvars.iv900, i64 19)
...
polly.loop_header562:                             ; preds = %polly.loop_exit588, %polly.loop_header556
  ...
  %189 = mul nuw nsw i64 %polly.indvar565, 20
  br label %polly.loop_header568

polly.loop_exit570:                               ; preds = %polly.loop_exit576
  %190 = mul nsw i64 %polly.indvar565, -20
...
polly.loop_exit588:                               ; preds = %polly.loop_exit595, %polly.loop_exit570
  ...
  %indvars.iv.next911 = add nsw i64 %indvars.iv910, -20
  %indvars.iv.next918 = add nsw i64 %indvars.iv917, -12
  %indvars.iv.next920 = add nuw nsw i64 %indvars.iv919, 3
  %indvars.iv.next925 = add nuw nsw i64 %indvars.iv924, 12
  %exitcond934.not = icmp eq i64 %polly.indvar_next566, 60
...
polly.loop_header600:                             ; preds = %polly.loop_header593, %polly.loop_exit610
  ...
  %smin930 = call i64 @llvm.smin.i64(i64 %indvars.iv928, i64 19)
