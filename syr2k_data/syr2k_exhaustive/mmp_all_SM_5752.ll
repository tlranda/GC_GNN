; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5752.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5752.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit229, %polly.loop_header199
  ...
  %100 = add i64 %indvars.iv854, %99
  %101 = sub nsw i64 %indvars.iv860, %99
  %102 = shl nsw i64 %polly.indvar208, 8
  br label %polly.loop_header211

polly.loop_exit213:                               ; preds = %polly.loop_exit219
  %103 = mul nsw i64 %polly.indvar208, -256
  %104 = mul nuw nsw i64 %polly.indvar208, 13
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233.us, %polly.loop_exit248.us
  ...
  %116 = add i64 %polly.indvar242.us, %110
  %117 = add i64 %116, %103
...
polly.loop_header246.us:                          ; preds = %polly.loop_header246.preheader.us, %polly.loop_header246.us
  ...
  %118 = add nuw nsw i64 %polly.indvar250.us, %102
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %136 = udiv i64 %indvars.iv878, 5
  %137 = mul nuw nsw i64 %136, 20
  %138 = add i64 %indvars.iv876, %137
  %139 = sub nsw i64 %indvars.iv883, %137
  %140 = shl nsw i64 %polly.indvar383, 8
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %141 = mul nsw i64 %polly.indvar383, -256
  %142 = mul nuw nsw i64 %polly.indvar383, 13
  %143 = add nuw nsw i64 %polly.indvar383, 4
  %pexp.p_div_q402 = udiv i64 %143, 5
  %144 = sub nsw i64 %142, %pexp.p_div_q402
...
polly.loop_header392:                             ; preds = %polly.loop_header392, %polly.loop_header386
  ...
  %146 = add nuw nsw i64 %polly.indvar395, %140
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit411 ], [ %139, %polly.loop_exit388 ]
  %indvars.iv880 = phi i64 [ %indvars.iv.next881, %polly.loop_exit411 ], [ %138, %polly.loop_exit388 ]
  ...
  %148 = mul nsw i64 %polly.indvar406, 20
...
polly.loop_header416.us:                          ; preds = %polly.loop_header409.us, %polly.loop_exit426.us
  ...
  %154 = add i64 %polly.indvar420.us, %148
  %155 = add i64 %154, %141
...
polly.loop_header424.us:                          ; preds = %polly.loop_header424.preheader.us, %polly.loop_header424.us
  ...
  %156 = add nuw nsw i64 %polly.indvar428.us, %140
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %174 = udiv i64 %indvars.iv902, 5
  %175 = mul nuw nsw i64 %174, 20
  %176 = add i64 %indvars.iv900, %175
  %177 = sub nsw i64 %indvars.iv907, %175
  %178 = shl nsw i64 %polly.indvar561, 8
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %179 = mul nsw i64 %polly.indvar561, -256
  %180 = mul nuw nsw i64 %polly.indvar561, 13
  %181 = add nuw nsw i64 %polly.indvar561, 4
  %pexp.p_div_q580 = udiv i64 %181, 5
  %182 = sub nsw i64 %180, %pexp.p_div_q580
...
polly.loop_header570:                             ; preds = %polly.loop_header570, %polly.loop_header564
  ...
  %184 = add nuw nsw i64 %polly.indvar573, %178
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  %indvars.iv909 = phi i64 [ %indvars.iv.next910, %polly.loop_exit589 ], [ %177, %polly.loop_exit566 ]
  %indvars.iv904 = phi i64 [ %indvars.iv.next905, %polly.loop_exit589 ], [ %176, %polly.loop_exit566 ]
  ...
  %186 = mul nsw i64 %polly.indvar584, 20
...
polly.loop_header594.us:                          ; preds = %polly.loop_header587.us, %polly.loop_exit604.us
  ...
  %192 = add i64 %polly.indvar598.us, %186
  %193 = add i64 %192, %179
...
polly.loop_header602.us:                          ; preds = %polly.loop_header602.preheader.us, %polly.loop_header602.us
  ...
  %194 = add nuw nsw i64 %polly.indvar606.us, %178
