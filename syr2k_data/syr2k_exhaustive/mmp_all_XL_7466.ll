; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7466.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7466.c"
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  %smin855 = call i64 @llvm.smin.i64(i64 %indvars.iv853, i64 -920)
  %107 = mul nuw nsw i64 %polly.indvar224, 80
...
polly.loop_exit229:                               ; preds = %polly.loop_exit236, %polly.loop_header221
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar_next225, 13
...
polly.loop_header392:                             ; preds = %polly.loop_exit384, %polly.loop_exit400
  ...
  %.inv838 = icmp slt i64 %138, 11
  %140 = select i1 %.inv838, i64 %139, i64 11
  %polly.loop_guard409 = icmp sgt i64 %140, -1
  %141 = mul nsw i64 %polly.indvar395, -64
  %142 = icmp slt i64 %141, -1136
  %143 = select i1 %142, i64 %141, i64 -1136
  %144 = add nsw i64 %143, 1199
  %145 = shl nsw i64 %polly.indvar395, 6
...
polly.loop_header406.preheader:                   ; preds = %polly.loop_header398
  ...
  %146 = mul nuw nsw i64 %polly.indvar401, 80
...
polly.loop_exit408:                               ; preds = %polly.loop_exit416, %polly.loop_header398
  ...
  %exitcond882.not = icmp eq i64 %polly.indvar_next402, 13
...
polly.loop_exit416:                               ; preds = %polly.loop_exit423, %polly.loop_header406
  ...
  %indvars.iv.next872 = add i64 %indvars.iv871, -100
...
polly.loop_header414:                             ; preds = %polly.loop_header414.preheader, %polly.loop_exit423
  ...
  %smin875 = call i64 @llvm.smin.i64(i64 %indvars.iv873, i64 99)
...
polly.loop_header572:                             ; preds = %polly.loop_exit564, %polly.loop_exit580
  ...
  %.inv839 = icmp slt i64 %177, 11
  %179 = select i1 %.inv839, i64 %178, i64 11
  %polly.loop_guard589 = icmp sgt i64 %179, -1
  %180 = mul nsw i64 %polly.indvar575, -64
  %181 = icmp slt i64 %180, -1136
  %182 = select i1 %181, i64 %180, i64 -1136
  %183 = add nsw i64 %182, 1199
  %184 = shl nsw i64 %polly.indvar575, 6
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header578
  ...
  %185 = mul nuw nsw i64 %polly.indvar581, 80
...
polly.loop_exit588:                               ; preds = %polly.loop_exit596, %polly.loop_header578
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar_next582, 13
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit596
  ...
  %187 = mul nsw i64 %polly.indvar590, 100
