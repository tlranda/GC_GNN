; ModuleID = 'syr2k_exhaustive/mmp_all_SM_1031.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_1031.c"
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1054.not = icmp eq i64 %polly.indvar_next204, 20
...
polly.merge.us:                                   ; preds = %polly.loop_header251.us, %polly.loop_exit242.us
  ...
  %exitcond1039.not = icmp eq i64 %polly.indvar_next238.us, 50
...
polly.merge:                                      ; preds = %polly.loop_header265
  ...
  %exitcond1037.not = icmp eq i64 %polly.indvar_next238, 50
...
polly.loop_exit287:                               ; preds = %polly.loop_exit295
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar_next282, 50
...
polly.loop_header425:                             ; preds = %polly.loop_header425.preheader, %polly.loop_exit433
  ...
  %166 = mul nuw nsw i64 %polly.indvar428, 50
...
polly.loop_exit433:                               ; preds = %polly.loop_exit455
  ...
  %exitcond1083.not = icmp eq i64 %polly.indvar_next429, 20
...
polly.loop_exit445:                               ; preds = %polly.loop_header443
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next441, 50
...
polly.merge466.us:                                ; preds = %polly.loop_header482.us, %polly.loop_exit472.us
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next463.us, 50
...
polly.merge466:                                   ; preds = %polly.loop_header496
  ...
  %exitcond1064.not = icmp eq i64 %polly.indvar_next463, 50
...
polly.loop_exit518:                               ; preds = %polly.loop_exit526
  ...
  %exitcond1080.not = icmp eq i64 %polly.indvar_next513, 50
...
polly.start552:                                   ; preds = %init_array.exit
  %malloccall554 = tail call dereferenceable_or_null(480000) i8* @malloc(i64 480000) #6
  %malloccall556 = tail call dereferenceable_or_null(480000) i8* @malloc(i64 480000) #6
...
polly.loop_header656:                             ; preds = %polly.loop_header656.preheader, %polly.loop_exit664
  ...
  %235 = mul nuw nsw i64 %polly.indvar659, 50
  br label %polly.loop_header662

polly.loop_exit664:                               ; preds = %polly.loop_exit686
  %polly.indvar_next660 = add nuw nsw i64 %polly.indvar659, 1
  %exitcond1112.not = icmp eq i64 %polly.indvar_next660, 20
...
polly.loop_exit676:                               ; preds = %polly.loop_header674
  ...
  %exitcond1089.not = icmp eq i64 %polly.indvar_next672, 50
...
polly.merge697.us:                                ; preds = %polly.loop_header713.us, %polly.loop_exit703.us
  ...
  %exitcond1095.not = icmp eq i64 %polly.indvar_next694.us, 50
...
polly.merge697:                                   ; preds = %polly.loop_header727
  ...
  %exitcond1093.not = icmp eq i64 %polly.indvar_next694, 50
...
polly.loop_exit749:                               ; preds = %polly.loop_exit757
  ...
  %exitcond1109.not = icmp eq i64 %polly.indvar_next744, 50
