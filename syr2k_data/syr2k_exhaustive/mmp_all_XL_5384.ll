; ModuleID = 'syr2k_exhaustive/mmp_all_XL_5384.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_5384.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %105 = mul nuw nsw i64 %polly.indvar208, 12
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %indvars.iv.next857 = add nuw nsw i64 %indvars.iv856, 12
  %indvars.iv.next861 = add nsw i64 %indvars.iv860, -50
  %exitcond868.not = icmp eq i64 %polly.indvar_next209, 24
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233.us, %polly.loop_exit248.us
  %indvars.iv864 = phi i64 [ %109, %polly.loop_header233.us ], [ %indvars.iv.next865, %polly.loop_exit248.us ]
  %polly.indvar242.us = phi i64 [ %113, %polly.loop_header233.us ], [ %polly.indvar_next243.us, %polly.loop_exit248.us ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv864, i64 49)
  %116 = add nuw i64 %polly.indvar242.us, %110
  %117 = add i64 %116, %104
...
polly.loop_header246.us:                          ; preds = %polly.loop_header246.preheader.us, %polly.loop_header246.us
  ...
  %118 = add nuw nsw i64 %polly.indvar250.us, %103
...
polly.loop_header246.preheader.us:                ; preds = %polly.loop_header239.us
  %polly.access.add.Packed_MemRef_call2257.us = add nsw i64 %polly.access.mul.Packed_MemRef_call2256.us, %117
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241.loopexit.us, %polly.loop_header227
  ...
  %indvars.iv.next859 = add i64 %indvars.iv858, -4
  %indvars.iv.next863 = add i64 %indvars.iv862, 4
...
vector.body1060:                                  ; preds = %vector.body1060, %vector.ph1064
  ...
  %128 = shl nuw nsw i64 %index1067, 3
  %129 = getelementptr i8, i8* %scevgep370, i64 %128
  %130 = bitcast i8* %129 to <4 x double>*
  %wide.load1071 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !78, !noalias !80
  %131 = fmul fast <4 x double> %wide.load1071, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %133 = icmp eq i64 %index.next1068, %n.vec1066
  br i1 %133, label %middle.block1058, label %vector.body1060, !llvm.loop !84

middle.block1058:                                 ; preds = %vector.body1060
  %cmp.n1070 = icmp eq i64 %126, %n.vec1066
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %135 = mul nuw nsw i64 %polly.indvar377, 50
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %136 = lshr i64 %polly.indvar383, 1
  %137 = add nuw i64 %indvars.iv878, %136
  %138 = shl nuw nsw i64 %137, 2
  %139 = sub i64 %indvars.iv876, %138
  %140 = add i64 %indvars.iv883, %138
  %141 = mul nuw nsw i64 %polly.indvar383, 50
  br label %polly.loop_header386

polly.loop_exit388:                               ; preds = %polly.loop_exit394
  %142 = mul nsw i64 %polly.indvar383, -50
  %143 = mul nuw nsw i64 %polly.indvar383, 12
  %144 = add nuw nsw i64 %143, %136
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit411
  %polly.indvar_next384 = add nuw nsw i64 %polly.indvar383, 1
  %indvars.iv.next873 = add nsw i64 %indvars.iv872, -50
  %indvars.iv.next877 = add nuw nsw i64 %indvars.iv876, 50
  %indvars.iv.next879 = add nuw nsw i64 %indvars.iv878, 12
  %indvars.iv.next884 = add nsw i64 %indvars.iv883, -50
  %exitcond892.not = icmp eq i64 %polly.indvar_next384, 24
...
polly.loop_header386:                             ; preds = %polly.loop_exit394, %polly.loop_header380
  ...
  %145 = add nuw nsw i64 %polly.indvar389, %135
...
polly.loop_header392:                             ; preds = %polly.loop_header392, %polly.loop_header386
  ...
  %146 = add nuw nsw i64 %polly.indvar395, %141
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  %indvars.iv885 = phi i64 [ %indvars.iv.next886, %polly.loop_exit411 ], [ %140, %polly.loop_exit388 ]
  %indvars.iv880 = phi i64 [ %indvars.iv.next881, %polly.loop_exit411 ], [ %139, %polly.loop_exit388 ]
  %polly.indvar406 = phi i64 [ %polly.indvar_next407, %polly.loop_exit411 ], [ %144, %polly.loop_exit388 ]
  %smax882 = call i64 @llvm.smax.i64(i64 %indvars.iv880, i64 0)
  %147 = add i64 %smax882, %indvars.iv885
  %148 = shl nsw i64 %polly.indvar406, 2
  %149 = sub nsw i64 %141, %148
  %150 = icmp sgt i64 %149, 0
  %151 = select i1 %150, i64 %149, i64 0
  %polly.loop_guard419 = icmp slt i64 %151, 4
...
polly.loop_header409.us:                          ; preds = %polly.loop_header403, %polly.loop_exit418.loopexit.us
  ...
  %152 = add nuw nsw i64 %polly.indvar412.us, %135
  %153 = shl i64 %152, 3
...
polly.loop_header416.us:                          ; preds = %polly.loop_header409.us, %polly.loop_exit426.us
  %indvars.iv887 = phi i64 [ %147, %polly.loop_header409.us ], [ %indvars.iv.next888, %polly.loop_exit426.us ]
  %polly.indvar420.us = phi i64 [ %151, %polly.loop_header409.us ], [ %polly.indvar_next421.us, %polly.loop_exit426.us ]
  %smin889 = call i64 @llvm.smin.i64(i64 %indvars.iv887, i64 49)
  %154 = add nuw i64 %polly.indvar420.us, %148
  %155 = add i64 %154, %142
  %polly.loop_guard427.us952 = icmp sgt i64 %155, -1
...
polly.loop_header424.us:                          ; preds = %polly.loop_header424.preheader.us, %polly.loop_header424.us
  ...
  %156 = add nuw nsw i64 %polly.indvar428.us, %141
...
polly.loop_header424.preheader.us:                ; preds = %polly.loop_header416.us
  %polly.access.add.Packed_MemRef_call2275435.us = add nsw i64 %polly.access.mul.Packed_MemRef_call2275434.us, %155
...
polly.loop_exit411:                               ; preds = %polly.loop_exit418.loopexit.us, %polly.loop_header403
  ...
  %indvars.iv.next881 = add i64 %indvars.iv880, -4
  %indvars.iv.next886 = add i64 %indvars.iv885, 4
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1037 = icmp ult i64 %164, 4
...
vector.body1036:                                  ; preds = %vector.body1036, %vector.ph1038
  ...
  %166 = shl nuw nsw i64 %index1041, 3
  %167 = getelementptr i8, i8* %scevgep548, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load1045 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !88, !noalias !90
  %169 = fmul fast <4 x double> %wide.load1045, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next1042, %n.vec1040
  br i1 %171, label %middle.block1034, label %vector.body1036, !llvm.loop !94

middle.block1034:                                 ; preds = %vector.body1036
  %cmp.n1044 = icmp eq i64 %164, %n.vec1040
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %173 = mul nuw nsw i64 %polly.indvar555, 50
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %174 = lshr i64 %polly.indvar561, 1
  %175 = add nuw i64 %indvars.iv902, %174
  %176 = shl nuw nsw i64 %175, 2
  %177 = sub i64 %indvars.iv900, %176
  %178 = add i64 %indvars.iv907, %176
  %179 = mul nuw nsw i64 %polly.indvar561, 50
  br label %polly.loop_header564

polly.loop_exit566:                               ; preds = %polly.loop_exit572
  %180 = mul nsw i64 %polly.indvar561, -50
  %181 = mul nuw nsw i64 %polly.indvar561, 12
  %182 = add nuw nsw i64 %181, %174
  br label %polly.loop_header581

polly.loop_exit583:                               ; preds = %polly.loop_exit589
  %polly.indvar_next562 = add nuw nsw i64 %polly.indvar561, 1
  %indvars.iv.next897 = add nsw i64 %indvars.iv896, -50
  %indvars.iv.next901 = add nuw nsw i64 %indvars.iv900, 50
  %indvars.iv.next903 = add nuw nsw i64 %indvars.iv902, 12
  %indvars.iv.next908 = add nsw i64 %indvars.iv907, -50
  %exitcond916.not = icmp eq i64 %polly.indvar_next562, 24
...
polly.loop_header564:                             ; preds = %polly.loop_exit572, %polly.loop_header558
  ...
  %183 = add nuw nsw i64 %polly.indvar567, %173
...
polly.loop_header570:                             ; preds = %polly.loop_header570, %polly.loop_header564
  ...
  %184 = add nuw nsw i64 %polly.indvar573, %179
  %polly.access.mul.call2577 = mul nuw nsw i64 %184, 1000
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  %indvars.iv909 = phi i64 [ %indvars.iv.next910, %polly.loop_exit589 ], [ %178, %polly.loop_exit566 ]
  %indvars.iv904 = phi i64 [ %indvars.iv.next905, %polly.loop_exit589 ], [ %177, %polly.loop_exit566 ]
  %polly.indvar584 = phi i64 [ %polly.indvar_next585, %polly.loop_exit589 ], [ %182, %polly.loop_exit566 ]
  %smax906 = call i64 @llvm.smax.i64(i64 %indvars.iv904, i64 0)
  %185 = add i64 %smax906, %indvars.iv909
  %186 = shl nsw i64 %polly.indvar584, 2
  %187 = sub nsw i64 %179, %186
  %188 = icmp sgt i64 %187, 0
  %189 = select i1 %188, i64 %187, i64 0
  %polly.loop_guard597 = icmp slt i64 %189, 4
...
polly.loop_header587.us:                          ; preds = %polly.loop_header581, %polly.loop_exit596.loopexit.us
  ...
  %190 = add nuw nsw i64 %polly.indvar590.us, %173
  %191 = shl i64 %190, 3
...
polly.loop_header594.us:                          ; preds = %polly.loop_header587.us, %polly.loop_exit604.us
  %indvars.iv911 = phi i64 [ %185, %polly.loop_header587.us ], [ %indvars.iv.next912, %polly.loop_exit604.us ]
  %polly.indvar598.us = phi i64 [ %189, %polly.loop_header587.us ], [ %polly.indvar_next599.us, %polly.loop_exit604.us ]
  %smin913 = call i64 @llvm.smin.i64(i64 %indvars.iv911, i64 49)
  %192 = add nuw i64 %polly.indvar598.us, %186
  %193 = add i64 %192, %180
...
polly.loop_header602.us:                          ; preds = %polly.loop_header602.preheader.us, %polly.loop_header602.us
  ...
  %194 = add nuw nsw i64 %polly.indvar606.us, %179
...
polly.loop_header602.preheader.us:                ; preds = %polly.loop_header594.us
  %polly.access.add.Packed_MemRef_call2453613.us = add nsw i64 %polly.access.mul.Packed_MemRef_call2453612.us, %193
...
polly.loop_exit589:                               ; preds = %polly.loop_exit596.loopexit.us, %polly.loop_header581
  ...
  %indvars.iv.next905 = add i64 %indvars.iv904, -4
  %indvars.iv.next910 = add i64 %indvars.iv909, 4
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin975 = call i64 @llvm.smin.i64(i64 %204, i64 -1168)
  %205 = add nsw i64 %smin975, 1200
...
vector.ph976:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert983 = insertelement <4 x i64> poison, i64 %206, i32 0
  %broadcast.splat984 = shufflevector <4 x i64> %broadcast.splatinsert983, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert985 = insertelement <4 x i32> poison, i32 %209, i32 0
...
vector.body974:                                   ; preds = %vector.body974, %vector.ph976
  ...
  %211 = add nuw nsw <4 x i64> %vec.ind981, %broadcast.splat984
  %212 = trunc <4 x i64> %211 to <4 x i32>
  %213 = mul <4 x i32> %broadcast.splat986, %212
  ...
  %223 = icmp eq i64 %index.next978, %205
  br i1 %223, label %polly.loop_exit772, label %vector.body974, !llvm.loop !103
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin990 = call i64 @llvm.smin.i64(i64 %233, i64 -968)
  %234 = add nsw i64 %smin990, 1000
...
vector.body989:                                   ; preds = %vector.body989, %vector.ph992
  ...
  %240 = add nuw nsw <4 x i64> %vec.ind999, %broadcast.splat1002
  %241 = trunc <4 x i64> %240 to <4 x i32>
  %242 = mul <4 x i32> %broadcast.splat1004, %241
  ...
  %252 = icmp eq i64 %index.next996, %234
  br i1 %252, label %polly.loop_exit799, label %vector.body989, !llvm.loop !106
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1008 = call i64 @llvm.smin.i64(i64 %262, i64 -968)
  %263 = add nsw i64 %smin1008, 1000
...
vector.body1007:                                  ; preds = %vector.body1007, %vector.ph1010
  ...
  %269 = add nuw nsw <4 x i64> %vec.ind1017, %broadcast.splat1020
  %270 = trunc <4 x i64> %269 to <4 x i32>
  %271 = mul <4 x i32> %broadcast.splat1022, %270
  ...
  %281 = icmp eq i64 %index.next1014, %263
  br i1 %281, label %polly.loop_exit825, label %vector.body1007, !llvm.loop !109
