; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7407.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7407.c"
...
vector.body1048:                                  ; preds = %vector.body1048, %vector.ph1052
  ...
  %wide.load1059 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %129, label %middle.block1046, label %vector.body1048, !llvm.loop !80
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1026
  ...
  %wide.load1033 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %163, label %middle.block1022, label %vector.body1024, !llvm.loop !90
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph964
  ...
  br i1 %211, label %polly.loop_exit770, label %vector.body962, !llvm.loop !99
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph980
  ...
  br i1 %240, label %polly.loop_exit797, label %vector.body977, !llvm.loop !102
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %269, label %polly.loop_exit823, label %vector.body995, !llvm.loop !105
