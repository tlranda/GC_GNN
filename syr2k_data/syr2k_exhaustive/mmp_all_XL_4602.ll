; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4602.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4602.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit220
  ...
  %polly.loop_guard221 = icmp slt i64 %117, 50
...
polly.loop_header218:                             ; preds = %polly.loop_header218.preheader, %polly.loop_exit252
  ...
  %polly.loop_guard2351078 = icmp sgt i64 %121, -1
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1190
  ...
  %136 = shl nuw nsw i64 %index1193, 3
  %137 = getelementptr i8, i8* %scevgep381, i64 %136
  %138 = bitcast i8* %137 to <4 x double>*
  %wide.load1197 = load <4 x double>, <4 x double>* %138, align 8, !alias.scope !74, !noalias !76
  %139 = fmul fast <4 x double> %wide.load1197, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %141 = icmp eq i64 %index.next1194, %n.vec1192
  br i1 %141, label %middle.block1184, label %vector.body1186, !llvm.loop !80

middle.block1184:                                 ; preds = %vector.body1186
  %cmp.n1196 = icmp eq i64 %134, %n.vec1192
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %143 = shl nuw nsw i64 %polly.indvar388, 1
  %144 = mul nuw nsw i64 %polly.indvar388, 7
  %145 = add nuw nsw i64 %144, 7
  %pexp.p_div_q397 = lshr i64 %145, 4
  %146 = sub nsw i64 %143, %pexp.p_div_q397
  %polly.loop_guard402 = icmp sgt i64 %146, -2
  %147 = mul nsw i64 %polly.indvar388, -50
  %148 = mul nuw nsw i64 %polly.indvar388, 50
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %160 = shl nsw i64 %polly.indvar403, 5
  %161 = add nsw i64 %160, %147
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %polly.loop_guard410 = icmp slt i64 %163, 50
...
polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit445
  %indvars.iv1010 = phi i64 [ %164, %polly.loop_header407.preheader ], [ %indvars.iv.next1011, %polly.loop_exit445 ]
  ...
  %polly.loop_guard4241079 = icmp sgt i64 %167, -1
...
polly.loop_header562:                             ; preds = %polly.loop_exit570, %polly.start476
  ...
  %min.iters.check1163 = icmp ult i64 %180, 4
...
vector.body1162:                                  ; preds = %vector.body1162, %vector.ph1164
  ...
  %182 = shl nuw nsw i64 %index1167, 3
  %183 = getelementptr i8, i8* %scevgep574, i64 %182
  %184 = bitcast i8* %183 to <4 x double>*
  %wide.load1171 = load <4 x double>, <4 x double>* %184, align 8, !alias.scope !84, !noalias !86
  %185 = fmul fast <4 x double> %wide.load1171, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %187 = icmp eq i64 %index.next1168, %n.vec1166
  br i1 %187, label %middle.block1160, label %vector.body1162, !llvm.loop !90

middle.block1160:                                 ; preds = %vector.body1162
  %cmp.n1170 = icmp eq i64 %180, %n.vec1166
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %189 = shl nuw nsw i64 %polly.indvar581, 1
  %190 = mul nuw nsw i64 %polly.indvar581, 7
  %191 = add nuw nsw i64 %190, 7
  %pexp.p_div_q590 = lshr i64 %191, 4
  %192 = sub nsw i64 %189, %pexp.p_div_q590
  %polly.loop_guard595 = icmp sgt i64 %192, -2
  %193 = mul nsw i64 %polly.indvar581, -50
  %194 = mul nuw nsw i64 %polly.indvar581, 50
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %206 = shl nsw i64 %polly.indvar596, 5
  %207 = add nsw i64 %206, %193
  %208 = icmp sgt i64 %207, 0
  %209 = select i1 %208, i64 %207, i64 0
  %polly.loop_guard603 = icmp slt i64 %209, 50
...
polly.loop_header600.preheader:                   ; preds = %polly.loop_header592
  ...
  %210 = add i64 %smax1027, %indvars.iv1030
  %211 = sub nsw i64 %194, %206
  %212 = add nuw nsw i64 %206, 32
...
polly.loop_exit602:                               ; preds = %polly.loop_exit638, %polly.loop_header592
  ...
  %polly.loop_cond598.not = icmp sgt i64 %polly.indvar596, %192
...
polly.loop_header600:                             ; preds = %polly.loop_header600.preheader, %polly.loop_exit638
  %indvars.iv1032 = phi i64 [ %210, %polly.loop_header600.preheader ], [ %indvars.iv.next1033, %polly.loop_exit638 ]
  ...
  %polly.loop_guard6171080 = icmp sgt i64 %213, -1
...
vector.ph1102:                                    ; preds = %polly.loop_header805
  %broadcast.splatinsert1109 = insertelement <4 x i64> poison, i64 %230, i32 0
  %broadcast.splat1110 = shufflevector <4 x i64> %broadcast.splatinsert1109, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1111 = insertelement <4 x i32> poison, i32 %233, i32 0
...
vector.body1101:                                  ; preds = %vector.body1101, %vector.ph1102
  ...
  %235 = add nuw nsw <4 x i64> %vec.ind1107, %broadcast.splat1110
  %236 = trunc <4 x i64> %235 to <4 x i32>
  %237 = mul <4 x i32> %broadcast.splat1112, %236
  ...
  %247 = icmp eq i64 %index.next1104, %229
  br i1 %247, label %polly.loop_exit813, label %vector.body1101, !llvm.loop !99

polly.loop_exit813:                               ; preds = %vector.body1101, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond1071.not = icmp eq i64 %polly.indvar808, %227
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond1067.not = icmp eq i64 %polly.indvar814, %231
...
polly.loop_header826:                             ; preds = %polly.loop_exit834, %polly.loop_header820
  ...
  %smin1116 = call i64 @llvm.smin.i64(i64 %257, i64 -968)
  %258 = add nsw i64 %smin1116, 1000
  %smin1056 = call i64 @llvm.smin.i64(i64 %indvars.iv1054, i64 -968)
  %259 = shl nsw i64 %polly.indvar829, 5
  %260 = add nsw i64 %smin1056, 999
...
vector.body1115:                                  ; preds = %vector.body1115, %vector.ph1118
  ...
  %264 = add nuw nsw <4 x i64> %vec.ind1125, %broadcast.splat1128
  %265 = trunc <4 x i64> %264 to <4 x i32>
  %266 = mul <4 x i32> %broadcast.splat1130, %265
  ...
  %276 = icmp eq i64 %index.next1122, %258
  br i1 %276, label %polly.loop_exit840, label %vector.body1115, !llvm.loop !102

polly.loop_exit840:                               ; preds = %vector.body1115, %polly.loop_header838
  %polly.indvar_next836 = add nuw nsw i64 %polly.indvar835, 1
  %exitcond1061.not = icmp eq i64 %polly.indvar835, %256
...
polly.loop_header838:                             ; preds = %polly.loop_header832, %polly.loop_header838
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar841, %260
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %smin1134 = call i64 @llvm.smin.i64(i64 %286, i64 -968)
  %287 = add nsw i64 %smin1134, 1000
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv1044, i64 -968)
  %288 = shl nsw i64 %polly.indvar855, 5
  %289 = add nsw i64 %smin1046, 999
...
vector.body1133:                                  ; preds = %vector.body1133, %vector.ph1136
  ...
  %293 = add nuw nsw <4 x i64> %vec.ind1143, %broadcast.splat1146
  %294 = trunc <4 x i64> %293 to <4 x i32>
  %295 = mul <4 x i32> %broadcast.splat1148, %294
  ...
  %305 = icmp eq i64 %index.next1140, %287
  br i1 %305, label %polly.loop_exit866, label %vector.body1133, !llvm.loop !105

polly.loop_exit866:                               ; preds = %vector.body1133, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1051.not = icmp eq i64 %polly.indvar861, %285
...
polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  ...
  %exitcond1047.not = icmp eq i64 %polly.indvar867, %289
