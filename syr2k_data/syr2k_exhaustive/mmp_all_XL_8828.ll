; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8828.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8828.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %indvars.iv785 = phi i64 [ %indvars.iv.next786, %polly.loop_exit207 ], [ 15, %polly.loop_exit193 ]
...
polly.loop_header205:                             ; preds = %polly.loop_header205.preheader, %polly.loop_exit213
  %indvars.iv791 = phi i64 [ %103, %polly.loop_header205.preheader ], [ %indvars.iv.next792, %polly.loop_exit213 ]
  %indvars.iv787 = phi i64 [ %104, %polly.loop_header205.preheader ], [ %indvars.iv.next788, %polly.loop_exit213 ]
  ...
  %polly.loop_guard221.not = icmp sgt i64 %111, %115
...
polly.loop_header211:                             ; preds = %polly.loop_header205, %polly.loop_exit220
  ...
  %116 = shl nuw nsw i64 %polly.indvar214, 3
  %scevgep233 = getelementptr i8, i8* %call1, i64 %116
  %scevgep237 = getelementptr i8, i8* %call2, i64 %116
  br label %polly.loop_header218

polly.loop_exit220:                               ; preds = %polly.loop_exit228
  %polly.indvar_next215 = add nuw nsw i64 %polly.indvar214, 1
  %exitcond795.not = icmp eq i64 %polly.indvar_next215, 1000
...
polly.loop_header218:                             ; preds = %polly.loop_exit228, %polly.loop_header211
  %indvars.iv793 = phi i64 [ %indvars.iv.next794, %polly.loop_exit228 ], [ %107, %polly.loop_header211 ]
  %polly.indvar222 = phi i64 [ %polly.indvar_next223, %polly.loop_exit228 ], [ %111, %polly.loop_header211 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv793, i64 99)
  %117 = add i64 %polly.indvar222, %108
  %118 = add i64 %117, %106
  %polly.loop_guard229871 = icmp sgt i64 %118, -1
  br i1 %polly.loop_guard229871, label %polly.loop_header226.preheader, label %polly.loop_exit228

polly.loop_header226.preheader:                   ; preds = %polly.loop_header218
  %119 = mul i64 %117, 8000
  %scevgep238 = getelementptr i8, i8* %scevgep237, i64 %119
  ...
  %scevgep246 = getelementptr i8, i8* %scevgep233, i64 %119
...
polly.loop_exit228:                               ; preds = %polly.loop_header226, %polly.loop_header218
  ...
  %polly.loop_cond224.not.not = icmp slt i64 %polly.indvar222, %115
...
polly.loop_header226:                             ; preds = %polly.loop_header226.preheader, %polly.loop_header226
  ...
  %121 = add nuw nsw i64 %polly.indvar230, %105
  %122 = mul nuw nsw i64 %121, 8000
  %scevgep234 = getelementptr i8, i8* %scevgep233, i64 %122
  ...
  %scevgep242 = getelementptr i8, i8* %scevgep237, i64 %122
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit364
  ...
  %indvars.iv801 = phi i64 [ %indvars.iv.next802, %polly.loop_exit364 ], [ 15, %polly.loop_exit346 ]
  ...
  %134 = shl nuw nsw i64 %indvars.iv801, 2
  %135 = and i64 %134, 9223372036854775744
  %136 = shl nuw nsw i64 %polly.indvar357, 1
  %137 = mul nuw nsw i64 %polly.indvar357, 7
  %138 = add nuw nsw i64 %137, 15
  %pexp.p_div_q360 = lshr i64 %138, 4
  %139 = sub nsw i64 %136, %pexp.p_div_q360
  %polly.loop_guard365 = icmp slt i64 %139, 19
...
polly.loop_header362.preheader:                   ; preds = %polly.loop_header354
  %140 = sub nsw i64 %indvars.iv806, %135
  %141 = add i64 %indvars.iv799, %135
  %142 = mul nuw nsw i64 %polly.indvar357, 100
  %143 = mul nsw i64 %polly.indvar357, -100
  br label %polly.loop_header362

polly.loop_exit364:                               ; preds = %polly.loop_exit371, %polly.loop_header354
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %indvars.iv.next800 = add nsw i64 %indvars.iv799, -28
  %indvars.iv.next802 = add nuw nsw i64 %indvars.iv801, 7
  %indvars.iv.next807 = add nuw nsw i64 %indvars.iv806, 28
  %exitcond815.not = icmp eq i64 %polly.indvar_next358, 12
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_exit371
  %indvars.iv808 = phi i64 [ %140, %polly.loop_header362.preheader ], [ %indvars.iv.next809, %polly.loop_exit371 ]
  %indvars.iv803 = phi i64 [ %141, %polly.loop_header362.preheader ], [ %indvars.iv.next804, %polly.loop_exit371 ]
  %polly.indvar366 = phi i64 [ %139, %polly.loop_header362.preheader ], [ %polly.indvar_next367, %polly.loop_exit371 ]
  %smax805 = call i64 @llvm.smax.i64(i64 %indvars.iv803, i64 0)
  %144 = add i64 %smax805, %indvars.iv808
  %145 = shl nsw i64 %polly.indvar366, 6
  %146 = sub nsw i64 %142, %145
  %147 = icmp sgt i64 %146, 0
  %148 = select i1 %147, i64 %146, i64 0
  %149 = mul nsw i64 %polly.indvar366, -64
  %150 = icmp slt i64 %149, -1136
  %151 = select i1 %150, i64 %149, i64 -1136
  %152 = add nsw i64 %151, 1199
  %polly.loop_guard379.not = icmp sgt i64 %148, %152
...
polly.loop_exit371:                               ; preds = %polly.loop_exit378, %polly.loop_header362
  ...
  %polly.loop_cond368 = icmp slt i64 %polly.indvar366, 18
...
polly.loop_header369:                             ; preds = %polly.loop_header362, %polly.loop_exit378
  ...
  %153 = shl nuw nsw i64 %polly.indvar372, 3
  %scevgep391 = getelementptr i8, i8* %call1, i64 %153
  %scevgep395 = getelementptr i8, i8* %call2, i64 %153
...
polly.loop_exit378:                               ; preds = %polly.loop_exit386
  ...
  %exitcond814.not = icmp eq i64 %polly.indvar_next373, 1000
...
polly.loop_header376:                             ; preds = %polly.loop_exit386, %polly.loop_header369
  %indvars.iv810 = phi i64 [ %indvars.iv.next811, %polly.loop_exit386 ], [ %144, %polly.loop_header369 ]
  %polly.indvar380 = phi i64 [ %polly.indvar_next381, %polly.loop_exit386 ], [ %148, %polly.loop_header369 ]
  %smin812 = call i64 @llvm.smin.i64(i64 %indvars.iv810, i64 99)
  %154 = add i64 %polly.indvar380, %145
  %155 = add i64 %154, %143
  %polly.loop_guard387872 = icmp sgt i64 %155, -1
  br i1 %polly.loop_guard387872, label %polly.loop_header384.preheader, label %polly.loop_exit386

polly.loop_header384.preheader:                   ; preds = %polly.loop_header376
  %156 = mul i64 %154, 8000
  %scevgep396 = getelementptr i8, i8* %scevgep395, i64 %156
  ...
  %scevgep404 = getelementptr i8, i8* %scevgep391, i64 %156
...
polly.loop_exit386:                               ; preds = %polly.loop_header384, %polly.loop_header376
  ...
  %polly.loop_cond382.not.not = icmp slt i64 %polly.indvar380, %152
...
polly.loop_header384:                             ; preds = %polly.loop_header384.preheader, %polly.loop_header384
  ...
  %158 = add nuw nsw i64 %polly.indvar388, %142
  %159 = mul nuw nsw i64 %158, 8000
  %scevgep392 = getelementptr i8, i8* %scevgep391, i64 %159
  ...
  %scevgep400 = getelementptr i8, i8* %scevgep395, i64 %159
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit522
  ...
  %indvars.iv820 = phi i64 [ %indvars.iv.next821, %polly.loop_exit522 ], [ 15, %polly.loop_exit504 ]
  ...
  %171 = shl nuw nsw i64 %indvars.iv820, 2
  %172 = and i64 %171, 9223372036854775744
  %173 = shl nuw nsw i64 %polly.indvar515, 1
  %174 = mul nuw nsw i64 %polly.indvar515, 7
  %175 = add nuw nsw i64 %174, 15
  %pexp.p_div_q518 = lshr i64 %175, 4
  %176 = sub nsw i64 %173, %pexp.p_div_q518
  %polly.loop_guard523 = icmp slt i64 %176, 19
...
polly.loop_header520.preheader:                   ; preds = %polly.loop_header512
  %177 = sub nsw i64 %indvars.iv825, %172
  %178 = add i64 %indvars.iv818, %172
  %179 = mul nuw nsw i64 %polly.indvar515, 100
  %180 = mul nsw i64 %polly.indvar515, -100
...
polly.loop_exit522:                               ; preds = %polly.loop_exit529, %polly.loop_header512
  ...
  %indvars.iv.next819 = add nsw i64 %indvars.iv818, -28
  %indvars.iv.next821 = add nuw nsw i64 %indvars.iv820, 7
  %indvars.iv.next826 = add nuw nsw i64 %indvars.iv825, 28
  %exitcond834.not = icmp eq i64 %polly.indvar_next516, 12
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit529
  %indvars.iv827 = phi i64 [ %177, %polly.loop_header520.preheader ], [ %indvars.iv.next828, %polly.loop_exit529 ]
  %indvars.iv822 = phi i64 [ %178, %polly.loop_header520.preheader ], [ %indvars.iv.next823, %polly.loop_exit529 ]
  %polly.indvar524 = phi i64 [ %176, %polly.loop_header520.preheader ], [ %polly.indvar_next525, %polly.loop_exit529 ]
  %smax824 = call i64 @llvm.smax.i64(i64 %indvars.iv822, i64 0)
  %181 = add i64 %smax824, %indvars.iv827
  %182 = shl nsw i64 %polly.indvar524, 6
  %183 = sub nsw i64 %179, %182
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %186 = mul nsw i64 %polly.indvar524, -64
  %187 = icmp slt i64 %186, -1136
  %188 = select i1 %187, i64 %186, i64 -1136
  %189 = add nsw i64 %188, 1199
  %polly.loop_guard537.not = icmp sgt i64 %185, %189
...
polly.loop_exit529:                               ; preds = %polly.loop_exit536, %polly.loop_header520
  ...
  %polly.loop_cond526 = icmp slt i64 %polly.indvar524, 18
...
polly.loop_header527:                             ; preds = %polly.loop_header520, %polly.loop_exit536
  ...
  %190 = shl nuw nsw i64 %polly.indvar530, 3
  %scevgep549 = getelementptr i8, i8* %call1, i64 %190
  %scevgep553 = getelementptr i8, i8* %call2, i64 %190
...
polly.loop_exit536:                               ; preds = %polly.loop_exit544
  ...
  %exitcond833.not = icmp eq i64 %polly.indvar_next531, 1000
...
polly.loop_header534:                             ; preds = %polly.loop_exit544, %polly.loop_header527
  %indvars.iv829 = phi i64 [ %indvars.iv.next830, %polly.loop_exit544 ], [ %181, %polly.loop_header527 ]
  %polly.indvar538 = phi i64 [ %polly.indvar_next539, %polly.loop_exit544 ], [ %185, %polly.loop_header527 ]
  %smin831 = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 99)
  %191 = add i64 %polly.indvar538, %182
  %192 = add i64 %191, %180
  %polly.loop_guard545873 = icmp sgt i64 %192, -1
  br i1 %polly.loop_guard545873, label %polly.loop_header542.preheader, label %polly.loop_exit544

polly.loop_header542.preheader:                   ; preds = %polly.loop_header534
  %193 = mul i64 %191, 8000
  %scevgep554 = getelementptr i8, i8* %scevgep553, i64 %193
  ...
  %scevgep562 = getelementptr i8, i8* %scevgep549, i64 %193
...
polly.loop_exit544:                               ; preds = %polly.loop_header542, %polly.loop_header534
  ...
  %polly.loop_cond540.not.not = icmp slt i64 %polly.indvar538, %189
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  %195 = add nuw nsw i64 %polly.indvar546, %179
  %196 = mul nuw nsw i64 %195, 8000
  %scevgep550 = getelementptr i8, i8* %scevgep549, i64 %196
  ...
  %scevgep558 = getelementptr i8, i8* %scevgep553, i64 %196
