; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2419.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2419.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1021 = add nuw nsw i64 %indvars.iv1020, 96
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %105 = shl nuw nsw i64 %polly.indvar225, 8
  %106 = add i64 %97, %105
  %smax1324 = call i64 @llvm.smax.i64(i64 %106, i64 0)
  %107 = mul nsw i64 %polly.indvar225, -256
  %108 = add i64 %98, %107
  %109 = add i64 %smax1324, %108
  %110 = shl nsw i64 %polly.indvar225, 8
...
polly.loop_exit230:                               ; preds = %polly.loop_exit261, %polly.loop_header222
  ...
  %indvars.iv.next1023 = add nsw i64 %indvars.iv1022, -256
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %117, i64 255)
  %118 = add nsw i64 %smin1327, 1
  %smin1028 = call i64 @llvm.smin.i64(i64 %indvars.iv1024, i64 255)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit423
  ...
  %155 = lshr i64 %indvars.iv1057, 3
  %156 = mul nsw i64 %polly.indvar417, -96
  %157 = icmp slt i64 %156, -1104
  %158 = select i1 %157, i64 %156, i64 -1104
  %159 = add nsw i64 %158, 1199
  %160 = mul nuw nsw i64 %polly.indvar417, 96
...
polly.loop_exit423:                               ; preds = %polly.loop_exit430
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next418, 13
...
polly.loop_header421:                             ; preds = %polly.loop_exit430, %polly.loop_header414
  ...
  %161 = shl nuw nsw i64 %polly.indvar424, 8
  %162 = add i64 %153, %161
  %smax1276 = call i64 @llvm.smax.i64(i64 %162, i64 0)
  %163 = mul nsw i64 %polly.indvar424, -256
  %164 = add i64 %154, %163
  %165 = add i64 %smax1276, %164
  %166 = shl nsw i64 %polly.indvar424, 8
...
polly.loop_exit430:                               ; preds = %polly.loop_exit466, %polly.loop_header421
  ...
  %indvars.iv.next1048 = add nsw i64 %indvars.iv1047, -256
  %exitcond1059.not = icmp eq i64 %polly.indvar424, %155
...
polly.loop_header428:                             ; preds = %polly.loop_header428.preheader, %polly.loop_exit466
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %173, i64 255)
  %174 = add nsw i64 %smin1279, 1
  %smin1054 = call i64 @llvm.smin.i64(i64 %indvars.iv1049, i64 255)
  %175 = add nsw i64 %polly.indvar432, %171
  %polly.loop_guard4451126 = icmp sgt i64 %175, -1
...
vector.body1275:                                  ; preds = %vector.body1275, %vector.ph1281
  ...
  %180 = add nuw nsw i64 %index1284, %polly.access.mul.Packed_MemRef_call1297478.us
...
polly.loop_header619:                             ; preds = %polly.loop_exit611, %polly.loop_exit628
  ...
  %209 = mul nsw i64 %polly.indvar622, -96
  %210 = mul nuw nsw i64 %polly.indvar622, 96
  %211 = lshr i64 %indvars.iv1083, 3
  %212 = mul nsw i64 %polly.indvar622, -96
  %213 = icmp slt i64 %212, -1104
  %214 = select i1 %213, i64 %212, i64 -1104
  %215 = add nsw i64 %214, 1199
  %216 = mul nuw nsw i64 %polly.indvar622, 96
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635
  ...
  %indvars.iv.next1067 = add nsw i64 %indvars.iv1066, -96
  %indvars.iv.next1072 = add nuw nsw i64 %indvars.iv1071, 96
  %indvars.iv.next1084 = add nuw nsw i64 %indvars.iv1083, 3
  %exitcond1086.not = icmp eq i64 %polly.indvar_next623, 13
...
polly.loop_header626:                             ; preds = %polly.loop_exit635, %polly.loop_header619
  ...
  %217 = shl nuw nsw i64 %polly.indvar629, 8
  %218 = add i64 %209, %217
  %smax1228 = call i64 @llvm.smax.i64(i64 %218, i64 0)
  %219 = mul nsw i64 %polly.indvar629, -256
  %220 = add i64 %210, %219
  %221 = add i64 %smax1228, %220
  %222 = shl nsw i64 %polly.indvar629, 8
...
polly.loop_exit635:                               ; preds = %polly.loop_exit671, %polly.loop_header626
  ...
  %indvars.iv.next1074 = add nsw i64 %indvars.iv1073, -256
  %exitcond1085.not = icmp eq i64 %polly.indvar629, %211
...
polly.loop_header633:                             ; preds = %polly.loop_header633.preheader, %polly.loop_exit671
  ...
  %indvars.iv1075 = phi i64 [ %226, %polly.loop_header633.preheader ], [ %indvars.iv.next1076, %polly.loop_exit671 ]
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %229, i64 255)
  %230 = add nsw i64 %smin1231, 1
  %smin1080 = call i64 @llvm.smin.i64(i64 %indvars.iv1075, i64 255)
  %231 = add nsw i64 %polly.indvar637, %227
  %polly.loop_guard6501127 = icmp sgt i64 %231, -1
...
vector.body1227:                                  ; preds = %vector.body1227, %vector.ph1233
  ...
  %236 = add nuw nsw i64 %index1236, %polly.access.mul.Packed_MemRef_call1502683.us
...
vector.body1154:                                  ; preds = %vector.body1154, %vector.ph1155
  ...
  br i1 %277, label %polly.loop_exit848, label %vector.body1154, !llvm.loop !110

polly.loop_exit848:                               ; preds = %vector.body1154, %polly.loop_header846
  %polly.indvar_next844 = add nuw nsw i64 %polly.indvar843, 1
  %exitcond1118.not = icmp eq i64 %polly.indvar843, %257
...
polly.loop_header846:                             ; preds = %polly.loop_header840, %polly.loop_header846
  ...
  %exitcond1114.not = icmp eq i64 %polly.indvar849, %261
...
vector.body1168:                                  ; preds = %vector.body1168, %vector.ph1171
  ...
  br i1 %306, label %polly.loop_exit875, label %vector.body1168, !llvm.loop !113

polly.loop_exit875:                               ; preds = %vector.body1168, %polly.loop_header873
  %polly.indvar_next871 = add nuw nsw i64 %polly.indvar870, 1
  %exitcond1108.not = icmp eq i64 %polly.indvar870, %286
...
polly.loop_header873:                             ; preds = %polly.loop_header867, %polly.loop_header873
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar876, %290
...
vector.body1186:                                  ; preds = %vector.body1186, %vector.ph1189
  ...
  br i1 %335, label %polly.loop_exit901, label %vector.body1186, !llvm.loop !116

polly.loop_exit901:                               ; preds = %vector.body1186, %polly.loop_header899
  %polly.indvar_next897 = add nuw nsw i64 %polly.indvar896, 1
  %exitcond1098.not = icmp eq i64 %polly.indvar896, %315
...
polly.loop_header899:                             ; preds = %polly.loop_header893, %polly.loop_header899
  ...
  %exitcond1094.not = icmp eq i64 %polly.indvar902, %319
