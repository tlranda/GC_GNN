; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10039.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10039.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  %indvars.iv796 = phi i64 [ %indvars.iv.next797, %polly.loop_exit207 ], [ 3, %polly.loop_exit193 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit214, %polly.loop_header199
  ...
  %indvars.iv.next797 = add nuw nsw i64 %indvars.iv796, 3
  %exitcond799.not = icmp eq i64 %polly.indvar_next203, 24
...
polly.loop_exit214:                               ; preds = %polly.loop_exit221, %polly.loop_header205
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar_next209, %98
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit221
  ...
  %polly.loop_guard229880 = icmp sgt i64 %109, -1
  %110 = add nuw nsw i64 %polly.indvar216, %102
  %111 = mul i64 %110, 8000
  %112 = mul i64 %110, 9600
  br i1 %polly.loop_guard229880, label %polly.loop_header219.us, label %polly.loop_exit221
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph999
  ...
  %120 = shl nuw nsw i64 %index1002, 3
  %121 = getelementptr i8, i8* %scevgep350, i64 %120
  %122 = bitcast i8* %121 to <4 x double>*
  %wide.load1006 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !69, !noalias !71
  %123 = fmul fast <4 x double> %wide.load1006, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %125 = icmp eq i64 %index.next1003, %n.vec1001
  br i1 %125, label %middle.block993, label %vector.body995, !llvm.loop !74

middle.block993:                                  ; preds = %vector.body995
  %cmp.n1005 = icmp eq i64 %118, %n.vec1001
...
polly.loop_header344:                             ; preds = %polly.loop_header344.preheader, %polly.loop_header344
  ...
  br i1 %exitcond822.not, label %polly.loop_exit346, label %polly.loop_header344, !llvm.loop !75

polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit364
  %indvars.iv818 = phi i64 [ %indvars.iv.next819, %polly.loop_exit364 ], [ 3, %polly.loop_exit346 ]
  %indvars.iv816 = phi i64 [ %indvars.iv.next817, %polly.loop_exit364 ], [ 1, %polly.loop_exit346 ]
  %indvars.iv807 = phi i64 [ %indvars.iv.next808, %polly.loop_exit364 ], [ 0, %polly.loop_exit346 ]
  ...
  %127 = lshr i64 %indvars.iv818, 3
  %128 = sub nsw i64 %indvars.iv816, %127
  %129 = mul nuw nsw i64 %polly.indvar357, 3
  %130 = add nuw nsw i64 %129, 3
  %pexp.p_div_q360 = lshr i64 %130, 3
...
polly.loop_exit364:                               ; preds = %polly.loop_exit372, %polly.loop_header354
  ...
  %indvars.iv.next819 = add nuw nsw i64 %indvars.iv818, 3
  %exitcond821.not = icmp eq i64 %polly.indvar_next358, 24
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_exit372
  %indvars.iv809 = phi i64 [ %indvars.iv807, %polly.loop_header362.preheader ], [ %indvars.iv.next810, %polly.loop_exit372 ]
  ...
  %133 = mul nuw nsw i64 %polly.indvar366, 80
...
polly.loop_header370.preheader:                   ; preds = %polly.loop_header362
  ...
  %137 = add i64 %smax806, %indvars.iv809
...
polly.loop_exit372:                               ; preds = %polly.loop_exit379, %polly.loop_header362
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar_next367, %128
  br i1 %exitcond820.not, label %polly.loop_exit364, label %polly.loop_header362

polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  %indvars.iv811 = phi i64 [ %137, %polly.loop_header370.preheader ], [ %indvars.iv.next812, %polly.loop_exit379 ]
  ...
  %polly.loop_guard387881 = icmp sgt i64 %139, -1
  %140 = add nuw nsw i64 %polly.indvar374, %132
  %141 = mul i64 %140, 8000
  %142 = mul i64 %140, 9600
  br i1 %polly.loop_guard387881, label %polly.loop_header377.us, label %polly.loop_exit379
...
polly.loop_header384.us:                          ; preds = %polly.loop_header384.us, %polly.loop_header377.us
  ...
  %exitcond814.not = icmp eq i64 %polly.indvar388.us, %smin813
  br i1 %exitcond814.not, label %polly.loop_exit386.loopexit.us, label %polly.loop_header384.us

polly.loop_exit386.loopexit.us:                   ; preds = %polly.loop_header384.us
  %polly.indvar_next381.us = add nuw nsw i64 %polly.indvar380.us, 1
  %exitcond815.not = icmp eq i64 %polly.indvar_next381.us, 1000
  br i1 %exitcond815.not, label %polly.loop_exit379, label %polly.loop_header377.us
...
vector.body971:                                   ; preds = %vector.body971, %vector.ph973
  ...
  %150 = shl nuw nsw i64 %index976, 3
  %151 = getelementptr i8, i8* %scevgep508, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load980 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !78, !noalias !80
  %153 = fmul fast <4 x double> %wide.load980, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next977, %n.vec975
  br i1 %155, label %middle.block969, label %vector.body971, !llvm.loop !83

middle.block969:                                  ; preds = %vector.body971
  %cmp.n979 = icmp eq i64 %148, %n.vec975
...
polly.loop_header502:                             ; preds = %polly.loop_header502.preheader, %polly.loop_header502
  ...
  br i1 %exitcond844.not, label %polly.loop_exit504, label %polly.loop_header502, !llvm.loop !84

polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit522
  %indvars.iv840 = phi i64 [ %indvars.iv.next841, %polly.loop_exit522 ], [ 3, %polly.loop_exit504 ]
  %indvars.iv838 = phi i64 [ %indvars.iv.next839, %polly.loop_exit522 ], [ 1, %polly.loop_exit504 ]
  %indvars.iv829 = phi i64 [ %indvars.iv.next830, %polly.loop_exit522 ], [ 0, %polly.loop_exit504 ]
  %indvars.iv824 = phi i64 [ %indvars.iv.next825, %polly.loop_exit522 ], [ 0, %polly.loop_exit504 ]
  %polly.indvar515 = phi i64 [ %polly.indvar_next516, %polly.loop_exit522 ], [ 0, %polly.loop_exit504 ]
  %157 = lshr i64 %indvars.iv840, 3
  %158 = sub nsw i64 %indvars.iv838, %157
  %159 = mul nuw nsw i64 %polly.indvar515, 3
  %160 = add nuw nsw i64 %159, 3
  %pexp.p_div_q518 = lshr i64 %160, 3
...
polly.loop_exit522:                               ; preds = %polly.loop_exit530, %polly.loop_header512
  ...
  %indvars.iv.next830 = add nuw nsw i64 %indvars.iv829, 50
  %indvars.iv.next839 = add nuw nsw i64 %indvars.iv838, 1
  %indvars.iv.next841 = add nuw nsw i64 %indvars.iv840, 3
  %exitcond843.not = icmp eq i64 %polly.indvar_next516, 24
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit530
  %indvars.iv831 = phi i64 [ %indvars.iv829, %polly.loop_header520.preheader ], [ %indvars.iv.next832, %polly.loop_exit530 ]
  %indvars.iv826 = phi i64 [ %indvars.iv824, %polly.loop_header520.preheader ], [ %indvars.iv.next827, %polly.loop_exit530 ]
  %polly.indvar524 = phi i64 [ 0, %polly.loop_header520.preheader ], [ %polly.indvar_next525, %polly.loop_exit530 ]
  %163 = mul nuw nsw i64 %polly.indvar524, 80
...
polly.loop_header528.preheader:                   ; preds = %polly.loop_header520
  ...
  %167 = add i64 %smax828, %indvars.iv831
...
polly.loop_exit530:                               ; preds = %polly.loop_exit537, %polly.loop_header520
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next525, %158
  br i1 %exitcond842.not, label %polly.loop_exit522, label %polly.loop_header520

polly.loop_header528:                             ; preds = %polly.loop_header528.preheader, %polly.loop_exit537
  %indvars.iv833 = phi i64 [ %167, %polly.loop_header528.preheader ], [ %indvars.iv.next834, %polly.loop_exit537 ]
  %polly.indvar532 = phi i64 [ %166, %polly.loop_header528.preheader ], [ %polly.indvar_next533, %polly.loop_exit537 ]
  %smin835 = call i64 @llvm.smin.i64(i64 %indvars.iv833, i64 79)
  %169 = add nsw i64 %polly.indvar532, %168
  %polly.loop_guard545882 = icmp sgt i64 %169, -1
  %170 = add nuw nsw i64 %polly.indvar532, %162
  %171 = mul i64 %170, 8000
  %172 = mul i64 %170, 9600
  br i1 %polly.loop_guard545882, label %polly.loop_header535.us, label %polly.loop_exit537
...
polly.loop_header542.us:                          ; preds = %polly.loop_header542.us, %polly.loop_header535.us
  ...
  %exitcond836.not = icmp eq i64 %polly.indvar546.us, %smin835
  br i1 %exitcond836.not, label %polly.loop_exit544.loopexit.us, label %polly.loop_header542.us

polly.loop_exit544.loopexit.us:                   ; preds = %polly.loop_header542.us
  %polly.indvar_next539.us = add nuw nsw i64 %polly.indvar538.us, 1
  %exitcond837.not = icmp eq i64 %polly.indvar_next539.us, 1000
  br i1 %exitcond837.not, label %polly.loop_exit537, label %polly.loop_header535.us
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin910 = call i64 @llvm.smin.i64(i64 %180, i64 -1168)
  %181 = add nsw i64 %smin910, 1200
  %smin868 = call i64 @llvm.smin.i64(i64 %indvars.iv866, i64 -1168)
  %182 = shl nsw i64 %polly.indvar703, 5
  %183 = add nsw i64 %smin868, 1199
...
vector.ph911:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert918 = insertelement <4 x i64> poison, i64 %182, i32 0
  %broadcast.splat919 = shufflevector <4 x i64> %broadcast.splatinsert918, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert920 = insertelement <4 x i32> poison, i32 %185, i32 0
...
vector.body909:                                   ; preds = %vector.body909, %vector.ph911
  ...
  %187 = add nuw nsw <4 x i64> %vec.ind916, %broadcast.splat919
  %188 = trunc <4 x i64> %187 to <4 x i32>
  %189 = mul <4 x i32> %broadcast.splat921, %188
  ...
  %199 = icmp eq i64 %index.next913, %181
  br i1 %199, label %polly.loop_exit714, label %vector.body909, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body909, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond873.not = icmp eq i64 %polly.indvar709, %179
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar715, %183
  br i1 %exitcond869.not, label %polly.loop_exit714, label %polly.loop_header712, !llvm.loop !93
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin925 = call i64 @llvm.smin.i64(i64 %209, i64 -968)
  %210 = add nsw i64 %smin925, 1000
  %smin858 = call i64 @llvm.smin.i64(i64 %indvars.iv856, i64 -968)
  %211 = shl nsw i64 %polly.indvar730, 5
  %212 = add nsw i64 %smin858, 999
...
vector.body924:                                   ; preds = %vector.body924, %vector.ph927
  ...
  %216 = add nuw nsw <4 x i64> %vec.ind934, %broadcast.splat937
  %217 = trunc <4 x i64> %216 to <4 x i32>
  %218 = mul <4 x i32> %broadcast.splat939, %217
  ...
  %228 = icmp eq i64 %index.next931, %210
  br i1 %228, label %polly.loop_exit741, label %vector.body924, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body924, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond863.not = icmp eq i64 %polly.indvar736, %208
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar742, %212
  br i1 %exitcond859.not, label %polly.loop_exit741, label %polly.loop_header739, !llvm.loop !96
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin943 = call i64 @llvm.smin.i64(i64 %238, i64 -968)
  %239 = add nsw i64 %smin943, 1000
  %smin848 = call i64 @llvm.smin.i64(i64 %indvars.iv846, i64 -968)
  %240 = shl nsw i64 %polly.indvar756, 5
  %241 = add nsw i64 %smin848, 999
...
vector.body942:                                   ; preds = %vector.body942, %vector.ph945
  ...
  %245 = add nuw nsw <4 x i64> %vec.ind952, %broadcast.splat955
  %246 = trunc <4 x i64> %245 to <4 x i32>
  %247 = mul <4 x i32> %broadcast.splat957, %246
  ...
  %257 = icmp eq i64 %index.next949, %239
  br i1 %257, label %polly.loop_exit767, label %vector.body942, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body942, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond853.not = icmp eq i64 %polly.indvar762, %237
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar768, %241
  br i1 %exitcond849.not, label %polly.loop_exit767, label %polly.loop_header765, !llvm.loop !99
}
