; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9917.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9917.c"
...
polly.loop_header199:                             ; preds = %polly.loop_exit193, %polly.loop_exit207
  ...
  %smin780 = call i64 @llvm.smin.i64(i64 %indvars.iv778, i64 -1168)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next779 = add nsw i64 %indvars.iv778, -32
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv775, i64 63)
...
polly.loop_header350:                             ; preds = %polly.loop_exit342, %polly.loop_exit359
  ...
  %121 = shl nsw i64 %polly.indvar353, 5
...
polly.loop_exit359:                               ; preds = %polly.loop_exit365
  ...
  %exitcond800.not = icmp eq i64 %polly.indvar_next354, 38
...
polly.loop_header357:                             ; preds = %polly.loop_exit365, %polly.loop_header350
  ...
  %123 = shl nsw i64 %polly.indvar360, 6
...
polly.loop_header504:                             ; preds = %polly.loop_exit496, %polly.loop_exit513
  ...
  %smin814 = call i64 @llvm.smin.i64(i64 %indvars.iv812, i64 -1168)
  %144 = shl nsw i64 %polly.indvar507, 5
...
polly.loop_exit513:                               ; preds = %polly.loop_exit519
  ...
  %exitcond817.not = icmp eq i64 %polly.indvar_next508, 38
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header504
  ...
  %146 = shl nsw i64 %polly.indvar514, 6
