; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6297.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6297.c"
...
polly.loop_exit219.3:                             ; preds = %polly.loop_header217.3
  ...
  %305 = mul nuw nsw i64 %polly.indvar208, 23
  %306 = add nuw nsw i64 %305, 47
  %pexp.p_div_q = udiv i64 %306, 48
  %307 = sub nsw i64 %polly.indvar208, %pexp.p_div_q
  %polly.loop_guard = icmp slt i64 %307, 13
...
polly.loop_header240.1:                           ; preds = %polly.loop_exit250, %polly.loop_exit250.1
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv870.1, i64 49)
...
polly.loop_header240.2:                           ; preds = %polly.loop_exit250.1, %polly.loop_exit250.2
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv870.2, i64 49)
...
polly.loop_header240.3:                           ; preds = %polly.loop_exit250.2, %polly.loop_exit250.3
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv870.3, i64 49)
...
polly.loop_exit396.3:                             ; preds = %polly.loop_header394.3
  %341 = mul nsw i64 %polly.indvar385, -50
  %342 = mul nuw nsw i64 %polly.indvar385, 23
  %343 = add nuw nsw i64 %342, 47
  %pexp.p_div_q404 = udiv i64 %343, 48
  %344 = sub nsw i64 %polly.indvar385, %pexp.p_div_q404
  %polly.loop_guard409 = icmp slt i64 %344, 13
...
polly.loop_header420.1:                           ; preds = %polly.loop_exit430, %polly.loop_exit430.1
  ...
  %smin895.1 = call i64 @llvm.smin.i64(i64 %indvars.iv893.1, i64 49)
...
polly.loop_header420.2:                           ; preds = %polly.loop_exit430.1, %polly.loop_exit430.2
  ...
  %smin895.2 = call i64 @llvm.smin.i64(i64 %indvars.iv893.2, i64 49)
...
polly.loop_header420.3:                           ; preds = %polly.loop_exit430.2, %polly.loop_exit430.3
  ...
  %smin895.3 = call i64 @llvm.smin.i64(i64 %indvars.iv893.3, i64 49)
...
polly.loop_exit576.3:                             ; preds = %polly.loop_header574.3
  %378 = mul nsw i64 %polly.indvar565, -50
  %379 = mul nuw nsw i64 %polly.indvar565, 23
  %380 = add nuw nsw i64 %379, 47
  %pexp.p_div_q584 = udiv i64 %380, 48
  %381 = sub nsw i64 %polly.indvar565, %pexp.p_div_q584
  %polly.loop_guard589 = icmp slt i64 %381, 13
...
polly.loop_header600.1:                           ; preds = %polly.loop_exit610, %polly.loop_exit610.1
  ...
  %smin919.1 = call i64 @llvm.smin.i64(i64 %indvars.iv917.1, i64 49)
...
polly.loop_header600.2:                           ; preds = %polly.loop_exit610.1, %polly.loop_exit610.2
  ...
  %smin919.2 = call i64 @llvm.smin.i64(i64 %indvars.iv917.2, i64 49)
...
polly.loop_header600.3:                           ; preds = %polly.loop_exit610.2, %polly.loop_exit610.3
  ...
  %smin919.3 = call i64 @llvm.smin.i64(i64 %indvars.iv917.3, i64 49)
