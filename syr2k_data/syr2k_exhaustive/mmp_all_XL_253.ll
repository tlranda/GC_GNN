; ModuleID = 'syr2k_exhaustive/mmp_all_XL_253.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_253.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit220.7
  ...
  %118 = mul nsw i64 %indvar1401, -16
  %119 = add i64 %108, %118
  %smax1403 = call i64 @llvm.smax.i64(i64 %119, i64 0)
  %120 = shl nuw nsw i64 %indvar1401, 4
  %121 = add i64 %110, %120
...
vector.body1400:                                  ; preds = %vector.body1400, %vector.ph1408
  ...
  %wide.load1421 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %159, label %middle.block1398, label %vector.body1400, !llvm.loop !85
...
vector.body1336:                                  ; preds = %vector.body1336, %vector.ph1340
  ...
  %wide.load1347 = load <4 x double>, <4 x double>* %165, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %168, label %middle.block1334, label %vector.body1336, !llvm.loop !93
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %180 = and i64 %179, 9223372036854775792
  %181 = sub nsw i64 %178, %180
  %182 = mul nsw i64 %polly.indvar419, -4
  %183 = add i64 %182, %180
  %184 = lshr i64 %polly.indvar419, 2
...
vector.body1350:                                  ; preds = %vector.body1350, %vector.ph1358
  ...
  %wide.load1371 = load <4 x double>, <4 x double>* %227, align 8, !alias.scope !86, !noalias !88
  ...
  br i1 %232, label %middle.block1348, label %vector.body1350, !llvm.loop !98
...
vector.body1288:                                  ; preds = %vector.body1288, %vector.ph1290
  ...
  %wide.load1297 = load <4 x double>, <4 x double>* %238, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %241, label %middle.block1286, label %vector.body1288, !llvm.loop !106
...
vector.body1300:                                  ; preds = %vector.body1300, %vector.ph1308
  ...
  %wide.load1321 = load <4 x double>, <4 x double>* %300, align 8, !alias.scope !99, !noalias !101
  ...
  br i1 %305, label %middle.block1298, label %vector.body1300, !llvm.loop !111
...
vector.body1226:                                  ; preds = %vector.body1226, %vector.ph1228
  ...
  br i1 %328, label %polly.loop_exit884, label %vector.body1226, !llvm.loop !117
...
vector.body1241:                                  ; preds = %vector.body1241, %vector.ph1244
  ...
  br i1 %357, label %polly.loop_exit911, label %vector.body1241, !llvm.loop !120
...
vector.body1259:                                  ; preds = %vector.body1259, %vector.ph1262
  ...
  br i1 %386, label %polly.loop_exit937, label %vector.body1259, !llvm.loop !123
