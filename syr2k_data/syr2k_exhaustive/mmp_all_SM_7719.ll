; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7719.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7719.c"
...
vector.body1023:                                  ; preds = %vector.body1023, %vector.ph1025
  ...
  br i1 %57, label %middle.block1021, label %vector.body1023, !llvm.loop !54
...
vector.body1049:                                  ; preds = %vector.body1049, %vector.ph1051
  ...
  br i1 %68, label %middle.block1047, label %vector.body1049, !llvm.loop !56
...
vector.body1061:                                  ; preds = %vector.body1061, %vector.ph1065
  ...
  %wide.load1072 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !62, !noalias !64
  ...
  br i1 %95, label %middle.block1059, label %vector.body1061, !llvm.loop !68
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond849.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !69
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond845.not = icmp eq i64 %polly.indvar_next225, 10
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249926 = icmp sgt i64 %109, -1
  %110 = add nuw nsw i64 %polly.indvar236, %101
  %111 = mul i64 %110, 8000
  %112 = mul i64 %110, 9600
  br i1 %polly.loop_guard249926, label %polly.loop_header239.us, label %polly.loop_exit241
...
polly.loop_exit248.loopexit.us:                   ; preds = %polly.loop_header246.us
  ...
  %exitcond843.not = icmp eq i64 %polly.indvar_next243.us, 100
...
vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1039
  ...
  %123 = shl nuw nsw i64 %index1042, 3
  %124 = getelementptr i8, i8* %scevgep370, i64 %123
  %125 = bitcast i8* %124 to <4 x double>*
  %wide.load1046 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !73, !noalias !75
  %126 = fmul fast <4 x double> %wide.load1046, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %128 = icmp eq i64 %index.next1043, %n.vec1041
  br i1 %128, label %middle.block1033, label %vector.body1035, !llvm.loop !79

middle.block1033:                                 ; preds = %vector.body1035
  %cmp.n1045 = icmp eq i64 %121, %n.vec1041
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  br i1 %exitcond871.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !80
...
polly.loop_header396:                             ; preds = %polly.loop_exit404, %polly.loop_header390
  ...
  %135 = mul nuw nsw i64 %polly.indvar399, 100
  br label %polly.loop_header402

polly.loop_exit404:                               ; preds = %polly.loop_exit411
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %exitcond867.not = icmp eq i64 %polly.indvar_next400, 10
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %136 = mul nuw nsw i64 %polly.indvar405, 100
...
polly.loop_header409.preheader:                   ; preds = %polly.loop_header402
  ...
  %140 = add i64 %smax855, %indvars.iv858
...
polly.loop_header409:                             ; preds = %polly.loop_header409.preheader, %polly.loop_exit418
  %indvars.iv860 = phi i64 [ %140, %polly.loop_header409.preheader ], [ %indvars.iv.next861, %polly.loop_exit418 ]
  ...
  %polly.loop_guard426927 = icmp sgt i64 %142, -1
  %143 = add nuw nsw i64 %polly.indvar413, %134
  %144 = mul i64 %143, 8000
  %145 = mul i64 %143, 9600
  br i1 %polly.loop_guard426927, label %polly.loop_header416.us, label %polly.loop_exit418
...
polly.loop_exit425.loopexit.us:                   ; preds = %polly.loop_header423.us
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar_next420.us, 100
  br i1 %exitcond864.not, label %polly.loop_exit418, label %polly.loop_header416.us
...
polly.loop_header535:                             ; preds = %polly.loop_exit543, %polly.start449
  ...
  %min.iters.check1012 = icmp ult i64 %154, 4
...
vector.body1011:                                  ; preds = %vector.body1011, %vector.ph1013
  ...
  %156 = shl nuw nsw i64 %index1016, 3
  %157 = getelementptr i8, i8* %scevgep547, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load1020 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !83, !noalias !85
  %159 = fmul fast <4 x double> %wide.load1020, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next1017, %n.vec1015
  br i1 %161, label %middle.block1009, label %vector.body1011, !llvm.loop !89

middle.block1009:                                 ; preds = %vector.body1011
  %cmp.n1019 = icmp eq i64 %154, %n.vec1015
...
polly.loop_header541:                             ; preds = %polly.loop_header541.preheader, %polly.loop_header541
  ...
  br i1 %exitcond893.not, label %polly.loop_exit543, label %polly.loop_header541, !llvm.loop !90
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_header567
  ...
  %168 = mul nuw nsw i64 %polly.indvar576, 100
  br label %polly.loop_header579

polly.loop_exit581:                               ; preds = %polly.loop_exit588
  %polly.indvar_next577 = add nuw nsw i64 %polly.indvar576, 1
  %exitcond889.not = icmp eq i64 %polly.indvar_next577, 10
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %169 = mul nuw nsw i64 %polly.indvar582, 100
...
polly.loop_header586.preheader:                   ; preds = %polly.loop_header579
  ...
  %173 = add i64 %smax877, %indvars.iv880
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit595
  %indvars.iv882 = phi i64 [ %173, %polly.loop_header586.preheader ], [ %indvars.iv.next883, %polly.loop_exit595 ]
  ...
  %polly.loop_guard603928 = icmp sgt i64 %175, -1
  %176 = add nuw nsw i64 %polly.indvar590, %167
  %177 = mul i64 %176, 8000
  %178 = mul i64 %176, 9600
  br i1 %polly.loop_guard603928, label %polly.loop_header593.us, label %polly.loop_exit595
...
polly.loop_exit602.loopexit.us:                   ; preds = %polly.loop_header600.us
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar_next597.us, 100
  br i1 %exitcond886.not, label %polly.loop_exit595, label %polly.loop_header593.us
...
polly.loop_header756:                             ; preds = %polly.loop_exit764, %polly.loop_header750
  ...
  %smin950 = call i64 @llvm.smin.i64(i64 %189, i64 -1168)
  %190 = add nsw i64 %smin950, 1200
  %smin917 = call i64 @llvm.smin.i64(i64 %indvars.iv915, i64 -1168)
  %191 = shl nsw i64 %polly.indvar759, 5
  %192 = add nsw i64 %smin917, 1199
...
vector.ph951:                                     ; preds = %polly.loop_header762
  %broadcast.splatinsert958 = insertelement <4 x i64> poison, i64 %191, i32 0
  %broadcast.splat959 = shufflevector <4 x i64> %broadcast.splatinsert958, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert960 = insertelement <4 x i32> poison, i32 %194, i32 0
...
vector.body949:                                   ; preds = %vector.body949, %vector.ph951
  ...
  %196 = add nuw nsw <4 x i64> %vec.ind956, %broadcast.splat959
  %197 = trunc <4 x i64> %196 to <4 x i32>
  %198 = mul <4 x i32> %broadcast.splat961, %197
  ...
  %208 = icmp eq i64 %index.next953, %190
  br i1 %208, label %polly.loop_exit770, label %vector.body949, !llvm.loop !98

polly.loop_exit770:                               ; preds = %vector.body949, %polly.loop_header768
  %polly.indvar_next766 = add nuw nsw i64 %polly.indvar765, 1
  %exitcond922.not = icmp eq i64 %polly.indvar765, %188
...
polly.loop_header768:                             ; preds = %polly.loop_header762, %polly.loop_header768
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar771, %192
  br i1 %exitcond918.not, label %polly.loop_exit770, label %polly.loop_header768, !llvm.loop !99
...
polly.loop_header783:                             ; preds = %polly.loop_exit791, %polly.loop_header777
  ...
  %smin965 = call i64 @llvm.smin.i64(i64 %218, i64 -968)
  %219 = add nsw i64 %smin965, 1000
  %smin907 = call i64 @llvm.smin.i64(i64 %indvars.iv905, i64 -968)
  %220 = shl nsw i64 %polly.indvar786, 5
  %221 = add nsw i64 %smin907, 999
...
vector.body964:                                   ; preds = %vector.body964, %vector.ph967
  ...
  %225 = add nuw nsw <4 x i64> %vec.ind974, %broadcast.splat977
  %226 = trunc <4 x i64> %225 to <4 x i32>
  %227 = mul <4 x i32> %broadcast.splat979, %226
  ...
  %237 = icmp eq i64 %index.next971, %219
  br i1 %237, label %polly.loop_exit797, label %vector.body964, !llvm.loop !101

polly.loop_exit797:                               ; preds = %vector.body964, %polly.loop_header795
  %polly.indvar_next793 = add nuw nsw i64 %polly.indvar792, 1
  %exitcond912.not = icmp eq i64 %polly.indvar792, %217
...
polly.loop_header795:                             ; preds = %polly.loop_header789, %polly.loop_header795
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar798, %221
  br i1 %exitcond908.not, label %polly.loop_exit797, label %polly.loop_header795, !llvm.loop !102
...
polly.loop_header809:                             ; preds = %polly.loop_exit817, %polly.loop_header803
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %247, i64 -968)
  %248 = add nsw i64 %smin983, 1000
  %smin897 = call i64 @llvm.smin.i64(i64 %indvars.iv895, i64 -968)
  %249 = shl nsw i64 %polly.indvar812, 5
  %250 = add nsw i64 %smin897, 999
...
vector.body982:                                   ; preds = %vector.body982, %vector.ph985
  ...
  %254 = add nuw nsw <4 x i64> %vec.ind992, %broadcast.splat995
  %255 = trunc <4 x i64> %254 to <4 x i32>
  %256 = mul <4 x i32> %broadcast.splat997, %255
  ...
  %266 = icmp eq i64 %index.next989, %248
  br i1 %266, label %polly.loop_exit823, label %vector.body982, !llvm.loop !104

polly.loop_exit823:                               ; preds = %vector.body982, %polly.loop_header821
  %polly.indvar_next819 = add nuw nsw i64 %polly.indvar818, 1
  %exitcond902.not = icmp eq i64 %polly.indvar818, %246
...
polly.loop_header821:                             ; preds = %polly.loop_header815, %polly.loop_header821
  ...
  %exitcond898.not = icmp eq i64 %polly.indvar824, %250
  br i1 %exitcond898.not, label %polly.loop_exit823, label %polly.loop_header821, !llvm.loop !105
}
