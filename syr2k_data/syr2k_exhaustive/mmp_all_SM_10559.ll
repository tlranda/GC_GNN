; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10559.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10559.c"
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %128 = shl nsw i64 %polly.indvar361, 4
...
polly.loop_exit367:                               ; preds = %polly.loop_exit373
  ...
  %exitcond813.not = icmp eq i64 %polly.indvar_next362, 63
...
polly.loop_header514:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %smin827 = call i64 @llvm.smin.i64(i64 %indvars.iv825, i64 -984)
  %156 = shl nsw i64 %polly.indvar517, 4
...
polly.loop_exit523:                               ; preds = %polly.loop_exit529
  ...
  %exitcond834.not = icmp eq i64 %polly.indvar_next518, 63
