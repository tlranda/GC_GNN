; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1076.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1076.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1108 = call i64 @llvm.smin.i64(i64 %indvars.iv1088, i64 -872)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1111.not = icmp eq i64 %polly.indvar_next204, 8
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %103 = sub i64 %99, %102
  %104 = mul nsw i64 %polly.indvar209, -128
  %105 = add i64 %104, %102
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %exitcond1110.not = icmp eq i64 %polly.indvar_next210, 10
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %116 = mul nsw i64 %indvar1419, -96
  %117 = add i64 %103, %116
  %smax1421 = call i64 @llvm.smax.i64(i64 %117, i64 0)
  %118 = mul nuw nsw i64 %indvar1419, 96
  %119 = add i64 %105, %118
...
polly.loop_header272:                             ; preds = %polly.loop_header265, %polly.loop_exit282
  ...
  %smin1424 = call i64 @llvm.smin.i64(i64 %143, i64 127)
  %144 = add nsw i64 %smin1424, 1
  %smin1106 = call i64 @llvm.smin.i64(i64 %indvars.iv1104, i64 127)
...
polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  ...
  %smin1139 = call i64 @llvm.smin.i64(i64 %indvars.iv1117, i64 -872)
...
polly.loop_exit420:                               ; preds = %polly.loop_exit443
  ...
  %indvars.iv.next1118 = add nsw i64 %indvars.iv1117, -128
  %exitcond1142.not = icmp eq i64 %polly.indvar_next416, 8
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %179 = shl nuw nsw i64 %polly.indvar421, 7
  %180 = udiv i64 %polly.indvar421, 3
  %181 = add nuw i64 %polly.indvar421, %180
  %182 = mul nuw nsw i64 %181, 96
  %183 = sub i64 %179, %182
  %184 = mul nsw i64 %polly.indvar421, -128
  %185 = add i64 %184, %182
  %186 = udiv i64 %polly.indvar421, 3
  ...
  %191 = mul nsw i64 %polly.indvar421, -128
  %192 = shl nsw i64 %polly.indvar421, 7
...
polly.loop_exit443:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1127 = add nuw nsw i64 %indvars.iv1126, 128
  %indvars.iv.next1132 = add nsw i64 %indvars.iv1131, -128
  %exitcond1141.not = icmp eq i64 %polly.indvar_next422, 10
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit426
  ...
  %196 = mul nsw i64 %indvar1369, -96
  %197 = add i64 %183, %196
  %smax1371 = call i64 @llvm.smax.i64(i64 %197, i64 0)
  %198 = mul nuw nsw i64 %indvar1369, 96
  %199 = add i64 %185, %198
  ...
  %.inv942 = icmp sgt i64 %203, 127
  %205 = select i1 %.inv942, i64 127, i64 %204
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %smin1374 = call i64 @llvm.smin.i64(i64 %223, i64 127)
  %224 = add nsw i64 %smin1374, 1
  %smin1137 = call i64 @llvm.smin.i64(i64 %indvars.iv1135, i64 127)
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %smin1170 = call i64 @llvm.smin.i64(i64 %indvars.iv1148, i64 -872)
...
polly.loop_exit635:                               ; preds = %polly.loop_exit658
  ...
  %indvars.iv.next1149 = add nsw i64 %indvars.iv1148, -128
  %exitcond1173.not = icmp eq i64 %polly.indvar_next631, 8
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %259 = shl nuw nsw i64 %polly.indvar636, 7
  %260 = udiv i64 %polly.indvar636, 3
  %261 = add nuw i64 %polly.indvar636, %260
  %262 = mul nuw nsw i64 %261, 96
  %263 = sub i64 %259, %262
  %264 = mul nsw i64 %polly.indvar636, -128
  %265 = add i64 %264, %262
  %266 = udiv i64 %polly.indvar636, 3
  ...
  %271 = mul nsw i64 %polly.indvar636, -128
  %272 = shl nsw i64 %polly.indvar636, 7
...
polly.loop_exit658:                               ; preds = %polly.loop_exit697
  ...
  %indvars.iv.next1158 = add nuw nsw i64 %indvars.iv1157, 128
  %indvars.iv.next1163 = add nsw i64 %indvars.iv1162, -128
  %exitcond1172.not = icmp eq i64 %polly.indvar_next637, 10
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit641
  ...
  %276 = mul nsw i64 %indvar1319, -96
  %277 = add i64 %263, %276
  %smax1321 = call i64 @llvm.smax.i64(i64 %277, i64 0)
  %278 = mul nuw nsw i64 %indvar1319, 96
  %279 = add i64 %265, %278
...
polly.loop_exit697:                               ; preds = %polly.loop_exit704, %polly.loop_header695.preheader
  ...
  %indvars.iv.next1165 = add i64 %indvars.iv1164, 96
...
polly.loop_header702:                             ; preds = %polly.loop_header695, %polly.loop_exit712
  ...
  %smin1324 = call i64 @llvm.smin.i64(i64 %303, i64 127)
  %304 = add nsw i64 %smin1324, 1
  %smin1168 = call i64 @llvm.smin.i64(i64 %indvars.iv1166, i64 127)
