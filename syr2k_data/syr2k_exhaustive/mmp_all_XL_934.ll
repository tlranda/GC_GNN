; ModuleID = 'syr2k_exhaustive/mmp_all_XL_934.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_934.c"
...
vector.body1327:                                  ; preds = %vector.body1327, %vector.ph1329
  ...
  br i1 %57, label %middle.block1325, label %vector.body1327, !llvm.loop !63
...
vector.body1377:                                  ; preds = %vector.body1377, %vector.ph1379
  ...
  br i1 %68, label %middle.block1375, label %vector.body1377, !llvm.loop !65
...
vector.body1389:                                  ; preds = %vector.body1389, %vector.ph1393
  ...
  %wide.load1400 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1387, label %vector.body1389, !llvm.loop !78
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  br i1 %exitcond1066.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !79
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit208
  ...
  %smin1061 = call i64 @llvm.smin.i64(i64 %indvars.iv1033, i64 -920)
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1065.not = icmp eq i64 %polly.indvar_next204, 13
...
vector.body1403:                                  ; preds = %vector.body1403, %vector.ph1411
  ...
  %wide.load1424 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %151, label %middle.block1401, label %vector.body1403, !llvm.loop !83
...
polly.loop_header297:                             ; preds = %polly.loop_header297.preheader1425, %polly.loop_header297
  ...
  br i1 %exitcond1060.not, label %polly.loop_exit299, label %polly.loop_header297, !llvm.loop !84

polly.start325:                                   ; preds = %kernel_syr2k.exit
  %malloccall327 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
  %malloccall329 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
vector.body1339:                                  ; preds = %vector.body1339, %vector.ph1343
  ...
  %wide.load1350 = load <4 x double>, <4 x double>* %159, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %160, <4 x double>* %161, align 8, !alias.scope !85, !noalias !87
  %index.next1347 = add i64 %index1346, 4
  %162 = icmp eq i64 %index.next1347, %n.vec1345
  br i1 %162, label %middle.block1337, label %vector.body1339, !llvm.loop !92
...
polly.loop_header419:                             ; preds = %polly.loop_header419.preheader, %polly.loop_header419
  ...
  br i1 %exitcond1106.not, label %polly.loop_exit421, label %polly.loop_header419, !llvm.loop !93
...
polly.loop_header429:                             ; preds = %polly.loop_header429.preheader, %polly.loop_exit437
  ...
  %smin1101 = call i64 @llvm.smin.i64(i64 %indvars.iv1071, i64 -920)
  %164 = add nsw i64 %smin1101, 1000
  %165 = mul nuw nsw i64 %polly.indvar432, 80
...
polly.loop_exit437:                               ; preds = %polly.loop_exit459
  ...
  %indvars.iv.next1072 = add nsw i64 %indvars.iv1071, -80
  %exitcond1105.not = icmp eq i64 %polly.indvar_next433, 13
...
vector.body1353:                                  ; preds = %vector.body1353, %vector.ph1361
  ...
  %wide.load1374 = load <4 x double>, <4 x double>* %213, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %216, <4 x double>* %217, align 8, !alias.scope !85, !noalias !87
  %index.next1365 = add i64 %index1364, 4
  %218 = icmp eq i64 %index.next1365, %n.vec1363
  br i1 %218, label %middle.block1351, label %vector.body1353, !llvm.loop !96
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader1430, %polly.loop_header532
  ...
  br i1 %exitcond1100.not, label %polly.loop_exit534, label %polly.loop_header532, !llvm.loop !97

polly.start560:                                   ; preds = %init_array.exit
  %malloccall562 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
  %malloccall564 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
vector.body1291:                                  ; preds = %vector.body1291, %vector.ph1293
  ...
  %wide.load1300 = load <4 x double>, <4 x double>* %226, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %227, <4 x double>* %228, align 8, !alias.scope !98, !noalias !100
  %index.next1297 = add i64 %index1296, 4
  %229 = icmp eq i64 %index.next1297, %n.vec1295
  br i1 %229, label %middle.block1289, label %vector.body1291, !llvm.loop !105
...
polly.loop_header654:                             ; preds = %polly.loop_header654.preheader, %polly.loop_header654
  ...
  br i1 %exitcond1146.not, label %polly.loop_exit656, label %polly.loop_header654, !llvm.loop !106
...
polly.loop_header664:                             ; preds = %polly.loop_header664.preheader, %polly.loop_exit672
  ...
  %smin1141 = call i64 @llvm.smin.i64(i64 %indvars.iv1111, i64 -920)
  %231 = add nsw i64 %smin1141, 1000
  %232 = mul nuw nsw i64 %polly.indvar667, 80
...
polly.loop_exit672:                               ; preds = %polly.loop_exit694
  ...
  %exitcond1145.not = icmp eq i64 %polly.indvar_next668, 13
...
vector.body1303:                                  ; preds = %vector.body1303, %vector.ph1311
  ...
  %wide.load1324 = load <4 x double>, <4 x double>* %280, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %285, label %middle.block1301, label %vector.body1303, !llvm.loop !109
...
polly.loop_header767:                             ; preds = %polly.loop_header767.preheader1435, %polly.loop_header767
  ...
  br i1 %exitcond1140.not, label %polly.loop_exit769, label %polly.loop_header767, !llvm.loop !110
...
vector.body1230:                                  ; preds = %vector.body1230, %vector.ph1231
  ...
  store <4 x double> %304, <4 x double>* %309, align 8, !alias.scope !111, !noalias !113
  ...
  br i1 %310, label %polly.loop_exit939, label %vector.body1230, !llvm.loop !116
...
polly.loop_header937:                             ; preds = %polly.loop_header931, %polly.loop_header937
  ...
  br i1 %exitcond1171.not, label %polly.loop_exit939, label %polly.loop_header937, !llvm.loop !117
...
vector.body1244:                                  ; preds = %vector.body1244, %vector.ph1247
  ...
  store <4 x double> %333, <4 x double>* %338, align 8, !alias.scope !115, !noalias !118
  ...
  br i1 %339, label %polly.loop_exit966, label %vector.body1244, !llvm.loop !119
...
polly.loop_header964:                             ; preds = %polly.loop_header958, %polly.loop_header964
  ...
  br i1 %exitcond1161.not, label %polly.loop_exit966, label %polly.loop_header964, !llvm.loop !120
...
vector.body1262:                                  ; preds = %vector.body1262, %vector.ph1265
  ...
  store <4 x double> %362, <4 x double>* %367, align 8, !alias.scope !114, !noalias !121
  ...
  br i1 %368, label %polly.loop_exit992, label %vector.body1262, !llvm.loop !122
...
polly.loop_header990:                             ; preds = %polly.loop_header984, %polly.loop_header990
  ...
  br i1 %exitcond1151.not, label %polly.loop_exit992, label %polly.loop_header990, !llvm.loop !123
}
