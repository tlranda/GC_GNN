; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3742.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3742.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %pexp.p_div_q877 = udiv i8 %pexp.p_div_q.lhs.trunc, 6
...
polly.loop_exit207:                               ; preds = %polly.loop_exit242
  ...
  %exitcond1016.not = icmp eq i64 %119, 75
...
polly.loop_header205:                             ; preds = %polly.loop_exit242, %polly.loop_header199
  ...
  %120 = add i64 %smax, %indvars.iv1010
  %121 = mul nuw nsw i64 %polly.indvar208, 6
  %.not.not = icmp ugt i64 %121, %polly.indvar202
  %122 = mul nuw nsw i64 %polly.indvar208, 96
...
polly.loop_header240.preheader:                   ; preds = %polly.loop_exit229, %polly.loop_exit229.us, %polly.loop_header205.split
  ...
  %133 = mul nsw i64 %polly.indvar208, -96
...
polly.loop_header247:                             ; preds = %polly.loop_exit257, %polly.loop_header240
  %indvars.iv1012 = phi i64 [ %indvars.iv.next1013, %polly.loop_exit257 ], [ %120, %polly.loop_header240 ]
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit394
  ...
  %156 = udiv i64 %polly.indvar388, 6
  %157 = mul nuw nsw i64 %156, 96
  %158 = sub nsw i64 %indvars.iv1022, %157
  %159 = add i64 %indvars.iv1027, %157
  %pexp.p_div_q391.lhs.trunc = trunc i64 %polly.indvar388 to i8
  %pexp.p_div_q391876 = udiv i8 %pexp.p_div_q391.lhs.trunc, 6
...
polly.loop_exit394:                               ; preds = %polly.loop_exit435
  ...
  %exitcond1036.not = icmp eq i64 %178, 75
...
polly.loop_header392:                             ; preds = %polly.loop_exit435, %polly.loop_header385
  %indvars.iv1029 = phi i64 [ %indvars.iv.next1030, %polly.loop_exit435 ], [ %159, %polly.loop_header385 ]
  %indvars.iv1024 = phi i64 [ %indvars.iv.next1025, %polly.loop_exit435 ], [ %158, %polly.loop_header385 ]
  ...
  %180 = mul nuw nsw i64 %polly.indvar395, 6
  %.not.not873 = icmp ugt i64 %180, %polly.indvar388
  %181 = mul nuw nsw i64 %polly.indvar395, 96
...
polly.loop_header433.preheader:                   ; preds = %polly.loop_exit421, %polly.loop_exit421.us, %polly.loop_header392.split
  ...
  %192 = mul nsw i64 %polly.indvar395, -96
...
polly.loop_header440:                             ; preds = %polly.loop_exit450, %polly.loop_header433
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit450 ], [ %179, %polly.loop_header433 ]
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  ...
  %215 = udiv i64 %polly.indvar581, 6
  %216 = mul nuw nsw i64 %215, 96
  %217 = sub nsw i64 %indvars.iv1042, %216
  %218 = add i64 %indvars.iv1047, %216
  %pexp.p_div_q584.lhs.trunc = trunc i64 %polly.indvar581 to i8
  %pexp.p_div_q584875 = udiv i8 %pexp.p_div_q584.lhs.trunc, 6
...
polly.loop_header585:                             ; preds = %polly.loop_exit628, %polly.loop_header578
  %indvars.iv1049 = phi i64 [ %indvars.iv.next1050, %polly.loop_exit628 ], [ %218, %polly.loop_header578 ]
  %indvars.iv1044 = phi i64 [ %indvars.iv.next1045, %polly.loop_exit628 ], [ %217, %polly.loop_header578 ]
  ...
  %238 = add i64 %smax1046, %indvars.iv1049
  %239 = mul nuw nsw i64 %polly.indvar588, 6
  %.not.not874 = icmp ugt i64 %239, %polly.indvar581
  %240 = mul nuw nsw i64 %polly.indvar588, 96
  %241 = add nsw i64 %240, %220
  %242 = icmp sgt i64 %241, 0
  %243 = select i1 %242, i64 %241, i64 0
  %244 = add nsw i64 %241, 95
...
polly.loop_header626.preheader:                   ; preds = %polly.loop_exit614, %polly.loop_exit614.us, %polly.loop_header585.split
  ...
  %251 = mul nsw i64 %polly.indvar588, -96
  %252 = icmp slt i64 %251, -1104
  %253 = select i1 %252, i64 %251, i64 -1104
...
polly.loop_header633:                             ; preds = %polly.loop_exit643, %polly.loop_header626
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit643 ], [ %238, %polly.loop_header626 ]
