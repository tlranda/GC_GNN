; ModuleID = 'syr2k_exhaustive/mmp_all_XL_236.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_236.c"
...
polly.loop_exit208:                               ; preds = %polly.loop_exit214
  ...
  %112 = mul nuw nsw i64 %polly.indvar203, 6
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit431
  ...
  %169 = mul nuw nsw i64 %polly.indvar409, 6
  %170 = lshr i64 %polly.indvar409, 2
  %171 = add nuw i64 %169, %170
  %172 = shl nuw nsw i64 %171, 3
  %173 = sub i64 %168, %172
  %174 = mul nsw i64 %polly.indvar409, -50
  %175 = add i64 %174, %172
  %176 = lshr i64 %polly.indvar409, 2
...
polly.loop_exit414:                               ; preds = %polly.loop_exit420
  ...
  %183 = mul nuw nsw i64 %polly.indvar409, 6
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %240 = mul nuw nsw i64 %polly.indvar618, 6
  %241 = lshr i64 %polly.indvar618, 2
  %242 = add nuw i64 %240, %241
  %243 = shl nuw nsw i64 %242, 3
  %244 = sub i64 %239, %243
  %245 = mul nsw i64 %polly.indvar618, -50
  %246 = add i64 %245, %243
  %247 = lshr i64 %polly.indvar618, 2
...
polly.loop_exit623:                               ; preds = %polly.loop_exit629
  ...
  %254 = mul nuw nsw i64 %polly.indvar618, 6
...
polly.loop_exit640:                               ; preds = %polly.loop_exit679
  ...
  %indvars.iv.next1115 = add nuw nsw i64 %indvars.iv1114, 6
