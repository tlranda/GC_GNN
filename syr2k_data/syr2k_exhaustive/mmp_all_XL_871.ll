; ModuleID = 'syr2k_exhaustive/mmp_all_XL_871.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_871.c"
...
vector.body1338:                                  ; preds = %vector.body1338, %vector.ph1340
  ...
  br i1 %57, label %middle.block1336, label %vector.body1338, !llvm.loop !63
...
vector.body1388:                                  ; preds = %vector.body1388, %vector.ph1390
  ...
  br i1 %68, label %middle.block1386, label %vector.body1388, !llvm.loop !65
...
vector.body1400:                                  ; preds = %vector.body1400, %vector.ph1404
  ...
  %wide.load1411 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1398, label %vector.body1400, !llvm.loop !78
...
polly.loop_exit208:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1113.not = icmp eq i64 %polly.indvar_next204, 63
...
vector.body1414:                                  ; preds = %vector.body1414, %vector.ph1422
  ...
  %wide.load1435 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !71, !noalias !73
  ...
  store <4 x double> %169, <4 x double>* %170, align 8, !alias.scope !71, !noalias !73
  %index.next1426 = add i64 %index1425, 4
  %171 = icmp eq i64 %index.next1426, %n.vec1424
  br i1 %171, label %middle.block1412, label %vector.body1414, !llvm.loop !84
...
vector.body1350:                                  ; preds = %vector.body1350, %vector.ph1354
  ...
  %wide.load1361 = load <4 x double>, <4 x double>* %177, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %180, label %middle.block1348, label %vector.body1350, !llvm.loop !92
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_header400
  ...
  br i1 %exitcond1145.not, label %polly.loop_exit402, label %polly.loop_header400, !llvm.loop !93
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %smin1141 = call i64 @llvm.smin.i64(i64 %indvars.iv1119, i64 -984)
...
polly.loop_exit418:                               ; preds = %polly.loop_exit441
  ...
  %indvars.iv.next1120 = add nsw i64 %indvars.iv1119, -16
  %exitcond1144.not = icmp eq i64 %polly.indvar_next414, 63
...
polly.loop_header495.us:                          ; preds = %polly.loop_header495.us.preheader, %polly.loop_header495.us
  ...
  br i1 %exitcond1140.not, label %polly.loop_exit497.us, label %polly.loop_header495.us, !llvm.loop !96
...
vector.body1364:                                  ; preds = %vector.body1364, %vector.ph1372
  ...
  %wide.load1385 = load <4 x double>, <4 x double>* %251, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %254, <4 x double>* %255, align 8, !alias.scope !85, !noalias !87
  %index.next1376 = add i64 %index1375, 4
  %256 = icmp eq i64 %index.next1376, %n.vec1374
  br i1 %256, label %middle.block1362, label %vector.body1364, !llvm.loop !97
...
vector.body1302:                                  ; preds = %vector.body1302, %vector.ph1304
  ...
  %wide.load1311 = load <4 x double>, <4 x double>* %262, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %263, <4 x double>* %264, align 8, !alias.scope !98, !noalias !100
  %index.next1308 = add i64 %index1307, 4
  %265 = icmp eq i64 %index.next1308, %n.vec1306
  br i1 %265, label %middle.block1300, label %vector.body1302, !llvm.loop !105
...
polly.loop_header617:                             ; preds = %polly.loop_header617.preheader, %polly.loop_header617
  ...
  br i1 %exitcond1176.not, label %polly.loop_exit619, label %polly.loop_header617, !llvm.loop !106
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %smin1172 = call i64 @llvm.smin.i64(i64 %indvars.iv1150, i64 -984)
  %267 = add nsw i64 %smin1172, 1000
  %268 = shl nsw i64 %polly.indvar630, 4
  br label %polly.loop_header633

polly.loop_exit635:                               ; preds = %polly.loop_exit658
  %polly.indvar_next631 = add nuw nsw i64 %polly.indvar630, 1
  %indvars.iv.next1151 = add nsw i64 %indvars.iv1150, -16
  %exitcond1175.not = icmp eq i64 %polly.indvar_next631, 63
...
polly.loop_header712.us:                          ; preds = %polly.loop_header712.us.preheader, %polly.loop_header712.us
  ...
  br i1 %exitcond1171.not, label %polly.loop_exit714.us, label %polly.loop_header712.us, !llvm.loop !109
...
vector.body1314:                                  ; preds = %vector.body1314, %vector.ph1322
  ...
  %wide.load1335 = load <4 x double>, <4 x double>* %336, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %339, <4 x double>* %340, align 8, !alias.scope !98, !noalias !100
  %index.next1326 = add i64 %index1325, 4
  %341 = icmp eq i64 %index.next1326, %n.vec1324
  br i1 %341, label %middle.block1312, label %vector.body1314, !llvm.loop !110
...
vector.body1241:                                  ; preds = %vector.body1241, %vector.ph1242
  ...
  store <4 x double> %358, <4 x double>* %363, align 8, !alias.scope !111, !noalias !113
  ...
  br i1 %364, label %polly.loop_exit884, label %vector.body1241, !llvm.loop !116
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  br i1 %exitcond1201.not, label %polly.loop_exit884, label %polly.loop_header882, !llvm.loop !117
...
vector.body1255:                                  ; preds = %vector.body1255, %vector.ph1258
  ...
  store <4 x double> %387, <4 x double>* %392, align 8, !alias.scope !115, !noalias !118
  ...
  br i1 %393, label %polly.loop_exit911, label %vector.body1255, !llvm.loop !119
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  br i1 %exitcond1191.not, label %polly.loop_exit911, label %polly.loop_header909, !llvm.loop !120
...
vector.body1273:                                  ; preds = %vector.body1273, %vector.ph1276
  ...
  store <4 x double> %416, <4 x double>* %421, align 8, !alias.scope !114, !noalias !121
  ...
  br i1 %422, label %polly.loop_exit937, label %vector.body1273, !llvm.loop !122
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  br i1 %exitcond1181.not, label %polly.loop_exit937, label %polly.loop_header935, !llvm.loop !123
}
