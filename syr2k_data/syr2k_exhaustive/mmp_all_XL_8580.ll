; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8580.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8580.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %109 = icmp slt i64 %108, -1168
  %110 = select i1 %109, i64 %108, i64 -1168
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %exitcond788.not = icmp eq i64 %polly.indvar_next209, 38
...
polly.loop_exit219:                               ; preds = %polly.loop_exit226
  ...
  %exitcond787.not = icmp eq i64 %polly.indvar_next215, 1000
...
polly.loop_header217:                             ; preds = %polly.loop_exit226, %polly.loop_header211
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv785, i64 15)
  %113 = add nuw i64 %polly.indvar220, %104
  %114 = add i64 %113, %102
  %polly.loop_guard227862 = icmp sgt i64 %114, -1
  br i1 %polly.loop_guard227862, label %polly.loop_header224.preheader, label %polly.loop_exit226
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph981
  ...
  %123 = shl nuw nsw i64 %index984, 3
  %124 = getelementptr i8, i8* %scevgep348, i64 %123
  %125 = bitcast i8* %124 to <4 x double>*
  %wide.load988 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !72, !noalias !74
  %126 = fmul fast <4 x double> %wide.load988, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %128 = icmp eq i64 %index.next985, %n.vec983
  br i1 %128, label %middle.block975, label %vector.body977, !llvm.loop !77

middle.block975:                                  ; preds = %vector.body977
  %cmp.n987 = icmp eq i64 %121, %n.vec983
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %130 = lshr i64 %polly.indvar355, 1
  %131 = shl nuw nsw i64 %130, 5
  %132 = sub nsw i64 %indvars.iv792, %131
  %133 = add i64 %indvars.iv797, %131
  %134 = shl nsw i64 %polly.indvar355, 4
  %135 = mul nsw i64 %polly.indvar355, -16
...
polly.loop_exit361:                               ; preds = %polly.loop_exit367
  ...
  %indvars.iv.next798 = add nsw i64 %indvars.iv797, -16
  %exitcond807.not = icmp eq i64 %polly.indvar_next356, 75
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374, %polly.loop_header359
  ...
  %exitcond806.not = icmp eq i64 %polly.indvar_next363, 38
...
polly.loop_exit374:                               ; preds = %polly.loop_exit382
  ...
  %exitcond805.not = icmp eq i64 %polly.indvar_next369, 1000
...
polly.loop_header372:                             ; preds = %polly.loop_exit382, %polly.loop_header365
  ...
  %smin803 = call i64 @llvm.smin.i64(i64 %indvars.iv801, i64 15)
  %146 = add nuw i64 %polly.indvar376, %137
  %147 = add i64 %146, %135
  %polly.loop_guard383863 = icmp sgt i64 %147, -1
  br i1 %polly.loop_guard383863, label %polly.loop_header380.preheader, label %polly.loop_exit382
...
vector.body953:                                   ; preds = %vector.body953, %vector.ph955
  ...
  %156 = shl nuw nsw i64 %index958, 3
  %157 = getelementptr i8, i8* %scevgep504, i64 %156
  %158 = bitcast i8* %157 to <4 x double>*
  %wide.load962 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !81, !noalias !83
  %159 = fmul fast <4 x double> %wide.load962, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %161 = icmp eq i64 %index.next959, %n.vec957
  br i1 %161, label %middle.block951, label %vector.body953, !llvm.loop !86

middle.block951:                                  ; preds = %vector.body953
  %cmp.n961 = icmp eq i64 %154, %n.vec957
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %163 = lshr i64 %polly.indvar511, 1
  %164 = shl nuw nsw i64 %163, 5
  %165 = sub nsw i64 %indvars.iv810, %164
  %166 = add i64 %indvars.iv815, %164
  %167 = shl nsw i64 %polly.indvar511, 4
  %168 = mul nsw i64 %polly.indvar511, -16
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next811 = add nuw nsw i64 %indvars.iv810, 16
  %indvars.iv.next816 = add nsw i64 %indvars.iv815, -16
  %exitcond825.not = icmp eq i64 %polly.indvar_next512, 75
...
polly.loop_exit523:                               ; preds = %polly.loop_exit530, %polly.loop_header515
  ...
  %exitcond824.not = icmp eq i64 %polly.indvar_next519, 38
...
polly.loop_exit530:                               ; preds = %polly.loop_exit538
  ...
  %exitcond823.not = icmp eq i64 %polly.indvar_next525, 1000
...
polly.loop_header528:                             ; preds = %polly.loop_exit538, %polly.loop_header521
  ...
  %smin821 = call i64 @llvm.smin.i64(i64 %indvars.iv819, i64 15)
  %179 = add nuw i64 %polly.indvar532, %170
  %180 = add i64 %179, %168
  %polly.loop_guard539864 = icmp sgt i64 %180, -1
  br i1 %polly.loop_guard539864, label %polly.loop_header536.preheader, label %polly.loop_exit538

polly.loop_header536.preheader:                   ; preds = %polly.loop_header528
  %181 = mul i64 %179, 8000
...
polly.loop_header694:                             ; preds = %polly.loop_exit702, %polly.loop_header688
  ...
  %smin892 = call i64 @llvm.smin.i64(i64 %189, i64 -1168)
  %190 = add nsw i64 %smin892, 1200
  %smin850 = call i64 @llvm.smin.i64(i64 %indvars.iv848, i64 -1168)
  %191 = shl nsw i64 %polly.indvar697, 5
  %192 = add nsw i64 %smin850, 1199
...
vector.ph893:                                     ; preds = %polly.loop_header700
  %broadcast.splatinsert900 = insertelement <4 x i64> poison, i64 %191, i32 0
  %broadcast.splat901 = shufflevector <4 x i64> %broadcast.splatinsert900, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert902 = insertelement <4 x i32> poison, i32 %194, i32 0
...
vector.body891:                                   ; preds = %vector.body891, %vector.ph893
  ...
  %196 = add nuw nsw <4 x i64> %vec.ind898, %broadcast.splat901
  %197 = trunc <4 x i64> %196 to <4 x i32>
  %198 = mul <4 x i32> %broadcast.splat903, %197
  ...
  %208 = icmp eq i64 %index.next895, %190
  br i1 %208, label %polly.loop_exit708, label %vector.body891, !llvm.loop !95

polly.loop_exit708:                               ; preds = %vector.body891, %polly.loop_header706
  %polly.indvar_next704 = add nuw nsw i64 %polly.indvar703, 1
  %exitcond855.not = icmp eq i64 %polly.indvar703, %188
...
polly.loop_header706:                             ; preds = %polly.loop_header700, %polly.loop_header706
  ...
  %exitcond851.not = icmp eq i64 %polly.indvar709, %192
...
polly.loop_header721:                             ; preds = %polly.loop_exit729, %polly.loop_header715
  ...
  %smin907 = call i64 @llvm.smin.i64(i64 %218, i64 -968)
  %219 = add nsw i64 %smin907, 1000
  %smin840 = call i64 @llvm.smin.i64(i64 %indvars.iv838, i64 -968)
  %220 = shl nsw i64 %polly.indvar724, 5
  %221 = add nsw i64 %smin840, 999
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph909
  ...
  %225 = add nuw nsw <4 x i64> %vec.ind916, %broadcast.splat919
  %226 = trunc <4 x i64> %225 to <4 x i32>
  %227 = mul <4 x i32> %broadcast.splat921, %226
  ...
  %237 = icmp eq i64 %index.next913, %219
  br i1 %237, label %polly.loop_exit735, label %vector.body906, !llvm.loop !98

polly.loop_exit735:                               ; preds = %vector.body906, %polly.loop_header733
  %polly.indvar_next731 = add nuw nsw i64 %polly.indvar730, 1
  %exitcond845.not = icmp eq i64 %polly.indvar730, %217
...
polly.loop_header733:                             ; preds = %polly.loop_header727, %polly.loop_header733
  ...
  %exitcond841.not = icmp eq i64 %polly.indvar736, %221
...
polly.loop_header747:                             ; preds = %polly.loop_exit755, %polly.loop_header741
  ...
  %smin925 = call i64 @llvm.smin.i64(i64 %247, i64 -968)
  %248 = add nsw i64 %smin925, 1000
  %smin830 = call i64 @llvm.smin.i64(i64 %indvars.iv828, i64 -968)
  %249 = shl nsw i64 %polly.indvar750, 5
  %250 = add nsw i64 %smin830, 999
...
vector.body924:                                   ; preds = %vector.body924, %vector.ph927
  ...
  %254 = add nuw nsw <4 x i64> %vec.ind934, %broadcast.splat937
  %255 = trunc <4 x i64> %254 to <4 x i32>
  %256 = mul <4 x i32> %broadcast.splat939, %255
  ...
  %266 = icmp eq i64 %index.next931, %248
  br i1 %266, label %polly.loop_exit761, label %vector.body924, !llvm.loop !101

polly.loop_exit761:                               ; preds = %vector.body924, %polly.loop_header759
  %polly.indvar_next757 = add nuw nsw i64 %polly.indvar756, 1
  %exitcond835.not = icmp eq i64 %polly.indvar756, %246
...
polly.loop_header759:                             ; preds = %polly.loop_header753, %polly.loop_header759
  ...
  %exitcond831.not = icmp eq i64 %polly.indvar762, %250
