; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5771.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5771.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %104 = mul nuw nsw i64 %polly.indvar230, 20
...
vector.body1033:                                  ; preds = %vector.body1033, %vector.ph1037
  ...
  %wide.load1044 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %124, label %middle.block1031, label %vector.body1033, !llvm.loop !84
...
polly.loop_header372:                             ; preds = %polly.loop_header372.preheader, %polly.loop_exit380
  ...
  %127 = mul nuw nsw i64 %polly.indvar375, 80
...
polly.loop_header378:                             ; preds = %polly.loop_exit402, %polly.loop_header372
  ...
  %128 = mul nuw nsw i64 %polly.indvar381, 80
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_exit386
  ...
  %133 = mul nuw nsw i64 %polly.indvar403, 20
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %wide.load1018 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %153, label %middle.block1007, label %vector.body1009, !llvm.loop !94
...
polly.loop_header545:                             ; preds = %polly.loop_header545.preheader, %polly.loop_exit553
  ...
  %156 = mul nuw nsw i64 %polly.indvar548, 80
...
polly.loop_header551:                             ; preds = %polly.loop_exit575, %polly.loop_header545
  ...
  %157 = mul nuw nsw i64 %polly.indvar554, 80
  br label %polly.loop_header557

polly.loop_exit559:                               ; preds = %polly.loop_exit565
  %158 = mul nsw i64 %polly.indvar554, -80
  %159 = shl nsw i64 %polly.indvar554, 2
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_exit559
  ...
  %162 = mul nuw nsw i64 %polly.indvar576, 20
...
vector.body948:                                   ; preds = %vector.body948, %vector.ph949
  ...
  br i1 %196, label %polly.loop_exit760, label %vector.body948, !llvm.loop !103
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph965
  ...
  br i1 %225, label %polly.loop_exit787, label %vector.body962, !llvm.loop !106
...
vector.body980:                                   ; preds = %vector.body980, %vector.ph983
  ...
  br i1 %254, label %polly.loop_exit813, label %vector.body980, !llvm.loop !109
