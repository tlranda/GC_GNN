; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4386.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4386.c"
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin987 = call i64 @llvm.smin.i64(i64 %indvars.iv981, i64 99)
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header387
  ...
  %132 = mul nuw nsw i64 %polly.indvar397, 100
  %133 = sub nsw i64 %129, %132
  %134 = add nuw nsw i64 %132, 100
...
polly.loop_header400:                             ; preds = %polly.loop_exit437, %polly.loop_header394
  ...
  %smin1011 = call i64 @llvm.smin.i64(i64 %indvars.iv1005, i64 99)
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header576
  ...
  %163 = mul nuw nsw i64 %polly.indvar586, 100
  %164 = sub nsw i64 %160, %163
  %165 = add nuw nsw i64 %163, 100
...
polly.loop_header589:                             ; preds = %polly.loop_exit626, %polly.loop_header583
  ...
  %smin1035 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 99)
