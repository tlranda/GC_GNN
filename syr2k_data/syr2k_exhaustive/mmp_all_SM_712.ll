; ModuleID = 'syr2k_exhaustive/mmp_all_SM_712.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_712.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %104 = mul nuw nsw i64 %indvar1265, 50
  %105 = mul nuw nsw i64 %polly.indvar231, 50
  %106 = add nsw i64 %105, %100
  %107 = add nsw i64 %106, -1
  %.inv = icmp ugt i64 %106, 99
  %108 = select i1 %.inv, i64 99, i64 %107
  %polly.loop_guard = icmp sgt i64 %108, -1
  %109 = add nuw nsw i64 %106, 49
...
polly.loop_exit267:                               ; preds = %polly.loop_exit273
  ...
  %indvars.iv.next972 = add nuw nsw i64 %indvars.iv971, 50
  %exitcond980.not = icmp eq i64 %polly.indvar_next232, 24
...
polly.loop_header271:                             ; preds = %polly.loop_exit279, %polly.loop_header265
  ...
  %smin1267 = call i64 @llvm.smin.i64(i64 %115, i64 99)
  %116 = add nuw nsw i64 %smin1267, 1
  %smin975 = call i64 @llvm.smin.i64(i64 %indvars.iv973, i64 99)
...
polly.loop_exit279:                               ; preds = %polly.loop_header277, %middle.block1262
  ...
  %exitcond977.not = icmp eq i64 %polly.indvar_next275, 50
...
polly.loop_exit422:                               ; preds = %polly.loop_exit428
  %152 = mul nsw i64 %polly.indvar417, -100
...
polly.loop_header436:                             ; preds = %polly.loop_exit477, %polly.loop_exit422
  ...
  %156 = mul nuw nsw i64 %indvar1218, 50
  %157 = mul nuw nsw i64 %polly.indvar439, 50
  %158 = add nsw i64 %157, %152
  %159 = add nsw i64 %158, -1
  %.inv928 = icmp ugt i64 %158, 99
  %160 = select i1 %.inv928, i64 99, i64 %159
  %polly.loop_guard452 = icmp sgt i64 %160, -1
  %161 = add nuw nsw i64 %158, 49
...
polly.loop_exit477:                               ; preds = %polly.loop_exit483
  ...
  %exitcond1006.not = icmp eq i64 %polly.indvar_next440, 24
...
polly.loop_header481:                             ; preds = %polly.loop_exit489, %polly.loop_header475
  ...
  %smin1220 = call i64 @llvm.smin.i64(i64 %167, i64 99)
...
polly.loop_exit489:                               ; preds = %polly.loop_header487, %middle.block1215
  ...
  %exitcond1003.not = icmp eq i64 %polly.indvar_next485, 50
...
polly.loop_header624:                             ; preds = %polly.loop_exit648, %polly.loop_header618
  ...
  %203 = mul nuw nsw i64 %polly.indvar627, 100
  br label %polly.loop_header630

polly.loop_exit632:                               ; preds = %polly.loop_exit638
  %204 = mul nsw i64 %polly.indvar627, -100
...
polly.loop_header646:                             ; preds = %polly.loop_exit687, %polly.loop_exit632
  ...
  %208 = mul nuw nsw i64 %indvar1171, 50
  %209 = mul nuw nsw i64 %polly.indvar649, 50
  %210 = add nsw i64 %209, %204
  %211 = add nsw i64 %210, -1
  %.inv929 = icmp ugt i64 %210, 99
  %212 = select i1 %.inv929, i64 99, i64 %211
...
polly.loop_exit687:                               ; preds = %polly.loop_exit693
  ...
  %indvars.iv.next1024 = add nuw nsw i64 %indvars.iv1023, 50
  %exitcond1032.not = icmp eq i64 %polly.indvar_next650, 24
...
polly.loop_header691:                             ; preds = %polly.loop_exit699, %polly.loop_header685
  ...
  %smin1173 = call i64 @llvm.smin.i64(i64 %219, i64 99)
  %220 = add nuw nsw i64 %smin1173, 1
  %smin1027 = call i64 @llvm.smin.i64(i64 %indvars.iv1025, i64 99)
...
polly.loop_exit699:                               ; preds = %polly.loop_header697, %middle.block1168
  ...
  %exitcond1029.not = icmp eq i64 %polly.indvar_next695, 50
