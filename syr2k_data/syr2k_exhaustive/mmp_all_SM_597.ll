; ModuleID = 'syr2k_exhaustive/mmp_all_SM_597.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_597.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %indvars.iv1076 = phi i64 [ 7, %polly.loop_header200.preheader ], [ %indvars.iv.next1077, %polly.loop_exit224 ]
  ...
  %97 = mul nsw i64 %polly.indvar203, -12
  %98 = mul nuw nsw i64 %polly.indvar203, 12
  %99 = add nuw i64 %98, 28
  %100 = and i64 %99, -32
  %101 = add i64 %97, %100
  %102 = sub i64 %98, %100
  ...
  %107 = mul nsw i64 %polly.indvar203, -20
  %108 = mul nuw nsw i64 %polly.indvar203, 20
  br label %polly.loop_header206

polly.loop_exit208:                               ; preds = %polly.loop_exit214
  %109 = add nsw i64 %107, 1199
  %110 = mul nuw nsw i64 %polly.indvar203, 3
  %111 = add nuw nsw i64 %110, 7
  %pexp.p_div_q = lshr i64 %111, 3
  %112 = sub nsw i64 %polly.indvar203, %pexp.p_div_q
  %polly.loop_guard = icmp slt i64 %112, 38
...
polly.loop_exit224:                               ; preds = %polly.loop_exit263, %polly.loop_exit208
  ...
  %indvars.iv.next1075 = add nsw i64 %indvars.iv1074, -12
  %indvars.iv.next1077 = add nuw nsw i64 %indvars.iv1076, 3
  %indvars.iv.next1081 = add nuw nsw i64 %indvars.iv1080, 12
  %exitcond1088.not = icmp eq i64 %polly.indvar_next204, 60
...
polly.loop_header261.preheader:                   ; preds = %polly.loop_exit249, %polly.loop_exit249.us, %polly.loop_header222.split
  ...
  %134 = mul nsw i64 %polly.indvar225, -32
...
polly.loop_header268:                             ; preds = %polly.loop_header261, %polly.loop_exit278
  ...
  %smin1392 = call i64 @llvm.smin.i64(i64 %139, i64 19)
  %140 = add nsw i64 %smin1392, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1084, i64 19)
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit434
  ...
  %indvars.iv1100 = phi i64 [ 7, %polly.loop_header408.preheader ], [ %indvars.iv.next1101, %polly.loop_exit434 ]
  ...
  %173 = mul nsw i64 %polly.indvar411, -12
  %174 = mul nuw nsw i64 %polly.indvar411, 12
  %175 = add nuw i64 %174, 28
  %176 = and i64 %175, -32
  %177 = add i64 %173, %176
  %178 = sub i64 %174, %176
  %179 = shl nuw nsw i64 %indvars.iv1100, 2
  %180 = and i64 %179, 9223372036854775776
  %181 = add i64 %indvars.iv1098, %180
  %182 = sub nsw i64 %indvars.iv1105, %180
  %183 = mul nsw i64 %polly.indvar411, -20
  %184 = mul nuw nsw i64 %polly.indvar411, 20
  br label %polly.loop_header414

polly.loop_exit416:                               ; preds = %polly.loop_exit422
  %185 = add nsw i64 %183, 1199
  %186 = mul nuw nsw i64 %polly.indvar411, 3
  %187 = add nuw nsw i64 %186, 7
  %pexp.p_div_q430 = lshr i64 %187, 3
  %188 = sub nsw i64 %polly.indvar411, %pexp.p_div_q430
  %polly.loop_guard435 = icmp slt i64 %188, 38
...
polly.loop_exit434:                               ; preds = %polly.loop_exit474, %polly.loop_exit416
  ...
  %indvars.iv.next1106 = add nuw nsw i64 %indvars.iv1105, 12
  %exitcond1114.not = icmp eq i64 %polly.indvar_next412, 60
...
polly.loop_header472.preheader:                   ; preds = %polly.loop_exit460, %polly.loop_exit460.us, %polly.loop_header432.split
  ...
  %210 = mul nsw i64 %polly.indvar436, -32
  %211 = icmp slt i64 %210, -1168
  %212 = select i1 %211, i64 %210, i64 -1168
...
polly.loop_header479:                             ; preds = %polly.loop_header472, %polly.loop_exit489
  ...
  %smin1342 = call i64 @llvm.smin.i64(i64 %215, i64 19)
  %216 = add nsw i64 %smin1342, 1
  %smin1111 = call i64 @llvm.smin.i64(i64 %indvars.iv1109, i64 19)
...
polly.loop_header619:                             ; preds = %polly.loop_header619.preheader, %polly.loop_exit645
  ...
  %indvars.iv1126 = phi i64 [ 7, %polly.loop_header619.preheader ], [ %indvars.iv.next1127, %polly.loop_exit645 ]
  ...
  %249 = mul nsw i64 %polly.indvar622, -12
  %250 = mul nuw nsw i64 %polly.indvar622, 12
  %251 = add nuw i64 %250, 28
  %252 = and i64 %251, -32
  %253 = add i64 %249, %252
  %254 = sub i64 %250, %252
  ...
  %259 = mul nsw i64 %polly.indvar622, -20
  %260 = mul nuw nsw i64 %polly.indvar622, 20
  br label %polly.loop_header625

polly.loop_exit627:                               ; preds = %polly.loop_exit633
  %261 = add nsw i64 %259, 1199
  %262 = mul nuw nsw i64 %polly.indvar622, 3
  %263 = add nuw nsw i64 %262, 7
  %pexp.p_div_q641 = lshr i64 %263, 3
  %264 = sub nsw i64 %polly.indvar622, %pexp.p_div_q641
  %polly.loop_guard646 = icmp slt i64 %264, 38
...
polly.loop_exit645:                               ; preds = %polly.loop_exit685, %polly.loop_exit627
  ...
  %indvars.iv.next1125 = add nsw i64 %indvars.iv1124, -12
  %indvars.iv.next1127 = add nuw nsw i64 %indvars.iv1126, 3
  %indvars.iv.next1132 = add nuw nsw i64 %indvars.iv1131, 12
  %exitcond1140.not = icmp eq i64 %polly.indvar_next623, 60
...
polly.loop_header683.preheader:                   ; preds = %polly.loop_exit671, %polly.loop_exit671.us, %polly.loop_header643.split
  ...
  %286 = mul nsw i64 %polly.indvar647, -32
  %287 = icmp slt i64 %286, -1168
  %288 = select i1 %287, i64 %286, i64 -1168
...
polly.loop_header690:                             ; preds = %polly.loop_header683, %polly.loop_exit700
  ...
  %smin1292 = call i64 @llvm.smin.i64(i64 %291, i64 19)
  %292 = add nsw i64 %smin1292, 1
  %smin1137 = call i64 @llvm.smin.i64(i64 %indvars.iv1135, i64 19)
