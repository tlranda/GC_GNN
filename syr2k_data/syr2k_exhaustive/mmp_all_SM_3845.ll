; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3845.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3845.c"
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %107 = or i64 %106, 1
  %108 = shl nsw i64 %polly.indvar208, 6
  %109 = mul nsw i64 %polly.indvar208, -64
...
polly.loop_header217.us955:                       ; preds = %polly.loop_header211.split, %polly.merge.us992
  ...
  %119 = add nuw nsw i64 %polly.indvar220.us956, %97
...
polly.loop_header263.us:                          ; preds = %polly.loop_header263.preheader, %polly.loop_exit272.loopexit.us
  ...
  %125 = add nuw nsw i64 %polly.indvar266.us, %97
...
polly.loop_header270.us:                          ; preds = %polly.loop_header263.us, %polly.loop_exit280.us
  %indvars.iv1127 = phi i64 [ %110, %polly.loop_header263.us ], [ %indvars.iv.next1128, %polly.loop_exit280.us ]
  ...
  %128 = add i64 %127, %109
  %polly.loop_guard281.us1234 = icmp sgt i64 %128, -1
...
vector.body1355:                                  ; preds = %vector.body1355, %vector.ph1359
  ...
  %141 = shl nuw nsw i64 %index1362, 3
  %142 = getelementptr i8, i8* %scevgep402, i64 %141
  %143 = bitcast i8* %142 to <4 x double>*
  %wide.load1366 = load <4 x double>, <4 x double>* %143, align 8, !alias.scope !78, !noalias !80
  %144 = fmul fast <4 x double> %wide.load1366, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  br i1 %146, label %middle.block1353, label %vector.body1355, !llvm.loop !84

middle.block1353:                                 ; preds = %vector.body1355
  %cmp.n1365 = icmp eq i64 %139, %n.vec1361
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %148 = mul nuw nsw i64 %polly.indvar409, 100
...
polly.loop_header412:                             ; preds = %polly.loop_exit422, %polly.loop_header406
  ...
  %149 = udiv i64 %indvars.iv1141, 25
  %150 = mul nuw nsw i64 %149, 100
  %151 = trunc i64 %polly.indvar415 to i8
  %152 = mul i8 %151, 9
  %pexp.p_div_q418.lhs.trunc = add i8 %152, 24
...
polly.loop_header420.preheader:                   ; preds = %polly.loop_header412
  %154 = sub nsw i64 %indvars.iv1139, %150
  %155 = sub nsw i64 %indvars.iv1153, %150
  %156 = add i64 %indvars.iv1148, %150
  %157 = shl nsw i64 %polly.indvar415, 4
  %158 = or i64 %157, 1
  %159 = shl nsw i64 %polly.indvar415, 6
  %160 = mul nsw i64 %polly.indvar415, -64
...
polly.loop_header420:                             ; preds = %polly.loop_header420.preheader, %polly.loop_exit479
  %indvars.iv1155 = phi i64 [ %155, %polly.loop_header420.preheader ], [ %indvars.iv.next1156, %polly.loop_exit479 ]
  %indvars.iv1150 = phi i64 [ %156, %polly.loop_header420.preheader ], [ %indvars.iv.next1151, %polly.loop_exit479 ]
  %indvars.iv1143 = phi i64 [ %154, %polly.loop_header420.preheader ], [ %indvars.iv.next1144, %polly.loop_exit479 ]
...
polly.loop_header463.preheader.us:                ; preds = %polly.loop_header427.us
  %169 = add nuw nsw i64 %polly.indvar430.us, %148
...
polly.loop_header427.us1002:                      ; preds = %polly.loop_header420.split, %polly.merge434.us1039
  ...
  %170 = add nuw nsw i64 %polly.indvar430.us1003, %148
...
polly.loop_header427:                             ; preds = %polly.loop_header420.split, %polly.merge434
  ...
  %172 = add nuw nsw i64 %polly.indvar430, %148
...
polly.loop_header477.us:                          ; preds = %polly.loop_header477.preheader, %polly.loop_exit486.loopexit.us
  ...
  %176 = add nuw nsw i64 %polly.indvar480.us, %148
...
polly.loop_header484.us:                          ; preds = %polly.loop_header477.us, %polly.loop_exit494.us
  %indvars.iv1157 = phi i64 [ %161, %polly.loop_header477.us ], [ %indvars.iv.next1158, %polly.loop_exit494.us ]
  ...
  %179 = add i64 %178, %160
  %polly.loop_guard495.us1235 = icmp sgt i64 %179, -1
...
polly.loop_header604:                             ; preds = %polly.loop_exit612, %polly.start518
  ...
  %min.iters.check1332 = icmp ult i64 %190, 4
...
vector.body1331:                                  ; preds = %vector.body1331, %vector.ph1333
  ...
  %192 = shl nuw nsw i64 %index1336, 3
  %193 = getelementptr i8, i8* %scevgep616, i64 %192
  %194 = bitcast i8* %193 to <4 x double>*
  %wide.load1340 = load <4 x double>, <4 x double>* %194, align 8, !alias.scope !88, !noalias !90
  %195 = fmul fast <4 x double> %wide.load1340, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %197 = icmp eq i64 %index.next1337, %n.vec1335
  br i1 %197, label %middle.block1329, label %vector.body1331, !llvm.loop !94

middle.block1329:                                 ; preds = %vector.body1331
  %cmp.n1339 = icmp eq i64 %190, %n.vec1335
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %199 = mul nuw nsw i64 %polly.indvar623, 100
...
polly.loop_header626:                             ; preds = %polly.loop_exit636, %polly.loop_header620
  ...
  %200 = udiv i64 %indvars.iv1172, 25
  %201 = mul nuw nsw i64 %200, 100
  %202 = trunc i64 %polly.indvar629 to i8
  %203 = mul i8 %202, 9
  %pexp.p_div_q632.lhs.trunc = add i8 %203, 24
...
polly.loop_header634.preheader:                   ; preds = %polly.loop_header626
  %205 = sub nsw i64 %indvars.iv1170, %201
  %206 = sub nsw i64 %indvars.iv1184, %201
  %207 = add i64 %indvars.iv1179, %201
  %208 = shl nsw i64 %polly.indvar629, 4
  %209 = or i64 %208, 1
  %210 = shl nsw i64 %polly.indvar629, 6
  %211 = mul nsw i64 %polly.indvar629, -64
...
polly.loop_header634:                             ; preds = %polly.loop_header634.preheader, %polly.loop_exit693
  %indvars.iv1186 = phi i64 [ %206, %polly.loop_header634.preheader ], [ %indvars.iv.next1187, %polly.loop_exit693 ]
  %indvars.iv1181 = phi i64 [ %207, %polly.loop_header634.preheader ], [ %indvars.iv.next1182, %polly.loop_exit693 ]
  %indvars.iv1174 = phi i64 [ %205, %polly.loop_header634.preheader ], [ %indvars.iv.next1175, %polly.loop_exit693 ]
...
polly.loop_header677.preheader.us:                ; preds = %polly.loop_header641.us
  %220 = add nuw nsw i64 %polly.indvar644.us, %199
...
polly.loop_header641.us1049:                      ; preds = %polly.loop_header634.split, %polly.merge648.us1086
  ...
  %221 = add nuw nsw i64 %polly.indvar644.us1050, %199
...
polly.loop_header641:                             ; preds = %polly.loop_header634.split, %polly.merge648
  ...
  %223 = add nuw nsw i64 %polly.indvar644, %199
...
polly.loop_header691.us:                          ; preds = %polly.loop_header691.preheader, %polly.loop_exit700.loopexit.us
  ...
  %227 = add nuw nsw i64 %polly.indvar694.us, %199
...
polly.loop_header698.us:                          ; preds = %polly.loop_header691.us, %polly.loop_exit708.us
  %indvars.iv1188 = phi i64 [ %212, %polly.loop_header691.us ], [ %indvars.iv.next1189, %polly.loop_exit708.us ]
  ...
  %230 = add i64 %229, %211
  %polly.loop_guard709.us1236 = icmp sgt i64 %230, -1
...
polly.loop_header862:                             ; preds = %polly.loop_exit870, %polly.loop_header856
  ...
  %smin1270 = call i64 @llvm.smin.i64(i64 %243, i64 -1168)
  %244 = add nsw i64 %smin1270, 1200
  %smin1219 = call i64 @llvm.smin.i64(i64 %indvars.iv1217, i64 -1168)
  %245 = shl nsw i64 %polly.indvar865, 5
  %246 = add nsw i64 %smin1219, 1199
...
vector.ph1271:                                    ; preds = %polly.loop_header868
  %broadcast.splatinsert1278 = insertelement <4 x i64> poison, i64 %245, i32 0
  %broadcast.splat1279 = shufflevector <4 x i64> %broadcast.splatinsert1278, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1280 = insertelement <4 x i32> poison, i32 %248, i32 0
...
vector.body1269:                                  ; preds = %vector.body1269, %vector.ph1271
  ...
  %250 = add nuw nsw <4 x i64> %vec.ind1276, %broadcast.splat1279
  %251 = trunc <4 x i64> %250 to <4 x i32>
  %252 = mul <4 x i32> %broadcast.splat1281, %251
  ...
  %262 = icmp eq i64 %index.next1273, %244
  br i1 %262, label %polly.loop_exit876, label %vector.body1269, !llvm.loop !103

polly.loop_exit876:                               ; preds = %vector.body1269, %polly.loop_header874
  %polly.indvar_next872 = add nuw nsw i64 %polly.indvar871, 1
  %exitcond1224.not = icmp eq i64 %polly.indvar871, %242
...
polly.loop_header874:                             ; preds = %polly.loop_header868, %polly.loop_header874
  ...
  %exitcond1220.not = icmp eq i64 %polly.indvar877, %246
...
polly.loop_header889:                             ; preds = %polly.loop_exit897, %polly.loop_header883
  ...
  %smin1285 = call i64 @llvm.smin.i64(i64 %272, i64 -968)
  %273 = add nsw i64 %smin1285, 1000
  %smin1209 = call i64 @llvm.smin.i64(i64 %indvars.iv1207, i64 -968)
  %274 = shl nsw i64 %polly.indvar892, 5
  %275 = add nsw i64 %smin1209, 999
...
vector.body1284:                                  ; preds = %vector.body1284, %vector.ph1287
  ...
  %279 = add nuw nsw <4 x i64> %vec.ind1294, %broadcast.splat1297
  %280 = trunc <4 x i64> %279 to <4 x i32>
  %281 = mul <4 x i32> %broadcast.splat1299, %280
  ...
  %291 = icmp eq i64 %index.next1291, %273
  br i1 %291, label %polly.loop_exit903, label %vector.body1284, !llvm.loop !106

polly.loop_exit903:                               ; preds = %vector.body1284, %polly.loop_header901
  %polly.indvar_next899 = add nuw nsw i64 %polly.indvar898, 1
  %exitcond1214.not = icmp eq i64 %polly.indvar898, %271
...
polly.loop_header901:                             ; preds = %polly.loop_header895, %polly.loop_header901
  ...
  %exitcond1210.not = icmp eq i64 %polly.indvar904, %275
...
polly.loop_header915:                             ; preds = %polly.loop_exit923, %polly.loop_header909
  ...
  %smin1303 = call i64 @llvm.smin.i64(i64 %301, i64 -968)
  %302 = add nsw i64 %smin1303, 1000
  %smin1199 = call i64 @llvm.smin.i64(i64 %indvars.iv1197, i64 -968)
  %303 = shl nsw i64 %polly.indvar918, 5
  %304 = add nsw i64 %smin1199, 999
...
vector.body1302:                                  ; preds = %vector.body1302, %vector.ph1305
  ...
  %308 = add nuw nsw <4 x i64> %vec.ind1312, %broadcast.splat1315
  %309 = trunc <4 x i64> %308 to <4 x i32>
  %310 = mul <4 x i32> %broadcast.splat1317, %309
  ...
  %320 = icmp eq i64 %index.next1309, %302
  br i1 %320, label %polly.loop_exit929, label %vector.body1302, !llvm.loop !109

polly.loop_exit929:                               ; preds = %vector.body1302, %polly.loop_header927
  %polly.indvar_next925 = add nuw nsw i64 %polly.indvar924, 1
  %exitcond1204.not = icmp eq i64 %polly.indvar924, %300
...
polly.loop_header927:                             ; preds = %polly.loop_header921, %polly.loop_header927
  ...
  %exitcond1200.not = icmp eq i64 %polly.indvar930, %304
