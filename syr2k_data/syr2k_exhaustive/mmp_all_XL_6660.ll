; ModuleID = 'syr2k_exhaustive/mmp_all_XL_6660.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_6660.c"
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1045
  ...
  %wide.load1052 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %132, label %middle.block1039, label %vector.body1041, !llvm.loop !79
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %135 = mul nsw i64 %polly.indvar393, -4
  %136 = shl nsw i64 %polly.indvar393, 2
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %polly.loop_guard413 = icmp slt i64 %148, 4
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  %wide.load1026 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %169, label %middle.block1015, label %vector.body1017, !llvm.loop !89
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %172 = mul nsw i64 %polly.indvar571, -4
  %173 = shl nsw i64 %polly.indvar571, 2
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %polly.loop_guard591 = icmp slt i64 %185, 4
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph957
  ...
  br i1 %220, label %polly.loop_exit772, label %vector.body955, !llvm.loop !98
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  br i1 %249, label %polly.loop_exit799, label %vector.body970, !llvm.loop !101
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  br i1 %278, label %polly.loop_exit825, label %vector.body988, !llvm.loop !104
