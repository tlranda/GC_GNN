; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9680.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9680.c"
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph994
  ...
  %wide.load1001 = load <4 x double>, <4 x double>* %127, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %130, label %middle.block988, label %vector.body990, !llvm.loop !73
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %polly.loop_guard376 = icmp slt i64 %144, 20
...
vector.body966:                                   ; preds = %vector.body966, %vector.ph968
  ...
  %wide.load975 = load <4 x double>, <4 x double>* %162, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %165, label %middle.block964, label %vector.body966, !llvm.loop !82
...
polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  ...
  %167 = mul nsw i64 %polly.indvar514, -20
...
polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  ...
  %polly.loop_guard533 = icmp slt i64 %179, 20
...
vector.body904:                                   ; preds = %vector.body904, %vector.ph906
  ...
  br i1 %214, label %polly.loop_exit712, label %vector.body904, !llvm.loop !91
...
vector.body919:                                   ; preds = %vector.body919, %vector.ph922
  ...
  br i1 %243, label %polly.loop_exit739, label %vector.body919, !llvm.loop !94
...
vector.body937:                                   ; preds = %vector.body937, %vector.ph940
  ...
  br i1 %272, label %polly.loop_exit765, label %vector.body937, !llvm.loop !97
