; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7967.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7967.c"
...
vector.body1046:                                  ; preds = %vector.body1046, %vector.ph1048
  ...
  br i1 %57, label %middle.block1044, label %vector.body1046, !llvm.loop !54
...
vector.body1072:                                  ; preds = %vector.body1072, %vector.ph1074
  ...
  br i1 %68, label %middle.block1070, label %vector.body1072, !llvm.loop !56
...
vector.body1084:                                  ; preds = %vector.body1084, %vector.ph1088
  ...
  %wide.load1095 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !62, !noalias !64
  ...
  br i1 %95, label %middle.block1082, label %vector.body1084, !llvm.loop !68
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond858.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !69
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar_next225, 8
...
vector.body1058:                                  ; preds = %vector.body1058, %vector.ph1062
  ...
  %wide.load1069 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %132, label %middle.block1056, label %vector.body1058, !llvm.loop !79
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  br i1 %exitcond887.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !80
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  ...
  %smin875 = call i64 @llvm.smin.i64(i64 %indvars.iv873, i64 -872)
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412
  ...
  %exitcond883.not = icmp eq i64 %polly.indvar_next400, 8
...
vector.body1034:                                  ; preds = %vector.body1034, %vector.ph1036
  ...
  %wide.load1043 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %169, label %middle.block1032, label %vector.body1034, !llvm.loop !89
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  br i1 %exitcond916.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !90
...
polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  ...
  %smin904 = call i64 @llvm.smin.i64(i64 %indvars.iv902, i64 -872)
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond912.not = icmp eq i64 %polly.indvar_next578, 8
...
vector.body972:                                   ; preds = %vector.body972, %vector.ph974
  ...
  br i1 %220, label %polly.loop_exit772, label %vector.body972, !llvm.loop !98
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  br i1 %exitcond941.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !99
...
vector.body987:                                   ; preds = %vector.body987, %vector.ph990
  ...
  br i1 %249, label %polly.loop_exit799, label %vector.body987, !llvm.loop !101
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  br i1 %exitcond931.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !102
...
vector.body1005:                                  ; preds = %vector.body1005, %vector.ph1008
  ...
  br i1 %278, label %polly.loop_exit825, label %vector.body1005, !llvm.loop !104
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  br i1 %exitcond921.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !105
}
