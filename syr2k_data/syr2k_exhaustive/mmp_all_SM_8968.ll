; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8968.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8968.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond800.not = icmp eq i64 %polly.indvar_next203, 125
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %98 = udiv i64 %indvars.iv788, 24
  %99 = mul nuw nsw i64 %98, 96
  %100 = sub nsw i64 %indvars.iv, %99
  %101 = add i64 %indvars.iv792, %99
  %102 = trunc i64 %polly.indvar208 to i16
  %pexp.p_div_q.lhs.trunc = mul i16 %102, 5
...
polly.loop_exit225:                               ; preds = %polly.loop_exit232
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar_next221, 8
...
polly.loop_header223:                             ; preds = %polly.loop_header217, %polly.loop_exit232
  %indvars.iv796 = phi i64 [ %105, %polly.loop_header217 ], [ %indvars.iv.next797, %polly.loop_exit232 ]
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar_next358, 125
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %136 = udiv i64 %indvars.iv805, 24
  %137 = mul nuw nsw i64 %136, 96
  %138 = sub nsw i64 %indvars.iv803, %137
  %139 = add i64 %indvars.iv810, %137
  %140 = trunc i64 %polly.indvar363 to i16
  %pexp.p_div_q366.lhs.trunc = mul i16 %140, 5
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv812 = phi i64 [ %indvars.iv.next813, %polly.loop_exit375 ], [ %139, %polly.loop_header360 ]
  %indvars.iv807 = phi i64 [ %indvars.iv.next808, %polly.loop_exit375 ], [ %138, %polly.loop_header360 ]
...
polly.loop_exit382:                               ; preds = %polly.loop_exit390
  ...
  %exitcond818.not = icmp eq i64 %polly.indvar_next377, 8
...
polly.loop_header380:                             ; preds = %polly.loop_header373, %polly.loop_exit390
  %indvars.iv814 = phi i64 [ %143, %polly.loop_header373 ], [ %indvars.iv.next815, %polly.loop_exit390 ]
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %exitcond840.not = icmp eq i64 %polly.indvar_next516, 125
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %174 = udiv i64 %indvars.iv825, 24
  %175 = mul nuw nsw i64 %174, 96
  %176 = sub nsw i64 %indvars.iv823, %175
  %177 = add i64 %indvars.iv830, %175
  %178 = trunc i64 %polly.indvar521 to i16
  %pexp.p_div_q524.lhs.trunc = mul i16 %178, 5
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv832 = phi i64 [ %indvars.iv.next833, %polly.loop_exit533 ], [ %177, %polly.loop_header518 ]
  %indvars.iv827 = phi i64 [ %indvars.iv.next828, %polly.loop_exit533 ], [ %176, %polly.loop_header518 ]
...
polly.loop_exit540:                               ; preds = %polly.loop_exit548
  ...
  %exitcond838.not = icmp eq i64 %polly.indvar_next535, 8
