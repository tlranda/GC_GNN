; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7749.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7749.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv846 = phi i64 [ %indvars.iv.next847, %polly.loop_exit223 ], [ 2, %polly.loop_exit207 ]
  ...
  %99 = mul nsw i64 %polly.indvar218, -100
  %100 = mul nuw nsw i64 %polly.indvar218, 100
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond848 = icmp eq i64 %polly.indvar_next231, %98
  br i1 %exitcond848, label %polly.loop_exit229, label %polly.loop_header227
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1045
  ...
  %wide.load1052 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %133, label %middle.block1039, label %vector.body1041, !llvm.loop !80
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv869 = phi i64 [ %indvars.iv.next870, %polly.loop_exit398 ], [ 2, %polly.loop_exit382 ]
  ...
  %135 = lshr i64 %polly.indvar393, 2
  %136 = add nuw i64 %indvars.iv869, %135
  %137 = mul nsw i64 %polly.indvar393, -100
  %138 = mul nuw nsw i64 %polly.indvar393, 100
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %147 = mul nuw nsw i64 %polly.indvar406, 80
  %148 = add nsw i64 %147, %137
  %149 = icmp sgt i64 %148, 0
  %150 = select i1 %149, i64 %148, i64 0
  %polly.loop_guard413 = icmp slt i64 %150, 100
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %indvars.iv.next858 = add nsw i64 %indvars.iv857, 80
  %indvars.iv.next863 = add nsw i64 %indvars.iv862, -80
  %exitcond871 = icmp eq i64 %polly.indvar_next407, %136
  br i1 %exitcond871, label %polly.loop_exit405, label %polly.loop_header403
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  %wide.load1026 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %171, label %middle.block1015, label %vector.body1017, !llvm.loop !90
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit576 ], [ 2, %polly.loop_exit560 ]
  ...
  %173 = lshr i64 %polly.indvar571, 2
  %174 = add nuw i64 %indvars.iv892, %173
  %175 = mul nsw i64 %polly.indvar571, -100
  %176 = mul nuw nsw i64 %polly.indvar571, 100
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %185 = mul nuw nsw i64 %polly.indvar584, 80
  %186 = add nsw i64 %185, %175
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %polly.loop_guard591 = icmp slt i64 %188, 100
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %indvars.iv.next881 = add nsw i64 %indvars.iv880, 80
  %indvars.iv.next886 = add nsw i64 %indvars.iv885, -80
  %exitcond894 = icmp eq i64 %polly.indvar_next585, %174
  br i1 %exitcond894, label %polly.loop_exit583, label %polly.loop_header581
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph957
  ...
  br i1 %223, label %polly.loop_exit772, label %vector.body955, !llvm.loop !99
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  br i1 %252, label %polly.loop_exit799, label %vector.body970, !llvm.loop !102
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  br i1 %281, label %polly.loop_exit825, label %vector.body988, !llvm.loop !105
