; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7733.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7733.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv832, i64 276)
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next833 = add nuw nsw i64 %indvars.iv832, 24
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit394
  ...
  %umin856 = call i64 @llvm.umin.i64(i64 %indvars.iv854, i64 276)
  ...
  %132 = add nuw nsw i64 %umin856, 23
...
polly.loop_exit394:                               ; preds = %polly.loop_exit401
  ...
  %indvars.iv.next855 = add nuw nsw i64 %indvars.iv854, 24
...
polly.loop_header392:                             ; preds = %polly.loop_exit401, %polly.loop_header386
  ...
  %133 = shl nsw i64 %polly.indvar395, 2
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408, %polly.loop_header392
  ...
  %indvars.iv.next848 = add nsw i64 %indvars.iv847, -4
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit408
  ...
  %smin851 = call i64 @llvm.smin.i64(i64 %indvars.iv849, i64 3)
...
polly.loop_header559:                             ; preds = %polly.loop_exit551, %polly.loop_exit567
  ...
  %umin879 = call i64 @llvm.umin.i64(i64 %indvars.iv877, i64 276)
  ...
  %162 = add nuw nsw i64 %umin879, 23
...
polly.loop_exit567:                               ; preds = %polly.loop_exit574
  ...
  %indvars.iv.next878 = add nuw nsw i64 %indvars.iv877, 24
...
polly.loop_header565:                             ; preds = %polly.loop_exit574, %polly.loop_header559
  ...
  %163 = shl nsw i64 %polly.indvar568, 2
...
polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit581
  ...
  %smin874 = call i64 @llvm.smin.i64(i64 %indvars.iv872, i64 3)
