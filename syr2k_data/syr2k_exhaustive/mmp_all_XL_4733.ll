; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4733.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4733.c"
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit250
  ...
  %polly.loop_guard2331083 = icmp sgt i64 %135, -1
...
vector.body1191:                                  ; preds = %vector.body1191, %vector.ph1195
  ...
  %150 = shl nuw nsw i64 %index1198, 3
  %151 = getelementptr i8, i8* %scevgep379, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load1202 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !74, !noalias !76
  %153 = fmul fast <4 x double> %wide.load1202, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next1199, %n.vec1197
  br i1 %155, label %middle.block1189, label %vector.body1191, !llvm.loop !80

middle.block1189:                                 ; preds = %vector.body1191
  %cmp.n1201 = icmp eq i64 %148, %n.vec1197
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %157 = udiv i64 %polly.indvar386, 5
  %158 = add nuw i64 %indvars.iv1015, %157
  %umin1017 = call i64 @llvm.umin.i64(i64 %158, i64 56)
  %159 = mul nsw i64 %polly.indvar386, -64
  %160 = icmp slt i64 %159, -1136
  %161 = select i1 %160, i64 %159, i64 -1136
  %162 = add nsw i64 %161, 1199
  %163 = shl nsw i64 %polly.indvar386, 6
  %164 = add nuw nsw i64 %umin1017, 3
...
polly.loop_header403.preheader:                   ; preds = %polly.loop_header396
  ...
  %192 = add i64 %smax1002, %indvars.iv1005
...
polly.loop_exit405:                               ; preds = %polly.loop_exit441, %polly.loop_header396
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar399, %164
...
polly.loop_header403:                             ; preds = %polly.loop_header403.preheader, %polly.loop_exit441
  %indvars.iv1007 = phi i64 [ %192, %polly.loop_header403.preheader ], [ %indvars.iv.next1008, %polly.loop_exit441 ]
  ...
  %polly.loop_guard4201084 = icmp sgt i64 %195, -1
...
polly.loop_header558:                             ; preds = %polly.loop_exit566, %polly.start472
  ...
  %min.iters.check1168 = icmp ult i64 %208, 4
...
vector.body1167:                                  ; preds = %vector.body1167, %vector.ph1169
  ...
  %210 = shl nuw nsw i64 %index1172, 3
  %211 = getelementptr i8, i8* %scevgep570, i64 %210
  %212 = bitcast i8* %211 to <4 x double>*
  %wide.load1176 = load <4 x double>, <4 x double>* %212, align 8, !alias.scope !84, !noalias !86
  %213 = fmul fast <4 x double> %wide.load1176, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %215 = icmp eq i64 %index.next1173, %n.vec1171
  br i1 %215, label %middle.block1165, label %vector.body1167, !llvm.loop !90

middle.block1165:                                 ; preds = %vector.body1167
  %cmp.n1175 = icmp eq i64 %208, %n.vec1171
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %217 = udiv i64 %polly.indvar577, 5
  %218 = add nuw i64 %indvars.iv1041, %217
  %umin1043 = call i64 @llvm.umin.i64(i64 %218, i64 56)
  %219 = mul nsw i64 %polly.indvar577, -64
  %220 = icmp slt i64 %219, -1136
  %221 = select i1 %220, i64 %219, i64 -1136
  %222 = add nsw i64 %221, 1199
  %223 = shl nsw i64 %polly.indvar577, 6
  %224 = add nuw nsw i64 %umin1043, 3
...
polly.loop_header594.preheader:                   ; preds = %polly.loop_header587
  ...
  %252 = add i64 %smax1028, %indvars.iv1031
...
polly.loop_exit596:                               ; preds = %polly.loop_exit632, %polly.loop_header587
  ...
  %exitcond1044.not = icmp eq i64 %polly.indvar590, %224
...
polly.loop_header594:                             ; preds = %polly.loop_header594.preheader, %polly.loop_exit632
  %indvars.iv1033 = phi i64 [ %252, %polly.loop_header594.preheader ], [ %indvars.iv.next1034, %polly.loop_exit632 ]
  ...
  %polly.loop_guard6111085 = icmp sgt i64 %255, -1
...
vector.ph1107:                                    ; preds = %polly.loop_header799
  %broadcast.splatinsert1114 = insertelement <4 x i64> poison, i64 %272, i32 0
  %broadcast.splat1115 = shufflevector <4 x i64> %broadcast.splatinsert1114, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1116 = insertelement <4 x i32> poison, i32 %275, i32 0
...
vector.body1106:                                  ; preds = %vector.body1106, %vector.ph1107
  ...
  %277 = add nuw nsw <4 x i64> %vec.ind1112, %broadcast.splat1115
  %278 = trunc <4 x i64> %277 to <4 x i32>
  %279 = mul <4 x i32> %broadcast.splat1117, %278
  ...
  %289 = icmp eq i64 %index.next1109, %271
  br i1 %289, label %polly.loop_exit807, label %vector.body1106, !llvm.loop !99

polly.loop_exit807:                               ; preds = %vector.body1106, %polly.loop_header805
  %polly.indvar_next803 = add nuw nsw i64 %polly.indvar802, 1
  %exitcond1076.not = icmp eq i64 %polly.indvar802, %269
...
polly.loop_header805:                             ; preds = %polly.loop_header799, %polly.loop_header805
  ...
  %exitcond1072.not = icmp eq i64 %polly.indvar808, %273
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %smin1121 = call i64 @llvm.smin.i64(i64 %299, i64 -968)
  %300 = add nsw i64 %smin1121, 1000
  %smin1061 = call i64 @llvm.smin.i64(i64 %indvars.iv1059, i64 -968)
  %301 = shl nsw i64 %polly.indvar823, 5
  %302 = add nsw i64 %smin1061, 999
...
vector.body1120:                                  ; preds = %vector.body1120, %vector.ph1123
  ...
  %306 = add nuw nsw <4 x i64> %vec.ind1130, %broadcast.splat1133
  %307 = trunc <4 x i64> %306 to <4 x i32>
  %308 = mul <4 x i32> %broadcast.splat1135, %307
  ...
  %318 = icmp eq i64 %index.next1127, %300
  br i1 %318, label %polly.loop_exit834, label %vector.body1120, !llvm.loop !102

polly.loop_exit834:                               ; preds = %vector.body1120, %polly.loop_header832
  %polly.indvar_next830 = add nuw nsw i64 %polly.indvar829, 1
  %exitcond1066.not = icmp eq i64 %polly.indvar829, %298
...
polly.loop_header832:                             ; preds = %polly.loop_header826, %polly.loop_header832
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar835, %302
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %smin1139 = call i64 @llvm.smin.i64(i64 %328, i64 -968)
  %329 = add nsw i64 %smin1139, 1000
  %smin1051 = call i64 @llvm.smin.i64(i64 %indvars.iv1049, i64 -968)
  %330 = shl nsw i64 %polly.indvar849, 5
  %331 = add nsw i64 %smin1051, 999
...
vector.body1138:                                  ; preds = %vector.body1138, %vector.ph1141
  ...
  %335 = add nuw nsw <4 x i64> %vec.ind1148, %broadcast.splat1151
  %336 = trunc <4 x i64> %335 to <4 x i32>
  %337 = mul <4 x i32> %broadcast.splat1153, %336
  ...
  %347 = icmp eq i64 %index.next1145, %329
  br i1 %347, label %polly.loop_exit860, label %vector.body1138, !llvm.loop !105

polly.loop_exit860:                               ; preds = %vector.body1138, %polly.loop_header858
  %polly.indvar_next856 = add nuw nsw i64 %polly.indvar855, 1
  %exitcond1056.not = icmp eq i64 %polly.indvar855, %327
...
polly.loop_header858:                             ; preds = %polly.loop_header852, %polly.loop_header858
  ...
  %exitcond1052.not = icmp eq i64 %polly.indvar861, %331
