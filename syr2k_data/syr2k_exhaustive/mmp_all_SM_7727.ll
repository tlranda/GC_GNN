; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7727.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7727.c"
...
for.cond1.preheader.i:                            ; preds = %entry, %for.inc17.i
  ...
  %scevgep958 = getelementptr i8, i8* %call2, i64 %12
  %scevgep957 = getelementptr i8, i8* %call2, i64 %11
  %scevgep956 = getelementptr i8, i8* %call1, i64 %12
  %scevgep955 = getelementptr i8, i8* %call1, i64 %11
  %bound0 = icmp ult i8* %scevgep955, %scevgep958
  %bound1 = icmp ult i8* %scevgep957, %scevgep956
...
for.inc17.i:                                      ; preds = %vector.body, %for.body3.i
  ...
  br i1 %exitcond18.not.i, label %vector.ph962, label %for.cond1.preheader.i, !llvm.loop !15

vector.ph962:                                     ; preds = %for.inc17.i, %for.inc41.i
  %indvars.iv7.i = phi i64 [ %indvars.iv.next8.i, %for.inc41.i ], [ 0, %for.inc17.i ]
  %broadcast.splatinsert969 = insertelement <4 x i64> poison, i64 %indvars.iv7.i, i32 0
...
vector.body961:                                   ; preds = %vector.body961, %vector.ph962
  %index963 = phi i64 [ 0, %vector.ph962 ], [ %index.next964, %vector.body961 ]
  %vec.ind967 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph962 ], [ %vec.ind.next968, %vector.body961 ]
  %32 = mul nuw nsw <4 x i64> %vec.ind967, %broadcast.splat970
  %33 = trunc <4 x i64> %32 to <4 x i32>
  %34 = add <4 x i32> %33, <i32 3, i32 3, i32 3, i32 3>
  %35 = urem <4 x i32> %34, <i32 1200, i32 1200, i32 1200, i32 1200>
  %36 = sitofp <4 x i32> %35 to <4 x double>
  %37 = fmul fast <4 x double> %36, <double 1.000000e-03, double 1.000000e-03, double 1.000000e-03, double 1.000000e-03>
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv7.i, i64 %index963
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next964 = add i64 %index963, 4
  %vec.ind.next968 = add <4 x i64> %vec.ind967, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next964, 1200
  br i1 %40, label %for.inc41.i, label %vector.body961, !llvm.loop !16

for.inc41.i:                                      ; preds = %vector.body961
  %indvars.iv.next8.i = add nuw nsw i64 %indvars.iv7.i, 1
  %exitcond9.not.i = icmp eq i64 %indvars.iv.next8.i, 1200
  br i1 %exitcond9.not.i, label %init_array.exit, label %vector.ph962, !llvm.loop !17
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check1025 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check1025, label %for.body3.i46.preheader1099, label %vector.ph1026

vector.ph1026:                                    ; preds = %for.body3.i46.preheader
  %n.vec1028 = and i64 %indvars.iv21.i, 9223372036854775804
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1026
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i, i64 %index1029
  ...
  %46 = icmp eq i64 %index.next1030, %n.vec1028
  br i1 %46, label %middle.block1022, label %vector.body1024, !llvm.loop !18

middle.block1022:                                 ; preds = %vector.body1024
  %cmp.n1032 = icmp eq i64 %indvars.iv21.i, %n.vec1028
  br i1 %cmp.n1032, label %for.inc6.i, label %for.body3.i46.preheader1099

for.body3.i46.preheader1099:                      ; preds = %for.body3.i46.preheader, %middle.block1022
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec1028, %middle.block1022 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1099, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1099 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block1022, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1048 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1048, label %for.body3.i60.preheader1098, label %vector.ph1049

vector.ph1049:                                    ; preds = %for.body3.i60.preheader
  %n.vec1051 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1047:                                  ; preds = %vector.body1047, %vector.ph1049
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i52, i64 %index1052
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1056 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1056, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1053 = add i64 %index1052, 4
  %57 = icmp eq i64 %index.next1053, %n.vec1051
  br i1 %57, label %middle.block1045, label %vector.body1047, !llvm.loop !55

middle.block1045:                                 ; preds = %vector.body1047
  %cmp.n1055 = icmp eq i64 %indvars.iv21.i52, %n.vec1051
  br i1 %cmp.n1055, label %for.inc6.i63, label %for.body3.i60.preheader1098

for.body3.i60.preheader1098:                      ; preds = %for.body3.i60.preheader, %middle.block1045
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1051, %middle.block1045 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1098, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1098 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1045, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1074 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1074, label %for.body3.i99.preheader1097, label %vector.ph1075

vector.ph1075:                                    ; preds = %for.body3.i99.preheader
  %n.vec1077 = and i64 %indvars.iv21.i91, 9223372036854775804
  br label %vector.body1073

vector.body1073:                                  ; preds = %vector.body1073, %vector.ph1075
  %index1078 = phi i64 [ 0, %vector.ph1075 ], [ %index.next1079, %vector.body1073 ]
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call778, i64 %indvars.iv21.i91, i64 %index1078
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1082 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1082, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1079 = add i64 %index1078, 4
  %68 = icmp eq i64 %index.next1079, %n.vec1077
  br i1 %68, label %middle.block1071, label %vector.body1073, !llvm.loop !57

middle.block1071:                                 ; preds = %vector.body1073
  %cmp.n1081 = icmp eq i64 %indvars.iv21.i91, %n.vec1077
  br i1 %cmp.n1081, label %for.inc6.i102, label %for.body3.i99.preheader1097

for.body3.i99.preheader1097:                      ; preds = %for.body3.i99.preheader, %middle.block1071
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1077, %middle.block1071 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1097, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1097 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1071, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit193, %polly.start
  %indvar1086 = phi i64 [ %indvar.next1087, %polly.loop_exit193 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1086, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1088 = icmp ult i64 %88, 4
  br i1 %min.iters.check1088, label %polly.loop_header191.preheader, label %vector.ph1089

vector.ph1089:                                    ; preds = %polly.loop_header
  %n.vec1091 = and i64 %88, -4
  br label %vector.body1085

vector.body1085:                                  ; preds = %vector.body1085, %vector.ph1089
  %index1092 = phi i64 [ 0, %vector.ph1089 ], [ %index.next1093, %vector.body1085 ]
  %90 = shl nuw nsw i64 %index1092, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1096 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  %93 = fmul fast <4 x double> %wide.load1096, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !63, !noalias !65
  %index.next1093 = add i64 %index1092, 4
  %95 = icmp eq i64 %index.next1093, %n.vec1091
  br i1 %95, label %middle.block1083, label %vector.body1085, !llvm.loop !69

middle.block1083:                                 ; preds = %vector.body1085
  %cmp.n1095 = icmp eq i64 %88, %n.vec1091
  br i1 %cmp.n1095, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block1083
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1091, %middle.block1083 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1083
  %polly.indvar_next = add nuw nsw i64 %polly.indvar, 1
  %exitcond860.not = icmp eq i64 %polly.indvar_next, 1200
  %indvar.next1087 = add i64 %indvar1086, 1
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv851 = phi i64 [ %indvars.iv.next852, %polly.loop_exit223 ], [ 27, %polly.loop_exit207 ]
  ...
  %97 = udiv i64 %indvars.iv851, 25
  %98 = sub nsw i64 %indvars.iv849, %97
  %smin853 = call i64 @llvm.smin.i64(i64 %98, i64 21)
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next852 = add nuw nsw i64 %indvars.iv851, 2
  %exitcond856.not = icmp eq i64 %polly.indvar_next219, 13
  br i1 %exitcond856.not, label %polly.exiting, label %polly.loop_header215

polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  %indvars.iv845 = phi i64 [ %indvars.iv.next846, %polly.loop_exit229 ], [ 0, %polly.loop_header215 ]
  %polly.indvar224 = phi i64 [ %polly.indvar_next225, %polly.loop_exit229 ], [ 0, %polly.loop_header215 ]
  %smin847 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -872)
  %105 = shl nsw i64 %polly.indvar224, 7
  %106 = add nsw i64 %smin847, 999
  br label %polly.loop_header227

polly.loop_exit229:                               ; preds = %polly.loop_exit235
  %polly.indvar_next225 = add nuw nsw i64 %polly.indvar224, 1
  %indvars.iv.next846 = add nsw i64 %indvars.iv845, -128
  %exitcond855.not = icmp eq i64 %polly.indvar_next225, 8
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %107 = mul nuw nsw i64 %polly.indvar230, 50
...
polly.loop_header233.preheader:                   ; preds = %polly.loop_header227
  ...
  %111 = add i64 %smax, %indvars.iv841
...
polly.loop_exit235:                               ; preds = %polly.loop_exit241, %polly.loop_header227
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar230, %104
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  %indvars.iv843 = phi i64 [ %111, %polly.loop_header233.preheader ], [ %indvars.iv.next844, %polly.loop_exit241 ]
  ...
  %polly.loop_guard249950 = icmp sgt i64 %113, -1
  %114 = add nuw nsw i64 %polly.indvar236, %103
  %115 = mul i64 %114, 8000
  %116 = mul i64 %114, 9600
  br i1 %polly.loop_guard249950, label %polly.loop_header239.us, label %polly.loop_exit241
...
polly.loop_header239.us:                          ; preds = %polly.loop_header233, %polly.loop_exit248.loopexit.us
  ...
  %117 = add nuw nsw i64 %polly.indvar242.us, %105
  %118 = shl i64 %117, 3
...
polly.loop_exit248.loopexit.us:                   ; preds = %polly.loop_header246.us
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar242.us, %106
  br i1 %exitcond848.not, label %polly.loop_exit241, label %polly.loop_header239.us
...
polly.loop_header358:                             ; preds = %polly.loop_exit366, %polly.start272
  %indvar1060 = phi i64 [ %indvar.next1061, %polly.loop_exit366 ], [ 0, %polly.start272 ]
  %polly.indvar361 = phi i64 [ %polly.indvar_next362, %polly.loop_exit366 ], [ 1, %polly.start272 ]
  %125 = add i64 %indvar1060, 1
  %126 = mul nuw nsw i64 %polly.indvar361, 9600
  %scevgep370 = getelementptr i8, i8* %call, i64 %126
  %min.iters.check1062 = icmp ult i64 %125, 4
  br i1 %min.iters.check1062, label %polly.loop_header364.preheader, label %vector.ph1063

vector.ph1063:                                    ; preds = %polly.loop_header358
  %n.vec1065 = and i64 %125, -4
...
vector.body1059:                                  ; preds = %vector.body1059, %vector.ph1063
  ...
  %127 = shl nuw nsw i64 %index1066, 3
  %128 = getelementptr i8, i8* %scevgep370, i64 %127
  %129 = bitcast i8* %128 to <4 x double>*
  %wide.load1070 = load <4 x double>, <4 x double>* %129, align 8, !alias.scope !74, !noalias !76
  %130 = fmul fast <4 x double> %wide.load1070, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %132 = icmp eq i64 %index.next1067, %n.vec1065
  br i1 %132, label %middle.block1057, label %vector.body1059, !llvm.loop !80

middle.block1057:                                 ; preds = %vector.body1059
  %cmp.n1069 = icmp eq i64 %125, %n.vec1065
  br i1 %cmp.n1069, label %polly.loop_exit366, label %polly.loop_header364.preheader

polly.loop_header364.preheader:                   ; preds = %polly.loop_header358, %middle.block1057
  %polly.indvar367.ph = phi i64 [ 0, %polly.loop_header358 ], [ %n.vec1065, %middle.block1057 ]
  br label %polly.loop_header364

polly.loop_exit366:                               ; preds = %polly.loop_header364, %middle.block1057
  %polly.indvar_next362 = add nuw nsw i64 %polly.indvar361, 1
  %exitcond889.not = icmp eq i64 %polly.indvar_next362, 1200
  %indvar.next1061 = add i64 %indvar1060, 1
  br i1 %exitcond889.not, label %polly.loop_header374.preheader, label %polly.loop_header358
...
polly.loop_header364:                             ; preds = %polly.loop_header364.preheader, %polly.loop_header364
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next368, %polly.indvar361
  br i1 %exitcond888.not, label %polly.loop_exit366, label %polly.loop_header364, !llvm.loop !81
...
polly.loop_exit382:                               ; preds = %polly.loop_header380
  ...
  %exitcond887.not = icmp eq i64 %polly.indvar_next378, 1000
  br i1 %exitcond887.not, label %polly.loop_header390, label %polly.loop_header374
...
polly.loop_header380:                             ; preds = %polly.loop_header380, %polly.loop_header374
  ...
  %exitcond886.not = icmp eq i64 %polly.indvar_next384, 1200
  br i1 %exitcond886.not, label %polly.loop_exit382, label %polly.loop_header380

polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv880 = phi i64 [ %indvars.iv.next881, %polly.loop_exit398 ], [ 27, %polly.loop_exit382 ]
  %indvars.iv878 = phi i64 [ %indvars.iv.next879, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  %indvars.iv866 = phi i64 [ %indvars.iv.next867, %polly.loop_exit398 ], [ 0, %polly.loop_exit382 ]
  ...
  %134 = udiv i64 %indvars.iv880, 25
  %135 = sub nsw i64 %indvars.iv878, %134
  %smin882 = call i64 @llvm.smin.i64(i64 %135, i64 21)
  %136 = mul nsw i64 %polly.indvar393, -96
  %137 = icmp slt i64 %136, -1104
  %138 = select i1 %137, i64 %136, i64 -1104
  %139 = add nsw i64 %138, 1199
  %140 = mul nuw nsw i64 %polly.indvar393, 96
  %141 = add nsw i64 %smin882, 2
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit405
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next862 = add nsw i64 %indvars.iv861, -96
  %indvars.iv.next867 = add nuw nsw i64 %indvars.iv866, 96
  %indvars.iv.next879 = add nuw nsw i64 %indvars.iv878, 2
  %indvars.iv.next881 = add nuw nsw i64 %indvars.iv880, 2
  %exitcond885.not = icmp eq i64 %polly.indvar_next394, 13
  br i1 %exitcond885.not, label %polly.exiting273, label %polly.loop_header390

polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header390
  %indvars.iv874 = phi i64 [ %indvars.iv.next875, %polly.loop_exit405 ], [ 0, %polly.loop_header390 ]
  %polly.indvar399 = phi i64 [ %polly.indvar_next400, %polly.loop_exit405 ], [ 0, %polly.loop_header390 ]
  %smin876 = call i64 @llvm.smin.i64(i64 %indvars.iv874, i64 -872)
  %142 = shl nsw i64 %polly.indvar399, 7
  %143 = add nsw i64 %smin876, 999
  br label %polly.loop_header403

polly.loop_exit405:                               ; preds = %polly.loop_exit412
  %polly.indvar_next400 = add nuw nsw i64 %polly.indvar399, 1
  %indvars.iv.next875 = add nsw i64 %indvars.iv874, -128
  %exitcond884.not = icmp eq i64 %polly.indvar_next400, 8
  br i1 %exitcond884.not, label %polly.loop_exit398, label %polly.loop_header396

polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  %indvars.iv868 = phi i64 [ %indvars.iv.next869, %polly.loop_exit412 ], [ %indvars.iv866, %polly.loop_header396 ]
  %indvars.iv863 = phi i64 [ %indvars.iv.next864, %polly.loop_exit412 ], [ %indvars.iv861, %polly.loop_header396 ]
  %polly.indvar406 = phi i64 [ %polly.indvar_next407, %polly.loop_exit412 ], [ 0, %polly.loop_header396 ]
  %144 = mul nuw nsw i64 %polly.indvar406, 50
  %145 = add nsw i64 %144, %136
  %146 = icmp sgt i64 %145, 0
  %147 = select i1 %146, i64 %145, i64 0
  %polly.loop_guard413.not = icmp sgt i64 %147, %139
...
polly.loop_header410.preheader:                   ; preds = %polly.loop_header403
  ...
  %148 = add i64 %smax865, %indvars.iv868
...
polly.loop_exit412:                               ; preds = %polly.loop_exit419, %polly.loop_header403
  ...
  %indvars.iv.next869 = add nsw i64 %indvars.iv868, -50
  %exitcond883.not = icmp eq i64 %polly.indvar406, %141
  br i1 %exitcond883.not, label %polly.loop_exit405, label %polly.loop_header403

polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  %indvars.iv870 = phi i64 [ %148, %polly.loop_header410.preheader ], [ %indvars.iv.next871, %polly.loop_exit419 ]
  %polly.indvar414 = phi i64 [ %147, %polly.loop_header410.preheader ], [ %polly.indvar_next415, %polly.loop_exit419 ]
  %smin872 = call i64 @llvm.smin.i64(i64 %indvars.iv870, i64 49)
  %150 = add nsw i64 %polly.indvar414, %149
  %polly.loop_guard427951 = icmp sgt i64 %150, -1
  %151 = add nuw nsw i64 %polly.indvar414, %140
  %152 = mul i64 %151, 8000
  %153 = mul i64 %151, 9600
  br i1 %polly.loop_guard427951, label %polly.loop_header417.us, label %polly.loop_exit419
...
polly.loop_header417.us:                          ; preds = %polly.loop_header410, %polly.loop_exit426.loopexit.us
  ...
  %154 = add nuw nsw i64 %polly.indvar420.us, %142
  %155 = shl i64 %154, 3
...
polly.loop_header424.us:                          ; preds = %polly.loop_header417.us, %polly.loop_header424.us
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar428.us, %smin872
  br i1 %exitcond873.not, label %polly.loop_exit426.loopexit.us, label %polly.loop_header424.us

polly.loop_exit426.loopexit.us:                   ; preds = %polly.loop_header424.us
  %polly.indvar_next421.us = add nuw nsw i64 %polly.indvar420.us, 1
  %exitcond877.not = icmp eq i64 %polly.indvar420.us, %143
  br i1 %exitcond877.not, label %polly.loop_exit419, label %polly.loop_header417.us
...
polly.loop_exit419:                               ; preds = %polly.loop_exit426.loopexit.us, %polly.loop_header410
  ...
  %polly.loop_cond416.not.not = icmp ult i64 %polly.indvar414, %139
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1036 = icmp ult i64 %162, 4
  br i1 %min.iters.check1036, label %polly.loop_header542.preheader, label %vector.ph1037

vector.ph1037:                                    ; preds = %polly.loop_header536
  %n.vec1039 = and i64 %162, -4
  br label %vector.body1035

vector.body1035:                                  ; preds = %vector.body1035, %vector.ph1037
  %index1040 = phi i64 [ 0, %vector.ph1037 ], [ %index.next1041, %vector.body1035 ]
  %164 = shl nuw nsw i64 %index1040, 3
  %165 = getelementptr i8, i8* %scevgep548, i64 %164
  %166 = bitcast i8* %165 to <4 x double>*
  %wide.load1044 = load <4 x double>, <4 x double>* %166, align 8, !alias.scope !84, !noalias !86
  %167 = fmul fast <4 x double> %wide.load1044, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %169 = icmp eq i64 %index.next1041, %n.vec1039
  br i1 %169, label %middle.block1033, label %vector.body1035, !llvm.loop !90

middle.block1033:                                 ; preds = %vector.body1035
  %cmp.n1043 = icmp eq i64 %162, %n.vec1039
  br i1 %cmp.n1043, label %polly.loop_exit544, label %polly.loop_header542.preheader

polly.loop_header542.preheader:                   ; preds = %polly.loop_header536, %middle.block1033
  %polly.indvar545.ph = phi i64 [ 0, %polly.loop_header536 ], [ %n.vec1039, %middle.block1033 ]
  br label %polly.loop_header542

polly.loop_exit544:                               ; preds = %polly.loop_header542, %middle.block1033
  %polly.indvar_next540 = add nuw nsw i64 %polly.indvar539, 1
  %exitcond918.not = icmp eq i64 %polly.indvar_next540, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond918.not, label %polly.loop_header552.preheader, label %polly.loop_header536
...
polly.loop_header542:                             ; preds = %polly.loop_header542.preheader, %polly.loop_header542
  ...
  %exitcond917.not = icmp eq i64 %polly.indvar_next546, %polly.indvar539
  br i1 %exitcond917.not, label %polly.loop_exit544, label %polly.loop_header542, !llvm.loop !91
...
polly.loop_exit560:                               ; preds = %polly.loop_header558
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar_next556, 1000
  br i1 %exitcond916.not, label %polly.loop_header568, label %polly.loop_header552
...
polly.loop_header558:                             ; preds = %polly.loop_header558, %polly.loop_header552
  ...
  %exitcond915.not = icmp eq i64 %polly.indvar_next562, 1200
  br i1 %exitcond915.not, label %polly.loop_exit560, label %polly.loop_header558

polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv909 = phi i64 [ %indvars.iv.next910, %polly.loop_exit576 ], [ 27, %polly.loop_exit560 ]
  %indvars.iv907 = phi i64 [ %indvars.iv.next908, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %indvars.iv895 = phi i64 [ %indvars.iv.next896, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %indvars.iv890 = phi i64 [ %indvars.iv.next891, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %polly.indvar571 = phi i64 [ %polly.indvar_next572, %polly.loop_exit576 ], [ 0, %polly.loop_exit560 ]
  %171 = udiv i64 %indvars.iv909, 25
  %172 = sub nsw i64 %indvars.iv907, %171
  %smin911 = call i64 @llvm.smin.i64(i64 %172, i64 21)
  %173 = mul nsw i64 %polly.indvar571, -96
  %174 = icmp slt i64 %173, -1104
  %175 = select i1 %174, i64 %173, i64 -1104
  %176 = add nsw i64 %175, 1199
  %177 = mul nuw nsw i64 %polly.indvar571, 96
  %178 = add nsw i64 %smin911, 2
  br label %polly.loop_header574

polly.loop_exit576:                               ; preds = %polly.loop_exit583
  %polly.indvar_next572 = add nuw nsw i64 %polly.indvar571, 1
  %indvars.iv.next891 = add nsw i64 %indvars.iv890, -96
  %indvars.iv.next896 = add nuw nsw i64 %indvars.iv895, 96
  %indvars.iv.next908 = add nuw nsw i64 %indvars.iv907, 2
  %indvars.iv.next910 = add nuw nsw i64 %indvars.iv909, 2
  %exitcond914.not = icmp eq i64 %polly.indvar_next572, 13
  br i1 %exitcond914.not, label %polly.exiting451, label %polly.loop_header568

polly.loop_header574:                             ; preds = %polly.loop_exit583, %polly.loop_header568
  %indvars.iv903 = phi i64 [ %indvars.iv.next904, %polly.loop_exit583 ], [ 0, %polly.loop_header568 ]
  %polly.indvar577 = phi i64 [ %polly.indvar_next578, %polly.loop_exit583 ], [ 0, %polly.loop_header568 ]
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 -872)
  %179 = shl nsw i64 %polly.indvar577, 7
  %180 = add nsw i64 %smin905, 999
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond913.not = icmp eq i64 %polly.indvar_next578, 8
  br i1 %exitcond913.not, label %polly.loop_exit576, label %polly.loop_header574

polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  %indvars.iv897 = phi i64 [ %indvars.iv.next898, %polly.loop_exit590 ], [ %indvars.iv895, %polly.loop_header574 ]
  %indvars.iv892 = phi i64 [ %indvars.iv.next893, %polly.loop_exit590 ], [ %indvars.iv890, %polly.loop_header574 ]
  %polly.indvar584 = phi i64 [ %polly.indvar_next585, %polly.loop_exit590 ], [ 0, %polly.loop_header574 ]
  %181 = mul nuw nsw i64 %polly.indvar584, 50
  %182 = add nsw i64 %181, %173
  %183 = icmp sgt i64 %182, 0
  %184 = select i1 %183, i64 %182, i64 0
  %polly.loop_guard591.not = icmp sgt i64 %184, %176
...
polly.loop_header588.preheader:                   ; preds = %polly.loop_header581
  %smax894 = call i64 @llvm.smax.i64(i64 %indvars.iv892, i64 0)
  %185 = add i64 %smax894, %indvars.iv897
...
polly.loop_exit590:                               ; preds = %polly.loop_exit597, %polly.loop_header581
  ...
  %indvars.iv.next893 = add nsw i64 %indvars.iv892, 50
  %indvars.iv.next898 = add nsw i64 %indvars.iv897, -50
  %exitcond912.not = icmp eq i64 %polly.indvar584, %178
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv899 = phi i64 [ %185, %polly.loop_header588.preheader ], [ %indvars.iv.next900, %polly.loop_exit597 ]
  %polly.indvar592 = phi i64 [ %184, %polly.loop_header588.preheader ], [ %polly.indvar_next593, %polly.loop_exit597 ]
  %smin901 = call i64 @llvm.smin.i64(i64 %indvars.iv899, i64 49)
  %187 = add nsw i64 %polly.indvar592, %186
  %polly.loop_guard605952 = icmp sgt i64 %187, -1
  %188 = add nuw nsw i64 %polly.indvar592, %177
  %189 = mul i64 %188, 8000
  %190 = mul i64 %188, 9600
  br i1 %polly.loop_guard605952, label %polly.loop_header595.us, label %polly.loop_exit597
...
polly.loop_header595.us:                          ; preds = %polly.loop_header588, %polly.loop_exit604.loopexit.us
  ...
  %191 = add nuw nsw i64 %polly.indvar598.us, %179
  %192 = shl i64 %191, 3
...
polly.loop_header602.us:                          ; preds = %polly.loop_header595.us, %polly.loop_header602.us
  ...
  %exitcond902.not = icmp eq i64 %polly.indvar606.us, %smin901
  br i1 %exitcond902.not, label %polly.loop_exit604.loopexit.us, label %polly.loop_header602.us

polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  %polly.indvar_next599.us = add nuw nsw i64 %polly.indvar598.us, 1
  %exitcond906.not = icmp eq i64 %polly.indvar598.us, %180
  br i1 %exitcond906.not, label %polly.loop_exit597, label %polly.loop_header595.us
...
polly.loop_exit597:                               ; preds = %polly.loop_exit604.loopexit.us, %polly.loop_header588
  ...
  %polly.loop_cond594.not.not = icmp ult i64 %polly.indvar592, %176
...
polly.loop_header752:                             ; preds = %entry, %polly.loop_exit760
  %indvars.iv943 = phi i64 [ %indvars.iv.next944, %polly.loop_exit760 ], [ 0, %entry ]
...
polly.loop_exit760:                               ; preds = %polly.loop_exit766
  ...
  %exitcond948.not = icmp eq i64 %polly.indvar_next756, 38
  br i1 %exitcond948.not, label %polly.loop_header779, label %polly.loop_header752

polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  %indvars.iv939 = phi i64 [ %indvars.iv.next940, %polly.loop_exit766 ], [ 0, %polly.loop_header752 ]
  %polly.indvar761 = phi i64 [ %polly.indvar_next762, %polly.loop_exit766 ], [ 0, %polly.loop_header752 ]
  %201 = mul nsw i64 %polly.indvar761, -32
  %smin974 = call i64 @llvm.smin.i64(i64 %201, i64 -1168)
  %202 = add nsw i64 %smin974, 1200
  %smin941 = call i64 @llvm.smin.i64(i64 %indvars.iv939, i64 -1168)
  %203 = shl nsw i64 %polly.indvar761, 5
  %204 = add nsw i64 %smin941, 1199
...
polly.loop_exit766:                               ; preds = %polly.loop_exit772
  ...
  %exitcond947.not = icmp eq i64 %polly.indvar_next762, 38
  br i1 %exitcond947.not, label %polly.loop_exit760, label %polly.loop_header758
...
polly.loop_header764:                             ; preds = %polly.loop_exit772, %polly.loop_header758
  ...
  br i1 %min.iters.check, label %polly.loop_header770, label %vector.ph975

vector.ph975:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert982 = insertelement <4 x i64> poison, i64 %203, i32 0
  %broadcast.splat983 = shufflevector <4 x i64> %broadcast.splatinsert982, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert984 = insertelement <4 x i32> poison, i32 %206, i32 0
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph975
  %index976 = phi i64 [ 0, %vector.ph975 ], [ %index.next977, %vector.body973 ]
  %vec.ind980 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph975 ], [ %vec.ind.next981, %vector.body973 ]
  %208 = add nuw nsw <4 x i64> %vec.ind980, %broadcast.splat983
  %209 = trunc <4 x i64> %208 to <4 x i32>
  %210 = mul <4 x i32> %broadcast.splat985, %209
  ...
  %220 = icmp eq i64 %index.next977, %202
  br i1 %220, label %polly.loop_exit772, label %vector.body973, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body973, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond946.not = icmp eq i64 %polly.indvar767, %200
  br i1 %exitcond946.not, label %polly.loop_exit766, label %polly.loop_header764
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond942.not = icmp eq i64 %polly.indvar773, %204
  br i1 %exitcond942.not, label %polly.loop_exit772, label %polly.loop_header770, !llvm.loop !100

polly.loop_header779:                             ; preds = %polly.loop_exit760, %polly.loop_exit787
  %indvars.iv933 = phi i64 [ %indvars.iv.next934, %polly.loop_exit787 ], [ 0, %polly.loop_exit760 ]
...
polly.loop_exit787:                               ; preds = %polly.loop_exit793
  ...
  %exitcond938.not = icmp eq i64 %polly.indvar_next783, 38
  br i1 %exitcond938.not, label %polly.loop_header805, label %polly.loop_header779

polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  %indvars.iv929 = phi i64 [ %indvars.iv.next930, %polly.loop_exit793 ], [ 0, %polly.loop_header779 ]
  %polly.indvar788 = phi i64 [ %polly.indvar_next789, %polly.loop_exit793 ], [ 0, %polly.loop_header779 ]
  %230 = mul nsw i64 %polly.indvar788, -32
  %smin989 = call i64 @llvm.smin.i64(i64 %230, i64 -968)
  %231 = add nsw i64 %smin989, 1000
  %smin931 = call i64 @llvm.smin.i64(i64 %indvars.iv929, i64 -968)
  %232 = shl nsw i64 %polly.indvar788, 5
  %233 = add nsw i64 %smin931, 999
  br label %polly.loop_header791

polly.loop_exit793:                               ; preds = %polly.loop_exit799
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %indvars.iv.next930 = add nsw i64 %indvars.iv929, -32
  %exitcond937.not = icmp eq i64 %polly.indvar_next789, 32
  br i1 %exitcond937.not, label %polly.loop_exit787, label %polly.loop_header785
...
polly.loop_header791:                             ; preds = %polly.loop_exit799, %polly.loop_header785
  ...
  %min.iters.check990 = icmp eq i64 %231, 0
  br i1 %min.iters.check990, label %polly.loop_header797, label %vector.ph991

vector.ph991:                                     ; preds = %polly.loop_header791
  %broadcast.splatinsert1000 = insertelement <4 x i64> poison, i64 %232, i32 0
  %broadcast.splat1001 = shufflevector <4 x i64> %broadcast.splatinsert1000, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1002 = insertelement <4 x i32> poison, i32 %235, i32 0
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  %237 = add nuw nsw <4 x i64> %vec.ind998, %broadcast.splat1001
  %238 = trunc <4 x i64> %237 to <4 x i32>
  %239 = mul <4 x i32> %broadcast.splat1003, %238
  ...
  %249 = icmp eq i64 %index.next995, %231
  br i1 %249, label %polly.loop_exit799, label %vector.body988, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body988, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond936.not = icmp eq i64 %polly.indvar794, %229
  br i1 %exitcond936.not, label %polly.loop_exit793, label %polly.loop_header791
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond932.not = icmp eq i64 %polly.indvar800, %233
  br i1 %exitcond932.not, label %polly.loop_exit799, label %polly.loop_header797, !llvm.loop !103

polly.loop_header805:                             ; preds = %polly.loop_exit787, %polly.loop_exit813
  %indvars.iv923 = phi i64 [ %indvars.iv.next924, %polly.loop_exit813 ], [ 0, %polly.loop_exit787 ]
  ...
  %258 = add nsw i64 %smin925, 1199
  br label %polly.loop_header811

polly.loop_exit813:                               ; preds = %polly.loop_exit819
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %indvars.iv.next924 = add nsw i64 %indvars.iv923, -32
  %exitcond928.not = icmp eq i64 %polly.indvar_next809, 38
  br i1 %exitcond928.not, label %init_array.exit, label %polly.loop_header805

polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  %indvars.iv919 = phi i64 [ %indvars.iv.next920, %polly.loop_exit819 ], [ 0, %polly.loop_header805 ]
  %polly.indvar814 = phi i64 [ %polly.indvar_next815, %polly.loop_exit819 ], [ 0, %polly.loop_header805 ]
  %259 = mul nsw i64 %polly.indvar814, -32
  %smin1007 = call i64 @llvm.smin.i64(i64 %259, i64 -968)
  %260 = add nsw i64 %smin1007, 1000
  %smin921 = call i64 @llvm.smin.i64(i64 %indvars.iv919, i64 -968)
  %261 = shl nsw i64 %polly.indvar814, 5
  %262 = add nsw i64 %smin921, 999
  br label %polly.loop_header817

polly.loop_exit819:                               ; preds = %polly.loop_exit825
  %polly.indvar_next815 = add nuw nsw i64 %polly.indvar814, 1
  %indvars.iv.next920 = add nsw i64 %indvars.iv919, -32
  %exitcond927.not = icmp eq i64 %polly.indvar_next815, 32
  br i1 %exitcond927.not, label %polly.loop_exit813, label %polly.loop_header811
...
polly.loop_header817:                             ; preds = %polly.loop_exit825, %polly.loop_header811
  ...
  %min.iters.check1008 = icmp eq i64 %260, 0
  br i1 %min.iters.check1008, label %polly.loop_header823, label %vector.ph1009

vector.ph1009:                                    ; preds = %polly.loop_header817
  %broadcast.splatinsert1018 = insertelement <4 x i64> poison, i64 %261, i32 0
  %broadcast.splat1019 = shufflevector <4 x i64> %broadcast.splatinsert1018, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1020 = insertelement <4 x i32> poison, i32 %264, i32 0
...
vector.body1006:                                  ; preds = %vector.body1006, %vector.ph1009
  ...
  %266 = add nuw nsw <4 x i64> %vec.ind1016, %broadcast.splat1019
  %267 = trunc <4 x i64> %266 to <4 x i32>
  %268 = mul <4 x i32> %broadcast.splat1021, %267
  ...
  %278 = icmp eq i64 %index.next1013, %260
  br i1 %278, label %polly.loop_exit825, label %vector.body1006, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body1006, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond926.not = icmp eq i64 %polly.indvar820, %258
  br i1 %exitcond926.not, label %polly.loop_exit819, label %polly.loop_header817
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond922.not = icmp eq i64 %polly.indvar826, %262
  br i1 %exitcond922.not, label %polly.loop_exit825, label %polly.loop_header823, !llvm.loop !106
}
