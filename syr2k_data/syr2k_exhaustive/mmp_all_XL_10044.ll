; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10044.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10044.c"
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233879 = icmp sgt i64 %118, -1
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph998
  ...
  %131 = shl nuw nsw i64 %index1001, 3
  %132 = getelementptr i8, i8* %scevgep350, i64 %131
  %133 = bitcast i8* %132 to <4 x double>*
  %wide.load1005 = load <4 x double>, <4 x double>* %133, align 8, !alias.scope !69, !noalias !71
  %134 = fmul fast <4 x double> %wide.load1005, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %136 = icmp eq i64 %index.next1002, %n.vec1000
  br i1 %136, label %middle.block992, label %vector.body994, !llvm.loop !74

middle.block992:                                  ; preds = %vector.body994
  %cmp.n1004 = icmp eq i64 %129, %n.vec1000
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %138 = udiv i64 %polly.indvar357, 5
  %139 = add nuw i64 %indvars.iv815, %138
  %umin817 = call i64 @llvm.umin.i64(i64 %139, i64 56)
  %140 = mul nsw i64 %polly.indvar357, -64
  %141 = icmp slt i64 %140, -1136
  %142 = select i1 %141, i64 %140, i64 -1136
  %143 = add nsw i64 %142, 1199
  %144 = shl nsw i64 %polly.indvar357, 6
  %145 = add nuw nsw i64 %umin817, 3
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %157 = add i64 %smax805, %indvars.iv808
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond818.not = icmp eq i64 %polly.indvar370, %145
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv810 = phi i64 [ %157, %polly.loop_header374.preheader ], [ %indvars.iv.next811, %polly.loop_exit383 ]
  ...
  %polly.loop_guard391880 = icmp sgt i64 %159, -1
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph972
  ...
  %172 = shl nuw nsw i64 %index975, 3
  %173 = getelementptr i8, i8* %scevgep508, i64 %172
  %174 = bitcast i8* %173 to <4 x double>*
  %wide.load979 = load <4 x double>, <4 x double>* %174, align 8, !alias.scope !78, !noalias !80
  %175 = fmul fast <4 x double> %wide.load979, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %177 = icmp eq i64 %index.next976, %n.vec974
  br i1 %177, label %middle.block968, label %vector.body970, !llvm.loop !83

middle.block968:                                  ; preds = %vector.body970
  %cmp.n978 = icmp eq i64 %170, %n.vec974
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %179 = udiv i64 %polly.indvar515, 5
  %180 = add nuw i64 %indvars.iv837, %179
  %umin839 = call i64 @llvm.umin.i64(i64 %180, i64 56)
  %181 = mul nsw i64 %polly.indvar515, -64
  %182 = icmp slt i64 %181, -1136
  %183 = select i1 %182, i64 %181, i64 -1136
  %184 = add nsw i64 %183, 1199
  %185 = shl nsw i64 %polly.indvar515, 6
  %186 = add nuw nsw i64 %umin839, 3
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %198 = add i64 %smax827, %indvars.iv830
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond840.not = icmp eq i64 %polly.indvar528, %186
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv832 = phi i64 [ %198, %polly.loop_header532.preheader ], [ %indvars.iv.next833, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549881 = icmp sgt i64 %200, -1
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin909 = call i64 @llvm.smin.i64(i64 %213, i64 -1168)
  %214 = add nsw i64 %smin909, 1200
  %smin867 = call i64 @llvm.smin.i64(i64 %indvars.iv865, i64 -1168)
  %215 = shl nsw i64 %polly.indvar703, 5
  %216 = add nsw i64 %smin867, 1199
...
vector.ph910:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert917 = insertelement <4 x i64> poison, i64 %215, i32 0
  %broadcast.splat918 = shufflevector <4 x i64> %broadcast.splatinsert917, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert919 = insertelement <4 x i32> poison, i32 %218, i32 0
...
vector.body908:                                   ; preds = %vector.body908, %vector.ph910
  ...
  %220 = add nuw nsw <4 x i64> %vec.ind915, %broadcast.splat918
  %221 = trunc <4 x i64> %220 to <4 x i32>
  %222 = mul <4 x i32> %broadcast.splat920, %221
  ...
  %232 = icmp eq i64 %index.next912, %214
  br i1 %232, label %polly.loop_exit714, label %vector.body908, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body908, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond872.not = icmp eq i64 %polly.indvar709, %212
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar715, %216
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin924 = call i64 @llvm.smin.i64(i64 %242, i64 -968)
  %243 = add nsw i64 %smin924, 1000
  %smin857 = call i64 @llvm.smin.i64(i64 %indvars.iv855, i64 -968)
  %244 = shl nsw i64 %polly.indvar730, 5
  %245 = add nsw i64 %smin857, 999
...
vector.body923:                                   ; preds = %vector.body923, %vector.ph926
  ...
  %249 = add nuw nsw <4 x i64> %vec.ind933, %broadcast.splat936
  %250 = trunc <4 x i64> %249 to <4 x i32>
  %251 = mul <4 x i32> %broadcast.splat938, %250
  ...
  %261 = icmp eq i64 %index.next930, %243
  br i1 %261, label %polly.loop_exit741, label %vector.body923, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body923, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond862.not = icmp eq i64 %polly.indvar736, %241
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar742, %245
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin942 = call i64 @llvm.smin.i64(i64 %271, i64 -968)
  %272 = add nsw i64 %smin942, 1000
  %smin847 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -968)
  %273 = shl nsw i64 %polly.indvar756, 5
  %274 = add nsw i64 %smin847, 999
...
vector.body941:                                   ; preds = %vector.body941, %vector.ph944
  ...
  %278 = add nuw nsw <4 x i64> %vec.ind951, %broadcast.splat954
  %279 = trunc <4 x i64> %278 to <4 x i32>
  %280 = mul <4 x i32> %broadcast.splat956, %279
  ...
  %290 = icmp eq i64 %index.next948, %272
  br i1 %290, label %polly.loop_exit767, label %vector.body941, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body941, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond852.not = icmp eq i64 %polly.indvar762, %270
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar768, %274
