; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2417.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2417.c"
...
for.cond1.preheader.i:                            ; preds = %entry, %for.inc17.i
  ...
  %scevgep1133 = getelementptr i8, i8* %call2, i64 %12
  %scevgep1132 = getelementptr i8, i8* %call2, i64 %11
  %scevgep1131 = getelementptr i8, i8* %call1, i64 %12
  %scevgep1130 = getelementptr i8, i8* %call1, i64 %11
  %bound0 = icmp ult i8* %scevgep1130, %scevgep1133
  %bound1 = icmp ult i8* %scevgep1132, %scevgep1131
...
for.inc17.i:                                      ; preds = %vector.body, %for.body3.i
  ...
  br i1 %exitcond18.not.i, label %vector.ph1137, label %for.cond1.preheader.i, !llvm.loop !15

vector.ph1137:                                    ; preds = %for.inc17.i, %for.inc41.i
  %indvars.iv7.i = phi i64 [ %indvars.iv.next8.i, %for.inc41.i ], [ 0, %for.inc17.i ]
  %broadcast.splatinsert1144 = insertelement <4 x i64> poison, i64 %indvars.iv7.i, i32 0
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1137
  ...
  %32 = mul nuw nsw <4 x i64> %vec.ind1142, %broadcast.splat1145
  %33 = trunc <4 x i64> %32 to <4 x i32>
  %34 = add <4 x i32> %33, <i32 3, i32 3, i32 3, i32 3>
  %35 = urem <4 x i32> %34, <i32 1200, i32 1200, i32 1200, i32 1200>
  %36 = sitofp <4 x i32> %35 to <4 x double>
  %37 = fmul fast <4 x double> %36, <double 1.000000e-03, double 1.000000e-03, double 1.000000e-03, double 1.000000e-03>
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call852, i64 %indvars.iv7.i, i64 %index1138
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next1139 = add i64 %index1138, 4
  %vec.ind.next1143 = add <4 x i64> %vec.ind1142, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next1139, 1200
  br i1 %40, label %for.inc41.i, label %vector.body1136, !llvm.loop !16

for.inc41.i:                                      ; preds = %vector.body1136
  %indvars.iv.next8.i = add nuw nsw i64 %indvars.iv7.i, 1
  %exitcond9.not.i = icmp eq i64 %indvars.iv.next8.i, 1200
  br i1 %exitcond9.not.i, label %init_array.exit, label %vector.ph1137, !llvm.loop !17
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1199, label %for.body3.i46.preheader1342, label %vector.ph1200
...
vector.body1198:                                  ; preds = %vector.body1198, %vector.ph1200
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call852, i64 %indvars.iv21.i, i64 %index1203
...
middle.block1196:                                 ; preds = %vector.body1198
  ...
  br i1 %cmp.n1206, label %for.inc6.i, label %for.body3.i46.preheader1342

for.body3.i46.preheader1342:                      ; preds = %for.body3.i46.preheader, %middle.block1196
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  ...
  br i1 %min.iters.check1244, label %for.body3.i60.preheader1340, label %vector.ph1245
...
vector.body1243:                                  ; preds = %vector.body1243, %vector.ph1245
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call852, i64 %indvars.iv21.i52, i64 %index1248
  ...
  br i1 %57, label %middle.block1241, label %vector.body1243, !llvm.loop !57

middle.block1241:                                 ; preds = %vector.body1243
  %cmp.n1251 = icmp eq i64 %indvars.iv21.i52, %n.vec1247
  br i1 %cmp.n1251, label %for.inc6.i63, label %for.body3.i60.preheader1340

for.body3.i60.preheader1340:                      ; preds = %for.body3.i60.preheader, %middle.block1241
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  ...
  br i1 %min.iters.check1292, label %for.body3.i99.preheader1338, label %vector.ph1293
...
vector.body1291:                                  ; preds = %vector.body1291, %vector.ph1293
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call852, i64 %indvars.iv21.i91, i64 %index1296
  ...
  br i1 %68, label %middle.block1289, label %vector.body1291, !llvm.loop !59

middle.block1289:                                 ; preds = %vector.body1291
  %cmp.n1299 = icmp eq i64 %indvars.iv21.i91, %n.vec1295
  br i1 %cmp.n1299, label %for.inc6.i102, label %for.body3.i99.preheader1338

for.body3.i99.preheader1338:                      ; preds = %for.body3.i99.preheader, %middle.block1289
...
polly.loop_header:                                ; preds = %polly.loop_exit194, %polly.start
  %indvar1304 = phi i64 [ %indvar.next1305, %polly.loop_exit194 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit194 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1304, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1306 = icmp ult i64 %88, 4
  br i1 %min.iters.check1306, label %polly.loop_header192.preheader, label %vector.ph1307
...
vector.body1303:                                  ; preds = %vector.body1303, %vector.ph1307
  ...
  %wide.load1314 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !65, !noalias !67
  ...
  br i1 %95, label %middle.block1301, label %vector.body1303, !llvm.loop !72

middle.block1301:                                 ; preds = %vector.body1303
  %cmp.n1313 = icmp eq i64 %88, %n.vec1309
  br i1 %cmp.n1313, label %polly.loop_exit194, label %polly.loop_header192.preheader

polly.loop_header192.preheader:                   ; preds = %polly.loop_header, %middle.block1301
  %polly.indvar195.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1309, %middle.block1301 ]
  br label %polly.loop_header192

polly.loop_exit194:                               ; preds = %polly.loop_header192, %middle.block1301
  %polly.indvar_next = add nuw nsw i64 %polly.indvar, 1
  %exitcond1034.not = icmp eq i64 %polly.indvar_next, 1200
  %indvar.next1305 = add i64 %indvar1304, 1
  br i1 %exitcond1034.not, label %polly.loop_header200.preheader, label %polly.loop_header
...
polly.loop_header192:                             ; preds = %polly.loop_header192.preheader, %polly.loop_header192
  ...
  %exitcond1033.not = icmp eq i64 %polly.indvar_next196, %polly.indvar
  br i1 %exitcond1033.not, label %polly.loop_exit194, label %polly.loop_header192, !llvm.loop !73
...
polly.loop_exit208:                               ; preds = %polly.loop_header206
  ...
  %exitcond1032.not = icmp eq i64 %polly.indvar_next204, 1000
  br i1 %exitcond1032.not, label %polly.loop_header216, label %polly.loop_header200
...
polly.loop_header206:                             ; preds = %polly.loop_header206, %polly.loop_header200
  ...
  %exitcond1031.not = icmp eq i64 %polly.indvar_next210, 1200
  br i1 %exitcond1031.not, label %polly.loop_exit208, label %polly.loop_header206
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %exitcond1030.not = icmp eq i64 %polly.indvar_next220, 13
  br i1 %exitcond1030.not, label %polly.exiting, label %polly.loop_header216
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %105 = add i64 %97, %104
  %smax1318 = call i64 @llvm.smax.i64(i64 %105, i64 0)
  %106 = mul nsw i64 %polly.indvar225, -100
  %107 = add i64 %98, %106
  %108 = add i64 %smax1318, %107
  %109 = mul nuw nsw i64 %polly.indvar225, 100
...
polly.loop_exit230:                               ; preds = %polly.loop_exit261, %polly.loop_header222
  ...
  %indvars.iv.next1021 = add nsw i64 %indvars.iv1020, -100
  %exitcond1029.not = icmp eq i64 %polly.indvar225, %umin
  br i1 %exitcond1029.not, label %polly.loop_exit224, label %polly.loop_header222

polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  %indvar1319 = phi i64 [ 0, %polly.loop_header228.preheader ], [ %indvar.next1320, %polly.loop_exit261 ]
  ...
  %116 = add i64 %108, %indvar1319
  %smin1321 = call i64 @llvm.smin.i64(i64 %116, i64 99)
  %117 = add nsw i64 %smin1321, 1
  %smin1026 = call i64 @llvm.smin.i64(i64 %indvars.iv1022, i64 99)
  %118 = add nsw i64 %polly.indvar231, %114
  %polly.loop_guard2441119 = icmp sgt i64 %118, -1
  %119 = add nuw nsw i64 %polly.indvar231, %103
  %.not = icmp ult i64 %119, %115
  %polly.access.mul.call1253 = mul nsw i64 %119, 1000
  br i1 %polly.loop_guard2441119, label %polly.loop_header234.us, label %polly.loop_header228.split
...
polly.loop_header259.preheader:                   ; preds = %polly.loop_header234, %polly.merge.us
  ...
  br i1 %polly.loop_guard2441119, label %polly.loop_header259.us, label %polly.loop_exit261
...
polly.loop_header259.us:                          ; preds = %polly.loop_header259.preheader, %polly.loop_exit268.loopexit.us
  ...
  %min.iters.check1322 = icmp ult i64 %117, 4
  br i1 %min.iters.check1322, label %polly.loop_header266.us.preheader, label %vector.ph1323

vector.ph1323:                                    ; preds = %polly.loop_header259.us
  %n.vec1325 = and i64 %117, -4
  %broadcast.splatinsert1331 = insertelement <4 x double> poison, double %_p_scalar_280.us, i32 0
  %broadcast.splat1332 = shufflevector <4 x double> %broadcast.splatinsert1331, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1334 = insertelement <4 x double> poison, double %_p_scalar_288.us, i32 0
...
vector.body1317:                                  ; preds = %vector.body1317, %vector.ph1323
  %index1326 = phi i64 [ 0, %vector.ph1323 ], [ %index.next1327, %vector.body1317 ]
  %122 = add nuw nsw i64 %index1326, %109
  %123 = add nuw nsw i64 %index1326, %polly.access.mul.Packed_MemRef_call1273.us
  %124 = getelementptr double, double* %Packed_MemRef_call1, i64 %123
  %125 = bitcast double* %124 to <4 x double>*
  %wide.load1330 = load <4 x double>, <4 x double>* %125, align 8
  %126 = fmul fast <4 x double> %broadcast.splat1332, %wide.load1330
  ...
  %wide.load1333 = load <4 x double>, <4 x double>* %129, align 8
  %130 = fmul fast <4 x double> %broadcast.splat1335, %wide.load1333
  %131 = shl i64 %122, 3
  %132 = add i64 %131, %121
  %133 = getelementptr i8, i8* %call, i64 %132
  %134 = bitcast i8* %133 to <4 x double>*
  %wide.load1336 = load <4 x double>, <4 x double>* %134, align 8, !alias.scope !65, !noalias !67
  ...
  %137 = fadd fast <4 x double> %136, %wide.load1336
  ...
  %139 = icmp eq i64 %index.next1327, %n.vec1325
  br i1 %139, label %middle.block1315, label %vector.body1317, !llvm.loop !77

middle.block1315:                                 ; preds = %vector.body1317
  %cmp.n1329 = icmp eq i64 %117, %n.vec1325
  br i1 %cmp.n1329, label %polly.loop_exit268.loopexit.us, label %polly.loop_header266.us.preheader

polly.loop_header266.us.preheader:                ; preds = %polly.loop_header259.us, %middle.block1315
  %polly.indvar270.us.ph = phi i64 [ 0, %polly.loop_header259.us ], [ %n.vec1325, %middle.block1315 ]
...
polly.loop_exit268.loopexit.us:                   ; preds = %polly.loop_header266.us, %middle.block1315
...
polly.loop_header382:                             ; preds = %polly.loop_exit390, %polly.start294
  %indvar1256 = phi i64 [ %indvar.next1257, %polly.loop_exit390 ], [ 0, %polly.start294 ]
  %polly.indvar385 = phi i64 [ %polly.indvar_next386, %polly.loop_exit390 ], [ 1, %polly.start294 ]
  %143 = add i64 %indvar1256, 1
  %144 = mul nuw nsw i64 %polly.indvar385, 9600
  %scevgep394 = getelementptr i8, i8* %call, i64 %144
  %min.iters.check1258 = icmp ult i64 %143, 4
  br i1 %min.iters.check1258, label %polly.loop_header388.preheader, label %vector.ph1259

vector.ph1259:                                    ; preds = %polly.loop_header382
  %n.vec1261 = and i64 %143, -4
...
vector.body1255:                                  ; preds = %vector.body1255, %vector.ph1259
  ...
  %145 = shl nuw nsw i64 %index1262, 3
  %146 = getelementptr i8, i8* %scevgep394, i64 %145
  %147 = bitcast i8* %146 to <4 x double>*
  %wide.load1266 = load <4 x double>, <4 x double>* %147, align 8, !alias.scope !79, !noalias !81
  %148 = fmul fast <4 x double> %wide.load1266, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %150 = icmp eq i64 %index.next1263, %n.vec1261
  br i1 %150, label %middle.block1253, label %vector.body1255, !llvm.loop !86

middle.block1253:                                 ; preds = %vector.body1255
  %cmp.n1265 = icmp eq i64 %143, %n.vec1261
  br i1 %cmp.n1265, label %polly.loop_exit390, label %polly.loop_header388.preheader

polly.loop_header388.preheader:                   ; preds = %polly.loop_header382, %middle.block1253
  %polly.indvar391.ph = phi i64 [ 0, %polly.loop_header382 ], [ %n.vec1261, %middle.block1253 ]
  br label %polly.loop_header388

polly.loop_exit390:                               ; preds = %polly.loop_header388, %middle.block1253
  %polly.indvar_next386 = add nuw nsw i64 %polly.indvar385, 1
  %exitcond1059.not = icmp eq i64 %polly.indvar_next386, 1200
  %indvar.next1257 = add i64 %indvar1256, 1
  br i1 %exitcond1059.not, label %polly.loop_header398.preheader, label %polly.loop_header382
...
polly.loop_header388:                             ; preds = %polly.loop_header388.preheader, %polly.loop_header388
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next392, %polly.indvar385
  br i1 %exitcond1058.not, label %polly.loop_exit390, label %polly.loop_header388, !llvm.loop !87
...
polly.loop_exit406:                               ; preds = %polly.loop_header404
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next402, 1000
  br i1 %exitcond1057.not, label %polly.loop_header414, label %polly.loop_header398
...
polly.loop_header404:                             ; preds = %polly.loop_header404, %polly.loop_header398
  ...
  %exitcond1056.not = icmp eq i64 %polly.indvar_next408, 1200
  br i1 %exitcond1056.not, label %polly.loop_exit406, label %polly.loop_header404

polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  %indvars.iv1041 = phi i64 [ %indvars.iv.next1042, %polly.loop_exit422 ], [ 0, %polly.loop_exit406 ]
  %indvars.iv1036 = phi i64 [ %indvars.iv.next1037, %polly.loop_exit422 ], [ 0, %polly.loop_exit406 ]
  %polly.indvar417 = phi i64 [ %polly.indvar_next418, %polly.loop_exit422 ], [ 0, %polly.loop_exit406 ]
  %152 = mul nsw i64 %polly.indvar417, -96
  %153 = mul nuw nsw i64 %polly.indvar417, 96
  %umin1053 = call i64 @llvm.umin.i64(i64 %polly.indvar417, i64 11)
  %154 = mul nsw i64 %polly.indvar417, -96
  %155 = icmp slt i64 %154, -1104
  %156 = select i1 %155, i64 %154, i64 -1104
  %157 = add nsw i64 %156, 1199
  %158 = mul nuw nsw i64 %polly.indvar417, 96
  br label %polly.loop_header420

polly.loop_exit422:                               ; preds = %polly.loop_exit429
  %polly.indvar_next418 = add nuw nsw i64 %polly.indvar417, 1
  %indvars.iv.next1037 = add nsw i64 %indvars.iv1036, -96
  %indvars.iv.next1042 = add nuw nsw i64 %indvars.iv1041, 96
  %exitcond1055.not = icmp eq i64 %polly.indvar_next418, 13
  br i1 %exitcond1055.not, label %polly.exiting295, label %polly.loop_header414

polly.loop_header420:                             ; preds = %polly.loop_exit429, %polly.loop_header414
  %indvars.iv1043 = phi i64 [ %indvars.iv.next1044, %polly.loop_exit429 ], [ %indvars.iv1041, %polly.loop_header414 ]
  %indvars.iv1038 = phi i64 [ %indvars.iv.next1039, %polly.loop_exit429 ], [ %indvars.iv1036, %polly.loop_header414 ]
  %polly.indvar423 = phi i64 [ %polly.indvar_next424, %polly.loop_exit429 ], [ 0, %polly.loop_header414 ]
  %159 = mul nuw nsw i64 %polly.indvar423, 100
  %160 = add i64 %152, %159
  %smax1270 = call i64 @llvm.smax.i64(i64 %160, i64 0)
  %161 = mul nsw i64 %polly.indvar423, -100
  %162 = add i64 %153, %161
  %163 = add i64 %smax1270, %162
  %164 = mul nuw nsw i64 %polly.indvar423, 100
...
polly.loop_header427.preheader:                   ; preds = %polly.loop_header420
  ...
  %168 = add i64 %smax1040, %indvars.iv1043
  %169 = sub nsw i64 %158, %164
  %170 = add nuw nsw i64 %164, 100
...
polly.loop_exit429:                               ; preds = %polly.loop_exit465, %polly.loop_header420
  ...
  %indvars.iv.next1044 = add nsw i64 %indvars.iv1043, -100
  %exitcond1054.not = icmp eq i64 %polly.indvar423, %umin1053
  br i1 %exitcond1054.not, label %polly.loop_exit422, label %polly.loop_header420

polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  %indvar1271 = phi i64 [ 0, %polly.loop_header427.preheader ], [ %indvar.next1272, %polly.loop_exit465 ]
  %indvars.iv1045 = phi i64 [ %168, %polly.loop_header427.preheader ], [ %indvars.iv.next1046, %polly.loop_exit465 ]
  %polly.indvar431 = phi i64 [ %167, %polly.loop_header427.preheader ], [ %polly.indvar_next432, %polly.loop_exit465 ]
  %171 = add i64 %163, %indvar1271
  %smin1273 = call i64 @llvm.smin.i64(i64 %171, i64 99)
  %172 = add nsw i64 %smin1273, 1
  %smin1050 = call i64 @llvm.smin.i64(i64 %indvars.iv1045, i64 99)
  %173 = add nsw i64 %polly.indvar431, %169
  %polly.loop_guard4441120 = icmp sgt i64 %173, -1
  %174 = add nuw nsw i64 %polly.indvar431, %158
  %.not906 = icmp ult i64 %174, %170
  %polly.access.mul.call1457 = mul nsw i64 %174, 1000
  br i1 %polly.loop_guard4441120, label %polly.loop_header434.us, label %polly.loop_header427.split
...
polly.loop_header441.us:                          ; preds = %polly.loop_header434.us, %polly.loop_header441.us
  ...
  %exitcond1048.not = icmp eq i64 %polly.indvar445.us, %smin1050
  br i1 %exitcond1048.not, label %polly.cond452.loopexit.us, label %polly.loop_header441.us
...
polly.merge453.us:                                ; preds = %polly.then454.us, %polly.cond452.loopexit.us
  ...
  %exitcond1049.not = icmp eq i64 %polly.indvar_next438.us, 1000
  br i1 %exitcond1049.not, label %polly.loop_header463.preheader, label %polly.loop_header434.us
...
polly.loop_header434:                             ; preds = %polly.loop_header427.split, %polly.loop_header434
  ...
  %exitcond1035.not = icmp eq i64 %polly.indvar_next438, 1000
  br i1 %exitcond1035.not, label %polly.loop_header463.preheader, label %polly.loop_header434

polly.loop_header463.preheader:                   ; preds = %polly.loop_header434, %polly.merge453.us
  %176 = mul i64 %174, 9600
  br i1 %polly.loop_guard4441120, label %polly.loop_header463.us, label %polly.loop_exit465
...
polly.loop_header463.us:                          ; preds = %polly.loop_header463.preheader, %polly.loop_exit472.loopexit.us
  ...
  %min.iters.check1274 = icmp ult i64 %172, 4
  br i1 %min.iters.check1274, label %polly.loop_header470.us.preheader, label %vector.ph1275

vector.ph1275:                                    ; preds = %polly.loop_header463.us
  %n.vec1277 = and i64 %172, -4
  %broadcast.splatinsert1283 = insertelement <4 x double> poison, double %_p_scalar_484.us, i32 0
  %broadcast.splat1284 = shufflevector <4 x double> %broadcast.splatinsert1283, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1286 = insertelement <4 x double> poison, double %_p_scalar_492.us, i32 0
...
vector.body1269:                                  ; preds = %vector.body1269, %vector.ph1275
  %index1278 = phi i64 [ 0, %vector.ph1275 ], [ %index.next1279, %vector.body1269 ]
  %177 = add nuw nsw i64 %index1278, %164
  %178 = add nuw nsw i64 %index1278, %polly.access.mul.Packed_MemRef_call1297477.us
  %179 = getelementptr double, double* %Packed_MemRef_call1297, i64 %178
  %180 = bitcast double* %179 to <4 x double>*
  %wide.load1282 = load <4 x double>, <4 x double>* %180, align 8
  %181 = fmul fast <4 x double> %broadcast.splat1284, %wide.load1282
  ...
  %wide.load1285 = load <4 x double>, <4 x double>* %184, align 8
  %185 = fmul fast <4 x double> %broadcast.splat1287, %wide.load1285
  %186 = shl i64 %177, 3
  %187 = add i64 %186, %176
  %188 = getelementptr i8, i8* %call, i64 %187
  %189 = bitcast i8* %188 to <4 x double>*
  %wide.load1288 = load <4 x double>, <4 x double>* %189, align 8, !alias.scope !79, !noalias !81
  ...
  %192 = fadd fast <4 x double> %191, %wide.load1288
  ...
  %194 = icmp eq i64 %index.next1279, %n.vec1277
  br i1 %194, label %middle.block1267, label %vector.body1269, !llvm.loop !90

middle.block1267:                                 ; preds = %vector.body1269
  %cmp.n1281 = icmp eq i64 %172, %n.vec1277
  br i1 %cmp.n1281, label %polly.loop_exit472.loopexit.us, label %polly.loop_header470.us.preheader

polly.loop_header470.us.preheader:                ; preds = %polly.loop_header463.us, %middle.block1267
  %polly.indvar474.us.ph = phi i64 [ 0, %polly.loop_header463.us ], [ %n.vec1277, %middle.block1267 ]
...
polly.loop_header470.us:                          ; preds = %polly.loop_header470.us.preheader, %polly.loop_header470.us
  ...
  %exitcond1051.not = icmp eq i64 %polly.indvar474.us, %smin1050
  br i1 %exitcond1051.not, label %polly.loop_exit472.loopexit.us, label %polly.loop_header470.us, !llvm.loop !91

polly.loop_exit472.loopexit.us:                   ; preds = %polly.loop_header470.us, %middle.block1267
  %polly.indvar_next467.us = add nuw nsw i64 %polly.indvar466.us, 1
  %exitcond1052.not = icmp eq i64 %polly.indvar_next467.us, 1000
  br i1 %exitcond1052.not, label %polly.loop_exit465, label %polly.loop_header463.us
...
polly.loop_header586:                             ; preds = %polly.loop_exit594, %polly.start498
  ...
  %min.iters.check1210 = icmp ult i64 %198, 4
  br i1 %min.iters.check1210, label %polly.loop_header592.preheader, label %vector.ph1211

vector.ph1211:                                    ; preds = %polly.loop_header586
  %n.vec1213 = and i64 %198, -4
...
vector.body1209:                                  ; preds = %vector.body1209, %vector.ph1211
  ...
  %200 = shl nuw nsw i64 %index1214, 3
  %201 = getelementptr i8, i8* %scevgep598, i64 %200
  %202 = bitcast i8* %201 to <4 x double>*
  %wide.load1218 = load <4 x double>, <4 x double>* %202, align 8, !alias.scope !92, !noalias !94
  %203 = fmul fast <4 x double> %wide.load1218, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %205 = icmp eq i64 %index.next1215, %n.vec1213
  br i1 %205, label %middle.block1207, label %vector.body1209, !llvm.loop !99

middle.block1207:                                 ; preds = %vector.body1209
  %cmp.n1217 = icmp eq i64 %198, %n.vec1213
  br i1 %cmp.n1217, label %polly.loop_exit594, label %polly.loop_header592.preheader

polly.loop_header592.preheader:                   ; preds = %polly.loop_header586, %middle.block1207
  %polly.indvar595.ph = phi i64 [ 0, %polly.loop_header586 ], [ %n.vec1213, %middle.block1207 ]
  br label %polly.loop_header592

polly.loop_exit594:                               ; preds = %polly.loop_header592, %middle.block1207
  %polly.indvar_next590 = add nuw nsw i64 %polly.indvar589, 1
  %exitcond1084.not = icmp eq i64 %polly.indvar_next590, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond1084.not, label %polly.loop_header602.preheader, label %polly.loop_header586
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_header592
  ...
  %exitcond1083.not = icmp eq i64 %polly.indvar_next596, %polly.indvar589
  br i1 %exitcond1083.not, label %polly.loop_exit594, label %polly.loop_header592, !llvm.loop !100
...
polly.loop_exit610:                               ; preds = %polly.loop_header608
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar_next606, 1000
  br i1 %exitcond1082.not, label %polly.loop_header618, label %polly.loop_header602
...
polly.loop_header608:                             ; preds = %polly.loop_header608, %polly.loop_header602
  ...
  %exitcond1081.not = icmp eq i64 %polly.indvar_next612, 1200
  br i1 %exitcond1081.not, label %polly.loop_exit610, label %polly.loop_header608

polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  %indvars.iv1066 = phi i64 [ %indvars.iv.next1067, %polly.loop_exit626 ], [ 0, %polly.loop_exit610 ]
  %indvars.iv1061 = phi i64 [ %indvars.iv.next1062, %polly.loop_exit626 ], [ 0, %polly.loop_exit610 ]
  %polly.indvar621 = phi i64 [ %polly.indvar_next622, %polly.loop_exit626 ], [ 0, %polly.loop_exit610 ]
  %207 = mul nsw i64 %polly.indvar621, -96
  %208 = mul nuw nsw i64 %polly.indvar621, 96
  %umin1078 = call i64 @llvm.umin.i64(i64 %polly.indvar621, i64 11)
  %209 = mul nsw i64 %polly.indvar621, -96
  %210 = icmp slt i64 %209, -1104
  %211 = select i1 %210, i64 %209, i64 -1104
  %212 = add nsw i64 %211, 1199
  %213 = mul nuw nsw i64 %polly.indvar621, 96
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633
  ...
  %indvars.iv.next1062 = add nsw i64 %indvars.iv1061, -96
  %indvars.iv.next1067 = add nuw nsw i64 %indvars.iv1066, 96
  %exitcond1080.not = icmp eq i64 %polly.indvar_next622, 13
  br i1 %exitcond1080.not, label %polly.exiting499, label %polly.loop_header618

polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  %indvars.iv1068 = phi i64 [ %indvars.iv.next1069, %polly.loop_exit633 ], [ %indvars.iv1066, %polly.loop_header618 ]
  %indvars.iv1063 = phi i64 [ %indvars.iv.next1064, %polly.loop_exit633 ], [ %indvars.iv1061, %polly.loop_header618 ]
  %polly.indvar627 = phi i64 [ %polly.indvar_next628, %polly.loop_exit633 ], [ 0, %polly.loop_header618 ]
  %214 = mul nuw nsw i64 %polly.indvar627, 100
  %215 = add i64 %207, %214
  %smax1222 = call i64 @llvm.smax.i64(i64 %215, i64 0)
  %216 = mul nsw i64 %polly.indvar627, -100
  %217 = add i64 %208, %216
  %218 = add i64 %smax1222, %217
  %219 = mul nuw nsw i64 %polly.indvar627, 100
...
polly.loop_header631.preheader:                   ; preds = %polly.loop_header624
  ...
  %223 = add i64 %smax1065, %indvars.iv1068
  %224 = sub nsw i64 %213, %219
  %225 = add nuw nsw i64 %219, 100
...
polly.loop_exit633:                               ; preds = %polly.loop_exit669, %polly.loop_header624
  ...
  %exitcond1079.not = icmp eq i64 %polly.indvar627, %umin1078
  br i1 %exitcond1079.not, label %polly.loop_exit626, label %polly.loop_header624

polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  %indvar1223 = phi i64 [ 0, %polly.loop_header631.preheader ], [ %indvar.next1224, %polly.loop_exit669 ]
  %indvars.iv1070 = phi i64 [ %223, %polly.loop_header631.preheader ], [ %indvars.iv.next1071, %polly.loop_exit669 ]
  %polly.indvar635 = phi i64 [ %222, %polly.loop_header631.preheader ], [ %polly.indvar_next636, %polly.loop_exit669 ]
  %226 = add i64 %218, %indvar1223
  %smin1225 = call i64 @llvm.smin.i64(i64 %226, i64 99)
  %227 = add nsw i64 %smin1225, 1
  %smin1075 = call i64 @llvm.smin.i64(i64 %indvars.iv1070, i64 99)
  %228 = add nsw i64 %polly.indvar635, %224
  %polly.loop_guard6481121 = icmp sgt i64 %228, -1
  %229 = add nuw nsw i64 %polly.indvar635, %213
  %.not907 = icmp ult i64 %229, %225
  %polly.access.mul.call1661 = mul nsw i64 %229, 1000
  br i1 %polly.loop_guard6481121, label %polly.loop_header638.us, label %polly.loop_header631.split
...
polly.loop_header645.us:                          ; preds = %polly.loop_header638.us, %polly.loop_header645.us
  ...
  %exitcond1073.not = icmp eq i64 %polly.indvar649.us, %smin1075
  br i1 %exitcond1073.not, label %polly.cond656.loopexit.us, label %polly.loop_header645.us
...
polly.merge657.us:                                ; preds = %polly.then658.us, %polly.cond656.loopexit.us
  ...
  %exitcond1074.not = icmp eq i64 %polly.indvar_next642.us, 1000
  br i1 %exitcond1074.not, label %polly.loop_header667.preheader, label %polly.loop_header638.us
...
polly.loop_header638:                             ; preds = %polly.loop_header631.split, %polly.loop_header638
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next642, 1000
  br i1 %exitcond1060.not, label %polly.loop_header667.preheader, label %polly.loop_header638

polly.loop_header667.preheader:                   ; preds = %polly.loop_header638, %polly.merge657.us
  %231 = mul i64 %229, 9600
  br i1 %polly.loop_guard6481121, label %polly.loop_header667.us, label %polly.loop_exit669
...
polly.loop_header667.us:                          ; preds = %polly.loop_header667.preheader, %polly.loop_exit676.loopexit.us
  ...
  %min.iters.check1226 = icmp ult i64 %227, 4
  br i1 %min.iters.check1226, label %polly.loop_header674.us.preheader, label %vector.ph1227

vector.ph1227:                                    ; preds = %polly.loop_header667.us
  %n.vec1229 = and i64 %227, -4
  %broadcast.splatinsert1235 = insertelement <4 x double> poison, double %_p_scalar_688.us, i32 0
  %broadcast.splat1236 = shufflevector <4 x double> %broadcast.splatinsert1235, <4 x double> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1238 = insertelement <4 x double> poison, double %_p_scalar_696.us, i32 0
...
vector.body1221:                                  ; preds = %vector.body1221, %vector.ph1227
  %index1230 = phi i64 [ 0, %vector.ph1227 ], [ %index.next1231, %vector.body1221 ]
  %232 = add nuw nsw i64 %index1230, %219
  %233 = add nuw nsw i64 %index1230, %polly.access.mul.Packed_MemRef_call1501681.us
  %234 = getelementptr double, double* %Packed_MemRef_call1501, i64 %233
  %235 = bitcast double* %234 to <4 x double>*
  %wide.load1234 = load <4 x double>, <4 x double>* %235, align 8
  %236 = fmul fast <4 x double> %broadcast.splat1236, %wide.load1234
  ...
  %wide.load1237 = load <4 x double>, <4 x double>* %239, align 8
  %240 = fmul fast <4 x double> %broadcast.splat1239, %wide.load1237
  %241 = shl i64 %232, 3
  %242 = add i64 %241, %231
  %243 = getelementptr i8, i8* %call, i64 %242
  %244 = bitcast i8* %243 to <4 x double>*
  %wide.load1240 = load <4 x double>, <4 x double>* %244, align 8, !alias.scope !92, !noalias !94
  ...
  %247 = fadd fast <4 x double> %246, %wide.load1240
  ...
  %249 = icmp eq i64 %index.next1231, %n.vec1229
  br i1 %249, label %middle.block1219, label %vector.body1221, !llvm.loop !103

middle.block1219:                                 ; preds = %vector.body1221
  %cmp.n1233 = icmp eq i64 %227, %n.vec1229
  br i1 %cmp.n1233, label %polly.loop_exit676.loopexit.us, label %polly.loop_header674.us.preheader

polly.loop_header674.us.preheader:                ; preds = %polly.loop_header667.us, %middle.block1219
  %polly.indvar678.us.ph = phi i64 [ 0, %polly.loop_header667.us ], [ %n.vec1229, %middle.block1219 ]
...
polly.loop_header674.us:                          ; preds = %polly.loop_header674.us.preheader, %polly.loop_header674.us
  ...
  %exitcond1076.not = icmp eq i64 %polly.indvar678.us, %smin1075
  br i1 %exitcond1076.not, label %polly.loop_exit676.loopexit.us, label %polly.loop_header674.us, !llvm.loop !104

polly.loop_exit676.loopexit.us:                   ; preds = %polly.loop_header674.us, %middle.block1219
  %polly.indvar_next671.us = add nuw nsw i64 %polly.indvar670.us, 1
  %exitcond1077.not = icmp eq i64 %polly.indvar_next671.us, 1000
  br i1 %exitcond1077.not, label %polly.loop_exit669, label %polly.loop_header667.us

polly.loop_header826:                             ; preds = %entry, %polly.loop_exit834
  %indvars.iv1109 = phi i64 [ %indvars.iv.next1110, %polly.loop_exit834 ], [ 0, %entry ]
...
polly.loop_exit834:                               ; preds = %polly.loop_exit840
  ...
  %exitcond1114.not = icmp eq i64 %polly.indvar_next830, 38
  br i1 %exitcond1114.not, label %polly.loop_header853, label %polly.loop_header826

polly.loop_header832:                             ; preds = %polly.loop_exit840, %polly.loop_header826
  %indvars.iv1105 = phi i64 [ %indvars.iv.next1106, %polly.loop_exit840 ], [ 0, %polly.loop_header826 ]
...
polly.loop_exit840:                               ; preds = %polly.loop_exit846
  ...
  %exitcond1113.not = icmp eq i64 %polly.indvar_next836, 38
  br i1 %exitcond1113.not, label %polly.loop_exit834, label %polly.loop_header832
...
polly.loop_header838:                             ; preds = %polly.loop_exit846, %polly.loop_header832
  ...
  br i1 %min.iters.check, label %polly.loop_header844, label %vector.ph1149

vector.ph1149:                                    ; preds = %polly.loop_header838
  %broadcast.splatinsert1156 = insertelement <4 x i64> poison, i64 %257, i32 0
  %broadcast.splat1157 = shufflevector <4 x i64> %broadcast.splatinsert1156, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1158 = insertelement <4 x i32> poison, i32 %260, i32 0
...
vector.body1148:                                  ; preds = %vector.body1148, %vector.ph1149
  ...
  %262 = add nuw nsw <4 x i64> %vec.ind1154, %broadcast.splat1157
  %263 = trunc <4 x i64> %262 to <4 x i32>
  %264 = mul <4 x i32> %broadcast.splat1159, %263
  ...
  %274 = icmp eq i64 %index.next1151, %256
  br i1 %274, label %polly.loop_exit846, label %vector.body1148, !llvm.loop !110

polly.loop_exit846:                               ; preds = %vector.body1148, %polly.loop_header844
  %polly.indvar_next842 = add nuw nsw i64 %polly.indvar841, 1
  %exitcond1112.not = icmp eq i64 %polly.indvar841, %254
  br i1 %exitcond1112.not, label %polly.loop_exit840, label %polly.loop_header838
...
polly.loop_header844:                             ; preds = %polly.loop_header838, %polly.loop_header844
  ...
  %exitcond1108.not = icmp eq i64 %polly.indvar847, %258
  br i1 %exitcond1108.not, label %polly.loop_exit846, label %polly.loop_header844, !llvm.loop !111

polly.loop_header853:                             ; preds = %polly.loop_exit834, %polly.loop_exit861
  %indvars.iv1099 = phi i64 [ %indvars.iv.next1100, %polly.loop_exit861 ], [ 0, %polly.loop_exit834 ]
...
polly.loop_exit861:                               ; preds = %polly.loop_exit867
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar_next857, 38
  br i1 %exitcond1104.not, label %polly.loop_header879, label %polly.loop_header853

polly.loop_header859:                             ; preds = %polly.loop_exit867, %polly.loop_header853
  %indvars.iv1095 = phi i64 [ %indvars.iv.next1096, %polly.loop_exit867 ], [ 0, %polly.loop_header853 ]
  %polly.indvar862 = phi i64 [ %polly.indvar_next863, %polly.loop_exit867 ], [ 0, %polly.loop_header853 ]
  %284 = mul nsw i64 %polly.indvar862, -32
  %smin1163 = call i64 @llvm.smin.i64(i64 %284, i64 -968)
  %285 = add nsw i64 %smin1163, 1000
  %smin1097 = call i64 @llvm.smin.i64(i64 %indvars.iv1095, i64 -968)
  %286 = shl nsw i64 %polly.indvar862, 5
  %287 = add nsw i64 %smin1097, 999
...
polly.loop_exit867:                               ; preds = %polly.loop_exit873
  ...
  %exitcond1103.not = icmp eq i64 %polly.indvar_next863, 32
  br i1 %exitcond1103.not, label %polly.loop_exit861, label %polly.loop_header859
...
polly.loop_header865:                             ; preds = %polly.loop_exit873, %polly.loop_header859
  ...
  %min.iters.check1164 = icmp eq i64 %285, 0
  br i1 %min.iters.check1164, label %polly.loop_header871, label %vector.ph1165

vector.ph1165:                                    ; preds = %polly.loop_header865
  %broadcast.splatinsert1174 = insertelement <4 x i64> poison, i64 %286, i32 0
  %broadcast.splat1175 = shufflevector <4 x i64> %broadcast.splatinsert1174, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1176 = insertelement <4 x i32> poison, i32 %289, i32 0
...
vector.body1162:                                  ; preds = %vector.body1162, %vector.ph1165
  ...
  %291 = add nuw nsw <4 x i64> %vec.ind1172, %broadcast.splat1175
  %292 = trunc <4 x i64> %291 to <4 x i32>
  %293 = mul <4 x i32> %broadcast.splat1177, %292
  ...
  %303 = icmp eq i64 %index.next1169, %285
  br i1 %303, label %polly.loop_exit873, label %vector.body1162, !llvm.loop !113

polly.loop_exit873:                               ; preds = %vector.body1162, %polly.loop_header871
  %polly.indvar_next869 = add nuw nsw i64 %polly.indvar868, 1
  %exitcond1102.not = icmp eq i64 %polly.indvar868, %283
  br i1 %exitcond1102.not, label %polly.loop_exit867, label %polly.loop_header865
...
polly.loop_header871:                             ; preds = %polly.loop_header865, %polly.loop_header871
  ...
  %exitcond1098.not = icmp eq i64 %polly.indvar874, %287
  br i1 %exitcond1098.not, label %polly.loop_exit873, label %polly.loop_header871, !llvm.loop !114

polly.loop_header879:                             ; preds = %polly.loop_exit861, %polly.loop_exit887
  %indvars.iv1089 = phi i64 [ %indvars.iv.next1090, %polly.loop_exit887 ], [ 0, %polly.loop_exit861 ]
  ...
  %312 = add nsw i64 %smin1091, 1199
  br label %polly.loop_header885

polly.loop_exit887:                               ; preds = %polly.loop_exit893
  %polly.indvar_next883 = add nuw nsw i64 %polly.indvar882, 1
  %indvars.iv.next1090 = add nsw i64 %indvars.iv1089, -32
  %exitcond1094.not = icmp eq i64 %polly.indvar_next883, 38
  br i1 %exitcond1094.not, label %init_array.exit, label %polly.loop_header879

polly.loop_header885:                             ; preds = %polly.loop_exit893, %polly.loop_header879
  %indvars.iv1085 = phi i64 [ %indvars.iv.next1086, %polly.loop_exit893 ], [ 0, %polly.loop_header879 ]
  %polly.indvar888 = phi i64 [ %polly.indvar_next889, %polly.loop_exit893 ], [ 0, %polly.loop_header879 ]
  %313 = mul nsw i64 %polly.indvar888, -32
  %smin1181 = call i64 @llvm.smin.i64(i64 %313, i64 -968)
  %314 = add nsw i64 %smin1181, 1000
  %smin1087 = call i64 @llvm.smin.i64(i64 %indvars.iv1085, i64 -968)
  %315 = shl nsw i64 %polly.indvar888, 5
  %316 = add nsw i64 %smin1087, 999
...
polly.loop_exit893:                               ; preds = %polly.loop_exit899
  ...
  %exitcond1093.not = icmp eq i64 %polly.indvar_next889, 32
  br i1 %exitcond1093.not, label %polly.loop_exit887, label %polly.loop_header885
...
vector.body1180:                                  ; preds = %vector.body1180, %vector.ph1183
  ...
  %320 = add nuw nsw <4 x i64> %vec.ind1190, %broadcast.splat1193
  %321 = trunc <4 x i64> %320 to <4 x i32>
  %322 = mul <4 x i32> %broadcast.splat1195, %321
  ...
  %332 = icmp eq i64 %index.next1187, %314
  br i1 %332, label %polly.loop_exit899, label %vector.body1180, !llvm.loop !116

polly.loop_exit899:                               ; preds = %vector.body1180, %polly.loop_header897
  %polly.indvar_next895 = add nuw nsw i64 %polly.indvar894, 1
  %exitcond1092.not = icmp eq i64 %polly.indvar894, %312
  br i1 %exitcond1092.not, label %polly.loop_exit893, label %polly.loop_header891
...
polly.loop_header897:                             ; preds = %polly.loop_header891, %polly.loop_header897
  ...
  %exitcond1088.not = icmp eq i64 %polly.indvar900, %316
  br i1 %exitcond1088.not, label %polly.loop_exit899, label %polly.loop_header897, !llvm.loop !117
}
