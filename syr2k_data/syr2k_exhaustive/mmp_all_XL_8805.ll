; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8805.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8805.c"
...
polly.loop_exit225:                               ; preds = %polly.loop_exit232
  ...
  %exitcond793.not = icmp eq i64 %polly.indvar_next221, 100
...
polly.loop_header223:                             ; preds = %polly.loop_header217, %polly.loop_exit232
  ...
  %117 = add i64 %116, %104
  %polly.loop_guard233868 = icmp sgt i64 %117, -1
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph987
  ...
  %128 = shl nuw nsw i64 %index990, 3
  %129 = getelementptr i8, i8* %scevgep350, i64 %128
  %130 = bitcast i8* %129 to <4 x double>*
  %wide.load994 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !72, !noalias !74
  %131 = fmul fast <4 x double> %wide.load994, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %133 = icmp eq i64 %index.next991, %n.vec989
  br i1 %133, label %middle.block981, label %vector.body983, !llvm.loop !77

middle.block981:                                  ; preds = %vector.body983
  %cmp.n993 = icmp eq i64 %126, %n.vec989
...
polly.loop_exit362:                               ; preds = %polly.loop_exit369
  ...
  %exitcond813.not = icmp eq i64 %polly.indvar_next358, 10
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %136 = lshr i64 %polly.indvar363, 2
  %137 = add nuw i64 %polly.indvar363, %136
  %138 = shl nuw nsw i64 %137, 6
  %139 = sub i64 %indvars.iv798, %138
  %140 = add i64 %indvars.iv803, %138
  %141 = mul nuw nsw i64 %polly.indvar363, 80
  %142 = mul nsw i64 %polly.indvar363, -80
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv805 = phi i64 [ %indvars.iv.next806, %polly.loop_exit375 ], [ %140, %polly.loop_header360 ]
  %indvars.iv800 = phi i64 [ %indvars.iv.next801, %polly.loop_exit375 ], [ %139, %polly.loop_header360 ]
  ...
  %143 = add i64 %smax802, %indvars.iv805
...
polly.loop_exit382:                               ; preds = %polly.loop_exit390
  ...
  %exitcond811.not = icmp eq i64 %polly.indvar_next377, 100
  br i1 %exitcond811.not, label %polly.loop_exit375, label %polly.loop_header373

polly.loop_header380:                             ; preds = %polly.loop_header373, %polly.loop_exit390
  %indvars.iv807 = phi i64 [ %143, %polly.loop_header373 ], [ %indvars.iv.next808, %polly.loop_exit390 ]
  ...
  %155 = add i64 %154, %142
  %polly.loop_guard391869 = icmp sgt i64 %155, -1
  br i1 %polly.loop_guard391869, label %polly.loop_header388.preheader, label %polly.loop_exit390
...
vector.body959:                                   ; preds = %vector.body959, %vector.ph961
  ...
  %166 = shl nuw nsw i64 %index964, 3
  %167 = getelementptr i8, i8* %scevgep508, i64 %166
  %168 = bitcast i8* %167 to <4 x double>*
  %wide.load968 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !81, !noalias !83
  %169 = fmul fast <4 x double> %wide.load968, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %171 = icmp eq i64 %index.next965, %n.vec963
  br i1 %171, label %middle.block957, label %vector.body959, !llvm.loop !86

middle.block957:                                  ; preds = %vector.body959
  %cmp.n967 = icmp eq i64 %164, %n.vec963
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %173 = mul nuw nsw i64 %polly.indvar515, 100
...
polly.loop_exit520:                               ; preds = %polly.loop_exit527
  ...
  %exitcond831.not = icmp eq i64 %polly.indvar_next516, 10
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %174 = lshr i64 %polly.indvar521, 2
  %175 = add nuw i64 %polly.indvar521, %174
  %176 = shl nuw nsw i64 %175, 6
  %177 = sub i64 %indvars.iv816, %176
  %178 = add i64 %indvars.iv821, %176
  %179 = mul nuw nsw i64 %polly.indvar521, 80
  %180 = mul nsw i64 %polly.indvar521, -80
...
polly.loop_header525:                             ; preds = %polly.loop_exit533, %polly.loop_header518
  %indvars.iv823 = phi i64 [ %indvars.iv.next824, %polly.loop_exit533 ], [ %178, %polly.loop_header518 ]
  %indvars.iv818 = phi i64 [ %indvars.iv.next819, %polly.loop_exit533 ], [ %177, %polly.loop_header518 ]
  ...
  %181 = add i64 %smax820, %indvars.iv823
...
polly.loop_exit540:                               ; preds = %polly.loop_exit548
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next535, 100
  br i1 %exitcond829.not, label %polly.loop_exit533, label %polly.loop_header531

polly.loop_header538:                             ; preds = %polly.loop_header531, %polly.loop_exit548
  %indvars.iv825 = phi i64 [ %181, %polly.loop_header531 ], [ %indvars.iv.next826, %polly.loop_exit548 ]
  ...
  %193 = add i64 %192, %180
  %polly.loop_guard549870 = icmp sgt i64 %193, -1
  br i1 %polly.loop_guard549870, label %polly.loop_header546.preheader, label %polly.loop_exit548
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin898 = call i64 @llvm.smin.i64(i64 %204, i64 -1168)
  %205 = add nsw i64 %smin898, 1200
...
vector.ph899:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert906 = insertelement <4 x i64> poison, i64 %206, i32 0
  %broadcast.splat907 = shufflevector <4 x i64> %broadcast.splatinsert906, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert908 = insertelement <4 x i32> poison, i32 %209, i32 0
...
vector.body897:                                   ; preds = %vector.body897, %vector.ph899
  ...
  %211 = add nuw nsw <4 x i64> %vec.ind904, %broadcast.splat907
  %212 = trunc <4 x i64> %211 to <4 x i32>
  %213 = mul <4 x i32> %broadcast.splat909, %212
  ...
  %223 = icmp eq i64 %index.next901, %205
  br i1 %223, label %polly.loop_exit714, label %vector.body897, !llvm.loop !95
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin913 = call i64 @llvm.smin.i64(i64 %233, i64 -968)
  %234 = add nsw i64 %smin913, 1000
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph915
  ...
  %240 = add nuw nsw <4 x i64> %vec.ind922, %broadcast.splat925
  %241 = trunc <4 x i64> %240 to <4 x i32>
  %242 = mul <4 x i32> %broadcast.splat927, %241
  ...
  %252 = icmp eq i64 %index.next919, %234
  br i1 %252, label %polly.loop_exit741, label %vector.body912, !llvm.loop !98
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin931 = call i64 @llvm.smin.i64(i64 %262, i64 -968)
  %263 = add nsw i64 %smin931, 1000
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  %269 = add nuw nsw <4 x i64> %vec.ind940, %broadcast.splat943
  %270 = trunc <4 x i64> %269 to <4 x i32>
  %271 = mul <4 x i32> %broadcast.splat945, %270
  ...
  %281 = icmp eq i64 %index.next937, %263
  br i1 %281, label %polly.loop_exit767, label %vector.body930, !llvm.loop !101
