; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6416.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6416.c"
...
vector.body1063:                                  ; preds = %vector.body1063, %vector.ph1067
  ...
  %wide.load1074 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !79, !noalias !81
  ...
  br i1 %133, label %middle.block1061, label %vector.body1063, !llvm.loop !85
...
vector.body1039:                                  ; preds = %vector.body1039, %vector.ph1041
  ...
  %wide.load1048 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !89, !noalias !91
  ...
  br i1 %171, label %middle.block1037, label %vector.body1039, !llvm.loop !95
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph979
  ...
  br i1 %223, label %polly.loop_exit772, label %vector.body977, !llvm.loop !104
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph995
  ...
  br i1 %252, label %polly.loop_exit799, label %vector.body992, !llvm.loop !107
...
vector.body1010:                                  ; preds = %vector.body1010, %vector.ph1013
  ...
  br i1 %281, label %polly.loop_exit825, label %vector.body1010, !llvm.loop !110
...
polly.loop_exit394.3:                             ; preds = %polly.loop_header392.3
  %326 = mul nsw i64 %polly.indvar383, -20
...
polly.loop_exit572.3:                             ; preds = %polly.loop_header570.3
  %360 = mul nsw i64 %polly.indvar561, -20
