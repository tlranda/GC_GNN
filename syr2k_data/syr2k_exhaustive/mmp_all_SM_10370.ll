; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10370.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10370.c"
...
vector.body897:                                   ; preds = %vector.body897, %vector.ph898
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call718, i64 %indvars.iv7.i, i64 %index899
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph962
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call718, i64 %indvars.iv21.i, i64 %index965
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph985
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call718, i64 %indvars.iv21.i52, i64 %index988
...
vector.body1009:                                  ; preds = %vector.body1009, %vector.ph1011
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call718, i64 %indvars.iv21.i91, i64 %index1014
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin793 = call i64 @llvm.smin.i64(i64 %indvars.iv791, i64 -920)
  %102 = mul nuw nsw i64 %polly.indvar208, 80
  %103 = add nsw i64 %smin793, 999
  br label %polly.loop_header211

polly.loop_exit213:                               ; preds = %polly.loop_exit219
  %polly.indvar_next209 = add nuw nsw i64 %polly.indvar208, 1
  %indvars.iv.next792 = add nsw i64 %indvars.iv791, -80
  %exitcond796.not = icmp eq i64 %polly.indvar_next209, 13
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225, %polly.loop_header211
  ...
  %exitcond795.not = icmp eq i64 %polly.indvar214, %umin
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233880 = icmp sgt i64 %110, -1
  %111 = add nuw nsw i64 %polly.indvar220, %101
  %112 = mul i64 %111, 8000
  %113 = mul i64 %111, 9600
  br i1 %polly.loop_guard233880, label %polly.loop_header223.us, label %polly.loop_exit225
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph999
  ...
  %wide.load1006 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %129, label %middle.block993, label %vector.body995, !llvm.loop !74
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %indvars.iv800 = phi i64 [ %indvars.iv.next801, %polly.loop_exit362 ], [ 0, %polly.loop_exit346 ]
  %polly.indvar357 = phi i64 [ %polly.indvar_next358, %polly.loop_exit362 ], [ 0, %polly.loop_exit346 ]
  %umin817 = call i64 @llvm.umin.i64(i64 %polly.indvar357, i64 11)
  %131 = mul nsw i64 %polly.indvar357, -96
  %132 = icmp slt i64 %131, -1104
  %133 = select i1 %132, i64 %131, i64 -1104
  %134 = add nsw i64 %133, 1199
  %135 = mul nuw nsw i64 %polly.indvar357, 96
...
polly.loop_exit362:                               ; preds = %polly.loop_exit368
  ...
  %exitcond820.not = icmp eq i64 %polly.indvar_next358, 13
...
polly.loop_header360:                             ; preds = %polly.loop_exit368, %polly.loop_header354
  %indvars.iv813 = phi i64 [ %indvars.iv.next814, %polly.loop_exit368 ], [ 0, %polly.loop_header354 ]
  %polly.indvar363 = phi i64 [ %polly.indvar_next364, %polly.loop_exit368 ], [ 0, %polly.loop_header354 ]
  %smin815 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 -920)
  %136 = mul nuw nsw i64 %polly.indvar363, 80
  %137 = add nsw i64 %smin815, 999
...
polly.loop_exit368:                               ; preds = %polly.loop_exit375
  ...
  %exitcond819.not = icmp eq i64 %polly.indvar_next364, 13
...
polly.loop_header366:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  %indvars.iv807 = phi i64 [ %indvars.iv.next808, %polly.loop_exit375 ], [ %indvars.iv805, %polly.loop_header360 ]
  %indvars.iv802 = phi i64 [ %indvars.iv.next803, %polly.loop_exit375 ], [ %indvars.iv800, %polly.loop_header360 ]
  %polly.indvar369 = phi i64 [ %polly.indvar_next370, %polly.loop_exit375 ], [ 0, %polly.loop_header360 ]
  %138 = mul nuw nsw i64 %polly.indvar369, 100
...
polly.loop_header373.preheader:                   ; preds = %polly.loop_header366
  ...
  %142 = add i64 %smax804, %indvars.iv807
...
polly.loop_exit375:                               ; preds = %polly.loop_exit382, %polly.loop_header366
  ...
  %exitcond818.not = icmp eq i64 %polly.indvar369, %umin817
  br i1 %exitcond818.not, label %polly.loop_exit368, label %polly.loop_header366

polly.loop_header373:                             ; preds = %polly.loop_header373.preheader, %polly.loop_exit382
  %indvars.iv809 = phi i64 [ %142, %polly.loop_header373.preheader ], [ %indvars.iv.next810, %polly.loop_exit382 ]
  ...
  %polly.loop_guard390881 = icmp sgt i64 %144, -1
  %145 = add nuw nsw i64 %polly.indvar377, %135
  %146 = mul i64 %145, 8000
  %147 = mul i64 %145, 9600
  br i1 %polly.loop_guard390881, label %polly.loop_header380.us, label %polly.loop_exit382
...
polly.loop_header387.us:                          ; preds = %polly.loop_header380.us, %polly.loop_header387.us
  ...
  %exitcond812.not = icmp eq i64 %polly.indvar391.us, %smin811
  br i1 %exitcond812.not, label %polly.loop_exit389.loopexit.us, label %polly.loop_header387.us

polly.loop_exit389.loopexit.us:                   ; preds = %polly.loop_header387.us
  %polly.indvar_next384.us = add nuw nsw i64 %polly.indvar383.us, 1
  %exitcond816.not = icmp eq i64 %polly.indvar383.us, %137
  br i1 %exitcond816.not, label %polly.loop_exit382, label %polly.loop_header380.us
...
polly.loop_header495:                             ; preds = %init_array.exit, %polly.loop_exit503
  ...
  br i1 %min.iters.check972, label %polly.loop_header501.preheader, label %vector.ph973

vector.ph973:                                     ; preds = %polly.loop_header495
...
vector.body971:                                   ; preds = %vector.body971, %vector.ph973
  ...
  %wide.load980 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %163, label %middle.block969, label %vector.body971, !llvm.loop !83

middle.block969:                                  ; preds = %vector.body971
  %cmp.n979 = icmp eq i64 %156, %n.vec975
  br i1 %cmp.n979, label %polly.loop_exit503, label %polly.loop_header501.preheader

polly.loop_header501.preheader:                   ; preds = %polly.loop_header495, %middle.block969
  %polly.indvar504.ph = phi i64 [ 0, %polly.loop_header495 ], [ %n.vec975, %middle.block969 ]
  br label %polly.loop_header501

polly.loop_exit503:                               ; preds = %polly.loop_header501, %middle.block969
  %polly.indvar_next499 = add nuw nsw i64 %polly.indvar498, 1
  %exitcond845.not = icmp eq i64 %polly.indvar_next499, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond845.not, label %polly.loop_header511, label %polly.loop_header495
...
polly.loop_header501:                             ; preds = %polly.loop_header501.preheader, %polly.loop_header501
  ...
  %exitcond844.not = icmp eq i64 %polly.indvar_next505, %polly.indvar498
  br i1 %exitcond844.not, label %polly.loop_exit503, label %polly.loop_header501, !llvm.loop !84

polly.loop_header511:                             ; preds = %polly.loop_exit503, %polly.loop_exit519
  %indvars.iv828 = phi i64 [ %indvars.iv.next829, %polly.loop_exit519 ], [ 0, %polly.loop_exit503 ]
  %indvars.iv823 = phi i64 [ %indvars.iv.next824, %polly.loop_exit519 ], [ 0, %polly.loop_exit503 ]
  %polly.indvar514 = phi i64 [ %polly.indvar_next515, %polly.loop_exit519 ], [ 0, %polly.loop_exit503 ]
  %umin840 = call i64 @llvm.umin.i64(i64 %polly.indvar514, i64 11)
  %165 = mul nsw i64 %polly.indvar514, -96
  %166 = icmp slt i64 %165, -1104
  %167 = select i1 %166, i64 %165, i64 -1104
  %168 = add nsw i64 %167, 1199
  %169 = mul nuw nsw i64 %polly.indvar514, 96
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond843.not = icmp eq i64 %polly.indvar_next515, 13
  br i1 %exitcond843.not, label %kernel_syr2k.exit, label %polly.loop_header511

polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  %indvars.iv836 = phi i64 [ %indvars.iv.next837, %polly.loop_exit525 ], [ 0, %polly.loop_header511 ]
  %polly.indvar520 = phi i64 [ %polly.indvar_next521, %polly.loop_exit525 ], [ 0, %polly.loop_header511 ]
  %smin838 = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 -920)
  %170 = mul nuw nsw i64 %polly.indvar520, 80
  %171 = add nsw i64 %smin838, 999
...
polly.loop_exit525:                               ; preds = %polly.loop_exit532
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar_next521, 13
  br i1 %exitcond842.not, label %polly.loop_exit519, label %polly.loop_header517

polly.loop_header523:                             ; preds = %polly.loop_exit532, %polly.loop_header517
  %indvars.iv830 = phi i64 [ %indvars.iv.next831, %polly.loop_exit532 ], [ %indvars.iv828, %polly.loop_header517 ]
  %indvars.iv825 = phi i64 [ %indvars.iv.next826, %polly.loop_exit532 ], [ %indvars.iv823, %polly.loop_header517 ]
  %polly.indvar526 = phi i64 [ %polly.indvar_next527, %polly.loop_exit532 ], [ 0, %polly.loop_header517 ]
  %172 = mul nuw nsw i64 %polly.indvar526, 100
...
polly.loop_exit532:                               ; preds = %polly.loop_exit539, %polly.loop_header523
  ...
  %exitcond841.not = icmp eq i64 %polly.indvar526, %umin840
  br i1 %exitcond841.not, label %polly.loop_exit525, label %polly.loop_header523

polly.loop_header530:                             ; preds = %polly.loop_header530.preheader, %polly.loop_exit539
  %indvars.iv832 = phi i64 [ %176, %polly.loop_header530.preheader ], [ %indvars.iv.next833, %polly.loop_exit539 ]
  ...
  %polly.loop_guard547882 = icmp sgt i64 %178, -1
  %179 = add nuw nsw i64 %polly.indvar534, %169
  %180 = mul i64 %179, 8000
  %181 = mul i64 %179, 9600
  br i1 %polly.loop_guard547882, label %polly.loop_header537.us, label %polly.loop_exit539
...
polly.loop_header544.us:                          ; preds = %polly.loop_header537.us, %polly.loop_header544.us
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar548.us, %smin834
  br i1 %exitcond835.not, label %polly.loop_exit546.loopexit.us, label %polly.loop_header544.us

polly.loop_exit546.loopexit.us:                   ; preds = %polly.loop_header544.us
  %polly.indvar_next541.us = add nuw nsw i64 %polly.indvar540.us, 1
  %exitcond839.not = icmp eq i64 %polly.indvar540.us, %171
  br i1 %exitcond839.not, label %polly.loop_exit539, label %polly.loop_header537.us
...
polly.loop_header692:                             ; preds = %entry, %polly.loop_exit700
  %indvars.iv870 = phi i64 [ %indvars.iv.next871, %polly.loop_exit700 ], [ 0, %entry ]
...
polly.loop_exit700:                               ; preds = %polly.loop_exit706
  ...
  %exitcond875.not = icmp eq i64 %polly.indvar_next696, 38
  br i1 %exitcond875.not, label %polly.loop_header719, label %polly.loop_header692

polly.loop_header698:                             ; preds = %polly.loop_exit706, %polly.loop_header692
  %indvars.iv866 = phi i64 [ %indvars.iv.next867, %polly.loop_exit706 ], [ 0, %polly.loop_header692 ]
...
polly.loop_exit706:                               ; preds = %polly.loop_exit712
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar_next702, 38
  br i1 %exitcond874.not, label %polly.loop_exit700, label %polly.loop_header698
...
polly.loop_header704:                             ; preds = %polly.loop_exit712, %polly.loop_header698
  ...
  br i1 %min.iters.check, label %polly.loop_header710, label %vector.ph911

vector.ph911:                                     ; preds = %polly.loop_header704
...
vector.body909:                                   ; preds = %vector.body909, %vector.ph911
  ...
  br i1 %211, label %polly.loop_exit712, label %vector.body909, !llvm.loop !92

polly.loop_exit712:                               ; preds = %vector.body909, %polly.loop_header710
  %polly.indvar_next708 = add nuw nsw i64 %polly.indvar707, 1
  %exitcond873.not = icmp eq i64 %polly.indvar707, %191
  br i1 %exitcond873.not, label %polly.loop_exit706, label %polly.loop_header704
...
polly.loop_header710:                             ; preds = %polly.loop_header704, %polly.loop_header710
  ...
  %exitcond869.not = icmp eq i64 %polly.indvar713, %195
  br i1 %exitcond869.not, label %polly.loop_exit712, label %polly.loop_header710, !llvm.loop !93

polly.loop_header719:                             ; preds = %polly.loop_exit700, %polly.loop_exit727
  %indvars.iv860 = phi i64 [ %indvars.iv.next861, %polly.loop_exit727 ], [ 0, %polly.loop_exit700 ]
...
polly.loop_exit727:                               ; preds = %polly.loop_exit733
  ...
  %exitcond865.not = icmp eq i64 %polly.indvar_next723, 38
  br i1 %exitcond865.not, label %polly.loop_header745, label %polly.loop_header719

polly.loop_header725:                             ; preds = %polly.loop_exit733, %polly.loop_header719
  %indvars.iv856 = phi i64 [ %indvars.iv.next857, %polly.loop_exit733 ], [ 0, %polly.loop_header719 ]
...
polly.loop_exit733:                               ; preds = %polly.loop_exit739
  ...
  %exitcond864.not = icmp eq i64 %polly.indvar_next729, 32
  br i1 %exitcond864.not, label %polly.loop_exit727, label %polly.loop_header725
...
polly.loop_header731:                             ; preds = %polly.loop_exit739, %polly.loop_header725
  ...
  br i1 %min.iters.check926, label %polly.loop_header737, label %vector.ph927

vector.ph927:                                     ; preds = %polly.loop_header731
...
vector.body924:                                   ; preds = %vector.body924, %vector.ph927
  ...
  br i1 %240, label %polly.loop_exit739, label %vector.body924, !llvm.loop !95

polly.loop_exit739:                               ; preds = %vector.body924, %polly.loop_header737
  %polly.indvar_next735 = add nuw nsw i64 %polly.indvar734, 1
  %exitcond863.not = icmp eq i64 %polly.indvar734, %220
  br i1 %exitcond863.not, label %polly.loop_exit733, label %polly.loop_header731
...
polly.loop_header737:                             ; preds = %polly.loop_header731, %polly.loop_header737
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar740, %224
  br i1 %exitcond859.not, label %polly.loop_exit739, label %polly.loop_header737, !llvm.loop !96

polly.loop_header745:                             ; preds = %polly.loop_exit727, %polly.loop_exit753
  %indvars.iv850 = phi i64 [ %indvars.iv.next851, %polly.loop_exit753 ], [ 0, %polly.loop_exit727 ]
...
polly.loop_exit753:                               ; preds = %polly.loop_exit759
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar_next749, 38
  br i1 %exitcond855.not, label %init_array.exit, label %polly.loop_header745

polly.loop_header751:                             ; preds = %polly.loop_exit759, %polly.loop_header745
  %indvars.iv846 = phi i64 [ %indvars.iv.next847, %polly.loop_exit759 ], [ 0, %polly.loop_header745 ]
...
polly.loop_exit759:                               ; preds = %polly.loop_exit765
  ...
  %exitcond854.not = icmp eq i64 %polly.indvar_next755, 32
  br i1 %exitcond854.not, label %polly.loop_exit753, label %polly.loop_header751
...
polly.loop_header757:                             ; preds = %polly.loop_exit765, %polly.loop_header751
  ...
  br i1 %min.iters.check944, label %polly.loop_header763, label %vector.ph945

vector.ph945:                                     ; preds = %polly.loop_header757
...
vector.body942:                                   ; preds = %vector.body942, %vector.ph945
  ...
  br i1 %269, label %polly.loop_exit765, label %vector.body942, !llvm.loop !98

polly.loop_exit765:                               ; preds = %vector.body942, %polly.loop_header763
  %polly.indvar_next761 = add nuw nsw i64 %polly.indvar760, 1
  %exitcond853.not = icmp eq i64 %polly.indvar760, %249
  br i1 %exitcond853.not, label %polly.loop_exit759, label %polly.loop_header757
...
polly.loop_header763:                             ; preds = %polly.loop_header757, %polly.loop_header763
  ...
  %exitcond849.not = icmp eq i64 %polly.indvar766, %253
  br i1 %exitcond849.not, label %polly.loop_exit765, label %polly.loop_header763, !llvm.loop !99
}
