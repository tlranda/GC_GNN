; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3595.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3595.c"
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1145
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call835, i64 %indvars.iv7.i, i64 %index1146
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  ...
  br i1 %min.iters.check1207, label %for.body3.i46.preheader1284, label %vector.ph1208
...
vector.body1206:                                  ; preds = %vector.body1206, %vector.ph1208
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call835, i64 %indvars.iv21.i, i64 %index1211
...
for.body3.i46.preheader1284:                      ; preds = %for.body3.i46.preheader, %middle.block1204
...
vector.body1229:                                  ; preds = %vector.body1229, %vector.ph1231
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call835, i64 %indvars.iv21.i52, i64 %index1234
  ...
  br i1 %57, label %middle.block1227, label %vector.body1229, !llvm.loop !59
...
vector.body1255:                                  ; preds = %vector.body1255, %vector.ph1257
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call835, i64 %indvars.iv21.i91, i64 %index1260
  ...
  br i1 %68, label %middle.block1253, label %vector.body1255, !llvm.loop !61
...
vector.body1267:                                  ; preds = %vector.body1267, %vector.ph1271
  ...
  %wide.load1278 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !67, !noalias !69
  ...
  br i1 %95, label %middle.block1265, label %vector.body1267, !llvm.loop !73
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond1035.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !74

polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  %indvars.iv = phi i64 [ 0, %polly.loop_header199.preheader ], [ %indvars.iv.next, %polly.loop_exit207 ]
  %polly.indvar202 = phi i64 [ 0, %polly.loop_header199.preheader ], [ %polly.indvar_next203, %polly.loop_exit207 ]
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -920)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond1034.not = icmp eq i64 %polly.indvar_next203, 13
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  %104 = sub nsw i64 %indvars.iv1023, %100
  %105 = add i64 %indvars.iv1017, %100
...
polly.loop_exit213:                               ; preds = %polly.loop_exit252, %polly.loop_header205
  ...
  %indvars.iv.next1020 = add nuw nsw i64 %indvars.iv1019, 2
  %indvars.iv.next1024 = add nuw nsw i64 %indvars.iv1023, 32
  %exitcond1033.not = icmp eq i64 %polly.indvar_next209, 10
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit252
  %indvars.iv1025 = phi i64 [ %104, %polly.loop_header211.preheader ], [ %indvars.iv.next1026, %polly.loop_exit252 ]
  %indvars.iv1021 = phi i64 [ %105, %polly.loop_header211.preheader ], [ %indvars.iv.next1022, %polly.loop_exit252 ]
  ...
  %108 = add i64 %smax, %indvars.iv1025
  ...
  %115 = add nsw i64 %110, 79
  %polly.loop_guard239.not = icmp sgt i64 %114, %115
...
polly.loop_header224.us:                          ; preds = %polly.loop_header217.us, %polly.loop_header224.us
  ...
  %117 = add nuw nsw i64 %polly.indvar228.us, %107
  %polly.access.mul.call1232.us = mul nuw nsw i64 %117, 1000
  %polly.access.add.call1233.us = add nuw nsw i64 %116, %polly.access.mul.call1232.us
...
polly.loop_header236.us:                          ; preds = %polly.loop_exit226.loopexit.us, %polly.loop_header236.us
  ...
  %118 = add nuw nsw i64 %polly.indvar240.us, %107
  %polly.access.mul.call1244.us = mul nsw i64 %118, 1000
  %polly.access.add.call1245.us = add nuw nsw i64 %116, %polly.access.mul.call1244.us
  ...
  %polly.loop_cond242.not.not.us = icmp slt i64 %polly.indvar240.us, %115
...
polly.loop_exit238.us:                            ; preds = %polly.loop_header236.us, %polly.loop_exit226.loopexit.us
  ...
  %exitcond1016.not = icmp eq i64 %polly.indvar_next221.us, %97
  br i1 %exitcond1016.not, label %polly.loop_header250.preheader, label %polly.loop_header217.us
...
polly.loop_header250.preheader:                   ; preds = %polly.loop_exit238, %polly.loop_exit238.us, %polly.loop_header211.split
  ...
  %polly.loop_guard260 = icmp slt i64 %122, 80
...
polly.loop_header250.us:                          ; preds = %polly.loop_header250.preheader, %polly.loop_exit259.loopexit.us
  ...
  %123 = add nuw nsw i64 %polly.indvar253.us, %98
...
polly.loop_header257.us:                          ; preds = %polly.loop_header250.us, %polly.loop_exit267.us
  %indvars.iv1027 = phi i64 [ %108, %polly.loop_header250.us ], [ %indvars.iv.next1028, %polly.loop_exit267.us ]
  %polly.indvar261.us = phi i64 [ %122, %polly.loop_header250.us ], [ %polly.indvar_next262.us, %polly.loop_exit267.us ]
  %smin1029 = call i64 @llvm.smin.i64(i64 %indvars.iv1027, i64 127)
  %125 = add nsw i64 %polly.indvar261.us, %110
  %polly.loop_guard268.us1127 = icmp sgt i64 %125, -1
  br i1 %polly.loop_guard268.us1127, label %polly.loop_header265.preheader.us, label %polly.loop_exit267.us
...
polly.loop_header265.us:                          ; preds = %polly.loop_header265.preheader.us, %polly.loop_header265.us
  ...
  %126 = add nuw nsw i64 %polly.indvar269.us, %107
  ...
  %scevgep279.us = getelementptr i8, i8* %call2, i64 %128
  ...
  %129 = shl i64 %126, 3
  %130 = add i64 %129, %134
  %scevgep286.us = getelementptr i8, i8* %call, i64 %130
  ...
  %exitcond1030.not = icmp eq i64 %polly.indvar269.us, %smin1029
  br i1 %exitcond1030.not, label %polly.loop_exit267.us, label %polly.loop_header265.us
...
polly.loop_exit267.us:                            ; preds = %polly.loop_header265.us, %polly.loop_header257.us
  ...
  %polly.loop_cond263.us = icmp ult i64 %polly.indvar261.us, 79
...
polly.loop_header265.preheader.us:                ; preds = %polly.loop_header257.us
  %131 = add nsw i64 %polly.indvar261.us, %109
  %132 = mul i64 %131, 8000
  %133 = add i64 %132, %124
  %scevgep276.us = getelementptr i8, i8* %call2, i64 %133
  ...
  %polly.access.add.Packed_MemRef_call1283.us = add nsw i64 %125, %polly.access.mul.Packed_MemRef_call1272.us
...
polly.loop_exit259.loopexit.us:                   ; preds = %polly.loop_exit267.us
  ...
  %exitcond1032.not = icmp eq i64 %polly.indvar_next254.us, %97
  br i1 %exitcond1032.not, label %polly.loop_exit252, label %polly.loop_header250.us
...
polly.loop_header236:                             ; preds = %polly.loop_header217, %polly.loop_header236
  ...
  %135 = add nuw nsw i64 %polly.indvar240, %107
  %polly.access.mul.call1244 = mul nsw i64 %135, 1000
  %polly.access.add.call1245 = add nuw nsw i64 %119, %polly.access.mul.call1244
  ...
  %polly.loop_cond242.not.not = icmp slt i64 %polly.indvar240, %115
...
polly.start291:                                   ; preds = %kernel_syr2k.exit
  %malloccall293 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header377:                             ; preds = %polly.loop_exit385, %polly.start291
  %indvar1242 = phi i64 [ %indvar.next1243, %polly.loop_exit385 ], [ 0, %polly.start291 ]
  %polly.indvar380 = phi i64 [ %polly.indvar_next381, %polly.loop_exit385 ], [ 1, %polly.start291 ]
  %136 = add i64 %indvar1242, 1
  %137 = mul nuw nsw i64 %polly.indvar380, 9600
  %scevgep389 = getelementptr i8, i8* %call, i64 %137
  %min.iters.check1244 = icmp ult i64 %136, 4
  br i1 %min.iters.check1244, label %polly.loop_header383.preheader, label %vector.ph1245

vector.ph1245:                                    ; preds = %polly.loop_header377
  %n.vec1247 = and i64 %136, -4
...
vector.body1241:                                  ; preds = %vector.body1241, %vector.ph1245
  ...
  %138 = shl nuw nsw i64 %index1248, 3
  %139 = getelementptr i8, i8* %scevgep389, i64 %138
  %140 = bitcast i8* %139 to <4 x double>*
  %wide.load1252 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !78, !noalias !80
  %141 = fmul fast <4 x double> %wide.load1252, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %143 = icmp eq i64 %index.next1249, %n.vec1247
  br i1 %143, label %middle.block1239, label %vector.body1241, !llvm.loop !84

middle.block1239:                                 ; preds = %vector.body1241
  %cmp.n1251 = icmp eq i64 %136, %n.vec1247
  br i1 %cmp.n1251, label %polly.loop_exit385, label %polly.loop_header383.preheader

polly.loop_header383.preheader:                   ; preds = %polly.loop_header377, %middle.block1239
  %polly.indvar386.ph = phi i64 [ 0, %polly.loop_header377 ], [ %n.vec1247, %middle.block1239 ]
  br label %polly.loop_header383

polly.loop_exit385:                               ; preds = %polly.loop_header383, %middle.block1239
  %polly.indvar_next381 = add nuw nsw i64 %polly.indvar380, 1
  %exitcond1064.not = icmp eq i64 %polly.indvar_next381, 1200
  %indvar.next1243 = add i64 %indvar1242, 1
  br i1 %exitcond1064.not, label %polly.loop_header393.preheader, label %polly.loop_header377
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_header383
  ...
  %144 = shl nuw nsw i64 %polly.indvar386, 3
  %scevgep390 = getelementptr i8, i8* %scevgep389, i64 %144
  ...
  %exitcond1063.not = icmp eq i64 %polly.indvar_next387, %polly.indvar380
  br i1 %exitcond1063.not, label %polly.loop_exit385, label %polly.loop_header383, !llvm.loop !85

polly.loop_header393:                             ; preds = %polly.loop_header393.preheader, %polly.loop_exit401
  %indvars.iv1037 = phi i64 [ 0, %polly.loop_header393.preheader ], [ %indvars.iv.next1038, %polly.loop_exit401 ]
  %polly.indvar396 = phi i64 [ 0, %polly.loop_header393.preheader ], [ %polly.indvar_next397, %polly.loop_exit401 ]
  %smin1059 = call i64 @llvm.smin.i64(i64 %indvars.iv1037, i64 -920)
  %145 = add nsw i64 %smin1059, 1000
  %146 = mul nuw nsw i64 %polly.indvar396, 80
  br label %polly.loop_header399

polly.loop_exit401:                               ; preds = %polly.loop_exit409
  %polly.indvar_next397 = add nuw nsw i64 %polly.indvar396, 1
  %indvars.iv.next1038 = add nsw i64 %indvars.iv1037, -80
  %exitcond1062.not = icmp eq i64 %polly.indvar_next397, 13
  br i1 %exitcond1062.not, label %polly.exiting292, label %polly.loop_header393

polly.loop_header399:                             ; preds = %polly.loop_exit409, %polly.loop_header393
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit409 ], [ 0, %polly.loop_header393 ]
  %indvars.iv1046 = phi i64 [ %indvars.iv.next1047, %polly.loop_exit409 ], [ 4, %polly.loop_header393 ]
  %indvars.iv1044 = phi i64 [ %indvars.iv.next1045, %polly.loop_exit409 ], [ 0, %polly.loop_header393 ]
  %polly.indvar402 = phi i64 [ %polly.indvar_next403, %polly.loop_exit409 ], [ 0, %polly.loop_header393 ]
  %147 = udiv i64 %indvars.iv1046, 5
  %148 = mul nuw nsw i64 %147, 80
  %149 = shl nuw nsw i64 %polly.indvar402, 1
  %150 = trunc i64 %149 to i8
  %pexp.p_div_q405.lhs.trunc = add i8 %150, 4
  %pexp.p_div_q405892 = udiv i8 %pexp.p_div_q405.lhs.trunc, 5
  %pexp.p_div_q405.zext = zext i8 %pexp.p_div_q405892 to i64
  %151 = sub nsw i64 %149, %pexp.p_div_q405.zext
  %polly.loop_guard410 = icmp slt i64 %151, 15
...
polly.loop_header407.preheader:                   ; preds = %polly.loop_header399
  %152 = sub nsw i64 %indvars.iv1051, %148
  %153 = add i64 %indvars.iv1044, %148
  %154 = mul nsw i64 %polly.indvar402, -128
  %155 = shl nsw i64 %polly.indvar402, 7
...
polly.loop_exit409:                               ; preds = %polly.loop_exit449, %polly.loop_header399
  ...
  %exitcond1061.not = icmp eq i64 %polly.indvar_next403, 10
  br i1 %exitcond1061.not, label %polly.loop_exit401, label %polly.loop_header399

polly.loop_header407:                             ; preds = %polly.loop_header407.preheader, %polly.loop_exit449
  %indvars.iv1053 = phi i64 [ %152, %polly.loop_header407.preheader ], [ %indvars.iv.next1054, %polly.loop_exit449 ]
  %indvars.iv1048 = phi i64 [ %153, %polly.loop_header407.preheader ], [ %indvars.iv.next1049, %polly.loop_exit449 ]
  %polly.indvar411 = phi i64 [ %151, %polly.loop_header407.preheader ], [ %polly.indvar_next412, %polly.loop_exit449 ]
  %smax1050 = call i64 @llvm.smax.i64(i64 %indvars.iv1048, i64 0)
  %156 = add i64 %smax1050, %indvars.iv1053
  %157 = mul nsw i64 %polly.indvar411, 80
  %158 = add nsw i64 %157, %154
  %159 = add nsw i64 %158, -1
  %.inv889 = icmp sgt i64 %158, 127
  %160 = select i1 %.inv889, i64 127, i64 %159
  %polly.loop_guard424 = icmp sgt i64 %160, -1
  %161 = icmp sgt i64 %158, 0
  %162 = select i1 %161, i64 %158, i64 0
  %163 = add nsw i64 %158, 79
  %polly.loop_guard436.not = icmp sgt i64 %162, %163
...
polly.loop_header414.us:                          ; preds = %polly.loop_header407, %polly.loop_exit435.us
  ...
  %164 = add nuw nsw i64 %polly.indvar417.us, %146
...
polly.loop_header421.us:                          ; preds = %polly.loop_header414.us, %polly.loop_header421.us
  ...
  %165 = add nuw nsw i64 %polly.indvar425.us, %155
  %polly.access.mul.call1429.us = mul nuw nsw i64 %165, 1000
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar425.us, %160
  br i1 %exitcond1041.not, label %polly.loop_exit423.loopexit.us, label %polly.loop_header421.us

polly.loop_header433.us:                          ; preds = %polly.loop_exit423.loopexit.us, %polly.loop_header433.us
  %polly.indvar437.us = phi i64 [ %polly.indvar_next438.us, %polly.loop_header433.us ], [ %162, %polly.loop_exit423.loopexit.us ]
  %166 = add nuw nsw i64 %polly.indvar437.us, %155
  %polly.access.mul.call1441.us = mul nsw i64 %166, 1000
  ...
  %polly.loop_cond439.not.not.us = icmp slt i64 %polly.indvar437.us, %163
...
polly.loop_exit435.us:                            ; preds = %polly.loop_header433.us, %polly.loop_exit423.loopexit.us
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next418.us, %145
  br i1 %exitcond1043.not, label %polly.loop_header447.preheader, label %polly.loop_header414.us
...
polly.loop_exit449:                               ; preds = %polly.loop_exit456.loopexit.us, %polly.loop_header447.preheader
  ...
  %polly.loop_cond413 = icmp slt i64 %polly.indvar411, 14
  %indvars.iv.next1049 = add i64 %indvars.iv1048, -80
  %indvars.iv.next1054 = add i64 %indvars.iv1053, 80
...
polly.loop_header414:                             ; preds = %polly.loop_header407.split, %polly.loop_exit435
  ...
  %167 = add nuw nsw i64 %polly.indvar417, %146
...
polly.loop_exit435:                               ; preds = %polly.loop_header433
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next418, %145
  br i1 %exitcond1040.not, label %polly.loop_header447.preheader, label %polly.loop_header414
...
polly.loop_header447.preheader:                   ; preds = %polly.loop_exit435, %polly.loop_exit435.us, %polly.loop_header407.split
  ...
  %polly.loop_guard457 = icmp slt i64 %170, 80
...
polly.loop_header447.us:                          ; preds = %polly.loop_header447.preheader, %polly.loop_exit456.loopexit.us
  ...
  %171 = add nuw nsw i64 %polly.indvar450.us, %146
...
polly.loop_header454.us:                          ; preds = %polly.loop_header447.us, %polly.loop_exit464.us
  %indvars.iv1055 = phi i64 [ %156, %polly.loop_header447.us ], [ %indvars.iv.next1056, %polly.loop_exit464.us ]
  %polly.indvar458.us = phi i64 [ %170, %polly.loop_header447.us ], [ %polly.indvar_next459.us, %polly.loop_exit464.us ]
  %smin1057 = call i64 @llvm.smin.i64(i64 %indvars.iv1055, i64 127)
  %173 = add nsw i64 %polly.indvar458.us, %158
  %polly.loop_guard465.us1128 = icmp sgt i64 %173, -1
  br i1 %polly.loop_guard465.us1128, label %polly.loop_header462.preheader.us, label %polly.loop_exit464.us
...
polly.loop_header462.us:                          ; preds = %polly.loop_header462.preheader.us, %polly.loop_header462.us
  ...
  %174 = add nuw nsw i64 %polly.indvar466.us, %155
  ...
  %scevgep476.us = getelementptr i8, i8* %call2, i64 %176
  ...
  %177 = shl i64 %174, 3
  %178 = add i64 %177, %182
  %scevgep483.us = getelementptr i8, i8* %call, i64 %178
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar466.us, %smin1057
  br i1 %exitcond1058.not, label %polly.loop_exit464.us, label %polly.loop_header462.us
...
polly.loop_exit464.us:                            ; preds = %polly.loop_header462.us, %polly.loop_header454.us
  ...
  %polly.loop_cond460.us = icmp ult i64 %polly.indvar458.us, 79
...
polly.loop_header462.preheader.us:                ; preds = %polly.loop_header454.us
  %179 = add nsw i64 %polly.indvar458.us, %157
  %180 = mul i64 %179, 8000
  %181 = add i64 %180, %172
  %scevgep473.us = getelementptr i8, i8* %call2, i64 %181
  ...
  %polly.access.add.Packed_MemRef_call1294480.us = add nsw i64 %173, %polly.access.mul.Packed_MemRef_call1294469.us
...
polly.loop_exit456.loopexit.us:                   ; preds = %polly.loop_exit464.us
  ...
  %exitcond1060.not = icmp eq i64 %polly.indvar_next451.us, %145
  br i1 %exitcond1060.not, label %polly.loop_exit449, label %polly.loop_header447.us

polly.loop_header433:                             ; preds = %polly.loop_header414, %polly.loop_header433
  %polly.indvar437 = phi i64 [ %polly.indvar_next438, %polly.loop_header433 ], [ %162, %polly.loop_header414 ]
  %183 = add nuw nsw i64 %polly.indvar437, %155
  %polly.access.mul.call1441 = mul nsw i64 %183, 1000
  %polly.access.add.call1442 = add nuw nsw i64 %167, %polly.access.mul.call1441
  ...
  %polly.loop_cond439.not.not = icmp slt i64 %polly.indvar437, %163
  br i1 %polly.loop_cond439.not.not, label %polly.loop_header433, label %polly.loop_exit435

polly.start488:                                   ; preds = %init_array.exit
  %malloccall490 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header574:                             ; preds = %polly.loop_exit582, %polly.start488
  ...
  %185 = mul nuw nsw i64 %polly.indvar577, 9600
  %scevgep586 = getelementptr i8, i8* %call, i64 %185
  %min.iters.check1218 = icmp ult i64 %184, 4
  br i1 %min.iters.check1218, label %polly.loop_header580.preheader, label %vector.ph1219

vector.ph1219:                                    ; preds = %polly.loop_header574
  %n.vec1221 = and i64 %184, -4
...
vector.body1217:                                  ; preds = %vector.body1217, %vector.ph1219
  ...
  %186 = shl nuw nsw i64 %index1222, 3
  %187 = getelementptr i8, i8* %scevgep586, i64 %186
  %188 = bitcast i8* %187 to <4 x double>*
  %wide.load1226 = load <4 x double>, <4 x double>* %188, align 8, !alias.scope !88, !noalias !90
  %189 = fmul fast <4 x double> %wide.load1226, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %191 = icmp eq i64 %index.next1223, %n.vec1221
  br i1 %191, label %middle.block1215, label %vector.body1217, !llvm.loop !94

middle.block1215:                                 ; preds = %vector.body1217
  %cmp.n1225 = icmp eq i64 %184, %n.vec1221
  br i1 %cmp.n1225, label %polly.loop_exit582, label %polly.loop_header580.preheader

polly.loop_header580.preheader:                   ; preds = %polly.loop_header574, %middle.block1215
  %polly.indvar583.ph = phi i64 [ 0, %polly.loop_header574 ], [ %n.vec1221, %middle.block1215 ]
  br label %polly.loop_header580

polly.loop_exit582:                               ; preds = %polly.loop_header580, %middle.block1215
  %polly.indvar_next578 = add nuw nsw i64 %polly.indvar577, 1
  %exitcond1092.not = icmp eq i64 %polly.indvar_next578, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond1092.not, label %polly.loop_header590.preheader, label %polly.loop_header574
...
polly.loop_header580:                             ; preds = %polly.loop_header580.preheader, %polly.loop_header580
  ...
  %192 = shl nuw nsw i64 %polly.indvar583, 3
  %scevgep587 = getelementptr i8, i8* %scevgep586, i64 %192
  ...
  %exitcond1091.not = icmp eq i64 %polly.indvar_next584, %polly.indvar577
  br i1 %exitcond1091.not, label %polly.loop_exit582, label %polly.loop_header580, !llvm.loop !95

polly.loop_header590:                             ; preds = %polly.loop_header590.preheader, %polly.loop_exit598
  %indvars.iv1065 = phi i64 [ 0, %polly.loop_header590.preheader ], [ %indvars.iv.next1066, %polly.loop_exit598 ]
  %polly.indvar593 = phi i64 [ 0, %polly.loop_header590.preheader ], [ %polly.indvar_next594, %polly.loop_exit598 ]
  %smin1087 = call i64 @llvm.smin.i64(i64 %indvars.iv1065, i64 -920)
  %193 = add nsw i64 %smin1087, 1000
  %194 = mul nuw nsw i64 %polly.indvar593, 80
...
polly.loop_exit598:                               ; preds = %polly.loop_exit606
  ...
  %exitcond1090.not = icmp eq i64 %polly.indvar_next594, 13
  br i1 %exitcond1090.not, label %polly.exiting489, label %polly.loop_header590

polly.loop_header596:                             ; preds = %polly.loop_exit606, %polly.loop_header590
  %indvars.iv1079 = phi i64 [ %indvars.iv.next1080, %polly.loop_exit606 ], [ 0, %polly.loop_header590 ]
  %indvars.iv1074 = phi i64 [ %indvars.iv.next1075, %polly.loop_exit606 ], [ 4, %polly.loop_header590 ]
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit606 ], [ 0, %polly.loop_header590 ]
  %polly.indvar599 = phi i64 [ %polly.indvar_next600, %polly.loop_exit606 ], [ 0, %polly.loop_header590 ]
  %195 = udiv i64 %indvars.iv1074, 5
  %196 = mul nuw nsw i64 %195, 80
  %197 = shl nuw nsw i64 %polly.indvar599, 1
  %198 = trunc i64 %197 to i8
  %pexp.p_div_q602.lhs.trunc = add i8 %198, 4
  %pexp.p_div_q602891 = udiv i8 %pexp.p_div_q602.lhs.trunc, 5
  %pexp.p_div_q602.zext = zext i8 %pexp.p_div_q602891 to i64
  %199 = sub nsw i64 %197, %pexp.p_div_q602.zext
  %polly.loop_guard607 = icmp slt i64 %199, 15
...
polly.loop_header604.preheader:                   ; preds = %polly.loop_header596
  %200 = sub nsw i64 %indvars.iv1079, %196
  %201 = add i64 %indvars.iv1072, %196
  %202 = mul nsw i64 %polly.indvar599, -128
  %203 = shl nsw i64 %polly.indvar599, 7
...
polly.loop_exit606:                               ; preds = %polly.loop_exit646, %polly.loop_header596
  ...
  %indvars.iv.next1080 = add nuw nsw i64 %indvars.iv1079, 32
  %exitcond1089.not = icmp eq i64 %polly.indvar_next600, 10
  br i1 %exitcond1089.not, label %polly.loop_exit598, label %polly.loop_header596

polly.loop_header604:                             ; preds = %polly.loop_header604.preheader, %polly.loop_exit646
  %indvars.iv1081 = phi i64 [ %200, %polly.loop_header604.preheader ], [ %indvars.iv.next1082, %polly.loop_exit646 ]
  %indvars.iv1076 = phi i64 [ %201, %polly.loop_header604.preheader ], [ %indvars.iv.next1077, %polly.loop_exit646 ]
  %polly.indvar608 = phi i64 [ %199, %polly.loop_header604.preheader ], [ %polly.indvar_next609, %polly.loop_exit646 ]
  %smax1078 = call i64 @llvm.smax.i64(i64 %indvars.iv1076, i64 0)
  %204 = add i64 %smax1078, %indvars.iv1081
  %205 = mul nsw i64 %polly.indvar608, 80
  %206 = add nsw i64 %205, %202
  %207 = add nsw i64 %206, -1
  %.inv890 = icmp sgt i64 %206, 127
  %208 = select i1 %.inv890, i64 127, i64 %207
  %polly.loop_guard621 = icmp sgt i64 %208, -1
  %209 = icmp sgt i64 %206, 0
  %210 = select i1 %209, i64 %206, i64 0
  %211 = add nsw i64 %206, 79
  %polly.loop_guard633.not = icmp sgt i64 %210, %211
...
polly.loop_header611.us:                          ; preds = %polly.loop_header604, %polly.loop_exit632.us
  ...
  %212 = add nuw nsw i64 %polly.indvar614.us, %194
...
polly.loop_header618.us:                          ; preds = %polly.loop_header611.us, %polly.loop_header618.us
  ...
  %213 = add nuw nsw i64 %polly.indvar622.us, %203
  %polly.access.mul.call1626.us = mul nuw nsw i64 %213, 1000
  %polly.access.add.call1627.us = add nuw nsw i64 %212, %polly.access.mul.call1626.us
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar622.us, %208
  br i1 %exitcond1069.not, label %polly.loop_exit620.loopexit.us, label %polly.loop_header618.us

polly.loop_header630.us:                          ; preds = %polly.loop_exit620.loopexit.us, %polly.loop_header630.us
  %polly.indvar634.us = phi i64 [ %polly.indvar_next635.us, %polly.loop_header630.us ], [ %210, %polly.loop_exit620.loopexit.us ]
  %214 = add nuw nsw i64 %polly.indvar634.us, %203
  %polly.access.mul.call1638.us = mul nsw i64 %214, 1000
  %polly.access.add.call1639.us = add nuw nsw i64 %212, %polly.access.mul.call1638.us
  ...
  %polly.loop_cond636.not.not.us = icmp slt i64 %polly.indvar634.us, %211
...
polly.loop_exit632.us:                            ; preds = %polly.loop_header630.us, %polly.loop_exit620.loopexit.us
  ...
  %exitcond1071.not = icmp eq i64 %polly.indvar_next615.us, %193
  br i1 %exitcond1071.not, label %polly.loop_header644.preheader, label %polly.loop_header611.us
...
polly.loop_exit646:                               ; preds = %polly.loop_exit653.loopexit.us, %polly.loop_header644.preheader
  ...
  %polly.loop_cond610 = icmp slt i64 %polly.indvar608, 14
  %indvars.iv.next1077 = add i64 %indvars.iv1076, -80
  %indvars.iv.next1082 = add i64 %indvars.iv1081, 80
...
polly.loop_header611:                             ; preds = %polly.loop_header604.split, %polly.loop_exit632
  ...
  %215 = add nuw nsw i64 %polly.indvar614, %194
...
polly.loop_exit632:                               ; preds = %polly.loop_header630
  ...
  %exitcond1068.not = icmp eq i64 %polly.indvar_next615, %193
  br i1 %exitcond1068.not, label %polly.loop_header644.preheader, label %polly.loop_header611
...
polly.loop_header644.preheader:                   ; preds = %polly.loop_exit632, %polly.loop_exit632.us, %polly.loop_header604.split
  ...
  %polly.loop_guard654 = icmp slt i64 %218, 80
...
polly.loop_header644.us:                          ; preds = %polly.loop_header644.preheader, %polly.loop_exit653.loopexit.us
  ...
  %219 = add nuw nsw i64 %polly.indvar647.us, %194
...
polly.loop_header651.us:                          ; preds = %polly.loop_header644.us, %polly.loop_exit661.us
  %indvars.iv1083 = phi i64 [ %204, %polly.loop_header644.us ], [ %indvars.iv.next1084, %polly.loop_exit661.us ]
  %polly.indvar655.us = phi i64 [ %218, %polly.loop_header644.us ], [ %polly.indvar_next656.us, %polly.loop_exit661.us ]
  %smin1085 = call i64 @llvm.smin.i64(i64 %indvars.iv1083, i64 127)
  %221 = add nsw i64 %polly.indvar655.us, %206
  %polly.loop_guard662.us1129 = icmp sgt i64 %221, -1
  br i1 %polly.loop_guard662.us1129, label %polly.loop_header659.preheader.us, label %polly.loop_exit661.us
...
polly.loop_header659.us:                          ; preds = %polly.loop_header659.preheader.us, %polly.loop_header659.us
  ...
  %222 = add nuw nsw i64 %polly.indvar663.us, %203
  ...
  %scevgep673.us = getelementptr i8, i8* %call2, i64 %224
  ...
  %225 = shl i64 %222, 3
  %226 = add i64 %225, %230
  %scevgep680.us = getelementptr i8, i8* %call, i64 %226
  ...
  %exitcond1086.not = icmp eq i64 %polly.indvar663.us, %smin1085
  br i1 %exitcond1086.not, label %polly.loop_exit661.us, label %polly.loop_header659.us
...
polly.loop_exit661.us:                            ; preds = %polly.loop_header659.us, %polly.loop_header651.us
  ...
  %polly.loop_cond657.us = icmp ult i64 %polly.indvar655.us, 79
...
polly.loop_header659.preheader.us:                ; preds = %polly.loop_header651.us
  %227 = add nsw i64 %polly.indvar655.us, %205
  %228 = mul i64 %227, 8000
  %229 = add i64 %228, %220
  %scevgep670.us = getelementptr i8, i8* %call2, i64 %229
  ...
  %polly.access.add.Packed_MemRef_call1491677.us = add nsw i64 %221, %polly.access.mul.Packed_MemRef_call1491666.us
...
polly.loop_exit653.loopexit.us:                   ; preds = %polly.loop_exit661.us
  ...
  %exitcond1088.not = icmp eq i64 %polly.indvar_next648.us, %193
  br i1 %exitcond1088.not, label %polly.loop_exit646, label %polly.loop_header644.us

polly.loop_header630:                             ; preds = %polly.loop_header611, %polly.loop_header630
  %polly.indvar634 = phi i64 [ %polly.indvar_next635, %polly.loop_header630 ], [ %210, %polly.loop_header611 ]
  %231 = add nuw nsw i64 %polly.indvar634, %203
  %polly.access.mul.call1638 = mul nsw i64 %231, 1000
  ...
  %polly.loop_cond636.not.not = icmp slt i64 %polly.indvar634, %211
...
polly.loop_header809:                             ; preds = %entry, %polly.loop_exit817
  %indvars.iv1117 = phi i64 [ %indvars.iv.next1118, %polly.loop_exit817 ], [ 0, %entry ]
  ...
  %232 = shl nsw i64 %polly.indvar812, 5
  %233 = add nsw i64 %smin1119, 1199
...
polly.loop_exit817:                               ; preds = %polly.loop_exit823
  ...
  %exitcond1122.not = icmp eq i64 %polly.indvar_next813, 38
  br i1 %exitcond1122.not, label %polly.loop_header836, label %polly.loop_header809

polly.loop_header815:                             ; preds = %polly.loop_exit823, %polly.loop_header809
  %indvars.iv1113 = phi i64 [ %indvars.iv.next1114, %polly.loop_exit823 ], [ 0, %polly.loop_header809 ]
  %polly.indvar818 = phi i64 [ %polly.indvar_next819, %polly.loop_exit823 ], [ 0, %polly.loop_header809 ]
  %234 = mul nsw i64 %polly.indvar818, -32
  ...
  %236 = shl nsw i64 %polly.indvar818, 5
  %237 = add nsw i64 %smin1115, 1199
...
polly.loop_exit823:                               ; preds = %polly.loop_exit829
  ...
  %exitcond1121.not = icmp eq i64 %polly.indvar_next819, 38
  br i1 %exitcond1121.not, label %polly.loop_exit817, label %polly.loop_header815
...
polly.loop_header821:                             ; preds = %polly.loop_exit829, %polly.loop_header815
  ...
  %238 = add nuw nsw i64 %polly.indvar824, %232
  %239 = trunc i64 %238 to i32
  %240 = mul nuw nsw i64 %238, 9600
  %min.iters.check = icmp eq i64 %235, 0
  br i1 %min.iters.check, label %polly.loop_header827, label %vector.ph1157

vector.ph1157:                                    ; preds = %polly.loop_header821
  %broadcast.splatinsert1164 = insertelement <4 x i64> poison, i64 %236, i32 0
  %broadcast.splat1165 = shufflevector <4 x i64> %broadcast.splatinsert1164, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1166 = insertelement <4 x i32> poison, i32 %239, i32 0
...
vector.body1156:                                  ; preds = %vector.body1156, %vector.ph1157
  ...
  %241 = add nuw nsw <4 x i64> %vec.ind1162, %broadcast.splat1165
  %242 = trunc <4 x i64> %241 to <4 x i32>
  %243 = mul <4 x i32> %broadcast.splat1167, %242
  ...
  store <4 x double> %247, <4 x double>* %252, align 8, !alias.scope !98, !noalias !100
  %index.next1159 = add i64 %index1158, 4
  %vec.ind.next1163 = add <4 x i64> %vec.ind1162, <i64 4, i64 4, i64 4, i64 4>
  %253 = icmp eq i64 %index.next1159, %235
  br i1 %253, label %polly.loop_exit829, label %vector.body1156, !llvm.loop !103

polly.loop_exit829:                               ; preds = %vector.body1156, %polly.loop_header827
  %polly.indvar_next825 = add nuw nsw i64 %polly.indvar824, 1
  %exitcond1120.not = icmp eq i64 %polly.indvar824, %233
  br i1 %exitcond1120.not, label %polly.loop_exit823, label %polly.loop_header821
...
polly.loop_header827:                             ; preds = %polly.loop_header821, %polly.loop_header827
  ...
  %254 = add nuw nsw i64 %polly.indvar830, %236
  ...
  %scevgep833 = getelementptr i8, i8* %call, i64 %260
  ...
  %exitcond1116.not = icmp eq i64 %polly.indvar830, %237
  br i1 %exitcond1116.not, label %polly.loop_exit829, label %polly.loop_header827, !llvm.loop !104

polly.loop_header836:                             ; preds = %polly.loop_exit817, %polly.loop_exit844
  %indvars.iv1107 = phi i64 [ %indvars.iv.next1108, %polly.loop_exit844 ], [ 0, %polly.loop_exit817 ]
  ...
  %261 = shl nsw i64 %polly.indvar839, 5
  %262 = add nsw i64 %smin1109, 1199
...
polly.loop_exit844:                               ; preds = %polly.loop_exit850
  ...
  %exitcond1112.not = icmp eq i64 %polly.indvar_next840, 38
  br i1 %exitcond1112.not, label %polly.loop_header862, label %polly.loop_header836

polly.loop_header842:                             ; preds = %polly.loop_exit850, %polly.loop_header836
  %indvars.iv1103 = phi i64 [ %indvars.iv.next1104, %polly.loop_exit850 ], [ 0, %polly.loop_header836 ]
  %polly.indvar845 = phi i64 [ %polly.indvar_next846, %polly.loop_exit850 ], [ 0, %polly.loop_header836 ]
  %263 = mul nsw i64 %polly.indvar845, -32
  %smin1171 = call i64 @llvm.smin.i64(i64 %263, i64 -968)
  %264 = add nsw i64 %smin1171, 1000
  %smin1105 = call i64 @llvm.smin.i64(i64 %indvars.iv1103, i64 -968)
  %265 = shl nsw i64 %polly.indvar845, 5
  %266 = add nsw i64 %smin1105, 999
...
polly.loop_exit850:                               ; preds = %polly.loop_exit856
  ...
  %exitcond1111.not = icmp eq i64 %polly.indvar_next846, 32
  br i1 %exitcond1111.not, label %polly.loop_exit844, label %polly.loop_header842
...
polly.loop_header848:                             ; preds = %polly.loop_exit856, %polly.loop_header842
  ...
  %267 = add nuw nsw i64 %polly.indvar851, %261
  %268 = trunc i64 %267 to i32
  %269 = mul nuw nsw i64 %267, 8000
  %min.iters.check1172 = icmp eq i64 %264, 0
  br i1 %min.iters.check1172, label %polly.loop_header854, label %vector.ph1173

vector.ph1173:                                    ; preds = %polly.loop_header848
  %broadcast.splatinsert1182 = insertelement <4 x i64> poison, i64 %265, i32 0
  %broadcast.splat1183 = shufflevector <4 x i64> %broadcast.splatinsert1182, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1184 = insertelement <4 x i32> poison, i32 %268, i32 0
...
vector.body1170:                                  ; preds = %vector.body1170, %vector.ph1173
  ...
  %270 = add nuw nsw <4 x i64> %vec.ind1180, %broadcast.splat1183
  %271 = trunc <4 x i64> %270 to <4 x i32>
  %272 = mul <4 x i32> %broadcast.splat1185, %271
  ...
  store <4 x double> %276, <4 x double>* %281, align 8, !alias.scope !102, !noalias !105
  %index.next1177 = add i64 %index1176, 4
  %vec.ind.next1181 = add <4 x i64> %vec.ind1180, <i64 4, i64 4, i64 4, i64 4>
  %282 = icmp eq i64 %index.next1177, %264
  br i1 %282, label %polly.loop_exit856, label %vector.body1170, !llvm.loop !106

polly.loop_exit856:                               ; preds = %vector.body1170, %polly.loop_header854
  %polly.indvar_next852 = add nuw nsw i64 %polly.indvar851, 1
  %exitcond1110.not = icmp eq i64 %polly.indvar851, %262
  br i1 %exitcond1110.not, label %polly.loop_exit850, label %polly.loop_header848
...
polly.loop_header854:                             ; preds = %polly.loop_header848, %polly.loop_header854
  ...
  %283 = add nuw nsw i64 %polly.indvar857, %265
  ...
  %scevgep860 = getelementptr i8, i8* %call2, i64 %289
  ...
  %exitcond1106.not = icmp eq i64 %polly.indvar857, %266
  br i1 %exitcond1106.not, label %polly.loop_exit856, label %polly.loop_header854, !llvm.loop !107

polly.loop_header862:                             ; preds = %polly.loop_exit844, %polly.loop_exit870
  %indvars.iv1097 = phi i64 [ %indvars.iv.next1098, %polly.loop_exit870 ], [ 0, %polly.loop_exit844 ]
  ...
  %290 = shl nsw i64 %polly.indvar865, 5
  %291 = add nsw i64 %smin1099, 1199
  br label %polly.loop_header868

polly.loop_exit870:                               ; preds = %polly.loop_exit876
  %polly.indvar_next866 = add nuw nsw i64 %polly.indvar865, 1
  %indvars.iv.next1098 = add nsw i64 %indvars.iv1097, -32
  %exitcond1102.not = icmp eq i64 %polly.indvar_next866, 38
  br i1 %exitcond1102.not, label %init_array.exit, label %polly.loop_header862

polly.loop_header868:                             ; preds = %polly.loop_exit876, %polly.loop_header862
  %indvars.iv1093 = phi i64 [ %indvars.iv.next1094, %polly.loop_exit876 ], [ 0, %polly.loop_header862 ]
  %polly.indvar871 = phi i64 [ %polly.indvar_next872, %polly.loop_exit876 ], [ 0, %polly.loop_header862 ]
  %292 = mul nsw i64 %polly.indvar871, -32
  %smin1189 = call i64 @llvm.smin.i64(i64 %292, i64 -968)
  %293 = add nsw i64 %smin1189, 1000
  %smin1095 = call i64 @llvm.smin.i64(i64 %indvars.iv1093, i64 -968)
  %294 = shl nsw i64 %polly.indvar871, 5
  %295 = add nsw i64 %smin1095, 999
...
polly.loop_exit876:                               ; preds = %polly.loop_exit882
  ...
  %exitcond1101.not = icmp eq i64 %polly.indvar_next872, 32
  br i1 %exitcond1101.not, label %polly.loop_exit870, label %polly.loop_header868
...
polly.loop_header874:                             ; preds = %polly.loop_exit882, %polly.loop_header868
  ...
  %296 = add nuw nsw i64 %polly.indvar877, %290
  %297 = trunc i64 %296 to i32
  %298 = mul nuw nsw i64 %296, 8000
  %min.iters.check1190 = icmp eq i64 %293, 0
  br i1 %min.iters.check1190, label %polly.loop_header880, label %vector.ph1191

vector.ph1191:                                    ; preds = %polly.loop_header874
  %broadcast.splatinsert1200 = insertelement <4 x i64> poison, i64 %294, i32 0
  %broadcast.splat1201 = shufflevector <4 x i64> %broadcast.splatinsert1200, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1202 = insertelement <4 x i32> poison, i32 %297, i32 0
...
vector.body1188:                                  ; preds = %vector.body1188, %vector.ph1191
  ...
  %299 = add nuw nsw <4 x i64> %vec.ind1198, %broadcast.splat1201
  %300 = trunc <4 x i64> %299 to <4 x i32>
  %301 = mul <4 x i32> %broadcast.splat1203, %300
  ...
  store <4 x double> %305, <4 x double>* %310, align 8, !alias.scope !101, !noalias !108
  %index.next1195 = add i64 %index1194, 4
  %vec.ind.next1199 = add <4 x i64> %vec.ind1198, <i64 4, i64 4, i64 4, i64 4>
  %311 = icmp eq i64 %index.next1195, %293
  br i1 %311, label %polly.loop_exit882, label %vector.body1188, !llvm.loop !109

polly.loop_exit882:                               ; preds = %vector.body1188, %polly.loop_header880
  %polly.indvar_next878 = add nuw nsw i64 %polly.indvar877, 1
  %exitcond1100.not = icmp eq i64 %polly.indvar877, %291
  br i1 %exitcond1100.not, label %polly.loop_exit876, label %polly.loop_header874
...
polly.loop_header880:                             ; preds = %polly.loop_header874, %polly.loop_header880
  ...
  %312 = add nuw nsw i64 %polly.indvar883, %294
  ...
  %scevgep887 = getelementptr i8, i8* %call1, i64 %318
  ...
  %exitcond1096.not = icmp eq i64 %polly.indvar883, %295
  br i1 %exitcond1096.not, label %polly.loop_exit882, label %polly.loop_header880, !llvm.loop !110
}
