; ModuleID = 'syr2k_exhaustive/mmp_all_SM_843.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_843.c"
...
polly.loop_header200:                             ; preds = %polly.loop_header200.preheader, %polly.loop_exit224
  ...
  %101 = sub i64 %97, %100
  %102 = mul nsw i64 %polly.indvar203, -80
  %103 = add i64 %102, %100
  ...
  %109 = mul nsw i64 %polly.indvar203, -80
  %110 = mul nuw nsw i64 %polly.indvar203, 80
...
polly.loop_exit224:                               ; preds = %polly.loop_exit261
  ...
  %indvars.iv.next1073 = add nsw i64 %indvars.iv1072, -80
  %exitcond1080.not = icmp eq i64 %polly.indvar_next204, 15
...
polly.loop_exit261:                               ; preds = %polly.loop_exit268, %polly.loop_header259.preheader
  ...
  %polly.loop_cond227 = icmp ult i64 %polly.indvar225, 18
  %indvars.iv.next1071 = add i64 %indvars.iv1070, -64
...
polly.loop_header266:                             ; preds = %polly.loop_header259, %polly.loop_exit276
  ...
  %smin1380 = call i64 @llvm.smin.i64(i64 %138, i64 79)
  %139 = add nsw i64 %smin1380, 1
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1076, i64 79)
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit431
  ...
  %172 = mul nuw nsw i64 %polly.indvar409, 80
  %173 = lshr i64 %polly.indvar409, 2
  %174 = add nuw i64 %polly.indvar409, %173
  %175 = shl nuw nsw i64 %174, 6
  %176 = sub i64 %172, %175
  %177 = mul nsw i64 %polly.indvar409, -80
  %178 = add i64 %177, %175
  %179 = lshr i64 %polly.indvar409, 2
  %180 = add nuw i64 %polly.indvar409, %179
  %181 = shl nuw nsw i64 %180, 6
  %182 = sub i64 %indvars.iv1090, %181
  %183 = add i64 %indvars.iv1095, %181
  %184 = mul nsw i64 %polly.indvar409, -80
  %185 = mul nuw nsw i64 %polly.indvar409, 80
...
polly.loop_exit431:                               ; preds = %polly.loop_exit470
  ...
  %exitcond1104.not = icmp eq i64 %polly.indvar_next410, 15
...
polly.loop_exit470:                               ; preds = %polly.loop_exit477, %polly.loop_header468.preheader
  ...
  %polly.loop_cond434 = icmp ult i64 %polly.indvar432, 18
  %indvars.iv.next1093 = add i64 %indvars.iv1092, -64
...
polly.loop_header468.preheader:                   ; preds = %polly.loop_exit456, %polly.loop_exit456.us, %polly.loop_header429.split
  ...
  %208 = mul nsw i64 %polly.indvar432, -64
...
polly.loop_header475:                             ; preds = %polly.loop_header468, %polly.loop_exit485
  ...
  %smin1330 = call i64 @llvm.smin.i64(i64 %213, i64 79)
  %214 = add nsw i64 %smin1330, 1
  %smin1101 = call i64 @llvm.smin.i64(i64 %indvars.iv1099, i64 79)
...
polly.loop_header615:                             ; preds = %polly.loop_header615.preheader, %polly.loop_exit640
  ...
  %247 = mul nuw nsw i64 %polly.indvar618, 80
  %248 = lshr i64 %polly.indvar618, 2
  %249 = add nuw i64 %polly.indvar618, %248
  %250 = shl nuw nsw i64 %249, 6
  %251 = sub i64 %247, %250
  %252 = mul nsw i64 %polly.indvar618, -80
  %253 = add i64 %252, %250
  %254 = lshr i64 %polly.indvar618, 2
  %255 = add nuw i64 %polly.indvar618, %254
  %256 = shl nuw nsw i64 %255, 6
  %257 = sub i64 %indvars.iv1114, %256
  %258 = add i64 %indvars.iv1119, %256
  %259 = mul nsw i64 %polly.indvar618, -80
  %260 = mul nuw nsw i64 %polly.indvar618, 80
...
polly.loop_exit640:                               ; preds = %polly.loop_exit679
  ...
  %exitcond1128.not = icmp eq i64 %polly.indvar_next619, 15
...
polly.loop_exit679:                               ; preds = %polly.loop_exit686, %polly.loop_header677.preheader
  ...
  %polly.loop_cond643 = icmp ult i64 %polly.indvar641, 18
  %indvars.iv.next1117 = add i64 %indvars.iv1116, -64
  %indvars.iv.next1122 = add i64 %indvars.iv1121, 64
...
polly.loop_header684:                             ; preds = %polly.loop_header677, %polly.loop_exit694
  ...
  %smin1280 = call i64 @llvm.smin.i64(i64 %288, i64 79)
  %289 = add nsw i64 %smin1280, 1
  %smin1125 = call i64 @llvm.smin.i64(i64 %indvars.iv1123, i64 79)
