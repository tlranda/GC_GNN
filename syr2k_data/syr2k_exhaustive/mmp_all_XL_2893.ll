; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2893.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2893.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit242
  ...
  %exitcond1014.not = icmp eq i64 %106, 300
...
polly.loop_header205:                             ; preds = %polly.loop_exit242, %polly.loop_header199
  ...
  %108 = shl nuw nsw i64 %polly.indvar208, 1
...
polly.loop_exit242:                               ; preds = %polly.loop_exit249.loopexit.us, %polly.loop_header240.preheader
  ...
  %indvars.iv.next1004 = add i64 %indvars.iv1003, -8
  %indvars.iv.next1008 = add i64 %indvars.iv1007, 8
  %exitcond1013.not = icmp eq i64 %polly.indvar_next209, 150
...
polly.loop_header240.preheader:                   ; preds = %polly.loop_exit229, %polly.loop_exit229.us, %polly.loop_header205.split
  ...
  %polly.loop_guard250 = icmp slt i64 %117, 8
...
polly.loop_header247.us:                          ; preds = %polly.loop_exit257.us, %polly.loop_header240.us
  %indvars.iv1009 = phi i64 [ %indvars.iv.next1010, %polly.loop_exit257.us ], [ %107, %polly.loop_header240.us ]
...
polly.loop_exit257.us:                            ; preds = %polly.loop_header255.us, %polly.loop_header247.us
  ...
  %polly.loop_cond253.us = icmp ult i64 %polly.indvar251.us, 7
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit394
  ...
  %137 = lshr i64 %polly.indvar388, 1
  %138 = shl nuw nsw i64 %137, 3
  %139 = sub nsw i64 %indvars.iv1020, %138
  %140 = add i64 %indvars.iv1025, %138
...
polly.loop_exit394:                               ; preds = %polly.loop_exit435
  ...
  %exitcond1035.not = icmp eq i64 %146, 300
...
polly.loop_header392:                             ; preds = %polly.loop_exit435, %polly.loop_header385
  %indvars.iv1027 = phi i64 [ %indvars.iv.next1028, %polly.loop_exit435 ], [ %140, %polly.loop_header385 ]
  %indvars.iv1022 = phi i64 [ %indvars.iv.next1023, %polly.loop_exit435 ], [ %139, %polly.loop_header385 ]
  %polly.indvar395 = phi i64 [ %polly.indvar_next396, %polly.loop_exit435 ], [ %137, %polly.loop_header385 ]
  %smax1024 = call i64 @llvm.smax.i64(i64 %indvars.iv1022, i64 0)
  %147 = add i64 %smax1024, %indvars.iv1027
  %148 = shl nuw nsw i64 %polly.indvar395, 1
  %.not.not873 = icmp ugt i64 %148, %polly.indvar388
  %149 = shl nsw i64 %polly.indvar395, 3
  %150 = add nsw i64 %149, %142
  %151 = icmp sgt i64 %150, 0
  %152 = select i1 %151, i64 %150, i64 0
  %153 = add nsw i64 %150, 7
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442.loopexit.us, %polly.loop_header433.preheader
  ...
  %indvars.iv.next1028 = add i64 %indvars.iv1027, 8
  %exitcond1034.not = icmp eq i64 %polly.indvar_next396, 150
...
polly.loop_header433.preheader:                   ; preds = %polly.loop_exit421, %polly.loop_exit421.us, %polly.loop_header392.split
  ...
  %polly.loop_guard443 = icmp slt i64 %157, 8
...
polly.loop_header440.us:                          ; preds = %polly.loop_exit450.us, %polly.loop_header433.us
  %indvars.iv1029 = phi i64 [ %indvars.iv.next1030, %polly.loop_exit450.us ], [ %147, %polly.loop_header433.us ]
...
polly.loop_exit450.us:                            ; preds = %polly.loop_header448.us, %polly.loop_header440.us
  ...
  %polly.loop_cond446.us = icmp ult i64 %polly.indvar444.us, 7
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  ...
  %177 = lshr i64 %polly.indvar581, 1
  %178 = shl nuw nsw i64 %177, 3
  %179 = sub nsw i64 %indvars.iv1041, %178
  %180 = add i64 %indvars.iv1046, %178
...
polly.loop_header585:                             ; preds = %polly.loop_exit628, %polly.loop_header578
  %indvars.iv1048 = phi i64 [ %indvars.iv.next1049, %polly.loop_exit628 ], [ %180, %polly.loop_header578 ]
  %indvars.iv1043 = phi i64 [ %indvars.iv.next1044, %polly.loop_exit628 ], [ %179, %polly.loop_header578 ]
  %polly.indvar588 = phi i64 [ %polly.indvar_next589, %polly.loop_exit628 ], [ %177, %polly.loop_header578 ]
  %smax1045 = call i64 @llvm.smax.i64(i64 %indvars.iv1043, i64 0)
  %187 = add i64 %smax1045, %indvars.iv1048
  %188 = shl nuw nsw i64 %polly.indvar588, 1
  %.not.not874 = icmp ugt i64 %188, %polly.indvar581
  %189 = shl nsw i64 %polly.indvar588, 3
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635.loopexit.us, %polly.loop_header626.preheader
  ...
  %indvars.iv.next1044 = add i64 %indvars.iv1043, -8
  %indvars.iv.next1049 = add i64 %indvars.iv1048, 8
  %exitcond1055.not = icmp eq i64 %polly.indvar_next589, 150
...
polly.loop_header626.preheader:                   ; preds = %polly.loop_exit614, %polly.loop_exit614.us, %polly.loop_header585.split
  ...
  %polly.loop_guard636 = icmp slt i64 %197, 8
...
polly.loop_header633.us:                          ; preds = %polly.loop_exit643.us, %polly.loop_header626.us
  %indvars.iv1050 = phi i64 [ %indvars.iv.next1051, %polly.loop_exit643.us ], [ %187, %polly.loop_header626.us ]
...
polly.loop_exit643.us:                            ; preds = %polly.loop_header641.us, %polly.loop_header633.us
  ...
  %polly.loop_cond639.us = icmp ult i64 %polly.indvar637.us, 7
