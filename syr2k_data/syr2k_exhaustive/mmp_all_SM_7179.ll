; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7179.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7179.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %104 = mul nuw nsw i64 %polly.indvar230, 80
...
polly.loop_header233:                             ; preds = %polly.loop_header233.preheader, %polly.loop_exit241
  ...
  %polly.loop_guard249934 = icmp sgt i64 %110, -1
...
vector.body1043:                                  ; preds = %vector.body1043, %vector.ph1047
  ...
  %124 = shl nuw nsw i64 %index1050, 3
  %125 = getelementptr i8, i8* %scevgep370, i64 %124
  %126 = bitcast i8* %125 to <4 x double>*
  %wide.load1054 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !74, !noalias !76
  %127 = fmul fast <4 x double> %wide.load1054, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %129 = icmp eq i64 %index.next1051, %n.vec1049
  br i1 %129, label %middle.block1041, label %vector.body1043, !llvm.loop !80

middle.block1041:                                 ; preds = %vector.body1043
  %cmp.n1053 = icmp eq i64 %122, %n.vec1049
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %131 = udiv i64 %indvars.iv869, 5
  %umin871 = call i64 @llvm.umin.i64(i64 %131, i64 14)
  %132 = mul nsw i64 %polly.indvar393, -32
  %133 = icmp slt i64 %132, -1168
  %134 = select i1 %133, i64 %132, i64 -1168
  %135 = add nsw i64 %134, 1199
  %136 = shl nsw i64 %polly.indvar393, 5
...
polly.loop_exit405:                               ; preds = %polly.loop_exit412
  ...
  %exitcond873.not = icmp eq i64 %polly.indvar_next400, 50
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %138 = mul nuw nsw i64 %polly.indvar406, 80
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit419
  ...
  %polly.loop_guard427935 = icmp sgt i64 %144, -1
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1020 = icmp ult i64 %156, 4
...
vector.body1019:                                  ; preds = %vector.body1019, %vector.ph1021
  ...
  %158 = shl nuw nsw i64 %index1024, 3
  %159 = getelementptr i8, i8* %scevgep548, i64 %158
  %160 = bitcast i8* %159 to <4 x double>*
  %wide.load1028 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !84, !noalias !86
  %161 = fmul fast <4 x double> %wide.load1028, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %163 = icmp eq i64 %index.next1025, %n.vec1023
  br i1 %163, label %middle.block1017, label %vector.body1019, !llvm.loop !90

middle.block1017:                                 ; preds = %vector.body1019
  %cmp.n1027 = icmp eq i64 %156, %n.vec1023
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  %indvars.iv893 = phi i64 [ %indvars.iv.next894, %polly.loop_exit576 ], [ 1, %polly.loop_exit560 ]
  ...
  %165 = udiv i64 %indvars.iv893, 5
  %umin895 = call i64 @llvm.umin.i64(i64 %165, i64 14)
  %166 = mul nsw i64 %polly.indvar571, -32
  %167 = icmp slt i64 %166, -1168
  %168 = select i1 %167, i64 %166, i64 -1168
  %169 = add nsw i64 %168, 1199
  %170 = shl nsw i64 %polly.indvar571, 5
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583
  ...
  %indvars.iv.next894 = add nuw nsw i64 %indvars.iv893, 2
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590
  ...
  %exitcond897.not = icmp eq i64 %polly.indvar_next578, 50
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %172 = mul nuw nsw i64 %polly.indvar584, 80
...
polly.loop_header588:                             ; preds = %polly.loop_header588.preheader, %polly.loop_exit597
  %indvars.iv888 = phi i64 [ %176, %polly.loop_header588.preheader ], [ %indvars.iv.next889, %polly.loop_exit597 ]
  %polly.indvar592 = phi i64 [ %175, %polly.loop_header588.preheader ], [ %polly.indvar_next593, %polly.loop_exit597 ]
  %smin890 = call i64 @llvm.smin.i64(i64 %indvars.iv888, i64 79)
  %178 = add nsw i64 %polly.indvar592, %177
  %polly.loop_guard605936 = icmp sgt i64 %178, -1
...
polly.loop_exit604.loopexit.us:                   ; preds = %polly.loop_header602.us
  ...
  %exitcond892.not = icmp eq i64 %polly.indvar_next599.us, 20
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin958 = call i64 @llvm.smin.i64(i64 %192, i64 -1168)
  %193 = add nsw i64 %smin958, 1200
  %smin925 = call i64 @llvm.smin.i64(i64 %indvars.iv923, i64 -1168)
  %194 = shl nsw i64 %polly.indvar761, 5
  %195 = add nsw i64 %smin925, 1199
...
vector.ph959:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert966 = insertelement <4 x i64> poison, i64 %194, i32 0
  %broadcast.splat967 = shufflevector <4 x i64> %broadcast.splatinsert966, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert968 = insertelement <4 x i32> poison, i32 %197, i32 0
...
vector.body957:                                   ; preds = %vector.body957, %vector.ph959
  ...
  %199 = add nuw nsw <4 x i64> %vec.ind964, %broadcast.splat967
  %200 = trunc <4 x i64> %199 to <4 x i32>
  %201 = mul <4 x i32> %broadcast.splat969, %200
  ...
  %211 = icmp eq i64 %index.next961, %193
  br i1 %211, label %polly.loop_exit772, label %vector.body957, !llvm.loop !99

polly.loop_exit772:                               ; preds = %vector.body957, %polly.loop_header770
  %polly.indvar_next768 = add nuw nsw i64 %polly.indvar767, 1
  %exitcond930.not = icmp eq i64 %polly.indvar767, %191
...
polly.loop_header770:                             ; preds = %polly.loop_header764, %polly.loop_header770
  ...
  %exitcond926.not = icmp eq i64 %polly.indvar773, %195
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin973 = call i64 @llvm.smin.i64(i64 %221, i64 -968)
  %222 = add nsw i64 %smin973, 1000
  %smin915 = call i64 @llvm.smin.i64(i64 %indvars.iv913, i64 -968)
  %223 = shl nsw i64 %polly.indvar788, 5
  %224 = add nsw i64 %smin915, 999
...
vector.body972:                                   ; preds = %vector.body972, %vector.ph975
  ...
  %228 = add nuw nsw <4 x i64> %vec.ind982, %broadcast.splat985
  %229 = trunc <4 x i64> %228 to <4 x i32>
  %230 = mul <4 x i32> %broadcast.splat987, %229
  ...
  %240 = icmp eq i64 %index.next979, %222
  br i1 %240, label %polly.loop_exit799, label %vector.body972, !llvm.loop !102

polly.loop_exit799:                               ; preds = %vector.body972, %polly.loop_header797
  %polly.indvar_next795 = add nuw nsw i64 %polly.indvar794, 1
  %exitcond920.not = icmp eq i64 %polly.indvar794, %220
...
polly.loop_header797:                             ; preds = %polly.loop_header791, %polly.loop_header797
  ...
  %exitcond916.not = icmp eq i64 %polly.indvar800, %224
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin991 = call i64 @llvm.smin.i64(i64 %250, i64 -968)
  %251 = add nsw i64 %smin991, 1000
  %smin905 = call i64 @llvm.smin.i64(i64 %indvars.iv903, i64 -968)
  %252 = shl nsw i64 %polly.indvar814, 5
  %253 = add nsw i64 %smin905, 999
...
vector.body990:                                   ; preds = %vector.body990, %vector.ph993
  ...
  %257 = add nuw nsw <4 x i64> %vec.ind1000, %broadcast.splat1003
  %258 = trunc <4 x i64> %257 to <4 x i32>
  %259 = mul <4 x i32> %broadcast.splat1005, %258
  ...
  %269 = icmp eq i64 %index.next997, %251
  br i1 %269, label %polly.loop_exit825, label %vector.body990, !llvm.loop !105

polly.loop_exit825:                               ; preds = %vector.body990, %polly.loop_header823
  %polly.indvar_next821 = add nuw nsw i64 %polly.indvar820, 1
  %exitcond910.not = icmp eq i64 %polly.indvar820, %249
...
polly.loop_header823:                             ; preds = %polly.loop_header817, %polly.loop_header823
  ...
  %exitcond906.not = icmp eq i64 %polly.indvar826, %253
