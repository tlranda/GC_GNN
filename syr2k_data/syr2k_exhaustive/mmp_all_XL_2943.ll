; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2943.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2943.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %.inv = icmp ugt i64 %102, 63
  %104 = select i1 %.inv, i64 63, i64 %103
...
polly.loop_header254:                             ; preds = %polly.loop_exit262, %polly.loop_header248
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv900, i64 63)
...
polly.loop_header393:                             ; preds = %polly.loop_exit401, %polly.loop_header387
  ...
  %134 = mul nsw i64 %polly.indvar396, -64
...
polly.loop_header399:                             ; preds = %polly.loop_exit440, %polly.loop_header393
  ...
  %.inv869 = icmp ugt i64 %137, 63
  %139 = select i1 %.inv869, i64 63, i64 %138
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header577
  ...
  %169 = mul nsw i64 %polly.indvar586, -64
  %170 = shl nsw i64 %polly.indvar586, 6
...
polly.loop_header589:                             ; preds = %polly.loop_exit630, %polly.loop_header583
  ...
  %.inv870 = icmp ugt i64 %172, 63
  %174 = select i1 %.inv870, i64 63, i64 %173
...
polly.loop_header634:                             ; preds = %polly.loop_exit642, %polly.loop_header628
  ...
  %smin933 = call i64 @llvm.smin.i64(i64 %indvars.iv931, i64 63)
