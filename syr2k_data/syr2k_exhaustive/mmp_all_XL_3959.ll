; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3959.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3959.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit250
  ...
  %exitcond1015.not = icmp eq i64 %polly.indvar_next209, 5
...
polly.loop_header211:                             ; preds = %polly.loop_exit250, %polly.loop_header205
  ...
  %104 = shl nsw i64 %polly.indvar214, 7
...
polly.loop_exit250:                               ; preds = %polly.loop_exit257.loopexit.us, %polly.loop_header248.preheader
  ...
  %indvars.iv.next1001 = add nuw nsw i64 %indvars.iv1000, 128
  %indvars.iv.next1009 = add nsw i64 %indvars.iv1008, -128
  %exitcond1014.not = icmp eq i64 %polly.indvar_next215, 10
...
polly.loop_header255.us:                          ; preds = %polly.loop_header248.us, %polly.loop_exit264.us
  ...
  %smin1004 = call i64 @llvm.smin.i64(i64 %indvars.iv1002, i64 255)
...
polly.loop_header395:                             ; preds = %polly.loop_exit403, %polly.loop_header389
  ...
  %141 = mul nsw i64 %polly.indvar398, -256
  %142 = shl nsw i64 %polly.indvar398, 8
...
polly.loop_exit403:                               ; preds = %polly.loop_exit442
  ...
  %indvars.iv.next1033 = add nsw i64 %indvars.iv1032, -256
  %exitcond1042.not = icmp eq i64 %polly.indvar_next399, 5
...
polly.loop_header401:                             ; preds = %polly.loop_exit442, %polly.loop_header395
  ...
  %smin1036 = call i64 @llvm.smin.i64(i64 %indvars.iv1034, i64 -1072)
  %144 = add nsw i64 %smin1036, 1199
  %smax1037 = call i64 @llvm.smax.i64(i64 %144, i64 0)
  %145 = shl nsw i64 %polly.indvar404, 7
  %146 = add nsw i64 %145, %141
  %147 = add nsw i64 %146, -1
  %.inv875 = icmp ugt i64 %146, 255
  %148 = select i1 %.inv875, i64 255, i64 %147
...
polly.loop_exit442:                               ; preds = %polly.loop_exit449.loopexit.us, %polly.loop_header440.preheader
  ...
  %exitcond1041.not = icmp eq i64 %polly.indvar_next405, 10
...
polly.loop_header440.preheader:                   ; preds = %polly.loop_exit428, %polly.loop_exit428.us, %polly.loop_header401.split
  %156 = mul nsw i64 %polly.indvar404, -128
...
polly.loop_header447.us:                          ; preds = %polly.loop_header440.us, %polly.loop_exit456.us
  ...
  %smin1030 = call i64 @llvm.smin.i64(i64 %indvars.iv1028, i64 255)
...
polly.loop_header587:                             ; preds = %polly.loop_exit595, %polly.loop_header581
  ...
  %182 = mul nsw i64 %polly.indvar590, -256
  %183 = shl nsw i64 %polly.indvar590, 8
...
polly.loop_exit595:                               ; preds = %polly.loop_exit634
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next591, 5
...
polly.loop_header593:                             ; preds = %polly.loop_exit634, %polly.loop_header587
  ...
  %smin1063 = call i64 @llvm.smin.i64(i64 %indvars.iv1061, i64 -1072)
  ...
  %.inv876 = icmp ugt i64 %187, 255
  %189 = select i1 %.inv876, i64 255, i64 %188
...
polly.loop_exit634:                               ; preds = %polly.loop_exit641.loopexit.us, %polly.loop_header632.preheader
  ...
  %indvars.iv.next1054 = add nuw nsw i64 %indvars.iv1053, 128
  %indvars.iv.next1062 = add nsw i64 %indvars.iv1061, -128
  %exitcond1068.not = icmp eq i64 %polly.indvar_next597, 10
...
polly.loop_header632.preheader:                   ; preds = %polly.loop_exit620, %polly.loop_exit620.us, %polly.loop_header593.split
  %197 = mul nsw i64 %polly.indvar596, -128
