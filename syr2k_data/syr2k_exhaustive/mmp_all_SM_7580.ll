; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7580.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7580.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv847 = phi i64 [ %indvars.iv.next848, %polly.loop_exit223 ], [ 10, %polly.loop_exit207 ]
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next848 = add nuw nsw i64 %indvars.iv847, 10
  %exitcond851.not = icmp eq i64 %polly.indvar_next219, 15
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %101 = shl nsw i64 %polly.indvar230, 3
...
vector.body1048:                                  ; preds = %vector.body1048, %vector.ph1052
  ...
  %wide.load1059 = load <4 x double>, <4 x double>* %123, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %126, label %middle.block1046, label %vector.body1048, !llvm.loop !79
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  %indvars.iv873 = phi i64 [ %indvars.iv.next874, %polly.loop_exit398 ], [ 10, %polly.loop_exit382 ]
  ...
  %128 = mul nsw i64 %polly.indvar393, -80
  %129 = mul nuw nsw i64 %polly.indvar393, 80
  br label %polly.loop_header396

polly.loop_exit398:                               ; preds = %polly.loop_exit404
  %polly.indvar_next394 = add nuw nsw i64 %polly.indvar393, 1
  %indvars.iv.next857 = add nsw i64 %indvars.iv856, -80
  %indvars.iv.next862 = add nuw nsw i64 %indvars.iv861, 80
  %indvars.iv.next874 = add nuw nsw i64 %indvars.iv873, 10
  %exitcond877.not = icmp eq i64 %polly.indvar_next394, 15
...
polly.loop_header396:                             ; preds = %polly.loop_exit404, %polly.loop_header390
  ...
  %130 = mul nuw nsw i64 %polly.indvar399, 80
...
polly.loop_exit404:                               ; preds = %polly.loop_exit411
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar_next400, 13
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %132 = shl nsw i64 %polly.indvar405, 3
  %133 = add nsw i64 %132, %128
  %134 = icmp sgt i64 %133, 0
  %135 = select i1 %134, i64 %133, i64 0
  %polly.loop_guard412 = icmp slt i64 %135, 80
...
vector.body1024:                                  ; preds = %vector.body1024, %vector.ph1026
  ...
  %wide.load1033 = load <4 x double>, <4 x double>* %154, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %157, label %middle.block1022, label %vector.body1024, !llvm.loop !89
...
polly.loop_header567:                             ; preds = %polly.loop_exit559, %polly.loop_exit575
  %indvars.iv899 = phi i64 [ %indvars.iv.next900, %polly.loop_exit575 ], [ 10, %polly.loop_exit559 ]
  ...
  %159 = mul nsw i64 %polly.indvar570, -80
  %160 = mul nuw nsw i64 %polly.indvar570, 80
...
polly.loop_exit575:                               ; preds = %polly.loop_exit581
  ...
  %indvars.iv.next888 = add nuw nsw i64 %indvars.iv887, 80
  %indvars.iv.next900 = add nuw nsw i64 %indvars.iv899, 10
  %exitcond903.not = icmp eq i64 %polly.indvar_next571, 15
...
polly.loop_header573:                             ; preds = %polly.loop_exit581, %polly.loop_header567
  ...
  %smin897 = call i64 @llvm.smin.i64(i64 %indvars.iv895, i64 -920)
...
polly.loop_exit581:                               ; preds = %polly.loop_exit588
  ...
  %exitcond902.not = icmp eq i64 %polly.indvar_next577, 13
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %163 = shl nsw i64 %polly.indvar582, 3
  %164 = add nsw i64 %163, %159
  %165 = icmp sgt i64 %164, 0
  %166 = select i1 %165, i64 %164, i64 0
  %polly.loop_guard589 = icmp slt i64 %166, 80
...
vector.body962:                                   ; preds = %vector.body962, %vector.ph964
  ...
  br i1 %202, label %polly.loop_exit770, label %vector.body962, !llvm.loop !98
...
vector.body977:                                   ; preds = %vector.body977, %vector.ph980
  ...
  br i1 %231, label %polly.loop_exit797, label %vector.body977, !llvm.loop !101
...
vector.body995:                                   ; preds = %vector.body995, %vector.ph998
  ...
  br i1 %260, label %polly.loop_exit823, label %vector.body995, !llvm.loop !104
