; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7497.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7497.c"
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond829.not = icmp eq i64 %polly.indvar_next219, 19
...
polly.loop_header384:                             ; preds = %polly.loop_exit376, %polly.loop_exit392
  ...
  %smin845 = call i64 @llvm.smin.i64(i64 %indvars.iv843, i64 -1136)
  %119 = shl nsw i64 %polly.indvar387, 6
...
polly.loop_exit392:                               ; preds = %polly.loop_exit398
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar_next388, 19
...
polly.loop_header390:                             ; preds = %polly.loop_exit398, %polly.loop_header384
  ...
  %121 = shl nsw i64 %polly.indvar393, 6
...
polly.loop_header396:                             ; preds = %polly.loop_exit404, %polly.loop_header390
  ...
  %smin840 = call i64 @llvm.smin.i64(i64 %indvars.iv838, i64 63)
...
polly.loop_header555:                             ; preds = %polly.loop_exit547, %polly.loop_exit563
  ...
  %smin866 = call i64 @llvm.smin.i64(i64 %indvars.iv864, i64 -1136)
  %141 = shl nsw i64 %polly.indvar558, 6
...
polly.loop_exit563:                               ; preds = %polly.loop_exit569
  ...
  %indvars.iv.next856 = add nuw nsw i64 %indvars.iv855, 64
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, -64
  %indvars.iv.next869 = add nuw nsw i64 %indvars.iv868, 1
  %exitcond871.not = icmp eq i64 %polly.indvar_next559, 19
...
polly.loop_header561:                             ; preds = %polly.loop_exit569, %polly.loop_header555
  ...
  %143 = shl nsw i64 %polly.indvar564, 6
...
polly.loop_header567:                             ; preds = %polly.loop_exit575, %polly.loop_header561
  ...
  %smin861 = call i64 @llvm.smin.i64(i64 %indvars.iv859, i64 63)
