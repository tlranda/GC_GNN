; ModuleID = 'syr2k_exhaustive/mmp_all_XL_677.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_677.c"
...
vector.body1336:                                  ; preds = %vector.body1336, %vector.ph1338
  ...
  br i1 %57, label %middle.block1334, label %vector.body1336, !llvm.loop !63
...
vector.body1386:                                  ; preds = %vector.body1386, %vector.ph1388
  ...
  br i1 %68, label %middle.block1384, label %vector.body1386, !llvm.loop !65
...
vector.body1398:                                  ; preds = %vector.body1398, %vector.ph1402
  ...
  %wide.load1409 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %95, label %middle.block1396, label %vector.body1398, !llvm.loop !78
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %100 = mul nuw nsw i64 %polly.indvar209, 7
  %101 = udiv i64 %100, 25
  %102 = add nuw i64 %polly.indvar209, %101
  %103 = mul nuw nsw i64 %102, 50
  %104 = sub i64 %99, %103
  %105 = mul nsw i64 %polly.indvar209, -64
  %106 = add i64 %105, %103
  %107 = udiv i64 %indvars.iv1092, 25
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %114 = mul nuw nsw i64 %polly.indvar209, 7
  %pexp.p_div_q = udiv i64 %114, 25
  %115 = add nuw nsw i64 %pexp.p_div_q, %polly.indvar209
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %indvars.iv.next1093 = add nuw nsw i64 %indvars.iv1092, 7
  %indvars.iv.next1097 = add nsw i64 %indvars.iv1096, -64
  %exitcond1106.not = icmp eq i64 %polly.indvar_next210, 19
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us, %polly.loop_header228.split
  ...
  %polly.loop_guard275 = icmp slt i64 %137, 50
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  ...
  %smin1418 = call i64 @llvm.smin.i64(i64 %138, i64 63)
  %139 = add nsw i64 %smin1418, 1
  %smin1102 = call i64 @llvm.smin.i64(i64 %indvars.iv1100, i64 63)
...
polly.loop_header280.us:                          ; preds = %polly.loop_header280.us.preheader, %polly.loop_header280.us
  ...
  br i1 %exitcond1103.not, label %polly.loop_exit282.us, label %polly.loop_header280.us, !llvm.loop !83
...
vector.body1412:                                  ; preds = %vector.body1412, %vector.ph1420
  ...
  %wide.load1433 = load <4 x double>, <4 x double>* %157, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %162, label %middle.block1410, label %vector.body1412, !llvm.loop !84
...
vector.body1348:                                  ; preds = %vector.body1348, %vector.ph1352
  ...
  %wide.load1359 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %171, label %middle.block1346, label %vector.body1348, !llvm.loop !92
...
polly.loop_header402:                             ; preds = %polly.loop_header402.preheader, %polly.loop_header402
  ...
  br i1 %exitcond1141.not, label %polly.loop_exit404, label %polly.loop_header402, !llvm.loop !93
...
polly.loop_header412:                             ; preds = %polly.loop_header412.preheader, %polly.loop_exit420
  ...
  %174 = shl nsw i64 %polly.indvar415, 6
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %175 = shl nuw nsw i64 %polly.indvar421, 6
  %176 = mul nuw nsw i64 %polly.indvar421, 7
  %177 = udiv i64 %176, 25
  %178 = add nuw i64 %polly.indvar421, %177
  %179 = mul nuw nsw i64 %178, 50
  %180 = sub i64 %175, %179
  %181 = mul nsw i64 %polly.indvar421, -64
  %182 = add i64 %181, %179
  %183 = udiv i64 %indvars.iv1124, 25
  %184 = add nuw i64 %polly.indvar421, %183
  %185 = mul nuw nsw i64 %184, 50
  %186 = sub i64 %indvars.iv1122, %185
  %187 = add i64 %indvars.iv1129, %185
  %188 = shl nsw i64 %polly.indvar421, 6
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %189 = mul nsw i64 %polly.indvar421, -64
  %190 = mul nuw nsw i64 %polly.indvar421, 7
  %pexp.p_div_q440 = udiv i64 %190, 25
  %191 = add nuw nsw i64 %pexp.p_div_q440, %polly.indvar421
...
polly.loop_exit443:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1123 = add nuw nsw i64 %indvars.iv1122, 64
  %indvars.iv.next1125 = add nuw nsw i64 %indvars.iv1124, 7
  %indvars.iv.next1130 = add nsw i64 %indvars.iv1129, -64
  %exitcond1139.not = icmp eq i64 %polly.indvar_next422, 19
...
polly.loop_exit482:                               ; preds = %polly.loop_exit489.loopexit.us, %polly.loop_header480.preheader
  ...
  %indvars.iv.next1132 = add i64 %indvars.iv1131, 50
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header441.split
  ...
  %polly.loop_guard490 = icmp slt i64 %213, 50
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1368 = call i64 @llvm.smin.i64(i64 %214, i64 63)
...
polly.loop_header495.us:                          ; preds = %polly.loop_header495.us.preheader, %polly.loop_header495.us
  ...
  br i1 %exitcond1136.not, label %polly.loop_exit497.us, label %polly.loop_header495.us, !llvm.loop !96
...
vector.body1362:                                  ; preds = %vector.body1362, %vector.ph1370
  ...
  %wide.load1383 = load <4 x double>, <4 x double>* %233, align 8, !alias.scope !85, !noalias !87
...
vector.body1300:                                  ; preds = %vector.body1300, %vector.ph1302
  ...
  %wide.load1309 = load <4 x double>, <4 x double>* %244, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %247, label %middle.block1298, label %vector.body1300, !llvm.loop !105
...
polly.loop_header627:                             ; preds = %polly.loop_header627.preheader, %polly.loop_exit635
  ...
  %250 = shl nsw i64 %polly.indvar630, 6
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %251 = shl nuw nsw i64 %polly.indvar636, 6
  %252 = mul nuw nsw i64 %polly.indvar636, 7
  %253 = udiv i64 %252, 25
  %254 = add nuw i64 %polly.indvar636, %253
  %255 = mul nuw nsw i64 %254, 50
  %256 = sub i64 %251, %255
  %257 = mul nsw i64 %polly.indvar636, -64
  %258 = add i64 %257, %255
  %259 = udiv i64 %indvars.iv1157, 25
  %260 = add nuw i64 %polly.indvar636, %259
  %261 = mul nuw nsw i64 %260, 50
  %262 = sub i64 %indvars.iv1155, %261
  %263 = add i64 %indvars.iv1162, %261
  %264 = shl nsw i64 %polly.indvar636, 6
  br label %polly.loop_header639

polly.loop_exit641:                               ; preds = %polly.loop_exit647
  %265 = mul nsw i64 %polly.indvar636, -64
  %266 = mul nuw nsw i64 %polly.indvar636, 7
  %pexp.p_div_q655 = udiv i64 %266, 25
  %267 = add nuw nsw i64 %pexp.p_div_q655, %polly.indvar636
...
polly.loop_exit658:                               ; preds = %polly.loop_exit697
  ...
  %indvars.iv.next1156 = add nuw nsw i64 %indvars.iv1155, 64
  %indvars.iv.next1158 = add nuw nsw i64 %indvars.iv1157, 7
  %indvars.iv.next1163 = add nsw i64 %indvars.iv1162, -64
  %exitcond1172.not = icmp eq i64 %polly.indvar_next637, 19
...
polly.loop_exit697:                               ; preds = %polly.loop_exit704.loopexit.us, %polly.loop_header695.preheader
  ...
  %indvars.iv.next1160 = add i64 %indvars.iv1159, -50
  %indvars.iv.next1165 = add i64 %indvars.iv1164, 50
...
polly.loop_header695.preheader:                   ; preds = %polly.loop_exit683, %polly.loop_exit683.us, %polly.loop_header656.split
  ...
  %polly.loop_guard705 = icmp slt i64 %289, 50
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  ...
  %smin1318 = call i64 @llvm.smin.i64(i64 %290, i64 63)
  %291 = add nsw i64 %smin1318, 1
  %smin1168 = call i64 @llvm.smin.i64(i64 %indvars.iv1166, i64 63)
...
polly.loop_header710.us:                          ; preds = %polly.loop_header710.us.preheader, %polly.loop_header710.us
  ...
  br i1 %exitcond1169.not, label %polly.loop_exit712.us, label %polly.loop_header710.us, !llvm.loop !109
...
vector.body1312:                                  ; preds = %vector.body1312, %vector.ph1320
  ...
  %wide.load1333 = load <4 x double>, <4 x double>* %309, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %314, label %middle.block1310, label %vector.body1312, !llvm.loop !110
...
vector.body1239:                                  ; preds = %vector.body1239, %vector.ph1240
  ...
  br i1 %337, label %polly.loop_exit882, label %vector.body1239, !llvm.loop !116
...
vector.body1253:                                  ; preds = %vector.body1253, %vector.ph1256
  ...
  br i1 %366, label %polly.loop_exit909, label %vector.body1253, !llvm.loop !119
...
vector.body1271:                                  ; preds = %vector.body1271, %vector.ph1274
  ...
  br i1 %395, label %polly.loop_exit935, label %vector.body1271, !llvm.loop !122
