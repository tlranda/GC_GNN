; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7979.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7979.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv832 = phi i64 [ %indvars.iv.next833, %polly.loop_exit223 ], [ 1, %polly.loop_exit207 ]
  %indvars.iv825 = phi i64 [ %indvars.iv.next826, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %indvars.iv = phi i64 [ %indvars.iv.next, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %polly.indvar218 = phi i64 [ %polly.indvar_next219, %polly.loop_exit223 ], [ 0, %polly.loop_exit207 ]
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv832, i64 18)
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 63)
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit394
  %indvars.iv854 = phi i64 [ %indvars.iv.next855, %polly.loop_exit394 ], [ 1, %polly.loop_exit378 ]
  ...
  %umin856 = call i64 @llvm.umin.i64(i64 %indvars.iv854, i64 18)
...
polly.loop_header392:                             ; preds = %polly.loop_exit401, %polly.loop_header386
  ...
  %131 = shl nsw i64 %polly.indvar395, 6
...
polly.loop_header559:                             ; preds = %polly.loop_exit551, %polly.loop_exit567
  %indvars.iv877 = phi i64 [ %indvars.iv.next878, %polly.loop_exit567 ], [ 1, %polly.loop_exit551 ]
  ...
  %umin879 = call i64 @llvm.umin.i64(i64 %indvars.iv877, i64 18)
...
polly.loop_header565:                             ; preds = %polly.loop_exit574, %polly.loop_header559
  ...
  %160 = shl nsw i64 %polly.indvar568, 6
