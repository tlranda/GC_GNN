; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3596.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3596.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin972 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -920)
  %97 = add nsw i64 %smin972, 1000
  %98 = mul nsw i64 %polly.indvar202, -80
  %99 = icmp slt i64 %98, -920
  %100 = select i1 %99, i64 %98, i64 -920
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %exitcond989.not = icmp eq i64 %polly.indvar_next203, 13
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %indvars.iv964 = phi i64 [ %indvars.iv.next965, %polly.loop_exit213 ], [ 80, %polly.loop_header199 ]
...
polly.loop_exit213:                               ; preds = %polly.loop_exit269
  ...
  %indvars.iv.next975 = add nuw nsw i64 %indvars.iv974, 16
...
polly.merge.loopexit:                             ; preds = %polly.loop_exit256
  %.pre1099 = mul nuw nsw i64 %polly.indvar214, 80
...
polly.loop_exit269:                               ; preds = %polly.loop_exit275
  ...
  %indvars.iv.next977 = add nsw i64 %indvars.iv976, -80
  %indvars.iv.next981 = add nsw i64 %indvars.iv980, 80
  %exitcond987.not = icmp eq i64 %polly.indvar_next215, 15
...
vector.body1221:                                  ; preds = %vector.body1221, %vector.ph1225
  ...
  %wide.load1232 = load <4 x double>, <4 x double>* %141, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %144, label %middle.block1219, label %vector.body1221, !llvm.loop !84
...
polly.loop_header398:                             ; preds = %polly.loop_header398.preheader, %polly.loop_header398
  ...
  br i1 %exitcond1024.not, label %polly.loop_exit400, label %polly.loop_header398, !llvm.loop !85
...
polly.loop_header408:                             ; preds = %polly.loop_header408.preheader, %polly.loop_exit416
  ...
  %smin1005 = call i64 @llvm.smin.i64(i64 %indvars.iv992, i64 -920)
  %146 = add nsw i64 %smin1005, 1000
  %147 = mul nsw i64 %polly.indvar411, -80
  %148 = icmp slt i64 %147, -920
  %149 = select i1 %148, i64 %147, i64 -920
...
polly.loop_exit416:                               ; preds = %polly.loop_exit422
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next412, 13
...
polly.loop_header414:                             ; preds = %polly.loop_exit422, %polly.loop_header408
  ...
  %indvars.iv997 = phi i64 [ %indvars.iv.next998, %polly.loop_exit422 ], [ 80, %polly.loop_header408 ]
  %polly.indvar417 = phi i64 [ %polly.indvar_next418, %polly.loop_exit422 ], [ 0, %polly.loop_header408 ]
  %152 = mul nuw nsw i64 %polly.indvar417, 3
...
polly.loop_header420:                             ; preds = %polly.loop_exit484, %polly.loop_header414
  ...
  %158 = mul nuw nsw i64 %polly.indvar423, 5
...
polly.merge427.loopexit:                          ; preds = %polly.loop_exit471
  %.pre1097 = mul nuw nsw i64 %polly.indvar423, 80
...
polly.start521:                                   ; preds = %init_array.exit
  %malloccall523 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1199
  ...
  %wide.load1206 = load <4 x double>, <4 x double>* %190, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %193, label %middle.block1195, label %vector.body1197, !llvm.loop !94
...
polly.loop_header613:                             ; preds = %polly.loop_header613.preheader, %polly.loop_header613
  ...
  br i1 %exitcond1058.not, label %polly.loop_exit615, label %polly.loop_header613, !llvm.loop !95
...
polly.loop_header623:                             ; preds = %polly.loop_header623.preheader, %polly.loop_exit631
  ...
  %smin1039 = call i64 @llvm.smin.i64(i64 %indvars.iv1026, i64 -920)
  %195 = add nsw i64 %smin1039, 1000
  %196 = mul nsw i64 %polly.indvar626, -80
  %197 = icmp slt i64 %196, -920
  %198 = select i1 %197, i64 %196, i64 -920
  %199 = mul nuw nsw i64 %polly.indvar626, 80
...
polly.loop_exit631:                               ; preds = %polly.loop_exit637
  ...
  %exitcond1057.not = icmp eq i64 %polly.indvar_next627, 13
...
polly.loop_header629:                             ; preds = %polly.loop_exit637, %polly.loop_header623
  ...
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit637 ], [ 80, %polly.loop_header623 ]
  %polly.indvar632 = phi i64 [ %polly.indvar_next633, %polly.loop_exit637 ], [ 0, %polly.loop_header623 ]
  %201 = mul nuw nsw i64 %polly.indvar632, 3
  %202 = shl nsw i64 %polly.indvar632, 4
  %203 = or i64 %202, 1
...
polly.loop_header635:                             ; preds = %polly.loop_exit699, %polly.loop_header629
  ...
  %207 = mul nuw nsw i64 %polly.indvar638, 5
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1137
  ...
  br i1 %256, label %polly.loop_exit880, label %vector.body1136, !llvm.loop !103
...
polly.loop_header878:                             ; preds = %polly.loop_header872, %polly.loop_header878
  ...
  br i1 %exitcond1083.not, label %polly.loop_exit880, label %polly.loop_header878, !llvm.loop !104
...
vector.body1150:                                  ; preds = %vector.body1150, %vector.ph1153
  ...
  br i1 %285, label %polly.loop_exit907, label %vector.body1150, !llvm.loop !106
...
polly.loop_header905:                             ; preds = %polly.loop_header899, %polly.loop_header905
  ...
  br i1 %exitcond1073.not, label %polly.loop_exit907, label %polly.loop_header905, !llvm.loop !107
...
vector.body1168:                                  ; preds = %vector.body1168, %vector.ph1171
  ...
  br i1 %314, label %polly.loop_exit933, label %vector.body1168, !llvm.loop !109
...
polly.loop_header931:                             ; preds = %polly.loop_header925, %polly.loop_header931
  ...
  br i1 %exitcond1063.not, label %polly.loop_exit933, label %polly.loop_header931, !llvm.loop !110
}
