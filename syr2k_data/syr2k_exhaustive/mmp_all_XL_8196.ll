; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8196.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8196.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond796.not = icmp eq i64 %polly.indvar_next209, 60
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %139 = shl nuw nsw i64 %polly.indvar363, 1
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %exitcond816.not = icmp eq i64 %polly.indvar_next364, 60
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %175 = shl nuw nsw i64 %polly.indvar521, 1
  %176 = add nuw nsw i64 %175, %170
  %177 = mul nuw nsw i64 %polly.indvar521, 20
  %178 = mul nsw i64 %polly.indvar521, -20
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next821 = add nuw nsw i64 %indvars.iv820, 20
  %indvars.iv.next823 = add nuw nsw i64 %indvars.iv822, 2
  %indvars.iv.next828 = add nsw i64 %indvars.iv827, -20
  %exitcond836.not = icmp eq i64 %polly.indvar_next522, 60
