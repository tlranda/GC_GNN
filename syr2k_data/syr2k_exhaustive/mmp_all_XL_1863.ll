; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1863.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1863.c"
...
polly.loop_exit224:                               ; preds = %polly.loop_exit230
  ...
  %indvars.iv.next1035 = add nuw nsw i64 %indvars.iv1034, 32
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %102 = mul nsw i64 %polly.indvar231, -32
  %103 = add i64 %97, %102
  %104 = shl nsw i64 %polly.indvar231, 5
  %105 = sub nsw i64 %98, %104
  %106 = add nuw nsw i64 %104, 32
...
polly.loop_header234:                             ; preds = %polly.loop_exit265, %polly.loop_header228
  ...
  %smin1350 = call i64 @llvm.smin.i64(i64 %107, i64 31)
  %108 = add nsw i64 %smin1350, 1
  %smin1044 = call i64 @llvm.smin.i64(i64 %indvars.iv1038, i64 31)
...
polly.loop_header418:                             ; preds = %polly.loop_exit410, %polly.loop_exit426
  ...
  %147 = shl nsw i64 %polly.indvar421, 5
...
polly.loop_exit426:                               ; preds = %polly.loop_exit432
  ...
  %exitcond1087.not = icmp eq i64 %polly.indvar_next422, 38
...
polly.loop_header430:                             ; preds = %polly.loop_exit438, %polly.loop_header424
  ...
  %151 = mul nsw i64 %polly.indvar433, -32
  %152 = add i64 %146, %151
  %153 = shl nsw i64 %polly.indvar433, 5
  %154 = sub nsw i64 %147, %153
  %155 = add nuw nsw i64 %153, 32
...
polly.loop_header436:                             ; preds = %polly.loop_exit473, %polly.loop_header430
  ...
  %smin1305 = call i64 @llvm.smin.i64(i64 %156, i64 31)
  %157 = add nsw i64 %smin1305, 1
  %smin1075 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 31)
...
polly.loop_header626:                             ; preds = %polly.loop_exit618, %polly.loop_exit634
  ...
  %195 = shl nuw nsw i64 %polly.indvar629, 5
  %smin1112 = call i64 @llvm.smin.i64(i64 %indvars.iv1110, i64 -1168)
  %196 = shl nsw i64 %polly.indvar629, 5
...
polly.loop_exit634:                               ; preds = %polly.loop_exit640
  ...
  %indvars.iv.next1097 = add nuw nsw i64 %indvars.iv1096, 32
  %indvars.iv.next1111 = add nsw i64 %indvars.iv1110, -32
  %indvars.iv.next1115 = add nuw nsw i64 %indvars.iv1114, 1
  %exitcond1118.not = icmp eq i64 %polly.indvar_next630, 38
...
polly.loop_header638:                             ; preds = %polly.loop_exit646, %polly.loop_header632
  ...
  %200 = mul nsw i64 %polly.indvar641, -32
  %201 = add i64 %195, %200
  %202 = shl nsw i64 %polly.indvar641, 5
  %203 = sub nsw i64 %196, %202
  %204 = add nuw nsw i64 %202, 32
...
polly.loop_header644:                             ; preds = %polly.loop_exit681, %polly.loop_header638
  ...
  %smin1260 = call i64 @llvm.smin.i64(i64 %205, i64 31)
  %206 = add nsw i64 %smin1260, 1
  %smin1106 = call i64 @llvm.smin.i64(i64 %indvars.iv1100, i64 31)
