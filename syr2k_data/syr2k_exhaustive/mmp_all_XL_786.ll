; ModuleID = 'syr2k_exhaustive/mmp_all_XL_786.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_786.c"
...
polly.loop_header228:                             ; preds = %polly.loop_exit214, %polly.loop_exit269
  ...
  %116 = mul nsw i64 %indvar1414, -64
  %117 = add i64 %102, %116
  %smax1416 = call i64 @llvm.smax.i64(i64 %117, i64 0)
  %118 = shl nuw nsw i64 %indvar1414, 6
  %119 = add i64 %103, %118
...
polly.loop_header274:                             ; preds = %polly.loop_header267, %polly.loop_exit284
  ...
  %smin1419 = call i64 @llvm.smin.i64(i64 %143, i64 49)
...
vector.body1413:                                  ; preds = %vector.body1413, %vector.ph1421
  ...
  %wide.load1434 = load <4 x double>, <4 x double>* %159, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %164, label %middle.block1411, label %vector.body1413, !llvm.loop !83
...
vector.body1349:                                  ; preds = %vector.body1349, %vector.ph1353
  ...
  %wide.load1360 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %175, label %middle.block1347, label %vector.body1349, !llvm.loop !92
...
polly.loop_header420:                             ; preds = %polly.loop_exit446, %polly.loop_header414
  ...
  %178 = mul nsw i64 %polly.indvar423, -14
  %179 = mul nuw nsw i64 %polly.indvar423, 14
  %180 = add nuw i64 %179, 62
  %181 = and i64 %180, -64
  %182 = add i64 %178, %181
  %183 = sub i64 %179, %181
  %184 = shl nuw nsw i64 %indvars.iv1125, 1
  %185 = and i64 %184, 9223372036854775744
  %186 = add i64 %indvars.iv1123, %185
  %187 = sub nsw i64 %indvars.iv1130, %185
  %188 = mul nsw i64 %polly.indvar423, -50
  %189 = mul nuw nsw i64 %polly.indvar423, 50
  br label %polly.loop_header426

polly.loop_exit428:                               ; preds = %polly.loop_exit434
  %190 = add nsw i64 %188, 1199
  %191 = mul nuw nsw i64 %polly.indvar423, 7
  %192 = add nuw nsw i64 %191, 31
  %pexp.p_div_q442 = lshr i64 %192, 5
  %193 = sub nsw i64 %polly.indvar423, %pexp.p_div_q442
  %polly.loop_guard447 = icmp slt i64 %193, 19
...
polly.loop_header484.preheader:                   ; preds = %polly.loop_exit472, %polly.loop_exit472.us, %polly.loop_header444.split
  ...
  %218 = mul nsw i64 %polly.indvar448, -64
...
polly.loop_header491:                             ; preds = %polly.loop_header484, %polly.loop_exit501
  ...
  %smin1369 = call i64 @llvm.smin.i64(i64 %223, i64 49)
...
vector.body1363:                                  ; preds = %vector.body1363, %vector.ph1371
  ...
  %wide.load1384 = load <4 x double>, <4 x double>* %239, align 8, !alias.scope !85, !noalias !87
  ...
  br i1 %244, label %middle.block1361, label %vector.body1363, !llvm.loop !96
...
vector.body1301:                                  ; preds = %vector.body1301, %vector.ph1303
  ...
  %wide.load1310 = load <4 x double>, <4 x double>* %252, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %255, label %middle.block1299, label %vector.body1301, !llvm.loop !105
...
polly.loop_header637:                             ; preds = %polly.loop_exit663, %polly.loop_header631
  ...
  %258 = mul nsw i64 %polly.indvar640, -14
  %259 = mul nuw nsw i64 %polly.indvar640, 14
  %260 = add nuw i64 %259, 62
  %261 = and i64 %260, -64
  %262 = add i64 %258, %261
  %263 = sub i64 %259, %261
  %264 = shl nuw nsw i64 %indvars.iv1152, 1
  %265 = and i64 %264, 9223372036854775744
  %266 = add i64 %indvars.iv1150, %265
  %267 = sub nsw i64 %indvars.iv1157, %265
  %268 = mul nsw i64 %polly.indvar640, -50
  %269 = mul nuw nsw i64 %polly.indvar640, 50
  br label %polly.loop_header643

polly.loop_exit645:                               ; preds = %polly.loop_exit651
  %270 = add nsw i64 %268, 1199
  %271 = mul nuw nsw i64 %polly.indvar640, 7
  %272 = add nuw nsw i64 %271, 31
  %pexp.p_div_q659 = lshr i64 %272, 5
  %273 = sub nsw i64 %polly.indvar640, %pexp.p_div_q659
  %polly.loop_guard664 = icmp slt i64 %273, 19
...
polly.loop_header701.preheader:                   ; preds = %polly.loop_exit689, %polly.loop_exit689.us, %polly.loop_header661.split
  ...
  %298 = mul nsw i64 %polly.indvar665, -64
...
polly.loop_header708:                             ; preds = %polly.loop_header701, %polly.loop_exit718
  ...
  %smin1319 = call i64 @llvm.smin.i64(i64 %303, i64 49)
...
vector.body1313:                                  ; preds = %vector.body1313, %vector.ph1321
  ...
  %wide.load1334 = load <4 x double>, <4 x double>* %319, align 8, !alias.scope !98, !noalias !100
  ...
  br i1 %324, label %middle.block1311, label %vector.body1313, !llvm.loop !109
...
vector.body1239:                                  ; preds = %vector.body1239, %vector.ph1241
  ...
  br i1 %349, label %polly.loop_exit888, label %vector.body1239, !llvm.loop !116
...
vector.body1254:                                  ; preds = %vector.body1254, %vector.ph1257
  ...
  br i1 %378, label %polly.loop_exit915, label %vector.body1254, !llvm.loop !119
...
vector.body1272:                                  ; preds = %vector.body1272, %vector.ph1275
  ...
  br i1 %407, label %polly.loop_exit941, label %vector.body1272, !llvm.loop !122
