; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1652.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1652.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %smin1046 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -920)
  %99 = add nsw i64 %smin1046, 1000
  %100 = mul nuw nsw i64 %polly.indvar225, 80
...
polly.loop_header424:                             ; preds = %polly.loop_exit432, %polly.loop_header418
  ...
  %148 = mul nuw nsw i64 %polly.indvar427, 80
...
polly.loop_exit432:                               ; preds = %polly.loop_exit438
  ...
  %exitcond1080.not = icmp eq i64 %polly.indvar_next428, 13
...
polly.start506:                                   ; preds = %init_array.exit
  %malloccall508 = tail call dereferenceable_or_null(768000) i8* @malloc(i64 768000) #6
...
polly.loop_header632:                             ; preds = %polly.loop_exit640, %polly.loop_header626
  ...
  %smin1102 = call i64 @llvm.smin.i64(i64 %indvars.iv1086, i64 -920)
  %195 = add nsw i64 %smin1102, 1000
  %196 = mul nuw nsw i64 %polly.indvar635, 80
...
polly.loop_exit640:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1108.not = icmp eq i64 %polly.indvar_next636, 13
