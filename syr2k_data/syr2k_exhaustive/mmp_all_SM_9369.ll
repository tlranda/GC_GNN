; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9369.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9369.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit225.3, %polly.loop_header205
  ...
  %112 = mul nuw nsw i64 %polly.indvar214, 100
  %113 = sub nsw i64 %98, %112
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv779, i64 99)
...
polly.loop_exit225:                               ; preds = %polly.loop_exit231.loopexit.us, %polly.loop_header211
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next782, i64 99)
...
vector.body987:                                   ; preds = %vector.body987, %vector.ph991
  ...
  %wide.load998 = load <4 x double>, <4 x double>* %126, align 8, !alias.scope !69, !noalias !71
  ...
  br i1 %129, label %middle.block985, label %vector.body987, !llvm.loop !74
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %131 = udiv i64 %polly.indvar355, 25
...
polly.loop_header365:                             ; preds = %polly.loop_exit379.3, %polly.loop_header358
  ...
  %146 = mul nuw nsw i64 %polly.indvar368, 100
  %147 = sub nsw i64 %132, %146
  %smin799 = call i64 @llvm.smin.i64(i64 %indvars.iv795, i64 99)
...
polly.loop_exit379:                               ; preds = %polly.loop_exit386.loopexit.us, %polly.loop_header365
  ...
  %smin799.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next798, i64 99)
...
vector.body963:                                   ; preds = %vector.body963, %vector.ph965
  ...
  %wide.load972 = load <4 x double>, <4 x double>* %160, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %163, label %middle.block961, label %vector.body963, !llvm.loop !83
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %165 = udiv i64 %polly.indvar511, 25
...
polly.loop_header521:                             ; preds = %polly.loop_exit535.3, %polly.loop_header514
  ...
  %180 = mul nuw nsw i64 %polly.indvar524, 100
  %181 = sub nsw i64 %166, %180
  %smin817 = call i64 @llvm.smin.i64(i64 %indvars.iv813, i64 99)
...
polly.loop_exit535:                               ; preds = %polly.loop_exit542.loopexit.us, %polly.loop_header521
  ...
  %smin817.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next816, i64 99)
...
vector.body901:                                   ; preds = %vector.body901, %vector.ph903
  ...
  br i1 %211, label %polly.loop_exit708, label %vector.body901, !llvm.loop !92
...
vector.body916:                                   ; preds = %vector.body916, %vector.ph919
  ...
  br i1 %240, label %polly.loop_exit735, label %vector.body916, !llvm.loop !95
...
vector.body934:                                   ; preds = %vector.body934, %vector.ph937
  ...
  br i1 %269, label %polly.loop_exit761, label %vector.body934, !llvm.loop !98
...
polly.loop_exit225.1:                             ; preds = %polly.loop_exit231.loopexit.us.1, %polly.loop_exit225
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next782.1, i64 99)
...
polly.loop_exit225.2:                             ; preds = %polly.loop_exit231.loopexit.us.2, %polly.loop_exit225.1
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next782.2, i64 99)
...
polly.loop_exit379.1:                             ; preds = %polly.loop_exit386.loopexit.us.1, %polly.loop_exit379
  ...
  %smin799.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next798.1, i64 99)
...
polly.loop_exit379.2:                             ; preds = %polly.loop_exit386.loopexit.us.2, %polly.loop_exit379.1
  ...
  %smin799.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next798.2, i64 99)
...
polly.loop_exit379.3:                             ; preds = %polly.loop_exit386.loopexit.us.3, %polly.loop_exit379.2
  ...
  %indvars.iv.next796 = add nsw i64 %indvars.iv795, -100
...
polly.loop_exit535.1:                             ; preds = %polly.loop_exit542.loopexit.us.1, %polly.loop_exit535
  ...
  %smin817.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next816.1, i64 99)
...
polly.loop_exit535.2:                             ; preds = %polly.loop_exit542.loopexit.us.2, %polly.loop_exit535.1
  ...
  %smin817.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next816.2, i64 99)
...
polly.loop_exit535.3:                             ; preds = %polly.loop_exit542.loopexit.us.3, %polly.loop_exit535.2
  ...
  %indvars.iv.next814 = add nsw i64 %indvars.iv813, -100
