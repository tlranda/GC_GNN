; ModuleID = 'syr2k_exhaustive/mmp_all_XL_988.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_988.c"
...
polly.loop_header206:                             ; preds = %polly.loop_exit230, %polly.loop_header200
  ...
  %109 = sub i64 %105, %108
  %110 = mul nsw i64 %polly.indvar209, -128
  %111 = add i64 %110, %108
  %112 = shl nuw nsw i64 %polly.indvar209, 10
  %113 = shl nuw nsw i64 %polly.indvar209, 7
  %114 = udiv i64 %polly.indvar209, 3
  ...
  %120 = add i64 %119, %116
  %121 = udiv i64 %polly.indvar209, 3
  %122 = add nuw i64 %polly.indvar209, %121
  %123 = mul nuw nsw i64 %122, 96
  %124 = sub i64 %indvars.iv1092, %123
  %125 = add i64 %indvars.iv1096, %123
  %126 = mul nsw i64 %polly.indvar209, -128
  %127 = shl nsw i64 %polly.indvar209, 7
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit220.7
  ...
  %129 = mul nsw i64 %indvar1426, -96
  %130 = add i64 %109, %129
  %smax1445 = call i64 @llvm.smax.i64(i64 %130, i64 0)
  %131 = mul nuw nsw i64 %indvar1426, 96
  %132 = add i64 %111, %131
  %133 = add i64 %smax1445, %132
  %134 = mul nsw i64 %indvar1426, -96
  %135 = add i64 %117, %134
  %smax1428 = call i64 @llvm.smax.i64(i64 %135, i64 0)
  %136 = mul nuw nsw i64 %indvar1426, 96
  %137 = add i64 %116, %136
  ...
  %145 = mul nuw nsw i64 %polly.indvar231, 96
  %146 = add nsw i64 %145, %126
  %147 = add nsw i64 %146, -1
  %.inv = icmp sgt i64 %146, 127
  %148 = select i1 %.inv, i64 127, i64 %147
  %polly.loop_guard = icmp sgt i64 %148, -1
  %149 = icmp sgt i64 %146, 0
  %150 = select i1 %149, i64 %146, i64 0
  %151 = add nsw i64 %146, 95
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_header251.7, %polly.loop_header251.us.7, %polly.loop_exit242.loopexit.us.7, %polly.loop_header228.split
  ...
  %159 = mul nsw i64 %polly.indvar231, -96
...
polly.loop_header272:                             ; preds = %polly.loop_header265, %polly.loop_exit282
  ...
  %smin1446 = call i64 @llvm.smin.i64(i64 %166, i64 127)
  ...
  %smin1433 = call i64 @llvm.smin.i64(i64 %171, i64 127)
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %213 = shl nuw nsw i64 %polly.indvar421, 7
  %214 = udiv i64 %polly.indvar421, 3
  %215 = add nuw i64 %polly.indvar421, %214
  %216 = mul nuw nsw i64 %215, 96
  %217 = sub i64 %213, %216
  %218 = mul nsw i64 %polly.indvar421, -128
  %219 = add i64 %218, %216
  %220 = shl nuw nsw i64 %polly.indvar421, 10
  %221 = shl nuw nsw i64 %polly.indvar421, 7
  %222 = udiv i64 %polly.indvar421, 3
  %223 = add nuw i64 %polly.indvar421, %222
  %224 = mul nuw nsw i64 %223, 96
  %225 = sub i64 %221, %224
  %226 = or i64 %220, 8
  %227 = mul nsw i64 %polly.indvar421, -128
  %228 = add i64 %227, %224
  %229 = udiv i64 %polly.indvar421, 3
  ...
  %234 = mul nsw i64 %polly.indvar421, -128
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit432.7
  ...
  %237 = mul nsw i64 %indvar1363, -96
  %238 = add i64 %217, %237
  %smax1382 = call i64 @llvm.smax.i64(i64 %238, i64 0)
  %239 = mul nuw nsw i64 %indvar1363, 96
  %240 = add i64 %219, %239
  %241 = add i64 %smax1382, %240
  %242 = mul nsw i64 %indvar1363, -96
  %243 = add i64 %225, %242
  %smax1365 = call i64 @llvm.smax.i64(i64 %243, i64 0)
  %244 = mul nuw nsw i64 %indvar1363, 96
  %245 = add i64 %224, %244
  ...
  %253 = mul nuw nsw i64 %polly.indvar444, 96
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_header466.7, %polly.loop_header466.us.7, %polly.loop_exit456.loopexit.us.7, %polly.loop_header441.split
  ...
  %267 = mul nsw i64 %polly.indvar444, -96
  %268 = icmp slt i64 %267, -1104
  %269 = select i1 %268, i64 %267, i64 -1104
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %smin1383 = call i64 @llvm.smin.i64(i64 %274, i64 127)
  ...
  %smin1370 = call i64 @llvm.smin.i64(i64 %279, i64 127)
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %322 = udiv i64 %polly.indvar636, 3
  %323 = add nuw i64 %polly.indvar636, %322
  %324 = mul nuw nsw i64 %323, 96
  %325 = sub i64 %321, %324
  %326 = mul nsw i64 %polly.indvar636, -128
  %327 = add i64 %326, %324
  %328 = shl nuw nsw i64 %polly.indvar636, 10
  %329 = shl nuw nsw i64 %polly.indvar636, 7
  %330 = udiv i64 %polly.indvar636, 3
  %331 = add nuw i64 %polly.indvar636, %330
  %332 = mul nuw nsw i64 %331, 96
  %333 = sub i64 %329, %332
  %334 = or i64 %328, 8
  %335 = mul nsw i64 %polly.indvar636, -128
  %336 = add i64 %335, %332
  %337 = udiv i64 %polly.indvar636, 3
  %338 = add nuw i64 %polly.indvar636, %337
  %339 = mul nuw nsw i64 %338, 96
  %340 = sub i64 %indvars.iv1140, %339
  %341 = add i64 %indvars.iv1145, %339
  %342 = mul nsw i64 %polly.indvar636, -128
  %343 = shl nsw i64 %polly.indvar636, 7
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit647.7
  ...
  %345 = mul nsw i64 %indvar1300, -96
  %346 = add i64 %325, %345
  %smax1319 = call i64 @llvm.smax.i64(i64 %346, i64 0)
  %347 = mul nuw nsw i64 %indvar1300, 96
  %348 = add i64 %327, %347
  %349 = add i64 %smax1319, %348
  %350 = mul nsw i64 %indvar1300, -96
  %351 = add i64 %333, %350
  %smax1302 = call i64 @llvm.smax.i64(i64 %351, i64 0)
  %352 = mul nuw nsw i64 %indvar1300, 96
  %353 = add i64 %332, %352
  ...
  %361 = mul nuw nsw i64 %polly.indvar659, 96
  %362 = add nsw i64 %361, %342
  %363 = add nsw i64 %362, -1
  %.inv943 = icmp sgt i64 %362, 127
  %364 = select i1 %.inv943, i64 127, i64 %363
  %polly.loop_guard672 = icmp sgt i64 %364, -1
  %365 = icmp sgt i64 %362, 0
  %366 = select i1 %365, i64 %362, i64 0
  %367 = add nsw i64 %362, 95
...
polly.loop_header695.preheader:                   ; preds = %polly.loop_header681.7, %polly.loop_header681.us.7, %polly.loop_exit671.loopexit.us.7, %polly.loop_header656.split
  ...
  %375 = mul nsw i64 %polly.indvar659, -96
  %376 = icmp slt i64 %375, -1104
  %377 = select i1 %376, i64 %375, i64 -1104
...
polly.loop_header702:                             ; preds = %polly.loop_header695, %polly.loop_exit712
  ...
  %smin1320 = call i64 @llvm.smin.i64(i64 %382, i64 127)
  ...
  %smin1307 = call i64 @llvm.smin.i64(i64 %387, i64 127)
