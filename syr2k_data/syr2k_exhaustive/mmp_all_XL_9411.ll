; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9411.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9411.c"
...
vector.body978:                                   ; preds = %vector.body978, %vector.ph982
  ...
  %wide.load989 = load <4 x double>, <4 x double>* %125, align 8, !alias.scope !68, !noalias !70
  ...
  br i1 %128, label %middle.block976, label %vector.body978, !llvm.loop !73
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %130 = udiv i64 %polly.indvar355, 25
...
polly.loop_header358:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %143 = mul nuw nsw i64 %polly.indvar361, 100
  br label %polly.loop_header365

polly.loop_exit367:                               ; preds = %polly.loop_exit379.3
  %polly.indvar_next362 = add nuw nsw i64 %polly.indvar361, 1
  %exitcond801.not = icmp eq i64 %polly.indvar_next362, 10
...
polly.loop_header365:                             ; preds = %polly.loop_exit379.3, %polly.loop_header358
  ...
  %144 = mul nuw nsw i64 %polly.indvar368, 100
...
polly.loop_exit386.loopexit.us:                   ; preds = %polly.loop_header384.us
  ...
  %exitcond798.not = icmp eq i64 %polly.indvar_next381.us, 100
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph956
  ...
  %wide.load963 = load <4 x double>, <4 x double>* %158, align 8, !alias.scope !77, !noalias !79
  ...
  br i1 %161, label %middle.block952, label %vector.body954, !llvm.loop !82
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit516
  ...
  %163 = udiv i64 %polly.indvar511, 25
...
polly.loop_header514:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %176 = mul nuw nsw i64 %polly.indvar517, 100
...
polly.loop_exit523:                               ; preds = %polly.loop_exit535.3
  ...
  %exitcond816.not = icmp eq i64 %polly.indvar_next518, 10
...
polly.loop_header521:                             ; preds = %polly.loop_exit535.3, %polly.loop_header514
  ...
  %177 = mul nuw nsw i64 %polly.indvar524, 100
  %178 = sub nsw i64 %164, %177
  %smin811 = call i64 @llvm.smin.i64(i64 %indvars.iv807, i64 99)
...
polly.loop_exit542.loopexit.us:                   ; preds = %polly.loop_header540.us
  ...
  %exitcond813.not = icmp eq i64 %polly.indvar_next537.us, 100
...
polly.loop_exit535:                               ; preds = %polly.loop_exit542.loopexit.us, %polly.loop_header521
  ...
  %smin811.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next810, i64 99)
...
vector.body892:                                   ; preds = %vector.body892, %vector.ph894
  ...
  br i1 %208, label %polly.loop_exit708, label %vector.body892, !llvm.loop !91
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  br i1 %237, label %polly.loop_exit735, label %vector.body907, !llvm.loop !94
...
vector.body925:                                   ; preds = %vector.body925, %vector.ph928
  ...
  br i1 %266, label %polly.loop_exit761, label %vector.body925, !llvm.loop !97
...
polly.loop_exit231.loopexit.us.1:                 ; preds = %polly.loop_header229.us.1
  ...
  %exitcond783.1.not = icmp eq i64 %polly.indvar_next227.us.1, 100
...
polly.loop_exit231.loopexit.us.2:                 ; preds = %polly.loop_header229.us.2
  ...
  %exitcond783.2.not = icmp eq i64 %polly.indvar_next227.us.2, 100
...
polly.loop_exit231.loopexit.us.3:                 ; preds = %polly.loop_header229.us.3
  ...
  %exitcond783.3.not = icmp eq i64 %polly.indvar_next227.us.3, 100
...
polly.loop_exit386.loopexit.us.1:                 ; preds = %polly.loop_header384.us.1
  ...
  %exitcond798.1.not = icmp eq i64 %polly.indvar_next381.us.1, 100
...
polly.loop_exit386.loopexit.us.2:                 ; preds = %polly.loop_header384.us.2
  ...
  %exitcond798.2.not = icmp eq i64 %polly.indvar_next381.us.2, 100
...
polly.loop_exit386.loopexit.us.3:                 ; preds = %polly.loop_header384.us.3
  ...
  %exitcond798.3.not = icmp eq i64 %polly.indvar_next381.us.3, 100
...
polly.loop_exit542.loopexit.us.1:                 ; preds = %polly.loop_header540.us.1
  ...
  %exitcond813.1.not = icmp eq i64 %polly.indvar_next537.us.1, 100
...
polly.loop_exit535.1:                             ; preds = %polly.loop_exit542.loopexit.us.1, %polly.loop_exit535
  ...
  %smin811.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next810.1, i64 99)
...
polly.loop_exit542.loopexit.us.2:                 ; preds = %polly.loop_header540.us.2
  ...
  %exitcond813.2.not = icmp eq i64 %polly.indvar_next537.us.2, 100
...
polly.loop_exit535.2:                             ; preds = %polly.loop_exit542.loopexit.us.2, %polly.loop_exit535.1
  ...
  %smin811.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next810.2, i64 99)
...
polly.loop_exit542.loopexit.us.3:                 ; preds = %polly.loop_header540.us.3
  ...
  %exitcond813.3.not = icmp eq i64 %polly.indvar_next537.us.3, 100
