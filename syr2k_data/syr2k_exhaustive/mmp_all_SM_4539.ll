; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4539.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4539.c"
...
vector.body1197:                                  ; preds = %vector.body1197, %vector.ph1201
  ...
  %wide.load1208 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !74, !noalias !76
  ...
  br i1 %133, label %middle.block1195, label %vector.body1197, !llvm.loop !80
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %135 = udiv i64 %indvars.iv1015, 5
  %umin1017 = call i64 @llvm.umin.i64(i64 %135, i64 14)
...
vector.body1173:                                  ; preds = %vector.body1173, %vector.ph1175
  ...
  %wide.load1182 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !84, !noalias !86
  ...
  br i1 %171, label %middle.block1171, label %vector.body1173, !llvm.loop !90
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit582
  ...
  %173 = udiv i64 %indvars.iv1041, 5
  %umin1043 = call i64 @llvm.umin.i64(i64 %173, i64 14)
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %180 = mul nuw nsw i64 %polly.indvar590, 80
...
vector.body1112:                                  ; preds = %vector.body1112, %vector.ph1113
  ...
  br i1 %223, label %polly.loop_exit807, label %vector.body1112, !llvm.loop !99
...
vector.body1126:                                  ; preds = %vector.body1126, %vector.ph1129
  ...
  br i1 %252, label %polly.loop_exit834, label %vector.body1126, !llvm.loop !102
...
vector.body1144:                                  ; preds = %vector.body1144, %vector.ph1147
  ...
  br i1 %281, label %polly.loop_exit860, label %vector.body1144, !llvm.loop !105
