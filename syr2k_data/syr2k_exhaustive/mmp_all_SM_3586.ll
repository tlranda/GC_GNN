; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3586.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3586.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit248
  ...
  %exitcond1033.not = icmp eq i64 %108, 300
...
polly.loop_header246.preheader:                   ; preds = %polly.loop_exit235, %polly.loop_exit235.us, %polly.loop_header211.split
  ...
  %polly.loop_guard256 = icmp slt i64 %121, 80
...
polly.loop_header253.us:                          ; preds = %polly.loop_header246.us, %polly.loop_exit263.us
  %indvars.iv1027 = phi i64 [ %109, %polly.loop_header246.us ], [ %indvars.iv.next1028, %polly.loop_exit263.us ]
...
vector.body1237:                                  ; preds = %vector.body1237, %vector.ph1241
  ...
  %wide.load1248 = load <4 x double>, <4 x double>* %139, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %142, label %middle.block1235, label %vector.body1237, !llvm.loop !84
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %146 = udiv i64 %polly.indvar398, 20
  %147 = mul nuw nsw i64 %146, 80
  %148 = sub nsw i64 %indvars.iv1044, %147
  %149 = add i64 %indvars.iv1049, %147
...
polly.loop_exit404:                               ; preds = %polly.loop_exit445
  ...
  %exitcond1059.not = icmp eq i64 %155, 300
...
polly.loop_header402:                             ; preds = %polly.loop_exit445, %polly.loop_header395
  %indvars.iv1051 = phi i64 [ %indvars.iv.next1052, %polly.loop_exit445 ], [ %149, %polly.loop_header395 ]
  %indvars.iv1046 = phi i64 [ %indvars.iv.next1047, %polly.loop_exit445 ], [ %148, %polly.loop_header395 ]
  ...
  %157 = mul nuw nsw i64 %polly.indvar405, 20
  %.not.not885 = icmp ugt i64 %157, %polly.indvar398
  %158 = mul nuw nsw i64 %polly.indvar405, 80
...
polly.loop_exit431.us:                            ; preds = %polly.loop_header429.us, %polly.loop_header408.us
  ...
  %exitcond1043.not = icmp eq i64 %polly.indvar_next412.us, %144
...
polly.loop_exit431:                               ; preds = %polly.loop_header429
  ...
  %exitcond1040.not = icmp eq i64 %polly.indvar_next412, %144
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_exit431, %polly.loop_exit431.us, %polly.loop_header402.split
  ...
  %polly.loop_guard453 = icmp slt i64 %168, 80
...
polly.loop_exit452.loopexit.us:                   ; preds = %polly.loop_exit460.us
  ...
  %exitcond1058.not = icmp eq i64 %polly.indvar_next447.us, %144
...
vector.body1213:                                  ; preds = %vector.body1213, %vector.ph1215
  ...
  %wide.load1222 = load <4 x double>, <4 x double>* %186, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %189, label %middle.block1211, label %vector.body1213, !llvm.loop !94
...
polly.loop_header586:                             ; preds = %polly.loop_header586.preheader, %polly.loop_exit594
  ...
  %191 = add nsw i64 %smin1083, 1000
  %192 = mul nuw nsw i64 %polly.indvar589, 80
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %193 = udiv i64 %polly.indvar595, 20
  %194 = mul nuw nsw i64 %193, 80
  %195 = sub nsw i64 %indvars.iv1070, %194
  %196 = add i64 %indvars.iv1075, %194
...
polly.loop_header599:                             ; preds = %polly.loop_exit642, %polly.loop_header592
  %indvars.iv1077 = phi i64 [ %indvars.iv.next1078, %polly.loop_exit642 ], [ %196, %polly.loop_header592 ]
  %indvars.iv1072 = phi i64 [ %indvars.iv.next1073, %polly.loop_exit642 ], [ %195, %polly.loop_header592 ]
  ...
  %203 = add i64 %smax1074, %indvars.iv1077
  %204 = mul nuw nsw i64 %polly.indvar602, 20
  %.not.not886 = icmp ugt i64 %204, %polly.indvar595
  %205 = mul nuw nsw i64 %polly.indvar602, 80
...
polly.loop_exit628.us:                            ; preds = %polly.loop_header626.us, %polly.loop_header605.us
  ...
  %exitcond1069.not = icmp eq i64 %polly.indvar_next609.us, %191
...
polly.loop_exit628:                               ; preds = %polly.loop_header626
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next609, %191
...
polly.loop_header640.preheader:                   ; preds = %polly.loop_exit628, %polly.loop_exit628.us, %polly.loop_header599.split
  ...
  %polly.loop_guard650 = icmp slt i64 %215, 80
...
polly.loop_header647.us:                          ; preds = %polly.loop_header640.us, %polly.loop_exit657.us
  %indvars.iv1079 = phi i64 [ %203, %polly.loop_header640.us ], [ %indvars.iv.next1080, %polly.loop_exit657.us ]
...
polly.loop_exit649.loopexit.us:                   ; preds = %polly.loop_exit657.us
  ...
  %exitcond1084.not = icmp eq i64 %polly.indvar_next644.us, %191
...
vector.body1152:                                  ; preds = %vector.body1152, %vector.ph1153
  ...
  br i1 %250, label %polly.loop_exit825, label %vector.body1152, !llvm.loop !103
...
vector.body1166:                                  ; preds = %vector.body1166, %vector.ph1169
  ...
  br i1 %279, label %polly.loop_exit852, label %vector.body1166, !llvm.loop !106
...
vector.body1184:                                  ; preds = %vector.body1184, %vector.ph1187
  ...
  br i1 %308, label %polly.loop_exit878, label %vector.body1184, !llvm.loop !109
