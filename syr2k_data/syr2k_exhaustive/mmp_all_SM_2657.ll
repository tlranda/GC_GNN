; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2657.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2657.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv1029, i64 18)
...
polly.loop_header228:                             ; preds = %polly.loop_header228.preheader, %polly.loop_exit261
  ...
  %smin1327 = call i64 @llvm.smin.i64(i64 %116, i64 63)
  %117 = add nsw i64 %smin1327, 1
  %smin1026 = call i64 @llvm.smin.i64(i64 %indvars.iv1022, i64 63)
...
polly.loop_header414:                             ; preds = %polly.loop_exit406, %polly.loop_exit422
  ...
  %umin1057 = call i64 @llvm.umin.i64(i64 %indvars.iv1055, i64 18)
...
polly.loop_header427:                             ; preds = %polly.loop_header427.preheader, %polly.loop_exit465
  ...
  %smin1279 = call i64 @llvm.smin.i64(i64 %171, i64 63)
  %172 = add nsw i64 %smin1279, 1
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1047, i64 63)
...
polly.loop_header618:                             ; preds = %polly.loop_exit610, %polly.loop_exit626
  ...
  %umin1084 = call i64 @llvm.umin.i64(i64 %indvars.iv1082, i64 18)
...
polly.loop_header624:                             ; preds = %polly.loop_exit633, %polly.loop_header618
  ...
  %214 = shl nuw nsw i64 %polly.indvar627, 6
  %215 = add i64 %207, %214
  %smax1228 = call i64 @llvm.smax.i64(i64 %215, i64 0)
  %216 = mul nsw i64 %polly.indvar627, -64
  %217 = add i64 %208, %216
  %218 = add i64 %smax1228, %217
  %219 = shl nsw i64 %polly.indvar627, 6
...
polly.loop_header631:                             ; preds = %polly.loop_header631.preheader, %polly.loop_exit669
  ...
  %smin1231 = call i64 @llvm.smin.i64(i64 %226, i64 63)
  %227 = add nsw i64 %smin1231, 1
  %smin1079 = call i64 @llvm.smin.i64(i64 %indvars.iv1074, i64 63)
