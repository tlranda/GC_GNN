; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3060.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3060.c"
...
vector.body1355:                                  ; preds = %vector.body1355, %vector.ph1359
  ...
  %wide.load1366 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !78, !noalias !80
  ...
  br i1 %173, label %middle.block1353, label %vector.body1355, !llvm.loop !84
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %175 = mul nuw nsw i64 %polly.indvar409, 20
...
vector.body1331:                                  ; preds = %vector.body1331, %vector.ph1333
  ...
  %wide.load1340 = load <4 x double>, <4 x double>* %248, align 8, !alias.scope !88, !noalias !90
  ...
  br i1 %251, label %middle.block1329, label %vector.body1331, !llvm.loop !94
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %253 = mul nuw nsw i64 %polly.indvar623, 20
...
vector.body1269:                                  ; preds = %vector.body1269, %vector.ph1271
  ...
  br i1 %343, label %polly.loop_exit876, label %vector.body1269, !llvm.loop !103
...
vector.body1284:                                  ; preds = %vector.body1284, %vector.ph1287
  ...
  store <4 x double> %366, <4 x double>* %371, align 8, !alias.scope !102, !noalias !105
  ...
  br i1 %372, label %polly.loop_exit903, label %vector.body1284, !llvm.loop !106
...
vector.body1302:                                  ; preds = %vector.body1302, %vector.ph1305
  ...
  store <4 x double> %395, <4 x double>* %400, align 8, !alias.scope !101, !noalias !108
  ...
  br i1 %401, label %polly.loop_exit929, label %vector.body1302, !llvm.loop !109
