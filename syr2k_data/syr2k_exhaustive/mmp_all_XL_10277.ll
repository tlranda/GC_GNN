; ModuleID = 'syr2k_exhaustive/mmp_all_XL_10277.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_10277.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit214, %polly.loop_header199
  ...
  %exitcond797.not = icmp eq i64 %polly.indvar_next203, 15
...
polly.loop_header212.preheader:                   ; preds = %polly.loop_header205
  ...
  %106 = add i64 %smax, %indvars.iv792
...
polly.loop_exit214:                               ; preds = %polly.loop_exit221, %polly.loop_header205
  ...
  %indvars.iv.next789 = add nsw i64 %indvars.iv788, 50
...
polly.loop_header212:                             ; preds = %polly.loop_header212.preheader, %polly.loop_exit221
  %indvars.iv794 = phi i64 [ %106, %polly.loop_header212.preheader ], [ %indvars.iv.next795, %polly.loop_exit221 ]
  %polly.indvar216 = phi i64 [ %105, %polly.loop_header212.preheader ], [ %polly.indvar_next217, %polly.loop_exit221 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv794, i64 49)
  %108 = add nsw i64 %polly.indvar216, %107
  %polly.loop_guard229868 = icmp sgt i64 %108, -1
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit364
  ...
  %126 = shl nuw nsw i64 %polly.indvar357, 1
  %127 = trunc i64 %126 to i8
  %pexp.p_div_q360.lhs.trunc = add i8 %127, 2
  %pexp.p_div_q360775 = udiv i8 %pexp.p_div_q360.lhs.trunc, 5
  %pexp.p_div_q360.zext = zext i8 %pexp.p_div_q360775 to i64
  %128 = sub nsw i64 %126, %pexp.p_div_q360.zext
...
polly.loop_exit364:                               ; preds = %polly.loop_exit372, %polly.loop_header354
  ...
  %indvars.iv.next806 = add nuw nsw i64 %indvars.iv805, 80
  %exitcond814.not = icmp eq i64 %polly.indvar_next358, 15
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_exit372
  ...
  %131 = mul nuw nsw i64 %polly.indvar366, 50
  %132 = add nsw i64 %131, %129
  %133 = icmp sgt i64 %132, 0
  %134 = select i1 %133, i64 %132, i64 0
  %polly.loop_guard373 = icmp slt i64 %134, 80
...
polly.loop_header370:                             ; preds = %polly.loop_header370.preheader, %polly.loop_exit379
  %indvars.iv809 = phi i64 [ %135, %polly.loop_header370.preheader ], [ %indvars.iv.next810, %polly.loop_exit379 ]
  ...
  %polly.loop_guard387869 = icmp sgt i64 %137, -1
...
polly.loop_exit379:                               ; preds = %polly.loop_exit386.loopexit.us, %polly.loop_header370
  ...
  %polly.loop_cond376 = icmp ult i64 %polly.indvar374, 79
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit522
  ...
  %155 = shl nuw nsw i64 %polly.indvar515, 1
  %156 = trunc i64 %155 to i8
  %pexp.p_div_q518.lhs.trunc = add i8 %156, 2
  %pexp.p_div_q518774 = udiv i8 %pexp.p_div_q518.lhs.trunc, 5
  %pexp.p_div_q518.zext = zext i8 %pexp.p_div_q518774 to i64
  %157 = sub nsw i64 %155, %pexp.p_div_q518.zext
...
polly.loop_header520.preheader:                   ; preds = %polly.loop_header512
  %158 = mul nsw i64 %polly.indvar515, -80
  %159 = mul nuw nsw i64 %polly.indvar515, 80
...
polly.loop_exit522:                               ; preds = %polly.loop_exit530, %polly.loop_header512
  ...
  %indvars.iv.next823 = add nuw nsw i64 %indvars.iv822, 80
  %exitcond831.not = icmp eq i64 %polly.indvar_next516, 15
...
polly.loop_header520:                             ; preds = %polly.loop_header520.preheader, %polly.loop_exit530
  ...
  %160 = mul nuw nsw i64 %polly.indvar524, 50
  %161 = add nsw i64 %160, %158
  %162 = icmp sgt i64 %161, 0
  %163 = select i1 %162, i64 %161, i64 0
  %polly.loop_guard531 = icmp slt i64 %163, 80
...
polly.loop_header528.preheader:                   ; preds = %polly.loop_header520
  ...
  %164 = add i64 %smax821, %indvars.iv824
...
polly.loop_exit530:                               ; preds = %polly.loop_exit537, %polly.loop_header520
  ...
  %indvars.iv.next820 = add nsw i64 %indvars.iv819, 50
...
polly.loop_header528:                             ; preds = %polly.loop_header528.preheader, %polly.loop_exit537
  %indvars.iv826 = phi i64 [ %164, %polly.loop_header528.preheader ], [ %indvars.iv.next827, %polly.loop_exit537 ]
  %polly.indvar532 = phi i64 [ %163, %polly.loop_header528.preheader ], [ %polly.indvar_next533, %polly.loop_exit537 ]
  %smin828 = call i64 @llvm.smin.i64(i64 %indvars.iv826, i64 49)
  %166 = add nsw i64 %polly.indvar532, %165
  %polly.loop_guard545870 = icmp sgt i64 %166, -1
...
polly.loop_exit537:                               ; preds = %polly.loop_exit544.loopexit.us, %polly.loop_header528
  ...
  %polly.loop_cond534 = icmp ult i64 %polly.indvar532, 79
...
vector.body897:                                   ; preds = %vector.body897, %vector.ph899
  ...
  br i1 %196, label %polly.loop_exit714, label %vector.body897, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body897, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond861.not = icmp eq i64 %polly.indvar709, %176
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar715, %180
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph915
  ...
  br i1 %225, label %polly.loop_exit741, label %vector.body912, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body912, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond851.not = icmp eq i64 %polly.indvar736, %205
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond847.not = icmp eq i64 %polly.indvar742, %209
...
vector.body930:                                   ; preds = %vector.body930, %vector.ph933
  ...
  br i1 %254, label %polly.loop_exit767, label %vector.body930, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body930, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond841.not = icmp eq i64 %polly.indvar762, %234
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond837.not = icmp eq i64 %polly.indvar768, %238
