; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9697.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9697.c"
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %141 = lshr i64 %indvars.iv815, 4
  %142 = mul nsw i64 %polly.indvar357, -20
  %143 = mul nuw nsw i64 %polly.indvar357, 20
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %159 = shl nsw i64 %polly.indvar370, 6
  %160 = add nsw i64 %159, %142
  %161 = icmp sgt i64 %160, 0
  %162 = select i1 %161, i64 %160, i64 0
  %polly.loop_guard377 = icmp slt i64 %162, 20
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %185 = lshr i64 %indvars.iv836, 4
  %186 = mul nsw i64 %polly.indvar515, -20
  %187 = mul nuw nsw i64 %polly.indvar515, 20
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %203 = shl nsw i64 %polly.indvar528, 6
  %204 = add nsw i64 %203, %186
  %205 = icmp sgt i64 %204, 0
  %206 = select i1 %205, i64 %204, i64 0
  %polly.loop_guard535 = icmp slt i64 %206, 20
