; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7743.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7743.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_header215
  ...
  %103 = shl nsw i64 %polly.indvar224, 8
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  ...
  %127 = lshr i64 %indvars.iv856, 3
  %128 = mul nsw i64 %polly.indvar389, -96
  %129 = icmp slt i64 %128, -1104
  %130 = select i1 %129, i64 %128, i64 -1104
  %131 = add nsw i64 %130, 1199
  %132 = mul nuw nsw i64 %polly.indvar389, 96
...
polly.loop_exit395:                               ; preds = %polly.loop_exit402
  ...
  %exitcond859.not = icmp eq i64 %polly.indvar_next390, 13
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %133 = shl nsw i64 %polly.indvar396, 8
...
polly.loop_exit402:                               ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar396, %127
...
polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit409
  ...
  %polly.loop_guard417918 = icmp sgt i64 %139, -1
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  ...
  %157 = lshr i64 %indvars.iv878, 3
  %158 = mul nsw i64 %polly.indvar563, -96
  %159 = icmp slt i64 %158, -1104
  %160 = select i1 %159, i64 %158, i64 -1104
  %161 = add nsw i64 %160, 1199
  %162 = mul nuw nsw i64 %polly.indvar563, 96
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576
  ...
  %indvars.iv.next865 = add nsw i64 %indvars.iv864, -96
  %indvars.iv.next870 = add nuw nsw i64 %indvars.iv869, 96
  %indvars.iv.next879 = add nuw nsw i64 %indvars.iv878, 3
  %exitcond881.not = icmp eq i64 %polly.indvar_next564, 13
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %163 = shl nsw i64 %polly.indvar570, 8
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583, %polly.loop_header567
  ...
  %exitcond880.not = icmp eq i64 %polly.indvar570, %157
...
polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit583
  %indvars.iv873 = phi i64 [ %167, %polly.loop_header574.preheader ], [ %indvars.iv.next874, %polly.loop_exit583 ]
  ...
  %polly.loop_guard591919 = icmp sgt i64 %169, -1
...
vector.body940:                                   ; preds = %vector.body940, %vector.ph942
  ...
  br i1 %199, label %polly.loop_exit760, label %vector.body940, !llvm.loop !99

polly.loop_exit760:                               ; preds = %vector.body940, %polly.loop_header758
  %polly.indvar_next756 = add nuw nsw i64 %polly.indvar755, 1
  %exitcond913.not = icmp eq i64 %polly.indvar755, %179
...
polly.loop_header758:                             ; preds = %polly.loop_header752, %polly.loop_header758
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar761, %183
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph958
  ...
  br i1 %228, label %polly.loop_exit787, label %vector.body955, !llvm.loop !102

polly.loop_exit787:                               ; preds = %vector.body955, %polly.loop_header785
  %polly.indvar_next783 = add nuw nsw i64 %polly.indvar782, 1
  %exitcond903.not = icmp eq i64 %polly.indvar782, %208
...
polly.loop_header785:                             ; preds = %polly.loop_header779, %polly.loop_header785
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar788, %212
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph976
  ...
  br i1 %257, label %polly.loop_exit813, label %vector.body973, !llvm.loop !105

polly.loop_exit813:                               ; preds = %vector.body973, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond893.not = icmp eq i64 %polly.indvar808, %237
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar814, %241
