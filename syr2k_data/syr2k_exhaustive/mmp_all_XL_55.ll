; ModuleID = 'syr2k_exhaustive/mmp_all_XL_55.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_55.c"
...
polly.start302:                                   ; preds = %kernel_syr2k.exit
  %malloccall304 = tail call dereferenceable_or_null(480000) i8* @malloc(i64 480000) #8
...
polly.start510:                                   ; preds = %init_array.exit
  %malloccall512 = tail call dereferenceable_or_null(480000) i8* @malloc(i64 480000) #8
  %malloccall514 = tail call dereferenceable_or_null(480000) i8* @malloc(i64 480000) #8
...
polly.loop_header614:                             ; preds = %polly.loop_header614.preheader, %polly.loop_exit622
  ...
  %183 = mul nuw nsw i64 %polly.indvar617, 50
