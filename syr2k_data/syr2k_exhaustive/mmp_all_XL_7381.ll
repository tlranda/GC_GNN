; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7381.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7381.c"
...
vector.body1041:                                  ; preds = %vector.body1041, %vector.ph1045
  ...
  %wide.load1052 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %134, label %middle.block1039, label %vector.body1041, !llvm.loop !79
...
polly.loop_header402:                             ; preds = %polly.loop_exit411, %polly.loop_header396
  ...
  %149 = shl nsw i64 %polly.indvar405, 2
...
vector.body1017:                                  ; preds = %vector.body1017, %vector.ph1019
  ...
  %wide.load1026 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %173, label %middle.block1015, label %vector.body1017, !llvm.loop !89
...
polly.loop_header579:                             ; preds = %polly.loop_exit588, %polly.loop_header573
  ...
  %188 = shl nsw i64 %polly.indvar582, 2
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph957
  ...
  br i1 %226, label %polly.loop_exit770, label %vector.body955, !llvm.loop !98
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph973
  ...
  br i1 %255, label %polly.loop_exit797, label %vector.body970, !llvm.loop !101
...
vector.body988:                                   ; preds = %vector.body988, %vector.ph991
  ...
  br i1 %284, label %polly.loop_exit823, label %vector.body988, !llvm.loop !104
