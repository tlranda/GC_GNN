; ModuleID = 'syr2k_exhaustive/mmp_all_SM_6349.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_6349.c"
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_exit213
  ...
  %107 = mul nuw nsw i64 %polly.indvar230, 96
...
polly.loop_header239:                             ; preds = %polly.loop_header233, %polly.loop_exit248
  ...
  %118 = add i64 %117, %103
  %polly.loop_guard249945 = icmp sgt i64 %118, -1
...
vector.body1054:                                  ; preds = %vector.body1054, %vector.ph1058
  ...
  %129 = shl nuw nsw i64 %index1061, 3
  %130 = getelementptr i8, i8* %scevgep370, i64 %129
  %131 = bitcast i8* %130 to <4 x double>*
  %wide.load1065 = load <4 x double>, <4 x double>* %131, align 8, !alias.scope !79, !noalias !81
  %132 = fmul fast <4 x double> %wide.load1065, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %134 = icmp eq i64 %index.next1062, %n.vec1060
  br i1 %134, label %middle.block1052, label %vector.body1054, !llvm.loop !85

middle.block1052:                                 ; preds = %vector.body1054
  %cmp.n1064 = icmp eq i64 %127, %n.vec1060
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit382
  ...
  %136 = mul nuw nsw i64 %polly.indvar377, 50
...
polly.loop_header380:                             ; preds = %polly.loop_exit405, %polly.loop_header374
  ...
  %137 = udiv i64 %polly.indvar383, 6
  %138 = mul nuw nsw i64 %137, 96
  %139 = sub nsw i64 %indvars.iv874, %138
  %140 = add i64 %indvars.iv879, %138
...
polly.loop_header403:                             ; preds = %polly.loop_exit411, %polly.loop_exit388
  ...
  %indvars.iv876 = phi i64 [ %indvars.iv.next877, %polly.loop_exit411 ], [ %139, %polly.loop_exit388 ]
  ...
  %145 = add i64 %smax878, %indvars.iv881
  %146 = mul nuw nsw i64 %polly.indvar406, 96
  %147 = sub nsw i64 %141, %146
  %148 = icmp sgt i64 %147, 0
  %149 = select i1 %148, i64 %147, i64 0
  %150 = mul nsw i64 %polly.indvar406, -96
...
polly.loop_header416:                             ; preds = %polly.loop_header409, %polly.loop_exit426
  %indvars.iv883 = phi i64 [ %145, %polly.loop_header409 ], [ %indvars.iv.next884, %polly.loop_exit426 ]
  ...
  %157 = add i64 %156, %142
  %polly.loop_guard427946 = icmp sgt i64 %157, -1
...
polly.loop_header536:                             ; preds = %polly.loop_exit544, %polly.start450
  ...
  %min.iters.check1031 = icmp ult i64 %166, 4
...
vector.body1030:                                  ; preds = %vector.body1030, %vector.ph1032
  ...
  %168 = shl nuw nsw i64 %index1035, 3
  %169 = getelementptr i8, i8* %scevgep548, i64 %168
  %170 = bitcast i8* %169 to <4 x double>*
  %wide.load1039 = load <4 x double>, <4 x double>* %170, align 8, !alias.scope !89, !noalias !91
  %171 = fmul fast <4 x double> %wide.load1039, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %173 = icmp eq i64 %index.next1036, %n.vec1034
  br i1 %173, label %middle.block1028, label %vector.body1030, !llvm.loop !95

middle.block1028:                                 ; preds = %vector.body1030
  %cmp.n1038 = icmp eq i64 %166, %n.vec1034
...
polly.loop_header552:                             ; preds = %polly.loop_header552.preheader, %polly.loop_exit560
  ...
  %175 = mul nuw nsw i64 %polly.indvar555, 50
...
polly.loop_header558:                             ; preds = %polly.loop_exit583, %polly.loop_header552
  ...
  %176 = udiv i64 %polly.indvar561, 6
  %177 = mul nuw nsw i64 %176, 96
  %178 = sub nsw i64 %indvars.iv896, %177
  %179 = add i64 %indvars.iv901, %177
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_exit566
  %indvars.iv903 = phi i64 [ %indvars.iv.next904, %polly.loop_exit589 ], [ %179, %polly.loop_exit566 ]
  %indvars.iv898 = phi i64 [ %indvars.iv.next899, %polly.loop_exit589 ], [ %178, %polly.loop_exit566 ]
  ...
  %184 = add i64 %smax900, %indvars.iv903
  %185 = mul nuw nsw i64 %polly.indvar584, 96
  %186 = sub nsw i64 %180, %185
  %187 = icmp sgt i64 %186, 0
  %188 = select i1 %187, i64 %186, i64 0
  %189 = mul nsw i64 %polly.indvar584, -96
...
polly.loop_header594:                             ; preds = %polly.loop_header587, %polly.loop_exit604
  %indvars.iv905 = phi i64 [ %184, %polly.loop_header587 ], [ %indvars.iv.next906, %polly.loop_exit604 ]
  ...
  %196 = add i64 %195, %181
  %polly.loop_guard605947 = icmp sgt i64 %196, -1
...
polly.loop_header758:                             ; preds = %polly.loop_exit766, %polly.loop_header752
  ...
  %smin969 = call i64 @llvm.smin.i64(i64 %207, i64 -1168)
  %208 = add nsw i64 %smin969, 1200
...
vector.ph970:                                     ; preds = %polly.loop_header764
  %broadcast.splatinsert977 = insertelement <4 x i64> poison, i64 %209, i32 0
  %broadcast.splat978 = shufflevector <4 x i64> %broadcast.splatinsert977, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert979 = insertelement <4 x i32> poison, i32 %212, i32 0
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %214 = add nuw nsw <4 x i64> %vec.ind975, %broadcast.splat978
  %215 = trunc <4 x i64> %214 to <4 x i32>
  %216 = mul <4 x i32> %broadcast.splat980, %215
  ...
  %226 = icmp eq i64 %index.next972, %208
  br i1 %226, label %polly.loop_exit772, label %vector.body968, !llvm.loop !104
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %smin984 = call i64 @llvm.smin.i64(i64 %236, i64 -968)
  %237 = add nsw i64 %smin984, 1000
...
vector.body983:                                   ; preds = %vector.body983, %vector.ph986
  ...
  %243 = add nuw nsw <4 x i64> %vec.ind993, %broadcast.splat996
  %244 = trunc <4 x i64> %243 to <4 x i32>
  %245 = mul <4 x i32> %broadcast.splat998, %244
  ...
  %255 = icmp eq i64 %index.next990, %237
  br i1 %255, label %polly.loop_exit799, label %vector.body983, !llvm.loop !107
...
polly.loop_header811:                             ; preds = %polly.loop_exit819, %polly.loop_header805
  ...
  %smin1002 = call i64 @llvm.smin.i64(i64 %265, i64 -968)
  %266 = add nsw i64 %smin1002, 1000
...
vector.body1001:                                  ; preds = %vector.body1001, %vector.ph1004
  ...
  %272 = add nuw nsw <4 x i64> %vec.ind1011, %broadcast.splat1014
  %273 = trunc <4 x i64> %272 to <4 x i32>
  %274 = mul <4 x i32> %broadcast.splat1016, %273
  ...
  %284 = icmp eq i64 %index.next1008, %266
  br i1 %284, label %polly.loop_exit825, label %vector.body1001, !llvm.loop !110
