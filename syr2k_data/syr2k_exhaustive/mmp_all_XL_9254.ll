; ModuleID = 'syr2k_exhaustive/mmp_all_XL_9254.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_9254.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %98 = shl nuw nsw i64 %indvars.iv785, 1
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond797.not = icmp eq i64 %polly.indvar_next209, 24
...
vector.body992:                                   ; preds = %vector.body992, %vector.ph996
  ...
  %wide.load1003 = load <4 x double>, <4 x double>* %130, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %133, label %middle.block990, label %vector.body992, !llvm.loop !76
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %136 = shl nuw nsw i64 %indvars.iv803, 1
  %137 = and i64 %136, 9223372036854775680
  %138 = sub nsw i64 %indvars.iv801, %137
  %139 = add i64 %indvars.iv808, %137
  %140 = mul nuw nsw i64 %polly.indvar363, 25
  %pexp.p_div_q366 = lshr i64 %140, 6
...
polly.loop_exit369:                               ; preds = %polly.loop_exit375
  ...
  %indvars.iv.next802 = add nuw nsw i64 %indvars.iv801, 50
  %indvars.iv.next804 = add nuw nsw i64 %indvars.iv803, 25
  %indvars.iv.next809 = add nsw i64 %indvars.iv808, -50
  %exitcond818.not = icmp eq i64 %polly.indvar_next364, 24
...
vector.body968:                                   ; preds = %vector.body968, %vector.ph970
  ...
  %wide.load977 = load <4 x double>, <4 x double>* %168, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %171, label %middle.block966, label %vector.body968, !llvm.loop !85
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %174 = shl nuw nsw i64 %indvars.iv824, 1
  %175 = and i64 %174, 9223372036854775680
  %176 = sub nsw i64 %indvars.iv822, %175
  %177 = add i64 %indvars.iv829, %175
  %178 = mul nuw nsw i64 %polly.indvar521, 25
  %pexp.p_div_q524 = lshr i64 %178, 6
  %179 = mul nuw nsw i64 %polly.indvar521, 50
  %180 = mul nsw i64 %polly.indvar521, -50
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next823 = add nuw nsw i64 %indvars.iv822, 50
  %indvars.iv.next825 = add nuw nsw i64 %indvars.iv824, 25
  %indvars.iv.next830 = add nsw i64 %indvars.iv829, -50
  %exitcond839.not = icmp eq i64 %polly.indvar_next522, 24
...
vector.body906:                                   ; preds = %vector.body906, %vector.ph908
  ...
  br i1 %223, label %polly.loop_exit714, label %vector.body906, !llvm.loop !94
...
vector.body921:                                   ; preds = %vector.body921, %vector.ph924
  ...
  br i1 %252, label %polly.loop_exit741, label %vector.body921, !llvm.loop !97
...
vector.body939:                                   ; preds = %vector.body939, %vector.ph942
  ...
  br i1 %281, label %polly.loop_exit767, label %vector.body939, !llvm.loop !100
