; ModuleID = 'syr2k_exhaustive/mmp_all_SM_190.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_190.c"
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %indvars.iv.next1091 = add nuw nsw i64 %indvars.iv1090, 20
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %118 = mul nsw i64 %indvar1413, -8
  %119 = add i64 %104, %118
  %smax1415 = call i64 @llvm.smax.i64(i64 %119, i64 0)
  %120 = shl nuw nsw i64 %indvar1413, 3
  %121 = add i64 %106, %120
...
polly.loop_exit267:                               ; preds = %polly.loop_exit274.loopexit.us, %polly.loop_header265.preheader
  ...
  %indvars.iv.next1099 = add i64 %indvars.iv1098, 8
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us, %polly.loop_header228.split
  ...
  %polly.loop_guard275 = icmp slt i64 %137, 8
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  ...
  %smin1418 = call i64 @llvm.smin.i64(i64 %138, i64 19)
  %139 = add nsw i64 %smin1418, 1
  %smin1102 = call i64 @llvm.smin.i64(i64 %indvars.iv1100, i64 19)
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %180 = sub i64 %175, %179
  %181 = mul nsw i64 %polly.indvar421, -20
  %182 = add i64 %181, %179
  ...
  %188 = mul nuw nsw i64 %polly.indvar421, 20
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %189 = mul nsw i64 %polly.indvar421, -20
...
polly.loop_exit443:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1123 = add nuw nsw i64 %indvars.iv1122, 20
  %indvars.iv.next1125 = add nuw nsw i64 %indvars.iv1124, 2
  %indvars.iv.next1130 = add nsw i64 %indvars.iv1129, -20
  %exitcond1139.not = icmp eq i64 %polly.indvar_next422, 60
...
polly.loop_exit482:                               ; preds = %polly.loop_exit489.loopexit.us, %polly.loop_header480.preheader
  ...
  %indvars.iv.next1127 = add i64 %indvars.iv1126, -8
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header441.split
  ...
  %polly.loop_guard490 = icmp slt i64 %213, 8
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1368 = call i64 @llvm.smin.i64(i64 %214, i64 19)
  %215 = add nsw i64 %smin1368, 1
  %smin1135 = call i64 @llvm.smin.i64(i64 %indvars.iv1133, i64 19)
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %264 = mul nuw nsw i64 %polly.indvar636, 20
  br label %polly.loop_header639

polly.loop_exit641:                               ; preds = %polly.loop_exit647
  %265 = mul nsw i64 %polly.indvar636, -20
...
polly.loop_exit658:                               ; preds = %polly.loop_exit697
  ...
  %indvars.iv.next1156 = add nuw nsw i64 %indvars.iv1155, 20
  %indvars.iv.next1158 = add nuw nsw i64 %indvars.iv1157, 2
  %indvars.iv.next1163 = add nsw i64 %indvars.iv1162, -20
  %exitcond1172.not = icmp eq i64 %polly.indvar_next637, 60
...
polly.loop_exit697:                               ; preds = %polly.loop_exit704.loopexit.us, %polly.loop_header695.preheader
  ...
  %indvars.iv.next1160 = add i64 %indvars.iv1159, -8
  %indvars.iv.next1165 = add i64 %indvars.iv1164, 8
...
polly.loop_header695.preheader:                   ; preds = %polly.loop_exit683, %polly.loop_exit683.us, %polly.loop_header656.split
  ...
  %polly.loop_guard705 = icmp slt i64 %289, 8
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  ...
  %smin1318 = call i64 @llvm.smin.i64(i64 %290, i64 19)
  %291 = add nsw i64 %smin1318, 1
  %smin1168 = call i64 @llvm.smin.i64(i64 %indvars.iv1166, i64 19)
