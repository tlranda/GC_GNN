; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4694.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4694.c"
...
vector.body1081:                                  ; preds = %vector.body1081, %vector.ph1082
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call807, i64 %indvars.iv7.i, i64 %index1083
...
vector.body1143:                                  ; preds = %vector.body1143, %vector.ph1145
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call807, i64 %indvars.iv21.i, i64 %index1148
...
vector.body1166:                                  ; preds = %vector.body1166, %vector.ph1168
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call807, i64 %indvars.iv21.i52, i64 %index1171
  ...
  br i1 %57, label %middle.block1164, label %vector.body1166, !llvm.loop !54
...
vector.body1192:                                  ; preds = %vector.body1192, %vector.ph1194
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call807, i64 %indvars.iv21.i91, i64 %index1197
  ...
  br i1 %68, label %middle.block1190, label %vector.body1192, !llvm.loop !56
...
vector.body1204:                                  ; preds = %vector.body1204, %vector.ph1208
  ...
  %wide.load1215 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !62, !noalias !64
  ...
  br i1 %95, label %middle.block1202, label %vector.body1204, !llvm.loop !68
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %100 = mul nuw nsw i64 %polly.indvar214, 100
  %101 = sub nsw i64 %98, %100
  %102 = add nuw nsw i64 %100, 100
...
polly.loop_header217:                             ; preds = %polly.loop_exit248, %polly.loop_header211
  ...
  %smin983 = call i64 @llvm.smin.i64(i64 %indvars.iv979, i64 99)
...
polly.merge.us:                                   ; preds = %polly.then.us, %polly.cond.loopexit.us
  ...
  %exitcond982.not = icmp eq i64 %polly.indvar_next227.us, 100
...
polly.loop_exit248:                               ; preds = %polly.loop_exit255.loopexit.us, %polly.loop_header217.split, %polly.loop_header246.preheader
  ...
  %exitcond986.not = icmp eq i64 %polly.indvar_next221, 50
...
polly.loop_exit255.loopexit.us:                   ; preds = %polly.loop_header253.us
  ...
  %exitcond985.not = icmp eq i64 %polly.indvar_next250.us, 100
...
polly.loop_header365:                             ; preds = %polly.loop_exit373, %polly.start279
  %indvar1179 = phi i64 [ %indvar.next1180, %polly.loop_exit373 ], [ 0, %polly.start279 ]
  %polly.indvar368 = phi i64 [ %polly.indvar_next369, %polly.loop_exit373 ], [ 1, %polly.start279 ]
  %118 = add i64 %indvar1179, 1
  %119 = mul nuw nsw i64 %polly.indvar368, 9600
  %scevgep377 = getelementptr i8, i8* %call, i64 %119
  %min.iters.check1181 = icmp ult i64 %118, 4
  br i1 %min.iters.check1181, label %polly.loop_header371.preheader, label %vector.ph1182

vector.ph1182:                                    ; preds = %polly.loop_header365
  %n.vec1184 = and i64 %118, -4
...
vector.body1178:                                  ; preds = %vector.body1178, %vector.ph1182
  ...
  %120 = shl nuw nsw i64 %index1185, 3
  %121 = getelementptr i8, i8* %scevgep377, i64 %120
  %122 = bitcast i8* %121 to <4 x double>*
  %wide.load1189 = load <4 x double>, <4 x double>* %122, align 8, !alias.scope !73, !noalias !75
  %123 = fmul fast <4 x double> %wide.load1189, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %125 = icmp eq i64 %index.next1186, %n.vec1184
  br i1 %125, label %middle.block1176, label %vector.body1178, !llvm.loop !79

middle.block1176:                                 ; preds = %vector.body1178
  %cmp.n1188 = icmp eq i64 %118, %n.vec1184
  br i1 %cmp.n1188, label %polly.loop_exit373, label %polly.loop_header371.preheader

polly.loop_header371.preheader:                   ; preds = %polly.loop_header365, %middle.block1176
  %polly.indvar374.ph = phi i64 [ 0, %polly.loop_header365 ], [ %n.vec1184, %middle.block1176 ]
  br label %polly.loop_header371

polly.loop_exit373:                               ; preds = %polly.loop_header371, %middle.block1176
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %127 = lshr i64 %polly.indvar384, 1
  %128 = mul nuw nsw i64 %polly.indvar384, 50
...
polly.loop_exit389:                               ; preds = %polly.loop_exit396
  ...
  %exitcond1008.not = icmp eq i64 %polly.indvar_next385, 24
...
polly.loop_header394:                             ; preds = %polly.loop_exit402, %polly.loop_header387
  ...
  %130 = mul nuw nsw i64 %polly.indvar397, 100
  %131 = sub nsw i64 %128, %130
  %132 = add nuw nsw i64 %130, 100
...
polly.merge425.us:                                ; preds = %polly.then426.us, %polly.cond424.loopexit.us
  ...
  %exitcond1001.not = icmp eq i64 %polly.indvar_next410.us, 100
...
polly.loop_exit437:                               ; preds = %polly.loop_exit444.loopexit.us, %polly.loop_header400.split, %polly.loop_header435.preheader
  ...
  %exitcond1005.not = icmp eq i64 %polly.indvar_next404, 50
...
polly.loop_header406:                             ; preds = %polly.loop_header400.split, %polly.loop_header406
  ...
  %polly.access.add.call1430 = add nuw nsw i64 %135, %polly.indvar409
  ...
  %polly.access.add.Packed_MemRef_call1282433 = add nsw i64 %polly.access.mul.Packed_MemRef_call1282432, %133
  ...
  %exitcond992.not = icmp eq i64 %polly.indvar_next410, 100
  br i1 %exitcond992.not, label %polly.loop_header435.preheader, label %polly.loop_header406
...
polly.loop_exit444.loopexit.us:                   ; preds = %polly.loop_header442.us
  ...
  %exitcond1004.not = icmp eq i64 %polly.indvar_next439.us, 100
  br i1 %exitcond1004.not, label %polly.loop_exit437, label %polly.loop_header435.us

polly.start468:                                   ; preds = %init_array.exit
  %malloccall470 = tail call dereferenceable_or_null(960000) i8* @malloc(i64 960000) #6
...
polly.loop_header554:                             ; preds = %polly.loop_exit562, %polly.start468
  ...
  %min.iters.check1155 = icmp ult i64 %148, 4
  br i1 %min.iters.check1155, label %polly.loop_header560.preheader, label %vector.ph1156

vector.ph1156:                                    ; preds = %polly.loop_header554
  %n.vec1158 = and i64 %148, -4
...
vector.body1154:                                  ; preds = %vector.body1154, %vector.ph1156
  ...
  %150 = shl nuw nsw i64 %index1159, 3
  %151 = getelementptr i8, i8* %scevgep566, i64 %150
  %152 = bitcast i8* %151 to <4 x double>*
  %wide.load1163 = load <4 x double>, <4 x double>* %152, align 8, !alias.scope !83, !noalias !85
  %153 = fmul fast <4 x double> %wide.load1163, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %155 = icmp eq i64 %index.next1160, %n.vec1158
  br i1 %155, label %middle.block1152, label %vector.body1154, !llvm.loop !89

middle.block1152:                                 ; preds = %vector.body1154
  %cmp.n1162 = icmp eq i64 %148, %n.vec1158
  br i1 %cmp.n1162, label %polly.loop_exit562, label %polly.loop_header560.preheader

polly.loop_header560.preheader:                   ; preds = %polly.loop_header554, %middle.block1152
  %polly.indvar563.ph = phi i64 [ 0, %polly.loop_header554 ], [ %n.vec1158, %middle.block1152 ]
  br label %polly.loop_header560

polly.loop_exit562:                               ; preds = %polly.loop_header560, %middle.block1152
...
polly.loop_header570:                             ; preds = %polly.loop_header570.preheader, %polly.loop_exit578
  ...
  %157 = lshr i64 %polly.indvar573, 1
  %158 = mul nuw nsw i64 %polly.indvar573, 50
  br label %polly.loop_header576

polly.loop_exit578:                               ; preds = %polly.loop_exit585
  %polly.indvar_next574 = add nuw nsw i64 %polly.indvar573, 1
  %indvars.iv.next1013 = add nuw nsw i64 %indvars.iv1012, 50
  %exitcond1027.not = icmp eq i64 %polly.indvar_next574, 24
...
polly.loop_header576:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %159 = mul nuw nsw i64 %polly.indvar579, 100
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %exitcond1026.not = icmp eq i64 %polly.indvar_next580, 10
...
polly.loop_header583:                             ; preds = %polly.loop_exit591, %polly.loop_header576
  ...
  %160 = mul nuw nsw i64 %polly.indvar586, 100
  %161 = sub nsw i64 %158, %160
  %162 = add nuw nsw i64 %160, 100
...
polly.loop_header589:                             ; preds = %polly.loop_exit626, %polly.loop_header583
  ...
  %smin1021 = call i64 @llvm.smin.i64(i64 %indvars.iv1016, i64 99)
...
polly.merge614.us:                                ; preds = %polly.then615.us, %polly.cond613.loopexit.us
  ...
  %exitcond1020.not = icmp eq i64 %polly.indvar_next599.us, 100
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633.loopexit.us, %polly.loop_header589.split, %polly.loop_header624.preheader
  ...
  %exitcond1024.not = icmp eq i64 %polly.indvar_next593, 50
...
polly.loop_header595:                             ; preds = %polly.loop_header589.split, %polly.loop_header595
  ...
  %polly.access.add.call1619 = add nuw nsw i64 %165, %polly.indvar598
  ...
  %polly.access.add.Packed_MemRef_call1471622 = add nsw i64 %polly.access.mul.Packed_MemRef_call1471621, %163
  ...
  %exitcond1011.not = icmp eq i64 %polly.indvar_next599, 100
  br i1 %exitcond1011.not, label %polly.loop_header624.preheader, label %polly.loop_header595
...
polly.loop_exit633.loopexit.us:                   ; preds = %polly.loop_header631.us
  ...
  %exitcond1023.not = icmp eq i64 %polly.indvar_next628.us, 100
...
polly.loop_header793:                             ; preds = %polly.loop_exit801, %polly.loop_header787
  ...
  br i1 %min.iters.check, label %polly.loop_header799, label %vector.ph1094

vector.ph1094:                                    ; preds = %polly.loop_header793
  %broadcast.splatinsert1101 = insertelement <4 x i64> poison, i64 %182, i32 0
  %broadcast.splat1102 = shufflevector <4 x i64> %broadcast.splatinsert1101, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1103 = insertelement <4 x i32> poison, i32 %185, i32 0
...
vector.body1093:                                  ; preds = %vector.body1093, %vector.ph1094
  ...
  %187 = add nuw nsw <4 x i64> %vec.ind1099, %broadcast.splat1102
  %188 = trunc <4 x i64> %187 to <4 x i32>
  %189 = mul <4 x i32> %broadcast.splat1104, %188
  ...
  %199 = icmp eq i64 %index.next1096, %181
  br i1 %199, label %polly.loop_exit801, label %vector.body1093, !llvm.loop !98

polly.loop_exit801:                               ; preds = %vector.body1093, %polly.loop_header799
...
polly.loop_header814:                             ; preds = %polly.loop_exit822, %polly.loop_header808
  ...
  %smin1108 = call i64 @llvm.smin.i64(i64 %209, i64 -968)
  %210 = add nsw i64 %smin1108, 1000
...
polly.loop_header820:                             ; preds = %polly.loop_exit828, %polly.loop_header814
  ...
  %min.iters.check1109 = icmp eq i64 %210, 0
  br i1 %min.iters.check1109, label %polly.loop_header826, label %vector.ph1110

vector.ph1110:                                    ; preds = %polly.loop_header820
  %broadcast.splatinsert1119 = insertelement <4 x i64> poison, i64 %211, i32 0
  %broadcast.splat1120 = shufflevector <4 x i64> %broadcast.splatinsert1119, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1121 = insertelement <4 x i32> poison, i32 %214, i32 0
...
vector.body1107:                                  ; preds = %vector.body1107, %vector.ph1110
  ...
  %216 = add nuw nsw <4 x i64> %vec.ind1117, %broadcast.splat1120
  %217 = trunc <4 x i64> %216 to <4 x i32>
  %218 = mul <4 x i32> %broadcast.splat1122, %217
  ...
  %228 = icmp eq i64 %index.next1114, %210
  br i1 %228, label %polly.loop_exit828, label %vector.body1107, !llvm.loop !101

polly.loop_exit828:                               ; preds = %vector.body1107, %polly.loop_header826
...
polly.loop_header840:                             ; preds = %polly.loop_exit848, %polly.loop_header834
  ...
  %smin1126 = call i64 @llvm.smin.i64(i64 %238, i64 -968)
  %239 = add nsw i64 %smin1126, 1000
...
polly.loop_header846:                             ; preds = %polly.loop_exit854, %polly.loop_header840
  ...
  %min.iters.check1127 = icmp eq i64 %239, 0
  br i1 %min.iters.check1127, label %polly.loop_header852, label %vector.ph1128

vector.ph1128:                                    ; preds = %polly.loop_header846
  %broadcast.splatinsert1137 = insertelement <4 x i64> poison, i64 %240, i32 0
  %broadcast.splat1138 = shufflevector <4 x i64> %broadcast.splatinsert1137, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1139 = insertelement <4 x i32> poison, i32 %243, i32 0
...
vector.body1125:                                  ; preds = %vector.body1125, %vector.ph1128
  ...
  %245 = add nuw nsw <4 x i64> %vec.ind1135, %broadcast.splat1138
  %246 = trunc <4 x i64> %245 to <4 x i32>
  %247 = mul <4 x i32> %broadcast.splat1140, %246
  ...
  %257 = icmp eq i64 %index.next1132, %239
  br i1 %257, label %polly.loop_exit854, label %vector.body1125, !llvm.loop !104

polly.loop_exit854:                               ; preds = %vector.body1125, %polly.loop_header852
