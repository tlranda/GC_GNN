; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8949.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8949.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next782 = add nsw i64 %indvars.iv781, -100
  %exitcond788.not = icmp eq i64 %polly.indvar_next203, 12
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit361
  ...
  %132 = mul nuw nsw i64 %polly.indvar355, 100
  %133 = mul nsw i64 %polly.indvar355, -100
  br label %polly.loop_header359

polly.loop_exit361:                               ; preds = %polly.loop_exit367
  %polly.indvar_next356 = add nuw nsw i64 %polly.indvar355, 1
  %indvars.iv.next792 = add nuw nsw i64 %indvars.iv791, 100
...
polly.loop_header359:                             ; preds = %polly.loop_exit367, %polly.loop_header352
  ...
  %135 = mul nuw nsw i64 %polly.indvar362, 80
  %136 = sub nsw i64 %132, %135
  %137 = icmp sgt i64 %136, 0
  %138 = select i1 %137, i64 %136, i64 0
  %polly.loop_guard375 = icmp slt i64 %138, 80
...
polly.loop_exit367:                               ; preds = %polly.loop_exit374.loopexit.us, %polly.loop_header359
  ...
  %indvars.iv.next799 = add i64 %indvars.iv798, 80
...
polly.loop_header508:                             ; preds = %polly.loop_exit500, %polly.loop_exit517
  ...
  %162 = mul nuw nsw i64 %polly.indvar511, 100
  %163 = mul nsw i64 %polly.indvar511, -100
...
polly.loop_exit517:                               ; preds = %polly.loop_exit523
  ...
  %indvars.iv.next809 = add nuw nsw i64 %indvars.iv808, 100
  %indvars.iv.next814 = add nsw i64 %indvars.iv813, -100
  %exitcond822.not = icmp eq i64 %polly.indvar_next512, 12
...
polly.loop_header515:                             ; preds = %polly.loop_exit523, %polly.loop_header508
  ...
  %165 = mul nuw nsw i64 %polly.indvar518, 80
  %166 = sub nsw i64 %162, %165
  %167 = icmp sgt i64 %166, 0
  %168 = select i1 %167, i64 %166, i64 0
  %polly.loop_guard531 = icmp slt i64 %168, 80
