; ModuleID = 'syr2k_exhaustive/mmp_all_SM_9149.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_9149.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond778.not = icmp eq i64 %polly.indvar_next209, 12
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225
  ...
  %exitcond777.not = icmp eq i64 %polly.indvar_next215, 12
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph964
  ...
  %wide.load971 = load <4 x double>, <4 x double>* %116, align 8, !alias.scope !71, !noalias !73
  ...
  br i1 %119, label %middle.block958, label %vector.body960, !llvm.loop !76
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit360
  ...
  %121 = shl nsw i64 %polly.indvar355, 6
...
polly.loop_exit366:                               ; preds = %polly.loop_exit372
  ...
  %exitcond794.not = icmp eq i64 %polly.indvar_next362, 12
...
polly.loop_exit372:                               ; preds = %polly.loop_exit378
  ...
  %indvars.iv.next783 = add nuw nsw i64 %indvars.iv782, 100
  %exitcond793.not = icmp eq i64 %polly.indvar_next368, 12
...
polly.loop_header376:                             ; preds = %polly.loop_exit384, %polly.loop_header370
  ...
  %smin786 = call i64 @llvm.smin.i64(i64 %indvars.iv784, i64 99)
...
polly.loop_exit384:                               ; preds = %polly.loop_header382
  ...
  %exitcond788.not = icmp eq i64 %polly.indvar_next380, 100
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  %wide.load945 = load <4 x double>, <4 x double>* %140, align 8, !alias.scope !80, !noalias !82
  ...
  br i1 %143, label %middle.block934, label %vector.body936, !llvm.loop !85
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit513
  ...
  %145 = shl nsw i64 %polly.indvar508, 6
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %147 = mul nuw nsw i64 %polly.indvar514, 100
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond810.not = icmp eq i64 %polly.indvar_next515, 12
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %148 = mul nuw nsw i64 %polly.indvar520, 100
...
polly.loop_exit525:                               ; preds = %polly.loop_exit531
  ...
  %exitcond809.not = icmp eq i64 %polly.indvar_next521, 12
...
polly.loop_header529:                             ; preds = %polly.loop_exit537, %polly.loop_header523
  ...
  %smin802 = call i64 @llvm.smin.i64(i64 %indvars.iv800, i64 99)
...
polly.loop_exit537:                               ; preds = %polly.loop_header535
  ...
  %exitcond804.not = icmp eq i64 %polly.indvar_next533, 100
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph876
  ...
  br i1 %181, label %polly.loop_exit702, label %vector.body874, !llvm.loop !94
...
vector.body889:                                   ; preds = %vector.body889, %vector.ph892
  ...
  br i1 %210, label %polly.loop_exit729, label %vector.body889, !llvm.loop !97
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  br i1 %239, label %polly.loop_exit755, label %vector.body907, !llvm.loop !100
