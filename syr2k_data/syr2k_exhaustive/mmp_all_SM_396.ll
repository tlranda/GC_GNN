; ModuleID = 'syr2k_exhaustive/mmp_all_SM_396.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_396.c"
...
polly.loop_header263.preheader:                   ; preds = %polly.loop_exit252, %polly.loop_exit252.us, %polly.loop_header228.split
  ...
  %polly.loop_guard273 = icmp slt i64 %133, 20
...
vector.body1397:                                  ; preds = %vector.body1397, %vector.ph1405
  ...
  %wide.load1418 = load <4 x double>, <4 x double>* %153, align 8, !alias.scope !71, !noalias !73
  ...
  store <4 x double> %156, <4 x double>* %157, align 8, !alias.scope !71, !noalias !73
  %index.next1409 = add i64 %index1408, 4
  %158 = icmp eq i64 %index.next1409, %n.vec1407
  br i1 %158, label %middle.block1395, label %vector.body1397, !llvm.loop !84
...
vector.body1333:                                  ; preds = %vector.body1333, %vector.ph1337
  ...
  %wide.load1344 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %165, <4 x double>* %166, align 8, !alias.scope !85, !noalias !87
  %index.next1341 = add i64 %index1340, 4
  %167 = icmp eq i64 %index.next1341, %n.vec1339
  br i1 %167, label %middle.block1331, label %vector.body1333, !llvm.loop !92
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header439.split
  ...
  %polly.loop_guard490 = icmp slt i64 %205, 20
...
vector.body1347:                                  ; preds = %vector.body1347, %vector.ph1355
  ...
  %wide.load1368 = load <4 x double>, <4 x double>* %225, align 8, !alias.scope !85, !noalias !87
  ...
  store <4 x double> %228, <4 x double>* %229, align 8, !alias.scope !85, !noalias !87
  %index.next1359 = add i64 %index1358, 4
  %230 = icmp eq i64 %index.next1359, %n.vec1357
  br i1 %230, label %middle.block1345, label %vector.body1347, !llvm.loop !97
...
vector.body1285:                                  ; preds = %vector.body1285, %vector.ph1287
  ...
  %wide.load1294 = load <4 x double>, <4 x double>* %236, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %237, <4 x double>* %238, align 8, !alias.scope !98, !noalias !100
  %index.next1291 = add i64 %index1290, 4
  %239 = icmp eq i64 %index.next1291, %n.vec1289
  br i1 %239, label %middle.block1283, label %vector.body1285, !llvm.loop !105
...
polly.loop_header697.preheader:                   ; preds = %polly.loop_exit685, %polly.loop_exit685.us, %polly.loop_header656.split
  ...
  %polly.loop_guard707 = icmp slt i64 %277, 20
...
vector.body1297:                                  ; preds = %vector.body1297, %vector.ph1305
  ...
  %wide.load1318 = load <4 x double>, <4 x double>* %297, align 8, !alias.scope !98, !noalias !100
  ...
  store <4 x double> %300, <4 x double>* %301, align 8, !alias.scope !98, !noalias !100
  %index.next1309 = add i64 %index1308, 4
  %302 = icmp eq i64 %index.next1309, %n.vec1307
  br i1 %302, label %middle.block1295, label %vector.body1297, !llvm.loop !110
...
vector.body1223:                                  ; preds = %vector.body1223, %vector.ph1225
  ...
  store <4 x double> %319, <4 x double>* %324, align 8, !alias.scope !111, !noalias !113
  ...
  br i1 %325, label %polly.loop_exit884, label %vector.body1223, !llvm.loop !116
...
vector.body1238:                                  ; preds = %vector.body1238, %vector.ph1241
  ...
  store <4 x double> %348, <4 x double>* %353, align 8, !alias.scope !115, !noalias !118
  ...
  br i1 %354, label %polly.loop_exit911, label %vector.body1238, !llvm.loop !119
...
vector.body1256:                                  ; preds = %vector.body1256, %vector.ph1259
  ...
  store <4 x double> %377, <4 x double>* %382, align 8, !alias.scope !114, !noalias !121
  ...
  br i1 %383, label %polly.loop_exit937, label %vector.body1256, !llvm.loop !122
