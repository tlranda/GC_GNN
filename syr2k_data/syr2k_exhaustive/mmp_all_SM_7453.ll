; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7453.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7453.c"
...
vector.body1028:                                  ; preds = %vector.body1028, %vector.ph1030
  ...
  br i1 %57, label %middle.block1026, label %vector.body1028, !llvm.loop !53
...
vector.body1054:                                  ; preds = %vector.body1054, %vector.ph1056
  ...
  br i1 %68, label %middle.block1052, label %vector.body1054, !llvm.loop !55
...
vector.body1066:                                  ; preds = %vector.body1066, %vector.ph1070
  ...
  %wide.load1077 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !61, !noalias !63
  ...
  br i1 %95, label %middle.block1064, label %vector.body1066, !llvm.loop !67
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond848.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !68
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  ...
  %smin839 = call i64 @llvm.smin.i64(i64 %indvars.iv837, i64 -1136)
  %97 = shl nsw i64 %polly.indvar218, 6
...
polly.loop_header227:                             ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %101 = shl nsw i64 %polly.indvar230, 6
...
vector.body1040:                                  ; preds = %vector.body1040, %vector.ph1044
  ...
  %wide.load1051 = load <4 x double>, <4 x double>* %119, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %122, label %middle.block1038, label %vector.body1040, !llvm.loop !78
...
polly.loop_header362:                             ; preds = %polly.loop_header362.preheader, %polly.loop_header362
  ...
  br i1 %exitcond873.not, label %polly.loop_exit364, label %polly.loop_header362, !llvm.loop !79
...
polly.loop_header388:                             ; preds = %polly.loop_exit380, %polly.loop_exit396
  ...
  %124 = shl nsw i64 %polly.indvar391, 6
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond870.not = icmp eq i64 %polly.indvar_next392, 19
...
polly.loop_header400:                             ; preds = %polly.loop_exit408, %polly.loop_header394
  ...
  %128 = shl nsw i64 %polly.indvar403, 6
...
vector.body1016:                                  ; preds = %vector.body1016, %vector.ph1018
  ...
  %wide.load1025 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !82, !noalias !84
  ...
  store <4 x double> %147, <4 x double>* %148, align 8, !alias.scope !82, !noalias !84
  %index.next1022 = add i64 %index1021, 4
  %149 = icmp eq i64 %index.next1022, %n.vec1020
  br i1 %149, label %middle.block1014, label %vector.body1016, !llvm.loop !88
...
polly.loop_header537:                             ; preds = %polly.loop_header537.preheader, %polly.loop_header537
  ...
  br i1 %exitcond898.not, label %polly.loop_exit539, label %polly.loop_header537, !llvm.loop !89
...
polly.loop_header563:                             ; preds = %polly.loop_exit555, %polly.loop_exit571
  ...
  %smin889 = call i64 @llvm.smin.i64(i64 %indvars.iv887, i64 -1136)
  %151 = shl nsw i64 %polly.indvar566, 6
...
polly.loop_exit571:                               ; preds = %polly.loop_exit577
  ...
  %indvars.iv.next876 = add nuw nsw i64 %indvars.iv875, 64
  %indvars.iv.next888 = add nsw i64 %indvars.iv887, -64
  %indvars.iv.next892 = add nuw nsw i64 %indvars.iv891, 1
  %exitcond895.not = icmp eq i64 %polly.indvar_next567, 19
...
polly.loop_header575:                             ; preds = %polly.loop_exit583, %polly.loop_header569
  ...
  %155 = shl nsw i64 %polly.indvar578, 6
...
polly.loop_header581:                             ; preds = %polly.loop_exit589, %polly.loop_header575
  ...
  %smin881 = call i64 @llvm.smin.i64(i64 %indvars.iv879, i64 63)
...
vector.body954:                                   ; preds = %vector.body954, %vector.ph956
  ...
  store <4 x double> %184, <4 x double>* %189, align 8, !alias.scope !92, !noalias !94
  ...
  br i1 %190, label %polly.loop_exit764, label %vector.body954, !llvm.loop !97
...
polly.loop_header762:                             ; preds = %polly.loop_header756, %polly.loop_header762
  ...
  br i1 %exitcond923.not, label %polly.loop_exit764, label %polly.loop_header762, !llvm.loop !98
...
vector.body969:                                   ; preds = %vector.body969, %vector.ph972
  ...
  store <4 x double> %213, <4 x double>* %218, align 8, !alias.scope !96, !noalias !99
  ...
  br i1 %219, label %polly.loop_exit791, label %vector.body969, !llvm.loop !100
...
polly.loop_header789:                             ; preds = %polly.loop_header783, %polly.loop_header789
  ...
  br i1 %exitcond913.not, label %polly.loop_exit791, label %polly.loop_header789, !llvm.loop !101
...
vector.body987:                                   ; preds = %vector.body987, %vector.ph990
  ...
  store <4 x double> %242, <4 x double>* %247, align 8, !alias.scope !95, !noalias !102
  ...
  br i1 %248, label %polly.loop_exit817, label %vector.body987, !llvm.loop !103
...
polly.loop_header815:                             ; preds = %polly.loop_header809, %polly.loop_header815
  ...
  br i1 %exitcond903.not, label %polly.loop_exit817, label %polly.loop_header815, !llvm.loop !104
}
