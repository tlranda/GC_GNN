; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5072.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5072.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %umin = call i64 @llvm.umin.i64(i64 %indvars.iv976, i64 138)
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next977 = add nuw nsw i64 %indvars.iv976, 12
  %exitcond979.not = icmp eq i64 %polly.indvar_next203, 13
...
polly.loop_header211.preheader:                   ; preds = %polly.loop_header205
  ...
  %107 = add i64 %smax, %indvars.iv967
  %108 = sub nsw i64 %101, %103
  %109 = add nuw nsw i64 %103, 8
  br label %polly.loop_header211

polly.loop_exit213:                               ; preds = %polly.loop_exit244, %polly.loop_header205
  %polly.indvar_next209 = add nuw nsw i64 %polly.indvar208, 1
  %indvars.iv.next964 = add nsw i64 %indvars.iv963, 8
  %indvars.iv.next968 = add nsw i64 %indvars.iv967, -8
  %exitcond978.not = icmp eq i64 %polly.indvar208, %102
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit244
  %indvars.iv969 = phi i64 [ %107, %polly.loop_header211.preheader ], [ %indvars.iv.next970, %polly.loop_exit244 ]
  %polly.indvar214 = phi i64 [ %106, %polly.loop_header211.preheader ], [ %polly.indvar_next215, %polly.loop_exit244 ]
  %smin973 = call i64 @llvm.smin.i64(i64 %indvars.iv969, i64 7)
  %110 = add nsw i64 %polly.indvar214, %108
  %polly.loop_guard2271066 = icmp sgt i64 %110, -1
  %111 = add nuw nsw i64 %polly.indvar214, %101
...
vector.body1180:                                  ; preds = %vector.body1180, %vector.ph1184
  ...
  %122 = shl nuw nsw i64 %index1187, 3
  %123 = getelementptr i8, i8* %scevgep375, i64 %122
  %124 = bitcast i8* %123 to <4 x double>*
  %wide.load1191 = load <4 x double>, <4 x double>* %124, align 8, !alias.scope !74, !noalias !76
  %125 = fmul fast <4 x double> %wide.load1191, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %127 = icmp eq i64 %index.next1188, %n.vec1186
  br i1 %127, label %middle.block1178, label %vector.body1180, !llvm.loop !80

middle.block1178:                                 ; preds = %vector.body1180
  %cmp.n1190 = icmp eq i64 %120, %n.vec1186
...
polly.loop_header379:                             ; preds = %polly.loop_header379.preheader, %polly.loop_exit387
  %indvars.iv1000 = phi i64 [ 0, %polly.loop_header379.preheader ], [ %indvars.iv.next1001, %polly.loop_exit387 ]
  ...
  %umin1002 = call i64 @llvm.umin.i64(i64 %indvars.iv1000, i64 138)
  %129 = mul nsw i64 %polly.indvar382, -96
  %130 = icmp slt i64 %129, -1104
  %131 = select i1 %130, i64 %129, i64 -1104
  %132 = add nsw i64 %131, 1199
  %133 = mul nuw nsw i64 %polly.indvar382, 96
  %134 = add nuw nsw i64 %umin1002, 11
...
polly.loop_exit387:                               ; preds = %polly.loop_exit394
  ...
  %indvars.iv.next989 = add nuw nsw i64 %indvars.iv988, 96
  %indvars.iv.next1001 = add nuw nsw i64 %indvars.iv1000, 12
  %exitcond1004.not = icmp eq i64 %polly.indvar_next383, 13
...
polly.loop_header385:                             ; preds = %polly.loop_exit394, %polly.loop_header379
  ...
  %135 = shl nsw i64 %polly.indvar388, 3
  %136 = add nsw i64 %135, %129
  %137 = icmp sgt i64 %136, 0
  %138 = select i1 %137, i64 %136, i64 0
  %polly.loop_guard395.not = icmp sgt i64 %138, %132
...
polly.loop_header392.preheader:                   ; preds = %polly.loop_header385
  ...
  %139 = add i64 %smax987, %indvars.iv990
  %140 = sub nsw i64 %133, %135
  %141 = add nuw nsw i64 %135, 8
...
polly.loop_exit394:                               ; preds = %polly.loop_exit430, %polly.loop_header385
  ...
  %indvars.iv.next991 = add nsw i64 %indvars.iv990, -8
  %exitcond1003.not = icmp eq i64 %polly.indvar388, %134
...
polly.loop_header392:                             ; preds = %polly.loop_header392.preheader, %polly.loop_exit430
  %indvars.iv992 = phi i64 [ %139, %polly.loop_header392.preheader ], [ %indvars.iv.next993, %polly.loop_exit430 ]
  %polly.indvar396 = phi i64 [ %138, %polly.loop_header392.preheader ], [ %polly.indvar_next397, %polly.loop_exit430 ]
  %smin997 = call i64 @llvm.smin.i64(i64 %indvars.iv992, i64 7)
  %142 = add nsw i64 %polly.indvar396, %140
  %polly.loop_guard4091067 = icmp sgt i64 %142, -1
  %143 = add nuw nsw i64 %polly.indvar396, %133
  %.not853 = icmp ult i64 %143, %141
  %polly.access.mul.call1422 = mul nsw i64 %143, 1000
...
polly.loop_header406.us:                          ; preds = %polly.loop_header399.us, %polly.loop_header406.us
  ...
  %144 = add nuw nsw i64 %polly.indvar410.us, %135
  %polly.access.mul.call1414.us = mul nuw nsw i64 %144, 1000
...
polly.then419.us:                                 ; preds = %polly.cond417.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1280426.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1280.us, %142
...
polly.loop_exit430:                               ; preds = %polly.loop_exit437.loopexit.us, %polly.loop_header392.split, %polly.loop_header428.preheader
  ...
  %polly.loop_cond398.not.not = icmp ult i64 %polly.indvar396, %132
...
polly.loop_header399:                             ; preds = %polly.loop_header392.split, %polly.loop_header399
  ...
  %polly.access.add.Packed_MemRef_call1280426 = add nsw i64 %polly.access.mul.Packed_MemRef_call1280425, %142
...
polly.loop_header428.us:                          ; preds = %polly.loop_header428.preheader, %polly.loop_exit437.loopexit.us
  ...
  %147 = shl nuw nsw i64 %polly.indvar431.us, 3
  %scevgep446.us = getelementptr i8, i8* %call2, i64 %147
  %polly.access.mul.Packed_MemRef_call1280442.us = mul nuw nsw i64 %polly.indvar431.us, 1200
  %scevgep447.us = getelementptr i8, i8* %scevgep446.us, i64 %145
  ...
  %polly.access.add.Packed_MemRef_call1280455.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1280442.us, %142
...
polly.loop_header435.us:                          ; preds = %polly.loop_header435.us, %polly.loop_header428.us
  ...
  %148 = add nuw nsw i64 %polly.indvar439.us, %135
  ...
  %scevgep451.us = getelementptr i8, i8* %scevgep446.us, i64 %149
  ...
  %150 = shl i64 %148, 3
  %151 = add i64 %150, %146
  %scevgep458.us = getelementptr i8, i8* %call, i64 %151
...
polly.loop_header549:                             ; preds = %polly.loop_exit557, %polly.start463
  ...
  %153 = mul nuw nsw i64 %polly.indvar552, 9600
  %scevgep561 = getelementptr i8, i8* %call, i64 %153
  %min.iters.check1157 = icmp ult i64 %152, 4
...
vector.body1156:                                  ; preds = %vector.body1156, %vector.ph1158
  ...
  %154 = shl nuw nsw i64 %index1161, 3
  %155 = getelementptr i8, i8* %scevgep561, i64 %154
  %156 = bitcast i8* %155 to <4 x double>*
  %wide.load1165 = load <4 x double>, <4 x double>* %156, align 8, !alias.scope !84, !noalias !86
  %157 = fmul fast <4 x double> %wide.load1165, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %159 = icmp eq i64 %index.next1162, %n.vec1160
  br i1 %159, label %middle.block1154, label %vector.body1156, !llvm.loop !90

middle.block1154:                                 ; preds = %vector.body1156
  %cmp.n1164 = icmp eq i64 %152, %n.vec1160
...
polly.loop_header555:                             ; preds = %polly.loop_header555.preheader, %polly.loop_header555
  ...
  %160 = shl nuw nsw i64 %polly.indvar558, 3
  %scevgep562 = getelementptr i8, i8* %scevgep561, i64 %160
...
polly.loop_header565:                             ; preds = %polly.loop_header565.preheader, %polly.loop_exit573
  %indvars.iv1025 = phi i64 [ 0, %polly.loop_header565.preheader ], [ %indvars.iv.next1026, %polly.loop_exit573 ]
  ...
  %umin1027 = call i64 @llvm.umin.i64(i64 %indvars.iv1025, i64 138)
  %161 = mul nsw i64 %polly.indvar568, -96
  %162 = icmp slt i64 %161, -1104
  %163 = select i1 %162, i64 %161, i64 -1104
  %164 = add nsw i64 %163, 1199
  %165 = mul nuw nsw i64 %polly.indvar568, 96
  %166 = add nuw nsw i64 %umin1027, 11
...
polly.loop_exit573:                               ; preds = %polly.loop_exit580
  ...
  %indvars.iv.next1014 = add nuw nsw i64 %indvars.iv1013, 96
  %indvars.iv.next1026 = add nuw nsw i64 %indvars.iv1025, 12
  %exitcond1029.not = icmp eq i64 %polly.indvar_next569, 13
...
polly.loop_header571:                             ; preds = %polly.loop_exit580, %polly.loop_header565
  ...
  %167 = shl nsw i64 %polly.indvar574, 3
  %168 = add nsw i64 %167, %161
  %169 = icmp sgt i64 %168, 0
  %170 = select i1 %169, i64 %168, i64 0
  %polly.loop_guard581.not = icmp sgt i64 %170, %164
...
polly.loop_header578.preheader:                   ; preds = %polly.loop_header571
  ...
  %171 = add i64 %smax1012, %indvars.iv1015
  %172 = sub nsw i64 %165, %167
  %173 = add nuw nsw i64 %167, 8
...
polly.loop_exit580:                               ; preds = %polly.loop_exit616, %polly.loop_header571
  ...
  %indvars.iv.next1011 = add nsw i64 %indvars.iv1010, 8
  %indvars.iv.next1016 = add nsw i64 %indvars.iv1015, -8
  %exitcond1028.not = icmp eq i64 %polly.indvar574, %166
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit616
  %indvars.iv1017 = phi i64 [ %171, %polly.loop_header578.preheader ], [ %indvars.iv.next1018, %polly.loop_exit616 ]
  %polly.indvar582 = phi i64 [ %170, %polly.loop_header578.preheader ], [ %polly.indvar_next583, %polly.loop_exit616 ]
  %smin1022 = call i64 @llvm.smin.i64(i64 %indvars.iv1017, i64 7)
  %174 = add nsw i64 %polly.indvar582, %172
  %polly.loop_guard5951068 = icmp sgt i64 %174, -1
  %175 = add nuw nsw i64 %polly.indvar582, %165
  %.not854 = icmp ult i64 %175, %173
  %polly.access.mul.call1608 = mul nsw i64 %175, 1000
...
polly.loop_header592.us:                          ; preds = %polly.loop_header585.us, %polly.loop_header592.us
  ...
  %176 = add nuw nsw i64 %polly.indvar596.us, %167
  %polly.access.mul.call1600.us = mul nuw nsw i64 %176, 1000
...
polly.then605.us:                                 ; preds = %polly.cond603.loopexit.us
  ...
  %polly.access.add.Packed_MemRef_call1466612.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1466.us, %174
...
polly.loop_exit616:                               ; preds = %polly.loop_exit623.loopexit.us, %polly.loop_header578.split, %polly.loop_header614.preheader
  ...
  %polly.loop_cond584.not.not = icmp ult i64 %polly.indvar582, %164
...
polly.loop_header585:                             ; preds = %polly.loop_header578.split, %polly.loop_header585
  ...
  %polly.access.add.Packed_MemRef_call1466612 = add nsw i64 %polly.access.mul.Packed_MemRef_call1466611, %174
...
polly.loop_header614.us:                          ; preds = %polly.loop_header614.preheader, %polly.loop_exit623.loopexit.us
  ...
  %179 = shl nuw nsw i64 %polly.indvar617.us, 3
  %scevgep632.us = getelementptr i8, i8* %call2, i64 %179
  %polly.access.mul.Packed_MemRef_call1466628.us = mul nuw nsw i64 %polly.indvar617.us, 1200
  %scevgep633.us = getelementptr i8, i8* %scevgep632.us, i64 %177
  ...
  %polly.access.add.Packed_MemRef_call1466641.us = add nsw i64 %polly.access.mul.Packed_MemRef_call1466628.us, %174
...
polly.loop_header621.us:                          ; preds = %polly.loop_header621.us, %polly.loop_header614.us
  ...
  %180 = add nuw nsw i64 %polly.indvar625.us, %167
  ...
  %scevgep637.us = getelementptr i8, i8* %scevgep632.us, i64 %181
  ...
  %182 = shl i64 %180, 3
  %183 = add i64 %182, %178
  %scevgep644.us = getelementptr i8, i8* %call, i64 %183
...
polly.loop_header773:                             ; preds = %entry, %polly.loop_exit781
  ...
  %184 = shl nsw i64 %polly.indvar776, 5
  %185 = add nsw i64 %smin1058, 1199
...
polly.loop_header779:                             ; preds = %polly.loop_exit787, %polly.loop_header773
  ...
  %186 = mul nsw i64 %polly.indvar782, -32
  ...
  %188 = shl nsw i64 %polly.indvar782, 5
  %189 = add nsw i64 %smin1054, 1199
...
polly.loop_header785:                             ; preds = %polly.loop_exit793, %polly.loop_header779
  ...
  %190 = add nuw nsw i64 %polly.indvar788, %184
...
vector.ph1096:                                    ; preds = %polly.loop_header785
  %broadcast.splatinsert1103 = insertelement <4 x i64> poison, i64 %188, i32 0
  %broadcast.splat1104 = shufflevector <4 x i64> %broadcast.splatinsert1103, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1105 = insertelement <4 x i32> poison, i32 %191, i32 0
...
vector.body1095:                                  ; preds = %vector.body1095, %vector.ph1096
  ...
  %193 = add nuw nsw <4 x i64> %vec.ind1101, %broadcast.splat1104
  %194 = trunc <4 x i64> %193 to <4 x i32>
  %195 = mul <4 x i32> %broadcast.splat1106, %194
  ...
  %205 = icmp eq i64 %index.next1098, %187
  br i1 %205, label %polly.loop_exit793, label %vector.body1095, !llvm.loop !99

polly.loop_exit793:                               ; preds = %vector.body1095, %polly.loop_header791
  %polly.indvar_next789 = add nuw nsw i64 %polly.indvar788, 1
  %exitcond1059.not = icmp eq i64 %polly.indvar788, %185
...
polly.loop_header791:                             ; preds = %polly.loop_header785, %polly.loop_header791
  ...
  %206 = add nuw nsw i64 %polly.indvar794, %188
  ...
  %scevgep797 = getelementptr i8, i8* %call, i64 %212
  ...
  %exitcond1055.not = icmp eq i64 %polly.indvar794, %189
...
polly.loop_header800:                             ; preds = %polly.loop_exit781, %polly.loop_exit808
  ...
  %213 = shl nsw i64 %polly.indvar803, 5
  %214 = add nsw i64 %smin1048, 1199
...
polly.loop_header806:                             ; preds = %polly.loop_exit814, %polly.loop_header800
  ...
  %215 = mul nsw i64 %polly.indvar809, -32
  %smin1110 = call i64 @llvm.smin.i64(i64 %215, i64 -968)
  %216 = add nsw i64 %smin1110, 1000
  %smin1044 = call i64 @llvm.smin.i64(i64 %indvars.iv1042, i64 -968)
  %217 = shl nsw i64 %polly.indvar809, 5
  %218 = add nsw i64 %smin1044, 999
...
vector.body1109:                                  ; preds = %vector.body1109, %vector.ph1112
  ...
  %222 = add nuw nsw <4 x i64> %vec.ind1119, %broadcast.splat1122
  %223 = trunc <4 x i64> %222 to <4 x i32>
  %224 = mul <4 x i32> %broadcast.splat1124, %223
  ...
  %234 = icmp eq i64 %index.next1116, %216
  br i1 %234, label %polly.loop_exit820, label %vector.body1109, !llvm.loop !102

polly.loop_exit820:                               ; preds = %vector.body1109, %polly.loop_header818
  %polly.indvar_next816 = add nuw nsw i64 %polly.indvar815, 1
  %exitcond1049.not = icmp eq i64 %polly.indvar815, %214
...
polly.loop_header818:                             ; preds = %polly.loop_header812, %polly.loop_header818
  ...
  %235 = add nuw nsw i64 %polly.indvar821, %217
  ...
  %scevgep824 = getelementptr i8, i8* %call2, i64 %241
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar821, %218
...
polly.loop_header826:                             ; preds = %polly.loop_exit808, %polly.loop_exit834
  ...
  %242 = shl nsw i64 %polly.indvar829, 5
  %243 = add nsw i64 %smin1038, 1199
...
polly.loop_header832:                             ; preds = %polly.loop_exit840, %polly.loop_header826
  ...
  %244 = mul nsw i64 %polly.indvar835, -32
  %smin1128 = call i64 @llvm.smin.i64(i64 %244, i64 -968)
  %245 = add nsw i64 %smin1128, 1000
  %smin1034 = call i64 @llvm.smin.i64(i64 %indvars.iv1032, i64 -968)
  %246 = shl nsw i64 %polly.indvar835, 5
  %247 = add nsw i64 %smin1034, 999
...
vector.body1127:                                  ; preds = %vector.body1127, %vector.ph1130
  ...
  %251 = add nuw nsw <4 x i64> %vec.ind1137, %broadcast.splat1140
  %252 = trunc <4 x i64> %251 to <4 x i32>
  %253 = mul <4 x i32> %broadcast.splat1142, %252
  ...
  %263 = icmp eq i64 %index.next1134, %245
  br i1 %263, label %polly.loop_exit846, label %vector.body1127, !llvm.loop !105

polly.loop_exit846:                               ; preds = %vector.body1127, %polly.loop_header844
  %polly.indvar_next842 = add nuw nsw i64 %polly.indvar841, 1
  %exitcond1039.not = icmp eq i64 %polly.indvar841, %243
...
polly.loop_header844:                             ; preds = %polly.loop_header838, %polly.loop_header844
  ...
  %264 = add nuw nsw i64 %polly.indvar847, %246
  ...
  %scevgep851 = getelementptr i8, i8* %call1, i64 %270
  ...
  %exitcond1035.not = icmp eq i64 %polly.indvar847, %247
