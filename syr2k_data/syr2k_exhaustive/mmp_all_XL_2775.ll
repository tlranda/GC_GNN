; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2775.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2775.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit244
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next203, 60
...
polly.loop_header205:                             ; preds = %polly.loop_exit244, %polly.loop_header199
  ...
  %.inv = icmp ugt i64 %101, 19
  %103 = select i1 %.inv, i64 19, i64 %102
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %138 = mul nuw nsw i64 %polly.indvar386, 5
...
polly.loop_exit391:                               ; preds = %polly.loop_exit430
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar_next387, 60
...
polly.loop_header389:                             ; preds = %polly.loop_exit430, %polly.loop_header383
  ...
  %.inv857 = icmp ugt i64 %142, 19
  %144 = select i1 %.inv857, i64 19, i64 %143
...
polly.loop_header569:                             ; preds = %polly.loop_header569.preheader, %polly.loop_exit577
  ...
  %179 = mul nuw nsw i64 %polly.indvar572, 5
  %180 = mul nsw i64 %polly.indvar572, -20
  %181 = mul nuw nsw i64 %polly.indvar572, 20
...
polly.loop_exit577:                               ; preds = %polly.loop_exit616
  ...
  %exitcond918.not = icmp eq i64 %polly.indvar_next573, 60
...
polly.loop_header575:                             ; preds = %polly.loop_exit616, %polly.loop_header569
  ...
  %.inv858 = icmp ugt i64 %183, 19
  %185 = select i1 %.inv858, i64 19, i64 %184
