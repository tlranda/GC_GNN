; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10079.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10079.c"
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  ...
  %polly.loop_guard233879 = icmp sgt i64 %112, -1
...
vector.body994:                                   ; preds = %vector.body994, %vector.ph998
  ...
  %126 = shl nuw nsw i64 %index1001, 3
  %127 = getelementptr i8, i8* %scevgep350, i64 %126
  %128 = bitcast i8* %127 to <4 x double>*
  %wide.load1005 = load <4 x double>, <4 x double>* %128, align 8, !alias.scope !68, !noalias !70
  %129 = fmul fast <4 x double> %wide.load1005, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %131 = icmp eq i64 %index.next1002, %n.vec1000
  br i1 %131, label %middle.block992, label %vector.body994, !llvm.loop !73

middle.block992:                                  ; preds = %vector.body994
  %cmp.n1004 = icmp eq i64 %124, %n.vec1000
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %133 = udiv i64 %polly.indvar357, 5
  %134 = add nuw i64 %indvars.iv815, %133
  %umin817 = call i64 @llvm.umin.i64(i64 %134, i64 56)
  %135 = mul nsw i64 %polly.indvar357, -64
  %136 = icmp slt i64 %135, -1136
  %137 = select i1 %136, i64 %135, i64 -1136
  %138 = add nsw i64 %137, 1199
  %139 = shl nsw i64 %polly.indvar357, 6
  %140 = add nuw nsw i64 %umin817, 3
...
polly.loop_header374.preheader:                   ; preds = %polly.loop_header367
  ...
  %146 = add i64 %smax805, %indvars.iv808
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond818.not = icmp eq i64 %polly.indvar370, %140
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv810 = phi i64 [ %146, %polly.loop_header374.preheader ], [ %indvars.iv.next811, %polly.loop_exit383 ]
  ...
  %polly.loop_guard391880 = icmp sgt i64 %148, -1
...
vector.body970:                                   ; preds = %vector.body970, %vector.ph972
  ...
  %162 = shl nuw nsw i64 %index975, 3
  %163 = getelementptr i8, i8* %scevgep508, i64 %162
  %164 = bitcast i8* %163 to <4 x double>*
  %wide.load979 = load <4 x double>, <4 x double>* %164, align 8, !alias.scope !77, !noalias !79
  %165 = fmul fast <4 x double> %wide.load979, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %167 = icmp eq i64 %index.next976, %n.vec974
  br i1 %167, label %middle.block968, label %vector.body970, !llvm.loop !82

middle.block968:                                  ; preds = %vector.body970
  %cmp.n978 = icmp eq i64 %160, %n.vec974
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %169 = udiv i64 %polly.indvar515, 5
  %170 = add nuw i64 %indvars.iv837, %169
  %umin839 = call i64 @llvm.umin.i64(i64 %170, i64 56)
  %171 = mul nsw i64 %polly.indvar515, -64
  %172 = icmp slt i64 %171, -1136
  %173 = select i1 %172, i64 %171, i64 -1136
  %174 = add nsw i64 %173, 1199
  %175 = shl nsw i64 %polly.indvar515, 6
  %176 = add nuw nsw i64 %umin839, 3
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %182 = add i64 %smax827, %indvars.iv830
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond840.not = icmp eq i64 %polly.indvar528, %176
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv832 = phi i64 [ %182, %polly.loop_header532.preheader ], [ %indvars.iv.next833, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549881 = icmp sgt i64 %184, -1
...
polly.loop_header700:                             ; preds = %polly.loop_exit708, %polly.loop_header694
  ...
  %smin909 = call i64 @llvm.smin.i64(i64 %198, i64 -1168)
  %199 = add nsw i64 %smin909, 1200
  %smin867 = call i64 @llvm.smin.i64(i64 %indvars.iv865, i64 -1168)
  %200 = shl nsw i64 %polly.indvar703, 5
  %201 = add nsw i64 %smin867, 1199
...
vector.ph910:                                     ; preds = %polly.loop_header706
  %broadcast.splatinsert917 = insertelement <4 x i64> poison, i64 %200, i32 0
  %broadcast.splat918 = shufflevector <4 x i64> %broadcast.splatinsert917, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert919 = insertelement <4 x i32> poison, i32 %203, i32 0
...
vector.body908:                                   ; preds = %vector.body908, %vector.ph910
  ...
  %205 = add nuw nsw <4 x i64> %vec.ind915, %broadcast.splat918
  %206 = trunc <4 x i64> %205 to <4 x i32>
  %207 = mul <4 x i32> %broadcast.splat920, %206
  ...
  %217 = icmp eq i64 %index.next912, %199
  br i1 %217, label %polly.loop_exit714, label %vector.body908, !llvm.loop !91

polly.loop_exit714:                               ; preds = %vector.body908, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond872.not = icmp eq i64 %polly.indvar709, %197
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond868.not = icmp eq i64 %polly.indvar715, %201
...
polly.loop_header727:                             ; preds = %polly.loop_exit735, %polly.loop_header721
  ...
  %smin924 = call i64 @llvm.smin.i64(i64 %227, i64 -968)
  %228 = add nsw i64 %smin924, 1000
  %smin857 = call i64 @llvm.smin.i64(i64 %indvars.iv855, i64 -968)
  %229 = shl nsw i64 %polly.indvar730, 5
  %230 = add nsw i64 %smin857, 999
...
vector.body923:                                   ; preds = %vector.body923, %vector.ph926
  ...
  %234 = add nuw nsw <4 x i64> %vec.ind933, %broadcast.splat936
  %235 = trunc <4 x i64> %234 to <4 x i32>
  %236 = mul <4 x i32> %broadcast.splat938, %235
  ...
  %246 = icmp eq i64 %index.next930, %228
  br i1 %246, label %polly.loop_exit741, label %vector.body923, !llvm.loop !94

polly.loop_exit741:                               ; preds = %vector.body923, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond862.not = icmp eq i64 %polly.indvar736, %226
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond858.not = icmp eq i64 %polly.indvar742, %230
...
polly.loop_header753:                             ; preds = %polly.loop_exit761, %polly.loop_header747
  ...
  %smin942 = call i64 @llvm.smin.i64(i64 %256, i64 -968)
  %257 = add nsw i64 %smin942, 1000
  %smin847 = call i64 @llvm.smin.i64(i64 %indvars.iv845, i64 -968)
  %258 = shl nsw i64 %polly.indvar756, 5
  %259 = add nsw i64 %smin847, 999
...
vector.body941:                                   ; preds = %vector.body941, %vector.ph944
  ...
  %263 = add nuw nsw <4 x i64> %vec.ind951, %broadcast.splat954
  %264 = trunc <4 x i64> %263 to <4 x i32>
  %265 = mul <4 x i32> %broadcast.splat956, %264
  ...
  %275 = icmp eq i64 %index.next948, %257
  br i1 %275, label %polly.loop_exit767, label %vector.body941, !llvm.loop !97

polly.loop_exit767:                               ; preds = %vector.body941, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond852.not = icmp eq i64 %polly.indvar762, %255
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond848.not = icmp eq i64 %polly.indvar768, %259
