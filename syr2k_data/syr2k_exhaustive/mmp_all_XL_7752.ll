; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7752.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7752.c"
...
polly.loop_header390:                             ; preds = %polly.loop_exit382, %polly.loop_exit398
  ...
  %134 = lshr i64 %indvars.iv869, 6
  %135 = mul nsw i64 %polly.indvar393, -100
  %136 = mul nuw nsw i64 %polly.indvar393, 100
...
polly.loop_header403:                             ; preds = %polly.loop_exit412, %polly.loop_header396
  ...
  %145 = shl nsw i64 %polly.indvar406, 8
  %146 = add nsw i64 %145, %135
  %147 = icmp sgt i64 %146, 0
  %148 = select i1 %147, i64 %146, i64 0
  %polly.loop_guard413 = icmp slt i64 %148, 100
...
polly.loop_header568:                             ; preds = %polly.loop_exit560, %polly.loop_exit576
  ...
  %171 = lshr i64 %indvars.iv892, 6
  %172 = mul nsw i64 %polly.indvar571, -100
  %173 = mul nuw nsw i64 %polly.indvar571, 100
...
polly.loop_header581:                             ; preds = %polly.loop_exit590, %polly.loop_header574
  ...
  %182 = shl nsw i64 %polly.indvar584, 8
  %183 = add nsw i64 %182, %172
  %184 = icmp sgt i64 %183, 0
  %185 = select i1 %184, i64 %183, i64 0
  %polly.loop_guard591 = icmp slt i64 %185, 100
