; ModuleID = 'syr2k_exhaustive/mmp_all_XL_3982.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_3982.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %polly.indvar202 = phi i64 [ 0, %polly.loop_header199.preheader ], [ %107, %polly.loop_exit207 ]
...
polly.loop_exit207:                               ; preds = %polly.loop_exit242
  %107 = add nuw nsw i64 %polly.indvar202, 1
  %indvars.iv.next = add nuw nsw i64 %indvars.iv, 4
  %indvars.iv.next1006 = add nsw i64 %indvars.iv1005, -4
  %exitcond1014.not = icmp eq i64 %107, 300
...
polly.loop_header205:                             ; preds = %polly.loop_exit242, %polly.loop_header199
  ...
  %.not.not = icmp ugt i64 %109, %polly.indvar202
  %110 = shl nsw i64 %polly.indvar208, 7
  %111 = add nsw i64 %110, %102
  %112 = icmp sgt i64 %111, 0
  %113 = select i1 %112, i64 %111, i64 0
  %114 = add nsw i64 %111, 127
  %115 = icmp slt i64 %103, %114
  %116 = select i1 %115, i64 %103, i64 %114
  %polly.loop_guard.not = icmp sgt i64 %113, %116
...
polly.loop_header227.us:                          ; preds = %polly.loop_header211.us, %polly.loop_header227.us
  %polly.indvar230.us = phi i64 [ %polly.indvar_next231.us, %polly.loop_header227.us ], [ %113, %polly.loop_header211.us ]
  %117 = add nuw nsw i64 %polly.indvar230.us, %101
  %polly.access.mul.call1234.us = mul nsw i64 %117, 1000
  ...
  %polly.loop_cond232.not.not.us = icmp slt i64 %polly.indvar230.us, %116
...
polly.loop_exit242:                               ; preds = %polly.loop_exit249, %polly.loop_header240.preheader
  ...
  %exitcond1013.not = icmp eq i64 %polly.indvar_next209, 10
...
polly.loop_header240.preheader:                   ; preds = %polly.loop_exit229, %polly.loop_exit229.us, %polly.loop_header205.split
  %118 = sub nsw i64 %101, %110
  %119 = icmp sgt i64 %118, 0
  %120 = select i1 %119, i64 %118, i64 0
  %121 = mul nsw i64 %polly.indvar208, -128
  %122 = icmp slt i64 %121, -1072
  %123 = select i1 %122, i64 %121, i64 -1072
  %124 = add nsw i64 %123, 1199
  %polly.loop_guard250.not = icmp sgt i64 %120, %124
...
polly.loop_header227:                             ; preds = %polly.loop_header211, %polly.loop_header227
  %polly.indvar230 = phi i64 [ %polly.indvar_next231, %polly.loop_header227 ], [ %113, %polly.loop_header211 ]
  ...
  %polly.loop_cond232.not.not = icmp slt i64 %polly.indvar230, %116
...
polly.loop_header240:                             ; preds = %polly.loop_header240.preheader, %polly.loop_exit249
  ...
  %126 = shl nuw nsw i64 %polly.indvar243, 3
  %scevgep266 = getelementptr i8, i8* %call2, i64 %126
...
polly.loop_header247:                             ; preds = %polly.loop_exit257, %polly.loop_header240
  %indvars.iv1009 = phi i64 [ %indvars.iv.next1010, %polly.loop_exit257 ], [ %108, %polly.loop_header240 ]
  %polly.indvar251 = phi i64 [ %polly.indvar_next252, %polly.loop_exit257 ], [ %120, %polly.loop_header240 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv1009, i64 3)
  %127 = add nsw i64 %polly.indvar251, %111
  %polly.loop_guard2581096 = icmp sgt i64 %127, -1
...
polly.loop_header255.preheader:                   ; preds = %polly.loop_header247
  %128 = add nuw nsw i64 %polly.indvar251, %110
  %129 = mul i64 %128, 8000
  %scevgep267 = getelementptr i8, i8* %scevgep266, i64 %129
  ...
  %polly.access.add.Packed_MemRef_call1275 = add nsw i64 %127, %polly.access.mul.Packed_MemRef_call1262
...
polly.loop_exit257:                               ; preds = %polly.loop_header255, %polly.loop_header247
  ...
  %polly.loop_cond253.not.not = icmp slt i64 %polly.indvar251, %124
...
polly.loop_header255:                             ; preds = %polly.loop_header255.preheader, %polly.loop_header255
  ...
  %131 = add nuw nsw i64 %polly.indvar259, %101
  ...
  %scevgep271 = getelementptr i8, i8* %scevgep266, i64 %132
  ...
  %133 = shl i64 %131, 3
  %134 = add i64 %133, %130
  %scevgep278 = getelementptr i8, i8* %call, i64 %134
...
polly.loop_header369:                             ; preds = %polly.loop_exit377, %polly.start283
  ...
  %135 = add i64 %indvar1215, 1
  %136 = mul nuw nsw i64 %polly.indvar372, 9600
  %scevgep381 = getelementptr i8, i8* %call, i64 %136
  %min.iters.check1217 = icmp ult i64 %135, 4
...
vector.body1214:                                  ; preds = %vector.body1214, %vector.ph1218
  ...
  %137 = shl nuw nsw i64 %index1221, 3
  %138 = getelementptr i8, i8* %scevgep381, i64 %137
  %139 = bitcast i8* %138 to <4 x double>*
  %wide.load1225 = load <4 x double>, <4 x double>* %139, align 8, !alias.scope !79, !noalias !81
  %140 = fmul fast <4 x double> %wide.load1225, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %142 = icmp eq i64 %index.next1222, %n.vec1220
  br i1 %142, label %middle.block1212, label %vector.body1214, !llvm.loop !85

middle.block1212:                                 ; preds = %vector.body1214
  %cmp.n1224 = icmp eq i64 %135, %n.vec1220
...
polly.loop_header375:                             ; preds = %polly.loop_header375.preheader, %polly.loop_header375
  ...
  %143 = shl nuw nsw i64 %polly.indvar378, 3
  %scevgep382 = getelementptr i8, i8* %scevgep381, i64 %143
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit394
  ...
  %144 = lshr i64 %polly.indvar388, 5
  %145 = shl nuw nsw i64 %144, 7
  %146 = sub nsw i64 %indvars.iv1020, %145
  %147 = add i64 %indvars.iv1025, %145
  %148 = shl nsw i64 %polly.indvar388, 2
  %149 = mul nsw i64 %polly.indvar388, -4
  %150 = add nsw i64 %149, 1199
  %polly.access.mul.call1415.us = mul nsw i64 %polly.indvar388, 4000
  %151 = or i64 %148, 1
  %polly.access.mul.call1415.us.1 = mul nuw nsw i64 %151, 1000
  %152 = or i64 %148, 2
  %polly.access.mul.call1415.us.2 = mul nuw nsw i64 %152, 1000
  %153 = or i64 %148, 3
  %polly.access.mul.call1415.us.3 = mul nuw nsw i64 %153, 1000
...
polly.loop_exit394:                               ; preds = %polly.loop_exit435
  ...
  %exitcond1035.not = icmp eq i64 %154, 300
...
polly.loop_header392:                             ; preds = %polly.loop_exit435, %polly.loop_header385
  %indvars.iv1027 = phi i64 [ %indvars.iv.next1028, %polly.loop_exit435 ], [ %147, %polly.loop_header385 ]
  %indvars.iv1022 = phi i64 [ %indvars.iv.next1023, %polly.loop_exit435 ], [ %146, %polly.loop_header385 ]
  %polly.indvar395 = phi i64 [ %polly.indvar_next396, %polly.loop_exit435 ], [ %144, %polly.loop_header385 ]
  %smax1024 = call i64 @llvm.smax.i64(i64 %indvars.iv1022, i64 0)
  %155 = add i64 %smax1024, %indvars.iv1027
  %156 = shl nsw i64 %polly.indvar395, 5
  %.not.not873 = icmp ugt i64 %156, %polly.indvar388
  %157 = shl nsw i64 %polly.indvar395, 7
  ...
  %polly.loop_guard422.not = icmp sgt i64 %160, %163
...
polly.loop_header419.us:                          ; preds = %polly.loop_header398.us, %polly.loop_header419.us
  ...
  %164 = add nuw nsw i64 %polly.indvar423.us, %148
  ...
  %polly.loop_cond425.not.not.us = icmp slt i64 %polly.indvar423.us, %163
...
polly.loop_exit435:                               ; preds = %polly.loop_exit442, %polly.loop_header433.preheader
  ...
  %indvars.iv.next1028 = add i64 %indvars.iv1027, 128
  %exitcond1034.not = icmp eq i64 %polly.indvar_next396, 10
...
polly.loop_header433.preheader:                   ; preds = %polly.loop_exit421, %polly.loop_exit421.us, %polly.loop_header392.split
  %165 = sub nsw i64 %148, %157
  %166 = icmp sgt i64 %165, 0
  %167 = select i1 %166, i64 %165, i64 0
  %168 = mul nsw i64 %polly.indvar395, -128
...
polly.loop_header419:                             ; preds = %polly.loop_header398, %polly.loop_header419
  ...
  %172 = add nuw nsw i64 %polly.indvar423, %148
  ...
  %polly.loop_cond425.not.not = icmp slt i64 %polly.indvar423, %163
...
polly.loop_header440:                             ; preds = %polly.loop_exit450, %polly.loop_header433
  %indvars.iv1029 = phi i64 [ %indvars.iv.next1030, %polly.loop_exit450 ], [ %155, %polly.loop_header433 ]
  %polly.indvar444 = phi i64 [ %polly.indvar_next445, %polly.loop_exit450 ], [ %167, %polly.loop_header433 ]
  %smin1031 = call i64 @llvm.smin.i64(i64 %indvars.iv1029, i64 3)
  %174 = add nsw i64 %polly.indvar444, %158
  %polly.loop_guard4511097 = icmp sgt i64 %174, -1
...
polly.loop_header448.preheader:                   ; preds = %polly.loop_header440
  %175 = add nuw nsw i64 %polly.indvar444, %157
  ...
  %polly.access.add.Packed_MemRef_call1286468 = add nsw i64 %174, %polly.access.mul.Packed_MemRef_call1286455
...
polly.loop_header448:                             ; preds = %polly.loop_header448.preheader, %polly.loop_header448
  ...
  %178 = add nuw nsw i64 %polly.indvar452, %148
...
polly.loop_header562:                             ; preds = %polly.loop_exit570, %polly.start476
  ...
  %min.iters.check1191 = icmp ult i64 %182, 4
...
vector.body1190:                                  ; preds = %vector.body1190, %vector.ph1192
  ...
  %184 = shl nuw nsw i64 %index1195, 3
  %185 = getelementptr i8, i8* %scevgep574, i64 %184
  %186 = bitcast i8* %185 to <4 x double>*
  %wide.load1199 = load <4 x double>, <4 x double>* %186, align 8, !alias.scope !89, !noalias !91
  %187 = fmul fast <4 x double> %wide.load1199, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %189 = icmp eq i64 %index.next1196, %n.vec1194
  br i1 %189, label %middle.block1188, label %vector.body1190, !llvm.loop !95

middle.block1188:                                 ; preds = %vector.body1190
  %cmp.n1198 = icmp eq i64 %182, %n.vec1194
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit587
  ...
  %polly.indvar581 = phi i64 [ 0, %polly.loop_header578.preheader ], [ %201, %polly.loop_exit587 ]
  %191 = lshr i64 %polly.indvar581, 5
  %192 = shl nuw nsw i64 %191, 7
  %193 = sub nsw i64 %indvars.iv1041, %192
  %194 = add i64 %indvars.iv1046, %192
  %195 = shl nsw i64 %polly.indvar581, 2
  %196 = mul nsw i64 %polly.indvar581, -4
  %197 = add nsw i64 %196, 1199
  %polly.access.mul.call1608.us = mul nsw i64 %polly.indvar581, 4000
  %198 = or i64 %195, 1
  %polly.access.mul.call1608.us.1 = mul nuw nsw i64 %198, 1000
  %199 = or i64 %195, 2
  %polly.access.mul.call1608.us.2 = mul nuw nsw i64 %199, 1000
  %200 = or i64 %195, 3
  %polly.access.mul.call1608.us.3 = mul nuw nsw i64 %200, 1000
  br label %polly.loop_header585

polly.loop_exit587:                               ; preds = %polly.loop_exit628
  %201 = add nuw nsw i64 %polly.indvar581, 1
  %indvars.iv.next1042 = add nuw nsw i64 %indvars.iv1041, 4
  %indvars.iv.next1047 = add nsw i64 %indvars.iv1046, -4
  %exitcond1056.not = icmp eq i64 %201, 300
...
polly.loop_header585:                             ; preds = %polly.loop_exit628, %polly.loop_header578
  %indvars.iv1048 = phi i64 [ %indvars.iv.next1049, %polly.loop_exit628 ], [ %194, %polly.loop_header578 ]
  %indvars.iv1043 = phi i64 [ %indvars.iv.next1044, %polly.loop_exit628 ], [ %193, %polly.loop_header578 ]
  %polly.indvar588 = phi i64 [ %polly.indvar_next589, %polly.loop_exit628 ], [ %191, %polly.loop_header578 ]
  %smax1045 = call i64 @llvm.smax.i64(i64 %indvars.iv1043, i64 0)
  %202 = add i64 %smax1045, %indvars.iv1048
  %203 = shl nsw i64 %polly.indvar588, 5
  %.not.not874 = icmp ugt i64 %203, %polly.indvar581
  %204 = shl nsw i64 %polly.indvar588, 7
  %205 = add nsw i64 %204, %196
  %206 = icmp sgt i64 %205, 0
  %207 = select i1 %206, i64 %205, i64 0
  %208 = add nsw i64 %205, 127
  %209 = icmp slt i64 %197, %208
  %210 = select i1 %209, i64 %197, i64 %208
  %polly.loop_guard615.not = icmp sgt i64 %207, %210
...
polly.loop_header612.us:                          ; preds = %polly.loop_header591.us, %polly.loop_header612.us
  %polly.indvar616.us = phi i64 [ %polly.indvar_next617.us, %polly.loop_header612.us ], [ %207, %polly.loop_header591.us ]
  %211 = add nuw nsw i64 %polly.indvar616.us, %195
  %polly.access.mul.call1620.us = mul nsw i64 %211, 1000
  ...
  %polly.loop_cond618.not.not.us = icmp slt i64 %polly.indvar616.us, %210
...
polly.loop_exit628:                               ; preds = %polly.loop_exit635, %polly.loop_header626.preheader
  ...
  %indvars.iv.next1044 = add i64 %indvars.iv1043, -128
  %indvars.iv.next1049 = add i64 %indvars.iv1048, 128
  %exitcond1055.not = icmp eq i64 %polly.indvar_next589, 10
...
polly.loop_header626.preheader:                   ; preds = %polly.loop_exit614, %polly.loop_exit614.us, %polly.loop_header585.split
  %212 = sub nsw i64 %195, %204
  %213 = icmp sgt i64 %212, 0
  %214 = select i1 %213, i64 %212, i64 0
  %215 = mul nsw i64 %polly.indvar588, -128
  %216 = icmp slt i64 %215, -1072
  %217 = select i1 %216, i64 %215, i64 -1072
  %218 = add nsw i64 %217, 1199
  %polly.loop_guard636.not = icmp sgt i64 %214, %218
...
polly.loop_header612:                             ; preds = %polly.loop_header591, %polly.loop_header612
  %polly.indvar616 = phi i64 [ %polly.indvar_next617, %polly.loop_header612 ], [ %207, %polly.loop_header591 ]
  %219 = add nuw nsw i64 %polly.indvar616, %195
  ...
  %polly.loop_cond618.not.not = icmp slt i64 %polly.indvar616, %210
...
polly.loop_header626:                             ; preds = %polly.loop_header626.preheader, %polly.loop_exit635
  ...
  %220 = shl nuw nsw i64 %polly.indvar629, 3
  %scevgep652 = getelementptr i8, i8* %call2, i64 %220
...
polly.loop_header633:                             ; preds = %polly.loop_exit643, %polly.loop_header626
  %indvars.iv1050 = phi i64 [ %indvars.iv.next1051, %polly.loop_exit643 ], [ %202, %polly.loop_header626 ]
  %polly.indvar637 = phi i64 [ %polly.indvar_next638, %polly.loop_exit643 ], [ %214, %polly.loop_header626 ]
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1050, i64 3)
  %221 = add nsw i64 %polly.indvar637, %205
  %polly.loop_guard6441098 = icmp sgt i64 %221, -1
...
polly.loop_header641.preheader:                   ; preds = %polly.loop_header633
  %222 = add nuw nsw i64 %polly.indvar637, %204
  %223 = mul i64 %222, 8000
  %scevgep653 = getelementptr i8, i8* %scevgep652, i64 %223
  ...
  %polly.access.add.Packed_MemRef_call1479661 = add nsw i64 %221, %polly.access.mul.Packed_MemRef_call1479648
...
polly.loop_exit643:                               ; preds = %polly.loop_header641, %polly.loop_header633
  ...
  %polly.loop_cond639.not.not = icmp slt i64 %polly.indvar637, %218
...
polly.loop_header641:                             ; preds = %polly.loop_header641.preheader, %polly.loop_header641
  ...
  %225 = add nuw nsw i64 %polly.indvar645, %195
  ...
  %scevgep657 = getelementptr i8, i8* %scevgep652, i64 %226
  ...
  %227 = shl i64 %225, 3
  %228 = add i64 %227, %224
  %scevgep664 = getelementptr i8, i8* %call, i64 %228
...
polly.loop_header793:                             ; preds = %entry, %polly.loop_exit801
  ...
  %229 = shl nsw i64 %polly.indvar796, 5
  %230 = add nsw i64 %smin1085, 1199
...
polly.loop_header799:                             ; preds = %polly.loop_exit807, %polly.loop_header793
  ...
  %231 = mul nsw i64 %polly.indvar802, -32
  %smin1129 = call i64 @llvm.smin.i64(i64 %231, i64 -1168)
  %232 = add nsw i64 %smin1129, 1200
  %smin1081 = call i64 @llvm.smin.i64(i64 %indvars.iv1079, i64 -1168)
  %233 = shl nsw i64 %polly.indvar802, 5
  %234 = add nsw i64 %smin1081, 1199
...
polly.loop_header805:                             ; preds = %polly.loop_exit813, %polly.loop_header799
  ...
  %235 = add nuw nsw i64 %polly.indvar808, %229
...
vector.ph1130:                                    ; preds = %polly.loop_header805
  %broadcast.splatinsert1137 = insertelement <4 x i64> poison, i64 %233, i32 0
  %broadcast.splat1138 = shufflevector <4 x i64> %broadcast.splatinsert1137, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1139 = insertelement <4 x i32> poison, i32 %236, i32 0
...
vector.body1128:                                  ; preds = %vector.body1128, %vector.ph1130
  ...
  %238 = add nuw nsw <4 x i64> %vec.ind1135, %broadcast.splat1138
  %239 = trunc <4 x i64> %238 to <4 x i32>
  %240 = mul <4 x i32> %broadcast.splat1140, %239
  ...
  %250 = icmp eq i64 %index.next1132, %232
  br i1 %250, label %polly.loop_exit813, label %vector.body1128, !llvm.loop !104

polly.loop_exit813:                               ; preds = %vector.body1128, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond1086.not = icmp eq i64 %polly.indvar808, %230
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %251 = add nuw nsw i64 %polly.indvar814, %233
  ...
  %scevgep817 = getelementptr i8, i8* %call, i64 %257
  ...
  %exitcond1082.not = icmp eq i64 %polly.indvar814, %234
...
polly.loop_header820:                             ; preds = %polly.loop_exit801, %polly.loop_exit828
  ...
  %258 = shl nsw i64 %polly.indvar823, 5
  %259 = add nsw i64 %smin1075, 1199
...
polly.loop_header826:                             ; preds = %polly.loop_exit834, %polly.loop_header820
  ...
  %260 = mul nsw i64 %polly.indvar829, -32
  %smin1144 = call i64 @llvm.smin.i64(i64 %260, i64 -968)
  %261 = add nsw i64 %smin1144, 1000
  %smin1071 = call i64 @llvm.smin.i64(i64 %indvars.iv1069, i64 -968)
  %262 = shl nsw i64 %polly.indvar829, 5
  %263 = add nsw i64 %smin1071, 999
...
vector.body1143:                                  ; preds = %vector.body1143, %vector.ph1146
  ...
  %267 = add nuw nsw <4 x i64> %vec.ind1153, %broadcast.splat1156
  %268 = trunc <4 x i64> %267 to <4 x i32>
  %269 = mul <4 x i32> %broadcast.splat1158, %268
  ...
  %279 = icmp eq i64 %index.next1150, %261
  br i1 %279, label %polly.loop_exit840, label %vector.body1143, !llvm.loop !107

polly.loop_exit840:                               ; preds = %vector.body1143, %polly.loop_header838
  %polly.indvar_next836 = add nuw nsw i64 %polly.indvar835, 1
  %exitcond1076.not = icmp eq i64 %polly.indvar835, %259
...
polly.loop_header838:                             ; preds = %polly.loop_header832, %polly.loop_header838
  ...
  %280 = add nuw nsw i64 %polly.indvar841, %262
  ...
  %scevgep844 = getelementptr i8, i8* %call2, i64 %286
  ...
  %exitcond1072.not = icmp eq i64 %polly.indvar841, %263
...
polly.loop_header852:                             ; preds = %polly.loop_exit860, %polly.loop_header846
  ...
  %289 = mul nsw i64 %polly.indvar855, -32
  %smin1162 = call i64 @llvm.smin.i64(i64 %289, i64 -968)
  %290 = add nsw i64 %smin1162, 1000
  %smin1061 = call i64 @llvm.smin.i64(i64 %indvars.iv1059, i64 -968)
  %291 = shl nsw i64 %polly.indvar855, 5
  %292 = add nsw i64 %smin1061, 999
...
vector.body1161:                                  ; preds = %vector.body1161, %vector.ph1164
  ...
  %296 = add nuw nsw <4 x i64> %vec.ind1171, %broadcast.splat1174
  %297 = trunc <4 x i64> %296 to <4 x i32>
  %298 = mul <4 x i32> %broadcast.splat1176, %297
  ...
  %308 = icmp eq i64 %index.next1168, %290
  br i1 %308, label %polly.loop_exit866, label %vector.body1161, !llvm.loop !110

polly.loop_exit866:                               ; preds = %vector.body1161, %polly.loop_header864
  %polly.indvar_next862 = add nuw nsw i64 %polly.indvar861, 1
  %exitcond1066.not = icmp eq i64 %polly.indvar861, %288
  br i1 %exitcond1066.not, label %polly.loop_exit860, label %polly.loop_header858

polly.loop_header864:                             ; preds = %polly.loop_header858, %polly.loop_header864
  %polly.indvar867 = phi i64 [ %polly.indvar_next868, %polly.loop_header864 ], [ 0, %polly.loop_header858 ]
  %309 = add nuw nsw i64 %polly.indvar867, %291
  ...
  %scevgep871 = getelementptr i8, i8* %call1, i64 %315
  ...
  %exitcond1062.not = icmp eq i64 %polly.indvar867, %292
