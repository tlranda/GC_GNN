; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4246.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4246.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %polly.loop_guard = icmp slt i64 %125, 16
...
vector.body1187:                                  ; preds = %vector.body1187, %vector.ph1191
  ...
  %wide.load1198 = load <4 x double>, <4 x double>* %146, align 8, !alias.scope !74, !noalias !76
  ...
  store <4 x double> %147, <4 x double>* %148, align 8, !alias.scope !74, !noalias !76
  %index.next1195 = add i64 %index1194, 4
  %149 = icmp eq i64 %index.next1195, %n.vec1193
  br i1 %149, label %middle.block1185, label %vector.body1187, !llvm.loop !80
...
polly.loop_header383:                             ; preds = %polly.loop_header383.preheader, %polly.loop_exit391
  ...
  %151 = mul nsw i64 %polly.indvar386, -16
  %152 = shl nsw i64 %polly.indvar386, 4
...
polly.loop_header395:                             ; preds = %polly.loop_exit404, %polly.loop_header389
  ...
  %polly.loop_guard405 = icmp slt i64 %179, 16
...
vector.body1163:                                  ; preds = %vector.body1163, %vector.ph1165
  ...
  %wide.load1172 = load <4 x double>, <4 x double>* %200, align 8, !alias.scope !84, !noalias !86
  ...
  store <4 x double> %201, <4 x double>* %202, align 8, !alias.scope !84, !noalias !86
  %index.next1169 = add i64 %index1168, 4
  %203 = icmp eq i64 %index.next1169, %n.vec1167
  br i1 %203, label %middle.block1161, label %vector.body1163, !llvm.loop !90
...
polly.loop_header573:                             ; preds = %polly.loop_header573.preheader, %polly.loop_exit581
  ...
  %205 = mul nsw i64 %polly.indvar576, -16
  %206 = shl nsw i64 %polly.indvar576, 4
...
polly.loop_header585:                             ; preds = %polly.loop_exit594, %polly.loop_header579
  ...
  %polly.loop_guard595 = icmp slt i64 %233, 16
...
vector.body1102:                                  ; preds = %vector.body1102, %vector.ph1103
  ...
  store <4 x double> %265, <4 x double>* %270, align 8, !alias.scope !94, !noalias !96
  ...
  br i1 %271, label %polly.loop_exit805, label %vector.body1102, !llvm.loop !99
...
vector.body1116:                                  ; preds = %vector.body1116, %vector.ph1119
  ...
  store <4 x double> %294, <4 x double>* %299, align 8, !alias.scope !98, !noalias !101
  ...
  br i1 %300, label %polly.loop_exit832, label %vector.body1116, !llvm.loop !102
...
vector.body1134:                                  ; preds = %vector.body1134, %vector.ph1137
  ...
  store <4 x double> %323, <4 x double>* %328, align 8, !alias.scope !97, !noalias !104
  ...
  br i1 %329, label %polly.loop_exit858, label %vector.body1134, !llvm.loop !105
