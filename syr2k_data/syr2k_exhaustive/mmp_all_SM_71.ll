; ModuleID = 'syr2k_exhaustive/mmp_all_SM_71.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_71.c"
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %114 = mul nuw nsw i64 %polly.indvar209, 12
...
polly.loop_exit230:                               ; preds = %polly.loop_exit267
  ...
  %indvars.iv.next1093 = add nuw nsw i64 %indvars.iv1092, 12
...
polly.loop_header228:                             ; preds = %polly.loop_exit267, %polly.loop_exit214
  ...
  %118 = mul nsw i64 %indvar1413, -4
  %119 = add i64 %104, %118
  %smax1415 = call i64 @llvm.smax.i64(i64 %119, i64 0)
  %120 = shl nuw nsw i64 %indvar1413, 2
  %121 = add i64 %106, %120
...
polly.loop_exit267:                               ; preds = %polly.loop_exit274.loopexit.us, %polly.loop_header265.preheader
  ...
  %polly.loop_cond233 = icmp ult i64 %polly.indvar231, 299
  %indvars.iv.next1095 = add i64 %indvars.iv1094, -4
  %indvars.iv.next1099 = add i64 %indvars.iv1098, 4
...
polly.loop_header265.preheader:                   ; preds = %polly.loop_exit253, %polly.loop_exit253.us, %polly.loop_header228.split
  ...
  %polly.loop_guard275 = icmp slt i64 %137, 4
...
polly.loop_exit282.us:                            ; preds = %polly.loop_header280.us, %middle.block1410, %polly.loop_header272.us
  ...
  %polly.loop_cond278.us = icmp ult i64 %polly.indvar276.us, 3
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %176 = mul nuw nsw i64 %polly.indvar421, 12
  %177 = lshr i64 %polly.indvar421, 1
  %178 = add nuw i64 %176, %177
  %179 = shl nuw nsw i64 %178, 2
  %180 = sub i64 %175, %179
  %181 = mul nsw i64 %polly.indvar421, -50
  %182 = add i64 %181, %179
  %183 = lshr i64 %polly.indvar421, 1
...
polly.loop_exit426:                               ; preds = %polly.loop_exit432
  ...
  %190 = mul nuw nsw i64 %polly.indvar421, 12
...
polly.loop_exit443:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1125 = add nuw nsw i64 %indvars.iv1124, 12
...
polly.loop_exit482:                               ; preds = %polly.loop_exit489.loopexit.us, %polly.loop_header480.preheader
  ...
  %polly.loop_cond446 = icmp ult i64 %polly.indvar444, 299
  %indvars.iv.next1127 = add i64 %indvars.iv1126, -4
  %indvars.iv.next1132 = add i64 %indvars.iv1131, 4
...
polly.loop_header480.preheader:                   ; preds = %polly.loop_exit468, %polly.loop_exit468.us, %polly.loop_header441.split
  ...
  %polly.loop_guard490 = icmp slt i64 %213, 4
...
polly.loop_exit497.us:                            ; preds = %polly.loop_header495.us, %middle.block1360, %polly.loop_header487.us
  ...
  %polly.loop_cond493.us = icmp ult i64 %polly.indvar491.us, 3
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %252 = mul nuw nsw i64 %polly.indvar636, 12
  %253 = lshr i64 %polly.indvar636, 1
...
polly.loop_exit641:                               ; preds = %polly.loop_exit647
  ...
  %266 = mul nuw nsw i64 %polly.indvar636, 12
...
polly.loop_exit697:                               ; preds = %polly.loop_exit704.loopexit.us, %polly.loop_header695.preheader
  ...
  %polly.loop_cond661 = icmp ult i64 %polly.indvar659, 299
  %indvars.iv.next1160 = add i64 %indvars.iv1159, -4
  %indvars.iv.next1165 = add i64 %indvars.iv1164, 4
...
polly.loop_header695.preheader:                   ; preds = %polly.loop_exit683, %polly.loop_exit683.us, %polly.loop_header656.split
  ...
  %polly.loop_guard705 = icmp slt i64 %289, 4
...
polly.loop_exit712.us:                            ; preds = %polly.loop_header710.us, %middle.block1310, %polly.loop_header702.us
  ...
  %polly.loop_cond708.us = icmp ult i64 %polly.indvar706.us, 3
