; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2084.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2084.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %smin1054 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -984)
  %108 = add nsw i64 %smin1054, 1000
  %109 = shl nsw i64 %polly.indvar225, 4
...
polly.loop_exit236:                               ; preds = %polly.loop_exit267, %polly.loop_header228
  ...
  %indvars.iv.next1041 = add i64 %indvars.iv1040, 50
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1361 = call i64 @llvm.smin.i64(i64 %122, i64 49)
  %123 = add nsw i64 %smin1361, 1
  %smin1052 = call i64 @llvm.smin.i64(i64 %indvars.iv1046, i64 49)
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  ...
  %161 = mul nsw i64 %polly.indvar423, -64
  %162 = shl nuw nsw i64 %polly.indvar423, 6
  ...
  %.inv926 = icmp ult i64 %165, 23
  %166 = mul nsw i64 %polly.indvar423, -64
  %167 = icmp slt i64 %166, -1136
  %168 = select i1 %167, i64 %166, i64 -1136
  %169 = add nsw i64 %168, 1199
  %170 = shl nsw i64 %polly.indvar423, 6
  %.op1158 = add nuw i64 %165, 2
  %171 = select i1 %.inv926, i64 %.op1158, i64 24
...
polly.loop_header426:                             ; preds = %polly.loop_exit435, %polly.loop_header420
  ...
  %173 = shl nsw i64 %polly.indvar429, 4
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %176 = mul i64 %polly.indvar436, -50
  %177 = add i64 %162, %176
  %178 = add i64 %smax1310, %177
  %179 = mul nsw i64 %polly.indvar436, 50
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1313 = call i64 @llvm.smin.i64(i64 %186, i64 49)
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  ...
  %226 = shl nuw nsw i64 %polly.indvar634, 6
  ...
  %.inv928 = icmp ult i64 %229, 23
  %230 = mul nsw i64 %polly.indvar634, -64
  %231 = icmp slt i64 %230, -1136
  %232 = select i1 %231, i64 %230, i64 -1136
  %233 = add nsw i64 %232, 1199
  %234 = shl nsw i64 %polly.indvar634, 6
  %.op1160 = add nuw i64 %229, 2
  %235 = select i1 %.inv928, i64 %.op1160, i64 24
...
polly.loop_exit639:                               ; preds = %polly.loop_exit646
  ...
  %exitcond1118.not = icmp eq i64 %polly.indvar_next635, 19
...
polly.loop_header637:                             ; preds = %polly.loop_exit646, %polly.loop_header631
  ...
  %237 = shl nsw i64 %polly.indvar640, 4
...
polly.loop_exit646:                               ; preds = %polly.loop_exit653
  ...
  %exitcond1117.not = icmp eq i64 %polly.indvar_next641, 63
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %238 = mul i64 %polly.indvar647, 50
  %239 = add i64 %225, %238
  %smax1262 = call i64 @llvm.smax.i64(i64 %239, i64 0)
  %240 = mul i64 %polly.indvar647, -50
  %241 = add i64 %226, %240
  %242 = add i64 %smax1262, %241
  %243 = mul nsw i64 %polly.indvar647, 50
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1265 = call i64 @llvm.smin.i64(i64 %250, i64 49)
