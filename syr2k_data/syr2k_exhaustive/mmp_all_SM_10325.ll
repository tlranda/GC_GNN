; ModuleID = 'syr2k_exhaustive/mmp_all_SM_10325.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_10325.c"
...
polly.loop_header217.preheader:                   ; preds = %polly.loop_header211
  ...
  %109 = add i64 %smax, %indvars.iv791
...
polly.loop_header217:                             ; preds = %polly.loop_header217.preheader, %polly.loop_exit225
  %indvars.iv793 = phi i64 [ %109, %polly.loop_header217.preheader ], [ %indvars.iv.next794, %polly.loop_exit225 ]
  ...
  %polly.loop_guard233873 = icmp sgt i64 %111, -1
...
polly.loop_header354:                             ; preds = %polly.loop_exit346, %polly.loop_exit362
  ...
  %132 = add nuw nsw i64 %pexp.p_div_q366, %polly.indvar357
  %.inv774 = icmp ult i64 %132, 14
  ...
  %.op874 = add nuw i64 %132, 2
  %138 = select i1 %.inv774, i64 %.op874, i64 15
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %139 = mul nuw nsw i64 %polly.indvar363, 20
...
polly.loop_header367:                             ; preds = %polly.loop_exit376, %polly.loop_header360
  ...
  %140 = mul nsw i64 %polly.indvar370, 80
...
polly.loop_exit376:                               ; preds = %polly.loop_exit383, %polly.loop_header367
  ...
  %exitcond815.not = icmp eq i64 %polly.indvar_next371, %138
...
polly.loop_header374:                             ; preds = %polly.loop_header374.preheader, %polly.loop_exit383
  %indvars.iv810 = phi i64 [ %144, %polly.loop_header374.preheader ], [ %indvars.iv.next811, %polly.loop_exit383 ]
  ...
  %polly.loop_guard391875 = icmp sgt i64 %146, -1
...
polly.loop_header512:                             ; preds = %polly.loop_exit504, %polly.loop_exit520
  ...
  %167 = add nuw nsw i64 %pexp.p_div_q524, %polly.indvar515
  %.inv775 = icmp ult i64 %167, 14
  ...
  %.op876 = add nuw i64 %167, 2
  %173 = select i1 %.inv775, i64 %.op876, i64 15
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %174 = mul nuw nsw i64 %polly.indvar521, 20
...
polly.loop_header525:                             ; preds = %polly.loop_exit534, %polly.loop_header518
  ...
  %175 = mul nsw i64 %polly.indvar528, 80
...
polly.loop_header532.preheader:                   ; preds = %polly.loop_header525
  ...
  %179 = add i64 %smax824, %indvars.iv827
...
polly.loop_exit534:                               ; preds = %polly.loop_exit541, %polly.loop_header525
  ...
  %exitcond834.not = icmp eq i64 %polly.indvar_next529, %173
...
polly.loop_header532:                             ; preds = %polly.loop_header532.preheader, %polly.loop_exit541
  %indvars.iv829 = phi i64 [ %179, %polly.loop_header532.preheader ], [ %indvars.iv.next830, %polly.loop_exit541 ]
  ...
  %polly.loop_guard549877 = icmp sgt i64 %181, -1
...
polly.loop_header539.us:                          ; preds = %polly.loop_header532, %polly.loop_exit548.loopexit.us
  ...
  %185 = add nuw nsw i64 %polly.indvar542.us, %174
  %186 = shl i64 %185, 3
  %187 = add i64 %186, %183
...
vector.body904:                                   ; preds = %vector.body904, %vector.ph906
  ...
  br i1 %214, label %polly.loop_exit714, label %vector.body904, !llvm.loop !92

polly.loop_exit714:                               ; preds = %vector.body904, %polly.loop_header712
  %polly.indvar_next710 = add nuw nsw i64 %polly.indvar709, 1
  %exitcond866.not = icmp eq i64 %polly.indvar709, %194
...
polly.loop_header712:                             ; preds = %polly.loop_header706, %polly.loop_header712
  ...
  %exitcond862.not = icmp eq i64 %polly.indvar715, %198
...
vector.body919:                                   ; preds = %vector.body919, %vector.ph922
  ...
  br i1 %243, label %polly.loop_exit741, label %vector.body919, !llvm.loop !95

polly.loop_exit741:                               ; preds = %vector.body919, %polly.loop_header739
  %polly.indvar_next737 = add nuw nsw i64 %polly.indvar736, 1
  %exitcond856.not = icmp eq i64 %polly.indvar736, %223
...
polly.loop_header739:                             ; preds = %polly.loop_header733, %polly.loop_header739
  ...
  %exitcond852.not = icmp eq i64 %polly.indvar742, %227
...
vector.body937:                                   ; preds = %vector.body937, %vector.ph940
  ...
  br i1 %272, label %polly.loop_exit767, label %vector.body937, !llvm.loop !98

polly.loop_exit767:                               ; preds = %vector.body937, %polly.loop_header765
  %polly.indvar_next763 = add nuw nsw i64 %polly.indvar762, 1
  %exitcond846.not = icmp eq i64 %polly.indvar762, %252
...
polly.loop_header765:                             ; preds = %polly.loop_header759, %polly.loop_header765
  ...
  %exitcond842.not = icmp eq i64 %polly.indvar768, %256
