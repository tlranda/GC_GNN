; ModuleID = 'syr2k_exhaustive/mmp_all_SM_2383.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_2383.c"
...
polly.loop_header222:                             ; preds = %polly.loop_exit230, %polly.loop_header216
  ...
  %107 = mul nuw nsw i64 %polly.indvar225, 80
...
polly.loop_header228:                             ; preds = %polly.loop_exit236, %polly.loop_header222
  ...
  %113 = mul nsw i64 %polly.indvar231, 80
...
polly.loop_header234:                             ; preds = %polly.loop_header234.preheader, %polly.loop_exit267
  ...
  %smin1361 = call i64 @llvm.smin.i64(i64 %120, i64 79)
...
polly.loop_header420:                             ; preds = %polly.loop_exit412, %polly.loop_exit428
  ...
  %167 = select i1 %.inv926, i64 %.op1158, i64 15
...
polly.loop_header426:                             ; preds = %polly.loop_exit435, %polly.loop_header420
  ...
  %169 = mul nuw nsw i64 %polly.indvar429, 80
...
polly.loop_header433:                             ; preds = %polly.loop_exit442, %polly.loop_header426
  ...
  %172 = mul i64 %polly.indvar436, -80
  %173 = add i64 %160, %172
  %174 = add i64 %smax1310, %173
  %175 = mul nsw i64 %polly.indvar436, 80
...
polly.loop_exit442:                               ; preds = %polly.loop_exit478, %polly.loop_header433
  ...
  %indvars.iv.next1070 = add i64 %indvars.iv1069, 80
  %indvars.iv.next1075 = add i64 %indvars.iv1074, -80
...
polly.loop_header440:                             ; preds = %polly.loop_header440.preheader, %polly.loop_exit478
  ...
  %smin1313 = call i64 @llvm.smin.i64(i64 %182, i64 79)
  %183 = add nsw i64 %smin1313, 1
  %smin1082 = call i64 @llvm.smin.i64(i64 %indvars.iv1076, i64 79)
...
polly.loop_header631:                             ; preds = %polly.loop_exit623, %polly.loop_exit639
  ...
  %229 = select i1 %.inv928, i64 %.op1160, i64 15
...
polly.loop_header637:                             ; preds = %polly.loop_exit646, %polly.loop_header631
  ...
  %231 = mul nuw nsw i64 %polly.indvar640, 80
...
polly.loop_header644:                             ; preds = %polly.loop_exit653, %polly.loop_header637
  ...
  %232 = mul i64 %polly.indvar647, 80
  %233 = add i64 %221, %232
  %smax1262 = call i64 @llvm.smax.i64(i64 %233, i64 0)
  %234 = mul i64 %polly.indvar647, -80
  %235 = add i64 %222, %234
  %236 = add i64 %smax1262, %235
  %237 = mul nsw i64 %polly.indvar647, 80
...
polly.loop_header651:                             ; preds = %polly.loop_header651.preheader, %polly.loop_exit689
  ...
  %smin1265 = call i64 @llvm.smin.i64(i64 %244, i64 79)
  %245 = add nsw i64 %smin1265, 1
  %smin1112 = call i64 @llvm.smin.i64(i64 %indvars.iv1106, i64 79)
