; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8304.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8304.c"
...
vector.body960:                                   ; preds = %vector.body960, %vector.ph964
  ...
  %wide.load971 = load <4 x double>, <4 x double>* %114, align 8, !alias.scope !72, !noalias !74
  ...
  br i1 %117, label %middle.block958, label %vector.body960, !llvm.loop !77
...
polly.loop_header352:                             ; preds = %polly.loop_exit344, %polly.loop_exit366.4
  ...
  %120 = shl nsw i64 %polly.indvar355, 6
...
vector.body936:                                   ; preds = %vector.body936, %vector.ph938
  ...
  %wide.load945 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !81, !noalias !83
  ...
  br i1 %139, label %middle.block934, label %vector.body936, !llvm.loop !86
...
polly.loop_header505:                             ; preds = %polly.loop_exit497, %polly.loop_exit519.4
  ...
  %142 = shl nsw i64 %polly.indvar508, 6
...
vector.body874:                                   ; preds = %vector.body874, %vector.ph876
  ...
  br i1 %175, label %polly.loop_exit702, label %vector.body874, !llvm.loop !95
...
vector.body889:                                   ; preds = %vector.body889, %vector.ph892
  ...
  br i1 %204, label %polly.loop_exit729, label %vector.body889, !llvm.loop !98
...
vector.body907:                                   ; preds = %vector.body907, %vector.ph910
  ...
  br i1 %233, label %polly.loop_exit755, label %vector.body907, !llvm.loop !101
