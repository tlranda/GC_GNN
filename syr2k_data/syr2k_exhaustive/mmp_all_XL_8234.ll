; ModuleID = 'syr2k_exhaustive/mmp_all_XL_8234.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_8234.c"
...
polly.loop_header360:                             ; preds = %polly.loop_exit369, %polly.loop_header354
  ...
  %144 = lshr i64 %polly.indvar363, 2
  ...
  %151 = mul nuw nsw i64 %polly.indvar363, 100
  %152 = mul nsw i64 %polly.indvar363, -100
  br label %polly.loop_header367

polly.loop_exit369:                               ; preds = %polly.loop_exit375
  %polly.indvar_next364 = add nuw nsw i64 %polly.indvar363, 1
  %indvars.iv.next801 = add nuw nsw i64 %indvars.iv800, 100
  %indvars.iv.next803 = add nuw nsw i64 %indvars.iv802, 6
...
polly.loop_header367:                             ; preds = %polly.loop_exit375, %polly.loop_header360
  ...
  %154 = shl nsw i64 %polly.indvar370, 4
  %155 = sub nsw i64 %151, %154
  %156 = icmp sgt i64 %155, 0
  %157 = select i1 %156, i64 %155, i64 0
  %polly.loop_guard383 = icmp slt i64 %157, 16
...
polly.loop_header518:                             ; preds = %polly.loop_exit527, %polly.loop_header512
  ...
  %184 = lshr i64 %polly.indvar521, 2
  ...
  %191 = mul nuw nsw i64 %polly.indvar521, 100
  %192 = mul nsw i64 %polly.indvar521, -100
...
polly.loop_exit527:                               ; preds = %polly.loop_exit533
  ...
  %indvars.iv.next823 = add nuw nsw i64 %indvars.iv822, 6
...
polly.loop_exit533:                               ; preds = %polly.loop_exit548.us.3, %polly.loop_header525
  ...
  %indvars.iv.next825 = add i64 %indvars.iv824, -16
  %indvars.iv.next830 = add i64 %indvars.iv829, 16
...
vector.body912:                                   ; preds = %vector.body912, %vector.ph914
  ...
  br i1 %229, label %polly.loop_exit714, label %vector.body912, !llvm.loop !95
...
vector.body927:                                   ; preds = %vector.body927, %vector.ph930
  ...
  br i1 %258, label %polly.loop_exit741, label %vector.body927, !llvm.loop !98
...
vector.body945:                                   ; preds = %vector.body945, %vector.ph948
  ...
  br i1 %287, label %polly.loop_exit767, label %vector.body945, !llvm.loop !101
