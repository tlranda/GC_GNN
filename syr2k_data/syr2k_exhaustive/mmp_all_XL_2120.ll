; ModuleID = 'syr2k_exhaustive/mmp_all_XL_2120.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_2120.c"
...
polly.loop_header216:                             ; preds = %polly.loop_exit208, %polly.loop_exit224
  ...
  %.inv = icmp slt i64 %101, 11
  %103 = select i1 %.inv, i64 %102, i64 11
...
polly.loop_header235:                             ; preds = %polly.loop_header235.preheader, %polly.loop_exit269
  ...
  %smin1350 = call i64 @llvm.smin.i64(i64 %122, i64 99)
...
polly.loop_header422:                             ; preds = %polly.loop_exit414, %polly.loop_exit430
  ...
  %.inv932 = icmp slt i64 %165, 11
  %167 = select i1 %.inv932, i64 %166, i64 11
  %polly.loop_guard439 = icmp sgt i64 %167, -1
  %168 = mul nsw i64 %polly.indvar425, -64
  %169 = icmp slt i64 %168, -1136
  %170 = select i1 %169, i64 %168, i64 -1136
  %171 = add nsw i64 %170, 1199
  %172 = shl nsw i64 %polly.indvar425, 6
...
polly.loop_header436:                             ; preds = %polly.loop_header436.preheader, %polly.loop_exit446
  ...
  %174 = mul i64 %polly.indvar440, 100
  %175 = add i64 %161, %174
  %smax1299 = call i64 @llvm.smax.i64(i64 %175, i64 0)
  %176 = mul i64 %polly.indvar440, -100
  %177 = add i64 %162, %176
  %178 = add i64 %smax1299, %177
  %179 = mul nsw i64 %polly.indvar440, 100
...
polly.loop_header444:                             ; preds = %polly.loop_header444.preheader, %polly.loop_exit482
  ...
  %smin1302 = call i64 @llvm.smin.i64(i64 %186, i64 99)
...
polly.loop_header635:                             ; preds = %polly.loop_exit627, %polly.loop_exit643
  ...
  %.inv934 = icmp slt i64 %229, 11
  %231 = select i1 %.inv934, i64 %230, i64 11
  %polly.loop_guard652 = icmp sgt i64 %231, -1
  %232 = mul nsw i64 %polly.indvar638, -64
  %233 = icmp slt i64 %232, -1136
  %234 = select i1 %233, i64 %232, i64 -1136
  %235 = add nsw i64 %234, 1199
  %236 = shl nsw i64 %polly.indvar638, 6
...
polly.loop_header649:                             ; preds = %polly.loop_header649.preheader, %polly.loop_exit659
  ...
  %238 = mul i64 %polly.indvar653, 100
  %239 = add i64 %225, %238
  %smax1251 = call i64 @llvm.smax.i64(i64 %239, i64 0)
  %240 = mul i64 %polly.indvar653, -100
  %241 = add i64 %226, %240
  %242 = add i64 %smax1251, %241
  %243 = mul nsw i64 %polly.indvar653, 100
...
polly.loop_header657:                             ; preds = %polly.loop_header657.preheader, %polly.loop_exit695
  ...
  %smin1254 = call i64 @llvm.smin.i64(i64 %250, i64 99)
