; ModuleID = 'syr2k_exhaustive/mmp_all_SM_8640.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_8640.c"
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond778.not = icmp eq i64 %polly.indvar_next209, 24
...
polly.loop_exit219:                               ; preds = %polly.loop_exit225
  ...
  %exitcond777.not = icmp eq i64 %polly.indvar_next215, 24
...
polly.loop_header223:                             ; preds = %polly.loop_exit231, %polly.loop_header217
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv770, i64 49)
...
polly.loop_exit366:                               ; preds = %polly.loop_exit372
  ...
  %exitcond794.not = icmp eq i64 %polly.indvar_next362, 24
...
polly.loop_exit372:                               ; preds = %polly.loop_exit378
  ...
  %indvars.iv.next783 = add nuw nsw i64 %indvars.iv782, 50
  %exitcond793.not = icmp eq i64 %polly.indvar_next368, 24
...
polly.loop_header376:                             ; preds = %polly.loop_exit384, %polly.loop_header370
  ...
  %smin786 = call i64 @llvm.smin.i64(i64 %indvars.iv784, i64 49)
...
polly.loop_exit384:                               ; preds = %polly.loop_header382
  ...
  %exitcond788.not = icmp eq i64 %polly.indvar_next380, 50
...
polly.loop_header511:                             ; preds = %polly.loop_exit519, %polly.loop_header505
  ...
  %147 = mul nuw nsw i64 %polly.indvar514, 50
...
polly.loop_exit519:                               ; preds = %polly.loop_exit525
  ...
  %exitcond810.not = icmp eq i64 %polly.indvar_next515, 24
...
polly.loop_header517:                             ; preds = %polly.loop_exit525, %polly.loop_header511
  ...
  %148 = mul nuw nsw i64 %polly.indvar520, 50
...
polly.loop_exit525:                               ; preds = %polly.loop_exit531
  ...
  %indvars.iv.next799 = add nuw nsw i64 %indvars.iv798, 50
  %exitcond809.not = icmp eq i64 %polly.indvar_next521, 24
...
polly.loop_header529:                             ; preds = %polly.loop_exit537, %polly.loop_header523
  ...
  %smin802 = call i64 @llvm.smin.i64(i64 %indvars.iv800, i64 49)
...
polly.loop_exit537:                               ; preds = %polly.loop_header535
  ...
  %exitcond804.not = icmp eq i64 %polly.indvar_next533, 50
