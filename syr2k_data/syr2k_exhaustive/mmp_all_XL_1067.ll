; ModuleID = 'syr2k_exhaustive/mmp_all_XL_1067.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_1067.c"
...
polly.loop_exit230:                               ; preds = %polly.loop_exit265
  ...
  %exitcond1118.not = icmp eq i64 %115, 300
...
polly.loop_header228:                             ; preds = %polly.loop_exit265, %polly.loop_exit214
  ...
  %118 = mul nsw i64 %indvar1427, -96
  %119 = add i64 %102, %118
  %smax1429 = call i64 @llvm.smax.i64(i64 %119, i64 0)
  %120 = mul nuw nsw i64 %indvar1427, 96
  %121 = add i64 %104, %120
  %122 = add i64 %smax1429, %121
  %smax = call i64 @llvm.smax.i64(i64 %indvars.iv1106, i64 0)
  %123 = add i64 %smax, %indvars.iv1110
  %124 = mul nuw nsw i64 %polly.indvar231, 24
  %.not.not = icmp ugt i64 %124, %polly.indvar209
  %125 = mul nuw nsw i64 %polly.indvar231, 96
  %126 = add nsw i64 %125, %109
  %127 = icmp sgt i64 %126, 0
  %128 = select i1 %127, i64 %126, i64 0
  %129 = add nsw i64 %126, 95
...
polly.loop_header270:                             ; preds = %polly.loop_header263, %polly.loop_exit280
  ...
  %143 = add i64 %122, %indvar1430
  %smin1432 = call i64 @llvm.smin.i64(i64 %143, i64 3)
  %144 = add nsw i64 %smin1432, 1
  %smin1114 = call i64 @llvm.smin.i64(i64 %indvars.iv1112, i64 3)
  %145 = add nsw i64 %polly.indvar274, %126
  %polly.loop_guard2811221 = icmp sgt i64 %145, -1
...
polly.loop_header278.preheader:                   ; preds = %polly.loop_header270
  ...
  %min.iters.check1433 = icmp ult i64 %144, 4
...
vector.body1426:                                  ; preds = %vector.body1426, %vector.ph1434
  ...
  %148 = add nuw nsw i64 %index1437, %110
  %149 = add nuw nsw i64 %index1437, %polly.access.mul.Packed_MemRef_call1285
  %150 = getelementptr double, double* %Packed_MemRef_call1, i64 %149
  %151 = bitcast double* %150 to <4 x double>*
  %wide.load1441 = load <4 x double>, <4 x double>* %151, align 8
  %152 = fmul fast <4 x double> %broadcast.splat1443, %wide.load1441
  %153 = getelementptr double, double* %Packed_MemRef_call2, i64 %149
  %154 = bitcast double* %153 to <4 x double>*
  %wide.load1444 = load <4 x double>, <4 x double>* %154, align 8
  %155 = fmul fast <4 x double> %broadcast.splat1446, %wide.load1444
  %156 = shl i64 %148, 3
  %157 = add i64 %156, %147
  %158 = getelementptr i8, i8* %call, i64 %157
  %159 = bitcast i8* %158 to <4 x double>*
  %wide.load1447 = load <4 x double>, <4 x double>* %159, align 8, !alias.scope !72, !noalias !74
  ...
  %162 = fadd fast <4 x double> %161, %wide.load1447
  ...
  %164 = icmp eq i64 %index.next1438, %n.vec1436
  br i1 %164, label %middle.block1424, label %vector.body1426, !llvm.loop !84

middle.block1424:                                 ; preds = %vector.body1426
  %cmp.n1440 = icmp eq i64 %144, %n.vec1436
...
vector.body1362:                                  ; preds = %vector.body1362, %vector.ph1366
  ...
  %170 = shl nuw nsw i64 %index1369, 3
  %171 = getelementptr i8, i8* %scevgep406, i64 %170
  %172 = bitcast i8* %171 to <4 x double>*
  %wide.load1373 = load <4 x double>, <4 x double>* %172, align 8, !alias.scope !86, !noalias !88
  %173 = fmul fast <4 x double> %wide.load1373, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %175 = icmp eq i64 %index.next1370, %n.vec1368
  br i1 %175, label %middle.block1360, label %vector.body1362, !llvm.loop !93

middle.block1360:                                 ; preds = %vector.body1362
  %cmp.n1372 = icmp eq i64 %168, %n.vec1368
...
polly.loop_header410:                             ; preds = %polly.loop_header410.preheader, %polly.loop_exit418
  ...
  %177 = add nsw i64 %smin1147, 1000
  %178 = shl nsw i64 %polly.indvar413, 7
...
polly.loop_header416:                             ; preds = %polly.loop_exit441, %polly.loop_header410
  ...
  %180 = udiv i64 %polly.indvar419, 24
  %181 = mul nuw nsw i64 %180, 96
  %182 = sub nsw i64 %179, %181
  %183 = mul nsw i64 %polly.indvar419, -4
  %184 = add i64 %183, %181
  %185 = udiv i64 %polly.indvar419, 24
  %186 = mul nuw nsw i64 %185, 96
  %187 = sub nsw i64 %indvars.iv1134, %186
  %188 = add i64 %indvars.iv1139, %186
...
polly.loop_exit441:                               ; preds = %polly.loop_exit482
  ...
  %indvars.iv.next1135 = add nuw nsw i64 %indvars.iv1134, 4
  %indvars.iv.next1140 = add nsw i64 %indvars.iv1139, -4
  %exitcond1149.not = icmp eq i64 %195, 300
...
polly.loop_exit430:                               ; preds = %polly.loop_header428
  ...
  %exitcond1128.not = icmp eq i64 %polly.indvar_next426, %177
...
polly.loop_header439:                             ; preds = %polly.loop_exit482, %polly.loop_exit424
  ...
  %indvars.iv1141 = phi i64 [ %indvars.iv.next1142, %polly.loop_exit482 ], [ %188, %polly.loop_exit424 ]
  %indvars.iv1136 = phi i64 [ %indvars.iv.next1137, %polly.loop_exit482 ], [ %187, %polly.loop_exit424 ]
  %polly.indvar442 = phi i64 [ %polly.indvar_next443, %polly.loop_exit482 ], [ %185, %polly.loop_exit424 ]
  %198 = mul nsw i64 %indvar1377, -96
  %199 = add i64 %182, %198
  %smax1379 = call i64 @llvm.smax.i64(i64 %199, i64 0)
  %200 = mul nuw nsw i64 %indvar1377, 96
  %201 = add i64 %184, %200
  %202 = add i64 %smax1379, %201
  %smax1138 = call i64 @llvm.smax.i64(i64 %indvars.iv1136, i64 0)
  %203 = add i64 %smax1138, %indvars.iv1141
  %204 = mul nuw nsw i64 %polly.indvar442, 24
  %.not.not944 = icmp ugt i64 %204, %polly.indvar419
  %205 = mul nuw nsw i64 %polly.indvar442, 96
...
polly.loop_exit468.us:                            ; preds = %polly.loop_header466.us, %polly.loop_header445.us
  ...
  %exitcond1133.not = icmp eq i64 %polly.indvar_next449.us, %177
...
polly.loop_exit468:                               ; preds = %polly.loop_header466
  ...
  %exitcond1130.not = icmp eq i64 %polly.indvar_next449, %177
...
polly.loop_exit489:                               ; preds = %polly.loop_exit497
  ...
  %exitcond1148.not = icmp eq i64 %polly.indvar_next484, %177
...
polly.loop_header487:                             ; preds = %polly.loop_header480, %polly.loop_exit497
  ...
  %indvars.iv1143 = phi i64 [ %203, %polly.loop_header480 ], [ %indvars.iv.next1144, %polly.loop_exit497 ]
  %polly.indvar491 = phi i64 [ %217, %polly.loop_header480 ], [ %polly.indvar_next492, %polly.loop_exit497 ]
  %223 = add i64 %202, %indvar1380
  %smin1382 = call i64 @llvm.smin.i64(i64 %223, i64 3)
  %224 = add nsw i64 %smin1382, 1
  %smin1145 = call i64 @llvm.smin.i64(i64 %indvars.iv1143, i64 3)
  %225 = add nsw i64 %polly.indvar491, %206
  %polly.loop_guard4981222 = icmp sgt i64 %225, -1
...
polly.loop_header495.preheader:                   ; preds = %polly.loop_header487
  ...
  %min.iters.check1383 = icmp ult i64 %224, 4
...
vector.body1376:                                  ; preds = %vector.body1376, %vector.ph1384
  ...
  %228 = add nuw nsw i64 %index1387, %190
  %229 = add nuw nsw i64 %index1387, %polly.access.mul.Packed_MemRef_call1309502
  %230 = getelementptr double, double* %Packed_MemRef_call1309, i64 %229
  %231 = bitcast double* %230 to <4 x double>*
  %wide.load1391 = load <4 x double>, <4 x double>* %231, align 8
  %232 = fmul fast <4 x double> %broadcast.splat1393, %wide.load1391
  %233 = getelementptr double, double* %Packed_MemRef_call2311, i64 %229
  %234 = bitcast double* %233 to <4 x double>*
  %wide.load1394 = load <4 x double>, <4 x double>* %234, align 8
  %235 = fmul fast <4 x double> %broadcast.splat1396, %wide.load1394
  %236 = shl i64 %228, 3
  %237 = add i64 %236, %227
  %238 = getelementptr i8, i8* %call, i64 %237
  %239 = bitcast i8* %238 to <4 x double>*
  %wide.load1397 = load <4 x double>, <4 x double>* %239, align 8, !alias.scope !86, !noalias !88
  ...
  %242 = fadd fast <4 x double> %241, %wide.load1397
  ...
  %244 = icmp eq i64 %index.next1388, %n.vec1386
  br i1 %244, label %middle.block1374, label %vector.body1376, !llvm.loop !97

middle.block1374:                                 ; preds = %vector.body1376
  %cmp.n1390 = icmp eq i64 %224, %n.vec1386
...
polly.loop_header611:                             ; preds = %polly.loop_exit619, %polly.start523
  ...
  %min.iters.check1315 = icmp ult i64 %248, 4
...
vector.body1314:                                  ; preds = %vector.body1314, %vector.ph1316
  ...
  %250 = shl nuw nsw i64 %index1319, 3
  %251 = getelementptr i8, i8* %scevgep623, i64 %250
  %252 = bitcast i8* %251 to <4 x double>*
  %wide.load1323 = load <4 x double>, <4 x double>* %252, align 8, !alias.scope !99, !noalias !101
  %253 = fmul fast <4 x double> %wide.load1323, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %255 = icmp eq i64 %index.next1320, %n.vec1318
  br i1 %255, label %middle.block1312, label %vector.body1314, !llvm.loop !106

middle.block1312:                                 ; preds = %vector.body1314
  %cmp.n1322 = icmp eq i64 %248, %n.vec1318
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %260 = udiv i64 %polly.indvar636, 24
  %261 = mul nuw nsw i64 %260, 96
  %262 = sub nsw i64 %259, %261
  %263 = mul nsw i64 %polly.indvar636, -4
  %264 = add i64 %263, %261
  %265 = udiv i64 %polly.indvar636, 24
  %266 = mul nuw nsw i64 %265, 96
  %267 = sub nsw i64 %indvars.iv1165, %266
  %268 = add i64 %indvars.iv1170, %266
...
polly.loop_exit658:                               ; preds = %polly.loop_exit699
  ...
  %indvars.iv.next1171 = add nsw i64 %indvars.iv1170, -4
  %exitcond1180.not = icmp eq i64 %275, 300
...
polly.loop_exit647:                               ; preds = %polly.loop_header645
  ...
  %exitcond1159.not = icmp eq i64 %polly.indvar_next643, %257
...
polly.loop_header656:                             ; preds = %polly.loop_exit699, %polly.loop_exit641
  ...
  %indvars.iv1172 = phi i64 [ %indvars.iv.next1173, %polly.loop_exit699 ], [ %268, %polly.loop_exit641 ]
  %indvars.iv1167 = phi i64 [ %indvars.iv.next1168, %polly.loop_exit699 ], [ %267, %polly.loop_exit641 ]
  %polly.indvar659 = phi i64 [ %polly.indvar_next660, %polly.loop_exit699 ], [ %265, %polly.loop_exit641 ]
  %278 = mul nsw i64 %indvar1327, -96
  %279 = add i64 %262, %278
  %smax1329 = call i64 @llvm.smax.i64(i64 %279, i64 0)
  %280 = mul nuw nsw i64 %indvar1327, 96
  %281 = add i64 %264, %280
  %282 = add i64 %smax1329, %281
  %smax1169 = call i64 @llvm.smax.i64(i64 %indvars.iv1167, i64 0)
  %283 = add i64 %smax1169, %indvars.iv1172
  %284 = mul nuw nsw i64 %polly.indvar659, 24
  %.not.not945 = icmp ugt i64 %284, %polly.indvar636
  %285 = mul nuw nsw i64 %polly.indvar659, 96
  %286 = add nsw i64 %285, %269
  %287 = icmp sgt i64 %286, 0
  %288 = select i1 %287, i64 %286, i64 0
  %289 = add nsw i64 %286, 95
...
polly.loop_exit685.us:                            ; preds = %polly.loop_header683.us, %polly.loop_header662.us
  ...
  %exitcond1164.not = icmp eq i64 %polly.indvar_next666.us, %257
...
polly.loop_exit685:                               ; preds = %polly.loop_header683
  ...
  %exitcond1161.not = icmp eq i64 %polly.indvar_next666, %257
...
polly.loop_exit706:                               ; preds = %polly.loop_exit714
  ...
  %exitcond1179.not = icmp eq i64 %polly.indvar_next701, %257
...
polly.loop_header704:                             ; preds = %polly.loop_header697, %polly.loop_exit714
  ...
  %indvars.iv1174 = phi i64 [ %283, %polly.loop_header697 ], [ %indvars.iv.next1175, %polly.loop_exit714 ]
  %polly.indvar708 = phi i64 [ %297, %polly.loop_header697 ], [ %polly.indvar_next709, %polly.loop_exit714 ]
  %303 = add i64 %282, %indvar1330
  %smin1332 = call i64 @llvm.smin.i64(i64 %303, i64 3)
  %304 = add nsw i64 %smin1332, 1
  %smin1176 = call i64 @llvm.smin.i64(i64 %indvars.iv1174, i64 3)
  %305 = add nsw i64 %polly.indvar708, %286
  %polly.loop_guard7151223 = icmp sgt i64 %305, -1
...
polly.loop_header712.preheader:                   ; preds = %polly.loop_header704
  ...
  %min.iters.check1333 = icmp ult i64 %304, 4
...
vector.body1326:                                  ; preds = %vector.body1326, %vector.ph1334
  ...
  %308 = add nuw nsw i64 %index1337, %270
  %309 = add nuw nsw i64 %index1337, %polly.access.mul.Packed_MemRef_call1526719
  %310 = getelementptr double, double* %Packed_MemRef_call1526, i64 %309
  %311 = bitcast double* %310 to <4 x double>*
  %wide.load1341 = load <4 x double>, <4 x double>* %311, align 8
  %312 = fmul fast <4 x double> %broadcast.splat1343, %wide.load1341
  %313 = getelementptr double, double* %Packed_MemRef_call2528, i64 %309
  %314 = bitcast double* %313 to <4 x double>*
  %wide.load1344 = load <4 x double>, <4 x double>* %314, align 8
  %315 = fmul fast <4 x double> %broadcast.splat1346, %wide.load1344
  %316 = shl i64 %308, 3
  %317 = add i64 %316, %307
  %318 = getelementptr i8, i8* %call, i64 %317
  %319 = bitcast i8* %318 to <4 x double>*
  %wide.load1347 = load <4 x double>, <4 x double>* %319, align 8, !alias.scope !99, !noalias !101
  ...
  %322 = fadd fast <4 x double> %321, %wide.load1347
  ...
  %324 = icmp eq i64 %index.next1338, %n.vec1336
  br i1 %324, label %middle.block1324, label %vector.body1326, !llvm.loop !110

middle.block1324:                                 ; preds = %vector.body1326
  %cmp.n1340 = icmp eq i64 %304, %n.vec1336
...
vector.ph1254:                                    ; preds = %polly.loop_header876
  %broadcast.splatinsert1261 = insertelement <4 x i64> poison, i64 %332, i32 0
  %broadcast.splat1262 = shufflevector <4 x i64> %broadcast.splatinsert1261, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert1263 = insertelement <4 x i32> poison, i32 %335, i32 0
...
vector.body1253:                                  ; preds = %vector.body1253, %vector.ph1254
  ...
  %337 = add nuw nsw <4 x i64> %vec.ind1259, %broadcast.splat1262
  %338 = trunc <4 x i64> %337 to <4 x i32>
  %339 = mul <4 x i32> %broadcast.splat1264, %338
  ...
  %349 = icmp eq i64 %index.next1256, %331
  br i1 %349, label %polly.loop_exit884, label %vector.body1253, !llvm.loop !117

polly.loop_exit884:                               ; preds = %vector.body1253, %polly.loop_header882
  %polly.indvar_next880 = add nuw nsw i64 %polly.indvar879, 1
  %exitcond1211.not = icmp eq i64 %polly.indvar879, %329
...
polly.loop_header882:                             ; preds = %polly.loop_header876, %polly.loop_header882
  ...
  %exitcond1207.not = icmp eq i64 %polly.indvar885, %333
...
polly.loop_header897:                             ; preds = %polly.loop_exit905, %polly.loop_header891
  ...
  %smin1268 = call i64 @llvm.smin.i64(i64 %359, i64 -968)
  %360 = add nsw i64 %smin1268, 1000
  %smin1196 = call i64 @llvm.smin.i64(i64 %indvars.iv1194, i64 -968)
  %361 = shl nsw i64 %polly.indvar900, 5
  %362 = add nsw i64 %smin1196, 999
...
vector.body1267:                                  ; preds = %vector.body1267, %vector.ph1270
  ...
  %366 = add nuw nsw <4 x i64> %vec.ind1277, %broadcast.splat1280
  %367 = trunc <4 x i64> %366 to <4 x i32>
  %368 = mul <4 x i32> %broadcast.splat1282, %367
  ...
  %378 = icmp eq i64 %index.next1274, %360
  br i1 %378, label %polly.loop_exit911, label %vector.body1267, !llvm.loop !120

polly.loop_exit911:                               ; preds = %vector.body1267, %polly.loop_header909
  %polly.indvar_next907 = add nuw nsw i64 %polly.indvar906, 1
  %exitcond1201.not = icmp eq i64 %polly.indvar906, %358
...
polly.loop_header909:                             ; preds = %polly.loop_header903, %polly.loop_header909
  ...
  %exitcond1197.not = icmp eq i64 %polly.indvar912, %362
...
polly.loop_header923:                             ; preds = %polly.loop_exit931, %polly.loop_header917
  ...
  %smin1286 = call i64 @llvm.smin.i64(i64 %388, i64 -968)
  %389 = add nsw i64 %smin1286, 1000
  %smin1186 = call i64 @llvm.smin.i64(i64 %indvars.iv1184, i64 -968)
  %390 = shl nsw i64 %polly.indvar926, 5
  %391 = add nsw i64 %smin1186, 999
...
vector.body1285:                                  ; preds = %vector.body1285, %vector.ph1288
  ...
  %395 = add nuw nsw <4 x i64> %vec.ind1295, %broadcast.splat1298
  %396 = trunc <4 x i64> %395 to <4 x i32>
  %397 = mul <4 x i32> %broadcast.splat1300, %396
  ...
  %407 = icmp eq i64 %index.next1292, %389
  br i1 %407, label %polly.loop_exit937, label %vector.body1285, !llvm.loop !123

polly.loop_exit937:                               ; preds = %vector.body1285, %polly.loop_header935
  %polly.indvar_next933 = add nuw nsw i64 %polly.indvar932, 1
  %exitcond1191.not = icmp eq i64 %polly.indvar932, %387
...
polly.loop_header935:                             ; preds = %polly.loop_header929, %polly.loop_header935
  ...
  %exitcond1187.not = icmp eq i64 %polly.indvar938, %391
