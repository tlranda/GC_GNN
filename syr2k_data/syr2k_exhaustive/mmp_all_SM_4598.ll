; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4598.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4598.c"
...
polly.loop_header211:                             ; preds = %polly.loop_exit219, %polly.loop_header205
  ...
  %112 = shl nsw i64 %polly.indvar214, 2
...
vector.body1189:                                  ; preds = %vector.body1189, %vector.ph1193
  ...
  %wide.load1200 = load <4 x double>, <4 x double>* %136, align 8, !alias.scope !73, !noalias !75
  ...
  br i1 %139, label %middle.block1187, label %vector.body1189, !llvm.loop !79
...
polly.loop_header396:                             ; preds = %polly.loop_exit405, %polly.loop_header389
  ...
  %156 = shl nsw i64 %polly.indvar399, 2
...
vector.body1165:                                  ; preds = %vector.body1165, %vector.ph1167
  ...
  %wide.load1174 = load <4 x double>, <4 x double>* %180, align 8, !alias.scope !83, !noalias !85
  ...
  br i1 %183, label %middle.block1163, label %vector.body1165, !llvm.loop !89
...
polly.loop_header587:                             ; preds = %polly.loop_exit596, %polly.loop_header580
  ...
  %200 = shl nsw i64 %polly.indvar590, 2
...
vector.body1104:                                  ; preds = %vector.body1104, %vector.ph1105
  ...
  br i1 %241, label %polly.loop_exit807, label %vector.body1104, !llvm.loop !98
...
vector.body1118:                                  ; preds = %vector.body1118, %vector.ph1121
  ...
  br i1 %270, label %polly.loop_exit834, label %vector.body1118, !llvm.loop !101
...
vector.body1136:                                  ; preds = %vector.body1136, %vector.ph1139
  ...
  br i1 %299, label %polly.loop_exit860, label %vector.body1136, !llvm.loop !104
