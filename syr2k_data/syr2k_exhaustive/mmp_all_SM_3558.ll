; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3558.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3558.c"
...
polly.loop_header199:                             ; preds = %polly.loop_header199.preheader, %polly.loop_exit207
  ...
  %smin1129 = call i64 @llvm.smin.i64(i64 %indvars.iv1110, i64 -968)
...
polly.loop_header406:                             ; preds = %polly.loop_header406.preheader, %polly.loop_exit414
  ...
  %smin1163 = call i64 @llvm.smin.i64(i64 %indvars.iv1143, i64 -968)
  %146 = add nsw i64 %smin1163, 1000
  %147 = shl nsw i64 %polly.indvar409, 5
  br label %polly.loop_header412

polly.loop_exit414:                               ; preds = %polly.loop_exit422
  %polly.indvar_next410 = add nuw nsw i64 %polly.indvar409, 1
  %indvars.iv.next1144 = add nsw i64 %indvars.iv1143, -32
  %exitcond1166.not = icmp eq i64 %polly.indvar_next410, 32
...
polly.loop_header620:                             ; preds = %polly.loop_header620.preheader, %polly.loop_exit628
  ...
  %smin1197 = call i64 @llvm.smin.i64(i64 %indvars.iv1177, i64 -968)
  %195 = add nsw i64 %smin1197, 1000
  %196 = shl nsw i64 %polly.indvar623, 5
...
polly.loop_exit628:                               ; preds = %polly.loop_exit636
  ...
  %exitcond1200.not = icmp eq i64 %polly.indvar_next624, 32
