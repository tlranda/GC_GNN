; ModuleID = 'syr2k_exhaustive/mmp_all_SM_217.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_217.c"
...
polly.loop_exit214:                               ; preds = %polly.loop_exit220
  ...
  %113 = mul nuw nsw i64 %polly.indvar209, 12
...
polly.loop_header272.us:                          ; preds = %polly.loop_header265.us, %polly.loop_exit282.us
  ...
  %smin1401 = call i64 @llvm.smin.i64(i64 %137, i64 99)
...
polly.loop_header418:                             ; preds = %polly.loop_exit443, %polly.loop_header412
  ...
  %173 = mul nuw nsw i64 %polly.indvar421, 100
  %174 = mul nuw nsw i64 %polly.indvar421, 12
  %175 = lshr i64 %polly.indvar421, 1
  %176 = add nuw i64 %174, %175
  %177 = shl nuw nsw i64 %176, 3
  %178 = sub i64 %173, %177
  %179 = mul nsw i64 %polly.indvar421, -100
  %180 = add i64 %179, %177
  ...
  %186 = mul nuw nsw i64 %polly.indvar421, 100
  br label %polly.loop_header424

polly.loop_exit426:                               ; preds = %polly.loop_exit432
  %187 = mul nsw i64 %polly.indvar421, -100
  %188 = mul nuw nsw i64 %polly.indvar421, 12
...
polly.loop_header441:                             ; preds = %polly.loop_exit482, %polly.loop_exit426
  ...
  %.inv942 = icmp sgt i64 %199, 99
  %201 = select i1 %.inv942, i64 99, i64 %200
...
polly.loop_header487.us:                          ; preds = %polly.loop_header480.us, %polly.loop_exit497.us
  ...
  %smin1351 = call i64 @llvm.smin.i64(i64 %212, i64 99)
...
polly.loop_header633:                             ; preds = %polly.loop_exit658, %polly.loop_header627
  ...
  %248 = mul nuw nsw i64 %polly.indvar636, 100
  %249 = mul nuw nsw i64 %polly.indvar636, 12
  %250 = lshr i64 %polly.indvar636, 1
  %251 = add nuw i64 %249, %250
  %252 = shl nuw nsw i64 %251, 3
  %253 = sub i64 %248, %252
  %254 = mul nsw i64 %polly.indvar636, -100
  %255 = add i64 %254, %252
  ...
  %261 = mul nuw nsw i64 %polly.indvar636, 100
  br label %polly.loop_header639

polly.loop_exit641:                               ; preds = %polly.loop_exit647
  %262 = mul nsw i64 %polly.indvar636, -100
  %263 = mul nuw nsw i64 %polly.indvar636, 12
...
polly.loop_header656:                             ; preds = %polly.loop_exit697, %polly.loop_exit641
  ...
  %.inv943 = icmp sgt i64 %274, 99
  %276 = select i1 %.inv943, i64 99, i64 %275
...
polly.loop_header702.us:                          ; preds = %polly.loop_header695.us, %polly.loop_exit712.us
  ...
  %smin1301 = call i64 @llvm.smin.i64(i64 %287, i64 99)
