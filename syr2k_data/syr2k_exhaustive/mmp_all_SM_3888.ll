; ModuleID = 'syr2k_exhaustive/mmp_all_SM_3888.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_3888.c"
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %112 = shl nuw nsw i64 %indvars.iv1007, 1
  %113 = and i64 %112, 9223372036854775680
  %114 = sub nsw i64 %indvars.iv, %113
  %115 = add i64 %indvars.iv1011, %113
  %116 = mul nuw nsw i64 %polly.indvar208, 25
  %pexp.p_div_q = lshr i64 %116, 6
  %117 = mul nsw i64 %polly.indvar208, -50
  %118 = mul nuw nsw i64 %polly.indvar208, 50
...
polly.loop_header248.preheader:                   ; preds = %polly.loop_header234.7, %polly.loop_header234.us.7, %polly.loop_exit225.loopexit.us.7, %polly.loop_header211.split
  ...
  %135 = mul nsw i64 %polly.indvar214, -128
...
polly.loop_header255:                             ; preds = %polly.loop_header248, %polly.loop_exit265
  %indvars.iv1015 = phi i64 [ %120, %polly.loop_header248 ], [ %indvars.iv.next1016, %polly.loop_exit265 ]
...
polly.loop_exit399:                               ; preds = %polly.loop_exit406
  ...
  %exitcond1045.not = icmp eq i64 %polly.indvar_next395, 125
...
polly.loop_header397:                             ; preds = %polly.loop_exit406, %polly.loop_header391
  ...
  %176 = shl nuw nsw i64 %indvars.iv1029, 1
  %177 = and i64 %176, 9223372036854775680
  %178 = sub nsw i64 %indvars.iv1027, %177
  %179 = add i64 %indvars.iv1034, %177
  %180 = mul nuw nsw i64 %polly.indvar400, 25
  %pexp.p_div_q403 = lshr i64 %180, 6
  %181 = mul nsw i64 %polly.indvar400, -50
  %182 = mul nuw nsw i64 %polly.indvar400, 50
...
polly.loop_header404:                             ; preds = %polly.loop_exit445, %polly.loop_header397
  %indvars.iv1036 = phi i64 [ %indvars.iv.next1037, %polly.loop_exit445 ], [ %179, %polly.loop_header397 ]
  %indvars.iv1031 = phi i64 [ %indvars.iv.next1032, %polly.loop_exit445 ], [ %178, %polly.loop_header397 ]
  ...
  %184 = add i64 %smax1033, %indvars.iv1036
  %185 = shl nsw i64 %polly.indvar407, 7
  %186 = add nsw i64 %185, %181
  %187 = add nsw i64 %186, -1
  %.inv883 = icmp sgt i64 %186, 49
  %188 = select i1 %.inv883, i64 49, i64 %187
  %polly.loop_guard420 = icmp sgt i64 %188, -1
  %189 = icmp sgt i64 %186, 0
  %190 = select i1 %189, i64 %186, i64 0
  %191 = add nsw i64 %186, 127
...
polly.loop_header417.us:                          ; preds = %polly.loop_header404, %polly.loop_header417.us
  ...
  %exitcond1025.not = icmp eq i64 %polly.indvar421.us, %188
...
polly.loop_header443.preheader:                   ; preds = %polly.loop_header429.7, %polly.loop_header429.us.7, %polly.loop_exit419.loopexit.us.7, %polly.loop_header404.split
  ...
  %199 = mul nsw i64 %polly.indvar407, -128
...
polly.loop_exit452:                               ; preds = %polly.loop_exit460
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar_next447, 8
...
polly.loop_header450:                             ; preds = %polly.loop_header443, %polly.loop_exit460
  %indvars.iv1038 = phi i64 [ %184, %polly.loop_header443 ], [ %indvars.iv.next1039, %polly.loop_exit460 ]
...
polly.loop_header592:                             ; preds = %polly.loop_exit601, %polly.loop_header586
  ...
  %240 = shl nuw nsw i64 %indvars.iv1053, 1
  %241 = and i64 %240, 9223372036854775680
  %242 = sub nsw i64 %indvars.iv1051, %241
  %243 = add i64 %indvars.iv1058, %241
  %244 = mul nuw nsw i64 %polly.indvar595, 25
  %pexp.p_div_q598 = lshr i64 %244, 6
  %245 = mul nsw i64 %polly.indvar595, -50
  %246 = mul nuw nsw i64 %polly.indvar595, 50
...
polly.loop_header599:                             ; preds = %polly.loop_exit640, %polly.loop_header592
  %indvars.iv1060 = phi i64 [ %indvars.iv.next1061, %polly.loop_exit640 ], [ %243, %polly.loop_header592 ]
  %indvars.iv1055 = phi i64 [ %indvars.iv.next1056, %polly.loop_exit640 ], [ %242, %polly.loop_header592 ]
  ...
  %248 = add i64 %smax1057, %indvars.iv1060
  %249 = shl nsw i64 %polly.indvar602, 7
  %250 = add nsw i64 %249, %245
  %251 = add nsw i64 %250, -1
  %.inv884 = icmp sgt i64 %250, 49
  %252 = select i1 %.inv884, i64 49, i64 %251
  %polly.loop_guard615 = icmp sgt i64 %252, -1
  %253 = icmp sgt i64 %250, 0
  %254 = select i1 %253, i64 %250, i64 0
  %255 = add nsw i64 %250, 127
...
polly.loop_header612.us:                          ; preds = %polly.loop_header599, %polly.loop_header612.us
  ...
  %exitcond1049.not = icmp eq i64 %polly.indvar616.us, %252
...
polly.loop_header638.preheader:                   ; preds = %polly.loop_header624.7, %polly.loop_header624.us.7, %polly.loop_exit614.loopexit.us.7, %polly.loop_header599.split
  ...
  %263 = mul nsw i64 %polly.indvar602, -128
  %264 = icmp slt i64 %263, -1072
  %265 = select i1 %264, i64 %263, i64 -1072
...
polly.loop_exit647:                               ; preds = %polly.loop_exit655
  ...
  %exitcond1066.not = icmp eq i64 %polly.indvar_next642, 8
...
polly.loop_header645:                             ; preds = %polly.loop_header638, %polly.loop_exit655
  %indvars.iv1062 = phi i64 [ %248, %polly.loop_header638 ], [ %indvars.iv.next1063, %polly.loop_exit655 ]
...
polly.loop_header417.us.1:                        ; preds = %polly.loop_header417.us.1.preheader, %polly.loop_header417.us.1
  ...
  %exitcond1025.1.not = icmp eq i64 %polly.indvar421.us.1, %188
...
polly.loop_header417.us.2:                        ; preds = %polly.loop_header417.us.2.preheader, %polly.loop_header417.us.2
  ...
  %exitcond1025.2.not = icmp eq i64 %polly.indvar421.us.2, %188
...
polly.loop_header417.us.3:                        ; preds = %polly.loop_header417.us.3.preheader, %polly.loop_header417.us.3
  ...
  %exitcond1025.3.not = icmp eq i64 %polly.indvar421.us.3, %188
...
polly.loop_header417.us.4:                        ; preds = %polly.loop_header417.us.4.preheader, %polly.loop_header417.us.4
  ...
  %exitcond1025.4.not = icmp eq i64 %polly.indvar421.us.4, %188
...
polly.loop_header417.us.5:                        ; preds = %polly.loop_header417.us.5.preheader, %polly.loop_header417.us.5
  ...
  %exitcond1025.5.not = icmp eq i64 %polly.indvar421.us.5, %188
...
polly.loop_header417.us.6:                        ; preds = %polly.loop_header417.us.6.preheader, %polly.loop_header417.us.6
  ...
  %exitcond1025.6.not = icmp eq i64 %polly.indvar421.us.6, %188
...
polly.loop_header417.us.7:                        ; preds = %polly.loop_header417.us.7.preheader, %polly.loop_header417.us.7
  ...
  %exitcond1025.7.not = icmp eq i64 %polly.indvar421.us.7, %188
...
polly.loop_header612.us.1:                        ; preds = %polly.loop_header612.us.1.preheader, %polly.loop_header612.us.1
  ...
  %exitcond1049.1.not = icmp eq i64 %polly.indvar616.us.1, %252
...
polly.loop_header612.us.2:                        ; preds = %polly.loop_header612.us.2.preheader, %polly.loop_header612.us.2
  ...
  %exitcond1049.2.not = icmp eq i64 %polly.indvar616.us.2, %252
...
polly.loop_header612.us.3:                        ; preds = %polly.loop_header612.us.3.preheader, %polly.loop_header612.us.3
  ...
  %exitcond1049.3.not = icmp eq i64 %polly.indvar616.us.3, %252
...
polly.loop_header612.us.4:                        ; preds = %polly.loop_header612.us.4.preheader, %polly.loop_header612.us.4
  ...
  %exitcond1049.4.not = icmp eq i64 %polly.indvar616.us.4, %252
  br i1 %exitcond1049.4.not, label %polly.loop_exit614.loopexit.us.4, label %polly.loop_header612.us.4
...
polly.loop_header612.us.5:                        ; preds = %polly.loop_header612.us.5.preheader, %polly.loop_header612.us.5
  ...
  %exitcond1049.5.not = icmp eq i64 %polly.indvar616.us.5, %252
  br i1 %exitcond1049.5.not, label %polly.loop_exit614.loopexit.us.5, label %polly.loop_header612.us.5
...
polly.loop_header612.us.6:                        ; preds = %polly.loop_header612.us.6.preheader, %polly.loop_header612.us.6
  ...
  %exitcond1049.6.not = icmp eq i64 %polly.indvar616.us.6, %252
  br i1 %exitcond1049.6.not, label %polly.loop_exit614.loopexit.us.6, label %polly.loop_header612.us.6
...
polly.loop_header612.us.7:                        ; preds = %polly.loop_header612.us.7.preheader, %polly.loop_header612.us.7
  ...
  %exitcond1049.7.not = icmp eq i64 %polly.indvar616.us.7, %252
  br i1 %exitcond1049.7.not, label %polly.loop_exit614.loopexit.us.7, label %polly.loop_header612.us.7
