; ModuleID = 'syr2k_exhaustive/mmp_all_SM_7618.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_7618.c"
...
polly.loop_header215:                             ; preds = %polly.loop_exit207, %polly.loop_exit223
  %indvars.iv834 = phi i64 [ %indvars.iv.next835, %polly.loop_exit223 ], [ 2, %polly.loop_exit207 ]
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %indvars.iv.next828 = add nuw nsw i64 %indvars.iv827, 80
  %indvars.iv.next835 = add nuw nsw i64 %indvars.iv834, 1
  %exitcond837.not = icmp eq i64 %polly.indvar_next219, 15
...
polly.loop_header227.preheader:                   ; preds = %polly.loop_header221
  ...
  %105 = add i64 %smax, %indvars.iv829
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %exitcond836 = icmp eq i64 %polly.indvar_next225, %98
  br i1 %exitcond836, label %polly.loop_exit223, label %polly.loop_header221

polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  %indvars.iv831 = phi i64 [ %105, %polly.loop_header227.preheader ], [ %indvars.iv.next832, %polly.loop_exit235 ]
  %polly.indvar230 = phi i64 [ %104, %polly.loop_header227.preheader ], [ %polly.indvar_next231, %polly.loop_exit235 ]
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv831, i64 63)
  %107 = add nsw i64 %polly.indvar230, %106
  %polly.loop_guard243917 = icmp sgt i64 %107, -1
...
polly.loop_header233.us:                          ; preds = %polly.loop_header227, %polly.loop_exit242.loopexit.us
  ...
  %scevgep247.us = getelementptr i8, i8* %call1, i64 %111
  %polly.access.mul.Packed_MemRef_call2251.us = mul nuw nsw i64 %polly.indvar236.us, 1200
  %polly.access.add.Packed_MemRef_call2252.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2251.us, %108
  ...
  %scevgep260.us = getelementptr i8, i8* %scevgep247.us, i64 %109
...
polly.loop_header240.us:                          ; preds = %polly.loop_header240.us, %polly.loop_header233.us
  ...
  %polly.access.add.Packed_MemRef_call2256.us = add nuw nsw i64 %112, %polly.access.mul.Packed_MemRef_call2251.us
...
polly.loop_exit235:                               ; preds = %polly.loop_exit242.loopexit.us, %polly.loop_header227
  ...
  %polly.loop_cond232 = icmp ult i64 %polly.indvar230, 79
...
polly.loop_header354:                             ; preds = %polly.loop_exit362, %polly.start268
  ...
  %117 = mul nuw nsw i64 %polly.indvar357, 9600
  %scevgep366 = getelementptr i8, i8* %call, i64 %117
...
vector.body1026:                                  ; preds = %vector.body1026, %vector.ph1030
  ...
  %119 = getelementptr i8, i8* %scevgep366, i64 %118
...
polly.loop_header360:                             ; preds = %polly.loop_header360.preheader, %polly.loop_header360
  ...
  %124 = shl nuw nsw i64 %polly.indvar363, 3
  %scevgep367 = getelementptr i8, i8* %scevgep366, i64 %124
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit395
  %indvars.iv856 = phi i64 [ %indvars.iv.next857, %polly.loop_exit395 ], [ 2, %polly.loop_exit378 ]
  ...
  %125 = lshr i64 %polly.indvar389, 2
  %126 = add nuw i64 %indvars.iv856, %125
  %127 = mul nsw i64 %polly.indvar389, -80
  %128 = mul nuw nsw i64 %polly.indvar389, 80
...
polly.loop_exit395:                               ; preds = %polly.loop_exit402
  ...
  %indvars.iv.next848 = add nuw nsw i64 %indvars.iv847, 80
  %indvars.iv.next857 = add nuw nsw i64 %indvars.iv856, 1
  %exitcond859.not = icmp eq i64 %polly.indvar_next390, 15
...
polly.loop_header393:                             ; preds = %polly.loop_exit402, %polly.loop_header386
  ...
  %129 = shl nsw i64 %polly.indvar396, 6
  %130 = add nsw i64 %129, %127
  %131 = icmp sgt i64 %130, 0
  %132 = select i1 %131, i64 %130, i64 0
  %polly.loop_guard403 = icmp slt i64 %132, 80
...
polly.loop_header400.preheader:                   ; preds = %polly.loop_header393
  ...
  %133 = add i64 %smax846, %indvars.iv849
...
polly.loop_exit402:                               ; preds = %polly.loop_exit409, %polly.loop_header393
  ...
  %exitcond858 = icmp eq i64 %polly.indvar_next397, %126
  br i1 %exitcond858, label %polly.loop_exit395, label %polly.loop_header393

polly.loop_header400:                             ; preds = %polly.loop_header400.preheader, %polly.loop_exit409
  %indvars.iv851 = phi i64 [ %133, %polly.loop_header400.preheader ], [ %indvars.iv.next852, %polly.loop_exit409 ]
  %polly.indvar404 = phi i64 [ %132, %polly.loop_header400.preheader ], [ %polly.indvar_next405, %polly.loop_exit409 ]
  %smin853 = call i64 @llvm.smin.i64(i64 %indvars.iv851, i64 63)
  %135 = add nsw i64 %polly.indvar404, %134
  %polly.loop_guard417918 = icmp sgt i64 %135, -1
  %136 = add nuw nsw i64 %polly.indvar404, %128
...
polly.loop_header407.us:                          ; preds = %polly.loop_header400, %polly.loop_exit416.loopexit.us
  ...
  %139 = shl nuw nsw i64 %polly.indvar410.us, 3
  ...
  %polly.access.add.Packed_MemRef_call2271426.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2271425.us, %136
  ...
  %scevgep434.us = getelementptr i8, i8* %scevgep421.us, i64 %137
...
polly.loop_header414.us:                          ; preds = %polly.loop_header414.us, %polly.loop_header407.us
  ...
  %140 = add nuw nsw i64 %polly.indvar418.us, %129
  %141 = mul nuw nsw i64 %140, 8000
  %scevgep422.us = getelementptr i8, i8* %scevgep421.us, i64 %141
  ...
  %polly.access.add.Packed_MemRef_call2271430.us = add nuw nsw i64 %140, %polly.access.mul.Packed_MemRef_call2271425.us
  ...
  %142 = shl i64 %140, 3
  %143 = add i64 %142, %138
  %scevgep437.us = getelementptr i8, i8* %call, i64 %143
...
polly.loop_exit409:                               ; preds = %polly.loop_exit416.loopexit.us, %polly.loop_header400
  ...
  %polly.loop_cond406 = icmp ult i64 %polly.indvar404, 79
...
polly.loop_header528:                             ; preds = %polly.loop_exit536, %polly.start442
  ...
  %145 = mul nuw nsw i64 %polly.indvar531, 9600
  %scevgep540 = getelementptr i8, i8* %call, i64 %145
...
vector.body1002:                                  ; preds = %vector.body1002, %vector.ph1004
  ...
  %147 = getelementptr i8, i8* %scevgep540, i64 %146
...
polly.loop_header534:                             ; preds = %polly.loop_header534.preheader, %polly.loop_header534
  ...
  %152 = shl nuw nsw i64 %polly.indvar537, 3
  %scevgep541 = getelementptr i8, i8* %scevgep540, i64 %152
...
polly.loop_header560:                             ; preds = %polly.loop_exit552, %polly.loop_exit569
  %indvars.iv878 = phi i64 [ %indvars.iv.next879, %polly.loop_exit569 ], [ 2, %polly.loop_exit552 ]
  ...
  %153 = lshr i64 %polly.indvar563, 2
  %154 = add nuw i64 %indvars.iv878, %153
  %155 = mul nsw i64 %polly.indvar563, -80
  %156 = mul nuw nsw i64 %polly.indvar563, 80
...
polly.loop_exit569:                               ; preds = %polly.loop_exit576
  ...
  %indvars.iv.next870 = add nuw nsw i64 %indvars.iv869, 80
  %indvars.iv.next879 = add nuw nsw i64 %indvars.iv878, 1
  %exitcond881.not = icmp eq i64 %polly.indvar_next564, 15
...
polly.loop_header567:                             ; preds = %polly.loop_exit576, %polly.loop_header560
  ...
  %157 = shl nsw i64 %polly.indvar570, 6
  %158 = add nsw i64 %157, %155
  %159 = icmp sgt i64 %158, 0
  %160 = select i1 %159, i64 %158, i64 0
  %polly.loop_guard577 = icmp slt i64 %160, 80
...
polly.loop_header574.preheader:                   ; preds = %polly.loop_header567
  ...
  %161 = add i64 %smax868, %indvars.iv871
...
polly.loop_exit576:                               ; preds = %polly.loop_exit583, %polly.loop_header567
  ...
  %exitcond880 = icmp eq i64 %polly.indvar_next571, %154
  br i1 %exitcond880, label %polly.loop_exit569, label %polly.loop_header567

polly.loop_header574:                             ; preds = %polly.loop_header574.preheader, %polly.loop_exit583
  %indvars.iv873 = phi i64 [ %161, %polly.loop_header574.preheader ], [ %indvars.iv.next874, %polly.loop_exit583 ]
  %polly.indvar578 = phi i64 [ %160, %polly.loop_header574.preheader ], [ %polly.indvar_next579, %polly.loop_exit583 ]
  %smin875 = call i64 @llvm.smin.i64(i64 %indvars.iv873, i64 63)
  %163 = add nsw i64 %polly.indvar578, %162
  %polly.loop_guard591919 = icmp sgt i64 %163, -1
  %164 = add nuw nsw i64 %polly.indvar578, %156
...
polly.loop_header581.us:                          ; preds = %polly.loop_header574, %polly.loop_exit590.loopexit.us
  ...
  %167 = shl nuw nsw i64 %polly.indvar584.us, 3
  %scevgep595.us = getelementptr i8, i8* %call1, i64 %167
  %polly.access.mul.Packed_MemRef_call2445599.us = mul nuw nsw i64 %polly.indvar584.us, 1200
  %polly.access.add.Packed_MemRef_call2445600.us = add nuw nsw i64 %polly.access.mul.Packed_MemRef_call2445599.us, %164
  ...
  %scevgep608.us = getelementptr i8, i8* %scevgep595.us, i64 %165
...
polly.loop_header588.us:                          ; preds = %polly.loop_header588.us, %polly.loop_header581.us
  ...
  %168 = add nuw nsw i64 %polly.indvar592.us, %157
  %169 = mul nuw nsw i64 %168, 8000
  %scevgep596.us = getelementptr i8, i8* %scevgep595.us, i64 %169
  ...
  %polly.access.add.Packed_MemRef_call2445604.us = add nuw nsw i64 %168, %polly.access.mul.Packed_MemRef_call2445599.us
  ...
  %170 = shl i64 %168, 3
  %171 = add i64 %170, %166
  %scevgep611.us = getelementptr i8, i8* %call, i64 %171
...
polly.loop_exit583:                               ; preds = %polly.loop_exit590.loopexit.us, %polly.loop_header574
  ...
  %polly.loop_cond580 = icmp ult i64 %polly.indvar578, 79
...
vector.body940:                                   ; preds = %vector.body940, %vector.ph942
  ...
  br i1 %193, label %polly.loop_exit760, label %vector.body940, !llvm.loop !99

polly.loop_exit760:                               ; preds = %vector.body940, %polly.loop_header758
  %polly.indvar_next756 = add nuw nsw i64 %polly.indvar755, 1
  %exitcond913.not = icmp eq i64 %polly.indvar755, %173
...
polly.loop_header758:                             ; preds = %polly.loop_header752, %polly.loop_header758
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar761, %177
...
vector.body955:                                   ; preds = %vector.body955, %vector.ph958
  ...
  br i1 %222, label %polly.loop_exit787, label %vector.body955, !llvm.loop !102

polly.loop_exit787:                               ; preds = %vector.body955, %polly.loop_header785
  %polly.indvar_next783 = add nuw nsw i64 %polly.indvar782, 1
  %exitcond903.not = icmp eq i64 %polly.indvar782, %202
...
polly.loop_header785:                             ; preds = %polly.loop_header779, %polly.loop_header785
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar788, %206
...
vector.body973:                                   ; preds = %vector.body973, %vector.ph976
  ...
  br i1 %251, label %polly.loop_exit813, label %vector.body973, !llvm.loop !105

polly.loop_exit813:                               ; preds = %vector.body973, %polly.loop_header811
  %polly.indvar_next809 = add nuw nsw i64 %polly.indvar808, 1
  %exitcond893.not = icmp eq i64 %polly.indvar808, %231
...
polly.loop_header811:                             ; preds = %polly.loop_header805, %polly.loop_header811
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar814, %235
