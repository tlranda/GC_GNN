; ModuleID = 'syr2k_exhaustive/mmp_all_XL_7739.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_7739.c"
...
vector.body922:                                   ; preds = %vector.body922, %vector.ph923
  ...
  %38 = getelementptr inbounds [1200 x double], [1200 x double]* %call764, i64 %indvars.iv7.i, i64 %index924
  %39 = bitcast double* %38 to <4 x double>*
  store <4 x double> %37, <4 x double>* %39, align 8, !tbaa !2
  %index.next925 = add i64 %index924, 4
  %vec.ind.next929 = add <4 x i64> %vec.ind928, <i64 4, i64 4, i64 4, i64 4>
  %40 = icmp eq i64 %index.next925, 1200
...
for.body3.i46.preheader:                          ; preds = %for.cond1.preheader.i45
  %min.iters.check986 = icmp ult i64 %indvars.iv21.i, 4
  br i1 %min.iters.check986, label %for.body3.i46.preheader1060, label %vector.ph987

vector.ph987:                                     ; preds = %for.body3.i46.preheader
  %n.vec989 = and i64 %indvars.iv21.i, 9223372036854775804
...
vector.body985:                                   ; preds = %vector.body985, %vector.ph987
  ...
  %42 = getelementptr inbounds [1200 x double], [1200 x double]* %call764, i64 %indvars.iv21.i, i64 %index990
  ...
  %46 = icmp eq i64 %index.next991, %n.vec989
  br i1 %46, label %middle.block983, label %vector.body985, !llvm.loop !18

middle.block983:                                  ; preds = %vector.body985
  %cmp.n993 = icmp eq i64 %indvars.iv21.i, %n.vec989
  br i1 %cmp.n993, label %for.inc6.i, label %for.body3.i46.preheader1060

for.body3.i46.preheader1060:                      ; preds = %for.body3.i46.preheader, %middle.block983
  %indvars.iv18.i.ph = phi i64 [ 0, %for.body3.i46.preheader ], [ %n.vec989, %middle.block983 ]
  br label %for.body3.i46

for.body3.i46:                                    ; preds = %for.body3.i46.preheader1060, %for.body3.i46
  %indvars.iv18.i = phi i64 [ %indvars.iv.next19.i, %for.body3.i46 ], [ %indvars.iv18.i.ph, %for.body3.i46.preheader1060 ]
...
for.inc6.i:                                       ; preds = %for.body3.i46, %middle.block983, %for.cond1.preheader.i45
...
for.body3.i60.preheader:                          ; preds = %for.cond1.preheader.i54
  %min.iters.check1009 = icmp ult i64 %indvars.iv21.i52, 4
  br i1 %min.iters.check1009, label %for.body3.i60.preheader1059, label %vector.ph1010

vector.ph1010:                                    ; preds = %for.body3.i60.preheader
  %n.vec1012 = and i64 %indvars.iv21.i52, 9223372036854775804
...
vector.body1008:                                  ; preds = %vector.body1008, %vector.ph1010
  ...
  %53 = getelementptr inbounds [1200 x double], [1200 x double]* %call764, i64 %indvars.iv21.i52, i64 %index1013
  %54 = bitcast double* %53 to <4 x double>*
  %wide.load1017 = load <4 x double>, <4 x double>* %54, align 8, !tbaa !2
  %55 = fmul fast <4 x double> %wide.load1017, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %56 = bitcast double* %53 to <4 x double>*
  store <4 x double> %55, <4 x double>* %56, align 8, !tbaa !2
  %index.next1014 = add i64 %index1013, 4
  %57 = icmp eq i64 %index.next1014, %n.vec1012
  br i1 %57, label %middle.block1006, label %vector.body1008, !llvm.loop !55

middle.block1006:                                 ; preds = %vector.body1008
  %cmp.n1016 = icmp eq i64 %indvars.iv21.i52, %n.vec1012
  br i1 %cmp.n1016, label %for.inc6.i63, label %for.body3.i60.preheader1059

for.body3.i60.preheader1059:                      ; preds = %for.body3.i60.preheader, %middle.block1006
  %indvars.iv18.i55.ph = phi i64 [ 0, %for.body3.i60.preheader ], [ %n.vec1012, %middle.block1006 ]
  br label %for.body3.i60

for.body3.i60:                                    ; preds = %for.body3.i60.preheader1059, %for.body3.i60
  %indvars.iv18.i55 = phi i64 [ %indvars.iv.next19.i58, %for.body3.i60 ], [ %indvars.iv18.i55.ph, %for.body3.i60.preheader1059 ]
...
for.inc6.i63:                                     ; preds = %for.body3.i60, %middle.block1006, %for.cond1.preheader.i54
...
for.body3.i99.preheader:                          ; preds = %for.cond1.preheader.i93
  %min.iters.check1035 = icmp ult i64 %indvars.iv21.i91, 4
  br i1 %min.iters.check1035, label %for.body3.i99.preheader1058, label %vector.ph1036

vector.ph1036:                                    ; preds = %for.body3.i99.preheader
  %n.vec1038 = and i64 %indvars.iv21.i91, 9223372036854775804
...
vector.body1034:                                  ; preds = %vector.body1034, %vector.ph1036
  ...
  %64 = getelementptr inbounds [1200 x double], [1200 x double]* %call764, i64 %indvars.iv21.i91, i64 %index1039
  %65 = bitcast double* %64 to <4 x double>*
  %wide.load1043 = load <4 x double>, <4 x double>* %65, align 8, !tbaa !2
  %66 = fmul fast <4 x double> %wide.load1043, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %67 = bitcast double* %64 to <4 x double>*
  store <4 x double> %66, <4 x double>* %67, align 8, !tbaa !2
  %index.next1040 = add i64 %index1039, 4
  %68 = icmp eq i64 %index.next1040, %n.vec1038
  br i1 %68, label %middle.block1032, label %vector.body1034, !llvm.loop !57

middle.block1032:                                 ; preds = %vector.body1034
  %cmp.n1042 = icmp eq i64 %indvars.iv21.i91, %n.vec1038
  br i1 %cmp.n1042, label %for.inc6.i102, label %for.body3.i99.preheader1058

for.body3.i99.preheader1058:                      ; preds = %for.body3.i99.preheader, %middle.block1032
  %indvars.iv18.i94.ph = phi i64 [ 0, %for.body3.i99.preheader ], [ %n.vec1038, %middle.block1032 ]
  br label %for.body3.i99

for.body3.i99:                                    ; preds = %for.body3.i99.preheader1058, %for.body3.i99
  %indvars.iv18.i94 = phi i64 [ %indvars.iv.next19.i97, %for.body3.i99 ], [ %indvars.iv18.i94.ph, %for.body3.i99.preheader1058 ]
...
for.inc6.i102:                                    ; preds = %for.body3.i99, %middle.block1032, %for.cond1.preheader.i93
...
polly.loop_header:                                ; preds = %polly.loop_exit193, %polly.start
  %indvar1047 = phi i64 [ %indvar.next1048, %polly.loop_exit193 ], [ 0, %polly.start ]
  %polly.indvar = phi i64 [ %polly.indvar_next, %polly.loop_exit193 ], [ 1, %polly.start ]
  %88 = add i64 %indvar1047, 1
  %89 = mul nuw nsw i64 %polly.indvar, 9600
  %scevgep = getelementptr i8, i8* %call, i64 %89
  %min.iters.check1049 = icmp ult i64 %88, 4
  br i1 %min.iters.check1049, label %polly.loop_header191.preheader, label %vector.ph1050

vector.ph1050:                                    ; preds = %polly.loop_header
  %n.vec1052 = and i64 %88, -4
...
vector.body1046:                                  ; preds = %vector.body1046, %vector.ph1050
  ...
  %90 = shl nuw nsw i64 %index1053, 3
  %91 = getelementptr i8, i8* %scevgep, i64 %90
  %92 = bitcast i8* %91 to <4 x double>*
  %wide.load1057 = load <4 x double>, <4 x double>* %92, align 8, !alias.scope !63, !noalias !65
  %93 = fmul fast <4 x double> %wide.load1057, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  %94 = bitcast i8* %91 to <4 x double>*
  store <4 x double> %93, <4 x double>* %94, align 8, !alias.scope !63, !noalias !65
  %index.next1054 = add i64 %index1053, 4
  %95 = icmp eq i64 %index.next1054, %n.vec1052
  br i1 %95, label %middle.block1044, label %vector.body1046, !llvm.loop !69

middle.block1044:                                 ; preds = %vector.body1046
  %cmp.n1056 = icmp eq i64 %88, %n.vec1052
  br i1 %cmp.n1056, label %polly.loop_exit193, label %polly.loop_header191.preheader

polly.loop_header191.preheader:                   ; preds = %polly.loop_header, %middle.block1044
  %polly.indvar194.ph = phi i64 [ 0, %polly.loop_header ], [ %n.vec1052, %middle.block1044 ]
  br label %polly.loop_header191

polly.loop_exit193:                               ; preds = %polly.loop_header191, %middle.block1044
  %polly.indvar_next = add nuw nsw i64 %polly.indvar, 1
  %exitcond837.not = icmp eq i64 %polly.indvar_next, 1200
...
polly.loop_header191:                             ; preds = %polly.loop_header191.preheader, %polly.loop_header191
  ...
  br i1 %exitcond836.not, label %polly.loop_exit193, label %polly.loop_header191, !llvm.loop !70
...
polly.loop_exit207:                               ; preds = %polly.loop_header205
  ...
  %exitcond835.not = icmp eq i64 %polly.indvar_next203, 1000
  br i1 %exitcond835.not, label %polly.loop_header215, label %polly.loop_header199
...
polly.loop_header205:                             ; preds = %polly.loop_header205, %polly.loop_header199
  ...
  %exitcond834.not = icmp eq i64 %polly.indvar_next209, 1200
  br i1 %exitcond834.not, label %polly.loop_exit207, label %polly.loop_header205
...
polly.loop_exit223:                               ; preds = %polly.loop_exit229
  ...
  %exitcond833.not = icmp eq i64 %polly.indvar_next219, 13
  br i1 %exitcond833.not, label %polly.exiting, label %polly.loop_header215
...
polly.loop_exit229:                               ; preds = %polly.loop_exit235, %polly.loop_header221
  ...
  %indvars.iv.next824 = add nsw i64 %indvars.iv823, 100
  %indvars.iv.next828 = add nsw i64 %indvars.iv827, -100
  %exitcond832.not = icmp eq i64 %polly.indvar224, %umin
  br i1 %exitcond832.not, label %polly.loop_exit223, label %polly.loop_header221
...
polly.loop_header227:                             ; preds = %polly.loop_header227.preheader, %polly.loop_exit235
  ...
  %smin = call i64 @llvm.smin.i64(i64 %indvars.iv829, i64 99)
  %108 = add nsw i64 %polly.indvar230, %107
  %polly.loop_guard243911 = icmp sgt i64 %108, -1
  %109 = add nuw nsw i64 %polly.indvar230, %101
  %110 = mul i64 %109, 8000
  %111 = mul i64 %109, 9600
  br i1 %polly.loop_guard243911, label %polly.loop_header233.us, label %polly.loop_exit235
...
polly.loop_header354:                             ; preds = %polly.loop_exit362, %polly.start268
  %indvar1021 = phi i64 [ %indvar.next1022, %polly.loop_exit362 ], [ 0, %polly.start268 ]
  %polly.indvar357 = phi i64 [ %polly.indvar_next358, %polly.loop_exit362 ], [ 1, %polly.start268 ]
  %117 = add i64 %indvar1021, 1
  %118 = mul nuw nsw i64 %polly.indvar357, 9600
  %scevgep366 = getelementptr i8, i8* %call, i64 %118
  %min.iters.check1023 = icmp ult i64 %117, 4
  br i1 %min.iters.check1023, label %polly.loop_header360.preheader, label %vector.ph1024

vector.ph1024:                                    ; preds = %polly.loop_header354
  %n.vec1026 = and i64 %117, -4
...
vector.body1020:                                  ; preds = %vector.body1020, %vector.ph1024
  ...
  %119 = shl nuw nsw i64 %index1027, 3
  %120 = getelementptr i8, i8* %scevgep366, i64 %119
  %121 = bitcast i8* %120 to <4 x double>*
  %wide.load1031 = load <4 x double>, <4 x double>* %121, align 8, !alias.scope !74, !noalias !76
  %122 = fmul fast <4 x double> %wide.load1031, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %124 = icmp eq i64 %index.next1028, %n.vec1026
  br i1 %124, label %middle.block1018, label %vector.body1020, !llvm.loop !80

middle.block1018:                                 ; preds = %vector.body1020
  %cmp.n1030 = icmp eq i64 %117, %n.vec1026
  br i1 %cmp.n1030, label %polly.loop_exit362, label %polly.loop_header360.preheader

polly.loop_header360.preheader:                   ; preds = %polly.loop_header354, %middle.block1018
  %polly.indvar363.ph = phi i64 [ 0, %polly.loop_header354 ], [ %n.vec1026, %middle.block1018 ]
  br label %polly.loop_header360

polly.loop_exit362:                               ; preds = %polly.loop_header360, %middle.block1018
  %polly.indvar_next358 = add nuw nsw i64 %polly.indvar357, 1
  %exitcond858.not = icmp eq i64 %polly.indvar_next358, 1200
  %indvar.next1022 = add i64 %indvar1021, 1
  br i1 %exitcond858.not, label %polly.loop_header370.preheader, label %polly.loop_header354
...
polly.loop_header360:                             ; preds = %polly.loop_header360.preheader, %polly.loop_header360
  ...
  %exitcond857.not = icmp eq i64 %polly.indvar_next364, %polly.indvar357
  br i1 %exitcond857.not, label %polly.loop_exit362, label %polly.loop_header360, !llvm.loop !81
...
polly.loop_exit378:                               ; preds = %polly.loop_header376
  ...
  %exitcond856.not = icmp eq i64 %polly.indvar_next374, 1000
  br i1 %exitcond856.not, label %polly.loop_header386, label %polly.loop_header370
...
polly.loop_header376:                             ; preds = %polly.loop_header376, %polly.loop_header370
  ...
  %exitcond855.not = icmp eq i64 %polly.indvar_next380, 1200
...
polly.loop_header386:                             ; preds = %polly.loop_exit378, %polly.loop_exit394
  %indvars.iv843 = phi i64 [ %indvars.iv.next844, %polly.loop_exit394 ], [ 0, %polly.loop_exit378 ]
  %indvars.iv838 = phi i64 [ %indvars.iv.next839, %polly.loop_exit394 ], [ 0, %polly.loop_exit378 ]
  %polly.indvar389 = phi i64 [ %polly.indvar_next390, %polly.loop_exit394 ], [ 0, %polly.loop_exit378 ]
  %umin852 = call i64 @llvm.umin.i64(i64 %polly.indvar389, i64 11)
  %126 = mul nsw i64 %polly.indvar389, -96
  %127 = icmp slt i64 %126, -1104
  %128 = select i1 %127, i64 %126, i64 -1104
  %129 = add nsw i64 %128, 1199
  %130 = mul nuw nsw i64 %polly.indvar389, 96
  br label %polly.loop_header392

polly.loop_exit394:                               ; preds = %polly.loop_exit401
  %polly.indvar_next390 = add nuw nsw i64 %polly.indvar389, 1
  %indvars.iv.next839 = add nsw i64 %indvars.iv838, -96
  %indvars.iv.next844 = add nuw nsw i64 %indvars.iv843, 96
  %exitcond854.not = icmp eq i64 %polly.indvar_next390, 13
  br i1 %exitcond854.not, label %polly.exiting269, label %polly.loop_header386

polly.loop_header392:                             ; preds = %polly.loop_exit401, %polly.loop_header386
  %indvars.iv845 = phi i64 [ %indvars.iv.next846, %polly.loop_exit401 ], [ %indvars.iv843, %polly.loop_header386 ]
  %indvars.iv840 = phi i64 [ %indvars.iv.next841, %polly.loop_exit401 ], [ %indvars.iv838, %polly.loop_header386 ]
  %polly.indvar395 = phi i64 [ %polly.indvar_next396, %polly.loop_exit401 ], [ 0, %polly.loop_header386 ]
  %131 = mul nuw nsw i64 %polly.indvar395, 100
...
polly.loop_header399.preheader:                   ; preds = %polly.loop_header392
  %smax842 = call i64 @llvm.smax.i64(i64 %indvars.iv840, i64 0)
  %135 = add i64 %smax842, %indvars.iv845
...
polly.loop_exit401:                               ; preds = %polly.loop_exit408, %polly.loop_header392
  ...
  %exitcond853.not = icmp eq i64 %polly.indvar395, %umin852
  br i1 %exitcond853.not, label %polly.loop_exit394, label %polly.loop_header392

polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit408
  %indvars.iv847 = phi i64 [ %135, %polly.loop_header399.preheader ], [ %indvars.iv.next848, %polly.loop_exit408 ]
  %polly.indvar403 = phi i64 [ %134, %polly.loop_header399.preheader ], [ %polly.indvar_next404, %polly.loop_exit408 ]
  %smin849 = call i64 @llvm.smin.i64(i64 %indvars.iv847, i64 99)
  %137 = add nsw i64 %polly.indvar403, %136
  %polly.loop_guard416912 = icmp sgt i64 %137, -1
  %138 = add nuw nsw i64 %polly.indvar403, %130
  %139 = mul i64 %138, 8000
  %140 = mul i64 %138, 9600
  br i1 %polly.loop_guard416912, label %polly.loop_header406.us, label %polly.loop_exit408
...
polly.loop_header413.us:                          ; preds = %polly.loop_header413.us, %polly.loop_header406.us
  ...
  %exitcond850.not = icmp eq i64 %polly.indvar417.us, %smin849
  br i1 %exitcond850.not, label %polly.loop_exit415.loopexit.us, label %polly.loop_header413.us

polly.loop_exit415.loopexit.us:                   ; preds = %polly.loop_header413.us
  %polly.indvar_next410.us = add nuw nsw i64 %polly.indvar409.us, 1
  %exitcond851.not = icmp eq i64 %polly.indvar_next410.us, 1000
  br i1 %exitcond851.not, label %polly.loop_exit408, label %polly.loop_header406.us
...
polly.loop_header527:                             ; preds = %polly.loop_exit535, %polly.start441
  ...
  %min.iters.check997 = icmp ult i64 %146, 4
  br i1 %min.iters.check997, label %polly.loop_header533.preheader, label %vector.ph998

vector.ph998:                                     ; preds = %polly.loop_header527
  %n.vec1000 = and i64 %146, -4
...
vector.body996:                                   ; preds = %vector.body996, %vector.ph998
  ...
  %148 = shl nuw nsw i64 %index1001, 3
  %149 = getelementptr i8, i8* %scevgep539, i64 %148
  %150 = bitcast i8* %149 to <4 x double>*
  %wide.load1005 = load <4 x double>, <4 x double>* %150, align 8, !alias.scope !84, !noalias !86
  %151 = fmul fast <4 x double> %wide.load1005, <double 1.200000e+00, double 1.200000e+00, double 1.200000e+00, double 1.200000e+00>
  ...
  %153 = icmp eq i64 %index.next1002, %n.vec1000
  br i1 %153, label %middle.block994, label %vector.body996, !llvm.loop !90

middle.block994:                                  ; preds = %vector.body996
  %cmp.n1004 = icmp eq i64 %146, %n.vec1000
  br i1 %cmp.n1004, label %polly.loop_exit535, label %polly.loop_header533.preheader

polly.loop_header533.preheader:                   ; preds = %polly.loop_header527, %middle.block994
  %polly.indvar536.ph = phi i64 [ 0, %polly.loop_header527 ], [ %n.vec1000, %middle.block994 ]
  br label %polly.loop_header533

polly.loop_exit535:                               ; preds = %polly.loop_header533, %middle.block994
  %polly.indvar_next531 = add nuw nsw i64 %polly.indvar530, 1
  %exitcond879.not = icmp eq i64 %polly.indvar_next531, 1200
  %indvar.next = add i64 %indvar, 1
  br i1 %exitcond879.not, label %polly.loop_header543.preheader, label %polly.loop_header527
...
polly.loop_header533:                             ; preds = %polly.loop_header533.preheader, %polly.loop_header533
  ...
  %exitcond878.not = icmp eq i64 %polly.indvar_next537, %polly.indvar530
  br i1 %exitcond878.not, label %polly.loop_exit535, label %polly.loop_header533, !llvm.loop !91
...
polly.loop_exit551:                               ; preds = %polly.loop_header549
  ...
  %exitcond877.not = icmp eq i64 %polly.indvar_next547, 1000
  br i1 %exitcond877.not, label %polly.loop_header559, label %polly.loop_header543
...
polly.loop_header549:                             ; preds = %polly.loop_header549, %polly.loop_header543
  ...
  %exitcond876.not = icmp eq i64 %polly.indvar_next553, 1200
  br i1 %exitcond876.not, label %polly.loop_exit551, label %polly.loop_header549

polly.loop_header559:                             ; preds = %polly.loop_exit551, %polly.loop_exit567
  %indvars.iv864 = phi i64 [ %indvars.iv.next865, %polly.loop_exit567 ], [ 0, %polly.loop_exit551 ]
  %indvars.iv859 = phi i64 [ %indvars.iv.next860, %polly.loop_exit567 ], [ 0, %polly.loop_exit551 ]
  %polly.indvar562 = phi i64 [ %polly.indvar_next563, %polly.loop_exit567 ], [ 0, %polly.loop_exit551 ]
  %umin873 = call i64 @llvm.umin.i64(i64 %polly.indvar562, i64 11)
  %155 = mul nsw i64 %polly.indvar562, -96
  %156 = icmp slt i64 %155, -1104
  %157 = select i1 %156, i64 %155, i64 -1104
  %158 = add nsw i64 %157, 1199
  %159 = mul nuw nsw i64 %polly.indvar562, 96
...
polly.loop_exit567:                               ; preds = %polly.loop_exit574
  ...
  %indvars.iv.next860 = add nsw i64 %indvars.iv859, -96
  %indvars.iv.next865 = add nuw nsw i64 %indvars.iv864, 96
  %exitcond875.not = icmp eq i64 %polly.indvar_next563, 13
  br i1 %exitcond875.not, label %polly.exiting442, label %polly.loop_header559

polly.loop_header565:                             ; preds = %polly.loop_exit574, %polly.loop_header559
  %indvars.iv866 = phi i64 [ %indvars.iv.next867, %polly.loop_exit574 ], [ %indvars.iv864, %polly.loop_header559 ]
  %indvars.iv861 = phi i64 [ %indvars.iv.next862, %polly.loop_exit574 ], [ %indvars.iv859, %polly.loop_header559 ]
  %polly.indvar568 = phi i64 [ %polly.indvar_next569, %polly.loop_exit574 ], [ 0, %polly.loop_header559 ]
  %160 = mul nuw nsw i64 %polly.indvar568, 100
...
polly.loop_header572.preheader:                   ; preds = %polly.loop_header565
  ...
  %164 = add i64 %smax863, %indvars.iv866
...
polly.loop_exit574:                               ; preds = %polly.loop_exit581, %polly.loop_header565
  ...
  %exitcond874.not = icmp eq i64 %polly.indvar568, %umin873
  br i1 %exitcond874.not, label %polly.loop_exit567, label %polly.loop_header565

polly.loop_header572:                             ; preds = %polly.loop_header572.preheader, %polly.loop_exit581
  %indvars.iv868 = phi i64 [ %164, %polly.loop_header572.preheader ], [ %indvars.iv.next869, %polly.loop_exit581 ]
  ...
  %polly.loop_guard589913 = icmp sgt i64 %166, -1
  %167 = add nuw nsw i64 %polly.indvar576, %159
  %168 = mul i64 %167, 8000
  %169 = mul i64 %167, 9600
  br i1 %polly.loop_guard589913, label %polly.loop_header579.us, label %polly.loop_exit581
...
polly.loop_header586.us:                          ; preds = %polly.loop_header586.us, %polly.loop_header579.us
  ...
  %exitcond871.not = icmp eq i64 %polly.indvar590.us, %smin870
  br i1 %exitcond871.not, label %polly.loop_exit588.loopexit.us, label %polly.loop_header586.us

polly.loop_exit588.loopexit.us:                   ; preds = %polly.loop_header586.us
  %polly.indvar_next583.us = add nuw nsw i64 %polly.indvar582.us, 1
  %exitcond872.not = icmp eq i64 %polly.indvar_next583.us, 1000
  br i1 %exitcond872.not, label %polly.loop_exit581, label %polly.loop_header579.us
...
polly.loop_header738:                             ; preds = %entry, %polly.loop_exit746
  %indvars.iv904 = phi i64 [ %indvars.iv.next905, %polly.loop_exit746 ], [ 0, %entry ]
...
polly.loop_exit746:                               ; preds = %polly.loop_exit752
  ...
  %exitcond909.not = icmp eq i64 %polly.indvar_next742, 38
  br i1 %exitcond909.not, label %polly.loop_header765, label %polly.loop_header738

polly.loop_header744:                             ; preds = %polly.loop_exit752, %polly.loop_header738
  %indvars.iv900 = phi i64 [ %indvars.iv.next901, %polly.loop_exit752 ], [ 0, %polly.loop_header738 ]
  %polly.indvar747 = phi i64 [ %polly.indvar_next748, %polly.loop_exit752 ], [ 0, %polly.loop_header738 ]
  %177 = mul nsw i64 %polly.indvar747, -32
  %smin935 = call i64 @llvm.smin.i64(i64 %177, i64 -1168)
  %178 = add nsw i64 %smin935, 1200
  %smin902 = call i64 @llvm.smin.i64(i64 %indvars.iv900, i64 -1168)
  %179 = shl nsw i64 %polly.indvar747, 5
  %180 = add nsw i64 %smin902, 1199
...
polly.loop_exit752:                               ; preds = %polly.loop_exit758
  ...
  %exitcond908.not = icmp eq i64 %polly.indvar_next748, 38
  br i1 %exitcond908.not, label %polly.loop_exit746, label %polly.loop_header744
...
polly.loop_header750:                             ; preds = %polly.loop_exit758, %polly.loop_header744
  ...
  br i1 %min.iters.check, label %polly.loop_header756, label %vector.ph936

vector.ph936:                                     ; preds = %polly.loop_header750
  %broadcast.splatinsert943 = insertelement <4 x i64> poison, i64 %179, i32 0
  %broadcast.splat944 = shufflevector <4 x i64> %broadcast.splatinsert943, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert945 = insertelement <4 x i32> poison, i32 %182, i32 0
...
vector.body934:                                   ; preds = %vector.body934, %vector.ph936
  %index937 = phi i64 [ 0, %vector.ph936 ], [ %index.next938, %vector.body934 ]
  %vec.ind941 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph936 ], [ %vec.ind.next942, %vector.body934 ]
  %184 = add nuw nsw <4 x i64> %vec.ind941, %broadcast.splat944
  %185 = trunc <4 x i64> %184 to <4 x i32>
  %186 = mul <4 x i32> %broadcast.splat946, %185
  ...
  %196 = icmp eq i64 %index.next938, %178
  br i1 %196, label %polly.loop_exit758, label %vector.body934, !llvm.loop !99

polly.loop_exit758:                               ; preds = %vector.body934, %polly.loop_header756
  %polly.indvar_next754 = add nuw nsw i64 %polly.indvar753, 1
  %exitcond907.not = icmp eq i64 %polly.indvar753, %176
  br i1 %exitcond907.not, label %polly.loop_exit752, label %polly.loop_header750
...
polly.loop_header756:                             ; preds = %polly.loop_header750, %polly.loop_header756
  ...
  %exitcond903.not = icmp eq i64 %polly.indvar759, %180
  br i1 %exitcond903.not, label %polly.loop_exit758, label %polly.loop_header756, !llvm.loop !100

polly.loop_header765:                             ; preds = %polly.loop_exit746, %polly.loop_exit773
  %indvars.iv894 = phi i64 [ %indvars.iv.next895, %polly.loop_exit773 ], [ 0, %polly.loop_exit746 ]
  %polly.indvar768 = phi i64 [ %polly.indvar_next769, %polly.loop_exit773 ], [ 0, %polly.loop_exit746 ]
  %smin896 = call i64 @llvm.smin.i64(i64 %indvars.iv894, i64 -1168)
  %204 = shl nsw i64 %polly.indvar768, 5
  %205 = add nsw i64 %smin896, 1199
...
polly.loop_exit773:                               ; preds = %polly.loop_exit779
  ...
  %exitcond899.not = icmp eq i64 %polly.indvar_next769, 38
  br i1 %exitcond899.not, label %polly.loop_header791, label %polly.loop_header765

polly.loop_header771:                             ; preds = %polly.loop_exit779, %polly.loop_header765
  %indvars.iv890 = phi i64 [ %indvars.iv.next891, %polly.loop_exit779 ], [ 0, %polly.loop_header765 ]
  %polly.indvar774 = phi i64 [ %polly.indvar_next775, %polly.loop_exit779 ], [ 0, %polly.loop_header765 ]
  %206 = mul nsw i64 %polly.indvar774, -32
  %smin950 = call i64 @llvm.smin.i64(i64 %206, i64 -968)
  %207 = add nsw i64 %smin950, 1000
  %smin892 = call i64 @llvm.smin.i64(i64 %indvars.iv890, i64 -968)
  %208 = shl nsw i64 %polly.indvar774, 5
  %209 = add nsw i64 %smin892, 999
...
polly.loop_exit779:                               ; preds = %polly.loop_exit785
  ...
  %exitcond898.not = icmp eq i64 %polly.indvar_next775, 32
  br i1 %exitcond898.not, label %polly.loop_exit773, label %polly.loop_header771
...
polly.loop_header777:                             ; preds = %polly.loop_exit785, %polly.loop_header771
  ...
  %min.iters.check951 = icmp eq i64 %207, 0
  br i1 %min.iters.check951, label %polly.loop_header783, label %vector.ph952

vector.ph952:                                     ; preds = %polly.loop_header777
  %broadcast.splatinsert961 = insertelement <4 x i64> poison, i64 %208, i32 0
  %broadcast.splat962 = shufflevector <4 x i64> %broadcast.splatinsert961, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert963 = insertelement <4 x i32> poison, i32 %211, i32 0
...
vector.body949:                                   ; preds = %vector.body949, %vector.ph952
  %index955 = phi i64 [ 0, %vector.ph952 ], [ %index.next956, %vector.body949 ]
  %vec.ind959 = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, %vector.ph952 ], [ %vec.ind.next960, %vector.body949 ]
  %213 = add nuw nsw <4 x i64> %vec.ind959, %broadcast.splat962
  %214 = trunc <4 x i64> %213 to <4 x i32>
  %215 = mul <4 x i32> %broadcast.splat964, %214
  ...
  %225 = icmp eq i64 %index.next956, %207
  br i1 %225, label %polly.loop_exit785, label %vector.body949, !llvm.loop !102

polly.loop_exit785:                               ; preds = %vector.body949, %polly.loop_header783
  %polly.indvar_next781 = add nuw nsw i64 %polly.indvar780, 1
  %exitcond897.not = icmp eq i64 %polly.indvar780, %205
  br i1 %exitcond897.not, label %polly.loop_exit779, label %polly.loop_header777
...
polly.loop_header783:                             ; preds = %polly.loop_header777, %polly.loop_header783
  ...
  %exitcond893.not = icmp eq i64 %polly.indvar786, %209
  br i1 %exitcond893.not, label %polly.loop_exit785, label %polly.loop_header783, !llvm.loop !103

polly.loop_header791:                             ; preds = %polly.loop_exit773, %polly.loop_exit799
  %indvars.iv884 = phi i64 [ %indvars.iv.next885, %polly.loop_exit799 ], [ 0, %polly.loop_exit773 ]
...
polly.loop_exit799:                               ; preds = %polly.loop_exit805
  ...
  %exitcond889.not = icmp eq i64 %polly.indvar_next795, 38
  br i1 %exitcond889.not, label %init_array.exit, label %polly.loop_header791

polly.loop_header797:                             ; preds = %polly.loop_exit805, %polly.loop_header791
  %indvars.iv880 = phi i64 [ %indvars.iv.next881, %polly.loop_exit805 ], [ 0, %polly.loop_header791 ]
  %polly.indvar800 = phi i64 [ %polly.indvar_next801, %polly.loop_exit805 ], [ 0, %polly.loop_header791 ]
  %235 = mul nsw i64 %polly.indvar800, -32
  %smin968 = call i64 @llvm.smin.i64(i64 %235, i64 -968)
  %236 = add nsw i64 %smin968, 1000
  %smin882 = call i64 @llvm.smin.i64(i64 %indvars.iv880, i64 -968)
  %237 = shl nsw i64 %polly.indvar800, 5
  %238 = add nsw i64 %smin882, 999
...
polly.loop_exit805:                               ; preds = %polly.loop_exit811
  ...
  %exitcond888.not = icmp eq i64 %polly.indvar_next801, 32
  br i1 %exitcond888.not, label %polly.loop_exit799, label %polly.loop_header797
...
polly.loop_header803:                             ; preds = %polly.loop_exit811, %polly.loop_header797
  ...
  %min.iters.check969 = icmp eq i64 %236, 0
  br i1 %min.iters.check969, label %polly.loop_header809, label %vector.ph970

vector.ph970:                                     ; preds = %polly.loop_header803
  %broadcast.splatinsert979 = insertelement <4 x i64> poison, i64 %237, i32 0
  %broadcast.splat980 = shufflevector <4 x i64> %broadcast.splatinsert979, <4 x i64> poison, <4 x i32> zeroinitializer
  %broadcast.splatinsert981 = insertelement <4 x i32> poison, i32 %240, i32 0
...
vector.body967:                                   ; preds = %vector.body967, %vector.ph970
  ...
  %242 = add nuw nsw <4 x i64> %vec.ind977, %broadcast.splat980
  %243 = trunc <4 x i64> %242 to <4 x i32>
  %244 = mul <4 x i32> %broadcast.splat982, %243
  ...
  %254 = icmp eq i64 %index.next974, %236
  br i1 %254, label %polly.loop_exit811, label %vector.body967, !llvm.loop !105

polly.loop_exit811:                               ; preds = %vector.body967, %polly.loop_header809
  %polly.indvar_next807 = add nuw nsw i64 %polly.indvar806, 1
  %exitcond887.not = icmp eq i64 %polly.indvar806, %234
  br i1 %exitcond887.not, label %polly.loop_exit805, label %polly.loop_header803
...
polly.loop_header809:                             ; preds = %polly.loop_header803, %polly.loop_header809
  ...
  %exitcond883.not = icmp eq i64 %polly.indvar812, %238
  br i1 %exitcond883.not, label %polly.loop_exit811, label %polly.loop_header809, !llvm.loop !106
}
