; ModuleID = 'syr2k_exhaustive/mmp_all_SM_5438.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_5438.c"
...
polly.loop_header221:                             ; preds = %polly.loop_exit229, %polly.loop_exit207
  ...
  %smin.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next824, i64 31)
  %105 = or i64 %101, 1
  ...
  %smin.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next824.1, i64 31)
  %109 = or i64 %101, 2
  ...
  %smin.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next824.2, i64 31)
  %113 = or i64 %101, 3
...
polly.loop_header368:                             ; preds = %polly.loop_header368.preheader, %polly.loop_exit392
  ...
  %131 = shl nsw i64 %polly.indvar371, 5
  br label %polly.loop_header374

polly.loop_exit376:                               ; preds = %polly.loop_exit382
  %132 = mul nsw i64 %polly.indvar371, -32
  %133 = shl nsw i64 %polly.indvar371, 3
...
polly.loop_header390:                             ; preds = %polly.loop_exit398, %polly.loop_exit376
  ...
  %smin840 = call i64 @llvm.smin.i64(i64 %indvars.iv836, i64 31)
  ...
  %smin840.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839, i64 31)
  %139 = or i64 %135, 1
  ...
  %smin840.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839.1, i64 31)
  %143 = or i64 %135, 2
  ...
  %smin840.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next839.2, i64 31)
  %147 = or i64 %135, 3
...
polly.loop_header537:                             ; preds = %polly.loop_header537.preheader, %polly.loop_exit561
  ...
  %165 = shl nsw i64 %polly.indvar540, 5
  br label %polly.loop_header543

polly.loop_exit545:                               ; preds = %polly.loop_exit551
  %166 = mul nsw i64 %polly.indvar540, -32
  %167 = shl nsw i64 %polly.indvar540, 3
...
polly.loop_header559:                             ; preds = %polly.loop_exit567, %polly.loop_exit545
  ...
  %smin856 = call i64 @llvm.smin.i64(i64 %indvars.iv852, i64 31)
  ...
  %smin856.1 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855, i64 31)
  %173 = or i64 %169, 1
  ...
  %smin856.2 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855.1, i64 31)
  %177 = or i64 %169, 2
  ...
  %smin856.3 = call i64 @llvm.smin.i64(i64 %indvars.iv.next855.2, i64 31)
  %181 = or i64 %169, 3
