; ModuleID = 'syr2k_exhaustive/mmp_all_SM_4845.c'
source_filename = "syr2k_exhaustive/mmp_all_SM_4845.c"
...
polly.loop_header211:                             ; preds = %polly.loop_header211.preheader, %polly.loop_exit220
  ...
  %polly.loop_guard221 = icmp slt i64 %116, 80
...
polly.loop_header385:                             ; preds = %polly.loop_header385.preheader, %polly.loop_exit393
  ...
  %142 = shl nuw nsw i64 %polly.indvar388, 1
  %143 = add nuw nsw i64 %142, 2
  %pexp.p_div_q397 = udiv i64 %143, 5
  %144 = sub nsw i64 %142, %pexp.p_div_q397
  %polly.loop_guard402 = icmp sgt i64 %144, -2
  %145 = mul nsw i64 %polly.indvar388, -80
  %146 = mul nuw nsw i64 %polly.indvar388, 80
...
polly.loop_header399:                             ; preds = %polly.loop_header399.preheader, %polly.loop_exit409
  ...
  %158 = mul nuw nsw i64 %polly.indvar403, 50
  %159 = add nsw i64 %158, %145
  %160 = icmp sgt i64 %159, 0
  %161 = select i1 %160, i64 %159, i64 0
  %polly.loop_guard410 = icmp slt i64 %161, 80
...
polly.loop_header578:                             ; preds = %polly.loop_header578.preheader, %polly.loop_exit586
  ...
  %187 = shl nuw nsw i64 %polly.indvar581, 1
  %188 = add nuw nsw i64 %187, 2
  %pexp.p_div_q590 = udiv i64 %188, 5
  %189 = sub nsw i64 %187, %pexp.p_div_q590
  %polly.loop_guard595 = icmp sgt i64 %189, -2
  %190 = mul nsw i64 %polly.indvar581, -80
  %191 = mul nuw nsw i64 %polly.indvar581, 80
...
polly.loop_header592:                             ; preds = %polly.loop_header592.preheader, %polly.loop_exit602
  ...
  %203 = mul nuw nsw i64 %polly.indvar596, 50
  %204 = add nsw i64 %203, %190
  %205 = icmp sgt i64 %204, 0
  %206 = select i1 %205, i64 %204, i64 0
  %polly.loop_guard603 = icmp slt i64 %206, 80
