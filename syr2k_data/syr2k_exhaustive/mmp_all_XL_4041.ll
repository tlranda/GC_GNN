; ModuleID = 'syr2k_exhaustive/mmp_all_XL_4041.c'
source_filename = "syr2k_exhaustive/mmp_all_XL_4041.c"
...
polly.loop_exit207:                               ; preds = %polly.loop_exit213
  ...
  %indvars.iv.next978 = add nuw nsw i64 %indvars.iv977, 4
...
polly.loop_header205:                             ; preds = %polly.loop_exit213, %polly.loop_header199
  ...
  %smin989 = call i64 @llvm.smin.i64(i64 %indvars.iv, i64 -968)
...
polly.loop_exit213:                               ; preds = %polly.loop_exit219
  ...
  %exitcond993.not = icmp eq i64 %polly.indvar_next209, 32
...
polly.loop_exit248:                               ; preds = %polly.loop_exit255.loopexit.us, %polly.loop_header217.split, %polly.loop_header246.preheader
  ...
  %exitcond991.not = icmp eq i64 %polly.indvar_next221, 4
...
polly.loop_header381:                             ; preds = %polly.loop_header381.preheader, %polly.loop_exit389
  ...
  %129 = shl nsw i64 %polly.indvar384, 2
...
polly.loop_exit389:                               ; preds = %polly.loop_exit396
  ...
  %exitcond1018.not = icmp eq i64 %polly.indvar_next385, 300
...
polly.loop_header387:                             ; preds = %polly.loop_exit396, %polly.loop_header381
  ...
  %smin1013 = call i64 @llvm.smin.i64(i64 %indvars.iv997, i64 -968)
...
polly.loop_exit396:                               ; preds = %polly.loop_exit402
  ...
  %exitcond1017.not = icmp eq i64 %polly.indvar_next391, 32
...
polly.loop_exit437:                               ; preds = %polly.loop_exit444.loopexit.us, %polly.loop_header400.split, %polly.loop_header435.preheader
  ...
  %exitcond1015.not = icmp eq i64 %polly.indvar_next404, 4
...
polly.start468:                                   ; preds = %init_array.exit
  %malloccall470 = tail call dereferenceable_or_null(307200) i8* @malloc(i64 307200) #6
...
polly.loop_header570:                             ; preds = %polly.loop_header570.preheader, %polly.loop_exit578
  ...
  %160 = shl nsw i64 %polly.indvar573, 2
...
polly.loop_exit578:                               ; preds = %polly.loop_exit585
  ...
  %exitcond1042.not = icmp eq i64 %polly.indvar_next574, 300
...
polly.loop_header576:                             ; preds = %polly.loop_exit585, %polly.loop_header570
  ...
  %smin1037 = call i64 @llvm.smin.i64(i64 %indvars.iv1021, i64 -968)
  %161 = add nsw i64 %smin1037, 1000
  %162 = shl nsw i64 %polly.indvar579, 5
...
polly.loop_exit585:                               ; preds = %polly.loop_exit591
  ...
  %indvars.iv.next1022 = add nsw i64 %indvars.iv1021, -32
  %exitcond1041.not = icmp eq i64 %polly.indvar_next580, 32
...
polly.loop_exit626:                               ; preds = %polly.loop_exit633.loopexit.us, %polly.loop_header589.split, %polly.loop_header624.preheader
  ...
  %exitcond1039.not = icmp eq i64 %polly.indvar_next593, 4
